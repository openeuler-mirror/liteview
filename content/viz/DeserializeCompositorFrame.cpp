...
{
    SkScalar r0c0, r0c1, r0c2, r0c3, r1c0, r1c1,
        r1c2, r1c3, r2c0, r2c1, r2c2, r2c3, r3c0, r3c1, r3c2, r3c3;
    ...
    *out = gfx::Transform::RowMajor(r0c0, r0c1, r0c2, r0c3, r1c0, r1c1,
        r1c2, r1c3, r2c0, r2c1, r2c2, r2c3, r3c0, r3c1, r3c2, r3c3);
}
...
void deserializeVizFrameDeadline(viz::FrameDeadline* out, base::PickleIterator& pickleIn)
{
    ...
    *out = viz::FrameDeadline(base::TimeTicks::FromInternalValue(frameStartTime), deadlineInFrames, base::TimeDelta::FromInternalValue(frameInterval), useDefaultLowerBoundDeadline);
}
...
//     sprintf_s(output, 0x99, "DisplayItemListTest::deserializeCcDisplayItemList: %p, %d\n", newData, padding);
