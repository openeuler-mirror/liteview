...
// Ϊ���� typeof indexedDB === 'object' �ҷ��� IDBFactory �ӿ�ϰ�ߣ�Ҳ���Թ���Ϊ IDBFactory ��ʵ��
// ��һ����վֻ��� window.indexedDB �Ƿ�����Լ��Ƿ���� .open ����
// ��ѡ������������������ȫ�֣���Щ��վ���ܻ��� new IDBDatabase(...) �ȣ������٣�
// ����Ϊ�˼򵥣���ǿ��Ҫ����Ϊ�������վֻ���� indexedDB.open()
    "    })();\n"
    "} else {\n"
    "}\n"
;
...
void BindJsQuery::bindFun(v8::Local<v8::Context> context, QueryFn* queryFn, QueryFn2* queryFn2, MbWebView* webview, const blink::LocalFrameToken& frameToken)
{
    ...
    if (!setMbQueryStrValue->IsFunction())// https://www.hao123.com/?tn=48021271_79_hao_pg ����ҳ��֪��Ϊɶ��ʱ��ʧ��
        return;
