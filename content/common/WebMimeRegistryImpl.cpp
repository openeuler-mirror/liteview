...
static WTF::String checkAndEnsureBit8String(const blink::WebString& ext)
{
    ...
    if (!extension.Is8Bit()) {
        ...
        extension = WTF::String(utf8String.c_str(), utf8String.size());
    }
...
WebMimeRegistryImpl::SupportsType WebMimeRegistryImpl::supportsMediaMIMEType(const blink::WebString& type, const blink::WebString& typeCodecs, const blink::WebString& system)
{
