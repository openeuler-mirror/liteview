...
bool blink::mojom::blink::ClipboardHost::IsFormatAvailable(::blink::mojom::blink::ClipboardFormat format, ::blink::mojom::blink::ClipboardBuffer buffer, bool* out_result)
{
    return false;
}
...
bool blink::mojom::blink::ClipboardHost::ReadHtml(::blink::mojom::blink::ClipboardBuffer buffer, ::WTF::String* out_markup,
    ::blink::KURL* out_url, uint32_t* out_fragment_start, uint32_t* out_fragment_end)
{
    return false;
}
...
bool blink::mojom::blink::ClipboardHost::ReadCustomData(::blink::mojom::blink::ClipboardBuffer buffer, const ::WTF::String& type, ::WTF::String* out_result)
{
    return false;
}
...
// todo(mb): Temp impl.Currently only used here.
...
bool ClipboardHostImpl::GetSequenceNumber(::blink::mojom::blink::ClipboardBuffer buffer, ::blink::ClipboardSequenceNumberToken* out_result)
{
    ...
    uint64_t sequence = ClipboardSequenceMonitor::getSequence();
#endif
    base::UnguessableToken token = base::UnguessableToken::Deserialize(sequence, 0);
    *out_result = ::blink::ClipboardSequenceNumberToken(token);
    return true;
}
...
#endif
    base::UnguessableToken token = base::UnguessableToken::Deserialize(sequence, 0);
    std::move(callback).Run(::blink::ClipboardSequenceNumberToken(token));
}
...
void ClipboardHostImpl::IsFormatAvailable(::blink::mojom::blink::ClipboardFormat format, ::blink::mojom::blink::ClipboardBuffer buffer, IsFormatAvailableCallback callback)
{
    CHECK(false);
...
bool ClipboardHostImpl::ReadHtml(::blink::mojom::blink::ClipboardBuffer buffer, 
    ::WTF::String* outMarkup, ::blink::KURL* out_url, uint32_t* outFragmentStart, uint32_t* outFragmentEnd)
{
    ClipboardType clipboardType;
    if (!convertBufferType(buffer, &clipboardType))
        return false;
    ...
    *outMarkup = WTF::String::FromUTF8(utf8CfHtmlStart.c_str(), utf8CfHtmlStart.size());
...
void ClipboardHostImpl::WriteCustomData(const WTF::HashMap<::WTF::String, ::WTF::String>& data)
{
