...
bool ::blink::mojom::BlobRegistry::Register(
    ::mojo::PendingReceiver<::blink::mojom::Blob> blob, const std::string& uuid, const std::string& content_type, const std::string& content_disposition,
...
bool ::blink::mojom::blink::BlobRegistry::Register(
...
static ::base::FilePath standardizationFilePath(const ::base::FilePath& path)
{
    ...
    return base::FilePath::FromUTF16Unsafe(base::StringPiece16(unescaped.data(), base::checked_cast<wtf_size_t>(unescaped.length())));
}
...
public:
    ...
    void ReadRange(uint64_t offset, uint64_t length, ::mojo::ScopedDataPipeProducerHandle pipe, ::mojo::PendingRemote<::blink::mojom::blink::BlobReaderClient> client) override
    {
        content::printFuncName(__FUNCTION__, true, true);
    }
...
void BlobReceiver::ReadAll(::mojo::ScopedDataPipeProducerHandle pipe, ::mojo::PendingRemote<::blink::mojom::blink::BlobReaderClient> client, bool isSync)
{
    ...
    uint64_t expectedContentSize = 0;
...
struct WaitForDataInfo {
    ...
    void waitForData()
    {
        ...
        runner->PostTask(FROM_HERE, base::BindOnce([](WaitForDataInfo* self) {
            self->waitForDataImpl();
        }, this));
...
private:
    ...
    {
        bytesProvider->RequestAsReply(base::BindOnce([](WaitForDataInfo* self, const WTF::Vector<uint8_t>& bytes) {
    ...
    WTF::Vector<::blink::mojom::blink::DataElementPtr> elements)
{
    ...
    for (size_t i = 0; i < elements.size(); ++i) {
        ...
        if (ele->is_bytes()) {
            ...
            blob->GetInternalUUID(base::BindOnce([](DataElementImpl* dataEle, const WTF::String& uid) {
                dataEle->u.blob->uuid = uid.Ascii();
            }, dataEle));
...
bool BlobRegistryImpl::Register(
    ::mojo::PendingReceiver<::blink::mojom::blink::Blob> blob,
...
void BlobRegistryImpl::GetBlobFromUUID(
    ...
    ::blink::mojom::blink::BlobRegistry::GetBlobFromUUIDCallback callback)
{
    content::printFuncName(__FUNCTION__, true, true);
}
...
void BlobRegistryImpl::URLStoreForOrigin(
    ...
    ::mojo::PendingAssociatedReceiver<::blink::mojom::blink::BlobURLStore> urlStore)
{
    //content::printFuncName(__FUNCTION__, true, true);
