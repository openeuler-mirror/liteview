...
bool blink::mojom::blink::LocalFrameHost::CreatePortal(
    ::mojo::PendingAssociatedReceiver<::blink::mojom::blink::Portal> portal,
...
void LocalFrameHostImpl::DidChangeBackgroundColor(::SkColor background_color, bool color_adjust)
{
    printFuncName(__FUNCTION__, false, false);
}
    ...
    ThreadCall::callUiThreadAsync(MB_FROM_HERE, [webviewHandle, urlStr, id]() {
        ...
        if (webview)
            webview->getClosure().m_LoadingFinishCallback(
                webviewHandle, 
                webview->getClosure().m_LoadingFinishParam, 
                (mbWebFrameHandle)id,
                urlStr->c_str(),
                MB_LOADING_FAILED, 
                "");
...
void LocalFrameHostImpl::DidBlockNavigation(const ::blink::KURL& blocked_url, const ::blink::KURL& initiator_url, ::blink::mojom::blink::NavigationBlockedReason reason)
{
    printFuncName(__FUNCTION__, true, false);
}
...
void LocalFrameHostImpl::GoToEntryAtOffset(int32_t offset, bool has_user_gesture)
{
    //printFuncName(__FUNCTION__, true, false);
...
void LocalFrameHostImpl::NavigateToNavigationApiKey(const WTF::String& key, bool has_user_gesture)
{
    printFuncName(__FUNCTION__, true, false);
}
...
void LocalFrameHostImpl::UpdateUserActivationState(::blink::mojom::blink::UserActivationUpdateType update_type, 
    ::blink::mojom::blink::UserActivationNotificationType notification_type)
{ 
    printFuncName(__FUNCTION__, false, false);
}
...
void LocalFrameHostImpl::RunModalAlertDialog(const ::WTF::String& alertMsg, 
    bool disable_third_party_subframe_suppresion, ::blink::mojom::blink::LocalFrameHost::RunModalAlertDialogCallback callback)
{
    printFuncName(__FUNCTION__, true, false);
}
...
void LocalFrameHostImpl::RunModalConfirmDialog(const ::WTF::String& alertMsg, 
    bool disable_third_party_subframe_suppresion, ::blink::mojom::blink::LocalFrameHost::RunModalConfirmDialogCallback callback)
{
    printFuncName(__FUNCTION__, true, false);
}
    ...
    const ::WTF::String& alertMsg, const ::WTF::String& defaultVal, bool disableThirdPartySubframeSuppresion, bool* outSuccess, ::WTF::String* outResult)
{
    ...
    do {
        ...
        ThreadCall::callUiThreadSync(MB_FROM_HERE, [webviewHandle, txt, defaultValue, &ret, &isOk]() {
            MbWebView* webview = (MbWebView*)common::LiveIdDetect::getMbWebviewIds()->getPtr(webviewHandle);
            if (webview)
                ret = webview->getClosure().m_PromptBoxCallback(webviewHandle, webview->getClosure().m_PromptBoxParam, txt->c_str(), defaultValue->c_str(), &isOk);
        });
    } while (false);
    ...
    if (ret) {
        *outResult = ::WTF::String::FromUTF8(mbGetString(ret), mbGetStringLen(ret));
        mbDeleteString(ret);
        *outSuccess = isOk;
        return true;
    } 
...
void LocalFrameHostImpl::RunModalPromptDialog(
    const ::WTF::String& alertMsg, const ::WTF::String& defaultVal, bool disable_third_party_subframe_suppresion, 
...
void LocalFrameHostImpl::FocusedElementChanged(bool is_editable_element, const ::gfx::Rect& bounds_in_frame_widget, ::blink::mojom::blink::FocusType focus_type)
{
    printFuncName(__FUNCTION__, true, false);
}
...
void LocalFrameHostImpl::ShowPopupMenu(::mojo::PendingRemote<::blink::mojom::blink::PopupMenuClient> popup_client, const ::gfx::Rect& bounds, int32_t item_height, double font_size,
...
void LocalFrameHostImpl::CreateNewPopupWidget(
    ::mojo::PendingAssociatedReceiver<::blink::mojom::blink::PopupWidgetHost> popupHost,
...
void LocalFrameHostImpl::ShowContextMenu(::mojo::PendingAssociatedRemote<::blink::mojom::blink::ContextMenuClient> client, const ::blink::UntrustworthyContextMenuParams& params)
{
//#if defined(OS_WIN)
...
void LocalFrameHostImpl::DidChangeFrameOwnerProperties(const ::blink::FrameToken& child_frame_token, ::blink::mojom::blink::FrameOwnerPropertiesPtr frame_owner_properties)
{
    printFuncName(__FUNCTION__, false, false);
}
...
public:
    ...
    {
        createAndBindInterface<::blink::mojom::blink::KeepAliveHandle, KeepAliveHandleImpl>(std::move(keepAliveHandle.PassPipe()));
    }
};
...
{
    printFuncName(__FUNCTION__, false, false);
    createAndBindInterface<::blink::mojom::blink::KeepAliveHandleFactory, KeepAliveHandleFactoryImpl>(std::move(factory.PassPipe()));
}

void LocalFrameHostImpl::DidAddMessageToConsole(::blink::mojom::blink::ConsoleMessageLevel log_level, 
    const ::WTF::String& msg, uint32_t line_number, const ::WTF::String& source_id,
...
bool LocalFrameHostImpl::CreatePortal(::mojo::PendingAssociatedReceiver<::blink::mojom::blink::Portal> portal, ::mojo::PendingAssociatedRemote<::blink::mojom::blink::PortalClient> client,
    ::blink::mojom::blink::RemoteFrameInterfacesFromRendererPtr remote_frame_interfaces, ::blink::mojom::blink::FrameReplicationStatePtr* out_initial_replicated_state,
    ::blink::PortalToken* out_portal_token, ::blink::RemoteFrameToken* out_frame_token, ::base::UnguessableToken* out_devtools_frame_token)
{
    printFuncName(__FUNCTION__, true, false);
...
void LocalFrameHostImpl::CreatePortal(::mojo::PendingAssociatedReceiver<::blink::mojom::blink::Portal> portal, ::mojo::PendingAssociatedRemote<::blink::mojom::blink::PortalClient> client,
...
bool LocalFrameHostImpl::AdoptPortal(const ::blink::PortalToken& portal_token, ::blink::mojom::blink::RemoteFrameInterfacesFromRendererPtr remote_frame_interfaces,
    ::blink::mojom::blink::FrameReplicationStatePtr* out_replicated_state, ::blink::RemoteFrameToken* out_frame_token, ::base::UnguessableToken* out_devtools_frame_token)
{
    printFuncName(__FUNCTION__, true, false);
    return false;
...
void LocalFrameHostImpl::CreateFencedFrame(::mojo::PendingAssociatedReceiver<::blink::mojom::blink::FencedFrameOwnerHost> fenced_frame, ::blink::mojom::blink::FencedFrameMode mode,
