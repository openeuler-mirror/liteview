...
public:
    ...
    virtual void UpdateTooltipFromKeyboard(const ::WTF::String& tooltip_text, ::base::i18n::TextDirection text_direction_hint, const ::gfx::Rect& bounds) override
    {
    ...
    void allowResize() { m_allowResize = true; }
    void disallowResize() { m_allowResize = false; }
    ...
    scoped_refptr<base::SingleThreadTaskRunner> m_runner;
