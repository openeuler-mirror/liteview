...
public:
    ...
    virtual void EnterFullscreen(::blink::mojom::blink::FullscreenOptionsPtr options, ::blink::mojom::blink::LocalFrameHost::EnterFullscreenCallback callback) override;
    ...
    virtual void DidChangeBackgroundColor(::SkColor background_color, bool color_adjust) override;
    ...
    virtual void DidBlockNavigation(const ::blink::KURL& blocked_url, const ::blink::KURL& initiator_url, ::blink::mojom::blink::NavigationBlockedReason reason) override;
    ...
    virtual void GoToEntryAtOffset(int32_t offset, bool has_user_gesture) override;

    virtual void NavigateToNavigationApiKey(const WTF::String& key, bool has_user_gesture) override;
    ...
    virtual void FocusedElementChanged(bool is_editable_element, const ::gfx::Rect& bounds_in_frame_widget, ::blink::mojom::blink::FocusType focus_type) override;
    ...
    virtual void ShowContextMenu(::mojo::PendingAssociatedRemote<::blink::mojom::blink::ContextMenuClient> client, const ::blink::UntrustworthyContextMenuParams& params) override;
    ...
    virtual void DidChangeFrameOwnerProperties(const ::blink::FrameToken& child_frame_token, ::blink::mojom::blink::FrameOwnerPropertiesPtr frame_owner_properties) override;
    ...
    virtual bool CreatePortal(::mojo::PendingAssociatedReceiver<::blink::mojom::blink::Portal> portal, ::mojo::PendingAssociatedRemote<::blink::mojom::blink::PortalClient> client,
        ...
        ::blink::PortalToken* out_portal_token, ::blink::RemoteFrameToken* out_frame_token, ::base::UnguessableToken* out_devtools_frame_token) override;
    ...
    virtual bool AdoptPortal(const ::blink::PortalToken& portal_token, ::blink::mojom::blink::RemoteFrameInterfacesFromRendererPtr remote_frame_interfaces,
        ::blink::mojom::blink::FrameReplicationStatePtr* out_replicated_state, ::blink::RemoteFrameToken* out_frame_token, ::base::UnguessableToken* out_devtools_frame_token) override;
