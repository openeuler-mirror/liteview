...
void PageNavController::FrameHistoryItem::loadFromHistoryItem(MbWebView* page, PageNavController::FrameHistoryItem* curItem, PageNavController::FrameHistoryItem* newItem)
{
...
//         return;
    ...
    ThreadCall::callBlinkThreadAsync(FROM_HERE, [self, offset] {
...
void PageNavController::FrameHistoryItem::copyHistoryItem(const blink::WebHistoryItem& item)
{
    ...
    blink::PageState pageState = otherWebItem->ToPageState(); // 这里面有些字段我还没实现拷贝
