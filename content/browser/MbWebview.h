...
public:
    ...
    bool getIsAutoDrawToHwnd() const { return m_isAutoDrawToHwnd; }
    ...
    bool isContextMenuEnable() const { return m_isContextMenuEnable; }

    std::string getCookiesForSession();
#ifndef _WIN32
    void setNcHittestPadding(int ncHittestPadding) { m_ncHittestPadding = ncHittestPadding; }
#endif
    ...
    void performCookieCommand(mbCookieCommand command);
    ...
    void initPopupWidgetModeInBlinkThread(
    ...
    void resetState() { m_hasDispatchWillCommitProvisionalLoad = false; }  // 有url load的时候会调用
    ...
    bool isWebWindowMode() const { return m_isWebWindowMode; }
    ...
    void setSessionStorageNamespaceId(const std::string& sessionStorageNamespaceId) { m_sessionStorageNamespaceId = sessionStorageNamespaceId; }
    ...
    std::map<std::string, void*>& getUserKeyValues() { return m_userKeyValues; }
    ...
    WebLocalFrameClientImpl* getFrameClient() const { return m_frameClient; }
