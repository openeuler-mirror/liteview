...
public:
    ...
    T* fromMaybe(T* default_value) const { return value_ ? value_.get() : default_value; }
...
public:
    ...
    const T& fromMaybe(const T& default_value) const { return is_just_ ? value_ : default_value; }
