...
void WriteUTF8AsUTF16(ParserHandler* writer, const std::string& utf8) { writer->HandleString16(SpanFrom(UTF8ToUTF16(SpanFrom(utf8)))); }
...
public:
    ...
    void HandleDouble(double value) override { log_ << "double: " << value << "\n"; }
    ...
    std::vector<std::vector<uint16_t>> raw_log_string16() const { return raw_log_string16_; }
...
{
    std::vector<uint16_t> json16 = { '{', '"', 'm', 's', 'g', '"', ':', '"', 'H', 'e', 'l', 'l', 'o', ',', ' ', 0xd83c, 0xdf0e, '.', '"', ',', '"', 'l', 's', 't', '"', ':', '[',
        '1', ',', '2', ',', '3', ']', '}' };
    std::vector<uint8_t> cbor;
    {
