...
public:
    ...
    inline void JumpIfObjectType(Condition cc, Register object, InstanceType instance_type, Register map, Label* target, Label::Distance distance = Label::kFar);
    ...
    inline void JumpIfSmi(Condition cc, Register value, Smi smi, Label* target, Label::Distance distance = Label::kFar);
    ...
    inline void LoadTaggedPointerField(Register output, Register source, int offset);
...
// [%compressed_base + %r1 + K].
    ...
    inline void LoadTaggedPointerField(TaggedRegister output, Register source, int offset);
    inline void LoadTaggedPointerField(TaggedRegister output, TaggedRegister source, int offset);
    inline void LoadTaggedPointerField(Register output, TaggedRegister source, int offset);
    inline void LoadTaggedAnyField(Register output, TaggedRegister source, int offset);
    inline void LoadTaggedAnyField(TaggedRegister output, TaggedRegister source, int offset);
