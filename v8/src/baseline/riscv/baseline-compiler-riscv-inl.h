...
void BaselineCompiler::Prologue()
{
    ...
    int max_frame_size = bytecode_->frame_size() + max_call_args_ * kSystemPointerSize;
...
{
    ASM_CODE_COMMENT(&masm_);
    __ masm()->AddWord(kScratchReg, sp, Operand(InterpreterFrameConstants::kFixedFrameSizeFromFp + bytecode_->frame_size()));
