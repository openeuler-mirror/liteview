...
BytecodeOffsetIterator::BytecodeOffsetIterator(Handle<ByteArray> mapping_table, Handle<BytecodeArray> bytecodes)
...
BytecodeOffsetIterator::BytecodeOffsetIterator(ByteArray mapping_table, BytecodeArray bytecodes)
