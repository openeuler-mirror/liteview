...
using BlockConstIterator = std::vector<BasicBlock*, ZoneAllocator<BasicBlock*>>::const_iterator;
using BlockConstReverseIterator = std::vector<BasicBlock*, ZoneAllocator<BasicBlock*>>::const_reverse_iterator;
...
public:
    ...
    compiler::ZoneRefMap<compiler::ObjectRef, Constant*>& constants() { return constants_; }
