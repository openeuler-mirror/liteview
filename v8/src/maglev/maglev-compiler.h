...
public:
    ...
    static void Compile(LocalIsolate* local_isolate, MaglevCompilationInfo* compilation_info);

    // Called on the main thread after Compile has completed.
    // TODO(v8:7700): Move this to a different class?
    static MaybeHandle<CodeT> GenerateCode(Isolate* isolate, MaglevCompilationInfo* compilation_info);
};
