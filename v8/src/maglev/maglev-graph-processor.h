...
//
template <typename NodeProcessor> class GraphProcessor;
...
public:
    ...
    void ProcessGraph(Graph* graph)
    {
        ...
        for (block_it_ = graph->begin(); block_it_ != graph->end(); ++block_it_) {
            ...
            for (node_it_ = block->nodes().begin(); node_it_ != block->nodes().end(); ++node_it_) {
                Node* node = *node_it_;
...
public:
    ...
    template <typename Node> void Process(Node* node, const ProcessingState& state)
    {
