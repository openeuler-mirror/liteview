...
private:
    ...
    void FreeRegistersUsedBy(ValueNode* node);
    template <typename RegisterT> RegisterT FreeUnblockedRegister();
    ...
    template <typename RegisterT> void DropRegisterValueAtEnd(RegisterT reg);
    template <typename RegisterT> void EnsureFreeRegisterAtEnd();
    compiler::AllocatedOperand AllocateRegisterAtEnd(ValueNode* node);

    template <typename RegisterT> void DropRegisterValue(RegisterFrameState<RegisterT>& registers, RegisterT reg);
