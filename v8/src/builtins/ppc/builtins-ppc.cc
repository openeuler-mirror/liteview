...
void ResetBytecodeAge(MacroAssembler* masm, Register bytecode_array, Register scratch)
{
    ...
    __ StoreU16(scratch, FieldMemOperand(bytecode_array, BytecodeArray::kBytecodeAgeOffset), r0);
}
...
void ResetFeedbackVectorOsrUrgency(MacroAssembler* masm, Register feedback_vector, Register scratch1, Register scratch2)
{
    ...
    __ andi(scratch1, scratch1, Operand(FeedbackVector::MaybeHasOptimizedOsrCodeBit::kMask));
...
void OnStackReplacement(MacroAssembler* masm, OsrSourceTier source, Register maybe_target_code)
{
    ...
    __ LoadTaggedPointerField(r4, FieldMemOperand(r3, Code::kDeoptimizationDataOrInterpreterDataOffset), r0);
...
void Builtins::Generate_JSConstructStubGeneric(MacroAssembler* masm)
{
    ...
    __ JumpIfIsInRange(
        r7, static_cast<uint32_t>(FunctionKind::kDefaultDerivedConstructor), static_cast<uint32_t>(FunctionKind::kDerivedConstructor), &not_create_implicit_receiver);
...
void Generate_JSEntryVariant(MacroAssembler* masm, StackFrame::Type type, Builtin entry_trampoline)
{
    ...
    // emitted after an instruction is emitted, rather than before.
    {
        ...
        __ Move(scratch, ExternalReference::Create(IsolateAddressId::kPendingExceptionAddress, masm->isolate()));
    }
...
static void LeaveInterpreterFrame(MacroAssembler* masm, Register scratch1, Register scratch2)
{
    ...
    __ lwz(params_size, FieldMemOperand(params_size, BytecodeArray::kParameterSizeOffset));
...
void Builtins::Generate_BaselineOutOfLinePrologue(MacroAssembler* masm)
{
    ...
    // Increment invocation count for the function.
    {
        ...
        __ LoadU64(invocation_count, FieldMemOperand(feedback_vector, FeedbackVector::kInvocationCountOffset), r0);
        __ AddS64(invocation_count, invocation_count, Operand(1));
        __ StoreU64(invocation_count, FieldMemOperand(feedback_vector, FeedbackVector::kInvocationCountOffset), r0);
    }
...
void Builtins::Generate_InterpreterEntryTrampoline(MacroAssembler* masm, InterpreterEntryTrampolineMode mode)
{
    ...
    Label compile_lazy;
    __ CompareObjectType(kInterpreterBytecodeArrayRegister, r7, no_reg, BYTECODE_ARRAY_TYPE);
    __ bne(&compile_lazy);
...
static void Generate_InterpreterEnterBytecode(MacroAssembler* masm)
{
    ...
    __ CompareObjectType(r5, kInterpreterDispatchTableRegister, kInterpreterDispatchTableRegister, INTERPRETER_DATA_TYPE);
    ...
    if (v8_flags.debug_code) {
        ...
        __ CompareObjectType(kInterpreterBytecodeArrayRegister, r4, no_reg, BYTECODE_ARRAY_TYPE);
...
void Generate_ContinueToBuiltinHelper(MacroAssembler* masm, bool java_script_builtin, bool with_result)
{
    ...
    if (with_result) {
        if (java_script_builtin) {
            ...
            __ StoreU64(r3, MemOperand(sp, config->num_allocatable_general_registers() * kSystemPointerSize + BuiltinContinuationFrameConstants::kFixedFrameSize));
        }
    }
...
void Builtins::Generate_CallOrConstructVarargs(MacroAssembler* masm, Handle<Code> code)
{
    ...
    // Push arguments onto the stack (thisArgument is already on the stack).
    {
        ...
        __ cmpi(r7, Operand::Zero());
        __ beq(&no_args);
        __ addi(r5, r5, Operand(FixedArray::kHeaderSize - kHeapObjectTag - kTaggedSize));
        __ mtctr(r7);
        __ bind(&loop);
...
void Builtins::Generate_WasmCompileLazy(MacroAssembler* masm)
{
...

    {
        ...
        CHECK_EQ(WasmCompileLazyFrameConstants::kNumberOfSavedFpParamRegs, simd_regs.Count());
        ...
        __ LoadU64(ip, MemOperand(kWasmInstanceRegister, WasmInstanceObject::kJumpTableStartOffset - kHeapObjectTag), r0);
...
void Builtins::Generate_CEntry(MacroAssembler* masm, int result_size, SaveFPRegsMode save_doubles, ArgvMode argv_mode, bool builtin_exit_frame)
{
    ...
    ExternalReference pending_handler_constant_pool_address = ExternalReference::Create(IsolateAddressId::kPendingHandlerConstantPoolAddress, masm->isolate());
    ...
    MacroAssembler* masm, Register function_address, ExternalReference thunk_ref, int stack_space, MemOperand* stack_space_operand, MemOperand return_value_operand)
{
    ...
    __ lbz(scratch, __ ExternalReferenceAsOperand(ExternalReference::is_profiling_address(isolate), scratch));
    __ cmpi(scratch, Operand::Zero());
...
void Builtins::Generate_CallApiCallback(MacroAssembler* masm)
{
    ...
    // on the stack).
    __ addi(scratch, scratch, Operand((FCA::kArgsLength + 1) * kSystemPointerSize));
    __ StoreU64(scratch, MemOperand(sp, (kStackFrameExtraParamSlot + 2) * kSystemPointerSize));

    // FunctionCallbackInfo::length_.
    __ stw(argc, MemOperand(sp, (kStackFrameExtraParamSlot + 3) * kSystemPointerSize));
...
void Builtins::Generate_CallApiGetter(MacroAssembler* masm)
{
    ...
    __ LoadU64(api_function_address, FieldMemOperand(callback, AccessorInfo::kMaybeRedirectedGetterOffset), r0);
