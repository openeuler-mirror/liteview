...
// bool HeapObject::IsJSDateTimeFormat() const
// {
//   DebugBreak();
//   return false;
// }
...
V8_WARN_UNUSED_RESULT Object DateTimeFormatRange(BuiltinArguments args, Isolate* isolate, const char* const method_name)
{
...
Handle<JSFunction> CreateBoundFunction(Isolate* isolate, Handle<JSObject> object, Builtin builtin, int len)
{
    ...
    Handle<SharedFunctionInfo> info = isolate->factory()->NewSharedFunctionInfoForBuiltin(isolate->factory()->empty_string(), builtin, FunctionKind::kNormalFunction);
 ...
 */
template <class T>
Object LegacyFormatConstructor(BuiltinArguments args, Isolate* isolate, v8::Isolate::UseCounterFeature feature, Handle<Object> constructor, const char* method_name)
{
 ...
 * Segmenter
 */
template <class T> Object DisallowCallConstructor(BuiltinArguments args, Isolate* isolate, v8::Isolate::UseCounterFeature feature, const char* method_name)
{
    isolate->CountUsage(feature);
 ...
 */
template <class T> Object CallOrConstructConstructor(BuiltinArguments args, Isolate* isolate, const char* method_name)
{
    Handle<JSReceiver> new_target;
...
BUILTIN(NumberFormatPrototypeFormatNumber)
{
    ...
    Handle<JSFunction> new_bound_format_function = CreateBoundFunction(isolate, number_format, Builtin::kNumberFormatInternalFormatNumber, 1);
...
BUILTIN(NumberFormatInternalFormatNumber)
{
    ...
    Handle<JSNumberFormat> number_format = Handle<JSNumberFormat>(JSNumberFormat::cast(context->get(static_cast<int>(Intl::BoundFunctionContextSlot::kBoundFunction))), isolate);
...
template <class T, MaybeHandle<T> (*F)(Isolate*, Handle<JSNumberFormat>, Handle<Object>, Handle<Object>)>
V8_WARN_UNUSED_RESULT Object NumberFormatRange(BuiltinArguments args, Isolate* isolate, const char* const method_name)
{
...
BUILTIN(DateTimeFormatPrototypeFormat)
{
    ...
    Handle<JSFunction> new_bound_format_function = CreateBoundFunction(isolate, format, Builtin::kDateTimeFormatInternalFormat, 1);
...
BUILTIN(DateTimeFormatInternalFormat)
{
    ...
    // internal slot.
    Handle<JSDateTimeFormat> date_format_holder
        = Handle<JSDateTimeFormat>(JSDateTimeFormat::cast(context->get(static_cast<int>(Intl::BoundFunctionContextSlot::kBoundFunction))), isolate);
...
BUILTIN(LocalePrototypeNumberingSystems)
{
    ...
    RETURN_RESULT_OR_FAILURE(isolate, JSLocale::NumberingSystems(isolate, locale));
}
...
BUILTIN(RelativeTimeFormatSupportedLocalesOf)
{
    ...
    RETURN_RESULT_OR_FAILURE(
        isolate, Intl::SupportedLocalesOf(isolate, "Intl.RelativeTimeFormat.supportedLocalesOf", JSRelativeTimeFormat::GetAvailableLocales(), locales, options));
}
...
BUILTIN(StringPrototypeToLocaleLowerCase)
{
    ...
    RETURN_RESULT_OR_FAILURE(isolate, Intl::StringLocaleConvertCase(isolate, string, false, args.atOrUndefined(isolate, 1)));
}
...
BUILTIN(StringPrototypeToLocaleUpperCase)
{
    ...
    RETURN_RESULT_OR_FAILURE(isolate, Intl::StringLocaleConvertCase(isolate, string, true, args.atOrUndefined(isolate, 1)));
}
...
BUILTIN(PluralRulesPrototypeSelectRange)
{
    ...
    RETURN_RESULT_OR_FAILURE(isolate, JSPluralRules::ResolvePluralRange(isolate, plural_rules, x->Number(), y->Number()));
}
...
BUILTIN(PluralRulesSupportedLocalesOf)
{
    ...
    RETURN_RESULT_OR_FAILURE(isolate, Intl::SupportedLocalesOf(isolate, "Intl.PluralRules.supportedLocalesOf", JSPluralRules::GetAvailableLocales(), locales, options));
}
...
BUILTIN(CollatorSupportedLocalesOf)
{
    ...
    RETURN_RESULT_OR_FAILURE(isolate, Intl::SupportedLocalesOf(isolate, "Intl.Collator.supportedLocalesOf", JSCollator::GetAvailableLocales(), locales, options));
}
...
BUILTIN(CollatorPrototypeCompare)
{
    ...
    Handle<JSFunction> new_bound_compare_function = CreateBoundFunction(isolate, collator, Builtin::kCollatorInternalCompare, 2);
...
BUILTIN(CollatorInternalCompare)
{
    ...
    Handle<JSCollator> collator = Handle<JSCollator>(JSCollator::cast(context->get(static_cast<int>(Intl::BoundFunctionContextSlot::kBoundFunction))), isolate);
...
BUILTIN(SegmenterSupportedLocalesOf)
{
    ...
    RETURN_RESULT_OR_FAILURE(isolate, Intl::SupportedLocalesOf(isolate, "Intl.Segmenter.supportedLocalesOf", JSSegmenter::GetAvailableLocales(), locales, options));
}
...
BUILTIN(SegmentsPrototypeIterator)
{
    ...
    HandleScope scope(isolate);
    CHECK_RECEIVER(JSSegments, segments, method_name);
    RETURN_RESULT_OR_FAILURE(isolate, JSSegmentIterator::Create(isolate, segments->icu_break_iterator().raw(), segments->granularity()));
}
...
BUILTIN(V8BreakIteratorPrototypeAdoptText)
{
    ...
    Handle<JSFunction> new_bound_adopt_text_function = CreateBoundFunction(isolate, break_iterator, Builtin::kV8BreakIteratorInternalAdoptText, 1);
...
BUILTIN(V8BreakIteratorPrototypeFirst)
{
    ...
    Handle<JSFunction> new_bound_first_function = CreateBoundFunction(isolate, break_iterator, Builtin::kV8BreakIteratorInternalFirst, 0);
...
BUILTIN(V8BreakIteratorPrototypeNext)
{
    ...
    Handle<JSFunction> new_bound_next_function = CreateBoundFunction(isolate, break_iterator, Builtin::kV8BreakIteratorInternalNext, 0);
...
BUILTIN(V8BreakIteratorPrototypeCurrent)
{
    ...
    Handle<JSFunction> new_bound_current_function = CreateBoundFunction(isolate, break_iterator, Builtin::kV8BreakIteratorInternalCurrent, 0);
...
BUILTIN(V8BreakIteratorPrototypeBreakType)
{
    ...
    Handle<JSFunction> new_bound_break_type_function = CreateBoundFunction(isolate, break_iterator, Builtin::kV8BreakIteratorInternalBreakType, 0);
