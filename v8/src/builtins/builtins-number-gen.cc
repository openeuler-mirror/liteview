...
#define DEF_BINOP(Name, Generator)                                                                                                                                                 \
    ...
    {                                                                                                                                                                              \
        ...
        TNode<Object> result = binop_asm.Generator([&]() { return context; }, lhs, rhs, slot, [&]() { return feedback_vector; }, UpdateFeedbackMode::kGuaranteedFeedback, false);  \
                                                                                                                                                                                   \
        Return(result);                                                                                                                                                            \
    }
...
#define DEF_BINOP(Name, Generator)                                                                                                                                                 \
    ...
    {                                                                                                                                                                              \
        ...
        TNode<Object> result = binop_asm.Generator(                                                                                                                                \
            [&]() { return LoadContextFromBaseline(); }, lhs, rhs, slot, [&]() { return LoadFeedbackVectorFromBaseline(); }, UpdateFeedbackMode::kGuaranteedFeedback, false);      \
                                                                                                                                                                                   \
        Return(result);                                                                                                                                                            \
    }
...
#define DEF_BINOP_RHS_SMI(Name, Generator)                                                                                                                                         \
    ...
    {                                                                                                                                                                              \
        ...
        BinaryOpAssembler binop_asm(state());                                                                                                                                      \
        TNode<Object> result = binop_asm.Generator(                                                                                                                                \
            [&]() { return LoadContextFromBaseline(); }, lhs, rhs, slot, [&]() { return LoadFeedbackVectorFromBaseline(); }, UpdateFeedbackMode::kGuaranteedFeedback, true);       \
                                                                                                                                                                                   \
        Return(result);                                                                                                                                                            \
    }
...
#define DEF_COMPARE(Name)                                                                                                                                                          \
    ...
    {                                                                                                                                                                              \
        ...
        TNode<Oddball> result = RelationalComparison(Operation::k##Name, lhs, rhs, context, &var_type_feedback);                                                                   \
