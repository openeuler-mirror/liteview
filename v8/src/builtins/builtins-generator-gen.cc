...
protected:
    ...
    void InnerResume(CodeStubArguments* args, TNode<JSGeneratorObject> receiver, TNode<Object> value, TNode<Context> context, JSGeneratorObject::ResumeMode resume_mode,
        char const* const method_name);
    void GeneratorPrototypeResume(
        CodeStubArguments* args, TNode<Object> receiver, TNode<Object> value, TNode<Context> context, JSGeneratorObject::ResumeMode resume_mode, char const* const method_name);
};
    ...
    JSGeneratorObject::ResumeMode resume_mode, char const* const method_name)
{
    ...
    TNode<Object> result;
    {
        ...
        result = CallStub(CodeFactory::ResumeGenerator(isolate()), context, value, receiver);
    }
...
TF_BUILTIN(SuspendGeneratorBaseline, GeneratorBuiltinsAssembler)
{
    ...
    CSA_DCHECK(this, Word32BinaryNot(IsSharedFunctionInfoDontAdaptArguments(sfi)));
    TNode<IntPtrT> formal_parameter_count = Signed(ChangeUint32ToWord(LoadSharedFunctionInfoFormalParameterCountWithoutReceiver(sfi)));

    TNode<FixedArray> parameters_and_registers = LoadJSGeneratorObjectParametersAndRegisters(generator);
    auto parameters_and_registers_length = SmiUntag(LoadFixedArrayBaseLength(parameters_and_registers));
    ...
    CSA_CHECK(this, UintPtrLessThan(formal_parameter_count, parameters_and_registers_length));
    ...
    auto register_base_index = IntPtrAdd(formal_parameter_count, IntPtrConstant(interpreter::Register(0).ToOperand()));
