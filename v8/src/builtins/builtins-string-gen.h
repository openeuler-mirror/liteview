...
public:
    ...
    void StringEqual_Core(TNode<String> lhs, TNode<Word32T> lhs_instance_type, TNode<String> rhs, TNode<Word32T> rhs_instance_type, TNode<IntPtrT> length, Label* if_equal,
    ...
    TNode<String> SubString(TNode<String> string, TNode<UintPtrT> from, TNode<UintPtrT> to) { return SubString(string, Signed(from), Signed(to)); }
...
protected:
    void StringEqual_Loop(TNode<String> lhs, TNode<Word32T> lhs_instance_type, MachineType lhs_type, TNode<String> rhs, TNode<Word32T> rhs_instance_type, MachineType rhs_type,
    ...
    TNode<IntPtrT> CallSearchStringRaw(const TNode<RawPtrT> subject_ptr, const TNode<IntPtrT> subject_length, const TNode<RawPtrT> search_ptr, const TNode<IntPtrT> search_length,
        const TNode<IntPtrT> start_position);

    void GenerateStringEqual(TNode<String> left, TNode<String> right);
    void GenerateStringRelationalComparison(TNode<String> left, TNode<String> right, Operation op);

    using StringAtAccessor = std::function<TNode<Object>(TNode<String> receiver, TNode<IntPtrT> length, TNode<IntPtrT> index)>;
    ...
    TNode<BoolT> SmiIsNegative(TNode<Smi> value) { return SmiLessThan(value, SmiConstant(0)); }
...
private:
    template <typename T> TNode<String> AllocAndCopyStringCharacters(TNode<T> from, TNode<Int32T> from_instance_type, TNode<IntPtrT> from_index, TNode<IntPtrT> character_count);
};
