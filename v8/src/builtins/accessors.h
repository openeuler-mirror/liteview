...
#define ACCESSOR_GETTER_DECLARATION(accessor_name) static void accessor_name(v8::Local<v8::Name> name, const v8::PropertyCallbackInfo<v8::Value>& info);
    ACCESSOR_GETTER_LIST(ACCESSOR_GETTER_DECLARATION)
#undef ACCESSOR_GETTER_DECLARATION

#define ACCESSOR_SETTER_DECLARATION(accessor_name)                                                                                                                                 \
    static void accessor_name(v8::Local<v8::Name> name, v8::Local<v8::Value> value, const v8::PropertyCallbackInfo<v8::Boolean>& info);
...
#undef COUNT_ACCESSOR
    ...
    static MaybeHandle<Object> ReplaceAccessorWithDataProperty(Isolate* isolate, Handle<Object> receiver, Handle<JSObject> holder, Handle<Name> name, Handle<Object> value);
    ...
    V8_EXPORT_PRIVATE static Handle<AccessorInfo> MakeAccessor(Isolate* isolate, Handle<Name> name, AccessorNameGetterCallback getter, AccessorNameBooleanSetterCallback setter);
