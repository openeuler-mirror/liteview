...
#define TEMPORAL_PROTOTYPE_METHOD3(T, METHOD, name)                                                                                                                                \
    ...
    {                                                                                                                                                                              \
        HandleScope scope(isolate);                                                                                                                                                \
        CHECK_RECEIVER(JSTemporal##T, obj, "Temporal." #T ".prototype." #name);                                                                                                    \
        RETURN_RESULT_OR_FAILURE(isolate, JSTemporal##T ::METHOD(isolate, obj, args.atOrUndefined(isolate, 1), args.atOrUndefined(isolate, 2), args.atOrUndefined(isolate, 3)));   \
    }
...
#define TEMPORAL_GET_NUMBER_AFTER_DIVID(T, M, field, scale, name)                                                                                                                  \
    ...
    {                                                                                                                                                                              \
        ...
        Handle<BigInt> value;                                                                                                                                                      \
        ASSIGN_RETURN_FAILURE_ON_EXCEPTION(isolate, value, BigInt::Divide(isolate, Handle<BigInt>(handle->field(), isolate), BigInt::FromUint64(isolate, scale)));                 \
...
#define TEMPORAL_ZONED_DATE_TIME_GET_PREPARE(M)                                                                                                                                    \
    ...
    ASSIGN_RETURN_FAILURE_ON_EXCEPTION(isolate, temporal_date_time, temporal::BuiltinTimeZoneGetPlainDateTimeFor(isolate, time_zone, instant, calendar, method_name));
...
{
    HandleScope scope(isolate);
    RETURN_RESULT_OR_FAILURE(isolate, JSTemporalDuration::Compare(isolate, args.atOrUndefined(isolate, 1), args.atOrUndefined(isolate, 2), args.atOrUndefined(isolate, 3)));
}
