...
BUILTIN(CallAsyncModuleFulfilled)
{
    ...
    Handle<SourceTextModule> module = Handle<SourceTextModule>(SourceTextModule::cast(isolate->context().get(SourceTextModule::ExecuteAsyncModuleContextSlots::kModule)), isolate);
