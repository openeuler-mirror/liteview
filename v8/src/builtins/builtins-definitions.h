...
#define BUILTIN_LIST_BASE_TIER1(CPP, TFJ, TFC, TFS, TFH, ASM)                                                                                                                      \
    ...
    TFS(ArrayIncludesSmiOrObject, kElements, kSearchElement, kLength, kFromIndex)                                                                                                  \
    TFS(ArrayIncludesPackedDoubles, kElements, kSearchElement, kLength, kFromIndex)                                                                                                \
    TFS(ArrayIncludesHoleyDoubles, kElements, kSearchElement, kLength, kFromIndex)                                                                                                 \
    ...
    TFS(ArrayIndexOfPackedDoubles, kElements, kSearchElement, kLength, kFromIndex)                                                                                                 \
    TFS(ArrayIndexOfHoleyDoubles, kElements, kSearchElement, kLength, kFromIndex)                                                                                                  \
    ...
    TFS(FlatMapIntoArray, kTarget, kSource, kSourceLength, kStart, kDepth, kMapperFunction, kThisArg)                                                                              \
    ...
    TFJ(AtomicsCompareExchange, kJSArgcReceiverSlots + 4, kReceiver, kArray, kIndex, kOldValue, kNewValue)                                                                         \
    ...
    ASM(CEntry_Return1_DontSaveFPRegs_ArgvOnStack_BuiltinExit, CEntry1ArgvOnStack)                                                                                                 \
...
#define BUILTIN_LIST_C(V) BUILTIN_LIST(V, IGNORE_BUILTIN, IGNORE_BUILTIN, IGNORE_BUILTIN, IGNORE_BUILTIN, IGNORE_BUILTIN, IGNORE_BUILTIN)

#define BUILTIN_LIST_A(V) BUILTIN_LIST(IGNORE_BUILTIN, IGNORE_BUILTIN, IGNORE_BUILTIN, IGNORE_BUILTIN, IGNORE_BUILTIN, IGNORE_BUILTIN, V)

#define BUILTIN_LIST_TFS(V) BUILTIN_LIST(IGNORE_BUILTIN, IGNORE_BUILTIN, IGNORE_BUILTIN, V, IGNORE_BUILTIN, IGNORE_BUILTIN, IGNORE_BUILTIN)

#define BUILTIN_LIST_TFJ(V) BUILTIN_LIST(IGNORE_BUILTIN, V, IGNORE_BUILTIN, IGNORE_BUILTIN, IGNORE_BUILTIN, IGNORE_BUILTIN, IGNORE_BUILTIN)

#define BUILTIN_LIST_TFC(V) BUILTIN_LIST(IGNORE_BUILTIN, IGNORE_BUILTIN, V, IGNORE_BUILTIN, IGNORE_BUILTIN, IGNORE_BUILTIN, IGNORE_BUILTIN)
