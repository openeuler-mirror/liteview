...
struct ParsedISO8601Result {
    ...
    bool time_nanosecond_is_undefined() const { return time_nanosecond == kMinInt31; }
    ...
    bool tzuo_nanosecond_is_undefined() const { return tzuo_nanosecond == kMinInt31; }
};
...
public:
#define DEFINE_PARSE_METHOD(R, NAME) V8_WARN_UNUSED_RESULT static base::Optional<R> Parse##NAME(Isolate* isolate, Handle<String> iso_string)
