...
V8_INLINE Address GetIsolateRootAddress(Address on_heap_addr) { return V8HeapCompressionScheme::GetPtrComprCageBaseAddress(on_heap_addr); }

V8_INLINE Address GetIsolateRootAddress(PtrComprCageBase cage_base) { return cage_base.address(); }

#else

V8_INLINE Address GetIsolateRootAddress(Address on_heap_addr) { UNREACHABLE(); }

V8_INLINE Address GetIsolateRootAddress(PtrComprCageBase cage_base) { UNREACHABLE(); }
...
#elif defined(V8_COMPRESS_POINTERS_IN_ISOLATE_CAGE) && !defined(V8_EXTERNAL_CODE_SPACE)
    Isolate* isolate = Isolate::FromRootAddress(GetIsolateRootAddress(object.ptr()));
