...
double ArmDebugger::GetRegisterPairDoubleValue(int regnum) { return sim_->get_double_from_register_pair(regnum); }

double ArmDebugger::GetVFPDoubleRegisterValue(int regnum) { return sim_->get_double_from_d_register(regnum).get_scalar(); }
        ...
        if (argc == 2 || (argc == 3 && strcmp(arg2, "fp") == 0)) {
            ...
            if (strcmp(arg1, "all") == 0) {
                ...
                for (int i = 0; i < DwVfpRegister::SupportedRegisterCount(); i++) {
                    ...
                    PrintF("%3s: %f 0x%08x %08x\n", VFPRegisters::Name(i, true), dvalue, static_cast<uint32_t>(as_words >> 32), static_cast<uint32_t>(as_words & 0xFFFFFFFF));
                }
            } else {
...
void Simulator::SetRedirectInstruction(Instruction* instruction) { instruction->SetInstructionBits(al | (0xF * B24) | kCallRtRedirected); }
...
bool Simulator::has_bad_pc() const { return ((registers_[pc] == bad_lr) || (registers_[pc] == end_sim_pc)); }
...
using SimulatorRuntimeCall = int64_t (*)(int32_t arg0, int32_t arg1, int32_t arg2, int32_t arg3, int32_t arg4, int32_t arg5, int32_t arg6, int32_t arg7, int32_t arg8, int32_t arg9,
...
using SimulatorRuntimeProfilingGetterCall = void (*)(int32_t arg0, int32_t arg1, void* arg2);
...
int64_t UnsafeGenericFunctionCall(intptr_t function, int32_t arg0, int32_t arg1, int32_t arg2, int32_t arg3, int32_t arg4, int32_t arg5, int32_t arg6, int32_t arg7, int32_t arg8,
    int32_t arg9, int32_t arg10, int32_t arg11, int32_t arg12, int32_t arg13, int32_t arg14, int32_t arg15, int32_t arg16, int32_t arg17, int32_t arg18, int32_t arg19)
{
...
void Simulator::SoftwareInterrupt(Instruction* instr)
{
    ...
    case kCallRtRedirected: {
        ...
        if (fp_call) {
            ...
            if (v8_flags.trace_sim || !stack_aligned) {
                PrintF("Call to host function at %p args %08x %08x %08x", reinterpret_cast<void*>(external), arg0, arg1, arg2);
                if (!stack_aligned) {
                    PrintF(" with unaligned stack %08x\n", get_register(sp));
                }
                PrintF("\n");
            ...
            if (v8_flags.trace_sim || !stack_aligned) {
                PrintF("Call to host function at %p "
                       ...
                       "%08x",
                    reinterpret_cast<void*>(external), arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13, arg14, arg15, arg16, arg17, arg18,
                    arg19);
                if (!stack_aligned) {
                    PrintF(" with unaligned stack %08x\n", get_register(sp));
                }
...
void Simulator::DecodeType6(Instruction* instr) { DecodeType6CoprocessorIns(instr); }
...
template <typename T> void AddSat(Simulator* simulator, int Vd, int Vm, int Vn) { Binop<T>(simulator, Vd, Vm, Vn, SaturateAdd<T>); }

template <typename T> void SubSat(Simulator* simulator, int Vd, int Vm, int Vn) { Binop<T>(simulator, Vd, Vm, Vn, SaturateSub<T>); }
...
template <typename T, int SIZE> void Add(Simulator* simulator, int Vd, int Vm, int Vn) { Binop<T>(simulator, Vd, Vm, Vn, std::plus<T>()); }

template <typename T, int SIZE> void Sub(Simulator* simulator, int Vd, int Vm, int Vn) { Binop<T>(simulator, Vd, Vm, Vn, std::minus<T>()); }
...
float MinMax(float a, float b, bool is_min) { return is_min ? JSMin(a, b) : JSMax(a, b); }
template <typename T> T MinMax(T a, T b, bool is_min) { return is_min ? std::min(a, b) : std::max(a, b); }
