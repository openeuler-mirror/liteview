...
public:
    static inline uintptr_t JsLimitFromCLimit(v8::internal::Isolate* isolate, uintptr_t c_limit) { return Simulator::current(isolate)->StackLimit(c_limit); }
    ...
    static inline void UnregisterJSStackComparableAddress(v8::internal::Isolate* isolate) { Simulator::current(isolate)->PopAddress(); }
};
...
public:
    ...
    static inline void UnregisterJSStackComparableAddress(v8::internal::Isolate* isolate) { USE(isolate); }
};
...
public:
    ...
    static GeneratedCode FromAddress(Isolate* isolate, Address addr) { return GeneratedCode(isolate, reinterpret_cast<Signature*>(addr)); }

    static GeneratedCode FromBuffer(Isolate* isolate, byte* buffer) { return GeneratedCode(isolate, reinterpret_cast<Signature*>(buffer)); }

    template <typename CodeOrCodeT> static GeneratedCode FromCode(CodeOrCodeT code) { return FromAddress(code.GetIsolate(), code.entry()); }
    ...
    Return Call(Args... args)
    {
        ...
        FATAL("Generated code execution not possible during cross-compilation."
              "Also, generic C function calls are not implemented on 32-bit arm yet.");
#endif // defined(V8_TARGET_OS_WIN) && !defined(V8_OS_WIN) && !defined(V8_OS_STARBOARD) && !defined(V8_TARGET_ARCH_ARM)
