...
intptr_t PPCDebugger::GetRegisterValue(int regnum) { return sim_->get_register(regnum); }

double PPCDebugger::GetRegisterPairDoubleValue(int regnum) { return sim_->get_double_from_register_pair(regnum); }

double PPCDebugger::GetFPDoubleRegisterValue(int regnum) { return sim_->get_double_from_d_register(regnum); }
...
void Simulator::SetRedirectInstruction(Instruction* instruction) { instruction->SetInstructionBits(rtCallRedirInstr | kCallRtRedirected); }
...
bool Simulator::has_bad_pc() const { return ((special_reg_pc_ == bad_lr) || (special_reg_pc_ == end_sim_pc)); }
...
void Simulator::SetFpResult(const double& result) { set_d_register_from_double(1, result); }
...
#define GENERATE_RW_FUNC(size, type)                                                                                                                                               \
    ...
    void Simulator::Write##size(uintptr_t addr, type value) { Write(addr, value); }                                                                                                \
    int32_t Simulator::WriteEx##size(uintptr_t addr, type value) { return WriteEx(addr, value); }
...
using SimulatorRuntimeCall = intptr_t (*)(intptr_t arg0, intptr_t arg1, intptr_t arg2, intptr_t arg3, intptr_t arg4, intptr_t arg5, intptr_t arg6, intptr_t arg7, intptr_t arg8,
    intptr_t arg9, intptr_t arg10, intptr_t arg11, intptr_t arg12, intptr_t arg13, intptr_t arg14, intptr_t arg15, intptr_t arg16, intptr_t arg17, intptr_t arg18, intptr_t arg19);
using SimulatorRuntimePairCall
    = ObjectPair (*)(intptr_t arg0, intptr_t arg1, intptr_t arg2, intptr_t arg3, intptr_t arg4, intptr_t arg5, intptr_t arg6, intptr_t arg7, intptr_t arg8, intptr_t arg9,
        intptr_t arg10, intptr_t arg11, intptr_t arg12, intptr_t arg13, intptr_t arg14, intptr_t arg15, intptr_t arg16, intptr_t arg17, intptr_t arg18, intptr_t arg19);
...
using SimulatorRuntimeProfilingGetterCall = void (*)(intptr_t arg0, intptr_t arg1, void* arg2);
...
void Simulator::SoftwareInterrupt(Instruction* instr)
{
    ...
    case kCallRtRedirected: {
        ...
        if (fp_call) {
            ...
            if (v8_flags.trace_sim || !stack_aligned) {
                PrintF("Call to host function at %p args %08" V8PRIxPTR " %08" V8PRIxPTR " %08" V8PRIxPTR, reinterpret_cast<void*>(external), arg[0], arg[1], arg[2]);
                if (!stack_aligned) {
                    PrintF(" with unaligned stack %08" V8PRIxPTR "\n", get_register(sp));
                }
                PrintF("\n");
            ...
            if (v8_flags.trace_sim || !stack_aligned) {
                ...
                PrintF("Call to host function at %p,\n"
                       "\t\t\t\targs %08" V8PRIxPTR ", %08" V8PRIxPTR ", %08" V8PRIxPTR ", %08" V8PRIxPTR ", %08" V8PRIxPTR ", %08" V8PRIxPTR ", %08" V8PRIxPTR ", %08" V8PRIxPTR
                       ", %08" V8PRIxPTR ", %08" V8PRIxPTR ", %08" V8PRIxPTR ", %08" V8PRIxPTR ", %08" V8PRIxPTR ", %08" V8PRIxPTR ", %08" V8PRIxPTR ", %08" V8PRIxPTR
                       ", %08" V8PRIxPTR ", %08" V8PRIxPTR ", %08" V8PRIxPTR ", %08" V8PRIxPTR,
                    reinterpret_cast<void*>(FUNCTION_ADDR(target)), arg[0], arg[1], arg[2], arg[3], arg[4], arg[5], arg[6], arg[7], arg[8], arg[9], arg[10], arg[11], arg[12],
            ...
            if (redirection->type() == ExternalReference::BUILTIN_CALL_PAIR) {
                ...
                ObjectPair result = target(arg[0], arg[1], arg[2], arg[3], arg[4], arg[5], arg[6], arg[7], arg[8], arg[9], arg[10], arg[11], arg[12], arg[13], arg[14], arg[15],
                ...
                SimulatorRuntimeCall target = reinterpret_cast<SimulatorRuntimeCall>(external);
                intptr_t result = target(arg[0], arg[1], arg[2], arg[3], arg[4], arg[5], arg[6], arg[7], arg[8], arg[9], arg[10], arg[11], arg[12], arg[13], arg[14], arg[15],
                    arg[16], arg[17], arg[18], arg[19]);
                if (v8_flags.trace_sim) {
...
bool Simulator::isStopInstruction(Instruction* instr) { return (instr->Bits(27, 24) == 0xF) && (instr->SvcValue() >= kStopCode); }
...
void Simulator::ExecuteGeneric(Instruction* instr)
{
    ...
    case PLOAD_STORE_MLS: {
        ...
        Instruction* next_instr = base::bit_cast<Instruction*>(get_pc() + kInstrSize);
...
#define VSPLT(type)                                                                                                                                                                \
    ...
    case XXSPLTIB: {
        ...
        int t = instr->RTValue();
        FOR_EACH_LANE(i, int8_t) { set_simd_register_by_lane<int8_t>(t, i, imm8); }
        break;
    }
#undef VSPLT
#define VSPLTI(type)                                                                                                                                                               \
...
#define VECTOR_ARITHMETIC_OP(type, op)                                                                                                                                             \
    DECODE_VX_INSTRUCTION(t, a, b, T)                                                                                                                                              \
    FOR_EACH_LANE(i, type) { set_simd_register_by_lane<type>(t, i, get_simd_register_by_lane<type>(a, i) op get_simd_register_by_lane<type>(b, i)); }
    case XVADDDP: {
...
#define VECTOR_SHIFT_OP(type, op, mask)                                                                                                                                            \
    DECODE_VX_INSTRUCTION(t, a, b, T)                                                                                                                                              \
    FOR_EACH_LANE(i, type) { set_simd_register_by_lane<type>(t, i, get_simd_register_by_lane<type>(a, i) op(get_simd_register_by_lane<type>(b, i) & mask)); }
    case VSLD: {
...
#define VECTOR_UNPACK(S, D, if_high_side)                                                                                                                                          \
    ...
    FOR_EACH_LANE(i, D) { temps[i] = get_simd_register_by_lane<S>(b, i, if_high_side); }                                                                                           \
    FOR_EACH_LANE(i, D) { set_simd_register_by_lane<D>(t, i, temps[i], if_high_side); }
    case VUPKHSB: {
...
#undef VECTOR_FP_ROUNDING
    ...
    case VPERM: {
        ...
        FOR_EACH_LANE(i, int8_t) { set_simd_register_by_lane<int8_t>(vrt, i, temp[i]); }
        break;
    }
    case VBPERMQ: {
        DECODE_VX_INSTRUCTION(t, a, b, T)
...
#define VECTOR_UNARY_OP(type, op)                                                                                                                                                  \
    int t = instr->RTValue();                                                                                                                                                      \
    int b = instr->RBValue();                                                                                                                                                      \
    FOR_EACH_LANE(i, type) { set_simd_register_by_lane<type>(t, i, op(get_simd_register_by_lane<type>(b, i))); }
    case XVABSDP: {
...
#undef VECTOR_ROUNDING_AVERAGE
    case VPOPCNTB: {
        int t = instr->RTValue();
        int b = instr->RBValue();
        FOR_EACH_LANE(i, uint8_t) { set_simd_register_by_lane<uint8_t>(t, i, base::bits::CountPopulation(get_simd_register_by_lane<uint8_t>(b, i))); }
        break;
    }
