...
#define DEFINE_FRAME_SIZES(parent, count)                                                                                                                                          \
    ...
    static constexpr int kFixedSlotCountFromFp = kFixedFrameSizeFromFp / kSystemPointerSize;                                                                                       \
    static constexpr int kExtraSlotCount = kFixedFrameSize / kSystemPointerSize - parent::kFixedFrameSize / kSystemPointerSize
...
public:
    ...
    static constexpr int kNumExtraArgsWithReceiver = kNumExtraArgsWithoutReceiver + 1;
};
...
public:
    ...
    static constexpr int kBytecodeOffsetOrFeedbackVectorFromFp = STANDARD_FRAME_EXTRA_PUSHED_VALUE_OFFSET(1);
...
public:
    static constexpr int kBytecodeOffsetExpressionIndex = kBytecodeOffsetOrFeedbackVectorExpressionIndex;

    static constexpr int kBytecodeOffsetFromFp = kBytecodeOffsetOrFeedbackVectorFromFp;
};
...
public:
    static constexpr int kFeedbackVectorExpressionIndex = kBytecodeOffsetOrFeedbackVectorExpressionIndex;

    static constexpr int kFeedbackVectorFromFp = kBytecodeOffsetOrFeedbackVectorFromFp;
};

inline static int FPOffsetToFrameSlot(int frame_offset) { return StandardFrameConstants::kFixedSlotCountAboveFp - 1 - frame_offset / kSystemPointerSize; }

inline static int FrameSlotToFPOffset(int slot) { return (StandardFrameConstants::kFixedSlotCountAboveFp - 1 - slot) * kSystemPointerSize; }
