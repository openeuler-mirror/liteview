...
{
    return HandleScopeImplementer::ArchiveSpacePerThread() + Isolate::ArchiveSpacePerThread() + Debug::ArchiveSpacePerThread() + StackGuard::ArchiveSpacePerThread()
        + RegExpStack::ArchiveSpacePerThread() + Bootstrapper::ArchiveSpacePerThread() + Relocatable::ArchiveSpacePerThread();
}
...
void ThreadState::AllocateSpace() { data_ = NewArray<char>(ArchiveSpacePerThread()); }
...
ThreadState* ThreadManager::FirstThreadStateInUse() { return in_use_anchor_->Next(); }
