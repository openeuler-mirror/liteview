...
// static
Address SimulatorBase::UnwrapRedirection(Address redirection_trampoline) { return reinterpret_cast<Address>(Redirection::UnwrapRedirection(redirection_trampoline)); }
