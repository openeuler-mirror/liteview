...
public:
    ...
    bool ShouldPerfomCheckpoint() const { return !IsRunningMicrotasks() && !GetMicrotasksScopeDepth() && !HasMicrotasksSuppressions(); }
    ...
    bool HasMicrotasksSuppressions() const { return microtasks_suppressions_ != 0; }
    ...
    bool DebugMicrotasksScopeDepthIsZero() const { return debug_microtasks_depth_ == 0; }
#endif

    void set_microtasks_policy(v8::MicrotasksPolicy microtasks_policy) { microtasks_policy_ = microtasks_policy; }
