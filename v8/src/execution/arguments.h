...
public:
    ...
    public:
        inline ChangeValueScope(Isolate* isolate, Arguments* args, int index, Object value);
    ...
    V8_INLINE Object operator[](int index) const { return Object(*address_of_arg_at(index)); }
...
#define RUNTIME_FUNCTION(Name) RUNTIME_FUNCTION_RETURNS_TYPE(Address, Object, BUILTIN_CONVERT_RESULT, Name)
