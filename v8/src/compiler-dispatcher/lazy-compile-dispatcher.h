...
private:
    ...
    struct Job {
        ...
        bool is_running_on_background() const { return state == State::kRunning || state == State::kAbortRequested; }
    ...
    Job* GetJobFor(Handle<SharedFunctionInfo> shared, const base::MutexGuard&) const;
