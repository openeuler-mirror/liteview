...
public:
    ...
    bool operator==(const Digits& other) const { return digits_ == other.digits_ && len_ == other.len_; }
...
inline int AddResultLength(int x_length, int y_length) { return std::max(x_length, y_length) + 1; }
inline int AddSignedResultLength(int x_length, int y_length, bool same_sign) { return same_sign ? AddResultLength(x_length, y_length) : std::max(x_length, y_length); }
inline int SubtractResultLength(int x_length, int y_length) { return x_length; }
inline int SubtractSignedResultLength(int x_length, int y_length, bool same_sign) { return same_sign ? std::max(x_length, y_length) : AddResultLength(x_length, y_length); }
inline int MultiplyResultLength(Digits X, Digits Y) { return X.len() + Y.len(); }
...
inline int BitwiseAnd_PosPos_ResultLength(int x_length, int y_length) { return std::min(x_length, y_length); }
...
inline int BitwiseOrResultLength(int x_length, int y_length) { return std::max(x_length, y_length); }
inline int BitwiseXor_PosPos_ResultLength(int x_length, int y_length) { return std::max(x_length, y_length); }
inline int BitwiseXor_NegNeg_ResultLength(int x_length, int y_length) { return std::max(x_length, y_length); }
...
inline int LeftShift_ResultLength(int x_length, digit_t x_most_significant_digit, digit_t shift)
{
    int digit_shift = static_cast<int>(shift / kDigitBits);
    int bits_shift = static_cast<int>(shift % kDigitBits);
    bool grow = bits_shift != 0 && (x_most_significant_digit >> (kDigitBits - bits_shift)) != 0;
...
inline int AsUintN_Neg_ResultLength(int n) { return ((n - 1) / kDigitBits) + 1; }
...
public:
    ...
    int ResultLength() { return std::max(stack_parts_used_, static_cast<int>(heap_parts_.size())); }
