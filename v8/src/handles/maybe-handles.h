...
public:
    ...
    V8_INLINE Address address() const { return reinterpret_cast<Address>(location_); }
...
private:
    inline MaybeObjectHandle(Object object, HeapObjectReferenceType reference_type, Isolate* isolate);
...
template <typename T> class DirectMaybeHandle final {
public:
    ...
    template <typename S> V8_WARN_UNUSED_RESULT V8_INLINE bool ToDirectHandle(DirectHandle<S>* out) const
    {
