...
namespace {
enum class V8StartupState { kIdle, kPlatformInitializing, kPlatformInitialized, kV8Initializing, kV8Initialized, kV8Disposing, kV8Disposed, kPlatformDisposing, kPlatformDisposed };
...
void AdvanceStartupState(V8StartupState expected_next_state)
{
    ...
    if (next_state != expected_next_state) {
        ...
        FATAL("Wrong initialization order: got %d expected %d!", static_cast<int>(current_state), static_cast<int>(next_state));
    }
...
void V8::Initialize()
{
    ...
    FlagValue<bool>* log_all_flags[] = { &v8_flags.log_all, &v8_flags.log_code, &v8_flags.log_code_disassemble, &v8_flags.log_source_code, &v8_flags.log_source_position,
        &v8_flags.log_feedback_vector, &v8_flags.log_function_events, &v8_flags.log_internal_timer_events, &v8_flags.log_deopt, &v8_flags.log_ic, &v8_flags.log_maps };
    if (v8_flags.log_all) {
        ...
        v8_flags.log = v8_flags.log || v8_flags.perf_prof || v8_flags.perf_basic_prof || v8_flags.ll_prof || v8_flags.prof || v8_flags.prof_cpp || v8_flags.gdbjit;
    }
...
void V8::SetPlatformForTesting(v8::Platform* platform) { base::Relaxed_Store(reinterpret_cast<base::AtomicWord*>(&platform_), reinterpret_cast<base::AtomicWord>(platform)); }
...
// static
double Platform::SystemClockTimeMillis() { return base::OS::TimeCurrentMillis(); }
} // namespace v8
