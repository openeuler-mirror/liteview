...
RegExpBytecodeGenerator::IrregexpImplementation RegExpBytecodeGenerator::Implementation() { return kBytecodeImplementation; }
...
void RegExpBytecodeGenerator::Copy(byte* a) { MemCopy(a, buffer_.data(), length()); }
