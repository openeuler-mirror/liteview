...
#define MAKE_ACCEPT(Name)                                                                                                                                                          \
    void* RegExp##Name::Accept(RegExpVisitor* visitor, void* data) { return visitor->Visit##Name(this, data); }
...
Interval RegExpLookaround::CaptureRegisters() { return body()->CaptureRegisters(); }
...
bool RegExpAssertion::IsAnchoredAtStart() { return assertion_type() == RegExpAssertion::Type::START_OF_INPUT; }

bool RegExpAssertion::IsAnchoredAtEnd() { return assertion_type() == RegExpAssertion::Type::END_OF_INPUT; }
...
bool RegExpLookaround::IsAnchoredAtStart() { return is_positive() && type() == LOOKAHEAD && body()->IsAnchoredAtStart(); }
