...
int RegExpMacroAssemblerX64::stack_limit_slack() { return RegExpStack::kStackLimitSlack; }
...
void RegExpMacroAssemblerX64::CheckNotBackReferenceIgnoreCase(int start_reg, bool read_backward, bool unicode, Label* on_no_match)
{
    ...
    if (mode_ == LATIN1) {
...

        {
            ...
            ExternalReference compare = unicode ? ExternalReference::re_case_insensitive_compare_unicode() : ExternalReference::re_case_insensitive_compare_non_unicode();
...
void RegExpMacroAssemblerX64::CheckBitInTable(Handle<ByteArray> table, Label* on_bit_set)
{
    ...
    __ cmpb(FieldOperand(rax, index, times_1, ByteArray::kHeaderSize), Immediate(0));
...
Handle<HeapObject> RegExpMacroAssemblerX64::GetCode(Handle<String> source)
{
    ...
    PROFILE(isolate, RegExpCodeCreateEvent(Handle<AbstractCode>::cast(code), source));
...
RegExpMacroAssembler::IrregexpImplementation RegExpMacroAssemblerX64::Implementation() { return kX64Implementation; }
...
void RegExpMacroAssemblerX64::PushCurrentPosition() { Push(rdi); }
...
void RegExpMacroAssemblerX64::ReadCurrentPositionFromRegister(int reg) { __ movq(rdi, register_location(reg)); }

void RegExpMacroAssemblerX64::ReadPositionFromRegister(Register dst, int reg) { __ movq(dst, register_location(reg)); }
...
int RegExpMacroAssemblerX64::CheckStackGuardState(Address* return_address, Address raw_code, Address re_frame)
{
...
void RegExpMacroAssemblerX64::BranchOrBacktrack(Condition condition, Label* to) { __ j(condition, to ? to : &backtrack_label_); }
...
void RegExpMacroAssemblerX64::FixupCodeRelativePositions()
{
    for (int position : code_relative_fixup_positions_) {
        ...
        masm_.long_at_put(patch_position, offset + position + Code::kHeaderSize - kHeapObjectTag);
    }
...
void RegExpMacroAssemblerX64::Drop() { __ addq(backtrack_stackpointer(), Immediate(kIntSize)); }
