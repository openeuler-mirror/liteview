...
public:
    ...
    static inline CharacterRange Singleton(base::uc32 value) { return CharacterRange(value, value); }
    ...
    static inline CharacterRange Everything() { return CharacterRange(0, kMaxCodePoint); }
    ...
    V8_EXPORT_PRIVATE static void AddClassEscape(StandardCharacterSet standard_character_set, ZoneList<CharacterRange>* ranges, bool add_unicode_case_equivalents, Zone* zone);
...
inline bool operator==(const CharacterRange& lhs, const CharacterRange& rhs) { return lhs.from() == rhs.from() && lhs.to() == rhs.to(); }
inline bool operator!=(const CharacterRange& lhs, const CharacterRange& rhs) { return !operator==(lhs, rhs); }
...
public:
    ...
    StandardCharacterSet standard_set_type() const { return standard_set_type_.value(); }
    void set_standard_set_type(StandardCharacterSet standard_set_type) { standard_set_type_ = standard_set_type; }
...
public:
    ...
    // returns true.
    StandardCharacterSet standard_type() const { return set_.standard_set_type(); }

    CharacterSet character_set() const { return set_; }
    ZoneList<CharacterRange>* ranges(Zone* zone) { return set_.ranges(zone); }

    bool is_negated() const { return (class_ranges_flags_ & NEGATED) != 0; }
    bool contains_split_surrogate() const { return (class_ranges_flags_ & CONTAINS_SPLIT_SURROGATE) != 0; }
...
public:
    ...
    RegExpClassSetExpression(OperationType op, bool is_negated, ZoneList<RegExpTree*>* operands)
        : operation_(op)
...
private:
    ...
    static void ComputeCharacterRanges(RegExpTree* root, ZoneList<CharacterRange>* result_ranges, ZoneList<CharacterRange>* temp_ranges, Zone* zone);
