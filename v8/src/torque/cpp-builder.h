...
public:
    ...
    std::vector<TemplateParameter> GetTemplateParameters() const { return template_parameters_; }
...
#undef ACCESSOR
    ...
    void SetReturnType(std::string return_type) { return_type_ = std::move(return_type); }
