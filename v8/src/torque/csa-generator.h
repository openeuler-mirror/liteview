...
public:
    CSAGenerator(const ControlFlowGraph& cfg, std::ostream& out, base::Optional<Builtin::Kind> linkage = base::nullopt)
...
private:
    ...
    std::string PreCallableExceptionPreparation(base::Optional<Block*> catch_block);
    void PostCallableExceptionPreparation(const std::string& catch_name, const Type* return_type, base::Optional<Block*> catch_block, Stack<std::string>* stack,
