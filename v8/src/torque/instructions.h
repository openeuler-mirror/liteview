...
public:
    ...
    static DefinitionLocation Parameter(std::size_t index) { return DefinitionLocation(Kind::kParameter, nullptr, index); }

    static DefinitionLocation Phi(const Block* block, std::size_t index) { return DefinitionLocation(Kind::kPhi, block, index); }

    static DefinitionLocation Instruction(const InstructionBase* instruction, std::size_t index = 0) { return DefinitionLocation(Kind::kInstruction, instruction, index); }
    ...
    bool IsPhiFromBlock(const Block* block) const { return IsPhi() && GetPhiBlock() == block; }
    ...
    bool operator!=(const DefinitionLocation& other) const { return !operator==(other); }
...
public:
    ...
    template <class T> bool Is() const { return kind_ == T::kKind; }
...
#undef ENUM_ITEM
    ...
    void TypeInstruction(Stack<const Type*>* stack, ControlFlowGraph* cfg) const { return instruction_->TypeInstruction(stack, cfg); }
    void RecomputeDefinitionLocations(Stack<DefinitionLocation>* locations, Worklist<Block*>* worklist) const { instruction_->RecomputeDefinitionLocations(locations, worklist); }
...
inline std::ostream& operator<<(std::ostream& os, const DeleteRangeInstruction& instruction) { return os << "DeleteRange " << instruction.range; }
...
inline std::ostream& operator<<(std::ostream& os, const PushUninitializedInstruction& instruction) { return os << "PushUninitialized " << *instruction.type; }
...
inline std::ostream& operator<<(std::ostream& os, const LoadReferenceInstruction& instruction) { return os << "LoadReference " << *instruction.type; }
...
inline std::ostream& operator<<(std::ostream& os, const StoreReferenceInstruction& instruction) { return os << "StoreReference " << *instruction.type; }
...
struct CallCsaMacroAndBranchInstruction : InstructionBase {
    TORQUE_INSTRUCTION_BOILERPLATE()
    CallCsaMacroAndBranchInstruction(Macro* macro, std::vector<std::string> constexpr_arguments, base::Optional<Block*> return_continuation, std::vector<Block*> label_blocks,
        base::Optional<Block*> catch_block)
        : macro(macro)
        , constexpr_arguments(constexpr_arguments)
...
struct CallBuiltinInstruction : InstructionBase {
    ...
    CallBuiltinInstruction(bool is_tailcall, Builtin* builtin, size_t argc, base::Optional<Block*> catch_block)
...
struct CallRuntimeInstruction : InstructionBase {
    ...
    CallRuntimeInstruction(bool is_tailcall, RuntimeFunction* runtime_function, size_t argc, base::Optional<Block*> catch_block)
        : is_tailcall(is_tailcall)
...
struct GotoInstruction : InstructionBase {
    TORQUE_INSTRUCTION_BOILERPLATE()
    bool IsBlockTerminator() const override { return true; }
    void AppendSuccessorBlocks(std::vector<Block*>* block_list) const override { block_list->push_back(destination); }
...
inline std::ostream& operator<<(std::ostream& os, const ReturnInstruction& instruction) { return os << "Return count: " << instruction.count; }
...
inline std::ostream& operator<<(std::ostream& os, const PrintConstantStringInstruction& instruction)
{
...
inline std::ostream& operator<<(std::ostream& os, const UnsafeCastInstruction& instruction) { return os << "UnsafeCast " << *instruction.destination_type; }
