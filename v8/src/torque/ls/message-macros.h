...
#define JSON_STRING_ACCESSORS(name)                                                                                                                                                \
    inline const std::string& name() const { return object().at(#name).ToString(); }                                                                                               \
    inline void set_##name(const std::string& str) { object()[#name] = JsonValue::From(str); }                                                                                     \
    inline bool has_##name() const { return object().find(#name) != object().end(); }
...
#define JSON_INT_ACCESSORS(name)                                                                                                                                                   \
    ...
    inline void set_##name(int n) { object()[#name] = JsonValue::From(static_cast<double>(n)); }
...
#define JSON_DYNAMIC_OBJECT_ACCESSORS(name)                                                                                                                                        \
    template <class T> inline T name() { return GetObject<T>(#name); }
