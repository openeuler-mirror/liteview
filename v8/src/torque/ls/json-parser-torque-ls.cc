...
template <bool value> base::Optional<ParseResult> MakeBoolLiteral(ParseResultIterator* child_results) { return ParseResult { JsonValue::From(value) }; }

base::Optional<ParseResult> MakeNullLiteral(ParseResultIterator* child_results)
{
    JsonValue result;
...
base::Optional<ParseResult> MakeNumberLiteral(ParseResultIterator* child_results)
{
...
base::Optional<ParseResult> MakeStringLiteral(ParseResultIterator* child_results)
{
