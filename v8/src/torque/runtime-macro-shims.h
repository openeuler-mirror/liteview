...
template <typename Smi> inline int32_t SmiUntag(Smi s) { return s.value(); }
...
inline int32_t ConstexprIntegerLiteralToInt32(const IntegerLiteral& i) { return i.To<int32_t>(); }
inline int31_t ConstexprIntegerLiteralToInt31(const IntegerLiteral& i) { return int31_t(ConstexprIntegerLiteralToInt32(i)); }
inline intptr_t ConstexprIntegerLiteralToIntptr(const IntegerLiteral& i) { return i.To<intptr_t>(); }
