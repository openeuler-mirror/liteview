...
#define ALLOCATABLE_DOUBLE_REGISTERS(V)                                                                                                                                            \
    V(d0)                                                                                                                                                                          \
    V(d1) V(d2) V(d3) V(d4) V(d5) V(d6) V(d7) V(d8) V(d9) V(d10) V(d11) V(d12) V(d16) V(d17) V(d18) V(d19) V(d20) V(d21) V(d22) V(d23) V(d24) V(d25) V(d26) V(d27) V(d28) V(d29)   \
        V(d30) V(d31)
...
public:
    ...
    SwVfpRegister high() const { return SwVfpRegister::from_code(code() * 2 + 1); }
    VfpRegList ToVfpRegList() const
    {
        // A D register overlaps two S registers.
        return uint64_t { 0x3 } << (code() * 2);
...
public:
    ...
    DwVfpRegister high() const { return DwVfpRegister::from_code(code() * 2 + 1); }
    VfpRegList ToVfpRegList() const
    {
