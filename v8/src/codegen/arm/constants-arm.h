...
inline NeonSize NeonDataTypeToSize(NeonDataType dt) { return static_cast<NeonSize>(NeonSz(dt)); }
...
#define DECLARE_STATIC_ACCESSOR(Name) DECLARE_STATIC_TYPED_ACCESSOR(int, Name)
    ...
    inline Condition ConditionField() const { return static_cast<Condition>(BitField(31, 28)); }
    ...
    inline Opcode OpcodeField() const { return static_cast<Opcode>(BitField(24, 21)); }
    inline int SValue() const { return Bit(20); }
    // with register
    inline int RmValue() const { return Bits(3, 0); }
    DECLARE_STATIC_ACCESSOR(RmValue)
    inline int ShiftValue() const { return static_cast<ShiftOp>(Bits(6, 5)); }
    inline ShiftOp ShiftField() const { return static_cast<ShiftOp>(BitField(6, 5)); }
    ...
    inline int SImmed24Value() const { return signed_bitextract_32(23, 0, InstructionBits()); }
    ...
    inline SoftwareInterruptCodes SvcValue() const { return static_cast<SoftwareInterruptCodes>(Bits(23, 0)); }
    ...
    inline bool IsMiscType0() const { return (Bit(24) == 1) && (Bit(23) == 0) && (Bit(20) == 0) && ((Bit(7) == 0)); }

    // Test for nop-like instructions which fall under type 1.
    inline bool IsNopLikeType1() const { return Bits(24, 8) == 0x120F0; }

    // Test for a stop instruction.
    inline bool IsStop() const { return (TypeValue() == 7) && (Bit(24) == 1) && (SvcValue() >= kStopCode); }
    ...
    static Instruction* At(Address pc) { return reinterpret_cast<Instruction*>(pc); }
