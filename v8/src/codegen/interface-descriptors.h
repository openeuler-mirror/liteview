...
public:
    ...
    void InitializeRegisters(Flags flags, int return_count, int parameter_count, StackArgumentOrder stack_order, int register_parameter_count, const Register* registers);
    ...
    bool IsInitialized() const { return IsInitializedRegisters() && IsInitializedTypes(); }
...
private:
    ...
    {
        const bool initialized = return_count_ != kUninitializedCount && param_count_ != kUninitializedCount && (register_param_count_ == 0 || register_params_ != nullptr);
...
#undef DEF_ENUM
    ...
    static CallInterfaceDescriptorData* call_descriptor_data(CallDescriptors::Key key) { return &call_descriptor_data_[key]; }
...
public:
    ...
    bool HasContextParameter() const { return (flags() & CallInterfaceDescriptorData::kNoContext) == 0; }

    bool AllowVarArgs() const { return flags() & CallInterfaceDescriptorData::kAllowVarArgs; }

    bool CalleeSaveRegisters() const { return flags() & CallInterfaceDescriptorData::kCalleeSaveRegisters; }
    ...
    int GetRegisterParameterCount() const { return data()->register_param_count(); }

    int GetStackParameterCount() const { return data()->param_count() - data()->register_param_count(); }
    ...
    RegList allocatable_registers() const { return data()->allocatable_registers(); }

    StackArgumentOrder GetStackArgumentOrder() const { return data()->stack_order(); }

    static constexpr inline Register ContextRegister() { return kContextRegister; }

    const char* DebugName() const;

    bool operator==(const CallInterfaceDescriptor& other) const { return data() == other.data(); }
...
public:
    ...
    static constexpr inline bool AllowVarArgs() { return DerivedDescriptor::kAllowVarArgs; }
    static constexpr inline bool HasContextParameter() { return !DerivedDescriptor::kNoContext; }
...
private:
    ...
    static void InitializeTypes(CallInterfaceDescriptorData* data) { data->InitializeTypes(nullptr, 0); }
};
...
#define DEFINE_RESULT_AND_PARAMETER_TYPES(...)                                                                                                                                     \
    ...
    {                                                                                                                                                                              \
        ...
        static_assert(kReturnCount + kParameterCount == arraysize(machine_types), "Parameter names definition is not consistent with parameter types");                            \
...
class CopyDataPropertiesWithExcludedPropertiesOnStackDescriptor : public StaticCallInterfaceDescriptor<CopyDataPropertiesWithExcludedPropertiesOnStackDescriptor> {
public:
...
class ConstructWithArrayLike_WithFeedbackDescriptor : public StaticCallInterfaceDescriptor<ConstructWithArrayLike_WithFeedbackDescriptor> {
public:
...
class ApiCallbackDescriptor : public StaticCallInterfaceDescriptor<ApiCallbackDescriptor> {
public:
    DEFINE_PARAMETERS_VARARGS(kApiFunctionAddress, kActualArgumentsCount, kCallData, kHolder)
...
class WasmFloat64ToNumberDescriptor final : public StaticCallInterfaceDescriptor<WasmFloat64ToNumberDescriptor> {
public:
    DEFINE_PARAMETERS_NO_CONTEXT(kValue)
    DEFINE_RESULT_AND_PARAMETER_TYPES(MachineType::AnyTagged(), // result
...
class WasmI32AtomicWait32Descriptor final : public StaticCallInterfaceDescriptor<WasmI32AtomicWait32Descriptor> {
public:
    DEFINE_PARAMETERS_NO_CONTEXT(kAddress, kExpectedValue, kTimeoutLow, kTimeoutHigh)
    DEFINE_RESULT_AND_PARAMETER_TYPES(MachineType::Uint32(), // result 1
...
class WasmI64AtomicWait32Descriptor final : public StaticCallInterfaceDescriptor<WasmI64AtomicWait32Descriptor> {
public:
    DEFINE_PARAMETERS_NO_CONTEXT(kAddress, kExpectedValueLow, kExpectedValueHigh, kTimeoutLow, kTimeoutHigh)
