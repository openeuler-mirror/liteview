...
public:
    ...
    // flushed.
    static void PreparedForOptimization(Isolate* isolate, Handle<JSFunction> function, bool allow_heuristic_optimization);
    ...
    static void MarkedForOptimization(Isolate* isolate, Handle<JSFunction> function);
    ...
    static void FunctionWasOptimized(Isolate* isolate, Handle<JSFunction> function);
    ...
    static bool IsHeuristicOptimizationAllowed(Isolate* isolate, JSFunction function);
};
