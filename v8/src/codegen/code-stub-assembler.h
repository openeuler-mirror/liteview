...
#define HEAP_MUTABLE_IMMOVABLE_OBJECT_LIST(V)                                                                                                                                      \
    ...
    V(AsyncFunctionAwaitRejectSharedFun, async_function_await_reject_shared_fun, AsyncFunctionAwaitRejectSharedFun)                                                                \
    V(AsyncFunctionAwaitResolveSharedFun, async_function_await_resolve_shared_fun, AsyncFunctionAwaitResolveSharedFun)                                                             \
    V(AsyncGeneratorAwaitRejectSharedFun, async_generator_await_reject_shared_fun, AsyncGeneratorAwaitRejectSharedFun)                                                             \
    V(AsyncGeneratorAwaitResolveSharedFun, async_generator_await_resolve_shared_fun, AsyncGeneratorAwaitResolveSharedFun)                                                          \
    V(AsyncGeneratorReturnClosedRejectSharedFun, async_generator_return_closed_reject_shared_fun, AsyncGeneratorReturnClosedRejectSharedFun)                                       \
    ...
    V(AsyncGeneratorReturnResolveSharedFun, async_generator_return_resolve_shared_fun, AsyncGeneratorReturnResolveSharedFun)                                                       \
    V(AsyncGeneratorYieldWithAwaitResolveSharedFun, async_generator_yield_with_await_resolve_shared_fun, AsyncGeneratorYieldWithAwaitResolveSharedFun)                             \
    V(AsyncIteratorValueUnwrapSharedFun, async_iterator_value_unwrap_shared_fun, AsyncIteratorValueUnwrapSharedFun)                                                                \
    ...
    V(PromiseAllResolveElementSharedFun, promise_all_resolve_element_shared_fun, PromiseAllResolveElementSharedFun)                                                                \
    V(PromiseAllSettledRejectElementSharedFun, promise_all_settled_reject_element_shared_fun, PromiseAllSettledRejectElementSharedFun)                                             \
    V(PromiseAllSettledResolveElementSharedFun, promise_all_settled_resolve_element_shared_fun, PromiseAllSettledResolveElementSharedFun)                                          \
    V(PromiseAnyRejectElementSharedFun, promise_any_reject_element_shared_fun, PromiseAnyRejectElementSharedFun)                                                                   \
    V(PromiseCapabilityDefaultRejectSharedFun, promise_capability_default_reject_shared_fun, PromiseCapabilityDefaultRejectSharedFun)                                              \
    V(PromiseCapabilityDefaultResolveSharedFun, promise_capability_default_resolve_shared_fun, PromiseCapabilityDefaultResolveSharedFun)                                           \
    V(PromiseCatchFinallySharedFun, promise_catch_finally_shared_fun, PromiseCatchFinallySharedFun)                                                                                \
    V(PromiseGetCapabilitiesExecutorSharedFun, promise_get_capabilities_executor_shared_fun, PromiseGetCapabilitiesExecutorSharedFun)                                              \
    ...
    V(PromiseThenFinallySharedFun, promise_then_finally_shared_fun, PromiseThenFinallySharedFun)                                                                                   \
    V(PromiseThenProtector, promise_then_protector, PromiseThenProtector)                                                                                                          \
    V(PromiseThrowerFinallySharedFun, promise_thrower_finally_shared_fun, PromiseThrowerFinallySharedFun)                                                                          \
    V(PromiseValueThunkFinallySharedFun, promise_value_thunk_finally_shared_fun, PromiseValueThunkFinallySharedFun)                                                                \
    ...
    V(ShadowRealmImportValueFulfilledSFI, shadow_realm_import_value_fulfilled_sfi, ShadowRealmImportValueFulfilledSFI)                                                             \
...
#ifdef DEBUG
#define CSA_CHECK(csa, x) (csa)->Check([&]() -> TNode<BoolT> { return x; }, #x, __FILE__, __LINE__)
#else
...
#define CSA_DCHECK_1_ARG(a, ...)                                                                                                                                                   \
    {                                                                                                                                                                              \
        {                                                                                                                                                                          \
            a, #a                                                                                                                                                                  \
        }                                                                                                                                                                          \
    }
#define CSA_DCHECK_2_ARGS(a, b, ...)                                                                                                                                               \
    {                                                                                                                                                                              \
        { a, #a }, { b, #b }                                                                                                                                                       \
    }
// clang-format on
#define SWITCH_CSA_DCHECK_ARGS(dummy, a, b, FUNC, ...) FUNC(a, b)
#define CSA_DCHECK_ARGS(...) CALL(SWITCH_CSA_DCHECK_ARGS, (, ##__VA_ARGS__, CSA_DCHECK_2_ARGS, CSA_DCHECK_1_ARG, CSA_DCHECK_0_ARGS))
// Workaround for MSVC to skip comma in empty __VA_ARGS__.
#define CALL(x, y) x y

// CSA_DCHECK(csa, <condition>, <extra values to print...>)

#define CSA_DCHECK(csa, condition_node, ...) (csa)->Dcheck(condition_node, #condition_node, __FILE__, __LINE__, CSA_DCHECK_ARGS(__VA_ARGS__))
...
#define CSA_DCHECK_JS_ARGC_OP(csa, Op, op, expected)                                                                                                                               \
    (csa)->Dcheck(                                                                                                                                                                 \
        [&]() -> TNode<BoolT> {                                                                                                                                                    \
            const TNode<Word32T> argc = (csa)->UncheckedParameter<Word32T>(Descriptor::kJSActualArgumentsCount);                                                                   \
            return (csa)->Op(argc, (csa)->Int32Constant(i::JSParameterCount(expected)));                                                                                           \
        },                                                                                                                                                                         \
        "argc " #op " " #expected, __FILE__, __LINE__, { { SmiFromInt32((csa)->UncheckedParameter<Int32T>(Descriptor::kJSActualArgumentsCount)), "argc" } })

#define CSA_DCHECK_JS_ARGC_EQ(csa, expected) CSA_DCHECK_JS_ARGC_OP(csa, Word32Equal, ==, expected)
...
#define TYPED_VARIABLE_DEF(type, name, ...) TVariable<type> name(CSA_DEBUG_INFO(name), __VA_ARGS__)
#define TYPED_VARIABLE_CONSTRUCTOR(name, ...) name(CSA_DEBUG_INFO(name), __VA_ARGS__)
#else // DEBUG
...
#define TVARIABLE_CONSTRUCTOR(...) EXPAND(TYPED_VARIABLE_CONSTRUCTOR(__VA_ARGS__, this))
...
public:
    ...
    TNode<IntPtrT> ParameterToIntPtr(TNode<UintPtrT> value) { return Signed(value); }
    ...
    TNode<IntPtrT> BIntToIntPtr(TNode<BInt> source) { return SmiToIntPtr(source); }
    TNode<BInt> SmiToBInt(TNode<Smi> source) { return source; }
    TNode<BInt> IntPtrToBInt(TNode<IntPtrT> source) { return SmiFromIntPtr(source); }
...
#error Unknown architecture.
    ...
    TNode<Uint16T> Uint16Constant(uint16_t t) { return UncheckedCast<Uint16T>(Int32Constant(t)); }
    ...
    template <typename T> TNode<T> RunLazy(LazyNode<T> lazy) { return lazy(); }

#define PARAMETER_BINOP(OpName, IntPtrOpName, SmiOpName)                                                                                                                           \
    TNode<Smi> OpName(TNode<Smi> a, TNode<Smi> b) { return SmiOpName(a, b); }                                                                                                      \
    TNode<IntPtrT> OpName(TNode<IntPtrT> a, TNode<IntPtrT> b) { return IntPtrOpName(a, b); }                                                                                       \
    TNode<UintPtrT> OpName(TNode<UintPtrT> a, TNode<UintPtrT> b) { return Unsigned(IntPtrOpName(Signed(a), Signed(b))); }                                                          \
    TNode<RawPtrT> OpName(TNode<RawPtrT> a, TNode<RawPtrT> b) { return ReinterpretCast<RawPtrT>(IntPtrOpName(ReinterpretCast<IntPtrT>(a), ReinterpretCast<IntPtrT>(b))); }
...
#define PARAMETER_BINOP(OpName, IntPtrOpName, SmiOpName)                                                                                                                           \
    ...
    TNode<BoolT> OpName(TNode<IntPtrT> a, TNode<IntPtrT> b) { return IntPtrOpName(a, b); }                                                                                         \
    TNode<BoolT> OpName(TNode<UintPtrT> a, TNode<UintPtrT> b) { return IntPtrOpName(Signed(a), Signed(b)); }                                                                       \
    TNode<BoolT> OpName(TNode<RawPtrT> a, TNode<RawPtrT> b) { return IntPtrOpName(a, b); }
    // TODO(v8:9708): Define BInt operations once all uses are ported.
...
#undef PARAMETER_BINOP
    ...
    TNode<BoolT> TaggedNotEqual(TNode<AnyTaggedT> a, TNode<AnyTaggedT> b) { return Word32BinaryNot(TaggedEqual(a, b)); }

    TNode<Smi> NoContextConstant();

#define HEAP_CONSTANT_ACCESSOR(rootIndexName, rootAccessorName, name)                                                                                                              \
    TNode<std::remove_pointer<std::remove_reference<decltype(std::declval<ReadOnlyRoots>().rootAccessorName())>::type>::type> name##Constant();
    HEAP_IMMUTABLE_IMMOVABLE_OBJECT_LIST(HEAP_CONSTANT_ACCESSOR)
#undef HEAP_CONSTANT_ACCESSOR

#define HEAP_CONSTANT_ACCESSOR(rootIndexName, rootAccessorName, name)                                                                                                              \
    TNode<std::remove_pointer<std::remove_reference<decltype(std::declval<Heap>().rootAccessorName())>::type>::type> name##Constant();
    ...
    {                                                                                                                                                                              \
        if (SmiValuesAre32Bits()) {                                                                                                                                                \
            ...
            return BitcastWordToTaggedSigned(                                                                                                                                      \
                ChangeInt32ToIntPtr(Int32OpName(TruncateIntPtrToInt32(BitcastTaggedToWordForTagAndSmiBits(a)), TruncateIntPtrToInt32(BitcastTaggedToWordForTagAndSmiBits(b)))));   \
        }                                                                                                                                                                          \
    }
...
#undef SMI_ARITHMETIC_BINOP
    ...
    {
        TNode<Smi> result = BitcastWordToTaggedSigned(WordShl(BitcastTaggedToWordForTagAndSmiBits(a), shift));
    ...
    TNode<Smi> SmiShr(TNode<Smi> a, int shift)
    {
        ...
        if (kTaggedSize == kInt64Size) {
            result = BitcastWordToTaggedSigned(WordAnd(WordShr(BitcastTaggedToWordForTagAndSmiBits(a), shift), BitcastTaggedToWordForTagAndSmiBits(SmiConstant(-1))));
        } else {
            ...
            result = BitcastWordToTaggedSigned(
                WordAnd(ChangeInt32ToIntPtr(Word32Shr(TruncateWordToInt32(BitcastTaggedToWordForTagAndSmiBits(a)), shift)), BitcastTaggedToWordForTagAndSmiBits(SmiConstant(-1))));
        }
        // Smi shift have different result to int32 shift when the inputs are not
        // strictly limited. The CSA_DCHECK is to ensure valid inputs.
    ...
    TNode<Smi> SmiSar(TNode<Smi> a, int shift)
    {
        ...
        DCHECK_LT(shift, 32);
        if (kTaggedSize == kInt64Size) {
            return BitcastWordToTaggedSigned(WordAnd(WordSar(BitcastTaggedToWordForTagAndSmiBits(a), shift), BitcastTaggedToWordForTagAndSmiBits(SmiConstant(-1))));
        } else {
            // For pointer compressed Smis, we want to make sure that we truncate to
            // int32 before shifting, to avoid the values of the top 32-bits from
            // changing the sign bit of the smi.
            return BitcastWordToTaggedSigned(
                WordAnd(ChangeInt32ToIntPtr(Word32Sar(TruncateWordToInt32(BitcastTaggedToWordForTagAndSmiBits(a)), shift)), BitcastTaggedToWordForTagAndSmiBits(SmiConstant(-1))));
        }
    }

    TNode<Smi> WordOrSmiShr(TNode<Smi> a, int shift) { return SmiShr(a, shift); }

    TNode<IntPtrT> WordOrSmiShr(TNode<IntPtrT> a, int shift) { return WordShr(a, shift); }
...
#define BINT_COMPARISON_OP(BIntOpName, SmiOpName, IntPtrOpName)                                                                                                                    \
    TNode<BoolT> BIntOpName(TNode<BInt> a, TNode<BInt> b) { return SmiOpName(a, b); }
#else
#define BINT_COMPARISON_OP(BIntOpName, SmiOpName, IntPtrOpName)                                                                                                                    \
    TNode<BoolT> BIntOpName(TNode<BInt> a, TNode<BInt> b) { return IntPtrOpName(a, b); }
#endif
...
#undef BINT_COMPARISON_OP
    ...
    TNode<BoolT> IsCodeTMap(TNode<Map> map) { return V8_EXTERNAL_CODE_SPACE_BOOL ? IsCodeDataContainerMap(map) : IsCodeMap(map); }
    TNode<BoolT> IsCodeT(TNode<HeapObject> object) { return IsCodeTMap(LoadMap(object)); }
...
#error "This code requires updating for big-endian architectures"
        ...
        static_assert(CodeDataContainer::kCodeCageBaseUpper32BitsOffset == CodeDataContainer::kCodeOffset + kTaggedSize);
        TNode<Object> o = BitcastWordToTagged(Load<RawPtrT>(code, IntPtrConstant(CodeDataContainer::kCodeOffset - kHeapObjectTag)));
        return CAST(o);
#else
        return code;
#endif
    ...
    TNode<CodeDataContainer> CodeDataContainerFromCodeT(TNode<CodeT> code)
    {
        ...
        return code;
#else
        return LoadObjectField<CodeDataContainer>(code, Code::kCodeDataContainerOffset);
#endif
    }
    ...
    TNode<CodeT> ToCodeT(TNode<Code> code, TNode<CodeDataContainer> code_data_container)
    {
#ifdef V8_EXTERNAL_CODE_SPACE
    ...
    template <class... TArgs> TNode<Object> Call(TNode<Context> context, TNode<Object> callable, TNode<JSReceiver> receiver, TArgs... args)
    {
        return CallJS(CodeFactory::Call(isolate(), ConvertReceiverMode::kNotNullOrUndefined), context, callable, receiver, args...);
    }
    template <class... TArgs> TNode<Object> Call(TNode<Context> context, TNode<Object> callable, TNode<Object> receiver, TArgs... args)
    {
        if (IsUndefinedConstant(receiver) || IsNullConstant(receiver)) {
            return CallJS(CodeFactory::Call(isolate(), ConvertReceiverMode::kNullOrUndefined), context, callable, receiver, args...);
        }
        return CallJS(CodeFactory::Call(isolate()), context, callable, receiver, args...);
    }

    TNode<Object> CallApiCallback(TNode<Object> context, TNode<RawPtrT> callback, TNode<IntPtrT> argc, TNode<Object> data, TNode<Object> holder, TNode<Object> receiver);
    ...
    template <class... TArgs> TNode<JSReceiver> ConstructWithTarget(TNode<Context> context, TNode<JSReceiver> target, TNode<JSReceiver> new_target, TArgs... args)
    {
        return CAST(ConstructJSWithTarget(CodeFactory::Construct(isolate()), context, target, new_target, implicit_cast<TNode<Object>>(args)...));
    }
    ...
    TNode<Smi> SelectSmiConstant(TNode<BoolT> condition, Smi true_value, Smi false_value);
    TNode<Smi> SelectSmiConstant(TNode<BoolT> condition, int true_value, Smi false_value) { return SelectSmiConstant(condition, Smi::FromInt(true_value), false_value); }
    TNode<Smi> SelectSmiConstant(TNode<BoolT> condition, Smi true_value, int false_value) { return SelectSmiConstant(condition, true_value, Smi::FromInt(false_value)); }
    ...
    TNode<String> SingleCharacterStringConstant(char const* single_char)
    {
        ...
        return HeapConstant(isolate()->factory()->LookupSingleCharacterStringFromCode(single_char[0]));
    }
    ...
    template <class... T> void Bind(compiler::CodeAssemblerParameterizedLabel<T...>* label, TNode<T>*... phis) { CodeAssembler::Bind(label, phis...); }

    void BranchIfSmiEqual(TNode<Smi> a, TNode<Smi> b, Label* if_true, Label* if_false) { Branch(SmiEqual(a, b), if_true, if_false); }

    void BranchIfSmiLessThan(TNode<Smi> a, TNode<Smi> b, Label* if_true, Label* if_false) { Branch(SmiLessThan(a, b), if_true, if_false); }

    void BranchIfSmiLessThanOrEqual(TNode<Smi> a, TNode<Smi> b, Label* if_true, Label* if_false) { Branch(SmiLessThanOrEqual(a, b), if_true, if_false); }

    void BranchIfFloat64IsNaN(TNode<Float64T> value, Label* if_true, Label* if_false) { Branch(Float64Equal(value, value), if_false, if_true); }
    ...
    void BranchIfToBooleanIsFalse(TNode<Object> value, Label* if_false, Label* if_true) { BranchIfToBooleanIsTrue(value, if_true, if_false); }
    ...
    TNode<RawPtrT> LoadSandboxedPointerFromObject(TNode<HeapObject> object, int offset) { return LoadSandboxedPointerFromObject(object, IntPtrConstant(offset)); }
    ...
    void StoreSandboxedPointerToObject(TNode<HeapObject> object, int offset, TNode<RawPtrT> pointer) { StoreSandboxedPointerToObject(object, IntPtrConstant(offset), pointer); }
    ...
    TNode<UintPtrT> LoadBoundedSizeFromObject(TNode<HeapObject> object, int offset) { return LoadBoundedSizeFromObject(object, IntPtrConstant(offset)); }
    ...
    void StoreBoundedSizeToObject(TNode<HeapObject> object, int offset, TNode<UintPtrT> value) { StoreBoundedSizeToObject(object, IntPtrConstant(offset), value); }
    ...
    TNode<RawPtrT> LoadForeignForeignAddressPtr(TNode<Foreign> object) { return LoadExternalPointerFromObject(object, Foreign::kForeignAddressOffset, kForeignForeignAddressTag); }

    TNode<RawPtrT> LoadCallHandlerInfoJsCallbackPtr(TNode<CallHandlerInfo> object)
    {
        return LoadExternalPointerFromObject(object, CallHandlerInfo::kMaybeRedirectedCallbackOffset, kCallHandlerInfoCallbackTag);
    }

    TNode<RawPtrT> LoadExternalStringResourcePtr(TNode<ExternalString> object)
    {
        return LoadExternalPointerFromObject(object, ExternalString::kResourceOffset, kExternalStringResourceTag);
    }
    ...
    TNode<RawPtrT> LoadExternalStringResourceDataPtr(TNode<ExternalString> object)
    {
        ...
        CSA_DCHECK(this, Word32NotEqual(Word32And(LoadInstanceType(object), Int32Constant(kUncachedExternalStringMask)), Int32Constant(kUncachedExternalStringTag)));
        return LoadExternalPointerFromObject(object, ExternalString::kResourceDataOffset, kExternalStringResourceDataTag);
    }

#if V8_ENABLE_WEBASSEMBLY
    TNode<RawPtrT> LoadWasmInternalFunctionCallTargetPtr(TNode<WasmInternalFunction> object)
    {
        return LoadExternalPointerFromObject(object, WasmInternalFunction::kCallTargetOffset, kWasmInternalFunctionCallTargetTag);
    }
    ...
    TNode<RawPtrT> LoadJSTypedArrayExternalPointerPtr(TNode<JSTypedArray> holder) { return LoadSandboxedPointerFromObject(holder, JSTypedArray::kExternalPointerOffset); }
    ...
    TNode<Object> LoadBufferObject(TNode<RawPtrT> buffer, int offset) { return LoadFullTagged(buffer, IntPtrConstant(offset)); }
    template <typename T> TNode<T> LoadBufferData(TNode<RawPtrT> buffer, int offset) { return UncheckedCast<T>(Load(MachineTypeOf<T>::value, buffer, IntPtrConstant(offset))); }
    TNode<RawPtrT> LoadBufferPointer(TNode<RawPtrT> buffer, int offset) { return LoadBufferData<RawPtrT>(buffer, offset); }
    TNode<Smi> LoadBufferSmi(TNode<RawPtrT> buffer, int offset) { return CAST(LoadBufferObject(buffer, offset)); }
    TNode<IntPtrT> LoadBufferIntptr(TNode<RawPtrT> buffer, int offset) { return LoadBufferData<IntPtrT>(buffer, offset); }
    ...
    {
        const MachineType machine_type = offset == HeapObject::kMapOffset ? MachineType::MapInHeader() : MachineTypeOf<T>::value;
        return CAST(LoadFromObject(machine_type, object, IntPtrConstant(offset - kHeapObjectTag)));
    }
    template <class T, typename std::enable_if<std::is_convertible<TNode<T>, TNode<Object>>::value && !std::is_base_of<T, Map>::value, int>::type = 0>
    TNode<T> LoadObjectField(TNode<HeapObject> object, int offset)
    {
        return CAST(LoadFromObject(MachineTypeOf<T>::value, object, IntPtrConstant(offset - kHeapObjectTag)));
    }
    ...
    TNode<MaybeObject> LoadMaybeWeakObjectField(TNode<HeapObject> object, int offset) { return UncheckedCast<MaybeObject>(LoadObjectField(object, offset)); }

    TNode<Object> LoadConstructorOrBackPointer(TNode<Map> map) { return LoadObjectField(map, Map::kConstructorOrBackPointerOrNativeContextOffset); }

    TNode<Simd128T> LoadSimd128(TNode<IntPtrT> ptr) { return Load<Simd128T>(ptr); }
    ...
    struct Reference {
        ...
        std::tuple<TNode<Object>, TNode<IntPtrT>> Flatten() const { return std::make_tuple(object, offset); }
    };
    ...
    template <class T, typename std::enable_if<std::is_convertible<TNode<T>, TNode<UntaggedT>>::value, int>::type = 0> void StoreReference(Reference reference, TNode<T> value)
    {
        DCHECK(!IsMapOffsetConstant(reference.offset));
        TNode<IntPtrT> offset = IntPtrSub(reference.offset, IntPtrConstant(kHeapObjectTag));
    ...
    TNode<FixedArrayBase> LoadElements(TNode<JSObject> object) { return LoadJSObjectElements(object); }
    ...
    TNode<IntPtrT> LoadJSReceiverIdentityHash(TNode<JSReceiver> receiver, Label* if_no_hash = nullptr);
    ...
    TNode<BoolT> IsNotCleared(TNode<MaybeObject> value) { return Word32BinaryNot(IsCleared(value)); }
    ...
    void FixedArrayBoundsCheck(TNode<FixedArrayBase> array, TNode<UintPtrT> index, int additional_offset) { FixedArrayBoundsCheck(array, Signed(index), additional_offset); }
    ...
    // Array is any array-like type that has a fixed header followed by
    // tagged elements.
    template <typename Array> TNode<Int32T> LoadAndUntagToWord32ArrayElement(TNode<Array> array, int array_header_size, TNode<IntPtrT> index, int additional_offset = 0);
    ...
    TNode<BytecodeArray> LoadSharedFunctionInfoBytecodeArray(TNode<SharedFunctionInfo> shared);
    ...
    void StoreFixedArrayElement(
        TNode<FixedArray> object, int index, TNode<Object> value, WriteBarrierMode barrier_mode = UPDATE_WRITE_BARRIER, CheckBounds check_bounds = CheckBounds::kAlways)
    {
    ...
    template <typename TIndex>
    void StoreFixedArrayElement(TNode<FixedArray> array, TNode<TIndex> index, TNode<Object> value, WriteBarrierMode barrier_mode = UPDATE_WRITE_BARRIER, int additional_offset = 0,
    ...
    void StoreFeedbackVectorSlot(
        TNode<FeedbackVector> feedback_vector, TNode<UintPtrT> slot, TNode<AnyTaggedT> value, WriteBarrierMode barrier_mode = UPDATE_WRITE_BARRIER, int additional_offset = 0);

    void StoreJSSharedStructInObjectField(TNode<HeapObject> object, TNode<IntPtrT> offset, TNode<Object> value);
    ...
    void StoreJSSharedStructPropertyArrayElement(TNode<PropertyArray> array, TNode<IntPtrT> index, TNode<Object> value)
    {
        ...
        StoreFixedArrayOrPropertyArrayElement(array, index, value, UNSAFE_SKIP_WRITE_BARRIER);
    }
    ...
    TNode<Cell> AllocateSmiCell(int value = 0) { return AllocateCellWithValue(SmiConstant(value), SKIP_WRITE_BARRIER); }
    ...
    TNode<HeapNumber> AllocateHeapNumberWithValue(double value) { return AllocateHeapNumberWithValue(Float64Constant(value)); }
    ...
    TNode<ByteArray> AllocateNonEmptyByteArray(TNode<UintPtrT> length, AllocationFlags flags);
    ...
    TNode<JSObject> AllocateJSObjectFromMap(TNode<Map> map, base::Optional<TNode<HeapObject>> properties = base::nullopt,
        base::Optional<TNode<FixedArray>> elements = base::nullopt, AllocationFlags flags = AllocationFlag::kNone, SlackTrackingMode slack_tracking_mode = kNoSlackTracking);

    void InitializeJSObjectFromMap(TNode<HeapObject> object, TNode<Map> map, TNode<IntPtrT> instance_size, base::Optional<TNode<HeapObject>> properties = base::nullopt,
        base::Optional<TNode<FixedArray>> elements = base::nullopt, SlackTrackingMode slack_tracking_mode = kNoSlackTracking);
    ...
    std::pair<TNode<JSArray>, TNode<FixedArrayBase>> AllocateUninitializedJSArrayWithElements(ElementsKind kind, TNode<Map> array_map, TNode<Smi> length,
        base::Optional<TNode<AllocationSite>> allocation_site, TNode<IntPtrT> capacity, AllocationFlags allocation_flags = AllocationFlag::kNone,
        int array_header_size = JSArray::kHeaderSize);

    // Allocate a JSArray and fill elements with the hole.
    TNode<JSArray> AllocateJSArray(ElementsKind kind, TNode<Map> array_map, TNode<IntPtrT> capacity, TNode<Smi> length, base::Optional<TNode<AllocationSite>> allocation_site,
        AllocationFlags allocation_flags = AllocationFlag::kNone);
    TNode<JSArray> AllocateJSArray(ElementsKind kind, TNode<Map> array_map, TNode<Smi> capacity, TNode<Smi> length, base::Optional<TNode<AllocationSite>> allocation_site,
        AllocationFlags allocation_flags = AllocationFlag::kNone)
    {
        return AllocateJSArray(kind, array_map, SmiUntag(capacity), length, allocation_site, allocation_flags);
    }
    ...
    {
        return AllocateJSArray(kind, array_map, SmiUntag(capacity), length, base::nullopt, allocation_flags);
    }
    ...
    {
        return AllocateJSArray(kind, array_map, capacity, length, base::nullopt, allocation_flags);
    }

    // Allocate a JSArray and initialize the header fields.
    TNode<JSArray> AllocateJSArray(TNode<Map> array_map, TNode<FixedArrayBase> elements, TNode<Smi> length, base::Optional<TNode<AllocationSite>> allocation_site = base::nullopt,
        int array_header_size = JSArray::kHeaderSize);
    ...
    TNode<JSArray> CloneFastJSArray(TNode<Context> context, TNode<JSArray> array, base::Optional<TNode<AllocationSite>> allocation_site = base::nullopt,
    ...
    TNode<FixedArrayBase> AllocateFixedArray(
        ElementsKind kind, TNode<TIndex> capacity, AllocationFlags flags = AllocationFlag::kNone, base::Optional<TNode<Map>> fixed_array_map = base::nullopt);
    ...
    void FindNonDefaultConstructorOrConstruct(
    ...
    {
        TNode<FixedArray> result = UncheckedCast<FixedArray>(AllocateFixedArray(PACKED_ELEMENTS, capacity, AllocationFlag::kAllowLargeObjectAllocation));
    ...
    {
        TNode<FixedDoubleArray> result = UncheckedCast<FixedDoubleArray>(AllocateFixedArray(PACKED_DOUBLE_ELEMENTS, capacity, AllocationFlag::kAllowLargeObjectAllocation));
    ...
    TNode<FixedDoubleArray> AllocateFixedDoubleArrayWithHoles(TNode<IntPtrT> capacity, AllocationFlags flags)
    {
    ...
    TNode<JSObject> AllocateJSIteratorResult(TNode<Context> context, TNode<Object> value, TNode<Oddball> done);
    ...
    // kinds.
    template <typename TIndex>
    void CopyFixedArrayElements(ElementsKind from_kind, TNode<FixedArrayBase> from_array, ElementsKind to_kind, TNode<FixedArrayBase> to_array, TNode<TIndex> element_count,
        TNode<TIndex> capacity, WriteBarrierMode barrier_mode = UPDATE_WRITE_BARRIER)
    {
    ...
    template <typename TIndex>
    void CopyFixedArrayElements(ElementsKind from_kind, TNode<FixedArrayBase> from_array, ElementsKind to_kind, TNode<FixedArrayBase> to_array, TNode<TIndex> first_element,
    ...
    void CopyElements(ElementsKind kind, TNode<FixedArrayBase> dst_elements, TNode<IntPtrT> dst_index, TNode<FixedArrayBase> src_elements, TNode<IntPtrT> src_index,
        TNode<IntPtrT> length, WriteBarrierMode write_barrier = UPDATE_WRITE_BARRIER);
    ...
    template <typename T> bool ClassHasMapConstant() { return false; }
    ...
    template <typename TIndex>
    TNode<FixedArrayBase> ExtractFixedArray(TNode<FixedArrayBase> source, base::Optional<TNode<TIndex>> first, base::Optional<TNode<TIndex>> count = base::nullopt,
        base::Optional<TNode<TIndex>> capacity = base::nullopt, ExtractFixedArrayFlags extract_flags = ExtractFixedArrayFlag::kAllFixedArrays,
        TVariable<BoolT>* var_holes_converted = nullptr, base::Optional<TNode<Int32T>> source_elements_kind = base::nullopt);
    ...
    TNode<FixedArray> ExtractToFixedArray(TNode<FixedArrayBase> source, TNode<TIndex> first, TNode<TIndex> count, TNode<TIndex> capacity, TNode<Map> source_map,
        ...
        TVariable<BoolT>* var_holes_converted = nullptr, base::Optional<TNode<Int32T>> source_runtime_kind = base::nullopt);
    ...
    // allocated.
    template <typename TIndex>
    TNode<FixedArrayBase> ExtractFixedDoubleArrayFillingHoles(TNode<FixedArrayBase> source, TNode<TIndex> first, TNode<TIndex> count, TNode<TIndex> capacity, TNode<Map> source_map,
        TVariable<BoolT>* var_holes_converted, AllocationFlags allocation_flags, ExtractFixedArrayFlags extract_flags);
    ...
    void TaggedPointerToWord32OrBigIntWithFeedback(TNode<Context> context, TNode<HeapObject> pointer, Label* if_number, TVariable<Word32T>* var_word32, Label* if_bigint,
        TVariable<BigInt>* var_maybe_bigint, TVariable<Smi>* var_feedback);
    ...
    void TryFloat32ToSmi(TNode<Float32T> number, TVariable<Smi>* output, Label* if_smi);
    ...
    void TaggedToNumeric(TNode<Context> context, TNode<Object> value, TVariable<Numeric>* var_numeric);
    void TaggedToNumericWithFeedback(TNode<Context> context, TNode<Object> value, TVariable<Numeric>* var_numeric, TVariable<Smi>* var_feedback);
    ...
    TNode<IntPtrT> TimesSystemPointerSize(TNode<IntPtrT> value) { return Signed(TimesSystemPointerSize(implicit_cast<TNode<WordT>>(value))); }
    TNode<UintPtrT> TimesSystemPointerSize(TNode<UintPtrT> value) { return Unsigned(TimesSystemPointerSize(implicit_cast<TNode<WordT>>(value))); }

    TNode<WordT> TimesTaggedSize(TNode<WordT> value);
    TNode<IntPtrT> TimesTaggedSize(TNode<IntPtrT> value) { return Signed(TimesTaggedSize(implicit_cast<TNode<WordT>>(value))); }
    TNode<UintPtrT> TimesTaggedSize(TNode<UintPtrT> value) { return Unsigned(TimesTaggedSize(implicit_cast<TNode<WordT>>(value))); }

    TNode<WordT> TimesDoubleSize(TNode<WordT> value);
    TNode<UintPtrT> TimesDoubleSize(TNode<UintPtrT> value) { return Unsigned(TimesDoubleSize(implicit_cast<TNode<WordT>>(value))); }
    TNode<IntPtrT> TimesDoubleSize(TNode<IntPtrT> value) { return Signed(TimesDoubleSize(implicit_cast<TNode<WordT>>(value))); }

    // Type conversions.
    // Throws a TypeError for {method_name} if {value} is not coercible to Object,
    // or returns the {value} converted to a String otherwise.
    TNode<String> ToThisString(TNode<Context> context, TNode<Object> value, TNode<String> method_name);
    TNode<String> ToThisString(TNode<Context> context, TNode<Object> value, char const* method_name) { return ToThisString(context, value, StringConstant(method_name)); }
    ...
    void ThrowRangeError(TNode<Context> context, MessageTemplate message, base::Optional<TNode<Object>> arg0 = base::nullopt, base::Optional<TNode<Object>> arg1 = base::nullopt,
    ...
    void ThrowTypeError(TNode<Context> context, MessageTemplate message, base::Optional<TNode<Object>> arg0, base::Optional<TNode<Object>> arg1 = base::nullopt,
        base::Optional<TNode<Object>> arg2 = base::nullopt);
    ...
    TNode<BoolT> IsMockArrayBufferAllocatorFlag() { return LoadRuntimeFlag(ExternalReference::address_of_mock_arraybuffer_allocator_flag()); }

    TNode<BoolT> HasBuiltinSubclassingFlag() { return LoadRuntimeFlag(ExternalReference::address_of_builtin_subclassing_flag()); }

    TNode<BoolT> HasSharedStringTableFlag() { return LoadRuntimeFlag(ExternalReference::address_of_shared_string_table_flag()); }

    TNode<BoolT> HasHarmonySymbolAsWeakmapKeyFlag() { return LoadRuntimeFlag(ExternalReference::address_of_FLAG_harmony_symbol_as_weakmap_key()); }
    ...
    TNode<BoolT> ElementsKindEqual(TNode<Int32T> a, TNode<Int32T> b) { return Word32Equal(a, b); }
    bool ElementsKindEqual(ElementsKind a, ElementsKind b) { return a == b; }
    TNode<BoolT> IsFastElementsKind(TNode<Int32T> elements_kind);
    bool IsFastElementsKind(ElementsKind kind) { return v8::internal::IsFastElementsKind(kind); }
    TNode<BoolT> IsFastPackedElementsKind(TNode<Int32T> elements_kind);
    bool IsFastPackedElementsKind(ElementsKind kind) { return v8::internal::IsFastPackedElementsKind(kind); }
    TNode<BoolT> IsFastOrNonExtensibleOrSealedElementsKind(TNode<Int32T> elements_kind);

    TNode<BoolT> IsDictionaryElementsKind(TNode<Int32T> elements_kind) { return ElementsKindEqual(elements_kind, Int32Constant(DICTIONARY_ELEMENTS)); }
    TNode<BoolT> IsDoubleElementsKind(TNode<Int32T> elements_kind);
    bool IsDoubleElementsKind(ElementsKind kind) { return v8::internal::IsDoubleElementsKind(kind); }
    ...
    TNode<Numeric> ToNumberOrNumeric(
        LazyNode<Context> context, TNode<Object> input, TVariable<Smi>* var_type_feedback, Object::Conversion mode, BigIntHandling bigint_handling = BigIntHandling::kThrow);
    ...
    template <typename BitField> TNode<Uint32T> DecodeWord32(TNode<Word32T> word32) { return DecodeWord32(word32, BitField::kShift, BitField::kMask); }

    // Returns a node that contains a decoded (unsigned!) value of a bit
    // field |BitField| in |word|. Returns result as a word-size node.
    template <typename BitField> TNode<UintPtrT> DecodeWord(TNode<WordT> word) { return DecodeWord(word, BitField::kShift, BitField::kMask); }

    // Returns a node that contains a decoded (unsigned!) value of a bit
    // field |BitField| in |word32|. Returns result as a word-size node.
    template <typename BitField> TNode<UintPtrT> DecodeWordFromWord32(TNode<Word32T> word32) { return DecodeWord<BitField>(ChangeUint32ToWord(word32)); }
    ...
    template <typename T> TNode<BoolT> IsSetWord32(TNode<Word32T> word32) { return IsSetWord32(word32, T::kMask); }

    // Returns true if any of the mask's bits in given |word32| are set.
    TNode<BoolT> IsSetWord32(TNode<Word32T> word32, uint32_t mask) { return Word32NotEqual(Word32And(word32, Int32Constant(mask)), Int32Constant(0)); }

    // Returns true if none of the mask's bits in given |word32| are set.
    TNode<BoolT> IsNotSetWord32(TNode<Word32T> word32, uint32_t mask) { return Word32Equal(Word32And(word32, Int32Constant(mask)), Int32Constant(0)); }
    ...
    template <typename T> TNode<BoolT> IsSetWord(TNode<WordT> word) { return IsSetWord(word, T::kMask); }

    // Returns true if any of the mask's bits in given |word| are set.
    TNode<BoolT> IsSetWord(TNode<WordT> word, uint32_t mask) { return WordNotEqual(WordAnd(word, IntPtrConstant(mask)), IntPtrConstant(0)); }
    ...
    template <typename T> TNode<BoolT> IsClearWord32(TNode<Word32T> word32) { return IsClearWord32(word32, T::kMask); }

    // Returns true if all of the mask's bits in given |word32| are clear.
    TNode<BoolT> IsClearWord32(TNode<Word32T> word32, uint32_t mask) { return Word32Equal(Word32And(word32, Int32Constant(mask)), Int32Constant(0)); }

    // Returns true if all of the |T|'s bits in given |word| are clear.
    template <typename T> TNode<BoolT> IsClearWord(TNode<WordT> word) { return IsClearWord(word, T::kMask); }

    // Returns true if all of the mask's bits in given |word| are clear.
    TNode<BoolT> IsClearWord(TNode<WordT> word, uint32_t mask) { return IntPtrEqual(WordAnd(word, IntPtrConstant(mask)), IntPtrConstant(0)); }
    ...
    template <typename TIndex> void Decrement(TVariable<TIndex>* variable, int value = 1) { Increment(variable, -value); }
    ...
    void TryToName(TNode<Object> key, Label* if_keyisindex, TVariable<IntPtrT>* var_index, Label* if_keyisunique, TVariable<Name>* var_unique, Label* if_bailout,
    ...
    template <typename Dictionary> TNode<IntPtrT> EntryToIndex(TNode<IntPtrT> entry) { return EntryToIndex<Dictionary>(entry, Dictionary::kEntryKeyIndex); }
    ...
    TNode<Smi> GetNumberDictionaryNumberOfElements(TNode<NumberDictionary> dictionary) { return GetNumberOfElements<NumberDictionary>(dictionary); }
    ...
    void NameDictionaryLookup(
        TNode<Dictionary> dictionary, TNode<Name> unique_name, Label* if_found, TVariable<IntPtrT>* var_name_index, Label* if_not_found, LookupMode mode = kFindExisting);
    ...
    template <class Dictionary> void InsertEntry(TNode<Dictionary> dictionary, TNode<Name> key, TNode<Object> value, TNode<IntPtrT> index, TNode<Smi> enum_index);

    template <class Dictionary> void Add(TNode<Dictionary> dictionary, TNode<Name> key, TNode<Object> value, Label* bailout);
    ...
    void TryGetOwnProperty(TNode<Context> context, TNode<Object> receiver, TNode<JSReceiver> object, TNode<Map> map, TNode<Int32T> instance_type, TNode<Name> unique_name,
        Label* if_found_value, TVariable<Object>* var_value, Label* if_not_found, Label* if_bailout);
    void TryGetOwnProperty(TNode<Context> context, TNode<Object> receiver, TNode<JSReceiver> object, TNode<Map> map, TNode<Int32T> instance_type, TNode<Name> unique_name,
        Label* if_found_value, TVariable<Object>* var_value, TVariable<Uint32T>* var_details, TVariable<Object>* var_raw_value, Label* if_not_found, Label* if_bailout,
        GetOwnPropertyMode mode);

    TNode<Object> GetProperty(TNode<Context> context, TNode<Object> receiver, Handle<Name> name) { return GetProperty(context, receiver, HeapConstant(name)); }

    TNode<Object> GetProperty(TNode<Context> context, TNode<Object> receiver, TNode<Object> name) { return CallBuiltin(Builtin::kGetProperty, context, receiver, name); }
    ...
    template <class... TArgs> TNode<Object> CallBuiltin(Builtin id, TNode<Object> context, TArgs... args)
    {
        return CallStub<Object>(Builtins::CallableFor(isolate(), id), context, args...);
    }
    ...
    void TryLookupProperty(TNode<HeapObject> object, TNode<Map> map, TNode<Int32T> instance_type, TNode<Name> unique_name, Label* if_found_fast, Label* if_found_dict,
        Label* if_found_global, TVariable<HeapObject>* var_meta_storage, TVariable<IntPtrT>* var_name_index, Label* if_not_found, Label* if_bailout);
    ...
    using LookupPropertyInHolder = std::function<void(
        TNode<HeapObject> receiver, TNode<HeapObject> holder, TNode<Map> map, TNode<Int32T> instance_type, TNode<Name> key, Label* next_holder, Label* if_bailout)>;

    // This is a type of a lookup element in holder generator function. The {key}
    // is an Int32 index.
    using LookupElementInHolder = std::function<void(
        TNode<HeapObject> receiver, TNode<HeapObject> holder, TNode<Map> map, TNode<Int32T> instance_type, TNode<IntPtrT> key, Label* next_holder, Label* if_bailout)>;
    ...
    TNode<Oddball> OrdinaryHasInstance(TNode<Context> context, TNode<Object> callable, TNode<Object> object);
    ...
    bool UpdateFeedbackModeEqual(UpdateFeedbackMode a, UpdateFeedbackMode b) { return a == b; }
    ...
    void EmitElementStore(TNode<JSObject> object, TNode<Object> key, TNode<Object> value, ElementsKind elements_kind, KeyedAccessStoreMode store_mode, Label* bailout,
        TNode<Context> context, TVariable<Object>* maybe_converted_value = nullptr);
    ...
    template <typename TIndex>
    TNode<TIndex> BuildFastLoop(const VariableList& var_list, TNode<TIndex> start_index, TNode<TIndex> end_index, const FastLoopBody<TIndex>& body, int increment,
        IndexAdvanceMode advance_mode = IndexAdvanceMode::kPre);

    template <typename TIndex>
    TNode<TIndex> BuildFastLoop(
        TNode<TIndex> start_index, TNode<TIndex> end_index, const FastLoopBody<TIndex>& body, int increment, IndexAdvanceMode advance_mode = IndexAdvanceMode::kPre)
    {
        return BuildFastLoop(VariableList(0, zone()), start_index, end_index, body, increment, advance_mode);
    }
    ...
    template <typename TIndex>
    void BuildFastArrayForEach(TNode<UnionT<UnionT<FixedArray, PropertyArray>, HeapObject>> array, ElementsKind kind, TNode<TIndex> first_element_inclusive,
        TNode<TIndex> last_element_exclusive, const FastArrayForEachBody& body, ForEachDirection direction = ForEachDirection::kReverse);
    ...
    TNode<IntPtrT> GetPropertyArrayAllocationSize(TNode<IntPtrT> element_count) { return GetArrayAllocationSize(element_count, PACKED_ELEMENTS, PropertyArray::kHeaderSize); }
    ...
    TNode<Oddball> RelationalComparison(Operation op, TNode<Object> left, TNode<Object> right, TNode<Context> context, TVariable<Smi>* var_type_feedback = nullptr)
    {
        return RelationalComparison(
            op, left, right, [=]() { return context; }, var_type_feedback);
    }

    TNode<Oddball> RelationalComparison(Operation op, TNode<Object> left, TNode<Object> right, const LazyNode<Context>& context, TVariable<Smi>* var_type_feedback = nullptr);
    ...
    void BranchIfNumberNotEqual(TNode<Number> left, TNode<Number> right, Label* if_true, Label* if_false) { BranchIfNumberEqual(left, right, if_false, if_true); }
    ...
    TNode<Oddball> Equal(TNode<Object> lhs, TNode<Object> rhs, TNode<Context> context, TVariable<Smi>* var_type_feedback = nullptr)
    {
        return Equal(
            lhs, rhs, [=]() { return context; }, var_type_feedback);
    }
    TNode<Oddball> Equal(TNode<Object> lhs, TNode<Object> rhs, const LazyNode<Context>& context, TVariable<Smi>* var_type_feedback = nullptr);

    TNode<Oddball> StrictEqual(TNode<Object> lhs, TNode<Object> rhs, TVariable<Smi>* var_type_feedback = nullptr);
    ...
    TNode<Oddball> HasProperty(TNode<Context> context, TNode<Object> object, TNode<Object> key, HasPropertyLookupMode mode);
    ...
    void ForInPrepare(TNode<HeapObject> enumerator, TNode<UintPtrT> slot, TNode<HeapObject> maybe_feedback_vector, TNode<FixedArray>* cache_array_out, TNode<Smi>* cache_length_out,
    ...
    TNode<Oddball> InstanceOf(TNode<Object> object, TNode<Object> callable, TNode<Context> context);
    ...
    TNode<CodeT> GetSharedFunctionInfoCode(TNode<SharedFunctionInfo> shared_info, TVariable<Uint16T>* data_type_out = nullptr, Label* if_compile_lazy = nullptr);
    ...
    TNode<BoolT> IsAnyPromiseHookEnabled() { return IsAnyPromiseHookEnabled(PromiseHookFlags()); }
    TNode<BoolT> IsIsolatePromiseHookEnabledOrHasAsyncEventDelegate(TNode<Uint32T> flags);
    TNode<BoolT> IsIsolatePromiseHookEnabledOrHasAsyncEventDelegate() { return IsIsolatePromiseHookEnabledOrHasAsyncEventDelegate(PromiseHookFlags()); }
    ...
    TNode<BoolT> NeedsAnyPromiseHooks() { return NeedsAnyPromiseHooks(PromiseHookFlags()); }
    ...
    inline TNode<Int32T> JSParameterCount(int argc_without_receiver) { return Int32Constant(argc_without_receiver + kJSArgcReceiverSlots); }
    inline TNode<Word32T> JSParameterCount(TNode<Word32T> argc_without_receiver) { return Int32Add(argc_without_receiver, Int32Constant(kJSArgcReceiverSlots)); }

    // Support for printf-style debugging
    void Print(const char* s);
    void Print(const char* prefix, TNode<MaybeObject> tagged_value);
    void Print(TNode<MaybeObject> tagged_value) { return Print(nullptr, tagged_value); }
    ...
    int31_t ConstexprIntegerLiteralToInt31(const IntegerLiteral& i) { return int31_t(i.To<int32_t>()); }
    int32_t ConstexprIntegerLiteralToInt32(const IntegerLiteral& i) { return i.To<int32_t>(); }
    uint32_t ConstexprIntegerLiteralToUint32(const IntegerLiteral& i) { return i.To<uint32_t>(); }
    int8_t ConstexprIntegerLiteralToInt8(const IntegerLiteral& i) { return i.To<int8_t>(); }
    uint8_t ConstexprIntegerLiteralToUint8(const IntegerLiteral& i) { return i.To<uint8_t>(); }
    uint64_t ConstexprIntegerLiteralToUint64(const IntegerLiteral& i) { return i.To<uint64_t>(); }
    intptr_t ConstexprIntegerLiteralToIntptr(const IntegerLiteral& i) { return i.To<intptr_t>(); }
    uintptr_t ConstexprIntegerLiteralToUintptr(const IntegerLiteral& i) { return i.To<uintptr_t>(); }
    ...
    bool ConstexprIntegerLiteralEqual(IntegerLiteral lhs, IntegerLiteral rhs) { return lhs == rhs; }
    ...
    using ForEachKeyValueFunction = std::function<void(TNode<Name> key, TNode<Object> value)>;
    ...
    TNode<Object> CallGetterIfAccessor(TNode<Object> value, TNode<HeapObject> holder, TNode<Uint32T> details, TNode<Context> context, TNode<Object> receiver, TNode<Object> name,
        Label* if_bailout, GetOwnPropertyMode mode = kCallJSGetterDontUseCachedName);
    ...
    TNode<IntPtrT> FeedbackIteratorEntrySize() { return IntPtrConstant(FeedbackIterator::kEntrySize); }

    TNode<IntPtrT> FeedbackIteratorHandlerOffset() { return IntPtrConstant(FeedbackIterator::kHandlerOffset); }
...
private:
    ...
    // fields initialized.
    TNode<JSArray> AllocateUninitializedJSArray(TNode<Map> array_map, TNode<Smi> length, base::Optional<TNode<AllocationSite>> allocation_site, TNode<IntPtrT> size_in_bytes);
    ...
    TNode<IntPtrT> SmiShiftBitsConstant() { return IntPtrConstant(kSmiShiftSize + kSmiTagSize); }
    TNode<Int32T> SmiShiftBitsConstant32() { return Int32Constant(kSmiShiftSize + kSmiTagSize); }
    ...
    void TaggedToNumeric(TNode<Context> context, TNode<Object> value, TVariable<Numeric>* var_numeric, TVariable<Smi>* var_feedback);

    enum IsKnownTaggedPointer { kNo, kYes };
    template <Object::Conversion conversion>
    void TaggedToWord32OrBigIntImpl(TNode<Context> context, TNode<Object> value, Label* if_number, TVariable<Word32T>* var_word32, IsKnownTaggedPointer is_known_tagged_pointer,
        Label* if_bigint = nullptr, TVariable<BigInt>* var_maybe_bigint = nullptr, TVariable<Smi>* var_feedback = nullptr);
    ...
    TNode<Object> LoadRoot(RootIndex root_index) { return CodeAssembler::LoadRoot(root_index); }

    TNode<AnyTaggedT> LoadRootMapWord(RootIndex root_index) { return CodeAssembler::LoadRootMapWord(root_index); }

    template <typename TIndex>
    void StoreFixedArrayOrPropertyArrayElement(
        TNode<UnionT<FixedArray, PropertyArray>> array, TNode<TIndex> index, TNode<Object> value, WriteBarrierMode barrier_mode = UPDATE_WRITE_BARRIER, int additional_offset = 0);
    ...
    template <typename TArray, typename TIndex, typename TValue> void StoreElementTypedArray(TNode<TArray> elements, ElementsKind kind, TNode<TIndex> index, TNode<TValue> value);
    ...
    void EmitElementStoreTypedArray(TNode<JSTypedArray> typed_array, TNode<IntPtrT> key, TNode<Object> value, ElementsKind elements_kind, KeyedAccessStoreMode store_mode,
...
public:
    ...
    TorqueStructArguments GetTorqueArguments() const { return TorqueStructArguments { fp_, base_, GetLengthWithoutReceiver(), argc_ }; }

    TNode<Object> GetOptionalArgumentValue(TNode<IntPtrT> index, TNode<Object> default_value);
    TNode<Object> GetOptionalArgumentValue(TNode<IntPtrT> index) { return GetOptionalArgumentValue(index, assembler_->UndefinedConstant()); }
    TNode<Object> GetOptionalArgumentValue(int index) { return GetOptionalArgumentValue(assembler_->IntPtrConstant(index)); }
...
public:
    ...
    TNode<RawPtrT> PointerToData(Label* if_bailout) { return TryToSequential(PTR_TO_DATA, if_bailout); }

    // Returns a pointer that, offset-wise, looks like a String.
    // Jumps to if_bailout if the external string cannot be unpacked.
    TNode<RawPtrT> PointerToString(Label* if_bailout) { return TryToSequential(PTR_TO_STRING, if_bailout); }
...
#define CLASS_MAP_CONSTANT_ADAPTER(V, rootIndexName, rootAccessorName, class_name)                                                                                                 \
    template <> inline bool CodeStubAssembler::ClassHasMapConstant<class_name>() { return true; }                                                                                  \
    template <> inline TNode<Map> CodeStubAssembler::GetClassMapConstant<class_name>() { return class_name##MapConstant(); }
