...
#define EXTERNAL_REFERENCE_LIST_WITH_ISOLATE(V)                                                                                                                                    \
    ...
    V(fast_c_call_caller_fp_address, "IsolateData::fast_c_call_caller_fp_address")                                                                                                 \
    V(fast_c_call_caller_pc_address, "IsolateData::fast_c_call_caller_pc_address")                                                                                                 \
...
#define EXTERNAL_REFERENCE_LIST(V)                                                                                                                                                 \
    ...
    V(address_of_FLAG_harmony_regexp_unicode_sets, "v8_flags.harmony_regexp_unicode_sets")                                                                                         \
    V(address_of_FLAG_harmony_symbol_as_weakmap_key, "v8_flags.harmony_symbol_as_weakmap_key")                                                                                     \
    ...
    IF_WASM(V, wasm_call_trap_callback_for_testing, "wasm::call_trap_callback_for_testing")                                                                                        \
