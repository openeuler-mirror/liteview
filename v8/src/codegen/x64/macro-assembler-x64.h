...
class V8_EXPORT_PRIVATE TurboAssembler : public SharedTurboAssemblerBase<TurboAssembler> {
public:
    ...
    void Push(Smi smi);
    void Push(TaggedIndex index) { Push(Immediate(static_cast<uint32_t>(index.ptr()))); }
    ...
    void AssertNotSmi(Register object) NOOP_UNLESS_DEBUG_CODE
        ...
        void AssertSmi(Register object) NOOP_UNLESS_DEBUG_CODE void AssertSmi(Operand object) NOOP_UNLESS_DEBUG_CODE
    ...
    void Move(XMMRegister dst, float src) { Move(dst, base::bit_cast<uint32_t>(src)); }
    void Move(XMMRegister dst, double src) { Move(dst, base::bit_cast<uint64_t>(src)); }
    ...
    void DropArguments(Register count, Register scratch, ArgumentsCountType type, ArgumentsCountMode mode);
    void DropArgumentsAndPushNewReceiver(Register argc, Register receiver, Register scratch, ArgumentsCountType type, ArgumentsCountMode mode);
    void DropArgumentsAndPushNewReceiver(Register argc, Operand receiver, Register scratch, ArgumentsCountType type, ArgumentsCountMode mode);
...
// register's value, in the version that takes a register.
    ...
    void LoadTaggedPointerField(TaggedRegister destination, Operand field_operand);
    ...
    void LoadExternalPointerField(
        Register destination, Operand field_operand, ExternalPointerTag tag, Register scratch, IsolateRootLocation isolateRootLocation = IsolateRootLocation::kInRootRegister);
...
public:
    ...
    void OptimizeCodeOrTailCallOptimizedCodeSlot(Register flags, Register feedback_vector, Register closure, JumpMode jump_mode = JumpMode::kJump);
...
inline Operand FieldOperand(Register object, int offset) { return Operand(object, offset - kHeapObjectTag); }
...
inline Operand FieldOperand(Register object, Register index, ScaleFactor scale, int offset) { return Operand(object, index, scale, offset - kHeapObjectTag); }
...
inline Operand StackOperandForReturnAddress(int32_t disp) { return Operand(rsp, disp); }
