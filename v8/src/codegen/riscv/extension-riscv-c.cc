...
void AssemblerRISCVC::c_j(int16_t imm12)
{
    ...
    int16_t uimm11 = ((imm12 & 0x800) >> 1) | ((imm12 & 0x400) >> 4) | ((imm12 & 0x300) >> 1) | ((imm12 & 0x80) >> 3) | ((imm12 & 0x40) >> 1) | ((imm12 & 0x20) >> 5)
...
bool AssemblerRISCVC::IsCJal(Instr instr) { return (instr & kRvcOpcodeMask) == RO_C_J; }
...
{
    int32_t imm12 = ((instr & 0x4) << 3) | ((instr & 0x38) >> 2) | ((instr & 0x40) << 1) | ((instr & 0x80) >> 1) | ((instr & 0x100) << 2) | ((instr & 0x600) >> 1)
