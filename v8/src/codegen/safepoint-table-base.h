...
public:
    ...
    bool has_deoptimization_index() const { return deopt_index_ != kNoDeoptIndex; }
...
protected:
    bool operator==(const SafepointEntryBase& other) const { return pc_ == other.pc_ && deopt_index_ == other.deopt_index_ && trampoline_pc_ == other.trampoline_pc_; }
...
public:
    bool emitted() const { return safepoint_table_offset_ != kNoSafepointTableOffset; }
