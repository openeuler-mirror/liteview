...
#define GENERAL_REGISTERS(V)                                                                                                                                                       \
    V(zero_reg)                                                                                                                                                                    \
    V(ra) V(tp) V(sp) V(a0) V(a1) V(a2) V(a3) V(a4) V(a5) V(a6) V(a7) V(t0) V(t1) V(t2) V(t3) V(t4) V(t5) V(t6) V(t7) V(t8) V(x_reg) V(fp) V(s0) V(s1) V(s2) V(s3) V(s4) V(s5)     \
        V(s6) V(s7) V(s8)

#define ALLOCATABLE_GENERAL_REGISTERS(V) V(a0) V(a1) V(a2) V(a3) V(a4) V(a5) V(a6) V(a7) V(t0) V(t1) V(t2) V(t3) V(t4) V(t5) V(s0) V(s1) V(s2) V(s3) V(s4) V(s5) V(s7) V(s8)

#define DOUBLE_REGISTERS(V)                                                                                                                                                        \
    V(f0)                                                                                                                                                                          \
    V(f1) V(f2) V(f3) V(f4) V(f5) V(f6) V(f7) V(f8) V(f9) V(f10) V(f11) V(f12) V(f13) V(f14) V(f15) V(f16) V(f17) V(f18) V(f19) V(f20) V(f21) V(f22) V(f23) V(f24) V(f25) V(f26)   \
        V(f27) V(f28) V(f29) V(f30) V(f31)

#define FLOAT_REGISTERS DOUBLE_REGISTERS
#define SIMD128_REGISTERS(V)                                                                                                                                                       \
    V(w0)                                                                                                                                                                          \
    V(w1) V(w2) V(w3) V(w4) V(w5) V(w6) V(w7) V(w8) V(w9) V(w10) V(w11) V(w12) V(w13) V(w14) V(w15) V(w16) V(w17) V(w18) V(w19) V(w20) V(w21) V(w22) V(w23) V(w24) V(w25) V(w26)   \
        V(w27) V(w28) V(w29) V(w30) V(w31)

#define ALLOCATABLE_DOUBLE_REGISTERS(V)                                                                                                                                            \
    V(f0) V(f1) V(f2) V(f3) V(f4) V(f5) V(f6) V(f7) V(f8) V(f9) V(f10) V(f11) V(f12) V(f13) V(f14) V(f15) V(f16) V(f17) V(f18) V(f19) V(f20) V(f21) V(f22) V(f23)
// clang-format on
