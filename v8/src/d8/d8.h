...
public:
    ...
    const std::vector<std::shared_ptr<v8::BackingStore>>& backing_stores() { return backing_stores_; }
    const std::vector<std::shared_ptr<v8::BackingStore>>& sab_backing_stores() { return sab_backing_stores_; }
    const std::vector<CompiledWasmModule>& compiled_wasm_modules() { return compiled_wasm_modules_; }
    const base::Optional<v8::SharedValueConveyor>& shared_value_conveyor() { return shared_value_conveyor_; }
...
public:
    ...
    static bool StartWorkerThread(Isolate* requester, std::shared_ptr<Worker> worker);
...
public:
    ...
    inline static PerIsolateData* Get(Isolate* isolate) { return reinterpret_cast<PerIsolateData*>(isolate->GetData(0)); }
...
public:
    ...
    DisallowReassignment<bool> fuzzilli_enable_builtins_coverage = { "fuzzilli-enable-builtins-coverage", true };
    ...
    DisallowReassignment<const char*> web_snapshot_config = { "web-snapshot-config", nullptr };
    DisallowReassignment<const char*> web_snapshot_output = { "web-snapshot-output", nullptr };
    DisallowReassignment<bool> d8_web_snapshot_api = { "experimental-d8-web-snapshot-api", false };
    ...
    DisallowReassignment<bool> enable_sandbox_crash_filter = { "enable-sandbox-crash-filter", false };
#endif // V8_ENABLE_SANDBOX
    DisallowReassignment<bool> throw_on_failed_access_check = { "throw-on-failed-access-check", false };
    DisallowReassignment<bool> noop_on_failed_access_check = { "noop-on-failed-access-check", false };
};
...
public:
    ...
    static int64_t GetTracingTimestampFromPerformanceTimestamp(double performance_timestamp);

    static void PerformanceNow(const v8::FunctionCallbackInfo<v8::Value>& args);
    static void PerformanceMark(const v8::FunctionCallbackInfo<v8::Value>& args);
    static void PerformanceMeasure(const v8::FunctionCallbackInfo<v8::Value>& args);
    static void PerformanceMeasureMemory(const v8::FunctionCallbackInfo<v8::Value>& args);
    ...
    static void RealmDetachGlobal(const v8::FunctionCallbackInfo<v8::Value>& args);
    ...
    static void RealmTakeWebSnapshot(const v8::FunctionCallbackInfo<v8::Value>& args);
    static void RealmUseWebSnapshot(const v8::FunctionCallbackInfo<v8::Value>& args);

    static void LogGetAndStop(const v8::FunctionCallbackInfo<v8::Value>& args);
    static void TestVerifySourcePositions(const v8::FunctionCallbackInfo<v8::Value>& args);

    static void InstallConditionalFeatures(const v8::FunctionCallbackInfo<v8::Value>& args);
    ...
    static void SerializerSerialize(const v8::FunctionCallbackInfo<v8::Value>& args);
    static void SerializerDeserialize(const v8::FunctionCallbackInfo<v8::Value>& args);
    ...
    static void ReadLine(const v8::FunctionCallbackInfo<v8::Value>& args) { args.GetReturnValue().Set(ReadFromStdin(args.GetIsolate())); }
    ...
    static void ReadCodeTypeAndArguments(const v8::FunctionCallbackInfo<v8::Value>& args, int index, CodeType* code_type, Local<Value>* arguments = nullptr);
    ...
    static MaybeLocal<String> ReadSource(const v8::FunctionCallbackInfo<v8::Value>& args, int index, CodeType default_type);
    ...
    static void WorkerTerminateAndWait(const v8::FunctionCallbackInfo<v8::Value>& args);
    ...
    static bool use_interactive_shell() { return (options.interactive_shell || !script_executed_.load()) && !options.test_shell; }
...
private:
    static inline int DeserializationRunCount() { return options.stress_deserialize ? 1000 : 1; }
    ...
    static MaybeLocal<Context> CreateRealm(const v8::FunctionCallbackInfo<v8::Value>& args, int index, v8::MaybeLocal<Value> global_object);
    static void DisposeRealm(const v8::FunctionCallbackInfo<v8::Value>& args, int index);
