...
// static
UnoptimizedCompileFlags UnoptimizedCompileFlags::ForFunctionCompile(Isolate* isolate, SharedFunctionInfo shared)
{
...
// static
UnoptimizedCompileFlags UnoptimizedCompileFlags::ForScriptCompile(Isolate* isolate, Script script)
{
    UnoptimizedCompileFlags flags(isolate, script.id());
    ...
    Isolate* isolate, bool is_user_javascript, LanguageMode language_mode, REPLMode repl_mode, ScriptType type, bool lazy)
{
    ...
    LOG(isolate, ScriptEvent(V8FileLogger::ScriptEventType::kReserveId, flags.script_id()));
    return flags;
}
...
// static
UnoptimizedCompileFlags UnoptimizedCompileFlags::ForTest(Isolate* isolate) { return UnoptimizedCompileFlags(isolate, Script::kTemporaryScriptId); }
...
ParseInfo::ParseInfo(const UnoptimizedCompileFlags flags, UnoptimizedCompileState* state, ReusableUnoptimizedCompileState* reusable_state, uintptr_t stack_limit,
...
ParseInfo::ParseInfo(
    LocalIsolate* isolate, const UnoptimizedCompileFlags flags, UnoptimizedCompileState* state, ReusableUnoptimizedCompileState* reusable_state, uintptr_t stack_limit)
    ...
    IsolateT* isolate, Handle<String> source, MaybeHandle<FixedArray> maybe_wrapped_arguments, ScriptOriginOptions origin_options, NativesFlag natives)
{
    ...
    Handle<Script> script = isolate->factory()->NewScriptWithId(source, flags().script_id());
...
void ParseInfo::CheckFlagsForFunctionFromScript(Script script)
{
    ...
    DCHECK_EQ(flags().is_eval() && !script.is_wrapped(), script.compilation_type() == Script::COMPILATION_TYPE_EVAL);
