...
// parsing failed.
V8_EXPORT_PRIVATE bool ParseProgram(ParseInfo* info, Handle<Script> script, Isolate* isolate, ReportStatisticsMode mode);
...
V8_EXPORT_PRIVATE bool ParseProgram(ParseInfo* info, Handle<Script> script, MaybeHandle<ScopeInfo> outer_scope, Isolate* isolate, ReportStatisticsMode mode);
