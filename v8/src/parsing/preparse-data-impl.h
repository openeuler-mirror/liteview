...
public:
    ...
    ProducedPreparseData* GetDataForSkippableFunction(Zone* zone, int start_position, int* end_position, int* num_parameters, int* function_length, int* num_inner_functions,
        bool* uses_super_property, LanguageMode* language_mode) final;
...
class OnHeapConsumedPreparseData final : public BaseConsumedPreparseData<PreparseData> {
public:
