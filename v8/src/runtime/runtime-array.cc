...
RUNTIME_FUNCTION(Runtime_NewArray)
{
    ...
    Handle<AllocationSite> site = type_info->IsAllocationSite() ? Handle<AllocationSite>::cast(type_info) : Handle<AllocationSite>::null();
    ...
    Handle<JSArray> array = Handle<JSArray>::cast(factory->NewJSObjectFromMap(initial_map, AllocationType::kYoung, allocation_site));
...
RUNTIME_FUNCTION(Runtime_ArrayIncludes_Slow)
{
    ...
    if (!object->map().IsSpecialReceiverMap() && len <= JSObject::kMaxElementCount && JSObject::PrototypeHasNoElements(isolate, JSObject::cast(*object))) {
