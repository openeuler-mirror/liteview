...
void PrintRegisterRange(UnoptimizedFrame* frame, std::ostream& os, interpreter::BytecodeArrayIterator& bytecode_iterator, const int& reg_field_width, const char* arrow_direction,
...
void PrintRegisters(UnoptimizedFrame* frame, std::ostream& os, bool is_input, interpreter::BytecodeArrayIterator& bytecode_iterator, Handle<Object> accumulator)
{
    ...
    for (int operand_index = 0; operand_index < operand_count; operand_index++) {
        ...
        bool should_print = is_input ? interpreter::Bytecodes::IsRegisterInputOperandType(operand_type) : interpreter::Bytecodes::IsRegisterOutputOperandType(operand_type);
        if (should_print) {
...
RUNTIME_FUNCTION(Runtime_TraceUnoptimizedBytecodeEntry)
{
    ...
    UnoptimizedFrame* frame = reinterpret_cast<UnoptimizedFrame*>(frame_iterator.frame());
