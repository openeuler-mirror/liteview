...
RUNTIME_FUNCTION(Runtime_EnqueueMicrotask)
{
    ...
    Handle<CallableTask> microtask = isolate->factory()->NewCallableTask(function, handle(function->native_context(), isolate));
...
RUNTIME_FUNCTION(Runtime_RejectPromise)
{
    ...
    return *JSPromise::Reject(promise, reason, debug_event->BooleanValue(isolate));
}
...
RUNTIME_FUNCTION(Runtime_ConstructInternalAggregateErrorHelper)
{
    ...
    Handle<Object> message_string = MessageFormatter::Format(isolate, MessageTemplate(message_template_index), arg0, arg1, arg2);
