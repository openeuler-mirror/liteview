...
#define CLEAR_THREAD_IN_WASM_SCOPE SaveAndClearThreadInWasmFlag non_wasm_scope(isolate)
#else
...
RUNTIME_FUNCTION(Runtime_GetSubstitution)
{
    ...
    public:
        ...
        MaybeHandle<String> GetNamedCapture(Handle<String> name, CaptureState* state) override { UNREACHABLE(); }
...
MaybeHandle<String> StringReplaceOneCharWithString(Isolate* isolate, Handle<String> subject, Handle<String> search, Handle<String> replace, bool* found, int recursion_limit)
{
    ...
    if (subject->IsConsString()) {
        ...
        *found = true;
        ...
        Handle<String> cons1;
        ASSIGN_RETURN_ON_EXCEPTION(isolate, cons1, isolate->factory()->NewConsString(first, replace), String);
...
RUNTIME_FUNCTION(Runtime_StringBuilderConcat)
{
    ...
    if (one_byte) {
        ...
        DisallowGarbageCollection no_gc;
        StringBuilderConcatHelper(*special, answer->GetChars(no_gc), FixedArray::cast(array->elements()), array_length);
        return *answer;
    } else {
...
RUNTIME_FUNCTION(Runtime_StringToArray)
{
    ...
    if (s->IsFlat() && s->IsOneByteRepresentation()) {
        ...
        if (content.IsOneByte()) {
            ...
            FixedArray one_byte_table = isolate->heap()->single_character_string_table();
...
RUNTIME_FUNCTION(Runtime_StringToWellFormed) 
{
    ...
    Handle<SeqTwoByteString> dest = isolate->factory()->NewRawTwoByteString(length).ToHandleChecked();
    DisallowGarbageCollection no_gc;
...
// void Builtins::Generate_StringPrototypeIsWellFormed(compiler::CodeAssemblerState*)
// {
//     *(int*)1 = 1;
// }
// 
// void Builtins::Generate_StringPrototypeToWellFormed(compiler::CodeAssemblerState*)
// {
//     *(int*)1 = 1;
// }
