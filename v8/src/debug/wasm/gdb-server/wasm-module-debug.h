...
public:
    ...
    i::Isolate* GetIsolate() const { return reinterpret_cast<i::Isolate*>(isolate_); }
...
private:
    ...
    // stack frame.
    static std::vector<FrameSummary> FindWasmFrame(StackTraceFrameIterator* frame_it, uint32_t* frame_index);
