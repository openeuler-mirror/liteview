...
void Sandbox::Initialize(v8::VirtualAddressSpace* vas)
{
    ...
    if (max_reservation_size < kSandboxSize) {
        ...
        InitializeAsPartiallyReservedSandbox(vas, kSandboxSize, max_reservation_size);
    } else {
        ...
        if (!success) {
            ...
            while (!success && next_reservation_size >= kSandboxMinimumReservationSize) {
                success = InitializeAsPartiallyReservedSandbox(vas, kSandboxSize, next_reservation_size);
