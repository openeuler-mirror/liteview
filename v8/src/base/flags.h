...
// int.
template <typename T, typename S = int> class Flags final {
public:
    using flag_type = T;
    using mask_type = S;
    ...
    constexpr bool operator==(flag_type flag) const { return mask_ == static_cast<S>(flag); }
    constexpr bool operator!=(flag_type flag) const { return mask_ != static_cast<S>(flag); }
    ...
    constexpr Flags operator&(const Flags& flags) const { return Flags(mask_ & flags.mask_); }
    constexpr Flags operator|(const Flags& flags) const { return Flags(mask_ | flags.mask_); }
    constexpr Flags operator^(const Flags& flags) const { return Flags(mask_ ^ flags.mask_); }
    ...
    constexpr Flags operator&(flag_type flag) const { return operator&(Flags(flag)); }
    constexpr Flags operator|(flag_type flag) const { return operator|(Flags(flag)); }
    constexpr Flags operator^(flag_type flag) const { return operator^(Flags(flag)); }
...
#define DEFINE_OPERATORS_FOR_FLAGS(Type)                                                                                                                                           \
    V8_ALLOW_UNUSED V8_WARN_UNUSED_RESULT inline constexpr Type operator&(Type::flag_type lhs, Type::flag_type rhs) { return Type(lhs) & rhs; }                                    \
    V8_ALLOW_UNUSED V8_WARN_UNUSED_RESULT inline constexpr Type operator&(Type::flag_type lhs, const Type& rhs) { return rhs & lhs; }                                              \
    ...
    V8_ALLOW_UNUSED V8_WARN_UNUSED_RESULT inline constexpr Type operator^(Type::flag_type lhs, const Type& rhs) { return rhs ^ lhs; }                                              \
    V8_ALLOW_UNUSED inline void operator^(Type::flag_type lhs, Type::mask_type rhs) { }                                                                                            \
    V8_ALLOW_UNUSED inline constexpr Type operator~(Type::flag_type val) { return ~Type(val); }
