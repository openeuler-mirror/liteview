...
void MemoryProtectionKey::InitializeMemoryProtectionKeySupport()
{
    ...
    bool kernel_has_pkru_fix = kernel > 5 || (kernel == 5 && major >= 13) || // anything >= 5.13
...
// static
DISABLE_CFI_ICALL
bool MemoryProtectionKey::SetPermissionsAndKey(v8::PageAllocator* page_allocator, base::AddressRegion region, v8::PageAllocator::Permission page_permissions, int key)
{
    DCHECK(pkey_api_initialized);
