...
public:
    ...
    PointerWithPayload(PointerType* pointer, PayloadType payload) { Update(pointer, payload); }

    V8_INLINE PointerType* GetPointer() const { return reinterpret_cast<PointerType*>(pointer_with_payload_ & kPointerMask); }
    ...
    V8_INLINE PayloadType GetPayload() const { return static_cast<PayloadType>(pointer_with_payload_ & kPayloadMask); }
