...
public:
    ...
    enum { kPPCPower5, kPPCPower6, kPPCPower7, kPPCPower8, kPPCPower9, kPPCPower10, kPPCG4, kPPCG5, kPPCPA6T };
    ...
    bool exposes_num_virtual_address_bits() const { return num_virtual_address_bits_ != kUnknownNumVirtualAddressBits; }
