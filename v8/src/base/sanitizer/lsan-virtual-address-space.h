...
public:
    ...
    void SetRandomSeed(int64_t seed) override { return vas_->SetRandomSeed(seed); }
    ...
    bool SetPagePermissions(Address address, size_t size, PagePermissions permissions) override { return vas_->SetPagePermissions(address, size, permissions); }

    bool RecommitPages(Address address, size_t size, PagePermissions permissions) override { return vas_->RecommitPages(address, size, permissions); }

    bool AllocateGuardRegion(Address address, size_t size) override { return vas_->AllocateGuardRegion(address, size); }

    void FreeGuardRegion(Address address, size_t size) override { vas_->FreeGuardRegion(address, size); }
    ...
    bool DiscardSystemPages(Address address, size_t size) override { return vas_->DiscardSystemPages(address, size); }

    bool DecommitPages(Address address, size_t size) override { return vas_->DecommitPages(address, size); }
