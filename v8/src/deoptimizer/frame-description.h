...
public:
    ...
    void operator delete(void* pointer, uint32_t frame_size) { base::Free(pointer); }
    ...
    intptr_t GetFrameSlot(unsigned offset) { return *GetFrameSlotPointer(offset); }
    ...
    void SetFrameSlot(unsigned offset, intptr_t value) { *GetFrameSlotPointer(offset) = value; }
    ...
    intptr_t GetRegister(unsigned n) const { return register_values_.GetRegister(n); }

    Float64 GetDoubleRegister(unsigned n) const { return register_values_.GetDoubleRegister(n); }

    void SetRegister(unsigned n, intptr_t value) { register_values_.SetRegister(n, value); }
    ...
    void SetConstantPool(intptr_t constant_pool) { constant_pool_ = constant_pool; }
    ...
    static int registers_offset() { return offsetof(FrameDescription, register_values_.registers_); }

    static constexpr int double_registers_offset() { return offsetof(FrameDescription, register_values_.double_registers_); }

    static int frame_size_offset() { return offsetof(FrameDescription, frame_size_); }

    static int pc_offset() { return offsetof(FrameDescription, pc_); }

    static int continuation_offset() { return offsetof(FrameDescription, continuation_); }

    static int frame_content_offset() { return offsetof(FrameDescription, frame_content_); }
