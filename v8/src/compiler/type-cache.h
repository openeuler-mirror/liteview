...
public:
    ...
    Type const kWeakFixedArrayLengthType = CreateRange(0.0, WeakFixedArray::kMaxLength);
    ...
    Type const kJSTypedArrayLengthType = CreateRange(0.0, JSTypedArray::kMaxLength);
...
private:
    ...
    Type CreateRange(double min, double max) { return Type::Range(min, max, zone()); }
