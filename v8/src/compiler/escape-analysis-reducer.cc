        ...
        if (!escaping_use) {
            ...
            for (Node* load : loads) {
                ...
                case IrOpcode::kLoadElement: {
                    ...
                    Node* formal_parameter_count = jsgraph()->Constant(params.formal_parameter_count());
                    NodeProperties::SetType(formal_parameter_count, Type::Constant(params.formal_parameter_count(), jsgraph()->graph()->zone()));
                    Node* offset_to_first_elem = jsgraph()->Constant(CommonFrameConstants::kFixedSlotCountAboveFp);
                ...
                case IrOpcode::kLoadField: {
                    DCHECK_EQ(FieldAccessOf(load->op()).offset, FixedArray::kLengthOffset);
