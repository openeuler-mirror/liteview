...
void PendingLoopPhiOp::PrintOptions(std::ostream& os) const { os << "[" << rep << ", #o" << old_backedge_index.id() << "]"; }
...
std::ostream& operator<<(std::ostream& os, const Block* b) { return os << b->index(); }
