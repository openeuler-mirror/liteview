...
public:
    enum class Enum : uint8_t { kWord32, kWord64, kFloat32, kFloat64, kTagged, kCompressed };
    ...
    static RegisterRepresentation FromMachineRepresentation(MachineRepresentation rep)
    {
        switch (rep) {
...
V8_INLINE bool operator==(RegisterRepresentation a, RegisterRepresentation b) { return a.value() == b.value(); }
V8_INLINE bool operator!=(RegisterRepresentation a, RegisterRepresentation b) { return a.value() != b.value(); }

V8_INLINE size_t hash_value(RegisterRepresentation rep) { return static_cast<size_t>(rep.value()); }
...
public:
    ...
    static constexpr WordRepresentation Word32() { return WordRepresentation(Enum::kWord32); }
    static constexpr WordRepresentation Word64() { return WordRepresentation(Enum::kWord64); }

    static constexpr WordRepresentation PointerSized() { return WordRepresentation(RegisterRepresentation::PointerSized()); }

    constexpr Enum value() const { return static_cast<Enum>(RegisterRepresentation::value()); }
    constexpr operator Enum() const { return value(); }
...
public:
    ...
    static constexpr FloatRepresentation Float32() { return FloatRepresentation(Enum::kFloat32); }
    static constexpr FloatRepresentation Float64() { return FloatRepresentation(Enum::kFloat64); }
...
public:
    ...
    static MemoryRepresentation FromMachineRepresentation(MachineRepresentation rep)
    {
        switch (rep) {
        case MachineRepresentation::kWord8:
            return Uint8();
...
V8_INLINE bool operator==(MemoryRepresentation a, MemoryRepresentation b) { return a.value() == b.value(); }
V8_INLINE bool operator!=(MemoryRepresentation a, MemoryRepresentation b) { return a.value() != b.value(); }

V8_INLINE size_t hash_value(MemoryRepresentation rep) { return static_cast<size_t>(rep.value()); }
