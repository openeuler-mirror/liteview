...
// unconditionally.
inline bool CollectFeedbackInGenericLowering() { return v8_flags.turbo_collect_feedback_in_generic_lowering; }
...
inline size_t hash_value(StackCheckKind kind) { return static_cast<size_t>(kind); }
...
inline size_t hash_value(CheckForMinusZeroMode mode) { return static_cast<size_t>(mode); }
