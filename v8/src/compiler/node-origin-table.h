...
public:
    ...
    bool operator==(const NodeOrigin& o) const { return reducer_name_ == o.reducer_name_ && created_from_ == o.created_from_; }
...
inline bool operator!=(const NodeOrigin& lhs, const NodeOrigin& rhs) { return !(lhs == rhs); }
...
public:
    ...
    void SetCurrentBytecodePosition(int offset) { current_bytecode_position_ = offset; }
...
private:
    ...
    static NodeOrigin UnknownNodeOrigin(Zone* zone) { return NodeOrigin::Unknown(); }
