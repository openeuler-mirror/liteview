...
public:
    ...
    const ZoneMap<int, InductionVariable*>& induction_variables() { return induction_vars_; }
...
private:
    ...
    struct Constraint {
        ...
        bool operator!=(const Constraint& other) const { return left != other.left || kind != other.kind || right != other.right; }
    };
