...
public:
    ...
    public:
        ...
        bool IsSideEffectFree() const { return kind_ == LoweringResultKind::kSideEffectFree; }
        ...
        static LoweringResult NoChange() { return LoweringResult(LoweringResultKind::kNoChange, nullptr, nullptr, nullptr); }

        static LoweringResult Exit(Node* control) { return LoweringResult(LoweringResultKind::kExit, nullptr, nullptr, control); }
