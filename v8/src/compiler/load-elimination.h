...
private:
    ...
    struct FieldInfo {
        ...
        {
            return value == other.value && representation == other.representation && name.address() == other.name.address() && const_field_info == other.const_field_info;
        }
    ...
    public:
        ...
        AbstractField const* Extend(Node* object, FieldInfo info, Zone* zone) const
        {
        ...
        bool Equals(AbstractField const* that) const { return this == that || this->info_for_node_ == that->info_for_node_; }
    ...
    public:
        ...
        AbstractMaps const* Extend(Node* object, ZoneHandleSet<Map> maps, Zone* zone) const;
        ...
        bool Equals(AbstractMaps const* that) const { return this == that || this->info_for_node_ == that->info_for_node_; }
    ...
    public:
        ...
        bool operator==(const IndexRange& other) const { return begin_ == other.begin_ && end_ == other.end_; }
    ...
    public:
        ...
        AbstractState const* SetMaps(Node* object, ZoneHandleSet<Map> maps, Zone* zone) const;
    ...
    static AbstractState const* empty_state() { return AbstractState::empty_state(); }
