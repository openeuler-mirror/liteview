...
public:
    ...
    const char* reducer_name() const override { return "SimplifiedOperatorReducer"; }
...
private:
    ...
    Reduction ReplaceUint32(uint32_t value) { return ReplaceInt32(base::bit_cast<int32_t>(value)); }
