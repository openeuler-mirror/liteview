...
Node** CommonNodeCache::FindExternalConstant(ExternalReference value) { return external_constants_.Find(base::bit_cast<intptr_t>(value.address())); }

Node** CommonNodeCache::FindHeapConstant(Handle<HeapObject> value) { return heap_constants_.Find(base::bit_cast<intptr_t>(value.address())); }
