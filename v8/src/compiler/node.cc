...
void Node::Print(std::ostream& os, int depth) const { PrintNode(this, os, depth); }
...
V8_EXPORT_PRIVATE extern void _v8_internal_Node_Print(void* object) { reinterpret_cast<i::compiler::Node*>(object)->Print(); }
