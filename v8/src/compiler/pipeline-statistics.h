...
public:
    PipelineStatistics(OptimizedCompilationInfo* info, std::shared_ptr<CompilationStatistics> turbo_stats, ZoneStats* zone_stats);
    ~PipelineStatistics();
...
private:
    size_t OuterZoneSize() { return static_cast<size_t>(outer_zone_->allocation_size()); }
    ...
    public:
        ...
        void End(PipelineStatistics* pipeline_stats, CompilationStatistics::BasicStats* diff);
