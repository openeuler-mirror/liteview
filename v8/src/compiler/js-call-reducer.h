...
private:
    ...
    Reduction ReduceCallApiFunction(Node* node, const SharedFunctionInfoRef& shared);
    Reduction ReduceCallWasmFunction(Node* node, const SharedFunctionInfoRef& shared);
    ...
    Reduction ReduceArrayFindIndex(Node* node, const SharedFunctionInfoRef& shared);
    ...
    Reduction ReduceArrayReduceRight(Node* node, const SharedFunctionInfoRef& shared);
    ...
    Reduction ReduceCallOrConstructWithArrayLikeOrSpreadOfCreateArguments(Node* node, Node* arguments_list, int arraylike_or_spread_index, CallFrequency const& frequency,
        FeedbackSource const& feedback, SpeculationMode speculation_mode, CallFeedbackRelation feedback_relation);
    ...
    Reduction ReduceTypedArrayConstructor(Node* node, const SharedFunctionInfoRef& shared);
    ...
    Reduction ReduceArrayBufferViewAccessor(Node* node, InstanceType instance_type, FieldAccess const& access);
