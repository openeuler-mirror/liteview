...
public:
    ...
    void SetCurrentPosition(const SourcePosition& pos) { current_position_ = pos; }
...
private:
    ...
    static SourcePosition UnknownSourcePosition(Zone* zone) { return SourcePosition::Unknown(); }
