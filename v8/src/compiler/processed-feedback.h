...
public:
    NamedAccessFeedback(NameRef const& name, ZoneVector<MapRef> const& maps, FeedbackSlotKind slot_kind);
...
public:
    CallFeedback(base::Optional<HeapObjectRef> target, float frequency, SpeculationMode mode, CallFeedbackContent call_feedback_content, FeedbackSlotKind slot_kind)
...
public:
    explicit SingleValueFeedback(T value, FeedbackSlotKind slot_kind)
        ...
        , value_(value)
    {
        DCHECK((K == kBinaryOperation && slot_kind == FeedbackSlotKind::kBinaryOp) || (K == kCompareOperation && slot_kind == FeedbackSlotKind::kCompareOp)
            || (K == kForIn && slot_kind == FeedbackSlotKind::kForIn) || (K == kInstanceOf && slot_kind == FeedbackSlotKind::kInstanceOf)
...
class InstanceOfFeedback : public SingleValueFeedback<base::Optional<JSObjectRef>, ProcessedFeedback::kInstanceOf> {
