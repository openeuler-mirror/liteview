...
public:
    ...
    Node* CEntryStubConstant(int result_size, SaveFPRegsMode save_doubles = SaveFPRegsMode::kIgnore, ArgvMode argv_mode = ArgvMode::kStack, bool builtin_exit_frame = false);
    ...
    Node* BooleanConstant(bool is_true) { return is_true ? TrueConstant() : FalseConstant(); }
