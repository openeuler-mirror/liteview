...
public:
    ...
    MemOperand MemoryOperand(AddressingMode* mode = NULL, size_t first_index = 0) { return MemoryOperand(mode, &first_index); }
...
static inline bool HasRegisterInput(Instruction* instr, size_t index) { return instr->InputAt(index)->IsRegister(); }

namespace {

class OutOfLineRecordWrite final : public OutOfLineCode {
public:
    OutOfLineRecordWrite(CodeGenerator* gen, Register object, Register offset, Register value, Register scratch0, Register scratch1, RecordWriteMode mode, StubCallMode stub_mode,
    ...
    OutOfLineRecordWrite(CodeGenerator* gen, Register object, int32_t offset, Register value, Register scratch0, Register scratch1, RecordWriteMode mode, StubCallMode stub_mode,
        UnwindingInfoWriter* unwinding_info_writer)
        : OutOfLineCode(gen)
        , object_(object)
        , offset_(no_reg)
    ...
    void Generate() final
    {
        ...
        __ CheckPageFlag(value_, scratch0_, MemoryChunk::kPointersToHereAreInterestingOrInSharedHeapMask, eq, exit());
        if (offset_ == no_reg) {
...
void AdjustStackPointerForTailCall(
    TurboAssembler* tasm, FrameAccessState* state, int new_slot_above_sp, ZoneVector<Register>* pending_pushes = nullptr, bool allow_shrinkage = true)
{
...
void CodeGenerator::BailoutIfDeoptimized()
{
    ...
    __ LoadS32(r11, FieldMemOperand(r11, CodeDataContainer::kKindSpecificFlagsOffset), r0);
    __ TestBit(r11, Code::kMarkedForDeoptimizationBit);
    __ Jump(BUILTIN_CODE(isolate(), CompileLazyDeoptimizedCode), RelocInfo::CODE_TARGET, ne, cr0);
}
...
CodeGenerator::CodeGenResult CodeGenerator::AssembleArchInstruction(Instruction* instr)
{
    ...
    case kArchCallCodeObject: {
        v8::internal::Assembler::BlockTrampolinePoolScope block_trampoline_pool(tasm());
    ...
    case kArchCallJSFunction: {
        ...
        if (v8_flags.debug_code) {
            ...
            __ LoadTaggedPointerField(kScratchReg, FieldMemOperand(func, JSFunction::kContextOffset), r0);
            __ CmpS64(cp, kScratchReg);
            __ Assert(eq, AbortReason::kWrongFunctionContext);
        }
        static_assert(kJavaScriptCallCodeStartRegister == r5, "ABI mismatch");
        __ LoadTaggedPointerField(r5, FieldMemOperand(func, JSFunction::kCodeOffset), r0);
    ...
    case kArchCallCFunction: {
        ...
        if (instr->InputAt(0)->IsImmediate()) {
            ...
            __ CallCFunction(ref, num_gp_parameters, num_fp_parameters, has_function_descriptor);
        } else {
            Register func = i.InputRegister(0);
            __ CallCFunction(func, num_gp_parameters, num_fp_parameters, has_function_descriptor);
        }
#if V8_ENABLE_WEBASSEMBLY
        if (isWasmCapiFunction) {
            ...
            __ patch_wasm_cpi_return_address(kScratchReg, start_pc_offset, offset_since_start_call);
    ...
    case kArchAbortCSADcheck:
        DCHECK(i.InputRegister(0) == r4);
        {
            ...
            __ Call(isolate()->builtins()->code_handle(Builtin::kAbortCSADcheck), RelocInfo::CODE_TARGET);
        }
        __ stop();
        break;
    ...
    case kPPC_ShiftLeftPair: {
        ...
        if (instr->InputAt(2)->IsImmediate()) {
            __ ShiftLeftPair(i.OutputRegister(0), second_output, i.InputRegister(0), i.InputRegister(1), i.InputInt32(2));
        } else {
            __ ShiftLeftPair(i.OutputRegister(0), second_output, i.InputRegister(0), i.InputRegister(1), kScratchReg, i.InputRegister(2));
        }
        break;
    }
    case kPPC_ShiftRightPair: {
        Register second_output = instr->OutputCount() >= 2 ? i.OutputRegister(1) : i.TempRegister(0);
        if (instr->InputAt(2)->IsImmediate()) {
            __ ShiftRightPair(i.OutputRegister(0), second_output, i.InputRegister(0), i.InputRegister(1), i.InputInt32(2));
        } else {
            __ ShiftRightPair(i.OutputRegister(0), second_output, i.InputRegister(0), i.InputRegister(1), kScratchReg, i.InputRegister(2));
        }
        break;
    }
    case kPPC_ShiftRightAlgPair: {
        Register second_output = instr->OutputCount() >= 2 ? i.OutputRegister(1) : i.TempRegister(0);
        if (instr->InputAt(2)->IsImmediate()) {
            __ ShiftRightAlgPair(i.OutputRegister(0), second_output, i.InputRegister(0), i.InputRegister(1), i.InputInt32(2));
        } else {
            __ ShiftRightAlgPair(i.OutputRegister(0), second_output, i.InputRegister(0), i.InputRegister(1), kScratchReg, i.InputRegister(2));
        }
        break;
    }
#endif
...
#else
        __ MovInt64ToDouble(i.OutputDoubleRegister(), i.InputRegister(0), i.InputRegister(1));
#endif
        DCHECK_EQ(LeaveRC, i.OutputRCBit());
        break;
    ...
    case kAtomicCompareExchangeInt8:
        __ AtomicCompareExchange<int8_t>(MemOperand(i.InputRegister(0), i.InputRegister(1)), i.InputRegister(2), i.InputRegister(3), i.OutputRegister(), kScratchReg);
        break;
    case kPPC_AtomicCompareExchangeUint8:
        __ AtomicCompareExchange<uint8_t>(MemOperand(i.InputRegister(0), i.InputRegister(1)), i.InputRegister(2), i.InputRegister(3), i.OutputRegister(), kScratchReg);
        break;
...
#undef SIMD_UNOP_LIST
    ...
    case kPPC_F64x2ReplaceLane: {
        ...
        __ F64x2ReplaceLane(i.OutputSimd128Register(), i.InputSimd128Register(0), i.InputDoubleRegister(2), i.InputInt8(1), kScratchReg, kScratchSimd128Reg);
        break;
    }
    case kPPC_F32x4ReplaceLane: {
        DCHECK_EQ(i.OutputSimd128Register(), i.InputSimd128Register(0));
        __ F32x4ReplaceLane(i.OutputSimd128Register(), i.InputSimd128Register(0), i.InputDoubleRegister(2), i.InputInt8(1), kScratchReg, kScratchDoubleReg, kScratchSimd128Reg);
        break;
    }
    ...
    case kPPC_I64x2Mul: {
        __ I64x2Mul(i.OutputSimd128Register(), i.InputSimd128Register(0), i.InputSimd128Register(1), ip, r0, i.ToRegister(instr->TempAt(0)), kScratchSimd128Reg);
        break;
    }
    case kPPC_F64x2Min: {
    ...
    case kPPC_I64x2Abs: {
        __ I64x2Abs(i.OutputSimd128Register(), i.InputSimd128Register(0), kScratchSimd128Reg);
        break;
    }
    case kPPC_I32x4Abs: {
        __ I32x4Abs(i.OutputSimd128Register(), i.InputSimd128Register(0), kScratchSimd128Reg);
        break;
    }
    case kPPC_I16x8Abs: {
        __ I16x8Abs(i.OutputSimd128Register(), i.InputSimd128Register(0), kScratchSimd128Reg);
        break;
    }
    case kPPC_I16x8Neg: {
        __ I16x8Neg(i.OutputSimd128Register(), i.InputSimd128Register(0), kScratchSimd128Reg);
        break;
    }
    case kPPC_I8x16Abs: {
        __ I8x16Abs(i.OutputSimd128Register(), i.InputSimd128Register(0), kScratchSimd128Reg);
        break;
    }
    case kPPC_I8x16Neg: {
        __ I8x16Neg(i.OutputSimd128Register(), i.InputSimd128Register(0), kScratchSimd128Reg);
        break;
    }
    case kPPC_S128And: {
...
#undef SIMD_ALL_TRUE
    ...
    case kPPC_I64x2UConvertI32x4Low: {
        ...
        __ vinsertd(kScratchSimd128Reg, kScratchSimd128Reg, Operand(1 * lane_width_in_bytes));
        __ vand(i.OutputSimd128Register(), kScratchSimd128Reg, i.OutputSimd128Register());
        break;
    }
    ...
    case kPPC_I16x8SConvertI32x4: {
        __ vpkswss(i.OutputSimd128Register(), i.InputSimd128Register(1), i.InputSimd128Register(0));
        break;
    }
    case kPPC_I16x8UConvertI32x4: {
        __ vpkswus(i.OutputSimd128Register(), i.InputSimd128Register(1), i.InputSimd128Register(0));
        break;
    }
    case kPPC_I8x16SConvertI16x8: {
        __ vpkshss(i.OutputSimd128Register(), i.InputSimd128Register(1), i.InputSimd128Register(0));
        break;
    }
    case kPPC_I8x16UConvertI16x8: {
        __ vpkshus(i.OutputSimd128Register(), i.InputSimd128Register(1), i.InputSimd128Register(0));
        break;
    }
    ...
    case kPPC_I16x8RoundingAverageU: {
        __ vavguh(i.OutputSimd128Register(), i.InputSimd128Register(0), i.InputSimd128Register(1));
        break;
    }
    case kPPC_I8x16RoundingAverageU: {
        __ vavgub(i.OutputSimd128Register(), i.InputSimd128Register(0), i.InputSimd128Register(1));
        break;
    }
    ...
    case kPPC_I64x2BitMask: {
        if (CpuFeatures::IsSupported(PPC_10_PLUS)) {
            ...
            __ vbpermq(kScratchSimd128Reg, i.InputSimd128Register(0), kScratchSimd128Reg);
    ...
    case kPPC_I32x4DotI16x8S: {
        __ vxor(kScratchSimd128Reg, kScratchSimd128Reg, kScratchSimd128Reg);
        __ vmsumshm(i.OutputSimd128Register(), i.InputSimd128Register(0), i.InputSimd128Register(1), kScratchSimd128Reg);
        break;
    }
    case kPPC_F32x4Pmin: {
        Simd128Register dst = i.OutputSimd128Register(), src0 = i.InputSimd128Register(0), src1 = i.InputSimd128Register(1);
...
#undef ASSEMBLE_LOAD_TRANSFORM
    ...
    case kPPC_S128Load16Lane: {
        ...
        MAYBE_REVERSE_BYTES(kScratchSimd128Reg, xxbrh)
        __ vinserth(dst, kScratchSimd128Reg, Operand((7 - i.InputUint8(3)) * lane_width_in_bytes));
        break;
    }
    case kPPC_S128Load32Lane: {
        ...
        MAYBE_REVERSE_BYTES(kScratchSimd128Reg, xxbrw)
        __ vinsertw(dst, kScratchSimd128Reg, Operand((3 - i.InputUint8(3)) * lane_width_in_bytes));
        break;
    }
    case kPPC_S128Load64Lane: {
        ...
        MAYBE_REVERSE_BYTES(kScratchSimd128Reg, xxbrd)
        __ vinsertd(dst, kScratchSimd128Reg, Operand((1 - i.InputUint8(3)) * lane_width_in_bytes));
        break;
    }
    case kPPC_S128Store8Lane: {
        ...
        MemOperand operand = i.MemoryOperand(&mode, &index);
        DCHECK_EQ(mode, kMode_MRR);
        __ vextractub(kScratchSimd128Reg, i.InputSimd128Register(0), Operand(15 - i.InputUint8(3)));
    ...
    case kPPC_S128Store16Lane: {
        ...
        MemOperand operand = i.MemoryOperand(&mode, &index);
        DCHECK_EQ(mode, kMode_MRR);
        __ vextractuh(kScratchSimd128Reg, i.InputSimd128Register(0), Operand((7 - i.InputUint8(3)) * lane_width_in_bytes));
        MAYBE_REVERSE_BYTES(kScratchSimd128Reg, xxbrh)
    ...
    case kPPC_S128Store32Lane: {
        ...
        MemOperand operand = i.MemoryOperand(&mode, &index);
        DCHECK_EQ(mode, kMode_MRR);
        __ vextractuw(kScratchSimd128Reg, i.InputSimd128Register(0), Operand((3 - i.InputUint8(3)) * lane_width_in_bytes));
        MAYBE_REVERSE_BYTES(kScratchSimd128Reg, xxbrw)
    ...
    case kPPC_S128Store64Lane: {
        ...
        MemOperand operand = i.MemoryOperand(&mode, &index);
        DCHECK_EQ(mode, kMode_MRR);
        __ vextractd(kScratchSimd128Reg, i.InputSimd128Register(0), Operand((1 - i.InputUint8(3)) * lane_width_in_bytes));
        MAYBE_REVERSE_BYTES(kScratchSimd128Reg, xxbrd)
...
#undef EXT_ADD_PAIRWISE
    case kPPC_I16x8Q15MulRSatS: {
        __ vxor(kScratchSimd128Reg, kScratchSimd128Reg, kScratchSimd128Reg);
        __ vmhraddshs(i.OutputSimd128Register(), i.InputSimd128Register(0), i.InputSimd128Register(1), kScratchSimd128Reg);
        break;
    }
#define EXT_MUL(mul_even, mul_odd)                                                                                                                                                 \
    ...
    case kPPC_I64x2ExtMulLowI32x4S: {
        ...
        __ vextractd(kScratchSimd128Reg, kScratchSimd128Reg, Operand(1 * lane_width_in_bytes));
...
void CodeGenerator::AssembleArchDeoptBranch(Instruction* instr, BranchInfo* branch) { AssembleArchBranch(instr, branch); }

void CodeGenerator::AssembleArchJumpRegardlessOfAssemblyOrder(RpoNumber target) { __ b(GetLabel(target)); }
...
void CodeGenerator::AssembleArchSelect(Instruction* instr, FlagsCondition condition) { UNIMPLEMENTED(); }
...
void CodeGenerator::FinishFrame(Frame* frame)
{
    ...
    const RegList saves = V8_EMBEDDED_CONSTANT_POOL_BOOL ? call_descriptor->CalleeSavedRegisters() - kConstantPoolRegister : call_descriptor->CalleeSavedRegisters();
    if (!saves.is_empty()) {
    ...
    if (required_slots > 0) {
        ...
        if (info()->IsWasm() && required_slots * kSystemPointerSize > 4 * KB) {
            ...
            if (required_slots * kSystemPointerSize < v8_flags.stack_size * KB) {
                Register scratch = ip;
                __ LoadU64(scratch, FieldMemOperand(kWasmInstanceRegister, WasmInstanceObject::kRealStackLimitAddressOffset), r0);
                __ LoadU64(scratch, MemOperand(scratch), r0);
                __ AddS64(scratch, scratch, Operand(required_slots * kSystemPointerSize), r0);
...
void CodeGenerator::SetPendingMove(MoveOperands* move)
{
    ...
    } else if (move->source().IsConstant() && (move->destination().IsDoubleStackSlot() || move->destination().IsFloatStackSlot())) {
        move_cycle_.pending_double_scratch_register_use = true;
    }
}
