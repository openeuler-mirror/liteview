...
class SpillPlacer {
public:
    SpillPlacer(LiveRangeFinder* finder, TopTierRegisterAllocationData* data, Zone* zone);
...
private:
    ...
    bool IsLatestVreg(int vreg) const { return assigned_indices_ > 0 && vreg_numbers_[assigned_indices_ - 1] == vreg; }
