...
public:
    ...
    Operand InputImmediate(size_t index) const { return ToImmediate(instr_->InputAt(index)); }
    ...
    MemOperand InputOffset(size_t first_index = 0) { return InputOffset(&first_index); }
...
void CodeGenerator::BailoutIfDeoptimized()
{
    ...
    __ ldr(scratch, FieldMemOperand(scratch, CodeDataContainer::kKindSpecificFlagsOffset));
...
void CodeGenerator::PrepareForDeoptimizationExits(ZoneDeque<DeoptimizationExit*>* exits) { __ CheckConstPool(true, false); }
