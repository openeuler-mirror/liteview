...
public:
    ...
    Immediate ToImmediate(InstructionOperand* operand)
    {
        ...
        if (constant.type() == Constant::kInt32 && RelocInfo::IsWasmReference(constant.rmode())) {
            return Immediate(static_cast<Address>(constant.ToInt32()), constant.rmode());
        }
#endif // V8_ENABLE_WEBASSEMBLY
...
bool VerifyOutputOfAtomicPairInstr(IA32OperandConverter* converter, const Instruction* instr)
{
    ...
    if (instr->OutputCount() == 1) {
        return (converter->OutputRegister(0) == eax && converter->TempRegister(0) == edx) || (converter->OutputRegister(0) == edx && converter->TempRegister(0) == eax);
    }
...
void CodeGenerator::BailoutIfDeoptimized()
{
    ...
    __ test(FieldOperand(eax, CodeDataContainer::kKindSpecificFlagsOffset), Immediate(1 << Code::kMarkedForDeoptimizationBit));
    __ pop(eax); // Restore eax.
...
CodeGenerator::CodeGenResult CodeGenerator::AssembleArchInstruction(Instruction* instr)
{
    ...
    case kIA32AddPair: {
        ...
        bool use_temp = false;
        if ((HasRegisterInput(instr, 1) && i.OutputRegister(0).code() == i.InputRegister(1).code()) || i.OutputRegister(0).code() == i.InputRegister(3).code()) {
    ...
    case kIA32I8x16Swizzle: {
        __ I8x16Swizzle(i.OutputSimd128Register(), i.InputSimd128Register(0), i.InputSimd128Register(1), kScratchDoubleReg, i.TempRegister(0), MiscField::decode(instr->opcode()));
        break;
    }
    ...
    case kIA32I32x4TruncF64x2UZero: {
        __ I32x4TruncF64x2UZero(i.OutputSimd128Register(), i.InputSimd128Register(0), i.TempRegister(0), kScratchDoubleReg);
        break;
    }
    case kIA32I32x4TruncF32x4U: {
        __ I32x4TruncF32x4U(i.OutputSimd128Register(), i.InputSimd128Register(0), i.TempRegister(0), kScratchDoubleReg);
        break;
    }
    case kIA32Cvttps2dq: {
    ...
    if (required_slots > 0) {
        ...
        if (info()->IsWasm() && required_slots * kSystemPointerSize > 4 * KB) {
            ...
            if (required_slots * kSystemPointerSize < v8_flags.stack_size * KB) {
                ...
                __ push(scratch);
                __ mov(scratch, FieldOperand(kWasmInstanceRegister, WasmInstanceObject::kRealStackLimitAddressOffset));
            ...
            __ wasm_call(wasm::WasmCode::kWasmStackOverflow, RelocInfo::WASM_STUB_CALL);
