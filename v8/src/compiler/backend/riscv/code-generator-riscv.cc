...
#define TRACE_UNIMPL() PrintF("UNIMPLEMENTED code_generator_riscv64: %s at line %d\n", __FUNCTION__, __LINE__)
...
public:
    ...
    FloatRegister OutputSingleRegister(size_t index = 0) { return ToSingleRegister(instr_->OutputAt(index)); }

    FloatRegister InputSingleRegister(size_t index) { return ToSingleRegister(instr_->InputAt(index)); }
...
public:
    OutOfLineRecordWrite(CodeGenerator* gen, Register object, Register index, Register value, Register scratch0, Register scratch1, RecordWriteMode mode, StubCallMode stub_mode)
        : OutOfLineCode(gen)
        , object_(object)
        , index_(index)
        , value_(value)
...
void CodeGenerator::BailoutIfDeoptimized()
{
    ...
    __ Jump(BUILTIN_CODE(isolate(), CompileLazyDeoptimizedCode), RelocInfo::CODE_TARGET, ne, kScratchReg, Operand(zero_reg));
}
...
CodeGenerator::CodeGenResult CodeGenerator::AssembleArchInstruction(Instruction* instr)
{
    ...
    case kRiscvAddPair:
        __ AddPair(i.OutputRegister(0), i.OutputRegister(1), i.InputRegister(0), i.InputRegister(1), i.InputRegister(2), i.InputRegister(3), kScratchReg, kScratchReg2);
        break;
    case kRiscvSubPair:
        __ SubPair(i.OutputRegister(0), i.OutputRegister(1), i.InputRegister(0), i.InputRegister(1), i.InputRegister(2), i.InputRegister(3), kScratchReg, kScratchReg2);
        break;
    case kRiscvAndPair:
    ...
    case kRiscvXorPair:
        ...
        break;
    case kRiscvMulPair:
        __ MulPair(i.OutputRegister(0), i.OutputRegister(1), i.InputRegister(0), i.InputRegister(1), i.InputRegister(2), i.InputRegister(3), kScratchReg, kScratchReg2);
        break;
    case kRiscvShlPair: {
...
#undef ATOMIC_BINOP_CASE
    ...
    case kRiscvRvvSt: {
        ...
        Register dst = i.MemoryOperand().offset() == 0 ? i.MemoryOperand().rm() : kScratchReg;
    ...
    case kRiscvS128AndNot: {
        ...
        __ vand_vv(i.OutputSimd128Register(), i.InputSimd128Register(0), kSimd128ScratchReg);
        break;
    }
    ...
    case kRiscvI8x16RoundingAverageU: {
        ...
        __ vwaddu_vv(kSimd128ScratchReg, i.InputSimd128Register(0), i.InputSimd128Register(1));
        __ li(kScratchReg, 1);
    ...
    case kRiscvI8x16Eq: {
        __ WasmRvvEq(i.OutputSimd128Register(), i.InputSimd128Register(0), i.InputSimd128Register(1), E8, m1);
        break;
    }
    case kRiscvI16x8Eq: {
        __ WasmRvvEq(i.OutputSimd128Register(), i.InputSimd128Register(0), i.InputSimd128Register(1), E16, m1);
        break;
    }
    case kRiscvI32x4Eq: {
        __ WasmRvvEq(i.OutputSimd128Register(), i.InputSimd128Register(0), i.InputSimd128Register(1), E32, m1);
        break;
    }
    case kRiscvI64x2Eq: {
        __ WasmRvvEq(i.OutputSimd128Register(), i.InputSimd128Register(0), i.InputSimd128Register(1), E64, m1);
        break;
    }
    case kRiscvI8x16Ne: {
        __ WasmRvvNe(i.OutputSimd128Register(), i.InputSimd128Register(0), i.InputSimd128Register(1), E8, m1);
        break;
    }
    case kRiscvI16x8Ne: {
        __ WasmRvvNe(i.OutputSimd128Register(), i.InputSimd128Register(0), i.InputSimd128Register(1), E16, m1);
        break;
    }
    case kRiscvI32x4Ne: {
        __ WasmRvvNe(i.OutputSimd128Register(), i.InputSimd128Register(0), i.InputSimd128Register(1), E32, m1);
        break;
    }
    case kRiscvI64x2Ne: {
        __ WasmRvvNe(i.OutputSimd128Register(), i.InputSimd128Register(0), i.InputSimd128Register(1), E64, m1);
        break;
    }
    case kRiscvI8x16GeS: {
        __ WasmRvvGeS(i.OutputSimd128Register(), i.InputSimd128Register(0), i.InputSimd128Register(1), E8, m1);
        break;
    }
    case kRiscvI16x8GeS: {
        __ WasmRvvGeS(i.OutputSimd128Register(), i.InputSimd128Register(0), i.InputSimd128Register(1), E16, m1);
        break;
    }
    case kRiscvI32x4GeS: {
        __ WasmRvvGeS(i.OutputSimd128Register(), i.InputSimd128Register(0), i.InputSimd128Register(1), E32, m1);
        break;
    }
    case kRiscvI64x2GeS: {
        __ WasmRvvGeS(i.OutputSimd128Register(), i.InputSimd128Register(0), i.InputSimd128Register(1), E64, m1);
        break;
    }
    case kRiscvI8x16GeU: {
        __ WasmRvvGeU(i.OutputSimd128Register(), i.InputSimd128Register(0), i.InputSimd128Register(1), E8, m1);
        break;
    }
    case kRiscvI16x8GeU: {
        __ WasmRvvGeU(i.OutputSimd128Register(), i.InputSimd128Register(0), i.InputSimd128Register(1), E16, m1);
        break;
    }
    case kRiscvI32x4GeU: {
        __ WasmRvvGeU(i.OutputSimd128Register(), i.InputSimd128Register(0), i.InputSimd128Register(1), E32, m1);
        break;
    }
    case kRiscvI8x16GtS: {
        __ WasmRvvGtS(i.OutputSimd128Register(), i.InputSimd128Register(0), i.InputSimd128Register(1), E8, m1);
        break;
    }
    case kRiscvI16x8GtS: {
        __ WasmRvvGtS(i.OutputSimd128Register(), i.InputSimd128Register(0), i.InputSimd128Register(1), E16, m1);
        break;
    }
    case kRiscvI32x4GtS: {
        __ WasmRvvGtS(i.OutputSimd128Register(), i.InputSimd128Register(0), i.InputSimd128Register(1), E32, m1);
        break;
    }
    case kRiscvI64x2GtS: {
        __ WasmRvvGtS(i.OutputSimd128Register(), i.InputSimd128Register(0), i.InputSimd128Register(1), E64, m1);
        break;
    }
    case kRiscvI8x16GtU: {
        __ WasmRvvGtU(i.OutputSimd128Register(), i.InputSimd128Register(0), i.InputSimd128Register(1), E8, m1);
        break;
    }
    case kRiscvI16x8GtU: {
        __ WasmRvvGtU(i.OutputSimd128Register(), i.InputSimd128Register(0), i.InputSimd128Register(1), E16, m1);
        break;
    }
    case kRiscvI32x4GtU: {
        __ WasmRvvGtU(i.OutputSimd128Register(), i.InputSimd128Register(0), i.InputSimd128Register(1), E32, m1);
        break;
    }
    case kRiscvI8x16Shl: {
        __ VU.set(kScratchReg, E8, m1);
    ...
    case kRiscvF64x2Min: {
        ...
        __ vmfeq_vv(v0, i.InputSimd128Register(0), i.InputSimd128Register(0));
        __ vmfeq_vv(kSimd128ScratchReg, i.InputSimd128Register(1), i.InputSimd128Register(1));
        __ vand_vv(v0, v0, kSimd128ScratchReg);
        __ li(kScratchReg, kNaN);
        __ vmv_vx(kSimd128ScratchReg, kScratchReg);
        __ vfmin_vv(kSimd128ScratchReg, i.InputSimd128Register(1), i.InputSimd128Register(0), Mask);
        __ vmv_vv(i.OutputSimd128Register(), kSimd128ScratchReg);
        break;
    }
    case kRiscvF64x2Max: {
        ...
        __ li(kScratchReg, kNaN);
        __ vmv_vx(kSimd128ScratchReg, kScratchReg);
        __ vfmax_vv(kSimd128ScratchReg, i.InputSimd128Register(1), i.InputSimd128Register(0), Mask);
        __ vmv_vv(i.OutputSimd128Register(), kSimd128ScratchReg);
        break;
    }
#endif
    ...
    case kRiscvF64x2Qfma: {
        __ VU.set(kScratchReg, E64, m1);
        __ vfmadd_vv(i.InputSimd128Register(1), i.InputSimd128Register(2), i.InputSimd128Register(0));
        __ vmv_vv(i.OutputSimd128Register(), i.InputSimd128Register(1));
        break;
    }
    case kRiscvF64x2Qfms: {
        __ VU.set(kScratchReg, E64, m1);
        __ vfnmsub_vv(i.InputSimd128Register(1), i.InputSimd128Register(2), i.InputSimd128Register(0));
        __ vmv_vv(i.OutputSimd128Register(), i.InputSimd128Register(1));
        break;
    }
    ...
    case kRiscvF32x4Mul: {
        __ VU.set(kScratchReg, E32, m1);
        __ VU.set(FPURoundingMode::RTZ);
        __ vfmul_vv(i.OutputSimd128Register(), i.InputSimd128Register(1), i.InputSimd128Register(0));
        break;
    }
    case kRiscvF32x4Eq: {
        __ VU.set(kScratchReg, E32, m1);
...
void CodeGenerator::AssembleArchJumpRegardlessOfAssemblyOrder(RpoNumber target) { __ Branch(GetLabel(target)); }
...
void CodeGenerator::AssembleConstructFrame()
{
    ...
    if (required_slots > 0) {
        ...
        if (info()->IsWasm() && required_slots > 128) {
            ...
            if ((required_slots * kSystemPointerSize) < (v8_flags.stack_size * 1024)) {
                __ LoadWord(kScratchReg, FieldMemOperand(kWasmInstanceRegister, WasmInstanceObject::kRealStackLimitAddressOffset));
                __ LoadWord(kScratchReg, MemOperand(kScratchReg));
                __ AddWord(kScratchReg, kScratchReg, Operand(required_slots * kSystemPointerSize));
