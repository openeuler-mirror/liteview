...
class V8_EXPORT_PRIVATE AddTypeAssertionsReducer final : public NON_EXPORTED_BASE(AdvancedReducer) {
public:
    ...
    const char* reducer_name() const override { return "AddTypeAssertionsReducer"; }
