...
public:
    ...
    inline int GetTotalFrameSlotCount() const { return slot_allocator_.Size() + return_slot_count_; }
    ...
    bool DidAllocateDoubleRegisters() const { return !allocated_double_registers_->IsEmpty(); }
...
public:
    ...
    int GetSPToFPOffset() const { return GetSPToFPSlotCount() * kSystemPointerSize; }
