...
#define FOREACH_WASM_NON_FLAG_FEATURE(V) V(reftypes, "reference type opcodes", true)
...
#undef NAME
    ...
    static V8_EXPORT_PRIVATE WasmFeatures FromContext(Isolate*, Handle<Context> context);
};
