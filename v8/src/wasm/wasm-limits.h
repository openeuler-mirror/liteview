...
constexpr size_t kV8MaxWasmMemory32Pages = kSystemPointerSize == 4 ? 32767 // = 2 GiB - 64Kib
                                                                   : 65536; // = 4 GiB
constexpr size_t kV8MaxWasmMemory64Pages = kSystemPointerSize == 4 ? 32767 // = 2 GiB - 64Kib
                                                                   : 262144; // = 16 GiB
...
inline uint64_t max_mem32_bytes() { return uint64_t { max_mem32_pages() } * kWasmPageSize; }

inline uint64_t max_mem64_bytes() { return uint64_t { max_mem64_pages() } * kWasmPageSize; }
