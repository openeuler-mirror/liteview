...
bool V8_EXPORT_PRIVATE IsJSCompatibleSignature(const FunctionSig* sig, const WasmModule* module, const WasmFeatures&);
...
#define FOREACH_GC_OPCODE(V) /*              Force 80 columns               */                                                                                                     \
    ...
    V(ArrayCopy, 0xfb18, _, "array.copy") /* not standardized - V8 experimental */                                                                                                 \
