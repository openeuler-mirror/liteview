...
#define FLAG_REF(feat, ...)                                                                                                                                                        \
    if (v8_flags.experimental_wasm_##feat)                                                                                                                                         \
...
// static
WasmFeatures WasmFeatures::FromIsolate(Isolate* isolate) { return FromContext(isolate, handle(isolate->context(), isolate)); }

// static
WasmFeatures WasmFeatures::FromContext(Isolate* isolate, Handle<Context> context)
{
