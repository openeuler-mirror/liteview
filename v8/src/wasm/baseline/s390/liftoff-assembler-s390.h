...
inline MemOperand GetStackSlot(uint32_t offset) { return MemOperand(fp, -offset); }
...
void LiftoffAssembler::LoadInstanceFromFrame(Register dst) { LoadU64(dst, liftoff::GetInstanceOperand()); }
...
void LiftoffAssembler::SpillInstance(Register instance) { StoreU64(instance, liftoff::GetInstanceOperand()); }
    ...
    Register dst_addr, Register offset_reg, int32_t offset_imm, LiftoffRegister src, LiftoffRegList /* pinned */, SkipWriteBarrier skip_write_barrier)
{
    ...
    Label write_barrier;
    Label exit;
    CheckPageFlag(dst_addr, r1, MemoryChunk::kPointersFromHereAreInterestingMask, ne, &write_barrier);
    b(&exit);
    bind(&write_barrier);
    ...
    CheckPageFlag(src.gp(), r1, MemoryChunk::kPointersToHereAreInterestingMask, eq, &exit);
    lay(r1, dst_op);
...
{
    Register tmp1 = GetUnusedRegister(kGpReg, LiftoffRegList { dst_addr, offset_reg, value, result }).gp();
    Register tmp2 = GetUnusedRegister(kGpReg, LiftoffRegList { dst_addr, offset_reg, value, result, tmp1 }).gp();
...
void LiftoffAssembler::Move(Register dst, Register src, ValueKind kind) { mov(dst, src); }
...
void LiftoffAssembler::emit_i32_eqz(Register dst, Register src) { EMIT_EQZ(ltr, src); }
...
void LiftoffAssembler::emit_i64_eqz(Register dst, LiftoffRegister src) { EMIT_EQZ(ltgr, src.gp()); }
...
#define EMIT_SIMD_BINOP_RR(name, op)                                                                                                                                               \
    void LiftoffAssembler::emit_##name(LiftoffRegister dst, LiftoffRegister lhs, LiftoffRegister rhs) { op(dst.fp(), lhs.fp(), rhs.fp()); }
...
#define EMIT_SIMD_SHIFT_RR(name, op)                                                                                                                                               \
    void LiftoffAssembler::emit_##name(LiftoffRegister dst, LiftoffRegister lhs, LiftoffRegister rhs) { op(dst.fp(), lhs.fp(), rhs.gp(), kScratchDoubleReg); }
...
#define EMIT_SIMD_SHIFT_RI(name, op)                                                                                                                                               \
    void LiftoffAssembler::emit_##name(LiftoffRegister dst, LiftoffRegister lhs, int32_t rhs) { op(dst.fp(), lhs.fp(), Operand(rhs), r0, kScratchDoubleReg); }
...
#define EMIT_SIMD_EXTRACT_LANE(name, op, dtype)                                                                                                                                    \
    void LiftoffAssembler::emit_##name(LiftoffRegister dst, LiftoffRegister src, uint8_t imm_lane_idx) { op(dst.dtype(), src.fp(), imm_lane_idx, r0); }
...
#define EMIT_SIMD_EXT_MUL(name, op)                                                                                                                                                \
    void LiftoffAssembler::emit_##name(LiftoffRegister dst, LiftoffRegister src1, LiftoffRegister src2) { op(dst.fp(), src1.fp(), src2.fp(), kScratchDoubleReg); }
...
#define EMIT_SIMD_ALL_TRUE(name, op)                                                                                                                                               \
    void LiftoffAssembler::emit_##name(LiftoffRegister dst, LiftoffRegister src) { op(dst.gp(), src.fp(), r0, kScratchDoubleReg); }
...
#define EMIT_SIMD_QFM(name, op)                                                                                                                                                    \
    void LiftoffAssembler::emit_##name(LiftoffRegister dst, LiftoffRegister src1, LiftoffRegister src2, LiftoffRegister src3) { op(dst.fp(), src1.fp(), src2.fp(), src3.fp()); }
...
void LiftoffAssembler::emit_i64x2_mul(LiftoffRegister dst, LiftoffRegister lhs, LiftoffRegister rhs) { I64x2Mul(dst.fp(), lhs.fp(), rhs.fp(), r0, r1, ip); }

void LiftoffAssembler::emit_i32x4_ge_u(LiftoffRegister dst, LiftoffRegister lhs, LiftoffRegister rhs) { I32x4GeU(dst.fp(), lhs.fp(), rhs.fp(), kScratchDoubleReg); }

void LiftoffAssembler::emit_i16x8_ge_u(LiftoffRegister dst, LiftoffRegister lhs, LiftoffRegister rhs) { I16x8GeU(dst.fp(), lhs.fp(), rhs.fp(), kScratchDoubleReg); }

void LiftoffAssembler::emit_i8x16_ge_u(LiftoffRegister dst, LiftoffRegister lhs, LiftoffRegister rhs) { I8x16GeU(dst.fp(), lhs.fp(), rhs.fp(), kScratchDoubleReg); }
...
void LiftoffAssembler::emit_i32x4_relaxed_trunc_f32x4_s(LiftoffRegister dst, LiftoffRegister src) { I32x4SConvertF32x4(dst.fp(), src.fp(), kScratchDoubleReg, r0); }

void LiftoffAssembler::emit_i32x4_relaxed_trunc_f32x4_u(LiftoffRegister dst, LiftoffRegister src) { I32x4UConvertF32x4(dst.fp(), src.fp(), kScratchDoubleReg, r0); }
...
void LiftoffAssembler::emit_f32x4_relaxed_min(LiftoffRegister dst, LiftoffRegister lhs, LiftoffRegister rhs) { emit_f32x4_pmin(dst, lhs, rhs); }

void LiftoffAssembler::emit_f32x4_relaxed_max(LiftoffRegister dst, LiftoffRegister lhs, LiftoffRegister rhs) { emit_f32x4_pmax(dst, lhs, rhs); }

void LiftoffAssembler::emit_f64x2_convert_low_i32x4_s(LiftoffRegister dst, LiftoffRegister src) { F64x2ConvertLowI32x4S(dst.fp(), src.fp()); }

void LiftoffAssembler::emit_f64x2_convert_low_i32x4_u(LiftoffRegister dst, LiftoffRegister src) { F64x2ConvertLowI32x4U(dst.fp(), src.fp()); }

void LiftoffAssembler::emit_f64x2_promote_low_f32x4(LiftoffRegister dst, LiftoffRegister src) { F64x2PromoteLowF32x4(dst.fp(), src.fp(), kScratchDoubleReg, r0, r1, ip); }

void LiftoffAssembler::emit_i64x2_bitmask(LiftoffRegister dst, LiftoffRegister src) { I64x2BitMask(dst.gp(), src.fp(), r0, kScratchDoubleReg); }

void LiftoffAssembler::emit_i32x4_bitmask(LiftoffRegister dst, LiftoffRegister src) { I32x4BitMask(dst.gp(), src.fp(), r0, kScratchDoubleReg); }

void LiftoffAssembler::emit_i32x4_dot_i16x8_s(LiftoffRegister dst, LiftoffRegister lhs, LiftoffRegister rhs) { I32x4DotI16x8S(dst.fp(), lhs.fp(), rhs.fp(), kScratchDoubleReg); }

void LiftoffAssembler::emit_i16x8_bitmask(LiftoffRegister dst, LiftoffRegister src) { I16x8BitMask(dst.gp(), src.fp(), r0, kScratchDoubleReg); }
...
void LiftoffAssembler::emit_i8x16_popcnt(LiftoffRegister dst, LiftoffRegister src) { I8x16Popcnt(dst.fp(), src.fp()); }

void LiftoffAssembler::emit_v128_anytrue(LiftoffRegister dst, LiftoffRegister src) { V128AnyTrue(dst.gp(), src.fp(), r0); }

void LiftoffAssembler::emit_i8x16_bitmask(LiftoffRegister dst, LiftoffRegister src) { I8x16BitMask(dst.gp(), src.fp(), r0, ip, kScratchDoubleReg); }
...
void LiftoffAssembler::emit_i32x4_sconvert_f32x4(LiftoffRegister dst, LiftoffRegister src) { I32x4SConvertF32x4(dst.fp(), src.fp(), kScratchDoubleReg, r0); }

void LiftoffAssembler::emit_i32x4_uconvert_f32x4(LiftoffRegister dst, LiftoffRegister src) { I32x4UConvertF32x4(dst.fp(), src.fp(), kScratchDoubleReg, r0); }

void LiftoffAssembler::emit_f32x4_sconvert_i32x4(LiftoffRegister dst, LiftoffRegister src) { F32x4SConvertI32x4(dst.fp(), src.fp(), kScratchDoubleReg, r0); }

void LiftoffAssembler::emit_f32x4_uconvert_i32x4(LiftoffRegister dst, LiftoffRegister src) { F32x4UConvertI32x4(dst.fp(), src.fp(), kScratchDoubleReg, r0); }

void LiftoffAssembler::emit_f32x4_demote_f64x2_zero(LiftoffRegister dst, LiftoffRegister src) { F32x4DemoteF64x2Zero(dst.fp(), src.fp(), kScratchDoubleReg, r0, r1, ip); }

void LiftoffAssembler::emit_i8x16_sconvert_i16x8(LiftoffRegister dst, LiftoffRegister lhs, LiftoffRegister rhs) { I8x16SConvertI16x8(dst.fp(), lhs.fp(), rhs.fp()); }
...
void LiftoffAssembler::emit_i16x8_sconvert_i32x4(LiftoffRegister dst, LiftoffRegister lhs, LiftoffRegister rhs) { I16x8SConvertI32x4(dst.fp(), lhs.fp(), rhs.fp()); }
...
void LiftoffAssembler::emit_i32x4_trunc_sat_f64x2_s_zero(LiftoffRegister dst, LiftoffRegister src) { I32x4TruncSatF64x2SZero(dst.fp(), src.fp(), kScratchDoubleReg); }

void LiftoffAssembler::emit_i32x4_trunc_sat_f64x2_u_zero(LiftoffRegister dst, LiftoffRegister src) { I32x4TruncSatF64x2UZero(dst.fp(), src.fp(), kScratchDoubleReg); }
...
void LiftoffAssembler::DeallocateStackSlot(uint32_t size) { lay(sp, MemOperand(sp, size)); }
...
void LiftoffStackSlots::Construct(int param_slots)
{
    ...
    for (auto& slot : slots_) {
        ...
        case LiftoffAssembler::VarState::kStack: {
            ...
            case kF32: {
                asm_->AllocateStackSpace(stack_decrement - kSystemPointerSize);
                asm_->LoadF32(kScratchDoubleReg, liftoff::GetStackSlot(slot.src_offset_));
