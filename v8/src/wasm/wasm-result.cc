...
Handle<Object> ErrorThrower::Reify()
{
    ...
    Handle<String> message = isolate_->factory()->NewStringFromUtf8(base::VectorOf(error_msg_)).ToHandleChecked();
    Reset();
...
ErrorThrower::ErrorThrower(ErrorThrower&& other) V8_NOEXCEPT : isolate_(other.isolate_),
