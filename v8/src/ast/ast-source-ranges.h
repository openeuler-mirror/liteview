...
struct SourceRange {
    ...
    static SourceRange OpenEnded(int32_t start) { return SourceRange(start, kNoSourcePosition); }
    static SourceRange ContinuationOf(const SourceRange& that, int end = kNoSourcePosition) { return that.IsEmpty() ? Empty() : SourceRange(that.end, end); }
    ...
    // Coverage::Collect().
    static SourceRange FunctionLiteralMarkerRange() { return { kFunctionLiteralSourcePosition, kFunctionLiteralSourcePosition }; }
...
public:
    ...
    bool HasRange(SourceRangeKind kind) override { return kind == SourceRangeKind::kRight; }
...
public:
    ...
    bool HasRange(SourceRangeKind kind) override { return kind == SourceRangeKind::kContinuation; }
...
public:
    ...
    bool HasRange(SourceRangeKind kind) override { return kind == SourceRangeKind::kBody; }
...
public:
    ...
    bool HasRange(SourceRangeKind kind) override { return kind == SourceRangeKind::kThen || kind == SourceRangeKind::kElse; }
...
public:
    ...
    bool HasRange(SourceRangeKind kind) override { return kind == SourceRangeKind::kThen || kind == SourceRangeKind::kElse || kind == SourceRangeKind::kContinuation; }
...
public:
    ...
    bool HasRange(SourceRangeKind kind) override { return kind == SourceRangeKind::kBody || kind == SourceRangeKind::kContinuation; }
...
public:
    ...
    bool HasRange(SourceRangeKind kind) override { return kind == SourceRangeKind::kCatch || kind == SourceRangeKind::kContinuation; }
...
public:
    ...
    bool HasRange(SourceRangeKind kind) override { return kind == SourceRangeKind::kFinally || kind == SourceRangeKind::kContinuation; }
