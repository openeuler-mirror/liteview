...
public:
    ...
    Handle<BytecodeArray> ToBytecodeArray(IsolateT* isolate, int register_count, int parameter_count, Handle<ByteArray> handler_table);
...
private:
    ...
    SourcePositionTableBuilder* source_position_table_builder() { return &source_position_table_builder_; }
