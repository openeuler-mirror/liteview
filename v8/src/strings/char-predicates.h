...
#else
inline bool IsWhiteSpaceSlow(base::uc32 c) { return unibrow::WhiteSpace::Is(c); }
#endif
...
inline bool IsWhiteSpaceOrLineTerminatorSlow(base::uc32 c) { return IsWhiteSpaceSlow(c) || unibrow::IsLineTerminator(c); }
