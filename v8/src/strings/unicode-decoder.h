...
public:
    ...
    bool is_invalid() const { return static_cast<const Decoder&>(*this).is_invalid(); }
    ...
    template <typename Char> void Decode(Char* out, const base::Vector<const uint8_t>& data);
