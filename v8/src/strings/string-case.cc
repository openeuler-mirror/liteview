...
#ifdef DEBUG
bool CheckFastAsciiConvert(char* dst, const char* src, int length, bool changed, bool is_to_lower)
{
...
template <bool is_lower> int FastAsciiConvert(char* dst, const char* src, int length, bool* changed_out)
{
#ifdef DEBUG
    char* saved_dst = dst;
#endif
...
template int FastAsciiConvert<false>(char* dst, const char* src, int length, bool* changed_out);
template int FastAsciiConvert<true>(char* dst, const char* src, int length, bool* changed_out);
