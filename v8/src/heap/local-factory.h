...
#undef ROOT_ACCESSOR
    ...
    Handle<Object> NewRangeError(MessageTemplate template_index) { UNREACHABLE(); }
    ...
    void NumberToStringCacheSet(Handle<Object> number, int hash, Handle<String> js_string);
