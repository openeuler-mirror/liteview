...
public:
    ...
    void AddStrongReferenceForReferenceSummarizer(HeapObject host, HeapObject obj)
    {
...
public:
    ...
    V8_INLINE ConcurrentBitmap<AccessMode::ATOMIC>* bitmap(const BasicMemoryChunk* chunk) const;
...
public:
    ...
    V8_INLINE ConcurrentBitmap<AccessMode::NON_ATOMIC>* bitmap(const BasicMemoryChunk* chunk) const;
...
class AtomicMarkingState final : public MarkingStateBase<AtomicMarkingState, AccessMode::ATOMIC> {
public:
