...
//     ...
//   }
template <typename ResultType, typename ConcreteVisitor> class HeapVisitor : public ObjectVisitorWithCageBases {
public:
...
#define VISIT(TypeName) V8_INLINE ResultType Visit##TypeName(Map map, TypeName object);
...
#undef VISIT
    ...
    template <typename T> static V8_INLINE T Cast(HeapObject object);
};

template <typename ConcreteVisitor> class NewSpaceVisitor : public HeapVisitor<int, ConcreteVisitor> {
public:
