...
#ifdef DEBUG
    size_t AllocatedOnPage(const BasicMemoryChunk* page) const { return allocated_on_page_.at(page); }
#endif
...
#ifdef DEBUG
    std::unordered_map<const BasicMemoryChunk*, size_t, BasicMemoryChunk::Hasher> allocated_on_page_;
#endif
};
