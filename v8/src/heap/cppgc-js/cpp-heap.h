...
public:
    ...
    public:
        ...
        const base::Optional<cppgc::internal::MetricRecorder::GCCycle> ExtractLastFullGcEvent();
        const base::Optional<cppgc::internal::MetricRecorder::GCCycle> ExtractLastYoungGcEvent();
        const base::Optional<cppgc::internal::MetricRecorder::MainThreadIncrementalMark> ExtractLastIncrementalMarkEvent();
    ...
    private:
        ...
        base::Optional<cppgc::internal::MetricRecorder::GCCycle> last_full_gc_event_;
        base::Optional<cppgc::internal::MetricRecorder::GCCycle> last_young_gc_event_;
        base::Optional<cppgc::internal::MetricRecorder::MainThreadIncrementalMark> last_incremental_mark_event_;
    };
    ...
    private:
        base::Optional<cppgc::internal::MarkerBase::PauseConcurrentMarkingScope> pause_scope_;
    };

    static void InitializeOncePerProcess();

    static CppHeap* From(v8::CppHeap* heap) { return static_cast<CppHeap*>(heap); }
    static const CppHeap* From(const v8::CppHeap* heap) { return static_cast<const CppHeap*>(heap); }

    CppHeap(v8::Platform*,
        // const std::vector<std::unique_ptr<cppgc::CustomSpaceBase>>&,
        const std::vector<cppgc::CustomSpaceBase*>&, const v8::WrapperDescriptor&, cppgc::Heap::MarkingType, cppgc::Heap::SweepingType);
    ~CppHeap() final;
    ...
    v8::WrapperDescriptor wrapper_descriptor() const { return wrapper_descriptor_; }
