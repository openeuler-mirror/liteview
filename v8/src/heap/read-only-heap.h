...
public:
    ...
    V8_EXPORT_PRIVATE inline static ReadOnlyRoots GetReadOnlyRoots(HeapObject object);
    ...
    static bool IsReadOnlySpaceShared() { return V8_SHARED_RO_HEAP_BOOL && (!COMPRESS_POINTERS_BOOL || COMPRESS_POINTERS_IN_SHARED_CAGE_BOOL); }
...
protected:
    ...
    static ReadOnlyHeap* CreateInitalHeapForBootstrapping(Isolate* isolate, std::shared_ptr<ReadOnlyArtifacts> artifacts);
...
private:
    ...
    explicit SoleReadOnlyHeap(ReadOnlySpace* ro_space)
