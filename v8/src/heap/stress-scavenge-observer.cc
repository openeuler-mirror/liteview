...
bool StressScavengeObserver::HasRequestedGC() const { return has_requested_gc_; }

void StressScavengeObserver::RequestedGCDone()
{
    size_t new_space_size = heap_->new_space()->Size();
    double current_percent = new_space_size ? new_space_size * 100.0 / heap_->new_space()->Capacity() : 0;
...
double StressScavengeObserver::MaxNewSpaceSizeReached() const { return max_new_space_size_reached_; }
