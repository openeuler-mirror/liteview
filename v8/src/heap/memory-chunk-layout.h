...
enum RememberedSetType { OLD_TO_NEW, OLD_TO_OLD, OLD_TO_SHARED, OLD_TO_CODE = V8_EXTERNAL_CODE_SPACE_BOOL ? OLD_TO_SHARED + 1 : OLD_TO_SHARED, NUMBER_OF_REMEMBERED_SET_TYPES };
...
#define FIELD(Type, Name) k##Name##Offset, k##Name##End = k##Name##Offset + sizeof(Type) - 1
    enum Header {
        ...
        FIELD(size_t, Size), // kSizeOffset, kSizeEnd = kSizeOffset + sizeof(size_t) - 1
