...
public:
    ...
    template <typename Class> Class& To() { return *static_cast<Class*>(this); }
    ...
    MutatorMarkingState& MutatorMarkingStateForTesting() { return mutator_marking_state_; }
...
protected:
    ...
    ConservativeTracingVisitor& conservative_visitor() final { return conservative_marking_visitor_; }
...
void MarkerBase::WriteBarrierForInConstructionObject(HeapObjectHeader& header) { mutator_marking_state_.not_fully_constructed_worklist().Push<AccessMode::kAtomic>(&header); }
