...
public:
    ...
    const BaseSpace* Space(RegularSpaceType space) const { return const_cast<RawHeap&>(*this).Space(space); }

    BaseSpace* CustomSpace(CustomSpaceIndex space_index) { return Space(SpaceIndexForCustomSpace(space_index)); }
    const BaseSpace* CustomSpace(CustomSpaceIndex space_index) const { return const_cast<RawHeap&>(*this).CustomSpace(space_index); }
...
private:
    ...
    const BaseSpace* Space(size_t space_index) const { return const_cast<RawHeap&>(*this).Space(space_index); }
