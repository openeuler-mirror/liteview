...
HeapGrowing::HeapGrowingImpl::~HeapGrowingImpl() { stats_collector_->UnregisterObserver(this); }
...
void HeapGrowing::HeapGrowingImpl::ResetAllocatedObjectSize(size_t allocated_object_size) { ConfigureLimit(allocated_object_size); }
...
void HeapGrowing::HeapGrowingImpl::ConfigureLimit(size_t allocated_object_size)
{
    ...
    size_t estimated_bytes_allocated_during_incremental_gc
        = std::ceil(IncrementalMarkingSchedule::kEstimatedMarkingTimeMs * stats_collector_->GetRecentAllocationSpeedInBytesPerMs());
...
void HeapGrowing::HeapGrowingImpl::DisableForTesting() { disabled_for_testing_ = true; }

HeapGrowing::HeapGrowing(GarbageCollector* collector, StatsCollector* stats_collector, cppgc::Heap::ResourceConstraints constraints, cppgc::Heap::MarkingType marking_support,
...
size_t HeapGrowing::limit_for_atomic_gc() const { return impl_->limit_for_atomic_gc(); }
size_t HeapGrowing::limit_for_incremental_gc() const { return impl_->limit_for_incremental_gc(); }
