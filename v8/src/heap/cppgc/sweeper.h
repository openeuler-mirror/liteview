...
public:
    ...
    static constexpr bool CanDiscardMemory() { return CheckMemoryIsInaccessibleIsNoop(); }
    ...
    bool SweepForAllocationIfRunning(NormalPageSpace* space, size_t min_wanted_size, v8::base::TimeDelta max_duration);
