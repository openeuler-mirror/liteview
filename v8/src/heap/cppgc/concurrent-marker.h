...
public:
    ConcurrentMarkerBase(HeapBase&, MarkingWorklists&, IncrementalMarkingSchedule&, cppgc::Platform*);
    ...
    IncrementalMarkingSchedule& incremental_marking_schedule() const { return incremental_marking_schedule_; }
...
public:
    ConcurrentMarker(HeapBase& heap, MarkingWorklists& marking_worklists, IncrementalMarkingSchedule& incremental_marking_schedule, cppgc::Platform* platform)
