...
public:
    ...
    static const Heap* From(const cppgc::Heap* heap) { return static_cast<const Heap*>(heap); }
    ...
    const EmbedderStackState* override_stack_state() const final { return HeapBase::override_stack_state(); }
