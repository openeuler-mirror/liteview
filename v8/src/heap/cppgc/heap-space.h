...
public:
    ...
    static const NormalPageSpace& From(const BaseSpace& space) { return From(const_cast<BaseSpace&>(space)); }
    ...
    const LinearAllocationBuffer& linear_allocation_buffer() const { return current_lab_; }
...
public:
    ...
    static const LargePageSpace& From(const BaseSpace& space) { return From(const_cast<BaseSpace&>(space)); }
