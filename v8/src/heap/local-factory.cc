...
HeapObject LocalFactory::AllocateRaw(int size, AllocationType allocation, AllocationAlignment alignment)
{
...
Handle<Object> LocalFactory::NumberToStringCacheGet(Object, int) { return undefined_value(); }
