...
V8_WARN_UNUSED_RESULT inline bool IsValidHeapObject(Heap* heap, HeapObject object)
{
...
V8_WARN_UNUSED_RESULT inline bool IsValidCodeObject(Heap* heap, HeapObject object)
{
    if (V8_ENABLE_THIRD_PARTY_HEAP_BOOL) {
