...
public:
    ...
    template <FindMementoMode mode> inline AllocationMemento FindAllocationMemento(Map map, HeapObject object);
    ...
    inline void UpdateAllocationSite(Map map, HeapObject object, PretenuringFeedbackMap* pretenuring_feedback);
    ...
    // their feedback.
    V8_EXPORT_PRIVATE void PretenureAllocationSiteOnNextCollection(AllocationSite site);
