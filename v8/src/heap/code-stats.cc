...
void CodeStatistics::RecordCodeAndMetadataStatistics(HeapObject object, Isolate* isolate)
{
...
void CodeStatistics::CollectCodeCommentStatistics(AbstractCode obj, Isolate* isolate)
{
