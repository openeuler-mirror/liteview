...
bool NativeContextInferrer::Infer(Isolate* isolate, Map map, HeapObject object, Address* native_context)
{
    ...
    case kVisitJSFunction:
        return InferForJSFunction(isolate, JSFunction::cast(object), native_context);
    ...
    case kVisitJSWeakCollection:
        return InferForJSObject(isolate, map, JSObject::cast(object), native_context);
    default:
        return false;
    }
}
...
V8_INLINE void NativeContextStats::IncrementSize(Address context, Map map, HeapObject object, size_t size)
{
