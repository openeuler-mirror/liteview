...
AllocationResult ConcurrentAllocator::AllocateRaw(int size_in_bytes, AllocationAlignment alignment, AllocationOrigin origin)
{
    ...
    return result.IsFailure() ? AllocateInLabSlow(size_in_bytes, alignment, origin) : result;
}

AllocationResult ConcurrentAllocator::AllocateInLabFastUnaligned(int size_in_bytes)
{
    size_in_bytes = ALIGN_TO_ALLOCATION_ALIGNMENT(size_in_bytes);
...
AllocationResult ConcurrentAllocator::AllocateInLabFastAligned(int size_in_bytes, AllocationAlignment alignment)
{
    size_in_bytes = ALIGN_TO_ALLOCATION_ALIGNMENT(size_in_bytes);
