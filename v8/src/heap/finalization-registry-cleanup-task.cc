...
void FinalizationRegistryCleanupTask::RunInternal()
{
    ...
    Handle<Context> context(Context::cast(finalization_registry->native_context()), isolate);
    ...
    InvokeFinalizationRegistryCleanupFromTask(context, finalization_registry, callback);
