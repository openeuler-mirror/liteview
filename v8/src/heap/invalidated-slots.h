...
public:
    ...
    static InvalidatedSlotsFilter OldToOld(MemoryChunk* chunk, LivenessCheck liveness_check);
    static InvalidatedSlotsFilter OldToNew(MemoryChunk* chunk, LivenessCheck liveness_check);
    static InvalidatedSlotsFilter OldToShared(MemoryChunk* chunk, LivenessCheck liveness_check);
...
private:
    ...
    explicit InvalidatedSlotsFilter(MemoryChunk* chunk, InvalidatedSlots* invalidated_slots, RememberedSetType remembered_set_type, LivenessCheck liveness_check);
...
public:
    ...
    explicit InvalidatedSlotsCleanup(MemoryChunk* chunk, InvalidatedSlots* invalidated_slots);
