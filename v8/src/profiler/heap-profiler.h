...
public:
    ...
    AllocationTracker* allocation_tracker() const { return allocation_tracker_.get(); }
    ...
    bool HasBuildEmbedderGraphCallback() { return !build_embedder_graph_callbacks_.empty(); }

    void SetGetDetachednessCallback(v8::HeapProfiler::GetDetachednessCallback callback, void* data);
    bool HasGetDetachednessCallback() const { return get_detachedness_callback_.first != nullptr; }
    ...
    void QueryObjects(Handle<Context> context, debug::QueryObjectPredicate* predicate, std::vector<v8::Global<v8::Object>>* objects);
