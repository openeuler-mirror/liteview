...
#  define CONTEXT_REG(reg, REG) &uc->uc_mcontext.regs[REG_##REG]
# else
...
bool TryHandleSignal(int signum, siginfo_t* info, void* context)
{
    ...
    if (!/*g_thread_in_wasm_code*/IsThreadInWasm())
        return false;
...
//#error "Unsupported architecture."
        uintptr_t* context_ip = nullptr;
#endif
        printf("TryHandleSignal fail\n");
        __debugbreak();
        ...
        if (!TryFindLandingPad(*simulated_ip_reg, &landing_pad))
            return false;
