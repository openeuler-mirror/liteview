...
#elif V8_TARGET_ARCH_ARM64 && V8_HOST_ARCH_X64 && (V8_OS_LINUX || V8_OS_DARWIN || V8_OS_WIN)
...
int TH_EXPORT_PRIVATE RegisterHandlerData(uintptr_t base, size_t size, size_t num_protected_instructions, const ProtectedInstructionData* protected_instructions);
...
extern uintptr_t g_thread_in_wasm_code_tls;
