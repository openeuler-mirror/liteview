...
template <typename Type> class PointerToIndexHashMap : public base::TemplateHashMapImpl<uintptr_t, uint32_t, base::KeyEqualityMatcher<intptr_t>, base::DefaultAllocationPolicy> {
public:
...
template <> inline uintptr_t PointerToIndexHashMap<Address>::Key(Address value) { return static_cast<uintptr_t>(value); }

template <> inline uintptr_t PointerToIndexHashMap<HeapObject>::Key(HeapObject value) { return value.ptr(); }
