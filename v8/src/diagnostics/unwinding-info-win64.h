...
public:
    ...
    BuiltinUnwindInfo unwinding_info() const { return BuiltinUnwindInfo(fp_offsets_); }
...
public:
    ...
    BuiltinUnwindInfo unwinding_info() const { return BuiltinUnwindInfo(fp_offsets_, fp_adjustments_); }
