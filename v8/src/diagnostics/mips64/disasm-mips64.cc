...
void Decoder::PrintPCImm16(Instruction* instr, int delta_pc, int n_bits)
{
    ...
    out_buffer_pos_ += base::SNPrintF(out_buffer_ + out_buffer_pos_, "%s", converter_.NameOfAddress(reinterpret_cast<byte*>(instr) + delta_pc + (offset << n_bits)));
}
...
void Decoder::PrintPCImm21(Instruction* instr, int delta_pc, int n_bits)
{
    ...
    imm21 <<= (32 - kImm21Bits);
    imm21 >>= (32 - kImm21Bits);
    out_buffer_pos_ += base::SNPrintF(out_buffer_ + out_buffer_pos_, "%s", converter_.NameOfAddress(reinterpret_cast<byte*>(instr) + delta_pc + (imm21 << n_bits)));
}
...
void Decoder::PrintPCImm26(Instruction* instr, int delta_pc, int n_bits)
{
    ...
    imm26 <<= (32 - kImm26Bits);
    imm26 >>= (32 - kImm26Bits);
    out_buffer_pos_ += base::SNPrintF(out_buffer_ + out_buffer_pos_, "%s", converter_.NameOfAddress(reinterpret_cast<byte*>(instr) + delta_pc + (imm26 << n_bits)));
}
...
void Decoder::PrintPCImm26(Instruction* instr)
{
    ...
    out_buffer_pos_ += base::SNPrintF(out_buffer_ + out_buffer_pos_, "%s", converter_.NameOfAddress((reinterpret_cast<byte*>(pc))));
}
