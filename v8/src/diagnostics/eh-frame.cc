...
#if !defined(V8_TARGET_ARCH_X64) && !defined(V8_TARGET_ARCH_ARM) && !defined(V8_TARGET_ARCH_ARM64) && !defined(V8_TARGET_ARCH_S390X) && !defined(V8_TARGET_ARCH_PPC64)
...
int EhFrameWriter::RegisterToDwarfCode(Register) { UNIMPLEMENTED(); }

#ifdef ENABLE_DISASSEMBLER

const char* EhFrameDisassembler::DwarfRegisterCodeToString(int) { UNIMPLEMENTED(); }
...
void EhFrameWriter::RecordRegisterSavedToStack(int dwarf_register_code, int offset)
{
    ...
    if (factored_offset >= 0) {
        ...
        WriteByte((EhFrameConstants::kSavedRegisterTag << EhFrameConstants::kSavedRegisterMaskSize) | (dwarf_register_code & EhFrameConstants::kSavedRegisterMask));
...
void EhFrameWriter::RecordRegisterNotModified(Register name) { RecordRegisterNotModified(RegisterToDwarfCode(name)); }
...
void EhFrameWriter::RecordRegisterFollowsInitialRule(Register name) { RecordRegisterFollowsInitialRule(RegisterToDwarfCode(name)); }
...
void EhFrameWriter::RecordRegisterFollowsInitialRule(int dwarf_register_code)
{
    ...
    if (dwarf_register_code <= EhFrameConstants::kFollowInitialRuleMask) {
        WriteByte((EhFrameConstants::kFollowInitialRuleTag << EhFrameConstants::kFollowInitialRuleMaskSize) | (dwarf_register_code & EhFrameConstants::kFollowInitialRuleMask));
    } else {
...
// static
uint32_t EhFrameIterator::DecodeULeb128(const byte* encoded, int* encoded_size)
{
...
// static
void EhFrameDisassembler::DumpDwarfDirectives(std::ostream& stream, const byte* start, const byte* end)
{
