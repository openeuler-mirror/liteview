...
protected:
    ...
    V8_INLINE void LogStart(Isolate* isolate) { V8FileLogger::CallEventLogger(isolate, histogram_->name(), v8::LogEventStatus::kStart, true); }

    V8_INLINE void LogEnd(Isolate* isolate) { V8FileLogger::CallEventLogger(isolate, histogram_->name(), v8::LogEventStatus::kEnd, true); }
...
public:
    explicit TimedHistogramScope(TimedHistogram* histogram, Isolate* isolate = nullptr)
...
private:
    ...
    NestedTimedHistogram* timed_histogram() { return static_cast<NestedTimedHistogram*>(histogram_); }
