...
public:
    ...
    base::TimeDelta time() const { return base::TimeDelta::FromMicroseconds(time_); }
...
public:
    ...
    RuntimeCallCounter* GetCounter(RuntimeCallCounterId counter_id) { return &counters_[static_cast<int>(counter_id)]; }
    RuntimeCallCounter* GetCounter(int counter_id) { return &counters_[counter_id]; }
...
#define TRACE_HANDLER_STATS(isolate, counter_name) CHANGE_CURRENT_RUNTIME_COUNTER(isolate->counters()->runtime_call_stats(), RuntimeCallCounterId::kHandler_##counter_name)
...
public:
    ...
    inline RuntimeCallTimerScope(LocalIsolate* isolate, RuntimeCallCounterId counter_id, RuntimeCallStats::CounterMode mode = RuntimeCallStats::CounterMode::kExact);
    inline RuntimeCallTimerScope(RuntimeCallStats* stats, RuntimeCallCounterId counter_id, RuntimeCallStats::CounterMode mode = RuntimeCallStats::CounterMode::kExact)
    {
