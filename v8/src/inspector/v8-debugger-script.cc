...
public:
    ...
    v8::Maybe<v8::debug::WasmScript::DebugSymbolsType> getDebugSymbolsType() const override
    {
    ...
    v8::Maybe<String16> getExternalDebugSymbolsURL() const override
    {
        auto script = this->script();
        if (!script->IsWasm())
            return v8::Nothing<String16>();
        v8::MemorySpan<const char> external_url = v8::debug::WasmScript::Cast(*script)->ExternalSymbolsURL();
        if (external_url.size() == 0)
            return v8::Nothing<String16>();
    ...
    int length() const override { return static_cast<int>(m_scriptSource.Get(m_isolate)->Length()); }

    const String16& sourceMappingURL() const override { return m_sourceMappingURL; }

    void setSourceMappingURL(const String16& sourceMappingURL) override { m_sourceMappingURL = sourceMappingURL; }
...
private:
    ...
    v8::Local<v8::debug::Script> script() const override { return m_script.Get(m_isolate); }
