...
public:
    ...
    virtual protocol::Response buildRemoteObject(v8::Local<v8::Context> context, WrapMode mode, std::unique_ptr<protocol::Runtime::RemoteObject>* result) const = 0;
    ...
    virtual std::unique_ptr<protocol::Runtime::WebDriverValue> buildWebDriverValue(v8::Local<v8::Context> context, int max_depth) const = 0;
    ...
    static bool getProperties(v8::Local<v8::Context> context, v8::Local<v8::Object> object, bool ownProperties, bool accessorPropertiesOnly, bool nonIndexedPropertiesOnly,
...
protocol::Response objectToProtocolValue(v8::Local<v8::Context> context, v8::Local<v8::Object> object, int maxDepth, std::unique_ptr<protocol::DictionaryValue>* result);
