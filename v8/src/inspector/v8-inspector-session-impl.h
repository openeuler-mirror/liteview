...
public:
    static std::unique_ptr<V8InspectorSessionImpl> create(
        V8InspectorImpl*, int contextGroupId, int sessionId, V8Inspector::Channel*, StringView state, v8_inspector::V8Inspector::ClientTrustLevel);
    ...
    std::unique_ptr<V8InspectorSession::CommandLineAPIScope> initializeCommandLineAPIScope(int executionContextId) override;
    ...
    V8Inspector::ClientTrustLevel clientTrustLevel() { return m_clientTrustLevel; }
