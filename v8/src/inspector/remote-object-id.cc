...
{
    return String16::concat(String16::fromInteger64(static_cast<int64_t>(isolateId)), ".", String16::fromInteger(injectedScriptId), ".", String16::fromInteger(id));
}
...
String16 RemoteObjectId::serialize(uint64_t isolateId, int injectedScriptId, int id) { return serializeId(isolateId, injectedScriptId, id); }
...
String16 RemoteCallFrameId::serialize(uint64_t isolateId, int injectedScriptId, int frameOrdinal) { return serializeId(isolateId, injectedScriptId, frameOrdinal); }
