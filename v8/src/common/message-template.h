...
#define MESSAGE_TEMPLATES(T)                                                                                                                                                       \
    ...
    T(ParameterOfFunctionOutOfRange, "Paramenter % of function %() is % and out of range")                                                                                         \
    ...
    T(SharedArraySizeOutOfRange, "SharedArray length out of range (maximum of 2**14-2 allowed)")                                                                                   \
    ...
    T(JsonParseExpectedPropNameOrRBrace, "Expected property name or '}' in JSON at position %")                                                                                    \
    T(JsonParseExpectedCommaOrRBrack, "Expected ',' or ']' after array element in JSON at position %")                                                                             \
    T(JsonParseExpectedCommaOrRBrace,                                                                                                                                              \
        "Expected ',' or '}' after property value in JSON at position "                                                                                                            \
        "%")                                                                                                                                                                       \
    T(JsonParseExpectedDoubleQuotedPropertyName, "Expected double-quoted property name in JSON at position %")                                                                     \
    T(JsonParseExponentPartMissingNumber, "Exponent part is missing a number in JSON at position %")                                                                               \
    T(JsonParseExpectedColonAfterPropertyName, "Expected ':' after property name in JSON at position %")                                                                           \
    T(JsonParseUnterminatedFractionalNumber, "Unterminated fractional number in JSON at position %")                                                                               \
    T(JsonParseUnexpectedNonWhiteSpaceCharacter,                                                                                                                                   \
        "Unexpected non-whitespace character after JSON at position "                                                                                                              \
        "%")                                                                                                                                                                       \
    T(JsonParseBadEscapedCharacter, "Bad escaped character in JSON at position %")                                                                                                 \
    T(JsonParseBadControlCharacter, "Bad control character in string literal in JSON at position %")                                                                               \
    T(JsonParseBadUnicodeEscape, "Bad Unicode escape in JSON at position %")                                                                                                       \
    T(JsonParseNoNumberAfterMinusSign, "No number after minus sign in JSON at position %")                                                                                         \
