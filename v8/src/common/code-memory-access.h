...
private:
    ...
    static SimpleTlsIntptrXp code_space_write_nesting_level_;
...
#if DEBUG
    V8_EXPORT_PRIVATE static bool is_key_permissions_initialized_for_current_thread();
#if V8_HAS_PKU_JIT_WRITE_PROTECT
    ...
    static SimpleTlsBoolXp is_key_permissions_initialized_for_current_thread_;
