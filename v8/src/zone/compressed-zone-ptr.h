...
public:
    ...
    bool operator==(const CompressedZonePtr& other) const { return compressed_value_ == other.compressed_value_; }
    bool operator!=(const CompressedZonePtr& other) const { return !(*this == other); }
    bool operator==(T* other) const { return compressed_value_ == ZoneCompression::Compress(other); }
...
private:
    T* Decompress() const { return reinterpret_cast<T*>(ZoneCompression::Decompress(this, compressed_value_)); }
