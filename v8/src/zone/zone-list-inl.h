...
template <typename T> void ZoneList<T>::AddAll(const ZoneList<T>& other, Zone* zone) { AddAll(other.ToVector(), zone); }

template <typename T> void ZoneList<T>::AddAll(const base::Vector<const T>& other, Zone* zone)
{
...
template <typename T> void ZoneList<T>::ResizeAdd(const T& element, Zone* zone) { ResizeAddInternal(element, zone); }
