...
ACCESSORS(JSSegmenter, icu_break_iterator, Managed<icu::BreakIterator>, kIcuBreakIteratorOffset)
...
inline JSSegmenter::Granularity JSSegmenter::granularity() const { return GranularityBits::decode(flags()); }
