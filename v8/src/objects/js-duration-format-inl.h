...
#define IMPL_INLINE_SETTER_GETTER(T, n, B, f, M)                                                                                                                                   \
    ...
    inline JSDurationFormat::T JSDurationFormat::n() const { return B::decode(f()); }
...
#define IMPL_INLINE_FIELD_STYLE3_SETTER_GETTER(f, R) IMPL_INLINE_SETTER_GETTER(FieldStyle, f##_style, R##StyleBits, style_flags, kNarrow)

#define IMPL_INLINE_FIELD_STYLE4_SETTER_GETTER(f, R) IMPL_INLINE_SETTER_GETTER(FieldStyle, f##_style, R##StyleBits, style_flags, kNumeric)

#define IMPL_INLINE_FIELD_STYLE5_SETTER_GETTER(f, R) IMPL_INLINE_SETTER_GETTER(FieldStyle, f##_style, R##StyleBits, style_flags, k2Digit)
...
ACCESSORS(JSDurationFormat, icu_number_formatter, Managed<icu::number::LocalizedNumberFormatter>, kIcuNumberFormatterOffset)
} // namespace internal
} // namespace v8
