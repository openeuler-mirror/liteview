...
class StringComparator {
    ...
    public:
        ...
        void Init(String string, const SharedStringAccessGuardIfNeeded& access_guard);
...
public:
    ...
    bool Equals(String string_1, String string_2, const SharedStringAccessGuardIfNeeded& access_guard);
