...
public:
    ...
    inline static Handle<SwissNameDictionary> Add(
        IsolateT* isolate, Handle<SwissNameDictionary> table, Handle<Name> key, Handle<Object> value, PropertyDetails details, InternalIndex* entry_out = nullptr);
    ...
    template <typename IsolateT> inline InternalIndex FindEntry(IsolateT* isolate, Object key);
    ...
    template <typename IsolateT> inline InternalIndex FindEntry(IsolateT* isolate, Handle<Object> key);
    ...
    template <typename IsolateT> void Initialize(IsolateT* isolate, ByteArray meta_table, int capacity);

    template <typename IsolateT> static Handle<SwissNameDictionary> Rehash(IsolateT* isolate, Handle<SwissNameDictionary> table, int new_capacity);
...
private:
    ...
    inline Object LoadFromDataTable(PtrComprCageBase cage_base, int entry, int data_offset);
    inline void StoreToDataTable(int entry, int data_offset, Object data);
    inline void StoreToDataTableNoBarrier(int entry, int data_offset, Object data);
    ...
    template <typename T> inline static void SetMetaTableField(ByteArray meta_table, int field_index, int value);
    template <typename T> inline static int GetMetaTableField(ByteArray meta_table, int field_index);
};
