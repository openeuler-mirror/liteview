...
template <int start_offset> int FlexibleBodyDescriptor<start_offset>::SizeOf(Map map, HeapObject object) { return object.SizeFromMap(map); }

template <int start_offset> int FlexibleWeakBodyDescriptor<start_offset>::SizeOf(Map map, HeapObject object) { return object.SizeFromMap(map); }

bool BodyDescriptorBase::IsValidJSObjectSlotImpl(Map map, HeapObject obj, int offset)
{
...
template <typename ObjectVisitor> void BodyDescriptorBase::IterateJSObjectBodyImpl(Map map, HeapObject obj, int start_offset, int end_offset, ObjectVisitor* v)
{
#ifdef V8_COMPRESS_POINTERS
    static_assert(kEmbedderDataSlotSize == 2 * kTaggedSize);
...
template <typename ObjectVisitor> DISABLE_CFI_PERF void BodyDescriptorBase::IteratePointers(HeapObject obj, int start_offset, int end_offset, ObjectVisitor* v)
{
...
template <typename ObjectVisitor> void BodyDescriptorBase::IteratePointer(HeapObject obj, int offset, ObjectVisitor* v)
{
    DCHECK_NE(offset, HeapObject::kMapOffset);
    v->VisitPointer(obj, obj.RawField(offset));
}

template <typename ObjectVisitor> DISABLE_CFI_PERF void BodyDescriptorBase::IterateMaybeWeakPointers(HeapObject obj, int start_offset, int end_offset, ObjectVisitor* v)
{
    v->VisitPointers(obj, obj.RawMaybeWeakField(start_offset), obj.RawMaybeWeakField(end_offset));
}

template <typename ObjectVisitor> void BodyDescriptorBase::IterateMaybeWeakPointer(HeapObject obj, int offset, ObjectVisitor* v)
{
    DCHECK_NE(offset, HeapObject::kMapOffset);
    v->VisitPointer(obj, obj.RawMaybeWeakField(offset));
}

template <typename ObjectVisitor> DISABLE_CFI_PERF void BodyDescriptorBase::IterateCustomWeakPointers(HeapObject obj, int start_offset, int end_offset, ObjectVisitor* v)
{
    v->VisitCustomWeakPointers(obj, obj.RawField(start_offset), obj.RawField(end_offset));
}

template <typename ObjectVisitor> DISABLE_CFI_PERF void BodyDescriptorBase::IterateEphemeron(HeapObject obj, int index, int key_offset, int value_offset, ObjectVisitor* v)
{
    v->VisitEphemeron(obj, index, obj.RawField(key_offset), obj.RawField(value_offset));
}

template <typename ObjectVisitor> void BodyDescriptorBase::IterateCustomWeakPointer(HeapObject obj, int offset, ObjectVisitor* v)
{
...
public:
    ...
    template <typename ObjectVisitor> static inline void IterateBody(Map map, HeapObject obj, int object_size, ObjectVisitor* v) { }

    static inline int SizeOf(Map map, HeapObject object) { return HeapNumber::kSize; }
};

// This is a descriptor for one/two pointer fillers.
class FreeSpaceFillerBodyDescriptor final : public DataOnlyBodyDescriptor {
public:
    static inline int SizeOf(Map map, HeapObject raw_object) { return map.instance_size(); }
};

class FreeSpace::BodyDescriptor final : public DataOnlyBodyDescriptor {
public:
    static inline int SizeOf(Map map, HeapObject raw_object) { return FreeSpace::unchecked_cast(raw_object).Size(); }
};
...
public:
    ...
    static inline int SizeOf(Map map, HeapObject object) { return map.instance_size(); }
};
...
public:
    ...
    static bool IsValidSlot(Map map, HeapObject obj, int offset) { return offset >= kStartOffset; }
...
public:
    static bool IsValidSlot(Map map, HeapObject obj, int offset) { return offset >= HeapObject::kHeaderSize; }
...
public:
    static bool IsValidSlot(Map map, HeapObject obj, int offset) { return IsValidJSObjectSlotImpl(map, obj, offset); }
...
public:
    static bool IsValidSlot(Map map, HeapObject obj, int offset)
    {
        ...
        return offset >= MetaTablePointerOffset() && (offset < table.DataTableEndOffset(table.Capacity()));
    }
...
public:
    ...
    static inline int SizeOf(Map map, HeapObject obj) { return ByteArray::SizeFor(ByteArray::cast(obj).length(kAcquireLoad)); }
};

class BytecodeArray::BodyDescriptor final : public BodyDescriptorBase {
public:
    static bool IsValidSlot(Map map, HeapObject obj, int offset) { return offset >= kConstantPoolOffset && offset <= kSourcePositionTableOffset; }
    ...
    static inline int SizeOf(Map map, HeapObject obj) { return BytecodeArray::SizeFor(BytecodeArray::cast(obj).length(kAcquireLoad)); }
};
...
public:
    ...
    static inline int SizeOf(Map map, HeapObject obj) { return BigInt::SizeFor(BigInt::cast(obj).length(kAcquireLoad)); }
};
...
public:
    ...
    static inline int SizeOf(Map map, HeapObject obj) { return FixedDoubleArray::SizeFor(FixedDoubleArray::cast(obj).length(kAcquireLoad)); }
};
...
public:
    ...
    static inline int SizeOf(Map map, HeapObject obj) { return FeedbackMetadata::SizeFor(FeedbackMetadata::cast(obj).slot_count(kAcquireLoad)); }
};

class PreparseData::BodyDescriptor final : public BodyDescriptorBase {
public:
    static bool IsValidSlot(Map map, HeapObject obj, int offset) { return offset >= PreparseData::cast(obj).inner_start_offset(); }
...
public:
    ...
    static inline int SizeOf(Map map, HeapObject obj) { return obj.SizeFromMap(map); }
};
...
public:
    ...
    template <typename ObjectVisitor> static inline void IterateBody(Map map, HeapObject obj, int object_size, ObjectVisitor* v)
    {
        v->VisitExternalPointer(obj, obj.RawExternalPointerField(kForeignAddressOffset), kForeignForeignAddressTag);
    }
...
public:
    static bool IsValidSlot(Map map, HeapObject obj, int offset) { UNREACHABLE(); }
    ...
    static inline int SizeOf(Map map, HeapObject object) { return kSupertypesOffset + WasmTypeInfo::cast(object).supertypes_length() * kTaggedSize; }
};
...
class WasmExportedFunctionData::BodyDescriptor final : public BodyDescriptorBase {
public:
    static bool IsValidSlot(Map map, HeapObject obj, int offset) { UNREACHABLE(); }

    template <typename ObjectVisitor> static inline void IterateBody(Map map, HeapObject obj, int object_size, ObjectVisitor* v)
    {
        WasmFunctionData::BodyDescriptor::IterateBody<ObjectVisitor>(map, obj, object_size, v);
        IteratePointers(obj, kStartOfStrongFieldsOffset, kEndOfStrongFieldsOffset, v);
        v->VisitExternalPointer(obj, obj.RawExternalPointerField(kSigOffset), kWasmExportedFunctionDataSignatureTag);
    }
...
public:
    ...
    {
        IteratePointers(obj, kStartOfStrongFieldsOffset, kEndOfStrongFieldsOffset, v);
        v->VisitExternalPointer(obj, obj.RawExternalPointerField(kCallTargetOffset), kWasmInternalFunctionCallTargetTag);
    }
...
public:
    static bool IsValidSlot(Map map, HeapObject obj, int offset)
    {
        SLOW_DCHECK(std::is_sorted(std::begin(kTaggedFieldOffsets), std::end(kTaggedFieldOffsets)));
        static_assert(sizeof(*kTaggedFieldOffsets) == sizeof(uint16_t));
        if (offset < int { 8 * sizeof(*kTaggedFieldOffsets) }
            && std::binary_search(std::begin(kTaggedFieldOffsets), std::end(kTaggedFieldOffsets), static_cast<uint16_t>(offset))) {
            return true;
        }
        return IsValidJSObjectSlotImpl(map, obj, offset);
    }
...
public:
    ...
    static inline int SizeOf(Map map, HeapObject object) { return WasmArray::SizeFor(map, WasmArray::cast(object).length()); }
};
...
public:
    ...
    {
        IteratePointers(obj, kStartOfStrongFieldsOffset, kEndOfStrongFieldsOffset, v);
        v->VisitExternalPointer(obj, obj.RawExternalPointerField(kJmpbufOffset), kWasmContinuationJmpbufTag);
    }
...
public:
    ...
    static inline int SizeOf(Map map, HeapObject object) { return WasmStruct::GcSafeSize(map); }
};
...
public:
    ...
    template <typename ObjectVisitor> static inline void IterateBody(Map map, HeapObject obj, int object_size, ObjectVisitor* v)
    {
        ...
        v->VisitExternalPointer(obj, string.RawExternalPointerField(kResourceOffset), kExternalStringResourceTag);
        if (string.is_uncached())
            return;
        v->VisitExternalPointer(obj, string.RawExternalPointerField(kResourceDataOffset), kExternalStringResourceDataTag);
    }
...
public:
    static_assert(kRelocationInfoOffset + kTaggedSize == kDeoptimizationDataOrInterpreterDataOffset);
    static_assert(kDeoptimizationDataOrInterpreterDataOffset + kTaggedSize == kPositionTableOffset);
    ...
    static constexpr int kRelocModeMask = RelocInfo::ModeMask(RelocInfo::CODE_TARGET) | RelocInfo::ModeMask(RelocInfo::RELATIVE_CODE_TARGET)
        | RelocInfo::ModeMask(RelocInfo::FULL_EMBEDDED_OBJECT) | RelocInfo::ModeMask(RelocInfo::COMPRESSED_EMBEDDED_OBJECT) | RelocInfo::ModeMask(RelocInfo::EXTERNAL_REFERENCE)
        | RelocInfo::ModeMask(RelocInfo::INTERNAL_REFERENCE) | RelocInfo::ModeMask(RelocInfo::INTERNAL_REFERENCE_ENCODED) | RelocInfo::ModeMask(RelocInfo::OFF_HEAP_TARGET);

    template <typename ObjectVisitor> static inline void IterateBody(Map map, HeapObject obj, ObjectVisitor* v)
    {
    ...
    template <typename ObjectVisitor> static inline void IterateBody(Map map, HeapObject obj, int object_size, ObjectVisitor* v) { IterateBody(map, obj, v); }

    static inline int SizeOf(Map map, HeapObject object) { return Code::unchecked_cast(object).CodeSize(); }
};
...
public:
    static bool IsValidSlot(Map map, HeapObject obj, int offset)
    {
        static_assert(Map::kEndOfStrongFieldsOffset == Map::kStartOfWeakFieldsOffset,
            "Leverage that weak fields directly follow strong fields for the "
            "check below");
        return offset >= Map::kStartOfStrongFieldsOffset && offset < Map::kEndOfWeakFieldsOffset;
    }
...
public:
    ...
    static inline int SizeOf(Map map, HeapObject object) { return object.SizeFromMap(map); }
};

class NativeContext::BodyDescriptor final : public BodyDescriptorBase {
public:
    static bool IsValidSlot(Map map, HeapObject obj, int offset) { return offset < NativeContext::kEndOfTaggedFieldsOffset; }
    ...
    static inline int SizeOf(Map map, HeapObject object) { return NativeContext::kSize; }
};

class CodeDataContainer::BodyDescriptor final : public BodyDescriptorBase {
public:
    static bool IsValidSlot(Map map, HeapObject obj, int offset) { return offset >= HeapObject::kHeaderSize && offset <= CodeDataContainer::kPointerFieldsWeakEndOffset; }

    template <typename ObjectVisitor> static inline void IterateBody(Map map, HeapObject obj, int object_size, ObjectVisitor* v)
    {
        IteratePointers(obj, HeapObject::kHeaderSize, CodeDataContainer::kPointerFieldsStrongEndOffset, v);
        IterateCustomWeakPointers(obj, CodeDataContainer::kPointerFieldsStrongEndOffset, CodeDataContainer::kPointerFieldsWeakEndOffset, v);
    ...
    static inline int SizeOf(Map map, HeapObject object) { return CodeDataContainer::kSize; }
};
...
template <typename Op, typename... Args> auto BodyDescriptorApply(InstanceType type, Args&&... args)
{
#define CALL_APPLY(ClassName) Op::template apply<ClassName::BodyDescriptor>(std::forward<Args>(args)...)
...
#define MAKE_TORQUE_BODY_DESCRIPTOR_APPLY(TYPE, TypeName)                                                                                                                          \
    case TYPE:                                                                                                                                                                     \
        ...
        TORQUE_INSTANCE_TYPE_TO_BODY_DESCRIPTOR_LIST(MAKE_TORQUE_BODY_DESCRIPTOR_APPLY)
#undef MAKE_TORQUE_BODY_DESCRIPTOR_APPLY

    case FILLER_TYPE:
        return Op::template apply<FreeSpaceFillerBodyDescriptor>(std::forward<Args>(args)...);
...
template <typename ObjectVisitor> void HeapObject::IterateFast(PtrComprCageBase cage_base, ObjectVisitor* v)
{
    v->VisitMapPointer(*this);
    IterateBodyFast(cage_base, v);
}

template <typename ObjectVisitor> void HeapObject::IterateFast(Map map, int object_size, ObjectVisitor* v)
{
    v->VisitMapPointer(*this);
    IterateBodyFast(map, object_size, v);
}

template <typename ObjectVisitor> void HeapObject::IterateBodyFast(PtrComprCageBase cage_base, ObjectVisitor* v)
{
    Map m = map(cage_base);
...
struct CallIterateBody {
    template <typename BodyDescriptor, typename ObjectVisitor> static void apply(Map map, HeapObject obj, int object_size, ObjectVisitor* v)
    {
        BodyDescriptor::IterateBody(map, obj, object_size, v);
    }
};

template <typename ObjectVisitor> void HeapObject::IterateBodyFast(Map map, int object_size, ObjectVisitor* v)
{
    BodyDescriptorApply<CallIterateBody>(map.instance_type(), map, *this, object_size, v);
}

class EphemeronHashTable::BodyDescriptor final : public BodyDescriptorBase {
public:
    static bool IsValidSlot(Map map, HeapObject obj, int offset) { return (offset >= EphemeronHashTable::kHeaderSize); }
...
public:
    ...
    static bool IsValidSlot(Map map, HeapObject obj, int offset) { return offset < AccessorInfo::kEndOfStrongFieldsOffset; }
...
public:
    static_assert(CallHandlerInfo::kEndOfStrongFieldsOffset == CallHandlerInfo::kMaybeRedirectedCallbackOffset);

    static bool IsValidSlot(Map map, HeapObject obj, int offset) { return offset < CallHandlerInfo::kEndOfStrongFieldsOffset; }

    template <typename ObjectVisitor> static inline void IterateBody(Map map, HeapObject obj, int object_size, ObjectVisitor* v)
    {
        IteratePointers(obj, HeapObject::kHeaderSize, CallHandlerInfo::kEndOfStrongFieldsOffset, v);
        v->VisitExternalPointer(obj, obj.RawExternalPointerField(CallHandlerInfo::kMaybeRedirectedCallbackOffset), kCallHandlerInfoCallbackTag);
    }
