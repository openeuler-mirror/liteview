...
std::ostream& operator<<(std::ostream& os, InstanceType instance_type)
{
    if (InstanceTypeChecker::IsJSApiObject(instance_type)) {
        return os << "[api object] " << static_cast<int16_t>(instance_type) - i::Internals::kFirstJSApiObjectType;
    }
...
Handle<FieldType> Object::OptimalType(Isolate* isolate, Representation representation)
{
...
Handle<Object> Object::NewStorageFor(Isolate* isolate, Handle<Object> object, Representation representation)
{
    ...
    if (object->IsUninitialized(isolate)) {
        ...
        result->set_value_as_bits(HeapNumber::cast(*object).value_as_bits(kRelaxedLoad), kRelaxedStore);
    } else {
...
template <AllocationType allocation_type, typename IsolateT> Handle<Object> Object::WrapForRead(IsolateT* isolate, Handle<Object> object, Representation representation)
{
    ...
    return isolate->factory()->template NewHeapNumberFromBits<allocation_type>(HeapNumber::cast(*object).value_as_bits(kRelaxedLoad));
}

template Handle<Object> Object::WrapForRead<AllocationType::kYoung>(Isolate* isolate, Handle<Object> object, Representation representation);
template Handle<Object> Object::WrapForRead<AllocationType::kOld>(LocalIsolate* isolate, Handle<Object> object, Representation representation);

MaybeHandle<JSReceiver> Object::ToObjectImpl(Isolate* isolate, Handle<Object> object, const char* method_name)
{
    ...
    if (object->IsSmi()) {
        ...
        if (constructor_function_index == Map::kNoConstructorFunctionIndex) {
            if (method_name != nullptr) {
                THROW_NEW_ERROR(isolate, NewTypeError(MessageTemplate::kCalledOnNullOrUndefined, isolate->factory()->NewStringFromAsciiChecked(method_name)), JSReceiver);
            }
            THROW_NEW_ERROR(isolate, NewTypeError(MessageTemplate::kUndefinedOrNullToObject), JSReceiver);
        }
        constructor = handle(JSFunction::cast(native_context->get(constructor_function_index)), isolate);
    }
...
// static
MaybeHandle<Object> Object::ConvertToNumberOrNumeric(Isolate* isolate, Handle<Object> input, Conversion mode)
{
    while (true) {
        if (input->IsNumber()) {
            return input;
        ...
        if (input->IsSymbol()) {
            THROW_NEW_ERROR(isolate, NewTypeError(MessageTemplate::kSymbolToNumber), Object);
        }
        if (input->IsBigInt()) {
            if (mode == Conversion::kToNumeric)
                return input;
            DCHECK_EQ(mode, Conversion::kToNumber);
            THROW_NEW_ERROR(isolate, NewTypeError(MessageTemplate::kBigIntToNumber), Object);
        }
        ASSIGN_RETURN_ON_EXCEPTION(isolate, input, JSReceiver::ToPrimitive(isolate, Handle<JSReceiver>::cast(input), ToPrimitiveHint::kNumber), Object);
    }
}

// static
MaybeHandle<Object> Object::ConvertToInteger(Isolate* isolate, Handle<Object> input)
{
    ASSIGN_RETURN_ON_EXCEPTION(isolate, input, ConvertToNumberOrNumeric(isolate, input, Conversion::kToNumber), Object);
    if (input->IsSmi())
        return input;
...
// static
MaybeHandle<Object> Object::ConvertToInt32(Isolate* isolate, Handle<Object> input)
{
    ASSIGN_RETURN_ON_EXCEPTION(isolate, input, ConvertToNumberOrNumeric(isolate, input, Conversion::kToNumber), Object);
    if (input->IsSmi())
        return input;
...
// static
MaybeHandle<Object> Object::ConvertToUint32(Isolate* isolate, Handle<Object> input)
{
    ASSIGN_RETURN_ON_EXCEPTION(isolate, input, ConvertToNumberOrNumeric(isolate, input, Conversion::kToNumber), Object);
    if (input->IsSmi())
...
{
    ASSIGN_RETURN_ON_EXCEPTION(isolate, input, Object::ToPrimitive(isolate, input, ToPrimitiveHint::kString), Name);
    if (input->IsName())
...
MaybeHandle<String> Object::ConvertToString(Isolate* isolate, Handle<Object> input)
{
    while (true) {
        ...
        if (input->IsSymbol()) {
            THROW_NEW_ERROR(isolate, NewTypeError(MessageTemplate::kSymbolToString), String);
        }
        if (input->IsBigInt()) {
            return BigInt::ToString(isolate, Handle<BigInt>::cast(input));
        }
        ASSIGN_RETURN_ON_EXCEPTION(isolate, input, JSReceiver::ToPrimitive(isolate, Handle<JSReceiver>::cast(input), ToPrimitiveHint::kString), String);
...
bool IsErrorObject(Isolate* isolate, Handle<Object> object)
{
    ...
    return JSReceiver::HasOwnProperty(isolate, Handle<JSReceiver>::cast(object), symbol).FromMaybe(false);
}

Handle<String> AsStringOrEmpty(Isolate* isolate, Handle<Object> object) { return object->IsString() ? Handle<String>::cast(object) : isolate->factory()->empty_string(); }

Handle<String> NoSideEffectsErrorToString(Isolate* isolate, Handle<JSReceiver> error)
{
...
// static
MaybeHandle<String> Object::NoSideEffectsToMaybeString(Isolate* isolate, Handle<Object> input)
{
    ...
    if (input->IsString() || input->IsNumber() || input->IsOddball()) {
        ...
        if (input->IsJSBoundFunction()) {
            ...
            fun_str = JSWrappedFunction::ToString(Handle<JSWrappedFunction>::cast(input));
        } else {
        ...
        Handle<Object> to_string = JSReceiver::GetDataProperty(isolate, receiver, isolate->factory()->toString_string());
        ...
        if (IsErrorObject(isolate, input) || *to_string == *isolate->error_to_string()) {
            ...
            return NoSideEffectsErrorToString(isolate, Handle<JSReceiver>::cast(input));
            ...
            if (ctor->IsFunction()) {
                ...
                if (ctor->IsJSBoundFunction()) {
                    ctor_name = JSBoundFunction::GetName(isolate, Handle<JSBoundFunction>::cast(ctor)).ToHandleChecked();
                } else if (ctor->IsJSFunction()) {
                    ctor_name = JSFunction::GetName(isolate, Handle<JSFunction>::cast(ctor));
                }
...
// static
Handle<String> Object::NoSideEffectsToString(Isolate* isolate, Handle<Object> input)
{
    DisallowJavascriptExecution no_js(isolate);
    ...
    Handle<Object> tag_obj = JSReceiver::GetDataProperty(isolate, receiver, isolate->factory()->to_string_tag_symbol());
...
// static
MaybeHandle<Object> Object::ConvertToLength(Isolate* isolate, Handle<Object> input)
{
...
// static
MaybeHandle<Object> Object::ConvertToIndex(Isolate* isolate, Handle<Object> input, MessageTemplate error_index)
{
...
template <typename IsolateT> bool Object::BooleanValue(IsolateT* isolate)
{
    if (IsSmi())
...
bool StrictNumberEquals(const Object x, const Object y) { return StrictNumberEquals(x.Number(), y.Number()); }

bool StrictNumberEquals(Handle<Object> x, Handle<Object> y) { return StrictNumberEquals(*x, *y); }
...
Maybe<ComparisonResult> Object::Compare(Isolate* isolate, Handle<Object> x, Handle<Object> y)
{
    ...
    if (x->IsString() && y->IsString()) {
        ...
        return Just(String::Compare(isolate, Handle<String>::cast(x), Handle<String>::cast(y)));
    }
    if (x->IsBigInt() && y->IsString()) {
        return BigInt::CompareToString(isolate, Handle<BigInt>::cast(x), Handle<String>::cast(y));
    }
    if (x->IsString() && y->IsBigInt()) {
        Maybe<ComparisonResult> maybe_result = BigInt::CompareToString(isolate, Handle<BigInt>::cast(y), Handle<String>::cast(x));
    ...
    if (x_is_number && y_is_number) {
        ...
        return Just(BigInt::CompareToBigInt(Handle<BigInt>::cast(x), Handle<BigInt>::cast(y)));
    } else if (x_is_number) {
    ...
    while (true) {
        if (x->IsNumber()) {
            if (y->IsNumber()) {
                ...
                return Just(StrictNumberEquals(*x, Handle<Oddball>::cast(y)->to_number()));
            } else if (y->IsString()) {
                return Just(StrictNumberEquals(x, String::ToNumber(isolate, Handle<String>::cast(y))));
            } else if (y->IsBigInt()) {
                return Just(BigInt::EqualToNumber(Handle<BigInt>::cast(y), x));
            } else if (y->IsJSReceiver()) {
                if (!JSReceiver::ToPrimitive(isolate, Handle<JSReceiver>::cast(y)).ToHandle(&y)) {
                    return Nothing<bool>();
                }
            } else {
                return Just(false);
            ...
            if (y->IsString()) {
                return Just(String::Equals(isolate, Handle<String>::cast(x), Handle<String>::cast(y)));
            } else if (y->IsNumber()) {
                ...
                return BigInt::EqualToString(isolate, Handle<BigInt>::cast(y), Handle<String>::cast(x));
            } else if (y->IsJSReceiver()) {
                if (!JSReceiver::ToPrimitive(isolate, Handle<JSReceiver>::cast(y)).ToHandle(&y)) {
                    return Nothing<bool>();
                }
            ...
            if (y->IsOddball()) {
                ...
                return Just(StrictNumberEquals(Handle<Oddball>::cast(x)->to_number(), *y));
            } else if (y->IsString()) {
            ...
            } else if (!JSReceiver::ToPrimitive(isolate, Handle<JSReceiver>::cast(x)).ToHandle(&x)) {
                return Nothing<bool>();
            }
        } else {
...
MaybeHandle<Object> Object::Add(Isolate* isolate, Handle<Object> lhs, Handle<Object> rhs)
{
    if (lhs->IsNumber() && rhs->IsNumber()) {
        ...
        return isolate->factory()->NewConsString(Handle<String>::cast(lhs), Handle<String>::cast(rhs));
    }
    ASSIGN_RETURN_ON_EXCEPTION(isolate, lhs, Object::ToPrimitive(isolate, lhs), Object);
    ASSIGN_RETURN_ON_EXCEPTION(isolate, rhs, Object::ToPrimitive(isolate, rhs), Object);
    if (lhs->IsString() || rhs->IsString()) {
        ASSIGN_RETURN_ON_EXCEPTION(isolate, rhs, Object::ToString(isolate, rhs), Object);
        ASSIGN_RETURN_ON_EXCEPTION(isolate, lhs, Object::ToString(isolate, lhs), Object);
        return isolate->factory()->NewConsString(Handle<String>::cast(lhs), Handle<String>::cast(rhs));
    }
    ASSIGN_RETURN_ON_EXCEPTION(isolate, rhs, Object::ToNumber(isolate, rhs), Object);
    ASSIGN_RETURN_ON_EXCEPTION(isolate, lhs, Object::ToNumber(isolate, lhs), Object);
    return isolate->factory()->NewNumber(lhs->Number() + rhs->Number());
}

// static
MaybeHandle<Object> Object::OrdinaryHasInstance(Isolate* isolate, Handle<Object> callable, Handle<Object> object)
{
    ...
    if (callable->IsJSBoundFunction()) {
        ...
        Handle<Object> bound_callable(Handle<JSBoundFunction>::cast(callable)->bound_target_function(), isolate);
    ...
    ASSIGN_RETURN_ON_EXCEPTION(isolate, prototype, Object::GetProperty(isolate, callable, isolate->factory()->prototype_string()), Object);
    if (!prototype->IsJSReceiver()) {
        THROW_NEW_ERROR(isolate, NewTypeError(MessageTemplate::kInstanceofNonobjectProto, prototype), Object);
    }

    // Return whether or not {prototype} is in the prototype chain of {object}.
    Maybe<bool> result = JSReceiver::HasInPrototypeChain(isolate, Handle<JSReceiver>::cast(object), prototype);
    if (result.IsNothing())
...
// static
MaybeHandle<Object> Object::InstanceOf(Isolate* isolate, Handle<Object> object, Handle<Object> callable)
{
    // The {callable} must be a receiver.
    if (!callable->IsJSReceiver()) {
        THROW_NEW_ERROR(isolate, NewTypeError(MessageTemplate::kNonObjectInInstanceOfCheck), Object);
    }

    // Lookup the @@hasInstance method on {callable}.
    Handle<Object> inst_of_handler;
    ASSIGN_RETURN_ON_EXCEPTION(isolate, inst_of_handler, Object::GetMethod(Handle<JSReceiver>::cast(callable), isolate->factory()->has_instance_symbol()), Object);
    if (!inst_of_handler->IsUndefined(isolate)) {
        // Call the {inst_of_handler} on the {callable}.
        Handle<Object> result;
        ASSIGN_RETURN_ON_EXCEPTION(isolate, result, Execution::Call(isolate, inst_of_handler, callable, 1, &object), Object);
        return isolate->factory()->ToBoolean(result->BooleanValue(isolate));
    }

    // The {callable} must have a [[Call]] internal method.
    if (!callable->IsCallable()) {
        THROW_NEW_ERROR(isolate, NewTypeError(MessageTemplate::kNonCallableInInstanceOfCheck), Object);
    }

    // Fall back to OrdinaryHasInstance with {callable} and {object}.
    Handle<Object> result;
    ASSIGN_RETURN_ON_EXCEPTION(isolate, result, Object::OrdinaryHasInstance(isolate, callable, object), Object);
    return result;
}

// static
MaybeHandle<Object> Object::GetMethod(Handle<JSReceiver> receiver, Handle<Name> name)
{
    Handle<Object> func;
    Isolate* isolate = receiver->GetIsolate();
    ASSIGN_RETURN_ON_EXCEPTION(isolate, func, JSReceiver::GetProperty(isolate, receiver, name), Object);
    if (func->IsNullOrUndefined(isolate)) {
        return isolate->factory()->undefined_value();
    }
    if (!func->IsCallable()) {
        THROW_NEW_ERROR(isolate, NewTypeError(MessageTemplate::kPropertyNotFunction, func, name, receiver), Object);
    }
    return func;
}
...
MaybeHandle<FixedArray> Object::CreateListFromArrayLike(Isolate* isolate, Handle<Object> object, ElementTypes element_types)
{
    ...
    if (!object->IsJSReceiver()) {
        THROW_NEW_ERROR(isolate, NewTypeError(MessageTemplate::kCalledOnNonObject, isolate->factory()->NewStringFromAsciiChecked("CreateListFromArrayLike")), FixedArray);
    }

    // 4. Let len be ? ToLength(? Get(obj, "length")).
    Handle<JSReceiver> receiver = Handle<JSReceiver>::cast(object);
    Handle<Object> raw_length_number;
    ASSIGN_RETURN_ON_EXCEPTION(isolate, raw_length_number, Object::GetLengthFromArrayLike(isolate, receiver), FixedArray);
    uint32_t len;
    if (!raw_length_number->ToUint32(&len) || len > static_cast<uint32_t>(FixedArray::kMaxLength)) {
        THROW_NEW_ERROR(isolate, NewRangeError(MessageTemplate::kInvalidArrayLength), FixedArray);
    }
    ...
    for (uint32_t index = 0; index < len; ++index) {
        ...
        Handle<Object> next;
        ASSIGN_RETURN_ON_EXCEPTION(isolate, next, JSReceiver::GetElement(isolate, receiver, index), FixedArray);
        ...
        case ElementTypes::kStringAndSymbol: {
            ...
            //     TypeError exception.
            if (!next->IsName()) {
                THROW_NEW_ERROR(isolate, NewTypeError(MessageTemplate::kNotPropertyName, next), FixedArray);
            }
...
MaybeHandle<Object> Object::GetLengthFromArrayLike(Isolate* isolate, Handle<JSReceiver> object)
{
    ...
    ASSIGN_RETURN_ON_EXCEPTION(isolate, val, JSReceiver::GetProperty(isolate, object, key), Object);
    ...
    for (; it->IsFound(); it->Next()) {
        ...
        case LookupIterator::JSPROXY: {
            ...
            if (receiver->IsJSGlobalObject()) {
                receiver = handle(JSGlobalObject::cast(*receiver).global_proxy(), it->isolate());
            }
            ...
            MaybeHandle<Object> result = JSProxy::GetProperty(it->isolate(), it->GetHolder<JSProxy>(), it->GetName(), receiver, &was_found);
            if (!was_found && !is_global_reference)
                it->NotFound();
            return result;
        }
        case LookupIterator::WASM_OBJECT:
            THROW_NEW_ERROR(it->isolate(), NewTypeError(MessageTemplate::kWasmObjectsAreOpaque), Object);
        case LookupIterator::INTERCEPTOR: {
            bool done;
            Handle<Object> result;
            ASSIGN_RETURN_ON_EXCEPTION(it->isolate(), result, JSObject::GetPropertyWithInterceptor(it, &done), Object);
            if (done)
                return result;
            break;
        }
...
// static
MaybeHandle<Object> JSProxy::GetProperty(Isolate* isolate, Handle<JSProxy> proxy, Handle<Name> name, Handle<Object> receiver, bool* was_found)
{
    *was_found = true;
    ...
    if (proxy->IsRevoked()) {
        THROW_NEW_ERROR(isolate, NewTypeError(MessageTemplate::kProxyRevoked, trap_name), Object);
    }
    // 5. Let target be the value of the [[ProxyTarget]] internal slot of O.
    Handle<JSReceiver> target(JSReceiver::cast(proxy->target()), isolate);
    // 6. Let trap be ? GetMethod(handler, "get").
    Handle<Object> trap;
    ASSIGN_RETURN_ON_EXCEPTION(isolate, trap, Object::GetMethod(Handle<JSReceiver>::cast(handler), trap_name), Object);
    ...
    ASSIGN_RETURN_ON_EXCEPTION(isolate, trap_result, Execution::Call(isolate, trap, handler, arraysize(args), args), Object);
...
// static
MaybeHandle<Object> JSProxy::CheckGetSetTrapResult(Isolate* isolate, Handle<Name> name, Handle<JSReceiver> target, Handle<Object> trap_result, AccessKind access_kind)
{
    ...
    if (target_found.FromJust()) {
        ...
        bool inconsistent
            = PropertyDescriptor::IsDataDescriptor(&target_desc) && !target_desc.configurable() && !target_desc.writable() && !trap_result->SameValue(*target_desc.value());
        if (inconsistent) {
            if (access_kind == kGet) {
                THROW_NEW_ERROR(isolate, NewTypeError(MessageTemplate::kProxyGetNonConfigurableData, name, target_desc.value(), trap_result), Object);
            } else {
        ...
        if (access_kind == kGet) {
            inconsistent = PropertyDescriptor::IsAccessorDescriptor(&target_desc) && !target_desc.configurable() && target_desc.get()->IsUndefined(isolate)
        ...
        if (inconsistent) {
            if (access_kind == kGet) {
                THROW_NEW_ERROR(isolate, NewTypeError(MessageTemplate::kProxyGetNonConfigurableAccessor, name, trap_result), Object);
            } else {
...
{
    Handle<FixedArray> list = isolate->factory()->NewFixedArray(kLengthIndex + size, AllocationType::kOld);
    list->set(kLengthIndex, Smi::zero());
    return Handle<TemplateList>::cast(list);
}

// static
Handle<TemplateList> TemplateList::Add(Isolate* isolate, Handle<TemplateList> list, Handle<i::Object> value)
{
...
MaybeHandle<HeapObject> JSProxy::GetPrototype(Handle<JSProxy> proxy)
{
    ...
    if (proxy->IsRevoked()) {
        THROW_NEW_ERROR(isolate, NewTypeError(MessageTemplate::kProxyRevoked, trap_name), HeapObject);
    }
    Handle<JSReceiver> target(JSReceiver::cast(proxy->target()), isolate);
    ...
    Handle<Object> trap;
    ASSIGN_RETURN_ON_EXCEPTION(isolate, trap, Object::GetMethod(handler, trap_name), HeapObject);
    ...
    ASSIGN_RETURN_ON_EXCEPTION(isolate, handler_proto, Execution::Call(isolate, trap, handler, arraysize(argv), argv), HeapObject);
    // 8. If Type(handlerProto) is neither Object nor Null, throw a TypeError.
    if (!(handler_proto->IsJSReceiver() || handler_proto->IsNull(isolate))) {
        THROW_NEW_ERROR(isolate, NewTypeError(MessageTemplate::kProxyGetPrototypeOfInvalid), HeapObject);
    }
    ...
    ASSIGN_RETURN_ON_EXCEPTION(isolate, target_proto, JSReceiver::GetPrototype(isolate, target), HeapObject);
    // 12. If SameValue(handlerProto, targetProto) is false, throw a TypeError.
    if (!handler_proto->SameValue(*target_proto)) {
        THROW_NEW_ERROR(isolate, NewTypeError(MessageTemplate::kProxyGetPrototypeOfNonExtensible), HeapObject);
    }
...
MaybeHandle<Object> Object::GetPropertyWithAccessor(LookupIterator* it)
{
    ...
    if (structure->IsAccessorInfo()) {
        ...
        if (info->is_sloppy() && !receiver->IsJSReceiver()) {
            ASSIGN_RETURN_ON_EXCEPTION(isolate, receiver, Object::ConvertReceiver(isolate, receiver), Object);
        }
        ...
        if (info->replace_on_access() && receiver->IsJSReceiver()) {
            RETURN_ON_EXCEPTION(isolate, Accessors::ReplaceAccessorWithDataProperty(isolate, receiver, holder, name, result), Object);
        }
    ...
    if (getter->IsFunctionTemplateInfo()) {
        SaveAndSwitchContext save(isolate, *holder->GetCreationContext().ToHandleChecked());
        return Builtins::InvokeApiFunction(isolate, false, Handle<FunctionTemplateInfo>::cast(getter), receiver, 0, nullptr, isolate->factory()->undefined_value());
    } else if (getter->IsCallable()) {
        // TODO(rossberg): nicer would be to cast to some JSCallable here...
        return Object::GetPropertyWithDefinedGetter(receiver, Handle<JSReceiver>::cast(getter));
    }
...
Maybe<bool> Object::SetPropertyWithAccessor(LookupIterator* it, Handle<Object> value, Maybe<ShouldThrow> maybe_should_throw)
{
    ...
    if (setter->IsFunctionTemplateInfo()) {
        ...
        RETURN_ON_EXCEPTION_VALUE(isolate,
            Builtins::InvokeApiFunction(isolate, false, Handle<FunctionTemplateInfo>::cast(setter), receiver, arraysize(argv), argv, isolate->factory()->undefined_value()),
            Nothing<bool>());
        return Just(true);
    } else if (setter->IsCallable()) {
        // TODO(rossberg): nicer would be to cast to some JSCallable here...
        return SetPropertyWithDefinedSetter(receiver, Handle<JSReceiver>::cast(setter), value, maybe_should_throw);
    }

    RETURN_FAILURE(isolate, GetShouldThrow(isolate, maybe_should_throw), NewTypeError(MessageTemplate::kNoSetterInCallback, it->GetName(), it->GetHolder<JSObject>()));
}

MaybeHandle<Object> Object::GetPropertyWithDefinedGetter(Handle<Object> receiver, Handle<JSReceiver> getter)
{
...
Maybe<bool> Object::SetPropertyWithDefinedSetter(Handle<Object> receiver, Handle<JSReceiver> setter, Handle<Object> value, Maybe<ShouldThrow> should_throw)
{
...
MaybeHandle<Object> Object::ArraySpeciesConstructor(Isolate* isolate, Handle<Object> original_array)
{
    Handle<Object> default_species = isolate->array_function();
    if (!v8_flags.builtin_subclassing)
        return default_species;
    if (original_array->IsJSArray() && Handle<JSArray>::cast(original_array)->HasArrayPrototype(isolate) && Protectors::IsArraySpeciesLookupChainIntact(isolate)) {
        return default_species;
    }
    ...
    if (is_array.FromJust()) {
        ASSIGN_RETURN_ON_EXCEPTION(isolate, constructor, Object::GetProperty(isolate, original_array, isolate->factory()->constructor_string()), Object);
        if (constructor->IsConstructor()) {
            Handle<Context> constructor_context;
            ASSIGN_RETURN_ON_EXCEPTION(isolate, constructor_context, JSReceiver::GetFunctionRealm(Handle<JSReceiver>::cast(constructor)), Object);
        ...
        if (constructor->IsJSReceiver()) {
            ASSIGN_RETURN_ON_EXCEPTION(isolate, constructor, JSReceiver::GetProperty(isolate, Handle<JSReceiver>::cast(constructor), isolate->factory()->species_symbol()), Object);
    ...
    if (constructor->IsUndefined(isolate)) {
        ...
        if (!constructor->IsConstructor()) {
            THROW_NEW_ERROR(isolate, NewTypeError(MessageTemplate::kSpeciesNotConstructor), Object);
        }
        return constructor;
    }
}
...
V8_WARN_UNUSED_RESULT MaybeHandle<Object> Object::SpeciesConstructor(Isolate* isolate, Handle<JSReceiver> recv, Handle<JSFunction> default_ctor)
{
    ...
    ASSIGN_RETURN_ON_EXCEPTION(isolate, ctor_obj, JSObject::GetProperty(isolate, recv, isolate->factory()->constructor_string()), Object);

    if (ctor_obj->IsUndefined(isolate))
        return default_ctor;

    if (!ctor_obj->IsJSReceiver()) {
        THROW_NEW_ERROR(isolate, NewTypeError(MessageTemplate::kConstructorNotReceiver), Object);
    }

    Handle<JSReceiver> ctor = Handle<JSReceiver>::cast(ctor_obj);

    Handle<Object> species;
    ASSIGN_RETURN_ON_EXCEPTION(isolate, species, JSObject::GetProperty(isolate, ctor, isolate->factory()->species_symbol()), Object);
...
bool Object::IterationHasObservableEffects()
{
    ...
    if (!array.GetCreationContext().ToHandle(&context))
        return false;
    if (!array.map().prototype().IsJSObject())
        return true;
    JSObject array_proto = JSObject::cast(array.map().prototype());
    auto initial_array_prototype = context->native_context().initial_array_prototype();
...
void HeapObject::HeapObjectShortPrint(std::ostream& os)
{
    ...
    case SWISS_NAME_DICTIONARY_TYPE:
        os << "<SwissNameDictionary[" << SwissNameDictionary::cast(*this).Capacity() << "]>";
        break;
    ...
    case DESCRIPTOR_ARRAY_TYPE:
        os << "<DescriptorArray[" << DescriptorArray::cast(*this).number_of_descriptors() << "]>";
        break;
    ...
    case CLOSURE_FEEDBACK_CELL_ARRAY_TYPE:
        os << "<ClosureFeedbackCellArray[" << ClosureFeedbackCellArray::cast(*this).length() << "]>";
        break;
...
void Tuple2::BriefPrintDetails(std::ostream& os) { os << " " << Brief(value1()) << ", " << Brief(value2()); }

void MegaDomHandler::BriefPrintDetails(std::ostream& os) { os << " " << Brief(accessor(kAcquireLoad)) << ", " << Brief(context()); }

void ClassPositions::BriefPrintDetails(std::ostream& os) { os << " " << start() << ", " << end(); }

void CallableTask::BriefPrintDetails(std::ostream& os) { os << " callable=" << Brief(callable()); }

void HeapObject::Iterate(PtrComprCageBase cage_base, ObjectVisitor* v) { IterateFast<ObjectVisitor>(cage_base, v); }
...
void HeapObject::IterateBody(Map map, int object_size, ObjectVisitor* v) { IterateBodyFast<ObjectVisitor>(map, object_size, v); }

struct CallIsValidSlot {
    template <typename BodyDescriptor> static bool apply(Map map, HeapObject obj, int offset) { return BodyDescriptor::IsValidSlot(map, obj, offset); }
};

bool HeapObject::IsValidSlot(Map map, int offset)
{
    DCHECK_NE(0, offset);
    return BodyDescriptorApply<CallIsValidSlot>(map.instance_type(), map, *this, offset);
}
...
int HeapObject::SizeFromMap(Map map) const
{
    ...
    if (base::IsInRange(instance_type, FIRST_FIXED_ARRAY_TYPE, LAST_FIXED_ARRAY_TYPE)) {
        return FixedArray::SizeFor(FixedArray::unchecked_cast(*this).length(kAcquireLoad));
    }
    ...
    if (instance_type == ONE_BYTE_STRING_TYPE || instance_type == ONE_BYTE_INTERNALIZED_STRING_TYPE || instance_type == SHARED_ONE_BYTE_STRING_TYPE) {
        // Strings may get concurrently truncated, hence we have to access its
        // length synchronized.
        return SeqOneByteString::SizeFor(SeqOneByteString::unchecked_cast(*this).length(kAcquireLoad));
    }
    if (instance_type == BYTE_ARRAY_TYPE) {
        return ByteArray::SizeFor(ByteArray::unchecked_cast(*this).length(kAcquireLoad));
    }
    if (instance_type == BYTECODE_ARRAY_TYPE) {
        return BytecodeArray::SizeFor(BytecodeArray::unchecked_cast(*this).length(kAcquireLoad));
    }
    if (instance_type == FREE_SPACE_TYPE) {
        return FreeSpace::unchecked_cast(*this).size(kRelaxedLoad);
    }
    if (instance_type == STRING_TYPE || instance_type == INTERNALIZED_STRING_TYPE || instance_type == SHARED_STRING_TYPE) {
        // Strings may get concurrently truncated, hence we have to access its
        // length synchronized.
        return SeqTwoByteString::SizeFor(SeqTwoByteString::unchecked_cast(*this).length(kAcquireLoad));
    }
    if (instance_type == FIXED_DOUBLE_ARRAY_TYPE) {
        return FixedDoubleArray::SizeFor(FixedDoubleArray::unchecked_cast(*this).length(kAcquireLoad));
    }
    if (instance_type == FEEDBACK_METADATA_TYPE) {
        return FeedbackMetadata::SizeFor(FeedbackMetadata::unchecked_cast(*this).slot_count(kAcquireLoad));
    }
    if (base::IsInRange(instance_type, FIRST_DESCRIPTOR_ARRAY_TYPE, LAST_DESCRIPTOR_ARRAY_TYPE)) {
        return DescriptorArray::SizeFor(DescriptorArray::unchecked_cast(*this).number_of_all_descriptors());
    }
    if (base::IsInRange(instance_type, FIRST_WEAK_FIXED_ARRAY_TYPE, LAST_WEAK_FIXED_ARRAY_TYPE)) {
        return WeakFixedArray::SizeFor(WeakFixedArray::unchecked_cast(*this).length(kAcquireLoad));
    }
    if (instance_type == WEAK_ARRAY_LIST_TYPE) {
        return WeakArrayList::SizeForCapacity(WeakArrayList::unchecked_cast(*this).capacity());
    }
    if (instance_type == SMALL_ORDERED_HASH_SET_TYPE) {
        return SmallOrderedHashSet::SizeFor(SmallOrderedHashSet::unchecked_cast(*this).Capacity());
    }
    if (instance_type == SMALL_ORDERED_HASH_MAP_TYPE) {
        return SmallOrderedHashMap::SizeFor(SmallOrderedHashMap::unchecked_cast(*this).Capacity());
    }
    if (instance_type == SMALL_ORDERED_NAME_DICTIONARY_TYPE) {
        return SmallOrderedNameDictionary::SizeFor(SmallOrderedNameDictionary::unchecked_cast(*this).Capacity());
    }
    if (instance_type == SWISS_NAME_DICTIONARY_TYPE) {
        return SwissNameDictionary::SizeFor(SwissNameDictionary::unchecked_cast(*this).Capacity());
    }
    if (instance_type == PROPERTY_ARRAY_TYPE) {
        return PropertyArray::SizeFor(PropertyArray::cast(*this).length(kAcquireLoad));
    }
    if (instance_type == FEEDBACK_VECTOR_TYPE) {
        return FeedbackVector::SizeFor(FeedbackVector::unchecked_cast(*this).length());
    }
...
#undef MAKE_TORQUE_SIZE_FOR
    ...
    if (instance_type == COVERAGE_INFO_TYPE) {
        return CoverageInfo::SizeFor(CoverageInfo::unchecked_cast(*this).slot_count());
    }
#if V8_ENABLE_WEBASSEMBLY
    if (instance_type == WASM_TYPE_INFO_TYPE) {
        return WasmTypeInfo::SizeFor(WasmTypeInfo::unchecked_cast(*this).supertypes_length());
    }
    ...
    return EmbedderDataArray::SizeFor(EmbedderDataArray::unchecked_cast(*this).length());
}

bool HeapObject::NeedsRehashing(PtrComprCageBase cage_base) const { return NeedsRehashing(map(cage_base).instance_type()); }
...
bool HeapObject::NeedsRehashing(InstanceType instance_type) const
{
    if (V8_EXTERNAL_CODE_SPACE_BOOL) {
        ...
        DCHECK_IMPLIES(instance_type != CODE_TYPE, instance_type == map().instance_type());
    } else {
...
MaybeHandle<Object> Object::SetProperty(Isolate* isolate, Handle<Object> object, Handle<Name> name, Handle<Object> value, StoreOrigin store_origin, Maybe<ShouldThrow> should_throw)
{
    ...
    do {
        ...
        case LookupIterator::INTEGER_INDEXED_EXOTIC: {
            ...
            if (holder->type() == kExternalBigInt64Array || holder->type() == kExternalBigUint64Array) {
                ASSIGN_RETURN_ON_EXCEPTION_VALUE(it->isolate(), throwaway_value, BigInt::FromObject(it->isolate(), value), Nothing<bool>());
            } else {
                ASSIGN_RETURN_ON_EXCEPTION_VALUE(it->isolate(), throwaway_value, Object::ToNumber(it->isolate(), value), Nothing<bool>());
            }
...
bool Object::CheckContextualStoreToJSGlobalObject(LookupIterator* it, Maybe<ShouldThrow> should_throw)
{
    ...
    if (it->GetReceiver()->IsJSGlobalObject(isolate) && (GetShouldThrow(isolate, should_throw) == ShouldThrow::kThrowOnError)) {
...
Maybe<bool> Object::SetSuperProperty(LookupIterator* it, Handle<Object> value, StoreOrigin store_origin, Maybe<ShouldThrow> should_throw)
{
    ...
    LookupIterator own_lookup = it->IsElement() ? LookupIterator(isolate, receiver, it->index(), c) : LookupIterator(isolate, receiver, it->name(), c);
...
Maybe<bool> Object::CannotCreateProperty(Isolate* isolate, Handle<Object> receiver, Handle<Object> name, Handle<Object> value, Maybe<ShouldThrow> should_throw)
{
    RETURN_FAILURE(isolate, GetShouldThrow(isolate, should_throw), NewTypeError(MessageTemplate::kStrictCannotCreateProperty, name, Object::TypeOf(isolate, receiver), receiver));
}

Maybe<bool> Object::WriteToReadOnlyProperty(LookupIterator* it, Handle<Object> value, Maybe<ShouldThrow> maybe_should_throw)
{
...
Maybe<bool> Object::WriteToReadOnlyProperty(Isolate* isolate, Handle<Object> receiver, Handle<Object> name, Handle<Object> value, ShouldThrow should_throw)
{
...
Maybe<bool> Object::RedefineIncompatibleProperty(Isolate* isolate, Handle<Object> name, Handle<Object> value, Maybe<ShouldThrow> should_throw)
{
...
{
    Isolate* isolate = it->isolate();
    DCHECK_IMPLIES(it->GetReceiver()->IsJSProxy(isolate), it->GetName()->IsPrivateName(isolate));
    DCHECK_IMPLIES(!it->IsElement() && it->GetName()->IsPrivateName(isolate), it->state() == LookupIterator::DATA);
    Handle<JSReceiver> receiver = Handle<JSReceiver>::cast(it->GetReceiver());
    ...
    if (it->IsElement() && receiver->IsJSObject(isolate) && JSObject::cast(*receiver).HasTypedArrayOrRabGsabTypedArrayElements(isolate)) {
    ...
    if (V8_UNLIKELY(receiver->IsJSSharedStruct(isolate) || receiver->IsJSSharedArray(isolate))) {
...
Maybe<bool> Object::AddDataProperty(
    LookupIterator* it, Handle<Object> value, PropertyAttributes attributes, Maybe<ShouldThrow> should_throw, StoreOrigin store_origin, EnforceDefineSemantics semantics)
{
    if (!it->GetReceiver()->IsJSReceiver()) {
    ...
    DCHECK_IMPLIES(receiver->IsJSProxy(), it->state() == LookupIterator::NOT_FOUND);
    ...
    if (it->ExtendingNonExtensible(receiver)) {
        RETURN_FAILURE(isolate, GetShouldThrow(it->isolate(), should_throw),
            NewTypeError(semantics == EnforceDefineSemantics::kDefine ? MessageTemplate::kDefineDisallowed : MessageTemplate::kObjectNotExtensible, it->GetName()));
    }
...
Maybe<bool> Object::TransitionAndWriteDataProperty(
    LookupIterator* it, Handle<Object> value, PropertyAttributes attributes, Maybe<ShouldThrow> should_throw, StoreOrigin store_origin)
{
    Handle<JSReceiver> receiver = it->GetStoreTarget<JSReceiver>();
    it->UpdateProtector();
...
MaybeHandle<Object> Object::ShareSlow(Isolate* isolate, Handle<HeapObject> value, ShouldThrow throw_if_cannot_be_shared)
{
    ...
    if (throw_if_cannot_be_shared == kThrowOnError) {
        THROW_NEW_ERROR(isolate, NewTypeError(MessageTemplate::kCannotBeShared, value), Object);
    }
    return MaybeHandle<Object>();
}

template <class T> static int AppendUniqueCallbacks(Isolate* isolate, Handle<TemplateList> callbacks, Handle<typename T::Array> array, int valid_descriptors)
{
...
Maybe<bool> JSProxy::HasProperty(Isolate* isolate, Handle<JSProxy> proxy, Handle<Name> name)
{
    DCHECK(!name->IsPrivate());
    ...
    Handle<Object> trap;
    ASSIGN_RETURN_ON_EXCEPTION_VALUE(isolate, trap, Object::GetMethod(Handle<JSReceiver>::cast(handler), isolate->factory()->has_string()), Nothing<bool>());
    // 7. If trap is undefined, then
    if (trap->IsUndefined(isolate)) {
...
Maybe<bool> JSProxy::SetProperty(Handle<JSProxy> proxy, Handle<Name> name, Handle<Object> value, Handle<Object> receiver, Maybe<ShouldThrow> should_throw)
{
    DCHECK(!name->IsPrivate());
    Isolate* isolate = proxy->GetIsolate();
    STACK_CHECK(isolate, Nothing<bool>());
    ...
    Handle<Object> trap;
    ASSIGN_RETURN_ON_EXCEPTION_VALUE(isolate, trap, Object::GetMethod(handler, trap_name), Nothing<bool>());
    if (trap->IsUndefined(isolate)) {
        PropertyKey key(isolate, name);
        LookupIterator it(isolate, receiver, key, target);
...
Maybe<bool> JSProxy::DeletePropertyOrElement(Handle<JSProxy> proxy, Handle<Name> name, LanguageMode language_mode)
{
    DCHECK(!name->IsPrivate());
...
MaybeHandle<JSProxy> JSProxy::New(Isolate* isolate, Handle<Object> target, Handle<Object> handler)
{
    if (!target->IsJSReceiver()) {
        THROW_NEW_ERROR(isolate, NewTypeError(MessageTemplate::kProxyNonObject), JSProxy);
    }
    if (!handler->IsJSReceiver()) {
        THROW_NEW_ERROR(isolate, NewTypeError(MessageTemplate::kProxyNonObject), JSProxy);
    }
    return isolate->factory()->NewJSProxy(Handle<JSReceiver>::cast(target), Handle<JSReceiver>::cast(handler));
}
...
bool PropertyKeyToArrayIndex(Handle<Object> index_obj, uint32_t* output) { return PropertyKeyToArrayLength(index_obj, output) && *output != kMaxUInt32; }
...
Maybe<bool> JSArray::ArraySetLength(Isolate* isolate, Handle<JSArray> a, PropertyDescriptor* desc, Maybe<ShouldThrow> should_throw)
{
    ...
    if (!result) {
        RETURN_FAILURE(
            isolate, GetShouldThrow(isolate, should_throw), NewTypeError(MessageTemplate::kStrictDeleteProperty, isolate->factory()->NewNumberFromUint(actual_new_len - 1), a));
    }
    return Just(result);
}
...
Maybe<bool> JSProxy::DefineOwnProperty(Isolate* isolate, Handle<JSProxy> proxy, Handle<Object> key, PropertyDescriptor* desc, Maybe<ShouldThrow> should_throw)
{
    ...
    if (key->IsSymbol() && Handle<Symbol>::cast(key)->IsPrivate()) {
        ...
        return JSProxy::SetPrivateSymbol(isolate, proxy, Handle<Symbol>::cast(key), desc, should_throw);
    }
    ...
    Handle<Object> trap;
    ASSIGN_RETURN_ON_EXCEPTION_VALUE(isolate, trap, Object::GetMethod(Handle<JSReceiver>::cast(handler), trap_name), Nothing<bool>());
    // 7. If trap is undefined, then:
    if (trap->IsUndefined(isolate)) {
    ...
    Handle<Name> property_name = key->IsName() ? Handle<Name>::cast(key) : Handle<Name>::cast(isolate->factory()->NumberToString(key));
...
// static
Maybe<bool> JSProxy::SetPrivateSymbol(Isolate* isolate, Handle<JSProxy> proxy, Handle<Symbol> private_name, PropertyDescriptor* desc, Maybe<ShouldThrow> should_throw)
{
    ...
    Handle<Object> value = desc->has_value() ? desc->value() : Handle<Object>::cast(isolate->factory()->undefined_value());
...
// ES6 9.5.5
// static
Maybe<bool> JSProxy::GetOwnPropertyDescriptor(Isolate* isolate, Handle<JSProxy> proxy, Handle<Name> name, PropertyDescriptor* desc)
{
    DCHECK(!name->IsPrivate());
    STACK_CHECK(isolate, Nothing<bool>());
...
Maybe<bool> JSProxy::PreventExtensions(Handle<JSProxy> proxy, ShouldThrow should_throw)
{
    Isolate* isolate = proxy->GetIsolate();
    STACK_CHECK(isolate, Nothing<bool>());
    Factory* factory = isolate->factory();
...
Handle<DescriptorArray> DescriptorArray::CopyUpTo(Isolate* isolate, Handle<DescriptorArray> desc, int enumeration_index, int slack)
{
...
Handle<DescriptorArray> DescriptorArray::CopyUpToAddAttributes(
    Isolate* isolate, Handle<DescriptorArray> source_handle, int enumeration_index, PropertyAttributes attributes, int slack)
{
    ...
    if (attributes != NONE) {
        for (InternalIndex i : InternalIndex::Range(size)) {
            ...
            if (!key.IsPrivate()) {
                ...
                HeapObject heap_object;
                if (details.kind() != PropertyKind::kAccessor || !(value_or_field_type->GetHeapObjectIfStrong(&heap_object) && heap_object.IsAccessorPair())) {
                    mask |= READ_ONLY;
                }
...
Handle<DescriptorArray> DescriptorArray::CopyForFastObjectClone(Isolate* isolate, Handle<DescriptorArray> src_handle, int enumeration_index, int slack)
{
    if (enumeration_index + slack == 0) {
        return isolate->factory()->empty_descriptor_array();
    }
    ...
    int size = enumeration_index;
    Handle<DescriptorArray> descriptors_handle = DescriptorArray::Allocate(isolate, size, slack);
    ...
    for (InternalIndex i : InternalIndex::Range(size)) {
        ...
        PropertyDetails new_details(PropertyKind::kData, NONE, details.location(), details.constness(), new_representation, details.field_index());
...
Handle<FixedArray> FixedArray::SetAndGrow(Isolate* isolate, Handle<FixedArray> array, int index, Handle<Object> value)
{
...
Handle<FixedArray> FixedArray::ShrinkOrEmpty(Isolate* isolate, Handle<FixedArray> array, int new_length)
{
    if (new_length == 0) {
...
// static
Handle<ArrayList> ArrayList::Add(Isolate* isolate, Handle<ArrayList> array, Handle<Object> obj, AllocationType allocation)
{
...
// static
Handle<ArrayList> ArrayList::Add(Isolate* isolate, Handle<ArrayList> array, Handle<Object> obj1, Handle<Object> obj2)
{
    int length = array->Length();
...
Handle<ArrayList> ArrayList::Add(Isolate* isolate, Handle<ArrayList> array, Handle<Object> obj1, Smi obj2, Smi obj3, Smi obj4)
{
    int length = array->Length();
...
// static
Handle<ArrayList> ArrayList::New(Isolate* isolate, int size) { return isolate->factory()->NewArrayList(size); }

Handle<FixedArray> ArrayList::Elements(Isolate* isolate, Handle<ArrayList> array)
{
    int length = array->Length();
...
Handle<FixedArray> EnsureSpaceInFixedArray(Isolate* isolate, Handle<FixedArray> array, int length, AllocationType allocation)
{
    ...
    if (capacity < length) {
        ...
        array = isolate->factory()->CopyFixedArrayAndGrow(array, grow_by, allocation);
    }
    return array;
}
...
{
    DCHECK_LT(0, length);
    auto new_array = Handle<ArrayList>::cast(EnsureSpaceInFixedArray(isolate, array, kFirstIndex + length, allocation));
    DCHECK_EQ(array->Length(), new_array->Length());
    return new_array;
}

// static
Handle<WeakArrayList> WeakArrayList::AddToEnd(Isolate* isolate, Handle<WeakArrayList> array, const MaybeObjectHandle& value)
{
    int length = array->length();
...
Handle<WeakArrayList> WeakArrayList::AddToEnd(Isolate* isolate, Handle<WeakArrayList> array, const MaybeObjectHandle& value1, const MaybeObjectHandle& value2)
{
    int length = array->length();
    array = EnsureSpace(isolate, array, length + 2);
    {
...
// static
Handle<WeakArrayList> WeakArrayList::Append(Isolate* isolate, Handle<WeakArrayList> array, const MaybeObjectHandle& value, AllocationType allocation)
{
    int length = 0;
    int new_length = 0;
    {
...
// static
Handle<WeakArrayList> PrototypeUsers::Add(Isolate* isolate, Handle<WeakArrayList> array, Handle<Map> value, int* assigned_index)
{
    int length = array->length();
    if (length == 0) {
...
WeakArrayList PrototypeUsers::Compact(Handle<WeakArrayList> array, Heap* heap, CompactionCallback callback, AllocationType allocation)
{
    if (array->length() == 0) {
        return *array;
    }
...
Handle<RegExpMatchInfo> RegExpMatchInfo::New(Isolate* isolate, int capture_count)
{
...
Handle<RegExpMatchInfo> RegExpMatchInfo::ReserveCaptures(Isolate* isolate, Handle<RegExpMatchInfo> match_info, int capture_count)
{
    ...
    Handle<RegExpMatchInfo> result = Handle<RegExpMatchInfo>::cast(EnsureSpaceInFixedArray(isolate, match_info, required_length, AllocationType::kYoung));
...
{
    return nof_descriptors + slack == 0 ? isolate->factory()->empty_descriptor_array() : isolate->factory()->NewDescriptorArray(nof_descriptors, slack, allocation);
}
...
void DescriptorArray::Initialize(EnumCache empty_enum_cache, HeapObject undefined_value, int nof_descriptors, int slack)
{
...
void DescriptorArray::ClearEnumCache() { set_enum_cache(GetReadOnlyRoots().empty_enum_cache(), SKIP_WRITE_BARRIER); }
...
// static
void DescriptorArray::InitializeOrChangeEnumCache(Handle<DescriptorArray> descriptors, Isolate* isolate, Handle<FixedArray> keys, Handle<FixedArray> indices)
{
...
int16_t DescriptorArray::UpdateNumberOfMarkedDescriptors(unsigned mark_compact_epoch, int16_t new_marked)
{
    ...
    while (old_marked < new_marked) {
        int16_t actual_raw_marked = CompareAndSwapRawNumberOfMarkedDescriptors(old_raw_marked, new_raw_marked);
...
Handle<AccessorPair> AccessorPair::Copy(Isolate* isolate, Handle<AccessorPair> pair)
{
...
Handle<Object> AccessorPair::GetComponent(Isolate* isolate, Handle<NativeContext> native_context, Handle<AccessorPair> accessor_pair, AccessorComponent component)
{
    Handle<Object> accessor(accessor_pair->get(component), isolate);
    if (accessor->IsFunctionTemplateInfo()) {
        auto function = ApiNatives::InstantiateFunction(isolate, native_context, Handle<FunctionTemplateInfo>::cast(accessor)).ToHandleChecked();
...
MaybeHandle<String> Name::ToFunctionName(Isolate* isolate, Handle<Name> name)
{
    ...
    Handle<Object> description(Handle<Symbol>::cast(name)->description(), isolate);
...
// static
MaybeHandle<String> Name::ToFunctionName(Isolate* isolate, Handle<Name> name, Handle<String> prefix)
{
    Handle<String> name_string;
    ASSIGN_RETURN_ON_EXCEPTION(isolate, name_string, ToFunctionName(isolate, name), String);
    IncrementalStringBuilder builder(isolate);
...
void Relocatable::Iterate(Isolate* isolate, RootVisitor* v) { Iterate(v, isolate->relocatable_top()); }
...
template <typename sinkchar> void WriteFixedArrayToFlat(FixedArray fixed_array, int length, String separator, sinkchar* sink, int sink_length)
{
    DisallowGarbageCollection no_gc;
    CHECK_GT(length, 0);
...
Address JSArray::ArrayJoinConcatToSequentialString(Isolate* isolate, Address raw_fixed_array, intptr_t length, Address raw_separator, Address raw_dest)
{
    ...
    if (StringShape(dest).IsSequentialOneByte()) {
        WriteFixedArrayToFlat(fixed_array, static_cast<int>(length), separator, SeqOneByteString::cast(dest).GetChars(no_gc), dest.length());
    } else {
        DCHECK(StringShape(dest).IsSequentialTwoByte());
        WriteFixedArrayToFlat(fixed_array, static_cast<int>(length), separator, SeqTwoByteString::cast(dest).GetChars(no_gc), dest.length());
    }
    return dest.ptr();
}
...
void Oddball::Initialize(Isolate* isolate, Handle<Oddball> oddball, const char* to_string, Handle<Object> to_number, const char* type_of, byte kind)
{
    ...
    if (to_number->IsHeapNumber()) {
        oddball->set_to_number_raw_as_bits(Handle<HeapNumber>::cast(to_number)->value_as_bits(kRelaxedLoad));
    } else {
...
template EXPORT_TEMPLATE_DEFINE(V8_EXPORT_PRIVATE) void Script::InitLineEnds(Isolate* isolate, Handle<Script> script);
template EXPORT_TEMPLATE_DEFINE(V8_EXPORT_PRIVATE) void Script::InitLineEnds(LocalIsolate* isolate, Handle<Script> script);

bool Script::GetPositionInfo(Handle<Script> script, int position, PositionInfo* info, OffsetFlag offset_flag)
{
...
template <typename Char> bool GetPositionInfoSlowImpl(const base::Vector<Char>& source, int position, Script::PositionInfo* info)
{
    if (position < 0) {
        position = 0;
    }
...
bool GetPositionInfoSlow(const Script script, int position, const DisallowGarbageCollection& no_gc, Script::PositionInfo* info)
{
...
bool Script::GetPositionInfo(int position, PositionInfo* info, OffsetFlag offset_flag) const
{
    ...
    if (line_ends().IsUndefined()) {
        ...
        if (Smi::ToInt(ends.get(0)) >= position) {
            ...
            DCHECK(Smi::ToInt(ends.get(info->line)) >= position && Smi::ToInt(ends.get(info->line - 1)) < position);
...
// static
Handle<String> Script::GetScriptHash(Isolate* isolate, Handle<Script> script, bool forceForInspector)
{
...
template <typename IsolateT> MaybeHandle<SharedFunctionInfo> Script::FindSharedFunctionInfo(Handle<Script> script, IsolateT* isolate, FunctionLiteral* function_literal)
{
    int function_literal_id = function_literal->function_literal_id();
    if (V8_UNLIKELY(script->type() == Script::TYPE_WEB_SNAPSHOT && function_literal_id >= script->shared_function_info_count())) {
...
template MaybeHandle<SharedFunctionInfo> Script::FindSharedFunctionInfo(Handle<Script> script, Isolate* isolate, FunctionLiteral* function_literal);
template MaybeHandle<SharedFunctionInfo> Script::FindSharedFunctionInfo(Handle<Script> script, LocalIsolate* isolate, FunctionLiteral* function_literal);

MaybeHandle<SharedFunctionInfo> Script::FindWebSnapshotSharedFunctionInfo(Handle<Script> script, Isolate* isolate, FunctionLiteral* function_literal)
{
    ...
    Handle<ObjectHashTable> shared_function_info_table = handle(ObjectHashTable::cast(script->shared_function_info_table()), isolate);
    {
        DisallowHeapAllocation no_gc;
        Object index_object = shared_function_info_table->Lookup(handle(Smi::FromInt(function_literal->start_position()), isolate));
    ...
    shared_function_info_table
        = ObjectHashTable::Put(shared_function_info_table, handle(Smi::FromInt(function_literal->start_position()), isolate), handle(Smi::FromInt(function_literal_id), isolate));
    ...
    Handle<WeakFixedArray> old_infos = handle(script->shared_function_infos(), isolate);
    if (new_length > old_infos->length()) {
        int capacity = WeakArrayList::CapacityForLength(new_length);
        Handle<WeakFixedArray> new_infos(isolate->factory()->NewWeakFixedArray(capacity, AllocationType::kOld));
        new_infos->CopyElements(isolate, 0, *old_infos, 0, old_length, WriteBarrierMode::UPDATE_WRITE_BARRIER);
        script->set_shared_function_infos(*new_infos);
    }
    return MaybeHandle<SharedFunctionInfo>();
}

MaybeHandle<SharedFunctionInfo> Script::FindWebSnapshotSharedFunctionInfo(Handle<Script> script, LocalIsolate* isolate, FunctionLiteral* function_literal)
{
...
void JSArray::Initialize(Handle<JSArray> array, int capacity, int length)
{
    ...
    array->GetIsolate()->factory()->NewJSArrayStorage(array, length, capacity, INITIALIZE_ARRAY_ELEMENTS_WITH_HOLE);
}
...
// static
Maybe<bool> JSProxy::SetPrototype(Isolate* isolate, Handle<JSProxy> proxy, Handle<Object> value, bool from_javascript, ShouldThrow should_throw)
{
    STACK_CHECK(isolate, Nothing<bool>());
...
int FixedArrayBase::GetMaxLengthForNewSpaceAllocation(ElementsKind kind) { return ((kMaxRegularHeapObjectSize - FixedArrayBase::kHeaderSize) >> ElementsKindToShiftSize(kind)); }

bool FixedArrayBase::IsCowArray() const { return map() == GetReadOnlyRoots().fixed_cow_array_map(); }
...
int JSPromise::async_task_id() const { return AsyncTaskIdBits::decode(flags()); }

void JSPromise::set_async_task_id(int id) { set_flags(AsyncTaskIdBits::update(flags(), id)); }

// static
Handle<Object> JSPromise::Fulfill(Handle<JSPromise> promise, Handle<Object> value)
{
    Isolate* const isolate = promise->GetIsolate();

#ifdef V8_ENABLE_JAVASCRIPT_PROMISE_HOOKS
    if (isolate->HasContextPromiseHooks()) {
        isolate->raw_native_context().RunPromiseHook(PromiseHookType::kResolve, promise, isolate->factory()->undefined_value());
    }
#endif
...
// static
MaybeHandle<Object> JSPromise::Resolve(Handle<JSPromise> promise, Handle<Object> resolution)
{
    Isolate* const isolate = promise->GetIsolate();
    DCHECK(!reinterpret_cast<v8::Isolate*>(isolate)->GetCurrentContext().IsEmpty());
    ...
    if (promise.is_identical_to(resolution)) {
        ...
        Handle<Object> self_resolution_error = isolate->factory()->NewTypeError(MessageTemplate::kPromiseCyclic, resolution);
    ...
    if (receiver->IsJSPromise() && isolate->IsInAnyContext(receiver->map().prototype(), Context::PROMISE_PROTOTYPE_INDEX) && Protectors::IsPromiseThenLookupChainIntact(isolate)) {
        ...
        then = JSReceiver::GetProperty(isolate, receiver, isolate->factory()->then_string());
    }
    ...
    if (!JSReceiver::GetContextForMicrotask(Handle<JSReceiver>::cast(then_action)).ToHandle(&then_context)) {
        then_context = isolate->native_context();
    }

    Handle<PromiseResolveThenableJobTask> task
        = isolate->factory()->NewPromiseResolveThenableJobTask(promise, Handle<JSReceiver>::cast(resolution), Handle<JSReceiver>::cast(then_action), then_context);
    if (isolate->debug()->is_active() && resolution->IsJSPromise()) {
        // Mark the dependency of the new {promise} on the {resolution}.
        Object::SetProperty(isolate, resolution, isolate->factory()->promise_handled_by_symbol(), promise).Check();
    }
...
// static
Handle<Object> JSPromise::TriggerPromiseReactions(Isolate* isolate, Handle<Object> reactions, Handle<Object> argument, PromiseReaction::Type type)
{
    ...
    while (!reactions->IsSmi()) {
        ...
        if (primary_handler->IsJSReceiver()) {
            has_handler_context = JSReceiver::GetContextForMicrotask(Handle<JSReceiver>::cast(primary_handler)).ToHandle(&handler_context);
        }
        if (!has_handler_context && secondary_handler->IsJSReceiver()) {
            has_handler_context = JSReceiver::GetContextForMicrotask(Handle<JSReceiver>::cast(secondary_handler)).ToHandle(&handler_context);
        }
        ...
        if (type == PromiseReaction::kFulfill) {
            task->set_map(ReadOnlyRoots(isolate).promise_fulfill_reaction_job_task_map(), kReleaseStore);
            Handle<PromiseFulfillReactionJobTask>::cast(task)->set_argument(*argument);
            Handle<PromiseFulfillReactionJobTask>::cast(task)->set_context(*handler_context);
            ...
            static_assert(static_cast<int>(PromiseReaction::kPromiseOrCapabilityOffset) == static_cast<int>(PromiseFulfillReactionJobTask::kPromiseOrCapabilityOffset));
            ...
            DisallowGarbageCollection no_gc;
            task->set_map(ReadOnlyRoots(isolate).promise_reject_reaction_job_task_map(), kReleaseStore);
            Handle<PromiseRejectReactionJobTask>::cast(task)->set_argument(*argument);
            Handle<PromiseRejectReactionJobTask>::cast(task)->set_context(*handler_context);
            Handle<PromiseRejectReactionJobTask>::cast(task)->set_handler(*primary_handler);
            static_assert(static_cast<int>(PromiseReaction::kPromiseOrCapabilityOffset) == static_cast<int>(PromiseRejectReactionJobTask::kPromiseOrCapabilityOffset));
            static_assert(static_cast<int>(PromiseReaction::kContinuationPreservedEmbedderDataOffset)
        ...
        if (microtask_queue) {
            microtask_queue->EnqueueMicrotask(*Handle<PromiseReactionJobTask>::cast(task));
        }
    }
...
template <typename Derived, typename Shape> void HashTable<Derived, Shape>::Rehash(PtrComprCageBase cage_base, Derived new_table)
{
    DisallowGarbageCollection no_gc;
...
template <typename Derived, typename Shape> InternalIndex HashTable<Derived, Shape>::EntryForProbe(ReadOnlyRoots roots, Object k, int probe, InternalIndex expected)
{
    uint32_t hash = Shape::HashForObject(roots, k);
...
// static
template <typename Derived, typename Shape>
bool HashTable<Derived, Shape>::HasSufficientCapacityToAdd(int capacity, int number_of_elements, int number_of_deleted_elements, int number_of_additional_elements)
{
...
template <typename Derived, typename Shape> Handle<Derived> HashTable<Derived, Shape>::Shrink(Isolate* isolate, Handle<Derived> table, int additional_capacity)
{
    ...
    bool pretenure = (new_capacity > kMinCapacityForPretenure) && !Heap::InYoungGeneration(*table);
...
template <typename Derived, typename Shape> InternalIndex HashTable<Derived, Shape>::FindInsertionEntry(PtrComprCageBase cage_base, ReadOnlyRoots roots, uint32_t hash)
{
    uint32_t capacity = Capacity();
    uint32_t count = 1;
...
base::Optional<PropertyCell> GlobalDictionary::TryFindPropertyCellForConcurrentLookupIterator(Isolate* isolate, Handle<Name> name, RelaxedLoadTag tag)
{
    ...
    for (InternalIndex entry = FirstProbe(hash, capacity);; entry = NextProbe(entry, count++, capacity)) {
        ...
        if (element == undefined)
            return {};
        if (ShapeT::kMatchNeedsHoleCheck && element == the_hole)
            continue;
        if (!ShapeT::IsMatch(name, element))
            continue;
...
Handle<StringSet> StringSet::New(Isolate* isolate) { return HashTable::New(isolate, 0); }

Handle<StringSet> StringSet::Add(Isolate* isolate, Handle<StringSet> stringset, Handle<String> name)
{
...
bool StringSet::Has(Isolate* isolate, Handle<String> name) { return FindEntry(isolate, *name).is_found(); }

Handle<RegisteredSymbolTable> RegisteredSymbolTable::Add(Isolate* isolate, Handle<RegisteredSymbolTable> table, Handle<String> key, Handle<Symbol> symbol)
{
...
template <typename Derived, typename Shape> Handle<Derived> Dictionary<Derived, Shape>::DeleteEntry(Isolate* isolate, Handle<Derived> dictionary, InternalIndex entry)
{
...
template <typename Derived, typename Shape>
template <typename IsolateT>
Handle<Derived> Dictionary<Derived, Shape>::Add(IsolateT* isolate, Handle<Derived> dictionary, Key key, Handle<Object> value, PropertyDetails details, InternalIndex* entry_out)
{
    ReadOnlyRoots roots(isolate);
    ...
    DCHECK(dictionary->KeyAt(isolate, entry).IsNumber() || Shape::Unwrap(dictionary->KeyAt(isolate, entry)).IsUniqueName());
...
template <typename Derived, typename Shape> Handle<Derived> Dictionary<Derived, Shape>::ShallowCopy(Isolate* isolate, Handle<Derived> dictionary)
{
    return Handle<Derived>::cast(isolate->factory()->CopyFixedArrayWithMap(dictionary, Derived::GetMap(ReadOnlyRoots(isolate))));
}
...
template <typename Derived, typename Shape> Handle<FixedArray> BaseNameDictionary<Derived, Shape>::IterationIndices(Isolate* isolate, Handle<Derived> dictionary)
{
...
template <typename Derived, typename Shape> Object Dictionary<Derived, Shape>::SlowReverseLookup(Object value)
{
...
template <typename Derived, typename Shape> Object ObjectHashTableBase<Derived, Shape>::Lookup(PtrComprCageBase cage_base, Handle<Object> key, int32_t hash)
{
    DisallowGarbageCollection no_gc;
...
template <typename Derived, typename Shape> Object ObjectHashTableBase<Derived, Shape>::Lookup(Handle<Object> key)
{
    DisallowGarbageCollection no_gc;
...
template <typename Derived, typename Shape> Object ObjectHashTableBase<Derived, Shape>::Lookup(Handle<Object> key, int32_t hash)
{
    return Lookup(GetPtrComprCageBase(*this), key, hash);
}

template <typename Derived, typename Shape> Object ObjectHashTableBase<Derived, Shape>::ValueAt(InternalIndex entry) { return this->get(EntryToValueIndex(entry)); }

Object RegisteredSymbolTable::ValueAt(InternalIndex entry) { return this->get(EntryToValueIndex(entry)); }

Object NameToIndexHashTable::ValueAt(InternalIndex entry) { return this->get(EntryToValueIndex(entry)); }
...
template <typename Derived, typename Shape> Handle<Derived> ObjectHashTableBase<Derived, Shape>::Put(Handle<Derived> table, Handle<Object> key, Handle<Object> value)
{
...
template <typename Derived, typename Shape>
Handle<Derived> ObjectHashTableBase<Derived, Shape>::Put(Isolate* isolate, Handle<Derived> table, Handle<Object> key, Handle<Object> value, int32_t hash)
{
    ReadOnlyRoots roots(isolate);
    ...
    if (!table->HasSufficientCapacityToAdd(1)) {
        ...
        if (capacity > ObjectHashTable::kMaxCapacity) {
            for (size_t i = 0; i < 2; ++i) {
                isolate->heap()->CollectAllGarbage(Heap::kNoGCFlags, GarbageCollectionReason::kFullHashtable);
            }
            table->Rehash(isolate);
        }
    }
...
template <typename Derived, typename Shape> void ObjectHashTableBase<Derived, Shape>::AddEntry(InternalIndex entry, Object key, Object value)
{
    Derived* self = static_cast<Derived*>(this);
...
void JSSet::Rehash(Isolate* isolate)
{
    ...
    Handle<OrderedHashSet> new_table = OrderedHashSet::Rehash(isolate, table_handle).ToHandleChecked();
    set_table(*new_table);
}
...
void JSMap::Rehash(Isolate* isolate)
{
    ...
    Handle<OrderedHashMap> new_table = OrderedHashMap::Rehash(isolate, table_handle).ToHandleChecked();
    set_table(*new_table);
}

void JSWeakCollection::Initialize(Handle<JSWeakCollection> weak_collection, Isolate* isolate)
{
    Handle<EphemeronHashTable> table = EphemeronHashTable::New(isolate, 0);
    weak_collection->set_table(*table);
}

void JSWeakCollection::Set(Handle<JSWeakCollection> weak_collection, Handle<Object> key, Handle<Object> value, int32_t hash)
{
    DCHECK(key->IsJSReceiver() || key->IsSymbol());
    Handle<EphemeronHashTable> table(EphemeronHashTable::cast(weak_collection->table()), weak_collection->GetIsolate());
    DCHECK(table->IsKey(weak_collection->GetReadOnlyRoots(), *key));
    Handle<EphemeronHashTable> new_table = EphemeronHashTable::Put(weak_collection->GetIsolate(), table, key, value, hash);
...
bool JSWeakCollection::Delete(Handle<JSWeakCollection> weak_collection, Handle<Object> key, int32_t hash)
{
    DCHECK(key->IsJSReceiver() || key->IsSymbol());
    Handle<EphemeronHashTable> table(EphemeronHashTable::cast(weak_collection->table()), weak_collection->GetIsolate());
    DCHECK(table->IsKey(weak_collection->GetReadOnlyRoots(), *key));
    bool was_present = false;
    Handle<EphemeronHashTable> new_table = EphemeronHashTable::Remove(weak_collection->GetIsolate(), table, key, &was_present, hash);
    weak_collection->set_table(*new_table);
    if (*table != *new_table) {
        // Zap the old table since we didn't record slots for its elements.
        EphemeronHashTable::FillEntriesWithHoles(table);
...
Handle<JSArray> JSWeakCollection::GetEntries(Handle<JSWeakCollection> holder, int max_entries)
{
    Isolate* isolate = holder->GetIsolate();
    Handle<EphemeronHashTable> table(EphemeronHashTable::cast(holder->table()), isolate);
...
Handle<PropertyCell> PropertyCell::InvalidateAndReplaceEntry(
    Isolate* isolate, Handle<GlobalDictionary> dictionary, InternalIndex entry, PropertyDetails new_details, Handle<Object> new_value)
{
...
// static
PropertyCellType PropertyCell::InitialType(Isolate* isolate, Object value) { return value.IsUndefined(isolate) ? PropertyCellType::kUndefined : PropertyCellType::kConstant; }

// static
PropertyCellType PropertyCell::UpdatedType(Isolate* isolate, PropertyCell cell, Object value, PropertyDetails details)
{
    DisallowGarbageCollection no_gc;
...
Handle<PropertyCell> PropertyCell::PrepareForAndSetValue(Isolate* isolate, Handle<GlobalDictionary> dictionary, InternalIndex entry, Handle<Object> value, PropertyDetails details)
{
    DCHECK(!value->IsTheHole(isolate));
...
// static
bool PropertyCell::CheckDataIsCompatible(PropertyDetails details, Object value)
{
    DisallowGarbageCollection no_gc;
    ...
    if (value.IsTheHole()) {
        ...
        CHECK_EQ(value.IsAccessorInfo() || value.IsAccessorPair(), details.kind() == PropertyKind::kAccessor);
        DCHECK_IMPLIES(cell_type == PropertyCellType::kUndefined, value.IsUndefined());
    }
    return true;
}

#ifdef DEBUG
bool PropertyCell::CanTransitionTo(PropertyDetails new_details, Object new_value) const
{
    ...
    case PropertyCellType::kConstant:
        return !value().IsTheHole() && new_details.cell_type() != PropertyCellType::kUndefined;
    case PropertyCellType::kConstantType:
        return new_details.cell_type() == PropertyCellType::kConstantType || new_details.cell_type() == PropertyCellType::kMutable
            || (new_details.cell_type() == PropertyCellType::kConstant && new_value.IsTheHole());
    case PropertyCellType::kMutable:
        return new_details.cell_type() == PropertyCellType::kMutable || (new_details.cell_type() == PropertyCellType::kConstant && new_value.IsTheHole());
    case PropertyCellType::kInTransition:
        UNREACHABLE();
    }
}
...
int JSGeneratorObject::source_position() const
{
    ...
    AbstractCode code = AbstractCode::cast(function().shared().GetBytecodeArray(isolate));
    return code.SourcePosition(isolate, code_offset());
}

// static
AccessCheckInfo AccessCheckInfo::Get(Isolate* isolate, Handle<JSObject> receiver)
{
    DisallowGarbageCollection no_gc;
...
#define EXTERN_DEFINE_HASH_TABLE(DERIVED, SHAPE)                                                                                                                                   \
    ...
    template EXPORT_TEMPLATE_DEFINE(V8_EXPORT_PRIVATE) Handle<DERIVED> HashTable<DERIVED, SHAPE>::New(LocalIsolate*, int, AllocationType, MinimumCapacity);                        \
                                                                                                                                                                                   \
    template EXPORT_TEMPLATE_DEFINE(V8_EXPORT_PRIVATE) Handle<DERIVED> HashTable<DERIVED, SHAPE>::EnsureCapacity(Isolate*, Handle<DERIVED>, int, AllocationType);                  \
    template EXPORT_TEMPLATE_DEFINE(V8_EXPORT_PRIVATE) Handle<DERIVED> HashTable<DERIVED, SHAPE>::EnsureCapacity(LocalIsolate*, Handle<DERIVED>, int, AllocationType);
...
#define EXTERN_DEFINE_DICTIONARY(DERIVED, SHAPE)                                                                                                                                   \
    ...
    template class EXPORT_TEMPLATE_DEFINE(V8_EXPORT_PRIVATE) Dictionary<DERIVED, SHAPE>;                                                                                           \
                                                                                                                                                                                   \
    template V8_EXPORT_PRIVATE Handle<DERIVED> Dictionary<DERIVED, SHAPE>::Add(Isolate* isolate, Handle<DERIVED>, Key, Handle<Object>, PropertyDetails, InternalIndex*);           \
    template V8_EXPORT_PRIVATE Handle<DERIVED> Dictionary<DERIVED, SHAPE>::Add(LocalIsolate* isolate, Handle<DERIVED>, Key, Handle<Object>, PropertyDetails, InternalIndex*);
...
{
    DisallowGarbageCollection no_gc;
    JSFinalizationRegistry finalization_registry = JSFinalizationRegistry::cast(Object(raw_finalization_registry));
    ...
    if (weak_cell.key_list_prev().IsUndefined(isolate)) {
        SimpleNumberDictionary key_map = SimpleNumberDictionary::cast(finalization_registry.key_map());
