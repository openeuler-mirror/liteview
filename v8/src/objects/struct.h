...
public:
    ...
    inline void set(AccessorComponent component, Object value, ReleaseStoreTag tag);
    ...
    static Handle<Object> GetComponent(Isolate* isolate, Handle<NativeContext> native_context, Handle<AccessorPair> accessor_pair, AccessorComponent component);
