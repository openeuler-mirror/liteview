...
bool ScopeInfo::HasSimpleParameters() const { return HasSimpleParametersBit::decode(Flags()); }
...
bool ScopeInfo::HasInlinedLocalNames() const { return ContextLocalCount() < kScopeInfoMaxInlinedLocalNamesSize; }
...
public:
    ...
    public:
        ...
        friend bool operator==(const Iterator& a, const Iterator& b) { return a.range_ == b.range_ && a.index_ == b.index_; }
    ...
    private:
        ...
        NameToIndexHashTable table() const { return scope_info()->context_local_names_hashtable(); }
...
// static
ScopeInfo::LocalNamesRange<Handle<ScopeInfo>> ScopeInfo::IterateLocalNames(Handle<ScopeInfo> scope_info) { return LocalNamesRange<Handle<ScopeInfo>>(scope_info); }

// static
ScopeInfo::LocalNamesRange<ScopeInfo*> ScopeInfo::IterateLocalNames(ScopeInfo* scope_info, const DisallowGarbageCollection& no_gc)
{
    USE(no_gc);
