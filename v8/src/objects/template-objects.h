...
class CachedTemplateObject final : public TorqueGeneratedCachedTemplateObject<CachedTemplateObject, Struct> {
public:
    static Handle<CachedTemplateObject> New(Isolate* isolate, int slot_id, Handle<JSArray> template_object, Handle<HeapObject> next);
