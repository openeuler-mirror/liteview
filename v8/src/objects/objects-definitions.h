...
#define STRING_TYPE_LIST(V)                                                                                                                                                        \
    ...
    V(ONE_BYTE_STRING_TYPE, kVariableSizeSentinel, one_byte_string, OneByteString)                                                                                                 \
    V(CONS_STRING_TYPE, ConsString::kSize, cons_string, ConsString)                                                                                                                \
    V(CONS_ONE_BYTE_STRING_TYPE, ConsString::kSize, cons_one_byte_string, ConsOneByteString)                                                                                       \
    V(SLICED_STRING_TYPE, SlicedString::kSize, sliced_string, SlicedString)                                                                                                        \
    V(SLICED_ONE_BYTE_STRING_TYPE, SlicedString::kSize, sliced_one_byte_string, SlicedOneByteString)                                                                               \
    V(EXTERNAL_STRING_TYPE, ExternalTwoByteString::kSize, external_string, ExternalString)                                                                                         \
    V(EXTERNAL_ONE_BYTE_STRING_TYPE, ExternalOneByteString::kSize, external_one_byte_string, ExternalOneByteString)                                                                \
    V(UNCACHED_EXTERNAL_STRING_TYPE, ExternalTwoByteString::kUncachedSize, uncached_external_string, UncachedExternalString)                                                       \
    V(UNCACHED_EXTERNAL_ONE_BYTE_STRING_TYPE, ExternalOneByteString::kUncachedSize, uncached_external_one_byte_string, UncachedExternalOneByteString)                              \
                                                                                                                                                                                   \
    V(INTERNALIZED_STRING_TYPE, kVariableSizeSentinel, internalized_string, InternalizedString)                                                                                    \
    V(ONE_BYTE_INTERNALIZED_STRING_TYPE, kVariableSizeSentinel, one_byte_internalized_string, OneByteInternalizedString)                                                           \
    V(EXTERNAL_INTERNALIZED_STRING_TYPE, ExternalTwoByteString::kSize, external_internalized_string, ExternalInternalizedString)                                                   \
    V(EXTERNAL_ONE_BYTE_INTERNALIZED_STRING_TYPE, ExternalOneByteString::kSize, external_one_byte_internalized_string, ExternalOneByteInternalizedString)                          \
    V(UNCACHED_EXTERNAL_INTERNALIZED_STRING_TYPE, ExternalTwoByteString::kUncachedSize, uncached_external_internalized_string, UncachedExternalInternalizedString)                 \
    V(UNCACHED_EXTERNAL_ONE_BYTE_INTERNALIZED_STRING_TYPE, ExternalOneByteString::kUncachedSize, uncached_external_one_byte_internalized_string,                                   \
        UncachedExternalOneByteInternalizedString)                                                                                                                                 \
    V(THIN_STRING_TYPE, ThinString::kSize, thin_string, ThinString)                                                                                                                \
    V(THIN_ONE_BYTE_STRING_TYPE, ThinString::kSize, thin_one_byte_string, ThinOneByteString)                                                                                       \
                                                                                                                                                                                   \
    V(SHARED_STRING_TYPE, kVariableSizeSentinel, shared_string, SharedString)                                                                                                      \
    V(SHARED_ONE_BYTE_STRING_TYPE, kVariableSizeSentinel, shared_one_byte_string, SharedOneByteString)                                                                             \
    V(SHARED_EXTERNAL_STRING_TYPE, ExternalTwoByteString::kSize, shared_external_string, SharedExternalString)                                                                     \
    V(SHARED_EXTERNAL_ONE_BYTE_STRING_TYPE, ExternalOneByteString::kSize, shared_external_one_byte_string, SharedExternalOneByteString)                                            \
    V(SHARED_UNCACHED_EXTERNAL_STRING_TYPE, ExternalTwoByteString::kUncachedSize, shared_uncached_external_string, SharedUncachedExternalString)                                   \
    V(SHARED_UNCACHED_EXTERNAL_ONE_BYTE_STRING_TYPE, ExternalOneByteString::kUncachedSize, shared_uncached_external_one_byte_string, SharedUncachedExternalOneByteString)          \
    V(SHARED_THIN_STRING_TYPE, ThinString::kSize, shared_thin_string, SharedThinString)                                                                                            \
    V(SHARED_THIN_ONE_BYTE_STRING_TYPE, ThinString::kSize, shared_thin_one_byte_string, SharedThinOneByteString)
...
#define STRUCT_LIST_GENERATOR(V, _)                                                                                                                                                \
    ...
    V(_, FUNCTION_TEMPLATE_INFO_TYPE, FunctionTemplateInfo, function_template_info)                                                                                                \
    ...
    V(_, CACHED_TEMPLATE_OBJECT_TYPE, CachedTemplateObject, cached_template_object)                                                                                                \
    ...
    IF_WASM(V, _, WASM_INDIRECT_FUNCTION_TABLE_TYPE, WasmIndirectFunctionTable, wasm_indirect_function_table)
