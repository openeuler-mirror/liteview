...
class RegExpMatchInfo : public TorqueGeneratedRegExpMatchInfo<RegExpMatchInfo, FixedArray> {
public:
    ...
    inline void SetLastSubject(String value, WriteBarrierMode mode = UPDATE_WRITE_BARRIER);

    // Like LastSubject, but modifiable by the user.
    inline Object LastInput();
    inline void SetLastInput(Object value, WriteBarrierMode mode = UPDATE_WRITE_BARRIER);
