...
public:
    ...
    // locales and options.
    static MaybeHandle<JSDisplayNames> New(Isolate* isolate, Handle<Map> map, Handle<Object> locales, Handle<Object> options);

    static Handle<JSObject> ResolvedOptions(Isolate* isolate, Handle<JSDisplayNames> format_holder);

    static MaybeHandle<Object> Of(Isolate* isolate, Handle<JSDisplayNames> holder, Handle<Object> code_obj);
