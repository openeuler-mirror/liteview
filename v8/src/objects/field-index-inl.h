...
FieldIndex FieldIndex::ForSmiLoadHandler(Map map, int32_t handler)
{
    ...
    return FieldIndex(is_inobject, LoadHandler::FieldIndexBits::decode(handler) * kTaggedSize, LoadHandler::IsDoubleBits::decode(handler) ? kDouble : kTagged, inobject_properties,
        first_inobject_offset);
}

FieldIndex FieldIndex::ForPropertyIndex(Map map, int property_index, Representation representation)
{
...
FieldIndex FieldIndex::ForDescriptor(PtrComprCageBase cage_base, Map map, InternalIndex descriptor_index)
{
