...
byte Oddball::kind() const { return Smi::ToInt(TaggedField<Smi>::load(*this, kKindOffset)); }

void Oddball::set_kind(byte value) { WRITE_FIELD(*this, kKindOffset, Smi::FromInt(value)); }

// static
Handle<Object> Oddball::ToNumber(Isolate* isolate, Handle<Oddball> input) { return Handle<Object>(input->to_number(), isolate); }

DEF_GETTER(HeapObject, IsBoolean, bool) { return IsOddball(cage_base) && ((Oddball::cast(*this).kind() & Oddball::kNotBooleanMask) == 0); }
