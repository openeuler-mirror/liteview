...
#define DECL_RARE_ACCESSORS(Name, CamelName, Type)                                                                                                                                 \
    ...
    static inline void Set##CamelName(Isolate* isolate, Handle<FunctionTemplateInfo> function_template_info, Handle<Type> Name);
    ...
    DECL_RARE_ACCESSORS(prototype_provider_template, PrototypeProviderTemplate, HeapObject)
    ...
    DECL_RARE_ACCESSORS(indexed_property_handler, IndexedPropertyHandler, HeapObject)
...
#undef DECL_RARE_ACCESSORS
    ...
    static Handle<SharedFunctionInfo> GetOrCreateSharedFunctionInfo(Isolate* isolate, Handle<FunctionTemplateInfo> info, MaybeHandle<Name> maybe_name);

    static Handle<SharedFunctionInfo> GetOrCreateSharedFunctionInfo(LocalIsolate* isolate, Handle<FunctionTemplateInfo> info, Handle<Name> maybe_name)
    {
    ...
    static base::Optional<Name> TryGetCachedPropertyName(Isolate* isolate, Object getter);
    // Fast API overloads.
...
private:
    ...
    static inline FunctionTemplateRareData EnsureFunctionTemplateRareData(Isolate* isolate, Handle<FunctionTemplateInfo> function_template_info);

    static FunctionTemplateRareData AllocateFunctionTemplateRareData(Isolate* isolate, Handle<FunctionTemplateInfo> function_template_info);
