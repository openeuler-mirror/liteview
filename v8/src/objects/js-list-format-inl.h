...
ACCESSORS(JSListFormat, icu_formatter, Managed<icu::ListFormatter>, kIcuFormatterOffset)
...
inline JSListFormat::Style JSListFormat::style() const { return StyleBits::decode(flags()); }
...
inline JSListFormat::Type JSListFormat::type() const { return TypeBits::decode(flags()); }
