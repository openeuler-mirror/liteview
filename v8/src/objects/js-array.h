...
public:
    ...
    void set_length(Object value, ReleaseStoreTag tag, WriteBarrierMode mode = UPDATE_WRITE_BARRIER) = delete;
    ...
    V8_EXPORT_PRIVATE static void Initialize(Handle<JSArray> array, int capacity, int length = 0);
    ...
    // ES6 9.4.2.1
    V8_WARN_UNUSED_RESULT static Maybe<bool> DefineOwnProperty(Isolate* isolate, Handle<JSArray> o, Handle<Object> name, PropertyDescriptor* desc, Maybe<ShouldThrow> should_throw);
    ...
    static const int kInitialMaxFastElementArray = (kMaxRegularHeapObjectSize - FixedArray::kHeaderSize - kHeaderSize - AllocationMemento::kSize) >> kDoubleSizeLog2;
...
public:
    ...
    static inline void SetRaw(Handle<JSArray> template_object, Handle<JSArray> raw_object);
};
