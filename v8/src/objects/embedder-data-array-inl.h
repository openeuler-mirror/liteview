...
Address EmbedderDataArray::slots_start() { return field_address(OffsetOfElementAt(0)); }

Address EmbedderDataArray::slots_end() { return field_address(OffsetOfElementAt(length())); }
