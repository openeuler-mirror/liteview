...
public:
    ...
    V8_EXPORT_PRIVATE static Handle<Object> Fulfill(Handle<JSPromise> promise, Handle<Object> value);
...
private:
    ...
    static Handle<Object> TriggerPromiseReactions(Isolate* isolate, Handle<Object> reactions, Handle<Object> argument, PromiseReaction::Type type);
