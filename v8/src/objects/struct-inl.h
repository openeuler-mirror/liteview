...
Object AccessorPair::get(AccessorComponent component) { return component == ACCESSOR_GETTER ? getter() : setter(); }
...
void AccessorPair::set(AccessorComponent component, Object value, ReleaseStoreTag tag)
{
    if (component == ACCESSOR_GETTER) {
...
bool AccessorPair::Equals(Object getter_value, Object setter_value) { return (getter() == getter_value) && (setter() == setter_value); }
