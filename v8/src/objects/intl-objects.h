  ...
  class AvailableLocales {
   public:
    AvailableLocales() {
      ...
      if (!(U_SUCCESS(status))) {
        all_locales.push_back("en");
        all_locales.push_back("en-US");
        all_locales.push_back("zh");
        all_locales.push_back("zh-CN");
        OutputDebugStringA("AvailableLocales 1\n");
      } else {
        OutputDebugStringA("AvailableLocales 2\n");
