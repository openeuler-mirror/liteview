...
public:
    ...
    // locales and options.
    V8_WARN_UNUSED_RESULT static MaybeHandle<JSDurationFormat> New(Isolate* isolate, Handle<Map> map, Handle<Object> locales, Handle<Object> options);

    V8_WARN_UNUSED_RESULT static Handle<JSObject> ResolvedOptions(Isolate* isolate, Handle<JSDurationFormat> format_holder);
