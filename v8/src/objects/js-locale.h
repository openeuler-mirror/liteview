...
public:
    ...
    // and options.
    static MaybeHandle<JSLocale> New(Isolate* isolate, Handle<Map> map, Handle<String> locale, Handle<JSReceiver> options);

    static MaybeHandle<JSLocale> Maximize(Isolate* isolate, Handle<JSLocale> locale);
    static MaybeHandle<JSLocale> Minimize(Isolate* isolate, Handle<JSLocale> locale);

    V8_WARN_UNUSED_RESULT static MaybeHandle<JSArray> Calendars(Isolate* isolate, Handle<JSLocale> locale);
    V8_WARN_UNUSED_RESULT static MaybeHandle<JSArray> Collations(Isolate* isolate, Handle<JSLocale> locale);
    V8_WARN_UNUSED_RESULT static MaybeHandle<JSArray> HourCycles(Isolate* isolate, Handle<JSLocale> locale);
    V8_WARN_UNUSED_RESULT static MaybeHandle<JSArray> NumberingSystems(Isolate* isolate, Handle<JSLocale> locale);
    V8_WARN_UNUSED_RESULT static MaybeHandle<JSObject> TextInfo(Isolate* isolate, Handle<JSLocale> locale);
    V8_WARN_UNUSED_RESULT static MaybeHandle<Object> TimeZones(Isolate* isolate, Handle<JSLocale> locale);
    V8_WARN_UNUSED_RESULT static MaybeHandle<JSObject> WeekInfo(Isolate* isolate, Handle<JSLocale> locale);
    ...
    static Handle<Object> NumberingSystem(Isolate* isolate, Handle<JSLocale> locale);
