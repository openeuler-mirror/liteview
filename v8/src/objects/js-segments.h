...
public:
    ...
    V8_WARN_UNUSED_RESULT static MaybeHandle<JSSegments> Create(Isolate* isolate, Handle<JSSegmenter> segmenter, Handle<String> string);

    // ecma402 #sec-%segmentsprototype%.containing
    V8_WARN_UNUSED_RESULT static MaybeHandle<Object> Containing(Isolate* isolate, Handle<JSSegments> segments_holder, double n);
