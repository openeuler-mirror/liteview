...
enum class BinaryOperationHint : uint8_t { kNone, kSignedSmall, kSignedSmallInputs, kNumber, kNumberOrOddball, kString, kBigInt, kBigInt64, kAny };

inline size_t hash_value(BinaryOperationHint hint) { return static_cast<unsigned>(hint); }
...
inline size_t hash_value(CompareOperationHint hint) { return static_cast<unsigned>(hint); }
