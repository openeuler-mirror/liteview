...
ACCESSORS(JSDisplayNames, internal, Managed<DisplayNamesInternal>, kInternalOffset)
...
inline JSDisplayNames::Style JSDisplayNames::style() const { return StyleBits::decode(flags()); }
...
inline JSDisplayNames::Fallback JSDisplayNames::fallback() const { return FallbackBit::decode(flags()); }
...
inline JSDisplayNames::LanguageDisplay JSDisplayNames::language_display() const { return LanguageDisplayBit::decode(flags()); }
} // namespace internal
} // namespace v8
