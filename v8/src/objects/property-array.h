...
public:
    ...
    inline Object get(PtrComprCageBase cage_base, int index, SeqCstAccessTag tag) const;
    ...
    inline Object Swap(PtrComprCageBase cage_base, int index, Object value, SeqCstAccessTag tag);

    // Signature must be in sync with FixedArray::CopyElements().
    inline void CopyElements(Isolate* isolate, int dst_index, PropertyArray src, int src_index, int len, WriteBarrierMode mode);
