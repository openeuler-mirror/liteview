...
void StringTableKey::set_raw_hash_field(uint32_t raw_hash_field) { raw_hash_field_ = raw_hash_field; }

uint32_t StringTableKey::hash() const { return Name::HashBits::decode(raw_hash_field_); }
