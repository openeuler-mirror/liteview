...
public:
    ...
    static MaybeHandle<Script> GetScript(Isolate* isolate, Handle<CallSiteInfo> info);
    ...
    V8_EXPORT_PRIVATE static Handle<PrimitiveHeapObject> GetFunctionName(Handle<CallSiteInfo> info);
    ...
    static bool ComputeLocation(Handle<CallSiteInfo> info, MessageLocation* location);
