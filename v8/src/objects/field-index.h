...
public:
    ...
    static inline FieldIndex ForPropertyIndex(Map map, int index, Representation representation = Representation::Tagged());
    ...
    static inline FieldIndex ForDescriptor(Map map, InternalIndex descriptor_index);
    static inline FieldIndex ForDescriptor(PtrComprCageBase cage_base, Map map, InternalIndex descriptor_index);
    ...
    int GetFieldAccessStubKey() const { return bit_field_ & (IsInObjectBits::kMask | EncodingBits::kMask | OffsetBits::kMask); }

    bool operator==(FieldIndex const& other) const { return bit_field_ == other.bit_field_; }
...
private:
    FieldIndex(bool is_inobject, int offset, Encoding encoding, int inobject_properties, int first_inobject_property_offset)
    {
        ...
        bit_field_ = IsInObjectBits::encode(is_inobject) | EncodingBits::encode(encoding) | FirstInobjectPropertyOffsetBits::encode(first_inobject_property_offset)
            | OffsetBits::encode(offset) | InObjectPropertyBits::encode(inobject_properties);
    }
    ...
    int first_inobject_property_offset() const { return FirstInobjectPropertyOffsetBits::decode(bit_field_); }
