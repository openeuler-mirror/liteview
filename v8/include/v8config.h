...
#define V8_GNUC_PREREQ(major, minor, patchlevel) ((__GNUC__ * 10000 + __GNUC_MINOR__ * 100 + __GNUC_PATCHLEVEL__) >= ((major)*10000 + (minor)*100 + (patchlevel)))
...
// compiler.
#if !V8_TARGET_ARCH_X64 && !V8_TARGET_ARCH_IA32 && !V8_TARGET_ARCH_ARM && !V8_TARGET_ARCH_ARM64 && !V8_TARGET_ARCH_MIPS64 && !V8_TARGET_ARCH_PPC && !V8_TARGET_ARCH_PPC64          \
    && !V8_TARGET_ARCH_S390 && !V8_TARGET_ARCH_RISCV64 && !V8_TARGET_ARCH_LOONG64 && !V8_TARGET_ARCH_RISCV32
#if defined(_M_X64) || defined(__x86_64__)
