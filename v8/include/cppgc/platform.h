...
public:
     ...
     */
    virtual std::shared_ptr<TaskRunner> GetForegroundTaskRunner() { return nullptr; }
     ...
     * \endcode
     */
    virtual std::unique_ptr<JobHandle> PostJob(TaskPriority priority, std::unique_ptr<JobTask> job_task) { return nullptr; }
