...
public:
    ...
    static V8_INLINE WriteBarrierType GetWriteBarrierType(const internal::BasicMember<T, WeaknessTag, WriteBarrierPolicy, CheckingPolicy>& value, WriteBarrierParams& params)
    {
     ...
     * \returns whether a write barrier is needed and which barrier to invoke.
     */
    template <typename HeapHandleCallback> static V8_INLINE WriteBarrierType GetWriteBarrierType(const void* slot, WriteBarrierParams& params, HeapHandleCallback callback)
    {
     ...
     * \returns whether a write barrier is needed and which barrier to invoke.
     */
    static V8_INLINE WriteBarrierType GetWriteBarrierType(const void* value, WriteBarrierParams& params) { return internal::WriteBarrier::GetWriteBarrierType(value, params); }
     ...
     */
    static V8_INLINE void DijkstraWriteBarrier(const WriteBarrierParams& params, const void* object) { internal::WriteBarrier::DijkstraMarkingBarrier(params, object); }
     ...
     *   not supported.
     */
    static V8_INLINE void SteeleWriteBarrier(const WriteBarrierParams& params, const void* object) { internal::WriteBarrier::SteeleMarkingBarrier(params, object); }
