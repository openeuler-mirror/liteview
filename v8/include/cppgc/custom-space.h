...
// class CustomSpaceBaseTest {
// public:
//   CustomSpaceBaseTest() {
//
//   }
//   virtual ~CustomSpaceBaseTest() = default;
...
// };
//
// struct HeapOptionsTest {
//   std::vector<std::unique_ptr<CustomSpaceBaseTest> > custom_spaces2;
// };
...
public:
    ...
    CustomSpaceIndex GetCustomSpaceIndex() const final { return ConcreteCustomSpace::kSpaceIndex; }
    bool IsCompactable() const final { return ConcreteCustomSpace::kSupportsCompaction; }
};
