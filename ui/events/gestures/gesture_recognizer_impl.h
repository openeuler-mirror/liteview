...
public:
    ...
    std::vector<std::unique_ptr<ui::TouchEvent>> ExtractTouches(GestureConsumer* consumer) override;
    void TransferTouches(GestureConsumer* consumer, const std::vector<std::unique_ptr<ui::TouchEvent>>& touch_events) override;
...
private:
    ...
    std::map<GestureConsumer*, std::unique_ptr<GestureProviderAura>> consumer_gesture_provider_;
