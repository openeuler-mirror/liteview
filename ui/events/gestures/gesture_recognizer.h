...
public:
    ...
    virtual std::vector<std::unique_ptr<TouchEvent>> ExtractTouches(GestureConsumer* consumer) = 0;
    ...
    virtual void TransferTouches(GestureConsumer* consumer, const std::vector<std::unique_ptr<ui::TouchEvent>>& touch_events) = 0;
