...
public:
    ...
    void set_gesture_consumer(GestureConsumer* consumer) { gesture_consumer_ = consumer; }

    FilteredGestureProvider& filtered_gesture_provider() { return filtered_gesture_provider_; }
