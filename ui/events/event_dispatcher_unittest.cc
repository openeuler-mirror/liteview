...
public:
    ...
    void AddHandlerId(int id) { handler_list_.push_back(id); }
...
private:
    ...
    std::unique_ptr<EventTargetIterator> GetChildIterator() const override { return nullptr; }
...
public:
    EventHandlerDestroyDispatcherDelegate(EventDispatcherDelegate* delegate, int id)
        : TestEventHandler(id)
...
public:
    ...
    void set_dispatcher_delegate(EventDispatcherDelegate* dispatcher_delegate) { dispatcher_delegate_ = dispatcher_delegate; }
...
public:
    ...
    EventDispatchDetails ProcessEvent(EventTarget* target, Event* event) { return DispatchEvent(target, event); }
...
TEST(EventDispatcherTest, EventDispatchOrder)
{
    ...
    MouseEvent mouse(ui::ET_MOUSE_MOVED, gfx::Point(3, 4), gfx::Point(3, 4), ui::EventTimeForNow(), 0, 0);
