...
TEST(MotionEventAndroidTest, Constructor)
{
    ...
    base::TimeTicks event_time = base::TimeTicks() + base::Milliseconds(kEventTimeMS);
    ...
    int history_size = 0;
    int action_index = -1;
    MotionEventAndroid event(base::android::AttachCurrentThread(), nullptr, kPixToDip, 0.f, 0.f, 0.f, kEventTimeMS, kAndroidActionDown, pointer_count, history_size, action_index,
        kAndroidActionButton, 0, kAndroidButtonPrimary, kAndroidAltKeyDown, raw_offset, -raw_offset, false, &p0, &p1);
...
TEST(MotionEventAndroidTest, Clone)
{
    ...
    MotionEventAndroid::Pointer p0(1, 13.7f, -7.13f, 5.3f, 1.2f, 0.1f, 0.2f, kAndroidToolTypeFinger);
    MotionEventAndroid event(base::android::AttachCurrentThread(), nullptr, kPixToDip, 0, 0, 0, 0, kAndroidActionDown, pointer_count, 0, 0, 0, 0, 0, 0, 0, 0, false, &p0, nullptr);
...
TEST(MotionEventAndroidTest, Cancel)
{
    ...
    MotionEventAndroid event(
        base::android::AttachCurrentThread(), nullptr, kPixToDip, 0, 0, 0, kEventTimeMS, kAndroidActionDown, pointer_count, 0, 0, 0, 0, 0, 0, 0, 0, false, &p0, nullptr);
...
TEST(MotionEventAndroidTest, InvalidOrientationsSanitized)
{
    ...
    MotionEventAndroid event(base::android::AttachCurrentThread(), nullptr, kPixToDip, 0, 0, 0, 0, kAndroidActionDown, pointer_count, 0, 0, 0, 0, 0, 0, 0, 0, false, &p0, &p1);
...
TEST(MotionEventAndroidTest, NonEmptyHistoryForNonMoveEventsSanitized)
{
    ...
    MotionEventAndroid event(
        base::android::AttachCurrentThread(), nullptr, kPixToDip, 0, 0, 0, 0, kAndroidActionDown, pointer_count, history_size, 0, 0, 0, 0, 0, 0, 0, false, &p0, nullptr);
...
TEST(MotionEventAndroidTest, ActionIndexForPointerDown)
{
    ...
    int history_size = 0;
    int action_index = 1;
    MotionEventAndroid event(base::android::AttachCurrentThread(), nullptr, kPixToDip, 0, 0, 0, 0, kAndroidActionPointerDown, pointer_count, history_size, action_index, 0, 0, 0, 0,
        0, 0, false, &p0, &p1);
