...
public:
    GestureEventAndroid(int type, const gfx::PointF& location, const gfx::PointF& screen_location, long time_ms, float scale, float delta_x, float delta_y, float velocity_x,
        float velocity_y, bool target_viewport, bool synthetic_scroll, bool prevent_boosting);
