...
EventModifiers::EventModifiers() { memset(modifiers_down_, 0, sizeof(modifiers_down_)); }
...
int EventModifiers::GetModifierFlags() { return modifier_flags_; }
...
// static
int EventModifiers::GetEventFlagFromModifier(unsigned int modifier) { return kEventFlagFromModifiers[modifier]; }
