...
WebMouseEvent WebMouseEventBuilder::Build(HWND hwnd, UINT message, WPARAM wparam, LPARAM lparam, base::TimeTicks time_stamp, blink::WebPointerProperties::PointerType pointer_type)
{
    ...
    HWND hwnd, UINT message, WPARAM wparam, LPARAM lparam, base::TimeTicks time_stamp, blink::WebPointerProperties::PointerType pointer_type)
{
    ...
    if (horizontal_scroll) {
        ...
        base::UmaHistogramCounts10M("InputMethod.MouseWheel.ScrollCharacters", base::saturated_cast<int>(scroll_chars));
        ...
        base::UmaHistogramCounts10M("InputMethod.MouseWheel.ScrollLines", base::saturated_cast<int>(scroll_lines));
