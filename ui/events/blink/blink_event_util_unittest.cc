...
{
    blink::WebMouseWheelEvent event(blink::WebInputEvent::Type::kMouseWheel, blink::WebInputEvent::kNoModifiers, blink::WebInputEvent::GetStaticTimeStampForTests());
...
TEST(BlinkEventUtilTest, NonPaginatedWebMouseWheelEvent) { RunTest(ui::ScrollGranularity::kScrollByPixel); }

TEST(BlinkEventUtilTest, NonPaginatedWebMouseWheelEventPercentBased) { RunTest(ui::ScrollGranularity::kScrollByPercentage); }
...
{
    ui::GestureEventDetails details(ui::ET_GESTURE_SCROLL_BEGIN, 1, 1, ui::ScrollGranularity::kScrollByPage);
    details.set_device_type(ui::GestureDeviceType::DEVICE_TOUCHSCREEN);
    auto event = CreateWebGestureEvent(details, base::TimeTicks(), gfx::PointF(1.f, 1.f), gfx::PointF(1.f, 1.f), 0, 0U);
    std::unique_ptr<blink::WebInputEvent> webEvent = ScaleWebInputEvent(event, 2.f);
    EXPECT_TRUE(webEvent);
...
{
    ui::GestureEventDetails details(ui::ET_GESTURE_SCROLL_UPDATE, 1, 1, ui::ScrollGranularity::kScrollByPage);
    details.set_device_type(ui::GestureDeviceType::DEVICE_TOUCHSCREEN);
    auto event = CreateWebGestureEvent(details, base::TimeTicks(), gfx::PointF(1.f, 1.f), gfx::PointF(1.f, 1.f), 0, 0U);
    std::unique_ptr<blink::WebInputEvent> webEvent = ScaleWebInputEvent(event, 2.f);
    EXPECT_TRUE(webEvent);
...
TEST(BlinkEventUtilTest, WebEventModifersAndEventFlags)
{
    ...
    constexpr int kWebEventModifiersToTest[] = { WebInputEvent::kShiftKey, WebInputEvent::kControlKey, WebInputEvent::kAltKey, WebInputEvent::kAltGrKey, WebInputEvent::kMetaKey,
        WebInputEvent::kCapsLockOn, WebInputEvent::kNumLockOn, WebInputEvent::kScrollLockOn, WebInputEvent::kLeftButtonDown, WebInputEvent::kMiddleButtonDown,
        WebInputEvent::kRightButtonDown, WebInputEvent::kBackButtonDown, WebInputEvent::kForwardButtonDown, WebInputEvent::kIsAutoRepeat };
