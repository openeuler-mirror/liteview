...
public:
    ...
    virtual void OnKeyboardDevicesUpdated(const std::vector<InputDevice>& devices) = 0;
    ...
    virtual void OnTouchpadDevicesUpdated(const std::vector<InputDevice>& devices) = 0;
