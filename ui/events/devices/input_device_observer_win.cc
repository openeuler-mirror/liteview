...
#define WIN_NOTIFY_OBSERVERS(method_decl, input_device_types)                                                                                                                      \
    ...
    {                                                                                                                                                                              \
        for (InputDeviceEventObserver & observer : observers_) {                                                                                                                   \
            observer.OnInputDeviceConfigurationChanged(InputDeviceEventObserver::input_device_types);                                                                              \
        }                                                                                                                                                                          \
    }
...
InputDeviceObserverWin* InputDeviceObserverWin::GetInstance() { return base::Singleton<InputDeviceObserverWin, base::LeakySingletonTraits<InputDeviceObserverWin>>::get(); }
...
void InputDeviceObserverWin::AddObserver(InputDeviceEventObserver* observer) { observers_.AddObserver(observer); }

void InputDeviceObserverWin::RemoveObserver(InputDeviceEventObserver* observer) { observers_.RemoveObserver(observer); }
