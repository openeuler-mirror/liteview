...
protected:
    void CallOnDeviceListsComplete() { DeviceDataManager::GetInstance()->OnDeviceListsComplete(); }
};
...
public:
    ...
    int on_touch_device_associations_changed_call_count() const { return on_touch_device_associations_changed_call_count_; }

    // InputDeviceEventObserver:
    void OnTouchDeviceAssociationChanged() override { on_touch_device_associations_changed_call_count_++; }
