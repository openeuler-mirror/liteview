...
void MicrophoneMuteSwitchMonitor::AddObserver(Observer* observer) { observers_.AddObserver(observer); }

void MicrophoneMuteSwitchMonitor::RemoveObserver(Observer* observer) { observers_.RemoveObserver(observer); }
