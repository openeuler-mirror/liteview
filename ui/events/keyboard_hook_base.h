...
public:
    KeyboardHookBase(absl::optional<base::flat_set<DomCode>> dom_codes, KeyEventCallback callback);
...
protected:
    ...
    const absl::optional<base::flat_set<DomCode>>& dom_codes() { return dom_codes_; }
