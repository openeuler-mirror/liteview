...
public:
    ...
    void set_device_type(GestureDeviceType device_type) { device_type_ = device_type; }

    bool is_source_touch_event_set_blocking() const { return is_source_touch_event_set_blocking_; }
    void set_is_source_touch_event_set_blocking(bool is_source_touch_event_set_blocking) { is_source_touch_event_set_blocking_ = is_source_touch_event_set_blocking; }

    EventPointerType primary_pointer_type() const { return primary_pointer_type_; }
    void set_primary_pointer_type(EventPointerType primary_pointer_type) { primary_pointer_type_ = primary_pointer_type; }

    uint32_t primary_unique_touch_event_id() const { return primary_unique_touch_event_id_; }
    void set_primary_unique_touch_event_id(uint32_t unique_touch_event_id) { primary_unique_touch_event_id_ = unique_touch_event_id; }
    ...
    const gfx::Rect bounding_box() const { return ToEnclosingRect(bounding_box_); }

    const gfx::RectF& bounding_box_f() const { return bounding_box_; }
    ...
    {
        return type_ == other.type_ && !memcmp(&data_, &other.data_, sizeof(Details)) && device_type_ == other.device_type_ && touch_points_ == other.touch_points_
