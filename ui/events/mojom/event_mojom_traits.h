...
template <> struct StructTraits<ui::mojom::PointerDetailsDataView, ui::PointerDetails> {
    static ui::EventPointerType pointer_type(const ui::PointerDetails& i) { return i.pointer_type; }
    ...
    static float tangential_pressure(const ui::PointerDetails& i) { return i.tangential_pressure; }
