...
const size_t kWritingSystemKeyDomCodeEntries = std::size(writing_system_key_domcodes);
...
void DomKeyboardLayout::AddKeyMapping(DomCode code, uint32_t unicode) { layout_.emplace(code, unicode); }
