...
uint32_t DomKeyboardLayoutMapWin::GetKeyboardLayoutCount()
{
    ...
    // evaluated first.
    auto iter = std::find(keyboard_layout_handles_.begin(), keyboard_layout_handles_.end(), GetKeyboardLayout(0));
...
// static
base::flat_map<std::string, std::string> GenerateDomKeyboardLayoutMap() { return DomKeyboardLayoutMapWin().Generate(); }
