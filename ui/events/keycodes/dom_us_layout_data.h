...
#if BUILDFLAG(IS_POSIX)
    { DomCode::PRIVACY_SCREEN_TOGGLE, VKEY_PRIVACY_SCREEN_TOGGLE }, // 0x000017 PrivacyScreenToggle
    { DomCode::MICROPHONE_MUTE_TOGGLE, VKEY_MICROPHONE_MUTE_TOGGLE }, // 0x000018 MicrophoneMuteToggle
    { DomCode::KEYBOARD_BACKLIGHT_TOGGLE, VKEY_KBD_BACKLIGHT_TOGGLE }, // 0x000019 KeyboardBacklightToggle
#endif
