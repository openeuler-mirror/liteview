...
DomKey DomKeyFromFuchsiaNonPrintableKey(const fuchsia::ui::input3::NonPrintableKey& key)
{
...
DomKey DomKeyFromFuchsiaKeyMeaning(const fuchsia::ui::input3::KeyMeaning& key_meaning)
{
