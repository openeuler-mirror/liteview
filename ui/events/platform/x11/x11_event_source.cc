...
// static
bool X11EventSource::HasInstance() { return GetInstance(); }

// static
X11EventSource* X11EventSource::GetInstance() { return static_cast<X11EventSource*>(PlatformEventSource::GetInstance()); }
...
x11::Time X11EventSource::GetCurrentServerTime()
{
    ...
    if (!dummy_initialized_) {
        ...
        dummy_window_events_ = std::make_unique<x11::XScopedEventSelector>(dummy_window_, x11::EventMask::PropertyChange);
...
absl::optional<gfx::Point> X11EventSource::GetRootCursorLocationFromCurrentEvent() const
{
...
void X11EventSource::OnEvent(const x11::Event& x11_event)
{
    ...
    if (crossing && crossing->opcode == x11::CrossingEvent::EnterNotify && crossing->detail != x11::NotifyDetail::Inferior && crossing->mode != x11::NotifyMode::Ungrab) {
