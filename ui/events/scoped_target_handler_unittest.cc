...
public:
    ...
    std::unique_ptr<EventTargetIterator> GetChildIterator() const override { return base::WrapUnique(new TestEventTargetIterator); }
...
TEST(ScopedTargetHandlerTest, HandlerInvoked)
{
    ...
    MouseEvent event(ET_MOUSE_PRESSED, gfx::Point(), gfx::Point(), EventTimeForNow(), EF_LEFT_MOUSE_BUTTON, EF_LEFT_MOUSE_BUTTON);
