...
public:
    KeyboardHookWinBase(absl::optional<base::flat_set<DomCode>> dom_codes, KeyEventCallback callback, bool enable_hook_registration);
    ...
    static std::unique_ptr<KeyboardHookWinBase> CreateModifierKeyboardHookForTesting(absl::optional<base::flat_set<DomCode>> dom_codes, KeyEventCallback callback);
