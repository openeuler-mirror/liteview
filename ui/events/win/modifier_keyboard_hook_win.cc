...
bool IsControlKey(DWORD vk) { return vk == VK_CONTROL || vk == VK_LCONTROL || vk == VK_RCONTROL; }

bool IsWindowsKey(DWORD vk) { return vk == VK_LWIN || vk == VK_RWIN; }
...
public:
    ModifierKeyboardHookWinImpl(absl::optional<base::flat_set<DomCode>> dom_codes, KeyEventCallback callback, bool enable_hook_registration);
...
ModifierKeyboardHookWinImpl::ModifierKeyboardHookWinImpl(absl::optional<base::flat_set<DomCode>> dom_codes, KeyEventCallback callback, bool enable_hook_registration)
...
// static
std::unique_ptr<KeyboardHookWinBase> KeyboardHookWinBase::CreateModifierKeyboardHookForTesting(absl::optional<base::flat_set<DomCode>> dom_codes, KeyEventCallback callback)
{
