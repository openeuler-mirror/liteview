...
public:
    ...
    void set_mark_events_as_handled(bool handle) { mark_events_as_handled_ = handle; }
    ...
    void set_recorder(HandlerSequenceRecorder* recorder) { recorder_ = recorder; }
    void set_target_name(const std::string& target_name) { target_name_ = target_name; }
