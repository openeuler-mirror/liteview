...
public:
    ...
    void set_time_stamp(base::TimeTicks time_stamp) { event_->time_stamp_ = time_stamp; }

    void set_source_device_id(int source_device_id) { event_->source_device_id_ = source_device_id; }
...
public:
    ...
    void set_location(const gfx::Point& location) { located_event_->set_location(location); }
    void set_location_f(const gfx::PointF& location) { located_event_->set_location_f(location); }
...
public:
    ...
    void set_is_char(bool is_char) { key_event_->set_is_char(is_char); }
