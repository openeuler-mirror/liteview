...
void MockMotionEvent::PushPointer(float x, float y) { MotionEventGeneric::PushPointer(CreatePointer(x, y, static_cast<int>(GetPointerCount()))); }
...
MotionEvent::Classification MockMotionEvent::GetClassification() const { return gesture_classification_; }
