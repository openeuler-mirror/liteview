...
constexpr fup::TouchInteractionId kIxnOne = { .device_id = 1u, .pointer_id = 1u, .interaction_id = 2u };
...
protected:
    PointerEventsHandlerTest()
    {
        ...
        pointer_handler_ = std::make_unique<PointerEventsHandler>(touch_source_bindings_.AddBinding(touch_source_.get()), mouse_source_bindings_.AddBinding(mouse_source_.get()));
    }
...
TEST_F(PointerEventsHandlerTest, Watch_EventCallbacksAreIndependent)
{
    ...
    std::vector<fup::TouchEvent> touch_events = TouchEventBuilder()
                                                    .AddTime(1111789u)
                                                    .AddViewParameters(kRect, kRect, kIdentity)
                                                    .AddSample(kIxnOne, fup::EventPhase::ADD, { 10.f, 10.f })
                                                    .AddResult({ .interaction = kIxnOne, .status = fup::TouchInteractionStatus::GRANTED })
                                                    .BuildAsVector();
    ...
    std::vector<fup::MouseEvent> mouse_events = MouseEventBuilder()
                                                    .AddTime(1111789u)
                                                    .AddViewParameters(kRect, kRect, kIdentity)
                                                    .AddSample(kMouseDeviceId, { 10.f, 10.f }, { 0 }, kNoScrollDelta, kNoScrollInPhysicalPixelDelta, kNotPrecisionScroll)
...
TEST_F(PointerEventsHandlerTest, Data_FuchsiaTimeVersusChromeTime)
{
    ...
    std::vector<fup::TouchEvent> events = TouchEventBuilder()
...
TEST_F(PointerEventsHandlerTest, Phase_ChromeMouseEventTypesAreSynthesized)
{
    ...
    std::vector<fup::MouseEvent> events = MouseEventBuilder()
                                              .AddTime(1111789u)
                                              .AddViewParameters(kRect, kRect, kIdentity)
                                              .AddSample(kMouseDeviceId, { 10.f, 10.f }, { 0 /*button id*/ }, kNoScrollDelta, kNoScrollInPhysicalPixelDelta, kNotPrecisionScroll)
                                              .AddMouseDeviceInfo(kMouseDeviceId, { 2 /*first button id*/, 0 /*second button id*/, 1 /*third button id*/ })
                                              .BuildAsVector();
    ...
    events
        = MouseEventBuilder().AddTime(1111789u).AddSample(kMouseDeviceId, { 10.f, 10.f }, {}, kNoScrollDelta, kNoScrollInPhysicalPixelDelta, kNotPrecisionScroll).BuildAsVector();
    mouse_source_->ScheduleCallback(std::move(events));
    RunLoopUntilIdle();
...
TEST_F(PointerEventsHandlerTest, Phase_ChromeMouseEventFlagsAreSynthesized)
{
    ...
    events = MouseEventBuilder()
                 .AddTime(1111789u)
                 .AddSample(kMouseDeviceId, { 10.f, 10.f }, { 2 }, kNoScrollDelta, kNoScrollInPhysicalPixelDelta, kNotPrecisionScroll)
                 .BuildAsVector();
    mouse_source_->ScheduleCallback(std::move(events));
    RunLoopUntilIdle();
...
TEST_F(PointerEventsHandlerTest, Phase_ChromeMouseEventFlagCombo)
{
    ...
    std::vector<fup::MouseEvent> events = MouseEventBuilder()
                                              .AddTime(1111789u)
                                              .AddViewParameters(kRect, kRect, kIdentity)
                                              .AddSample(kMouseDeviceId, { 10.f, 10.f }, { 0, 1 }, kNoScrollDelta, kNoScrollInPhysicalPixelDelta, kNotPrecisionScroll)
                                              .AddMouseDeviceInfo(kMouseDeviceId, { 0, 1, 2 })
                                              .BuildAsVector();
    mouse_source_->ScheduleCallback(std::move(events));
    RunLoopUntilIdle();
...
TEST_F(PointerEventsHandlerTest, ChromeMouseEventDoubleClick)
{
    ...
    events.push_back(MouseEventBuilder()
                         .AddTime(2111789u)
                         .AddViewParameters(kRect, kRect, kIdentity)
                         .AddSample(kMouseDeviceId, { 10.f, 10.f }, {}, kNoScrollDelta, kNoScrollInPhysicalPixelDelta, kNotPrecisionScroll)
                         .AddMouseDeviceInfo(kMouseDeviceId, { 0, 1, 2 })
                         .Build());
    // Press
    events.push_back(MouseEventBuilder()
...
TEST_F(PointerEventsHandlerTest, MouseMultiButtonDrag)
{
    ...
    events.push_back(MouseEventBuilder()
                         .AddTime(1111790u)
                         .AddViewParameters(kRect, kRect, kIdentity)
                         .AddSample(kMouseDeviceId, { 11.f, 10.f }, { 0, 1 }, kNoScrollDelta, kNoScrollInPhysicalPixelDelta, kNotPrecisionScroll)
                         .Build());
    // right button up.
    events.push_back(MouseEventBuilder()
                         .AddTime(1111791u)
                         .AddViewParameters(kRect, kRect, kIdentity)
                         .AddSample(kMouseDeviceId, { 11.f, 10.f }, { 0 }, kNoScrollDelta, kNoScrollInPhysicalPixelDelta, kNotPrecisionScroll)
                         .Build());
    // drag with left button pressing.
    events.push_back(MouseEventBuilder()
                         .AddTime(1111792u)
                         .AddViewParameters(kRect, kRect, kIdentity)
                         .AddSample(kMouseDeviceId, { 11.f, 11.f }, { 0 }, kNoScrollDelta, kNoScrollInPhysicalPixelDelta, kNotPrecisionScroll)
                         .Build());
    // left button up.
    events.push_back(MouseEventBuilder()
                         .AddTime(11117913u)
                         .AddViewParameters(kRect, kRect, kIdentity)
                         .AddSample(kMouseDeviceId, { 11.f, 11.f }, {}, kNoScrollDelta, kNoScrollInPhysicalPixelDelta, kNotPrecisionScroll)
                         .Build());
    // mouse move.
    events.push_back(MouseEventBuilder()
                         .AddTime(1111794u)
                         .AddViewParameters(kRect, kRect, kIdentity)
                         .AddSample(kMouseDeviceId, { 12.f, 11.f }, {}, kNoScrollDelta, kNoScrollInPhysicalPixelDelta, kNotPrecisionScroll)
                         .Build());
...
TEST_F(PointerEventsHandlerTest, MouseWheelEvent)
{
    ...
    std::vector<fup::MouseEvent> events = MouseEventBuilder()
                                              .AddTime(1111789u)
                                              .AddViewParameters(kRect, kRect, kIdentity)
                                              .AddSample(kMouseDeviceId, { 10.f, 10.f }, {}, { 0, 1 }, kNoScrollInPhysicalPixelDelta, kNotPrecisionScroll)
                                              .AddMouseDeviceInfo(kMouseDeviceId, { 0, 1, 2 })
                                              .BuildAsVector();
    mouse_source_->ScheduleCallback(std::move(events));
    RunLoopUntilIdle();
    ...
    events = MouseEventBuilder()
                 .AddTime(1111789u)
                 .AddViewParameters(kRect, kRect, kIdentity)
                 .AddSample(kMouseDeviceId, { 10.f, 10.f }, {}, { 1, 0 }, kNoScrollInPhysicalPixelDelta, kNotPrecisionScroll)
                 .AddMouseDeviceInfo(kMouseDeviceId, { 0, 1, 2 })
                 .BuildAsVector();
    mouse_source_->ScheduleCallback(std::move(events));
    RunLoopUntilIdle();
...
TEST_F(PointerEventsHandlerTest, MouseWheelEventDeltaInPhysicalPixel)
{
    ...
    std::vector<fup::MouseEvent> events = MouseEventBuilder()
                                              .AddTime(1111789u)
                                              .AddViewParameters(kRect, kRect, kIdentity)
                                              .AddSample(kMouseDeviceId, { 10.f, 10.f }, {}, { 0, 1 }, { 0, 100 }, kNotPrecisionScroll)
                                              .AddMouseDeviceInfo(kMouseDeviceId, { 0, 1, 2 })
                                              .BuildAsVector();
    mouse_source_->ScheduleCallback(std::move(events));
    RunLoopUntilIdle();
    ...
    events = MouseEventBuilder()
                 .AddTime(1111789u)
                 .AddViewParameters(kRect, kRect, kIdentity)
                 .AddSample(kMouseDeviceId, { 10.f, 10.f }, {}, { 1, 0 }, { 100, 0 }, kNotPrecisionScroll)
                 .AddMouseDeviceInfo(kMouseDeviceId, { 0, 1, 2 })
                 .BuildAsVector();
    mouse_source_->ScheduleCallback(std::move(events));
    RunLoopUntilIdle();
...
TEST_F(PointerEventsHandlerTest, ScrollEventDeltaInPhysicalPixel)
{
    ...
    std::vector<fup::MouseEvent> events = MouseEventBuilder()
                                              .AddTime(1111789u)
                                              .AddViewParameters(kRect, kRect, kIdentity)
                                              .AddSample(kMouseDeviceId, { 10.f, 10.f }, {}, { 0, 1 }, { 0, 100 }, kPrecisionScroll)
                                              .AddMouseDeviceInfo(kMouseDeviceId, { 0, 1, 2 })
                                              .BuildAsVector();
    mouse_source_->ScheduleCallback(std::move(events));
    RunLoopUntilIdle();
    ...
    events = MouseEventBuilder()
                 .AddTime(1111789u)
                 .AddViewParameters(kRect, kRect, kIdentity)
                 .AddSample(kMouseDeviceId, { 10.f, 10.f }, {}, { 1, 0 }, { 100, 0 }, kPrecisionScroll)
                 .AddMouseDeviceInfo(kMouseDeviceId, { 0, 1, 2 })
                 .BuildAsVector();
    mouse_source_->ScheduleCallback(std::move(events));
    RunLoopUntilIdle();
...
TEST_F(PointerEventsHandlerTest, ScrollEventDeltaInPhysicalPixelNoTickDelta)
{
    ...
    std::vector<fup::MouseEvent> events = MouseEventBuilder()
                                              .AddTime(1111789u)
                                              .AddViewParameters(kRect, kRect, kIdentity)
                                              .AddSample(kMouseDeviceId, { 10.f, 10.f }, {}, kNoScrollDelta, { 0, 100 }, kPrecisionScroll)
                                              .AddMouseDeviceInfo(kMouseDeviceId, { 0, 1, 2 })
                                              .BuildAsVector();
    mouse_source_->ScheduleCallback(std::move(events));
    RunLoopUntilIdle();
    ...
    events = MouseEventBuilder()
                 .AddTime(1111789u)
                 .AddViewParameters(kRect, kRect, kIdentity)
                 .AddSample(kMouseDeviceId, { 10.f, 10.f }, {}, kNoScrollDelta, { 100, 0 }, kPrecisionScroll)
                 .AddMouseDeviceInfo(kMouseDeviceId, { 0, 1, 2 })
                 .BuildAsVector();
    mouse_source_->ScheduleCallback(std::move(events));
    RunLoopUntilIdle();
...
TEST_F(PointerEventsHandlerTest, MouseWheelEventWithButtonPressed)
{
    ...
    events.push_back(MouseEventBuilder()
                         .AddTime(1111789u)
                         .AddViewParameters(kRect, kRect, kIdentity)
                         .AddSample(kMouseDeviceId, { 10.f, 10.f }, { 0 }, { 0, 1 }, kNoScrollInPhysicalPixelDelta, kNotPrecisionScroll)
                         .Build());
    mouse_source_->ScheduleCallback(std::move(events));
...
TEST_F(PointerEventsHandlerTest, Phase_ChromeTouchEventTypesAreSynthesized)
{
    ...
    events = TouchEventBuilder().AddTime(2222000u).AddSample(kIxnOne, fup::EventPhase::CHANGE, { 10.f, 10.f }).BuildAsVector();
    touch_source_->ScheduleCallback(std::move(events));
    RunLoopUntilIdle();
    ...
    events = TouchEventBuilder().AddTime(3333000u).AddSample(kIxnOne, fup::EventPhase::REMOVE, { 10.f, 10.f }).BuildAsVector();
    touch_source_->ScheduleCallback(std::move(events));
    RunLoopUntilIdle();
...
TEST_F(PointerEventsHandlerTest, Phase_FuchsiaCancelBecomesChromeCancel)
{
    ...
    events = TouchEventBuilder().AddTime(2222000u).AddSample(kIxnOne, fup::EventPhase::CANCEL, { 10.f, 10.f }).BuildAsVector();
    touch_source_->ScheduleCallback(std::move(events));
    RunLoopUntilIdle();
...
TEST_F(PointerEventsHandlerTest, Protocol_ResponseMatchesEarlierEvents)
{
    ...
    std::vector<fup::TouchEvent> events = TouchEventBuilder().AddTime(1111000u).AddViewParameters(kRect, kRect, kIdentity).BuildAsVector();

    // Fuchsia ptr 1 ADD sample. Yes response.
    fup::TouchEvent e1 = TouchEventBuilder()
                             .AddTime(1111000u)
                             .AddViewParameters(kRect, kRect, kIdentity)
                             .AddSample({ .device_id = 0u, .pointer_id = 1u, .interaction_id = 3u }, fup::EventPhase::ADD, { 10.f, 10.f })
                             .Build();
    events.emplace_back(std::move(e1));

    // Fuchsia ptr 2 ADD sample. Yes response.
    fup::TouchEvent e2 = TouchEventBuilder().AddTime(1111000u).AddSample({ .device_id = 0u, .pointer_id = 2u, .interaction_id = 3u }, fup::EventPhase::ADD, { 5.f, 5.f }).Build();
    events.emplace_back(std::move(e2));

    // Fuchsia ptr 3 ADD sample. Yes response.
    fup::TouchEvent e3 = TouchEventBuilder().AddTime(1111000u).AddSample({ .device_id = 0u, .pointer_id = 3u, .interaction_id = 3u }, fup::EventPhase::ADD, { 1.f, 1.f }).Build();
...
TEST_F(PointerEventsHandlerTest, Protocol_LateGrant)
{
    ...
    std::vector<fup::TouchEvent> events
        = TouchEventBuilder().AddTime(1111000u).AddViewParameters(kRect, kRect, kIdentity).AddSample(kIxnOne, fup::EventPhase::ADD, { 10.f, 10.f }).BuildAsVector();
    touch_source_->ScheduleCallback(std::move(events));
    RunLoopUntilIdle();
    ...
    events = TouchEventBuilder().AddTime(3333000u).AddResult({ kIxnOne, fup::TouchInteractionStatus::GRANTED }).BuildAsVector();
    touch_source_->ScheduleCallback(std::move(events));
    RunLoopUntilIdle();
    ...
    events = TouchEventBuilder().AddTime(/* in nanoseconds */ 4444000u).AddSample(kIxnOne, fup::EventPhase::CHANGE, { 10.f, 10.f }).BuildAsVector();
    touch_source_->ScheduleCallback(std::move(events));
    RunLoopUntilIdle();
...
TEST_F(PointerEventsHandlerTest, Protocol_LateDeny)
{
    ...
    events = TouchEventBuilder().AddTime(3333000u).AddResult({ kIxnOne, fup::TouchInteractionStatus::DENIED }).BuildAsVector();
    touch_source_->ScheduleCallback(std::move(events));
    RunLoopUntilIdle();
...
TEST_F(PointerEventsHandlerTest, Protocol_PointersAreIndependent)
{
    ...
    constexpr fup::TouchInteractionId kIxnTwo = { .device_id = 1u, .pointer_id = 2u, .interaction_id = 2u };

    // Fuchsia ptr1 ADD and ptr2 ADD, no grant result for either - buffer them.
    std::vector<fup::TouchEvent> events
        = TouchEventBuilder().AddTime(1111000u).AddViewParameters(kRect, kRect, kIdentity).AddSample(kIxnOne, fup::EventPhase::ADD, { 10.f, 10.f }).BuildAsVector();
    fup::TouchEvent ptr2 = TouchEventBuilder().AddTime(1111000u).AddSample(kIxnTwo, fup::EventPhase::ADD, { 15.f, 15.f }).Build();
    ...
    events = TouchEventBuilder().AddTime(2222000u).AddResult({ kIxnTwo, fup::TouchInteractionStatus::GRANTED }).BuildAsVector();
    touch_source_->ScheduleCallback(std::move(events));
    RunLoopUntilIdle();
