...
public:
    ...
    absl::optional<std::vector<fuchsia::ui::pointer::TouchResponse>> UploadedResponses();

private:
    // |fuchsia.ui.pointer.TouchSource|
    void UpdateResponse(
        fuchsia::ui::pointer::TouchInteractionId interaction_id, fuchsia::ui::pointer::TouchResponse response, TouchSource::UpdateResponseCallback callback) override;
