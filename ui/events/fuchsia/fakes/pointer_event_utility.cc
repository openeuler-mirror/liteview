...
fup::ViewParameters CreateViewParameters(std::array<std::array<float, 2>, 2> view, std::array<std::array<float, 2>, 2> viewport, std::array<float, 9> transform)
{
...
TouchEventBuilder& TouchEventBuilder::AddSample(fup::TouchInteractionId id, fup::EventPhase phase, std::array<float, 2> position)
{
...
TouchEventBuilder& TouchEventBuilder::AddViewParameters(std::array<std::array<float, 2>, 2> view, std::array<std::array<float, 2>, 2> viewport, std::array<float, 9> transform)
{
    params_ = CreateViewParameters(std::move(view), std::move(viewport), std::move(transform));
    return *this;
}

TouchEventBuilder& TouchEventBuilder::AddResult(fup::TouchInteractionResult result)
{
    result_ = result;
    return *this;
}
...
MouseEventBuilder& MouseEventBuilder::AddSample(uint32_t id, std::array<float, 2> position, std::vector<uint8_t> pressed_buttons, std::array<int64_t, 2> scroll,
    std::array<int64_t, 2> scroll_in_physical_pixel, bool is_precision_scroll)
{
...
MouseEventBuilder& MouseEventBuilder::AddViewParameters(std::array<std::array<float, 2>, 2> view, std::array<std::array<float, 2>, 2> viewport, std::array<float, 9> transform)
{
    params_ = CreateViewParameters(std::move(view), std::move(viewport), std::move(transform));
    return *this;
}

MouseEventBuilder& MouseEventBuilder::AddMouseDeviceInfo(uint32_t id, std::vector<uint8_t> buttons)
{
