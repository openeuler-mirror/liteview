...
KeyboardHookBase::KeyboardHookBase(absl::optional<base::flat_set<DomCode>> dom_codes, KeyEventCallback callback)
...
bool KeyboardHookBase::IsKeyLocked(DomCode dom_code) const { return ShouldCaptureKeyEvent(dom_code); }
...
void KeyboardHookBase::ForwardCapturedKeyEvent(KeyEvent* event) { key_event_callback_.Run(event); }
