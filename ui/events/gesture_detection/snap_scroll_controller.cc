...
SnapScrollController::SnapScrollController(float snap_bound, const gfx::SizeF& display_size)
...
void SnapScrollController::SetSnapScrollMode(const MotionEvent& event, bool is_scale_gesture_detection_in_progress)
{
...
void SnapScrollController::UpdateSnapScrollMode(float distance_x, float distance_y)
{
...
bool SnapScrollController::IsSnapVertical() const { return mode_ == SNAP_VERT; }

bool SnapScrollController::IsSnapHorizontal() const { return mode_ == SNAP_HORIZ; }

bool SnapScrollController::IsSnappingScrolls() const { return IsSnapHorizontal() || IsSnapVertical(); }
