...
public:
    ...
    static GestureConfigurationAndroid* GetInstance() { return base::Singleton<GestureConfigurationAndroid>::get(); }
...
GestureConfiguration* GestureConfiguration::GetPlatformSpecificInstance() { return GestureConfigurationAndroid::GetInstance(); }
