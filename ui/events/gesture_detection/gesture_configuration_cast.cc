...
public:
    ...
    static GestureConfigurationCast* GetInstance() { return base::Singleton<GestureConfigurationCast>::get(); }
...
GestureConfiguration* GestureConfiguration::GetPlatformSpecificInstance() { return GestureConfigurationCast::GetInstance(); }
