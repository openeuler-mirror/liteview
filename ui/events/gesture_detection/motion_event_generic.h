...
public:
    ...
    const PointerProperties& pointer(size_t index) const { return pointers_[index]; }
    ...
    void set_unique_event_id(uint32_t unique_event_id) { unique_event_id_ = unique_event_id; }
