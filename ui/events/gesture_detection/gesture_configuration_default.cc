...
public:
    ...
    static GestureConfigurationDefault* GetInstance() { return base::Singleton<GestureConfigurationDefault>::get(); }
...
GestureConfiguration* GestureConfiguration::GetPlatformSpecificInstance() { return GestureConfigurationDefault::GetInstance(); }
