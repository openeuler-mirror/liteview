...
GESTURE_DETECTION_EXPORT GestureProvider::Config GetGestureProviderConfig(GestureProviderConfigType, scoped_refptr<base::SequencedTaskRunner> task_runner = nullptr);
