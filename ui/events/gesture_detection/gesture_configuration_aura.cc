...
public:
    ...
    static GestureConfigurationAura* GetInstance() { return base::Singleton<GestureConfigurationAura>::get(); }
...
private:
        ...
        : GestureConfiguration()
    {
        ...
        if (command_line->HasSwitch(switches::kTouchSlopDistance) && base::StringToDouble(command_line->GetSwitchValueASCII(switches::kTouchSlopDistance), &touch_slop_distance)) {
...
GestureConfiguration* GestureConfiguration::GetPlatformSpecificInstance() { return GestureConfigurationAura::GetInstance(); }
