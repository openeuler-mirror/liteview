...
void PointerProperties::SetAxesAndOrientation(float radius_x, float radius_y, float rotation_angle_degree)
{
    ...
    DCHECK(0 <= rotation_angle_rad && rotation_angle_rad < base::kPiFloat) << "Unexpected touch rotation angle " << rotation_angle_rad << " rad";
...
uint32_t MotionEventGeneric::GetUniqueEventId() const { return unique_event_id_; }

MotionEvent::Action MotionEventGeneric::GetAction() const { return action_; }
...
size_t MotionEventGeneric::GetPointerCount() const { return pointers_->size(); }
...
int MotionEventGeneric::GetButtonState() const { return button_state_; }

int MotionEventGeneric::GetFlags() const { return flags_; }

base::TimeTicks MotionEventGeneric::GetEventTime() const { return event_time_; }

size_t MotionEventGeneric::GetHistorySize() const { return historical_events_.size(); }
