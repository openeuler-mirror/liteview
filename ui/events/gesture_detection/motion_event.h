...
public:
    enum class Action { NONE, DOWN, UP, MOVE, CANCEL, POINTER_DOWN, POINTER_UP, HOVER_ENTER, HOVER_EXIT, HOVER_MOVE, BUTTON_PRESS, BUTTON_RELEASE, LAST = BUTTON_RELEASE };
...
GESTURE_DETECTION_EXPORT std::ostream& operator<<(std::ostream& stream, const MotionEvent::Action action);
GESTURE_DETECTION_EXPORT std::ostream& operator<<(std::ostream& stream, const MotionEvent::ToolType tool_type);
