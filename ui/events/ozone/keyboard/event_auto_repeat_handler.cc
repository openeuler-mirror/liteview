...
bool EventAutoRepeatHandler::IsAutoRepeatEnabled() { return auto_repeat_enabled_; }

void EventAutoRepeatHandler::SetAutoRepeatEnabled(bool enabled) { auto_repeat_enabled_ = enabled; }
...
void EventAutoRepeatHandler::UpdateKeyRepeat(unsigned int key, unsigned int scan_code, bool down, bool suppress_auto_repeat, int device_id)
{
...
void EventAutoRepeatHandler::StartKeyRepeat(unsigned int key, unsigned int scan_code, int device_id)
{
    repeat_key_ = key;
...
void EventAutoRepeatHandler::OnRepeatCommit(unsigned int sequence)
{
    ...
    delegate_->DispatchKey(repeat_key_, repeat_scan_code_, true /* down */, true /* repeat */, EventTimeForNow(), repeat_device_id_, ui::EF_NONE);
