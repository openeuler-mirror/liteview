...
TEST(InputControllerEvdevTest, AccelerationSuspension)
{
    ...
    EXPECT_TRUE(controller.input_device_settings_.pointing_stick_acceleration_enabled);
    ...
    EXPECT_FALSE(controller.input_device_settings_.pointing_stick_acceleration_enabled);
