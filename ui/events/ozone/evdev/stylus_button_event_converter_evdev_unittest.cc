...
public:
    ...
    void SetUp() override
    {
        ...
        event_factory_ = ui::CreateEventFactoryEvdevForTest(
            nullptr, device_manager_.get(), keyboard_layout_engine_.get(), base::BindRepeating(&StylusButtonEventConverterEvdevTest::DispatchEventForTest, base::Unretained(this)));
