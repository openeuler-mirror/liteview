...
public:
    TestMicrophoneMuteObserver() { ui::MicrophoneMuteSwitchMonitor::Get()->AddObserver(this); }
    ...
    ~TestMicrophoneMuteObserver() override { ui::MicrophoneMuteSwitchMonitor::Get()->RemoveObserver(this); }

    void OnMicrophoneMuteSwitchValueChanged(bool muted) override { observed_values_.push_back(muted); }
...
public:
    ...
    std::unique_ptr<ui::MicrophoneMuteSwitchEventConverterEvdev> CreateDevice(const ui::DeviceCapabilities& caps)
    {
        ...
        return std::make_unique<ui::MicrophoneMuteSwitchEventConverterEvdev>(std::move(events_in), base::FilePath(kTestDevicePath), 1, devinfo, dispatcher_.get());
    }
