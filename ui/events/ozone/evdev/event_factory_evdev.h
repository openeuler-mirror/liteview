...
public:
    ...
    void DispatchKeyboardDevicesUpdated(const std::vector<InputDevice>& devices, base::flat_map<int, std::vector<uint64_t>> key_bits_mapping);
    void DispatchTouchscreenDevicesUpdated(const std::vector<TouchscreenDevice>& devices);
    void DispatchMouseDevicesUpdated(const std::vector<InputDevice>& devices, bool has_mouse, bool has_pointing_stick);
    void DispatchTouchpadDevicesUpdated(const std::vector<InputDevice>& devices, bool has_haptic_touchpad);
