...
class PerOpTimings {
public:
    void Add(const std::string& op, absl::Duration time) { time_per_op_[op] += time; }
...
int32_t GetReduceInnerSize(
    int32_t input_tensor_rank, const int32_t* __restrict input_shape, int32_t index_tensor_rank, const int32_t* __restrict index_shape, const Tidx* __restrict index_values)
{
...
template <typename T>
void ConcatV2Args2(int32_t arg0_rank, const int32_t* __restrict arg0_shape, const T* __restrict arg0_values, int32_t arg1_rank, const int32_t* __restrict arg1_shape,
    const T* __restrict arg1_values, const int32_t* __restrict axis_value, T* __restrict output_values)
{
...
template <typename T>
void MatMul(
    const int32_t* __restrict input_shape, const T* __restrict input_values, const int32_t* __restrict weight_shape, const T* __restrict weight_values, T* __restrict output_values)
{
...
template <typename T>
void DepthwiseConv2dNative(const int32_t* __restrict input_shape, const T* __restrict input_values, const int32_t* __restrict kernel_shape, const T* __restrict kernel_values,
    int32_t stride_y, int32_t stride_x, int32_t out_height, int32_t out_width, T* __restrict output_values)
{
...
template <typename T>
void DepthwiseConv2dNativeVALID(const int32_t* __restrict input_shape, const T* __restrict input_values, const int32_t* __restrict kernel_shape, const T* __restrict kernel_values,
    int32_t stride_y, int32_t stride_x, T* __restrict output_values)
{
    const auto out_size = GetConvOutputSizeVALID(input_shape, kernel_shape, stride_y, stride_x);
    DepthwiseConv2dNative<T>(input_shape, input_values, kernel_shape, kernel_values, stride_y, stride_x, std::get<0>(out_size), std::get<1>(out_size), output_values);
}

template <typename T>
void DepthwiseConv2dNativeSAME(const int32_t* __restrict input_shape, const T* __restrict input_values, const int32_t* __restrict kernel_shape, const T* __restrict kernel_values,
    int32_t stride_y, int32_t stride_x, T* __restrict output_values)
{
...
template <typename T>
void FullyConnected(const int32_t* __restrict input_shape, const T* __restrict input_values, const int32_t* __restrict weight_shape, const T* __restrict weight_values,
...
template <typename T, typename Tidx>
void SparseFullyConnectedCSR(const int32_t* __restrict input_shape, const T* __restrict input_values, const int32_t num_rows, const int32_t* __restrict nnz_shape,
    const T* __restrict nnz_values, const Tidx* __restrict outer_index, const Tidx* __restrict cols, const int32_t* __restrict bias_shape, const T* __restrict bias_values,
...
void Gather(int32_t params_rank, const int32_t* __restrict params_shape, const T* __restrict params_values, int32_t indices_rank, const int32_t* __restrict indices_shape,
    const TIndex* __restrict indices_values, T* __restrict output_values)
{
...
template <typename T>
void Im2Row(const int32_t* __restrict input_shape, const T* __restrict input_values, const int32_t* __restrict kernel_shape, int32_t stride_y, int32_t stride_x, int32_t out_height,
...
template <typename T>
void Im2RowVALID(const int32_t* __restrict input_shape, const T* __restrict input_values, const int32_t* __restrict kernel_shape, int32_t stride_y, int32_t stride_x,
    T* __restrict output_values)
{
    const auto out_size = GetConvOutputSizeVALID(input_shape, kernel_shape, stride_y, stride_x);
...
template <typename T>
void Im2RowSAME(const int32_t* __restrict input_shape, const T* __restrict input_values, const int32_t* __restrict kernel_shape, int32_t stride_y, int32_t stride_x,
    T* __restrict output_values)
{
    const auto out_size = GetConvOutputSizeSAME(input_shape, stride_y, stride_x);
    Im2Row<T>(input_shape, input_values, kernel_shape, stride_y, stride_x, std::get<0>(out_size), std::get<1>(out_size), output_values);
...
#define POOL_OP(OP_NAME, DEFAULT_VALUE, UPDATE_EXPR, RESULT_EXPR)                                                                                                                  \
    template <typename T>                                                                                                                                                          \
    void OP_NAME##Pool(const int32_t* __restrict input_shape, const T* __restrict input_values, int32_t stride_y, int32_t stride_x, int32_t kernel_height, int32_t kernel_width,   \
                ...
                for (int32_t out_x = 0; out_x < out_width; ++out_x) {                                                                                                              \
                    ...
                    for (int32_t chan = 0; chan < depth; ++chan, ++out_write_ptr) {                                                                                                \
                        ...
                        *out_write_ptr = RESULT_EXPR;                                                                                                                              \
                                                                                                                                                                                   ...
                                                                                                                                                                                   \
    template <typename T>                                                                                                                                                          \
    void OP_NAME##PoolVALID(const int32_t* __restrict input_shape, const T* __restrict input_values, int32_t stride_y, int32_t stride_x, int32_t kernel_height,                    \
        int32_t kernel_width, T* __restrict output_values)                                                                                                                         \
    {                                                                                                                                                                              \
        const int32_t kernel_shape[4] = { kernel_height, kernel_width, 1, 1 };                                                                                                     \
        const auto out_size = GetConvOutputSizeVALID(input_shape, kernel_shape, stride_y, stride_x);                                                                               \
        OP_NAME##Pool<T>(input_shape, input_values, stride_y, stride_x, kernel_height, kernel_width, std::get<0>(out_size), std::get<1>(out_size), output_values);                 \
    }                                                                                                                                                                              \
                                                                                                                                                                                   \
    template <typename T>                                                                                                                                                          \
...
template <typename T> int32_t StridedSliceEnd(int32_t range_mask, const T* __restrict range_values, const T* __restrict strides, const int32_t* __restrict input_shape, int32_t dim)
{
    const bool is_explicit = 0 == (range_mask & (1 << dim));
    if (is_explicit) {
        const T range_value = range_values[dim];
...
template <typename T, typename TIdx>
void StridedSlice(const int32_t input_rank, const int32_t* __restrict input_shape, const T* __restrict input_values, const TIdx* __restrict begin, const TIdx* __restrict end,
    const TIdx* __restrict strides, int32_t begin_mask, int32_t end_mask, T* __restrict output_values)
{
...
template <typename T> void TransposeRank3(const int32_t* __restrict input_shape, const T* __restrict input_values, const int32_t* __restrict perm, T* __restrict output_values)
{
...
template <typename T> void TransposeRank4(const int32_t* __restrict input_shape, const T* __restrict input_values, const int32_t* __restrict perm, T* __restrict output_values)
{
...
void OneHot(const int32_t input_rank, const int32_t* __restrict input_shape, const TIdx* __restrict input_values, const TDepth* __restrict depth, const T* __restrict on_value,
    const T* __restrict off_value, const int32_t axis, T* __restrict output_values)
{
...
#define SIMPLE_UNARY_OP(OP_NAME, _, EXPR_EIGEN)                                                                                                                                    \
    template <typename T> void OP_NAME(const int32_t rank, const int32_t* __restrict input_shape, const T* __restrict input_values, T* __restrict output_values)                   \
    {                                                                                                                                                                              \
...
SIMPLE_UNARY_OP(HardSigmoid, std::min(std::max((static_cast<T>(0.2) * value + static_cast<T>(0.5)), static_cast<T>(0)), static_cast<T>(1)), (0.2 * values + 0.5).max(0).min(1))
...
void OpNoBroadcast(const int32_t left_rank, const int32_t* __restrict left_shape, const T* __restrict left_values, const int32_t right_rank, const int32_t* __restrict right_shape,
    const T* __restrict right_values, T* __restrict output_values, OP op)
{
...
template <typename T, typename OP>
void OpInnerBroadcast(int32_t left_rank, const int32_t* __restrict left_shape, const T* __restrict left_values, int32_t right_rank, const int32_t* __restrict right_shape,
    const T* __restrict right_values, T* __restrict output_values, OP op)
{
...
template <typename T, typename OP>
void OpGenericBroadcast(int32_t left_rank, const int32_t* __restrict left_shape, const T* __restrict left_values, int32_t right_rank, const int32_t* __restrict right_shape,
    const T* __restrict right_values, T* __restrict output_values, OP op)
{
    ...
    do {
        output_values[Offset(output_rank, output_shape, output_indices)] = op(
            left_values[BroadcastOffset(left_rank, left_shape, output_rank, output_indices)], right_values[BroadcastOffset(right_rank, right_shape, output_rank, output_indices)]);
...
#define BROADCAST_BINARY_OP(OP_NAME, EXPR, EXPR_EIGEN)                                                                                                                             \
    template <typename T> struct Op##OP_NAME {                                                                                                                                     \
        ...
        template <typename X, typename Y, typename Z> void apply(const X& lhs, const Y& rhs, Z out) { out = EXPR_EIGEN; }                                                          \
    };                                                                                                                                                                             \
    template <typename T>                                                                                                                                                          \
    ...
    template <typename T>                                                                                                                                                          \
    void OP_NAME(const int32_t left_rank, const int32_t* __restrict left_shape, const T* __restrict left_values, const int32_t right_rank, const int32_t* __restrict right_shape,  \
        const T* __restrict right_values, T* __restrict output_values)                                                                                                             \
    {                                                                                                                                                                              \
...
#define REDUCE_OP(OP_NAME, DEFAULT_VALUE, UPDATE_EXPR, RESULT_EXPR)                                                                                                                \
    ...
    {                                                                                                                                                                              \
        ...
        const T count                                                                                                                                                              \
            = (reduce_mask[0] ? input_shape[0] : 1) * (reduce_mask[1] ? input_shape[1] : 1) * (reduce_mask[2] ? input_shape[2] : 1) * (reduce_mask[3] ? input_shape[3] : 1);       \
        /* Used by mean reduce. */                                                                                                                                                 \
        (void)sizeof(count);                                                                                                                                                       \
        for (int32_t i = 0; i < output_size; ++i) {                                                                                                                                \
            const T value = output_values[i];                                                                                                                                      \
                ...
                for (int32_t dim2 = 0; dim2 < input_shape[2]; ++dim2) {                                                                                                            \
                    for (int32_t dim3 = 0; dim3 < input_shape[3]; ++dim3) {                                                                                                        \
                        for (int32_t dim4 = 0; dim4 < input_shape[4]; ++dim4, ++input_values) {                                                                                    \
                            T* out_ptr = output_values + out_strides[0] * dim0 + out_strides[1] * dim1 + out_strides[2] * dim2 + out_strides[3] * dim3 + out_strides[4] * dim4;    \
                            const T prev = *out_ptr;                                                                                                                               \
                            const T next = *input_values;                                                                                                                          \
                            *out_ptr = UPDATE_EXPR;                                                                                                                                \
                        }                                                                                                                                                          \
...
template <typename T> void AddN(const int32_t rank, const int32_t* __restrict shape, std::initializer_list<const T* __restrict> input_values, T* __restrict output_values)
{
    ...
    FixedAllocations* __restrict fixed)
{
    ...
    FullyConnected<float>(input_from_feature_columns_input_layer_concat_concat0_shape, input_from_feature_columns_input_layer_concat_concat0,
        dnn_hiddenlayer_0_kernel__1__cf__1_shape, dnn_hiddenlayer_0_kernel__1__cf__1.values, dnn_hiddenlayer_0_bias__0__cf__0_shape, dnn_hiddenlayer_0_bias__0__cf__0.values,
        fixed->alloc0);
