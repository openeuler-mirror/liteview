    ...
    const std::vector<InProgressTouchEvdev>& touches, base::TimeTicks time, std::bitset<kNumTouchEvdevSlots>* slots_to_hold, std::bitset<kNumTouchEvdevSlots>* slots_to_suppress)
{
    ...
    base::TimeTicks latest_stylus_time = shared_palm_state_->latest_stylus_touch_time;
    ...
    for (size_t i = 0; i < events_size; ++i) {
        ...
        stroke_length_[i]++;
        base::TimeDelta time_since_stylus_for_touch_start = touch_started_time_[i] - latest_stylus_time;
...
std::string HeuristicStylusPalmDetectionFilter::FilterNameForTesting() const { return kFilterName; }

base::TimeDelta HeuristicStylusPalmDetectionFilter::HoldTime() const { return time_after_stylus_to_hold_; }

base::TimeDelta HeuristicStylusPalmDetectionFilter::CancelTime() const { return time_after_stylus_to_cancel_; }
