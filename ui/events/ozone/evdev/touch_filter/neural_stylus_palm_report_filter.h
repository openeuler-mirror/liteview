...
class COMPONENT_EXPORT(EVDEV) NeuralStylusReportFilter : public PalmDetectionFilter {
public:
    explicit NeuralStylusReportFilter(SharedPalmDetectionFilterState* shared_palm_state);
    ...
    static bool CompatibleWithNeuralStylusReportFilter(const EventDeviceInfo& devinfo);
