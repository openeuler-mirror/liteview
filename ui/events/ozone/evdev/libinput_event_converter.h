...
public:
    ...
    public:
        ...
        absl::optional<LibInputEventConverter::LibInputDevice> AddDevice(const base::FilePath& path) const;
        bool Dispatch() const;
        int Fd();
    ...
    LibInputEventConverter(LibInputEventConverter::LibInputContext&& ctx, const base::FilePath& path, int id, const EventDeviceInfo& devinfo, CursorDelegateEvdev* cursor,
