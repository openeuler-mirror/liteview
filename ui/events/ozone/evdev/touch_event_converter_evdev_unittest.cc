...
base::TimeTicks ToTestTimeTicks(int64_t micros) { return base::TimeTicks() + base::Microseconds(micros); }
...
public:
    MockTouchEventConverterEvdev(
        ...
        base::ScopedFD fd, base::FilePath path, const EventDeviceInfo& devinfo, SharedPalmDetectionFilterState* shared_palm_state, DeviceEventDispatcherEvdev* dispatcher);
    ...
    void SimulateReinitialize(const EventDeviceInfo& devinfo) { Initialize(devinfo); }
...
MockTouchEventConverterEvdev::~MockTouchEventConverterEvdev() { SetEnabled(false); }
...
void MockTouchEventConverterEvdev::ConfigureReadMock(struct input_event* queue, long read_this_many, long queue_index)
{
    ...
    DCHECK(nwrite == static_cast<int>(sizeof(struct input_event) * read_this_many)) << "write() failed, errno: " << errno;
}
...
public:
    ...
    void SetUpDevice()
    {
        ...
        EventDeviceInfo devinfo;
        dispatcher_ = std::make_unique<ui::MockDeviceEventDispatcherEvdev>(base::BindRepeating(&TouchEventConverterEvdevTest::DispatchCallback, base::Unretained(this)));
        device_ = std::make_unique<ui::MockTouchEventConverterEvdev>(std::move(events_in), base::FilePath(kTestDevicePath), devinfo, shared_palm_state_.get(), dispatcher_.get());
    ...
    ui::SharedPalmDetectionFilterState* shared_palm_state() { return shared_palm_state_.get(); }
...
private:
    ...
    void DispatchCallback(const GenericEventParams& params) { dispatched_events_.push_back(params); }
...
TEST_F(TouchEventConverterEvdevTest, TwoFingerGesture)
{
    ...
    struct input_event mock_kernel_queue_press0[] = { { { 0, 0 }, EV_ABS, ABS_MT_TRACKING_ID, 684 }, { { 0, 0 }, EV_ABS, ABS_MT_TOUCH_MAJOR, 3 },
        { { 0, 0 }, EV_ABS, ABS_MT_PRESSURE, 45 }, { { 0, 0 }, EV_ABS, ABS_MT_POSITION_X, 42 }, { { 0, 0 }, EV_ABS, ABS_MT_POSITION_Y, 51 }, { { 0, 0 }, EV_SYN, SYN_REPORT, 0 } };
    ...
    struct input_event mock_kernel_queue_move0press1[] = { { { 0, 0 }, EV_ABS, ABS_MT_POSITION_X, 40 }, { { 0, 0 }, EV_SYN, SYN_REPORT, 0 }, { { 0, 0 }, EV_ABS, ABS_MT_SLOT, 1 },
    ...
    struct input_event mock_kernel_queue_release0_move1[]
        = { { { 0, 0 }, EV_ABS, ABS_MT_TRACKING_ID, -1 }, { { 0, 0 }, EV_ABS, ABS_MT_SLOT, 1 }, { { 0, 0 }, EV_ABS, ABS_MT_POSITION_X, 38 }, { { 0, 0 }, EV_SYN, SYN_REPORT, 0 } };
...
TEST_F(TouchEventConverterEvdevTest, Unsync)
{
    ...
    struct input_event mock_kernel_queue_move0[] = { { { 0, 0 }, EV_SYN, SYN_DROPPED, 0 }, { { 0, 0 }, EV_ABS, ABS_MT_POSITION_X, 40 }, { { 0, 0 }, EV_SYN, SYN_REPORT, 0 } };
...
TEST_F(TouchEventConverterEvdevTest, ActiveStylusTouchAndRelease)
{
    ...
    struct input_event mock_kernel_queue[] {
        { { 0, 0 }, EV_KEY, BTN_TOOL_PEN, 1 }, { { 0, 0 }, EV_ABS, ABS_X, 9170 }, { { 0, 0 }, EV_ABS, ABS_Y, 3658 }, { { 0, 0 }, EV_ABS, ABS_TILT_X, 0 },
            { { 0, 0 }, EV_ABS, ABS_TILT_Y, 0 }, { { 0, 0 }, EV_SYN, SYN_REPORT, 0 }, { { 0, 0 }, EV_KEY, BTN_TOUCH, 1 }, { { 0, 0 }, EV_ABS, ABS_PRESSURE, 60 },
            { { 0, 0 }, EV_SYN, SYN_REPORT, 0 }, { { 0, 0 }, EV_KEY, BTN_TOUCH, 0 }, { { 0, 0 }, EV_ABS, ABS_X, 9173 }, { { 0, 0 }, EV_ABS, ABS_Y, 3906 },
            { { 0, 0 }, EV_ABS, ABS_TILT_X, 30 }, { { 0, 0 }, EV_ABS, ABS_TILT_Y, 50 }, { { 0, 0 }, EV_ABS, ABS_PRESSURE, 0 }, { { 0, 0 }, EV_SYN, SYN_REPORT, 0 },
...
TEST_F(TouchEventConverterEvdevTest, ActiveStylusMotion)
{
    ...
    struct input_event mock_kernel_queue[] {
        { { 0, 0 }, EV_KEY, BTN_TOOL_PEN, 1 }, { { 0, 0 }, EV_ABS, ABS_X, 8921 }, { { 0, 0 }, EV_ABS, ABS_Y, 1072 }, { { 0, 0 }, EV_SYN, SYN_REPORT, 0 },
            ...
            { { 0, 0 }, EV_ABS, ABS_PRESSURE, 0 }, { { 0, 0 }, EV_SYN, SYN_REPORT, 0 }, { { 0, 0 }, EV_KEY, BTN_TOOL_PEN, 0 }, { { 0, 0 }, EV_SYN, SYN_REPORT, 0 },
    };
...
TEST_F(TouchEventConverterEvdevTest, InvalidDimensions)
{
    ...
    EXPECT_FALSE(TouchEventConverterEvdev::Create({}, base::FilePath(kTestDevicePath), 0, devinfo, shared_palm_state(), nullptr));
}
} // namespace ui
