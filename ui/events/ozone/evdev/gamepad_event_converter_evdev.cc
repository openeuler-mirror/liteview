...
GamepadEventConverterEvdev::GamepadEventConverterEvdev(base::ScopedFD fd, base::FilePath path, int id, const EventDeviceInfo& devinfo, DeviceEventDispatcherEvdev* dispatcher)
...
GamepadEventConverterEvdev::~GamepadEventConverterEvdev() { DCHECK(!IsEnabled()); }

bool GamepadEventConverterEvdev::HasGamepad() const { return true; }
...
void GamepadEventConverterEvdev::OnDisabled() { ResetGamepad(); }

std::vector<ui::GamepadDevice::Axis> GamepadEventConverterEvdev::GetGamepadAxes() const { return axes_; }

bool GamepadEventConverterEvdev::GetGamepadRumbleCapability() const { return supports_rumble_; }

std::vector<uint64_t> GamepadEventConverterEvdev::GetGamepadKeyBits() const { return key_bits_; }
