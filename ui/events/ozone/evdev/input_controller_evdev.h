...
private:
    ...
    FRIEND_TEST_ALL_PREFIXES(InputControllerEvdevTest, AccelerationChangeDuringSuspension);
    ...
    bool is_mouse_acceleration_suspended() { return stored_acceleration_settings_.get() != nullptr; }
