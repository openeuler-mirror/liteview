...
public:
    InputDeviceFactoryEvdev(std::unique_ptr<DeviceEventDispatcherEvdev> dispatcher, CursorDelegateEvdev* cursor, std::unique_ptr<InputDeviceOpener> input_device_opener);
...
private:
    ...
    const std::unique_ptr<KeyboardImposterCheckerEvdev> keyboard_imposter_checker_;
