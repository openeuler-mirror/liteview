...
bool IsNumpadEnterKey(unsigned int keycode) { return (keycode == KEY_KPENTER); }
...
bool IsNumpadKey(unsigned int keycode) { return (IsNumpadEnterKey(keycode) || IsNumpadOtherKey(keycode)); }

bool IsNumlockKey(unsigned int keycode) { return (keycode == KEY_NUMLOCK); }
...
bool NumberpadMetricsDelegate::IsEligible() const { return eligible_; }

bool NumberpadMetricsDelegate::IsEnabled() const { return enabled_; }
...
NumberpadMetricsRecorder::NumberpadMetricsRecorder() { UpdateDeviceState(); }
