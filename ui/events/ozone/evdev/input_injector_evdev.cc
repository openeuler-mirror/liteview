...
void InputInjectorEvdev::SetDeviceId(int device_id) { device_id_ = device_id; }
...
void InputInjectorEvdev::InjectMouseButton(EventFlags button, bool down)
{
    ...
    dispatcher_->DispatchMouseButtonEvent(
        MouseButtonEventParams(device_id_, EF_NONE, cursor_->GetLocation(), code, down, MouseButtonMapType::kNone, PointerDetails(EventPointerType::kMouse), EventTimeForNow()));
}
...
void InputInjectorEvdev::MoveCursorTo(const gfx::PointF& location)
{
    ...
    dispatcher_->DispatchMouseMoveEvent(
        MouseMoveEventParams(device_id_, event_flags, cursor_->GetLocation(), nullptr /* ordinal_delta */, PointerDetails(EventPointerType::kMouse), EventTimeForNow()));
}
