...
public:
    ...
    void SetUpDevice(const ui::EventDeviceInfo& info)
    {
        ...
        event_factory_ = ui::CreateEventFactoryEvdevForTest(
            cursor_.get(), device_manager_.get(), keyboard_layout_engine_.get(), base::BindRepeating(&EventConverterEvdevImplTest::DispatchEventForTest, base::Unretained(this)));
    ...
    ui::InputController* GetInputController() { return event_factory_->input_controller(); }

    void SetTestNowSeconds(int64_t seconds) { test_clock_->SetNowSeconds(seconds); }
...
TEST_F(EventConverterEvdevImplTest, MouseBackButton)
{
    ...
    struct input_event mock_kernel_queue[] = { { { 0, 0 }, EV_KEY, BTN_SIDE, 1 }, { { 0, 0 }, EV_SYN, SYN_REPORT, 0 },

        { { 0, 0 }, EV_KEY, BTN_BACK, 1 }, { { 0, 0 }, EV_SYN, SYN_REPORT, 0 },

        { { 0, 0 }, EV_KEY, BTN_SIDE, 0 }, { { 0, 0 }, EV_SYN, SYN_REPORT, 0 },

        { { 0, 0 }, EV_KEY, BTN_BACK, 0 }, { { 0, 0 }, EV_SYN, SYN_REPORT, 0 } };
...
TEST_F(EventConverterEvdevImplTest, MouseForwardButton)
{
    ...
    struct input_event mock_kernel_queue[] = { { { 0, 0 }, EV_KEY, BTN_FORWARD, 1 }, { { 0, 0 }, EV_SYN, SYN_REPORT, 0 },

        { { 0, 0 }, EV_KEY, BTN_EXTRA, 1 }, { { 0, 0 }, EV_SYN, SYN_REPORT, 0 },

        { { 0, 0 }, EV_KEY, BTN_EXTRA, 0 }, { { 0, 0 }, EV_SYN, SYN_REPORT, 0 },

        { { 0, 0 }, EV_KEY, BTN_FORWARD, 0 }, { { 0, 0 }, EV_SYN, SYN_REPORT, 0 } };
