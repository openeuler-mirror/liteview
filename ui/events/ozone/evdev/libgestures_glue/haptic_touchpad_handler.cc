...
bool HapticTouchpadHandler::IsValid() { return haptics_enabled_; }
...
void HapticTouchpadHandler::SetClickStrength(HapticTouchpadEffectStrength strength) { click_strength_ = strength; }
...
void HapticTouchpadHandler::PlayEffect(HapticTouchpadEffect effect, HapticTouchpadEffectStrength strength) { PlayFfEffect(ff_effect_id_[effect][strength]); }
