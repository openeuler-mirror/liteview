...
public:
    ...
    void PlayFfEffect(int effect_id) override { played_effect_ids_.push_back(effect_id); }

    int UploadFfEffect(uint16_t hid_usage, uint8_t intensity) override { return ++num_effects_uploaded_; }
