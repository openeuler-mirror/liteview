...
void GesturesTimerSet(void* data, GesturesTimer* timer, stime_t delay, GesturesTimerCallback callback, void* callback_data) { timer->Set(delay, callback, callback_data); }
