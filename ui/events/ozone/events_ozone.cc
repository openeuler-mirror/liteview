...
bool DispatchEventFromNativeUiEvent(const PlatformEvent& event, base::OnceCallback<void(ui::Event*)> callback)
{
...
EVENTS_EXPORT void DisableNativeUiEventDispatchForTest() { dispatch_disabled = true; }
