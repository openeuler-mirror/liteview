...
void TestLookup(const char* name, KeyboardLayoutEngine* engine)
{
    static const struct {
        ...
        { DomCode::US_A, EF_SHIFT_DOWN, DomKey::Constant<'A'>::Character, VKEY_A, 'A' },
        { DomCode::US_A, EF_CONTROL_DOWN, DomKey::Constant<'a'>::Character, VKEY_A, 1 },
    ...
    for (const auto& t : kTestCases) {
        ...
        KeyEvent key_event(ET_KEY_PRESSED, keycode, t.input_dom_code, t.input_flags, dom_key, EventTimeForNow());
