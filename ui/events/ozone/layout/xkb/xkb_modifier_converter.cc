...
xkb_mod_mask_t XkbModifierConverter::MaskFromNames(const std::vector<base::StringPiece>& names) const
{
...
xkb_mod_mask_t XkbModifierConverter::MaskFromName(base::StringPiece name) const
{
