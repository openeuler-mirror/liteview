...
#if !defined(USE_AURA)
// static
NativeTheme* NativeTheme::GetInstanceForWeb() { return NativeThemeAndroid::instance(); }
...
SkColor NativeThemeAndroid::ControlsAccentColorForState(State state, ColorScheme color_scheme) const
{
...
SkColor NativeThemeAndroid::ControlsSliderColorForState(State state, ColorScheme color_scheme) const
{
    ControlColorId color_id;
    if (state == kPressed) {
...
SkColor NativeThemeAndroid::ControlsBorderColorForState(State state, ColorScheme color_scheme) const
{
    ControlColorId color_id;
    if (state == kPressed) {
...
SkColor NativeThemeAndroid::ButtonBorderColorForState(State state, ColorScheme color_scheme) const
{
    ControlColorId color_id;
    if (state == kPressed) {
...
SkColor NativeThemeAndroid::ControlsFillColorForState(State state, ColorScheme color_scheme) const
{
    ControlColorId color_id;
    if (state == kPressed) {
...
SkColor NativeThemeAndroid::ButtonFillColorForState(State state, ColorScheme color_scheme) const
{
    ControlColorId color_id;
    if (state == kPressed) {
