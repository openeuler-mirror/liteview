...
public:
    ...
    void PaintArrowButton(
        cc::PaintCanvas* canvas, const gfx::Rect& rect, Part direction, State state, ColorScheme color_scheme, const ScrollbarArrowExtraParams& arrow) const override;
...
private:
    ...
    void PaintButton(cc::PaintCanvas* canvas, const gfx::Rect& rect, ColorScheme color_scheme) const;
    void PaintArrow(cc::PaintCanvas* canvas, const gfx::Rect& rect, Part part, State state, ColorScheme color_scheme) const;
    ...
    void OffsetArrowRect(gfx::Rect& arrow_rect, Part part, int max_arrow_rect_side) const;
};
