...
protected:
    ...
    SkPath PathForArrow(const gfx::Rect& rect, NativeTheme::Part direction) const { return theme_.PathForArrow(BoundingRectForArrow(rect), direction); }

    gfx::Rect BoundingRectForArrow(const gfx::Rect& rect) const { return theme_.BoundingRectForArrow(rect); }
