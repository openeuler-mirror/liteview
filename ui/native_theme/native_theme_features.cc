...
#if BUILDFLAG(IS_ANDROID) || BUILDFLAG(IS_CHROMEOS_ASH) || BUILDFLAG(IS_FUCHSIA) || BUILDFLAG(IS_CHROMEOS_LACROS)
...
bool IsOverlayScrollbarEnabled() { return base::FeatureList::IsEnabled(features::kOverlayScrollbar); }
