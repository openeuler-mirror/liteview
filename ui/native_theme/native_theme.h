...
// of lacros-chrome is complete.
    ...
    virtual void Paint(cc::PaintCanvas* canvas, const ui::ColorProvider* color_provider, Part part, State state, const gfx::Rect& rect, const ExtraParams& extra,
        ColorScheme color_scheme = ColorScheme::kDefault, const absl::optional<SkColor>& accent_color = absl::nullopt) const
        = 0;
    ...
    ColorProviderManager::Key GetColorProviderKey(scoped_refptr<ColorProviderManager::ThemeInitializerSupplier> custom_theme, bool use_custom_frame = true) const;
    ...
    absl::optional<SkColor> GetSystemThemeColor(SystemThemeColor theme_color) const;

    bool HasDifferentSystemColors(const std::map<SystemThemeColor, SkColor>& colors) const;

    void set_use_dark_colors(bool should_use_dark_colors) { should_use_dark_colors_ = should_use_dark_colors; }
    ...
    void set_preferred_color_scheme(PreferredColorScheme preferred_color_scheme) { preferred_color_scheme_ = preferred_color_scheme; }
    ...
    void set_user_color(absl::optional<SkColor> user_color) { user_color_ = user_color; }
    ...
    bool UpdateSystemColorInfo(bool is_dark_mode, bool forced_colors, const base::flat_map<SystemThemeColor, uint32_t>& colors);
