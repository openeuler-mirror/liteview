...
public:
    ...
    public:
        ...
        virtual void AddColorMixers(ColorProvider* provider, const Key& key) const = 0;
    ...
    class COMPONENT_EXPORT(COLOR) ThemeInitializerSupplier : public InitializerSupplier, public base::RefCountedThreadSafe<ThemeInitializerSupplier> {
    public:
    ...
    struct COMPONENT_EXPORT(COLOR) Key {
        ...
        Key(ColorMode color_mode, ContrastMode contrast_mode, SystemTheme system_theme, FrameType frame_type, absl::optional<SkColor> user_color = absl::nullopt,
        ...
        // enabled. Triage.
        raw_ptr<InitializerSupplier, DegradeToNoOpWhenMTE> app_controller = nullptr; // unowned

        bool operator<(const Key& other) const
        {
            auto* lhs_app_controller = app_controller.get();
            auto* rhs_app_controller = other.app_controller.get();
            return std::tie(color_mode, contrast_mode, elevation_mode, system_theme, frame_type, user_color, custom_theme, lhs_app_controller) < std::tie(
                       other.color_mode, other.contrast_mode, other.elevation_mode, other.system_theme, other.frame_type, other.user_color, other.custom_theme, rhs_app_controller);
        }
    };

    using ColorProviderInitializerList = base::RepeatingCallbackList<void(ColorProvider*, const Key&)>;
    ...
    size_t num_providers_initialized() const { return num_providers_initialized_; }
