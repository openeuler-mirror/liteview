...
ColorTransform BlendForMinContrast(ColorTransform foreground_transform, ColorTransform background_transform,
    absl::optional<ColorTransform> high_contrast_foreground_transform = absl::nullopt, float contrast_ratio = color_utils::kMinimumReadableContrastRatio);
...
COMPONENT_EXPORT(COLOR)
ColorTransform PickGoogleColor(ColorTransform color, ColorTransform background_color, float min_contrast = 0.0f);
