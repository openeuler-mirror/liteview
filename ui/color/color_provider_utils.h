...
base::StringPiece COMPONENT_EXPORT(COLOR) ColorModeName(ColorProviderManager::ColorMode color_mode);

// Converts the ContrastMode.
base::StringPiece COMPONENT_EXPORT(COLOR) ContrastModeName(ColorProviderManager::ContrastMode contrast_mode);

// Converts SystemTheme.
base::StringPiece COMPONENT_EXPORT(COLOR) SystemThemeName(ui::SystemTheme system_theme);
...
ColorProvider COMPONENT_EXPORT(COLOR) CreateColorProviderFromRendererColorMap(const RendererColorMap& renderer_color_map);
