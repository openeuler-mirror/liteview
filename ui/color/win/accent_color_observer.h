...
public:
    ...
    absl::optional<SkColor> accent_color_inactive() const { return accent_color_inactive_; }
    absl::optional<SkColor> accent_border_color() const { return accent_border_color_; }
