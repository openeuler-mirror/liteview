...
TEST(ColorTransformTest, BlendForMinContrast)
{
    ...
    const auto verify_contrast
        = [&](SkColor input) { EXPECT_GE(color_utils::GetContrastRatio(transform.Run(input, mixer), kBackground), color_utils::kMinimumReadableContrastRatio); };
