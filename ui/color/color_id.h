...
#define E_CPONLY_kColorRefPrimary0 E_CPONLY(kColorRefPrimary0, kUiColorsStart2, kUiColorsStart3)
#else
#define E_CPONLY_kColorRefPrimary0 E_CPONLY(kColorRefPrimary0, kUiColorsStart, kUiColorsStart)
#endif
