...
// recipes.
TEST(ColorMixerTest, GetInputColorNoInput) { EXPECT_EQ(gfx::kPlaceholderColor, ColorMixer().GetInputColor(kColorTest0)); }
...
// recipes.
TEST(ColorMixerTest, GetResultColorNoInput) { EXPECT_EQ(gfx::kPlaceholderColor, ColorMixer().GetResultColor(kColorTest0)); }
