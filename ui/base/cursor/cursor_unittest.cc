...
TEST(CursorTest, CustomTypeComparesBitmapPixels)
{
    ...
    EXPECT_NE(cursor1.custom_bitmap().getGenerationID(), cursor2.custom_bitmap().getGenerationID());
    EXPECT_TRUE(gfx::BitmapsAreEqual(cursor1.custom_bitmap(), cursor2.custom_bitmap()));
