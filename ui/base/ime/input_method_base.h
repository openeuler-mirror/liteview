...
// implementations.
class COMPONENT_EXPORT(UI_BASE_IME) InputMethodBase : public InputMethod, public base::SupportsWeakPtr<InputMethodBase> {
public:
...
protected:
    ...
    ImeKeyEventDispatcher* ime_key_event_dispatcher() { return ime_key_event_dispatcher_; }
