...
#if BUILDFLAG(IS_WIN)
bool DummyInputMethod::OnUntranslatedIMEMessage(const CHROME_MSG event, NativeEventResult* result) { return false; }

void DummyInputMethod::OnInputLocaleChanged() { }

bool DummyInputMethod::IsInputLocaleCJK() const { return false; }
#endif
...
TextInputClient* DummyInputMethod::GetTextInputClient() const { return NULL; }

ui::EventDispatchDetails DummyInputMethod::DispatchKeyEvent(ui::KeyEvent* event) { return ui::EventDispatchDetails(); }
...
TextInputType DummyInputMethod::GetTextInputType() const { return TEXT_INPUT_TYPE_NONE; }

bool DummyInputMethod::IsCandidatePopupOpen() const { return false; }
...
VirtualKeyboardController* DummyInputMethod::GetVirtualKeyboardController() { return nullptr; }
