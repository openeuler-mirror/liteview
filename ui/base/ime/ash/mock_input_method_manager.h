...
class COMPONENT_EXPORT(UI_BASE_IME_ASH) MockInputMethodManager : public InputMethodManager, public ui::VirtualKeyboardController {
public:
public:
    ...
    public:
        ...
        void AddInputMethodExtension(const std::string& extension_id, const InputMethodDescriptors& descriptors, ui::TextInputMethod* instance) override;
        ...
        std::unique_ptr<InputMethodDescriptors> GetEnabledInputMethodsSortedByLocalizedDisplayNames() const override;
        std::unique_ptr<InputMethodDescriptors> GetEnabledInputMethods() const override;
    ...
    void SetVirtualKeyboardEnabled(bool enabled) { virtual_keyboard_enabled_ = enabled; }
...
private:
    ...
    base::ObserverList<ui::VirtualKeyboardControllerObserver>::Unchecked observer_list_;
};
