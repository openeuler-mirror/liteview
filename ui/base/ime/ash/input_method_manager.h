...
public:
    ...
    public:
        ...
        virtual void OnExtraInputEnabledStateChange(bool is_extra_input_options_enabled, bool is_emoji_enabled, bool is_handwriting_enabled, bool is_voice_enabled) { }
    ...
    public:
        ...
        // |instance|.
        virtual void AddInputMethodExtension(const std::string& extension_id, const InputMethodDescriptors& descriptors, ui::TextInputMethod* instance) = 0;
        ...
        virtual std::unique_ptr<InputMethodDescriptors> GetEnabledInputMethodsSortedByLocalizedDisplayNames() const = 0;
        ...
        virtual std::unique_ptr<InputMethodDescriptors> GetEnabledInputMethods() const = 0;
    ...
    virtual bool MigrateInputMethods(std::vector<std::string>* input_method_ids) = 0;
