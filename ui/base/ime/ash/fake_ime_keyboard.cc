...
bool FakeImeKeyboard::SetCurrentKeyboardLayoutByName(const std::string& layout_name)
{
...
bool FakeImeKeyboard::GetAutoRepeatEnabled() { return auto_repeat_is_enabled_; }

bool FakeImeKeyboard::ReapplyCurrentKeyboardLayout() { return true; }

void FakeImeKeyboard::ReapplyCurrentModifierLockStatus() { }

void FakeImeKeyboard::DisableNumLock() { }

bool FakeImeKeyboard::IsISOLevel5ShiftAvailable() const { return false; }

bool FakeImeKeyboard::IsAltGrAvailable() const { return false; }
