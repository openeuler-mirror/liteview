...
bool ImeKeyboardImpl::SetCurrentKeyboardLayoutByName(const std::string& layout_name)
{
...
{
    input_controller_->SetAutoRepeatRate(base::Milliseconds(rate.initial_delay_in_ms), base::Milliseconds(rate.repeat_interval_in_ms));
    return true;
}
...
bool ImeKeyboardImpl::GetAutoRepeatEnabled() { return input_controller_->IsAutoRepeatEnabled(); }

bool ImeKeyboardImpl::ReapplyCurrentKeyboardLayout() { return SetCurrentKeyboardLayoutByName(last_layout_); }

void ImeKeyboardImpl::ReapplyCurrentModifierLockStatus() { }

void ImeKeyboardImpl::DisableNumLock() { input_controller_->SetNumLockEnabled(false); }
...
bool ImeKeyboardImpl::CapsLockIsEnabled() { return input_controller_->IsCapsLockEnabled(); }
