...
void MockIMECandidateWindowHandler::SetCursorBounds(const gfx::Rect& cursor_bounds, const gfx::Rect& composition_head) { ++set_cursor_bounds_call_count_; }

gfx::Rect MockIMECandidateWindowHandler::GetCursorBounds() const { return gfx::Rect(1, 1, 1, 1); }
