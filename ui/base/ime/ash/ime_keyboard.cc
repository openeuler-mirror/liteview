...
void ImeKeyboard::AddObserver(Observer* observer) { observers_.AddObserver(observer); }

void ImeKeyboard::RemoveObserver(Observer* observer) { observers_.RemoveObserver(observer); }

bool ImeKeyboard::SetCurrentKeyboardLayoutByName(const std::string& layout_name)
{
...
bool ImeKeyboard::CapsLockIsEnabled() { return caps_lock_is_enabled_; }
