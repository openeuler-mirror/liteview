...
public:
    ...
    void SetCandidateWindowHandler(ash::IMECandidateWindowHandlerInterface* handler);

    ash::IMEAssistiveWindowHandlerInterface* GetAssistiveWindowHandler() const;
    void SetAssistiveWindowHandler(ash::IMEAssistiveWindowHandlerInterface* handler);
