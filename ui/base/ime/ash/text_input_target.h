...
public:
    ...
    virtual void CommitText(const std::u16string& text, TextInputClient::InsertTextCursorBehavior cursor_behavior) = 0;
    ...
    virtual bool AddGrammarFragments(const std::vector<GrammarFragment>& fragements) = 0;
    ...
    virtual void UpdateCompositionText(const CompositionText& text, uint32_t cursor_pos, bool visible) = 0;
    ...
    virtual void ConfirmCompositionText(bool reset_engine, bool keep_selection) = 0;
