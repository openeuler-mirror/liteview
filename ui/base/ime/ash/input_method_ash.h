...
class COMPONENT_EXPORT(UI_BASE_IME_ASH) InputMethodAsh : public InputMethodBase, public TextInputTarget {
public:
...
protected:
    ...
    CompositionText ExtractCompositionText(const CompositionText& text, uint32_t cursor_position) const;

    // Process a key returned from the input method.
    [[nodiscard]] virtual ui::EventDispatchDetails ProcessKeyEventPostIME(ui::KeyEvent* event, ui::ime::KeyEventHandledState handled_state, bool stopped_propagation);
