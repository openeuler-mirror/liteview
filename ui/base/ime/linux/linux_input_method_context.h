...
public:
    ...
    virtual void SetSurroundingText(const std::u16string& text, const gfx::Range& selection_range) = 0;

    // Tells the system IME the content type of the text input client is changed.
    virtual void SetContentType(TextInputType type, TextInputMode mode, uint32_t flags, bool should_do_learning) = 0;
    ...
    virtual void UpdateFocus(bool has_client, TextInputType old_type, TextInputType new_type) = 0;
