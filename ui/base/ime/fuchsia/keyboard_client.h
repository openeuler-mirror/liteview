...
class COMPONENT_EXPORT(UI_BASE_IME_FUCHSIA) KeyboardClient : public fuchsia::ui::input3::KeyboardListener {
public:
    // |keyboard_service| and |event_sink| must outlive |this|.
    KeyboardClient(fuchsia::ui::input3::Keyboard* keyboard_service, fuchsia::ui::views::ViewRef view_ref, InputEventSink* event_sink);
    ...
    void OnKeyEvent(fuchsia::ui::input3::KeyEvent key_event, fuchsia::ui::input3::KeyboardListener::OnKeyEventCallback callback) final;
