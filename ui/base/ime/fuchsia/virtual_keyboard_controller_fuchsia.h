...
public:
    ...
    VirtualKeyboardControllerFuchsia(fuchsia::ui::views::ViewRef view_ref, ui::InputMethodBase* input_method);
...
private:
    ...
    fuchsia::input::virtualkeyboard::TextType requested_type_ = fuchsia::input::virtualkeyboard::TextType::ALPHANUMERIC;
