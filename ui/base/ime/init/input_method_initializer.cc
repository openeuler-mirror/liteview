...
#if !BUILDFLAG(IS_CHROMEOS_ASH) && defined(USE_AURA) && (BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_CHROMEOS_LACROS))
...
void InitializeInputMethodForTesting()
{
    ...
    GetInputMethodContextFactoryForTest()
        = base::BindRepeating([](LinuxInputMethodContextDelegate* delegate) -> std::unique_ptr<LinuxInputMethodContext> { return std::make_unique<FakeInputMethodContext>(); });
#elif BUILDFLAG(IS_WIN)
