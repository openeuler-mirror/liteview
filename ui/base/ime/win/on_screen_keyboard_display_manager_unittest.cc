...
protected:
    ...
    std::unique_ptr<OnScreenKeyboardDisplayManagerTabTip> CreateTabTip() { return std::make_unique<OnScreenKeyboardDisplayManagerTabTip>(nullptr); }

    std::unique_ptr<OnScreenKeyboardDisplayManagerInputPane> CreateInputPane() { return std::make_unique<OnScreenKeyboardDisplayManagerInputPane>(nullptr); }
