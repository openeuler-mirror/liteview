...
public:
    ...
    unsigned cancel_composition_call_count() const { return cancel_composition_call_count_; }

    // Call count of ConfirmComposition().
    unsigned confirm_composition_call_count() const { return confirm_composition_call_count_; }
    ...
    unsigned associate_focus_call_count() const { return associate_focus_call_count_; }

    // Call count of SetFocusClient().
    unsigned set_focused_client_call_count() const { return set_focused_client_call_count_; }

    // Call count of RemoveFocusedClient().
    unsigned remove_focused_client_call_count() const { return remove_focused_client_call_count_; }
    ...
    TextInputType latest_text_iput_type() const { return latest_text_input_type_; }

    void SetTSFTextStoreForTesting(TSFTextStore* tsf_text_store) { tsf_text_store_ = tsf_text_store; }
