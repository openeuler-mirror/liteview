...
public:
    ...
    // |input_mode|.
    static void ConvertInputModeToImmFlags(TextInputMode input_mode, DWORD initial_conversion_mode, BOOL* open, DWORD* new_conversion_mode);
...
protected:
    ...
    bool GetString(HIMC imm_context, WPARAM lparam, int type, std::u16string* result);
