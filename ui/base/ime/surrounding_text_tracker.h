...
public:
    ...
    UpdateResult Update(const base::StringPiece16 surrounding_text, const gfx::Range& selection);
    ...
    void OnInsertText(const base::StringPiece16 text, TextInputClient::InsertTextCursorBehavior cursor_behavior);
