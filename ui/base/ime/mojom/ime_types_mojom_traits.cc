...
// static
ui::mojom::ImeTextSpanUnderlineStyle EnumTraits<ui::mojom::ImeTextSpanUnderlineStyle, ui::ImeTextSpan::UnderlineStyle>::ToMojom(ui::ImeTextSpan::UnderlineStyle underline_style)
{
...
// static
bool EnumTraits<ui::mojom::ImeTextSpanUnderlineStyle, ui::ImeTextSpan::UnderlineStyle>::FromMojom(ui::mojom::ImeTextSpanUnderlineStyle input, ui::ImeTextSpan::UnderlineStyle* out)
{
    switch (input) {
