...
class COMPONENT_EXPORT(UI_BASE_IME) TextInputClient : public base::SupportsWeakPtr<TextInputClient> {
public:
    ...
    // ChromeOS.
    virtual void GetActiveTextInputControlLayoutBounds(absl::optional<gfx::Rect>* control_bounds, absl::optional<gfx::Rect>* selection_bounds) = 0;
#endif
    ...
    virtual void SetActiveCompositionForAccessibility(const gfx::Range& range, const std::u16string& active_composition_text, bool is_composition_committed) = 0;
