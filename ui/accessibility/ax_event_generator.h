...
public:
    ...
    public:
        ...
        Iterator(std::map<AXNodeID, std::set<EventParams>>::const_iterator map_start_iter, std::map<AXNodeID, std::set<EventParams>>::const_iterator map_end_iter);
...
protected:
    ...
    void OnIgnoredWillChange(AXTree* tree, AXNode* node, bool is_ignored_new_value) override;
