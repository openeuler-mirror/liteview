...
{
    TestPositionType text_position = AXNodePosition::CreateTextPosition(GetTreeID(), /*anchor_id=*/1, /*text_offset=*/103, ax::mojom::TextAffinity::kDownstream);
...
{
    TestPositionType tree_position = AXNodePosition::CreateTreePosition(*ax_tree(), *ax_tree()->root(), /*child_index=*/4);
...
{
    TestPositionType text_position_1 = AXNodePosition::CreateTextPosition(GetTreeID(), /*anchor_id=*/7, /*text_offset=*/1, ax::mojom::TextAffinity::kDownstream);

    TestPositionType text_position_2 = AXNodePosition::CreateTextPosition(GetTreeID(), /*anchor_id=*/27, /*text_offset=*/1, ax::mojom::TextAffinity::kDownstream);
