...
void AXActionHandlerRegistry::AddObserver(AXActionHandlerObserver* observer) { observers_.AddObserver(observer); }

void AXActionHandlerRegistry::RemoveObserver(AXActionHandlerObserver* observer) { observers_.RemoveObserver(observer); }

void AXActionHandlerRegistry::PerformAction(const ui::AXActionData& action_data)
{
...
void AXActionHandlerRegistry::SetAXTreeID(const ui::AXTreeID& id, AXActionHandlerBase* action_handler)
{
