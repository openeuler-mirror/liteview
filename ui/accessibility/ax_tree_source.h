...
public:
    ...
    virtual void GetChildren(AXNodeSource node, std::vector<AXNodeSource>* out_children) const = 0;
    ...
    virtual void AddObserver(ui::AXTreeSourceObserver<AXNodeSource>* observer) { NOTIMPLEMENTED(); }

    virtual void RemoveObserver(ui::AXTreeSourceObserver<AXNodeSource>* observer) { NOTIMPLEMENTED(); }
