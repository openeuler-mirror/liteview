...
absl::optional<AXNodeID> GetActivePopupAxUniqueId() { return GetActivePopupAXUniqueIdInstance(); }
...
void ClearActivePopupAxUniqueId() { GetActivePopupAXUniqueIdInstance() = absl::nullopt; }
