...
bool IsFormatBoundary(const ax::mojom::Role role) { return IsControl(role) || IsHeading(role) || IsImageOrVideo(role); }
...
bool IsImageOrVideo(const ax::mojom::Role role) { return IsImage(role) || role == ax::mojom::Role::kVideo; }
...
bool IsTableColumn(ax::mojom::Role role) { return role == ax::mojom::Role::kColumn; }
