...
protected:
    ...
    void CreateBrowserWindow(AXNodeData& window, AXNodeData& back_button, AXNodeData& web_view, AXNodeData& root_web_area, AXNodeData& iframe_root, AXNodeData& paragraph,
        AXNodeData& address_bar, std::vector<TestAXTreeManager>& out_managers) const;
    ...
    const AXNode& GetButtonNode() const { return *ax_tree()->GetFromId(button_.id); }

    const AXNode& GetCheckBoxNode() const { return *ax_tree()->GetFromId(check_box_.id); }

    const AXNode& GetTextFieldNode() const { return *ax_tree()->GetFromId(text_field_.id); }

    const AXNode& GetStaticText1Node() const { return *ax_tree()->GetFromId(static_text1_.id); }

    const AXNode& GetLineBreakNode() const { return *ax_tree()->GetFromId(line_break_.id); }

    const AXNode& GetStaticText2Node() const { return *ax_tree()->GetFromId(static_text2_.id); }

    const AXNode& GetInlineBox1Node() const { return *ax_tree()->GetFromId(inline_box1_.id); }

    const AXNode& GetInlineBox2Node() const { return *ax_tree()->GetFromId(inline_box2_.id); }
...
class AXPositionExpandToEnclosingTextBoundaryTestWithParam : public AXPositionTest, public ::testing::WithParamInterface<ExpandToEnclosingTextBoundaryTestParam> {
public:
...
std::unique_ptr<AXTree> AXPositionTest::CreateMultipageDocument(AXNodeData& root_data, AXNodeData& page_1_data, AXNodeData& page_1_text_data, AXNodeData& page_2_data,
    AXNodeData& page_2_text_data, AXNodeData& page_3_data, AXNodeData& page_3_text_data) const
{
    root_data.id = 1;
...
void AXPositionTest::CreateBrowserWindow(AXNodeData& window, AXNodeData& back_button, AXNodeData& web_view, AXNodeData& root_web_area, AXNodeData& iframe_root,
    AXNodeData& paragraph, AXNodeData& address_bar, std::vector<TestAXTreeManager>& out_managers) const
{
    // First tree: Views.
    window.id = 1;
    window.role = ax::mojom::Role::kWindow;
...
TEST_F(AXPositionTest, DISABLED_Clone)
{
    ...
    TestPositionType tree_position = AXNodePosition::CreateTreePosition(*ax_tree(), GetRootNode(), 0 /* child_index */);
    ...
    tree_position = AXNodePosition::CreateTreePosition(*ax_tree(), GetRootNode(), 1 /* child_index */);
    ASSERT_NE(nullptr, tree_position);
    copy_position = tree_position->Clone();
    ASSERT_NE(nullptr, copy_position);
    EXPECT_TRUE(copy_position->IsTreePosition());
    ...
    EXPECT_DEATH_IF_SUPPORTED(AXNodePosition::CreateTreePosition(*ax_tree(), GetRootNode(), AXNodePosition::BEFORE_TEXT), "Creating invalid positions is disallowed.");

    TestPositionType text_position = CreateTextPosition(text_field_.id, 0 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    ...
    text_position = CreateTextPosition(text_field_.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    copy_position = text_position->Clone();
    ASSERT_NE(nullptr, copy_position);
...
TEST_F(AXPositionTest, Serialize)
{
    ...
    TestPositionType tree_position = AXNodePosition::CreateTreePosition(*ax_tree(), GetRootNode(), 1 /* child_index */);
    ASSERT_NE(nullptr, tree_position);
    ...
    tree_position = AXNodePosition::CreateTreePosition(*ax_tree(), GetInlineBox2Node(), AXNodePosition::BEFORE_TEXT);
    ASSERT_NE(nullptr, tree_position);
    copy_position = AXNodePosition::Unserialize(tree_position->Serialize());
    ASSERT_NE(nullptr, copy_position);
    EXPECT_TRUE(copy_position->IsTreePosition());
...
TEST_F(AXPositionTest, ToString)
{
    ...
    TestPositionType text_position_1 = CreateTextPosition(root_data.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ...
    TestPositionType text_position_2 = CreateTextPosition(root_data.id, 5 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ...
    TestPositionType text_position_3 = CreateTextPosition(root_data.id, 9 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ...
    TestPositionType text_position_4 = CreateTextPosition(root_data.id, 10 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ...
    TestPositionType text_position_5 = CreateTextPosition(root_data.id, 19 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ...
    TestPositionType text_position_6 = CreateTextPosition(static_text_data_2.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ...
    TestPositionType text_position_7 = CreateTextPosition(static_text_data_2.id, 1 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ...
    TestPositionType text_position_8 = CreateTextPosition(static_text_data_3.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ...
    TestPositionType text_position_9 = CreateTextPosition(static_text_data_3.id, 5 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ...
    TestPositionType text_position_10 = CreateTextPosition(static_text_data_3.id, 9 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
...
TEST_F(AXPositionTest, DISABLED_IsIgnored)
{
    ...
    TestPositionType text_position_3 = CreateTextPosition(root_data.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_TRUE(text_position_3->IsTextPosition());
    ...
    TestPositionType text_position_4 = CreateTextPosition(root_data.id, 1 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_TRUE(text_position_4->IsTextPosition());
    // Same as above.
    ...
    // ignored.
    TestPositionType text_position_5 = CreateTextPosition(container_data.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_TRUE(text_position_5->IsTextPosition());
    ...
    TestPositionType text_position_7 = CreateTextPosition(inline_box_data_1.id, 1 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_TRUE(text_position_7->IsTextPosition());
    ...
    TestPositionType tree_position_1 = AXNodePosition::CreateTreePosition(*ax_tree(), *root, 0 /* child_index */);
    ...
    TestPositionType tree_position_2 = AXNodePosition::CreateTreePosition(*ax_tree(), *root, 1 /* child_index */);
    ...
    TestPositionType tree_position_3 = AXNodePosition::CreateTreePosition(*ax_tree(), *inline_box_1, 0 /* child_index */);
    ...
    TestPositionType tree_position_4 = AXNodePosition::CreateTreePosition(*ax_tree(), *inline_box_1, AXNodePosition::BEFORE_TEXT);
    ...
    TestPositionType tree_position_5 = AXNodePosition::CreateTreePosition(*ax_tree(), *root, 2 /* child_index */);
    ...
    // node's children.
    EXPECT_DEATH_IF_SUPPORTED(AXNodePosition::CreateTreePosition(*ax_tree(), *static_text_1, AXNodePosition::BEFORE_TEXT), "Creating invalid positions is disallowed.");
}
...
{
    TestPositionType text_position = CreateTextPosition(root_.id, 0 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
...
{
    TestPositionType text_position = CreateTextPosition(button_.id, 0 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    ASSERT_EQ(u"", text_position->GetText());
}
...
{
    TestPositionType text_position = CreateTextPosition(check_box_.id, 0 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    ASSERT_EQ(u"", text_position->GetText());
}
...
{
    TestPositionType text_position = CreateTextPosition(static_text1_.id, 0 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
...
{
    TestPositionType text_position = CreateTextPosition(inline_box1_.id, 0 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    ASSERT_EQ(u"Line 1", text_position->GetText());
}
...
{
    TestPositionType text_position = CreateTextPosition(line_break_.id, 0 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
...
{
    // "Line <1>".
    TestPositionType text_field_position = CreateTextPosition(text_field_.id, 5 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_field_position);
    EXPECT_FALSE(text_field_position->IsPointingToLineBreak());
    // "Line 1<>".
    TestPositionType static_text1_position = CreateTextPosition(static_text1_.id, 6 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ASSERT_NE(nullptr, static_text1_position);
    EXPECT_FALSE(static_text1_position->IsPointingToLineBreak());
    // Before the line break.
    text_field_position = CreateTextPosition(text_field_.id, 6 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_field_position);
    EXPECT_TRUE(text_field_position->IsPointingToLineBreak());
    // After the line break.
    text_field_position = CreateTextPosition(text_field_.id, 7 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_field_position);
    EXPECT_FALSE(text_field_position->IsPointingToLineBreak());
    text_field_position = CreateTextPosition(text_field_.id, 7 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ASSERT_NE(nullptr, text_field_position);
    EXPECT_TRUE(text_field_position->IsPointingToLineBreak());

    TestPositionType line_break_position = CreateTextPosition(line_break_.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, line_break_position);
    EXPECT_TRUE(line_break_position->IsPointingToLineBreak());
    line_break_position = CreateTextPosition(line_break_.id, 1 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, line_break_position);
    EXPECT_TRUE(line_break_position->IsPointingToLineBreak());
    // An upstream affinity should not matter on leaf nodes.
    line_break_position = CreateTextPosition(line_break_.id, 1 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ASSERT_NE(nullptr, line_break_position);
    EXPECT_TRUE(line_break_position->IsPointingToLineBreak());
    ...
    TestPositionType root_data_position = CreateTextPosition(root_data.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, root_data_position);
    EXPECT_FALSE(root_data_position->IsPointingToLineBreak());
    root_data_position = CreateTextPosition(root_data.id, 1 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, root_data_position);
    EXPECT_TRUE(root_data_position->IsPointingToLineBreak());
    root_data_position = CreateTextPosition(root_data.id, 2 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, root_data_position);
    EXPECT_FALSE(root_data_position->IsPointingToLineBreak());
}
...
{
    TestPositionType button_position = CreateTextPosition(button_.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ...
    TestPositionType text_field_position = CreateTextPosition(text_field_.id, 6 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_field_position);
...
TEST_F(AXPositionTest, GetMaxTextOffsetAndGetTextWithGeneratedContent)
{
    ...
    TestPositionType text_position = CreateTextPosition(text_field_2.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
...
TEST_F(AXPositionTest, AtStartOfAnchorWithTreePosition)
{
    ...
    tree_position = AXNodePosition::CreateTreePosition(GetTreeID(), root_.id, 1 /* child_index */);
    ASSERT_NE(nullptr, tree_position);
    EXPECT_FALSE(tree_position->AtStartOfAnchor());

    tree_position = AXNodePosition::CreateTreePosition(GetTreeID(), root_.id, 3 /* child_index */);
    ASSERT_NE(nullptr, tree_position);
    EXPECT_FALSE(tree_position->AtStartOfAnchor());

    // A "before text" position.
    tree_position = AXNodePosition::CreateTreePosition(*ax_tree(), GetInlineBox1Node(), AXNodePosition::BEFORE_TEXT);
    ASSERT_NE(nullptr, tree_position);
    EXPECT_TRUE(tree_position->AtStartOfAnchor());

    // An "after text" position.
    tree_position = AXNodePosition::CreateTreePosition(*ax_tree(), GetInlineBox1Node(), 0 /* child_index */);
    ASSERT_NE(nullptr, tree_position);
    EXPECT_FALSE(tree_position->AtStartOfAnchor());
}
...
TEST_F(AXPositionTest, AtStartOfAnchorWithTextPosition)
{
    ...
    text_position = CreateTextPosition(inline_box1_.id, 1 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    EXPECT_FALSE(text_position->AtStartOfAnchor());

    text_position = CreateTextPosition(inline_box1_.id, 6 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    EXPECT_FALSE(text_position->AtStartOfAnchor());
}
...
{
    TestPositionType tree_position = AXNodePosition::CreateTreePosition(*ax_tree(), GetRootNode(), 3 /* child_index */);
    ASSERT_NE(nullptr, tree_position);
    EXPECT_TRUE(tree_position->AtEndOfAnchor());

    tree_position = AXNodePosition::CreateTreePosition(*ax_tree(), GetRootNode(), 2 /* child_index */);
    ASSERT_NE(nullptr, tree_position);
    EXPECT_FALSE(tree_position->AtEndOfAnchor());

    tree_position = AXNodePosition::CreateTreePosition(*ax_tree(), GetRootNode(), 0 /* child_index */);
    ASSERT_NE(nullptr, tree_position);
    EXPECT_FALSE(tree_position->AtEndOfAnchor());
}
...
{
    TestPositionType text_position = CreateTextPosition(inline_box1_.id, 6 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    EXPECT_TRUE(text_position->AtEndOfAnchor());

    text_position = CreateTextPosition(inline_box1_.id, 5 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    EXPECT_FALSE(text_position->AtEndOfAnchor());

    text_position = CreateTextPosition(inline_box1_.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    EXPECT_FALSE(text_position->AtEndOfAnchor());
}
...
TEST_F(AXPositionTest, AtStartOfLineWithTextPosition)
{
    ...
    text_position = CreateTextPosition(line_break_.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    EXPECT_FALSE(text_position->AtStartOfLine());
    ...
    text_position = CreateTextPosition(line_break_.id, 1 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    EXPECT_TRUE(text_position->AtStartOfLine());
    ...
    // An upstream affinity should not affect the outcome since there is no soft
    // line break.
    text_position = CreateTextPosition(inline_box2_.id, 0 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    EXPECT_TRUE(text_position->AtStartOfLine());

    text_position = CreateTextPosition(inline_box2_.id, 1 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    EXPECT_FALSE(text_position->AtStartOfLine());
}
...
TEST_F(AXPositionTest, AtStartOfLineStaticTextExtraPrecedingSpace)
{
    ...
    TestPositionType text_position = CreateTextPosition(static_text1.id, 1 /* child_index */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_FALSE(text_position->AtStartOfLine());
}

TEST_F(AXPositionTest, AtEndOfLineWithTextPosition)
{
    TestPositionType text_position = CreateTextPosition(inline_box1_.id, 5 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    EXPECT_FALSE(text_position->AtEndOfLine());

    text_position = CreateTextPosition(inline_box1_.id, 6 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    ...
    text_position = CreateTextPosition(inline_box2_.id, 5 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    EXPECT_FALSE(text_position->AtEndOfLine());

    text_position = CreateTextPosition(inline_box2_.id, 6 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    EXPECT_TRUE(text_position->AtEndOfLine());
}
...
TEST_F(AXPositionTest, AtStartOfBlankLine)
{
    ...
    TestPositionType tree_position = AXNodePosition::CreateTreePosition(*ax_tree(), GetTextFieldNode(), 1 /* child_index */);
    ASSERT_NE(nullptr, tree_position);
    ASSERT_TRUE(tree_position->IsTreePosition());
    EXPECT_TRUE(tree_position->AtStartOfLine());

    TestPositionType text_position = CreateTextPosition(line_break_.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    EXPECT_TRUE(text_position->AtStartOfLine());
...
TEST_F(AXPositionTest, AtStartAndEndOfLineWhenAtEndOfTextSpan)
{
    ...
    SetTree(CreateAXTree({ root_data, static_text_data_1, inline_box_data_1, inline_box_data_2, inline_box_data_3, inline_box_data_4, static_text_data_2, inline_box_data_5 }));
    ...
    TestPositionType tree_position = AXNodePosition::CreateTreePosition(*ax_tree(), *inline_box_2, 0 /* child_index */);
    ASSERT_NE(nullptr, tree_position);
    ASSERT_TRUE(tree_position->IsTreePosition());
    EXPECT_TRUE(tree_position->AtStartOfLine());
    EXPECT_FALSE(tree_position->AtEndOfLine());
    ...
    tree_position = AXNodePosition::CreateTreePosition(*ax_tree(), *inline_box_4, 0 /* child_index */);
    ASSERT_NE(nullptr, tree_position);
    ASSERT_TRUE(tree_position->IsTreePosition());
    EXPECT_FALSE(tree_position->AtStartOfLine());
    EXPECT_TRUE(tree_position->AtEndOfLine());

    TestPositionType text_position = CreateTextPosition(inline_box_data_2.id, 1 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    EXPECT_TRUE(text_position->AtStartOfLine());
    EXPECT_FALSE(text_position->AtEndOfLine());

    text_position = CreateTextPosition(inline_box_data_4.id, 1 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    EXPECT_FALSE(text_position->AtStartOfLine());
    EXPECT_TRUE(text_position->AtEndOfLine());
...
TEST_F(AXPositionTest, AtStartAndEndOfLineInsideTextField)
{
    ...
    SetTree(CreateAXTree({ root_data, text_field_data_1, static_text_data_1, inline_box_data_1, inline_box_data_2, inline_box_data_3, text_field_data_2, static_text_data_2,
        inline_box_data_4, inline_box_data_5, inline_box_data_6 }));

    AXNode* text_field_1 = ax_tree()->GetFromId(text_field_data_1.id);
    AXNode* text_field_2 = ax_tree()->GetFromId(text_field_data_2.id);

    TestPositionType tree_position = AXNodePosition::CreateTreePosition(*ax_tree(), *text_field_1, 0 /* child_index */);
    ASSERT_NE(nullptr, tree_position);
    ASSERT_TRUE(tree_position->IsTreePosition());
    EXPECT_TRUE(tree_position->AtStartOfLine());
    EXPECT_FALSE(tree_position->AtEndOfLine());

    tree_position = AXNodePosition::CreateTreePosition(*ax_tree(), *text_field_1, 1 /* child_index */);
    ASSERT_NE(nullptr, tree_position);
    ASSERT_TRUE(tree_position->IsTreePosition());
    EXPECT_FALSE(tree_position->AtStartOfLine());
    EXPECT_TRUE(tree_position->AtEndOfLine());

    tree_position = AXNodePosition::CreateTreePosition(*ax_tree(), *text_field_2, 0 /* child_index */);
    ASSERT_NE(nullptr, tree_position);
    ASSERT_TRUE(tree_position->IsTreePosition());
    EXPECT_TRUE(tree_position->AtStartOfLine());
    EXPECT_FALSE(tree_position->AtEndOfLine());

    tree_position = AXNodePosition::CreateTreePosition(*ax_tree(), *text_field_2, 1 /* child_index */);
    ASSERT_NE(nullptr, tree_position);
    ASSERT_TRUE(tree_position->IsTreePosition());
    EXPECT_FALSE(tree_position->AtStartOfLine());
    EXPECT_TRUE(tree_position->AtEndOfLine());

    TestPositionType text_position = CreateTextPosition(text_field_data_1.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    EXPECT_TRUE(text_position->AtStartOfLine());
    EXPECT_FALSE(text_position->AtEndOfLine());

    text_position = CreateTextPosition(text_field_data_1.id, 16 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    EXPECT_FALSE(text_position->AtStartOfLine());
    EXPECT_TRUE(text_position->AtEndOfLine());

    text_position = CreateTextPosition(text_field_data_2.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    EXPECT_TRUE(text_position->AtStartOfLine());
    EXPECT_FALSE(text_position->AtEndOfLine());

    text_position = CreateTextPosition(text_field_data_2.id, 16 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    EXPECT_FALSE(text_position->AtStartOfLine());
    EXPECT_TRUE(text_position->AtEndOfLine());
...
TEST_F(AXPositionTest, AtStartOrEndOfParagraphWithPreservedNewLine)
{
    ...
    TestPositionType text_position1 = CreateTextPosition(root_data.id, 8 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    EXPECT_FALSE(text_position1->AtEndOfParagraph());
    EXPECT_FALSE(text_position1->AtStartOfParagraph());

    // Text position "some text<\n>more text".
    TestPositionType text_position2 = CreateTextPosition(root_data.id, 9 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    EXPECT_FALSE(text_position2->AtEndOfParagraph());
    EXPECT_TRUE(text_position2->AtStartOfParagraph());

    // Text position "some text<\n>more text".
    TestPositionType text_position3 = CreateTextPosition(root_data.id, 9 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    EXPECT_TRUE(text_position3->AtEndOfParagraph());
    EXPECT_FALSE(text_position3->AtStartOfParagraph());

    // Text position "some text\n<m>ore text".
    TestPositionType text_position4 = CreateTextPosition(root_data.id, 10 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    EXPECT_FALSE(text_position4->AtEndOfParagraph());
    EXPECT_TRUE(text_position4->AtStartOfParagraph());

    // Text position "some text\n<m>ore text".
    TestPositionType text_position5 = CreateTextPosition(root_data.id, 10 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    EXPECT_FALSE(text_position5->AtEndOfParagraph());
    EXPECT_FALSE(text_position5->AtStartOfParagraph());

    // Text position "<\n>more text".
    TestPositionType text_position6 = CreateTextPosition(container_data.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    EXPECT_FALSE(text_position6->AtEndOfParagraph());
    EXPECT_TRUE(text_position6->AtStartOfParagraph());

    // Text position "\n<m>ore text".
    TestPositionType text_position7 = CreateTextPosition(container_data.id, 1 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    EXPECT_FALSE(text_position7->AtEndOfParagraph());
    EXPECT_TRUE(text_position7->AtStartOfParagraph());

    // Text position "\n<m>ore text".
    TestPositionType text_position8 = CreateTextPosition(container_data.id, 1 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    EXPECT_FALSE(text_position8->AtEndOfParagraph());
    EXPECT_FALSE(text_position8->AtStartOfParagraph());

    // Text position "\n<m>ore text".
    TestPositionType text_position9 = CreateTextPosition(static_text_data_2.id, 1 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    EXPECT_FALSE(text_position9->AtEndOfParagraph());
    EXPECT_TRUE(text_position9->AtStartOfParagraph());

    // Text position "\n<m>ore text".
    TestPositionType text_position10 = CreateTextPosition(static_text_data_2.id, 1 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    EXPECT_FALSE(text_position10->AtEndOfParagraph());
    EXPECT_FALSE(text_position10->AtStartOfParagraph());

    TestPositionType text_position11 = CreateTextPosition(preserved_newline_data.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    EXPECT_FALSE(text_position11->AtEndOfParagraph());
    EXPECT_TRUE(text_position11->AtStartOfParagraph());

    TestPositionType text_position12 = CreateTextPosition(preserved_newline_data.id, 1 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    EXPECT_FALSE(text_position12->AtEndOfParagraph());
    EXPECT_FALSE(text_position12->AtStartOfParagraph());

    TestPositionType text_position13 = CreateTextPosition(more_text_data.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    EXPECT_FALSE(text_position13->AtEndOfParagraph());
    EXPECT_TRUE(text_position13->AtStartOfParagraph());

    TestPositionType text_position14 = CreateTextPosition(more_text_data.id, 1 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
...
TEST_F(AXPositionTest, TreePositionAtStartOrEndOfListMarkerAnchor)
{
    ...
    TestPositionType tree_position = AXNodePosition::CreateTreePosition(GetTreeID(), list_marker.id, 1);
    ASSERT_NE(nullptr, tree_position);
...
TEST_F(AXPositionTest, AtStartOrEndOfParagraphOnAListMarker)
{
    ...
    SetTree(CreateAXTree({ root, static_text1, inline_box1, list, list_item1, list_marker_legacy, static_text2, static_text3, inline_box3, list_item2, list_marker_ng, static_text4,
    ...
    // bullet / item.
    TestPositionType text_position = CreateTextPosition(static_text1.id, 12 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    EXPECT_FALSE(text_position->AtStartOfParagraph());
    EXPECT_TRUE(text_position->AtEndOfParagraph());
    ...
    // to a position that is before the list itself, or before the first list
    // bullet / item.
    text_position = CreateTextPosition(inline_box1.id, 12 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    EXPECT_FALSE(text_position->AtStartOfParagraph());
    EXPECT_TRUE(text_position->AtEndOfParagraph());

    // A text position before the list.
    text_position = CreateTextPosition(list.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    EXPECT_TRUE(text_position->AtStartOfParagraph());
    EXPECT_FALSE(text_position->AtEndOfParagraph());
    ...
    // "AtStartOfParagraph".
    text_position = CreateTextPosition(list.id, 14 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    EXPECT_TRUE(text_position->AtStartOfParagraph());
    EXPECT_FALSE(text_position->AtEndOfParagraph());

    // An upstream text position after the list. It should be "AtEndOfParagraph".
    text_position = CreateTextPosition(list.id, 14 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ASSERT_NE(nullptr, text_position);
    EXPECT_FALSE(text_position->AtStartOfParagraph());
    EXPECT_TRUE(text_position->AtEndOfParagraph());

    // A text position before the first list bullet (the Legacy Layout one).
    text_position = CreateTextPosition(list_marker_legacy.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ...
    text_position = CreateTextPosition(list_marker_legacy.id, 1 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    EXPECT_TRUE(text_position->IsLeaf());
    EXPECT_FALSE(text_position->IsIgnored());
    EXPECT_FALSE(text_position->AtStartOfParagraph());
    ...
    text_position = CreateTextPosition(list_marker_legacy.id, 2 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    EXPECT_TRUE(text_position->IsLeaf());
    EXPECT_FALSE(text_position->IsIgnored());
    EXPECT_FALSE(text_position->AtStartOfParagraph());
    ...
    text_position = CreateTextPosition(list_marker_legacy.id, 3 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    EXPECT_TRUE(text_position->IsLeaf());
    EXPECT_FALSE(text_position->IsIgnored());
    EXPECT_FALSE(text_position->AtStartOfParagraph());
    ...
    text_position = CreateTextPosition(list_marker_ng.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    EXPECT_TRUE(text_position->IsLeaf());
    EXPECT_TRUE(text_position->AtStartOfParagraph());
    EXPECT_FALSE(text_position->AtEndOfParagraph());

    text_position = CreateTextPosition(list_marker_ng.id, 3 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    EXPECT_TRUE(text_position->IsLeaf());
    EXPECT_FALSE(text_position->AtStartOfParagraph());
    EXPECT_FALSE(text_position->AtEndOfParagraph());
    ...
    // bullet.
    text_position = CreateTextPosition(static_text3.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    EXPECT_FALSE(text_position->AtStartOfParagraph());
    EXPECT_FALSE(text_position->AtEndOfParagraph());
    ...
    // A text position before the text contents of the first list item - not the
    // bullet.
    text_position = CreateTextPosition(inline_box3.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    EXPECT_FALSE(text_position->AtStartOfParagraph());
    EXPECT_FALSE(text_position->AtEndOfParagraph());

    // A text position after the text contents of the first list item.
    text_position = CreateTextPosition(static_text3.id, 11 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    EXPECT_FALSE(text_position->AtStartOfParagraph());
    EXPECT_TRUE(text_position->AtEndOfParagraph());

    // A text position after the text contents of the first list item.
    text_position = CreateTextPosition(inline_box3.id, 11 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    EXPECT_FALSE(text_position->AtStartOfParagraph());
    EXPECT_TRUE(text_position->AtEndOfParagraph());
    ...
    // bullet.
    text_position = CreateTextPosition(static_text4.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    EXPECT_FALSE(text_position->AtStartOfParagraph());
    EXPECT_FALSE(text_position->AtEndOfParagraph());
    ...
    // A text position before the text contents of the second list item - not the
    // bullet.
    text_position = CreateTextPosition(inline_box4.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    EXPECT_FALSE(text_position->AtStartOfParagraph());
    EXPECT_FALSE(text_position->AtEndOfParagraph());

    // A text position after the text contents of the second list item.
    text_position = CreateTextPosition(static_text4.id, 12 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    EXPECT_FALSE(text_position->AtStartOfParagraph());
    EXPECT_TRUE(text_position->AtEndOfParagraph());

    // A text position after the text contents of the second list item.
    text_position = CreateTextPosition(inline_box4.id, 12 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    EXPECT_FALSE(text_position->AtStartOfParagraph());
    EXPECT_TRUE(text_position->AtEndOfParagraph());

    // A text position before the text "After list.".
    text_position = CreateTextPosition(inline_box5.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    EXPECT_TRUE(text_position->AtStartOfParagraph());
    EXPECT_FALSE(text_position->AtEndOfParagraph());
}
...
TEST_F(AXPositionTest, AtStartOrEndOfParagraphWithLeadingAndTrailingWhitespace)
{
    ...
    SetTree(CreateAXTree({ root_data, container_data_a, container_data_b, container_data_c, static_text_data_a, static_text_data_b, static_text_data_c, inline_text_data_a,
        inline_text_data_b_1, inline_text_data_b_2, inline_text_data_b_3, inline_text_data_c }));

    // Before the first "\n".
    TestPositionType text_position1 = CreateTextPosition(inline_text_data_a.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    EXPECT_FALSE(text_position1->AtEndOfParagraph());
    ...
    TestPositionType text_position2 = CreateTextPosition(inline_text_data_a.id, 1 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    EXPECT_TRUE(text_position2->AtEndOfParagraph());
    EXPECT_FALSE(text_position2->AtStartOfParagraph());

    // Before "some".
    TestPositionType text_position3 = CreateTextPosition(inline_text_data_b_1.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    EXPECT_FALSE(text_position3->AtEndOfParagraph());
    EXPECT_TRUE(text_position3->AtStartOfParagraph());

    // After "some".
    TestPositionType text_position4 = CreateTextPosition(inline_text_data_b_1.id, 4 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    EXPECT_FALSE(text_position4->AtEndOfParagraph());
    EXPECT_FALSE(text_position4->AtStartOfParagraph());

    // Before " ".
    TestPositionType text_position5 = CreateTextPosition(inline_text_data_b_2.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    EXPECT_FALSE(text_position5->AtEndOfParagraph());
    EXPECT_FALSE(text_position5->AtStartOfParagraph());

    // After " ".
    TestPositionType text_position6 = CreateTextPosition(inline_text_data_b_2.id, 1 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    EXPECT_FALSE(text_position6->AtEndOfParagraph());
    EXPECT_FALSE(text_position6->AtStartOfParagraph());

    // Before "text".
    TestPositionType text_position7 = CreateTextPosition(inline_text_data_b_3.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    EXPECT_FALSE(text_position7->AtEndOfParagraph());
    EXPECT_FALSE(text_position7->AtStartOfParagraph());

    // After "text".
    TestPositionType text_position8 = CreateTextPosition(inline_text_data_b_3.id, 4 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    EXPECT_TRUE(text_position8->AtEndOfParagraph());
    EXPECT_FALSE(text_position8->AtStartOfParagraph());

    // Before the second "\n".
    TestPositionType text_position9 = CreateTextPosition(inline_text_data_c.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    EXPECT_FALSE(text_position9->AtEndOfParagraph());
    EXPECT_TRUE(text_position9->AtStartOfParagraph());

    // After the second "\n".
    TestPositionType text_position10 = CreateTextPosition(inline_text_data_c.id, 1 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
...
TEST_F(AXPositionTest, AtStartOrEndOfParagraphWithIgnoredNodes)
{
    ...
    TestPositionType text_position2 = CreateTextPosition(inline_text_data_a.id, 12 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    EXPECT_TRUE(text_position2->AtEndOfParagraph());
    EXPECT_FALSE(text_position2->AtStartOfParagraph());
    ...
    TestPositionType text_position10 = CreateTextPosition(inline_text_data_c.id, 12 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    EXPECT_TRUE(text_position10->AtEndOfParagraph());
    EXPECT_FALSE(text_position10->AtStartOfParagraph());
}
...
{
    ScopedAXEmbeddedObjectBehaviorSetter ax_embedded_object_behavior(AXEmbeddedObjectBehavior::kExposeCharacter);
    ...
    // Before "hello".
    TestPositionType text_position = CreateTextPosition(inline_box_4.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    EXPECT_FALSE(text_position->AtEndOfParagraph());
    EXPECT_TRUE(text_position->AtStartOfParagraph());
    ...
    text_position = CreateTextPosition(inline_box_4.id, 5 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    EXPECT_TRUE(text_position->AtEndOfParagraph());
    EXPECT_FALSE(text_position->AtStartOfParagraph());

    // Before the image's embedded object character.
    text_position = CreateTextPosition(image_5.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    EXPECT_FALSE(text_position->AtEndOfParagraph());
    EXPECT_TRUE(text_position->AtStartOfParagraph());

    // After the image's embedded object character.
    text_position = CreateTextPosition(image_5.id, 1 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    EXPECT_TRUE(text_position->AtEndOfParagraph());
    EXPECT_FALSE(text_position->AtStartOfParagraph());

    // Before "world".
    text_position = CreateTextPosition(inline_box_7.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    EXPECT_FALSE(text_position->AtEndOfParagraph());
    EXPECT_TRUE(text_position->AtStartOfParagraph());

    // After "world".
    text_position = CreateTextPosition(inline_box_7.id, 5 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    EXPECT_TRUE(text_position->AtEndOfParagraph());
    EXPECT_FALSE(text_position->AtStartOfParagraph());
}
...
TEST_F(AXPositionTest, CreateNextOrPreviousParagraphPositionWithIgnoredNodes)
{
    ...
    SetTree(CreateAXTree({ root_data, static_text_data_a, inline_text_data_a, ignored_container_data_a, static_text_data_b, inline_text_data_b_1, inline_text_data_b_2,
        inline_text_data_b_3, ignored_container_data_b, static_text_data_c, inline_text_data_c }));

    TestPositionType paragraph_start_position = CreateTextPosition(inline_text_data_a.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    paragraph_start_position = paragraph_start_position->CreateNextParagraphStartPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    ...
    paragraph_start_position = CreateTextPosition(inline_text_data_c.id, 15 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    paragraph_start_position
        = paragraph_start_position->CreatePreviousParagraphStartPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    ASSERT_TRUE(paragraph_start_position->IsTextPosition());
    EXPECT_EQ(inline_text_data_c.id, paragraph_start_position->anchor_id());
    EXPECT_EQ(0, paragraph_start_position->text_offset());
    paragraph_start_position
    ...
    TestPositionType paragraph_end_position = CreateTextPosition(inline_text_data_a.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    paragraph_end_position = paragraph_end_position->CreateNextParagraphEndPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    ...
    paragraph_end_position = CreateTextPosition(inline_text_data_c.id, 15 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    paragraph_end_position = paragraph_end_position->CreatePreviousParagraphEndPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    ASSERT_TRUE(paragraph_end_position->IsTextPosition());
    EXPECT_EQ(inline_text_data_b_3.id, paragraph_end_position->anchor_id());
    // "paragraph<>".
    EXPECT_EQ(9, paragraph_end_position->text_offset());
...
TEST_F(AXPositionTest, CreatePreviousParagraphEndPositionStopAtAnchorBoundaryWithConsecutiveParentChildLineBreakingObjects)
{
    ...
    TestPositionType test_position = CreateTextPosition(root_data.id, 11 /* text_offset */, ax::mojom::TextAffinity::kDownstream);

    test_position = test_position->CreatePreviousParagraphEndPosition({ AXBoundaryBehavior::kStopAtAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
...
TEST_F(AXPositionTest, LowestCommonAncestor)
{
    ...
    TestPositionType root_position = AXNodePosition::CreateTreePosition(*ax_tree(), GetRootNode(), 3 /* child_index */);
    ASSERT_NE(nullptr, root_position);
    // A "before text" position.
    TestPositionType button_position = AXNodePosition::CreateTreePosition(*ax_tree(), GetButtonNode(), AXNodePosition::BEFORE_TEXT);
    ASSERT_NE(nullptr, button_position);
    TestPositionType text_field_position = AXNodePosition::CreateTreePosition(*ax_tree(), GetTextFieldNode(), 2 /* child_index */);
    ASSERT_NE(nullptr, text_field_position);
    TestPositionType static_text1_position = AXNodePosition::CreateTreePosition(*ax_tree(), GetStaticText1Node(), 0 /* child_index */);
    ASSERT_NE(nullptr, static_text1_position);
    TestPositionType static_text2_position = AXNodePosition::CreateTreePosition(*ax_tree(), GetStaticText2Node(), 0 /* child_index */);
    ASSERT_NE(nullptr, static_text2_position);
    TestPositionType inline_box1_position = CreateTextPosition(inline_box1_.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, inline_box1_position);
    ASSERT_TRUE(inline_box1_position->IsTextPosition());
    TestPositionType inline_box2_position = CreateTextPosition(inline_box2_.id, 0 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
...
TEST_F(AXPositionTest, AsTreePositionWithTextPosition)
{
    ...
    TestPositionType text_position = CreateTextPosition(text_field_.id, 12 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    ...
    text_position = CreateTextPosition(inline_box2_.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
...
{
    TestPositionType text_position = CreateTextPosition(text_field_.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
...
TEST_F(AXPositionTest, AsLeafTreePositionWithTreePosition)
{
    ...
    TestPositionType tree_position = AXNodePosition::CreateTreePosition(*ax_tree(), GetTextFieldNode(), 0 /* child_index */);
    ASSERT_NE(nullptr, tree_position);
    ...
    // Create a tree position pointing to the line break node inside the text
    // field.
    tree_position = AXNodePosition::CreateTreePosition(*ax_tree(), GetTextFieldNode(), 1 /* child_index */);
    ASSERT_NE(nullptr, tree_position);
    ...
    // text field.
    tree_position = AXNodePosition::CreateTreePosition(*ax_tree(), GetTextFieldNode(), 2 /* child_index */);
    ASSERT_NE(nullptr, tree_position);
    test_position = tree_position->AsLeafTreePosition();
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsLeafTreePosition());
...
TEST_F(AXPositionTest, AsLeafTreePositionWithTextPosition)
{
    ...
    // position).
    TestPositionType text_position = CreateTextPosition(root_.id, 13 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    ...
    text_position = CreateTextPosition(root_.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    ...
    text_position = CreateTextPosition(text_field_.id, 0 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    test_position = text_position->AsLeafTreePosition();
    ASSERT_NE(nullptr, test_position);
    ...
    // box.
    text_position = CreateTextPosition(root_.id, 6 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    test_position = text_position->AsLeafTreePosition();
    ASSERT_NE(nullptr, test_position);
    ...
    text_position = CreateTextPosition(text_field_.id, 6 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ASSERT_NE(nullptr, text_position);
    test_position = text_position->AsLeafTreePosition();
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsLeafTreePosition());
    ...
    // Create a text position on the root, pointing to the line break character
    // inside the text field.
    text_position = CreateTextPosition(root_.id, 6 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    test_position = text_position->AsLeafTreePosition();
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsLeafTreePosition());
    ...
    // Create a text position pointing to the line break character inside the text
    // field.
    text_position = CreateTextPosition(text_field_.id, 6 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    test_position = text_position->AsLeafTreePosition();
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsLeafTreePosition());
    ...
    text_position = CreateTextPosition(text_field_.id, 13 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    test_position = text_position->AsLeafTreePosition();
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsLeafTreePosition());
    ...
    // text position.
    text_position = CreateTextPosition(root_.id, 10 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    test_position = text_position->AsLeafTreePosition();
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsLeafTreePosition());
...
TEST_F(AXPositionTest, AsLeafTextPositionWithTreePositionAndEmptyLeafDescendants)
{
    ...
    TestPositionType tree_position = AXNodePosition::CreateTreePosition(*ax_tree(), *root, 1 /* child_index */);
    ...
    tree_position = AXNodePosition::CreateTreePosition(*ax_tree(), *root, 2 /* child_index */);
    ASSERT_FALSE(tree_position->IsLeafTextPosition());
    test_position = tree_position->AsLeafTextPosition();
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsLeafTextPosition());
...
TEST_F(AXPositionTest, AsLeafTextPositionWithTextPosition)
{
    ...
    text_position = CreateTextPosition(root_.id, 10 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ASSERT_NE(nullptr, text_position);
    test_position = text_position->AsLeafTextPosition();
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsLeafTextPosition());
...
TEST_F(AXPositionTest, AsLeafTextPositionWithTextPositionAndEmptyTextSandwich)
{
    ...
    TestPositionType text_position = CreateTextPosition(root_data.id, 9 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    ASSERT_FALSE(text_position->IsLeafTextPosition());
    TestPositionType test_position = text_position->AsLeafTextPosition();
    ...
    text_position = CreateTextPosition(root_data.id, 9 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ASSERT_NE(nullptr, text_position);
    test_position = text_position->AsLeafTextPosition();
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsLeafTextPosition());
...
TEST_F(AXPositionTest, AsLeafTextPositionWithTextPositionAndEmbeddedObject)
{
    ...
    TestPositionType before_root = CreateTextPosition(root.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, before_root);
    TestPositionType middle_root = CreateTextPosition(root.id, 1 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, middle_root);
    TestPositionType middle_root_upstream = CreateTextPosition(root.id, 1 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ASSERT_NE(nullptr, middle_root_upstream);
    TestPositionType after_root = CreateTextPosition(root.id, 2 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ...
    // completeness.
    TestPositionType after_root_upstream = CreateTextPosition(root.id, 2 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ASSERT_NE(nullptr, after_root_upstream);

    TestPositionType before_image = CreateTextPosition(image.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ...
    TestPositionType after_image = CreateTextPosition(image.id, 1 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, after_image);

    TestPositionType before_paragraph = CreateTextPosition(paragraph.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ...
    TestPositionType after_paragraph = CreateTextPosition(paragraph.id, 1 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, after_paragraph);
    // A position with an upstream affinity after the paragraph should make no
    // difference compared with a downstream affinity, but we'll test it for
    // completeness.
    TestPositionType after_paragraph_upstream = CreateTextPosition(paragraph.id, 1 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ASSERT_NE(nullptr, after_paragraph_upstream);

    TestPositionType before_link = CreateTextPosition(link.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, before_link);
    // The llink has the text "Hello" inside it.
    TestPositionType after_link = CreateTextPosition(link.id, 5 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, after_link);
    // A position with an upstream affinity after the link should make no
    // difference compared with a downstream affinity, but we'll test it for
    // completeness.
    TestPositionType after_link_upstream = CreateTextPosition(link.id, 5 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ASSERT_NE(nullptr, after_link_upstream);

    TestPositionType before_inline_box = CreateTextPosition(inline_box.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, before_inline_box);
    // The inline box has the text "Hello" inside it.
    TestPositionType after_inline_box = CreateTextPosition(inline_box.id, 5 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
...
TEST_F(AXPositionTest, AsUnignoredPosition)
{
    ...
    TestPositionType text_position = CreateTextPosition(container_data.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ...
    // "After text" position.
    text_position = CreateTextPosition(container_data.id, 1 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    EXPECT_TRUE(text_position->IsIgnored());
    ...
    TestPositionType tree_position = AXNodePosition::CreateTreePosition(*ax_tree(), *container, 0 /* child_index */);
    ...
    tree_position = AXNodePosition::CreateTreePosition(*ax_tree(), *container, 1 /* child_index */);
    EXPECT_TRUE(tree_position->IsIgnored());
    // Changing the adjustment behavior should not affect the outcome.
    ...
    tree_position = AXNodePosition::CreateTreePosition(*ax_tree(), *static_text_1, 2 /* child_index */);
    EXPECT_TRUE(tree_position->IsIgnored());
    test_position = tree_position->AsUnignoredPosition(AXPositionAdjustmentBehavior::kMoveBackward);
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTreePosition());
    ...
    text_position = CreateTextPosition(root_data.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    EXPECT_TRUE(text_position->IsIgnored());
    ...
    tree_position = AXNodePosition::CreateTreePosition(GetTreeID(), root_data.id, 1 /* child_index */);
    EXPECT_TRUE(tree_position->IsIgnored());
    test_position = tree_position->AsUnignoredPosition(AXPositionAdjustmentBehavior::kMoveForward);
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTreePosition());
    ...
    // "Before children" position.
    tree_position = AXNodePosition::CreateTreePosition(*ax_tree(), *container, 0 /* child_index */);
    EXPECT_TRUE(tree_position->IsIgnored());
    test_position = tree_position->AsUnignoredPosition(AXPositionAdjustmentBehavior::kMoveForward);
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTreePosition());
    ...
    text_position = CreateTextPosition(root_data.id, 1 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    EXPECT_TRUE(text_position->IsIgnored());
    test_position = text_position->AsUnignoredPosition(AXPositionAdjustmentBehavior::kMoveForward);
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    ...
    text_position = CreateTextPosition(inline_box_data_2.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    EXPECT_TRUE(text_position->IsIgnored());
    test_position = text_position->AsUnignoredPosition(AXPositionAdjustmentBehavior::kMoveForward);
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    ...
    tree_position = AXNodePosition::CreateTreePosition(*ax_tree(), *inline_box_2, AXNodePosition::BEFORE_TEXT);
    EXPECT_TRUE(tree_position->IsIgnored());
...
TEST_F(AXPositionTest, CreatePositionAtTextBoundaryContentStartEndIsIgnored)
{
    ...
    SetTree(CreateAXTree(
        { root_data, static_text_data_1, static_text_data_2, static_text_data_3, static_text_data_4, inline_box_data_1, inline_box_data_2, inline_box_data_3, inline_box_data_4 }));

    TestPositionType text_position = CreateTextPosition(inline_box_data_2.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_FALSE(text_position->IsIgnored());
    TestPositionType test_position = text_position->CreatePositionAtTextBoundary(
        ax::mojom::TextBoundary::kWordStart, ax::mojom::MoveDirection::kForward, { AXBoundaryBehavior::kStopAtLastAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    EXPECT_EQ(inline_box_data_3.id, test_position->anchor_id());
    EXPECT_EQ(0, test_position->text_offset());
    ...
    text_position = CreateTextPosition(inline_box_data_3.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_FALSE(text_position->IsIgnored());
...
TEST_F(AXPositionTest, CreatePositionAtInvalidGraphemeBoundary)
{
    ...
    TestPositionType test_position = CreateTextPosition(GetTree()->root()->id(), 4 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    ...
    test_position = CreateTextPosition(GetTree()->root()->id(), 10 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    EXPECT_EQ(GetTree()->root()->id(), test_position->anchor_id());
...
{
    TestPositionType text_position = CreateTextPosition(inline_box1_.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    ...
    text_position = CreateTextPosition(inline_box1_.id, 1 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
...
TEST_F(AXPositionTest, CreatePositionAtPreviousFormatStartWithNullPosition)
{
    TestPositionType null_position = AXNodePosition::CreateNullPosition();
    ASSERT_NE(nullptr, null_position);
    TestPositionType test_position = null_position->CreatePreviousFormatStartPosition({ AXBoundaryBehavior::kStopAtAnchorBoundary, AXBoundaryDetection::kCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsNullPosition());
    ...
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsNullPosition());
    test_position = null_position->CreatePreviousFormatStartPosition({ AXBoundaryBehavior::kStopAtAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsNullPosition());
}
...
{
    ScopedAXEmbeddedObjectBehaviorSetter ax_embedded_object_behavior(AXEmbeddedObjectBehavior::kExposeCharacter);
    TestPositionType tree_position = AXNodePosition::CreateTreePosition(*ax_tree(), GetStaticText1Node(), 1 /* child_index */);
    ASSERT_NE(nullptr, tree_position);
    ASSERT_TRUE(tree_position->IsTreePosition());

    TestPositionType test_position = tree_position->CreatePreviousFormatStartPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTreePosition());
    EXPECT_EQ(static_text1_.id, test_position->anchor_id());
    EXPECT_EQ(0, test_position->child_index());

    test_position = test_position->CreatePreviousFormatStartPosition({ AXBoundaryBehavior::kStopAtLastAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTreePosition());
...
{
    ScopedAXEmbeddedObjectBehaviorSetter ax_embedded_object_behavior(AXEmbeddedObjectBehavior::kExposeCharacter);
    TestPositionType text_position = CreateTextPosition(inline_box1_.id, 2 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());

    TestPositionType test_position = text_position->CreatePreviousFormatStartPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    EXPECT_EQ(inline_box1_.id, test_position->anchor_id());
    EXPECT_EQ(0, test_position->text_offset());
...
TEST_F(AXPositionTest, CreatePositionAtNextFormatEndWithNullPosition)
{
    TestPositionType null_position = AXNodePosition::CreateNullPosition();
    ASSERT_NE(nullptr, null_position);
    TestPositionType test_position = null_position->CreateNextFormatEndPosition({ AXBoundaryBehavior::kStopAtAnchorBoundary, AXBoundaryDetection::kCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsNullPosition());
...
{
    ScopedAXEmbeddedObjectBehaviorSetter ax_embedded_object_behavior(AXEmbeddedObjectBehavior::kExposeCharacter);
    TestPositionType tree_position = AXNodePosition::CreateTreePosition(*ax_tree(), GetButtonNode(), 0 /* child_index */);
    ASSERT_NE(nullptr, tree_position);
    ASSERT_TRUE(tree_position->IsTreePosition());

    TestPositionType test_position = tree_position->CreateNextFormatEndPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTreePosition());
    EXPECT_EQ(check_box_.id, test_position->anchor_id());
    EXPECT_EQ(0, test_position->child_index());

    test_position = test_position->CreateNextFormatEndPosition({ AXBoundaryBehavior::kStopAtLastAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTreePosition());
    EXPECT_EQ(inline_box1_.id, test_position->anchor_id());
    EXPECT_EQ(0, test_position->child_index());
...
{
    ScopedAXEmbeddedObjectBehaviorSetter ax_embedded_object_behavior(AXEmbeddedObjectBehavior::kExposeCharacter);
    TestPositionType text_position = CreateTextPosition(button_.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());

    TestPositionType test_position = text_position->CreateNextFormatEndPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    EXPECT_EQ(button_.id, test_position->anchor_id());
    EXPECT_EQ(1, test_position->text_offset());
...
TEST_F(AXPositionTest, CreatePositionAtNextFormatEndOnEmbeddedObject)
{
    ...
    SetTree(CreateAXTree({ root_1, heading_2, static_text_3, inline_text_4, popup_button_5, menu_list_popup_6, menu_list_option_7, heading_8, static_text_9, inline_text_10,
        popup_button_11, menu_list_popup_12, menu_list_option_13, popup_button_14, menu_list_popup_15, menu_list_option_16, static_text_17, inline_text_18 }));

    // Creating initial text position at "<h>eading 1...".
    TestPositionType text_position = CreateTextPosition(inline_text_4.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    ...
    format_end_position = format_end_position->CreateNextFormatEndPosition({ AXBoundaryBehavior::kStopAtLastAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    ASSERT_NE(nullptr, format_end_position);
    EXPECT_TRUE(format_end_position->IsTextPosition());
...
TEST_F(AXPositionTest, CreatePositionAtFormatBoundaryWithTextPosition)
{
    ...
    TestPositionType text_position = CreateTextPosition(text_data.id, 8 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    TestPositionType test_position = text_position->CreatePreviousFormatStartPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    ...
    text_position = CreateTextPosition(more_text_data.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
...
TEST_F(AXPositionTest, MoveByFormatWithIgnoredNodes)
{
    ...
    SetTree(CreateAXTree({ root_1, generic_container_2, button_3, static_text_4, inline_box_5, svg_root_6, generic_container_7, generic_container_8, heading_9, static_text_10,
        inline_box_11, static_text_12, inline_box_13, generic_container_14, generic_container_15, heading_16, static_text_17, inline_box_18, generic_container_19,
        generic_container_20, static_text_21, inline_box_22, heading_23, static_text_24, inline_box_25 }));
    ...
    {
        // Forward movement
        TestPositionType text_position = CreateTextPosition(inline_box_5.id, 6 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
        ASSERT_NE(nullptr, text_position);
        EXPECT_TRUE(text_position->IsTextPosition());
        EXPECT_EQ(inline_box_5.id, text_position->anchor_id());
        EXPECT_EQ(6, text_position->text_offset());

        text_position = text_position->CreateNextFormatEndPosition({ AXBoundaryBehavior::kStopAtLastAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
        ASSERT_NE(nullptr, text_position);
        EXPECT_TRUE(text_position->IsTextPosition());
        ...
        // Backward movement
        text_position = CreateTextPosition(inline_box_11.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
        ASSERT_NE(nullptr, text_position);
        EXPECT_TRUE(text_position->IsTextPosition());
        EXPECT_EQ(inline_box_11.id, text_position->anchor_id());
        EXPECT_EQ(0, text_position->text_offset());

        text_position = text_position->CreatePreviousFormatStartPosition({ AXBoundaryBehavior::kStopAtLastAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
        ASSERT_NE(nullptr, text_position);
        EXPECT_TRUE(text_position->IsTextPosition());
        EXPECT_EQ(inline_box_5.id, text_position->anchor_id());
        EXPECT_EQ(0, text_position->text_offset());
    ...
    {
        // Forward movement
        TestPositionType text_position = CreateTextPosition(inline_box_11.id, 7 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
        ASSERT_NE(nullptr, text_position);
        EXPECT_TRUE(text_position->IsTextPosition());
        EXPECT_EQ(inline_box_11.id, text_position->anchor_id());
        EXPECT_EQ(7, text_position->text_offset());
        ...
        // Backward movement
        text_position = CreateTextPosition(inline_box_25.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
        ASSERT_NE(nullptr, text_position);
        EXPECT_TRUE(text_position->IsTextPosition());
...
TEST_F(AXPositionTest, CreatePositionAtPageBoundaryWithNullPosition)
{
    TestPositionType null_position = AXNodePosition::CreateNullPosition();
    ASSERT_NE(nullptr, null_position);
    TestPositionType test_position = null_position->CreatePreviousPageStartPosition({ AXBoundaryBehavior::kStopAtAnchorBoundary, AXBoundaryDetection::kCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsNullPosition());
...
TEST_F(AXPositionTest, CreatePositionAtPageBoundaryWithTreePosition)
{
    ...
    TestPositionType tree_position = AXNodePosition::CreateTreePosition(*ax_tree(), *page_1, 0 /* child_index */);
    ASSERT_NE(nullptr, tree_position);
    ASSERT_TRUE(tree_position->IsTreePosition());

    // AXBoundaryDetection::kCheckInitialPosition shouldn't move at all since
    // it's at a boundary.
    TestPositionType test_position = tree_position->CreateNextPageStartPosition({ AXBoundaryBehavior::kStopAtAnchorBoundary, AXBoundaryDetection::kCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTreePosition());
    ...
    test_position = tree_position->CreateNextPageStartPosition({ AXBoundaryBehavior::kStopAtLastAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTreePosition());
    EXPECT_EQ(page_2_text_data.id, test_position->anchor_id());
    EXPECT_EQ(AXNodePosition::BEFORE_TEXT, test_position->child_index());
    ...
    test_position = test_position->CreateNextPageStartPosition({ AXBoundaryBehavior::kStopAtLastAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTreePosition());
    ...
    TestPositionType null_position = test_position->CreateNextPageStartPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    ...
    test_position = tree_position->CreatePreviousPageEndPosition({ AXBoundaryBehavior::kStopAtLastAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTreePosition());
    EXPECT_EQ(page_2_text_data.id, test_position->anchor_id());
    EXPECT_EQ(0, test_position->child_index());
    ...
    test_position = test_position->CreatePreviousPageStartPosition({ AXBoundaryBehavior::kStopAtLastAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTreePosition());
    ...
    test_position = test_position->CreatePreviousPageEndPosition({ AXBoundaryBehavior::kStopAtLastAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTreePosition());
    EXPECT_EQ(page_1_text_data.id, test_position->anchor_id());
    EXPECT_EQ(AXNodePosition::BEFORE_TEXT, test_position->child_index());
...
TEST_F(AXPositionTest, CreatePositionAtPageBoundaryWithTextPosition)
{
    ...
    // Test CreateNextPageStartPosition at the start of the whole content.
    TestPositionType text_position = CreateTextPosition(page_1_text_data.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());

    // AXBoundaryDetection::kCheckInitialPosition shouldn't move at all since
    // it's at a boundary.
    TestPositionType test_position = text_position->CreateNextPageStartPosition({ AXBoundaryBehavior::kStopAtAnchorBoundary, AXBoundaryDetection::kCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    EXPECT_EQ(page_1_text_data.id, test_position->anchor_id());
    EXPECT_EQ(0, test_position->text_offset());
    ...
    test_position = text_position->CreateNextPageStartPosition({ AXBoundaryBehavior::kStopAtLastAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    EXPECT_EQ(page_2_text_data.id, test_position->anchor_id());
    EXPECT_EQ(0, test_position->text_offset());
    ...
    test_position = text_position->CreatePreviousPageEndPosition({ AXBoundaryBehavior::kStopAtLastAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    EXPECT_EQ(page_2_text_data.id, test_position->anchor_id());
    EXPECT_EQ(19, test_position->text_offset());
...
TEST_F(AXPositionTest, CreatePositionAtPageBoundaryWithNonPaginatedDocument)
{
    ...
    TestPositionType text_position = CreateTextPosition(static_text1_.id, 1 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ...
    // page)
    TestPositionType test_position = text_position->CreatePreviousPageStartPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    EXPECT_EQ(button_.id, test_position->anchor_id());
    EXPECT_EQ(0, test_position->text_offset());
...
TEST_F(AXPositionTest, CreatePositionAtStartOfAXTreeWithTreePosition)
{
    ...
    TestPositionType tree_position = AXNodePosition::CreateTreePosition(views_tree_id, window.id, 0 /* child_index */);
    ASSERT_NE(nullptr, tree_position);
    ...
    tree_position = AXNodePosition::CreateTreePosition(views_tree_id, window.id, 1 /* child_index */);
    ASSERT_NE(nullptr, tree_position);
    ...
    tree_position = AXNodePosition::CreateTreePosition(views_tree_id, back_button.id, AXNodePosition::BEFORE_TEXT /* child_index */);
    ASSERT_NE(nullptr, tree_position);
    test_position = tree_position->CreatePositionAtStartOfAXTree();
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTreePosition());
    ...
    tree_position = AXNodePosition::CreateTreePosition(views_tree_id, back_button.id, 0 /* child_index */);
    ASSERT_NE(nullptr, tree_position);
    test_position = tree_position->CreatePositionAtStartOfAXTree();
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTreePosition());
    ...
    tree_position = AXNodePosition::CreateTreePosition(views_tree_id, web_view.id, 0 /* child_index */);
    ASSERT_NE(nullptr, tree_position);
    test_position = tree_position->CreatePositionAtStartOfAXTree();
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTreePosition());
    ...
    tree_position = AXNodePosition::CreateTreePosition(views_tree_id, web_view.id, 1 /* child_index */);
    ASSERT_NE(nullptr, tree_position);
    test_position = tree_position->CreatePositionAtStartOfAXTree();
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTreePosition());
    ...
    tree_position = AXNodePosition::CreateTreePosition(webpage_tree_id, root_web_area.id, 0 /* child_index */);
    ASSERT_NE(nullptr, tree_position);
    test_position = tree_position->CreatePositionAtStartOfAXTree();
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTreePosition());
    ...
    tree_position = AXNodePosition::CreateTreePosition(webpage_tree_id, root_web_area.id, 1 /* child_index */);
    ASSERT_NE(nullptr, tree_position);
    test_position = tree_position->CreatePositionAtStartOfAXTree();
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTreePosition());
    ...
    tree_position = AXNodePosition::CreateTreePosition(webpage_tree_id, paragraph.id, AXNodePosition::BEFORE_TEXT /* child_index */);
    ASSERT_NE(nullptr, tree_position);
    test_position = tree_position->CreatePositionAtStartOfAXTree();
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTreePosition());
    ...
    tree_position = AXNodePosition::CreateTreePosition(webpage_tree_id, paragraph.id, 0 /* child_index */);
    ASSERT_NE(nullptr, tree_position);
    test_position = tree_position->CreatePositionAtStartOfAXTree();
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTreePosition());
    ...
    tree_position = AXNodePosition::CreateTreePosition(iframe_tree_id, iframe_root.id, AXNodePosition::BEFORE_TEXT /* child_index */);
    ASSERT_NE(nullptr, tree_position);
    test_position = tree_position->CreatePositionAtStartOfAXTree();
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTreePosition());
    ...
    tree_position = AXNodePosition::CreateTreePosition(iframe_tree_id, iframe_root.id, 0 /* child_index */);
    ASSERT_NE(nullptr, tree_position);
    test_position = tree_position->CreatePositionAtStartOfAXTree();
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTreePosition());
...
TEST_F(AXPositionTest, CreatePositionAtStartOfAXTreeWithTextPosition)
{
    ...
    TestPositionType text_position = AXNodePosition::CreateTextPosition(views_tree_id, window.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ...
    text_position = CreateTextPosition(*views_tree->GetFromId(window.id), 4 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ...
    text_position = CreateTextPosition(*views_tree->GetFromId(back_button.id), 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    test_position = text_position->CreatePositionAtStartOfAXTree();
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    ...
    text_position = CreateTextPosition(*views_tree->GetFromId(back_button.id), 4 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    test_position = text_position->CreatePositionAtStartOfAXTree();
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    ...
    text_position = CreateTextPosition(*views_tree->GetFromId(web_view.id), 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    test_position = text_position->CreatePositionAtStartOfAXTree();
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    ...
    text_position = CreateTextPosition(*views_tree->GetFromId(web_view.id), 1 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    test_position = text_position->CreatePositionAtStartOfAXTree();
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    ...
    text_position = CreateTextPosition(*webpage_tree->GetFromId(root_web_area.id), 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    test_position = text_position->CreatePositionAtStartOfAXTree();
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    ...
    text_position = CreateTextPosition(*webpage_tree->GetFromId(root_web_area.id), 1 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    test_position = text_position->CreatePositionAtStartOfAXTree();
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    ...
    text_position = CreateTextPosition(*webpage_tree->GetFromId(paragraph.id), 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    test_position = text_position->CreatePositionAtStartOfAXTree();
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    ...
    text_position = CreateTextPosition(*webpage_tree->GetFromId(paragraph.id), 12 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    test_position = text_position->CreatePositionAtStartOfAXTree();
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    ...
    text_position = CreateTextPosition(*iframe_tree->GetFromId(iframe_root.id), 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    test_position = text_position->CreatePositionAtStartOfAXTree();
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    ...
    text_position = CreateTextPosition(*iframe_tree->GetFromId(iframe_root.id), 13 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    test_position = text_position->CreatePositionAtStartOfAXTree();
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
...
TEST_F(AXPositionTest, CreatePositionAtEndOfAXTreeWithTextPosition)
{
    ...
    TestPositionType text_position = CreateTextPosition(*views_tree->GetFromId(window.id), 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
...
TEST_F(AXPositionTest, CreatePositionAtEndOfContentWithTextPosition)
{
    ...
    text_position = CreateTextPosition(*webpage_tree->GetFromId(root_web_area.id), 12 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    test_position = text_position->CreatePositionAtEndOfContent();
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
...
{
    TestPositionType tree_position = AXNodePosition::CreateTreePosition(*ax_tree(), GetRootNode(), 2 /* child_index */);
    ASSERT_NE(nullptr, tree_position);
    ...
    tree_position = AXNodePosition::CreateTreePosition(*ax_tree(), GetButtonNode(), 0 /* child_index */);
    ASSERT_NE(nullptr, tree_position);
...
{
    TestPositionType text_position = CreateTextPosition(static_text1_.id, 5 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    ...
    text_position = CreateTextPosition(static_text2_.id, 4 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
...
{
    TestPositionType tree_position = AXNodePosition::CreateTreePosition(*ax_tree(), GetCheckBoxNode(), AXNodePosition::BEFORE_TEXT /* child_index */);
    ASSERT_NE(nullptr, tree_position);
    ...
    tree_position = AXNodePosition::CreateTreePosition(GetTreeID(), check_box_.id, 0 /* child_index */);
    ASSERT_NE(nullptr, tree_position);
    ...
    tree_position = AXNodePosition::CreateTreePosition(*ax_tree(), GetInlineBox2Node(), AXNodePosition::BEFORE_TEXT /* child_index */);
    ASSERT_NE(nullptr, tree_position);
    ASSERT_TRUE(tree_position->IsTreePosition());
    ...
    tree_position = AXNodePosition::CreateTreePosition(*ax_tree(), GetInlineBox2Node(), 0 /* child_index */);
    ASSERT_NE(nullptr, tree_position);
    ASSERT_TRUE(tree_position->IsTreePosition());
...
TEST_F(AXPositionTest, CreateParentPositionWithTextPosition)
{
    // Create a position that points at the end of the first line, right after the
    // check box.
    TestPositionType text_position = CreateTextPosition(check_box_.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    ...
    text_position = CreateTextPosition(root_.id, 2 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
...
TEST_F(AXPositionTest, CreateParentPositionWithMoveDirection)
{
    ...
    TestPositionType tree_position = AXNodePosition::CreateTreePosition(*ax_tree(), *inline_box_4_node, AXNodePosition::BEFORE_TEXT /* child_index */);
    ASSERT_NE(nullptr, tree_position);
    ...
    tree_position = AXNodePosition::CreateTreePosition(*ax_tree(), *inline_box_4_node, AXNodePosition::BEFORE_TEXT /* child_index */);
    ASSERT_NE(nullptr, tree_position);
    ...
    tree_position = AXNodePosition::CreateTreePosition(*ax_tree(), *inline_box_4_node, 0 /* child_index */);
    ASSERT_NE(nullptr, tree_position);
    ...
    tree_position = AXNodePosition::CreateTreePosition(*ax_tree(), *inline_box_7_node, 0 /* child_index */);
    ASSERT_NE(nullptr, tree_position);
    ancestor_position = tree_position->CreateAncestorPosition(GetRoot(), ax::mojom::MoveDirection::kForward);
    ASSERT_NE(nullptr, ancestor_position);
    EXPECT_TRUE(ancestor_position->IsTreePosition());
    ...
    // Find the equivalent position on the root, when the original position is
    // before "Hello", with a backward direction.
    text_position = CreateTextPosition(inline_box_4.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
...
TEST_F(AXPositionTest, CreateParentAndLeafPositionWithIgnoredNodes)
{
    ...
    SetTree(CreateAXTree({ root, generic_container_ignored, static_text_1, inline_box_1, static_text_ignored_1, inline_box_ignored_1, static_text_ignored_2, inline_box_ignored_2,
        static_text_2, inline_box_2 }));

    AXNode* inline_box_ignored_1_node = ax_tree()->GetFromId(inline_box_ignored_1.id);
    AXNode* inline_box_ignored_2_node = ax_tree()->GetFromId(inline_box_ignored_2.id);
    ...
    TestPositionType middle_root = CreateTextPosition(root.id, 5 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_FALSE(middle_root->IsNullPosition());

    // "Hello<W>orld"
    // At the start of the second line before "World".
    TestPositionType middle_root_upstream = CreateTextPosition(root.id, 5 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ...
    TestPositionType after_root = CreateTextPosition(root.id, 10 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_FALSE(after_root->IsNullPosition());

    // "<H>ello"
    TestPositionType before_inline_box_1 = CreateTextPosition(inline_box_1.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_FALSE(before_inline_box_1->IsNullPosition());
    // "Hello<>"
    TestPositionType after_inline_box_1 = CreateTextPosition(inline_box_1.id, 5 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_FALSE(after_inline_box_1->IsNullPosition());

    // "<I>gnored1"
    TestPositionType before_inline_box_ignored_1 = CreateTextPosition(inline_box_ignored_1.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_FALSE(before_inline_box_ignored_1->IsNullPosition());
    ASSERT_TRUE(before_inline_box_ignored_1->IsIgnored());

    TestPositionType before_inline_box_ignored_1_tree = AXNodePosition::CreateTreePosition(*ax_tree(), *inline_box_ignored_1_node, AXNodePosition::BEFORE_TEXT /* child_index */);
    ASSERT_FALSE(before_inline_box_ignored_1_tree->IsNullPosition());
    ASSERT_TRUE(before_inline_box_ignored_1_tree->IsIgnored());
    TestPositionType after_inline_box_ignored_1_tree = AXNodePosition::CreateTreePosition(*ax_tree(), *inline_box_ignored_1_node, 0 /* child_index */);
    ASSERT_FALSE(after_inline_box_ignored_1_tree->IsNullPosition());
    ASSERT_TRUE(after_inline_box_ignored_1_tree->IsIgnored());

    // "<I>gnored2"
    TestPositionType before_inline_box_ignored_2 = CreateTextPosition(inline_box_ignored_2.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_FALSE(before_inline_box_ignored_2->IsNullPosition());
    ASSERT_TRUE(before_inline_box_ignored_2->IsIgnored());

    TestPositionType before_inline_box_ignored_2_tree = AXNodePosition::CreateTreePosition(*ax_tree(), *inline_box_ignored_2_node, AXNodePosition::BEFORE_TEXT /* child_index */);
    ASSERT_FALSE(before_inline_box_ignored_2_tree->IsNullPosition());
    ASSERT_TRUE(before_inline_box_ignored_2_tree->IsIgnored());
    TestPositionType after_inline_box_ignored_2_tree = AXNodePosition::CreateTreePosition(*ax_tree(), *inline_box_ignored_2_node, 0 /* child_index */);
    ASSERT_FALSE(after_inline_box_ignored_2_tree->IsNullPosition());
    ASSERT_TRUE(after_inline_box_ignored_2_tree->IsIgnored());

    // "<W>orld"
    TestPositionType before_inline_box_2 = CreateTextPosition(inline_box_2.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_FALSE(before_inline_box_2->IsNullPosition());
    // "World<>"
    TestPositionType after_inline_box_2 = CreateTextPosition(inline_box_2.id, 5 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
...
TEST_F(AXPositionTest, CreateParentAndLeafPositionWithEmptyNodes)
{
    ...
    TestPositionType before_inline_box_empty = CreateTextPosition(inline_box_empty.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_FALSE(before_inline_box_empty->IsNullPosition());

    TestPositionType before_inline_box_empty_tree = AXNodePosition::CreateTreePosition(*ax_tree(), *inline_box_empty_node, AXNodePosition::BEFORE_TEXT /* child_index */);
    ASSERT_FALSE(before_inline_box_empty_tree->IsNullPosition());
    TestPositionType after_inline_box_empty_tree = AXNodePosition::CreateTreePosition(*ax_tree(), *inline_box_empty_node, 0 /* child_index */);
    ASSERT_FALSE(after_inline_box_empty_tree->IsNullPosition());

    TestPositionType before_button_empty = CreateTextPosition(button_empty.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_FALSE(before_button_empty->IsNullPosition());

    TestPositionType before_button_empty_tree = AXNodePosition::CreateTreePosition(*ax_tree(), *button_empty_node, AXNodePosition::BEFORE_TEXT /* child_index */);
    ASSERT_FALSE(before_button_empty_tree->IsNullPosition());
    TestPositionType after_button_empty_tree = AXNodePosition::CreateTreePosition(*ax_tree(), *button_empty_node, 0 /* child_index */);
...
TEST_F(AXPositionTest, CreateParentAndLeafPositionWithEmbeddedObjects)
{
    ...
    // affinity).
    TestPositionType middle_root = CreateTextPosition(root.id, AXNode::kEmbeddedObjectCharacterLengthUTF16 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_FALSE(middle_root->IsNullPosition());
    TestPositionType middle_root_upstream = CreateTextPosition(root.id, AXNode::kEmbeddedObjectCharacterLengthUTF16 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ASSERT_FALSE(middle_root_upstream->IsNullPosition());

    // The root has 7 characters: two embedded objects and the word "Hello".
    TestPositionType after_root = CreateTextPosition(root.id, 7 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_FALSE(after_root->IsNullPosition());
    ...
    ASSERT_FALSE(before_inline_box_1->IsNullPosition());
    // "Paragraph<>"
    TestPositionType after_inline_box_1 = CreateTextPosition(inline_box_1.id, 9 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_FALSE(after_inline_box_1->IsNullPosition());

    TestPositionType after_inline_box_1_tree = AXNodePosition::CreateTreePosition(*ax_tree(), *inline_box_1_node, 0 /* child_index */);
    ...
    TestPositionType before_inline_box_2_tree = AXNodePosition::CreateTreePosition(*ax_tree(), *inline_box_2_node, AXNodePosition::BEFORE_TEXT /* child_index */);
    ASSERT_FALSE(before_inline_box_2_tree->IsNullPosition());
    TestPositionType after_inline_box_2_tree = AXNodePosition::CreateTreePosition(*ax_tree(), *inline_box_2_node, 0 /* child_index */);
...
{
    TestPositionType check_box_position = AXNodePosition::CreateTreePosition(*ax_tree(), GetRootNode(), 1 /* child_index */);
    ...
    TestPositionType root_position = CreateTextPosition(root_.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, root_position);
    ...
    TestPositionType text_field_position = AXNodePosition::CreateTreePosition(*ax_tree(), GetRootNode(), 2 /* child_index */);
    ASSERT_NE(nullptr, text_field_position);
    ...
    TestPositionType root_position2 = CreateTextPosition(root_.id, 10 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
...
{
    TestPositionType text_position = CreateTextPosition(inline_box2_.id, 5 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    ...
    TestPositionType before_text_position = AXNodePosition::CreateTreePosition(*ax_tree(), GetInlineBox2Node(), AXNodePosition::BEFORE_TEXT);
    ...
    // box.
    TestPositionType check_box_position = CreateTextPosition(check_box_.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, check_box_position);
...
{
    TestPositionType root_position = AXNodePosition::CreateTreePosition(*ax_tree(), GetRootNode(), 0 /* child_index */);
    ASSERT_TRUE(root_position->IsTreePosition());

    TestPositionType button_position = AXNodePosition::CreateTreePosition(*ax_tree(), GetButtonNode(), AXNodePosition::BEFORE_TEXT);
    TestPositionType checkbox_position = AXNodePosition::CreateTreePosition(*ax_tree(), GetCheckBoxNode(), AXNodePosition::BEFORE_TEXT);
    TestPositionType inline_box1_position = AXNodePosition::CreateTreePosition(*ax_tree(), GetInlineBox1Node(), AXNodePosition::BEFORE_TEXT);
    TestPositionType line_break_position = AXNodePosition::CreateTreePosition(*ax_tree(), GetLineBreakNode(), AXNodePosition::BEFORE_TEXT);
    TestPositionType inline_box2_position = AXNodePosition::CreateTreePosition(*ax_tree(), GetInlineBox2Node(), AXNodePosition::BEFORE_TEXT);
    ...
    TestPositionType root_text_position = CreateTextPosition(root_.id, 2 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ...
    TestPositionType inline_box1_text_position = CreateTextPosition(inline_box1_.id, 2 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
...
TEST_F(AXPositionTest, CreatePreviousLeafTreePosition)
{
    ...
    TestPositionType inline_box2_text_position = CreateTextPosition(inline_box2_.id, 2 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
...
TEST_F(AXPositionTest, DISABLED_AsLeafTextPositionBeforeAndAfterCharacterWithInvalidPosition)
{
    ...
    TestPositionType text_position = CreateTextPosition(text_data.id, 9 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    EXPECT_TRUE(text_position->IsTextPosition());
...
TEST_F(AXPositionTest, AsLeafTextPositionBeforeAndAfterCharacterAtInvalidGraphemeBoundary)
{
    ...
    test_position = CreateTextPosition(GetTree()->root()->id(), 10 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
...
TEST_F(AXPositionTest, AsLeafTextPositionBeforeCharacterNoAdjustment)
{
    ...
    TestPositionType text_position = CreateTextPosition(root_.id, 6 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    ...
    text_position = CreateTextPosition(static_text1_.id, 6 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    test_position = text_position->AsLeafTextPositionBeforeCharacter();
    EXPECT_NE(nullptr, test_position);
...
TEST_F(AXPositionTest, AsLeafTextPositionAfterCharacterNoAdjustment)
{
    ...
    text_position = CreateTextPosition(root_.id, 7 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
...
{
    TestPositionType text_position = CreateTextPosition(inline_box1_.id, 3 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    TestPositionType test_position = text_position->AsLeafTextPositionBeforeCharacter();
    EXPECT_NE(nullptr, test_position);
    ...
    text_position = CreateTextPosition(inline_box2_.id, 6 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    test_position = text_position->AsLeafTextPositionBeforeCharacter();
    EXPECT_NE(nullptr, test_position);
    ...
    text_position = CreateTextPosition(root_.id, 13 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    test_position = text_position->AsLeafTextPositionBeforeCharacter();
    EXPECT_NE(nullptr, test_position);
...
TEST_F(AXPositionTest, AsLeafTextPositionAfterCharacter)
{
    ...
    text_position = CreateTextPosition(inline_box1_.id, 5 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    test_position = text_position->AsLeafTextPositionAfterCharacter();
    EXPECT_NE(nullptr, test_position);
    ...
    text_position = CreateTextPosition(line_break_.id, 1 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    test_position = text_position->AsLeafTextPositionAfterCharacter();
    EXPECT_NE(nullptr, test_position);
...
TEST_F(AXPositionTest, CreateNextAndPreviousCharacterPositionWithNullPosition)
{
    TestPositionType null_position = AXNodePosition::CreateNullPosition();
    ASSERT_NE(nullptr, null_position);
    TestPositionType test_position = null_position->CreateNextCharacterPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsNullPosition());
...
TEST_F(AXPositionTest, AsValidPosition)
{
    ...
    TestPositionType test_position = text_position->CreateNextCharacterPosition({ AXBoundaryBehavior::kStopAtAnchorBoundary, AXBoundaryDetection::kCheckInitialPosition });
...
TEST_F(AXPositionTest, AsValidPositionInDescendantOfEmptyObject)
{
    ...
    TestPositionType text_position = CreateTextPosition(inline_box_4.id, 3, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    EXPECT_TRUE(text_position->IsTextPosition());
    EXPECT_TRUE(text_position->IsValid());
    ...
    TestPositionType tree_position = AXNodePosition::CreateTreePosition(GetTreeID(), inline_box_4.id, 0);
...
{
    TestPositionType text_position = CreateTextPosition(inline_box1_.id, 4 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    ...
    EXPECT_EQ(inline_box1_.id, test_position->anchor_id());
    EXPECT_EQ(5, test_position->text_offset());
    test_position = text_position->CreateNextCharacterPosition({ AXBoundaryBehavior::kStopAtLastAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    EXPECT_EQ(inline_box1_.id, test_position->anchor_id());
    EXPECT_EQ(5, test_position->text_offset());
    ...
    text_position = CreateTextPosition(text_field_.id, 12 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
...
TEST_F(AXPositionTest, CreatePreviousCharacterPosition)
{
    ...
    TestPositionType test_position = text_position->CreatePreviousCharacterPosition({ AXBoundaryBehavior::kStopAtAnchorBoundary, AXBoundaryDetection::kCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    EXPECT_EQ(inline_box2_.id, test_position->anchor_id());
    EXPECT_EQ(5, test_position->text_offset());
    ...
    EXPECT_EQ(inline_box2_.id, test_position->anchor_id());
    EXPECT_EQ(4, test_position->text_offset());
    test_position = text_position->CreatePreviousCharacterPosition({ AXBoundaryBehavior::kStopAtAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    EXPECT_EQ(inline_box2_.id, test_position->anchor_id());
    EXPECT_EQ(4, test_position->text_offset());
    test_position = text_position->CreatePreviousCharacterPosition({ AXBoundaryBehavior::kStopAtLastAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    EXPECT_EQ(inline_box2_.id, test_position->anchor_id());
    EXPECT_EQ(4, test_position->text_offset());
    ...
    text_position = CreateTextPosition(text_field_.id, 1 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
...
TEST_F(AXPositionTest, CreateNextCharacterPositionAtGraphemeBoundary)
{
    ...
    TestPositionType test_position = CreateTextPosition(GetTree()->root()->id(), 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, test_position);
    ...
    test_position = CreateTextPosition(GetTree()->root()->id(), 3 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ...
    test_position = CreateTextPosition(GetTree()->root()->id(), 4 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    test_position = test_position->CreateNextCharacterPosition({ AXBoundaryBehavior::kStopAtAnchorBoundary, AXBoundaryDetection::kCheckInitialPosition });
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    EXPECT_EQ(GetTree()->root()->id(), test_position->anchor_id());
    ...
    test_position = CreateTextPosition(GetTree()->root()->id(), 9 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    test_position = test_position->CreateNextCharacterPosition({ AXBoundaryBehavior::kStopAtAnchorBoundary, AXBoundaryDetection::kCheckInitialPosition });
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    EXPECT_EQ(GetTree()->root()->id(), test_position->anchor_id());
...
TEST_F(AXPositionTest, CreatePreviousCharacterPositionAtGraphemeBoundary)
{
    ...
    TestPositionType test_position = CreateTextPosition(GetTree()->root()->id(), text_offsets.back() /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, test_position);
    ASSERT_TRUE(test_position->IsTextPosition());
...
TEST_F(AXPositionTest, ReciprocalCreateNextAndPreviousCharacterPosition)
{
    ...
    while (!text_position->IsNullPosition()) {
        TestPositionType moved_position = text_position->CreateNextCharacterPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    ...
    tree_position = AXNodePosition::CreateTreePosition(*ax_tree(), GetRootNode(), root_.child_ids.size() /* child_index */);
    ...
    while (!text_position->IsNullPosition()) {
        TestPositionType moved_position = text_position->CreatePreviousCharacterPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
        ASSERT_NE(nullptr, moved_position);
...
TEST_F(AXPositionTest, CreateNextAndPreviousWordStartPositionWithNullPosition)
{
    TestPositionType null_position = AXNodePosition::CreateNullPosition();
    ASSERT_NE(nullptr, null_position);
    TestPositionType test_position = null_position->CreateNextWordStartPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsNullPosition());
...
TEST_F(AXPositionTest, CreateNextAndPreviousWordEndPositionWithNullPosition)
{
    TestPositionType null_position = AXNodePosition::CreateNullPosition();
    ASSERT_NE(nullptr, null_position);
    TestPositionType test_position = null_position->CreateNextWordEndPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsNullPosition());
...
TEST_F(AXPositionTest, OperatorEquals)
{
    ...
    TestPositionType button_position1 = AXNodePosition::CreateTreePosition(*ax_tree(), GetRootNode(), 0 /* child_index */);
    ASSERT_NE(nullptr, button_position1);
    TestPositionType button_position2 = AXNodePosition::CreateTreePosition(*ax_tree(), GetRootNode(), 0 /* child_index */);
    ...
    // position.
    TestPositionType tree_position1 = AXNodePosition::CreateTreePosition(*ax_tree(), GetRootNode(), 3 /* child_index */);
    ...
    tree_position1 = AXNodePosition::CreateTreePosition(*ax_tree(), GetTextFieldNode(), 3 /* child_index */);
    ASSERT_NE(nullptr, tree_position1);
    tree_position2 = AXNodePosition::CreateTreePosition(*ax_tree(), GetTextFieldNode(), 3 /* child_index */);
    ASSERT_NE(nullptr, tree_position2);
    EXPECT_EQ(*tree_position1, *tree_position2);

    // Two "before text" positions on the same node should be equivalent.
    tree_position1 = AXNodePosition::CreateTreePosition(*ax_tree(), GetInlineBox1Node(), AXNodePosition::BEFORE_TEXT);
    ASSERT_NE(nullptr, tree_position1);
    tree_position2 = AXNodePosition::CreateTreePosition(*ax_tree(), GetInlineBox1Node(), AXNodePosition::BEFORE_TEXT);
    ASSERT_NE(nullptr, tree_position2);
    EXPECT_EQ(*tree_position1, *tree_position2);
    ...
    TestPositionType text_position1 = CreateTextPosition(inline_box1_.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position1);
    ASSERT_TRUE(text_position1->IsTextPosition());
    TestPositionType text_position2 = CreateTextPosition(inline_box1_.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position2);
    ASSERT_TRUE(text_position2->IsTextPosition());
    EXPECT_EQ(*text_position1, *text_position2);

    text_position2 = CreateTextPosition(inline_box1_.id, 0 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ASSERT_NE(nullptr, text_position2);
    ASSERT_TRUE(text_position2->IsTextPosition());
    EXPECT_GT(*text_position1, *text_position2);

    // Text offsets should match.
    text_position1 = CreateTextPosition(inline_box1_.id, 5 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ASSERT_NE(nullptr, text_position1);
    ASSERT_TRUE(text_position1->IsTextPosition());
    EXPECT_NE(*text_position1, *text_position2);

    // Two "after text" positions on the same node should be equivalent.
    text_position1 = CreateTextPosition(line_break_.id, 1 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ASSERT_NE(nullptr, text_position1);
    ASSERT_TRUE(text_position1->IsTextPosition());
    text_position2 = CreateTextPosition(line_break_.id, 1 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ASSERT_NE(nullptr, text_position2);
    ASSERT_TRUE(text_position2->IsTextPosition());
    EXPECT_EQ(*text_position1, *text_position2);
    ...
    text_position1 = CreateTextPosition(static_text1_.id, 6 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position1);
    ASSERT_TRUE(text_position1->IsTextPosition());
    text_position2 = CreateTextPosition(inline_box1_.id, 6 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position2);
    ASSERT_TRUE(text_position2->IsTextPosition());
    EXPECT_EQ(*text_position1, *text_position2);

    // ...and at the end of the document.
    text_position1 = CreateTextPosition(static_text2_.id, 6 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position1);
    ASSERT_TRUE(text_position1->IsTextPosition());
    text_position2 = CreateTextPosition(inline_box2_.id, 6 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position2);
    ASSERT_TRUE(text_position2->IsTextPosition());
...
{
    TestPositionType text_position_one = CreateTextPosition(root_.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position_one);
    ASSERT_TRUE(text_position_one->IsTextPosition());

    TestPositionType text_position_two = CreateTextPosition(root_.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
...
TEST_F(AXPositionTest, OperatorEqualsSameTextOffsetDifferentAnchorIdRoot)
{
    ...
    TestPositionType text_position_two = CreateTextPosition(check_box_.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position_two);
    ASSERT_TRUE(text_position_two->IsTextPosition());
...
{
    TestPositionType text_position_one = CreateTextPosition(button_.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position_one);
    ASSERT_TRUE(text_position_one->IsTextPosition());
...
TEST_F(AXPositionTest, OperatorEqualsTextPositionsInTextField)
{
    ...
    TestPositionType inline_text_position = CreateTextPosition(inline_box_5.id, 4 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, inline_text_position);

    // TextPosition anchor_id=2 anchor_role=textField text_offset=4
    // annotated_text=hell<o>
    TestPositionType text_field_position = CreateTextPosition(text_field_2.id, 4 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_field_position);
...
TEST_F(AXPositionTest, OperatorEqualsTextPositionsInSearchBox)
{
    ...
    SetTree(CreateAXTree({ root_1, search_box_2, generic_container_3, generic_container_4, static_text_5, inline_box_6, button_7, static_text_8, inline_box_9 }));

    // TextPosition anchor_role=inlineTextBox_6 text_offset=5
    // annotated_text=hello<>
    TestPositionType inline_text_position = CreateTextPosition(inline_box_6.id, 5 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, inline_text_position);

    // TextPosition anchor_role=search_box_2 text_offset=5 annotated_text=hello<>
    TestPositionType search_box_position = CreateTextPosition(search_box_2.id, 5 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ...
    TestPositionType static_text_position = CreateTextPosition(static_text_8.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, static_text_position);

    // TextPosition anchor_role=button_7 text_offset=0 annotated_text=<X>
    TestPositionType button_position = CreateTextPosition(button_7.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, button_position);
...
TEST_F(AXPositionTest, OperatorsTreePositionsAroundEmbeddedCharacter)
{
    ...
    TestPositionType before_root_1 = AXNodePosition::CreateTreePosition(*ax_tree(), *root_1_node, 0 /* child_index */);
    ASSERT_NE(nullptr, before_root_1);
    TestPositionType middle_root_1 = AXNodePosition::CreateTreePosition(*ax_tree(), *root_1_node, 1 /* child_index */);
    ASSERT_NE(nullptr, middle_root_1);
    TestPositionType after_root_1 = AXNodePosition::CreateTreePosition(*ax_tree(), *root_1_node, 2 /* child_index */);
    ASSERT_NE(nullptr, after_root_1);

    TestPositionType before_paragraph_2 = AXNodePosition::CreateTreePosition(*ax_tree(), *paragraph_2_node, 0 /* child_index */);
    ASSERT_NE(nullptr, before_paragraph_2);
    TestPositionType after_paragraph_2 = AXNodePosition::CreateTreePosition(*ax_tree(), *paragraph_2_node, 1 /* child_index */);
    ASSERT_NE(nullptr, after_paragraph_2);

    TestPositionType before_paragraph_6 = AXNodePosition::CreateTreePosition(*ax_tree(), *paragraph_6_node, 0 /* child_index */);
    ASSERT_NE(nullptr, before_paragraph_6);
    TestPositionType after_paragraph_6 = AXNodePosition::CreateTreePosition(*ax_tree(), *paragraph_6_node, 1 /* child_index */);
    ASSERT_NE(nullptr, before_paragraph_6);

    TestPositionType before_inline_box_5 = AXNodePosition::CreateTreePosition(*ax_tree(), *inline_box_5_node, AXNodePosition::BEFORE_TEXT /* child_index */);
    ASSERT_NE(nullptr, before_inline_box_5);
    TestPositionType after_inline_box_5 = AXNodePosition::CreateTreePosition(*ax_tree(), *inline_box_5_node, 0 /* child_index */);
    ASSERT_NE(nullptr, after_inline_box_5);

    TestPositionType before_inline_box_8 = AXNodePosition::CreateTreePosition(*ax_tree(), *inline_box_8_node, AXNodePosition::BEFORE_TEXT /* child_index */);
    ASSERT_NE(nullptr, before_inline_box_8);
    TestPositionType after_inline_box_8 = AXNodePosition::CreateTreePosition(*ax_tree(), *inline_box_8_node, 0 /* child_index */);
...
TEST_F(AXPositionTest, OperatorsTextPositionsAroundEmbeddedCharacter)
{
    ...
    TestPositionType before_root_1 = CreateTextPosition(root_1.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, before_root_1);
    TestPositionType middle_root_1 = CreateTextPosition(root_1.id, 1 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, middle_root_1);
    TestPositionType middle_root_1_upstream = CreateTextPosition(root_1.id, 1 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ASSERT_NE(nullptr, middle_root_1_upstream);
    TestPositionType after_root_1 = CreateTextPosition(root_1.id, 2 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, after_root_1);

    TestPositionType before_paragraph_2 = CreateTextPosition(paragraph_2.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, before_paragraph_2);
    // The first paragraph has a link inside it, so it will only expose a single
    // "embedded object replacement character".
    TestPositionType after_paragraph_2 = CreateTextPosition(paragraph_2.id, 1 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, after_paragraph_2);

    TestPositionType before_paragraph_6 = CreateTextPosition(paragraph_6.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, before_paragraph_6);
    // The second paragraph contains "World".
    TestPositionType after_paragraph_6 = CreateTextPosition(paragraph_6.id, 5 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, before_paragraph_6);

    TestPositionType before_inline_box_5 = CreateTextPosition(inline_box_5.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, before_inline_box_5);
    TestPositionType middle_inline_box_5 = CreateTextPosition(inline_box_5.id, 1 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, middle_inline_box_5);
    // "Hello".
    TestPositionType after_inline_box_5 = CreateTextPosition(inline_box_5.id, 5 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, after_inline_box_5);

    TestPositionType before_inline_box_8 = CreateTextPosition(inline_box_8.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, before_inline_box_8);
    TestPositionType middle_inline_box_8 = CreateTextPosition(inline_box_8.id, 1 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, middle_inline_box_8);
    // "World".
    TestPositionType after_inline_box_8 = CreateTextPosition(inline_box_8.id, 5 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, after_inline_box_8);
...
TEST_F(AXPositionTest, OperatorsLessThanAndGreaterThan)
{
    ...
    TestPositionType button_position1 = AXNodePosition::CreateTreePosition(*ax_tree(), GetRootNode(), 0 /* child_index */);
    ASSERT_NE(nullptr, button_position1);
    TestPositionType button_position2 = AXNodePosition::CreateTreePosition(*ax_tree(), GetRootNode(), 1 /* child_index */);
    ASSERT_NE(nullptr, button_position2);
    EXPECT_LT(*button_position1, *button_position2);
    EXPECT_GT(*button_position2, *button_position1);

    TestPositionType tree_position1 = AXNodePosition::CreateTreePosition(*ax_tree(), GetTextFieldNode(), 2 /* child_index */);
    ASSERT_NE(nullptr, tree_position1);
    // An "after children" position.
    TestPositionType tree_position2 = AXNodePosition::CreateTreePosition(*ax_tree(), GetTextFieldNode(), 3 /* child_index */);
    ASSERT_NE(nullptr, tree_position2);
    ...
    ASSERT_NE(nullptr, tree_position1);
    // An "after text" position.
    tree_position2 = AXNodePosition::CreateTreePosition(*ax_tree(), GetInlineBox1Node(), 0 /* child_index */);
    ASSERT_NE(nullptr, tree_position2);
    EXPECT_LT(*tree_position1, *tree_position2);
    EXPECT_GT(*tree_position2, *tree_position1);

    // Two text positions that share a common anchor.
    TestPositionType text_position1 = CreateTextPosition(inline_box1_.id, 2 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position1);
    ASSERT_TRUE(text_position1->IsTextPosition());
    TestPositionType text_position2 = CreateTextPosition(inline_box1_.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position2);
    ...
    ASSERT_TRUE(text_position1->IsTextPosition());
    // A "before text" position.
    text_position2 = CreateTextPosition(line_break_.id, 0 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ASSERT_NE(nullptr, text_position2);
    ASSERT_TRUE(text_position2->IsTextPosition());
    EXPECT_GT(*text_position1, *text_position2);
    EXPECT_LT(*text_position2, *text_position1);
    ...
    text_position1 = CreateTextPosition(text_field_.id, 6 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position1);
    ASSERT_TRUE(text_position1->IsTextPosition());
    text_position2 = CreateTextPosition(inline_box1_.id, 5 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position2);
    ASSERT_TRUE(text_position2->IsTextPosition());
    EXPECT_GT(*text_position1, *text_position2);
    EXPECT_LT(*text_position2, *text_position1);
    ...
    text_position1 = CreateTextPosition(inline_box2_.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position1);
    ASSERT_TRUE(text_position1->IsTextPosition());
    text_position2 = CreateTextPosition(line_break_.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position2);
    ASSERT_TRUE(text_position2->IsTextPosition());
    EXPECT_GT(*text_position1, *text_position2);
    EXPECT_LT(*text_position2, *text_position1);
    ...
    text_position2 = CreateTextPosition(line_break_.id, 1 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position2);
    ASSERT_TRUE(text_position2->IsTextPosition());
    EXPECT_GT(*text_position1, *text_position2);
    EXPECT_LT(*text_position2, *text_position1);
    ...
    text_position1 = CreateTextPosition(inline_box2_.id, 6 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position1);
    ASSERT_TRUE(text_position1->IsTextPosition());
    // Validate that we're actually at the end of the whole content by normalizing
    // to the equivalent "before character" position.
    ...
    text_position2 = CreateTextPosition(static_text2_.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position2);
    ASSERT_TRUE(text_position2->IsTextPosition());
    EXPECT_GT(*text_position1, *text_position2);
    EXPECT_LT(*text_position2, *text_position1);
...
TEST_F(AXPositionTest, Swap)
{
    ...
    TestPositionType tree_position1 = AXNodePosition::CreateTreePosition(*ax_tree(), GetRootNode(), 2 /* child_index */);
    ASSERT_NE(nullptr, tree_position1);
    TestPositionType tree_position2 = AXNodePosition::CreateTreePosition(*ax_tree(), GetTextFieldNode(), 3 /* child_index */);
    ASSERT_NE(nullptr, tree_position2);
    ...
    TestPositionType text_position = CreateTextPosition(line_break_.id, 1 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
...
TEST_F(AXPositionTest, CreateNextAnchorPosition)
{
    ...
    // empty text field.
    TestPositionType text_position1 = CreateTextPosition(text_data.id, 8 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position1);
...
TEST_F(AXPositionTest, CreateLinePositionsMultipleAnchorsInSingleLine)
{
    ...
    TestPositionType text_position = CreateTextPosition(inline_block.id, 3 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
...
TEST_F(AXPositionTest, CreateNextWordPositionInList)
{
    ...
    SetTree(CreateAXTree({ root, list, list_item1, list_marker1, static_text1, inline_box1, static_text2, inline_box2, list_item2, list_marker2, static_text3, inline_box3,
        static_text4, inline_box4 }));

    TestPositionType text_position = CreateTextPosition(inline_box1.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    ...
    // "1. <f>irst item\n2. second item"
    text_position = text_position->CreateNextWordStartPosition({ AXBoundaryBehavior::kStopAtLastAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
...
TEST_F(AXPositionTest, CreatePreviousWordPositionInList)
{
    ...
    TestPositionType text_position = CreateTextPosition(inline_box4.id, 11 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    ASSERT_EQ(inline_box4.id, text_position->anchor_id());
    ...
    // "1. first item\n2. second <i>tem"
    text_position = text_position->CreatePreviousWordStartPosition({ AXBoundaryBehavior::kStopAtLastAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    ASSERT_EQ(inline_box4.id, text_position->anchor_id());
    ASSERT_EQ(7, text_position->text_offset());
...
TEST_F(AXPositionTest, EmptyObjectReplacedByCharacterTextNavigation)
{
    ...
    root_1.role = ax::mojom::Role::kRootWebArea;
    root_1.child_ids = { static_text_2.id, text_field_4.id, static_text_6.id, heading_8.id, generic_container_11.id, generic_container_12.id, static_text_13.id, button_14.id };
    ...
    SetTree(CreateAXTree({ root_1, static_text_2, inline_box_3, text_field_4, generic_container_5, static_text_6, inline_box_7, heading_8, static_text_9, inline_box_10,
        generic_container_11, generic_container_12, static_text_13, button_14, generic_container_15, generic_container_16 }));

    // CreateNextWordStartPosition tests.
    TestPositionType position = CreateTextPosition(inline_box_3.id, 0 /* child_index_or_text_offset */, ax::mojom::TextAffinity::kDownstream);

    TestPositionType result_position = position->CreateNextWordStartPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    ...
    position = CreateTextPosition(generic_container_5.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ...
    position = CreateTextPosition(root_1.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ...
    // replacement character".
    position = CreateTextPosition(text_field_4.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ...
    TestPositionType text_position = CreateTextPosition(generic_container_12.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ...
    text_position = CreateTextPosition(static_text_13.id, 3 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);

    text_position = text_position->CreateNextParagraphEndPosition({ AXBoundaryBehavior::kStopAtLastAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    ASSERT_NE(nullptr, text_position);
    ...
    TestPositionType generic_container_position = AXNodePosition::CreateTreePosition(GetTreeID(), generic_container_16.id, AXNodePosition::BEFORE_TEXT);
...
TEST_F(AXPositionTest, EmptyObjectReplacedByCharacterEmbedObject)
{
    ...
    // empty object.
    TestPositionType tree_position = AXNodePosition::CreateTreePosition(*ax_tree(), *embed_object_node, 0 /* child_index */);
    ASSERT_TRUE(tree_position->IsTreePosition());
...
TEST_F(AXPositionTest, TextNavigationWithCollapsedCombobox)
{
    ...
    TestPositionType position = CreateTextPosition(inline_box_3.id, 0, ax::mojom::TextAffinity::kDownstream);
    ...
    position = CreateTextPosition(inline_box_8.id, 4, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, position);
    ...
    position = CreateTextPosition(inline_box_3.id, 0, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, position);
...
TEST_F(AXPositionTest, GetUnignoredSelectionWithLeafNodes)
{
    ...
    TestPositionType parent_at_0 = AXNodePosition::CreateTreePosition(GetTreeID(), parent_data.id, 0);
    TestPositionType parent_at_1 = AXNodePosition::CreateTreePosition(GetTreeID(), parent_data.id, 1);
    TestPositionType parent_at_2 = AXNodePosition::CreateTreePosition(GetTreeID(), parent_data.id, 2);
    TestPositionType child_1_at_0 = AXNodePosition::CreateTreePosition(GetTreeID(), child_1_data.id, 0);
    TestPositionType child_2_at_before_text = AXNodePosition::CreateTreePosition(GetTreeID(), child_2_data.id, AXNodePosition::BEFORE_TEXT);
    ...
    TestPositionType parent_at_before_text = AXNodePosition::CreateTreePosition(GetTreeID(), parent_data.id, AXNodePosition::BEFORE_TEXT);
...
TEST_P(AXPositionExpandToEnclosingTextBoundaryTestWithParam, TextPositionBeforeLine2)
{
    ...
    TestPositionType text_position = CreateTextPosition(text_field_.id, 7 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_TRUE(text_position->IsTextPosition());
...
{
    TestPositionType text_position = CreateTextPosition(static_text2_.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_TRUE(text_position->IsTextPosition());
...
INSTANTIATE_TEST_SUITE_P(CreateNextSentenceStartPositionWithBoundaryBehaviorStopAtLastAnchorBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(
        TextNavigationTestParam {
            base::BindRepeating([](const TestPositionType& position) {
                return position->CreateNextSentenceStartPosition({ AXBoundaryBehavior::kStopAtLastAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
            }),
            ROOT_ID, 0 /* text_offset */,
            { "TextPosition anchor_id=1 text_offset=7 "
              "affinity=downstream annotated_text=Line 1\n<L>ine 2",
...
INSTANTIATE_TEST_SUITE_P(CreatePreviousSentenceStartPositionWithBoundaryBehaviorStopAtAnchorBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(
        TextNavigationTestParam {
            base::BindRepeating([](const TestPositionType& position) {
                return position->CreatePreviousSentenceStartPosition({ AXBoundaryBehavior::kStopAtAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
            }),
            ROOT_ID, 13 /* text_offset at end of root. */,
            { "TextPosition anchor_id=1 text_offset=7 "
              "affinity=downstream annotated_text=Line 1\n<L>ine 2",
...
INSTANTIATE_TEST_SUITE_P(CreatePreviousSentenceStartPositionWithBoundaryBehaviorStopAtAnchorBoundaryOrIfAlreadyAtBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(
        TextNavigationTestParam {
            base::BindRepeating([](const TestPositionType& position) {
...
INSTANTIATE_TEST_SUITE_P(CreatePreviousSentenceStartPositionWithBoundaryBehaviorStopAtLastAnchorBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(
        TextNavigationTestParam {
            base::BindRepeating([](const TestPositionType& position) {
                return position->CreatePreviousSentenceStartPosition({ AXBoundaryBehavior::kStopAtLastAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
            }),
...
INSTANTIATE_TEST_SUITE_P(CreateNextSentenceEndPositionWithBoundaryBehaviorStopAtLastAnchorBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(
        TextNavigationTestParam {
            base::BindRepeating([](const TestPositionType& position) {
                return position->CreateNextSentenceEndPosition({ AXBoundaryBehavior::kStopAtLastAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
            }),
            ROOT_ID, 0 /* text_offset */,
            { "TextPosition anchor_id=1 text_offset=6 "
              "affinity=downstream annotated_text=Line 1<\n>Line 2",
...
INSTANTIATE_TEST_SUITE_P(CreatePreviousSentenceEndPositionWithBoundaryBehaviorStopAtAnchorBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(
        TextNavigationTestParam {
            base::BindRepeating([](const TestPositionType& position) {
                return position->CreatePreviousSentenceEndPosition({ AXBoundaryBehavior::kStopAtAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
            }),
            ROOT_ID, 13 /* text_offset at end of root. */,
            { "TextPosition anchor_id=1 text_offset=6 "
              "affinity=downstream annotated_text=Line 1<\n>Line 2",
...
INSTANTIATE_TEST_SUITE_P(CreatePreviousSentenceEndPositionWithBoundaryBehaviorStopAtLastAnchorBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(
        TextNavigationTestParam {
            base::BindRepeating([](const TestPositionType& position) {
                return position->CreatePreviousSentenceEndPosition({ AXBoundaryBehavior::kStopAtLastAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
            }),
            ROOT_ID, 13 /* text_offset at end of root. */,
            { "TextPosition anchor_id=1 text_offset=6 "
              "affinity=downstream annotated_text=Line 1<\n>Line 2",
...
INSTANTIATE_TEST_SUITE_P(CreatePreviousWordStartPositionWithBoundaryBehaviorStopAtLastAnchorBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(
        TextNavigationTestParam {
            base::BindRepeating([](const TestPositionType& position) {
                return position->CreatePreviousWordStartPosition({ AXBoundaryBehavior::kStopAtLastAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
            }),
            ROOT_ID, 13 /* text_offset */,
            { "TextPosition anchor_id=1 text_offset=12 "
              "affinity=downstream annotated_text=Line 1\nLine <2>",
...
INSTANTIATE_TEST_SUITE_P(CreatePreviousWordEndPositionWithBoundaryBehaviorStopAtLastAnchorBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(
        TextNavigationTestParam {
            base::BindRepeating([](const TestPositionType& position) {
                return position->CreatePreviousWordEndPosition({ AXBoundaryBehavior::kStopAtLastAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
            }),
            ROOT_ID, 13 /* text_offset at end of root. */,
            { "TextPosition anchor_id=1 text_offset=11 "
              "affinity=downstream annotated_text=Line 1\nLine< >2",
...
INSTANTIATE_TEST_SUITE_P(CreatePreviousLineStartPositionWithBoundaryBehaviorStopAtLastAnchorBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(
        TextNavigationTestParam {
            base::BindRepeating([](const TestPositionType& position) {
                return position->CreatePreviousLineStartPosition({ AXBoundaryBehavior::kStopAtLastAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
            }),
            ROOT_ID, 13 /* text_offset at the end of root. */,
            { "TextPosition anchor_id=1 text_offset=7 "
              "affinity=downstream annotated_text=Line 1\n<L>ine 2",
...
INSTANTIATE_TEST_SUITE_P(CreatePreviousLineEndPositionWithBoundaryBehaviorStopAtLastAnchorBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(
        TextNavigationTestParam {
            base::BindRepeating([](const TestPositionType& position) {
                return position->CreatePreviousLineEndPosition({ AXBoundaryBehavior::kStopAtLastAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
            }),
            ROOT_ID, 13 /* text_offset at end of root. */,
            { "TextPosition anchor_id=1 text_offset=6 "
              "affinity=downstream annotated_text=Line 1<\n>Line 2",
...
INSTANTIATE_TEST_SUITE_P(CreateNextParagraphStartPositionWithBoundaryBehaviorStopAtAnchorBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(
        TextNavigationTestParam {
            base::BindRepeating([](const TestPositionType& position) {
                return position->CreateNextParagraphStartPosition({ AXBoundaryBehavior::kStopAtAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
            }),
            ROOT_ID, 0 /* text_offset */,
            { "TextPosition anchor_id=1 text_offset=7 "
              "affinity=downstream annotated_text=Line 1\n<L>ine 2",
...
INSTANTIATE_TEST_SUITE_P(CreateNextParagraphStartPositionWithBoundaryBehaviorStopAtLastAnchorBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(
        TextNavigationTestParam {
            base::BindRepeating([](const TestPositionType& position) {
                return position->CreateNextParagraphStartPosition({ AXBoundaryBehavior::kStopAtLastAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
            }),
            ROOT_ID, 0 /* text_offset */,
            { "TextPosition anchor_id=1 text_offset=7 "
              "affinity=downstream annotated_text=Line 1\n<L>ine 2",
...
INSTANTIATE_TEST_SUITE_P(CreatePreviousParagraphStartPositionWithBoundaryBehaviorStopAtAnchorBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(
        TextNavigationTestParam {
            base::BindRepeating([](const TestPositionType& position) {
                return position->CreatePreviousParagraphStartPosition({ AXBoundaryBehavior::kStopAtAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
            }),
            ROOT_ID, 13 /* text_offset at the end of root. */,
            { "TextPosition anchor_id=1 text_offset=7 "
              "affinity=downstream annotated_text=Line 1\n<L>ine 2",
...
INSTANTIATE_TEST_SUITE_P(CreatePreviousParagraphStartPositionWithBoundaryBehaviorStopAtAnchorBoundaryOrIfAlreadyAtBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(
        TextNavigationTestParam {
            base::BindRepeating([](const TestPositionType& position) {
                return position->CreatePreviousParagraphStartPosition({ AXBoundaryBehavior::kStopAtAnchorBoundary, AXBoundaryDetection::kCheckInitialPosition });
            }),
...
INSTANTIATE_TEST_SUITE_P(CreatePreviousParagraphStartPositionWithBoundaryBehaviorStopAtLastAnchorBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(
        TextNavigationTestParam {
            base::BindRepeating([](const TestPositionType& position) {
                return position->CreatePreviousParagraphStartPosition({ AXBoundaryBehavior::kStopAtLastAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
            }),
            ROOT_ID, 13 /* text_offset at the end of root. */,
            { "TextPosition anchor_id=1 text_offset=7 "
              "affinity=downstream annotated_text=Line 1\n<L>ine 2",
...
INSTANTIATE_TEST_SUITE_P(CreateNextParagraphEndPositionWithBoundaryBehaviorStopAtLastAnchorBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(
        TextNavigationTestParam {
            base::BindRepeating([](const TestPositionType& position) {
                return position->CreateNextParagraphEndPosition({ AXBoundaryBehavior::kStopAtLastAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
            }),
            ROOT_ID, 0 /* text_offset */,
            { "TextPosition anchor_id=1 text_offset=6 "
              "affinity=downstream annotated_text=Line 1<\n>Line 2",
...
INSTANTIATE_TEST_SUITE_P(CreatePreviousParagraphEndPositionWithBoundaryBehaviorStopAtAnchorBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(
        TextNavigationTestParam {
            base::BindRepeating([](const TestPositionType& position) {
                return position->CreatePreviousParagraphEndPosition({ AXBoundaryBehavior::kStopAtAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
            }),
            ROOT_ID, 13 /* text_offset at end of root. */,
            { "TextPosition anchor_id=1 text_offset=6 "
              "affinity=downstream annotated_text=Line 1<\n>Line 2",
...
INSTANTIATE_TEST_SUITE_P(CreatePreviousParagraphEndPositionWithBoundaryBehaviorStopAtLastAnchorBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(
        TextNavigationTestParam {
            base::BindRepeating([](const TestPositionType& position) {
                return position->CreatePreviousParagraphEndPosition({ AXBoundaryBehavior::kStopAtLastAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
            }),
            ROOT_ID, 13 /* text_offset at end of root. */,
            { "TextPosition anchor_id=1 text_offset=6 "
              "affinity=downstream annotated_text=Line 1<\n>Line 2",
