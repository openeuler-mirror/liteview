...
MATCHER_P(HasAXNodeID, ax_node_data, "") { return arg->id() == ax_node_data.id; }
...
TEST(AXNodeTest, TreeWalking)
{
    ...
    initial_state.nodes = { root, paragraph_0, static_text_0_0_ignored, paragraph_1_ignored, static_text_1_0, paragraph_2, static_text_2_0, paragraph_3_ignored, link_3_0_ignored,
        static_text_3_0_0, button_3_1 };
    ...
    EXPECT_THAT(root_node->GetAllChildren(), ElementsAre(HasAXNodeID(paragraph_0), HasAXNodeID(paragraph_1_ignored), HasAXNodeID(paragraph_2), HasAXNodeID(paragraph_3_ignored)));
    ...
    EXPECT_EQ(static_text_0_0_ignored.id, root_node->GetDeepestFirstChild()->id());
...

    {
        ...
        EXPECT_THAT(siblings, ElementsAre(HasAXNodeID(paragraph_0), HasAXNodeID(paragraph_1_ignored), HasAXNodeID(paragraph_2), HasAXNodeID(paragraph_3_ignored)));
    }

    {
        ...
        EXPECT_THAT(
            siblings, ElementsAre(HasAXNodeID(paragraph_0), HasAXNodeID(static_text_1_0), HasAXNodeID(paragraph_2), HasAXNodeID(static_text_3_0_0), HasAXNodeID(button_3_1)));
    }

    {
        ...
        EXPECT_THAT(siblings, ElementsAre(HasAXNodeID(paragraph_3_ignored), HasAXNodeID(paragraph_2), HasAXNodeID(paragraph_1_ignored), HasAXNodeID(paragraph_0)));
    }

    {
        ...
        EXPECT_THAT(
            siblings, ElementsAre(HasAXNodeID(button_3_1), HasAXNodeID(static_text_3_0_0), HasAXNodeID(paragraph_2), HasAXNodeID(static_text_1_0), HasAXNodeID(paragraph_0)));
    }
...
TEST(AXNodeTest, GetValueForControlTextField)
{
    ...
    rich_text_field_text_container.child_ids = { rich_text_field_line_1.id, rich_text_field_image.id, rich_text_field_line_break.id, rich_text_field_line_2.id };
    ...
    update.nodes = { root, rich_text_field, rich_text_field_text_container, rich_text_field_line_1, rich_text_field_image, rich_text_field_line_break, rich_text_field_line_2 };
...
TEST(AXNodeTest, GetTextContentRangeBounds)
{
    ...
    EXPECT_EQ(gfx::RectF(0, 0, 27, 0), text1_node->GetTextContentRangeBoundsUTF8(0, 3));
    EXPECT_EQ(gfx::RectF(12, 0, 7, 0), text1_node->GetTextContentRangeBoundsUTF8(1, 2));
    ...
    EXPECT_EQ(gfx::RectF(0, 0, 59, 0), text2_node->GetTextContentRangeBoundsUTF8(0, 18));
    EXPECT_EQ(gfx::RectF(0, 0, 19, 0), text2_node->GetTextContentRangeBoundsUTF8(6, 12));
    ...
    EXPECT_EQ(gfx::RectF(0, 0, 0, 85), text3_node->GetTextContentRangeBoundsUTF8(0, 18));
    EXPECT_EQ(gfx::RectF(0, 66, 0, 10), text3_node->GetTextContentRangeBoundsUTF8(6, 12));
