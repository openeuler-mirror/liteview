...
AX_BASE_EXPORT BASE_DECLARE_FEATURE(kExperimentalAccessibilityDictationWithPumpkin);
...
AX_BASE_EXPORT BASE_DECLARE_FEATURE(kExperimentalAccessibilityDictationMoreCommands);
...
AX_BASE_EXPORT BASE_DECLARE_FEATURE(kExperimentalAccessibilityGoogleTtsLanguagePacks);
...
AX_BASE_EXPORT BASE_DECLARE_FEATURE(kExperimentalAccessibilityColorEnhancementSettings);

// Returns true if the experimental color enhancements settings are enabled.
AX_BASE_EXPORT bool AreExperimentalAccessibilityColorEnhancementSettingsEnabled();
