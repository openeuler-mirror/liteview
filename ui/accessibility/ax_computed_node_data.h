...
public:
    ...
    // demand.
    bool HasOrCanComputeAttribute(const ax::mojom::StringAttribute attribute) const;
    bool HasOrCanComputeAttribute(const ax::mojom::IntListAttribute attribute) const;
    ...
    const std::string& GetOrComputeAttributeUTF8(const ax::mojom::StringAttribute attribute) const;
    std::u16string GetOrComputeAttributeUTF16(const ax::mojom::StringAttribute attribute) const;
    const std::vector<int32_t>& GetOrComputeAttribute(const ax::mojom::IntListAttribute attribute) const;
...
private:
    ...
    mutable absl::optional<std::u16string> text_content_with_paragraph_breaks_utf16_;
