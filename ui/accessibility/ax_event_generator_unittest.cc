...
void PrintTo(const AXEventGenerator::TargetedEvent& event, std::ostream* os) { *os << event.event_params.event << " on " << event.node_id; }
    ...
    std::string(negation ? "does not have" : "has") + " " + PrintToString(expected_event_type) + " on " + PrintToString(expected_node_id))
{
    ...
    return Matches(expected_event_type)(event.event_params.event) && Matches(expected_node_id)(event.node_id);
}
...
TEST(AXEventGeneratorTest, SelectedAndSelectedChildren)
{
    ...
    ASSERT_TRUE(tree.Unserialize(update));
    EXPECT_THAT(event_generator,
        UnorderedElementsAre(HasEventAtNode(AXEventGenerator::Event::SELECTED_CHILDREN_CHANGED, 2), HasEventAtNode(AXEventGenerator::Event::SELECTED_CHANGED, 3),
            HasEventAtNode(AXEventGenerator::Event::WIN_IACCESSIBLE_STATE_CHANGED, 3), HasEventAtNode(AXEventGenerator::Event::SELECTED_CHANGED, 4),
            HasEventAtNode(AXEventGenerator::Event::WIN_IACCESSIBLE_STATE_CHANGED, 4)));
}
...
TEST(AXEventGeneratorTest, SelectedAndSelectedValueChanged)
{
    ...
    EXPECT_THAT(event_generator,
        IsSupersetOf({ HasEventAtNode(AXEventGenerator::Event::SELECTED_VALUE_CHANGED, popup_button.id),
            HasEventAtNode(AXEventGenerator::Event::SELECTED_CHANGED, menu_list_option_1.id), HasEventAtNode(AXEventGenerator::Event::SELECTED_CHANGED, menu_list_option_2.id),
            HasEventAtNode(AXEventGenerator::Event::SELECTED_VALUE_CHANGED, list_box.id), HasEventAtNode(AXEventGenerator::Event::SELECTED_CHANGED, list_box_option_1.id),
...

    {
        ...
        EXPECT_THAT(event_generator,
            UnorderedElementsAre(
                HasEventAtNode(AXEventGenerator::Event::DOCUMENT_SELECTION_CHANGED, root.id), HasEventAtNode(AXEventGenerator::Event::TEXT_SELECTION_CHANGED, text_field.id)));
    }
...
TEST(AXEventGeneratorTest, AddLiveRegionAttribute)
{
    ...
    ASSERT_TRUE(tree.Unserialize(update));
    EXPECT_THAT(
        event_generator, UnorderedElementsAre(HasEventAtNode(AXEventGenerator::Event::LIVE_STATUS_CHANGED, 1), HasEventAtNode(AXEventGenerator::Event::LIVE_REGION_CREATED, 1)));
...
TEST(AXEventGeneratorTest, CheckedStateChanged)
{
    ...
    ASSERT_TRUE(tree.Unserialize(update));
    EXPECT_THAT(event_generator,
        UnorderedElementsAre(HasEventAtNode(AXEventGenerator::Event::CHECKED_STATE_CHANGED, 1), HasEventAtNode(AXEventGenerator::Event::WIN_IACCESSIBLE_STATE_CHANGED, 1)));
}
...
TEST(AXEventGeneratorTest, ActiveDescendantChanged)
{
    ...
    ASSERT_TRUE(tree.Unserialize(update));
    EXPECT_THAT(event_generator,
        UnorderedElementsAre(HasEventAtNode(AXEventGenerator::Event::ACTIVE_DESCENDANT_CHANGED, 1), HasEventAtNode(AXEventGenerator::Event::RELATED_NODE_CHANGED, 1)));
}
...
TEST(AXEventGeneratorTest, LiveRegionChanged)
{
    ...
    ASSERT_TRUE(tree.Unserialize(update));
    EXPECT_THAT(event_generator,
        UnorderedElementsAre(HasEventAtNode(AXEventGenerator::Event::LIVE_REGION_CHANGED, 1), HasEventAtNode(AXEventGenerator::Event::LIVE_REGION_NODE_CHANGED, 2),
            HasEventAtNode(AXEventGenerator::Event::LIVE_REGION_NODE_CHANGED, 3), HasEventAtNode(AXEventGenerator::Event::NAME_CHANGED, 2),
...
TEST(AXEventGeneratorTest, LiveRegionOnlyTextChanges)
{
    ...
    ASSERT_TRUE(tree.Unserialize(update));
    EXPECT_THAT(event_generator,
        UnorderedElementsAre(HasEventAtNode(AXEventGenerator::Event::CHECKED_STATE_CHANGED, 3), HasEventAtNode(AXEventGenerator::Event::WIN_IACCESSIBLE_STATE_CHANGED, 3),
...
TEST(AXEventGeneratorTest, BusyLiveRegionChanged)
{
    ...
    ASSERT_TRUE(tree.Unserialize(update));
    EXPECT_THAT(event_generator, UnorderedElementsAre(HasEventAtNode(AXEventGenerator::Event::NAME_CHANGED, 2), HasEventAtNode(AXEventGenerator::Event::NAME_CHANGED, 3)));
}
...
TEST(AXEventGeneratorTest, RemoveAriaLiveOffFromChild)
{
    ...
    ASSERT_TRUE(tree.Unserialize(update));
    EXPECT_THAT(
        event_generator, UnorderedElementsAre(HasEventAtNode(AXEventGenerator::Event::LIVE_STATUS_CHANGED, 2), HasEventAtNode(AXEventGenerator::Event::LIVE_REGION_CREATED, 2)));
}
...
TEST(AXEventGeneratorTest, AddChild)
{
    ...
    ASSERT_TRUE(tree.Unserialize(update));
    EXPECT_THAT(event_generator, UnorderedElementsAre(HasEventAtNode(AXEventGenerator::Event::CHILDREN_CHANGED, 1), HasEventAtNode(AXEventGenerator::Event::SUBTREE_CREATED, 3)));
}
...
TEST(AXEventGeneratorTest, TextAttributeChanged)
{
    ...
    ASSERT_TRUE(tree.Unserialize(update));
    EXPECT_THAT(event_generator,
        UnorderedElementsAre(HasEventAtNode(AXEventGenerator::Event::TEXT_ATTRIBUTE_CHANGED, 4), HasEventAtNode(AXEventGenerator::Event::TEXT_ATTRIBUTE_CHANGED, 5),
            HasEventAtNode(AXEventGenerator::Event::TEXT_ATTRIBUTE_CHANGED, 6), HasEventAtNode(AXEventGenerator::Event::TEXT_ATTRIBUTE_CHANGED, 7),
            HasEventAtNode(AXEventGenerator::Event::TEXT_ATTRIBUTE_CHANGED, 8), HasEventAtNode(AXEventGenerator::Event::TEXT_ATTRIBUTE_CHANGED, 9),
            HasEventAtNode(AXEventGenerator::Event::TEXT_ATTRIBUTE_CHANGED, 10), HasEventAtNode(AXEventGenerator::Event::TEXT_ATTRIBUTE_CHANGED, 11),
            HasEventAtNode(AXEventGenerator::Event::TEXT_ATTRIBUTE_CHANGED, 12), HasEventAtNode(AXEventGenerator::Event::TEXT_ATTRIBUTE_CHANGED, 13),
            HasEventAtNode(AXEventGenerator::Event::TEXT_ATTRIBUTE_CHANGED, 14), HasEventAtNode(AXEventGenerator::Event::TEXT_ATTRIBUTE_CHANGED, 15),
            HasEventAtNode(AXEventGenerator::Event::TEXT_ATTRIBUTE_CHANGED, 16), HasEventAtNode(AXEventGenerator::Event::TEXT_ATTRIBUTE_CHANGED, 17)));
}
...
TEST(AXEventGeneratorTest, OtherAttributeChanged)
{
    ...
    EXPECT_THAT(event_generator,
        UnorderedElementsAre(HasEventAtNode(AXEventGenerator::Event::CONTROLS_CHANGED, 6), HasEventAtNode(AXEventGenerator::Event::LANGUAGE_CHANGED, 2),
            HasEventAtNode(AXEventGenerator::Event::OTHER_ATTRIBUTE_CHANGED, 3), HasEventAtNode(AXEventGenerator::Event::TEXT_ATTRIBUTE_CHANGED, 4),
            HasEventAtNode(AXEventGenerator::Event::OTHER_ATTRIBUTE_CHANGED, 5), HasEventAtNode(AXEventGenerator::Event::RELATED_NODE_CHANGED, 6)));
}
...
TEST(AXEventGeneratorTest, MenuItemSelected)
{
    ...
    ASSERT_TRUE(tree.Unserialize(update));
    EXPECT_THAT(event_generator,
        UnorderedElementsAre(HasEventAtNode(AXEventGenerator::Event::ACTIVE_DESCENDANT_CHANGED, 1), HasEventAtNode(AXEventGenerator::Event::MENU_ITEM_SELECTED, 3),
...
TEST(AXEventGeneratorTest, NodeBecomesIgnored2)
{
    ...
    ASSERT_TRUE(tree.Unserialize(update));
    EXPECT_THAT(event_generator, UnorderedElementsAre(HasEventAtNode(AXEventGenerator::Event::CHILDREN_CHANGED, 2), HasEventAtNode(AXEventGenerator::Event::IGNORED_CHANGED, 4)));
}
...
TEST(AXEventGeneratorTest, NodeChangesIsIgnoredDueToFocusChange)
{
    ...
    EXPECT_THAT(event_generator,
        UnorderedElementsAre(HasEventAtNode(AXEventGenerator::Event::IGNORED_CHANGED, button_1.id), HasEventAtNode(AXEventGenerator::Event::IGNORED_CHANGED, button_2.id),
            HasEventAtNode(AXEventGenerator::Event::CHILDREN_CHANGED, root.id), HasEventAtNode(AXEventGenerator::Event::SUBTREE_CREATED, button_2.id)));
}
...
TEST(AXEventGeneratorTest, IgnoredChangedFiredOnAncestorOnly1)
{
  ...
  // 2 (IGN)  3
    ...
    ASSERT_TRUE(tree.Unserialize(update));
    EXPECT_THAT(event_generator,
        UnorderedElementsAre(HasEventAtNode(AXEventGenerator::Event::IGNORED_CHANGED, 2), HasEventAtNode(AXEventGenerator::Event::IGNORED_CHANGED, 3),
...
TEST(AXEventGeneratorTest, IgnoredChangedFiredOnAncestorOnly3)
{
  ...
  // 3    4 (IGN)
    ...
    ASSERT_TRUE(tree.Unserialize(update));
    EXPECT_THAT(event_generator,
        UnorderedElementsAre(HasEventAtNode(AXEventGenerator::Event::CHILDREN_CHANGED, 2), HasEventAtNode(AXEventGenerator::Event::IGNORED_CHANGED, 1),
            HasEventAtNode(AXEventGenerator::Event::PARENT_CHANGED, 2), HasEventAtNode(AXEventGenerator::Event::IGNORED_CHANGED, 3),
            HasEventAtNode(AXEventGenerator::Event::SUBTREE_CREATED, 3)));
}
...
TEST(AXEventGeneratorTest, IgnoredChangedFiredOnAncestorOnly4)
{
  ...
  // 6        7        8 (IGN)
    ...
    ASSERT_TRUE(tree.Unserialize(update));
    EXPECT_THAT(event_generator,
        UnorderedElementsAre(HasEventAtNode(AXEventGenerator::Event::CHILDREN_CHANGED, 5), HasEventAtNode(AXEventGenerator::Event::SUBTREE_CREATED, 6),
            HasEventAtNode(AXEventGenerator::Event::SUBTREE_CREATED, 7), HasEventAtNode(AXEventGenerator::Event::IGNORED_CHANGED, 6),
            HasEventAtNode(AXEventGenerator::Event::IGNORED_CHANGED, 7), HasEventAtNode(AXEventGenerator::Event::IGNORED_CHANGED, 8)));
}
...
TEST(AXEventGeneratorTest, IgnoredChangedFiredOnAncestorOnly5)
{
  ...
  // 6        7 (IGN)  8 (IGN)
    ...
    EXPECT_THAT(event_generator,
        UnorderedElementsAre(HasEventAtNode(AXEventGenerator::Event::CHILDREN_CHANGED, 5), HasEventAtNode(AXEventGenerator::Event::SUBTREE_CREATED, 6),
            HasEventAtNode(AXEventGenerator::Event::IGNORED_CHANGED, 1), HasEventAtNode(AXEventGenerator::Event::PARENT_CHANGED, 2),
...
TEST(AXEventGeneratorTest, IgnoredChangedFiredOnAncestorOnly6)
{
  ...
  // 6        7        8 (IGN)
    ...
    ASSERT_TRUE(tree.Unserialize(update));
    EXPECT_THAT(event_generator,
        UnorderedElementsAre(HasEventAtNode(AXEventGenerator::Event::CHILDREN_CHANGED, 5), HasEventAtNode(AXEventGenerator::Event::SUBTREE_CREATED, 1),
            HasEventAtNode(AXEventGenerator::Event::SUBTREE_CREATED, 6), HasEventAtNode(AXEventGenerator::Event::SUBTREE_CREATED, 7),
            HasEventAtNode(AXEventGenerator::Event::IGNORED_CHANGED, 1), HasEventAtNode(AXEventGenerator::Event::PARENT_CHANGED, 2),
...
TEST(AXEventGeneratorTest, IgnoredChangedFiredOnAncestorOnly7)
{
  ...
  // 5 (IGN)       6 (IGN)
    ...
    ASSERT_TRUE(tree.Unserialize(update));
    EXPECT_THAT(event_generator,
        UnorderedElementsAre(HasEventAtNode(AXEventGenerator::Event::SUBTREE_CREATED, 1), HasEventAtNode(AXEventGenerator::Event::IGNORED_CHANGED, 1),
...
TEST(AXEventGeneratorTest, ActiveDescendantChangeOnDescendant)
{
    ...
    ASSERT_TRUE(tree.Unserialize(update));
    EXPECT_THAT(event_generator,
        UnorderedElementsAre(HasEventAtNode(AXEventGenerator::Event::ACTIVE_DESCENDANT_CHANGED, 3), HasEventAtNode(AXEventGenerator::Event::RELATED_NODE_CHANGED, 3),
...
TEST(AXEventGeneratorTest, StringPropertyChanges)
{
    ...
    EXPECT_TRUE(tree.Unserialize(update));
    EXPECT_THAT(event_generator,
        UnorderedElementsAre(HasEventAtNode(AXEventGenerator::Event::ACCESS_KEY_CHANGED, 2), HasEventAtNode(AXEventGenerator::Event::CLASS_NAME_CHANGED, 3),
            HasEventAtNode(AXEventGenerator::Event::KEY_SHORTCUTS_CHANGED, 4), HasEventAtNode(AXEventGenerator::Event::LANGUAGE_CHANGED, 5),
...
TEST(AXEventGeneratorTest, IntPropertyChanges)
{
    ...
    EXPECT_TRUE(tree.Unserialize(update));
    EXPECT_THAT(event_generator,
        UnorderedElementsAre(HasEventAtNode(AXEventGenerator::Event::HIERARCHICAL_LEVEL_CHANGED, 2), HasEventAtNode(AXEventGenerator::Event::POSITION_IN_SET_CHANGED, 3),
...
TEST(AXEventGeneratorTest, IntListPropertyChanges)
{
    ...
    EXPECT_THAT(event_generator,
        UnorderedElementsAre(HasEventAtNode(AXEventGenerator::Event::DESCRIBED_BY_CHANGED, 2), HasEventAtNode(AXEventGenerator::Event::FLOW_FROM_CHANGED, 1),
            ...
            HasEventAtNode(AXEventGenerator::Event::LABELED_BY_CHANGED, 4), HasEventAtNode(AXEventGenerator::Event::RELATED_NODE_CHANGED, 2),
            HasEventAtNode(AXEventGenerator::Event::RELATED_NODE_CHANGED, 3), HasEventAtNode(AXEventGenerator::Event::RELATED_NODE_CHANGED, 4)));
}
...
TEST(AXEventGeneratorTest, MultiselectableStateChanged)
{
    ...
    EXPECT_TRUE(tree.Unserialize(update));
    EXPECT_THAT(event_generator,
        UnorderedElementsAre(HasEventAtNode(AXEventGenerator::Event::MULTISELECTABLE_STATE_CHANGED, 1), HasEventAtNode(AXEventGenerator::Event::STATE_CHANGED, 1),
            HasEventAtNode(AXEventGenerator::Event::WIN_IACCESSIBLE_STATE_CHANGED, 1)));
}
...
TEST(AXEventGeneratorTest, ControlsChanged)
{
    ...
    EXPECT_TRUE(tree.Unserialize(update));
    EXPECT_THAT(
        event_generator, UnorderedElementsAre(HasEventAtNode(AXEventGenerator::Event::CONTROLS_CHANGED, 1), HasEventAtNode(AXEventGenerator::Event::RELATED_NODE_CHANGED, 1)));
}
...
TEST(AXEventGeneratorTest, DropeffectChanged)
{
    ...
    EXPECT_TRUE(tree.Unserialize(update));
    EXPECT_THAT(event_generator, UnorderedElementsAre(HasEventAtNode(AXEventGenerator::Event::DROPEFFECT_CHANGED, 1)));
}
...
TEST(AXEventGeneratorTest, GrabbedChanged)
{
    ...
    EXPECT_TRUE(tree.Unserialize(update));
    EXPECT_THAT(event_generator, UnorderedElementsAre(HasEventAtNode(AXEventGenerator::Event::GRABBED_CHANGED, 1)));
}
...
TEST(AXEventGeneratorTest, HasPopupChanged)
{
    ...
    EXPECT_TRUE(tree.Unserialize(update));
    EXPECT_THAT(event_generator,
        UnorderedElementsAre(HasEventAtNode(AXEventGenerator::Event::HASPOPUP_CHANGED, 1), HasEventAtNode(AXEventGenerator::Event::WIN_IACCESSIBLE_STATE_CHANGED, 1)));
}
...
TEST(AXEventGeneratorTest, EditableTextChanged)
{
    ...
    EXPECT_THAT(event_generator,
        UnorderedElementsAre(HasEventAtNode(AXEventGenerator::Event::VALUE_IN_TEXT_FIELD_CHANGED, text_field.id),
            HasEventAtNode(AXEventGenerator::Event::NAME_CHANGED, static_text.id), HasEventAtNode(AXEventGenerator::Event::EDITABLE_TEXT_CHANGED, text_field.id)));
}
...
TEST(AXEventGeneratorTest, LiveRegionNodeRemoved)
{
    ...
    EXPECT_TRUE(tree.Unserialize(update));
    EXPECT_THAT(
        event_generator, UnorderedElementsAre(HasEventAtNode(AXEventGenerator::Event::CHILDREN_CHANGED, 1), HasEventAtNode(AXEventGenerator::Event::LIVE_REGION_CHANGED, 1)));
}
...
TEST(AXEventGeneratorTest, LiveRegionNodeReparented)
{
    ...
    EXPECT_TRUE(tree.Unserialize(update));
    EXPECT_THAT(event_generator,
        UnorderedElementsAre(HasEventAtNode(AXEventGenerator::Event::LIVE_REGION_CHANGED, 3), HasEventAtNode(AXEventGenerator::Event::LIVE_REGION_NODE_CHANGED, 5),
...
TEST(AXEventGeneratorTest, LiveRootsNested)
{
    ...
    EXPECT_TRUE(tree.Unserialize(update));
    EXPECT_THAT(event_generator,
        UnorderedElementsAre(HasEventAtNode(AXEventGenerator::Event::LIVE_REGION_CHANGED, 3), HasEventAtNode(AXEventGenerator::Event::LIVE_REGION_NODE_CHANGED, 4),
...
TEST(AXEventGeneratorTest, NoParentChangedOnIgnoredNode)
{
    ...
    ASSERT_TRUE(tree.Unserialize(update));
    EXPECT_THAT(event_generator,
        UnorderedElementsAre(HasEventAtNode(AXEventGenerator::Event::CHILDREN_CHANGED, 47), HasEventAtNode(AXEventGenerator::Event::STATE_CHANGED, 100),
            HasEventAtNode(AXEventGenerator::Event::WIN_IACCESSIBLE_STATE_CHANGED, 100), HasEventAtNode(AXEventGenerator::Event::SUBTREE_CREATED, 168)));
...
TEST(AXEventGeneratorTest, InsertUnderIgnoredTest)
{
    ...
    EXPECT_TRUE(tree.Unserialize(update));
    EXPECT_THAT(event_generator, UnorderedElementsAre(HasEventAtNode(AXEventGenerator::Event::CHILDREN_CHANGED, 1), HasEventAtNode(AXEventGenerator::Event::SUBTREE_CREATED, 5)));
}
