...
bool IsFlagSet(uint32_t bitfield, uint32_t flag) { return (bitfield & (1U << flag)) != 0; }

bool IsFlagSet(uint64_t bitfield, uint32_t flag) { return (bitfield & (1ULL << flag)) != 0; }

uint32_t ModifyFlag(uint32_t bitfield, uint32_t flag, bool set) { return set ? (bitfield |= (1U << flag)) : (bitfield &= ~(1U << flag)); }

uint64_t ModifyFlag(uint64_t bitfield, uint32_t flag, bool set) { return set ? (bitfield |= (1ULL << flag)) : (bitfield &= ~(1ULL << flag)); }
...
template <typename ItemType, typename ItemToStringFunction> std::string VectorToString(const std::vector<ItemType>& items, ItemToStringFunction itemToStringFunction)
{
    std::string str;
...
typename std::vector<std::pair<FirstType, SecondType>>::const_iterator FindInVectorOfPairs(FirstType first, const std::vector<std::pair<FirstType, SecondType>>& vector)
{
...
bool AXNodeData::GetBoolAttribute(ax::mojom::BoolAttribute attribute, bool* value) const
{
    auto iter = FindInVectorOfPairs(attribute, bool_attributes);
...
bool AXNodeData::GetFloatAttribute(ax::mojom::FloatAttribute attribute, float* value) const
{
    auto iter = FindInVectorOfPairs(attribute, float_attributes);
...
bool AXNodeData::GetIntAttribute(ax::mojom::IntAttribute attribute, int* value) const
{
    auto iter = FindInVectorOfPairs(attribute, int_attributes);
...
bool AXNodeData::GetStringAttribute(ax::mojom::StringAttribute attribute, std::string* value) const
{
    auto iter = FindInVectorOfPairs(attribute, string_attributes);
...
bool AXNodeData::GetString16Attribute(ax::mojom::StringAttribute attribute, std::u16string* value) const
{
    std::string value_utf8;
    if (!GetStringAttribute(attribute, &value_utf8))
        return false;
...
bool AXNodeData::GetIntListAttribute(ax::mojom::IntListAttribute attribute, std::vector<int32_t>* value) const
{
    auto iter = FindInVectorOfPairs(attribute, intlist_attributes);
    if (iter != intlist_attributes.end()) {
        *value = iter->second;
...
bool AXNodeData::GetStringListAttribute(ax::mojom::StringListAttribute attribute, std::vector<std::string>* value) const
{
    auto iter = FindInVectorOfPairs(attribute, stringlist_attributes);
    if (iter != stringlist_attributes.end()) {
        *value = iter->second;
...
bool AXNodeData::GetHtmlAttribute(const char* attribute, std::string* value) const
{
    for (const std::pair<std::string, std::string>& html_attribute : html_attributes) {
...
bool AXNodeData::GetHtmlAttribute(const char* attribute, std::u16string* value) const
{
    std::string value_utf8;
...
{
    ax::mojom::StringAttribute attribute = ax::mojom::StringAttribute::kChildTreeId;
...
{
    DCHECK_NE(attribute, ax::mojom::BoolAttribute::kNone);
    base::EraseIf(bool_attributes, [attribute](const auto& bool_attribute) { return bool_attribute.first == attribute; });
}

void AXNodeData::RemoveIntAttribute(ax::mojom::IntAttribute attribute)
{
    DCHECK_NE(attribute, ax::mojom::IntAttribute::kNone);
    base::EraseIf(int_attributes, [attribute](const auto& int_attribute) { return int_attribute.first == attribute; });
}

void AXNodeData::RemoveFloatAttribute(ax::mojom::FloatAttribute attribute)
{
    DCHECK_NE(attribute, ax::mojom::FloatAttribute::kNone);
    base::EraseIf(float_attributes, [attribute](const auto& float_attribute) { return float_attribute.first == attribute; });
}

void AXNodeData::RemoveStringAttribute(ax::mojom::StringAttribute attribute)
{
    DCHECK_NE(attribute, ax::mojom::StringAttribute::kNone);
    base::EraseIf(string_attributes, [attribute](const auto& string_attribute) { return string_attribute.first == attribute; });
}

void AXNodeData::RemoveIntListAttribute(ax::mojom::IntListAttribute attribute)
{
    DCHECK_NE(attribute, ax::mojom::IntListAttribute::kNone);
    base::EraseIf(intlist_attributes, [attribute](const auto& intlist_attribute) { return intlist_attribute.first == attribute; });
}

void AXNodeData::RemoveStringListAttribute(ax::mojom::StringListAttribute attribute)
{
    DCHECK_NE(attribute, ax::mojom::StringListAttribute::kNone);
    base::EraseIf(stringlist_attributes, [attribute](const auto& stringlist_attribute) { return stringlist_attribute.first == attribute; });
}
...
AXTextAttributes AXNodeData::GetTextAttributes() const
{
    ...
    GetIntAttribute(ax::mojom::IntAttribute::kBackgroundColor, &text_attributes.background_color);
    GetIntAttribute(ax::mojom::IntAttribute::kColor, &text_attributes.color);
    GetIntAttribute(ax::mojom::IntAttribute::kInvalidState, &text_attributes.invalid_state);
    GetIntAttribute(ax::mojom::IntAttribute::kTextOverlineStyle, &text_attributes.overline_style);
    GetIntAttribute(ax::mojom::IntAttribute::kTextDirection, &text_attributes.text_direction);
    GetIntAttribute(ax::mojom::IntAttribute::kTextPosition, &text_attributes.text_position);
    GetIntAttribute(ax::mojom::IntAttribute::kTextStrikethroughStyle, &text_attributes.strikethrough_style);
    GetIntAttribute(ax::mojom::IntAttribute::kTextStyle, &text_attributes.text_style);
    GetIntAttribute(ax::mojom::IntAttribute::kTextUnderlineStyle, &text_attributes.underline_style);
    GetFloatAttribute(ax::mojom::FloatAttribute::kFontSize, &text_attributes.font_size);
    GetFloatAttribute(ax::mojom::FloatAttribute::kFontWeight, &text_attributes.font_weight);
    GetStringAttribute(ax::mojom::StringAttribute::kFontFamily, &text_attributes.font_family);
    GetIntListAttribute(ax::mojom::IntListAttribute::kMarkerTypes, &text_attributes.marker_types);
    GetIntListAttribute(ax::mojom::IntListAttribute::kHighlightTypes, &text_attributes.highlight_types);
...
void AXNodeData::SetName(const std::u16string& name) { SetName(base::UTF16ToUTF8(name)); }
...
void AXNodeData::SetNameChecked(const std::u16string& name) { SetNameChecked(base::UTF16ToUTF8(name)); }
...
void AXNodeData::SetDescription(const std::u16string& description) { SetDescription(base::UTF16ToUTF8(description)); }
...
void AXNodeData::SetValue(const std::string& value) { AddStringAttribute(ax::mojom::StringAttribute::kValue, value); }

void AXNodeData::SetValue(const std::u16string& value) { SetValue(base::UTF16ToUTF8(value)); }

bool AXNodeData::HasState(ax::mojom::State state_enum) const { return IsFlagSet(state, static_cast<uint32_t>(state_enum)); }

bool AXNodeData::HasAction(ax::mojom::Action action) const { return IsFlagSet(actions, static_cast<uint32_t>(action)); }
...
bool AXNodeData::HasDropeffect(ax::mojom::Dropeffect dropeffect_enum) const
{
    ...
    return IsFlagSet(static_cast<uint32_t>(dropeffect), static_cast<uint32_t>(dropeffect_enum));
}
...
{
    DCHECK_GE(static_cast<int>(dropeffect_enum), static_cast<int>(ax::mojom::Dropeffect::kMinValue));
    DCHECK_LE(static_cast<int>(dropeffect_enum), static_cast<int>(ax::mojom::Dropeffect::kMaxValue));
    int32_t dropeffect = GetIntAttribute(ax::mojom::IntAttribute::kDropeffect);
    dropeffect = ModifyFlag(static_cast<uint32_t>(dropeffect), static_cast<uint32_t>(dropeffect_enum), true);
    RemoveIntAttribute(ax::mojom::IntAttribute::kDropeffect);
    AddIntAttribute(ax::mojom::IntAttribute::kDropeffect, dropeffect);
}

ax::mojom::CheckedState AXNodeData::GetCheckedState() const { return static_cast<ax::mojom::CheckedState>(GetIntAttribute(ax::mojom::IntAttribute::kCheckedState)); }
...
bool AXNodeData::HasCheckedState() const { return HasIntAttribute(ax::mojom::IntAttribute::kCheckedState); }
...
ax::mojom::HasPopup AXNodeData::GetHasPopup() const { return static_cast<ax::mojom::HasPopup>(GetIntAttribute(ax::mojom::IntAttribute::kHasPopup)); }
...
ax::mojom::InvalidState AXNodeData::GetInvalidState() const { return static_cast<ax::mojom::InvalidState>(GetIntAttribute(ax::mojom::IntAttribute::kInvalidState)); }
...
ax::mojom::NameFrom AXNodeData::GetNameFrom() const { return static_cast<ax::mojom::NameFrom>(GetIntAttribute(ax::mojom::IntAttribute::kNameFrom)); }
...
ax::mojom::DescriptionFrom AXNodeData::GetDescriptionFrom() const { return static_cast<ax::mojom::DescriptionFrom>(GetIntAttribute(ax::mojom::IntAttribute::kDescriptionFrom)); }
...
ax::mojom::TextPosition AXNodeData::GetTextPosition() const { return static_cast<ax::mojom::TextPosition>(GetIntAttribute(ax::mojom::IntAttribute::kTextPosition)); }
...
ax::mojom::Restriction AXNodeData::GetRestriction() const { return static_cast<ax::mojom::Restriction>(GetIntAttribute(ax::mojom::IntAttribute::kRestriction)); }
...
ax::mojom::ListStyle AXNodeData::GetListStyle() const { return static_cast<ax::mojom::ListStyle>(GetIntAttribute(ax::mojom::IntAttribute::kListStyle)); }
...
ax::mojom::TextAlign AXNodeData::GetTextAlign() const { return static_cast<ax::mojom::TextAlign>(GetIntAttribute(ax::mojom::IntAttribute::kTextAlign)); }
...
ax::mojom::WritingDirection AXNodeData::GetTextDirection() const { return static_cast<ax::mojom::WritingDirection>(GetIntAttribute(ax::mojom::IntAttribute::kTextDirection)); }
...
bool AXNodeData::IsActivatable() const { return IsTextField() || role == ax::mojom::Role::kListBox; }

bool AXNodeData::IsActiveLiveRegionRoot() const
{
    std::string aria_live_status;
    if (GetStringAttribute(ax::mojom::StringAttribute::kLiveStatus, &aria_live_status)) {
...
bool AXNodeData::IsContainedInActiveLiveRegion() const
{
    ...
    if (GetStringAttribute(ax::mojom::StringAttribute::kContainerLiveStatus, &aria_container_live_status)) {
...
bool AXNodeData::IsIgnored() const { return HasState(ax::mojom::State::kIgnored) || role == ax::mojom::Role::kNone; }

bool AXNodeData::IsInvisible() const { return HasState(ax::mojom::State::kInvisible); }

bool AXNodeData::IsInvisibleOrIgnored() const { return IsIgnored() || IsInvisible(); }
...
bool AXNodeData::IsTextField() const { return IsAtomicTextField() || IsNonAtomicTextField() || IsSpinnerTextField(); }

bool AXNodeData::IsPasswordField() const { return IsTextField() && HasState(ax::mojom::State::kProtected); }
...
bool AXNodeData::IsNonAtomicTextField() const { return GetBoolAttribute(ax::mojom::BoolAttribute::kNonAtomicTextFieldRoot); }
...
bool AXNodeData::IsSpinnerTextField() const
{
    ...
    return role == ax::mojom::Role::kSpinButton && GetStringAttribute(ax::mojom::StringAttribute::kInputType) == "number";
}
...
std::string AXNodeData::ToString() const
{
    ...
    for (const std::pair<ax::mojom::IntAttribute, int32_t>& int_attribute : int_attributes) {
        ...
        case ax::mojom::IntAttribute::kNameFrom:
            result += " name_from=";
            result += ui::ToString(static_cast<ax::mojom::NameFrom>(int_attribute.second));
            break;
        case ax::mojom::IntAttribute::kDescriptionFrom:
...
size_t AXNodeData::ByteSize() const
{
    ...
    total_size += int_attributes.size() * (sizeof(ax::mojom::IntAttribute) + sizeof(int32_t)) + float_attributes.size() * (sizeof(ax::mojom::FloatAttribute) + sizeof(float))
        + bool_attributes.size() * (sizeof(ax::mojom::BoolAttribute) + sizeof(bool)) + child_ids.size() * sizeof(int32_t);

    // Complex collections.
    for (const auto& pair : string_attributes) {
        total_size += sizeof(ax::mojom::StringAttribute) + pair.second.size() * sizeof(char);
    }

    for (const auto& pair : intlist_attributes) {
        total_size += sizeof(ax::mojom::IntListAttribute) + pair.second.size() * sizeof(int32_t);
    }
    ...
    for (const auto& pair : html_attributes) {
        total_size += pair.first.size() * sizeof(char) + pair.second.size() * sizeof(char);
    }
...
std::string AXNodeData::DropeffectBitfieldToString() const
{
    ...
    std::string str;
    for (int dropeffect_idx = static_cast<int>(ax::mojom::Dropeffect::kMinValue); dropeffect_idx <= static_cast<int>(ax::mojom::Dropeffect::kMaxValue); ++dropeffect_idx) {
        ax::mojom::Dropeffect dropeffect_enum = static_cast<ax::mojom::Dropeffect>(dropeffect_idx);
