...
template <typename AXNodeSource> class AX_EXPORT AXTreeSourceAnnotator : public AXTreeSourceObserver<AXNodeSource> {
public:
    ...
    virtual std::string GetAnnotation(const AXTreeSource<AXNodeSource>& tree_source, const AXNodeSource& node_source) const = 0;
    ...
    virtual ax::mojom::ImageAnnotationStatus GetAnnotationStatus(const AXTreeSource<AXNodeSource>& tree_source, const AXNodeSource& node_source) const = 0;

    // Returns true if an accessible name for the given `AXNodeSource` has already
    // been automatically generated.
    virtual bool HasAnnotationInCache(const AXTreeSource<AXNodeSource>& tree_source, const AXNodeSource& node_source) const = 0;

    // Returns true if an accessible name for the given `AXNodeSource` has already
    // been automatically generated, is in the process of being generated, or has
    // encountered an error.
    virtual bool HasNodeInCache(const AXTreeSource<AXNodeSource>& tree_source, const AXNodeSource& node_source) const = 0;
