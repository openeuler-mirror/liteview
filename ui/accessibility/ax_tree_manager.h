...
public:
    ...
    virtual void FireGeneratedEvent(ui::AXEventGenerator::Event event_type, const ui::AXNode* node) { }
    ...
    virtual AXNode* GetNodeFromTree(const AXTreeID& tree_id, const AXNodeID node_id) const = 0;
