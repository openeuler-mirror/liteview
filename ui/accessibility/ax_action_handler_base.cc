...
bool AXActionHandlerBase::RequiresPerformActionPointInPixels() const { return false; }
...
AXActionHandlerBase::~AXActionHandlerBase() { AXActionHandlerRegistry::GetInstance()->RemoveAXTreeID(tree_id_); }
