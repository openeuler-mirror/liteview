...
absl::optional<int32_t> GetCellAttribute(const ui::AXPlatformNodeDelegate* delegate, ax::mojom::IntAttribute attribute)
{
    switch (attribute) {
...
absl::optional<int32_t> GetRowAttribute(const ui::AXPlatformNodeDelegate* delegate, ax::mojom::IntAttribute attribute)
{
...
absl::optional<int32_t> GetTableAttribute(const ui::AXPlatformNodeDelegate* delegate, ax::mojom::IntAttribute attribute)
{
    switch (attribute) {
...
absl::optional<int> GetOrderedSetItemAttribute(const ui::AXPlatformNodeDelegate* delegate, ax::mojom::IntAttribute attribute)
{
    switch (attribute) {
...
absl::optional<int> GetOrderedSetAttribute(const ui::AXPlatformNodeDelegate* delegate, ax::mojom::IntAttribute attribute)
{
    switch (attribute) {
    case ax::mojom::IntAttribute::kSetSize:
        return delegate->GetSetSize();
...
absl::optional<int32_t> GetFromData(const ui::AXPlatformNodeDelegate* delegate, ax::mojom::IntAttribute attribute)
{
    int32_t value;
...
absl::optional<int32_t> ComputeAttribute(const ui::AXPlatformNodeDelegate* delegate, ax::mojom::IntAttribute attribute)
{
