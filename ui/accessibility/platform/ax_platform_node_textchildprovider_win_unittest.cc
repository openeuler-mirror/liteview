...
protected:
    ...
    void SetUp() override
    {
        ...
        update.nodes = { root, nontext_child_of_root, text_child_of_root, nontext_child_of_nontext, text_child_of_nontext, text_child_of_text };
    ...
    void InitITextChildProvider(AXNode* node, ComPtr<IRawElementProviderSimple>& raw_element_provider, ComPtr<ITextChildProvider>& text_child_provider)
    {
        ...
        if (!text_child_provider) {
            ui::AXPlatformNodeWin* platform_node = (ui::AXPlatformNodeWin*)raw_element_provider.Get();

            ComPtr<ITextChildProvider> new_child_provider = ui::AXPlatformNodeTextChildProviderWin::Create(platform_node);
...
TEST_F(AXPlatformNodeTextChildProviderTest, ITextChildProviderTextRangeFromNontextChildOfRoot)
{
    ...
    EXPECT_EQ(base::WideToUTF16(text_content.Get()), kEmbeddedCharacterAsString + u"\ntext child of nontext.");
