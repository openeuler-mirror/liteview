...
public:
    ...
    //                    all over
    static AXInspectScenario From(const std::string& directive_prefix, const std::vector<std::string>& lines, const std::vector<AXPropertyFilter>& default_filters = {});
...
private:
    ...
    static Directive ParseDirective(const std::string& directive_prefix, const std::string& directive);
