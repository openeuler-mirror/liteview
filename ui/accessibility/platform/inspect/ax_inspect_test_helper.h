...
public:
    ...
    void OverrideExpectationType(const std::string& expectation_type) { expectation_type_ = expectation_type; }
    ...
    // an empty path.
    base::FilePath GetExpectationFilePath(const base::FilePath& test_file_path, const base::FilePath::StringType& expectations_qualifier = FILE_PATH_LITERAL(""));
    ...
    absl::optional<AXInspectScenario> ParseScenario(const base::FilePath& scenario_path, const std::vector<AXPropertyFilter>& default_filters = {});
    ...
    static absl::optional<std::vector<std::string>> LoadExpectationFile(const base::FilePath& expected_file);
    ...
    static bool ValidateAgainstExpectation(
        const base::FilePath& test_file_path, const base::FilePath& expected_file, const std::vector<std::string>& actual_lines, const std::vector<std::string>& expected_lines);
