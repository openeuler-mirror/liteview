...
AX_EXPORT AXUIElementRef FindAXUIElement(const AXUIElementRef node, const AXFindCriteria& criteria);
...
AX_EXPORT AXUIElementRef FindAXWindowChild(AXUIElementRef parent, const std::string& pattern);
