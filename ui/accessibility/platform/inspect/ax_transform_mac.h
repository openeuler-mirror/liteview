...
AX_EXPORT base::Value::List AXNSArrayToBaseValue(NSArray*, const AXTreeIndexerMac*);

// Returns the base::Value::Dict representation of the given NSDictionary.
AX_EXPORT base::Value::Dict AXNSDictionaryToBaseValue(NSDictionary*, const AXTreeIndexerMac*);
