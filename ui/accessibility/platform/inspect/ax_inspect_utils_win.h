...
AX_EXPORT void IAccessibleStateToStringVector(int32_t ia_state, std::vector<std::wstring>* result);
AX_EXPORT std::wstring IAccessible2StateToString(int32_t ia2_state);
AX_EXPORT void IAccessible2StateToStringVector(int32_t ia_state, std::vector<std::wstring>* result);
...
template <typename ServiceType> HRESULT IA2QueryInterface(IAccessible* accessible, ServiceType** out_accessible)
{
...
public:
    ...
    public:
        ...
        bool operator==(const Iterator& rhs) const { return children_ == rhs.children_ && index_ == rhs.index_; }
