...
TEST_F(AXFragmentRootTest, UIAFindItemByPropertyUniqueId)
{
    ...
    // the item.
    {
        ...
        EXPECT_HRESULT_FAILED(
            item_container_provider->FindItemByProperty(invalid_element_provider_simple.Get(), UiaRegistrarWin::GetInstance().GetUniqueIdPropertyId(), unique_id_variant, &result));
        result.Reset();
    ...
    // corresponding IRawElementProviderSimple through FindItemByProperty().
    {
        ...
        EXPECT_HRESULT_SUCCEEDED(item_container_provider->FindItemByProperty(nullptr, UiaRegistrarWin::GetInstance().GetUniqueIdPropertyId(), unique_id_variant, &result));
...
TEST_F(AXFragmentRootTest, TestUIAMultipleFragmentRoots)
{
  ...
  //   U6---U7   U8---U9
    ...
    update.nodes = { top_fragment_root_n1, sibling_n2, child_fragment_root_n3, sibling_n6, sibling_n7, sibling_n4, child_fragment_root_n5, sibling_n8, sibling_n9 };
