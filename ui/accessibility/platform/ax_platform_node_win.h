...
extern AX_EXPORT base::ObserverList<WinAccessibilityAPIUsageObserver>::Unchecked& GetWinAccessibilityAPIUsageObserverList();
...
class AX_EXPORT __declspec(uuid("26f5641a-246d-457b-a96d-07f3fae6acf2")) AXPlatformNodeWin : public CComObjectRootEx<CComMultiThreadModel>,
...
public:
    ...
    IFACEMETHODIMP get_localizedExtendedStates(LONG max_localized_extended_states, BSTR** localized_extended_states, LONG* n_localized_extended_states) override;
    ...
    HRESULT GetTextAttributeValue(TEXTATTRIBUTEID attribute_id, const absl::optional<int>& start_offset, const absl::optional<int>& end_offset, base::win::VariantVector* result);
    ...
    static absl::optional<PROPERTYID> MojoEventToUIAProperty(ax::mojom::Event event);
...
protected:
    ...
    bool IsHyperlink();
    void ComputeHypertextRemovedAndInserted(size_t* start, size_t* old_len, size_t* new_len);
...
private:
    ...
    // UIA AriaProperties Property with the name |uia_aria_property|.
    void HtmlAttributeToUIAAriaProperty(std::vector<std::wstring>& properties, const char* html_attribute_name, const char* uia_aria_property);
    ...
    std::vector<AXPlatformNodeWin*> CreatePlatformNodeVectorFromRelationIdVector(std::vector<int32_t>& relation_id_list);
    ...
    SAFEARRAY* CreateUIAElementsSafeArray(std::vector<AXPlatformNodeWin*>& platform_node_list);
    ...
    HRESULT GetAnnotationTypesAttribute(const absl::optional<int>& start_offset, const absl::optional<int>& end_offset, base::win::VariantVector* result);
    ...
    static absl::optional<HorizontalTextAlignment> AXTextAlignToUIAHorizontalTextAlignment(ax::mojom::TextAlign text_align);
    ...
    static void AggregateRangesForMarkerType(AXPlatformNodeBase* node, ax::mojom::MarkerType marker_type, int offset_ranges_amount, std::vector<std::pair<int, int>>* ranges,
    ...
    MarkerTypeRangeResult GetMarkerTypeFromRange(const absl::optional<int>& start_offset, const absl::optional<int>& end_offset, ax::mojom::MarkerType marker_type,
        const absl::optional<ax::mojom::HighlightType>& highlight_type = absl::nullopt);
