...
- (std::unique_ptr<ui::AXAnnouncementSpec>)announcementForEvent:(ax::mojom::Event)eventType;
...
- (void)scheduleLiveRegionAnnouncement:(std::unique_ptr<ui::AXAnnouncementSpec>)announcement;
