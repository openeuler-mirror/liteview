...
bool AX_EXPORT ShouldIgnoreGeneratedEventForAutomation(AXEventGenerator::Event event_type);

std::tuple<ax::mojom::Event, AXEventGenerator::Event> AX_EXPORT MakeTupleForAutomationFromEventTypes(
...
std::tuple<ax::mojom::Event, AXEventGenerator::Event> AX_EXPORT AutomationEventTypeToAXEventTuple(const char* event_type_string);
