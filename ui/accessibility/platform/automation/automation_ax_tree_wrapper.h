...
public:
    ...
    void EventListenerAdded(const std::tuple<ax::mojom::Event, AXEventGenerator::Event>& event_type, ui::AXNode* node);
    void EventListenerRemoved(const std::tuple<ax::mojom::Event, AXEventGenerator::Event>& event_type, ui::AXNode* node);
    bool HasEventListener(const std::tuple<ax::mojom::Event, AXEventGenerator::Event>& event_type, ui::AXNode* node);
    ...
    AXNode* GetNodeFromTree(const AXTreeID& tree_id, const AXNodeID node_id) const override;
