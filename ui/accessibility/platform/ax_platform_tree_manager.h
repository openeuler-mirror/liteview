...
public:
    ...
    virtual AXPlatformNode* GetPlatformNodeFromTree(const AXNodeID node_id) const = 0;
...
protected:
    explicit AXPlatformTreeManager(const AXTreeID& tree_id, std::unique_ptr<AXTree> tree)
