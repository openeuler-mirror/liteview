...
public:
    ...
    virtual bool GetBoolAttribute(ax::mojom::BoolAttribute attribute, bool* value) const = 0;
    virtual bool HasFloatAttribute(ax::mojom::FloatAttribute attribute) const = 0;
    virtual float GetFloatAttribute(ax::mojom::FloatAttribute attribute) const = 0;
    virtual bool GetFloatAttribute(ax::mojom::FloatAttribute attribute, float* value) const = 0;
    virtual const std::vector<std::pair<ax::mojom::IntAttribute, int32_t>>& GetIntAttributes() const = 0;
    ...
    virtual bool GetIntAttribute(ax::mojom::IntAttribute attribute, int* value) const = 0;
    virtual const std::vector<std::pair<ax::mojom::StringAttribute, std::string>>& GetStringAttributes() const = 0;
    virtual bool HasStringAttribute(ax::mojom::StringAttribute attribute) const = 0;
    virtual const std::string& GetStringAttribute(ax::mojom::StringAttribute attribute) const = 0;
    virtual bool GetStringAttribute(ax::mojom::StringAttribute attribute, std::string* value) const = 0;
    virtual std::u16string GetString16Attribute(ax::mojom::StringAttribute attribute) const = 0;
    virtual bool GetString16Attribute(ax::mojom::StringAttribute attribute, std::u16string* value) const = 0;
    virtual const std::string& GetInheritedStringAttribute(ax::mojom::StringAttribute attribute) const = 0;
    virtual std::u16string GetInheritedString16Attribute(ax::mojom::StringAttribute attribute) const = 0;
    virtual const std::vector<std::pair<ax::mojom::IntListAttribute, std::vector<int32_t>>>& GetIntListAttributes() const = 0;
    virtual bool HasIntListAttribute(ax::mojom::IntListAttribute attribute) const = 0;
    virtual const std::vector<int32_t>& GetIntListAttribute(ax::mojom::IntListAttribute attribute) const = 0;
    virtual bool GetIntListAttribute(ax::mojom::IntListAttribute attribute, std::vector<int32_t>* value) const = 0;
    virtual bool HasStringListAttribute(ax::mojom::StringListAttribute attribute) const = 0;
    virtual const std::vector<std::string>& GetStringListAttribute(ax::mojom::StringListAttribute attribute) const = 0;
    virtual bool GetStringListAttribute(ax::mojom::StringListAttribute attribute, std::vector<std::string>* value) const = 0;
    virtual bool HasHtmlAttribute(const char* attribute) const = 0;
    virtual const base::StringPairs& GetHtmlAttributes() const = 0;
    virtual bool GetHtmlAttribute(const char* attribute, std::string* value) const = 0;
    virtual bool GetHtmlAttribute(const char* attribute, std::u16string* value) const = 0;
    ...
    virtual AXNodePosition::AXPositionInstance CreatePositionAt(int offset, ax::mojom::TextAffinity affinity = ax::mojom::TextAffinity::kDownstream) const = 0;

    // Creates a text position rooted at this object.
    virtual AXNodePosition::AXPositionInstance CreateTextPositionAt(int offset, ax::mojom::TextAffinity affinity = ax::mojom::TextAffinity::kDownstream) const = 0;
    ...
    public:
        ...
        bool operator==(const ChildIterator& rhs) const { return GetIndexInParent() == rhs.GetIndexInParent(); }
        bool operator!=(const ChildIterator& rhs) const { return GetIndexInParent() != rhs.GetIndexInParent(); }
    ...
    // `AXNode`.
    virtual const std::map<int, int>& GetHypertextOffsetToHyperlinkChildIndex() const = 0;
    ...
    virtual gfx::Rect GetBoundsRect(const AXCoordinateSystem coordinate_system, const AXClippingBehavior clipping_behavior, AXOffscreenResult* offscreen_result = nullptr) const
        = 0;
    ...
    gfx::Rect GetClippedRootFrameBoundsRect(ui::AXOffscreenResult* offscreen_result = nullptr) const;
    gfx::Rect GetUnclippedRootFrameBoundsRect(ui::AXOffscreenResult* offscreen_result = nullptr) const;
    gfx::Rect GetClippedFrameBoundsRect(ui::AXOffscreenResult* offscreen_result = nullptr) const;
    gfx::Rect GetUnclippedFrameBoundsRect(ui::AXOffscreenResult* offscreen_result = nullptr) const;
    ...
    virtual const std::vector<gfx::NativeViewAccessible> GetUIADirectChildrenInRange(ui::AXPlatformNodeDelegate* start, ui::AXPlatformNodeDelegate* end) = 0;
    ...
    virtual absl::optional<int32_t> GetCellId(int row_index, int col_index) const = 0;
    ...
    friend std::ostream& operator<<(std::ostream& stream, const AXPlatformNodeDelegate& delegate) { return stream << delegate.ToString(); }
