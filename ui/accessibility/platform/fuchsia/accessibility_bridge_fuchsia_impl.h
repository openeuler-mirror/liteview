...
class AX_EXPORT AccessibilityBridgeFuchsiaImpl final : public ui::AccessibilityBridgeFuchsia, public ui::AXFuchsiaSemanticProvider::Delegate {
public:
    ...
    // do not reconnect).
    AccessibilityBridgeFuchsiaImpl(aura::Window* root_window, fuchsia::ui::views::ViewRef view_ref, base::RepeatingCallback<void(bool)> on_semantics_enabled,
    ...
    void OnAccessibilityHitTestResult(int hit_test_request_id, absl::optional<uint32_t> result) override;
...
private:
    ...
    base::flat_map<int /* request_id */, fuchsia::accessibility::semantics::SemanticListener::HitTestCallback> pending_hit_test_callbacks_;
