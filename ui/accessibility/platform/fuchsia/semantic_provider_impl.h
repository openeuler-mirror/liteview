...
// fuchsia view.
class AX_EXPORT AXFuchsiaSemanticProviderImpl : public AXFuchsiaSemanticProvider, public fuchsia::accessibility::semantics::SemanticListener {
public:
    // Arguments:
    ...
    // semantic provider.
    AXFuchsiaSemanticProviderImpl(fuchsia::ui::views::ViewRef view_ref, Delegate* delegate);
    ...
    bool Clear() override;
    void SendEvent(fuchsia::accessibility::semantics::SemanticEvent event) override;
...
private:
    ...
    public:
        ...
        void Apply(fuchsia::accessibility::semantics::SemanticTreePtr* semantic_tree);
    ...
    void OnAccessibilityActionRequested(uint32_t node_id, fuchsia::accessibility::semantics::Action action,
        fuchsia::accessibility::semantics::SemanticListener::OnAccessibilityActionRequestedCallback callback) override;

    // fuchsia::accessibility::semantics::SemanticListener:
    void HitTest(::fuchsia::math::PointF local_point, HitTestCallback callback) override;

    // fuchsia::accessibility::semantics::SemanticListener:
    void OnSemanticsModeChanged(bool update_enabled, OnSemanticsModeChangedCallback callback) override;

    fuchsia::ui::views::ViewRef view_ref_;

    Delegate* const delegate_;

    fidl::Binding<fuchsia::accessibility::semantics::SemanticListener> semantic_listener_binding_;
