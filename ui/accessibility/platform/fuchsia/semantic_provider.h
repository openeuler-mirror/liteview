...
public:
    ...
    public:
        ...
        virtual bool OnAccessibilityAction(uint32_t node_id, fuchsia::accessibility::semantics::Action action) = 0;
        ...
        // hit tests.
        virtual void OnHitTest(fuchsia::math::PointF point, HitTestCallback callback) = 0;
    ...
    virtual void SendEvent(fuchsia::accessibility::semantics::SemanticEvent event) = 0;
