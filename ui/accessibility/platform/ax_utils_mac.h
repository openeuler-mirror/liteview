...
AX_EXPORT AXPlatformNodeDelegate::AXPosition AXTextMarkerToAXPosition(id text_marker);

// Returns the AXRange representing the given AXTextMarkerRange.
AX_EXPORT AXPlatformNodeDelegate::AXRange AXTextMarkerRangeToAXRange(id marker_range);
...
AX_EXPORT id AXTextMarkerFrom(const AXPlatformNodeCocoa* anchor, int offset, ax::mojom::TextAffinity affinity);
