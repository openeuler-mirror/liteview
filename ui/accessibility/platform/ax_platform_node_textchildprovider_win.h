...
namespace ui {
class AX_EXPORT AXPlatformNodeTextChildProviderWin : public CComObjectRootEx<CComMultiThreadModel>, public ITextChildProvider {
public:
    ...
    static AXPlatformNodeTextChildProviderWin* Create(ui::AXPlatformNodeWin* owner);
