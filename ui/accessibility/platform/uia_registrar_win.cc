...
// UIA custom events.
EVENTID UiaRegistrarWin::GetTestCompleteEventId() const { return test_complete_event_id_; }

// UIA custom properties.
PROPERTYID UiaRegistrarWin::GetUniqueIdPropertyId() const { return unique_id_property_id_; }
