...
public:
    const AXNodePosition::AXPositionInstance& GetStart(const AXPlatformNodeTextRangeProviderWin* text_range) { return text_range->start(); }

    const AXNodePosition::AXPositionInstance& GetEnd(const AXPlatformNodeTextRangeProviderWin* text_range) { return text_range->end(); }

    ui::AXPlatformNodeWin* GetOwner(const AXPlatformNodeTextRangeProviderWin* text_range) { return text_range->GetOwner(); }
    ...
    void CreateTextRangeProviderWin(ComPtr<AXPlatformNodeTextRangeProviderWin>& text_range_provider_win, AXPlatformNodeWin* owner, AXTreeID tree_id, AXNodeID start_anchor_id,
        int start_offset, ax::mojom::TextAffinity start_affinity, AXNodeID end_anchor_id, int end_offset, ax::mojom::TextAffinity end_affinity)
    {
        AXNodePosition::AXPositionInstance range_start = AXNodePosition::CreateTextPosition(tree_id, start_anchor_id, start_offset, start_affinity);
        AXNodePosition::AXPositionInstance range_end = AXNodePosition::CreateTextPosition(tree_id, end_anchor_id, end_offset, end_affinity);

        ComPtr<ITextRangeProvider> text_range_provider = AXPlatformNodeTextRangeProviderWin::CreateTextRangeProviderForTesting(owner, std::move(range_start), std::move(range_end));
    ...
    ui::AXTreeUpdate BuildAXTreeForMove()
    {
        ...
        update.has_tree_data = true;
        update.root_id = root_data.id;
        update.nodes = { root_data, group1_data, text_data, group2_data, line_break1_data, standalone_text_data, line_break2_data, bold_text_data, paragraph1_data,
            paragraph1_text_data, ignored_text_data, paragraph2_data, paragraph2_text_data };
        update.tree_data.tree_id = ui::AXTreeID::CreateNewAXTreeID();
        return update;
    }
    ...
    AXTreeUpdate BuildAXTreeForMoveByFormat()
    {
        ...
        root_data.id = 1;
        root_data.role = ax::mojom::Role::kRootWebArea;
        root_data.child_ids = { group1_data.id, group2_data.id, group3_data.id, paragraph1_data.id, paragraph2_data.id, paragraph3_data.id, paragraph4_data.id };

        AXTreeUpdate update;
        update.has_tree_data = true;
        update.root_id = root_data.id;
        update.nodes = { root_data, group1_data, text_data, group2_data, line_break1_data, standalone_text_data, line_break2_data, group3_data, bold_text_data, paragraph1_data,
            paragraph1_text_data, paragraph2_data, paragraph2_text_data, paragraph3_data, paragraph3_text_data, paragraph4_data, paragraph4_text_data };
        update.tree_data.tree_id = ui::AXTreeID::CreateNewAXTreeID();
        return update;
    }
...
class MockAXPlatformNodeTextRangeProviderWin : public CComObjectRootEx<CComMultiThreadModel>, public ITextRangeProvider {
public:
    ...
    //
    IFACEMETHODIMP Clone(ITextRangeProvider** clone) override { return E_NOTIMPL; }

    IFACEMETHODIMP Compare(ITextRangeProvider* other, BOOL* result) override { return E_NOTIMPL; }
    ...
    IFACEMETHODIMP ExpandToEnclosingUnit(TextUnit unit) override { return E_NOTIMPL; }

    IFACEMETHODIMP FindAttribute(TEXTATTRIBUTEID attribute_id, VARIANT val, BOOL backward, ITextRangeProvider** result) override { return E_NOTIMPL; }

    IFACEMETHODIMP FindText(BSTR string, BOOL backwards, BOOL ignore_case, ITextRangeProvider** result) override { return E_NOTIMPL; }

    IFACEMETHODIMP GetAttributeValue(TEXTATTRIBUTEID attribute_id, VARIANT* value) override { return E_NOTIMPL; }

    IFACEMETHODIMP GetBoundingRectangles(SAFEARRAY** rectangles) override { return E_NOTIMPL; }

    IFACEMETHODIMP GetEnclosingElement(IRawElementProviderSimple** element) override { return E_NOTIMPL; }

    IFACEMETHODIMP GetText(int max_count, BSTR* text) override { return E_NOTIMPL; }

    IFACEMETHODIMP Move(TextUnit unit, int count, int* units_moved) override { return E_NOTIMPL; }

    IFACEMETHODIMP MoveEndpointByUnit(TextPatternRangeEndpoint endpoint, TextUnit unit, int count, int* units_moved) override { return E_NOTIMPL; }

    IFACEMETHODIMP MoveEndpointByRange(TextPatternRangeEndpoint this_endpoint, ITextRangeProvider* other, TextPatternRangeEndpoint other_endpoint) override { return E_NOTIMPL; }
    ...
    IFACEMETHODIMP ScrollIntoView(BOOL align_to_top) override { return E_NOTIMPL; }

    IFACEMETHODIMP GetChildren(SAFEARRAY** children) override { return E_NOTIMPL; }
};
...
TEST_F(AXPlatformNodeTextRangeProviderTest, TestITextRangeProviderCompareEndpoints)
{
    ...
    EXPECT_HRESULT_SUCCEEDED(
        document_text_range_provider->CompareEndpoints(TextPatternRangeEndpoint_Start, document_text_range_provider.Get(), TextPatternRangeEndpoint_Start, &result));
    EXPECT_EQ(0, result);

    EXPECT_HRESULT_SUCCEEDED(
        document_text_range_provider->CompareEndpoints(TextPatternRangeEndpoint_End, document_text_range_provider.Get(), TextPatternRangeEndpoint_End, &result));
    EXPECT_EQ(0, result);

    EXPECT_HRESULT_SUCCEEDED(
        document_text_range_provider->CompareEndpoints(TextPatternRangeEndpoint_Start, document_text_range_provider.Get(), TextPatternRangeEndpoint_End, &result));
    EXPECT_EQ(-1, result);

    EXPECT_HRESULT_SUCCEEDED(
        document_text_range_provider->CompareEndpoints(TextPatternRangeEndpoint_End, document_text_range_provider.Get(), TextPatternRangeEndpoint_Start, &result));
    EXPECT_EQ(1, result);
    ...
    // "more text".
    EXPECT_HRESULT_SUCCEEDED(text_range_provider->CompareEndpoints(TextPatternRangeEndpoint_Start, more_text_range_provider.Get(), TextPatternRangeEndpoint_Start, &result));
    EXPECT_EQ(-1, result);

    EXPECT_HRESULT_SUCCEEDED(text_range_provider->CompareEndpoints(TextPatternRangeEndpoint_End, more_text_range_provider.Get(), TextPatternRangeEndpoint_Start, &result));
    EXPECT_EQ(0, result);
    ...
    EXPECT_HRESULT_SUCCEEDED(text_range_provider->CompareEndpoints(TextPatternRangeEndpoint_Start, document_text_range_provider.Get(), TextPatternRangeEndpoint_Start, &result));
    EXPECT_EQ(0, result);

    EXPECT_HRESULT_SUCCEEDED(text_range_provider->CompareEndpoints(TextPatternRangeEndpoint_End, document_text_range_provider.Get(), TextPatternRangeEndpoint_End, &result));
    EXPECT_EQ(-1, result);

    // Compare the endpoints of "more text" with those of the entire document.
    EXPECT_HRESULT_SUCCEEDED(
        more_text_range_provider->CompareEndpoints(TextPatternRangeEndpoint_Start, document_text_range_provider.Get(), TextPatternRangeEndpoint_Start, &result));
    EXPECT_EQ(1, result);

    EXPECT_HRESULT_SUCCEEDED(more_text_range_provider->CompareEndpoints(TextPatternRangeEndpoint_End, document_text_range_provider.Get(), TextPatternRangeEndpoint_End, &result));
    EXPECT_EQ(0, result);
}
...
TEST_F(AXPlatformNodeTextRangeProviderTest, TestITextRangeProviderExpandToEnclosingFormat)
{
    ...
    // Case 1: Degenerate range at start of A.
    {
        ...
        ASSERT_HRESULT_SUCCEEDED(test_case_provider->MoveEndpointByRange(TextPatternRangeEndpoint_End, test_case_provider.Get(), TextPatternRangeEndpoint_Start));
    ...
    // Case 4: Range from start of A to middle of B.
    {
        ...
        ASSERT_HRESULT_SUCCEEDED(unit_a_provider->Clone(&test_case_provider));
        CopyOwnerToClone(unit_a_provider.Get(), test_case_provider.Get());
        ASSERT_HRESULT_SUCCEEDED(test_case_provider->MoveEndpointByUnit(TextPatternRangeEndpoint_End, TextUnit_Character, /*count*/ 4, &count));
        ASSERT_EQ(4, count);
        EXPECT_UIA_TEXTRANGE_EQ(test_case_provider, L"Paragraph 1\nPara");
...
TEST_F(AXPlatformNodeTextRangeProviderTest, TestITextRangeProviderExpandToEnclosingFormatWithEmptyObjects)
{
    ...
    generic_container_5.AddBoolAttribute(ax::mojom::BoolAttribute::kIsLineBreakingObject, true);
...
TEST_F(AXPlatformNodeTextRangeProviderTest, TestITextRangeProviderIgnoredForTextNavigation)
{
    ...
    root_1.role = ax::mojom::Role::kRootWebArea;
    root_1.child_ids = { static_text_2.id, splitter_4.id, static_text_5.id, generic_container_7.id, static_text_8.id };
    ...
    splitter_4.AddBoolAttribute(ax::mojom::BoolAttribute::kIsLineBreakingObject, true);
    ...
    generic_container_7.AddBoolAttribute(ax::mojom::BoolAttribute::kIsLineBreakingObject, true);
    ...
    update.has_tree_data = true;
    update.root_id = root_1.id;
    update.nodes = { root_1, static_text_2, inline_box_3, splitter_4, static_text_5, inline_box_6, generic_container_7, static_text_8, inline_box_9 };
...
TEST_F(AXPlatformNodeTextRangeProviderTest, TestITextRangeProviderInvalidCalls)
{
    ...
    // validate call.
    {
        ...
        EXPECT_UIA_ELEMENTNOTAVAILABLE(
            text_range_provider->CompareEndpoints(TextPatternRangeEndpoint_Start, text_range_provider.Get(), TextPatternRangeEndpoint_Start, &compare_endpoints_result));
        ...
        EXPECT_UIA_ELEMENTNOTAVAILABLE(text_range_provider->MoveEndpointByRange(TextPatternRangeEndpoint_Start, text_range_provider.Get(), TextPatternRangeEndpoint_Start));
    ...
    // performed on the other provider.
    {
        ...
        EXPECT_UIA_INVALIDOPERATION(
            this_provider->CompareEndpoints(TextPatternRangeEndpoint_Start, other_provider_different_type.Get(), TextPatternRangeEndpoint_Start, &compare_endpoints_result));

        EXPECT_UIA_INVALIDOPERATION(this_provider->MoveEndpointByRange(TextPatternRangeEndpoint_Start, other_provider_different_type.Get(), TextPatternRangeEndpoint_Start));
    }
}
...
TEST_F(AXPlatformNodeTextRangeProviderTest, TestITextRangeProviderGetEnclosingElement)
{
    ...
    update.has_tree_data = true;
    update.root_id = root_data.id;
    update.nodes = { root_data, paragraph_data, static_text_data1, inline_text_data1, link_data, static_text_data2, inline_text_data2, link_data2, list_data, list_item_data,
        static_text_data3, inline_text_data3, search_box, search_text, pdf_highlight_data, static_text_data4, inline_text_data4 };
    Init(update);
...
TEST_F(AXPlatformNodeTextRangeProviderTest, TestITextRangeProviderMoveEndpointByRange)
{
    ...
    EXPECT_HRESULT_SUCCEEDED(document_text_range_provider->MoveEndpointByRange(TextPatternRangeEndpoint_Start, document_text_range_provider.Get(), TextPatternRangeEndpoint_End));
    ...
    EXPECT_HRESULT_SUCCEEDED(document_text_range_provider->MoveEndpointByRange(TextPatternRangeEndpoint_Start, more_text_range_provider.Get(), TextPatternRangeEndpoint_Start));
    ...
    EXPECT_HRESULT_SUCCEEDED(document_text_range_provider->MoveEndpointByRange(TextPatternRangeEndpoint_End, text_range_provider.Get(), TextPatternRangeEndpoint_End));
    ...
    EXPECT_HRESULT_SUCCEEDED(more_text_range_provider->MoveEndpointByRange(TextPatternRangeEndpoint_End, text_range_provider.Get(), TextPatternRangeEndpoint_Start));
    ...
    EXPECT_HRESULT_SUCCEEDED(text_range_provider->MoveEndpointByRange(TextPatternRangeEndpoint_Start, more_text_range_provider.Get(), TextPatternRangeEndpoint_End));
...
TEST_F(AXPlatformNodeTextRangeProviderTest, TestITextRangeProviderGetAttributeValue)
{
    ...
    text_data.AddIntListAttribute(ax::mojom::IntListAttribute::kMarkerTypes,
        { (int)ax::mojom::MarkerType::kGrammar, (int)ax::mojom::MarkerType::kSpelling, (int)ax::mojom::MarkerType::kHighlight, (int)ax::mojom::MarkerType::kHighlight,
            (int)ax::mojom::MarkerType::kHighlight });
    text_data.AddIntListAttribute(ax::mojom::IntListAttribute::kHighlightTypes,
        { (int)ax::mojom::HighlightType::kNone, (int)ax::mojom::HighlightType::kNone, (int)ax::mojom::HighlightType::kHighlight, (int)ax::mojom::HighlightType::kSpellingError,
...

    {
        ...
        EXPECT_HRESULT_SUCCEEDED(text_range_provider->GetAttributeValue(UIA_CultureAttributeId, lang_variant.Receive()));
...

    {
        ...
        EXPECT_UIA_TEXTATTRIBUTE_MIXED(text_range_provider, UIA_AnnotationTypesAttributeId);
        ...
        CreateTextRangeProviderWin(range_with_annotations, owner, tree_data.tree_id,
...

    {
        ...
        EXPECT_UIA_TEXTATTRIBUTE_MIXED(heading_text_range_provider, UIA_AnnotationTypesAttributeId);
...
TEST_F(AXPlatformNodeTextRangeProviderTest, TestITextRangeProviderGetAttributeValueAnnotationObjects)
{
    ...
    CreateTextRangeProviderWin(some_text_range_provider, owner, update.tree_data.tree_id,
...
TEST_F(AXPlatformNodeTextRangeProviderTest, TestITextRangeProviderGetAttributeValueAnnotationObjectsMixed)
{
    ...
    CreateTextRangeProviderWin(mixed_text_range_provider, owner, update.tree_data.tree_id,
...
TEST_F(AXPlatformNodeTextRangeProviderTest, TestITextRangeProviderGetAttributeValueWithAncestorTextPosition)
{
    ...
    AXPlatformNodeWin* owner = static_cast<AXPlatformNodeWin*>(AXPlatformNodeFromNode(GetNodeFromTree(tree_id, 2)));
    ...
    CreateTextRangeProviderWin(text_range_provider_win, owner, tree_id,
...
TEST_F(AXPlatformNodeTextRangeProviderTest, FindTextWithEmbeddedObjectCharacter)
{
    ...
    update.has_tree_data = true;
    update.root_id = root_1.id;
    update.nodes = { root_1, list_2, list_item_3, static_text_4, inline_box_5, list_item_6, static_text_7, inline_box_8 };
...
TEST_F(AXPlatformNodeTextRangeProviderTest, TestITextRangeProviderIgnoredNodes)
{
    ...
    tree_update.nodes[1].AddBoolAttribute(ax::mojom::BoolAttribute::kNonAtomicTextFieldRoot, true);
    ...
    Init(tree_update);
    EXPECT_ENCLOSING_ELEMENT(GetNodeFromTree(tree_id, 1), GetNodeFromTree(tree_id, 1));
    EXPECT_ENCLOSING_ELEMENT(GetNodeFromTree(tree_id, 2), GetNodeFromTree(tree_id, 1));
    EXPECT_ENCLOSING_ELEMENT(GetNodeFromTree(tree_id, 3), GetNodeFromTree(tree_id, 3));
    EXPECT_ENCLOSING_ELEMENT(GetNodeFromTree(tree_id, 4), GetNodeFromTree(tree_id, 4));
    EXPECT_ENCLOSING_ELEMENT(GetNodeFromTree(tree_id, 5), GetNodeFromTree(tree_id, 5));
    EXPECT_ENCLOSING_ELEMENT(GetNodeFromTree(tree_id, 8), GetNodeFromTree(tree_id, 1));
    EXPECT_ENCLOSING_ELEMENT(GetNodeFromTree(tree_id, 11), GetNodeFromTree(tree_id, 11));
    EXPECT_ENCLOSING_ELEMENT(GetNodeFromTree(tree_id, 13), GetNodeFromTree(tree_id, 13));
    EXPECT_ENCLOSING_ELEMENT(GetNodeFromTree(tree_id, 14), GetNodeFromTree(tree_id, 14));

    // Test movement and GetText()
    ComPtr<ITextRangeProvider> text_range_provider;
    GetTextRangeProviderFromTextNode(text_range_provider, GetNodeFromTree(tree_id, 1));
...
TEST_F(AXPlatformNodeTextRangeProviderTest, TestNormalizeTextRangePastEndOfDocument)
{
    ...
    ComPtr<ITextRangeProvider> text_range_provider;
    GetTextRangeProviderFromTextNode(text_range_provider, GetNodeFromTree(tree_id, 3));
...
TEST_F(AXPlatformNodeTextRangeProviderTest, TestNormalizeTextRangeInsideIgnoredNodes)
{
    ...
    AXPlatformNodeWin* owner = static_cast<AXPlatformNodeWin*>(AXPlatformNodeFromNode(GetNodeFromTree(tree_id, 1)));
    ...
    CreateTextRangeProviderWin(ignored_range_win, owner, tree_id,
...
TEST_F(AXPlatformNodeTextRangeProviderTest, TestNormalizeTextRangeSpanIgnoredNodes)
{
    ...
    update.has_tree_data = true;
    update.nodes = { root_data, before_text, ignored_text1, ignored_text2, after_text };
    Init(update);
    ...
    CreateTextRangeProviderWin(range_span_ignored_nodes, owner, tree_id,
...
TEST_F(AXPlatformNodeTextRangeProviderTest, TestNormalizeTextRangeForceSameAnchorOnDegenerateRange)
{
    ...
    generic_container_2.AddBoolAttribute(ax::mojom::BoolAttribute::kIsLineBreakingObject, true);
    ...
    AXPlatformNodeWin* owner = static_cast<AXPlatformNodeWin*>(AXPlatformNodeFromNode(GetNodeFromTree(tree_data.tree_id, 1)));
    ...
    CreateTextRangeProviderWin(range, owner, tree_data.tree_id,
...
TEST_F(AXPlatformNodeTextRangeProviderTest, TestValidateStartAndEnd)
{
    ...
    CreateTextRangeProviderWin(text_range_provider, owner, tree_id,
...
TEST_F(AXPlatformNodeTextRangeProviderTest, TestReplaceStartAndEndEndpointNode)
{
    ...
    ComPtr<AXPlatformNodeTextRangeProviderWin> range;
    CreateTextRangeProviderWin(range, owner, tree_id,
    ...
    // 3. Replace the node on which |start_| and |end_| is.
    {
        ...
        CreateTextRangeProviderWin(range_2, owner, tree_id,
...
TEST_F(AXPlatformNodeTextRangeProviderTest, TestDeleteTreePositionPreviousSibling)
{
    ...
    AXNodePosition::AXPositionInstance range_start = AXNodePosition::CreateTreePosition(*tree, *generic_container_2_node,
        /*child_index*/ 3);
...
TEST_F(AXPlatformNodeTextRangeProviderTest, CaretAtEndOfTextFieldReadOnly)
{
    ...
    generic_container_3.AddBoolAttribute(ax::mojom::BoolAttribute::kIsLineBreakingObject, true);
    ...
    update.tree_data.tree_id = tree_id;
    update.has_tree_data = true;
    update.nodes = { root_1, text_field_2, generic_container_3, static_text_4, inline_text_5, static_text_6, inline_text_7 };
    Init(update);
...
TEST_F(AXPlatformNodeTextRangeProviderTest, GeneratedNewlineReturnsCommonAnchorReadonly)
{
    ...
    root_1.role = ax::mojom::Role::kRootWebArea;
    root_1.child_ids = { generic_container_2.id, generic_container_5.id, generic_container_8.id };

    generic_container_2.role = ax::mojom::Role::kGenericContainer;
    generic_container_2.child_ids = { image_3.id, text_field_4.id };

    image_3.role = ax::mojom::Role::kImage;
    image_3.AddBoolAttribute(ax::mojom::BoolAttribute::kIsLineBreakingObject, true);
    ...
    image_6.AddBoolAttribute(ax::mojom::BoolAttribute::kIsLineBreakingObject, true);
    ...
    text_field_9.AddBoolAttribute(ax::mojom::BoolAttribute::kIsLineBreakingObject, true);
    ...
    update.tree_data.tree_id = tree_id;
    update.has_tree_data = true;
    update.nodes = { root_1, generic_container_2, image_3, text_field_4, generic_container_5, image_6, text_field_7, generic_container_8, text_field_9, text_field_10 };
    Init(update);
    ...
    CreateTextRangeProviderWin(range_1, owner, tree_id,
    ...
    CreateTextRangeProviderWin(range_3, owner, tree_id,
