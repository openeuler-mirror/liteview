...
void AXLanguageInfoStats::InvalidateTopResults() { top_results_valid_ = false; }
...
void AXLanguageInfoStats::RecordDetectionAttempt() { ++count_detection_attempted_; }
...
AXLanguageDetectionObserver::~AXLanguageDetectionObserver() { tree_->RemoveObserver(this); }

void AXLanguageDetectionObserver::OnAtomicUpdateFinished(ui::AXTree* tree, bool root_changed, const std::vector<Change>& changes)
{
