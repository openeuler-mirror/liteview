...
size_t FuzzerData::RemainingBytes() { return data_size_ - data_index_; }
...
ui::AXTree* AXTreeFuzzerGenerator::GetTree() { return tree_manager_.GetTree(); }
...
void AXTreeFuzzerGenerator::RecursiveGenerateUpdate(const ui::AXNode* node, ui::AXTreeUpdate& tree_update, FuzzerData& fuzz_data, std::set<ui::AXNodeID>& updated_nodes)
{
    ...
    case kRemoveNode: {
        ...
        parent_update.child_ids.erase(std::remove(parent_update.child_ids.begin(), parent_update.child_ids.end(), node->id()), parent_update.child_ids.end());
...
ui::AXNodeID AXTreeFuzzerGenerator::GetMaxAssignedID() const { return max_assigned_node_id_; }
