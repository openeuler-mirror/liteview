...
public:
    ...
    const std::set<AXNodeID>& live_region_roots_with_changes() const { return live_region_roots_with_changes_; }

private:
    void WalkTreeAndAssignLiveRootsToNodes(const AXNode& node, const AXNode* current_root);
