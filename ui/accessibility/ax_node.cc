...
AXNodeData&& AXNode::TakeData() { return std::move(data_); }
...
AXNode* AXNode::GetLowestCommonAncestor(const AXNode& other)
{
    ...
    base::stack<AXNode*> other_ancestors = other.GetAncestorsCrossingTreeBoundary();
...
bool AXNode::IsLineBreak() const
{
    ...
    // character.
    return GetRole() == ax::mojom::Role::kLineBreak || (GetRole() == ax::mojom::Role::kInlineTextBox && GetBoolAttribute(ax::mojom::BoolAttribute::kIsLineBreakingObject));
}

void AXNode::SetData(const AXNodeData& src) { data_ = src; }
...
void AXNode::SetIndexInParent(size_t index_in_parent) { index_in_parent_ = index_in_parent; }
...
void AXNode::SwapChildren(std::vector<AXNode*>* children) { children->swap(children_); }
...
SkColor AXNode::ComputeColor() const { return ComputeColorAttribute(ax::mojom::IntAttribute::kColor); }

SkColor AXNode::ComputeBackgroundColor() const { return ComputeColorAttribute(ax::mojom::IntAttribute::kBackgroundColor); }
...
AXTreeManager* AXNode::GetManager() const { return AXTreeManager::FromID(tree_->GetAXTreeID()); }
...
bool AXNode::HasStringAttribute(ax::mojom::StringAttribute attribute) const { return GetComputedNodeData().HasOrCanComputeAttribute(attribute); }

const std::string& AXNode::GetStringAttribute(ax::mojom::StringAttribute attribute) const { return GetComputedNodeData().GetOrComputeAttributeUTF8(attribute); }

bool AXNode::GetStringAttribute(ax::mojom::StringAttribute attribute, std::string* value) const
{
...
std::u16string AXNode::GetString16Attribute(ax::mojom::StringAttribute attribute) const { return GetComputedNodeData().GetOrComputeAttributeUTF16(attribute); }

bool AXNode::GetString16Attribute(ax::mojom::StringAttribute attribute, std::u16string* value) const
{
    if (GetComputedNodeData().HasOrCanComputeAttribute(attribute)) {
...
std::u16string AXNode::GetInheritedString16Attribute(ax::mojom::StringAttribute attribute) const { return base::UTF8ToUTF16(GetInheritedStringAttribute(attribute)); }

bool AXNode::HasIntListAttribute(ax::mojom::IntListAttribute attribute) const { return GetComputedNodeData().HasOrCanComputeAttribute(attribute); }

const std::vector<int32_t>& AXNode::GetIntListAttribute(ax::mojom::IntListAttribute attribute) const { return GetComputedNodeData().GetOrComputeAttribute(attribute); }

bool AXNode::GetIntListAttribute(ax::mojom::IntListAttribute attribute, std::vector<int32_t>* value) const
{
    if (GetComputedNodeData().HasOrCanComputeAttribute(attribute)) {
...
AXLanguageInfo* AXNode::GetLanguageInfo() const { return language_info_.get(); }

void AXNode::SetLanguageInfo(std::unique_ptr<AXLanguageInfo> lang_info) { language_info_ = std::move(lang_info); }

void AXNode::ClearLanguageInfo() { language_info_.reset(); }
...
void AXNode::ClearComputedNodeData() { computed_node_data_.reset(); }

const std::string& AXNode::GetNameUTF8() const
{
    DCHECK(!tree_->GetTreeUpdateInProgressState());
    const AXNode* node = this;
    if (GetRole() == ax::mojom::Role::kPortal && GetNameFrom() == ax::mojom::NameFrom::kNone) {
        const AXTreeManager* child_tree_manager = AXTreeManager::ForChildTree(*this);
        if (child_tree_manager)
...
gfx::RectF AXNode::GetTextContentRangeBoundsUTF8(int start_offset, int end_offset) const
{
    DCHECK(!tree_->GetTreeUpdateInProgressState());
    ...
    if (!base::UTF8ToUTF16(GetTextContentUTF8().data(), base::checked_cast<size_t>(start_offset), &out_trancated_string_utf16)) {
        return gfx::RectF();
    }
    start_offset = base::checked_cast<int>(out_trancated_string_utf16.length());
    if (!base::UTF8ToUTF16(GetTextContentUTF8().data(), base::checked_cast<size_t>(end_offset), &out_trancated_string_utf16)) {
        return gfx::RectF();
    }
...
std::ostream& operator<<(std::ostream& stream, const AXNode& node) { return stream << node.data().ToString(); }

bool AXNode::IsTable() const { return IsTableLike(GetRole()); }
...
bool AXNode::IsTableRow() const { return ui::IsTableRow(GetRole()); }
...
bool AXNode::IsTableColumn() const { return ui::IsTableColumn(GetRole()); }
...
bool AXNode::IsTableCellOrHeader() const { return IsCellOrTableHeader(GetRole()); }
...
absl::optional<int> AXNode::GetTableCellAriaColIndex() const
{
    ...
    return (aria_col_index > 0) ? absl::optional<int>(aria_col_index) : absl::nullopt;
}
...
absl::optional<int> AXNode::GetTableCellAriaRowIndex() const
{
    ...
    return (aria_row_index > 0) ? absl::optional<int>(aria_row_index) : absl::nullopt;
}
...
absl::optional<int> AXNode::GetPosInSet() { return tree_->GetPosInSet(*this); }

// Uses AXTree's cache to calculate node's SetSize.
absl::optional<int> AXNode::GetSetSize() { return tree_->GetSetSize(*this); }
...
bool AXNode::SetRoleMatchesItemRole(const AXNode* ordered_set) const
{
    ...
    case ax::mojom::Role::kGroup:
        return item_role == ax::mojom::Role::kComment || item_role == ax::mojom::Role::kListItem || item_role == ax::mojom::Role::kMenuItem
            || item_role == ax::mojom::Role::kMenuItemRadio || item_role == ax::mojom::Role::kListBoxOption || item_role == ax::mojom::Role::kTreeItem;
    ...
    case ax::mojom::Role::kDescriptionList:
        ...
        // and setsize.
        return item_role == ax::mojom::Role::kDescriptionListTerm || item_role == ax::mojom::Role::kTerm;
...
{
    return IsIgnored() || IsEmbeddedGroup() || GetRole() == ax::mojom::Role::kLabelText || GetRole() == ax::mojom::Role::kListItem
        || GetRole() == ax::mojom::Role::kGenericContainer || GetRole() == ax::mojom::Role::kScrollView || GetRole() == ax::mojom::Role::kUnknown;
}
...
bool AXNode::IsRowInTreeGrid(const AXNode* ordered_set) const
{
    ...
    if (GetRole() != ax::mojom::Role::kRow || !HasState(ax::mojom::State::kFocusable) || !ordered_set) {
        return false;
    }
...
std::string AXNode::GetTextForRangeValue() const
{
    ...
    float numeric_value;
    if (range_value.empty() && GetFloatAttribute(ax::mojom::FloatAttribute::kValueForRange, &numeric_value)) {
...
bool AXNode::IsInvisibleOrIgnored() const { return id() != tree_->data().focus_id && (IsIgnored() || data_.IsInvisible()); }
...
bool AXNode::IsCollapsedMenuListSelect() const { return HasState(ax::mojom::State::kCollapsed) && GetRole() == ax::mojom::Role::kComboBoxSelect; }
