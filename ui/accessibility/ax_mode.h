...
public:
    ...
    void set_mode(uint32_t flag, bool value) { flags_ = value ? (flags_ | flag) : (flags_ & ~flag); }
...
static constexpr AXMode kAXModeBasic(AXMode::kNativeAPIs | AXMode::kWebContents);
...
static constexpr AXMode kAXModeCompleteNoHTML(AXMode::kNativeAPIs | AXMode::kWebContents | AXMode::kInlineTextBoxes | AXMode::kScreenReader);
