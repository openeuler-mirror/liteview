...
int TreeGenerator::UniqueTreeCount() const { return total_unique_tree_count_; }
...
void TreeGenerator::BuildUniqueTreeWithIgnoredNodes(int tree_index, int ignored_index, absl::optional<int> focused_node, AXTree* out_tree) const
{
