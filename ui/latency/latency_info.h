...
public:
    ...
    // static void TraceIntermediateFlowEvents(const std::vector<LatencyInfo>& latency_info, perfetto::protos::pbzero::ChromeLatencyInfo::Step step);
    ...
    void AddLatencyNumberWithTraceName(LatencyComponentType component, const char* trace_name_str);
    ...
    const SourceEventType& source_event_type() const { return source_event_type_; }
    void set_source_event_type(SourceEventType type) { source_event_type_ = type; }
