...
public:
    ...
    virtual void OnDragEnter(const gfx::PointF& point, std::unique_ptr<OSExchangeData> data, int operation, int modifiers) = 0;
    ...
    virtual int OnDragMotion(const gfx::PointF& point, int operation, int modifiers) = 0;
    ...
    // |modifiers| contains bitmask of ui::EventFlags that accompany the event.
    virtual void OnDragDrop(std::unique_ptr<OSExchangeData> data, int modifiers) = 0;
