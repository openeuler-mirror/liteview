...
bool EnumTraits<display::mojom::TouchSupport, display::Display::TouchSupport>::FromMojom(display::mojom::TouchSupport touch_support, display::Display::TouchSupport* out)
{
    switch (touch_support) {
