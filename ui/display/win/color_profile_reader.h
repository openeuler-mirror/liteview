...
private:
    ...
    static ColorProfileReader::DeviceToPathMap BuildDeviceToPathMapOnBackgroundThread();
    ...
    // main thread.
    static DeviceToDataMap ReadProfilesOnBackgroundThread(DeviceToPathMap new_device_to_path_map);
