...
public:
    ...
    // host.
    virtual absl::optional<bool> IsWindowOnCurrentVirtualDesktop(gfx::NativeWindow window) const;
...
protected:
    ...
    virtual MONITORINFOEX MonitorInfoFromScreenPoint(const gfx::Point& screen_point) const;
    virtual MONITORINFOEX MonitorInfoFromScreenRect(const gfx::Rect& screen_rect) const;
    virtual MONITORINFOEX MonitorInfoFromWindow(HWND hwnd, DWORD default_options) const;
