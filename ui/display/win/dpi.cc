...
int GetDPIFromScalingFactor(float device_scaling_factor) { return kDefaultDPI * device_scaling_factor; }

double GetAccessibilityFontScale() { return 1.0 / UwpTextScaleFactor::Instance()->GetTextScaleFactor(); }
...
float GetUnforcedDeviceScaleFactor() { return g_device_scale_factor ? g_device_scale_factor : GetScalingFactorFromDPI(GetDefaultSystemDPI()); }

float GetScalingFactorFromDPI(int dpi) { return static_cast<float>(dpi) / kDefaultDPI; }
