...
::testing::AssertionResult SkColorSpacePrimariesEquals(const char* lhs_expr, const char* rhs_expr, const SkColorSpacePrimaries& lhs, const SkColorSpacePrimaries& rhs)
{
...
struct TestParams {
    ...
    { 0x22f0u, 0x6c28u, kGenericBlockZeroHashedSerialNumber, kNormalDisplayHashedDescriptorBlockSerialNumber, gfx::Size(64, 40),
        "HP Z 30w", // non-ascii char in display name.
        gfx::Size(2560, 1600), 2, 2012, false, 2.2, 10, kNormalDisplayPrimaries, 586181672, 9834990092472576, 1713305697, "HWP", "286C", {}, {}, absl::nullopt, absl::nullopt,
        absl::nullopt, kBadDisplayName, kBadDisplayNameLength },
    { 0x22f0u, 0x6c28u, kGenericBlockZeroHashedSerialNumber, kNormalDisplayHashedDescriptorBlockSerialNumber, gfx::Size(64, 40), "HP ZR30w", gfx::Size(2560, 1600), 2, 2012, false,
        2.2, 10, kNormalDisplayPrimaries, 586181672, 9834734971736576, 51468448, "HWP", "286C", {}, {}, absl::nullopt, absl::nullopt, absl::nullopt, kNormalDisplay,
        kNormalDisplayLength },
    { 0x22f0u, 0x6c28u, kGenericBlockZeroHashedSerialNumber, kNormalDisplayHashedDescriptorBlockSerialNumber, kNoMaxImageSize, "HP ZR30w", gfx::Size(2560, 1600), 2, 2012, false,
        2.2, 10, kNormalDisplayPrimaries, 586181672, 9834734971736576, 403808854, "HWP", "286C", {}, {}, absl::nullopt, absl::nullopt, absl::nullopt, kNoMaxImageSizeDisplay,
        kNoMaxImageSizeDisplayLength },
    { 0x22f0u, 0x6c28u, kGenericBlockZeroHashedSerialNumber, kNoSerialNumber, gfx::Size(64, 40), "HP ZR30w", gfx::Size(2560, 1600), 2, 2012, false, 2.2, 10,
        kNormalDisplayPrimaries, 586181672, 9834734971736576, 3094128629, "HWP", "286C", {}, {}, absl::nullopt, absl::nullopt, absl::nullopt, kBlockZeroSerialNumberOnlyDisplay,
        kBlockZeroSerialNumberOnlyDisplayLength },
    { 0x22f0u, 0x6c28u, kNoSerialNumber, kNoSerialNumber, gfx::Size(64, 40), "HP ZR30w", gfx::Size(2560, 1600), 2, 2012, false, 2.2, 10, kNormalDisplayPrimaries, 586181672,
        9834734971736576, 2769865770, "HWP", "286C", {}, {}, absl::nullopt, absl::nullopt, absl::nullopt, kNoSerialNumberDisplay, kNoSerialNumberDisplayLength },
    { 0x22f0u, 0x6c28u, kGenericBlockZeroHashedSerialNumber, kNormalDisplayHashedDescriptorBlockSerialNumber, gfx::Size(64, 40), "HP ZR30w", gfx::Size(2560, 1600),
        kNoWeekOfManufactureTag, 2012, false, 2.2, 10, kNormalDisplayPrimaries, 586181672, 9834734971736576, 4082014303, "HWP", "286C", {}, {}, absl::nullopt, absl::nullopt,
        absl::nullopt, kNoWeekOfManufactureDisplay, kNoWeekOfManufactureDisplayLength },
    { 0x22f0u, 0x6c28u, kGenericBlockZeroHashedSerialNumber, kNormalDisplayHashedDescriptorBlockSerialNumber, gfx::Size(64, 40), "HP ZR30w", gfx::Size(2560, 1600), kModelYearTag,
        2012, false, 2.2, 10, kNormalDisplayPrimaries, 586181672, 9834734971736576, 1070357245, "HWP", "286C", {}, {}, absl::nullopt, absl::nullopt, absl::nullopt,
        kModelYearDisplay, kModelYearDisplayLength },
    { 0x4ca3u, 0x4231u, kNoSerialNumber, kNoSerialNumber, gfx::Size(26, 16), "", gfx::Size(1280, 800), kNoWeekOfManufactureTag, 2011, false, 2.2, -1, kInternalDisplayPrimaries,
        1285767729, 21571318625337344, 1646280528, "SEC", "3142", {}, {}, absl::nullopt, absl::nullopt, absl::nullopt, kInternalDisplay, kInternalDisplayLength },
    { 0x4c2du, 0xfe08u, kNoSerialNumber, kNoSerialNumber, gfx::Size(16, 9), "SAMSUNG", gfx::Size(1920, 1080), 41, 2011, true, 2.2, -1, kOverscanDisplayPrimaries, 1278082568,
        21442559853606400, 3766836601, "SAM", "08FE", {}, {}, absl::nullopt, 24, 75, kOverscanDisplay, kOverscanDisplayLength },
    { 0x10ACu, 0x6440u,
        base::MD5String("842018892"), // == LSB of 0x4c, 0x30, 0x30, 0x32
        base::MD5String("PH5NY13N200L"), gfx::Size(64, 40), "DELL U3011", gfx::Size(1920, 1200), 12, 2011, false, 2.2, -1, kMisdetectedDisplayPrimaries, 279733312,
        4692848143772416, 1487444765, "DEL", "4064", { gfx::ColorSpace::PrimaryID::BT709, gfx::ColorSpace::PrimaryID::SMPTE170M }, {}, absl::nullopt, 49, 86, kMisdetectedDisplay,
        kMisdetectedDisplayLength },
    { 0x22f0u, 0x7626u, kGenericBlockZeroHashedSerialNumber, base::MD5String("CNK80204HM"), gfx::Size(52, 33), "HP LP2465", gfx::Size(1920, 1200), 2, 2008, false, 2.2, -1,
        kLP2565APrimaries, 586184230, 9834630174887424, 1695949480, "HWP", "2676", {}, {}, absl::nullopt, 48, 85, kLP2565A, kLP2565ALength },
    { 0x22f0u, 0x7526u, kGenericBlockZeroHashedSerialNumber, base::MD5String("CNK80204HM"), gfx::Size(52, 33), "HP LP2465", gfx::Size(1920, 1200), 2, 2008, false, 2.2, -1,
        kLP2565BPrimaries, 586183974, 9834630174887424, 3357789438, "HWP", "2675", {}, {}, absl::nullopt, 48, 85, kLP2565B, kLP2565BLength },
    { 0x22f0u, 0x7532u, kGenericBlockZeroHashedSerialNumber, base::MD5String("CNC7270MW0"), gfx::Size(70, 39), "HP Z32x", gfx::Size(3840, 2160), 27, 2017, false, 2.2, 10,
        kHPz32xPrimaries, 586183986, 9834799315992832, 129207725, "HWP", "3275", {}, {}, absl::nullopt, 24, 60, kHPz32x, kHPz32xLength },
    { 0x30E4u, 0x2E04u, kNoSerialNumber, kNoSerialNumber, gfx::Size(27, 18), "", gfx::Size(2560, 1700), kNoWeekOfManufactureTag, 2014, false, 2.5, 8, kSamusPrimaries, 820260356,
        13761487533244416, 2825178591, "LGD", "042E", {}, {}, absl::nullopt, absl::nullopt, absl::nullopt, kSamus, kSamusLength },
    { 0x4D10u, 0x8A14u, kNoSerialNumber, kNoSerialNumber, gfx::Size(26, 17), "LQ123P1JX32", gfx::Size(2400, 1600), 22, 2017, false, 2.2, 8, kEvePrimaries, 1292929556,
        21692109949126656, 2755351929, "SHP", "148A", {}, {}, absl::nullopt, absl::nullopt, absl::nullopt, kEve, kEveLength },
    { 19501u, 62989u,
        base::MD5String("16780800"), // == LSB of 0x00, 0x0e, 0x00 0x01
        kNoSerialNumber, gfx::Size(95, 54), "SAMSUNG", gfx::Size(3840, 2160), 1, 2017, true, 2.2, -1, kHDRPrimaries, 1278080525, 21442559853606400, 755395064, "SAM", "0DF6",
        { gfx::ColorSpace::PrimaryID::BT709, gfx::ColorSpace::PrimaryID::SMPTE170M, gfx::ColorSpace::PrimaryID::BT2020 },
        { gfx::ColorSpace::TransferID::BT709, gfx::ColorSpace::TransferID::PQ, gfx::ColorSpace::TransferID::HLG },
        absl::make_optional<gfx::HDRStaticMetadata>(603.666, 530.095, 0.00454), 24, 75, kHDRMetadata, kHDRMetadataLength },

    // Empty Edid, which is tantamount to error.
    { 0, 0, kNoSerialNumber, kNoSerialNumber, gfx::Size(0, 0), "", gfx::Size(0, 0), kNoWeekOfManufactureTag, display::kInvalidYearOfManufacture, false, 0.0, -1,
        SkColorSpacePrimaries(), 0, 0,
        // Not zero because we're still hashing some string of zero/empty values.
        710538554, "@@@", "0000", {}, {}, absl::nullopt, absl::nullopt, absl::nullopt, nullptr, 0u },
};
...
TEST_P(EDIDParserTest, ParseEdids)
{
    ...
    EXPECT_EQ(GetParam().supported_color_primary_ids_, parser_.supported_color_primary_ids());
    EXPECT_EQ(GetParam().supported_color_transfer_ids_, parser_.supported_color_transfer_ids());

    const absl::optional<gfx::HDRStaticMetadata> hdr_static_metadata = parser_.hdr_static_metadata();
    EXPECT_EQ(GetParam().hdr_static_metadata_.has_value(), hdr_static_metadata.has_value());
    if (GetParam().hdr_static_metadata_.has_value() && hdr_static_metadata.has_value()) {
        constexpr double epsilon = 0.001;
        EXPECT_NEAR(GetParam().hdr_static_metadata_->max, hdr_static_metadata->max, epsilon);
        EXPECT_NEAR(GetParam().hdr_static_metadata_->max_avg, hdr_static_metadata->max_avg, epsilon);
        EXPECT_NEAR(GetParam().hdr_static_metadata_->min, hdr_static_metadata->min, epsilon);
    }
