...
public:
    ...
    Rotation panel_rotation() const { return panel_rotation_ ? *panel_rotation_ : rotation_; }
    ...
    AccelerometerSupport accelerometer_support() const { return accelerometer_support_; }
    void set_accelerometer_support(AccelerometerSupport support) { accelerometer_support_ = support; }
    ...
    void set_depth_per_component(int depth_per_component) { depth_per_component_ = depth_per_component; }
    ...
    void set_display_frequency(int display_frequency) { display_frequency_ = display_frequency; }
