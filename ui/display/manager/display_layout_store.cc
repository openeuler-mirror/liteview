...
const DisplayLayout& DisplayLayoutStore::GetRegisteredDisplayLayout(const DisplayIdList& list) { return GetOrCreateRegisteredDisplayLayoutInternal(list, /*create=*/false); }
...
const DisplayLayout& DisplayLayoutStore::GetOrCreateRegisteredDisplayLayout(const DisplayIdList& list) { return GetOrCreateRegisteredDisplayLayoutInternal(list, /*create=*/true); }
