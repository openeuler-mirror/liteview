...
inline bool operator!=(const ManagedDisplayMode& lhs, const ManagedDisplayMode& rhs) { return !(lhs == rhs); }
...
public:
    ...
    void set_touch_support(Display::TouchSupport support) { touch_support_ = support; }
    ...
    void set_panel_orientation(PanelOrientation panel_orientation) { panel_orientation_ = panel_orientation; }
    ...
    const gfx::Insets& overscan_insets_in_dip() const { return overscan_insets_in_dip_; }
    ...
    Display::RotationSource active_rotation_source() const { return active_rotation_source_; }
    ...
    void set_from_native_platform(bool from_native_platform) { from_native_platform_ = from_native_platform; }
    ...
    const gfx::DisplayColorSpaces& display_color_spaces() const { return display_color_spaces_; }
    void set_display_color_spaces(const gfx::DisplayColorSpaces& display_color_spaces) { display_color_spaces_ = display_color_spaces; }

    uint32_t bits_per_channel() const { return bits_per_channel_; }
    void set_bits_per_channel(uint32_t bits_per_channel) { bits_per_channel_ = bits_per_channel; }

    bool is_aspect_preserving_scaling() const { return is_aspect_preserving_scaling_; }

    void set_is_aspect_preserving_scaling(bool value) { is_aspect_preserving_scaling_ = value; }

    // Maximum cursor size in native pixels.
    const gfx::Size& maximum_cursor_size() const { return maximum_cursor_size_; }
    void set_maximum_cursor_size(const gfx::Size& size) { maximum_cursor_size_ = size; }
    ...
    const gfx::RoundedCornersF& rounded_corners_radii() const { return rounded_corners_radii_; }
    void set_rounded_corners_radii(const gfx::RoundedCornersF radii) { rounded_corners_radii_ = radii; }
