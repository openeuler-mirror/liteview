...
DisplayIdList GenerateDisplayIdList(ForwardIterator first, ForwardIterator last, Generator generator = Generator())
{
    DisplayIdList list;
...
DISPLAY_MANAGER_EXPORT display::ManagedDisplayInfo CreateDisplayInfo(int64_t id, const gfx::Rect& bounds);
...
DISPLAY_MANAGER_EXPORT MixedMirrorModeParamsErrors ValidateParamsForMixedMirrorMode(const DisplayIdList& connected_display_ids, const MixedMirrorModeParams& mixed_mode_params);
