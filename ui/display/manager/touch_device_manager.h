...
public:
    ...
    // connected to.
    struct WeakComp {
        bool operator()(const TouchDeviceIdentifier& lhs, const TouchDeviceIdentifier& rhs) const { return lhs.id() < rhs.id(); }
    };
...
public:
    ...
    const TouchAssociationMap& touch_associations() const { return touch_associations_; }

    const PortAssociationMap& port_associations() const { return port_associations_; }
