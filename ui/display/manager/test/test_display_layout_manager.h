...
public:
    TestDisplayLayoutManager(std::vector<std::unique_ptr<DisplaySnapshot>> displays, MultipleDisplayState display_state);
    ...
    void set_displays(std::vector<std::unique_ptr<DisplaySnapshot>> displays) { displays_ = std::move(displays); }

    void set_display_state(MultipleDisplayState display_state) { display_state_ = display_state; }
