...
public:
    ...
    // turned on/off.
    void set_forced_mirror_mode_for_tablet(bool forced) { forced_mirror_mode_for_tablet_ = forced; }

    bool forced_mirror_mode_for_tablet() const { return forced_mirror_mode_for_tablet_; }
