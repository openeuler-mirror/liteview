...
TEST_F(ApplyContentProtectionTaskTest, ApplyHdcpToInternalDisplay)
{
    ...
    ApplyContentProtectionTask task(&layout_manager, &display_delegate_, request, base::BindOnce(&ApplyContentProtectionTaskTest::ResponseCallback, base::Unretained(this)));
    task.Run();
