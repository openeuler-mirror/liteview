...
private:
    ...
    // transformed.
    void UpdateTouchTransform(int64_t target_display_id, const ManagedDisplayInfo& touch_display, const ManagedDisplayInfo& target_display, UpdateData* update_data) const;
