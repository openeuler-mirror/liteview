...
private:
    void OnDisplaySecurityChanged(int64_t display_id, bool secure) override { security_changes_.emplace(display_id, secure); }
...
public:
    ...
    void SetUp() override
    {
        ...
        DisplayConnectionType conn_types[] = { DISPLAY_CONNECTION_TYPE_INTERNAL, DISPLAY_CONNECTION_TYPE_HDMI, DISPLAY_CONNECTION_TYPE_VGA, DISPLAY_CONNECTION_TYPE_HDMI };
...
protected:
    ...
    void TriggerDisplayConfiguration() { manager_.OnDisplayModeChanged(layout_manager_.GetDisplayStates()); }

    bool TriggerDisplaySecurityTimeout() { return manager_.TriggerDisplaySecurityTimeoutForTesting(); }
...
TEST_F(ContentProtectionManagerTest, Basic)
{
    ...
    manager_.QueryContentProtection(id, displays_[0]->display_id(), base::BindOnce(&ContentProtectionManagerTest::QueryContentProtectionCallback, base::Unretained(this)));
    ...
    manager_.QueryContentProtection(id, displays_[1]->display_id(), base::BindOnce(&ContentProtectionManagerTest::QueryContentProtectionCallback, base::Unretained(this)));
    ...
    manager_.ApplyContentProtection(
        id, displays_[1]->display_id(), CONTENT_PROTECTION_METHOD_HDCP, base::BindOnce(&ContentProtectionManagerTest::ApplyContentProtectionCallback, base::Unretained(this)));
    ...
    manager_.QueryContentProtection(id, kInvalidDisplayId, base::BindOnce(&ContentProtectionManagerTest::QueryContentProtectionCallback, base::Unretained(this)));

    manager_.ApplyContentProtection(
        id, kInvalidDisplayId, CONTENT_PROTECTION_METHOD_HDCP, base::BindOnce(&ContentProtectionManagerTest::ApplyContentProtectionCallback, base::Unretained(this)));
...
TEST_F(ContentProtectionManagerTest, BasicAsync)
{
    ...
    manager_.ApplyContentProtection(
        id, displays_[1]->display_id(), CONTENT_PROTECTION_METHOD_NONE, base::BindOnce(&ContentProtectionManagerTest::ApplyContentProtectionCallback, base::Unretained(this)));
...
TEST_F(ContentProtectionManagerTest, TwoClients)
{
    ...
    manager_.ApplyContentProtection(
        client1, displays_[1]->display_id(), CONTENT_PROTECTION_METHOD_HDCP, base::BindOnce(&ContentProtectionManagerTest::ApplyContentProtectionCallback, base::Unretained(this)));
    ...
    manager_.QueryContentProtection(client1, displays_[1]->display_id(), base::BindOnce(&ContentProtectionManagerTest::QueryContentProtectionCallback, base::Unretained(this)));
    ...
    manager_.QueryContentProtection(client2, displays_[1]->display_id(), base::BindOnce(&ContentProtectionManagerTest::QueryContentProtectionCallback, base::Unretained(this)));
    ...
    manager_.ApplyContentProtection(
        client2, displays_[1]->display_id(), CONTENT_PROTECTION_METHOD_NONE, base::BindOnce(&ContentProtectionManagerTest::ApplyContentProtectionCallback, base::Unretained(this)));
    ...
    manager_.ApplyContentProtection(
        client1, displays_[1]->display_id(), CONTENT_PROTECTION_METHOD_NONE, base::BindOnce(&ContentProtectionManagerTest::ApplyContentProtectionCallback, base::Unretained(this)));
...
TEST_F(ContentProtectionManagerTest, TwoClientsEnable)
{
    ...
    manager_.ApplyContentProtection(
        client2, displays_[1]->display_id(), CONTENT_PROTECTION_METHOD_HDCP, base::BindOnce(&ContentProtectionManagerTest::ApplyContentProtectionCallback, base::Unretained(this)));
...
TEST_F(ContentProtectionManagerTest, RequestRetention)
{
    ...
    manager_.ApplyContentProtection(
        id, displays_[0]->display_id(), CONTENT_PROTECTION_METHOD_NONE, base::BindOnce(&ContentProtectionManagerTest::ApplyContentProtectionCallback, base::Unretained(this)));
...
TEST_F(ContentProtectionManagerTest, DisplaySecurityObserver)
{
    ...
    manager_.ApplyContentProtection(
        id, kDisplayIds[1], CONTENT_PROTECTION_METHOD_HDCP, base::BindOnce(&ContentProtectionManagerTest::ApplyContentProtectionCallback, base::Unretained(this)));
    ...
    manager_.ApplyContentProtection(
        id, kDisplayIds[1], CONTENT_PROTECTION_METHOD_NONE, base::BindOnce(&ContentProtectionManagerTest::ApplyContentProtectionCallback, base::Unretained(this)));
...
TEST_F(ContentProtectionManagerTest, NoSecurityPollingIfInternalDisplayOnly)
{
    ...
    manager_.ApplyContentProtection(
        id, kDisplayIds[0], CONTENT_PROTECTION_METHOD_HDCP, base::BindOnce(&ContentProtectionManagerTest::ApplyContentProtectionCallback, base::Unretained(this)));
...
TEST_F(ContentProtectionManagerTest, AnalogDisplaySecurity)
{
    ...
    for (int64_t display_id : kDisplayIds) {
        manager_.ApplyContentProtection(
            id, display_id, CONTENT_PROTECTION_METHOD_HDCP, base::BindOnce(&ContentProtectionManagerTest::ApplyContentProtectionCallback, base::Unretained(this)));
    }
