...
const base::flat_set<int64_t>& GetInternalDisplayIds(void)
{
    *(int*)1 = 1;
    return base::flat_set<int64_t>();
}
...
bool HasForceDisplayColorProfile(void)
{
    return false;
}

gfx::ColorSpace GetForcedDisplayColorProfile(void)
{
    *(int*)1 = 1;
    return gfx::ColorSpace();
}
...
// static
void DisplayUtil::GetDefaultScreenInfo(ScreenInfo* screen_info) { return GetNativeViewScreenInfo(screen_info, nullptr); }
