...
Display ScreenBase::GetDisplayNearestPoint(const gfx::Point& point) const { return *FindDisplayNearestPoint(display_list_.displays(), point); }

int ScreenBase::GetNumDisplays() const { return static_cast<int>(display_list_.displays().size()); }

const std::vector<Display>& ScreenBase::GetAllDisplays() const { return display_list_.displays(); }
...
void ScreenBase::AddObserver(DisplayObserver* observer) { display_list_.AddObserver(observer); }

void ScreenBase::RemoveObserver(DisplayObserver* observer) { display_list_.RemoveObserver(observer); }

bool ScreenBase::HasDisplayObservers() const { return !display_list_.observers()->empty(); }
