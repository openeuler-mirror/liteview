...
ui::InterpolatedTransform* GetScreenRotation(int degrees, bool reversed)
{
    ...
    std::unique_ptr<ui::InterpolatedTransform> rotation
        = std::make_unique<ui::InterpolatedTransformAboutPivot>(old_pivot, std::make_unique<ui::InterpolatedRotation>(reversed ? degrees : 0, reversed ? 0 : degrees));
...
ui::InterpolatedTransform* GetMaximize()
{
    ...
    std::unique_ptr<ui::InterpolatedTransform> translation
        = std::make_unique<ui::InterpolatedTranslation>(gfx::PointF(), gfx::PointF(target_bounds.x() - initial_bounds.x(), target_bounds.y() - initial_bounds.y()));
