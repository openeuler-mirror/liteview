...
RRectF::RRectF(float x, float y, float width, float height, float upper_left_x, float upper_left_y, float upper_right_x, float upper_right_y, float lower_right_x,
...
void RRectF::Offset(float horizontal, float vertical) { skrrect_.offset(horizontal, vertical); }
...
namespace {
inline bool AboveTol(float val1, float val2, float tolerance) { return (std::abs(val1 - val2) > tolerance); }
} // namespace
