...
{
    return RRectF(x_, y_, width_, height_, upper_left_x_, upper_left_y_, upper_right_x_, upper_right_y_, lower_right_x_, lower_right_y_, lower_left_x_, lower_left_y_);
}
