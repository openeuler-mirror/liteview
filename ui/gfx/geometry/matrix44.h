...
public:
    ...
    Matrix44(SkScalar col1row1, SkScalar col2row1, SkScalar col3row1, SkScalar col4row1, SkScalar col1row2, SkScalar col2row2, SkScalar col3row2, SkScalar col4row2,
        SkScalar col1row3, SkScalar col2row3, SkScalar col3row3, SkScalar col4row3, SkScalar col1row4, SkScalar col2row4, SkScalar col3row4, SkScalar col4row4)
        // fMat is indexed by [col][row] (i.e. col-major).
        : fMat { { col1row1, col1row2, col1row3, col1row4 }, { col2row1, col2row2, col2row3, col2row4 }, { col3row1, col3row2, col3row3, col3row4 },
     ...
     */
    inline bool isScaleTranslate() const { return !(this->getType() & ~(kScale_Mask | kTranslate_Mask)); }
    ...
    // correct.
    void setRotateUnitSinCos(SkScalar x, SkScalar y, SkScalar z, SkScalar sin_angle, SkScalar cos_angle);
    ...
    friend Matrix44 operator*(const Matrix44& a, const Matrix44& b) { return Matrix44(a, b); }
