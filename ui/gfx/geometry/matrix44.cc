...
static inline bool eq4(const SkScalar* SK_RESTRICT a, const SkScalar* SK_RESTRICT b) { return (a[0] == b[0]) & (a[1] == b[1]) & (a[2] == b[2]) & (a[3] == b[3]); }
...
void Matrix44::setRotateUnitSinCos(SkScalar x, SkScalar y, SkScalar z, SkScalar sin_angle, SkScalar cos_angle)
{
...
void Matrix44::setRotateAboutXAxisSinCos(SkScalar sin_angle, SkScalar cos_angle)
{
    fMat[0][0] = 1;
    fMat[0][1] = 0;
    fMat[0][2] = 0;
...
void Matrix44::setRotateAboutYAxisSinCos(SkScalar sin_angle, SkScalar cos_angle)
{
    fMat[0][0] = cos_angle;
    fMat[0][1] = 0;
    fMat[0][2] = -sin_angle;
...
void Matrix44::setRotateAboutZAxisSinCos(SkScalar sin_angle, SkScalar cos_angle)
{
    fMat[0][0] = cos_angle;
    fMat[0][1] = sin_angle;
    fMat[0][2] = 0;
