...
struct Double4 {
    ...
    bool operator==(const Double4& other) { return data[0] == other.data[0] && data[1] == other.data[1] && data[2] == other.data[2] && data[3] == other.data[3]; }
};
#endif

ALWAYS_INLINE double Sum(Double4 v) { return v[0] + v[1] + v[2] + v[3]; }

ALWAYS_INLINE Double4 LoadDouble4(const double s[4]) { return Double4 { s[0], s[1], s[2], s[3] }; }
...
#else
typedef int64_t DoubleBoolean4[4];
#endif
ALWAYS_INLINE int64_t AllTrue(DoubleBoolean4 v) { return v[0] & v[1] & v[2] & v[3]; }
