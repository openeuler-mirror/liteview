...
public:
    ...
    bool HasRoundedCorners() const { return rounded_corner_bounds_.GetType() != RRectF::Type::kEmpty && rounded_corner_bounds_.GetType() != RRectF::Type::kRect; }

    const absl::optional<gfx::LinearGradient>& gradient_mask() const { return gradient_mask_; }
...
inline bool operator!=(const MaskFilterInfo& lhs, const MaskFilterInfo& rhs) { return !(lhs == rhs); }
