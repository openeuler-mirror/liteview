...
TEST(TransformOperationTest, BlendOrder)
{
    ...
    operations_expected.AppendScale(
        gfx::Tween::FloatValueBetween(progress, sx1, sx2), gfx::Tween::FloatValueBetween(progress, sy1, sy2), gfx::Tween::FloatValueBetween(progress, sz1, sz2));

    operations_expected.AppendTranslate(
        gfx::Tween::FloatValueBetween(progress, dx1, dx2), gfx::Tween::FloatValueBetween(progress, dy1, dy2), gfx::Tween::FloatValueBetween(progress, dz1, dz2));
...
static void CheckProgress(
    SkScalar progress, const gfx::Transform& from_matrix, const gfx::Transform& to_matrix, const TransformOperations& from_transform, const TransformOperations& to_transform)
{
...
static void EmpiricallyTestBounds(const TransformOperations& from, const TransformOperations& to, SkScalar min_progress, SkScalar max_progress, bool test_containment_only)
{
...
TEST(TransformOperationTest, BlendedBoundsForRotationEmpiricalTests)
{
    ...
    struct {
        ...
        float y;
        float z;
    } axes[] = { { 1.f, 1.f, 1.f }, { -1.f, -1.f, -1.f }, { -1.f, 2.f, 3.f }, { 1.f, -2.f, 3.f }, { 1.f, 2.f, -3.f }, { 0.f, 0.f, 0.f }, { 1.f, 0.f, 0.f }, { 0.f, 1.f, 0.f },
        { 0.f, 0.f, 1.f }, { 1.f, 1.f, 0.f }, { 0.f, 1.f, 1.f }, { 1.f, 0.f, 1.f }, { -1.f, 0.f, 0.f }, { 0.f, -1.f, 0.f }, { 0.f, 0.f, -1.f }, { -1.f, -1.f, 0.f },
