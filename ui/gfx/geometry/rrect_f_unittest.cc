...
TEST(RRectFTest, BuildFromCorners)
{
    ...
    RRectF b = RRectFBuilder().set_origin(40, 50).set_size(60, 70).set_upper_left(1, 2).set_upper_right(3, 4).set_lower_right(5, 6).set_lower_left(7, 8).Build();
    EXPECT_EQ(a, b);
}
...
TEST(RRectFTest, BuildFromCornersHigherThanSize)
{
    ...
    RRectF b = RRectFBuilder().set_origin(0, 0).set_size(20, 10).set_upper_left(48, 8).set_upper_right(32, 16).set_lower_right(56, 24).set_lower_left(24, 32).Build();
    EXPECT_EQ(a, b);
}
