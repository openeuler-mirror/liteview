...
inline bool operator==(const Vector3dF& lhs, const Vector3dF& rhs) { return lhs.x() == rhs.x() && lhs.y() == rhs.y() && lhs.z() == rhs.z(); }

inline bool operator!=(const Vector3dF& lhs, const Vector3dF& rhs) { return !(lhs == rhs); }

inline Vector3dF operator-(const Vector3dF& v) { return Vector3dF(-v.x(), -v.y(), -v.z()); }
...
inline Vector3dF ScaleVector3d(const Vector3dF& v, const Vector3dF& s) { return ScaleVector3d(v, s.x(), s.y(), s.z()); }

// Return a vector that is |v| scaled by the given scale factor.
inline Vector3dF ScaleVector3d(const Vector3dF& v, float scale) { return ScaleVector3d(v, scale, scale, scale); }
