...
inline constexpr bool operator==(const Vector2dF& lhs, const Vector2dF& rhs) { return lhs.x() == rhs.x() && lhs.y() == rhs.y(); }

inline constexpr bool operator!=(const Vector2dF& lhs, const Vector2dF& rhs) { return !(lhs == rhs); }

inline constexpr Vector2dF operator-(const Vector2dF& v) { return Vector2dF(-v.x(), -v.y()); }
...
inline Vector2dF ScaleVector2d(const Vector2dF& v, float scale) { return ScaleVector2d(v, scale, scale); }

inline Vector2dF TransposeVector2d(const Vector2dF& v) { return Vector2dF(v.y(), v.x()); }
