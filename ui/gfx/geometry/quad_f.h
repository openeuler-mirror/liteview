...
public:
    ...
    PointF CenterPoint() const { return PointF((p1_.x() + p2_.x() + p3_.x() + p4_.x()) / 4.0, (p1_.y() + p2_.y() + p3_.y() + p4_.y()) / 4.0); }
...
inline bool operator==(const QuadF& lhs, const QuadF& rhs) { return lhs.p1() == rhs.p1() && lhs.p2() == rhs.p2() && lhs.p3() == rhs.p3() && lhs.p4() == rhs.p4(); }

inline bool operator!=(const QuadF& lhs, const QuadF& rhs) { return !(lhs == rhs); }
