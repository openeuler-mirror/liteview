...
inline bool operator==(const LinearGradient::Step& lhs, const LinearGradient::Step& rhs) { return lhs.fraction == rhs.fraction && lhs.alpha == rhs.alpha; }
...
inline bool operator!=(const LinearGradient& lhs, const LinearGradient& rhs) { return !(lhs == rhs); }
