...
public:
    ...
    static Transform RowMajor(SkScalar r0c0, SkScalar r0c1, SkScalar r0c2, SkScalar r0c3, SkScalar r1c0, SkScalar r1c1, SkScalar r1c2, SkScalar r1c3, SkScalar r2c0, SkScalar r2c1,
        SkScalar r2c2, SkScalar r2c3, SkScalar r3c0, SkScalar r3c1, SkScalar r3c2, SkScalar r3c3)
    {
    ...
    static Transform ColMajor(SkScalar r0c0, SkScalar r1c0, SkScalar r2c0, SkScalar r3c0, SkScalar r0c1, SkScalar r1c1, SkScalar r2c1, SkScalar r3c1, SkScalar r0c2, SkScalar r1c2,
    ...
    static Transform AffineForTesting(SkScalar v0, SkScalar v1, SkScalar v2, SkScalar v3, SkScalar v4, SkScalar v5) { return Affine(v0, v1, v2, v3, v4, v5); }
    ...
    static Transform MakeTranslation(SkScalar tx, SkScalar ty) { return Affine(1, 0, 0, 1, tx, ty); }
    // Creates a transform as a 2d scale.
    static Transform MakeScale(SkScalar scale) { return MakeScale(scale, scale); }
    static Transform MakeScale(SkScalar sx, SkScalar sy) { return Affine(sx, 0, 0, sy, 0, 0); }
    ...
    bool IsIdentityOr2DTranslation() const { return matrix_.isTranslate() && matrix_.rc(2, 3) == 0; }
    ...
    // be inverted.
    [[nodiscard]] absl::optional<PointF> InverseMapPoint(const PointF& point) const;
    [[nodiscard]] absl::optional<Point3F> InverseMapPoint(const Point3F& point) const;
    ...
    // Returns |this| * |other|.
    Transform operator*(const Transform& other) const { return Transform(*this, other); }
...
private:
    ...
    Transform(SkScalar r0c0, SkScalar r1c0, SkScalar r2c0, SkScalar r3c0, SkScalar r0c1, SkScalar r1c1, SkScalar r2c1, SkScalar r3c1, SkScalar r0c2, SkScalar r1c2, SkScalar r2c2,
        SkScalar r3c2, SkScalar r0c3, SkScalar r1c3, SkScalar r2c3, SkScalar r3c3);
    ...
    static Transform Affine(SkScalar r0c0, SkScalar r0c1, SkScalar r1c0, SkScalar r1c1, SkScalar x_translation, SkScalar y_translation)
    {
