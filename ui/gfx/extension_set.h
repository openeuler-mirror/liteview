...
GFX_EXPORT ExtensionSet MakeExtensionSet(const base::StringPiece& extensions_string);

GFX_EXPORT bool HasExtension(const ExtensionSet& extension_set, const base::StringPiece& extension);
