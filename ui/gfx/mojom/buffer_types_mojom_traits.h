...
template <> struct COMPONENT_EXPORT(GFX_SHARED_MOJOM_TRAITS) StructTraits<gfx::mojom::BufferUsageAndFormatDataView, gfx::BufferUsageAndFormat> {
    static gfx::BufferUsage usage(const gfx::BufferUsageAndFormat& input) { return input.usage; }

    static gfx::BufferFormat format(const gfx::BufferUsageAndFormat& input) { return input.format; }
...
template <> struct COMPONENT_EXPORT(GFX_SHARED_MOJOM_TRAITS) StructTraits<gfx::mojom::GpuMemoryBufferIdDataView, gfx::GpuMemoryBufferId> {
    static int32_t id(const gfx::GpuMemoryBufferId& buffer_id) { return buffer_id.id; }
...
template <> struct COMPONENT_EXPORT(GFX_SHARED_MOJOM_TRAITS) StructTraits<gfx::mojom::GpuMemoryBufferHandleDataView, gfx::GpuMemoryBufferHandle> {
    static gfx::GpuMemoryBufferId id(const gfx::GpuMemoryBufferHandle& handle) { return handle.id; }
    static uint32_t offset(const gfx::GpuMemoryBufferHandle& handle) { return handle.offset; }
    static uint32_t stride(const gfx::GpuMemoryBufferHandle& handle) { return handle.stride; }
