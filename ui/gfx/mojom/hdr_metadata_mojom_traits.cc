...
bool StructTraits<gfx::mojom::ColorVolumeMetadataDataView, gfx::ColorVolumeMetadata>::Read(gfx::mojom::ColorVolumeMetadataDataView data, gfx::ColorVolumeMetadata* output)
{
