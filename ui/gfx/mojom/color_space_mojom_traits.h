...
template <> struct COMPONENT_EXPORT(GFX_SHARED_MOJOM_TRAITS) StructTraits<gfx::mojom::ColorSpaceDataView, gfx::ColorSpace> {
    static gfx::ColorSpace::PrimaryID primaries(const gfx::ColorSpace& input) { return input.primaries_; }

    static gfx::ColorSpace::TransferID transfer(const gfx::ColorSpace& input) { return input.transfer_; }

    static gfx::ColorSpace::MatrixID matrix(const gfx::ColorSpace& input) { return input.matrix_; }

    static gfx::ColorSpace::RangeID range(const gfx::ColorSpace& input) { return input.range_; }

    static base::span<const float> custom_primary_matrix(const gfx::ColorSpace& input) { return input.custom_primary_matrix_; }

    static base::span<const float> transfer_params(const gfx::ColorSpace& input) { return input.transfer_params_; }
