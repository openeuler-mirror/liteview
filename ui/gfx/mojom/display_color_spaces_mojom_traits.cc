...
// static
base::span<const gfx::ColorSpace> StructTraits<gfx::mojom::DisplayColorSpacesDataView, gfx::DisplayColorSpaces>::color_spaces(const gfx::DisplayColorSpaces& input)
{
    return input.color_spaces_;
}

// static
base::span<const gfx::BufferFormat> StructTraits<gfx::mojom::DisplayColorSpacesDataView, gfx::DisplayColorSpaces>::buffer_formats(const gfx::DisplayColorSpaces& input)
{
    return input.buffer_formats_;
}

// static
bool StructTraits<gfx::mojom::DisplayColorSpacesDataView, gfx::DisplayColorSpaces>::Read(gfx::mojom::DisplayColorSpacesDataView input, gfx::DisplayColorSpaces* out)
{
