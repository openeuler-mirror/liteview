...
SkColor ConsumeSkColor(FuzzedDataProvider* fdp) { return static_cast<SkColor>(fdp->ConsumeIntegral<uint32_t>()); }
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    while (fdp.remaining_bytes() != 0) {
        ...
        case RenderTextAPI::kIndexOfAdjacentGrapheme: {
            size_t index = render_text->IndexOfAdjacentGrapheme(fdp.ConsumeIntegralInRange<size_t>(0, render_text->text().length()), ConsumeLogicalCursorDirection(&fdp));
        ...
        case RenderTextAPI::kSetDisplayRect:
            render_text->SetDisplayRect(gfx::Rect(fdp.ConsumeIntegralInRange<int>(-30, 30), fdp.ConsumeIntegralInRange<int>(-30, 30), fdp.ConsumeIntegralInRange<int>(0, 200),
