...
public:
    PropertyCache(Connection* connection, Window window, const std::vector<Atom>& properties);
...
private:
    ...
    void OnGetPropertyResponse(PropertyValue* value, GetPropertyResponse response);
