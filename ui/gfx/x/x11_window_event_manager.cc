...
XScopedEventSelector::XScopedEventSelector(Window window, EventMask event_mask)
    ...
    , event_manager_(XWindowEventManager::GetInstance()->weak_ptr_factory_.GetWeakPtr())
{
...
// static
XWindowEventManager* XWindowEventManager::GetInstance() { return base::Singleton<XWindowEventManager>::get(); }
