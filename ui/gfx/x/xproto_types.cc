...
ReadBuffer::ReadBuffer(scoped_refptr<base::RefCountedMemory> data, bool setup_message)
    : data(data)
{
...
scoped_refptr<base::RefCountedMemory> ReadBuffer::ReadAndAdvance(size_t length)
{
...
int ReadBuffer::TakeFd() { return *fds++; }
...
void WriteBuffer::AppendBuffer(scoped_refptr<base::RefCountedMemory> buffer, size_t size)
{
    AppendCurrentBuffer();
...
void WriteBuffer::AppendCurrentBuffer() { buffers_.push_back(base::RefCountedBytes::TakeVector(&current_buffer_)); }
