...
public:
    ...
    Future<void> RedirectWindow(const Window& window = {}, const Redirect& update = {});
    ...
    Future<void> RedirectSubwindows(const Window& window = {}, const Redirect& update = {});
    ...
    Future<void> UnredirectWindow(const Window& window = {}, const Redirect& update = {});
    ...
    Future<void> UnredirectSubwindows(const Window& window = {}, const Redirect& update = {});
    ...
    Future<void> CreateRegionFromBorderClip(const CreateRegionFromBorderClipRequest& request);

    Future<void> CreateRegionFromBorderClip(const XFixes::Region& region = {}, const Window& window = {});
    ...
    Future<void> NameWindowPixmap(const Window& window = {}, const Pixmap& pixmap = {});
    ...
    Future<GetOverlayWindowReply> GetOverlayWindow(const GetOverlayWindowRequest& request);
...
inline constexpr x11::Composite::Redirect operator|(x11::Composite::Redirect l, x11::Composite::Redirect r)
{
    using T = std::underlying_type_t<x11::Composite::Redirect>;
    return static_cast<x11::Composite::Redirect>(static_cast<T>(l) | static_cast<T>(r));
}
