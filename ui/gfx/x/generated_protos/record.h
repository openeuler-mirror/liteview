...
public:
    ...
    struct Range8 {
        bool operator==(const Range8& other) const { return first == other.first && last == other.last; }
    ...
    struct Range16 {
        bool operator==(const Range16& other) const { return first == other.first && last == other.last; }
    ...
    struct ExtRange {
        bool operator==(const ExtRange& other) const { return major == other.major && minor == other.minor; }
    ...
    struct Range {
        ...
        {
            return core_requests == other.core_requests && core_replies == other.core_replies && ext_requests == other.ext_requests && ext_replies == other.ext_replies
                && delivered_events == other.delivered_events && device_events == other.device_events && errors == other.errors && client_started == other.client_started
    ...
    struct ClientInfo {
        bool operator==(const ClientInfo& other) const { return client_resource == other.client_resource && ranges == other.ranges; }
    ...
    Future<QueryVersionReply> QueryVersion(const uint16_t& major_version = {}, const uint16_t& minor_version = {});
    ...
    Future<void> CreateContext(
        const Context& context = {}, const ElementHeader& element_header = {}, const std::vector<ClientSpec>& client_specs = {}, const std::vector<Range>& ranges = {});
    ...
    Future<void> UnregisterClients(const Context& context = {}, const std::vector<ClientSpec>& client_specs = {});
...
inline constexpr x11::Record::HType operator|(x11::Record::HType l, x11::Record::HType r)
{
...
inline constexpr x11::Record::ClientSpec operator|(x11::Record::ClientSpec l, x11::Record::ClientSpec r)
{
    using T = std::underlying_type_t<x11::Record::ClientSpec>;
    return static_cast<x11::Record::ClientSpec>(static_cast<T>(l) | static_cast<T>(r));
}
