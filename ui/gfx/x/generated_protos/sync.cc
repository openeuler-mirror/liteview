...
Future<Sync::ListSystemCountersReply> Sync::ListSystemCounters() { return Sync::ListSystemCounters(Sync::ListSystemCountersRequest {}); }
...
Future<void> Sync::CreateCounter(const Counter& id, const Int64& initial_value) { return Sync::CreateCounter(Sync::CreateCounterRequest { id, initial_value }); }
...
Future<void> Sync::DestroyCounter(const Counter& counter) { return Sync::DestroyCounter(Sync::DestroyCounterRequest { counter }); }
...
Future<Sync::QueryCounterReply> Sync::QueryCounter(const Counter& counter) { return Sync::QueryCounter(Sync::QueryCounterRequest { counter }); }
...
Future<void> Sync::Await(const std::vector<WaitCondition>& wait_list) { return Sync::Await(Sync::AwaitRequest { wait_list }); }
...
Future<void> Sync::ChangeCounter(const Counter& counter, const Int64& amount) { return Sync::ChangeCounter(Sync::ChangeCounterRequest { counter, amount }); }
...
Future<void> Sync::SetCounter(const Counter& counter, const Int64& value) { return Sync::SetCounter(Sync::SetCounterRequest { counter, value }); }
...
Future<void> Sync::CreateAlarm(const Alarm& id, const absl::optional<Counter>& counter, const absl::optional<Valuetype>& valueType, const absl::optional<Int64>& value,
    const absl::optional<Testtype>& testType, const absl::optional<Int64>& delta, const absl::optional<uint32_t>& events)
{
...
Future<void> Sync::ChangeAlarm(const Alarm& id, const absl::optional<Counter>& counter, const absl::optional<Valuetype>& valueType, const absl::optional<Int64>& value,
    const absl::optional<Testtype>& testType, const absl::optional<Int64>& delta, const absl::optional<uint32_t>& events)
{
...
Future<void> Sync::DestroyAlarm(const Alarm& alarm) { return Sync::DestroyAlarm(Sync::DestroyAlarmRequest { alarm }); }
...
Future<Sync::QueryAlarmReply> Sync::QueryAlarm(const Alarm& alarm) { return Sync::QueryAlarm(Sync::QueryAlarmRequest { alarm }); }
...
Future<void> Sync::SetPriority(const uint32_t& id, const int32_t& priority) { return Sync::SetPriority(Sync::SetPriorityRequest { id, priority }); }
...
Future<Sync::GetPriorityReply> Sync::GetPriority(const uint32_t& id) { return Sync::GetPriority(Sync::GetPriorityRequest { id }); }
...
Future<void> Sync::TriggerFence(const Fence& fence) { return Sync::TriggerFence(Sync::TriggerFenceRequest { fence }); }
...
Future<void> Sync::ResetFence(const Fence& fence) { return Sync::ResetFence(Sync::ResetFenceRequest { fence }); }
...
Future<void> Sync::DestroyFence(const Fence& fence) { return Sync::DestroyFence(Sync::DestroyFenceRequest { fence }); }
...
Future<Sync::QueryFenceReply> Sync::QueryFence(const Fence& fence) { return Sync::QueryFence(Sync::QueryFenceRequest { fence }); }
...
Future<void> Sync::AwaitFence(const std::vector<Fence>& fence_list) { return Sync::AwaitFence(Sync::AwaitFenceRequest { fence_list }); }
