...
Future<Dpms::GetVersionReply> Dpms::GetVersion(const Dpms::GetVersionRequest& request)
{
    ...
    return connection_->SendRequest<Dpms::GetVersionReply>(&buf, "Dpms::GetVersion", false);
}

Future<Dpms::GetVersionReply> Dpms::GetVersion(const uint16_t& client_major_version, const uint16_t& client_minor_version)
{
    return Dpms::GetVersion(Dpms::GetVersionRequest { client_major_version, client_minor_version });
}

template <> COMPONENT_EXPORT(X11) std::unique_ptr<Dpms::GetVersionReply> detail::ReadReply<Dpms::GetVersionReply>(ReadBuffer* buffer)
{
    auto& buf = *buffer;
...
Future<Dpms::CapableReply> Dpms::Capable(const Dpms::CapableRequest& request)
{
    ...
    return connection_->SendRequest<Dpms::CapableReply>(&buf, "Dpms::Capable", false);
}

Future<Dpms::CapableReply> Dpms::Capable() { return Dpms::Capable(Dpms::CapableRequest {}); }

template <> COMPONENT_EXPORT(X11) std::unique_ptr<Dpms::CapableReply> detail::ReadReply<Dpms::CapableReply>(ReadBuffer* buffer)
{
    auto& buf = *buffer;
...
Future<Dpms::GetTimeoutsReply> Dpms::GetTimeouts(const Dpms::GetTimeoutsRequest& request)
{
    if (!connection_->Ready() || !present())
        return {};
    ...
    return connection_->SendRequest<Dpms::GetTimeoutsReply>(&buf, "Dpms::GetTimeouts", false);
}

Future<Dpms::GetTimeoutsReply> Dpms::GetTimeouts() { return Dpms::GetTimeouts(Dpms::GetTimeoutsRequest {}); }

template <> COMPONENT_EXPORT(X11) std::unique_ptr<Dpms::GetTimeoutsReply> detail::ReadReply<Dpms::GetTimeoutsReply>(ReadBuffer* buffer)
{
    auto& buf = *buffer;
...
Future<void> Dpms::SetTimeouts(const uint16_t& standby_timeout, const uint16_t& suspend_timeout, const uint16_t& off_timeout)
{
    return Dpms::SetTimeouts(Dpms::SetTimeoutsRequest { standby_timeout, suspend_timeout, off_timeout });
}
...
Future<void> Dpms::Enable() { return Dpms::Enable(Dpms::EnableRequest {}); }
...
Future<void> Dpms::Disable() { return Dpms::Disable(Dpms::DisableRequest {}); }
...
Future<void> Dpms::ForceLevel(const DPMSMode& power_level) { return Dpms::ForceLevel(Dpms::ForceLevelRequest { power_level }); }
...
Future<Dpms::InfoReply> Dpms::Info() { return Dpms::Info(Dpms::InfoRequest {}); }

template <> COMPONENT_EXPORT(X11) std::unique_ptr<Dpms::InfoReply> detail::ReadReply<Dpms::InfoReply>(ReadBuffer* buffer)
{
    auto& buf = *buffer;
