...
public:
    ...
    struct ListItem {
        bool operator==(const ListItem& other) const { return name == other.name && object_context == other.object_context && data_context == other.data_context; }
    ...
    Future<QueryVersionReply> QueryVersion(const uint8_t& client_major = {}, const uint8_t& client_minor = {});
    ...
    Future<void> SetDeviceCreateContext(const SetDeviceCreateContextRequest& request);
    ...
    Future<GetDeviceCreateContextReply> GetDeviceCreateContext(const GetDeviceCreateContextRequest& request);
    ...
    Future<void> SetDeviceContext(const uint32_t& device = {}, const std::string& context = {});
    ...
    Future<GetDeviceContextReply> GetDeviceContext(const GetDeviceContextRequest& request);
    ...
    Future<void> SetWindowCreateContext(const SetWindowCreateContextRequest& request);
    ...
    Future<GetWindowCreateContextReply> GetWindowCreateContext(const GetWindowCreateContextRequest& request);
    ...
    Future<GetWindowContextReply> GetWindowContext(const GetWindowContextRequest& request);
    ...
    Future<void> SetPropertyCreateContext(const SetPropertyCreateContextRequest& request);
    ...
    using GetPropertyCreateContextResponse = Response<GetPropertyCreateContextReply>;

    Future<GetPropertyCreateContextReply> GetPropertyCreateContext(const GetPropertyCreateContextRequest& request);
    ...
    Future<void> SetPropertyUseContext(const SetPropertyUseContextRequest& request);
    ...
    Future<GetPropertyUseContextReply> GetPropertyUseContext(const GetPropertyUseContextRequest& request);
    ...
    Future<GetPropertyContextReply> GetPropertyContext(const GetPropertyContextRequest& request);

    Future<GetPropertyContextReply> GetPropertyContext(const Window& window = {}, const Atom& property = {});
    ...
    Future<GetPropertyDataContextReply> GetPropertyDataContext(const GetPropertyDataContextRequest& request);

    Future<GetPropertyDataContextReply> GetPropertyDataContext(const Window& window = {}, const Atom& property = {});
    ...
    Future<void> SetSelectionCreateContext(const SetSelectionCreateContextRequest& request);
    ...
    using GetSelectionCreateContextResponse = Response<GetSelectionCreateContextReply>;

    Future<GetSelectionCreateContextReply> GetSelectionCreateContext(const GetSelectionCreateContextRequest& request);
    ...
    Future<void> SetSelectionUseContext(const SetSelectionUseContextRequest& request);
    ...
    Future<GetSelectionUseContextReply> GetSelectionUseContext(const GetSelectionUseContextRequest& request);
    ...
    Future<GetSelectionContextReply> GetSelectionContext(const GetSelectionContextRequest& request);

    Future<GetSelectionContextReply> GetSelectionContext(const Atom& selection = {});
    ...
    using GetSelectionDataContextResponse = Response<GetSelectionDataContextReply>;

    Future<GetSelectionDataContextReply> GetSelectionDataContext(const GetSelectionDataContextRequest& request);

    Future<GetSelectionDataContextReply> GetSelectionDataContext(const Atom& selection = {});
    ...
    Future<ListSelectionsReply> ListSelections(const ListSelectionsRequest& request);
    ...
    Future<GetClientContextReply> GetClientContext(const GetClientContextRequest& request);
