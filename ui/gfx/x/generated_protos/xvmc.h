...
public:
    ...
    struct SurfaceInfo {
        ...
        {
            return id == other.id && chroma_format == other.chroma_format && pad0 == other.pad0 && max_width == other.max_width && max_height == other.max_height
                && subpicture_max_width == other.subpicture_max_width && subpicture_max_height == other.subpicture_max_height && mc_type == other.mc_type && flags == other.flags;
        }
    ...
    Future<ListSurfaceTypesReply> ListSurfaceTypes(const ListSurfaceTypesRequest& request);
    ...
    Future<CreateContextReply> CreateContext(const Context& context_id = {}, const Xv::Port& port_id = {}, const Surface& surface_id = {}, const uint16_t& width = {},
        const uint16_t& height = {}, const uint32_t& flags = {});
    ...
    Future<CreateSurfaceReply> CreateSurface(const Surface& surface_id = {}, const Context& context_id = {});
    ...
    Future<CreateSubpictureReply> CreateSubpicture(const CreateSubpictureRequest& request);
    ...
    Future<ListSubpictureTypesReply> ListSubpictureTypes(const ListSubpictureTypesRequest& request);

    Future<ListSubpictureTypesReply> ListSubpictureTypes(const Xv::Port& port_id = {}, const Surface& surface_id = {});
