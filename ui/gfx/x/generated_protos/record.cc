...
template <> void ReadError<Record::BadContextError>(Record::BadContextError* error_, ReadBuffer* buffer)
{
    auto& buf = *buffer;
...
Future<Record::QueryVersionReply> Record::QueryVersion(const Record::QueryVersionRequest& request)
{
    ...
    return connection_->SendRequest<Record::QueryVersionReply>(&buf, "Record::QueryVersion", false);
}

Future<Record::QueryVersionReply> Record::QueryVersion(const uint16_t& major_version, const uint16_t& minor_version)
{
    return Record::QueryVersion(Record::QueryVersionRequest { major_version, minor_version });
}

template <> COMPONENT_EXPORT(X11) std::unique_ptr<Record::QueryVersionReply> detail::ReadReply<Record::QueryVersionReply>(ReadBuffer* buffer)
{
    auto& buf = *buffer;
...
Future<void> Record::CreateContext(const Record::CreateContextRequest& request)
{
    if (!connection_->Ready() || !present())
        return {};
...
Future<void> Record::CreateContext(const Context& context, const ElementHeader& element_header, const std::vector<ClientSpec>& client_specs, const std::vector<Range>& ranges)
{
    return Record::CreateContext(Record::CreateContextRequest { context, element_header, client_specs, ranges });
}

Future<void> Record::RegisterClients(const Record::RegisterClientsRequest& request)
{
    if (!connection_->Ready() || !present())
        return {};
...
Future<void> Record::RegisterClients(const Context& context, const ElementHeader& element_header, const std::vector<ClientSpec>& client_specs, const std::vector<Range>& ranges)
{
    return Record::RegisterClients(Record::RegisterClientsRequest { context, element_header, client_specs, ranges });
}

Future<void> Record::UnregisterClients(const Record::UnregisterClientsRequest& request)
{
    if (!connection_->Ready() || !present())
        return {};
    ...
    return connection_->SendRequest<void>(&buf, "Record::UnregisterClients", false);
}

Future<void> Record::UnregisterClients(const Context& context, const std::vector<ClientSpec>& client_specs)
{
    return Record::UnregisterClients(Record::UnregisterClientsRequest { context, client_specs });
}

Future<Record::GetContextReply> Record::GetContext(const Record::GetContextRequest& request)
{
    if (!connection_->Ready() || !present())
        return {};
    ...
    return connection_->SendRequest<Record::GetContextReply>(&buf, "Record::GetContext", false);
}

Future<Record::GetContextReply> Record::GetContext(const Context& context) { return Record::GetContext(Record::GetContextRequest { context }); }

template <> COMPONENT_EXPORT(X11) std::unique_ptr<Record::GetContextReply> detail::ReadReply<Record::GetContextReply>(ReadBuffer* buffer)
{
    auto& buf = *buffer;
...
Future<Record::EnableContextReply> Record::EnableContext(const Record::EnableContextRequest& request)
{
    if (!connection_->Ready() || !present())
        return {};
    ...
    return connection_->SendRequest<Record::EnableContextReply>(&buf, "Record::EnableContext", false);
}

Future<Record::EnableContextReply> Record::EnableContext(const Context& context) { return Record::EnableContext(Record::EnableContextRequest { context }); }

template <> COMPONENT_EXPORT(X11) std::unique_ptr<Record::EnableContextReply> detail::ReadReply<Record::EnableContextReply>(ReadBuffer* buffer)
{
    auto& buf = *buffer;
...
Future<void> Record::DisableContext(const Record::DisableContextRequest& request)
{
    if (!connection_->Ready() || !present())
        return {};
...
Future<void> Record::DisableContext(const Context& context) { return Record::DisableContext(Record::DisableContextRequest { context }); }
...
Future<void> Record::FreeContext(const Context& context) { return Record::FreeContext(Record::FreeContextRequest { context }); }
