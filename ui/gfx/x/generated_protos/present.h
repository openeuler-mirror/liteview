...
public:
    ...
    struct Notify {
        bool operator==(const Notify& other) const { return window == other.window && serial == other.serial; }
    ...
    Future<void> PresentPixmap(const Window& window = {}, const Pixmap& pixmap = {}, const uint32_t& serial = {}, const XFixes::Region& valid = {},
        const XFixes::Region& update = {}, const int16_t& x_off = {}, const int16_t& y_off = {}, const RandR::Crtc& target_crtc = {}, const Sync::Fence& wait_fence = {},
        const Sync::Fence& idle_fence = {}, const uint32_t& options = {}, const uint64_t& target_msc = {}, const uint64_t& divisor = {}, const uint64_t& remainder = {},
    ...
    Future<void> NotifyMSC(const Window& window = {}, const uint32_t& serial = {}, const uint64_t& target_msc = {}, const uint64_t& divisor = {}, const uint64_t& remainder = {});
    ...
    Future<void> SelectInput(const Event& eid = {}, const Window& window = {}, const EventMask& event_mask = {});
    ...
    Future<QueryCapabilitiesReply> QueryCapabilities(const QueryCapabilitiesRequest& request);
...
inline constexpr x11::Present::Event operator|(x11::Present::Event l, x11::Present::Event r)
{
    using T = std::underlying_type_t<x11::Present::Event>;
    return static_cast<x11::Present::Event>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::Present::EventMask operator|(x11::Present::EventMask l, x11::Present::EventMask r)
{
    using T = std::underlying_type_t<x11::Present::EventMask>;
    return static_cast<x11::Present::EventMask>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::Present::Option operator|(x11::Present::Option l, x11::Present::Option r)
{
    using T = std::underlying_type_t<x11::Present::Option>;
    return static_cast<x11::Present::Option>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::Present::Capability operator|(x11::Present::Capability l, x11::Present::Capability r)
{
    using T = std::underlying_type_t<x11::Present::Capability>;
    return static_cast<x11::Present::Capability>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::Present::CompleteKind operator|(x11::Present::CompleteKind l, x11::Present::CompleteKind r)
{
    using T = std::underlying_type_t<x11::Present::CompleteKind>;
    return static_cast<x11::Present::CompleteKind>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::Present::CompleteMode operator|(x11::Present::CompleteMode l, x11::Present::CompleteMode r)
{
    using T = std::underlying_type_t<x11::Present::CompleteMode>;
    return static_cast<x11::Present::CompleteMode>(static_cast<T>(l) | static_cast<T>(r));
}
