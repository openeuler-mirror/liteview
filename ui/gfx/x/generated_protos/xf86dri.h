...
public:
    ...
    struct DrmClipRect {
        bool operator==(const DrmClipRect& other) const { return x1 == other.x1 && y1 == other.y1 && x2 == other.x2 && x3 == other.x3; }
    ...
    using QueryDirectRenderingCapableResponse = Response<QueryDirectRenderingCapableReply>;

    Future<QueryDirectRenderingCapableReply> QueryDirectRenderingCapable(const QueryDirectRenderingCapableRequest& request);

    Future<QueryDirectRenderingCapableReply> QueryDirectRenderingCapable(const uint32_t& screen = {});
    ...
    Future<OpenConnectionReply> OpenConnection(const OpenConnectionRequest& request);
    ...
    Future<GetClientDriverNameReply> GetClientDriverName(const GetClientDriverNameRequest& request);

    Future<GetClientDriverNameReply> GetClientDriverName(const uint32_t& screen = {});
    ...
    Future<CreateContextReply> CreateContext(const uint32_t& screen = {}, const uint32_t& visual = {}, const uint32_t& context = {});
    ...
    Future<void> DestroyContext(const uint32_t& screen = {}, const uint32_t& context = {});
    ...
    Future<CreateDrawableReply> CreateDrawable(const CreateDrawableRequest& request);

    Future<CreateDrawableReply> CreateDrawable(const uint32_t& screen = {}, const uint32_t& drawable = {});
    ...
    Future<void> DestroyDrawable(const uint32_t& screen = {}, const uint32_t& drawable = {});
    ...
    Future<GetDrawableInfoReply> GetDrawableInfo(const GetDrawableInfoRequest& request);

    Future<GetDrawableInfoReply> GetDrawableInfo(const uint32_t& screen = {}, const uint32_t& drawable = {});
    ...
    Future<AuthConnectionReply> AuthConnection(const AuthConnectionRequest& request);

    Future<AuthConnectionReply> AuthConnection(const uint32_t& screen = {}, const uint32_t& magic = {});
