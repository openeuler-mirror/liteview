...
public:
    ...
    struct DRI2Buffer {
        ...
        {
            return attachment == other.attachment && name == other.name && pitch == other.pitch && cpp == other.cpp && flags == other.flags;
        }
    ...
    struct AttachFormat {
        bool operator==(const AttachFormat& other) const { return attachment == other.attachment && format == other.format; }
    ...
    Future<ConnectReply> Connect(const Window& window = {}, const DriverType& driver_type = {});
    ...
    Future<AuthenticateReply> Authenticate(const Window& window = {}, const uint32_t& magic = {});
    ...
    Future<GetBuffersReply> GetBuffers(const Drawable& drawable = {}, const uint32_t& count = {}, const std::vector<uint32_t>& attachments = {});
    ...
    Future<CopyRegionReply> CopyRegion(const Drawable& drawable = {}, const uint32_t& region = {}, const uint32_t& dest = {}, const uint32_t& src = {});
    ...
    Future<GetBuffersWithFormatReply> GetBuffersWithFormat(const GetBuffersWithFormatRequest& request);

    Future<GetBuffersWithFormatReply> GetBuffersWithFormat(const Drawable& drawable = {}, const uint32_t& count = {}, const std::vector<AttachFormat>& attachments = {});
    ...
    Future<SwapBuffersReply> SwapBuffers(const Drawable& drawable = {}, const uint32_t& target_msc_hi = {}, const uint32_t& target_msc_lo = {}, const uint32_t& divisor_hi = {},
    ...
    Future<WaitMSCReply> WaitMSC(const Drawable& drawable = {}, const uint32_t& target_msc_hi = {}, const uint32_t& target_msc_lo = {}, const uint32_t& divisor_hi = {},
        const uint32_t& divisor_lo = {}, const uint32_t& remainder_hi = {}, const uint32_t& remainder_lo = {});
    ...
    Future<WaitSBCReply> WaitSBC(const Drawable& drawable = {}, const uint32_t& target_sbc_hi = {}, const uint32_t& target_sbc_lo = {});
    ...
    Future<void> SwapInterval(const Drawable& drawable = {}, const uint32_t& interval = {});
    ...
    Future<GetParamReply> GetParam(const Drawable& drawable = {}, const uint32_t& param = {});
...
inline constexpr x11::Dri2::Attachment operator|(x11::Dri2::Attachment l, x11::Dri2::Attachment r)
{
    using T = std::underlying_type_t<x11::Dri2::Attachment>;
    return static_cast<x11::Dri2::Attachment>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::Dri2::DriverType operator|(x11::Dri2::DriverType l, x11::Dri2::DriverType r)
{
    using T = std::underlying_type_t<x11::Dri2::DriverType>;
    return static_cast<x11::Dri2::DriverType>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::Dri2::EventType operator|(x11::Dri2::EventType l, x11::Dri2::EventType r)
{
    using T = std::underlying_type_t<x11::Dri2::EventType>;
    return static_cast<x11::Dri2::EventType>(static_cast<T>(l) | static_cast<T>(r));
}
