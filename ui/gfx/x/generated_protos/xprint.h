...
public:
    ...
    struct Printer {
        bool operator==(const Printer& other) const { return name == other.name && description == other.description; }
    ...
    Future<PrintQueryVersionReply> PrintQueryVersion(const PrintQueryVersionRequest& request);
    ...
    Future<PrintGetPrinterListReply> PrintGetPrinterList(const PrintGetPrinterListRequest& request);

    Future<PrintGetPrinterListReply> PrintGetPrinterList(const std::vector<String8>& printer_name = {}, const std::vector<String8>& locale = {});

    struct PrintRehashPrinterListRequest { };

    using PrintRehashPrinterListResponse = Response<void>;

    Future<void> PrintRehashPrinterList(const PrintRehashPrinterListRequest& request);
    ...
    Future<void> CreateContext(const uint32_t& context_id = {}, const std::vector<String8>& printerName = {}, const std::vector<String8>& locale = {});
    ...
    Future<PrintGetContextReply> PrintGetContext(const PrintGetContextRequest& request);
    ...
    using PrintGetScreenOfContextResponse = Response<PrintGetScreenOfContextReply>;

    Future<PrintGetScreenOfContextReply> PrintGetScreenOfContext(const PrintGetScreenOfContextRequest& request);
    ...
    Future<void> PrintPutDocumentData(
        const Drawable& drawable = {}, const std::vector<uint8_t>& data = {}, const std::vector<String8>& doc_format = {}, const std::vector<String8>& options = {});
    ...
    Future<PrintGetDocumentDataReply> PrintGetDocumentData(const PrintGetDocumentDataRequest& request);

    Future<PrintGetDocumentDataReply> PrintGetDocumentData(const PContext& context = {}, const uint32_t& max_bytes = {});
    ...
    Future<void> PrintSelectInput(const PContext& context = {}, const uint32_t& event_mask = {});
    ...
    Future<PrintInputSelectedReply> PrintInputSelected(const PrintInputSelectedRequest& request);

    Future<PrintInputSelectedReply> PrintInputSelected(const PContext& context = {});
    ...
    Future<PrintGetAttributesReply> PrintGetAttributes(const PrintGetAttributesRequest& request);

    Future<PrintGetAttributesReply> PrintGetAttributes(const PContext& context = {}, const uint8_t& pool = {});
    ...
    Future<PrintGetOneAttributesReply> PrintGetOneAttributes(const PrintGetOneAttributesRequest& request);

    Future<PrintGetOneAttributesReply> PrintGetOneAttributes(const PContext& context = {}, const uint8_t& pool = {}, const std::vector<String8>& name = {});
    ...
    Future<void> PrintSetAttributes(
        const PContext& context = {}, const uint32_t& stringLen = {}, const uint8_t& pool = {}, const uint8_t& rule = {}, const std::vector<String8>& attributes = {});
    ...
    Future<PrintGetPageDimensionsReply> PrintGetPageDimensions(const PrintGetPageDimensionsRequest& request);

    Future<PrintGetPageDimensionsReply> PrintGetPageDimensions(const PContext& context = {});
    ...
    Future<PrintQueryScreensReply> PrintQueryScreens(const PrintQueryScreensRequest& request);
    ...
    using PrintSetImageResolutionResponse = Response<PrintSetImageResolutionReply>;

    Future<PrintSetImageResolutionReply> PrintSetImageResolution(const PrintSetImageResolutionRequest& request);

    Future<PrintSetImageResolutionReply> PrintSetImageResolution(const PContext& context = {}, const uint16_t& image_resolution = {});
    ...
    using PrintGetImageResolutionResponse = Response<PrintGetImageResolutionReply>;

    Future<PrintGetImageResolutionReply> PrintGetImageResolution(const PrintGetImageResolutionRequest& request);

    Future<PrintGetImageResolutionReply> PrintGetImageResolution(const PContext& context = {});
...
inline constexpr x11::XPrint::GetDoc operator|(x11::XPrint::GetDoc l, x11::XPrint::GetDoc r)
{
    using T = std::underlying_type_t<x11::XPrint::GetDoc>;
    return static_cast<x11::XPrint::GetDoc>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::XPrint::EvMask operator|(x11::XPrint::EvMask l, x11::XPrint::EvMask r)
{
    using T = std::underlying_type_t<x11::XPrint::EvMask>;
    return static_cast<x11::XPrint::EvMask>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::XPrint::Detail operator|(x11::XPrint::Detail l, x11::XPrint::Detail r)
{
    using T = std::underlying_type_t<x11::XPrint::Detail>;
    return static_cast<x11::XPrint::Detail>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::XPrint::Attr operator|(x11::XPrint::Attr l, x11::XPrint::Attr r)
{
