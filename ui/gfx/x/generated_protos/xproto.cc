...
Future<void> XProto::CreateWindow(const uint8_t& depth, const Window& wid, const Window& parent, const int16_t& x, const int16_t& y, const uint16_t& width, const uint16_t& height,
    const uint16_t& border_width, const WindowClass& c_class, const VisualId& visual, const absl::optional<Pixmap>& background_pixmap,
    const absl::optional<uint32_t>& background_pixel, const absl::optional<Pixmap>& border_pixmap, const absl::optional<uint32_t>& border_pixel,
    const absl::optional<Gravity>& bit_gravity, const absl::optional<Gravity>& win_gravity, const absl::optional<BackingStore>& backing_store,
    const absl::optional<uint32_t>& backing_planes, const absl::optional<uint32_t>& backing_pixel, const absl::optional<Bool32>& override_redirect,
    const absl::optional<Bool32>& save_under, const absl::optional<EventMask>& event_mask, const absl::optional<EventMask>& do_not_propogate_mask,
    const absl::optional<ColorMap>& colormap, const absl::optional<Cursor>& cursor)
{
    return XProto::CreateWindow(CreateWindowRequest { depth, wid, parent, x, y, width, height, border_width, c_class, visual, background_pixmap, background_pixel, border_pixmap,
        border_pixel, bit_gravity, win_gravity, backing_store, backing_planes, backing_pixel, override_redirect, save_under, event_mask, do_not_propogate_mask, colormap, cursor });
}
...
Future<void> XProto::ChangeWindowAttributes(const Window& window, const absl::optional<Pixmap>& background_pixmap, const absl::optional<uint32_t>& background_pixel,
    const absl::optional<Pixmap>& border_pixmap, const absl::optional<uint32_t>& border_pixel, const absl::optional<Gravity>& bit_gravity,
    const absl::optional<Gravity>& win_gravity, const absl::optional<BackingStore>& backing_store, const absl::optional<uint32_t>& backing_planes,
    const absl::optional<uint32_t>& backing_pixel, const absl::optional<Bool32>& override_redirect, const absl::optional<Bool32>& save_under,
    const absl::optional<EventMask>& event_mask, const absl::optional<EventMask>& do_not_propogate_mask, const absl::optional<ColorMap>& colormap,
    const absl::optional<Cursor>& cursor)
{
    return XProto::ChangeWindowAttributes(ChangeWindowAttributesRequest { window, background_pixmap, background_pixel, border_pixmap, border_pixel, bit_gravity, win_gravity,
        backing_store, backing_planes, backing_pixel, override_redirect, save_under, event_mask, do_not_propogate_mask, colormap, cursor });
}
...
Future<GetWindowAttributesReply> XProto::GetWindowAttributes(const Window& window) { return XProto::GetWindowAttributes(GetWindowAttributesRequest { window }); }
...
Future<void> XProto::DestroyWindow(const Window& window) { return XProto::DestroyWindow(DestroyWindowRequest { window }); }
...
Future<void> XProto::DestroySubwindows(const Window& window) { return XProto::DestroySubwindows(DestroySubwindowsRequest { window }); }
...
Future<void> XProto::ChangeSaveSet(const SetMode& mode, const Window& window) { return XProto::ChangeSaveSet(ChangeSaveSetRequest { mode, window }); }
...
Future<void> XProto::MapWindow(const Window& window) { return XProto::MapWindow(MapWindowRequest { window }); }
...
Future<void> XProto::MapSubwindows(const Window& window) { return XProto::MapSubwindows(MapSubwindowsRequest { window }); }
...
Future<void> XProto::UnmapWindow(const Window& window) { return XProto::UnmapWindow(UnmapWindowRequest { window }); }
...
Future<void> XProto::UnmapSubwindows(const Window& window) { return XProto::UnmapSubwindows(UnmapSubwindowsRequest { window }); }
...
Future<void> XProto::ConfigureWindow(const Window& window, const absl::optional<int32_t>& x, const absl::optional<int32_t>& y, const absl::optional<uint32_t>& width,
    const absl::optional<uint32_t>& height, const absl::optional<uint32_t>& border_width, const absl::optional<Window>& sibling, const absl::optional<StackMode>& stack_mode)
{
...
Future<void> XProto::CirculateWindow(const Circulate& direction, const Window& window) { return XProto::CirculateWindow(CirculateWindowRequest { direction, window }); }
...
Future<GetGeometryReply> XProto::GetGeometry(const Drawable& drawable) { return XProto::GetGeometry(GetGeometryRequest { drawable }); }
...
Future<QueryTreeReply> XProto::QueryTree(const Window& window) { return XProto::QueryTree(QueryTreeRequest { window }); }
...
Future<InternAtomReply> XProto::InternAtom(const uint8_t& only_if_exists, const std::string& name) { return XProto::InternAtom(InternAtomRequest { only_if_exists, name }); }
...
Future<GetAtomNameReply> XProto::GetAtomName(const Atom& atom) { return XProto::GetAtomName(GetAtomNameRequest { atom }); }
...
Future<void> XProto::ChangeProperty(const PropMode& mode, const Window& window, const Atom& property, const Atom& type, const uint8_t& format, const uint32_t& data_len,
...
Future<void> XProto::DeleteProperty(const Window& window, const Atom& property) { return XProto::DeleteProperty(DeletePropertyRequest { window, property }); }
...
Future<ListPropertiesReply> XProto::ListProperties(const Window& window) { return XProto::ListProperties(ListPropertiesRequest { window }); }
...
Future<GetSelectionOwnerReply> XProto::GetSelectionOwner(const Atom& selection) { return XProto::GetSelectionOwner(GetSelectionOwnerRequest { selection }); }
...
Future<void> XProto::UngrabPointer(const Time& time) { return XProto::UngrabPointer(UngrabPointerRequest { time }); }
...
Future<void> XProto::GrabButton(const uint8_t& owner_events, const Window& grab_window, const EventMask& event_mask, const GrabMode& pointer_mode, const GrabMode& keyboard_mode,
    const Window& confine_to, const Cursor& cursor, const ButtonIndex& button, const ModMask& modifiers)
{
...
Future<void> XProto::UngrabKeyboard(const Time& time) { return XProto::UngrabKeyboard(UngrabKeyboardRequest { time }); }
...
Future<void> XProto::GrabKey(
    const uint8_t& owner_events, const Window& grab_window, const ModMask& modifiers, const KeyCode& key, const GrabMode& pointer_mode, const GrabMode& keyboard_mode)
{
...
Future<void> XProto::AllowEvents(const Allow& mode, const Time& time) { return XProto::AllowEvents(AllowEventsRequest { mode, time }); }
...
Future<void> XProto::GrabServer() { return XProto::GrabServer(GrabServerRequest {}); }
...
Future<void> XProto::UngrabServer() { return XProto::UngrabServer(UngrabServerRequest {}); }
...
Future<QueryPointerReply> XProto::QueryPointer(const Window& window) { return XProto::QueryPointer(QueryPointerRequest { window }); }
...
Future<GetInputFocusReply> XProto::GetInputFocus() { return XProto::GetInputFocus(GetInputFocusRequest {}); }
...
Future<QueryKeymapReply> XProto::QueryKeymap() { return XProto::QueryKeymap(QueryKeymapRequest {}); }
...
Future<void> XProto::OpenFont(const Font& fid, const std::string& name) { return XProto::OpenFont(OpenFontRequest { fid, name }); }
...
Future<void> XProto::CloseFont(const Font& font) { return XProto::CloseFont(CloseFontRequest { font }); }
...
Future<QueryFontReply> XProto::QueryFont(const Fontable& font) { return XProto::QueryFont(QueryFontRequest { font }); }
...
Future<ListFontsReply> XProto::ListFonts(const uint16_t& max_names, const std::string& pattern) { return XProto::ListFonts(ListFontsRequest { max_names, pattern }); }
...
Future<void> XProto::SetFontPath(const std::vector<Str>& font) { return XProto::SetFontPath(SetFontPathRequest { font }); }
...
Future<GetFontPathReply> XProto::GetFontPath() { return XProto::GetFontPath(GetFontPathRequest {}); }
...
Future<void> XProto::FreePixmap(const Pixmap& pixmap) { return XProto::FreePixmap(FreePixmapRequest { pixmap }); }
...
Future<void> XProto::CreateGC(const GraphicsContext& cid, const Drawable& drawable, const absl::optional<Gx>& function, const absl::optional<uint32_t>& plane_mask,
    const absl::optional<uint32_t>& foreground, const absl::optional<uint32_t>& background, const absl::optional<uint32_t>& line_width, const absl::optional<LineStyle>& line_style,
    const absl::optional<CapStyle>& cap_style, const absl::optional<JoinStyle>& join_style, const absl::optional<FillStyle>& fill_style, const absl::optional<FillRule>& fill_rule,
    const absl::optional<Pixmap>& tile, const absl::optional<Pixmap>& stipple, const absl::optional<int32_t>& tile_stipple_x_origin,
    const absl::optional<int32_t>& tile_stipple_y_origin, const absl::optional<Font>& font, const absl::optional<SubwindowMode>& subwindow_mode,
    const absl::optional<Bool32>& graphics_exposures, const absl::optional<int32_t>& clip_x_origin, const absl::optional<int32_t>& clip_y_origin,
    const absl::optional<Pixmap>& clip_mask, const absl::optional<uint32_t>& dash_offset, const absl::optional<uint32_t>& dashes, const absl::optional<ArcMode>& arc_mode)
{
    return XProto::CreateGC(
        CreateGCRequest { cid, drawable, function, plane_mask, foreground, background, line_width, line_style, cap_style, join_style, fill_style, fill_rule, tile, stipple,
            tile_stipple_x_origin, tile_stipple_y_origin, font, subwindow_mode, graphics_exposures, clip_x_origin, clip_y_origin, clip_mask, dash_offset, dashes, arc_mode });
}
...
Future<void> XProto::ChangeGC(const GraphicsContext& gc, const absl::optional<Gx>& function, const absl::optional<uint32_t>& plane_mask, const absl::optional<uint32_t>& foreground,
    const absl::optional<uint32_t>& background, const absl::optional<uint32_t>& line_width, const absl::optional<LineStyle>& line_style, const absl::optional<CapStyle>& cap_style,
    const absl::optional<JoinStyle>& join_style, const absl::optional<FillStyle>& fill_style, const absl::optional<FillRule>& fill_rule, const absl::optional<Pixmap>& tile,
    const absl::optional<Pixmap>& stipple, const absl::optional<int32_t>& tile_stipple_x_origin, const absl::optional<int32_t>& tile_stipple_y_origin,
    const absl::optional<Font>& font, const absl::optional<SubwindowMode>& subwindow_mode, const absl::optional<Bool32>& graphics_exposures,
    const absl::optional<int32_t>& clip_x_origin, const absl::optional<int32_t>& clip_y_origin, const absl::optional<Pixmap>& clip_mask,
    const absl::optional<uint32_t>& dash_offset, const absl::optional<uint32_t>& dashes, const absl::optional<ArcMode>& arc_mode)
{
    return XProto::ChangeGC(ChangeGCRequest { gc, function, plane_mask, foreground, background, line_width, line_style, cap_style, join_style, fill_style, fill_rule, tile, stipple,
        tile_stipple_x_origin, tile_stipple_y_origin, font, subwindow_mode, graphics_exposures, clip_x_origin, clip_y_origin, clip_mask, dash_offset, dashes, arc_mode });
}
...
Future<void> XProto::SetClipRectangles(
    const ClipOrdering& ordering, const GraphicsContext& gc, const int16_t& clip_x_origin, const int16_t& clip_y_origin, const std::vector<Rectangle>& rectangles)
{
...
Future<void> XProto::FreeGC(const GraphicsContext& gc) { return XProto::FreeGC(FreeGCRequest { gc }); }
...
Future<void> XProto::ClearArea(const uint8_t& exposures, const Window& window, const int16_t& x, const int16_t& y, const uint16_t& width, const uint16_t& height)
{
...
Future<void> XProto::CopyPlane(const Drawable& src_drawable, const Drawable& dst_drawable, const GraphicsContext& gc, const int16_t& src_x, const int16_t& src_y,
    const int16_t& dst_x, const int16_t& dst_y, const uint16_t& width, const uint16_t& height, const uint32_t& bit_plane)
{
...
Future<void> XProto::PolyArc(const Drawable& drawable, const GraphicsContext& gc, const std::vector<Arc>& arcs) { return XProto::PolyArc(PolyArcRequest { drawable, gc, arcs }); }
...
Future<void> XProto::FillPoly(const Drawable& drawable, const GraphicsContext& gc, const PolyShape& shape, const CoordMode& coordinate_mode, const std::vector<Point>& points)
{
...
Future<void> XProto::PutImage(const ImageFormat& format, const Drawable& drawable, const GraphicsContext& gc, const uint16_t& width, const uint16_t& height, const int16_t& dst_x,
    const int16_t& dst_y, const uint8_t& left_pad, const uint8_t& depth, const scoped_refptr<base::RefCountedMemory>& data)
{
...
Future<GetImageReply> XProto::GetImage(
    const ImageFormat& format, const Drawable& drawable, const int16_t& x, const int16_t& y, const uint16_t& width, const uint16_t& height, const uint32_t& plane_mask)
{
...
Future<void> XProto::FreeColormap(const ColorMap& cmap) { return XProto::FreeColormap(FreeColormapRequest { cmap }); }
...
Future<void> XProto::CopyColormapAndFree(const ColorMap& mid, const ColorMap& src_cmap) { return XProto::CopyColormapAndFree(CopyColormapAndFreeRequest { mid, src_cmap }); }
...
Future<void> XProto::InstallColormap(const ColorMap& cmap) { return XProto::InstallColormap(InstallColormapRequest { cmap }); }
...
Future<void> XProto::UninstallColormap(const ColorMap& cmap) { return XProto::UninstallColormap(UninstallColormapRequest { cmap }); }
...
Future<ListInstalledColormapsReply> XProto::ListInstalledColormaps(const Window& window) { return XProto::ListInstalledColormaps(ListInstalledColormapsRequest { window }); }
...
Future<AllocNamedColorReply> XProto::AllocNamedColor(const ColorMap& cmap, const std::string& name) { return XProto::AllocNamedColor(AllocNamedColorRequest { cmap, name }); }
...
Future<void> XProto::StoreColors(const ColorMap& cmap, const std::vector<ColorItem>& items) { return XProto::StoreColors(StoreColorsRequest { cmap, items }); }
...
Future<QueryColorsReply> XProto::QueryColors(const ColorMap& cmap, const std::vector<uint32_t>& pixels) { return XProto::QueryColors(QueryColorsRequest { cmap, pixels }); }
...
Future<LookupColorReply> XProto::LookupColor(const ColorMap& cmap, const std::string& name) { return XProto::LookupColor(LookupColorRequest { cmap, name }); }
...
Future<void> XProto::CreateCursor(const Cursor& cid, const Pixmap& source, const Pixmap& mask, const uint16_t& fore_red, const uint16_t& fore_green, const uint16_t& fore_blue,
    const uint16_t& back_red, const uint16_t& back_green, const uint16_t& back_blue, const uint16_t& x, const uint16_t& y)
{
...
Future<void> XProto::CreateGlyphCursor(const Cursor& cid, const Font& source_font, const Font& mask_font, const uint16_t& source_char, const uint16_t& mask_char,
    const uint16_t& fore_red, const uint16_t& fore_green, const uint16_t& fore_blue, const uint16_t& back_red, const uint16_t& back_green, const uint16_t& back_blue)
{
...
Future<void> XProto::FreeCursor(const Cursor& cursor) { return XProto::FreeCursor(FreeCursorRequest { cursor }); }
...
Future<void> XProto::RecolorCursor(const Cursor& cursor, const uint16_t& fore_red, const uint16_t& fore_green, const uint16_t& fore_blue, const uint16_t& back_red,
...
Future<QueryExtensionReply> XProto::QueryExtension(const std::string& name) { return XProto::QueryExtension(QueryExtensionRequest { name }); }
...
Future<ListExtensionsReply> XProto::ListExtensions() { return XProto::ListExtensions(ListExtensionsRequest {}); }
...
Future<void> XProto::ChangeKeyboardMapping(const ChangeKeyboardMappingRequest& request)
{
    ...
    // keysyms
    DCHECK_EQ(static_cast<size_t>((keycode_count) * (keysyms_per_keycode)), keysyms.size());
...
Future<void> XProto::ChangeKeyboardMapping(const uint8_t& keycode_count, const KeyCode& first_keycode, const uint8_t& keysyms_per_keycode, const std::vector<KeySym>& keysyms)
{
...
Future<void> XProto::ChangeKeyboardControl(const absl::optional<int32_t>& key_click_percent, const absl::optional<int32_t>& bell_percent, const absl::optional<int32_t>& bell_pitch,
    const absl::optional<int32_t>& bell_duration, const absl::optional<uint32_t>& led, const absl::optional<LedMode>& led_mode, const absl::optional<KeyCode32>& key,
    const absl::optional<AutoRepeatMode>& auto_repeat_mode)
{
    return XProto::ChangeKeyboardControl(ChangeKeyboardControlRequest { key_click_percent, bell_percent, bell_pitch, bell_duration, led, led_mode, key, auto_repeat_mode });
}
...
Future<GetKeyboardControlReply> XProto::GetKeyboardControl() { return XProto::GetKeyboardControl(GetKeyboardControlRequest {}); }
...
Future<void> XProto::Bell(const int8_t& percent) { return XProto::Bell(BellRequest { percent }); }
...
Future<void> XProto::ChangePointerControl(
    const int16_t& acceleration_numerator, const int16_t& acceleration_denominator, const int16_t& threshold, const uint8_t& do_acceleration, const uint8_t& do_threshold)
{
    return XProto::ChangePointerControl(ChangePointerControlRequest { acceleration_numerator, acceleration_denominator, threshold, do_acceleration, do_threshold });
}
...
Future<GetPointerControlReply> XProto::GetPointerControl() { return XProto::GetPointerControl(GetPointerControlRequest {}); }
...
Future<GetScreenSaverReply> XProto::GetScreenSaver() { return XProto::GetScreenSaver(GetScreenSaverRequest {}); }
...
Future<ListHostsReply> XProto::ListHosts() { return XProto::ListHosts(ListHostsRequest {}); }
...
Future<void> XProto::SetAccessControl(const AccessControl& mode) { return XProto::SetAccessControl(SetAccessControlRequest { mode }); }
...
Future<void> XProto::SetCloseDownMode(const CloseDown& mode) { return XProto::SetCloseDownMode(SetCloseDownModeRequest { mode }); }
...
Future<void> XProto::KillClient(const uint32_t& resource) { return XProto::KillClient(KillClientRequest { resource }); }
...
Future<void> XProto::ForceScreenSaver(const ScreenSaverMode& mode) { return XProto::ForceScreenSaver(ForceScreenSaverRequest { mode }); }
...
Future<SetPointerMappingReply> XProto::SetPointerMapping(const std::vector<uint8_t>& map) { return XProto::SetPointerMapping(SetPointerMappingRequest { map }); }
...
Future<GetPointerMappingReply> XProto::GetPointerMapping() { return XProto::GetPointerMapping(GetPointerMappingRequest {}); }
...
Future<SetModifierMappingReply> XProto::SetModifierMapping(const SetModifierMappingRequest& request)
{
    ...
    // keycodes
    DCHECK_EQ(static_cast<size_t>((keycodes_per_modifier) * (8)), keycodes.size());
...
Future<GetModifierMappingReply> XProto::GetModifierMapping() { return XProto::GetModifierMapping(GetModifierMappingRequest {}); }
...
Future<void> XProto::NoOperation() { return XProto::NoOperation(NoOperationRequest {}); }
