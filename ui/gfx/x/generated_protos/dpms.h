...
public:
    ...
    Future<GetVersionReply> GetVersion(const uint16_t& client_major_version = {}, const uint16_t& client_minor_version = {});
    ...
    Future<void> SetTimeouts(const uint16_t& standby_timeout = {}, const uint16_t& suspend_timeout = {}, const uint16_t& off_timeout = {});
...
inline constexpr x11::Dpms::DPMSMode operator|(x11::Dpms::DPMSMode l, x11::Dpms::DPMSMode r)
{
    using T = std::underlying_type_t<x11::Dpms::DPMSMode>;
    return static_cast<x11::Dpms::DPMSMode>(static_cast<T>(l) | static_cast<T>(r));
}
