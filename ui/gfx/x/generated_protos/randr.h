...
public:
    ...
    struct ScreenSize {
        bool operator==(const ScreenSize& other) const { return width == other.width && height == other.height && mwidth == other.mwidth && mheight == other.mheight; }
    ...
    struct RefreshRates {
        bool operator==(const RefreshRates& other) const { return rates == other.rates; }
    ...
    struct ModeInfo {
        bool operator==(const ModeInfo& other) const
        {
            return id == other.id && width == other.width && height == other.height && dot_clock == other.dot_clock && hsync_start == other.hsync_start
                && hsync_end == other.hsync_end && htotal == other.htotal && hskew == other.hskew && vsync_start == other.vsync_start && vsync_end == other.vsync_end
                && vtotal == other.vtotal && name_len == other.name_len && mode_flags == other.mode_flags;
        }
    ...
    struct ScreenChangeNotifyEvent {
        ...
        x11::Window* GetWindow() { return reinterpret_cast<x11::Window*>(&request_window); }
    };

    struct MonitorInfo {
        bool operator==(const MonitorInfo& other) const
        {
            return name == other.name && primary == other.primary && automatic == other.automatic && x == other.x && y == other.y && width == other.width && height == other.height
                && width_in_millimeters == other.width_in_millimeters && height_in_millimeters == other.height_in_millimeters && outputs == other.outputs;
        }
    ...
    Future<SetScreenConfigReply> SetScreenConfig(const Window& window = {}, const Time& timestamp = {}, const Time& config_timestamp = {}, const uint16_t& sizeID = {},
        const Rotation& rotation = {}, const uint16_t& rate = {});
    ...
    Future<void> SetScreenSize(const Window& window = {}, const uint16_t& width = {}, const uint16_t& height = {}, const uint32_t& mm_width = {}, const uint32_t& mm_height = {});
    ...
    Future<void> ChangeOutputProperty(const Output& output = {}, const Atom& property = {}, const Atom& type = {}, const uint8_t& format = {}, const PropMode& mode = {},
    ...
    Future<GetOutputPropertyReply> GetOutputProperty(const Output& output = {}, const Atom& property = {}, const Atom& type = {}, const uint32_t& long_offset = {},
    ...
    Future<CreateModeReply> CreateMode(const Window& window = {}, const ModeInfo& mode_info = { {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {} }, const std::string& name = {});
    ...
    Future<SetCrtcConfigReply> SetCrtcConfig(const Crtc& crtc = {}, const Time& timestamp = {}, const Time& config_timestamp = {}, const int16_t& x = {}, const int16_t& y = {},
        const Mode& mode = {}, const Rotation& rotation = {}, const std::vector<Output>& outputs = {});
    ...
    Future<void> SetCrtcGamma(const Crtc& crtc = {}, const std::vector<uint16_t>& red = {}, const std::vector<uint16_t>& green = {}, const std::vector<uint16_t>& blue = {});
    ...
    Future<void> SetCrtcTransform(const Crtc& crtc = {}, const Render::Transform& transform = { {}, {}, {}, {}, {}, {}, {}, {}, {} }, const std::string& filter_name = {},
    ...
    Future<SetPanningReply> SetPanning(const Crtc& crtc = {}, const Time& timestamp = {}, const uint16_t& left = {}, const uint16_t& top = {}, const uint16_t& width = {},
    ...
    Future<void> ChangeProviderProperty(const Provider& provider = {}, const Atom& property = {}, const Atom& type = {}, const uint8_t& format = {}, const uint8_t& mode = {},
    ...
    Future<GetProviderPropertyReply> GetProviderProperty(const Provider& provider = {}, const Atom& property = {}, const Atom& type = {}, const uint32_t& long_offset = {},
        const uint32_t& long_length = {}, const uint8_t& c_delete = {}, const uint8_t& pending = {});
    ...
    Future<CreateLeaseReply> CreateLease(const Window& window = {}, const Lease& lid = {}, const std::vector<Crtc>& crtcs = {}, const std::vector<Output>& outputs = {});
