...
public:
    ...
    struct ModeInfo {
        ...
        {
            return dotclock == other.dotclock && hdisplay == other.hdisplay && hsyncstart == other.hsyncstart && hsyncend == other.hsyncend && htotal == other.htotal
                && hskew == other.hskew && vdisplay == other.vdisplay && vsyncstart == other.vsyncstart && vsyncend == other.vsyncend && vtotal == other.vtotal
    ...
    Future<void> ModModeLine(const uint32_t& screen = {}, const uint16_t& hdisplay = {}, const uint16_t& hsyncstart = {}, const uint16_t& hsyncend = {},
        const uint16_t& htotal = {}, const uint16_t& hskew = {}, const uint16_t& vdisplay = {}, const uint16_t& vsyncstart = {}, const uint16_t& vsyncend = {},
        const uint16_t& vtotal = {}, const ModeFlag& flags = {}, const std::vector<uint8_t>& c_private = {});
    ...
    Future<void> SwitchMode(const uint16_t& screen = {}, const uint16_t& zoom = {});
    ...
    Future<void> LockModeSwitch(const uint16_t& screen = {}, const uint16_t& lock = {});
    ...
    Future<GetAllModeLinesReply> GetAllModeLines(const GetAllModeLinesRequest& request);
    ...
    Future<void> AddModeLine(const uint32_t& screen = {}, const DotClock& dotclock = {}, const uint16_t& hdisplay = {}, const uint16_t& hsyncstart = {},
        const uint16_t& hsyncend = {}, const uint16_t& htotal = {}, const uint16_t& hskew = {}, const uint16_t& vdisplay = {}, const uint16_t& vsyncstart = {},
        const uint16_t& vsyncend = {}, const uint16_t& vtotal = {}, const ModeFlag& flags = {}, const DotClock& after_dotclock = {}, const uint16_t& after_hdisplay = {},
        const uint16_t& after_hsyncstart = {}, const uint16_t& after_hsyncend = {}, const uint16_t& after_htotal = {}, const uint16_t& after_hskew = {},
        const uint16_t& after_vdisplay = {}, const uint16_t& after_vsyncstart = {}, const uint16_t& after_vsyncend = {}, const uint16_t& after_vtotal = {},
    ...
    Future<void> DeleteModeLine(const uint32_t& screen = {}, const DotClock& dotclock = {}, const uint16_t& hdisplay = {}, const uint16_t& hsyncstart = {},
        const uint16_t& hsyncend = {}, const uint16_t& htotal = {}, const uint16_t& hskew = {}, const uint16_t& vdisplay = {}, const uint16_t& vsyncstart = {},
        const uint16_t& vsyncend = {}, const uint16_t& vtotal = {}, const ModeFlag& flags = {}, const std::vector<uint8_t>& c_private = {});
    ...
    Future<ValidateModeLineReply> ValidateModeLine(const ValidateModeLineRequest& request);

    Future<ValidateModeLineReply> ValidateModeLine(const uint32_t& screen = {}, const DotClock& dotclock = {}, const uint16_t& hdisplay = {}, const uint16_t& hsyncstart = {},
        const uint16_t& hsyncend = {}, const uint16_t& htotal = {}, const uint16_t& hskew = {}, const uint16_t& vdisplay = {}, const uint16_t& vsyncstart = {},
        const uint16_t& vsyncend = {}, const uint16_t& vtotal = {}, const ModeFlag& flags = {}, const std::vector<uint8_t>& c_private = {});
    ...
    Future<void> SwitchToMode(const uint32_t& screen = {}, const DotClock& dotclock = {}, const uint16_t& hdisplay = {}, const uint16_t& hsyncstart = {},
        const uint16_t& hsyncend = {}, const uint16_t& htotal = {}, const uint16_t& hskew = {}, const uint16_t& vdisplay = {}, const uint16_t& vsyncstart = {},
        const uint16_t& vsyncend = {}, const uint16_t& vtotal = {}, const ModeFlag& flags = {}, const std::vector<uint8_t>& c_private = {});
    ...
    Future<void> SetViewPort(const uint16_t& screen = {}, const uint32_t& x = {}, const uint32_t& y = {});
    ...
    Future<void> SetClientVersion(const uint16_t& major = {}, const uint16_t& minor = {});
    ...
    Future<void> SetGamma(const uint16_t& screen = {}, const uint32_t& red = {}, const uint32_t& green = {}, const uint32_t& blue = {});
    ...
    Future<GetGammaRampReply> GetGammaRamp(const uint16_t& screen = {}, const uint16_t& size = {});
    ...
    Future<void> SetGammaRamp(const uint16_t& screen = {}, const uint16_t& size = {}, const std::vector<uint16_t>& red = {}, const std::vector<uint16_t>& green = {},
    ...
    Future<GetGammaRampSizeReply> GetGammaRampSize(const GetGammaRampSizeRequest& request);
    ...
    Future<GetPermissionsReply> GetPermissions(const GetPermissionsRequest& request);
...
inline constexpr x11::XF86VidMode::ModeFlag operator|(x11::XF86VidMode::ModeFlag l, x11::XF86VidMode::ModeFlag r)
{
    using T = std::underlying_type_t<x11::XF86VidMode::ModeFlag>;
    return static_cast<x11::XF86VidMode::ModeFlag>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::XF86VidMode::ClockFlag operator|(x11::XF86VidMode::ClockFlag l, x11::XF86VidMode::ClockFlag r)
{
    using T = std::underlying_type_t<x11::XF86VidMode::ClockFlag>;
    return static_cast<x11::XF86VidMode::ClockFlag>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::XF86VidMode::Permission operator|(x11::XF86VidMode::Permission l, x11::XF86VidMode::Permission r)
{
    using T = std::underlying_type_t<x11::XF86VidMode::Permission>;
    return static_cast<x11::XF86VidMode::Permission>(static_cast<T>(l) | static_cast<T>(r));
}
