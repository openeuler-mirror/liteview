...
public:
    ...
    Future<void> Create(const DamageId& damage = {}, const Drawable& drawable = {}, const ReportLevel& level = {});
    ...
    Future<void> Subtract(const DamageId& damage = {}, const XFixes::Region& repair = {}, const XFixes::Region& parts = {});
    ...
    Future<void> Add(const Drawable& drawable = {}, const XFixes::Region& region = {});
...
inline constexpr x11::Damage::ReportLevel operator|(x11::Damage::ReportLevel l, x11::Damage::ReportLevel r)
{
    using T = std::underlying_type_t<x11::Damage::ReportLevel>;
    return static_cast<x11::Damage::ReportLevel>(static_cast<T>(l) | static_cast<T>(r));
}
