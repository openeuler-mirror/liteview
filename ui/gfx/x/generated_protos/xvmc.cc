...
Future<XvMC::QueryVersionReply> XvMC::QueryVersion(const XvMC::QueryVersionRequest& request)
{
    ...
    return connection_->SendRequest<XvMC::QueryVersionReply>(&buf, "XvMC::QueryVersion", false);
}

Future<XvMC::QueryVersionReply> XvMC::QueryVersion() { return XvMC::QueryVersion(XvMC::QueryVersionRequest {}); }

template <> COMPONENT_EXPORT(X11) std::unique_ptr<XvMC::QueryVersionReply> detail::ReadReply<XvMC::QueryVersionReply>(ReadBuffer* buffer)
{
    auto& buf = *buffer;
...
Future<XvMC::ListSurfaceTypesReply> XvMC::ListSurfaceTypes(const XvMC::ListSurfaceTypesRequest& request)
{
    if (!connection_->Ready() || !present())
        return {};
    ...
    return connection_->SendRequest<XvMC::ListSurfaceTypesReply>(&buf, "XvMC::ListSurfaceTypes", false);
}

Future<XvMC::ListSurfaceTypesReply> XvMC::ListSurfaceTypes(const Xv::Port& port_id) { return XvMC::ListSurfaceTypes(XvMC::ListSurfaceTypesRequest { port_id }); }

template <> COMPONENT_EXPORT(X11) std::unique_ptr<XvMC::ListSurfaceTypesReply> detail::ReadReply<XvMC::ListSurfaceTypesReply>(ReadBuffer* buffer)
{
    auto& buf = *buffer;
...
Future<XvMC::CreateContextReply> XvMC::CreateContext(const XvMC::CreateContextRequest& request)
{
    if (!connection_->Ready() || !present())
        return {};
    ...
    return connection_->SendRequest<XvMC::CreateContextReply>(&buf, "XvMC::CreateContext", false);
}

Future<XvMC::CreateContextReply> XvMC::CreateContext(
    const Context& context_id, const Xv::Port& port_id, const Surface& surface_id, const uint16_t& width, const uint16_t& height, const uint32_t& flags)
{
    return XvMC::CreateContext(XvMC::CreateContextRequest { context_id, port_id, surface_id, width, height, flags });
}

template <> COMPONENT_EXPORT(X11) std::unique_ptr<XvMC::CreateContextReply> detail::ReadReply<XvMC::CreateContextReply>(ReadBuffer* buffer)
{
    auto& buf = *buffer;
...
Future<void> XvMC::DestroyContext(const Context& context_id) { return XvMC::DestroyContext(XvMC::DestroyContextRequest { context_id }); }

Future<XvMC::CreateSurfaceReply> XvMC::CreateSurface(const XvMC::CreateSurfaceRequest& request)
{
    if (!connection_->Ready() || !present())
        return {};
    ...
    return connection_->SendRequest<XvMC::CreateSurfaceReply>(&buf, "XvMC::CreateSurface", false);
}

Future<XvMC::CreateSurfaceReply> XvMC::CreateSurface(const Surface& surface_id, const Context& context_id)
{
    return XvMC::CreateSurface(XvMC::CreateSurfaceRequest { surface_id, context_id });
}

template <> COMPONENT_EXPORT(X11) std::unique_ptr<XvMC::CreateSurfaceReply> detail::ReadReply<XvMC::CreateSurfaceReply>(ReadBuffer* buffer)
{
    auto& buf = *buffer;
...
Future<void> XvMC::DestroySurface(const Surface& surface_id) { return XvMC::DestroySurface(XvMC::DestroySurfaceRequest { surface_id }); }

Future<XvMC::CreateSubpictureReply> XvMC::CreateSubpicture(const XvMC::CreateSubpictureRequest& request)
{
    if (!connection_->Ready() || !present())
        return {};
    ...
    return connection_->SendRequest<XvMC::CreateSubpictureReply>(&buf, "XvMC::CreateSubpicture", false);
}

Future<XvMC::CreateSubpictureReply> XvMC::CreateSubpicture(
    const SubPicture& subpicture_id, const Context& context, const uint32_t& xvimage_id, const uint16_t& width, const uint16_t& height)
{
    return XvMC::CreateSubpicture(XvMC::CreateSubpictureRequest { subpicture_id, context, xvimage_id, width, height });
}

template <> COMPONENT_EXPORT(X11) std::unique_ptr<XvMC::CreateSubpictureReply> detail::ReadReply<XvMC::CreateSubpictureReply>(ReadBuffer* buffer)
{
    auto& buf = *buffer;
...
Future<void> XvMC::DestroySubpicture(const XvMC::DestroySubpictureRequest& request)
{
    if (!connection_->Ready() || !present())
        return {};
...
Future<void> XvMC::DestroySubpicture(const SubPicture& subpicture_id) { return XvMC::DestroySubpicture(XvMC::DestroySubpictureRequest { subpicture_id }); }

Future<XvMC::ListSubpictureTypesReply> XvMC::ListSubpictureTypes(const XvMC::ListSubpictureTypesRequest& request)
{
    if (!connection_->Ready() || !present())
        return {};
    ...
    return connection_->SendRequest<XvMC::ListSubpictureTypesReply>(&buf, "XvMC::ListSubpictureTypes", false);
}

Future<XvMC::ListSubpictureTypesReply> XvMC::ListSubpictureTypes(const Xv::Port& port_id, const Surface& surface_id)
{
    return XvMC::ListSubpictureTypes(XvMC::ListSubpictureTypesRequest { port_id, surface_id });
}

template <> COMPONENT_EXPORT(X11) std::unique_ptr<XvMC::ListSubpictureTypesReply> detail::ReadReply<XvMC::ListSubpictureTypesReply>(ReadBuffer* buffer)
{
    auto& buf = *buffer;
