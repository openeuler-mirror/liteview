...
public:
    ...
    struct Rational {
        bool operator==(const Rational& other) const { return numerator == other.numerator && denominator == other.denominator; }
    ...
    struct Format {
        bool operator==(const Format& other) const { return visual == other.visual && depth == other.depth; }
    ...
    struct AdaptorInfo {
        ...
        {
            return base_id == other.base_id && num_ports == other.num_ports && type == other.type && name == other.name && formats == other.formats;
        }
    ...
    struct EncodingInfo {
        ...
        {
            return encoding == other.encoding && width == other.width && height == other.height && rate == other.rate && name == other.name;
        }
    ...
    struct Image {
        ...
        {
            return id == other.id && width == other.width && height == other.height && pitches == other.pitches && offsets == other.offsets && data == other.data;
        }
    ...
    struct AttributeInfo {
        bool operator==(const AttributeInfo& other) const { return flags == other.flags && min == other.min && max == other.max && name == other.name; }
    ...
    struct ImageFormatInfo {
        ...
        {
            return id == other.id && type == other.type && byte_order == other.byte_order && guid == other.guid && bpp == other.bpp && num_planes == other.num_planes
                && depth == other.depth && red_mask == other.red_mask && green_mask == other.green_mask && blue_mask == other.blue_mask && format == other.format
                && y_sample_bits == other.y_sample_bits && u_sample_bits == other.u_sample_bits && v_sample_bits == other.v_sample_bits && vhorz_y_period == other.vhorz_y_period
                && vhorz_u_period == other.vhorz_u_period && vhorz_v_period == other.vhorz_v_period && vvert_y_period == other.vvert_y_period
                && vvert_u_period == other.vvert_u_period && vvert_v_period == other.vvert_v_period && vcomp_order == other.vcomp_order && vscanline_order == other.vscanline_order;
        }
    ...
    Future<QueryEncodingsReply> QueryEncodings(const QueryEncodingsRequest& request);
    ...
    Future<void> PutVideo(const Port& port = {}, const Drawable& drawable = {}, const GraphicsContext& gc = {}, const int16_t& vid_x = {}, const int16_t& vid_y = {},
        const uint16_t& vid_w = {}, const uint16_t& vid_h = {}, const int16_t& drw_x = {}, const int16_t& drw_y = {}, const uint16_t& drw_w = {}, const uint16_t& drw_h = {});
    ...
    Future<void> PutStill(const Port& port = {}, const Drawable& drawable = {}, const GraphicsContext& gc = {}, const int16_t& vid_x = {}, const int16_t& vid_y = {},
        const uint16_t& vid_w = {}, const uint16_t& vid_h = {}, const int16_t& drw_x = {}, const int16_t& drw_y = {}, const uint16_t& drw_w = {}, const uint16_t& drw_h = {});
    ...
    Future<void> GetVideo(const Port& port = {}, const Drawable& drawable = {}, const GraphicsContext& gc = {}, const int16_t& vid_x = {}, const int16_t& vid_y = {},
        const uint16_t& vid_w = {}, const uint16_t& vid_h = {}, const int16_t& drw_x = {}, const int16_t& drw_y = {}, const uint16_t& drw_w = {}, const uint16_t& drw_h = {});
    ...
    Future<void> GetStill(const Port& port = {}, const Drawable& drawable = {}, const GraphicsContext& gc = {}, const int16_t& vid_x = {}, const int16_t& vid_y = {},
        const uint16_t& vid_w = {}, const uint16_t& vid_h = {}, const int16_t& drw_x = {}, const int16_t& drw_y = {}, const uint16_t& drw_w = {}, const uint16_t& drw_h = {});
    ...
    Future<void> SelectVideoNotify(const Drawable& drawable = {}, const uint8_t& onoff = {});
    ...
    Future<void> SelectPortNotify(const Port& port = {}, const uint8_t& onoff = {});
    ...
    Future<void> SetPortAttribute(const Port& port = {}, const Atom& attribute = {}, const int32_t& value = {});
    ...
    Future<GetPortAttributeReply> GetPortAttribute(const GetPortAttributeRequest& request);

    Future<GetPortAttributeReply> GetPortAttribute(const Port& port = {}, const Atom& attribute = {});
    ...
    Future<QueryPortAttributesReply> QueryPortAttributes(const QueryPortAttributesRequest& request);
    ...
    Future<ListImageFormatsReply> ListImageFormats(const ListImageFormatsRequest& request);
    ...
    Future<QueryImageAttributesReply> QueryImageAttributes(const QueryImageAttributesRequest& request);

    Future<QueryImageAttributesReply> QueryImageAttributes(const Port& port = {}, const uint32_t& id = {}, const uint16_t& width = {}, const uint16_t& height = {});
    ...
    Future<void> PutImage(const Port& port = {}, const Drawable& drawable = {}, const GraphicsContext& gc = {}, const uint32_t& id = {}, const int16_t& src_x = {},
        const int16_t& src_y = {}, const uint16_t& src_w = {}, const uint16_t& src_h = {}, const int16_t& drw_x = {}, const int16_t& drw_y = {}, const uint16_t& drw_w = {},
        const uint16_t& drw_h = {}, const uint16_t& width = {}, const uint16_t& height = {}, const std::vector<uint8_t>& data = {});
    ...
    Future<void> ShmPutImage(const Port& port = {}, const Drawable& drawable = {}, const GraphicsContext& gc = {}, const Shm::Seg& shmseg = {}, const uint32_t& id = {},
        const uint32_t& offset = {}, const int16_t& src_x = {}, const int16_t& src_y = {}, const uint16_t& src_w = {}, const uint16_t& src_h = {}, const int16_t& drw_x = {},
        const int16_t& drw_y = {}, const uint16_t& drw_w = {}, const uint16_t& drw_h = {}, const uint16_t& width = {}, const uint16_t& height = {}, const uint8_t& send_event = {});
...
inline constexpr x11::Xv::ImageFormatInfoType operator|(x11::Xv::ImageFormatInfoType l, x11::Xv::ImageFormatInfoType r)
{
    using T = std::underlying_type_t<x11::Xv::ImageFormatInfoType>;
    return static_cast<x11::Xv::ImageFormatInfoType>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::Xv::ImageFormatInfoFormat operator|(x11::Xv::ImageFormatInfoFormat l, x11::Xv::ImageFormatInfoFormat r)
{
    using T = std::underlying_type_t<x11::Xv::ImageFormatInfoFormat>;
    return static_cast<x11::Xv::ImageFormatInfoFormat>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::Xv::AttributeFlag operator|(x11::Xv::AttributeFlag l, x11::Xv::AttributeFlag r)
{
    using T = std::underlying_type_t<x11::Xv::AttributeFlag>;
    return static_cast<x11::Xv::AttributeFlag>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::Xv::VideoNotifyReason operator|(x11::Xv::VideoNotifyReason l, x11::Xv::VideoNotifyReason r)
{
    using T = std::underlying_type_t<x11::Xv::VideoNotifyReason>;
    return static_cast<x11::Xv::VideoNotifyReason>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::Xv::ScanlineOrder operator|(x11::Xv::ScanlineOrder l, x11::Xv::ScanlineOrder r)
{
    using T = std::underlying_type_t<x11::Xv::ScanlineOrder>;
    return static_cast<x11::Xv::ScanlineOrder>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::Xv::GrabPortStatus operator|(x11::Xv::GrabPortStatus l, x11::Xv::GrabPortStatus r)
{
    using T = std::underlying_type_t<x11::Xv::GrabPortStatus>;
    return static_cast<x11::Xv::GrabPortStatus>(static_cast<T>(l) | static_cast<T>(r));
}
