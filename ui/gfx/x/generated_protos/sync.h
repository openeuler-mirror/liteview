...
public:
    ...
    struct Int64 {
        bool operator==(const Int64& other) const { return hi == other.hi && lo == other.lo; }
    ...
    struct SystemCounter {
        bool operator==(const SystemCounter& other) const { return counter == other.counter && resolution == other.resolution && name == other.name; }
    ...
    struct WaitCondition {
        bool operator==(const WaitCondition& other) const { return trigger == other.trigger && event_threshold == other.event_threshold; }
    ...
    Future<void> CreateAlarm(const Alarm& id = {}, const absl::optional<Counter>& counter = absl::nullopt, const absl::optional<Valuetype>& valueType = absl::nullopt,
        const absl::optional<Int64>& value = absl::nullopt, const absl::optional<Testtype>& testType = absl::nullopt, const absl::optional<Int64>& delta = absl::nullopt,
    ...
    Future<void> ChangeAlarm(const Alarm& id = {}, const absl::optional<Counter>& counter = absl::nullopt, const absl::optional<Valuetype>& valueType = absl::nullopt,
        const absl::optional<Int64>& value = absl::nullopt, const absl::optional<Testtype>& testType = absl::nullopt, const absl::optional<Int64>& delta = absl::nullopt,
        const absl::optional<uint32_t>& events = absl::nullopt);
