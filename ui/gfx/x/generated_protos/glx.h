...
public:
    ...
    Future<void> RenderLarge(const ContextTag& context_tag = {}, const uint16_t& request_num = {}, const uint16_t& request_total = {}, const std::vector<uint8_t>& data = {});
    ...
    Future<void> UseXFont(const ContextTag& context_tag = {}, const Font& font = {}, const uint32_t& first = {}, const uint32_t& count = {}, const uint32_t& list_base = {});
    ...
    Future<VendorPrivateWithReplyReply> VendorPrivateWithReply(const uint32_t& vendor_code = {}, const ContextTag& context_tag = {}, const std::vector<uint8_t>& data = {});
    ...
    Future<void> CreateContextAttribsARB(const Context& context = {}, const FbConfig& fbconfig = {}, const uint32_t& screen = {}, const Context& share_list = {},
    ...
    Future<ReadPixelsReply> ReadPixels(const ContextTag& context_tag = {}, const int32_t& x = {}, const int32_t& y = {}, const int32_t& width = {}, const int32_t& height = {},
    ...
    Future<GetTexImageReply> GetTexImage(const ContextTag& context_tag = {}, const uint32_t& target = {}, const int32_t& level = {}, const uint32_t& format = {},
    ...
    Future<GetColorTableReply> GetColorTable(
    ...
    Future<GetConvolutionParameterfvReply> GetConvolutionParameterfv(const ContextTag& context_tag = {}, const uint32_t& target = {}, const uint32_t& pname = {});
    ...
    Future<GetConvolutionParameterivReply> GetConvolutionParameteriv(const ContextTag& context_tag = {}, const uint32_t& target = {}, const uint32_t& pname = {});
    ...
    Future<GetHistogramReply> GetHistogram(const ContextTag& context_tag = {}, const uint32_t& target = {}, const uint32_t& format = {}, const uint32_t& type = {},
