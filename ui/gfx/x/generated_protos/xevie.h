...
public:
    ...
    Future<QueryVersionReply> QueryVersion(const uint16_t& client_major_version = {}, const uint16_t& client_minor_version = {});
    ...
    Future<SendReply> Send(const Event& event = {}, const uint32_t& data_type = {});
...
inline constexpr x11::Xevie::Datatype operator|(x11::Xevie::Datatype l, x11::Xevie::Datatype r)
{
    using T = std::underlying_type_t<x11::Xevie::Datatype>;
    return static_cast<x11::Xevie::Datatype>(static_cast<T>(l) | static_cast<T>(r));
}
