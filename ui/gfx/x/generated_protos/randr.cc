...
Future<void> RandR::SelectInput(const Window& window, const NotifyMask& enable) { return RandR::SelectInput(RandR::SelectInputRequest { window, enable }); }
...
Future<RandR::GetScreenInfoReply> RandR::GetScreenInfo(const Window& window) { return RandR::GetScreenInfo(RandR::GetScreenInfoRequest { window }); }
...
Future<RandR::GetScreenSizeRangeReply> RandR::GetScreenSizeRange(const Window& window) { return RandR::GetScreenSizeRange(RandR::GetScreenSizeRangeRequest { window }); }
...
Future<RandR::GetScreenResourcesReply> RandR::GetScreenResources(const Window& window) { return RandR::GetScreenResources(RandR::GetScreenResourcesRequest { window }); }
...
Future<RandR::ListOutputPropertiesReply> RandR::ListOutputProperties(const Output& output) { return RandR::ListOutputProperties(RandR::ListOutputPropertiesRequest { output }); }
...
Future<void> RandR::ConfigureOutputProperty(const Output& output, const Atom& property, const uint8_t& pending, const uint8_t& range, const std::vector<int32_t>& values)
{
...
Future<void> RandR::ChangeOutputProperty(const Output& output, const Atom& property, const Atom& type, const uint8_t& format, const PropMode& mode, const uint32_t& num_units,
...
Future<RandR::GetOutputPropertyReply> RandR::GetOutputProperty(
    const Output& output, const Atom& property, const Atom& type, const uint32_t& long_offset, const uint32_t& long_length, const uint8_t& c_delete, const uint8_t& pending)
{
...
Future<void> RandR::DestroyMode(const Mode& mode) { return RandR::DestroyMode(RandR::DestroyModeRequest { mode }); }
...
Future<void> RandR::AddOutputMode(const Output& output, const Mode& mode) { return RandR::AddOutputMode(RandR::AddOutputModeRequest { output, mode }); }
...
Future<void> RandR::DeleteOutputMode(const Output& output, const Mode& mode) { return RandR::DeleteOutputMode(RandR::DeleteOutputModeRequest { output, mode }); }
...
Future<RandR::SetCrtcConfigReply> RandR::SetCrtcConfig(const Crtc& crtc, const Time& timestamp, const Time& config_timestamp, const int16_t& x, const int16_t& y, const Mode& mode,
    const Rotation& rotation, const std::vector<Output>& outputs)
{
...
Future<RandR::GetCrtcGammaSizeReply> RandR::GetCrtcGammaSize(const Crtc& crtc) { return RandR::GetCrtcGammaSize(RandR::GetCrtcGammaSizeRequest { crtc }); }
...
Future<RandR::GetCrtcGammaReply> RandR::GetCrtcGamma(const Crtc& crtc) { return RandR::GetCrtcGamma(RandR::GetCrtcGammaRequest { crtc }); }
...
template <> COMPONENT_EXPORT(X11) std::unique_ptr<RandR::GetScreenResourcesCurrentReply> detail::ReadReply<RandR::GetScreenResourcesCurrentReply>(ReadBuffer* buffer)
{
    auto& buf = *buffer;
...
Future<void> RandR::SetCrtcTransform(const Crtc& crtc, const Render::Transform& transform, const std::string& filter_name, const std::vector<Render::Fixed>& filter_params)
{
...
Future<RandR::GetCrtcTransformReply> RandR::GetCrtcTransform(const Crtc& crtc) { return RandR::GetCrtcTransform(RandR::GetCrtcTransformRequest { crtc }); }
...
Future<RandR::GetPanningReply> RandR::GetPanning(const Crtc& crtc) { return RandR::GetPanning(RandR::GetPanningRequest { crtc }); }
...
Future<RandR::SetPanningReply> RandR::SetPanning(const Crtc& crtc, const Time& timestamp, const uint16_t& left, const uint16_t& top, const uint16_t& width, const uint16_t& height,
    const uint16_t& track_left, const uint16_t& track_top, const uint16_t& track_width, const uint16_t& track_height, const int16_t& border_left, const int16_t& border_top,
...
Future<void> RandR::SetOutputPrimary(const Window& window, const Output& output) { return RandR::SetOutputPrimary(RandR::SetOutputPrimaryRequest { window, output }); }
...
Future<RandR::GetOutputPrimaryReply> RandR::GetOutputPrimary(const Window& window) { return RandR::GetOutputPrimary(RandR::GetOutputPrimaryRequest { window }); }
...
Future<RandR::GetProvidersReply> RandR::GetProviders(const Window& window) { return RandR::GetProviders(RandR::GetProvidersRequest { window }); }
...
Future<void> RandR::ConfigureProviderProperty(const Provider& provider, const Atom& property, const uint8_t& pending, const uint8_t& range, const std::vector<int32_t>& values)
{
...
Future<void> RandR::ChangeProviderProperty(const Provider& provider, const Atom& property, const Atom& type, const uint8_t& format, const uint8_t& mode, const uint32_t& num_items,
    const scoped_refptr<base::RefCountedMemory>& data)
{
...
Future<RandR::GetMonitorsReply> RandR::GetMonitors(const Window& window, const uint8_t& get_active) { return RandR::GetMonitors(RandR::GetMonitorsRequest { window, get_active }); }
...
Future<void> RandR::SetMonitor(const Window& window, const MonitorInfo& monitorinfo) { return RandR::SetMonitor(RandR::SetMonitorRequest { window, monitorinfo }); }
...
Future<void> RandR::DeleteMonitor(const Window& window, const Atom& name) { return RandR::DeleteMonitor(RandR::DeleteMonitorRequest { window, name }); }
...
Future<void> RandR::FreeLease(const Lease& lid, const uint8_t& terminate) { return RandR::FreeLease(RandR::FreeLeaseRequest { lid, terminate }); }
