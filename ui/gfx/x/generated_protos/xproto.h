...
struct Char16 {
    bool operator==(const Char16& other) const { return byte1 == other.byte1 && byte2 == other.byte2; }
...
struct Format {
    bool operator==(const Format& other) const { return depth == other.depth && bits_per_pixel == other.bits_per_pixel && scanline_pad == other.scanline_pad; }
...
struct VisualType {
    ...
    {
        return visual_id == other.visual_id && c_class == other.c_class && bits_per_rgb_value == other.bits_per_rgb_value && colormap_entries == other.colormap_entries
            && red_mask == other.red_mask && green_mask == other.green_mask && blue_mask == other.blue_mask;
    }
...
struct Depth {
    bool operator==(const Depth& other) const { return depth == other.depth && visuals == other.visuals; }
...
struct Screen {
    bool operator==(const Screen& other) const
    {
        return root == other.root && default_colormap == other.default_colormap && white_pixel == other.white_pixel && black_pixel == other.black_pixel
            ...
            && width_in_millimeters == other.width_in_millimeters && height_in_millimeters == other.height_in_millimeters && min_installed_maps == other.min_installed_maps
            && max_installed_maps == other.max_installed_maps && root_visual == other.root_visual && backing_stores == other.backing_stores && save_unders == other.save_unders
            && root_depth == other.root_depth && allowed_depths == other.allowed_depths;
    }
...
struct SetupRequest {
    ...
    {
        return byte_order == other.byte_order && protocol_major_version == other.protocol_major_version && protocol_minor_version == other.protocol_minor_version
            && authorization_protocol_name == other.authorization_protocol_name && authorization_protocol_data == other.authorization_protocol_data;
    }
...
struct SetupFailed {
    ...
    {
        return status == other.status && protocol_major_version == other.protocol_major_version && protocol_minor_version == other.protocol_minor_version && length == other.length
            && reason == other.reason;
    }
...
struct SetupAuthenticate {
    bool operator==(const SetupAuthenticate& other) const { return status == other.status && length == other.length && reason == other.reason; }
...
struct Setup {
    ...
    {
        return status == other.status && protocol_major_version == other.protocol_major_version && protocol_minor_version == other.protocol_minor_version && length == other.length
            && release_number == other.release_number && resource_id_base == other.resource_id_base && resource_id_mask == other.resource_id_mask
            && motion_buffer_size == other.motion_buffer_size && maximum_request_length == other.maximum_request_length && image_byte_order == other.image_byte_order
            && bitmap_format_bit_order == other.bitmap_format_bit_order && bitmap_format_scanline_unit == other.bitmap_format_scanline_unit
            && bitmap_format_scanline_pad == other.bitmap_format_scanline_pad && min_keycode == other.min_keycode && max_keycode == other.max_keycode && vendor == other.vendor
...
struct TimeCoord {
    bool operator==(const TimeCoord& other) const { return time == other.time && x == other.x && y == other.y; }
...
struct FontProperty {
    bool operator==(const FontProperty& other) const { return name == other.name && value == other.value; }
...
struct CharInfo {
    ...
    {
        return left_side_bearing == other.left_side_bearing && right_side_bearing == other.right_side_bearing && character_width == other.character_width && ascent == other.ascent
...
struct Segment {
    bool operator==(const Segment& other) const { return x1 == other.x1 && y1 == other.y1 && x2 == other.x2 && y2 == other.y2; }
...
struct ColorItem {
    bool operator==(const ColorItem& other) const { return pixel == other.pixel && red == other.red && green == other.green && blue == other.blue && flags == other.flags; }
...
struct Host {
    bool operator==(const Host& other) const { return family == other.family && address == other.address; }
...
public:
    ...
    Future<void> CreateWindow(const uint8_t& depth = {}, const Window& wid = {}, const Window& parent = {}, const int16_t& x = {}, const int16_t& y = {},
        const uint16_t& width = {}, const uint16_t& height = {}, const uint16_t& border_width = {}, const WindowClass& c_class = {}, const VisualId& visual = {},
        const absl::optional<Pixmap>& background_pixmap = absl::nullopt, const absl::optional<uint32_t>& background_pixel = absl::nullopt,
        const absl::optional<Pixmap>& border_pixmap = absl::nullopt, const absl::optional<uint32_t>& border_pixel = absl::nullopt,
        const absl::optional<Gravity>& bit_gravity = absl::nullopt, const absl::optional<Gravity>& win_gravity = absl::nullopt,
        const absl::optional<BackingStore>& backing_store = absl::nullopt, const absl::optional<uint32_t>& backing_planes = absl::nullopt,
        const absl::optional<uint32_t>& backing_pixel = absl::nullopt, const absl::optional<Bool32>& override_redirect = absl::nullopt,
        const absl::optional<Bool32>& save_under = absl::nullopt, const absl::optional<EventMask>& event_mask = absl::nullopt,
        const absl::optional<EventMask>& do_not_propogate_mask = absl::nullopt, const absl::optional<ColorMap>& colormap = absl::nullopt,
    ...
    Future<void> ChangeWindowAttributes(const Window& window = {}, const absl::optional<Pixmap>& background_pixmap = absl::nullopt,
        const absl::optional<uint32_t>& background_pixel = absl::nullopt, const absl::optional<Pixmap>& border_pixmap = absl::nullopt,
        const absl::optional<uint32_t>& border_pixel = absl::nullopt, const absl::optional<Gravity>& bit_gravity = absl::nullopt,
        const absl::optional<Gravity>& win_gravity = absl::nullopt, const absl::optional<BackingStore>& backing_store = absl::nullopt,
        const absl::optional<uint32_t>& backing_planes = absl::nullopt, const absl::optional<uint32_t>& backing_pixel = absl::nullopt,
        const absl::optional<Bool32>& override_redirect = absl::nullopt, const absl::optional<Bool32>& save_under = absl::nullopt,
        const absl::optional<EventMask>& event_mask = absl::nullopt, const absl::optional<EventMask>& do_not_propogate_mask = absl::nullopt,
        const absl::optional<ColorMap>& colormap = absl::nullopt, const absl::optional<Cursor>& cursor = absl::nullopt);
    ...
    Future<void> ConfigureWindow(const Window& window = {}, const absl::optional<int32_t>& x = absl::nullopt, const absl::optional<int32_t>& y = absl::nullopt,
        const absl::optional<uint32_t>& width = absl::nullopt, const absl::optional<uint32_t>& height = absl::nullopt, const absl::optional<uint32_t>& border_width = absl::nullopt,
        const absl::optional<Window>& sibling = absl::nullopt, const absl::optional<StackMode>& stack_mode = absl::nullopt);
    ...
    Future<void> ChangeProperty(const PropMode& mode = {}, const Window& window = {}, const Atom& property = {}, const Atom& type = {}, const uint8_t& format = {},
    ...
    Future<void> ConvertSelection(const Window& requestor = {}, const Atom& selection = {}, const Atom& target = {}, const Atom& property = {}, const Time& time = {});

    Future<void> SendEvent(const SendEventRequest& request);

    Future<void> SendEvent(const uint8_t& propagate = {}, const Window& destination = {}, const EventMask& event_mask = {}, const std::array<char, 32>& event = {});

    Future<GrabPointerReply> GrabPointer(const GrabPointerRequest& request);

    Future<GrabPointerReply> GrabPointer(const uint8_t& owner_events = {}, const Window& grab_window = {}, const EventMask& event_mask = {}, const GrabMode& pointer_mode = {},
    ...
    Future<void> GrabButton(const uint8_t& owner_events = {}, const Window& grab_window = {}, const EventMask& event_mask = {}, const GrabMode& pointer_mode = {},
    ...
    Future<TranslateCoordinatesReply> TranslateCoordinates(const Window& src_window = {}, const Window& dst_window = {}, const int16_t& src_x = {}, const int16_t& src_y = {});

    Future<void> WarpPointer(const WarpPointerRequest& request);

    Future<void> WarpPointer(const Window& src_window = {}, const Window& dst_window = {}, const int16_t& src_x = {}, const int16_t& src_y = {}, const uint16_t& src_width = {},
    ...
    Future<void> CreatePixmap(const uint8_t& depth = {}, const Pixmap& pid = {}, const Drawable& drawable = {}, const uint16_t& width = {}, const uint16_t& height = {});
    ...
    Future<void> CreateGC(const GraphicsContext& cid = {}, const Drawable& drawable = {}, const absl::optional<Gx>& function = absl::nullopt,
        const absl::optional<uint32_t>& plane_mask = absl::nullopt, const absl::optional<uint32_t>& foreground = absl::nullopt,
        const absl::optional<uint32_t>& background = absl::nullopt, const absl::optional<uint32_t>& line_width = absl::nullopt,
        const absl::optional<LineStyle>& line_style = absl::nullopt, const absl::optional<CapStyle>& cap_style = absl::nullopt,
        const absl::optional<JoinStyle>& join_style = absl::nullopt, const absl::optional<FillStyle>& fill_style = absl::nullopt,
        const absl::optional<FillRule>& fill_rule = absl::nullopt, const absl::optional<Pixmap>& tile = absl::nullopt, const absl::optional<Pixmap>& stipple = absl::nullopt,
        const absl::optional<int32_t>& tile_stipple_x_origin = absl::nullopt, const absl::optional<int32_t>& tile_stipple_y_origin = absl::nullopt,
        const absl::optional<Font>& font = absl::nullopt, const absl::optional<SubwindowMode>& subwindow_mode = absl::nullopt,
        const absl::optional<Bool32>& graphics_exposures = absl::nullopt, const absl::optional<int32_t>& clip_x_origin = absl::nullopt,
        const absl::optional<int32_t>& clip_y_origin = absl::nullopt, const absl::optional<Pixmap>& clip_mask = absl::nullopt,
        const absl::optional<uint32_t>& dash_offset = absl::nullopt, const absl::optional<uint32_t>& dashes = absl::nullopt,
        const absl::optional<ArcMode>& arc_mode = absl::nullopt);

    Future<void> ChangeGC(const ChangeGCRequest& request);

    Future<void> ChangeGC(const GraphicsContext& gc = {}, const absl::optional<Gx>& function = absl::nullopt, const absl::optional<uint32_t>& plane_mask = absl::nullopt,
        const absl::optional<uint32_t>& foreground = absl::nullopt, const absl::optional<uint32_t>& background = absl::nullopt,
        const absl::optional<uint32_t>& line_width = absl::nullopt, const absl::optional<LineStyle>& line_style = absl::nullopt,
        const absl::optional<CapStyle>& cap_style = absl::nullopt, const absl::optional<JoinStyle>& join_style = absl::nullopt,
        const absl::optional<FillStyle>& fill_style = absl::nullopt, const absl::optional<FillRule>& fill_rule = absl::nullopt, const absl::optional<Pixmap>& tile = absl::nullopt,
        const absl::optional<Pixmap>& stipple = absl::nullopt, const absl::optional<int32_t>& tile_stipple_x_origin = absl::nullopt,
        const absl::optional<int32_t>& tile_stipple_y_origin = absl::nullopt, const absl::optional<Font>& font = absl::nullopt,
        const absl::optional<SubwindowMode>& subwindow_mode = absl::nullopt, const absl::optional<Bool32>& graphics_exposures = absl::nullopt,
        const absl::optional<int32_t>& clip_x_origin = absl::nullopt, const absl::optional<int32_t>& clip_y_origin = absl::nullopt,
        const absl::optional<Pixmap>& clip_mask = absl::nullopt, const absl::optional<uint32_t>& dash_offset = absl::nullopt,
        const absl::optional<uint32_t>& dashes = absl::nullopt, const absl::optional<ArcMode>& arc_mode = absl::nullopt);
    ...
    Future<void> SetClipRectangles(const ClipOrdering& ordering = {}, const GraphicsContext& gc = {}, const int16_t& clip_x_origin = {}, const int16_t& clip_y_origin = {},
    ...
    Future<void> PolyPoint(const CoordMode& coordinate_mode = {}, const Drawable& drawable = {}, const GraphicsContext& gc = {}, const std::vector<Point>& points = {});

    Future<void> PolyLine(const PolyLineRequest& request);

    Future<void> PolyLine(const CoordMode& coordinate_mode = {}, const Drawable& drawable = {}, const GraphicsContext& gc = {}, const std::vector<Point>& points = {});
    ...
    Future<void> PutImage(const ImageFormat& format = {}, const Drawable& drawable = {}, const GraphicsContext& gc = {}, const uint16_t& width = {}, const uint16_t& height = {},
    ...
    Future<GetImageReply> GetImage(const ImageFormat& format = {}, const Drawable& drawable = {}, const int16_t& x = {}, const int16_t& y = {}, const uint16_t& width = {},
        const uint16_t& height = {}, const uint32_t& plane_mask = {});

    Future<void> PolyText8(const PolyText8Request& request);

    Future<void> PolyText8(const Drawable& drawable = {}, const GraphicsContext& gc = {}, const int16_t& x = {}, const int16_t& y = {}, const std::vector<uint8_t>& items = {});

    Future<void> PolyText16(const PolyText16Request& request);

    Future<void> PolyText16(const Drawable& drawable = {}, const GraphicsContext& gc = {}, const int16_t& x = {}, const int16_t& y = {}, const std::vector<uint8_t>& items = {});

    Future<void> ImageText8(const ImageText8Request& request);

    Future<void> ImageText8(const Drawable& drawable = {}, const GraphicsContext& gc = {}, const int16_t& x = {}, const int16_t& y = {}, const std::string& string = {});

    Future<void> ImageText16(const ImageText16Request& request);

    Future<void> ImageText16(const Drawable& drawable = {}, const GraphicsContext& gc = {}, const int16_t& x = {}, const int16_t& y = {}, const std::vector<Char16>& string = {});
    ...
    Future<AllocColorCellsReply> AllocColorCells(const uint8_t& contiguous = {}, const ColorMap& cmap = {}, const uint16_t& colors = {}, const uint16_t& planes = {});
    ...
    Future<void> CreateCursor(const Cursor& cid = {}, const Pixmap& source = {}, const Pixmap& mask = {}, const uint16_t& fore_red = {}, const uint16_t& fore_green = {},
        const uint16_t& fore_blue = {}, const uint16_t& back_red = {}, const uint16_t& back_green = {}, const uint16_t& back_blue = {}, const uint16_t& x = {},
        const uint16_t& y = {});
    ...
    Future<QueryBestSizeReply> QueryBestSize(const QueryShapeOf& c_class = {}, const Drawable& drawable = {}, const uint16_t& width = {}, const uint16_t& height = {});
    ...
    Future<void> ChangeKeyboardControl(const absl::optional<int32_t>& key_click_percent = absl::nullopt, const absl::optional<int32_t>& bell_percent = absl::nullopt,
        const absl::optional<int32_t>& bell_pitch = absl::nullopt, const absl::optional<int32_t>& bell_duration = absl::nullopt,
        const absl::optional<uint32_t>& led = absl::nullopt, const absl::optional<LedMode>& led_mode = absl::nullopt, const absl::optional<KeyCode32>& key = absl::nullopt,
    ...
    Future<void> SetScreenSaver(const int16_t& timeout = {}, const int16_t& interval = {}, const Blanking& prefer_blanking = {}, const Exposures& allow_exposures = {});
