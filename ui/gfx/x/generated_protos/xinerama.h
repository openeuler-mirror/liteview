...
public:
    ...
    struct ScreenInfo {
        bool operator==(const ScreenInfo& other) const { return x_org == other.x_org && y_org == other.y_org && width == other.width && height == other.height; }
    ...
    Future<QueryVersionReply> QueryVersion(const uint8_t& major = {}, const uint8_t& minor = {});
    ...
    Future<GetScreenCountReply> GetScreenCount(const GetScreenCountRequest& request);
    ...
    Future<GetScreenSizeReply> GetScreenSize(const Window& window = {}, const uint32_t& screen = {});
