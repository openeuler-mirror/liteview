...
public:
    ...
    void SetOutputColorSpaceAndBufferFormat(ContentColorUsage color_usage, bool needs_alpha, const gfx::ColorSpace& color_space, gfx::BufferFormat buffer_format);
    ...
    // on Windows.
    void SetSDRMaxLuminanceNits(float sdr_max_luminance_nits) { sdr_max_luminance_nits_ = sdr_max_luminance_nits; }
    ...
    void SetHDRMaxLuminanceRelative(float hdr_max_luminance_relative) { hdr_max_luminance_relative_ = hdr_max_luminance_relative; }
    float GetHDRMaxLuminanceRelative() const { return hdr_max_luminance_relative_; }
    ...
    void SetPrimaries(const SkColorSpacePrimaries& primaries) { primaries_ = primaries; }
    ...
    void ToStrings(std::vector<std::string>* out_names, std::vector<gfx::ColorSpace>* out_color_spaces, std::vector<gfx::BufferFormat>* out_buffer_formats) const;
