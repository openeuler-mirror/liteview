...
public:
    ...
    PlatformFontMac(sk_sp<SkTypeface> typeface, int font_size_pixels, const absl::optional<FontRenderParams>& params);
...
private:
    ...
    PlatformFontMac(NativeFont font, absl::optional<SystemFontType> system_font_type);

    PlatformFontMac(NativeFont font, absl::optional<SystemFontType> system_font_type, FontSpec spec);
