...
SingletonHwndObserver::~SingletonHwndObserver() { ClearWndProc(); }
...
void SingletonHwndObserver::OnWndProc(HWND hwnd, UINT message, WPARAM wparam, LPARAM lparam) { wnd_proc_.Run(hwnd, message, wparam, lparam); }
