...
// static
void CrashIdHelper::RegisterMainThread(base::PlatformThreadId thread_id) { main_thread_id_ = thread_id; }

CrashIdHelper::ScopedLogger::~ScopedLogger() { CrashIdHelper::Get()->OnDidProcessMessages(); }
