...
// static
SingletonHwnd* SingletonHwnd::GetInstance() { return base::Singleton<SingletonHwnd>::get(); }
...
void SingletonHwnd::AddObserver(SingletonHwndObserver* observer) { observer_list_.AddObserver(observer); }

void SingletonHwnd::RemoveObserver(SingletonHwndObserver* observer) { observer_list_.RemoveObserver(observer); }
