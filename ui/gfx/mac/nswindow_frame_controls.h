...
GFX_EXPORT void SetNSWindowCanFullscreen(NSWindow* window, bool allow_fullscreen);

// Sets whether the window appears on all workspaces.
GFX_EXPORT void SetNSWindowVisibleOnAllWorkspaces(NSWindow* window, bool always_visible);
...
GFX_EXPORT void ApplyNSWindowSizeConstraints(NSWindow* window, const gfx::Size& min_size, const gfx::Size& max_size, bool can_resize, bool can_fullscreen);
