...
GFX_EXPORT void PaintVectorIcon(Canvas* canvas, const VectorIcon& icon, SkColor color);

// As above, with a specified size. |dip_size| is the length of a single edge
// of the square icon, in device independent pixels.
GFX_EXPORT void PaintVectorIcon(Canvas* canvas, const VectorIcon& icon, int dip_size, SkColor color);
...
GFX_EXPORT ImageSkia CreateVectorIcon(const VectorIcon& icon, int dip_size, SkColor color);
...
GFX_EXPORT ImageSkia CreateVectorIconWithBadge(const VectorIcon& icon, int dip_size, SkColor color, const VectorIcon& badge_icon);
...
GFX_EXPORT ImageSkia CreateVectorIconFromSource(const std::string& source, int dip_size, SkColor color);
#endif
