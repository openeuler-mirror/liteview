...
GFX_EXPORT bool IsWithinHSLRange(const HSL& hsl, const HSL& lower_bound, const HSL& upper_bound);
...
GFX_EXPORT SkColor AlphaBlend(SkColor foreground, SkColor background, SkAlpha alpha);

// As above, but with alpha specified as 0..1.
GFX_EXPORT SkColor AlphaBlend(SkColor foreground, SkColor background, float alpha);

// Returns the color that results from painting |foreground| on top of
// |background|.
GFX_EXPORT SkColor GetResultingPaintColor(SkColor foreground, SkColor background);
...
// |background|.
GFX_EXPORT SkColor PickContrastingColor(SkColor foreground1, SkColor foreground2, SkColor background);
...
GFX_EXPORT BlendResult BlendForMinContrast(
    SkColor default_foreground, SkColor background, absl::optional<SkColor> high_contrast_foreground = absl::nullopt, float contrast_ratio = kMinimumReadableContrastRatio);
...
GFX_EXPORT SkColor PickGoogleColor(SkColor color, SkColor background_color, float min_contrast);
...
GFX_EXPORT SkColor PickGoogleColor(SkColor color, SkColor background_color_a, SkColor background_color_b, float min_contrast);
