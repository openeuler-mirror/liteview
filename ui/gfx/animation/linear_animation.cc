...
void LinearAnimation::SetDuration(base::TimeDelta duration)
{
    static const double duration_scale_factor = []() {
        ...
        return (base::StringToDouble(command_line->GetSwitchValueASCII(switches::kAnimationDurationScale), &animation_duration_scale) && (animation_duration_scale >= 0.0))
...
void LinearAnimation::AnimationStarted() { state_ = 0.0; }
...
bool LinearAnimation::ShouldSendCanceledFromStop() { return state_ != 1; }
