...
void ExpectTranslateX(SkScalar translate_x, const gfx::TransformOperations& operations) { EXPECT_FLOAT_EQ(translate_x, operations.Apply().rc(0, 3)); }
...
TEST(KeyframedAnimationCurveTest, MaximumScale)
{
    ...
    curve->AddKeyframe(TransformKeyframe::Create(base::Seconds(1.f), operations1, CubicBezierTimingFunction::CreatePreset(CubicBezierTimingFunction::EaseType::EASE)));
    ...
    curve->AddKeyframe(TransformKeyframe::Create(base::Seconds(2.f), operations2, CubicBezierTimingFunction::CreatePreset(CubicBezierTimingFunction::EaseType::EASE)));
    ...
    curve->AddKeyframe(TransformKeyframe::Create(base::Seconds(3.f), operations3, CubicBezierTimingFunction::CreatePreset(CubicBezierTimingFunction::EaseType::EASE)));
    ...
    curve2->AddKeyframe(TransformKeyframe::Create(base::TimeDelta(), operations5, CubicBezierTimingFunction::CreatePreset(CubicBezierTimingFunction::EaseType::EASE)));
    gfx::TransformOperations operations6;
    operations6.AppendScale(0.5f, 0.3f, -0.8f);
    curve2->AddKeyframe(TransformKeyframe::Create(base::Seconds(1.f), operations6, CubicBezierTimingFunction::CreatePreset(CubicBezierTimingFunction::EaseType::EASE)));
...
TEST(KeyframeAnimationCurveTest, NonCalculatableMaximumScale)
{
    ...
    curve->AddKeyframe(TransformKeyframe::Create(base::Seconds(1.f), operations4, CubicBezierTimingFunction::CreatePreset(CubicBezierTimingFunction::EaseType::EASE)));
    curve->AddKeyframe(TransformKeyframe::Create(base::Seconds(1.f), operations4, CubicBezierTimingFunction::CreatePreset(CubicBezierTimingFunction::EaseType::EASE)));
    ...
    curve->AddKeyframe(TransformKeyframe::Create(base::TimeDelta(), operations, CubicBezierTimingFunction::CreatePreset(CubicBezierTimingFunction::EaseType::EASE)));
...
TEST(KeyframedAnimationCurveTest, CurveAndKeyframeTiming)
{
    ...
    EXPECT_FLOAT_EQ(0.f, curve->GetValue(base::Seconds(-1.f)));
    EXPECT_FLOAT_EQ(0.f, curve->GetValue(base::Seconds(0.f)));
    EXPECT_FLOAT_EQ(0.f, curve->GetValue(base::Seconds(0.25f))); // Clamped. c(.25) < 0
    ...
    EXPECT_FLOAT_EQ(1.f, curve->GetValue(base::Seconds(0.75f))); // Clamped. c(.75) > 1
    EXPECT_FLOAT_EQ(1.f, curve->GetValue(base::Seconds(1.f)));
    EXPECT_FLOAT_EQ(1.f, curve->GetValue(base::Seconds(2.f)));
}
...
TEST(KeyFrameAnimationCurveTest, TickIntervalForLinearTimingFunction)
{
    ...
    curve->AddKeyframe(SizeKeyframe::Create(base::Seconds(kDurationAB), size_b, StepsTimingFunction::Create(kNumStepsBC, StepsTimingFunction::StepPosition::START)));
