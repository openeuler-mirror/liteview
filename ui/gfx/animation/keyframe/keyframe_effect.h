...
public:
    ...
    void set_transition(const Transition& transition) { transition_ = transition; }
    ...
    void TransitionSizeTo(SizeAnimationCurve::Target* target, base::TimeTicks monotonic_time, int target_property, const gfx::SizeF& from, const gfx::SizeF& to);
...
private:
    void TickInternal(base::TimeTicks monotonic_time, bool include_infinite_animations);
