...
std::string KeyframeModel::ToString(RunState state) { return s_runStateNames[state]; }
...
int KeyframeModel::TargetProperty() const { return target_property_; }
...
KeyframeModel::Phase KeyframeModel::CalculatePhaseForTesting(base::TimeDelta local_time) const { return CalculatePhase(local_time); }
...
absl::optional<base::TimeDelta> KeyframeModel::CalculateActiveTime(base::TimeTicks monotonic_time) const
{
...
bool KeyframeModel::HasActiveTime(base::TimeTicks monotonic_time) const { return CalculateActiveTime(monotonic_time).has_value(); }

bool KeyframeModel::StartShouldBeDeferred() const { return false; }
