...
public:
    ...
    // elision.
    StringSlicer(const std::u16string& text, const std::u16string& ellipsis, bool elide_in_middle, bool elide_at_beginning, absl::optional<bool> elide_whitespace = absl::nullopt);
...
GFX_EXPORT std::u16string ElideText(const std::u16string& text, const gfx::FontList& font_list, float available_pixel_width, ElideBehavior elide_behavior);
...
GFX_EXPORT std::u16string ElideFilename(const base::FilePath& filename, const gfx::FontList& font_list, float available_pixel_width);
...
GFX_EXPORT bool ElideString(const std::u16string& input, size_t max_len, std::u16string* output);
...
GFX_EXPORT bool ElideRectangleString(const std::u16string& input, size_t max_rows, size_t max_cols, bool strict, std::u16string* output);
...
GFX_EXPORT int ElideRectangleText(const std::u16string& text, const gfx::FontList& font_list, float available_pixel_width, int available_pixel_height,
...
GFX_EXPORT std::u16string TruncateString(const std::u16string& string, size_t length, BreakType break_type);
