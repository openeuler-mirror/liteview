...
static bool IsUninitializedBitmap(const SkBitmap& bitmap) { return bitmap.isNull() && bitmap.colorType() == kUnknown_SkColorType && bitmap.alphaType() == kUnknown_SkAlphaType; }
