...
public:
    explicit ScopedDefaultFontDescription(const std::string& font_description) { FontList::SetDefaultFontDescription(font_description); }
    ~ScopedDefaultFontDescription() { FontList::SetDefaultFontDescription(std::string()); }
};
