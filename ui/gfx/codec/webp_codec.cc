...
bool WebpCodec::Encode(const SkPixmap& input, int quality, std::vector<unsigned char>* output)
{
    output->clear();
...
bool WebpCodec::Encode(const SkBitmap& src, int quality, std::vector<unsigned char>* output)
{
    SkPixmap pixmap;
...
absl::optional<std::vector<uint8_t>> WebpCodec::EncodeAnimated(const std::vector<SkEncoder::Frame>& frames, const SkWebpEncoder::Options& options)
{
...
absl::optional<std::vector<uint8_t>> WebpCodec::EncodeAnimated(const std::vector<Frame>& frames, const SkWebpEncoder::Options& options)
{
