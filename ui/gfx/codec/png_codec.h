...
public:
    ...
    static bool Encode(const unsigned char* input, ColorFormat format, const Size& size, int row_byte_width, bool discard_transparency, const std::vector<Comment>& comments,
    ...
    // information.
    static bool EncodeBGRASkBitmap(const SkBitmap& input, bool discard_transparency, std::vector<unsigned char>* output);
    ...
    static bool FastEncodeBGRASkBitmap(const SkBitmap& input, bool discard_transparency, std::vector<unsigned char>* output);
    ...
    static bool EncodeA8SkBitmap(const SkBitmap& input, std::vector<unsigned char>* output);
    ...
    // otherwise.
    static bool Decode(const unsigned char* input, size_t input_size, SkBitmap* bitmap);
};
