    ...
    if (color_space.GetMatrixID() == gfx::ColorSpace::MatrixID::RGB && !force_yuv) {
        ...
        if (color_space.GetRangeID() == gfx::ColorSpace::RangeID::LIMITED) {
            ...
            if (color_space.GetPrimaryID() == gfx::ColorSpace::PrimaryID::BT2020) {
                ...
                if (color_space.GetTransferID() == gfx::ColorSpace::TransferID::LINEAR || color_space.GetTransferID() == gfx::ColorSpace::TransferID::LINEAR_HDR
                    || color_space.GetTransferID() == gfx::ColorSpace::TransferID::SCRGB_LINEAR_80_NITS) {
        ...
        if (color_space.GetPrimaryID() == gfx::ColorSpace::PrimaryID::BT2020) {
            ...
            } else if (color_space.GetTransferID() == gfx::ColorSpace::TransferID::HLG) {
            ...
            if (color_space.GetRangeID() == gfx::ColorSpace::RangeID::FULL) {
                ...
                if (color_space.GetTransferID() == gfx::ColorSpace::TransferID::SMPTE170M) {
