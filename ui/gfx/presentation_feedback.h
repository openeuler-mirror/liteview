...
struct PresentationFeedback {
    ...
    static PresentationFeedback Failure() { return { base::TimeTicks::Now(), base::TimeDelta(), Flags::kFailure }; }
...
inline bool operator!=(const PresentationFeedback& lhs, const PresentationFeedback& rhs) { return !(lhs == rhs); }
