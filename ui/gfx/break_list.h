...
template <class T> bool BreakList<T>::SetValue(T value)
{
...
template <class T> bool BreakList<T>::EqualsValueForTesting(T value) const { return breaks_.size() == 1 && breaks_[0] == Break(0, value); }
