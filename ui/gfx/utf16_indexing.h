...
GFX_EXPORT ptrdiff_t UTF16IndexToOffset(const std::u16string& s, size_t base, size_t pos);
GFX_EXPORT size_t UTF16OffsetToIndex(const std::u16string& s, size_t base, ptrdiff_t offset);
