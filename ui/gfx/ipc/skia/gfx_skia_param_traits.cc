...
void ParamTraits<SkImageInfo>::Log(const SkImageInfo& p, std::string* l) { l->append("<SkImageInfo>"); }
...
void ParamTraits<gfx::Transform>::Log(const param_type& p, std::string* l) { l->append(p.ToString()); }
