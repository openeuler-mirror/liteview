...
void ParamTraits<gfx::ColorSpace>::Log(const gfx::ColorSpace& p, std::string* l) { l->append("<gfx::ColorSpace>"); }
...
void ParamTraits<gfx::DisplayColorSpaces>::Log(const gfx::DisplayColorSpaces& p, std::string* l) { l->append("<gfx::DisplayColorSpaces>"); }
