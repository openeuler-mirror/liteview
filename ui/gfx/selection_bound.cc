...
void SelectionBound::SetVisibleEdgeStart(const gfx::PointF& value) { visible_edge_start_ = value; }
...
void SelectionBound::SetVisibleEdgeEnd(const gfx::PointF& value) { visible_edge_end_ = value; }
...
int SelectionBound::GetHeight() const { return edge_end_rounded_.y() - edge_start_rounded_.y(); }

std::string SelectionBound::ToString() const
{
    return base::StringPrintf("SelectionBound(%s, %s, %s, %s, %d)", edge_start_.ToString().c_str(), edge_end_.ToString().c_str(), edge_start_rounded_.ToString().c_str(),
...
bool operator!=(const SelectionBound& lhs, const SelectionBound& rhs) { return !(lhs == rhs); }
