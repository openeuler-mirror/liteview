...
// invalidating |handle|.
GFX_EXPORT NativePixmapHandle CloneHandleForIPC(const NativePixmapHandle& handle);
...
//     in a size_t.
GFX_EXPORT bool CanFitImageForSizeAndFormat(const gfx::NativePixmapHandle& handle, const gfx::Size& size, gfx::BufferFormat format, bool assume_single_memory_object);
} // namespace gfx
