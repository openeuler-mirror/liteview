...
public:
    ...
    const std::vector<Range>& secondary_selections() const { return secondary_selections_; }
...
GFX_EXPORT std::ostream& operator<<(std::ostream& out, const SelectionModel& model);
