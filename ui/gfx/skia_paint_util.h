...
// is created.
//
GFX_EXPORT sk_sp<cc::PaintShader> CreateImageRepShader(const gfx::ImageSkiaRep& image_rep, SkTileMode tile_mode_x, SkTileMode tile_mode_y, const SkMatrix& local_matrix);
...
GFX_EXPORT sk_sp<cc::PaintShader> CreateGradientShader(const gfx::Point& start_point, const gfx::Point& end_point, SkColor start_color, SkColor end_color);
...
// this case.
GFX_EXPORT sk_sp<SkDrawLooper> CreateShadowDrawLooper(const std::vector<ShadowValue>& shadows);
