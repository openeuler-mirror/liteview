...
TEST(DelegatedInkTest, PointAndMetadataMatch)
{
    ...
    DelegatedInkMetadata metadata_with_frame_time(point, /*diameter=*/7.777f, SK_ColorCYAN, timestamp, gfx::RectF(6, 14, 240, 307), base::TimeTicks::Now(), /*hovering=*/true);
...
TEST(DelegatedInkTest, PointAndMetadataDoNotMatch)
{
    ...
    DelegatedInkMetadata close_metadata(metadata_location_close, /*diameter=*/5, SK_ColorWHITE, timestamp, gfx::RectF(40, 30.6f, 43, 7.2f), /*hovering=*/true);
    EXPECT_FALSE(ink_point.MatchesDelegatedInkMetadata(&close_metadata));

    const gfx::PointF metadata_location_far(23.789f, 20);
    DelegatedInkMetadata far_metadata(metadata_location_far, /*diameter=*/1, SK_ColorYELLOW, timestamp, gfx::RectF(12.44f, 3, 1000, 1000.1f), /*hovering=*/false);
    EXPECT_FALSE(ink_point.MatchesDelegatedInkMetadata(&far_metadata));

    DelegatedInkMetadata metadata_different_timestamp(point_location, /*diameter=*/10, SK_ColorGREEN, timestamp + base::Milliseconds(10), gfx::RectF(0, 0, 0, 0),
        /*hovering*/ true);
