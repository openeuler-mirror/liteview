...
TEST(SelectionBoundTest, RectBetweenSelectionBounds)
{
    ...
    expected_rect = gfx::Rect(
        b1.edge_start_rounded().x(), b1.edge_start_rounded().y(), b2.edge_end_rounded().x() - b1.edge_start_rounded().x(), b2.edge_end_rounded().y() - b1.edge_start_rounded().y());
    EXPECT_EQ(expected_rect, RectBetweenSelectionBounds(b1, b2));
    EXPECT_EQ(expected_rect, RectBetweenSelectionBounds(b2, b1));
    ...
    expected_rect = gfx::Rect(
        b1.edge_end_rounded().x(), b1.edge_start_rounded().y(), b2.edge_end_rounded().x() - b1.edge_end_rounded().x(), b2.edge_end_rounded().y() - b2.edge_start_rounded().y());
    EXPECT_EQ(expected_rect, RectBetweenSelectionBounds(b1, b2));
    EXPECT_EQ(expected_rect, RectBetweenSelectionBounds(b2, b1));
}
