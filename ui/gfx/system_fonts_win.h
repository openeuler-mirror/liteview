...
GFX_EXPORT void SetGetMinimumFontSizeCallback(GetMinimumFontSizeCallback callback);
...
GFX_EXPORT void AdjustLOGFONTForTesting(const FontAdjustment& font_adjustment, LOGFONT* logfont);
