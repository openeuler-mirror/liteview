...
public:
    ...
    ImageSkiaRep(sk_sp<cc::PaintRecord> paint_record, const gfx::Size& size, float scale);
    ...
    bool is_null() const { return type_ == ImageRepType::kImageTypeBitmap ? bitmap_.isNull() : !paint_record_; }
