...
ImageSkiaRep::ImageSkiaRep(sk_sp<cc::PaintRecord> paint_record, const gfx::Size& pixel_size, float scale)
...
int ImageSkiaRep::GetWidth() const { return static_cast<int>(pixel_width() / scale()); }

int ImageSkiaRep::GetHeight() const { return static_cast<int>(pixel_height() / scale()); }
...
sk_sp<cc::PaintRecord> ImageSkiaRep::GetPaintRecord() const
{
    ...
    cc::RecordPaintCanvas record_canvas(display_item_list.get(), SkRect::MakeIWH(pixel_width(), pixel_height()));
