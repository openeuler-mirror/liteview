...
GFX_EXPORT gfx::ImageSkiaRep ImageSkiaRepOfScaleFromUIImage(UIImage* image, float scale);
...
GFX_EXPORT UIImage* UIImageFromImageSkiaRep(const gfx::ImageSkiaRep& image_skia_rep);
