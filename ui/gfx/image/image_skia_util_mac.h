...
GFX_EXPORT gfx::ImageSkia ImageSkiaFromResizedNSImage(NSImage* image, NSSize size);
...
GFX_EXPORT NSImage* NSImageFromImageSkiaWithColorSpace(const gfx::ImageSkia& image_skia, CGColorSpaceRef color_space);
