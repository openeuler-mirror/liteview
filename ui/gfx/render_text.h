...
class StyleIterator {
public:
    StyleIterator(const BreakList<SkColor>* colors, const BreakList<BaselineStyle>* baselines, const BreakList<int>* font_size_overrides, const BreakList<Font::Weight>* weights,
...
public:
    ...
    HorizontalAlignment horizontal_alignment() const { return horizontal_alignment_; }
    ...
    SkColor selection_background_focused_color() const { return selection_background_focused_color_; }
    void set_selection_background_focused_color(SkColor color) { selection_background_focused_color_ = color; }

    bool symmetric_selection_visual_bounds() const { return symmetric_selection_visual_bounds_; }
    void set_symmetric_selection_visual_bounds(bool symmetric) { symmetric_selection_visual_bounds_ = symmetric; }
    ...
    absl::optional<bool> whitespace_elision() const { return whitespace_elision_; }

    const Rect& display_rect() const { return display_rect_; }
    void SetDisplayRect(const Rect& r);

    bool subpixel_rendering_suppressed() const { return subpixel_rendering_suppressed_; }
    void set_subpixel_rendering_suppressed(bool suppressed) { subpixel_rendering_suppressed_ = suppressed; }
    ...
    const std::vector<Range>& secondary_selections() const { return selection_model_.secondary_selections(); }
    ...
    DirectionalityMode directionality_mode() const { return directionality_mode_; }
    ...
    bool GetWordLookupDataAtPoint(const Point& point, DecoratedText* decorated_word, Point* baseline_point);
    ...
    // retrieved.
    bool GetLookupDataForRange(const Range& range, DecoratedText* decorated_text, Point* baseline_point);
    ...
    void set_glyph_height_for_test(float height) { glyph_height_for_test_ = height; }
...
protected:
    ...
    void set_shaped_text(std::unique_ptr<internal::ShapedText> shaped_text) { shaped_text_ = std::move(shaped_text); }
...
private:
    ...
    virtual bool GetDecoratedTextForRange(const Range& range, DecoratedText* decorated_text) = 0;
