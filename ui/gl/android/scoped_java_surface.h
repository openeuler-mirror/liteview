...
public:
    ...
    static ScopedJavaSurface AcquireExternalSurface(const base::android::JavaRef<jobject>& surface);
    ...
    const base::android::JavaRef<jobject>& j_surface() const { return j_surface_; }
