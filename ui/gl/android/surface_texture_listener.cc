...
void SurfaceTextureListener::Destroy(JNIEnv* env, const JavaParamRef<jobject>& obj)
{
...
void SurfaceTextureListener::FrameAvailable(JNIEnv* env, const JavaParamRef<jobject>& obj)
{
