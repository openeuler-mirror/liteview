...
TEST(EGLInitializationDisplaysTest, DisableD3D11)
{
    ...
    GetEGLInitDisplaysForTesting(true, true, true, true, true, true, true, command_line.get(), &displays);
    ...
    // not available
    displays.clear();
    GetEGLInitDisplaysForTesting(false, true, true, true, true, true, true, command_line.get(), &displays);
    EXPECT_FALSE(base::Contains(displays, gl::ANGLE_D3D11));
}
...
TEST(EGLInitializationDisplaysTest, DefaultRenderers)
{
    ...
    GetEGLInitDisplaysForTesting(true, true, true, true, true, true, true, command_line.get(), &default_no_flag_displays);
    ...
    GetEGLInitDisplaysForTesting(true, true, true, true, true, true, true, command_line.get(), &default_with_flag_displays);
...
TEST(EGLInitializationDisplaysTest, NoExtensions)
{
    ...
    std::vector<gl::DisplayType> displays;
    GetEGLInitDisplaysForTesting(false, false, false, false, false, false, false, command_line.get(), &displays);
