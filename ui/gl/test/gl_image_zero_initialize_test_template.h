...
template <typename GLImageTestDelegate> class GLImageZeroInitializeTest : public GLImageTest<GLImageTestDelegate> { };
...
TYPED_TEST_P(GLImageZeroInitializeTest, ZeroInitialize)
{
    ...
    GLTestHelper::CheckPixels(0, 0, image_size.width(), image_size.height(), zero_color);
