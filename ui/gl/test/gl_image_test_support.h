...
public:
    ...
    static GLDisplay* InitializeGL(absl::optional<GLImplementationParts> prefered_impl);
    ...
    static void SetBufferDataToColor(int width, int height, int stride, int plane, gfx::BufferFormat format, const uint8_t color[4], uint8_t* data);
};
