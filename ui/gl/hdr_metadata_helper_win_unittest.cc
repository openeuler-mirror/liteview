...
TEST_F(HDRMetadataHelperWinTest, CachesMetadataIfAvailable)
{
    ...
    EXPECT_EQ(result->RedPrimary[1], static_cast<int>(desc.RedPrimary[1] * kPrimariesFixedPoint));
    EXPECT_EQ(result->GreenPrimary[0], static_cast<int>(desc.GreenPrimary[0] * kPrimariesFixedPoint));
    EXPECT_EQ(result->GreenPrimary[1], static_cast<int>(desc.GreenPrimary[1] * kPrimariesFixedPoint));
    EXPECT_EQ(result->BluePrimary[0], static_cast<int>(desc.BluePrimary[0] * kPrimariesFixedPoint));
    EXPECT_EQ(result->BluePrimary[1], static_cast<int>(desc.BluePrimary[1] * kPrimariesFixedPoint));
    EXPECT_EQ(result->WhitePoint[0], static_cast<int>(desc.WhitePoint[0] * kPrimariesFixedPoint));
    EXPECT_EQ(result->WhitePoint[1], static_cast<int>(desc.WhitePoint[1] * kPrimariesFixedPoint));
