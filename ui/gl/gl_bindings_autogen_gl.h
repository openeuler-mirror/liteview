...
typedef void(GL_BINDING_CALL* glBindFragmentInputLocationCHROMIUMProc)(GLuint program, GLint location, const char* name);
typedef void(GL_BINDING_CALL* glBindFramebufferEXTProc)(GLenum target, GLuint framebuffer);
typedef void(GL_BINDING_CALL* glBindImageTextureEXTProc)(GLuint index, GLuint texture, GLint level, GLboolean layered, GLint layer, GLenum access, GLint format);
...
typedef void(GL_BINDING_CALL* glClearTexSubImageProc)(
...
typedef GLenum(GL_BINDING_CALL* glClientWaitSyncAPPLEProc)(GLsync sync, GLbitfield flags, GLuint64 timeout);
...
typedef void(GL_BINDING_CALL* glCompressedTexSubImage3DProc)(
...
typedef void(GL_BINDING_CALL* glCompressedTexSubImage3DRobustANGLEProc)(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height,
...
typedef void(GL_BINDING_CALL* glCopySubTextureCHROMIUMProc)(GLuint sourceId, GLint sourceLevel, GLenum destTarget, GLuint destId, GLint destLevel, GLint xoffset, GLint yoffset,
...
typedef void(GL_BINDING_CALL* glCopyTexSubImage3DProc)(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLint x, GLint y, GLsizei width, GLsizei height);
typedef void(GL_BINDING_CALL* glCopyTextureCHROMIUMProc)(GLuint sourceId, GLint sourceLevel, GLenum destTarget, GLuint destId, GLint destLevel, GLint internalFormat,
...
typedef void(GL_BINDING_CALL* glCoverFillPathNVProc)(GLuint path, GLenum coverMode);
typedef void(GL_BINDING_CALL* glCoverStrokePathInstancedNVProc)(
    GLsizei numPaths, GLenum pathNameType, const void* paths, GLuint pathBase, GLenum coverMode, GLenum transformType, const GLfloat* transformValues);
typedef void(GL_BINDING_CALL* glCoverStrokePathNVProc)(GLuint name, GLenum coverMode);
...
typedef void(GL_BINDING_CALL* glDeleteFencesAPPLEProc)(GLsizei n, const GLuint* fences);
...
typedef GLsync(GL_BINDING_CALL* glFenceSyncAPPLEProc)(GLenum condition, GLbitfield flags);
...
typedef void(GL_BINDING_CALL* glFramebufferTextureMultiviewOVRProc)(GLenum target, GLenum attachment, GLuint texture, GLint level, GLint baseViewIndex, GLsizei numViews);
...
typedef void(GL_BINDING_CALL* glGetActiveUniformBlockivRobustANGLEProc)(GLuint program, GLuint uniformBlockIndex, GLenum pname, GLsizei bufSize, GLsizei* length, GLint* params);
typedef void(GL_BINDING_CALL* glGetActiveUniformBlockNameProc)(GLuint program, GLuint uniformBlockIndex, GLsizei bufSize, GLsizei* length, char* uniformBlockName);
...
typedef void(GL_BINDING_CALL* glGetInternalformativRobustANGLEProc)(GLenum target, GLenum internalformat, GLenum pname, GLsizei bufSize, GLsizei* length, GLint* params);
typedef void(GL_BINDING_CALL* glGetInternalformatSampleivNVProc)(GLenum target, GLenum internalformat, GLsizei samples, GLenum pname, GLsizei bufSize, GLint* params);
...
typedef void(GL_BINDING_CALL* glGetProgramInterfaceivRobustANGLEProc)(GLuint program, GLenum programInterface, GLenum pname, GLsizei bufSize, GLsizei* length, GLint* params);
...
typedef void(GL_BINDING_CALL* glGetProgramResourceNameProc)(GLuint program, GLenum programInterface, GLuint index, GLsizei bufSize, GLsizei* length, GLchar* name);
...
typedef void(GL_BINDING_CALL* glGetTexLevelParameterfvRobustANGLEProc)(GLenum target, GLint level, GLenum pname, GLsizei bufSize, GLsizei* length, GLfloat* params);
typedef void(GL_BINDING_CALL* glGetTexLevelParameterivProc)(GLenum target, GLint level, GLenum pname, GLint* params);
typedef void(GL_BINDING_CALL* glGetTexLevelParameterivRobustANGLEProc)(GLenum target, GLint level, GLenum pname, GLsizei bufSize, GLsizei* length, GLint* params);
...
typedef void(GL_BINDING_CALL* glGetTransformFeedbackVaryingProc)(GLuint program, GLuint index, GLsizei bufSize, GLsizei* length, GLsizei* size, GLenum* type, char* name);
...
typedef void(GL_BINDING_CALL* glInvalidateSubFramebufferProc)(GLenum target, GLsizei numAttachments, const GLenum* attachments, GLint x, GLint y, GLint width, GLint height);
...
typedef void(GL_BINDING_CALL* glMatrixLoadfEXTProc)(GLenum matrixMode, const GLfloat* m);
...
typedef void(GL_BINDING_CALL* glMultiDrawArraysInstancedANGLEProc)(GLenum mode, const GLint* firsts, const GLsizei* counts, const GLsizei* instanceCounts, GLsizei drawcount);
...
typedef void(GL_BINDING_CALL* glMultiDrawElementsInstancedBaseVertexBaseInstanceANGLEProc)(GLenum mode, const GLsizei* counts, GLenum type, const GLvoid* const* indices,
...
typedef void(GL_BINDING_CALL* glPathCommandsNVProc)(GLuint path, GLsizei numCommands, const GLubyte* commands, GLsizei numCoords, GLenum coordType, const GLvoid* coords);
typedef void(GL_BINDING_CALL* glPathParameterfNVProc)(GLuint path, GLenum pname, GLfloat value);
typedef void(GL_BINDING_CALL* glPathParameteriNVProc)(GLuint path, GLenum pname, GLint value);
typedef void(GL_BINDING_CALL* glPathStencilFuncNVProc)(GLenum func, GLint ref, GLuint mask);
...
typedef void(GL_BINDING_CALL* glProgramPathFragmentInputGenNVProc)(GLuint program, GLint location, GLenum genMode, GLint components, const GLfloat* coeffs);
...
typedef void(GL_BINDING_CALL* glReadPixelsRobustANGLEProc)(
...
typedef void(GL_BINDING_CALL* glStencilFillPathNVProc)(GLuint path, GLenum fillMode, GLuint mask);
...
typedef void(GL_BINDING_CALL* glStencilStrokePathNVProc)(GLuint path, GLint reference, GLuint mask);
typedef void(GL_BINDING_CALL* glStencilThenCoverFillPathInstancedNVProc)(GLsizei numPaths, GLenum pathNameType, const void* paths, GLuint pathBase, GLenum fillMode, GLuint mask,
    GLenum coverMode, GLenum transformType, const GLfloat* transformValues);
typedef void(GL_BINDING_CALL* glStencilThenCoverFillPathNVProc)(GLuint path, GLenum fillMode, GLuint mask, GLenum coverMode);
...
typedef void(GL_BINDING_CALL* glStencilThenCoverStrokePathNVProc)(GLuint path, GLint reference, GLuint mask, GLenum coverMode);
...
typedef void(GL_BINDING_CALL* glTexImage2DRobustANGLEProc)(
...
typedef void(GL_BINDING_CALL* glTexImage3DProc)(
...
typedef void(GL_BINDING_CALL* glTexImage3DRobustANGLEProc)(
...
typedef void(GL_BINDING_CALL* glTexStorage2DMultisampleProc)(GLenum target, GLsizei samples, GLenum internalformat, GLsizei width, GLsizei height, GLboolean fixedsamplelocations);
...
typedef void(GL_BINDING_CALL* glTexStorageMem2DEXTProc)(GLenum target, GLsizei levels, GLenum internalFormat, GLsizei width, GLsizei height, GLuint memory, GLuint64 offset);
typedef void(GL_BINDING_CALL* glTexStorageMemFlags2DANGLEProc)(GLenum target, GLsizei levels, GLenum internalFormat, GLsizei width, GLsizei height, GLuint memory, GLuint64 offset,
...
typedef void(GL_BINDING_CALL* glTexSubImage3DProc)(
...
typedef void(GL_BINDING_CALL* glTexSubImage3DRobustANGLEProc)(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth,
...
typedef void(GL_BINDING_CALL* glWaitSyncAPPLEProc)(GLsync sync, GLbitfield flags, GLuint64 timeout);
...
struct ProcsGL {
    ...
    glStencilThenCoverFillPathInstancedNVProc glStencilThenCoverFillPathInstancedNVFn;
    glStencilThenCoverFillPathNVProc glStencilThenCoverFillPathNVFn;
    glStencilThenCoverStrokePathInstancedNVProc glStencilThenCoverStrokePathInstancedNVFn;
...
public:
    ...
    virtual void glBindFragmentInputLocationCHROMIUMFn(GLuint program, GLint location, const char* name) = 0;
    ...
    virtual void glClearTexSubImageFn(
        GLuint texture, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLint width, GLint height, GLint depth, GLenum format, GLenum type, const GLvoid* data)
        = 0;
    virtual GLenum glClientWaitSyncFn(GLsync sync, GLbitfield flags, GLuint64 timeout) = 0;
    virtual GLenum glClientWaitSyncAPPLEFn(GLsync sync, GLbitfield flags, GLuint64 timeout) = 0;
    ...
    virtual void glCompressedTexImage3DFn(
        GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLsizei depth, GLint border, GLsizei imageSize, const void* data)
        = 0;
    virtual void glCompressedTexImage3DRobustANGLEFn(
        GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLsizei depth, GLint border, GLsizei imageSize, GLsizei dataSize, const void* data)
        = 0;
    virtual void glCompressedTexSubImage2DFn(
        GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLsizei imageSize, const void* data)
        = 0;
    virtual void glCompressedTexSubImage2DRobustANGLEFn(
        GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLsizei imageSize, GLsizei dataSize, const void* data)
        = 0;
    virtual void glCompressedTexSubImage3DFn(
        GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLsizei imageSize, const void* data)
        = 0;
    virtual void glCompressedTexSubImage3DRobustANGLEFn(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth,
    ...
    virtual void glCopySubTextureCHROMIUMFn(GLuint sourceId, GLint sourceLevel, GLenum destTarget, GLuint destId, GLint destLevel, GLint xoffset, GLint yoffset, GLint x, GLint y,
    ...
    virtual void glCopyTexSubImage3DFn(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLint x, GLint y, GLsizei width, GLsizei height) = 0;
    virtual void glCopyTextureCHROMIUMFn(GLuint sourceId, GLint sourceLevel, GLenum destTarget, GLuint destId, GLint destLevel, GLint internalFormat, GLenum destType,
    ...
    virtual void glCoverFillPathInstancedNVFn(
        GLsizei numPaths, GLenum pathNameType, const void* paths, GLuint pathBase, GLenum coverMode, GLenum transformType, const GLfloat* transformValues)
        = 0;
    ...
    virtual void glGetActiveUniformBlockivRobustANGLEFn(GLuint program, GLuint uniformBlockIndex, GLenum pname, GLsizei bufSize, GLsizei* length, GLint* params) = 0;
    ...
    virtual GLuint glGetDebugMessageLogFn(GLuint count, GLsizei bufSize, GLenum* sources, GLenum* types, GLuint* ids, GLenum* severities, GLsizei* lengths, char* messageLog) = 0;
    ...
    virtual void glGetFramebufferAttachmentParameterivRobustANGLEFn(GLenum target, GLenum attachment, GLenum pname, GLsizei bufSize, GLsizei* length, GLint* params) = 0;
    ...
    virtual void glGetProgramInterfaceivRobustANGLEFn(GLuint program, GLenum programInterface, GLenum pname, GLsizei bufSize, GLsizei* length, GLint* params) = 0;
    ...
    virtual void glInvalidateSubFramebufferFn(GLenum target, GLsizei numAttachments, const GLenum* attachments, GLint x, GLint y, GLint width, GLint height) = 0;
    ...
    virtual void glMultiDrawArraysInstancedANGLEFn(GLenum mode, const GLint* firsts, const GLsizei* counts, const GLsizei* instanceCounts, GLsizei drawcount) = 0;
    ...
    virtual void glPathCommandsNVFn(GLuint path, GLsizei numCommands, const GLubyte* commands, GLsizei numCoords, GLenum coordType, const GLvoid* coords) = 0;
    virtual void glPathParameterfNVFn(GLuint path, GLenum pname, GLfloat value) = 0;
    ...
    virtual void glProgramPathFragmentInputGenNVFn(GLuint program, GLint location, GLenum genMode, GLint components, const GLfloat* coeffs) = 0;
    ...
    virtual void glRenderbufferStorageMultisampleAdvancedAMDFn(GLenum target, GLsizei samples, GLsizei storageSamples, GLenum internalformat, GLsizei width, GLsizei height) = 0;
    ...
    virtual void glStencilFillPathInstancedNVFn(
        GLsizei numPaths, GLenum pathNameType, const void* paths, GLuint pathBase, GLenum fillMode, GLuint mask, GLenum transformType, const GLfloat* transformValues)
        = 0;
    virtual void glStencilFillPathNVFn(GLuint path, GLenum fillMode, GLuint mask) = 0;
    ...
    virtual void glStencilStrokePathInstancedNVFn(
        GLsizei numPaths, GLenum pathNameType, const void* paths, GLuint pathBase, GLint ref, GLuint mask, GLenum transformType, const GLfloat* transformValues)
        = 0;
    virtual void glStencilStrokePathNVFn(GLuint path, GLint reference, GLuint mask) = 0;
    virtual void glStencilThenCoverFillPathInstancedNVFn(GLsizei numPaths, GLenum pathNameType, const void* paths, GLuint pathBase, GLenum fillMode, GLuint mask, GLenum coverMode,
        GLenum transformType, const GLfloat* transformValues)
        = 0;
    virtual void glStencilThenCoverFillPathNVFn(GLuint path, GLenum fillMode, GLuint mask, GLenum coverMode) = 0;
    virtual void glStencilThenCoverStrokePathInstancedNVFn(
        GLsizei numPaths, GLenum pathNameType, const void* paths, GLuint pathBase, GLint ref, GLuint mask, GLenum coverMode, GLenum transformType, const GLfloat* transformValues)
        = 0;
    virtual void glStencilThenCoverStrokePathNVFn(GLuint path, GLint reference, GLuint mask, GLenum coverMode) = 0;
    ...
    virtual void glTexImage2DExternalANGLEFn(GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height, GLint border, GLenum format, GLenum type) = 0;
    virtual void glTexImage2DRobustANGLEFn(
        GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height, GLint border, GLenum format, GLenum type, GLsizei bufSize, const void* pixels)
        = 0;
    virtual void glTexImage3DFn(
        GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height, GLsizei depth, GLint border, GLenum format, GLenum type, const void* pixels)
        = 0;
    virtual void glTexImage3DRobustANGLEFn(GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height, GLsizei depth, GLint border, GLenum format, GLenum type,
    ...
    virtual void glTexStorage2DMultisampleFn(GLenum target, GLsizei samples, GLenum internalformat, GLsizei width, GLsizei height, GLboolean fixedsamplelocations) = 0;
    ...
    virtual void glTexStorageMem2DEXTFn(GLenum target, GLsizei levels, GLenum internalFormat, GLsizei width, GLsizei height, GLuint memory, GLuint64 offset) = 0;
    virtual void glTexStorageMemFlags2DANGLEFn(GLenum target, GLsizei levels, GLenum internalFormat, GLsizei width, GLsizei height, GLuint memory, GLuint64 offset,
        GLbitfield createFlags, GLbitfield usageFlags, const void* imageCreateInfoPNext)
        = 0;
    ...
    virtual void glTexSubImage2DRobustANGLEFn(
        GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLenum type, GLsizei bufSize, const void* pixels)
        = 0;
    virtual void glTexSubImage3DFn(
        GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLenum type, const void* pixels)
        = 0;
    virtual void glTexSubImage3DRobustANGLEFn(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format,
    ...
    virtual void glWaitSyncAPPLEFn(GLsync sync, GLbitfield flags, GLuint64 timeout) = 0;
...
#define glBindFragmentInputLocationCHROMIUM ::gl::g_current_gl_context->glBindFragmentInputLocationCHROMIUMFn
...
#define glClientWaitSyncAPPLE ::gl::g_current_gl_context->glClientWaitSyncAPPLEFn
...
#define glCoverageModulationNV ::gl::g_current_gl_context->glCoverageModulationNVFn
#define glCoverFillPathInstancedNV ::gl::g_current_gl_context->glCoverFillPathInstancedNVFn
#define glCoverFillPathNV ::gl::g_current_gl_context->glCoverFillPathNVFn
#define glCoverStrokePathInstancedNV ::gl::g_current_gl_context->glCoverStrokePathInstancedNVFn
...
#define glMatrixLoadIdentityEXT ::gl::g_current_gl_context->glMatrixLoadIdentityEXTFn
...
#define glProgramPathFragmentInputGenNV ::gl::g_current_gl_context->glProgramPathFragmentInputGenNVFn
...
#define glStencilFillPathInstancedNV ::gl::g_current_gl_context->glStencilFillPathInstancedNVFn
...
#define glStencilStrokePathInstancedNV ::gl::g_current_gl_context->glStencilStrokePathInstancedNVFn
#define glStencilStrokePathNV ::gl::g_current_gl_context->glStencilStrokePathNVFn
#define glStencilThenCoverFillPathInstancedNV ::gl::g_current_gl_context->glStencilThenCoverFillPathInstancedNVFn
#define glStencilThenCoverFillPathNV ::gl::g_current_gl_context->glStencilThenCoverFillPathNVFn
#define glStencilThenCoverStrokePathInstancedNV ::gl::g_current_gl_context->glStencilThenCoverStrokePathInstancedNVFn
#define glStencilThenCoverStrokePathNV ::gl::g_current_gl_context->glStencilThenCoverStrokePathNVFn
