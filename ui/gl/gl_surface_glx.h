...
protected:
    ...
    gfx::AcceleratedWidget window() const { return static_cast<gfx::AcceleratedWidget>(window_); }
...
public:
    ...
    UnmappedNativeViewGLSurfaceGLX(const UnmappedNativeViewGLSurfaceGLX&) = delete;
    UnmappedNativeViewGLSurfaceGLX& operator=(const UnmappedNativeViewGLSurfaceGLX&) = delete;
