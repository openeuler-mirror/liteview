...
public:
    ...
    bool Initialize(
        const base::UnsafeSharedMemoryRegion& shared_memory_region, gfx::GenericSharedMemoryId shared_memory_id, gfx::BufferFormat format, size_t offset, size_t stride);
