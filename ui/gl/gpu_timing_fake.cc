...
GPUTimingFake::GPUTimingFake() { Reset(); }
...
int64_t GPUTimingFake::GetFakeCPUTime() { return fake_cpu_time_; }

void GPUTimingFake::SetCPUGLOffset(int64_t offset) { gl_cpu_time_offset_ = offset; }
...
void GPUTimingFake::SetDisjoint() { disjointed_ = true; }

void GPUTimingFake::ExpectGetErrorCalls(MockGLInterface& gl) { EXPECT_CALL(gl, GetError()).Times(AtLeast(0)).WillRepeatedly(Invoke(this, &GPUTimingFake::FakeGLGetError)); }
...
void GPUTimingFake::ExpectNoDisjointCalls(MockGLInterface& gl) { EXPECT_CALL(gl, GetIntegerv(GL_GPU_DISJOINT_EXT, _)).Times(Exactly(0)); }
...
void GPUTimingFake::ExpectNoOffsetCalculationQuery(MockGLInterface& gl) { EXPECT_CALL(gl, GetInteger64v(GL_TIMESTAMP, NotNull())).Times(Exactly(0)); }
...
GLenum GPUTimingFake::FakeGLGetError() { return GL_NO_ERROR; }
