...
template <> struct ScopedTypeRefTraits<CGLPixelFormatObj> {
    ...
    static CGLPixelFormatObj Retain(CGLPixelFormatObj object) { return CGLRetainPixelFormat(object); }
...
public:
    ...
    ScopedCGLSetCurrentContext& operator=(const ScopedCGLSetCurrentContext&) = delete;
