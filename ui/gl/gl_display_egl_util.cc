...
public:
    ...
    absl::optional<base::ScopedEnvironmentVariableOverride> MaybeGetScopedDisplayUnsetForVulkan() override { return absl::nullopt; }
...
// static
void GLDisplayEglUtil::SetInstance(GLDisplayEglUtil* gl_display_util) { g_instance = gl_display_util; }
