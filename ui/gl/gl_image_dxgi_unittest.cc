...
template <gfx::BufferFormat format> class GLImageDXGITestDelegate : public GLImageTestDelegateBase {
public:
    scoped_refptr<GLImage> CreateSolidColorImage(const gfx::Size& size, const uint8_t color[4]) const
    {
        ...
        bool rv = image->InitializeHandle(base::win::ScopedHandle(handle), 0, format);
...
using GLImageTestTypes = testing::Types<GLImageDXGITestDelegate<gfx::BufferFormat::RGBA_8888>, GLImageDXGITestDelegate<gfx::BufferFormat::RGBX_8888>>;

// Disabled by default as it requires DX11.
INSTANTIATE_TYPED_TEST_SUITE_P(DISABLED_GLImageDXGIHandle, GLImageTest, GLImageTestTypes);

using GLImageRGBTestTypes = testing::Types<GLImageDXGITestDelegate<gfx::BufferFormat::RGBA_8888>, GLImageDXGITestDelegate<gfx::BufferFormat::RGBX_8888>>;

// Disabled by default as it requires DX11.
INSTANTIATE_TYPED_TEST_SUITE_P(DISABLED_GLImageDXGIHandle, GLImageZeroInitializeTest, GLImageRGBTestTypes);
