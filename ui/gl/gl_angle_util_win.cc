...
Microsoft::WRL::ComPtr<ID3D11Device> QueryD3D11DeviceObjectFromANGLE()
{
    ...
    d3d11_device = reinterpret_cast<ID3D11Device*>(QueryDeviceObjectFromANGLE(EGL_D3D11_DEVICE_ANGLE));
    return d3d11_device;
}
...
Microsoft::WRL::ComPtr<IDirect3DDevice9> QueryD3D9DeviceObjectFromANGLE()
{
    ...
    d3d9_device = reinterpret_cast<IDirect3DDevice9*>(QueryDeviceObjectFromANGLE(EGL_D3D9_DEVICE_ANGLE));
    return d3d9_device;
}
