...
typedef EGLBoolean(GL_BINDING_CALL* eglExportDMABUFImageQueryMESAProc)(EGLDisplay dpy, EGLImageKHR image, int* fourcc, int* num_planes, EGLuint64KHR* modifiers);
...
typedef EGLBoolean(GL_BINDING_CALL* eglGetCompositorTimingANDROIDProc)(EGLDisplay dpy, EGLSurface surface, EGLint numTimestamps, EGLint* names, EGLnsecsANDROID* values);
...
typedef EGLBoolean(GL_BINDING_CALL* eglGetSyncValuesCHROMIUMProc)(EGLDisplay dpy, EGLSurface surface, EGLuint64CHROMIUM* ust, EGLuint64CHROMIUM* msc, EGLuint64CHROMIUM* sbc);
...
public:
    ...
    virtual EGLBoolean eglGetFrameTimestampsANDROIDFn(EGLDisplay dpy, EGLSurface surface, EGLuint64KHR frameId, EGLint numTimestamps, EGLint* timestamps, EGLnsecsANDROID* values)
        = 0;
    ...
    virtual EGLBoolean eglGetSyncValuesCHROMIUMFn(EGLDisplay dpy, EGLSurface surface, EGLuint64CHROMIUM* ust, EGLuint64CHROMIUM* msc, EGLuint64CHROMIUM* sbc) = 0;
    ...
    virtual EGLBoolean eglQueryDmaBufModifiersEXTFn(EGLDisplay dpy, EGLint format, EGLint max_modifiers, EGLuint64KHR* modifiers, EGLBoolean* external_only, EGLint* num_modifiers)
        = 0;
