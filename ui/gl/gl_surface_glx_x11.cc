...
GLSurfaceGLXX11::~GLSurfaceGLXX11() { Destroy(); }
...
void GLSurfaceGLXX11::RegisterEvents()
{
    ...
    connection->ChangeWindowAttributes(x11::ChangeWindowAttributesRequest { .window = static_cast<x11::Window>(window()), .event_mask = x11::EventMask::Exposure });

    connection->AddEventObserver(this);
}

void GLSurfaceGLXX11::UnregisterEvents() { x11::Connection::Get()->RemoveEventObserver(this); }
