...
// different.
void MakeGlMockFunctionUnique(const char* func_name) { VLOG(2) << "Calling mock " << func_name; }
} // namespace
...
void GL_BINDING_CALL MockGLInterface::Mock_glBeginQueryARB(GLenum target, GLuint id)
{
...
void GL_BINDING_CALL MockGLInterface::Mock_glBeginTransformFeedbackEXT(GLenum primitiveMode)
{
...
void GL_BINDING_CALL MockGLInterface::Mock_glBindBufferBaseEXT(GLenum target, GLuint index, GLuint buffer)
{
...
void GL_BINDING_CALL MockGLInterface::Mock_glBindBufferRangeEXT(GLenum target, GLuint index, GLuint buffer, GLintptr offset, GLsizeiptr size)
{
    MakeGlMockFunctionUnique("glBindBufferRangeEXT");
    interface_->BindBufferRange(target, index, buffer, offset, size);
}

void GL_BINDING_CALL MockGLInterface::Mock_glBindFragDataLocation(GLuint program, GLuint colorNumber, const char* name)
{
...
void GL_BINDING_CALL MockGLInterface::Mock_glBindFragDataLocationIndexed(GLuint program, GLuint colorNumber, GLuint index, const char* name)
{
...
void GL_BINDING_CALL MockGLInterface::Mock_glBindFragmentInputLocationCHROMIUM(GLuint program, GLint location, const char* name)
{
...
void GL_BINDING_CALL MockGLInterface::Mock_glBindFramebufferEXT(GLenum target, GLuint framebuffer)
{
    MakeGlMockFunctionUnique("glBindFramebufferEXT");
    interface_->BindFramebufferEXT(target, framebuffer);
}

void GL_BINDING_CALL MockGLInterface::Mock_glBindImageTexture(GLuint index, GLuint texture, GLint level, GLboolean layered, GLint layer, GLenum access, GLint format)
{
...
void GL_BINDING_CALL MockGLInterface::Mock_glBindImageTextureEXT(GLuint index, GLuint texture, GLint level, GLboolean layered, GLint layer, GLenum access, GLint format)
{
...
void GL_BINDING_CALL MockGLInterface::Mock_glBindRenderbufferEXT(GLenum target, GLuint renderbuffer)
{
...
void GL_BINDING_CALL MockGLInterface::Mock_glBindVertexArrayAPPLE(GLuint array)
{
...
void GL_BINDING_CALL MockGLInterface::Mock_glBlitFramebufferEXT(
    GLint srcX0, GLint srcY0, GLint srcX1, GLint srcY1, GLint dstX0, GLint dstY0, GLint dstX1, GLint dstY1, GLbitfield mask, GLenum filter)
{
...
GLenum GL_BINDING_CALL MockGLInterface::Mock_glCheckFramebufferStatusEXT(GLenum target)
{
...
void GL_BINDING_CALL MockGLInterface::Mock_glClearTexImage(GLuint texture, GLint level, GLenum format, GLenum type, const GLvoid* data)
{
...
void GL_BINDING_CALL MockGLInterface::Mock_glClearTexSubImage(
...
void GL_BINDING_CALL MockGLInterface::Mock_glClearTexSubImageEXT(
    GLuint texture, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLint width, GLint height, GLint depth, GLenum format, GLenum type, const GLvoid* data)
{
...
GLenum GL_BINDING_CALL MockGLInterface::Mock_glClientWaitSyncAPPLE(GLsync sync, GLbitfield flags, GLuint64 timeout)
{
...
void GL_BINDING_CALL MockGLInterface::Mock_glCompressedTexImage3DRobustANGLE(
...
void GL_BINDING_CALL MockGLInterface::Mock_glCompressedTexSubImage2DRobustANGLE(
...
void GL_BINDING_CALL MockGLInterface::Mock_glCompressedTexSubImage3D(
...
void GL_BINDING_CALL MockGLInterface::Mock_glCompressedTexSubImage3DRobustANGLE(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width,
...
void GL_BINDING_CALL MockGLInterface::Mock_glCopyBufferSubData(GLenum readTarget, GLenum writeTarget, GLintptr readOffset, GLintptr writeOffset, GLsizeiptr size)
{
...
void GL_BINDING_CALL MockGLInterface::Mock_glCopySubTextureCHROMIUM(GLuint sourceId, GLint sourceLevel, GLenum destTarget, GLuint destId, GLint destLevel, GLint xoffset,
...
void GL_BINDING_CALL MockGLInterface::Mock_glCopyTexImage2D(GLenum target, GLint level, GLenum internalformat, GLint x, GLint y, GLsizei width, GLsizei height, GLint border)
{
    MakeGlMockFunctionUnique("glCopyTexImage2D");
    interface_->CopyTexImage2D(target, level, internalformat, x, y, width, height, border);
}

void GL_BINDING_CALL MockGLInterface::Mock_glCopyTexSubImage2D(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint x, GLint y, GLsizei width, GLsizei height)
{
...
void GL_BINDING_CALL MockGLInterface::Mock_glCopyTextureCHROMIUM(GLuint sourceId, GLint sourceLevel, GLenum destTarget, GLuint destId, GLint destLevel, GLint internalFormat,
    GLenum destType, GLboolean unpackFlipY, GLboolean unpackPremultiplyAlpha, GLboolean unpackUnmultiplyAlpha)
{
    ...
    interface_->CopyTextureCHROMIUM(sourceId, sourceLevel, destTarget, destId, destLevel, internalFormat, destType, unpackFlipY, unpackPremultiplyAlpha, unpackUnmultiplyAlpha);
}

void GL_BINDING_CALL MockGLInterface::Mock_glCoverFillPathCHROMIUM(GLuint path, GLenum coverMode)
{
    ...
    GLsizei numPaths, GLenum pathNameType, const void* paths, GLuint pathBase, GLenum coverMode, GLenum transformType, const GLfloat* transformValues)
{
    ...
    interface_->CoverFillPathInstancedNV(numPaths, pathNameType, paths, pathBase, coverMode, transformType, transformValues);
}
...
void GL_BINDING_CALL MockGLInterface::Mock_glCoverFillPathNV(GLuint path, GLenum coverMode)
{
    MakeGlMockFunctionUnique("glCoverFillPathNV");
    interface_->CoverFillPathNV(path, coverMode);
}

void GL_BINDING_CALL MockGLInterface::Mock_glCoverStrokePathCHROMIUM(GLuint name, GLenum coverMode)
{
    ...
    GLsizei numPaths, GLenum pathNameType, const void* paths, GLuint pathBase, GLenum coverMode, GLenum transformType, const GLfloat* transformValues)
{
    ...
    interface_->CoverStrokePathInstancedNV(numPaths, pathNameType, paths, pathBase, coverMode, transformType, transformValues);
}
...
void GL_BINDING_CALL MockGLInterface::Mock_glCoverStrokePathNV(GLuint name, GLenum coverMode)
{
    MakeGlMockFunctionUnique("glCoverStrokePathNV");
    interface_->CoverStrokePathNV(name, coverMode);
}

void GL_BINDING_CALL MockGLInterface::Mock_glCoverageModulationCHROMIUM(GLenum components)
{
    MakeGlMockFunctionUnique("glCoverageModulationCHROMIUM");
    interface_->CoverageModulationNV(components);
}

void GL_BINDING_CALL MockGLInterface::Mock_glCoverageModulationNV(GLenum components)
{
...
void GL_BINDING_CALL MockGLInterface::Mock_glDebugMessageControl(GLenum source, GLenum type, GLenum severity, GLsizei count, const GLuint* ids, GLboolean enabled)
{
    MakeGlMockFunctionUnique("glDebugMessageControl");
    interface_->DebugMessageControl(source, type, severity, count, ids, enabled);
}

void GL_BINDING_CALL MockGLInterface::Mock_glDebugMessageControlKHR(GLenum source, GLenum type, GLenum severity, GLsizei count, const GLuint* ids, GLboolean enabled)
{
...
void GL_BINDING_CALL MockGLInterface::Mock_glDeleteFencesAPPLE(GLsizei n, const GLuint* fences)
{
...
void GL_BINDING_CALL MockGLInterface::Mock_glDeleteFramebuffersEXT(GLsizei n, const GLuint* framebuffers)
{
...
void GL_BINDING_CALL MockGLInterface::Mock_glDeletePathsCHROMIUM(GLuint path, GLsizei range)
{
    MakeGlMockFunctionUnique("glDeletePathsCHROMIUM");
    interface_->DeletePathsNV(path, range);
}

void GL_BINDING_CALL MockGLInterface::Mock_glDeletePathsNV(GLuint path, GLsizei range)
{
...
void GL_BINDING_CALL MockGLInterface::Mock_glDeleteQueriesARB(GLsizei n, const GLuint* ids)
{
...
void GL_BINDING_CALL MockGLInterface::Mock_glDeleteRenderbuffersEXT(GLsizei n, const GLuint* renderbuffers)
{
...
void GL_BINDING_CALL MockGLInterface::Mock_glDeleteVertexArraysAPPLE(GLsizei n, const GLuint* arrays)
{
...
void GL_BINDING_CALL MockGLInterface::Mock_glDrawArraysInstancedARB(GLenum mode, GLint first, GLsizei count, GLsizei primcount)
{
    MakeGlMockFunctionUnique("glDrawArraysInstancedARB");
    interface_->DrawArraysInstancedANGLE(mode, first, count, primcount);
}

void GL_BINDING_CALL MockGLInterface::Mock_glDrawArraysInstancedBaseInstance(GLenum mode, GLint first, GLsizei count, GLsizei primcount, GLuint baseinstance)
{
...
void GL_BINDING_CALL MockGLInterface::Mock_glDrawArraysInstancedBaseInstanceANGLE(GLenum mode, GLint first, GLsizei count, GLsizei primcount, GLuint baseinstance)
{
...
void GL_BINDING_CALL MockGLInterface::Mock_glDrawBuffersARB(GLsizei n, const GLenum* bufs)
{
...
void GL_BINDING_CALL MockGLInterface::Mock_glDrawElementsInstancedARB(GLenum mode, GLsizei count, GLenum type, const void* indices, GLsizei primcount)
{
    MakeGlMockFunctionUnique("glDrawElementsInstancedARB");
    interface_->DrawElementsInstancedANGLE(mode, count, type, indices, primcount);
}

void GL_BINDING_CALL MockGLInterface::Mock_glDrawElementsInstancedBaseVertexBaseInstance(
...
GLsync GL_BINDING_CALL MockGLInterface::Mock_glFenceSyncAPPLE(GLenum condition, GLbitfield flags)
{
...
void GL_BINDING_CALL MockGLInterface::Mock_glFramebufferRenderbufferEXT(GLenum target, GLenum attachment, GLenum renderbuffertarget, GLuint renderbuffer)
{
...
void GL_BINDING_CALL MockGLInterface::Mock_glFramebufferTexture2DEXT(GLenum target, GLenum attachment, GLenum textarget, GLuint texture, GLint level)
{
    MakeGlMockFunctionUnique("glFramebufferTexture2DEXT");
    interface_->FramebufferTexture2DEXT(target, attachment, textarget, texture, level);
}

void GL_BINDING_CALL MockGLInterface::Mock_glFramebufferTexture2DMultisampleEXT(GLenum target, GLenum attachment, GLenum textarget, GLuint texture, GLint level, GLsizei samples)
{
...
void GL_BINDING_CALL MockGLInterface::Mock_glFramebufferTexture2DMultisampleIMG(GLenum target, GLenum attachment, GLenum textarget, GLuint texture, GLint level, GLsizei samples)
{
...
void GL_BINDING_CALL MockGLInterface::Mock_glFramebufferTextureMultiviewOVR(GLenum target, GLenum attachment, GLuint texture, GLint level, GLint baseViewIndex, GLsizei numViews)
{
...
void GL_BINDING_CALL MockGLInterface::Mock_glGenFencesAPPLE(GLsizei n, GLuint* fences)
{
...
void GL_BINDING_CALL MockGLInterface::Mock_glGenFramebuffersEXT(GLsizei n, GLuint* framebuffers)
{
...
void GL_BINDING_CALL MockGLInterface::Mock_glGenQueriesARB(GLsizei n, GLuint* ids)
{
...
void GL_BINDING_CALL MockGLInterface::Mock_glGenRenderbuffersEXT(GLsizei n, GLuint* renderbuffers)
{
...
void GL_BINDING_CALL MockGLInterface::Mock_glGenVertexArraysAPPLE(GLsizei n, GLuint* arrays)
{
...
void GL_BINDING_CALL MockGLInterface::Mock_glGetActiveAttrib(GLuint program, GLuint index, GLsizei bufsize, GLsizei* length, GLint* size, GLenum* type, char* name)
{
    MakeGlMockFunctionUnique("glGetActiveAttrib");
    interface_->GetActiveAttrib(program, index, bufsize, length, size, type, name);
}

void GL_BINDING_CALL MockGLInterface::Mock_glGetActiveUniform(GLuint program, GLuint index, GLsizei bufsize, GLsizei* length, GLint* size, GLenum* type, char* name)
{
    MakeGlMockFunctionUnique("glGetActiveUniform");
    interface_->GetActiveUniform(program, index, bufsize, length, size, type, name);
}

void GL_BINDING_CALL MockGLInterface::Mock_glGetActiveUniformBlockName(GLuint program, GLuint uniformBlockIndex, GLsizei bufSize, GLsizei* length, char* uniformBlockName)
{
...
void GL_BINDING_CALL MockGLInterface::Mock_glGetActiveUniformsiv(GLuint program, GLsizei uniformCount, const GLuint* uniformIndices, GLenum pname, GLint* params)
{
...
GLint GL_BINDING_CALL MockGLInterface::Mock_glGetFragDataIndex(GLuint program, const char* name)
{
...
void GL_BINDING_CALL MockGLInterface::Mock_glGetFramebufferAttachmentParameterivEXT(GLenum target, GLenum attachment, GLenum pname, GLint* params)
{
...
void GL_BINDING_CALL MockGLInterface::Mock_glGetInternalformatSampleivNV(GLenum target, GLenum internalformat, GLsizei samples, GLenum pname, GLsizei bufSize, GLint* params)
{
...
void GL_BINDING_CALL MockGLInterface::Mock_glGetInternalformativRobustANGLE(GLenum target, GLenum internalformat, GLenum pname, GLsizei bufSize, GLsizei* length, GLint* params)
{
...
void GL_BINDING_CALL MockGLInterface::Mock_glGetProgramResourceName(GLuint program, GLenum programInterface, GLuint index, GLsizei bufSize, GLsizei* length, GLchar* name)
{
...
void GL_BINDING_CALL MockGLInterface::Mock_glGetQueryObjecti64v(GLuint id, GLenum pname, GLint64* params)
{
...
void GL_BINDING_CALL MockGLInterface::Mock_glGetQueryObjectiv(GLuint id, GLenum pname, GLint* params)
{
    MakeGlMockFunctionUnique("glGetQueryObjectiv");
    interface_->GetQueryObjectiv(id, pname, params);
}

void GL_BINDING_CALL MockGLInterface::Mock_glGetQueryObjectivARB(GLuint id, GLenum pname, GLint* params)
{
...
void GL_BINDING_CALL MockGLInterface::Mock_glGetQueryObjectui64v(GLuint id, GLenum pname, GLuint64* params)
{
...
void GL_BINDING_CALL MockGLInterface::Mock_glGetQueryObjectuivARB(GLuint id, GLenum pname, GLuint* params)
{
...
void GL_BINDING_CALL MockGLInterface::Mock_glGetQueryivARB(GLenum target, GLenum pname, GLint* params)
{
...
void GL_BINDING_CALL MockGLInterface::Mock_glGetRenderbufferParameterivEXT(GLenum target, GLenum pname, GLint* params)
{
...
void GL_BINDING_CALL MockGLInterface::Mock_glGetTexLevelParameterfvRobustANGLE(GLenum target, GLint level, GLenum pname, GLsizei bufSize, GLsizei* length, GLfloat* params)
{
...
void GL_BINDING_CALL MockGLInterface::Mock_glGetTexLevelParameterivRobustANGLE(GLenum target, GLint level, GLenum pname, GLsizei bufSize, GLsizei* length, GLint* params)
{
...
void GL_BINDING_CALL MockGLInterface::Mock_glGetTransformFeedbackVarying(GLuint program, GLuint index, GLsizei bufSize, GLsizei* length, GLsizei* size, GLenum* type, char* name)
{
...
void GL_BINDING_CALL MockGLInterface::Mock_glGetTransformFeedbackVaryingEXT(GLuint program, GLuint index, GLsizei bufSize, GLsizei* length, GLsizei* size, GLenum* type, char* name)
{
...
void GL_BINDING_CALL MockGLInterface::Mock_glInvalidateSubFramebuffer(GLenum target, GLsizei numAttachments, const GLenum* attachments, GLint x, GLint y, GLint width, GLint height)
{
...
GLboolean GL_BINDING_CALL MockGLInterface::Mock_glIsFramebufferEXT(GLuint framebuffer)
{
...
GLboolean GL_BINDING_CALL MockGLInterface::Mock_glIsRenderbufferEXT(GLuint renderbuffer)
{
...
GLboolean GL_BINDING_CALL MockGLInterface::Mock_glIsVertexArrayAPPLE(GLuint array)
{
...
void* GL_BINDING_CALL MockGLInterface::Mock_glMapBuffer(GLenum target, GLenum access)
{
...
void GL_BINDING_CALL MockGLInterface::Mock_glMatrixLoadIdentityCHROMIUM(GLenum matrixMode)
{
    MakeGlMockFunctionUnique("glMatrixLoadIdentityCHROMIUM");
    interface_->MatrixLoadIdentityEXT(matrixMode);
}

void GL_BINDING_CALL MockGLInterface::Mock_glMatrixLoadIdentityEXT(GLenum matrixMode)
{
    MakeGlMockFunctionUnique("glMatrixLoadIdentityEXT");
    interface_->MatrixLoadIdentityEXT(matrixMode);
}

void GL_BINDING_CALL MockGLInterface::Mock_glMatrixLoadfCHROMIUM(GLenum matrixMode, const GLfloat* m)
{
    MakeGlMockFunctionUnique("glMatrixLoadfCHROMIUM");
    interface_->MatrixLoadfEXT(matrixMode, m);
}

void GL_BINDING_CALL MockGLInterface::Mock_glMatrixLoadfEXT(GLenum matrixMode, const GLfloat* m)
{
...
void GL_BINDING_CALL MockGLInterface::Mock_glMultiDrawElementsANGLE(GLenum mode, const GLsizei* counts, GLenum type, const GLvoid* const* indices, GLsizei drawcount)
{
...
void GL_BINDING_CALL MockGLInterface::Mock_glMultiDrawElementsInstancedBaseVertexBaseInstanceANGLE(GLenum mode, const GLsizei* counts, GLenum type, const GLvoid* const* indices,
...
void GL_BINDING_CALL MockGLInterface::Mock_glPathCommandsCHROMIUM(
    GLuint path, GLsizei numCommands, const GLubyte* commands, GLsizei numCoords, GLenum coordType, const GLvoid* coords)
{
    ...
    interface_->PathCommandsNV(path, numCommands, commands, numCoords, coordType, coords);
}

void GL_BINDING_CALL MockGLInterface::Mock_glPathCommandsNV(GLuint path, GLsizei numCommands, const GLubyte* commands, GLsizei numCoords, GLenum coordType, const GLvoid* coords)
{
    MakeGlMockFunctionUnique("glPathCommandsNV");
    interface_->PathCommandsNV(path, numCommands, commands, numCoords, coordType, coords);
}

void GL_BINDING_CALL MockGLInterface::Mock_glPathParameterfCHROMIUM(GLuint path, GLenum pname, GLfloat value)
{
    MakeGlMockFunctionUnique("glPathParameterfCHROMIUM");
    interface_->PathParameterfNV(path, pname, value);
}

void GL_BINDING_CALL MockGLInterface::Mock_glPathParameterfNV(GLuint path, GLenum pname, GLfloat value)
{
    MakeGlMockFunctionUnique("glPathParameterfNV");
    interface_->PathParameterfNV(path, pname, value);
}

void GL_BINDING_CALL MockGLInterface::Mock_glPathParameteriCHROMIUM(GLuint path, GLenum pname, GLint value)
{
    MakeGlMockFunctionUnique("glPathParameteriCHROMIUM");
    interface_->PathParameteriNV(path, pname, value);
}

void GL_BINDING_CALL MockGLInterface::Mock_glPathParameteriNV(GLuint path, GLenum pname, GLint value)
{
    MakeGlMockFunctionUnique("glPathParameteriNV");
    interface_->PathParameteriNV(path, pname, value);
}

void GL_BINDING_CALL MockGLInterface::Mock_glPathStencilFuncCHROMIUM(GLenum func, GLint ref, GLuint mask)
{
    MakeGlMockFunctionUnique("glPathStencilFuncCHROMIUM");
    interface_->PathStencilFuncNV(func, ref, mask);
}

void GL_BINDING_CALL MockGLInterface::Mock_glPathStencilFuncNV(GLenum func, GLint ref, GLuint mask)
{
...
void GL_BINDING_CALL MockGLInterface::Mock_glProgramPathFragmentInputGenCHROMIUM(GLuint program, GLint location, GLenum genMode, GLint components, const GLfloat* coeffs)
{
    MakeGlMockFunctionUnique("glProgramPathFragmentInputGenCHROMIUM");
    interface_->ProgramPathFragmentInputGenNV(program, location, genMode, components, coeffs);
}

void GL_BINDING_CALL MockGLInterface::Mock_glProgramPathFragmentInputGenNV(GLuint program, GLint location, GLenum genMode, GLint components, const GLfloat* coeffs)
{
...
void GL_BINDING_CALL MockGLInterface::Mock_glQueryCounter(GLuint id, GLenum target)
{
...
void GL_BINDING_CALL MockGLInterface::Mock_glReadPixelsRobustANGLE(
...
void GL_BINDING_CALL MockGLInterface::Mock_glRenderbufferStorageEXT(GLenum target, GLenum internalformat, GLsizei width, GLsizei height)
{
    MakeGlMockFunctionUnique("glRenderbufferStorageEXT");
    interface_->RenderbufferStorageEXT(target, internalformat, width, height);
}

void GL_BINDING_CALL MockGLInterface::Mock_glRenderbufferStorageMultisample(GLenum target, GLsizei samples, GLenum internalformat, GLsizei width, GLsizei height)
{
...
void GL_BINDING_CALL MockGLInterface::Mock_glRenderbufferStorageMultisampleANGLE(GLenum target, GLsizei samples, GLenum internalformat, GLsizei width, GLsizei height)
{
...
void GL_BINDING_CALL MockGLInterface::Mock_glRenderbufferStorageMultisampleEXT(GLenum target, GLsizei samples, GLenum internalformat, GLsizei width, GLsizei height)
{
...
void GL_BINDING_CALL MockGLInterface::Mock_glRenderbufferStorageMultisampleIMG(GLenum target, GLsizei samples, GLenum internalformat, GLsizei width, GLsizei height)
{
...
void GL_BINDING_CALL MockGLInterface::Mock_glStencilFillPathCHROMIUM(GLuint path, GLenum fillMode, GLuint mask)
{
    ...
    GLsizei numPaths, GLenum pathNameType, const void* paths, GLuint pathBase, GLenum fillMode, GLuint mask, GLenum transformType, const GLfloat* transformValues)
{
    ...
    interface_->StencilFillPathInstancedNV(numPaths, pathNameType, paths, pathBase, fillMode, mask, transformType, transformValues);
}
...
void GL_BINDING_CALL MockGLInterface::Mock_glStencilFillPathNV(GLuint path, GLenum fillMode, GLuint mask)
{
...
void GL_BINDING_CALL MockGLInterface::Mock_glStencilStrokePathCHROMIUM(GLuint path, GLint reference, GLuint mask)
{
    ...
    GLsizei numPaths, GLenum pathNameType, const void* paths, GLuint pathBase, GLint ref, GLuint mask, GLenum transformType, const GLfloat* transformValues)
{
    ...
    interface_->StencilStrokePathInstancedNV(numPaths, pathNameType, paths, pathBase, ref, mask, transformType, transformValues);
}
...
void GL_BINDING_CALL MockGLInterface::Mock_glStencilStrokePathNV(GLuint path, GLint reference, GLuint mask)
{
    MakeGlMockFunctionUnique("glStencilStrokePathNV");
    interface_->StencilStrokePathNV(path, reference, mask);
}

void GL_BINDING_CALL MockGLInterface::Mock_glStencilThenCoverFillPathCHROMIUM(GLuint path, GLenum fillMode, GLuint mask, GLenum coverMode)
{
...
void GL_BINDING_CALL MockGLInterface::Mock_glStencilThenCoverFillPathInstancedCHROMIUM(
    GLsizei numPaths, GLenum pathNameType, const void* paths, GLuint pathBase, GLenum fillMode, GLuint mask, GLenum coverMode, GLenum transformType, const GLfloat* transformValues)
{
    ...
    interface_->StencilThenCoverFillPathInstancedNV(numPaths, pathNameType, paths, pathBase, fillMode, mask, coverMode, transformType, transformValues);
}

void GL_BINDING_CALL MockGLInterface::Mock_glStencilThenCoverFillPathInstancedNV(
    GLsizei numPaths, GLenum pathNameType, const void* paths, GLuint pathBase, GLenum fillMode, GLuint mask, GLenum coverMode, GLenum transformType, const GLfloat* transformValues)
{
...
void GL_BINDING_CALL MockGLInterface::Mock_glStencilThenCoverFillPathNV(GLuint path, GLenum fillMode, GLuint mask, GLenum coverMode)
{
    MakeGlMockFunctionUnique("glStencilThenCoverFillPathNV");
    interface_->StencilThenCoverFillPathNV(path, fillMode, mask, coverMode);
}

void GL_BINDING_CALL MockGLInterface::Mock_glStencilThenCoverStrokePathCHROMIUM(GLuint path, GLint reference, GLuint mask, GLenum coverMode)
{
    ...
    GLsizei numPaths, GLenum pathNameType, const void* paths, GLuint pathBase, GLint ref, GLuint mask, GLenum coverMode, GLenum transformType, const GLfloat* transformValues)
{
    ...
    interface_->StencilThenCoverStrokePathInstancedNV(numPaths, pathNameType, paths, pathBase, ref, mask, coverMode, transformType, transformValues);
}

void GL_BINDING_CALL MockGLInterface::Mock_glStencilThenCoverStrokePathInstancedNV(
    GLsizei numPaths, GLenum pathNameType, const void* paths, GLuint pathBase, GLint ref, GLuint mask, GLenum coverMode, GLenum transformType, const GLfloat* transformValues)
{
...
void GL_BINDING_CALL MockGLInterface::Mock_glStencilThenCoverStrokePathNV(GLuint path, GLint reference, GLuint mask, GLenum coverMode)
{
...
void GL_BINDING_CALL MockGLInterface::Mock_glTexImage2DRobustANGLE(
...
void GL_BINDING_CALL MockGLInterface::Mock_glTexImage3D(
...
void GL_BINDING_CALL MockGLInterface::Mock_glTexImage3DRobustANGLE(
...
void GL_BINDING_CALL MockGLInterface::Mock_glTexStorageMem2DEXT(GLenum target, GLsizei levels, GLenum internalFormat, GLsizei width, GLsizei height, GLuint memory, GLuint64 offset)
{
...
void GL_BINDING_CALL MockGLInterface::Mock_glTexStorageMemFlags2DANGLE(GLenum target, GLsizei levels, GLenum internalFormat, GLsizei width, GLsizei height, GLuint memory,
...
void GL_BINDING_CALL MockGLInterface::Mock_glTexSubImage3D(
...
void GL_BINDING_CALL MockGLInterface::Mock_glTexSubImage3DRobustANGLE(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height,
...
void GL_BINDING_CALL MockGLInterface::Mock_glTransformFeedbackVaryingsEXT(GLuint program, GLsizei count, const char* const* varyings, GLenum bufferMode)
{
...
void GL_BINDING_CALL MockGLInterface::Mock_glVertexAttribDivisorARB(GLuint index, GLuint divisor)
{
...
void GL_BINDING_CALL MockGLInterface::Mock_glWaitSyncAPPLE(GLsync sync, GLbitfield flags, GLuint64 timeout)
{
...
static void MockGlInvalidFunction() { NOTREACHED(); }
...
GLFunctionPointerType GL_BINDING_CALL MockGLInterface::GetGLProcAddress(const char* name)
{
    ...
    if (strcmp(name, "glBeginTransformFeedbackEXT") == 0)
        return reinterpret_cast<GLFunctionPointerType>(Mock_glBeginTransformFeedbackEXT);
    ...
    if (strcmp(name, "glBindFragDataLocationIndexed") == 0)
        return reinterpret_cast<GLFunctionPointerType>(Mock_glBindFragDataLocationIndexed);
    ...
    if (strcmp(name, "glBindFragmentInputLocationCHROMIUM") == 0)
        return reinterpret_cast<GLFunctionPointerType>(Mock_glBindFragmentInputLocationCHROMIUM);
    ...
    if (strcmp(name, "glCheckFramebufferStatusEXT") == 0)
        return reinterpret_cast<GLFunctionPointerType>(Mock_glCheckFramebufferStatusEXT);
    ...
    if (strcmp(name, "glCoverFillPathCHROMIUM") == 0)
        return reinterpret_cast<GLFunctionPointerType>(Mock_glCoverFillPathCHROMIUM);
    if (strcmp(name, "glCoverFillPathInstancedCHROMIUM") == 0)
        return reinterpret_cast<GLFunctionPointerType>(Mock_glCoverFillPathInstancedCHROMIUM);
    if (strcmp(name, "glCoverFillPathInstancedNV") == 0)
        return reinterpret_cast<GLFunctionPointerType>(Mock_glCoverFillPathInstancedNV);
    ...
    if (strcmp(name, "glCoverStrokePathCHROMIUM") == 0)
        return reinterpret_cast<GLFunctionPointerType>(Mock_glCoverStrokePathCHROMIUM);
    if (strcmp(name, "glCoverStrokePathInstancedCHROMIUM") == 0)
        return reinterpret_cast<GLFunctionPointerType>(Mock_glCoverStrokePathInstancedCHROMIUM);
    if (strcmp(name, "glCoverStrokePathInstancedNV") == 0)
        return reinterpret_cast<GLFunctionPointerType>(Mock_glCoverStrokePathInstancedNV);
    ...
    if (strcmp(name, "glCoverageModulationCHROMIUM") == 0)
        return reinterpret_cast<GLFunctionPointerType>(Mock_glCoverageModulationCHROMIUM);
    ...
    if (strcmp(name, "glDeleteFramebuffersEXT") == 0)
        return reinterpret_cast<GLFunctionPointerType>(Mock_glDeleteFramebuffersEXT);
    ...
    if (strcmp(name, "glDeleteRenderbuffersEXT") == 0)
        return reinterpret_cast<GLFunctionPointerType>(Mock_glDeleteRenderbuffersEXT);
    ...
    if (strcmp(name, "glDeleteVertexArraysAPPLE") == 0)
        return reinterpret_cast<GLFunctionPointerType>(Mock_glDeleteVertexArraysAPPLE);
    ...
    if (strcmp(name, "glDrawArraysInstancedARB") == 0)
        return reinterpret_cast<GLFunctionPointerType>(Mock_glDrawArraysInstancedARB);
    if (strcmp(name, "glDrawArraysInstancedBaseInstance") == 0)
        return reinterpret_cast<GLFunctionPointerType>(Mock_glDrawArraysInstancedBaseInstance);
    ...
    if (strcmp(name, "glDrawElementsInstancedARB") == 0)
        return reinterpret_cast<GLFunctionPointerType>(Mock_glDrawElementsInstancedARB);
    if (strcmp(name, "glDrawElementsInstancedBaseVertexBaseInstance") == 0)
        return reinterpret_cast<GLFunctionPointerType>(Mock_glDrawElementsInstancedBaseVertexBaseInstance);
    ...
    if (strcmp(name, "glEndTransformFeedbackEXT") == 0)
        return reinterpret_cast<GLFunctionPointerType>(Mock_glEndTransformFeedbackEXT);
    ...
    if (strcmp(name, "glFramebufferRenderbufferEXT") == 0)
        return reinterpret_cast<GLFunctionPointerType>(Mock_glFramebufferRenderbufferEXT);
    ...
    if (strcmp(name, "glFramebufferTexture2DEXT") == 0)
        return reinterpret_cast<GLFunctionPointerType>(Mock_glFramebufferTexture2DEXT);
    ...
    if (strcmp(name, "glGetFramebufferAttachmentParameterivEXT") == 0)
        return reinterpret_cast<GLFunctionPointerType>(Mock_glGetFramebufferAttachmentParameterivEXT);
    ...
    if (strcmp(name, "glGetGraphicsResetStatusARB") == 0)
        return reinterpret_cast<GLFunctionPointerType>(Mock_glGetGraphicsResetStatusARB);
    ...
    if (strcmp(name, "glGetRenderbufferParameterivEXT") == 0)
        return reinterpret_cast<GLFunctionPointerType>(Mock_glGetRenderbufferParameterivEXT);
    ...
    if (strcmp(name, "glGetTransformFeedbackVaryingEXT") == 0)
        return reinterpret_cast<GLFunctionPointerType>(Mock_glGetTransformFeedbackVaryingEXT);
    ...
    if (strcmp(name, "glMatrixLoadIdentityCHROMIUM") == 0)
        return reinterpret_cast<GLFunctionPointerType>(Mock_glMatrixLoadIdentityCHROMIUM);
    if (strcmp(name, "glMatrixLoadIdentityEXT") == 0)
        return reinterpret_cast<GLFunctionPointerType>(Mock_glMatrixLoadIdentityEXT);
    ...
    if (strcmp(name, "glPathParameterfCHROMIUM") == 0)
        return reinterpret_cast<GLFunctionPointerType>(Mock_glPathParameterfCHROMIUM);
    ...
    if (strcmp(name, "glPathParameteriCHROMIUM") == 0)
        return reinterpret_cast<GLFunctionPointerType>(Mock_glPathParameteriCHROMIUM);
    ...
    if (strcmp(name, "glPathStencilFuncCHROMIUM") == 0)
        return reinterpret_cast<GLFunctionPointerType>(Mock_glPathStencilFuncCHROMIUM);
    ...
    if (strcmp(name, "glProgramPathFragmentInputGenCHROMIUM") == 0)
        return reinterpret_cast<GLFunctionPointerType>(Mock_glProgramPathFragmentInputGenCHROMIUM);
    if (strcmp(name, "glProgramPathFragmentInputGenNV") == 0)
        return reinterpret_cast<GLFunctionPointerType>(Mock_glProgramPathFragmentInputGenNV);
    ...
    if (strcmp(name, "glRenderbufferStorageEXT") == 0)
        return reinterpret_cast<GLFunctionPointerType>(Mock_glRenderbufferStorageEXT);
    ...
    if (strcmp(name, "glStencilFillPathCHROMIUM") == 0)
        return reinterpret_cast<GLFunctionPointerType>(Mock_glStencilFillPathCHROMIUM);
    if (strcmp(name, "glStencilFillPathInstancedCHROMIUM") == 0)
        return reinterpret_cast<GLFunctionPointerType>(Mock_glStencilFillPathInstancedCHROMIUM);
    if (strcmp(name, "glStencilFillPathInstancedNV") == 0)
        return reinterpret_cast<GLFunctionPointerType>(Mock_glStencilFillPathInstancedNV);
    ...
    if (strcmp(name, "glStencilStrokePathCHROMIUM") == 0)
        return reinterpret_cast<GLFunctionPointerType>(Mock_glStencilStrokePathCHROMIUM);
    if (strcmp(name, "glStencilStrokePathInstancedCHROMIUM") == 0)
        return reinterpret_cast<GLFunctionPointerType>(Mock_glStencilStrokePathInstancedCHROMIUM);
    if (strcmp(name, "glStencilStrokePathInstancedNV") == 0)
        return reinterpret_cast<GLFunctionPointerType>(Mock_glStencilStrokePathInstancedNV);
    ...
    if (strcmp(name, "glStencilThenCoverFillPathCHROMIUM") == 0)
        return reinterpret_cast<GLFunctionPointerType>(Mock_glStencilThenCoverFillPathCHROMIUM);
    if (strcmp(name, "glStencilThenCoverFillPathInstancedCHROMIUM") == 0)
        return reinterpret_cast<GLFunctionPointerType>(Mock_glStencilThenCoverFillPathInstancedCHROMIUM);
    if (strcmp(name, "glStencilThenCoverFillPathInstancedNV") == 0)
        return reinterpret_cast<GLFunctionPointerType>(Mock_glStencilThenCoverFillPathInstancedNV);
    if (strcmp(name, "glStencilThenCoverFillPathNV") == 0)
        return reinterpret_cast<GLFunctionPointerType>(Mock_glStencilThenCoverFillPathNV);
    if (strcmp(name, "glStencilThenCoverStrokePathCHROMIUM") == 0)
        return reinterpret_cast<GLFunctionPointerType>(Mock_glStencilThenCoverStrokePathCHROMIUM);
    if (strcmp(name, "glStencilThenCoverStrokePathInstancedCHROMIUM") == 0)
        return reinterpret_cast<GLFunctionPointerType>(Mock_glStencilThenCoverStrokePathInstancedCHROMIUM);
    if (strcmp(name, "glStencilThenCoverStrokePathInstancedNV") == 0)
        return reinterpret_cast<GLFunctionPointerType>(Mock_glStencilThenCoverStrokePathInstancedNV);
    if (strcmp(name, "glStencilThenCoverStrokePathNV") == 0)
        return reinterpret_cast<GLFunctionPointerType>(Mock_glStencilThenCoverStrokePathNV);
    ...
    if (strcmp(name, "glTransformFeedbackVaryingsEXT") == 0)
        return reinterpret_cast<GLFunctionPointerType>(Mock_glTransformFeedbackVaryingsEXT);
    ...
    if (strcmp(name, "glVertexAttribDivisorARB") == 0)
        return reinterpret_cast<GLFunctionPointerType>(Mock_glVertexAttribDivisorARB);
