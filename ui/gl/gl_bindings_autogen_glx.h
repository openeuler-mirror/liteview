...
typedef bool(GL_BINDING_CALL* glXGetMscRateOMLProc)(Display* dpy, GLXDrawable drawable, int32_t* numerator, int32_t* denominator);
typedef void(GL_BINDING_CALL* glXGetSelectedEventProc)(Display* dpy, GLXDrawable drawable, unsigned long* mask);
typedef bool(GL_BINDING_CALL* glXGetSyncValuesOMLProc)(Display* dpy, GLXDrawable drawable, int64_t* ust, int64_t* msc, int64_t* sbc);
...
public:
    ...
    virtual bool glXGetMscRateOMLFn(Display* dpy, GLXDrawable drawable, int32_t* numerator, int32_t* denominator) = 0;
    virtual void glXGetSelectedEventFn(Display* dpy, GLXDrawable drawable, unsigned long* mask) = 0;
    virtual bool glXGetSyncValuesOMLFn(Display* dpy, GLXDrawable drawable, int64_t* ust, int64_t* msc, int64_t* sbc) = 0;
...
#define glXCreateContextAttribsARB ::gl::g_current_glx_context->glXCreateContextAttribsARBFn
...
#define glXGetCurrentDrawable ::gl::g_current_glx_context->glXGetCurrentDrawableFn
#define glXGetCurrentReadDrawable ::gl::g_current_glx_context->glXGetCurrentReadDrawableFn
#define glXGetFBConfigAttrib ::gl::g_current_glx_context->glXGetFBConfigAttribFn
#define glXGetFBConfigFromVisualSGIX ::gl::g_current_glx_context->glXGetFBConfigFromVisualSGIXFn
...
#define glXGetVisualFromFBConfig ::gl::g_current_glx_context->glXGetVisualFromFBConfigFn
#define glXIsDirect ::gl::g_current_glx_context->glXIsDirectFn
#define glXMakeContextCurrent ::gl::g_current_glx_context->glXMakeContextCurrentFn
...
#define glXQueryExtensionsString ::gl::g_current_glx_context->glXQueryExtensionsStringFn
...
#define glXReleaseTexImageEXT ::gl::g_current_glx_context->glXReleaseTexImageEXTFn
