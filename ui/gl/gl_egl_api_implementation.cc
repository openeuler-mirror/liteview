...
void EGLApiBase::InitializeBase(DriverEGL* driver) { driver_ = driver; }

RealEGLApi::RealEGLApi() { }

RealEGLApi::~RealEGLApi() { }

void RealEGLApi::Initialize(DriverEGL* driver) { InitializeBase(driver); }
...
bool InitializeExtensionSettingsOneOffEGL(GLDisplayEGL* display) { return display->InitializeExtensionSettings(); }
