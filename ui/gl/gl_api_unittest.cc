...
public:
    ...
    static GLFunctionPointerType GL_BINDING_CALL FakeGLGetProcAddress(const char* proc) { return reinterpret_cast<GLFunctionPointerType>(0x1); }
    ...
    static void GL_BINDING_CALL FakeGetIntegervFn(GLenum pname, GLint* params) { *params = num_fake_extension_strings_; }
    ...
    const char* GetExtensions() { return reinterpret_cast<const char*>(api_->glGetStringFn(GL_EXTENSIONS)); }
    ...
    const char* GetExtensioni(uint32_t index) { return reinterpret_cast<const char*>(api_->glGetStringiFn(GL_EXTENSIONS, index)); }
...
{
    static const char* kFakeExtensions[] = { "GL_ARB_timer_query" };
