...
ScopedViewport::~ScopedViewport() { glViewport(data_[0], data_[1], data_[2], data_[3]); }
...
ScopedColorMask::~ScopedColorMask() { glColorMask(colors_[0], colors_[1], colors_[2], colors_[3]); }
