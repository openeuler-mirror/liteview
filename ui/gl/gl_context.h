...
class GL_EXPORT GLContext : public base::RefCounted<GLContext>, public base::SupportsWeakPtr<GLContext> {
public:
    ...
    virtual bool Initialize(GLSurface* compatible_surface, const GLContextAttribs& attribs) = 0;
