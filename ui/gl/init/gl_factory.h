...
// |system_device_id| specifies which GPU to use on a multi-GPU system.
// If its value is 0, use the default GPU of the system.
GL_INIT_EXPORT GLDisplay* InitializeGLNoExtensionsOneOff(bool init_bindings, uint64_t system_device_id);
...
// for use in tests.
GL_INIT_EXPORT bool InitializeStaticGLBindingsImplementation(GLImplementationParts impl, bool fallback_to_software_gl);
...
// |system_device_id| specifies which GPU to use on a multi-GPU system.
// If its value is 0, use the default GPU of the system.
GL_INIT_EXPORT GLDisplay* InitializeGLOneOffPlatformImplementation(bool fallback_to_software_gl, bool disable_gl_drawing, bool init_extensions, uint64_t system_device_id);
...
GL_INIT_EXPORT scoped_refptr<GLSurface> CreateSurfacelessViewGLSurface(GLDisplay* display, gfx::AcceleratedWidget window);
...
GL_INIT_EXPORT scoped_refptr<GLSurface> CreateOffscreenGLSurfaceWithFormat(GLDisplay* display, const gfx::Size& size, GLSurfaceFormat format);
