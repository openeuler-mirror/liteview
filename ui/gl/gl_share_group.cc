...
void GLShareGroup::AddContext(GLContext* context) { contexts_.insert(context); }
...
#if BUILDFLAG(IS_APPLE)
void GLShareGroup::SetRendererID(int renderer_id) { renderer_id_ = renderer_id; }

int GLShareGroup::GetRendererID() { return renderer_id_; }
#endif
