...
public:
    DirectCompositionChildSurfaceWin(GLDisplayEGL* display, bool use_angle_texture_offset);

    DirectCompositionChildSurfaceWin(const DirectCompositionChildSurfaceWin&) = delete;
    DirectCompositionChildSurfaceWin& operator=(const DirectCompositionChildSurfaceWin&) = delete;
    ...
    const Microsoft::WRL::ComPtr<IDCompositionSurface>& dcomp_surface() const { return dcomp_surface_; }
    ...
    void SetDCompSurfaceForTesting(Microsoft::WRL::ComPtr<IDCompositionSurface> surface);
