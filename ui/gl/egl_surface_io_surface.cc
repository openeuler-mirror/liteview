...
// static
std::unique_ptr<ScopedEGLSurfaceIOSurface> ScopedEGLSurfaceIOSurface::Create(EGLDisplay display, IOSurfaceRef io_surface, uint32_t plane, gfx::BufferFormat format)
{
