...
const char kDisableES3GLContextForTesting[] = "disable-es3-gl-context-for-testing";
...
// are supported.
const char kDisableDirectCompositionVideoOverlays[] = "disable-direct-composition-video-overlays";
...
const int kGLSwitchesCopiedFromGpuProcessHostNumSwitches = std::size(kGLSwitchesCopiedFromGpuProcessHost);
...
BASE_FEATURE(kDirectCompositionLowLatencyPresentation, "DirectCompositionLowLatencyPresentation", base::FEATURE_DISABLED_BY_DEFAULT);
...
BASE_FEATURE(kDirectCompositionVerifyDrawOffset, "DirectCompositionVerifyDrawOffset", base::FEATURE_DISABLED_BY_DEFAULT);

const base::FeatureParam<int> kVerifyDrawOffsetX { &kDirectCompositionVerifyDrawOffset, "verify_draw_offset_x", 0 };

const base::FeatureParam<int> kVerifyDrawOffsetY { &kDirectCompositionVerifyDrawOffset, "verify_draw_offset_y", 0 };
...
BASE_FEATURE(kEGLDualGpuRendering, "EGLDualGpuRendering", base::FEATURE_DISABLED_BY_DEFAULT);
...
BASE_FEATURE(kDefaultANGLEMetal, "DefaultANGLEMetal", base::FEATURE_DISABLED_BY_DEFAULT);
...
bool SupportsEGLDualGpuRendering()
{
    ...
    gl::GLDisplayEGL* display_default = gl::GLDisplayManagerEGL::GetInstance()->GetDisplay(gl::GpuPreference::kDefault);
    DCHECK(display_default);
    gl::GLDisplayEGL* display_high_performance = gl::GLDisplayManagerEGL::GetInstance()->GetDisplay(gl::GpuPreference::kHighPerformance);
