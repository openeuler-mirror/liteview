...
unsigned GLImageStub::GetDataType() { return GL_UNSIGNED_BYTE; }

GLImageStub::BindOrCopy GLImageStub::ShouldBindOrCopy() { return BIND; }
...
bool GLImageStub::CopyTexSubImage(unsigned target, const gfx::Point& offset, const gfx::Rect& rect) { return false; }
