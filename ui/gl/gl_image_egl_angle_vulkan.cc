...
bool GLImageEGLAngleVulkan::Initialize(VkImage image, const VkImageCreateInfo* create_info, unsigned int internal_format)
{
    ...
    bool result = GLImageEGL::Initialize(EGL_NO_CONTEXT, EGL_VULKAN_IMAGE_ANGLE, reinterpret_cast<EGLClientBuffer>(&image), attribs);
