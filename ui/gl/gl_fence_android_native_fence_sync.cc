...
// static
std::unique_ptr<GLFenceAndroidNativeFenceSync> GLFenceAndroidNativeFenceSync::CreateForGpuFence() { return CreateInternal(EGL_SYNC_NATIVE_FENCE_ANDROID, nullptr); }
...
std::unique_ptr<GLFenceAndroidNativeFenceSync> GLFenceAndroidNativeFenceSync::CreateFromGpuFence(const gfx::GpuFence& gpu_fence)
{
    ...
    EGLint attribs[] = { EGL_SYNC_NATIVE_FENCE_FD_ANDROID, handle.owned_fd.release(), EGL_NONE };
