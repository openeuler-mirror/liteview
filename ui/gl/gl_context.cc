...
namespace {
base::LazyInstance<base::ThreadLocalPointer<GLContext>>::Leaky current_context_ = LAZY_INSTANCE_INITIALIZER;

base::LazyInstance<base::ThreadLocalPointer<GLContext>>::Leaky current_real_context_ = LAZY_INSTANCE_INITIALIZER;
} // namespace
...
void GLContext::ScopedReleaseCurrent::Cancel() { canceled_ = true; }
...
// static
int32_t GLContext::TotalGLContexts() { return static_cast<int32_t>(base::subtle::NoBarrier_Load(&total_gl_contexts_)); }

// static
bool GLContext::SwitchableGPUsSupported() { return switchable_gpus_supported_; }
...
bool GLContext::ForceGpuSwitchIfNeeded() { return true; }

void GLContext::SetUnbindFboOnMakeCurrent() { NOTIMPLEMENTED(); }
...
void GLContext::ForceReleaseVirtuallyCurrent() { NOTREACHED(); }

void GLContext::DirtyVirtualContextState() { current_virtual_context_ = nullptr; }

#if defined(USE_EGL)
GLDisplayEGL* GLContext::GetGLDisplayEGL() { return nullptr; }
#endif // USE_EGL
...
bool GLContext::HasBackpressureFences() const { return !backpressure_fences_.empty(); }

void GLContext::DestroyBackpressureFences() { backpressure_fences_.clear(); }
...
bool GLContext::HasExtension(const char* name) { return gfx::HasExtension(GetExtensions(), name); }
...
GLShareGroup* GLContext::share_group() { return share_group_.get(); }
...
GLContext* GLContext::GetCurrent() { return current_context_.Pointer()->Get(); }

GLContext* GLContext::GetRealCurrent() { return current_real_context_.Pointer()->Get(); }

std::unique_ptr<gl::GLVersionInfo> GLContext::GenerateGLVersionInfo() { return std::make_unique<GLVersionInfo>(GetGLVersion().c_str(), GetGLRenderer().c_str(), GetExtensions()); }
...
GLStateRestorer* GLContext::GetGLStateRestorer() { return state_restorer_.get(); }

void GLContext::SetGLStateRestorer(GLStateRestorer* state_restorer) { state_restorer_ = base::WrapUnique(state_restorer); }
...
void GLContext::BindGLApi() { SetCurrentGL(GetCurrentGL()); }
