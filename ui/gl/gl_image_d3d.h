...
public:
    ...
    GLImageD3D(const gfx::Size& size, unsigned internal_format, unsigned data_type, const gfx::ColorSpace& color_space, Microsoft::WRL::ComPtr<ID3D11Texture2D> texture,
        size_t array_slice = 0, size_t plane_index = 0, Microsoft::WRL::ComPtr<IDXGISwapChain1> swap_chain = nullptr);
    ...
    const Microsoft::WRL::ComPtr<ID3D11Texture2D>& texture() const { return texture_; }
