...
public:
    ...
    virtual gl::GLDisplay* InitializeGLOneOffPlatform(uint64_t system_device_id) = 0;
    ...
    virtual scoped_refptr<gl::GLSurface> CreateSurfacelessViewGLSurface(gl::GLDisplay* display, gfx::AcceleratedWidget window) = 0;
