...
const char kDisableRunningAsSystemCompositor[] = "disable-running-as-system-compositor";
...
const char kPlatformDisallowsChromeOSDirectVideoDecoder[] = "platform-disallows-chromeos-direct-video-decoder";
