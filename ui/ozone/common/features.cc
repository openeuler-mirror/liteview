...
// protocols.
BASE_FEATURE(kWaylandOverlayDelegation, "WaylandOverlayDelegation",
...
// scale factor.
BASE_FEATURE(kWaylandSurfaceSubmissionInPixelCoordinates, "WaylandSurfaceSubmissionInPixelCoordinates",
#if BUILDFLAG(IS_CHROMEOS_LACROS)
    base::FEATURE_ENABLED_BY_DEFAULT
#else
    base::FEATURE_DISABLED_BY_DEFAULT
...
{
    return base::FeatureList::IsEnabled(kWaylandSurfaceSubmissionInPixelCoordinates);
}
