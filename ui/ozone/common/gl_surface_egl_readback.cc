...
gfx::SwapResult GLSurfaceEglReadback::SwapBuffers(PresentationCallback callback, gl::FrameData data)
{
...
void GLSurfaceEglReadback::ReadPixels(void* buffer)
{
    ...
    glReadPixels(0, 0, size.width(), size.height(), GL_BGRA, GL_UNSIGNED_BYTE, buffer);
