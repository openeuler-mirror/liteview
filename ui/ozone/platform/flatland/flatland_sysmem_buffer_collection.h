...
class FlatlandSysmemBufferCollection : public base::RefCountedThreadSafe<FlatlandSysmemBufferCollection> {
public:
    ...
    bool Initialize(fuchsia::sysmem::Allocator_Sync* sysmem_allocator, fuchsia::ui::composition::Allocator* flatland_allocator,
    ...
    scoped_refptr<gfx::NativePixmap> CreateNativePixmap(size_t buffer_index, gfx::Size size);
    ...
    gfx::SysmemBufferCollectionId id() const
    {
        return id_;
    }
    size_t num_buffers() const
    {
        return buffers_info_.buffer_count;
    }
...
private:
    ...
    bool InitializeInternal(fuchsia::sysmem::Allocator_Sync* sysmem_allocator, fuchsia::ui::composition::Allocator* flatland_allocator,
        fuchsia::sysmem::BufferCollectionTokenSyncPtr collection_token, bool register_with_flatland_allocator, size_t min_buffer_count);
