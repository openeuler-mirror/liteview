...
public:
    ...
    // Flatland Allocator.
    void Initialize(fuchsia::sysmem::AllocatorHandle sysmem_allocator, fuchsia::ui::composition::AllocatorHandle flatland_allocator);
    ...
    scoped_refptr<FlatlandSysmemBufferCollection> CreateCollection(
        VkDevice vk_device, gfx::Size size, gfx::BufferFormat format, gfx::BufferUsage usage, size_t num_buffers);

    scoped_refptr<FlatlandSysmemBufferCollection> ImportFlatlandSysmemBufferCollection(VkDevice vk_device, gfx::SysmemBufferCollectionId id, zx::channel token,
        gfx::Size size, gfx::BufferFormat format, gfx::BufferUsage usage, size_t min_buffer_count);

    scoped_refptr<FlatlandSysmemBufferCollection> GetCollectionById(gfx::SysmemBufferCollectionId id);
...
private:
    ...
    base::small_map<std::unordered_map<gfx::SysmemBufferCollectionId, FlatlandSysmemBufferCollection*, base::UnguessableTokenHash>> collections_ GUARDED_BY(
        collections_lock_);
