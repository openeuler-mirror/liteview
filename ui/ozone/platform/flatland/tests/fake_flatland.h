...
class FakeParentViewportWatcher : public fuchsia::ui::composition::testing::ParentViewportWatcher_TestBase {
public:
    explicit FakeParentViewportWatcher(fidl::InterfaceRequest<fuchsia::ui::composition::ParentViewportWatcher> request);
...
class FakeFlatland : public fuchsia::ui::composition::testing::Allocator_TestBase, public fuchsia::ui::composition::testing::Flatland_TestBase {
public:
    using PresentHandler = base::RepeatingCallback<void(fuchsia::ui::composition::PresentArgs)>;
    using ViewRefFocusedRequestHandler = fidl::InterfaceRequestHandler<fuchsia::ui::views::ViewRefFocused>;
    using TouchSourceRequestHandler = fidl::InterfaceRequestHandler<fuchsia::ui::pointer::TouchSource>;
    ...
    {
        return allocator_binding_.is_bound();
    }

    bool is_flatland_connected() const
    {
        return flatland_binding_.is_bound();
    }
    ...
    //
    // This can only be called once.
    fidl::InterfaceRequestHandler<fuchsia::ui::composition::Flatland> GetFlatlandRequestHandler(async_dispatcher_t* dispatcher = nullptr);
    fidl::InterfaceRequestHandler<fuchsia::ui::composition::Allocator> GetAllocatorRequestHandler(async_dispatcher_t* dispatcher = nullptr);
...
private:
    ...
    // |fuchsia::ui::composition::Flatland|
    void CreateView2(fuchsia::ui::views::ViewCreationToken token, fuchsia::ui::views::ViewIdentityOnCreation view_identity,
        fuchsia::ui::composition::ViewBoundProtocols view_protocols,
        fidl::InterfaceRequest<fuchsia::ui::composition::ParentViewportWatcher> parent_viewport_watcher) override;
