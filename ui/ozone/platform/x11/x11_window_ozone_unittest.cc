...
TEST_F(X11WindowOzoneTest, SendPlatformEventToRightTarget)
{
    ...
    xi_event.InitGenericButtonEvent(kPointerDeviceId, ET_MOUSE_PRESSED, gfx::Point(218, 290), EF_NONE);
...
TEST_F(X11WindowOzoneTest, MouseEnterAndDelete)
{
    ...
    window_2->SetCapture();
    ScopedXI2Event xi_event;
    xi_event.InitGenericButtonEvent(kPointerDeviceId, ET_MOUSE_PRESSED, gfx::Point(0, 0), EF_NONE);
