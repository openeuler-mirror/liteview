...
TEST_F(X11WindowTest, DISABLED_ToggleMinimizePropogateToPlatformWindowDelegate)
{
    ...
    // Minimize by iconifying.
    {
        ...
        SendClientMessage(x11_window, GetX11RootWindow(), x11::GetAtom("WM_CHANGE_STATE"), { WM_STATE_ICONIC, 0, 0, 0, 0 });
        // Wait till set.
    ...
    {
        SendClientMessage(x11_window, GetX11RootWindow(), x11::GetAtom("WM_CHANGE_STATE"), { WM_STATE_NORMAL, 0, 0, 0, 0 });
        // Wait till unset.
