...
std::unique_ptr<NativePixmapGLBinding> NativePixmapGLXBinding::Create(
    scoped_refptr<gfx::NativePixmap> pixmap, gfx::BufferFormat plane_format, gfx::BufferPlane plane, gfx::Size plane_size, GLenum target, GLuint texture_id)
{
    auto gl_image = base::MakeRefCounted<gl::GLImageGLXNativePixmap>(plane_size, plane_format, plane);
