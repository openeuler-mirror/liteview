...
{
    auto gl_image = base::MakeRefCounted<gl::GLImageEGLPixmap>(plane_size, plane_format);
    x11::Pixmap pixmap = gl::XPixmapFromNativePixmap(*static_cast<gfx::NativePixmapDmaBuf*>(native_pixmap.get()), plane_format);
