...
void GLEGLUtilityX11::CollectGpuExtraInfo(bool enable_native_gpu_memory_buffers, gfx::GpuExtraInfo& gpu_extra_info) const
{
    ...
    if (gl::GetGLImplementation() == gl::kGLImplementationDesktopGL) {
        ...
        gpu_extra_info.gpu_memory_buffer_support_x11.erase(
            std::remove_if(gpu_extra_info.gpu_memory_buffer_support_x11.begin(), gpu_extra_info.gpu_memory_buffer_support_x11.end(),
                [&](gfx::BufferUsageAndFormat usage_and_format) {
                    return visual_picker->GetFbConfigForFormat(usage_and_format.format) == x11::Glx::FbConfig {};
                }),
...
absl::optional<base::ScopedEnvironmentVariableOverride> GLEGLUtilityX11::MaybeGetScopedDisplayUnsetForVulkan()
{
