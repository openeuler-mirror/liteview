...
public:
    ...
    void InitializeGPU(const InitParams& args) override
    {
        ...
        if (base::CommandLine::ForCurrentProcess()->HasSwitch(switches::kDisableBufferBWCompression)) {
        ...
        overlay_manager_ = std::make_unique<DrmOverlayManagerGpu>(drm_thread_proxy_.get(), args.allow_sync_and_real_buffer_page_flip_testing);
