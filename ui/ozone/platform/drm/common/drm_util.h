...
public:
    HardwareDisplayControllerInfo(ScopedDrmConnectorPtr connector, ScopedDrmCrtcPtr crtc, uint8_t index);
...
using HardwareDisplayControllerInfoList = std::vector<std::unique_ptr<HardwareDisplayControllerInfo>>;
