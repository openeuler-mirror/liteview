...
public:
    ...
    bool ConfigureDisplays(const std::vector<display::DisplayConfigurationParams>& config_requests, uint32_t modeset_flag);
    ...
    void SetColorMatrix(int64_t display_id, const std::vector<float>& color_matrix);
