...
public:
    HardwareDisplayController(std::unique_ptr<CrtcController> controller, const gfx::Point& origin);
    ...
    // |commit_request|.
    void GetModesetProps(CommitRequest* commit_request, const DrmOverlayPlaneList& modeset_planes, const drmModeModeInfo& mode);
    ...
    void UpdatePreferredModiferForFormat(gfx::BufferFormat buffer_format, uint64_t modifier);
