...
public:
    ...
    void SetColorSpace(gfx::AcceleratedWidget widget, const gfx::ColorSpace& color_space);
    ...
    void GetHardwareCapabilities(gfx::AcceleratedWidget widget, ui::HardwareCapabilitiesCallback receive_callback);
    ...
    void ConfigureNativeDisplays(
        const std::vector<display::DisplayConfigurationParams>& config_requests, uint32_t modeset_flag, ConfigureNativeDisplaysCallback callback) override;
    ...
    void SetGammaCorrection(
        int64_t display_id, const std::vector<display::GammaRampRGBEntry>& degamma_lut, const std::vector<display::GammaRampRGBEntry>& gamma_lut) override;
    ...
    void SetCursor(gfx::AcceleratedWidget widget, const std::vector<SkBitmap>& bitmaps, const gfx::Point& location, base::TimeDelta frame_delay) override;
