...
public:
    ...
    virtual void CursorSet(gfx::AcceleratedWidget window, const std::vector<SkBitmap>& bitmaps, const gfx::Point& point, base::TimeDelta frame_delay) = 0;
...
private:
    ...
    void CursorSetLockTested(gfx::AcceleratedWidget window, const std::vector<SkBitmap>& bitmaps, const gfx::Point& point, base::TimeDelta frame_delay);
    ...
    DrmWindowHostManager* const window_manager_ GUARDED_BY_CONTEXT(ui_thread_checker_); // Not owned.
