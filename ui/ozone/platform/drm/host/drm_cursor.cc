...
public:
    ...
    void CursorSet(gfx::AcceleratedWidget window, const std::vector<SkBitmap>& bitmaps, const gfx::Point& point, base::TimeDelta frame_delay) override
    {
    }
...
{
    CursorSetLockTested(window_, std::vector<SkBitmap>(), gfx::Point(), base::TimeDelta());
}
...
void DrmCursor::CursorSetLockTested(gfx::AcceleratedWidget window, const std::vector<SkBitmap>& bitmaps, const gfx::Point& point, base::TimeDelta frame_delay)
{
