...
uint32_t IdentifyDirectionV6(int hittest)
{
    ...
    switch (hittest) {
    case HTBOTTOM:
        direction = zxdg_toplevel_v6_resize_edge::ZXDG_TOPLEVEL_V6_RESIZE_EDGE_BOTTOM;
        break;
    case HTBOTTOMLEFT:
        direction = zxdg_toplevel_v6_resize_edge::ZXDG_TOPLEVEL_V6_RESIZE_EDGE_BOTTOM_LEFT;
        break;
    case HTBOTTOMRIGHT:
        direction = zxdg_toplevel_v6_resize_edge::ZXDG_TOPLEVEL_V6_RESIZE_EDGE_BOTTOM_RIGHT;
        break;
    case HTLEFT:
        direction = zxdg_toplevel_v6_resize_edge::ZXDG_TOPLEVEL_V6_RESIZE_EDGE_LEFT;
        break;
    case HTRIGHT:
        direction = zxdg_toplevel_v6_resize_edge::ZXDG_TOPLEVEL_V6_RESIZE_EDGE_RIGHT;
        break;
    case HTTOP:
        direction = zxdg_toplevel_v6_resize_edge::ZXDG_TOPLEVEL_V6_RESIZE_EDGE_TOP;
        break;
    case HTTOPLEFT:
        direction = zxdg_toplevel_v6_resize_edge::ZXDG_TOPLEVEL_V6_RESIZE_EDGE_TOP_LEFT;
        break;
    case HTTOPRIGHT:
        direction = zxdg_toplevel_v6_resize_edge::ZXDG_TOPLEVEL_V6_RESIZE_EDGE_TOP_RIGHT;
        break;
    default:
        direction = zxdg_toplevel_v6_resize_edge::ZXDG_TOPLEVEL_V6_RESIZE_EDGE_NONE;
        break;
    }
    return direction;
}
...
uint32_t IdentifyDirection(const ui::WaylandConnection& connection, int hittest)
{
    if (connection.shell())
...
bool DrawBitmap(const SkBitmap& bitmap, ui::WaylandShmBuffer* out_buffer)
{
    ...
    sk_sp<SkSurface> sk_surface
        = SkSurface::MakeRasterDirect(SkImageInfo::Make(size.width(), size.height(), kColorType, kOpaque_SkAlphaType), mapped_memory, out_buffer->stride());
