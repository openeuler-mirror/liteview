...
class WaylandScopedDisableClientSideDecorationsForTest : public PlatformUtils::ScopedDisableClientSideDecorationsForTest {
public:
...
std::unique_ptr<PlatformUtils::ScopedDisableClientSideDecorationsForTest> WaylandUtils::DisableClientSideDecorationsForTest()
{
