...
public:
    ...
    ZWPTextInputWrapperV1Test& operator=(const ZWPTextInputWrapperV1Test&) = delete;
    ...
    void SetUp() override
    {
        ...
        wrapper_
            = std::make_unique<ZWPTextInputWrapperV1>(connection_.get(), nullptr, connection_->text_input_manager_v1(), connection_->text_input_extension_v1());
        ...
        mock_ext_text_input_ = server_.text_input_extension_v1()->extended_text_input();
...
TEST_P(ZWPTextInputWrapperV1Test, FinalizeVirtualKeyboardChangesShowInputPanel)
{
    InSequence s;
...
TEST_P(ZWPTextInputWrapperV1Test, FinalizeVirtualKeyboardChangesHideInputPanel)
{
    InSequence s;
...
TEST_P(ZWPTextInputWrapperV1Test, FinalizeVirtualKeyboardChangesMultipleInputPanelChanges)
{
    InSequence s;
    EXPECT_CALL(*mock_text_input_, ShowInputPanel());
    EXPECT_CALL(*mock_text_input_, HideInputPanel());
...
INSTANTIATE_TEST_SUITE_P(XdgVersionStableTest, ZWPTextInputWrapperV1Test, Values(wl::ServerConfig { .shell_version = wl::ShellVersion::kStable }));
INSTANTIATE_TEST_SUITE_P(XdgVersionV6Test, ZWPTextInputWrapperV1Test, Values(wl::ServerConfig { .shell_version = wl::ShellVersion::kV6 }));
