...
private:
    ...
    static void OnScale(void* data, struct zaura_output* zaura_output, uint32_t flags, uint32_t scale);
    static void OnConnection(void* data, struct zaura_output* zaura_output, uint32_t connection);
    static void OnDeviceScaleFactor(void* data, struct zaura_output* zaura_output, uint32_t scale);
    static void OnInsets(void* data, struct zaura_output* zaura_output, int32_t top, int32_t left, int32_t bottom, int32_t right);
    static void OnLogicalTransform(void* data, struct zaura_output* zaura_output, int32_t transform);
