...
public:
    ...
    WaylandWindow* origin_window_for_testing()
    {
        return origin_window_;
    }

    absl::optional<DragSource> drag_source()
    {
        return drag_source_;
    }
...
private:
    ...
    FRIEND_TEST_ALL_PREFIXES(WaylandWindowDragControllerTest, HandleDraggedWindowDestructionAfterMoveLoop);
