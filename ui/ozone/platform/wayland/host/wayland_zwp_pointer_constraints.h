...
private:
    ...
    static void OnLock(void* data, struct zwp_locked_pointer_v1* zwp_locked_pointer_v1);
    static void OnUnlock(void* data, struct zwp_locked_pointer_v1* zwp_locked_pointer_v1);
