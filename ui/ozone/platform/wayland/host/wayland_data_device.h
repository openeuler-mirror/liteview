...
public:
    ...
    public:
        ...
        virtual void OnDragEnter(WaylandWindow* window, const gfx::PointF& location, uint32_t serial) = 0;
    ...
    void RequestData(WaylandDataOffer* offer, const std::string& mime_type, RequestDataCallback callback);
...
private:
    ...
    static void OnOffer(void* data, wl_data_device* data_device, wl_data_offer* id);
    ...
    static void OnSelection(void* data, wl_data_device* data_device, wl_data_offer* id);
