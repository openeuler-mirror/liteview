...
void WaylandBufferHandle::OnWlBufferCreated(wl::Object<struct wl_buffer> wl_buffer)
{
...
// static
void WaylandBufferHandle::BufferRelease(void* data, struct wl_buffer* wl_buffer)
{
