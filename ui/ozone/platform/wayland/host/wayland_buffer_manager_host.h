...
public:
    ...
    void CommitOverlays(gfx::AcceleratedWidget widget, uint32_t frame_id, std::vector<wl::WaylandOverlayConfig> overlays) override;
    ...
    void OnPresentation(gfx::AcceleratedWidget widget, uint32_t frame_id, const gfx::PresentationFeedback& feedback);
