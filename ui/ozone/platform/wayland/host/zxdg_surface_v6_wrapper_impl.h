...
public:
    ZXDGSurfaceV6WrapperImpl(WaylandWindow* wayland_window, WaylandConnection* connection);
    ...
    static void Configure(void* data, struct zxdg_surface_v6* zxdg_surface_v6, uint32_t serial);
