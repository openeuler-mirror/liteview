...
{
    static constexpr wl_data_offer_listener kDataOfferListener = { &OnOffer, &OnSourceAction, &OnAction };
...
void WaylandDataOffer::OnSourceAction(void* data, wl_data_offer* offer, uint32_t source_actions)
{
    auto* self = static_cast<WaylandDataOffer*>(data);
