...
public:
    explicit WaylandZcrColorManagementOutput(struct zcr_color_management_output_v1* management_output);
...
private:
    ...
    static void OnColorSpaceChanged(void* data, struct zcr_color_management_output_v1* cmo);
    static void OnExtendedDynamicRange(void* data, struct zcr_color_management_output_v1* cmo, uint32_t value);
