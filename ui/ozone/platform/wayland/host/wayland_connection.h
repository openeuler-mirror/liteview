...
public:
    ...
    zxdg_shell_v6* shell_v6() const
    {
        return shell_v6_.get();
    }
    ...
    WaylandZwpRelativePointerManager* wayland_zwp_relative_pointer_manager() const
    {
    ...
    const gfx::PointF MaybeConvertLocation(const gfx::PointF& location, const WaylandWindow* window) const;
...
private:
    ...
    std::unique_ptr<WaylandZwpPointerConstraints> wayland_zwp_pointer_constraints_;
    std::unique_ptr<WaylandZwpRelativePointerManager> wayland_zwp_relative_pointer_manager_;
