...
private:
    ...
    void HandleAuraToplevelConfigure(int32_t x, int32_t y, int32_t width, int32_t height, const WindowStates& window_states) override;
    ...
    static void OcclusionChanged(void* data, zaura_surface* surface, wl_fixed_t occlusion_fraction, uint32_t occlusion_reason);
    static void LockFrame(void* data, zaura_surface* surface);
    static void UnlockFrame(void* data, zaura_surface* surface);
    static void OcclusionStateChanged(void* data, zaura_surface* surface, uint32_t mode);
