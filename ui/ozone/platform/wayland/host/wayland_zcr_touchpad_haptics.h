...
private:
    ...
    static void OnActivated(void* data, struct zcr_touchpad_haptics_v1* zcr_touchpad_haptics_v1);
    static void OnDeactivated(void* data, struct zcr_touchpad_haptics_v1* zcr_touchpad_haptics_v1);
