...
GSourceFuncs WatchSourceFuncs = { WatchSourcePrepare, WatchSourceCheck, WatchSourceDispatch, nullptr };

} // namespace

WaylandEventWatcherGlib::WaylandEventWatcherGlib(wl_display* display, wl_event_queue* event_queue)
...
// static
std::unique_ptr<WaylandEventWatcher> WaylandEventWatcher::CreateWaylandEventWatcher(wl_display* display, wl_event_queue* event_queue)
{
