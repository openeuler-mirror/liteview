...
public:
    ...
    virtual void OnPreeditString(base::StringPiece text, const std::vector<SpanStyle>& spans, int32_t preedit_cursor) = 0;
...
public:
    ...
    virtual void SetSurroundingText(const std::string& text, const gfx::Range& selection_range) = 0;
    virtual void SetContentType(ui::TextInputType type, ui::TextInputMode mode, uint32_t flags, bool should_do_learning) = 0;
