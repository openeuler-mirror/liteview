...
public:
    ZXDGToplevelV6WrapperImpl(std::unique_ptr<ZXDGSurfaceV6WrapperImpl> surface, WaylandWindow* wayland_window, WaylandConnection* connection);
    ZXDGToplevelV6WrapperImpl(const ZXDGToplevelV6WrapperImpl&) = delete;
    ZXDGToplevelV6WrapperImpl& operator=(const ZXDGToplevelV6WrapperImpl&) = delete;
    ...
    void SetRestoreInfo(int32_t restore_session_id, int32_t restore_window_id) override;
    void SetRestoreInfoWithWindowIdSource(int32_t restore_session_id, const std::string& restore_window_id_source) override;
...
private:
    ...
    static void ConfigureTopLevel(void* data, struct zxdg_toplevel_v6* zxdg_toplevel_v6, int32_t width, int32_t height, struct wl_array* states);
    static void CloseTopLevel(void* data, struct zxdg_toplevel_v6* zxdg_toplevel_v6);
