...
public:
    ...
    virtual void SetRestoreInfo(int32_t restore_session_id, int32_t restore_window_id) = 0;

    virtual void SetRestoreInfoWithWindowIdSource(int32_t restore_session_id, const std::string& restore_window_id_source) = 0;
