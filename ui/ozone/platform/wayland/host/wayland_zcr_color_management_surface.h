...
public:
    explicit WaylandZcrColorManagementSurface(struct zcr_color_management_surface_v1* management_surface, WaylandConnection* connection);
...
private:
    ...
    static void OnPreferredColorSpace(void* data, struct zcr_color_management_surface_v1* cms, struct wl_output* output);
