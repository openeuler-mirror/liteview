...
private:
    ...
    static void OutputHandleLogicalPosition(void* data, struct zxdg_output_v1* zxdg_output_v1, int32_t x, int32_t y);
    static void OutputHandleLogicalSize(void* data, struct zxdg_output_v1* zxdg_output_v1, int32_t width, int32_t height);
    static void OutputHandleDone(void* data, struct zxdg_output_v1* zxdg_output_v1);
    static void OutputHandleName(void* data, struct zxdg_output_v1* zxdg_output_v1, const char* name);
    static void OutputHandleDescription(void* data, struct zxdg_output_v1* zxdg_output_v1, const char* description);
