...
public:
    ...
    void OnOutputAddedOrUpdated(uint32_t output_id, const gfx::Point& origin, const gfx::Size& logical_size, const gfx::Size& physical_size,
...
private:
    ...
    void AddOrUpdateDisplay(uint32_t output_id, const gfx::Point& origin, const gfx::Size& logical_size, const gfx::Size& physical_size,
        const gfx::Insets& insets, float scale, int32_t panel_transform, int32_t logical_transform, const std::string& label);
