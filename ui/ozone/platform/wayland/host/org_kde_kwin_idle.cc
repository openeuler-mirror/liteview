...
private:
    static void Idle(void* data, struct org_kde_kwin_idle_timeout* org_kde_kwin_idle_timeout);
    static void Resumed(void* data, struct org_kde_kwin_idle_timeout* org_kde_kwin_idle_timeout);
...
OrgKdeKwinIdle::Timeout::Timeout(org_kde_kwin_idle_timeout* timeout)
    : timeout_(timeout)
{
    static constexpr org_kde_kwin_idle_timeout_listener kTimeoutListener = { &Idle, &Resumed };
...
// static
void OrgKdeKwinIdle::Timeout::Idle(void* data, struct org_kde_kwin_idle_timeout* org_kde_kwin_idle_timeout)
{
...
// static
void OrgKdeKwinIdle::Timeout::Resumed(void* data, struct org_kde_kwin_idle_timeout* org_kde_kwin_idle_timeout)
{
    auto* self = static_cast<OrgKdeKwinIdle::Timeout*>(data);
