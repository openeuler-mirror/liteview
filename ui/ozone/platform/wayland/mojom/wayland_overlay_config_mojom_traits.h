...
template <> struct StructTraits<wl::mojom::WaylandOverlayConfigDataView, wl::WaylandOverlayConfig> {
    ...
    static const gfx::ColorSpace color_space(const wl::WaylandOverlayConfig& input)
    {
        return input.color_space;
    }

    static const gfx::OverlayTransform& transform(const wl::WaylandOverlayConfig& input)
    {
    ...
    static const gfx::RRectF& rounded_clip_bounds(const wl::WaylandOverlayConfig& input)
    {
        return input.rounded_clip_bounds;
    }

    static const absl::optional<SkColor4f>& background_color(const wl::WaylandOverlayConfig& input)
    {
        return input.background_color;
    }

    static const absl::optional<gfx::Rect>& clip_rect(const wl::WaylandOverlayConfig& input)
    {
