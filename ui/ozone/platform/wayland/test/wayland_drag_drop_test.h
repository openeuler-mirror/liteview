...
class WaylandDragDropTest : public WaylandTest, public wl::TestDataDevice::DragDelegate {
public:
    WaylandDragDropTest();
    ...
    void ReadData(const std::string& mime_type, wl::TestDataSource::ReadDataCallback callback);
    ...
    MOCK_METHOD3(MockStartDrag, void(wl::TestDataSource* source, wl::MockSurface* origin, uint32_t serial));
...
protected:
    ...
    void StartDrag(wl::TestDataSource* source, wl::MockSurface* origin, uint32_t serial) override;
