...
struct GtkPrimarySelectionDevice final : public TestSelectionDevice::Delegate {
    TestSelectionOffer* CreateAndSendOffer() override
    {
        ...
        wl_resource* new_offer_resource = CreateResourceWithImpl<TestSelectionOffer>(
            wl_resource_get_client(device->resource()), &gtk_primary_selection_offer_interface, version, &kOfferImpl, 0, delegate);
...
struct GtkPrimarySelectionDeviceManager : public TestSelectionDeviceManager::Delegate {
    ...
    TestSelectionDevice* CreateDevice(wl_client* client, uint32_t id) override
    {
        ...
        wl_resource* resource
            = CreateResourceWithImpl<TestSelectionDevice>(client, &gtk_primary_selection_device_interface, version_, &kTestSelectionDeviceImpl, id, delegate);
    ...
    TestSelectionSource* CreateSource(wl_client* client, uint32_t id) override
    {
        ...
        wl_resource* resource
            = CreateResourceWithImpl<TestSelectionSource>(client, &gtk_primary_selection_source_interface, version_, &kTestSelectionSourceImpl, id, delegate);
...
TestSelectionDeviceManager* CreateTestSelectionManagerGtk()
{
    ...
    return new TestSelectionDeviceManager(interface_info, new GtkPrimarySelectionDeviceManager(kVersion));
}
