...
void GetAuraOutput(wl_client* client, wl_resource* resource, uint32_t id, wl_resource* output_resource)
{
    wl_resource* zaura_output_resource
        = CreateResourceWithImpl<TestZAuraOutput>(client, &zaura_output_interface, kZAuraOutputVersion, &kTestZAuraToplevelImpl, id);
...
MockZAuraShell::MockZAuraShell()
    : GlobalObject(&zaura_shell_interface, &kMockZAuraShellImpl, kZAuraShellVersion)
{
}
