...
void SetRestoreInfo(struct wl_client* client, struct wl_resource* resource, int32_t restore_session_id, int32_t restore_window_id)
{
    NOTREACHED();
}
...
void SetRestoreInfoWithWindowIdSource(struct wl_client* client, struct wl_resource* resource, int32_t restore_session_id, const char* restore_window_id_source)
{
    NOTREACHED();
}
