...
void TestOutput::Flush()
{
    ...
    if (pending_rect_ || pending_transform_) {
        ...
        wl_output_send_geometry(
            resource(), rect_.x(), rect_.y(), 0 /* physical_width */, 0 /* physical_height */, 0 /* subpixel */, kUnknownMake, kUnknownModel, transform_);
        wl_output_send_mode(resource(), WL_OUTPUT_MODE_CURRENT, rect_.width(), rect_.height(), 0);
    }
