...
struct ZwpPrimarySelectionDevice final : public TestSelectionDevice::Delegate {
    TestSelectionOffer* CreateAndSendOffer() override
    {
        ...
        wl_resource* new_offer_resource = CreateResourceWithImpl<TestSelectionOffer>(
            wl_resource_get_client(device->resource()), &zwp_primary_selection_offer_v1_interface, version, &kOfferImpl, 0, delegate);
...
struct ZwpPrimarySelectionDeviceManager : public TestSelectionDeviceManager::Delegate {
    ...
    TestSelectionDevice* CreateDevice(wl_client* client, uint32_t id) override
    {
        ...
        wl_resource* resource = CreateResourceWithImpl<TestSelectionDevice>(
            client, &zwp_primary_selection_device_v1_interface, version_, &kTestSelectionDeviceImpl, id, delegate);
    ...
    TestSelectionSource* CreateSource(wl_client* client, uint32_t id) override
    {
        ...
        wl_resource* resource = CreateResourceWithImpl<TestSelectionSource>(
            client, &zwp_primary_selection_source_v1_interface, version_, &kTestSelectionSourceImpl, id, delegate);
...
TestSelectionDeviceManager* CreateTestSelectionManagerZwp()
{
    ...
    return new TestSelectionDeviceManager(interface_info, new ZwpPrimarySelectionDeviceManager(kVersion));
}
