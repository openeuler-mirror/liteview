...
gfx::SwapResult GLSurfaceEglReadbackWayland::SwapBuffers(PresentationCallback callback, gl::FrameData data)
{
    NOTREACHED();
    return gfx::SwapResult::SWAP_FAILED;
}

void GLSurfaceEglReadbackWayland::SwapBuffersAsync(SwapCompletionCallback completion_callback, PresentationCallback presentation_callback, gl::FrameData data)
{
    ...
    buffer_manager_->CommitBuffer(widget_, next_buffer->buffer_id_,
        /*frame_id*/ next_buffer->buffer_id_, bounds, gfx::RoundedCornersF(), surface_scale_factor_, bounds);
}
