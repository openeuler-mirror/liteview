...
public:
    ...
    void Initialize(mojo::PendingRemote<ozone::mojom::WaylandBufferManagerHost> remote_host,
        ...
        bool supports_acquire_fence, uint32_t supported_surface_augmentor_version) override;
    ...
    void OnSubmission(gfx::AcceleratedWidget widget, uint32_t frame_id, gfx::SwapResult swap_result, gfx::GpuFenceHandle release_fence_handle) override;
    void OnPresentation(gfx::AcceleratedWidget widget, uint32_t frame_id, const gfx::PresentationFeedback& feedback) override;
    ...
    // buffer.
    void CommitBuffer(gfx::AcceleratedWidget widget, uint32_t frame_id, uint32_t buffer_id, const gfx::Rect& bounds_rect, const gfx::RoundedCornersF& corners,
        float surface_scale_factor, const gfx::Rect& damage_region);
    // Send overlay configurations for a frame to a WaylandWindow identified by
    // |widget|.
    void CommitOverlays(gfx::AcceleratedWidget widget, uint32_t frame_id, std::vector<wl::WaylandOverlayConfig> overlays);
...
private:
    ...
    void SubmitSwapResultOnOriginThread(gfx::AcceleratedWidget widget, uint32_t frame_id, gfx::SwapResult swap_result, gfx::GpuFenceHandle release_fence);
    void SubmitPresentationOnOriginThread(gfx::AcceleratedWidget widget, uint32_t frame_id, const gfx::PresentationFeedback& feedback);
    ...
    void CommitOverlaysTask(gfx::AcceleratedWidget widget, uint32_t frame_id, std::vector<wl::WaylandOverlayConfig> overlays);
    ...
    std::map<gfx::AcceleratedWidget, WaylandSurfaceGpu*> widget_to_surface_map_; // Guarded by |lock_|.
