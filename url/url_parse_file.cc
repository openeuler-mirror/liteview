...
template <typename CHAR> void DoParseUNC(const CHAR* spec, int after_slashes, int spec_len, Parsed* parsed)
{
...
template <typename CHAR> void DoParseLocalFile(const CHAR* spec, int path_begin, int spec_len, Parsed* parsed)
{
    parsed->host.reset();
...
template <typename CHAR> void DoParseFileURL(const CHAR* spec, int spec_len, Parsed* parsed)
{
    DCHECK(spec_len >= 0);
...
void ParseFileURL(const char* url, int url_len, Parsed* parsed) { DoParseFileURL(url, url_len, parsed); }

void ParseFileURL(const char16_t* url, int url_len, Parsed* parsed) { DoParseFileURL(url, url_len, parsed); }
