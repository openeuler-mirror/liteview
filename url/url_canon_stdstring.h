...
template <typename CharT> class StringPieceReplacements : public Replacements<CharT> {
private:
    ...
    void SetImpl(SetterFun fun, StringPieceT str) { (this->*fun)(str.data(), Component(0, static_cast<int>(str.size()))); }
