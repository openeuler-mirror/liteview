...
COMPONENT_EXPORT(URL)
void ParsePathURL(const char16_t* url, int url_len, bool trim_path_end, Parsed* parsed);
...
COMPONENT_EXPORT(URL)
bool ExtractQueryKeyValue(const char16_t* url, Component* query, Component* key, Component* value);
