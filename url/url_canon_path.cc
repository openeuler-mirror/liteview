...
const unsigned char kPathCharLookup[0x100] = {
    ...
    ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE,
    ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE,
    ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE,
    ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE,
    ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE,
    ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE
};
...
// was just unescaped.
template <typename CHAR> void CheckForNestedEscapes(const CHAR* spec, size_t next_input_index, size_t input_len, size_t last_invalid_percent_index, CanonOutput* output)
{
...
template <typename CHAR, typename UCHAR> bool DoPartialPathInternal(const CHAR* spec, const Component& path, size_t path_begin_in_output, CanonOutput* output)
{
    if (!path.is_nonempty())
        return true;
                ...
                if ((dotlen = IsDot(spec, i, end)) > 0) {
                    ...
                    if (DecodeEscaped(spec, &i, end, &unescaped_value)) {
                        ...
                        if (unescaped_flags & UNESCAPE) {
                            ...
                            if (last_invalid_percent_index.has_value() && ((last_invalid_percent_index.value() + 3) >= output->length())) {
                                CheckForNestedEscapes(spec, i + 1, end, last_invalid_percent_index.value(), output);
                            }
                        } else {
...
template <typename CHAR, typename UCHAR> bool DoPartialPath(const CHAR* spec, const Component& path, CanonOutput* output, Component* out_path)
{
    ...
    bool success = DoPartialPathInternal<CHAR, UCHAR>(spec, path, out_path->begin, output);
    out_path->len = output->length() - out_path->begin;
    return success;
}

template <typename CHAR, typename UCHAR> bool DoPath(const CHAR* spec, const Component& path, CanonOutput* output, Component* out_path)
{
    bool success = true;
    out_path->begin = output->length();
    if (path.len > 0) {
        ...
        success = DoPartialPathInternal<CHAR, UCHAR>(spec, path, out_path->begin, output);
    } else {
...
bool CanonicalizePath(const char* spec, const Component& path, CanonOutput* output, Component* out_path) { return DoPath<char, unsigned char>(spec, path, output, out_path); }

bool CanonicalizePath(const char16_t* spec, const Component& path, CanonOutput* output, Component* out_path) { return DoPath<char16_t, char16_t>(spec, path, output, out_path); }
...
bool CanonicalizePartialPathInternal(const char* spec, const Component& path, size_t path_begin_in_output, CanonOutput* output)
{
    return DoPartialPathInternal<char, unsigned char>(spec, path, path_begin_in_output, output);
}

bool CanonicalizePartialPathInternal(const char16_t* spec, const Component& path, size_t path_begin_in_output, CanonOutput* output)
{
    return DoPartialPathInternal<char16_t, char16_t>(spec, path, path_begin_in_output, output);
}
