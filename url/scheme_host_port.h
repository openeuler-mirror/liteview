...
public:
    ...
    SchemeHostPort(base::StringPiece scheme, base::StringPiece host, uint16_t port);
    ...
    bool operator==(const SchemeHostPort& other) const { return port_ == other.port() && scheme_ == other.scheme() && host_ == other.host(); }
