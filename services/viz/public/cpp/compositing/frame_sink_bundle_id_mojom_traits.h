...
template <> struct StructTraits<viz::mojom::FrameSinkBundleIdDataView, viz::FrameSinkBundleId> {
    static uint32_t client_id(const viz::FrameSinkBundleId& frame_sink_id) { return frame_sink_id.client_id(); }

    static uint32_t bundle_id(const viz::FrameSinkBundleId& frame_sink_id) { return frame_sink_id.bundle_id(); }
