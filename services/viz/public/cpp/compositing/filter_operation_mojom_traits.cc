...
// static
viz::mojom::FilterType StructTraits<viz::mojom::FilterOperationDataView, cc::FilterOperation>::type(const cc::FilterOperation& op) { return CCFilterTypeToMojo(op.type()); }
...
bool StructTraits<viz::mojom::FilterOperationDataView, cc::FilterOperation>::Read(viz::mojom::FilterOperationDataView data, cc::FilterOperation* out)
{
    ...
    case cc::FilterOperation::DROP_SHADOW: {
        ...
        if (!data.ReadDropShadowOffset(&offset) || !data.ReadDropShadowColor(&drop_shadow_color))
            return false;
