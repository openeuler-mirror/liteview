...
template <> struct UnionTraits<viz::mojom::DrawQuadStateDataView, viz::DrawQuad> {
    ...
    static const viz::DrawQuad& debug_border_quad_state(const viz::DrawQuad& quad) { return quad; }

    static const viz::DrawQuad& render_pass_quad_state(const viz::DrawQuad& quad) { return quad; }

    static const viz::DrawQuad& solid_color_quad_state(const viz::DrawQuad& quad) { return quad; }

    static const viz::DrawQuad& surface_quad_state(const viz::DrawQuad& quad) { return quad; }

    static const viz::DrawQuad& texture_quad_state(const viz::DrawQuad& quad) { return quad; }

    static const viz::DrawQuad& tile_quad_state(const viz::DrawQuad& quad) { return quad; }

    static const viz::DrawQuad& stream_video_quad_state(const viz::DrawQuad& quad) { return quad; }

    static const viz::DrawQuad& video_hole_quad_state(const viz::DrawQuad& quad) { return quad; }

    static const viz::DrawQuad& yuv_video_quad_state(const viz::DrawQuad& quad) { return quad; }

    static const viz::DrawQuad& shared_element_quad_state(const viz::DrawQuad& quad) { return quad; }
...
template <> struct StructTraits<viz::mojom::SharedElementQuadStateDataView, viz::DrawQuad> {
    static const viz::SharedElementResourceId& resource_id(const viz::DrawQuad& input)
    {
...
template <> struct StructTraits<viz::mojom::TextureQuadStateDataView, viz::DrawQuad> {
    ...
    static const absl::optional<gfx::HDRMetadata> hdr_metadata(const viz::DrawQuad& input)
    {
        const viz::TextureDrawQuad* quad = viz::TextureDrawQuad::MaterialCast(&input);
    ...
    static const absl::optional<gfx::Rect>& damage_rect(const viz::DrawQuad& input)
    {
        const viz::TextureDrawQuad* quad = viz::TextureDrawQuad::MaterialCast(&input);
...
template <> struct StructTraits<viz::mojom::YUVVideoQuadStateDataView, viz::DrawQuad> {
    static const gfx::Size& coded_size(const viz::DrawQuad& input)
    {
        const viz::YUVVideoDrawQuad* quad = viz::YUVVideoDrawQuad::MaterialCast(&input);
    ...
    static bool Read(viz::mojom::YUVVideoQuadStateDataView data, viz::DrawQuad* out);
};
...
template <> struct StructTraits<viz::mojom::DrawQuadDataView, DrawQuadWithSharedQuadState> {
    static const gfx::Rect& rect(const DrawQuadWithSharedQuadState& input) { return input.quad->rect; }

    static const gfx::Rect& visible_rect(const DrawQuadWithSharedQuadState& input) { return input.quad->visible_rect; }

    static bool needs_blending(const DrawQuadWithSharedQuadState& input) { return input.quad->needs_blending; }

    static OptSharedQuadState sqs(const DrawQuadWithSharedQuadState& input) { return { input.shared_quad_state }; }

    static const viz::DrawQuad& draw_quad_state(const DrawQuadWithSharedQuadState& input) { return *input.quad; }
};
...
template <> struct ArrayTraits<viz::QuadList> {
    ...
    static ConstIterator GetBegin(const viz::QuadList& input) { return ConstIterator(input.begin()); }
