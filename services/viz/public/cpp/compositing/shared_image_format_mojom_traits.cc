...
// static
bool EnumTraits<viz::mojom::PlaneConfig, viz::SharedImageFormat::PlaneConfig>::FromMojom(viz::mojom::PlaneConfig input, viz::SharedImageFormat::PlaneConfig* out)
{
    switch (input) {
...
// static
bool EnumTraits<viz::mojom::Subsampling, viz::SharedImageFormat::Subsampling>::FromMojom(viz::mojom::Subsampling input, viz::SharedImageFormat::Subsampling* out)
{
    switch (input) {
...
// static
viz::mojom::ChannelFormat EnumTraits<viz::mojom::ChannelFormat, viz::SharedImageFormat::ChannelFormat>::ToMojom(viz::SharedImageFormat::ChannelFormat channel_format)
{
...
// static
bool EnumTraits<viz::mojom::ChannelFormat, viz::SharedImageFormat::ChannelFormat>::FromMojom(viz::mojom::ChannelFormat input, viz::SharedImageFormat::ChannelFormat* out)
{
    switch (input) {
