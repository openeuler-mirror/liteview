...
// static
viz::mojom::BeginFrameArgsType EnumTraits<viz::mojom::BeginFrameArgsType, viz::BeginFrameArgs::BeginFrameArgsType>::ToMojom(viz::BeginFrameArgs::BeginFrameArgsType type)
{
    switch (type) {
