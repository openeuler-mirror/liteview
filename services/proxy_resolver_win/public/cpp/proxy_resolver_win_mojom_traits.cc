...
// static
bool EnumTraits<proxy_resolver_win::mojom::WinHttpStatus, net::WinHttpStatus>::FromMojom(proxy_resolver_win::mojom::WinHttpStatus input, net::WinHttpStatus* output)
{
    switch (input) {
