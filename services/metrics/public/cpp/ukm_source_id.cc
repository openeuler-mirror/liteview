...
int64_t GetNumTypeBits() { return std::ceil(std::log2(static_cast<int64_t>(SourceIdObj::Type::kMaxValue) + 1)); }
...
SourceId AssignNewSourceId() { return ukm::SourceIdObj::New().ToInt64(); }
...
SourceIdType GetSourceIdType(SourceId source_id) { return ukm::SourceIdObj::FromInt64(source_id).GetType(); }
