...
// static
proxy_resolver::mojom::HostResolveOperation EnumTraits<proxy_resolver::mojom::HostResolveOperation, net::ProxyResolveDnsOperation>::ToMojom(net::ProxyResolveDnsOperation input)
{
    switch (input) {
