...
void TestRequestClient::ResolveDns(const std::string& hostname, net::ProxyResolveDnsOperation operation, const net::NetworkAnonymizationKey& network_anonymization_key,
    mojo::PendingRemote<mojom::HostResolverRequestClient> client)
{
}

void TestRequestClient::OnDisconnect() { event_waiter_.NotifyEvent(CONNECTION_ERROR); }
...
public:
    ...
    struct Job {
        ...
        void SetCallback(net::CompletionOnceCallback callback) { callback_ = std::move(callback); }
    ...
    public:
        ...
        net::LoadState GetLoadState() override { return net::LOAD_STATE_RESOLVING_PROXY_FOR_URL; }
    ...
    const std::vector<std::unique_ptr<Job>>& pending_jobs() { return pending_jobs_; }
