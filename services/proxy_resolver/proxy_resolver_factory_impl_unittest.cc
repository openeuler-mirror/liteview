...
public:
    ...
    void ReportResult(int32_t error) override { std::move(create_callback_).Run(error); }
    ...
    void set_idle_callback(base::OnceClosure callback) { idle_callback_ = std::move(callback); }
