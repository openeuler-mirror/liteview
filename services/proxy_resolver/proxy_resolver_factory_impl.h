...
protected:
    // Visible for tests.
    ProxyResolverFactoryImpl(mojo::PendingReceiver<mojom::ProxyResolverFactory> receiver, std::unique_ptr<ProxyResolverV8TracingFactory> proxy_resolver_factory);
...
private:
    ...
    void CreateResolver(
        const std::string& pac_script, mojo::PendingReceiver<mojom::ProxyResolver> receiver, mojo::PendingRemote<mojom::ProxyResolverFactoryRequestClient> client) override;
