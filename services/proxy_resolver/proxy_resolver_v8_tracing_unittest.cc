...
public:
    ...
    void Alert(const std::u16string& message) { alerts_.push_back(base::UTF16ToASCII(message)); }
    ...
    std::unique_ptr<ProxyResolverV8Tracing::Bindings> CreateBindings() { return std::make_unique<ForwardingBindings>(this); }
...
TEST_F(ProxyResolverV8TracingTest, JavascriptError)
{
    ...
    std::unique_ptr<net::ProxyResolver::Request> req;
    resolver->GetProxyForURL(GURL("http://throw-an-error/"), net::NetworkAnonymizationKey(), &proxy_info, callback.callback(), &req, mock_bindings.CreateBindings());
...
TEST_F(ProxyResolverV8TracingTest, Dns)
{
    ...
    host_resolver.SetResult(net::GetHostName(), net::ProxyResolveDnsOperation::MY_IP_ADDRESS, net::NetworkAnonymizationKey(), { net::IPAddress(122, 133, 144, 155) });
    host_resolver.SetResult(net::GetHostName(), net::ProxyResolveDnsOperation::MY_IP_ADDRESS_EX, net::NetworkAnonymizationKey(), { net::IPAddress(133, 122, 100, 200) });
    ...
    host_resolver.SetResult("host1", net::ProxyResolveDnsOperation::DNS_RESOLVE_EX, net::NetworkAnonymizationKey(), { v6_local, net::IPAddress(192, 168, 1, 1) });
...
TEST_F(ProxyResolverV8TracingTest, InfiniteDNSSequence)
{
    ...
    for (int i = 0; i < 21; ++i) {
        host_resolver.SetResult(
            "host" + base::NumberToString(i), net::ProxyResolveDnsOperation::DNS_RESOLVE, net::NetworkAnonymizationKey(), { net::IPAddress(166, 155, 144, 11) });
    }
...
TEST_F(ProxyResolverV8TracingTest, CancelAll)
{
    ...
    for (size_t i = 0; i < kNumRequests; ++i) {
        resolver->GetProxyForURL(GURL("http://foo/"), net::NetworkAnonymizationKey(), &proxy_info[i], base::BindOnce(&CrashCallback), &request[i], mock_bindings.CreateBindings());
    }
...
TEST_F(ProxyResolverV8TracingTest, CancelSome)
{
    ...
    resolver->GetProxyForURL(GURL("http://foo/"), net::NetworkAnonymizationKey(), &proxy_info1, base::BindOnce(&CrashCallback), &request1, mock_bindings.CreateBindings());
...
TEST_F(ProxyResolverV8TracingTest, CancelWhilePendingCompletionTask)
{
    ...
    resolver->GetProxyForURL(
        GURL("http://throw-an-error/"), net::NetworkAnonymizationKey(), &proxy_info1, base::BindOnce(&CrashCallback), &request1, mock_bindings.CreateBindings());
    ...
    resolver->GetProxyForURL(
        GURL("http://i-have-no-idea-what-im-doing/"), net::NetworkAnonymizationKey(), &proxy_info2, callback.callback(), &request2, mock_bindings.CreateBindings());
...
TEST_F(ProxyResolverV8TracingTest, CancelWhileOutstandingNonBlockingDns)
{
    ...
    resolver->GetProxyForURL(GURL("http://foo/req1"), net::NetworkAnonymizationKey(), &proxy_info1, base::BindOnce(&CrashCallback), &request1, mock_bindings.CreateBindings());

    run_loop1.Run();

    base::RunLoop run_loop2;
    host_resolver.set_hang_callback(run_loop2.QuitClosure());
    resolver->GetProxyForURL(GURL("http://foo/req2"), net::NetworkAnonymizationKey(), &proxy_info2, base::BindOnce(&CrashCallback), &request2, mock_bindings.CreateBindings());
...
TEST_F(ProxyResolverV8TracingTest, CancelWhileBlockedInNonBlockingDns)
{
    ...
    resolver->GetProxyForURL(GURL("http://foo/"), net::NetworkAnonymizationKey(), &proxy_info, base::BindOnce(&CrashCallback), &request, mock_bindings.CreateBindings());
...
TEST_F(ProxyResolverV8TracingTest, CancelCreateResolverWhileOutstandingBlockingDns)
{
    ...
    std::unique_ptr<ProxyResolverV8Tracing> resolver;
    std::unique_ptr<net::ProxyResolverFactory::Request> request;
    factory->CreateProxyResolverV8Tracing(LoadScriptData("dns_during_init.js"), mock_bindings.CreateBindings(), &resolver, base::BindOnce(&CrashCallback), &request);
...
TEST_F(ProxyResolverV8TracingTest, MultipleResolvers)
{
    ...
    host_resolver0.SetResult(net::GetHostName(), net::ProxyResolveDnsOperation::MY_IP_ADDRESS, net::NetworkAnonymizationKey(), { net::IPAddress(122, 133, 144, 155) });
    host_resolver0.SetResult(net::GetHostName(), net::ProxyResolveDnsOperation::MY_IP_ADDRESS_EX, net::NetworkAnonymizationKey(), { net::IPAddress(133, 122, 100, 200) });
    ...
    net::IPAddress v6_local;
    ASSERT_TRUE(v6_local.AssignFromIPLiteral("::1"));
    host_resolver0.SetResult("host1", net::ProxyResolveDnsOperation::DNS_RESOLVE_EX, net::NetworkAnonymizationKey(), { v6_local, net::IPAddress(192, 168, 1, 1) });
...
TEST_F(ProxyResolverV8TracingTest, MyIPAddressWithNetworkAnonymizationKey)
{
    ...
    host_resolver.SetResult(net::GetHostName(), net::ProxyResolveDnsOperation::MY_IP_ADDRESS_EX, net::NetworkAnonymizationKey(), { net::IPAddress(5, 6, 7, 8) });
