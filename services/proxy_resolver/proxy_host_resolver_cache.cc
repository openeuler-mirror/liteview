...
void ProxyHostResolverCache::StoreEntry(std::string hostname, net::NetworkAnonymizationKey network_anonymization_key, bool is_ex_operation, std::vector<net::IPAddress> results)
{
...
const std::vector<net::IPAddress>* ProxyHostResolverCache::LookupEntry(std::string hostname, net::NetworkAnonymizationKey network_anonymization_key, bool is_ex_operation)
{
    Key key { std::move(hostname), std::move(network_anonymization_key), is_ex_operation };
