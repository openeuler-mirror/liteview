...
bool CheckCSPSource(const mojom::CSPSource& source, const GURL& url, const mojom::CSPSource& self_source, bool has_followed_redirect = false, bool is_opaque_fenced_frame = false);
