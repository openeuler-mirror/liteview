...
// static
network::mojom::ReportingApiReportStatus EnumTraits<network::mojom::ReportingApiReportStatus, net::ReportingReport::Status>::ToMojom(net::ReportingReport::Status input)
{
    switch (input) {
...
// static
bool StructTraits<network::mojom::ReportingApiReportDataView, net::ReportingReport>::Read(network::mojom::ReportingApiReportDataView data, net::ReportingReport* out)
{
