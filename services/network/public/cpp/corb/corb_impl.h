...
public:
    ...
    private:
        ...
        bool needs_sniffing() const { return should_block_based_on_headers_ == Decision::kSniffMore || corb_protection_logging_needs_sniffing_; }
        ...
        static Decision ShouldBlockBasedOnHeaders(mojom::RequestMode request_mode, const GURL& request_url, const absl::optional<url::Origin>& request_initiator,
            const network::mojom::URLResponseHead& response, MimeType canonical_mime_type);
