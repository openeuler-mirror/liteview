...
constexpr char kTrustTokensSecTrustTokenVersionHeader[] = "Sec-Trust-Token-Version";
...
constexpr char kTrustTokensRequestHeaderSecTrustTokensAdditionalSigningData[] = "Sec-Trust-Tokens-Additional-Signing-Data";

// A response header, asks UA to discard all previously issued tokens when
// value is "all", ignored otherwise.
constexpr char kTrustTokensResponseHeaderSecTrustTokenClearData[] = "Sec-Trust-Token-Clear-Data";
...
constexpr char kTrustTokensResponseHeaderSecTrustTokenLifetime[] = "Sec-Trust-Token-Lifetime";
