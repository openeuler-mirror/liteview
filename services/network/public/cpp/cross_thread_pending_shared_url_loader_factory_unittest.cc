...
public:
    ...
    void Clone(mojo::PendingReceiver<mojom::URLLoaderFactory> receiver) override { EXPECT_TRUE(owning_thread_->RunsTasksInCurrentSequence()); }
...
protected:
    void SetUp() override
    {
        ...
        loader_thread_->PostTaskAndReply(
            FROM_HERE, base::BindOnce(&CrossThreadPendingSharedURLLoaderFactoryTest::SetupFactoryInfoOnLoaderThread, base::Unretained(this)), run_loop.QuitClosure());
        run_loop.Run();
    }
    ...
    void TearDown() override
    {
        ...
        base::RunLoop run_loop;
        loader_thread_->PostTaskAndReply(
            FROM_HERE, base::BindOnce(&CrossThreadPendingSharedURLLoaderFactoryTest::ReleaseSharedFactoryOnLoaderThread, base::Unretained(this)), run_loop.QuitClosure());
        run_loop.Run();
    }

    void CheckLoaderThread(const ResourceRequest& request) { EXPECT_TRUE(loader_thread_->RunsTasksInCurrentSequence()); }
