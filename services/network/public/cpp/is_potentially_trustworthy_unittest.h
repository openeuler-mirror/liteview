...
protected:
    ...
    bool IsOriginPotentiallyTrustworthy(const OriginType& origin) { return TTrustworthinessTraits::IsOriginPotentiallyTrustworthy(origin); }
    ...
    bool IsUrlPotentiallyTrustworthy(base::StringPiece str) { return TTrustworthinessTraits::IsUrlPotentiallyTrustworthy(str); }
    bool IsOriginOfLocalhost(const OriginType& origin) { return TTrustworthinessTraits::IsOriginOfLocalhost(origin); }
};
...
TYPED_TEST_P(AbstractTrustworthinessTest, OriginFromString)
{
    ...
    EXPECT_TRUE(this->IsOriginPotentiallyTrustworthy("quic-transport://example.com/counter"));
}
...
TYPED_TEST_P(AbstractTrustworthinessTest, UrlFromString)
{
    ...
    EXPECT_TRUE(this->IsUrlPotentiallyTrustworthy("quic-transport://example.com/counter"));
...
REGISTER_TYPED_TEST_SUITE_P(AbstractTrustworthinessTest, OpaqueOrigins, OriginFromString, CustomSchemes, UrlFromString, TestcasesInheritedFromBlink, IsTrustworthyWithPattern);
