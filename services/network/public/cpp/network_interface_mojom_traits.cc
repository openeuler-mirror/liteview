...
bool StructTraits<network::mojom::NetworkInterfaceDataView, net::NetworkInterface>::Read(network::mojom::NetworkInterfaceDataView data, net::NetworkInterface* out)
{
...
network::mojom::ConnectionType EnumTraits<network::mojom::ConnectionType, net::NetworkChangeNotifier::ConnectionType>::ToMojom(net::NetworkChangeNotifier::ConnectionType input)
{
    switch (input) {
