...
absl::optional<std::vector<network::mojom::WebClientHintsType>> COMPONENT_EXPORT(NETWORK_CPP) ParseClientHintsHeader(const std::string& header);
...
const ClientHintToDelegatedThirdPartiesHeader COMPONENT_EXPORT(NETWORK_CPP) ParseClientHintToDelegatedThirdPartiesHeader(const std::string& header, MetaCHType type);
