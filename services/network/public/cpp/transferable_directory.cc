...
TransferableDirectory::TransferableDirectory(TransferableDirectory&& other) { *this = std::move(other); }
...
const base::FilePath& TransferableDirectory::path() const { return path_; }

void TransferableDirectory::ClearPath() { path_ = {}; }
...
void TransferableDirectory::OpenForTransfer() { NOTREACHED() << "Directory transfer not supported on this platform."; }
