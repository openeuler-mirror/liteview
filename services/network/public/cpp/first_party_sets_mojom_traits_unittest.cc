...
TEST(FirstPartySetsTraitsTest, Roundtrips_SamePartyCookieContextType)
{
    ...
    for (ContextType context_type : { ContextType::kCrossParty, ContextType::kSameParty }) {
        ContextType roundtrip;
        ASSERT_TRUE(mojo::test::SerializeAndDeserialize<mojom::SamePartyCookieContextType>(context_type, roundtrip));
...
{
    {
        ...
        EXPECT_TRUE(mojo::test::SerializeAndDeserialize<mojom::SamePartyContext>(same_party, copy));
...

    {
        ...
        EXPECT_TRUE(mojo::test::SerializeAndDeserialize<mojom::SamePartyContext>(cross_party, copy));
...
TEST(FirstPartySetsTraitsTest, Roundtrips_FirstPartySetMetadata)
{
    ...
    auto make_metadata = [&]() {
        ...
        // properly.
        return net::FirstPartySetMetadata(net::SamePartyContext(net::SamePartyContext::Type::kSameParty), &frame_entry, &top_frame_entry);
    };
    ...
    EXPECT_EQ(round_tripped.context(), net::SamePartyContext(net::SamePartyContext::Type::kSameParty));
...
TEST(FirstPartySetsTraitsTest, RoundTrips_GlobalFirstPartySets)
{
    ...
    const net::GlobalFirstPartySets original(
        /*entries=*/
        {
            ...
            { c, net::FirstPartySetEntry(a, net::SiteType::kService, absl::nullopt) },
        },
