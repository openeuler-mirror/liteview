...
network::mojom::AlternateProtocolUsage EnumTraits<network::mojom::AlternateProtocolUsage, net::AlternateProtocolUsage>::ToMojom(net::AlternateProtocolUsage input)
{
    switch (input) {
...
bool EnumTraits<network::mojom::AlternateProtocolUsage, net::AlternateProtocolUsage>::FromMojom(network::mojom::AlternateProtocolUsage input, net::AlternateProtocolUsage* output)
{
    switch (input) {
