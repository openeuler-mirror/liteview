...
OptionalSecureDnsMode ToOptionalSecureDnsMode(absl::optional<net::SecureDnsMode> optional)
{
    if (!optional)
...
absl::optional<net::SecureDnsMode> FromOptionalSecureDnsMode(OptionalSecureDnsMode mode)
{
    switch (mode) {
...
// static
bool StructTraits<network::mojom::DnsOverHttpsConfigDataView, net::DnsOverHttpsConfig>::Read(network::mojom::DnsOverHttpsConfigDataView data, net::DnsOverHttpsConfig* out_config)
{
...
// static
DnsConfigOverrides::Tristate StructTraits<DnsConfigOverridesDataView, net::DnsConfigOverrides>::append_to_multi_label_name(const net::DnsConfigOverrides& overrides)
{
    return ToTristate(overrides.append_to_multi_label_name);
}

// static
DnsConfigOverrides::Tristate StructTraits<DnsConfigOverridesDataView, net::DnsConfigOverrides>::rotate(const net::DnsConfigOverrides& overrides)
{
    return ToTristate(overrides.rotate);
}

// static
DnsConfigOverrides::Tristate StructTraits<DnsConfigOverridesDataView, net::DnsConfigOverrides>::use_local_ipv6(const net::DnsConfigOverrides& overrides)
{
...
// static
DnsConfigOverrides::Tristate StructTraits<DnsConfigOverridesDataView, net::DnsConfigOverrides>::allow_dns_over_https_upgrade(const net::DnsConfigOverrides& overrides)
{
...
// static
ResolveHostParameters::Source EnumTraits<ResolveHostParameters::Source, net::HostResolverSource>::ToMojom(net::HostResolverSource input)
{
    switch (input) {
...
// static
bool EnumTraits<ResolveHostParameters::Source, net::HostResolverSource>::FromMojom(ResolveHostParameters::Source input, net::HostResolverSource* output)
{
    switch (input) {
...
// static
MdnsListenClient::UpdateType EnumTraits<MdnsListenClient::UpdateType, net::MdnsListenerUpdateType>::ToMojom(net::MdnsListenerUpdateType input)
{
    switch (input) {
...
// static
bool EnumTraits<MdnsListenClient::UpdateType, net::MdnsListenerUpdateType>::FromMojom(MdnsListenClient::UpdateType input, net::MdnsListenerUpdateType* output)
{
    switch (input) {
