...
TEST_F(CorsTest, CheckAccessDetectsWildcardOriginNotAllowed)
{
    ...
    const auto result
        = CheckAccess(response_url, allow_all_header /* allow_origin_header */, absl::nullopt /* allow_credentials_header */, network::mojom::CredentialsMode::kOmit, origin);
    EXPECT_TRUE(result.has_value());

    // Access-Control-Allow-Origin '*' should not be allowed if credentials mode
    // is kInclude.
    const auto result2
        = CheckAccess(response_url, allow_all_header /* allow_origin_header */, absl::nullopt /* allow_credentials_header */, network::mojom::CredentialsMode::kInclude, origin);
...
TEST_F(CorsTest, CheckAccessDetectsMissingAllowOriginHeader)
{
    ...
    const auto result
        = CheckAccess(response_url, absl::nullopt /* allow_origin_header */, absl::nullopt /* allow_credentials_header */, network::mojom::CredentialsMode::kOmit, origin);
...
TEST_F(CorsTest, CheckAccessDetectsMultipleAllowOriginValues)
{
    ...
    const auto result1 = CheckAccess(
        response_url, space_separated_multiple_origins /* allow_origin_header */, absl::nullopt /* allow_credentials_header */, network::mojom::CredentialsMode::kOmit, origin);
    ...
    const auto result2 = CheckAccess(
        response_url, comma_separated_multiple_origins /* allow_origin_header */, absl::nullopt /* allow_credentials_header */, network::mojom::CredentialsMode::kOmit, origin);
    ASSERT_FALSE(result2.has_value());
...
TEST_F(CorsTest, CheckAccessDetectsInvalidAllowOriginValue)
{
    ...
    const auto result = CheckAccess(
        response_url, std::string("invalid.origin") /* allow_origin_header */, absl::nullopt /* allow_credentials_header */, network::mojom::CredentialsMode::kOmit, origin);
    ASSERT_FALSE(result.has_value());
...
TEST_F(CorsTest, CheckAccessDetectsAllowOriginMismatch)
{
    ...
    const auto result1
        = CheckAccess(response_url, origin.Serialize() /* allow_origin_header */, absl::nullopt /* allow_credentials_header */, network::mojom::CredentialsMode::kOmit, origin);
    ASSERT_TRUE(result1.has_value());

    const auto result2 = CheckAccess(
        response_url, std::string("http://not.google.com") /* allow_origin_header */, absl::nullopt /* allow_credentials_header */, network::mojom::CredentialsMode::kOmit, origin);
    ASSERT_FALSE(result2.has_value());
    ...
    const auto result3
        = CheckAccess(response_url, null_string /* allow_origin_header */, absl::nullopt /* allow_credentials_header */, network::mojom::CredentialsMode::kOmit, null_origin);
...
TEST_F(CorsTest, CheckAccessDetectsInvalidAllowCredential)
{
    ...
    const auto result1 = CheckAccess(
        response_url, origin.Serialize() /* allow_origin_header */, std::string("true") /* allow_credentials_header */, network::mojom::CredentialsMode::kInclude, origin);
    ASSERT_TRUE(result1.has_value());

    const auto restul2 = CheckAccess(
        response_url, origin.Serialize() /* allow_origin_header */, std::string("fuga") /* allow_credentials_header */, network::mojom::CredentialsMode::kInclude, origin);
...
TEST_F(CorsTest, CheckAccessAndReportMetricsForPermittedSecureOrigin)
{
    ...
    CheckAccessAndReportMetrics(
        response_url, origin.Serialize() /* allow_origin_header */, absl::nullopt /* allow_credentials_header */, network::mojom::CredentialsMode::kOmit, origin);
...
TEST_F(CorsTest, CheckAccessAndReportMetricsForNotPermittedSecureOrigin)
{
    ...
    CheckAccessAndReportMetrics(
        response_url, absl::nullopt /* allow_origin_header */, absl::nullopt /* allow_credentials_header */, network::mojom::CredentialsMode::kOmit, origin);
...
TEST_F(CorsTest, SafelistedSecCHPrefersColorScheme) { EXPECT_TRUE(IsCorsSafelistedHeader("Sec-CH-Prefers-Color-Scheme", "\"Prefers-Color-Scheme!\"")); }

TEST_F(CorsTest, SafelistedSecCHPrefersReducedMotion) { EXPECT_TRUE(IsCorsSafelistedHeader("Sec-CH-Prefers-Reduced-Motion", "\"Prefers-Reduced-Motion!\"")); }
...
TEST_F(CorsTest, SafelistedSecCHViewportHeight) { EXPECT_TRUE(IsCorsSafelistedHeader("Sec-CH-Viewport-Height", "\"Viewport-Height!\"")); }
...
TEST_F(CorsTest, CorsUnsafeRequestHeaderNames)
{
    ...
    EXPECT_EQ(CorsUnsafeRequestHeaderNames(
                  { { "content-type", "text/plain" }, { "dpr", "12345" }, { "aCCept", "en,ja" }, { "accept-charset", "utf-8" }, { "uSer-Agent", "foo" }, { "hogE", "fuga" } }),
        List({ "accept-charset", "user-agent", "hoge" }));

    // All headers are not safelisted.
    EXPECT_EQ(CorsUnsafeRequestHeaderNames(
                  { { "content-type", "text/html" }, { "dpr", "123-45" }, { "aCCept", "en,ja" }, { "accept-charset", "utf-8" }, { "uSer-Agent", "foo" }, { "hogE", "fuga" } }),
        List({ "content-type", "dpr", "accept-charset", "user-agent", "hoge" }));

    // |safelistValueSize| is 1024.
    EXPECT_EQ(CorsUnsafeRequestHeaderNames(
                  { { "content-type", "text/plain; charset=" + std::string(108, '1') }, { "accept", std::string(128, '1') }, { "accept-language", std::string(128, '1') },
                      { "content-language", std::string(128, '1') }, { "dpr", std::string(128, '1') }, { "device-memory", std::string(128, '1') }, { "save-data", "on" },
                      { "viewport-width", std::string(128, '1') }, { "width", std::string(126, '1') }, { "hogE", "fuga" } }),
        List({ "hoge" }));
    ...
    EXPECT_EQ(CorsUnsafeRequestHeaderNames(
                  { { "content-type", "text/plain; charset=" + std::string(108, '1') }, { "accept", std::string(128, '1') }, { "accept-language", std::string(128, '1') },
                      { "content-language", std::string(128, '1') }, { "dpr", std::string(128, '1') }, { "device-memory", std::string(128, '1') }, { "save-data", "on" },
                      { "viewport-width", std::string(128, '1') }, { "width", std::string(127, '1') }, { "hogE", "fuga" } }),
    ...
    EXPECT_EQ(CorsUnsafeRequestHeaderNames(
                  { { "content-type", "text/plain; charset=" + std::string(128, '1') }, { "accept", std::string(128, '1') }, { "accept-language", std::string(128, '1') },
                      { "content-language", std::string(128, '1') }, { "dpr", std::string(128, '1') }, { "device-memory", std::string(128, '1') }, { "save-data", "on" },
                      { "viewport-width", std::string(128, '1') }, { "width", std::string(127, '1') }, { "hogE", "fuga" } }),
