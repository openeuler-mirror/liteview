...
private:
    ...
    static mojom::CorsOriginAccessMatchPriority GetHighestPriorityOfRuleForOrigin(const url::Origin& destination_origin, const PatternsMap& patterns_map, MapType type);
