...
// {
//     size_t public_suffix_length = host.find_last_of('.');
//     if (public_suffix_length == std::string::npos)
//         return host.length();
//     return host.length() - public_suffix_length - 1;
// }
// 
// }
...
bool IsPublicSuffixSubdomainOfHost(const std::string& subdomain, const std::string& host) 
{
    ...
    return public_suffix_length != std::string::npos && public_suffix_length != 0 && IsSubdomainOfHost(subdomain.substr(subdomain.length() - public_suffix_length), host);
}
...
OriginAccessEntry::OriginAccessEntry(const std::string& protocol, const std::string& host, const uint16_t port, const mojom::CorsDomainMatchMode domain_match_mode,
    ...
    , host_is_public_suffix_(false)
{
    ...
    size_t public_suffix_length = 0;
    public_suffix_length = net::registry_controlled_domains::PermissiveGetHostRegistryLength(
