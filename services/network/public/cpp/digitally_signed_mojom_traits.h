...
template <> struct StructTraits<network::mojom::DigitallySignedDataView, net::ct::DigitallySigned> {
    static net::ct::DigitallySigned::HashAlgorithm hash_algorithm(const net::ct::DigitallySigned& obj) { return obj.hash_algorithm; }
    static net::ct::DigitallySigned::SignatureAlgorithm signature_algorithm(const net::ct::DigitallySigned& obj) { return obj.signature_algorithm; }
    static base::span<const uint8_t> signature(const net::ct::DigitallySigned& obj) { return base::as_bytes(base::make_span(obj.signature_data)); }
