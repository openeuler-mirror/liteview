...
template <> struct StructTraits<network::mojom::MutablePartialNetworkTrafficAnnotationTagDataView, net::MutablePartialNetworkTrafficAnnotationTag> {
    static int32_t unique_id_hash_code(const net::MutablePartialNetworkTrafficAnnotationTag& traffic_annotation) { return traffic_annotation.unique_id_hash_code; }
