...
public:
    ...
    void SetAllowHTTP1ForStreamingUpload(bool allow) { allow_http1_for_streaming_upload_ = allow; }
    bool AllowHTTP1ForStreamingUpload() const { return allow_http1_for_streaming_upload_; }

    const std::vector<DataElement>* elements() const { return &elements_; }
    std::vector<DataElement>* elements_mutable() { return &elements_; }
    void swap_elements(std::vector<DataElement>* elements) { elements_.swap(*elements); }
    ...
    void set_contains_sensitive_info(bool contains_sensitive_info) { contains_sensitive_info_ = contains_sensitive_info; }
