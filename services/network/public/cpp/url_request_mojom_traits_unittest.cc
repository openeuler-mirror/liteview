...
{
    for (auto referrer_policy : { net::ReferrerPolicy::CLEAR_ON_TRANSITION_FROM_SECURE_TO_INSECURE, net::ReferrerPolicy::REDUCE_GRANULARITY_ON_TRANSITION_CROSS_ORIGIN,
             net::ReferrerPolicy::ORIGIN_ONLY_ON_TRANSITION_CROSS_ORIGIN, net::ReferrerPolicy::NEVER_CLEAR, net::ReferrerPolicy::ORIGIN,
             net::ReferrerPolicy::CLEAR_ON_TRANSITION_CROSS_ORIGIN, net::ReferrerPolicy::ORIGIN_CLEAR_ON_TRANSITION_FROM_SECURE_TO_INSECURE, net::ReferrerPolicy::NO_REFERRER }) {
...
TEST(URLRequestMojomTraitsTest, Roundtrips_ResourceRequest)
{
    ...
    original.web_bundle_token_params = absl::make_optional(
        ResourceRequest::WebBundleTokenParams(GURL("https://bundle.test/"), base::UnguessableToken::Create(), mojo::PendingRemote<network::mojom::WebBundleHandle>()));
    original.net_log_create_info = absl::make_optional(net::NetLogSource(net::NetLogSourceType::URL_REQUEST, net::NetLog::Get()->NextID()));
    original.net_log_reference_info = absl::make_optional(net::NetLogSource(net::NetLogSourceType::URL_REQUEST, net::NetLog::Get()->NextID()));
    ...
    original.trusted_params->isolation_info
        = net::IsolationInfo::Create(net::IsolationInfo::RequestType::kMainFrame, url::Origin::Create(original.url), url::Origin::Create(original.url), original.site_for_cookies);
    ...
    original.trust_token_params->type = mojom::TrustTokenOperationType::kRedemption;
