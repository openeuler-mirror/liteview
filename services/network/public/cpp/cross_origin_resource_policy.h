...
public:
    ...
    // process.
    [[nodiscard]] static absl::optional<mojom::BlockedByResponseReason> IsBlocked(const GURL& request_url, const GURL& original_url,
    ...
    [[nodiscard]] static absl::optional<mojom::BlockedByResponseReason> IsBlockedByHeaderValue(const GURL& request_url, const GURL& original_url,
    ...
    // etc.
    static absl::optional<mojom::BlockedByResponseReason> IsNavigationBlocked(const GURL& request_url, const GURL& original_url,
