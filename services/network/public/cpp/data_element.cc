...
DataElementBytes DataElementBytes::Clone() const { return DataElementBytes(bytes_); }
...
DataElementDataPipe DataElementDataPipe::Clone() const { return DataElementDataPipe(CloneDataPipeGetter()); }
