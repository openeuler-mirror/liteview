...
public:
    ...
    void Send(int connection_id, net::HttpStatusCode status_code, const std::string& data, const std::string& mime_type, net::NetworkTrafficAnnotationTag traffic_annotation);
