...
public:
    ...
    mojo::DataPipeConsumerHandle receive_handle() const { return socket_receive_handle_.get(); }
    mojo::SimpleWatcher& read_watcher() { return receive_pipe_watcher_; }
    mojo::DataPipeProducerHandle send_handle() const { return socket_send_handle_.get(); }
