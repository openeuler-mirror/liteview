...
bool IsOriginAllowlisted(const url::Origin& origin) { return SecureOriginAllowlist::GetInstance().IsOriginAllowlisted(origin); }

bool IsOriginAllowlisted(const char* str) { return IsOriginAllowlisted(url::Origin::Create(GURL(str))); }

bool IsUrlPotentiallyTrustworthy(const char* str) { return network::IsUrlPotentiallyTrustworthy(GURL(str)); }
...
public:
    ...
    static bool IsOriginPotentiallyTrustworthy(const OriginType& origin) { return network::IsOriginPotentiallyTrustworthy(origin); }
    static bool IsUrlPotentiallyTrustworthy(base::StringPiece str) { return network::IsUrlPotentiallyTrustworthy(GURL(str)); }
    static bool IsOriginOfLocalhost(const OriginType& origin) { return net::IsLocalhost(origin.GetURL()); }
