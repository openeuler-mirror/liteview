...
const char kWeekdayName[7][4] = { "Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat" };

const char kMonthName[12][4] = { "Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec" };
...
std::ostream& operator<<(std::ostream& os, Time time)
{
    ...
    return os << StringPrintf("%04d-%02d-%02d %02d:%02d:%02d.%03d UTC", exploded.year, exploded.month, exploded.day_of_month, exploded.hour, exploded.minute,
