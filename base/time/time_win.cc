...
ThreadTicks ThreadTicks::GetForThread(const PlatformThreadHandle& thread_handle)
{
    ...
    ::QueryThreadCycleTimeXp(thread_handle.platform_handle(), &thread_cycle_time);
...
bool ThreadTicks::IsSupportedWin()
{
    ...
    static bool is_supported = QueryThreadCycleTimeIsLoaded() && CPU().has_non_stop_time_stamp_counter(); // SUPPORT_XP_CODE
    return is_supported;
#else
