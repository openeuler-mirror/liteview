...
extern const BASE_EXPORT base::FeatureParam<TimeDelta> kBrowserPeriodicYieldingToNativeNormalInputAfterMsParam;
extern const BASE_EXPORT base::FeatureParam<TimeDelta> kBrowserPeriodicYieldingToNativeFlingInputAfterMsParam;
extern const BASE_EXPORT base::FeatureParam<TimeDelta> kBrowserPeriodicYieldingToNativeNoInputAfterMsParam;
extern const BASE_EXPORT base::FeatureParam<TimeDelta> kBrowserPeriodicYieldingToNativeDelay;
