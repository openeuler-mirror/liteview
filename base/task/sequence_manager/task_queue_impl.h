...
public:
    ...
    [[nodiscard]] std::unique_ptr<TaskQueue::OnTaskPostedCallbackHandle> AddOnTaskPostedHandler(OnTaskPostedHandler handler);
...
private:
    ...
    public:
        explicit TaskRunner(scoped_refptr<GuardedTaskPoster> task_poster, scoped_refptr<const AssociatedThreadId> associated_thread, TaskType task_type);
    ...
    void RecordQueuingDelayedTaskMetrics(const Task& pending_task, LazyNow* lazy_now);
