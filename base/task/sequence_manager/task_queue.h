...
inline const char* GetQueueName_Name(QueueName value)
{
    switch (value) {
...
public:
    ...
    public:
        ...
        // This is always called on the thread this TaskQueue is associated with.
        virtual absl::optional<WakeUp> GetNextAllowedWakeUp(LazyNow* lazy_now, absl::optional<WakeUp> next_desired_wake_up, bool has_ready_task) = 0;
    ...
    // thread.
    [[nodiscard]] std::unique_ptr<OnTaskPostedCallbackHandle> AddOnTaskPostedHandler(OnTaskPostedHandler handler);
...
protected:
    ...
    internal::TaskQueueImpl* GetTaskQueueImpl() const
    {
        return impl_.get();
    }
