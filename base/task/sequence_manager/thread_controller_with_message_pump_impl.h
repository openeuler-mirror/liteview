...
public:
    ...
    void SetNextDelayedDoWork(LazyNow* lazy_now, absl::optional<WakeUp> wake_up) override;
...
private:
    ...
    void InitializeThreadTaskRunnerHandle() EXCLUSIVE_LOCKS_REQUIRED(task_runner_lock_);
    ...
    base::TimeDelta periodic_yielding_to_native_interval_ = base::TimeDelta::Max();
};
