...
public:
    ...
    // O(1).
    absl::optional<TaskQueue::QueuePriority> GetHighestPendingPriority(SelectTaskOption option = SelectTaskOption::kDefault) const;
...
protected:
    ...
    struct SetOperationOldest {
        static absl::optional<WorkQueueAndTaskOrder> GetWithPriority(const WorkQueueSets& sets, TaskQueue::QueuePriority priority)
        {
...
private:
    ...
    static TaskQueue::QueuePriority NextPriority(TaskQueue::QueuePriority priority);
