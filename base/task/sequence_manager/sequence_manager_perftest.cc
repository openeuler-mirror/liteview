...
public:
    ...
    bool MaybeFastForwardToWakeUp(absl::optional<WakeUp> wake_up, bool quit_when_idle_requested) override
    {
        if (wake_up) {
...
public:
    ...
    {
        scoped_refptr<TestTaskQueue> task_queue = manager_->CreateTaskQueueWithType<TestTaskQueue>(TaskQueue::Spec(QueueName::TEST_TQ));
...
public:
        ...
        : name_(name)
    {
        ...
        // runner.
        scoped_refptr<TaskQueue> default_task_queue = GetManager()->template CreateTaskQueueWithType<TestTaskQueue>(TaskQueue::Spec(QueueName::DEFAULT_TQ));
