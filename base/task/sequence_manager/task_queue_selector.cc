...
TaskQueue::QueuePriority TaskQueueSelector::NextPriority(TaskQueue::QueuePriority priority)
{
...
absl::optional<TaskQueue::QueuePriority> TaskQueueSelector::GetHighestPendingPriority(SelectTaskOption option) const
{
    DCHECK_CALLED_ON_VALID_THREAD(associated_thread_->thread_checker);
    ...
    for (; highest_priority != TaskQueue::kQueuePriorityCount; highest_priority = NextPriority(highest_priority)) {
