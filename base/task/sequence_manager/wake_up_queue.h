...
public:
    ...
    void SetNextWakeUpForQueue(internal::TaskQueueImpl* queue, LazyNow* lazy_now, absl::optional<WakeUp> wake_up);
...
protected:
    ...
    virtual void OnNextWakeUpChanged(LazyNow* lazy_now, absl::optional<WakeUp> next_wake_up) = 0;
...
private:
    ...
    void OnNextWakeUpChanged(LazyNow* lazy_now, absl::optional<WakeUp> wake_up) override;
