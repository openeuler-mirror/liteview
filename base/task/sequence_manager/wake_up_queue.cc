...
void WakeUpQueue::SetNextWakeUpForQueue(internal::TaskQueueImpl* queue, LazyNow* lazy_now, absl::optional<WakeUp> wake_up)
{
    DCHECK_CALLED_ON_VALID_THREAD(associated_thread_->thread_checker);
...
void DefaultWakeUpQueue::OnNextWakeUpChanged(LazyNow* lazy_now, absl::optional<WakeUp> wake_up)
{
...
void NonWakingWakeUpQueue::OnNextWakeUpChanged(LazyNow* lazy_now, absl::optional<WakeUp> wake_up)
{
}
