...
public:
    ...
    void WillQueueTask(perfetto::StaticString trace_event_name, PendingTask* pending_task);
...
private:
    ...
    // EventContext.
    void EmitTaskLocation(perfetto::EventContext& ctx, const PendingTask& task) const;
    ...
    void MaybeEmitIPCHashAndDelay(perfetto::EventContext& ctx, const PendingTask& task) const;
