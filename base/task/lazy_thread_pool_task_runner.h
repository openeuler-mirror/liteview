...
#define LAZY_THREAD_POOL_SEQUENCED_TASK_RUNNER_INITIALIZER(traits)                                                                                             \
    ...
    [[maybe_unused]] constexpr base::TaskTraits LAZY_TASK_RUNNER_CONCATENATE_INTERNAL(kVerifyTraitsAreConstexpr, __LINE__) = traits
...
#define LAZY_THREAD_POOL_SINGLE_THREAD_TASK_RUNNER_INITIALIZER(traits, thread_mode)                                                                            \
    ...
    [[maybe_unused]] constexpr base::TaskTraits LAZY_TASK_RUNNER_CONCATENATE_INTERNAL(kVerifyTraitsAreConstexpr, __LINE__) = traits;                           \
    [[maybe_unused]] constexpr base::SingleThreadTaskRunnerThreadMode LAZY_TASK_RUNNER_CONCATENATE_INTERNAL(kVerifyThreadModeIsConstexpr, __LINE__)            \
        = thread_mode
