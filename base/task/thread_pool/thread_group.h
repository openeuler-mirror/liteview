...
protected:
    ...
    public:
        ...
        // should be enqueued.
        void SchedulePushTaskSourceAndWakeUpWorkers(TransactionWithRegisteredTaskSource transaction_with_task_source, ThreadGroup* destination_thread_group);

    private:
        // A TransactionWithRegisteredTaskSource and the thread group in which it
        // should be enqueued.
        absl::optional<TransactionWithRegisteredTaskSource> transaction_with_task_source_;
    ...
    // experiment is complete.
    ThreadGroup(TrackedRef<TaskTracker> task_tracker, TrackedRef<Delegate> delegate, ThreadGroup* predecessor_thread_group = nullptr);
    ...
    void ReEnqueueTaskSourceLockRequired(BaseScopedCommandsExecutor* workers_executor, ScopedReenqueueExecutor* reenqueue_executor,
        TransactionWithRegisteredTaskSource transaction_with_task_source) EXCLUSIVE_LOCKS_REQUIRED(lock_);
    ...
    void PushTaskSourceAndWakeUpWorkersImpl(BaseScopedCommandsExecutor* executor, TransactionWithRegisteredTaskSource transaction_with_task_source);
