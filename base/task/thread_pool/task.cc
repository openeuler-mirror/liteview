...
Task::Task(const Location& posted_from, OnceClosure task, TimeTicks queue_time, TimeDelta delay, TimeDelta leeway)
    : Task(posted_from, std::move(task), queue_time, delay.is_zero() ? TimeTicks() : queue_time + delay, leeway)
{
}
