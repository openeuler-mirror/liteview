...
public:
    ...
    TaskSource(const TaskTraits& traits, TaskRunner* task_runner, TaskSourceExecutionMode execution_mode);
...
public:
    TransactionWithRegisteredTaskSource(RegisteredTaskSource task_source_in, TaskSource::Transaction transaction_in);
    ...
    TransactionWithRegisteredTaskSource& operator=(const TransactionWithRegisteredTaskSource&) = delete;
    ~TransactionWithRegisteredTaskSource() = default;

    static TransactionWithRegisteredTaskSource FromTaskSource(RegisteredTaskSource task_source_in);
