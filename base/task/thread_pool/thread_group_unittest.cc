...
#if HAS_NATIVE_THREAD_POOL()
        case test::GroupType::NATIVE: {
            ThreadGroupNativeType* thread_group_native_impl = static_cast<ThreadGroupNativeType*>(thread_group_.get());
...
class ThreadGroupTest : public ThreadGroupTestBase, public testing::WithParamInterface<test::GroupType> {
public:
...
// parameter.
class ThreadGroupTestAllExecutionModes : public ThreadGroupTestBase, public testing::WithParamInterface<std::tuple<test::GroupType, TaskSourceExecutionMode>> {
public:
...
TEST_P(ThreadGroupTest, UpdatePriorityBestEffortToUserBlocking)
{
    ...
    std::unique_ptr<ConditionVariable> num_tasks_running_cv = num_tasks_running_lock.CreateConditionVariable();
...
TEST_P(ThreadGroupTest, ScheduleJobTaskSource)
{
    ...
    thread_group_->PushTaskSourceAndWakeUpWorkers(TransactionWithRegisteredTaskSource::FromTaskSource(std::move(registered_task_source)));
...
TEST_P(ThreadGroupTest, ScheduleJobTaskSourceMultipleTime)
{
    ...
    thread_group_->PushTaskSourceAndWakeUpWorkers(TransactionWithRegisteredTaskSource::FromTaskSource(task_tracker_.RegisterTaskSource(task_source)));
...
TEST_P(ThreadGroupTest, CancelJobTaskSource)
{
    ...
    std::unique_ptr<ConditionVariable> tasks_running_cv = tasks_running_lock.CreateConditionVariable();
...
INSTANTIATE_TEST_SUITE_P(Generic, ThreadGroupTest, ::testing::Values(test::GroupType::GENERIC));
INSTANTIATE_TEST_SUITE_P(GenericParallel, ThreadGroupTestAllExecutionModes,
    ::testing::Combine(::testing::Values(test::GroupType::GENERIC), ::testing::Values(TaskSourceExecutionMode::kParallel)));
INSTANTIATE_TEST_SUITE_P(GenericSequenced, ThreadGroupTestAllExecutionModes,
    ::testing::Combine(::testing::Values(test::GroupType::GENERIC), ::testing::Values(TaskSourceExecutionMode::kSequenced)));
INSTANTIATE_TEST_SUITE_P(GenericJob, ThreadGroupTestAllExecutionModes,
    ::testing::Combine(::testing::Values(test::GroupType::GENERIC), ::testing::Values(TaskSourceExecutionMode::kJob)));

#if HAS_NATIVE_THREAD_POOL()
INSTANTIATE_TEST_SUITE_P(Native, ThreadGroupTest, ::testing::Values(test::GroupType::NATIVE));
INSTANTIATE_TEST_SUITE_P(NativeParallel, ThreadGroupTestAllExecutionModes,
    ::testing::Combine(::testing::Values(test::GroupType::NATIVE), ::testing::Values(TaskSourceExecutionMode::kParallel)));
INSTANTIATE_TEST_SUITE_P(NativeSequenced, ThreadGroupTestAllExecutionModes,
    ::testing::Combine(::testing::Values(test::GroupType::NATIVE), ::testing::Values(TaskSourceExecutionMode::kSequenced)));
INSTANTIATE_TEST_SUITE_P(NativeJob, ThreadGroupTestAllExecutionModes,
    ::testing::Combine(::testing::Values(test::GroupType::NATIVE), ::testing::Values(TaskSourceExecutionMode::kJob)));
#endif
