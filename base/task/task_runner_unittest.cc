...
TEST_F(TaskRunnerTest, PostTaskAndReplyWithResult)
{
    ...
    ThreadTaskRunnerHandle::Get()->PostTaskAndReplyWithResult(FROM_HERE, BindOnce(&ReturnFourtyTwo), BindOnce(&StoreValue, &result));
...
TEST_F(TaskRunnerTest, PostTaskAndReplyWithResultRepeatingCallbacks)
{
    ...
    test::SingleThreadTaskEnvironment task_environment;
    ThreadTaskRunnerHandle::Get()->PostTaskAndReplyWithResult(FROM_HERE, BindRepeating(&ReturnFourtyTwo), BindRepeating(&StoreValue, &result));
...
TEST_F(TaskRunnerTest, PostTaskAndReplyWithResultImplicitConvert)
{
    ...
    test::SingleThreadTaskEnvironment task_environment;
    ThreadTaskRunnerHandle::Get()->PostTaskAndReplyWithResult(FROM_HERE, BindOnce(&ReturnFourtyTwo), BindOnce(&StoreDoubleValue, &result));
...
{
    test::SingleThreadTaskEnvironment task_environment;
    ThreadTaskRunnerHandle::Get()->PostTaskAndReplyWithResult(FROM_HERE, BindOnce(&CreateFoo), BindOnce(&ExpectFoo));
...
{
    test::SingleThreadTaskEnvironment task_environment;
    ThreadTaskRunnerHandle::Get()->PostTaskAndReplyWithResult(FROM_HERE, BindOnce(&CreateScopedFoo), BindOnce(&ExpectScopedFoo));
