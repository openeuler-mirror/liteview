...
TEST(ScopedMachVMTest, ResetLargerAddress)
{
    ...
    ScopedMachVM scoper(address + 3 * base::GetPageSize(), 3 * base::GetPageSize());
...
TEST(ScopedMachVMTest, ResetUnaligned)
{
    ...
    scoper.reset_unaligned(address + base::GetPageSize(), base::GetPageSize() - 3);
    // Reset with another unaligned size.
    scoper.reset_unaligned(address + base::GetPageSize(), base::GetPageSize() - 11);
