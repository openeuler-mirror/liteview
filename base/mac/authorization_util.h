...
BASE_EXPORT
AuthorizationRef GetAuthorizationRightsWithPrompt(AuthorizationRights* rights, CFStringRef prompt, AuthorizationFlags extraFlags);
...
BASE_EXPORT
OSStatus ExecuteWithPrivilegesAndGetPID(
...
// to exit.
BASE_EXPORT
OSStatus ExecuteWithPrivilegesAndWait(
