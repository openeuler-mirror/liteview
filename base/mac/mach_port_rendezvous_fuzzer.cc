...
struct MachPortRendezvousFuzzer {
    MachPortRendezvousFuzzer()
    {
        ...
        mach_port_t port = base::MachPortRendezvousServer::GetInstance()->server_port_.get();
    ...
    void ClearClientData() EXCLUSIVE_LOCKS_REQUIRED(base::MachPortRendezvousServer::GetInstance()->GetLock())
    {
...
DEFINE_BINARY_PROTO_FUZZER(const mach_fuzzer::MachMessage& message)
{
    ...
    {
        base::AutoLock lock(base::MachPortRendezvousServer::GetInstance()->GetLock());
