...
TEST_P(ElfReaderTest, ReadElfBuildIdLowercase)
{
    ...
    EXPECT_EQ(8u, build_id_size);
    EXPECT_EQ(ToLowerASCII(kBuildIdHexStringLower), StringPiece(&build_id[0], build_id_size));
}
...
TEST_P(ElfReaderTest, ReadElfLibraryName)
{
    ...
    absl::optional<StringPiece> library_name = ReadElfLibraryName(image.elf_start());
