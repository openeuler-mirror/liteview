...
TestElfImageBuilder& TestElfImageBuilder::AddNoteSegment(Word type, StringPiece name, span<const uint8_t> desc)
{
...
{
    static_assert(std::is_trivially_copyable<T>::value, "T should be a plain struct");
