...
std::u16string GetShortTimeZone(const Time& time)
{
    ...
    zone_formatter->format(UTZFMT_STYLE_SPECIFIC_SHORT, *zone, static_cast<UDate>(time.ToDoubleT() * 1000), name, nullptr);
...
TEST(TimeFormattingTest, TimeFormatWithPattern)
{
    ...
    EXPECT_EQ(u"April 30 at 3:42:07 PM", TimeFormatWithPattern(time, "MMMMdjmmss"));
