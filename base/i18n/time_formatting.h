...
BASE_I18N_EXPORT std::u16string TimeFormatWithPattern(const Time& time, const char* pattern);
...
[[nodiscard]] BASE_I18N_EXPORT bool TimeDurationFormat(const TimeDelta time, const DurationFormatWidth width, std::u16string* out);
...
[[nodiscard]] BASE_I18N_EXPORT bool TimeDurationFormatWithSeconds(const TimeDelta time, const DurationFormatWidth width, std::u16string* out);
