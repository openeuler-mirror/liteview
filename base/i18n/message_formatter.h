...
public:
    ...
    static std::u16string FormatWithNamedArgs(StringPiece16 msg, StringPiece name0 = StringPiece(), const internal::MessageArg& arg0 = internal::MessageArg(),
        StringPiece name1 = StringPiece(), const internal::MessageArg& arg1 = internal::MessageArg(), StringPiece name2 = StringPiece(),
        const internal::MessageArg& arg2 = internal::MessageArg(), StringPiece name3 = StringPiece(), const internal::MessageArg& arg3 = internal::MessageArg(),
        StringPiece name4 = StringPiece(), const internal::MessageArg& arg4 = internal::MessageArg(), StringPiece name5 = StringPiece(),
        const internal::MessageArg& arg5 = internal::MessageArg(), StringPiece name6 = StringPiece(),
        const internal::MessageArg& arg6 = internal::MessageArg());

    static std::u16string FormatWithNumberedArgs(StringPiece16 msg, const internal::MessageArg& arg0 = internal::MessageArg(),
