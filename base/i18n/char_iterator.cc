...
// static
UTF16CharIterator UTF16CharIterator::LowerBound(StringPiece16 str, size_t array_index)
{
...
// static
UTF16CharIterator UTF16CharIterator::UpperBound(StringPiece16 str, size_t array_index)
{
    DCHECK_LE(array_index, str.length());
