...
public:
    ...
    {
        return s.empty()
            || (!!illegal_anywhere_.containsNone(icu::UnicodeString(s.c_str(), s.size())) && !illegal_at_ends_.contains(*s.begin())
...
IllegalCharacters::IllegalCharacters()
{
    ...
    illegal_anywhere_ = icu::UnicodeSet(UNICODE_STRING_SIMPLE("[[\"~*/:<>?\\\\|][:Cc:][:Cf:]]"), everywhere_status);
