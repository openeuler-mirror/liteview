...
{
    const CommandLine::CharType* raw_argv[] = { FILE_PATH_LITERAL("prog"), FILE_PATH_LITERAL("--"), FILE_PATH_LITERAL("--arg1") };
...
{
    std::unique_ptr<CommandLine> initial(new CommandLine(CommandLine::NO_PROGRAM));
...
public:
    ...
    void ResolveDuplicate(base::StringPiece key, CommandLine::StringPieceType new_value, CommandLine::StringType& out_value) override;
};

MergeDuplicateFoosSemicolon::~MergeDuplicateFoosSemicolon() = default;

void MergeDuplicateFoosSemicolon::ResolveDuplicate(base::StringPiece key, CommandLine::StringPieceType new_value, CommandLine::StringType& out_value)
{
