...
std::vector<absl::string_view> StringPiecesToStringViews(span<const StringPiece> pieces)
{
...
std::vector<StringPiece> StringViewsToStringPieces(span<const absl::string_view> views)
{
