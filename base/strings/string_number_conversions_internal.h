...
template <int BASE, typename CHAR> absl::optional<uint8_t> CharToDigit(CHAR c)
{
...
template <typename Number, int kBase, typename CharT> auto StringToNumber(BasicStringPiece<CharT> input)
{
...
template <typename Char, typename OutIter> static bool HexStringToByteContainer(StringPiece input, OutIter output)
{
