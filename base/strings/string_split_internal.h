...
template <typename CharT> BasicStringPiece<CharT> WhitespaceForType();

template <> inline StringPiece16 WhitespaceForType<char16_t>()
{
    return kWhitespaceUTF16;
}
template <> inline StringPiece WhitespaceForType<char>()
{
