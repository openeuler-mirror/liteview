...
template <typename CharT> class CommonStringPieceTest : public ::testing::Test {
public:
    static std::string as_string(const char* input)
    {
        return input;
    }
...
template <> class CommonStringPieceTest<char16_t> : public ::testing::Test {
public:
...
#define CMP_Y(op, x, y)                                                                                                                                        \
    {                                                                                                                                                          \
        ...
        ASSERT_TRUE((BasicStringPiece<TypeParam>((lhs.c_str())) op BasicStringPiece<TypeParam>((rhs.c_str()))));                                               \
...
#define CMP_N(op, x, y)                                                                                                                                        \
    {                                                                                                                                                          \
        std::basic_string<TypeParam> lhs(TestFixture::as_string(x));                                                                                           \
        std::basic_string<TypeParam> rhs(TestFixture::as_string(y));                                                                                           \
        ASSERT_FALSE((BasicStringPiece<TypeParam>((lhs.c_str())) op BasicStringPiece<TypeParam>((rhs.c_str()))));                                              \
...
{
    std::basic_string<TypeParam> alphabet(TestFixture::as_string("abcdefghijklmnopqrstuvwxyz"));
...
TYPED_TEST(CommonStringPieceTest, CheckFind)
{
    ...
    std::basic_string<TypeParam> not_found(TestFixture::as_string("xx not found bb"));
    Piece g(not_found);
    ...
    size_t empty_search_pos = std::basic_string<TypeParam>().find(std::basic_string<TypeParam>());
    ...
    ASSERT_EQ(a.rfind(d), static_cast<size_t>(a.rfind(std::basic_string<TypeParam>())));
    ASSERT_EQ(a.rfind(e), a.rfind(std::basic_string<TypeParam>()));
    ASSERT_EQ(a.rfind(d), static_cast<size_t>(std::basic_string<TypeParam>(a).rfind(std::basic_string<TypeParam>())));
    ASSERT_EQ(a.rfind(e), std::basic_string<TypeParam>(a).rfind(std::basic_string<TypeParam>()));
    ...
    std::basic_string<TypeParam> one_two_three_four(TestFixture::as_string("one,two:three;four"));
...
{
    std::basic_string<TypeParam> alphabet(TestFixture::as_string("abcdefghijklmnopqrstuvwxyz"));
    std::basic_string<TypeParam> alphabet_z(TestFixture::as_string("abcdefghijklmnopqrstuvwxyzz"));
    std::basic_string<TypeParam> alphabet_y(TestFixture::as_string("abcdefghijklmnopqrstuvwxyy"));
...
TYPED_TEST(CommonStringPieceTest, CheckConstructors)
{
    ...
    ASSERT_EQ(empty, BasicStringPiece<TypeParam>(str.c_str(), static_cast<typename BasicStringPiece<TypeParam>::size_type>(0)));
    ASSERT_EQ(empty, BasicStringPiece<TypeParam>());
    ASSERT_TRUE(empty == BasicStringPiece<TypeParam>(nullptr, static_cast<typename BasicStringPiece<TypeParam>::size_type>(0)));
    ASSERT_EQ(empty, BasicStringPiece<TypeParam>());
