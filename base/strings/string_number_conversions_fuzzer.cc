...
template <class NumberType> void CheckRoundtrips(const uint8_t* data, const size_t size, bool (*string_to_num)(base::StringPiece, NumberType*))
{
    return CheckRoundtripsT<NumberType, base::StringPiece, std::string>(data, size, &base::NumberToString, string_to_num);
}

template <class NumberType> void CheckRoundtrips16(const uint8_t* data, const size_t size, bool (*string_to_num)(base::StringPiece16, NumberType*))
{
    return CheckRoundtripsT<NumberType, base::StringPiece16, std::u16string>(data, size, &base::NumberToString16, string_to_num);
}
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    base::StringPiece string_piece_input(reinterpret_cast<const char*>(data), size);
