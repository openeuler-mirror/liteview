...
inline rust::Slice<const uint8_t> StringPieceToRustSlice(StringPiece string_piece)
{
    return rust::Slice<const uint8_t>(reinterpret_cast<const uint8_t*>(string_piece.data()), string_piece.length() * sizeof(StringPiece::value_type));
}
