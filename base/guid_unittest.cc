...
{
    static constexpr uint64_t kBytes[] = { 0x0123456789ABCDEFULL, 0xFEDCBA9876543210ULL };
    const std::string clientid = RandomDataToGUIDString(kBytes);
...
{
    static constexpr uint64_t kBytes[] = { 0xDEADBEEFDEADBEEFULL, 0xDEADBEEFDEADBEEFULL };
    const std::string clientid = RandomDataToGUIDString(kBytes);

    static constexpr char kExpectedCanonicalStr[] = "deadbeef-dead-beef-dead-beefdeadbeef";
...
TEST(GUIDTest, FormatRandomDataAsV4)
{
    ...
    const GUID guid1a = GUID::FormatRandomDataAsV4ForTesting(as_bytes(make_span(bytes1a)));
    const GUID guid1b = GUID::FormatRandomDataAsV4ForTesting(as_bytes(make_span(bytes1b)));
    const GUID guid2 = GUID::FormatRandomDataAsV4ForTesting(as_bytes(make_span(bytes2)));
    const GUID guid3 = GUID::FormatRandomDataAsV4ForTesting(as_bytes(make_span(bytes3)));
