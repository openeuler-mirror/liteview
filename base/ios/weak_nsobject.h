...
template <typename NST> class WeakNSProtocol {
public:
...
// Free functions
template <class NST> bool operator==(NST p1, const WeakNSProtocol<NST>& p2)
{
    return p1 == p2.get();
}
...
template <typename NST> class WeakNSObject : public WeakNSProtocol<NST*> {
public:
...
template <> class WeakNSObject<id> : public WeakNSProtocol<id> {
public:
