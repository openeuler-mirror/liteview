...
NO_INSTRUMENT_FUNCTION bool DumpToFile(const base::FilePath& path, const LogData& data)
{
    ...
    for (size_t i = 0; i < count; i++) {
        ...
        if (file.WriteAtCurrentPos(offset_str.c_str(), static_cast<int>(offset_str.size())) < 0) {
...
NO_INSTRUMENT_FUNCTION bool SwitchToNextPhaseOrDump(int pid, uint64_t start_ns_since_epoch)
{
