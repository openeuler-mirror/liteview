...
ScopedHardwareBufferFenceSync::ScopedHardwareBufferFenceSync(ScopedHardwareBufferHandle handle, ScopedFD fence_fd, ScopedFD available_fence_fd, bool is_video)
