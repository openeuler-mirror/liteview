...
jstring ConvertUTF16ToJavaStringImpl(JNIEnv* env, const base::StringPiece16& str)
{
...
ScopedJavaLocalRef<jstring> ConvertUTF8ToJavaString(JNIEnv* env, const StringPiece& str)
{
...
ScopedJavaLocalRef<jstring> ConvertUTF16ToJavaString(JNIEnv* env, const StringPiece16& str)
{
