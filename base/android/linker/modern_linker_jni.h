...
public:
    ...
    bool LoadLibrary(const String& library_path, bool spawn_relro_region, const LoadTimeReporter& reporter);
...
private:
    ...
    bool LoadWithDlopenExt(const String& path, const LoadTimeReporter& reporter, void** handle);
