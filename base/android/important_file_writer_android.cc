...
static jboolean JNI_ImportantFileWriterAndroid_WriteFileAtomically(JNIEnv* env, const JavaParamRef<jstring>& file_name, const JavaParamRef<jbyteArray>& data)
{
    ...
    bool result = base::ImportantFileWriter::WriteFileAtomically(path, native_data_string);
    return result;
}
