...
JavaObjectWeakGlobalRef::JavaObjectWeakGlobalRef(JavaObjectWeakGlobalRef&& orig) noexcept
    : obj_(orig.obj_)
{
    orig.obj_ = nullptr;
}
...
JavaObjectWeakGlobalRef::JavaObjectWeakGlobalRef(JNIEnv* env, const base::android::JavaRef<jobject>& obj)
...
base::android::ScopedJavaLocalRef<jobject> JavaObjectWeakGlobalRef::get(JNIEnv* env) const
{
    return GetRealObject(env, obj_);
}

base::android::ScopedJavaLocalRef<jobject> GetRealObject(JNIEnv* env, jweak obj)
{
