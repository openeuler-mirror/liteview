...
public:
    ...
    void EnableIfNotSetWithParameter(const Feature& feature, StringPiece name, StringPiece value);
    ...
    bool IsEnabledWithParameter(const Feature& feature, StringPiece parameter_name, StringPiece parameter_value);

private:
    void AddFeatureIfNotSet(const Feature& feature, StringPiece suffix, bool enable);
