...
protected:
    ...
    void SetUp() override
    {
        ...
        base_address_ = AllocPages(kPoolSize, kSuperPageSize, PageAccessibilityConfiguration::kInaccessible, PageTag::kPartitionAlloc);
...
TEST_F(PartitionAllocAddressPoolManagerTest, DecommittedDataIsErased)
{
    ...
    ASSERT_TRUE(address);
    RecommitSystemPages(address, kSuperPageSize, PageAccessibilityConfiguration::kReadWrite, PageAccessibilityDisposition::kRequireUpdate);
    ...
    RecommitSystemPages(address2, kSuperPageSize, PageAccessibilityConfiguration::kReadWrite, PageAccessibilityDisposition::kRequireUpdate);
