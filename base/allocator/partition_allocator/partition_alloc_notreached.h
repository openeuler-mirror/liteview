...
#define PA_NOTREACHED()                                                                                                                                        \
    true ? ::partition_alloc::internal::logging::RawError(__FILE__ "(" PA_STRINGIFY(__LINE__) ") PA_NOTREACHED() hit.") : PA_EAT_CHECK_STREAM_PARAMS()

#elif BUILDFLAG(ENABLE_PARTITION_ALLOC_AS_MALLOC_SUPPORT) && defined(OFFICIAL_BUILD) && defined(NDEBUG) && BUILDFLAG(PA_DCHECK_IS_ON)
...
#define PA_NOTREACHED()                                                                                                                                        \
    PA_UNLIKELY(true)                                                                                                                                          \
    ? ::partition_alloc::internal::logging::RawCheck(__FILE__ "(" PA_STRINGIFY(__LINE__) ") PA_NOTREACHED() hit.") : PA_EAT_CHECK_STREAM_PARAMS()
