...
enum class AllocatorType { kSystem, kPartitionAlloc, kPartitionAllocWithThreadCache };
...
public:
    ...
    void Free(void* data) override
    {
        ThreadSafePartitionRoot::FreeNoHooks(data);
    }
...
public:
    ...
    void* Alloc(size_t size) override
    {
        return g_partition_root->AllocWithFlagsNoHooks(0, size, PartitionPageSize());
    }
    void Free(void* data) override
    {
        ThreadSafePartitionRoot::FreeNoHooks(data);
