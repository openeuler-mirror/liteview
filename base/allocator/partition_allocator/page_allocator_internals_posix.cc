...
int GetAccessFlags(PageAccessibilityConfiguration accessibility)
{
    ...
    case PageAccessibilityConfiguration::kReadWriteTagged:
        ...
        return PROT_READ | PROT_WRITE | (base::CPU::GetInstanceNoAllocation().has_mte() ? PA_PROT_MTE : 0);
#else
        [[fallthrough]];
#endif
    ...
    case PageAccessibilityConfiguration::kReadExecuteProtected:
        return PROT_READ | PROT_EXEC | (base::CPU::GetInstanceNoAllocation().has_bti() ? PA_PROT_BTI : 0);
