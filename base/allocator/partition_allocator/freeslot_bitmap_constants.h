...
PAGE_ALLOCATOR_CONSTANTS_DECLARE_CONSTEXPR PA_ALWAYS_INLINE size_t ReservedFreeSlotBitmapSize()
{
...
PAGE_ALLOCATOR_CONSTANTS_DECLARE_CONSTEXPR PA_ALWAYS_INLINE size_t CommittedFreeSlotBitmapSize()
{
#if BUILDFLAG(USE_FREESLOT_BITMAP)
...
PAGE_ALLOCATOR_CONSTANTS_DECLARE_CONSTEXPR PA_ALWAYS_INLINE size_t NumPartitionPagesPerFreeSlotBitmap()
{
...
PA_ALWAYS_INLINE uintptr_t SuperPageFreeSlotBitmapAddr(uintptr_t super_page)
{
    ...
    return super_page + PartitionPageSize() + (IsManagedByNormalBuckets(super_page) ? ReservedTagBitmapSize() : 0);
}
#endif
