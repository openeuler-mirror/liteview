...
PA_COMPONENT_EXPORT(PARTITION_ALLOC)
uintptr_t AllocPages(size_t length, size_t align, PageAccessibilityConfiguration accessibility, PageTag page_tag, int file_descriptor_for_shared_alloc = -1);
PA_COMPONENT_EXPORT(PARTITION_ALLOC)
...
uintptr_t AllocPagesWithAlignOffset(uintptr_t address, size_t length, size_t align, size_t align_offset, PageAccessibilityConfiguration page_accessibility,
    PageTag page_tag, int file_descriptor_for_shared_alloc = -1);
...
PAGE_ALLOCATOR_CONSTANTS_DECLARE_CONSTEXPR PA_ALWAYS_INLINE uintptr_t RoundUpToSystemPage(uintptr_t address)
{
...
// 0 for an |address| of 0.
PAGE_ALLOCATOR_CONSTANTS_DECLARE_CONSTEXPR PA_ALWAYS_INLINE uintptr_t RoundDownToSystemPage(uintptr_t address)
{
...
PAGE_ALLOCATOR_CONSTANTS_DECLARE_CONSTEXPR PA_ALWAYS_INLINE uintptr_t RoundUpToPageAllocationGranularity(uintptr_t address)
{
...
PAGE_ALLOCATOR_CONSTANTS_DECLARE_CONSTEXPR PA_ALWAYS_INLINE uintptr_t RoundDownToPageAllocationGranularity(uintptr_t address)
{
