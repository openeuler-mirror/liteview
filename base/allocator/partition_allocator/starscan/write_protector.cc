...
void UserFaultFDWPSet(int uffd, uintptr_t begin, size_t length, UserFaultFDWPMode mode)
{
    ...
    wp.range.len = length;
    wp.mode = (mode == UserFaultFDWPMode::kProtect) ? UFFDIO_WRITEPROTECT_MODE_WP : 0;
