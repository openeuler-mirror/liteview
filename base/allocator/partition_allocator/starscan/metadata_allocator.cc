...
{
    static internal::base::NoDestructor<ThreadSafePartitionRoot> allocator(kConfig);
    return *allocator;
}
...
void ReinitPCScanMetadataAllocatorForTesting()
{
    ...
    PCScanMetadataAllocator().PurgeMemory(PurgeFlags::kDecommitEmptySlotSpans | PurgeFlags::kDiscardUnusedSystemPages);
