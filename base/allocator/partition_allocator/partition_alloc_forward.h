...
template <bool thread_safe = internal::ThreadSafe> struct PartitionRoot;
...
#define PA_MALLOC_ALIGNED __attribute__((assume_aligned(::partition_alloc::internal::kAlignment)))
#endif
