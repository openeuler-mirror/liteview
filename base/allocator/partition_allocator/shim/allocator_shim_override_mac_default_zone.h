...
{
    return partition_alloc::internal::base::bits::AlignUp(size, partition_alloc::internal::kAlignment);
}
...
bool IsAlreadyRegistered()
{
    ...
    for (unsigned int i = 0; i < zone_count; i++) {
        ...
        if (zone->zone_name && (strcmp(zone->zone_name, partition_alloc::kPartitionAllocZoneName) == 0)) {
...
__attribute__((constructor(0))) void InitializeDefaultMallocZoneWithPartitionAlloc()
{
    ...
    if (strcmp(system_default_zone->zone_name, partition_alloc::kDelegatingZoneName) == 0) {
