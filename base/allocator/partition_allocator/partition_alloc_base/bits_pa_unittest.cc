...
TEST(BitsTest, CountLeadingZeroBits8)
{
    ...
    for (int shift = 0; shift <= 7; ++shift) {
        EXPECT_EQ(7 - shift, CountLeadingZeroBits(static_cast<uint8_t>(1 << shift)));
    }
...
TEST(BitsTest, CountLeadingZeroBits16)
{
    ...
    for (int shift = 0; shift <= 15; ++shift) {
        EXPECT_EQ(15 - shift, CountLeadingZeroBits(static_cast<uint16_t>(1 << shift)));
    }
...
TEST(BitsTest, LeftMostBit)
{
    ...
    static_assert(static_cast<int64_t>(0xFFFFFFFFFFFFFFFFu) == 0xFFFFFFFFFFFFFFFFl, "Comparing signed with unsigned literals compares bits.");
