...
#define PA_COMPACT_GOOGLE_LOG_EX_INFO(ClassName, ...)                                                                                                          \
    ::partition_alloc::internal::logging::ClassName(__FILE__, __LINE__, ::partition_alloc::internal::logging::LOGGING_INFO, ##__VA_ARGS__)
#define PA_COMPACT_GOOGLE_LOG_EX_WARNING(ClassName, ...)                                                                                                       \
    ::partition_alloc::internal::logging::ClassName(__FILE__, __LINE__, ::partition_alloc::internal::logging::LOGGING_WARNING, ##__VA_ARGS__)
#define PA_COMPACT_GOOGLE_LOG_EX_ERROR(ClassName, ...)                                                                                                         \
    ::partition_alloc::internal::logging::ClassName(__FILE__, __LINE__, ::partition_alloc::internal::logging::LOGGING_ERROR, ##__VA_ARGS__)
#define PA_COMPACT_GOOGLE_LOG_EX_FATAL(ClassName, ...)                                                                                                         \
    ::partition_alloc::internal::logging::ClassName(__FILE__, __LINE__, ::partition_alloc::internal::logging::LOGGING_FATAL, ##__VA_ARGS__)
#define PA_COMPACT_GOOGLE_LOG_EX_DFATAL(ClassName, ...)                                                                                                        \
    ::partition_alloc::internal::logging::ClassName(__FILE__, __LINE__, ::partition_alloc::internal::logging::LOGGING_DFATAL, ##__VA_ARGS__)
#define PA_COMPACT_GOOGLE_LOG_EX_DCHECK(ClassName, ...)                                                                                                        \
    ::partition_alloc::internal::logging::ClassName(__FILE__, __LINE__, ::partition_alloc::internal::logging::LOGGING_DCHECK, ##__VA_ARGS__)
...
#define PA_ERROR 0
#define PA_COMPACT_GOOGLE_LOG_EX_0(ClassName, ...) PA_COMPACT_GOOGLE_LOG_EX_ERROR(ClassName, ##__VA_ARGS__)
...
#define PA_PLOG_STREAM(severity)                                                                                                                               \
    PA_COMPACT_GOOGLE_LOG_EX_##severity(Win32ErrorLogMessage, ::partition_alloc::internal::logging::GetLastSystemErrorCode()).stream()
#elif BUILDFLAG(IS_POSIX) || BUILDFLAG(IS_FUCHSIA)
#define PA_PLOG_STREAM(severity) PA_COMPACT_GOOGLE_LOG_EX_##severity(ErrnoLogMessage, ::partition_alloc::internal::logging::GetLastSystemErrorCode()).stream()
#endif
...
class PA_COMPONENT_EXPORT(PARTITION_ALLOC) Win32ErrorLogMessage : public LogMessage {
public:
