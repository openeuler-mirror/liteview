    ...
    : command_line_(command_line)
{
    ...
    for (const StringPiece& feature : FeatureList::SplitFeatureListString(enabled_features)) {
        enabled_features_.emplace_back(feature);
    }
    for (const StringPiece& feature : FeatureList::SplitFeatureListString(disabled_features)) {
...
void ScopedAddFeatureFlags::EnableIfNotSetWithParameter(const Feature& feature, StringPiece name, StringPiece value)
{
...
bool ScopedAddFeatureFlags::IsEnabledWithParameter(const Feature& feature, StringPiece parameter_name, StringPiece parameter_value)
{
...
void ScopedAddFeatureFlags::AddFeatureIfNotSet(const Feature& feature, StringPiece suffix, bool enable)
{
