...
private:
    ...
    template <typename Void = void> typename std::enable_if_t<std::is_base_of<ScopedGenericOwnershipTracking, Traits>::value, Void> TrackAcquire(const T& value)
    {
    ...
    typename std::enable_if_t<!std::is_base_of<ScopedGenericOwnershipTracking, Traits>::value, Void> TrackAcquire(const T& value)
    {
    }

    template <typename Void = void> typename std::enable_if_t<std::is_base_of<ScopedGenericOwnershipTracking, Traits>::value, Void> TrackRelease(const T& value)
    {
        if (value != traits_type::InvalidValue()) {
    ...
    template <typename Void = void>
    typename std::enable_if_t<!std::is_base_of<ScopedGenericOwnershipTracking, Traits>::value, Void> TrackRelease(const T& value)
    {
    }
