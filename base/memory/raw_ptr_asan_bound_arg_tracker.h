...
namespace base {
namespace internal {
template <typename, typename> struct Invoker;

template <typename T, typename Impl> class UnretainedWrapper;

template <typename T, bool> class UnretainedRefWrapper;
} // namespace internal
...
private:
    template <typename, typename> friend struct internal::Invoker;
    ...
    template <typename T, typename Impl> void AddArg(const internal::UnretainedWrapper<T, Impl>& arg)
    {
    ...
    template <typename T, bool IsSupportedType> void AddArg(const internal::UnretainedRefWrapper<T, IsSupportedType>& arg)
    {
