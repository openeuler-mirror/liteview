...
public:
    ...
    // vector.)
    static scoped_refptr<RefCountedBytes> TakeVector(std::vector<unsigned char>* to_destroy);
    ...
    template <typename T> T* front_as()
    {
...
public:
    ...
    static scoped_refptr<RefCountedString16> TakeString(std::u16string* to_destroy);
