...
public:
    ...
    void SetStringWithCopiedName(base::StringPiece name, base::StringPiece value) override
    {
        pickle_.WriteBytes(&kTypeString, 1);
        pickle_.WriteString(value);
        WriteKeyNameWithCopy(pickle_, name);
    ...
    void SetValue(const char* name, Writer* value) override
    {
        ...
        pickle_.WriteBytes(pickle_writer->pickle_.payload(), pickle_writer->pickle_.payload_size());
        EndDictionary();
    }
...
void TracedValue::SetDoubleWithCopiedName(base::StringPiece name, double value)
{
    DCHECK_CURRENT_CONTAINER_IS(kStackTypeDict);
...
void TracedValue::SetStringWithCopiedName(base::StringPiece name, base::StringPiece value)
{
    DCHECK_CURRENT_CONTAINER_IS(kStackTypeDict);
...
void TracedValue::SetValueWithCopiedName(base::StringPiece name, TracedValue* value)
{
    DCHECK_CURRENT_CONTAINER_IS(kStackTypeDict);
...
void TracedValue::SetPointerWithCopiedName(base::StringPiece name, void* value)
{
    DCHECK_CURRENT_CONTAINER_IS(kStackTypeDict);
...
TracedValue::ArrayScope TracedValue::BeginArrayScopedWithCopiedName(base::StringPiece name)
{
...
TracedValue::DictionaryScope TracedValue::BeginDictionaryScopedWithCopiedName(base::StringPiece name)
{
    BeginDictionaryWithCopiedName(name);
    return TracedValue::DictionaryScope(this);
}
