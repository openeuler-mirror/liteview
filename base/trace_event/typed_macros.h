...
#define TRACE_EVENT_BEGIN(category, name, ...) TRACING_INTERNAL_ADD_TRACE_EVENT(TRACE_EVENT_PHASE_BEGIN, category, name, ##__VA_ARGS__)

// End a slice under |category|.
// Defaults to the current thread's track.
#define TRACE_EVENT_END(category, ...)                                                                                                                         \
    TRACING_INTERNAL_ADD_TRACE_EVENT(TRACE_EVENT_PHASE_END, category, trace_event_internal::kTraceEventEndName, ##__VA_ARGS__)
...
// Defaults to the current thread's track.
#define TRACE_EVENT_INSTANT(category, name, ...) TRACING_INTERNAL_ADD_TRACE_EVENT(TRACE_EVENT_PHASE_INSTANT, category, name, ##__VA_ARGS__)
