...
#if 0 // ndef BASE_TRACE_EVENT_TYPED_MACROS_INTERNAL_H_
...
#define TRACING_INTERNAL_ADD_TRACE_EVENT(phase, category, name, ...)                                                                                           \
    do {                                                                                                                                                       \
        ...
        if (INTERNAL_TRACE_EVENT_CATEGORY_GROUP_ENABLED()) {                                                                                                   \
            trace_event_internal::AddTypedTraceEvent(phase, INTERNAL_TRACE_EVENT_UID(category_group_enabled), name, ##__VA_ARGS__);                            \
        }                                                                                                                                                      \
    } while (false)
    ...
    struct {                                                                                                                                                   \
        struct ScopedTraceEvent {                                                                                                                              \
            ...
            {                                                                                                                                                  \
                ...
                /* end state.                                                  */                                                                              \
                TRACING_INTERNAL_ADD_TRACE_EVENT(TRACE_EVENT_PHASE_END, category, "", [](perfetto::EventContext) {});                                          \
            }                                                                                                                                                  \
        } event;                                                                                                                                               \
    } TRACING_INTERNAL_UID(scoped_event) { [&]() {                                                                                                             \
        TRACING_INTERNAL_ADD_TRACE_EVENT(TRACE_EVENT_PHASE_BEGIN, category, name, ##__VA_ARGS__);                                                              \
        return 0;                                                                                                                                              \
    }() };
