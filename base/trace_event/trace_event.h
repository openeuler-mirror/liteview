...
#define TRACE_ID_WITH_SCOPE(scope, ...) trace_event_internal::TraceID::WithScope(scope, ##__VA_ARGS__)
...
#define TRACE_EVENT_API_GET_CATEGORY_GROUP_ENABLED base::trace_event::TraceLog::GetCategoryGroupEnabled

// Get the number of times traces have been recorded. This is used to implement
// the TRACE_EVENT_IS_NEW_TRACE facility.
// unsigned int TRACE_EVENT_API_GET_NUM_TRACES_RECORDED()
#define TRACE_EVENT_API_GET_NUM_TRACES_RECORDED trace_event_internal::GetNumTracesRecorded
...
#define INTERNAL_TRACE_EVENT_GET_CATEGORY_INFO_CUSTOM_VARIABLES(category_group, atomic, category_group_enabled)                                                \
    category_group_enabled = reinterpret_cast<const unsigned char*>(TRACE_EVENT_API_ATOMIC_LOAD(atomic));                                                      \
...
#define INTERNAL_TRACE_EVENT_GET_CATEGORY_INFO_MAYBE_AT_COMPILE_TIME(category_group, k_category_group_enabled, category_group_enabled)                         \
    if (k_category_group_enabled) {                                                                                                                            \
        category_group_enabled = k_category_group_enabled;                                                                                                     \
    } else {                                                                                                                                                   \
        static TRACE_EVENT_API_ATOMIC_WORD INTERNAL_TRACE_EVENT_UID(atomic) = 0;                                                                               \
        INTERNAL_TRACE_EVENT_GET_CATEGORY_INFO_CUSTOM_VARIABLES(category_group, INTERNAL_TRACE_EVENT_UID(atomic), category_group_enabled);                     \
    }
...
#define INTERNAL_TRACE_TIME_TICKS_NOW() base::subtle::TimeTicksNowIgnoringOverride()
...
// //         INTERNAL_TRACE_EVENT_UID(h));                                        \
// //   }
// #define INTERNAL_TRACE_EVENT_ADD_SCOPED_WITH_FLAGS(category_group, name, flags, ...)
//
...
// //     }                                                                        \
// //   } while (0)
// #define INTERNAL_TRACE_EVENT_ADD_WITH_ID_TID_AND_TIMESTAMPS(phase, category_group, name, id, thread_id, timestamp, thread_timestamp, flags)
//
// // Implementation detail: internal macro to create static category and add
    ...
    const char* arg1_name, ARG1_TYPE&& arg1_val)
{
    ...
    return base::trace_event::TraceEventHandle();
}
...
template <class ARG1_TYPE>
static void AddMetadataEvent(const unsigned char* category_group_enabled, const char* event_name, const char* arg_name, ARG1_TYPE&& arg_val)
{
...
public:
    ...
    void Initialize(const unsigned char* category_group_enabled, const char* name, base::trace_event::TraceEventHandle event_handle)
    {
...
#define TRACE_EVENT_BINARY_EFFICIENT0(category_group, name)                                                                                                    \
    trace_event_internal::ScopedTraceBinaryEfficient INTERNAL_TRACE_EVENT_UID(scoped_trace)(category_group, name);
