...
#include "base/trace_event/trace_event_empty.h"
...
#define INTERNAL_TRACE_EVENT_ADD_SCOPED_WITH_FLOW(...) INTERNAL_TRACE_IGNORE(__VA_ARGS__)
#define INTERNAL_TRACE_EVENT_ADD_WITH_ID_TID_AND_TIMESTAMP(...) INTERNAL_TRACE_IGNORE(__VA_ARGS__)
#define INTERNAL_TRACE_EVENT_ADD_WITH_ID_TID_AND_TIMESTAMPS(...) INTERNAL_TRACE_IGNORE(__VA_ARGS__)
...
class BASE_EXPORT ConvertableToTraceFormatStub {
 public:
   ConvertableToTraceFormatStub() = default;
   ConvertableToTraceFormatStub(const ConvertableToTraceFormatStub&) = delete;
   ConvertableToTraceFormatStub& operator=(const ConvertableToTraceFormatStub&) = delete;
  virtual ~ConvertableToTraceFormatStub();
...
class BASE_EXPORT TracedValue : public ConvertableToTraceFormatStub {
 public:
