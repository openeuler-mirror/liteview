...
// static
std::unique_ptr<TraceEventFilter> TestEventFilter::Factory(const std::string& predicate_name)
{
...
void TestEventFilter::EndEvent(const char* category_name, const char* name) const
{
    if (g_hits_counter)
