...
TEST(EstimateMemoryUsageTest, IsStandardContainerComplexIteratorTest)
{
    ...
    static_assert(internal::IsStandardContainerComplexIterator<std::list<int>::iterator>(), "");
    static_assert(internal::IsStandardContainerComplexIterator<std::list<int>::const_iterator>(), "");
    static_assert(internal::IsStandardContainerComplexIterator<std::list<int>::reverse_iterator>(), "");
    static_assert(internal::IsStandardContainerComplexIterator<std::list<int>::const_reverse_iterator>(), "");
