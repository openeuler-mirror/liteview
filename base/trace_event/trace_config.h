...
public:
    ...
    const EventFilters& event_filters() const
    {
...
private:
    ...
    void InitializeFromStrings(StringPiece category_filter_string, StringPiece trace_options_string);
