...
public:
    ...
    [[nodiscard]] ArrayScope BeginArrayScopedWithCopiedName(base::StringPiece name);
    ...
    [[nodiscard]] DictionaryScope BeginDictionaryScopedWithCopiedName(base::StringPiece name);
    ...
    //      })},
    //    });
    static std::unique_ptr<TracedValue> Build(const std::initializer_list<DictionaryItem> items);
    ...
    public:
        ...
        // These, instead, can be safely passed a temporary string.
        virtual void SetIntegerWithCopiedName(base::StringPiece name, int value) = 0;
        virtual void SetDoubleWithCopiedName(base::StringPiece name, double value) = 0;
        virtual void SetBooleanWithCopiedName(base::StringPiece name, bool value) = 0;
        virtual void SetStringWithCopiedName(base::StringPiece name, base::StringPiece value) = 0;
        virtual void SetValueWithCopiedName(base::StringPiece name, Writer* value) = 0;
