...
static_assert(std::is_same<BigEnoughPromotion<int16_t, int8_t>::type, int16_t>::value, "");
static_assert(std::is_same<BigEnoughPromotion<int32_t, uint32_t>::type, int64_t>::value, "");
static_assert(std::is_same<BigEnoughPromotion<intmax_t, int8_t>::type, intmax_t>::value, "");
static_assert(std::is_same<BigEnoughPromotion<uintmax_t, int8_t>::type, uintmax_t>::value, "");
static_assert(BigEnoughPromotion<int16_t, int8_t>::is_contained, "");
static_assert(BigEnoughPromotion<int32_t, uint32_t>::is_contained, "");
static_assert(BigEnoughPromotion<intmax_t, int8_t>::is_contained, "");
static_assert(!BigEnoughPromotion<uintmax_t, int8_t>::is_contained, "");
static_assert(std::is_same<FastIntegerArithmeticPromotion<int16_t, int8_t>::type, int32_t>::value, "");
static_assert(std::is_same<FastIntegerArithmeticPromotion<int32_t, uint32_t>::type, int64_t>::value, "");
static_assert(std::is_same<FastIntegerArithmeticPromotion<intmax_t, int8_t>::type, intmax_t>::value, "");
static_assert(std::is_same<FastIntegerArithmeticPromotion<uintmax_t, int8_t>::type, uintmax_t>::value, "");
...
static void TestSpecializedArithmetic(
    const char* dst, int line, typename std::enable_if<numeric_limits<Dst>::is_integer && numeric_limits<Dst>::is_signed, int>::type = 0)
{
...
template <typename Dst> void TestSpecializedArithmetic(const char* dst, int line, typename std::enable_if<numeric_limits<Dst>::is_iec559, int>::type = 0)
{
    using DstLimits = SaturationDefaultLimits<Dst>;
    TEST_EXPECTED_SUCCESS(-CheckedNumeric<Dst>(DstLimits::lowest()));
...
static_assert(std::is_same<decltype(TestOverload(StrictNumeric<int>())), int>::value, "");
static_assert(std::is_same<decltype(TestOverload(StrictNumeric<size_t>())), size_t>::value, "");
...
#pragma warning(disable : 4756)
    ...
    static_assert(std::is_same<int16_t, decltype(int8_min.ValueOrDie<int16_t>())::type>::value, "ValueOrDie returning incorrect type.");
    static_assert(std::is_same<int16_t, decltype(int8_min.ValueOrDefault<int16_t>(0))::type>::value, "ValueOrDefault returning incorrect type.");
