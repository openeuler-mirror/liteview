...
public:
    ...
    ArmCFITable(span<const uint32_t> function_addresses, span<const uint16_t> entry_data_indices, span<const uint8_t> entry_data);
    ...
    size_t GetTableSizeForTesting() const
    {
        return function_addresses_.size();
    }
