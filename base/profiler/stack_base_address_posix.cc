...
absl::optional<uintptr_t> GetThreadStackBaseAddress(PlatformThreadId id, pthread_t pthread_id)
{
    ...
    if (is_main_thread) {
        ...
        static const absl::optional<uintptr_t> main_thread_base_address = GetAndroidMainThreadStackBaseAddressImpl();
