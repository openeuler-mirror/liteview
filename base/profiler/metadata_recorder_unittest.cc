...
TEST(MetadataRecorderTest, ReclaimInactiveSlots)
{
    ...
    for (size_t i = 0; i < MetadataRecorder::MAX_METADATA_COUNT; ++i) {
        ...
        items_set.insert(MetadataRecorder::Item { i, absl::nullopt, absl::nullopt, static_cast<int64_t>(i) });
    }
    ...
    for (size_t i = 3; i < MetadataRecorder::MAX_METADATA_COUNT; i += 4) {
        ...
        ++entries_removed;
        items_set.erase(MetadataRecorder::Item { i, absl::nullopt, absl::nullopt, static_cast<int64_t>(i) });
    }
    ...
    for (size_t i = 1; i <= entries_removed; ++i) {
        ...
        items_set.insert(MetadataRecorder::Item { i * 100, absl::nullopt, absl::nullopt, static_cast<int64_t>(i * 100) });
    }
