...
#if (BUILDFLAG(IS_POSIX) && !BUILDFLAG(IS_IOS) && !defined(ARCH_CPU_ARM64)) || (BUILDFLAG(IS_FUCHSIA) && !defined(ARCH_CPU_ARM64)) || BUILDFLAG(IS_WIN)
...
MAYBE_TEST(ModuleCacheTest, GetDebugBasename)
{
    ...
    EXPECT_EQ("libbase_unittests__library",
        ...
        module->GetDebugBasename().RemoveFinalExtension().RemoveFinalExtension().value());
...
TEST(ModuleCacheTest, TransformELFModuleIDToBreakpadFormat)
{
    ...
    EXPECT_EQ(TransformModuleIDToBreakpadFormat("7F0715C286F8B16C10E4AD349CDA3B9B56C7A773"), "C215077FF8866CB110E4AD349CDA3B9B0");
}
#endif
