...
public:
    ...
    ScopedSampleMetadata(StringPiece name, int64_t value, SampleMetadataScope scope);
    ...
    ScopedSampleMetadata(StringPiece name, int64_t key, int64_t value, SampleMetadataScope scope);
...
BASE_EXPORT void ApplyMetadataToPastSamples(TimeTicks period_start, TimeTicks period_end, StringPiece name, int64_t value, SampleMetadataScope scope);
BASE_EXPORT void ApplyMetadataToPastSamples(
    TimeTicks period_start, TimeTicks period_end, StringPiece name, int64_t key, int64_t value, SampleMetadataScope scope);
