...
MetadataRecorder::Item::Item(uint64_t name_hash, absl::optional<int64_t> key, absl::optional<PlatformThreadId> thread_id, int64_t value)
    : name_hash(name_hash)
    , key(key)
    , thread_id(thread_id)
    , value(value)
...
void MetadataRecorder::Set(uint64_t name_hash, absl::optional<int64_t> key, absl::optional<PlatformThreadId> thread_id, int64_t value)
{
...
void MetadataRecorder::Remove(uint64_t name_hash, absl::optional<int64_t> key, absl::optional<PlatformThreadId> thread_id)
{
    AutoLock lock(write_lock_);
