...
TEST(ChromeUnwinderAndroidV2Test, TestFunctionOffsetTableLookupExactMatchingOffset)
{
...
TEST(ChromeUnwinderAndroidV2Test, TestFunctionOffsetTableLookupNonExactMatchingOffset)
{
    const uint8_t function_offset_table[] = {
        // Function 1: [(130, 2), (128, 3), (0, 4)]
        // offset = 130
...
TEST(ChromeUnwinderAndroidV2Test, TestAddressTableLookupInvalidIntructionOffset)
{
...
TEST(ChromeUnwinderAndroidV2Test, TestAddressTableLookupOnSecondPageOfFunctionSpanningPageBoundary)
{
...
TEST(ChromeUnwinderAndroidV2Test, TestAddressTableLookupWithinFunctionSpanningMultiplePages)
{
...
TEST(ChromeUnwinderAndroidV2Test, CanUnwindFrom)
{
    ...
    ChromeUnwinderAndroidV2 unwinder(dummy_unwind_info, chrome_module->GetBaseAddress(),
...
TEST(ChromeUnwinderAndroidV2Test, TryUnwind)
{
    ...
    ChromeUnwinderAndroidV2 unwinder(unwind_info, chrome_module->GetBaseAddress(), text_section_start_address);
    ...
    EXPECT_EQ(UnwindResult::kUnrecognizedFrame, unwinder.TryUnwind(&context, stack_memory.stack_end_address(), &unwound_frames));
...
TEST(ChromeUnwinderAndroidV2Test, TryUnwindInfiniteLoopSingleFrame)
{
    ...
    EXPECT_EQ(UnwindResult::kAborted, unwinder.TryUnwind(&context, stack_memory.stack_end_address(), &unwound_frames));
