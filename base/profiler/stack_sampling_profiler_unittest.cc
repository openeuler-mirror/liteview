...
// initialized.
    ...
    || (BUILDFLAG(IS_ANDROID) && BUILDFLAG(ENABLE_ARM_CFI_TABLE)) || (BUILDFLAG(IS_CHROMEOS) && defined(ARCH_CPU_X86_64) && !defined(MEMORY_SANITIZER))
...
{
    std::move(callback_).Run(Profile { samples_, record_metadata_count_, retrospective_metadata_, profile_duration, sampling_period });
}
