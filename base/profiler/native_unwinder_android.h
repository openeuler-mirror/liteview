...
public:
    ...
    NativeUnwinderAndroid(unwindstack::Maps* memory_regions_map, unwindstack::Memory* process_memory, uintptr_t exclude_module_with_base_address);
...
private:
    void EmitDexFrame(uintptr_t dex_pc, std::vector<Frame>* stack) const;
