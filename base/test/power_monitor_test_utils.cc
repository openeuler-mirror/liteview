...
void TestBatteryLevelProvider::GetBatteryState(base::OnceCallback<void(const absl::optional<base::BatteryLevelProvider::BatteryState>&)> callback)
{
    std::move(callback).Run(battery_state_);
}

void TestBatteryLevelProvider::SetBatteryState(absl::optional<base::BatteryLevelProvider::BatteryState> battery_state)
{
