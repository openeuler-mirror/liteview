...
PowerThermalObserver::DeviceThermalState PowerMonitorTestSource::GetCurrentThermalState()
{
...
PowerThermalObserver::DeviceThermalState ScopedPowerMonitorTestSource::GetCurrentThermalState()
{
...
void ScopedPowerMonitorTestSource::GeneratePowerStateEvent(bool on_battery_power)
{
