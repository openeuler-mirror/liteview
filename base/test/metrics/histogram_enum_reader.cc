...
absl::optional<HistogramEnumEntryMap> ParseEnumFromHistogramsXml(const std::string& enum_name, XmlReader* reader)
{
    int entries_index = -1;
...
absl::optional<HistogramEnumEntryMap> ReadEnumFromEnumsXml(const std::string& enum_name)
{
    FilePath src_root;
    ...
    base::FilePath enums_xml = src_root.AppendASCII("tools").AppendASCII("metrics").AppendASCII("histograms").AppendASCII("enums.xml");
