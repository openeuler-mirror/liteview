...
{
    {
        ...
        // stable enum.
        absl::optional<HistogramEnumEntryMap> results = ReadEnumFromEnumsXml("Boolean");
        ASSERT_TRUE(results);
    ...
    {
        absl::optional<HistogramEnumEntryMap> results = ReadEnumFromEnumsXml("TheWorstNameForAnEnum");
