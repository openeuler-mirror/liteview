...
public:
    ...
    void GetBatteryState(base::OnceCallback<void(const absl::optional<base::BatteryLevelProvider::BatteryState>&)> callback) override;

    void SetBatteryState(absl::optional<base::BatteryLevelProvider::BatteryState> battery_state);
