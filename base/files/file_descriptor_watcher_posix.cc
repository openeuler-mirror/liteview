...
class FileDescriptorWatcher::Controller::Watcher : public MessagePumpForIO/*MessagePumpGlib*/::FdWatcher, public CurrentThread::DestructionObserver {
public:
...
private:
    ...
    const scoped_refptr<SequencedTaskRunner> callback_task_runner_ = SequencedTaskRunnerHandle::Get();
