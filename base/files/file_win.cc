...
bool File::DeleteOnClose(bool delete_on_close)
{
    ...
    return ::SetFileInformationByHandleXp(GetPlatformFile(), FileDispositionInfo, &disposition, sizeof(disposition)) != 0;
}
...
File::Error File::OSErrorToFileError(DWORD last_error)
{
    ...
    default:
        UmaHistogramSparse("PlatformFile.UnknownErrors.Windows", static_cast<int>(last_error));
