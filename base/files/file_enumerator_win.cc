...
#include "base/win/windows_version.h" // SUPPORT_XP_CODE
...
#else
            find_handle_ = FindFirstFileEx(src.value().c_str(), (base::win::GetVersion() >= base::win::Version::WIN7 ? FindExInfoBasic : FindExInfoStandard),
                &find_data_, FindExSearchNameMatch, nullptr, (base::win::GetVersion() >= base::win::Version::WIN7 ? FIND_FIRST_EX_LARGE_FETCH : 0));
#endif
            has_find_data_ = true;
        } else {
