...
TEST(FileEnumerator, GetInfo)
{
    ...
    FileEnumerator file_enumerator(temp_dir.GetPath(), false, FileEnumerator::FILES);
...
TEST(FileEnumerator, GetInfoRecursive)
{
    ...
    TestDirectory directories[] = { TestDirectory(FILE_PATH_LITERAL("dir1")), TestDirectory(FILE_PATH_LITERAL("dir2")),
        TestDirectory(FILE_PATH_LITERAL("dir3")), TestDirectory(FILE_PATH_LITERAL("dirempty")) };
    ...
    std::vector<TestFile> files
        = { TestFile(FILE_PATH_LITERAL("dir1"), FILE_PATH_LITERAL("file1"), "First"), TestFile(FILE_PATH_LITERAL("dir1"), FILE_PATH_LITERAL("file2"), "Second"),
              TestFile(FILE_PATH_LITERAL("dir2"), FILE_PATH_LITERAL("fileA"), "Third-third-3"),
    ...
    FileEnumerator file_enumerator(temp_dir.GetPath(), true, FileEnumerator::FILES | FileEnumerator::DIRECTORIES);
    while (!file_enumerator.Next().empty()) {
        auto info = file_enumerator.GetInfo();
        bool found = false;
        if (info.IsDirectory()) {
