...
public:
    ...
    static GUID FormatRandomDataAsV4(base::span<const uint8_t, kGuidV4InputLength> input, base::PassKey<content::FileSystemAccessManagerImpl> pass_key);
    static GUID FormatRandomDataAsV4ForTesting(base::span<const uint8_t, kGuidV4InputLength> input);
...
private:
    static GUID FormatRandomDataAsV4Impl(base::span<const uint8_t, kGuidV4InputLength> input);
