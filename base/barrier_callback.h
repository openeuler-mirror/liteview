...
template <typename T, typename RawArg = base::remove_cvref_t<T>, typename DoneArg = std::vector<RawArg>, template <typename> class CallbackType,
    typename std::enable_if<std::is_same<std::vector<RawArg>, base::remove_cvref_t<DoneArg>>::value>::type* = nullptr,
