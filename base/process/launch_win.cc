...
bool GetAppOutputInternal(CommandLine::StringPieceType cl, bool include_stderr, std::string* output, int* exit_code)
{
...
Process LaunchElevatedProcess(const CommandLine& cmdline, bool start_hidden, bool wait)
{
    ...
    debug::GlobalActivityTracker::RecordProcessLaunchIfEnabled(GetProcessId(shex_info.hProcess), file, arguments);
