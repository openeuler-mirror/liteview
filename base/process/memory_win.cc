...
extern "C" void (*const free_unchecked)(void*);
extern "C" void* (* const realloc_unchecked)(void*, size_t);
...
// #pragma comment(linker, "/alternatename:_free_unchecked=_free_default")
// #elif defined(_M_X64) || defined(_M_ARM) || defined(_M_ARM64)
// #pragma comment(linker, "/alternatename:malloc_unchecked=malloc_default")
// #pragma comment(linker, "/alternatename:free_unchecked=free_default")
// #else
...
void* UncheckedRealloc(void* addr, size_t size)
{
    return realloc_unchecked(addr, size);
}
