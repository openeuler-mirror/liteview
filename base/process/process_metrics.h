...
public:
    ...
    // Exposed for testing.
    bool ParseProcTimeInState(const std::string& content, PlatformThreadId tid, TimeInStatePerThread& time_in_state_per_thread);
#endif // BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_CHROMEOS) ||                                                                                                     \
...
// Exposed for testing.
BASE_EXPORT bool ParseProcMeminfo(StringPiece input, SystemMemoryInfoKB* meminfo);
