...
#define SUPPORTS_LOCATION_BUILTINS (__has_builtin(__builtin_FUNCTION) && __has_builtin(__builtin_FILE) && __has_builtin(__builtin_LINE))
...
#ifdef _DEBUG //!BUILDFLAG(FROM_HERE_USES_LOCATION_BUILTINS)
#if 0 //!BUILDFLAG(ENABLE_LOCATION_SOURCE)
...
#ifdef _DEBUG
#define FROM_HERE ::base::Location::CreateFromHere(__func__, __FILE__, __LINE__)
#define FROM_CURRENT_HERE ::base::Location::CreateFromHere("", __FILE__, __LINE__)
#else
#define FROM_HERE ::base::Location::Current()
#define FROM_CURRENT_HERE ::base::Location::Current()
#endif
