...
TEST(TraitsBagTest, Filtering)
{
    ...
    static_assert(std::is_same<ExampleTrait2, decltype(Predicate::Filter(ExampleTrait2 {}))>::value, "ExampleTrait2 should not be filtered");

    static_assert(std::is_same<EmptyTrait, decltype(Predicate::Filter(ExampleTrait {}))>::value, "ExampleTrait should be filtered");

    static_assert(std::is_same<EmptyTrait, decltype(Predicate::Filter(EnumTraitA::A))>::value, "EnumTraitA should be filtered");

    static_assert(std::is_same<EnumTraitB, decltype(Predicate::Filter(EnumTraitB::TWO))>::value, "EnumTraitB should not be filtered");

    static_assert(std::is_same<EmptyTrait, decltype(Predicate::Filter(EmptyTrait {}))>::value, "EmptyTrait should not be filtered");
}
