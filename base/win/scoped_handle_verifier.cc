...
NOINLINE void ReportErrorOnScopedHandleOperation(const base::debug::StackTrace& creation_stack, HandleOperation operation)
{
...
NOINLINE void ReportErrorOnScopedHandleOperation(
    const base::debug::StackTrace& creation_stack, const ScopedHandleVerifierInfo& other, HandleOperation operation)
{
