...
TEST(WindowsVersion, GetVersionExAndKernelOsVersionMatch)
{
    ...
    // 18363.
    EXPECT_EQ(OSInfo::GetInstance()->Kernel32VersionNumber().major, OSInfo::GetInstance()->version_number().major);
    EXPECT_EQ(OSInfo::GetInstance()->Kernel32VersionNumber().minor, OSInfo::GetInstance()->version_number().minor);
}
...
TEST(OSInfo, MajorMinorBuildToVersion)
{
    ...
    EXPECT_EQ(OSInfo::MajorMinorBuildToVersion(10, 0, 20347), Version::WIN10_21H2);
