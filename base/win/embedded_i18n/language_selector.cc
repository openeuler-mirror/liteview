...
std::vector<std::wstring> GetCandidatesFromSystem(WStringPiece preferred_language)
{
...
LanguageSelector::LanguageSelector(WStringPiece preferred_language, span<const LangToOffset> languages_to_offset)
