...
TEST(ScopedSafearrayTest, ScopedSafearrayInitialLockScope)
{
    ...
    absl::optional<ScopedSafearray::LockScope<VT_I4>> lock_scope = scoped_safe_array.CreateLockScope<VT_I4>();
...
TEST(ScopedSafearrayTest, ScopedSafearrayLockScopeMoveConstructor)
{
    ...
    absl::optional<ScopedSafearray::LockScope<VT_I4>> first = scoped_safe_array.CreateLockScope<VT_I4>();
...
TEST(ScopedSafearrayTest, ScopedSafearrayLockScopeTypeMismatch)
{
    ...
    {
        absl::optional<ScopedSafearray::LockScope<VT_BSTR>> invalid_lock_scope = scoped_safe_array.CreateLockScope<VT_BSTR>();
        EXPECT_FALSE(invalid_lock_scope.has_value());
    }

    {
        absl::optional<ScopedSafearray::LockScope<VT_UI4>> invalid_lock_scope = scoped_safe_array.CreateLockScope<VT_UI4>();
        EXPECT_FALSE(invalid_lock_scope.has_value());
    }
}
