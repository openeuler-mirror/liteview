...
struct CHROME_FORMATETC {
    CLIPFORMAT cfFormat;
    /* [unique] */ /*DVTARGETDEVICE*/void* ptd;
    DWORD dwAspect;
    LONG lindex;
    DWORD tymed;
};
...
// #if _MSC_VER >= 1200
// #pragma warning(push)
// #pragma warning(disable:4005) // padding added after data member
...
inline WIN32_FIND_DATAW* ChromeToWindowsType(CHROME_WIN32_FIND_DATA* p)
{
    return reinterpret_cast<WIN32_FIND_DATAW*>(p);
}

inline const WIN32_FIND_DATAW* ChromeToWindowsType(const CHROME_WIN32_FIND_DATA* p)
{
    return reinterpret_cast<const WIN32_FIND_DATAW*>(p);
}

inline /*FORMATETC*/void* ChromeToWindowsType(CHROME_FORMATETC* p)
{
    return reinterpret_cast</*FORMATETC*/void*>(p);
}

inline const /*FORMATETC*/void* ChromeToWindowsType(const CHROME_FORMATETC* p)
{
    return reinterpret_cast<const /*FORMATETC*/void*>(p);
}
