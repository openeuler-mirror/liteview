...
FILETIME RegKey::GetLastWriteTime() const
{
    ...
    LONG result = RegQueryInfoKey(key_, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr, &last_write_time);
...
LONG RegKey::DeleteEmptyKey(const wchar_t* name)
{
    ...
    DWORD count = 0;
    result = RegQueryInfoKey(target_key, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr, &count, nullptr, nullptr, nullptr, nullptr);
    ...
    if (count == 0)
        return RegDeleteKeyExXp(key_, name, wow64access_, 0);
...
LONG RegKey::RegDelRecurse(HKEY root_key, const wchar_t* name, REGSAM access)
{
    ...
    LONG result = RegDeleteKeyExXp(root_key, name, access, 0);
    if (result == ERROR_SUCCESS)
        return result;
    ...
    while (result == ERROR_SUCCESS) {
        ...
        result = RegEnumKeyEx(target_key, 0, WriteInto(&key_name, kMaxKeyNameLength), &key_size, nullptr, nullptr, nullptr, nullptr);
    ...
    result = RegDeleteKeyExXp(root_key, name, access, 0);
