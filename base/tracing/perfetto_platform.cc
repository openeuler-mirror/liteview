...
void PerfettoPlatform::StartTaskRunner(scoped_refptr<SequencedTaskRunner> task_runner)
{
...
#if !BUILDFLAG(IS_NACL)
        return std::make_unique<perfetto::base::ThreadTaskRunner>(perfetto::base::ThreadTaskRunner::CreateAndStart());
#else
        DCHECK(false);
        return nullptr;
#endif
