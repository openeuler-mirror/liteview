...
#define NOTREACHED() LAZY_CHECK_STREAM(::logging::CheckError::NotReached(__FILE__, __LINE__).stream(), true)
#else
...
#if DCHECK_IS_ON()
#define NOTIMPLEMENTED() ::logging::CheckError::NotImplemented(__FILE__, __LINE__, __FUNCTION__).stream()
#else
