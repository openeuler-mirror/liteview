    ...
    , weak_factory_(this)
{
    ...
    kern_return_t kr = mach_port_allocate(mach_task_self(), MACH_PORT_RIGHT_RECEIVE, base::mac::ScopedMachReceiveRight::Receiver(wakeup_).get());
...
void MessagePumpKqueue::SetWakeupTimerEvent(const base::TimeTicks& wakeup_time, kevent64_s* timer_event)
{
...
void MessagePumpKqueue::MaybeUpdateWakeupTimer(const base::TimeTicks& wakeup_time)
{
