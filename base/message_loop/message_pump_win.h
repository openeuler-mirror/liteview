...
private:
    ...
    NOINLINE void NOT_TAIL_CALLED WaitForWork(Delegate::NextWorkInfo next_work_info);
...
public:
    ...
    bool WaitForIOCompletionWithHandler(DWORD timeout, MessagePumpForIO::IOHandler* filter);
