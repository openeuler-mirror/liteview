...
GSourceFuncs WorkSourceFuncs = { WorkSourcePrepare, WorkSourceCheck, WorkSourceDispatch, nullptr };
...
GSourceFuncs g_fd_watch_source_funcs = { FdWatchSourcePrepare, FdWatchSourceCheck, FdWatchSourceDispatch, nullptr };
    ...
    , wakeup_gpollfd_(std::make_unique<GPollFD>())
{
    ...
    work_source_ = std::unique_ptr<GSource, GSourceDeleter>(g_source_new(&WorkSourceFuncs, sizeof(WorkSource)));
