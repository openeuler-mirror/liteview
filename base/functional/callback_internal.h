...
private:
    ...
    BindStateBase(InvokeFuncStorage polymorphic_invoke, void (*destructor)(const BindStateBase*),
        bool (*query_cancellation_traits)(const BindStateBase*, CancellationQueryMode mode));
...
struct ThenHelper<OriginalCallback<void(OriginalArgs...)>, ThenCallback<ThenR(ThenArgs...)>> {
    ...
    {
        return [](OriginalCallback<void(OriginalArgs...)> c1, ThenCallback<ThenR(ThenArgs...)> c2, OriginalArgs... c1_args) {
...
struct ThenHelper<OriginalCallback<OriginalR(OriginalArgs...)>, ThenCallback<ThenR(ThenArgs...)>> {
    ...
    static auto CreateTrampoline()
    {
        return [](OriginalCallback<OriginalR(OriginalArgs...)> c1, ThenCallback<ThenR(ThenArgs...)> c2, OriginalArgs... c1_args) {
