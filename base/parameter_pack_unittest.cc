...
{
    static_assert(std::is_same<int, ParameterPack<int, float, bool>::NthType<0>>::value, "");
    static_assert(std::is_same<float, ParameterPack<int, float, bool>::NthType<1>>::value, "");
    static_assert(std::is_same<bool, ParameterPack<int, float, bool>::NthType<2>>::value, "");
}
