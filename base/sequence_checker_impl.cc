...
public:
    ...
    bool CalledOnValidSequence(std::unique_ptr<debug::StackTrace>* out_bound_at) const
    {
...
bool SequenceCheckerImpl::CalledOnValidSequence(std::unique_ptr<debug::StackTrace>* bound_at) const
{
