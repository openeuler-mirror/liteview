...
public:
    ...
    public:
        ...
        virtual void SampleAdded(void* address, size_t size, size_t total, AllocatorType type, const char* context) = 0;
    ...
    static void RecordAlloc(void* address, size_t, AllocatorType, const char* context);
...
private:
    ...
    void DoRecordAlloc(intptr_t accumulated_bytes, size_t size, void* address, AllocatorType type, const char* context);
