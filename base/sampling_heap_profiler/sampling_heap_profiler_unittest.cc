...
public:
    ...
    void SampleAdded(void* address, size_t size, size_t, PoissonAllocationSampler::AllocatorType, const char*) override
    {
...
TEST_F(SamplingHeapProfilerTest, MAYBE_MANUAL_SamplerMicroBenchmark)
{
    ...
    for (int i = 1; i <= kNumAllocations; ++i) {
        sampler->RecordAlloc(reinterpret_cast<void*>(static_cast<intptr_t>(i)), allocation_size, PoissonAllocationSampler::AllocatorType::kMalloc, nullptr);
    }
...
TEST_F(SamplingHeapProfilerTest, HookedAllocatorMuted)
{
...

    {
        ...
        sampler->RecordAlloc(kAddress, 10000, PoissonAllocationSampler::kManualForTesting, nullptr);
