...
TEST_F(PathServiceTest, Get)
{
    ...
    constexpr std::array kUnsupportedKeys = { // DIR_USER_DESKTOP is not implemented on iOS. See crbug.com/1257402.
        DIR_USER_DESKTOP
    };

#elif BUILDFLAG(IS_FUCHSIA)
    constexpr std::array kUnsupportedKeys = { // TODO(crbug.com/1231928): Implement DIR_USER_DESKTOP.
        DIR_USER_DESKTOP
    };
#else
...
TEST_F(PathServiceTest, AndroidTestOverrides)
{
    ...
    EXPECT_EQ(PathService::CheckedGet(DIR_GEN_TEST_DATA_ROOT).value(), kExpectedChromiumTestsRoot);
}
