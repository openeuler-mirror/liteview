...
#define INTERNAL_SCOPED_THREAD_PRIORITY_APPEND_LINE(name) INTERNAL_SCOPED_THREAD_PRIORITY_CONCAT1(name, __LINE__)
...
#define SCOPED_MAY_LOAD_LIBRARY_AT_BACKGROUND_PRIORITY()                                                                                                       \
    ...
    base::internal::ScopedMayLoadLibraryAtBackgroundPriority INTERNAL_SCOPED_THREAD_PRIORITY_APPEND_LINE(scoped_may_load_library_at_background_priority)(      \
