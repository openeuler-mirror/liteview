...
template <typename T, typename... Args> SequenceLocalStorageMap::ValueDestructorPair CreateValueDestructorPair(Args... args)
{
    T* value = new T(args...);
    SequenceLocalStorageMap::ValueDestructorPair::DestructorFunc* destructor = [](void* ptr) { std::default_delete<T>()(static_cast<T*>(ptr)); };

    SequenceLocalStorageMap::ValueDestructorPair value_destructor_pair { value, destructor };
...
TEST(SequenceLocalStorageMapTest, SetGet)
{
    ...
    SequenceLocalStorageMap::ValueDestructorPair value_destructor_pair = CreateValueDestructorPair<int>(5);
...
TEST(SequenceLocalStorageMapTest, Destructor)
{
...

    {
        ...
        SequenceLocalStorageMap::ValueDestructorPair value_destructor_pair = CreateValueDestructorPair<SetOnDestroy>(&set_on_destruction);
...
TEST(SequenceLocalStorageMapTest, DestructorCalledOnSetOverwrite)
{
    ...
    bool set_on_destruction2 = false;
    {
        ...
        SequenceLocalStorageMap::ValueDestructorPair value_destructor_pair = CreateValueDestructorPair<SetOnDestroy>(&set_on_destruction);
        SequenceLocalStorageMap::ValueDestructorPair value_destructor_pair2 = CreateValueDestructorPair<SetOnDestroy>(&set_on_destruction2);
