...
private:
    ...
    public:
        ...
        // to Clear().
        void Init(const HangWatchStates& watch_states, base::TimeTicks deadline_ignore_threshold);
...
public:
    ...
    static ThreadLocalPointer<HangWatchState>* GetHangWatchStateForCurrentThread();
