...
public:
    ...
    ThreadTaskRunnerHandleOverride& operator=(const ThreadTaskRunnerHandleOverride&) = delete;
...
private:
    ...
    explicit ThreadTaskRunnerHandleOverride(scoped_refptr<SingleThreadTaskRunner> overriding_task_runner, bool allow_nested_runloop = false)
        : contained_override_(std::move(overriding_task_runner), allow_nested_runloop)
    {
    }
...
public:
    explicit ThreadTaskRunnerHandleOverrideForTesting(scoped_refptr<SingleThreadTaskRunner> overriding_task_runner)
