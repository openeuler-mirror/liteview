...
INLINE_OR_NOT_TAIL_CALLED void AssertBlockingAllowed() EMPTY_BODY_IF_DCHECK_IS_OFF;
INLINE_OR_NOT_TAIL_CALLED void AssertBlockingDisallowedForTesting() EMPTY_BODY_IF_DCHECK_IS_OFF;
...
INLINE_OR_NOT_TAIL_CALLED void DisallowBaseSyncPrimitives() EMPTY_BODY_IF_DCHECK_IS_OFF;
...
// scope.
INLINE_OR_NOT_TAIL_CALLED void AssertBaseSyncPrimitivesAllowed() EMPTY_BODY_IF_DCHECK_IS_OFF;

// Resets all thread restrictions on the current thread.
INLINE_OR_NOT_TAIL_CALLED void ResetThreadRestrictionsForTesting() EMPTY_BODY_IF_DCHECK_IS_OFF;

// Check whether the current thread is allowed to use singletons (Singleton /
// LazyInstance).  DCHECKs if not.
INLINE_OR_NOT_TAIL_CALLED void AssertSingletonAllowed() EMPTY_BODY_IF_DCHECK_IS_OFF;
...
INLINE_OR_NOT_TAIL_CALLED void AssertLongCPUWorkAllowed() EMPTY_BODY_IF_DCHECK_IS_OFF;

INLINE_OR_NOT_TAIL_CALLED void DisallowUnresponsiveTasks() EMPTY_BODY_IF_DCHECK_IS_OFF;
