...
{
    ThreadTaskRunnerHandle thread_task_runner_handle(MakeRefCounted<TestSimpleTaskRunner>());
...
TEST(ThreadCheckerTest, AllowedSameThreadAndSequenceDifferentTasksWithThreadTaskRunnerHandle)
{
    ThreadTaskRunnerHandle thread_task_runner_handle(MakeRefCounted<TestSimpleTaskRunner>());
...
TEST(ThreadCheckerTest, AllowedSameThreadSequenceAndTaskNoThreadTaskRunnerHandle)
{
...
TEST(ThreadCheckerTest, DisallowedDifferentThreadsSameSequence)
{
    ...
    RunCallbackOnNewThreadSynchronously(
        BindOnce(&ExpectNotCalledOnValidThreadWithSequenceTokenAndThreadTaskRunnerHandle, Unretained(&thread_checker), sequence_token));
}
