...
#define DCHECK_CALLED_ON_VALID_THREAD(name, ...)                                                                                                               \
    base::ScopedValidateThreadChecker THREAD_CHECKER_INTERNAL_UID(scoped_validate_thread_checker_)(name, ##__VA_ARGS__);
...
public:
    ...
    ScopedValidateThreadChecker(const ThreadChecker& checker, const StringPiece& msg) EXCLUSIVE_LOCK_FUNCTION(checker);
