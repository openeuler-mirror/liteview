...
TEST(ThreadLocalTest, Pointer)
{
    ...
    char* tls_val;
    WaitableEvent done(WaitableEvent::ResetPolicy::MANUAL, WaitableEvent::InitialState::NOT_SIGNALED);
...
public:
    SetTrueOnDestruction(bool* was_destroyed)
...
{
    absl::optional<ThreadLocalOwnedPointer<SetTrueOnDestruction>> tls_owned_pointer(absl::in_place);
...
TEST(ThreadLocalTest, ThreadLocalOwnedPointerDeathIfDestroyedWithActiveThread)
{
    ...
    absl::optional<ThreadLocalOwnedPointer<int>> tls_owned_pointer(absl::in_place);
