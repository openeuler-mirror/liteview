...
absl::optional<std::vector<Instruction>> ExpectImmediateCrashInvocation(std::vector<Instruction> instructions)
{
    ...
    return absl::make_optional(std::vector<Instruction>(iter, instructions.end()));
}
