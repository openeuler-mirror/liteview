...
BASE_EXPORT bool EscapeJSONString(StringPiece str, bool put_in_quotes, std::string* dest);
...
BASE_EXPORT bool EscapeJSONString(StringPiece16 str, bool put_in_quotes, std::string* dest);
...
BASE_EXPORT std::string EscapeBytesAsInvalidJSONString(StringPiece str, bool put_in_quotes);
