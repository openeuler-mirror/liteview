...
enum JSONParserOptions {
    ...
    JSON_PARSE_CHROMIUM_EXTENSIONS = JSON_ALLOW_COMMENTS | JSON_ALLOW_CONTROL_CHARS | JSON_ALLOW_VERT_TAB | JSON_ALLOW_X_ESCAPES,
};
...
public:
    ...
    static absl::optional<Value> Read(StringPiece json, int options = JSON_PARSE_CHROMIUM_EXTENSIONS, size_t max_depth = internal::kAbsoluteMaxDepth);
    ...
    static std::unique_ptr<Value> ReadDeprecated(
        StringPiece json, int options = JSON_PARSE_CHROMIUM_EXTENSIONS, size_t max_depth = internal::kAbsoluteMaxDepth);
    ...
    static Result ReadAndReturnValueWithError(StringPiece json, int options = JSON_PARSE_CHROMIUM_EXTENSIONS);
};
