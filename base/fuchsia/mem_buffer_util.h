...
BASE_EXPORT absl::optional<std::u16string> ReadUTF8FromVMOAsUTF16(const fuchsia::mem::Buffer& buffer);
...
BASE_EXPORT fuchsia::mem::Buffer MemBufferFromString(StringPiece data, StringPiece name);
...
BASE_EXPORT fuchsia::mem::Buffer MemBufferFromString16(StringPiece16 data, StringPiece name);
...
BASE_EXPORT absl::optional<std::string> StringFromMemBuffer(const fuchsia::mem::Buffer& buffer);

// Returns the contents of `data`, or null if the read operation fails.
BASE_EXPORT absl::optional<std::string> StringFromMemData(const fuchsia::mem::Data& data);
...
BASE_EXPORT fuchsia::mem::Buffer CloneBuffer(const fuchsia::mem::Buffer& buffer, StringPiece name);
