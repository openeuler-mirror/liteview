...
public:
    ...
    static std::unique_ptr<ServiceProviderImpl> CreateForOutgoingDirectory(sys::OutgoingDirectory* outgoing_directory);

    explicit ServiceProviderImpl(fidl::InterfaceHandle<::fuchsia::io::Directory> service_directory);
    ...
    void SetOnLastClientDisconnectedClosure(base::OnceClosure on_last_client_disconnected);
