...
public:
    ...
    {
        provider_impl_ = ServiceProviderImpl::CreateForOutgoingDirectory(&service_directory_);
    ...
    void VerifyTestInterface(fidl::InterfacePtr<testfidl::TestInterface>* stub, zx_status_t expected_error)
    {
...
{
    ScopedServiceBinding<testfidl::TestInterface> service_binding(&service_directory_, &test_service_);

    testfidl::TestInterfacePtr stub;
    provider_client_->ConnectToService(testfidl::TestInterface::Name_, stub.NewRequest().TakeChannel());

    testfidl::TestInterfacePtr stub2;
    provider_client_->ConnectToService(testfidl::TestInterface::Name_, stub2.NewRequest().TakeChannel());
