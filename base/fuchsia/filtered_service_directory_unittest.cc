...
public:
    ...
    {
        filtered_service_directory_ = std::make_unique<FilteredServiceDirectory>(public_service_directory_);
        fidl::InterfaceHandle<::fuchsia::io::Directory> directory;
        EXPECT_EQ(filtered_service_directory_->ConnectClient(directory.NewRequest()), ZX_OK);
        filtered_client_ = std::make_unique<sys::ServiceDirectory>(std::move(directory));
    }
...
{
    EXPECT_EQ(filtered_service_directory_->AddService(testfidl::TestInterface::Name_), ZX_OK);
