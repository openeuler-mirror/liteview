...
TestComponentController::TestComponentController(TestComponentController&&) = default;

TestComponentController& TestComponentController::operator=(TestComponentController&&) = default;
