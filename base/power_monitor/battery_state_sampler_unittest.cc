...
public:
    ...
    void GetBatteryState(OnceCallback<void(const absl::optional<BatteryState>&)> callback) override
    {
...
public:
    ...
    void OnBatteryStateSampled(const absl::optional<BatteryLevelProvider::BatteryState>& battery_state) override
    {
...
// matter.
const absl::optional<BatteryLevelProvider::BatteryState> kTestBatteryState1 = BatteryLevelProvider::BatteryState { .battery_count = 1,
...
const absl::optional<BatteryLevelProvider::BatteryState> kTestBatteryState2 = BatteryLevelProvider::BatteryState { .battery_count = 1,
    .is_external_power_connected = false,
    .current_capacity = 5000,
    .full_charged_capacity = 10000,
    .charge_unit = BatteryLevelProvider::BatteryLevelUnit::kMWh };
const absl::optional<BatteryLevelProvider::BatteryState> kTestBatteryState3 = BatteryLevelProvider::BatteryState { .battery_count = 1,
