...
public:
    ...
    public:
        ...
        virtual void OnBatteryStateSampled(const absl::optional<BatteryLevelProvider::BatteryState>& battery_state) = 0;
    };
...
private:
    ...
    void OnInitialBatteryStateSampled(const absl::optional<BatteryLevelProvider::BatteryState>& battery_state);

    // Triggers the sampling of the battery state.
    void OnSamplingEvent();

    // Notifies observers of the sampled battery state.
    void OnBatteryStateSampled(const absl::optional<BatteryLevelProvider::BatteryState>& battery_state);
    ...
    absl::optional<BatteryLevelProvider::BatteryState> last_battery_state_ GUARDED_BY_CONTEXT(sequence_checker_);
