...
public:
    ...
    static bool AddPowerSuspendObserverAndReturnSuspendedState(PowerSuspendObserver* observer);
    // Returns true if the system is on-battery.
    static bool AddPowerStateObserverAndReturnOnBatteryState(PowerStateObserver* observer);
    // Returns the power thermal state.
    static PowerThermalObserver::DeviceThermalState AddPowerStateObserverAndReturnPowerThermalState(PowerThermalObserver* observer);
    ...
    static void SetCurrentThermalState(PowerThermalObserver::DeviceThermalState state);
...
private:
    ...
    static void NotifyThermalStateChange(PowerThermalObserver::DeviceThermalState new_state);
