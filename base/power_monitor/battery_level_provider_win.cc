...
absl::optional<BATTERY_INFORMATION> GetBatteryInformation(HANDLE battery, ULONG battery_tag)
{
...
absl::optional<BATTERY_STATUS> GetBatteryStatus(HANDLE battery, ULONG battery_tag)
{
...
public:
    ...
    void GetBatteryState(base::OnceCallback<void(const absl::optional<BatteryState>&)> callback) override
    {
...
private:
    ...
    void OnBatteryStateObtained(base::OnceCallback<void(const absl::optional<BatteryState>&)> callback, const absl::optional<BatteryState>& battery_state)
    {
...
// static
absl::optional<BatteryLevelProvider::BatteryState> BatteryLevelProviderWin::GetBatteryStateImpl()
{
    OutputDebugStringA("BatteryLevelProviderWin::GetBatteryStateImpl fail\n");
    return absl::nullopt;
