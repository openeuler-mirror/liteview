...
template <typename T> struct __is_cpp17_contiguous_iterator<::base::CheckedContiguousIterator<T>> : true_type { };

template <typename T> struct pointer_traits<::base::CheckedContiguousIterator<T>> {
