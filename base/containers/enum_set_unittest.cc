...
using TestEnumExtremeSet = EnumSet<TestEnumExtreme, TestEnumExtreme::TEST_MIN, TestEnumExtreme::TEST_MAX>;
...
{
    static_assert(TestEnumSet::All().Has(TestEnum::TEST_2), "Expected All() to be integral constant expression");
    static_assert(TestEnumSet::FromRange(TestEnum::TEST_2, TestEnum::TEST_4).Has(TestEnum::TEST_2), "Expected FromRange() to be integral constant expression");
    static_assert(TestEnumSet(TestEnum::TEST_2).Has(TestEnum::TEST_2), "Expected TestEnumSet() to be integral constant expression");
    static_assert(TestEnumSet::FromEnumBitmask(1 << static_cast<uint64_t>(TestEnum::TEST_2)).Has(TestEnum::TEST_2),
        "Expected TestEnumSet() to be integral constant expression");
    static_assert(TestEnumSet::single_val_bitstring(TestEnum::TEST_1) == 1, "Expected single_val_bitstring() to be integral constant expression");
    static_assert(TestEnumSet::bitstring(TestEnum::TEST_1, TestEnum::TEST_2) == 3, "Expected bitstring() to be integral constant expression");
}
...
{
    EXPECT_EQ(TestEnumSet(TestEnum::TEST_4, TestEnum::TEST_2, TestEnum::TEST_1, TestEnum::TEST_4, TestEnum::TEST_2, TestEnum::TEST_4),
...
{
    EXPECT_EQ(TestEnumSet(TestEnum::TEST_2, TestEnum::TEST_3, TestEnum::TEST_4), TestEnumSet::FromRange(TestEnum::TEST_2, TestEnum::TEST_4));
    EXPECT_EQ(TestEnumSet::All(), TestEnumSet::FromRange(TestEnum::TEST_1, TestEnum::TEST_5));
    EXPECT_EQ(TestEnumSet(TestEnum::TEST_2), TestEnumSet::FromRange(TestEnum::TEST_2, TestEnum::TEST_2));

    using RestrictedRangeSet = EnumSet<TestEnum, TestEnum::TEST_2, TestEnum::TEST_MAX>;
    EXPECT_EQ(RestrictedRangeSet(TestEnum::TEST_2, TestEnum::TEST_3, TestEnum::TEST_4), RestrictedRangeSet::FromRange(TestEnum::TEST_2, TestEnum::TEST_4));
    EXPECT_EQ(RestrictedRangeSet::All(), RestrictedRangeSet::FromRange(TestEnum::TEST_2, TestEnum::TEST_5));
}
...
TEST_F(EnumSetTest, Put)
{
    ...
    EXPECT_EQ(TestEnumSet(TestEnum::TEST_3, TestEnum::TEST_4, TestEnum::TEST_5), enums);
}
...
TEST_F(EnumSetTest, PutRange)
{
    ...
    EXPECT_EQ(TestEnumSet(TestEnum::TEST_2, TestEnum::TEST_3, TestEnum::TEST_4), enums);
}
...
TEST_F(EnumSetTest, Union)
{
    ...
    EXPECT_EQ(TestEnumSet(TestEnum::TEST_3, TestEnum::TEST_4, TestEnum::TEST_5), enums3);
}
...
TEST_F(EnumSetTest, ToFromEnumBitmask)
{
    ...
    const TestEnumSet enums2(TestEnum::TEST_3, TestEnum::TEST_4);
    const uint64_t val2 = 1ULL << static_cast<uint64_t>(TestEnum::TEST_3) | 1ULL << static_cast<uint64_t>(TestEnum::TEST_4);
...
TEST_F(EnumSetTest, FromEnumBitmaskIgnoresExtraBits)
{
    ...
    for (const TestEnumSet& set : kSets) {
        ...
        const uint64_t kJunkVals[] = {
            ...
            val | single_val_bitstring(TestEnum::TEST_6_OUT_OF_BOUNDS) | single_val_bitstring(TestEnum::TEST_7_OUT_OF_BOUNDS),
...
{
    EXPECT_CHECK_DEATH(TestEnumSet::single_val_bitstring(TestEnum::TEST_BELOW_MIN));
    EXPECT_CHECK_DEATH(TestEnumSet::single_val_bitstring(TestEnum::TEST_6_OUT_OF_BOUNDS));
...
TEST_F(EnumSetTest, SparseEnum)
{
    ...
    using TestEnumSparseSet = EnumSet<TestEnumSparse, TestEnumSparse::TEST_MIN, TestEnumSparse::TEST_MAX>;
...
TEST_F(EnumSetDeathTest, SingleValBitstringEnumWithNegatives)
{
    ...
    using TestEnumWithNegSet = EnumSet<TestEnumNeg, TestEnumNeg::TEST_MIN, TestEnumNeg::TEST_MAX>;

    // Should crash because TEST_BELOW_MIN is not in range.
    EXPECT_CHECK_DEATH(TestEnumWithNegSet::single_val_bitstring(TestEnumNeg::TEST_BELOW_MIN));
    // TEST_D is in range, but note that TEST_MIN is negative. This should work.
    EXPECT_EQ(TestEnumWithNegSet::single_val_bitstring(TestEnumNeg::TEST_D), 1u << 3);
    // Even though TEST_A is negative, it is in range, so this should work.
    EXPECT_EQ(TestEnumWithNegSet::single_val_bitstring(TestEnumNeg::TEST_A), 1u << 0);
}
...
TEST_F(EnumSetDeathTest, FromRangeCrashesOnBadInputs)
{
    ...
    EXPECT_CHECK_DEATH(TestEnumSet().FromRange(TestEnum::TEST_3, TestEnum::TEST_1));

    // FromRange crashes when the start value is out of range.
    EXPECT_CHECK_DEATH(TestEnumSet().FromRange(TestEnum::TEST_BELOW_MIN, TestEnum::TEST_1));
    EXPECT_CHECK_DEATH(TestEnumSet().FromRange(TestEnum::TEST_BELOW_MIN_NEGATIVE, TestEnum::TEST_1));
    EXPECT_CHECK_DEATH(TestEnumSet().FromRange(TestEnum::TEST_6_OUT_OF_BOUNDS, TestEnum::TEST_1));

    // FromRange crashes when the end value is out of range.
    EXPECT_CHECK_DEATH(TestEnumSet().FromRange(TestEnum::TEST_3, TestEnum::TEST_BELOW_MIN));
    EXPECT_CHECK_DEATH(TestEnumSet().FromRange(TestEnum::TEST_3, TestEnum::TEST_BELOW_MIN_NEGATIVE));
    ...
    EXPECT_CHECK_DEATH(TestEnumSet().FromRange(TestEnum::TEST_7_OUT_OF_BOUNDS, TestEnum::TEST_6_OUT_OF_BOUNDS));
    EXPECT_CHECK_DEATH(TestEnumSet().FromRange(TestEnum::TEST_6_OUT_OF_BOUNDS, TestEnum::TEST_7_OUT_OF_BOUNDS));
}
...
TEST_F(EnumSetDeathTest, PutRangeCrashesOnBadInputs)
{
    ...
    EXPECT_CHECK_DEATH(TestEnumSet().PutRange(TestEnum::TEST_BELOW_MIN_NEGATIVE, TestEnum::TEST_BELOW_MIN));
    EXPECT_CHECK_DEATH(TestEnumSet().PutRange(TestEnum::TEST_3, TestEnum::TEST_7_OUT_OF_BOUNDS));

    // Crashes when both inputs are out of range.
    EXPECT_CHECK_DEATH(TestEnumSet().PutRange(TestEnum::TEST_6_OUT_OF_BOUNDS, TestEnum::TEST_7_OUT_OF_BOUNDS));

    // Crashes when inputs are out of order.
    EXPECT_CHECK_DEATH(TestEnumSet().PutRange(TestEnum::TEST_2, TestEnum::TEST_1));
}
