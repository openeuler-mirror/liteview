...
TEST(ContiguousIteratorTest, ForwardIterator)
{
    ...
    static_assert(std::is_same<std::forward_iterator_tag, typename std::iterator_traits<ForwardIterator>::iterator_category>::value,
        "Error: The iterator_category of ForwardIterator is not "
        "std::forward_iterator_tag.");
    static_assert(!IsContiguousIterator<ForwardIterator>::value, "Error: ForwardIterator should not be considered a contiguous iterator.");
...
TEST(ContiguousIteratorTest, BidirectionalIterator)
{
    ...
    static_assert(std::is_same<std::bidirectional_iterator_tag, typename std::iterator_traits<BidirectionalIterator>::iterator_category>::value,
    ...
    static_assert(!IsContiguousIterator<std::reverse_iterator<BidirectionalIterator>>::value,
...
TEST(ContiguousIteratorTest, RandomAccessIterator)
{
    ...
    static_assert(std::is_same<std::random_access_iterator_tag, typename std::iterator_traits<RandomAccessIterator>::iterator_category>::value,
    ...
    static_assert(!IsContiguousIterator<const RandomAccessIterator&>::value,
        ...
        "a contiguous iterator.");
    static_assert(!IsContiguousIterator<std::reverse_iterator<RandomAccessIterator>>::value,
...
{
    static_assert(IsContiguousIterator<int*>::value, "Error: int* should be considered a contiguous iterator.");

    static_assert(IsContiguousIterator<int* const>::value, "Error: int* const should be considered a contiguous iterator.");
...
TEST(ContiguousIterator, VectorInt)
{
    ...
    static_assert(!IsContiguousIterator<std::vector<int>::reverse_iterator>::value,
        "Error: std::vector<int>::reverse_iterator should not be considered a "
        "contiguous iterator.");

    static_assert(!IsContiguousIterator<std::vector<int>::const_reverse_iterator>::value,
...
TEST(ContiguousIterator, VectorString)
{
    ...
    static_assert(IsContiguousIterator<std::vector<std::string>::const_iterator>::value,
        "Error: std::vector<std::string>::const_iterator should be considered a "
        "contiguous iterator.");

    static_assert(!IsContiguousIterator<std::vector<std::string>::reverse_iterator>::value,
        "Error: std::vector<std::string>::reverse_iterator should not be "
        "considered a contiguous iterator.");

    static_assert(!IsContiguousIterator<std::vector<std::string>::const_reverse_iterator>::value,
...
TEST(ContiguousIterator, VectorBool)
{
    ...
    static_assert(!IsContiguousIterator<std::vector<bool>::reverse_iterator>::value,
        "Error: std::vector<bool>::reverse_iterator should not be considered a "
        "contiguous iterator.");

    static_assert(!IsContiguousIterator<std::vector<bool>::const_reverse_iterator>::value,
...
TEST(ContiguousIterator, ArrayInt)
{
    ...
    static_assert(!IsContiguousIterator<std::array<int, 1>::reverse_iterator>::value,
        "Error: std::array<int, 1>::reverse_iterator should not be considered "
        "a contiguous iterator.");

    static_assert(!IsContiguousIterator<std::array<int, 1>::const_reverse_iterator>::value,
...
{
    static_assert(IsContiguousIterator<std::array<std::string, 1>::iterator>::value,
        "Error: std::array<std::string, 1>::iterator should be considered a "
        "contiguous iterator.");

    static_assert(IsContiguousIterator<std::array<std::string, 1>::const_iterator>::value,
        "Error: std::array<std::string, 1>::const_iterator should be considered "
        "a contiguous iterator.");

    static_assert(!IsContiguousIterator<std::array<std::string, 1>::reverse_iterator>::value,
        "Error: std::array<std::string, 1>::reverse_iterator should "
        "not be considered a contiguous iterator.");

    static_assert(!IsContiguousIterator<std::array<std::string, 1>::const_reverse_iterator>::value,
...
TEST(ContiguousIterator, String)
{
    ...
    static_assert(!IsContiguousIterator<std::string::const_reverse_iterator>::value,
...
TEST(ContiguousIterator, String16)
{
    ...
    static_assert(!IsContiguousIterator<std::u16string::const_reverse_iterator>::value,
...
{
    static_assert(IsContiguousIterator<decltype(std::begin(std::declval<std::valarray<int>&>()))>::value,
        "Error: std::valarray<int>::iterator should be considered a "
        "contiguous iterator.");

    static_assert(IsContiguousIterator<decltype(std::begin(std::declval<const std::valarray<int>&>()))>::value,
...
{
    static_assert(IsContiguousIterator<decltype(std::begin(std::declval<std::valarray<std::string>&>()))>::value,
        "Error: std::valarray<std::string>::iterator should be "
        "considered a contiguous iterator.");

    static_assert(IsContiguousIterator<decltype(std::begin(std::declval<const std::valarray<std::string>&>()))>::value,
...
{
    static_assert(IsContiguousIterator<base::StringPiece::const_iterator>::value,
        "Error: base::StringPiece::const_iterator should be considered a "
        "contiguous iterator.");

    static_assert(!IsContiguousIterator<base::StringPiece::const_reverse_iterator>::value,
...
TEST(ContiguousIterator, SpanString)
{
    ...
    static_assert(!IsContiguousIterator<base::span<std::string>::reverse_iterator>::value,
