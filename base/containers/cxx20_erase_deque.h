...
template <class T, class Allocator, class Value> size_t Erase(std::deque<T, Allocator>& container, const Value& value)
{
...
template <class T, class Allocator, class Predicate> size_t EraseIf(std::deque<T, Allocator>& container, Predicate pred)
{
