...
public:
    ...
    template <typename Functor> void EraseIf(Functor predicate)
    {
        ...
        std::move(erase_start, impl_.heap_.end(), std::back_inserter(elements_to_delete.container()));
...
private:
    ...
    // integral types.
    template <typename I, typename = std::enable_if_t<std::is_integral<I>::value>> size_type ToIndex(I pos)
    {
...
template <typename T, typename Compare, typename HeapHandleAccessor>
template <class InputIterator>
void IntrusiveHeap<T, Compare, HeapHandleAccessor>::insert(InputIterator first, InputIterator last)
{
...
typename IntrusiveHeap<T, Compare, HeapHandleAccessor>::const_iterator IntrusiveHeap<T, Compare, HeapHandleAccessor>::emplace(Args&&... args)
{
