...
public:
    ...
    // removed prior to insertion. An iterator indicating the inserted item will
    // be returned (this will always be the front of the list).
    template <class K, class V, class MapKeyGetter = GetKeyFromKVPair, class = std::enable_if_t<std::is_same_v<MapKeyGetter, GetKeyFromValue>>>
...
using LRUCacheSet = internal::LRUCacheBase<ValueType, identity, internal::LRUCacheKeyIndex<ValueType, Compare>>;
...
using HashingLRUCacheSet = internal::LRUCacheBase<ValueType, identity, internal::HashingLRUCacheKeyIndex<ValueType, Hash, Equal>>;
