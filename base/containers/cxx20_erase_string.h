...
size_t Erase(std::basic_string<CharT, Traits, Allocator>& container, const Value& value)
{
...
size_t EraseIf(std::basic_string<CharT, Traits, Allocator>& container, Predicate pred)
{
...
#endif // BASE_CONTAINERS_CXX20_ERASE_STRING_H_
