...
// static
// LazyInstance<absl::Mutex>::Leaky StatisticsRecorder::lock_ = LAZY_INSTANCE_INITIALIZER;
//
// // static
...
// static
StatisticsRecorder::Histograms StatisticsRecorder::WithName(Histograms histograms, const std::string& query)
{
...
// static
StatisticsRecorder::Histograms StatisticsRecorder::NonPersistent(Histograms histograms)
{
    //   histograms.erase(
    //       ranges::remove_if(histograms,
