...
public:
    ...
    static PersistentMemoryAllocator::Reference GetNextPersistentRecord(PersistentMemoryAllocator::Iterator& iterator, uint64_t* sample_map_id);
...
private:
    ...
    HistogramBase::Count* ImportSamples(HistogramBase::Sample until_value, bool import_everything);
