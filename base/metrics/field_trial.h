...
public:
    ...
    public:
        ...
        virtual double GetEntropyForTrial(StringPiece trial_name, uint32_t randomization_seed) const = 0;
    ...
    struct BASE_EXPORT FieldTrialEntry {
        ...
        bool GetTrialAndGroupName(StringPiece* trial_name, StringPiece* group_name) const;
    ...
    private:
        ...
        // and |group_name|.
        bool ReadStringPair(PickleIterator* iter, StringPiece* trial_name, StringPiece* group_name) const;
    };
    ...
    static FieldTrial* CreateSimulatedFieldTrial(StringPiece trial_name, Probability total_probability, StringPiece default_group_name, double entropy_value);
...
private:
    ...
    FieldTrial(StringPiece trial_name, Probability total_probability, StringPiece default_group_name, double entropy_value);

    virtual ~FieldTrial();

    // Return the default group name of the FieldTrial.
    const std::string& default_group_name() const
    {
    ...
    const std::string& group_name_internal() const
    {
        return group_name_;
    }
...
public:
    ...
    public:
        ...
        virtual void OnFieldTrialGroupFinalized(const std::string& trial_name, const std::string& group_name) = 0;
    ...
    static FieldTrial* FactoryGetFieldTrial(StringPiece trial_name, FieldTrial::Probability total_probability, StringPiece default_group_name,
        const FieldTrial::EntropyProvider& entropy_provider, uint32_t randomization_seed = 0);
    ...
    static void GetActiveFieldTrialGroupsFromString(const std::string& trials_string, FieldTrial::ActiveGroups* active_groups);
    ...
    static void GetInitiallyActiveFieldTrials(const CommandLine& command_line, FieldTrial::ActiveGroups* active_groups);
    ...
    // allocator.
    static void CreateTrialsFromCommandLine(const CommandLine& cmd_line, uint32_t fd_key);
    ...
    static void CreateFeaturesFromCommandLine(const CommandLine& command_line, FeatureList* feature_list);
    ...
    static void PopulateLaunchOptionsWithFieldTrialState(CommandLine* command_line, LaunchOptions* launch_options);
    ...
    static const FieldTrial::EntropyProvider& GetEntropyProviderForSessionRandomization();
...
private:
    ...
    static ReadOnlySharedMemoryRegion DeserializeSharedMemoryRegionMetadata(const std::string& switch_value, int fd);
    ...
    static bool CreateTrialsFromSwitchValue(const std::string& switch_value, uint32_t fd_key);
