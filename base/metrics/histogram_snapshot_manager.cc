...
class MakeActive {
public:
    explicit MakeActive(std::atomic<bool>* is_active)
...
void HistogramSnapshotManager::PrepareSamples(const HistogramBase* histogram, std::unique_ptr<HistogramSamples> samples)
{
    DCHECK(histogram_flattener_);
