...
TEST_F(HistogramSnapshotManagerTest, PrepareDeltasNoFlagsFilter)
{
    ...
    StatisticsRecorder::PrepareDeltas(false, HistogramBase::kNoFlags, HistogramBase::kNoFlags, &histogram_snapshot_manager_);
...
TEST_F(HistogramSnapshotManagerTest, PrepareDeltasUmaHistogramFlagFilter)
{
    ...
    StatisticsRecorder::PrepareDeltas(false, HistogramBase::kNoFlags, HistogramBase::kUmaTargetedHistogramFlag, &histogram_snapshot_manager_);
...
TEST_F(HistogramSnapshotManagerTest, PrepareDeltasUmaStabilityHistogramFlagFilter)
{
    ...
    StatisticsRecorder::PrepareDeltas(false, HistogramBase::kNoFlags, HistogramBase::kUmaStabilityHistogramFlag, &histogram_snapshot_manager_);
