...
public:
    Factory(const std::string& name, HistogramBase::Sample minimum, HistogramBase::Sample maximum, size_t bucket_count, int32_t flags)
...
protected:
    Factory(
        const std::string& name, HistogramType histogram_type, HistogramBase::Sample minimum, HistogramBase::Sample maximum, size_t bucket_count, int32_t flags)
        : name_(name)
...
HistogramBase* Histogram::FactoryTimeGet(const std::string& name, TimeDelta minimum, TimeDelta maximum, size_t bucket_count, int32_t flags)
{
    ...
    return FactoryGet(name, static_cast<Sample>(minimum.InMilliseconds()), static_cast<Sample>(maximum.InMilliseconds()), bucket_count, flags);
}
...
HistogramBase* Histogram::FactoryMicrosecondsTimeGet(const std::string& name, TimeDelta minimum, TimeDelta maximum, size_t bucket_count, int32_t flags)
{
    ...
    return FactoryGet(name, static_cast<Sample>(minimum.InMicroseconds()), static_cast<Sample>(maximum.InMicroseconds()), bucket_count, flags);
}
...
// static
bool Histogram::InspectConstructionArguments(StringPiece name, Sample* minimum, Sample* maximum, size_t* bucket_count)
{
...
HistogramBase* LinearHistogram::FactoryGetWithRangeDescription(
    const std::string& name, Sample minimum, Sample maximum, size_t bucket_count, int32_t flags, const DescriptionPair descriptions[])
{
