...
template <typename T, bool IsEnum = std::is_enum<T>::value> struct FeatureParam {
...
template <> struct FeatureParam<base::TimeDelta> {
    constexpr FeatureParam(const Feature* feature, const char* name, base::TimeDelta default_value)
        : feature(feature)
        , name(name)
        , default_value(default_value)
    {
