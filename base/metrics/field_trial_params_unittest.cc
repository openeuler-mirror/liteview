...
#if DCHECK_IS_ON()
#define EXPECT_DCHECK_OR_EQ(val1, val2) EXPECT_DEATH_IF_SUPPORTED(std::make_pair(val1, val2), ".*")
#else
...
TEST_F(FieldTrialParamsTest, FeatureParamTimeDelta)
{
    ...
    static BASE_FEATURE(kFeature, "TestFeature", FEATURE_DISABLED_BY_DEFAULT);
    static const FeatureParam<base::TimeDelta> a { &kFeature, "a", base::TimeDelta() };
    static const FeatureParam<base::TimeDelta> b { &kFeature, "b", base::TimeDelta() };
    static const FeatureParam<base::TimeDelta> c { &kFeature, "c", base::TimeDelta() };
    static const FeatureParam<base::TimeDelta> d { &kFeature, "d", base::TimeDelta() };
    static const FeatureParam<base::TimeDelta> e { &kFeature, "e", base::TimeDelta() };
    static const FeatureParam<base::TimeDelta> f { &kFeature, "f", base::TimeDelta() };
