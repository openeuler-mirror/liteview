...
public:
    ...
    {
        TRACE_EVENT_BEGIN2(internal::CategoryName::kTimeline, internal::kCompositeLayers, internal::kLayerTreeId, layer_tree_host_id,
            internal::kFrameSequenceNumber, sequence_number);
    }
    ScopedCommitTrace(const ScopedCommitTrace&) = delete;
    ~ScopedCommitTrace()
    {
        TRACE_EVENT_END0(internal::CategoryName::kTimeline, internal::kCompositeLayers);
    }
