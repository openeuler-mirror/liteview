...
CC_BASE_EXPORT BASE_DECLARE_FEATURE(kDurationEstimatesInCompositorTimingHistory);
...
// being deferred.
CC_BASE_EXPORT BASE_DECLARE_FEATURE(kSkipCommitsIfNotSynchronizingCompositorState);
