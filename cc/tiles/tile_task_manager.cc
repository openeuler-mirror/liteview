...
// static
std::unique_ptr<TileTaskManagerImpl> TileTaskManagerImpl::Create(TaskGraphRunner* task_graph_runner)
{
    return base::WrapUnique<TileTaskManagerImpl>(new TileTaskManagerImpl(task_graph_runner));
}
