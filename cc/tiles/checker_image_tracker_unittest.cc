...
public:
    ...
    TestImageController()
        : ImageController(base::ThreadTaskRunnerHandle::Get().get(), base::ThreadTaskRunnerHandle::Get())
    {
...
public:
    ...
    DrawImage CreateImage(ImageType image_type, PaintImage::AnimationType animation = PaintImage::AnimationType::STATIC,
        PaintImage::CompletionState completion = PaintImage::CompletionState::DONE, bool is_multipart = false)
    {
        int dimension = 0;
        switch (image_type) {
...
TEST_F(CheckerImageTrackerTest, CheckersOnlyStaticCompletedImages)
{
    ...
    DrawImage animated_image = CreateImage(ImageType::CHECKERABLE, PaintImage::AnimationType::ANIMATED);
    DrawImage partial_image = CreateImage(ImageType::CHECKERABLE, PaintImage::AnimationType::STATIC, PaintImage::CompletionState::PARTIALLY_DONE);
    DrawImage video_image = CreateImage(ImageType::CHECKERABLE, PaintImage::AnimationType::VIDEO);
...
TEST_F(CheckerImageTrackerTest, DontCheckerMultiPartImages)
{
    ...
    DrawImage multi_part_image = CreateImage(ImageType::CHECKERABLE, PaintImage::AnimationType::STATIC, PaintImage::CompletionState::DONE, true);
