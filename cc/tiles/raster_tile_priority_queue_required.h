...
private:
    ...
    void Build(const std::vector<PictureLayerImpl*>& active_layers, const std::vector<PictureLayerImpl*>& pending_layers, Type type);
    void BuildRequiredForDraw(const std::vector<PictureLayerImpl*>& active_layers);
    void BuildRequiredForActivation(const std::vector<PictureLayerImpl*>& active_layers, const std::vector<PictureLayerImpl*>& pending_layers);
