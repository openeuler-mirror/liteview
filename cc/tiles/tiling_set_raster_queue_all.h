...
public:
    TilingSetRasterQueueAll(PictureLayerTilingSet* tiling_set, bool prioritize_low_res, bool is_drawing_layer);
...
private:
    ...
    public:
        TilingIterator();
        explicit TilingIterator(PictureLayerTiling* tiling, TilingData* tiling_data);
        ~TilingIterator();
