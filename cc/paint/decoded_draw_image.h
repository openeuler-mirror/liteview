...
public:
    DecodedDrawImage(sk_sp<SkImage> image, sk_sp<SkColorFilter> dark_mode_color_filter, const SkSize& src_rect_offset, const SkSize& scale_adjustment,
    ...
    DecodedDrawImage(absl::optional<uint32_t> transfer_cache_entry_id, sk_sp<SkColorFilter> dark_mode_color_filter, const SkSize& src_rect_offset,
