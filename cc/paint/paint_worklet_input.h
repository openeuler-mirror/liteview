...
class CC_PAINT_EXPORT PaintWorkletInput : public base::RefCountedThreadSafe<PaintWorkletInput> {
public:
...
using PaintWorkletRecordMap = base::flat_map<scoped_refptr<const PaintWorkletInput>, std::pair<PaintImage::Id, sk_sp<PaintRecord>>>;
