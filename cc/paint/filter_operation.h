...
public:
    ...
    static FilterOperation CreateAlphaThresholdFilter(const ShapeRects& shape, float inner_threshold, float outer_threshold)
    {
        return FilterOperation(ALPHA_THRESHOLD, shape, inner_threshold, outer_threshold);
    }
...
private:
    friend class FilterOperationTest;
    ...
    FilterOperation(FilterType type, const ShapeRects& shape, float inner_threshold, float outer_threshold);
