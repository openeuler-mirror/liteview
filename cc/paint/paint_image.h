...
public:
    ...
    // is texture backed.
    bool Decode(void* memory, SkImageInfo* info, sk_sp<SkColorSpace> color_space, size_t frame_index, GeneratorClientId client_id) const;
    ...
    bool DecodeYuv(const SkYUVAPixmaps& pixmaps, size_t frame_index, GeneratorClientId client_id) const;
    ...
    // transformation.
    bool IsYuv(const SkYUVAPixmapInfo::SupportedDataTypes& supported_data_types, SkYUVAPixmapInfo* info = nullptr) const;
...
private:
    ...
    bool DecodeFromGenerator(void* memory, SkImageInfo* info, sk_sp<SkColorSpace> color_space, size_t frame_index, GeneratorClientId client_id) const;
