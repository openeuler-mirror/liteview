...
TEST(FilterOperationsTest, MapRectReverseBlur)
{
    FilterOperations ops;
    ops.Append(FilterOperation::CreateBlurFilter(20));
    EXPECT_EQ(gfx::Rect(60, 60, 30, 30), ops.MapRectReverse(gfx::Rect(0, 0, 150, 150), SkMatrix::I()));
    EXPECT_EQ(gfx::Rect(120, 120, 60, 60), ops.MapRectReverse(gfx::Rect(0, 0, 300, 300), SkMatrix::Scale(2, 2)));
    EXPECT_EQ(gfx::Rect(60, 50, 30, 30), ops.MapRectReverse(gfx::Rect(0, -10, 150, 150), SkMatrix::Scale(1, -1)));
}
...
TEST(FilterOperationsTest, MapRectReverseDropShadowReferenceFilter)
{
    ...
    ops.Append(FilterOperation::CreateReferenceFilter(sk_make_sp<DropShadowPaintFilter>(SkIntToScalar(3), SkIntToScalar(8), SkIntToScalar(4), SkIntToScalar(9),
        SkColors::kBlack, DropShadowPaintFilter::ShadowMode::kDrawShadowAndForeground, nullptr)));
    EXPECT_EQ(gfx::Rect(-15, -35, 34, 64), ops.MapRectReverse(gfx::Rect(0, 0, 10, 10), SkMatrix::I()));
    EXPECT_EQ(gfx::Rect(-30, -70, 68, 128), ops.MapRectReverse(gfx::Rect(0, 0, 20, 20), SkMatrix::Scale(2, 2)));
    EXPECT_EQ(gfx::Rect(-15, -29, 34, 64), ops.MapRectReverse(gfx::Rect(0, -10, 10, 10), SkMatrix::Scale(1, -1)));
}
