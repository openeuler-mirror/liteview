...
struct CC_PAINT_EXPORT TargetColorParams {
    ...
    bool operator<(const TargetColorParams& other) const
    {
        return std::tie(color_space, sdr_max_luminance_nits, hdr_max_luminance_relative)
            < std::tie(other.color_space, other.sdr_max_luminance_nits, other.hdr_max_luminance_relative);
    }
