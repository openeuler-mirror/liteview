...
public:
    ...
    struct ImageAssetMetadata {
        ImageAssetMetadata(base::FilePath resource_path_in, absl::optional<gfx::Size> size_in);
    ...
    // invalid.
    bool RegisterAsset(base::StringPiece resource_path, base::StringPiece resource_name, base::StringPiece resource_id, absl::optional<gfx::Size> size);
...
SkottieResourceIdHash CC_PAINT_EXPORT HashSkottieResourceId(base::StringPiece resource_id);
