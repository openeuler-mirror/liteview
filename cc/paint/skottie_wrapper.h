...
public:
    ...
    static scoped_refptr<SkottieWrapper> CreateSerializable(std::vector<uint8_t> data);

    // Creates a non serializable instance of the class. This uses less memory.
    static scoped_refptr<SkottieWrapper> CreateNonSerializable(base::span<const uint8_t> data);
