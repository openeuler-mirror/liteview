...
public:
    ...
    // scaling the layer.
    absl::optional<DirectlyCompositedImageResult> GetDirectlyCompositedImageResult() const;
    ...
    {
        return paint_op_buffer_.HasNonAAPaint();
    }
    ...
    bool GetColorIfSolidInRect(const gfx::Rect& rect, SkColor4f* color, int max_ops_to_analyze = 1);
