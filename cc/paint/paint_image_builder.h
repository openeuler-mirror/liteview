...
public:
    ...
    PaintImageBuilder&& set_paint_record(sk_sp<PaintRecord> paint_record, const gfx::Rect& rect, PaintImage::ContentId content_id)
    {
    ...
    PaintImageBuilder&& set_paint_worklet_input(scoped_refptr<PaintWorkletInput> input)
    {
