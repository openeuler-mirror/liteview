...
public:
    ...
    ScrollTimeline(absl::optional<ElementId> scroller_id, ScrollDirection direction, absl::optional<ScrollOffsets> scroll_offsets, int animation_timeline_id);

    static scoped_refptr<ScrollTimeline> Create(absl::optional<ElementId> scroller_id, ScrollDirection direction, absl::optional<ScrollOffsets> scroll_offsets);
    ...
    virtual absl::optional<base::TimeTicks> CurrentTime(const ScrollTree& scroll_tree, bool is_active_tree) const;

    void UpdateScrollerIdAndScrollOffsets(absl::optional<ElementId> scroller_id, absl::optional<ScrollOffsets> scroll_offsets);
    ...
    absl::optional<ElementId> GetActiveIdForTest() const
    {
        return active_id_;
    }
    absl::optional<ElementId> GetPendingIdForTest() const
    {
        return pending_id_;
    }
