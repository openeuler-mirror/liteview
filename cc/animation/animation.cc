...
void Animation::Tick(base::TimeTicks tick_time)
{
    ...
    if (IsScrollLinkedAnimation()) {
        ...
        // improvement.
        keyframe_effect()->Pause(tick_time - base::TimeTicks(), PauseCondition::kAfterStart);
...
{
    AnimationEvent event(AnimationEvent::FINISHED, { timeline_id, id(), keyframe_model_id }, group_id, target_property, base::TimeTicks());
