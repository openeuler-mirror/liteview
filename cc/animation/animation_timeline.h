...
class CC_ANIMATION_EXPORT AnimationTimeline : public base::RefCounted<AnimationTimeline> {
public:
    ...
    void set_is_impl_only(bool is_impl_only)
    {
    ...
    {
        return !id_to_animation_map_.empty();
    }
    bool TickTimeLinkedAnimations(const std::vector<scoped_refptr<Animation>>& ticking_animations, base::TimeTicks monotonic_time);
