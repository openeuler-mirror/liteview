...
public:
    ...
    void Tick(base::TimeDelta t, int property_id, gfx::KeyframeModel* keyframe_model) const override;
...
private:
    ...
    ScrollOffsetAnimationCurve(
        const gfx::PointF& target_value, AnimationType animation_type, absl::optional<DurationBehavior> duration_behavior = absl::nullopt);
    ...
    base::TimeDelta SegmentDuration(const gfx::Vector2dF& delta, base::TimeDelta delayed_by, absl::optional<double> velocity = absl::nullopt);
