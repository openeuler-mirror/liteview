...
private:
    ...
    absl::optional<base::TimeDelta> CurrentTime(base::TimeTicks monotonic_time, const ScrollTree& scroll_tree, bool is_active_tree);
    ...
    ProtectedSequenceReadable<absl::optional<base::TimeDelta>> last_synced_local_time_;
