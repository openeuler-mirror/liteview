...
public:
    MockScrollTimeline()
        : ScrollTimeline(ElementId(), ScrollTimeline::ScrollDown,
            /* scroll_offsets */ absl::nullopt, AnimationIdProvider::NextTimelineId())
    {
    }
    MOCK_CONST_METHOD2(CurrentTime, absl::optional<base::TimeTicks>(const ScrollTree&, bool));
...
absl::optional<base::TimeTicks> FakeIncreasingScrollTimelineTime(Unused, Unused)
{
