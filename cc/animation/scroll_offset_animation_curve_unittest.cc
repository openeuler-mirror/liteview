...
TEST(ScrollOffsetAnimationCurveTest, EaseInOutUpdateTarget)
{
    ...
    std::unique_ptr<ScrollOffsetAnimationCurve> curve(
        ScrollOffsetAnimationCurveFactory::CreateEaseInOutAnimationForTesting(target_value, DurationBehavior::CONSTANT));
    curve->SetInitialValue(initial_value);
...
{
    std::unique_ptr<ScrollOffsetAnimationCurve> curve(
        ScrollOffsetAnimationCurveFactory::CreateEaseInOutAnimationForTesting(gfx::PointF(0.f, 100.f), DurationBehavior::INVERSE_DELTA));
