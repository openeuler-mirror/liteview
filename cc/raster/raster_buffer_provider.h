...
public:
    ...
    static void PlaybackToMemory(void* memory, viz::ResourceFormat format, const gfx::Size& size, size_t stride, const RasterSource* raster_source,
    ...
    virtual bool IsResourceReadyToDraw(const ResourcePool::InUsePoolResource& resource) const = 0;
