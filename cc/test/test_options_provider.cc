...
TestOptionsProvider::TestOptionsProvider()
    ...
    , deserialize_options_(this, &service_paint_cache_, &strike_client_, &scratch_buffer_, true, nullptr)
{
}
...
ImageProvider::ScopedResult TestOptionsProvider::GetRasterContent(const DrawImage& draw_image)
{
    ...
    ClientImageTransferCacheEntry cache_entry(&bitmap.pixmap(), false /* needs_mips */, target_color_params);
