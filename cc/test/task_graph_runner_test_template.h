...
TYPED_TEST_P(TaskGraphRunnerTest, Basic)
{
    ...
    for (int i = 0; i < kNamespaceCount; ++i) {
        ...
        this->ScheduleTasks(i, std::vector<TaskInfo>(1, TaskInfo(i, 0u, 0u, 0u, 0u, 0u)));
    }
    ...
    for (int i = 0; i < kNamespaceCount; ++i)
        this->ScheduleTasks(i, std::vector<TaskInfo>(1, TaskInfo(i, 0u, 0u, 1u, 0u, 0u)));
    ...
    for (int i = 0; i < kNamespaceCount; ++i)
        this->ScheduleTasks(i, std::vector<TaskInfo>(1, TaskInfo(i, 0u, 0u, 2u, 0u, 0u)));
...
REGISTER_TYPED_TEST_SUITE_P(TaskGraphRunnerTest, Basic, Dependencies, Categories);
