...
protected:
    ...
    bool RunPixelTestWithReadbackTargetAndArea(viz::AggregatedRenderPassList* pass_list, viz::AggregatedRenderPass* target, const base::FilePath& ref_file,
    ...
    base::WritableSharedMemoryMapping AllocateSharedBitmapMemory(const viz::SharedBitmapId& id, const gfx::Size& size);
    ...
    viz::ResourceId AllocateAndFillSoftwareResource(const gfx::Size& size, const SkBitmap& source);
...
private:
    ...
    bool PixelsMatchReference(const base::FilePath& ref_file, const PixelComparator& comparator);
