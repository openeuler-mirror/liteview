...
void UIResourceLayer::SetVertexOpacity(float bottom_left, float top_left, float top_right, float bottom_right)
{
    ...
    if (old_vertex_opacity[0] == bottom_left && old_vertex_opacity[1] == top_left && old_vertex_opacity[2] == top_right
