...
TEST(RecordingSourceTest, DiscardableImagesWithTransform)
{
    ...
    std::unique_ptr<FakeRecordingSource> recording_source = FakeRecordingSource::CreateFilledRecordingSource(recorded_viewport.size());
    ...
    // Tile sized iterators. These should find only one pixel ref.
    {
        ...
        raster_source->GetDiscardableImagesInRect(gfx::Rect(0, 0, 128, 128), &images);
    ...
    {
        std::vector<const DrawImage*> images;
        raster_source->GetDiscardableImagesInRect(gfx::Rect(130, 140, 128, 128), &images);
    ...
    {
        std::vector<const DrawImage*> images;
        raster_source->GetDiscardableImagesInRect(gfx::Rect(130, 0, 128, 128), &images);
        EXPECT_EQ(1u, images.size());
        EXPECT_TRUE(images[0]->paint_image() == discardable_image[1][1]);
    }
    ...
    {
        std::vector<const DrawImage*> images;
        raster_source->GetDiscardableImagesInRect(gfx::Rect(0, 0, 256, 256), &images);
...
TEST(RecordingSourceTest, EmptyImages)
{
    ...
    {
        std::vector<const DrawImage*> images;
        raster_source->GetDiscardableImagesInRect(gfx::Rect(140, 140, 128, 128), &images);
        EXPECT_TRUE(images.empty());
    }
...
TEST(RecordingSourceTest, DiscardableImages)
{
    ...
    {
        std::vector<const DrawImage*> images;
        raster_source->GetDiscardableImagesInRect(gfx::Rect(140, 0, 128, 128), &images);
        EXPECT_TRUE(images.empty());
    }
...
TEST(RecordingSourceTest, DiscardableImagesBaseNonDiscardable)
{
    ...
    {
        std::vector<const DrawImage*> images;
        raster_source->GetDiscardableImagesInRect(gfx::Rect(260, 260, 256, 256), &images);
        EXPECT_EQ(1u, images.size());
        EXPECT_TRUE(images[0]->paint_image() == discardable_image[1][1]);
    }
    // Ensure there's no discardable images in the empty cell
    {
        std::vector<const DrawImage*> images;
        raster_source->GetDiscardableImagesInRect(gfx::Rect(0, 256, 256, 256), &images);
        EXPECT_TRUE(images.empty());
    }
    // Layer sized iterators. These should find three images.
    {
        std::vector<const DrawImage*> images;
        raster_source->GetDiscardableImagesInRect(gfx::Rect(0, 0, 512, 512), &images);
        EXPECT_EQ(3u, images.size());
        EXPECT_TRUE(images[0]->paint_image() == discardable_image[0][0]);
