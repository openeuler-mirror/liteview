...
TEST(SurfaceLayerImplTest, Occlusion)
{
    ...
    surface_layer_impl->SetRange(viz::SurfaceRange(absl::nullopt, surface_id), absl::nullopt);
...
TEST(SurfaceLayerImplTest, SurfaceLayerImplWithTwoDifferentSurfaces)
{
    ...
    {
        AppendQuadsData data;
        surface_layer_impl->SetRange(viz::SurfaceRange(absl::nullopt, surface_id1), 0u);
        surface_layer_impl->AppendQuads(render_pass.get(), &data);
...
TEST(SurfaceLayerImplTest, SurfaceLayerImplsWithDeadlines)
{
    ...
    surface_layer_impl2->SetRange(viz::SurfaceRange(surface_id1, surface_id2), absl::nullopt);
...
TEST(SurfaceLayerImplTest, WillDrawNotifiesSynchronouslyInCompositeImmediate)
{
    ...
    SurfaceLayerImpl* surface_layer_impl = impl.AddLayer<SurfaceLayerImpl>(std::move(callback));
