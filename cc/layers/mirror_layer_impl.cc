...
{
    const LayerImpl* mirrored_layer = layer_tree_impl()->LayerById(mirrored_layer_id_);
    return GetScaledEnclosingVisibleRectInTargetSpace(mirrored_layer->GetIdealContentsScaleKey());
}
