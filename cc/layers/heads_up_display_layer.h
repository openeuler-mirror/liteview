...
public:
    ...
    void UpdateWebVitalMetrics(std::unique_ptr<WebVitalMetrics> web_vital_metrics);
...
private:
    ...
    ProtectedSequenceWritable<std::unique_ptr<WebVitalMetrics>> web_vital_metrics_;
};
