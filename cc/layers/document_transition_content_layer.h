...
public:
    static scoped_refptr<DocumentTransitionContentLayer> Create(const viz::SharedElementResourceId& resource_id, bool is_live_content_layer);

    DocumentTransitionContentLayer(const DocumentTransitionContentLayer&) = delete;
    DocumentTransitionContentLayer& operator=(const DocumentTransitionContentLayer&) = delete;
...
protected:
    explicit DocumentTransitionContentLayer(const viz::SharedElementResourceId& resource_id, bool is_live_content_layer);
