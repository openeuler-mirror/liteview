...
public:
    ...
    void UpdateRasterSource(scoped_refptr<RasterSource> raster_source, Region* new_invalidation, const PictureLayerTilingSet* pending_set,
    ...
    void SetDirectlyCompositedImageDefaultRasterScale(const gfx::Vector2dF& scale);
    ...
    void SetPaintWorkletRecord(scoped_refptr<const PaintWorkletInput>, sk_sp<PaintRecord>);
...
protected:
    ...
    void CleanUpTilingsOnActiveLayer(const std::vector<PictureLayerTiling*>& used_tilings);
    ...
    LCDTextDisallowedReason lcd_text_disallowed_reason_ = LCDTextDisallowedReason::kNone;
