...
private:
    ...
    {
        InitializeSingleThreaded(&single_thread_client_, base::ThreadTaskRunnerHandle::Get());
    }
...
public:
    ...
    MOCK_METHOD3(Release2, void(const viz::SharedBitmapId& shared_bitmap_id, const gpu::SyncToken& sync_token, bool lost_resource));
};
...
struct CommonResourceObjects {
        ...
        , sync_token2_(gpu::CommandBufferNamespace::GPU_IO, gpu::CommandBufferId::FromUnsafeValue(0x234), 2)
    {
        ...
        resource1_ = viz::TransferableResource::MakeGpu(
            mailbox_name1_, GL_LINEAR, arbitrary_target1, sync_token1_, size, viz::RGBA_8888, false /* is_overlay_candidate */);
        resource2_ = viz::TransferableResource::MakeGpu(
            mailbox_name2_, GL_LINEAR, arbitrary_target2, sync_token2_, size, viz::RGBA_8888, false /* is_overlay_candidate */);
        shared_bitmap_id_ = viz::SharedBitmap::GenerateId();
        sw_release_callback_ = base::BindRepeating(&MockReleaseCallback::Release2, base::Unretained(&mock_callback_), shared_bitmap_id_);
        sw_resource_ = viz::TransferableResource::MakeSoftware(shared_bitmap_id_, size, viz::RGBA_8888);
    }
...
TEST_F(TextureLayerTest, ShutdownWithResource)
{
    for (int i = 0; i < 2; ++i) {
        ...
        if (gpu) {
            ...
            layer->SetTransferableResource(test_data_.sw_resource_, test_data_.sw_release_callback_);
        }
        ...
        if (gpu) {
            ...
            EXPECT_CALL(test_data_.mock_callback_, Release2(test_data_.shared_bitmap_id_, _, false)).Times(1);
        }
        {
            base::RunLoop loop;
            loop.RunUntilIdle();
...
TEST_F(TextureLayerWithResourceTest, ReplaceMailboxOnMainThreadBeforeCommit)
{
    ...
    EXPECT_CALL(*layer_tree_host_, SetNeedsCommit()).Times(AtLeast(1));
    test_layer->SetTransferableResource(test_data_.sw_resource_, test_data_.sw_release_callback_);
    Mock::VerifyAndClearExpectations(layer_tree_host_.get());
    Mock::VerifyAndClearExpectations(&test_data_.mock_callback_);
...
public:
    ...
    void SetMailbox(char mailbox_char)
    {
        ...
        auto resource = viz::TransferableResource::MakeGpu(MailboxFromChar(mailbox_char), GL_LINEAR, GL_TEXTURE_2D,
            SyncTokenFromUInt(static_cast<uint32_t>(mailbox_char)), size, viz::RGBA_8888, false /* is_overlay_candidate */);
...
TEST_F(TextureLayerImplWithResourceTest, TestWillDraw)
{
    ...
    EXPECT_CALL(test_data_.mock_callback_, Release2(test_data_.shared_bitmap_id_, gpu::SyncToken(), false)).Times(AnyNumber());
    // Hardware mode.
    {
...

    {
        // Software resource.
        std::unique_ptr<TextureLayerImpl> impl_layer = CreateTextureLayer();
        impl_layer->SetTransferableResource(test_data_.sw_resource_, test_data_.sw_release_callback_);
...
public:
        ...
        SharedBitmapIdRegistrar* bitmap_registrar, viz::TransferableResource* resource, viz::ReleaseCallback* release_callback) override
    {
        ...
        *resource = viz::TransferableResource::MakeGpu(
            MailboxFromChar('1'), GL_LINEAR, GL_TEXTURE_2D, SyncTokenFromUInt(0x123), size, viz::RGBA_8888, false /* is_overlay_candidate */);
...
public:
    ...
    {
        constexpr gfx::Size size(64, 64);
        return viz::TransferableResource::MakeGpu(MailboxFromChar(name), GL_LINEAR, GL_TEXTURE_2D, SyncTokenFromUInt(static_cast<uint32_t>(name)), size,
...
public:
        ...
        SharedBitmapIdRegistrar* bitmap_registrar, viz::TransferableResource* resource, viz::ReleaseCallback* release_callback) override
    {
        constexpr gfx::Size size(64, 64);
        *resource = viz::TransferableResource::MakeGpu(
            MailboxFromChar('1'), GL_LINEAR, GL_TEXTURE_2D, SyncTokenFromUInt(1), size, viz::RGBA_8888, false /* is_overlay_candidate */);
...
protected:
    void BeginTest() override
    {
        ...
        bitmap_ = base::MakeRefCounted<CrossThreadSharedBitmap>(id_, viz::bitmap_allocation::AllocateSharedBitmap(size, format), size, format);
    }
    ...
    void DidCommitAndDrawFrame() override
    {
        ...
        case 1:
            ...
            texture_layer_->SetTransferableResource(
                viz::TransferableResource::MakeSoftware(id_, gfx::Size(1, 1), viz::RGBA_8888), base::BindOnce([](const gpu::SyncToken&, bool) {}));
            break;
        case 2:
...
class SoftwareTextureLayerMultipleRegisterTest : public SoftwareTextureLayerTest {
protected:
    void BeginTest() override
    {
        PostSetNeedsCommitToMainThread();
        ...
        bitmap1_ = base::MakeRefCounted<CrossThreadSharedBitmap>(id1_, viz::bitmap_allocation::AllocateSharedBitmap(size, format), size, format);
        id2_ = viz::SharedBitmap::GenerateId();
        bitmap2_ = base::MakeRefCounted<CrossThreadSharedBitmap>(id2_, viz::bitmap_allocation::AllocateSharedBitmap(size, format), size, format);
    }
    ...
    void DidCommitAndDrawFrame() override
    {
        ...
        case 1:
            ...
            // doesn't need to register the SharedBitmapId otherwise.
            texture_layer_->SetTransferableResource(
                viz::TransferableResource::MakeSoftware(id1_, gfx::Size(1, 1), viz::RGBA_8888), base::BindOnce([](const gpu::SyncToken&, bool) {}));
            break;
        case 2:
...
class SoftwareTextureLayerRegisterUnregisterTest : public SoftwareTextureLayerTest {
protected:
    void BeginTest() override
    {
        PostSetNeedsCommitToMainThread();
    ...
    void DidCommitAndDrawFrame() override
    {
        ...
        case 1:
            ...
            // LayerTreeFrameSink. But we unregister one.
            {
                ...
                // thing.
                SharedBitmapIdRegistration temp_reg = texture_layer_->RegisterSharedBitmapId(id2_, bitmap2_);
            }
            // Give the TextureLayer a resource so it contributes to the frame. It
            // doesn't need to register the SharedBitmapId otherwise.
            texture_layer_->SetTransferableResource(
...
protected:
    ...
    void NextStep()
    {
        ...
        case 1:
            ...
            // Give the TextureLayer a resource so it contributes to the frame. It
            // doesn't need to register the SharedBitmapId otherwise.
            texture_layer_->SetTransferableResource(viz::TransferableResource::MakeSoftware(id_, gfx::Size(1, 1), viz::RGBA_8888),
                base::BindOnce(&SoftwareTextureLayerLoseFrameSinkTest::ReleaseCallback, base::Unretained(this)));
...
class SoftwareTextureLayerUnregisterRegisterTest : public SoftwareTextureLayerTest {
protected:
    void BeginTest() override
    {
        PostSetNeedsCommitToMainThread();
    ...
    void DidCommitAndDrawFrame() override
    {
        ...
        case 1:
            ...
            {
                // Register-Unregister-
                SharedBitmapIdRegistration temp_reg = texture_layer_->RegisterSharedBitmapId(id_, bitmap_);
            }
            // Register.
            registration_ = texture_layer_->RegisterSharedBitmapId(id_, bitmap_);
