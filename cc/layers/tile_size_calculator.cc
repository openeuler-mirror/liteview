...
// AffectingParams.
bool TileSizeCalculator::AffectingParams::operator==(const AffectingParams& other) const
{
    return max_texture_size == other.max_texture_size && use_gpu_rasterization == other.use_gpu_rasterization
        && device_scale_factor == other.device_scale_factor && max_tile_size == other.max_tile_size
        && gpu_raster_max_texture_size == other.gpu_raster_max_texture_size && max_untiled_layer_size == other.max_untiled_layer_size
        && default_tile_size == other.default_tile_size && layer_content_bounds == other.layer_content_bounds;
}
