...
public:
    ...
    {
        return rare_properties_ ? rare_properties_->non_fast_scrollable_region : Region::Empty();
    }
    ...
    void set_needs_show_scrollbars(bool yes)
    {
        needs_show_scrollbars_ = yes;
    }
    bool needs_show_scrollbars()
    {
        return needs_show_scrollbars_;
    }
    ...
    virtual void NotifyKnownResourceIdsBeforeAppendQuads(const base::flat_set<viz::SharedElementResourceId>& known_resource_ids)
    {
    }
