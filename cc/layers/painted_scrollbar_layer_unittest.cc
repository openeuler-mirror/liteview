...
public:
    ...
    MOCK_METHOD3(PaintPart, void(PaintCanvas* canvas, ScrollbarPart part, const gfx::Rect& rect));
...
TEST_F(PaintedScrollbarLayerTest, NeedsPaint)
{
    ...
    EXPECT_CALL(*scrollbar, PaintPart(_, ScrollbarPart::TRACK_BUTTONS_TICKMARKS, _)).Times(1);
    ...
    EXPECT_CALL(*scrollbar, PaintPart(_, ScrollbarPart::TRACK_BUTTONS_TICKMARKS, _)).Times(0);
    scrollbar_layer->Update();
    Mock::VerifyAndClearExpectations(scrollbar.get());
