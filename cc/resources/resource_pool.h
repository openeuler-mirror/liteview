...
public:
    ...
    public:
        ...
        void InitOverlayCandidateAndTextureTarget(const viz::ResourceFormat format, const gpu::Capabilities& caps, bool use_gpu_memory_buffer_resources);
    ...
    public:
        ...
        const viz::ResourceFormat& format() const
        {
    ...
    ResourcePool(viz::ClientResourceProvider* resource_provider, viz::ContextProvider* context_provider,
    ...
    InUsePoolResource AcquireResource(
        const gfx::Size& size, viz::ResourceFormat format, const gfx::ColorSpace& color_space, const std::string& debug_name = std::string());
...
private:
    ...
    class PoolResource {
    public:
        PoolResource(ResourcePool* resource_pool, size_t unique_id, const gfx::Size& size, viz::ResourceFormat format, const gfx::ColorSpace& color_space);
        ~PoolResource();
        ...
        size_t memory_usage() const
        {
            ...
            size_t memory_usage = viz::ResourceSizes::UncheckedSizeInBytes<size_t>(size(), format());
    ...
    PoolResource* ReuseResource(const gfx::Size& size, viz::ResourceFormat format, const gfx::ColorSpace& color_space);

    // Creates a new resource without trying to reuse an old one.
    PoolResource* CreateResource(const gfx::Size& size, viz::ResourceFormat format, const gfx::ColorSpace& color_space);
