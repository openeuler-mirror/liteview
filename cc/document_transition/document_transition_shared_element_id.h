...
public:
    ...
    DocumentTransitionSharedElementId& operator=(DocumentTransitionSharedElementId&&) = default;

    DocumentTransitionSharedElementId& operator=(const DocumentTransitionSharedElementId&) = default;

    bool operator==(const DocumentTransitionSharedElementId& other) const
    {
        return element_indices_ == other.element_indices_ && document_tag_ == other.document_tag_;
    }
    ...
    bool operator<(const DocumentTransitionSharedElementId& other) const
    {
        return std::tie(document_tag_, element_indices_) < std::tie(other.document_tag_, other.element_indices_);
    }
