...
public:
    ...
    void DidSubmitCompositorFrame(uint32_t frame_token, base::TimeTicks submit_time, EventMetricsSet events_metrics, bool has_missing_content);
    ...
    void AsProtozeroInto(perfetto::EventContext& ctx, perfetto::protos::pbzero::ChromeCompositorSchedulerState* state) const;
...
protected:
    ...
    // destroyed.
    raw_ptr<CompositorFrameReportingController, DanglingUntriaged> compositor_frame_reporting_controller_;
    ...
    //   power_scheduler::PowerMode last_power_mode_vote_ = power_scheduler::PowerMode::kIdle;
