...
private:
    ...
    bool UpdateRenderSurfaceIfNeeded(int parent_effect_tree_id, DataForRecursion* data_for_children, bool subtree_has_rounded_corner,
        bool subtree_has_gradient_mask, bool created_transform_node) const;
...
bool PropertyTreeBuilderContext::UpdateRenderSurfaceIfNeeded(int parent_effect_tree_id, DataForRecursion* data_for_children, bool subtree_has_rounded_corner,
    bool subtree_has_gradient_mask, bool created_transform_node) const
{
    ...
    // rounded corners.
    *data_for_children->subtree_has_rounded_corner = (subtree_has_rounded_corner && !effect_node->HasRenderSurface()) || has_rounded_corner;
...
void PropertyTreeBuilderContext::AddScrollNodeIfNeeded(const DataForRecursion& data_from_ancestor, Layer* layer, DataForRecursion* data_for_children) const
{
    ...
    bool requires_node = is_root || scrollable || contains_non_fast_scrollable_region;
...
void PropertyTreeBuilderContext::BuildPropertyTreesInternal(Layer* layer, const DataForRecursion& data_from_parent) const
{
    ...
    *data_for_children.subtree_has_gradient_mask = false;
    ...
    created_render_surface = UpdateRenderSurfaceIfNeeded(
        data_from_parent.effect_tree_parent, &data_for_children, subtree_has_rounded_corner, subtree_has_gradient_mask, created_transform_node);
}
