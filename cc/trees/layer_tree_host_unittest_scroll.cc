...
std::unique_ptr<ScrollState> UpdateState(const gfx::Point& point, const gfx::Vector2dF& delta)
{
    ScrollStateData scroll_state_data;
...
public:
    ...
    void DidCompositorScroll(ElementId element_id, const gfx::PointF& offset, const absl::optional<TargetSnapAreaElementIds>& snap_target_ids) override
    {
    ...
    void DidActivateTreeOnThread(LayerTreeHostImpl* impl) override
    {
        ...
        case 0: {
            ...
            impl->GetInputHandler().ScrollUpdate(UpdateState(gfx::Point(), scroll_amount_).get());
...
TEST_F(LayerTreeHostScrollTestCaseWithChild, DeviceScaleFactor1_ScrollRootScrollLayer)
{
    device_scale_factor_ = 1.f;
...
TEST_F(LayerTreeHostScrollTestCaseWithChild, DeviceScaleFactor15_ScrollRootScrollLayer)
{
    device_scale_factor_ = 1.5f;
    scroll_child_layer_ = false;
    RunTest(CompositorMode::THREADED);
...
TEST_F(LayerTreeHostScrollTestCaseWithChild, DeviceScaleFactor2_ScrollRootScrollLayer)
{
    device_scale_factor_ = 2.f;
    scroll_child_layer_ = false;
    RunTest(CompositorMode::THREADED);
...
public:
    ...
    void DidActivateTreeOnThread(LayerTreeHostImpl* host_impl) override
    {
        ...
        if (host_impl->active_tree()->source_frame_number() == 0) {
            ...
            EXPECT_TRUE(!!host_impl->mutator_host()->ImplOnlyScrollAnimatingElement());
...
void DoGestureScroll(LayerTreeHostImpl* host_impl, const scoped_refptr<Layer>& scroller, gfx::Vector2dF offset, ElementId scroller_element_id)
{
    ...
    std::unique_ptr<ScrollState> update_scroll_state(new ScrollState(update_scroll_state_data));
...
public:
    ...
    void SetupTree() override
    {
        ...
        SnapAreaData snap_area_data(ScrollSnapAlign(SnapAlignment::kStart), gfx::RectF(500, 500, 100, 100), false, snap_area_id_);
    ...
    void WillSendBeginMainFrameOnThread(LayerTreeHostImpl* host_impl) override
    {
        ...
        if (host_impl->active_tree()->source_frame_number() == 0) {
            ...
            snap_animation_finished_ = !host_impl->GetInputHandler().animating_for_snap_for_testing();
        }
    }
...
public:
    ...
    void SetupTree() override
    {
        ...
        SnapAreaData snap_area_data_a(ScrollSnapAlign(SnapAlignment::kStart), gfx::RectF(500, 500, 100, 100), false, snap_area_a_id_);
        ...
        SnapAreaData snap_area_data_b(ScrollSnapAlign(SnapAlignment::kStart), gfx::RectF(500, 500, 100, 100), false, snap_area_b_id_);
...
public:
    ...
    void DrawLayersOnThread(LayerTreeHostImpl* impl) override
    {
        ...
        EXPECT_EQ(ScrollThread::SCROLL_ON_IMPL_THREAD, status.thread) << "In Frame " << impl->active_tree()->source_frame_number();
...
public:
    ...
    void SetupTree() override
    {
        ...
        layer_tree_host()->OuterViewportScrollLayerForTesting()->SetNonFastScrollableRegion(gfx::Rect(20, 20, 20, 20));
    }
...
public:
    ...
    {
        LayerTreeHostScrollTest::SetupTree();
        GetScrollNode(layer_tree_host()->OuterViewportScrollLayerForTesting())->main_thread_scrolling_reasons
    ...
    void DrawLayersOnThread(LayerTreeHostImpl* impl) override
    {
        ...
        // Scroll hitting the scroller layer.
        {
            ...
            if (base::FeatureList::IsEnabled(features::kScrollUnification)) {
                ...
                EXPECT_EQ(ScrollThread::SCROLL_ON_MAIN_THREAD, status.thread);
                EXPECT_EQ(MainThreadScrollingReason::kThreadedScrollingDisabled, status.main_thread_scrolling_reasons);
            }
            impl->GetInputHandler().ScrollEnd();
        }
...
public:
    ...
    void DidCompositorScroll(ElementId element_id, const gfx::PointF&, const absl::optional<TargetSnapAreaElementIds>&) override
    {
...
public:
    ...
    {
        LayerTreeHostScrollTest::SetupTree();
        GetViewportScrollNode()->main_thread_scrolling_reasons = MainThreadScrollingReason::kHasBackgroundAttachmentFixedObjects;
    }

    void UpdateLayerTreeHost() override
    {
        if (layer_tree_host()->SourceFrameNumber() == 1)
            GetViewportScrollNode()->main_thread_scrolling_reasons = MainThreadScrollingReason::kNotScrollingOnMain;
    }
...
private:
    ...
    void DoScrollBeginAndUpdate(InputHandler& input_handler)
    {
        ...
        input_handler.ScrollUpdate(UpdateState(gfx::Point(), gfx::Vector2dF(0, 10)).get());
    }
};
...
public:
    NonScrollingNonFastScrollableRegion()
    {
        SetUseLayerLists();
    }
...
public:
    ...
    void DrawLayersOnThread(LayerTreeHostImpl* impl) override
    {
        ...
        // Perform a scroll over our FakePictureLayer.
        {
            ...
            impl->GetInputHandler().ScrollUpdate(UpdateState(gfx::Point(), gfx::Vector2dF(0, 10)).get());
            impl->GetInputHandler().ScrollEnd();
        }
...
public:
    ...
    {
        if (is_first_frame_) {
            host_impl->browser_controls_manager()->UpdateBrowserControlsState(BrowserControlsState::kHidden, BrowserControlsState::kHidden, true);
...
public:
    ...
    void DidActivateTreeOnThread(LayerTreeHostImpl* host_impl) override
    {
        ...
        case 0:
            ...
            host_impl->GetInputHandler().ScrollUpdate(UpdateState(gfx::Point(), gfx::Vector2dF(0, 10)).get());
