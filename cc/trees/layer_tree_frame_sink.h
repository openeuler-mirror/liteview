...
class CC_EXPORT LayerTreeFrameSink : public viz::SharedBitmapReporter, public viz::ContextLostObserver {
public:
    ...
    LayerTreeFrameSink(scoped_refptr<viz::ContextProvider> context_provider, scoped_refptr<RasterContextProviderWrapper> worker_context_provider_wrapper,
