...
struct CC_EXPORT CommitState {
    ...
    // added here.
    std::vector<PresentationTimeCallbackBuffer::MainCallback> pending_presentation_time_callbacks;
    ...
    std::vector<std::unique_ptr<DocumentTransitionRequest>> document_transition_requests;
