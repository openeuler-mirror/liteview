...
public:
    ...
    virtual void NeedsImplSideInvalidation(bool needs_first_draw_on_activation) = 0;
...
public:
    ...
    void DidObserveScrollDelay(base::TimeDelta scroll_delay, base::TimeTicks scroll_timestamp);
    ...
    void UpdateBrowserControlsState(BrowserControlsState constraints, BrowserControlsState current, bool animate) override;
    ...
    int GetMSAASampleCountForRaster(const scoped_refptr<DisplayItemList>& display_list) override;
    ...
    void GetGpuRasterizationCapabilities(bool* gpu_rasterization_enabled, bool* gpu_rasterization_supported, bool* can_use_msaa, bool* supports_disable_msaa);
    bool use_gpu_rasterization() const
    {
        return use_gpu_rasterization_;
    }
    ...
    void RegisterMainThreadPresentationTimeCallbackForTesting(uint32_t frame_token, PresentationTimeCallbackBuffer::MainCallback callback);
    ...
    void RegisterCompositorPresentationTimeCallback(uint32_t frame_token, PresentationTimeCallbackBuffer::CompositorCallback callback);
...
private:
    ...
    GpuRasterizationStatus gpu_rasterization_status_ = GpuRasterizationStatus::OFF_DEVICE;
