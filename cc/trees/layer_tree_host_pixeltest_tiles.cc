...
#if BUILDFLAG(IS_CHROMEOS_ASH) || defined(MEMORY_SANITIZER) || defined(ADDRESS_SANITIZER) || BUILDFLAG(IS_FUCHSIA)
...
TEST_P(LayerTreeHostTilesTestPartialInvalidation, MAYBE_PartialRaster)
{
    ...
    RunSingleThreadedPixelTest(picture_layer_, base::FilePath(FILE_PATH_LITERAL("blue_yellow_partial_flipped.png")));
}
#undef MAYBE_PartialRaster

TEST_P(LayerTreeHostTilesTestPartialInvalidation, FullRaster)
{
    RunSingleThreadedPixelTest(picture_layer_, base::FilePath(FILE_PATH_LITERAL("blue_yellow_flipped.png")));
}
...
#define MAYBE_PartialRaster DISABLED_PartialRaster
#elif BUILDFLAG(IS_CHROMEOS_ASH) || defined(MEMORY_SANITIZER) || defined(ADDRESS_SANITIZER) || BUILDFLAG(IS_FUCHSIA)
// TODO(crbug.com/1045521): Flakes on all slower bots.
#define MAYBE_PartialRaster DISABLED_PartialRaster
#else
#define MAYBE_PartialRaster PartialRaster
...
{
    use_partial_raster_ = true;
    RunPixelTest(picture_layer_, base::FilePath(FILE_PATH_LITERAL("blue_yellow_partial_flipped.png")));
}
#undef MAYBE_PartialRaster

TEST_P(LayerTreeHostTilesTestPartialInvalidationMultiThread, FullRaster)
{
    RunPixelTest(picture_layer_, base::FilePath(FILE_PATH_LITERAL("blue_yellow_flipped.png")));
}
