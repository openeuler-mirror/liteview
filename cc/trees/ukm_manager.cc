...
void UkmManager::RecordThroughputUKM(FrameSequenceTrackerType tracker_type, FrameInfo::SmoothEffectDrivingThread thread_type, int64_t throughput) const
{
...
void UkmManager::RecordAggregateThroughput(AggregationType aggregation_type, int64_t throughput_percent) const
{
    //   ukm::builders::Graphics_Smoothness_PercentDroppedFrames builder(source_id_);
