...
std::vector<cc::PresentationTimeCallbackBuffer::MainCallback> GenerateMainCallbacks(int num_callbacks)
{
...
std::vector<cc::PresentationTimeCallbackBuffer::CompositorCallback> GenerateCompositorCallbacks(int num_callbacks)
{
...
TEST(PresentationTimeCallbackBufferTest, TestOneMainThreadCallback)
{
    ...
    buffer.RegisterMainThreadPresentationCallbacks(kFrameToken2, GenerateMainCallbacks(1));
...
TEST(PresentationTimeCallbackBufferTest, TestOneCompositorThreadCallback)
{
    ...
    buffer.RegisterCompositorPresentationCallbacks(kFrameToken2, GenerateCompositorCallbacks(1));
...
TEST(PresentationTimeCallbackBufferTest, TestCallbackBatching)
{
    ...
    buffer.RegisterMainThreadPresentationCallbacks(kFrameToken1, GenerateMainCallbacks(1));
    buffer.RegisterMainThreadPresentationCallbacks(kFrameToken2, GenerateMainCallbacks(2));
    buffer.RegisterMainThreadPresentationCallbacks(kFrameToken4, GenerateMainCallbacks(2));
...
TEST(PresentationTimeCallbackBufferTest, PopMainCallbacksOnly)
{
    ...
    buffer.RegisterMainThreadPresentationCallbacks(kFrameToken1, GenerateMainCallbacks(1));
    buffer.RegisterCompositorPresentationCallbacks(kFrameToken1, GenerateCompositorCallbacks(1));
    buffer.RegisterMainThreadPresentationCallbacks(kFrameToken2, GenerateMainCallbacks(1));
    buffer.RegisterCompositorPresentationCallbacks(kFrameToken2, GenerateCompositorCallbacks(1));
    buffer.RegisterMainThreadPresentationCallbacks(kFrameToken3, GenerateMainCallbacks(1));
    buffer.RegisterCompositorPresentationCallbacks(kFrameToken3, GenerateCompositorCallbacks(1));
