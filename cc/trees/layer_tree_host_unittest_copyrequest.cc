...
INSTANTIATE_TEST_SUITE_P(
    All, LayerTreeHostCopyRequestTestMultipleRequests, CombineWithCompositorModes(viz::GetRendererTypesNoDawn()), PrintTupleToStringParamName());
...
INSTANTIATE_TEST_SUITE_P(
    All, LayerTreeHostCopyRequestTestMultipleRequestsOutOfOrder, CombineWithCompositorModes(viz::GetGpuRendererTypesNoDawn()), PrintTupleToStringParamName());
...
INSTANTIATE_TEST_SUITE_P(
    All, LayerTreeHostCopyRequestCompletionCausesCommit, CombineWithCompositorModes(viz::GetGpuRendererTypesNoDawn()), PrintTupleToStringParamName());
...
INSTANTIATE_TEST_SUITE_P(
    All, LayerTreeHostCopyRequestTestLayerDestroyed, CombineWithCompositorModes(viz::GetGpuRendererTypesNoDawn()), PrintTupleToStringParamName());
...
INSTANTIATE_TEST_SUITE_P(
    All, LayerTreeHostCopyRequestTestInHiddenSubtree, CombineWithCompositorModes(viz::GetGpuRendererTypesNoDawn()), PrintTupleToStringParamName());
...
INSTANTIATE_TEST_SUITE_P(All, LayerTreeHostTestHiddenSurfaceNotAllocatedForSubtreeCopyRequest, CombineWithCompositorModes(viz::GetGpuRendererTypesNoDawn()),
...
INSTANTIATE_TEST_SUITE_P(
    All, LayerTreeHostCopyRequestTestClippedOut, CombineWithCompositorModes(viz::GetGpuRendererTypesNoDawn()), PrintTupleToStringParamName());
...
INSTANTIATE_TEST_SUITE_P(
    All, LayerTreeHostCopyRequestTestScaledLayer, CombineWithCompositorModes(viz::GetGpuRendererTypesNoDawn()), PrintTupleToStringParamName());
...
INSTANTIATE_TEST_SUITE_P(
    All, LayerTreeHostTestAsyncTwoReadbacksWithoutDraw, CombineWithCompositorModes(viz::GetGpuRendererTypesNoDawn()), PrintTupleToStringParamName());
...
INSTANTIATE_TEST_SUITE_P(
    All, LayerTreeHostCopyRequestTestDeleteSharedImage, CombineWithCompositorModes(viz::GetGpuRendererTypesNoDawn()), PrintTupleToStringParamName());
...
INSTANTIATE_TEST_SUITE_P(
    All, LayerTreeHostCopyRequestTestCreatesSharedImage, CombineWithCompositorModes(viz::GetGpuRendererTypesNoDawn()), PrintTupleToStringParamName());
...
INSTANTIATE_TEST_SUITE_P(
    All, LayerTreeHostCopyRequestTestDestroyBeforeCopy, CombineWithCompositorModes(viz::GetGpuRendererTypesNoDawn()), PrintTupleToStringParamName());
...
INSTANTIATE_TEST_SUITE_P(
    All, LayerTreeHostCopyRequestTestShutdownBeforeCopy, CombineWithCompositorModes(viz::GetGpuRendererTypesNoDawn()), PrintTupleToStringParamName());
...
protected:
    ...
    DrawResult PrepareToDrawOnThread(LayerTreeHostImpl* host_impl, LayerTreeHostImpl::FrameData* frame_data, DrawResult draw_result) override
    {
        ...
        for (EffectTreeLayerListIterator it(host_impl->active_tree()); it.state() != EffectTreeLayerListIterator::State::END; ++it) {
...
INSTANTIATE_TEST_SUITE_P(All, LayerTreeHostCopyRequestTestMultipleDrawsHiddenCopyRequest, CombineWithCompositorModes(viz::GetGpuRendererTypesNoDawn()),
    PrintTupleToStringParamName());
