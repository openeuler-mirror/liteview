...
TEST_F(ThrottleDeciderTest, BackdropFilter)
{
    ...
    surface_quad->surface_range = viz::SurfaceRange(absl::nullopt, viz::SurfaceId(frame_sink_id, viz::LocalSurfaceId(1u, base::UnguessableToken::Create())));
    ...
    render_passes[0]->backdrop_filter_bounds = absl::optional<gfx::RRectF>(gfx::RRectF(0.0f, 10.0f, 50.0f, 50.0f, 1.0f));
