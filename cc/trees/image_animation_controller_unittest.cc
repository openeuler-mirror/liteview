...
public:
    void SetUp() override
    {
        task_runner_ = new DelayTrackingTaskRunner(base::ThreadTaskRunnerHandle::Get().get());
...
TEST_F(ImageAnimationControllerTest, AnimationWithDelays)
{
    ...
    DiscardableImageMap::AnimatedImageMetadata data(PaintImage::GetNextId(), PaintImage::CompletionState::DONE, frames, kAnimationLoopInfinite, 0);
...
TEST_F(ImageAnimationControllerTest, DriversControlAnimationTicking)
{
    ...
    DiscardableImageMap::AnimatedImageMetadata first_data(
        PaintImage::GetNextId(), PaintImage::CompletionState::DONE, first_image_frames, kAnimationLoopOnce, 0);
    ...
    DiscardableImageMap::AnimatedImageMetadata second_data(
        PaintImage::GetNextId(), PaintImage::CompletionState::DONE, second_image_frames, kAnimationLoopOnce, 0);
...
TEST_F(ImageAnimationControllerTest, RepetitionsRequested)
{
    ...
    DiscardableImageMap::AnimatedImageMetadata data(PaintImage::GetNextId(), PaintImage::CompletionState::DONE, frames, kAnimationLoopOnce, 0);
    controller_->UpdateAnimatedImage(data);
    FakeAnimationDriver driver;
    controller_->RegisterAnimationDriver(data.paint_image_id, &driver);
    controller_->UpdateStateFromDrivers();
...
TEST_F(ImageAnimationControllerTest, DisplayCompleteFrameOnly)
{
    ...
    DiscardableImageMap::AnimatedImageMetadata data(PaintImage::GetNextId(), PaintImage::CompletionState::PARTIALLY_DONE, frames, kAnimationLoopInfinite, 0);
    controller_->UpdateAnimatedImage(data);
    FakeAnimationDriver driver;
    controller_->RegisterAnimationDriver(data.paint_image_id, &driver);
    controller_->UpdateStateFromDrivers();
...
TEST_F(ImageAnimationControllerTest, DontLoopPartiallyLoadedImages)
{
    ...
    DiscardableImageMap::AnimatedImageMetadata data(PaintImage::GetNextId(), PaintImage::CompletionState::PARTIALLY_DONE, frames, 2, 0);
    controller_->UpdateAnimatedImage(data);
    FakeAnimationDriver driver;
    controller_->RegisterAnimationDriver(data.paint_image_id, &driver);
    controller_->UpdateStateFromDrivers();
...
TEST_F(ImageAnimationControllerTest, FinishRepetitionsDuringCatchUp)
{
    ...
    DiscardableImageMap::AnimatedImageMetadata data(PaintImage::GetNextId(), PaintImage::CompletionState::DONE, frames, 3, 0);
    controller_->UpdateAnimatedImage(data);
    FakeAnimationDriver driver;
    controller_->RegisterAnimationDriver(data.paint_image_id, &driver);
    controller_->UpdateStateFromDrivers();
...
TEST_F(ImageAnimationControllerTest, ResetAnimations)
{
    std::vector<FrameMetadata> frames
        = { FrameMetadata(true, base::Milliseconds(2)), FrameMetadata(true, base::Milliseconds(3)), FrameMetadata(true, base::Milliseconds(4)) };
    DiscardableImageMap::AnimatedImageMetadata data(PaintImage::GetNextId(), PaintImage::CompletionState::DONE, frames, 3, 0u);
    controller_->UpdateAnimatedImage(data);
    FakeAnimationDriver driver;
    controller_->RegisterAnimationDriver(data.paint_image_id, &driver);
    controller_->UpdateStateFromDrivers();
...
TEST_F(ImageAnimationControllerTest, ImageWithLessThanIntervalDurations)
{
    ...
    DiscardableImageMap::AnimatedImageMetadata data(PaintImage::GetNextId(), PaintImage::CompletionState::DONE, frames, kAnimationLoopOnce, 0u);
    controller_->UpdateAnimatedImage(data);
    FakeAnimationDriver driver;
    controller_->RegisterAnimationDriver(data.paint_image_id, &driver);
    controller_->UpdateStateFromDrivers();
