...
public:
    ...
    void UpdateTransforms(int id, const ViewportPropertyIds* viewport_property_ids = nullptr);
    ...
    const AnchorScrollContainersData* GetAnchorScrollContainersData(int node_id) const;
...
private:
    ...
    void UpdateLocalTransform(TransformNode* node, const ViewportPropertyIds* viewport_property_ids);
...
public:
    ...
    virtual void DidCompositorScroll(ElementId scroll_element_id, const gfx::PointF&, const absl::optional<TargetSnapAreaElementIds>&) = 0;
