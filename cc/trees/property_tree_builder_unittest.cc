...
public:
    PropertyTreeBuilderTest()
        : LayerTreeImplTestBase(LayerTreeSettings())
    {
    }
...
TEST_F(PropertyTreeBuilderTest, RoundedCornerBounds)
{
    ...
    EXPECT_FLOAT_EQ(actual_render_target_rrect_3.GetSimpleRadius(), kRoundedCorner3Radius * kDeviceScale * kRoundedCorner3Scale);
...
TEST_F(PropertyTreeBuilderTest, RoundedCornerBoundsSiblingRenderTarget)
{
    ...
    gfx::RectF bounds_in_target_space = kRoundedCornerLayer1Bound;
    bounds_in_target_space.Scale(kDeviceScale);
    const gfx::RRectF actual_render_target_rrect_1 = rounded_corner_layer_1_impl->render_target()->mask_filter_info().rounded_corner_bounds();
    EXPECT_EQ(actual_render_target_rrect_1.rect(), bounds_in_target_space);
    EXPECT_FLOAT_EQ(actual_render_target_rrect_1.GetSimpleRadius(), kRoundedCorner1Radius * kDeviceScale);
...
TEST_F(PropertyTreeBuilderTest, FastRoundedCornerTriggersRenderSurfaceInAncestor)
{
    // Layer Tree:
    // +root
    // +--rounded corner layer [1] [should trigger render surface]
    ...
    gfx::RectF bounds_in_target_space = kRoundedCornerLayer1Bound;
    bounds_in_target_space.Scale(kDeviceScale);
    const gfx::RRectF actual_render_target_rrect_1 = rounded_corner_layer_impl_1->render_target()->mask_filter_info().rounded_corner_bounds();
    EXPECT_EQ(actual_render_target_rrect_1.rect(), bounds_in_target_space);
    EXPECT_FLOAT_EQ(actual_render_target_rrect_1.GetSimpleRadius(), kRoundedCorner1Radius * kDeviceScale);
    ...
    bounds_in_target_space = kRoundedCornerLayer3Bound;
    bounds_in_target_space.Scale(kDeviceScale);
    const gfx::RRectF actual_render_target_rrect_3 = rounded_corner_layer_impl_3->render_target()->mask_filter_info().rounded_corner_bounds();
    EXPECT_EQ(actual_render_target_rrect_3.rect(), bounds_in_target_space);
...
TEST_F(PropertyTreeBuilderTest, FastRoundedCornerDoesNotTriggerRenderSurfaceFromSubtree)
{
    // Layer Tree:
    // +root
    ...
    // Set up layer bounds.
    root->SetBounds(gfx::Size(100, 100));
    fast_rounded_corner_layer_1->SetBounds(gfx::ToRoundedSize(kRoundedCornerLayer1Bound.size()));
    rounded_corner_layer_1->SetBounds(gfx::ToRoundedSize(kRoundedCornerLayer2Bound.size()));
    rounded_corner_layer_2->SetBounds(gfx::ToRoundedSize(kRoundedCornerLayer3Bound.size()));
    rounded_corner_layer_3->SetBounds(gfx::ToRoundedSize(kRoundedCornerLayer4Bound.size()));
    ...
    // Set Rounded corners
    fast_rounded_corner_layer_1->SetRoundedCorner({ kRoundedCorner1Radius, kRoundedCorner1Radius, kRoundedCorner1Radius, kRoundedCorner1Radius });
    rounded_corner_layer_1->SetRoundedCorner({ kRoundedCorner2Radius, kRoundedCorner2Radius, kRoundedCorner2Radius, kRoundedCorner2Radius });
    rounded_corner_layer_2->SetRoundedCorner({ kRoundedCorner3Radius, kRoundedCorner3Radius, kRoundedCorner3Radius, kRoundedCorner3Radius });
    rounded_corner_layer_3->SetRoundedCorner({ kRoundedCorner4Radius, kRoundedCorner4Radius, kRoundedCorner4Radius, kRoundedCorner4Radius });
    ...
    // The offset from the origin of the render target is [5, 5] and the device
    // scale factor is 1.6.
    const gfx::RRectF actual_self_rrect_1 = fast_rounded_corner_layer_impl_1->draw_properties().mask_filter_info.rounded_corner_bounds();
    EXPECT_TRUE(actual_self_rrect_1.IsEmpty());

    gfx::RectF bounds_in_target_space = kRoundedCornerLayer1Bound;
    bounds_in_target_space.Scale(kDeviceScale);
    const gfx::RRectF actual_render_target_rrect_1 = fast_rounded_corner_layer_impl_1->render_target()->mask_filter_info().rounded_corner_bounds();
    EXPECT_EQ(actual_render_target_rrect_1.rect(), bounds_in_target_space);
    EXPECT_FLOAT_EQ(actual_render_target_rrect_1.GetSimpleRadius(), kRoundedCorner1Radius * kDeviceScale);
    ...
    // The offset from the origin of the render target is [0, 0] and the device
    // scale factor is 1.6. The corner radius is also scaled by a factor of 1.6.
    const gfx::RRectF actual_self_rrect_2 = rounded_corner_layer_impl_1->draw_properties().mask_filter_info.rounded_corner_bounds();
    bounds_in_target_space = kRoundedCornerLayer2Bound;
    bounds_in_target_space.Scale(kDeviceScale);
    EXPECT_EQ(actual_self_rrect_2.rect(), bounds_in_target_space);
    EXPECT_FLOAT_EQ(actual_self_rrect_2.GetSimpleRadius(), kRoundedCorner2Radius * kDeviceScale);
    ...
    // corner radius is also scaled by a factor of 1.6.
    const gfx::RRectF actual_self_rrect_3 = rounded_corner_layer_impl_2->draw_properties().mask_filter_info.rounded_corner_bounds();
    EXPECT_TRUE(actual_self_rrect_3.IsEmpty());

    bounds_in_target_space = kRoundedCornerLayer3Bound;
    bounds_in_target_space.Scale(kDeviceScale);
    const gfx::RRectF actual_render_target_rrect_3 = rounded_corner_layer_impl_2->render_target()->mask_filter_info().rounded_corner_bounds();
    EXPECT_EQ(actual_render_target_rrect_3.rect(), bounds_in_target_space);
    EXPECT_FLOAT_EQ(actual_render_target_rrect_3.GetSimpleRadius(), kRoundedCorner3Radius * kDeviceScale);
    ...
    // corner radius is also scaled by a factor of 1.6.
    const gfx::RRectF actual_self_rrect_4 = rounded_corner_layer_impl_3->draw_properties().mask_filter_info.rounded_corner_bounds();
    bounds_in_target_space = kRoundedCornerLayer4Bound;
    bounds_in_target_space.Scale(kDeviceScale);
    EXPECT_EQ(actual_self_rrect_4.rect(), bounds_in_target_space);
    EXPECT_FLOAT_EQ(actual_self_rrect_4.GetSimpleRadius(), kRoundedCorner4Radius * kDeviceScale);
