...
public:
    ...
    // switches to false.
    virtual void OnDeferCommitsChanged(bool defer_status, PaintHoldingReason reason, absl::optional<PaintHoldingCommitTrigger> trigger) = 0;
    ...
    // impl thread.
    virtual void DidCommit(base::TimeTicks commit_start_time, base::TimeTicks commit_finish_time) = 0;
    virtual void DidCommitAndDrawFrame() = 0;
    virtual void DidReceiveCompositorFrameAck() = 0;
    virtual void DidCompletePageScaleAnimation() = 0;
    virtual void DidPresentCompositorFrame(uint32_t frame_token, const gfx::PresentationFeedback& feedback) = 0;
