...
public:
    ...
    void SetupTree() override
    {
        ...
        auto resource
            = viz::TransferableResource::MakeGpu(mailbox, GL_LINEAR, GL_TEXTURE_2D, sync_token, size, viz::RGBA_8888, false /* is_overlay_candidate */);
        ...
        gpu::MailboxHolder holders[media::VideoFrame::kMaxPlanes] = { gpu::MailboxHolder(mailbox, sync_token, GL_TEXTURE_2D) };
        hw_video_frame_ = VideoFrame::WrapNativeTextures(media::PIXEL_FORMAT_ARGB, holders, media::VideoFrame::ReleaseMailboxCB(), gfx::Size(4, 4),
            gfx::Rect(0, 0, 4, 4), gfx::Size(4, 4), base::TimeDelta());
        ASSERT_TRUE(hw_video_frame_);
        scaled_hw_video_frame_ = VideoFrame::WrapNativeTextures(media::PIXEL_FORMAT_ARGB, holders, media::VideoFrame::ReleaseMailboxCB(), gfx::Size(4, 4),
...
public:
    ...
    void BeginTest() override
    {
        ...
        scrollbar_layer_ = FakePaintedScrollbarLayer::Create(false, true, scroll_layer->element_id());
