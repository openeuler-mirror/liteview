...
public:
    ...
    scoped_refptr<DisplayItemList> PaintContentsToDisplayList() override
    {
        ...
        display_list->push<ClipRectOp>(gfx::RectToSkRect(PaintableRegion()), SkClipOp::kIntersect, false);
...
TEST_P(LayerTreeHostMaskPixelTestWithLayerList, MaskWithEffect)
{
    ...
    pixel_comparator_ = std::make_unique<FuzzyPixelOffByOneComparator>(true /* discard_alpha */);
...
TEST_P(LayerTreeHostMasksForBackdropFiltersPixelTestWithLayerList, Test)
{
    ...
    if (use_skia_vulkan() && use_accelerated_raster()) {
        ...
        pixel_comparator_ = std::make_unique<FuzzyPixelComparator>(true /* discard_alpha */, percentage_pixels_large_error, percentage_pixels_small_error,
            average_error_allowed_in_bad_pixels, large_error_allowed, small_error_allowed);
    }
...
public:
        ...
        , force_shaders_(GetParam().flags & kForceShaders)
    {
        ...
        pixel_comparator_ = std::make_unique<FuzzyPixelComparator>(false, // discard_alpha
            percentage_pixels_error, percentage_pixels_small_error, average_error_allowed_in_bad_pixels, large_error_allowed, small_error_allowed);
    }
...
MaskTestConfig const kTestConfigs[] = {
    ...
    MaskTestConfig { { viz::RendererType::kSkiaVk, TestRasterType::kZeroCopy }, kUseAntialiasing },
#endif // BUILDFLAG(ENABLE_VULKAN_BACKEND_TESTS)
};
