...
public:
    ...
    const base::flat_set<AnimationDriver*>& GetDriversForTesting(PaintImage::Id paint_image_id) const;
...
private:
    ...
    private:
        ...
        // recording received.
        PaintImage::CompletionState completion_state_ = PaintImage::CompletionState::PARTIALLY_DONE;
