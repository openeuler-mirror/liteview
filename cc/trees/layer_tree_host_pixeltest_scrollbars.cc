...
public:
    ...
    void PaintPart(PaintCanvas* canvas, ScrollbarPart part, const gfx::Rect& rect) override
    {
        PaintFlags flags;
...
TEST_P(LayerTreeHostScrollbarsPixelTest, MAYBE_HugeTransformScale)
{
    ...
    auto context = base::MakeRefCounted<viz::TestInProcessContextProvider>(viz::TestContextType::kGLES2, /*support_locking=*/false);
    ...
    RunPixelTest(background, base::FilePath(use_skia_vulkan() ? FILE_PATH_LITERAL("spiral_64_scale_vk.png") : FILE_PATH_LITERAL("spiral_64_scale.png")));
}
...
TEST_P(LayerTreeHostOverlayScrollbarsPixelTest, NinePatchScrollbarScaledUp)
{
    ...
    scoped_refptr<PaintedOverlayScrollbarLayer> layer = PaintedOverlayScrollbarLayer::Create(std::move(scrollbar));
