...
public:
    ...
    void SimulateSubmitCompositorFrame(EventMetricsSet events_metrics)
    {
        ...
        ++current_token_;
        reporting_controller_.DidSubmitCompositorFrame(*current_token_, submit_time_, current_id_, last_activated_id_, std::move(events_metrics),
...
TEST_F(CompositorFrameReportingControllerTest, ActiveReporterCounts)
{
    ...
    reporting_controller_.DidSubmitCompositorFrame(0, AdvanceNowByMs(10), current_id_3, last_activated_id_, {},
        /*has_missing_content=*/false);
...
TEST_F(CompositorFrameReportingControllerTest, MainFrameCausedNoDamage)
{
    ...
    reporting_controller_.BeginMainFrameAborted(current_id_1, CommitEarlyOutReason::FINISHED_NO_UPDATES);
    ...
    reporting_controller_.BeginMainFrameAborted(current_id_2, CommitEarlyOutReason::FINISHED_NO_UPDATES);
...
TEST_F(CompositorFrameReportingControllerTest, DidNotProduceFrame)
{
    ...
    reporting_controller_.WillActivate();
    reporting_controller_.DidActivate();
    reporting_controller_.DidSubmitCompositorFrame(1, AdvanceNowByMs(10), current_id_2, current_id_1, {},
        /*has_missing_content=*/false);
    viz::FrameTimingDetails details = {};
...
TEST_F(CompositorFrameReportingControllerTest, DidNotProduceFrameDueToWaitingOnMain)
{
    ...
    reporting_controller_.DidSubmitCompositorFrame(1, AdvanceNowByMs(10), current_id_3, current_id_1, {},
        /*has_missing_content=*/false);
    viz::FrameTimingDetails details;
...
TEST_F(CompositorFrameReportingControllerTest, MainFrameAborted)
{
    ...
    reporting_controller_.WillBeginImplFrame(args_);
    reporting_controller_.WillBeginMainFrame(args_);
    reporting_controller_.BeginMainFrameAborted(current_id_, CommitEarlyOutReason::FINISHED_NO_UPDATES);
    reporting_controller_.OnFinishImplFrame(current_id_);
    reporting_controller_.DidSubmitCompositorFrame(1, AdvanceNowByMs(10), current_id_, last_activated_id_, {},
        /*has_missing_content=*/false);
...
TEST_F(CompositorFrameReportingControllerTest, MainFrameAborted2)
{
    ...
    histogram_tester.ExpectTotalCount("CompositorLatency.EndActivateToSubmitCompositorFrame", 2);
    histogram_tester.ExpectTotalCount("CompositorLatency.SubmitCompositorFrameToPresentationCompositorFrame", 2);
    reporting_controller_.DidSubmitCompositorFrame(2, AdvanceNowByMs(10), current_id_2, current_id_1, {},
        /*has_missing_content=*/false);
    ...
    reporting_controller_.WillBeginImplFrame(args_3);
    reporting_controller_.OnFinishImplFrame(current_id_3);
    reporting_controller_.DidSubmitCompositorFrame(3, AdvanceNowByMs(10), current_id_3, current_id_1, {},
        /*has_missing_content=*/false);
...
TEST_F(CompositorFrameReportingControllerTest, LongMainFrame)
{
    ...
    reporting_controller_.WillActivate();
    reporting_controller_.DidActivate();
    reporting_controller_.DidSubmitCompositorFrame(1, AdvanceNowByMs(10), current_id_1, current_id_1, {},
        /*has_missing_content=*/false);
    reporting_controller_.DidPresentCompositorFrame(1, details);
    ...
    reporting_controller_.WillActivate();
    reporting_controller_.DidActivate();
    reporting_controller_.DidSubmitCompositorFrame(3, AdvanceNowByMs(10), current_id_3, current_id_2, {},
        /*has_missing_content=*/false);
    reporting_controller_.DidPresentCompositorFrame(3, details);
...
TEST_F(CompositorFrameReportingControllerTest, ReportingMissedDeadlineFrame1)
{
    ...
    reporting_controller_.WillActivate();
    reporting_controller_.DidActivate();
    reporting_controller_.DidSubmitCompositorFrame(1, AdvanceNowByMs(10), current_id_, current_id_, {},
        /*has_missing_content=*/false);
    viz::FrameTimingDetails details = {};
...
TEST_F(CompositorFrameReportingControllerTest, EventLatencyMainRepaintedScroll)
{
    ...
    std::unique_ptr<EventMetrics> metrics_1
        = CreateScrollUpdateEventMetrics(ui::ScrollInputType::kWheel, /*is_inertial=*/false, ScrollUpdateEventMetrics::ScrollUpdateType::kStarted);
    ...
    std::unique_ptr<EventMetrics> metrics_2
        = CreateScrollUpdateEventMetrics(ui::ScrollInputType::kWheel, /*is_inertial=*/false, ScrollUpdateEventMetrics::ScrollUpdateType::kContinued);
    ...
    reporting_controller_.DidSubmitCompositorFrame(*current_token_, AdvanceNowByMs(10), current_id_, {}, { {}, std::move(metrics_list) },
        /*has_missing_content=*/false);
    ...
    base::TimeDelta expected_latency_1 = details_2.presentation_feedback.timestamp - start_time_1;
    histogram_tester.ExpectBucketCount("EventLatency.FirstGestureScrollUpdate.Wheel.TotalLatency", expected_latency_1.InMicroseconds(), 1);

    // metrics_2 did NOT have requires_main_thread_update(), so its latency is
    // based on the partial-update presentation (details_1).
    base::TimeDelta expected_latency_2 = details_1.presentation_feedback.timestamp - start_time_2;
    histogram_tester.ExpectBucketCount("EventLatency.GestureScrollUpdate.Wheel.TotalLatency", expected_latency_2.InMicroseconds(), 1);
}
...
TEST_F(CompositorFrameReportingControllerTest, NewMainUpdateIsNotPartialUpdate)
{
    ...
    SimulateBeginMainFrame();
    reporting_controller_.OnFinishImplFrame(current_id_);
    reporting_controller_.DidSubmitCompositorFrame(1u, AdvanceNowByMs(10), current_id_, {}, {},
        /*has_missing_content=*/false);
    viz::FrameTimingDetails details = {};
    details.presentation_feedback.timestamp = AdvanceNowByMs(10);
    ...
    SimulateBeginMainFrame();
    reporting_controller_.OnFinishImplFrame(current_id_);
    reporting_controller_.DidSubmitCompositorFrame(1u, AdvanceNowByMs(10), current_id_, previous_id, {},
        /*has_missing_content=*/false);
    details.presentation_feedback.timestamp = AdvanceNowByMs(10);
    reporting_controller_.DidPresentCompositorFrame(1u, details);
...
TEST_F(CompositorFrameReportingControllerTest, DependentDroppedFrameTerminatesReporterImmediately)
{
    ...
    SimulateBeginImplFrame();
    reporting_controller_.OnFinishImplFrame(current_id_);
    reporting_controller_.DidSubmitCompositorFrame(2u, AdvanceNowByMs(10), current_id_, {}, {},
        /*has_missing_content=*/false);
...
TEST_F(CompositorFrameReportingControllerTest, CompositorFrameBlockedOnMainFrameWithNoDamage)
{
    ...
    reporting_controller_.BeginMainFrameAborted(args_1.frame_id, CommitEarlyOutReason::FINISHED_NO_UPDATES);
    reporting_controller_.DidNotProduceFrame(args_1.frame_id, FrameSkippedReason::kNoDamage);
    EXPECT_EQ(0u, dropped_counter_.total_dropped());
...
TEST_F(CompositorFrameReportingControllerTest, DroppedFrameCountOnMainFrameAbort)
{
    ...
    for (int i = 0; i < 5; ++i) {
        ...
        SimulateBeginMainFrame();
        reporting_controller_.OnFinishImplFrame(current_id_);
        reporting_controller_.BeginMainFrameAborted(current_id_, CommitEarlyOutReason::ABORTED_DEFERRED_COMMIT);
        SimulateSubmitCompositorFrame({});
    }
    SimulatePresentCompositorFrame();
...
TEST_F(CompositorFrameReportingControllerTest, NewMainThreadUpdateNotReportedAsDropped)
{
    ...
    reporting_controller_.DidSubmitCompositorFrame(2u, AdvanceNowByMs(10), current_id_, previous_id, {},
        /*has_missing_content=*/false);
    details.presentation_feedback.timestamp = AdvanceNowByMs(10);
