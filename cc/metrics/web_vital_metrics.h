...
struct CC_EXPORT WebVitalMetrics {
    ...
    bool HasValue() const
    {
        return has_lcp || has_fid || has_cls;
    }
    ...
    static constexpr MetricsInfo lcp_info = { 2.5f, 4.f, WebVitalMetrics::MetricsInfo::Unit::kSecond };
    static constexpr MetricsInfo fid_info = { 100, 300, WebVitalMetrics::MetricsInfo::Unit::kMillisecond };
    static constexpr MetricsInfo cls_info = { 0.1f, 0.25f, WebVitalMetrics::MetricsInfo::Unit::kScore };
};
