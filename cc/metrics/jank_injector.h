...
public:
    ...
    ScopedJankInjectionEnabler& operator=(const ScopedJankInjectionEnabler&) = delete;
};
...
public:
    ...
    void ScheduleJankIfNeeded(const viz::BeginFrameArgs& args, base::SingleThreadTaskRunner* task_runner);

    const JankConfig& config() const
    {
        return config_;
    }
...
private:
    ...
    void ScheduleJank(const viz::BeginFrameArgs& args, base::SingleThreadTaskRunner* task_runner);
    void SignalJank();
