...
public:
    ...
    virtual void DidSubmitCompositorFrame(uint32_t frame_token, base::TimeTicks submit_time, const viz::BeginFrameId& current_frame_id,
...
private:
    ...
    void ReportMultipleSwaps(base::TimeTicks begin_frame_time, base::TimeDelta interval);
    ...
    std::map<viz::BeginFrameId, EventMetrics::List> events_metrics_from_dropped_frames_;
