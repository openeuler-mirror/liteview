...
TEST_F(JankInjectorTest, Basic)
{
    ...
    features.InitFromCommandLine("JankInjectionAblation:cluster/4/percent/10", std::string());
    ...
    auto args = viz::BeginFrameArgs::Create(BEGINFRAME_FROM_HERE, kSourceId, ++sequence_number, frame_time, deadline, kInterval, viz::BeginFrameArgs::NORMAL);
