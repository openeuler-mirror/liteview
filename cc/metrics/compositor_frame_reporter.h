...
public:
    ...
    private:
        absl::optional<std::pair<base::TimeTicks, base::TimeTicks>> list_[static_cast<int>(VizBreakdown::kBreakdownCount)];
    ...
    static const char* GetStageName(StageType stage_type, absl::optional<VizBreakdown> viz_breakdown = absl::nullopt,
        absl::optional<BlinkBreakdown> blink_breakdown = absl::nullopt, bool impl_only = false);
...
private:
    ...
    void ReportCompositorLatencyHistogram(FrameSequenceTrackerType intraction_type, StageType stage_type, absl::optional<VizBreakdown> viz_breakdown,
        absl::optional<BlinkBreakdown> blink_breakdown, base::TimeDelta time_delta) const;
