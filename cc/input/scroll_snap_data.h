...
struct SnapAreaData {
    ...
    SnapAreaData(const ScrollSnapAlign& align, const gfx::RectF& rec, bool msnap, ElementId id)
...
public:
    ...
    bool operator==(const SnapContainerData& other) const
    {
        return (other.scroll_snap_type_ == scroll_snap_type_) && (other.rect_ == rect_) && (other.max_position_ == max_position_)
            ...
            && (other.target_snap_area_element_ids_ == target_snap_area_element_ids_);
    }
    ...
    bool FindSnapPosition(const SnapSelectionStrategy& strategy, gfx::PointF* snap_position, TargetSnapAreaElementIds* target_element_ids,
...
private:
    ...
    absl::optional<SnapSearchResult> FindClosestValidAreaInternal(SearchAxis axis, const SnapSelectionStrategy& strategy,
        const SnapSearchResult& cross_axis_snap_result, const ElementId& active_element_id, bool should_consider_covering = true) const;
    ...
    // given axis.
    absl::optional<SnapSearchResult> GetTargetSnapAreaSearchResult(SearchAxis axis) const;
