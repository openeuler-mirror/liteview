...
TEST_F(SnapFlingControllerTest, CreatesAndAnimatesCurveOnFirstInertialGSU)
{
    ...
    EXPECT_CALL(mock_client_, GetSnapFlingInfoAndSetAnimatingSnapTarget(testing::_, testing::_, testing::_))
        .WillOnce(testing::DoAll(testing::SetArgPointee<1>(gfx::PointF(0, 0)), testing::SetArgPointee<2>(gfx::PointF(0, 100)), testing::Return(true)));
...
TEST_F(SnapFlingControllerTest, ScrollEndWhenHasEqualOffsetsOnInertialGSU)
{
    ...
    EXPECT_CALL(mock_client_, GetSnapFlingInfoAndSetAnimatingSnapTarget(testing::_, testing::_, testing::_))
        .WillOnce(testing::DoAll(testing::SetArgPointee<1>(gfx::PointF(0, 0)), testing::SetArgPointee<2>(gfx::PointF(0, 0)), testing::Return(true)));
...
TEST_F(SnapFlingControllerTest, DoesNotHandleNonInertialGSU)
{
    ...
    EXPECT_CALL(mock_client_, GetSnapFlingInfoAndSetAnimatingSnapTarget(testing::_, testing::_, testing::_)).Times(0);
    EXPECT_CALL(mock_client_, RequestAnimationForSnapFling()).Times(0);
    EXPECT_CALL(mock_client_, ScrollByForSnapFling(testing::_)).Times(0);
