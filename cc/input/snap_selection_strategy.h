...
public:
    ...
    static std::unique_ptr<SnapSelectionStrategy> CreateForEndPosition(
        const gfx::PointF& current_position, bool scrolled_x, bool scrolled_y, SnapTargetsPrioritization prioritization = SnapTargetsPrioritization::kIgnore);
    ...
    virtual const absl::optional<SnapSearchResult>& PickBestResult(
        const absl::optional<SnapSearchResult>& closest, const absl::optional<SnapSearchResult>& covering) const
        = 0;
...
public:
    EndPositionStrategy(const gfx::PointF& current_position, bool scrolled_x, bool scrolled_y, SnapTargetsPrioritization snap_targets_prioritization)
    ...
    const absl::optional<SnapSearchResult>& PickBestResult(
        const absl::optional<SnapSearchResult>& closest, const absl::optional<SnapSearchResult>& covering) const override;
