...
const float kIdleThicknessScale = SingleScrollbarAnimationControllerThinning::kIdleThicknessScale;
...
class ScrollbarAnimationControllerAuraOverlayTest : public LayerTreeImplTestBase, public testing::Test {
public:
...
protected:
    ...
    void SetUp() override
    {
        ...
        h_scrollbar_layer_
            = AddLayer<SolidColorScrollbarLayerImpl>(ScrollbarOrientation::HORIZONTAL, kThumbThickness, kTrackStart, kIsLeftSideVerticalScrollbar);
        v_scrollbar_layer_ = AddLayer<SolidColorScrollbarLayerImpl>(ScrollbarOrientation::VERTICAL, kThumbThickness, kTrackStart, kIsLeftSideVerticalScrollbar);
        ...
        scrollbar_controller_ = ScrollbarAnimationController::CreateScrollbarAnimationControllerAuraOverlay(
            scroll_layer_->element_id(), &client_, kFadeDelay, kFadeDuration, kThinningDuration, 0.0f);
        v_scrollbar_layer_->SetCurrentPos(0);
        h_scrollbar_layer_->SetCurrentPos(0);
        mouse_move_distance_to_trigger_fade_in_
            = scrollbar_controller_->GetScrollbarAnimationController(ScrollbarOrientation::VERTICAL).MouseMoveDistanceToTriggerFadeIn();
        mouse_move_distance_to_trigger_expand_
            = scrollbar_controller_->GetScrollbarAnimationController(ScrollbarOrientation::VERTICAL).MouseMoveDistanceToTriggerExpand();
    }
...
class ScrollbarAnimationControllerFluentOverlayTest : public ScrollbarAnimationControllerAuraOverlayTest {
public:
...
TEST_F(ScrollbarAnimationControllerAuraOverlayTest, BasicAppearByWillUpdateScrollThenFadeOut)
{
    base::TimeTicks time;
    time += base::Seconds(1);
...
// to fade out.
TEST_F(ScrollbarAnimationControllerAuraOverlayTest, DontFadeWhileCapturedBeforeThick)
{
    base::TimeTicks time;
    time += base::Seconds(1);
...
TEST_F(ScrollbarAnimationControllerAuraOverlayTest, DontFadeWhileCapturedThenAway)
{
    base::TimeTicks time;
    time += base::Seconds(1);
...
TEST_F(ScrollbarAnimationControllerAuraOverlayTest, MoveNearScrollbarWhileFading)
{
    base::TimeTicks time;
    time += base::Seconds(1);
...
TEST_F(ScrollbarAnimationControllerAuraOverlayTest, MainThreadScrollQueuesFade)
{
...
TEST_F(ScrollbarAnimationControllerAuraOverlayTest, MouseNearOtherBeforeAnimationFinished)
{
    base::TimeTicks time;
    time += base::Seconds(1);
...
TEST_F(ScrollbarAnimationControllerFluentOverlayTest, FluentScrollbarMinimalModeByDefault)
{
...
TEST_F(ScrollbarAnimationControllerFluentOverlayTest, FluentScrollbarMinimalModeOnMouseLeave)
{
...
TEST_F(ScrollbarAnimationControllerFluentOverlayTest, FluentScrollbarMinimalModeOnWillUpdateScroll)
{
...
protected:
    void SetUp() override
    {
        ...
        scroll_layer_ = AddLayer<LayerImpl>();
        scrollbar_layer_ = AddLayer<SolidColorScrollbarLayerImpl>(orientation(), kThumbThickness, kTrackStart, kIsLeftSideVerticalScrollbar);
        SetElementIdsForTesting();
