...
struct MemBufSkdata { // ��չԭ���mbMemBuf����mbMemBuf::unuse������
    mbMemBuf buf;
    sk_sp<SkData> skdata;
};

struct MemBufStdString { // ��չԭ���mbMemBuf����mbMemBuf::unuse������
    mbMemBuf buf;
...
mbMemBuf* MB_CALL_TYPE mbUtilBase64EncodeBuffer(const void* str, int len)
{
    ...
    base::Base64EncodeAppend(base::span<const uint8_t>((const uint8_t*)str, len), base64Str);
...
void MB_CALL_TYPE mbEnableHighDPISupport()
{
    ...
    content::RenderThreadImpl::get()->setZoom(f);
#endif
}
