...
public:
    enum OS {
        ...
        kOsMacMonterey = 1 << 22,
        kOsMacVentura = 1 << 23,
        kOsMac = kOsMacLeopard | kOsMacSnowLeopard | kOsMacLion | kOsMacMountainLion | kOsMacMavericks | kOsMacYosemite | kOsMacElCapitan | kOsMacSierra | kOsMacHighSierra
            | kOsMacMojave | kOsMacCatalina | kOsMacBigSur | kOsMacMonterey | kOsMacVentura,
