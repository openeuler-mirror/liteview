...
public:
    ...
    enum MultiGpuStyle { kMultiGpuStyleOptimus, kMultiGpuStyleAMDSwitchable, kMultiGpuStyleAMDSwitchableIntegrated, kMultiGpuStyleAMDSwitchableDiscrete, kMultiGpuStyleNone };
    ...
    struct GPU_EXPORT Version {
        ...
        bool Contains(const std::string& version_string) const { return Contains(version_string, '.'); }
