...
void GPUTestConfig::set_gpu_device_id(uint32_t id) { gpu_device_id_ = id; }
...
void GPUTestConfig::ClearGPUVendor() { gpu_vendor_.clear(); }
...
// static
bool GPUTestBotConfig::GpuBlocklistedOnBot() { return false; }
