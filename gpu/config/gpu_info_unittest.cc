...
public:
    ...
    void BeginVideoDecodeAcceleratorSupportedProfile() override { video_decode_accelerator_profile_active_ = true; }

    void EndVideoDecodeAcceleratorSupportedProfile() override { video_decode_accelerator_profile_active_ = false; }

    void BeginVideoEncodeAcceleratorSupportedProfile() override { video_encode_accelerator_profile_active_ = true; }

    void EndVideoEncodeAcceleratorSupportedProfile() override { video_encode_accelerator_profile_active_ = false; }

    void BeginImageDecodeAcceleratorSupportedProfile() override { image_decode_accelerator_profile_active_ = true; }

    void EndImageDecodeAcceleratorSupportedProfile() override { image_decode_accelerator_profile_active_ = false; }
    ...
    bool video_decode_accelerator_profile_active() const { return video_decode_accelerator_profile_active_; }

    bool video_encode_accelerator_profile_active() const { return video_encode_accelerator_profile_active_; }

    bool image_decode_accelerator_profile_active() const { return image_decode_accelerator_profile_active_; }
