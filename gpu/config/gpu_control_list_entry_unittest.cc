...
public:
    ...
    void EntryShouldApply(const Entry& entry) const { EXPECT_TRUE(EntryApplies(entry)); }

    void EntryShouldNotApply(const Entry& entry) const { EXPECT_FALSE(EntryApplies(entry)); }
