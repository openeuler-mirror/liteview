...
void PrintDeviceError(WGPUErrorType, const char* message, void*) { DLOG(ERROR) << "*** WebGPU client Device error: " << message; }

} // namespace

namespace skia_bindings {

GrContextForWebGPUInterface::GrContextForWebGPUInterface(gpu::webgpu::WebGPUInterface* webgpu, gpu::ContextSupport* context_support, const gpu::Capabilities& capabilities,
...
GrDirectContext* GrContextForWebGPUInterface::get() { return gr_context_.get(); }
