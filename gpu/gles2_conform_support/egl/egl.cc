...
extern "C" {
EGLAPI EGLint EGLAPIENTRY eglGetError() { return ThreadState::Get()->ConsumeErrorCode(); }
...
EGLAPI EGLenum EGLAPIENTRY eglQueryAPI() { return EGL_OPENGL_ES_API; }
...
EGLAPI EGLContext EGLAPIENTRY eglGetCurrentContext() { return EGL_NO_CONTEXT; }

EGLAPI EGLSurface EGLAPIENTRY eglGetCurrentSurface(EGLint readdraw) { return EGL_NO_SURFACE; }

EGLAPI EGLDisplay EGLAPIENTRY eglGetCurrentDisplay() { return EGL_NO_DISPLAY; }
...
EGLAPI EGLBoolean EGLAPIENTRY eglWaitGL() { return EGL_FALSE; }
