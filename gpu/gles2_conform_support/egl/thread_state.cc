...
Display* ThreadState::GetDefaultDisplay() { return g_egl_default_display; }
...
void ThreadState::AutoCurrentContextRestore::SetCurrent(Surface* surface, Context* context) { thread_state_->SetCurrent(surface, context); }
