...
int RunHelper(base::TestSuite* test_suite) { return test_suite->Run(); }
...
bool RunGLES2ConformTest(const char* path)
{
    ...
    base::FilePath test_expectations_path
        = src_path.Append(FILE_PATH_LITERAL("gpu")).Append(FILE_PATH_LITERAL("gles2_conform_support")).Append(FILE_PATH_LITERAL("gles2_conform_test_expectations.txt"));
