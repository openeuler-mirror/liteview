...
EGLImageKHR GTFCreateEGLImage(int width, int height, GLenum format, GLenum type)
{
    ...
    EGLImageKHR egl_image = egl_create_image_khr_(eglGetCurrentDisplay(), eglGetCurrentContext(), EGL_GL_TEXTURE_2D_KHR, reinterpret_cast<EGLClientBuffer>(texture), attrib);
