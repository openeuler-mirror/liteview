...
public:
    ...
    bool Initialize(VulkanDeviceQueue* device_queue, VkSurfaceKHR surface, const VkSurfaceFormatKHR& surface_format, const gfx::Size& image_size, uint32_t min_image_count,
...
private:
    ...
    bool BeginWriteCurrentImage(VkImage* image, uint32_t* image_index, VkImageLayout* layout, VkImageUsageFlags* usage, VkSemaphore* begin_semaphore, VkSemaphore* end_semaphore);
