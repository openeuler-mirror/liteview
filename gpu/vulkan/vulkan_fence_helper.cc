...
void VulkanFenceHelper::Destroy() { PerformImmediateCleanup(); }
...
void VulkanFenceHelper::EnqueueCleanupTaskForSubmittedWork(CleanupTask task) { tasks_pending_fence_.emplace_back(std::move(task)); }
