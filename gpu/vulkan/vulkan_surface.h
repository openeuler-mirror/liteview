...
public:
    ...
    void PostSubBufferAsync(const gfx::Rect& rect, VulkanSwapChain::PostSubBufferCompletionCallback completion_callback, PresentationCallback presentation_callback);
    ...
    gfx::AcceleratedWidget accelerated_widget() const { return accelerated_widget_; }
...
private:
    ...
    void PostSubBufferCompleted(VulkanSwapChain::PostSubBufferCompletionCallback completion_callback, PresentationCallback presentation_callback, gfx::SwapResult result);
