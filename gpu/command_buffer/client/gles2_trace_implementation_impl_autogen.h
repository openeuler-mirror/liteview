...
void GLES2TraceImplementation::CompressedTexSubImage3D(
...
void GLES2TraceImplementation::CopyTexSubImage3D(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLint x, GLint y, GLsizei width, GLsizei height)
{
...
void GLES2TraceImplementation::GetTransformFeedbackVarying(GLuint program, GLuint index, GLsizei bufsize, GLsizei* length, GLsizei* size, GLenum* type, char* name)
{
...
void GLES2TraceImplementation::InvalidateSubFramebuffer(GLenum target, GLsizei count, const GLenum* attachments, GLint x, GLint y, GLsizei width, GLsizei height)
{
...
void GLES2TraceImplementation::MultiDrawArraysInstancedWEBGL(GLenum mode, const GLint* firsts, const GLsizei* counts, const GLsizei* instance_counts, GLsizei drawcount)
{
...
void GLES2TraceImplementation::TexImage3D(
...
void GLES2TraceImplementation::TexSubImage3D(
...
void GLES2TraceImplementation::FramebufferTexture2DMultisampleEXT(GLenum target, GLenum attachment, GLenum textarget, GLuint texture, GLint level, GLsizei samples)
{
...
void GLES2TraceImplementation::CopyTextureCHROMIUM(GLuint source_id, GLint source_level, GLenum dest_target, GLuint dest_id, GLint dest_level, GLint internalformat,
...
void GLES2TraceImplementation::CopySubTextureCHROMIUM(GLuint source_id, GLint source_level, GLenum dest_target, GLuint dest_id, GLint dest_level, GLint xoffset, GLint yoffset,
...
void GLES2TraceImplementation::ProduceTextureDirectCHROMIUM(GLuint texture, GLbyte* mailbox)
{
    TRACE_EVENT_BINARY_EFFICIENT0("gpu", "GLES2Trace::ProduceTextureDirectCHROMIUM");
    gl_->ProduceTextureDirectCHROMIUM(texture, mailbox);
}

GLuint GLES2TraceImplementation::CreateAndConsumeTextureCHROMIUM(const GLbyte* mailbox)
{
    TRACE_EVENT_BINARY_EFFICIENT0("gpu", "GLES2Trace::CreateAndConsumeTextureCHROMIUM");
...
{
    TRACE_EVENT_BINARY_EFFICIENT0("gpu", "GLES2Trace::CoverageModulationCHROMIUM");
...
void GLES2TraceImplementation::FramebufferTextureMultiviewOVR(GLenum target, GLenum attachment, GLuint texture, GLint level, GLint baseViewIndex, GLsizei numViews)
{
