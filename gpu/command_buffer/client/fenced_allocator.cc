...
uint32_t RoundDown(uint32_t size) { return size & ~(FencedAllocator::kAllocAlignment - 1); }
...
bool FencedAllocator::InUseOrFreePending() { return blocks_.size() != 1 || blocks_[0].state != FREE; }
