...
public:
    ...
    void UseProgram(const gfx::Size& src_texture_size, const gfx::RectF& src_rect, const gfx::Size& dst_size, bool scale_x, bool flip_y, const GLfloat color_weights[3][4]);
...
public:
    ...
    void ScaleToMultipleOutputs(GLuint src_texture, const gfx::Size& src_texture_size, const gfx::Vector2dF& src_offset, GLuint dest_texture_0, GLuint dest_texture_1,
    ...
    void ComputeRegionOfInfluence(
        const gfx::Size& src_texture_size, const gfx::Vector2dF& src_offset, const gfx::Rect& output_rect, gfx::Rect* sampling_rect, gfx::Vector2dF* offset) const override
    {
    ...
    GLenum GetReadbackFormat() const override { return chain_properties_->readback_format; }
...
private:
    ...
    {
        return gfx::ScaleRect(gfx::RectF(rect), static_cast<float>(spec_.scale_from.x()) / spec_.scale_to.x(), static_cast<float>(spec_.scale_from.y()) / spec_.scale_to.y());
    }
    ...
    // provide.
    std::pair<gfx::RectF, gfx::Rect> ComputeBaseCaseRects(const gfx::Size& src_texture_size, const gfx::Vector2dF& src_offset, const gfx::Rect& requested_output_rect) const
    {
        DCHECK(!subscaler_);
    ...
    void Execute(GLuint src_texture, const gfx::Size& src_texture_size, const gfx::RectF& src_rect, GLuint dest_texture_0, GLuint dest_texture_1, const gfx::Size& result_size)
    {
...
// static
void GLHelperScaling::ConvertScalerOpsToScalerStages(GLHelper::ScalerQuality quality, gfx::Vector2d scale_from, base::circular_deque<GLHelperScaling::ScaleOp>* x_ops,
...
// static
void GLHelperScaling::ComputeScalerStages(GLHelper::ScalerQuality quality, const gfx::Vector2d& scale_from, const gfx::Vector2d& scale_to, bool flipped_source, bool flip_output,
    bool swizzle, std::vector<ScalerStage>* scaler_stages)
{
...
{
    const ScalerStage stage = { SHADER_PLANAR, plane == 0 ? gfx::Vector2d(4, 1) : gfx::Vector2d(8, 2), gfx::Vector2d(1, 1), true, flipped_source, flip_output, swizzle };
    auto result = std::make_unique<ScalerImpl>(gl_, this, stage, nullptr);
    switch (plane) {
    case 0:
