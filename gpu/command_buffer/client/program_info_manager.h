...
public:
    ...
    bool GetTransformFeedbackVarying(GLES2Implementation* gl, GLuint program, GLuint index, GLsizei bufsize, GLsizei* length, GLsizei* size, GLenum* type, char* name);
...
private:
    ...
    Program* GetProgramInfo(GLES2Implementation* gl, GLuint program, ProgramInfoType type);
