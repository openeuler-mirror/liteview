...
DawnProcTable* WebGPUInterfaceStub::procs() { return static_cast<APIChannelStub*>(api_channel_.get())->procs(); }
...
scoped_refptr<APIChannel> WebGPUInterfaceStub::GetAPIChannel() const { return api_channel_; }
void WebGPUInterfaceStub::FlushCommands() { }
bool WebGPUInterfaceStub::EnsureAwaitingFlush() { return false; }
void WebGPUInterfaceStub::FlushAwaitingCommands() { }
ReservedTexture WebGPUInterfaceStub::ReserveTexture(WGPUDevice, const WGPUTextureDescriptor*) { return { nullptr, 0, 0, 0, 0 }; }

WGPUDevice WebGPUInterfaceStub::DeprecatedEnsureDefaultDeviceSync() { return nullptr; }
