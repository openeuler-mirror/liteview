...
public:
    ...
    public:
        ...
        uint32_t shm_offset() const { return info_.bucket->base_shm_offset + sizeof(QuerySync) * info_.index(); }

        void MarkAsActive() { state_ = kActive; }
        ...
        bool NeverUsed() const { return state_ == kUninitialized; }
    ...
    int32_t DisjointCountSyncShmID() const { return disjoint_count_sync_shm_id_; }

    uint32_t DisjointCountSyncShmOffset() const { return disjoint_count_sync_shm_offset_; }
