...
public:
    ...
    bool MarkAsUsedForBind(GLES2Implementation* gl_impl, GLenum target, GLuint index, GLuint id, GLintptr offset, GLsizeiptr size, BindIndexedRangeFn bind_fn) override
    {
        base::AutoLock auto_lock(lock_);
        bool result = id ? id_allocator_.MarkAsUsed(id) : true;
...
public:
    ...
    bool MarkAsUsedForBind(GLES2Implementation* /* gl_impl */, GLenum /* target */, GLuint /* index */, GLuint /* id */, GLintptr /* offset */, GLsizeiptr /* size */,
...
void ShareGroup::SetProgramInfoManagerForTesting(ProgramInfoManager* manager) { program_info_manager_.reset(manager); }
