...
public:
    ...
    base::Lock* GetDrDcLockPtr() const { return lock_ ? lock_->GetDrDcLockPtr() : nullptr; }
    ...
    std::unique_ptr<base::AutoLockMaybe> GetScopedDrDcLock() const { return std::make_unique<base::AutoLockMaybe>(GetDrDcLockPtr()); }
