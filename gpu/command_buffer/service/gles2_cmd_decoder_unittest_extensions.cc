...
class GLES2DecoderTestWithCHROMIUMFramebufferMixedSamples : public GLES2DecoderTest {
public:
...
INSTANTIATE_TEST_SUITE_P(Service, GLES2DecoderTestWithCHROMIUMFramebufferMixedSamples, ::testing::Bool());
