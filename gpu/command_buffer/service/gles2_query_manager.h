...
public:
    ...
    public:
        ...
        void SafelyResetDisjointValue() { gles2_query_manager_->SafelyResetDisjointValue(); }

        void UpdateDisjointValue() { gles2_query_manager_->UpdateDisjointValue(); }

        void BeginContinualDisjointUpdate() { gles2_query_manager_->update_disjoints_continually_ = true; }
