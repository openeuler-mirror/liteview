...
public:
    ...
    ValueValidator(const T* valid_values, int num_values) { AddValues(valid_values, num_values); }
    ...
    bool IsValid(const T value) const { return base::Contains(valid_values_, value); }
