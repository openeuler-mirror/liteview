...
public:
    explicit AsyncAPIMock(bool default_do_commands, CommandBufferServiceBase* command_buffer_service);
...
public:
    ...
    MOCK_CONST_METHOD9(Translate,
        bool(const std::string& shader_source, std::string* info_log, std::string* translated_source, int* shader_version, AttributeMap* attrib_map, UniformMap* uniform_map,
            VaryingMap* varying_map, InterfaceBlockMap* interface_block_map, OutputVariableList* output_variable_list));
