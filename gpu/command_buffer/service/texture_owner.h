...
class GPU_GLES2_EXPORT TextureOwner : public base::RefCountedDeleteOnSequence<TextureOwner>, public SharedContextState::ContextLostObserver {
public:
    ...
    static std::unique_ptr<gles2::AbstractTexture> CreateTexture(scoped_refptr<SharedContextState> context_state);
...
protected:
    ...
    public:
        ScopedRestoreTextureBinding() { glGetIntegerv(GL_TEXTURE_BINDING_EXTERNAL_OES, &bound_service_id_); }
        ~ScopedRestoreTextureBinding() { glBindTexture(GL_TEXTURE_EXTERNAL_OES, bound_service_id_); }
    ...
    TextureOwner(bool binds_texture_on_update, std::unique_ptr<gles2::AbstractTexture> texture, scoped_refptr<SharedContextState> context_state);
...
private:
    ...
    TextureOwner(bool binds_texture_on_update, std::unique_ptr<gles2::AbstractTexture> texture);
