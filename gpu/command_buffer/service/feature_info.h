...
public:
    ...
    const Validators* validators() const { return &validators_; }
    ...
    const DisallowedFeatures& disallowed_features() const { return disallowed_features_; }
    ...
    bool ext_color_buffer_float_available() const { return ext_color_buffer_float_available_; }

    bool ext_color_buffer_half_float_available() const { return ext_color_buffer_half_float_available_; }

    bool oes_texture_float_linear_available() const { return oes_texture_float_linear_available_; }

    bool oes_texture_half_float_linear_available() const { return oes_texture_half_float_linear_available_; }

    bool is_passthrough_cmd_decoder() const { return is_passthrough_cmd_decoder_; }
