...
GpuFenceManager::~GpuFenceManager() { DCHECK(gpu_fence_entries_.empty()); }
...
bool GpuFenceManager::RemoveGpuFence(uint32_t client_id) { return gpu_fence_entries_.erase(client_id) == 1u; }
