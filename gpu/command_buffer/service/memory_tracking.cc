...
MemoryTypeTracker::MemoryTypeTracker(MemoryTracker* memory_tracker)
    : MemoryTypeTracker(memory_tracker, base::SequencedTaskRunnerHandle::IsSet() ? base::SequencedTaskRunnerHandle::Get() : nullptr)
{
}
...
MemoryTypeTracker::~MemoryTypeTracker() { DCHECK_EQ(mem_represented_, 0u); }
