...
public:
    ...
    DXGISharedHandleState(base::PassKey<DXGISharedHandleManager>, scoped_refptr<DXGISharedHandleManager> manager, gfx::DXGIHandleToken token, base::win::ScopedHandle shared_handle,
    ...
    Microsoft::WRL::ComPtr<ID3D11Texture2D> d3d11_texture() const { return d3d11_texture_; }
...
public:
    explicit DXGISharedHandleManager(Microsoft::WRL::ComPtr<ID3D11Device> d3d11_device);
    ...
    scoped_refptr<DXGISharedHandleState> GetOrCreateSharedHandleState(gfx::DXGIHandleToken token, base::win::ScopedHandle shared_handle);
    ...
    scoped_refptr<DXGISharedHandleState> CreateAnonymousSharedHandleState(base::win::ScopedHandle shared_handle, Microsoft::WRL::ComPtr<ID3D11Texture2D> d3d11_texture);
...
private:
    ...
    using SharedHandleMap = std::map<gfx::DXGIHandleToken, DXGISharedHandleState*>;
