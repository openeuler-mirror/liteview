...
void CommandsIssuedQuery::Pause() { MarkAsPaused(); }

void CommandsIssuedQuery::Resume() { MarkAsActive(); }
...
void CommandsIssuedQuery::QueryCounter(base::subtle::Atomic32 submit_count) { NOTREACHED(); }

void CommandsIssuedQuery::Process(bool did_finish) { NOTREACHED(); }
...
void CommandsIssuedTimestampQuery::Begin() { NOTREACHED(); }

void CommandsIssuedTimestampQuery::Pause() { MarkAsPaused(); }

void CommandsIssuedTimestampQuery::Resume() { MarkAsActive(); }

void CommandsIssuedTimestampQuery::End(base::subtle::Atomic32 submit_count) { NOTREACHED(); }
...
void CommandsIssuedTimestampQuery::Process(bool did_finish) { NOTREACHED(); }
...
void CommandsCompletedQuery::Pause() { MarkAsPaused(); }

void CommandsCompletedQuery::Resume() { MarkAsActive(); }
...
void CommandsCompletedQuery::QueryCounter(base::subtle::Atomic32 submit_count) { NOTREACHED(); }
...
void QueryManager::StartTracking(QueryManager::Query* /* query */) { ++query_count_; }

void QueryManager::StopTracking(QueryManager::Query* /* query */) { --query_count_; }

GLenum QueryManager::AdjustTargetForEmulation(GLenum target) { return target; }
