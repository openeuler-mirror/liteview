...
protected:
    ...
    GLenum GetInitialTarget(const Buffer* buffer) const { return buffer->initial_target(); }
...
TEST_F(BufferManagerTest, GetMaxValueForRangeUint8) { RunGetMaxValueForRangeUint8Test(false); }

TEST_F(BufferManagerTest, GetMaxValueForRangeUint8PrimitiveRestart) { RunGetMaxValueForRangeUint8Test(true); }

TEST_F(BufferManagerTest, GetMaxValueForRangeUint16) { RunGetMaxValueForRangeUint16Test(false); }

TEST_F(BufferManagerTest, GetMaxValueForRangeUint16PrimitiveRestart) { RunGetMaxValueForRangeUint16Test(true); }

TEST_F(BufferManagerTest, GetMaxValueForRangeUint32) { RunGetMaxValueForRangeUint32Test(false); }

TEST_F(BufferManagerTest, GetMaxValueForRangeUint32PrimitiveRestart) { RunGetMaxValueForRangeUint32Test(true); }
...
TEST_F(BufferManagerTest, BindBufferConflicts)
{
...

    {
        ...
        const GLenum kTargets[]
            = { GL_ARRAY_BUFFER, GL_COPY_READ_BUFFER, GL_COPY_WRITE_BUFFER, GL_PIXEL_PACK_BUFFER, GL_PIXEL_UNPACK_BUFFER, GL_TRANSFORM_FEEDBACK_BUFFER, GL_UNIFORM_BUFFER };
