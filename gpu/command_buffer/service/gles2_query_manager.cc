...
void AbstractIntegerQuery::QueryCounter(base::subtle::Atomic32 submit_count) { NOTREACHED(); }
...
public:
    CommandLatencyQuery(QueryManager* manager, GLenum target, scoped_refptr<gpu::Buffer> buffer, QuerySync* sync);
...
CommandLatencyQuery::CommandLatencyQuery(QueryManager* manager, GLenum target, scoped_refptr<gpu::Buffer> buffer, QuerySync* sync)
    : Query(manager, target, std::move(buffer), sync)
{
}

void CommandLatencyQuery::Begin() { MarkAsActive(); }

void CommandLatencyQuery::Pause() { MarkAsPaused(); }

void CommandLatencyQuery::Resume() { MarkAsActive(); }
...
void CommandLatencyQuery::QueryCounter(base::subtle::Atomic32 submit_count) { NOTREACHED(); }

void CommandLatencyQuery::Process(bool did_finish) { NOTREACHED(); }
...
class AsyncReadPixelsCompletedQuery : public GLES2QueryManager::GLES2Query, public base::SupportsWeakPtr<AsyncReadPixelsCompletedQuery> {
public:
...
void AsyncReadPixelsCompletedQuery::Begin() { MarkAsActive(); }

void AsyncReadPixelsCompletedQuery::Pause() { MarkAsPaused(); }

void AsyncReadPixelsCompletedQuery::Resume() { MarkAsActive(); }

void AsyncReadPixelsCompletedQuery::End(base::subtle::Atomic32 submit_count)
{
    MarkAsPending(submit_count);
    gles2_query_manager()->decoder()->WaitForReadPixels(base::BindOnce(&AsyncReadPixelsCompletedQuery::Complete, AsWeakPtr()));
}

void AsyncReadPixelsCompletedQuery::QueryCounter(base::subtle::Atomic32 submit_count) { NOTREACHED(); }

void AsyncReadPixelsCompletedQuery::Complete() { MarkAsCompleted(1); }

void AsyncReadPixelsCompletedQuery::Process(bool did_finish) { NOTREACHED(); }
...
void GetErrorQuery::Begin() { MarkAsActive(); }

void GetErrorQuery::Pause() { MarkAsPaused(); }

void GetErrorQuery::Resume() { MarkAsActive(); }
...
void GetErrorQuery::QueryCounter(base::subtle::Atomic32 submit_count) { NOTREACHED(); }

void GetErrorQuery::Process(bool did_finish) { NOTREACHED(); }
...
void TimeElapsedQuery::QueryCounter(base::subtle::Atomic32 submit_count) { NOTREACHED(); }

void TimeElapsedQuery::Pause() { MarkAsPaused(); }

void TimeElapsedQuery::Resume() { MarkAsActive(); }
...
void TimeElapsedQuery::Destroy(bool have_context) { gpu_timer_->Destroy(have_context); }
...
void TimeStampQuery::Begin() { NOTREACHED(); }

void TimeStampQuery::End(base::subtle::Atomic32 submit_count) { NOTREACHED(); }

void TimeStampQuery::Pause() { MarkAsPaused(); }

void TimeStampQuery::Resume() { MarkAsActive(); }
...
GLES2QueryManager::GLES2QueryManager(GLES2Decoder* decoder, FeatureInfo* feature_info)
    : decoder_(decoder)
    , use_arb_occlusion_query2_for_occlusion_query_boolean_(feature_info->feature_flags().use_arb_occlusion_query2_for_occlusion_query_boolean)
    , use_arb_occlusion_query_for_occlusion_query_boolean_(feature_info->feature_flags().use_arb_occlusion_query_for_occlusion_query_boolean)
...
std::unique_ptr<gl::GPUTimer> GLES2QueryManager::CreateGPUTimer(bool elapsed_time) { return gpu_timing_client_->CreateGPUTimer(elapsed_time); }

bool GLES2QueryManager::GPUTimingAvailable() { return gpu_timing_client_->IsAvailable(); }
