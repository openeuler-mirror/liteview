...
public:
    ...
    bool CreateLockedEntry(const EntryKey& key, ServiceDiscardableHandle handle, GrDirectContext* context, base::span<uint8_t> data);
...
private:
    struct CacheEntryInternal {
        CacheEntryInternal(absl::optional<ServiceDiscardableHandle> handle, std::unique_ptr<cc::ServiceTransferCacheEntry> entry);
