    ...
    : workarounds_(gpu_driver_bug_workarounds)
{
    ...
    feature_flags_.android_surface_control = gpu_feature_info.status_values[GPU_FEATURE_TYPE_ANDROID_SURFACE_CONTROL] == gpu::kGpuFeatureStatusEnabled;

#if BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_CAST_ANDROID)
    feature_flags_.chromium_image_ycbcr_420v = base::Contains(gpu_feature_info.supported_buffer_formats_for_allocation_and_texturing, gfx::BufferFormat::YUV_420_BIPLANAR);
...
bool IsGL_REDSupportedOnFBOs()
{
    ...
    GLubyte data[1] = { 0 };
    glTexImage2D(GL_TEXTURE_2D, 0, GL_RED_EXT, 1, 1, 0, GL_RED_EXT, GL_UNSIGNED_BYTE, data);
...
void FeatureInfo::EnableANGLEInstancedArrayIfPossible(const gfx::ExtensionSet& extensions)
{
    if (!feature_flags_.angle_instanced_arrays) {
        if (gfx::HasExtension(extensions, "GL_ANGLE_instanced_arrays")
            || (gfx::HasExtension(extensions, "GL_ARB_instanced_arrays") && gfx::HasExtension(extensions, "GL_ARB_draw_instanced")) || gl_version_info_->is_es3
...
void FeatureInfo::InitializeFeatures()
{
    ...
    bool has_pixel_buffers = gl_version_info_->is_es3 || gl_version_info_->is_desktop_core_profile || gfx::HasExtension(extensions, "GL_ARB_pixel_buffer_object")
    ...
    bool have_bptc = gfx::HasExtension(extensions, "GL_EXT_texture_compression_bptc") || gl_version_info_->IsAtLeastGL(4, 2)
    ...
    bool have_rgtc = gfx::HasExtension(extensions, "GL_EXT_texture_compression_rgtc") || gl_version_info_->IsAtLeastGL(3, 0)
    ...
    if (!workarounds_.disable_depth_texture
        && (gfx::HasExtension(extensions, "GL_ARB_depth_texture") || gfx::HasExtension(extensions, "GL_OES_depth_texture")
            || gfx::HasExtension(extensions, "GL_ANGLE_depth_texture") || gl_version_info_->is_desktop_core_profile)) {
    ...
    if (gfx::HasExtension(extensions, "GL_EXT_packed_depth_stencil") || gfx::HasExtension(extensions, "GL_OES_packed_depth_stencil") || gl_version_info_->is_es3
        || gl_version_info_->is_desktop_core_profile) {
    ...
    if (gl_version_info_->is_es3 || gl_version_info_->is_desktop_core_profile || gfx::HasExtension(extensions, "GL_OES_vertex_array_object")
        || gfx::HasExtension(extensions, "GL_ARB_vertex_array_object") || gfx::HasExtension(extensions, "GL_APPLE_vertex_array_object")) {
    ...
    if (gl_version_info_->is_es3 || gfx::HasExtension(extensions, "GL_OES_element_index_uint") || gl::HasDesktopGLFeatures()) {
    ...
    if (gl_version_info_->IsAtLeastGL(3, 0) || gl_version_info_->is_es3 || gfx::HasExtension(extensions, "GL_OES_fbo_render_mipmap")
    ...
    if (gl_version_info_->IsAtLeastGL(3, 2)
        || (gl_version_info_->IsAtLeastGL(2, 0) && (gfx::HasExtension(extensions, "GL_EXT_framebuffer_sRGB") || gfx::HasExtension(extensions, "GL_ARB_framebuffer_sRGB")))) {
    ...
    // GL_EXT_sRGB.
    if ((((gl_version_info_->is_es3 || gfx::HasExtension(extensions, "GL_OES_rgb8_rgba8")) && gfx::HasExtension(extensions, "GL_EXT_sRGB")) || feature_flags_.desktop_srgb_support)
    ...
    if (has_srgb_framebuffer_support) {
        ...
        // 3.0).
        if (feature_flags_.desktop_srgb_support || gfx::HasExtension(extensions, "GL_EXT_sRGB_write_control")) {
    ...
    if (gl_version_info_->is_es) {
        ...
        have_s3tc_srgb = gfx::HasExtension(extensions, "GL_NV_sRGB_formats") || gfx::HasExtension(extensions, "GL_EXT_texture_compression_s3tc_srgb");
    } else {
        ...
        if (gfx::HasExtension(extensions, "GL_EXT_texture_sRGB") || gl_version_info_->IsAtLeastGL(4, 1)) {
            have_s3tc_srgb = gfx::HasExtension(extensions, "GL_EXT_texture_compression_s3tc");
        }
    }
    ...
    bool enable_texture_format_bgra8888 = has_ext_bgra || has_apple_bgra || !gl_version_info_->is_es;

    bool has_ext_texture_storage = gfx::HasExtension(extensions, "GL_EXT_texture_storage");
    bool has_arb_texture_storage = gfx::HasExtension(extensions, "GL_ARB_texture_storage");
    bool has_texture_storage
        = !workarounds_.disable_texture_storage && (has_ext_texture_storage || has_arb_texture_storage || gl_version_info_->is_es3 || gl_version_info_->IsAtLeastGL(4, 2));
    ...
    bool enable_render_buffer_bgra = gl_version_info_->is_angle || !gl_version_info_->is_es;
    ...
    // extension.
    bool enable_read_format_bgra = gfx::HasExtension(extensions, "GL_EXT_read_format_bgra") || !gl_version_info_->is_es;
    ...
    feature_flags_.arb_es3_compatibility = gfx::HasExtension(extensions, "GL_ARB_ES3_compatibility") && !gl_version_info_->is_es;
    ...
    feature_flags_.ext_disjoint_timer_query = gfx::HasExtension(extensions, "GL_EXT_disjoint_timer_query");
    if (feature_flags_.ext_disjoint_timer_query || gfx::HasExtension(extensions, "GL_ARB_timer_query") || gfx::HasExtension(extensions, "GL_EXT_timer_query")) {
        AddExtensionString("GL_EXT_disjoint_timer_query");
    }

    if (gfx::HasExtension(extensions, "GL_OES_rgb8_rgba8") || gl::HasDesktopGLFeatures()) {
    ...
    if (!disallowed_features_.npot_support
        && (gl_version_info_->is_es3 || gl_version_info_->is_desktop_core_profile || gfx::HasExtension(extensions, "GL_ARB_texture_non_power_of_two")
    ...
    if (!workarounds_.disable_chromium_framebuffer_multisample) {
        bool ext_has_multisample = gfx::HasExtension(extensions, "GL_ARB_framebuffer_object")
            || (gfx::HasExtension(extensions, "GL_EXT_framebuffer_multisample") && gfx::HasExtension(extensions, "GL_EXT_framebuffer_blit")) || gl_version_info_->is_es3
            || gl_version_info_->is_desktop_core_profile;
    ...
    if (!gl_version_info_->is_es || gfx::HasExtension(extensions, "GL_EXT_multisample_compatibility")) {
    ...
    if (gfx::HasExtension(extensions, "GL_OES_depth24") || gl::HasDesktopGLFeatures() || gl_version_info_->is_es3) {
        AddExtensionString("GL_OES_depth24");
        feature_flags_.oes_depth24 = true;
        validators_.render_buffer_format.AddValue(GL_DEPTH_COMPONENT24);
    }

    if (gl_version_info_->is_es3 || gfx::HasExtension(extensions, "GL_OES_standard_derivatives") || gl::HasDesktopGLFeatures()) {
    ...
    if (gfx::HasExtension(extensions, "GL_ARB_texture_rectangle") || gfx::HasExtension(extensions, "GL_ANGLE_texture_rectangle") || gl_version_info_->is_desktop_core_profile) {
    ...
    if (feature_flags_.chromium_image_ycbcr_420v) {
        ...
        feature_flags_.gpu_memory_buffer_formats.Add(gfx::BufferFormat::YUV_420_BIPLANAR);
    }
    ...
    feature_flags_.chromium_image_ab30
        = gl_version_info_->IsAtLeastGL(3, 3) || gl_version_info_->IsAtLeastGLES(3, 0) || gfx::HasExtension(extensions, "GL_EXT_texture_type_2_10_10_10_REV");
#endif
    ...
    if (feature_flags_.chromium_image_ar30) {
        feature_flags_.gpu_memory_buffer_formats.Add(gfx::BufferFormat::BGRA_1010102);
    }
    if (feature_flags_.chromium_image_ab30) {
        feature_flags_.gpu_memory_buffer_formats.Add(gfx::BufferFormat::RGBA_1010102);
    }
    ...
    bool have_occlusion_query = gl_version_info_->IsAtLeastGLES(3, 0) || gl_version_info_->IsAtLeastGL(3, 3);
    bool have_ext_occlusion_query_boolean = gfx::HasExtension(extensions, "GL_EXT_occlusion_query_boolean");
    bool have_arb_occlusion_query2 = gfx::HasExtension(extensions, "GL_ARB_occlusion_query2");
    bool have_arb_occlusion_query = (gl_version_info_->is_desktop_core_profile && gl_version_info_->IsAtLeastGL(1, 5)) || gfx::HasExtension(extensions, "GL_ARB_occlusion_query");

    if (have_occlusion_query || have_ext_occlusion_query_boolean || have_arb_occlusion_query2 || have_arb_occlusion_query) {
        ...
        feature_flags_.use_arb_occlusion_query2_for_occlusion_query_boolean
            = !have_ext_occlusion_query_boolean && (have_arb_occlusion_query2 || (gl_version_info_->IsAtLeastGL(3, 3) && gl_version_info_->IsLowerThanGL(4, 3)));
    ...
    bool have_es2_draw_buffers_vendor_agnostic
        = gl_version_info_->is_desktop_core_profile || gfx::HasExtension(extensions, "GL_ARB_draw_buffers") || gfx::HasExtension(extensions, "GL_EXT_draw_buffers");
    ...
    bool have_es2_draw_buffers = !workarounds_.disable_ext_draw_buffers && (have_es2_draw_buffers_vendor_agnostic || can_emulate_es2_draw_buffers_on_es3_nv)
        && (context_type_ == CONTEXT_TYPE_OPENGLES2
            || (context_type_ == CONTEXT_TYPE_WEBGL1 && IsWebGLDrawBuffersSupported(is_webgl_compatibility_context, depth_texture_format, depth_stencil_texture_format)));
    ...
    if (gl_version_info_->is_es3 || gfx::HasExtension(extensions, "GL_EXT_blend_minmax") || gl::HasDesktopGLFeatures()) {
    ...
    if (gfx::HasExtension(extensions, "GL_EXT_frag_depth") || gl::HasDesktopGLFeatures()) {
        AddExtensionString("GL_EXT_frag_depth");
        feature_flags_.ext_frag_depth = true;
    }

    if (gfx::HasExtension(extensions, "GL_EXT_shader_texture_lod") || gl::HasDesktopGLFeatures()) {
    ...
    feature_flags_.map_buffer_range = gl_version_info_->is_es3 || gl_version_info_->is_desktop_core_profile || gfx::HasExtension(extensions, "GL_ARB_map_buffer_range")
    ...
    if (gl_version_info_->is_es3 || gfx::HasExtension(extensions, "GL_ARB_sampler_objects")) {
    ...
    if (!workarounds_.disable_blend_equation_advanced) {
        bool blend_equation_advanced_coherent
            = gfx::HasExtension(extensions, "GL_NV_blend_equation_advanced_coherent") || gfx::HasExtension(extensions, "GL_KHR_blend_equation_advanced_coherent");
        ...
        if (blend_equation_advanced_coherent || gfx::HasExtension(extensions, "GL_NV_blend_equation_advanced") || gfx::HasExtension(extensions, "GL_KHR_blend_equation_advanced")) {
            const GLenum equations[] = { GL_MULTIPLY_KHR, GL_SCREEN_KHR, GL_OVERLAY_KHR, GL_DARKEN_KHR, GL_LIGHTEN_KHR, GL_COLORDODGE_KHR, GL_COLORBURN_KHR, GL_HARDLIGHT_KHR,
    ...
    if ((gl_version_info_->is_es3 || gl_version_info_->is_desktop_core_profile || gfx::HasExtension(extensions, "GL_EXT_texture_rg")
    ...
    if (IsWebGL2OrES3OrHigherContext()
        && (gl_version_info_->is_desktop_core_profile || (gl_version_info_->IsAtLeastGL(2, 1) && gfx::HasExtension(extensions, "GL_ARB_texture_rg"))
    ...
    bool has_opengl_dual_source_blending
        = gl_version_info_->IsAtLeastGL(3, 3) || (gl_version_info_->IsAtLeastGL(3, 2) && gfx::HasExtension(extensions, "GL_ARB_blend_func_extended"));
    if (!disable_shader_translator_ && !workarounds_.get_frag_data_info_bug
        && ((gl_version_info_->IsAtLeastGL(3, 2) && has_opengl_dual_source_blending)
            || (gl_version_info_->IsAtLeastGLES(3, 0) && gfx::HasExtension(extensions, "GL_EXT_blend_func_extended")))) {
    ...
    feature_flags_.khr_debug = gl_version_info_->IsAtLeastGL(4, 3) || gl_version_info_->IsAtLeastGLES(3, 2) || gfx::HasExtension(extensions, "GL_KHR_debug");
    ...
    feature_flags_.ext_pixel_buffer_object = gfx::HasExtension(extensions, "GL_ARB_pixel_buffer_object") || gfx::HasExtension(extensions, "GL_NV_pixel_buffer_object");
    ...
    if ((!is_passthrough_cmd_decoder_
            && ((gl_version_info_->IsAtLeastGLES(3, 2) && gfx::HasExtension(extensions, "GL_EXT_base_instance"))
                || (gl_version_info_->is_desktop_core_profile && gl_version_info_->IsAtLeastGL(4, 2))))
...
void FeatureInfo::InitializeFloatAndHalfFloatFeatures(const gfx::ExtensionSet& extensions)
{
    ...
    if (gfx::HasExtension(extensions, "GL_ARB_texture_float") || gl_version_info_->is_desktop_core_profile) {
    ...
    if (!gl_version_info_->is_es || gl_version_info_->IsAtLeastGLES(3, 2) || gfx::HasExtension(extensions, "GL_EXT_float_blend")) {
    ...
    if (may_enable_chromium_color_buffer_float && !had_native_chromium_color_buffer_float_ext) {
        if (workarounds_.force_enable_color_buffer_float || workarounds_.force_enable_color_buffer_float_except_rgb32f) {
            if (enable_es3)
                enable_ext_color_buffer_float = true;
            if (IsWebGL1OrES2Context() && !enable_ext_color_buffer_half_float && gl_version_info_->IsAtLeastGL(3, 0)) {
                enable_ext_color_buffer_half_float = true;
            }
            feature_flags_.chromium_color_buffer_float_rgba = true;
            if (!disallowed_features_.chromium_color_buffer_float_rgba)
            ...
            base::UmaHistogramBoolean("GPU.RenderableFormat.RGBA32F.FLOAT", status_rgba == GL_FRAMEBUFFER_COMPLETE);
            base::UmaHistogramBoolean("GPU.RenderableFormat.RGB32F.FLOAT", status_rgb == GL_FRAMEBUFFER_COMPLETE);
            ...
            if (IsWebGL1OrES2Context() && !enable_ext_color_buffer_half_float && (gl_version_info_->IsAtLeastGLES(3, 0) || gl_version_info_->IsAtLeastGL(3, 0))) {
                ...
                bool supported = glCheckFramebufferStatusEXT(GL_FRAMEBUFFER) == GL_FRAMEBUFFER_COMPLETE;
                base::UmaHistogramBoolean("GPU.RenderableFormat.RGBA16F.HALF_FLOAT", supported);
...
bool FeatureInfo::IsWebGLContext() const { return IsWebGLContextType(context_type_); }

bool FeatureInfo::IsWebGL1OrES2Context() const { return IsWebGL1OrES2ContextType(context_type_); }

bool FeatureInfo::IsWebGL2OrES3Context() const { return IsWebGL2OrES3ContextType(context_type_); }

bool FeatureInfo::IsWebGL2OrES3OrHigherContext() const { return IsWebGL2OrES3OrHigherContextType(context_type_); }

bool FeatureInfo::IsES31ForTestingContext() const { return IsES31ForTestingContextType(context_type_); }

void FeatureInfo::AddExtensionString(const base::StringPiece& extension) { extensions_.insert(extension); }
