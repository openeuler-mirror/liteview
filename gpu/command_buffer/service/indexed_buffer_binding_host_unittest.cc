...
protected:
    void SetUp() override { GpuServiceTest::SetUpWithGLVersion("4.1", ""); }
    ...
    void SetBufferSize(GLenum target, GLsizeiptr size) { buffer_manager_->SetInfo(buffer_.get(), target, size, GL_STATIC_DRAW, false); }
