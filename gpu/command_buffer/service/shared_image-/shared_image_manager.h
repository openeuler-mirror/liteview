...
public:
    ...
    bool display_context_on_another_thread() const { return display_context_on_another_thread_; }
...
#if BUILDFLAG(IS_WIN)
    const scoped_refptr<DXGISharedHandleManager>& dxgi_shared_handle_manager() const { return dxgi_shared_handle_manager_; }
#endif
