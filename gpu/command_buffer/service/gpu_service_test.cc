...
GpuServiceTest::~GpuServiceTest() { DCHECK(ran_teardown_); }
...
void GpuServiceTest::SetUp() { SetUpWithGLVersion("2.0", "GL_EXT_framebuffer_object"); }
...
gl::GLContext* GpuServiceTest::GetGLContext() { return context_.get(); }

gl::GLSurface* GpuServiceTest::GetGLSurface() { return surface_.get(); }
