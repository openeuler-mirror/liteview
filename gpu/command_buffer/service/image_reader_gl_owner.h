...
public:
    ...
    const AImageReader* image_reader_for_testing() const NO_THREAD_SAFETY_ANALYSIS { return image_reader_; }
...
private:
    ...
    ImageReaderGLOwner(std::unique_ptr<gles2::AbstractTexture> texture, Mode secure_mode, scoped_refptr<SharedContextState> context_state, scoped_refptr<RefCountedLock> drdc_lock);
