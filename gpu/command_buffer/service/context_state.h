...
struct GPU_GLES2_EXPORT TextureUnit {
    ...
    {
        return bound_texture_2d || bound_texture_cube_map || bound_texture_external_oes || bound_texture_rectangle_arb || bound_texture_3d || bound_texture_2d_array;
    }
...
struct GPU_GLES2_EXPORT ContextState {
    ...
    void SetIgnoreCachedStateForTest(bool ignore) { ignore_cached_state = ignore; }
    ...
    const std::vector<uint32_t>& generic_attrib_base_type_mask() const { return generic_attrib_base_type_mask_; }
