...
protected:
    ...
    void Draw(GLenum reset_status, error::ContextLostReason expected_other_reason)
    {
        ...
        EXPECT_CALL(*mock_decoder_, MarkContextLost(expected_other_reason)).Times(1).RetiresOnSaturation();
        cmds::DrawArrays cmd;
