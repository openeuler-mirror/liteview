...
bool GPU_GLES2_EXPORT AHardwareBufferSupportedFormat(viz::ResourceFormat format);
...
GPU_GLES2_EXPORT ui::ScopedEGLImage CreateEGLImageFromAHardwareBuffer(AHardwareBuffer* buffer);
