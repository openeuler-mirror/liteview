...
TextureBase* PassthroughAbstractTextureImpl::GetTextureBase() const { return texture_passthrough_.get(); }
...
void PassthroughAbstractTextureImpl::SetCleanupCallback(CleanupCallback cb) { cleanup_cb_ = std::move(cb); }

void PassthroughAbstractTextureImpl::NotifyOnContextLost() { NOTIMPLEMENTED(); }
