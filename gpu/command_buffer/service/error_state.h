...
#define ERRORSTATE_SET_GL_ERROR_INVALID_ENUM(error_state, function_name, value, label) error_state->SetGLErrorInvalidEnum(__FILE__, __LINE__, function_name, value, label)
