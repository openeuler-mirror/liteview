...
{
    if (prev_state) {
        if ((blend_color_red != prev_state->blend_color_red) || (blend_color_green != prev_state->blend_color_green) || (blend_color_blue != prev_state->blend_color_blue)
        ...
        if ((blend_source_rgb != prev_state->blend_source_rgb) || (blend_dest_rgb != prev_state->blend_dest_rgb) || (blend_source_alpha != prev_state->blend_source_alpha)
        ...
        if ((color_clear_red != prev_state->color_clear_red) || (color_clear_green != prev_state->color_clear_green) || (color_clear_blue != prev_state->color_clear_blue)
        ...
        if (feature_info_->feature_flags().chromium_texture_filtering_hint) {
            if (prev_state->hint_texture_filtering != hint_texture_filtering) {
                api()->glHintFn(GL_TEXTURE_FILTERING_HINT_CHROMIUM, hint_texture_filtering);
            }
        }
        ...
        if ((stencil_back_func != prev_state->stencil_back_func) || (stencil_back_ref != prev_state->stencil_back_ref) || (stencil_back_mask != prev_state->stencil_back_mask))
