...
TEST_F(ShaderManagerTest, DoCompile)
{
    ...
    TestHelper::SetShaderStates(
        gl_.get(), shader1, true, &kLog, &kTranslatedSource, nullptr, &attrib_map, &uniform_map, &varying_map, &interface_block_map, &output_variable_list, nullptr);
    ...
    TestHelper::SetShaderStates(gl_.get(), shader1, false, &kLog, &kTranslatedSource, nullptr, &attrib_map, &uniform_map, &varying_map, nullptr, &output_variable_list, nullptr);
    EXPECT_FALSE(shader1->valid());
