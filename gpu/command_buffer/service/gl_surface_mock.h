...
public:
    ...
    MOCK_METHOD2(SwapBuffers, gfx::SwapResult(PresentationCallback callback, gl::FrameData data));
    MOCK_METHOD6(PostSubBuffer, gfx::SwapResult(int x, int y, int width, int height, PresentationCallback callback, gl::FrameData data));
