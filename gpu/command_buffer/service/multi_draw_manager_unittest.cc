...
TEST_P(MultiDrawManagerTest, DrawBeforeBegin) { EXPECT_FALSE(DoMultiDraw(1)); }
...
INSTANTIATE_TEST_SUITE_P(All, MultiDrawManagerTest,
    testing::Combine(testing::Values(MultiDrawManager::IndexStorageType::Offset, MultiDrawManager::IndexStorageType::Pointer),
        testing::Values(MultiDrawManager::DrawFunction::DrawArrays, MultiDrawManager::DrawFunction::DrawArraysInstanced,
            MultiDrawManager::DrawFunction::DrawArraysInstancedBaseInstance, MultiDrawManager::DrawFunction::DrawElements, MultiDrawManager::DrawFunction::DrawElementsInstanced,
            MultiDrawManager::DrawFunction::DrawElementsInstancedBaseVertexBaseInstance)));
