...
public:
    CommandBufferTaskExecutor(const GpuPreferences& gpu_preferences, const GpuFeatureInfo& gpu_feature_info, SyncPointManager* sync_point_manager, MailboxManager* mailbox_manager,
    ...
    gl::GLSurfaceFormat share_group_surface_format() const { return share_group_surface_format_; }
