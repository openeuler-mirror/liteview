...
TEST_F(RasterFormatTest, BeginRasterCHROMIUMImmediate)
{
    ...
    void* next_cmd = cmd.Set(&cmd, static_cast<GLfloat>(11), static_cast<GLfloat>(12), static_cast<GLfloat>(13), static_cast<GLfloat>(14), static_cast<GLboolean>(15),
        static_cast<GLuint>(16), static_cast<gpu::raster::MsaaMode>(17), static_cast<GLboolean>(18), static_cast<GLboolean>(19), data);
...
TEST_F(RasterFormatTest, RasterCHROMIUM)
{
    ...
    void* next_cmd = cmd.Set(
        &cmd, static_cast<GLuint>(11), static_cast<GLuint>(12), static_cast<GLsizeiptr>(13), static_cast<GLuint>(14), static_cast<GLuint>(15), static_cast<GLsizeiptr>(16));
...
TEST_F(RasterFormatTest, CopySubTextureINTERNALImmediate)
{
    ...
    cmds::CopySubTextureINTERNALImmediate& cmd = *GetBufferAs<cmds::CopySubTextureINTERNALImmediate>();
    void* next_cmd = cmd.Set(&cmd, static_cast<GLint>(11), static_cast<GLint>(12), static_cast<GLint>(13), static_cast<GLint>(14), static_cast<GLsizei>(15),
        static_cast<GLsizei>(16), static_cast<GLboolean>(17), data);
    EXPECT_EQ(static_cast<uint32_t>(cmds::CopySubTextureINTERNALImmediate::kCmdId), cmd.header.command);
    EXPECT_EQ(sizeof(cmd) + RoundSizeToMultipleOfEntries(sizeof(data)), cmd.header.size * 4u);
...
TEST_F(RasterFormatTest, ReadbackARGBImagePixelsINTERNALImmediate)
{
    ...
    void* next_cmd = cmd.Set(&cmd, static_cast<GLint>(11), static_cast<GLint>(12), static_cast<GLuint>(13), static_cast<GLuint>(14), static_cast<GLuint>(15),
        static_cast<GLuint>(16), static_cast<GLuint>(17), static_cast<GLint>(18), static_cast<GLuint>(19), static_cast<GLuint>(20), static_cast<GLuint>(21), data);
...
TEST_F(RasterFormatTest, ConvertYUVAMailboxesToRGBINTERNALImmediate)
{
    ...
    cmds::ConvertYUVAMailboxesToRGBINTERNALImmediate& cmd = *GetBufferAs<cmds::ConvertYUVAMailboxesToRGBINTERNALImmediate>();
    void* next_cmd = cmd.Set(&cmd, static_cast<GLenum>(11), static_cast<GLenum>(12), static_cast<GLenum>(13), data);
    EXPECT_EQ(static_cast<uint32_t>(cmds::ConvertYUVAMailboxesToRGBINTERNALImmediate::kCmdId), cmd.header.command);
    EXPECT_EQ(sizeof(cmd) + RoundSizeToMultipleOfEntries(sizeof(data)), cmd.header.size * 4u);
...
TEST_F(RasterFormatTest, ConvertRGBAToYUVAMailboxesINTERNALImmediate)
{
    ...
    cmds::ConvertRGBAToYUVAMailboxesINTERNALImmediate& cmd = *GetBufferAs<cmds::ConvertRGBAToYUVAMailboxesINTERNALImmediate>();
    void* next_cmd = cmd.Set(&cmd, static_cast<GLenum>(11), static_cast<GLenum>(12), static_cast<GLenum>(13), data);
    EXPECT_EQ(static_cast<uint32_t>(cmds::ConvertRGBAToYUVAMailboxesINTERNALImmediate::kCmdId), cmd.header.command);
    EXPECT_EQ(sizeof(cmd) + RoundSizeToMultipleOfEntries(sizeof(data)), cmd.header.size * 4u);
    EXPECT_EQ(static_cast<GLenum>(11), cmd.planes_yuv_color_space);
    EXPECT_EQ(static_cast<GLenum>(12), cmd.plane_config);
    EXPECT_EQ(static_cast<GLenum>(13), cmd.subsampling);
