...
struct Noop {
    ...
    void Init(uint32_t skip_count) { SetHeader(skip_count); }
...
struct GetBucketStart {
    ...
    void Init(uint32_t _bucket_id, uint32_t _result_memory_id, uint32_t _result_memory_offset, uint32_t _data_memory_size, uint32_t _data_memory_id, uint32_t _data_memory_offset)
    {
        SetHeader();
        bucket_id = _bucket_id;
    ...
    static void* Set(void* cmd, uint32_t _bucket_id, uint32_t _result_memory_id, uint32_t _result_memory_offset, uint32_t _data_memory_size, uint32_t _data_memory_id,
...
struct InsertFenceSync {
    ...
    uint64_t release_count() const volatile { return (static_cast<uint64_t>(release_count_1) << 32) + static_cast<uint64_t>(release_count_0); }
