...
std::string GLES2Util::GetStringCompressedTextureFormat(uint32_t value) { return GLES2Util::GetQualifiedEnumString(nullptr, 0, value); }
...
std::string GLES2Util::GetStringFramebufferParameter(uint32_t value) { return GLES2Util::GetQualifiedEnumString(nullptr, 0, value); }
...
std::string GLES2Util::GetStringGLState(uint32_t value)
{
    static const EnumToString string_table[] = {
        ...
        { GL_TEXTURE_FILTERING_HINT_CHROMIUM, "GL_TEXTURE_FILTERING_HINT_CHROMIUM" },
...
std::string GLES2Util::GetStringShaderBinaryFormat(uint32_t value) { return GLES2Util::GetQualifiedEnumString(nullptr, 0, value); }
...
{
    static const EnumToString string_table[] = {
        { GL_SHARED_IMAGE_ACCESS_MODE_OVERLAY_CHROMIUM, "GL_SHARED_IMAGE_ACCESS_MODE_OVERLAY_CHROMIUM" },
