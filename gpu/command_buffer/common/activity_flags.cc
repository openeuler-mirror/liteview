...
volatile base::subtle::Atomic32* ActivityFlagsBase::AsAtomic() { return reinterpret_cast<volatile base::subtle::Atomic32*>(mapping_.memory()); }
...
GpuProcessHostActivityFlags::GpuProcessHostActivityFlags() { Initialize(base::UnsafeSharedMemoryRegion::Create(sizeof(Flag))); }
