...
public:
    ...
    SkiaGpuTraceMemoryDump(base::trace_event::ProcessMemoryDump* pmd, absl::optional<uint64_t> share_group_tracing_guid)
        : pmd_(pmd)
...
void DumpGrMemoryStatistics(const GrDirectContext* context, base::trace_event::ProcessMemoryDump* pmd, absl::optional<uint64_t> tracing_guid)
{
