...
TEST_F(WebGPUFormatTest, DawnCommands)
{
    ...
    void* next_cmd = cmd.Set(&cmd, static_cast<uint32_t>(11), static_cast<uint32_t>(12), static_cast<uint32_t>(13));
...
TEST_F(WebGPUFormatTest, AssociateMailboxImmediate)
{
    ...
    void* next_cmd = cmd.Set(
        &cmd, static_cast<GLuint>(11), static_cast<GLuint>(12), static_cast<GLuint>(13), static_cast<GLuint>(14), static_cast<GLuint>(15), static_cast<MailboxFlags>(16), data);
...
TEST_F(WebGPUFormatTest, SetWebGPUExecutionContextToken)
{
    ...
    void* next_cmd = cmd.Set(&cmd, static_cast<uint32_t>(11), static_cast<uint32_t>(12), static_cast<uint32_t>(13), static_cast<uint32_t>(14), static_cast<uint32_t>(15));
