...
Mailbox::Mailbox() { memset(name, 0, sizeof(name)); }
...
void Mailbox::SetZero() { memset(name, 0, sizeof(name)); }
...
bool Mailbox::IsSharedImage() const { return name[kSharedImageFlagIndex] & kSharedImageFlag; }

Mailbox Mailbox::Generate() { return GenerateMailbox(false /* is_shared_image */); }

Mailbox Mailbox::GenerateForSharedImage() { return GenerateMailbox(true /* is_shared_image */); }
