...
gl::GLDisplay* GLTestHelper::InitializeGLDefault() { return GLTestHelper::InitializeGL(gl::GLImplementation::kGLImplementationNone); }
...
bool GpuCommandBufferTestEGL::InitializeEGL(int width, int height)
{
    ...
    gl::GLVersionInfo gl_version_info(reinterpret_cast<const char*>(glGetString(GL_VERSION)), reinterpret_cast<const char*>(glGetString(GL_RENDERER)), gl_extensions_);
