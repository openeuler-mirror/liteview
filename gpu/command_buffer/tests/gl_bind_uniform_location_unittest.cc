...
TEST_P(BindUniformLocationTest, ConflictsDetection)
{
    ...
    static const char* v_shader_str = SHADER(attribute vec4 a_position; void main() { gl_Position = a_position; });
    static const char* f_shader_str = SHADER(precision mediump float; uniform vec4 u_colorA; uniform vec4 u_colorB; void main() { gl_FragColor = u_colorA + u_colorB; });
...
TEST_P(BindUniformLocationTest, Compositor)
{
    ...
    static const char* v_shader_str
        = SHADER(attribute vec4 a_position; attribute vec2 a_texCoord; uniform mat4 matrix; uniform vec2 color_a[4]; uniform vec4 color_b; varying vec4 v_color; void main() {
    ...
    static const char* f_shader_str = SHADER(precision mediump float; varying vec4 v_color; uniform float alpha; uniform vec4 multiplier; uniform vec3 color_c[8]; void main() {
...
TEST_P(BindUniformLocationTest, UnusedUniformUpdate)
{
    ...
    static const char* kFragmentShaderString
        = SHADER(precision mediump float; uniform vec4 u_colorA; uniform float u_colorU; uniform vec4 u_colorC; void main() { gl_FragColor = u_colorA + u_colorC; });
    // clang-format on
