...
std::ostream& operator<<(std::ostream& os, const fuzzing::Vec2& vec2) { return os << "vec2(" << vec2.first() << ", " << vec2.second() << ")"; }

std::ostream& operator<<(std::ostream& os, const fuzzing::Vec3& vec3) { return os << "vec3(" << vec3.first() << ", " << vec3.second() << ", " << vec3.third() << ")"; }
...
std::ostream& operator<<(std::ostream& os, const fuzzing::Const& cons)
{
    ...
    case fuzzing::Const::kIvec3: {
        os << "ivec3(" << base::NumberToString(cons.ivec3().first()) << ", " << base::NumberToString(cons.ivec3().second()) << ", " << base::NumberToString(cons.ivec3().third())
           << ")";
        break;
    }
    case fuzzing::Const::kIvec4: {
        os << "ivec4(" << base::NumberToString(cons.ivec4().first()) << ", " << base::NumberToString(cons.ivec4().second()) << ", " << base::NumberToString(cons.ivec4().third())
    ...
    case fuzzing::Const::kUvec3: {
        os << "uvec3(" << base::NumberToString(cons.uvec3().first()) << "u, " << base::NumberToString(cons.uvec3().second()) << "u, " << base::NumberToString(cons.uvec3().third())
           << "u)";
        break;
    }
    case fuzzing::Const::kUvec4: {
        os << "uvec4(" << base::NumberToString(cons.uvec4().first()) << "u, " << base::NumberToString(cons.uvec4().second()) << "u, " << base::NumberToString(cons.uvec4().third())
           << "u, " << base::NumberToString(cons.uvec4().fourth()) << "u)";
        break;
    }
...
std::ostream& operator<<(std::ostream& os, const fuzzing::UnaryOp& unary_op) { return os << GetUnaryOp(unary_op.op()) << unary_op.rvalue(); }
...
std::ostream& operator<<(std::ostream& os, const fuzzing::While& while_stmt) { return os << "while (" << while_stmt.cond() << ") {\n" << while_stmt.body() << "}\n"; }

std::string GetVar(const fuzzing::Var& var) { return "var" + base::NumberToString(var); }

std::ostream& operator<<(std::ostream& os, const fuzzing::Lvalue& lvalue) { return os << GetVar(lvalue.var()); }

std::ostream& operator<<(std::ostream& os, const fuzzing::Assignment& assignment) { return os << assignment.lvalue() << " = " << assignment.rvalue() << ";\n"; }
