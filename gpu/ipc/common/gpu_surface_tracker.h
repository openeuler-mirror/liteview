...
public:
...
#if BUILDFLAG(IS_ANDROID)
        SurfaceRecord(gfx::AcceleratedWidget widget, const base::android::JavaRef<jobject>& j_surface, bool can_be_used_with_surface_control);
    ...
    gfx::AcceleratedWidget AcquireNativeWidget(gpu::SurfaceHandle surface_handle, bool* can_be_used_with_surface_control) override;

#if BUILDFLAG(IS_ANDROID)
    gl::ScopedJavaSurface AcquireJavaSurface(gpu::SurfaceHandle surface_handle, bool* can_be_used_with_surface_control) override;
#endif
