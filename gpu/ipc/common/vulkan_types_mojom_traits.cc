...
// static
bool StructTraits<gpu::mojom::VkExtensionPropertiesDataView, VkExtensionProperties>::Read(gpu::mojom::VkExtensionPropertiesDataView data, VkExtensionProperties* out)
{
...
// static
bool StructTraits<gpu::mojom::VkPhysicalDeviceLimitsDataView, VkPhysicalDeviceLimits>::Read(gpu::mojom::VkPhysicalDeviceLimitsDataView data, VkPhysicalDeviceLimits* out)
{
...
// static
bool StructTraits<gpu::mojom::VkPhysicalDeviceFeaturesDataView, VkPhysicalDeviceFeatures>::Read(gpu::mojom::VkPhysicalDeviceFeaturesDataView data, VkPhysicalDeviceFeatures* out)
{
...
// static
bool StructTraits<gpu::mojom::VkQueueFamilyPropertiesDataView, VkQueueFamilyProperties>::Read(gpu::mojom::VkQueueFamilyPropertiesDataView data, VkQueueFamilyProperties* out)
{
