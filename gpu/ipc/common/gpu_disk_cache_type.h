...
using GpuDiskCacheDawnWebGPUHandle = base::IdType32<class GpuDiskCacheDawnWebGPU>;

//
// Variant handle that encompasses all possible handles, and utilities.
//
using GpuDiskCacheHandle = absl::variant<absl::monostate, GpuDiskCacheGlShaderHandle, GpuDiskCacheDawnWebGPUHandle>;
