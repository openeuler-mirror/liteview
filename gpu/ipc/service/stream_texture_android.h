...
// gpu main thread.
class StreamTexture : public StreamTextureSharedImageInterface, public mojom::StreamTexture {
public:
...
private:
    StreamTexture(GpuChannel* channel, int32_t route_id, mojo::PendingAssociatedReceiver<mojom::StreamTexture> receiver, scoped_refptr<SharedContextState> context_state);
