...
public:
    ...
    void set_sandbox_helper(GpuSandboxHelper* helper) { sandbox_helper_ = helper; }
    ...
    const absl::optional<GPUInfo>& gpu_info_for_hardware_gpu() const { return gpu_info_for_hardware_gpu_; }
    const absl::optional<GpuFeatureInfo>& gpu_feature_info_for_hardware_gpu() const { return gpu_feature_info_for_hardware_gpu_; }
    const absl::optional<DevicePerfInfo>& device_perf_info() const { return device_perf_info_; }
    ...
    VulkanImplementation* vulkan_implementation() { return vulkan_implementation_.get(); }
#else
