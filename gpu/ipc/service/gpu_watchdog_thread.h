...
class GPU_IPC_SERVICE_EXPORT GpuWatchdogThread : public base::Thread, public base::PowerSuspendObserver, public base::TaskObserver, public gl::ProgressReporter {
public:
    static std::unique_ptr<GpuWatchdogThread> Create(bool start_backgrounded, const std::string& thread_name);

    static std::unique_ptr<GpuWatchdogThread> Create(
        bool start_backgrounded, base::TimeDelta timeout, int init_factor, int restart_factor, bool test_mode, const std::string& thread_name);
...
private:
    ...
    GpuWatchdogThread(base::TimeDelta timeout, int init_factor, int restart_factor, bool test_mode, const std::string& thread_name);
