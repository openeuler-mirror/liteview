...
private:
    ...
    void ProcessCompletedDecode(mojom::ScheduleImageDecodeParamsPtr params_ptr, uint64_t decode_release_count);
    ...
    void FinishCompletedDecode(uint64_t decode_release_count) EXCLUSIVE_LOCKS_REQUIRED(lock_);
    ...
    scoped_refptr<SyncPointClientState> sync_point_client_state_ GUARDED_BY(lock_);
