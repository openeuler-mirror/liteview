...
TEST_F(GpuChannelTest, IncompatibleStreamIds)
{
    ...
    gpu::ContextResult result = gpu::ContextResult::kSuccess;
    gpu::Capabilities capabilities;
    CreateCommandBuffer(*channel, std::move(init_params), kRouteId1, GetSharedMemoryRegion(), &result, &capabilities);
    EXPECT_EQ(result, gpu::ContextResult::kSuccess);
    ...
    CreateCommandBuffer(*channel, std::move(init_params2), kRouteId2, GetSharedMemoryRegion(), &result, &capabilities);
    EXPECT_EQ(result, gpu::ContextResult::kFatalFailure);
...
TEST_F(GpuChannelTest, CreateFailsIfSharedContextIsLost)
{
    ...
    int32_t kSharedRouteId = static_cast<int32_t>(GpuChannelReservedRoutes::kMaxValue) + 1;
    {
        ...
        gpu::ContextResult result = gpu::ContextResult::kSuccess;
        gpu::Capabilities capabilities;
        CreateCommandBuffer(*channel, std::move(init_params), kSharedRouteId, GetSharedMemoryRegion(), &result, &capabilities);
        EXPECT_EQ(result, gpu::ContextResult::kSuccess);
    }
    ...
    int32_t kFriendlyRouteId = kSharedRouteId + 1;
    {
        ...
        gpu::ContextResult result = gpu::ContextResult::kSuccess;
        gpu::Capabilities capabilities;
        CreateCommandBuffer(*channel, std::move(init_params), kFriendlyRouteId, GetSharedMemoryRegion(), &result, &capabilities);
        EXPECT_EQ(result, gpu::ContextResult::kSuccess);
    }
    ...
    int32_t kAnotherRouteId = kFriendlyRouteId + 1;
    {
        ...
        gpu::ContextResult result = gpu::ContextResult::kSuccess;
        gpu::Capabilities capabilities;
        CreateCommandBuffer(*channel, std::move(init_params), kAnotherRouteId, GetSharedMemoryRegion(), &result, &capabilities);
...
TEST_F(GpuChannelExitForContextLostTest, CreateFailsDuringLostContextShutdown_1)
{
    ...
    channel_manager()->OnContextLost(-1 /* context_lost_count */, false /* synthetic_loss */);
