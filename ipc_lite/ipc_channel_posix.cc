...
bool Channel::ChannelImpl::Connect()
{
    ...
    if (server_listen_pipe_ != -1) {
        ...
        // active sockets.
        base::CurrentIOThread::Get()->WatchFileDescriptor(server_listen_pipe_, true, base::WatchableIOMessagePumpPosix::WATCH_READ, &server_listen_connection_watcher_, this);
    } else {
