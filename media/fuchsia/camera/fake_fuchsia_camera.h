...
private:
    ...
    void OnBufferCollectionAllocated(zx_status_t status, fuchsia::sysmem::BufferCollectionInfo_2 buffer_collection_info);
    ...
    absl::optional<fuchsia::math::Size> resolution_update_ = fuchsia::math::Size { kDefaultFrameSize.width(), kDefaultFrameSize.height() };
    WatchResolutionCallback watch_resolution_callback_;

    absl::optional<fuchsia::camera3::Orientation> orientation_update_ = fuchsia::camera3::Orientation::UP;
    WatchOrientationCallback watch_orientation_callback_;

    fuchsia::sysmem::BufferCollectionTokenPtr new_buffer_collection_token_;

    absl::optional<fidl::InterfaceHandle<fuchsia::sysmem::BufferCollectionToken>> new_buffer_collection_token_for_client_;
