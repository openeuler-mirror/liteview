...
public:
    ...
    public:
        IoPacket(size_t index, size_t offset, size_t size, base::TimeDelta timestamp, bool unit_end, base::OnceClosure destroy_cb);
        ...
        void set_format(fuchsia::media::FormatDetails format) { format_ = std::move(format); }
    ...
    void SetInputBufferCollectionToken(fuchsia::sysmem::BufferCollectionTokenPtr token);
    ...
    void CompleteOutputBuffersAllocation(fuchsia::sysmem::BufferCollectionTokenPtr token);
