...
private:
    ...
    void OnSysmemBufferStreamBufferCollectionToken(fuchsia::sysmem::BufferCollectionTokenPtr token) override;
    ...
    void SetBufferCollectionTokenForGpu(fuchsia::sysmem::BufferCollectionTokenPtr token);
    ...
    const mojo::SharedRemote<media::mojom::FuchsiaMediaResourceProvider> media_resource_provider_;
