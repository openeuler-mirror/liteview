...
namespace media::mojom::blink {
    const char AudioProcessorControls::Name_[] = "media.mojom.blink.AudioProcessorControls";
    const char AudioInputStream::Name_[] = "media.mojom.blink.AudioInputStream";
    const char AudioInputStreamClient::Name_[] = "media.mojom.blink.AudioInputStreamClient";
    const char AudioOutputStreamProviderClient::Name_[] = "media.mojom.blink.AudioInputStreamClient";
    const char AudioOutputStreamProvider::Name_[] = "media.mojom.blink.AudioOutputStreamProvider";
    const char AudioOutputStream::Name_[] = "media.mojom.blink.AudioOutputStream";
}
...
// todo(mb): 抹平不同 OS 的区别
#if defined(ENABLE_MB_MEDIA) && defined(OS_WIN)
...
public:
    ...
    const SkImageInfo& GetSkImageInfo() override { return SkImageInfo(); }
    gpu::Mailbox GetMailbox() const override { return gpu::Mailbox(); }
...
bool VideoFrameYUVConverter::ConvertYUVVideoFrameNoCaching(VideoFrame const*, viz::RasterContextProvider*, gpu::MailboxHolder const&,
    absl::optional<struct media::VideoFrameYUVConverter::GrParams>)
{
    *(int*)1 = 1;
    return false;
}

bool VideoFrameYUVConverter::ConvertYUVVideoFrame(VideoFrame const*, viz::RasterContextProvider*, gpu::MailboxHolder const&, absl::optional<VideoFrameYUVConverter::GrParams>)
{
    *(int*)1 = 1;
    return false;
}
