...
void MockRemotee::StartDataStreams(mojo::PendingRemote<mojom::RemotingDataStreamReceiver> audio_stream, mojo::PendingRemote<mojom::RemotingDataStreamReceiver> video_stream)
{
...
void MockReceiverController::OnSendRpc(std::vector<uint8_t> message) { ReceiverController::OnMessageFromSource(message); }
