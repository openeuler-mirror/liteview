...
// the remoting media.
class Receiver final : public Renderer, public RendererClient, public cast_streaming::remoting::RpcRendererCallMessageHandler {
public:
    Receiver(int rpc_handle, int remote_handle, ReceiverController* receiver_controller, const scoped_refptr<base::SingleThreadTaskRunner>& media_task_runner,
