...
public:
    ...
    VideoCaptureDeviceDescriptor(const std::string& display_name, const std::string& device_id, VideoCaptureApi capture_api = VideoCaptureApi::UNKNOWN,
        const VideoCaptureControlSupport& control_support = VideoCaptureControlSupport(), VideoCaptureTransportType transport_type = VideoCaptureTransportType::OTHER_TRANSPORT);
    ...
    bool operator==(const VideoCaptureDeviceDescriptor& other) const { return (other.device_id == device_id) && (other.capture_api == capture_api); }
    ...
    const VideoCaptureControlSupport& control_support() const { return control_support_; }
    void set_control_support(const VideoCaptureControlSupport& control_support) { control_support_ = control_support; }
