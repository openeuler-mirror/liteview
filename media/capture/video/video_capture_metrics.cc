...
// Define a map of resolutions using std::map
const std::map<gfx::Size, VideoResolutionDesignation, FrameSizeCompare> kResolutions = {
...
VideoResolutionDesignation ResolutionNameFromSize(gfx::Size frame_size) {
    ...
    if (frame_size.width() < frame_size.height()) {
        //std::swap(frame_size.width(), frame_size.height());
        *(int*)1 = 1;
    }
