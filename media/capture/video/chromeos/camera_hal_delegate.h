...
public:
    ...
    void OpenDevice(int32_t camera_id, mojo::PendingReceiver<cros::mojom::Camera3DeviceOps> device_ops_receiver, OpenDeviceCallback callback);
...
private:
    ...
    void OpenDeviceOnIpcThread(int32_t camera_id, mojo::PendingReceiver<cros::mojom::Camera3DeviceOps> device_ops_receiver, OpenDeviceCallback callback);
    ...
    base::flat_map<int, std::unique_ptr<VideoCaptureDeviceChromeOSDelegate>> vcd_delegate_map_;
