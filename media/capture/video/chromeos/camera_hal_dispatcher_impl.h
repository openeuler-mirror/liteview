...
public:
    virtual void OnActiveClientChange(cros::mojom::CameraClientType type, bool is_active) = 0;
};
...
class FailedCameraHalServerCallbacks final : public cros::mojom::CameraHalServerCallbacks {
private:
...
public:
    ...
    virtual void OnCameraHWPrivacySwitchStatusChanged(int32_t camera_id, cros::mojom::CameraPrivacySwitchState state) { }

    virtual void OnCameraSWPrivacySwitchStatusChanged(cros::mojom::CameraPrivacySwitchState state) { }
};
...
class CAPTURE_EXPORT CameraHalDispatcherImpl final : public cros::mojom::CameraHalDispatcher, public cros::mojom::CameraHalServerCallbacks {
public:
    ...
    bool Start(MojoMjpegDecodeAcceleratorFactoryCB jda_factory, MojoJpegEncodeAcceleratorFactoryCB jea_factory);
    ...
    cros::mojom::CameraPrivacySwitchState AddCameraPrivacySwitchObserver(CameraPrivacySwitchObserver* observer);
    ...
    void GetCameraSWPrivacySwitchState(cros::mojom::CameraHalServer::GetCameraSWPrivacySwitchStateCallback callback);
    ...
    void RegisterServer(mojo::PendingRemote<cros::mojom::CameraHalServer> server) final;
    void RegisterServerWithToken(mojo::PendingRemote<cros::mojom::CameraHalServer> server, const base::UnguessableToken& token, RegisterServerWithTokenCallback callback) final;
    void RegisterClient(mojo::PendingRemote<cros::mojom::CameraHalClient> client) final;
    void RegisterClientWithToken(mojo::PendingRemote<cros::mojom::CameraHalClient> client, cros::mojom::CameraClientType type, const base::UnguessableToken& auth_token,
    ...
    void RegisterSensorClientWithToken(
        mojo::PendingRemote<chromeos::sensors::mojom::SensorHalClient> client, const base::UnguessableToken& auth_token, RegisterSensorClientWithTokenCallback callback) final;
    ...
    void GetAutoFramingSupported(cros::mojom::CameraHalServer::GetAutoFramingSupportedCallback callback);
...
private:
    ...
    void GetCameraSWPrivacySwitchStateOnProxyThread(cros::mojom::CameraHalServer::GetCameraSWPrivacySwitchStateCallback callback);
    ...
    void RegisterClientWithTokenOnProxyThread(
        mojo::PendingRemote<cros::mojom::CameraHalClient> client, cros::mojom::CameraClientType type, base::UnguessableToken token, RegisterClientWithTokenCallback callback);
    ...
    void GetAutoFramingSupportedOnProxyThread(cros::mojom::CameraHalServer::GetAutoFramingSupportedCallback callback);
    ...
    mojo::Receiver<cros::mojom::CameraHalServerCallbacks> camera_hal_server_callbacks_;
    ...
    cros::mojom::CameraPrivacySwitchState current_hw_privacy_switch_state_ GUARDED_BY(hw_privacy_switch_lock_) = cros::mojom::CameraPrivacySwitchState::UNKNOWN;

    cros::mojom::CameraAutoFramingState current_auto_framing_state_ = cros::mojom::CameraAutoFramingState::OFF;

    cros::mojom::CameraHalServer::GetAutoFramingSupportedCallback auto_framing_supported_callback_;
