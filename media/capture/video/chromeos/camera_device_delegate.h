...
public:
    ...
    CameraDeviceDelegate(VideoCaptureDeviceDescriptor device_descriptor, CameraHalDelegate* camera_hal_delegate, scoped_refptr<base::SingleThreadTaskRunner> ipc_task_runner);
...
private:
    ...
    void OnFlushed(bool require_photo, absl::optional<gfx::Size> new_blob_resolution, int32_t result);
    ...
    void ConfigureStreams(bool require_photo, absl::optional<gfx::Size> new_blob_resolution);
    ...
    void OnConstructedDefaultStillCaptureRequestSettings(cros::mojom::CameraMetadataPtr settings);
    ...
    mojom::RangePtr GetControlRangeByVendorTagName(const std::string& range_name, const absl::optional<int32_t>& current);
