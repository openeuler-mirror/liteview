...
template <typename T> CAPTURE_EXPORT base::span<T> GetMetadataEntryAsSpan(const cros::mojom::CameraMetadataPtr& camera_metadata, cros::mojom::CameraMetadataTag tag)
{
