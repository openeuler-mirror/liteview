...
public:
    explicit VideoCaptureDeviceFactoryChromeOS(scoped_refptr<base::SingleThreadTaskRunner> task_runner_for_screen_observer);
...
private:
    ...
    const scoped_refptr<base::SingleThreadTaskRunner> task_runner_for_screen_observer_;
