...
public:
        ...
        , frame_production_thread_("FakeV4L2Impl FakeProductionThread")
    {
        ...
        selected_format_.sizeimage = VideoFrame::AllocationSize(PIXEL_FORMAT_I420, gfx::Size(kDefaultWidth, kDefaultHeight));
    ...
    int s_fmt(v4l2_format* format)
    {
        ...
        pix_format.sizeimage = VideoFrame::AllocationSize(PIXEL_FORMAT_I420, gfx::Size(pix_format.width, pix_format.height));
    ...
    int dqbuf(v4l2_buffer* buf)
    {
        ...
        buf->bytesused = VideoFrame::AllocationSize(PIXEL_FORMAT_I420, gfx::Size(selected_format_.width, selected_format_.height));
        buf->flags = buffer->flags;
    ...
    int streamon(const int* type)
    {
        ...
        frame_production_thread_.task_runner()->PostTask(FROM_HERE, base::BindOnce(&FakeV4L2Impl::OpenedDevice::RunFrameProductionLoop, base::Unretained(this)));
        return kSuccessReturnValue;
    }
