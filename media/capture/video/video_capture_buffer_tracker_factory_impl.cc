...
std::unique_ptr<VideoCaptureBufferTracker> VideoCaptureBufferTrackerFactoryImpl::CreateTrackerForExternalGpuMemoryBuffer(const gfx::GpuMemoryBufferHandle& handle)
{
#if BUILDFLAG(IS_MAC)
