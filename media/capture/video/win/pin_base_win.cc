...
void PinBase::SetOwner(IBaseFilter* owner) { owner_ = owner; }
...
HRESULT PinBase::QueryAccept(const AM_MEDIA_TYPE* media_type) { return S_FALSE; }
...
HRESULT PinBase::QueryInternalConnections(IPin** pins, ULONG* no_pins) { return E_NOTIMPL; }

HRESULT PinBase::EndOfStream() { return S_OK; }

HRESULT PinBase::BeginFlush() { return S_OK; }

HRESULT PinBase::EndFlush() { return S_OK; }
...
HRESULT PinBase::GetAllocator(IMemAllocator** allocator) { return VFW_E_NO_ALLOCATOR; }

HRESULT PinBase::NotifyAllocator(IMemAllocator* allocator, BOOL read_only) { return S_OK; }

HRESULT PinBase::GetAllocatorRequirements(ALLOCATOR_PROPERTIES* properties) { return E_NOTIMPL; }
...
HRESULT PinBase::ReceiveCanBlock() { return S_FALSE; }
