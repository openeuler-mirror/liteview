...
static inline double PlatformToCaptureValue(long value) { return value; }
static inline double PlatformToCaptureStep(long step, double min, double max) { return step; }
