...
HRESULT FilterBase::FindPin(LPCWSTR id, IPin** pin) { return E_NOTIMPL; }
...
HRESULT FilterBase::QueryVendorInfo(LPWSTR* pVendorInfo) { return S_OK; }
...
HRESULT FilterBase::SetSyncSource(IReferenceClock* clock) { return S_OK; }

HRESULT FilterBase::GetSyncSource(IReferenceClock** clock) { return E_NOTIMPL; }
