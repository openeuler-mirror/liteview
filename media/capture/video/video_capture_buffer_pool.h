...
public:
    ...
    virtual mojo::ScopedSharedBufferHandle DuplicateAsMojoBuffer(int buffer_id) = 0;
    ...
    virtual int ReserveIdForExternalBuffer(const gfx::GpuMemoryBufferHandle& handle, int* buffer_id_to_drop) = 0;
