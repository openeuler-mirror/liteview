...
public:
    ...
    bool IsHeldByProducerOrConsumer() const { return held_by_producer_ || consumer_hold_count_ > 0; }
    ...
    uint64_t LastCustomerUseSequenceNumber() const { return last_customer_use_sequence_number_; }
