...
bool CompareByArea(const gfx::Size& a, const gfx::Size& b) { return a.GetArea() < b.GetArea(); }
...
void CaptureResolutionChooser::UpdateSnappedFrameSizes()
{
    ...
    constrained_size
        = ComputeBoundedCaptureSize(apply_aspect_ratio_adjustment_ ? PadToMatchAspectRatio(constrained_size, max_frame_size_) : constrained_size, min_frame_size_, max_frame_size_);
