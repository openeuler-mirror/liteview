...
TEST(VideoCaptureOracleTest, TransitionsSmoothlyBetweenSamplers)
{
    ...
    for (int i = 0; i < 1000; ++i) {
        ...
        const bool oracle_says_sample
            = oracle.ObserveEventAndDecideCapture(VideoCaptureOracle::kCompositorUpdate, provide_animated_content_event ? animation_damage_rect : gfx::Rect(), t);
