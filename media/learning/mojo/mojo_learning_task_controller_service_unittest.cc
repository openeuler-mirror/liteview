...
public:
    ...
    public:
        ...
        void CancelObservation(base::UnguessableToken id) override { cancel_args_.id_ = id; }
        ...
        const LearningTask& GetLearningTask() override { return LearningTask::Empty(); }
...
TEST_F(MojoLearningTaskControllerServiceTest, UpdateDefaultTargetToNoValue)
{
    ...
    EXPECT_EQ(id, controller_raw_->update_default_args_.id_);
    EXPECT_EQ(absl::nullopt, controller_raw_->update_default_args_.default_target_);
}
