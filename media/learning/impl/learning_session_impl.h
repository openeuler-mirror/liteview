...
public:
    ...
    using CreateTaskControllerCB
        = base::RepeatingCallback<base::SequenceBound<LearningTaskController>(scoped_refptr<base::SequencedTaskRunner>, const LearningTask&, SequenceBoundFeatureProvider)>;
