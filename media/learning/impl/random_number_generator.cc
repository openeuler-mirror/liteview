...
double RandomNumberGenerator::GenerateDouble(double range) { return base::BitsToOpenEndedUnitInterval(Generate()) * range; }
...
void HasRandomNumberGenerator::SetRandomNumberGeneratorForTesting(RandomNumberGenerator* rng) { rng_ = rng; }
