...
class COMPONENT_EXPORT(LEARNING_IMPL) ExtraTreesTrainer : public TrainingAlgorithm, public HasRandomNumberGenerator, public base::SupportsWeakPtr<ExtraTreesTrainer> {
public:
    ExtraTreesTrainer();
