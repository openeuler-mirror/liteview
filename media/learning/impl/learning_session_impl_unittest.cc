...
public:
    ...
    public:
        ...
        void CancelObservation(base::UnguessableToken id) override { cancelled_id_ = id; }
    ...
    public:
        ...
        void AddFeatures(FeatureVector features, FeatureProvider::FeatureVectorCB cb) override { *flag_ptr_ = true; }
