...
bool TargetHistogram::operator==(const TargetHistogram& rhs) const { return rhs.total_counts() == total_counts() && rhs.counts_ == counts_; }
...
double& TargetHistogram::operator[](const TargetValue& value) { return counts_[value]; }
...
std::ostream& operator<<(std::ostream& out, const media::learning::TargetHistogram& dist) { return out << dist.ToString(); }
