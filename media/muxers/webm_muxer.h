...
public:
    ...
    struct MEDIA_EXPORT VideoParameters {
        ...
        VideoParameters(gfx::Size visible_rect_size, double frame_rate, VideoCodec codec, absl::optional<gfx::ColorSpace> color_space);
    ...
    WebmMuxer(AudioCodec audio_codec, bool has_video_, bool has_audio_, std::unique_ptr<Delegate> delegate);
    ...
    bool OnEncodedVideo(const VideoParameters& params, std::string encoded_data, std::string encoded_alpha, base::TimeTicks timestamp, bool is_key_frame);
    bool OnEncodedAudio(const media::AudioParameters& params, std::string encoded_data, base::TimeTicks timestamp);
...
private:
    ...
    // frame size.
    void AddVideoTrack(const gfx::Size& frame_size, double frame_rate, const absl::optional<gfx::ColorSpace>& color_space);
    ...
    base::TimeTicks UpdateLastTimestampMonotonically(base::TimeTicks timestamp, base::TimeTicks* last_timestamp);
    ...
    struct EncodedFrame {
        ...
        base::TimeDelta relative_timestamp; // relative to first_frame_timestamp_xxx_
        bool is_keyframe;
    };
