...
public:
    ...
    void NotImplemented_(const std::string& name) override { FAIL() << "Unexpected call to: " << name; }
...
public:
    ...
    void OnData(const AudioBus* source, base::TimeTicks capture_time, double volume) override
    {
...
protected:
    ...
    void MakeAudioInputStreamOnAudioThread() { RunOnAudioThread(base::BindOnce(&AudioInputTest::MakeAudioInputStream, base::Unretained(this))); }
    ...
    void OpenAndCloseAudioInputStreamOnAudioThread() { RunOnAudioThread(base::BindOnce(&AudioInputTest::OpenAndClose, base::Unretained(this))); }

    void OpenStopAndCloseAudioInputStreamOnAudioThread() { RunOnAudioThread(base::BindOnce(&AudioInputTest::OpenStopAndClose, base::Unretained(this))); }
    ...
    void StopAndCloseAudioInputStreamOnAudioThread() { RunOnAudioThread(base::BindOnce(&AudioInputTest::StopAndClose, base::Unretained(this))); }
    ...
    void MakeAudioInputStream()
    {
        ...
        audio_input_stream_
            = audio_manager_->MakeAudioInputStream(params, AudioDeviceDescription::kDefaultDeviceId, base::BindRepeating(&AudioInputTest::OnLogMessage, base::Unretained(this)));
