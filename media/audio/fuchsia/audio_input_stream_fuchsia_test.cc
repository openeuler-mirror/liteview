...
public:
    ...
    const std::vector<std::unique_ptr<AudioBus>>& packets() const { return packets_; }
...
TEST_F(AudioInputStreamFuchsiaTest, InitializeAndDestroy) { InitializeCapturer(ChannelLayoutConfig::Mono()); }
...
TEST_F(AudioInputStreamFuchsiaTest, CaptureMono) { TestCapture(ChannelLayoutConfig::Mono()); }

TEST_F(AudioInputStreamFuchsiaTest, CaptureStereo) { TestCapture(ChannelLayoutConfig::Stereo()); }
