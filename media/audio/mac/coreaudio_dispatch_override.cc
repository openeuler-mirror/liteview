...
void LogInitResult(DispatchOverrideInitResult result) { UMA_HISTOGRAM_ENUMERATION("Media.Audio.CoreAudioDispatchOverrideInitResult", result, RESULT_MAX + 1); }
...
void LogCallsiteLookupEvent(CallsiteLookupEvent event) { UMA_HISTOGRAM_ENUMERATION("Media.Audio.CoreAudioDispatchOverrideLookupEvent", event, LOOKUP_MAX + 1); }
#endif
...
bool AddressIsPauseOrResume(intptr_t address)
{
    ...
    if (!resumeio_callsite && info.dli_sname && (strcmp(info.dli_sname, "HALC_IOContext_ResumeIO") == 0 || strcmp(info.dli_sname, "_XIOContext_ResumeIO") == 0)) {
    ...
    } else if (!pauseio_callsite && info.dli_sname && (strcmp(info.dli_sname, "HALC_IOContext_PauseIO") == 0 || strcmp(info.dli_sname, "_XIOContext_PauseIO") == 0)) {
