...
public:
    ...
    AudioDeviceListenerMac(base::RepeatingClosure listener_cb, bool monitor_default_input = false, bool monitor_addition_removal = false, bool monitor_sources = false);
...
private:
    ...
    using SourceListenerMap = base::flat_map<SourceListenerKey, std::unique_ptr<PropertyListener>>;
