...
public:
    ...
    AUAudioInputStream(AudioManagerMac* manager, const AudioParameters& input_params, AudioDeviceID audio_device_id, const AudioManager::LogCallback& log_callback,
    ...
    size_t requested_buffer_size() const { return input_params_.frames_per_buffer(); }
...
private:
    ...
    static OSStatus DataIsAvailable(
