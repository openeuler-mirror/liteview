...
public:
    ...
    using OnAudioParamsCallback = base::OnceCallback<void(const absl::optional<AudioParameters>&)>;
    using OnDeviceIdCallback = base::OnceCallback<void(const absl::optional<std::string>&)>;
    using OnInputDeviceInfoCallback = base::OnceCallback<void(const absl::optional<AudioParameters>&, const absl::optional<std::string>&)>;
