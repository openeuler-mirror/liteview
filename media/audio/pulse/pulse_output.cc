...
PulseAudioOutputStream::PulseAudioOutputStream(const AudioParameters& params, const std::string& device_id, AudioManagerBase* manager, AudioManager::LogCallback log_callback)
...
void PulseAudioOutputStream::FulfillWriteRequest(size_t requested_bytes)
{
    ...
    while (bytes_remaining > 0) {
        ...
        size_t frames_filled = source_callback_->OnMoreData(pulse::GetHardwareLatency(pa_stream_), base::TimeTicks::Now(), 0, audio_bus_.get());
