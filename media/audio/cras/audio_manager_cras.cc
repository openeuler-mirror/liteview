...
bool AudioManagerCras::HasAudioOutputDevices() { return true; }

bool AudioManagerCras::HasAudioInputDevices() { return !cras_util_->CrasGetAudioDevices(DeviceType::kInput).empty(); }
...
{
    return base::GetFieldTrialParamByFeatureAsBool(features::kCrOSSystemAECDeactivatedGroups, base::NumberToString(aec_group_id), false);
}
...
{
    return base::GetFieldTrialParamByFeatureAsBool(features::kCrOSDspBasedAecDeactivatedGroups, base::NumberToString(aec_group_id), false)
...
{
    return base::GetFieldTrialParamByFeatureAsBool(features::kCrOSDspBasedNsDeactivatedGroups, base::NumberToString(aec_group_id), false)
...
{
    return base::GetFieldTrialParamByFeatureAsBool(features::kCrOSDspBasedAgcDeactivatedGroups, base::NumberToString(aec_group_id), false)
...
bool AudioManagerCras::IsDefault(const std::string& device_id, bool is_input) { return AudioDeviceDescription::IsDefaultDevice(device_id); }

enum CRAS_CLIENT_TYPE AudioManagerCras::GetClientType() { return CRAS_CLIENT_TYPE_LACROS; }
