...
bool ExperimentalAecActive(const AudioParameters& params) { return params.effects() & AudioParameters::EXPERIMENTAL_ECHO_CANCELLER; }

bool AecActive(const AudioParameters& params) { return params.effects() & AudioParameters::ECHO_CANCELLER; }

bool NsActive(const AudioParameters& params) { return params.effects() & AudioParameters::NOISE_SUPPRESSION; }

bool AgcActive(const AudioParameters& params) { return params.effects() & AudioParameters::AUTOMATIC_GAIN_CONTROL; }

bool DspAecAllowed(const AudioParameters& params) { return params.effects() & AudioParameters::ALLOW_DSP_ECHO_CANCELLER && params.effects() & AudioParameters::ECHO_CANCELLER; }
...
INSTANTIATE_TEST_SUITE_P(AllInputParameters, GetStreamParametersForSystem,
    ::testing::Combine(::testing::Values(512, kDefaultInputBufferSize), ::testing::Values(false, true), ::testing::Values(kNoAecFlaggedGroupId, kAecTestGroupId),
...
INSTANTIATE_TEST_SUITE_P(
    AllAllowedDspInputParameters, AllowedDspParameters, ::testing::Combine(::testing::Values(false, true), ::testing::Values(false, true), ::testing::Values(false, true)));
