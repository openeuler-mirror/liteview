...
static WAVEHDR* GetNextBuffer(WAVEHDR* current) { return reinterpret_cast<WAVEHDR*>(current->dwUser); }
...
PCMWaveInAudioInputStream::~PCMWaveInAudioInputStream() { DCHECK(NULL == wavein_); }
