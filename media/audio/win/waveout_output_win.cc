...
PCMWaveOutAudioOutputStream::~PCMWaveOutAudioOutputStream() { DCHECK(NULL == waveout_); }
...
bool PCMWaveOutAudioOutputStream::Open()
{
    ...
    MMRESULT result = ::waveOutOpen(&waveout_, device_id_, reinterpret_cast<LPCWAVEFORMATEX>(&format_), reinterpret_cast<DWORD_PTR>(buffer_event_.Get()), NULL, CALLBACK_EVENT);
