...
public:
    ...
    public:
        ...
        // the consumer.
        virtual int OnMoreData(base::TimeDelta delay, base::TimeTicks delay_timestamp, int prior_frames_skipped, AudioBus* dest) = 0;

        virtual int OnMoreData(base::TimeDelta delay, base::TimeTicks delay_timestamp, int prior_frames_skipped, AudioBus* dest, bool is_mixing);
...
public:
    ...
    public:
        ...
        virtual void OnData(const AudioBus* source, base::TimeTicks capture_time, double volume) = 0;
