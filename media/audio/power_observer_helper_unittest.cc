...
protected:
    ...
    void CreatePowerObserverHelper()
    {
        ...
        power_observer_helper_ = std::make_unique<PowerObserverHelper>(power_observer_helper_thread_.task_runner(),
            base::BindRepeating(&PowerObserverHelperTest::OnSuspend, base::Unretained(this)), base::BindRepeating(&PowerObserverHelperTest::OnResume, base::Unretained(this)));
    }
    ...
    PowerObserverHelper* power_observer_helper() const { return power_observer_helper_.get(); }
