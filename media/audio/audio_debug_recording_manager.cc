...
AudioDebugRecordingManager::AudioDebugRecordingManager() { DETACH_FROM_SEQUENCE(sequence_checker_); }
...
std::unique_ptr<AudioDebugRecorder> AudioDebugRecordingManager::RegisterDebugRecordingSource(AudioDebugRecordingStreamType stream_type, const AudioParameters& params)
{
    DCHECK_CALLED_ON_VALID_SEQUENCE(sequence_checker_);
...
std::unique_ptr<AudioDebugRecordingHelper> AudioDebugRecordingManager::CreateAudioDebugRecordingHelper(const AudioParameters& params, base::OnceClosure on_destruction_closure)
{
