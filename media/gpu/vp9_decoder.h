...
public:
    ...
    public:
        ...
        virtual Status SubmitDecode(scoped_refptr<VP9Picture> pic, const Vp9SegmentationParams& segm_params, const Vp9LoopFilterParams& lf_params,
            const Vp9ReferenceFrameVector& reference_frames, const base::OnceClosure done_cb)
            = 0;
        ...
        virtual bool GetFrameContext(scoped_refptr<VP9Picture> pic, Vp9FrameContext* frame_ctx) = 0;
    ...
    explicit VP9Decoder(std::unique_ptr<VP9Accelerator> accelerator, VideoCodecProfile profile, const VideoColorSpace& container_color_space = VideoColorSpace());
...
private:
    ...
    void UpdateFrameContext(scoped_refptr<VP9Picture> pic, Vp9Parser::ContextRefreshCallback context_refresh_cb);
