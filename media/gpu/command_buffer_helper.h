...
public:
    ...
    virtual std::unique_ptr<gpu::SharedImageRepresentationFactoryRef> Register(std::unique_ptr<gpu::SharedImageBacking> backing) = 0;
    ...
    virtual GLuint CreateTexture(GLenum target, GLenum internal_format, GLsizei width, GLsizei height, GLenum format, GLenum type) = 0;
    ...
    virtual bool BindImage(GLuint service_id, gl::GLImage* image, bool client_managed) = 0;
