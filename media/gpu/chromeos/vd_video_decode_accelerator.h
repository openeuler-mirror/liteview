...
public:
    ...
    using CreateVideoDecoderCb = base::RepeatingCallback<decltype(VideoDecoderPipeline::Create)>;
    ...
    void RequestFrames(const Fourcc& fourcc, const gfx::Size& coded_size, const gfx::Rect& visible_rect, size_t max_num_frames, NotifyLayoutChangedCb notify_layout_changed_cb,
...
private:
    ...
    std::map<gfx::GpuMemoryBufferId, int32_t /* picture_buffer_id */> frame_id_to_picture_id_;
