...
public:
    ...
    public:
        ...
        using ImportFrameCb = base::RepeatingCallback<void(scoped_refptr<VideoFrame>)>;
...
private:
    ...
    static void ImportFrameThunk(scoped_refptr<base::SequencedTaskRunner> task_runner, absl::optional<base::WeakPtr<VdaVideoFramePool>> weak_this, scoped_refptr<VideoFrame> frame);
