...
MEDIA_GPU_EXPORT scoped_refptr<VideoFrame> CreateGpuMemoryBufferVideoFrame(VideoPixelFormat pixel_format, const gfx::Size& coded_size, const gfx::Rect& visible_rect,
...
MEDIA_GPU_EXPORT absl::optional<VideoFrameLayout> GetPlatformVideoFrameLayout(VideoPixelFormat pixel_format, const gfx::Size& coded_size, gfx::BufferUsage buffer_usage);
