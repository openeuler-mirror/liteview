...
public:
    ...
    using CreateFrameCB
        = base::RepeatingCallback<CroStatus::Or<scoped_refptr<VideoFrame>>(VideoPixelFormat, const gfx::Size&, const gfx::Rect&, const gfx::Size&, bool, bool, base::TimeDelta)>;
    ...
    virtual CroStatus::Or<GpuBufferLayout> Initialize(const Fourcc& fourcc, const gfx::Size& coded_size, const gfx::Rect& visible_rect, const gfx::Size& natural_size,
        size_t max_num_frames, bool use_protected, bool use_linear_buffers = false)
        = 0;
