...
public:
    ...
    // ImageProcessor.
    static std::unique_ptr<ImageProcessorClient> Create(const ImageProcessor::PortConfig& input_config, const ImageProcessor::PortConfig& output_config, size_t num_buffers,
        VideoRotation relative_rotation, std::vector<std::unique_ptr<VideoFrameProcessor>> frame_processors);
...
private:
    ...
    // |num_buffers|.
    bool CreateImageProcessor(const ImageProcessor::PortConfig& input_config, const ImageProcessor::PortConfig& output_config, size_t num_buffers, VideoRotation relative_rotation);

    // Create |image_processor_| on |my_thread_|.
    void CreateImageProcessorTask(const ImageProcessor::PortConfig& input_config, const ImageProcessor::PortConfig& output_config, size_t num_buffers,
        VideoRotation relative_rotation, base::WaitableEvent* done);
