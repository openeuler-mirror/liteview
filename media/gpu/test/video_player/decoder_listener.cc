...
bool DecoderListener::WaitForFlushDone() { return WaitForEvent(Event::kFlushDone); }

bool DecoderListener::WaitForResetDone() { return WaitForEvent(Event::kResetDone); }

bool DecoderListener::WaitForFrameDecoded(size_t times) { return WaitForEvent(Event::kFrameDecoded, times); }
...
bool DecoderListener::WaitForFrameProcessors() { return decoder_wrapper_->WaitForFrameProcessors(); }

void DecoderListener::WaitForRenderer() { decoder_wrapper_->WaitForRenderer(); }

size_t DecoderListener::GetFlushDoneCount() const { return GetEventCount(Event::kFlushDone); }

size_t DecoderListener::GetResetDoneCount() const { return GetEventCount(Event::kResetDone); }

size_t DecoderListener::GetFrameDecodedCount() const { return GetEventCount(Event::kFrameDecoded); }
