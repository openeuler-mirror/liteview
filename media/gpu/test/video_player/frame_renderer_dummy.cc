...
FrameRendererDummy::~FrameRendererDummy() { Destroy(); }
...
scoped_refptr<VideoFrame> FrameRendererDummy::CreateVideoFrame(VideoPixelFormat pixel_format, const gfx::Size& size, uint32_t texture_target, uint32_t* texture_id)
{
    *texture_id = 0;
    ...
    absl::optional<VideoFrameLayout> layout = CreateVideoFrameLayout(pixel_format, size);
    DCHECK(layout);
