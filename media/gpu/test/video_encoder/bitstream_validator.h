...
public:
    ...
    static std::unique_ptr<BitstreamValidator> Create(const VideoDecoderConfig& decoder_config, size_t last_frame_index,
        std::vector<std::unique_ptr<VideoFrameProcessor>> video_frame_processors = {}, absl::optional<size_t> spatial_layer_index_to_decode_ = absl::nullopt,
        absl::optional<size_t> temporal_layer_index_to_decode = absl::nullopt, const std::vector<gfx::Size>& spatial_layer_resolutions = {});
...
private:
    BitstreamValidator(std::unique_ptr<VideoDecoder> decoder, std::unique_ptr<MediaLog> media_log, size_t last_frame_index, const gfx::Rect& decoding_rect,
        absl::optional<size_t> spatial_layer_index_to_decode_, absl::optional<size_t> temporal_layer_index_to_decode, const std::vector<gfx::Size>& spatial_layer_resolutions,
