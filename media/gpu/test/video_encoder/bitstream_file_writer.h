...
public:
    static std::unique_ptr<BitstreamFileWriter> Create(const base::FilePath& output_filepath, VideoCodec codec, const gfx::Size& resolution, uint32_t frame_rate,
        uint32_t num_frames, absl::optional<size_t> spatial_layer_index_to_write = absl::nullopt, absl::optional<size_t> temporal_layer_index_to_write = absl::nullopt,
...
private:
    ...
    BitstreamFileWriter(std::unique_ptr<FrameFileWriter> frame_file_writer, absl::optional<size_t> spatial_layer_index_to_write,
