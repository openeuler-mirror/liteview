...
public:
    ...
    private:
        ...
        BitstreamRef(scoped_refptr<DecoderBuffer> buffer, const BitstreamBufferMetadata& metadata, int32_t id, base::TimeTicks source_timestamp, base::OnceClosure release_cb);
        ~BitstreamRef();
