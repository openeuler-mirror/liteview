...
protected:
    void Initialize() { pbm_->Initialize(environment_.GetMainThreadTaskRunner(), cbh_); }
    ...
    PictureBuffer CreateARGBPictureBuffer(VideoDecodeAccelerator::TextureAllocationMode mode = VideoDecodeAccelerator::TextureAllocationMode::kAllocateGLTextures)
    {
...
TEST_F(PictureBufferManagerImplTest, Initialize) { Initialize(); }
