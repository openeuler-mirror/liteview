...
private:
    void BindCommandBufferMediaReceiver(gpu::CommandBufferStub* stub, mojo::GenericPendingAssociatedReceiver receiver);

    const raw_ptr<gpu::GpuChannel> channel_;
    AndroidOverlayMojoFactoryCB overlay_factory_cb_;
    mojo::UniqueAssociatedReceiverSet<mojom::GpuAcceleratedVideoDecoderProvider> accelerated_video_decoder_providers_;
};
