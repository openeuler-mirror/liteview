...
class GpuVideoDecodeAcceleratorHost : public VideoDecodeAccelerator, public gpu::CommandBufferProxyImpl::DeletionObserver, public mojom::GpuAcceleratedVideoDecoderClient {
public:
