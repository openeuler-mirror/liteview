...
public:
    ...
    scoped_refptr<media::AV1Picture> CreateAV1Picture(bool apply_grain) override { return base::MakeRefCounted<media::AV1Picture>(); }
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    for (int i = 0; i < 2; ++i) {
        ...
        scoped_refptr<media::DecoderBuffer> decoder_buffer = media::DecoderBuffer::CopyFrom(decoder_buffer_data.data(), decoder_buffer_data.size());
