...
private:
    ...
    scoped_refptr<H264BitstreamBuffer> GeneratePackedSliceHeader(
        const VAEncPictureParameterBufferH264& pic_param, const VAEncSliceParameterBufferH264& sliice_param, const H264Picture& pic);
    ...
    bool SubmitPackedHeaders(const H264BitstreamBuffer& packed_sps, const H264BitstreamBuffer& packed_pps);
