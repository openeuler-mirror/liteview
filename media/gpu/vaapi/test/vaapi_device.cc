    ...
    : display_(nullptr)
{
    ...
    display_file_ = base::File(base::FilePath::FromUTF8Unsafe(kDriRenderNode0Path), base::File::FLAG_OPEN | base::File::FLAG_READ | base::File::FLAG_WRITE);
    LOG_ASSERT(display_file_.IsValid()) << "Failed to open " << kDriRenderNode0Path;
