...
public:
    ...
    void DefaultDestroyPendingBuffers_Locked() EXCLUSIVE_LOCKS_REQUIRED(mock_vaapi_wrapper_->va_lock_) { mock_vaapi_wrapper_->pending_va_buffers_.clear(); }

    size_t GetPendingBuffersSize() const { return mock_vaapi_wrapper_->pending_va_buffers_.size(); }
