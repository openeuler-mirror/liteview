...
public:
    ...
    const scoped_refptr<VASurface>& display_va_surface() const { return display_va_surface_; }
    const scoped_refptr<VASurface>& reconstruct_va_surface() const { return reconstruct_va_surface_; }
