...
private:
    ...
    void SetFrameHeader(size_t frame_num, VP8Picture& picture, std::array<bool, kNumVp8ReferenceBuffers>& ref_frames_used);
    ...
    using VP8RateControl = VideoRateControl<libvpx::VP8RateControlRtcConfig, libvpx::VP8RateControlRTC, libvpx::VP8FrameParamsQpRTC>;
