...
public:
    ...
    public:
        ...
        EncodeJob(bool keyframe, base::TimeDelta timestamp, VASurfaceID input_surface_id);
        // Constructor for VA-API.
        EncodeJob(bool keyframe, base::TimeDelta timestamp, VASurfaceID input_surface_id, scoped_refptr<CodecPicture> picture, std::unique_ptr<ScopedVABuffer> coded_buffer);
