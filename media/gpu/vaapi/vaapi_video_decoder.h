...
class VaapiVideoDecoder : public VideoDecoderMixin, public DecodeSurfaceHandler<VASurface> {
public:
    ...
    void SurfaceReady(scoped_refptr<VASurface> va_surface, int32_t buffer_id, const gfx::Rect& visible_rect, const VideoColorSpace& color_space) override;
...
private:
    ...
    VaapiVideoDecoder(std::unique_ptr<MediaLog> media_log, scoped_refptr<base::SequencedTaskRunner> decoder_task_runner, base::WeakPtr<VideoDecoderMixin::Client> client);
    ...
    static CroStatus::Or<scoped_refptr<VideoFrame>> AllocateCustomFrameProxy(base::WeakPtr<VaapiVideoDecoder> decoder, VideoPixelFormat format, const gfx::Size& coded_size,
    ...
    // frame it creates.
    CroStatus::Or<scoped_refptr<VideoFrame>> AllocateCustomFrame(VideoPixelFormat format, const gfx::Size& coded_size, const gfx::Rect& visible_rect, const gfx::Size& natural_size,
    ...
    base::small_map<std::map<gfx::GpuMemoryBufferId, scoped_refptr<VASurface>>> allocated_va_surfaces_;
