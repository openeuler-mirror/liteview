...
public:
    ...
    VaapiVideoDecoderDelegate(DecodeSurfaceHandler<VASurface>* const vaapi_dec, scoped_refptr<VaapiWrapper> vaapi_wrapper, ProtectedSessionUpdateCB on_protected_session_update_cb,
        CdmContext* cdm_context, EncryptionScheme encryption_scheme = EncryptionScheme::kUnencrypted);
...
protected:
    ...
    // for Intel platforms.
    bool IsEncryptedSession() const { return (encryption_scheme_ != EncryptionScheme::kUnencrypted) && !transcryption_; }
