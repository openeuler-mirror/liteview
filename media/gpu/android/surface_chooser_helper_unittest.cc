...
public:
    ...
    void ReplaceHelper(bool is_overlay_required, bool promote_secure_only, bool always_use_texture_owner = false)
    {
        ...
        helper_
            = std::make_unique<SurfaceChooserHelper>(std::move(chooser), is_overlay_required, promote_secure_only, always_use_texture_owner, std::move(aggregator), &tick_clock_);
    }
