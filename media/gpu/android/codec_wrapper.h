...
public:
    ...
    void set_render_cb(base::OnceClosure render_cb) { render_cb_ = std::move(render_cb); }
...
private:
    ...
    CodecOutputBuffer(int64_t id, const gfx::Size& size, const gfx::ColorSpace& color_space);
...
public:
    ...
    CodecWrapper(CodecSurfacePair codec_surface_pair, OutputReleasedCB output_buffer_release_cb, scoped_refptr<base::SequencedTaskRunner> release_task_runner,
