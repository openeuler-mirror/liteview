...
private:
    ...
    PooledSharedImageVideoProvider(base::SequenceBound<GpuHelper> gpu_helper, std::unique_ptr<SharedImageVideoProvider> provider, scoped_refptr<gpu::RefCountedLock> drdc_lock);
    ...
    public:
        ...
        void OnImageReturned(
            const gpu::SyncToken& sync_token, scoped_refptr<CodecImageHolder> codec_image_holder, base::OnceClosure cb, scoped_refptr<gpu::RefCountedLock> drdc_lock) override;
