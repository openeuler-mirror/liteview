...
public:
        ...
        : allocator_thread_("AllocatorThread")
    {
        ...
        allocator_ = new CodecAllocator(base::BindRepeating(&MockMediaCodecBridge::CreateVideoDecoder), base::SequencedTaskRunnerHandle::Get());
...
TEST_F(CodecAllocatorTest, NormalCreation)
{
    ...
    allocator_->CreateMediaCodecAsync(base::BindOnce(&CodecAllocatorTest::OnCodecCreatedInternal, base::Unretained(this), run_loop.QuitClosure()), std::move(config));
...
TEST_F(CodecAllocatorTest, MultipleCreation)
{
    ...
    base::RunLoop run_loop;
    allocator_->CreateMediaCodecAsync(base::BindOnce(&CodecAllocatorTest::OnCodecCreatedInternal, base::Unretained(this), base::DoNothing()), std::move(config));
    ...
    allocator_->CreateMediaCodecAsync(base::BindOnce(&CodecAllocatorTest::OnCodecCreatedInternal, base::Unretained(this), run_loop.QuitClosure()), std::move(config_secure));
...
TEST_F(CodecAllocatorTest, CodecReleasedOnRightTaskRunnerWhenHung)
{
    ...
    reinterpret_cast<MockMediaCodecBridge*>(hw_codec.get())->destruction_cb.ReplaceClosure(base::BindOnce(&CodecAllocatorTest::VerifyOnPrimaryTaskRunner, base::Unretained(this)));
...
TEST_F(CodecAllocatorTest, AllocateAndDestroyCodecOnAllocatorThread)
{
    ...
    {
        base::RunLoop run_loop;
        allocator_->ReleaseMediaCodec(std::move(last_created_codec_), base::BindOnce(&CodecAllocatorTest::OnCodecReleasedInternal, base::Unretained(this), run_loop.QuitClosure()));
