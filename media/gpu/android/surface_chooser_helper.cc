...
void SurfaceChooserHelper::SetVideoRotation(VideoRotation video_rotation) { surface_chooser_state_.video_rotation = video_rotation; }

void SurfaceChooserHelper::SetIsPersistentVideo(bool is_persistent_video) { surface_chooser_state_.is_persistent_video = is_persistent_video; }

void SurfaceChooserHelper::UpdateChooserState(absl::optional<AndroidOverlayFactoryCB> new_factory)
{
...
SurfaceChooserHelper::FrameInformation SurfaceChooserHelper::ComputeFrameInformation(bool is_using_overlay)
{
    ...
    return surface_chooser_state_.is_fullscreen ? FrameInformation::OVERLAY_INSECURE_PLAYER_ELEMENT_FULLSCREEN : FrameInformation::OVERLAY_INSECURE_NON_PLAYER_ELEMENT_FULLSCREEN;
}
