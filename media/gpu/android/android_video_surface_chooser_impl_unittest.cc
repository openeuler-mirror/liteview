...
public:
    ...
    std::unique_ptr<AndroidOverlay> ReleaseOverlay() { return std::move(overlay_); }
...
using TestParams
    = std::tuple<ShouldUseOverlay, ShouldBePowerEfficient, AllowDynamic, IsRequired, IsFullscreen, IsSecure, IsCCPromotable, IsExpectingRelayout, PromoteSecureOnly, MiscFlags>;
...
public:
    ...
    void StartChooser(AndroidOverlayFactoryCB factory)
    {
        ...
        chooser_->SetClientCallbacks(
            base::BindRepeating(&MockClient::UseOverlayImpl, base::Unretained(&client_)), base::BindRepeating(&MockClient::UseTextureOwner, base::Unretained(&client_)));
        chooser_->UpdateState(factory ? absl::make_optional(std::move(factory)) : absl::nullopt, chooser_state_);
    }
    ...
    {
        Factory* factory = new Factory(std::move(overlay), base::BindRepeating(&AndroidVideoSurfaceChooserImplTest::MockOnOverlayCreated, base::Unretained(this)));
...
TEST_F(AndroidVideoSurfaceChooserImplTest, UpdateStateAfterDeleteRetriesOverlay)
{
    ...
    EXPECT_CALL(*this, MockOnOverlayCreated());
    chooser_->UpdateState(absl::optional<AndroidOverlayFactoryCB>(), chooser_state_);
}
...
INSTANTIATE_TEST_SUITE_P(NoFullscreenUsesTextureOwner, AndroidVideoSurfaceChooserImplTest,
    Combine(Values(ShouldUseOverlay::No), Values(ShouldBePowerEfficient::Ignored), Either(AllowDynamic), Values(IsRequired::No), Values(IsFullscreen::No), Values(IsSecure::No),
        Either(IsCCPromotable), Either(IsExpectingRelayout), Values(PromoteSecureOnly::Yes), AnyMisc));

INSTANTIATE_TEST_SUITE_P(FullscreenUsesOverlay, AndroidVideoSurfaceChooserImplTest,
    Combine(Values(ShouldUseOverlay::Yes), Values(ShouldBePowerEfficient::Ignored), Either(AllowDynamic), Either(IsRequired), Values(IsFullscreen::Yes), Values(IsSecure::No),
        Values(IsCCPromotable::Yes), Values(IsExpectingRelayout::No), Values(PromoteSecureOnly::No), Values(MiscFlags::None)));

INSTANTIATE_TEST_SUITE_P(RequiredUsesOverlay, AndroidVideoSurfaceChooserImplTest,
    Combine(Values(ShouldUseOverlay::Yes), Values(ShouldBePowerEfficient::No), Values(AllowDynamic::Yes), Values(IsRequired::Yes), Either(IsFullscreen), Either(IsSecure),
        Either(IsCCPromotable), Either(IsExpectingRelayout), Either(PromoteSecureOnly), Values(MiscFlags::None, MiscFlags::Persistent)));
...
INSTANTIATE_TEST_SUITE_P(SecureUsesOverlayIfPromotable, AndroidVideoSurfaceChooserImplTest,
    Combine(Values(ShouldUseOverlay::Yes), Values(ShouldBePowerEfficient::No), Either(AllowDynamic), Either(IsRequired), Either(IsFullscreen), Values(IsSecure::Yes),
        Values(IsCCPromotable::Yes), Values(IsExpectingRelayout::No), Either(PromoteSecureOnly), Values(MiscFlags::None)));
...
INSTANTIATE_TEST_SUITE_P(NotCCPromotableNotRequiredUsesTextureOwner, AndroidVideoSurfaceChooserImplTest,
    Combine(Values(ShouldUseOverlay::No), Values(ShouldBePowerEfficient::No), Values(AllowDynamic::Yes), Values(IsRequired::No), Either(IsFullscreen), Either(IsSecure),
        Values(IsCCPromotable::No), Either(IsExpectingRelayout), Either(PromoteSecureOnly), AnyMisc));
...
INSTANTIATE_TEST_SUITE_P(InsecureExpectingRelayoutUsesTextureOwner, AndroidVideoSurfaceChooserImplTest,
    Combine(Values(ShouldUseOverlay::No), Values(ShouldBePowerEfficient::No), Values(AllowDynamic::Yes), Values(IsRequired::No), Either(IsFullscreen), Either(IsSecure),
        Either(IsCCPromotable), Values(IsExpectingRelayout::Yes), Either(PromoteSecureOnly), AnyMisc));
...
INSTANTIATE_TEST_SUITE_P(NotDynamicInFullscreenUsesOverlay, AndroidVideoSurfaceChooserImplTest,
    Combine(Values(ShouldUseOverlay::Yes), Values(ShouldBePowerEfficient::No), Values(AllowDynamic::No), Either(IsRequired), Values(IsFullscreen::Yes), Either(IsSecure),
        Either(IsCCPromotable), Either(IsExpectingRelayout), Values(PromoteSecureOnly::No), Values(MiscFlags::None, MiscFlags::Persistent)));
...
INSTANTIATE_TEST_SUITE_P(NotDynamicSecureUsesOverlay, AndroidVideoSurfaceChooserImplTest,
    Combine(Values(ShouldUseOverlay::Yes), Values(ShouldBePowerEfficient::No), Values(AllowDynamic::No), Either(IsRequired), Either(IsFullscreen), Values(IsSecure::Yes),
        Either(IsCCPromotable), Either(IsExpectingRelayout), Either(PromoteSecureOnly), Values(MiscFlags::None, MiscFlags::Persistent)));
...
INSTANTIATE_TEST_SUITE_P(NotDynamicRequiredUsesOverlay, AndroidVideoSurfaceChooserImplTest,
    Combine(Values(ShouldUseOverlay::Yes), Values(ShouldBePowerEfficient::No), Values(AllowDynamic::No), Values(IsRequired::Yes), Either(IsFullscreen), Either(IsSecure),
        Either(IsCCPromotable), Either(IsExpectingRelayout), Either(PromoteSecureOnly), Values(MiscFlags::None, MiscFlags::Persistent)));
...
INSTANTIATE_TEST_SUITE_P(AggressiveOverlayIsPowerEfficient, AndroidVideoSurfaceChooserImplTest,
    Combine(Values(ShouldUseOverlay::Yes), Values(ShouldBePowerEfficient::Yes), Values(AllowDynamic::Yes), Values(IsRequired::No), Values(IsFullscreen::No), Values(IsSecure::No),
        Values(IsCCPromotable::Yes), Values(IsExpectingRelayout::No), Values(PromoteSecureOnly::No), Values(MiscFlags::None)));
...
INSTANTIATE_TEST_SUITE_P(IsVideoRotatedUsesTextureOwner, AndroidVideoSurfaceChooserImplTest,
    Combine(Values(ShouldUseOverlay::No), Either(ShouldBePowerEfficient), Either(AllowDynamic), Either(IsRequired), Either(IsFullscreen), Either(IsSecure), Either(IsCCPromotable),
        Either(IsExpectingRelayout), Either(PromoteSecureOnly), Values(MiscFlags::Rotated)));
...
INSTANTIATE_TEST_SUITE_P(FullscreenPersistentVideoUsesSurfaceTexture, AndroidVideoSurfaceChooserImplTest,
    Combine(Values(ShouldUseOverlay::No), Values(ShouldBePowerEfficient::Ignored), Values(AllowDynamic::Yes), Values(IsRequired::No), Values(IsFullscreen::Yes), Either(IsSecure),
        Values(IsCCPromotable::Yes), Values(IsExpectingRelayout::No), Either(PromoteSecureOnly), Values(MiscFlags::Persistent)));
