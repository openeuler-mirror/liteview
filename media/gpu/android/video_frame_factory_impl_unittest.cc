...
public:
        ...
        : task_runner_(base::ThreadTaskRunnerHandle::Get())
    {
        ...
        impl_ = std::make_unique<VideoFrameFactoryImpl>(task_runner_, gpu_preferences_, std::move(image_provider), std::move(mre_manager), std::move(info_helper),
    ...
    {
        auto output_buffer = CodecOutputBuffer::CreateForTesting(0, video_frame_params_.coded_size, video_frame_params_.color_space);
...
TEST_F(VideoFrameFactoryImplTest, SetSurfaceBundleForwardsToMaybeRenderEarlyManager)
{
    ...
    scoped_refptr<CodecSurfaceBundle> surface_bundle = base::MakeRefCounted<CodecSurfaceBundle>(base::MakeRefCounted<NiceMock<gpu::MockTextureOwner>>(0, nullptr, nullptr, true),
        features::NeedThreadSafeAndroidMedia() ? base::MakeRefCounted<gpu::RefCountedLockForTest>() : nullptr);
...
TEST_F(VideoFrameFactoryImplTest, CreateVideoFrameFailsIfUnsupportedFormat)
{
    ...
    auto output_buffer = CodecOutputBuffer::CreateForTesting(0, coded_size, gfx::ColorSpace());
