...
private:
    ...
    struct InputData {
        InputData(Microsoft::WRL::ComPtr<IMFSample>&& sample, const int sample_count, EncoderStatusCB&& done_cb);
        InputData(InputData&&);
        ~InputData();
    ...
    Microsoft::WRL::ComPtr<IMFSample> output_sample_ GUARDED_BY_CONTEXT(sequence_checker_);
