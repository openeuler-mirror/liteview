...
public:
        ...
        ZeroCopyDisabledByWorkaround zero_copy_disabled_by_workaround = ZeroCopyDisabledByWorkaround::kFalse)
    {
        ...
        return TextureSelector::Create(prefs, workarounds, decoder_output_format, hdr_mode, &format_checker_, nullptr, nullptr, media_log.get(), gfx::ColorSpace());
    }
...
{
    AllowFormatCheckerSupportExcept({});
    auto tex_sel = CreateWithDefaultGPUInfo(DXGI_FORMAT_NV12, ZeroCopyEnabled::kTrue, TextureSelector::HDRMode::kSDROnly, ZeroCopyDisabledByWorkaround::kTrue);
...
TEST_F(D3D11TextureSelectorUnittest, P010BindsP010InHDR)
{
    ...
    AllowFormatCheckerSupportExcept({});
    auto tex_sel = CreateWithDefaultGPUInfo(DXGI_FORMAT_P010, ZeroCopyEnabled::kTrue, TextureSelector::HDRMode::kSDROrHDR);
...
TEST_F(D3D11TextureSelectorUnittest, P010CopiesTo16bitRGBInHDR)
{
    ...
    auto tex_sel = CreateWithDefaultGPUInfo(DXGI_FORMAT_P010, ZeroCopyEnabled::kFalse, TextureSelector::HDRMode::kSDROrHDR);
...
TEST_F(D3D11TextureSelectorUnittest, P010CopiesTo10BitRGBInHDR)
{
    ...
    AllowFormatCheckerSupportExcept({ DXGI_FORMAT_P010, DXGI_FORMAT_R16G16B16A16_FLOAT });
    auto tex_sel = CreateWithDefaultGPUInfo(DXGI_FORMAT_P010, ZeroCopyEnabled::kFalse, TextureSelector::HDRMode::kSDROrHDR);
...
TEST_F(D3D11TextureSelectorUnittest, P010CopiesTo8BitInSDR)
{
    ...
    // HDR mode.
    AllowFormatCheckerSupportExcept({});
    auto tex_sel = CreateWithDefaultGPUInfo(DXGI_FORMAT_P010, ZeroCopyEnabled::kTrue, TextureSelector::HDRMode::kSDROnly);
