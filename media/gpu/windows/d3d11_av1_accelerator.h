...
public:
    D3D11AV1Accelerator(D3D11VideoDecoderClient* client, MediaLog* media_log, ComD3D11VideoDevice video_device, std::unique_ptr<VideoContextWrapper> video_context);
...
private:
    ...
    void RecordFailure(const std::string& fail_type, const std::string& message, D3D11Status::Codes reason);
