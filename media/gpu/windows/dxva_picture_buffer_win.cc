...
public:
    ...
    bool CopyTexSubImage(unsigned target, const gfx::Point& offset, const gfx::Rect& rect) override { return false; }
...
void DXVAPictureBuffer::ResetReuseFence() { NOTREACHED(); }
...
gl::GLFence* DXVAPictureBuffer::reuse_fence() { return nullptr; }
...
bool PbufferPictureBuffer::Initialize(const DXVAVideoDecodeAccelerator& decoder, EGLConfig egl_config)
{
    ...
    EGLint attrib_list[] = { EGL_WIDTH, size().width(), EGL_HEIGHT, size().height(), EGL_TEXTURE_FORMAT, use_rgb ? EGL_TEXTURE_RGB : EGL_TEXTURE_RGBA, EGL_TEXTURE_TARGET,
        EGL_TEXTURE_2D, EGL_NONE };
...
gl::GLFence* PbufferPictureBuffer::reuse_fence() { return reuse_fence_.get(); }
...
bool PbufferPictureBuffer::AllowOverlay() const { return false; }

bool PbufferPictureBuffer::CanBindSamples() const { return false; }
...
bool EGLStreamPictureBuffer::AllowOverlay() const { return true; }

bool EGLStreamPictureBuffer::CanBindSamples() const { return true; }
...
bool EGLStreamDelayedCopyPictureBuffer::AllowOverlay() const { return true; }

bool EGLStreamDelayedCopyPictureBuffer::CanBindSamples() const { return true; }
...
bool EGLStreamCopyPictureBuffer::AllowOverlay() const { return true; }

bool EGLStreamCopyPictureBuffer::CanBindSamples() const { return false; }
