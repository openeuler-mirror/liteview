...
public:
    ...
    virtual void SetStreamHDRMetadata(const DXGI_HDR_METADATA_HDR10& stream_metadata);
    virtual void SetDisplayHDRMetadata(const DXGI_HDR_METADATA_HDR10& display_metadata);

    virtual HRESULT VideoProcessorBlt(ID3D11VideoProcessorOutputView* output_view, UINT output_frameno, UINT stream_count, D3D11_VIDEO_PROCESSOR_STREAM* streams);
