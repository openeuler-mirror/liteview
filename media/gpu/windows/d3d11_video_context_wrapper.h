...
public:
    ...
    virtual HRESULT DecoderBeginFrame(ID3D11VideoDecoder* video_decoder, ID3D11VideoDecoderOutputView* output_view, UINT content_key_size, const void* content_key) = 0;
