...
public:
    ...
    static std::unique_ptr<ImageProcessorBackend> Create(scoped_refptr<V4L2Device> device, size_t num_buffers, const PortConfig& input_config, const PortConfig& output_config,
        OutputMode output_mode, VideoRotation relative_rotation, ErrorCB error_cb, scoped_refptr<base::SequencedTaskRunner> backend_task_runner);
    ...
    void Process(scoped_refptr<VideoFrame> input_frame, scoped_refptr<VideoFrame> output_frame, FrameReadyCB cb) override;
    void ProcessLegacy(scoped_refptr<VideoFrame> frame, LegacyFrameReadyCB cb) override;
    void Reset() override;
    ...
    static bool TryOutputFormat(uint32_t input_pixelformat, uint32_t output_pixelformat, const gfx::Size& input_size, gfx::Size* output_size, size_t* num_planes);
...
private:
    ...
    V4L2ImageProcessorBackend(scoped_refptr<base::SequencedTaskRunner> backend_task_runner, scoped_refptr<V4L2Device> device, const PortConfig& input_config,
    ...
    base::small_map<std::map<base::TimeDelta, std::unique_ptr<ScopedDecodeTrace>>> buffer_tracers_ GUARDED_BY_CONTEXT(backend_sequence_checker_);
    ...
    base::WeakPtrFactory<V4L2ImageProcessorBackend> backend_weak_this_factory_ { this };
