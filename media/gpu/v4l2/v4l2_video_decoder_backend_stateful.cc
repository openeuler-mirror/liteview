...
bool V4L2StatefulVideoDecoderBackend::DecodeRequest::IsCompleted() const { return bytes_used == buffer->data_size(); }
...
void V4L2StatefulVideoDecoderBackend::ReuseOutputBufferThunk(
    scoped_refptr<base::SequencedTaskRunner> task_runner, absl::optional<base::WeakPtr<V4L2StatefulVideoDecoderBackend>> weak_this, V4L2ReadableBufferRef buffer)
{
    DVLOGF(3);
    DCHECK(weak_this);
...
bool V4L2StatefulVideoDecoderBackend::StopInputQueueOnResChange() const { return false; }
