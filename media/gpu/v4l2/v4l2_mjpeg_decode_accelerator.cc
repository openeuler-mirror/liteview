...
const uint8_t kDefaultDhtSeg[] = { ,
...
V4L2MjpegDecodeAccelerator::V4L2MjpegDecodeAccelerator(const scoped_refptr<V4L2Device>& device, const scoped_refptr<base::SingleThreadTaskRunner>& io_task_runner)
...
V4L2MjpegDecodeAccelerator::~V4L2MjpegDecodeAccelerator()
{
    ...
    if (decoder_thread_.IsRunning()) {
        decoder_task_runner_->PostTask(FROM_HERE, base::BindOnce(&V4L2MjpegDecodeAccelerator::DestroyTask, base::Unretained(this)));
...
{
    child_task_runner_->PostTask(FROM_HERE, base::BindOnce(&V4L2MjpegDecodeAccelerator::NotifyError, weak_ptr_, task_id, error));
}

void V4L2MjpegDecodeAccelerator::InitializeOnTaskRunner(chromeos_camera::MjpegDecodeAccelerator::Client* client, chromeos_camera::MjpegDecodeAccelerator::InitCB init_cb)
{
    DCHECK(child_task_runner_->BelongsToCurrentThread());
    ...
    decoder_task_runner_->PostTask(FROM_HERE, base::BindOnce(&V4L2MjpegDecodeAccelerator::StartDevicePoll, base::Unretained(this)));

    VLOGF(2) << "V4L2MjpegDecodeAccelerator initialized.";
    std::move(init_cb).Run(true);
}

void V4L2MjpegDecodeAccelerator::InitializeAsync(chromeos_camera::MjpegDecodeAccelerator::Client* client, chromeos_camera::MjpegDecodeAccelerator::InitCB init_cb)
{
    DCHECK(child_task_runner_->BelongsToCurrentThread());
    ...
    child_task_runner_->PostTask(
        FROM_HERE, base::BindOnce(&V4L2MjpegDecodeAccelerator::InitializeOnTaskRunner, weak_factory_.GetWeakPtr(), client, BindToCurrentLoop(std::move(init_cb))));
}
...
void V4L2MjpegDecodeAccelerator::Decode(BitstreamBuffer bitstream_buffer, scoped_refptr<VideoFrame> video_frame)
{
    ...
    decoder_task_runner_->PostTask(FROM_HERE, base::BindOnce(&V4L2MjpegDecodeAccelerator::DecodeTask, base::Unretained(this), std::move(job_record)));
}

void V4L2MjpegDecodeAccelerator::Decode(int32_t task_id, base::ScopedFD src_dmabuf_fd, size_t src_size, off_t src_offset, scoped_refptr<media::VideoFrame> dst_frame)
{
...
size_t V4L2MjpegDecodeAccelerator::InputBufferQueuedCount() { return input_buffer_map_.size() - free_input_buffers_.size(); }

size_t V4L2MjpegDecodeAccelerator::OutputBufferQueuedCount() { return output_buffer_map_.size() - free_output_buffers_.size(); }
...
void V4L2MjpegDecodeAccelerator::DevicePollTask()
{
    ...
    decoder_task_runner_->PostTask(FROM_HERE, base::BindOnce(&V4L2MjpegDecodeAccelerator::ServiceDeviceTask, base::Unretained(this), event_pending));
}
...
bool V4L2MjpegDecodeAccelerator::ConvertOutputImage(const BufferRecord& output_buffer, scoped_refptr<VideoFrame> dst_frame)
{
    ...
    if (output_buffer_num_planes_ == 1 && dst_frame->format() == PIXEL_FORMAT_I420) {
        ...
        if (libyuv::ConvertToI420(static_cast<uint8_t*>(output_buffer.address[0]), src_size, dst_ptrs[0], dst_strides[0], dst_ptrs[1], dst_strides[1], dst_ptrs[2], dst_strides[2],
                0 /*x*/, 0 /*y*/, output_buffer_coded_size_.width(), output_buffer_coded_size_.height(), dst_width, dst_height, libyuv::kRotate0, output_buffer_pixelformat_)) {
    ...
    if (output_buffer_pixelformat_ == V4L2_PIX_FMT_YUV420M) {
        ...
        case PIXEL_FORMAT_I420:
            DCHECK_EQ(dst_frame->layout().num_planes(), 3u);
            if (libyuv::I420Copy(src_ptrs[0], src_strides[0], src_ptrs[1], src_strides[1], src_ptrs[2], src_strides[2], dst_ptrs[0], dst_strides[0], dst_ptrs[1], dst_strides[1],
                    dst_ptrs[2], dst_strides[2], dst_width, dst_height)) {
        ...
        case PIXEL_FORMAT_YV12:
            DCHECK_EQ(dst_frame->layout().num_planes(), 3u);
            if (libyuv::I420Copy(src_ptrs[0], src_strides[0], src_ptrs[1], src_strides[1], src_ptrs[2], src_strides[2], dst_ptrs[0], dst_strides[0], dst_ptrs[2], dst_strides[2],
        ...
        case PIXEL_FORMAT_NV12:
            ...
            if (libyuv::I420ToNV12(src_ptrs[0], src_strides[0], src_ptrs[1], src_strides[1], src_ptrs[2], src_strides[2], dst_ptrs[0], dst_strides[0], dst_ptrs[1], dst_strides[1],
        ...
        case PIXEL_FORMAT_I420:
            DCHECK_EQ(dst_frame->layout().num_planes(), 3u);
            if (libyuv::I422ToI420(src_ptrs[0], src_strides[0], src_ptrs[1], src_strides[1], src_ptrs[2], src_strides[2], dst_ptrs[0], dst_strides[0], dst_ptrs[1], dst_strides[1],
                    dst_ptrs[2], dst_strides[2], dst_width, dst_height)) {
        ...
        case PIXEL_FORMAT_YV12:
            DCHECK_EQ(dst_frame->layout().num_planes(), 3u);
            if (libyuv::I422ToI420(src_ptrs[0], src_strides[0], src_ptrs[1], src_strides[1], src_ptrs[2], src_strides[2], dst_ptrs[0], dst_strides[0], dst_ptrs[2], dst_strides[2],
                    dst_ptrs[1], dst_strides[1], dst_width, dst_height)) {
                VLOGF(1) << "I422ToI420 failed";
                return false;
            }
        ...
        case PIXEL_FORMAT_NV12:
            DCHECK_EQ(dst_frame->layout().num_planes(), 2u);
            if (libyuv::I422ToNV21(src_ptrs[0], src_strides[0], src_ptrs[2], src_strides[2], src_ptrs[1], src_strides[1], dst_ptrs[0], dst_strides[0], dst_ptrs[1], dst_strides[1],
                    dst_width, dst_height)) {
...
void V4L2MjpegDecodeAccelerator::Dequeue()
{
    ...
    while (!running_jobs_.empty() && OutputBufferQueuedCount() > 0) {
        ...
        if (dqbuf.flags & V4L2_BUF_FLAG_ERROR) {
            ...
            job_record.reset();
            child_task_runner_->PostTask(FROM_HERE, base::BindOnce(&V4L2MjpegDecodeAccelerator::VideoFrameReady, weak_ptr_, task_id));
        }
    }
}

static bool AddHuffmanTable(const void* input_ptr, size_t input_size, void* output_ptr, size_t output_size)
{
    DCHECK(input_ptr);
    DCHECK(output_ptr);
    DCHECK_LE((input_size + sizeof(kDefaultDhtSeg)), output_size);

    base::BigEndianReader reader(static_cast<const uint8_t*>(input_ptr), input_size);
    ...
    while (!has_marker_sos && !has_marker_dht) {
        ...
        case JPEG_SOS: {
            if (!has_marker_dht) {
                memcpy(static_cast<uint8_t*>(output_ptr) + current_offset, kDefaultDhtSeg, sizeof(kDefaultDhtSeg));
        ...
        memcpy(static_cast<uint8_t*>(output_ptr) + current_offset, start_addr, segment_size);
        current_offset += segment_size;
    }
    if (reader.remaining()) {
        memcpy(static_cast<uint8_t*>(output_ptr) + current_offset, reader.ptr(), reader.remaining());
    }
    return true;
}
...
bool V4L2MjpegDecodeAccelerator::EnqueueInputRecord()
{
    ...
    if (!AddHuffmanTable(job_record->memory(), job_record->size(), input_record.address[0], input_record.length[0])) {
