...
int main(int argc, char** argv)
{
    ...
    for (int i = 0; i < n_frames || n_frames == 0; i++) {
        ...
        gfx::Size size;
        const VideoDecoder::Result res = dec->DecodeNextFrame(y_plane, u_plane, v_plane, size, i);
        ...
        base::FilePath filename(base::StringPrintf("%s%.6d.yuv", output_file_prefix.c_str(), i));
