...
std::unique_ptr<ImageProcessor> CreateImageProcessor(const Fourcc vda_output_format, const Fourcc ip_output_format, const gfx::Size& vda_output_coded_size,
    ...
    scoped_refptr<V4L2Device> image_processor_device, ImageProcessor::OutputMode image_processor_output_mode, scoped_refptr<base::SequencedTaskRunner> client_task_runner,
    ImageProcessor::ErrorCB error_cb)
{
    ...
    auto image_processor = ImageProcessor::Create(base::BindRepeating(&V4L2ImageProcessorBackend::Create, image_processor_device, nb_buffers),
        ...
        ImageProcessor::PortConfig(ip_output_format, ip_output_coded_size, {}, visible_rect, { output_storage_type }), image_processor_output_mode, VIDEO_ROTATION_0,
...
gfx::Size NativePixmapSizeFromHandle(const gfx::NativePixmapHandle& handle, const Fourcc fourcc, const gfx::Size& current_size)
{
    ...
    int adjusted_coded_height = handle.planes.size() > 1 && handle.planes[1].offset != 0 ? handle.planes[1].offset / adjusted_coded_width : current_size.height();
...
bool InputBufferFragmentSplitter::IsPartialFramePending() const { return false; }
...
bool H264InputBufferFragmentSplitter::IsPartialFramePending() const { return partial_frame_pending_; }
