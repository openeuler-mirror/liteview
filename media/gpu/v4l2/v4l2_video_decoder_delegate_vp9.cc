...
private:
    ...
    scoped_refptr<VP9Picture> CreateDuplicate() override { return new V4L2VP9Picture(dec_surface_); }
...
DecodeStatus V4L2VideoDecoderDelegateVP9::SubmitDecode(scoped_refptr<VP9Picture> pic, const Vp9SegmentationParams& segm_params, const Vp9LoopFilterParams& lf_params,
    const Vp9ReferenceFrameVector& ref_frames, base::OnceClosure done_cb)
{
...
bool V4L2VideoDecoderDelegateVP9::GetFrameContext(scoped_refptr<VP9Picture> pic, Vp9FrameContext* frame_ctx)
{
    NOTIMPLEMENTED() << "Frame context update not supported";
    return false;
}

bool V4L2VideoDecoderDelegateVP9::NeedsCompressedHeaderParsed() const { return supports_compressed_header_; }

bool V4L2VideoDecoderDelegateVP9::SupportsContextProbabilityReadback() const { return false; }
