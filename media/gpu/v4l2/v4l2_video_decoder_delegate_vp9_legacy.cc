...
DecodeStatus V4L2VideoDecoderDelegateVP9Legacy::SubmitDecode(scoped_refptr<VP9Picture> pic, const Vp9SegmentationParams& segm_params, const Vp9LoopFilterParams& lf_params,
...
#undef SET_V4L2_FRM_HDR_FLAG_IF
    ...
    static_assert(std::extent<decltype(v4l2_decode_param.active_ref_frames)>() == std::extent<decltype(frame_hdr->ref_frame_idx)>(), "active reference frame array sizes mismatch");
...
bool V4L2VideoDecoderDelegateVP9Legacy::NeedsCompressedHeaderParsed() const { return device_needs_compressed_header_parsed_; }

bool V4L2VideoDecoderDelegateVP9Legacy::SupportsContextProbabilityReadback() const { return true; }
