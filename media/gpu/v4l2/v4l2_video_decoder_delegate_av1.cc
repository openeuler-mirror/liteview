...
public:
    ...
    const scoped_refptr<V4L2DecodeSurface>& dec_surface() const { return dec_surface_; }

private:
    ~V4L2AV1Picture() override = default;

    scoped_refptr<AV1Picture> CreateDuplicate() override { return new V4L2AV1Picture(dec_surface_); }
...
void FillSequenceParams(v4l2_ctrl_av1_sequence& v4l2_seq_params, const libgav1::ObuSequenceHeader& seq_header)
{
...
void FillQuantizerIndexDeltaParams(struct v4l2_av1_quantization& v4l2_quant, const libgav1::ObuSequenceHeader& seq_header, const libgav1::ObuFrameHeader& frm_header)
{
...
DecodeStatus V4L2VideoDecoderDelegateAV1::SubmitDecode(const AV1Picture& pic, const libgav1::ObuSequenceHeader& sequence_header, const AV1ReferenceFrameVector& ref_frames,
    const libgav1::Vector<libgav1::TileBuffer>& tile_buffers, base::span<const uint8_t> data)
{
    ...
    FillCdefParams(v4l2_cdef, frame_header.cdef, base::strict_cast<int8_t>(color_bitdepth));
    ...
    v4l2_frame_params.last_frame_idx = frame_header.reference_frame_index[libgav1::kReferenceFrameLast];
    v4l2_frame_params.gold_frame_idx = frame_header.reference_frame_index[libgav1::kReferenceFrameGolden];
    ...
    for (size_t i = 0; i < libgav1::kNumInterReferenceFrameTypes; i++)
        v4l2_frame_params.ref_frame_idx[i] = base::checked_cast<__u8>(frame_header.reference_frame_index[i]);
