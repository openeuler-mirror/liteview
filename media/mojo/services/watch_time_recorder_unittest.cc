...
public:
    WatchTimeRecorderTest()
        : computation_keys_(
            { WatchTimeKey::kAudioSrc, WatchTimeKey::kAudioMse, WatchTimeKey::kAudioEme, WatchTimeKey::kAudioVideoSrc, WatchTimeKey::kAudioVideoMse, WatchTimeKey::kAudioVideoEme })
        , mtbr_keys_({ kMeanTimeBetweenRebuffersAudioSrc, kMeanTimeBetweenRebuffersAudioMse, kMeanTimeBetweenRebuffersAudioEme, kMeanTimeBetweenRebuffersAudioVideoSrc,
              kMeanTimeBetweenRebuffersAudioVideoMse, kMeanTimeBetweenRebuffersAudioVideoEme })
        ...
        , discard_keys_({ kDiscardedWatchTimeAudioSrc, kDiscardedWatchTimeAudioMse, kDiscardedWatchTimeAudioEme, kDiscardedWatchTimeAudioVideoSrc, kDiscardedWatchTimeAudioVideoMse,
              kDiscardedWatchTimeAudioVideoEme })
    {
        source_id_ = test_recorder_->GetNewSourceID();
        ResetMetricRecorders();
        MediaMetricsProvider::Create(MediaMetricsProvider::BrowsingMode::kIncognito, MediaMetricsProvider::FrameStatus::kTopFrame, GetSourceId(), learning::FeatureValue(0),
            VideoDecodePerfHistory::SaveCallback(), MediaMetricsProvider::GetLearningSessionCallback(),
            base::BindRepeating(&WatchTimeRecorderTest::GetRecordAggregateWatchTimeCallback, base::Unretained(this)),
    ...
    {
        provider_->Initialize(properties->is_mse, properties->is_mse ? mojom::MediaURLScheme::kUnknown : mojom::MediaURLScheme::kHttp, properties->media_stream_type);
    ...
    {
        Initialize(mojom::PlaybackProperties::New(has_audio, has_video, false, false, is_mse, is_encrypted, false, media_stream_type));
    }

    void ExpectWatchTime(const std::vector<base::StringPiece>& keys, base::TimeDelta value)
    {
        for (int i = 0; i <= static_cast<int>(WatchTimeKey::kWatchTimeKeyMax); ++i) {
            const base::StringPiece test_key = ConvertWatchTimeKeyToStringForUma(static_cast<WatchTimeKey>(i));
            if (test_key.empty())
                continue;
    ...
    void ExpectHelper(const std::vector<base::StringPiece>& full_key_list, const std::vector<base::StringPiece>& keys, int64_t value)
    {
    ...
    void ExpectMtbrTime(const std::vector<base::StringPiece>& keys, base::TimeDelta value) { ExpectHelper(mtbr_keys_, keys, value.InMilliseconds()); }

    void ExpectZeroRebuffers(const std::vector<base::StringPiece>& keys) { ExpectHelper(smooth_keys_, keys, 0); }

    void ExpectRebuffers(const std::vector<base::StringPiece>& keys, int count) { ExpectHelper(smooth_keys_, keys, count); }
    ...
    void ExpectUkmWatchTime(const std::vector<base::StringPiece>& keys, base::TimeDelta value)
    {
    ...
    {
        return mojom::SecondaryPlaybackProperties::New(AudioCodec::kAAC, VideoCodec::kH264, AudioCodecProfile::kUnknown, H264PROFILE_MAIN, AudioDecoderType::kUnknown,
            VideoDecoderType::kUnknown, EncryptionScheme::kUnencrypted, EncryptionScheme::kUnencrypted, gfx::Size(800, 600));
    }

    ukm::SourceId GetSourceId() { return source_id_; }

    MediaMetricsProvider::RecordAggregateWatchTimeCallback GetRecordAggregateWatchTimeCallback()
    {
        return base::BindRepeating(
            [](base::WeakPtr<content::RenderFrameHostDelegate> delegate, GURL last_committed_url, base::TimeDelta total_watch_time, base::TimeDelta time_stamp, bool has_video,
                bool has_audio) {
...
{
    mojom::PlaybackPropertiesPtr properties = mojom::PlaybackProperties::New(true, true, false, false, false, false, false, mojom::MediaStreamType::kNone);
...
{
    mojom::PlaybackPropertiesPtr properties = mojom::PlaybackProperties::New(true, true, false, false, false, false, false, mojom::MediaStreamType::kNone);
    mojom::SecondaryPlaybackPropertiesPtr secondary_properties = mojom::SecondaryPlaybackProperties::New(AudioCodec::kAAC, VideoCodec::kH264, AudioCodecProfile::kXHE_AAC,
        H264PROFILE_MAIN, AudioDecoderType::kUnknown, VideoDecoderType::kUnknown, EncryptionScheme::kCenc, EncryptionScheme::kCbcs, gfx::Size(800, 600));
    Initialize(properties.Clone());
    wtr_->UpdateSecondaryProperties(secondary_properties.Clone());
...
{
    mojom::PlaybackPropertiesPtr properties = mojom::PlaybackProperties::New(true, true, false, false, true, true, false, mojom::MediaStreamType::kNone);
    mojom::SecondaryPlaybackPropertiesPtr secondary_properties = mojom::SecondaryPlaybackProperties::New(AudioCodec::kOpus, VideoCodec::kVP9, AudioCodecProfile::kUnknown,
        VP9PROFILE_PROFILE0, AudioDecoderType::kUnknown, VideoDecoderType::kUnknown, EncryptionScheme::kUnencrypted, EncryptionScheme::kUnencrypted, gfx::Size(800, 600));
    Initialize(properties.Clone());
    wtr_->UpdateSecondaryProperties(secondary_properties.Clone());
...
{
    mojom::PlaybackPropertiesPtr properties = mojom::PlaybackProperties::New(true, true, true, true, false, false, false, mojom::MediaStreamType::kNone);
    mojom::SecondaryPlaybackPropertiesPtr secondary_properties = CreateSecondaryProperties();
    Initialize(properties.Clone());
    wtr_->UpdateSecondaryProperties(secondary_properties.Clone());
...
TEST_F(WatchTimeRecorderTest, BasicUkmMediaStreamType)
{
    ...
    for (const auto& media_stream_type : media_stream_types) {
        mojom::PlaybackPropertiesPtr properties = mojom::PlaybackProperties::New(true, true, false, false, false, false, false, media_stream_type);
        Initialize(properties.Clone());
        wtr_->UpdateSecondaryProperties(CreateSecondaryProperties());
...
{
    mojom::PlaybackPropertiesPtr properties = mojom::PlaybackProperties::New(true, true, false, false, true, true, false, mojom::MediaStreamType::kNone);
    mojom::SecondaryPlaybackPropertiesPtr secondary_properties1 = mojom::SecondaryPlaybackProperties::New(AudioCodec::kUnknown, VideoCodec::kUnknown, AudioCodecProfile::kUnknown,
        VIDEO_CODEC_PROFILE_UNKNOWN, AudioDecoderType::kUnknown, VideoDecoderType::kUnknown, EncryptionScheme::kUnencrypted, EncryptionScheme::kUnencrypted, gfx::Size(800, 600));
    Initialize(properties.Clone());
    ...
    mojom::SecondaryPlaybackPropertiesPtr secondary_properties2 = mojom::SecondaryPlaybackProperties::New(AudioCodec::kAAC, VideoCodec::kH264, AudioCodecProfile::kXHE_AAC,
        H264PROFILE_MAIN, AudioDecoderType::kFFmpeg, VideoDecoderType::kFFmpeg, EncryptionScheme::kUnencrypted, EncryptionScheme::kUnencrypted, gfx::Size(800, 600));
...
{
    mojom::PlaybackPropertiesPtr properties = mojom::PlaybackProperties::New(true, true, false, false, true, true, false, mojom::MediaStreamType::kNone);
    mojom::SecondaryPlaybackPropertiesPtr secondary_properties1 = mojom::SecondaryPlaybackProperties::New(AudioCodec::kOpus, VideoCodec::kVP9, AudioCodecProfile::kUnknown,
        VP9PROFILE_PROFILE0, AudioDecoderType::kMojo, VideoDecoderType::kMojo, EncryptionScheme::kUnencrypted, EncryptionScheme::kUnencrypted, gfx::Size(400, 300));
    Initialize(properties.Clone());
    wtr_->UpdateSecondaryProperties(secondary_properties1.Clone());
    ...
    mojom::SecondaryPlaybackPropertiesPtr secondary_properties2 = mojom::SecondaryPlaybackProperties::New(AudioCodec::kAAC, VideoCodec::kH264, AudioCodecProfile::kUnknown,
        H264PROFILE_MAIN, AudioDecoderType::kFFmpeg, VideoDecoderType::kFFmpeg, EncryptionScheme::kCenc, EncryptionScheme::kCenc, gfx::Size(800, 600));
    wtr_->UpdateSecondaryProperties(secondary_properties2.Clone());
...
TEST_F(WatchTimeRecorderTest, MultipleSecondaryPropertiesWithFinalize)
{
    mojom::PlaybackPropertiesPtr properties = mojom::PlaybackProperties::New(true, true, false, false, true, true, false, mojom::MediaStreamType::kNone);
    mojom::SecondaryPlaybackPropertiesPtr secondary_properties1 = mojom::SecondaryPlaybackProperties::New(AudioCodec::kOpus, VideoCodec::kVP9, AudioCodecProfile::kUnknown,
        VP9PROFILE_PROFILE0, AudioDecoderType::kMojo, VideoDecoderType::kMojo, EncryptionScheme::kCbcs, EncryptionScheme::kCbcs, gfx::Size(400, 300));
    Initialize(properties.Clone());
    wtr_->UpdateSecondaryProperties(secondary_properties1.Clone());
