...
public:
        ...
        mojom::MediaStreamType media_stream_type = mojom::MediaStreamType::kNone)
    {
        ...
        MediaMetricsProvider::Create((is_incognito ? MediaMetricsProvider::BrowsingMode::kIncognito : MediaMetricsProvider::BrowsingMode::kNormal),
            (is_top_frame ? MediaMetricsProvider::FrameStatus::kTopFrame : MediaMetricsProvider::FrameStatus::kNotTopFrame), GetSourceId(), learning::FeatureValue(0),
            VideoDecodePerfHistory::SaveCallback(), MediaMetricsProvider::GetLearningSessionCallback(),
            base::BindRepeating(&MediaMetricsProviderTest::GetRecordAggregateWatchTimeCallback, base::Unretained(this)),
    ...
    MediaMetricsProvider::RecordAggregateWatchTimeCallback GetRecordAggregateWatchTimeCallback() { return base::NullCallback(); }
