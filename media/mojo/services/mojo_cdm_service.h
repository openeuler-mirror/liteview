...
public:
    ...
    using InitializeCB = base::OnceCallback<void(mojom::CdmContextPtr cdm_context, const std::string& error_message)>;
    ...
    void CreateSessionAndGenerateRequest(
        CdmSessionType session_type, EmeInitDataType init_data_type, const std::vector<uint8_t>& init_data, CreateSessionAndGenerateRequestCallback callback) final;
...
private:
    ...
    void OnCdmCreated(InitializeCB callback, const scoped_refptr<::media::ContentDecryptionModule>& cdm, const std::string& error_message);
