...
public:
    using RecordAggregateWatchTimeCallback = base::OnceCallback<void(base::TimeDelta total_watch_time, base::TimeDelta time_stamp, bool has_video, bool has_audio)>;

    WatchTimeRecorder(mojom::PlaybackPropertiesPtr properties, ukm::SourceId source_id, bool is_top_frame, uint64_t player_id, RecordAggregateWatchTimeCallback record_playback_cb);
...
private:
    ...
    struct ExtendedMetricsKeyMap {
        ...
        ExtendedMetricsKeyMap(WatchTimeKey watch_time_key, base::StringPiece mtbr_key, base::StringPiece smooth_rate_key, base::StringPiece discard_key);
