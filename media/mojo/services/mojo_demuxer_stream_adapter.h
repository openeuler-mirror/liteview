...
private:
    void OnStreamReady(Type type, mojo::ScopedDataPipeConsumerHandle consumer_handle, const absl::optional<AudioDecoderConfig>& audio_config,
    ...
    void UpdateConfig(const absl::optional<AudioDecoderConfig>& audio_config, const absl::optional<VideoDecoderConfig>& video_config);
