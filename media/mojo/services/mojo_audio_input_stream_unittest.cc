...
std::unique_ptr<AudioInputDelegate> CreateNoDelegate(AudioInputDelegate::EventHandler* event_handler) { return nullptr; }
...
public:
    ...
    mojo::Remote<mojom::AudioInputStream> CreateAudioInput()
    {
        ...
        impl_ = std::make_unique<MojoAudioInputStream>(stream.BindNewPipeAndPassReceiver(), client_receiver_.BindNewPipeAndPassRemote(),
            base::BindOnce(&MockDelegateFactory::CreateDelegate, base::Unretained(&mock_delegate_factory_)), base::BindOnce(&MockClient::Initialized, base::Unretained(&client_)),
