...
public:
    ...
    public:
        ...
        void CreateOverlay(
            mojo::PendingReceiver<mojom::AndroidOverlay> overlay_receiver, mojo::PendingRemote<mojom::AndroidOverlayClient> client, mojom::AndroidOverlayConfigPtr config) override
        {
...
public:
    ...
    void CreateSurface()
    {
        ...
        surface_key_ = gpu::GpuSurfaceTracker::Get()->AddSurfaceForNativeWidget(
            gpu::GpuSurfaceTracker::SurfaceRecord(gfx::kNullAcceleratedWidget, surface_.j_surface(), false /* can_be_used_with_surface_control */));
