...
public:
    ...
    MojoCdm(mojo::Remote<mojom::ContentDecryptionModule> remote_cdm, media::mojom::CdmContextPtr cdm_context, const SessionMessageCB& session_message_cb,
    ...
    void CreateSessionAndGenerateRequest(
        CdmSessionType session_type, EmeInitDataType init_data_type, const std::vector<uint8_t>& init_data, std::unique_ptr<NewSessionCdmPromise> promise) final;
