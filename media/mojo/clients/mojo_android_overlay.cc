...
const base::android::JavaRef<jobject>& MojoAndroidOverlay::GetJavaSurface() const { return surface_.j_surface(); }
...
void MojoAndroidOverlay::OnSurfaceReady(uint64_t surface_key)
{
    ...
    surface_ = gpu::GpuSurfaceLookup::GetInstance()->AcquireJavaSurface(surface_key, &can_be_used_with_surface_control);
