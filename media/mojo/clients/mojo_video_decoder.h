...
public:
    ...
    void Initialize(const VideoDecoderConfig& config, bool low_delay, CdmContext* cdm_context, InitCB init_cb, const OutputCB& output_cb, const WaitingCB& waiting_cb) final;
    ...
    void set_writer_capacity_for_testing(uint32_t capacity) { writer_capacity_ = capacity; }
...
private:
    ...
    void InitializeRemoteDecoder(const VideoDecoderConfig& config, bool low_delay, absl::optional<base::UnguessableToken> cdm_id);
