...
MojoRenderer::MojoRenderer(const scoped_refptr<base::SingleThreadTaskRunner>& task_runner, std::unique_ptr<VideoOverlayFactory> video_overlay_factory,
...
void MojoRenderer::InitializeRendererFromStreams(media::RendererClient* client)
{
    ...
    remote_renderer_->Initialize(
        client_receiver_.BindNewEndpointAndPassRemote(), std::move(stream_proxies), nullptr, base::BindOnce(&MojoRenderer::OnInitialized, base::Unretained(this), client));
}
...
void MojoRenderer::InitializeRendererFromUrl(media::RendererClient* client)
{
    ...
    mojom::MediaUrlParamsPtr media_url_params
        = mojom::MediaUrlParams::New(url_params.media_url, url_params.site_for_cookies, url_params.top_frame_origin, url_params.allow_credentials, url_params.is_hls);
    remote_renderer_->Initialize(
        client_receiver_.BindNewEndpointAndPassRemote(), absl::nullopt, std::move(media_url_params), base::BindOnce(&MojoRenderer::OnInitialized, base::Unretained(this), client));
}
...
void MojoRenderer::SetLatencyHint(absl::optional<base::TimeDelta> latency_hint)
{
