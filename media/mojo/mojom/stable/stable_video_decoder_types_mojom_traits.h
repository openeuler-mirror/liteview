...
template <> struct StructTraits<media::stable::mojom::ColorVolumeMetadataDataView, gfx::ColorVolumeMetadata> {
    ...
    static bool Read(media::stable::mojom::ColorVolumeMetadataDataView data, gfx::ColorVolumeMetadata* output);
};

template <> struct StructTraits<media::stable::mojom::DecoderBufferDataView, scoped_refptr<media::DecoderBuffer>> {
    static bool IsNull(const scoped_refptr<media::DecoderBuffer>& input) { return !input; }

    static void SetToNull(scoped_refptr<media::DecoderBuffer>* input) { *input = nullptr; }
    ...
    static std::vector<uint8_t> side_data(const scoped_refptr<media::DecoderBuffer>& input);
...
template <> struct StructTraits<media::stable::mojom::DecryptConfigDataView, std::unique_ptr<media::DecryptConfig>> {
    static bool IsNull(const std::unique_ptr<media::DecryptConfig>& input) { return !input; }

    static void SetToNull(std::unique_ptr<media::DecryptConfig>* output) { output->reset(); }
    ...
    static const absl::optional<media::EncryptionPattern>& encryption_pattern(const std::unique_ptr<media::DecryptConfig>& input);
...
template <> struct StructTraits<media::stable::mojom::HDRMetadataDataView, gfx::HDRMetadata> {
    ...
    static const gfx::ColorVolumeMetadata& color_volume_metadata(const gfx::HDRMetadata& input);
...
template <> struct StructTraits<media::stable::mojom::StatusDataDataView, media::internal::StatusData> {
    ...
    static base::span<const base::Value> frames(const media::internal::StatusData& input);

    static absl::optional<media::internal::StatusData> cause(const media::internal::StatusData& input);
...
template <> struct StructTraits<media::stable::mojom::VideoDecoderConfigDataView, media::VideoDecoderConfig> {
    ...
    static const absl::optional<gfx::HDRMetadata>& hdr_metadata(const media::VideoDecoderConfig& input);
...
template <> struct StructTraits<media::stable::mojom::VideoFrameDataView, scoped_refptr<media::VideoFrame>> {
    static bool IsNull(const scoped_refptr<media::VideoFrame>& input) { return !input; }

    static void SetToNull(scoped_refptr<media::VideoFrame>* input) { *input = nullptr; }
    ...
    static const absl::optional<gfx::HDRMetadata>& hdr_metadata(const scoped_refptr<media::VideoFrame>& input);

    static media::stable::mojom::VideoFrameDataPtr data(const scoped_refptr<media::VideoFrame>& input);

    static const media::VideoFrameMetadata& metadata(const scoped_refptr<media::VideoFrame>& input);

    static bool Read(media::stable::mojom::VideoFrameDataView input, scoped_refptr<media::VideoFrame>* output);
};
