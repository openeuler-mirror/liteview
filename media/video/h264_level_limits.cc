...
uint32_t H264LevelToMaxMBPS(uint8_t level) { return LevelToLevelLimits(level).max_mbps; }

uint32_t H264LevelToMaxFS(uint8_t level) { return LevelToLevelLimits(level).max_fs; }

uint32_t H264LevelToMaxDpbMbs(uint8_t level) { return LevelToLevelLimits(level).max_dpb_mbs; }
