...
{
    SupportedVideoDecoderConfig config2(supported_config_.profile_min, supported_config_.profile_max, supported_config_.coded_size_min, supported_config_.coded_size_max,
