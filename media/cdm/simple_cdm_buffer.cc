...
void SimpleCdmBuffer::Destroy() { delete this; }

uint32_t SimpleCdmBuffer::Capacity() const { return buffer_.size(); }

uint8_t* SimpleCdmBuffer::Data() { return buffer_.data(); }
...
uint32_t SimpleCdmBuffer::Size() const { return size_; }
