...
private:
    ...
    void WriteUpdatedEntry(PendingOperations::Id op_id, const VideoDescKey& key, const VideoStats& new_video_stats, AppendVideoStatsCB append_done_cb, bool read_success,
    ...
    void OnGotVideoStatsCollection(
        PendingOperations::Id op_id, GetVideoStatsCollectionCB get_stats_cb, bool success, std::unique_ptr<std::map<std::string, WebrtcVideoStatsEntryProto>> stats_proto);
    ...
    void set_wall_clock_for_test(const base::Clock* tick_clock) { wall_clock_ = tick_clock; }
