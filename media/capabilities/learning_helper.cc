...
LearningHelper::LearningHelper(FeatureProviderFactoryCB feature_factory)
{
    ...
    // do it here.
    learning_session_
        = std::make_unique<LearningSessionImpl>(base::ThreadPool::CreateSequencedTaskRunner({ base::TaskPriority::BEST_EFFORT, base::TaskShutdownBehavior::SKIP_ON_SHUTDOWN }));
...
void LearningHelper::AppendStats(const VideoDecodeStatsDB::VideoDescKey& video_key, learning::FeatureValue origin, const VideoDecodeStatsDB::DecodeStatsEntry& new_stats)
{
