...
const int kSizeBuckets[] = { 50, 100, 144, 240, 256, 280, 360, 426, 480, 640, 720, 854, 960, 1080, 1280, 1440, 1920, 2160, 2560, 2880, 3160, 3840, 4128, 4320, 5120, 6144, 7360,
    7680, 8000, 9000, 10000, 11000, 11520 };
...
constexpr int kWebrtcPixelsBoundaries[]
    = { (kWebrtcPixelsBuckets[0] + kWebrtcPixelsBuckets[1]) / 2, (kWebrtcPixelsBuckets[1] + kWebrtcPixelsBuckets[2]) / 2, (kWebrtcPixelsBuckets[2] + kWebrtcPixelsBuckets[3]) / 2 };
...
int GetWebrtcPixelsBucket(int pixels) { return kWebrtcPixelsBuckets[GetWebrtcPixelsBucketIndex(pixels)]; }
