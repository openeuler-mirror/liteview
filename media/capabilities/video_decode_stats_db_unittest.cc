...
VideoDecodeStatsDB::VideoDescKey MakeKey(VideoCodecProfile codec_profile, const gfx::Size& size, int frame_rate, std::string key_system, bool use_hw_secure_codecs)
{
...
TEST(VideoDecodeStatsDBTest, KeySerialization)
{
    ...
    auto keyB = MakeKey(H264PROFILE_BASELINE, gfx::Size(1280, 720), 30, "org.w3.clearkey", false);
