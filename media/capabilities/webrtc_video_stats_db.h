...
public:
    ...
    using GetVideoStatsCB = base::OnceCallback<void(bool, absl::optional<VideoStatsEntry>)>;
    ...
    using GetVideoStatsCollectionCB = base::OnceCallback<void(bool, absl::optional<VideoStatsCollection>)>;
