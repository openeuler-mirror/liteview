...
MATCHER(UnexpectedProjectionId, "") { return CONTAINS_STRING(arg, "Unexpected id in Projection: 0x"); }

MATCHER(UnexpectedProjectionType, "") { return CONTAINS_STRING(arg, "Unexpected value for ProjectionType: 0x"); }

MATCHER(UnexpectedMultipleValuesForProjectionType, "") { return CONTAINS_STRING(arg, "Multiple values for id: 0x7671"); }

MATCHER(UnexpectedMultipleValuesForYaw, "") { return CONTAINS_STRING(arg, "Multiple values for id: 0x7673"); }

MATCHER(UnexpectedMultipleValuesForPitch, "") { return CONTAINS_STRING(arg, "Multiple values for id: 0x7674"); }

MATCHER(UnexpectedMultipleValuesForRoll, "") { return CONTAINS_STRING(arg, "Multiple values for id: 0x7675"); }

MATCHER(UnexpectedProjectionYaw, "") { return CONTAINS_STRING(arg, "Value not within valid range. id: 0x7673 val:"); }

MATCHER(UnexpectedProjectionPitch, "") { return CONTAINS_STRING(arg, "Value not within valid range. id: 0x7674 val:"); }

MATCHER(UnexpectedProjectionRoll, "") { return CONTAINS_STRING(arg, "Value not within valid range. id: 0x7675 val:"); }

MATCHER(MissingProjectionType, "") { return CONTAINS_STRING(arg, "Projection element is incomplete; ProjectionType required."); }

MATCHER(MissingProjectionPoseYaw, "") { return CONTAINS_STRING(arg, "Projection element is incomplete; ProjectionPoseYaw required."); }

MATCHER(MissingProjectionPosePitch, "") { return CONTAINS_STRING(arg, "Projection element is incomplete; ProjectionPosePitch required."); }

MATCHER(MissingProjectionPoseRoll, "") { return CONTAINS_STRING(arg, "Projection element is incomplete; ProjectionPoseRoll required."); }
...
public:
    ...
    bool OnUInt(int id, int64_t val) { return projection_parser_.OnUInt(id, val); }

    bool OnFloat(int id, double val) { return projection_parser_.OnFloat(id, val); }

    WebMParserClient* VideoClientOnListStart(int id) { return webm_video_client_.OnListStart(id); }

    void VideoClientOnListEnd(int id) { webm_video_client_.OnListEnd(id); }

    bool VideoClientOnUInt(int id, int64_t val) { return webm_video_client_.OnUInt(id, val); }
