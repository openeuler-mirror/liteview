...
protected:
    void ParseWebMFile(const std::string& filename, const StreamParser::InitParameters& expected_params)
    {
        ...
        Demuxer::EncryptedMediaInitDataCB encrypted_media_init_data_cb = base::BindRepeating(&WebMStreamParserTest::OnEncryptedMediaInitData, base::Unretained(this));
        ...
        parser_->Init(base::BindOnce(&WebMStreamParserTest::InitF, base::Unretained(this), expected_params),
            base::BindRepeating(&WebMStreamParserTest::NewConfigCB, base::Unretained(this)), base::BindRepeating(&WebMStreamParserTest::NewBuffersCB, base::Unretained(this)),
            false, // don't ignore_text_track
            encrypted_media_init_data_cb, base::BindRepeating(&WebMStreamParserTest::NewMediaSegmentCB, base::Unretained(this)),
    ...
    bool NewConfigCB(std::unique_ptr<MediaTracks> tracks, const StreamParser::TextTrackConfigMap& text_track_map)
    {
        DCHECK(tracks.get());
