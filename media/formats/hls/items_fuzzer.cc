...
bool IsSubstring(base::StringPiece sub, base::StringPiece base) { return base.data() <= sub.data() && base.data() + base.size() >= sub.data() + sub.size(); }

absl::optional<media::hls::SourceString> GetItemContent(media::hls::TagItem tag)
{
...
absl::optional<media::hls::SourceString> GetItemContent(media::hls::UriItem uri) { return uri.content; }

size_t GetItemLineNumber(media::hls::TagItem tag) { return tag.GetLineNumber(); }

size_t GetItemLineNumber(media::hls::UriItem uri) { return uri.content.Line(); }
