...
constexpr TagKind GetTagKind(CommonTagName) { return TagKind::kCommonTag; }

constexpr TagName ToTagName(CommonTagName name) { return static_cast<TagName>(name); }

constexpr TagKind GetTagKind(MultivariantPlaylistTagName) { return TagKind::kMultivariantPlaylistTag; }

constexpr TagName ToTagName(MultivariantPlaylistTagName name) { return static_cast<TagName>(name); }

constexpr TagKind GetTagKind(MediaPlaylistTagName) { return TagKind::kMediaPlaylistTag; }

constexpr TagName ToTagName(MediaPlaylistTagName name) { return static_cast<TagName>(name); }

MEDIA_EXPORT TagKind GetTagKind(TagName name);

// No-op conversion function for generic code.
constexpr TagName ToTagName(TagName name) { return name; }
