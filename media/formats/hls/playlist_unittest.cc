...
{
    constexpr auto ok_test = [](types::DecimalInteger version, Playlist::Kind kind, base::StringPiece src, const base::Location& from = base::Location::Current()) {
    ...
    constexpr auto error_test = [](ParseStatusCode expected_error, base::StringPiece src, const base::Location& from = base::Location::Current()) {
        auto result = Playlist::IdentifyPlaylist(src);
