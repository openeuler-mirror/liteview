...
// implementation.
types::DecimalInteger MaxSeconds() { return base::TimeDelta::FiniteMax().InSeconds(); }

template <typename T> void ErrorTest(absl::optional<base::StringPiece> content, ParseStatusCode expected_status, const base::Location& from = base::Location::Current())
{
...
template <typename T>
void ErrorTest(absl::optional<base::StringPiece> content, const VariableDictionary& variable_dict, VariableDictionary::SubstitutionBuffer& sub_buffer,
...
template <typename T> OkTestResult<T> OkTest(absl::optional<std::string> content, const base::Location& from = base::Location::Current())
{
...
template <typename T>
OkTestResult<T> OkTest(absl::optional<std::string> content, const VariableDictionary& variable_dict, VariableDictionary::SubstitutionBuffer& sub_buffer,
...
void RunTagIdenficationTest(TagName name, base::StringPiece line, absl::optional<base::StringPiece> expected_content, const base::Location& from = base::Location::Current())
{
...
template <typename T>
void RunTagIdenficationTest(base::StringPiece line, absl::optional<base::StringPiece> expected_content, const base::Location& from = base::Location::Current())
{
...
TEST(HlsTagsTest, ParseXIFrameStreamInfTag)
{
    RunTagIdenficationTest(
        ToTagName(MultivariantPlaylistTagName::kXIFrameStreamInf), "#EXT-X-I-FRAME-STREAM-INF:URI=\"foo.m3u8\",BANDWIDTH=1000\n", "URI=\"foo.m3u8\",BANDWIDTH=1000");
...
TEST(HlsTagsTest, ParseXMediaTag)
{
    ...
    ErrorTest<XMediaTag>(absl::nullopt, variable_dict, sub_buffer, ParseStatusCode::kMalformedTag);
...
{
    RunTagIdenficationTest(
        ToTagName(MultivariantPlaylistTagName::kXSessionData), "#EXT-X-SESSION-DATA:DATA-ID=\"com.google.key\",VALUE=\"value\"\n", "DATA-ID=\"com.google.key\",VALUE=\"value\"");
    // TODO(crbug.com/1266991): Implement the EXT-X-SESSION-DATA tag.
}

TEST(HlsTagsTest, ParseXSessionKeyTag)
{
    RunTagIdenficationTest(ToTagName(MultivariantPlaylistTagName::kXSessionKey), "#EXT-X-SESSION-KEY:METHOD=AES-128,URI=\"https://google.com/key\"\n",
...
TEST(HlsTagsTest, ParseXStreamInfTag)
{
    ...
    ErrorTest<XStreamInfTag>(absl::nullopt, variable_dict, sub_buffer, ParseStatusCode::kMalformedTag);
...
{
    RunTagIdenficationTest(
        ToTagName(MediaPlaylistTagName::kXDateRange), "#EXT-X-DATERANGE:ID=\"ad\",START-DATE=\"2022-07-19T01:04:57+0000\"\n", "ID=\"ad\",START-DATE=\"2022-07-19T01:04:57+0000\"");
...
{
    RunTagIdenficationTest(ToTagName(MediaPlaylistTagName::kXKey), "#EXT-X-KEY:METHOD=NONE\n", "METHOD=NONE");
...
TEST(HlsTagsTest, ParseXMapTag)
{
    ...
    ErrorTest<XMapTag>(absl::nullopt, variable_dict, sub_buffer, ParseStatusCode::kMalformedTag);
...
TEST(HlsTagsTest, ParseXPartTag)
{
    ...
    ErrorTest<XPartTag>(absl::nullopt, variable_dict, sub_buffer, ParseStatusCode::kMalformedTag);
    ...
    EXPECT_EQ(result.tag.independent, false);
    EXPECT_EQ(result.tag.gap, false);
    ErrorTest<XPartTag>("URI=\"foo.ts\",DURATION=" + base::NumberToString(MaxSeconds() + 1), variable_dict, sub_buffer, ParseStatusCode::kValueOverflowsTimeDelta);
...
{
    RunTagIdenficationTest(ToTagName(MediaPlaylistTagName::kXProgramDateTime), "#EXT-X-PROGRAM-DATE-TIME:2010-02-19T14:54:23.031+08:00\n", "2010-02-19T14:54:23.031+08:00");
    // TODO(crbug.com/1266991): Implement the EXT-X-PROGRAM-DATE-TIME tag.
}

TEST(HlsTagsTest, ParseXRenditionReportTag)
{
    RunTagIdenficationTest(ToTagName(MediaPlaylistTagName::kXRenditionReport), "#EXT-X-RENDITION-REPORT:URI=\"foo.m3u8\",LAST-MSN=200\n", "URI=\"foo.m3u8\",LAST-MSN=200");
...
{
    RunTagIdenficationTest(ToTagName(MediaPlaylistTagName::kXSkip), "#EXT-X-SKIP:SKIPPED-SEGMENTS=10\n", "SKIPPED-SEGMENTS=10");
