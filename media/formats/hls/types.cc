...
namespace {
re2::StringPiece to_re2(base::StringPiece str) { return re2::StringPiece(str.data(), str.size()); }

re2::StringPiece to_re2(SourceString str) { return to_re2(str.Str()); }

bool IsOneOf(char c, base::StringPiece set) { return base::Contains(set, c); }
...
// static
absl::optional<ByteRange> ByteRange::Validate(DecimalInteger length, DecimalInteger offset)
{
    if (length == 0) {
        return absl::nullopt;
    }
