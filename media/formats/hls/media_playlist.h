...
public:
    ...
    const std::vector<scoped_refptr<MediaSegment>>& GetSegments() const { return segments_; }
    ...
    absl::optional<PlaylistType> GetPlaylistType() const { return playlist_type_; }
    ...
    absl::optional<PartialSegmentInfo> GetPartialSegmentInfo() const { return partial_segment_info_; }
    ...
    absl::optional<base::TimeDelta> GetSkipBoundary() const { return skip_boundary_; }
    ...
    absl::optional<base::TimeDelta> GetPartHoldBackDistance() const { return part_hold_back_distance_; }
    ...
    static ParseStatus::Or<scoped_refptr<MediaPlaylist>> Parse(base::StringPiece source, GURL uri, types::DecimalInteger version, const MultivariantPlaylist* parent_playlist);
