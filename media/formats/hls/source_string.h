...
template <typename T> class GenericSourceString;
...
template <typename ResolutionState> class MEDIA_EXPORT GenericSourceString {
public:
    static GenericSourceString Create(base::PassKey<SourceLineIterator>, size_t line, base::StringPiece str);
    static GenericSourceString Create(base::PassKey<VariableDictionary>, size_t line, size_t column, base::StringPiece str, ResolutionState resolution_state);
    static GenericSourceString CreateForTesting(base::StringPiece str);
    static GenericSourceString CreateForTesting(size_t line, size_t column, base::StringPiece str);
    static GenericSourceString CreateForTesting(size_t line, size_t column, base::StringPiece str, ResolutionState resolution_state);
    ...
    GenericSourceString Substr(size_t pos = 0, size_t count = base::StringPiece::npos) const;
...
private:
    template <typename> friend class GenericSourceString;

    GenericSourceString(size_t line, size_t column, base::StringPiece str, ResolutionState resolution_state);
