...
public:
    ...
    void Init(InitCB init_cb, NewConfigCB config_cb, NewBuffersCB new_buffers_cb, bool ignore_text_tracks /* must be true */, EncryptedMediaInitDataCB encrypted_media_init_data_cb,
