...
protected:
    ...
    const AudioDecoderConfig& last_audio_config() const { return last_audio_config_; }
...
private:
    ...
    bool OnNewConfig(std::unique_ptr<MediaTracks> tracks, const StreamParser::TextTrackConfigMap& text_config);
