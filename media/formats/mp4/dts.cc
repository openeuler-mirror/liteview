...
int DTS::GetFrameDuration() const { return frame_duration_; }

uint32_t DTS::GetDtsSamplingFrequency() const { return dts_sampling_frequency_; }

uint32_t DTS::GetMaxBitrate() const { return max_bitrate_; }

uint32_t DTS::GetAvgBitrate() const { return avg_bitrate_; }

uint8_t DTS::GetPcmSampleDepth() const { return pcm_sample_depth_; }
