...
const int kSyncFrameSizeInWordsFor44kHz[] = { 69, 70, 87, 88, 104, 105, 121, 122, 139, 140, 174, 175, 208, 209, 243, 244, 278, 279, 348, 349, 417, 418, 487, 488, 557, 558, 696,
...
int ParseEac3SyncFrameSize(Ac3Header& header) { return 2 * (header.eac3_frame_size_code() + 1); }

// Returns the number of audio samples in an AC3 synchronization frame.
int GetAc3SyncFrameSampleCount() { return kAudioSamplePerAc3SyncFrame; }
...
// static
int Ac3Util::ParseTotalAc3SampleCount(const uint8_t* data, size_t size) { return ParseTotalSampleCount(data, size, false); }

// static
int Ac3Util::ParseTotalEac3SampleCount(const uint8_t* data, size_t size) { return ParseTotalSampleCount(data, size, true); }
