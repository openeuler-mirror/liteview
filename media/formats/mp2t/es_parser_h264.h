...
public:
    ...
    EsParserH264(NewVideoConfigCB new_video_config_cb, EmitBufferCB emit_buffer_cb, EncryptionScheme init_encryption_scheme, const GetDecryptConfigCB& get_decrypt_config_cb);
#endif
