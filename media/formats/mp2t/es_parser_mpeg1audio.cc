...
void EsParserMpeg1Audio::ResetInternal() { last_audio_decoder_config_ = AudioDecoderConfig(); }
...
bool EsParserMpeg1Audio::UpdateAudioConfiguration(const uint8_t* mpeg1audio_header)
{
    ...
    AudioDecoderConfig audio_decoder_config(AudioCodec::kMP3, kSampleFormatS16, header.channel_layout, header.sample_rate, EmptyExtraData(), EncryptionScheme::kUnencrypted);
