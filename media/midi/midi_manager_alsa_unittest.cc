...
protected:
    void SetUp() override
    {
        ...
        port_input_0_ = std::make_unique<MidiManagerAlsa::MidiPort>("path", MidiManagerAlsa::MidiPort::Id("bus", "vendor", "model", "interface", "serial"), 1, 2, 5, "client_name",
            "port_name", "manufacturer", "version", MidiManagerAlsa::MidiPort::Type::kInput);
        port_input_1_ = std::make_unique<MidiManagerAlsa::MidiPort>("path", MidiManagerAlsa::MidiPort::Id("bus", "vendor", "model", "interface", "serial"), 1, 2, 5, "client_name",
            "port_name", "manufacturer", "version", MidiManagerAlsa::MidiPort::Type::kInput);
        port_input_minimal_ = std::make_unique<MidiManagerAlsa::MidiPort>("", MidiManagerAlsa::MidiPort::Id(), 0, 0, 0, "", "", "", "", MidiManagerAlsa::MidiPort::Type::kInput);
        // Outputs. port_output_0_ == port_output_1_.
        port_output_0_ = std::make_unique<MidiManagerAlsa::MidiPort>("path", MidiManagerAlsa::MidiPort::Id("bus", "vendor", "model", "interface", "serial"), 1, 2, 5, "client_name",
            "port_name", "manufacturer", "version", MidiManagerAlsa::MidiPort::Type::kOutput);
        port_output_1_ = std::make_unique<MidiManagerAlsa::MidiPort>("path", MidiManagerAlsa::MidiPort::Id("bus", "vendor", "model", "interface", "serial"), 1, 2, 5, "client_name",
            "port_name", "manufacturer", "version", MidiManagerAlsa::MidiPort::Type::kOutput);

        // MidiPort fields that differ from port_input_0_ in a single way each time.
        // Used for testing the Match* and Find* methods.
        port_input_0_alt_path_ = std::make_unique<MidiManagerAlsa::MidiPort>("path2", MidiManagerAlsa::MidiPort::Id("bus", "vendor", "model", "interface", "serial"), 1, 2, 5,
            "client_name", "port_name", "manufacturer", "version", MidiManagerAlsa::MidiPort::Type::kInput);
        port_input_0_alt_id_ = std::make_unique<MidiManagerAlsa::MidiPort>("path", MidiManagerAlsa::MidiPort::Id("bus", "vendor", "model", "interface", "serial2"), 1, 2, 5,
            "client_name", "port_name", "manufacturer", "version", MidiManagerAlsa::MidiPort::Type::kInput);
        port_input_0_alt_client_name_ = std::make_unique<MidiManagerAlsa::MidiPort>("path", MidiManagerAlsa::MidiPort::Id("bus", "vendor", "model", "interface", "serial"), 1, 2, 5,
            "client_name2", "port_name", "manufacturer", "version", MidiManagerAlsa::MidiPort::Type::kInput);
        port_input_0_alt_port_name_ = std::make_unique<MidiManagerAlsa::MidiPort>("path", MidiManagerAlsa::MidiPort::Id("bus", "vendor", "model", "interface", "serial"), 1, 2, 5,
            "client_name", "port_name2", "manufacturer", "version", MidiManagerAlsa::MidiPort::Type::kInput);
        port_input_0_alt_client_id_ = std::make_unique<MidiManagerAlsa::MidiPort>("path", MidiManagerAlsa::MidiPort::Id("bus", "vendor", "model", "interface", "serial"), 2, 2, 5,
            "client_name", "port_name", "manufacturer", "version", MidiManagerAlsa::MidiPort::Type::kInput);
        port_input_0_alt_port_id_ = std::make_unique<MidiManagerAlsa::MidiPort>("path", MidiManagerAlsa::MidiPort::Id("bus", "vendor", "model", "interface", "serial"), 1, 3, 5,
            "client_name", "port_name", "manufacturer", "version", MidiManagerAlsa::MidiPort::Type::kInput);
        port_input_0_alt_midi_device_ = std::make_unique<MidiManagerAlsa::MidiPort>("path", MidiManagerAlsa::MidiPort::Id("bus", "vendor", "model", "interface", "serial"), 1, 2, 6,
            "client_name", "port_name", "manufacturer", "version", MidiManagerAlsa::MidiPort::Type::kInput);
...
{
    EXPECT_EQ("My\\x20Vendor", MidiManagerAlsa::AlsaCard::ExtractManufacturerString("My\\x20Vendor", "1234", "My Vendor, Inc.", "Card", "My Vendor Inc Card at bus"));
    ...
    EXPECT_EQ("C-Media Electronics Inc",
        MidiManagerAlsa::AlsaCard::ExtractManufacturerString("", "0x13f6", "C-Media Electronics Inc", "C-Media CMI8738 MIDI", "C-Media CMI8738 (model 55) at 0xd000, irq 19"));
    EXPECT_EQ("C-Media Electronics Inc",
        MidiManagerAlsa::AlsaCard::ExtractManufacturerString("", "0x13f6", "C-Media Electronics Inc", "C-Media CMI8738 FM", "C-Media CMI8738 (model 55) at 0xd000, irq 19"));
}
...
TEST_F(MidiManagerAlsaTest, ToMidiPortState)
{
    ...
    EXPECT_TRUE((*alsa_seq_state_0_.ToMidiPortState(alsa_cards_)->begin())
                    ->MatchConnected(MidiManagerAlsa::MidiPort("", MidiManagerAlsa::MidiPort::Id(), 0, 1, -1, "0", "0:1", "", "", MidiManagerAlsa::MidiPort::Type::kOutput)));
}
