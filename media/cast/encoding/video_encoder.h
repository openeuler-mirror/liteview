...
public:
    ...
    using FrameEncodedCallback = base::OnceCallback<void(std::unique_ptr<SenderEncodedFrame>)>;
    ...
    virtual bool EncodeVideoFrame(scoped_refptr<media::VideoFrame> video_frame, base::TimeTicks reference_time, FrameEncodedCallback frame_encoded_callback) = 0;
