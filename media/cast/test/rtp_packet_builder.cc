...
void RtpPacketBuilder::SetPacketId(uint16_t packet_id) { packet_id_ = packet_id; }

void RtpPacketBuilder::SetMaxPacketId(uint16_t max_packet_id) { max_packet_id_ = max_packet_id; }

void RtpPacketBuilder::SetTimestamp(uint32_t timestamp) { timestamp_ = timestamp; }

void RtpPacketBuilder::SetSequenceNumber(uint16_t sequence_number) { sequence_number_ = sequence_number; }

void RtpPacketBuilder::SetMarkerBit(bool marker) { marker_ = marker; }

void RtpPacketBuilder::SetPayloadType(int payload_type) { payload_type_ = payload_type; }

void RtpPacketBuilder::SetSsrc(uint32_t ssrc) { ssrc_ = ssrc; }
