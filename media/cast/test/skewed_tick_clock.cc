...
base::TimeTicks SkewedTickClock::SkewTicks(base::TimeTicks now) const { return base::Microseconds((now - last_skew_set_time_).InMicroseconds() * skew_) + skew_clock_at_last_set_; }
...
base::TimeTicks SkewedTickClock::NowTicks() const { return SkewTicks(clock_->NowTicks()); }
