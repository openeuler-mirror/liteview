...
void AudioDecoder::DecodeFrame(std::unique_ptr<EncodedFrame> encoded_frame, DecodeFrameCallback callback)
{
    ...
    cast_environment_->PostTask(CastEnvironment::AUDIO, FROM_HERE, base::BindOnce(&AudioDecoder::ImplBase::DecodeFrame, impl_, std::move(encoded_frame), std::move(callback)));
}
