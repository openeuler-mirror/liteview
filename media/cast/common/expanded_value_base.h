...
public:
    ...
    bool operator==(const ExpandedValueBase<FullWidthInteger, Subclass>& rhs) const { return value_ == rhs.value_; }
    bool operator!=(const ExpandedValueBase<FullWidthInteger, Subclass>& rhs) const { return value_ != rhs.value_; }
    bool operator<(const ExpandedValueBase<FullWidthInteger, Subclass>& rhs) const { return value_ < rhs.value_; }
    bool operator>(const ExpandedValueBase<FullWidthInteger, Subclass>& rhs) const { return value_ > rhs.value_; }
    bool operator<=(const ExpandedValueBase<FullWidthInteger, Subclass>& rhs) const { return value_ <= rhs.value_; }
    ...
    static Subclass DeserializeForIPC(uint64_t serialized) { return Subclass(static_cast<FullWidthInteger>(serialized)); }
    ...
    template <typename ShortUnsigned> static constexpr FullWidthInteger max_distance_for_expansion() { return std::numeric_limits<ShortUnsigned>::max() / 2; }
