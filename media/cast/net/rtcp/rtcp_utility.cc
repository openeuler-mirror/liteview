...
void RtcpParser::SetMaxValidFrameId(FrameId frame_id) { max_valid_frame_id_ = frame_id; }
...
uint32_t ConvertToNtpDiff(uint32_t delay_seconds, uint32_t delay_fraction) { return ((delay_seconds & 0x0000FFFF) << 16) + ((delay_fraction & 0xFFFF0000) >> 16); }
