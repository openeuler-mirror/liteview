...
ReceiverRtcpEventSubscriber::~ReceiverRtcpEventSubscriber() { DCHECK(thread_checker_.CalledOnValidThread()); }
...
struct CompareByFirst {
    bool operator()(const std::pair<RtpTimeTicks, RtcpEvent>& a, const std::pair<RtpTimeTicks, RtcpEvent>& b) { return a.first < b.first; }
};
