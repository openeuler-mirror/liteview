...
public:
    ...
    const RtcpSenderInfo& sender_report() const { return sender_report_; }
    ...
    bool has_receiver_reference_time_report() const { return has_receiver_reference_time_report_; }
    const RtcpReceiverReferenceTimeReport& receiver_reference_time_report() const { return receiver_reference_time_report_; }

    bool has_picture_loss_indicator() const { return has_picture_loss_indicator_; }
