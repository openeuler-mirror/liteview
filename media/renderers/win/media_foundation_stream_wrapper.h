...
//
class MediaFoundationStreamWrapper : public Microsoft::WRL::RuntimeClass<Microsoft::WRL::RuntimeClassFlags<Microsoft::WRL::RuntimeClassType::ClassicCom>, IMFMediaStream> {
public:
...
protected:
    ...
    HRESULT GenerateSampleFromDecoderBuffer(DecoderBuffer* buffer, IMFSample** sample_out);
