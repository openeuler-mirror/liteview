...
HRESULT MediaFoundationSourceWrapper::RuntimeClassInitialize(MediaResource* media_resource, MediaLog* media_log, scoped_refptr<base::SequencedTaskRunner> task_runner)
{
    DVLOG_FUNC(1);
...
HRESULT MediaFoundationSourceWrapper::CreatePresentationDescriptor(IMFPresentationDescriptor** presentation_descriptor_out)
{
    ...
    RETURN_IF_FAILED(MFCreatePresentationDescriptor(stream_desc_count, reinterpret_cast<IMFStreamDescriptor**>(stream_descriptors.data()), &presentation_descriptor));
...
uint32_t MediaFoundationSourceWrapper::StreamCount() const { return media_streams_.size(); }
