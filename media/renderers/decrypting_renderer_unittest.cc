...
public:
    ...
    void UseAesDecryptor(bool use_aes_decryptor) { use_aes_decryptor_ = use_aes_decryptor; }
...
protected:
    ...
    // pipeline.
    void InitializeDecryptingRendererWithFalse() { decrypting_renderer_->InitializeRenderer(false); }
