...
public:
    PipelineControllerTest()
        ...
        , pipeline_controller_(std::unique_ptr<Pipeline>(pipeline_), base::BindRepeating(&PipelineControllerTest::OnSeeked, base::Unretained(this)),
              base::BindRepeating(&PipelineControllerTest::OnSuspended, base::Unretained(this)),
              base::BindRepeating(&PipelineControllerTest::OnBeforeResume, base::Unretained(this)), base::BindRepeating(&PipelineControllerTest::OnResumed, base::Unretained(this)),
    ...
    PipelineStatusCallback StartPipeline_WithDynamicData() { return StartPipeline(false, false); }

    PipelineStatusCallback StartPipeline_WithStreamingData() { return StartPipeline(true, false); }
...
protected:
    ...
    void OnAddTextTrack(const TextTrackConfig& config, AddTextTrackDoneCB done_cb) override { }
