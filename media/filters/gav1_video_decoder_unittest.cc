...
MATCHER(ContainsDecoderErrorLog, "") { return CONTAINS_STRING(arg, "libgav1::Decoder::DequeueFrame failed"); }
...
public:
    ...
    void Initialize() { InitializeWithConfig(TestVideoConfig::Normal(VideoCodec::kAV1)); }
    ...
    void Reinitialize() { InitializeWithConfig(TestVideoConfig::Large(VideoCodec::kAV1)); }
...
TEST_F(Gav1VideoDecoderTest, Initialize_Normal) { Initialize(); }
...
TEST_F(Gav1VideoDecoderTest, DecodeFrame_LargerWidth) { DecodeIFrameThenTestFile("av1-I-frame-1280x720", gfx::Size(1280, 720)); }
