...
TEST_P(AudioTimestampValidatorTest, WarnForEraticTimes)
{
    ...
    decoder_config.Initialize(kCodec, kSampleFormat, kChannelLayout, kSamplesPerSecond, EmptyExtraData(), EncryptionScheme::kUnencrypted, kSeekPreroll, codec_delay_);
