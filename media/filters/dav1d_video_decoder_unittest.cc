...
MATCHER(ContainsDecoderErrorLog, "") { return CONTAINS_STRING(arg, "dav1d_send_data() failed"); }
...
TEST_F(Dav1dVideoDecoderTest, Initialize_Normal) { Initialize(); }
...
TEST_F(Dav1dVideoDecoderTest, DecodeFrame_LargerWidth) { DecodeIFrameThenTestFile("av1-I-frame-1280x720", gfx::Size(1280, 720)); }
