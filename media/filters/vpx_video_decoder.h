...
public:
    ...
    void force_allocation_error_for_testing() { memory_pool_->force_allocation_error_for_testing(); }
...
public:
    OffloadingVpxVideoDecoder()
        : OffloadingVideoDecoder(1024, std::vector<VideoCodec>(1, VideoCodec::kVP9), std::make_unique<VpxVideoDecoder>(OffloadableVideoDecoder::OffloadState::kOffloaded))
    {
    }
};
