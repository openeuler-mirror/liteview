...
public:
    ...
    static SupportsType IsTypeSupported(base::StringPiece type, base::span<const std::string> codecs);
    ...
    // attempted decode.
    static std::unique_ptr<StreamParser> Create(base::StringPiece type, base::span<const std::string> codecs, MediaLog* media_log);
