...
public:
    ...
    bool UpdateCadenceEstimate(base::TimeDelta render_interval, base::TimeDelta frame_duration, base::TimeDelta frame_duration_deviation, base::TimeDelta max_acceptable_drift);

    // Returns true if a useful cadence was found.
    bool has_cadence() const { return bm_.use_bresenham_cadence_ ? bm_.perfect_cadence_.has_value() : !cadence_.empty(); }
    ...
    void set_cadence_hysteresis_threshold_for_testing(base::TimeDelta threshold) { cadence_hysteresis_threshold_ = threshold; }
...
private:
    ...
    Cadence CalculateCadence(base::TimeDelta render_interval, base::TimeDelta frame_duration, base::TimeDelta max_acceptable_drift, base::TimeDelta* time_until_max_drift) const;
