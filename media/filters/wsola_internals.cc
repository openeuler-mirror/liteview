...
int DecimatedSearch(
    int decimation, Interval exclude_interval, const AudioBus* target_block, const AudioBus* search_segment, const float* energy_target_block, const float* energy_candidate_blocks)
{
...
int FullSearch(int low_limit, int high_limit, Interval exclude_interval, const AudioBus* target_block, const AudioBus* search_block, const float* energy_target_block,
...
int OptimalIndex(const AudioBus* search_block, const AudioBus* target_block, Interval exclude_interval)
{
    ...
    std::unique_ptr<float[]> energy_candidate_blocks(new float[channels * num_candidate_blocks]);
    ...
    int optimal_index = DecimatedSearch(kSearchDecimation, exclude_interval, target_block, search_block, energy_target_block.get(), energy_candidate_blocks.get());
