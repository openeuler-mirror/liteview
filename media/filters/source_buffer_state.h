...
public:
    ...
    using NewTextTrackCB = base::RepeatingCallback<void(ChunkDemuxerStream*, const TextTrackConfig&)>;
    ...
    void Init(StreamParser::InitCB init_cb, const std::string& expected_codecs, const StreamParser::EncryptedMediaInitDataCB& encrypted_media_init_data_cb,
    ...
    bool Append(const uint8_t* data, size_t length, base::TimeDelta append_window_start, base::TimeDelta append_window_end, base::TimeDelta* timestamp_offset);
    bool AppendChunks(
    ...
    bool generate_timestamps_flag() const { return stream_parser_->GetGenerateTimestampsFlag(); }
...
private:
    ...
    bool OnNewConfigs(std::string expected_codecs, std::unique_ptr<MediaTracks> tracks, const StreamParser::TextTrackConfigMap& text_configs);
