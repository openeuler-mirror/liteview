...
public:
    ...
    int FrontTimestampInMilliseconds() { return clock_->front_timestamp().InMilliseconds(); }

    int BackTimestampInMilliseconds() { return clock_->back_timestamp().InMilliseconds(); }

    int TimeUntilPlaybackInMilliseconds(int timestamp_ms) { return clock_->TimeUntilPlayback(base::Milliseconds(timestamp_ms)).InMilliseconds(); }
