...
public:
    BlockingUrlProtocolTest()
        : url_protocol_(new BlockingUrlProtocol(&data_source_, base::BindRepeating(&BlockingUrlProtocolTest::OnDataSourceError, base::Unretained(this))))
    {
...
TEST_F(BlockingUrlProtocolTest, IsStreaming)
{
    ...
    url_protocol_ = std::make_unique<BlockingUrlProtocol>(&data_source_, base::BindRepeating(&BlockingUrlProtocolTest::OnDataSourceError, base::Unretained(this)));
