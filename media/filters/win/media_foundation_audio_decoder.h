...
public:
    ...
    static std::unique_ptr<MediaFoundationAudioDecoder> Create(scoped_refptr<base::SingleThreadTaskRunner> task_runner);

    MediaFoundationAudioDecoder(scoped_refptr<base::SingleThreadTaskRunner> task_runner);
