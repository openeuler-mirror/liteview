...
Vp9FrameContext kVp9DefaultFrameContext = {
    ...
    // coef_probs
    { // 4x4
        { { { { { 195, 29, 183 }, { 84, 49, 136 }, { 8, 42, 71 } }, { { 31, 107, 169 }, { 35, 99, 159 }, { 17, 82, 140 }, { 8, 66, 114 }, { 2, 44, 76 }, { 1, 19, 32 } },
              ...
              { { { 191, 107, 226 }, { 124, 117, 204 }, { 25, 99, 155 } }, { { 29, 148, 210 }, { 37, 126, 194 }, { 8, 93, 157 }, { 2, 68, 118 }, { 1, 39, 69 }, { 1, 17, 33 } },
            ...
            { { { { 214, 49, 220 }, { 132, 63, 188 }, { 42, 65, 137 } }, { { 85, 137, 221 }, { 104, 131, 216 }, { 49, 111, 192 }, { 21, 87, 155 }, { 2, 49, 87 }, { 1, 16, 28 } },
                ...
                { { { 229, 99, 249 }, { 143, 111, 235 }, { 46, 109, 192 } }, { { 82, 158, 236 }, { 94, 146, 224 }, { 25, 117, 191 }, { 9, 87, 149 }, { 3, 56, 99 }, { 1, 33, 57 } },
        ...
        // 8x8
        { { { { { 125, 34, 187 }, { 52, 41, 133 }, { 6, 31, 56 } }, { { 37, 109, 153 }, { 51, 102, 147 }, { 23, 87, 128 }, { 8, 67, 101 }, { 1, 41, 63 }, { 1, 19, 29 } },
              ...
              { { { 202, 105, 245 }, { 108, 106, 216 }, { 18, 90, 144 } }, { { 33, 172, 219 }, { 64, 149, 206 }, { 14, 117, 177 }, { 5, 90, 141 }, { 2, 61, 95 }, { 1, 37, 57 } },
            ...
            { { { { 212, 35, 215 }, { 113, 47, 169 }, { 29, 48, 105 } }, { { 74, 129, 203 }, { 106, 120, 203 }, { 49, 107, 178 }, { 19, 84, 144 }, { 4, 50, 84 }, { 1, 15, 25 } },
        ...
        // 16x16
        { { { { { 7, 27, 153 }, { 5, 30, 95 }, { 1, 16, 30 } }, { { 50, 75, 127 }, { 57, 75, 124 }, { 27, 67, 108 }, { 10, 54, 86 }, { 1, 33, 52 }, { 1, 12, 18 } },
              ...
              { { { 19, 55, 240 }, { 19, 59, 196 }, { 3, 52, 105 } }, { { 41, 166, 207 }, { 104, 153, 199 }, { 31, 123, 181 }, { 14, 101, 152 }, { 5, 72, 106 }, { 1, 36, 52 } },
            ...
            { { { { 211, 29, 217 }, { 96, 47, 156 }, { 22, 43, 87 } }, { { 78, 120, 193 }, { 111, 116, 186 }, { 46, 102, 164 }, { 15, 80, 128 }, { 2, 49, 76 }, { 1, 18, 28 } },
        ...
        // 32x32
        { { { { { 17, 38, 140 }, { 7, 34, 80 }, { 1, 17, 29 } }, { { 37, 75, 128 }, { 41, 76, 128 }, { 26, 66, 116 }, { 12, 52, 94 }, { 2, 32, 55 }, { 1, 10, 16 } },
            ...
            { { { { 181, 21, 201 }, { 61, 37, 123 }, { 10, 38, 71 } }, { { 47, 106, 172 }, { 95, 104, 173 }, { 42, 93, 159 }, { 18, 77, 131 }, { 4, 50, 81 }, { 1, 17, 23 } },
    ...
    // uv_mode_probs
    { { 120, 7, 76, 176, 208, 126, 28, 54, 103 }, { 48, 12, 154, 155, 139, 90, 34, 117, 119 }, { 67, 6, 25, 204, 243, 158, 13, 21, 96 }, { 97, 5, 44, 131, 176, 139, 48, 68, 97 },
        { 83, 5, 42, 156, 111, 152, 26, 49, 152 }, { 80, 5, 58, 178, 74, 83, 33, 62, 145 }, { 86, 5, 32, 154, 192, 168, 14, 22, 163 }, { 85, 5, 32, 156, 216, 148, 19, 29, 73 },
        { 77, 7, 64, 116, 132, 122, 37, 126, 120 }, { 101, 21, 107, 181, 192, 103, 19, 67, 125 } },
    // partition_probs
    { { 199, 122, 141 }, { 147, 63, 159 }, { 148, 133, 118 }, { 121, 104, 114 }, { 174, 73, 87 }, { 92, 41, 83 }, { 82, 99, 50 }, { 53, 39, 39 }, { 177, 58, 59 }, { 68, 26, 63 },
        { 52, 79, 25 }, { 17, 14, 12 }, { 222, 34, 30 }, { 72, 16, 44 }, { 58, 32, 12 }, { 10, 7, 6 } },
    // mv_joint_probs
    { 32, 64, 96 },
    // mv_sign_prob
    { 128, 128 },
...
const Vp9FrameContext& Vp9UncompressedHeaderParser::GetVp9DefaultFrameContextForTesting() const { return kVp9DefaultFrameContext; }
...
uint8_t Vp9UncompressedHeaderParser::ReadProb() { return reader_.ReadBool() ? reader_.ReadLiteral(8) : kVp9MaxProb; }
...
bool Vp9UncompressedHeaderParser::Parse(const uint8_t* stream, off_t frame_size, Vp9FrameHeader* fhdr)
{
    ...
    if (fhdr->IsKeyframe()) {
        ...
        if (fhdr->intra_only) {
            ...
            static_assert(std::extent<decltype(fhdr->ref_frame_sign_bias)>() >= Vp9RefType::VP9_FRAME_LAST + kVp9NumRefsPerFrame, "ref_frame_sign_bias is not big enough");
