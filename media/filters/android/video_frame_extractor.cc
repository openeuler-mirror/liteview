...
void VideoFrameExtractor::ConvertPacket(AVPacket* packet)
{
    ...
    case AV_CODEC_ID_H264:
        ...
        bitstream_converter_.reset(new FFmpegH264ToAnnexBBitstreamConverter(video_stream_->codecpar));
        break;
#if BUILDFLAG(ENABLE_PLATFORM_HEVC)
    case AV_CODEC_ID_HEVC:
        bitstream_converter_.reset(new FFmpegH265ToAnnexBBitstreamConverter(video_stream_->codecpar));
        break;
#endif
    case AV_CODEC_ID_AAC:
        bitstream_converter_.reset(new FFmpegAACBitstreamConverter(video_stream_->codecpar));
        break;
    default:
        break;
    }
