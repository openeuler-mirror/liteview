...
public:
    FakeVideoDecoderTest()
        : decoder_(new FakeVideoDecoder(
            0xFACCE, GetParam().decoding_delay, GetParam().max_decode_requests, base::BindRepeating(&FakeVideoDecoderTest::OnBytesDecoded, base::Unretained(this))))
    ...
    void Initialize() { InitializeWithConfigAndExpectResult(TestVideoConfig::Normal(), true); }
