...
struct MEDIA_EXPORT AudioProcessingSettings {
    ...
    {
        return echo_cancellation == b.echo_cancellation && noise_suppression == b.noise_suppression && transient_noise_suppression == b.transient_noise_suppression
            && automatic_gain_control == b.automatic_gain_control && experimental_automatic_gain_control == b.experimental_automatic_gain_control
            && high_pass_filter == b.high_pass_filter && multi_channel_capture_processing == b.multi_channel_capture_processing && stereo_mirroring == b.stereo_mirroring
    ...
    bool NeedAudioModification() const { return NeedWebrtcAudioProcessing() || stereo_mirroring; }

    bool NeedPlayoutReference() const { return echo_cancellation || automatic_gain_control; }
