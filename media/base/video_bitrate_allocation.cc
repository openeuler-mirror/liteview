...
uint32_t VideoBitrateAllocation::GetSumBps() const { return sum_bitrate_.target_bps(); }

const Bitrate VideoBitrateAllocation::GetSumBitrate() const { return sum_bitrate_; }

Bitrate::Mode VideoBitrateAllocation::GetMode() const { return sum_bitrate_.mode(); }
