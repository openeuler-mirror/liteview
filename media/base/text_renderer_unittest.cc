...
public:
    ...
    void CreateTextRenderer()
    {
        ...
        text_renderer_
            = std::make_unique<TextRenderer>(task_environment_.GetMainThreadTaskRunner(), base::BindRepeating(&TextRendererTest::OnAddTextTrack, base::Unretained(this)));
...
{
    text_renderer_ = std::make_unique<TextRenderer>(task_environment_.GetMainThreadTaskRunner(), base::BindRepeating(&TextRendererTest::OnAddTextTrack, base::Unretained(this)));
    text_renderer_.reset();
}
