...
struct MediaLogRecord {
    ...
    bool operator==(const MediaLogRecord& other) const { return id == other.id && type == other.type && params == other.params && time == other.time; }
    bool operator!=(const MediaLogRecord& other) const { return !(*this == other); }
