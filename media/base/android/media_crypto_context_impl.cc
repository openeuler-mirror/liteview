...
void MediaCryptoContextImpl::SetMediaCryptoReadyCB(MediaCryptoReadyCB media_crypto_ready_cb) { media_drm_bridge_->SetMediaCryptoReadyCB(std::move(media_crypto_ready_cb)); }
