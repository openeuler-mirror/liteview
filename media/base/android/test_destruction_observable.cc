...
std::unique_ptr<DestructionObserver> DestructionObservable::CreateDestructionObserver() { return std::make_unique<DestructionObserver>(this); }
...
DestructionObserver::~DestructionObserver() { VerifyExpectations(); }
