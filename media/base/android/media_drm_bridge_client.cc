...
MediaDrmBridgeClient* GetMediaDrmBridgeClient() { return g_media_drm_bridge_client; }
...
media::MediaDrmBridgeDelegate* MediaDrmBridgeClient::GetMediaDrmBridgeDelegate(const std::vector<uint8_t>& scheme_uuid) { return nullptr; }
