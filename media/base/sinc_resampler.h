...
public:
    ...
    static constexpr int kKernelStorageSize = kKernelSize * (kKernelOffsetCount + 1);
...
private:
    ...
    static float Convolve_SSE(const float* input_ptr, const float* k1, const float* k2, double kernel_interpolation_factor);
    static float Convolve_AVX2(const float* input_ptr, const float* k1, const float* k2, double kernel_interpolation_factor);
#elif defined(ARCH_CPU_ARM_FAMILY) && defined(USE_NEON)
    static float Convolve_NEON(const float* input_ptr, const float* k1, const float* k2, double kernel_interpolation_factor);
#endif
    ...
    using ConvolveProc = float (*)(const float*, const float*, const float*, double);
