...
{
    NOTREACHED();
    static base::NoDestructor<MediaUrlParams> instance { GURL(), net::SiteForCookies(), url::Origin(), false, false };
    return *instance;
}

MediaResource::Type MediaResource::GetType() const { return STREAM; }
