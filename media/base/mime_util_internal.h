...
public:
    ...
    void SplitCodecs(base::StringPiece codecs, std::vector<std::string>* codecs_out) const;
    void StripCodecs(std::vector<std::string>* codecs) const;
    bool ParseVideoCodecString(base::StringPiece mime_type, // fixme, make optional
        base::StringPiece codec_id, bool* out_is_ambiguous, VideoCodec* out_codec, VideoCodecProfile* out_profile, uint8_t* out_level, VideoColorSpace* out_color_space) const;
    bool ParseAudioCodecString(base::StringPiece mime_type, base::StringPiece codec_id, bool* out_is_ambiguous, AudioCodec* out_codec) const;
    SupportsType IsSupportedMediaFormat(base::StringPiece mime_type, const std::vector<std::string>& codecs, bool is_encrypted) const;
    ...
    static bool IsCodecSupportedOnAndroid(
        Codec codec, base::StringPiece mime_type_lower_case, bool is_encrypted, VideoCodecProfile video_profile, const PlatformInfo& platform_info);
...
private:
    ...
    // encrypted blocks.
    SupportsType AreSupportedCodecs(const std::vector<ParsedCodecResult>& parsed_codecs, base::StringPiece mime_type_lower_case, bool is_encrypted) const;
    ...
    bool ParseCodecStrings(base::StringPiece mime_type_lower_case, const std::vector<std::string>& codecs, std::vector<ParsedCodecResult>* out_results) const;
    ...
    bool ParseCodecHelper(base::StringPiece mime_type_lower_case, base::StringPiece codec_id, ParsedCodecResult* out_result) const;
    ...
    SupportsType IsCodecSupported(
        base::StringPiece mime_type_lower_case, Codec codec, VideoCodecProfile video_profile, uint8_t video_level, const VideoColorSpace& eotf, bool is_encrypted) const;
    ...
    bool GetDefaultCodec(base::StringPiece mime_type_lower_case, Codec* default_codec) const;
