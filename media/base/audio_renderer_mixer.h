...
public:
    ...
    const AudioParameters& get_output_params_for_testing() const { return output_params_; }
...
private:
    ...
    bool can_passthrough(int sample_rate) const { return sample_rate == output_params_.sample_rate(); }
