...
double AudioBufferConverter::ProvideInput(AudioBus* audio_bus, uint32_t frames_delayed)
{
...
void AudioBufferConverter::ConvertIfPossible()
{
    ...
    auto output_buffer
        = AudioBuffer::CreateBuffer(kSampleFormatPlanarF32, output_params_.channel_layout(), output_params_.channels(), output_params_.sample_rate(), request_frames, pool_);
