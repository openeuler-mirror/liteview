...
int SilentSinkSuspender::Render(base::TimeDelta delay, base::TimeTicks delay_timestamp, int prior_frames_skipped, AudioBus* dest)
{
...
void SilentSinkSuspender::OnRenderError() { callback_->OnRenderError(); }
...
void SilentSinkSuspender::TransitionSinks(bool use_fake_sink)
{
    ...
    if (use_fake_sink) {
        ...
        fake_sink_.Start(base::BindRepeating(
            [](SilentSinkSuspender* suspender, base::TimeDelta frozen_delay, base::TimeTicks frozen_delay_timestamp, base::TimeTicks ideal_time, base::TimeTicks now) {
