...
MediaUrlParams::MediaUrlParams(const GURL& media_url, const net::SiteForCookies& site_for_cookies, const url::Origin& top_frame_origin, bool allow_credentials, bool is_hls)
    : media_url(media_url)
