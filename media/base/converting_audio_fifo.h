...
public:
    ...
    ConvertingAudioFifo(const AudioParameters& input_params, const AudioParameters& converted_params, OuputCallback output_callback);
    ...
    int min_number_input_frames_needed_for_testing() { return min_input_frames_needed_; }
...
private:
    ...
    std::unique_ptr<AudioBus> converted_audio_bus_ GUARDED_BY_CONTEXT(sequence_checker_);
