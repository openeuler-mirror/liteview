...
bool IsDefaultDevice(const std::string& device_id) { return device_id.empty() || device_id == "default"; }
...
bool AudioRendererMixerInput::IsOptimizedForHardwareParameters() { return true; }

bool AudioRendererMixerInput::CurrentThreadIsRenderingThread() { return mixer_->CurrentThreadIsRenderingThread(); }
...
void AudioRendererMixerInput::OnRenderError() { callback_->OnRenderError(); }
