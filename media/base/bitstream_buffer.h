...
public:
    ...
    base::UnsafeSharedMemoryRegion DuplicateRegion() const { return region_.Duplicate(); }
    ...
    base::TimeDelta presentation_timestamp() const { return presentation_timestamp_; }
