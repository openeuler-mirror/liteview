...
StatusData::StatusData(const StatusData& copy) { *this = copy; }
...
void StatusData::AddLocation(const base::Location& location) { frames.push_back(MediaSerialize(location)); }
...
internal::OkStatusImplicitConstructionHelper OkStatus() { return {}; }
