...
// static
VideoAspectRatio VideoAspectRatio::PAR(int width, int height) { return VideoAspectRatio(Type::kPixel, width, height); }

// static
VideoAspectRatio VideoAspectRatio::DAR(int width, int height) { return VideoAspectRatio(Type::kDisplay, width, height); }
...
bool VideoAspectRatio::IsValid() const { return std::isfinite(aspect_ratio_) && aspect_ratio_ > 0.0; }
