...
// static
int64_t AudioTimestampHelper::TimeToFrames(base::TimeDelta time, int samples_per_second) { return std::round(time.InSecondsF() * samples_per_second); }
...
base::TimeDelta AudioTimestampHelper::base_timestamp() const { return base_timestamp_; }
...
base::TimeDelta AudioTimestampHelper::GetTimestamp() const { return ComputeTimestamp(frame_count_); }
