...
MEDIA_EXPORT scoped_refptr<VideoFrame> ReadbackTextureBackedFrameToMemorySync(
    VideoFrame& txt_frame, gpu::raster::RasterInterface* ri, GrDirectContext* gr_context, VideoFramePool* pool = nullptr);
...
[[nodiscard]] MEDIA_EXPORT EncoderStatus ConvertAndScaleFrame(const VideoFrame& src_frame, VideoFrame& dst_frame, std::vector<uint8_t>& tmp_buf);
