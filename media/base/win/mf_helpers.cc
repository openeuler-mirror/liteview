...
Microsoft::WRL::ComPtr<IMFSample> CreateEmptySampleWithBuffer(uint32_t buffer_length, int align)
{
    ...
    HRESULT hr = MFCreateSampleXp(&sample);
    ...
    if (align == 0) {
        ...
        hr = MFCreateMemoryBufferXp(buffer_length, &buffer);
    } else {
        hr = MFCreateAlignedMemoryBufferXp(buffer_length, align - 1, &buffer);
    }
...
HRESULT SetDebugName(ID3D11DeviceChild* d3d11_device_child, const char* debug_string) { return SetDebugNameInternal(d3d11_device_child, debug_string); }

HRESULT SetDebugName(ID3D11Device* d3d11_device, const char* debug_string) { return SetDebugNameInternal(d3d11_device, debug_string); }

HRESULT SetDebugName(IDXGIObject* dxgi_object, const char* debug_string) { return SetDebugNameInternal(dxgi_object, debug_string); }
