...
std::ostream& operator<<(std::ostream& out, const PipelineStatus& status) { return out << PipelineStatusToString(status); }
...
bool operator!=(const PipelineStatistics& first, const PipelineStatistics& second) { return !(first == second); }
