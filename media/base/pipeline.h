...
public:
    ...
    public:
        ...
        virtual void OnAddTextTrack(const TextTrackConfig& config, AddTextTrackDoneCB done_cb) = 0;
    ...
    virtual void OnSelectedVideoTrackChanged(absl::optional<MediaTrack::Id> selected_track_id, base::OnceClosure change_completed_cb) = 0;
    ...
    // activation.
    virtual void SetWasPlayedWithUserActivation(bool was_played_with_user_activation) = 0;
