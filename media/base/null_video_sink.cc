...
NullVideoSink::NullVideoSink(bool clockless, base::TimeDelta interval, const NewFrameCB& new_frame_cb, const scoped_refptr<base::SingleThreadTaskRunner>& task_runner)
...
NullVideoSink::~NullVideoSink() { DCHECK(!started_); }
