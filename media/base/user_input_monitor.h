...
void MEDIA_EXPORT WriteKeyPressMonitorCount(const base::WritableSharedMemoryMapping& shmem, uint32_t count);
...
public:
    ...
    static std::unique_ptr<UserInputMonitor> Create(scoped_refptr<base::SingleThreadTaskRunner> io_task_runner, scoped_refptr<base::SingleThreadTaskRunner> ui_task_runner);
