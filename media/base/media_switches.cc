...
BASE_FEATURE(kFFmpegDecodeOpaqueVP8, "FFmpegDecodeOpaqueVP8", base::FEATURE_ENABLED_BY_DEFAULT);
...
BASE_FEATURE(kPictureInPicture, "PictureInPicture", base::FEATURE_ENABLED_BY_DEFAULT);
...
BASE_FEATURE(kPreloadMetadataLazyLoad, "PreloadMetadataLazyLoad", base::FEATURE_ENABLED_BY_DEFAULT);
...
BASE_FEATURE(kUseDecoderStreamForWebRTC, "UseDecoderStreamForWebRTC", base::FEATURE_DISABLED_BY_DEFAULT);

// If enabled, when RTCVideoDecoderAdapter is used then SW decoders will be
// exposed directly to WebRTC.
BASE_FEATURE(kExposeSwDecodersToWebRTC, "ExposeSwDecodersToWebRTC", base::FEATURE_DISABLED_BY_DEFAULT);

// Let video without audio be paused when it is playing in the background.
BASE_FEATURE(kBackgroundVideoPauseOptimization, "BackgroundVideoPauseOptimization", base::FEATURE_ENABLED_BY_DEFAULT);
...
BASE_FEATURE(kCdmProcessSiteIsolation, "CdmProcessSiteIsolation", base::FEATURE_ENABLED_BY_DEFAULT);
...
BASE_FEATURE(kChromeWideEchoCancellation, "ChromeWideEchoCancellation", base::FEATURE_DISABLED_BY_DEFAULT);
...
const base::FeatureParam<int> kChromeWideEchoCancellationProcessingFifoSize { &kChromeWideEchoCancellation, "processing_fifo_size", 0 };
...
const base::FeatureParam<bool> kChromeWideEchoCancellationMinimizeResampling { &kChromeWideEchoCancellation, "minimize_resampling", true };
...
const base::FeatureParam<double> kChromeWideEchoCancellationDynamicMixingTimeout { &kChromeWideEchoCancellation, "mixing_buffer_duration_percent", -1.0 };
...
const base::FeatureParam<bool> kChromeWideEchoCancellationAllowAllSampleRates { &kChromeWideEchoCancellation, "allow_all_sample_rates", true };
#endif
...
BASE_FEATURE(kOpenscreenCastStreamingSession, "OpenscreenCastStreamingSession", base::FEATURE_DISABLED_BY_DEFAULT);
...
BASE_FEATURE(kGav1VideoDecoder, "Gav1VideoDecoder", base::FEATURE_DISABLED_BY_DEFAULT);
...
BASE_FEATURE(kGlobalMediaControlsForCast, "GlobalMediaControlsForCast", base::FEATURE_DISABLED_BY_DEFAULT);
#endif

// Allow Global Media Controls in system tray of CrOS.
BASE_FEATURE(kGlobalMediaControlsForChromeOS, "GlobalMediaControlsForChromeOS", base::FEATURE_ENABLED_BY_DEFAULT);

constexpr base::FeatureParam<kCrosGlobalMediaControlsPinOptions>::Option kCrosGlobalMediaControlsParamOptions[] = { { kCrosGlobalMediaControlsPinOptions::kPin, "default-pinned" },
    { kCrosGlobalMediaControlsPinOptions::kNotPin, "default-unpinned" }, { kCrosGlobalMediaControlsPinOptions::kHeuristic, "heuristic" } };

constexpr base::FeatureParam<kCrosGlobalMediaControlsPinOptions> kCrosGlobalMediaControlsPinParam(
    &kGlobalMediaControlsForChromeOS, "CrosGlobalMediaControlsPinParam", kCrosGlobalMediaControlsPinOptions::kHeuristic, &kCrosGlobalMediaControlsParamOptions);
...
BASE_FEATURE(kGlobalMediaControlsModernUI, "GlobalMediaControlsModernUI", base::FEATURE_DISABLED_BY_DEFAULT);
...
BASE_FEATURE(kUseMediaHistoryStore, "UseMediaHistoryStore", base::FEATURE_DISABLED_BY_DEFAULT);
...
BASE_FEATURE(kVaapiVideoDecodeLinux, "VaapiVideoDecoder", base::FEATURE_ENABLED_BY_DEFAULT);

BASE_FEATURE(kVaapiVideoEncodeLinux, "VaapiVideoEncoder", base::FEATURE_DISABLED_BY_DEFAULT);
...
BASE_FEATURE(kVaapiAV1Decoder, "VaapiAV1Decoder", base::FEATURE_ENABLED_BY_DEFAULT);
...
BASE_FEATURE(kGlobalVaapiLock, "GlobalVaapiLock", base::FEATURE_ENABLED_BY_DEFAULT);
...
BASE_FEATURE(kVaapiVp8TemporalLayerHWEncoding, "VaapiVp8TemporalLayerEncoding", base::FEATURE_DISABLED_BY_DEFAULT);
// Enable VP9 k-SVC encoding with HW encoder for webrtc use case on ChromeOS.
BASE_FEATURE(kVaapiVp9kSVCHWEncoding, "VaapiVp9kSVCHWEncoding", base::FEATURE_ENABLED_BY_DEFAULT);
...
BASE_FEATURE(kVp9kSVCHWDecoding, "Vp9kSVCHWDecoding",
#if BUILDFLAG(IS_CHROMEOS)
    base::FEATURE_ENABLED_BY_DEFAULT
#else
    base::FEATURE_DISABLED_BY_DEFAULT
...
BASE_FEATURE(kKeepRvfcFrameAlive, "keep-rvfc-frame-alive", base::FEATURE_DISABLED_BY_DEFAULT);
...
BASE_FEATURE(kLiveCaptionMultiLanguage, "LiveCaptionMultiLanguage", base::FEATURE_DISABLED_BY_DEFAULT);
...
BASE_FEATURE(kLiveCaptionSystemWideOnChromeOS, "LiveCaptionSystemWideOnChromeOS", base::FEATURE_DISABLED_BY_DEFAULT);

// Live Translate translates captions generated by Live Caption.
BASE_FEATURE(kLiveTranslate, "LiveTranslate", base::FEATURE_DISABLED_BY_DEFAULT);
...
BASE_FEATURE(kHardwareSecureDecryptionExperiment, "HardwareSecureDecryptionExperiment", base::FEATURE_DISABLED_BY_DEFAULT);
...
BASE_FEATURE(kWakeLockOptimisationHiddenMuted, "kWakeLockOptimisationHiddenMuted", base::FEATURE_ENABLED_BY_DEFAULT);

// If active, enable HiDPI mode that increases the display scale factor
// while capturing a low-resolution tab.
BASE_FEATURE(kWebContentsCaptureHiDpi, "WebContentsCaptureHiDPI", base::FEATURE_DISABLED_BY_DEFAULT);
...
BASE_FEATURE(kResolutionBasedDecoderPriority, "ResolutionBasedDecoderPriority", base::FEATURE_DISABLED_BY_DEFAULT);

// Forces use of hardware (platform) video decoders in
// `media::DecoderSelector`.
BASE_FEATURE(kForceHardwareVideoDecoders, "ForceHardwareVideoDecoders", base::FEATURE_DISABLED_BY_DEFAULT);

// Forces use of hardware (platform) audio decoders in
// `media::DecoderSelector`.
BASE_FEATURE(kForceHardwareAudioDecoders, "ForceHardwareAudioDecoders", base::FEATURE_DISABLED_BY_DEFAULT);
...
// platform
BASE_FEATURE(kAutoplayIgnoreWebAudio, "AutoplayIgnoreWebAudio", base::FEATURE_DISABLED_BY_DEFAULT);
...
BASE_FEATURE(kPictureInPictureAPI, "PictureInPictureAPI", base::FEATURE_ENABLED_BY_DEFAULT);
...
BASE_FEATURE(kUsePooledSharedImageVideoProvider, "UsePooledSharedImageVideoProvider", base::FEATURE_ENABLED_BY_DEFAULT);

// Historically we hardcoded sRGB for color space. This flags controls if we
// pass real color space to VideoFrame/SharedImages.
BASE_FEATURE(kUseRealColorSpaceForAndroidVideo, "UseRealColorSpaceForAndroidVideo", base::FEATURE_ENABLED_BY_DEFAULT);
...
// ChromeOS.
BASE_FEATURE(kChromeOSHWVBREncoding, "ChromeOSHWVBREncoding", base::FEATURE_DISABLED_BY_DEFAULT);
...
BASE_FEATURE(kUseChromeOSDirectVideoDecoder, "UseChromeOSDirectVideoDecoder", base::FEATURE_ENABLED_BY_DEFAULT);
...
// do this processing.
BASE_FEATURE(kPreferLibYuvImageProcessor, "PreferLibYUVImageProcessor", base::FEATURE_DISABLED_BY_DEFAULT);
...
BASE_FEATURE(kUseAlternateVideoDecoderImplementation, "UseAlternateVideoDecoderImplementation", base::FEATURE_DISABLED_BY_DEFAULT);
#endif // BUILDFLAG(IS_CHROMEOS)
...
// used by GL.
BASE_FEATURE(kDelayCopyNV12Textures, "DelayCopyNV12Textures", base::FEATURE_ENABLED_BY_DEFAULT);
...
const base::Feature MEDIA_EXPORT kMediaFoundationAV1Encoding { "MediaFoundationAV1Encoding", base::FEATURE_DISABLED_BY_DEFAULT };
...
const base::Feature MEDIA_EXPORT kMediaFoundationH264CbpEncoding { "MediaFoundationH264CbpEncoding", base::FEATURE_DISABLED_BY_DEFAULT };

// Enables VP9 encode acceleration for Windows.
const base::Feature MEDIA_EXPORT kMediaFoundationVP9Encoding { "MediaFoundationVP9Encoding", base::FEATURE_DISABLED_BY_DEFAULT };
...
BASE_FEATURE(kMediaFoundationD3D11VideoCapture, "MediaFoundationD3D11VideoCapture", base::FEATURE_DISABLED_BY_DEFAULT);

// Enables VP8 decode acceleration for Windows.
const base::Feature MEDIA_EXPORT kMediaFoundationVP8Decoding { "MediaFoundationVP8Decoding", base::FEATURE_DISABLED_BY_DEFAULT };
...
const base::Feature MEDIA_EXPORT kWasapiRawAudioCapture { "WASAPIRawAudioCapture", base::FEATURE_ENABLED_BY_DEFAULT };

// Emulates audio capture timestamps instead of using timestamps from the actual
// audio device.
// See crbug.com/1315231 for more details.
const base::Feature MEDIA_EXPORT kUseFakeAudioCaptureTimestamps { "UseFakeAudioCaptureTimestamps", base::FEATURE_DISABLED_BY_DEFAULT };
...
constexpr base::FeatureParam<MediaFoundationClearRenderingStrategy>::Option kMediaFoundationClearRenderingStrategyOptions[]
    = { { MediaFoundationClearRenderingStrategy::kDirectComposition, "direct-composition" }, { MediaFoundationClearRenderingStrategy::kFrameServer, "frame-server" },
...
#if BUILDFLAG(IS_CHROMEOS)
const base::Feature MEDIA_EXPORT kDeprecateLowUsageCodecs { "DeprecateLowUsageCodecs", base::FEATURE_ENABLED_BY_DEFAULT };
#endif // BUILDFLAG(IS_CHROMEOS)

#if BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_CHROMEOS)
// Spawn utility processes to perform hardware decode acceleration instead of
// using the GPU process.
const base::Feature MEDIA_EXPORT kUseOutOfProcessVideoDecoding { "UseOutOfProcessVideoDecoding", base::FEATURE_DISABLED_BY_DEFAULT };
#endif // BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_CHROMEOS)

#if BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_CHROMEOS)
// Spawn utility processes to perform hardware encode acceleration instead of
// using the GPU process.
const base::Feature MEDIA_EXPORT kUseOutOfProcessVideoEncoding { "UseOutOfProcessVideoEncoding", base::FEATURE_DISABLED_BY_DEFAULT };
#endif // BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_CHROMEOS)
...
BASE_FEATURE(kMediaEngagementBypassAutoplayPolicies, "MediaEngagementBypassAutoplayPolicies", base::FEATURE_DISABLED_BY_DEFAULT);
BASE_FEATURE(kPreloadMediaEngagementData, "PreloadMediaEngagementData", base::FEATURE_DISABLED_BY_DEFAULT);
#else
BASE_FEATURE(kMediaEngagementBypassAutoplayPolicies, "MediaEngagementBypassAutoplayPolicies", base::FEATURE_ENABLED_BY_DEFAULT);
BASE_FEATURE(kPreloadMediaEngagementData, "PreloadMediaEngagementData", base::FEATURE_ENABLED_BY_DEFAULT);
#endif
...
BASE_FEATURE(kMediaSessionWebRTC, "MediaSessionWebRTC", base::FEATURE_ENABLED_BY_DEFAULT);
...
// estimations.
BASE_FEATURE(kBresenhamCadence, "BresenhamCadence", base::FEATURE_DISABLED_BY_DEFAULT);
...
bool IsHardwareSecureDecryptionEnabled() { return base::FeatureList::IsEnabled(kHardwareSecureDecryption) || base::FeatureList::IsEnabled(kHardwareSecureDecryptionExperiment); }
...
#if BUILDFLAG(IS_WIN)
bool IsMediaFoundationH264CbpEncodingEnabled() { return base::FeatureList::IsEnabled(kMediaFoundationH264CbpEncoding); }

bool IsMediaFoundationD3D11VideoCaptureEnabled() { return base::FeatureList::IsEnabled(kMediaFoundationD3D11VideoCapture); }
#endif
