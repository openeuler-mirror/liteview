...
public:
    ...
    VideoDecoderConfig(VideoCodec codec, VideoCodecProfile profile, AlphaMode alpha_mode, const VideoColorSpace& color_space, VideoTransformation transformation,
    ...
    void set_visible_rect(const gfx::Rect& visible_rect) { visible_rect_ = visible_rect; }
    ...
    void set_natural_size(const gfx::Size& natural_size) { natural_size_ = natural_size; }
    ...
    void set_aspect_ratio(const VideoAspectRatio& aspect_ratio) { aspect_ratio_ = aspect_ratio; }
    ...
    bool is_encrypted() const { return encryption_scheme_ != EncryptionScheme::kUnencrypted; }

    // Encryption scheme used for encrypted buffers.
    EncryptionScheme encryption_scheme() const { return encryption_scheme_; }

    // Color space of the image data.
    void set_color_space_info(const VideoColorSpace& color_space) { color_space_info_ = color_space; }
    const VideoColorSpace& color_space_info() const { return color_space_info_; }

    // Dynamic range of the image data.
    void set_hdr_metadata(const gfx::HDRMetadata& hdr_metadata) { hdr_metadata_ = hdr_metadata; }
