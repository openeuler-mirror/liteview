...
bool ColorPlaneLayout::operator==(const ColorPlaneLayout& rhs) const { return stride == rhs.stride && offset == rhs.offset && size == rhs.size; }

bool ColorPlaneLayout::operator!=(const ColorPlaneLayout& rhs) const { return !(*this == rhs); }
