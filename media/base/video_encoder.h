...
public:
    ...
    // becomes available.
    using OutputCB = base::RepeatingCallback<void(VideoEncoderOutput output, absl::optional<CodecDescription>)>;
    ...
    virtual void Initialize(VideoCodecProfile profile, const Options& options, OutputCB output_cb, EncoderStatusCB done_cb) = 0;
    ...
    virtual void Encode(scoped_refptr<VideoFrame> frame, bool key_frame, EncoderStatusCB done_cb) = 0;
