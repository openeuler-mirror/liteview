...
public:
    ...
    using TrackChangeCB = base::OnceCallback<void(DemuxerStream::Type type, const std::vector<DemuxerStream*>&)>;
    ...
    virtual absl::optional<container_names::MediaContainerName> GetContainerForMetrics() const = 0;
