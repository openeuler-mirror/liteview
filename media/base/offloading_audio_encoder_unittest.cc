...
protected:
    void SetUp() override
    {
        ...
        EXPECT_CALL(*mock_audio_encoder_, OnDestruct()).WillOnce(Invoke([this]() { EXPECT_TRUE(work_runner_->RunsTasksInCurrentSequence()); }));
    }
...
TEST_F(OffloadingAudioEncoderTest, Initialize)
{
    ...
    AudioEncoder::OutputCB output_cb = base::BindLambdaForTesting([&](EncodedAudioBuffer, absl::optional<AudioEncoder::CodecDescription>) {
