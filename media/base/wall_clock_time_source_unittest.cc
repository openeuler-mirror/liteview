...
public:
    ...
    void AdvanceTimeInSeconds(int seconds) { tick_clock_->Advance(base::Seconds(seconds)); }

    int CurrentMediaTimeInSeconds() { return time_source_.CurrentMediaTime().InSeconds(); }

    void SetMediaTimeInSeconds(int seconds) { return time_source_.SetMediaTime(base::Seconds(seconds)); }
