...
struct UnsignedInt8ToFloat32TestConfig {
    ...
    static TargetTraits::ValueType PerformConversion(SourceTraits::ValueType source_value) { return SourceTraits::ToFloat(source_value); }
};
...
struct Float32ToUnsignedInt8TestConfig {
    ...
    static TargetTraits::ValueType PerformConversion(SourceTraits::ValueType source_value) { return TargetTraits::FromFloat(source_value); }
};
...
struct UnsignedInt8ToFloat64TestConfig {
    ...
    static TargetTraits::ValueType PerformConversion(SourceTraits::ValueType source_value) { return SourceTraits::ToDouble(source_value); }
};
...
struct Float64ToUnsignedInt8TestConfig {
    ...
    static TargetTraits::ValueType PerformConversion(SourceTraits::ValueType source_value) { return TargetTraits::FromDouble(source_value); }
};
...
typedef ::testing::Types<UnsignedInt8ToFloat32TestConfig, SignedInt16ToFloat32TestConfig, SignedInt32ToFloat32TestConfig, Float32ToUnsignedInt8TestConfig,
    Float32ToSignedInt16TestConfig, Float32ToSignedInt32TestConfig, UnsignedInt8ToFloat64TestConfig, SignedInt16ToFloat64TestConfig, SignedInt32ToFloat64TestConfig,
    Float64ToUnsignedInt8TestConfig, Float64ToSignedInt16TestConfig, Float64ToSignedInt32TestConfig>
    TestConfigs;
