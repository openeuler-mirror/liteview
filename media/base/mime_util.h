...
MEDIA_EXPORT void SplitCodecs(base::StringPiece, std::vector<std::string>* codecs_out);
...
MEDIA_EXPORT bool ParseVideoCodecString(base::StringPiece mime_type, base::StringPiece codec_id, bool* out_is_ambiguous, VideoCodec* out_codec, VideoCodecProfile* out_profile,
...
// in which case values for |out_*| arguments are undefined.
MEDIA_EXPORT bool ParseAudioCodecString(base::StringPiece mime_type, base::StringPiece codec_id, bool* out_is_ambiguous, AudioCodec* out_codec);
...
MEDIA_EXPORT SupportsType IsSupportedMediaFormat(base::StringPiece mime_type, const std::vector<std::string>& codecs);

// Similar to the above, but for encrypted formats.
MEDIA_EXPORT SupportsType IsSupportedEncryptedMediaFormat(base::StringPiece mime_type, const std::vector<std::string>& codecs);
