...
public:
    ...
    double ProvideInput() { return mixer_input_->ProvideInput(audio_bus_.get(), 0); }
    ...
    MockAudioRendererSink* GetMockSink() const { return reinterpret_cast<MockAudioRendererSink*>(mixer_input_->sink_.get()); }
