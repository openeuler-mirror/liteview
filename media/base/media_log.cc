...
std::string MediaLog::GetErrorMessageLocked() { return ""; }
...
LogHelper::LogHelper(MediaLogMessageLevel level, const std::unique_ptr<MediaLog>& media_log)
    : LogHelper(level, media_log.get())
{
}

LogHelper::~LogHelper() { media_log_->AddMessage(level_, stream_.str()); }
