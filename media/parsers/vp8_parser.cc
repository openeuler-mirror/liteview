...
Vp8FrameHeader::Vp8FrameHeader(const Vp8FrameHeader& fhdr) { memcpy(this, &fhdr, sizeof(*this)); }
...
static inline uint32_t GetBitsAt(uint32_t data, size_t shift, size_t num_bits) { return ((data >> shift) & ((1 << num_bits) - 1)); }
