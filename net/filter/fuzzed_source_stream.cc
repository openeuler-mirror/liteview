...
FuzzedSourceStream::~FuzzedSourceStream() { DCHECK(!read_pending_); }
...
std::string FuzzedSourceStream::Description() const { return ""; }

bool FuzzedSourceStream::MayHaveMoreBytes() const { return !end_returned_; }
