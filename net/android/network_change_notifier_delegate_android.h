...
public:
    ...
    void NotifyMaxBandwidthChanged(JNIEnv* env, const base::android::JavaParamRef<jobject>& obj, jint subtype);
    ...
    void NotifyPurgeActiveNetworkList(JNIEnv* env, const base::android::JavaParamRef<jobject>& obj, const base::android::JavaParamRef<jlongArray>& active_networks);
    ...
    bool RegisterNetworkCallbackFailed() const { return register_network_callback_failed_; }
