...
public:
    ...
    void OverrideRadioActivityForTesting(absl::optional<base::android::RadioDataActivity> radio_activity) { radio_activity_override_for_testing_ = radio_activity; }
    void OverrideRadioTypeForTesting(absl::optional<base::android::RadioConnectionType> radio_type) { radio_type_override_for_testing_ = radio_type; }
    void OverrideLastCheckTimeForTesting(base::TimeTicks last_check_time) { last_check_time_ = last_check_time; }
