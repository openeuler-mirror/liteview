...
bool SignWithPrivateKey(const base::android::JavaRef<jobject>& private_key, base::StringPiece algorithm, base::span<const uint8_t> input, std::vector<uint8_t>* signature);
...
// Returns true on success, false on failure.
bool EncryptWithPrivateKey(const base::android::JavaRef<jobject>& private_key, base::StringPiece algorithm, base::span<const uint8_t> input, std::vector<uint8_t>* ciphertext);
