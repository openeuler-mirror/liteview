...
public:
    ...
    void Init() { address_tracker_.Init(); }
...
NetworkChangeNotifier::ConnectionType NetworkChangeNotifierAndroid::GetCurrentConnectionType() const { return delegate_->GetCurrentConnectionType(); }

NetworkChangeNotifier::ConnectionCost NetworkChangeNotifierAndroid::GetCurrentConnectionCost() { return delegate_->GetCurrentConnectionCost(); }

NetworkChangeNotifier::ConnectionSubtype NetworkChangeNotifierAndroid::GetCurrentConnectionSubtype() const { return delegate_->GetCurrentConnectionSubtype(); }
...
void NetworkChangeNotifierAndroid::ForceNetworkHandlesSupportedForTesting() { force_network_handles_supported_for_testing_ = true; }
...
void NetworkChangeNotifierAndroid::GetCurrentConnectedNetworks(NetworkChangeNotifier::NetworkList* networks) const { delegate_->GetCurrentlyConnectedNetworks(networks); }
...
handles::NetworkHandle NetworkChangeNotifierAndroid::GetCurrentDefaultNetwork() const { return delegate_->GetCurrentDefaultNetwork(); }

void NetworkChangeNotifierAndroid::OnConnectionTypeChanged() { BlockingThreadObjects::NotifyNetworkChangeNotifierObservers(); }

void NetworkChangeNotifierAndroid::OnConnectionCostChanged() { NetworkChangeNotifier::NotifyObserversOfConnectionCostChange(); }
...
void NetworkChangeNotifierAndroid::OnDefaultNetworkActive() { NetworkChangeNotifier::NotifyObserversOfDefaultNetworkActive(); }
...
{
    CHECK_EQ(NetId::INVALID, handles::kInvalidNetworkHandle) << "handles::kInvalidNetworkHandle doesn't match NetId::INVALID";
...
bool NetworkChangeNotifierAndroid::IsDefaultNetworkActiveInternal() { return delegate_->IsDefaultNetworkActive(); }

void NetworkChangeNotifierAndroid::DefaultNetworkActiveObserverAdded() { delegate_->DefaultNetworkActiveObserverAdded(); }

void NetworkChangeNotifierAndroid::DefaultNetworkActiveObserverRemoved() { delegate_->DefaultNetworkActiveObserverRemoved(); }
