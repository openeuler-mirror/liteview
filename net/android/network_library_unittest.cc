...
TEST(NetworkLibraryTest, CaptivePortal) { EXPECT_FALSE(android::GetIsCaptivePortal()); }
...
TEST(NetworkLibraryTest, BindToNetwork)
{
    ...
    std::array sockets { socket_tcp_ipv4.SocketDescriptorForTesting(), socket_tcp_ipv6.SocketDescriptorForTesting(), socket_udp_ipv4.SocketDescriptorForTesting(),
