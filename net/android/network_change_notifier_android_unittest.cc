...
public:
    ...
    void OnMaxBandwidthChanged(double max_bandwidth_mbps, net::NetworkChangeNotifier::ConnectionType type) override { max_bandwidth_notifications_count_++; }
    ...
    void OnDefaultNetworkActive() override { default_network_active_notifications_count_++; }
    ...
    int bandwidth_notifications_count() const { return max_bandwidth_notifications_count_; }
    int default_network_active_notifications_count() const { return default_network_active_notifications_count_; }
...
public:
    ...
    void OnConnectionTypeChanged(NetworkChangeNotifier::ConnectionType connection_type) override { notifications_count_++; }
...
public:
    ...
    void OnConnectionCostChanged(NetworkChangeNotifier::ConnectionCost cost) override { notifications_count_++; }
...
public:
    ...
    void OnMaxBandwidthChanged(double max_bandwidth_mbps, NetworkChangeNotifier::ConnectionType type) override { notifications_count_++; }
...
protected:
    ...
    void RunTest(const base::RepeatingCallback<int(void)>& notifications_count_getter, const base::RepeatingCallback<ConnectionType(void)>& connection_type_getter)
    {
    ...
    bool is_default_network_active_api_supported() const { return delegate_.is_default_network_active_api_supported_; }
...
protected:
    ...
    void ForceNetworkHandlesSupportedForTesting() { notifier_.ForceNetworkHandlesSupportedForTesting(); }
...
protected:
    NetworkChangeNotifierDelegateAndroidTest() { delegate_.RegisterObserver(&delegate_observer_); }

    ~NetworkChangeNotifierDelegateAndroidTest() override { delegate_.UnregisterObserver(&delegate_observer_); }
