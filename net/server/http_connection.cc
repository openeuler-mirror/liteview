...
int HttpConnection::ReadIOBuffer::GetCapacity() const { return base_->capacity(); }
...
char* HttpConnection::ReadIOBuffer::StartOfBuffer() const { return base_->StartOfBuffer(); }
...
int HttpConnection::ReadIOBuffer::RemainingCapacity() const { return base_->RemainingCapacity(); }
...
bool HttpConnection::QueuedWriteIOBuffer::IsEmpty() const { return pending_data_.empty(); }
