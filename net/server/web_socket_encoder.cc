...
void EncodeFrameHybi17(base::StringPiece message, int masking_key, bool compressed, WebSocketFrameHeader::OpCodeEnum op_code, std::string* output)
{
...
// static
std::unique_ptr<WebSocketEncoder> WebSocketEncoder::CreateServer() { return base::WrapUnique(new WebSocketEncoder(FOR_SERVER, nullptr, nullptr)); }
