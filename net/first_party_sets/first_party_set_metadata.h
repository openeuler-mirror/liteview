...
public:
    ...
    FirstPartySetMetadata(const SamePartyContext& context, const FirstPartySetEntry* frame_entry, const FirstPartySetEntry* top_frame_entry);
    ...
    // more easily.
    const absl::optional<FirstPartySetEntry>& frame_entry() const { return frame_entry_; }
    const absl::optional<FirstPartySetEntry>& top_frame_entry() const { return top_frame_entry_; }
