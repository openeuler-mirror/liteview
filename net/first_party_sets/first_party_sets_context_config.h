...
public:
    using OverrideSets = base::flat_map<SchemefulSite, absl::optional<FirstPartySetEntry>>;
    ...
    absl::optional<absl::optional<FirstPartySetEntry>> FindOverride(const SchemefulSite& site) const;
    ...
    bool ForEachCustomizationEntry(base::FunctionRef<bool(const SchemefulSite&, const absl::optional<FirstPartySetEntry>&)> f) const;
