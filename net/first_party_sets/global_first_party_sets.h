...
public:
    ...
    GlobalFirstPartySets(base::flat_map<SchemefulSite, FirstPartySetEntry> entries, base::flat_map<SchemefulSite, SchemefulSite> aliases);
    GlobalFirstPartySets(
    ...
    FirstPartySetsContextConfig ComputeConfig(const std::vector<base::flat_map<SchemefulSite, FirstPartySetEntry>>& replacement_sets,
    ...
    // insecure.
    absl::optional<FirstPartySetEntry> FindEntry(const SchemefulSite& site, const FirstPartySetsContextConfig& config) const;
    ...
    void ApplyManuallySpecifiedSet(const base::flat_map<SchemefulSite, FirstPartySetEntry>& manual_entries);
    ...
    const base::flat_map<SchemefulSite, FirstPartySetEntry>& manual_sets() const { return manual_sets_; }
...
private:
    ...
    std::vector<base::flat_map<SchemefulSite, FirstPartySetEntry>> NormalizeAdditionSets(const std::vector<base::flat_map<SchemefulSite, FirstPartySetEntry>>& addition_sets) const;
    ...
    const base::flat_map<SchemefulSite, FirstPartySetEntry>& entries() const { return entries_; }

    const base::flat_map<SchemefulSite, SchemefulSite>& aliases() const { return aliases_; }

    const FirstPartySetsContextConfig& manual_config() const { return manual_config_; }
