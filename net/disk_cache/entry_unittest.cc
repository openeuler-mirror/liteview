...
{
    const int kSize1 = 10;
    scoped_refptr<net::IOBuffer> buffer1 = base::MakeRefCounted<net::IOBuffer>(kSize1);
    ...
    scoped_refptr<net::IOBuffer> buffer2 = base::MakeRefCounted<net::IOBuffer>(kSize2);
    scoped_refptr<net::IOBuffer> buffer3 = base::MakeRefCounted<net::IOBuffer>(kSize3);
...
void DiskCacheEntryTest::StreamAccess()
{
    ...
    scoped_refptr<net::IOBuffer> buffer1 = base::MakeRefCounted<net::IOBuffer>(kBufferSize);
    ...
    scoped_refptr<net::IOBuffer> buffer2 = base::MakeRefCounted<net::IOBuffer>(kReadBufferSize);
    for (int i = 0; i < kNumStreams; i++) {
...
void DiskCacheEntryTest::ReuseEntry(int size, int stream_index)
{
    ...
    scoped_refptr<net::IOBuffer> buffer = base::MakeRefCounted<net::IOBuffer>(size);
...
void VerifyContentSparseIO(disk_cache::Entry* entry, int64_t offset, char* buffer, int size)
{
    ...
    scoped_refptr<net::IOBuffer> buf_1 = base::MakeRefCounted<net::IOBuffer>(size);
...
void DiskCacheEntryTest::BasicSparseIO()
{
    ...
    scoped_refptr<net::IOBuffer> buf_1 = base::MakeRefCounted<net::IOBuffer>(kSize);
    scoped_refptr<net::IOBuffer> buf_2 = base::MakeRefCounted<net::IOBuffer>(kSize);
...
TEST_F(DiskCacheEntryTest, GetAvailableRangeBlockFileDiscontinuous)
{
    ...
    scoped_refptr<net::IOBuffer> buf_2k = base::MakeRefCounted<net::IOBuffer>(2 * 1024);
    CacheTestFillBuffer(buf_2k->data(), 2 * 1024, false);

    const int kSmallSize = 612; // sub-1k
    scoped_refptr<net::IOBuffer> buf_small = base::MakeRefCounted<net::IOBuffer>(kSmallSize);
...
TEST_F(DiskCacheEntryTest, MemoryOnlyMisalignedSparseIO)
{
    ...
    for (int i = 0; i < kSize; i += 1024) {
        scoped_refptr<net::WrappedIOBuffer> buf_3 = base::MakeRefCounted<net::WrappedIOBuffer>(buf_1->data() + i);
...
void DiskCacheEntryTest::SparseClipEnd(int64_t max_index, bool expect_unsupported)
{
    ...
    scoped_refptr<net::IOBuffer> read_buf = base::MakeRefCounted<net::IOBuffer>(kSize * 2);
...
bool DiskCacheEntryTest::SimpleCacheMakeBadChecksumEntry(const std::string& key, int data_size)
{
    ...
    scoped_refptr<net::IOBuffer> buffer = base::MakeRefCounted<net::IOBuffer>(data_size);
...
TEST_F(DiskCacheEntryTest, SimpleCacheBadChecksum)
{
    ...
    scoped_refptr<net::IOBuffer> read_buffer = base::MakeRefCounted<net::IOBuffer>(kLargeSize);
...
TEST_F(DiskCacheEntryTest, SimpleCacheOptimistic)
{
    ...
    const int kSize2 = 20;
    scoped_refptr<net::IOBuffer> buffer1 = base::MakeRefCounted<net::IOBuffer>(kSize1);
    scoped_refptr<net::IOBuffer> buffer1_read = base::MakeRefCounted<net::IOBuffer>(kSize1);
    scoped_refptr<net::IOBuffer> buffer2 = base::MakeRefCounted<net::IOBuffer>(kSize2);
    scoped_refptr<net::IOBuffer> buffer2_read = base::MakeRefCounted<net::IOBuffer>(kSize2);
    CacheTestFillBuffer(buffer1->data(), kSize1, false);
    CacheTestFillBuffer(buffer2->data(), kSize2, false);
...
TEST_F(DiskCacheEntryTest, SimpleCacheOptimisticWriteReleases)
{
    ...
    scoped_refptr<net::IOBuffer> buffer1 = base::MakeRefCounted<net::IOBuffer>(kWriteSize);
...
TEST_F(DiskCacheEntryTest, SimpleCacheInFlightTruncate)
{
    ...
    scoped_refptr<net::IOBuffer> write_buffer = base::MakeRefCounted<net::IOBuffer>(kBufferSize);
    ...
    scoped_refptr<net::IOBuffer> read_buffer = base::MakeRefCounted<net::IOBuffer>(kReadBufferSize);
    CallbackTest read_callback(&helper, false);
    EXPECT_EQ(net::ERR_IO_PENDING, entry->ReadData(1, 0, read_buffer.get(), kReadBufferSize, base::BindOnce(&CallbackTest::Run, base::Unretained(&read_callback))));
    ++expected;

    // Truncate the entry to the length of that read.
    scoped_refptr<net::IOBuffer> truncate_buffer = base::MakeRefCounted<net::IOBuffer>(kReadBufferSize);
    CacheTestFillBuffer(truncate_buffer->data(), kReadBufferSize, false);
    CallbackTest truncate_callback(&helper, false);
    EXPECT_EQ(net::ERR_IO_PENDING, entry->WriteData(1, 0, truncate_buffer.get(), kReadBufferSize, base::BindOnce(&CallbackTest::Run, base::Unretained(&truncate_callback)), true));
    ++expected;
...
TEST_F(DiskCacheEntryTest, SimpleCacheInFlightRead)
{
    ...
    CallbackTest write_callback(&helper, false);
    EXPECT_EQ(net::ERR_IO_PENDING, entry->WriteData(1, 0, write_buffer.get(), kBufferSize, base::BindOnce(&CallbackTest::Run, base::Unretained(&write_callback)), true));
    ++expected;

    scoped_refptr<net::IOBuffer> read_buffer = base::MakeRefCounted<net::IOBuffer>(kBufferSize);
    CallbackTest read_callback(&helper, false);
...
TEST_F(DiskCacheEntryTest, SimpleCacheMultipleReadersCheckCRC2)
{
    ...
    scoped_refptr<net::IOBuffer> read_buffer1 = base::MakeRefCounted<net::IOBuffer>(size);
    scoped_refptr<net::IOBuffer> read_buffer2 = base::MakeRefCounted<net::IOBuffer>(size);
...
TEST_F(DiskCacheEntryTest, SimpleCacheReadCombineCRC)
{
    ...
    scoped_refptr<net::IOBuffer> buffer1_read1 = base::MakeRefCounted<net::IOBuffer>(buf_len);
    ...
    offset = buf_len;
    buf_len = kHalfSize;
    scoped_refptr<net::IOBuffer> buffer1_read2 = base::MakeRefCounted<net::IOBuffer>(buf_len);
...
TEST_F(DiskCacheEntryTest, SimpleCacheNonSequentialWrite)
{
    ...
    for (int i = 0; i < disk_cache::kSimpleEntryStreamCount; ++i) {
        ...
        scoped_refptr<net::IOBuffer> buffer1_read1 = base::MakeRefCounted<net::IOBuffer>(kSize);
...
TEST_F(DiskCacheEntryTest, SimpleCacheStream1SizeChanges)
{
    ...
    const int kSize = 100;
    scoped_refptr<net::IOBuffer> buffer = base::MakeRefCounted<net::IOBuffer>(kSize);
    scoped_refptr<net::IOBuffer> buffer_read = base::MakeRefCounted<net::IOBuffer>(kSize);
    CacheTestFillBuffer(buffer->data(), kSize, false);
...
TEST_F(DiskCacheEntryTest, SimpleCacheCRCRewrite)
{
    ...
    const int kSize = 2 * kHalfSize;
    scoped_refptr<net::IOBuffer> buffer1 = base::MakeRefCounted<net::IOBuffer>(kSize);
    scoped_refptr<net::IOBuffer> buffer2 = base::MakeRefCounted<net::IOBuffer>(kHalfSize);
    CacheTestFillBuffer(buffer1->data(), kSize, false);
...
TEST_F(DiskCacheEntryTest, SimpleCacheNoSideDataEOF)
{
    ...
    scoped_refptr<net::IOBuffer> check_stream_data = base::MakeRefCounted<net::IOBuffer>(kSize);
...
TEST_F(DiskCacheEntryTest, SimpleCacheReadWithoutKeySHA256)
{
    ...
    scoped_refptr<net::IOBuffer> stream_0_iobuffer = base::MakeRefCounted<net::StringIOBuffer>(stream_0_data);
    ...
    scoped_refptr<net::IOBuffer> stream_1_iobuffer = base::MakeRefCounted<net::StringIOBuffer>(stream_1_data);
    ...
    scoped_refptr<net::IOBuffer> check_stream_0_data = base::MakeRefCounted<net::IOBuffer>(stream_0_data.size());
    ...
    scoped_refptr<net::IOBuffer> check_stream_1_data = base::MakeRefCounted<net::IOBuffer>(stream_1_data.size());
...
TEST_F(DiskCacheEntryTest, SimpleCacheCreateCollision)
{
    ...
    scoped_refptr<net::IOBuffer> buffer1 = base::MakeRefCounted<net::IOBuffer>(kSize);
    scoped_refptr<net::IOBuffer> buffer2 = base::MakeRefCounted<net::IOBuffer>(kSize);
    scoped_refptr<net::IOBuffer> read_buffer = base::MakeRefCounted<net::IOBuffer>(kSize);
    CacheTestFillBuffer(buffer1->data(), kSize, false);
    CacheTestFillBuffer(buffer2->data(), kSize, false);
...
TEST_F(DiskCacheEntryTest, SimpleCacheChecksumpScrewUp)
{
    ...
    scoped_refptr<net::IOBuffer> big_buffer = base::MakeRefCounted<net::IOBuffer>(kDoubleSize);
...
TEST_F(DiskCacheEntryTest, LastUsedTimePersists) { LastUsedTimePersists(); }
...
void DiskCacheEntryTest::TruncateBackwards()
{
    ...
    scoped_refptr<net::IOBuffer> buffer = base::MakeRefCounted<net::IOBuffer>(kBigSize);
    CacheTestFillBuffer(buffer->data(), kBigSize, false);
    scoped_refptr<net::IOBuffer> read_buf = base::MakeRefCounted<net::IOBuffer>(kBigSize);
...
TEST_F(DiskCacheEntryTest, BlockFileOptimisticWrite)
{
    ...
    scoped_refptr<net::IOBuffer> write_buf1 = base::MakeRefCounted<net::IOBuffer>(kSize1);
    CacheTestFillBuffer(write_buf1->data(), kSize1, false);

    net::TestCompletionCallback cb_write1;
    EXPECT_EQ(net::ERR_IO_PENDING, entry->WriteData(0, 0, write_buf1.get(), kSize1, cb_write1.callback(), true));
    ...
    scoped_refptr<net::IOBuffer> write_buf2 = base::MakeRefCounted<net::IOBuffer>(kSize2);
    CacheTestFillBuffer(write_buf2->data(), kSize2, false);

    net::TestCompletionCallback cb_write2;
    EXPECT_EQ(net::ERR_IO_PENDING, entry->WriteData(0, 0, write_buf2.get(), kSize2, cb_write2.callback(), true));
    EXPECT_EQ(kSize2, cb_write2.WaitForResult());

    scoped_refptr<net::IOBuffer> read_buf = base::MakeRefCounted<net::IOBuffer>(kSize2);
    net::TestCompletionCallback cb_read;
    EXPECT_EQ(net::ERR_IO_PENDING, entry->ReadData(0, 0, read_buf.get(), kSize2, cb_read.callback()));
...
public:
    ...
    void InitCacheAndCreateEntryWithNoCrc(const std::string& key)
    {
        ...
        scoped_refptr<net::IOBuffer> second_half = base::MakeRefCounted<net::IOBuffer>(kRemSize);
    ...
    void TryRead(const std::string& key, bool expect_preread_stream1)
    {
        disk_cache::Entry* entry = nullptr;
        ASSERT_THAT(OpenEntry(key, &entry), IsOk());
        scoped_refptr<net::IOBuffer> read_buf = base::MakeRefCounted<net::IOBuffer>(kEntrySize);
        net::TestCompletionCallback cb;
