...
enum CrashLocation { ON_INSERT_1, ON_INSERT_2, ON_INSERT_3, ON_INSERT_4, ON_REMOVE_1, ON_REMOVE_2, ON_REMOVE_3, ON_REMOVE_4, ON_REMOVE_5, ON_REMOVE_6, ON_REMOVE_7, ON_REMOVE_8 };
...
Rankings::Iterator::Iterator() { memset(this, 0, sizeof(Iterator)); }
...
void Rankings::FreeRankingsBlock(CacheRankingsBlock* node) { TrackRankingsBlock(node, false); }
...
void Rankings::WriteHead(List list) { control_data_->heads[list] = heads_[list].value(); }

void Rankings::WriteTail(List list) { control_data_->tails[list] = tails_[list].value(); }
