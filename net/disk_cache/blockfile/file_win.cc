...
class CompletionHandler : public base::MessagePumpForIO::IOHandler, public base::RefCounted<CompletionHandler> {
public:
    CompletionHandler()
...
static base::LazyInstance<CompletionHandlerHolder>::DestructorAtExit g_completion_handler_holder = LAZY_INSTANCE_INITIALIZER;
...
bool File::Init(const base::FilePath& name)
{
    ...
    base::CurrentIOThread::Get()->RegisterIOHandler(base_file_.GetPlatformFile(), CompletionHandler::Get());
...
bool File::Read(void* buffer, size_t buffer_len, size_t offset)
{
    ...
    int ret = sync_base_file_.Read(offset, static_cast<char*>(buffer), buffer_len);
...
bool File::Write(const void* buffer, size_t buffer_len, size_t offset)
{
    ...
    int ret = sync_base_file_.Write(offset, static_cast<const char*>(buffer), buffer_len);
    return static_cast<int>(buffer_len) == ret;
}
