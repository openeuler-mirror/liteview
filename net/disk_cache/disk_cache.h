...
NET_EXPORT BackendResult CreateCacheBackend(net::CacheType type, net::BackendType backend_type, scoped_refptr<BackendFileOperationsFactory> file_operations,
    const base::FilePath& path, int64_t max_bytes, ResetHandling reset_handling, net::NetLog* net_log, base::OnceClosure post_cleanup_callback, BackendResultCallback callback);
...
public:
    ...
    virtual absl::optional<base::File::Info> GetFileInfo(const base::FilePath& path) = 0;
...
public:
    ...
    absl::optional<base::File::Info> GetFileInfo(const base::FilePath& path) override;
