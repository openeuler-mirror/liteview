...
bool SimpleFileEnumerator::HasError() const { return has_error_; }
...
absl::optional<SimpleFileEnumerator::Entry> SimpleFileEnumerator::Next()
{
    ...
    while (true) {
        ...
        return absl::make_optional<Entry>(std::move(path), file_info.size, file_info.last_accessed, file_info.last_modified);
    }
    dir_ = nullptr;
    return absl::nullopt;
}
...
bool SimpleFileEnumerator::HasError() const { return enumerator_.GetError() != base::File::FILE_OK; }
