...
public:
    ...
    uint32_t RawTimeForSorting() const { return last_used_time_seconds_since_epoch_; }
    ...
    static base::TimeDelta GetLowerEpsilonForTimeComparisons() { return base::Seconds(1); }
    static base::TimeDelta GetUpperEpsilonForTimeComparisons() { return base::TimeDelta(); }
...
class NET_EXPORT_PRIVATE SimpleIndex : public base::SupportsWeakPtr<SimpleIndex> {
public:
    ...
    SimpleIndex(const scoped_refptr<base::SequencedTaskRunner>& task_runner, scoped_refptr<BackendCleanupTracker> cleanup_tracker, SimpleIndexDelegate* delegate,
        net::CacheType cache_type, std::unique_ptr<SimpleIndexFile> simple_index_file);
