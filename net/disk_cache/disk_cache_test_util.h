...
struct BackendResultIsPendingHelper {
    bool operator()(const disk_cache::BackendResult& result) const { return result.net_error == net::ERR_IO_PENDING; }
};
...
struct EntryResultIsPendingHelper {
    bool operator()(const disk_cache::EntryResult& result) const { return result.net_error() == net::ERR_IO_PENDING; }
};
...
struct RangeResultIsPendingHelper {
    bool operator()(const disk_cache::RangeResult& result) const { return result.net_error == net::ERR_IO_PENDING; }
};
...
public:
    ...
    disk_cache::EntryResult ReleaseLastEntryResult() { return std::move(last_entry_result_); }
