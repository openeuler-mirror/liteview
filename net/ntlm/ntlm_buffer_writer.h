...
public:
    ...
    [[nodiscard]] bool WriteAvPairHeader(const AvPair& pair) { return WriteAvPairHeader(pair.avid, pair.avlen); }
...
private:
    ...
    const uint8_t* GetBufferPtrAtCursor() const { return GetBufferPtr() + GetCursor(); }
