...
public:
    ...
    bool operator==(const AddressList& other) const { return std::tie(endpoints_, dns_aliases_) == std::tie(other.endpoints_, other.dns_aliases_); }
    ...
    template <typename InputIt> void insert(iterator pos, InputIt first, InputIt last) { endpoints_.insert(pos, first, last); }
