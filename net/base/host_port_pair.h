...
public:
    ...
    bool operator<(const HostPortPair& other) const { return std::tie(port_, host_) < std::tie(other.port_, other.host_); }
    ...
    bool Equals(const HostPortPair& other) const { return host_ == other.host_ && port_ == other.port_; }
