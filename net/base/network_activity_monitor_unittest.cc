...
public:
    NetworkActivityMontiorTest() { activity_monitor::ResetBytesReceivedForTesting(); }
};
...
void VerifyBytesReceivedIsMultipleOf(uint64_t bytes) { EXPECT_EQ(0u, activity_monitor::GetBytesReceived() % bytes); }
