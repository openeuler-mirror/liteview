...
public:
    ...
    void SetConnectionType(ConnectionType connection_type) { connection_type_ = connection_type; }
    ...
    // ignored.
    void SetConnectionCost(ConnectionCost connection_cost) { connection_cost_ = connection_cost; }

    bool IsDefaultNetworkActiveInternal() override;

    void SetIsDefaultNetworkActiveInternalForTesting(bool is_active) { is_default_network_active_ = is_active; }
