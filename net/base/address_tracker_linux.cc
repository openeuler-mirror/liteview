...
AddressTrackerLinux::AddressTrackerLinux(const base::RepeatingClosure& address_callback, const base::RepeatingClosure& link_callback, const base::RepeatingClosure& tunnel_callback,
...
void AddressTrackerLinux::Init()
{
    ...
    if (tracking_) {
        watcher_ = base::FileDescriptorWatcher::WatchReadable(netlink_fd_.get(), base::BindRepeating(&AddressTrackerLinux::OnFileCanReadWithoutBlocking, base::Unretained(this)));
    }
}
