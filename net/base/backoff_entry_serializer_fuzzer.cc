...
public:
    ...
    BackoffEntry::Policy policy() const { return PolicyFromProto(input_.policy()); }
    base::Time parse_time() const { return base::Time() + base::Microseconds(input_.parse_time()); }
    base::TimeTicks parse_time_ticks() const { return base::TimeTicks() + base::Microseconds(input_.parse_time()); }
    base::Time serialize_time() const { return base::Time() + base::Microseconds(input_.serialize_time()); }
    base::TimeTicks now_ticks() const { return base::TimeTicks() + base::Microseconds(input_.now_ticks()); }
