...
enum class MediaResponseCacheType { kMediaResponseTransactionCacheDisabled = 0, kMediaResponseTransactionCacheEnabled = 1, kMaxValue = kMediaResponseTransactionCacheEnabled };
