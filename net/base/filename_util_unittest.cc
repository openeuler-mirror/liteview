...
void RunGenerateFileNameTestCase(const GenerateFilenameCase* test_case)
{
    ...
    base::FilePath file_path = GenerateFileName(
        GURL(test_case->url), test_case->content_disp_header, test_case->referrer_charset, test_case->suggested_filename, test_case->mime_type, default_filename);
    EXPECT_EQ(test_case->expected_filename, FilePathAsWString(file_path)) << "test case at line number: " << test_case->lineno << "; " << GetLocaleWarningString();
}
...
TEST(FilenameUtilTest, GenerateFileName)
{
    ...
    const GenerateFilenameCase selection_tests[] = {
        ...
        { __LINE__, "http://www.google.com/%EC%98%88%EC%88%A0%20%EC%98%88%EC%88%A0.jpg", "malformed_disposition", "", "", "", L"download", L"\uc608\uc220 \uc608\uc220.jpg" },
    ...
    const GenerateFilenameCase generation_tests[] = {
        ...
        { __LINE__, "http://www.example.com/download.py", "filename=%E5%B2%A1%E3%80%80%E5%B2%A1.txt", "utf-8", "", "text/plain", L"", L"\u5ca1\u3000\u5ca1.txt" },
    };
