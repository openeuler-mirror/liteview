...
//   "BLAH xxx:xx"      INVALID
NET_EXPORT ProxyServer PacResultElementToProxyServer(base::StringPiece pac_result_element);
...
NET_EXPORT ProxyServer ProxyUriToProxyServer(base::StringPiece uri, ProxyServer::Scheme default_scheme);
