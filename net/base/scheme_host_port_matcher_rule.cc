...
// static
std::unique_ptr<SchemeHostPortMatcherRule> SchemeHostPortMatcherRule::FromUntrimmedRawString(base::StringPiece raw_untrimmed)
{
...
bool SchemeHostPortMatcherRule::IsHostnamePatternRule() const { return false; }

SchemeHostPortMatcherHostnamePatternRule::SchemeHostPortMatcherHostnamePatternRule(const std::string& optional_scheme, const std::string& hostname_pattern, int optional_port)
...
bool SchemeHostPortMatcherHostnamePatternRule::IsHostnamePatternRule() const { return true; }
...
SchemeHostPortMatcherResult SchemeHostPortMatcherIPBlockRule::Evaluate(const GURL& url) const
{
    ...
    return IPAddressMatchesPrefix(ip_address, ip_prefix_, prefix_length_in_bits_) ? SchemeHostPortMatcherResult::kInclude : SchemeHostPortMatcherResult::kNoMatch;
}

std::string SchemeHostPortMatcherIPBlockRule::ToString() const { return description_; }
