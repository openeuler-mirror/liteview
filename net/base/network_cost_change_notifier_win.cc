...
NetworkCostChangeNotifierWin::CoCreateInstanceCallback& GetCoCreateInstanceOverride()
{
    static base::NoDestructor<NetworkCostChangeNotifierWin::CoCreateInstanceCallback> callback_for_testing;
...
class NetworkCostManagerEventSinkWin final : public Microsoft::WRL::RuntimeClass<Microsoft::WRL::RuntimeClassFlags<Microsoft::WRL::ClassicCom>, INetworkCostManagerEvents> {
public:
    static HRESULT CreateInstance(INetworkCostManager* network_cost_manager, base::RepeatingClosure cost_changed_callback, ComPtr<NetworkCostManagerEventSinkWin>* result)
    {
    ...
    HRESULT __stdcall DataPlanStatusChanged(NLM_SOCKADDR* /*socket_address*/) final { return S_OK; }
...
base::SequenceBound<NetworkCostChangeNotifierWin> NetworkCostChangeNotifierWin::CreateInstance(CostChangedCallback cost_changed_callback)
{
    ...
    return base::SequenceBound<NetworkCostChangeNotifierWin>(com_best_effort_task_runner,
        ...
        base::BindPostTask(base::SequencedTaskRunnerHandle::Get(), cost_changed_callback));
}
...
void NetworkCostChangeNotifierWin::StartWatching()
{
    ...
    if (base::win::GetComApartmentTypeForThread() == base::win::ComApartmentType::NONE) {
    ...
    CoCreateInstanceCallback co_create_instance_callback = base::BindRepeating(&CoCreateInstance);
    ...
    HRESULT hr = co_create_instance_callback.Run(CLSID_NetworkListManager, /*unknown_outer=*/nullptr, CLSCTX_ALL, IID_INetworkCostManager, &cost_manager);
    if (hr != S_OK) {
        return;
    }
    ...
    hr = NetworkCostManagerEventSinkWin::CreateInstance(cost_manager.Get(),
        ...
        base::BindPostTask(base::SequencedTaskRunnerHandle::Get(), base::BindRepeating(&NetworkCostChangeNotifierWin::HandleCostChanged, weak_ptr_factory_.GetWeakPtr())),
...
// static
void NetworkCostChangeNotifierWin::OverrideCoCreateInstanceForTesting(CoCreateInstanceCallback callback_for_testing) { GetCoCreateInstanceOverride() = callback_for_testing; }
