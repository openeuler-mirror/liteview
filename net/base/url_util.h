...
NET_EXPORT GURL AppendQueryParameter(const GURL& url, const std::string& name, const std::string& value);
...
NET_EXPORT GURL AppendOrReplaceQueryParameter(const GURL& url, const std::string& name, absl::optional<base::StringPiece> value);
...
NET_EXPORT bool GetValueForKeyInQuery(const GURL& url, const std::string& search_key, std::string* out_value);
...
NET_EXPORT bool ParseHostAndPort(base::StringPiece input, std::string* host, int* port);
...
NET_EXPORT bool IsSubdomainOf(base::StringPiece subdomain, base::StringPiece superdomain);

// Canonicalizes |host| and returns it.  Also fills |host_info| with
// IP address information.  |host_info| must not be NULL.
NET_EXPORT std::string CanonicalizeHost(base::StringPiece host, url::CanonHostInfo* host_info);
