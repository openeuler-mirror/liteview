...
bool GetNetworkListImpl(NetworkInterfaceList* networks, int policy, const std::unordered_set<int>& online_links, const internal::AddressTrackerLinux::AddressMap& address_map,
...
bool GetNetworkList(NetworkInterfaceList* networks, int policy)
{
    ...
    if (build_info->sdk_int() >= base::android::SDK_VERSION_NOUGAT) {
        ...
        bool use_alternative_getifaddrs = base::StringPiece(build_info->brand()) == "samsung" && base::StartsWith(build_info->hardware(), "mt");
    ...
    return internal::GetNetworkListImpl(networks, policy, tracker.GetOnlineLinks(), tracker.GetAddressMap(), &internal::AddressTrackerLinux::GetInterfaceName);
}
