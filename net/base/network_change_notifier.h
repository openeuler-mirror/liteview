...
public:
    ...
    static std::unique_ptr<NetworkChangeNotifier> CreateIfNeeded(
        ...
        NetworkChangeNotifier::ConnectionType initial_type = CONNECTION_UNKNOWN, NetworkChangeNotifier::ConnectionSubtype initial_subtype = SUBTYPE_UNKNOWN);
#else
        NetworkChangeNotifier::ConnectionType initial_type = CONNECTION_NONE, NetworkChangeNotifier::ConnectionSubtype initial_subtype = SUBTYPE_NONE);
#endif
...
protected:
    ...
    virtual const internal::AddressTrackerLinux* GetAddressTrackerInternal() const;
#endif
