...
public:
    ...
    static absl::optional<SchemefulSite> CreateIfHasRegisterableDomain(const url::Origin&);
    ...
    bool has_registrable_domain_or_host() const { return !registrable_domain_or_host().empty(); }
    ...
    std::string registrable_domain_or_host_for_testing() const { return registrable_domain_or_host(); }
...
private:
    ...
    static absl::optional<SchemefulSite> DeserializeWithNonce(const std::string& value);
    ...
    std::string registrable_domain_or_host() const { return site_as_origin_.host(); }
