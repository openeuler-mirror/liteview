...
public:
    ...
    base::OnceClosure closure() { return base::BindOnce(&TestClosure::DidSetResult, base::Unretained(this)); }
};
...
public:
    ...
    CompletionOnceCallback callback() { return base::BindOnce(&TestCompletionCallback::SetResult, base::Unretained(this)); }
};
...
public:
    ...
    Int64CompletionOnceCallback callback() { return base::BindOnce(&TestInt64CompletionCallback::SetResult, base::Unretained(this)); }
};
