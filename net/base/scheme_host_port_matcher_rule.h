...
public:
    ...
    // by the caller.
    static std::unique_ptr<SchemeHostPortMatcherRule> FromUntrimmedRawString(base::StringPiece raw_untrimmed);
...
public:
    ...
    SchemeHostPortMatcherIPBlockRule(const std::string& description, const std::string& optional_scheme, const IPAddress& ip_prefix, size_t prefix_length_in_bits);
