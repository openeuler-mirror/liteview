...
// with a request.
NET_EXPORT BASE_DECLARE_FEATURE(kPartitionHttpServerPropertiesByNetworkIsolationKey);
...
NET_EXPORT extern const base::FeatureParam<std::string> kPostQuantumCECPQ2Prefix;
...
NET_EXPORT extern const base::FeatureParam<int> kCertDualVerificationTrialCacheSize;
...
NET_EXPORT extern const base::FeatureParam<int> kOptimizeNetworkBuffersMinInputStreamAvailableValueToIgnore;

NET_EXPORT extern const base::FeatureParam<int> kOptimizeNetworkBuffersMinInputStreamReadSize;

NET_EXPORT extern const base::FeatureParam<int> kOptimizeNetworkBuffersMaxInputStreamBytesToReadWhenAvailableUnknown;

NET_EXPORT extern const base::FeatureParam<int> kOptimizeNetworkBuffersFilterSourceStreamBufferSize;

NET_EXPORT extern const base::FeatureParam<bool> kOptimizeNetworkBuffersInputStreamCheckAvailable;
...
NET_EXPORT extern const base::FeatureParam<int> kStorageAccessAPIImplicitGrantLimit;
...
NET_EXPORT extern const base::FeatureParam<bool> kStorageAccessAPIGrantsUnpartitionedStorage;
...
NET_EXPORT extern const base::FeatureParam<bool> kStorageAccessAPIAutoGrantInFPS;
...
NET_EXPORT extern const base::FeatureParam<bool> kStorageAccessAPIAutoDenyOutsideFPS;
