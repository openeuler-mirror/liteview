...
public:
    ...
    public:
        ...
        bool Equals(const Pointer& other) const { return (priority_ == other.priority_) && (iterator_ == other.iterator_); }
    ...
    // |rhs|. Assumes that both Pointers refer to elements in this PriorityQueue.
    bool IsCloserToLastMinThan(const Pointer& lhs, const Pointer& rhs) { return !lhs.Equals(rhs) && !IsCloserToFirstMaxThan(lhs, rhs); }
