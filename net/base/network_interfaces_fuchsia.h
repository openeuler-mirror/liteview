...
public:
    ...
    static absl::optional<InterfaceProperties> VerifyAndCreate(fuchsia::net::interfaces::Properties properties);
    ...
    const fuchsia::net::interfaces::DeviceClass& device_class() const { return properties_.device_class(); }
...
using ExistingInterfaceProperties = std::vector<std::pair<uint64_t, InterfaceProperties>>;
...
absl::optional<internal::ExistingInterfaceProperties> GetExistingInterfaces(const fuchsia::net::interfaces::WatcherSyncPtr& watcher);
