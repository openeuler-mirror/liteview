...
NET_EXPORT bool GetPreferredExtensionForMimeType(const std::string& mime_type, base::FilePath::StringType* extension);
...
NET_EXPORT bool MatchesMimeType(const std::string& mime_type_pattern, const std::string& mime_type);
...
// ignored.
NET_EXPORT bool ParseMimeType(const std::string& type_str, std::string* mime_type, base::StringPairs* params);
...
NET_EXPORT bool ParseMimeTypeWithoutParameter(base::StringPiece type_string, std::string* top_level_type, std::string* subtype);
...
NET_EXPORT void GetExtensionsForMimeType(const std::string& mime_type, std::vector<base::FilePath::StringType>* extensions);
...
NET_EXPORT void AddMultipartValueForUploadWithFileName(const std::string& value_name, const std::string& file_name, const std::string& value, const std::string& mime_boundary,
