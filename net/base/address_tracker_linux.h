...
public:
    ...
    AddressTrackerLinux(const base::RepeatingClosure& address_callback, const base::RepeatingClosure& link_callback, const base::RepeatingClosure& tunnel_callback,
...
private:
    ...
    NetworkChangeNotifier::ConnectionType current_connection_type_ = NetworkChangeNotifier::CONNECTION_NONE;
    bool tracking_;
