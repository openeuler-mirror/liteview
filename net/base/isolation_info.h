...
public:
    ...
    static absl::optional<IsolationInfo> Deserialize(const std::string& serialized);
    ...
    static IsolationInfo Create(RequestType request_type, const url::Origin& top_frame_origin, const url::Origin& frame_origin, const SiteForCookies& site_for_cookies,
        absl::optional<std::set<SchemefulSite>> party_context = absl::nullopt, const base::UnguessableToken* nonce = nullptr);
    ...
    static IsolationInfo CreateDoubleKey(RequestType request_type, const url::Origin& top_frame_origin, const SiteForCookies& site_for_cookies,
        absl::optional<std::set<SchemefulSite>> party_context = absl::nullopt, const base::UnguessableToken* nonce = nullptr);
    ...
    static IsolationInfo CreatePartial(RequestType request_type, const net::NetworkIsolationKey& network_isolation_key);
    ...
    static absl::optional<IsolationInfo> CreateIfConsistent(RequestType request_type, const absl::optional<url::Origin>& top_frame_origin,
        const absl::optional<url::Origin>& frame_origin, const SiteForCookies& site_for_cookies, absl::optional<std::set<SchemefulSite>> party_context = absl::nullopt,
    ...
    static IsolationInfo ToDoUseTopFrameOriginAsWell(const url::Origin& incorrectly_used_frame_origin);
    ...
    const absl::optional<url::Origin>& top_frame_origin() const { return top_frame_origin_; }
    const absl::optional<url::Origin>& frame_origin() const;

    const NetworkIsolationKey& network_isolation_key() const { return network_isolation_key_; }
    ...
    const absl::optional<std::set<SchemefulSite>>& party_context() const { return party_context_; }
...
private:
    IsolationInfo(RequestType request_type, const absl::optional<url::Origin>& top_frame_origin, const absl::optional<url::Origin>& frame_origin,
