...
void PrioritizedTaskRunner::PostTaskAndReply(const base::Location& from_here, base::OnceClosure task, base::OnceClosure reply, uint32_t priority)
{
    ...
    task_runner->PostTaskAndReply(from_here, base::BindOnce(&PrioritizedTaskRunner::RunTaskAndPostReply, this), base::BindOnce(&PrioritizedTaskRunner::RunReply, this));
}
...
void PrioritizedTaskRunner::RunReply()
{
    ...
    Job job;
    {
        ...
        std::pop_heap(reply_job_heap_.begin(), reply_job_heap_.end(), JobComparer());
