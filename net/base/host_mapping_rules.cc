...
{
    std::vector<base::StringPiece> parts = base::SplitStringPiece(base::TrimWhitespaceASCII(rule_string, base::TRIM_ALL), " ", base::TRIM_WHITESPACE, base::SPLIT_WANT_ALL);
...
void HostMappingRules::SetRulesFromString(base::StringPiece rules_string)
{
    ...
    std::vector<base::StringPiece> rules = base::SplitStringPiece(rules_string, ",", base::TRIM_WHITESPACE, base::SPLIT_WANT_ALL);
