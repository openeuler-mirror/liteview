...
NET_EXPORT std::string GetDomainAndRegistry(base::StringPiece host, PrivateRegistryFilter filter);
...
NET_EXPORT bool SameDomainOrHost(const url::Origin& origin1, const absl::optional<url::Origin>& origin2, PrivateRegistryFilter filter);
...
NET_EXPORT bool HostHasRegistryControlledDomain(base::StringPiece host, UnknownRegistryFilter unknown_filter, PrivateRegistryFilter private_filter);
...
NET_EXPORT size_t GetCanonicalHostRegistryLength(base::StringPiece canon_host, UnknownRegistryFilter unknown_filter, PrivateRegistryFilter private_filter);
...
NET_EXPORT size_t PermissiveGetHostRegistryLength(base::StringPiece host, UnknownRegistryFilter unknown_filter, PrivateRegistryFilter private_filter);
NET_EXPORT size_t PermissiveGetHostRegistryLength(base::StringPiece16 host, UnknownRegistryFilter unknown_filter, PrivateRegistryFilter private_filter);
...
NET_EXPORT_PRIVATE void SetFindDomainGraphForTesting(const unsigned char* domains, size_t length);
