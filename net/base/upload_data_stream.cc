...
base::Value NetLogInitEndInfoParams(int result, int total_size, bool is_chunked)
{
...
bool UploadDataStream::IsInMemory() const { return false; }

const std::vector<std::unique_ptr<UploadElementReader>>* UploadDataStream::GetElementReaders() const { return nullptr; }
...
bool UploadDataStream::AllowHTTP1() const { return true; }
