...
bool SchemeHostPortMatcher::Includes(const GURL& url) const { return Evaluate(url) == SchemeHostPortMatcherResult::kInclude; }
...
void SchemeHostPortMatcher::Clear() { rules_.clear(); }
