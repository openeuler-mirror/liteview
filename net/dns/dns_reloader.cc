...
#if BUILDFLAG(IS_POSIX) && !BUILDFLAG(IS_APPLE) && !BUILDFLAG(IS_OPENBSD) && !BUILDFLAG(IS_ANDROID) && !BUILDFLAG(IS_FUCHSIA)
...
void EnsureDnsReloaderInit() { g_dns_reloader.Pointer(); }
