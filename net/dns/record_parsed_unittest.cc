...
{
    DnsRecordParser parser1(kT1ResponseDatagram, sizeof(kT1ResponseDatagram), sizeof(dns_protocol::Header), kT1RecordCount);
    std::string dotted_qname;
    uint16_t qtype;
    ...
    DnsRecordParser parser2(kT1ResponseWithCacheFlushBit, sizeof(kT1ResponseWithCacheFlushBit), 0, kT1RecordCount);
