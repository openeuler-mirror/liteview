...
NET_EXPORT bool DNSDomainFromDot(const base::StringPiece& dotted, std::string* out);
...
NET_EXPORT bool DNSDomainFromUnrestrictedDot(const base::StringPiece& dotted, std::string* out);
...
NET_EXPORT_PRIVATE bool IsValidUnrestrictedDNSDomain(const base::StringPiece& dotted);
...
NET_EXPORT absl::optional<std::string> DnsDomainToString(base::StringPiece dns_name, bool require_complete = false);
NET_EXPORT absl::optional<std::string> DnsDomainToString(base::BigEndianReader& reader, bool require_complete = false);
...
public:
    bool operator()(base::StringPiece lhs, base::StringPiece rhs) const { return base::CompareCaseInsensitiveASCII(lhs, rhs) < 0; }
};
