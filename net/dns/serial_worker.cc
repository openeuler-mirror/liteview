...
void SerialWorker::WorkItem::FollowupWork(base::OnceClosure closure) { std::move(closure).Run(); }
...
void SerialWorker::WorkNowInternal()
{
    ...
    case State::kIdle:
        ...
        base::ThreadPool::PostTaskAndReplyWithResult(FROM_HERE, { base::MayBlock(), base::TaskShutdownBehavior::CONTINUE_ON_SHUTDOWN }, base::BindOnce(&DoWork, CreateWorkItem()),
...
void SerialWorker::RerunWork(std::unique_ptr<WorkItem> work_item)
{
    ...
    state_ = State::kWorking;
    base::ThreadPool::PostTaskAndReplyWithResult(FROM_HERE, { base::MayBlock(), base::TaskShutdownBehavior::CONTINUE_ON_SHUTDOWN }, base::BindOnce(&DoWork, std::move(work_item)),
        base::BindOnce(&SerialWorker::OnDoWorkFinished, AsWeakPtr()));
}
...
base::WeakPtr<SerialWorker> SerialWorker::AsWeakPtr() { return weak_factory_.GetWeakPtr(); }
