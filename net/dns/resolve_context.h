...
public:
    ...
    const URLRequestContext* url_request_context() const { return url_request_context_; }
    ...
    const DnsSession* current_session_for_testing() const { return current_session_.get(); }
    ...
    base::SafeRef<ResolveContext> AsSafeRef() { return weak_ptr_factory_.GetSafeRef(); }

    base::WeakPtr<ResolveContext> GetWeakPtr() { return weak_ptr_factory_.GetWeakPtr(); }
