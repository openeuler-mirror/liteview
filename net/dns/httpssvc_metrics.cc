...
HttpssvcMetrics::~HttpssvcMetrics() { RecordMetrics(); }
...
void HttpssvcMetrics::SaveAddressQueryFailure() { disqualified_ = true; }
...
std::string HttpssvcMetrics::BuildMetricName(base::StringPiece leaf_name) const
{
