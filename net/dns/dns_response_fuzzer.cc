...
void ValidateParsedResponse(net::DnsResponse& response, const net::IOBufferWithSize& packet, absl::optional<net::DnsQuery> query = absl::nullopt)
{
    ...
    if (response.IsValid()) {
        ...
        if (query) {
            ...
            absl::optional<std::string> dotted_qname = net::DnsDomainToString(query->qname(), /*require_complete=*/true);
