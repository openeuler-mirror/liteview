...
public:
    ...
    static DohProviderEntry ConstructForTesting(std::string provider, const base::Feature* feature, absl::optional<DohProviderIdForHistogram> provider_id_for_histogram,
...
private:
    DohProviderEntry(std::string provider,
        ...
        const base::Feature* feature, absl::optional<DohProviderIdForHistogram> provider_id_for_histogram, std::set<base::StringPiece> ip_strs,
        ...
        std::set<std::string> display_countries, LoggingLevel logging_level);
};
