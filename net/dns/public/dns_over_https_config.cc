...
std::vector<absl::optional<DnsOverHttpsServerConfig>> ParseTemplates(std::vector<std::string> templates)
{
...
// static
absl::optional<DnsOverHttpsConfig> DnsOverHttpsConfig::FromTemplates(std::vector<std::string> server_templates)
{
...
// static
absl::optional<DnsOverHttpsConfig> DnsOverHttpsConfig::FromTemplatesForTesting(std::vector<std::string> server_templates) { return FromTemplates(std::move(server_templates)); }

// static
absl::optional<DnsOverHttpsConfig> DnsOverHttpsConfig::FromString(base::StringPiece doh_config)
{
...
// static
DnsOverHttpsConfig DnsOverHttpsConfig::FromStringLax(base::StringPiece doh_config)
{
...
bool DnsOverHttpsConfig::operator==(const DnsOverHttpsConfig& other) const { return servers() == other.servers(); }
