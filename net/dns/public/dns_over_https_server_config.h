...
public:
    ...
    static absl::optional<DnsOverHttpsServerConfig> FromString(std::string doh_template, Endpoints endpoints = {});

    static absl::optional<DnsOverHttpsServerConfig> FromValue(base::Value::Dict value);
