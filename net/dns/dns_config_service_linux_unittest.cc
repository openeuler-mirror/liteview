...
public:
    ...
    DnsConfigService::CallbackType GetCallback() { return base::BindRepeating(&CallbackHelper::OnComplete, base::Unretained(this)); }
...
private:
    ...
    scoped_refptr<base::SingleThreadTaskRunner> task_runner_ = base::ThreadTaskRunnerHandle::Get();
};
...
public:
    ...
    void set_blocking_helper(BlockingHelper* blocking_helper) { blocking_helper_ = blocking_helper; }
...
public:
    void set_value(std::vector<ServiceSpecification> value) { value_ = std::move(value); }

    // NsswitchReader:
    std::vector<ServiceSpecification> ReadAndParseHosts() override { return value_; }
...
TEST_F(DnsConfigServiceLinuxTest, DestroyOnDifferentThread)
{
    ...
    std::unique_ptr<internal::DnsConfigServiceLinux, base::OnTaskRunnerDeleter> service(new internal::DnsConfigServiceLinux(), base::OnTaskRunnerDeleter(runner));

    runner->PostTask(FROM_HERE, base::BindOnce(&internal::DnsConfigServiceLinux::WatchConfig, base::Unretained(service.get()), base::BindRepeating(&DummyConfigCallback)));
    service.reset();
    RunUntilIdle();
}
...
TEST_F(DnsConfigServiceLinuxTest, RejectsWithExtraFiles)
{
    ...
    nsswitch_reader_->set_value({ NsswitchReader::ServiceSpecification(NsswitchReader::Service::kFiles), NsswitchReader::ServiceSpecification(NsswitchReader::Service::kFiles),
...
TEST_F(DnsConfigServiceLinuxTest, RejectsWithBadFilesSuccessAction)
{
    ...
    nsswitch_reader_->set_value(
        { NsswitchReader::ServiceSpecification(NsswitchReader::Service::kFiles, { { /*negated=*/false, NsswitchReader::Status::kSuccess, NsswitchReader::Action::kContinue } }),
            NsswitchReader::ServiceSpecification(NsswitchReader::Service::kDns) });
...
TEST_F(DnsConfigServiceLinuxTest, RejectsWithBadFilesNotFoundAction)
{
    ...
    nsswitch_reader_->set_value(
        { NsswitchReader::ServiceSpecification(NsswitchReader::Service::kFiles, { { /*negated=*/false, NsswitchReader::Status::kNotFound, NsswitchReader::Action::kReturn } }),
            NsswitchReader::ServiceSpecification(NsswitchReader::Service::kDns) });
...
TEST_F(DnsConfigServiceLinuxTest, RejectsWithBadDnsSuccessAction)
{
    ...
    nsswitch_reader_->set_value({ NsswitchReader::ServiceSpecification(NsswitchReader::Service::kFiles),
        NsswitchReader::ServiceSpecification(NsswitchReader::Service::kDns, { { /*negated=*/false, NsswitchReader::Status::kSuccess, NsswitchReader::Action::kContinue } }) });
...
TEST_F(DnsConfigServiceLinuxTest, RejectsNsswitchWithMisorderedServices)
{
    ...
    nsswitch_reader_->set_value({ NsswitchReader::ServiceSpecification(NsswitchReader::Service::kDns), NsswitchReader::ServiceSpecification(NsswitchReader::Service::kFiles) });
...
TEST_F(DnsConfigServiceLinuxTest, AcceptsIncompatibleNsswitchServicesAfterDns)
{
    ...
    nsswitch_reader_->set_value({ NsswitchReader::ServiceSpecification(NsswitchReader::Service::kFiles), NsswitchReader::ServiceSpecification(NsswitchReader::Service::kDns),
...
TEST_F(DnsConfigServiceLinuxTest, RejectsNsswitchMdns)
{
    ...
    nsswitch_reader_->set_value({ NsswitchReader::ServiceSpecification(NsswitchReader::Service::kFiles), NsswitchReader::ServiceSpecification(NsswitchReader::Service::kMdns),
        NsswitchReader::ServiceSpecification(NsswitchReader::Service::kDns) });
...
TEST_F(DnsConfigServiceLinuxTest, RejectsNsswitchMdns4)
{
    ...
    nsswitch_reader_->set_value({ NsswitchReader::ServiceSpecification(NsswitchReader::Service::kFiles), NsswitchReader::ServiceSpecification(NsswitchReader::Service::kMdns4),
        NsswitchReader::ServiceSpecification(NsswitchReader::Service::kDns) });
...
TEST_F(DnsConfigServiceLinuxTest, RejectsNsswitchMdns6)
{
    ...
    nsswitch_reader_->set_value({ NsswitchReader::ServiceSpecification(NsswitchReader::Service::kFiles), NsswitchReader::ServiceSpecification(NsswitchReader::Service::kMdns6),
        NsswitchReader::ServiceSpecification(NsswitchReader::Service::kDns) });
...
TEST_F(DnsConfigServiceLinuxTest, AcceptsNsswitchMdnsMinimal)
{
    ...
    nsswitch_reader_->set_value({ NsswitchReader::ServiceSpecification(NsswitchReader::Service::kFiles),
        NsswitchReader::ServiceSpecification(NsswitchReader::Service::kMdnsMinimal), NsswitchReader::ServiceSpecification(NsswitchReader::Service::kMdns4Minimal),
...
TEST_F(DnsConfigServiceLinuxTest, AcceptsNsswitchMdnsMinimalWithCommonActions)
{
    ...
    nsswitch_reader_->set_value({ NsswitchReader::ServiceSpecification(NsswitchReader::Service::kFiles),
        ...
        NsswitchReader::ServiceSpecification(NsswitchReader::Service::kMdns4Minimal, { { /*negated=*/false, NsswitchReader::Status::kNotFound, NsswitchReader::Action::kReturn } }),
        NsswitchReader::ServiceSpecification(
...
TEST_F(DnsConfigServiceLinuxTest, AcceptsNsswitchMyHostname)
{
    ...
    nsswitch_reader_->set_value({ NsswitchReader::ServiceSpecification(NsswitchReader::Service::kFiles), NsswitchReader::ServiceSpecification(NsswitchReader::Service::kMyHostname),
        NsswitchReader::ServiceSpecification(NsswitchReader::Service::kDns) });
...
TEST_F(DnsConfigServiceLinuxTest, RejectsWithBadMyHostnameNotFoundAction)
{
    ...
    nsswitch_reader_->set_value({ NsswitchReader::ServiceSpecification(NsswitchReader::Service::kFiles),
        NsswitchReader::ServiceSpecification(NsswitchReader::Service::kMyHostname, { { /*negated=*/false, NsswitchReader::Status::kNotFound, NsswitchReader::Action::kReturn } }),
        NsswitchReader::ServiceSpecification(NsswitchReader::Service::kDns) });
...
TEST_F(DnsConfigServiceLinuxTest, RejectsNsswitchResolve)
{
    ...
    nsswitch_reader_->set_value({ NsswitchReader::ServiceSpecification(NsswitchReader::Service::kFiles), NsswitchReader::ServiceSpecification(NsswitchReader::Service::kResolve),
        NsswitchReader::ServiceSpecification(NsswitchReader::Service::kDns) });
...
TEST_F(DnsConfigServiceLinuxTest, RejectsNsswitchNis)
{
    ...
    nsswitch_reader_->set_value({ NsswitchReader::ServiceSpecification(NsswitchReader::Service::kFiles), NsswitchReader::ServiceSpecification(NsswitchReader::Service::kNis),
        NsswitchReader::ServiceSpecification(NsswitchReader::Service::kDns) });
...
TEST_F(DnsConfigServiceLinuxTest, RejectsWithBadNisNotFoundAction)
{
    ...
    nsswitch_reader_->set_value({ NsswitchReader::ServiceSpecification(NsswitchReader::Service::kFiles),
        NsswitchReader::ServiceSpecification(NsswitchReader::Service::kNis, { { /*negated=*/false, NsswitchReader::Status::kNotFound, NsswitchReader::Action::kReturn } }),
        NsswitchReader::ServiceSpecification(NsswitchReader::Service::kDns) });
...
TEST_F(DnsConfigServiceLinuxTest, RejectsNsswitchUnknown)
{
    ...
    nsswitch_reader_->set_value({ NsswitchReader::ServiceSpecification(NsswitchReader::Service::kFiles), NsswitchReader::ServiceSpecification(NsswitchReader::Service::kUnknown),
        NsswitchReader::ServiceSpecification(NsswitchReader::Service::kDns) });
