...
TEST(MappedHostResolverTest, Inclusion)
{
    ...
    std::unique_ptr<HostResolver::ResolveHostRequest> request
        = resolver->CreateRequest(HostPortPair("www.google.com", 80), NetworkAnonymizationKey(), NetLogWithSource(), absl::nullopt);
    ...
    request = resolver->CreateRequest(HostPortPair("www.google.com", 80), NetworkAnonymizationKey(), NetLogWithSource(), absl::nullopt);
    ...
    // is "foo.com:77".
    request = resolver->CreateRequest(HostPortPair("foo.com", 77), NetworkAnonymizationKey(), NetLogWithSource(), absl::nullopt);
    rv = request->Start(callback.callback());
    EXPECT_THAT(rv, IsError(ERR_IO_PENDING));
    rv = callback.WaitForResult();
    EXPECT_THAT(rv, IsOk());
    ...
    request = resolver->CreateRequest(HostPortPair("chromium.org", 61), NetworkAnonymizationKey(), NetLogWithSource(), absl::nullopt);
    rv = request->Start(callback.callback());
    EXPECT_THAT(rv, IsError(ERR_IO_PENDING));
    rv = callback.WaitForResult();
    EXPECT_THAT(rv, IsOk());
...
TEST(MappedHostResolverTest, MapsHostWithScheme)
{
    ...
    std::unique_ptr<HostResolver::ResolveHostRequest> request
        = resolver->CreateRequest(url::SchemeHostPort(url::kHttpScheme, "to.map.test", 155), NetworkAnonymizationKey(), NetLogWithSource(), absl::nullopt);
...
TEST(MappedHostResolverTest, MapsHostWithSchemeToIpLiteral)
{
    ...
    std::unique_ptr<HostResolver::ResolveHostRequest> request
        = resolver->CreateRequest(url::SchemeHostPort(url::kHttpScheme, "host.test", 156), NetworkAnonymizationKey(), NetLogWithSource(), absl::nullopt);
...
TEST(MappedHostResolverTest, MapsHostWithSchemeToNonCanon)
{
    ...
    std::unique_ptr<HostResolver::ResolveHostRequest> request
        = resolver->CreateRequest(url::SchemeHostPort(url::kHttpScheme, "host.test", 157), NetworkAnonymizationKey(), NetLogWithSource(), absl::nullopt);
...
TEST(MappedHostResolverTest, MapsHostWithSchemeToNameWithPort)
{
    ...
    std::unique_ptr<HostResolver::ResolveHostRequest> request
        = resolver->CreateRequest(url::SchemeHostPort(url::kHttpScheme, "host.test", 158), NetworkAnonymizationKey(), NetLogWithSource(), absl::nullopt);
...
TEST(MappedHostResolverTest, HandlesUnmappedHostWithScheme)
{
    ...
    std::unique_ptr<HostResolver::ResolveHostRequest> request
        = resolver->CreateRequest(url::SchemeHostPort(url::kHttpsScheme, "unmapped.test", 155), NetworkAnonymizationKey(), NetLogWithSource(), absl::nullopt);
...
TEST(MappedHostResolverTest, Exclusion)
{
    ...
    request = resolver->CreateRequest(HostPortPair("chrome.com", 80), NetworkAnonymizationKey(), NetLogWithSource(), absl::nullopt);
    rv = request->Start(callback.callback());
    EXPECT_THAT(rv, IsError(ERR_IO_PENDING));
    rv = callback.WaitForResult();
    EXPECT_THAT(rv, IsOk());
...
TEST(MappedHostResolverTest, SetRulesFromString)
{
    ...
    request = resolver->CreateRequest(HostPortPair("chrome.net", 80), NetworkAnonymizationKey(), NetLogWithSource(), absl::nullopt);
    rv = request->Start(callback.callback());
    EXPECT_THAT(rv, IsError(ERR_IO_PENDING));
    rv = callback.WaitForResult();
    EXPECT_THAT(rv, IsOk());
...
TEST(MappedHostResolverTest, MapToError)
{
    ...
    request = resolver->CreateRequest(HostPortPair("www.foo.com", 80), NetworkAnonymizationKey(), NetLogWithSource(), absl::nullopt);
...
TEST(MappedHostResolverTest, MapHostWithSchemeToError)
{
    ...
    std::unique_ptr<HostResolver::ResolveHostRequest> request
        = resolver->CreateRequest(url::SchemeHostPort(url::kWssScheme, "host.test", 155), NetworkAnonymizationKey(), NetLogWithSource(), absl::nullopt);
