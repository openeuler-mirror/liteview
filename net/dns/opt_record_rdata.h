...
public:
    ...
    private:
        ...
        friend std::unique_ptr<OptRecordRdata> OptRecordRdata::Create(base::StringPiece data);
    };
    ...
    const std::multimap<uint16_t, const std::unique_ptr<const Opt>>& opts() const { return opts_; }
