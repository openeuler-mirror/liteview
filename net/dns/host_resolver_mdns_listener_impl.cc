...
void HostResolverMdnsListenerImpl::OnRecordUpdate(net::MDnsListener::UpdateType update, const RecordParsed* record)
{
    ...
    case DnsQueryType::TXT:
        ...
        delegate_->OnTextResult(ConvertUpdateType(update), query_type_, parsed_entry.text_records().value());
        break;
    case DnsQueryType::PTR:
    case DnsQueryType::SRV:
        DCHECK(parsed_entry.hostnames());
        delegate_->OnHostnameResult(ConvertUpdateType(update), query_type_, parsed_entry.hostnames().value().front());
        break;
    }
}
