...
// static
std::unique_ptr<SrvRecordRdata> SrvRecordRdata::Create(const base::StringPiece& data, const DnsRecordParser& parser)
{
    ...
    if (!parser.ReadName(data.substr(kSrvRecordMinimumSize).begin(), &rdata->target_))
        return nullptr;
...
// static
std::unique_ptr<ARecordRdata> ARecordRdata::Create(const base::StringPiece& data, const DnsRecordParser& parser)
{
    if (!HasValidSize(data, kType))
        return nullptr;
...
uint16_t ARecordRdata::Type() const { return ARecordRdata::kType; }
...
// static
std::unique_ptr<AAAARecordRdata> AAAARecordRdata::Create(const base::StringPiece& data, const DnsRecordParser& parser)
{
    if (!HasValidSize(data, kType))
        return nullptr;
...
uint16_t AAAARecordRdata::Type() const { return AAAARecordRdata::kType; }
...
// static
std::unique_ptr<CnameRecordRdata> CnameRecordRdata::Create(const base::StringPiece& data, const DnsRecordParser& parser)
{
...
uint16_t CnameRecordRdata::Type() const { return CnameRecordRdata::kType; }
...
// static
std::unique_ptr<PtrRecordRdata> PtrRecordRdata::Create(const base::StringPiece& data, const DnsRecordParser& parser)
{
...
uint16_t PtrRecordRdata::Type() const { return PtrRecordRdata::kType; }
...
// static
std::unique_ptr<TxtRecordRdata> TxtRecordRdata::Create(const base::StringPiece& data, const DnsRecordParser& parser)
{
...
uint16_t TxtRecordRdata::Type() const { return TxtRecordRdata::kType; }
...
// static
std::unique_ptr<NsecRecordRdata> NsecRecordRdata::Create(const base::StringPiece& data, const DnsRecordParser& parser)
{
...
uint16_t NsecRecordRdata::Type() const { return NsecRecordRdata::kType; }
