...
public:
    ...
    void set_watch_failed_for_testing(bool watch_failed) { watch_failed_ = watch_failed; }
...
protected:
    ...
    explicit DnsConfigService(base::FilePath::StringPieceType hosts_file_path, absl::optional<base::TimeDelta> config_change_delay = base::Milliseconds(50));
