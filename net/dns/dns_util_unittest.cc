...
// NUL in the result.
static std::string IncludeNUL(const char* in) { return std::string(in, strlen(in) + 1); }
...
TEST_F(DNSUtilTest, DNSDomainFromDot)
{
    ...
    EXPECT_TRUE(DNSDomainFromDot("abcdefghi.abcdefghi.abcdefghi.abcdefghi.abcdefghi.abcdefghi.abcdefghi.abcdefghi.abcdefghi.abcdefghi.abcdefghi.abcdefghi.abcdefghi.abcdefghi."
                                 "abcdefghi.abcdefghi.abcdefghi.abcdefghi.abcdefghi.abcdefghi.abcdefghi.abcdefghi.abcdefghi.abcdefghi.abcdefghi.abc",
        &out));
    EXPECT_EQ(out,
        IncludeNUL("\011abcdefghi\011abcdefghi\011abcdefghi\011abcdefghi\011abcdefghi\011abcdefghi\011abcdefghi\011abcdefghi\011abcdefghi\011abcdefghi\011abcdefghi\011abcdefghi"
                   "\011abcdefghi\011abcdefghi\011abcdefghi\011abcdefghi\011abcdefghi\011abcdefghi\011abcdefghi\011abcdefghi\011abcdefghi\011abcdefghi\011abcdefghi\011abcdefghi"
                   "\011abcdefghi\003abc"));

    // 254 characters in the name: invalid
    EXPECT_FALSE(DNSDomainFromDot("123456789.123456789.123456789.123456789.123456789.123456789.123456789.123456789.123456789.123456789.123456789.123456789.123456789.123456789."
...
TEST_F(DNSUtilTest, DNSDomainFromUnrestrictedDot)
{
    ...
    EXPECT_TRUE(DNSDomainFromUnrestrictedDot("_ipp._tcp.local.foo printer (bar)", &out));
    ...
    // Label is too long: invalid
    EXPECT_FALSE(DNSDomainFromUnrestrictedDot("123456789a123456789a123456789a123456789a123456789a123456789a1234", &out));
}
...
TEST_F(DNSUtilTest, DnsDomainToStringShouldRejectEmptyIncomplete)
{
    ...
    EXPECT_THAT(DnsDomainToString(dns_name, false /* require_complete */), testing::Optional(Eq("")));
    auto reader = base::BigEndianReader::FromStringPiece(dns_name);
    EXPECT_THAT(DnsDomainToString(reader, false /* require_complete */), testing::Optional(Eq("")));

    EXPECT_EQ(DnsDomainToString(dns_name, true /* require_complete */), absl::nullopt);
    auto reader1 = base::BigEndianReader::FromStringPiece(dns_name);
    EXPECT_EQ(DnsDomainToString(reader1, true /* require_complete */), absl::nullopt);
}
...
TEST_F(DNSUtilTest, DnsDomainToStringComplete)
{
    ...
    EXPECT_THAT(DnsDomainToString(dns_name, false /* require_complete */), testing::Optional(Eq("foo.test")));
    auto reader = base::BigEndianReader::FromStringPiece(dns_name);
    EXPECT_THAT(DnsDomainToString(reader, false /* require_complete */), testing::Optional(Eq("foo.test")));

    EXPECT_THAT(DnsDomainToString(dns_name, true /* require_complete */), testing::Optional(Eq("foo.test")));
    auto reader1 = base::BigEndianReader::FromStringPiece(dns_name);
    EXPECT_THAT(DnsDomainToString(reader1, true /* require_complete */), testing::Optional(Eq("foo.test")));
}
...
TEST_F(DNSUtilTest, DnsDomainToStringNotComplete)
{
    ...
    EXPECT_THAT(DnsDomainToString(dns_name, false /* require_complete */), testing::Optional(Eq("boo.test")));
    auto reader = base::BigEndianReader::FromStringPiece(dns_name);
    EXPECT_THAT(DnsDomainToString(reader, false /* require_complete */), testing::Optional(Eq("boo.test")));

    EXPECT_EQ(DnsDomainToString(dns_name, true /* require_complete */), absl::nullopt);
    auto reader2 = base::BigEndianReader::FromStringPiece(dns_name);
    EXPECT_EQ(DnsDomainToString(reader2, true /* require_complete */), absl::nullopt);
}
...
TEST_F(DNSUtilTest, DnsDomainToStringShouldRejectEmptyWhenRequiringComplete)
{
    ...
    EXPECT_THAT(DnsDomainToString(dns_name, true /* require_complete */), testing::Optional(Eq("")));
    auto reader2 = base::BigEndianReader::FromStringPiece(dns_name);
    EXPECT_THAT(DnsDomainToString(reader2, true /* require_complete */), testing::Optional(Eq("")));
}
...
TEST_F(DNSUtilTest, DnsDomainToStringShouldHandleExcessInput)
{
    ...
    EXPECT_THAT(DnsDomainToString(dns_name), testing::Optional(Eq("cool.name.test")));
    auto reader = base::BigEndianReader::FromStringPiece(dns_name);
    EXPECT_THAT(DnsDomainToString(reader), testing::Optional(Eq("cool.name.test")));
...
TEST_F(DNSUtilTest, GetDohUpgradeServersFromDotHostname)
{
    ...
    scoped_feature_list.InitWithFeatures(
        /*enabled_features=*/ {}, /*disabled_features=*/ { GetDohProviderEntry("CleanBrowsingFamily").feature });
    doh_servers = GetDohUpgradeServersFromDotHostname("family-filter-dns.cleanbrowsing.org");
    EXPECT_EQ(0u, doh_servers.size());
}
...
TEST_F(DNSUtilTest, GetDohUpgradeServersFromNameservers)
{
    ...
    scoped_feature_list.InitWithFeatures(
        /*enabled_features=*/ {},
        /*disabled_features=*/ { GetDohProviderEntry("CleanBrowsingSecure").feature, GetDohProviderEntry("Cloudflare").feature });
