...
{
    return HostCache::Key(url::SchemeHostPort(url::kHttpsScheme, hostname, 443), DnsQueryType::UNSPECIFIED, 0, HostResolverSource::ANY, NetworkAnonymizationKey());
}

bool FoobarIndexIsOdd(const std::string& foobarx_com) { return (foobarx_com[6] - '0') % 2 == 1; }
...
MATCHER_P(EntryContentsEqual, entry, base::StrCat({ "contents ", negation ? "!=" : "==", " contents of ", testing::PrintToString(entry) })) { return arg.ContentsEqual(entry); }
...
std::vector<IPEndPoint> MakeEndpoints(std::vector<std::string> my_addresses)
{
    ...
    std::transform(my_addresses.begin(), my_addresses.end(), out.begin(), [](auto& s) { return IPEndPoint(MakeIP(s), 0); });
    return out;
}
...
TEST(HostCacheTest, GetEndpoints)
{
    ...
    EXPECT_THAT(entry.GetEndpoints(), Optional(ElementsAre(ExpectEndpointResult(ip_endpoints))));
}
...
TEST(HostCacheTest, HandlesKeysWithoutScheme)
{
    ...
    HostCache::Key key_with_scheme(url::SchemeHostPort(url::kHttpsScheme, "host1.test", 443), DnsQueryType::UNSPECIFIED, 0, HostResolverSource::ANY, NetworkAnonymizationKey());
...
TEST(HostCacheTest, DnsQueryTypeIsPartOfKey)
{
    ...
    HostCache::Key key1(url::SchemeHostPort(url::kHttpScheme, "foobar.com", 80), DnsQueryType::UNSPECIFIED, 0, HostResolverSource::ANY, NetworkAnonymizationKey());
...
TEST(HostCacheTest, PreserveActivePin)
{
    ...
    EXPECT_THAT(result1.GetEndpoints(), Optional(ElementsAre(ExpectEndpointResult(ElementsAre(endpoint1)))));
    ...
    EXPECT_THAT(result2.GetEndpoints(), Optional(ElementsAre(ExpectEndpointResult(ElementsAre(endpoint2)))));
...
TEST(HostCacheTest, KeyComparators)
{
    ...
    std::vector<CacheTestParameters> tests = {
        { HostCache::Key(url::SchemeHostPort(url::kHttpsScheme, "host1", 443), DnsQueryType::UNSPECIFIED, 0, HostResolverSource::ANY, NetworkAnonymizationKey()),
            HostCache::Key(url::SchemeHostPort(url::kHttpsScheme, "host1", 443), DnsQueryType::UNSPECIFIED, 0, HostResolverSource::ANY, NetworkAnonymizationKey()), 0 },
        { HostCache::Key(url::SchemeHostPort(url::kHttpsScheme, "host1", 443), DnsQueryType::A, 0, HostResolverSource::ANY, NetworkAnonymizationKey()),
            HostCache::Key(url::SchemeHostPort(url::kHttpsScheme, "host1", 443), DnsQueryType::UNSPECIFIED, 0, HostResolverSource::ANY, NetworkAnonymizationKey()), 1 },
        { HostCache::Key(url::SchemeHostPort(url::kHttpsScheme, "host1", 443), DnsQueryType::UNSPECIFIED, 0, HostResolverSource::ANY, NetworkAnonymizationKey()),
        ...
        { HostCache::Key(url::SchemeHostPort(url::kHttpsScheme, "host1", 443), DnsQueryType::UNSPECIFIED, 0, HostResolverSource::ANY, NetworkAnonymizationKey()),
            HostCache::Key(url::SchemeHostPort(url::kHttpsScheme, "host2", 443), DnsQueryType::UNSPECIFIED, 0, HostResolverSource::ANY, NetworkAnonymizationKey()), -1 },
        { HostCache::Key(url::SchemeHostPort(url::kHttpsScheme, "host1", 443), DnsQueryType::A, 0, HostResolverSource::ANY, NetworkAnonymizationKey()),
            HostCache::Key(url::SchemeHostPort(url::kHttpsScheme, "host2", 443), DnsQueryType::UNSPECIFIED, 0, HostResolverSource::ANY, NetworkAnonymizationKey()), 1 },
        { HostCache::Key(url::SchemeHostPort(url::kHttpsScheme, "host1", 443), DnsQueryType::UNSPECIFIED, 0, HostResolverSource::ANY, NetworkAnonymizationKey()),
        ...
        { HostCache::Key(url::SchemeHostPort(url::kHttpsScheme, "host1", 443), DnsQueryType::UNSPECIFIED, 0, HostResolverSource::ANY, NetworkAnonymizationKey()),
            HostCache::Key(
                url::SchemeHostPort(url::kHttpsScheme, "host1", 443), DnsQueryType::UNSPECIFIED, HOST_RESOLVER_CANONNAME, HostResolverSource::ANY, NetworkAnonymizationKey()),
            -1 },
        { HostCache::Key(
              url::SchemeHostPort(url::kHttpsScheme, "host1", 443), DnsQueryType::UNSPECIFIED, HOST_RESOLVER_CANONNAME, HostResolverSource::ANY, NetworkAnonymizationKey()),
            HostCache::Key(url::SchemeHostPort(url::kHttpsScheme, "host1", 443), DnsQueryType::UNSPECIFIED, 0, HostResolverSource::ANY, NetworkAnonymizationKey()), 1 },
        { HostCache::Key(
              url::SchemeHostPort(url::kHttpsScheme, "host1", 443), DnsQueryType::UNSPECIFIED, HOST_RESOLVER_CANONNAME, HostResolverSource::ANY, NetworkAnonymizationKey()),
            HostCache::Key(
                url::SchemeHostPort(url::kHttpsScheme, "host2", 443), DnsQueryType::UNSPECIFIED, HOST_RESOLVER_CANONNAME, HostResolverSource::ANY, NetworkAnonymizationKey()),
            -1 },
        // 9: Different host scheme.
        { HostCache::Key(url::SchemeHostPort(url::kHttpsScheme, "host1", 443), DnsQueryType::UNSPECIFIED, 0, HostResolverSource::ANY, NetworkAnonymizationKey()),
            HostCache::Key(url::SchemeHostPort(url::kHttpScheme, "host1", 443), DnsQueryType::UNSPECIFIED, 0, HostResolverSource::ANY, NetworkAnonymizationKey()), 1 },
        // 10: Different host port.
        { HostCache::Key(url::SchemeHostPort(url::kHttpsScheme, "host1", 443), DnsQueryType::UNSPECIFIED, 0, HostResolverSource::ANY, NetworkAnonymizationKey()),
            HostCache::Key(url::SchemeHostPort(url::kHttpsScheme, "host1", 1544), DnsQueryType::UNSPECIFIED, 0, HostResolverSource::ANY, NetworkAnonymizationKey()), -1 },
...
TEST(HostCacheTest, SerializeAndDeserializeWithNetworkAnonymizationKey)
{
    ...
    const NetworkAnonymizationKey kOpaqueNetworkAnonymizationKey(kOpaqueSite, kOpaqueSite);
...
TEST(HostCacheTest, SerializeForDebugging)
{
    ...
    const std::string* nik_string = serialized_cache[0].GetDict().FindString("network_anonymization_key");
...
TEST(HostCacheTest, SerializeAndDeserializeEndpointResult)
{
    ...
    HostCache::Entry metadata_entry(OK, std::multimap<HttpsRecordPriority, ConnectionEndpointMetadata> { { 1u, metadata1 }, { 2u, metadata2 } }, HostCache::Entry::SOURCE_DNS);

    auto merged_entry = HostCache::Entry::MergeEntries(entry, metadata_entry);

    EXPECT_THAT(merged_entry.GetEndpoints(), Optional(ElementsAre(ExpectEndpointResult(ip_endpoints))));
    EXPECT_THAT(merged_entry.GetMetadatas(),
        testing::Optional(testing::ElementsAre(ExpectConnectionEndpointMetadata(testing::ElementsAre("h3", "h2"), testing::ElementsAre('f', 'o', 'o'), ipv6_alias),
            ExpectConnectionEndpointMetadata(testing::ElementsAre("h2", "h4"), IsEmpty(), ipv4_alias))));
    EXPECT_THAT(merged_entry.canonical_names(), testing::Optional(UnorderedElementsAre(ipv4_alias, ipv6_alias)));
    ...
    EXPECT_THAT(result->second.GetEndpoints(), Optional(ElementsAre(ExpectEndpointResult(ip_endpoints))));
    EXPECT_THAT(result->second.GetMetadatas(),
        testing::Optional(testing::ElementsAre(ExpectConnectionEndpointMetadata(testing::ElementsAre("h3", "h2"), testing::ElementsAre('f', 'o', 'o'), ipv6_alias),
            ExpectConnectionEndpointMetadata(testing::ElementsAre("h2", "h4"), IsEmpty(), ipv4_alias))));
    EXPECT_THAT(result->second.canonical_names(), testing::Optional(UnorderedElementsAre(ipv4_alias, ipv6_alias)));
...
TEST(HostCacheTest, DeserializeLegacyAddresses)
{
 ...
 [ {
   ...
   "secure": false
    ...
    ASSERT_TRUE(result);
    EXPECT_THAT(result->second.ip_endpoints(), Pointee(ElementsAreArray(MakeEndpoints({ "2000::", "1.2.3.4" }))));
    EXPECT_THAT(result->second.aliases(), Pointee(ElementsAre()));
}
...
TEST(HostCacheTest, MergeEndpointsWithAliases)
{
    ...
    EXPECT_THAT(result.hostnames(), Optional(ElementsAre(kHostnameFront, kHostnameBack)));
...
TEST(HostCacheTest, MergeMetadatasWithIpEndpointsDifferentCanonicalName)
{
    ...
    EXPECT_THAT(result.GetEndpoints(), Optional(ElementsAre(ExpectEndpointResult(std::vector<IPEndPoint> { ip_endpoint }))));
...
TEST(HostCacheTest, MergeMetadatasWithIpEndpointsMatchingCanonicalName)
{
    ...
    EXPECT_THAT(result.GetEndpoints(), Optional(ElementsAre(ExpectEndpointResult(ElementsAre(ip_endpoint), metadata), ExpectEndpointResult(ElementsAre(ip_endpoint)))));
...
TEST(HostCacheTest, MergeMultipleMetadatasWithIpEndpoints)
{
    ...
    EXPECT_THAT(result.GetEndpoints(),
        Optional(ElementsAre(ExpectEndpointResult(ElementsAre(ip_endpoint), back_metadata), ExpectEndpointResult(ElementsAre(ip_endpoint), front_metadata),
