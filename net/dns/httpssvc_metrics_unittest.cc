...
public:
    ...
    std::string BuildMetricNamePrefix() const { return base::StrCat({ "Net.DNS.HTTPSSVC.RecordHttps.", secure_ ? "Secure." : "Insecure.", "ExpectNoerror." }); }

    template <typename T> void ExpectSample(base::StringPiece name, absl::optional<T> sample) const
    {
        if (sample)
    ...
    void ExpectSample(base::StringPiece name, absl::optional<base::TimeDelta> sample) const
    {
    ...
    void VerifyAddressResolveTimeMetric(absl::optional<base::TimeDelta> expect_noerror_time = absl::nullopt)
    {
    ...
    void VerifyHttpsMetricsForExpectNoerror(absl::optional<HttpssvcDnsRcode> rcode = absl::nullopt, absl::optional<bool> parsable = absl::nullopt,
        absl::optional<bool> record_with_error = absl::nullopt, absl::optional<base::TimeDelta> resolve_time_https = absl::nullopt,
...
TEST_P(HttpssvcMetricsTest, AddressAndHttpsParsable)
{
    ...
    VerifyHttpsMetricsForExpectNoerror({ HttpssvcDnsRcode::kNoError } /* rcode */, { true } /* parsable */, absl::nullopt /* record_with_error */,
...
TEST_P(HttpssvcMetricsTest, AddressAndHttpsMissingWithRcode)
{
    ...
    VerifyAddressResolveTimeMetric({ kResolveTime } /* expect_noerror_time */);
    VerifyHttpsMetricsForExpectNoerror({ HttpssvcDnsRcode::kNxDomain } /* rcode */, absl::nullopt /* parsable */, absl::nullopt /* record_with_error */,
        { kResolveTimeHttps } /* resolve_time_https */, { 15 } /* resolve_time_ratio */);
}
...
TEST_P(HttpssvcMetricsTest, AddressAndHttpsParsableWithRcode)
{
    ...
    VerifyHttpsMetricsForExpectNoerror({ HttpssvcDnsRcode::kNxDomain } /* rcode */,
        ...
        absl::nullopt /* parsable */, { true } /* record_with_error */, { kResolveTimeHttps } /* resolve_time_https */, { 15 } /* resolve_time_ratio */);
}
...
TEST_P(HttpssvcMetricsTest, AddressAndHttpsTimedOut)
{
    ...
    VerifyHttpsMetricsForExpectNoerror({ HttpssvcDnsRcode::kTimedOut } /* rcode */,
        // "parsable" metric is omitted because the RCODE is not NOERROR.
        absl::nullopt /* parsable */, absl::nullopt /* record_with_error */, { kResolveTimeHttps } /* resolve_time_https */, { 15 } /* resolve_time_ratio */);
}
