...
private:
    ...
    public:
        ...
        bool ParseHosts(DnsHosts* hosts) const override { return factory_->ParseHosts(hosts); }
...
DnsHosts::value_type CreateHostsEntry(base::StringPiece name, AddressFamily family, IPAddress address)
{
...
{
    DnsHosts hosts = { CreateHostsEntry("name1", ADDRESS_FAMILY_IPV4, { IPAddress(1, 2, 3, 4) }), CreateHostsEntry("name2", ADDRESS_FAMILY_IPV4, { IPAddress(1, 2, 3, 5) }),
