...
{
    DnsRecordParser parser(kT1ResponseDatagram, sizeof(kT1ResponseDatagram), sizeof(dns_protocol::Header), kT1RecordCount);
...
{
    DnsRecordParser parser(kTestResponsesDifferentAnswers, sizeof(kTestResponsesDifferentAnswers), 0,
        /*num_records=*/2);
...
{
    DnsRecordParser parser(kTestResponsesSameAnswers, sizeof(kTestResponsesSameAnswers), 0,
        /*num_records=*/2);
...
{
    DnsRecordParser parser(kTestResponsesGoodbyePacket, sizeof(kTestResponsesGoodbyePacket), 0,
        /*num_records=*/2);
    ...
    parser = DnsRecordParser(kTestResponsesGoodbyePacket, sizeof(kTestResponsesGoodbyePacket), 0,
        /*num_records=*/2);
...
{
    DnsRecordParser parser(kTestResponseTwoRecords, sizeof(kTestResponseTwoRecords), 0, /*num_records=*/2);
...
{
    DnsRecordParser parser(kTestResponsesDifferentCapitalization, sizeof(kTestResponsesDifferentCapitalization), 0,
        /*num_records=*/2);
