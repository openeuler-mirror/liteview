...
int HostResolverProc::Resolve(
    const std::string& host, AddressFamily address_family, HostResolverFlags host_resolver_flags, AddressList* addrlist, int* os_error, handles::NetworkHandle network)
{
...
int HostResolverProc::ResolveUsingPrevious(const std::string& host, AddressFamily address_family, HostResolverFlags host_resolver_flags, AddressList* addrlist, int* os_error)
{
...
void HostResolverProc::SetLastProc(scoped_refptr<HostResolverProc> proc) { GetLastProc(this)->SetPreviousProc(std::move(proc)); }
...
// static
HostResolverProc* HostResolverProc::GetDefault() { return default_proc_; }
