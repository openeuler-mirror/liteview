...
std::string BuildOCSPResponseWithResponseData(EVP_PKEY* responder_key, const std::string& response_data, absl::optional<SignatureAlgorithm> signature_algorithm = absl::nullopt);
