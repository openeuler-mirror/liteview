...
// CertificateList.
CertificateList CreateCertificateListFromFile(const base::FilePath& certs_dir, base::StringPiece cert_file, int format);
...
scoped_refptr<X509Certificate> CreateCertificateChainFromFile(const base::FilePath& certs_dir, base::StringPiece cert_file, int format);
...
scoped_refptr<X509Certificate> ImportCertFromFile(const base::FilePath& certs_dir, base::StringPiece cert_file);
...
// ignored.
bssl::UniquePtr<EVP_PKEY> LoadPrivateKeyFromFile(const base::FilePath& key_path);
