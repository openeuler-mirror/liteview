...
public:
    ...
    void HandleRequest(base::WeakPtr<HttpResponseDelegate> connection, std::unique_ptr<HttpRequest> request);
    ...
    HostPortPair host_port_pair() const { return HostPortPair::FromURL(base_url_); }
    ...
    url::Origin GetOrigin(const absl::optional<std::string>& hostname = absl::nullopt) const;
