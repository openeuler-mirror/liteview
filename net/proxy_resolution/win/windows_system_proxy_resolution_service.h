...
public:
    ...
    static std::unique_ptr<WindowsSystemProxyResolutionService> Create(std::unique_ptr<WindowsSystemProxyResolver> windows_system_proxy_resolver, NetLog* net_log);
...
private:
    ...
    size_t PendingRequestSizeForTesting() const { return pending_requests_.size(); }
