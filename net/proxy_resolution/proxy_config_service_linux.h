...
public:
    ...
    public:
        ...
        Delegate(std::unique_ptr<base::Environment> env_var_getter, absl::optional<std::unique_ptr<SettingGetter>> setting_getter,
        ...
        void SetUpAndFetchInitialConfig(const scoped_refptr<base::SingleThreadTaskRunner>& glib_task_runner, const scoped_refptr<base::SequencedTaskRunner>& main_task_runner,
    ...
    private:
        ...
        bool GetProxyFromEnvVarForScheme(base::StringPiece variable, ProxyServer::Scheme scheme, ProxyServer* result_server);
        // As above but with scheme set to HTTP, for convenience.
        bool GetProxyFromEnvVar(base::StringPiece variable, ProxyServer* result_server);
        ...
        void SetNewProxyConfig(const absl::optional<ProxyConfigWithAnnotation>& new_config);
