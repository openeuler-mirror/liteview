...
public:
    ...
    bool is_direct_only() const { return is_direct() && proxy_list_.size() == 1 && proxy_retry_info_.empty(); }
    ...
    void set_proxy_resolve_start_time(const base::TimeTicks& proxy_resolve_start_time) { proxy_resolve_start_time_ = proxy_resolve_start_time; }

    base::TimeTicks proxy_resolve_start_time() const { return proxy_resolve_start_time_; }

    void set_proxy_resolve_end_time(const base::TimeTicks& proxy_resolve_end_time) { proxy_resolve_end_time_ = proxy_resolve_end_time; }

    base::TimeTicks proxy_resolve_end_time() const { return proxy_resolve_end_time_; }

    void set_traffic_annotation(const MutableNetworkTrafficAnnotationTag& traffic_annotation) { traffic_annotation_ = traffic_annotation; }

    MutableNetworkTrafficAnnotationTag traffic_annotation() const { return traffic_annotation_; }
