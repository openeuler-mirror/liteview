...
void MockPacFileFetcher::Cancel() { pending_request_callback_.Reset(); }
...
URLRequestContext* MockPacFileFetcher::GetRequestContext() const { return nullptr; }

const GURL& MockPacFileFetcher::pending_request_url() const { return pending_request_url_; }

bool MockPacFileFetcher::has_pending_request() const { return !pending_request_callback_.is_null(); }
