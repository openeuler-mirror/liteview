...
void ExpectProxyServerEquals(const char* expectation, const ProxyList& proxy_servers)
{
...
ProxyConfigToValueTestCase GetTestCaseDirect() { return { ProxyConfig::CreateDirect(), "{}" }; }

ProxyConfigToValueTestCase GetTestCaseAutoDetect() { return { ProxyConfig::CreateAutoDetect(), "{\"auto_detect\":true}" }; }
...
INSTANTIATE_TEST_SUITE_P(All, ProxyConfigToValueTest,
    testing::Values(GetTestCaseDirect(), GetTestCaseAutoDetect(), GetTestCasePacUrl(), GetTestCasePacUrlMandatory(), GetTestCasePacUrlAndAutoDetect(), GetTestCaseSingleProxy(),
        GetTestCaseSingleProxyWithBypass(), GetTestCaseSingleProxyWithReversedBypass(), GetTestCaseProxyPerScheme(), GetTestCaseSingleProxyList()));
...
protected:
    void ParseFromString(const std::string& rules) { rules_.ParseFromString(rules); }
