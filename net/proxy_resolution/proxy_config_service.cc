...
public:
    ...
    ConfigAvailability GetLatestProxyConfig(ProxyConfigWithAnnotation* config) override { return CONFIG_UNSET; }
};
#endif
...
#elif BUILDFLAG(IS_ANDROID)
    return std::make_unique<ProxyConfigServiceAndroid>(std::move(main_task_runner), base::ThreadTaskRunnerHandle::Get());
