...
public:
    ...
    ProxyConfigService::ConfigAvailability availability() const { return availability_; }
...
public:
    JavaLooperPreparer() { Java_AndroidProxyConfigServiceTestUtil_prepareLooper(base::android::AttachCurrentThread()); }
};
...
protected:
    ...
    explicit ProxyConfigServiceAndroidTestBase(const StringMap& initial_configuration)
        ...
        , service_(base::ThreadTaskRunnerHandle::Get(), base::ThreadTaskRunnerHandle::Get(),
    ...
    void ClearConfiguration() { configuration_.clear(); }

    void AddProperty(const std::string& key, const std::string& value) { configuration_[key] = value; }
    ...
    void SetProxyOverride(
        const ProxyConfigServiceAndroid::ProxyOverrideRule& rule, const std::vector<std::string>& bypass_rules, const bool reverse_bypass, base::OnceClosure callback)
    {
    ...
    void SetProxyOverride(
        const std::vector<ProxyConfigServiceAndroid::ProxyOverrideRule>& rules, const std::vector<std::string>& bypass_rules, const bool reverse_bypass, base::OnceClosure callback)
    {
