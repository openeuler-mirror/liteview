...
public:
    ...
    using GetAllCookiesWithAccessSemanticsCallback = base::OnceCallback<void(const CookieList& cookies, const std::vector<CookieAccessSemantics>& access_semantics_list)>;
    ...
    virtual void SetCanonicalCookieAsync(std::unique_ptr<CanonicalCookie> cookie, const GURL& source_url, const CookieOptions& options, SetCookiesCallback callback,
    ...
    // reset to null.
    const CookieAccessDelegate* cookie_access_delegate() const { return cookie_access_delegate_.get(); }
