...
public:
    ...
    static CookiePartitionKeyCollection ContainsAll() { return CookiePartitionKeyCollection(true); }

    static CookiePartitionKeyCollection FromOptional(const absl::optional<CookiePartitionKey>& opt_key)
    {
    ...
    static CookiePartitionKeyCollection Todo() { return CookiePartitionKeyCollection(); }
