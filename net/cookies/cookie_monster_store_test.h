...
public:
    ...
    void set_store_load_commands(bool store_load_commands) { store_load_commands_ = store_load_commands; }
    ...
    CookieMonster::PersistentCookieStore::LoadedCallback TakeCallbackAt(size_t i) { return std::move(commands_[i].loaded_callback); }
