...
MATCHER_P(MatchesCookieWithName, name, "") { return testing::ExplainMatchResult(name, arg.Name(), result_listener); }
...
MATCHER_P(MatchesCookieAccessWithName, name, "") { return testing::ExplainMatchResult(MatchesCookieWithName(name), arg.cookie, result_listener); }
...
MATCHER_P(CookieStringIs, inner_matcher, "") { return testing::ExplainMatchResult(WhenKVSplit(';', '=', inner_matcher), arg, result_listener); }
...
MATCHER(HasDowngradeWarning, "")
{
    ...
    return testing::ExplainMatchResult(true, status.HasDowngradeWarning(), result_listener);
}
...
MATCHER_P4(MatchesCookieAccessResult, status, effective_same_site, access_semantics, is_allowed_to_access_secure_cookies, "")
{
    ...
    return testing::ExplainMatchResult(status, car.status, result_listener) && testing::ExplainMatchResult(effective_same_site, car.effective_same_site, result_listener)
