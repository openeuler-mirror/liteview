...
void RecordCookieSameSiteAttributeValueHistogram(CookieSameSiteString value, bool is_cookie_same_party)
{
    UMA_HISTOGRAM_ENUMERATION("Cookie.SameSiteAttributeValue", value);
    if (is_cookie_same_party) {
        base::UmaHistogramEnumeration("Cookie.SamePartyCookieSameSiteAttributeValue", value);
    }
}
