...
protected:
    ...
    void DeliverChangeNotifications() { CookieStoreTestTraits::DeliverChangeNotifications(); }
...
TYPED_TEST_P(CookieStoreChangeGlobalTest, NoCookie)
{
    ...
    std::unique_ptr<CookieChangeSubscription> subscription
        = cs->GetChangeDispatcher().AddCallbackForAllChanges(base::BindRepeating(&CookieStoreChangeTestBase<TypeParam>::OnCookieChange, base::Unretained(&cookie_changes)));
...
TYPED_TEST_P(CookieStoreChangeGlobalTest, DeregisterMultiple)
{
    ...
    std::unique_ptr<CookieChangeSubscription> subscription1
        = cs->GetChangeDispatcher().AddCallbackForAllChanges(base::BindRepeating(&CookieStoreChangeTestBase<TypeParam>::OnCookieChange, base::Unretained(&cookie_changes_1)));

    std::vector<CookieChangeInfo> cookie_changes_2;
    std::unique_ptr<CookieChangeSubscription> subscription2
        = cs->GetChangeDispatcher().AddCallbackForAllChanges(base::BindRepeating(&CookieStoreChangeTestBase<TypeParam>::OnCookieChange, base::Unretained(&cookie_changes_2)));
    this->DeliverChangeNotifications();
...
TYPED_TEST_P(CookieStoreChangeUrlTest, NoCookie)
{
    ...
    CookieStore* cs = this->GetCookieStore();
    std::vector<CookieChangeInfo> cookie_changes;
    std::unique_ptr<CookieChangeSubscription> subscription = cs->GetChangeDispatcher().AddCallbackForUrl(this->http_www_foo_.url(), absl::nullopt /* cookie_partition_key */,
...
TYPED_TEST_P(CookieStoreChangeUrlTest, InsertFiltering)
{
    ...
    CookieStore* cs = this->GetCookieStore();
    std::vector<CookieChangeInfo> cookie_changes;
    std::unique_ptr<CookieChangeSubscription> subscription = cs->GetChangeDispatcher().AddCallbackForUrl(this->www_foo_foo_.url(), absl::nullopt /* cookie_partition_key */,
        base::BindRepeating(&CookieStoreChangeTestBase<TypeParam>::OnCookieChange, base::Unretained(&cookie_changes)));
    this->DeliverChangeNotifications();
    ASSERT_EQ(0u, cookie_changes.size());
...
TYPED_TEST_P(CookieStoreChangeUrlTest, DeregisterMultiple)
{
    ...
    // Register two subscriptions.
    std::vector<CookieChangeInfo> cookie_changes_1, cookie_changes_2;
    std::unique_ptr<CookieChangeSubscription> subscription1 = cs->GetChangeDispatcher().AddCallbackForUrl(this->http_www_foo_.url(), absl::nullopt /* cookie_partition_key */,
        base::BindRepeating(&CookieStoreChangeTestBase<TypeParam>::OnCookieChange, base::Unretained(&cookie_changes_1)));
    std::unique_ptr<CookieChangeSubscription> subscription2 = cs->GetChangeDispatcher().AddCallbackForUrl(this->http_www_foo_.url(), absl::nullopt /* cookie_partition_key */,
...
TYPED_TEST_P(CookieStoreChangeUrlTest, DifferentSubscriptionsDisjoint)
{
    ...
    std::unique_ptr<CookieChangeSubscription> subscription1 = cs->GetChangeDispatcher().AddCallbackForUrl(this->http_www_foo_.url(), absl::nullopt /* cookie_partition_key */,
        base::BindRepeating(&CookieStoreChangeTestBase<TypeParam>::OnCookieChange, base::Unretained(&cookie_changes_1)));
    std::unique_ptr<CookieChangeSubscription> subscription2 = cs->GetChangeDispatcher().AddCallbackForUrl(this->http_bar_com_.url(), absl::nullopt /* cookie_partition_key */,
        base::BindRepeating(&CookieStoreChangeTestBase<TypeParam>::OnCookieChange, base::Unretained(&cookie_changes_2)));
    this->DeliverChangeNotifications();
    ASSERT_EQ(0u, cookie_changes_1.size());
    ASSERT_EQ(0u, cookie_changes_2.size());
...
TYPED_TEST_P(CookieStoreChangeUrlTest, DifferentSubscriptionsPaths)
{
    ...
    std::unique_ptr<CookieChangeSubscription> subscription1 = cs->GetChangeDispatcher().AddCallbackForUrl(this->http_www_foo_.url(), absl::nullopt /* cookie_partition_key */,
        base::BindRepeating(&CookieStoreChangeTestBase<TypeParam>::OnCookieChange, base::Unretained(&cookie_changes_1)));
    std::unique_ptr<CookieChangeSubscription> subscription2 = cs->GetChangeDispatcher().AddCallbackForUrl(this->www_foo_foo_.url(), absl::nullopt /* cookie_partition_key */,
        base::BindRepeating(&CookieStoreChangeTestBase<TypeParam>::OnCookieChange, base::Unretained(&cookie_changes_2)));
    this->DeliverChangeNotifications();
    ASSERT_EQ(0u, cookie_changes_1.size());
    ASSERT_EQ(0u, cookie_changes_2.size());
...
TYPED_TEST_P(CookieStoreChangeUrlTest, DifferentSubscriptionsFiltering)
{
    ...
    std::unique_ptr<CookieChangeSubscription> subscription2 = cs->GetChangeDispatcher().AddCallbackForUrl(this->http_bar_com_.url(), absl::nullopt /* cookie_partition_key */,
        base::BindRepeating(&CookieStoreChangeTestBase<TypeParam>::OnCookieChange, base::Unretained(&cookie_changes_2)));
    std::unique_ptr<CookieChangeSubscription> subscription3 = cs->GetChangeDispatcher().AddCallbackForUrl(this->www_foo_foo_.url(), absl::nullopt /* cookie_partition_key */,
...
TYPED_TEST_P(CookieStoreChangeUrlTest, ChangeIncludesCookieAccessSemantics)
{
    ...
    std::vector<CookieChangeInfo> cookie_changes;
    std::unique_ptr<CookieChangeSubscription> subscription = cs->GetChangeDispatcher().AddCallbackForUrl(GURL("http://domain1.test"), absl::nullopt /* cookie_partition_key */,
        base::BindRepeating(&CookieStoreChangeTestBase<TypeParam>::OnCookieChange, base::Unretained(&cookie_changes)));
...
TYPED_TEST_P(CookieStoreChangeUrlTest, PartitionedCookies)
{
    ...
    this->CreateAndSetCookie(cs, GURL("https://www.example.com/"), "__Host-b=2; Secure; Path=/; Partitioned", CookieOptions::MakeAllInclusive(), absl::nullopt /* server_time */,
        absl::nullopt /* system_time */, absl::make_optional(CookiePartitionKey::FromURLForTesting(GURL("https://sub.foo.com"))));
    // Partitioned cookie with a different partition key
    this->CreateAndSetCookie(cs, GURL("https://www.example.com"), "__Host-c=3; Secure; Path=/; Partitioned", CookieOptions::MakeAllInclusive(), absl::nullopt /* server_time */,
        absl::nullopt /* system_time */, absl::make_optional(CookiePartitionKey::FromURLForTesting(GURL("https://www.bar.com"))));
    this->DeliverChangeNotifications();
    ...
    std::unique_ptr<CookieChangeSubscription> other_subscription = cs->GetChangeDispatcher().AddCallbackForUrl(GURL("https://www.example.com/"),
        absl::nullopt /* cookie_partition_key */, base::BindRepeating(&CookieStoreChangeTestBase<TypeParam>::OnCookieChange, base::Unretained(&other_cookie_changes)));
    ...
    this->CreateAndSetCookie(cs, GURL("https://www.example.com"), "__Host-b=2; Secure; Path=/; Partitioned; Max-Age=7200", CookieOptions::MakeAllInclusive(),
        absl::nullopt /* server_time */, absl::nullopt /* system_time */, absl::make_optional(CookiePartitionKey::FromURLForTesting(GURL("https://www.foo.com"))));
    this->DeliverChangeNotifications();
...
TYPED_TEST_P(CookieStoreChangeNamedTest, NoCookie)
{
    ...
    std::unique_ptr<CookieChangeSubscription> subscription = cs->GetChangeDispatcher().AddCallbackForCookie(this->http_www_foo_.url(), "abc",
        absl::nullopt /* cookie_partition_key */, base::BindRepeating(&CookieStoreChangeTestBase<TypeParam>::OnCookieChange, base::Unretained(&cookie_changes)));
    this->DeliverChangeNotifications();
    EXPECT_EQ(0u, cookie_changes.size());
}
...
TYPED_TEST_P(CookieStoreChangeNamedTest, DeregisterMultiple)
{
    ...
    // Register two subscriptions.
    std::vector<CookieChangeInfo> cookie_changes_1, cookie_changes_2;
    std::unique_ptr<CookieChangeSubscription> subscription1 = cs->GetChangeDispatcher().AddCallbackForCookie(this->www_foo_foo_.url(), "abc",
        absl::nullopt /* cookie_partition_key */, base::BindRepeating(&CookieStoreChangeTestBase<TypeParam>::OnCookieChange, base::Unretained(&cookie_changes_1)));
    std::unique_ptr<CookieChangeSubscription> subscription2 = cs->GetChangeDispatcher().AddCallbackForCookie(this->www_foo_foo_.url(), "abc",
        absl::nullopt /* cookie_partition_key */, base::BindRepeating(&CookieStoreChangeTestBase<TypeParam>::OnCookieChange, base::Unretained(&cookie_changes_2)));
    this->DeliverChangeNotifications();
    ASSERT_EQ(0u, cookie_changes_1.size());
    ASSERT_EQ(0u, cookie_changes_2.size());
...
TYPED_TEST_P(CookieStoreChangeNamedTest, DifferentSubscriptionsDisjoint)
{
    ...
    std::vector<CookieChangeInfo> cookie_changes_1, cookie_changes_2;
    std::unique_ptr<CookieChangeSubscription> subscription1 = cs->GetChangeDispatcher().AddCallbackForCookie(this->http_www_foo_.url(), "abc",
        absl::nullopt /* cookie_partition_key */, base::BindRepeating(&CookieStoreChangeTestBase<TypeParam>::OnCookieChange, base::Unretained(&cookie_changes_1)));
    std::unique_ptr<CookieChangeSubscription> subscription2 = cs->GetChangeDispatcher().AddCallbackForCookie(this->http_bar_com_.url(), "ghi",
        absl::nullopt /* cookie_partition_key */, base::BindRepeating(&CookieStoreChangeTestBase<TypeParam>::OnCookieChange, base::Unretained(&cookie_changes_2)));
    this->DeliverChangeNotifications();
    ASSERT_EQ(0u, cookie_changes_1.size());
    ASSERT_EQ(0u, cookie_changes_2.size());
...
TYPED_TEST_P(CookieStoreChangeNamedTest, DifferentSubscriptionsDomains)
{
    ...
    std::unique_ptr<CookieChangeSubscription> subscription1 = cs->GetChangeDispatcher().AddCallbackForCookie(this->http_www_foo_.url(), "abc",
        absl::nullopt /* cookie_partition_key */, base::BindRepeating(&CookieStoreChangeTestBase<TypeParam>::OnCookieChange, base::Unretained(&cookie_changes_1)));
    std::unique_ptr<CookieChangeSubscription> subscription2 = cs->GetChangeDispatcher().AddCallbackForCookie(this->http_bar_com_.url(), "abc",
        absl::nullopt /* cookie_partition_key */, base::BindRepeating(&CookieStoreChangeTestBase<TypeParam>::OnCookieChange, base::Unretained(&cookie_changes_2)));
    this->DeliverChangeNotifications();
    ASSERT_EQ(0u, cookie_changes_1.size());
    ASSERT_EQ(0u, cookie_changes_2.size());
...
TYPED_TEST_P(CookieStoreChangeNamedTest, DifferentSubscriptionsNames)
{
    ...
    std::unique_ptr<CookieChangeSubscription> subscription1 = cs->GetChangeDispatcher().AddCallbackForCookie(this->http_www_foo_.url(), "abc",
        absl::nullopt /* cookie_partition_key */, base::BindRepeating(&CookieStoreChangeTestBase<TypeParam>::OnCookieChange, base::Unretained(&cookie_changes_1)));
    std::unique_ptr<CookieChangeSubscription> subscription2 = cs->GetChangeDispatcher().AddCallbackForCookie(this->http_www_foo_.url(), "ghi",
        absl::nullopt /* cookie_partition_key */, base::BindRepeating(&CookieStoreChangeTestBase<TypeParam>::OnCookieChange, base::Unretained(&cookie_changes_2)));
    this->DeliverChangeNotifications();
    ASSERT_EQ(0u, cookie_changes_1.size());
    ASSERT_EQ(0u, cookie_changes_2.size());
...
TYPED_TEST_P(CookieStoreChangeNamedTest, DifferentSubscriptionsFiltering)
{
    ...
    std::unique_ptr<CookieChangeSubscription> subscription1 = cs->GetChangeDispatcher().AddCallbackForCookie(this->http_www_foo_.url(), "abc",
        absl::nullopt /* cookie_partition_key */, base::BindRepeating(&CookieStoreChangeTestBase<TypeParam>::OnCookieChange, base::Unretained(&cookie_changes_1)));
    std::unique_ptr<CookieChangeSubscription> subscription2 = cs->GetChangeDispatcher().AddCallbackForCookie(this->http_www_foo_.url(), "hij",
        absl::nullopt /* cookie_partition_key */, base::BindRepeating(&CookieStoreChangeTestBase<TypeParam>::OnCookieChange, base::Unretained(&cookie_changes_2)));
    std::unique_ptr<CookieChangeSubscription> subscription3 = cs->GetChangeDispatcher().AddCallbackForCookie(this->http_bar_com_.url(), "abc",
        absl::nullopt /* cookie_partition_key */, base::BindRepeating(&CookieStoreChangeTestBase<TypeParam>::OnCookieChange, base::Unretained(&cookie_changes_3)));
    std::unique_ptr<CookieChangeSubscription> subscription4 = cs->GetChangeDispatcher().AddCallbackForCookie(this->www_foo_foo_.url(), "abc",
        absl::nullopt /* cookie_partition_key */, base::BindRepeating(&CookieStoreChangeTestBase<TypeParam>::OnCookieChange, base::Unretained(&cookie_changes_4)));
    this->DeliverChangeNotifications();
    ASSERT_EQ(0u, cookie_changes_1.size());
    ASSERT_EQ(0u, cookie_changes_2.size());
    EXPECT_EQ(0u, cookie_changes_3.size());
...
TYPED_TEST_P(CookieStoreChangeNamedTest, MultipleSubscriptions)
{
    ...
    std::unique_ptr<CookieChangeSubscription> subscription1 = cs->GetChangeDispatcher().AddCallbackForCookie(this->http_www_foo_.url(), "abc",
        absl::nullopt /* cookie_partition_key */, base::BindRepeating(&CookieStoreChangeTestBase<TypeParam>::OnCookieChange, base::Unretained(&cookie_changes_1)));
    std::unique_ptr<CookieChangeSubscription> subscription2 = cs->GetChangeDispatcher().AddCallbackForCookie(this->http_www_foo_.url(), "abc",
        absl::nullopt /* cookie_partition_key */, base::BindRepeating(&CookieStoreChangeTestBase<TypeParam>::OnCookieChange, base::Unretained(&cookie_changes_2)));
    this->DeliverChangeNotifications();
...
TYPED_TEST_P(CookieStoreChangeNamedTest, SubscriptionOutlivesStore)
{
    ...
    std::vector<CookieChangeInfo> cookie_changes;
    std::unique_ptr<CookieChangeSubscription> subscription = this->GetCookieStore()->GetChangeDispatcher().AddCallbackForCookie(this->http_www_foo_.url(), "abc",
        absl::nullopt /* cookie_partition_key */, base::BindRepeating(&CookieStoreChangeTestBase<TypeParam>::OnCookieChange, base::Unretained(&cookie_changes)));
...
TYPED_TEST_P(CookieStoreChangeNamedTest, PartitionedCookies)
{
    ...
    std::vector<CookieChangeInfo> cookie_changes;
    std::unique_ptr<CookieChangeSubscription> subscription
        = cs->GetChangeDispatcher().AddCallbackForCookie(GURL("https://www.example.com"), "__Host-a", CookiePartitionKey::FromURLForTesting(GURL("https://www.foo.com")),
            base::BindRepeating(&CookieStoreChangeTestBase<TypeParam>::OnCookieChange, base::Unretained(&cookie_changes)));

    // Unpartitioned cookie
    this->CreateAndSetCookie(cs, GURL("https://www.example.com"), "__Host-a=1; Secure; Path=/", CookieOptions::MakeAllInclusive());
    // Partitioned cookie with the same partition key
    this->CreateAndSetCookie(cs, GURL("https://www.example.com"), "__Host-a=2; Secure; Path=/; Partitioned", CookieOptions::MakeAllInclusive(), absl::nullopt /* server_time */,
        absl::nullopt /* system_time */, absl::make_optional(CookiePartitionKey::FromURLForTesting(GURL("https://sub.foo.com"))));
    // Partitioned cookie with a different partition key
    this->CreateAndSetCookie(cs, GURL("https://www.example.com"), "__Host-a=3; Secure; Path=/; Partitioned", CookieOptions::MakeAllInclusive(), absl::nullopt /* server_time */,
        absl::nullopt /* system_time */, absl::make_optional(CookiePartitionKey::FromURLForTesting(GURL("https://www.bar.com"))));
    this->DeliverChangeNotifications();
    ...
    // cookies do not emit events.
    std::vector<CookieChangeInfo> other_cookie_changes;
    std::unique_ptr<CookieChangeSubscription> other_subscription = cs->GetChangeDispatcher().AddCallbackForCookie(GURL("https://www.example.com"), "__Host-a",
        absl::nullopt /* cookie_partition_key */, base::BindRepeating(&CookieStoreChangeTestBase<TypeParam>::OnCookieChange, base::Unretained(&other_cookie_changes)));
    // Update Max-Age: None -> 7200
...
REGISTER_TYPED_TEST_SUITE_P(CookieStoreChangeGlobalTest, NoCookie, InitialCookie, InsertOne, InsertMany, DeleteOne, DeleteTwo, Overwrite, OverwriteWithHttpOnly, Deregister,
    DeregisterMultiple, DispatchRace, DeregisterRace, DeregisterRaceMultiple, MultipleSubscriptions, ChangeIncludesCookieAccessSemantics);

REGISTER_TYPED_TEST_SUITE_P(CookieStoreChangeUrlTest, NoCookie, InitialCookie, InsertOne, InsertMany, InsertFiltering, DeleteOne, DeleteTwo, DeleteFiltering, Overwrite,
    OverwriteFiltering, OverwriteWithHttpOnly, Deregister, DeregisterMultiple, DispatchRace, DeregisterRace, DeregisterRaceMultiple, DifferentSubscriptionsDisjoint,
    DifferentSubscriptionsDomains, DifferentSubscriptionsPaths, DifferentSubscriptionsFiltering, MultipleSubscriptions, ChangeIncludesCookieAccessSemantics, PartitionedCookies);

REGISTER_TYPED_TEST_SUITE_P(CookieStoreChangeNamedTest, NoCookie, InitialCookie, InsertOne, InsertTwo, InsertFiltering, DeleteOne, DeleteTwo, DeleteFiltering, Overwrite,
    OverwriteFiltering, OverwriteWithHttpOnly, Deregister, DeregisterMultiple, DispatchRace, DeregisterRace, DeregisterRaceMultiple, DifferentSubscriptionsDisjoint,
    DifferentSubscriptionsDomains, DifferentSubscriptionsNames, DifferentSubscriptionsPaths, DifferentSubscriptionsFiltering, MultipleSubscriptions, SubscriptionOutlivesStore,
    ChangeIncludesCookieAccessSemantics, PartitionedCookies);
