...
public:
    ...
    // is valid.
    explicit ParsedCookie(const std::string& cookie_line, CookieInclusionStatus* status_out = nullptr);
    ...
    TruncatingCharacterInCookieStringType GetTruncatingCharacterInCookieStringType() const { return truncating_char_in_cookie_string_type_; }
...
private:
    void ParseTokenValuePairs(const std::string& cookie_line, CookieInclusionStatus& status_out);
    ...
    TruncatingCharacterInCookieStringType truncating_char_in_cookie_string_type_ = TruncatingCharacterInCookieStringType::kTruncatingCharNone;
};
