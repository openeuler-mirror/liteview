...
public:
    ...
    void GetReports(std::vector<const ReportingReport*>* reports_out) const override;
    ...
    void ClearReportsPending(const std::vector<const ReportingReport*>& reports) override;
    void IncrementReportsAttempts(const std::vector<const ReportingReport*>& reports) override;
    ...
    void RemoveReports(const std::vector<const ReportingReport*>& reports) override;
    void RemoveReports(const std::vector<const ReportingReport*>& reports, bool delivery_success) override;
...
private:
    ...
    absl::optional<EndpointMap::iterator> RemoveEndpointInternal(ClientMap::iterator client_it, EndpointGroupMap::iterator group_it, EndpointMap::iterator endpoint_it);
