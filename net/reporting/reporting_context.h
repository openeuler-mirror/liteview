...
public:
    ...
    static std::unique_ptr<ReportingContext> Create(const ReportingPolicy& policy, URLRequestContext* request_context, ReportingCache::PersistentReportingStore* store);
    ...
    ReportingGarbageCollector* garbage_collector() { return garbage_collector_.get(); }
