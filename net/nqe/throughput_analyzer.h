...
protected:
    // Exposed for testing.
    bool disable_throughput_measurements_for_testing() const { return disable_throughput_measurements_; }
    ...
    bool IsHangingWindow(int64_t bits_received, base::TimeDelta duration, double downstream_kbps_double) const;
