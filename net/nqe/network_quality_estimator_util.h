...
// for testing.
NET_EXPORT_PRIVATE bool IsPrivateHostForTesting(HostResolver* host_resolver, const HostPortPair& host_port_pair, const NetworkAnonymizationKey& network_isolation_key);
