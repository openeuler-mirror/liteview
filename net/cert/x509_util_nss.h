...
NET_EXPORT ScopedCERTCertificate CreateCERTCertificateFromBytes(const uint8_t* data, size_t length);
...
NET_EXPORT ScopedCERTCertificateList CreateCERTCertificateListFromX509Certificate(const X509Certificate* cert, InvalidIntermediateBehavior invalid_intermediate_behavior);
...
NET_EXPORT ScopedCERTCertificateList CreateCERTCertificateListFromBytes(const char* data, size_t length, int format);
