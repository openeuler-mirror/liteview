...
public:
    ...
    public:
        RequestParams();
        RequestParams(scoped_refptr<X509Certificate> certificate, base::StringPiece hostname, int flags, base::StringPiece ocsp_response, base::StringPiece sct_list);
        RequestParams(const RequestParams& other);
        ~RequestParams();

        const scoped_refptr<X509Certificate>& certificate() const { return certificate_; }
    ...
    static std::unique_ptr<CertVerifier> CreateDefaultWithoutCaching(scoped_refptr<CertNetFetcher> cert_net_fetcher);
...
public:
    ...
    virtual void UpdateChromeRootStoreData(scoped_refptr<CertNetFetcher> cert_net_fetcher, const ChromeRootStoreData* root_store_data) = 0;
};
