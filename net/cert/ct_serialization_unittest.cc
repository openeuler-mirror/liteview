...
public:
    void SetUp() override { test_digitally_signed_ = ct::GetTestDigitallySigned(); }
...
{
    base::StringPiece digitally_signed(test_digitally_signed_);
    base::StringPiece partial_digitally_signed(digitally_signed.substr(0, test_digitally_signed_.size() - 5));
    ct::DigitallySigned parsed;
