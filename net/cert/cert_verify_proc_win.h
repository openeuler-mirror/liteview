...
public:
    ...
    public:
        ...
        // not be filled.
        const base::Time& authroot_this_update() const { return authroot_this_update_; }
        ...
        // be filled.
        const std::vector<uint8_t>& authroot_sequence_number() const { return authroot_sequence_number_; }
