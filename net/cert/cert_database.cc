...
CertDatabase* CertDatabase::GetInstance()
{
    ...
    return base::Singleton<CertDatabase, base::LeakySingletonTraits<CertDatabase>>::get();
}

void CertDatabase::AddObserver(Observer* observer) { observer_list_->AddObserver(observer); }

void CertDatabase::RemoveObserver(Observer* observer) { observer_list_->RemoveObserver(observer); }
...
void CertDatabase::NotifyObserversCertDBChanged()
{
    ...
    net::NetLog::Get()->AddGlobalEntry(NetLogEventType::CERTIFICATE_DATABASE_CHANGED);
