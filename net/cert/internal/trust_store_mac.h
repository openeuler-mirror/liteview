...
private:
    ...
    // data.
    static std::vector<bssl::UniquePtr<CRYPTO_BUFFER>> FindMatchingCertificatesForMacNormalizedSubject(CFDataRef name_data);
    ...
    static base::ScopedCFTypeRef<CFDataRef> GetMacNormalizedIssuer(const ParsedCertificate* cert);
