...
public:
    ...
    void SetUp() override
    {
        ...
        // for both.)
        crypto::ScopedPK11Slot private_slot_1(crypto::GetPrivateSlotForChromeOSUser(user_1_.username_hash(), base::OnceCallback<void(crypto::ScopedPK11Slot)>()));
        ...
        crypto::ScopedPK11Slot private_slot_2(crypto::GetPrivateSlotForChromeOSUser(user_2_.username_hash(), base::OnceCallback<void(crypto::ScopedPK11Slot)>()));
        ASSERT_TRUE(private_slot_2.get());
        profile_filter_2_.Init(crypto::GetPublicSlotForChromeOSUser(user_2_.username_hash()), std::move(private_slot_2), crypto::ScopedPK11Slot() /* no system slot */);
    ...
    crypto::ScopedPK11Slot get_system_slot() { return crypto::ScopedPK11Slot(PK11_ReferenceSlot(system_slot_user_.slot())); }
