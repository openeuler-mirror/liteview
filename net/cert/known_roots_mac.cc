...
bool IsKnownRoot(SecCertificateRef cert) { return g_known_roots.Get().IsKnownRoot(cert); }

bool IsKnownRoot(const HashValue& cert_sha256) { return g_known_roots.Get().IsKnownRoot(cert_sha256); }
