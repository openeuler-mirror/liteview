...
public:
    ...
    static scoped_refptr<const CTLogVerifier> Create(const base::StringPiece& public_key, std::string description);
...
private:
    ...
    bool VerifySignature(const base::StringPiece& data_to_sign, const base::StringPiece& signature) const;
