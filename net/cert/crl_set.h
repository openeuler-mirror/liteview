...
public:
    ...
    static bool ParseAndStoreUnparsedData(std::string data, scoped_refptr<CRLSet>* out_crl_set);
    ...
    //       signer
    Result CheckSerial(base::StringPiece serial_number, base::StringPiece issuer_spki_hash) const;
    ...
    Result CheckSubject(base::StringPiece asn1_subject, base::StringPiece spki_hash) const;
    ...
    static scoped_refptr<CRLSet> ForTesting(bool is_expired, const SHA256HashValue* issuer_spki, base::StringPiece serial_number, base::StringPiece utf8_common_name,
