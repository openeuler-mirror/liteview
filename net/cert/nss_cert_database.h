...
public:
    ...
    int ImportFromPKCS12(PK11SlotInfo* slot_info, const std::string& data, const std::u16string& password, bool is_extractable, ScopedCERTCertificateList* imported_certs);
    ...
    int ExportToPKCS12(const ScopedCERTCertificateList& certs, const std::u16string& password, std::string* output) const;
...
protected:
    ...
    static CertInfoList ListCertsInfoImpl(crypto::ScopedPK11Slot slot, bool add_certs_info);
