...
void TestRootCerts::ClearImpl() { CFArrayRemoveAllValues(temporary_roots_); }
...
void TestRootCerts::Init() { temporary_roots_.reset(CFArrayCreateMutable(kCFAllocatorDefault, 0, &kCFTypeArrayCallBacks)); }
