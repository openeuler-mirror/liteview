...
TEST(ParseCertificatePoliciesExtensionTest, TwoPoliciesWithQualifiers)
{
    ...
    ASSERT_EQ(2U, policies.size());
    {
        ...
        const uint8_t kExpectedQualifier[]
            = { 0x16, 0x19, 0x68, 0x74, 0x74, 0x70, 0x73, 0x3a, 0x2f, 0x2f, 0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x31, 0x5f, 0x32, 0x5f, 0x33 };
        EXPECT_EQ(der::Input(kExpectedQualifier), qualifier.qualifier);
    }
    {
        PolicyInformation& policy = policies[1];
        ...
        const uint8_t kExpectedQualifier[]
            = { 0x16, 0x18, 0x68, 0x74, 0x74, 0x70, 0x3a, 0x2f, 0x2f, 0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x31, 0x5f, 0x32, 0x5f, 0x34 };
        EXPECT_EQ(der::Input(kExpectedQualifier), qualifier.qualifier);
    }
}
