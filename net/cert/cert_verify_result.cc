...
CertVerifyResult::CertVerifyResult() { Reset(); }

CertVerifyResult::CertVerifyResult(const CertVerifyResult& other) { *this = other; }
...
CertVerifyResult& CertVerifyResult::operator=(const CertVerifyResult& other)
{
    ...
    is_issued_by_additional_trust_anchor = other.is_issued_by_additional_trust_anchor;
