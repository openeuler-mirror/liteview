...
TEST(X509TypesTest, ParseDNUserTrust)
{
    ...
    EXPECT_TRUE(usertrust.ParseDistinguishedName(UserTrustDN, sizeof(UserTrustDN)));
...
TEST(X509TypesTest, ParseDNTurkTrust)
{
    ...
    EXPECT_TRUE(turktrust.ParseDistinguishedName(TurkTrustDN, sizeof(TurkTrustDN)));
...
TEST(X509TypesTest, ParseDNATrust)
{
    ...
    EXPECT_TRUE(atrust.ParseDistinguishedName(ATrustQual01DN, sizeof(ATrustQual01DN)));
