...
public:
    ...
    void AdvanceTime(const TimeTicks& absolute_time) override { now_ = absolute_time; }
    ...
    int max_experienced_queries_per_tick() const { return max_experienced_queries_per_tick_; }
...
public:
    ...
    void SetFakeNow(const TimeTicks& fake_time) { fake_clock_.set_now(fake_time); }
...
public:
    ...
    void SetRequestJitter(const base::TimeDelta& request_jitter) { request_jitter_ = request_jitter; }
