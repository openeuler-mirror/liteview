...
public:
    ...
    void set_expected_content_size(const int64_t& size) { expected_content_size_ = size; }
    ...
    static GURL ComputeReferrerForPolicy(ReferrerPolicy policy, const GURL& original_referrer, const GURL& destination, bool* same_origin_out_for_metrics = nullptr);
