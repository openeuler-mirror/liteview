...
bool URLRequestJobFactory::ProtocolHandler::IsSafeRedirectTarget(const GURL& location) const { return true; }
...
URLRequestJobFactory::~URLRequestJobFactory() { DCHECK_CALLED_ON_VALID_THREAD(thread_checker_); }
