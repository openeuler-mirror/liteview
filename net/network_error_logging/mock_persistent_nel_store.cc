...
bool operator!=(const MockPersistentNelStore::Command& lhs, const MockPersistentNelStore::Command& rhs) { return !(lhs == rhs); }
...
bool MockPersistentNelStore::VerifyCommands(const CommandList& expected_commands) const { return command_list_ == expected_commands; }

MockPersistentNelStore::CommandList MockPersistentNelStore::GetAllCommands() const { return command_list_; }
