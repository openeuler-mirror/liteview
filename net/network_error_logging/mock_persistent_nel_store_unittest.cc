...
void RunClosureOnNelPoliciesLoaded(
    base::OnceClosure closure, std::vector<NetworkErrorLoggingService::NelPolicy>* policies_out, std::vector<NetworkErrorLoggingService::NelPolicy> loaded_policies)
{
...
protected:
    ...
    const NetworkAnonymizationKey network_anonymization_key_ = NetworkAnonymizationKey(SchemefulSite(GURL("https://foo.test/")), SchemefulSite(GURL("https://bar.test/")));
