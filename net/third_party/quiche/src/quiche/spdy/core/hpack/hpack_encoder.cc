...
public:
    ...
    bool HasNext() { return pseudo_begin_ != pseudo_end_ || regular_begin_ != regular_end_; }
...
std::unique_ptr<HpackEncoder::ProgressiveEncoder> HpackEncoder::EncodeHeaderSet(const Http2HeaderBlock& header_set) { return std::make_unique<Encoderator>(header_set, this); }
