...
size_t HpackDecoderAdapter::GetCurrentHeaderTableSizeSetting() const { return hpack_decoder_.GetCurrentHeaderTableSizeSetting(); }
...
const Http2HeaderBlock& HpackDecoderAdapter::decoded_block() const { return listener_adapter_.decoded_block(); }
...
void HpackDecoderAdapter::set_max_header_block_bytes(size_t max_header_block_bytes) { max_header_block_bytes_ = max_header_block_bytes; }
...
void HpackDecoderAdapter::ListenerAdapter::set_handler(SpdyHeadersHandlerInterface* handler) { handler_ = handler; }
