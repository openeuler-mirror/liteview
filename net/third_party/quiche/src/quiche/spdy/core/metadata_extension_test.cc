...
protected:
    ...
    void SetUp() override
    {
        extension_ = absl::make_unique<MetadataVisitor>(bind_front(&MetadataExtensionTest::OnCompletePayload, this), bind_front(&MetadataExtensionTest::OnMetadataSupport, this));
    }
