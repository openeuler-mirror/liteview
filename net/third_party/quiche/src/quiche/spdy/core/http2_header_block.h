...
public:
    ...
    const_iterator find(absl::string_view key) const { return wrap_const_iterator(map_.find(key)); }
    ...
    private:
        ...
        ValueProxy(Http2HeaderBlock* block, Http2HeaderBlock::MapType::iterator lookup_result, const absl::string_view key, size_t* spdy_header_block_value_size);
