...
public:
    static absl::string_view key(Http2HeaderBlock::ValueProxy* p) { return p->key_; }
};

std::pair<absl::string_view, absl::string_view> Pair(absl::string_view k, absl::string_view v) { return std::make_pair(k, v); }
