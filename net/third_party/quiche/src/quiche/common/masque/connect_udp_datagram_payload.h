...
class QUICHE_EXPORT_PRIVATE ConnectUdpDatagramUdpPacketPayload final : public ConnectUdpDatagramPayload {
public:
...
class QUICHE_EXPORT_PRIVATE ConnectUdpDatagramUnknownPayload final : public ConnectUdpDatagramPayload {
public:
