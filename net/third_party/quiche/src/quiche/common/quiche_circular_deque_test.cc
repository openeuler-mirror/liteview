...
public:
    ...
    friend bool operator==(const CountingAllocator& lhs, const CountingAllocator& rhs) { return lhs.shared_counts_ == rhs.shared_counts_; }

    friend bool operator!=(const CountingAllocator& lhs, const CountingAllocator& rhs) { return !(lhs == rhs); }
...
struct ConfigurableAllocator : public BaseAllocator<T> {
    ...
    friend bool operator==(const ConfigurableAllocator& /*lhs*/, const ConfigurableAllocator& /*rhs*/) { return equality_result; }

    friend bool operator!=(const ConfigurableAllocator& lhs, const ConfigurableAllocator& rhs) { return !(lhs == rhs); }
};
...
public:
    ...
    friend std::ostream& operator<<(std::ostream& os, const Foo& foo) { return os << "Foo(" << foo.i() << ")"; }
