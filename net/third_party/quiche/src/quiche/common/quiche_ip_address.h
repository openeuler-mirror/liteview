...
public:
    ...
    QUICHE_EXPORT_PRIVATE friend bool operator==(QuicheIpAddress lhs, QuicheIpAddress rhs);
    QUICHE_EXPORT_PRIVATE friend bool operator!=(QuicheIpAddress lhs, QuicheIpAddress rhs);
...
public:
    ...
    QUICHE_EXPORT_PRIVATE friend bool operator==(const QuicheIpPrefix& lhs, const QuicheIpPrefix& rhs);
    QUICHE_EXPORT_PRIVATE friend bool operator!=(const QuicheIpPrefix& lhs, const QuicheIpPrefix& rhs);
