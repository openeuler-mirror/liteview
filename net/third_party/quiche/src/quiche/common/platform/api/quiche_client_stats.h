...
#define QUICHE_CLIENT_HISTOGRAM_TIMES(name, sample, min, max, bucket_count, docstring) QUICHE_CLIENT_HISTOGRAM_TIMES_IMPL(name, sample, min, max, bucket_count, docstring)
...
#define QUICHE_CLIENT_HISTOGRAM_COUNTS(name, sample, min, max, bucket_count, docstring) QUICHE_CLIENT_HISTOGRAM_COUNTS_IMPL(name, sample, min, max, bucket_count, docstring)

inline void QuicheClientSparseHistogram(const std::string& name, int sample) { QuicheClientSparseHistogramImpl(name, sample); }
