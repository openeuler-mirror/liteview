...
#define GetQuicheReloadableFlag(module, flag) GetQuicheReloadableFlagImpl(module, flag)
#define SetQuicheReloadableFlag(module, flag, value) SetQuicheReloadableFlagImpl(module, flag, value)
#define GetQuicheRestartFlag(module, flag) GetQuicheRestartFlagImpl(module, flag)
#define SetQuicheRestartFlag(module, flag, value) SetQuicheRestartFlagImpl(module, flag, value)
