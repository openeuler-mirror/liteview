...
inline bool ExpandURITemplate(
    const std::string& uri_template, const absl::flat_hash_map<std::string, std::string>& parameters, std::string* target, absl::flat_hash_set<std::string>* vars_found = nullptr)
{
...
inline absl::optional<std::string> AsciiUrlDecode(absl::string_view input) { return AsciiUrlDecodeImpl(input); }
