...
inline quic::QuicEventLoopFactory* GetOverrideForDefaultEventLoop() { return GetOverrideForDefaultEventLoopImpl(); }

inline std::vector<quic::QuicEventLoopFactory*> GetExtraEventLoopImplementations() { return GetExtraEventLoopImplementationsImpl(); }
