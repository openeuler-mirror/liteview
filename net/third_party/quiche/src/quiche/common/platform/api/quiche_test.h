...
inline std::string QuicheGetTestMemoryCachePath() { return QuicheGetTestMemoryCachePathImpl(); }

// Returns the path to quiche/common directory where the test data could be
// located.
inline std::string QuicheGetCommonSourcePath() { return QuicheGetCommonSourcePathImpl(); }
