...
inline std::unique_ptr<quic::ProofVerifier> CreateDefaultProofVerifier(const std::string& host) { return CreateDefaultProofVerifierImpl(host); }
...
inline std::unique_ptr<quic::ProofSource> CreateDefaultProofSource() { return CreateDefaultProofSourceImpl(); }
