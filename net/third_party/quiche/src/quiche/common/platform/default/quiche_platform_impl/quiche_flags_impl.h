...
#define QUIC_PROTOCOL_FLAG(type, flag, ...) QUICHE_EXPORT_PRIVATE extern type FLAGS_##flag;
#include "quiche/quic/core/quic_protocol_flags_list.h"
#undef QUIC_PROTOCOL_FLAG

// Protocol flags.
#define QUICHE_PROTOCOL_FLAG(type, flag, ...) QUICHE_EXPORT_PRIVATE extern type FLAGS_##flag;
...
inline std::string GetQuicheFlagImplImpl(const std::string& flag) { return flag; }
...
#define GetQuicheReloadableFlagImpl(module, flag) GetQuicheFlag(QUICHE_RELOADABLE_FLAG(flag))
#define SetQuicheReloadableFlagImpl(module, flag, value) SetQuicheFlag(QUICHE_RELOADABLE_FLAG(flag), value)
#define GetQuicheRestartFlagImpl(module, flag) GetQuicheFlag(QUICHE_RESTART_FLAG(flag))
#define SetQuicheRestartFlagImpl(module, flag, value) SetQuicheFlag(QUICHE_RESTART_FLAG(flag), value)
