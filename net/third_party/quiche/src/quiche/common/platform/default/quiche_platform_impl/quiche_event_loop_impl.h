...
inline quic::QuicEventLoopFactory* GetOverrideForDefaultEventLoopImpl() { return nullptr; }

inline std::vector<quic::QuicEventLoopFactory*> GetExtraEventLoopImplementationsImpl() { return {}; }
