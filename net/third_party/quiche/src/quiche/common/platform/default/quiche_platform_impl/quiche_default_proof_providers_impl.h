...
inline std::unique_ptr<quic::ProofVerifier> CreateDefaultProofVerifierImpl(const std::string& /*host*/) { return nullptr; }
inline std::unique_ptr<quic::ProofSource> CreateDefaultProofSourceImpl() { return nullptr; }
