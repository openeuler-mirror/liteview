...
class QUICHE_EXPORT_PRIVATE Http2TraceLogger : public spdy::SpdyFramerVisitorInterface {
public:
    ...
    Http2TraceLogger(SpdyFramerVisitorInterface* parent, absl::string_view perspective, std::function<bool()> is_enabled, const void* connection_id);
...
public:
    ...
    Http2FrameLogger(absl::string_view perspective, std::function<bool()> is_enabled, const void* connection_id)
