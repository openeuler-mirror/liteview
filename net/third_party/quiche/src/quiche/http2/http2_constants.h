...
inline bool IsSupportedHttp2FrameType(uint32_t v) { return v <= static_cast<uint32_t>(Http2FrameType::ALTSVC) || v == static_cast<uint32_t>(Http2FrameType::PRIORITY_UPDATE); }
inline bool IsSupportedHttp2FrameType(Http2FrameType v) { return IsSupportedHttp2FrameType(static_cast<uint32_t>(v)); }
...
QUICHE_EXPORT_PRIVATE inline std::ostream& operator<<(std::ostream& out, Http2FrameType v) { return out << Http2FrameTypeToString(v); }
...
QUICHE_EXPORT_PRIVATE std::string Http2FrameFlagsToString(Http2FrameType type, uint8_t flags);
QUICHE_EXPORT_PRIVATE std::string Http2FrameFlagsToString(uint8_t type, uint8_t flags);
...
inline bool IsSupportedHttp2ErrorCode(uint32_t v) { return v <= static_cast<uint32_t>(Http2ErrorCode::HTTP_1_1_REQUIRED); }
inline bool IsSupportedHttp2ErrorCode(Http2ErrorCode v) { return IsSupportedHttp2ErrorCode(static_cast<uint32_t>(v)); }
...
QUICHE_EXPORT_PRIVATE inline std::ostream& operator<<(std::ostream& out, Http2ErrorCode v) { return out << Http2ErrorCodeToString(v); }
...
inline bool IsSupportedHttp2SettingsParameter(uint32_t v) { return 0 < v && v <= static_cast<uint32_t>(Http2SettingsParameter::MAX_HEADER_LIST_SIZE); }
inline bool IsSupportedHttp2SettingsParameter(Http2SettingsParameter v) { return IsSupportedHttp2SettingsParameter(static_cast<uint32_t>(v)); }

// Format the specified settings parameter.
QUICHE_EXPORT_PRIVATE std::string Http2SettingsParameterToString(uint32_t v);
QUICHE_EXPORT_PRIVATE std::string Http2SettingsParameterToString(Http2SettingsParameter v);
inline std::ostream& operator<<(std::ostream& out, Http2SettingsParameter v) { return out << Http2SettingsParameterToString(v); }
