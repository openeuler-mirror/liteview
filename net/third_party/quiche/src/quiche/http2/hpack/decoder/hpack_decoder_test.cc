...
public:
    ...
    static void set_listener(HpackDecoderState* state, HpackDecoderListener* listener) { state->listener_ = listener; }
};
...
protected:
    ...
    const HpackDecoderTables& GetDecoderTables() { return *HpackDecoderPeer::GetDecoderTables(&decoder_); }
    ...
    void set_header_table_size_limit(size_t size) { HpackDecoderPeer::GetDecoderTables(&decoder_)->DynamicTableSizeUpdate(size); }
