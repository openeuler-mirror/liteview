...
void HpackDecoderState::OnHpackDecodeError(HpackDecodingError error, std::string detailed_error)
{
...
void HpackDecoderState::ReportError(HpackDecodingError error, std::string detailed_error)
{
    QUICHE_DVLOG(2) << "HpackDecoderState::ReportError is new=" << (error_ == HpackDecodingError::kOk ? "true" : "false") << ", error: " << HpackDecodingErrorToString(error);
    if (error_ == HpackDecodingError::kOk) {
