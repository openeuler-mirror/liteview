...
public:
    ...
    size_t GetCurrentHeaderTableSizeSetting() const { return final_header_table_size_; }
    ...
    void OnHpackDecodeError(HpackDecodingError error, std::string detailed_error) override;
    ...
    size_t GetDynamicTableSize() const { return decoder_tables_.current_header_table_size(); }

    const HpackDecoderTables& decoder_tables_for_test() const { return decoder_tables_; }
