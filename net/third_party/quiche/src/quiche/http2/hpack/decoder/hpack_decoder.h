...
public:
    ...
    size_t GetCurrentHeaderTableSizeSetting() const { return decoder_state_.GetCurrentHeaderTableSizeSetting(); }
    ...
    size_t GetDynamicTableSize() const { return decoder_state_.GetDynamicTableSize(); }
