...
TEST(HpackVarintEncoderTest, Long)
{
    ...
    for (size_t i = 0; i < ABSL_ARRAYSIZE(kLongTestData); ++i) {
        std::string expected_encoding = absl::HexStringToBytes(kLongTestData[i].expected_encoding);
...
} kLastByteIsZeroTestData[] = { { 0b10110010, 1, 1, 0b10110011 }, { 0b10101100, 2, 3, 0b10101111 }, { 0b10101000, 3, 7, 0b10101111 }, { 0b10110000, 4, 15, 0b10111111 },
