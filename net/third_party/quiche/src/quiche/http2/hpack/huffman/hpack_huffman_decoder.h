...
inline std::ostream& operator<<(std::ostream& out, const HuffmanBitBuffer& v) { return out << v.DebugString(); }
...
public:
    ...
    bool InputProperlyTerminated() const { return bit_buffer_.InputProperlyTerminated(); }
...
inline std::ostream& operator<<(std::ostream& out, const HpackHuffmanDecoder& v) { return out << v.DebugString(); }
