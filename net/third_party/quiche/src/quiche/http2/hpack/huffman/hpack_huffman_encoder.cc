...
void HuffmanEncode(absl::string_view plain, size_t encoded_size, std::string* huffman)
{
...
void HuffmanEncodeFast(absl::string_view input, size_t encoded_size, std::string* output)
{
