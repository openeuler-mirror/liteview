...
QUICHE_EXPORT_PRIVATE void DoDecode(Http2PushPromiseFields* out, DecodeBuffer* b);
...
QUICHE_EXPORT_PRIVATE void DoDecode(Http2WindowUpdateFields* out, DecodeBuffer* b);
QUICHE_EXPORT_PRIVATE void DoDecode(Http2AltSvcFields* out, DecodeBuffer* b);
QUICHE_EXPORT_PRIVATE void DoDecode(Http2PriorityUpdateFields* out, DecodeBuffer* b);
