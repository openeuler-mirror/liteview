...
private:
    ...
    QUICHE_EXPORT_PRIVATE friend std::ostream& operator<<(std::ostream& out, State v);
    ...
    const Http2FrameHeader& frame_header() const { return frame_decoder_state_.frame_header(); }
