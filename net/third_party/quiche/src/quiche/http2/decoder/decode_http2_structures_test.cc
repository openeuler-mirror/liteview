...
template <typename T, size_t N> absl::string_view ToStringPiece(T (&data)[N]) { return absl::string_view(reinterpret_cast<const char*>(data), N * sizeof(T)); }
...
protected:
    ...
    template <size_t N> void DecodeLeadingStructure(const char (&data)[N]) { DecodeLeadingStructure(nullptr, absl::string_view(data, N)); }
    ...
    void TestDecodingRandomizedStructures() { TestDecodingRandomizedStructures(random_decode_count_); }
...
TEST_F(FrameHeaderDecoderTest, DecodesRandomized) { TestDecodingRandomizedStructures(); }
...
TEST_F(PriorityFieldsDecoderTest, DecodesRandomized) { TestDecodingRandomizedStructures(); }
...
TEST_F(RstStreamFieldsDecoderTest, DecodesRandomized) { TestDecodingRandomizedStructures(); }
...
TEST_F(SettingFieldsDecoderTest, DecodesRandomized) { TestDecodingRandomizedStructures(); }
...
TEST_F(PushPromiseFieldsDecoderTest, DecodesRandomized) { TestDecodingRandomizedStructures(); }
...
TEST_F(PingFieldsDecoderTest, DecodesRandomized) { TestDecodingRandomizedStructures(); }
...
TEST_F(GoAwayFieldsDecoderTest, DecodesRandomized) { TestDecodingRandomizedStructures(); }
...
TEST_F(WindowUpdateFieldsDecoderTest, DecodesRandomized) { TestDecodingRandomizedStructures(); }
...
TEST_F(AltSvcFieldsDecoderTest, DecodesRandomized) { TestDecodingRandomizedStructures(); }
