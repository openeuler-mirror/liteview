...
protected:
    ...
    template <size_t N> AssertionResult DecodeLeadingStructure(const char (&data)[N]) { return DecodeLeadingStructure(nullptr, absl::string_view(data, N)); }

    template <size_t N> AssertionResult DecodeLeadingStructure(const unsigned char (&data)[N]) { return DecodeLeadingStructure(nullptr, ToStringPiece(data)); }
...
TEST_F(Http2FrameHeaderDecoderTest, DecodesRandomized) { EXPECT_TRUE(TestDecodingRandomizedStructures()); }
...
TEST_F(Http2PriorityFieldsDecoderTest, DecodesRandomized) { EXPECT_TRUE(TestDecodingRandomizedStructures()); }
...
TEST_F(Http2RstStreamFieldsDecoderTest, DecodesRandomized) { EXPECT_TRUE(TestDecodingRandomizedStructures()); }
...
TEST_F(Http2SettingFieldsDecoderTest, DecodesRandomized) { EXPECT_TRUE(TestDecodingRandomizedStructures()); }
...
TEST_F(Http2PushPromiseFieldsDecoderTest, DecodesRandomized) { EXPECT_TRUE(TestDecodingRandomizedStructures()); }
...
TEST_F(Http2PingFieldsDecoderTest, DecodesRandomized) { EXPECT_TRUE(TestDecodingRandomizedStructures()); }
...
TEST_F(Http2GoAwayFieldsDecoderTest, DecodesRandomized) { EXPECT_TRUE(TestDecodingRandomizedStructures()); }
...
TEST_F(Http2WindowUpdateFieldsDecoderTest, DecodesRandomized) { EXPECT_TRUE(TestDecodingRandomizedStructures()); }
...
TEST_F(Http2AltSvcFieldsDecoderTest, DecodesRandomized) { EXPECT_TRUE(TestDecodingRandomizedStructures()); }
