...
TEST(DataProviderTest, ReadLessThanSourceProvides)
{
    ...
    ssize_t result = provider->read_callback(nullptr, kStreamId, nullptr, kReadLength, &data_flags, &provider->source, nullptr);
    ...
    int send_result = callbacks::DataFrameSourceSendCallback(nullptr, nullptr, framehd, result, &provider->source, nullptr);
