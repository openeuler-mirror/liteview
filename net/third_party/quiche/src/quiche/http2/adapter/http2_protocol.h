...
QUICHE_EXPORT_PRIVATE bool operator==(const Http2Setting& a, const Http2Setting& b);
...
ABSL_CONST_INIT QUICHE_EXPORT_PRIVATE extern const char kHttp2MethodPseudoHeader[];
ABSL_CONST_INIT QUICHE_EXPORT_PRIVATE extern const char kHttp2SchemePseudoHeader[];
ABSL_CONST_INIT QUICHE_EXPORT_PRIVATE extern const char kHttp2AuthorityPseudoHeader[];
ABSL_CONST_INIT QUICHE_EXPORT_PRIVATE extern const char kHttp2PathPseudoHeader[];
ABSL_CONST_INIT QUICHE_EXPORT_PRIVATE extern const char kHttp2StatusPseudoHeader[];
...
ABSL_CONST_INIT QUICHE_EXPORT_PRIVATE extern const uint16_t kMetadataExtensionId;
