...
TEST(WindowManagerShouldUpdateTest, CustomShouldWindowUpdateFn)
{
    ...
    std::list<int64_t> call_sequence1;
    WindowManager wm1(
        kDefaultLimit, [&call_sequence1](int64_t delta) { call_sequence1.push_back(delta); }, [](int64_t /*limit*/, int64_t /*window*/, int64_t /*delta*/) { return true; });
    // This window manager should never notify.
    std::list<int64_t> call_sequence2;
    WindowManager wm2(
        kDefaultLimit, [&call_sequence2](int64_t delta) { call_sequence2.push_back(delta); }, [](int64_t /*limit*/, int64_t /*window*/, int64_t /*delta*/) { return false; });
    // This window manager should notify as long as no data is buffered.
    std::list<int64_t> call_sequence3;
    WindowManager wm3(
        kDefaultLimit, [&call_sequence3](int64_t delta) { call_sequence3.push_back(delta); }, [](int64_t limit, int64_t window, int64_t delta) { return delta == limit - window; });
