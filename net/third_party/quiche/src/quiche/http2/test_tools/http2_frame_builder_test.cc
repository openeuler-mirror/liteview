...
TEST(Http2FrameBuilderTest, Constructors)
{
    ...
    }
    {
        ...
        const std::string kData = absl::HexStringToBytes("000000" // Payload length: 0 (unset)
                                                         "00" // Frame type: DATA
                                                         "00" // Flags: none
    ...
    }
    {
        ...
        const std::string kData = absl::HexStringToBytes("ffffff" // Payload length: 2^24 - 1 (max uint24)
...
TEST(Http2FrameBuilderTest, SetPayloadLength)
{
    ...
    const std::string kData = absl::HexStringToBytes("00003d" // Payload length: 61
                                                     "00" // Frame type: DATA
                                                     "08" // Flags: PADDED
...
TEST(Http2FrameBuilderTest, Settings)
{
    ...
    const std::string kData = absl::HexStringToBytes("000024" // Payload length: 36
...
{
    const std::string kData = absl::HexStringToBytes("12345678" // Last Stream Id
                                                     "00000001"); // Error code
...
TEST(Http2FrameBuilderTest, WindowUpdate)
{
    ...
    const std::string kData = absl::HexStringToBytes("0001e240" // Valid Window Size Increment
...
TEST(Http2FrameBuilderTest, AltSvc)
{
    ...
    const std::string kData = absl::HexStringToBytes("0063" // Has origin.
