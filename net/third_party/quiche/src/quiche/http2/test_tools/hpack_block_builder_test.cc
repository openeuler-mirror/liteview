...
{
    {
        ...
        const std::string expected = absl::HexStringToBytes("828684410f7777772e6578616d706c652e636f6d");
...
{
    {
        ...
        b.AppendNameIndexAndLiteralValue(HpackEntryType::kIndexedLiteralHeader, 1, kCompressed, absl::string_view(kHuffmanWwwExampleCom, sizeof kHuffmanWwwExampleCom));
        EXPECT_EQ(17u, b.size());
        ...
        const std::string expected = absl::HexStringToBytes("828684418cf1e3c2e5f23a6ba0ab90f4ff");
        EXPECT_EQ(expected, b.buffer());
    }
}
