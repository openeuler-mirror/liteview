...
public:
    ...
    void AppendSetting(const Http2SettingFields& setting_fields) { settings_.push_back(setting_fields); }

    const Http2FrameHeader& GetFrameHeader() const { return frame_header_; }

    absl::optional<Http2PriorityFields> GetOptPriority() const { return opt_priority_; }
    absl::optional<Http2ErrorCode> GetOptRstStreamErrorCode() const { return opt_rst_stream_error_code_; }
    absl::optional<Http2PushPromiseFields> GetOptPushPromise() const { return opt_push_promise_; }
    ...
    absl::optional<size_t> GetOptPayloadLength() const { return opt_payload_length_; }
    absl::optional<size_t> GetOptMissingLength() const { return opt_missing_length_; }
    absl::optional<size_t> GetOptAltsvcOriginLength() const { return opt_altsvc_origin_length_; }
    absl::optional<size_t> GetOptAltsvcValueLength() const { return opt_altsvc_value_length_; }
    absl::optional<size_t> GetOptWindowUpdateIncrement() const { return opt_window_update_increment_; }
    bool GetHasFrameSizeError() const { return has_frame_size_error_; }

    void SetOptPriority(absl::optional<Http2PriorityFields> opt_priority) { opt_priority_ = opt_priority; }
    void SetOptRstStreamErrorCode(absl::optional<Http2ErrorCode> opt_rst_stream_error_code) { opt_rst_stream_error_code_ = opt_rst_stream_error_code; }
    void SetOptPushPromise(absl::optional<Http2PushPromiseFields> opt_push_promise) { opt_push_promise_ = opt_push_promise; }
    void SetOptPing(absl::optional<Http2PingFields> opt_ping) { opt_ping_ = opt_ping; }
    void SetOptGoaway(absl::optional<Http2GoAwayFields> opt_goaway) { opt_goaway_ = opt_goaway; }
    void SetOptPadLength(absl::optional<size_t> opt_pad_length) { opt_pad_length_ = opt_pad_length; }
    void SetOptPayloadLength(absl::optional<size_t> opt_payload_length) { opt_payload_length_ = opt_payload_length; }
    void SetOptMissingLength(absl::optional<size_t> opt_missing_length) { opt_missing_length_ = opt_missing_length; }
    void SetOptAltsvcOriginLength(absl::optional<size_t> opt_altsvc_origin_length) { opt_altsvc_origin_length_ = opt_altsvc_origin_length; }
    void SetOptAltsvcValueLength(absl::optional<size_t> opt_altsvc_value_length) { opt_altsvc_value_length_ = opt_altsvc_value_length; }
    void SetOptWindowUpdateIncrement(absl::optional<size_t> opt_window_update_increment) { opt_window_update_increment_ = opt_window_update_increment; }
    void SetOptPriorityUpdate(absl::optional<Http2PriorityUpdateFields> priority_update) { opt_priority_update_ = priority_update; }

    void SetHasFrameSizeError(bool has_frame_size_error) { has_frame_size_error_ = has_frame_size_error; }
...
private:
    ...
    ::testing::AssertionResult AppendString(absl::string_view source, std::string* target, absl::optional<size_t>* opt_length);
