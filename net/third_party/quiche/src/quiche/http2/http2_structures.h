...
QUICHE_EXPORT_PRIVATE bool operator==(const Http2FrameHeader& a, const Http2FrameHeader& b);
QUICHE_EXPORT_PRIVATE inline bool operator!=(const Http2FrameHeader& a, const Http2FrameHeader& b) { return !(a == b); }
QUICHE_EXPORT_PRIVATE std::ostream& operator<<(std::ostream& out, const Http2FrameHeader& v);
...
QUICHE_EXPORT_PRIVATE bool operator==(const Http2PriorityFields& a, const Http2PriorityFields& b);
QUICHE_EXPORT_PRIVATE inline bool operator!=(const Http2PriorityFields& a, const Http2PriorityFields& b) { return !(a == b); }
QUICHE_EXPORT_PRIVATE std::ostream& operator<<(std::ostream& out, const Http2PriorityFields& v);

// Http2RstStreamFields:

struct QUICHE_EXPORT_PRIVATE Http2RstStreamFields {
    static constexpr size_t EncodedSize() { return 4; }
    bool IsSupportedErrorCode() const { return IsSupportedHttp2ErrorCode(error_code); }

    Http2ErrorCode error_code;
};

QUICHE_EXPORT_PRIVATE bool operator==(const Http2RstStreamFields& a, const Http2RstStreamFields& b);
QUICHE_EXPORT_PRIVATE inline bool operator!=(const Http2RstStreamFields& a, const Http2RstStreamFields& b) { return !(a == b); }
QUICHE_EXPORT_PRIVATE std::ostream& operator<<(std::ostream& out, const Http2RstStreamFields& v);
...
struct QUICHE_EXPORT_PRIVATE Http2SettingFields {
    ...
    bool IsSupportedParameter() const { return IsSupportedHttp2SettingsParameter(parameter); }

    Http2SettingsParameter parameter;
    uint32_t value;
};

QUICHE_EXPORT_PRIVATE bool operator==(const Http2SettingFields& a, const Http2SettingFields& b);
QUICHE_EXPORT_PRIVATE inline bool operator!=(const Http2SettingFields& a, const Http2SettingFields& b) { return !(a == b); }
QUICHE_EXPORT_PRIVATE std::ostream& operator<<(std::ostream& out, const Http2SettingFields& v);
...
QUICHE_EXPORT_PRIVATE bool operator==(const Http2PushPromiseFields& a, const Http2PushPromiseFields& b);
QUICHE_EXPORT_PRIVATE inline bool operator!=(const Http2PushPromiseFields& a, const Http2PushPromiseFields& b) { return !(a == b); }
QUICHE_EXPORT_PRIVATE std::ostream& operator<<(std::ostream& out, const Http2PushPromiseFields& v);
...
QUICHE_EXPORT_PRIVATE bool operator==(const Http2PingFields& a, const Http2PingFields& b);
QUICHE_EXPORT_PRIVATE inline bool operator!=(const Http2PingFields& a, const Http2PingFields& b) { return !(a == b); }
QUICHE_EXPORT_PRIVATE std::ostream& operator<<(std::ostream& out, const Http2PingFields& v);
...
QUICHE_EXPORT_PRIVATE bool operator==(const Http2GoAwayFields& a, const Http2GoAwayFields& b);
QUICHE_EXPORT_PRIVATE inline bool operator!=(const Http2GoAwayFields& a, const Http2GoAwayFields& b) { return !(a == b); }
QUICHE_EXPORT_PRIVATE std::ostream& operator<<(std::ostream& out, const Http2GoAwayFields& v);
...
QUICHE_EXPORT_PRIVATE bool operator==(const Http2WindowUpdateFields& a, const Http2WindowUpdateFields& b);
QUICHE_EXPORT_PRIVATE inline bool operator!=(const Http2WindowUpdateFields& a, const Http2WindowUpdateFields& b) { return !(a == b); }
QUICHE_EXPORT_PRIVATE std::ostream& operator<<(std::ostream& out, const Http2WindowUpdateFields& v);
...
QUICHE_EXPORT_PRIVATE bool operator==(const Http2AltSvcFields& a, const Http2AltSvcFields& b);
QUICHE_EXPORT_PRIVATE inline bool operator!=(const Http2AltSvcFields& a, const Http2AltSvcFields& b) { return !(a == b); }
QUICHE_EXPORT_PRIVATE std::ostream& operator<<(std::ostream& out, const Http2AltSvcFields& v);
...
QUICHE_EXPORT_PRIVATE bool operator==(const Http2PriorityUpdateFields& a, const Http2PriorityUpdateFields& b);
QUICHE_EXPORT_PRIVATE inline bool operator!=(const Http2PriorityUpdateFields& a, const Http2PriorityUpdateFields& b) { return !(a == b); }
QUICHE_EXPORT_PRIVATE std::ostream& operator<<(std::ostream& out, const Http2PriorityUpdateFields& v);
