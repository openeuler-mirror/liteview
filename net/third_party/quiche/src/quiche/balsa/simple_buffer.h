...
public:
    ...
    int WriteString(absl::string_view piece) { return Write(piece.data(), piece.size()); }
    ...
    absl::string_view GetReadableRegion() const { return absl::string_view(storage_ + read_idx_, write_idx_ - read_idx_); }
