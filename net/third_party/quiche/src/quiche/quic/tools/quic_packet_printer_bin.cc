...
// OnUnauthenticatedHeader: { connection_id: 13845207862000976235, connection_id_length:8, packet_number_length:1, multipath_flag: 0, reset_flag: 0, version_flag: 0, path_id: ,
// packet_number: 4 } OnDecryptedPacket OnPacketHeader OnAckFrame:  largest_observed: 1 ack_delay_time: 3000 missing_packets: [  ] is_truncated: 0 received_packets: [ 1 at 466016 ]
// OnStopWaitingFrame
...
public:
    ...
    void OnError(QuicFramer* framer) override { std::cerr << "OnError: " << QuicErrorCodeToString(framer->error()) << " detail: " << framer->detailed_error() << "\n"; }
    ...
    void OnAuthenticatedIetfStatelessResetPacket(const QuicIetfStatelessResetPacket& /*packet*/) override { std::cerr << "OnAuthenticatedIetfStatelessResetPacket\n"; }
