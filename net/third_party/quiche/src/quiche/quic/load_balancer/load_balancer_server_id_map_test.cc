...
public:
    const LoadBalancerServerId valid_server_id_ = *LoadBalancerServerId::Create(kServerId);
    const LoadBalancerServerId invalid_server_id_ = *LoadBalancerServerId::Create(absl::Span<const uint8_t>(kServerId, 3));
};
