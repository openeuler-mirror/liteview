...
public:
    explicit MasqueServerSession(MasqueMode masque_mode, const QuicConfig& config, const ParsedQuicVersionVector& supported_versions, QuicConnection* connection,
    ...
    std::unique_ptr<QuicBackendResponse> HandleMasqueRequest(const spdy::Http2HeaderBlock& request_headers, QuicSimpleServerBackend::RequestHandler* request_handler) override;
...
private:
    ...
    public:
        ...
        explicit ConnectUdpServerState(QuicSpdyStream* stream, const QuicSocketAddress& target_server_address, QuicUdpSocketFd fd, MasqueServerSession* masque_session);
        ...
        const QuicSocketAddress& target_server_address() const { return target_server_address_; }
    ...
    HttpDatagramSupport LocalHttpDatagramSupport() override { return HttpDatagramSupport::kDraft09; }
