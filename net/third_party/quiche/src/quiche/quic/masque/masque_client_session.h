...
private:
    ...
    public:
        ...
        explicit ConnectUdpClientState(QuicSpdyClientStream* stream, EncapsulatedClientSession* encapsulated_client_session, MasqueClientSession* masque_session,
        ...
        EncapsulatedClientSession* encapsulated_client_session() const { return encapsulated_client_session_; }
    ...
    const ConnectUdpClientState* GetOrCreateConnectUdpClientState(const QuicSocketAddress& target_server_address, EncapsulatedClientSession* encapsulated_client_session);
