...
public:
    ...
    std::unique_ptr<QuicAlarmFactory> CreateAlarmFactory() override { return std::make_unique<AlarmFactory>(this); }
...
// it.
class QUICHE_EXPORT_PRIVATE LibeventQuicEventLoopWithOwnership : public LibeventLoop, public LibeventQuicEventLoop {
public:
...
class QUICHE_EXPORT_PRIVATE QuicLibeventEventLoopFactory : public QuicEventLoopFactory {
public:
