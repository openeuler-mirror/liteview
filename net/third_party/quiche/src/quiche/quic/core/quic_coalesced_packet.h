...
public:
    ...
    bool MaybeCoalescePacket(const SerializedPacket& packet, const QuicSocketAddress& self_address, const QuicSocketAddress& peer_address, quiche::QuicheBufferAllocator* allocator,
    ...
    const SerializedPacket* initial_packet() const { return initial_packet_.get(); }
