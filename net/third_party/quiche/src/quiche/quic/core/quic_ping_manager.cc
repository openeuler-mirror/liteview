...
public:
    explicit AlarmDelegate(QuicPingManager* manager, QuicConnectionContext* context)
...
QuicPingManager::QuicPingManager(Perspective perspective, Delegate* delegate, QuicConnectionArena* arena, QuicAlarmFactory* alarm_factory, QuicConnectionContext* context)
