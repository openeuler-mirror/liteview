...
MATCHER_P(HasFlagSet, value, "Checks a flag in a bit mask") { return (arg & value) != 0; }
...
public:
    MOCK_METHOD(void, OnSocketEvent, (QuicEventLoop* /*event_loop*/, QuicUdpSocketFd /*fd*/, QuicSocketEventMask /*events*/), (override));
};
...
void SetNonBlocking(int fd) { QUICHE_CHECK(::fcntl(fd, F_SETFL, ::fcntl(fd, F_GETFL) | O_NONBLOCK) == 0) << "Failed to mark FD non-blocking, errno: " << errno; }
