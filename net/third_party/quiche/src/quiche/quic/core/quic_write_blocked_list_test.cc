...
TEST_F(QuicWriteBlockedListTest, PriorityOrder)
{
    ...
    */
    ...
    write_blocked_list_.RegisterStream(40, false, spdy::SpdyStreamPrecedence(kV3LowestPriority));
    write_blocked_list_.RegisterStream(23, false, spdy::SpdyStreamPrecedence(kV3HighestPriority));
    write_blocked_list_.RegisterStream(17, false, spdy::SpdyStreamPrecedence(kV3HighestPriority));
    write_blocked_list_.RegisterStream(1, true, spdy::SpdyStreamPrecedence(kV3HighestPriority));
    write_blocked_list_.RegisterStream(3, true, spdy::SpdyStreamPrecedence(kV3HighestPriority));
...
{
    write_blocked_list_.RegisterStream(5, false, spdy::SpdyStreamPrecedence(kV3HighestPriority));
    write_blocked_list_.RegisterStream(3, true, spdy::SpdyStreamPrecedence(kV3HighestPriority));
...
TEST_F(QuicWriteBlockedListTest, NoDuplicateEntries)
{
    ...
    write_blocked_list_.RegisterStream(kBlockedId, false, spdy::SpdyStreamPrecedence(kV3HighestPriority));
...
TEST_F(QuicWriteBlockedListTest, BatchingWrites)
{
    ...
    write_blocked_list_.RegisterStream(id1, false, spdy::SpdyStreamPrecedence(kV3LowestPriority));
    write_blocked_list_.RegisterStream(id2, false, spdy::SpdyStreamPrecedence(kV3LowestPriority));
    write_blocked_list_.RegisterStream(id3, false, spdy::SpdyStreamPrecedence(kV3HighestPriority));
...
TEST_F(QuicWriteBlockedListTest, Ceding)
{
    /*
         ...
         7
    */
    write_blocked_list_.RegisterStream(15, false, spdy::SpdyStreamPrecedence(kV3HighestPriority));
    write_blocked_list_.RegisterStream(16, false, spdy::SpdyStreamPrecedence(kV3HighestPriority));
