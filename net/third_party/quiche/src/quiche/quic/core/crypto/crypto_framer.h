...
public:
    ...
    void set_visitor(CryptoFramerVisitorInterface* visitor) { visitor_ = visitor; }
    ...
    void set_process_truncated_messages(bool process_truncated_messages) { process_truncated_messages_ = process_truncated_messages; }
