...
bool DefaultClientProofSource::AddCertAndKey(std::vector<std::string> server_hostnames, quiche::QuicheReferenceCountedPointer<Chain> chain, CertificatePrivateKey private_key)
{
...
const ClientProofSource::CertAndKey* DefaultClientProofSource::GetCertAndKey(absl::string_view hostname) const
{
...
const ClientProofSource::CertAndKey* DefaultClientProofSource::LookupExact(absl::string_view map_key) const
{
