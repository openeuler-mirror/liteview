...
public:
    ...
    void OnHandshakeMessage(const CryptoHandshakeMessage& message) override { out_ = std::make_unique<CryptoHandshakeMessage>(message); }
...
bool CryptoFramer::ProcessInput(absl::string_view input, EncryptionLevel /*level*/) { return ProcessInput(input); }
