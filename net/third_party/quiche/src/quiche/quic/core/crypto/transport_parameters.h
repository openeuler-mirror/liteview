...
struct QUIC_EXPORT_PRIVATE TransportParameters {
    ...
    public:
        ...
        friend QUIC_EXPORT_PRIVATE std::ostream& operator<<(std::ostream& os, const IntegerParameter& param);
    ...
    struct QUIC_EXPORT_PRIVATE PreferredAddress {
        ...
        friend QUIC_EXPORT_PRIVATE std::ostream& operator<<(std::ostream& os, const TransportParameters& params);
    };
    ...
    struct QUIC_EXPORT_PRIVATE LegacyVersionInformation {
        ...
        // Allows easily logging.
        std::string ToString() const;
        friend QUIC_EXPORT_PRIVATE std::ostream& operator<<(std::ostream& os, const LegacyVersionInformation& legacy_version_information);
    };
    ...
    struct QUIC_EXPORT_PRIVATE VersionInformation {
        ...
        // Allows easily logging.
        std::string ToString() const;
        friend QUIC_EXPORT_PRIVATE std::ostream& operator<<(std::ostream& os, const VersionInformation& version_information);
    };
...
QUIC_EXPORT_PRIVATE bool SerializeTransportParameters(const TransportParameters& in, std::vector<uint8_t>* out);
...
// ticket.
QUIC_EXPORT_PRIVATE bool SerializeTransportParametersForTicket(const TransportParameters& in, const std::vector<uint8_t>& application_data, std::vector<uint8_t>* out);
