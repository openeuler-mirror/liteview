...
QUIC_EXPORT_PRIVATE bssl::UniquePtr<EVP_PKEY> MakeKeyPairForSelfSignedCertificate();
...
QUIC_EXPORT_PRIVATE std::string CreateSelfSignedCertificate(EVP_PKEY& key, const CertificateOptions& options);
