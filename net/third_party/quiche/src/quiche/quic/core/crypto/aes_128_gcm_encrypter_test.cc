...
const TestVector test_group_0[] = { { "11754cd72aec309bf52f7687212e8957", "3c819d9a9bed087615030b65", "", "", "", "250327c674aaf477aef2675748cf6971" },
    { "ca47248ac0b6f8372a97ac43508308ed", "ffd2b598feabc9019262d2be", "", "", "", "60d20404af527d248d893ae495707d1a" }, { nullptr, nullptr, nullptr, nullptr, nullptr, nullptr } };
...
const TestVector test_group_2[] = { { "7fddb57453c241d03efbed3ac44e371c", "ee283a3fc75575e33efd4887", "d5de42b461646c255c87bd2962d3b9a2", "", "2ccda4a5415cb91e135c2a0f78c9b2fd",
...
const TestVector test_group_5[]
    = { { "fe9bb47deb3a61e423c2231841cfd1fb", "4d328eb776f500a2f7fb47aa", "f1cc3818e421876bb6b8bbd6c9", "", "b88c5c1977b35b517b0aeae967", "43fd4727fe5cdb4b5b42818dea7ef8c9" },
          { "6703df3701a7f54911ca72e24dca046a", "12823ab601c350ea4bc2488c", "793cd125b0b84a043e3ac67717", "", "b2051c80014f42f08735a7b0cd", "38e6bcd29962e5f2c13626b85a877101" },
          { nullptr, nullptr, nullptr, nullptr, nullptr, nullptr } };
...
TEST_F(Aes128GcmEncrypterTest, EncryptPacket)
{
    ...
    std::string aad = absl::HexStringToBytes("875d49f64a70c9cbe713278f44ff000005");
    std::string pt = absl::HexStringToBytes("aa0003a250bd000000000001");
    std::string ct = absl::HexStringToBytes("7dd4708b989ee7d38a013e3656e9b37beefd05808fe1ab41e3b4f2c0");
...
TEST_F(Aes128GcmEncrypterTest, GenerateHeaderProtectionMask)
{
    ...
    std::string sample = absl::HexStringToBytes("d1d7998068517adb769b48b924a32c47");
    ASSERT_TRUE(encrypter.SetHeaderProtectionKey(key));
    std::string mask = encrypter.GenerateHeaderProtectionMask(sample);
    std::string expected_mask = absl::HexStringToBytes("b132c37d6164da4ea4dc9b763aceec27");
