...
{
    absl::optional<QuicServerId> server_id = QuicServerId::ParseFromHostPortString("host.test:500");
    ...
    EXPECT_THAT(server_id, Optional(Property(&QuicServerId::privacy_mode_enabled, false)));
}

TEST_F(QuicServerIdTest, CannotParseMissingPort)
{
    absl::optional<QuicServerId> server_id = QuicServerId::ParseFromHostPortString("host.test");
...
{
    absl::optional<QuicServerId> server_id = QuicServerId::ParseFromHostPortString(":500");
...
{
    absl::optional<QuicServerId> server_id = QuicServerId::ParseFromHostPortString("userinfo@host.test:500");
...
{
    absl::optional<QuicServerId> server_id = QuicServerId::ParseFromHostPortString("[::1]:400");
