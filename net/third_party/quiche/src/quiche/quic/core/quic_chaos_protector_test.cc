...
public:
    ...
    void ReCreateChaosProtector() { chaos_protector_ = std::make_unique<QuicChaosProtector>(crypto_frame_, num_padding_bytes_, packet_size_, SetupHeaderAndFramers(), &random_); }
...
protected:
    ...
    {
        absl::optional<size_t> length = chaos_protector_->BuildDataPacket(header_, packet_buffer_.get());
