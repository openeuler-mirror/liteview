...
public:
    ...
    QuicPingManager(Perspective perspective, Delegate* delegate, QuicConnectionArena* arena, QuicAlarmFactory* alarm_factory, QuicConnectionContext* context);
    ...
    void reset_consecutive_retransmittable_on_wire_count() { consecutive_retransmittable_on_wire_count_ = 0; }
