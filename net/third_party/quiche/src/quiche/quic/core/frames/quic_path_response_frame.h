...
struct QUIC_EXPORT_PRIVATE QuicPathResponseFrame : public QuicInlinedFrame<QuicPathResponseFrame> {
    ...
    friend QUIC_EXPORT_PRIVATE std::ostream& operator<<(std::ostream& os, const QuicPathResponseFrame& frame);
