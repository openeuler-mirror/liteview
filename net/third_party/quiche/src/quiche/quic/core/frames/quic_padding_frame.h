...
struct QUIC_EXPORT_PRIVATE QuicPaddingFrame : public QuicInlinedFrame<QuicPaddingFrame> {
    QuicPaddingFrame()
    ...
    friend QUIC_EXPORT_PRIVATE std::ostream& operator<<(std::ostream& os, const QuicPaddingFrame& padding_frame);
