...
struct QUIC_EXPORT_PRIVATE QuicPathChallengeFrame : public QuicInlinedFrame<QuicPathChallengeFrame> {
    ...
    friend QUIC_EXPORT_PRIVATE std::ostream& operator<<(std::ostream& os, const QuicPathChallengeFrame& frame);
