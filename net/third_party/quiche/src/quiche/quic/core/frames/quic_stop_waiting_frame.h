...
struct QUIC_EXPORT_PRIVATE QuicStopWaitingFrame : public QuicInlinedFrame<QuicStopWaitingFrame> {
    QuicStopWaitingFrame();

    friend QUIC_EXPORT_PRIVATE std::ostream& operator<<(std::ostream& os, const QuicStopWaitingFrame& s);
