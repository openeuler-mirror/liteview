...
public:
    ...
    friend QUIC_EXPORT_PRIVATE std::ostream& operator<<(std::ostream& os, const PacketNumberQueue& q);
...
struct QUIC_EXPORT_PRIVATE QuicAckFrame {
    ...
    friend QUIC_EXPORT_PRIVATE std::ostream& operator<<(std::ostream& os, const QuicAckFrame& ack_frame);
...
inline QUIC_EXPORT_PRIVATE QuicPacketNumber LargestAcked(const QuicAckFrame& frame)
{
...
QUIC_EXPORT_PRIVATE bool IsAwaitingPacket(const QuicAckFrame& ack_frame, QuicPacketNumber packet_number, QuicPacketNumber peer_least_packet_awaiting_ack);
