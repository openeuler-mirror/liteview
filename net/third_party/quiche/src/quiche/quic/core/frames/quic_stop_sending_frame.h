...
struct QUIC_EXPORT_PRIVATE QuicStopSendingFrame : public QuicInlinedFrame<QuicStopSendingFrame> {
    ...
    friend QUIC_EXPORT_PRIVATE std::ostream& operator<<(std::ostream& os, const QuicStopSendingFrame& frame);
    ...
    QuicResetStreamError error() const { return QuicResetStreamError(error_code, ietf_error_code); }
};
