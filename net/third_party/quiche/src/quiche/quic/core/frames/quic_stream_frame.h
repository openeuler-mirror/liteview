...
struct QUIC_EXPORT_PRIVATE QuicStreamFrame : public QuicInlinedFrame<QuicStreamFrame> {
    QuicStreamFrame();
    ...
    friend QUIC_EXPORT_PRIVATE std::ostream& operator<<(std::ostream& os, const QuicStreamFrame& s);
