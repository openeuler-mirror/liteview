...
struct QUIC_EXPORT_PRIVATE QuicFrame {
    ...
    QUIC_EXPORT_PRIVATE friend std::ostream& operator<<(std::ostream& os, const QuicFrame& frame);
...
QUIC_EXPORT_PRIVATE void RemoveFramesForStream(QuicFrames* frames, QuicStreamId stream_id);
...
QUIC_EXPORT_PRIVATE QuicControlFrameId GetControlFrameId(const QuicFrame& frame);

// Sets control_frame_id of |frame| to |control_frame_id|.
QUIC_EXPORT_PRIVATE void SetControlFrameId(QuicControlFrameId control_frame_id, QuicFrame* frame);

// Returns a copy of |frame|.
QUIC_EXPORT_PRIVATE QuicFrame CopyRetransmittableControlFrame(const QuicFrame& frame);

// Returns a copy of |frame|.
QUIC_EXPORT_PRIVATE QuicFrame CopyQuicFrame(quiche::QuicheBufferAllocator* allocator, const QuicFrame& frame);

// Returns a copy of |frames|.
QUIC_EXPORT_PRIVATE QuicFrames CopyQuicFrames(quiche::QuicheBufferAllocator* allocator, const QuicFrames& frames);
