...
struct QUIC_EXPORT_PRIVATE QuicStreamsBlockedFrame : public QuicInlinedFrame<QuicStreamsBlockedFrame> {
    ...
    friend QUIC_EXPORT_PRIVATE std::ostream& operator<<(std::ostream& os, const QuicStreamsBlockedFrame& frame);
