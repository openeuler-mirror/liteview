...
public:
    ...
    static absl::optional<QuicServerId> ParseFromHostPortString(absl::string_view host_port_string);
    ...
    {
        return H::combine(std::move(h), server_id.host(), server_id.port(), server_id.privacy_mode_enabled());
    }
