...
public:
    ...
    QuicStreamOffset NumBytesConsumed() { return QuicStreamPeer::sequencer(receive_control_stream_)->NumBytesConsumed(); }
...
{
    std::string push_promise_frame = absl::HexStringToBytes("05" // PUSH_PROMISE
                                                            "01" // length
                                                            "00"); // push ID
...
{
    std::string cancel_push_frame = absl::HexStringToBytes("03" // type CANCEL_PUSH
                                                           "01" // payload length
                                                           "01"); // push ID
...
{
    std::string accept_ch_frame = absl::HexStringToBytes("4089" // type (ACCEPT_CH)
                                                         "00"); // length
