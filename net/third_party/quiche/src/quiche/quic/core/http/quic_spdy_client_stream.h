...
public:
    ...
    void OnPromiseHeaderList(QuicStreamId promised_id, size_t frame_len, const QuicHeaderList& header_list) override;
    ...
    size_t SendRequest(spdy::Http2HeaderBlock headers, absl::string_view body, bool fin);
    ...
    const spdy::Http2HeaderBlock& preliminary_headers() { return preliminary_headers_; }
...
protected:
    ...
    // on error.
    virtual bool CopyAndValidateHeaders(const QuicHeaderList& header_list, int64_t& content_length, spdy::Http2HeaderBlock& headers);
