...
QUIC_EXPORT std::string H3SettingsToString(Http3AndQpackSettingsIdentifiers identifier);
...
ABSL_CONST_INIT QUIC_EXPORT_PRIVATE extern const absl::string_view kUserAgentHeaderName;
