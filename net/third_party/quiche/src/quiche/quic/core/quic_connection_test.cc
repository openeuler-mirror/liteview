...
QuicStreamId GetNthClientInitiatedStreamId(int n, QuicTransportVersion version) { return QuicUtils::GetFirstBidirectionalStreamId(version, Perspective::IS_CLIENT) + n * 2; }
...
public:
    NullEncrypterWithConfidentialityLimit(Perspective perspective, QuicPacketCount confidentiality_limit)
        : NullEncrypter(perspective)
        , confidentiality_limit_(confidentiality_limit)
    {
    }

    QuicPacketCount GetConfidentialityLimit() const override { return confidentiality_limit_; }
...
public:
    ...
    QuicPacketCount GetIntegrityLimit() const override { return integrity_limit_; }
...
public:
    TestConnection(QuicConnectionId connection_id, QuicSocketAddress initial_self_address, QuicSocketAddress initial_peer_address, TestConnectionHelper* helper,
        TestAlarmFactory* alarm_factory, TestPacketWriter* writer, Perspective perspective, ParsedQuicVersion version, ConnectionIdGeneratorInterface& generator)
        ...
        , notifier_(nullptr)
    {
        ...
        SetEncrypter(ENCRYPTION_FORWARD_SECURE, std::make_unique<NullEncrypter>(perspective));
    ...
    void SetSendAlgorithm(SendAlgorithmInterface* send_algorithm) { QuicConnectionPeer::SetSendAlgorithm(this, send_algorithm); }

    void SetLossAlgorithm(LossDetectionInterface* loss_algorithm) { QuicConnectionPeer::SetLossAlgorithm(this, loss_algorithm); }

    void SendPacket(
        EncryptionLevel /*level*/, uint64_t packet_number, std::unique_ptr<QuicPacket> packet, HasRetransmittableData retransmittable, bool has_ack, bool has_pending_frames)
    {
        ScopedPacketFlusher flusher(this);
        char buffer[kMaxOutgoingPacketSize];
        size_t encrypted_length = QuicConnectionPeer::GetFramer(this)->EncryptPayload(ENCRYPTION_INITIAL, QuicPacketNumber(packet_number), *packet, buffer, kMaxOutgoingPacketSize);
    ...
    QuicConsumedData SaveAndSendStreamData(QuicStreamId id, absl::string_view data, QuicStreamOffset offset, StreamSendingState state, TransmissionType transmission_type)
    {
        ScopedPacketFlusher flusher(this);
    ...
    QuicConsumedData SendApplicationDataAtLevel(EncryptionLevel encryption_level, QuicStreamId id, absl::string_view data, QuicStreamOffset offset, StreamSendingState state)
    {
        ScopedPacketFlusher flusher(this);
    ...
    QuicConsumedData SendStreamData3() { return SendStreamDataWithString(GetNthClientInitiatedStreamId(1, transport_version()), "food", 0, NO_FIN); }

    QuicConsumedData SendStreamData5() { return SendStreamDataWithString(GetNthClientInitiatedStreamId(2, transport_version()), "food2", 0, NO_FIN); }
    ...
    QuicConsumedData SendCryptoDataWithString(absl::string_view data, QuicStreamOffset offset) { return SendCryptoDataWithString(data, offset, ENCRYPTION_INITIAL); }
    ...
    void set_version(ParsedQuicVersion version) { QuicConnectionPeer::GetFramer(this)->set_version(version); }
    ...
    void set_perspective(Perspective perspective)
    {
        ...
        for (EncryptionLevel level : { ENCRYPTION_ZERO_RTT, ENCRYPTION_HANDSHAKE, ENCRYPTION_FORWARD_SECURE }) {
            if (QuicConnectionPeer::GetFramer(this)->HasEncrypterOfEncryptionLevel(level)) {
                SetEncrypter(level, std::make_unique<NullEncrypter>(perspective));
            }
            if (QuicConnectionPeer::GetFramer(this)->HasDecrypterOfEncryptionLevel(level)) {
    ...
    TestAlarmFactory::TestAlarm* GetAckAlarm() { return reinterpret_cast<TestAlarmFactory::TestAlarm*>(QuicConnectionPeer::GetAckAlarm(this)); }

    TestAlarmFactory::TestAlarm* GetPingAlarm() { return reinterpret_cast<TestAlarmFactory::TestAlarm*>(QuicConnectionPeer::GetPingAlarm(this)); }

    TestAlarmFactory::TestAlarm* GetRetransmissionAlarm() { return reinterpret_cast<TestAlarmFactory::TestAlarm*>(QuicConnectionPeer::GetRetransmissionAlarm(this)); }

    TestAlarmFactory::TestAlarm* GetSendAlarm() { return reinterpret_cast<TestAlarmFactory::TestAlarm*>(QuicConnectionPeer::GetSendAlarm(this)); }

    TestAlarmFactory::TestAlarm* GetTimeoutAlarm() { return reinterpret_cast<TestAlarmFactory::TestAlarm*>(QuicConnectionPeer::GetIdleNetworkDetectorAlarm(this)); }

    TestAlarmFactory::TestAlarm* GetMtuDiscoveryAlarm() { return reinterpret_cast<TestAlarmFactory::TestAlarm*>(QuicConnectionPeer::GetMtuDiscoveryAlarm(this)); }

    TestAlarmFactory::TestAlarm* GetProcessUndecryptablePacketsAlarm()
    {
        return reinterpret_cast<TestAlarmFactory::TestAlarm*>(QuicConnectionPeer::GetProcessUndecryptablePacketsAlarm(this));
    }

    TestAlarmFactory::TestAlarm* GetDiscardPreviousOneRttKeysAlarm()
    {
        return reinterpret_cast<TestAlarmFactory::TestAlarm*>(QuicConnectionPeer::GetDiscardPreviousOneRttKeysAlarm(this));
    }

    TestAlarmFactory::TestAlarm* GetDiscardZeroRttDecryptionKeysAlarm()
    {
        return reinterpret_cast<TestAlarmFactory::TestAlarm*>(QuicConnectionPeer::GetDiscardZeroRttDecryptionKeysAlarm(this));
    }

    TestAlarmFactory::TestAlarm* GetBlackholeDetectorAlarm() { return reinterpret_cast<TestAlarmFactory::TestAlarm*>(QuicConnectionPeer::GetBlackholeDetectorAlarm(this)); }
    ...
    TestAlarmFactory::TestAlarm* GetMultiPortProbingAlarm() { return reinterpret_cast<TestAlarmFactory::TestAlarm*>(QuicConnectionPeer::GetMultiPortProbingAlarm(this)); }
    ...
    bool PathDegradingDetectionInProgress() { return QuicConnectionPeer::GetPathDegradingDeadline(this).IsInitialized(); }

    bool BlackholeDetectionInProgress() { return QuicConnectionPeer::GetBlackholeDetectionDeadline(this).IsInitialized(); }

    bool PathMtuReductionDetectionInProgress() { return QuicConnectionPeer::GetPathMtuReductionDetectionDeadline(this).IsInitialized(); }

    QuicByteCount GetBytesInFlight() { return QuicConnectionPeer::GetSentPacketManager(this)->GetBytesInFlight(); }

    void set_notifier(SimpleSessionNotifier* notifier) { notifier_ = notifier; }

    void ReturnEffectivePeerAddressForNextPacket(const QuicSocketAddress& addr) { next_effective_peer_addr_ = std::make_unique<QuicSocketAddress>(addr); }
    ...
    QuicSocketAddress self_address_on_default_path_while_sending_packet() { return self_address_on_default_path_while_sending_packet_; }
...
private:
    TestPacketWriter* writer() { return static_cast<TestPacketWriter*>(QuicConnection::writer()); }
...
struct TestParams {
    TestParams(ParsedQuicVersion version, AckResponse ack_response, bool no_stop_waiting)
        : version(version)
...
{
    return absl::StrCat(
        ParsedQuicVersionToString(p.version), "_", (p.ack_response == AckResponse::kDefer ? "defer" : "immediate"), "_", (p.no_stop_waiting ? "No" : ""), "StopWaiting");
}
...
std::vector<TestParams> GetTestParams()
{
    ...
    for (size_t i = 0; i < all_supported_versions.size(); ++i) {
        for (AckResponse ack_response : { AckResponse::kDefer, AckResponse::kImmediate }) {
            params.push_back(TestParams(all_supported_versions[i], ack_response, true));
            if (!all_supported_versions[i].HasIetfInvariantHeader()) {
                params.push_back(TestParams(all_supported_versions[i], ack_response, false));
            }
        }
    }
    return params;
...
protected:
    QuicConnectionTest()
        ...
        , connection_(connection_id_, kSelfAddress, kPeerAddress, helper_.get(), alarm_factory_.get(), writer_.get(), Perspective::IS_CLIENT, version(), connection_id_generator_)
        ...
        , connection_close_frame_count_(0)
    {
        ...
        for (EncryptionLevel level : { ENCRYPTION_ZERO_RTT, ENCRYPTION_FORWARD_SECURE }) {
            peer_creator_.SetEncrypter(level, std::make_unique<NullEncrypter>(peer_framer_.perspective()));
        }
        ...
        if (version().HasIetfInvariantHeader()) {
            ...
            QuicConnectionPeer::SetNoStopWaitingFrames(&connection_, GetParam().no_stop_waiting);
        }
        ...
        if (connection_.version().KnowsWhichDecrypterToUse()) {
            connection_.InstallDecrypter(ENCRYPTION_FORWARD_SECURE, std::make_unique<NullDecrypter>(Perspective::IS_CLIENT));
        }
    ...
    void ProcessFramePacket(QuicFrame frame) { ProcessFramePacketWithAddresses(frame, kSelfAddress, kPeerAddress, ENCRYPTION_FORWARD_SECURE); }
    ...
    void ForceProcessFramePacket(QuicFrame frame)
    {
        ...
        const size_t encrypted_length = peer_framer_.EncryptInPlace(
            ENCRYPTION_INITIAL, header.packet_number, GetStartOfEncryptedData(peer_framer_.version().transport_version, header), length, kMaxOutgoingPacketSize, encrypted_buffer);
    ...
    size_t ProcessFramesPacketAtLevel(uint64_t number, const QuicFrames& frames, EncryptionLevel level)
    {
        ...
        peer_creator_.set_encryption_level(level);
        if (QuicPacketCreatorPeer::GetEncryptionLevel(&peer_creator_) > ENCRYPTION_INITIAL) {
            peer_framer_.SetEncrypter(QuicPacketCreatorPeer::GetEncryptionLevel(&peer_creator_), std::make_unique<TaggingEncrypter>(0x01));
            // Set the corresponding decrypter.
            if (connection_.version().KnowsWhichDecrypterToUse()) {
                connection_.InstallDecrypter(QuicPacketCreatorPeer::GetEncryptionLevel(&peer_creator_), std::make_unique<StrictTaggingDecrypter>(0x01));
            } else {
                connection_.SetDecrypter(QuicPacketCreatorPeer::GetEncryptionLevel(&peer_creator_), std::make_unique<StrictTaggingDecrypter>(0x01));
            }
        }
    ...
    size_t ProcessCoalescedPacket(std::vector<PacketInfo> packets)
    {
        ...
        for (const auto& packet : packets) {
            ...
            char buffer[kMaxOutgoingPacketSize];
            size_t encrypted_length = peer_framer_.EncryptPayload(packet.level, QuicPacketNumber(packet.packet_number), *constructed_packet, buffer, kMaxOutgoingPacketSize);
        ...
        connection_.ProcessUdpPacket(kSelfAddress, kPeerAddress, QuicReceivedPacket(coalesced_buffer, coalesced_size, clock_.Now(), false));
        if (connection_.GetSendAlarm()->IsSet()) {
            connection_.GetSendAlarm()->Fire();
        }
    ...
    size_t ProcessDataPacket(uint64_t number) { return ProcessDataPacketAtLevel(number, false, ENCRYPTION_FORWARD_SECURE); }

    size_t ProcessDataPacket(QuicPacketNumber packet_number) { return ProcessDataPacketAtLevel(packet_number, false, ENCRYPTION_FORWARD_SECURE); }
    ...
    QuicByteCount SendStreamDataToPeer(QuicStreamId id, absl::string_view data, QuicStreamOffset offset, StreamSendingState state, QuicPacketNumber* last_packet)
    {
    ...
    void ProcessAckPacket(QuicAckFrame* frame) { ProcessFramePacket(QuicFrame(frame)); }

    void ProcessStopWaitingPacket(QuicStopWaitingFrame frame) { ProcessFramePacket(QuicFrame(frame)); }
    ...
    void ProcessGoAwayPacket(QuicGoAwayFrame* frame) { ProcessFramePacket(QuicFrame(frame)); }

    bool IsMissing(uint64_t number) { return IsAwaitingPacket(connection_.ack_frame(), QuicPacketNumber(number), QuicPacketNumber()); }
    ...
    {
        QuicPacketHeader header;
        if (peer_framer_.version().HasIetfInvariantHeader() && level < ENCRYPTION_FORWARD_SECURE) {
        ...
        if (peer_framer_.version().HasIetfInvariantHeader() && peer_framer_.perspective() == Perspective::IS_SERVER) {
    ...
    QuicTime::Delta DefaultRetransmissionTime() { return QuicTime::Delta::FromMilliseconds(kDefaultRetransmissionTimeMs); }

    QuicTime::Delta DefaultDelayedAckTime() { return QuicTime::Delta::FromMilliseconds(kDefaultDelayedAckTimeMs); }
    ...
    QuicAckFrame ConstructAckFrame(uint64_t largest_acked, uint64_t missing) { return ConstructAckFrame(QuicPacketNumber(largest_acked), QuicPacketNumber(missing)); }
    ...
    void ExpectNextPacketUnprocessable() { writer_->ExpectNextPacketUnprocessable(); }

    void AlwaysGetPacketTooLarge() { writer_->AlwaysGetPacketTooLarge(); }

    void SetWritePauseTimeDelta(QuicTime::Delta delta) { writer_->SetWritePauseTimeDelta(delta); }

    void CongestionBlockWrites() { EXPECT_CALL(*send_algorithm_, CanSend(_)).WillRepeatedly(testing::Return(false)); }

    void CongestionUnblockWrites() { EXPECT_CALL(*send_algorithm_, CanSend(_)).WillRepeatedly(testing::Return(true)); }
    ...
    bool IsDefaultTestConfiguration()
    {
        ...
        return p.ack_response == AckResponse::kImmediate && p.version == AllSupportedVersions()[0] && p.no_stop_waiting;
    }
    ...
    void TestClientRetryHandling(
        bool invalid_retry_tag, bool missing_original_id_in_config, bool wrong_original_id_in_config, bool missing_retry_id_in_config, bool wrong_retry_id_in_config);
...
TEST_P(QuicConnectionTest, CloseErrorCodeTestApplication)
{
    EXPECT_TRUE(connection_.connected());
    EXPECT_CALL(visitor_, OnConnectionClosed(_, _));
    connection_.CloseConnection(QUIC_HEADERS_STREAM_DATA_DECOMPRESS_FAILURE, "Should be application close", ConnectionCloseBehavior::SEND_CONNECTION_CLOSE_PACKET);
    EXPECT_FALSE(connection_.connected());
...
TEST_P(QuicConnectionTest, PeerPortChangeAtServer)
{
    ...
    EXPECT_CALL(visitor_, OnStreamFrame(_)).WillOnce(Invoke([=]() { EXPECT_EQ(kPeerAddress, connection_.peer_address()); })).WillOnce(Invoke([=]() {
        EXPECT_EQ(kNewPeerAddress, connection_.peer_address());
    }));
    QuicFrames frames;
    frames.push_back(QuicFrame(frame1_));
...
{
    set_perspective(Perspective::IS_SERVER);
    if (!connection_.validate_client_address() || GetQuicFlag(quic_enforce_strict_amplification_factor)) {
        return;
    }
    QuicPacketCreatorPeer::SetSendVersionInPacket(creator_, false);
    EXPECT_EQ(Perspective::IS_SERVER, connection_.perspective());
...
TEST_P(QuicConnectionTest, PeerIpAddressChangeAtServerWithMissingConnectionId)
{
    ...
    if (GetQuicReloadableFlag(quic_connection_uses_abstract_connection_id_generator) && !connection_.connection_id().IsEmpty()) {
...
TEST_P(QuicConnectionTest, ConnectionMigrationWithPendingPaddingBytes)
{
    ...
    if (GetQuicReloadableFlag(quic_flush_pending_frames_and_padding_bytes_on_migration)) {
        ...
        ASSERT_EQ(connection_.self_address_on_default_path_while_sending_packet().host().address_family(), IpAddressFamily::IP_UNSPEC);
    }
}
...
{
    set_perspective(Perspective::IS_SERVER);
    if (!connection_.connection_migration_use_new_cid() || GetQuicFlag(quic_enforce_strict_amplification_factor)) {
        return;
    }
    QuicPacketCreatorPeer::SetSendVersionInPacket(creator_, false);
    connection_.CreateConnectionIdManager();
    ...
    // validate path 2 and a non-probing frame.
    {
        ...
        ProcessFramesPacketWithAddresses(
            { QuicFrame(QuicPathResponseFrame(0, reverse_path_challenge_payload)), QuicFrame(&ack_frame) }, kSelfAddress, kPeerAddress3, ENCRYPTION_FORWARD_SECURE);
    }
}
...
TEST_P(QuicConnectionTest, ReceivePathProbeWithNoAddressChangeAtServer)
{
    ...
    std::unique_ptr<QuicReceivedPacket> received(ConstructReceivedPacket(QuicEncryptedPacket(probing_packet->encrypted_buffer, probing_packet->encrypted_length), clock_.Now()));
...
public:
    TestValidationResultDelegate(QuicConnection* connection, const QuicSocketAddress& expected_self_address, const QuicSocketAddress& expected_peer_address, bool* success)
...
TEST_P(QuicConnectionTest, ReceivePathProbingAtServer)
{
    ...
    if (GetParam().version.HasIetfQuicFrames()) {
        ...
        EXPECT_EQ((connection_.validate_client_address() ? 2 : 3) * bytes_sent, QuicConnectionPeer::BytesSentOnAlternativePath(&connection_));
        QuicFrames frames;
        ...
        EXPECT_EQ(connection_.validate_client_address(), QuicConnectionPeer::IsAlternativePathValidated(&connection_));
    }
...
TEST_P(QuicConnectionTest, SmallerServerMaxPacketSize)
{
    TestConnection connection(
        TestConnectionId(), kSelfAddress, kPeerAddress, helper_.get(), alarm_factory_.get(), writer_.get(), Perspective::IS_SERVER, version(), connection_id_generator_);
...
TEST_P(QuicConnectionTest, LimitMaxPacketSizeByWriterForNewConnection)
{
    ...
    writer_->set_max_packet_size(lower_max_packet_size);
    TestConnection connection(
        connection_id, kSelfAddress, kPeerAddress, helper_.get(), alarm_factory_.get(), writer_.get(), Perspective::IS_CLIENT, version(), connection_id_generator_);
...
TEST_P(QuicConnectionTest, AckReceiptCausesAckSend)
{
    ...
    EXPECT_CALL(*loss_algorithm_, DetectLosses(_, _, _, _, _, _)).WillOnce(DoAll(SetArgPointee<5>(lost_packets), Return(LossDetectionInterface::DetectionStats())));
    EXPECT_CALL(*send_algorithm_, OnCongestionEvent(true, _, _, _, _));
    ...
    EXPECT_CALL(*send_algorithm_, OnPacketSent(_, _, _, GetParam().version.HasIetfInvariantHeader() ? packet_size : packet_size - kQuicVersionSize, _))
...
TEST_P(QuicConnectionTest, AckNeedsRetransmittableFrames)
{
    ...
    // WINDOW_UPDATE.
    EXPECT_CALL(visitor_, OnAckNeedsRetransmittableFrame()).WillOnce(Invoke([this]() { connection_.SendControlFrame(QuicFrame(QuicWindowUpdateFrame(1, 0, 0))); }));
    EXPECT_CALL(*send_algorithm_, OnPacketSent(_, _, _, _, _)).Times(1);
...
TEST_P(QuicConnectionTest, LeastUnackedLower)
{
    ...
    if (!GetParam().no_stop_waiting) {
        EXPECT_CALL(*send_algorithm_, OnPacketSent(_, _, _, _, _)).Times(AtLeast(1));
        EXPECT_CALL(visitor_, OnConnectionClosed(_, ConnectionCloseSource::FROM_SELF)).Times(AtLeast(1));
    }
    ProcessStopWaitingPacket(InitStopWaitingFrame(1));
    if (!GetParam().no_stop_waiting) {
...
TEST_P(QuicConnectionTest, FramePackingAckResponse)
{
    ...
    EXPECT_CALL(visitor_, OnCanWrite())
        .WillOnce(DoAll(
            IgnoreResult(InvokeWithoutArgs(&connection_, &TestConnection::SendStreamData3)), IgnoreResult(InvokeWithoutArgs(&connection_, &TestConnection::SendStreamData5))));

    EXPECT_CALL(*send_algorithm_, OnPacketSent(_, _, _, _, _)).Times(1);

    // Process a data packet to cause the visitor's OnCanWrite to be invoked.
    EXPECT_CALL(visitor_, OnStreamFrame(_)).Times(1);
    peer_framer_.SetEncrypter(ENCRYPTION_FORWARD_SECURE, std::make_unique<TaggingEncrypter>(0x01));
    SetDecrypter(ENCRYPTION_FORWARD_SECURE, std::make_unique<StrictTaggingDecrypter>(0x01));
    ProcessDataPacket(2);
...
TEST_P(QuicConnectionTest, SendHandshakeMessages)
{
    ...
    connection_.SetEncrypter(ENCRYPTION_INITIAL, std::make_unique<TaggingEncrypter>(0x01));
...
TEST_P(QuicConnectionTest, DropRetransmitsForNullEncryptedPacketAfterForwardSecure)
{
    use_tagging_decrypter();
    connection_.SetEncrypter(ENCRYPTION_INITIAL, std::make_unique<TaggingEncrypter>(0x01));
    connection_.SendCryptoStreamData();
...
TEST_P(QuicConnectionTest, BufferNonDecryptablePackets)
{
    ...
    peer_framer_.SetEncrypter(ENCRYPTION_ZERO_RTT, std::make_unique<TaggingEncrypter>(tag));
    ...
    SetDecrypter(ENCRYPTION_ZERO_RTT, std::make_unique<StrictTaggingDecrypter>(tag));
    connection_.SetEncrypter(ENCRYPTION_ZERO_RTT, std::make_unique<TaggingEncrypter>(tag));
    connection_.SetDefaultEncryptionLevel(ENCRYPTION_ZERO_RTT);
    EXPECT_CALL(visitor_, OnStreamFrame(_)).Times(2);
...
TEST_P(QuicConnectionTest, MtuDiscoveryEnabled)
{
    ...
    EXPECT_CALL(*send_algorithm_, OnCongestionEvent(true, _, _, _, _)).Times(AnyNumber());
    ProcessAckPacket(&probe_ack);
...
TEST_P(QuicConnectionTest, PublicReset)
{
    ...
    std::unique_ptr<QuicEncryptedPacket> packet(framer_.BuildPublicResetPacket(header));
...
TEST_P(QuicConnectionTest, ClientHandlesVersionNegotiation)
{
    ...
    std::unique_ptr<QuicEncryptedPacket> encrypted(QuicFramer::BuildVersionNegotiationPacket(
        connection_id_, EmptyQuicConnectionId(), connection_.version().HasIetfInvariantHeader(), connection_.version().HasLengthPrefixedConnectionIds(), versions));
...
TEST_P(QuicConnectionTest, BadVersionNegotiation)
{
    ...
    EXPECT_CALL(visitor_, OnConnectionClosed(_, ConnectionCloseSource::FROM_SELF)).WillOnce(Invoke(this, &QuicConnectionTest::SaveConnectionCloseFrame));
    std::unique_ptr<QuicEncryptedPacket> encrypted(QuicFramer::BuildVersionNegotiationPacket(
        connection_id_, EmptyQuicConnectionId(), connection_.version().HasIetfInvariantHeader(), connection_.version().HasLengthPrefixedConnectionIds(), AllSupportedVersions()));
    std::unique_ptr<QuicReceivedPacket> received(ConstructReceivedPacket(*encrypted, QuicTime::Zero()));
    connection_.ProcessUdpPacket(kSelfAddress, kPeerAddress, *received);
    EXPECT_EQ(1, connection_close_frame_count_);
...
TEST_P(QuicConnectionTest, Pacing)
{
    TestConnection server(
        connection_id_, kPeerAddress, kSelfAddress, helper_.get(), alarm_factory_.get(), writer_.get(), Perspective::IS_SERVER, version(), connection_id_generator_);
    TestConnection client(
        connection_id_, kSelfAddress, kPeerAddress, helper_.get(), alarm_factory_.get(), writer_.get(), Perspective::IS_CLIENT, version(), connection_id_generator_);
...
{
    if (!GetQuicReloadableFlag(quic_use_ping_manager2) || !VersionHasIetfQuicFrames(connection_.version().transport_version)) {
        return;
    }
    EXPECT_CALL(visitor_, ShouldKeepConnectionAlive()).WillRepeatedly(Return(true));
    EXPECT_CALL(visitor_, OnSuccessfulVersionNegotiation(_));
...
TEST_P(QuicConnectionTest, BackOffRetransmittableOnWireTimeout)
{
    ...
    ProcessAckPacket(&frame);
    EXPECT_TRUE(connection_.GetPingAlarm()->IsSet());
    EXPECT_EQ(QuicTime::Delta::FromSeconds(kPingTimeoutSecs) - QuicTime::Delta::FromMilliseconds(5), connection_.GetPingAlarm()->deadline() - clock_.ApproximateNow());
}
...
TEST_P(QuicConnectionTest, ResetBackOffRetransmitableOnWireTimeout)
{
    ...
    clock_.AdvanceTime(QuicTime::Delta::FromMilliseconds(5));
    QuicPacketNumber ack_num = creator_->packet_number();
    frame = InitAckFrame({ { QuicPacketNumber(ack_num), QuicPacketNumber(ack_num + 1) } });
    ProcessAckPacket(&frame);
    EXPECT_TRUE(connection_.GetPingAlarm()->IsSet());
    EXPECT_EQ(initial_retransmittable_on_wire_timeout, connection_.GetPingAlarm()->deadline() - clock_.ApproximateNow());
...
TEST_P(QuicConnectionTest, GetCurrentLargestMessagePayload)
{
    ...
    connection_.SetEncrypter(ENCRYPTION_INITIAL, std::make_unique<TaggingEncrypter>(0x00));
...
{
    if (!connection_.version().SupportsMessageFrames() || !connection_.version().UsesTls()) {
        return;
    }
...
TEST_P(QuicConnectionTest, StopProcessingGQuicPacketInIetfQuicConnection)
{
    ...
    std::unique_ptr<QuicPacket> packet(ConstructDataPacket(2, !kHasStopWaiting, ENCRYPTION_INITIAL));
    char buffer[kMaxOutgoingPacketSize];
...
TEST_P(QuicConnectionTest, MultiplePacketNumberSpacesBasicReceiving)
{
    ...
    ProcessCryptoPacketAtLevel(1000, ENCRYPTION_INITIAL);
    EXPECT_TRUE(connection_.HasPendingAcks());
    peer_framer_.SetEncrypter(ENCRYPTION_FORWARD_SECURE, std::make_unique<TaggingEncrypter>(0x02));
    SetDecrypter(ENCRYPTION_FORWARD_SECURE, std::make_unique<StrictTaggingDecrypter>(0x02));
    connection_.SetEncrypter(ENCRYPTION_INITIAL, std::make_unique<TaggingEncrypter>(0x02));
...
TEST_P(QuicConnectionTest, CancelAckAlarmOnWriteBlocked)
{
    ...
    ProcessCryptoPacketAtLevel(1000, ENCRYPTION_INITIAL);
    EXPECT_TRUE(connection_.HasPendingAcks());
    peer_framer_.SetEncrypter(ENCRYPTION_ZERO_RTT, std::make_unique<TaggingEncrypter>(0x02));
    SetDecrypter(ENCRYPTION_ZERO_RTT, std::make_unique<StrictTaggingDecrypter>(0x02));
    connection_.SetEncrypter(ENCRYPTION_INITIAL, std::make_unique<TaggingEncrypter>(0x02));
    // Receives packet 1000 in application data.
...
TEST_P(QuicConnectionTest, ReplaceServerConnectionIdFromInitial) { TestReplaceConnectionIdFromInitial(); }
...
TEST_P(QuicConnectionTest, CheckConnectedBeforeFlush)
{
    ...
    std::unique_ptr<QuicConnectionCloseFrame> connection_close_frame(new QuicConnectionCloseFrame(connection_.transport_version(), kErrorCode, NO_IETF_QUIC_ERROR, "",
        /*transport_close_frame_type=*/0));
...
TEST_P(QuicConnectionTest, LegacyVersionEncapsulation)
{
    ...
    writer_->framer()->SetSupportedVersions(SupportedVersions(LegacyVersionForEncapsulation()));
    writer_->framer()->framer()->SetInitialObfuscators(connection_.connection_id());
    ...
    EXPECT_GT(connection_.GetStats().sent_legacy_version_encapsulated_packets, 0u);
    ...
    EXPECT_EQ(encapsulated_header.destination_connection_id, connection_.connection_id());
    ...
    EXPECT_EQ(1u, writer_->stream_frames().size());
    EXPECT_EQ(writer_->frame_count(), writer_->framer()->padding_frames().size() + writer_->stream_frames().size());
}
    ...
    bool invalid_retry_tag, bool missing_original_id_in_config, bool wrong_original_id_in_config, bool missing_retry_id_in_config, bool wrong_retry_id_in_config)
{
    ...
    uint8_t retry_packet_rfcv2[] = { 0xcf, 0x70, 0x9a, 0x50, 0xc4, 0x00, 0x08, 0xf0, 0x67, 0xa5, 0x50, 0x2a, 0x42, 0x62, 0xb5, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x1d, 0xc7, 0x11, 0x30,
        0xcd, 0x1e, 0xd3, 0x9d, 0x6e, 0xfc, 0xee, 0x5c, 0x85, 0x80, 0x65, 0x01 };
    // These values come from RFC9001 Appendix A.4.
    uint8_t retry_packet_rfcv1[] = { 0xff, 0x00, 0x00, 0x00, 0x01, 0x00, 0x08, 0xf0, 0x67, 0xa5, 0x50, 0x2a, 0x42, 0x62, 0xb5, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x04, 0xa2, 0x65, 0xba,
        0x2e, 0xff, 0x4d, 0x82, 0x90, 0x58, 0xfb, 0x3f, 0x0f, 0x24, 0x96, 0xba };
    uint8_t retry_packet29[] = { 0xff, 0xff, 0x00, 0x00, 0x1d, 0x00, 0x08, 0xf0, 0x67, 0xa5, 0x50, 0x2a, 0x42, 0x62, 0xb5, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0xd1, 0x69, 0x26, 0xd8,
...
TEST_P(QuicConnectionTest, DonotChangeQueuedAcks)
{
    ...
    QuicFrames frames;
    frames.push_back(
        QuicFrame(QuicStreamFrame(QuicUtils::GetFirstBidirectionalStreamId(connection_.version().transport_version, Perspective::IS_CLIENT), false, 0u, absl::string_view())));
    QuicAckFrame ack_frame = InitAckFrame(1);
    ...
    EXPECT_CALL(visitor_, OnStreamFrame(_)).WillOnce(Invoke([this]() {
        ...
        EXPECT_TRUE(QuicPacketCreatorPeer::QueuedFrames(QuicConnectionPeer::GetPacketCreator(&connection_))[0].ack_frame->packets.Contains(QuicPacketNumber(2)));
    }));
...
TEST_P(QuicConnectionTest, DonotExtendIdleTimeOnUndecryptablePackets)
{
    ...
    clock_.AdvanceTime(QuicTime::Delta::FromSeconds(1));
    const uint8_t tag = 0x07;
    peer_framer_.SetEncrypter(ENCRYPTION_FORWARD_SECURE, std::make_unique<TaggingEncrypter>(tag));
...
TEST_P(QuicConnectionTest, ProcessUndecryptablePacketsBasedOnEncryptionLevel)
{
    ...
    peer_framer_.SetEncrypter(ENCRYPTION_HANDSHAKE, std::make_unique<TaggingEncrypter>(0x01));
    peer_framer_.SetEncrypter(ENCRYPTION_FORWARD_SECURE, std::make_unique<TaggingEncrypter>(0x02));
    ...
    EXPECT_FALSE(connection_.GetProcessUndecryptablePacketsAlarm()->IsSet());
    SetDecrypter(ENCRYPTION_HANDSHAKE, std::make_unique<StrictTaggingDecrypter>(0x01));
    EXPECT_TRUE(connection_.GetProcessUndecryptablePacketsAlarm()->IsSet());
    connection_.SetEncrypter(ENCRYPTION_HANDSHAKE, std::make_unique<TaggingEncrypter>(0x01));
    connection_.SetDefaultEncryptionLevel(ENCRYPTION_HANDSHAKE);
...
TEST_P(QuicConnectionTest, ClientBundlesHandshakeDataWithHandshakeAck)
{
    ...
    connection_.SetEncrypter(ENCRYPTION_HANDSHAKE, std::make_unique<TaggingEncrypter>(0x02));
    connection_.SetDefaultEncryptionLevel(ENCRYPTION_HANDSHAKE);
    SetDecrypter(ENCRYPTION_HANDSHAKE, std::make_unique<StrictTaggingDecrypter>(0x02));
...
TEST_P(QuicConnectionTest, InflatedRttSample)
{
    ...
    frames.push_back(QuicFrame(&ack_frame));
    EXPECT_CALL(*send_algorithm_, OnCongestionEvent(_, _, _, _, _)).Times(AnyNumber());
...
TEST_P(QuicConnectionTest, SilentIdleTimeout)
{
    ...
    EXPECT_CALL(visitor_, OnConnectionClosed(_, ConnectionCloseSource::FROM_SELF));
    EXPECT_CALL(*send_algorithm_, OnPacketSent(_, _, _, _, _)).Times(0);
    if (!QuicConnectionPeer::GetBandwidthUpdateTimeout(&connection_).IsInfinite()) {
...
{
    if (!VersionHasIetfQuicFrames(connection_.version().transport_version) || !connection_.connection_migration_use_new_cid()) {
        return;
    }
    PathProbeTestInit(Perspective::IS_CLIENT);
    const QuicSocketAddress kNewSelfAddress(QuicIpAddress::Any4(), 12345);
...
TEST_P(QuicConnectionTest, ReceiveStreamFrameBeforePathChallenge)
{
    ...
    EXPECT_CALL(*send_algorithm_, OnConnectionMigration()).Times(connection_.validate_client_address() ? 0u : 1u);
    EXPECT_CALL(visitor_, OnStreamFrame(_)).WillOnce(Invoke([=](const QuicStreamFrame& frame) {
    ...
    EXPECT_CALL(*send_algorithm_, OnPacketSent(_, _, _, _, _)).Times(connection_.validate_client_address() ? 0u : 1u);
    ProcessFramesPacketWithAddresses(frames, kSelfAddress, kNewPeerAddress, ENCRYPTION_FORWARD_SECURE);
    ...
    EXPECT_EQ(1u, writer_->stream_frames().size());
    EXPECT_EQ(1u, writer_->path_response_frames().size());
    EXPECT_EQ(connection_.validate_client_address() ? 1u : 0u, writer_->path_challenge_frames().size());
    // The final check is to ensure that the random data in the response
    // matches the random data from the challenge.
...
TEST_P(QuicConnectionTest, ReceiveStreamFrameFollowingPathChallenge)
{
    ...
    EXPECT_CALL(*send_algorithm_, OnPacketSent(_, _, _, _, _)).Times(AtLeast(1u)).WillOnce(Invoke([=, &received_packet_size]() {
...
TEST_P(QuicConnectionTest, PathChallengeWithDataInOutOfOrderPacket)
{
    ...
    EXPECT_CALL(visitor_, OnStreamFrame(_)).Times(2).WillRepeatedly(Invoke([=](const QuicStreamFrame& frame) {
        // Send some data on the stream. The STREAM_FRAME should be built into
...
TEST_P(QuicConnectionTest, ZeroRttRejectionAndMissingInitialKeys)
{
    ...
    EXPECT_CALL(visitor_, OnCryptoFrame(_)).WillRepeatedly(Invoke([=](const QuicCryptoFrame& frame) {
        if (frame.level == ENCRYPTION_HANDSHAKE) {
            // 0-RTT gets rejected.
            connection_.MarkZeroRttPacketsForRetransmission(0);
            // Send Crypto data.
            connection_.SetEncrypter(ENCRYPTION_HANDSHAKE, std::make_unique<TaggingEncrypter>(0x03));
            connection_.SetDefaultEncryptionLevel(ENCRYPTION_HANDSHAKE);
            connection_.SendCryptoDataWithString("foo", 0, ENCRYPTION_HANDSHAKE);
            connection_.SetEncrypter(ENCRYPTION_FORWARD_SECURE, std::make_unique<TaggingEncrypter>(0x04));
            connection_.SetDefaultEncryptionLevel(ENCRYPTION_FORWARD_SECURE);
...
TEST_P(QuicConnectionTest, InitiateKeyUpdate)
{
    ...
    EXPECT_CALL(visitor_, AdvanceKeysAndCreateCurrentOneRttDecrypter()).WillOnce([]() { return std::make_unique<StrictTaggingDecrypter>(0x02); });
    ...
    EXPECT_CALL(visitor_, AdvanceKeysAndCreateCurrentOneRttDecrypter()).WillOnce([]() { return std::make_unique<StrictTaggingDecrypter>(0x03); });
    EXPECT_CALL(visitor_, CreateCurrentOneRttEncrypter()).WillOnce([]() { return std::make_unique<TaggingEncrypter>(0x03); });
    EXPECT_CALL(visitor_, OnKeyUpdate(KeyUpdateReason::kLocalForTests));
    EXPECT_TRUE(connection_.InitiateKeyUpdate(KeyUpdateReason::kLocalForTests));

    // Pretend that peer accepts the key update.
    EXPECT_CALL(peer_framer_visitor_, AdvanceKeysAndCreateCurrentOneRttDecrypter()).WillOnce([]() { return std::make_unique<StrictTaggingDecrypter>(0x03); });
    EXPECT_CALL(peer_framer_visitor_, CreateCurrentOneRttEncrypter()).WillOnce([]() { return std::make_unique<TaggingEncrypter>(0x03); });
    peer_framer_.DoKeyUpdate(KeyUpdateReason::kRemote);
    ...
    EXPECT_CALL(visitor_, AdvanceKeysAndCreateCurrentOneRttDecrypter()).WillOnce([]() { return std::make_unique<StrictTaggingDecrypter>(0x04); });
    EXPECT_CALL(visitor_, CreateCurrentOneRttEncrypter()).WillOnce([]() { return std::make_unique<TaggingEncrypter>(0x04); });
    EXPECT_CALL(visitor_, OnKeyUpdate(KeyUpdateReason::kLocalForTests));
    EXPECT_TRUE(connection_.InitiateKeyUpdate(KeyUpdateReason::kLocalForTests));
    EXPECT_FALSE(connection_.GetDiscardPreviousOneRttKeysAlarm()->IsSet());
    EXPECT_FALSE(connection_.HaveSentPacketsInCurrentKeyPhaseButNoneAcked());
...
TEST_P(QuicConnectionTest, InitiateKeyUpdateApproachingConfidentialityLimit)
{
    ...
    for (int packet_num = 1; packet_num <= 8; ++packet_num) {
        if (packet_num == 3 || packet_num == 6) {
            current_tag++;
            EXPECT_CALL(visitor_, AdvanceKeysAndCreateCurrentOneRttDecrypter()).WillOnce([current_tag]() { return std::make_unique<StrictTaggingDecrypter>(current_tag); });
        ...
        if (packet_num == 4 || packet_num == 7) {
            ...
            EXPECT_CALL(peer_framer_visitor_, CreateCurrentOneRttEncrypter()).WillOnce([current_tag]() { return std::make_unique<TaggingEncrypter>(current_tag); });
            peer_framer_.DoKeyUpdate(KeyUpdateReason::kRemote);
        }
...
TEST_P(QuicConnectionTest, CloseConnectionOnConfidentialityLimitKeyUpdateNotAllowed)
{
    ...
    connection_.SetDefaultEncryptionLevel(ENCRYPTION_FORWARD_SECURE);
    connection_.SetEncrypter(ENCRYPTION_FORWARD_SECURE, std::make_unique<NullEncrypterWithConfidentialityLimit>(Perspective::IS_CLIENT, kConfidentialityLimit));
    EXPECT_CALL(visitor_, GetHandshakeState()).WillRepeatedly(Return(HANDSHAKE_CONFIRMED));
    connection_.OnHandshakeComplete();
...
TEST_P(QuicConnectionTest, CloseConnectionOnIntegrityLimitAcrossKeyPhases)
{
    ...
    connection_.SetDefaultEncryptionLevel(ENCRYPTION_FORWARD_SECURE);
    connection_.SetEncrypter(ENCRYPTION_FORWARD_SECURE, std::make_unique<TaggingEncrypter>(0x01));
    SetDecrypter(ENCRYPTION_FORWARD_SECURE, std::make_unique<StrictTaggingDecrypterWithIntegrityLimit>(0x01, kIntegrityLimit));
    EXPECT_CALL(visitor_, GetHandshakeState()).WillRepeatedly(Return(HANDSHAKE_CONFIRMED));
    connection_.OnHandshakeComplete();
    connection_.RemoveEncrypter(ENCRYPTION_INITIAL);
...
TEST_P(QuicConnectionTest, SendAckFrequencyFrame)
{
    ...
    EXPECT_EQ(captured_frame.max_ack_delay, QuicTime::Delta::FromMilliseconds(kDefaultDelayedAckTimeMs));
...
TEST_P(QuicConnectionTest, MultiPortCreation)
{
    ...
    EXPECT_CALL(visitor_, CreateContextForMultiPortPath())
        .WillRepeatedly(Return(testing::ByMove(std::make_unique<TestQuicPathValidationContext>(kNewSelfAddress, connection_.peer_address(), &new_writer))));
    connection_.OnNewConnectionIdFrame(frame);
    EXPECT_TRUE(connection_.HasPendingPathValidation());
    EXPECT_TRUE(QuicConnectionPeer::IsAlternativePath(&connection_, kNewSelfAddress, connection_.peer_address()));
...
TEST_P(QuicConnectionTest, ServerReceivedZeroRttPacketAfterOneRttPacketWithRetainedKey)
{
    ...
    set_perspective(Perspective::IS_SERVER);
    SetDecrypter(ENCRYPTION_ZERO_RTT, std::make_unique<NullDecrypter>(Perspective::IS_SERVER));
...
TEST_P(QuicConnectionTest, PathChallengeBeforePeerIpAddressChangeAtServer)
{
    ...
    QuicPathFrameBuffer payload;
    EXPECT_CALL(*send_algorithm_, OnPacketSent(_, _, _, _, NO_RETRANSMITTABLE_DATA)).Times(AtLeast(1)).WillOnce(Invoke([&]() {
        EXPECT_EQ(kNewPeerAddress, writer_->last_write_peer_address());
        EXPECT_EQ(kPeerAddress, connection_.peer_address());
        EXPECT_EQ(kPeerAddress, connection_.effective_peer_address());
    ...
    // start connection migration.
    EXPECT_CALL(visitor_, OnConnectionMigration(IPV6_TO_IPV4_CHANGE)).Times(1);
    EXPECT_CALL(visitor_, OnStreamFrame(_)).WillOnce(Invoke([=]() { EXPECT_EQ(kNewPeerAddress, connection_.peer_address()); }));
    // IETF QUIC send algorithm should be changed to a different object, so no
    // OnPacketSent() called on the old send algorithm.
    EXPECT_CALL(*send_algorithm_, OnPacketSent(_, _, _, _, NO_RETRANSMITTABLE_DATA)).Times(0);
    QuicFrames frames2;
...
TEST_P(QuicConnectionTest, PathValidationSucceedsBeforePeerIpAddressChangeAtServer)
{
    ...
    const QuicSocketAddress kNewerPeerAddress(QuicIpAddress::Loopback4(),
        /*port=*/34567);
    EXPECT_CALL(visitor_, OnStreamFrame(_)).WillOnce(Invoke([=]() { EXPECT_EQ(kNewerPeerAddress, connection_.peer_address()); }));
    EXPECT_CALL(visitor_, MaybeSendAddressToken());
    QuicFrames frames2;
    frames2.push_back(QuicFrame(frame2_));
...
TEST_P(QuicConnectionTest, NoNonProbingFrameOnAlternativePath)
{
    ...
    EXPECT_CALL(visitor_, OnStreamFrame(_)).WillRepeatedly(Invoke([=]() { EXPECT_EQ(kPeerAddress, connection_.peer_address()); }));
...
TEST_P(QuicConnectionTest, PathValidationFailedOnClientDueToLackOfClientConnectionIdTheSecondTime)
{
    ...
    if (GetQuicReloadableFlag(quic_connection_uses_abstract_connection_id_generator)) {
        EXPECT_CALL(connection_id_generator_, GenerateNextConnectionId(_)).WillOnce(Return(TestConnectionId(456)));
    }
...
TEST_P(QuicConnectionTest, MigratePathDirectlyFailedDueToLackOfClientConnectionIdTheSecondTime)
{
    ...
    EXPECT_CALL(visitor_, SendNewConnectionId(_)).WillOnce(Invoke([&](const QuicNewConnectionIdFrame& frame) { new_client_connection_id = frame.connection_id; }));
...
{
    if (!version().HasIetfQuicFrames() || !connection_.connection_migration_use_new_cid()) {
        return;
    }
    set_perspective(Perspective::IS_SERVER);
...
TEST_P(QuicConnectionTest, ServerRetireSelfIssuedConnectionId)
{
    ...
    EXPECT_TRUE(
        connection_.GetOneActiveServerConnectionId() == cid0 || connection_.GetOneActiveServerConnectionId() == cid1 || connection_.GetOneActiveServerConnectionId() == cid2);
...
TEST_P(QuicConnectionTest, FailedToConsumeCryptoData)
{
    ...
    connection_.SetEncrypter(ENCRYPTION_INITIAL, std::make_unique<TaggingEncrypter>(0x01));
    connection_.SetEncrypter(ENCRYPTION_HANDSHAKE, std::make_unique<TaggingEncrypter>(0x03));
    SetDecrypter(ENCRYPTION_HANDSHAKE, std::make_unique<StrictTaggingDecrypter>(0x03));
    SetDecrypter(ENCRYPTION_ZERO_RTT, std::make_unique<StrictTaggingDecrypter>(0x02));
    connection_.SetEncrypter(ENCRYPTION_FORWARD_SECURE, std::make_unique<TaggingEncrypter>(0x04));
    // Received ENCRYPTION_ZERO_RTT 1.
    ProcessDataPacketAtLevel(1, !kHasStopWaiting, ENCRYPTION_ZERO_RTT);
...
TEST_P(QuicConnectionTest, RTTSampleDoesNotIncludeQueuingDelayWithPostponedAckProcessing)
{
    ...
    clock_.AdvanceTime(kTestRTT + QuicTime::Delta::FromMilliseconds(kDefaultDelayedAckTimeMs));
    EXPECT_EQ(0u, QuicConnectionPeer::NumUndecryptablePackets(&connection_));
    peer_framer_.SetEncrypter(ENCRYPTION_FORWARD_SECURE, std::make_unique<TaggingEncrypter>(0x01));
    QuicAckFrame ack_frame = InitAckFrame(1);
    // Peer reported ACK delay.
    ack_frame.ack_delay_time = QuicTime::Delta::FromMilliseconds(kDefaultDelayedAckTimeMs);
    QuicFrames frames;
    frames.push_back(QuicFrame(&ack_frame));
...
TEST_P(QuicConnectionTest, NoExtraPaddingInReserializedInitial)
{
    ...
    EXPECT_CALL(debug_visitor, OnPacketSent(_, _, _, _, _, _, _, _)).WillRepeatedly([&]() { debug_visitor_sent_count++; });
...
TEST_P(QuicConnectionTest, ServerConnectionIdChangeWithLateInitial)
{
    ...
    EXPECT_CALL(visitor_, OnCryptoFrame(_)).Times(2).WillOnce(InstallKeys(&connection_, ENCRYPTION_HANDSHAKE)).WillOnce(InstallKeys(&connection_, ENCRYPTION_FORWARD_SECURE));
    EXPECT_CALL(visitor_, OnStreamFrame(_)).Times(1);
