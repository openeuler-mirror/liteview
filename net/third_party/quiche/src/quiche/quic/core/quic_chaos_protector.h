...
class QUIC_EXPORT_PRIVATE QuicChaosProtector : public QuicStreamFrameDataProducer {
public:
    ...
    absl::optional<size_t> BuildDataPacket(const QuicPacketHeader& header, char* buffer);
...
private:
    ...
    absl::optional<size_t> BuildPacket(const QuicPacketHeader& header, char* buffer);
