...
absl::string_view IovecToStringPiece(iovec iov) { return absl::string_view(reinterpret_cast<const char*>(iov.iov_base), iov.iov_len); }
...
public:
    ...
    void WriteNextChunkToBuffer()
    {
        ...
        QUIC_DVLOG(1) << " write at offset: " << offset << " len to write: " << num_to_write << " write result: " << result << " left over: " << shuffled_buf_.size();
    }
