...
std::string PrintToString(const TestParams& p) { return absl::StrCat((p.endianness == quiche::NETWORK_BYTE_ORDER ? "Network" : "Host"), "ByteOrder"); }
...
TEST_P(QuicDataWriterTest, Write16BitUnsignedIntegers)
{
    ...
    char buffer16[2];
    {
        ...
        quiche::test::CompareCharArraysWithHexError("uint16_t", buffer16, 2, GetParam().endianness == quiche::NETWORK_BYTE_ORDER ? big_endian16 : little_endian16, 2);
...
TEST_P(QuicDataWriterTest, Write32BitUnsignedIntegers)
{
    ...
    char buffer32[4];
    {
        ...
        quiche::test::CompareCharArraysWithHexError("uint32_t", buffer32, 4, GetParam().endianness == quiche::NETWORK_BYTE_ORDER ? big_endian32 : little_endian32, 4);
...
TEST_P(QuicDataWriterTest, Write64BitUnsignedIntegers)
{
    ...
    quiche::test::CompareCharArraysWithHexError("uint64_t", buffer64, 8, GetParam().endianness == quiche::NETWORK_BYTE_ORDER ? AsChars(big_endian64) : AsChars(little_endian64), 8);
...
TEST_P(QuicDataWriterTest, StringPieceVarInt62)
{
    ...
    quiche::test::CompareCharArraysWithHexError("inner_payload", inner_payload_write.data(), inner_payload_write.length(), inner_payload_read.data(), inner_payload_read.length());
}
