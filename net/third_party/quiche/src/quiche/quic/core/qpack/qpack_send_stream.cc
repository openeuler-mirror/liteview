...
void QpackSendStream::OnStreamReset(const QuicRstStreamFrame& /*frame*/) { QUIC_BUG(quic_bug_10805_1) << "OnStreamReset() called for write unidirectional stream."; }
...
uint64_t QpackSendStream::NumBytesBuffered() const { return QuicStream::BufferedDataBytes(); }
