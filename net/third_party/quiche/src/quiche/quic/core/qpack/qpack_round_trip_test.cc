...
public:
    ...
    spdy::Http2HeaderBlock EncodeThenDecode(const spdy::Http2HeaderBlock& header_list)
    {
        ...
        QpackDecode(
            ...
            /* maximum_blocked_streams = */ 0, &encoder_stream_error_delegate, &decoder_stream_sender_delegate, &handler, FragmentModeToFragmentSizeGenerator(GetParam()),
