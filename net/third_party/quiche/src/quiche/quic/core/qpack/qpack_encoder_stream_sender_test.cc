...
protected:
    QpackEncoderStreamSenderTest() { stream_.set_qpack_stream_sender_delegate(&delegate_); }
...
TEST_F(QpackEncoderStreamSenderTest, InsertWithNameReference)
{
    ...
    expected_encoded_data = absl::HexStringToBytes("aa7f005a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a"
...
TEST_F(QpackEncoderStreamSenderTest, InsertWithoutNameReference)
{
    ...
    // 'Z' would be Huffman encoded to 8 bits, so no Huffman encoding is used.
    expected_encoded_data = absl::HexStringToBytes("5f005a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a7f"
...
TEST_F(QpackEncoderStreamSenderTest, Coalesce)
{
    ...
    std::string expected_encoded_data = absl::HexStringToBytes("c500" // Insert entry with static name reference.
