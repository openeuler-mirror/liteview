...
protected:
    ...
    void DecodeEncoderStreamData(absl::string_view data) { qpack_decoder_.encoder_stream_receiver()->Decode(data); }

    std::unique_ptr<QpackProgressiveDecoder> CreateProgressiveDecoder(QuicStreamId stream_id) { return qpack_decoder_.CreateProgressiveDecoder(stream_id, &handler_); }

    // Set up |progressive_decoder_|.
    void StartDecoding() { progressive_decoder_ = CreateProgressiveDecoder(/* stream_id = */ 1); }
...
TEST_P(QpackDecoderTest, MultipleLiteralEntries)
{
    ...
    DecodeHeaderBlock(absl::HexStringToBytes("0000" // prefix
...
TEST_P(QpackDecoderTest, ValueLenTooLargeForVarintDecoder)
{
    ...
    DecodeHeaderBlock(absl::HexStringToBytes("000023666f6f7fffffffffffffffffffff"));
}
...
TEST_P(QpackDecoderTest, HuffmanNameDoesNotHaveEOSPrefix)
{
    ...
    DecodeHeaderBlock(absl::HexStringToBytes("00002f0125a849e95ba97d7e8925a849e95bb8e8b4bf"));
}
...
TEST_P(QpackDecoderTest, HuffmanValueDoesNotHaveEOSPrefix)
{
    ...
    DecodeHeaderBlock(absl::HexStringToBytes("00002f0125a849e95ba97d7f8925a849e95bb8e8b4be"));
}
...
TEST_P(QpackDecoderTest, HuffmanNameEOSPrefixTooLong)
{
    ...
    // prefix of EOS.
    DecodeHeaderBlock(absl::HexStringToBytes("00002f0225a849e95ba97d7fff8925a849e95bb8e8b4bf"));
}
...
TEST_P(QpackDecoderTest, HuffmanValueEOSPrefixTooLong)
{
    ...
    // prefix of EOS.
    DecodeHeaderBlock(absl::HexStringToBytes("00002f0125a849e95ba97d7f8a25a849e95bb8e8b4bfff"));
}
...
{
    DecodeEncoderStreamData(absl::HexStringToBytes("3fe107" // Set dynamic table capacity to 1024.
    ...
    DecodeHeaderBlock(absl::HexStringToBytes("0500" // Required Insert Count 4 and Delta Base 0.
                                                    // Base is 4 + 0 = 4.
    ...
    DecodeHeaderBlock(absl::HexStringToBytes("0502" // Required Insert Count 4 and Delta Base 2.
                                                    // Base is 4 + 2 = 6.
    ...
    DecodeHeaderBlock(absl::HexStringToBytes("0582" // Required Insert Count 4 and Delta Base 2 with sign bit set.
                                                    // Base is 4 - 2 - 1 = 1.
...
TEST_P(QpackDecoderTest, DecreasingDynamicTableCapacityEvictsEntries)
{
    ...
    DecodeHeaderBlock(absl::HexStringToBytes("0200" // Required Insert Count 1 and Delta Base 0.
                                                    // Base is 1 + 0 = 1.
                                             "80")); // Dynamic table entry with relative index 0, absolute index 0.
...
{
    EXPECT_CALL(encoder_stream_error_delegate_, OnEncoderStreamError(QUIC_QPACK_ENCODER_STREAM_INSERTION_INVALID_RELATIVE_INDEX, Eq("Invalid relative index.")));
...
{
    EXPECT_CALL(encoder_stream_error_delegate_, OnEncoderStreamError(QUIC_QPACK_ENCODER_STREAM_DUPLICATE_INVALID_RELATIVE_INDEX, Eq("Invalid relative index.")));
...
TEST_P(QpackDecoderTest, InvalidDynamicEntryWhenBaseIsZero)
{
    ...
    DecodeHeaderBlock(absl::HexStringToBytes("0280" // Required Insert Count is 1.  Base 1 - 1 - 0 = 0 is explicitly
...
TEST_P(QpackDecoderTest, EvictedDynamicTableEntry)
{
    ...
    DecodeHeaderBlock(absl::HexStringToBytes("0380" // Required Insert Count 2 and Delta Base 0 with sign bit set.
                                                    // Base is 2 - 0 - 1 = 1
...
{
    EXPECT_CALL(encoder_stream_error_delegate_, OnEncoderStreamError(QUIC_QPACK_ENCODER_STREAM_SET_DYNAMIC_TABLE_CAPACITY, Eq("Error updating dynamic table capacity.")));
...
TEST_P(QpackDecoderTest, WrappedRequiredInsertCount)
{
    ...
    DecodeEncoderStreamData(absl::HexStringToBytes("6294e7" // Name "foo".
    ...
    DecodeHeaderBlock(absl::HexStringToBytes("0a00" // Encoded Required Insert Count 10, Required Insert Count 201,
...
TEST_P(QpackDecoderTest, NonZeroRequiredInsertCountButNoDynamicEntries)
{
    ...
    DecodeHeaderBlock(absl::HexStringToBytes("0200" // Required Insert Count is 1.
...
TEST_P(QpackDecoderTest, AddressEntryNotAllowedByRequiredInsertCount)
{
    ...
    DecodeHeaderBlock(absl::HexStringToBytes("0201" // Required Insert Count 1 and Delta Base 1.
                                                    // Base is 1 + 1 = 2.
...
TEST_P(QpackDecoderTest, PromisedRequiredInsertCountLargerThanActual)
{
    ...
    DecodeHeaderBlock(absl::HexStringToBytes("0300" // Required Insert Count 2 and Delta Base 0.
                                                    // Base is 2 + 0 = 2.
    ...
    DecodeHeaderBlock(absl::HexStringToBytes("0481" // Required Insert Count 3 and Delta Base 1 with sign bit set.
                                                    // Base is 3 - 1 - 1 = 1.
                                             "10")); // Indexed Header Field with Post-Base Index instruction
                                                     // addressing dynamic table entry with post-base index 0,
...
{
    StartDecoding();
    DecodeData(absl::HexStringToBytes("0200" // Required Insert Count 1 and Delta Base 0.
                                             // Base is 1 + 0 = 1.
                                      "80" // Indexed Header Field instruction addressing dynamic table
                                           // entry with relative index 0, absolute index 0.
    ...
    DecodeData(absl::HexStringToBytes("80" // Indexed Header Field instruction addressing dynamic table
                                           // entry with relative index 0, absolute index 0.
...
TEST_P(QpackDecoderTest, BlockedDecodingAndEvictedEntries)
{
    ...
    DecodeHeaderBlock(absl::HexStringToBytes("0700" // Required Insert Count 6 and Delta Base 0.
                                                    // Base is 6 + 0 = 6.
                                             "80")); // Indexed Header Field instruction addressing dynamic table
...
TEST_P(QpackDecoderTest, InsertCountIncrement)
{
    ...
    EXPECT_CALL(decoder_stream_sender_delegate_,
        WriteStreamData(Eq(absl::HexStringToBytes("81" // Header Acknowledgement on stream 1
