...
protected:
    ...
    std::string Encode(const spdy::Http2HeaderBlock& header_list) { return encoder_.EncodeHeaderList(/* stream_id = */ 1, header_list, &encoder_stream_sent_byte_count_); }
...
TEST_F(QpackEncoderTest, StaticTable)
{
    ...
    }
    {
        ...
        std::string output = Encode(header_list);
        EXPECT_EQ(absl::HexStringToBytes("0000d45f108621e9aec2a11f5c8294e7"), output);
    }
    {
        spdy::Http2HeaderBlock header_list;
...
TEST_F(QpackEncoderTest, DecoderStreamError)
{
    ...
    encoder.decoder_stream_receiver()->Decode(absl::HexStringToBytes("ffffffffffffffffffffff"));
}
...
TEST_F(QpackEncoderTest, InsertCountIncrementOverflow)
{
    ...
    EXPECT_CALL(decoder_stream_error_delegate_, OnDecoderStreamError(QUIC_QPACK_DECODER_STREAM_INCREMENT_OVERFLOW, Eq("Insert Count Increment instruction causes overflow.")));
...
TEST_F(QpackEncoderTest, DynamicTable)
{
    ...
    std::string insert_entries = absl::HexStringToBytes("62" // insert without name reference
...
TEST_F(QpackEncoderTest, SmallDynamicTable)
{
    ...
    std::string insert_entry = absl::HexStringToBytes("62" // insert without name reference
                                                      "94e7" // Huffman-encoded name "foo"
                                                      "03626172"); // value "bar"
...
TEST_F(QpackEncoderTest, BlockedStream)
{
    ...
    std::string set_dyanamic_table_capacity = absl::HexStringToBytes("3fe11f");
    // Insert one entry into the dynamic table.
    std::string insert_entry1 = absl::HexStringToBytes("62" // insert without name reference
                                                       "94e7" // Huffman-encoded name "foo"
                                                       "03626172"); // value "bar"
    ...
    EXPECT_EQ(absl::HexStringToBytes("0200" // prefix
                                     "80"), // dynamic entry 0
        encoder_.EncodeHeaderList(/* stream_id = */ 1, header_list1, &encoder_stream_sent_byte_count_));
    ...
    EXPECT_EQ(absl::HexStringToBytes("0000" // prefix
                                     ...
                                     "23626172" // literal name "bar"
                                     "0362617a"), // with literal value "baz"
        encoder_.EncodeHeaderList(/* stream_id = */ 2, header_list2, &encoder_stream_sent_byte_count_));
    ...
    // Insert three entries into the dynamic table.
    std::string insert_entries = absl::HexStringToBytes("80" // insert with name reference, dynamic index 0
                                                        "0362617a" // value "baz"
                                                        "c5" // insert with name reference, static index 5
                                                        "0362617a" // value "baz"
    ...
    EXPECT_EQ(absl::HexStringToBytes("0500" // prefix
        ...
        encoder_.EncodeHeaderList(/* stream_id = */ 3, header_list2, &encoder_stream_sent_byte_count_));
    EXPECT_EQ(insert_entries.size(), encoder_stream_sent_byte_count_);
    ...
    EXPECT_EQ(absl::HexStringToBytes("0200" // prefix
                                     ...
                                     "23626172" // literal name "bar"
                                     "0362617a"), // with literal value "baz"
        encoder_.EncodeHeaderList(/* stream_id = */ 4, header_list2, &encoder_stream_sent_byte_count_));
    EXPECT_EQ(0u, encoder_stream_sent_byte_count_);
    ...
    EXPECT_EQ(absl::HexStringToBytes("0400" // prefix
                                     ...
                                     "23626172" // literal name "bar"
                                     "0362617a"), // with literal value "baz"
        encoder_.EncodeHeaderList(/* stream_id = */ 5, header_list2, &encoder_stream_sent_byte_count_));
    EXPECT_EQ(0u, encoder_stream_sent_byte_count_);
    ...
    EXPECT_EQ(absl::HexStringToBytes("0500" // prefix
                                     "83828180"), // dynamic entries
        encoder_.EncodeHeaderList(/* stream_id = */ 6, header_list2, &encoder_stream_sent_byte_count_));
    EXPECT_EQ(0u, encoder_stream_sent_byte_count_);
}
...
TEST_F(QpackEncoderTest, Draining)
{
    ...
    EXPECT_CALL(encoder_stream_sender_delegate_, WriteStreamData(Eq(absl::HexStringToBytes("09"))));
