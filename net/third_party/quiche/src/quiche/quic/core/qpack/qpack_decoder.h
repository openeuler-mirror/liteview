...
class QUIC_EXPORT_PRIVATE QpackDecoder : public QpackEncoderStreamReceiver::Delegate,
...
public:
    ...
    void set_qpack_stream_sender_delegate(QpackStreamSenderDelegate* delegate) { decoder_stream_sender_.set_qpack_stream_sender_delegate(delegate); }

    QpackStreamReceiver* encoder_stream_receiver() { return &encoder_stream_receiver_; }
...
class QUIC_EXPORT_PRIVATE NoopEncoderStreamErrorDelegate : public QpackDecoder::EncoderStreamErrorDelegate {
public:
