...
static_assert(static_cast<size_t>(QuicUdpPacketInfoBit::NUM_BITS) <= BitMask64::NumBits(), "BitMask64 not wide enough to hold all bits.");
...
public:
    ...
    void ReadPacket(QuicUdpSocketFd fd, BitMask64 packet_info_interested, ReadPacketResult* result);
    ...
    size_t ReadMultiplePackets(QuicUdpSocketFd fd, BitMask64 packet_info_interested, ReadPacketResults* results);
