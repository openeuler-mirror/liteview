...
class QUIC_EXPORT_PRIVATE QuicCryptoHandshaker : public CryptoFramerVisitorInterface {
public:
...
protected:
    QuicTag last_sent_handshake_message_tag() const { return last_sent_handshake_message_tag_; }
