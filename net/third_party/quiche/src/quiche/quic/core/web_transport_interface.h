...
public:
    ...
    ABSL_MUST_USE_RESULT virtual ReadResult Read(char* buffer, size_t buffer_size) = 0;
    ...
    virtual void SetVisitor(std::unique_ptr<WebTransportStreamVisitor> visitor) = 0;
};
...
public:
    ...
    virtual void OnSessionClosed(WebTransportSessionError error_code, const std::string& error_message) = 0;
...
public:
    ...
    // and |error_message|.
    virtual void CloseSession(WebTransportSessionError error_code, absl::string_view error_message) = 0;
    ...
    virtual MessageStatus SendOrQueueDatagram(quiche::QuicheMemSlice datagram) = 0;
