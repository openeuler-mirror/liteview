...
public:
    ...
    QuicTime::Delta SmoothedOrInitialRtt() const { return smoothed_rtt_.IsZero() ? initial_rtt_ : smoothed_rtt_; }

    QuicTime::Delta MinOrInitialRtt() const { return min_rtt_.IsZero() ? initial_rtt_ : min_rtt_; }
    ...
    void EnableStandardDeviationCalculation() { calculate_standard_deviation_ = true; }
