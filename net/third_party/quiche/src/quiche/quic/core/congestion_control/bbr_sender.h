...
public:
    ...
    bool HasGoodBandwidthEstimateForResumption() const override { return has_non_app_limited_sample(); }
    ...
    bool has_non_app_limited_sample() const { return has_non_app_limited_sample_; }
...
QUIC_EXPORT_PRIVATE std::ostream& operator<<(std::ostream& os, const BbrSender::Mode& mode);
QUIC_EXPORT_PRIVATE std::ostream& operator<<(std::ostream& os, const BbrSender::DebugState& state);
