...
void RttStats::StandardDeviationCaculator::OnNewRttSample(QuicTime::Delta rtt_sample, QuicTime::Delta smoothed_rtt)
{
...
QuicTime::Delta RttStats::StandardDeviationCaculator::CalculateStandardDeviation() const
{
