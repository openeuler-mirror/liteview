...
inline constexpr int kMaxPromisedStreamsMultiplier = kMaxAvailableStreamsMultiplier - 1;
...
static_assert(kDefaultDelayedAckTimeMs <= kMinRetransmissionTimeMs / 2, "Delayed ack time must be less than or equal half the MinRTO");
