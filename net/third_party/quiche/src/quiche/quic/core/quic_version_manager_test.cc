...
TEST_F(QuicVersionManagerTest, QuicVersionManager)
{
    ...
    EXPECT_THAT(manager.GetSupportedAlpns(), ElementsAre("h3-Q050", "h3-Q046", "h3-Q043"));
    ...
    EXPECT_THAT(manager.GetSupportedAlpns(), ElementsAre("h3-29", "h3-Q050", "h3-Q046", "h3-Q043"));
    ...
    EXPECT_EQ(CurrentSupportedHttp3Versions(), manager.GetSupportedVersionsWithOnlyHttp3());
    EXPECT_THAT(manager.GetSupportedAlpns(), ElementsAre("h3", "h3-29", "h3-Q050", "h3-Q046", "h3-Q043"));

    QuicEnableVersion(ParsedQuicVersion::V2Draft01());
    expected_parsed_versions.insert(expected_parsed_versions.begin(), ParsedQuicVersion::V2Draft01());
    EXPECT_EQ(expected_parsed_versions, manager.GetSupportedVersions());
    EXPECT_EQ(FilterSupportedVersions(AllSupportedVersions()), manager.GetSupportedVersions());
