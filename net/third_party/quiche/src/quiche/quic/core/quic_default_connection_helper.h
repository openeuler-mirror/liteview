...
class QUIC_EXPORT_PRIVATE QuicDefaultConnectionHelper : public QuicConnectionHelperInterface {
public:
    ...
    quiche::QuicheBufferAllocator* GetStreamSendBufferAllocator() override { return allocator_ ? allocator_.get() : quiche::SimpleBufferAllocator::Get(); }
