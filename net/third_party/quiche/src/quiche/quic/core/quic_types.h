...
struct QUIC_EXPORT_PRIVATE QuicConsumedData {
    ...
    QUIC_EXPORT_PRIVATE friend std::ostream& operator<<(std::ostream& os, const QuicConsumedData& s);
...
QUIC_EXPORT_PRIVATE std::ostream& operator<<(std::ostream& os, const WriteStatus& status);

inline std::string HistogramEnumDescription(WriteStatus /*dummy*/) { return "status"; }

inline bool IsWriteBlockedStatus(WriteStatus status) { return status == WRITE_STATUS_BLOCKED || status == WRITE_STATUS_BLOCKED_DATA_BUFFERED; }

inline bool IsWriteError(WriteStatus status) { return status >= WRITE_STATUS_ERROR; }
...
struct QUIC_EXPORT_PRIVATE WriteResult {
    ...
    QUIC_EXPORT_PRIVATE friend std::ostream& operator<<(std::ostream& os, const WriteResult& s);
...
QUIC_EXPORT_PRIVATE std::string TransmissionTypeToString(TransmissionType transmission_type);
...
QUIC_EXPORT_PRIVATE std::ostream& operator<<(std::ostream& os, const Perspective& perspective);

// Describes whether a ConnectionClose was originated by the peer.
enum class ConnectionCloseSource { FROM_PEER, FROM_SELF };

QUIC_EXPORT_PRIVATE std::string ConnectionCloseSourceToString(ConnectionCloseSource connection_close_source);
...
QUIC_EXPORT_PRIVATE std::string ConnectionCloseBehaviorToString(ConnectionCloseBehavior connection_close_behavior);
QUIC_EXPORT_PRIVATE std::ostream& operator<<(std::ostream& os, const ConnectionCloseBehavior& connection_close_behavior);
...
QUIC_EXPORT_PRIVATE std::ostream& operator<<(std::ostream& os, const QuicFrameType& t);
...
QUIC_EXPORT_PRIVATE std::ostream& operator<<(std::ostream& os, const QuicIetfFrameType& c);
...
QUIC_EXPORT_PRIVATE std::string CongestionControlTypeToString(CongestionControlType cc_type);
...
inline bool EncryptionLevelIsValid(EncryptionLevel level) { return ENCRYPTION_INITIAL <= level && level < NUM_ENCRYPTION_LEVELS; }

QUIC_EXPORT_PRIVATE std::string EncryptionLevelToString(EncryptionLevel level);

QUIC_EXPORT_PRIVATE std::ostream& operator<<(std::ostream& os, EncryptionLevel level);
...
QUIC_EXPORT_PRIVATE absl::string_view ClientCertModeToString(ClientCertMode mode);

QUIC_EXPORT_PRIVATE std::ostream& operator<<(std::ostream& os, ClientCertMode mode);
...
QUIC_EXPORT_PRIVATE std::string AddressChangeTypeToString(AddressChangeType type);

QUIC_EXPORT_PRIVATE std::ostream& operator<<(std::ostream& os, AddressChangeType type);
...
QUIC_EXPORT_PRIVATE std::string PacketHeaderFormatToString(PacketHeaderFormat format);
...
struct QUIC_EXPORT_PRIVATE AckedPacket {
    ...
    friend QUIC_EXPORT_PRIVATE std::ostream& operator<<(std::ostream& os, const AckedPacket& acked_packet);
...
struct QUIC_EXPORT_PRIVATE LostPacket {
    ...
    friend QUIC_EXPORT_PRIVATE std::ostream& operator<<(std::ostream& os, const LostPacket& lost_packet);
...
QUIC_EXPORT_PRIVATE std::string QuicLongHeaderTypeToString(QuicLongHeaderType type);
...
QUIC_EXPORT_PRIVATE std::string MessageStatusToString(MessageStatus message_status);
...
struct QUIC_EXPORT_PRIVATE MessageResult {
    ...
    bool operator==(const MessageResult& other) const { return status == other.status && message_id == other.message_id; }

    QUIC_EXPORT_PRIVATE friend std::ostream& operator<<(std::ostream& os, const MessageResult& mr);
...
QUIC_EXPORT_PRIVATE std::string MessageResultToString(MessageResult message_result);
...
QUIC_EXPORT_PRIVATE std::string PacketNumberSpaceToString(PacketNumberSpace packet_number_space);
...
QUIC_EXPORT_PRIVATE std::string SerializedPacketFateToString(SerializedPacketFate fate);

QUIC_EXPORT_PRIVATE std::ostream& operator<<(std::ostream& os, const SerializedPacketFate fate);
...
QUIC_EXPORT_PRIVATE std::ostream& operator<<(std::ostream& os, const QuicConnectionCloseType type);

QUIC_EXPORT_PRIVATE std::string QuicConnectionCloseTypeString(QuicConnectionCloseType type);
...
QUIC_EXPORT_PRIVATE std::ostream& operator<<(std::ostream& os, const KeyUpdateReason reason);
...
QUIC_EXPORT_PRIVATE bool operator==(const ParsedClientHello& a, const ParsedClientHello& b);

QUIC_EXPORT_PRIVATE std::ostream& operator<<(std::ostream& os, const ParsedClientHello& parsed_chlo);
