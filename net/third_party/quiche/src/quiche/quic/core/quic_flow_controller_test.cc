...
public:
    void Initialize()
    {
        ...
        flow_controller_ = std::make_unique<QuicFlowController>(session_.get(), stream_id_, /*is_connection_flow_controller*/ false, send_window_, receive_window_,
            kStreamReceiveWindowLimit, should_auto_tune_receive_window_, &session_flow_controller_);
    }
