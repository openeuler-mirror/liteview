...
// connection ID.
class QUIC_EXPORT_PRIVATE DeterministicConnectionIdGenerator : public ConnectionIdGeneratorInterface {
public:
    ...
    uint8_t ConnectionIdLength(uint8_t /*first_byte*/) const override { return expected_connection_id_length_; }
