...
public:
    static QuicAlarm* GetAlarm(QuicPingManager* manager) { return manager->alarm_.get(); }

    static void SetPerspective(QuicPingManager* manager, Perspective perspective) { manager->perspective_ = perspective; }
};
...
public:
    QuicPingManagerTest()
        : manager_(Perspective::IS_CLIENT, &delegate_, &arena_, &alarm_factory_,
            /*context=*/nullptr)
        , alarm_(static_cast<MockAlarmFactory::TestAlarm*>(QuicPingManagerPeer::GetAlarm(&manager_)))
    {
