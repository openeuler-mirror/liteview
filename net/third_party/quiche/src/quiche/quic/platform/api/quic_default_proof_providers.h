...
inline std::unique_ptr<ProofVerifier> CreateDefaultProofVerifier(const std::string& host) { return quiche::CreateDefaultProofVerifier(host); }
...
inline std::unique_ptr<ProofSource> CreateDefaultProofSource() { return quiche::CreateDefaultProofSource(); }
