...
#define QUIC_CLIENT_HISTOGRAM_TIMES(name, sample, min, max, bucket_count, docstring) QUICHE_CLIENT_HISTOGRAM_TIMES(name, sample, min, max, bucket_count, docstring)
...
#define QUIC_CLIENT_HISTOGRAM_COUNTS(name, sample, min, max, bucket_count, docstring) QUICHE_CLIENT_HISTOGRAM_COUNTS(name, sample, min, max, bucket_count, docstring)

inline void QuicClientSparseHistogram(const std::string& name, int sample) { quiche::QuicheClientSparseHistogram(name, sample); }
