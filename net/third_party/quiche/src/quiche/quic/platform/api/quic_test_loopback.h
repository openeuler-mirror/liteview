...
inline IpAddressFamily AddressFamilyUnderTest() { return quiche::AddressFamilyUnderTest(); }
...
// platform-dependent.
inline QuicIpAddress TestLoopback(int index) { return quiche::TestLoopback(index); }
