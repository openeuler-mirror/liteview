...
public:
    MOCK_METHOD(void, OnSessionReady, (const spdy::Http2HeaderBlock&), (override));
    MOCK_METHOD(void, OnSessionClosed, (WebTransportSessionError, const std::string&), (override));
...
public:
    ...
    MOCK_METHOD(void, OnResetStreamReceived, (WebTransportStreamError error), (override));
    MOCK_METHOD(void, OnStopSendingReceived, (WebTransportStreamError error), (override));
