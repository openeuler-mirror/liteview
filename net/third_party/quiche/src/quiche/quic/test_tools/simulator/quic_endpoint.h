...
public:
    ...
    bool MaybeReserveConnectionId(const QuicConnectionId& /*server_connection_id*/) override { return true; }
...
private:
    ...
    std::unique_ptr<QuicConnection> CreateConnection(Simulator* simulator, std::string name, std::string peer_name, Perspective perspective, QuicConnectionId connection_id);
