...
private:
    ...
    bool ReadNextExpectedHeaderList(absl::string_view* expected_headers_data, spdy::Http2HeaderBlock* expected_header_list);
    ...
    bool CompareHeaderBlocks(spdy::Http2HeaderBlock decoded_header_list, spdy::Http2HeaderBlock expected_header_list);
