...
public:
    ...
    void AddPacketToBeRead(std::unique_ptr<QuicData> packet) { packets_to_be_read_.push_back(std::move(packet)); }
    ...
    const std::vector<std::string>& packets_written() const { return packets_written_; }
