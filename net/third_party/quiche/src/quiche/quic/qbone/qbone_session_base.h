...
public:
    QboneSessionBase(QuicConnection* connection, Visitor* owner, const QuicConfig& config, const ParsedQuicVersionVector& supported_versions, QbonePacketWriter* writer);
    ...
    void set_send_packets_as_messages(bool send_packets_as_messages) { send_packets_as_messages_ = send_packets_as_messages; }
...
protected:
    ...
    bool MaybeIncreaseLargestPeerStreamId(const QuicStreamId stream_id) override { return true; }
