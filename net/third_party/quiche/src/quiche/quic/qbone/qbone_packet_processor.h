...
public:
    ...
    public:
        ...
        virtual ProcessingResult FilterPacket(Direction direction, absl::string_view full_packet, absl::string_view payload, icmp6_hdr* icmp_header, OutputInterface* output);
    ...
    protected:
        ...
        // FilterPacket().
        uint8_t TransportProtocolFromHeader(absl::string_view ipv6_header) { return ipv6_header[6]; }
    ...
    void set_client_ip_subnet_length(size_t client_ip_subnet_length) { client_ip_subnet_length_ = client_ip_subnet_length; }
...
protected:
    ...
    ProcessingResult ProcessIPv6HeaderAndFilter(std::string* packet, Direction direction, uint8_t* transport_protocol, char** transport_data, icmp6_hdr* icmp_header);

    void SendIcmpResponse(icmp6_hdr* icmp_header, absl::string_view original_packet, Direction original_direction);
