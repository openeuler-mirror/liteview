...
public:
    ...
    // by the caller.
    QboneClient(QuicSocketAddress server_address, const QuicServerId& server_id, const ParsedQuicVersionVector& supported_versions, QuicSession::Visitor* session_owner,
...
protected:
    ...
    QboneClientControlStream::Handler* qbone_control_handler() { return qbone_handler_; }
