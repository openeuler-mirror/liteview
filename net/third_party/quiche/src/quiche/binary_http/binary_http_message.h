...
public:
    ...
    struct Field {
        std::string name;
        std::string value;
        bool operator==(const BinaryHttpMessage::Field& rhs) const { return name == rhs.name && value == rhs.value; }

        bool operator!=(const BinaryHttpMessage::Field& rhs) const { return !(*this == rhs); }
    ...
    const std::vector<Field>& GetHeaderFields() const { return header_fields_.fields(); }
...
protected:
    ...
    public:
        ...
        const std::vector<BinaryHttpMessage::Field>& fields() const { return fields_; }

        bool operator==(const BinaryHttpMessage::Fields& rhs) const { return fields_ == rhs.fields_; }
...
public:
    ...
    struct ControlData {
        ...
        std::string path;
        bool operator==(const BinaryHttpRequest::ControlData& rhs) const { return method == rhs.method && scheme == rhs.scheme && authority == rhs.authority && path == rhs.path; }
        bool operator!=(const BinaryHttpRequest::ControlData& rhs) const { return !(*this == rhs); }
    };
    ...
    bool operator==(const BinaryHttpRequest& rhs) const { return control_data_ == rhs.control_data_ && BinaryHttpMessage::operator==(rhs); }

    bool operator!=(const BinaryHttpRequest& rhs) const { return !(*this == rhs); }
...
public:
    ...
    public:
        ...
        bool operator==(const BinaryHttpResponse::InformationalResponse& rhs) const { return status_code_ == rhs.status_code_ && fields_ == rhs.fields_; }

        bool operator!=(const BinaryHttpResponse::InformationalResponse& rhs) const { return !(*this == rhs); }
        ...
        const std::vector<BinaryHttpMessage::Field>& fields() const { return fields_.fields(); }
    ...
    const std::vector<InformationalResponse>& informational_responses() const { return informational_response_control_data_; }

    virtual std::string DebugString() const override;

    bool operator==(const BinaryHttpResponse& rhs) const
    {
        return informational_response_control_data_ == rhs.informational_response_control_data_ && status_code_ == rhs.status_code_ && BinaryHttpMessage::operator==(rhs);
    }
    bool operator!=(const BinaryHttpResponse& rhs) const { return !(*this == rhs); }
