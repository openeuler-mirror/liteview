...
inline void QuicheRunSystemEventLoopIterationImpl() { base::RunLoop().RunUntilIdle(); }

class QuicheSystemEventLoopImpl {
public:
    explicit QuicheSystemEventLoopImpl(std::string context_name) { base::ThreadPoolInstance::CreateAndStartWithDefaultParams(context_name); }
