...
inline std::string QuicheStackTraceImpl() { return base::debug::StackTrace().ToString(); }

inline bool QuicheShouldRunStackTraceTestImpl() { return base::debug::StackTrace::WillSymbolizeToStreamForTesting(); }
