...
TEST_F(SSLClientSessionCacheTest, FlushForServer)
{
    ...
    key2.network_anonymization_key = NetworkAnonymizationKey(kSiteB, kSiteB, /*is_cross_site=*/false);
    ...
    key5.network_anonymization_key = NetworkAnonymizationKey(kSiteA, kSiteA, /*is_cross_site=*/false);
