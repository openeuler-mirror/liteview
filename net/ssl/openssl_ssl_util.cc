...
int OpenSSLNetErrorLib() { return g_openssl_net_error_lib.Get().net_error_lib(); }
...
base::Value NetLogOpenSSLErrorParams(int net_error, int ssl_error, const OpenSSLErrorInfo& error_info)
{
