...
public:
    ...
    void OpenFile(const base::FilePath& path) { task_runner_->PostTask(FROM_HERE, base::BindOnce(&Core::OpenFileImpl, this, path)); }
...
void SSLKeyLoggerImpl::WriteLine(const std::string& line) { core_->WriteLine(line); }
