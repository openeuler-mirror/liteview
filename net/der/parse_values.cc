...
bool ParseBool(const Input& in, bool* out) { return ParseBoolInternal(in, out, false /* relaxed */); }
...
// parse.
bool ParseBoolRelaxed(const Input& in, bool* out) { return ParseBoolInternal(in, out, true /* relaxed */); }
...
bool GeneralizedTime::InUTCTimeRange() const { return 1950 <= year && year < 2050; }
...
bool operator>(const GeneralizedTime& lhs, const GeneralizedTime& rhs) { return rhs < lhs; }

bool operator<=(const GeneralizedTime& lhs, const GeneralizedTime& rhs) { return !(lhs > rhs); }
