...
WebSocketEndpointLockManager::~WebSocketEndpointLockManager() { DCHECK_EQ(lock_info_map_.size(), pending_unlock_count_); }
...
bool WebSocketEndpointLockManager::IsEmpty() const { return lock_info_map_.empty(); }
...
WebSocketEndpointLockManager::LockInfo::~LockInfo() { DCHECK(!lock_releaser); }
