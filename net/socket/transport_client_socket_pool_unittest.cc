...
public:
    explicit SOCKS5MockData(IoMode mode)
    {
        ...
        data_ = std::make_unique<StaticSocketDataProvider>(base::make_span(reads_.get(), 2), base::make_span(writes_.get(), 2));
    }
...
protected:
    ...
    explicit TransportClientSocketPoolTest(base::test::TaskEnvironment::TimeSource time_source = base::test::TaskEnvironment::TimeSource::DEFAULT)
        ...
        , group_id_(url::SchemeHostPort(url::kHttpScheme, "www.google.com", 80), PrivacyMode::PRIVACY_MODE_DISABLED, NetworkAnonymizationKey(), SecureDnsPolicy::kAllow)
        ...
        , client_socket_factory_(NetLog::Get())
    {
        ...
        pool_ = std::make_unique<TransportClientSocketPool>(
            kMaxSockets, kMaxSocketsPerGroup, kUnusedIdleSocketTimeout, ProxyServer::Direct(), false /* is_for_websockets */, common_connect_job_params_.get());
        ...
        tagging_pool_ = std::make_unique<TransportClientSocketPool>(
            kMaxSockets, kMaxSocketsPerGroup, kUnusedIdleSocketTimeout, ProxyServer::Direct(), false /* is_for_websockets */, tagging_common_connect_job_params_.get());
        ...
        pool_for_real_sockets_ = std::make_unique<TransportClientSocketPool>(
            kMaxSockets, kMaxSocketsPerGroup, kUnusedIdleSocketTimeout, ProxyServer::Direct(), false /* is_for_websockets */, common_connect_job_params_for_real_sockets_.get());
    }

    ~TransportClientSocketPoolTest() override { TransportClientSocketPool::set_connect_backup_jobs_enabled(connect_backup_jobs_enabled_); }

    int StartRequest(const std::string& host_name, RequestPriority priority)
    {
        ClientSocketPool::GroupId group_id(
            url::SchemeHostPort(url::kHttpScheme, host_name, 80), PrivacyMode::PRIVACY_MODE_DISABLED, NetworkAnonymizationKey(), SecureDnsPolicy::kAllow);
    ...
    int GetOrderOfRequest(size_t index) { return test_base_.GetOrderOfRequest(index); }
...
TEST_F(TransportClientSocketPoolTest, Basic)
{
    ...
    int rv = handle.Init(group_id_, params_, absl::nullopt /* proxy_annotation_tag */, LOW, SocketTag(), ClientSocketPool::RespectLimits::ENABLED, callback.callback(),
...
TEST_F(TransportClientSocketPoolTest, SetResolvePriorityOnInit)
{
    for (int i = MINIMUM_PRIORITY; i <= MAXIMUM_PRIORITY; ++i) {
        ...
        EXPECT_EQ(ERR_IO_PENDING,
            handle.Init(group_id_, params_, absl::nullopt /* proxy_annotation_tag */, priority, SocketTag(), ClientSocketPool::RespectLimits::ENABLED, callback.callback(),
                ClientSocketPool::ProxyAuthCallback(), pool_.get(), NetLogWithSource()));
...
TEST_F(TransportClientSocketPoolTest, SetSecureDnsPolicy)
{
    for (auto secure_dns_policy : { SecureDnsPolicy::kAllow, SecureDnsPolicy::kDisable }) {
        ...
        ClientSocketHandle handle;
        ClientSocketPool::GroupId group_id(
            url::SchemeHostPort(url::kHttpScheme, "www.google.com", 80), PrivacyMode::PRIVACY_MODE_DISABLED, NetworkAnonymizationKey(), secure_dns_policy);
        EXPECT_EQ(ERR_IO_PENDING,
            handle.Init(group_id, params_, absl::nullopt /* proxy_annotation_tag */, LOW, SocketTag(), ClientSocketPool::RespectLimits::ENABLED, callback.callback(),
                ClientSocketPool::ProxyAuthCallback(), pool_.get(), NetLogWithSource()));
...
TEST_F(TransportClientSocketPoolTest, ReprioritizeRequests)
{
    ...
    int rv1 = handle1.Init(group_id_, params_, absl::nullopt /* proxy_annotation_tag */, LOW, SocketTag(), ClientSocketPool::RespectLimits::ENABLED, callback1.callback(),
        ClientSocketPool::ProxyAuthCallback(), pool_.get(), NetLogWithSource());
    EXPECT_THAT(rv1, IsError(ERR_IO_PENDING));

    TestCompletionCallback callback2;
    ClientSocketHandle handle2;
    int rv2 = handle2.Init(group_id_, params_, absl::nullopt /* proxy_annotation_tag */, HIGHEST, SocketTag(), ClientSocketPool::RespectLimits::ENABLED, callback2.callback(),
        ClientSocketPool::ProxyAuthCallback(), pool_.get(), NetLogWithSource());
    EXPECT_THAT(rv2, IsError(ERR_IO_PENDING));

    TestCompletionCallback callback3;
    ClientSocketHandle handle3;
    int rv3 = handle3.Init(group_id_, params_, absl::nullopt /* proxy_annotation_tag */, LOWEST, SocketTag(), ClientSocketPool::RespectLimits::ENABLED, callback3.callback(),
        ClientSocketPool::ProxyAuthCallback(), pool_.get(), NetLogWithSource());
    EXPECT_THAT(rv3, IsError(ERR_IO_PENDING));

    TestCompletionCallback callback4;
    ClientSocketHandle handle4;
    int rv4 = handle4.Init(group_id_, params_, absl::nullopt /* proxy_annotation_tag */, MEDIUM, SocketTag(), ClientSocketPool::RespectLimits::ENABLED, callback4.callback(),
        ClientSocketPool::ProxyAuthCallback(), pool_.get(), NetLogWithSource());
    EXPECT_THAT(rv4, IsError(ERR_IO_PENDING));

    TestCompletionCallback callback5;
    ClientSocketHandle handle5;
    int rv5 = handle5.Init(group_id_, params_, absl::nullopt /* proxy_annotation_tag */, HIGHEST, SocketTag(), ClientSocketPool::RespectLimits::ENABLED, callback5.callback(),
        ClientSocketPool::ProxyAuthCallback(), pool_.get(), NetLogWithSource());
    EXPECT_THAT(rv5, IsError(ERR_IO_PENDING));

    TestCompletionCallback callback6;
    ClientSocketHandle handle6;
    int rv6 = handle6.Init(group_id_, params_, absl::nullopt /* proxy_annotation_tag */, LOW, SocketTag(), ClientSocketPool::RespectLimits::ENABLED, callback6.callback(),
        ClientSocketPool::ProxyAuthCallback(), pool_.get(), NetLogWithSource());
    ...
    int rv7 = handle7.Init(group_id_, params_, absl::nullopt /* proxy_annotation_tag */, HIGHEST, SocketTag(), ClientSocketPool::RespectLimits::ENABLED, callback7.callback(),
        ClientSocketPool::ProxyAuthCallback(), pool_.get(), NetLogWithSource());
    ...
    int rv8 = handle8.Init(group_id_, params_, absl::nullopt /* proxy_annotation_tag */, HIGHEST, SocketTag(), ClientSocketPool::RespectLimits::ENABLED, callback8.callback(),
        ClientSocketPool::ProxyAuthCallback(), pool_.get(), NetLogWithSource());
...
{
    TransportClientSocketPool pool(kMaxSockets, 1, kUnusedIdleSocketTimeout, ProxyServer::Direct(), false /* is_for_websockets */, common_connect_job_params_.get());

    // Creates a job which ignores limits whose priority is MAXIMUM_PRIORITY.
    TestCompletionCallback callback1;
    ClientSocketHandle handle1;
    int rv1 = handle1.Init(group_id_, params_, absl::nullopt /* proxy_annotation_tag */, MAXIMUM_PRIORITY, SocketTag(), ClientSocketPool::RespectLimits::DISABLED,
    ...
    TestCompletionCallback callback2;
    ClientSocketHandle handle2;
    int rv2 = handle2.Init(group_id_, params_, absl::nullopt /* proxy_annotation_tag */, LOW, SocketTag(), ClientSocketPool::RespectLimits::ENABLED, callback2.callback(),
...
TEST_F(TransportClientSocketPoolTest, InitHostResolutionFailure)
{
    ...
    ClientSocketHandle handle;
    EXPECT_EQ(ERR_IO_PENDING,
        handle.Init(group_id_, params_, absl::nullopt /* proxy_annotation_tag */, kDefaultPriority, SocketTag(), ClientSocketPool::RespectLimits::ENABLED, callback.callback(),
            ClientSocketPool::ProxyAuthCallback(), pool_.get(), NetLogWithSource()));
...
TEST_F(TransportClientSocketPoolTest, TwoRequestsCancelOne)
{
    ...
    EXPECT_EQ(ERR_IO_PENDING,
        handle.Init(group_id_, params_, absl::nullopt /* proxy_annotation_tag */, kDefaultPriority, SocketTag(), ClientSocketPool::RespectLimits::ENABLED, callback.callback(),
            ClientSocketPool::ProxyAuthCallback(), pool_.get(), NetLogWithSource()));
    EXPECT_EQ(ERR_IO_PENDING,
        handle2.Init(group_id_, params_, absl::nullopt /* proxy_annotation_tag */, kDefaultPriority, SocketTag(), ClientSocketPool::RespectLimits::ENABLED, callback2.callback(),
            ClientSocketPool::ProxyAuthCallback(), pool_.get(), NetLogWithSource()));
...
TEST_F(TransportClientSocketPoolTest, ConnectCancelConnect)
{
    ...
    TestCompletionCallback callback2;
    EXPECT_EQ(ERR_IO_PENDING,
        handle.Init(group_id_, params_, absl::nullopt /* proxy_annotation_tag */, kDefaultPriority, SocketTag(), ClientSocketPool::RespectLimits::ENABLED, callback2.callback(),
            ClientSocketPool::ProxyAuthCallback(), pool_.get(), NetLogWithSource()));
...
public:
    RequestSocketCallback(
        const ClientSocketPool::GroupId& group_id, scoped_refptr<ClientSocketPool::SocketParams> socket_params, ClientSocketHandle* handle, TransportClientSocketPool* pool)
        : group_id_(group_id)
    ...
    CompletionOnceCallback callback() { return base::BindOnce(&RequestSocketCallback::OnComplete, base::Unretained(this)); }
...
private:
    void OnComplete(int result)
    {
        ...
        if (!within_callback_) {
            ...
            int rv = handle_->Init(group_id_, socket_params_, absl::nullopt /* proxy_annotation_tag */, LOWEST, SocketTag(), ClientSocketPool::RespectLimits::ENABLED, callback(),
...
TEST_F(TransportClientSocketPoolTest, RequestTwice)
{
    ...
    int rv = handle.Init(group_id_, params_, absl::nullopt /* proxy_annotation_tag */, LOWEST, SocketTag(), ClientSocketPool::RespectLimits::ENABLED, callback.callback(),
        ClientSocketPool::ProxyAuthCallback(), pool_.get(), NetLogWithSource());
...
TEST_F(TransportClientSocketPoolTest, IdleSocketLoadTiming)
{
    ...
    rv = handle.Init(group_id_, params_, absl::nullopt /* proxy_annotation_tag */, LOW, SocketTag(), ClientSocketPool::RespectLimits::ENABLED, callback.callback(),
        ClientSocketPool::ProxyAuthCallback(), pool_.get(), NetLogWithSource());
    EXPECT_THAT(rv, IsOk());
...
TEST(TransportClientSocketPoolStandaloneTest, DontCleanupOnIPAddressChange)
{
    ...
    auto pool = std::make_unique<TransportClientSocketPool>(kMaxSockets, kMaxSocketsPerGroup, kUnusedIdleSocketTimeout, ProxyServer::Direct(), false /* is_for_websockets */,
        common_connect_job_params.get(), false /* cleanup_on_ip_address_change */);
    ...
    TestCompletionCallback callback;
    ClientSocketHandle handle;
    int rv = handle.Init(group_id, params, absl::nullopt /* proxy_annotation_tag */, LOW, SocketTag(), ClientSocketPool::RespectLimits::ENABLED, callback.callback(),
...
TEST_F(TransportClientSocketPoolTest, SSLCertError)
{
    ...
    ClientSocketHandle handle;
    TestCompletionCallback callback;
    int rv = handle.Init(ClientSocketPool::GroupId(kEndpoint, PrivacyMode::PRIVACY_MODE_DISABLED, NetworkAnonymizationKey(), SecureDnsPolicy::kAllow), socket_params,
        absl::nullopt /* proxy_annotation_tag */, MEDIUM, SocketTag(), ClientSocketPool::RespectLimits::ENABLED, callback.callback(), ClientSocketPool::ProxyAuthCallback(),
...
TEST_F(TransportClientSocketPoolTest, SOCKS)
{
    ...
    TransportClientSocketPool proxy_pool(kMaxSockets, kMaxSocketsPerGroup, kUnusedIdleSocketTimeout,
        ProxyUriToProxyServer("socks5://foopy", ProxyServer::SCHEME_HTTP /* default_scheme */), false /* is_for_websockets */, tagging_common_connect_job_params_.get());

    for (IoMode socket_io_mode : { SYNCHRONOUS, ASYNC }) {
        scoped_refptr<ClientSocketPool::SocketParams> socket_params
            = base::MakeRefCounted<ClientSocketPool::SocketParams>(nullptr /* ssl_config_for_origin */, nullptr /* ssl_config_for_proxy */);
        ...
        ClientSocketHandle handle;
        TestCompletionCallback callback;
        int rv = handle.Init(ClientSocketPool::GroupId(kDestination, PrivacyMode::PRIVACY_MODE_DISABLED, NetworkAnonymizationKey(), SecureDnsPolicy::kAllow), socket_params,
            TRAFFIC_ANNOTATION_FOR_TESTS, LOW, SocketTag(), ClientSocketPool::RespectLimits::ENABLED, callback.callback(), ClientSocketPool::ProxyAuthCallback(), &proxy_pool,
            NetLogWithSource());
...
TEST_F(TransportClientSocketPoolTest, SpdyOneConnectJobTwoRequestsError)
{
    ...
    TransportClientSocketPool pool(1, 1, kUnusedIdleSocketTimeout, ProxyUriToProxyServer("https://unresolvable.proxy.name", ProxyServer::SCHEME_HTTP /* default_scheme */),
    ...
    spdy::SpdySerializedFrame connect(spdy_util.ConstructSpdyConnect(nullptr, 0, 1, HttpProxyConnectJob::kH2QuicTunnelPriority, HostPortPair::FromSchemeHostPort(kEndpoint)));
    ...
    scoped_refptr<ClientSocketPool::SocketParams> socket_params
        = base::MakeRefCounted<ClientSocketPool::SocketParams>(std::make_unique<SSLConfig>() /* ssl_config_for_origin */, std::make_unique<SSLConfig>() /* ssl_config_for_proxy */);

    ClientSocketPool::GroupId group_id(kEndpoint, PrivacyMode::PRIVACY_MODE_DISABLED, NetworkAnonymizationKey(), SecureDnsPolicy::kAllow);

    // Start the first connection attempt.
    TestCompletionCallback callback1;
    ClientSocketHandle handle1;
    int rv1 = handle1.Init(group_id, socket_params, TRAFFIC_ANNOTATION_FOR_TESTS, HIGHEST, SocketTag(), ClientSocketPool::RespectLimits::ENABLED, callback1.callback(),
        ClientSocketPool::ProxyAuthCallback(), &pool, NetLogWithSource());
    ...
    TestCompletionCallback callback2;
    ClientSocketHandle handle2;
    int rv2 = handle2.Init(group_id, socket_params, TRAFFIC_ANNOTATION_FOR_TESTS, LOWEST, SocketTag(), ClientSocketPool::RespectLimits::ENABLED, callback2.callback(),
        ClientSocketPool::ProxyAuthCallback(), &pool, NetLogWithSource());
...
TEST_F(TransportClientSocketPoolTest, SpdyAuthOneConnectJobTwoRequests)
{
    ...
    int rv1 = handle1.Init(group_id, socket_params, TRAFFIC_ANNOTATION_FOR_TESTS, HIGHEST, SocketTag(), ClientSocketPool::RespectLimits::ENABLED, callback1.callback(),
        base::BindLambdaForTesting([&](const HttpResponseInfo& response, HttpAuthController* auth_controller, base::OnceClosure restart_with_auth_callback) { run_loop.Quit(); }),
...
TEST_F(TransportClientSocketPoolTest, HttpTunnelSetupRedirect)
{
    ...
    for (IoMode io_mode : { SYNCHRONOUS, ASYNC }) {
        ...
        for (bool use_https_proxy : { false, true }) {
            ...
            TransportClientSocketPool proxy_pool(kMaxSockets, kMaxSocketsPerGroup, kUnusedIdleSocketTimeout,
                ProxyUriToProxyServer(use_https_proxy ? "https://proxy.test" : "http://proxy.test", ProxyServer::SCHEME_HTTP /* default_scheme */), false /* is_for_websockets */,
            ...
            scoped_refptr<ClientSocketPool::SocketParams> socket_params = base::MakeRefCounted<ClientSocketPool::SocketParams>(
                std::make_unique<SSLConfig>() /* ssl_config_for_origin */, std::make_unique<SSLConfig>() /* ssl_config_for_proxy */);
...
TEST_F(TransportClientSocketPoolTest, NetworkAnonymizationKey)
{
    ...
    TransportClientSocketPool::GroupId group_id(
        url::SchemeHostPort(url::kHttpScheme, kHost, 80), PrivacyMode::PRIVACY_MODE_DISABLED, kNetworkAnonymizationKey, SecureDnsPolicy::kAllow);
    ClientSocketHandle handle;
    TestCompletionCallback callback;
    EXPECT_THAT(handle.Init(group_id, base::MakeRefCounted<ClientSocketPool::SocketParams>(nullptr /* ssl_config_for_origin */, nullptr /* ssl_config_for_proxy */),
                    TRAFFIC_ANNOTATION_FOR_TESTS, LOW, SocketTag(), ClientSocketPool::RespectLimits::ENABLED, callback.callback(), ClientSocketPool::ProxyAuthCallback(),
...
TEST_F(TransportClientSocketPoolTest, NetworkIsolationKeySsl)
{
    ...
    TransportClientSocketPool::GroupId group_id(
        url::SchemeHostPort(url::kHttpsScheme, kHost, 443), PrivacyMode::PRIVACY_MODE_DISABLED, kNetworkAnonymizationKey, SecureDnsPolicy::kAllow);
    auto ssl_config_for_origin = std::make_unique<SSLConfig>();
    ssl_config_for_origin->alpn_protos = { kProtoHTTP2, kProtoHTTP11 };
    ClientSocketHandle handle;
    TestCompletionCallback callback;
    EXPECT_THAT(handle.Init(group_id,
                    base::MakeRefCounted<ClientSocketPool::SocketParams>(std::move(ssl_config_for_origin),
                        /*ssl_config_for_proxy=*/nullptr),
                    TRAFFIC_ANNOTATION_FOR_TESTS, LOW, SocketTag(), ClientSocketPool::RespectLimits::ENABLED, callback.callback(), ClientSocketPool::ProxyAuthCallback(),
                    pool_.get(), NetLogWithSource()),
        IsError(ERR_IO_PENDING));
...
TEST_F(TransportClientSocketPoolTest, NetworkIsolationKeyHttpProxy)
{
    ...
    const NetworkAnonymizationKey kNetworkAnonymizationKey1(kSite1, kSite1, /*is_cross_site=*/false);
    const SchemefulSite kSite2(GURL("https://bar.test/"));
    const NetworkAnonymizationKey kNetworkAnonymizationKey2(kSite2, kSite2, /*is_cross_site=*/false);
    const char kHost[] = "bar.test";
    const ProxyServer kProxyServer = ProxyUriToProxyServer("http://proxy.test", ProxyServer::SCHEME_HTTP /* default_scheme */);
    ...
    TransportClientSocketPool proxy_pool(
        kMaxSockets, kMaxSocketsPerGroup, kUnusedIdleSocketTimeout, kProxyServer, false /* is_for_websockets */, tagging_common_connect_job_params_.get());

    TransportClientSocketPool::GroupId group_id1(
        url::SchemeHostPort(url::kHttpScheme, kHost, 80), PrivacyMode::PRIVACY_MODE_DISABLED, kNetworkAnonymizationKey1, SecureDnsPolicy::kAllow);
    ClientSocketHandle handle1;
    TestCompletionCallback callback1;
    EXPECT_THAT(handle1.Init(group_id1, base::MakeRefCounted<ClientSocketPool::SocketParams>(nullptr /* ssl_config_for_origin */, nullptr /* ssl_config_for_proxy */),
                    TRAFFIC_ANNOTATION_FOR_TESTS, LOW, SocketTag(), ClientSocketPool::RespectLimits::ENABLED, callback1.callback(), ClientSocketPool::ProxyAuthCallback(),
                    &proxy_pool, NetLogWithSource()),
        IsError(ERR_IO_PENDING));

    TransportClientSocketPool::GroupId group_id2(
        url::SchemeHostPort(url::kHttpScheme, kHost, 80), PrivacyMode::PRIVACY_MODE_DISABLED, kNetworkAnonymizationKey2, SecureDnsPolicy::kAllow);
    ClientSocketHandle handle2;
    TestCompletionCallback callback2;
    EXPECT_THAT(handle2.Init(group_id2, base::MakeRefCounted<ClientSocketPool::SocketParams>(nullptr /* ssl_config_for_origin */, nullptr /* ssl_config_for_proxy */),
                    TRAFFIC_ANNOTATION_FOR_TESTS, LOW, SocketTag(), ClientSocketPool::RespectLimits::ENABLED, callback1.callback(), ClientSocketPool::ProxyAuthCallback(),
                    &proxy_pool, NetLogWithSource()),
        IsError(ERR_IO_PENDING));

    ASSERT_EQ(2u, session_deps_.host_resolver->last_id());
    EXPECT_EQ(kProxyServer.host_port_pair().host(), session_deps_.host_resolver->request_host(1));
    EXPECT_EQ(kProxyServer.host_port_pair().host(), session_deps_.host_resolver->request_host(2));
...
TEST_F(TransportClientSocketPoolTest, NetworkIsolationKeyHttpsProxy)
{
    ...
    const NetworkAnonymizationKey kNetworkAnonymizationKey2(kSite2, kSite2, /*is_cross_site=*/false);
    const char kHost[] = "bar.test";
    const ProxyServer kProxyServer = ProxyUriToProxyServer("https://proxy.test", ProxyServer::SCHEME_HTTP /* default_scheme */);
    ...
    TestCompletionCallback callback1;
    EXPECT_THAT(
        handle1.Init(group_id1, base::MakeRefCounted<ClientSocketPool::SocketParams>(nullptr /* ssl_config_for_origin */, std::make_unique<SSLConfig>() /* ssl_config_for_proxy */),
            TRAFFIC_ANNOTATION_FOR_TESTS, LOW, SocketTag(), ClientSocketPool::RespectLimits::ENABLED, callback1.callback(), ClientSocketPool::ProxyAuthCallback(), &proxy_pool,
            NetLogWithSource()),
        IsError(ERR_IO_PENDING));
    ...
    TestCompletionCallback callback2;
    EXPECT_THAT(
        handle2.Init(group_id2, base::MakeRefCounted<ClientSocketPool::SocketParams>(nullptr /* ssl_config_for_origin */, std::make_unique<SSLConfig>() /* ssl_config_for_proxy */),
            TRAFFIC_ANNOTATION_FOR_TESTS, LOW, SocketTag(), ClientSocketPool::RespectLimits::ENABLED, callback2.callback(), ClientSocketPool::ProxyAuthCallback(), &proxy_pool,
            NetLogWithSource()),
        IsError(ERR_IO_PENDING));
...
TEST_F(TransportClientSocketPoolTest, NetworkIsolationKeySocks4Proxy)
{
    ...
    const NetworkAnonymizationKey kNetworkAnonymizationKey2(kSite2, kSite2, /*is_cross_site=*/false);
    const char kHost[] = "bar.test";
    const ProxyServer kProxyServer = ProxyUriToProxyServer("socks4://proxy.test", ProxyServer::SCHEME_HTTP /* default_scheme */);
    ...
    TestCompletionCallback callback2;
    EXPECT_THAT(handle2.Init(group_id2, base::MakeRefCounted<ClientSocketPool::SocketParams>(nullptr /* ssl_config_for_origin */, nullptr /* ssl_config_for_proxy */),
                    TRAFFIC_ANNOTATION_FOR_TESTS, LOW, SocketTag(), ClientSocketPool::RespectLimits::ENABLED, callback2.callback(), ClientSocketPool::ProxyAuthCallback(),
                    &proxy_pool, NetLogWithSource()),
        IsError(ERR_IO_PENDING));
...
TEST_F(TransportClientSocketPoolTest, NetworkIsolationKeySocks5Proxy)
{
    ...
    const NetworkAnonymizationKey kNetworkAnonymizationKey2(kSite2, kSite2, /*is_cross_site=*/false);
    const char kHost[] = "bar.test";
    const ProxyServer kProxyServer = ProxyUriToProxyServer("socks5://proxy.test", ProxyServer::SCHEME_HTTP /* default_scheme */);
...
TEST_F(TransportClientSocketPoolTest, HasActiveSocket)
{
    ...
    ClientSocketHandle handle;
    ClientSocketPool::GroupId group_id1(kEndpoint1, PrivacyMode::PRIVACY_MODE_DISABLED, NetworkAnonymizationKey(), SecureDnsPolicy::kAllow);
    ClientSocketPool::GroupId group_id2(kEndpoint2, PrivacyMode::PRIVACY_MODE_DISABLED, NetworkAnonymizationKey(), SecureDnsPolicy::kAllow);

    // HasActiveSocket() must return false before creating a socket.
    EXPECT_FALSE(pool_->HasActiveSocket(group_id1));

    TestCompletionCallback callback1;
    int rv1 = handle.Init(group_id1, params_, absl::nullopt /* proxy_annotation_tag */, LOW, SocketTag(), ClientSocketPool::RespectLimits::ENABLED, callback1.callback(),
        ClientSocketPool::ProxyAuthCallback(), pool_.get(), NetLogWithSource());
    EXPECT_THAT(rv1, IsError(ERR_IO_PENDING));
    ...
    TestCompletionCallback callback2;
    int rv2 = handle.Init(group_id2, params_, absl::nullopt /* proxy_annotation_tag */, LOW, SocketTag(), ClientSocketPool::RespectLimits::ENABLED, callback2.callback(),
        ClientSocketPool::ProxyAuthCallback(), pool_.get(), NetLogWithSource());
    EXPECT_THAT(rv2, IsError(ERR_IO_PENDING));
...
TEST_F(TransportClientSocketPoolTest, Tag)
{
    ...
    const ClientSocketPool::GroupId kGroupId(url::SchemeHostPort(test_server.base_url()), PrivacyMode::PRIVACY_MODE_DISABLED, NetworkAnonymizationKey(), SecureDnsPolicy::kAllow);
    scoped_refptr<ClientSocketPool::SocketParams> params = ClientSocketPool::SocketParams::CreateForHttpForTesting();
    TestCompletionCallback callback;
    int rv = handle.Init(kGroupId, params, absl::nullopt /* proxy_annotation_tag */, LOW, tag1, ClientSocketPool::RespectLimits::ENABLED, callback.callback(),
    ...
    rv = handle.Init(kGroupId, params, absl::nullopt /* proxy_annotation_tag */, LOW, tag2, ClientSocketPool::RespectLimits::ENABLED, callback.callback(),
        ClientSocketPool::ProxyAuthCallback(), pool_for_real_sockets_.get(), NetLogWithSource());
    EXPECT_THAT(rv, IsOk());
    EXPECT_TRUE(handle.socket());
    EXPECT_TRUE(handle.socket()->IsConnected());
    ...
    TestCompletionCallback callback2;
    rv = handle.Init(kGroupId, params, absl::nullopt /* proxy_annotation_tag */, LOW, tag1, ClientSocketPool::RespectLimits::ENABLED, callback2.callback(),
        ClientSocketPool::ProxyAuthCallback(), pool_for_real_sockets_.get(), NetLogWithSource());
    ...
    rv = handle.Init(kGroupId, params, absl::nullopt /* proxy_annotation_tag */, LOW, tag1, ClientSocketPool::RespectLimits::ENABLED, callback.callback(),
        ClientSocketPool::ProxyAuthCallback(), pool_for_real_sockets_.get(), NetLogWithSource());
    EXPECT_THAT(rv, IsOk());
    // Disconnect socket to prevent reuse.
    handle.socket()->Disconnect();
    ...
    rv = handle.Init(kGroupId, params, absl::nullopt /* proxy_annotation_tag */, LOW, tag1, ClientSocketPool::RespectLimits::ENABLED, callback.callback(),
        ClientSocketPool::ProxyAuthCallback(), pool_for_real_sockets_.get(), NetLogWithSource());
    EXPECT_TRUE(rv == OK || rv == ERR_IO_PENDING) << "Result: " << rv;
    int rv_high_pri = handle_high_pri.Init(kGroupId, params, absl::nullopt /* proxy_annotation_tag */, HIGHEST, tag2, ClientSocketPool::RespectLimits::ENABLED,
...
TEST_F(TransportClientSocketPoolTest, TagSOCKSProxy)
{
    ...
    TransportClientSocketPool proxy_pool(kMaxSockets, kMaxSocketsPerGroup, kUnusedIdleSocketTimeout,
        ProxyUriToProxyServer("socks5://proxy", ProxyServer::SCHEME_HTTP /* default_scheme */), false /* is_for_websockets */, tagging_common_connect_job_params_.get());
...
TEST_F(TransportClientSocketPoolTest, TagSSLDirect)
{
    ...
    // Test socket is tagged before connected.
    uint64_t old_traffic = GetTaggedBytes(tag_val1);
    int rv = handle.Init(kGroupId, socket_params, absl::nullopt /* proxy_annotation_tag */, LOW, tag1, ClientSocketPool::RespectLimits::ENABLED, callback.callback(),
        ClientSocketPool::ProxyAuthCallback(), pool_for_real_sockets_.get(), NetLogWithSource());
    EXPECT_THAT(callback.GetResult(rv), IsOk());
    EXPECT_TRUE(handle.socket());
    EXPECT_TRUE(handle.socket()->IsConnected());
    ...
    old_traffic = GetTaggedBytes(tag_val2);
    TestCompletionCallback callback2;
    rv = handle.Init(kGroupId, socket_params, absl::nullopt /* proxy_annotation_tag */, LOW, tag2, ClientSocketPool::RespectLimits::ENABLED, callback2.callback(),
        ClientSocketPool::ProxyAuthCallback(), pool_for_real_sockets_.get(), NetLogWithSource());
    EXPECT_THAT(rv, IsOk());
    EXPECT_TRUE(handle.socket());
    EXPECT_TRUE(handle.socket()->IsConnected());
...
TEST_F(TransportClientSocketPoolTest, TagSSLDirectTwoSocketsFullPool)
{
    ...
    for (auto& tcp_handle : tcp_handles) {
        rv = tcp_handle.Init(kGroupId, socket_params, absl::nullopt /* proxy_annotation_tag */, LOW, tag1, ClientSocketPool::RespectLimits::ENABLED, callback.callback(),
            ClientSocketPool::ProxyAuthCallback(), pool_for_real_sockets_.get(), NetLogWithSource());
        EXPECT_THAT(callback.GetResult(rv), IsOk());
    ...
    rv = handle_to_be_canceled.Init(kGroupId, socket_params, absl::nullopt /* proxy_annotation_tag */, LOW, tag1, ClientSocketPool::RespectLimits::ENABLED, callback.callback(),
        ClientSocketPool::ProxyAuthCallback(), pool_for_real_sockets_.get(), NetLogWithSource());
    EXPECT_THAT(rv, IsError(ERR_IO_PENDING));
    rv = handle.Init(kGroupId, socket_params, absl::nullopt /* proxy_annotation_tag */, LOW, tag2, ClientSocketPool::RespectLimits::ENABLED, callback.callback(),
        ClientSocketPool::ProxyAuthCallback(), pool_for_real_sockets_.get(), NetLogWithSource());
    EXPECT_THAT(rv, IsError(ERR_IO_PENDING));
...
TEST_F(TransportClientSocketPoolTest, TagHttpProxyNoTunnel)
{
    ...
    TransportClientSocketPool proxy_pool(kMaxSockets, kMaxSocketsPerGroup, kUnusedIdleSocketTimeout,
        ProxyUriToProxyServer("http://proxy", ProxyServer::SCHEME_HTTP /* default_scheme */), false /* is_for_websockets */, tagging_common_connect_job_params_.get());
...
TEST_F(TransportClientSocketPoolMockNowSourceTest, IdleUnusedSocketTimeout)
{
    ...
    for (const auto& test : kTests) {
        ...
        SequencedSocketData provider_socket_1(MockConnect(ASYNC, OK), base::span<MockRead>(), kWrites);
        {
            ...
            TestCompletionCallback callback;
            int rv = connection.Init(ClientSocketPool::GroupId(kSchemeHostPort1, PrivacyMode::PRIVACY_MODE_DISABLED, NetworkAnonymizationKey(), SecureDnsPolicy::kAllow),
                ClientSocketPool::SocketParams::CreateForHttpForTesting(), absl::nullopt /* proxy_annotation_tag */, MEDIUM, SocketTag(), ClientSocketPool::RespectLimits::ENABLED,
                callback.callback(), ClientSocketPool::ProxyAuthCallback(), session->GetSocketPool(HttpNetworkSession::NORMAL_SOCKET_POOL, ProxyServer::Direct()),
                NetLogWithSource());
            EXPECT_THAT(callback.GetResult(rv), IsOk());
        ...
        EXPECT_EQ(1, session->GetSocketPool(HttpNetworkSession::NORMAL_SOCKET_POOL, ProxyServer::Direct())->IdleSocketCount());
...

        {
            ...
            ClientSocketHandle connection;
            TestCompletionCallback callback;
            int rv = connection.Init(ClientSocketPool::GroupId(kSchemeHostPort2, PrivacyMode::PRIVACY_MODE_DISABLED, NetworkAnonymizationKey(), SecureDnsPolicy::kAllow),
                socket_params, absl::nullopt /* proxy_annotation_tag */, MEDIUM, SocketTag(), ClientSocketPool::RespectLimits::ENABLED, callback.callback(),
                ClientSocketPool::ProxyAuthCallback(), session->GetSocketPool(HttpNetworkSession::NORMAL_SOCKET_POOL, ProxyServer::Direct()), NetLogWithSource());
            EXPECT_THAT(callback.GetResult(rv), IsOk());
            connection.socket()->Disconnect();
        }

        EXPECT_EQ(test.expect_idle_socket ? 1 : 0, session->GetSocketPool(HttpNetworkSession::NORMAL_SOCKET_POOL, ProxyServer::Direct())->IdleSocketCount());
    }
}
