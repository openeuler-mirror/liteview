...
public:
    ...
    void set_fuzz_connect_result(bool fuzz_connect_result) { fuzz_connect_result_ = fuzz_connect_result; }

    // Sets the remote address the socket claims to be using.
    void set_remote_address(const IPEndPoint& remote_address) { remote_address_ = remote_address; }
