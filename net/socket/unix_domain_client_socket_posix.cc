...
bool UnixDomainClientSocket::IsConnected() const { return socket_ && socket_->IsConnected(); }
...
const NetLogWithSource& UnixDomainClientSocket::NetLog() const { return net_log_; }
...
bool UnixDomainClientSocket::WasAlpnNegotiated() const { return false; }

NextProto UnixDomainClientSocket::GetNegotiatedProtocol() const { return kProtoUnknown; }

bool UnixDomainClientSocket::GetSSLInfo(SSLInfo* ssl_info) { return false; }
