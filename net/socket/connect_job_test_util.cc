...
void TestConnectJobDelegate::OnNeedsProxyAuth(const HttpResponseInfo& response, HttpAuthController* auth_controller, base::OnceClosure restart_with_auth_callback, ConnectJob* job)
{
...
std::unique_ptr<StreamSocket> TestConnectJobDelegate::ReleaseSocket() { return std::move(socket_); }
