...
int Socket::ReadIfReady(IOBuffer* buf, int buf_len, CompletionOnceCallback callback) { return ERR_READ_IF_READY_NOT_IMPLEMENTED; }
...
const std::set<std::string>& Socket::GetDnsAliases() const { return dns_aliases_; }
