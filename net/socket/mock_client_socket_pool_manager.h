...
public:
    ...
    void SetSocketPool(const ProxyServer& proxy_server, std::unique_ptr<ClientSocketPool> pool);
...
private:
    using ClientSocketPoolMap = std::map<ProxyServer, std::unique_ptr<ClientSocketPool>>;
