...
protected:
    void set_signed_cert_timestamps_received(bool signed_cert_timestamps_received) { signed_cert_timestamps_received_ = signed_cert_timestamps_received; }

    void set_stapled_ocsp_response_received(bool stapled_ocsp_response_received) { stapled_ocsp_response_received_ = stapled_ocsp_response_received; }
...
class NET_EXPORT SSLClientContext : public SSLConfigService::Observer, public CertDatabase::Observer {
public:
    ...
    SSLClientContext(SSLConfigService* ssl_config_service, CertVerifier* cert_verifier, TransportSecurityState* transport_security_state, CTPolicyEnforcer* ct_policy_enforcer,
    ...
    TransportSecurityState* transport_security_state() { return transport_security_state_; }
    CTPolicyEnforcer* ct_policy_enforcer() { return ct_policy_enforcer_; }
    SSLClientSessionCache* ssl_client_session_cache() { return ssl_client_session_cache_; }
    SCTAuditingDelegate* sct_auditing_delegate() { return sct_auditing_delegate_; }
    ...
    std::unique_ptr<SSLClientSocket> CreateSSLClientSocket(std::unique_ptr<StreamSocket> stream_socket, const HostPortPair& host_and_port, const SSLConfig& ssl_config);
