...
protected:
    WebSocketEndpointLockManagerTest() { websocket_endpoint_lock_manager_.SetUnlockDelayForTesting(base::TimeDelta()); }
    ...
    IPEndPoint DummyEndpoint() { return IPEndPoint(IPAddress::IPv4Localhost(), 80); }
