...
OwnedUDPSocketCount::OwnedUDPSocketCount(OwnedUDPSocketCount&& other) { *this = std::move(other); }
...
OwnedUDPSocketCount::~OwnedUDPSocketCount() { Reset(); }
...
int GetGlobalUDPSocketCountForTesting() { return GlobalUDPSocketCounts::Get().GetCountForTesting(); }
