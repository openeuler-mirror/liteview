...
private:
    ...
    int ConvertChunkToFrame(std::unique_ptr<WebSocketFrameChunk> chunk, std::unique_ptr<WebSocketFrame>* frame);
    ...
    std::unique_ptr<WebSocketFrame> CreateFrame(bool is_final_chunk, base::span<const char> data);
