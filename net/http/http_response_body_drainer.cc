...
int HttpResponseBodyDrainer::DoDrainResponseBody()
{
    ...
    return stream_->ReadResponseBody(read_buf_.get(), kDrainBodyBufferSize - total_read_, base::BindOnce(&HttpResponseBodyDrainer::OnIOComplete, base::Unretained(this)));
}
...
void HttpResponseBodyDrainer::OnTimerFired() { Finish(ERR_TIMED_OUT); }
