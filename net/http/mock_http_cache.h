...
public:
    ...
    net::Error ReadyForSparseIO(CompletionOnceCallback completion_callback) override;
...
public:
    ...
    net::Error DoomEntry(const std::string& key, net::RequestPriority request_priority, CompletionOnceCallback callback) override;
    ...
    void set_soft_failures_one_instance(int value) { soft_failures_one_instance_ = value; }
    ...
    void set_support_in_memory_entry_data(bool value) { support_in_memory_entry_data_ = value; }
    ...
    void set_force_fail_callback_later(bool value) { force_fail_callback_later_ = value; }
...
public:
    ...
    MockNetworkLayer* network_layer() { return static_cast<MockNetworkLayer*>(http_cache_.network_layer()); }
...
public:
    ...
    disk_cache::BackendResultCallback ReleaseCallback() { return std::move(callback_); }
