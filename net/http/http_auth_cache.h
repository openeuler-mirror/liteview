...
public:
    ...
    //   returns  - the matched entry or nullptr.
    Entry* LookupByPath(const url::SchemeHostPort& scheme_host_port, HttpAuth::Target target, const NetworkAnonymizationKey& network_anonymization_key, const std::string& path);
    ...
    bool key_server_entries_by_network_anonymization_key() const { return key_server_entries_by_network_anonymization_key_; }
