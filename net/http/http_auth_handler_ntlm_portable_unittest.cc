...
public:
    ...
    {
        std::string output;
        base::Base64Encode(base::StringPiece(reinterpret_cast<const char*>(buffer.data()), buffer.size()), &output);
    ...
    HttpAuthHandlerNTLM* GetAuthHandler() { return static_cast<HttpAuthHandlerNTLM*>(auth_handler_.get()); }
