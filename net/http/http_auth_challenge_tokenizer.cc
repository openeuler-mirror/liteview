...
HttpAuthChallengeTokenizer::HttpAuthChallengeTokenizer(std::string::const_iterator begin, std::string::const_iterator end)
    : begin_(begin)
    , end_(end)
    , params_begin_(end)
    , params_end_(end)
...
HttpUtil::NameValuePairsIterator HttpAuthChallengeTokenizer::param_pairs() const { return HttpUtil::NameValuePairsIterator(params_begin_, params_end_, ','); }
...
void HttpAuthChallengeTokenizer::Init(std::string::const_iterator begin, std::string::const_iterator end)
{
