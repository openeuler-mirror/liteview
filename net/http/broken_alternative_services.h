...
struct NET_EXPORT_PRIVATE BrokenAlternativeService {
    ...
    BrokenAlternativeService(const AlternativeService& alternative_service, const NetworkAnonymizationKey& network_anonymization_key, bool use_network_anonymization_key);
...
public:
    ...
    public:
        ...
        virtual void OnExpireBrokenAlternativeService(const AlternativeService& expired_alternative_service, const NetworkAnonymizationKey& network_anonymization_key) = 0;
    ...
    void SetDelayParams(absl::optional<base::TimeDelta> initial_delay, absl::optional<bool> exponential_backoff_on_initial_delay);
...
private:
    ...
    struct AlternativeServiceHash {
        size_t operator()(const net::AlternativeService& entry) const { return entry.protocol ^ std::hash<std::string>()(entry.host) ^ entry.port; }
    };
    ...
    // inserted.
    bool AddToBrokenListAndMap(const BrokenAlternativeService& broken_alternative_service, base::TimeTicks expiration, BrokenAlternativeServiceList::iterator* it);
