...
HttpResponseInfo::ConnectionInfoCoarse HttpResponseInfo::ConnectionInfoToCoarse(ConnectionInfo info)
{
    switch (info) {
...
bool HttpResponseInfo::InitFromPickle(const base::Pickle& pickle, bool* response_truncated)
{
    ...
    *response_truncated = (flags & RESPONSE_INFO_TRUNCATED) != 0;
    ...
    single_keyed_cache_entry_unusable = (flags & RESPONSE_INFO_SINGLE_KEYED_CACHE_ENTRY_UNUSABLE) != 0;
...
void HttpResponseInfo::Persist(base::Pickle* pickle, bool skip_transient_headers, bool response_truncated) const
{
    ...
    if (skip_transient_headers) {
        persist_options = HttpResponseHeaders::PERSIST_SANS_COOKIES | HttpResponseHeaders::PERSIST_SANS_CHALLENGES | HttpResponseHeaders::PERSIST_SANS_HOP_BY_HOP
            | HttpResponseHeaders::PERSIST_SANS_NON_CACHEABLE | HttpResponseHeaders::PERSIST_SANS_RANGES | HttpResponseHeaders::PERSIST_SANS_SECURITY_STATE;
    }
