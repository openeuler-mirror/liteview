...
protected:
    void SetUp() override { response_info_.headers = base::MakeRefCounted<HttpResponseHeaders>(""); }
...
TEST_F(HttpResponseInfoTest, UnusedSincePrefetchDefault) { EXPECT_FALSE(response_info_.unused_since_prefetch); }
...
TEST_F(HttpResponseInfoTest, AsyncRevalidationRequestedDefault) { EXPECT_FALSE(response_info_.async_revalidation_requested); }
...
TEST_F(HttpResponseInfoTest, StaleRevalidationTimeoutDefault) { EXPECT_TRUE(response_info_.stale_revalidate_timeout.is_null()); }
