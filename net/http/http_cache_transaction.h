...
public:
    ...
    void SetIOCallBackForTest(CompletionRepeatingCallback cb) { io_callback_ = cb; }
    ...
    void BypassLockAfterHeadersForTest() { bypass_lock_after_headers_for_test_ = true; }
    ...
    bool ResponseChecksumMatches(std::unique_ptr<crypto::SecureHash> checksum) const;
...
private:
    ...
    bool mark_single_keyed_cache_entry_unusable_ = false; // Set single_keyed_cache_entry_unusable.
