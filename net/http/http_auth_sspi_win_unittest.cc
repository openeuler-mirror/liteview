...
TEST(HttpAuthSSPITest, ParseChallenge_TwoRounds)
{
    ...
    EXPECT_EQ(OK, auth_sspi.GenerateAuthToken(nullptr, "HTTP/intranet.google.com", std::string(), &auth_token, NetLogWithSource(), base::BindOnce(&UnexpectedCallback)));
...
TEST(HttpAuthSSPITest, GenerateAuthToken_FullHandshake_AmbientCreds)
{
    ...
    std::string auth_token;
    ASSERT_EQ(OK, auth_sspi.GenerateAuthToken(nullptr, "HTTP/intranet.google.com", std::string(), &auth_token, NetLogWithSource(), base::BindOnce(&UnexpectedCallback)));
...
TEST(HttpAuthSSPITest, GenerateAuthToken_FullHandshake_AmbientCreds_Logging)
{
    ...
    std::string auth_token;
    ASSERT_EQ(OK, auth_sspi.GenerateAuthToken(nullptr, "HTTP/intranet.google.com", std::string(), &auth_token, net_log_with_source, base::BindOnce(&UnexpectedCallback)));
