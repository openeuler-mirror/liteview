...
public:
    ...
    NetworkAnonymizationKey GetNetworkAnonymizationKey() const override { return NetworkAnonymizationKey::CreateFromNetworkIsolationKey(network_isolation_key_); }

    void set_network_isolation_key(const net::NetworkIsolationKey& network_isolation_key) { network_isolation_key_ = network_isolation_key; }
...
class HttpCacheLookupManagerTest_NetworkIsolationKey : public ::testing::Test, public ::testing::WithParamInterface<bool /* use_same_network_isolation_key */> { };
