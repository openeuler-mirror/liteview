...
public:
    HttpBasicState(std::unique_ptr<ClientSocketHandle> connection, bool using_proxy);
    ...
    MutableNetworkTrafficAnnotationTag traffic_annotation() { return traffic_annotation_; }
