...
public:
    ...
    TransportSecurityPersister(TransportSecurityState* state, const scoped_refptr<base::SequencedTaskRunner>& background_runner, const base::FilePath& data_path);
...
private:
    ...
    static void Deserialize(const std::string& serialized, TransportSecurityState* state);
