...
public:
    ...
    bool IsLeaf() const { return left_.get() == nullptr && right_.get() == nullptr; }
...
bool CompareNodes(const std::unique_ptr<HuffmanNode>& lhs, const std::unique_ptr<HuffmanNode>& rhs) { return lhs->count() < rhs->count(); }
