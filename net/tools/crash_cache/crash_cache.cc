...
{
    const char* const folders[] = { "", "insert_empty1", "insert_empty2", "insert_empty3", "insert_one1", "insert_one2", "insert_one3", "insert_load1", "insert_load2",
        "remove_one1", "remove_one2", "remove_one3", "remove_one4", "remove_head1", "remove_head2", "remove_head3", "remove_head4", "remove_tail1", "remove_tail2", "remove_tail3",
...
{
    int size = 1024 * 1024;
    disk_cache::BackendImpl* backend = new disk_cache::BackendImpl(path, /* cleanup_tracker = */ nullptr, thread->task_runner().get(), net::DISK_CACHE, /* net_log = */ nullptr);
...
int LoadOperations(const base::FilePath& path, RankCrashes action, base::Thread* cache_thread)
{
    ...
    disk_cache::BackendImpl* cache = new disk_cache::BackendImpl(path, 0xf, cache_thread->task_runner().get(), net::DISK_CACHE, nullptr);
