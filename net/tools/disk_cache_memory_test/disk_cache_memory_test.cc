...
std::unique_ptr<Backend> CreateAndInitBackend(const CacheSpec& spec)
{
    ...
    result = CreateCacheBackend(spec.cache_type, spec.backend_type, /*file_operations=*/nullptr, spec.path, 0, disk_cache::ResetHandling::kNeverReset, /*net_log=*/nullptr,
        base::BindOnce(
...
int main(int argc, char** argv) { return !disk_cache::Main(argc, argv); }
