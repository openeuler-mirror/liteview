...
bool ParsePEM(base::StringPiece pem_input, base::StringPiece expected_block_type, std::string* der_output)
{
    ...
    base::StringPiece base64_encoded = pem_input.substr(base64_start_pos, block_end_pos - base64_start_pos);
