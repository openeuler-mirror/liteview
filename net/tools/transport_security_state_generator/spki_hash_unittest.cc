...
TEST(SPKIHashTest, FromString)
{
    ...
    EXPECT_THAT(hash_vector,
        testing::ElementsAreArray({ 0xD7, 0x5D, 0x75, 0xD7, 0x5D, 0x75, 0xD7, 0x5D, 0x75, 0xD7, 0x5D, 0x75, 0xD7, 0x5D, 0x75, 0xD7, 0x5D, 0x75, 0xD7, 0x5D, 0x75, 0xD7, 0x5D, 0x75,
    ...
    EXPECT_THAT(hash_vector2,
        testing::ElementsAreArray({ 0xE2, 0x8B, 0x14, 0xEF, 0xD8, 0x5F, 0x63, 0x73, 0xF6, 0xF9, 0x62, 0x46, 0x95, 0x3D, 0XA6, 0xC6, 0x64, 0x8B, 0xFB, 0x91, 0x48, 0xC0, 0xB1, 0x15,
            0xC5, 0x34, 0x1C, 0x6A, 0xFC, 0x81, 0x36, 0x04 }));
