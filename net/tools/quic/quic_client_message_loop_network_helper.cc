...
bool QuicClientMessageLooplNetworkHelper::CreateUDPSocketAndBind(quic::QuicSocketAddress server_address, quic::QuicIpAddress bind_to_address, int bind_to_port)
{
    ...
    packet_reader_ = std::make_unique<QuicChromiumPacketReader>(
        socket_.get(), clock_, this, kQuicYieldAfterPacketsRead, quic::QuicTime::Delta::FromMilliseconds(kQuicYieldAfterDurationMilliseconds), NetLogWithSource());
...
quic::QuicSocketAddress QuicClientMessageLooplNetworkHelper::GetLatestClientAddress() const { return client_address_; }
