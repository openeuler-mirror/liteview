...
public:
    QuicChromeServerDispatchPacketTest()
        ...
        , dispatcher_(std::make_unique<quic::test::MockQuicDispatcher>(&config_, &crypto_config_, &version_manager_, std::make_unique<quic::test::MockQuicConnectionHelper>(),
              std::make_unique<QuicSimpleServerSessionHelper>(quic::QuicRandom::GetInstance()), std::make_unique<quic::test::MockAlarmFactory>(), &memory_cache_backend_,
