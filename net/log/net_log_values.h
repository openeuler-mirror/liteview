...
NET_EXPORT base::Value NetLogParamsWithInt64(base::StringPiece name, int64_t value);
NET_EXPORT base::Value NetLogParamsWithBool(base::StringPiece name, bool value);
NET_EXPORT base::Value NetLogParamsWithString(base::StringPiece name, base::StringPiece value);
