...
public:
    ...
    protected:
        ...
        void AddEntryAtTimeWithMaterializedParams(NetLogEventType type, const NetLogSource& source, NetLogEventPhase phase, base::TimeTicks time, base::Value&& params);
        ...
        NetLogEventType type, const NetLogSource& source, NetLogEventPhase phase, const ParametersCallback& get_params)
    {
        ...
        public:
            ...
            base::Value GetParams(NetLogCaptureMode mode) const override { return get_params_(mode); }
    ...
    void AddGlobalEntryWithStringParams(NetLogEventType type, base::StringPiece name, base::StringPiece value);
    ...
    bool IsCapturing() const { return GetObserverCaptureModes() != 0; }
...
private:
    ...
    NetLogCaptureModeSet GetObserverCaptureModes() const { return base::subtle::NoBarrier_Load(&observer_capture_modes_); }
    ...
    // clang).
    void AddEntryWithMaterializedParams(NetLogEventType type, const NetLogSource& source, NetLogEventPhase phase, base::Value&& params);
