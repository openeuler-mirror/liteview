...
bool NetLogSource::operator==(const NetLogSource& rhs) const { return type == rhs.type && id == rhs.id && start_time == rhs.start_time; }

bool NetLogSource::IsValid() const { return id != kInvalidId; }
