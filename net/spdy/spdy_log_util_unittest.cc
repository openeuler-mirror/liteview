...
std::string ElideGoAwayDebugDataForNetLogAsString(NetLogCaptureMode capture_mode, base::StringPiece debug_data)
{
...
TEST(SpdyLogUtilTest, ElideHttp2HeaderBlockForNetLog)
{
    ...
    base::Value::List list = ElideHttp2HeaderBlockForNetLog(headers, NetLogCaptureMode::kDefault);
    ...
    list = ElideHttp2HeaderBlockForNetLog(headers, NetLogCaptureMode::kIncludeSensitive);
...
TEST(SpdyLogUtilTest, Http2HeaderBlockNetLogParams)
{
    ...
    std::unique_ptr<base::Value> dict = base::Value::ToUniquePtrValue(Http2HeaderBlockNetLogParams(&headers, NetLogCaptureMode::kDefault));
    ...
    dict = base::Value::ToUniquePtrValue(Http2HeaderBlockNetLogParams(&headers, NetLogCaptureMode::kIncludeSensitive));
