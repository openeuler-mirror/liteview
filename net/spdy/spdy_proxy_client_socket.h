...
public:
    ...
    SpdyProxyClientSocket(const base::WeakPtr<SpdyStream>& spdy_stream, const ProxyServer& proxy_server, const std::string& user_agent, const HostPortPair& endpoint,
        const NetLogWithSource& source_net_log, scoped_refptr<HttpAuthController> auth_controller, ProxyDelegate* proxy_delegate);
...
private:
    ...
    base::WeakPtrFactory<SpdyProxyClientSocket> write_callback_weak_factory_ { this };
};
