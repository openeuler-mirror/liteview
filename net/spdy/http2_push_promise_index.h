...
public:
    ...
    public:
        ...
        // |key|.
        virtual bool ValidatePushedStream(spdy::SpdyStreamId stream_id, const GURL& url, const HttpRequestInfo& request_info, const SpdySessionKey& key) const = 0;
    ...
    // session exists.
    void ClaimPushedStream(const SpdySessionKey& key, const GURL& url, const HttpRequestInfo& request_info, base::WeakPtr<SpdySession>* session, spdy::SpdyStreamId* stream_id);
