...
public:
    ...
    public:
        ...
        bool is_blocking_request_for_session() const { return is_blocking_request_for_session_; }
    ...
    SpdySessionPool(HostResolver* host_resolver, SSLClientContext* ssl_client_context, HttpServerProperties* http_server_properties,
        ...
        bool is_http_enabled, bool is_quic_enabled, size_t session_max_recv_window_size, int session_max_queued_capped_frames, const spdy::SettingsMap& initial_settings,
    ...
    base::WeakPtr<SpdySession> FindAvailableSession(const SpdySessionKey& key, bool enable_ip_based_pooling, bool is_websocket, const NetLogWithSource& net_log);
    ...
    HttpServerProperties* http_server_properties() { return http_server_properties_; }
...
private:
    ...
    std::unique_ptr<SpdySession> CreateSession(const SpdySessionKey& key, NetLog* net_log);
