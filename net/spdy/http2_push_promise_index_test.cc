...
public:
    ...
    bool ValidatePushedStream(spdy::SpdyStreamId stream_id, const GURL& url, const HttpRequestInfo& request_info, const SpdySessionKey& key) const override { return key == key_; }
...
protected:
    Http2PushPromiseIndexTest()
        ...
        , key1_(HostPortPair::FromURL(url1_), ProxyServer::Direct(), PRIVACY_MODE_ENABLED, SpdySessionKey::IsProxySession::kFalse, SocketTag(), NetworkAnonymizationKey(),
              SecureDnsPolicy::kAllow)
        , key2_(HostPortPair::FromURL(url2_), ProxyServer::Direct(), PRIVACY_MODE_ENABLED, SpdySessionKey::IsProxySession::kFalse, SocketTag(), NetworkAnonymizationKey(),
              SecureDnsPolicy::kAllow)
    {
    }
