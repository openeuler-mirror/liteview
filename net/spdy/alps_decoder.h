...
public:
    ...
    const spdy::SettingsMap& GetSettings() const { return settings_parser_.GetSettings(); }
    ...
    const std::vector<spdy::AcceptChOriginValuePair>& GetAcceptCh() const { return accept_ch_parser_.GetAcceptCh(); }
...
private:
    ...
    public:
        ...
        const std::vector<spdy::AcceptChOriginValuePair>& GetAcceptCh() const { return accept_ch_; }
