...
public:
    ...
    CompletionOnceCallback callback() { return base::BindOnce(&CancelStreamCallback::CancelStream, base::Unretained(this)); }
...
public:
    SpdyHttpStreamTest()
        ...
        , key_(host_port_pair_, ProxyServer::Direct(), PRIVACY_MODE_DISABLED, SpdySessionKey::IsProxySession::kFalse, SocketTag(), NetworkAnonymizationKey(),
...
TEST_F(SpdyHttpStreamTest, SendRequest)
{
    ...
    auto http_stream = std::make_unique<SpdyHttpStream>(session_, kNoPushedStreamFound, net_log.source(),
...
TEST_F(SpdyHttpStreamTest, LoadTimingTwoRequests)
{
    ...
    NetLogWithSource net_log;
    auto http_stream1 = std::make_unique<SpdyHttpStream>(session_, kNoPushedStreamFound, net_log.source(),
        /*dns_aliases=*/std::set<std::string>());
    ...
    auto http_stream2 = std::make_unique<SpdyHttpStream>(session_, kNoPushedStreamFound, net_log.source(),
        /*dns_aliases=*/std::set<std::string>());
...
TEST_F(SpdyHttpStreamTest, SendChunkedPost)
{
    ...
    upload_stream.AppendData(kUploadData + kFirstChunkSize, kUploadDataSize - kFirstChunkSize, true);
    ...
    HttpRequestHeaders headers;
    NetLogWithSource net_log;
    SpdyHttpStream http_stream(session_, kNoPushedStreamFound, net_log.source(), {} /* dns_aliases */);
    http_stream.RegisterRequest(&request);
...
TEST_F(SpdyHttpStreamTest, DelayedSendChunkedPost)
{
    ...
    scoped_refptr<IOBuffer> buf1 = base::MakeRefCounted<IOBuffer>(kUploadDataSize);
    ...
    scoped_refptr<IOBuffer> buf2 = base::MakeRefCounted<IOBuffer>(kUploadData1Size);
    ...
    scoped_refptr<IOBuffer> buf3 = base::MakeRefCounted<IOBuffer>(kUploadDataSize);
