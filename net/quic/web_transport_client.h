...
public:
    ...
    // CONNECTED -> CLOSED
    virtual void OnClosed(const absl::optional<WebTransportCloseInfo>& close_info) = 0;
    // CONNECTED -> FAILED
    ...
    virtual void OnDatagramProcessed(absl::optional<quic::MessageStatus> status) = 0;
};
...
public:
    ...
    virtual void Close(const absl::optional<WebTransportCloseInfo>& close_info) = 0;
