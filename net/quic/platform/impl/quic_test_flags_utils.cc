...
#define QUIC_FLAG(flag, value)                                                                                                                                                     \
    CHECK_EQ(value, FLAGS_##flag) << "Flag set to an unexpected value.  A prior test is likely "                                                                                   \
...
#define QUIC_PROTOCOL_FLAG_CHECK(type, flag, value)                                                                                                                                \
    CHECK_EQ((type)value, FLAGS_##flag) << "Flag set to an unexpected value.  A prior test is likely "                                                                             \
                                        << "setting a flag without using a QuicFlagSaver. Use QuicTest to "                                                                        \
                                           "avoid this issue.";
#define DEFINE_QUIC_PROTOCOL_FLAG_SINGLE_VALUE(type, flag, value, doc) QUIC_PROTOCOL_FLAG_CHECK(type, flag, value);

#define DEFINE_QUIC_PROTOCOL_FLAG_TWO_VALUES(type, flag, internal_value, external_value, doc) QUIC_PROTOCOL_FLAG_CHECK(type, flag, external_value);
#define GET_6TH_ARG(arg1, arg2, arg3, arg4, arg5, arg6, ...) arg6
#define QUIC_PROTOCOL_FLAG_MACRO_CHOOSER(...) GET_6TH_ARG(__VA_ARGS__, DEFINE_QUIC_PROTOCOL_FLAG_TWO_VALUES, DEFINE_QUIC_PROTOCOL_FLAG_SINGLE_VALUE)
