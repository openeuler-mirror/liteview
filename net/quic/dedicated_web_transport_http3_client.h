...
public:
    ...
    DedicatedWebTransportHttp3Client(const GURL& url, const url::Origin& origin, WebTransportClientVisitor* visitor, const NetworkAnonymizationKey& anonymization_key,
        URLRequestContext* context, const WebTransportParameters& parameters);
...
private:
    ...
    void SetErrorIfNecessary(int error, quic::QuicErrorCode quic_error, base::StringPiece details);
