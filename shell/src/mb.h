...
/* Windows：用尖括号拉系统 SDK。Linux 侧勿使用名为 windows.h 的工程文件（会与系统/预扫描混淆），
 * 兼容头已单独命名为 mb_windows_linux_shim.h。 */
...
#include <Windows.h>
#else
#include "mb_windows_linux_shim.h"
#endif
...
#define MB_FOR_EACH_DEFINE_FUNCTION(                                                                                                                           \
    ...
    ITERATOR2(void, mbNetSetResponseStatusText, mbNetJob jobPtr, const char* text, "") \
    ITERATOR2(void, mbNetSetResponseStatusCode, mbNetJob jobPtr, int code, "") \
    ...
    ITERATOR2(void, mbClearStorage, mbWebView webView, int isLocal, "isLocal=2 clear all storage")                                                                                      \
                                                                                                                                                               \
