...
class VIZ_HOST_EXPORT HostFrameSinkManager : public mojom::FrameSinkManagerClient {
public:
    ...
    void CreateRootCompositorFrameSink(mojom::RootCompositorFrameSinkParamsPtr params);
    ...
    // be executed later.
    void RequestCopyOfOutput(const SurfaceId& surface_id, std::unique_ptr<CopyOutputRequest> request);
...
private:
    ...
    void CreateFrameSink(const FrameSinkId& frame_sink_id, absl::optional<FrameSinkBundleId> bundle_id,
        mojo::PendingReceiver<mojom::CompositorFrameSink> receiver, mojo::PendingRemote<mojom::CompositorFrameSinkClient> client);
