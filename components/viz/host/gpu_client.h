...
class VIZ_HOST_EXPORT GpuClient : public mojom::GpuMemoryBufferFactory, public mojom::Gpu {
public:
    ...
    void SetConnectionErrorHandler(ConnectionErrorHandlerClosure connection_error_handler);
    ...
    void CreateGpuMemoryBuffer(gfx::GpuMemoryBufferId id, const gfx::Size& size, gfx::BufferFormat format, gfx::BufferUsage usage,
        mojom::GpuMemoryBufferFactory::CreateGpuMemoryBufferCallback callback) override;
    ...
    // mojom::Gpu overrides:
    void CreateGpuMemoryBufferFactory(mojo::PendingReceiver<mojom::GpuMemoryBufferFactory> receiver) override;
...
private:
    ...
    void OnCreateGpuMemoryBuffer(gfx::GpuMemoryBufferId id, gfx::GpuMemoryBufferHandle handle);
    void ClearCallback();
    ...
    // is still active.
    std::map<gfx::GpuMemoryBufferId, CreateGpuMemoryBufferCallback> pending_create_callbacks_;

    mojo::ReceiverSet<mojom::GpuMemoryBufferFactory> gpu_memory_buffer_factory_receivers_;
