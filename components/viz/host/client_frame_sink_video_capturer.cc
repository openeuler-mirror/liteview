...
void ClientFrameSinkVideoCapturer::ChangeTarget(const absl::optional<VideoCaptureTarget>& target)
{
    DCHECK_CALLED_ON_VALID_SEQUENCE(sequence_checker_);
...
void ClientFrameSinkVideoCapturer::ChangeTarget(const absl::optional<VideoCaptureTarget>& target, uint32_t crop_version)
{
    DCHECK_CALLED_ON_VALID_SEQUENCE(sequence_checker_);
