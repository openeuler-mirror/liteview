...
public:
    ...
    struct VIZ_SERVICE_EXPORT ResourceFrame {
        ...
        // above.
        base::flat_map<SharedElementResourceId, TransferableResource> element_id_to_resource;
    };

    explicit TransferableResourceTracker(SharedBitmapManager* shared_bitmap_manager);
...
private:
    ...
    struct TransferableResourceHolder {
        using ResourceReleaseCallback = base::OnceCallback<void(const TransferableResource&)>;
