...
public:
    ...
    void DrawText(const gfx::Point& pos, const std::string& text, const StaticSource* dcs, DrawOption option);
    void DrawText(const gfx::Vector2dF& pos, const std::string& text, const StaticSource* dcs, DrawOption option);
    void DrawText(const gfx::PointF& pos, const std::string& text, const StaticSource* dcs, DrawOption option);
    ...
    void Draw(const gfx::Size& obj_size, const gfx::Vector2dF& pos, const StaticSource* dcs, DrawOption option, int* id, const gfx::RectF& uv);
...
private:
    ...
    void DrawInternal(const gfx::Size& obj_size, const gfx::Vector2dF& pos, const StaticSource* dcs, DrawOption option, int* id, const gfx::RectF& uv);
    ...
    struct DrawCall : public CallSubmitCommon {
        DrawCall() = default;
        DrawCall(int index, int source, int thread, DrawOption draw_option, gfx::Size size, gfx::Vector2dF position, int buffer_id, gfx::RectF uv_rect)
    ...
    struct DrawTextCall : public CallSubmitCommon {
        ...
        DrawTextCall(int index, int source, int thread, DrawOption draw_option, gfx::Vector2dF position, std::string str)
            : CallSubmitCommon(index, source, thread, draw_option)
            , pos(position)
            , text(str)
        {
...
#define DBG_DRAW_RECTANGLE_OPT_BUFF(anno, option, pos, size, id) DBG_DRAW_RECTANGLE_OPT_BUFF_UV(anno, option, pos, size, id, DEFAULT_UV)
...
#define DBG_DRAW_RECT_OPT_BUFF(anno, option, rect, id)                                                                                                         \
    DBG_DRAW_RECTANGLE_OPT_BUFF(anno, option, gfx::Vector2dF(rect.origin().x(), rect.origin().y()), rect.size(), id)

#define DBG_DRAW_RECT_OPT_BUFF_UV(anno, option, rect, id, uv)                                                                                                  \
    DBG_DRAW_RECTANGLE_OPT_BUFF_UV(anno, option, gfx::Vector2dF(rect.origin().x(), rect.origin().y()), rect.size(), id, uv)

#define DBG_DRAW_RECT_OPT(anno, option, rect) DBG_DRAW_RECTANGLE_OPT(anno, option, gfx::Vector2dF(rect.origin().x(), rect.origin().y()), rect.size())
...
#define DBG_DRAW_RECT(anno, rect) DBG_DRAW_RECT_OPT_BUFF(anno, DBG_OPT_BLACK, rect, nullptr)
