...
public:
    ...
    struct ReshapeParams {
        ...
        {
            return size == other.size && device_scale_factor == other.device_scale_factor && color_space == other.color_space
                && sdr_white_level == other.sdr_white_level && format == other.format && alpha_type == other.alpha_type;
        }
        bool operator!=(const ReshapeParams& other) const
        {
            return !(*this == other);
