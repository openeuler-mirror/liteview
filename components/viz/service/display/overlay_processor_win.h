...
public:
    ...
    OverlayProcessorWin(OutputSurface* output_surface, std::unique_ptr<DCLayerOverlayProcessor> dc_layer_overlay_processor);
    ...
    void set_using_dc_layers_for_testing(bool value)
    {
        using_dc_layers_ = value;
    }
    void set_frames_since_last_qualified_multi_overlays_for_testing(int value)
    {
        GetOverlayProcessor()->set_frames_since_last_qualified_multi_overlays_for_testing(value);
    }
