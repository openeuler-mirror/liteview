...
public:
    ...
    public:
        ...
        ExternalUseClient::ImageContext* LockResource(ResourceId resource_id, bool maybe_concurrent_reads, bool is_video_plane,
            sk_sp<SkColorSpace> override_color_space = nullptr, bool raw_draw_if_possible = false);
