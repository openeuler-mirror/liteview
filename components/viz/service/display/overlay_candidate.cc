...
// static
bool OverlayCandidate::IsOccluded(const OverlayCandidate& candidate, QuadList::ConstIterator quad_list_begin, QuadList::ConstIterator quad_list_end)
{
...
void OverlayCandidate::TransformRectToTargetSpace(gfx::RectF& content_rect) const
{
