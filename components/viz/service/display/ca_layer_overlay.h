...
// CALayerOverlays.
class VIZ_SERVICE_EXPORT CALayerOverlaySharedState : public base::RefCountedThreadSafe<CALayerOverlaySharedState> {
public:
...
public:
    ...
    bool AreClipSettingsValid(const CALayerOverlay& ca_layer_overlay, CALayerOverlayList* ca_layer_overlay_list) const;
    void PutForcedOverlayContentIntoUnderlays(DisplayResourceProvider* resource_provider, AggregatedRenderPass* render_pass, const gfx::RectF& display_rect,
        QuadList* quad_list, const base::flat_map<AggregatedRenderPassId, cc::FilterOperations*>& render_pass_filters,
    ...
    virtual bool ProcessForCALayerOverlays(AggregatedRenderPass* render_passes, DisplayResourceProvider* resource_provider, const gfx::RectF& display_rect,
...
private:
    ...
    bool PutQuadInSeparateOverlay(QuadList::Iterator at, DisplayResourceProvider* resource_provider, AggregatedRenderPass* render_pass,
