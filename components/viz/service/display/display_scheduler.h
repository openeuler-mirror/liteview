...
public:
    ...
    void ReportFrameTime(base::TimeDelta frame_time, base::flat_set<base::PlatformThreadId> thread_ids) override;
...
protected:
    ...
    void MaybeCreateHintSession(base::flat_set<base::PlatformThreadId> thread_ids);
