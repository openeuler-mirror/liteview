...
bool OverlayStrategyUnderlayCast::Attempt(const SkM44& output_color_matrix, const OverlayProcessorInterface::FilterOperationsMap& render_pass_backdrop_filters,
...
void OverlayStrategyUnderlayCast::ProposePrioritized(const SkM44& output_color_matrix,
...
bool OverlayStrategyUnderlayCast::AttemptPrioritized(const SkM44& output_color_matrix,
    const OverlayProcessorInterface::FilterOperationsMap& render_pass_backdrop_filters, DisplayResourceProvider* resource_provider,
    AggregatedRenderPassList* render_pass_list, SurfaceDamageRectList* surface_damage_rect_list, const PrimaryPlane* primary_plane,
