...
public:
    ...
    virtual base::TimeDelta GetEstimatedDisplayDrawTime(const base::TimeDelta interval, double percentile) const = 0;
};

class VIZ_SERVICE_EXPORT DisplaySchedulerBase : public DisplayDamageTracker::Observer {
public:
    ...
    virtual void ReportFrameTime(base::TimeDelta frame_time, base::flat_set<base::PlatformThreadId> thread_ids) = 0;
