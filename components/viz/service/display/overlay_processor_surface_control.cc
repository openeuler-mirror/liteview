    ...
    const OverlayProcessorInterface::OutputSurfaceOverlayPlane* primary_plane, OverlayCandidateList* candidates)
{
    ...
    for (auto& candidate : *candidates) {
        ...
        if (absl::get<gfx::OverlayTransform>(candidate.transform) != display_transform_) {
            candidate.overlay_handled = false;
            return;
        }
...
void OverlayProcessorSurfaceControl::AdjustOutputSurfaceOverlay(absl::optional<OutputSurfaceOverlayPlane>* output_surface_plane)
{
