...
public:
    ...
    struct VIZ_SERVICE_EXPORT DrawingFrame {
        ...
        absl::optional<OverlayProcessorInterface::OutputSurfaceOverlayPlane> output_surface_plane;
    };
...
protected:
    ...
    void InitializeViewport(DrawingFrame* frame, const gfx::Rect& draw_rect, const gfx::Rect& viewport_rect, const gfx::Size& surface_size);
    ...
    gfx::Size CalculateTextureSizeForRenderPass(const AggregatedRenderPass* render_pass);
    ...
    const absl::optional<gfx::RRectF> BackdropFilterBoundsForPass(AggregatedRenderPassId render_pass_id) const;
    ...
    virtual void BindFramebufferToTexture(const AggregatedRenderPassId render_pass_id) = 0;
    virtual void SetScissorTestRect(const gfx::Rect& scissor_rect) = 0;
    virtual void PrepareSurfaceForPass(SurfaceInitializationMode initialization_mode, const gfx::Rect& render_pass_scissor) = 0;
    ...
    virtual const DrawQuad* CanPassBeDrawnDirectly(const AggregatedRenderPass* pass);
    ...
    {
        return CurrentRenderPassColorSpace().ToSkColorSpace(CurrentFrameSDRWhiteLevel());
    }
    ...
    base::flat_map<AggregatedRenderPassId, cc::FilterOperations*> render_pass_filters_;
    base::flat_map<AggregatedRenderPassId, cc::FilterOperations*> render_pass_backdrop_filters_;
    base::flat_map<AggregatedRenderPassId, absl::optional<gfx::RRectF>> render_pass_backdrop_filter_bounds_;
