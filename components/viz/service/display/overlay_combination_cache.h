...
public:
    ...
    OverlayCombinationToTest GetOverlayCombinationToTest(const std::vector<OverlayProposedCandidate>& sorted_candidates, int max_overlays_considered);
    ...
    void DeclarePromotedCandidates(const std::vector<OverlayProposedCandidate>& attempted_candidates);
...
private:
    ...
    std::vector<OverlayProposedCandidate> GetConsideredCandidates(const std::vector<OverlayProposedCandidate>& sorted_candidates, size_t max_overlays_possible);
