...
bool HitTestManager::OnSurfaceDamaged(const SurfaceId& surface_id, const BeginFrameAck& ack)
{
    return false;
}
...
void HitTestManager::SubmitHitTestRegionList(const SurfaceId& surface_id, const uint64_t frame_index, absl::optional<HitTestRegionList> hit_test_region_list)
{
