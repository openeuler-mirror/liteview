...
public:
    ...
    bool OnSurfaceDamaged(const SurfaceId& surface_id, const BeginFrameAck& ack) override;
    ...
    void SubmitHitTestRegionList(const SurfaceId& surface_id, const uint64_t frame_index, absl::optional<HitTestRegionList> hit_test_region_list);
