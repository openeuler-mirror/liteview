...
absl::optional<int64_t> HitTestAggregator::GetTraceIdIfUpdated(const SurfaceId& surface_id, uint64_t active_frame_index)
{
    bool enabled;
...
void HitTestAggregator::AppendRoot(const SurfaceId& surface_id)
{
    ...
    absl::optional<int64_t> trace_id = GetTraceIdIfUpdated(surface_id, active_frame_index);
