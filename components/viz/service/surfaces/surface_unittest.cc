...
TEST_F(SurfaceTest, PresentationCallback)
{
    ...
    {
        CompositorFrame frame = CompositorFrameBuilder().AddRenderPass(gfx::Rect(kSurfaceSize), kDamageRect).Build();
...
TEST_F(SurfaceTest, ActiveSurfaceReferencesWithOverlappingReferences)
{
    ...
    child_support2->SubmitCompositorFrame(child_surface_id2.local_surface_id(), MakeDefaultCompositorFrame());
    ...
    child_support1->SubmitCompositorFrame(child_surface_id1.local_surface_id(), MakeDefaultCompositorFrame());
