...
public:
    ...
    virtual bool OnSurfaceDamaged(const SurfaceId& surface_id, const BeginFrameAck& ack);
    ...
    virtual void OnRemovedSurfaceReference(const SurfaceId& parent_id, const SurfaceId& child_id)
    {
    }
};
