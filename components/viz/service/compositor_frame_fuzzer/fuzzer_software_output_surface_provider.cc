...
public:
    ...
    void EndPaint() override
    {
        ...
        gfx::PNGCodec::Encode(static_cast<const unsigned char*>(input_pixmap.addr()), color_format, gfx::Size(input_pixmap.width(), input_pixmap.height()),
            input_pixmap.rowBytes(),
            /*discard_transparency=*/false,
            /*comments=*/ {}, &output);

        base::WriteFile(NextOutputFilePath(), reinterpret_cast<char*>(output.data()), output.size());
    }
...
FuzzerSoftwareOutputSurfaceProvider::FuzzerSoftwareOutputSurfaceProvider(absl::optional<base::FilePath> png_dir_path)
