...
private:
    ...
    void OnCreatedCompositorFrameSink(const FrameSinkId& frame_sink_id, bool is_root) override
    {
    }
    void OnDestroyedCompositorFrameSink(const FrameSinkId& frame_sink_id) override;
    void OnRegisteredFrameSinkHierarchy(const FrameSinkId& parent_frame_sink_id, const FrameSinkId& child_frame_sink_id) override
    {
    }
    void OnUnregisteredFrameSinkHierarchy(const FrameSinkId& parent_frame_sink_id, const FrameSinkId& child_frame_sink_id) override
    {
    }
