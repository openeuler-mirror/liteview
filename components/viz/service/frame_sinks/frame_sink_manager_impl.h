...
public:
    struct VIZ_SERVICE_EXPORT InitParams {
        ...
        absl::optional<uint32_t> activation_deadline_in_frames = kDefaultActivationDeadlineInFrames;
    ...
    void CreateCompositorFrameSink(const FrameSinkId& frame_sink_id, const absl::optional<FrameSinkBundleId>& bundle_id,
        mojo::PendingReceiver<mojom::CompositorFrameSink> receiver, mojo::PendingRemote<mojom::CompositorFrameSinkClient> client) override;
    ...
    void RequestCopyOfOutput(const SurfaceId& surface_id, std::unique_ptr<CopyOutputRequest> request) override;
    ...
    base::StringPiece GetFrameSinkDebugLabel(const FrameSinkId& frame_sink_id) const override;
    ...
    void SubmitHitTestRegionList(const SurfaceId& surface_id, uint64_t frame_index, absl::optional<HitTestRegionList> hit_test_region_list);
    ...
    bool VerifySandboxedThreadIds(base::flat_set<base::PlatformThreadId> thread_ids);
