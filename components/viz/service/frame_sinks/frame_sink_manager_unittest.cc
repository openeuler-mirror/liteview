...
TEST_F(FrameSinkManagerTest, CreateCompositorFrameSink)
{
    ...
    manager_.CreateCompositorFrameSink(
        kFrameSinkIdA, /*bundle_id=*/absl::nullopt, compositor_frame_sink.BindNewPipeAndPassReceiver(), compositor_frame_sink_client.BindInterfaceRemote());
...
{
    base::test::ScopedFeatureList feature_list { features::kEagerSurfaceGarbageCollection };
...
TEST_F(FrameSinkManagerTest, GlobalThrottle)
{
    ...
    const base::TimeDelta expected_global_interval = base::Hertz(30).FloorToMultiple(base::Microseconds(100));
    ...
    VerifyThrottling(expected_global_interval, { kFrameSinkIdRoot, kFrameSinkIdA, kFrameSinkIdB });
    ...
    VerifyThrottling(expected_global_interval, { kFrameSinkIdRoot, kFrameSinkIdA, kFrameSinkIdB, kFrameSinkIdC, kFrameSinkIdD, kFrameSinkIdE, kFrameSinkIdF });
...
TEST_F(FrameSinkManagerTest, EvictRootSurfaceId)
{
    ...
    GetRootCompositorFrameSinkImpl()->SubmitCompositorFrame(local_surface_id, MakeDefaultCompositorFrame(), absl::nullopt, 0);
...
TEST_F(FrameSinkManagerTest, SubmitCompositorFrameWithEvictedSurfaceId)
{
    ...
    EXPECT_FALSE(GetRootCompositorFrameSinkImpl()->CurrentSurfaceId().is_valid());
    GetRootCompositorFrameSinkImpl()->SubmitCompositorFrame(local_surface_id2, MakeDefaultCompositorFrame(), absl::nullopt, 0);
