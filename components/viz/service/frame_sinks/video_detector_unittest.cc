...
public:
    VideoDetectorTest()
        : surface_aggregator_(frame_sink_manager_.surface_manager(), &resource_provider_, false, false)
    {
    }
...
protected:
    ...
    void SubmitRootFrame()
    {
        ...
        for (CompositorFrameSinkSupport* frame_sink : embedded_clients_) {
            ...
            quad->SetNew(shared_quad_state, gfx::Rect(0, 0, 10, 10), gfx::Rect(0, 0, 5, 5),
                SurfaceRange(absl::nullopt, frame_sink->last_activated_surface_id()), SkColors::kMagenta, /*stretch_content_to_fill_bounds=*/false);
        }
...
public:
    ...
    {
        scoped_feature_list_.InitAndDisableFeature(features::kVideoDetectorIgnoreNonVideos);
    }
};
