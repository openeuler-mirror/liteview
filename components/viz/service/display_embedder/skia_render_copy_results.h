...
public:
    NV12PlanesReadyContext(base::WeakPtr<SkiaOutputSurfaceImplOnGpu> impl_on_gpu, std::unique_ptr<CopyOutputRequest> request, const gfx::Rect& result_rect,
        const std::array<gpu::MailboxHolder, CopyOutputResult::kMaxPlanes>& plane_mailbox_holders, const gfx::ColorSpace& color_space);

    NV12PlanesReadyContext(const NV12PlanesReadyContext& other) = delete;
    NV12PlanesReadyContext& operator=(const NV12PlanesReadyContext& other) = delete;
...
private:
    ...
    gfx::Rect result_rect_;
    std::array<gpu::MailboxHolder, CopyOutputResult::kMaxPlanes> plane_mailbox_holders_;
...
struct NV12SinglePlaneReadyContext {
    explicit NV12SinglePlaneReadyContext(scoped_refptr<NV12PlanesReadyContext> nv12_planes_flushed);

    NV12SinglePlaneReadyContext(const NV12SinglePlaneReadyContext& other) = delete;
    NV12SinglePlaneReadyContext& operator=(const NV12SinglePlaneReadyContext& other) = delete;
