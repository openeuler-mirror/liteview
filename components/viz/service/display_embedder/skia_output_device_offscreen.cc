...
SkiaOutputDeviceOffscreen::SkiaOutputDeviceOffscreen(scoped_refptr<gpu::SharedContextState> context_state, gfx::SurfaceOrigin origin, bool has_alpha,
    ...
    : SkiaOutputDevice(context_state->gr_context(), memory_tracker, did_swap_buffer_complete_callback)
...
void SkiaOutputDeviceOffscreen::SwapBuffers(BufferPresentedCallback feedback, OutputSurfaceFrame frame)
{
...
void SkiaOutputDeviceOffscreen::PostSubBuffer(const gfx::Rect& rect, BufferPresentedCallback feedback, OutputSurfaceFrame frame)
{
...
SkSurface* SkiaOutputDeviceOffscreen::BeginPaint(std::vector<GrBackendSemaphore>* end_semaphores)
{
    ...
    if (!sk_surface_) {
        ...
        sk_surface_ = SkSurface::MakeFromBackendTexture(context_state_->gr_context(), backend_texture_,
