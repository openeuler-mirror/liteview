...
public:
    ...
    SkiaOutputDevice(GrDirectContext* gr_context, gpu::MemoryTracker* memory_tracker, DidSwapBufferCompleteCallback did_swap_buffer_complete_callback);
    ...
    virtual void SwapBuffers(BufferPresentedCallback feedback, OutputSurfaceFrame frame) = 0;
    virtual void PostSubBuffer(const gfx::Rect& rect, BufferPresentedCallback feedback, OutputSurfaceFrame frame);
    virtual void CommitOverlayPlanes(BufferPresentedCallback feedback, OutputSurfaceFrame frame);
    ...
    // called.
    virtual void SchedulePrimaryPlane(const absl::optional<OverlayProcessorInterface::OutputSurfaceOverlayPlane>& plane);
...
protected:
    ...
    public:
        ...
        ~SwapInfo();
        uint64_t SwapId();
        const gpu::SwapBuffersCompleteParams& Complete(gfx::SwapCompletionResult result, const absl::optional<gfx::Rect>& damage_area,
    ...
    virtual bool Draw(SkSurface* sk_surface, sk_sp<const SkDeferredDisplayList> ddl);
    ...
    void FinishSwapBuffers(gfx::SwapCompletionResult result, const gfx::Size& size, OutputSurfaceFrame frame,
        const absl::optional<gfx::Rect>& damage_area = absl::nullopt, std::vector<gpu::Mailbox> released_overlays = {},
