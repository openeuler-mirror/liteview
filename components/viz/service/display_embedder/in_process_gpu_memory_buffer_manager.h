...
private:
    ...
    void ShouldDestroyGpuMemoryBuffer(gfx::GpuMemoryBufferId id, const gpu::SyncToken& sync_token);
    ...
    base::flat_map<gfx::GpuMemoryBufferId, AllocatedBufferInfo> allocated_buffers_;
