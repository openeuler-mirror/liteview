...
// @generated_from: gpu.mojom.OverlayStateObserver
class OverlayStateObserver : public OverlayStateObserverInterfaceBase {
public:
    ...
    //     using Stub_ = OverlayStateObserverStub<ImplRefTraits>;
    //
    ...
    // @generated_from: gpu.mojom.OverlayStateObserver.OnStateChanged
