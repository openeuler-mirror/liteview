...
{
    return a.frame_id == b.frame_id && a.trace_id == b.trace_id && a.has_damage == b.has_damage;
}
...
bool AreLatencyInfosEqual(const ui::LatencyInfo& a, const ui::LatencyInfo& b)
{
    return a.began() == b.began() && a.terminated() == b.terminated() && a.coalesced() == b.coalesced() && a.trace_id() == b.trace_id()
        && a.ukm_source_id() == b.ukm_source_id() && a.gesture_scroll_id() == b.gesture_scroll_id();
}
...
TEST(CompositorFrameMetadata, Clone)
{
    ...
    metadata.transition_directives.emplace_back(4u, CompositorFrameTransitionDirective::Type::kSave);
    ...
    EXPECT_EQ(clone.is_resourceless_software_draw_with_scroll_or_animation, metadata.is_resourceless_software_draw_with_scroll_or_animation);
