...
void CompositorRenderPass::SetAll(CompositorRenderPassId pass_id, const gfx::Rect& output_rect, const gfx::Rect& damage_rect,
    ...
    const absl::optional<gfx::RRectF>& backdrop_filter_bounds, SubtreeCaptureId capture_id, gfx::Size subtree_capture_size, SharedElementResourceId resource_id,
    bool has_transparent_background, bool cache_render_pass, bool has_damage_from_contributing_content, bool generate_mipmap, bool per_quad_damage)
{
    DCHECK(pass_id);
...
std::unique_ptr<CompositorRenderPass> CompositorRenderPass::DeepCopy() const
{
    ...
    copy_pass->SetAll(id, output_rect, damage_rect, transform_to_root_target, filters, backdrop_filters, backdrop_filter_bounds, subtree_capture_id,
        subtree_size, shared_element_resource_id, has_transparent_background, cache_render_pass, has_damage_from_contributing_content, generate_mipmap,
        has_per_quad_damage);
