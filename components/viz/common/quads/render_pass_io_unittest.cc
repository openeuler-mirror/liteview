...
TEST(RenderPassIOTest, FilterOperations)
{
    ...
    }
    {
        ...
        EXPECT_EQ(gfx::Point(1.0f, 2.0f), render_pass1->backdrop_filters.at(0).drop_shadow_offset());
...
TEST(RenderPassIOTest, SharedQuadStateList)
{
    auto render_pass0 = CompositorRenderPass::Create();
    {
        ...
        sqs1->SetAll(transform, gfx::Rect(0, 0, 640, 480), gfx::Rect(10, 10, 600, 400),
            gfx::MaskFilterInfo(gfx::RRectF(gfx::RectF(2.f, 3.f, 4.f, 5.f), 1.5f), gradient_mask), gfx::Rect(5, 20, 1000, 200), false, 0.5f,
    ...
    auto render_pass0 = CompositorRenderPass::Create();
    {
        ...
        }
        {
            ...
            quad->SetAll(render_pass0->shared_quad_state_list.ElementAt(sqs_index), gfx::Rect(10, 10, 300, 400), gfx::Rect(10, 10, 200, 400), false,
                ResourceId(100), gfx::Size(600, 800), false, gfx::PointF(0.f, 0.f), gfx::PointF(1.f, 1.f), SkColors::kTransparent, opacity, false, false, false,
        ...
        {
            // 4. YUVVideoDrawQuad
            YUVVideoDrawQuad* quad = render_pass0->CreateAndAppendDrawQuad<YUVVideoDrawQuad>();
            skcms_Matrix3x3 primary_matrix = { { { 0.6587f, 0.3206f, 0.1508f }, { 0.3332f, 0.6135f, 0.0527f }, { 0.0081f, 0.0659f, 0.7965f } } };
            skcms_TransferFunction transfer_func = { 0.9495f, 0.0495f, 0.6587f, 0.3206f, 0.0003f, 0.f, 2.3955f };
            quad->SetAll(render_pass0->shared_quad_state_list.ElementAt(sqs_index), gfx::Rect(0, 0, 800, 600), gfx::Rect(10, 15, 780, 570), false,
                gfx::Size(800, 400), gfx::Rect(10, 20, 300, 400), gfx::Size(2, 2), ResourceId(1u), ResourceId(2u), ResourceId(3u), ResourceId(4u),
                gfx::ColorSpace::CreateCustom(primary_matrix, transfer_func), 3.f, 1.1f, 12u, gfx::ProtectedVideoType::kClear, gfx::HDRMetadata());
            ++sqs_index;
            ++quad_count;
        }
        {
            ...
            quad->SetAll(render_pass0->shared_quad_state_list.ElementAt(sqs_index), gfx::Rect(0, 0, 100, 50), gfx::Rect(0, 0, 100, 50), false, ResourceId(9u),
                gfx::Size(100, 50), false, gfx::PointF(0.f, 0.f), gfx::PointF(1.f, 1.f), SkColors::kBlue, vertex_opacity, false, true, false,
                gfx::ProtectedVideoType::kHardwareProtected);
            ++sqs_index;
            ++quad_count;
        }
        ...
        }
        {
            ...
            quad->SetAll(render_pass0->shared_quad_state_list.ElementAt(sqs_index), gfx::Rect(10, 10, 512, 256), gfx::Rect(12, 12, 500, 250), true,
                SurfaceRange(absl::nullopt, kSurfaceId1), SkColors::kBlack, true, true, false);
            ++quad_count;
        }
...
TEST(RenderPassIOTest, CompositorRenderPassList)
{
    ...
    EXPECT_TRUE(CompositorRenderPassListFromDict(dict0.value(), &render_pass_list));
    ...
    for (auto& entry : list->GetList()) {
        ...
        for (auto& quad_entry : quad_list->GetList()) {
            if (const base::Value* extra_value = quad_entry.FindKey("intersects_damage_under")) {
