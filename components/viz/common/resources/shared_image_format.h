...
public:
    ...
    static constexpr SharedImageFormat SinglePlane(ResourceFormat resource_format)
    {
...
// constexpr SharedImageFormat SharedImageFormat::kRGBA_8888 = SharedImageFormat::SinglePlane(ResourceFormat::RGBA_8888);
