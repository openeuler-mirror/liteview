...
public:
    ...
    {
        return frame_sink_id_ == other.frame_sink_id_ && local_surface_id_ == other.local_surface_id_;
    }
    ...
    bool operator<(const SurfaceId& other) const
    {
        return std::tie(frame_sink_id_, local_surface_id_) < std::tie(other.frame_sink_id_, other.local_surface_id_);
    }
