...
public:
    ...
    {
        return parent_sequence_number_ == other.parent_sequence_number_ && child_sequence_number_ == other.child_sequence_number_
...
{
    return std::tie(lhs.parent_sequence_number_, lhs.child_sequence_number_, lhs.embed_token_)
        < std::tie(rhs.parent_sequence_number_, rhs.child_sequence_number_, rhs.embed_token_);
}
