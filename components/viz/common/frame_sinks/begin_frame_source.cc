...
BeginFrameArgs BeginFrameSource::BeginFrameArgsGenerator::GenerateBeginFrameArgs(
    uint64_t source_id, base::TimeTicks frame_time, base::TimeTicks next_frame_time, base::TimeDelta vsync_interval)
{
    ...
    if (dynamic_begin_frame_deadline_offset_source_) {
        base::TimeDelta deadline_offset = dynamic_begin_frame_deadline_offset_source_->GetDeadlineOffset(vsync_interval);
        next_frame_time -= deadline_offset;
    }
    next_expected_frame_time_ = next_frame_time;
    next_sequence_number_ = sequence_number + 1;
    return BeginFrameArgs::Create(BEGINFRAME_FROM_HERE, source_id, sequence_number, frame_time, next_frame_time, vsync_interval, BeginFrameArgs::NORMAL);
}
...
void BeginFrameSource::AsProtozeroInto(perfetto::EventContext&, perfetto::protos::pbzero::BeginFrameSourceState* state) const
{
...
void BeginFrameSource::SetDynamicBeginFrameDeadlineOffsetSource(DynamicBeginFrameDeadlineOffsetSource* dynamic_begin_frame_deadline_offset_source)
{
}
...
void BackToBackBeginFrameSource::OnTimerTick()
{
    ...
    BeginFrameArgs args = BeginFrameArgs::Create(
        BEGINFRAME_FROM_HERE, source_id(), next_sequence_number_, frame_time, frame_time + default_interval, default_interval, BeginFrameArgs::NORMAL);
...
BeginFrameArgs DelayBasedBeginFrameSource::CreateBeginFrameArgs(base::TimeTicks frame_time)
{
    ...
    return begin_frame_args_generator_.GenerateBeginFrameArgs(source_id(), frame_time, time_source_->NextTickTime(), interval);
}
...
void DelayBasedBeginFrameSource::AddObserver(BeginFrameObserver* obs)
{
    ...
    if (!last_begin_frame_args_.IsValid()
        || last_or_missed_tick_time > last_begin_frame_args_.frame_time + last_begin_frame_args_.interval / kDoubleTickDivisor) {
...
void DelayBasedBeginFrameSource::SetDynamicBeginFrameDeadlineOffsetSource(DynamicBeginFrameDeadlineOffsetSource* dynamic_begin_frame_deadline_offset_source)
{
...
void DelayBasedBeginFrameSource::IssueBeginFrameToObserver(BeginFrameObserver* obs, const BeginFrameArgs& args)
{
    ...
    if (!last_args.IsValid() || (args.frame_time > last_args.frame_time + args.interval / kDoubleTickDivisor)) {
...
void ExternalBeginFrameSource::AsProtozeroInto(perfetto::EventContext& ctx, perfetto::protos::pbzero::BeginFrameSourceState* state) const
{
...
void ExternalBeginFrameSource::OnBeginFrame(const BeginFrameArgs& args)
{
    ...
    TRACE_EVENT2("viz", "ExternalBeginFrameSource::OnBeginFrame", "frame_time", last_begin_frame_args_.frame_time.since_origin().InMicroseconds(), "interval",
        last_begin_frame_args_.interval.InMicroseconds());
