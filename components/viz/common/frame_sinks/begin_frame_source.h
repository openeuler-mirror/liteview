...
protected:
    ...
    void AsProtozeroInto(perfetto::EventContext& ctx, perfetto::protos::pbzero::BeginFrameObserverState* state) const;
...
public:
    ...
    public:
        ...
        BeginFrameArgs GenerateBeginFrameArgs(uint64_t source_id, base::TimeTicks frame_time, base::TimeTicks next_frame_time, base::TimeDelta vsync_interval);

        void set_dynamic_begin_frame_deadline_offset_source(DynamicBeginFrameDeadlineOffsetSource* dynamic_begin_frame_deadline_offset_source)
        {
            dynamic_begin_frame_deadline_offset_source_ = dynamic_begin_frame_deadline_offset_source;
        }
    ...
    private:
        ...
        DynamicBeginFrameDeadlineOffsetSource* dynamic_begin_frame_deadline_offset_source_ = nullptr;
    };
    ...
    virtual void AsProtozeroInto(perfetto::EventContext& ctx, perfetto::protos::pbzero::BeginFrameSourceState* state) const;

    virtual void SetDynamicBeginFrameDeadlineOffsetSource(DynamicBeginFrameDeadlineOffsetSource* dynamic_begin_frame_deadline_offset_source);
...
public:
    ...
    void AsProtozeroInto(perfetto::EventContext& ctx, perfetto::protos::pbzero::BeginFrameSourceState* state) const override;
    void OnGpuNoLongerBusy() override;
