...
public:
    ...
    struct VIZ_COMMON_EXPORT TextureResult {
        ...
        TextureResult(const gpu::Mailbox& mailbox, const gpu::SyncToken& sync_token, const gfx::ColorSpace& color_space);

        // General purpose variant:
        TextureResult(const std::array<gpu::MailboxHolder, kMaxPlanes>& planes, const gfx::ColorSpace& color_space);
