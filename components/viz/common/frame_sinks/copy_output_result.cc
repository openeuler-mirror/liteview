...
CopyOutputResult::TextureResult::TextureResult(const gpu::Mailbox& mailbox, const gpu::SyncToken& sync_token, const gfx::ColorSpace& color_space)
...
CopyOutputResult::TextureResult::TextureResult(const std::array<gpu::MailboxHolder, kMaxPlanes>& planes, const gfx::ColorSpace& color_space)
    : planes(planes)
    , color_space(color_space)
{
}
...
{
    DCHECK(format_ == Format::RGBA || format_ == Format::I420_PLANES || format == Format::NV12_PLANES);
