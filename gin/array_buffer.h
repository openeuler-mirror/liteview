...
public:
    ...
    void* bytes() const { return backing_store_ ? backing_store_->Data() : nullptr; }
    size_t num_bytes() const { return backing_store_ ? backing_store_->ByteLength() : 0; }
...
public:
    ...
    void* bytes() const { return static_cast<uint8_t*>(array_buffer_.bytes()) + offset_; }
