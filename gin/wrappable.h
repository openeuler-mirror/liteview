...
//   virtual gin_helper::ObjectTemplateBuilder GetObjectTemplateBuilder(
//       v8::Isolate* isolate);
//   ...
// };
//
...
//
// gin_helper::ObjectTemplateBuilder MyClass::GetObjectTemplateBuilder(
//     v8::Isolate* isolate) {
...
// static Create function that returns a gin_helper::Handle. Forcing creators through
...
public:
    ...
    v8::MaybeLocal<v8::Object> GetWrapper(v8::Isolate* isolate) { return GetWrapperImpl(isolate, &T::kWrapperInfo); }
...
// template <typename T> struct ToV8ReturnsMaybe<T*, typename std::enable_if<std::is_convertible<T*, WrappableBase*>::value>::type> {
