...
TEST_F(DataObjectBuilderTest, UnusableAfterBuild)
{
    ...
    logging::ScopedLogAssertHandler handler(base::BindRepeating(
        [](bool* flag, const char* file, int line, base::StringPiece message, base::StringPiece stack_trace) { *flag = true; }, base::Unretained(&has_dcheck_failure)));
    builder.Build();
...
TEST_F(DataObjectBuilderTest, CreatesDataPropertiesForIndices)
{
    ...
    v8::Local<v8::Object> object = DataObjectBuilder(isolate).Set(42, base::StringPiece("forty-two")).Build();
