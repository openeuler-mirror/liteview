...
static_assert(V8_ARRAY_BUFFER_INTERNAL_FIELD_COUNT == 2, "array buffers must have two internal fields");

// ArrayBufferAllocator -------------------------------------------------------
partition_alloc::ThreadSafePartitionRoot* ArrayBufferAllocator::partition_ = nullptr;

void* ArrayBufferAllocator::Allocate(size_t length)
{
    unsigned int flags = partition_alloc::AllocFlags::kZeroFill | partition_alloc::AllocFlags::kReturnNull;
...
void* ArrayBufferAllocator::AllocateInternal(size_t length, unsigned int flags)
{
...
{
    static base::NoDestructor<partition_alloc::PartitionAllocator> partition_allocator {};
...
public:
    absl::optional<base::span<uint8_t>> Map(base::subtle::PlatformSharedMemoryHandle handle, bool write_allowed, uint64_t offset, size_t size) override
    {
