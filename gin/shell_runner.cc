...
v8::Local<ObjectTemplate> ShellRunnerDelegate::GetGlobalTemplate(ShellRunner* runner, v8::Isolate* isolate) { return v8::Local<ObjectTemplate>(); }
...
void ShellRunnerDelegate::UnhandledException(ShellRunner* runner, TryCatch& try_catch) { CHECK(false) << try_catch.GetStackTrace(); }
...
ContextHolder* ShellRunner::GetContextHolder() { return context_holder_.get(); }
