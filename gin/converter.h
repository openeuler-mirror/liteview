...
template <typename T, typename Enable = void> struct ToV8ReturnsMaybe {
...
template <> struct GIN_EXPORT Converter<const char*> {
    ...
    static bool FromV8(v8::Isolate* isolate, v8::Local<v8::Value> val, const char** out);
};
...
template <typename T> struct Converter<std::vector<T>> {
    static std::conditional_t<ToV8ReturnsMaybe<T>::value, v8::MaybeLocal<v8::Value>, v8::Local<v8::Value>> ToV8(v8::Isolate* isolate, const std::vector<T>& val)
    {
...
template <typename T> std::conditional_t<ToV8ReturnsMaybe<T>::value, v8::MaybeLocal<v8::Value>, v8::Local<v8::Value>> ConvertToV8(v8::Isolate* isolate, const T& input)
{
    return Converter<T>::ToV8(isolate, input);
}

template <typename T> std::enable_if_t<ToV8ReturnsMaybe<T>::value, bool> TryConvertToV8(v8::Isolate* isolate, const T& input, v8::Local<v8::Value>* output)
{
...
GIN_EXPORT inline v8::Local<v8::String> StringToV8(v8::Isolate* isolate, const base::StringPiece& input) { return ConvertToV8(isolate, input).As<v8::String>(); }

// This crashes when input.size() > v8::String::kMaxLength.
GIN_EXPORT v8::Local<v8::String> StringToSymbol(v8::Isolate* isolate, const base::StringPiece& val);

// This crashes when input.size() > v8::String::kMaxLength.
GIN_EXPORT v8::Local<v8::String> StringToSymbol(v8::Isolate* isolate, const base::StringPiece16& val);
