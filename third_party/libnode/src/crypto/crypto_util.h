...
struct CSPRNGResult {
    const bool ok;
    MUST_USE_RESULT bool is_ok() const
    {
        return ok;
    }
    MUST_USE_RESULT bool is_err() const
    {
        return !ok;
    }
};
...
public:
    ...
    virtual v8::Maybe<bool> ToResult(v8::Local<v8::Value>* err, v8::Local<v8::Value>* result) = 0;
    ...
    v8::Maybe<bool> ToResult(v8::Local<v8::Value>* err, v8::Local<v8::Value>* result) override
    {
        ...
        if (success_) {
            ...
            *err = v8::Undefined(env->isolate());
            return DeriveBitsTraits::EncodeOutput(env, *CryptoJob<DeriveBitsTraits>::params(), &out_, result);
        }
...
bool SetEngine(const char* id, uint32_t flags, CryptoErrorStore* errors = nullptr);
...
template <typename T> class ArrayBufferOrViewContents {
public:
...
v8::MaybeLocal<v8::Value> EncodeBignum(Environment* env, const BIGNUM* bn, int size, v8::Local<v8::Value>* error);

v8::Maybe<bool> SetEncodedValue(Environment* env, v8::Local<v8::Object> target, v8::Local<v8::String> name, const BIGNUM* bn, int size = 0);
