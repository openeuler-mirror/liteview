...
template <typename T> void CleanupQueue::ForEachBaseObject(T&& iterator) const
{
...
BaseObject* CleanupQueue::GetBaseObject(const CleanupHookCallback& callback) const
{
