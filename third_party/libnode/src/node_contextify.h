...
public:
    ...
    static ContextifyContext* ContextFromContextifiedSandbox(Environment* env, const v8::Local<v8::Object>& sandbox);
    ...
    {
        return context()->GetEmbedderData(ContextEmbedderIndex::kSandboxObject).As<v8::Object>();
    }
...
private:
    static BaseObjectPtr<ContextifyContext> New(Environment* env, v8::Local<v8::Object> sandbox_obj, ContextOptions* options);
    // Initialize a context created from CreateV8Context()
    static BaseObjectPtr<ContextifyContext> New(v8::Local<v8::Context> ctx, Environment* env, v8::Local<v8::Object> sandbox_obj, ContextOptions* options);
    ...
    static v8::ScriptCompiler::Source GetCommonJSSourceInstance(v8::Isolate* isolate, v8::Local<v8::String> code, v8::Local<v8::String> filename,
        int line_offset, int column_offset, v8::Local<v8::PrimitiveArray> host_defined_options, v8::ScriptCompiler::CachedData* cached_data);
    static v8::ScriptCompiler::CompileOptions GetCompileOptions(const v8::ScriptCompiler::Source& source);
    static void ContainsModuleSyntax(const v8::FunctionCallbackInfo<v8::Value>& args);
...
public:
    enum InternalFields { kUnboundScriptSlot = BaseObject::kInternalFieldCount, kInternalFieldCount };
...
v8::Maybe<bool> StoreCodeCacheResult(Environment* env, v8::Local<v8::Object> target, v8::ScriptCompiler::CompileOptions compile_options,
