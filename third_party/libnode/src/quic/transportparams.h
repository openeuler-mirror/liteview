...
public:
    ...
    struct Options {
        ...
        uint64_t initial_max_stream_data_bidi_local = DEFAULT_MAX_STREAM_DATA_BIDI_LOCAL;
        ...
        uint64_t initial_max_stream_data_bidi_remote = DEFAULT_MAX_STREAM_DATA_BIDI_REMOTE;
        ...
        static v8::Maybe<const Options> From(Environment* env, v8::Local<v8::Value> value);
    };
    ...
    void GenerateStatelessResetToken(const TokenSecret& token_secret, const CID& cid);
