...
public:
    ...
    TLSContext(Environment* env, Side side, Session* session, const Options& options);
    ...
    int Receive(ngtcp2_crypto_level crypto_level, uint64_t offset, const ngtcp2_vec& vec);
