...
public:
    ...
    static constexpr error_code QUIC_ERROR_TYPE_TRANSPORT = NGTCP2_CONNECTION_CLOSE_ERROR_CODE_TYPE_TRANSPORT;
    static constexpr error_code QUIC_ERROR_TYPE_APPLICATION = NGTCP2_CONNECTION_CLOSE_ERROR_CODE_TYPE_APPLICATION;
    ...
    static QuicError ForTransport(error_code code, const std::string_view reason = "");
    static QuicError ForApplication(error_code code, const std::string_view reason = "");
