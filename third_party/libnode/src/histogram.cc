...
void HistogramBase::FastRecord(Local<Value> receiver, const int64_t value, FastApiCallbackOptions& options)
{
    if (value < 1) {
...
double HistogramImpl::FastGetPercentile(Local<Value> receiver, const double percentile)
{
    HistogramImpl* histogram = HistogramImpl::FromJSObject(receiver);
