...
namespace atom {
const int AsarJsLength = 25769;
extern char AsarJs[AsarJsLength];
}
...
void PrintCallstack()
{
    ...
    sprintf(output, "node::PrintCallstack: %d\n", count);
    ...
    , code_cache_(std::make_shared<BuiltinCodeCache>())
{
    ...
    if (!asar_resource) {
#if 1
        asar_resource = new StaticExternalOneByteResource((const uint8_t*)atom::AsarJs, atom::AsarJsLength, nullptr);
#else
...
//         std::map<std::string, UnionBytes>::iterator console_constructor_it = source2->find("internal/modules/run_main");
// 
//         static StaticExternalOneByteResource* streams_resource = nullptr;
//         if (!streams_resource) {
//             std::string* buffer = new std::string();
//             asar::ReadFileToString(L"W:\\mycode\\mb108\\third_party\\libnode\\lib\\internal\\modules\\run_main.js", buffer);
//             *buffer += '\0';
//             streams_resource = new StaticExternalOneByteResource((const uint8_t*)buffer->c_str(), buffer->size() - 1, nullptr);
//         }
//         console_constructor_it->second.changeStaticExternalOneByteResource(streams_resource);
//     }
// 
//     {
//         // unlock impl_->mutex
//         ThreadsafeCopyOnWrite<BuiltinSourceMap>::Write source2 = source_.write();
//         std::map<std::string, UnionBytes>::iterator console_constructor_it = source2->find("internal/main/run_main_module");
// 
//         static StaticExternalOneByteResource* is_main_thread_resource = nullptr;
//         if (!is_main_thread_resource) {
//             std::string* buffer = new std::string();
//             asar::ReadFileToString(L"W:\\mycode\\mb108\\third_party\\libnode\\lib\\internal\\main\\run_main_module.js", buffer);
//             *buffer += '\0';
//             is_main_thread_resource = new StaticExternalOneByteResource((const uint8_t*)buffer->c_str(), buffer->size() - 1, nullptr);
//         }
//         console_constructor_it->second.changeStaticExternalOneByteResource(is_main_thread_resource);
//     }
// 
//     {
//         //W:\mycode\mb108\third_party\libnode\lib\internal\modules\cjs\loader.js
//         ThreadsafeCopyOnWrite<BuiltinSourceMap>::Write source2 = source_.write();
//         std::map<std::string, UnionBytes>::iterator console_constructor_it = source2->find("internal/modules/cjs/loader");
// 
//         static StaticExternalOneByteResource* console_constructor_resource = nullptr;
//         if (!console_constructor_resource) {
//             std::string* buffer = new std::string();
//             asar::ReadFileToString(L"W:\\mycode\\mb108\\third_party\\libnode\\lib\\internal\\modules\\cjs\\loader.js", buffer);
//             *buffer += '\0';
...
//         // unlock impl_->mutex
//         ThreadsafeCopyOnWrite<BuiltinSourceMap>::Write source2 = source_.write();
//         std::map<std::string, UnionBytes>::iterator console_constructor_it = source2->find("internal/modules/package_json_reader");
// 
//         static StaticExternalOneByteResource* console_constructor_resource = nullptr;
//         if (!console_constructor_resource) {
//             std::string* buffer = new std::string();
//             asar::ReadFileToString(L"W:\\mycode\\mb108\\third_party\\libnode\\lib\\internal\\modules\\package_json_reader.js", buffer);
//             *buffer += '\0';
//             console_constructor_resource = new StaticExternalOneByteResource((const uint8_t*)buffer->c_str(), buffer->size() - 1, nullptr);
//         }
//         console_constructor_it->second.changeStaticExternalOneByteResource(console_constructor_resource);
...
//         // unlock impl_->mutex
//         ThreadsafeCopyOnWrite<BuiltinSourceMap>::Write source2 = source_.write();
//         std::map<std::string, UnionBytes>::iterator console_constructor_it = source2->find("internal/errors");
// 
//         static StaticExternalOneByteResource* console_constructor_resource = nullptr;
//         if (!console_constructor_resource) {
//             std::string* buffer = new std::string();
//             asar::ReadFileToString(L"W:\\mycode\\mb108\\third_party\\libnode\\lib\\internal\\errors.js", buffer);
//             *buffer += '\0';
//             console_constructor_resource = new StaticExternalOneByteResource((const uint8_t*)buffer->c_str(), buffer->size() - 1, nullptr);
//         }
//         console_constructor_it->second.changeStaticExternalOneByteResource(console_constructor_resource);
...
//         // unlock impl_->mutex
//         ThreadsafeCopyOnWrite<BuiltinSourceMap>::Write source2 = source_.write();
//         std::map<std::string, UnionBytes>::iterator console_constructor_it = source2->find("internal/validators");
// 
//         static StaticExternalOneByteResource* console_constructor_resource = nullptr;
//         if (!console_constructor_resource) {
//             std::string* buffer = new std::string();
//             asar::ReadFileToString(L"W:\\mycode\\mb108\\third_party\\libnode\\lib\\internal\\validators.js", buffer);
//             *buffer += '\0';
//             console_constructor_resource = new StaticExternalOneByteResource((const uint8_t*)buffer->c_str(), buffer->size() - 1, nullptr);
//         }
//         console_constructor_it->second.changeStaticExternalOneByteResource(console_constructor_resource);
...
//         // unlock impl_->mutex
//         ThreadsafeCopyOnWrite<BuiltinSourceMap>::Write source2 = source_.write();
//         std::map<std::string, UnionBytes>::iterator console_constructor_it = source2->find("internal/options");
// 
//         static StaticExternalOneByteResource* console_constructor_resource = nullptr;
//         if (!console_constructor_resource) {
//             std::string* buffer = new std::string();
//             asar::ReadFileToString(L"W:\\mycode\\mb108\\third_party\\libnode\\lib\\internal\\options.js", buffer);
//             *buffer += '\0';
//             console_constructor_resource = new StaticExternalOneByteResource((const uint8_t*)buffer->c_str(), buffer->size() - 1, nullptr);
//         }
//         console_constructor_it->second.changeStaticExternalOneByteResource(console_constructor_resource);
...
{
//     std::string output1 = "BuiltinLoader, LoadBuiltinSource:";
//     output1 += id;
//     output1 += "\n";
