...
public:
    ...
    uint32_t DispatchMessage(const char* method, const char* params = nullptr, bool is_profile_request = false);
    ...
    virtual v8::MaybeLocal<v8::Object> GetProfile(v8::Local<v8::Object> result) = 0;
    ...
    void RemoveProfileId(uint32_t id)
    {
