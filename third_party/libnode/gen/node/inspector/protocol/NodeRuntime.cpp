...
void Frontend::waitingForDebugger()
{
    if (!m_frontendChannel)
        return;
    m_frontendChannel->sendProtocolNotification(InternalResponse::createNotification("NodeRuntime.waitingForDebugger"));
}
...
public:
    DispatcherImpl(FrontendChannel* frontendChannel, Backend* backend)
        ...
        , m_backend(backend)
    {
        m_dispatchMap["NodeRuntime.enable"] = &DispatcherImpl::enable;
        m_dispatchMap["NodeRuntime.disable"] = &DispatcherImpl::disable;
...
protected:
    ...
    void notifyWhenWaitingForDisconnect(
...
void DispatcherImpl::notifyWhenWaitingForDisconnect(
    int callId, const String& method, const ProtocolMessage& message, std::unique_ptr<DictionaryValue> requestMessageObject, ErrorSupport* errors)
{
