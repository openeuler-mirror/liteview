...
public:
    ...
    {
        return toValue()->serializeToJSON();
    }
...
public:
    ...
    void setSessionId(const String& value)
    {
        m_sessionId = value;
    }

    protocol::NodeWorker::WorkerInfo* getWorkerInfo()
    {
        return m_workerInfo.get();
    }
    void setWorkerInfo(std::unique_ptr<protocol::NodeWorker::WorkerInfo> value)
    {
        m_workerInfo = std::move(value);
    }

    bool getWaitingForDebugger()
    {
        return m_waitingForDebugger;
    }
    void setWaitingForDebugger(bool value)
    {
        m_waitingForDebugger = value;
    }
    ...
    template <int STATE> class AttachedToWorkerNotificationBuilder {
    public:
        enum {
            NoFieldsSet = 0,
            SessionIdSet = 1 << 1,
    ...
    private:
        ...
        AttachedToWorkerNotificationBuilder()
            : m_result(new AttachedToWorkerNotification())
        {
        }
...
public:
    ...
    template <int STATE> class DetachedFromWorkerNotificationBuilder {
    public:
        enum { NoFieldsSet = 0, SessionIdSet = 1 << 1, AllFieldsSet = (SessionIdSet | 0) };
    ...
    private:
        ...
        DetachedFromWorkerNotificationBuilder()
            : m_result(new DetachedFromWorkerNotification())
        {
        }
...
public:
    ...
    template <int STATE> class ReceivedMessageFromWorkerNotificationBuilder {
    public:
        enum { NoFieldsSet = 0, SessionIdSet = 1 << 1, MessageSet = 1 << 2, AllFieldsSet = (SessionIdSet | MessageSet | 0) };
    ...
    private:
        ...
        ReceivedMessageFromWorkerNotificationBuilder()
            : m_result(new ReceivedMessageFromWorkerNotification())
        {
        }
