...
public:
    ...
    bool hasRecordMode()
    {
        return m_recordMode.isJust();
    }
    String getRecordMode(const String& defaultValue)
    {
        return m_recordMode.isJust() ? m_recordMode.fromJust() : defaultValue;
    }
...
public:
    ...
    protocol::Array<protocol::DictionaryValue>* getValue()
    {
        return m_value.get();
    }
    void setValue(std::unique_ptr<protocol::Array<protocol::DictionaryValue>> value)
    {
    ...
    template <int STATE> class DataCollectedNotificationBuilder {
    public:
