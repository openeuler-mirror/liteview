...
request_virt_sarray(j_common_ptr cinfo, int pool_id, jpg_boolean pre_zero,
...
request_virt_barray(j_common_ptr cinfo, int pool_id, jpg_boolean pre_zero,
...
access_virt_sarray(j_common_ptr cinfo, jvirt_sarray_ptr ptr,
                   JDIMENSION start_row, JDIMENSION num_rows, jpg_boolean writable)
