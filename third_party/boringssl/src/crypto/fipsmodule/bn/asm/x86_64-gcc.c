...
#if !defined(OPENSSL_NO_ASM) && defined(OPENSSL_X86_64) && (defined(__GNUC__) || defined(__clang__))
...
BN_ULONG bn_add_words(BN_ULONG* rp, const BN_ULONG* ap, const BN_ULONG* bp, size_t n)
{
    BN_ULONG ret;
    size_t i = 0;
...
BN_ULONG bn_sub_words(BN_ULONG* rp, const BN_ULONG* ap, const BN_ULONG* bp, size_t n)
{
    BN_ULONG ret;
    size_t i = 0;
...
#define mul_add_c(a, b, c0, c1, c2)                                                                                                                            \
    do {                                                                                                                                                       \
        ...
        __asm__("addq %3,%0; adcq %4,%1; adcq %5,%2" : "+r"(c0), "+r"(c1), "+r"(c2) : "r"(t1), "r"(t2), "g"(0) : "cc");                                        \
    } while (0)
