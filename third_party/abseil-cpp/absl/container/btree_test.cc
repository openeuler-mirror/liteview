...
template <typename T> struct PropagatingCountingAlloc : public CountingAllocator<T> {
...
template <typename T> void BtreeAllocatorTest()
{
    using value_type = typename T::value_type;
...
template <typename K, int N = 256> void SetTest()
{
    ...
    using CountingBtreeSet = absl::btree_set<K, std::less<K>, PropagatingCountingAlloc<K>>;
...
template <typename K, int N = 256> void MapTest()
{
    ...
    using CountingBtreeMap = absl::btree_map<K, K, std::less<K>, PropagatingCountingAlloc<std::pair<const K, K>>>;
...
template <typename K, int N = 256> void MultiSetTest()
{
    ...
    using CountingBtreeMSet = absl::btree_multiset<K, std::less<K>, PropagatingCountingAlloc<K>>;
...
template <typename K, int N = 256> void MultiMapTest()
{
    ...
    using CountingBtreeMMap = absl::btree_multimap<K, K, std::less<K>, PropagatingCountingAlloc<std::pair<const K, K>>>;
...
public:
    ...
    template <typename Btree> constexpr static bool UsesGenerations()
    {
...
TEST(Btree, MoveAssignmentAllocatorPropagation)
{
    ...
    {
        absl::btree_set<MovableOnlyInstance, std::less<MovableOnlyInstance>, PropagatingCountingAlloc<MovableOnlyInstance>> set1(cmp, allocator1),
            set2(cmp, allocator2);
    ...
    {
        absl::btree_set<MovableOnlyInstance, std::less<MovableOnlyInstance>, CountingAllocator<MovableOnlyInstance>> set1(cmp, allocator1),
            set2(cmp, allocator1);
