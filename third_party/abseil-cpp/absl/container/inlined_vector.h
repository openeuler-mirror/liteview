...
template <typename T, size_t N, typename A = std::allocator<T>> class InlinedVector {
    ...
    template <typename TheA> using IsMemcpyOk = inlined_vector_internal::IsMemcpyOk<TheA>;
