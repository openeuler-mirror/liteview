...
#elif defined(_LIBCPP_VERSION) || defined(_MSC_VER) || (defined(__clang__) && __clang_major__ >= 15)                                                           \
    || (!defined(__clang__) && defined(__GLIBCXX__) && ABSL_INTERNAL_HAVE_MIN_GNUC_VERSION(4, 8))
...
#elif (defined(__clang__) && defined(_LIBCPP_VERSION)) || (defined(__clang__) && __clang_major__ >= 15)                                                        \
    || (!defined(__clang__)                                                                                                                                    \
        && ((ABSL_INTERNAL_HAVE_MIN_GNUC_VERSION(7, 4) && defined(__GLIBCXX__)) || (ABSL_INTERNAL_HAVE_MIN_GNUC_VERSION(8, 2) && defined(_LIBCPP_VERSION))))   \
...
//
#if ABSL_HAVE_FEATURE(cxx_thread_local) && !(TARGET_OS_IPHONE && __IPHONE_OS_VERSION_MIN_REQUIRED < __IPHONE_9_0)
...
#elif !(defined(__GNUC__) && (__GNUC__ < 5) && !defined(__EXCEPTIONS)) && !(ABSL_INTERNAL_HAVE_MIN_GNUC_VERSION(5, 0) && !defined(__cpp_exceptions))           \
...
#error ABSL_HAVE_MMAP cannot be directly set
    ...
    || defined(__asmjs__) || defined(__wasm__) || defined(__Fuchsia__) || defined(__sun) || defined(__ASYLO__) || defined(__myriad2__) || defined(__HAIKU__)   \
...
// corrected earlier versions with new XCode.
    ...
    && ((_LIBCPP_VERSION >= 11000 && /* XCode 12.5 or later: */                                                                                                \
        ...
        || (_LIBCPP_VERSION < 11000 && /* Pre-XCode 12.5: */                                                                                                   \
            ((defined(__ENVIRONMENT_MAC_OS_X_VERSION_MIN_REQUIRED__) && __ENVIRONMENT_MAC_OS_X_VERSION_MIN_REQUIRED__ < 101400)                                \
