...
template <typename To> constexpr To implicit_cast(typename absl::internal::identity_t<To> to)
{
    return to;
}
...
template <typename Dest, typename Source,
    typename std::enable_if<sizeof(Dest) == sizeof(Source) && type_traits_internal::is_trivially_copyable<Source>::value
