...
const std::string& GetTestTempDir()
{
    static std::string* temp_dir_name = []() -> std::string* {
        ...
        if (res->empty()) {
            ABSL_INTERNAL_LOG(FATAL, "Failed to make temporary directory for data files");
        }
...
TEST_F(ParseTest, TestKeepParsedArgs)
{
    ...
    EXPECT_THAT(out_args1,
        ElementsAreArray(
            { absl::string_view("testbin"), absl::string_view("arg1"), absl::string_view("arg2"), absl::string_view("arg3"), absl::string_view("arg4") }));

    auto out_args2 = flags::ParseCommandLineImpl(11, const_cast<char**>(in_args1), flags::ArgvListAction::kKeepParsedArgs,
        flags::UsageFlagsAction::kHandleUsage, flags::OnUndefinedFlag::kAbortIfUndefined);

    EXPECT_THAT(out_args2,
        ElementsAreArray({ absl::string_view("testbin"), absl::string_view("--bool_flag"), absl::string_view("--int_flag=211"),
            absl::string_view("--double_flag=1.1"), absl::string_view("--string_flag"), absl::string_view("asd"), absl::string_view("--"),
            absl::string_view("arg1"), absl::string_view("arg2"), absl::string_view("arg3"), absl::string_view("arg4") }));
}
...
TEST_F(ParseTest, TestIgnoreUndefinedFlags)
{
    ...
    auto out_args1 = flags::ParseCommandLineImpl(4, const_cast<char**>(in_args1), flags::ArgvListAction::kRemoveParsedArgs,
        flags::UsageFlagsAction::kHandleUsage, flags::OnUndefinedFlag::kIgnoreUndefined);

    EXPECT_THAT(out_args1, ElementsAreArray({ absl::string_view("testbin"), absl::string_view("arg1") }));
    ...
    auto out_args2 = flags::ParseCommandLineImpl(4, const_cast<char**>(in_args2), flags::ArgvListAction::kKeepParsedArgs, flags::UsageFlagsAction::kHandleUsage,
        flags::OnUndefinedFlag::kIgnoreUndefined);

    EXPECT_THAT(out_args2,
        ElementsAreArray(
            { absl::string_view("testbin"), absl::string_view("--undef_flag=aa"), absl::string_view("--string_flag=AA"), absl::string_view("arg1") }));
...
TEST_F(ParseDeathTest, TestSimpleHelpFlagHandling)
{
    ...
    auto out_args2 = flags::ParseCommandLineImpl(3, const_cast<char**>(in_args2), flags::ArgvListAction::kRemoveParsedArgs,
        flags::UsageFlagsAction::kIgnoreUsage, flags::OnUndefinedFlag::kAbortIfUndefined);
...
TEST_F(ParseDeathTest, TestSubstringHelpFlagHandling)
{
    ...
    auto out_args1 = flags::ParseCommandLineImpl(2, const_cast<char**>(in_args1), flags::ArgvListAction::kRemoveParsedArgs,
        flags::UsageFlagsAction::kIgnoreUsage, flags::OnUndefinedFlag::kAbortIfUndefined);
