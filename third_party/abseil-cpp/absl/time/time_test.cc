...
#undef TEST_FLOOR_CONVERSION
    ...
    EXPECT_EQ(0, absl::ToUniversal(absl::UniversalEpoch() + absl::Nanoseconds(0)));
...
{
#if defined(ABSL_SKIP_TIME_TESTS_BROKEN_ON_MSVC_OPT) && ABSL_SKIP_TIME_TESTS_BROKEN_ON_MSVC_OPT
    GTEST_SKIP();
#endif
