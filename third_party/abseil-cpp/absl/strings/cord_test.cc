...
public:
    ...
    static Cord MakeSubstring(Cord src, size_t offset, size_t length)
    {
        ...
        ABSL_RAW_CHECK(src.ExpectedChecksum() == absl::nullopt, "Can not be hardened");
        Cord cord;
...
TEST_P(CordTest, DiabolicalGrowth)
{
    ...
    ABSL_RAW_LOG(INFO, "Diabolical size allocated = %zu", cord.EstimatedMemoryUsage());
}
...
struct CordLeaker {
    ...
    constexpr explicit CordLeaker(const Str& str)
        : cord(str)
    {
    }
...
template <typename Str> void TestConstinitConstructor(Str)
{
...
{
    TestConstinitConstructor(absl::strings_internal::MakeStringConstant(ShortView {}));
    TestConstinitConstructor(absl::strings_internal::MakeStringConstant(LongView {}));
}
...
CordMutator cord_mutators[] = {
    ...
    { "append string", [](absl::Cord& c) { c.Append("0123456789"); }, [](absl::Cord& c) { c.RemoveSuffix(10); } },
    { "append cord",
        [](absl::Cord& c) {
    ...
    { "append checksummed cord",
        ...
        [](absl::Cord& c) { c.RemoveSuffix(10); } },
    { "append self", [](absl::Cord& c) { c.Append(c); }, [](absl::Cord& c) { c.RemoveSuffix(c.size() / 2); } },
    { "prepend string", [](absl::Cord& c) { c.Prepend("9876543210"); }, [](absl::Cord& c) { c.RemovePrefix(10); } },
    { "prepend cord",
        [](absl::Cord& c) {
    ...
    { "prepend checksummed cord",
        ...
        [](absl::Cord& c) { c.RemovePrefix(10); } },
    { "prepend self", [](absl::Cord& c) { c.Prepend(c); }, [](absl::Cord& c) { c.RemovePrefix(c.size() / 2); } },
