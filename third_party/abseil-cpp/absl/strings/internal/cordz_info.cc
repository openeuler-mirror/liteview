...
private:
    ...
    void AnalyzeRing(RepRef rep)
    {
        ...
        ring->ForEach([&](CordRepRing::index_type pos) { CountLinearReps(rep.Child(ring->entry_child(pos)), memory_usage_); });
    }
...
CordzInfo::CordzInfo(CordRep* rep, const CordzInfo* src, MethodIdentifier method)
    : rep_(rep)
