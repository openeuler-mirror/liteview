...
#if defined(_LIBCPP_VERSION) && (_LIBCPP_STD_VER <= 11 || defined(_LIBCPP_HAS_NO_CXX14_CONSTEXPR))
...
#if !defined(ABSL_SKIP_OVERLOAD_TEST_DUE_TO_MSVC_BUG) && !defined(ABSL_SKIP_OVERLOAD_TEST_DUE_TO_GCC_BUG)
