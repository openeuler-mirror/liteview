...
public:
    ...
    void Send(const absl::LogEntry& entry) override
    {
        ...
        __android_log_write(level, "native", entry.text_message_with_prefix_and_newline_c_str());
...
#endif
#if defined(_WIN32)
        static WindowsDebuggerLogSink* debugger_log_sink = new WindowsDebuggerLogSink;
