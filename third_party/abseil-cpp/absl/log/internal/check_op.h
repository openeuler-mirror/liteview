...
#define ABSL_LOG_INTERNAL_CHECK_OP(name, op, val1, val2)                                                                                                       \
    while (::std::string* absl_log_internal_check_op_result ABSL_ATTRIBUTE_UNUSED                                                                              \
        = ::absl::log_internal::name##Impl(::absl::log_internal::GetReferenceableValue(val1), ::absl::log_internal::GetReferenceableValue(val2),               \
            ABSL_LOG_INTERNAL_STRIP_STRING_LITERAL(#val1 " " #op " " #val2)))                                                                                  \
...
#define ABSL_LOG_INTERNAL_QCHECK_OP(name, op, val1, val2)                                                                                                      \
    while (::std::string* absl_log_internal_qcheck_op_result = ::absl::log_internal::name##Impl(::absl::log_internal::GetReferenceableValue(val1),             \
               ::absl::log_internal::GetReferenceableValue(val2), ABSL_LOG_INTERNAL_STRIP_STRING_LITERAL(#val1 " " #op " " #val2)))                            \
...
#define ABSL_LOG_INTERNAL_CHECK_STROP(func, op, expected, s1, s2)                                                                                              \
    while (::std::string* absl_log_internal_check_strop_result                                                                                                 \
        = ::absl::log_internal::Check##func##expected##Impl((s1), (s2), ABSL_LOG_INTERNAL_STRIP_STRING_LITERAL(#s1 " " #op " " #s2)))                          \
...
#define ABSL_LOG_INTERNAL_CHECK_OK(val)                                                                                                                        \
    for (::std::pair<const ::absl::Status*, ::std::string*> absl_log_internal_check_ok_goo;                                                                    \
         ...
         absl_log_internal_check_ok_goo.second = ABSL_PREDICT_TRUE(absl_log_internal_check_ok_goo.first->ok())                                                 \
             ? nullptr                                                                                                                                         \
             : ::absl::status_internal::MakeCheckFailString(absl_log_internal_check_ok_goo.first, ABSL_LOG_INTERNAL_STRIP_STRING_LITERAL(#val " is OK")),      \
...
#define ABSL_LOG_INTERNAL_QCHECK_OK(val)                                                                                                                       \
    for (::std::pair<const ::absl::Status*, ::std::string*> absl_log_internal_check_ok_goo;                                                                    \
         ...
         absl_log_internal_check_ok_goo.second = ABSL_PREDICT_TRUE(absl_log_internal_check_ok_goo.first->ok())                                                 \
             ...
             : ::absl::status_internal::MakeCheckFailString(absl_log_internal_check_ok_goo.first, ABSL_LOG_INTERNAL_STRIP_STRING_LITERAL(#val " is OK")),      \
         !ABSL_PREDICT_TRUE(absl_log_internal_check_ok_goo.first->ok());)                                                                                      \
    ABSL_LOG_INTERNAL_QCHECK(*absl_log_internal_check_ok_goo.second).InternalStream()
...
#define ABSL_LOG_INTERNAL_CHECK_OP_IMPL(name, op)                                                                                                              \
    ...
    {                                                                                                                                                          \
        ...
        return ABSL_PREDICT_TRUE(v1 op v2) ? nullptr : MakeCheckOpString<U1, U2>(v1, v2, exprtext);                                                            \
    }                                                                                                                                                          \
