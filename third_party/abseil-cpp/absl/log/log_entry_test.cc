...
public:
        ...
        : buf_(15000, '\0')
    {
        ...
        entry_.prefix_len_ = entry_.prefix_
            ? log_internal::FormatLogPrefix(entry_.log_severity(), entry_.timestamp(), entry_.tid(), entry_.source_basename(), entry_.source_line(), view)
            : 0;
    ...
    std::string FormatLogMessage() const
    {
        return log_internal::FormatLogMessage(
            entry_.log_severity(), ci_.cs, ci_.subsecond, entry_.tid(), entry_.source_basename(), entry_.source_line(), entry_.text_message());
    }
    std::string FormatPrefixIntoSizedBuffer(size_t sz)
    {
        ...
        const size_t prefix_size
            = log_internal::FormatLogPrefix(entry_.log_severity(), entry_.timestamp(), entry_.tid(), entry_.source_basename(), entry_.source_line(), buf);
...
{
    LogEntryTestPeer entry("foo.cc", 1234, kUsePrefix, absl::LogSeverity::kInfo, "2020-01-02T03:04:05.6789", 451, "hello world");
...
{
    LogEntryTestPeer entry("foo.cc", 1234, kNoPrefix, absl::LogSeverity::kInfo, "2020-01-02T03:04:05.6789", 451, "hello world");
    EXPECT_THAT(entry.FormatLogMessage(), Eq("I0102 03:04:05.678900     451 foo.cc:1234] hello world"));
...
{
    LogEntryTestPeer entry("", 0, kUsePrefix, absl::LogSeverity::kInfo, "2020-01-02T03:04:05", 0, "");
...
TEST(LogEntryTest, LongFields)
{
    LogEntryTestPeer entry("I am the very model of a modern Major-General / "
        ...
        2147483647, kUsePrefix, absl::LogSeverity::kInfo, "2020-01-02T03:04:05.678967896789", 2147483647,
