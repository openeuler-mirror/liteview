...
TEST(LogStreamerTest, LogInfoStreamer)
{
    ...
    EXPECT_CALL(test_sink,
        Send(AllOf(SourceFilename(Eq("path/file.cc")), SourceLine(Eq(1234)), Prefix(IsTrue()), LogSeverity(Eq(absl::LogSeverity::kInfo)),
            TimestampInMatchWindow(), ThreadID(Eq(absl::base_internal::GetTID())), TextMessage(Eq("WriteToStream: foo")),
...
TEST(LogStreamerTest, PassedByReference)
{
    ...
    EXPECT_CALL(test_sink,
        Send(AllOf(SourceFilename(Eq("path/file.cc")), SourceLine(Eq(1234)), TextMessage(Eq("WriteToStreamRef: foo")), ENCODED_MESSAGE(EqualsProto(R"pb(value {
...
TEST(LogStreamerTest, LogsEmptyLine)
{
    ...
    EXPECT_CALL(test_sink,
        Send(AllOf(SourceFilename(Eq("path/file.cc")), SourceLine(Eq(1234)), TextMessage(Eq("")), ENCODED_MESSAGE(EqualsProto(R"pb(value {
                                                                       str: ""
                                                                     })pb")),
            Stacktrace(IsEmpty()))));
    ...
    EXPECT_EXIT(
        {
            ...
            EXPECT_CALL(
                test_sink, Send(AllOf(SourceFilename(Eq("path/file.cc")), TextMessage(Eq("")), ENCODED_MESSAGE(EqualsProto(R"pb(value { str: "" })pb")))))
                .WillOnce(DeathTestExpectedLogging());
...
TEST(LogStreamerTest, MoveConstruction)
{
    ...
    EXPECT_CALL(test_sink,
        Send(AllOf(SourceFilename(Eq("path/file.cc")), SourceLine(Eq(1234)), LogSeverity(Eq(absl::LogSeverity::kInfo)),
            TextMessage(Eq("hello 0x10 world 0x10")), ENCODED_MESSAGE(EqualsProto(R"pb(value {
