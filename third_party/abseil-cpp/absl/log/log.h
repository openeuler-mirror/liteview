...
//
//   LOG(INFO) << "Found " << num_cookies << " cookies";
#define LOG(severity) ABSL_LOG_INTERNAL_CONDITION_##severity(STATELESS, true) ABSL_LOGGING_INTERNAL_LOG_##severity.InternalStream()

// PLOG()
//
// `PLOG` behaves like `LOG` except that a description of the current state of
// `errno` is appended to the streamed message.
#define PLOG(severity) ABSL_LOG_INTERNAL_CONDITION_##severity(STATELESS, true) ABSL_LOGGING_INTERNAL_LOG_##severity.InternalStream().WithPerror()
...
#ifndef NDEBUG
#define DLOG(severity) ABSL_LOG_INTERNAL_CONDITION_##severity(STATELESS, true) ABSL_LOGGING_INTERNAL_LOG_##severity.InternalStream()
#else
#define DLOG(severity) ABSL_LOG_INTERNAL_CONDITION_##severity(STATELESS, false) ABSL_LOGGING_INTERNAL_LOG_##severity.InternalStream()
#endif
...
#define LOG_IF(severity, condition) ABSL_LOG_INTERNAL_CONDITION_##severity(STATELESS, condition) ABSL_LOGGING_INTERNAL_LOG_##severity.InternalStream()
#define PLOG_IF(severity, condition)                                                                                                                           \
    ABSL_LOG_INTERNAL_CONDITION_##severity(STATELESS, condition) ABSL_LOGGING_INTERNAL_LOG_##severity.InternalStream().WithPerror()

#ifndef NDEBUG
#define DLOG_IF(severity, condition) ABSL_LOG_INTERNAL_CONDITION_##severity(STATELESS, condition) ABSL_LOGGING_INTERNAL_LOG_##severity.InternalStream()
#else
#define DLOG_IF(severity, condition)                                                                                                                           \
    ABSL_LOG_INTERNAL_CONDITION_##severity(STATELESS, false && (condition)) ABSL_LOGGING_INTERNAL_LOG_##severity.InternalStream()
#endif
...
//                              << " total)";
#define LOG_EVERY_N(severity, n) ABSL_LOG_INTERNAL_CONDITION_##severity(STATEFUL, true)(EveryN, n) ABSL_LOGGING_INTERNAL_LOG_##severity.InternalStream()
...
// thread-safe.
#define LOG_FIRST_N(severity, n) ABSL_LOG_INTERNAL_CONDITION_##severity(STATEFUL, true)(FirstN, n) ABSL_LOGGING_INTERNAL_LOG_##severity.InternalStream()
...
#define LOG_EVERY_POW_2(severity) ABSL_LOG_INTERNAL_CONDITION_##severity(STATEFUL, true)(EveryPow2) ABSL_LOGGING_INTERNAL_LOG_##severity.InternalStream()
...
#define LOG_EVERY_N_SEC(severity, n_seconds)                                                                                                                   \
    ABSL_LOG_INTERNAL_CONDITION_##severity(STATEFUL, true)(EveryNSec, n_seconds) ABSL_LOGGING_INTERNAL_LOG_##severity.InternalStream()

#define PLOG_EVERY_N(severity, n)                                                                                                                              \
    ABSL_LOG_INTERNAL_CONDITION_##severity(STATEFUL, true)(EveryN, n) ABSL_LOGGING_INTERNAL_LOG_##severity.InternalStream().WithPerror()

#define PLOG_FIRST_N(severity, n)                                                                                                                              \
    ABSL_LOG_INTERNAL_CONDITION_##severity(STATEFUL, true)(FirstN, n) ABSL_LOGGING_INTERNAL_LOG_##severity.InternalStream().WithPerror()

#define PLOG_EVERY_POW_2(severity)                                                                                                                             \
    ABSL_LOG_INTERNAL_CONDITION_##severity(STATEFUL, true)(EveryPow2) ABSL_LOGGING_INTERNAL_LOG_##severity.InternalStream().WithPerror()

#define PLOG_EVERY_N_SEC(severity, n_seconds)                                                                                                                  \
    ABSL_LOG_INTERNAL_CONDITION_##severity(STATEFUL, true)(EveryNSec, n_seconds) ABSL_LOGGING_INTERNAL_LOG_##severity.InternalStream().WithPerror()
...
#define VLOG_EVERY_N(verbose_level, n)                                                                                                                         \
    for (int absl_logging_internal_verbose_level = (verbose_level), absl_logging_internal_log_loop = 1; absl_logging_internal_log_loop;                        \
         absl_logging_internal_log_loop = 0)                                                                                                                   \
        ABSL_LOG_INTERNAL_CONDITION_INFO(STATEFUL, VLOG_IS_ON(absl_logging_internal_verbose_level))                                                            \
...
#define LOG_IF_EVERY_N(severity, condition, n)                                                                                                                 \
    ABSL_LOG_INTERNAL_CONDITION_##severity(STATEFUL, condition)(EveryN, n) ABSL_LOGGING_INTERNAL_LOG_##severity.InternalStream()

#define LOG_IF_FIRST_N(severity, condition, n)                                                                                                                 \
    ABSL_LOG_INTERNAL_CONDITION_##severity(STATEFUL, condition)(FirstN, n) ABSL_LOGGING_INTERNAL_LOG_##severity.InternalStream()

#define LOG_IF_EVERY_POW_2(severity, condition)                                                                                                                \
    ABSL_LOG_INTERNAL_CONDITION_##severity(STATEFUL, condition)(EveryPow2) ABSL_LOGGING_INTERNAL_LOG_##severity.InternalStream()

#define LOG_IF_EVERY_N_SEC(severity, condition, n_seconds)                                                                                                     \
    ABSL_LOG_INTERNAL_CONDITION_##severity(STATEFUL, condition)(EveryNSec, n_seconds) ABSL_LOGGING_INTERNAL_LOG_##severity.InternalStream()

#define PLOG_IF_EVERY_N(severity, condition, n)                                                                                                                \
    ABSL_LOG_INTERNAL_CONDITION_##severity(STATEFUL, condition)(EveryN, n) ABSL_LOGGING_INTERNAL_LOG_##severity.InternalStream().WithPerror()

#define PLOG_IF_FIRST_N(severity, condition, n)                                                                                                                \
    ABSL_LOG_INTERNAL_CONDITION_##severity(STATEFUL, condition)(FirstN, n) ABSL_LOGGING_INTERNAL_LOG_##severity.InternalStream().WithPerror()

#define PLOG_IF_EVERY_POW_2(severity, condition)                                                                                                               \
    ABSL_LOG_INTERNAL_CONDITION_##severity(STATEFUL, condition)(EveryPow2) ABSL_LOGGING_INTERNAL_LOG_##severity.InternalStream().WithPerror()

#define PLOG_IF_EVERY_N_SEC(severity, condition, n_seconds)                                                                                                    \
    ABSL_LOG_INTERNAL_CONDITION_##severity(STATEFUL, condition)(EveryNSec, n_seconds) ABSL_LOGGING_INTERNAL_LOG_##severity.InternalStream().WithPerror()
...
#else // def NDEBUG
#define DLOG_IF_EVERY_N(severity, condition, n)                                                                                                                \
    ABSL_LOG_INTERNAL_CONDITION_##severity(STATEFUL, false && (condition))(EveryN, n) ABSL_LOGGING_INTERNAL_LOG_##severity.InternalStream()

#define DLOG_IF_FIRST_N(severity, condition, n)                                                                                                                \
    ABSL_LOG_INTERNAL_CONDITION_##severity(STATEFUL, false && (condition))(FirstN, n) ABSL_LOGGING_INTERNAL_LOG_##severity.InternalStream()

#define DLOG_IF_EVERY_POW_2(severity, condition)                                                                                                               \
    ABSL_LOG_INTERNAL_CONDITION_##severity(STATEFUL, false && (condition))(EveryPow2) ABSL_LOGGING_INTERNAL_LOG_##severity.InternalStream()

#define DLOG_IF_EVERY_N_SEC(severity, condition, n_seconds)                                                                                                    \
    ABSL_LOG_INTERNAL_CONDITION_##severity(STATEFUL, false && (condition))(EveryNSec, n_seconds) ABSL_LOGGING_INTERNAL_LOG_##severity.InternalStream()
#endif // def NDEBUG
