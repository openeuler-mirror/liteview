...
TEST(LogFormatTest, NoMessage)
{
    ...
    EXPECT_CALL(test_sink,
        Send(AllOf(TextMessage(MatchesOstream(ComparisonStream())),
            TextPrefix(Truly([=](absl::string_view msg) { return absl::EndsWith(msg, absl::StrCat(" log_format_test.cc:", log_line, "] ")); })),
...
TYPED_TEST(CharLogFormatTest, Printable)
{
    ...
    EXPECT_CALL(test_sink,
        Send(AllOf(TextMessage(MatchesOstream(comparison_stream)), TextMessage(Eq("x")), ENCODED_MESSAGE(EqualsProto(R"pb(value { str: "x" })pb")))));
...
TYPED_TEST(CharLogFormatTest, Unprintable)
{
    ...
    EXPECT_CALL(test_sink, Send(AllOf(TextMessage(MatchesOstream(comparison_stream)), TextMessage(Eq("\xee")), ENCODED_MESSAGE(EqualsProto(R"pb(value {
                                                               str: "\xee"
                                                             })pb")))));
...
TYPED_TEST(UnsignedIntLogFormatTest, Positive)
{
    ...
    EXPECT_CALL(test_sink,
        Send(AllOf(TextMessage(MatchesOstream(comparison_stream)), TextMessage(Eq("224")), ENCODED_MESSAGE(EqualsProto(R"pb(value { str: "224" })pb")))));
...
TYPED_TEST(UnsignedIntLogFormatTest, BitfieldPositive)
{
    ...
    EXPECT_CALL(test_sink,
        Send(AllOf(TextMessage(MatchesOstream(comparison_stream)), TextMessage(Eq("42")), ENCODED_MESSAGE(EqualsProto(R"pb(value { str: "42" })pb")))));
...
TYPED_TEST(SignedIntLogFormatTest, Negative)
{
    ...
    EXPECT_CALL(test_sink, Send(AllOf(TextMessage(MatchesOstream(comparison_stream)), TextMessage(Eq("-112")), ENCODED_MESSAGE(EqualsProto(R"pb(value {
                                                               str: "-112"
                                                             })pb")))));
...
TYPED_TEST(SignedIntLogFormatTest, BitfieldPositive)
{
    ...
    EXPECT_CALL(test_sink,
        Send(AllOf(TextMessage(MatchesOstream(comparison_stream)), TextMessage(Eq("21")), ENCODED_MESSAGE(EqualsProto(R"pb(value { str: "21" })pb")))));
...
TYPED_TEST(FloatingPointLogFormatTest, Zero)
{
    ...
    EXPECT_CALL(test_sink,
        Send(AllOf(TextMessage(MatchesOstream(comparison_stream)), TextMessage(Eq("0")), ENCODED_MESSAGE(EqualsProto(R"pb(value { str: "0" })pb")))));
...
TYPED_TEST(FloatingPointLogFormatTest, Integer)
{
    ...
    EXPECT_CALL(test_sink,
        Send(AllOf(TextMessage(MatchesOstream(comparison_stream)), TextMessage(Eq("1")), ENCODED_MESSAGE(EqualsProto(R"pb(value { str: "1" })pb")))));
...
TYPED_TEST(FloatingPointLogFormatTest, NegativeInfinity)
{
    ...
    EXPECT_CALL(test_sink,
        Send(AllOf(TextMessage(MatchesOstream(comparison_stream)), TextMessage(AnyOf(Eq("-inf"), Eq("-Inf"))), ENCODED_MESSAGE(EqualsProto(R"pb(value {
                                                               str: "-inf"
                                                             })pb")))));
...
template <typename T> class VolatileVoidPtrLogFormatTest : public testing::Test { };
...
TYPED_TEST(VolatileVoidPtrLogFormatTest, Null)
{
    ...
    EXPECT_CALL(test_sink, Send(AllOf(TextMessage(MatchesOstream(comparison_stream)), TextMessage(Eq("false")), ENCODED_MESSAGE(EqualsProto(R"pb(value {
                                                               str: "false"
                                                             })pb")))));
...
TYPED_TEST(VolatileVoidPtrLogFormatTest, NonNull)
{
    ...
    EXPECT_CALL(test_sink, Send(AllOf(TextMessage(MatchesOstream(comparison_stream)), TextMessage(Eq("true")), ENCODED_MESSAGE(EqualsProto(R"pb(value {
                                                               str: "true"
                                                             })pb")))));
...
TYPED_TEST(CharPtrLogFormatTest, Null)
{
    ...
    EXPECT_CALL(test_sink,
        Send(AllOf(
            ...
            TextMessage(Eq("(null)")), ENCODED_MESSAGE(EqualsProto(R"pb(value { str: "(null)" })pb")))));
...
TYPED_TEST(CharPtrLogFormatTest, NonNull)
{
    ...
    EXPECT_CALL(test_sink, Send(AllOf(TextMessage(MatchesOstream(comparison_stream)), TextMessage(Eq("value")), ENCODED_MESSAGE(EqualsProto(R"pb(value {
                                                               str: "value"
                                                             })pb")))));
...
TEST(LogFormatTest, Custom)
{
    ...
    EXPECT_CALL(test_sink, Send(AllOf(TextMessage(MatchesOstream(comparison_stream)), TextMessage(Eq("CustomClass{}")), ENCODED_MESSAGE(EqualsProto(R"pb(value {
                                                            str: "CustomClass{}"
                                                          })pb")))));
    test_sink.StartCapturingLogs();
    LOG(INFO) << value;
...
TEST(LogFormatTest, CustomNonCopyable)
{
    ...
    EXPECT_CALL(test_sink,
        Send(AllOf(TextMessage(MatchesOstream(comparison_stream)), TextMessage(Eq("CustomClassNonCopyable{}")),
            ENCODED_MESSAGE(EqualsProto(R"pb(value { str: "CustomClassNonCopyable{}" })pb")))));
...
TEST(ManipulatorLogFormatTest, ShowPoint)
{
    ...
    EXPECT_CALL(test_sink,
        Send(AllOf(TextMessage(MatchesOstream(comparison_stream)), TextMessage(Eq("77 77.0000 77")), ENCODED_MESSAGE(EqualsProto(R"pb(value { str: "77" }
                                                  value { literal: " " }
                                                  value { str: "77.0000" }
                                                  value { literal: " " }
                                                  value { str: "77" })pb")))));
...
TEST(ManipulatorLogFormatTest, ShowPos)
{
    ...
    EXPECT_CALL(
        test_sink, Send(AllOf(TextMessage(MatchesOstream(comparison_stream)), TextMessage(Eq("77 +77 77")), ENCODED_MESSAGE(EqualsProto(R"pb(value { str: "77" }
                                                  value { literal: " " }
                                                  value { str: "+77" }
                                                  value { literal: " " }
                                                  value { str: "77" })pb")))));
...
TEST(ManipulatorLogFormatTest, Hex)
{
    ...
    EXPECT_CALL(test_sink, Send(AllOf(TextMessage(MatchesOstream(comparison_stream)), TextMessage(Eq("0x77")), ENCODED_MESSAGE(EqualsProto(R"pb(value {
                                                               str: "0x77"
                                                             })pb")))));
    test_sink.StartCapturingLogs();
...
TEST(ManipulatorLogFormatTest, Oct)
{
    ...
    EXPECT_CALL(test_sink,
        Send(AllOf(TextMessage(MatchesOstream(comparison_stream)), TextMessage(Eq("077")), ENCODED_MESSAGE(EqualsProto(R"pb(value { str: "077" })pb")))));
...
TEST(ManipulatorLogFormatTest, Dec)
{
    ...
    EXPECT_CALL(test_sink,
        Send(AllOf(TextMessage(MatchesOstream(comparison_stream)), TextMessage(Eq("77")), ENCODED_MESSAGE(EqualsProto(R"pb(value { str: "77" })pb")))));
...
TEST(ManipulatorLogFormatTest, ShowbaseHex)
{
    ...
    EXPECT_CALL(test_sink,
        Send(AllOf(TextMessage(MatchesOstream(comparison_stream)), TextMessage(Eq("77 0x77 77")), ENCODED_MESSAGE(EqualsProto(R"pb(value { str: "77" }
                                                  value { literal: " " }
                                                  value { str: "0x77" }
                                                  value { literal: " " }
                                                  value { str: "77" })pb")))));
...
TEST(ManipulatorLogFormatTest, ShowbaseOct)
{
    ...
    EXPECT_CALL(
        test_sink, Send(AllOf(TextMessage(MatchesOstream(comparison_stream)), TextMessage(Eq("77 077 77")), ENCODED_MESSAGE(EqualsProto(R"pb(value { str: "77" }
                                                  value { literal: " " }
                                                  value { str: "077" }
                                                  value { literal: " " }
                                                  value { str: "77" })pb")))));
...
TEST(ManipulatorLogFormatTest, FixedFloat)
{
    ...
    EXPECT_CALL(
        test_sink, Send(AllOf(TextMessage(MatchesOstream(comparison_stream)), TextMessage(Eq("77000000.000000")), ENCODED_MESSAGE(EqualsProto(R"pb(value {
                                                    str: "77000000.000000"
                                                  })pb")))));
...
TEST(ManipulatorLogFormatTest, ScientificFloat)
{
    ...
    EXPECT_CALL(test_sink, Send(AllOf(TextMessage(MatchesOstream(comparison_stream)), TextMessage(Eq("7.700000e+07")), ENCODED_MESSAGE(EqualsProto(R"pb(value {
                                                            str: "7.700000e+07"
                                                          })pb")))));
...
TEST(ManipulatorLogFormatTest, DefaultFloatFloat)
{
    ...
    EXPECT_CALL(test_sink, Send(AllOf(TextMessage(MatchesOstream(comparison_stream)), TextMessage(Eq("7.7e+07")), ENCODED_MESSAGE(EqualsProto(R"pb(value {
                                                            str: "7.7e+07"
                                                          })pb")))));
...
TEST(ManipulatorLogFormatTest, SetPrecisionOverflow)
{
    ...
    EXPECT_CALL(test_sink,
        Send(AllOf(TextMessage(MatchesOstream(comparison_stream)), TextMessage(Eq("602214085700000015187968")),
            ENCODED_MESSAGE(EqualsProto(R"pb(value { str: "602214085700000015187968" })pb")))));
...
TEST(ManipulatorLogFormatTest, Left)
{
    ...
    EXPECT_CALL(test_sink, Send(AllOf(TextMessage(MatchesOstream(comparison_stream)), TextMessage(Eq("-77     ")), ENCODED_MESSAGE(EqualsProto(R"pb(value {
                                                            str: "-77     "
                                                          })pb")))));
...
TEST(OverflowTest, TruncatesStrings)
{
    ...
    EXPECT_CALL(test_sink, Send(TextMessage(AllOf(SizeIs(AllOf(Ge(buffer_size - 256), Le(buffer_size))), Each(Eq('x'))))));
