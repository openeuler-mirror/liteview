...
void ABSL_ATTRIBUTE_NOINLINE TestWithPCInsideNonInlineFunction()
{
    ...
    ABSL_RAW_CHECK(strcmp(symbol, "non_inline_func") == 0, "TestWithPCInsideNonInlineFunction failed");
...
void ABSL_ATTRIBUTE_NOINLINE TestWithPCInsideInlineFunction()
{
    ...
    ABSL_RAW_CHECK(strcmp(symbol, __FUNCTION__) == 0, "TestWithPCInsideInlineFunction failed");
...
void ABSL_ATTRIBUTE_NOINLINE TestArmThumbOverlap()
{
    ...
    ABSL_RAW_CHECK(strcmp("ArmThumbOverlapArm()", symbol) == 0, "TestArmThumbOverlap failed");
...
#if defined(ABSL_INTERNAL_HAVE_ELF_SYMBOLIZE) || defined(ABSL_INTERNAL_HAVE_DARWIN_SYMBOLIZE)
