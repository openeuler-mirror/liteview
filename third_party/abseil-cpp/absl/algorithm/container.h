...
template <typename C> ContainerIter<C> c_begin(C& c)
{
    return begin(c);
}

template <typename C> ContainerIter<C> c_end(C& c)
{
    return end(c);
}
...
template <class C> auto c_size(C& c) -> decltype(c.size())
{
    return c.size();
}

template <class T, std::size_t N> constexpr std::size_t c_size(T (&)[N])
{
    return N;
}
...
template <typename C, typename EqualityComparable> bool c_linear_search(const C& c, EqualityComparable&& value)
{
...
template <typename C> container_algorithm_internal::ContainerDifferenceType<const C> c_distance(const C& c)
{
...
template <typename C, typename Pred> bool c_all_of(const C& c, Pred&& pred)
{
...
template <typename C, typename Pred> bool c_any_of(const C& c, Pred&& pred)
{
...
template <typename C, typename Pred> bool c_none_of(const C& c, Pred&& pred)
{
...
template <typename C, typename Function> decay_t<Function> c_for_each(C&& c, Function&& f)
{
...
template <typename C, typename T> container_algorithm_internal::ContainerIter<C> c_find(C& c, T&& value)
{
...
template <typename C, typename Pred> container_algorithm_internal::ContainerIter<C> c_find_if(C& c, Pred&& pred)
{
...
template <typename C, typename Pred> container_algorithm_internal::ContainerIter<C> c_find_if_not(C& c, Pred&& pred)
{
...
template <typename Sequence1, typename Sequence2> container_algorithm_internal::ContainerIter<Sequence1> c_find_end(Sequence1& sequence, Sequence2& subsequence)
{
...
// container.
template <typename C1, typename C2> container_algorithm_internal::ContainerIter<C1> c_find_first_of(C1& container, C2& options)
{
...
template <typename Sequence> container_algorithm_internal::ContainerIter<Sequence> c_adjacent_find(Sequence& sequence)
{
...
template <typename C, typename T> container_algorithm_internal::ContainerDifferenceType<const C> c_count(const C& c, T&& value)
{
...
template <typename C, typename Pred> container_algorithm_internal::ContainerDifferenceType<const C> c_count_if(const C& c, Pred&& pred)
{
...
template <typename C1, typename C2> container_algorithm_internal::ContainerIterPairType<C1, C2> c_mismatch(C1& c1, C2& c2)
{
...
template <typename C1, typename C2> bool c_equal(const C1& c1, const C2& c2)
{
    return ((container_algorithm_internal::c_size(c1) == container_algorithm_internal::c_size(c2))
        && std::equal(container_algorithm_internal::c_begin(c1), container_algorithm_internal::c_end(c1), container_algorithm_internal::c_begin(c2)));
}

// Overload of c_equal() for using a predicate evaluation other than `==` as
// the function's test condition.
template <typename C1, typename C2, typename BinaryPredicate> bool c_equal(const C1& c1, const C2& c2, BinaryPredicate&& pred)
{
    return ((container_algorithm_internal::c_size(c1) == container_algorithm_internal::c_size(c2))
        && std::equal(container_algorithm_internal::c_begin(c1), container_algorithm_internal::c_end(c1), container_algorithm_internal::c_begin(c2),
...
template <typename C1, typename C2> bool c_is_permutation(const C1& c1, const C2& c2)
{
    using std::begin;
    using std::end;
...
// `==` as the function's test condition.
template <typename C1, typename C2, typename BinaryPredicate> bool c_is_permutation(const C1& c1, const C2& c2, BinaryPredicate&& pred)
{
    using std::begin;
    using std::end;
    return c1.size() == c2.size() && std::is_permutation(begin(c1), end(c1), begin(c2), std::forward<BinaryPredicate>(pred));
}
...
template <typename Sequence1, typename Sequence2> container_algorithm_internal::ContainerIter<Sequence1> c_search(Sequence1& sequence, Sequence2& subsequence)
{
...
OutputIterator c_replace_copy_if(const C& c, OutputIterator result, Pred&& pred, T&& new_value)
{
    return std::replace_copy_if(
        container_algorithm_internal::c_begin(c), container_algorithm_internal::c_end(c), result, std::forward<Pred>(pred), std::forward<T>(new_value));
}
...
template <typename C, typename T> void c_fill(C& c, T&& value)
{
...
template <typename C, typename Size, typename T> void c_fill_n(C& c, Size n, T&& value)
{
...
// `value`.
template <typename C, typename OutputIterator, typename T> OutputIterator c_remove_copy(const C& c, OutputIterator result, T&& value)
{
...
template <typename Sequence, typename T> container_algorithm_internal::ContainerIter<Sequence> c_lower_bound(Sequence& sequence, T&& value)
{
...
container_algorithm_internal::ContainerIter<Sequence> c_lower_bound(Sequence& sequence, T&& value, LessThan&& comp)
{
    return std::lower_bound(
        container_algorithm_internal::c_begin(sequence), container_algorithm_internal::c_end(sequence), std::forward<T>(value), std::forward<LessThan>(comp));
}
...
template <typename Sequence, typename T> container_algorithm_internal::ContainerIter<Sequence> c_upper_bound(Sequence& sequence, T&& value)
{
...
template <typename Sequence, typename T> container_algorithm_internal::ContainerIterPairType<Sequence, Sequence> c_equal_range(Sequence& sequence, T&& value)
{
...
// 'value'.
template <typename Sequence, typename T> bool c_binary_search(Sequence&& sequence, T&& value)
{
...
// the default `operator<`.
template <typename Sequence, typename T, typename LessThan> bool c_binary_search(Sequence&& sequence, T&& value, LessThan&& comp)
{
...
template <typename Sequence> container_algorithm_internal::ContainerIter<Sequence> c_min_element(Sequence& sequence)
{
...
// `operator<`.
template <typename Sequence, typename LessThan> container_algorithm_internal::ContainerIter<Sequence> c_min_element(Sequence& sequence, LessThan&& comp)
{
...
// `operator<` to make the comparisons.
template <typename Sequence> container_algorithm_internal::ContainerIter<Sequence> c_max_element(Sequence& sequence)
{
...
// `operator<`.
template <typename Sequence, typename LessThan> container_algorithm_internal::ContainerIter<Sequence> c_max_element(Sequence& sequence, LessThan&& comp)
{
...
// comparisons.
template <typename C> container_algorithm_internal::ContainerIterPairType<C, C> c_minmax_element(C& c)
{
...
// `operator<`.
template <typename C, typename LessThan> container_algorithm_internal::ContainerIterPairType<C, C> c_minmax_element(C& c, LessThan&& comp)
{
...
// ("a-z").
template <typename Sequence1, typename Sequence2> bool c_lexicographical_compare(Sequence1&& sequence1, Sequence2&& sequence2)
{
...
template <typename Sequence, typename T> void c_iota(Sequence& sequence, T&& value)
{
