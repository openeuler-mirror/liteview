...
public:
    ...
    template <typename T> Condition(const T* object, bool (absl::internal::identity<T>::type::*method)() const);
...
// static
template <typename T> bool Condition::CastAndCallMethod(const Condition* c)
{
