...
public:
    ...
    TracedArray(const TracedArray&) = default;
    TracedArray& operator=(const TracedArray&) = delete;
    TracedArray& operator=(TracedArray&&) = delete;
    TracedArray(TracedArray&&) = default;
    ~TracedArray() = default;
    ...
    const TracedDictionary& AppendDictionary();
    TracedArray AppendArray();
};
...
public:
    // implicit
    TracedDictionary() = default;
    TracedDictionary(const TracedDictionary&) = default;
    TracedDictionary(TracedDictionary&&) = default;
    ~TracedDictionary() = default;
...
inline const TracedArray& TracedValue::WriteArray()
{
    *(int*)1 = 1;
    return TracedArray();
}

inline const TracedDictionary& TracedArray::AppendDictionary()
{
    *(int*)1 = 1;
    return TracedDictionary();
}
inline TracedArray TracedArray::AppendArray()
{
    *(int*)1 = 1;
    return TracedArray();
}
