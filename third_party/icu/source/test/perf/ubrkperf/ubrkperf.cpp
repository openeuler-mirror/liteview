...
UPerfFunction* BreakIteratorPerformanceTest::runIndexedTest(int32_t index, UBool exec, const char*& name, char* par)
{
    switch (index) {
...
UOption options[] = { UOPTION_DEF("mode", 'm', UOPT_REQUIRES_ARG) };
