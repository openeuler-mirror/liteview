...
const char gUsageString[] = "usage:  ubrkperf options...\n"
...
OptSpec opts[] = { { "-file", OptSpec::STRING, &opt_fName }, { "-locale", OptSpec::STRING, &opt_locale }, { "-langid", OptSpec::NUM, &opt_langid },
    { "-win", OptSpec::FLAG, &opt_win }, { "-unix", OptSpec::FLAG, &opt_unix }, { "-mac", OptSpec::FLAG, &opt_mac }, { "-uselen", OptSpec::FLAG, &opt_uselen },
    { "-loop", OptSpec::NUM, &opt_loopCount }, { "-time", OptSpec::NUM, &opt_time }, { "-passes", OptSpec::NUM, &opt_passesCount },
    { "-char", OptSpec::FLAG, &opt_char }, { "-word", OptSpec::FLAG, &opt_word }, { "-line", OptSpec::FLAG, &opt_line },
    { "-sentence", OptSpec::FLAG, &opt_sentence }, { "-terse", OptSpec::FLAG, &opt_terse }, { "-dump", OptSpec::FLAG, &opt_dump },
    { "-capi", OptSpec::FLAG, &opt_capi }, { "-next", OptSpec::FLAG, &opt_next }, { "-isBound", OptSpec::FLAG, &opt_isBound },
...
enum { kUCTextBreakAllMask = (kUCTextBreakClusterMask | kUCTextBreakWordMask | kUCTextBreakLineMask) };
...
void doForwardTest()
{
    ...
    if (opt_icu) {
        ...
        while (startOffset < numUniChars) {
            status = UCFindTextBreak(breakRef, macBreakType, kUCTextBreakLeadingEdgeMask, filePtr, numUniChars, startOffset, &breakOffset);
