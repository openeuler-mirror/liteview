...
StringPerformanceTest::StringPerformanceTest(int32_t argc, const char* argv[], UErrorCode& status)
...
UPerfFunction* StringPerformanceTest::runIndexedTest(int32_t index, UBool exec, const char*& name, char* par)
{
    switch (index) {
        TESTCASE(0, TestCtor);
