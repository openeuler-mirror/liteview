...
private:
    ...
    void verifyFormat(const char* description, const MeasureFormat& fmt, const Measure* measures, int32_t measureCount, const char* expected);
    void verifyFormatWithPrefix(
        const char* description, const MeasureFormat& fmt, const UnicodeString& prefix, const Measure* measures, int32_t measureCount, const char* expected);
    void verifyFormat(const char* description, const MeasureFormat& fmt, const ExpectedResult* expectedResults, int32_t count);
    void helperTestSimplePer(
        const Locale& locale, UMeasureFormatWidth width, double value, const MeasureUnit& unit, const MeasureUnit& perUnit, const char* expected);
    void helperTestSimplePer(const Locale& locale, UMeasureFormatWidth width, double value, const MeasureUnit& unit, const MeasureUnit& perUnit,
        const char* expected, int32_t field, int32_t expected_start, int32_t expected_end);
    void helperTestMultiples(const Locale& locale, UMeasureFormatWidth width, const char* expected);
    void helperTestManyLocaleDurations(const char* localeID, UMeasureFormatWidth width, const Measure* measures, int32_t measureCount, const char* expected);
    void helperTestDisplayName(const MeasureUnit* unit, const char* localeID, UMeasureFormatWidth width, const char* expected);
    void verifyFieldPosition(const char* description, const MeasureFormat& fmt, const UnicodeString& prefix, const Measure* measures, int32_t measureCount,
        NumberFormat::EAlignmentFields field, int32_t start, int32_t end);
    void verifySingleUnit(const MeasureUnit& unit, UMeasurePrefix unitPrefix, int8_t power, const char* identifier);
    void verifyCompoundUnit(const MeasureUnit& unit, const char* identifier, const char** subIdentifiers, int32_t subIdentifierCount);
    void verifyMixedUnit(const MeasureUnit& unit, const char* identifier, const char** subIdentifiers, int32_t subIdentifierCount);
};

void MeasureFormatTest::runIndexedTest(int32_t index, UBool exec, const char*& name, char*)
{
    if (exec) {
...
{ // TestCompatible71 would be identical
    UErrorCode status = U_ZERO_ERROR;
    LocalPointer<MeasureUnit> measureUnit;
    MeasureUnit measureUnitValue;
    measureUnit.adoptInstead(MeasureUnit::createGForce(status));
...
void MeasureFormatTest::TestGetAvailable()
{
    ...
    for (const char* type = types->next(NULL, status); type != NULL; type = types->next(NULL, status)) {
...
void MeasureFormatTest::TestExamplesInDocs()
{
    ...
    MeasureFormat fmtFrFull(Locale::getFrench(), UMEASFMT_WIDTH_WIDE, status);
    MeasureFormat fmtFrNarrow(Locale::getFrench(), UMEASFMT_WIDTH_NARROW, status);
    ...
    Measure feetAndInches[] = { Measure((double)70, MeasureUnit::createFoot(status), status), Measure((double)5.3, MeasureUnit::createInch(status), status) };
    Measure footAndInch[] = { Measure((double)1, MeasureUnit::createFoot(status), status), Measure((double)1, MeasureUnit::createInch(status), status) };
    Measure inchAndFeet[] = { Measure((double)1, MeasureUnit::createInch(status), status), Measure((double)2, MeasureUnit::createFoot(status), status) };
    if (!assertSuccess("Error creating measurements.", status)) {
        return;
    }
    verifyFormat("Celsius", fmtFr, &measureC, 1, "23\\u202F\\u00B0C");
    verifyFormatWithPrefix("Celsius", fmtFr, "Prefix: ", &measureC, 1, "Prefix: 23\\u202F\\u00B0C");
    verifyFormat("Fahrenheit", fmtFr, &measureF, 1, "70\\u202F\\u00B0F");
    verifyFormat("Feet and inches", fmtFrFull, feetAndInches, UPRV_LENGTHOF(feetAndInches), "70 pieds et 5,3\\u00A0pouces");
    verifyFormatWithPrefix("Feet and inches", fmtFrFull, "Prefix: ", feetAndInches, UPRV_LENGTHOF(feetAndInches), "Prefix: 70 pieds et 5,3\\u00A0pouces");
    verifyFormat("Foot and inch", fmtFrFull, footAndInch, UPRV_LENGTHOF(footAndInch), "1\\u00A0pied et 1\\u00A0pouce");
    verifyFormat("Foot and inch narrow", fmtFrNarrow, footAndInch, UPRV_LENGTHOF(footAndInch), "1\\u2032 1\\u2033");
    verifyFormat("Inch and feet", fmtEn, inchAndFeet, UPRV_LENGTHOF(inchAndFeet), "1 inch, 2 feet");
}
...
void MeasureFormatTest::TestFormatPeriodEn()
{
    ...
    Measure t_1h_23_5s[] = { Measure((double)1.0, MeasureUnit::createHour(status), status), Measure((double)23.5, MeasureUnit::createSecond(status), status) };
    Measure t_1h_23_5m[] = { Measure((double)1.0, MeasureUnit::createHour(status), status), Measure((double)23.5, MeasureUnit::createMinute(status), status) };
    Measure t_1h_0m_23s[] = { Measure((double)1.0, TimeUnit::createInstance(TimeUnit::UTIMEUNIT_HOUR, status), status),
        Measure((double)0.0, TimeUnit::createInstance(TimeUnit::UTIMEUNIT_MINUTE, status), status),
        Measure((double)23.0, TimeUnit::createInstance(TimeUnit::UTIMEUNIT_SECOND, status), status) };
    Measure t_2y_5M_3w_4d[] = { Measure(2.0, MeasureUnit::createYear(status), status), Measure(5.0, MeasureUnit::createMonth(status), status),
        Measure(3.0, MeasureUnit::createWeek(status), status), Measure(4.0, MeasureUnit::createDay(status), status) };
    Measure t_1m_59_9996s[] = { Measure(1.0, MeasureUnit::createMinute(status), status), Measure(59.9996, MeasureUnit::createSecond(status), status) };
    Measure t_5h_17m[] = { Measure(5.0, MeasureUnit::createHour(status), status), Measure(17.0, MeasureUnit::createMinute(status), status) };
    Measure t_neg5h_17m[] = { Measure(-5.0, MeasureUnit::createHour(status), status), Measure(17.0, MeasureUnit::createMinute(status), status) };
    Measure t_19m_28s[] = { Measure(19.0, MeasureUnit::createMinute(status), status), Measure(28.0, MeasureUnit::createSecond(status), status) };
    Measure t_0h_0m_9s[] = { Measure(0.0, MeasureUnit::createHour(status), status), Measure(0.0, MeasureUnit::createMinute(status), status),
        Measure(9.0, MeasureUnit::createSecond(status), status) };
    Measure t_0h_0m_17s[] = { Measure(0.0, MeasureUnit::createHour(status), status), Measure(0.0, MeasureUnit::createMinute(status), status),
        Measure(17.0, MeasureUnit::createSecond(status), status) };
    Measure t_6h_56_92m[] = { Measure(6.0, MeasureUnit::createHour(status), status), Measure(56.92, MeasureUnit::createMinute(status), status) };
    Measure t_3h_4s_5m[] = { Measure(3.0, MeasureUnit::createHour(status), status), Measure(4.0, MeasureUnit::createSecond(status), status),
        Measure(5.0, MeasureUnit::createMinute(status), status) };
    Measure t_6_7h_56_92m[] = { Measure(6.7, MeasureUnit::createHour(status), status), Measure(56.92, MeasureUnit::createMinute(status), status) };

    Measure t_3h_5h[] = { Measure(3.0, MeasureUnit::createHour(status), status), Measure(5.0, MeasureUnit::createHour(status), status) };

    if (!assertSuccess("Error creating Measure objects", status)) {
        return;
    }

    ExpectedResult fullData[] = { { t_1m_59_9996s, UPRV_LENGTHOF(t_1m_59_9996s), "1 minute, 59.9996 seconds" }, { t_19m, UPRV_LENGTHOF(t_19m), "19 minutes" },
        { t_1h_23_5s, UPRV_LENGTHOF(t_1h_23_5s), "1 hour, 23.5 seconds" }, { t_1h_23_5m, UPRV_LENGTHOF(t_1h_23_5m), "1 hour, 23.5 minutes" },
    ...
    ExpectedResult abbrevData[] = { { t_1m_59_9996s, UPRV_LENGTHOF(t_1m_59_9996s), "1 min, 59.9996 sec" }, { t_19m, UPRV_LENGTHOF(t_19m), "19 min" },
        { t_1h_23_5s, UPRV_LENGTHOF(t_1h_23_5s), "1 hr, 23.5 sec" }, { t_1h_23_5m, UPRV_LENGTHOF(t_1h_23_5m), "1 hr, 23.5 min" },
        { t_1h_0m_23s, UPRV_LENGTHOF(t_1h_0m_23s), "1 hr, 0 min, 23 sec" }, { t_2y_5M_3w_4d, UPRV_LENGTHOF(t_2y_5M_3w_4d), "2 yrs, 5 mths, 3 wks, 4 days" } };

    ExpectedResult narrowData[] = { { t_1m_59_9996s, UPRV_LENGTHOF(t_1m_59_9996s), "1m 59.9996s" }, { t_19m, UPRV_LENGTHOF(t_19m), "19m" },
        { t_1h_23_5s, UPRV_LENGTHOF(t_1h_23_5s), "1h 23.5s" }, { t_1h_23_5m, UPRV_LENGTHOF(t_1h_23_5m), "1h 23.5m" },
        { t_1h_0m_23s, UPRV_LENGTHOF(t_1h_0m_23s), "1h 0m 23s" }, { t_2y_5M_3w_4d, UPRV_LENGTHOF(t_2y_5M_3w_4d), "2y 5m 3w 4d" } };

    ExpectedResult numericData[] = { { t_1m_59_9996s, UPRV_LENGTHOF(t_1m_59_9996s), "1:59.9996" }, { t_19m, UPRV_LENGTHOF(t_19m), "19m" },
        { t_1h_23_5s, UPRV_LENGTHOF(t_1h_23_5s), "1:00:23.5" }, { t_1h_23_5m, UPRV_LENGTHOF(t_1h_23_5m), "1:23.5" },
        { t_1h_0m_23s, UPRV_LENGTHOF(t_1h_0m_23s), "1:00:23" }, { t_5h_17m, UPRV_LENGTHOF(t_5h_17m), "5:17" },
        { t_neg5h_17m, UPRV_LENGTHOF(t_neg5h_17m), "-5h 17m" }, { t_19m_28s, UPRV_LENGTHOF(t_19m_28s), "19:28" },
        { t_2y_5M_3w_4d, UPRV_LENGTHOF(t_2y_5M_3w_4d), "2y 5m 3w 4d" }, { t_0h_0m_9s, UPRV_LENGTHOF(t_0h_0m_9s), "0:00:09" },
        { t_6h_56_92m, UPRV_LENGTHOF(t_6h_56_92m), "6:56.92" }, { t_6_7h_56_92m, UPRV_LENGTHOF(t_6_7h_56_92m), "6:56.92" },
        { t_3h_4s_5m, UPRV_LENGTHOF(t_3h_4s_5m), "3h 4s 5m" }, { t_3h_5h, UPRV_LENGTHOF(t_3h_5h), "3h 5h" } };

    ExpectedResult fullDataDe[] = { { t_1m_59_9996s, UPRV_LENGTHOF(t_1m_59_9996s), "1 Minute, 59,9996 Sekunden" },
        { t_19m, UPRV_LENGTHOF(t_19m), "19 Minuten" }, { t_1h_23_5s, UPRV_LENGTHOF(t_1h_23_5s), "1 Stunde, 23,5 Sekunden" },
        { t_1h_23_5m, UPRV_LENGTHOF(t_1h_23_5m), "1 Stunde, 23,5 Minuten" }, { t_1h_0m_23s, UPRV_LENGTHOF(t_1h_0m_23s), "1 Stunde, 0 Minuten und 23 Sekunden" },
        { t_2y_5M_3w_4d, UPRV_LENGTHOF(t_2y_5M_3w_4d), "2 Jahre, 5 Monate, 3 Wochen und 4 Tage" } };

    ExpectedResult numericDataDe[] = { { t_1m_59_9996s, UPRV_LENGTHOF(t_1m_59_9996s), "1:59,9996" }, { t_19m, UPRV_LENGTHOF(t_19m), "19 Min." },
        { t_1h_23_5s, UPRV_LENGTHOF(t_1h_23_5s), "1:00:23,5" }, { t_1h_23_5m, UPRV_LENGTHOF(t_1h_23_5m), "1:23,5" },
        { t_1h_0m_23s, UPRV_LENGTHOF(t_1h_0m_23s), "1:00:23" }, { t_5h_17m, UPRV_LENGTHOF(t_5h_17m), "5:17" }, { t_19m_28s, UPRV_LENGTHOF(t_19m_28s), "19:28" },
        { t_2y_5M_3w_4d, UPRV_LENGTHOF(t_2y_5M_3w_4d), "2 J, 5 M, 3 W und 4 T" }, { t_0h_0m_17s, UPRV_LENGTHOF(t_0h_0m_17s), "0:00:17" },
        { t_6h_56_92m, UPRV_LENGTHOF(t_6h_56_92m), "6:56,92" }, { t_3h_5h, UPRV_LENGTHOF(t_3h_5h), "3 Std., 5 Std." } };

    ExpectedResult numericDataBn[] = { { t_1m_59_9996s, UPRV_LENGTHOF(t_1m_59_9996s), "\\u09E7:\\u09EB\\u09EF.\\u09EF\\u09EF\\u09EF\\u09EC" },
        ...
        { t_1h_23_5m, UPRV_LENGTHOF(t_1h_23_5m), "\\u09E7:\\u09E8\\u09E9.\\u09EB" }, { t_5h_17m, UPRV_LENGTHOF(t_5h_17m), "\\u09EB:\\u09E7\\u09ED" },
    ...
    ExpectedResult numericDataBnLatn[] = { { t_1m_59_9996s, UPRV_LENGTHOF(t_1m_59_9996s), "1:59.9996" },
        { t_19m, UPRV_LENGTHOF(t_19m), "19 \\u09AE\\u09BF\\u0983" }, { t_1h_23_5s, UPRV_LENGTHOF(t_1h_23_5s), "1:00:23.5" },
        { t_1h_0m_23s, UPRV_LENGTHOF(t_1h_0m_23s), "1:00:23" }, { t_1h_23_5m, UPRV_LENGTHOF(t_1h_23_5m), "1:23.5" },
        { t_5h_17m, UPRV_LENGTHOF(t_5h_17m), "5:17" }, { t_19m_28s, UPRV_LENGTHOF(t_19m_28s), "19:28" },
        { t_2y_5M_3w_4d, UPRV_LENGTHOF(t_2y_5M_3w_4d),
            "2 \\u09AC\\u099B\\u09B0, 5 \\u09AE\\u09BE\\u09B8, 3 \\u09B8\\u09AA\\u09CD\\u09A4\\u09BE\\u09B9, 4 \\u09A6\\u09BF\\u09A8" },
        { t_0h_0m_17s, UPRV_LENGTHOF(t_0h_0m_17s), "0:00:17" }, { t_6h_56_92m, UPRV_LENGTHOF(t_6h_56_92m), "6:56.92" },
        { t_3h_5h, UPRV_LENGTHOF(t_3h_5h), "3 \\u0998\\u0983, 5 \\u0998\\u0983" } };

    ExpectedResult fullDataSpellout[] = { { t_1y, UPRV_LENGTHOF(t_1y), "one year" }, { t_5M, UPRV_LENGTHOF(t_5M), "five months" },
        { t_4d, UPRV_LENGTHOF(t_4d), "four days" }, { t_2h, UPRV_LENGTHOF(t_2h), "two hours" }, { t_19m, UPRV_LENGTHOF(t_19m), "nineteen minutes" } };

    ExpectedResult fullDataSpelloutFr[]
        = { { t_1y, UPRV_LENGTHOF(t_1y), "un\\u00A0an" }, { t_5M, UPRV_LENGTHOF(t_5M), "cinq\\u00A0mois" }, { t_4d, UPRV_LENGTHOF(t_4d), "quatre\\u00A0jours" },
              { t_2h, UPRV_LENGTHOF(t_2h), "deux\\u00A0heures" }, { t_19m, UPRV_LENGTHOF(t_19m), "dix-neuf minutes" } };
...
void MeasureFormatTest::Test10219FractionalPlurals()
{
    ...
    const char* expected[2][3] = { { "1 minute", "1.5 minutes", "1.58 minutes" }, { "1 minute", "1.0 minutes", "1.01 minutes" } };
    UErrorCode status = U_ZERO_ERROR;
    for (int j = 0; j < UPRV_LENGTHOF(values); j++) {
        for (int i = 0; i < UPRV_LENGTHOF(expected[j]); i++) {
            DecimalFormat* df = (DecimalFormat*)NumberFormat::createInstance(en, status);
            if (U_FAILURE(status)) {
...
void MeasureFormatTest::TestGreek()
{
    ...
    UErrorCode status = U_ZERO_ERROR;
    MeasureUnit units[] = { toMeasureUnit(MeasureUnit::createSecond(status)), toMeasureUnit(MeasureUnit::createMinute(status)),
        toMeasureUnit(MeasureUnit::createHour(status)), toMeasureUnit(MeasureUnit::createDay(status)), toMeasureUnit(MeasureUnit::createWeek(status)),
        toMeasureUnit(MeasureUnit::createMonth(status)), toMeasureUnit(MeasureUnit::createYear(status)) };
    if (!assertSuccess("Error creating Measure units", status)) {
        return;
    }
    UMeasureFormatWidth styles[] = { UMEASFMT_WIDTH_WIDE, UMEASFMT_WIDTH_SHORT };
    int32_t numbers[] = { 1, 7 };
    const char* expected[] = { // "el_GR" 1 wide
        "1 \\u03B4\\u03B5\\u03C5\\u03C4\\u03B5\\u03C1\\u03CC\\u03BB\\u03B5\\u03C0\\u03C4\\u03BF", "1 \\u03BB\\u03B5\\u03C0\\u03C4\\u03CC",
        "1 \\u03CE\\u03C1\\u03B1", "1 \\u03B7\\u03BC\\u03AD\\u03C1\\u03B1", "1 \\u03B5\\u03B2\\u03B4\\u03BF\\u03BC\\u03AC\\u03B4\\u03B1",
        "1 \\u03BC\\u03AE\\u03BD\\u03B1\\u03C2", "1 \\u03AD\\u03C4\\u03BF\\u03C2",
        // "el_GR" 1 short
        "1 \\u03B4\\u03B5\\u03C5\\u03C4.", "1 \\u03BB.", "1 \\u03CE.", "1 \\u03B7\\u03BC\\u03AD\\u03C1\\u03B1", "1 \\u03B5\\u03B2\\u03B4.",
        "1 \\u03BC\\u03AE\\u03BD.",
        "1 \\u03AD\\u03C4.", // year (one)
        // "el_GR" 7 wide
        "7 \\u03B4\\u03B5\\u03C5\\u03C4\\u03B5\\u03C1\\u03CC\\u03BB\\u03B5\\u03C0\\u03C4\\u03B1", "7 \\u03BB\\u03B5\\u03C0\\u03C4\\u03AC",
        "7 \\u03CE\\u03C1\\u03B5\\u03C2", "7 \\u03B7\\u03BC\\u03AD\\u03C1\\u03B5\\u03C2", "7 \\u03B5\\u03B2\\u03B4\\u03BF\\u03BC\\u03AC\\u03B4\\u03B5\\u03C2",
        "7 \\u03BC\\u03AE\\u03BD\\u03B5\\u03C2", "7 \\u03AD\\u03C4\\u03B7",
        // "el_GR" 7 short
        "7 \\u03B4\\u03B5\\u03C5\\u03C4.", "7 \\u03BB.",
        "7 \\u03CE.", // hour (other)
        "7 \\u03B7\\u03BC\\u03AD\\u03C1\\u03B5\\u03C2", "7 \\u03B5\\u03B2\\u03B4.", "7 \\u03BC\\u03AE\\u03BD.",
        "7 \\u03AD\\u03C4.", // year (other)
        ...
        "7 \\u03B4\\u03B5\\u03C5\\u03C4.", "7 \\u03BB.",
        "7 \\u03CE.", // hour (other)
        "7 \\u03B7\\u03BC\\u03AD\\u03C1\\u03B5\\u03C2", "7 \\u03B5\\u03B2\\u03B4.", "7 \\u03BC\\u03AE\\u03BD.", "7 \\u03AD\\u03C4."
    }; // year (other)
...
void MeasureFormatTest::TestFormatSingleArg()
{
    ...
    fmt.format(new Measure(3.5, MeasureUnit::createFoot(status), status), buffer, pos, status);
    if (!assertSuccess("Error formatting", status)) {
        return;
    }
    assertEquals("TestFormatSingleArg", UnicodeString("3.5 feet"), buffer);
}
...
void MeasureFormatTest::TestSimplePer()
{
    ...
    helperTestSimplePer(en, UMEASFMT_WIDTH_WIDE, 1.0, *pound, *second, "1 pound per second");
    helperTestSimplePer(en, UMEASFMT_WIDTH_WIDE, 2.0, *pound, *second, "2 pounds per second");
    helperTestSimplePer(en, UMEASFMT_WIDTH_WIDE, 1.0, *pound, *minute, "1 pound per minute");
    helperTestSimplePer(en, UMEASFMT_WIDTH_WIDE, 2.0, *pound, *minute, "2 pounds per minute");

    helperTestSimplePer(en, UMEASFMT_WIDTH_SHORT, 1.0, *pound, *second, "1 lb/s");
    helperTestSimplePer(en, UMEASFMT_WIDTH_SHORT, 2.0, *pound, *second, "2 lb/s");
    helperTestSimplePer(en, UMEASFMT_WIDTH_SHORT, 1.0, *pound, *minute, "1 lb/min");
    helperTestSimplePer(en, UMEASFMT_WIDTH_SHORT, 2.0, *pound, *minute, "2 lb/min");

    helperTestSimplePer(en, UMEASFMT_WIDTH_NARROW, 1.0, *pound, *second, "1#/s");
    helperTestSimplePer(en, UMEASFMT_WIDTH_NARROW, 2.0, *pound, *second, "2#/s");
    helperTestSimplePer(en, UMEASFMT_WIDTH_NARROW, 1.0, *pound, *minute, "1#/min");
    helperTestSimplePer(en, UMEASFMT_WIDTH_NARROW, 2.0, *pound, *minute, "2#/min");

    helperTestSimplePer(en, UMEASFMT_WIDTH_SHORT, 23.3, *pound, *second, "23.3 lb/s", NumberFormat::kDecimalSeparatorField, 2, 3);

    helperTestSimplePer(en, UMEASFMT_WIDTH_SHORT, 23.3, *pound, *second, "23.3 lb/s", NumberFormat::kIntegerField, 0, 2);

    helperTestSimplePer(en, UMEASFMT_WIDTH_SHORT, 23.3, *pound, *minute, "23.3 lb/min", NumberFormat::kDecimalSeparatorField, 2, 3);

    helperTestSimplePer(en, UMEASFMT_WIDTH_SHORT, 23.3, *pound, *minute, "23.3 lb/min", NumberFormat::kIntegerField, 0, 2);
}
...
void MeasureFormatTest::TestNumeratorPlurals()
{
    ...
    helperTestSimplePer(pl, UMEASFMT_WIDTH_WIDE, 1.0, *foot, *second, "1 stopa na sekund\\u0119");
    helperTestSimplePer(pl, UMEASFMT_WIDTH_WIDE, 2.0, *foot, *second, "2 stopy na sekund\\u0119");
    helperTestSimplePer(pl, UMEASFMT_WIDTH_WIDE, 5.0, *foot, *second, "5 st\\u00f3p na sekund\\u0119");
    helperTestSimplePer(pl, UMEASFMT_WIDTH_WIDE, 1.5, *foot, *second, "1,5 stopy na sekund\\u0119");
}

void MeasureFormatTest::helperTestSimplePer(
    const Locale& locale, UMeasureFormatWidth width, double value, const MeasureUnit& unit, const MeasureUnit& perUnit, const char* expected)
{
    helperTestSimplePer(locale, width, value, unit, perUnit, expected, FieldPosition::DONT_CARE, 0, 0);
}

void MeasureFormatTest::helperTestSimplePer(const Locale& locale, UMeasureFormatWidth width, double value, const MeasureUnit& unit, const MeasureUnit& perUnit,
    const char* expected, int32_t field, int32_t expected_start, int32_t expected_end)
{
    UErrorCode status = U_ZERO_ERROR;
    ...
    fmt.formatMeasurePerUnit(measure, perUnit, buffer, pos, status);
    if (!assertSuccess("Error formatting measures with per", status)) {
        return;
    }
    UnicodeString uexpected(expected);
    uexpected = prefix + uexpected;
    assertEquals("TestSimplePer", uexpected.unescape(), buffer);
    if (field != FieldPosition::DONT_CARE) {
        assertEquals("Start", expected_start, pos.getBeginIndex() - prefix.length());
        assertEquals("End", expected_end, pos.getEndIndex() - prefix.length());
    }
}
...
void MeasureFormatTest::helperTestMultiples(const Locale& locale, UMeasureFormatWidth width, const char* expected)
{
    UErrorCode status = U_ZERO_ERROR;
    FieldPosition pos(FieldPosition::DONT_CARE);
    MeasureFormat fmt(locale, width, status);
    ...
    Measure measures[] = { Measure(2.0, MeasureUnit::createMile(status), status), Measure(1.0, MeasureUnit::createFoot(status), status),
...
{
    UErrorCode status = U_ZERO_ERROR;
    Measure measures[] = { Measure(5.0, MeasureUnit::createHour(status), status), Measure(37.0, MeasureUnit::createMinute(status), status) };
    if (!assertSuccess("Error creating measures", status)) {
        return;
    }
...
void MeasureFormatTest::helperTestManyLocaleDurations(
    const char* localeID, UMeasureFormatWidth width, const Measure* measures, int32_t measureCount, const char* expected)
{
    UErrorCode status = U_ZERO_ERROR;
...
void MeasureFormatTest::helperTestDisplayName(const MeasureUnit* unit, const char* localeID, UMeasureFormatWidth width, const char* expected)
{
    UErrorCode status = U_ZERO_ERROR;
    MeasureFormat fmt(Locale(localeID), width, status);
    if (U_FAILURE(status)) {
    ...
    if (U_FAILURE(status)) {
        errln("MeasureFormat::getUnitDisplayName failed for unit %s-%s, locale %s, width %d, status: %s", unit->getType(), unit->getSubtype(), localeID,
            (int)width, u_errorName(status));
        return;
    }

    UnicodeString expStr(UnicodeString(expected).unescape());
    if (dnam != expStr) {
        errln("MeasureFormat::getUnitDisplayName for unit %s-%s, locale %s, width %d: expected \"%s\", got \"%s\"", unit->getType(), unit->getSubtype(),
            localeID, (int)width, CStr(expStr)(), CStr(dnam)());
    }
...
void MeasureFormatTest::TestFieldPosition()
{
    ...
    verifyFieldPosition("", fmt, prefix, &measure, 1, NumberFormat::kDecimalSeparatorField, 10, 11);
    measure = Measure(43.0, MeasureUnit::createFoot(status), status);
    if (!assertSuccess("Error creating measure object 2", status)) {
        return;
    }
    verifyFieldPosition("", fmt, prefix, &measure, 1, NumberFormat::kDecimalSeparatorField, 0, 0);
}
...
void MeasureFormatTest::TestFieldPositionMultiple()
{
    ...
    Measure first[] = { Measure((double)354, MeasureUnit::createMeter(status), status), Measure((double)23, MeasureUnit::createCentimeter(status), status) };
    Measure second[] = { Measure((double)354, MeasureUnit::createMeter(status), status), Measure((double)23, MeasureUnit::createCentimeter(status), status),
        Measure((double)5.4, MeasureUnit::createMillimeter(status), status) };
    Measure third[] = { Measure((double)3, MeasureUnit::createMeter(status), status), Measure((double)23, MeasureUnit::createCentimeter(status), status),
        Measure((double)5, MeasureUnit::createMillimeter(status), status) };
    if (!assertSuccess("Error creating measure objects", status)) {
        return;
    }
    UnicodeString prefix("123456: ");
    verifyFieldPosition("Integer", fmt, prefix, first, UPRV_LENGTHOF(first), NumberFormat::kIntegerField, 8, 11);
    verifyFieldPosition("Decimal separator", fmt, prefix, second, UPRV_LENGTHOF(second), NumberFormat::kDecimalSeparatorField, 23, 24);
    verifyFieldPosition("no decimal separator", fmt, prefix, third, UPRV_LENGTHOF(third), NumberFormat::kDecimalSeparatorField, 0, 0);
}
...
void MeasureFormatTest::TestBadArg()
{
    ...
    FieldPosition pos(FieldPosition::DONT_CARE);
    UnicodeString buffer;
    fmt.format(9.3, buffer, pos, status);
...
void MeasureFormatTest::TestGroupingSeparator()
{
    ...
    Measure ms[] = { Measure((int32_t)INT32_MAX, MeasureUnit::createYear(status), status),
        Measure((int32_t)INT32_MIN, MeasureUnit::createMonth(status), status), Measure(-987.0, MeasureUnit::createDay(status), status),
        Measure(1362.0, MeasureUnit::createHour(status), status), Measure(987.0, MeasureUnit::createMinute(status), status) };
    ...
    assertEquals("grouping separator", "2,147,483,647 yrs, -2,147,483,648 mths, -987 days, 1,362 hr, 987 min", appendTo);
...
{
    UErrorCode status = U_ZERO_ERROR;
    Measure measures[] = { Measure(4.7, MeasureUnit::createHour(status), status), Measure(23.0, MeasureUnit::createMinute(status), status),
    ...
    assertEquals("TestDoubleZero", UnicodeString("4 hours, 23 minutes, 16.00 seconds"), appendTo);
...
void MeasureFormatTest::TestUnitPerUnitResolution()
{
    ...
    fmt.formatMeasurePerUnit(measure, *sqInch, actual, pos, status);
...
void MeasureFormatTest::TestIndividualPluralFallback()
{
    ...
    LocalPointer<Measure> twoDeg(new Measure(2.0, MeasureUnit::createGenericTemperature(errorCode), errorCode), errorCode);
...
void MeasureFormatTest::Test20332_PersonUnits()
{
    ...
    const struct TestCase {
        ...
        const char* expected;
    } cases[] = { { "en-us", MeasureUnit::createYearPerson(status), UMEASFMT_WIDTH_NARROW, "25y" },
...
void MeasureFormatTest::TestNumericTime()
{
    ...
    if (status.errDataIfFailureAndReset(WHERE))
        return;
...
void MeasureFormatTest::TestIdentifiers()
{
    ...
    struct TestCase {
        ...
        { "kilogram-meter-per-square-meter-square-second", "kilogram-meter-per-square-meter-square-second" },
        ...
        { "microfoot-millifoot-megafoot-mebifoot-kibifoot-kilofoot", "mebifoot-megafoot-kibifoot-kilofoot-millifoot-microfoot" },
        { "per-microfoot-millifoot-megafoot-mebifoot-kibifoot-kilofoot", "per-mebifoot-megafoot-kibifoot-kilofoot-millifoot-microfoot" },
    };
    for (const auto& cas : cases) {
...
void MeasureFormatTest::TestPrefixes()
{
    ...
    for (auto cas : cases) {
        ...
        assertEquals("umeas_getPrefixPower()", cas.expectedPower, umeas_getPrefixPower(m.getPrefix(status)));
        assertEquals("umeas_getPrefixBase()", cas.expectedBase, umeas_getPrefixBase(m.getPrefix(status)));
    }
}
...
void MeasureFormatTest::TestParseToBuiltIn()
{
    ...
    for (auto& cas : cases) {
        ...
        status.assertSuccess();
        assertEquals("forIdentifier returns a normal built-in unit when it exists", cas.expectedBuiltIn.getOffset(), fromIdent.getOffset());
...
void MeasureFormatTest::TestKilogramIdentifier()
{
    ...
    assertEquals("parsed kilogram equals built-in kilogram", MeasureUnit::getKilogram().getType(), kilogram.getType());
    assertEquals("parsed kilogram equals built-in kilogram", MeasureUnit::getKilogram().getSubtype(), kilogram.getSubtype());
    assertEquals("parsed gram equals built-in gram", MeasureUnit::getGram().getType(), gram.getType());
    assertEquals("parsed gram equals built-in gram", MeasureUnit::getGram().getSubtype(), gram.getSubtype());
    assertEquals("parsed microgram equals built-in microgram", MeasureUnit::getMicrogram().getType(), microgram.getType());
    assertEquals("parsed microgram equals built-in microgram", MeasureUnit::getMicrogram().getSubtype(), microgram.getSubtype());
    ...
    assertEquals(
        UnicodeString("Kilogram + milli should be milligram, got: ") + tmp.getIdentifier(), MeasureUnit::getMilligram().getIdentifier(), tmp.getIdentifier());
}
...
void MeasureFormatTest::TestCompoundUnitOperations()
{
    ...
    MeasureUnit overQuarticKilometer3 = kilometer.product(kilometer, status).product(kilometer, status).product(kilometer, status).reciprocal(status);
    MeasureUnit overQuarticKilometer4 = meter.withDimensionality(4, status).reciprocal(status).withPrefix(UMEASURE_PREFIX_KILO, status);
    ...
    MeasureUnit kiloSquareSecond = MeasureUnit::getSecond().withDimensionality(2, status).withPrefix(UMEASURE_PREFIX_KILO, status);
    ...
    verifyCompoundUnit(meterSecond, "meter-square-kilosecond", meterSecondSub, UPRV_LENGTHOF(meterSecondSub));
    const char* cubicMeterSecond1Sub[] = { "cubic-meter", "square-kilosecond" };
    verifyCompoundUnit(cubicMeterSecond1, "cubic-meter-square-kilosecond", cubicMeterSecond1Sub, UPRV_LENGTHOF(cubicMeterSecond1Sub));
    const char* centimeterSecond1Sub[] = { "centimeter", "square-kilosecond" };
    verifyCompoundUnit(centimeterSecond1, "centimeter-square-kilosecond", centimeterSecond1Sub, UPRV_LENGTHOF(centimeterSecond1Sub));
    const char* secondCubicMeterSub[] = { "cubic-meter", "square-kilosecond" };
    verifyCompoundUnit(secondCubicMeter, "cubic-meter-square-kilosecond", secondCubicMeterSub, UPRV_LENGTHOF(secondCubicMeterSub));
    const char* secondCentimeterSub[] = { "centimeter", "square-kilosecond" };
    verifyCompoundUnit(secondCentimeter, "centimeter-square-kilosecond", secondCentimeterSub, UPRV_LENGTHOF(secondCentimeterSub));
    const char* secondCentimeterPerKilometerSub[] = { "centimeter", "square-kilosecond", "per-kilometer" };
    verifyCompoundUnit(secondCentimeterPerKilometer, "centimeter-square-kilosecond-per-kilometer", secondCentimeterPerKilometerSub,
        UPRV_LENGTHOF(secondCentimeterPerKilometerSub));
    ...
    verifyMixedUnit(footInch, "foot-and-inch", footInchSub, UPRV_LENGTHOF(footInchSub));
    const char* inchFootSub[] = { "inch", "foot" };
    verifyMixedUnit(inchFoot, "inch-and-foot", inchFootSub, UPRV_LENGTHOF(inchFootSub));
...
void MeasureFormatTest::Test21223_FrenchDuration()
{
    ...
    Measure H5M10[] = { { 5, MeasureUnit::createHour(status), status }, { 10, MeasureUnit::createMinute(status), status } };
...
void MeasureFormatTest::TestInternalMeasureUnitImpl()
{
    ...
    assertEquals("append meter twice: identifier", "square-meter", std::move(m2).build(status).getIdentifier());
    ...
    assertEquals("append meter & centimeter: identifier", "meter-centimeter", std::move(mcm).build(status).getIdentifier());
    ...
    assertEquals("meter-square-meter: identifier", "cubic-meter", std::move(m2m).build(status).getIdentifier());
}

void MeasureFormatTest::verifyFieldPosition(const char* description, const MeasureFormat& fmt, const UnicodeString& prefix, const Measure* measures,
    int32_t measureCount, NumberFormat::EAlignmentFields field, int32_t start, int32_t end)
{
    // 8 char lead
    ...
    UErrorCode status = U_ZERO_ERROR;
    CharString ch;
    const char* descPrefix = ch.append(description, status).append(": ", status).data();
...
void MeasureFormatTest::verifyFormat(const char* description, const MeasureFormat& fmt, const Measure* measures, int32_t measureCount, const char* expected)
{
    verifyFormatWithPrefix(description, fmt, "", measures, measureCount, expected);
}
...
void MeasureFormatTest::verifyFormat(const char* description, const MeasureFormat& fmt, const ExpectedResult* expectedResults, int32_t count)
{
...
void MeasureFormatTest::verifySingleUnit(const MeasureUnit& unit, UMeasurePrefix unitPrefix, int8_t power, const char* identifier)
{
    IcuTestErrorCode status(*this, "verifySingleUnit");
    UnicodeString uid(identifier, -1, US_INV);
    assertEquals(uid + ": SI or binary prefix", unitPrefix, unit.getPrefix(status));
    status.errIfFailureAndReset("%s: SI or binary prefix", identifier);
    assertEquals(uid + ": Power", static_cast<int32_t>(power), static_cast<int32_t>(unit.getDimensionality(status)));
    ...
    assertEquals(uid + ": Complexity", UMEASURE_UNIT_SINGLE, unit.getComplexity(status));
    status.errIfFailureAndReset("%s: Complexity", identifier);
}

void MeasureFormatTest::verifyCompoundUnit(const MeasureUnit& unit, const char* identifier, const char** subIdentifiers, int32_t subIdentifierCount)
{
    ...
    assertTrue(uid + ": Constructor", unit == MeasureUnit::forIdentifier(identifier, status));
    status.errIfFailureAndReset("%s: Constructor", identifier);
    assertEquals(uid + ": Complexity", UMEASURE_UNIT_COMPOUND, unit.getComplexity(status));
    status.errIfFailureAndReset("%s: Complexity", identifier);
