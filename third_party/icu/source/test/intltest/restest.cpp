...
#define CONFIRM_EQ(actual, expected, myAction)                                                                                                                 \
...
#define CONFIRM_GE(actual, expected, myAction)                                                                                                                 \
    UPRV_BLOCK_MACRO_BEGIN                                                                                                                                     \
    {                                                                                                                                                          \
        if ((actual) >= (expected)) {                                                                                                                          \
            record_pass(myAction);                                                                                                                             \
    ...
    UPRV_BLOCK_MACRO_END
#define CONFIRM_NE(actual, expected, myAction)                                                                                                                 \
    UPRV_BLOCK_MACRO_BEGIN                                                                                                                                     \
    {                                                                                                                                                          \
        if ((expected) != (actual)) {                                                                                                                          \
            record_pass(myAction);                                                                                                                             \
...
#define CONFIRM_UErrorCode(actual, expected, myAction)                                                                                                         \
    UPRV_BLOCK_MACRO_BEGIN                                                                                                                                     \
    {                                                                                                                                                          \
        if ((expected) == (actual)) {                                                                                                                          \
            record_pass(myAction);                                                                                                                             \
...
UBool ResourceBundleTest::testTag(const char* frag, UBool in_Root, UBool in_te, UBool in_te_IN)
{
...
void ResourceBundleTest::TestGetSize(void)
{
    const struct {
        ...
        { "zerotest", 1 }, { "one", 1 }, { "importtest", 1 }, { "integerarray", 1 }, { "emptyarray", 0 }, { "emptytable", 0 },
        { "emptystring", 1 }, /* empty string is still a string */
        { "emptyint", 1 }, { "emptybin", 1 }, { "testinclude", 1 }, { "collations", 1 }, /* not 2 - there is hidden %%CollationBin */
    };
...
void ResourceBundleTest::TestGetLocaleByType(void)
{
    ...
    } test[] = { { "te_IN_BLAH", "string_only_in_te_IN", "te_IN", "te_IN" }, { "te_IN_BLAH", "string_only_in_te", "te_IN", "te" },
