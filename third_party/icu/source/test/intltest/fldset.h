...
public:
     ...
     * @return the number of valid parsed fields on success, or a negative number on failure.
     */
    int32_t parseFrom(const U_NAMESPACE_QUALIFIER UnicodeString& str, const FieldsSet& inheritFrom, UErrorCode& status)
    {
...
protected:
     ...
     */
    virtual int32_t handleParseName(
        const FieldsSet* inheritFrom, const U_NAMESPACE_QUALIFIER UnicodeString& name, const U_NAMESPACE_QUALIFIER UnicodeString& substr, UErrorCode& status);
     ...
     */
    virtual void handleParseValue(const FieldsSet* inheritFrom, int32_t field, const U_NAMESPACE_QUALIFIER UnicodeString& substr, UErrorCode& status);
     ...
     */
    void parseValueDefault(const FieldsSet* inheritFrom, int32_t field, const U_NAMESPACE_QUALIFIER UnicodeString& substr, UErrorCode& status);
     ...
     */
    void parseValueEnum(
        UDebugEnumType type, const FieldsSet* inheritFrom, int32_t field, const U_NAMESPACE_QUALIFIER UnicodeString& substr, UErrorCode& status);
...
public:
     ...
     */
    UBool matches(U_NAMESPACE_QUALIFIER Calendar* cal, CalendarFieldsSet& diffSet, UErrorCode& status) const;
...
protected:
     ...
     * subclass override
     */
    void handleParseValue(const FieldsSet* inheritFrom, int32_t field, const U_NAMESPACE_QUALIFIER UnicodeString& substr, UErrorCode& status) override;
};
...
protected:
    void handleParseValue(const FieldsSet* inheritFrom, int32_t field, const U_NAMESPACE_QUALIFIER UnicodeString& substr, UErrorCode& status) override;
    int32_t handleParseName(const FieldsSet* inheritFrom, const U_NAMESPACE_QUALIFIER UnicodeString& name, const U_NAMESPACE_QUALIFIER UnicodeString& substr,
