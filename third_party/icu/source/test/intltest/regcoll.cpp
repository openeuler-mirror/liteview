...
void CollationRegressionTest::Test4054734(/* char* par */)
{
    ...
    */
    ...
    static const UChar decomp[][CollationRegressionTest::MAX_TOKEN_LEN] = { { 0x0001, 0 }, { 0x3c, 0 }, { 0x0002, 0 }, { 0x0001, 0 }, { 0x3d, 0 },
        { 0x0001, 0 }, { 0x41, 0x0001, 0 }, { 0x3e, 0 }, { 0x7e, 0x0002, 0 }, { 0x00c0, 0 }, { 0x3d, 0 }, { 0x41, 0x0300, 0 } };
...
void CollationRegressionTest::Test4060154(/* char* par */)
{
   ...
   */
    ...
    static const UChar tertiary[][CollationRegressionTest::MAX_TOKEN_LEN]
        = { { 0x41, 0 }, { 0x3c, 0 }, { 0x42, 0 }, { 0x48, 0 }, { 0x3c, 0 }, { 0x0131, 0 }, { 0x48, 0 }, { 0x3c, 0 }, { 0x49, 0 }, { 0x0131, 0 }, { 0x3c, 0 },
              { 0x0130, 0 }, { 0x0130, 0 }, { 0x3c, 0 }, { 0x69, 0 }, { 0x0130, 0 }, { 0x3e, 0 }, { 0x48, 0 } };
...
*/
    static const UChar secondary[][CollationRegressionTest::MAX_TOKEN_LEN]
        = { { 0x48, 0 }, { 0x3c, 0 }, { 0x49, 0 }, { 0x0131, 0 }, { 0x3d, 0 }, { 0x0130, 0 } };
...
void CollationRegressionTest::Test4066696(/* char* par */)
{
    ...
    */
    ...
    static const UChar tests[][CollationRegressionTest::MAX_TOKEN_LEN] = { { 0x00E0, 0 }, { 0x3e, 0 }, { 0x01FA, 0 } };
...
void CollationRegressionTest::Test4078588(/* char *par */)
{
    ...
    if (result != Collator::LESS) {
        errln((UnicodeString) "Compare(a,bb) returned " + (int)result + (UnicodeString) "; expected -1");
    }
...
void CollationRegressionTest::Test4092260(/* char* par */)
{
    ...
    static const UChar tests[][CollationRegressionTest::MAX_TOKEN_LEN] = { { 0x00B5, 0 }, { 0x3d, 0 }, { 0x03BC, 0 } };
...
void CollationRegressionTest::Test4095316(/* char* par */)
{
    ...
    static const UChar tests[][CollationRegressionTest::MAX_TOKEN_LEN] = { { 0x03D4, 0 }, { 0x3d, 0 }, { 0x03AB, 0 } };
...
void CollationRegressionTest::Test4103436(/* char* par */)
{
    ...
    static const UChar tests[][CollationRegressionTest::MAX_TOKEN_LEN]
        = { { 0x66, 0x69, 0x6c, 0x65, 0 }, { 0x3c, 0 }, { 0x66, 0x69, 0x6c, 0x65, 0x20, 0x61, 0x63, 0x63, 0x65, 0x73, 0x73, 0 }, { 0x66, 0x69, 0x6c, 0x65, 0 },
              { 0x3c, 0 }, { 0x66, 0x69, 0x6c, 0x65, 0x61, 0x63, 0x63, 0x65, 0x73, 0x73, 0 } };
...
void CollationRegressionTest::Test4114076(/* char* par */)
{
    ...
    // conjoining Jamo
    //
    static const UChar test1[][CollationRegressionTest::MAX_TOKEN_LEN] = { { 0xd4db, 0 }, { 0x3d, 0 }, { 0x1111, 0x1171, 0x11b6, 0 } };
...
void CollationRegressionTest::Test4132736(/* char* par */)
{
    ...
    static const UChar test1[][CollationRegressionTest::MAX_TOKEN_LEN] = { { 0x65, 0x0300, 0x65, 0x0301, 0 }, { 0x3c, 0 }, { 0x65, 0x0301, 0x65, 0x0300, 0 },
...
{
    static const UChar test1[][CollationRegressionTest::MAX_TOKEN_LEN] = { { 0x45, 0x78, 0x63, 0x65, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0 }, { 0x3c, 0 },
        { 0x45, 0x78, 0x63, 0x65, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x6e, 0x49, 0x6e, 0x69, 0x74, 0x69, 0x61, 0x6c, 0x69, 0x7a, 0x65, 0x72, 0x45, 0x72, 0x72,
            0x6f, 0x72, 0 },
...
void CollationRegressionTest::Test4114077(/* char* par */)
{
    ...
    static const UChar test1[][CollationRegressionTest::MAX_TOKEN_LEN] = {
        ...
        { 0x70, 0x00ea, 0x63, 0x68, 0x65, 0 }, { 0x3e, 0 }, { 0x70, 0x00e9, 0x63, 0x68, 0x00e9, 0 }, { 0x0204, 0 }, { 0x3d, 0 }, { 0x45, 0x030F, 0 },
...
void CollationRegressionTest::Test4179216()
{
    ...
    for (int32_t i = 0; i < nextElementsLength; i++) {
        if (nextElements[i] == setOffsetElements[i]) {
            ...
            errln(UnicodeString("Error: next() yielded ") + nextElements[i] + ", but setOffset() yielded " + setOffsetElements[i]);
        }
    }
    delete iter;
}
...
void CollationRegressionTest::TestT7189()
{
    ...
    static const UChar text1[][CollationRegressionTest::MAX_TOKEN_LEN] = { // "Achter De Hoven"
    ...
    static const UChar text2[][CollationRegressionTest::MAX_TOKEN_LEN] = { // "Achter de Hoven"
...
void CollationRegressionTest::caseFirstCompressionSub(Collator* col, UnicodeString opt)
{
    ...
    for (int32_t len = 1; len <= maxLength; len++) {
        ...
        if (U_FAILURE(status)) {
            ...
            errln((UnicodeString) "Inconsistent comparison(" + opt + "): str1=" + UnicodeString(str1, len) + ", str2=" + UnicodeString(str2, len)
...
void CollationRegressionTest::compareArray(Collator& c, const UChar tests[][CollationRegressionTest::MAX_TOKEN_LEN], int32_t testCount)
{
    int32_t i;
