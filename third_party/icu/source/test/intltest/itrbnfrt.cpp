 ...
 */
void RbnfRoundTripTest::TestEnglishSpelloutRT()
{
 ...
 */
void RbnfRoundTripTest::TestDurationsRT()
{
    UErrorCode status = U_ZERO_ERROR;
 ...
 */
void RbnfRoundTripTest::TestSpanishSpelloutRT()
{
    UErrorCode status = U_ZERO_ERROR;
 ...
 */
void RbnfRoundTripTest::TestFrenchSpelloutRT()
{
    UErrorCode status = U_ZERO_ERROR;
 ...
 */
void RbnfRoundTripTest::TestSwissFrenchSpelloutRT()
{
    UErrorCode status = U_ZERO_ERROR;
 ...
 */
void RbnfRoundTripTest::TestItalianSpelloutRT()
{
    UErrorCode status = U_ZERO_ERROR;
 ...
 */
void RbnfRoundTripTest::TestGermanSpelloutRT()
{
    UErrorCode status = U_ZERO_ERROR;
 ...
 */
void RbnfRoundTripTest::TestSwedishSpelloutRT()
{
    UErrorCode status = U_ZERO_ERROR;
    RuleBasedNumberFormat* formatter = new RuleBasedNumberFormat(URBNF_SPELLOUT, Locale("sv", "SE"), status);
 ...
 */
void RbnfRoundTripTest::TestDutchSpelloutRT()
{
    UErrorCode status = U_ZERO_ERROR;
    RuleBasedNumberFormat* formatter = new RuleBasedNumberFormat(URBNF_SPELLOUT, Locale("nl", "NL"), status);
 ...
 */
void RbnfRoundTripTest::TestJapaneseSpelloutRT()
{
    UErrorCode status = U_ZERO_ERROR;
    RuleBasedNumberFormat* formatter = new RuleBasedNumberFormat(URBNF_SPELLOUT, Locale::getJapan(), status);
 ...
 */
void RbnfRoundTripTest::TestRussianSpelloutRT()
{
    UErrorCode status = U_ZERO_ERROR;
    RuleBasedNumberFormat* formatter = new RuleBasedNumberFormat(URBNF_SPELLOUT, Locale("ru", "RU"), status);
 ...
 */
void RbnfRoundTripTest::TestPortugueseSpelloutRT()
{
    UErrorCode status = U_ZERO_ERROR;
...
void RbnfRoundTripTest::doTest(const RuleBasedNumberFormat* formatter, double lowLimit, double highLimit)
{
    char buf[128];
    ...
    for (double i = lowLimit; i <= highLimit; i += increment) {
        ...
        if (U_FAILURE(status)) {
            ...
            double rt = (parseResult.getType() == Formattable::kDouble) ? parseResult.getDouble() : (double)parseResult.getLong();
...
void RbnfRoundTripTest::TestRBNFDisabled()
{
