...
private:
    void assertInSet(const UnicodeString& localeName, const UnicodeString& setName, const UnicodeSet& set, const UnicodeString& str);
    void assertInSet(const UnicodeString& localeName, const UnicodeString& setName, const UnicodeSet& set, UChar32 cp);
};
...
void StaticUnicodeSetsTest::testSetCoverage()
{
    ...
    assertTrue("COMMA should be superset of STRICT_COMMA", get(unisets::COMMA)->containsAll(*get(unisets::STRICT_COMMA)));
    assertTrue("PERIOD should be superset of STRICT_PERIOD", get(unisets::PERIOD)->containsAll(*get(unisets::STRICT_PERIOD)));
...
void StaticUnicodeSetsTest::assertInSet(const UnicodeString& localeName, const UnicodeString& setName, const UnicodeSet& set, const UnicodeString& str)
{
...
void StaticUnicodeSetsTest::assertInSet(const UnicodeString& localeName, const UnicodeString& setName, const UnicodeSet& set, UChar32 cp)
{
    ...
    assertTrue(localeName + UnicodeString(u" ") + UnicodeString(cp) + UnicodeString(u" is missing in ") + setName, set.contains(cp));
}
