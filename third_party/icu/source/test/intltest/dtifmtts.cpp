...
void DateIntervalFormatTest::testFormat()
{
    ...
    const char* DATA[] = {
        ...
        "10:10:10 \\u2013 11:10:10",
        "en",
        "CE 2007 11 10 20:10:10",
        "CE 2007 11 10 21:10:10",
        "Hms",
        "20:10:10 \\u2013 21:10:10",
        ...
        "en",
        "CE 2007 10 10 20:10:10",
        "CE 2008 10 10 20:10:10",
        "Hm",
        "10/10/2007, 20:10 \\u2013 10/10/2008, 20:10",
        ...
        "CE 2007 11 10 10:10:10",
        "Hm",
        "10/10/2007, 10:10 \\u2013 11/10/2007, 10:10",
        "en",
        "CE 2007 10 10 20:10:10",
        "CE 2007 11 10 20:10:10",
        "Hm",
        "10/10/2007, 20:10 \\u2013 11/10/2007, 20:10",
        ...
        "CE 2007 11 20 10:10:10",
        "Hm",
        "11/10/2007, 10:10 \\u2013 11/20/2007, 10:10",
        "en",
        "CE 2007 11 10 20:10:10",
        "CE 2007 11 20 20:10:10",
        "Hm",
        "11/10/2007, 20:10 \\u2013 11/20/2007, 20:10",
        ...
        "CE 2007 11 20 10:10:10",
        "h",
        "11/10/2007, 10 AM \\u2013 11/20/2007, 10 AM",

        "en",
        "CE 2007 11 10 10:10:10",
        "CE 2007 11 20 10:10:10",
        "hv",
        "11/10/2007, 10 AM PT \\u2013 11/20/2007, 10 AM PT",
        ...
        "CE 2007 11 20 10:10:10",
        "Hms",
        "11/10/2007, 10:10:10 \\u2013 11/20/2007, 10:10:10",
        "en",
        "CE 2007 11 10 20:10:10",
        "CE 2007 11 20 20:10:10",
        "Hms",
        "11/10/2007, 20:10:10 \\u2013 11/20/2007, 20:10:10",
        ...
        "CE 2007 11 20 10:10:10",
        "MMMMy",
        "2007\\u5E7411\\u6708", // (fixed expected result per ticket:6626:)
        ...
        "CE 2007 11 20 10:10:10",
        "MMM",
        "11\\u6708", // (fixed expected result per ticket:6626: and others)
        ...
        "CE 2007 01 10 14:10:10",
        "EEEEdMMMMy",
        "2007\\u5e741\\u670810\\u65e5\\u661f\\u671f\\u4e09", // (fixed expected result per ticket:6626:)
        ...
        "CE 2007 11 10 10:10:10",
        "Hms",
        "10.10.2007, 10:10:10 \\u2013 10.11.2007, 10:10:10",
        ...
        "CE 2007 11 20 10:10:10",
        "hmv",
        "10.11.2007, 10:10 AM Los Angeles Zeit \\u2013 20.11.2007, 10:10 AM Los Angeles Zeit",
        ...
        "CE 2007 01 10 10:20:10",
        "hmv",
        "10:00\\u201310:20 AM Los Angeles Zeit",
        ...
        "EEEEdMMMy",
        "\\u0E27\\u0E31\\u0E19\\u0E1E\\u0E38\\u0E18\\u0E17\\u0E35\\u0E48 10 \\u0E15.\\u0E04. 2550 \\u2013 "
        "\\u0E27\\u0E31\\u0E19\\u0E28\\u0E38\\u0E01\\u0E23\\u0E4C\\u0E17\\u0E35\\u0E48 10 \\u0E15.\\u0E04. 2551",
        ...
        "EEEEdMMMy",
        "\\u0E27\\u0E31\\u0E19\\u0E1E\\u0E38\\u0E18\\u0E17\\u0E35\\u0E48 10 \\u0E15.\\u0E04. \\u2013 "
        "\\u0E27\\u0E31\\u0E19\\u0E40\\u0E2A\\u0E32\\u0E23\\u0E4C\\u0E17\\u0E35\\u0E48 "
        "10 \\u0E1E.\\u0E22. 2550",
        ...
        "H 1 01 15 09:00:00",
        "GyMMMd",
        "Jan 5, 64 Sh\\u014Dwa \\u2013 Jan 15, 1 Heisei",
        ...
        "en-u-ca-japanese",
        "H 31 04 15 09:00:00",
        JP_ERA_2019_NARROW " 1 05 15 09:00:00",
        "GyMMMd",
        "Apr 15, 31 Heisei \\u2013 May 15, 1 " JP_ERA_2019_ROOT,

        "en-u-ca-japanese",
        "H 31 04 15 09:00:00",
        JP_ERA_2019_NARROW " 1 05 15 09:00:00",
        "GGGGGyMd",
        "4/15/31 H \\u2013 5/15/1 " JP_ERA_2019_NARROW,

        "ja-u-ca-japanese",
        "H 31 03 15 09:00:00",
        "H 31 04 15 09:00:00",
        "GyMMMd",
        "\\u5E73\\u621031\\u5E743\\u670815\\u65E5\\uFF5E4\\u670815\\u65E5",
...
void DateIntervalFormatTest::expect(const char** data, int32_t data_length)
{
    ...
    while (i < data_length) {
        ...
        if (!assertSuccess("parse 1st data in expect", ec))
            return;
        UDate date_2 = ref.parse(ctou(datestr_2), ec);
        if (!assertSuccess("parse 2nd data in expect", ec))
            return;
        ...
        if (!assertSuccess("createInstance(skeleton) in expect", ec))
            return;
        FieldPosition pos(FieldPosition::DONT_CARE);
        dtitvfmt->format(&dtitv, str.remove(), pos, ec);
        if (!assertSuccess("format in expect", ec))
            return;
        assertEquals((UnicodeString) "\"" + locName + "\\" + oneSkeleton + "\\" + ctou(datestr) + "\\" + ctou(datestr_2) + "\"", ctou(data[i++]), str);

        logln("interval date:" + str + "\"" + locName + "\", " + "\"" + datestr + "\", " + "\"" + datestr_2 + "\", " + oneSkeleton);
        delete dtitvfmt;
    }
}
...
void DateIntervalFormatTest::testFormatUserDII()
{
    ...
    const char* DATA[] = {
        ...
        "2007 01 10 10:00:10",
        "2007 01 10 14:10:10",
        "2007\\u5e741\\u670810\\u65e5", // (fixed expected result per ticket:6626:)
...
void DateIntervalFormatTest::testContext()
{
    ...
    for (testItemPtr = testItems; testItemPtr->locale != nullptr; ++testItemPtr) {
        ...
        if (U_FAILURE(status)) {
            errln("createInstance failed for locale %s skeleton %s: %s", testItemPtr->locale, testItemPtr->skeleton, u_errorName(status));
            continue;
        }
        ...
        if (U_FAILURE(status)) {
            errln("setContext failed for locale %s skeleton %s context %04X: %s", testItemPtr->locale, testItemPtr->skeleton, (unsigned)testItemPtr->context,
                u_errorName(status));
        } else {
            UDisplayContext getContext = fmt->getContext(UDISPCTX_TYPE_CAPITALIZATION, status);
            if (U_FAILURE(status)) {
                errln("getContext failed for locale %s skeleton %s context %04X: %s", testItemPtr->locale, testItemPtr->skeleton,
                    (unsigned)testItemPtr->context, u_errorName(status));
            } else if (getContext != testItemPtr->context) {
                errln("getContext failed for locale %s skeleton %s context %04X: got context %04X", testItemPtr->locale, testItemPtr->skeleton,
                    (unsigned)testItemPtr->context, (unsigned)getContext);
            }
        }
        ...
        if (U_FAILURE(status)) {
            errln("format failed for locale %s skeleton %s context %04X: %s", testItemPtr->locale, testItemPtr->skeleton, (unsigned)testItemPtr->context,
                u_errorName(status));
            continue;
        }
...
void DateIntervalFormatTest::expectUserDII(const char** data, int32_t data_length)
{
    int32_t i = 0;
    UnicodeString str;
    UErrorCode ec = U_ZERO_ERROR;
    ...
    while (i < data_length) {
        ...
        const char* datestr_2 = data[i++];
        UDate date = ref.parse(ctou(datestr), ec);
        if (!assertSuccess("parse in expectUserDII", ec))
            return;
        UDate date_2 = ref.parse(ctou(datestr_2), ec);
        if (!assertSuccess("parse in expectUserDII", ec))
            return;
        ...
        if (!assertSuccess("DateIntervalInfo::setIntervalPattern", ec))
            return;
        ...
        delete dtitvinf;
        if (!assertSuccess("createInstance(skeleton,dtitvinf) in expectUserDII", ec))
            return;
        FieldPosition pos(FieldPosition::DONT_CARE);
        dtitvfmt->format(&dtitv, str.remove(), pos, ec);
        if (!assertSuccess("format in expectUserDII", ec))
            return;
...
void DateIntervalFormatTest::stress(const char** data, int32_t data_length, const Locale& loc, const char* locName)
{
    ...
    if (!assertSuccess("construct SimpleDateFormat", ec))
        return;
    ...
    while (i < data_length) {
        ...
        for (uint32_t skeletonIndex = 0; skeletonIndex < UPRV_LENGTHOF(skeleton); ++skeletonIndex) {
            const UnicodeString& oneSkeleton = skeleton[skeletonIndex];
            DateIntervalFormat* dtitvfmt = DateIntervalFormat::createInstance(oneSkeleton, loc, ec);
            if (!assertSuccess("createInstance(skeleton)", ec))
                return;
            /*
        ...
        DateIntervalFormat* dtitvfmt = DateIntervalFormat::createInstance(UDAT_YEAR_ABBR_MONTH_DAY, loc, *dtitvinf, ec);
        delete dtitvinf;
        if (!assertSuccess("createInstance(skeleton,dtitvinf)", ec))
            return;
        FieldPosition pos(FieldPosition::DONT_CARE);
        dtitvfmt->format(&dtitv, str.remove(), pos, ec);
...
{
    UErrorCode status = U_ZERO_ERROR;
    LocalPointer<DateIntervalFormat> fmt(DateIntervalFormat::createInstance("yMMM", "es-US", status));
    ...
    assertEquals("", expected.unescape(), fmt->format(&interval, appendTo, fpos, status));
...
{
    UErrorCode status = U_ZERO_ERROR;
    LocalPointer<DateIntervalFormat> fmt(DateIntervalFormat::createInstance(UDAT_HOUR_MINUTE, Locale::getEnglish(), status));
...
void DateIntervalFormatTest::testFormattedDateInterval()
{
...

    {
        ...
        static const UFieldPositionWithCategory expectedFieldPositions[] = { // field, begin index, end index
            { UFIELD_CATEGORY_DATE, UDAT_MONTH_FIELD, 0, 4 }, { UFIELD_CATEGORY_DATE_INTERVAL_SPAN, 0, 5, 7 }, { UFIELD_CATEGORY_DATE, UDAT_DATE_FIELD, 5, 7 },
            { UFIELD_CATEGORY_DATE_INTERVAL_SPAN, 1, 10, 12 }, { UFIELD_CATEGORY_DATE, UDAT_DATE_FIELD, 10, 12 },
...

    {
        ...
        static const UFieldPositionWithCategory expectedFieldPositions[] = { // field, begin index, end index
            { UFIELD_CATEGORY_DATE, UDAT_MONTH_FIELD, 0, 4 }, { UFIELD_CATEGORY_DATE, UDAT_DATE_FIELD, 5, 7 }, { UFIELD_CATEGORY_DATE, UDAT_YEAR_FIELD, 9, 13 }
        };
        checkMixedFormattedValue(message, result, expectedString, expectedFieldPositions, UPRV_LENGTHOF(expectedFieldPositions));
    }
    ...
    // Test sample code
    {
        ...
        FormattedDateInterval result = fmt->formatToValue(*input1, *input2, status);
        assertEquals("Expected output from format", u"July 20 \u2013 August 3, 2018", result.toString(status));
        ...
        assertFalse("No more than one occurrence of the field", result.nextPosition(cfpos, status));
    }
    ...
    fmt.adoptInsteadAndCheckErrorCode(DateIntervalFormat::createInstance(u"dMMMMy", "en-US", dtitvinf, status), status);

    {
        ...
        FormattedDateInterval result = fmt->formatToValue(*input1, *input2, status);
        static const UFieldPositionWithCategory expectedFieldPositions[] = { // field, begin index, end index
            { UFIELD_CATEGORY_DATE_INTERVAL_SPAN, 1, 3, 16 }, { UFIELD_CATEGORY_DATE, UDAT_MONTH_FIELD, 3, 7 },
            { UFIELD_CATEGORY_DATE, UDAT_DATE_FIELD, 8, 10 }, { UFIELD_CATEGORY_DATE, UDAT_YEAR_FIELD, 12, 16 },
            { UFIELD_CATEGORY_DATE_INTERVAL_SPAN, 0, 21, 34 }, { UFIELD_CATEGORY_DATE, UDAT_MONTH_FIELD, 21, 25 },
            { UFIELD_CATEGORY_DATE, UDAT_DATE_FIELD, 26, 28 }, { UFIELD_CATEGORY_DATE, UDAT_YEAR_FIELD, 30, 34 }
        };
        checkMixedFormattedValue(message, result, expectedString, expectedFieldPositions, UPRV_LENGTHOF(expectedFieldPositions));
    }
}
...
void DateIntervalFormatTest::testCreateInstanceForAllLocales()
{
    ...
    for (int32_t i = 0; i < locale_count; i++) {
        std::unique_ptr<icu::StringEnumeration> calendars(icu::Calendar::getKeywordValuesForLocale("calendar", locales[i], FALSE, status));
        ...
        if (quick && (i % 5 != 0))
            continue;
        LocalPointer<DateIntervalFormat> fmt(DateIntervalFormat::createInstance(u"dMMMMy", locales[i], status), status);
        ...
        for (int32_t j = 0; j < calendar_count; j++) {
            ...
            fmt.adoptInsteadAndCheckErrorCode(DateIntervalFormat::createInstance(u"dMMMMy", locale, status), status);
...
void DateIntervalFormatTest::testFormatMillisecond()
{
    ...
    for (int32_t i = 0; kTestCases[i].year > 0; i++) {
        LocalPointer<DateIntervalFormat> fmt(DateIntervalFormat::createInstance(kTestCases[i].skeleton, enLocale, status));
        if (status.errIfFailureAndReset()) {
            continue;
        }
        ...
        calendar->clear();
        calendar->set(
            kTestCases[i].year, kTestCases[i].month, kTestCases[i].day, kTestCases[i].from_hour, kTestCases[i].from_miniute, kTestCases[i].from_second);
        ...
        calendar->clear();
        calendar->set(kTestCases[i].year, kTestCases[i].month, kTestCases[i].day, kTestCases[i].to_hour, kTestCases[i].to_miniute, kTestCases[i].to_second);
        ...
        if (formatted != kTestCases[i].expected) {
            std::string tmp1;
            std::string tmp2;
            errln("Case %d for skeleton %s : Got %s but expect %s", i, kTestCases[i].skeleton, formatted.toUTF8String<std::string>(tmp1).c_str(),
...
void DateIntervalFormatTest::testTicket20707()
{
    ...
    UnicodeString expected[][7] = { // Hour-cycle: k
        ...
        // Hour-cycle: K
        { u"0 AM", u"00", u"00", u"0 AM", u"0 AM", u"0 (hour: 00)", u"0 AM" }, { u"12 AM", u"00", u"00", u"12 AM", u"12 AM", u"0 (hour: 12)", u"12 AM" },
        { u"12 AM", u"00", u"00", u"12 AM", u"12 AM", u"0 (hour: 12)", u"12 AM" },
        // Hour-cycle: K
...
void DateIntervalFormatTest::getCategoryAndField(
    const FormattedDateInterval& formatted, std::vector<int32_t>& categories, std::vector<int32_t>& fields, IcuTestErrorCode& status)
{
    categories.clear();
    fields.clear();
    ConstrainedFieldPosition cfpos;
...
void DateIntervalFormatTest::verifyCategoryAndField(
    const FormattedDateInterval& formatted, const std::vector<int32_t>& categories, const std::vector<int32_t>& fields, IcuTestErrorCode& status)
{
    ConstrainedFieldPosition cfpos;
    int32_t i = 0;
    while (formatted.nextPosition(cfpos, status)) {
...
void DateIntervalFormatTest::testTicket21222GregorianEraDiff()
{
    ...
    LocalPointer<DateIntervalFormat> g(DateIntervalFormat::createInstance(u"h", Locale("en"), status));
    if (U_FAILURE(status)) {
        errln("Failure encountered: %s", u_errorName(status));
        return;
    }
    ...
    assertEquals("Gregorian - calendar both dates in AD", u"4/5/123, 6 AM \u2013 4/5/124, 6 AM", formatted.toString(status));

    formatted = g->formatToValue(bothBC, status);
    assertEquals("Gregorian - calendar both dates in BC", u"4/5/124, 6 AM \u2013 4/5/123, 6 AM", formatted.toString(status));

    formatted = g->formatToValue(BCtoAD, status);
    assertEquals("Gregorian - BC to AD", u"4/5/123 B, 6 AM \u2013 4/5/124 A, 6 AM", formatted.toString(status));
}
...
void DateIntervalFormatTest::testTicket21222ROCEraDiff()
{
    ...
    // Test roc calendar
    LocalPointer<DateIntervalFormat> roc(DateIntervalFormat::createInstance(u"h", Locale("zh-Hant-TW@calendar=roc"), status));
    if (U_FAILURE(status)) {
        errln("Failure encountered: %s", u_errorName(status));
        return;
    }
    ...
    assertEquals("roc calendar - both dates in MG Era", u"民國1/1/2 上午6時 – 民國2/1/2 上午6時", formatted.toString(status));
    getCategoryAndField(formatted, expectedCategory, expectedField, status);

    formatted = roc->formatToValue(beforeAfterMG, status);
    assertEquals("roc calendar - prior MG Era and in MG Era", u"民國前1/1/2 上午6時 – 民國2/1/2 上午6時", formatted.toString(status));
    verifyCategoryAndField(formatted, expectedCategory, expectedField, status);

    formatted = roc->formatToValue(bothBeforeMG, status);
    assertEquals("roc calendar - both dates prior MG Era", u"民國前2/1/2 上午6時 – 民國前1/1/2 上午6時", formatted.toString(status));
    verifyCategoryAndField(formatted, expectedCategory, expectedField, status);
}
...
void DateIntervalFormatTest::testTicket21222JapaneseEraDiff()
{
    ...
    LocalPointer<DateIntervalFormat> japanese(DateIntervalFormat::createInstance(u"h", Locale("ja@calendar=japanese"), status));
    if (U_FAILURE(status)) {
        errln("Failure encountered: %s", u_errorName(status));
        return;
    }
    ...
    assertEquals("japanese calendar - both dates in Reiwa", u"R1/5/4 午前6時～R1/6/5 午前6時", formatted.toString(status));
    getCategoryAndField(formatted, expectedCategory, expectedField, status);

    formatted = japanese->formatToValue(bothBeforeReiwa, status);
    assertEquals("japanese calendar - both dates before Reiwa", u"H31/3/2 午前6時～H31/4/3 午前6時", formatted.toString(status));
    verifyCategoryAndField(formatted, expectedCategory, expectedField, status);

    formatted = japanese->formatToValue(beforeAfterReiwa, status);
    assertEquals("japanese calendar - date before and in Reiwa", u"H31/3/2 午前6時～R1/5/4 午前6時", formatted.toString(status));
    verifyCategoryAndField(formatted, expectedCategory, expectedField, status);
}
