...
void PUtilTest::runIndexedTest(int32_t index, UBool exec, const char*& name, char* /*par*/)
{
...
void PUtilTest::maxMinTest(double a, double b, double exp, UBool max)
{
    double result = 0.0;
...
void PUtilTest::testPositiveInfinity(void)
{
    double pinf = uprv_getInfinity();
    double ninf = -uprv_getInfinity();
    double ten = 10.0;
...
void PUtilTest::testNegativeInfinity(void)
{
    double pinf = uprv_getInfinity();
    double ninf = -uprv_getInfinity();
    double ten = 10.0;
