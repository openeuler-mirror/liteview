...
private:
     ...
     */
    void stress(const char** data, int32_t data_length, const Locale& loc, const char* locName);

    void getCategoryAndField(const FormattedDateInterval& formatted, std::vector<int32_t>& categories, std::vector<int32_t>& fields, IcuTestErrorCode& status);
