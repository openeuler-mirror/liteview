...
{
    const char* LOCALES[] = { "zh_CN@calendar=chinese", "cop_EG@calendar=coptic", "hi_IN@calendar=indian", "am_ET@calendar=ethiopic" };
 ...
 */
void IntlTestDateFormatAPI::TestNameHiding(void)
{
