...
#define DRAW_OP_TEST_EXTERN(Op) extern GrOp::Owner Op##__Test(GrPaint&&, SkRandom*, GrRecordingContext*, skgpu::v1::SurfaceDrawContext*, int)
...
void GrDrawRandomOp(SkRandom* random, skgpu::v1::SurfaceDrawContext* sdc, GrPaint&& paint)
{
    ...
    using MakeDrawOpFn = GrOp::Owner(GrPaint&&, SkRandom*, GrRecordingContext*, skgpu::v1::SurfaceDrawContext*, int numSamples);
