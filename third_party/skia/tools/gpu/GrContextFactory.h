...
public:
    ...
    GrContextFactory::ContextType type() const
    {
        return fType;
    }
    GrBackendApi backend() const
    {
        return GrContextFactory::ContextTypeBackend(fType);
    }
...
private:
    ContextInfo(GrContextFactory::ContextType type, TestContext* testContext, GrDirectContext* context, const GrContextOptions& options)
        : fType(type)
