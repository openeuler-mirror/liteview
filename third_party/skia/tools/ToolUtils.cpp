...
public:
    ...
    sk_sp<SkImage> findOrCreate(skgpu::graphite::Recorder* recorder, const SkImage* image, SkImage::RequiredImageProperties requiredProps) override
    {
        ...
        uint64_t key = ((uint64_t)image->uniqueID() << 32) | (requiredProps.fMipmapped == skgpu::graphite::Mipmapped::kYes ? 0x1 : 0x0);
