...
void DebugLayerManager::storeSkPicture(int nodeId, int frame, sk_sp<SkPicture> picture, SkIRect dirty)
{
...
sk_sp<SkImage> DebugLayerManager::getLayerAsImage(const int nodeId, const int frame)
{
    ...
    auto surface = SkSurface::MakeRaster(SkImageInfo::Make(drawEvent.layerBounds, kRGBA_8888_SkColorType, kUnpremul_SkAlphaType, nullptr));
