...
public:
    ...
    public:
        ...
        void init(int id, GrDirectContext*, const SkSurfaceCharacterization& dstChar, const SkIRect& clip, const SkIRect& paddingOutsets);
    ...
    DDLTileHelper(
        GrDirectContext*, const SkSurfaceCharacterization& dstChar, const SkIRect& viewport, int numXDivisions, int numYDivisions, bool addRandomPaddingToDst);
    ...
    const sk_sp<SkDeferredDisplayList>& composeDDL() const
    {
        return fComposeDDL;
    }
