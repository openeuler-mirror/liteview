...
void Window_android::initDisplay(ANativeWindow* window)
{
    ...
    case kRaster_BackendType:
        fWindowContext = window_context_factory::MakeRasterForAndroid(window, fRequestedDisplayParams);
        break;
#ifdef SK_VULKAN
    case kVulkan_BackendType:
        fWindowContext = window_context_factory::MakeVulkanForAndroid(window, fRequestedDisplayParams);
        break;
#endif
    }
