...
void VulkanWindowContext::initializeContext()
{
    ...
    fInterface.reset(new skgpu::VulkanInterface(backendContext.fGetProc, fInstance, fDevice, backendContext.fInstanceVersion, physDevVersion, &extensions));
...
bool VulkanWindowContext::createBuffers(VkFormat format, VkImageUsageFlags usageFlags, SkColorType colorType, VkSharingMode sharingMode)
{
    ...
    for (uint32_t i = 0; i < fImageCount; ++i) {
        ...
        if (usageFlags & VK_IMAGE_USAGE_SAMPLED_BIT) {
            ...
            fSurfaces[i] = SkSurface::MakeFromBackendTexture(fContext.get(), backendTexture, kTopLeft_GrSurfaceOrigin, fDisplayParams.fMSAASampleCount,
