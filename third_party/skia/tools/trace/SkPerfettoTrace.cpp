    ...
    const uint8_t* categoryEnabledFlag, const char* eventName, const char* arg1Name, const uint8_t& arg1Type, const uint64_t& arg1Val)
{
    ...
    case TRACE_VALUE_TYPE_BOOL: {
        TRACE_EVENT_BEGIN(category, nullptr, arg1Name, value.as_bool, [&](perfetto::EventContext ctx) { ctx.event()->set_name(eventName); });
        break;
    }
    case TRACE_VALUE_TYPE_UINT: {
        TRACE_EVENT_BEGIN(category, nullptr, arg1Name, value.as_uint, [&](perfetto::EventContext ctx) { ctx.event()->set_name(eventName); });
        break;
    }
    case TRACE_VALUE_TYPE_INT: {
        TRACE_EVENT_BEGIN(category, nullptr, arg1Name, value.as_int, [&](perfetto::EventContext ctx) { ctx.event()->set_name(eventName); });
        break;
    }
    case TRACE_VALUE_TYPE_DOUBLE: {
        TRACE_EVENT_BEGIN(category, nullptr, arg1Name, value.as_double, [&](perfetto::EventContext ctx) { ctx.event()->set_name(eventName); });
        break;
    }
    case TRACE_VALUE_TYPE_POINTER: {
        TRACE_EVENT_BEGIN(category, nullptr, arg1Name, value.as_pointer, [&](perfetto::EventContext ctx) { ctx.event()->set_name(eventName); });
        break;
    }
    case TRACE_VALUE_TYPE_STRING: {
        TRACE_EVENT_BEGIN(category, nullptr, arg1Name, value.as_string, [&](perfetto::EventContext ctx) { ctx.event()->set_name(eventName); });
        break;
    }
    ...
    const char* categoryName, const char* eventName, const char* arg1Name, T arg1Val, const char* arg2Name, const uint8_t& arg2Type, const uint64_t& arg2Val)
{
    ...
    switch (arg2Type) {
    case TRACE_VALUE_TYPE_BOOL: {
        TRACE_EVENT_BEGIN(category, nullptr, arg1Name, arg1Val, arg2Name, value.as_bool, [&](perfetto::EventContext ctx) { ctx.event()->set_name(eventName); });
        break;
    }
    case TRACE_VALUE_TYPE_UINT: {
        TRACE_EVENT_BEGIN(category, nullptr, arg1Name, arg1Val, arg2Name, value.as_uint, [&](perfetto::EventContext ctx) { ctx.event()->set_name(eventName); });
        break;
    }
    case TRACE_VALUE_TYPE_INT: {
        TRACE_EVENT_BEGIN(category, nullptr, arg1Name, arg1Val, arg1Name, value.as_int, [&](perfetto::EventContext ctx) { ctx.event()->set_name(eventName); });
        break;
    }
    case TRACE_VALUE_TYPE_DOUBLE: {
        TRACE_EVENT_BEGIN(
            category, nullptr, arg1Name, arg1Val, arg2Name, value.as_double, [&](perfetto::EventContext ctx) { ctx.event()->set_name(eventName); });
        break;
    }
    case TRACE_VALUE_TYPE_POINTER: {
        TRACE_EVENT_BEGIN(
            category, nullptr, arg1Name, arg1Val, arg2Name, value.as_pointer, [&](perfetto::EventContext ctx) { ctx.event()->set_name(eventName); });
        break;
    }
    case TRACE_VALUE_TYPE_STRING: {
        TRACE_EVENT_BEGIN(
            category, nullptr, arg1Name, arg1Val, arg2Name, value.as_string, [&](perfetto::EventContext ctx) { ctx.event()->set_name(eventName); });
        break;
    }
    case TRACE_VALUE_TYPE_COPY_STRING: {
        TRACE_EVENT_BEGIN(
    ...
    const uint64_t& arg1Val, const char* arg2Name, const uint8_t& arg2Type, const uint64_t& arg2Val)
{
    ...
    switch (arg1Type) {
    case TRACE_VALUE_TYPE_BOOL: {
        begin_event_with_second_arg(category, eventName, arg1Name, value.as_bool, arg2Name, arg2Type, arg2Val);
        break;
    }
    case TRACE_VALUE_TYPE_UINT: {
        begin_event_with_second_arg(category, eventName, arg1Name, value.as_uint, arg2Name, arg2Type, arg2Val);
        break;
    }
    case TRACE_VALUE_TYPE_INT: {
        begin_event_with_second_arg(category, eventName, arg1Name, value.as_int, arg2Name, arg2Type, arg2Val);
        break;
    }
    case TRACE_VALUE_TYPE_DOUBLE: {
        begin_event_with_second_arg(category, eventName, arg1Name, value.as_double, arg2Name, arg2Type, arg2Val);
        break;
    }
    case TRACE_VALUE_TYPE_POINTER: {
        begin_event_with_second_arg(category, eventName, arg1Name, value.as_pointer, arg2Name, arg2Type, arg2Val);
        break;
    }
    case TRACE_VALUE_TYPE_STRING: {
        begin_event_with_second_arg(category, eventName, arg1Name, value.as_string, arg2Name, arg2Type, arg2Val);
        break;
    }
    case TRACE_VALUE_TYPE_COPY_STRING: {
        begin_event_with_second_arg(category, eventName, arg1Name, value.as_string, arg2Name, arg2Type, arg2Val);
