...
bool RandomScalerContext::generateAdvance(SkGlyph* glyph)
{
...
void RandomScalerContext::generateImage(const SkGlyph& glyph)
{
    ...
    SkBitmap bm;
    bm.installPixels(SkImageInfo::MakeN32Premul(glyph.fWidth, glyph.fHeight), glyph.fImage, glyph.rowBytes());
    bm.eraseColor(0);
