...
public:
    SkCommandLineConfig(const SkString& tag, const SkString& backend, const SkTArray<SkString>& viaParts);
    ...
    const SkTArray<SkString>& getViaParts() const
    {
        return fViaParts;
    }
...
public:
    ...
    SkCommandLineConfigGpu(const SkString& tag, const SkTArray<SkString>& viaParts, ContextType contextType, bool fakeGLESVer2, uint32_t surfaceFlags,
        int samples, SkColorType colorType, SkAlphaType alphaType, bool useStencilBuffers, bool testThreading, int testPersistentCache, bool testPrecompile,
        bool useDDLSink, bool OOPRish, bool slug, bool reducedShaders, SurfType);
    ...
    bool getTestThreading() const
    {
        return fTestThreading;
    }
...
public:
    ...
    SkCommandLineConfigGraphite(const SkString& tag, const SkTArray<SkString>& viaParts, ContextType contextType, SkColorType colorType, SkAlphaType alphaType)
