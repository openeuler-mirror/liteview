...
static void run_test(skiatest::Reporter*, GrDirectContext*, skgpu::v1::SurfaceDrawContext*, SkVector a, SkVector b, float expectedCrossProduct);
...
DEF_GANESH_TEST_FOR_RENDERING_CONTEXTS(SkSLCross, reporter, ctxInfo, CtsEnforcement::kApiLevel_T)
{
    ...
    auto sdc = skgpu::v1::SurfaceDrawContext::Make(dContext, GrColorType::kRGBA_8888, nullptr, SkBackingFit::kExact, { 1, 1 }, SkSurfaceProps(),
    ...
    std::unique_ptr<ProgramImpl> onMakeProgramImpl() const override
    {
        ...
        public:
            void emitCode(EmitArgs& args) override
            {
                ...
                const char *a, *b;
                fAUniform = args.fUniformHandler->addUniform(&fp, kFragment_GrShaderFlag, SkSLType::kFloat2, "a", &a);
                fBUniform = args.fUniformHandler->addUniform(&fp, kFragment_GrShaderFlag, SkSLType::kFloat2, "b", &b);
...
static void run_test(
    skiatest::Reporter* reporter, GrDirectContext* directContext, skgpu::v1::SurfaceDrawContext* sdc, SkVector a, SkVector b, float expectedCrossProduct)
{
    ...
    sdc->drawRect(/*clip=*/nullptr, std::move(crossPaint), GrAA::kNo, SkMatrix::I(), SkRect::MakeWH(1, 1));

    GrColor result;
    GrPixmap resultPM(SkImageInfo::Make(1, 1, kRGBA_8888_SkColorType, kPremul_SkAlphaType), &result, sizeof(GrColor));
