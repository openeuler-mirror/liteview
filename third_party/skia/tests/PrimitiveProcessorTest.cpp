                ...
                , fNumAttribs(numAttribs)
            {
                ...
                for (auto i = 0; i < numAttribs; ++i) {
                    ...
                    if (i & 0x1) {
                        ...
                        fAttributes[i] = { fAttribNames[i].c_str(), kFloat2_GrVertexAttribType, SkSLType::kFloat2 };
                    }
                }
...
DEF_GANESH_TEST_FOR_ALL_CONTEXTS(VertexAttributeCount, reporter, ctxInfo, CtsEnforcement::kApiLevel_T)
{
    ...
    auto sdc = skgpu::v1::SurfaceDrawContext::Make(dContext, GrColorType::kRGBA_8888, nullptr, SkBackingFit::kApprox, { 1, 1 }, SkSurfaceProps(),
        /*label=*/ {});
    if (!sdc) {
