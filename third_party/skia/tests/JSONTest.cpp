...
template <typename T, typename VT> static void check_primitive(skiatest::Reporter* reporter, const Value& v, T pv, bool is_type)
{
...
template <typename T> static void check_vector(skiatest::Reporter* reporter, const Value& v, size_t expected_size, bool is_vector)
{
...
template <typename T> void check_value(skiatest::Reporter* reporter, const Value& v, const char* expected_string)
{
...
DEF_TEST(JSON_ParseNumber, reporter)
{
    static constexpr struct {
        ...
        { "20.001111814444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444473", 20.001f, 0.001f },
    };
