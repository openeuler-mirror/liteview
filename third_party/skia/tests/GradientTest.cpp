...
static void test_big_grad(skiatest::Reporter* reporter)
{
    ...
    const SkScalar affine[] = { 1.06608627e-06f, 4.26434525e-07f, 6.2855f, 2.6611f, 273.4393f, 244.0046f };
    SkMatrix matrix;
...
struct GradRec {
    ...
    void gradCheck(skiatest::Reporter* reporter, const sk_sp<SkShader>& shader, SkShaderBase::GradientInfo* info, SkShaderBase::GradientType gt,
...
{
    sk_sp<SkShader> s(SkGradientShader::MakeLinear(buildRec.fPoint, buildRec.fColors, buildRec.fPos, buildRec.fColorCount, buildRec.fTileMode));
...
{
    sk_sp<SkShader> s(
        SkGradientShader::MakeRadial(buildRec.fPoint[0], buildRec.fRadius[0], buildRec.fColors, buildRec.fPos, buildRec.fColorCount, buildRec.fTileMode));
...
{
    sk_sp<SkShader> s(SkGradientShader::MakeSweep(buildRec.fPoint[0].fX, buildRec.fPoint[0].fY, buildRec.fColors, buildRec.fPos, buildRec.fColorCount));
...
{
    sk_sp<SkShader> s(SkGradientShader::MakeTwoPointConical(buildRec.fPoint[0], buildRec.fRadius[0], buildRec.fPoint[1], buildRec.fRadius[1], buildRec.fColors,
        buildRec.fPos, buildRec.fColorCount, buildRec.fTileMode));
...
static void linear_gradproc_matrix(skiatest::Reporter* reporter, const GradRec& buildRec, const GradRec& checkRec)
{
    ...
    s = SkGradientShader::MakeLinear(buildRec.fPoint, buildRec.fColors, buildRec.fPos, buildRec.fColorCount, buildRec.fTileMode);
...
static void test_two_point_conical_zero_radius(skiatest::Reporter* reporter)
{
    ...
    p.setShader(SkGradientShader::MakeTwoPointConical(
        SkPoint::Make(2.5f, 2.5f), 0, SkPoint::Make(3.0f, 3.0f), 10, colors, nullptr, std::size(colors), SkTileMode::kClamp));
...
static void test_degenerate_linear(skiatest::Reporter*)
{
    SkPaint p;
    const SkColor colors[] = { SK_ColorRED, SK_ColorGREEN };
    const SkPoint pts[] = { SkPoint::Make(-46058024627067344430605278824628224.0f, 0), SkPoint::Make(SK_ScalarMax, 0) };
...
static void test_unsorted_degenerate(skiatest::Reporter* r)
{
    ...
    const SkColor4f colors[] = { { 0.f, 0.f, 0.f, 0.f }, { 0.00784314f, 0.f, 0.f, 0.0627451f }, { 0.f, 0.00392157f, 0.f, 0.f } };
    ...
    sk_sp<SkShader> gradient = SkGradientShader::MakeLinear(points, colors, nullptr, positions, 3, SkTileMode::kMirror);
...
static void test_linear_fuzzer(skiatest::Reporter*)
{
    ...
    static const SkScalar gMatrix0[9] = { 6.40969056e-10f, 0, 6.40969056e-10f, 0, 4.42539023e-39f, 6.40969056e-10f, 0, 0, 1 };
    static const SkScalar gMatrix1[9]
        = { -2.75294113f, 6.40969056e-10f, 6.40969056e-10f, 6.40969056e-10f, 6.40969056e-10f, -3.32810161e+24f, 6.40969056e-10f, 6.40969056e-10f, 0 };
    static const SkScalar gMatrix2[9] = { 7.93481258e+17f, 6.40969056e-10f, 6.40969056e-10f, 6.40969056e-10f, 6.40969056e-10f, 6.40969056e-10f, 6.40969056e-10f,
        6.40969056e-10f, 0.688235283f };
    static const SkScalar gMatrix3[9] = { 1.89180674e+11f, 6.40969056e-10f, 6.40969056e-10f, 6.40969056e-10f, 6.40969056e-10f, 6.40969056e-10f, 6.40969056e-10f,
        11276.0469f, 8.12524808e+20f };
    ...
    static const struct {
        ...
        { { { 0, -2.752941f }, { 0, 0 } }, gColors0, nullptr, std::size(gColors0), SkTileMode::kClamp, 0, gMatrix0, nullptr },
        { { { 4.42539023e-39f, -4.42539023e-39f }, { 9.78041162e-15f, 4.42539023e-39f } }, gColors1, gPos1, std::size(gColors1), SkTileMode::kClamp, 0, nullptr,
            gMatrix1 },
        { { { 4.42539023e-39f, 6.40969056e-10f }, { 6.40969056e-10f, 1.49237238e-19f } }, gColors1, gPos1, std::size(gColors1), SkTileMode::kClamp, 0, nullptr,
            gMatrix2 },
        { { { 6.40969056e-10f, 6.40969056e-10f }, { 6.40969056e-10f, -0.688235283f } }, gColors0, nullptr, std::size(gColors0), SkTileMode::kClamp, 0, gMatrix3,
            nullptr },
    };
    ...
    for (const SkColorSpace* colorSpace : colorSpaces) {
        ...
        sk_sp<SkSurface> surface = SkSurface::MakeRaster(SkImageInfo::Make(100, 100, kN32_SkColorType, kPremul_SkAlphaType, sk_ref_sp(colorSpace)));
        ...
        for (const auto& config : gConfigs) {
            ...
            paint.setShader(SkGradientShader::MakeLinear(
                config.fPts, config.fColors, config.fPos, config.fCount, config.fTileMode, config.fFlags, localMatrix.getMaybeNull()));
...
static void test_sweep_fuzzer(skiatest::Reporter*)
{
    ...
    static const SkScalar gMatrix0[9]
        = { 1.12116716e-13f, 0, 8.50489682e+16f, 4.1917041e-41f, 3.51369881e-23f, -2.54344271e-26f, 9.61111907e+17f, -3.35263808e-29f, -1.35659403e+14f };
    static const struct {
        SkPoint fCenter;
        const SkColor* fColors;
        const SkScalar* fPos;
        ...
        { { 0, 0 }, gColors0, gPos0, std::size(gColors0), gMatrix0 },
    };
    ...
    for (const auto& config : gConfigs) {
        paint.setShader(SkGradientShader::MakeSweep(config.fCenter.x(), config.fCenter.y(), config.fColors, config.fPos, config.fCount));
