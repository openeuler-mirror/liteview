...
struct Test {
    ...
    {
        return Test(name, TestType::kCPU, CtsEnforcement::kNever, proc, nullptr, nullptr, nullptr);
    }

    static Test MakeGanesh(const char* name, CtsEnforcement ctsEnforcement, GaneshTestProc proc, ContextOptionsProc optionsProc = nullptr)
    {
        return Test(name, TestType::kGanesh, ctsEnforcement, nullptr, proc, nullptr, optionsProc);
    }

    static Test MakeGraphite(const char* name, CtsEnforcement ctsEnforcement, GraphiteTestProc proc)
    {
        return Test(name, TestType::kGraphite, ctsEnforcement, nullptr, nullptr, proc, nullptr);
    }
...
private:
    Test(const char* name, TestType testType, CtsEnforcement ctsEnforcement, CPUTestProc cpuProc, GaneshTestProc ganeshProc, GraphiteTestProc graphiteProc,
...
void RunWithGaneshTestContexts(GrContextTestFn* testFn, GrContextTypeFilterFn* filter, Reporter* reporter, const GrContextOptions& options);
...
#define DEF_GRAPHITE_TEST(name, reporter)                                                                                                                      \
    ...
    skiatest::TestRegistry name##TestRegistry(Test::MakeGraphite(#name, CtsEnforcement::kNever, test_graphite_##name));                                        \
    void test_##name(skiatest::Reporter* reporter)
...
#define DEF_GRAPHITE_TEST_FOR_CONTEXTS(name, reporter, graphite_context)                                                                                       \
    ...
    skiatest::TestRegistry name##TestRegistry(Test::MakeGraphite(#name, CtsEnforcement::kNever, test_graphite_contexts_##name));                               \
...
#define DEF_GANESH_TEST(name, reporter, options, ctsEnforcement)                                                                                               \
    ...
    skiatest::TestRegistry name##TestRegistry(Test::MakeGanesh(#name, ctsEnforcement, test_##name, nullptr));                                                  \
...
#define DEF_CONDITIONAL_GANESH_TEST_FOR_CONTEXTS(name, context_filter, reporter, context_info, options_filter, condition, ctsEnforcement)                      \
    ...
    skiatest::TestRegistry name##TestRegistry(Test::MakeGanesh(#name, ctsEnforcement, test_gpu_contexts_##name, options_filter), condition);                   \
...
#define DEF_CONDITIONAL_GANESH_TEST_FOR_ALL_CONTEXTS(name, reporter, context_info, condition, ctsEnforcement)                                                  \
    DEF_CONDITIONAL_GANESH_TEST_FOR_CONTEXTS(name, nullptr, reporter, context_info, nullptr, condition, ctsEnforcement)
...
#define DEF_CONDITIONAL_GANESH_TEST_FOR_RENDERING_CONTEXTS(name, reporter, context_info, condition, ctsEnforcement)                                            \
    DEF_CONDITIONAL_GANESH_TEST_FOR_CONTEXTS(                                                                                                                  \
        name, sk_gpu_test::GrContextFactory::IsRenderingContext, reporter, context_info, nullptr, condition, ctsEnforcement)

#define DEF_GANESH_TEST_FOR_CONTEXTS(name, context_filter, reporter, context_info, options_filter, ctsEnforcement)                                             \
    DEF_CONDITIONAL_GANESH_TEST_FOR_CONTEXTS(name, context_filter, reporter, context_info, options_filter, true, ctsEnforcement)
...
#define DEF_GANESH_TEST_FOR_RENDERING_CONTEXTS(name, reporter, context_info, ctsEnforcement)                                                                   \
    DEF_GANESH_TEST_FOR_CONTEXTS(name, sk_gpu_test::GrContextFactory::IsRenderingContext, reporter, context_info, nullptr, ctsEnforcement)
#define DEF_GANESH_TEST_FOR_ALL_GL_CONTEXTS(name, reporter, context_info, ctsEnforcement)                                                                      \
    DEF_GANESH_TEST_FOR_CONTEXTS(name, &skiatest::IsGLContextType, reporter, context_info, nullptr, ctsEnforcement)
#define DEF_GANESH_TEST_FOR_GL_RENDERING_CONTEXTS(name, reporter, context_info, ctsEnforcement)                                                                \
    DEF_GANESH_TEST_FOR_CONTEXTS(name, &skiatest::IsRenderingGLContextType, reporter, context_info, nullptr, ctsEnforcement)
#define DEF_GANESH_TEST_FOR_MOCK_CONTEXT(name, reporter, context_info)                                                                                         \
    DEF_GANESH_TEST_FOR_CONTEXTS(name, &skiatest::IsMockContextType, reporter, context_info, nullptr, CtsEnforcement::kNever)
#define DEF_GANESH_TEST_FOR_VULKAN_CONTEXT(name, reporter, context_info, ctsEnforcement)                                                                       \
    DEF_GANESH_TEST_FOR_CONTEXTS(name, &skiatest::IsVulkanContextType, reporter, context_info, nullptr, ctsEnforcement)
#define DEF_GANESH_TEST_FOR_METAL_CONTEXT(name, reporter, context_info)                                                                                        \
    DEF_GANESH_TEST_FOR_CONTEXTS(name, &skiatest::IsMetalContextType, reporter, context_info, nullptr, CtsEnforcement::kNever)
#define DEF_GANESH_TEST_FOR_D3D_CONTEXT(name, reporter, context_info)                                                                                          \
    DEF_GANESH_TEST_FOR_CONTEXTS(name, &skiatest::IsDirect3DContextType, reporter, context_info, nullptr, CtsEnforcement::kNever)
#define DEF_GANESH_TEST_FOR_DAWN_CONTEXT(name, reporter, context_info)                                                                                         \
    DEF_GANESH_TEST_FOR_CONTEXTS(name, &skiatest::IsDawnContextType, reporter, context_info, nullptr, CtsEnforcement::kNever)
