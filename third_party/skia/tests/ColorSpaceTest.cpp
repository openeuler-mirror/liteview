...
static inline void check_primaries(skiatest::Reporter* r, const SkColorSpacePrimaries& primaries, const skcms_Matrix3x3& reference)
{
    skcms_Matrix3x3 toXYZ;
...
DEF_TEST(ColorSpace_Primaries, r)
{
    ...
    bool result = skcms_PrimariesToXYZD50(0.64f, 0.33f, 0.30f, 0.60f, 0.15f, 0.06f, 0.3127f, 0.3290f, &srgbToXYZ);
    REPORTER_ASSERT(r, result);
    ...
    ntsc.fWX = 0.31006f;
    ntsc.fWY = 0.31616f;
    skcms_Matrix3x3 ntscToXYZ = { { { 0.6343706f, 0.1852204f, 0.1446290f }, { 0.3109496f, 0.5915984f, 0.0974520f }, { -0.0011817f, 0.0555518f, 0.7708399f } } };
