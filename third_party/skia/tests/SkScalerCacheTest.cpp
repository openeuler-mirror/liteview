...
DEF_TEST(SkScalerCacheMultiThread, Reporter)
{
    ...
    SkStrikeSpec strikeSpec
        = SkStrikeSpec::MakeMask(font, defaultPaint, SkSurfaceProps(0, kUnknown_SkPixelGeometry), SkScalerContextFlags::kNone, SkMatrix::I());
    ...
    for (int tries = 0; tries < 100; tries++) {
        ...
        auto perThread = [&](int threadIndex) {
            ...
            for (int i = 0; i < 100; i++) {
                ...
                accepted.startDevicePositioning(rejected.source(), SkMatrix::I(), scalerCache.roundingSpec());
