...
static bool check_read(skiatest::Reporter* reporter, const SkBitmap& expectedBitmap, const SkBitmap& actualBitmap)
{
    bool result = true;
...
static void basic_draw_test_helper(skiatest::Reporter* reporter, const sk_gpu_test::ContextInfo& info, GrSurfaceOrigin surfaceOrigin)
{
    ...
    sk_sp<SkImage> image = SkImage::MakeFromAHardwareBuffer(buffer, kPremul_SkAlphaType, nullptr, surfaceOrigin);
    ...
    SkImageInfo imageInfo = SkImageInfo::Make(DEV_W, DEV_H, kRGBA_8888_SkColorType, kPremul_SkAlphaType);
...
// surface.
DEF_GANESH_TEST_FOR_RENDERING_CONTEXTS(GrAHardwareBuffer_BasicDrawTest, reporter, context_info, CtsEnforcement::kApiLevel_T)
{
...
static void surface_draw_test_helper(skiatest::Reporter* reporter, const sk_gpu_test::ContextInfo& info, GrSurfaceOrigin surfaceOrigin)
{
    ...
    sk_sp<SkSurface> surface = SkSurface::MakeFromAHardwareBuffer(context, buffer, surfaceOrigin, nullptr, nullptr);
    if (!surface) {
...
DEF_GANESH_TEST_FOR_RENDERING_CONTEXTS(GrAHardwareBuffer_ImportAsSurface, reporter, context_info, CtsEnforcement::kApiLevel_T)
{
