...
DEF_GRAPHITE_TEST_FOR_CONTEXTS(RecorderDevicePtrTest, reporter, context)
{
    ...
    sk_sp<Device> device1 = Device::Make(recorder.get(), info, SkBudgeted::kYes, Mipmapped::kNo, SkSurfaceProps(),
    ...
    device1 = Device::Make(recorder.get(), info, SkBudgeted::kYes, Mipmapped::kNo, SkSurfaceProps(),
        /* addInitialClear= */ true);
    sk_sp<Device> device2 = Device::Make(recorder.get(), info, SkBudgeted::kYes, Mipmapped::kNo, SkSurfaceProps(),
        /* addInitialClear= */ true);
    sk_sp<Device> device3 = Device::Make(recorder.get(), info, SkBudgeted::kYes, Mipmapped::kNo, SkSurfaceProps(),
        /* addInitialClear= */ true);
    REPORTER_ASSERT(reporter, device1->recorder() == recorder.get());
