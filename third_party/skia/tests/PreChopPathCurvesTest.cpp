...
DEF_TEST(PreChopPathCurves, reporter)
{
    ...
    SkPath p = SkPath()
                   ...
                   .cubicTo(8.33583747124031f, 77.27177002747368f, 8.33583747124031f, 77.27177002747368f, 11.171727877046647f, -11.78621173228717f)
                   .conicTo(11.171727877046647f, -11.78621173228717f, 8.33583747124031f, 77.27177002747368f, 1e-6f)
                   .conicTo(8.33583747124031f, 77.27177002747368f, 11.171727877046647f, -11.78621173228717f, 1e6f);
