...
DEF_TEST(SkVMDebugTraceWrite, r)
{
    ...
    static constexpr char kExpected[] = R"({"version":"20220209","source":["\t// first line","// \"second line\"","//\\\\//\\)"
    ...
    REPORTER_ASSERT(r, actual == kExpected, "Expected:\n    %s\n\n  Actual:\n    %.*s\n", kExpected, (int)actual.size(), actual.data());
}

DEF_TEST(SkVMDebugTraceRead, r)
{
    const std::string_view kJSONTrace = R"({"version":"20220209","source":["\t// first line","// \"second line\"","//\\\\//\\)"
                                        R"(\\ third line"],"slots":[{"name":"SkVM_DebugTrace","columns":1,"rows":2,"index":3,)"
                                        R"("groupIdx":4,"kind":5,"line":6},{"name":"Unit_Test","columns":6,"rows":7,"index":8)"
                                        R"(,"kind":10,"line":11,"retval":12}],"functions":[{"name":"void testFunc();"}],"trac)"
                                        R"(e":[[2],[0,5],[1,10,15],[3,20]]})";
...
DEF_TEST(SkVMDebugTraceGetSlotComponentSuffix, r)
{
    ...
    SkSL::SkVMDebugTrace i;
    i.fSlotInfo = { { "s", 1, 1, 0, 0, SkSL::Type::NumberKind::kFloat, 0, -1 }, { "v", 4, 1, 0, 0, SkSL::Type::NumberKind::kFloat, 0, -1 },
        { "v", 4, 1, 1, 1, SkSL::Type::NumberKind::kFloat, 0, -1 }, { "v", 4, 1, 2, 2, SkSL::Type::NumberKind::kFloat, 0, -1 },
        { "v", 4, 1, 3, 3, SkSL::Type::NumberKind::kFloat, 0, -1 }, { "m", 4, 4, 0, 0, SkSL::Type::NumberKind::kFloat, 0, -1 },
        { "m", 4, 4, 1, 1, SkSL::Type::NumberKind::kFloat, 0, -1 }, { "m", 4, 4, 2, 2, SkSL::Type::NumberKind::kFloat, 0, -1 },
        { "m", 4, 4, 3, 3, SkSL::Type::NumberKind::kFloat, 0, -1 }, { "m", 4, 4, 4, 4, SkSL::Type::NumberKind::kFloat, 0, -1 },
        { "m", 4, 4, 5, 5, SkSL::Type::NumberKind::kFloat, 0, -1 }, { "m", 4, 4, 6, 6, SkSL::Type::NumberKind::kFloat, 0, -1 },
        { "m", 4, 4, 7, 7, SkSL::Type::NumberKind::kFloat, 0, -1 }, { "m", 4, 4, 8, 8, SkSL::Type::NumberKind::kFloat, 0, -1 },
        { "m", 4, 4, 9, 9, SkSL::Type::NumberKind::kFloat, 0, -1 }, { "m", 4, 4, 10, 10, SkSL::Type::NumberKind::kFloat, 0, -1 },
        { "m", 4, 4, 11, 11, SkSL::Type::NumberKind::kFloat, 0, -1 }, { "m", 4, 4, 12, 12, SkSL::Type::NumberKind::kFloat, 0, -1 },
        { "m", 4, 4, 13, 13, SkSL::Type::NumberKind::kFloat, 0, -1 }, { "m", 4, 4, 14, 14, SkSL::Type::NumberKind::kFloat, 0, -1 },
        { "m", 4, 4, 15, 15, SkSL::Type::NumberKind::kFloat, 0, -1 } };

    const std::string kExpected[] = { "", ".x", ".y", ".z", ".w", "[0][0]", "[0][1]", "[0][2]", "[0][3]", "[1][0]", "[1][1]", "[1][2]", "[1][3]", "[2][0]",
