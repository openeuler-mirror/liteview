...
struct TestMessageRefCnt : public SkRefCnt {
    TestMessageRefCnt(int i, float f)
        : x(i)
        , y(f)
    {
    }
...
static inline bool SkShouldPostMessageToBus(const AddressedMessage& msg, GrDirectContext::DirectContextID msgBusUniqueID)
{
