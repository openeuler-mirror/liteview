...
{
    const size_t size = sizeof(SkDescriptor) + sizeof(SkDescriptor::Entry) + sizeof(SkScalerContextRec);
...
DEF_TEST(Descriptor_valid_more_tags, r)
{
    ...
    const size_t size = sizeof(SkDescriptor) + 3 * sizeof(SkDescriptor::Entry) + sizeof(SkScalerContextRec) + effectSize + testSize;
...
{
    const size_t size = sizeof(SkDescriptor) + sizeof(SkDescriptor::Entry) + sizeof(SkScalerContextRec) - 4;
