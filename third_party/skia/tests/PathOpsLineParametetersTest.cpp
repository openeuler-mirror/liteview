    ...
    for (size_t index = 0; index < tests_count; ++index) {
        ...
        for (inner = 0; inner < 2; ++inner) {
            ...
            SkDebugf("%s [%d,%d] denormalizedDistance:%g != answer:%g"
                ...
                __FUNCTION__, static_cast<int>(index), (int)inner, denormalizedDistance[inner], answers[index][inner], distSq, answersSq, normalSquared);
        }
        ...
        for (inner = 0; inner < 2; ++inner) {
            ...
            SkDebugf("%s [%d,%d] normalizedDistance:%1.9g != answer:%g\n", __FUNCTION__, static_cast<int>(index), (int)inner, normalizedDistance[inner],
                answers[index][inner]);
