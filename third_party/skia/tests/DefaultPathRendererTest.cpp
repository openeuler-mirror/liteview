...
static SkBitmap read_back(GrDirectContext* dContext, skgpu::v1::SurfaceDrawContext* sdc, int width, int height)
{
...
{
    SkPath invPath = make_path(SkRect::MakeXYWH(0, 0, kBigSize, kBigSize), kBigSize / 2 - 1, SkPathFillType::kInverseWinding);
    SkPath path = make_path(SkRect::MakeXYWH(0, 0, kBigSize, kBigSize), kPad, SkPathFillType::kWinding);

    GrStyle style(SkStrokeRec::kFill_InitStyle);

    {
        auto sdc = skgpu::v1::SurfaceDrawContext::Make(
            dContext, GrColorType::kRGBA_8888, nullptr, SkBackingFit::kApprox, { kBigSize / 2 + 1, kBigSize / 2 + 1 }, SkSurfaceProps(), /*label=*/ {});
    ...
    {
        auto sdc = skgpu::v1::SurfaceDrawContext::Make(
            dContext, GrColorType::kRGBA_8888, nullptr, SkBackingFit::kExact, { kBigSize, kBigSize }, SkSurfaceProps(), /*label=*/ {});
...
DEF_GANESH_TEST_FOR_CONTEXTS(
    DefaultPathRendererTest, sk_gpu_test::GrContextFactory::IsRenderingContext, reporter, ctxInfo, only_allow_default, CtsEnforcement::kApiLevel_T)
{
