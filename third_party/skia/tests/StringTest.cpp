...
DEF_TEST(String_fromUTF16, r)
{
    ...
    const uint16_t test1[] = { 0xD835, 0xDCD0, 0xD835, 0xDCD1, 0xD835, 0xDCD2, 0xD835, 0xDCD3, 0xD835, 0xDCD4, 0x0020, 0xD835, 0xDCD5, 0xD835, 0xDCD6, 0xD835,
        0xDCD7, 0xD835, 0xDCD8, 0xD835, 0xDCD9 };
...
static void test_va_list_print(skiatest::Reporter* r, const char format[], ...) SK_PRINTF_LIKE(2, 3);
...
static void test_va_list_append(skiatest::Reporter* r, const char format[], ...) SK_PRINTF_LIKE(2, 3);
...
static void test_va_list_prepend(skiatest::Reporter* r, const char format[], ...) SK_PRINTF_LIKE(2, 3);
...
static void test_va_list_overflow_print(skiatest::Reporter* r, const char format[], ...) SK_PRINTF_LIKE(2, 3);
...
static void test_va_list_overflow_append(skiatest::Reporter* r, const char format[], ...) SK_PRINTF_LIKE(2, 3);
...
static void test_va_list_overflow_prepend(skiatest::Reporter* r, const char format[], ...) SK_PRINTF_LIKE(2, 3);
