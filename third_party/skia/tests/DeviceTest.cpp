...
DEF_GANESH_TEST_FOR_RENDERING_CONTEXTS(SpecialImage_GPUDevice, reporter, ctxInfo, CtsEnforcement::kApiLevel_T)
{
    ...
    auto device = dContext->priv().createDevice(SkBudgeted::kNo, ii, SkBackingFit::kExact, 1, GrMipmapped::kNo, GrProtected::kNo, kBottomLeft_GrSurfaceOrigin,
        SkSurfaceProps(), skgpu::v1::Device::InitContents::kClear);
