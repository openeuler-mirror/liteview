...
{
    return SkScalarNearlyEqual(a.left(), b.left()) && SkScalarNearlyEqual(a.top(), b.top()) && SkScalarNearlyEqual(a.right(), b.right())
...
static void test_strokecubic(skiatest::Reporter* reporter)
{
    ...
    path.cubicTo(SkBits2Float(hexCubicVals[2]), SkBits2Float(hexCubicVals[3]), SkBits2Float(hexCubicVals[4]), SkBits2Float(hexCubicVals[5]),
