...
static struct oneLineQuad {
    ...
    { { { { 447.96701049804687, 894.4381103515625 }, { 448.007080078125, 894.4239501953125 }, { 448.0140380859375, 894.4215087890625 } } },
    ...
    { { { { 973, 507 }, { 973, 508.24264526367187 }, { 972.12158203125, 509.12161254882812 } } }, { { { 930, 467 }, { 973, 510 } } } },
    ...
    for (size_t index = 0; index < lineQuadTests_count; ++index) {
        ...
        for (int pt = 0; pt < result; ++pt) {
            ...
            if (!t1.approximatelyEqual(lineQuadTests[index].expected[0])
                && (lineQuadTests[index].result == 1 || !t1.approximatelyEqual(lineQuadTests[index].expected[1]))) {
