...
DEF_TEST(BlurSigmaRange, reporter)
{
    ...
    SkPoint polyPts[] = {
        { 0.3f, 0.3f }, { 100.3f, 0.3f }, { 100.3f, 100.3f }, { 0.3f, 100.3f }, { 2.3f, 50.3f } // a little divet to throw off the rect special case
    };
    SkPath polyPath;
...
{
    const SkBlurStyle styles[] = { kNormal_SkBlurStyle, kSolid_SkBlurStyle, kOuter_SkBlurStyle, kInner_SkBlurStyle };
...
DEF_TEST(BlurredRRectNinePatchComputation, reporter)
{
    ...
    SkRRect rrectToDraw;
    SkISize size;
    SkScalar rectXs[SkGpuBlurUtils::kBlurRRectMaxDivisions], rectYs[SkGpuBlurUtils::kBlurRRectMaxDivisions];
    SkScalar texXs[SkGpuBlurUtils::kBlurRRectMaxDivisions], texYs[SkGpuBlurUtils::kBlurRRectMaxDivisions];
    ...
    // not nine-patchable
    {
        ...
        ninePatchable = SkGpuBlurUtils::ComputeBlurredRRectParams(rr, rr, kBlurRad, kBlurRad, &rrectToDraw, &size, rectXs, rectYs, texXs, texYs);
