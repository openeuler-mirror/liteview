...
{
    SkPath path;
    const SkPoint pts[] = { { 0, 0 }, { 100000000000.0f, 100000000000.0f }, { 0, 0 }, { 10, 10 }, { 10, 10 }, { 0, 0 }, { 10, 10 } };
...
DEF_TEST(PathMeasure, reporter)
{
    ...
    path.cubicTo(SK_Scalar1 * 2, SK_Scalar1 * 2, SK_Scalar1 * 3, SK_Scalar1 * 2, SK_Scalar1 * 4, SK_Scalar1 * 2);
    meas.setPath(&path, false);
    length = meas.getLength();
...
static void test_90_degrees(sk_sp<SkContourMeasure> cm, SkScalar radius, skiatest::Reporter* reporter)
{
    SkPoint pos;
    SkVector tan;
