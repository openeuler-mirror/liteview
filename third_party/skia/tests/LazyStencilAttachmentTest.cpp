...
DEF_GANESH_TEST_FOR_RENDERING_CONTEXTS(crbug_1271431, reporter, context_info, CtsEnforcement::kApiLevel_T)
{
    ...
    SkImageInfo ii = SkImageInfo::Make({ 100, 100 }, kRGBA_8888_SkColorType, kPremul_SkAlphaType, nullptr);
    sk_sp<SkSurface> surfs[2] { SkSurface::MakeRenderTarget(dc, SkBudgeted::kYes, ii, 1, nullptr),
