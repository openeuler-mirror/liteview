...
public:
    ...
    static sk_sp<SkFlattenable> CreateProc(SkReadBuffer& buffer)
    {
        ...
        return sk_sp<CompoundDrawable>(new CompoundDrawable((IntDrawable*)intDrawable.get(), (PaintDrawable*)paintDrawable.get()));
    }
    ...
    {
        return fIntDrawable.get();
    }
    PaintDrawable* paintDrawable() const
    {
        return fPaintDrawable.get();
    }
...
public:
    ...
    static sk_sp<SkFlattenable> CreateProc(SkReadBuffer& buffer)
    {
        ...
        return sk_sp<RootDrawable>(new RootDrawable((CompoundDrawable*)compoundDrawable.get(), (IntDrawable*)intDrawable.get(), (SkDrawable*)drawable.get()));
    }
