...
protected:
    ...
    void dodraw(SkCanvas* canvas, sk_sp<SkPathEffect> pe, SkScalar x, SkScalar y, const SkPaint* ptr = nullptr)
    {
        SkPaint paint;
        paint.setAntiAlias(true);
