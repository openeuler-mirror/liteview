...
private:
    ...
    {
        return SkString("PathTessellators");
    }
...
Sample::Click* SamplePathTessellators::onFindClickHandler(SkScalar x, SkScalar y, skui::ModifierKey)
{
...
Sample* MakeTessellatedPathSample()
{
    return new SamplePathTessellators;
}
