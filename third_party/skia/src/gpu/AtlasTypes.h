...
class DrawToken {
public:
    static DrawToken AlreadyFlushedToken()
    {
        return DrawToken(0);
    }
    ...
    DrawToken next() const
    {
        return DrawToken(fSequenceNumber + 1);
    }
...
private:
    DrawToken() = delete;
    explicit DrawToken(uint64_t sequenceNumber)
...
public:
    ...
    DrawToken nextTokenToFlush() const
    {
...
public:
     ...
     */
    skgpu::DrawToken lastUploadToken() const
    {
        return fLastUpload;
    }
    skgpu::DrawToken lastUseToken() const
    {
        return fLastUse;
    }
    void setLastUploadToken(skgpu::DrawToken token)
    {
        fLastUpload = token;
    }
    void setLastUseToken(skgpu::DrawToken token)
    {
        fLastUse = token;
    }
