...
{
    return quadratic_p4(precision, skvx::bit_pun<skvx::float2>(pts[0]), skvx::bit_pun<skvx::float2>(pts[1]), skvx::bit_pun<skvx::float2>(pts[2]), vectorXform);
}
...
{
    return cubic_p4(precision, skvx::bit_pun<skvx::float2>(pts[0]), skvx::bit_pun<skvx::float2>(pts[1]), skvx::bit_pun<skvx::float2>(pts[2]),
        skvx::bit_pun<skvx::float2>(pts[3]), vectorXform);
}
...
{
    return conic_p2(precision, skvx::bit_pun<skvx::float2>(pts[0]), skvx::bit_pun<skvx::float2>(pts[1]), skvx::bit_pun<skvx::float2>(pts[2]), w, vectorXform);
}
