...
public:
    ...
    void addToKey(const SkKeyContext& keyContext, int desiredCombination, SkPaintParamsKeyBuilder* keyBuilder)
    {
...
private:
    ...
    const int fNumSlots;
    SkDEBUGCODE(int fEpoch = kInvalidEpoch;) Option* fNext = nullptr;
...
void Option::Slot::addToKey(const SkKeyContext& keyContext, int desiredCombination, SkPaintParamsKeyBuilder* keyBuilder)
{
    SkASSERT(desiredCombination < this->numCombinations());
...
int ArenaData_SolidColor::numIntrinsicCombinationsDerived() const
{
    return 1;
}
void ArenaData_SolidColor::beginBlock(const SkKeyContext& keyContext, int intrinsicCombination, SkPaintParamsKeyBuilder* builder) const
{
...
CREATE_ARENA_OBJECT(LinearGradient, /* numChildSlots */ 0, int fMinNumStops; int fMaxNumStops;)
int ArenaData_LinearGradient::numIntrinsicCombinationsDerived() const
{
    return fMaxNumStops - fMinNumStops + 1;
}
void ArenaData_LinearGradient::beginBlock(const SkKeyContext& keyContext, int intrinsicCombination, SkPaintParamsKeyBuilder* builder) const
{
    SkASSERT(intrinsicCombination < this->numIntrinsicCombinationsDerived());

    GradientShaderBlocks::BeginBlock(keyContext, builder, /*gatherer=*/nullptr, { SkShaderBase::GradientType::kLinear, fMinNumStops + intrinsicCombination });
}

CREATE_ARENA_OBJECT(RadialGradient, /* numChildSlots */ 0, int fMinNumStops; int fMaxNumStops;)
int ArenaData_RadialGradient::numIntrinsicCombinationsDerived() const
{
    return fMaxNumStops - fMinNumStops + 1;
}
void ArenaData_RadialGradient::beginBlock(const SkKeyContext& keyContext, int intrinsicCombination, SkPaintParamsKeyBuilder* builder) const
{
    SkASSERT(intrinsicCombination < this->numIntrinsicCombinationsDerived());

    GradientShaderBlocks::BeginBlock(keyContext, builder, /*gatherer=*/nullptr, { SkShaderBase::GradientType::kRadial, fMinNumStops + intrinsicCombination });
}

CREATE_ARENA_OBJECT(SweepGradient, /* numChildSlots */ 0, int fMinNumStops; int fMaxNumStops;)
int ArenaData_SweepGradient::numIntrinsicCombinationsDerived() const
{
    return fMaxNumStops - fMinNumStops + 1;
}
void ArenaData_SweepGradient::beginBlock(const SkKeyContext& keyContext, int intrinsicCombination, SkPaintParamsKeyBuilder* builder) const
{
    SkASSERT(intrinsicCombination < this->numIntrinsicCombinationsDerived());

    GradientShaderBlocks::BeginBlock(keyContext, builder, /*gatherer=*/nullptr, { SkShaderBase::GradientType::kSweep, fMinNumStops + intrinsicCombination });
}

CREATE_ARENA_OBJECT(ConicalGradient, /* numChildSlots */ 0, int fMinNumStops; int fMaxNumStops;)
int ArenaData_ConicalGradient::numIntrinsicCombinationsDerived() const
{
    return fMaxNumStops - fMinNumStops + 1;
}
void ArenaData_ConicalGradient::beginBlock(const SkKeyContext& keyContext, int intrinsicCombination, SkPaintParamsKeyBuilder* builder) const
{
    SkASSERT(intrinsicCombination < this->numIntrinsicCombinationsDerived());

    GradientShaderBlocks::BeginBlock(keyContext, builder, /*gatherer=*/nullptr, { SkShaderBase::GradientType::kConical, fMinNumStops + intrinsicCombination });
}

CREATE_ARENA_OBJECT(LocalMatrix, /* numChildSlots */ 1)
int ArenaData_LocalMatrix::numIntrinsicCombinationsDerived() const
{
    return 1;
}
void ArenaData_LocalMatrix::beginBlock(const SkKeyContext& keyContext, int intrinsicCombination, SkPaintParamsKeyBuilder* builder) const
{
    SkASSERT(intrinsicCombination == 0);

    LocalMatrixShaderBlock::BeginBlock(keyContext, builder, /*gatherer=*/nullptr, { SkMatrix::I() });
}
...
void ArenaData_Image::beginBlock(const SkKeyContext& keyContext, int intrinsicCombination, SkPaintParamsKeyBuilder* builder) const
{
    SkASSERT(intrinsicCombination < this->numIntrinsicCombinationsDerived());
...
int ArenaData_PorterDuffBlendShader::numIntrinsicCombinationsDerived() const
{
    return 1;
}
void ArenaData_PorterDuffBlendShader::beginBlock(const SkKeyContext& keyContext, int intrinsicCombination, SkPaintParamsKeyBuilder* builder) const
{
    SkASSERT(intrinsicCombination == 0);

    PorterDuffBlendShaderBlock::BeginBlock(keyContext, builder, /*gatherer=*/nullptr, {}); // the porter-duff constant is unused
}

CREATE_ARENA_OBJECT(BlendShader, /* numChildSlots */ 2)
int ArenaData_BlendShader::numIntrinsicCombinationsDerived() const
{
    return 1;
}
void ArenaData_BlendShader::beginBlock(const SkKeyContext& keyContext, int intrinsicCombination, SkPaintParamsKeyBuilder* builder) const
{
    SkASSERT(intrinsicCombination == 0);

    BlendShaderBlock::BeginBlock(keyContext, builder, /*gatherer=*/nullptr, { SkBlendMode::kSrc }); // the blend mode is unused
}
...
#define CASE(T)                                                                                                                                                \
    case ShaderType::k##T:                                                                                                                                     \
        numIntrinsicCombinations = static_cast<const ArenaData_##T*>(this)->numIntrinsicCombinationsDerived();                                                 \
        break;
...
// Here to access the derived ArenaData objects
void Option::beginBlock(const SkKeyContext& keyContext, int intrinsicCombination, SkPaintParamsKeyBuilder* builder) const
{
#define CASE(T)                                                                                                                                                \
    case ShaderType::k##T:                                                                                                                                     \
        static_cast<const ArenaData_##T*>(this)->beginBlock(keyContext, intrinsicCombination, builder);                                                        \
        break;
...
CombinationOption CombinationOption::addChildOption(int childIndex, ShaderType type, int minNumStops, int maxNumStops)
{
    if (!this->isValid() || childIndex >= this->numChildSlots()) {
        return CombinationOption(fBuilder, /*dataInArena=*/nullptr);
    }
...
CombinationOption CombinationOption::addChildOption(int childIndex, ShaderType type, SkSpan<TileModePair> tileModes)
{
    if (!this->isValid() || childIndex >= this->numChildSlots()) {
        return CombinationOption(fBuilder, /*dataInArena=*/nullptr);
    }
...
ShaderType CombinationOption::type() const
{
    return fDataInArena->type();
}
int CombinationOption::numChildSlots() const
{
    return fDataInArena->numSlots();
}
...
template <typename T, typename... Args> Option* CombinationBuilder::allocInArena(Args&&... args)
{
    Option* arenaObject = fArena->make<T>(T { { T::kType, T::kNumChildSlots }, std::forward<Args>(args)... });
    if (!arenaObject) {
        return nullptr;
    }
...
Option* CombinationBuilder::addOptionInternal(ShaderType shaderType, int minNumStops, int maxNumStops)
{
...
Option* CombinationBuilder::addOptionInternal(ShaderType shaderType, SkSpan<TileModePair> tileModes)
{
...
CombinationOption CombinationBuilder::addOption(ShaderType shaderType, int minNumStops, int maxNumStops)
{
...
CombinationOption CombinationBuilder::addOption(ShaderType shaderType, SkSpan<TileModePair> tileModes)
{
...
void CombinationBuilder::createKey(const SkKeyContext& keyContext, int desiredCombination, SkPaintParamsKeyBuilder* keyBuilder)
{
...
void CombinationBuilder::buildCombinations(SkShaderCodeDictionary* dict, const std::function<void(SkUniquePaintParamsID)>& func)
{
