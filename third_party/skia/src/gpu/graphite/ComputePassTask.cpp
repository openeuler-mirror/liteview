...
sk_sp<ComputePassTask> ComputePassTask::Make(std::vector<ResourceBinding> bindings, const ComputePipelineDesc& pipelineDesc, const ComputePassDesc& desc)
{
    return sk_sp<ComputePassTask>(new ComputePassTask(std::move(bindings), pipelineDesc, desc));
}

ComputePassTask::ComputePassTask(std::vector<ResourceBinding> bindings, const ComputePipelineDesc& pipelineDesc, const ComputePassDesc& desc)
...
bool ComputePassTask::prepareResources(ResourceProvider* provider, const SkRuntimeEffectDictionary*)
{
