...
using Writer = PatchWriter<DynamicInstancesPatchAllocator<FixedCountStrokes>, Required<PatchAttribs::kJoinControlPoint>, Required<PatchAttribs::kStrokeParams>,
    Required<PatchAttribs::kPaintDepth>, Required<PatchAttribs::kSsboIndex>, ReplicateLineEndPoints, TrackJoinControlPoints>;

} // namespace

TessellateStrokesRenderStep::TessellateStrokesRenderStep()
    : RenderStep("TessellateStrokeRenderStep", "", Flags::kRequiresMSAA | Flags::kPerformsShading,
...
void TessellateStrokesRenderStep::writeVertices(DrawWriter* dw, const DrawParams& params, int ssboIndex) const
{
...
void TessellateStrokesRenderStep::writeUniformsAndTextures(const DrawParams& params, SkPipelineDataGatherer* gatherer) const
{
