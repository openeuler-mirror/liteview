...
AnalyticRRectRenderStep::AnalyticRRectRenderStep()
    : RenderStep("AnalyticRRectRenderStep", "", Flags::kPerformsShading,
        /*uniforms=*/ {}, PrimitiveType::kTriangles, kDirectDepthGreaterPass,
        /*vertexAttrs=*/ {},
        /*instanceAttrs=*/
        { { "xRadiiOrFlags", VertexAttribType::kFloat4, SkSLType::kFloat4 }, { "radiiOrQuadXs", VertexAttribType::kFloat4, SkSLType::kFloat4 },
            ...
            { "depth", VertexAttribType::kFloat, SkSLType::kFloat }, { "ssboIndex", VertexAttribType::kInt, SkSLType::kInt },
            { "maxScale", VertexAttribType::kFloat, SkSLType::kFloat }, { "mat0", VertexAttribType::kFloat3, SkSLType::kFloat3 },
            { "mat0", VertexAttribType::kFloat3, SkSLType::kFloat3 }, { "mat0", VertexAttribType::kFloat3, SkSLType::kFloat3 } })
{
}
...
void AnalyticRRectRenderStep::writeVertices(DrawWriter* writer, const DrawParams& params, int ssboIndex) const
{
    ...
    if (params.isStroke()) {
        ...
        SkASSERT(shape.isRect() || (shape.isRRect() && SkRRectPriv::AllCornersCircular(shape.rrect())));
    ...
    vw << params.order().depthAsFloat() << ssboIndex << params.transform().maxScaleFactor() << m.rc(0, 0) << m.rc(1, 0) << m.rc(3, 0) << m.rc(0, 1)
       << m.rc(1, 1) << m.rc(3, 1) << m.rc(0, 3) << m.rc(1, 3) << m.rc(3, 3);
}

void AnalyticRRectRenderStep::writeUniformsAndTextures(const DrawParams&, SkPipelineDataGatherer*) const
{
