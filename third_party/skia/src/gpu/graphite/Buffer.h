...
protected:
    Buffer(const SharedContext* sharedContext, size_t size, BufferType type, PrioritizeGpuReads prioritizeGpuReads)
...
private:
    ...
    PrioritizeGpuReads prioritizeGpuReads() const
    {
        return fPrioritizeGpuReads;
    }
