...
public:
    ...
    std::pair<Clip, CompressedPaintersOrder> applyClipToDraw(const BoundsManager*, const Transform&, const Geometry&, const SkStrokeRec&, PaintersDepth z);
...
private:
    ...
    public:
        ...
        RawElement(const Rect& deviceBounds, const Transform& localToDevice, const Shape& shape, SkClipOp op);
        ...
        std::pair<bool, CompressedPaintersOrder> updateForDraw(const BoundsManager* boundsManager, const TransformedShape& draw, PaintersDepth drawZ);
