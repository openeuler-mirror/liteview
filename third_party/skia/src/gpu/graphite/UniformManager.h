...
protected:
    ...
    using WriteUniformFn = uint32_t (*)(SkSLType type, CType ctype, void* dest, int n, const void* src);
...
public:
    UniformManager(Layout layout)
        : UniformOffsetCalculator(layout, /*startingOffset=*/0)
    {
    }
    ...
    void write(const SkPMColor4f& color)
    {
        this->write(&color, 1);
    }
