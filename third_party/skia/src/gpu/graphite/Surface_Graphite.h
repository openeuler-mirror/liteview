...
public:
    static sk_sp<SkSurface> MakeGraphite(
        Recorder* recorder, const SkImageInfo& info, SkBudgeted budgeted, Mipmapped = Mipmapped::kNo, const SkSurfaceProps* props = nullptr);
    ...
    GrSemaphoresSubmitted onFlush(BackendSurfaceAccess access, const GrFlushInfo&, const skgpu::MutableTextureState*) override;
#endif
