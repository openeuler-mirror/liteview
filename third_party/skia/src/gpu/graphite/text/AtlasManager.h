...
public:
    ...
    void addGlyphToBulkAndSetUseToken(BulkUsePlotUpdater*, MaskFormat, sktext::gpu::Glyph*, DrawToken);

    void setUseTokenBulk(const BulkUsePlotUpdater& updater, DrawToken token, MaskFormat format)
    {
