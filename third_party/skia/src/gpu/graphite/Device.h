...
public:
    ...
    static sk_sp<Device> Make(Recorder*, const SkImageInfo&, SkBudgeted, Mipmapped, const SkSurfaceProps&, bool addInitialClear);
    static sk_sp<Device> Make(Recorder*, sk_sp<TextureProxy>, const SkColorInfo&, const SkSurfaceProps&, bool addInitialClear);
    ...
    void asyncReadPixels(const SkImageInfo& info, SkIRect srcRect, SkImage::ReadPixelsCallback callback, SkImage::ReadPixelsContext context);

    void asyncRescaleAndReadPixels(const SkImageInfo& info, SkIRect srcRect, SkImage::RescaleGamma rescaleGamma, SkImage::RescaleMode rescaleMode,
        SkImage::ReadPixelsCallback callback, SkImage::ReadPixelsContext context);

    void asyncRescaleAndReadPixelsYUV420(SkYUVColorSpace yuvColorSpace, sk_sp<SkColorSpace> dstColorSpace, SkIRect srcRect, SkISize dstSize,
        SkImage::RescaleGamma rescaleGamma, SkImage::RescaleMode, SkImage::ReadPixelsCallback callback, SkImage::ReadPixelsContext context);
...
private:
    ...
    void onDrawGlyphRunList(SkCanvas*, const sktext::GlyphRunList&, const SkPaint&, const SkPaint&) override;
    ...
    void drawAtlasSubRun(const sktext::gpu::AtlasSubRun*, SkPoint drawOrigin, const SkPaint& paint, sk_sp<SkRefCnt> subRunStorage);
    ...
    const Renderer* chooseRenderer(const Geometry&, const Clip&, const SkStrokeRec&, bool requireMSAA) const;
