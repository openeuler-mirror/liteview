...
public:
    ...
    static sk_sp<Texture> Make(const MtlSharedContext*, SkISize dimensions, const TextureInfo&, SkBudgeted);
...
private:
    MtlTexture(const MtlSharedContext* sharedContext, SkISize dimensions, const TextureInfo& info, sk_cfp<id<MTLTexture>>, Ownership, SkBudgeted);
