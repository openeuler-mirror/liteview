...
#ifdef SK_ENABLE_PIET_GPU
    void setPietRenderer(const skgpu::piet::MtlRenderer* renderer)
    {
        fPietRenderer = renderer;
    }
#endif
...
private:
    ...
    void bindDrawBuffers(const BindBufferInfo& vertices, const BindBufferInfo& instances, const BindBufferInfo& indices);
