...
public:
    ...
    virtual std::string texturesAndSamplersSkSL(int startBinding) const
    {
        return R"()";
    }
    ...
    {
        return fFlags & Flags::kRequiresMSAA;
    }
    bool performsShading() const
    {
        return fFlags & Flags::kPerformsShading;
    }
    bool hasTextures() const
    {
        return fFlags & Flags::kHasTextures;
    }
    bool emitsCoverage() const
    {
        return fFlags & Flags::kEmitsCoverage;
    }
    bool emitsPrimitiveColor() const
    {
        return fFlags & Flags::kEmitsPrimitiveColor;
    }
    ...
    SkSpan<const SkUniform> uniforms() const
    {
...
protected:
    ...
    RenderStep(std::string_view className, std::string_view variantName, SkEnumBitMask<Flags> flags, std::initializer_list<SkUniform> uniforms,
...
public:
    ...
    bool requiresMSAA() const
    {
        return fStepFlags & StepFlags::kRequiresMSAA;
    }
    bool emitsCoverage() const
    {
        return fStepFlags & StepFlags::kEmitsCoverage;
    }
    bool emitsPrimitiveColor() const
    {
        return fStepFlags & StepFlags::kEmitsPrimitiveColor;
    }
...
private:
    ...
    Renderer(std::string_view name, const RenderStep* s1, const RenderStep* s2, const RenderStep* s3)
        : Renderer(name, std::array<const RenderStep*, 3> { s1, s2, s3 })
    {
    }

    Renderer(std::string_view name, const RenderStep* s1, const RenderStep* s2, const RenderStep* s3, const RenderStep* s4)
