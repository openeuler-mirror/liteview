...
public:
    static sk_sp<ComputePassTask> Make(std::vector<ResourceBinding> bindings, const ComputePipelineDesc&, const ComputePassDesc&);
...
private:
    ComputePassTask(std::vector<ResourceBinding> bindings, const ComputePipelineDesc&, const ComputePassDesc&);
