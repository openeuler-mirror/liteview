...
public:
    ...
    {
        return Mipmapped(fInfo.numMipLevels() > 1);
    }
    ...
    static sk_sp<TextureProxy> Make(const Caps*, SkISize dimensions, SkColorType, Mipmapped, Protected, Renderable, SkBudgeted);
