...
public:
    ...
    virtual TextureInfo getDefaultSampledTextureInfo(SkColorType, uint32_t levelCount, Protected, Renderable) const = 0;
     ...
     */
    virtual SkColorType supportedWritePixelsColorType(SkColorType dstColorType, const TextureInfo& dstTextureInfo, SkColorType srcColorType) const = 0;
     ...
     */
    virtual SkColorType supportedReadPixelsColorType(SkColorType srcColorType, const TextureInfo& srcTextureInfo, SkColorType dstColorType) const = 0;
    ...
    {
        return fStorageBufferPreferred;
    }
    ...
    bool allowMultipleGlyphCacheTextures() const
    {
        return fAllowMultipleGlyphCacheTextures;
    }
...
protected:
    ...
    uint32_t defaultMSAASamples() const
    {
        return 4;
    }
