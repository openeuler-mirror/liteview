...
public:
    PaintParams(
        const SkColor4f& color, sk_sp<SkBlender> finalBlender, sk_sp<SkShader>, sk_sp<SkColorFilter>, sk_sp<SkBlender> primitiveBlender, bool skipColorXform);
    explicit PaintParams(const SkPaint&, sk_sp<SkBlender> primitiveBlender = nullptr, bool skipColorXform = false);
