...
public:
    static sk_sp<GrGpu> Make(const GrD3DBackendContext& backendContext, const GrContextOptions&, GrDirectContext*);
...
private:
    ...
    sk_sp<GrD3DTexture> createD3DTexture(
        SkISize, DXGI_FORMAT, GrRenderable, int renderTargetSampleCnt, SkBudgeted, GrProtected, int mipLevelCount, GrMipmapStatus, std::string_view label);
