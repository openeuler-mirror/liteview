...
GrSurfaceProxyView GrAHardwareBufferImageGenerator::makeView(GrRecordingContext* context)
{
    ...
    sk_sp<GrTextureProxy> texProxy = proxyProvider->createLazyProxy(
        ...
        backendFormat, { width, height }, GrMipmapped::kNo, GrMipmapStatus::kNotAllocated, GrInternalSurfaceFlags::kReadOnly, SkBackingFit::kExact,
        SkBudgeted::kNo, GrProtected(fIsProtectedContent), GrSurfaceProxy::UseAllocator::kYes, "AHardwareBufferImageGenerator_MakeView");
...
GrSurfaceProxyView GrAHardwareBufferImageGenerator::onGenerateTexture(
    GrRecordingContext* context, const SkImageInfo& info, GrMipmapped mipmapped, GrImageTexGenPolicy texGenPolicy)
{
