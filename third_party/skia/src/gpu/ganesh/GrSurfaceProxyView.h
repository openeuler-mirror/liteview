...
public:
    ...
    static GrSurfaceProxyView Copy(GrRecordingContext* context, GrSurfaceProxyView src, GrMipmapped mipmapped, SkIRect srcRect, SkBackingFit fit,
    ...
    static GrSurfaceProxyView Copy(
        GrRecordingContext* rContext, GrSurfaceProxyView src, GrMipmapped mipmapped, SkBackingFit fit, SkBudgeted budgeted, std::string_view label)
    {
