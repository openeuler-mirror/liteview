...
public:
    ...
    // to aniso.
    static constexpr GrSamplerState Aniso(WrapMode wrapX, WrapMode wrapY, int maxAniso, GrMipmapped viewIsMipped)
    {
        ...
        sampler.fMipmapMode = viewIsMipped == GrMipmapped::kYes ? MipmapMode::kLinear : MipmapMode::kNone;
        return sampler;
    }
