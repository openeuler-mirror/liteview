...
private:
    ...
    id<MTLLibrary> compileMtlShaderLibrary(const std::string& shader, SkSL::Program::Inputs inputs, GrContextOptions::ShaderErrorHandler* errorHandler);
    void storeShadersInCache(const std::string shaders[], const SkSL::Program::Inputs inputs[], SkSL::ProgramSettings*, sk_sp<SkData>, bool isSkSL);
