...
public:
    static sk_sp<GrMtlTextureRenderTarget> MakeNewTextureRenderTarget(
        GrMtlGpu*, SkBudgeted, SkISize, int sampleCnt, MTLPixelFormat, uint32_t mipLevels, GrMipmapStatus, std::string_view label);
...
private:
    GrMtlTextureRenderTarget(GrMtlGpu* gpu, SkBudgeted budgeted, SkISize, sk_sp<GrMtlAttachment> texture, sk_sp<GrMtlAttachment> colorAttachment,
