...
private:
    GrMtlGpu(GrDirectContext*, const GrContextOptions&, id<MTLDevice>, id<MTLCommandQueue>, GrMTLHandle binaryArchive);
    ...
    bool createMtlTextureForBackendSurface(MTLPixelFormat, SkISize dimensions, int sampleCnt, GrTexturable, GrRenderable, GrMipmapped, GrMtlTextureInfo*);
