    ...
    OutputType PrimaryOut, OutputType SecondaryOut, skgpu::BlendEquation BlendEquation, skgpu::BlendCoeff SrcCoeff, skgpu::BlendCoeff DstCoeff)
{
    return
        ...
        SkASSERT(PrimaryOut != SecondaryOut || kNone_OutputType == PrimaryOut), SkASSERT(kNone_OutputType != PrimaryOut || kNone_OutputType == SecondaryOut),
 ...
 * Porter Duff formula.
 */
static constexpr BlendFormula MakeCoeffFormula(skgpu::BlendCoeff srcCoeff, skgpu::BlendCoeff dstCoeff)
{
 ...
 * LCD dst-out.
 */
static constexpr BlendFormula MakeSAModulateFormula(skgpu::BlendCoeff srcCoeff, skgpu::BlendCoeff dstCoeff)
{
 ...
 */
static constexpr BlendFormula MakeCoverageFormula(BlendFormula::OutputType oneMinusDstCoeffModulateOutput, skgpu::BlendCoeff srcCoeff)
{
 ...
 */
static constexpr BlendFormula MakeCoverageSrcCoeffZeroFormula(BlendFormula::OutputType oneMinusDstCoeffModulateOutput)
{
    ...
    const GrProcessorAnalysisColor& color, GrProcessorAnalysisCoverage coverage, const GrCaps& caps, GrClampType clampType) const
{
    ...
    BlendFormula blendFormula = [&]() {
        ...
        return get_blend_formula(color.isOpaque(), GrProcessorAnalysisCoverage::kNone != coverage, fBlendMode);
    }();
...
{
    static BlendFormula gSrcOverBlendFormula = MakeCoeffFormula(skgpu::BlendCoeff::kOne, skgpu::BlendCoeff::kISA);
    static PorterDuffXferProcessor gSrcOverXP(gSrcOverBlendFormula, GrProcessorAnalysisCoverage::kSingleChannel);
    return gSrcOverXP;
}
