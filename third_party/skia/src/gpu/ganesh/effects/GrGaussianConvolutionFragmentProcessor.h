...
public:
     ...
     */
    static std::unique_ptr<GrFragmentProcessor> Make(GrSurfaceProxyView, SkAlphaType, Direction, int halfWidth, float gaussianSigma, GrSamplerState::WrapMode,
        const SkIRect& subset, const SkIRect* pixelDomain, const GrCaps&);
...
private:
    ...
    GrGaussianConvolutionFragmentProcessor(std::unique_ptr<GrFragmentProcessor>, Direction, int halfWidth, float gaussianSigma);
