...
size_t GrComputeTightCombinedBufferSize(size_t bytesPerPixel, SkISize baseDimensions, SkTArray<size_t>* individualMipOffsets, int mipLevelCount)
{
...
void GrFillInCompressedData(SkImage::CompressionType type, SkISize dimensions, GrMipmapped mipmapped, char* dstPixels, const SkColor4f& colorf)
{
    ...
    for (int i = 0; i < numMipLevels; ++i) {
        ...
        if (SkImage::CompressionType::kETC2_RGB8_UNORM == type) {
            ...
            SkASSERT(type == SkImage::CompressionType::kBC1_RGB8_UNORM || type == SkImage::CompressionType::kBC1_RGBA8_UNORM);
...
static skgpu::Swizzle get_load_and_src_swizzle(GrColorType ct, SkRasterPipeline::StockStage* load, bool* isNormalized, bool* isSRGB)
{
    ...
    *isSRGB = false;
    ...
    case GrColorType::kBGR_565:
        *load = SkRasterPipeline::load_565;
        break;
    ...
    case GrColorType::kAlpha_F16:
        *load = SkRasterPipeline::load_af16;
        break;
    case GrColorType::kRGBA_F16_Clamped:
        *load = SkRasterPipeline::load_f16;
        break;
    case GrColorType::kRG_1616:
        *load = SkRasterPipeline::load_rg1616;
        break;
    case GrColorType::kRGBA_16161616:
        *load = SkRasterPipeline::load_16161616;
        break;
...
static skgpu::Swizzle get_dst_swizzle_and_store(GrColorType ct, SkRasterPipeline::StockStage* store, LumMode* lumMode, bool* isNormalized, bool* isSRGB)
{
    skgpu::Swizzle swizzle("rgba");
    *isNormalized = true;
    *isSRGB = false;
    *lumMode = LumMode::kNone;
    ...
    case GrColorType::kAlpha_16:
        *store = SkRasterPipeline::store_a16;
        break;
    case GrColorType::kBGR_565:
        *store = SkRasterPipeline::store_565;
        break;
    case GrColorType::kABGR_4444:
    ...
    case GrColorType::kRGBA_F16_Clamped:
        *store = SkRasterPipeline::store_f16;
        break;
    case GrColorType::kRG_1616:
        *store = SkRasterPipeline::store_rg1616;
        break;
    case GrColorType::kRGBA_16161616:
        *store = SkRasterPipeline::store_16161616;
        break;
