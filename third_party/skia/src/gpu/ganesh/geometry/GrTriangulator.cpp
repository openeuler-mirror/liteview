...
static void rewind_if_necessary(Edge* edge, EdgeList* activeEdges, Vertex** current, const Comparator& c)
{
...
void GrTriangulator::setTop(Edge* edge, Vertex* v, EdgeList* activeEdges, Vertex** current, const Comparator& c) const
{
...
void GrTriangulator::setBottom(Edge* edge, Vertex* v, EdgeList* activeEdges, Vertex** current, const Comparator& c) const
{
...
void GrTriangulator::mergeEdgesAbove(Edge* edge, Edge* other, EdgeList* activeEdges, Vertex** current, const Comparator& c) const
{
...
void GrTriangulator::mergeEdgesBelow(Edge* edge, Edge* other, EdgeList* activeEdges, Vertex** current, const Comparator& c) const
{
...
void GrTriangulator::mergeCollinearEdges(Edge* edge, EdgeList* activeEdges, Vertex** current, const Comparator& c) const
{
    for (;;) {
...
bool GrTriangulator::splitEdge(Edge* edge, Vertex* v, EdgeList* activeEdges, Vertex** current, const Comparator& c)
{
...
bool GrTriangulator::intersectEdgePair(Edge* left, Edge* right, EdgeList* activeEdges, Vertex** current, const Comparator& c)
{
...
bool GrTriangulator::checkForIntersection(Edge* left, Edge* right, EdgeList* activeEdges, Vertex** current, VertexList* mesh, const Comparator& c)
{
    if (!left || !right) {
        return false;
    }
    ...
    for (Vertex* v = mesh->fHead; v != nullptr; v = v->fNext) {
        ...
        do {
            ...
            if (v->fFirstEdgeBelow) {
                ...
                if (this->checkForIntersection(leftEnclosingEdge, rightEnclosingEdge, &activeEdges, &v, mesh, c)) {
                    result = SimplifyResult::kFoundSelfIntersection;
                    restartChecks = true;
                }
            }
