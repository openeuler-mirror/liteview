...
GrStyledShape GrStyledShape::MakeArc(
    const SkRect& oval, SkScalar startAngleDegrees, SkScalar sweepAngleDegrees, bool useCenter, const GrStyle& style, DoSimplify doSimplify)
{
    GrStyledShape result;
...
bool GrStyledShape::asRRect(SkRRect* rrect, SkPathDirection* dir, unsigned* start, bool* inverted) const
{
    ...
    SkASSERT(fStyle.hasPathEffect() || (fShape.dir() == GrShape::kDefaultDir && fShape.startIndex() == GrShape::kDefaultStart));
