...
{
    return SkDashPath::InternalFilter(dst, src, rec, cullRect, fIntervals.get(), fCount, fInitialDashLength, fInitialDashIndex, fIntervalLength);
}
...
TestAsFPArgs::TestAsFPArgs(GrProcessorTestData* d)
    ...
    , fArgs(d->context(), fMatrixProvider, fColorInfoStorage.get(), fSurfaceProps)
{
}
