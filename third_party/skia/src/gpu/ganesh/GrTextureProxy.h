...
public:
    ...
    bool slatedForMipmapRegen()
    {
        return fSlatedForMipmapRegen;
    }
    void needsMipmapRegen()
    {
        fSlatedForMipmapRegen = true;
    }
    void mipmapsRegenerated()
    {
        fSlatedForMipmapRegen = false;
    }
#endif
    ...
    GrTextureProxy(const GrBackendFormat&, SkISize, GrMipmapped, GrMipmapStatus, SkBackingFit, SkBudgeted, GrProtected, GrInternalSurfaceFlags, UseAllocator,
    ...
    GrTextureProxy(LazyInstantiateCallback&&, const GrBackendFormat&, SkISize, GrMipmapped, GrMipmapStatus, SkBackingFit, SkBudgeted, GrProtected,
        GrInternalSurfaceFlags, UseAllocator, GrDDLProvider creatingProvider, std::string_view label);
