...
void GrResourceCache::purgeUnlockedResources(const GrStdSteadyClock::time_point* purgeTime, bool scratchResourcesOnly)
{
    ...
    if (!scratchResourcesOnly) {
        ...
        while (fPurgeableQueue.count()) {
            ...
            const GrStdSteadyClock::time_point resourceTime = resource->cacheAccess().timeWhenResourceBecamePurgeable();
...
void GrResourceCache::dumpStatsKeyValuePairs(SkTArray<SkString>* keys, SkTArray<double>* values) const
{
    this->validate();
