...
void GrRecordingContext::Stats::dumpKeyValuePairs(SkTArray<SkString>* keys, SkTArray<double>* values) const
{
...
void GrRecordingContext::DMSAAStats::dumpKeyValuePairs(SkTArray<SkString>* keys, SkTArray<double>* values) const
{
