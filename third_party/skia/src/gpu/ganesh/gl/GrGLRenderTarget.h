...
public:
    ...
    static sk_sp<GrGLRenderTarget> MakeWrapped(GrGLGpu*, const SkISize&, GrGLFormat, int sampleCount, const IDs&, int stencilBits, std::string_view label);
...
protected:
    ...
    GrGLRenderTarget(GrGLGpu*, const SkISize&, GrGLFormat, int sampleCount, const IDs&, std::string_view label);
...
private:
    ...
    GrGLRenderTarget(GrGLGpu*, const SkISize&, GrGLFormat, int sampleCount, const IDs&, sk_sp<GrGLAttachment> stencil, std::string_view label);
