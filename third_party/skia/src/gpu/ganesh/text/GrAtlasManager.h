...
public:
    ...
    void addGlyphToBulkAndSetUseToken(skgpu::BulkUsePlotUpdater*, skgpu::MaskFormat, sktext::gpu::Glyph*, skgpu::DrawToken);

    void setUseTokenBulk(const skgpu::BulkUsePlotUpdater& updater, skgpu::DrawToken token, skgpu::MaskFormat format)
    {
