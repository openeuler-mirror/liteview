...
GrTextureProxy::GrTextureProxy(const GrBackendFormat& format, SkISize dimensions, GrMipmapped mipmapped, GrMipmapStatus mipmapStatus, SkBackingFit fit,
    SkBudgeted budgeted, GrProtected isProtected, GrInternalSurfaceFlags surfaceFlags, UseAllocator useAllocator, GrDDLProvider creatingProvider,
...
GrTextureProxy::GrTextureProxy(LazyInstantiateCallback&& callback, const GrBackendFormat& format, SkISize dimensions, GrMipmapped mipmapped,
    GrMipmapStatus mipmapStatus, SkBackingFit fit, SkBudgeted budgeted, GrProtected isProtected, GrInternalSurfaceFlags surfaceFlags, UseAllocator useAllocator,
...
void GrTextureProxy::onValidateSurface(const GrSurface* surface)
{
    ...
    SkASSERT(GrMipmapped::kNo == this->proxyMipmapped() || GrMipmapped::kYes == surface->asTexture()->mipmapped());
