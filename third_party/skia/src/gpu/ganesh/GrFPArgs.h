...
struct GrFPArgs {
    GrFPArgs(GrRecordingContext* context, const SkMatrixProvider& matrixProvider, const GrColorInfo* dstColorInfo, const SkSurfaceProps& surfaceProps)
        : fContext(context)
...
public:
    ConcatLocalMatrix(const GrFPArgs& args, const SkMatrix& childLM)
        : INHERITED(args)
    {
