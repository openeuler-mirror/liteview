...
public:
     ...
     */
    GrSemaphoresSubmitted flushSurfaces(SkSpan<GrSurfaceProxy*>, SkSurface::BackendSurfaceAccess = SkSurface::BackendSurfaceAccess::kNoAccess,
    ...
    GrSemaphoresSubmitted flushSurface(GrSurfaceProxy* proxy, SkSurface::BackendSurfaceAccess access = SkSurface::BackendSurfaceAccess::kNoAccess,
