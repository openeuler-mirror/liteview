...
private:
    ...
    void storeShadersInCache(const std::string shaders[], const SkSL::Program::Inputs inputs[], bool isSkSL);
    ...
    bool createVkShaderModule(VkShaderStageFlagBits stage, const std::string& sksl, VkShaderModule* shaderModule, VkPipelineShaderStageCreateInfo* stageInfo,
        const SkSL::ProgramSettings& settings, std::string* outSPIRV, SkSL::Program::Inputs* outInputs);
