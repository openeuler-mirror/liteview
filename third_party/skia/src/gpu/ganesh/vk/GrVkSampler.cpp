...
GrVkSampler* GrVkSampler::Create(GrVkGpu* gpu, GrSamplerState samplerState, const GrVkYcbcrConversionInfo& ycbcrInfo)
{
    ...
    if (ycbcrInfo.isValid()) {
        ...
        } else if (!(flags & VK_FORMAT_FEATURE_SAMPLED_IMAGE_YCBCR_CONVERSION_SEPARATE_RECONSTRUCTION_FILTER_BIT)) {
...
GrVkSampler::Key GrVkSampler::GenerateKey(GrSamplerState samplerState, const GrVkYcbcrConversionInfo& ycbcrInfo)
{
