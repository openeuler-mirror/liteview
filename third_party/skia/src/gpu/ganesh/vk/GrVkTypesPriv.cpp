...
GrVkImageInfo GrVkBackendSurfaceInfo::snapImageInfo(const skgpu::MutableTextureStateRef* mutableState) const
{
...
GrVkSurfaceInfo GrVkImageSpecToSurfaceInfo(const GrVkImageSpec& vkSpec, uint32_t sampleCount, uint32_t levelCount, GrProtected isProtected)
{
