...
sk_sp<GrVkRenderTarget> GrVkRenderTarget::MakeWrappedRenderTarget(
    GrVkGpu* gpu, SkISize dimensions, int sampleCnt, const GrVkImageInfo& info, sk_sp<skgpu::MutableTextureStateRef> mutableState)
{
...
sk_sp<GrVkRenderTarget> GrVkRenderTarget::MakeSecondaryCBRenderTarget(GrVkGpu* gpu, SkISize dimensions, const GrVkDrawableInfo& vkInfo)
{
    ...
    sk_sp<skgpu::MutableTextureStateRef> mutableState(new skgpu::MutableTextureStateRef(VK_IMAGE_LAYOUT_COLOR_ATTACHMENT_OPTIMAL, VK_QUEUE_FAMILY_IGNORED));
...
GrBackendRenderTarget GrVkRenderTarget::getBackendRenderTarget() const
{
    ...
    return GrBackendRenderTarget(beAttachment->width(), beAttachment->height(), beAttachment->vkImageInfo(), beAttachment->getMutableState());
}
