...
public:
     ...
     */
    GrVkCaps(const GrContextOptions& contextOptions, const skgpu::VulkanInterface* vkInterface, VkPhysicalDevice device,
    ...
    bool mustUseCoherentHostVisibleMemory() const
    {
        return fMustUseCoherentHostVisibleMemory;
    }
...
private:
    ...
    void init(const GrContextOptions& contextOptions, const skgpu::VulkanInterface* vkInterface, VkPhysicalDevice device, const VkPhysicalDeviceFeatures2&,
        uint32_t physicalDeviceVersion, const skgpu::VulkanExtensions&, GrProtected isProtected);
    ...
    struct FormatInfo {
        ...
        void initSampleCounts(const skgpu::VulkanInterface*, VkPhysicalDevice, const VkPhysicalDeviceProperties&, VkFormat);
