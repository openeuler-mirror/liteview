...
public:
    ...
    void purgeResourcesNotUsedSince(GrStdSteadyClock::time_point purgeTime, bool scratchResourcesOnly = false)
    {
...
private:
    ...
    void purgeUnlockedResources(const GrStdSteadyClock::time_point* purgeTime, bool scratchResourcesOnly);
