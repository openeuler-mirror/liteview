...
private:
    ...
    void onPrepareDraws(GrMeshDrawTarget* target) override
    {
        ...
        if (fUsesDistanceField) {
            ...
            flushInfo.fGeometryProcessor = GrBitmapTextGeoProc::Make(target->allocator(), *target->caps().shaderCaps(), this->color(), fWideColor, views,
    ...
    bool addToAtlasWithRetry(GrMeshDrawTarget* target, FlushInfo* flushInfo, skgpu::v1::SmallPathAtlasMgr* atlasMgr, int width, int height, const void* image,
        const SkRect& bounds, int srcInset, skgpu::v1::SmallPathShapeData* shapeData) const
    {
    ...
    bool addDFPathToAtlas(GrMeshDrawTarget* target, FlushInfo* flushInfo, skgpu::v1::SmallPathAtlasMgr* atlasMgr, skgpu::v1::SmallPathShapeData* shapeData,
    ...
    bool addBMPathToAtlas(GrMeshDrawTarget* target, FlushInfo* flushInfo, skgpu::v1::SmallPathAtlasMgr* atlasMgr, skgpu::v1::SmallPathShapeData* shapeData,
    ...
    void writePathVertices(VertexWriter& vertices, const VertexColor& color, const SkMatrix& ctm, const skgpu::v1::SmallPathShapeData* shapeData) const
    {
...
GR_DRAW_OP_TEST_DEFINE(SmallPathOp)
{
    ...
    return skgpu::v1::SmallPathOp::Make(context, std::move(paint), shape, viewMatrix, gammaCorrect, GrGetRandomStencil(random, context));
}
