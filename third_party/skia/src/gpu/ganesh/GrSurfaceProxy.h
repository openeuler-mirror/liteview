...
public:
    ...
    static sk_sp<GrSurfaceProxy> Copy(GrRecordingContext*, sk_sp<GrSurfaceProxy> src, GrSurfaceOrigin, GrMipmapped, SkIRect srcRect, SkBackingFit, SkBudgeted,
        std::string_view label, RectsMustMatch = RectsMustMatch::kNo, sk_sp<GrRenderTask>* outTask = nullptr);

    // Same as above Copy but copies the entire 'src'
    static sk_sp<GrSurfaceProxy> Copy(GrRecordingContext*, sk_sp<GrSurfaceProxy> src, GrSurfaceOrigin, GrMipmapped, SkBackingFit, SkBudgeted,
...
protected:
    ...
    GrSurfaceProxy(const GrBackendFormat&, SkISize, SkBackingFit, SkBudgeted, GrProtected, GrInternalSurfaceFlags, UseAllocator, std::string_view label);
    // Lazy-callback version - takes a new UniqueID from the shared resource/proxy pool.
    GrSurfaceProxy(LazyInstantiateCallback&&, const GrBackendFormat&, SkISize, SkBackingFit, SkBudgeted, GrProtected, GrInternalSurfaceFlags, UseAllocator,
    ...
    sk_sp<GrSurface> createSurfaceImpl(GrResourceProvider*, int sampleCnt, GrRenderable, GrMipmapped) const;
    ...
    bool instantiateImpl(GrResourceProvider* resourceProvider, int sampleCnt, GrRenderable, GrMipmapped, const skgpu::UniqueKey*);
