...
public:
    ...
    std::string SkSLToSPIRV(const char* shaderString, SkSL::ProgramKind, uint32_t rtFlipOffset, SkSL::Program::Inputs*);
...
private:
    ...
    bool onWritePixels(GrSurface*, SkIRect, GrColorType surfaceColorType, GrColorType srcColorType, const GrMipLevel[], int mipLevelCount, bool) override;
    ...
    void uploadTextureData(GrColorType srcColorType, const GrMipLevel texels[], int mipLevelCount, const SkIRect& rect, wgpu::Texture texture);
