...
GrDawnAttachment::GrDawnAttachment(
    GrDawnGpu* gpu, SkISize dimensions, UsageFlags supportedUsages, int samples, wgpu::Texture texture, wgpu::TextureView view, std::string_view label)
    : INHERITED(gpu, dimensions, supportedUsages, samples, GrMipmapped::kNo, GrProtected::kNo, label)
    , fTexture(texture)
    , fView(view)
{
...
sk_sp<GrDawnAttachment> GrDawnAttachment::MakeStencil(GrDawnGpu* gpu, SkISize dimensions, int sampleCnt)
{
    ...
    return sk_sp<GrDawnAttachment>(new GrDawnAttachment(gpu, dimensions, UsageFlags::kStencilAttachment, sampleCnt, texture, view,
