...
public:
    ...
    static std::unique_ptr<SurfaceDrawContext> Make(GrRecordingContext*, GrColorType, sk_sp<SkColorSpace>, SkBackingFit, SkISize dimensions,
        const SkSurfaceProps&, std::string_view label, int sampleCnt = 1, GrMipmapped = GrMipmapped::kNo, GrProtected = GrProtected::kNo,
    ...
    static std::unique_ptr<SurfaceDrawContext> Make(GrRecordingContext*, sk_sp<SkColorSpace>, SkBackingFit, SkISize dimensions, const GrBackendFormat&,
        int sampleCnt, GrMipmapped, GrProtected, skgpu::Swizzle readSwizzle, skgpu::Swizzle writeSwizzle, GrSurfaceOrigin, SkBudgeted, const SkSurfaceProps&,
    ...
    static std::unique_ptr<SurfaceDrawContext> MakeWithFallback(GrRecordingContext*, GrColorType, sk_sp<SkColorSpace>, SkBackingFit, SkISize dimensions,
        const SkSurfaceProps&, int sampleCnt = 1, GrMipmapped = GrMipmapped::kNo, GrProtected = GrProtected::kNo, GrSurfaceOrigin = kBottomLeft_GrSurfaceOrigin,
     ...
     */
    void drawVertices(const GrClip*, GrPaint&& paint, const SkMatrixProvider& matrixProvider, sk_sp<SkVertices> vertices,
     ...
     */
    void drawMesh(const GrClip*, GrPaint&& paint, const SkMatrixProvider& matrixProvider, const SkMesh& mesh);
     ...
     */
    void drawArc(const GrClip*, GrPaint&& paint, GrAA, const SkMatrix& viewMatrix, const SkRect& oval, SkScalar startAngle, SkScalar sweepAngle, bool useCenter,
        const GrStyle& style);
     ...
     */
    void drawGlyphRunList(SkCanvas*, const GrClip*, const SkMatrixProvider& viewMatrix, const sktext::GlyphRunList& glyphRunList,
...
private:
    ...
    bool SK_WARN_UNUSED_RESULT setupDstProxyView(const SkRect& opBounds, bool opRequiresMSAA, GrDstProxyView* result);
