...
void GrResourceAllocator::addInterval(GrSurfaceProxy* proxy, unsigned int start, unsigned int end, ActualUse actualUse SkDEBUGCODE(, bool isDirectDstRead))
{
    SkASSERT(start <= end);
...
bool GrResourceAllocator::Register::isRecyclable(const GrCaps& caps, GrSurfaceProxy* proxy, int knownUseCount) const
{
