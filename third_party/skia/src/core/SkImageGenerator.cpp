...
GrSurfaceProxyView SkImageGenerator::generateTexture(GrRecordingContext* ctx, const SkImageInfo& info, GrMipmapped mipmapped, GrImageTexGenPolicy texGenPolicy)
{
...
GrSurfaceProxyView SkImageGenerator::onGenerateTexture(GrRecordingContext*, const SkImageInfo&, GrMipmapped, GrImageTexGenPolicy)
{
    return {};
}
...
sk_sp<SkImage> SkImageGenerator::makeTextureImage(skgpu::graphite::Recorder* recorder, const SkImageInfo& info, skgpu::graphite::Mipmapped mipmapped)
{
...
sk_sp<SkImage> SkImageGenerator::onMakeTextureImage(skgpu::graphite::Recorder*, const SkImageInfo&, skgpu::graphite::Mipmapped)
{
    return nullptr;
}
...
std::unique_ptr<SkImageGenerator> SkImageGenerator::MakeFromEncoded(sk_sp<SkData> data, std::optional<SkAlphaType> at)
{
