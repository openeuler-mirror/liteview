...
struct SkPackedGlyphID {
    ...
    {
        SkString str;
        str.appendf("0x%x|%1d|%1d", this->glyphID(), this->subPixelField(kSubPixelX), this->subPixelField(kSubPixelY));
        return str;
    }
...
public:
    ...
    bool canDrawAsMask() const
    {
        return fCanDrawAsMask;
    }
    bool canDrawAsSDFT() const
    {
        return fCanDrawAsSDFT;
    }
