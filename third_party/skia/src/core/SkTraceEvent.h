    ...
    do {                                                                                                                                                       \
        ...
        if (INTERNAL_TRACE_EVENT_CATEGORY_GROUP_ENABLED_FOR_RECORDING_MODE()) {                                                                                \
            skia::tracing_internals::AddTraceEvent(                                                                                                            \
                phase, INTERNAL_TRACE_EVENT_UID(category_group_enabled), name, skia::tracing_internals::kNoEventId, flags, ##__VA_ARGS__);                     \
        }                                                                                                                                                      \
    } while (0)
    ...
    do {                                                                                                                                                       \
        if (INTERNAL_TRACE_EVENT_CATEGORY_GROUP_ENABLED_FOR_RECORDING_MODE()) {                                                                                \
            SkEventTracer::Handle h = skia::tracing_internals::AddTraceEvent(TRACE_EVENT_PHASE_COMPLETE, INTERNAL_TRACE_EVENT_UID(category_group_enabled),     \
                name, skia::tracing_internals::kNoEventId, TRACE_EVENT_FLAG_NONE, ##__VA_ARGS__);                                                              \
