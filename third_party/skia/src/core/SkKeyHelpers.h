...
struct PassthroughShaderBlock {
    ...
    static void BeginBlock(const SkKeyContext&, SkPaintParamsKeyBuilder*, SkPipelineDataGatherer*);
};
...
struct SolidColorShaderBlock {
    ...
    static void BeginBlock(const SkKeyContext&, SkPaintParamsKeyBuilder*, SkPipelineDataGatherer*, const SkPMColor4f&);
};
...
struct GradientShaderBlocks {
    ...
    struct GradientData {
        ...
        GradientData(SkShaderBase::GradientType, SkPoint point0, SkPoint point1, float radius0, float radius1, float bias, float scale, SkTileMode,
            int numStops, SkColor4f* colors, float* offsets);

        bool operator==(const GradientData& rhs) const
        {
            return fType == rhs.fType && fPoints[0] == rhs.fPoints[0] && fPoints[1] == rhs.fPoints[1] && fRadii[0] == rhs.fRadii[0]
                && fRadii[1] == rhs.fRadii[1] && fBias == rhs.fBias && fScale == rhs.fScale && fTM == rhs.fTM && fNumStops == rhs.fNumStops
                && !memcmp(fColor4fs, rhs.fColor4fs, sizeof(fColor4fs)) && !memcmp(fOffsets, rhs.fOffsets, sizeof(fOffsets));
        }
        bool operator!=(const GradientData& rhs) const
        {
            return !(*this == rhs);
    ...
    static void BeginBlock(const SkKeyContext&, SkPaintParamsKeyBuilder*, SkPipelineDataGatherer*, const GradientData&);
};
...
struct LocalMatrixShaderBlock {
    ...
    static void BeginBlock(const SkKeyContext&, SkPaintParamsKeyBuilder*, SkPipelineDataGatherer*, const LMShaderData&);
};

struct ImageShaderBlock {

    struct ImageData {
        ImageData(const SkSamplingOptions& sampling, SkTileMode tileModeX, SkTileMode tileModeY, SkRect subset);
    ...
    static void BeginBlock(const SkKeyContext&, SkPaintParamsKeyBuilder*, SkPipelineDataGatherer*, const ImageData&);
};
...
struct PorterDuffBlendShaderBlock {
    ...
    static void BeginBlock(const SkKeyContext&, SkPaintParamsKeyBuilder*, SkPipelineDataGatherer*, const PorterDuffBlendShaderData&);
};
...
struct BlendShaderBlock {
    ...
    static void BeginBlock(const SkKeyContext&, SkPaintParamsKeyBuilder*, SkPipelineDataGatherer*, const BlendShaderData&);
};
...
struct MatrixColorFilterBlock {
    ...
    static void BeginBlock(const SkKeyContext&, SkPaintParamsKeyBuilder*, SkPipelineDataGatherer*, const MatrixColorFilterData&);
};
...
struct BlendColorFilterBlock {
    ...
    static void BeginBlock(const SkKeyContext&, SkPaintParamsKeyBuilder*, SkPipelineDataGatherer*, const BlendColorFilterData&);
};
...
struct TableColorFilterBlock {
    ...
    static void BeginBlock(const SkKeyContext&, SkPaintParamsKeyBuilder*, SkPipelineDataGatherer*, const TableColorFilterData&);
};
...
struct BlendModeBlock {
    static void BeginBlock(const SkKeyContext&, SkPaintParamsKeyBuilder*, SkPipelineDataGatherer*, SkBlendMode);
};
...
struct RuntimeEffectBlock {
    ...
    static void BeginBlock(const SkKeyContext&, SkPaintParamsKeyBuilder*, SkPipelineDataGatherer*, const ShaderData&);
};
