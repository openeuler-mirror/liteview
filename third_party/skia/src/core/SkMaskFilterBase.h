...
public:
    ...
    */
    ...
    virtual bool canFilterMaskGPU(
        const GrStyledShape&, const SkIRect& devSpaceShapeBounds, const SkIRect& clipBounds, const SkMatrix& ctm, SkIRect* maskRect) const;
    ...
    virtual bool directFilterMaskGPU(
        GrRecordingContext*, skgpu::v1::SurfaceDrawContext*, GrPaint&& paint, const GrClip*, const SkMatrix& viewMatrix, const GrStyledShape& shape) const;
     ...
     */
    virtual GrSurfaceProxyView filterMaskGPU(GrRecordingContext*, GrSurfaceProxyView srcView, GrColorType srcColorType, SkAlphaType srcAlphaType,
        const SkMatrix& ctm, const SkIRect& maskRect) const;
#endif
