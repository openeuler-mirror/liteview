...
public:
    ...
    static std::tuple<SkStrikeSpec, SkScalar, sktext::gpu::SDFTMatrixRange> MakeSDFT(const SkFont& font, const SkPaint& paint,
    ...
    sktext::ScopedStrikeForGPU findOrCreateScopedStrike(sktext::StrikeForGPUCacheInterface* cache) const;
