...
public:
    ...
    const SkMatrixProvider& asMatrixProvider() const
    {
        return *this;
    }
    ...
    virtual skgpu::v1::Device* asGaneshDevice()
    {
        return nullptr;
    }
    ...
    void drawGlyphRunList(SkCanvas*, const sktext::GlyphRunList& glyphRunList, const SkPaint& initialPaint, const SkPaint& drawingPaint);
...
protected:
    ...
    virtual void onDrawGlyphRunList(SkCanvas*, const sktext::GlyphRunList&, const SkPaint& initialPaint, const SkPaint& drawingPaint) = 0;
     ...
     */
    virtual void drawFilteredImage(const skif::Mapping& mapping, SkSpecialImage* src, const SkImageFilter*, const SkSamplingOptions&, const SkPaint&);
    ...
    struct CreateInfo {
        CreateInfo(const SkImageInfo& info, SkPixelGeometry geo, TileUsage tileUsage, SkRasterHandleAllocator* allocator)
            : fInfo(info)
...
private:
    ...
    void simplifyGlyphRunRSXFormAndRedraw(SkCanvas*, const sktext::GlyphRunList&, const SkPaint& initialPaint, const SkPaint& drawingPaint);
...
protected:
    ...
    void drawFilteredImage(const skif::Mapping&, SkSpecialImage* src, const SkImageFilter*, const SkSamplingOptions&, const SkPaint&) override
    {
    }
#if SK_SUPPORT_GPU
