...
public:
     ...
     */
    static sk_sp<SkSpecialSurface> MakeRenderTarget(GrRecordingContext*, const SkImageInfo&, const SkSurfaceProps&, GrSurfaceOrigin);
#endif

#if SK_GRAPHITE_ENABLED
    static sk_sp<SkSpecialSurface> MakeGraphite(skgpu::graphite::Recorder*, const SkImageInfo&, const SkSurfaceProps&);
#endif
