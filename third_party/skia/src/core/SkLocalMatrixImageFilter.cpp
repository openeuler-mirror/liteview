...
sk_sp<SkImageFilter> SkLocalMatrixImageFilter::Make(const SkMatrix& localM, sk_sp<SkImageFilter> input)
{
    if (!input) {
        return nullptr;
    }
...
SkLocalMatrixImageFilter::SkLocalMatrixImageFilter(const SkMatrix& localM, sk_sp<SkImageFilter> input)
...
sk_sp<SkSpecialImage> SkLocalMatrixImageFilter::onFilterImage(const Context& ctx, SkIPoint* offset) const
{
