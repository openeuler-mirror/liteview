...
inline sk_sp<SkRuntimeEffect> SkMakeCachedRuntimeEffect(SkRuntimeEffect::Result (*make)(SkString), const char* sksl)
{
...
public:
    ...
    SkPMColor4f eval(const SkPMColor4f& inColor, const void* uniformData, std::function<SkPMColor4f(int, SkPMColor4f)> evalChild) const;

    bool isAlphaUnchanged() const
    {
        return fAlphaUnchanged;
    }
...
private:
    ...
    SkFilterColorProgram(skvm::Program program, std::vector<SampleCall> sampleCalls, bool alphaUnchanged);
