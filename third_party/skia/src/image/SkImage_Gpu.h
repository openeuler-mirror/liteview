...
public:
    SkImage_Gpu(sk_sp<GrImageContext> context, uint32_t uniqueID, GrSurfaceProxyView view, SkColorInfo info);
...
private:
    SkImage_Gpu(sk_sp<GrDirectContext>, GrSurfaceProxyView volatileSrc, sk_sp<GrSurfaceProxy> stableCopy, sk_sp<GrRenderTask> copyTask,
