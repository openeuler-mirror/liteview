...
public:
    ...
    virtual bool onReplaceBackendTexture(const GrBackendTexture&, GrSurfaceOrigin, ContentChangeMode, TextureReleaseProc, ReleaseContext);
     ...
     */
    virtual GrSemaphoresSubmitted onFlush(BackendSurfaceAccess access, const GrFlushInfo&, const skgpu::MutableTextureState*)
    {
     ...
     */
    virtual void onAsyncReadPixels(const SkImageInfo& info, const SkIRect srcRect, ReadPixelsCallback callback, ReadPixelsContext context)
    {
    ...
    virtual void onAsyncRescaleAndReadPixelsYUV420(
        SkYUVColorSpace, sk_sp<SkColorSpace> dstColorSpace, SkIRect srcRect, SkISize dstSize, RescaleGamma, RescaleMode, ReadPixelsCallback, ReadPixelsContext);
