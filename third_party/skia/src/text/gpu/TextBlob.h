...
#if SK_SUPPORT_GPU
    void draw(SkCanvas*, const GrClip* clip, const SkMatrixProvider& viewMatrix, SkPoint drawOrigin, const SkPaint& paint, skgpu::v1::SurfaceDrawContext* sdc);
#endif
#if defined(SK_GRAPHITE_ENABLED)
    void draw(SkCanvas*, SkPoint drawOrigin, const SkPaint& paint, skgpu::graphite::Device* device);
#endif
...
namespace skgpu::v1 {
sk_sp<sktext::gpu::Slug> MakeSlug(const SkMatrixProvider& drawMatrix, const sktext::GlyphRunList& glyphRunList, const SkPaint& initialPaint,
