...
#define SK_BLITTER_TRACE_STEP(name, trace, scanlines, pixels) SkBlitterTrace::Step name(trace ? &gSkVMBlitterTrace : nullptr, #name, scanlines, pixels)
#endif

#ifdef SK_BLITTER_TRACE_IS_RASTER_PIPELINE
SkBlitterTrace gSkRPBlitterTrace("RP", false);
#define SK_BLITTER_TRACE_STEP(name, trace, scanlines, pixels) SkBlitterTrace::Step name(trace ? &gSkRPBlitterTrace : nullptr, #name, scanlines, pixels)
#endif
