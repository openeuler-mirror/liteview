 ...
 */
SK_SPI sk_sp<SkDocument> SkMakeMultiPictureDocument(SkWStream* dst, const SkSerialProcs* = nullptr, std::function<void(const SkPicture*)> onEndPage = nullptr);
 ...
 */
SK_SPI bool SkMultiPictureDocumentRead(SkStreamSeekable* src, SkDocumentPage* dstArray, int dstArrayCount, const SkDeserialProcs* = nullptr);
