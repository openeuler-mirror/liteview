...
#include <memory>
    ...
    || (defined(SK_BUILD_FOR_MAC) && defined(__MAC_11_0) && __MAC_OS_VERSION_MIN_REQUIRED >= __MAC_11_0)
...
protected:
    ...
    sk_sp<SkTypeface> onMakeFromData(sk_sp<SkData> data, int ttcIndex) const override
    {
        ...
        return SkTypeface_Mac::Make(std::move(ct), OpszVariation(), SkMemoryStream::Make(std::move(data)));
    }
