...
void SkScalerContext_Mac::generateImage(const SkGlyph& glyph)
{
    ...
    if ((glyph.fMaskFormat == SkMask::kLCD16_Format)
        || (glyph.fMaskFormat == SkMask::kA8_Format && requestSmooth && SkCTFontGetSmoothBehavior() != SkCTFontSmoothBehavior::none)) {
    ...
    case SkMask::kLCD16_Format: {
        if (fPreBlend.isApplicable()) {
            RGBToLcd16<true>(cgPixels, cgRowBytes, glyph, glyph.fImage, fPreBlend.fR, fPreBlend.fG, fPreBlend.fB);
        } else {
            RGBToLcd16<false>(cgPixels, cgRowBytes, glyph, glyph.fImage, fPreBlend.fR, fPreBlend.fG, fPreBlend.fB);
        }
    } break;
...
void SkScalerContext_Mac::generateFontMetrics(SkFontMetrics* metrics)
{
    ...
    size_t bytesRead
        = this->getTypeface()->getTableData(SkTEndian_SwapBE32(SkOTTableOS2::TAG), offsetof(SkOTTableOS2, version.v2.sxHeight), sizeof(heights), &heights);
