...
sk_sp<SkSpecialImage> SkOffsetImageFilter::onFilterImage(const Context& ctx, SkIPoint* offset) const
{
    ...
    if (!this->cropRectIsSet()) {
        ...
        canvas->translate(SkIntToScalar(Sk32_sat_sub(srcOffset.fX, bounds.fLeft)), SkIntToScalar(Sk32_sat_sub(srcOffset.fY, bounds.fTop)));
...
SkIRect SkOffsetImageFilter::onFilterNodeBounds(const SkIRect& src, const SkMatrix& ctm, MapDirection dir, const SkIRect* inputRect) const
{
