...
sk_sp<SkSpecialImage> SkMergeImageFilter::onFilterImage(const Context& ctx, SkIPoint* offset) const
{
    ...
    for (int i = 0; i < inputCount; ++i) {
        ...
        const SkIRect inputBounds = SkIRect::MakeXYWH(offsets[i].fX, offsets[i].fY, inputs[i]->width(), inputs[i]->height());
