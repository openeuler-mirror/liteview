 ...
 */
const Modifiers* AddConstToVarModifiers(const Context& context, const Variable& var, const Expression* initialValue, const ProgramUsage* usage);
...
bool EliminateDeadGlobalVariables(const Context& context, LoadedModule& module, ProgramUsage* usage, bool onlyPrivateGlobals);
