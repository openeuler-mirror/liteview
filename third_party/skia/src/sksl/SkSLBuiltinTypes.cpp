...
BuiltinTypes::BuiltinTypes()
    ...
    , fTexture2DRect(Type::MakeTextureType("texture2DRect", SpvDimRect,
          ...
          /*isArrayedTexture=*/false,
          /*isMultisampled=*/false, Type::TextureAccess::kSample))
    , fReadWriteTexture2D(Type::MakeTextureType("readWriteTexture2D", SpvDim2D,
          /*isDepth=*/false,
          /*isArrayedTexture=*/false,
    ...
    , fGenTexture2D(Type::MakeGenericType("$genTexture2D", { fReadOnlyTexture2D.get(), fWriteOnlyTexture2D.get(), fReadWriteTexture2D.get() }))
    , fReadableTexture2D(Type::MakeGenericType("$readableTexture2D", { fReadOnlyTexture2D.get(), fInvalid.get(), fReadWriteTexture2D.get() }))
    , fWritableTexture2D(Type::MakeGenericType("$writableTexture2D", { fInvalid.get(), fWriteOnlyTexture2D.get(), fReadWriteTexture2D.get() }))
    ...
    , fGenType(Type::MakeGenericType("$genType", { fFloat.get(), fFloat2.get(), fFloat3.get(), fFloat4.get() }))
    , fGenHType(Type::MakeGenericType("$genHType", { fHalf.get(), fHalf2.get(), fHalf3.get(), fHalf4.get() }))
    , fGenIType(Type::MakeGenericType("$genIType", { fInt.get(), fInt2.get(), fInt3.get(), fInt4.get() }))
    , fGenUType(Type::MakeGenericType("$genUType", { fUInt.get(), fUInt2.get(), fUInt3.get(), fUInt4.get() }))
    , fGenBType(Type::MakeGenericType("$genBType", { fBool.get(), fBool2.get(), fBool3.get(), fBool4.get() }))
    ...
    , fSquareMat(Type::MakeGenericType("$squareMat", { fInvalid.get(), fFloat2x2.get(), fFloat3x3.get(), fFloat4x4.get() }))
    , fSquareHMat(Type::MakeGenericType("$squareHMat", { fInvalid.get(), fHalf2x2.get(), fHalf3x3.get(), fHalf4x4.get() }))
    , fVec(Type::MakeGenericType("$vec", { fInvalid.get(), fFloat2.get(), fFloat3.get(), fFloat4.get() }))
    , fHVec(Type::MakeGenericType("$hvec", { fInvalid.get(), fHalf2.get(), fHalf3.get(), fHalf4.get() }))
    , fIVec(Type::MakeGenericType("$ivec", { fInvalid.get(), fInt2.get(), fInt3.get(), fInt4.get() }))
    , fUVec(Type::MakeGenericType("$uvec", { fInvalid.get(), fUInt2.get(), fUInt3.get(), fUInt4.get() }))
    , fSVec(Type::MakeGenericType("$svec", { fInvalid.get(), fShort2.get(), fShort3.get(), fShort4.get() }))
    , fUSVec(Type::MakeGenericType("$usvec", { fInvalid.get(), fUShort2.get(), fUShort3.get(), fUShort4.get() }))
    , fBVec(Type::MakeGenericType("$bvec", { fInvalid.get(), fBool2.get(), fBool3.get(), fBool4.get() }))
