...
public:
    ...
    SwitchStatement(Position pos, bool isStatic, std::unique_ptr<Expression> value, StatementArray cases, std::shared_ptr<SymbolTable> symbols)
    ...
    static std::unique_ptr<Statement> Convert(const Context& context, Position pos, bool isStatic, std::unique_ptr<Expression> value,
    ...
    static std::unique_ptr<Statement> BlockForCase(StatementArray* cases, SwitchCase* caseToCapture, std::shared_ptr<SymbolTable> symbolTable);
