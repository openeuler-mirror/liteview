...
public:
    ...
    bool visitExpression(const Expression& e) override
    {
        ...
        case Expression::Kind::kVariableReference: {
            ...
            if ((v->storage() == Variable::Storage::kGlobal || v->storage() == Variable::Storage::kLocal) && (v->modifiers().fFlags & Modifiers::kConst_Flag)) {
                return false;
            }
...
bool Analysis::IsConstantIndexExpression(const Expression& expr, const std::set<const Variable*>* loopIndices)
{
