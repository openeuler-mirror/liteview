...
private:
    ...
    bool functionDeclarationEnd(Position start, dsl::DSLModifiers& modifiers, dsl::DSLType type, const Token& name);
    ...
    SkTArray<dsl::DSLGlobalVar> structVarDeclaration(Position start, const dsl::DSLModifiers& modifiers);
    ...
    void globalVarDeclarationEnd(Position position, const dsl::DSLModifiers& mods, dsl::DSLType baseType, Token name);

    dsl::DSLStatement localVarDeclarationEnd(Position position, const dsl::DSLModifiers& mods, dsl::DSLType baseType, Token name);
    ...
    bool SK_WARN_UNUSED_RESULT operatorRight(AutoDepth& depth, Operator::Kind op, BinaryParseFn rightFn, dsl::DSLExpression& result);
    ...
    dsl::DSLExpression swizzle(Position pos, dsl::DSLExpression base, std::string_view swizzleMask, Position maskPos);
