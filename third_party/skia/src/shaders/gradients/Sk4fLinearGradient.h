...
private:
    ...
    template <ApplyPremul premul> void shadePremulSpan(int x, int y, SkPMColor dst[], int count, float bias0, float bias1) const;

    template <ApplyPremul premul, SkTileMode tileMode> void shadeSpanInternal(int x, int y, SkPMColor dst[], int count, float bias0, float bias1) const;
