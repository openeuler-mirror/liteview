...
public:
    ...
    struct Descriptor {
        ...
        Descriptor(const SkColor4f colors[], sk_sp<SkColorSpace> colorSpace, const SkScalar pos[], int colorCount, SkTileMode mode,
    ...
    static bool ValidGradient(const SkColor4f colors[], const SkScalar pos[], int count, SkTileMode tileMode);
...
protected:
    ...
    virtual skvm::F32 transformT(skvm::Builder*, skvm::Uniforms*, skvm::Coord coord, skvm::I32* mask) const = 0;

    template <typename T, typename... Args> static Context* CheckedMakeContext(SkArenaAlloc* alloc, Args&&... args)
    {
