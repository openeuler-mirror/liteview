...
public:
    ...
    {
        return this->flag(SkSL::Layout::kBlendSupportAllEquations_Flag, "blend_support_all_equations", pos);
    }
    ...
    {
        return this->intValue(&fSkSLLayout.fLocation, location, SkSL::Layout::kLocation_Flag, "location", pos);
    }
    ...
    {
        return this->intValue(&fSkSLLayout.fBinding, binding, SkSL::Layout::kBinding_Flag, "binding", pos);
    }
    ...
    {
        return this->intValue(&fSkSLLayout.fBuiltin, builtin, SkSL::Layout::kBuiltin_Flag, "builtin", pos);
    }

    DSLLayout& inputAttachmentIndex(int inputAttachmentIndex, Position pos = {})
    {
        return this->intValue(
            &fSkSLLayout.fInputAttachmentIndex, inputAttachmentIndex, SkSL::Layout::kInputAttachmentIndex_Flag, "input_attachment_index", pos);
    }
...
private:
    ...
    DSLLayout& intValue(int* target, int value, SkSL::Layout::Flag flag, const char* name, Position pos);
