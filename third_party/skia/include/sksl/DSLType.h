...
public:
    ...
    template <typename... Args> static DSLExpression Construct(DSLType type, DSLVarBase& var, Args&&... args)
    {
        DSLExpression argArray[] = { var, args... };
        return Construct(type, SkSpan(argArray));
    }

    template <typename... Args> static DSLExpression Construct(DSLType type, DSLExpression expr, Args&&... args)
    {
...
#define TYPE(T)                                                                                                                                                \
    template <typename... Args> DSLExpression T(Args&&... args)                                                                                                \
    {                                                                                                                                                          \
...
public:
    ...
    DSLField(const DSLModifiers& modifiers, const DSLType type, std::string_view name, Position pos = {})
...
template <typename... Field> DSLType Struct(std::string_view name, Field... fields)
{
