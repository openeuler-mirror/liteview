...
public:
    ...
    DSLCase(DSLExpression value, SkSL::StatementArray statements, Position pos = {});
...
private:
    ...
    template <class... Cases> friend DSLStatement Switch(DSLExpression value, Cases... cases);
};
