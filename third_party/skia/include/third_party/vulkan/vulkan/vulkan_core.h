...
typedef enum VkEventCreateFlagBits { VK_EVENT_CREATE_DEVICE_ONLY_BIT_KHR = 0x00000001, VK_EVENT_CREATE_FLAG_BITS_MAX_ENUM = 0x7FFFFFFF } VkEventCreateFlagBits;
...
typedef enum VkShaderModuleCreateFlagBits { VK_SHADER_MODULE_CREATE_FLAG_BITS_MAX_ENUM = 0x7FFFFFFF } VkShaderModuleCreateFlagBits;
...
typedef enum VkSubmitFlagBitsKHR { VK_SUBMIT_PROTECTED_BIT_KHR = 0x00000001, VK_SUBMIT_FLAG_BITS_MAX_ENUM_KHR = 0x7FFFFFFF } VkSubmitFlagBitsKHR;
...
typedef void(VKAPI_PTR* PFN_vkCmdWaitEvents2KHR)(
    VkCommandBuffer commandBuffer, uint32_t eventCount, const VkEvent* pEvents, const VkDependencyInfoKHR* pDependencyInfos);
...
typedef void(VKAPI_PTR* PFN_vkCmdWriteBufferMarker2AMD)(
    VkCommandBuffer commandBuffer, VkPipelineStageFlags2KHR stage, VkBuffer dstBuffer, VkDeviceSize dstOffset, uint32_t marker);
...
typedef enum VkPrivateDataSlotCreateFlagBitsEXT { VK_PRIVATE_DATA_SLOT_CREATE_FLAG_BITS_MAX_ENUM_EXT = 0x7FFFFFFF } VkPrivateDataSlotCreateFlagBitsEXT;
...
typedef VkResult(VKAPI_PTR* PFN_vkSetPrivateDataEXT)(
    VkDevice device, VkObjectType objectType, uint64_t objectHandle, VkPrivateDataSlotEXT privateDataSlot, uint64_t data);
typedef void(VKAPI_PTR* PFN_vkGetPrivateDataEXT)(
    VkDevice device, VkObjectType objectType, uint64_t objectHandle, VkPrivateDataSlotEXT privateDataSlot, uint64_t* pData);
