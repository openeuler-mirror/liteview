...
public:
    ...
    */
    ...
    /** Creates SkImage from picture. Returned SkImage width and height are set by dimensions.
        ...
        @return            created SkImage, or nullptr
    */
    static sk_sp<SkImage> MakeFromPicture(sk_sp<SkPicture> picture, const SkISize& dimensions, const SkMatrix* matrix, const SkPaint* paint, BitDepth bitDepth,
    ...
    @return            created SkImage, or nullptr
*/
    static sk_sp<SkImage> MakeTextureFromCompressed(GrDirectContext* direct, sk_sp<SkData> data, int width, int height, CompressionType type,
    ...
    /** Creates SkImage from GPU texture associated with context. GPU texture must stay
        ...
        @return                    created SkImage, or nullptr
    */
    static sk_sp<SkImage> MakeFromTexture(GrRecordingContext* context, const GrBackendTexture& backendTexture, GrSurfaceOrigin origin, SkColorType colorType,
    ...
    /** Creates an SkImage from a GPU backend texture. The backend texture must stay
        ...
        @return                    created SkImage, or nullptr
    */
    static sk_sp<SkImage> MakeFromCompressedTexture(GrRecordingContext* context, const GrBackendTexture& backendTexture, GrSurfaceOrigin origin,
        SkAlphaType alphaType, sk_sp<SkColorSpace> colorSpace, TextureReleaseProc textureReleaseProc = nullptr, ReleaseContext releaseContext = nullptr);
    ...
    */
    ...
    static sk_sp<SkImage> MakeFromAdoptedTexture(GrRecordingContext* context, const GrBackendTexture& backendTexture, GrSurfaceOrigin textureOrigin,
    ...
    /** Creates an SkImage from YUV[A] planar textures. This requires that the textures stay valid
        ...
        @return                   created SkImage, or nullptr
    */
    static sk_sp<SkImage> MakeFromYUVATextures(GrRecordingContext* context, const GrYUVABackendTextures& yuvaTextures,
        sk_sp<SkColorSpace> imageColorSpace = nullptr, TextureReleaseProc textureReleaseProc = nullptr, ReleaseContext releaseContext = nullptr);
    ...
    /** Creates SkImage from SkYUVAPixmaps.
        ...
        @return                       created SkImage, or nullptr
    */
    static sk_sp<SkImage> MakeFromYUVAPixmaps(GrRecordingContext* context, const SkYUVAPixmaps& pixmaps, GrMipmapped buildMips = GrMipmapped::kNo,
        bool limitToMaxTextureSize = false, sk_sp<SkColorSpace> imageColorSpace = nullptr);
    ...
    /** Create a new SkImage that is very similar to an SkImage created by MakeFromTexture. The
        ...
        @return                    created SkImage, or nullptr
    */
    static sk_sp<SkImage> MakePromiseTexture(sk_sp<GrContextThreadSafeProxy> gpuContextProxy, const GrBackendFormat& backendFormat, SkISize dimensions,
    ...
    /** This entry point operates like 'MakePromiseTexture' but it is used to construct a SkImage
        ...
        @return                    created SkImage, or nullptr
    */
    static sk_sp<SkImage> MakePromiseYUVATexture(sk_sp<GrContextThreadSafeProxy> gpuContextProxy, const GrYUVABackendTextureInfo& backendTextureInfo,
    ...
    /** (See Skia bug 7447)
        ...
        @return                created SkImage, or nullptr
    */
    static sk_sp<SkImage> MakeFromAHardwareBuffer(AHardwareBuffer* hardwareBuffer, SkAlphaType alphaType = kPremul_SkAlphaType,
        sk_sp<SkColorSpace> colorSpace = nullptr, GrSurfaceOrigin surfaceOrigin = kTopLeft_GrSurfaceOrigin);
    ...
    */
    void asyncReadPixels(const SkImageInfo& info, const SkIRect& srcRect, ReadPixelsCallback callback, ReadPixelsContext context) const;
    ...
    */
    ...
    /** Creates an SkImage from a GPU texture associated with the recorder.
        ...
        @return                    created SkImage, or nullptr
    */
    static sk_sp<SkImage> MakeGraphiteFromBackendTexture(
        skgpu::graphite::Recorder*, const skgpu::graphite::BackendTexture&, SkColorType colorType, SkAlphaType alphaType, sk_sp<SkColorSpace> colorSpace);
    ...
    */
    sk_sp<SkImage> makeWithFilter(
        GrRecordingContext* context, const SkImageFilter* filter, const SkIRect& subset, const SkIRect& clipBounds, SkIRect* outSubset, SkIPoint* offset) const;
