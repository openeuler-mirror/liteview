...
public:
    ...
    */
    ...
    /** Allocates raster SkSurface. SkCanvas returned by SkSurface draws directly into pixels.
        ...
        @return              SkSurface if all parameters are valid; otherwise, nullptr
    */
    static sk_sp<SkSurface> MakeRasterDirectReleaseProc(const SkImageInfo& imageInfo, void* pixels, size_t rowBytes,
        void (*releaseProc)(void* pixels, void* context), void* context, const SkSurfaceProps* surfaceProps = nullptr);
    ...
    */
    ...
    /** Wraps a GPU-backed texture into SkSurface. Caller must ensure the texture is
        ...
        @return                    SkSurface if all parameters are valid; otherwise, nullptr
    */
    static sk_sp<SkSurface> MakeFromBackendTexture(GrRecordingContext* context, const GrBackendTexture& backendTexture, GrSurfaceOrigin origin, int sampleCnt,
    ...
    /** Wraps a GPU-backed buffer into SkSurface. Caller must ensure backendRenderTarget
        ...
        @return                         SkSurface if all parameters are valid; otherwise, nullptr
    */
    static sk_sp<SkSurface> MakeFromBackendRenderTarget(GrRecordingContext* context, const GrBackendRenderTarget& backendRenderTarget, GrSurfaceOrigin origin,
    ...
    /** Returns SkSurface on GPU indicated by context. Allocates memory for
        ...
        @return                      SkSurface if all parameters are valid; otherwise, nullptr
    */
    static sk_sp<SkSurface> MakeRenderTarget(GrRecordingContext* context, SkBudgeted budgeted, const SkImageInfo& imageInfo, int sampleCount,
        GrSurfaceOrigin surfaceOrigin, const SkSurfaceProps* surfaceProps, bool shouldCreateWithMips = false);
    ...
    */
    static sk_sp<SkSurface> MakeFromAHardwareBuffer(
        GrDirectContext* context, AHardwareBuffer* hardwareBuffer, GrSurfaceOrigin origin, sk_sp<SkColorSpace> colorSpace, const SkSurfaceProps* surfaceProps
     ...
     * the budget.
     */
    static sk_sp<SkSurface> MakeGraphite(skgpu::graphite::Recorder*, const SkImageInfo& imageInfo, skgpu::graphite::Mipmapped = skgpu::graphite::Mipmapped::kNo,
     ...
     */
    static sk_sp<SkSurface> MakeGraphiteFromBackendTexture(
        skgpu::graphite::Recorder*, const skgpu::graphite::BackendTexture&, SkColorType colorType, sk_sp<SkColorSpace> colorSpace, const SkSurfaceProps* props);
    ...
    /** Creates SkSurface from CAMetalLayer.
        ...
        @return                created SkSurface, or nullptr
     */
    static sk_sp<SkSurface> MakeFromCAMetalLayer(GrRecordingContext* context, GrMTLHandle layer, GrSurfaceOrigin origin, int sampleCnt, SkColorType colorType,
    ...
    /** Creates SkSurface from MTKView.
        ...
        @return                created SkSurface, or nullptr
     */
    static sk_sp<SkSurface> MakeFromMTKView(GrRecordingContext* context, GrMTLHandle mtkView, GrSurfaceOrigin origin, int sampleCnt, SkColorType colorType,
        sk_sp<SkColorSpace> colorSpace, const SkSurfaceProps* surfaceProps) SK_API_AVAILABLE(macos(10.11), ios(9.0));
#endif
    ...
    */
    ...
    /** If the surface was made via MakeFromBackendTexture then it's backing texture may be
        ...
        @param releaseContext      state passed to textureReleaseProc
     */
    bool replaceBackendTexture(const GrBackendTexture& backendTexture, GrSurfaceOrigin origin, ContentChangeMode mode = kRetain_ContentChangeMode,
    ...
    */
     ...
     */
    void asyncReadPixels(const SkImageInfo& info, const SkIRect& srcRect, ReadPixelsCallback callback, ReadPixelsContext context);
    ...
    */
    GrSemaphoresSubmitted flush(const GrFlushInfo& info, const skgpu::MutableTextureState* newState = nullptr);
