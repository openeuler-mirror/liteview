...
/** \class SkAutoTCallVProc
    ...
    function.
*/
template <typename T, void (*P)(T*)> class SkAutoTCallVProc : public std::unique_ptr<T, SkFunctionWrapper<std::remove_pointer_t<decltype(P)>, P>> {
