...
public:
    SkPathRef(SkTDArray<SkPoint> points, SkTDArray<uint8_t> verbs, SkTDArray<SkScalar> weights, unsigned segmentMask)
...
public:
    ...
    */
    ...
    {
        SkDEBUGCODE(this->validate();) fPoints.reserve(fPoints.size() + additionalPoints);
