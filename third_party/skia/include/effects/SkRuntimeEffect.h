...
public:
    ...
    sk_sp<SkShader> makeShader(sk_sp<const SkData> uniforms, SkSpan<ChildPtr> children, const SkMatrix* localMatrix = nullptr) const;

    sk_sp<SkImage> makeImage(GrRecordingContext*, sk_sp<const SkData> uniforms, SkSpan<ChildPtr> children, const SkMatrix* localMatrix, SkImageInfo resultInfo,
    ...
    sk_sp<SkColorFilter> makeColorFilter(sk_sp<const SkData> uniforms, SkSpan<ChildPtr> children) const;
...
protected:
    ...
    SkRuntimeEffect::ChildPtr* children()
    {
...
public:
    ...
    sk_sp<SkImage> makeImage(GrRecordingContext*, const SkMatrix* localMatrix, SkImageInfo resultInfo, bool mipmapped);
