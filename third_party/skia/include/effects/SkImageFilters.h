...
namespace skif {
static constexpr SkRect kNoCropRect = { SK_ScalarNegativeInfinity, SK_ScalarNegativeInfinity, SK_ScalarInfinity, SK_ScalarInfinity };
}
...
public:
    ...
    struct CropRect {
        ...
        {
            return fCropRect == skif::kNoCropRect ? nullptr : &fCropRect;
        }
