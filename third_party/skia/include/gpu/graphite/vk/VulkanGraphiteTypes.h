...
struct VulkanTextureInfo {
    ...
    VulkanTextureInfo(uint32_t sampleCount, uint32_t levelCount, VkImageCreateFlags flags, VkFormat format, VkImageTiling imageTiling,
        VkImageUsageFlags imageUsageFlags, VkSharingMode sharingMode, uint32_t currentQueueFamily, VkImageLayout imageLayout, VkImageAspectFlags aspectMask)
