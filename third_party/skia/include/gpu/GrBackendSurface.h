...
public:
    ...
    static GrBackendFormat MakeVk(const GrVkYcbcrConversionInfo& ycbcrInfo, bool willUseDRMFormatModifiers = false);
#endif
    ...
    static GrBackendFormat MakeMock(GrColorType colorType, SkImage::CompressionType compression, bool isStencilFormat = false);
...
#ifdef SK_VULKAN
    GrBackendFormat(const VkFormat vkFormat, const GrVkYcbcrConversionInfo&, bool willUseDRMFormatModifiers);
#endif
...
public:
    ...
    GrBackendTexture(int width, int height, GrMipmapped, const GrGLTextureInfo& glInfo, std::string_view label = {});
#endif

#ifdef SK_VULKAN
    GrBackendTexture(int width, int height, const GrVkImageInfo& vkInfo, std::string_view label = {});
#endif

#ifdef SK_METAL
    GrBackendTexture(int width, int height, GrMipmapped, const GrMtlTextureInfo& mtlInfo, std::string_view label = {});
#endif
...
#ifdef SK_DAWN
    GrBackendTexture(int width, int height, const GrDawnTextureInfo& dawnInfo, std::string_view label = {});
#endif

    GrBackendTexture(int width, int height, GrMipmapped, const GrMockTextureInfo& mockInfo, std::string_view label = {});
    ...
    {
        return fMipmapped == GrMipmapped::kYes;
    }
...
private:
    ...
    GrBackendTexture(int width, int height, GrMipmapped, const GrGLTextureInfo, sk_sp<GrGLTextureParameters>, std::string_view label = {});
    sk_sp<GrGLTextureParameters> getGLTextureParams() const;
#endif

#ifdef SK_VULKAN
    friend class GrVkTexture;
    GrBackendTexture(int width, int height, const GrVkImageInfo& vkInfo, sk_sp<skgpu::MutableTextureStateRef> mutableState, std::string_view label = {});
#endif
...
public:
    ...
    GrBackendRenderTarget(int width, int height, int sampleCnt, int stencilBits, const GrDawnRenderTargetInfo& dawnInfo);
#endif
...
private:
    ...
    GrBackendRenderTarget(int width, int height, const GrVkImageInfo& vkInfo, sk_sp<skgpu::MutableTextureStateRef> mutableState);
#endif
