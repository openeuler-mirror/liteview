...
REG_FIDDLE(skpaint_skia, 256, 256, false, 0)
{
    ...
    void draw(SkCanvas * canvas)
    {
        ...
        sk_sp<SkTextBlob> blob1 = SkTextBlob::MakeFromString("Skia!", SkFont(nullptr, 64.0f, 1.0f, 0.0f));
        sk_sp<SkTextBlob> blob2 = SkTextBlob::MakeFromString("Skia!", SkFont(nullptr, 64.0f, 1.5f, 0.0f));
