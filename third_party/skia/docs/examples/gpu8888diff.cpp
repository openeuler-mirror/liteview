...
REG_FIDDLE(gpu8888diff, 256, 256, false, 0)
{
    void draw(SkCanvas * canvas)
    {
        ...
        auto pack8888 = [](unsigned a, unsigned r, unsigned g, unsigned b) -> uint32_t { return (a << 24) | (b << 16) | (g << 8) | (r << 0); };
        uint32_t red8888[] = { pack8888(0xFF, 0xFF, 0x0, 0x0), pack8888(0xFF, 0xbb, 0x0, 0x0), pack8888(0xFF, 0x99, 0x0, 0x0), pack8888(0xFF, 0x55, 0x0, 0x0) };
        uint32_t blue8888[]
            = { pack8888(0xFF, 0x0, 0x0, 0x0FF), pack8888(0xFF, 0x0, 0x0, 0x0bb), pack8888(0xFF, 0x0, 0x0, 0x099), pack8888(0xFF, 0x0, 0x0, 0x055) };
