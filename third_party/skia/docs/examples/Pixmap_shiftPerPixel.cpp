...
REG_FIDDLE(Pixmap_shiftPerPixel, 256, 256, true, 0)
{
    ...
    void draw(SkCanvas * canvas)
    {
        ...
        for (SkColorType colorType : { kUnknown_SkColorType, kAlpha_8_SkColorType, kRGB_565_SkColorType, kARGB_4444_SkColorType, kRGBA_8888_SkColorType,
            ...
            SkDebugf("color: k"
                     ...
                     "_SkColorType"
                     "%*s"
                     "bytesPerPixel: %d shiftPerPixel: %d\n",
                color_type(colorType), (int)(10 - strlen(color_type(colorType))), " ", pixmap.info().bytesPerPixel(), pixmap.shiftPerPixel());
        }
    }
} // END FIDDLE
