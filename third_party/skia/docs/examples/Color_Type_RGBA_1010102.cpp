...
REG_FIDDLE(Color_Type_RGBA_1010102, 256, 96, false, 0)
{
    void draw(SkCanvas * canvas)
    {
        ...
        auto pack1010102 = [](unsigned r, unsigned g, unsigned b, unsigned a) -> uint32_t { return (r << 0) | (g << 10) | (b << 20) | (a << 30); };
        uint32_t redBits[] = { pack1010102(0x3FF, 0x000, 0x000, 0x3), pack1010102(0x2ff, 0x000, 0x000, 0x3), pack1010102(0x1ff, 0x000, 0x000, 0x3),
            pack1010102(0x0ff, 0x000, 0x000, 0x3) };
        uint32_t blueBits[] = { pack1010102(0x000, 0x000, 0x3FF, 0x3), pack1010102(0x000, 0x000, 0x2ff, 0x3), pack1010102(0x000, 0x000, 0x1ff, 0x3),
