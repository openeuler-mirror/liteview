...
REG_FIDDLE(ChromeMDRefreshTabs, 256, 256, false, 0)
{
    SkPath GetInteriorPath(float scale, const SkISize& size, float endcap_width, float horizontal_inset = 0)
    {
        ...
        right_path.arcTo(endcap_radius, endcap_radius, 90, SkPath::kSmall_ArcSize, SkPathDirection::kCW, right - endcap_radius, bottom - endcap_radius);
        ...
        right_path.arcTo(endcap_radius, endcap_radius, 90, SkPath::kSmall_ArcSize, SkPathDirection::kCCW, right - endcap_width, 0);
        ...
        left_path.arcTo(endcap_radius, endcap_radius, 90, SkPath::kSmall_ArcSize, SkPathDirection::kCCW, endcap_radius, endcap_radius);
        ...
        left_path.arcTo(endcap_radius, endcap_radius, 90, SkPath::kSmall_ArcSize, SkPathDirection::kCW, 0, bottom);
