...
REG_FIDDLE(Color_Type_RGB_888, 256, 96, false, 0)
{
    void draw(SkCanvas * canvas)
    {
        ...
        auto pack888 = [](unsigned r, unsigned g, unsigned b) -> uint32_t { return (r << 0) | (g << 8) | (b << 16); };
        uint32_t red888[] = { pack888(0xFF, 0x00, 0x00), pack888(0xbb, 0x00, 0x00), pack888(0x77, 0x00, 0x00), pack888(0x33, 0x00, 0x00) };
        uint32_t blue888[] = { pack888(0x00, 0x00, 0xFF), pack888(0x00, 0x00, 0xbb), pack888(0x00, 0x00, 0x77), pack888(0x00, 0x00, 0x33) };
