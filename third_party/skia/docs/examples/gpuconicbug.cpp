...
REG_FIDDLE(gpuconicbug, 300, 200, false, 0)
{
    void draw(SkCanvas * canvas)
    {
        ...
        path.conicTo(SkBits2Float(0x4350260c), SkBits2Float(0x41700f50), SkBits2Float(0x43506eb3), SkBits2Float(0x417007a8),
        ...
        path.conicTo(SkBits2Float(0x43509d29), SkBits2Float(0x427801bc), SkBits2Float(0x43507c38), SkBits2Float(0x42780379),
