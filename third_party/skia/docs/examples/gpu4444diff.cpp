...
REG_FIDDLE_SRGB(gpu4444diff, 260, 260, false, 3, 0, false)
{
    void draw(SkCanvas * canvas)
    {
        ...
        auto pack4444 = [](unsigned a, unsigned r, unsigned g, unsigned b) -> uint16_t { return (a << 0) | (b << 4) | (g << 8) | (r << 12); };
        uint16_t red4444[] = { pack4444(0xF, 0xF, 0x0, 0x0), pack4444(0xF, 0xb, 0x0, 0x0), pack4444(0xF, 0x9, 0x0, 0x0), pack4444(0xF, 0x5, 0x0, 0x0) };
        uint16_t blue4444[] = { pack4444(0xF, 0x0, 0x0, 0x0F), pack4444(0xF, 0x0, 0x0, 0x0b), pack4444(0xF, 0x0, 0x0, 0x09), pack4444(0xF, 0x0, 0x0, 0x05) };
