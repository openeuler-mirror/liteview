...
{
    SkPath GetBorderPath(float scale, bool unscale_at_end, bool extend_to_top, float endcap_width, const SkISize& size)
    {
        ...
        // bottom left
        path.arcTo(scaled_endcap_radius - 1, scaled_endcap_radius - 1, 90, SkPath::kSmall_ArcSize, SkPathDirection::kCCW, scaled_endcap_radius - 1,
        ...
        // top left
        path.arcTo(scaled_endcap_radius + 1, scaled_endcap_radius + 1, 90, SkPath::kSmall_ArcSize, SkPathDirection::kCW, scaled_endcap_radius * 2, -1);
        ...
        // top right
        path.arcTo(scaled_endcap_radius + 1, scaled_endcap_radius + 1, 90, SkPath::kSmall_ArcSize, SkPathDirection::kCW, right - scaled_endcap_radius + 1,
        ...
        // bottom right
        path.arcTo(scaled_endcap_radius - 1, scaled_endcap_radius - 1, 90, SkPath::kSmall_ArcSize, SkPathDirection::kCCW, right, bottom - 1);
        path.close();
    ...
    SkPath GetInteriorPath(float scale, const SkISize& size, float endcap_width, float horizontal_inset = 0)
    {
        const float right = size.fWidth * scale;
        ...
        right_path.arcTo(scaled_endcap_radius, scaled_endcap_radius, 90, SkPath::kSmall_ArcSize, SkPathDirection::kCW, right - scaled_endcap_radius,
        ...
        right_path.arcTo(scaled_endcap_radius, scaled_endcap_radius, 90, SkPath::kSmall_ArcSize, SkPathDirection::kCCW, right - scaled_endcap_radius * 2, 0);
        ...
        left_path.arcTo(
            scaled_endcap_radius, scaled_endcap_radius, 90, SkPath::kSmall_ArcSize, SkPathDirection::kCCW, scaled_endcap_radius, scaled_endcap_radius);
        ...
        left_path.arcTo(scaled_endcap_radius, scaled_endcap_radius, 90, SkPath::kSmall_ArcSize, SkPathDirection::kCW, 0, bottom);
