...
protected:
    ...
    void onDraw(SkCanvas* canvas) override
    {
        ...
        paint.setMaskFilter(SkEmbossMaskFilter::Make(SkBlurMask::ConvertRadiusToSigma(3), { { SK_Scalar1, SK_Scalar1, SK_Scalar1 }, 0, 128, 16 * 2 }));
        ...
        paint.setMaskFilter(SkEmbossMaskFilter::Make(SkBlurMask::ConvertRadiusToSigma(4), { { SK_Scalar1, SK_Scalar1, SK_Scalar1 }, 0, 128, 16 * 2 }));
