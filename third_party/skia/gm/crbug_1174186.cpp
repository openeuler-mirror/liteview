...
{
    auto m = SkMatrix::MakeAll(SkBits2Float(0x24480629), SkBits2Float(0xbf3555c2), SkBits2Float(0x4377d67b), SkBits2Float(0x23a61d51), SkBits2Float(0x3f34b400),
        SkBits2Float(0x4453f572), SkBits2Float(0x00000000), SkBits2Float(0x00000000), SkBits2Float(0x3f800000));

    SkPoint pts[] = { { SkBits2Float(0x3f7ffff2), SkBits2Float(0x43483d60) }, { SkBits2Float(0x00000000), SkBits2Float(0x43483d60) },
        { SkBits2Float(0x00000000), SkBits2Float(0x4311a628) }, { SkBits2Float(0x3f800000), SkBits2Float(0x43130f8c) } };
    ...
    for (int i = 0; i < 10; ++i) {
        for (int flags = 0; flags < static_cast<int>(SkCanvas::kAll_QuadAAFlags); ++flags) {
            ...
            canvas->save();
            canvas->concat(m);
            canvas->experimental_DrawEdgeAAQuad(SkRect::MakeWH(1000, 1000), pts, aaFlags, color, SkBlendMode::kSrcOver);
            canvas->restore();
