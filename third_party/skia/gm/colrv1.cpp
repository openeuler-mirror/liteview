...
public:
    ColrV1GM(const char* testName, SkSpan<const uint32_t> codepoints, SkScalar skewX, SkScalar rotateDeg,
        ...
        , fRotateDeg(rotateDeg)
    {
        ...
        fCoordinates = std::make_unique<SkFontArguments::VariationPosition::Coordinate[]>(specifiedVariations.size());
...
protected:
    ...
    SkString onShortName() override
    {
        ...
        for (int i = 0; i < fVariationPosition.coordinateCount; ++i) {
            SkString tagName = ToolUtils::VariationSliders::tagToString(fVariationPosition.coordinates[i].axis);
            gm_name.append(SkStringPrintf("_%s_%.2f", tagName.c_str(), fVariationPosition.coordinates[i].value));
        }
    ...
    DrawResult onDraw(SkCanvas* canvas, SkString* errorMsg) override
    {
        ...
        for (SkScalar textSize : kTextSizes) {
            ...
            for (size_t i = 0; i < fCodepoints.size(); ++i) {
                canvas->drawSimpleText(&fCodepoints[i], sizeof(uint32_t), SkTextEncoding::kUTF32, x, y, font, paint);
                SkScalar glyphAdvance = font.measureText(&fCodepoints[i], sizeof(uint32_t), SkTextEncoding::kUTF32, nullptr);
...
const uint32_t sweep_varsweep[] = { 0xf0200, 0xf0201, 0xf0202, 0xf0203, 0xf0204, 0xf0205, 0xf0206, 0xf0207, 0xf0208, 0xf0209, 0xf020a, 0xf020b, 0xf020c,
    0xf020d, 0xf020e, 0xf020f, 0xf0210, 0xf0211, 0xf0212, 0xf0213, 0xf0214, 0xf0215, 0xf0216, 0xf0217, 0xf0218, 0xf0219, 0xf021a, 0xf021b, 0xf021c, 0xf021d,
    0xf021e, 0xf021f, 0xf0220, 0xf0221, 0xf0222, 0xf0223, 0xf0224, 0xf0225, 0xf0226, 0xf0227, 0xf0228, 0xf0229, 0xf022a, 0xf022b, 0xf022c, 0xf022d, 0xf022e,
    0xf022f, 0xf0230, 0xf0231, 0xf0232, 0xf0233, 0xf0234, 0xf0235, 0xf0236, 0xf0237, 0xf0238, 0xf0239, 0xf023a, 0xf023b, 0xf023c, 0xf023d, 0xf023e, 0xf023f,
    0xf0240, 0xf0241, 0xf0242, 0xf0243, 0xf0244, 0xf0245, 0xf0246, 0xf0247 };
...
const uint32_t composite_mode[] = { 0xf0a00, 0xf0a01, 0xf0a02, 0xf0a03, 0xf0a04, 0xf0a05, 0xf0a06, 0xf0a07, 0xf0a08, 0xf0a09, 0xf0a0a, 0xf0a0b, 0xf0a0c,
    0xf0a0d, 0xf0a0e, 0xf0a0f, 0xf0a10, 0xf0a11, 0xf0a12, 0xf0a13, 0xf0a14, 0xf0a15, 0xf0a16, 0xf0a17, 0xf0a18, 0xf0a19, 0xf0a1a, 0xf0a1b };
...
namespace {
std::unique_ptr<ColrV1GM> F(const char* name, SkSpan<const uint32_t> codepoints, SkScalar skewX, SkScalar rotateDeg,
...
DEF_GM(return F(C(sweep_varsweep), 0.0f, 0.0f, { { "SWC1"_t, -0.25f }, { "SWC2"_t, 0.083333333f }, { "SWC3"_t, 0.083333333f }, { "SWC4"_t, +0.25f } }))
