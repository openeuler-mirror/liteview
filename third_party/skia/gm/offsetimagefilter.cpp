...
protected:
    ...
    void onDraw(SkCanvas* canvas) override
    {
        ...
        for (int i = 0; i < 4; i++) {
            ...
            SkIRect cropRect = SkIRect::MakeXYWH(i * 12, i * 8, image->width() - i * 8, image->height() - i * 12);
...
private:
    static void DrawClippedImage(SkCanvas* canvas, const SkImage* image, const SkPaint& paint, SkScalar scale, const SkIRect& cropRect)
    {
