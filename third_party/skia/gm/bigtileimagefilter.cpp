...
protected:
    ...
    void onDraw(SkCanvas* canvas) override
    {
...

        {
            ...
            sk_sp<SkImageFilter> tif(SkImageFilters::Tile(SkRect::MakeIWH(kBitmapSize, kBitmapSize), SkRect::MakeIWH(kWidth, kHeight), std::move(imageSource)));
...

        {
            ...
            sk_sp<SkImageFilter> tif(SkImageFilters::Tile(SkRect::MakeIWH(kBitmapSize, kBitmapSize), SkRect::MakeIWH(kBitmapSize, kBitmapSize), nullptr));
            ...
            SkRect bound3 = SkRect::MakeXYWH(320, 320, SkIntToScalar(kBitmapSize), SkIntToScalar(kBitmapSize));
            canvas->drawImageRect(fGreenImage.get(), bound2, bound3, SkSamplingOptions(), nullptr, SkCanvas::kStrict_SrcRectConstraint);
            canvas->restore();
        }
    }
