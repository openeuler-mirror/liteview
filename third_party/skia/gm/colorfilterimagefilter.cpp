...
{
    float matrix[20] = { 1, 0, 0, 0, brightness, 0, 1, 0, 0, brightness, 0, 0, 1, 0, brightness, 0, 0, 0, 1, 0 };
...
DEF_SIMPLE_GM(colorfiltershader, canvas, 610, 610)
{
    ...
    *shaders.append() = SkGradientShader::MakeTwoPointConical({ 0, 0 }, 50, { 0, 0 }, 150, colors, nullptr, 2, SkTileMode::kClamp).release();
