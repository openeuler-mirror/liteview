...
void test_fake_bowtie(SkCanvas* canvas, const SkPaint& paint)
{
    ...
    canvas->drawPath(SkPath::Polygon({ { 20, 20 }, { 50, 40 }, { 80, 20 }, { 80, 80 }, { 50, 60 }, { 20, 80 } }, false), paint);
    canvas->restore();
}
...
void test_intruding_vertex(SkCanvas* canvas, const SkPaint& paint)
{
    ...
    canvas->drawPath(SkPath::Polygon({ { 20, 20 }, { 50, 50 }, { 68, 20 }, { 68, 80 }, { 50, 50 }, { 20, 80 } }, false, SkPathFillType::kWinding, true), paint);
    canvas->restore();
}
...
void test_inversion_repeat_vertex(SkCanvas* canvas, const SkPaint& paint)
{
    ...
    canvas->drawPath(SkPath::Polygon(pts, std::size(pts), false, SkPathFillType::kWinding, true), paint);
    canvas->restore();
}
...
void test_fish(SkCanvas* canvas, const SkPaint& paint)
{
    ...
    canvas->drawPath(SkPath::Polygon({ { 20, 20 }, { 80, 80 }, { 70, 50 }, { 80, 20 }, { 20, 80 }, { 0, 50 } }, false, SkPathFillType::kWinding, true), paint);
    canvas->restore();
}
...
void test_fast_forward(SkCanvas* canvas, const SkPaint& paint)
{
    ...
    auto path = SkPathBuilder().addPolygon({ { 20, 20 }, { 60, 50 }, { 20, 80 } }, false).addPolygon({ { 40, 20 }, { 40, 80 }, { 80, 50 } }, false).detach();
...
void test_star(SkCanvas* canvas, const SkPaint& paint)
{
    ...
    canvas->drawPath(SkPath::Polygon({ { 30, 20 }, { 50, 80 }, { 70, 20 }, { 20, 57 }, { 80, 57 } }, false), paint);
    canvas->restore();
}
...
void test_stairstep(SkCanvas* canvas, const SkPaint& paint)
{
    ...
    canvas->drawPath(SkPath::Polygon({ { 50, 50 }, { 50, 20 }, { 80, 20 }, { 50, 50 }, { 20, 50 }, { 20, 80 } }, false), paint);
    canvas->restore();
}
