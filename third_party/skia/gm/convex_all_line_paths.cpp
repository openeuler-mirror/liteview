...
const SkPoint gPoints4[] = { { -6.0f, -50.0f }, { 4.0f, -50.0f }, { 5.0f, -25.0f }, // remove if collinear diagonal points are not concave
...
const SkPoint gPoints7[] = { { -10.0f, -50.0f }, { 10.0f, -50.0f }, { 10.0f, -25.0f }, { 10.0f, 0.0f }, { 10.0f, 25.0f }, { 10.0f, 50.0f }, { -10.0f, 50.0f } };
// capped teardrop
...
public:
    ConvexLineOnlyPathsGM(bool doStrokeAndFill)
        : fDoStrokeAndFill(doStrokeAndFill)
    {
...
protected:
    ...
    void drawPath(SkCanvas* canvas, int index, SkPoint* offset)
    {
        ...
        const SkPaint::Join joins[3] = { SkPaint::kRound_Join, SkPaint::kBevel_Join, SkPaint::kMiter_Join };
