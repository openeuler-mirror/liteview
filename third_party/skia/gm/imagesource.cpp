...
protected:
    ...
    void onDraw(SkCanvas* canvas) override
    {
        ...
        }
        {
            ...
            sk_sp<SkImageFilter> imageSourceSrcRect(SkImageFilters::Image(fImage, srcRect, srcRect, sampling));
        ...
        }
        {
            ...
            sk_sp<SkImageFilter> imageSourceSrcRectDstRect(SkImageFilters::Image(fImage, srcRect, dstRect, sampling));
        ...
        }
        {
            ...
            sk_sp<SkImageFilter> imageSourceDstRectOnly(SkImageFilters::Image(fImage, bounds, dstRect, sampling));
