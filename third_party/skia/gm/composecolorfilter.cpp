...
static sk_sp<SkColorFilter> MakeTintColorFilter(SkColor lo, SkColor hi, bool useSkSL)
{
    ...
    sk_sp<SkColorFilter> inner = SkLumaColorFilter::Make(), outer = SkColorFilters::Matrix(tint_matrix);
...
DEF_SIMPLE_GM(composeCF, canvas, 200, 200)
{
    ...
    paint.setShader(SkGradientShader::MakeSweep(50, 50, gradient_colors, nullptr, std::size(gradient_colors)));
