...
protected:
    ...
    void onDraw(SkCanvas* canvas) override
    {
        ...
        sk_sp<SkImageFilter> filters[] = {
            ...
            SkImageFilters::DropShadow(SkIntToScalar(10), SkIntToScalar(10), SkIntToScalar(3), SkIntToScalar(3), SK_ColorGREEN, nullptr),
            SkImageFilters::DisplacementMap(SkColorChannel::kR, SkColorChannel::kR, SkIntToScalar(12), std::move(gradient), checkerboard),
            ...
            SkImageFilters::PointLitDiffuse(pointLocation, SK_ColorWHITE, SK_Scalar1, SkIntToScalar(2), checkerboard),
        ...
        sk_sp<SkImageFilter> rectFilter(SkImageFilters::Shader(SkPerlinNoiseShader::MakeFractalNoise(0.1f, 0.05f, 1, 0)));
