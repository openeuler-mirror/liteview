...
static void draw_gpu_only_message(SkCanvas* canvas)
{
    ...
    paint.setShader(bmp.makeShader(SkTileMode::kMirror, SkTileMode::kMirror, SkSamplingOptions(SkFilterMode::kLinear, SkMipmapMode::kNearest), localM));
...
SkISize SimpleGM::onISize()
{
    return fSize;
}
SkString SimpleGM::onShortName()
{
    return fName;
}
...
SkISize SimpleGpuGM::onISize()
{
    return fSize;
}
SkString SimpleGpuGM::onShortName()
{
    return fName;
}
...
bool GM::onAnimate(double /*nanos*/)
{
    return false;
}
