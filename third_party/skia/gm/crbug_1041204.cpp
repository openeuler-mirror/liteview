...
DEF_SIMPLE_GM(crbug_10141204, canvas, 512, 512)
{
    ...
    canvas->concat(SkMatrix::MakeAll(-0.0005550860255665798f, -0.0030798374421905717f, -0.014111959825129805f, -0.07569627776417084f, 232.00000000000017f,
        39.999999999999936f, 0.f, 0.f, 1.f));
