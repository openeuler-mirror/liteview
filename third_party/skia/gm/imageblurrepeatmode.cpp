...
static sk_sp<SkImage> make_image(SkCanvas* canvas, int direction)
{
    ...
    const SkColor colors[] = { SK_ColorRED, SK_ColorBLUE, SK_ColorGREEN, SK_ColorYELLOW, SK_ColorBLACK };
...
DEF_SIMPLE_GM(imageblurrepeatunclipped, canvas, 256, 128)
{
    ...
    auto checkerboard = ToolUtils::create_checkerboard_image(256, 128, SK_ColorLTGRAY, SK_ColorGRAY, 8);
