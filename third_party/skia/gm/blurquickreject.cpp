...
protected:
    ...
    void onDraw(SkCanvas* canvas) override
    {
        ...
        SkRect blurRects[] = { { -kBoxSize - (kBlurRadius + 1), 0, -(kBlurRadius + 1), kBoxSize },
            { 0, -kBoxSize - (kBlurRadius + 1), kBoxSize, -(kBlurRadius + 1) }, { kBoxSize + kBlurRadius + 1, 0, 2 * kBoxSize + kBlurRadius + 1, kBoxSize },
        ...
        SkPaint blurPaint;
        blurPaint.setMaskFilter(SkMaskFilter::MakeBlur(kNormal_SkBlurStyle, SkBlurMask::ConvertRadiusToSigma(kBlurRadius)));
