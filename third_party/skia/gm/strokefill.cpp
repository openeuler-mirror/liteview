...
static void show_bold(SkCanvas* canvas, const char* text, SkScalar x, SkScalar y, const SkPaint& paint, const SkFont& font)
{
...
static void path_bold(SkCanvas* canvas, const SkPath& path, const SkPaint& paint, float textSize)
{
    ...
    set_strokeandfill(&p);
    SkScalar fakeBoldScale = SkScalarInterpFunc(textSize, kStdFakeBoldInterpKeys, kStdFakeBoldInterpValues, kStdFakeBoldInterpLength);
...
DEF_SIMPLE_GM_BG_NAME(strokefill, canvas, 640, 480, SK_ColorWHITE, SkString("stroke-fill"))
{
    ...
    SkRect r = SkRect::MakeXYWH(x - SkIntToScalar(50), y + SkIntToScalar(280), SkIntToScalar(100), SkIntToScalar(100));
    SkPath path3;
    ...
    r = SkRect::MakeXYWH(x + SkIntToScalar(70), y + SkIntToScalar(280), SkIntToScalar(100), SkIntToScalar(100));
    SkPath path4;
    ...
    r = SkRect::MakeXYWH(x + SkIntToScalar(190), y + SkIntToScalar(280), SkIntToScalar(100), SkIntToScalar(100));
    path4.reset();
    ...
    r = SkRect::MakeXYWH(x + SkIntToScalar(310), y + SkIntToScalar(280), SkIntToScalar(100), SkIntToScalar(100));
    path4.reset();
    SkASSERT(SkPathPriv::ComputeFirstDirection(path4) == SkPathFirstDirection::kUnknown);
    path4.addRect(r, SkPathDirection::kCW);
