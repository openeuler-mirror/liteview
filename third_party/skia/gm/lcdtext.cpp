...
class LcdTextGM : public skiagm::GM {
    ...
    void drawText(SkCanvas* canvas, const SkString& string, bool subpixelTextEnabled, bool lcdRenderTextEnabled)
    {
        SkPaint paint;
...
class SaveLayerPreserveLCDTextGM : public skiagm::GM {
    ...
    SkString onShortName() override
    {
        return SkString("savelayerpreservelcdtext");
    }
    ...
    void onDraw(SkCanvas* canvas) override
    {
        drawText(canvas, SkString("SaveLayer PreserveLCDText"), 50, SkCanvas::kPreserveLCDText_SaveLayerFlag);
        drawText(canvas, SkString("SaveLayer Default (LCDText not preserved)"), 150, 0);
    }

    void drawText(SkCanvas* canvas, const SkString& string, int y, SkCanvas::SaveLayerFlags saveLayerFlags)
    {
