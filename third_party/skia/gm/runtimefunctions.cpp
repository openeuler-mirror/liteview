...
class RuntimeFunctions : public skiagm::GM {
    ...
    {
        return SkString("runtimefunctions");
    }
    ...
    {
        SkRuntimeEffect::Result result = SkRuntimeEffect::MakeForShader(SkString(RUNTIME_FUNCTIONS_SRC));
        ...
        auto shader = result.effect->makeShader(SkData::MakeWithCopy(&iResolution, sizeof(iResolution)), nullptr, 0, &localM);
        SkPaint p;
