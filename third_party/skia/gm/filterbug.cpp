...
protected:
    ...
    {
        return SkString("filterbug");
    }

    SkISize onISize() override
    {
        return SkISize::Make(150, 150);
    }
    ...
    void onDraw(SkCanvas* canvas) override
    {
...

        {
            ...
            p1.setShader(fTop->makeShader(SkTileMode::kRepeat, SkTileMode::kRepeat, kSampling, &localMat));
...

        {
            ...
            p3.setShader(fBot->makeShader(SkTileMode::kRepeat, SkTileMode::kRepeat, kSampling, &localMat));
