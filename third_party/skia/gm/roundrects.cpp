...
protected:
    ...
    void onDraw(SkCanvas* canvas) override
    {
        ...
        for (int i = 0; i < fPaints.count(); ++i) {
            ...
            canvas->save();
            // position the roundrect, and make it at off-integer coords.
            canvas->translate(kXStart + SK_Scalar1 * kXStep * 2.55f + SK_Scalar1 / 4, kYStart + SK_Scalar1 * kYStep * i + 3 * SK_Scalar1 / 4);
        ...
        for (int i = 0; i < fPaints.count(); ++i) {
            ...
            // position the roundrect, and make it at off-integer coords.
            canvas->translate(
                kXStart + SK_Scalar1 * kXStep * 4 + SK_Scalar1 / 4, kYStart + SK_Scalar1 * kYStep * i + 3 * SK_Scalar1 / 4 + SK_ScalarHalf * kYStep);
        ...
        for (int i = 0; i < fPaints.count(); ++i) {
            ...
            canvas->save();
            // position the roundrect, and make it at off-integer coords.
            canvas->translate(kXStart + SK_Scalar1 * kXStep * 3.25f + SK_Scalar1 / 4, kYStart + SK_Scalar1 * kYStep * i + 3 * SK_Scalar1 / 4);
        ...
        for (int i = 0; i < fPaints.count(); ++i) {
            ...
            // position the roundrect, and make it at off-integer coords.
            canvas->translate(
                kXStart + SK_Scalar1 * kXStep * 2.5f + SK_Scalar1 / 4, kYStart + SK_Scalar1 * kYStep * i + 3 * SK_Scalar1 / 4 + SK_ScalarHalf * kYStep);
        ...
        auto shader = SkGradientShader::MakeRadial(center, 20, colors, pos, std::size(colors), SkTileMode::kClamp);

        for (int i = 0; i < fPaints.count(); ++i) {
            canvas->save();
            // position the path, and make it at off-integer coords.
            canvas->translate(
                kXStart + SK_Scalar1 * kXStep * 0 + SK_Scalar1 / 4, kYStart + SK_Scalar1 * kYStep * i + 3 * SK_Scalar1 / 4 + SK_ScalarHalf * kYStep);
        ...
        // strokes and radii
        {
            ...
            for (int i = 0; i < 4; ++i) {
                ...
                // position the roundrect, and make it at off-integer coords.
                canvas->translate(
                    kXStart + SK_Scalar1 * kXStep * 5 + SK_Scalar1 / 4, kYStart + SK_Scalar1 * kYStep * i + 3 * SK_Scalar1 / 4 + SK_ScalarHalf * kYStep);
        ...
        // test old entry point ( https://bug.skia.org/3786 )
        {
            ...
            canvas->translate(kXStart + SK_Scalar1 * kXStep * 5 + SK_Scalar1 / 4, kYStart + SK_Scalar1 * kYStep * 4 + SK_Scalar1 / 4 + SK_ScalarHalf * kYStep);
        ...
        // rrect with stroke > radius/2
        {
            ...
            canvas->save();
            // position the roundrect, and make it at off-integer coords.
            canvas->translate(kXStart + SK_Scalar1 * kXStep * 5 + SK_Scalar1 / 4, kYStart - SK_Scalar1 * kYStep + 73 * SK_Scalar1 / 4 + SK_ScalarHalf * kYStep);
