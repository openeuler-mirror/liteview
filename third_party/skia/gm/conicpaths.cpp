...
DEF_SIMPLE_GM(arccirclegap, canvas, 250, 250)
{
    ...
    SkPath path = SkPathBuilder().moveTo(288.88884710654133f, -280.26680862609f).arcTo({ 0, 0 }, { -39.00216443306411f, 400.6058925796476f }, radius).detach();
...
DEF_SIMPLE_GM(crbug_640176, canvas, 250, 250)
{
    ...
    path.conicTo(SkBits2Float(0x42f00000), SkBits2Float(0xc2009d9c), SkBits2Float(0x42f00001), SkBits2Float(0x00000000),
