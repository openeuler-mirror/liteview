...
DEF_SIMPLE_GM(crbug_1162942, canvas, 620, 200)
{
    ...
    SkMatrix ctm = SkMatrix::MakeAll(SkBits2Float(0x3FCC7F75), SkBits2Float(0x3D5784FC), SkBits2Float(0x44C48C99), SkBits2Float(0x3F699F7F),
        SkBits2Float(0x3E0A0D37), SkBits2Float(0x43908518), SkBits2Float(0x3AA17423), SkBits2Float(0x3A6CCDC3), SkBits2Float(0x3F2EFEEC));
    ctm.postTranslate(-1500.f, -325.f);

    SkPoint pts[4] = { { SkBits2Float(0x3F39778B), SkBits2Float(0x43FF7FFC) }, { SkBits2Float(0x0), SkBits2Float(0x43FF7FFA) },
        { SkBits2Float(0xB83B055E), SkBits2Float(0x42500003) }, { SkBits2Float(0x3F39776F), SkBits2Float(0x4250000D) } };
    SkRect bounds;
