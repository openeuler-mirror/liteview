...
protected:
    ...
    sk_sp<SkImageFilter> makeFilter(const SkIPoint& kernelOffset, SkTileMode tileMode, bool convolveAlpha, const SkIRect* cropRect = nullptr)
    {
        ...
        case kBasic_KernelFixture: {
            ...
            return SkImageFilters::MatrixConvolution(
                { 3, 3 }, kernel.data(), /* gain */ 0.3f, /* bias */ SkIntToScalar(100), kernelOffset, tileMode, convolveAlpha, nullptr, cropRect);
        }
        case kLarge_KernelFixture: {
            ...
            return SkImageFilters::MatrixConvolution(
                { 7, 7 }, kernel.data(), /* gain */ 0.3f, /* bias */ SkIntToScalar(100), kernelOffset, tileMode, convolveAlpha, nullptr, cropRect);
        }
        default:
            return nullptr;
        }
