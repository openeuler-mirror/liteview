...
protected:
    ...
    void onDraw(SkCanvas* canvas) override
    {
        ...
        for (SkBlendMode mode : { SkBlendMode::kPlus /* add */, SkBlendMode::kClear, SkBlendMode::kDarken, SkBlendMode::kDst, SkBlendMode::kDstATop,
                 SkBlendMode::kDstIn, SkBlendMode::kDstOut, SkBlendMode::kDstOver, SkBlendMode::kLighten, SkBlendMode::kModulate /* multiply */,
                 SkBlendMode::kOverlay, SkBlendMode::kScreen, SkBlendMode::kSrc, SkBlendMode::kSrcATop, SkBlendMode::kSrcIn, SkBlendMode::kSrcOut,
            ...
            SkTextUtils::DrawString(
                canvas, SkBlendMode_Name(mode), xOffset + kBitmapSize / 2.0f, yOffset + kBitmapSize, font, SkPaint(), SkTextUtils::kCenter_Align);
