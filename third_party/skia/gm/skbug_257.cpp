...
DEF_SIMPLE_GM(skbug_257, canvas, 512, 512)
{
    ...
    canvas->scale(scale, scale);
    {
        ...
        SkPoint points[8] = { { size / 2, 8 + translate }, { size / 2, 8 + translate + delta }, { 8, size / 2 + translate },
            { 8, size / 2 + translate + delta }, { size / 2, size - 8 + translate }, { size / 2, size - 8 + translate + delta },
