...
class FontRegenGM : public skiagm::GM {
    ...
    void onOnceBeforeDraw() override
    {
        ...
        static const SkString kTexts[] = { SkString("abcdefghijklmnopqrstuvwxyz"), SkString("ABCDEFGHI"), SkString("NOPQRSTUV") };
