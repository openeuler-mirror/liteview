...
protected:
    ...
    void onDraw(SkCanvas* canvas) override
    {
        ...
        SkPoint3 spotLocation = SkPoint3::Make(SkIntToScalar(-10), SkIntToScalar(-10), SkIntToScalar(20));
        ...
        sk_sp<SkImageFilter> filters[] = {
            ...
            SkImageFilters::Shader(SkPerlinNoiseShader::MakeFractalNoise(SkDoubleToScalar(0.1), SkDoubleToScalar(0.05), 1, 0)),
            SkImageFilters::PointLitDiffuse(pointLocation, white, surfaceScale, kd, nullptr),
            SkImageFilters::SpotLitDiffuse(spotLocation, spotTarget, spotExponent, cutoffAngle, white, surfaceScale, kd, nullptr),
        };
