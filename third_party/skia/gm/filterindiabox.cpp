...
static void draw_cell(SkCanvas* canvas, const SkBitmap& bm, const SkMatrix& mat, SkScalar dx, const SkSamplingOptions& sampling)
{
...
static void draw_row(SkCanvas* canvas, const SkBitmap& bm, const SkMatrix& mat, SkScalar dx)
{
    ...
    draw_cell(canvas, bm, mat, 2 * dx, SkSamplingOptions(SkFilterMode::kLinear, SkMipmapMode::kLinear));
...
class FilterIndiaBoxGM : public skiagm::GM {
    ...
    {
        return SkString("filterindiabox");
    }
