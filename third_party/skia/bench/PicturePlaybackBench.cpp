...
public:
    ...
    {
        return SkIPoint::Make(1024, 1024);
    }
    ...
    void onDelayedSetup() override
    {
        ...
        case kNone:
            break;
        case kRTree:
            factory = std::make_unique<SkRTreeFactory>();
            break;
        }
        ...
        for (int i = 0; i < 10000; i++) {
            SkScalar x = rand.nextRangeScalar(0, 1024), y = rand.nextRangeScalar(0, 1024), w = rand.nextRangeScalar(0, 128), h = rand.nextRangeScalar(0, 128);
            SkPaint paint;
