...
static SkSurfaceCharacterization create_characterization(GrDirectContext* direct)
{
    ...
    GrBackendFormat backendFormat = direct->defaultBackendFormat(kRGBA_8888_SkColorType, GrRenderable::kYes);
    ...
    SkSurfaceCharacterization c
        = direct->threadSafeProxy()->createCharacterization(maxResourceBytes, ii, backendFormat, 1, kTopLeft_GrSurfaceOrigin, props, false);
    return c;
}
