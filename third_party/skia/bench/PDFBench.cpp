...
struct PDFShaderBench : public Benchmark {
    ...
    bool isSuitableFor(Backend b) final
    {
        return b == kNonRendering_Backend;
    }
...
SkBitmap make_background()
{
    ...
    SkPaint shader;
    shader.setShader(SkShader::MakeBitmapShader(bitmap, SkShader::kRepeat_TileMode, SkShader::kRepeat_TileMode));
