...
public:
    CreateBackendTextureBench(GrMipmapped mipmapped)
...
private:
    ...
    void onDraw(int loops, SkCanvas* canvas) override
    {
        ...
        for (int i = 0; i < loops; ++i) {
            fBackendTextures.push_back(context->createBackendTexture(kSize, kSize, kRGBA_8888_SkColorType, SkColors::kRed, fMipmapped, GrRenderable::kNo,
                GrProtected::kNo, nullptr, nullptr,
