    ...
    void onDraw(int loops, SkCanvas* canvas) override
    {
        ...
        while (loops > 0) {
            ...
            case kText: {
                ...
                SkScalar x = random.nextRangeScalar(0, (SkScalar)size.fWidth), y = random.nextRangeScalar(0, (SkScalar)size.fHeight);
            ...
            case kRect: {
                ...
                SkRect rect = SkRect::MakeXYWH(random.nextUScalar1() * (size.fWidth - w), random.nextUScalar1() * (size.fHeight - h), w, h);
                int iterations = std::min(1000, loops);
                for (int j = 0; j < iterations; ++j) {
