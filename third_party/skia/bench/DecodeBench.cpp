...
public:
    ...
    {
        while (loops-- > 0) {
            const auto anim = skottie::Animation::Make(reinterpret_cast<const char*>(fData->data()), fData->size());
        }
    }
...
DEF_BENCH(
    return new SkottieDecodeBench("skottie_phonehub_svgo_no_frills_generic_error_min.json", "skottie/skottie-phonehub-svgo-no-frills-generic-error_min.json"));
...
DEF_BENCH(
    return new SkottiePictureDecodeBench("skottiepic_phonehub_svgo_no_frills_connecting.json", "skottie/skottie-phonehub-svgo-no-frills-connecting.json"));
DEF_BENCH(return new SkottiePictureDecodeBench(
    "skottiepic_phonehub_svgo_no_frills_generic_error.json", "skottie/skottie-phonehub-svgo-no-frills-generic-error.json"));
...
DEF_BENCH(return new SkottiePictureDecodeBench(
    "skottiepic_phonehub_svgo_no_masks_connecting_min.json", "skottie/skottie-phonehub-svgo-no-masks-connecting_min.json"));
DEF_BENCH(
    return new SkottiePictureDecodeBench("skottiepic_phonehub_svgo_no_masks_onboard_min.json", "skottie/skottie-phonehub-svgo-no-masks-onboard_min.json"));
DEF_BENCH(return new SkottiePictureDecodeBench(
    "skottiepic_phonehub_svgo_no_frills_connecting_min.json", "skottie/skottie-phonehub-svgo-no-frills-connecting_min.json"));
DEF_BENCH(return new SkottiePictureDecodeBench(
    "skottiepic_phonehub_svgo_no_frills_generic_error_min.json", "skottie/skottie-phonehub-svgo-no-frills-generic-error_min.json"));
DEF_BENCH(
    return new SkottiePictureDecodeBench("skottiepic_phonehub_svgo_no_frills_onboard_min.json", "skottie/skottie-phonehub-svgo-no-frills-onboard_min.json"));
