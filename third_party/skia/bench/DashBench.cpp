...
static void make_cubic(SkPath* path)
{
    ...
    SkScalar y0 = SkIntToScalar(10);
    path->moveTo(x0, y0);
    path->cubicTo(x0, y0 + 400 * SK_Scalar1, x0 + 600 * SK_Scalar1, y0 + 400 * SK_Scalar1, x0 + 600 * SK_Scalar1, y0);
}
...
protected:
    ...
    void onDraw(int loops, SkCanvas* canvas) override
    {
        ...
        SkPoint pts[4] = { { SkIntToScalar(0), 20.5f }, { SkIntToScalar(20), 20.5f }, { 20.5f, SkIntToScalar(0) }, { 20.5f, SkIntToScalar(20) } };
