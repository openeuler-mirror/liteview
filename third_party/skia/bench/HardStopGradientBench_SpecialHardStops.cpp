...
public:
    ...
    void onPreDraw(SkCanvas* canvas) override
    {
        ...
        SkScalar* positions = fKind == Kind::k001 ? pos_001 : fKind == Kind::k011 ? pos_011 : pos_centered;

        int count = fKind == Kind::kCentered ? 4 : 3;

        fPaint.setShader(SkGradientShader::MakeLinear(points, colors, positions, count, SkTileMode::kClamp, 0, nullptr));
    }
