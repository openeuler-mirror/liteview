...
static const char* atext[] = { "Call me Ishmael.  Some years ago--never mind how",
    ...
    "regulating the circulation.  Whenever I find myself growing grim about the", "mouth; whenever it is a damp, drizzly November in my soul; whenever I find",
    "myself involuntarily pausing before coffin warehouses, and bringing up the", "rear of every funeral I meet; and especially whenever my hypos get such an",
    ...
    "This is my substitute for pistol and ball.  With a philosophical flourish", "Cato throws himself upon his sword; I quietly take to the ship.  There is",
    ...
    "Right and left, the streets take you waterward.  Its extreme down-town is", "the battery, where that noble mole is washed by waves, and cooled by",
    "breezes, which a few hours previous were out of sight of land.  Look at the", "crowds of water-gazers there.  Circumambulate the city of a dreamy Sabbath",
    "afternoon.  Go from Corlears Hook to Coenties Slip, and from thence, by", "Whitehall northward.  What do you see?--Posted like silent sentinels all",
    "around the town, stand thousands upon thousands of mortal men fixed in ocean",
    "reveries.  Some leaning against the spiles; some seated upon the pier-heads;", "some looking over the bulwarks glasses!",
    ...
    "a dive.  Strange!  Nothing will content them but the extremest limit of the", "land; loitering under the shady lee of yonder warehouses will not suffice.",
    ...
    "the compasses of all those ships attract them thither?  Once more.  Say, you", "are in the country; in some high land of lakes.  Take almost any path you",
    "please, and ten to one it carries you down in a dale, and leaves you there", "by a pool in the stream.  There is magic in it.  Let the most absent-minded",
    ...
    "But here is an artist.  He desires to paint you the dreamiest, shadiest,", "quietest, most enchanting bit of romantic landscape in all the valley of the",
    "Saco.  What is the chief element he employs?  There stand his trees, each with",
    "a hollow trunk, as if a hermit and a crucifix were within; and here sleeps", "his meadow, and there sleep his cattle; and up from yonder cottage goes a",
    "sleepy smoke.  Deep into distant woodlands winds a mazy way, reaching to", "overlapping spurs of mountains bathed in their hill-side blue.  But though",
    "the picture lies thus tranced, and though this pine-tree shakes down its sighs", "like leaves upon this shepherd's head, yet all were vain, unless the",
    "shepherd's eye were fixed upon the magic stream before him.  Go visit the", "Prairies in June,", "",
    ...
    "robust healthy boy with a robust healthy soul in him, at some time or other", "crazy to go to sea?  Why upon your first voyage as a passenger, did you",
    "yourself feel such a mystical vibration, when first told that you and your", "ship were now out of sight of land?  Why did the old Persians hold the sea",
    ...
    "story of Narcissus, who because he could not grasp the tormenting, mild image", "he saw in the fountain, plunged into it and was drowned.  But that same",
    "image, we ourselves see in all rivers and oceans.  It is the image of the", "ungraspable phantom of life; and this is the key to it all.  Now, when I say",
    ...
    "passenger; nor, though I am something of a salt, do I ever go to sea as a", "Commodore, or a Captain, or a Cook.  I abandon the glory and distinction of",
    "such offices to those who like them.  For my part, I abominate all honorable",
    "respectable toils, trials, and tribulations of every kind whatsoever.  It is", "quite as much as I can do to take care of myself, without taking care of",
    ...
    "sailor, right before the mast, plumb down into the forecastle, aloft there", "to the royal mast-head.  True, they rather order me about some, and make me",
    "jump from spar to spar, like a grasshopper in a May meadow.  And at first,", "this sort of thing is unpleasant enough.  It touches one's sense of honor,",
    "particularly if you come of an old established family in the land, the van", "Rensselaers, or Randolphs, or Hardicanutes.  And more than all, if just",
    "previous to putting your hand into the tar-pot, you have been lording it as a", "country schoolmaster, making the tallest boys stand in awe of you.  The",
    ...
    "of a sea-captain orders me to get a broom and sweep down the decks?  What does", "that indignity amount to, weighed, I mean, in the scales of the New",
    "Testament?  Do you think the archangel Gabriel thinks anything the less of me,",
    "because I promptly and respectfully obey that old hunks in that particular", "instance?  Who aint a slave?  Tell me that.  Well, then, however the old",
    "sea-captains may order me about--however they may thump and punch me about, I",
    "have the satisfaction of knowing that it is all right; that everybody else", "is one way or other served in much the same way -- either in a physical or",
    "metaphysical point of view, that is; and so the universal thump is passed", "round, and all hands should rub each other's shoulder-blades, and be",
    ...
    "there is all the difference in the world between paying and being paid.  The", "act of paying is perhaps the most uncomfortable infliction that the two",
    "orchard thieves entailed upon us." };

static const char* ctext[] = { "第一回", "胡秀才告狀鳴冤　施賢臣得夢訪案", "", "　　話說江都縣有一秀才，姓胡，名登舉。他的父母為人所殺，頭顱不見。胡登舉合家",
    "嚇得膽裂魂飛，慌忙出門，去稟縣主。", "", "　　跑到縣衙，正遇升堂，就進去喊冤。走至堂上，打了一躬，手舉呈詞，口稱：「父",
    ...
    "，並沒蹤影。生忝居學校，父母如此死法，何以身列校庠對雙親而無愧乎？為此具呈，", "嚎叩老父師大人恩准，速賜拿獲兇手，庶生冤仇得雪。感戴無既。沾仁。上呈。",
    "", "　　施公看罷，不由點頭，暗暗吃驚，想道：「夤夜入院，非奸即盜。胡翰林夫婦年老",
    "被殺，而不竊去財物，且將人頭拿去，其中情由，顯係仇謀。此宗無題文章，令人如何",
    "做法？」為難良久，說道：「即委捕廳四老爺，前去驗屍。你只管入殮，自有頭緒結斷", "。」胡秀才一聽，只得含淚下堂，出衙回家，伺候驗屍。", "",
    ...
    "個小豬為題出簽差人，說：「限你二人五日之期，將九黃、七豬拿來，如若遲延，重責", "不饒。」將簽遞於二人。二人跪趴半步，口稱：「老爺容稟：小的們請個示來。",
    ...
    "久慣應役，極會搪塞，如敢再行囉唣，定加重責！」二人聞言，萬分無奈，站起退下去", "，訪拿九黃、七豬而去。施公也隨退堂。", "",
    ...
    "舉打躬下堂，出衙回家。且說施公為難多會，方要提胡宅管家的審問，只見公差英公然", "、張子仁上堂，跪下回稟：「小的二人，並訪不著九黃、七豬，求老爺寬限。」",
    ...
    "！老爺進去了，還求那個？」二人聞言，抬頭不看見老爺，忍氣站起，腿帶棒傷，身形", "晃亂。旁邊上來四個人，用手挽架下堂。" };
    ...
    void onDraw(int loops, SkCanvas* canvas) override
    {
        ...
        for (int i = 0; i < loops * 3; ++i) {
            for (auto& line : fLines) {
                font.textToGlyphs(line->utf.data(), line->utf.size(), fEncoding, fGlyphIds.data(), line->glyphCount);
            }
        }
    }
...
DEF_BENCH(return new UtfToGlyph(SkTextEncoding::kUTF32, ctext, std::size(ctext), "SkTypefaceUTF32ToGlyphCN");)
DEF_BENCH(return new UtfToGlyph(SkTextEncoding::kUTF16, ctext, std::size(ctext), "SkTypefaceUTF16ToGlyphCN");)
DEF_BENCH(return new UtfToGlyph(SkTextEncoding::kUTF8, ctext, std::size(ctext), "SkTypefaceUTF8ToGlyphCN");)

DEF_BENCH(return new UtfToGlyph(SkTextEncoding::kUTF32, atext, std::size(atext), "SkTypefaceUTF32ToGlyphAscii");)
DEF_BENCH(return new UtfToGlyph(SkTextEncoding::kUTF16, atext, std::size(atext), "SkTypefaceUTF16ToGlyphAscii");)
DEF_BENCH(return new UtfToGlyph(SkTextEncoding::kUTF8, atext, std::size(atext), "SkTypefaceUTF8ToGlyphAscii");)
