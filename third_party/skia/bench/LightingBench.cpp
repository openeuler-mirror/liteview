...
protected:
    ...
    static SkPoint3 GetDistantDirection()
    {
        ...
        static SkPoint3 distantDirection = SkPoint3::Make(
            SkScalarCos(azimuthRad) * SkScalarCos(elevationRad), SkScalarSin(azimuthRad) * SkScalarCos(elevationRad), SkScalarSin(elevationRad));
        return distantDirection;
    }

    static SkPoint3 GetSpotLocation()
    {
        static SkPoint3 spotLocation = SkPoint3::Make(SkIntToScalar(-10), SkIntToScalar(-10), SkIntToScalar(20));
        return spotLocation;
    }
...
protected:
    ...
    {
        draw(loops, canvas, SkImageFilters::PointLitDiffuse(GetPointLocation(), GetWhite(), GetSurfaceScale(), GetKd(), nullptr));
    }
...
protected:
    ...
    void onDraw(int loops, SkCanvas* canvas) override
    {
        draw(loops, canvas, SkImageFilters::DistantLitDiffuse(GetDistantDirection(), GetWhite(), GetSurfaceScale(), GetKd(), nullptr));
    }
    ...
    void onDraw(int loops, SkCanvas* canvas) override
    {
        draw(loops, canvas,
            SkImageFilters::SpotLitDiffuse(
                GetSpotLocation(), GetSpotTarget(), GetSpotExponent(), GetCutoffAngle(), GetWhite(), GetSurfaceScale(), GetKd(), nullptr));
    }
...
protected:
    ...
    void onDraw(int loops, SkCanvas* canvas) override
    {
        draw(loops, canvas, SkImageFilters::PointLitSpecular(GetPointLocation(), GetWhite(), GetSurfaceScale(), GetKs(), GetShininess(), nullptr));
    }
...
protected:
    ...
    void onDraw(int loops, SkCanvas* canvas) override
    {
        draw(loops, canvas, SkImageFilters::DistantLitSpecular(GetDistantDirection(), GetWhite(), GetSurfaceScale(), GetKs(), GetShininess(), nullptr));
    }
    ...
    void onDraw(int loops, SkCanvas* canvas) override
    {
        draw(loops, canvas,
            SkImageFilters::SpotLitSpecular(
                GetSpotLocation(), GetSpotTarget(), GetSpotExponent(), GetCutoffAngle(), GetWhite(), GetSurfaceScale(), GetKs(), GetShininess(), nullptr));
    }
