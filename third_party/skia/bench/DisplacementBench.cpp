...
protected:
    ...
    void onDraw(int loops, SkCanvas* canvas) override
    {
        ...
        paint.setImageFilter(SkImageFilters::DisplacementMap(SkColorChannel::kR, SkColorChannel::kG, 0.0f, std::move(displ), nullptr));
...
protected:
    ...
    void onDraw(int loops, SkCanvas* canvas) override
    {
        ...
        paint.setImageFilter(SkImageFilters::DisplacementMap(SkColorChannel::kB, SkColorChannel::kA, 16.0f, std::move(displ), nullptr));
        for (int i = 0; i < loops; i++) {
...
protected:
    ...
    void onDraw(int loops, SkCanvas* canvas) override
    {
        ...
        paint.setImageFilter(SkImageFilters::DisplacementMap(SkColorChannel::kR, SkColorChannel::kB, 32.0f, std::move(displ), nullptr));
        for (int i = 0; i < loops; ++i) {
