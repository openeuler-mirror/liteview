...
static const SkColor gColors[] = {
    SK_ColorRED, SK_ColorGREEN, SK_ColorBLUE, SK_ColorWHITE, SK_ColorBLACK, SK_ColorRED, SK_ColorGREEN, SK_ColorBLUE, SK_ColorWHITE, SK_ColorBLACK, SK_ColorRED,
    SK_ColorGREEN, SK_ColorBLUE, SK_ColorWHITE, SK_ColorBLACK, SK_ColorRED, SK_ColorGREEN, SK_ColorBLUE, SK_ColorWHITE, SK_ColorBLACK, SK_ColorRED,
    SK_ColorGREEN, SK_ColorBLUE, SK_ColorWHITE, SK_ColorBLACK, SK_ColorRED, SK_ColorGREEN, SK_ColorBLUE, SK_ColorWHITE, SK_ColorBLACK, SK_ColorRED,
    SK_ColorGREEN, SK_ColorBLUE, SK_ColorWHITE, SK_ColorBLACK, SK_ColorRED, SK_ColorGREEN, SK_ColorBLUE, SK_ColorWHITE, SK_ColorBLACK, SK_ColorRED,
    SK_ColorGREEN, SK_ColorBLUE, SK_ColorWHITE, SK_ColorBLACK, SK_ColorRED, SK_ColorGREEN, SK_ColorBLUE, SK_ColorWHITE, SK_ColorBLACK, // 10 lines, 50 colors
};
...
static sk_sp<SkShader> MakeRadial(const SkPoint pts[2], const GradData& data, SkTileMode tm, float scale)
{
    ...
    return SkGradientShader::MakeRadial(center, center.fX * scale, data.fColors, data.fPos, data.fCount, tm);
}
...
static sk_sp<SkShader> MakeConicalZeroRad(const SkPoint pts[2], const GradData& data, SkTileMode tm, float scale)
{
    ...
    center0.set(SkScalarAve(pts[0].fX, pts[1].fX), SkScalarAve(pts[0].fY, pts[1].fY));
    center1.set(SkScalarInterp(pts[0].fX, pts[1].fX, SkIntToScalar(3) / 5), SkScalarInterp(pts[0].fY, pts[1].fY, SkIntToScalar(1) / 4));
    return SkGradientShader::MakeTwoPointConical(center1, 0.0, center0, (pts[1].fX - pts[0].fX) / 2, data.fColors, data.fPos, data.fCount, tm);
}
...
static sk_sp<SkShader> MakeConicalOutside(const SkPoint pts[2], const GradData& data, SkTileMode tm, float scale)
{
    ...
    return SkGradientShader::MakeTwoPointConical(center0, radius0, center1, radius1, data.fColors, data.fPos, data.fCount, tm);
}
...
static sk_sp<SkShader> MakeConicalOutsideZeroRad(const SkPoint pts[2], const GradData& data, SkTileMode tm, float scale)
{
    ...
    center0.set(pts[0].fX + radius0, pts[0].fY + radius0);
    center1.set(pts[1].fX - radius1, pts[1].fY - radius1);
    return SkGradientShader::MakeTwoPointConical(center0, 0.0, center1, radius1, data.fColors, data.fPos, data.fCount, tm);
}
...
protected:
    ...
    void onDraw(int loops, SkCanvas* canvas) override
    {
        ...
        for (int i = 0; i < loops; i++) {
            ...
            paint.setShader(SkGradientShader::MakeLinear(pts, colors, nullptr, std::size(colors), SkTileMode::kClamp));
