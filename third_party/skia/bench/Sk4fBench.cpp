...
template <typename T> struct Sk4fRoundtripBench : public Benchmark {
    Sk4fRoundtripBench()
    {
    }
...
struct Sk4fGradientBench : public Benchmark {
    ...
    {
        skvx::float4 c0(0, 0, 255, 255), c1(255, 0, 0, 255), dc = c1 - c0, fx(0.1f), dx(0.002f), dcdx(dc * dx), dcdx4(dcdx + dcdx + dcdx + dcdx);
