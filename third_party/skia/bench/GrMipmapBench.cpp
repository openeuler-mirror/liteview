...
protected:
    ...
    void onDraw(int loops, SkCanvas* canvas) override
    {
        if (!fSurface) {
            ...
            SkImageInfo info = SkImageInfo::Make(fW, fH, kRGBA_8888_SkColorType, kPremul_SkAlphaType, srgb);
            ...
            fSurface = SkSurface::MakeRenderTarget(context, SkBudgeted::kNo, info, 0, kBottomLeft_GrSurfaceOrigin, nullptr, true);
        }
