...
public:
    ...
    LogicalRunType getRunType() const
    {
        return fRunType;
    }
    void setRunType(LogicalRunType runType)
    {
        fRunType = runType;
    }

    template <typename Callback> void forEachCluster(Callback&& callback)
    {
        GlyphIndex glyph = 0;
    ...
    template <typename Callback> void convertUtf16Range(Callback&& callback)
    {
    ...
    template <typename Callback> void convertClusterIndexes(Callback&& callback)
    {
