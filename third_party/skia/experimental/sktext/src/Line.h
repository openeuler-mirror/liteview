...
public:
    ...
    SkScalar above() const
    {
        return -this->fAscent + this->fLeading / 2;
    }
    SkScalar below() const
    {
        return this->fDescent + this->fLeading / 2;
    }
...
public:
    GlyphPos()
        : fRunIndex(EMPTY_INDEX)
        , fGlyphIndex(EMPTY_INDEX)
    {
    }
...
public:
    ...
    void moveTo(Stretch& tail)
    {
        ...
        SkASSERT(this->fGlyphEnd.runIndex() != tail.fGlyphStart.runIndex() || this->fGlyphEnd.glyphIndex() == tail.fGlyphStart.glyphIndex());
        this->fGlyphEnd = tail.fGlyphEnd;
        this->fWidth += tail.fWidth;
    ...
    void setTextRange(TextRange range)
    {
        fTextRange = range;
    }
    ...
    GlyphPos glyphStart() const
    {
        return fGlyphStart;
    }
    GlyphPos glyphEnd() const
    {
        return fGlyphEnd;
    }
    size_t glyphStartIndex() const
    {
        return fGlyphStart.glyphIndex();
    }
    size_t textStart() const
    {
        return fTextRange.fStart;
    }
...
public:
    ...
    GlyphPos glyphTrailingEnd() const
    {
        return fWhitespacesEnd;
    }
    SkScalar width() const
    {
        return fTextWidth;
    }
    SkScalar withWithTrailingSpaces() const
    {
        return fTextWidth + fSpacesWidth;
    }
    SkScalar horizontalOffset() const
    {
        return fHorizontalOffset;
    }
    SkScalar verticalOffset() const
    {
        return fVerticalOffset;
    }
    SkScalar height() const
    {
        return fTextMetrics.height();
    }
    SkScalar baseline() const
    {
        return fTextMetrics.baseline();
    }
    TextRange text() const
    {
        return fText;
    }
    TextRange whitespaces() const
    {
        return fWhitespaces;
    }
    bool isHardLineBreak() const
    {
        return fHardLineBreak;
    }
