...
protected:
    ...
    {
        return SkString("TextSample_HelloWorld");
    }
...
protected:
    SkString name() override
    {
        return SkString("TextSample_Align_Dir");
    }

    void drawLine(SkCanvas* canvas, SkScalar w, SkScalar h, const std::u16string& text, TextAlign align, TextDirection direction = TextDirection::kLtr)
    {
        ...
        Paint::drawText(direction == TextDirection::kRtl ? mirror(text) : normal(text), canvas, direction, align, foregroundPaint, backgroundPaint,
            SkString("Roboto"), 12.0f, SkFontStyle::Normal(), 0, 0);
    }
...
protected:
    SkString name() override
    {
        return SkString("TextSample_LongLTR");
    }
...
protected:
    SkString name() override
    {
        return SkString("TextSample_LongRTL");
    }
...
protected:
    ...
    void onDrawContent(SkCanvas* canvas) override
    {
        canvas->drawColor(SK_ColorWHITE);
        std::u16string utf16(
            u"يَهْدِيْكُمُ اللَّهُ وَيُصْلِحُ بَالَكُمُيَهْدِيْكُمُ اللَّهُ وَيُصْلِحُ بَالَكُمُ يَهْدِيْكُمُ اللَّهُ وَيُصْلِحُ بَالَكُمُ يَهْدِيْكُمُ اللَّهُ وَيُصْلِحُ بَالَكُمُ يَهْدِيْكُمُ اللَّهُ وَيُصْلِحُ بَالَكُمُيَهْدِيْكُمُ اللَّهُ وَيُصْلِحُ بَالَكُمُ "
            u"يَهْدِيْكُمُ اللَّهُ وَيُصْلِحُ بَالَكُمُ يَهْدِيْكُمُ اللَّهُ وَيُصْلِحُ بَالَكُمُ");
        Paint::drawText(utf16, canvas, TextDirection::kRtl, TextAlign::kRight, SkPaint(SkColors::kBlack), SkPaint(SkColors::kLtGray),
            SkString("Noto Naskh Arabic"), 40.0f, SkFontStyle::Normal(), SkSize::Make(800, 800), 0, 0);
    }
