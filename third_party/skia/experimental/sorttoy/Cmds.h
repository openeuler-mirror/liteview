...
public:
    ...
    void dump() const override
    {
        SkDebugf("%d: draw%s %d %d %d %d -- %d", fID.toInt(), fShape == Shape::kRect ? "Rect" : "Oval", fRect.fLeft, fRect.fTop, fRect.fRight, fRect.fBottom,
...
public:
    ...
    void dump() const override
    {
        SkDebugf("%d: clip%s %d %d %d %d", fID.toInt(), fShape == Shape::kRect ? "Rect" : "Oval", fRect.fLeft, fRect.fTop, fRect.fRight, fRect.fBottom);
    }
    ...
    bool hasBeenMutated() const
    {
        return fHasBeenMutated;
    }
    SkIRect rect() const
    {
        return fRect;
