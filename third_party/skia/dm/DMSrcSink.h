...
struct Src {
    ...
    virtual Result SK_WARN_UNUSED_RESULT draw([[maybe_unused]] int page, GrDirectContext* context, SkCanvas* canvas) const
    {
...
struct Sink {
    ...
    virtual Result SK_WARN_UNUSED_RESULT draw(const Src&, SkBitmap*, SkWStream*, SkString* log) const = 0;
...
public:
    ...
    sk_gpu_test::GrContextFactory::ContextType contextType() const
    {
        return fContextType;
    }
