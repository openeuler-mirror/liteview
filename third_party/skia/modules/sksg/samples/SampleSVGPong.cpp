...
protected:
    void onOnceBeforeDraw() override
    {
        ...
        fContentMatrix = sksg::Matrix<SkMatrix>::Make(SkMatrix::RectToRect(SkRect::MakeWH(1, 1), SkRect::MakeIWH(this->width(), this->height())));
    ...
    {
        if (fContentMatrix) {
            fContentMatrix->setMatrix(SkMatrix::RectToRect(SkRect::MakeWH(1, 1), SkRect::MakeIWH(this->width(), this->height())));
        }
