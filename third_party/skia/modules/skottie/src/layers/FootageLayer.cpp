...
SkMatrix image_matrix(const ImageAsset::FrameData& frame_data, const SkISize& dest_size)
{
    ...
    return frame_data.matrix * SkMatrix::RectToRect(SkRect::Make(frame_data.image->bounds()), SkRect::Make(dest_size), SkMatrix::kCenter_ScaleToFit);
}
...
const AnimationBuilder::FootageAssetInfo* AnimationBuilder::loadFootageAsset(const skjson::ObjectValue& jimage) const
{
