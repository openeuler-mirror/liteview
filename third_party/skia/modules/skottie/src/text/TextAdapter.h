...
public:
    static sk_sp<TextAdapter> Make(const skjson::ObjectValue&, const AnimationBuilder*, sk_sp<SkFontMgr>, sk_sp<CustomFont::GlyphCompMapper>, sk_sp<Logger>);
...
private:
    ...
    TextAdapter(sk_sp<SkFontMgr>, sk_sp<CustomFont::GlyphCompMapper>, sk_sp<Logger>, AnchorPointGrouping);
