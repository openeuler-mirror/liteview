...
public:
    ...
    static sk_sp<SkParticleDrawable> MakeImage(const char* imagePath, const char* imageName, int cols, int rows);
    static sk_sp<SkParticleDrawable> MakeSkottie(const char* animPath, const char* animName, int cols, int rows);
};
