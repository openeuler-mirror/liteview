...
private:
    explicit ParticleAssetProvider(AssetVec assets)
...
EMSCRIPTEN_BINDINGS(Particles)
{
    class_<SkParticleEffect>("ParticleEffect")
        ...
        .function(
            "_uniformPtr", optional_override([](SkParticleEffect& self) -> WASMPointerF32 { return reinterpret_cast<WASMPointerF32>(self.uniformData()); }))
        ...
        .function("_setPosition", optional_override([](SkParticleEffect& self, SkScalar x, SkScalar y) -> void {
    ...
    function("_MakeParticles",
        optional_override([](std::string json, size_t assetCount, WASMPointerU32 nptr, WASMPointerU32 dptr, WASMPointerU32 sptr) -> sk_sp<SkParticleEffect> {
            ...
            params->prepare(skresources::DataURIResourceProviderProxy::Make(ParticleAssetProvider::Make(std::move(assets))).get());
