...
EMSCRIPTEN_BINDINGS(Paragraph)
{
    ...
    class_<para::ParagraphBuilderImpl>("ParagraphBuilder")
        ...
        .function("_buildWithClientInfo",
            optional_override([](para::ParagraphBuilderImpl& self, WASMPointerU32 clientBidis, size_t bidisNum, WASMPointerU32 clientWords, size_t wordsNum,
                                  WASMPointerU32 clientGraphemes, size_t graphemesNum, WASMPointerU32 clientLineBreaks, size_t lineBreaksNum) {
                ...
                return self.BuildWithClientInfo(
                    std::move(bidiRegions), convertArrayU32(clientWords, wordsNum), convertArrayU32(clientGraphemes, graphemesNum), std::move(lineBreaks));
            }));
