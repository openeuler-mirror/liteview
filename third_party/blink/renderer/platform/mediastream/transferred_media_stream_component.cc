...
MediaStreamComponent* TransferredMediaStreamComponent::Clone(std::unique_ptr<MediaStreamTrackPlatform> cloned_platform_track) const
{
    if (component_) {
...
void TransferredMediaStreamComponent::SetCreationFrame(WebLocalFrame* creation_frame)
{
    if (component_) {
