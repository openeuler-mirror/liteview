...
public:
    ...
    virtual absl::optional<blink::AudioProcessingProperties> GetAudioProcessingProperties() const
    {
        return absl::nullopt;
    }
...
protected:
    ...
    void DeliverDataToTracks(const media::AudioBus& audio_bus, base::TimeTicks reference_time);
