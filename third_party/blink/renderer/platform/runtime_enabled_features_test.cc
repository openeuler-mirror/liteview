...
class RuntimeEnabledFeaturesTest : public testing::Test {
    void CheckAllDisabled()
    {
        ...
        CHECK(!RuntimeEnabledFeatures::OriginTrialsSampleAPIImpliedEnabledByRuntimeFlag());
        CHECK(!RuntimeEnabledFeatures::OriginTrialsSampleAPIDependentEnabledByRuntimeFlag());
    }
    void SetUp() override
    {
        CheckAllDisabled();
...
{
    // Internal status: false, false, false.
    EXPECT_FALSE(RuntimeEnabledFeatures::OriginTrialsSampleAPIEnabledByRuntimeFlag());
    EXPECT_FALSE(RuntimeEnabledFeatures::OriginTrialsSampleAPIImpliedEnabledByRuntimeFlag());
    EXPECT_FALSE(RuntimeEnabledFeatures::OriginTrialsSampleAPIDependentEnabledByRuntimeFlag());

    RuntimeEnabledFeatures::SetOriginTrialsSampleAPIEnabled(true);
    // Internal status: true, false, false.
    EXPECT_TRUE(RuntimeEnabledFeatures::OriginTrialsSampleAPIEnabledByRuntimeFlag());
    // Implied by OriginTrialsSampleAPI.
    EXPECT_TRUE(RuntimeEnabledFeatures::OriginTrialsSampleAPIImpliedEnabledByRuntimeFlag());
    EXPECT_FALSE(RuntimeEnabledFeatures::OriginTrialsSampleAPIDependentEnabledByRuntimeFlag());
    ...
    EXPECT_TRUE(RuntimeEnabledFeatures::OriginTrialsSampleAPIEnabledByRuntimeFlag());
    EXPECT_TRUE(RuntimeEnabledFeatures::OriginTrialsSampleAPIImpliedEnabledByRuntimeFlag());
    EXPECT_TRUE(RuntimeEnabledFeatures::OriginTrialsSampleAPIDependentEnabledByRuntimeFlag());
