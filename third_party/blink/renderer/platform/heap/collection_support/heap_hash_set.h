...
class HeapHashSet final : public GarbageCollected<HeapHashSet<ValueArg, HashArg, TraitsArg>>, public HashSet<ValueArg, HashArg, TraitsArg, HeapAllocator> {
    DISALLOW_NEW();
...
private:
    static constexpr void CheckType()
    {
        ...
        static_assert(std::is_trivially_destructible<HeapHashSet>::value, "HeapHashSet must be trivially destructible.");
