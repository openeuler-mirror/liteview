...
TEST_F(IncrementalMarkingTest, StepDuringObjectConstruction)
{
    ...
    MakeGarbageCollected<O>(base::BindOnce(
                                [](IncrementalMarkingTestDriver* driver, Holder* holder, O* thiz) {
                                    ...
                                    driver->TriggerMarkingSteps(ThreadState::StackState::kMayContainHeapPointers);
                                },
                                &driver, holder.Get()),
...
TEST_F(IncrementalMarkingTest, StepDuringMixinObjectConstruction)
{
    ...
    IncrementalMarkingTestDriver driver(ThreadState::Current());
    driver.StartGC();
    MakeGarbageCollected<Parent>(base::BindOnce(
...
TEST_F(IncrementalMarkingTest, AdjustMarkedBytesOnMarkedBackingStore)
{
    ...
    scoped_feature_list.InitAndDisableFeature(blink::features::kBlinkHeapConcurrentSweeping);
