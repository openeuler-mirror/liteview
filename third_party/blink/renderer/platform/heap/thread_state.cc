...
public:
    explicit BlinkRootsHandler(v8::CppHeap& cpp_heap)
        : cpp_heap_(cpp_heap)
    {
    }
    ...
    bool IsRoot(const v8::TracedReference<v8::Value>& handle) final
    {
        ...
        if (class_id != WrapperTypeInfo::kNodeClassId && class_id != WrapperTypeInfo::kObjectClassId)
            return true;

        const v8::TracedReference<v8::Object>& traced = handle.template As<v8::Object>();
    ...
    {
        DCHECK(handle.WrapperClassId() == WrapperTypeInfo::kNodeClassId || handle.WrapperClassId() == WrapperTypeInfo::kObjectClassId);
        ...
        bool success = DOMWrapperWorld::UnsetSpecificWrapperIfSet(ToScriptWrappable(traced), traced);
...
ThreadState::ThreadState(v8::Platform* platform)
    : cpp_heap_(v8::CppHeap::Create(platform,
        { CustomSpaces::CreateCustomSpaces(), v8::WrapperDescriptor(kV8DOMWrapperTypeIndex, kV8DOMWrapperObjectIndex, gin::GinEmbedder::kEmbedderBlink) }))
...
void ThreadState::NotifyGarbageCollection(v8::GCType type, v8::GCCallbackFlags flags)
{
    if (flags & v8::kGCCallbackFlagForced) {
        ...
        if (type == v8::kGCTypeScavenge) {
            ...
            forced_scheduled_gc_for_testing_ = cppgc::subtle::HeapState::PreviousGCWasConservative(heap_handle());
        }
    }
}
