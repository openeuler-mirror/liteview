...
public:
    ...
    ALWAYS_INLINE static void DispatchForObject(cppgc::internal::BasicMember<T, WeaknessTag, WriteBarrierPolicy, CheckingPolicy>* element)
    {
        HeapConsistency::WriteBarrierParams params;
    ...
    // Cannot refer to blink::Member and friends here due to cyclic includes.
    template <typename T, typename WeaknessTag, typename WriteBarrierPolicy, typename CheckingPolicy>
    ALWAYS_INLINE static bool IsWriteBarrierNeeded(cppgc::internal::BasicMember<T, WeaknessTag, WriteBarrierPolicy, CheckingPolicy>* element)
    {
        HeapConsistency::WriteBarrierParams params;
