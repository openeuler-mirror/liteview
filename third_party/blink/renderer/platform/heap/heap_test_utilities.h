...
public:
    ...
    virtual void TriggerMarkingSteps(ThreadState::StackState stack_state = ThreadState::StackState::kNoHeapPointers);
...
public:
    ...
    void TriggerMarkingSteps(ThreadState::StackState stack_state = ThreadState::StackState::kNoHeapPointers) override;
