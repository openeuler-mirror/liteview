...
void IncrementalMarkingTestDriver::TriggerMarkingSteps(ThreadState::StackState stack_state)
{
...
void ConcurrentMarkingTestDriver::TriggerMarkingSteps(ThreadState::StackState stack_state)
{
    CHECK(ThreadState::Current()->IsIncrementalMarking());
