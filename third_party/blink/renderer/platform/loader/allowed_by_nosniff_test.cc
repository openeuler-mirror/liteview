...
public:
    MOCK_METHOD5(AddConsoleMessageImpl,
        void(mojom::ConsoleMessageSource, mojom::ConsoleMessageLevel, const String&, bool, absl::optional<mojom::ConsoleMessageCategory>));
};
...
TEST_P(AllowedByNosniffTest, AllowedOrNot)
{
    ...
    for (auto& testcase : data) {
        ...
        Persistent<MockConsoleLogger> logger = MakeGarbageCollected<MockConsoleLogger>();
