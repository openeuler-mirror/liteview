...
protected:
    ...
    void BodyDataReceived(base::span<const char> data) override
    {
        ...
        data_received_ = data_received_ + String::FromUTF8(data.data(), data.size());
        TakeActions();
    }
    ...
    void BodyLoadingFinished(base::TimeTicks completion_time, int64_t total_encoded_data_length, int64_t total_encoded_body_length,
        int64_t total_decoded_body_length, bool should_report_corb_blocking, const absl::optional<blink::WebURLError>& error) override
    {
