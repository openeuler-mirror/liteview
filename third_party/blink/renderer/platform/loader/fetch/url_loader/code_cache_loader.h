...
public:
    ...
    void FetchFromCodeCache(mojom::CodeCacheType cache_type, const WebURL& url, FetchCodeCacheCallback callback) override;

    void ClearCodeCacheEntry(mojom::CodeCacheType cache_type, const WebURL& url) override;
