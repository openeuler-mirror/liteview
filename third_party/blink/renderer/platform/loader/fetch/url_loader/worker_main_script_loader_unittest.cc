...
protected:
    ...
    public:
        ...
        void FollowRedirect(
            const std::vector<std::string>&, const net::HttpRequestHeaders&, const net::HttpRequestHeaders&, const absl::optional<GURL>&) override
        {
        }
    ...
    public:
        ...
        MOCK_METHOD2(DidReceiveData, void(uint64_t identifier, base::span<const char> chunk));
        ...
        MOCK_METHOD5(DidFinishLoading,
            void(uint64_t identifier, base::TimeTicks finish_time, int64_t encoded_data_length, int64_t decoded_body_length, bool should_report_corb_blocking));
        ...
        MOCK_METHOD1(EvictFromBackForwardCache, void(blink::mojom::RendererEvictionReason));
    };
...
TEST_F(WorkerMainScriptLoaderTest, ResponseWithSucessThenOnComplete)
{
    ...
    EXPECT_EQ(kTopLevelScript, std::string(client_->Data()->Data(), client_->Data()->size()));
