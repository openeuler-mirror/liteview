...
public:
    static std::unique_ptr<CachedMetadataSender> Create(
        const ResourceResponse&, blink::mojom::CodeCacheType, scoped_refptr<const SecurityOrigin> requestor_origin);

    static void SendToCodeCacheHost(
        CodeCacheHost*, mojom::blink::CodeCacheType, WTF::String, base::Time, scoped_refptr<const SecurityOrigin>, const String&, const uint8_t*, size_t);
