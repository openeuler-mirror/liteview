...
public:
    ...
    void set_frame_request_blocker(scoped_refptr<WebFrameRequestBlocker> frame_request_blocker) override;
    ...
    std::unique_ptr<WebCodeCacheLoader> CreateCodeCacheLoader(CodeCacheHost*) override;
