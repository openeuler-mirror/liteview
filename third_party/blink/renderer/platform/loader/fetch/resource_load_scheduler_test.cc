...
public:
    ...
    void SetUp() override
    {
        ...
        feature_list_.InitAndDisableFeature(features::kDelayLowPriorityRequestsAccordingToNetworkState);
    }
...
{
    const base::FieldTrialParams network_params = { { features::kMaxNumOfThrottleableRequestsInTightMode.name, "2" },
        { features::kHttpRttThreshold.name, "3600ms" }, { features::kCostReductionOfMultiplexedRequests.name, "0.5" } };

    base::test::ScopedFeatureList feature_list;
    feature_list.InitWithFeaturesAndParameters({ { features::kDelayLowPriorityRequestsAccordingToNetworkState, network_params } }, {});
    ...
    MockClient* client1 = MakeGarbageCollected<MockClient>();
    ResourceLoadScheduler::ClientId id1 = ResourceLoadScheduler::kInvalidClientId;
    Scheduler()->Request(client1, ThrottleOption::kThrottleable, ResourceLoadPriority::kHigh, 0 /* intra_priority */, &id1);
    EXPECT_NE(ResourceLoadScheduler::kInvalidClientId, id1);

    MockClient* client2 = MakeGarbageCollected<MockClient>();
    ResourceLoadScheduler::ClientId id2 = ResourceLoadScheduler::kInvalidClientId;
    Scheduler()->Request(client2, ThrottleOption::kThrottleable, ResourceLoadPriority::kLow, 5 /* intra_priority */, &id2);
    Scheduler()->SetConnectionInfo(id2, net::HttpResponseInfo::CONNECTION_INFO_HTTP2);
    EXPECT_NE(ResourceLoadScheduler::kInvalidClientId, id2);
...
TEST_F(ResourceLoadSchedulerTest, ConsiderNetworkStateInTigtModeWithPoorConnection)
{
    const base::FieldTrialParams network_params = { { features::kMaxNumOfThrottleableRequestsInTightMode.name, "2" },
        { features::kHttpRttThreshold.name, "3600ms" }, { features::kCostReductionOfMultiplexedRequests.name, "0.5" } };
    ...
    MockClient* client3 = MakeGarbageCollected<MockClient>();
    ResourceLoadScheduler::ClientId id3 = ResourceLoadScheduler::kInvalidClientId;
    Scheduler()->Request(client3, ThrottleOption::kThrottleable, ResourceLoadPriority::kLow, 5 /* intra_priority */, &id3);
    Scheduler()->SetConnectionInfo(id3, net::HttpResponseInfo::CONNECTION_INFO_HTTP2);
...
TEST_F(ResourceLoadSchedulerTest, UnbatchedRequestsRunInInsertOrder)
{
    ...
    ResourceLoadScheduler::ClientId id2 = ResourceLoadScheduler::kInvalidClientId;
    Scheduler()->Request(client2, ThrottleOption::kThrottleable, ResourceLoadPriority::kHighest, 1 /* intra_priority */, &id2);
    EXPECT_NE(ResourceLoadScheduler::kInvalidClientId, id2);
