...
public:
    ...
    void AddConsoleMessage(mojom::blink::ConsoleMessageSource source, mojom::blink::ConsoleMessageLevel level, const String& message,
        bool discard_duplicates = false, absl::optional<mojom::blink::ConsoleMessageCategory> category = absl::nullopt)
    {
...
private:
    void AddConsoleMessageImpl(mojom::blink::ConsoleMessageSource source, mojom::blink::ConsoleMessageLevel level, const String& message,
        bool discard_duplicates, absl::optional<mojom::blink::ConsoleMessageCategory> category) override
    {
        if (!logger_) {
            return;
        }
