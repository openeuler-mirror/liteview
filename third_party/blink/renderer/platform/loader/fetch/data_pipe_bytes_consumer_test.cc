...
TEST_F(DataPipeBytesConsumerTest, TwoPhaseRead)
{
    ...
    MojoResult rv = producer_handle->WriteData(kData.c_str(), &write_size, MOJO_WRITE_DATA_FLAG_NONE);
...
TEST_F(DataPipeBytesConsumerTest, SignalSizeBeforeRead)
{
    ...
    MojoResult write_result = writable->WriteData(kData, &write_size, MOJO_WRITE_DATA_FLAG_NONE);
