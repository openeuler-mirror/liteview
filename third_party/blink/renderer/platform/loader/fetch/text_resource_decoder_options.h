...
public:
    ...
    {
        return hint_language_;
    }

private:
    TextResourceDecoderOptions(
        EncodingDetectionOption, ContentType, const WTF::TextEncoding& default_encoding, const char* hint_encoding, const KURL& hint_url);
