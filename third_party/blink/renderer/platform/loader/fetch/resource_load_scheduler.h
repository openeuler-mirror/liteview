...
public:
    ...
    void SetConnectionInfo(ClientId id, net::HttpResponseInfo::ConnectionInfo connection_info);
...
private:
    ...
    using IsMultiplexedConnection = base::StrongAlias<class IsMultiplexedConnectionTag, bool>;
    ...
    std::map<ThrottleOption, std::set<ClientIdWithPriority, ClientIdWithPriority::Compare>> pending_requests_;
