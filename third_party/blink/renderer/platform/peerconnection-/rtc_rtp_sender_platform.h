...
public:
    ...
    virtual void SetParameters(Vector<webrtc::RtpEncodingParameters>, absl::optional<webrtc::DegradationPreference>, RTCVoidRequest*) = 0;
    virtual void GetStats(RTCStatsReportCallback, const Vector<webrtc::NonStandardGroupId>&) = 0;
