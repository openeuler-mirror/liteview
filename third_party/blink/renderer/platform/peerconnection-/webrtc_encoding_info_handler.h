...
public:
    ...
    void EncodingInfo(const absl::optional<webrtc::SdpAudioFormat> sdp_audio_format, const absl::optional<webrtc::SdpVideoFormat> sdp_video_format,
        const absl::optional<String> video_scalability_mode, OnMediaCapabilitiesEncodingInfoCallback callback) const;
