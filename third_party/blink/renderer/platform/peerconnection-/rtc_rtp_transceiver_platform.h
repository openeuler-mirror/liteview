...
public:
    ...
    virtual absl::optional<webrtc::RtpTransceiverDirection> CurrentDirection() const = 0;
    virtual absl::optional<webrtc::RtpTransceiverDirection> FiredDirection() const = 0;
    virtual webrtc::RTCError Stop()
    {
        NOTREACHED();
        return webrtc::RTCError::OK();
    }
    virtual webrtc::RTCError SetCodecPreferences(Vector<webrtc::RtpCodecCapability>)
    {
        return {};
    }
    virtual webrtc::RTCError SetOfferedRtpHeaderExtensions(Vector<webrtc::RtpHeaderExtensionCapability> header_extensions) = 0;
    virtual Vector<webrtc::RtpHeaderExtensionCapability> HeaderExtensionsNegotiated() const = 0;
    virtual Vector<webrtc::RtpHeaderExtensionCapability> HeaderExtensionsToOffer() const = 0;
};
