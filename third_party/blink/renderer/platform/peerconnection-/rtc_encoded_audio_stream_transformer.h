...
using TransformerCallback = WTF::CrossThreadRepeatingFunction<void(std::unique_ptr<webrtc::TransformableFrameInterface>)>;
...
public:
    ...
    public:
        ...
        void TransformFrameOnSourceTaskRunner(std::unique_ptr<webrtc::TransformableFrameInterface> frame);
    ...
    private:
        ...
        RTCEncodedAudioStreamTransformer* transformer_ GUARDED_BY(transformer_lock_);
    };
