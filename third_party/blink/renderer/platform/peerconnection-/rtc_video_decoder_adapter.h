...
private:
    ...
    // Called on the worker thread.
    RTCVideoDecoderAdapter(media::GpuVideoAcceleratorFactories* gpu_factories, const media::VideoDecoderConfig& config);
    ...
    absl::optional<RTCVideoDecoderFallbackReason> FallbackOrRegisterConcurrentInstanceOnce(media::VideoCodec codec);
    absl::optional<RTCVideoDecoderFallbackReason> NeedSoftwareFallback(media::VideoCodec codec, const media::DecoderBuffer& buffer) const;
    ...
    void FlushOnMediaThread(WTF::CrossThreadOnceClosure flush_success_cb, WTF::CrossThreadOnceClosure flush_fail_cb);
    ...
    absl::optional<base::TimeTicks> start_time_ GUARDED_BY_CONTEXT(media_sequence_checker_);
