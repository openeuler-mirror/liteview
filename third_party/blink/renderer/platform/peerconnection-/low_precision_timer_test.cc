...
public:
        ...
        : task_environment_(base::test::TaskEnvironment::ThreadingMode::MULTIPLE_THREADS, base::test::TaskEnvironment::TimeSource::MOCK_TIME)
    {
        ...
        task_environment_.FastForwardBy(MetronomeSource::TimeSnappedToNextTick(now) - now);
    }
...
TEST_F(LowPrecisionTimerTest, MoveToNewTaskRunner)
{
    ...
    timer.StartOneShot(MetronomeSource::Tick());
    task_environment_.FastForwardBy(MetronomeSource::Tick() - base::Milliseconds(3));
...
TEST_F(LowPrecisionTimerTest, StartRepeating)
{
    ...
    task_environment_.FastForwardBy(MetronomeSource::Tick() - base::Milliseconds(10));
    EXPECT_EQ(listener.callback_count(), 1u);
    task_environment_.FastForwardBy(MetronomeSource::Tick());
    EXPECT_EQ(listener.callback_count(), 2u);
    task_environment_.FastForwardBy(MetronomeSource::Tick());
