...
// from here.
class MockTransformableVideoFrame : public webrtc::TransformableVideoFrameInterface {
public:
    ...
    MOCK_METHOD(const webrtc::VideoFrameMetadata&, GetMetadata, (), (const, override));
};
...
TEST_F(RTCEncodedVideoStreamTransformerTest, TransformerForwardsFrameToTransformerCallback)
{
    ...
    encoded_video_stream_transformer_.SetTransformerCallback(
        WTF::BindRepeating(&MockTransformerCallbackHolder::OnEncodedFrame, WTF::Unretained(&mock_transformer_callback_holder_)));
