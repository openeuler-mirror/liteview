...
template <typename T> struct NotAdvertisedDecoder {
    ...
    static std::unique_ptr<webrtc::AudioDecoder> MakeAudioDecoder(const Config& config, absl::optional<webrtc::AudioCodecPairId> codec_pair_id)
    {
...
{
    return webrtc::CreateAudioEncoderFactory<webrtc::AudioEncoderOpus, webrtc::AudioEncoderIsac, webrtc::AudioEncoderG722, webrtc::AudioEncoderG711,
...
{
    return webrtc::CreateAudioDecoderFactory<webrtc::AudioDecoderOpus, webrtc::AudioDecoderIsac, webrtc::AudioDecoderG722, webrtc::AudioDecoderG711,
