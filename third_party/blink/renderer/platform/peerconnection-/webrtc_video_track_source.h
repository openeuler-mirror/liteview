...
public:
    ...
    WebRtcVideoTrackSource(bool is_screencast, absl::optional<bool> needs_denoising, media::VideoCaptureFeedbackCB feedback_callback,
    ...
    void OnFrameCaptured(scoped_refptr<media::VideoFrame> frame, std::vector<scoped_refptr<media::VideoFrame>> scaled_frames);
...
private:
    ...
    absl::optional<FrameAdaptationParams> custom_frame_adaptation_params_for_testing_;
