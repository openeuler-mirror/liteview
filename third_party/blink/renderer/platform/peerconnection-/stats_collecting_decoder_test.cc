...
public:
    ...
    {
        webrtc::VideoFrame video_frame = CreateMockFrame(input_image._encodedWidth, input_image._encodedHeight, input_image.Timestamp());
...
public:
    ...
    void Decoded(webrtc::VideoFrame& decodedImage, absl::optional<int32_t> decode_time_ms, absl::optional<uint8_t> qp) override
    {
...
protected:
        ...
        StatsCollectingDecoder* decoder, int width, int height, bool is_hw_accelerated, int frames, int key_frame_interval, int frame_rate)
    {
        ...
        for (int i = 0; i < frames; ++i) {
            ...
            encoded_frame.SetTimestamp(90000 * frame_counter / frame_rate); // RTP timestamp using 90 kHz clock.
