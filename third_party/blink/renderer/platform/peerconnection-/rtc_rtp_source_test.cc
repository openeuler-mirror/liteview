...
{
    webrtc::RtpSource rtp_source(kTimestampMs, kSourceId, kSourceType, kRtpTimestamp, webrtc::RtpSource::Extensions());

    RTCRtpSource rtc_rtp_source(rtp_source);

    EXPECT_EQ((rtc_rtp_source.Timestamp() - base::TimeTicks()).InMilliseconds(), kTimestampMs);
...
TEST(RtcRtpSource, AbsoluteCaptureTimeSetAndReturnedNoOffset)
{
    ...
    webrtc::RtpSource rtp_source(kTimestampMs, kSourceId, kSourceType, kRtpTimestamp,
