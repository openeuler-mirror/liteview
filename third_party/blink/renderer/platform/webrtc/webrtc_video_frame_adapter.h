...
class PLATFORM_EXPORT WebRtcVideoFrameAdapter : public webrtc::VideoFrameBuffer {
public:
    ...
    class PLATFORM_EXPORT SharedResources : public base::RefCountedThreadSafe<SharedResources> {
    public:
        ...
        virtual void ReleaseTemporaryVectorBuffer(std::unique_ptr<std::vector<uint8_t>> buffer);
    ...
    scoped_refptr<media::VideoFrame> getMediaVideoFrame() const
    {
        return frame_;
    }
