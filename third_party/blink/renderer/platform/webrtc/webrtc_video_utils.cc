...
media::VideoCodecProfile WebRtcVideoFormatToMediaVideoCodecProfile(const webrtc::SdpVideoFormat& format)
{
    ...
    case webrtc::kVideoCodecVP9: {
        const absl::optional<webrtc::VP9Profile> vp9_profile = webrtc::ParseSdpForVP9Profile(format.parameters);
    ...
    case webrtc::kVideoCodecH264: {
        const absl::optional<webrtc::H264ProfileLevelId> h264_profile_level_id = webrtc::ParseSdpForH264ProfileLevelId(format.parameters);
...
media::VideoColorSpace WebRtcToMediaVideoColorSpace(const webrtc::ColorSpace& color_space)
{
