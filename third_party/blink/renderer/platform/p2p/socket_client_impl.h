...
class P2PSocketClientImpl : public blink::P2PSocketClient, public network::mojom::blink::P2PSocketClient {
public:
    P2PSocketClientImpl(P2PSocketDispatcher* dispatcher, const net::NetworkTrafficAnnotationTag& traffic_annotation);
    ...
    virtual void Init(network::P2PSocketType type, const net::IPEndPoint& local_address, uint16_t min_port, uint16_t max_port,
    ...
    uint64_t Send(const net::IPEndPoint& address, const Vector<int8_t>& data, const rtc::PacketOptions& options) override;
...
private:
    ...
    // condition.
    void SendWithPacketId(const net::IPEndPoint& address, const Vector<int8_t>& data, const rtc::PacketOptions& options, uint64_t packet_id);
    ...
    void DataReceived(const net::IPEndPoint& socket_address, const Vector<int8_t>& data, base::TimeTicks timestamp) override;
