...
class P2PAsyncAddressResolver : public base::RefCountedThreadSafe<P2PAsyncAddressResolver> {
public:
    ...
    void Start(const rtc::SocketAddress& addr, absl::optional<int> address_family, DoneCallback done_callback);
