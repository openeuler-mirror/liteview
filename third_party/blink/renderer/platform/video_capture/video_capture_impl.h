...
public:
    ...
    void OnBufferReady(media::mojom::blink::ReadyBufferPtr buffer, Vector<media::mojom::blink::ReadyBufferPtr> scaled_buffers) override;
...
private:
    ...
    public:
        VideoFrameBufferPreparer(VideoCaptureImpl& video_capture_impl, media::mojom::blink::ReadyBufferPtr ready_buffer);
        ...
        // context was lost.
        bool BindVideoFrameOnMediaThread(media::GpuVideoAcceleratorFactories* gpu_factories);
    ...
    static void BindVideoFramesOnMediaThread(media::GpuVideoAcceleratorFactories* gpu_factories, std::unique_ptr<VideoFrameBufferPreparer> frame_preparer,
    ...
    void OnVideoFrameReady(base::TimeTicks reference_time, std::unique_ptr<VideoFrameBufferPreparer> frame_preparer,
        std::vector<std::unique_ptr<VideoFrameBufferPreparer>> scaled_frame_preparers);
