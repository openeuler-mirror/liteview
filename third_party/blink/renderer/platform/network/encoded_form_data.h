...
public:
    ...
    FormDataElement(const String& filename, int64_t file_start, int64_t file_length, const absl::optional<base::Time>& expected_file_modification_time);
    FormDataElement(const String& blob_uuid, scoped_refptr<BlobDataHandle> optional_handle);
...
public:
    ...
    void AppendFile(const String& file_path, const absl::optional<base::Time>& expected_modification_time);
    void AppendFileRange(const String& filename, int64_t start, int64_t length, const absl::optional<base::Time>& expected_modification_time);
    void AppendBlob(const String& blob_uuid, scoped_refptr<BlobDataHandle> optional_handle);
