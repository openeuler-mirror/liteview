...
TEST(ParsedContentHeaderFieldParametersTest, ParameterName)
{
    ...
    absl::optional<ParsedContentHeaderFieldParameters> t = ParsedContentHeaderFieldParameters::Parse(HeaderFieldTokenizer(input), Mode::kNormal);
    ASSERT_TRUE(t);
...
TEST(ParsedContentHeaderFieldParametersTest, RelaxedParameterName)
{
    ...
    absl::optional<ParsedContentHeaderFieldParameters> t = ParsedContentHeaderFieldParameters::Parse(HeaderFieldTokenizer(input), Mode::kRelaxed);
    ASSERT_TRUE(t);
