...
{
    if (string.Is8Bit()) {
        return CharactersToInt(string.Characters8() + start, end - start, WTF::NumberParsingOptions(), nullptr);
    }
    return CharactersToInt(string.Characters16() + start, end - start, WTF::NumberParsingOptions(), nullptr);
}
