...
static ALWAYS_INLINE __m128i WrapIndexVector(__m128i v_write_index, __m128i v_buffer_length)
{
...
static ALWAYS_INLINE __m128 WrapPositionVector(__m128 v_position, __m128 v_buffer_length)
{
