...
static ALWAYS_INLINE int32x4_t WrapIndexVector(int32x4_t v_write_index, int32x4_t v_buffer_length)
{
...
static ALWAYS_INLINE float32x4_t WrapPositionVector(float32x4_t v_position, float32x4_t v_buffer_length)
{
