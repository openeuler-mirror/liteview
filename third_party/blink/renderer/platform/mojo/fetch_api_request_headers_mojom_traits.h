...
template <> struct StructTraits<blink::mojom::FetchAPIRequestHeadersDataView, WTF::HashMap<WTF::String, WTF::String, WTF::CaseFoldingHash>> {
    static WTF::HashMap<WTF::String, WTF::String> headers(const WTF::HashMap<WTF::String, WTF::String, WTF::CaseFoldingHash>& input)
    {
    ...
    static bool Read(blink::mojom::FetchAPIRequestHeadersDataView in, WTF::HashMap<WTF::String, WTF::String, WTF::CaseFoldingHash>* out)
    {
