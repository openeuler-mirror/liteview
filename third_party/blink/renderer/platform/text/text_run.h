...
public:
    ...
    TextRun(const LChar* c, unsigned len, float xpos = 0, float expansion = 0,
        ExpansionBehavior expansion_behavior = kAllowTrailingExpansion | kForbidLeadingExpansion, TextDirection direction = TextDirection::kLtr,
    ...
    TextRun(const StringView& string, float xpos = 0, float expansion = 0,
        ExpansionBehavior expansion_behavior = kAllowTrailingExpansion | kForbidLeadingExpansion, TextDirection direction = TextDirection::kLtr,
        bool directional_override = false)
    ...
    {
        return Is8Bit() ? StringView(data_.characters8, len_) : StringView(data_.characters16, len_);
    }
    ...
    {
        return disable_spacing_;
    }

    void DisableSpacing()
    {
        disable_spacing_ = true;
    }
