...
template <typename PhysicalToLogicalConverter> void CheckLegacyLogicalDirections(const PhysicalToLogicalConverter& converter)
{
...
{
    LogicalValues logical_values;
    PhysicalToLogicalSetter<int, LogicalValues> setter({ WritingMode::kVerticalRl, TextDirection::kRtl }, logical_values, &LogicalValues::SetInlineStart,
        &LogicalValues::SetInlineEnd, &LogicalValues::SetBlockStart, &LogicalValues::SetBlockEnd);
    setter.SetTop(kTop);
