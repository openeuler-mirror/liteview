...
public:
    static scoped_refptr<BidiContext> Create(
        unsigned char level, WTF::unicode::CharDirection, bool override = false, BidiEmbeddingSource = kFromStyleOrDOM, BidiContext* parent = nullptr);
...
private:
    ...
    static scoped_refptr<BidiContext> CreateUncached(unsigned char level, WTF::unicode::CharDirection, bool override, BidiEmbeddingSource, BidiContext* parent);
