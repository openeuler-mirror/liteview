...
public:
    ...
    Value Over() const
    {
        return (object_.*converter_.Over())();
    }
    Value Under() const
    {
        return (object_.*converter_.Under())();
    }
    Value LineLeft() const
    {
        return (object_.*converter_.LineLeft())();
    }
    Value LineRight() const
    {
        return (object_.*converter_.LineRight())();
    }
    Value Start() const
    {
        return (object_.*converter_.Start())();
    }
    Value End() const
    {
        return (object_.*converter_.End())();
    }
    Value Before() const
    {
        return (object_.*converter_.Before())();
    }
    Value After() const
    {
        return (object_.*converter_.After())();
    }
...
template <typename Value, typename Object> class PhysicalToLogicalSetter {
    STACK_ALLOCATED();

public:
    using Setter = void (Object::*)(Value);
    PhysicalToLogicalSetter(WritingDirectionMode writing_direction, Object& object, Setter inline_start_setter, Setter inline_end_setter,
        Setter block_start_setter, Setter block_end_setter)
        : object_(object)
        , converter_(writing_direction, inline_start_setter, inline_end_setter, block_start_setter, block_end_setter)
    {
    }

    void SetLeft(Value v)
    {
        (object_.*converter_.Left())(v);
    }
    void SetRight(Value v)
    {
        (object_.*converter_.Right())(v);
    }
    void SetTop(Value v)
    {
        (object_.*converter_.Top())(v);
    }
    void SetBottom(Value v)
    {
        (object_.*converter_.Bottom())(v);
    }
...
public:
    ...
    void SetOver(Value v)
    {
        (object_.*converter_.Over())(v);
    }
    void SetUnder(Value v)
    {
        (object_.*converter_.Under())(v);
    }
    void SetLineLeft(Value v)
    {
        (object_.*converter_.LineLeft())(v);
    }
    void SetLineRight(Value v)
    {
        (object_.*converter_.LineRight())(v);
    }
    void SetStart(Value v)
    {
        (object_.*converter_.Start())(v);
    }
    void SetEnd(Value v)
    {
        (object_.*converter_.End())(v);
    }
    void SetBefore(Value v)
    {
        (object_.*converter_.Before())(v);
    }
    void SetAfter(Value v)
    {
        (object_.*converter_.After())(v);
    }
