...
TestPaintArtifact& TestPaintArtifact::Chunk(DisplayItemClient& client, DisplayItem::Type type)
{
...
TestPaintArtifact& TestPaintArtifact::ScrollHitTest(const gfx::Rect& rect, const TransformPaintPropertyNode* scroll_translation)
{
...
{
    DEFINE_STATIC_LOCAL(Persistent<LiteralDebugNameClient>, client, (MakeGarbageCollected<LiteralDebugNameClient>("ForeignLayer")));
...
TestPaintArtifact& TestPaintArtifact::RectDrawing(DisplayItemClient& client, const gfx::Rect& bounds, Color color)
{
...
TestPaintArtifact& TestPaintArtifact::ScrollHitTest(DisplayItemClient& client, const gfx::Rect& rect, const TransformPaintPropertyNode* scroll_translation)
{
    auto& hit_test_data = paint_artifact_->PaintChunks().back().EnsureHitTestData();
...
TestPaintArtifact& TestPaintArtifact::TextKnownToBeOnOpaqueBackground()
{
    ...
    paint_artifact_->PaintChunks().back().text_known_to_be_on_opaque_background = true;
    return *this;
}
