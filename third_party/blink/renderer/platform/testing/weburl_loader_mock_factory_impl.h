...
public:
    ...
    WebURLLoaderMockFactoryImpl& operator=(const WebURLLoaderMockFactoryImpl&) = delete;
    ...
    void LoadSynchronously(std::unique_ptr<network::ResourceRequest> request, WebURLResponse* response, absl::optional<WebURLError>* error, WebData* data,
        int64_t* encoded_data_length);
    void LoadAsynchronouly(std::unique_ptr<network::ResourceRequest> request, WebURLLoaderMock* loader);
...
private:
    ...
    // accordingly.
    void LoadRequest(const WebURL& url, WebURLResponse* response, absl::optional<WebURLError>* error, WebData* data);
    ...
    bool LookupURL(const WebURL& url, absl::optional<WebURLError>* error, ResponseInfo* response_info);
    ...
    using LoaderToRequestMap = HashMap<WebURLLoaderMock*, std::unique_ptr<network::ResourceRequest>>;
