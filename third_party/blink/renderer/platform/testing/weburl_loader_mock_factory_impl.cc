...
WebURLLoaderMockFactoryImpl::WebURLLoaderMockFactoryImpl(TestingPlatformSupport* platform)
    : platform_(platform)
{
}
...
void WebURLLoaderMockFactoryImpl::RegisterURL(const WebURL& url, const WebURLResponse& response, const WebString& file_path)
{
...
void WebURLLoaderMockFactoryImpl::RegisterErrorURL(const WebURL& url, const WebURLResponse& response, const WebURLError& error)
{
    DCHECK(url_to_response_info_.find(url) == url_to_response_info_.end());
...
void WebURLLoaderMockFactoryImpl::RegisterURLProtocol(const WebString& protocol, const WebURLResponse& response, const WebString& file_path)
{
    ...
    DCHECK(protocol_to_response_info_.find(protocol) == protocol_to_response_info_.end());
    protocol_to_response_info_.Set(protocol, response_info);
}

void WebURLLoaderMockFactoryImpl::UnregisterURLProtocol(const WebString& protocol)
{
...
void WebURLLoaderMockFactoryImpl::FillNavigationParamsResponse(WebNavigationParams* params)
{
...
void WebURLLoaderMockFactoryImpl::LoadSynchronously(std::unique_ptr<network::ResourceRequest> request, WebURLResponse* response,
    absl::optional<WebURLError>* error, WebData* data, int64_t* encoded_data_length)
{
    LoadRequest(WebURL(KURL(request->url)), response, error, data);
    *encoded_data_length = data->size();
}

void WebURLLoaderMockFactoryImpl::LoadAsynchronouly(std::unique_ptr<network::ResourceRequest> request, WebURLLoaderMock* loader)
{
...
void WebURLLoaderMockFactoryImpl::LoadRequest(const WebURL& url, WebURLResponse* response, absl::optional<WebURLError>* error, WebData* data)
{
    ResponseInfo response_info;
...
bool WebURLLoaderMockFactoryImpl::LookupURL(const WebURL& url, absl::optional<WebURLError>* error, ResponseInfo* response_info)
{
...
// static
bool WebURLLoaderMockFactoryImpl::ReadFile(const base::FilePath& file_path, WebData* data)
{
