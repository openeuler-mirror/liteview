...
public:
    ...
    TestPaintArtifact& Chunk(DisplayItemClient&, DisplayItem::Type = DisplayItem::kDrawingFirst);
    ...
    TestPaintArtifact& Properties(const RefCountedPropertyTreeStateOrAlias& properties)
    {
    ...
    TestPaintArtifact& Chunk(const RefCountedPropertyTreeStateOrAlias& properties)
    {
        return Chunk().Properties(properties);
    }
    ...
    TestPaintArtifact& ScrollHitTest(const gfx::Rect&, const TransformPaintPropertyNode* scroll_translation);
    ...
    TestPaintArtifact& RectDrawing(DisplayItemClient&, const gfx::Rect& bounds, Color color);
    TestPaintArtifact& ScrollHitTest(DisplayItemClient&, const gfx::Rect&, const TransformPaintPropertyNode* scroll_translation);
