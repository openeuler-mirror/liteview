...
public:
    PaintTestConfigurations()
        ...
        , ScopedScrollUpdateOptimizationsForTest(GetParam() & kScrollUpdateOptimizations)
    {
...
#define INSTANTIATE_PAINT_TEST_SUITE_P(test_class)                                                                                                             \
    INSTANTIATE_TEST_SUITE_P(All, test_class, ::testing::Values(0, kScrollUnification, kScrollUpdateOptimizations))
