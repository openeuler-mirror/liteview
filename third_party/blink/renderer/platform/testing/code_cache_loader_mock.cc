...
void CodeCacheLoaderMock::FetchFromCodeCache(blink::mojom::CodeCacheType cache_type, const WebURL& url, WebCodeCacheLoader::FetchCodeCacheCallback callback)
{
...
void CodeCacheLoaderMock::ClearCodeCacheEntry(blink::mojom::CodeCacheType cache_type, const WebURL& url)
{
}
...
void CodeCacheLoaderMock::Controller::Respond(base::Time time, mojo_base::BigBuffer data)
{
    CHECK(callback_);
