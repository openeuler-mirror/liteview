...
{
    Platform::Current()->GetBrowserInterfaceBroker()->SetBinderForTesting(ukm::mojom::UkmRecorderInterface::Name_,
        WTF::BindRepeating(
...
{
    receiver_
        = std::make_unique<mojo::Receiver<ukm::mojom::UkmRecorderInterface>>(this, mojo::PendingReceiver<ukm::mojom::UkmRecorderInterface>(std::move(handle)));
}
