...
public:
    ...
    void Paint(cc::PaintCanvas* canvas, WebThemeEngine::Part part, WebThemeEngine::State state, const gfx::Rect& rect,
        const WebThemeEngine::ExtraParams* extra_params, mojom::ColorScheme color_scheme, const absl::optional<SkColor>& accent_color) override;
    ...
    absl::optional<SkColor> GetSystemColor(WebThemeEngine::SystemThemeColor system_theme_color) const override;
#if BUILDFLAG(IS_WIN)
    ...
    void ResetToSystemColors(WebThemeEngine::SystemColorInfoState system_color_info_state) override;
    WebThemeEngine::SystemColorInfoState GetSystemColorInfo() override;
    bool UpdateColorProviders(const ui::RendererColorMap& light_colors, const ui::RendererColorMap& dark_colors) override;

protected:
    const ui::ColorProvider* GetColorProviderForPainting(mojom::ColorScheme color_scheme) const;
