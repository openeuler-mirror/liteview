...
using FilterParamsMap = std::unordered_map<FilterParamMapKey, FilterParams, FilterParamMapKeyHash>;
...
public:
    ...
    input_prediction::FilterType GetFilterTypeFromName(const std::string& filter_name);
