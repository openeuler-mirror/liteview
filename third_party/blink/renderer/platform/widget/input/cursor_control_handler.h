...
public:
    ...
    absl::optional<InputHandlerProxy::EventDisposition> ObserveInputEvent(const WebInputEvent& event);

private:
    absl::optional<InputHandlerProxy::EventDisposition> HandleGestureScrollBegin(const WebGestureEvent& event);
    absl::optional<InputHandlerProxy::EventDisposition> HandleGestureScrollUpdate(const WebGestureEvent& event);
    absl::optional<InputHandlerProxy::EventDisposition> HandleGestureScrollEnd(const WebGestureEvent& event);
