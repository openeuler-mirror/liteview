...
public:
    FakeWidgetCompositor(cc::LayerTreeHost* layer_tree_host, base::WeakPtr<WidgetBase> widget_base,
        ...
        : WidgetCompositor(widget_base, std::move(main_task_runner), std::move(compositor_task_runner), std::move(receiver))
...
public:
    ...
    void BeginTest() override
    {
        ...
        widget_base_ = std::make_unique<WidgetBase>(
            /*widget_base_client=*/&client_, widget_host_remote.Unbind(), std::move(widget_receiver), base::ThreadTaskRunnerHandle::Get(),
            /*is_hidden=*/false,
            /*never_composited=*/false,
            /*is_for_child_local_root=*/false,
            /*is_for_scalable_page=*/true);

        widget_compositor_ = base::MakeRefCounted<FakeWidgetCompositor>(layer_tree_host(), widget_base_->GetWeakPtr(),
            layer_tree_host()->GetTaskRunnerProvider()->MainThreadTaskRunner(), layer_tree_host()->GetTaskRunnerProvider()->ImplThreadTaskRunner(),
