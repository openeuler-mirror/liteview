...
class PLATFORM_EXPORT WidgetCompositor : public base::RefCountedThreadSafe<WidgetCompositor>, public mojom::blink::WidgetCompositor {
public:
    WidgetCompositor(base::WeakPtr<WidgetBase> widget_base, scoped_refptr<base::SingleThreadTaskRunner> main_task_runner,
