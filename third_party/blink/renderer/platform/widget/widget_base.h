...
class PLATFORM_EXPORT WidgetBase : public mojom::blink::Widget, public LayerTreeViewDelegate {
public:
    ...
    void RequestPresentationTimeForNextFrame(mojom::blink::RecordContentToVisibleTimeRequestPtr visible_time_request) override;
    ...
    mojom::blink::WidgetHost* GetWidgetHostRemote()
    {
        return widget_host_.get();
    }
    ...
    void set_screen_infos(const display::ScreenInfos& s)
    {
        screen_infos_ = s;
    }
