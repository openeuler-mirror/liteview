...
public:
    ...
    virtual void NotifyPresentationTimeInBlink(base::OnceCallback<void(base::TimeTicks)> presentation_callback) = 0;
    ...
    // delta + granularity.
    virtual void InjectGestureScrollEvent(mojom::blink::GestureDevice device, const gfx::Vector2dF& delta, ui::ScrollGranularity granularity,
    ...
    virtual void GetEditContextBoundsInWindow(absl::optional<gfx::Rect>* control_bounds, absl::optional<gfx::Rect>* selection_bounds) = 0;
