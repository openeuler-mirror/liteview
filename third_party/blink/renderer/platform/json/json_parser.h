...
PLATFORM_EXPORT std::unique_ptr<JSONValue> ParseJSON(const String& json, JSONParseError* opt_error = nullptr, bool* opt_has_comments = nullptr);

PLATFORM_EXPORT std::unique_ptr<JSONValue> ParseJSON(const String& json, int max_depth, JSONParseError* opt_error = nullptr, bool* opt_has_comments = nullptr);
} // namespace blink
