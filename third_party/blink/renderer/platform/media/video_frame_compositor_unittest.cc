...
TEST_F(VideoFrameCompositorTest, OnContextLost)
{
    ...
    scoped_refptr<media::VideoFrame> gpu_frame = media::VideoFrame::WrapExternalGpuMemoryBuffer(
        gfx::Rect(encode_size), encode_size, std::move(gmb), mailbox_holders, base::DoNothing(), base::TimeDelta());
