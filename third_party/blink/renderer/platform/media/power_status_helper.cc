...
static constexpr const char* kBatteryDeltaHistogram = "Media.PlaybackPower.BatteryDelta";
static constexpr const char* kElapsedTimeHistogram = "Media.PlaybackPower.ElapsedTime";
...
static constexpr int kMaxEnumValue = PowerStatusHelper::Bits::kCodecBitsH264 | PowerStatusHelper::Bits::kCodecBitsVP9Profile0
    | PowerStatusHelper::Bits::kCodecBitsVP9Profile2 |

    PowerStatusHelper::Bits::kResolution360p | PowerStatusHelper::Bits::kResolution720p | PowerStatusHelper::Bits::kResolution1080p |

    PowerStatusHelper::Bits::kFrameRate30 | PowerStatusHelper::Bits::kFrameRate60 |

    PowerStatusHelper::Bits::kFullScreenNo | PowerStatusHelper::Bits::kFullScreenYes;
...
// static
absl::optional<int> PowerStatusHelper::BucketFor(bool is_playing, bool has_video, media::VideoCodec codec, media::VideoCodecProfile profile,
    gfx::Size natural_size, bool is_fullscreen, absl::optional<int> average_fps)
{
    if (!is_playing)
        return {};
...
void PowerStatusHelper::OnBatteryStatus(device::mojom::blink::BatteryStatusPtr battery_status)
{
    ...
    if (delta_int > 0 && elapsed_msec > 0) {
        ...
        base::LinearHistogram::FactoryGet(BatteryDeltaHistogram(), kMinUmaValue, kMaxUmaValue, kNumUmaBuckets, base::HistogramBase::kUmaTargetedHistogramFlag)
            ->AddCount(*current_bucket_, delta_int);

        base::LinearHistogram::FactoryGet(ElapsedTimeHistogram(), kMinUmaValue, kMaxUmaValue, kNumUmaBuckets, base::HistogramBase::kUmaTargetedHistogramFlag)
