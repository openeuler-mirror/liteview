...
protected:
    ...
    mojo::PendingRemote<media::mojom::VideoDecodeStatsRecorder> SetupRecordInterceptor(RecordInterceptor** interceptor)
    {
        ...
        *interceptor = new RecordInterceptor();
        ...
        mojo::MakeSelfOwnedReceiver(base::WrapUnique(*interceptor), recorder_remote.InitWithNewPipeAndPassReceiver());
