...
public:
    ...
    WebMediaPlayerImpl(WebLocalFrame* frame, WebMediaPlayerClient* client, WebMediaPlayerEncryptedMediaClient* encrypted_client,
    ...
    void EnabledAudioTracksChanged(const WebVector<WebMediaPlayer::TrackId>& enabledTrackIds) override;
    void SelectedVideoTrackChanged(WebMediaPlayer::TrackId* selectedTrackId) override;
...
private:
    ...
    void OnAddTextTrack(const media::TextTrackConfig& config, media::AddTextTrackDoneCB done_cb) override;
    ...
    void DoLoad(LoadType load_type, const WebURL& url, CorsMode cors_mode, bool is_cache_disabled);
    ...
    std::unique_ptr<media::Renderer> CreateRenderer(absl::optional<media::RendererType> renderer_type);
    ...
    void OnEncryptedMediaInitData(media::EmeInitDataType init_data_type, const std::vector<uint8_t>& init_data);
