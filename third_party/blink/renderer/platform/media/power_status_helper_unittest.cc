...
public:
    ...
    // both histograms.
    void VerifyHistogramDelta(int bucket, int battery_delta, base::TimeDelta time_delta)
    {
        ...
        histogram_tester_.ExpectBucketCount(helper_->BatteryDeltaHistogram(), bucket, total_battery_delta);
        histogram_tester_.ExpectBucketCount(helper_->ElapsedTimeHistogram(), bucket, total_time_delta);
    }
...
public:
    absl::optional<int> BucketFor(bool is_playing, bool has_video, media::VideoCodec codec, media::VideoCodecProfile profile, gfx::Size coded_size,
        bool is_fullscreen, absl::optional<int> average_fps)
    {
