...
protected:
    void Initialize(bool is_mse, bool is_encrypted, const gfx::Size& initial_video_size)
    {
        if (wtr_ && IsMonitoring())
            EXPECT_WATCH_TIME_FINALIZED();

        wtr_ = std::make_unique<WatchTimeReporter>(
            media::mojom::PlaybackProperties::New(has_audio_, has_video_, false, false, is_mse, is_encrypted, false, media::mojom::MediaStreamType::kNone),
