...
#define OPT_TARGET(m) ResultOf([](const absl::optional<TargetValue>& v) { return (*v).value(); }, m)
...
class SmoothnessHelperTest : public testing::Test {
    ...
    public:
        MOCK_METHOD4(BeginObservation,
            void(base::UnguessableToken id, const FeatureVector& features, const absl::optional<TargetValue>& default_target,
        ...
        MOCK_METHOD2(UpdateDefaultTarget, void(base::UnguessableToken id, const absl::optional<TargetValue>& default_target));
