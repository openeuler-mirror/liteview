...
public:
    ...
    BoxReflection(ReflectionDirection direction, float offset, sk_sp<PaintRecord> mask, const gfx::RectF& mask_bounds);
    ...
    const sk_sp<PaintRecord>& Mask() const
    {
        return mask_;
    }
...
{
    return a.Direction() == b.Direction() && a.Offset() == b.Offset() && a.Mask() == b.Mask() && a.MaskBounds() == b.MaskBounds();
}
