...
#define EXPECT_DEFAULT_ROOT_CHUNK(size)                                                                                                                        \
    EXPECT_THAT(GetPaintController().PaintChunks(), ElementsAre(IsPaintChunk(0, size, DefaultRootChunkId(), DefaultPaintChunkProperties())))
...
TEST_P(PaintControllerTest, NestedRecorders)
{
    ...
    EXPECT_THAT(GetPaintController().GetDisplayItemList(), ElementsAre(IsSameId(client.Id(), kBackgroundType)));
...
TEST_P(PaintControllerTest, UpdateBasic)
{
    ...
    EXPECT_THAT(GetPaintController().GetDisplayItemList(), ElementsAre(IsSameId(first.Id(), kBackgroundType), IsSameId(first.Id(), kForegroundType)));
...
TEST_P(PaintControllerTest, UpdateNewItemInMiddle)
{
    ...
    EXPECT_THAT(GetPaintController().GetDisplayItemList(), ElementsAre(IsSameId(first.Id(), kBackgroundType), IsSameId(second.Id(), kBackgroundType)));
...
TEST_P(PaintControllerTest, UpdateAddFirstOverlap)
{
    ...
    EXPECT_THAT(GetPaintController().GetDisplayItemList(), ElementsAre(IsSameId(second.Id(), kBackgroundType), IsSameId(second.Id(), kForegroundType)));
...
TEST_P(PaintControllerTest, CachedDisplayItems)
{
    ...
    sk_sp<const PaintRecord> first_paint_record = To<DrawingDisplayItem>(GetPaintController().GetDisplayItemList()[0]).GetPaintRecord();
    sk_sp<const PaintRecord> second_paint_record = To<DrawingDisplayItem>(GetPaintController().GetDisplayItemList()[1]).GetPaintRecord();
    ...
    EXPECT_NE(first_paint_record, To<DrawingDisplayItem>(GetPaintController().GetDisplayItemList()[0]).GetPaintRecord());
    // The second display item should be cached.
    if (!RuntimeEnabledFeatures::PaintUnderInvalidationCheckingEnabled()) {
        EXPECT_EQ(second_paint_record, To<DrawingDisplayItem>(GetPaintController().GetDisplayItemList()[1]).GetPaintRecord());
    }
    EXPECT_TRUE(ClientCacheIsValid(first));
    EXPECT_TRUE(ClientCacheIsValid(second));
...
TEST_P(PaintControllerTest, CachedSubsequenceForcePaintChunk)
{
...

    {
        ...
        GetPaintController().UpdateCurrentPaintChunkProperties(root_id, root, root_properties);
        DrawRect(context, root, kBackgroundType, gfx::Rect(100, 100, 100, 100));

        {
            SubsequenceRecorder r(context, container);
            GetPaintController().UpdateCurrentPaintChunkProperties(container_id, container, container_properties);
...
TEST_P(PaintControllerTest, CachedSubsequenceSwapOrder)
{
...

    {
        ...
        {
            GetPaintController().UpdateCurrentPaintChunkProperties(container1_id, container1, container1_properties);
        ...
        {
            GetPaintController().UpdateCurrentPaintChunkProperties(container2_id, container2, container2_properties);
...
TEST_P(PaintControllerTest, CachedSubsequenceContainingFragments)
{
    ...
    auto paint_container = [this, &context, &container]() {
        ...
        for (wtf_size_t i = 0; i < kFragmentCount; ++i) {
            ...
            ScopedPaintChunkProperties content_chunk_properties(GetPaintController(), DefaultPaintChunkProperties(), container, kBackgroundType);
            DrawRect(context, container, kBackgroundType, gfx::Rect(100, 100, 100, 100));
        }
    };
    ...
    {
        CommitCycleScope cycle_scope(GetPaintController());
        ScopedPaintChunkProperties root_chunk_properties(GetPaintController(), DefaultPaintChunkProperties(), root, kBackgroundType);
        DrawRect(context, root, kBackgroundType, gfx::Rect(100, 100, 100, 100));
        paint_container();
        DrawRect(context, root, kForegroundType, gfx::Rect(100, 100, 100, 100));
    }
    ...
    // The second paint.
    {
        ...
        if (RuntimeEnabledFeatures::PaintUnderInvalidationCheckingEnabled()) {
            EXPECT_FALSE(GetPaintController().UseCachedSubsequenceIfPossible(container));
            paint_container();
        } else {
            EXPECT_TRUE(GetPaintController().UseCachedSubsequenceIfPossible(container));
        }
...
TEST_P(PaintControllerTest, CachedNestedSubsequenceUpdate)
{
...

    {
        ...
        {
            SubsequenceRecorder r(context, container1);
            GetPaintController().UpdateCurrentPaintChunkProperties(container1_background_id, container1, container1_background_properties);
            DrawRect(context, container1, kBackgroundType, gfx::Rect(100, 100, 100, 100));

            {
                SubsequenceRecorder inner_r(context, content1);
                GetPaintController().UpdateCurrentPaintChunkProperties(content1_id, content1, content1_properties);
                DrawRect(context, content1, kBackgroundType, gfx::Rect(100, 100, 50, 200));
                DrawRect(context, content1, kForegroundType, gfx::Rect(100, 100, 50, 200));
            }
            GetPaintController().UpdateCurrentPaintChunkProperties(container1_foreground_id, container1, container1_foreground_properties);
            DrawRect(context, container1, kForegroundType, gfx::Rect(100, 100, 100, 100));
        }
        {
            SubsequenceRecorder r(context, container2);
            GetPaintController().UpdateCurrentPaintChunkProperties(container2_background_id, container2, container2_background_properties);
            DrawRect(context, container2, kBackgroundType, gfx::Rect(100, 200, 100, 100));
            {
                SubsequenceRecorder inner_r(context, content2);
                GetPaintController().UpdateCurrentPaintChunkProperties(content2_id, content2, content2_properties);
                DrawRect(context, content2, kBackgroundType, gfx::Rect(100, 200, 50, 200));
            }
        }
    }
...
TEST_P(PaintControllerTest, CachedNestedSubsequenceKeepingDescendants)
{
    ...
    {
        CommitCycleScope cycle_scope(GetPaintController());
        GetPaintController().UpdateCurrentPaintChunkProperties(root_id, root, properties);
...
TEST_P(PaintControllerTest, SkipCache)
{
    ...
    sk_sp<const PaintRecord> record1 = To<DrawingDisplayItem>(GetPaintController().GetDisplayItemList()[1]).GetPaintRecord();
    sk_sp<const PaintRecord> record2 = To<DrawingDisplayItem>(GetPaintController().GetDisplayItemList()[2]).GetPaintRecord();
    ...
    EXPECT_THAT(GetPaintController().GetDisplayItemList(),
        ElementsAre(IsSameId(multicol.Id(), kBackgroundType), IsSameId(content.Id(), kForegroundType), IsSameId(content.Id(), kForegroundType)));
    EXPECT_NE(record1, To<DrawingDisplayItem>(GetPaintController().GetDisplayItemList()[1]).GetPaintRecord());
    EXPECT_NE(record2, To<DrawingDisplayItem>(GetPaintController().GetDisplayItemList()[2]).GetPaintRecord());
    EXPECT_DEFAULT_ROOT_CHUNK(3);

    {
        ...
        const auto& display_item_list = GetPaintController().GetNewPaintArtifactShared()->GetDisplayItemList();
        EXPECT_THAT(display_item_list,
            ElementsAre(IsSameId(multicol.Id(), kBackgroundType), IsSameId(content.Id(), kForegroundType), IsSameId(content.Id(), kForegroundType),
                IsSameId(content.Id(), kForegroundType)));
        EXPECT_NE(record1, To<DrawingDisplayItem>(display_item_list[1]).GetPaintRecord());
        EXPECT_NE(record2, To<DrawingDisplayItem>(display_item_list[2]).GetPaintRecord());
    }
    EXPECT_DEFAULT_ROOT_CHUNK(4);
}
...
TEST_P(PaintControllerTest, PartialSkipCache)
{
    ...
    sk_sp<const PaintRecord> record0 = To<DrawingDisplayItem>(GetPaintController().GetDisplayItemList()[0]).GetPaintRecord();
    sk_sp<const PaintRecord> record1 = To<DrawingDisplayItem>(GetPaintController().GetDisplayItemList()[1]).GetPaintRecord();
    sk_sp<const PaintRecord> record2 = To<DrawingDisplayItem>(GetPaintController().GetDisplayItemList()[2]).GetPaintRecord();
    EXPECT_NE(record1, record2);
    ...
    EXPECT_THAT(GetPaintController().GetDisplayItemList(),
        ElementsAre(IsSameId(content.Id(), kBackgroundType), IsSameId(content.Id(), kForegroundType), IsSameId(content.Id(), kForegroundType)));
    EXPECT_NE(record0, To<DrawingDisplayItem>(GetPaintController().GetDisplayItemList()[0]).GetPaintRecord());
    EXPECT_NE(record1, To<DrawingDisplayItem>(GetPaintController().GetDisplayItemList()[1]).GetPaintRecord());
    EXPECT_NE(record2, To<DrawingDisplayItem>(GetPaintController().GetDisplayItemList()[2]).GetPaintRecord());
}
...
TEST_P(PaintControllerTest, SkipCacheDuplicatedItemAndChunkIds)
{
    ...
    EXPECT_THAT(paint_controller.GetDisplayItemList(), ElementsAre(IsSameId(item_client.Id(), kBackgroundType), IsSameId(item_client.Id(), kBackgroundType)));
    ...
    EXPECT_THAT(GetPaintController().PaintChunks(), ElementsAre(IsPaintChunk(0, 1, chunk_id, properties), IsPaintChunk(1, 2, chunk_id, properties)));
...
TEST_P(PaintControllerTest, SmallPaintControllerHasOnePaintChunk)
{
    ...
    EXPECT_THAT(GetPaintController().PaintChunks(), ElementsAre(IsPaintChunk(0, 1)));
}
...
TEST_P(PaintControllerTest, InsertValidItemInFront)
{
    ...
    EXPECT_THAT(GetPaintController().GetDisplayItemList(), ElementsAre(IsSameId(third.Id(), kBackgroundType), IsSameId(fourth.Id(), kBackgroundType)));
    EXPECT_TRUE(first.IsValid());
    EXPECT_TRUE(second.IsValid());
    EXPECT_TRUE(third.IsValid());
    EXPECT_TRUE(fourth.IsValid());
...
{
    auto paint_controller = std::make_unique<PaintController>(PaintController::kTransient);
    GraphicsContext context(*paint_controller);
    FakeDisplayItemClient& client = *MakeGarbageCollected<FakeDisplayItemClient>("client");
...
#if DCHECK_IS_ON()
        EXPECT_DEATH(GetPaintController().RecordRegionCaptureData(client, kCropId, kBounds), "Check failed: !crop_id->is_zero");
    }
#else
