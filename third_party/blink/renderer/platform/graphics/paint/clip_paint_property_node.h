...
class PLATFORM_EXPORT ClipPaintPropertyNodeOrAlias : public PaintPropertyNode<ClipPaintPropertyNodeOrAlias, ClipPaintPropertyNode> {
public:
...
public:
    static scoped_refptr<ClipPaintPropertyNodeAlias> Create(const ClipPaintPropertyNodeOrAlias& parent)
    {
        return base::AdoptRef(new ClipPaintPropertyNodeAlias(parent));
    }

    PaintPropertyChangeType SetParent(const ClipPaintPropertyNodeOrAlias& parent)
    {
...
private:
    explicit ClipPaintPropertyNodeAlias(const ClipPaintPropertyNodeOrAlias& parent)
        : ClipPaintPropertyNodeOrAlias(parent, kParentAlias)
    {
    }
};

class PLATFORM_EXPORT ClipPaintPropertyNode : public ClipPaintPropertyNodeOrAlias {
public:
    ...
    public:
        State(scoped_refptr<const TransformPaintPropertyNodeOrAlias> local_transform_space, const gfx::RectF& layout_clip_rect,
        ...
        State(scoped_refptr<const TransformPaintPropertyNodeOrAlias> local_transform_space, scoped_refptr<const EffectPaintPropertyNode> pixel_moving_filter)
            : local_transform_space(std::move(local_transform_space))
        ...
        scoped_refptr<const TransformPaintPropertyNodeOrAlias> local_transform_space;
    ...
    static scoped_refptr<ClipPaintPropertyNode> Create(const ClipPaintPropertyNodeOrAlias& parent, State&& state)
    {
    ...
    const absl::optional<Path>& ClipPath() const
    {
...
private:
    friend class PaintPropertyNode<ClipPaintPropertyNodeOrAlias, ClipPaintPropertyNode>;

    ClipPaintPropertyNode(const ClipPaintPropertyNodeOrAlias* parent, State&& state)
        : ClipPaintPropertyNodeOrAlias(parent)
        , state_(std::move(state))
    {
    }
