...
public:
    DISABLE_CFI_PERF
    DrawingDisplayItem(DisplayItemClientId client_id, Type type, const gfx::Rect& visual_rect, sk_sp<const PaintRecord> record,
        RasterEffectOutset raster_effect_outset, PaintInvalidationReason paint_invalidation_reason = PaintInvalidationReason::kJustCreated);
...
private:
    ...
    static gfx::Rect TightenVisualRect(const gfx::Rect& visual_rect, sk_sp<const PaintRecord>& record);
...
DISABLE_CFI_PERF
inline DrawingDisplayItem::DrawingDisplayItem(DisplayItemClientId client_id, Type type, const gfx::Rect& visual_rect, sk_sp<const PaintRecord> record,
    RasterEffectOutset raster_effect_outset, PaintInvalidationReason paint_invalidation_reason)
    : DisplayItem(client_id, type, UNLIKELY(ShouldTightenVisualRect(record)) ? TightenVisualRect(visual_rect, record) : visual_rect, raster_effect_outset,
