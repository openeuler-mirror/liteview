...
public:
    ...
    {
        return CullRect(LayoutRect::InfiniteIntRect());
    }

    bool IsInfinite() const
    {
        return rect_ == LayoutRect::InfiniteIntRect();
    }
    ...
    bool HasScrolledEnough(const gfx::Vector2dF& delta, const TransformPaintPropertyNode&);
...
private:
    ...
    bool ApplyScrollTranslation(const TransformPaintPropertyNode& root_transform, const TransformPaintPropertyNode& scroll_translation);
    ...
    bool ChangedEnough(const CullRect& old_cull_rect, const absl::optional<gfx::Rect>& expansion_bounds) const;
