...
#define DEFINE_PAINT_PHASE_CONVERSION_METHOD(Category)                                                                                                         \
    ...
    void PropertiesAsJSON(JSONObject&, const PaintArtifact&, bool client_known_to_be_alive = false) const;
#endif
...
template <> struct DefaultHash<blink::DisplayItem::Id::HashKey> {
    struct Hash {
        STATIC_ONLY(Hash);
        using Key = blink::DisplayItem::Id::HashKey;
