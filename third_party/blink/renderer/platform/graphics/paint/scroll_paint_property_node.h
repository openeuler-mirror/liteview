...
// geometry directly.
class PLATFORM_EXPORT ScrollPaintPropertyNode : public PaintPropertyNode<ScrollPaintPropertyNode, ScrollPaintPropertyNode> {
public:
    ...
    public:
        ...
        MainThreadScrollingReasons main_thread_scrolling_reasons = cc::MainThreadScrollingReason::kNotScrollingOnMain;
    ...
    static scoped_refptr<ScrollPaintPropertyNode> Create(const ScrollPaintPropertyNode& parent, State&& state)
    {
        return base::AdoptRef(new ScrollPaintPropertyNode(&parent, std::move(state)));
    }
    static scoped_refptr<ScrollPaintPropertyNode> CreateAlias(const ScrollPaintPropertyNode&)
    {
    ...
    {
        return state_.main_thread_scrolling_reasons & cc::MainThreadScrollingReason::kThreadedScrollingDisabled;
    }
    ...
    {
        return state_.main_thread_scrolling_reasons & cc::MainThreadScrollingReason::kHasBackgroundAttachmentFixedObjects;
    }
