...
class PLATFORM_EXPORT PaintRecordBuilder final : public GarbageCollected<PaintRecordBuilder>, public DisplayItemClient {
public:
    ...
    // |replay_state|.
    sk_sp<PaintRecord> EndRecording(const PropertyTreeState& replay_state = PropertyTreeState::Root());
