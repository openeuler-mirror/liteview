...
class PLATFORM_EXPORT EffectPaintPropertyNodeOrAlias : public PaintPropertyNode<EffectPaintPropertyNodeOrAlias, EffectPaintPropertyNode> {
public:
...
public:
    static scoped_refptr<EffectPaintPropertyNodeAlias> Create(const EffectPaintPropertyNodeOrAlias& parent)
    {
        return base::AdoptRef(new EffectPaintPropertyNodeAlias(parent));
    }

    PaintPropertyChangeType SetParent(const EffectPaintPropertyNodeOrAlias& parent)
    {
...
private:
    explicit EffectPaintPropertyNodeAlias(const EffectPaintPropertyNodeOrAlias& parent)
        : EffectPaintPropertyNodeOrAlias(parent, kParentAlias)
    {
    }
};

class PLATFORM_EXPORT EffectPaintPropertyNode : public EffectPaintPropertyNodeOrAlias {
public:
    ...
    static scoped_refptr<EffectPaintPropertyNode> Create(const EffectPaintPropertyNodeOrAlias& parent, State&& state)
    {
        return base::AdoptRef(new EffectPaintPropertyNode(&parent, std::move(state)));
    }
    ...
    const blink::DocumentTransitionSharedElementId& DocumentTransitionSharedElementId() const
    {
...
private:
    EffectPaintPropertyNode(const EffectPaintPropertyNodeOrAlias* parent, State&& state)
        : EffectPaintPropertyNodeOrAlias(parent)
        , state_(std::move(state))
    {
    }
