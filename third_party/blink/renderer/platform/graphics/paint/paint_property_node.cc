...
template <typename NodeType> int NodeDepthOrFoundAncestor(const NodeType& node, const NodeType& maybe_ancestor)
{
    int depth = 0;
...
template <typename NodeType> const NodeType& LowestCommonAncestorTemplate(const NodeType& a, const NodeType& b)
{
    // Measure both depths.
...
const TransformPaintPropertyNodeOrAlias& LowestCommonAncestorInternal(const TransformPaintPropertyNodeOrAlias& a, const TransformPaintPropertyNodeOrAlias& b)
{
    return LowestCommonAncestorTemplate(a, b);
}

const ClipPaintPropertyNodeOrAlias& LowestCommonAncestorInternal(const ClipPaintPropertyNodeOrAlias& a, const ClipPaintPropertyNodeOrAlias& b)
{
    return LowestCommonAncestorTemplate(a, b);
}

const EffectPaintPropertyNodeOrAlias& LowestCommonAncestorInternal(const EffectPaintPropertyNodeOrAlias& a, const EffectPaintPropertyNodeOrAlias& b)
{
    return LowestCommonAncestorTemplate(a, b);
}

const ScrollPaintPropertyNode& LowestCommonAncestorInternal(const ScrollPaintPropertyNode& a, const ScrollPaintPropertyNode& b)
{
    return LowestCommonAncestorTemplate(a, b);
}
