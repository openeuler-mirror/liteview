...
public:
    ...
    sk_sp<PaintRecord> GetPaintRecord(const PropertyTreeState& replay_state) const;
    ...
    void AppendChunksAsJSON(wtf_size_t start_chunk_index, wtf_size_t end_chunk_index, JSONArray&, unsigned flags) const;
