...
protected:
    ...
    static GeometryMapperTransformCache::ScreenTransform* GetScreenTransform(const TransformPaintPropertyNode& node)
    {
    ...
    static void CheckRootAsPlaneRoot(const TransformPaintPropertyNode& node, const TransformPaintPropertyNode& root_of_2d_translation,
        const TransformationMatrix& to_plane_root, double translate_x, double translate_y)
    {
        const auto& cache = GetTransformCache(node);
    ...
    static void CheckPlaneRootSameAs2dTranslationRoot(const TransformPaintPropertyNode& node, const TransformationMatrix& to_screen,
    ...
    static void CheckPlaneRootDifferent2dTranslationRoot(const TransformPaintPropertyNode& node, const TransformationMatrix& to_screen,
        const TransformPaintPropertyNode& plane_root, const TransformationMatrix& to_plane_root, const TransformPaintPropertyNode& root_of_2d_translation,
