...
public:
    ...
    static scoped_refptr<AcceleratedStaticBitmapImage> CreateFromCanvasMailbox(const gpu::Mailbox&, const gpu::SyncToken&, GLuint shared_image_texture_id,
        const SkImageInfo& sk_image_info, GLenum texture_target, bool is_origin_top_left, base::WeakPtr<WebGraphicsContext3DProviderWrapper>,
        ...
        bool supports_display_compositing, bool is_overlay_candidate);
    ...
    scoped_refptr<StaticBitmapImage> ConvertToColorSpace(sk_sp<SkColorSpace>, SkColorType) override;
    ...
    bool CopyToResourceProvider(CanvasResourceProvider* resource_provider) override;
...
private:
    ...
    AcceleratedStaticBitmapImage(const gpu::Mailbox&, const gpu::SyncToken&, GLuint shared_image_texture_id, const SkImageInfo& sk_image_info,
