...
protected:
    ...
    scoped_refptr<ParkableImage> MakeParkableImageForTesting(const char* buffer, size_t length)
    {
    ...
    static bool IsSameContent(scoped_refptr<ParkableImage> pi, const char* buffer, size_t length)
    {
        if (pi->size() != length) {
            return false;
        }
    ...
    void ExpectWriteStatistics(base::HistogramBase::Sample sample, base::HistogramBase::Count expected_count)
    {
        ...
        histogram_tester_.ExpectTotalCount("Memory.ParkableImage.Write.Throughput", expected_count);
    ...
    void ExpectReadStatistics(base::HistogramBase::Sample sample, base::HistogramBase::Count expected_count)
    {
        ...
        histogram_tester_.ExpectTotalCount("Memory.ParkableImage.Read.TimeSinceFreeze", expected_count);
    }
...
TEST_F(ParkableImageTest, ManagerStatistics5min)
{
    ...
    histogram_tester_.ExpectTotalCount("Memory.ParkableImage.DiskIsUsable.5min", 1);
...
TEST_F(ParkableImageNoParkingTest, ManagerStatistics5min)
{
    ...
    histogram_tester_.ExpectTotalCount("Memory.ParkableImage.DiskIsUsable.5min", 0);
    histogram_tester_.ExpectTotalCount("Memory.ParkableImage.OnDiskFootprintKb.5min", 0);
    histogram_tester_.ExpectTotalCount("Memory.ParkableImage.OnDiskSize.5min", 1);
