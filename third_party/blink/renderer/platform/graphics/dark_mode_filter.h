...
public:
    ...
    SkColor InvertColorIfNeeded(SkColor color, ElementRole role, SkColor contrast_background);

    absl::optional<cc::PaintFlags> ApplyToFlagsIfNeeded(const cc::PaintFlags& flags, ElementRole role, SkColor contrast_background);
    ...
    sk_sp<SkColorFilter> GenerateImageFilter(const SkPixmap& pixmap, const SkIRect& src) const;
...
private:
    ...
    SkColor AdjustDarkenColor(SkColor color, DarkModeFilter::ElementRole role, SkColor contrast_background);
