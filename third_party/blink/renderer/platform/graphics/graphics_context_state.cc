...
const cc::PaintFlags& GraphicsContextState::StrokeFlags(const int stroked_path_length, const int dash_thickness, const bool closed_path) const
{
    stroke_data_.SetupPaintDashPathEffect(&stroke_flags_, stroked_path_length, dash_thickness, closed_path);
...
void GraphicsContextState::SetLineDash(const DashArray& dashes, float dash_offset)
{
