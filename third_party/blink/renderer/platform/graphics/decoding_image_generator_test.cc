...
scoped_refptr<SegmentReader> CreateSegmentReader(char* reference_data, size_t data_length)
{
...
TEST_F(DecodingImageGeneratorTest, CreateWithNoSize)
{
    ...
    EXPECT_EQ(nullptr, DecodingImageGenerator::CreateAsSkImageGenerator(CreateSegmentReader(reference_data, kDefaultTestSize)->GetAsSkData()));
}
...
TEST_F(DecodingImageGeneratorTest, CreateWithNullImageDecoder)
{
    ...
    EXPECT_EQ(nullptr, DecodingImageGenerator::CreateAsSkImageGenerator(CreateSegmentReader(reference_data, kTooShortForSignature)->GetAsSkData()));
}
