...
public:
    ...
    DrawingBufferForTests(std::unique_ptr<WebGraphicsContext3DProvider> context_provider, const Platform::GraphicsInfo& graphics_info,
        ...
        : DrawingBuffer(std::move(context_provider), graphics_info, false /* usingSwapChain */, false /* desynchronized */, std::move(extensions_util), client,
            false /* discardFramebufferSupported */, true /* wantAlphaChannel */, true /* premultipliedAlpha */, preserve, kWebGL1, false /* wantDepth */,
            false /* wantStencil */, DrawingBuffer::kAllowChromiumImage /* ChromiumImageUsage */, cc::PaintFlags::FilterQuality::kLow,
            PredefinedColorSpace::kSRGB, CanvasPixelFormat::kUint8, gl::GpuPreference::kHighPerformance)
        , live_(nullptr)
    {
    }
    ...
    {
        return static_cast<viz::TestSharedImageInterface*>(ContextProvider()->SharedImageInterface());
    }
