...
private:
    struct PLATFORM_EXPORT ColorBuffer : public base::RefCountedThreadSafe<ColorBuffer> {
        ColorBuffer(base::WeakPtr<XRWebGLDrawingBuffer>, const gfx::Size&, const gpu::Mailbox& mailbox, GLuint texture_id);
