...
std::unique_ptr<RecyclableCanvasResource> DawnControlClientHolder::GetOrCreateCanvasResource(const SkImageInfo& info, bool is_origin_top_left)
{
    return recyclable_resource_cache_.GetOrCreateCanvasResource(info, is_origin_top_left);
}
