...
public:
    ...
    scoped_refptr<WebGPUMailboxTexture> GetNewTexture(const WGPUTextureDescriptor& desc, SkAlphaType alpha_type);
    ...
    struct WebGPUMailboxTextureAndSize {
        ...
        WebGPUMailboxTextureAndSize(scoped_refptr<WebGPUMailboxTexture> mailbox_texture, gfx::Size size)
...
private:
    ...
    struct SwapBuffer : WTF::RefCounted<SwapBuffer> {
        SwapBuffer(base::WeakPtr<WebGraphicsContext3DProviderWrapper> context_provider, gpu::Mailbox mailbox, gpu::SyncToken creation_token, gfx::Size size);
    ...
    scoped_refptr<WebGPUSwapBufferProvider::SwapBuffer> NewOrRecycledSwapBuffer(
        gpu::SharedImageInterface* sii, base::WeakPtr<WebGraphicsContext3DProviderWrapper> context_provider, const gfx::Size& size, SkAlphaType alpha_type);
