...
void WebGPURecyclableResourceCacheTest::SetUp()
{
    ...
    recyclable_resource_cache_
        = std::make_unique<WebGPURecyclableResourceCache>(SharedGpuContext::ContextProviderWrapper(), base::ThreadTaskRunnerHandle::Get());
}
...
TEST_F(WebGPURecyclableResourceCacheTest, MRUSameSize)
{
    ...
    std::unique_ptr<RecyclableCanvasResource> provider_holder_0 = recyclable_resource_cache_->GetOrCreateCanvasResource(kInfo, /*is_origin_top_left=*/true);
    returned_resource_providers.push_back(provider_holder_0->resource_provider());

    std::unique_ptr<RecyclableCanvasResource> provider_holder_1 = recyclable_resource_cache_->GetOrCreateCanvasResource(kInfo, /*is_origin_top_left=*/true);
    ...
    std::unique_ptr<RecyclableCanvasResource> provider_holder_2 = recyclable_resource_cache_->GetOrCreateCanvasResource(kInfo, /*is_origin_top_left=*/true);
...
TEST_F(WebGPURecyclableResourceCacheTest, DifferentSize)
{
    ...
    std::unique_ptr<RecyclableCanvasResource> provider_holder_0 = recyclable_resource_cache_->GetOrCreateCanvasResource(kInfos[0], /*is_origin_top_left=*/true);
    returned_resource_providers.push_back(provider_holder_0->resource_provider());

    std::unique_ptr<RecyclableCanvasResource> provider_holder_1 = recyclable_resource_cache_->GetOrCreateCanvasResource(kInfos[1], /*is_origin_top_left=*/true);
    returned_resource_providers.push_back(provider_holder_1->resource_provider());
    ...
    std::unique_ptr<RecyclableCanvasResource> provider_holder_2 = recyclable_resource_cache_->GetOrCreateCanvasResource(kInfos[0], /*is_origin_top_left=*/true);
    returned_resource_providers.push_back(provider_holder_2->resource_provider());

    std::unique_ptr<RecyclableCanvasResource> provider_holder_3 = recyclable_resource_cache_->GetOrCreateCanvasResource(kInfos[1], /*is_origin_top_left=*/true);
...
TEST_F(WebGPURecyclableResourceCacheTest, CacheMissHit)
{
    ...
    std::unique_ptr<RecyclableCanvasResource> provider_holder_0 = recyclable_resource_cache_->GetOrCreateCanvasResource(info_0, /*is_origin_top_left=*/true);
    returned_resource_providers.push_back(provider_holder_0->resource_provider());
    ...
    std::unique_ptr<RecyclableCanvasResource> provider_holder_1 = recyclable_resource_cache_->GetOrCreateCanvasResource(info_1, /*is_origin_top_left=*/true);
    returned_resource_providers.push_back(provider_holder_1->resource_provider());
    ...
    const auto info_2 = SkImageInfo::Make(10, 10, kRGBA_8888_SkColorType, kPremul_SkAlphaType);
    std::unique_ptr<RecyclableCanvasResource> provider_holder_2 = recyclable_resource_cache_->GetOrCreateCanvasResource(info_2, /*is_origin_top_left=*/false);
    returned_resource_providers.push_back(provider_holder_2->resource_provider());
    ...
    const SkImageInfo info_3 = SkImageInfo::Make(10, 10, kRGBA_8888_SkColorType, kPremul_SkAlphaType, SkColorSpace::MakeSRGBLinear());
    std::unique_ptr<RecyclableCanvasResource> provider_holder_3 = recyclable_resource_cache_->GetOrCreateCanvasResource(info_3, /*is_origin_top_left=*/true);
    returned_resource_providers.push_back(provider_holder_3->resource_provider());
    ...
    const SkImageInfo info_4 = SkImageInfo::Make(10, 10, kRGBA_F16_SkColorType, kPremul_SkAlphaType);
    std::unique_ptr<RecyclableCanvasResource> provider_holder_4 = recyclable_resource_cache_->GetOrCreateCanvasResource(info_4, /*is_origin_top_left=*/true);
    ...
    const auto info_5 = SkImageInfo::Make(10, 10, kRGBA_8888_SkColorType, kOpaque_SkAlphaType);
    std::unique_ptr<RecyclableCanvasResource> provider_holder_5 = recyclable_resource_cache_->GetOrCreateCanvasResource(info_5, /*is_origin_top_left=*/true);
    ...
    std::unique_ptr<RecyclableCanvasResource> provider_holder_6 = recyclable_resource_cache_->GetOrCreateCanvasResource(info_0, /*is_origin_top_left=*/true);
    ...
    for (int i = 0; i < wait_count; i++) {
        if (i == 1) {
            ...
            std::unique_ptr<RecyclableCanvasResource> provider_holder_1
                = recyclable_resource_cache_->GetOrCreateCanvasResource(kInfo, /*is_origin_top_left=*/true);
            returned_resource_providers.push_back(provider_holder_1->resource_provider());
