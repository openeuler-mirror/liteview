...
TEST_F(CanvasResourceProviderTest, CanvasResourceProviderAcceleratedOverlay)
{
    ...
    auto provider
        = CanvasResourceProvider::CreateSharedImageProvider(kInfo, cc::PaintFlags::FilterQuality::kMedium, CanvasResourceProvider::ShouldInitialize::kCallClear,
            context_provider_wrapper_, RasterMode::kGPU, true /*is_origin_top_left*/, shared_image_usage_flags);
...
TEST_F(CanvasResourceProviderTest, CanvasResourceProviderTexture)
{
    ...
    auto provider
        = CanvasResourceProvider::CreateSharedImageProvider(kInfo, cc::PaintFlags::FilterQuality::kLow, CanvasResourceProvider::ShouldInitialize::kCallClear,
            context_provider_wrapper_, RasterMode::kGPU, true /*is_origin_top_left*/, 0u /*shared_image_usage_flags*/);
...
TEST_F(CanvasResourceProviderTest, CanvasResourceProviderUnacceleratedOverlay)
{
    ...
    const uint32_t shared_image_usage_flags = gpu::SHARED_IMAGE_USAGE_DISPLAY_READ | gpu::SHARED_IMAGE_USAGE_SCANOUT;

    auto provider
        = CanvasResourceProvider::CreateSharedImageProvider(kInfo, cc::PaintFlags::FilterQuality::kLow, CanvasResourceProvider::ShouldInitialize::kCallClear,
            context_provider_wrapper_, RasterMode::kCPU, true /*is_origin_top_left*/, shared_image_usage_flags);
...
TEST_F(CanvasResourceProviderTest, CanvasResourceProviderSharedImageResourceRecycling)
{
    ...
    ASSERT_TRUE(resource->PrepareTransferableResource(&transferable_resource, &release_callback, kUnverifiedSyncToken));
...
TEST_F(CanvasResourceProviderTest, CanvasResourceProviderSharedImageStaticBitmapImage)
{
    ...
    EXPECT_EQ(provider->ProduceCanvasResource()->GetOrCreateGpuMailbox(kOrderingBarrier), image->GetMailboxHolder().mailbox);
...
TEST_F(CanvasResourceProviderTest, CanvasResourceProviderSharedImageCopyOnWriteDisabled)
{
    ...
    auto resource = provider->ProduceCanvasResource();
    EXPECT_NE(resource->GetOrCreateGpuMailbox(kOrderingBarrier), provider->ProduceCanvasResource()->GetOrCreateGpuMailbox(kOrderingBarrier));
}
...
TEST_F(CanvasResourceProviderTest, CanvasResourceProviderSharedBitmap)
{
    ...
    CanvasResourceDispatcher resource_dispatcher(
        &client, base::ThreadTaskRunnerHandle::Get(), 1 /* client_id */, 1 /* sink_id */, 1 /* placeholder_canvas_id */, kSize);

    auto provider = CanvasResourceProvider::CreateSharedBitmapProvider(
        kInfo, cc::PaintFlags::FilterQuality::kLow, CanvasResourceProvider::ShouldInitialize::kCallClear, resource_dispatcher.GetWeakPtr());
...
TEST_F(CanvasResourceProviderTest, CanvasResourceProviderDirect3DGpuMemoryBuffer)
{
    ...
    scoped_refptr<ExternalCanvasResource> resource
        = ExternalCanvasResource::Create(mailbox, viz::ReleaseCallback(), gpu::SyncToken(), kInfo, GL_TEXTURE_2D, SharedGpuContext::ContextProviderWrapper(),
            provider->CreateWeakPtr(), cc::PaintFlags::FilterQuality::kMedium, true /*is_origin_top_left*/, true /*is_overlay_candidate*/);
...
TEST_F(CanvasResourceProviderTest, DimensionsExceedMaxTextureSize_SharedImage)
{
    ...
    EXPECT_TRUE(provider->SupportsDirectCompositing());
    provider = CanvasResourceProvider::CreateSharedImageProvider(SkImageInfo::MakeN32Premul(kMaxTextureSize, kMaxTextureSize),
        cc::PaintFlags::FilterQuality::kLow, CanvasResourceProvider::ShouldInitialize::kCallClear, context_provider_wrapper_, RasterMode::kGPU,
        true /*is_origin_top_left*/, 0u /*shared_image_usage_flags*/);
    EXPECT_TRUE(provider->SupportsDirectCompositing());
...
{
    auto provider
        = CanvasResourceProvider::CreateSwapChainProvider(SkImageInfo::MakeN32Premul(kMaxTextureSize - 1, kMaxTextureSize), cc::PaintFlags::FilterQuality::kLow,
            CanvasResourceProvider::ShouldInitialize::kCallClear, context_provider_wrapper_, nullptr /* resource_dispatcher */, true /*is_origin_top_left*/);
    EXPECT_TRUE(provider->SupportsDirectCompositing());
    provider
        = CanvasResourceProvider::CreateSwapChainProvider(SkImageInfo::MakeN32Premul(kMaxTextureSize, kMaxTextureSize), cc::PaintFlags::FilterQuality::kLow,
            CanvasResourceProvider::ShouldInitialize::kCallClear, context_provider_wrapper_, nullptr /* resource_dispatcher */, true /*is_origin_top_left*/);
    EXPECT_TRUE(provider->SupportsDirectCompositing());
    provider
        = CanvasResourceProvider::CreateSwapChainProvider(SkImageInfo::MakeN32Premul(kMaxTextureSize + 1, kMaxTextureSize), cc::PaintFlags::FilterQuality::kLow,
...
TEST_F(CanvasResourceProviderTest, FlushForImage)
{
    ...
    MemoryManagedPaintCanvas* dst_canvas = static_cast<MemoryManagedPaintCanvas*>(dst_provider->Canvas());

    PaintImage paint_image = src_provider->Snapshot()->PaintImageForCurrentFrame();
