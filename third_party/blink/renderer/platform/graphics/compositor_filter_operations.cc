...
void CompositorFilterOperations::AppendDropShadowFilter(gfx::Point offset, float std_deviation, const Color& color)
{
...
{
    return gfx::RectF(filter_operations_.MapRect(gfx::ToEnclosingRect(input_rect), SkMatrix::I()));
}
