...
public:
    ...
    static ColorBehavior Ignore()
    {
        return ColorBehavior(Type::kIgnore);
    }
    bool IsIgnore() const
    {
        return type_ == Type::kIgnore;
    }
    ...
    static ColorBehavior Tag()
    {
        return ColorBehavior(Type::kTag);
    }
    bool IsTag() const
    {
        return type_ == Type::kTag;
    }
    ...
    bool IsTransformToSRGB() const
    {
        return type_ == Type::kTransformToSRGB;
    }
...
template <> struct CrossThreadCopier<blink::ColorBehavior> {
