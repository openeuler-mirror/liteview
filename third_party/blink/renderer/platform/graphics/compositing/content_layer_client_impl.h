...
class PLATFORM_EXPORT ContentLayerClientImpl : public cc::ContentLayerClient, public LayerAsJSONClient {
...
public:
    ...
    void AppendAdditionalInfoAsJSON(LayerTreeFlags, const cc::Layer&, JSONObject&) const override;
