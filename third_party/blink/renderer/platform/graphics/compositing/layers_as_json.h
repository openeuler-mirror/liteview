...
public:
    virtual void AppendAdditionalInfoAsJSON(LayerTreeFlags, const cc::Layer&, JSONObject&) const = 0;
};
...
public:
    ...
    void AddLayer(const cc::Layer& layer, const TransformPaintPropertyNode& transform, const LayerAsJSONClient* json_client);
