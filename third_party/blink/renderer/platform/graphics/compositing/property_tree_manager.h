...
public:
    ...
    // translation.
    int EnsureCompositorScrollNode(const TransformPaintPropertyNode& scroll_offset_translation);

    // Same as above but marks the scroll nodes as being the viewport.
    int EnsureCompositorInnerScrollNode(const TransformPaintPropertyNode& scroll_offset_translation);
    int EnsureCompositorOuterScrollNode(const TransformPaintPropertyNode& scroll_offset_translation);
    ...
    void EnsureCompositorScrollNodes(const Vector<const TransformPaintPropertyNode*>& scroll_translation_nodes);
...
private:
    ...
    static bool SupportsShaderBasedRoundedCorner(const ClipPaintPropertyNode&, CcEffectType type, const EffectPaintPropertyNode* next_effect);
    ...
    void CloseCcEffect();
    void PopulateCcEffectNode(cc::EffectNode&, const EffectPaintPropertyNode& effect, int output_clip_id, bool can_be_shared_element_resource);
    ...
    void CreateCompositorScrollNode(const ScrollPaintPropertyNode&, const cc::TransformNode& scroll_offset_translation, bool is_composited);
