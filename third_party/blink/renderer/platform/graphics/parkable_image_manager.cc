...
BASE_FEATURE(kParkableImagesToDisk, "ParkableImagesToDisk", base::FEATURE_DISABLED_BY_DEFAULT);
...
void ParkableImageManager::RecordStatisticsAfter5Minutes() const
{
    ...
    if (IsParkableImagesToDiskEnabled()) {
        base::UmaHistogramBoolean("Memory.ParkableImage.DiskIsUsable.5min", data_allocator().may_write());
