...
public:
    ...
    virtual scoped_refptr<StaticBitmapImage> ConvertToColorSpace(sk_sp<SkColorSpace>, SkColorType = kN32_SkColorType) = 0;
    ...
    {
        return GetSkImageInfoInternal().alphaType() == SkAlphaType::kPremul_SkAlphaType;
    }
