...
class PLATFORM_EXPORT MemoryManagedPaintCanvas final : public cc::RecordPaintCanvas {
public:
    ...
    MemoryManagedPaintCanvas(cc::DisplayItemList* list, const SkRect& bounds, Client* client);
...
private:
    ...
    HashSet<cc::PaintImage::ContentId, DefaultHash<cc::PaintImage::ContentId>::Hash, WTF::UnsignedWithZeroKeyHashTraits<cc::PaintImage::ContentId>>
        cached_image_ids_;
