...
public:
    static scoped_refptr<PaintRecordPattern> Create(sk_sp<PaintRecord>, const gfx::RectF& record_bounds, RepeatMode);
...
private:
    PaintRecordPattern(sk_sp<PaintRecord>, const gfx::RectF& record_bounds, RepeatMode);
