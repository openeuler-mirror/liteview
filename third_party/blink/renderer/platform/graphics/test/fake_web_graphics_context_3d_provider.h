...
public:
        ...
        , raster_context_provider_(raster_context_provider)
    {
        ...
        if (!raster_context_provider_) {
            ...
            raster_interface_ = std::make_unique<gpu::raster::RasterImplementationGLES>(gl_, nullptr);
        }

        webgpu_interface_ = std::make_unique<gpu::webgpu::WebGPUInterfaceStub>();

        // enable all gpu features.
        for (unsigned feature = 0; feature < gpu::NUMBER_OF_GPU_FEATURE_TYPES; ++feature) {
