...
public:
    ...
    void SubmitCompositorFrame(
        const viz::LocalSurfaceId&, viz::CompositorFrame frame, absl::optional<viz::HitTestRegionList> hit_test_region_list, uint64_t) override
    {
        SubmitCompositorFrame_(&frame);
    }
    MOCK_METHOD1(SubmitCompositorFrame_, void(viz::CompositorFrame*));
    void SubmitCompositorFrameSync(const viz::LocalSurfaceId&, viz::CompositorFrame frame, absl::optional<viz::HitTestRegionList> hit_test_region_list,
        uint64_t, SubmitCompositorFrameSyncCallback cb) override
    {
    ...
    MOCK_METHOD2(DidAllocateSharedBitmap, void(base::ReadOnlySharedMemoryRegion, const gpu::Mailbox&));
