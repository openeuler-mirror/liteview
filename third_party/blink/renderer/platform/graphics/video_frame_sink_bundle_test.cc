...
const viz::LocalSurfaceId kTestSurfaceId(1, base::UnguessableToken::Deserialize(1, 2));
...
TEST_F(VideoFrameSinkBundleTest, PassThrough)
{
    ...
    bundle.SubmitCompositorFrame(2, kTestSurfaceId, viz::MakeDefaultCompositorFrame(), absl::nullopt, 0);
...
TEST_F(VideoFrameSinkBundleTest, BatchSubmissionsDuringOnBeginFrame)
{
    ...
    EXPECT_CALL(mock_client1, OnBeginFrame).Times(1).WillOnce([&] {
        bundle.SubmitCompositorFrame(kTestVideoSinkId1.sink_id(), kTestSurfaceId, viz::MakeDefaultCompositorFrame(), absl::nullopt, 0);
    });
    ...
    EXPECT_CALL(mock_client3, OnBeginFrame).Times(1).WillOnce([&] {
        bundle.SubmitCompositorFrame(kTestVideoSinkId3.sink_id(), kTestSurfaceId, viz::MakeDefaultCompositorFrame(), absl::nullopt, 0);
    });
