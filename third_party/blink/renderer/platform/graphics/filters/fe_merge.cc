...
sk_sp<PaintFilter> FEMerge::CreateImageFilter()
{
    ...
    return sk_make_sp<MergePaintFilter>(input_refs.get(), size, base::OptionalToPtr(crop_rect));
}

WTF::TextStream& FEMerge::ExternalRepresentation(WTF::TextStream& ts, int indent) const
{
