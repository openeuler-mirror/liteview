...
static WTF::TextStream& operator<<(WTF::TextStream& ts, const ColorMatrixType& type)
{
    switch (type) {
    case FECOLORMATRIX_TYPE_UNKNOWN:
        ts << "UNKNOWN";
...
WTF::TextStream& FEColorMatrix::ExternalRepresentation(WTF::TextStream& ts, int indent) const
{
