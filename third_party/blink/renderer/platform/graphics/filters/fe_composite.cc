...
static WTF::TextStream& operator<<(WTF::TextStream& ts, const CompositeOperationType& type)
{
    switch (type) {
...
WTF::TextStream& FEComposite::ExternalRepresentation(WTF::TextStream& ts, int indent) const
{
