...
WTF::TextStream& FilterEffect::ExternalRepresentation(WTF::TextStream& ts, int) const
{
...
{
    sk_sp<SkColorFilter> color_filter = SkColorFilters::Blend(0, SkBlendMode::kClear);
