...
static WTF::TextStream& operator<<(WTF::TextStream& ts, const ChannelSelectorType& type)
{
    switch (type) {
    case CHANNEL_UNKNOWN:
        ts << "UNKNOWN";
...
WTF::TextStream& FEDisplacementMap::ExternalRepresentation(WTF::TextStream& ts, int indent) const
{
