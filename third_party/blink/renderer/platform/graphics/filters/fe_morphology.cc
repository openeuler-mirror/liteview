...
static WTF::TextStream& operator<<(WTF::TextStream& ts, const MorphologyOperatorType& type)
{
    switch (type) {
...
WTF::TextStream& FEMorphology::ExternalRepresentation(WTF::TextStream& ts, int indent) const
{
