...
static WTF::TextStream& operator<<(WTF::TextStream& ts, const TurbulenceType& type)
{
    switch (type) {
...
WTF::TextStream& FETurbulence::ExternalRepresentation(WTF::TextStream& ts, int indent) const
{
