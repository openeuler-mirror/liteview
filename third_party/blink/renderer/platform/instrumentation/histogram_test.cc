...
{
    TestCustomCountHistogram scoped_us_counter("ScopedUsHistogramTimerTest.Basic", 0, 10000000, 50);
    {
...
{
    TestCustomCountHistogram scoped_us_counter("ScopedHighResUsHistogramTimerTest.Basic", 0, 10000000, 50);
    {
