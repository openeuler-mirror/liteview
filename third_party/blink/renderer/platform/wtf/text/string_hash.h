...
inline void HashTraits<String>::ConstructDeletedValue(String& slot, bool zero_value)
{
    HashTraits<scoped_refptr<StringImpl>>::ConstructDeletedValue(slot.impl_, zero_value);
}
...
struct StringHash {
    ...
    static unsigned GetHash(StringImpl* key)
    {
        return key->GetHash();
    }
