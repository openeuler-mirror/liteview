...
WTF::StringTypeAdapter<LChar*>::StringTypeAdapter(LChar* buffer)
    : buffer_(buffer)
    , length_(base::checked_cast<wtf_size_t>(strlen(reinterpret_cast<char*>(buffer))))
{
}
...
WTF::StringTypeAdapter<const LChar*>::StringTypeAdapter(const LChar* buffer)
    : buffer_(buffer)
    , length_(base::checked_cast<wtf_size_t>(strlen(reinterpret_cast<const char*>(buffer))))
{
}
