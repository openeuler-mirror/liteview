...
public:
    ...
    [[nodiscard]] static String CreateUninitialized(unsigned length, UChar*& data)
    {
        return StringImpl::CreateUninitialized(length, data);
    }
    [[nodiscard]] static String CreateUninitialized(unsigned length, LChar*& data)
    {
        return StringImpl::CreateUninitialized(length, data);
    }
    ...
    template <wtf_size_t inlineCapacity> [[nodiscard]] static String Make8BitFrom16BitSource(const Vector<UChar, inlineCapacity>& buffer)
    {
    ...
    [[nodiscard]] static String FromUTF8WithLatin1Fallback(const char* s, size_t length)
    {
...
String::String(const Vector<UChar, inlineCapacity>& vector)
    : impl_(vector.size() ? StringImpl::Create(vector.data(), vector.size()) : StringImpl::empty_)
{
}
