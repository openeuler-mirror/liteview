...
template <> struct HashTraits<MoveOnlyHashValue> : public MoveOnlyHashTraits { };

template <> struct DefaultHash<MoveOnlyHashValue> {
...
template <> struct HashTraits<CountCopy> : public CountCopyHashTraits { };

template <> struct DefaultHash<CountCopy> {
...
template <typename T> struct ValueInstanceCountHash : public PtrHash<const int*> {
...
template <typename T> struct DefaultHash<ValueInstanceCount<T>> {
