...
template <typename Derived, bool needsDestructor> class ConditionalDestructor;

template <typename Derived> class ConditionalDestructor<Derived, true> {
public:
...
template <typename Derived> class ConditionalDestructor<Derived, false> { };
