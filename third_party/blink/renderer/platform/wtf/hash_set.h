...
private:
    typedef HashTable<ValueType, ValueType, IdentityExtractor, HashFunctions, ValueTraits, ValueTraits, Allocator> HashTableType;
...
struct IdentityExtractor {
    ...
    template <typename T> static void ExtractSafe(const T& t, void* out)
    {
...
template <typename Translator> struct HashSetTranslatorAdapter {
    ...
    template <typename T, typename U, typename V> static void Translate(T& location, U&& key, const V&, unsigned hash_code)
    {
...
template <typename T, typename U, typename V, typename W> bool operator==(const HashSet<T, U, V, W>& a, const HashSet<T, U, V, W>& b)
{
    if (a.size() != b.size())
        return false;
...
template <typename T, typename U, typename V, typename W> inline unsigned HashSet<T, U, V, W>::size() const
{
    return impl_.size();
}

template <typename T, typename U, typename V, typename W> inline unsigned HashSet<T, U, V, W>::Capacity() const
{
    return impl_.Capacity();
}

template <typename T, typename U, typename V, typename W> inline bool HashSet<T, U, V, W>::empty() const
{
    return impl_.empty();
}

template <typename T, typename U, typename V, typename W> inline typename HashSet<T, U, V, W>::iterator HashSet<T, U, V, W>::begin() const
{
    return impl_.begin();
}

template <typename T, typename U, typename V, typename W> inline typename HashSet<T, U, V, W>::iterator HashSet<T, U, V, W>::end() const
{
    return impl_.end();
}

template <typename T, typename U, typename V, typename W> inline typename HashSet<T, U, V, W>::iterator HashSet<T, U, V, W>::find(ValuePeekInType value) const
{
...
typename HashSet<Value, HashFunctions, Traits, Allocator>::iterator inline HashSet<Value, HashFunctions, Traits, Allocator>::Find(const T& value) const
{
...
inline typename HashSet<T, U, V, W>::AddResult HashSet<T, U, V, W>::insert(IncomingValueType&& value)
{
...
template <typename Value, typename HashFunctions, typename Traits, typename Allocator>
template <typename HashTranslator, typename T>
inline typename HashSet<Value, HashFunctions, Traits, Allocator>::AddResult HashSet<Value, HashFunctions, Traits, Allocator>::AddWithTranslator(T&& value)
{
...
template <typename T, typename U, typename V, typename W> inline void HashSet<T, U, V, W>::erase(iterator it)
{
    impl_.erase(it.impl_);
}

template <typename T, typename U, typename V, typename W> inline void HashSet<T, U, V, W>::erase(ValuePeekInType value)
{
    erase(find(value));
}

template <typename T, typename U, typename V, typename W> inline void HashSet<T, U, V, W>::clear()
{
    impl_.clear();
}

template <typename T, typename U, typename V, typename W> inline auto HashSet<T, U, V, W>::Take(iterator it) -> ValueType
{
    if (it == end())
...
template <typename T, typename U, typename V, typename W> inline auto HashSet<T, U, V, W>::Take(ValuePeekInType value) -> ValueType
{
    return Take(find(value));
}

template <typename T, typename U, typename V, typename W> inline auto HashSet<T, U, V, W>::TakeAny() -> ValueType
{
    return Take(begin());
}
