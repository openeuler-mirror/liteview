...
inline typename HashCountedSet<T, U, V, W>::AddResult HashCountedSet<T, U, V, W>::insert(const ValueType& value, unsigned count)
{
    DCHECK_GT(count, 0u);
...
template <typename T, typename U, typename V, typename W>
inline typename HashCountedSet<T, U, V, W>::AddResult HashCountedSet<T, U, V, W>::insert(const ValueType& value)
{
    return insert(value, 1u);
}

template <typename T, typename U, typename V, typename W> inline bool HashCountedSet<T, U, V, W>::erase(iterator it)
{
    if (it == end())
        return false;
...
template <typename T, typename U, typename V, typename W> inline void HashCountedSet<T, U, V, W>::RemoveAll(iterator it)
{
    if (it == end())
        return;
...
template <typename T, typename U, typename V, typename W> inline Vector<T> HashCountedSet<T, U, V, W>::AsVector() const
{
    Vector<T> vector;
