...
#define _TEMPLATE_KEYWORD_
#else
#define _TEMPLATE_KEYWORD_ template
#endif
...
template <typename Key, typename Value, typename Extractor, typename HashFunctions, typename Traits, typename KeyTraits, typename Allocator> class HashTable;
template <typename Key, typename Value, typename Extractor, typename HashFunctions, typename Traits, typename KeyTraits, typename Allocator>
class HashTableIterator;
template <typename Key, typename Value, typename Extractor, typename HashFunctions, typename Traits, typename KeyTraits, typename Allocator>
class HashTableConstIterator;
template <WeakHandlingFlag x, typename T, typename U, typename V, typename W, typename X, typename Y, typename Z> struct WeakProcessingHashTableHelper;
...
template <typename HashFunctions, typename Traits, typename Allocator> class IdentityHashTranslator {
...
template <typename Value, typename Extractor, typename KeyTraits> struct HashTableHelper {
    template <typename T> struct AddConstToPtrType {
        using type = T;
    };
    template <typename T> struct AddConstToPtrType<T*> {
        using type = const T*;
    };
...
class HashTable final
    : public ConditionalDestructor<HashTable<Key, Value, Extractor, HashFunctions, Traits, KeyTraits, Allocator>, !Allocator::kIsGarbageCollected> {
    DISALLOW_NEW();
...
public:
    ...
    typedef IdentityHashTranslator<HashFunctions, Traits, Allocator> IdentityTranslatorType;
    ...
    void Finalize()
    {
        static_assert(!Allocator::kIsGarbageCollected, "GCed collections can't be finalized.");
        if (LIKELY(!table_))
            return;
    ...
    {
        return insert<IdentityTranslatorType>(Extractor::Extract(value), std::forward<IncomingValueType>(value));
    }
    ...
    {
        return HashTableHelper<ValueType, Extractor, KeyTraits>::IsEmptyOrDeletedBucket(value);
    }
    ...
    template <typename VisitorDispatcher, typename A = Allocator> std::enable_if_t<A::kIsGarbageCollected> Trace(VisitorDispatcher) const;
...
protected:
    ...
    std::enable_if_t<A::kIsGarbageCollected> TraceTable(VisitorDispatcher, const ValueType* table) const;
...
private:
    ...
    {
        bucket.~ValueType();
        Traits::ConstructDeletedValue(const_cast<ValueType&>(bucket), Allocator::kIsGarbageCollected);
    }
...
template <typename Key, typename Value, typename Extractor, typename HashFunctions, typename Traits, typename KeyTraits, typename Allocator>
void HashTable<Key, Value, Extractor, HashFunctions, Traits, KeyTraits, Allocator>::ReserveCapacityForSize(unsigned new_size)
{
...
{
    DCHECK(!AccessForbidden());
    DCHECK((HashTableKeyChecker<HashTranslator, KeyTraits, HashFunctions::safe_to_compare_to_empty_or_deleted>::CheckKey(key)));
...
template <typename Key, typename Value, typename Extractor, typename HashFunctions, typename Traits, typename KeyTraits, typename Allocator>
template <typename HashTranslator, typename T>
inline typename HashTable<Key, Value, Extractor, HashFunctions, Traits, KeyTraits, Allocator>::LookupType
...
template <typename Key, typename Value, typename Extractor, typename HashFunctions, typename Traits, typename KeyTraits, typename Allocator>
template <typename HashTranslator, typename T>
inline typename HashTable<Key, Value, Extractor, HashFunctions, Traits, KeyTraits, Allocator>::FullLookupType
HashTable<Key, Value, Extractor, HashFunctions, Traits, KeyTraits, Allocator>::FullLookupForWriting(const T& key)
{
    DCHECK(!AccessForbidden());
    DCHECK(table_);
    RegisterModification();
...
template <> struct HashTableBucketInitializer<false> {
    ...
    template <typename Traits, typename Allocator, typename Value> static void Initialize(Value& bucket)
    {
        ConstructTraits<Value, Traits, Allocator>::ConstructAndNotifyElement(&bucket, Traits::EmptyValue());
    }

    template <typename Traits, typename Allocator, typename Value> static void Reinitialize(Value& bucket)
    {
...
{
    HashTableBucketInitializer<Traits::kEmptyValueIsZero>::template Initialize<Traits, Allocator>(bucket);
}

template <typename Key, typename Value, typename Extractor, typename HashFunctions, typename Traits, typename KeyTraits, typename Allocator>
inline void HashTable<Key, Value, Extractor, HashFunctions, Traits, KeyTraits, Allocator>::ReinitializeBucket(ValueType& bucket)
{
    HashTableBucketInitializer<Traits::kEmptyValueIsZero>::template Reinitialize<Traits, Allocator>(bucket);
}

template <typename Key, typename Value, typename Extractor, typename HashFunctions, typename Traits, typename KeyTraits, typename Allocator>
template <typename HashTranslator, typename T, typename Extra>
typename HashTable<Key, Value, Extractor, HashFunctions, Traits, KeyTraits, Allocator>::AddResult
HashTable<Key, Value, Extractor, HashFunctions, Traits, KeyTraits, Allocator>::insert(T&& key, Extra&& extra)
{
    DCHECK(!AccessForbidden());
...
template <typename HashTranslator, typename T, typename Extra>
typename HashTable<Key, Value, Extractor, HashFunctions, Traits, KeyTraits, Allocator>::AddResult
HashTable<Key, Value, Extractor, HashFunctions, Traits, KeyTraits, Allocator>::InsertPassingHashCode(T&& key, Extra&& extra)
{
    DCHECK(!AccessForbidden());
    DCHECK(Allocator::IsAllocationAllowed());
    if (!table_)
...
Value* HashTable<Key, Value, Extractor, HashFunctions, Traits, KeyTraits, Allocator>::Reinsert(ValueType&& entry)
{
    ...
    DCHECK(!IsDeletedBucket(*(LookupForWriting(Extractor::Extract(entry)).first)));
#if DUMP_HASHTABLE_STATS
...
template <typename Key, typename Value, typename Extractor, typename HashFunctions, typename Traits, typename KeyTraits, typename Allocator>
template <typename HashTranslator, typename T>
inline typename HashTable<Key, Value, Extractor, HashFunctions, Traits, KeyTraits, Allocator>::iterator
HashTable<Key, Value, Extractor, HashFunctions, Traits, KeyTraits, Allocator>::Find(const T& key)
{
...
template <typename Key, typename Value, typename Extractor, typename HashFunctions, typename Traits, typename KeyTraits, typename Allocator>
template <typename HashTranslator, typename T>
inline typename HashTable<Key, Value, Extractor, HashFunctions, Traits, KeyTraits, Allocator>::const_iterator
HashTable<Key, Value, Extractor, HashFunctions, Traits, KeyTraits, Allocator>::Find(const T& key) const
{
...
template <typename Key, typename Value, typename Extractor, typename HashFunctions, typename Traits, typename KeyTraits, typename Allocator>
void HashTable<Key, Value, Extractor, HashFunctions, Traits, KeyTraits, Allocator>::erase(const ValueType* pos)
{
    RegisterModification();
#if DUMP_HASHTABLE_STATS
...
template <typename Key, typename Value, typename Extractor, typename HashFunctions, typename Traits, typename KeyTraits, typename Allocator>
inline void HashTable<Key, Value, Extractor, HashFunctions, Traits, KeyTraits, Allocator>::erase(iterator it)
{
    if (it == end())
        return;
...
template <typename Key, typename Value, typename Extractor, typename HashFunctions, typename Traits, typename KeyTraits, typename Allocator>
inline void HashTable<Key, Value, Extractor, HashFunctions, Traits, KeyTraits, Allocator>::erase(const_iterator it)
{
    if (it == end())
        return;
    erase(it.position_);
...
template <typename Key, typename Value, typename Extractor, typename HashFunctions, typename Traits, typename KeyTraits, typename Allocator>
inline void HashTable<Key, Value, Extractor, HashFunctions, Traits, KeyTraits, Allocator>::erase(KeyPeekInType key)
{
    erase(find(key));
}
...
Value* HashTable<Key, Value, Extractor, HashFunctions, Traits, KeyTraits, Allocator>::AllocateTable(unsigned size)
{
    ...
    static_assert(Allocator::kIsGarbageCollected
            || ((!IsDisallowNew<KeyType>::value || !IsTraceable<KeyType>::value) && (!IsDisallowNew<ValueType>::value || !IsTraceable<ValueType>::value)),
        "Cannot put DISALLOW_NEW objects that "
        "have trace methods into an off-heap HashTable");

    if (Traits::kEmptyValueIsZero) {
        result = Allocator::template AllocateZeroedHashTableBacking<ValueType, HashTable>(alloc_size);
    } else {
        result = Allocator::template AllocateHashTableBacking<ValueType, HashTable>(alloc_size);
...
template <typename Key, typename Value, typename Extractor, typename HashFunctions, typename Traits, typename KeyTraits, typename Allocator>
Value* HashTable<Key, Value, Extractor, HashFunctions, Traits, KeyTraits, Allocator>::ExpandBuffer(unsigned new_table_size, Value* entry, bool& success)
{
    success = false;
    ...
    Allocator::_TEMPLATE_KEYWORD_ BackingWriteBarrier(&table_);
...
template <typename Key, typename Value, typename Extractor, typename HashFunctions, typename Traits, typename KeyTraits, typename Allocator>
Value* HashTable<Key, Value, Extractor, HashFunctions, Traits, KeyTraits, Allocator>::RehashTo(ValueType* new_table, unsigned new_table_size, Value* entry)
{
#if DUMP_HASHTABLE_STATS
    if (table_size_ != 0) {
...
template <typename Key, typename Value, typename Extractor, typename HashFunctions, typename Traits, typename KeyTraits, typename Allocator>
Value* HashTable<Key, Value, Extractor, HashFunctions, Traits, KeyTraits, Allocator>::Rehash(unsigned new_table_size, Value* entry)
{
    unsigned old_table_size = table_size_;
...
void HashTable<Key, Value, Extractor, HashFunctions, Traits, KeyTraits, Allocator>::swap(HashTable& other)
{
    ...
    Allocator::_TEMPLATE_KEYWORD_ BackingWriteBarrier(&table_);
    Allocator::_TEMPLATE_KEYWORD_ BackingWriteBarrier(&other.table_);
...
HashTable<Key, Value, Extractor, HashFunctions, Traits, KeyTraits, Allocator>::operator=(const HashTable& other)
{
    HashTable tmp(other);
    swap(tmp);
    return *this;
...
template <typename Key, typename Value, typename Extractor, typename HashFunctions, typename Traits, typename KeyTraits, typename Allocator>
HashTable<Key, Value, Extractor, HashFunctions, Traits, KeyTraits, Allocator>&
HashTable<Key, Value, Extractor, HashFunctions, Traits, KeyTraits, Allocator>::operator=(HashTable&& other)
{
    swap(other);
    return *this;
}

template <WeakHandlingFlag weakHandlingFlag, typename Key, typename Value, typename Extractor, typename HashFunctions, typename Traits, typename KeyTraits,
    typename Allocator>
...
template <typename Key, typename Value, typename Extractor, typename HashFunctions, typename Traits, typename KeyTraits, typename Allocator>
struct WeakProcessingHashTableHelper<kWeakHandling, Key, Value, Extractor, HashFunctions, Traits, KeyTraits, Allocator> {
    STATIC_ONLY(WeakProcessingHashTableHelper);
...
std::enable_if_t<A::kIsGarbageCollected> HashTable<Key, Value, Extractor, HashFunctions, Traits, KeyTraits, Allocator>::Trace(VisitorDispatcher visitor) const
{
    static_assert(WTF::IsWeak<ValueType>::value || IsTraceableInCollectionTrait<Traits>::value, "Value should not be traced");
    TraceTable(visitor, AsAtomicPtr(&table_)->load(std::memory_order_relaxed));
}

template <typename Key, typename Value, typename Extractor, typename HashFunctions, typename Traits, typename KeyTraits, typename Allocator>
template <typename VisitorDispatcher, typename A>
std::enable_if_t<A::kIsGarbageCollected> HashTable<Key, Value, Extractor, HashFunctions, Traits, KeyTraits, Allocator>::TraceTable(
    VisitorDispatcher visitor, const ValueType* table) const
{
    if (!WTF::IsWeak<ValueType>::value) {
        ...
        Allocator::template TraceHashTableBackingWeakly<ValueType, HashTable>(visitor, table, &table_,
            WeakProcessingHashTableHelper<WeakHandlingTrait<ValueType>::value, Key, Value, Extractor, HashFunctions, Traits, KeyTraits, Allocator>::Process,
            this);
    }
}
...
template <typename HashTable, typename Traits> std::ostream& operator<<(std::ostream& stream, const HashTableConstIteratorAdapter<HashTable, Traits>& iterator)
{
...
template <typename HashTable, typename Traits> std::ostream& operator<<(std::ostream& stream, const HashTableIteratorAdapter<HashTable, Traits>& iterator)
{
    return stream << iterator.impl_;
}
