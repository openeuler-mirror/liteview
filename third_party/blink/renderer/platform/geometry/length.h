...
public:
    ...
    {
        return (type_ == o.type_) && (quirk_ == o.quirk_) && (IsNone() || (GetFloatValue() == o.GetFloatValue()) || IsCalculatedEqual(o));
    }
    bool operator!=(const Length& o) const
    {
        return !(*this == o);
    ...
    static Length FillAvailable()
    {
        return Length(kFillAvailable);
    }
    static Length MinContent()
    {
        return Length(kMinContent);
    }
    static Length MaxContent()
    {
        return Length(kMaxContent);
    }
    static Length MinIntrinsic()
    {
        return Length(kMinIntrinsic);
    }
    ...
    {
        return GetType() == kPercent || GetType() == kCalculated || GetType() == kFillAvailable;
    }
    ...
    public:
        ...
        virtual absl::optional<LayoutUnit> EvaluateAnchor(const AtomicString& anchor_name, AnchorValue anchor_value) const;
        virtual absl::optional<LayoutUnit> EvaluateAnchorSize(const AtomicString& anchor_name, AnchorSizeValue anchor_size_value) const;
    };
    float NonNanCalculatedValue(LayoutUnit max_value, const AnchorEvaluator* = nullptr) const;
