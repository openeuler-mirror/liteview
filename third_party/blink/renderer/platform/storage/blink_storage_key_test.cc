...
TEST(BlinkStorageKeyTest, BlinkStorageKeyRoundTripConversion)
{
    ...
    for (const bool toggle : { false, true }) {
        ...
        Vector<BlinkStorageKey> keys = {
            ...
            BlinkStorageKey(origin1, BlinkSchemefulSite(origin2), nullptr, mojom::blink::AncestorChainBit::kCrossSite),
        };
...
TEST(BlinkStorageKey, StorageKeyRoundTripConversion)
{
    ...
    for (const bool toggle : { false, true }) {
        base::test::ScopedFeatureList scope_feature_list;
        scope_feature_list.InitWithFeatureState(net::features::kThirdPartyStoragePartitioning, toggle);
        Vector<StorageKey> storage_keys = { StorageKey(url_origin1), StorageKey(url_origin2), StorageKey(url_origin3), StorageKey(url_origin4),
            StorageKey::CreateWithNonce(url_origin1, nonce), StorageKey::CreateWithNonce(url_origin2, nonce),
            StorageKey::CreateWithOptionalNonce(url_origin1, net::SchemefulSite(url_origin2), nullptr, blink::mojom::AncestorChainBit::kCrossSite) };
...
TEST(BlinkStorageKeyTest, TopLevelSiteGetterWithPartitioningEnabled)
{
    ...
    BlinkStorageKey key_origin1_site1 = BlinkStorageKey(origin1, BlinkSchemefulSite(origin1));
    BlinkStorageKey key_origin1_site2 = BlinkStorageKey(origin1, BlinkSchemefulSite(origin2));
...
TEST(BlinkStorageKeyTest, CopyWithForceEnabledThirdPartyStoragePartitioning)
{
    ...
    for (const bool toggle : { false, true }) {
        ...
        BlinkStorageKey storage_key(origin1, BlinkSchemefulSite(origin2), nullptr, mojom::blink::AncestorChainBit::kCrossSite);
