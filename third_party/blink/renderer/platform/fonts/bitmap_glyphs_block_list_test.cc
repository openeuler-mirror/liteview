...
static void TestBitmapGlyphsBlockListed(AtomicString windows_family_name, bool block_listed_expected)
{
    ...
    font_family.SetFamily(windows_family_name, FontFamily::InferredTypeFor(windows_family_name));
    font_description.SetFamily(font_family);
    scoped_refptr<SimpleFontData> simple_font_data = font_cache.GetFontData(font_description, windows_family_name);
