...
static inline const ShapeResultTestInfo* TestInfo(scoped_refptr<const ShapeResult>& result)
{
...
{
    const UChar kStr[] = { 'A', // code point for verticalRightOrientationFontData()
...
TEST_F(CachingWordShaperTest, GlyphBoundsWithSpaces)
{
    ...
    float periods_and_spaces_width = shaper.Width(periods_and_spaces, nullptr, &periods_and_spaces_glyph_bounds);
