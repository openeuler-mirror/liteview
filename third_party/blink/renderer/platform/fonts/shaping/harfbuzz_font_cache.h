...
public:
    ...
    scoped_refptr<HarfBuzzFontData> GetOrCreateFontData(FontPlatformData* platform_data);

private:
    using FontDataMap = HashMap<uint64_t, scoped_refptr<HarfBuzzFontData>, WTF::IntHash<uint64_t>, WTF::UnsignedWithZeroKeyHashTraits<uint64_t>>;
