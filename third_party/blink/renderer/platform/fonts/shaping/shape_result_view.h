...
class PLATFORM_EXPORT ShapeResultView final : public RefCounted<ShapeResultView> {
public:
    ...
    static scoped_refptr<ShapeResultView> Create(base::span<const Segment> segments);

    // Creates a new ShapeResultView from a single segment.
    static scoped_refptr<ShapeResultView> Create(const ShapeResult*);
    static scoped_refptr<ShapeResultView> Create(const ShapeResult*, unsigned start_index, unsigned end_index);
    static scoped_refptr<ShapeResultView> Create(const ShapeResultView*, unsigned start_index, unsigned end_index);
...
private:
    ...
    template <class ShapeResultType> RunInfoPart* PopulateRunInfoParts(const ShapeResultType& result, const Segment& segment, RunInfoPart* part);
