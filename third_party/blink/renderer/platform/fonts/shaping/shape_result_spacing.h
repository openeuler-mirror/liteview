...
public:
    ...
    {
        return has_spacing_ ? letter_spacing_ : .0f;
    }
    float WordSpacing() const
    {
        return has_spacing_ ? word_spacing_ : .0f;
    }
    ...
    void SetExpansion(float expansion, TextDirection, bool allows_leading_expansion = false, bool allows_trailing_expansion = false);
    ...
    {
        ComputeSpacingParameters parameters;
        parameters.index = index;
        return ComputeSpacing(parameters, offset);
    }
    float ComputeSpacing(const ComputeSpacingParameters& parameters, float& offset);
