...
public:
    ...
    Vector<CharacterRange> IndividualCharacterRanges(TextDirection, float total_width) const;
    Vector<double> IndividualCharacterAdvances(const StringView&, TextDirection, float total_width) const;
...
private:
    ...
    static void AddRunInfoAdvances(const ShapeResult::RunInfo& run_info, double offset, Vector<double>& advances);
