...
void WebFontRenderStyle::ApplyToSkFont(SkFont* font, bool should_use_subpixel_positioning) const
{
    ...
    bool force_subpixel_positioning = !WebTestSupport::IsRunningWebTest() && (sk_hint_style != SkFontHinting::kFull || should_use_subpixel_positioning);
