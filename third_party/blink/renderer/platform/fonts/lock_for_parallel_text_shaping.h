...
public:
    ...
    LockForParallelTextShaping& operator=(const LockForParallelTextShaping&) = delete;
...
using AutoLockForParallelTextShaping = base::internal::BasicAutoLock<LockForParallelTextShaping>;
