...
protected:
    void CheckRuns(const Vector<OrientationTestRun>& runs)
    {
        ...
        OrientationIterator orientation_iterator(text.Characters16(), text.length(), FontOrientation::kVerticalMixed);
...
TEST_F(OrientationIteratorTest, Empty)
{
    ...
    OrientationIterator orientation_iterator(empty.Characters16(), empty.length(), FontOrientation::kVerticalMixed);
    unsigned limit = 0;
