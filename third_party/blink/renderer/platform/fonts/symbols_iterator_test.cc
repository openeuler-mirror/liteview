...
{
    CheckRuns({ { "#", FontFallbackPriority::kText }, { "#\uFE0F\u20E3", FontFallbackPriority::kEmojiEmoji }, { "#", FontFallbackPriority::kText } });
}

TEST_F(SymbolsIteratorTest, EmojiVS15AndVS16)
{
    CheckRuns({ { "\U0001F642", FontFallbackPriority::kEmojiEmoji }, { "\U0001F642\U0000FE0E", FontFallbackPriority::kText },
...
TEST_F(SymbolsIteratorTest, EmojiVS15)
{
    ...
    CheckRuns({ { "⚓\U0000FE0E", FontFallbackPriority::kText }, { "⛵", FontFallbackPriority::kEmojiEmoji } });
}
