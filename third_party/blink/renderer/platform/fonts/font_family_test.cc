...
FontFamily* CreateAndAppendFamily(FontFamily& parent, const char* family_name, FontFamily::Type family_type)
{
...
TEST(FontFamilyTest, CountNames)
{
    ...
    }
    {
        FontFamily family;
        family.SetFamily("A", FontFamily::Type::kFamilyName);
        FontFamily* b_family = CreateAndAppendFamily(family, "B", FontFamily::Type::kFamilyName);
