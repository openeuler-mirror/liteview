...
public:
    ...
    UTF16RagelIterator(const UChar* buffer, unsigned buffer_size, unsigned cursor = 0)
        : buffer_(buffer)
    ...
    {
        return buffer_ == other.buffer_ && buffer_size_ == other.buffer_size_ && cursor_ == other.cursor_;
    }
