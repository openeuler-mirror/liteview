...
FontPlatformData::FontPlatformData(const FontPlatformData& src, float text_size)
    : FontPlatformData(src.typeface_,
        ...
        std::string(),
#endif
        text_size, src.synthetic_bold_, src.synthetic_italic_, src.text_rendering_, src.orientation_)
{
}
...
FontPlatformData::FontPlatformData(sk_sp<SkTypeface> typeface, const std::string& family, float text_size, bool synthetic_bold, bool synthetic_italic,
    TextRenderingMode text_rendering, FontOrientation orientation)
    : typeface_(typeface)
    ,
#if !BUILDFLAG(IS_WIN) && !BUILDFLAG(IS_MAC)
    family_(family)
...
SkFont FontPlatformData::CreateSkFont(bool should_use_subpixel_positioning, const FontDescription*) const
{
    SkFont font;
...
scoped_refptr<OpenTypeVerticalData> FontPlatformData::CreateVerticalData() const
{
...
FontPlatformData::ThreadSpecificHarfBuzzFace::ThreadSpecificHarfBuzzFace() = default;
FontPlatformData::ThreadSpecificHarfBuzzFace::~ThreadSpecificHarfBuzzFace() = default;

HarfBuzzFace& FontPlatformData::ThreadSpecificHarfBuzzFace::GetOrCreate(FontPlatformData* platform_data)
{
