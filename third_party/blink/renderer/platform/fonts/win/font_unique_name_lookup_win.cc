...
sk_sp<SkTypeface> FontUniqueNameLookupWin::MatchUniqueNameSingleLookup(const String& font_unique_name)
{
    ...
    bool matching_mojo_success = service_->MatchUniqueFont(font_unique_name, &font_file_path, &ttc_index);
...
sk_sp<SkTypeface> FontUniqueNameLookupWin::MatchUniqueNameLookupTable(const String& font_unique_name)
{
...
sk_sp<SkTypeface> FontUniqueNameLookupWin::InstantiateFromPathAndTtcIndex(base::FilePath font_file_path, uint32_t ttc_index)
{
    return SkTypeface::MakeFromFile(font_file_path.AsUTF8Unsafe().c_str(), ttc_index);
}
...
bool FontUniqueNameLookupWin::IsFontUniqueNameLookupReadyForSyncLookup()
{
    ...
    service_->GetUniqueNameLookupTableIfAvailable(&sync_available_from_mojo, &shared_memory_region);
...
void FontUniqueNameLookupWin::PrepareFontUniqueNameLookup(NotifyFontUniqueNameLookupReady callback)
{
    ...
    service_->GetUniqueNameLookupTable(base::BindOnce(&FontUniqueNameLookupWin::ReceiveReadOnlySharedMemoryRegion, base::Unretained(this)));
}
...
void FontUniqueNameLookupWin::Init()
{
    ...
    service_->GetUniqueFontLookupMode(base::BindOnce(&FontUniqueNameLookupWin::InitWithLookupMode, base::Unretained(this)));
}

void FontUniqueNameLookupWin::ReceiveReadOnlySharedMemoryRegion(base::ReadOnlySharedMemoryRegion shared_memory_region)
{
    DCHECK(lookup_mode_ == blink::mojom::UniqueFontLookupMode::kRetrieveTable);
...
void FontUniqueNameLookupWin::InitWithLookupMode(blink::mojom::UniqueFontLookupMode lookup_mode)
{
