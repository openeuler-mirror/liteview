...
public:
    ...
    void SetUnitsPerEm(unsigned units_per_em)
    {
    ...
    static void AscentDescentWithHacks(float& ascent, float& descent, unsigned& visual_overflow_inflation_for_ascent,
        unsigned& visual_overflow_inflation_for_descent, const FontPlatformData&, const SkFont&, bool subpixel_ascent_descent = false,
        absl::optional<float> ascent_override = absl::nullopt, absl::optional<float> descent_override = absl::nullopt);
