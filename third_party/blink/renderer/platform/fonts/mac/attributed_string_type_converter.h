...
template <> struct PLATFORM_EXPORT TypeConverter<ui::mojom::blink::AttributedStringPtr, NSAttributedString*> {
    static ui::mojom::blink::AttributedStringPtr Convert(const NSAttributedString* ns_attributed_string);
};
