...
public:
    ...
    void DrawText(cc::PaintCanvas*, const TextRunPaintInfo&, const gfx::PointF&, float device_scale_factor, const cc::PaintFlags&,
        DrawType = DrawType::kGlyphsOnly) const;
    void DrawText(cc::PaintCanvas*, const TextRunPaintInfo&, const gfx::PointF&, float device_scale_factor, cc::NodeId node_id, const cc::PaintFlags&,
        DrawType = DrawType::kGlyphsOnly) const;
    void DrawText(cc::PaintCanvas*, const NGTextFragmentPaintInfo&, const gfx::PointF&, float device_scale_factor, cc::NodeId node_id, const cc::PaintFlags&,
        DrawType = DrawType::kGlyphsOnly) const;
    bool DrawBidiText(cc::PaintCanvas*, const TextRunPaintInfo&, const gfx::PointF&, CustomFontNotReadyAction, float device_scale_factor, const cc::PaintFlags&,
        DrawType = DrawType::kGlyphsOnly) const;
    void DrawEmphasisMarks(
        cc::PaintCanvas*, const TextRunPaintInfo&, const AtomicString& mark, const gfx::PointF&, float device_scale_factor, const cc::PaintFlags&) const;
    void DrawEmphasisMarks(
        cc::PaintCanvas*, const NGTextFragmentPaintInfo&, const AtomicString& mark, const gfx::PointF&, float device_scale_factor, const cc::PaintFlags&) const;
    ...
    void GetTextIntercepts(
        const TextRunPaintInfo&, float device_scale_factor, const cc::PaintFlags&, const std::tuple<float, float>& bounds, Vector<TextIntercept>&) const;
    void GetTextIntercepts(
        const NGTextFragmentPaintInfo&, float device_scale_factor, const cc::PaintFlags&, const std::tuple<float, float>& bounds, Vector<TextIntercept>&) const;
    ...
    // origin.
    float Width(const TextRun&, HashSet<const SimpleFontData*>* fallback_fonts = nullptr, gfx::RectF* glyph_bounds = nullptr) const;
    ...
    void ExpandRangeToIncludePartialGlyphs(const TextRun&, int* from, int* to) const;
