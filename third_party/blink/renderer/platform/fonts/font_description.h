...
public:
    ...
    {
        return size_adjust_ != kFontSizeAdjustNone;
    }
    ...
    {
        return GenericFamily() == kMonospaceFamily && !Family().Next() && Family().FamilyName() == font_family_names::kMonospace;
    }
    ...
    FontPalette* GetFontPalette() const
    {
    ...
    void SetSizeAdjust(float aspect)
    {
        size_adjust_ = ClampTo<float>(aspect);
    }
...
template <> struct DefaultHash<blink::FontDescription> {
