...
static unsigned CreateDecodingBaseline(DecoderCreator create_decoder, SharedBuffer* data)
{
...
static void TestMergeBuffer(DecoderCreator create_decoder, SharedBuffer* shared_data)
{
...
static void TestDecodeAfterReallocatingData(DecoderCreator create_decoder, SharedBuffer* data)
{
    ...
    scoped_refptr<SharedBuffer> reallocated_data = SharedBuffer::AdoptVector(copy);
...
void TestMergeBuffer(DecoderCreator create_decoder, const char* dir, const char* file)
{
    scoped_refptr<SharedBuffer> data = ReadFile(dir, file);
    ASSERT_TRUE(data.get());
    TestMergeBuffer(create_decoder, data.get());
