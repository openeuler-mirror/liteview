...
public:
    AVIFImageDecoder(AlphaOption, HighBitDepthDecodingOption, const ColorBehavior&, wtf_size_t max_decoded_bytes, AnimationOption);
    ...
    absl::optional<base::TimeDelta> FrameTimestampAtIndex(wtf_size_t) const override;
...
private:
    ...
    std::unique_ptr<avifDecoder, void (*)(avifDecoder*)> decoder_ { nullptr, nullptr };
    avifIO avif_io_ = {};
