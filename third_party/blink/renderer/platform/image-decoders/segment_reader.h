...
public:
    ...
    static scoped_refptr<SegmentReader> CreateFromSharedBuffer(scoped_refptr<SharedBuffer>);
    ...
    static scoped_refptr<SegmentReader> CreateFromParkableImage(scoped_refptr<ParkableImage>);
