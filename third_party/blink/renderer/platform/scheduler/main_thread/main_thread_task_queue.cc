...
// static
base::sequence_manager::QueueName MainThreadTaskQueue::NameForQueueType(MainThreadTaskQueue::QueueType queue_type)
{
    switch (queue_type) {
    case MainThreadTaskQueue::QueueType::kControl:
        return base::sequence_manager::QueueName::CONTROL_TQ;
    case MainThreadTaskQueue::QueueType::kDefault:
        return base::sequence_manager::QueueName::DEFAULT_TQ;
    case MainThreadTaskQueue::QueueType::kFrameLoading:
        return base::sequence_manager::QueueName::FRAME_LOADING_TQ;
    case MainThreadTaskQueue::QueueType::kFrameThrottleable:
        return base::sequence_manager::QueueName::FRAME_THROTTLEABLE_TQ;
    case MainThreadTaskQueue::QueueType::kFrameDeferrable:
        return base::sequence_manager::QueueName::FRAME_DEFERRABLE_TQ;
    case MainThreadTaskQueue::QueueType::kFramePausable:
        return base::sequence_manager::QueueName::FRAME_PAUSABLE_TQ;
    case MainThreadTaskQueue::QueueType::kFrameUnpausable:
        return base::sequence_manager::QueueName::FRAME_UNPAUSABLE_TQ;
    case MainThreadTaskQueue::QueueType::kCompositor:
        return base::sequence_manager::QueueName::COMPOSITOR_TQ;
    case MainThreadTaskQueue::QueueType::kIdle:
        return base::sequence_manager::QueueName::IDLE_TQ;
    case MainThreadTaskQueue::QueueType::kTest:
        return base::sequence_manager::QueueName::TEST_TQ;
    case MainThreadTaskQueue::QueueType::kFrameLoadingControl:
        return base::sequence_manager::QueueName::FRAME_LOADING_CONTROL_TQ;
    case MainThreadTaskQueue::QueueType::kV8:
        return base::sequence_manager::QueueName::V8_TQ;
    case MainThreadTaskQueue::QueueType::kInput:
        return base::sequence_manager::QueueName::INPUT_TQ;
    case MainThreadTaskQueue::QueueType::kDetached:
        return base::sequence_manager::QueueName::DETACHED_TQ;
    case MainThreadTaskQueue::QueueType::kOther:
        return base::sequence_manager::QueueName::OTHER_TQ;
    case MainThreadTaskQueue::QueueType::kWebScheduling:
        return base::sequence_manager::QueueName::WEB_SCHEDULING_TQ;
    case MainThreadTaskQueue::QueueType::kNonWaking:
        return base::sequence_manager::QueueName::NON_WAKING_TQ;
    case MainThreadTaskQueue::QueueType::kIPCTrackingForCachedPages:
        return base::sequence_manager::QueueName::IPC_TRACKING_FOR_CACHED_PAGES_TQ;
    case MainThreadTaskQueue::QueueType::kCount:
        NOTREACHED();
        return base::sequence_manager::QueueName::UNKNOWN_TQ;
    }
    NOTREACHED();
    return base::sequence_manager::QueueName::UNKNOWN_TQ;
}
...
// static
bool MainThreadTaskQueue::IsPerFrameTaskQueue(MainThreadTaskQueue::QueueType queue_type)
{
    switch (queue_type) {
...
MainThreadTaskQueue::MainThreadTaskQueue(std::unique_ptr<base::sequence_manager::internal::TaskQueueImpl> impl, const TaskQueue::Spec& spec,
...
void MainThreadTaskQueue::DetachFromMainThreadScheduler()
{
    ...
    task_queue_->SetOnTaskStartedHandler(base::BindRepeating(&MainThreadSchedulerImpl::OnTaskStarted, main_thread_scheduler_->GetWeakPtr(), nullptr));
    task_queue_->SetOnTaskCompletedHandler(base::BindRepeating(&MainThreadSchedulerImpl::OnTaskCompleted, main_thread_scheduler_->GetWeakPtr(), nullptr));
    on_ipc_task_posted_callback_handle_.reset();
    task_queue_->SetTaskExecutionTraceLogger(internal::TaskQueueImpl::TaskExecutionTraceLogger());
...
absl::optional<WebSchedulingPriority> MainThreadTaskQueue::web_scheduling_priority() const
{
