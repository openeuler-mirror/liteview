...
#define DURATION_PER_TASK_TYPE_METRIC_NAME "RendererScheduler.TaskDurationPerTaskType2"
#define QUEUEING_TIME_PER_QUEUE_TYPE_METRIC_NAME "RendererScheduler.QueueingDurationPerQueueType"
    ...
    MainThreadTaskQueue* queue, const base::sequence_manager::Task& task, const base::sequence_manager::TaskQueue::TaskTiming& task_timing)
{
    ...
    //
    //     total_task_time_reporter_.RecordAdditionalDuration(task_timing.wall_duration());
    //
