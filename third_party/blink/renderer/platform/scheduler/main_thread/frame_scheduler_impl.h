...
public:
    ...
    std::unique_ptr<WebResourceLoadingTaskRunnerHandle> CreateResourceLoadingTaskRunnerHandle() override;

    std::unique_ptr<WebResourceLoadingTaskRunnerHandle> CreateResourceLoadingMaybeUnfreezableTaskRunnerHandle() override;
    WebAgentGroupScheduler* GetAgentGroupScheduler() override;
    PageScheduler* GetPageScheduler() const override;
    void DidStartProvisionalLoad() override;
    void DidCommitProvisionalLoad(bool is_web_history_inert_commit, NavigationType navigation_type) override;
    ...
    //   void WriteIntoTrace(perfetto::TracedProto<perfetto::protos::pbzero::RendererMainThreadTaskExecution> proto) const;
...
private:
    ...
    std::unique_ptr<ResourceLoadingTaskRunnerHandleImpl> CreateResourceLoadingTaskRunnerHandleImpl();
    ...
    base::sequence_manager::TaskQueue::QueuePriority default_loading_task_priority_ = base::sequence_manager::TaskQueue::QueuePriority::kNormalPriority;
    ...
    TraceableState<PageVisibilityState, TracingCategory::kInfo> page_visibility_for_tracing_;
