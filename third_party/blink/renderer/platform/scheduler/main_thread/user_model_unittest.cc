...
{
    EXPECT_EQ(base::TimeDelta(), user_model_->TimeLeftInUserGesture(clock_->NowTicks()));
}
...
TEST_F(UserModelTest, TimeLeftInUserGesture_ImmediatelyAfterInput)
{
    ...
    EXPECT_EQ(priority_escalation_after_input_duration(), user_model_->TimeLeftInUserGesture(clock_->NowTicks()));
}
...
TEST_F(UserModelTest, TimeLeftInUserGesture_ShortlyAfterInput)
{
    ...
    EXPECT_EQ(priority_escalation_after_input_duration() - delta, user_model_->TimeLeftInUserGesture(clock_->NowTicks()));
}
...
TEST_F(UserModelTest, GestureExpectedSoon_ShortlyAfter_GestureScrollBegin)
{
    ...
    base::TimeDelta prediction_valid_duration;
    EXPECT_FALSE(user_model_->IsGestureExpectedSoon(clock_->NowTicks(), &prediction_valid_duration));
    EXPECT_EQ(base::Milliseconds(UserModel::kMedianGestureDurationMillis) - delta, prediction_valid_duration);
}
...
TEST_F(UserModelTest, GestureExpectedSoon_LongAfter_GestureScrollBegin)
{
    ...
    base::TimeDelta delta(base::Milliseconds(UserModel::kMedianGestureDurationMillis * 2));
    clock_->Advance(delta);

    base::TimeDelta prediction_valid_duration;
    EXPECT_TRUE(user_model_->IsGestureExpectedSoon(clock_->NowTicks(), &prediction_valid_duration));
    EXPECT_EQ(base::Milliseconds(UserModel::kExpectSubsequentGestureMillis), prediction_valid_duration);
}
...
TEST_F(UserModelTest, GestureExpectedSoon_ImmediatelyAfter_GestureScrollEnd)
{
    ...
    base::TimeDelta prediction_valid_duration;
    EXPECT_TRUE(user_model_->IsGestureExpectedSoon(clock_->NowTicks(), &prediction_valid_duration));
    EXPECT_EQ(subsequent_input_expected_after_input_duration(), prediction_valid_duration);
}
...
TEST_F(UserModelTest, GestureExpectedSoon_ShortlyAfter_GestureScrollEnd)
{
    ...
    base::TimeDelta prediction_valid_duration;
    EXPECT_TRUE(user_model_->IsGestureExpectedSoon(clock_->NowTicks(), &prediction_valid_duration));
    EXPECT_EQ(subsequent_input_expected_after_input_duration() - delta, prediction_valid_duration);
}
...
TEST_F(UserModelTest, IsGestureExpectedToContinue_GestureJustStarted)
{
    ...
    EXPECT_EQ(base::Milliseconds(UserModel::kMedianGestureDurationMillis), prediction_valid_duration);
}
