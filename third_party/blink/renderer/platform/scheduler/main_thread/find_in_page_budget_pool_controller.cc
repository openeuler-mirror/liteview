...
const QueuePriority FindInPageBudgetPoolController::kFindInPageBudgetNotExhaustedPriority;
const QueuePriority FindInPageBudgetPoolController::kFindInPageBudgetExhaustedPriority;
...
void FindInPageBudgetPoolController::OnTaskCompleted(MainThreadTaskQueue* queue, TaskQueue::TaskTiming* task_timing)
{
    ...
    QueuePriority task_priority = is_exhausted ? kFindInPageBudgetExhaustedPriority : kFindInPageBudgetNotExhaustedPriority;
