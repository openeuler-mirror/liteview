...
class PageSchedulerImplPageTransitionTest_PageLifecycleStateTransitionMetric_Test;
} // namespace page_scheduler_impl_unittest
...
public:
    ...
    bool ThrottleForegroundTimers() const
    {
        return throttle_foreground_timers_;
    }
...
private:
    ...
    friend class page_scheduler_impl_unittest::PageSchedulerImplPageTransitionTest;
    friend class page_scheduler_impl_unittest::PageSchedulerImplPageTransitionTest_PageLifecycleStateTransitionMetric_Test;
    ...
    void AddQueueToWakeUpBudgetPool(MainThreadTaskQueue* task_queue, FrameOriginType frame_origin_type, bool frame_visible, base::LazyNow* lazy_now);
    ...
    WakeUpBudgetPool* GetWakeUpBudgetPool(MainThreadTaskQueue* task_queue, FrameOriginType frame_origin_type, bool frame_visible);
    ...
    //    foreground pages.
    std::unique_ptr<WakeUpBudgetPool> cross_origin_hidden_normal_wake_up_budget_pool_;
