...
public:
    static constexpr auto kFindInPageBudgetNotExhaustedPriority = QueuePriority::kVeryHighPriority;
    static constexpr auto kFindInPageBudgetExhaustedPriority = QueuePriority::kNormalPriority;
    ...
    QueuePriority CurrentTaskPriority()
    {
