    ...
    , previous_time_(initial_time)
{
    ...
    time_overrides_ = std::make_unique<base::subtle::ScopedTimeClockOverrides>(
        &AutoAdvancingVirtualTimeDomain::GetVirtualTime, &AutoAdvancingVirtualTimeDomain::GetVirtualTimeTicks, nullptr);
...
bool AutoAdvancingVirtualTimeDomain::MaybeFastForwardToWakeUp(absl::optional<base::sequence_manager::WakeUp> wakeup, bool quit_when_idle_requested)
{
...
AutoAdvancingVirtualTimeDomain* AutoAdvancingVirtualTimeDomain::g_time_domain_ = nullptr;
