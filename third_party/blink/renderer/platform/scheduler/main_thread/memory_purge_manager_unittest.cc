...
protected:
    void SetupDelayedPurgeAfterFreezeExperiment()
    {
        scoped_feature_list_.InitWithFeaturesAndParameters(
            { { features::kFreezePurgeMemoryAllPagesFrozen, { { "delay-in-minutes", base::NumberToString(kDelayForPurgeAfterFreeze.InMinutes()) } } } },
...
{
    scoped_feature_list_.InitWithFeatures({} /* enabled */, { features::kPurgeRendererMemoryWhenBackgrounded } /* disabled */);
...
TEST_F(MemoryPurgeManagerTest, PageFrozenPurgeMemoryAllPagesFrozenDisabled)
{
    ...
    scoped_feature_list.InitWithFeatures(
        {} /* enabled */, { features::kFreezePurgeMemoryAllPagesFrozen, features::kPurgeRendererMemoryWhenBackgrounded } /* disabled */);
...
TEST_F(MemoryPurgeManagerTest, PageFrozenPurgeMemoryAllPagesFrozenEnabled)
{
    base::test::ScopedFeatureList scoped_feature_list;
    scoped_feature_list.InitWithFeatures(
        { features::kFreezePurgeMemoryAllPagesFrozen } /* enabled */, { features::kPurgeRendererMemoryWhenBackgrounded } /* disabled */);
...
{
    scoped_feature_list_.InitWithFeatures({ features::kPurgeRendererMemoryWhenBackgrounded } /* enabled */, {} /* disabled */);

    memory_purge_manager_.SetRendererBackgrounded(true);
    FastForwardBy(base::Minutes(MemoryPurgeManager::kDefaultMaxTimeToPurgeAfterBackgrounded));
...
TEST_F(MemoryPurgeManagerTest, PageFrozenAndResumedWhileBackgrounded)
{
    ...
    constexpr base::TimeDelta kBeforeBackgroundPurgeDelay = base::Minutes(MemoryPurgeManager::kDefaultMinTimeToPurgeAfterBackgrounded) / 2;

    scoped_feature_list_.InitWithFeaturesAndParameters(
        { { features::kFreezePurgeMemoryAllPagesFrozen, { { "delay-in-minutes", base::NumberToString(kFreezePurgeDelay.InMinutes()) } } },
            { features::kPurgeRendererMemoryWhenBackgrounded, {} } },
        {});
    ...
    memory_purge_manager_.OnPageResumed();
    FastForwardBy(base::Minutes(MemoryPurgeManager::kDefaultMaxTimeToPurgeAfterBackgrounded) - kBeforeBackgroundPurgeDelay);
...
TEST_F(MemoryPurgeManagerTest, PageFrozenAndRendererBackgroundedShorterBackgroundedDelay)
{
    constexpr base::TimeDelta kFreezePurgeDelay = base::Minutes(10);
    scoped_feature_list_.InitWithFeaturesAndParameters(
        { { features::kFreezePurgeMemoryAllPagesFrozen, { { "delay-in-minutes", base::NumberToString(kFreezePurgeDelay.InMinutes()) } } },
...
TEST_F(MemoryPurgeManagerTest, PageFrozenAndRendererBackgroundedShorterFreezeDelay)
{
    constexpr base::TimeDelta kFreezePurgeDelay = base::Minutes(MemoryPurgeManager::kDefaultMinTimeToPurgeAfterBackgrounded);
    scoped_feature_list_.InitWithFeaturesAndParameters(
        { { features::kFreezePurgeMemoryAllPagesFrozen, { { "delay-in-minutes", base::NumberToString(kFreezePurgeDelay.InMinutes()) } } },
            { features::kPurgeRendererMemoryWhenBackgrounded, {} } },
        {});
