...
class PLATFORM_EXPORT ResourceLoadingTaskRunnerHandleImpl : public WebResourceLoadingTaskRunnerHandle {
public:
    static std::unique_ptr<ResourceLoadingTaskRunnerHandleImpl> WrapTaskRunner(scoped_refptr<MainThreadTaskQueue> task_runner);

    ResourceLoadingTaskRunnerHandleImpl(const ResourceLoadingTaskRunnerHandleImpl&) = delete;
    ResourceLoadingTaskRunnerHandleImpl& operator=(const ResourceLoadingTaskRunnerHandleImpl&) = delete;
...
protected:
    explicit ResourceLoadingTaskRunnerHandleImpl(scoped_refptr<MainThreadTaskQueue> task_queue);
