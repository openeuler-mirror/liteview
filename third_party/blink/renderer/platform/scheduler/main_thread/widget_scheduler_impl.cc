...
void WidgetSchedulerImpl::DidHandleInputEventOnMainThread(const WebInputEvent& web_input_event, WebInputEventResult result)
{
    main_thread_scheduler_->DidHandleInputEventOnMainThread(web_input_event, result);
}
