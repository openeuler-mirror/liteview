...
public:
    ...
    private:
        ...
        SchedulingAffectingFeatureHandle(SchedulingPolicy::Feature feature, SchedulingPolicy policy, base::WeakPtr<FrameOrWorkerScheduler>);
    ...
    public:
        ...
        virtual void UpdateBackForwardCacheDisablingFeatures(uint64_t features_mask) = 0;
    };
    ...
    virtual std::unique_ptr<WebSchedulingTaskQueue> CreateWebSchedulingTaskQueue(WebSchedulingPriority) = 0;
...
protected:
    ...
    virtual void OnStartedUsingFeature(SchedulingPolicy::Feature feature, const SchedulingPolicy& policy) = 0;
    virtual void OnStoppedUsingFeature(SchedulingPolicy::Feature feature, const SchedulingPolicy& policy) = 0;

    // Gets a weak pointer for this scheduler that is reset when the influence by
    // registered features to this scheduler is reset.
    virtual base::WeakPtr<FrameOrWorkerScheduler> GetSchedulingAffectingFeatureWeakPtr() = 0;
