...
public:
    ...
    virtual std::unique_ptr<scheduler::WebAgentGroupScheduler> CreateAgentGroupScheduler() = 0;
    ...
    virtual scheduler::WebAgentGroupScheduler* GetCurrentAgentGroupScheduler() = 0;
