...
// frame.
class PLATFORM_EXPORT UnprioritizedResourceLoadingTaskRunnerHandle : public WebResourceLoadingTaskRunnerHandle {
public:
    static std::unique_ptr<UnprioritizedResourceLoadingTaskRunnerHandle> WrapTaskRunner(scoped_refptr<base::SingleThreadTaskRunner> task_runner);

    UnprioritizedResourceLoadingTaskRunnerHandle(const UnprioritizedResourceLoadingTaskRunnerHandle&) = delete;
    UnprioritizedResourceLoadingTaskRunnerHandle& operator=(const UnprioritizedResourceLoadingTaskRunnerHandle&) = delete;
...
protected:
    explicit UnprioritizedResourceLoadingTaskRunnerHandle(scoped_refptr<base::SingleThreadTaskRunner> task_runner);
