...
//   , thread_metrics_(ConvertBlinkThreadType(thread_type), has_cpu_timing_for_each_task)
//   , thread_task_duration_reporter_("RendererScheduler.TaskDurationPerThreadType2")
//   , thread_task_cpu_duration_reporter_("RendererScheduler.TaskCPUDurationPerThreadType2")
//   , foreground_thread_task_duration_reporter_("RendererScheduler.TaskDurationPerThreadType2.Foreground")
//   , foreground_thread_task_cpu_duration_reporter_("RendererScheduler.TaskCPUDurationPerThreadType2.Foreground")
//   , background_thread_task_duration_reporter_("RendererScheduler.TaskDurationPerThreadType2.Background")
//   , background_thread_task_cpu_duration_reporter_("RendererScheduler.TaskCPUDurationPerThreadType2.Background")
{
}
...
void MetricsHelper::RecordCommonTaskMetrics(const base::sequence_manager::Task& task, const base::sequence_manager::TaskQueue::TaskTiming& task_timing)
{
