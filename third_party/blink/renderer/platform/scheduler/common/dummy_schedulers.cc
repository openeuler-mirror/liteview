...
std::unique_ptr<AgentGroupScheduler> CreateDummyAgentGroupSchedulerWithIsolate(v8::Isolate* isolate);
...
public:
    ...
    void DidHandleInputEventOnMainThread(const WebInputEvent& web_input_event, WebInputEventResult result) override
    {
    }
...
public:
    DummyFrameScheduler()
        : page_scheduler_(CreateDummyPageScheduler())
    {
    }
    ...
    {
        return WebResourceLoadingTaskRunnerHandle::CreateUnprioritized(base::ThreadTaskRunnerHandle::Get());
    }
...
public:
    explicit SimpleThread(ThreadScheduler* scheduler)
...
public:
    ...
    void BindInterfaceBroker(mojo::PendingRemote<blink::mojom::BrowserInterfaceBroker> remote_broker) override
    {
    }
