...
base::TimeDelta GetForegroundTimersThrottledWakeUpInterval()
{
    ...
    static const base::FeatureParam<int> kForegroundTimersThrottledWakeUpIntervalMills { &features::kThrottleForegroundTimers,
        "ForegroundTimersThrottledWakeUpIntervalMills", kForegroundTimersThrottling_WakeUpIntervalMillis_Default };
    return base::Milliseconds(kForegroundTimersThrottledWakeUpIntervalMills.Get());
}
...
const base::FeatureParam<CompositorTQPolicyDuringThreadedScroll>::Option kCompositorTQPolicyDuringThreadedScrollOptions[]
    = { { CompositorTQPolicyDuringThreadedScroll::kLowPriorityWithAntiStarvation, "low-priority-with-anti-starvation" },
          { CompositorTQPolicyDuringThreadedScroll::kNormalPriorityWithAntiStarvation, "normal-priority-with-anti-starvation" },
          { CompositorTQPolicyDuringThreadedScroll::kVeryHighPriorityAlways, "very-high-priority-always" } };

const base::FeatureParam<CompositorTQPolicyDuringThreadedScroll> kCompositorTQPolicyDuringThreadedScroll { &kThreadedScrollPreventRenderingStarvation, "policy",
    CompositorTQPolicyDuringThreadedScroll::kLowPriorityWithAntiStarvation, &kCompositorTQPolicyDuringThreadedScrollOptions };
