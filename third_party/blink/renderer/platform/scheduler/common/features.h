...
BASE_FEATURE(kLowPriorityForBackgroundPages, "BlinkSchedulerLowPriorityForBackgroundPages", base::FEATURE_DISABLED_BY_DEFAULT);

// Enables setting the priority of background (with no audio) pages'
// task queues to best effort.
BASE_FEATURE(kBestEffortPriorityForBackgroundPages, "BlinkSchedulerBestEffortPriorityForBackgroundPages", base::FEATURE_DISABLED_BY_DEFAULT);

// Enables setting the priority of sub-frame task queues to low
// priority.
BASE_FEATURE(kLowPriorityForSubFrame, "BlinkSchedulerLowPriorityForSubFrame", base::FEATURE_DISABLED_BY_DEFAULT);

// Enables setting the priority of throttleable task queues to
// low priority.
BASE_FEATURE(kLowPriorityForThrottleableTask, "BlinkSchedulerLowPriorityForThrottleableTask", base::FEATURE_DISABLED_BY_DEFAULT);

// Enables setting the priority of sub-frame throttleable
// task queues to low priority.
BASE_FEATURE(kLowPriorityForSubFrameThrottleableTask, "BlinkSchedulerLowPriorityForSubFrameThrottleableTask", base::FEATURE_DISABLED_BY_DEFAULT);

// Enables setting the priority of hidden frame task queues to
// low priority.
BASE_FEATURE(kLowPriorityForHiddenFrame, "BlinkSchedulerLowPriorityForHiddenFrame", base::FEATURE_DISABLED_BY_DEFAULT);

// Enables setting the priority of an ad frame to low priority.
BASE_FEATURE(kLowPriorityForAdFrame, "BlinkSchedulerLowPriorityForAdFrame", base::FEATURE_DISABLED_BY_DEFAULT);

// Enables setting the priority of an ad frame to best effort priority.
BASE_FEATURE(kBestEffortPriorityForAdFrame, "BlinkSchedulerBestEffortPriorityForAdFrame", base::FEATURE_DISABLED_BY_DEFAULT);

// Enables setting the priority of cross-origin task queues to
// low priority.
BASE_FEATURE(kLowPriorityForCrossOrigin, "BlinkSchedulerLowPriorityForCrossOrigin", base::FEATURE_DISABLED_BY_DEFAULT);

// Prioritizes loading and compositing tasks while loading.
BASE_FEATURE(kPrioritizeCompositingAndLoadingDuringEarlyLoading, "PrioritizeCompositingAndLoadingDuringEarlyLoading", base::FEATURE_DISABLED_BY_DEFAULT);

// Prioritizes one BeginMainFrame after input.
BASE_FEATURE(kPrioritizeCompositingAfterInput, "PrioritizeCompositingAfterInput", base::FEATURE_DISABLED_BY_DEFAULT);
...
BASE_FEATURE(kMbiCompositorTaskRunnerPerAgentSchedulingGroup, "MbiCompositorTaskRunnerPerAgentSchedulingGroup", base::FEATURE_ENABLED_BY_DEFAULT);
...
PLATFORM_EXPORT extern const base::FeatureParam<CompositorTQPolicyDuringThreadedScroll>::Option kCompositorTQPolicyDuringThreadedScrollOptions[];

PLATFORM_EXPORT extern const base::FeatureParam<CompositorTQPolicyDuringThreadedScroll> kCompositorTQPolicyDuringThreadedScroll;

BASE_FEATURE(kRejectedPromisesPerWindowAgent, "BlinkSchedulerRejectedPromisesPerWindowAgent", base::FEATURE_ENABLED_BY_DEFAULT);

BASE_FEATURE(kMicrotaskQueuePerWindowAgent, "BlinkSchedulerMicroTaskQueuePerWindowAgent", base::FEATURE_DISABLED_BY_DEFAULT);

BASE_FEATURE(kMicrotaskQueuePerPaintWorklet, "BlinkSchedulerMicroTaskQueuePerPaintWorklet", base::FEATURE_DISABLED_BY_DEFAULT);

BASE_FEATURE(kMicrotaskQueuePerAnimationWorklet, "BlinkSchedulerMicroTaskQueuePerAnimationWorklet", base::FEATURE_DISABLED_BY_DEFAULT);

BASE_FEATURE(kMicrotaskQueuePerAudioWorklet, "BlinkSchedulerMicroTaskQueuePerAudioWorklet", base::FEATURE_DISABLED_BY_DEFAULT);
