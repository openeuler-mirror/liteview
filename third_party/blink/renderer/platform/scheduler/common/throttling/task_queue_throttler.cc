...
absl::optional<base::sequence_manager::WakeUp> TaskQueueThrottler::GetNextAllowedWakeUpImpl(
    LazyNow* lazy_now, absl::optional<base::sequence_manager::WakeUp> next_wake_up, bool has_ready_task)
{
    DCHECK(IsThrottled());
    ...
    if (has_ready_task) {
        ...
        if (!allowed_run_time.is_null()) {
            ...
            return base::sequence_manager::WakeUp { allowed_run_time, base::GetTaskLeeway(), base::sequence_manager::WakeUpResolution::kLow };
        }
    }
...
absl::optional<base::sequence_manager::WakeUp> TaskQueueThrottler::GetNextAllowedWakeUp(
    LazyNow* lazy_now, absl::optional<base::sequence_manager::WakeUp> next_desired_wake_up, bool has_ready_task)
{
...
absl::optional<QueueBlockType> TaskQueueThrottler::GetBlockType(base::TimeTicks now) const
{
