...
private:
    ...
    absl::optional<base::sequence_manager::WakeUp> GetNextAllowedWakeUpImpl(
        base::LazyNow* lazy_now, absl::optional<base::sequence_manager::WakeUp> next_wake_up, bool has_ready_task);

    // TaskQueue::Throttler implementation:
    absl::optional<base::sequence_manager::WakeUp> GetNextAllowedWakeUp(
        base::LazyNow* lazy_now, absl::optional<base::sequence_manager::WakeUp> next_wake_up, bool has_ready_task) override;
