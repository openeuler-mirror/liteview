...
public:
    ...
    void SetMaxBudgetLevel(base::TimeTicks now, absl::optional<base::TimeDelta> max_budget_level);
    ...
    void SetMaxThrottlingDelay(base::TimeTicks now, absl::optional<base::TimeDelta> max_throttling_delay);
