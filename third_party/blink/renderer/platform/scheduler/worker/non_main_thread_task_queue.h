...
class PLATFORM_EXPORT NonMainThreadTaskQueue : public base::RefCountedThreadSafe<NonMainThreadTaskQueue> {
public:
    // TODO(kraynov): Consider options to remove TaskQueueImpl reference here.
    NonMainThreadTaskQueue(std::unique_ptr<base::sequence_manager::internal::TaskQueueImpl> impl, const TaskQueue::Spec& spec,
