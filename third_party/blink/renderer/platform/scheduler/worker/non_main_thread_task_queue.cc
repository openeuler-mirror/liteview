...
NonMainThreadTaskQueue::NonMainThreadTaskQueue(std::unique_ptr<base::sequence_manager::internal::TaskQueueImpl> impl, const TaskQueue::Spec& spec,
    NonMainThreadSchedulerBase* non_main_thread_scheduler, bool can_be_throttled)
    ...
    , non_main_thread_scheduler_(non_main_thread_scheduler)
{
    ...
    DCHECK(!can_be_throttled || spec.should_notify_observers) << "Throttled queue is not supported with |!should_notify_observers|";
