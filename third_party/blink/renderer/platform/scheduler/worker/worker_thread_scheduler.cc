...
WorkerThreadScheduler::WorkerThreadScheduler(ThreadType thread_type, base::sequence_manager::SequenceManager* sequence_manager, WorkerSchedulerProxy* proxy)
    ...
    , worker_metrics_helper_(thread_type, GetHelper().HasCPUTimingForEachTask())
...
void WorkerThreadScheduler::RegisterWorkerScheduler(WorkerScheduler* worker_scheduler)
{
    worker_schedulers_.insert(worker_scheduler);
    worker_scheduler->OnLifecycleStateChanged(lifecycle_state_);
}

void WorkerThreadScheduler::UnregisterWorkerScheduler(WorkerScheduler* worker_scheduler)
{
...
HashSet<WorkerScheduler*>& WorkerThreadScheduler::GetWorkerSchedulersForTesting()
{
