...
WorkerMetricsHelper::WorkerMetricsHelper(ThreadType thread_type, bool has_cpu_timing_for_each_task)
...
void WorkerMetricsHelper::RecordTaskMetrics(const base::sequence_manager::Task& task, const base::sequence_manager::TaskQueue::TaskTiming& task_timing)
{
