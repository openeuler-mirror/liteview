...
scoped_refptr<base::SingleThreadTaskRunner> WebFakeThreadScheduler::CompositorTaskRunner()
{
    return base::ThreadTaskRunnerHandle::Get();
}

std::unique_ptr<WebAgentGroupScheduler> WebFakeThreadScheduler::CreateAgentGroupScheduler()
{
    return std::make_unique<FakeAgentGroupScheduler>(*this);
}

WebAgentGroupScheduler* WebFakeThreadScheduler::GetCurrentAgentGroupScheduler()
{
    return nullptr;
}
