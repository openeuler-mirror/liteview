...
public:
    ...
    ScriptState(v8::Local<v8::Context>, scoped_refptr<DOMWrapperWorld>, ExecutionContext* execution_context);
    ...
    static ScriptState* ForRelevantRealm(const v8::FunctionCallbackInfo<v8::Value>& info)
    {
    ...
    static ScriptState* ForRelevantRealm(const v8::PropertyCallbackInfo<v8::Value>& info)
    {
        return From(info.Holder()->GetCreationContextChecked());
    }

    static ScriptState* ForRelevantRealm(const v8::PropertyCallbackInfo<void>& info)
    {
        return From(info.Holder()->GetCreationContextChecked());
    }
    ...
    static ScriptState* From(v8::Local<v8::Context> context)
    {
        ...
        ScriptState* script_state = static_cast<ScriptState*>(context->GetAlignedPointerFromEmbedderData(kV8ContextPerContextDataIndex));
