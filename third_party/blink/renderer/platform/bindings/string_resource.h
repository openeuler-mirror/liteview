...
public:
    explicit StringResourceBase(const String& string)
    ...
    virtual ~StringResourceBase()
    {
        ...
        v8::Isolate::GetCurrent()->AdjustAmountOfExternalAllocatedMemory(-reduced_external_memory);
    }
    ...
    AtomicString GetAtomicString()
    {
        ...
        if (atomic_string_.IsNull()) {
            ...
            if (plain_string_.Impl() != atomic_string_.Impl()) {
                v8::Isolate::GetCurrent()->AdjustAmountOfExternalAllocatedMemory(atomic_string_.CharactersSizeInBytes());
            }
        }
...
template <typename StringType> PLATFORM_EXPORT StringType ToBlinkString(v8::Local<v8::String>, ExternalMode);
...
PLATFORM_EXPORT StringView ToBlinkStringView(v8::Local<v8::String>, StringView::StackBackingStore&, ExternalMode);
...
PLATFORM_EXPORT StringView ToBlinkStringView(v8::Local<v8::String> v8_string, StringView::StackBackingStore& backing_store, ExternalMode external);
