...
public:
    explicit V8CrossOriginCallbackInfo(const v8::PropertyCallbackInfo<v8::Value>& info)
    ...
    explicit V8CrossOriginCallbackInfo(const v8::FunctionCallbackInfo<v8::Value>& info)
        : isolate_(info.GetIsolate())
        , holder_(info.Holder())
    {
    }
...
private:
    ...
    V8CrossOriginCallbackInfo& operator=(const V8CrossOriginCallbackInfo&) = delete;
};
