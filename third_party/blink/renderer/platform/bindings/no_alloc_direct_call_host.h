...
inline void NoAllocDirectCallHost::EnterNoAllocDirectCallScope(v8::FastApiCallbackOptions* callback_options)
{
...
inline NoAllocDirectCallScope::NoAllocDirectCallScope(NoAllocDirectCallHost* host, v8::FastApiCallbackOptions* callback_options)
{
