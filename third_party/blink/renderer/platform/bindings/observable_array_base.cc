...
ObservableArrayBase::ObservableArrayBase(ScriptWrappable* platform_object, ObservableArrayExoticObject* observable_array_exotic_object)
...
v8::MaybeLocal<v8::Object> ObservableArrayBase::GetProxyHandlerObject(ScriptState* script_state)
{
    ...
    if (!v8_object->SetPrototype(v8_context, v8::Null(script_state->GetIsolate())).To(&did_set_prototype)) {
        return {};
    }
