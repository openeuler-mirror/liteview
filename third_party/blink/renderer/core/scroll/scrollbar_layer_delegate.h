...
public:
    ScrollbarLayerDelegate(blink::Scrollbar& scrollbar, float device_scale_factor);
    ...
    void PaintPart(cc::PaintCanvas* canvas, cc::ScrollbarPart part, const gfx::Rect& rect) override;
