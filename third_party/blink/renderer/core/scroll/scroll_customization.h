...
constexpr ScrollDirection kScrollDirectionPanX = kScrollDirectionPanLeft | kScrollDirectionPanRight;
constexpr ScrollDirection kScrollDirectionPanUp = 1 << 2;
constexpr ScrollDirection kScrollDirectionPanDown = 1 << 3;
constexpr ScrollDirection kScrollDirectionPanY = kScrollDirectionPanUp | kScrollDirectionPanDown;
constexpr ScrollDirection kScrollDirectionAuto = kScrollDirectionPanX | kScrollDirectionPanY;

CORE_EXPORT ScrollDirection GetScrollDirectionFromDeltas(double delta_x, double delta_y);
} // namespace scroll_customization
} // namespace blink
