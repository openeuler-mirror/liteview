...
static void AccumulateArrayBuffersForAllWorlds(v8::Isolate* isolate, DOMArrayBuffer* object, Vector<v8::Local<v8::ArrayBuffer>, 4>& buffers)
{
...
bool DOMArrayBuffer::Transfer(v8::Isolate* isolate, ArrayBufferContents& result)
{
...
bool DOMArrayBuffer::TransferDetachable(v8::Isolate* isolate, ArrayBufferContents& result)
{
...
DOMArrayBuffer* DOMArrayBuffer::CreateOrNull(const void* source, size_t byte_length)
{
...
v8::MaybeLocal<v8::Value> DOMArrayBuffer::Wrap(ScriptState* script_state)
{
    ...
    v8::Local<v8::ArrayBuffer> wrapper;
    {
        ...
        wrapper = v8::ArrayBuffer::New(script_state->GetIsolate(), Content()->BackingStore());
    }
...
DOMArrayBuffer* DOMArrayBuffer::Create(const Vector<base::span<const char>>& data)
{
    ...
    ArrayBufferContents contents(size, 1, ArrayBufferContents::kNotShared, ArrayBufferContents::kDontInitialize);
