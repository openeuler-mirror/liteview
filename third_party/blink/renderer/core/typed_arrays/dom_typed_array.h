...
public:
    ...
    {
        DOMArrayBuffer* buffer = DOMArrayBuffer::Create(array, length * sizeof(ValueType));
        return Create(buffer, 0, length);
    }
    ...
    {
        DOMArrayBuffer* buffer = DOMArrayBuffer::CreateOrNull(array, length * sizeof(ValueType));
        return buffer ? Create(buffer, 0, length) : nullptr;
    }
