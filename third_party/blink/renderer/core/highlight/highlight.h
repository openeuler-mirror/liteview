...
using HighlightSetIterable = SetlikeIterable<Member<AbstractRange>, AbstractRange>;
class HighlightRegistry;

class CORE_EXPORT Highlight : public EventTargetWithInlineData, public HighlightSetIterable {
...
public:
    ...
    public:
        ...
        bool Next(ScriptState*, Member<AbstractRange>&, Member<AbstractRange>&, ExceptionState&) override;
    ...
    HighlightSetIterable::IterationSource* StartIteration(ScriptState*, ExceptionState&) override;
