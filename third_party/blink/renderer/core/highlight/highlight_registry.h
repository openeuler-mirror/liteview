...
using HighlightRegistryMap = HeapLinkedHashSet<Member<HighlightRegistryMapEntry>, HashTraits<Member<HighlightRegistryMapEntry>>>;
using HighlightRegistryMapIterable = Maplike<AtomicString, IDLString, Member<Highlight>, Highlight>;
class LocalFrame;
...
public:
    ...
    public:
        ...
        bool Next(ScriptState*, AtomicString&, Member<Highlight>&, ExceptionState&) override;
...
private:
    ...
    {
        return highlights_.find(MakeGarbageCollected<HighlightRegistryMapEntry>(key));
    }

    bool GetMapEntry(ScriptState*, const AtomicString& key, Member<Highlight>& value, ExceptionState&) override
    {
    ...
    HighlightRegistryMapIterable::IterationSource* StartIteration(ScriptState*, ExceptionState&) override;
};
