...
void CSSCounterStyleRule::SetterInternal(const ExecutionContext* execution_context, AtRuleDescriptorID descriptor_id, const String& text)
{
    ...
    CSSValue* new_value = AtRuleDescriptorParser::ParseAtCounterStyleDescriptor(descriptor_id, token_range, context);
...
void CSSCounterStyleRule::setName(const ExecutionContext* execution_context, const String& text)
{
    ...
    auto tokens = tokenizer.TokenizeToEOF();
    CSSParserTokenRange token_range(tokens);
    AtomicString name = css_parsing_utils::ConsumeCounterStyleNameInPrelude(token_range, context);
