...
protected:
    const CounterStyle& GetCounterStyle(const AtomicString& name)
    {
        ...
        return *CounterStyleMap::GetUACounterStyleMap()->FindCounterStyleAcrossScopes(name);
    }

    const CounterStyle AddCounterStyle(const AtomicString& name, const String& descriptors)
    {
