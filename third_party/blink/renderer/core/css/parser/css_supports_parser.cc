...
bool CSSSupportsParser::IsEnclosedSupportsCondition(const CSSParserToken& first_token, const CSSParserToken& second_token)
{
    return (first_token.GetType() == kLeftParenthesisToken)
        && (AtIdent(second_token, "not") || second_token.GetType() == kLeftParenthesisToken || second_token.GetType() == kFunctionToken);
}
...
bool CSSSupportsParser::IsSupportsFeature(const CSSParserToken& first_token, const CSSParserToken& second_token)
{
    return IsSupportsSelectorFn(first_token, second_token) || IsSupportsDecl(first_token, second_token)
        || (RuntimeEnabledFeatures::SupportsFontFormatTechEnabled() && (IsFontFormatFn(first_token, second_token) || IsFontTechFn(first_token, second_token)));
}
...
CSSSupportsParser::Result CSSSupportsParser::ConsumeSupportsFeature(const CSSParserToken& first_token, CSSParserTokenStream& stream)
{
    ...
    if (IsFontTechFn(first_token, stream.Peek()) && RuntimeEnabledFeatures::SupportsFontFormatTechEnabled())
        return ConsumeFontTechFn(first_token, stream);

    // <supports-font-format-fn>
    if (IsFontFormatFn(first_token, stream.Peek()) && RuntimeEnabledFeatures::SupportsFontFormatTechEnabled())
...
CSSSupportsParser::Result CSSSupportsParser::ConsumeSupportsSelectorFn(const CSSParserToken& first_token, CSSParserTokenStream& stream)
{
...
CSSSupportsParser::Result CSSSupportsParser::ConsumeFontFormatFn(const CSSParserToken& first_token, CSSParserTokenStream& stream)
{
    ...
    CSSIdentifierValue* consumed_value = css_parsing_utils::ConsumeFontFormatIdent(format_block);
    ...
    parse_result = css_parsing_utils::IsSupportedKeywordFormat(consumed_value->GetValueID()) ? Result::kSupported : Result::kUnsupported;
...
CSSSupportsParser::Result CSSSupportsParser::ConsumeFontTechFn(const CSSParserToken& first_token, CSSParserTokenStream& stream)
{
    ...
    CSSIdentifierValue* consumed_value = css_parsing_utils::ConsumeFontTechIdent(technology_block);
    ...
    parse_result = css_parsing_utils::IsSupportedKeywordTech(consumed_value->GetValueID()) ? Result::kSupported : Result::kUnsupported;
...
CSSSupportsParser::Result CSSSupportsParser::ConsumeSupportsDecl(const CSSParserToken& first_token, CSSParserTokenStream& stream)
{
...
//                  | ( <ident> <any-value> )
CSSSupportsParser::Result CSSSupportsParser::ConsumeGeneralEnclosed(const CSSParserToken& first_token, CSSParserTokenStream& stream)
{
