...
TEST(CSSTokenizerTest, Escapes)
{
    ...
    TEST_TOKENS(String("null\\\0\0", 7u), Ident("null" + replacement + replacement));
...
TEST(CSSTokenizerTest, StringToken)
{
    ...
    TEST_TOKENS(String("'hel\0lo'", 8u), GetString("hel" + FromUChar32(0xFFFD) + "lo"));
    TEST_TOKENS(String("'h\\65l\0lo'", 10u), GetString("hel" + FromUChar32(0xFFFD) + "lo"));
}
...
TEST(CSSTokenizerTest, UnicodeRangeToken)
{
    ...
    TEST_TOKENS("u+222+111", UnicodeRng(0x222, 0x222), Number(kIntegerValueType, 111, kPlusSign));
    TEST_TOKENS("u+12345678", UnicodeRng(0x123456, 0x123456), Number(kIntegerValueType, 78, kNoSign));
    TEST_TOKENS("u+123-12345678", UnicodeRng(0x123, 0x123456), Number(kIntegerValueType, 78, kNoSign));
    ...
    TEST_TOKENS("u+a1?-123", UnicodeRng(0xa10, 0xa1f), Number(kIntegerValueType, -123, kMinusSign));
    TEST_TOKENS("u+1??4", UnicodeRng(0x100, 0x1ff), Number(kIntegerValueType, 4, kNoSign));
...
class CachedCSSTokenizerTest : public testing::Test, public testing::WithParamInterface<bool /* include_comments */> { };
