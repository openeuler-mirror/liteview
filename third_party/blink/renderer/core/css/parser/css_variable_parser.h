...
public:
    ...
    static CSSValue* ParseDeclarationIncludingCSSWide(const CSSTokenizedValue&, bool is_animation_tainted, const CSSParserContext&);
    static CSSCustomPropertyDeclaration* ParseDeclarationValue(const CSSTokenizedValue&, bool is_animation_tainted, const CSSParserContext&);
    static CSSVariableReferenceValue* ParseVariableReferenceValue(CSSParserTokenRange, const CSSParserContext&, bool is_animation_tainted);
