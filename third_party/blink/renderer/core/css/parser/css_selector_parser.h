...
public:
    ...
    static CSSSelectorVector ParseSelector(CSSParserTokenRange, const CSSParserContext*, StyleSheetContents*, Arena&);
    static CSSSelectorVector ConsumeSelector(CSSParserTokenStream&, const CSSParserContext*, StyleSheetContents*, CSSParserObserver*, Arena&);
    ...
    static absl::optional<CSSSelectorList> ParseScopeBoundary(CSSParserTokenRange, const CSSParserContext*, StyleSheetContents*);
...
private:
    ...
    CSSSelectorVector ConsumeComplexSelectorList(CSSParserTokenStream&, CSSParserObserver*);
    ...
    absl::optional<CSSSelectorList> ConsumeForgivingNestedSelectorList(CSSParserTokenRange&);
    // https://drafts.csswg.org/selectors/#typedef-forgiving-selector-list
    absl::optional<CSSSelectorList> ConsumeForgivingComplexSelectorList(CSSParserTokenRange&);
    absl::optional<CSSSelectorList> ConsumeForgivingCompoundSelectorList(CSSParserTokenRange&);
    // https://drafts.csswg.org/selectors/#typedef-relative-selector-list
    absl::optional<CSSSelectorList> ConsumeForgivingRelativeSelectorList(CSSParserTokenRange&);
    CSSSelectorList ConsumeRelativeSelectorList(CSSParserTokenRange&);

    ArenaUniquePtr<CSSParserSelector> ConsumeRelativeSelector(CSSParserTokenRange&);
    ArenaUniquePtr<CSSParserSelector> ConsumeComplexSelector(CSSParserTokenRange&);
    ...
    ArenaUniquePtr<CSSParserSelector> ConsumePartialComplexSelector(CSSParserTokenRange&, CSSSelector::RelationType& /* current combinator */,
        ArenaUniquePtr<CSSParserSelector> /* previous compound selector */, unsigned& /* previous compound flags */);

    ArenaUniquePtr<CSSParserSelector> ConsumeCompoundSelector(CSSParserTokenRange&);
    // This doesn't include element names, since they're handled specially
    ArenaUniquePtr<CSSParserSelector> ConsumeSimpleSelector(CSSParserTokenRange&);

    bool ConsumeName(CSSParserTokenRange&, AtomicString& name, AtomicString& namespace_prefix);
    ...
    void PrependTypeSelectorIfNeeded(const AtomicString& namespace_prefix, bool has_element_name, const AtomicString& element_name, CSSParserSelector*);
    ...
    static ArenaUniquePtr<CSSParserSelector> SplitCompoundAtImplicitShadowCrossingCombinator(ArenaUniquePtr<CSSParserSelector> compound_selector);
    void RecordUsageAndDeprecations(const CSSSelectorVector&);
    static bool ContainsUnknownWebkitPseudoElements(const CSSSelector& complex_selector);
