...
CSSParserLocalContext CSSParserLocalContext::WithAliasParsing(bool use_alias_parsing) const
{
...
CSSParserLocalContext CSSParserLocalContext::WithAnimationTainted(bool is_animation_tainted) const
{
    CSSParserLocalContext context = *this;
...
CSSParserLocalContext CSSParserLocalContext::WithCurrentShorthand(CSSPropertyID current_shorthand) const
{
    CSSParserLocalContext context = *this;
...
CSSParserLocalContext CSSParserLocalContext::WithVariableMode(VariableMode variable_mode) const
{
    CSSParserLocalContext context = *this;
...
CSSParserLocalContext::VariableMode CSSParserLocalContext::GetVariableMode() const
{
