...
public:
    static MediaQuerySet* ParseMediaQuerySet(const String&, const ExecutionContext*);
    static MediaQuerySet* ParseMediaQuerySet(CSSParserTokenRange, const ExecutionContext*);
    static MediaQuerySet* ParseMediaCondition(CSSParserTokenRange, const ExecutionContext*);
    static MediaQuerySet* ParseMediaQuerySetInMode(CSSParserTokenRange, CSSParserMode, const ExecutionContext*);
    ...
    public:
        ...
        virtual bool IsAllowedWithoutValue(const String& feature, const ExecutionContext*) const = 0;
...
private:
    ...
    const MediaQueryExpNode* ParseNameValueComparison(CSSParserTokenRange lhs, MediaQueryOperator op, CSSParserTokenRange rhs, NameAffinity, const FeatureSet&);
    ...
    const MediaQueryExpNode* ConsumeFeature(CSSParserTokenRange&, const FeatureSet&);
    ...
    // https://drafts.csswg.org/mediaqueries-4/#typedef-media-condition
    const MediaQueryExpNode* ConsumeCondition(CSSParserTokenRange&, ConditionMode = ConditionMode::kNormal);
