...
TEST_F(CSSSupportsParserTest, ConsumeSupportsSelectorFn)
{
    ...
    EXPECT_EQ(Result::kUnsupported, ConsumeSupportsSelectorFn("selector(div::-webkit-asdf)"));
    EXPECT_EQ(Result::kUnsupported, ConsumeSupportsSelectorFn("selector(a + div::-webkit-asdf)"));
    EXPECT_EQ(Result::kUnsupported, ConsumeSupportsSelectorFn("selector(div.cls::-webkit-asdf)"));
