...
public:
    ...
    static MutableCSSPropertyValueSet::SetResult ParseValue(MutableCSSPropertyValueSet*, CSSPropertyID, const String&, bool important, const CSSParserContext*);
    static MutableCSSPropertyValueSet::SetResult ParseVariableValue(
        MutableCSSPropertyValueSet*, const AtomicString& property_name, const String&, bool important, const CSSParserContext*, bool is_animation_tainted);
    static ImmutableCSSPropertyValueSet* ParseInlineStyleDeclaration(const String&, Element*);
    static ImmutableCSSPropertyValueSet* ParseInlineStyleDeclaration(const String&, CSSParserMode, SecureContextMode);
    ...
    static ParseSheetResult ParseStyleSheet(const String&, const CSSParserContext*, StyleSheetContents*, CSSDeferPropertyParsing = CSSDeferPropertyParsing::kNo,
        bool allow_import_rules = true, std::unique_ptr<CachedCSSTokenizer> tokenizer = nullptr);
    static CSSSelectorList ParsePageSelector(CSSParserTokenRange, StyleSheetContents*, const CSSParserContext& context);
...
private:
    ...
    template <typename T> bool ConsumeRuleList(CSSParserTokenStream&, RuleListType, T callback);
    ...
    StyleRuleKeyframe* ConsumeKeyframeStyleRule(CSSParserTokenRange prelude, const RangeOffset& prelude_offset, CSSParserTokenStream& block);
    ...
    void ConsumeDeclarationValue(const CSSTokenizedValue&, CSSPropertyID, bool important, StyleRule::RuleType);
    void ConsumeVariableValue(const CSSTokenizedValue&, const AtomicString& property_name, bool important, bool is_animation_tainted);
    ...
    const MediaQuerySet* CachedMediaQuerySet(String prelude_string, CSSParserTokenRange prelude);
