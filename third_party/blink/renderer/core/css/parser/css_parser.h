...
public:
    ...
    static CSSSelectorVector ParseSelector(const CSSParserContext*, StyleSheetContents*, const String&, Arena&);
    ...
    static MutableCSSPropertyValueSet::SetResult ParseValue(
        MutableCSSPropertyValueSet*, CSSPropertyID unresolved_property, const String&, bool important, const ExecutionContext* execution_context = nullptr);
    static MutableCSSPropertyValueSet::SetResult ParseValue(MutableCSSPropertyValueSet*, CSSPropertyID unresolved_property, const String&, bool important,
        SecureContextMode, StyleSheetContents*, const ExecutionContext* execution_context = nullptr);

    static MutableCSSPropertyValueSet::SetResult ParseValueForCustomProperty(MutableCSSPropertyValueSet*, const AtomicString& property_name,
    ...
    static bool ParseSystemColor(Color&, const String&, mojom::blink::ColorScheme color_scheme);
    ...
    static CSSPrimitiveValue* ParseLengthPercentage(const String&, const CSSParserContext*);
...
private:
    static MutableCSSPropertyValueSet::SetResult ParseValue(
        MutableCSSPropertyValueSet*, CSSPropertyID unresolved_property, const String&, bool important, const CSSParserContext*);
};
