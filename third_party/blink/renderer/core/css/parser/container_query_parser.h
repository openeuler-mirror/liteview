...
private:
    ...
    const MediaQueryExpNode* ConsumeFeatureQuery(CSSParserTokenRange&, const FeatureSet&);
    const MediaQueryExpNode* ConsumeFeatureQueryInParens(CSSParserTokenRange&, const FeatureSet&);
    const MediaQueryExpNode* ConsumeFeatureCondition(CSSParserTokenRange&, const FeatureSet&);
