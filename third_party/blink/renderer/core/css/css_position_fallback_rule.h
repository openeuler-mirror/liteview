...
template <> struct DowncastTraits<StyleRulePositionFallback> {
...
public:
    ...
    String name() const
    {
        return position_fallback_rule_->Name();
    }

    Type GetType() const final
    {
        return kPositionFallbackRule;
    }
    CSSRuleList* cssRules() const final
    {
        return rule_list_cssom_wrapper_;
    }
...
template <> struct DowncastTraits<CSSPositionFallbackRule> {
