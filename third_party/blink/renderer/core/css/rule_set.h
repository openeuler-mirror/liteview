...
public:
    ...
    RuleData(StyleRule*, unsigned selector_index, unsigned position, unsigned extra_specificity, AddRuleFlags);
...
public:
    ...
    void AddRulesFromSheet(StyleSheetContents*, const MediaQueryEvaluator&, AddRuleFlags = kRuleHasNoSpecialState, CascadeLayer* = nullptr);
    ...
    const HeapVector<Member<StyleRulePositionFallback>>& PositionFallbackRules() const
    {
...
private:
    ...
    void AddChildRules(
        const HeapVector<Member<StyleRuleBase>>&, const MediaQueryEvaluator& medium, AddRuleFlags, const ContainerQuery*, CascadeLayer*, const StyleScope*);
