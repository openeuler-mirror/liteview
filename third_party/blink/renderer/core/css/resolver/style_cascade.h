...
private:
    ...
    public:
        ...
        bool Append(CSSVariableData* data, wtf_size_t limit = std::numeric_limits<wtf_size_t>::max());
    ...
    const CSSValue* ResolveCustomProperty(const CSSProperty&, const CSSCustomPropertyDeclaration&, CascadeResolver&);
    const CSSValue* ResolveVariableReference(const CSSProperty&, const CSSVariableReferenceValue&, CascadeResolver&);
    ...
    const CSSValue* ResolveRevertLayer(const CSSProperty&, const CSSValue&, CascadePriority, CascadeOrigin&, CascadeResolver&);

    scoped_refptr<CSSVariableData> ResolveVariableData(CSSVariableData*, CascadeResolver&);
