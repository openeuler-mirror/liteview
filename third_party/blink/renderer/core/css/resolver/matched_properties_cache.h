...
public:
    ...
    void Set(const ComputedStyle&, const ComputedStyle& parent_style, const MatchedPropertiesVector&);
    void Clear();
...
public:
    ...
    public:
        ...
        bool IsValid() const
        {
            ...
            return hash_ != HashTraits<unsigned>::EmptyValue() && !HashTraits<unsigned>::IsDeletedValue(hash_);
        }
...
private:
    ...
    using Cache = HeapHashMap<unsigned, Member<CachedMatchedProperties>, DefaultHash<unsigned>::Hash, HashTraits<unsigned>>;
