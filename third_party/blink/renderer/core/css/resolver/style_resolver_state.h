...
public:
    ...
    bool CanCacheBaseStyle() const
    {
        return can_cache_base_style_;
    }
...
private:
    ...
    CSSToLengthConversionData UnzoomedLengthConversionData(const ComputedStyle* font_style) const;
