...
public:
    ...
    void UpdateFontDescription(FontDescription&, FontOrientation = FontOrientation::kHorizontal);
    ...
    static float InitialSizeAdjust()
    {
        return kFontSizeAdjustNone;
    }
    ...
    static FontSelectionValue InitialStyle()
    {
...
private:
    ...
    void UpdateSpecifiedSize(FontDescription&, const ComputedStyle&, const ComputedStyle* parent_style);
    ...
    float GetComputedSizeFromSpecifiedSize(FontDescription&, float effective_zoom, float specified_size);
