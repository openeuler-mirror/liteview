...
TransformOperations TransformBuilder::CreateTransformOperations(const CSSValue& in_value, const CSSToLengthConversionData& conversion_data)
{
    ...
    for (auto& value : *in_value_list) {
        ...
        case TransformOperation::kScaleY: {
            ...
            operations.Operations().push_back(ScaleTransformOperation::Create(sx, sy, 1.0, transform_type));
            break;
        }
        ...
        case TransformOperation::kScale3D: {
            ...
            operations.Operations().push_back(ScaleTransformOperation::Create(sx, sy, sz, transform_type));
            break;
        }
        ...
        case TransformOperation::kTranslateY: {
            ...
            operations.Operations().push_back(TranslateTransformOperation::Create(tx, ty, 0, transform_type));
            break;
        }
        ...
        case TransformOperation::kTranslate3D: {
            ...
            operations.Operations().push_back(TranslateTransformOperation::Create(tx, ty, tz, transform_type));
            break;
        }
        ...
        case TransformOperation::kRotate: {
            ...
            if (transform_value->length() == 1) {
                ...
                operations.Operations().push_back(RotateTransformOperation::Create(x, y, z, angle, transform_type));
            } else {
                ...
                operations.Operations().push_back(RotateAroundOriginTransformOperation::Create(
        ...
        case TransformOperation::kSkewY: {
            ...
            operations.Operations().push_back(SkewTransformOperation::Create(angle_x, angle_y, transform_type));
            break;
        }
        case TransformOperation::kMatrix: {
            double a = To<CSSPrimitiveValue>(transform_value->Item(0)).GetDoubleValue();
            double b = To<CSSPrimitiveValue>(transform_value->Item(1)).GetDoubleValue();
            double c = To<CSSPrimitiveValue>(transform_value->Item(2)).GetDoubleValue();
            double d = To<CSSPrimitiveValue>(transform_value->Item(3)).GetDoubleValue();
            double e = zoom_factor * To<CSSPrimitiveValue>(transform_value->Item(4)).GetDoubleValue();
            double f = zoom_factor * To<CSSPrimitiveValue>(transform_value->Item(5)).GetDoubleValue();
            operations.Operations().push_back(MatrixTransformOperation::Create(a, b, c, d, e, f));
            break;
        }
        case TransformOperation::kMatrix3D: {
            auto matrix = TransformationMatrix::ColMajor(To<CSSPrimitiveValue>(transform_value->Item(0)).GetDoubleValue(),
                To<CSSPrimitiveValue>(transform_value->Item(1)).GetDoubleValue(), To<CSSPrimitiveValue>(transform_value->Item(2)).GetDoubleValue(),
                To<CSSPrimitiveValue>(transform_value->Item(3)).GetDoubleValue(), To<CSSPrimitiveValue>(transform_value->Item(4)).GetDoubleValue(),
                To<CSSPrimitiveValue>(transform_value->Item(5)).GetDoubleValue(), To<CSSPrimitiveValue>(transform_value->Item(6)).GetDoubleValue(),
                To<CSSPrimitiveValue>(transform_value->Item(7)).GetDoubleValue(), To<CSSPrimitiveValue>(transform_value->Item(8)).GetDoubleValue(),
                To<CSSPrimitiveValue>(transform_value->Item(9)).GetDoubleValue(), To<CSSPrimitiveValue>(transform_value->Item(10)).GetDoubleValue(),
                To<CSSPrimitiveValue>(transform_value->Item(11)).GetDoubleValue(), To<CSSPrimitiveValue>(transform_value->Item(12)).GetDoubleValue(),
                To<CSSPrimitiveValue>(transform_value->Item(13)).GetDoubleValue(), To<CSSPrimitiveValue>(transform_value->Item(14)).GetDoubleValue(),
                To<CSSPrimitiveValue>(transform_value->Item(15)).GetDoubleValue());
            matrix.Zoom(zoom_factor);
            operations.Operations().push_back(Matrix3DTransformOperation::Create(matrix));
            break;
        }
        case TransformOperation::kPerspective: {
            ...
            operations.Operations().push_back(PerspectiveTransformOperation::Create(p));
            break;
        }
        default:
            NOTREACHED();
