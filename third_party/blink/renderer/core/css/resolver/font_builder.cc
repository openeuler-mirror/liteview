...
void FontBuilder::SetInitial(float effective_zoom)
{
    ...
    SetFamilyDescription(font_description_, FontBuilder::InitialFamilyDescription());
...
void FontBuilder::SetFeatureSettings(scoped_refptr<FontFeatureSettings> settings)
{
    Set(PropertySetFlag::kFeatureSettings);
    font_description_.SetFeatureSettings(std::move(settings));
}

void FontBuilder::SetVariationSettings(scoped_refptr<FontVariationSettings> settings)
{
...
float FontBuilder::GetComputedSizeFromSpecifiedSize(FontDescription& font_description, float effective_zoom, float specified_size)
{
    DCHECK(document_);
...
void FontBuilder::CheckForGenericFamilyChange(const FontDescription& parent_description, FontDescription& new_description)
{
    ...
    if (new_description.GenericFamily() != FontDescription::kMonospaceFamily && parent_description.GenericFamily() != FontDescription::kMonospaceFamily)
        return;
...
void FontBuilder::UpdateSpecifiedSize(FontDescription& font_description, const ComputedStyle& style, const ComputedStyle* parent_style)
{
    ...
    const FontDescription& parent_description = parent_style ? parent_style->GetFontDescription() : style.GetFontDescription();

    CheckForGenericFamilyChange(parent_description, font_description);
}

void FontBuilder::UpdateAdjustedSize(FontDescription& font_description, const ComputedStyle& style, FontSelector* font_selector)
{
...
void FontBuilder::UpdateComputedSize(FontDescription& font_description, const ComputedStyle& style)
{
    float computed_size = GetComputedSizeFromSpecifiedSize(font_description, style.EffectiveZoom(), font_description.SpecifiedSize());
    computed_size = TextAutosizer::ComputeAutosizedFontSize(computed_size, style.TextAutosizingMultiplier(), style.EffectiveZoom());
    font_description.SetComputedSize(computed_size);
}

void FontBuilder::UpdateFontDescription(FontDescription& description, FontOrientation font_orientation)
{
...
void FontBuilder::CreateFont(ComputedStyle& style, const ComputedStyle* parent_style)
{
    DCHECK(document_);
