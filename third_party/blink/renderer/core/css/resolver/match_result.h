...
public:
    ...
    unsigned GetLinkMatchType() const
    {
    ...
    unsigned GetLayerOrder() const
    {
        return layer_order_;
    }
    bool IsInlineStyle() const
    {
        return is_inline_style_;
    }
...
public:
    AddMatchedPropertiesOptions Build()
    {
        return options_;
    }
...
public:
    ...
    void AddMatchedProperties(const CSSPropertyValueSet* properties, const AddMatchedPropertiesOptions& = AddMatchedPropertiesOptions());
...
{
    return a.properties == b.properties && a.types_.link_match_type == b.types_.link_match_type;
}
