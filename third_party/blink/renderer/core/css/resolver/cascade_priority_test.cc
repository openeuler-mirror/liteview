...
{
    return CascadePriority(CascadeOrigin::kAuthor, false, tree_order, false, 0, position);
}

CascadePriority ImportantAuthorPriority(uint16_t tree_order, uint32_t position)
{
    return CascadePriority(CascadeOrigin::kAuthor, true, tree_order, false, 0, position);
}
...
TEST(CascadePriorityTest, OriginOperators)
{
    std::vector<CascadePriority> priorities
        = { CascadePriority(CascadeOrigin::kTransition, false, 0, false, 0, 0), CascadePriority(CascadeOrigin::kAnimation, false, 0, false, 0, 0),
              CascadePriority(CascadeOrigin::kAuthor, false, 0, false, 0, 0), CascadePriority(CascadeOrigin::kUser, false, 0, false, 0, 0),
              CascadePriority(CascadeOrigin::kUserAgent, false, 0, false, 0, 0), CascadePriority(CascadeOrigin::kNone, false, 0, false, 0, 0) };
...
{
    std::vector<CascadePriority> priorities = { CascadePriority(CascadeOrigin::kTransition, false, 0, false, 0, 0),
        CascadePriority(CascadeOrigin::kUserAgent, true, 0, false, 0, 0), CascadePriority(CascadeOrigin::kUser, true, 0, false, 0, 0),
        CascadePriority(CascadeOrigin::kAuthor, true, 0, false, 0, 0), CascadePriority(CascadeOrigin::kAnimation, false, 0, false, 0, 0),
        CascadePriority(CascadeOrigin::kAuthor, false, 0, false, 0, 0), CascadePriority(CascadeOrigin::kUser, false, 0, false, 0, 0),
        CascadePriority(CascadeOrigin::kUserAgent, false, 0, false, 0, 0), CascadePriority(CascadeOrigin::kNone, false, 0, false, 0, 0) };
...
TEST(CascadePriorityTest, IsImportant)
{
    ...
    EXPECT_FALSE(Priority(Origin::kUserAgent, false, 0, false, 0, 0).IsImportant());
    ...
    EXPECT_FALSE(Priority(Origin::kAnimation, false, 0, false, 0, 0).IsImportant());
    EXPECT_FALSE(Priority(Origin::kTransition, false, 0, false, 0, 0).IsImportant());
    EXPECT_FALSE(Priority(Origin::kAuthor, false, 1024, false, 2048, 4096).IsImportant());
    ...
    EXPECT_TRUE(Priority(Origin::kTransition, true, 0, false, 0, 0).IsImportant());
    EXPECT_TRUE(Priority(Origin::kAuthor, true, 1024, false, 2048, 4096).IsImportant());
}
...
TEST(CascadePriorityTest, GetOrigin)
{
    for (CascadeOrigin origin : all_origins) {
        EXPECT_EQ(CascadePriority(origin, false, 0, false, 0, 0).GetOrigin(), origin);
    }
    ...
    for (CascadeOrigin origin : all_origins) {
        ...
        if (origin == CascadeOrigin::kTransition)
            continue;
        EXPECT_EQ(CascadePriority(origin, true, 0, false, 0, 0).GetOrigin(), origin);
    }
}
...
TEST(CascadePriorityTest, LayerOrder)
{
    using Priority = CascadePriority;
    CascadeOrigin origin = CascadeOrigin::kAuthor;
    EXPECT_GE(Priority(origin, false, 0, false, 1, 0), Priority(origin, false, 0, false, 0, 0));
    EXPECT_GE(Priority(origin, false, 0, false, 7, 0), Priority(origin, false, 0, false, 6, 0));
    EXPECT_GE(Priority(origin, false, 0, false, 42, 0), Priority(origin, false, 0, false, 42, 0));
    EXPECT_FALSE(Priority(origin, false, 0, false, 1, 0) >= Priority(origin, false, 0, false, 8, 0));
}
...
TEST(CascadePriorityTest, LayerOrderImportant)
{
    using Priority = CascadePriority;
    CascadeOrigin origin = CascadeOrigin::kAuthor;
    EXPECT_GE(Priority(origin, true, 0, false, 0, 0), Priority(origin, true, 0, false, 1, 0));
    EXPECT_GE(Priority(origin, true, 0, false, 6, 0), Priority(origin, true, 0, false, 7, 0));
    EXPECT_GE(Priority(origin, true, 0, false, 42, 0), Priority(origin, true, 0, false, 42, 0));
    EXPECT_FALSE(Priority(origin, true, 0, false, 8, 0) >= Priority(origin, true, 0, false, 1, 0));
}
...
TEST(CascadePriorityTest, LayerOrderDifferentOrigin)
{
    ...
    CascadeOrigin author = CascadeOrigin::kAuthor;
    CascadeOrigin transition = CascadeOrigin::kTransition;
    EXPECT_GE(Priority(transition, false, 0, false, 1, 0), Priority(author, false, 0, false, 42, 0));
    EXPECT_GE(Priority(transition, false, 0, false, 1, 0), Priority(author, false, 0, false, 1, 0));
}
...
TEST(CascadePriorityTest, InlineStyle)
{
    ...
    EXPECT_GE(Priority(author, false, 0, true, 0, 0), Priority(author, false, 0, false, 0, 1));
    EXPECT_GE(Priority(author, false, 0, true, 0, 0), Priority(author, false, 0, false, 1, 0));
    EXPECT_GE(Priority(author, false, 1, true, 0, 0), Priority(author, false, 0, false, 0, 0));
    EXPECT_LT(Priority(author, false, 1, true, 0, 0), Priority(author, false, 2, false, 0, 0));
    EXPECT_GE(Priority(author, false, 0, true, 0, 0), Priority(user, false, 0, false, 0, 0));
    EXPECT_LT(Priority(author, false, 0, true, 0, 0), Priority(author, true, 0, false, 0, 0));

    // Important inline style priorities
    EXPECT_GE(Priority(author, true, 0, true, 0, 0), Priority(author, true, 0, false, 0, 1));
    EXPECT_GE(Priority(author, true, 0, true, 0, 0), Priority(author, true, 0, false, 1, 0));
    EXPECT_LT(Priority(author, true, 1, true, 0, 0), Priority(author, true, 0, false, 0, 0));
    EXPECT_GE(Priority(author, true, 1, true, 0, 0), Priority(author, true, 2, false, 0, 0));
    EXPECT_LT(Priority(author, true, 0, true, 0, 0), Priority(user, true, 0, false, 0, 0));
    EXPECT_GE(Priority(author, true, 0, true, 0, 0), Priority(author, false, 0, false, 0, 0));
}
...
TEST(CascadePriorityTest, ForLayerComparison)
{
    ...
    EXPECT_EQ(Priority(author, false, 0, false, 1, 2).ForLayerComparison(), Priority(author, false, 0, false, 1, 8).ForLayerComparison());
    EXPECT_EQ(Priority(author, true, 1, false, 1, 4).ForLayerComparison(), Priority(author, true, 1, false, 1, 8).ForLayerComparison());
    EXPECT_EQ(Priority(author, true, 1, false, 1, 16).ForLayerComparison(), Priority(author, false, 1, false, 1, 32).ForLayerComparison());
    EXPECT_EQ(Priority(author, true, 1, true, 0, 16).ForLayerComparison(), Priority(author, false, 1, true, 0, 32).ForLayerComparison());

    EXPECT_LT(Priority(user, false, 0, false, 0, 1).ForLayerComparison(), Priority(user, false, 0, false, 1, 0).ForLayerComparison());
    EXPECT_LT(Priority(user, false, 0, false, 0, 1).ForLayerComparison(), Priority(user, false, 0, true, 0, 0).ForLayerComparison());
    EXPECT_LT(Priority(user, false, 0, false, 0, 1).ForLayerComparison(), Priority(user, false, 1, false, 0, 0).ForLayerComparison());
    EXPECT_LT(Priority(user, false, 0, false, 0, 1).ForLayerComparison(), Priority(author, false, 0, false, 0, 0).ForLayerComparison());
    EXPECT_LT(Priority(user, true, 0, false, 0, 1).ForLayerComparison(), Priority(user, false, 0, false, 1, 0).ForLayerComparison());
    EXPECT_LT(Priority(user, true, 0, false, 0, 1).ForLayerComparison(), Priority(user, false, 0, true, 0, 0).ForLayerComparison());
    EXPECT_LT(Priority(user, true, 0, false, 0, 1).ForLayerComparison(), Priority(user, false, 1, false, 0, 0).ForLayerComparison());
    EXPECT_LT(Priority(user, true, 0, false, 0, 1).ForLayerComparison(), Priority(author, false, 0, false, 0, 0).ForLayerComparison());
    EXPECT_LT(Priority(user, false, 0, false, 0, 1).ForLayerComparison(), Priority(user, true, 0, false, 1, 0).ForLayerComparison());
    EXPECT_LT(Priority(user, false, 0, false, 0, 1).ForLayerComparison(), Priority(user, true, 0, true, 0, 0).ForLayerComparison());
    EXPECT_LT(Priority(user, false, 0, false, 0, 1).ForLayerComparison(), Priority(user, true, 1, false, 0, 0).ForLayerComparison());
    EXPECT_LT(Priority(user, false, 0, false, 0, 1).ForLayerComparison(), Priority(author, true, 0, false, 0, 0).ForLayerComparison());
    EXPECT_LT(Priority(user, true, 0, false, 0, 1).ForLayerComparison(), Priority(user, true, 0, false, 1, 0).ForLayerComparison());
    EXPECT_LT(Priority(user, true, 0, false, 0, 1).ForLayerComparison(), Priority(user, true, 0, true, 0, 0).ForLayerComparison());
    EXPECT_LT(Priority(user, true, 0, false, 0, 1).ForLayerComparison(), Priority(user, true, 1, false, 0, 0).ForLayerComparison());
    EXPECT_LT(Priority(user, true, 0, false, 0, 1).ForLayerComparison(), Priority(author, true, 0, false, 0, 0).ForLayerComparison());
}
