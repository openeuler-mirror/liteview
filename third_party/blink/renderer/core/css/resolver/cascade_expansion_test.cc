...
public:
    ...
    HeapVector<Member<ExpansionResult>> ExpansionAt(const MatchResult& result, wtf_size_t i)
    {
        ...
        ExpandCascade(result.GetMatchedProperties()[i], GetDocument(), i,
            [&ret](CascadePriority cascade_priority, const CSSProperty& css_property, const CSSPropertyName& name, const CSSValue& css_value,
                uint16_t tree_order) {
                ExpansionResult* er = MakeGarbageCollected<ExpansionResult>(css_property);
    ...
    Vector<CSSPropertyID> VisitedPropertiesInExpansion(const MatchedProperties& matched_properties, wtf_size_t i)
    {
        ...
        ExpandCascade(matched_properties, GetDocument(), i,
            [&visited](CascadePriority cascade_priority [[maybe_unused]], const CSSProperty& css_property, const CSSPropertyName& name,
                const CSSValue& css_value [[maybe_unused]], uint16_t tree_order [[maybe_unused]]) {
                EXPECT_EQ(name, css_property.GetCSSPropertyName());
...
TEST_F(CascadeExpansionTest, Name)
{
...

    {
        auto e = ExpansionAt(result, 0);
        ASSERT_EQ(2u, e.size());
        EXPECT_EQ(CSSPropertyName("--x"), e[0]->ref.GetProperty().GetCSSPropertyName());
        EXPECT_EQ(CSSPropertyID::kVariable, e[0]->ref.GetProperty().PropertyID());
        EXPECT_EQ(CSSPropertyName("--y"), e[1]->ref.GetProperty().GetCSSPropertyName());
...
TEST_F(CascadeExpansionTest, LinkOmitted)
{
    ...
    result.AddMatchedProperties(
        ParseDeclarationBlock("color:red"), AddMatchedPropertiesOptions::Builder().SetLinkMatchType(CSSSelector::kMatchVisited).Build());
    result.FinishAddingAuthorRulesForTreeScope(GetDocument());
...
TEST_F(CascadeExpansionTest, InternalVisitedOmitted)
{
    ...
    result.FinishAddingUserRules();
    result.FinishAddingPresentationalHints();
    result.AddMatchedProperties(ParseDeclarationBlock("color:red"), AddMatchedPropertiesOptions::Builder().SetLinkMatchType(CSSSelector::kMatchLink).Build());
    result.FinishAddingAuthorRulesForTreeScope(GetDocument());
...
TEST_F(CascadeExpansionTest, InlineAll)
{
    ...
    result.FinishAddingUserRules();
    result.FinishAddingPresentationalHints();
    result.AddMatchedProperties(ParseDeclarationBlock("left:1px;all:unset;right:1px"));
    result.FinishAddingAuthorRulesForTreeScope(GetDocument());
...
TEST_F(CascadeExpansionTest, FilterFirstLetter)
{
    ...
    result.AddMatchedProperties(ParseDeclarationBlock("object-fit:unset;font-size:1px"),
        AddMatchedPropertiesOptions::Builder().SetValidPropertyFilter(ValidPropertyFilter::kFirstLetter).Build());
    result.FinishAddingAuthorRulesForTreeScope(GetDocument());
...
TEST_F(CascadeExpansionTest, FilterFirstLine)
{
    ...
    result.AddMatchedProperties(ParseDeclarationBlock("display:none;font-size:1px"),
        AddMatchedPropertiesOptions::Builder().SetValidPropertyFilter(ValidPropertyFilter::kFirstLine).Build());
    result.FinishAddingAuthorRulesForTreeScope(GetDocument());
...
TEST_F(CascadeExpansionTest, FilterCue)
{
    ...
    result.FinishAddingPresentationalHints();
    result.AddMatchedProperties(ParseDeclarationBlock("object-fit:unset;font-size:1px"),
        AddMatchedPropertiesOptions::Builder().SetValidPropertyFilter(ValidPropertyFilter::kCue).Build());
    result.FinishAddingAuthorRulesForTreeScope(GetDocument());
...
TEST_F(CascadeExpansionTest, FilterMarker)
{
    ...
    result.FinishAddingPresentationalHints();
    result.AddMatchedProperties(ParseDeclarationBlock("object-fit:unset;font-size:1px"),
        AddMatchedPropertiesOptions::Builder().SetValidPropertyFilter(ValidPropertyFilter::kMarker).Build());
    result.FinishAddingAuthorRulesForTreeScope(GetDocument());
...
TEST_F(CascadeExpansionTest, FilterHighlightLegacy)
{
    ...
    result.AddMatchedProperties(ParseDeclarationBlock("display:block;background-color:lime;forced-color-adjust:none"),
        AddMatchedPropertiesOptions::Builder().SetValidPropertyFilter(ValidPropertyFilter::kHighlightLegacy).Build());
    result.FinishAddingAuthorRulesForTreeScope(GetDocument());
...
TEST_F(CascadeExpansionTest, FilterHighlight)
{
    ...
    result.FinishAddingPresentationalHints();
    result.AddMatchedProperties(ParseDeclarationBlock("display:block;background-color:lime;forced-color-adjust:none"),
        AddMatchedPropertiesOptions::Builder().SetValidPropertyFilter(ValidPropertyFilter::kHighlight).Build());
    result.FinishAddingAuthorRulesForTreeScope(GetDocument());
...
TEST_F(CascadeExpansionTest, Importance)
{
    ...
    result.FinishAddingUserRules();
    result.FinishAddingPresentationalHints();
    result.AddMatchedProperties(ParseDeclarationBlock("cursor:help;display:block !important"));
    result.FinishAddingAuthorRulesForTreeScope(GetDocument());
...
TEST_F(CascadeExpansionTest, AllVisitedOnly)
{
    ...
    result.FinishAddingPresentationalHints();
    result.AddMatchedProperties(ParseDeclarationBlock("all:unset"),
        AddMatchedPropertiesOptions::Builder().SetLinkMatchType(CSSSelector::kMatchVisited).SetValidPropertyFilter(ValidPropertyFilter::kNoFilter).Build());
    result.FinishAddingAuthorRulesForTreeScope(GetDocument());
...
TEST_F(CascadeExpansionTest, AllVisitedOrLink)
{
    ...
    result.FinishAddingPresentationalHints();
    result.AddMatchedProperties(ParseDeclarationBlock("all:unset"),
        AddMatchedPropertiesOptions::Builder().SetLinkMatchType(CSSSelector::kMatchAll).SetValidPropertyFilter(ValidPropertyFilter::kNoFilter).Build());
    result.FinishAddingAuthorRulesForTreeScope(GetDocument());
...
TEST_F(CascadeExpansionTest, AllLinkOnly)
{
    ...
    result.FinishAddingPresentationalHints();
    result.AddMatchedProperties(ParseDeclarationBlock("all:unset"),
        AddMatchedPropertiesOptions::Builder().SetLinkMatchType(CSSSelector::kMatchLink).SetValidPropertyFilter(ValidPropertyFilter::kNoFilter).Build());
    result.FinishAddingAuthorRulesForTreeScope(GetDocument());
...
TEST_F(CascadeExpansionTest, MatchedDeclarationsLimit)
{
    ...
    MatchResult result;
    result.AddMatchedProperties(ImmutableCSSPropertyValueSet::Create(declarations.data(), max + 1, kHTMLStandardMode));
    result.AddMatchedProperties(ImmutableCSSPropertyValueSet::Create(declarations.data(), max + 2, kHTMLStandardMode));
