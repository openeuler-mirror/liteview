...
{
    return MediaQueryExpValue(value, CSSPrimitiveValue::UnitType::kDynamicViewportHeight);
}

MediaQueryExpValue SvhValue(double value)
{
    return MediaQueryExpValue(value, CSSPrimitiveValue::UnitType::kSmallViewportHeight);
}

MediaQueryExpValue LvhValue(double value)
{
    return MediaQueryExpValue(value, CSSPrimitiveValue::UnitType::kLargeViewportHeight);
}

MediaQueryExpValue VhValue(double value)
{
    return MediaQueryExpValue(value, CSSPrimitiveValue::UnitType::kViewportHeight);
}

MediaQueryExpValue CqhValue(double value)
{
    return MediaQueryExpValue(value, CSSPrimitiveValue::UnitType::kContainerHeight);
}
...
{
    return MediaQueryExp::Create(feature, MediaQueryExpBounds(cmp, NoCmp(InvalidValue())));
}

MediaQueryExp RightExp(String feature, MediaQueryExpComparison cmp)
{
    return MediaQueryExp::Create(feature, MediaQueryExpBounds(NoCmp(InvalidValue()), cmp));
}
...
TEST(MediaQueryExpTest, SerializeNode)
{
    ...
    EXPECT_EQ("special(width < 10px)", FunctionNode(FeatureNode(RightExp("width", LtCmp(PxValue(10)))), "special")->Serialize());
    EXPECT_EQ("special((width < 10px))", FunctionNode(EnclosedFeatureNode(RightExp("width", LtCmp(PxValue(10)))), "special")->Serialize());
    EXPECT_EQ("special((11px >= thing) and (height = 12px))",
        FunctionNode(AndNode(EnclosedFeatureNode(LeftExp("thing", GeCmp(PxValue(11)))), EnclosedFeatureNode(RightExp("height", EqCmp(PxValue(12))))), "special")
            ->Serialize());
}
...
TEST(MediaQueryExpTest, UnitFlags)
{
    ...
    const auto* calc_value = DynamicTo<CSSPrimitiveValue>(css_test_helpers::ParseValue(*Document::CreateForTest(), "<length>", "calc(10em + 10dvh)"));
