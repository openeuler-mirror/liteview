...
MediaQuerySet* MediaQuerySet::Create(const String& media_string, const ExecutionContext* execution_context)
{
...
const MediaQuerySet* MediaQuerySet::CopyAndAdd(const String& query_string, const ExecutionContext* execution_context) const
{
...
const MediaQuerySet* MediaQuerySet::CopyAndRemove(const String& query_string_to_remove, const ExecutionContext* execution_context) const
{
    // To "parse a media query" for a given string means to follow "the parse
    // a media query list" steps and return "null" if more than one media query
    // is returned, or else the returned media query.
...
void MediaList::setMediaText(const ExecutionContext* execution_context, const String& value)
{
...
void MediaList::deleteMedium(const ExecutionContext* execution_context, const String& medium, ExceptionState& exception_state)
{
    CSSStyleSheet::RuleMutationScope mutation_scope(parent_rule_);
...
void MediaList::appendMedium(const ExecutionContext* execution_context, const String& medium)
{
    CSSStyleSheet::RuleMutationScope mutation_scope(parent_rule_);
