...
public:
    ...
    virtual void SetPropertyInternal(CSSPropertyID, const String& property_value, const String& value, bool important, SecureContextMode, ExceptionState&) = 0;
    ...
    NamedPropertySetterResult AnonymousNamedSetter(ScriptState*, const AtomicString& name, const ScriptValue& value);
