...
class CORE_EXPORT FontFaceSet : public EventTargetWithInlineData, public ExecutionContextClient, public FontFaceSetIterable, public FontFace::LoadFontCallback {
...
protected:
    ...
    using ReadyProperty = ScriptPromiseProperty<Member<FontFaceSet>, Member<DOMException>>;
