...
class ScopeProximityTest : public PageTestBase, public testing::WithParamInterface<ScopeProximityTestData>, private ScopedCSSScopeForTest {
public:
    ScopeProximityTest()
...
TEST_P(ScopeProximityTest, All)
{
    ...
    EXPECT_EQ(param.proximity, match ? absl::optional<unsigned>(result.proximity) : absl::nullopt);
}
