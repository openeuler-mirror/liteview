...
public:
    ...
    static bool IsValidToggleShorthand(const CSSValue* toggle_root, const CSSValue* toggle_trigger);
...
private:
    ...
    void AppendBackgroundPropertyAsText(StringBuilder& result, unsigned& num_decls) const;
