...
public:
    ...
    static StyleScope* Parse(CSSParserTokenRange prelude, const CSSParserContext* context, StyleSheetContents* style_sheet);
    ...
    const CSSSelectorList& From() const
    {
        return from_;
    }
    const absl::optional<CSSSelectorList>& To() const
    {
        return to_;
    }
