...
// system of HTML.
static const int kQuirksFontSizeTable[kFontSizeTableMax - kFontSizeTableMin + 1][kTotalKeywords] = {
...
static const int kStrictFontSizeTable[kFontSizeTableMax - kFontSizeTableMin + 1][kTotalKeywords] = {
...
static const float kFontSizeFactors[kTotalKeywords] = { 0.60f, 0.75f, 0.89f, 1.0f, 1.2f, 1.5f, 2.0f, 3.0f };

static int inline RowFromMediumFontSizeInRange(const Settings* settings, bool quirks_mode, bool is_monospace, int& medium_size)
{
...
template <typename T> static int FindNearestLegacyFontSize(int pixel_font_size, const T* table, int multiplier)
{
