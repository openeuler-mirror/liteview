...
public:
    ...
    static scoped_refptr<CSSCustomFontData> Create(CSSFontFaceSource* source, FallbackVisibility visibility)
    {
    ...
    void ClearFontFaceSource() override
    {
        font_face_source_ = nullptr;
    }
