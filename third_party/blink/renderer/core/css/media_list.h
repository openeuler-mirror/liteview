...
public:
    ...
    static MediaQuerySet* Create(const String& media_string, const ExecutionContext*);
    ...
    const MediaQuerySet* CopyAndRemove(const String&, const ExecutionContext*) const;
...
public:
    ...
    void deleteMedium(const ExecutionContext*, const String& old_medium, ExceptionState&);
