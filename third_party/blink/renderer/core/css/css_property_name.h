...
public:
    ...
    static absl::optional<CSSPropertyName> From(const ExecutionContext* execution_context, const String& value)
    {
...
template <> struct DefaultHash<blink::CSSPropertyName> {
    struct Hash {
        STATIC_ONLY(Hash);
        ...
        static bool Equal(const blink::CSSPropertyName& a, const blink::CSSPropertyName& b)
        {
            return a == b;
        }
