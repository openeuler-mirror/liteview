...
ColorSpaceGamut MediaValues::CalculateColorGamut(LocalFrame* frame)
{
    ...
    absl::optional<ColorSpaceGamut> override_value = overrides ? overrides->GetColorGamut() : absl::nullopt;
...
mojom::blink::PreferredColorScheme MediaValues::CalculatePreferredColorScheme(LocalFrame* frame)
{
    ...
    DCHECK(frame->GetPage());
    const MediaFeatureOverrides* overrides = frame->GetPage()->GetMediaFeatureOverrides();
    absl::optional<mojom::blink::PreferredColorScheme> override_value = overrides ? overrides->GetPreferredColorScheme() : absl::nullopt;
    return override_value.value_or(frame->GetDocument()->GetStyleEngine().GetPreferredColorScheme());
}
...
mojom::blink::PreferredContrast MediaValues::CalculatePreferredContrast(LocalFrame* frame)
{
    ...
    DCHECK(frame->GetPage());
    const MediaFeatureOverrides* overrides = frame->GetPage()->GetMediaFeatureOverrides();
    absl::optional<mojom::blink::PreferredContrast> override_value = overrides ? overrides->GetPreferredContrast() : absl::nullopt;
...
bool MediaValues::CalculatePrefersReducedMotion(LocalFrame* frame)
{
    ...
    DCHECK(frame->GetSettings());
    const MediaFeatureOverrides* overrides = frame->GetPage()->GetMediaFeatureOverrides();
    absl::optional<bool> override_value = overrides ? overrides->GetPrefersReducedMotion() : absl::nullopt;
    return override_value.value_or(frame->GetSettings()->GetPrefersReducedMotion());
}
...
bool MediaValues::CalculatePrefersReducedData(LocalFrame* frame)
{
    ...
    DCHECK(frame->GetSettings());
    const MediaFeatureOverrides* overrides = frame->GetPage()->GetMediaFeatureOverrides();
    absl::optional<bool> override_value = overrides ? overrides->GetPrefersReducedData() : absl::nullopt;
...
ForcedColors MediaValues::CalculateForcedColors(LocalFrame* frame)
{
    ...
    DCHECK(frame->GetSettings());
    const MediaFeatureOverrides* overrides = frame->GetPage()->GetMediaFeatureOverrides();
    absl::optional<ForcedColors> override_value = overrides ? overrides->GetForcedColors() : absl::nullopt;
    return override_value.value_or(WebThemeEngineHelper::GetNativeThemeEngine()->GetForcedColors());
}
...
int MediaValues::CalculateHorizontalViewportSegments(LocalFrame* frame)
{
    ...
    WebVector<gfx::Rect> window_segments = frame->GetWidgetForLocalRoot()->WindowSegments();
...
device::mojom::blink::DevicePostureType MediaValues::CalculateDevicePosture(LocalFrame* frame)
{
