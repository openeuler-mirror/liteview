...
TEST_F(StyleImageCacheTest, ComputedValueRelativePath)
{
    ...
    EXPECT_EQ(property.CSSValueFromComputedStyle(target1->ComputedStyleRef(), nullptr, false)->CssText(), "url(\"http://test.com/url.png\")");
    EXPECT_EQ(property.CSSValueFromComputedStyle(target2->ComputedStyleRef(), nullptr, false)->CssText(), "url(\"http://test.com/url.png\")");
}
