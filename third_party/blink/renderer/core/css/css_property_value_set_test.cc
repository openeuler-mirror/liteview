...
TEST_F(CSSPropertyValueSetTest, ConflictingLonghandAndShorthand)
{
    ...
    EXPECT_EQ("offset-position: initial; offset-distance: initial; "
...
TEST_F(CSSPropertyValueSetTest, SetPropertyReturnValue)
{
    ...
    EXPECT_EQ(MutableCSSPropertyValueSet::kChangedPropertySet,
        properties.SetProperty(CSSPropertyID::kColor, "red", /*important=*/false, SecureContextMode::kInsecureContext,
    ...
    EXPECT_EQ(MutableCSSPropertyValueSet::kModifiedExisting,
        properties.SetProperty(CSSPropertyID::kColor, "green",
            ...
            /*context_style_sheet=*/nullptr));
    EXPECT_EQ(MutableCSSPropertyValueSet::kChangedPropertySet,
        properties.SetProperty(CSSPropertyID::kColor, "", /*important=*/false, SecureContextMode::kInsecureContext,
            /*context_style_sheet=*/nullptr));
}
...
TEST_F(CSSPropertyValueSetTest, SetCustomPropertyReturnValue)
{
    MutableCSSPropertyValueSet properties(kHTMLStandardMode);
    EXPECT_EQ(MutableCSSPropertyValueSet::kChangedPropertySet,
        properties.SetProperty("--my-property", "red", /*important=*/false, SecureContextMode::kInsecureContext,
            /*context_style_sheet=*/nullptr,
    ...
    EXPECT_EQ(MutableCSSPropertyValueSet::kChangedPropertySet,
        properties.SetProperty("--your-property", "white", /*important=*/false, SecureContextMode::kInsecureContext,
            /*context_style_sheet=*/nullptr,
            /*is_animation_tainted=*/false));
    EXPECT_EQ(MutableCSSPropertyValueSet::kModifiedExisting,
        properties.SetProperty("--my-property", "green",
            ...
            /*is_animation_tainted=*/false));
    EXPECT_EQ(MutableCSSPropertyValueSet::kChangedPropertySet,
        properties.SetProperty("--my-property", "", /*important=*/false, SecureContextMode::kInsecureContext,
            /*context_style_sheet=*/nullptr,
            /*is_animation_tainted=*/false));
}
