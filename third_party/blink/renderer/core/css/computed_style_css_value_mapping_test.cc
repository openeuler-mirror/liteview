...
TEST_F(ComputedStyleCSSValueMappingTest, GetVariablesOnOldStyle)
{
    ...
    auto before = ComputedStyleCSSValueMapping::GetVariables(target->ComputedStyleRef(), GetDocument().GetPropertyRegistry());
    ...
    auto after = ComputedStyleCSSValueMapping::GetVariables(target->ComputedStyleRef(), GetDocument().GetPropertyRegistry());
