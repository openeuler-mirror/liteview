...
class CORE_EXPORT StyleEnvironmentVariables : public RefCounted<StyleEnvironmentVariables> {
public:
    ...
    static scoped_refptr<StyleEnvironmentVariables> Create(StyleEnvironmentVariables& parent);
...
private:
    ...
    typedef WTF::Vector<WTF::Vector<scoped_refptr<CSSVariableData>>> TwoDimensionVariableValues;
