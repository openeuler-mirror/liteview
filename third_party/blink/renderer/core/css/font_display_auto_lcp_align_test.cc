...
public:
    void SetUp() override
    {
        ...
        scoped_feature_list_.InitAndEnableFeatureWithParameters(features::kAlignFontDisplayAutoTimeoutWithLCPGoal, parameters);
        SimTest::SetUp();
    }

    static Vector<char> ReadAhemWoff2()
    {
        return test::ReadFromFile(test::CoreTestDataPath("Ahem.woff2"))->CopyAs<Vector<char>>();
    }

    static Vector<char> ReadMaterialIconsWoff2()
    {
        return test::ReadFromFile(test::CoreTestDataPath("MaterialIcons-Regular.woff2"))->CopyAs<Vector<char>>();
    }
...
class FontDisplayAutoLCPAlignFailureModeTest : public FontDisplayAutoLCPAlignTestBase {
public:
    void SetUp() override
    {
...
TEST_F(FontDisplayAutoLCPAlignFailureModeTest, FontFinishesAfterLCPLimit)
{
    ...
    test::RunDelayedTasks(base::Milliseconds(features::kAlignFontDisplayAutoTimeoutWithLCPGoalTimeoutParam.Get()));
...
TEST_F(FontDisplayAutoLCPAlignFailureModeTest, FontFaceInMemoryCacheAddedAfterLCPLimit)
{
    SimRequest main_resource("https://example.com", "text/html");
    SimSubresourceRequest font_resource("https://example.com/Ahem.woff2", "font/woff2");
...
TEST_F(FontDisplayAutoLCPAlignFailureModeTest, TimeoutFiredAfterDocumentShutdown)
{
    SimRequest main_resource("https://example.com/", "text/html");
    SimSubresourceRequest font_resource("https://example.com/Ahem.woff2", "font/woff2");
...
{
    SimRequest main_resource("https://example.com", "text/html");
    SimSubresourceRequest icon_font_resource("https://example.com/MaterialIcons-Regular.woff2", "font/woff2");
    SimSubresourceRequest non_icon_font_resource("https://example.com/Ahem.woff2", "font/woff2");
...
class FontDisplayAutoLCPAlignSwapModeTest : public FontDisplayAutoLCPAlignTestBase {
public:
    void SetUp() override
    {
...
TEST_F(FontDisplayAutoLCPAlignSwapModeTest, FontFaceInMemoryCacheAddedAfterLCPLimit)
{
    SimRequest main_resource("https://example.com", "text/html");
    SimSubresourceRequest font_resource("https://example.com/Ahem.woff2", "font/woff2");
