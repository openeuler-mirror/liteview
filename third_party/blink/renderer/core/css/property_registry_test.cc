...
public:
    ...
    const PropertyRegistration* RegisterProperty(AtomicString name, String syntax = "*", String initial_value = g_null_atom)
    {
    ...
    const PropertyRegistration* DeclareProperty(AtomicString name, String syntax = "*", String initial_value = g_null_atom)
    {
        auto* registration = css_test_helpers::CreatePropertyRegistration(name, syntax, MaybeParseInitialValue(syntax, initial_value));
