...
public:
    ...
    CSSComputedStyleDeclaration(Node*, bool allow_visited_style = false, const String& = String());
...
private:
    ...
    void SetPropertyInternal(
        CSSPropertyID, const String& custom_property_name, const String& value, bool important, SecureContextMode, ExceptionState&) override;
