...
public:
    ...
    RuleFeatureSet::SelectorPreMatch CollectFeatures(const String& selector_text)
    {
        return CollectFeaturesTo(selector_text, rule_feature_set_);
    }

    static RuleFeatureSet::SelectorPreMatch CollectFeaturesTo(CSSSelectorVector& selector_vector, const StyleScope* style_scope, RuleFeatureSet& set)
    {
    ...
    static RuleFeatureSet::SelectorPreMatch CollectFeaturesTo(StyleRule* style_rule, const StyleScope* style_scope, RuleFeatureSet& set)
    {
        RuleFeatureSet::SelectorPreMatch result = RuleFeatureSet::SelectorPreMatch::kSelectorNeverMatches;
    ...
    static RuleFeatureSet::SelectorPreMatch CollectFeaturesTo(const String& selector_text, RuleFeatureSet& set)
    {
        Arena arena;
        CSSSelectorVector selector_vector
            = CSSParser::ParseSelector(StrictCSSParserContext(SecureContextMode::kInsecureContext), nullptr, selector_text, arena);
    ...
    void CollectInvalidationSetsForClass(InvalidationLists& invalidation_lists, const AtomicString& class_name) const
    {
        Element* element = Traversal<HTMLElement>::FirstChild(*Traversal<HTMLElement>::FirstChild(*document_->body()));
        rule_feature_set_.CollectInvalidationSetsForClass(invalidation_lists, *element, class_name);
    }

    void CollectInvalidationSetsForId(InvalidationLists& invalidation_lists, const AtomicString& id) const
    {
        Element* element = Traversal<HTMLElement>::FirstChild(*Traversal<HTMLElement>::FirstChild(*document_->body()));
        rule_feature_set_.CollectInvalidationSetsForId(invalidation_lists, *element, id);
    }

    void CollectInvalidationSetsForAttribute(InvalidationLists& invalidation_lists, const QualifiedName& attribute_name) const
    {
        Element* element = Traversal<HTMLElement>::FirstChild(*Traversal<HTMLElement>::FirstChild(*document_->body()));
        rule_feature_set_.CollectInvalidationSetsForAttribute(invalidation_lists, *element, attribute_name);
    }

    void CollectInvalidationSetsForPseudoClass(InvalidationLists& invalidation_lists, CSSSelector::PseudoType pseudo) const
    {
        Element* element = Traversal<HTMLElement>::FirstChild(*Traversal<HTMLElement>::FirstChild(*document_->body()));
        rule_feature_set_.CollectInvalidationSetsForPseudoClass(invalidation_lists, *element, pseudo);
    }
    ...
    {
        rule_feature_set_.CollectUniversalSiblingInvalidationSet(invalidation_lists, 1);
    }
    ...
    AssertionResult HasClassInvalidation(const AtomicString& class_name, InvalidationSetVector& invalidation_sets)
    {
        if (invalidation_sets.size() != 1u) {
            return AssertionFailure() << "has " << invalidation_sets.size() << " invalidation set(s), should have 1";
        }
    ...
    AssertionResult HasClassInvalidation(const AtomicString& first_class_name, const AtomicString& second_class_name, InvalidationSetVector& invalidation_sets)
    {
        if (invalidation_sets.size() != 1u) {
            return AssertionFailure() << "has " << invalidation_sets.size() << " invalidation set(s), should have 1";
        }
    ...
    AssertionResult HasSiblingClassInvalidation(
        unsigned max_direct_adjacent_selectors, const AtomicString& sibling_name, InvalidationSetVector& invalidation_sets)
    {
        if (invalidation_sets.size() != 1u) {
            return AssertionFailure() << "has " << invalidation_sets.size() << " invalidation set(s), should have 1";
        }
    ...
    AssertionResult HasSiblingIdInvalidation(unsigned max_direct_adjacent_selectors, const AtomicString& sibling_name, InvalidationSetVector& invalidation_sets)
    {
        if (invalidation_sets.size() != 1u) {
            return AssertionFailure() << "has " << invalidation_sets.size() << " invalidation set(s), should have 1";
        }
    ...
    AssertionResult HasSiblingDescendantInvalidation(
        unsigned max_direct_adjacent_selectors, const AtomicString& sibling_name, const AtomicString& descendant_name, InvalidationSetVector& invalidation_sets)
    {
        if (invalidation_sets.size() != 1u) {
            return AssertionFailure() << "has " << invalidation_sets.size() << " invalidation set(s), should have 1";
        }
    ...
    AssertionResult HasSiblingDescendantInvalidation(
        unsigned max_direct_adjacent_selectors, const AtomicString& descendant_name, InvalidationSetVector& invalidation_sets)
    {
        if (invalidation_sets.size() != 1u) {
            return AssertionFailure() << "has " << invalidation_sets.size() << " invalidation set(s), should have 1";
        }
    ...
    AssertionResult HasSiblingAndSiblingDescendantInvalidationForLogicalCombinationsInHas(const AtomicString& sibling_name,
        const AtomicString& sibling_name_for_sibling_descendant, const AtomicString& descendant_name, InvalidationSetVector& invalidation_sets)
    {
        if (invalidation_sets.size() != 1u) {
            return AssertionFailure() << "has " << invalidation_sets.size() << " invalidation set(s), should have 1";
        }
    ...
    AssertionResult HasIdInvalidation(const AtomicString& id, InvalidationSetVector& invalidation_sets)
    {
        if (invalidation_sets.size() != 1u) {
            return AssertionFailure() << "has " << invalidation_sets.size() << " invalidation set(s), should have 1";
        }
    ...
    AssertionResult HasIdInvalidation(const AtomicString& first_id, const AtomicString& second_id, InvalidationSetVector& invalidation_sets)
    {
        if (invalidation_sets.size() != 1u) {
            return AssertionFailure() << "has " << invalidation_sets.size() << " invalidation set(s), should have 1";
        }
    ...
    AssertionResult HasTagNameInvalidation(const AtomicString& tag_name, InvalidationSetVector& invalidation_sets)
    {
        if (invalidation_sets.size() != 1u) {
            return AssertionFailure() << "has " << invalidation_sets.size() << " invalidation set(s), should have 1";
        }
    ...
    AssertionResult HasTagNameInvalidation(const AtomicString& first_tag_name, const AtomicString& second_tag_name, InvalidationSetVector& invalidation_sets)
    {
        if (invalidation_sets.size() != 1u) {
            return AssertionFailure() << "has " << invalidation_sets.size() << " invalidation set(s), should have 1";
        }
    ...
    AssertionResult HasAttributeInvalidation(const AtomicString& attribute, InvalidationSetVector& invalidation_sets)
    {
        if (invalidation_sets.size() != 1u) {
            return AssertionFailure() << "has " << invalidation_sets.size() << " invalidation set(s), should have 1";
        }
    ...
    AssertionResult HasFullRecalcForRuleSetInvalidation(bool expected)
    {
        if (rule_feature_set_.NeedsFullRecalcForRuleSetInvalidation() != expected) {
            return AssertionFailure() << rule_feature_set_.NeedsFullRecalcForRuleSetInvalidation() << " should be " << expected;
        }
        return AssertionSuccess();
    }
    ...
    AssertionResult HasRefCountForClassInvalidationSet(const RuleFeatureSet& rule_feature_set, const AtomicString& class_name, RefCount ref_count)
    {
        return HasRefCountForInvalidationSet(rule_feature_set.class_invalidation_sets_, class_name, ref_count);
    }

    AssertionResult HasRefCountForAttributeInvalidationSet(const RuleFeatureSet& rule_feature_set, const AtomicString& attribute, RefCount ref_count)
    {
        return HasRefCountForInvalidationSet(rule_feature_set.attribute_invalidation_sets_, attribute, ref_count);
    }

    AssertionResult HasRefCountForIdInvalidationSet(const RuleFeatureSet& rule_feature_set, const AtomicString& id, RefCount ref_count)
    {
        return HasRefCountForInvalidationSet(rule_feature_set.id_invalidation_sets_, id, ref_count);
    }
    ...
    {
        return HasRefCountForInvalidationSet(rule_feature_set.pseudo_invalidation_sets_, key, ref_count);
    }
...
{
    EXPECT_EQ(RuleFeatureSet::kSelectorMayMatch, CollectFeatures(".m + .n .o + .p"));
...
{
    EXPECT_EQ(RuleFeatureSet::kSelectorMayMatch, CollectFeatures(".l ~ .m + .n .o + .p"));
...
{
    EXPECT_EQ(RuleFeatureSet::kSelectorMayMatch, CollectFeatures(".k > .l ~ .m + .n .o + .p"));
...
{
    EXPECT_EQ(RuleFeatureSet::kSelectorMayMatch, CollectFeatures(":-webkit-any(.q, .r) ~ .s .t"));
...
{
    EXPECT_EQ(RuleFeatureSet::kSelectorMayMatch, CollectFeatures(":-webkit-any(.w, .x)"));
...
{
    EXPECT_EQ(RuleFeatureSet::kSelectorMayMatch, CollectFeatures(":-webkit-any(.v, .w):-webkit-any(.x, .y, .z)"));
...
{
    EXPECT_EQ(RuleFeatureSet::kSelectorMayMatch, CollectFeatures(".a :-webkit-any(#b, #c)"));
...
{
    EXPECT_EQ(RuleFeatureSet::kSelectorMayMatch, CollectFeatures(".a :-webkit-any(.v, .w):-webkit-any(.x, .y, .z)"));
...
{
    EXPECT_EQ(RuleFeatureSet::kSelectorMayMatch, CollectFeatures(".a :-webkit-any(span, div)"));
...
{
    EXPECT_EQ(RuleFeatureSet::kSelectorMayMatch, CollectFeatures(".v ~ :-webkit-any(.w, .x)"));
...
{
    EXPECT_EQ(RuleFeatureSet::kSelectorMayMatch, CollectFeatures(".u .v ~ :-webkit-any(.w, .x)"));
...
TEST_F(RuleFeatureSetTest, attribute)
{
    ...
    InvalidationLists invalidation_lists;
    CollectInvalidationSetsForAttribute(invalidation_lists, QualifiedName("", "c", ""));
...
TEST_F(RuleFeatureSetTest, nonMatchingHost)
{
    ...
    EXPECT_EQ(RuleFeatureSet::kSelectorNeverMatches, CollectFeatures("*:host(.a)"));
    EXPECT_EQ(RuleFeatureSet::kSelectorNeverMatches, CollectFeatures("*:host .a"));
    EXPECT_EQ(RuleFeatureSet::kSelectorNeverMatches, CollectFeatures("div :host .a"));
    EXPECT_EQ(RuleFeatureSet::kSelectorNeverMatches, CollectFeatures(":host:hover .a"));
...
{
    EXPECT_EQ(RuleFeatureSet::kSelectorNeverMatches, CollectFeatures(".a:host-context(*)"));
    EXPECT_EQ(RuleFeatureSet::kSelectorNeverMatches, CollectFeatures("*:host-context(.a)"));
    EXPECT_EQ(RuleFeatureSet::kSelectorNeverMatches, CollectFeatures("*:host-context(*) .a"));
    EXPECT_EQ(RuleFeatureSet::kSelectorNeverMatches, CollectFeatures("div :host-context(div) .a"));
    EXPECT_EQ(RuleFeatureSet::kSelectorNeverMatches, CollectFeatures(":host-context(div):hover .a"));
...
TEST_F(RuleFeatureSetTest, emptyIsWhere)
{
    ...
    EXPECT_EQ(RuleFeatureSet::kSelectorNeverMatches, CollectFeatures(":is(:nonsense)"));
    EXPECT_EQ(RuleFeatureSet::kSelectorNeverMatches, CollectFeatures(":where(:nonsense)"));
    EXPECT_EQ(RuleFeatureSet::kSelectorNeverMatches, CollectFeatures(".a:is(:nonsense)"));
    EXPECT_EQ(RuleFeatureSet::kSelectorNeverMatches, CollectFeatures(".b:where(:nonsense)"));
}
...
{
    EXPECT_EQ(RuleFeatureSet::kSelectorMayMatch, CollectFeatures(":not(.a) + .b"));
...
{
    EXPECT_EQ(RuleFeatureSet::kSelectorMayMatch, CollectFeatures("#x:not(.a) + .b"));
...
{
    EXPECT_EQ(RuleFeatureSet::kSelectorMayMatch, CollectFeatures("#x:-webkit-any(.a) + .b"));
...
{
    EXPECT_EQ(RuleFeatureSet::kSelectorMayMatch, CollectFeatures(":nth-child(2n)"));
...
{
    EXPECT_EQ(RuleFeatureSet::kSelectorMayMatch, CollectFeatures(".a:nth-child(2n)"));
...
{
    EXPECT_EQ(RuleFeatureSet::kSelectorMayMatch, CollectFeatures(":nth-child(2n) .a"));
...
{
    EXPECT_EQ(RuleFeatureSet::kSelectorMayMatch, CollectFeatures(":nth-child(2n) + .a .b"));
...
{
    EXPECT_EQ(RuleFeatureSet::kSelectorMayMatch, CollectFeatures(":not(:nth-child(2n))"));
...
{
    EXPECT_EQ(RuleFeatureSet::kSelectorMayMatch, CollectFeatures(".a:not(:nth-child(2n))"));
...
{
    EXPECT_EQ(RuleFeatureSet::kSelectorMayMatch, CollectFeatures(".blah:not(:nth-child(2n)) .a"));
...
{
    EXPECT_EQ(RuleFeatureSet::kSelectorMayMatch, CollectFeatures(":-webkit-any(#nomatch, :nth-child(2n))"));
...
{
    EXPECT_EQ(RuleFeatureSet::kSelectorMayMatch, CollectFeatures(".a:-webkit-any(#nomatch, :nth-child(2n))"));
...
{
    EXPECT_EQ(RuleFeatureSet::kSelectorMayMatch, CollectFeatures(".blah:-webkit-any(#nomatch, :nth-child(2n)) .a"));
...
{
    EXPECT_EQ(RuleFeatureSet::kSelectorMayMatch, CollectFeatures(":hover:active:focus"));
    EXPECT_TRUE(HasFullRecalcForRuleSetInvalidation(true));
}

TEST_F(RuleFeatureSetTest, RuleSetInvalidationHostContext)
{
    EXPECT_EQ(RuleFeatureSet::kSelectorMayMatch, CollectFeatures(":host-context(.x)"));
    EXPECT_TRUE(HasFullRecalcForRuleSetInvalidation(true));
    ClearFeatures();

    EXPECT_EQ(RuleFeatureSet::kSelectorMayMatch, CollectFeatures(":host-context(.x) .y"));
    EXPECT_TRUE(HasFullRecalcForRuleSetInvalidation(false));
}
...
TEST_F(RuleFeatureSetTest, RuleSetInvalidationNot)
{
    ...
    EXPECT_EQ(RuleFeatureSet::kSelectorMayMatch, CollectFeatures(":not(.x) :hover"));
    EXPECT_TRUE(HasFullRecalcForRuleSetInvalidation(true));
    ClearFeatures();
...
{
    EXPECT_EQ(RuleFeatureSet::kSelectorMayMatch, CollectFeatures("::-webkit-slider-thumb"));
    EXPECT_TRUE(HasFullRecalcForRuleSetInvalidation(false));
    ClearFeatures();

    EXPECT_EQ(RuleFeatureSet::kSelectorMayMatch, CollectFeatures(".x::-webkit-slider-thumb"));
    EXPECT_TRUE(HasFullRecalcForRuleSetInvalidation(false));
    ClearFeatures();
...
TEST_F(RuleFeatureSetTest, RuleSetInvalidationSlotted)
{
    ...
    EXPECT_EQ(RuleFeatureSet::kSelectorMayMatch, CollectFeatures("::slotted(.y)"));
    EXPECT_TRUE(HasFullRecalcForRuleSetInvalidation(false));
    ClearFeatures();

    EXPECT_EQ(RuleFeatureSet::kSelectorMayMatch, CollectFeatures(".x::slotted(.y)"));
    EXPECT_TRUE(HasFullRecalcForRuleSetInvalidation(false));
    ClearFeatures();
...
{
    EXPECT_EQ(RuleFeatureSet::kSelectorMayMatch, CollectFeatures(":-webkit-any(*, #x)"));
    EXPECT_TRUE(HasFullRecalcForRuleSetInvalidation(true));
    ClearFeatures();

    EXPECT_EQ(RuleFeatureSet::kSelectorMayMatch, CollectFeatures(".x:-webkit-any(*, #y)"));
    EXPECT_TRUE(HasFullRecalcForRuleSetInvalidation(false));
    ClearFeatures();

    EXPECT_EQ(RuleFeatureSet::kSelectorMayMatch, CollectFeatures(":-webkit-any(:-webkit-any(.a, .b), #x)"));
    EXPECT_TRUE(HasFullRecalcForRuleSetInvalidation(false));
    ClearFeatures();

    EXPECT_EQ(RuleFeatureSet::kSelectorMayMatch, CollectFeatures(":-webkit-any(:-webkit-any(.a, *), #x)"));
    EXPECT_TRUE(HasFullRecalcForRuleSetInvalidation(true));
    ClearFeatures();

    EXPECT_EQ(RuleFeatureSet::kSelectorMayMatch, CollectFeatures(":-webkit-any(*, .a) *"));
    EXPECT_TRUE(HasFullRecalcForRuleSetInvalidation(true));
}
...
TEST_F(RuleFeatureSetTest, SelfInvalidationSet)
{
    ...
    invalidation_lists.descendants.clear();
    CollectInvalidationSetsForAttribute(invalidation_lists, QualifiedName("", "d", ""));
    EXPECT_TRUE(HasSelfInvalidation(invalidation_lists.descendants));
    EXPECT_TRUE(HasSelfInvalidationSet(invalidation_lists.descendants));
...
{
    EXPECT_EQ(RuleFeatureSet::kSelectorMayMatch, CollectFeatures(":is(.q, .r) ~ .s .t"));
    {
        InvalidationLists invalidation_lists;
        CollectInvalidationSetsForClass(invalidation_lists, "q");
        EXPECT_TRUE(HasNoInvalidation(invalidation_lists.descendants));
...
{
    EXPECT_EQ(RuleFeatureSet::kSelectorMayMatch, CollectFeatures(".a :is(#b, #c)"));
...
{
    EXPECT_EQ(RuleFeatureSet::kSelectorMayMatch, CollectFeatures(".a :is(span, div)"));
...
{
    EXPECT_EQ(RuleFeatureSet::kSelectorMayMatch, CollectFeatures(".v ~ :is(.w, .x)"));
...
{
    EXPECT_EQ(RuleFeatureSet::kSelectorMayMatch, CollectFeatures(".u .v ~ :is(.w, .x)"));
...
{
    EXPECT_EQ(RuleFeatureSet::kSelectorMayMatch, CollectFeatures(".a :is(.w+.b, .x>#c)"));
...
{
    EXPECT_EQ(RuleFeatureSet::kSelectorMayMatch, CollectFeatures(".a :is(.w+.b, .e+:is(.c, #d))"));
...
{
    EXPECT_EQ(RuleFeatureSet::kSelectorMayMatch, CollectFeatures(":where(.w, .x)"));
...
{
    EXPECT_EQ(RuleFeatureSet::kSelectorMayMatch, CollectFeatures(":where(.q, .r) ~ .s .t"));
    {
        InvalidationLists invalidation_lists;
        CollectInvalidationSetsForClass(invalidation_lists, "q");
        EXPECT_TRUE(HasNoInvalidation(invalidation_lists.descendants));
...
{
    EXPECT_EQ(RuleFeatureSet::kSelectorMayMatch, CollectFeatures(".a :where(#b, #c)"));
...
{
    EXPECT_EQ(RuleFeatureSet::kSelectorMayMatch, CollectFeatures(".a :where(span, div)"));
...
{
    EXPECT_EQ(RuleFeatureSet::kSelectorMayMatch, CollectFeatures(".v ~ :where(.w, .x)"));
...
{
    EXPECT_EQ(RuleFeatureSet::kSelectorMayMatch, CollectFeatures(".u .v ~ :where(.w, .x)"));
...
{
    EXPECT_EQ(RuleFeatureSet::kSelectorMayMatch, CollectFeatures(".a :where(.w+.b, .x>#c)"));
...
{
    EXPECT_EQ(RuleFeatureSet::kSelectorMayMatch, CollectFeatures(".a :where(.w+.b, .e+:where(.c, #d))"));
...
{
    EXPECT_EQ(RuleFeatureSet::kSelectorMayMatch, CollectFeatures(".a .b::part(partname)"));
...
{
    EXPECT_EQ(RuleFeatureSet::kSelectorMayMatch, CollectFeatures(".a .b:has(.c)"));
...
{
    EXPECT_EQ(RuleFeatureSet::kSelectorMayMatch, CollectFeatures(".a .b:has(.c) .d"));
...
RefTestData ref_not_equal_test_data[] = {
    // clang-format on
    { "", ".a" }, { "", "#a" }, { "", "div" }, { "", ":hover" }, { "", "::before" }, { "", ":host" }, { "", ":host(.a)" }, { "", ":host-context(.a)" },
    { "", "*" }, { "", ":not(.a)" }, { ".a", ".b" }, { ".a", ".a, .b" }, { "#a", "#b" }, { "ol", "ul" }, { "[foo]", "[bar]" }, { ":link", ":visited" },
    { ".a::before", ".b::after" }, { "::cue(a)", "::cue(b)" }, { ".a .b", ".a .c" }, { ".a + .b", ".a + .c" }, { ".a + .b .c", ".a + .b .d" },
    { "div + .a", "div + .b" }, { ".a:nth-child(1)", ".b:nth-child(1)" }, { "div", "span" },
    // clang-format on
};
...
RefTestData ref_scope_equal_test_data[] = {
    ...
    // Using "to" keyword:
    { "@scope (.a, .b) to (.c, .d) { div {} }", ":is(.a, .b, .c, .d) div, :is(.a, .b):is(div) {}" },
    ...
    { "@scope (.a) to (.b) { @scope (.c) to (.d) { .e {} } }", ":is(.a, .b, .c, .d) .e, :is(.a, .c):is(.e) {}" },
};

class RuleFeatureSetScopeRefTest : public RuleFeatureSetRefTest, public testing::WithParamInterface<RefTestData>, private ScopedCSSScopeForTest {
public:
    RuleFeatureSetScopeRefTest()
        : ScopedCSSScopeForTest(true)
    {
    }
...
{
    EXPECT_EQ(RuleFeatureSet::kSelectorMayMatch, CollectFeatures(".a:has(:is(.b .c))"));
...
{
    EXPECT_EQ(RuleFeatureSet::kSelectorMayMatch, CollectFeatures(".a:has(~ :is(.b .c ~ .d))"));
...
{
    EXPECT_EQ(RuleFeatureSet::kSelectorMayMatch, CollectFeatures(".a:has(:is(:is(.b, .c) .d))"));
...
{
    EXPECT_EQ(RuleFeatureSet::kSelectorMayMatch, CollectFeatures(":has(:is(.a .b))"));
...
{
    EXPECT_EQ(RuleFeatureSet::kSelectorMayMatch, CollectFeatures(".a:has(~ :is(.b ~ .c .d ~ .e))"));
...
{
    EXPECT_EQ(RuleFeatureSet::kSelectorMayMatch, CollectFeatures(".a:has(~ :is(* ~ .b))"));
    {
        InvalidationLists invalidation_lists;
        CollectUniversalSiblingInvalidationSet(invalidation_lists);
...
{
    EXPECT_EQ(RuleFeatureSet::kSelectorMayMatch, CollectFeatures(".a:has(~ :is(.b ~ :is(.c ~ .d)))"));
