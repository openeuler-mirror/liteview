...
{
    CSSIdentifierValue* preference = ConsumeIdent<CSSValueID::kFirst, CSSValueID::kLast>(range);
...
CSSValue* ConsumeSteps(CSSParserTokenRange& range, const CSSParserContext& context)
{
    ...
    range = range_copy;
    return MakeGarbageCollected<cssvalue::CSSStepsTimingFunctionValue>(steps->GetIntValue(), position);
}

CSSValue* ConsumeCubicBezier(CSSParserTokenRange& range, const CSSParserContext& context)
{
    ...
    double x1, y1, x2, y2;
    if (ConsumeNumberRaw(args, context, x1) && x1 >= 0 && x1 <= 1 && ConsumeCommaIncludingWhitespace(args) && ConsumeNumberRaw(args, context, y1)
        && ConsumeCommaIncludingWhitespace(args) && ConsumeNumberRaw(args, context, x2) && x2 >= 0 && x2 <= 1 && ConsumeCommaIncludingWhitespace(args)
        && ConsumeNumberRaw(args, context, y2) && args.AtEnd()) {
        range = range_copy;
        return MakeGarbageCollected<cssvalue::CSSCubicBezierTimingFunctionValue>(x1, y1, x2, y2);
    }

    return nullptr;
}

CSSIdentifierValue* ConsumeBorderImageRepeatKeyword(CSSParserTokenRange& range)
{
    return ConsumeIdent<CSSValueID::kStretch, CSSValueID::kRepeat, CSSValueID::kSpace, CSSValueID::kRound>(range);
}
...
CSSValue* ConsumeShapeRadius(CSSParserTokenRange& args, const CSSParserContext& context)
{
...
cssvalue::CSSBasicShapeCircleValue* ConsumeBasicShapeCircle(CSSParserTokenRange& args, const CSSParserContext& context)
{
    ...
    if (ConsumeIdent<CSSValueID::kAt>(args)) {
        ...
        if (!ConsumePosition(args, context, UnitlessQuirk::kForbid, absl::optional<WebFeature>(), center_x, center_y))
            return nullptr;
...
cssvalue::CSSBasicShapeEllipseValue* ConsumeBasicShapeEllipse(CSSParserTokenRange& args, const CSSParserContext& context)
{
    // spec: https://drafts.csswg.org/css-shapes/#supported-basic-shapes
...
cssvalue::CSSBasicShapePolygonValue* ConsumeBasicShapePolygon(CSSParserTokenRange& args, const CSSParserContext& context)
{
...
template <typename T> bool ConsumeBorderRadiusCommon(CSSParserTokenRange& args, const CSSParserContext& context, T* shape)
{
...
cssvalue::CSSBasicShapeInsetValue* ConsumeBasicShapeInset(CSSParserTokenRange& args, const CSSParserContext& context)
{
...
cssvalue::CSSBasicShapeRectValue* ConsumeBasicShapeRect(CSSParserTokenRange& args, const CSSParserContext& context)
{
    CSSValue* lengths[4];
...
cssvalue::CSSBasicShapeXYWHValue* ConsumeBasicShapeXYWH(CSSParserTokenRange& args, const CSSParserContext& context)
{
...
bool ConsumeNumbers(CSSParserTokenRange& args, const CSSParserContext& context, CSSFunctionValue*& transform_value, unsigned number_of_arguments)
{
    do {
        CSSValue* parsed_value = ConsumeNumber(args, context, CSSPrimitiveValue::ValueRange::kAll);
        if (!parsed_value)
            return false;
...
bool ConsumeNumbersOrPercents(CSSParserTokenRange& args, const CSSParserContext& context, CSSFunctionValue*& transform_value, unsigned number_of_arguments)
{
    do {
        CSSValue* parsed_value = ConsumeNumberOrPercent(args, context, CSSPrimitiveValue::ValueRange::kAll);
        if (!parsed_value)
            return false;
        transform_value->Append(*parsed_value);
        if (--number_of_arguments && !ConsumeCommaIncludingWhitespace(args))
...
bool ConsumePerspective(CSSParserTokenRange& args, const CSSParserContext& context, CSSFunctionValue*& transform_value, bool use_legacy_parsing)
{
    CSSValue* parsed_value = ConsumeLength(args, context, CSSPrimitiveValue::ValueRange::kNonNegative);
    if (!parsed_value) {
...
bool ConsumeTranslate3d(CSSParserTokenRange& args, const CSSParserContext& context, CSSFunctionValue*& transform_value)
{
    unsigned number_of_arguments = 2;
    CSSValue* parsed_value = nullptr;
    do {
        parsed_value = ConsumeLengthOrPercent(args, context, CSSPrimitiveValue::ValueRange::kAll);
        if (!parsed_value)
            return false;
        transform_value->Append(*parsed_value);
        if (!ConsumeCommaIncludingWhitespace(args))
    ...
    parsed_value = ConsumeLength(args, context, CSSPrimitiveValue::ValueRange::kAll);
    if (!parsed_value)
        return false;
    transform_value->Append(*parsed_value);
    return true;
...
bool AddCSSPaintArgument(const Vector<CSSParserToken>& tokens, Vector<scoped_refptr<CSSVariableData>>* const variable_data)
{
    ...
    if (!token_range.AtEnd()) {
        ...
        scoped_refptr<CSSVariableData> unparsed_css_variable_data = CSSVariableData::Create({ token_range, StringView() }, false, false);
...
Vector<CSSParserToken> ConsumeFunctionArgsOrNot(CSSParserTokenRange& args)
{
    ...
    if (args.Peek().GetBlockType() == CSSParserToken::kBlockStart) {
        ...
        CSSParserTokenType closing_type = CSSParserToken::ClosingTokenType(args.Peek().GetType());

        CSSParserTokenRange contents = args.ConsumeBlock();
        while (!contents.AtEnd())
            argument_tokens.push_back(contents.Consume());
        argument_tokens.push_back(CSSParserToken(closing_type, CSSParserToken::kBlockEnd));
...
CSSFunctionValue* ConsumeFilterFunction(CSSParserTokenRange& range, const CSSParserContext& context)
{
    ...
    CSSFunctionValue* filter_value = MakeGarbageCollected<CSSFunctionValue>(filter_type);
    CSSValue* parsed_value = nullptr;

    if (filter_type == CSSValueID::kDropShadow) {
        parsed_value = ParseSingleShadow(args, context, AllowInsetAndSpread::kForbid);
    } else {
        if (args.AtEnd()) {
        ...
        if (filter_type == CSSValueID::kBrightness) {
            ...
            parsed_value = ConsumePercent(args, context, CSSPrimitiveValue::ValueRange::kAll);
            if (!parsed_value) {
                parsed_value = ConsumeNumber(args, context, CSSPrimitiveValue::ValueRange::kNonNegative);
            }
        } else if (filter_type == CSSValueID::kHueRotate) {
            parsed_value = ConsumeAngle(args, context, WebFeature::kUnitlessZeroAngleFilter);
        } else if (filter_type == CSSValueID::kBlur) {
            CSSParserContext::ParserModeOverridingScope scope(context, kHTMLStandardMode);
            parsed_value = ConsumeLength(args, context, CSSPrimitiveValue::ValueRange::kNonNegative);
        } else {
            // FIXME (crbug.com/397061): Support calc expressions like calc(10% + 0.5)
            parsed_value = ConsumePercent(args, context, CSSPrimitiveValue::ValueRange::kNonNegative);
            if (!parsed_value) {
                parsed_value = ConsumeNumber(args, context, CSSPrimitiveValue::ValueRange::kNonNegative);
            }
...
CSSLightDarkValuePair* ConsumeInternalLightDark(Func consume_value, CSSParserTokenRange& range, const CSSParserContext& context, Args&&... args)
{
    ...
    CSSValue* light_value = consume_value(arg_range, context, std::forward<Args>(args)...);
    if (!light_value || !ConsumeCommaIncludingWhitespace(arg_range))
        return nullptr;
    CSSValue* dark_value = consume_value(arg_range, context, std::forward<Args>(args)...);
...
public:
    MathFunctionParser(CSSParserTokenRange& range, const CSSParserContext& context, CSSPrimitiveValue::ValueRange value_range,
        ...
        , range_(range)
    {
        ...
        if (token.GetType() == kFunctionToken) {
            calc_value_ = CSSMathFunctionValue::Create(
                CSSMathExpressionNode::ParseMathFunction(token.FunctionId(), ConsumeFunction(range_), context, allowed_anchor_queries), value_range);
        }
...
CSSPrimitiveValue* ConsumeInteger(CSSParserTokenRange& range, const CSSParserContext& context, double minimum_value)
{
    const CSSParserToken& token = range.Peek();
    if (token.GetType() == kNumberToken) {
        if (token.GetNumericValueType() == kNumberValueType || token.NumericValue() < minimum_value)
            return nullptr;
        return CSSNumericLiteralValue::Create(range.ConsumeIncludingWhitespace().NumericValue(), CSSPrimitiveValue::UnitType::kInteger);
    }
...
CSSPrimitiveValue* ConsumeIntegerOrNumberCalc(CSSParserTokenRange& range, const CSSParserContext& context, CSSPrimitiveValue::ValueRange value_range)
{
    ...
    if (CSSPrimitiveValue* value = ConsumeInteger(int_range, context, minimum_value)) {
        range = int_range;
        return value;
    }
...
CSSPrimitiveValue* ConsumePositiveInteger(CSSParserTokenRange& range, const CSSParserContext& context)
{
...
CSSPrimitiveValue* ConsumeNumber(CSSParserTokenRange& range, const CSSParserContext& context, CSSPrimitiveValue::ValueRange value_range)
{
    const CSSParserToken& token = range.Peek();
    if (token.GetType() == kNumberToken) {
...
CSSPrimitiveValue* ConsumeLength(CSSParserTokenRange& range, const CSSParserContext& context, CSSPrimitiveValue::ValueRange value_range, UnitlessQuirk unitless)
{
    const CSSParserToken& token = range.Peek();
...
CSSPrimitiveValue* ConsumePercent(CSSParserTokenRange& range, const CSSParserContext& context, CSSPrimitiveValue::ValueRange value_range)
{
    const CSSParserToken& token = range.Peek();
    if (token.GetType() == kPercentageToken) {
        if (value_range == CSSPrimitiveValue::ValueRange::kNonNegative && token.NumericValue() < 0)
            return nullptr;
        return CSSNumericLiteralValue::Create(range.ConsumeIncludingWhitespace().NumericValue(), CSSPrimitiveValue::UnitType::kPercentage);
    }
    MathFunctionParser math_parser(range, context, value_range);
    if (const CSSMathFunctionValue* calculation = math_parser.Value()) {
...
CSSPrimitiveValue* ConsumeNumberOrPercent(CSSParserTokenRange& range, const CSSParserContext& context, CSSPrimitiveValue::ValueRange value_range)
{
...
CSSPrimitiveValue* ConsumeAlphaValue(CSSParserTokenRange& range, const CSSParserContext& context)
{
    return ConsumeNumberOrPercent(range, context, CSSPrimitiveValue::ValueRange::kAll);
}

bool CanConsumeCalcValue(CalculationCategory category, CSSParserMode css_parser_mode)
{
    return category == kCalcLength || category == kCalcPercent || category == kCalcPercentLength
        || (css_parser_mode == kSVGAttributeMode && category == kCalcNumber);
}

CSSPrimitiveValue* ConsumeLengthOrPercent(CSSParserTokenRange& range, const CSSParserContext& context, CSSPrimitiveValue::ValueRange value_range,
    UnitlessQuirk unitless, CSSAnchorQueryTypes allowed_anchor_queries)
{
    const CSSParserToken& token = range.Peek();
    ...
    MathFunctionParser math_parser(range, context, value_range, allowed_anchor_queries);
    if (const CSSMathFunctionValue* calculation = math_parser.Value()) {
...
CSSPrimitiveValue* ConsumeSVGGeometryPropertyLength(CSSParserTokenRange& range, const CSSParserContext& context, CSSPrimitiveValue::ValueRange value_range)
{
    CSSParserContext::ParserModeOverridingScope scope(context, kSVGAttributeMode);
    CSSPrimitiveValue* value = ConsumeLengthOrPercent(range, context, value_range, UnitlessQuirk::kForbid);
...
CSSPrimitiveValue* ConsumeGradientLengthOrPercent(
    CSSParserTokenRange& range, const CSSParserContext& context, CSSPrimitiveValue::ValueRange value_range, UnitlessQuirk unitless)
{
    return ConsumeLengthOrPercent(range, context, value_range, unitless);
}

static CSSPrimitiveValue* ConsumeNumericLiteralAngle(
    CSSParserTokenRange& range, const CSSParserContext& context, absl::optional<WebFeature> unitless_zero_feature)
{
    const CSSParserToken& token = range.Peek();
    if (token.GetType() == kDimensionToken) {
        switch (token.GetUnitType()) {
...
static CSSPrimitiveValue* ConsumeMathFunctionAngle(CSSParserTokenRange& range, const CSSParserContext& context, double minimum_value, double maximum_value)
{
    MathFunctionParser math_parser(range, context, CSSPrimitiveValue::ValueRange::kAll);
    if (const CSSMathFunctionValue* calculation = math_parser.Value()) {
...
static CSSPrimitiveValue* ConsumeMathFunctionAngle(CSSParserTokenRange& range, const CSSParserContext& context)
{
    MathFunctionParser math_parser(range, context, CSSPrimitiveValue::ValueRange::kAll);
    if (const CSSMathFunctionValue* calculation = math_parser.Value()) {
        if (calculation->Category() != kCalcAngle)
...
CSSPrimitiveValue* ConsumeAngle(
    CSSParserTokenRange& range, const CSSParserContext& context, absl::optional<WebFeature> unitless_zero_feature, double minimum_value, double maximum_value)
{
    if (auto* result = ConsumeNumericLiteralAngle(range, context, unitless_zero_feature))
        return result;

    return ConsumeMathFunctionAngle(range, context, minimum_value, maximum_value);
}

CSSPrimitiveValue* ConsumeAngle(CSSParserTokenRange& range, const CSSParserContext& context, absl::optional<WebFeature> unitless_zero_feature)
{
    if (auto* result = ConsumeNumericLiteralAngle(range, context, unitless_zero_feature))
        return result;
...
CSSPrimitiveValue* ConsumeHue(CSSParserTokenRange& range, const CSSParserContext& context, absl::optional<WebFeature> unitless_zero_feature)
{
    ...
    return CSSNumericLiteralValue::Create(fmod(fmod(angle_value, 360.0) + 360.0, 360.0), CSSPrimitiveValue::UnitType::kNumber);
}

CSSPrimitiveValue* ConsumeTime(CSSParserTokenRange& range, const CSSParserContext& context, CSSPrimitiveValue::ValueRange value_range)
{
    const CSSParserToken& token = range.Peek();
    if (token.GetType() == kDimensionToken) {
        if (value_range == CSSPrimitiveValue::ValueRange::kNonNegative && token.NumericValue() < 0)
...
CSSPrimitiveValue* ConsumeResolution(CSSParserTokenRange& range)
{
    ...
    if (token.GetType() != kDimensionToken)
        return nullptr;
    CSSPrimitiveValue::UnitType unit = token.GetUnitType();
    if (unit == CSSPrimitiveValue::UnitType::kDotsPerPixel || unit == CSSPrimitiveValue::UnitType::kDotsPerInch
...
CSSValue* ConsumeRatio(CSSParserTokenRange& range, const CSSParserContext& context)
{
    CSSPrimitiveValue* first = ConsumeNumber(range, context, CSSPrimitiveValue::ValueRange::kNonNegative);
    if (!first)
        return nullptr;
    ...
    if (css_parsing_utils::ConsumeSlashIncludingWhitespace(range)) {
        second = ConsumeNumber(range, context, CSSPrimitiveValue::ValueRange::kNonNegative);
        if (!second)
            return nullptr;
    } else {
...
CSSCustomIdentValue* ConsumeCustomIdent(CSSParserTokenRange& range, const CSSParserContext& context)
{
    if (range.Peek().GetType() != kIdentToken || IsCSSWideKeyword(range.Peek().Id()) || range.Peek().Id() == CSSValueID::kDefault) {
        return nullptr;
    }
    return MakeGarbageCollected<CSSCustomIdentValue>(range.ConsumeIncludingWhitespace().Value().ToAtomicString());
}
...
CSSCustomIdentValue* ConsumeCustomIdentConservatively(CSSParserTokenRange& range, const CSSParserContext& context)
{
    if (range.Peek().GetType() != kIdentToken)
        return nullptr;
...
CSSCustomIdentValue* ConsumeDashedIdent(CSSParserTokenRange& range, const CSSParserContext& context)
{
    if (range.Peek().GetType() != kIdentToken)
        return nullptr;
...
CSSStringValue* ConsumeString(CSSParserTokenRange& range)
{
    if (range.Peek().GetType() != kStringToken)
        return nullptr;
    return MakeGarbageCollected<CSSStringValue>(range.ConsumeIncludingWhitespace().Value().ToString());
}

StringView ConsumeUrlAsStringView(CSSParserTokenRange& range, const CSSParserContext& context)
{
    StringView url;
    const CSSParserToken& token = range.Peek();
    ...
    // data.
    if (!url.IsNull() && context.ResourceFetchRestriction() == ResourceFetchRestriction::kOnlyDataUrls && !ProtocolIs(url.ToString(), "data")) {
...
cssvalue::CSSURIValue* ConsumeUrl(CSSParserTokenRange& range, const CSSParserContext& context)
{
    StringView url = ConsumeUrlAsStringView(range, context);
    if (url.IsNull())
        return nullptr;
    AtomicString url_string(url.ToString());
    return MakeGarbageCollected<cssvalue::CSSURIValue>(url_string, context.CompleteURL(url_string));
}
...
static bool ParseRGBParameters(CSSParserTokenRange& range, const CSSParserContext& context, Color& result)
{
    DCHECK(range.Peek().FunctionId() == CSSValueID::kRgb || range.Peek().FunctionId() == CSSValueID::kRgba);
    CSSParserTokenRange args = ConsumeFunction(range);
    ...
    if ((comma_consumed && !requires_commas) || (slash_consumed && requires_commas))
        return false;
    if (comma_consumed || slash_consumed) {
        double alpha;
        if (!ConsumeNumberRaw(args, context, alpha)) {
            CSSPrimitiveValue* alpha_percent = ConsumePercent(args, context, CSSPrimitiveValue::ValueRange::kAll);
            if (!alpha_percent) {
                if (!ConsumeIdent<CSSValueID::kNone>(args))
                    return false;
                alpha = 0.0;
        ...
        result = Color::FromRGBA(color_array[0], color_array[1], color_array[2], alpha_component);
    } else {
...
static bool ParseHSLParameters(CSSParserTokenRange& range, const CSSParserContext& context, Color& result)
{
    DCHECK(range.Peek().FunctionId() == CSSValueID::kHsl || range.Peek().FunctionId() == CSSValueID::kHsla);
    CSSParserTokenRange args = ConsumeFunction(range);
    ...
    for (int i = 1; i < 3; i++) {
        ...
        if (value) {
            ...
            color_array[i] = ClampTo<double>(double_value, 0.0, 100.0) / 100.0; // Needs to be value between 0 and 1.0.
        } else {
            if (!ConsumeIdent<CSSValueID::kNone>(args))
                return false;
            color_array[i] = 0.0;
    ...
    result = Color::FromHSLA(color_array[0], color_array[1], color_array[2], alpha);
    return args.AtEnd();
}
...
// color() function.
static absl::optional<double> ConsumeAlphaWithLeadingSlash(CSSParserTokenRange& range, const CSSParserContext& context)
{
    ...
    if (ConsumeSlashIncludingWhitespace(range)) {
        ...
        if (!alpha_is_none) {
            if (!ConsumeNumberRaw(range, context, raw_alpha)) {
                CSSPrimitiveValue* alpha_percent = ConsumePercent(range, context, CSSPrimitiveValue::ValueRange::kAll);
                if (!alpha_percent)
                    return false;
...
static bool ParseHWBParameters(CSSParserTokenRange& range, const CSSParserContext& context, Color& result)
{
    ...
    for (double& percentage : percentages) {
        ...
        if (!value)
            return false;
        double double_value = value->GetDoubleValue();
        percentage = ClampTo<double>(double_value, 0.0, 100.0) / 100.0; // Needs to be a value between 0 and 1.0.
    }

    double alpha = 0.0;
    absl::optional<double> optional_alpha = ConsumeAlphaWithLeadingSlash(args, context);
...
static bool ParseLABOrOKLABParameters(CSSParserTokenRange& range, const CSSParserContext& context, Color& result)
{
...
static bool ParseLCHOrOKLCHParameters(CSSParserTokenRange& range, const CSSParserContext& context, Color& result)
{
    CSSValueID function_id = range.Peek().FunctionId();
...
static bool ParseColorFunctionParameters(CSSParserTokenRange& range, const CSSParserContext& context, Color& result)
{
    ...
    for (absl::optional<double>& param : params) {
        ...
        CSSPrimitiveValue* value = ConsumeNumber(args, context, CSSPrimitiveValue::ValueRange::kAll);
        if (value) {
    ...
    result = Color::FromColorFunction(colorspace, params[0], params[1], params[2], alpha);
    return args.AtEnd();
}

static bool ParseHexColor(CSSParserTokenRange& range, Color& result, bool accept_quirky_colors)
{
    const CSSParserToken& token = range.Peek();
...
static bool ParseFunctionalSyntaxColor(CSSParserTokenRange& range, const CSSParserContext& context, Color& result)
{
    ...
    case CSSValueID::kOklab:
        if (!RuntimeEnabledFeatures::CSSColor4Enabled() || !ParseLABOrOKLABParameters(color_range, context, result))
            return false;
        break;
    case CSSValueID::kLch:
    case CSSValueID::kOklch:
        if (!RuntimeEnabledFeatures::CSSColor4Enabled() || !ParseLCHOrOKLCHParameters(color_range, context, result))
            return false;
        break;
    case CSSValueID::kColor:
        if (!RuntimeEnabledFeatures::CSSColor4Enabled() || !ParseColorFunctionParameters(color_range, context, result))
            return false;
        break;
    default:
        return false;
...
Color ResolveColor(CSSValue* value)
{
    ...
    if (auto* color = DynamicTo<CSSIdentifierValue>(value)) {
        ...
        return StyleColor::ColorFromKeyword(color_id, mojom::blink::ColorScheme::kLight);
    }
...
CSSValue* ConsumeColorContrast(CSSParserTokenRange& range, const CSSParserContext& context, bool accept_quirky_colors)
{
    DCHECK_EQ(range.Peek().FunctionId(), CSSValueID::kColorContrast);
    CSSParserTokenRange args = ConsumeFunction(range);

    CSSValue* background_color = ConsumeColor(args, context, accept_quirky_colors);
    if (!background_color)
        return nullptr;
    ...
    SkColor resolved_background_color = ResolveColor(background_color).ToSkColorDeprecated();
    int highest_contrast_index = -1;
    float highest_contrast_ratio = 0;
    for (unsigned i = 0; i < colors_to_compare_against.size(); i++) {
        float contrast_ratio = color_utils::GetContrastRatio(resolved_background_color, ResolveColor(colors_to_compare_against[i]).ToSkColorDeprecated());
    ...
    if (highest_contrast_index < 0) {
        ...
        // contrast.
        return color_utils::GetContrastRatio(resolved_background_color, SK_ColorWHITE) > color_utils::GetContrastRatio(resolved_background_color, SK_ColorBLACK)
            ? MakeGarbageCollected<cssvalue::CSSColor>(Color::kWhite)
            : MakeGarbageCollected<cssvalue::CSSColor>(Color::kBlack);
    }

    return MakeGarbageCollected<cssvalue::CSSColor>(ResolveColor(colors_to_compare_against[highest_contrast_index]));
}

CSSValue* ConsumeColor(CSSParserTokenRange& range, const CSSParserContext& context, bool accept_quirky_colors, AllowedColorKeywords allowed_keywords)
{
    if (RuntimeEnabledFeatures::CSSColorContrastEnabled() && range.Peek().FunctionId() == CSSValueID::kColorContrast) {
    ...
    if (StyleColor::IsColorKeyword(id)) {
        ...
        if (allowed_keywords != AllowedColorKeywords::kAllowSystemColor
            && (StyleColor::IsSystemColorIncludingDeprecated(id) || StyleColor::IsSystemColor(id))) {
            return nullptr;
        }
    ...
    if (!ParseHexColor(range, color, accept_quirky_colors) && !ParseFunctionalSyntaxColor(range, context, color)) {
        return ConsumeInternalLightDark(ConsumeColor, range, context, accept_quirky_colors, allowed_keywords);
    }
    return cssvalue::CSSColor::Create(color);
}

CSSValue* ConsumeLineWidth(CSSParserTokenRange& range, const CSSParserContext& context, UnitlessQuirk unitless)
{
    CSSValueID id = range.Peek().Id();
...
static CSSValue* ConsumePositionComponent(
    CSSParserTokenRange& range, const CSSParserContext& context, UnitlessQuirk unitless, bool& horizontal_edge, bool& vertical_edge)
{
    if (range.Peek().GetType() != kIdentToken) {
        return ConsumeLengthOrPercent(range, context, CSSPrimitiveValue::ValueRange::kAll, unitless);
    }
...
static void PositionFromThreeOrFourValues(CSSValue** values, CSSValue*& result_x, CSSValue*& result_y)
{
...
bool ConsumePosition(CSSParserTokenRange& range, const CSSParserContext& context, UnitlessQuirk unitless, absl::optional<WebFeature> three_value_position,
    CSSValue*& result_x, CSSValue*& result_y)
{
    bool horizontal_edge = false;
    bool vertical_edge = false;
    CSSValue* value1 = ConsumePositionComponent(range, context, unitless, horizontal_edge, vertical_edge);
    if (!value1)
        return false;
    ...
    CSSValue* value2 = ConsumePositionComponent(range, context, unitless, horizontal_edge, vertical_edge);
    if (!value2) {
    ...
    if (identifier_value3 && identifier_value3->GetValueID() != CSSValueID::kCenter && range.Peek().GetType() != kIdentToken) {
...
CSSValuePair* ConsumePosition(
    CSSParserTokenRange& range, const CSSParserContext& context, UnitlessQuirk unitless, absl::optional<WebFeature> three_value_position)
{
    CSSValue* result_x = nullptr;
    CSSValue* result_y = nullptr;
    if (ConsumePosition(range, context, unitless, three_value_position, result_x, result_y)) {
...
bool ConsumeOneOrTwoValuedPosition(
    CSSParserTokenRange& range, const CSSParserContext& context, UnitlessQuirk unitless, CSSValue*& result_x, CSSValue*& result_y)
{
    bool horizontal_edge = false;
    bool vertical_edge = false;
    CSSValue* value1 = ConsumePositionComponent(range, context, unitless, horizontal_edge, vertical_edge);
...
bool ConsumeBorderShorthand(
    CSSParserTokenRange& range, const CSSParserContext& context, const CSSValue*& result_width, const CSSValue*& result_style, const CSSValue*& result_color)
{
    while (!result_width || !result_style || !result_color) {
        ...
        if (!result_style) {
            result_style = ParseLonghand(CSSPropertyID::kBorderLeftStyle, CSSPropertyID::kBorder, context, range);
            if (result_style)
                continue;
        }
        if (!result_color) {
...
static CSSPrimitiveValue* ConsumeDeprecatedGradientPoint(CSSParserTokenRange& args, const CSSParserContext& context, bool horizontal)
{
    if (args.Peek().GetType() == kIdentToken) {
        if ((horizontal && ConsumeIdent<CSSValueID::kLeft>(args)) || (!horizontal && ConsumeIdent<CSSValueID::kTop>(args))) {
            return CSSNumericLiteralValue::Create(0., CSSPrimitiveValue::UnitType::kPercentage);
        }
        if ((horizontal && ConsumeIdent<CSSValueID::kRight>(args)) || (!horizontal && ConsumeIdent<CSSValueID::kBottom>(args))) {
    ...
    CSSPrimitiveValue* result = ConsumePercent(args, context, CSSPrimitiveValue::ValueRange::kAll);
    if (!result)
...
static CSSValue* ConsumeDeprecatedGradientStopColor(CSSParserTokenRange& args, const CSSParserContext& context)
{
...
static bool ConsumeDeprecatedGradientColorStop(CSSParserTokenRange& range, cssvalue::CSSGradientColorStop& stop, const CSSParserContext& context)
{
    ...
    if (id == CSSValueID::kFrom || id == CSSValueID::kTo) {
        ...
        if (CSSPrimitiveValue* percent_value = ConsumePercent(args, context, CSSPrimitiveValue::ValueRange::kAll))
...
static CSSValue* ConsumeDeprecatedGradient(CSSParserTokenRange& args, const CSSParserContext& context)
{
    ...
    const CSSPrimitiveValue* first_x = ConsumeDeprecatedGradientPoint(args, context, true);
    if (!first_x)
        return nullptr;
    const CSSPrimitiveValue* first_y = ConsumeDeprecatedGradientPoint(args, context, false);
    if (!first_y)
        return nullptr;
    if (!ConsumeCommaIncludingWhitespace(args))
        return nullptr;
    ...
    if (id == CSSValueID::kRadial) {
        first_radius = ConsumeNumber(args, context, CSSPrimitiveValue::ValueRange::kNonNegative);
        if (!first_radius || !ConsumeCommaIncludingWhitespace(args))
            return nullptr;
    }

    const CSSPrimitiveValue* second_x = ConsumeDeprecatedGradientPoint(args, context, true);
    if (!second_x)
        return nullptr;
    const CSSPrimitiveValue* second_y = ConsumeDeprecatedGradientPoint(args, context, false);
    if (!second_y)
        return nullptr;
    ...
    if (id == CSSValueID::kRadial) {
        if (!ConsumeCommaIncludingWhitespace(args))
            return nullptr;
        second_radius = ConsumeNumber(args, context, CSSPrimitiveValue::ValueRange::kNonNegative);
        if (!second_radius)
            return nullptr;
    }
...
static CSSPrimitiveValue* ConsumeGradientAngleOrPercent(
    CSSParserTokenRange& range, const CSSParserContext& context, CSSPrimitiveValue::ValueRange value_range, UnitlessQuirk)
{
    const CSSParserToken& token = range.Peek();
    if (token.GetType() == kDimensionToken || token.GetType() == kNumberToken) {
...
using PositionFunctor = CSSPrimitiveValue* (*)(CSSParserTokenRange&, const CSSParserContext&, CSSPrimitiveValue::ValueRange, UnitlessQuirk);

static bool ConsumeGradientColorStops(
    CSSParserTokenRange& range, const CSSParserContext& context, cssvalue::CSSGradientValue* gradient, PositionFunctor consume_position_func)
{
    ...
    do {
        ...
        stop.offset_ = consume_position_func(range, context, CSSPrimitiveValue::ValueRange::kAll, UnitlessQuirk::kForbid);
...
static CSSValue* ConsumeDeprecatedRadialGradient(CSSParserTokenRange& args, const CSSParserContext& context, cssvalue::CSSGradientRepeat repeating)
{
    CSSValue* center_x = nullptr;
    CSSValue* center_y = nullptr;
    ConsumeOneOrTwoValuedPosition(args, context, UnitlessQuirk::kForbid, center_x, center_y);
    if ((center_x || center_y) && !ConsumeCommaIncludingWhitespace(args))
        return nullptr;

    const CSSIdentifierValue* shape = ConsumeIdent<CSSValueID::kCircle, CSSValueID::kEllipse>(args);
    const CSSIdentifierValue* size_keyword = ConsumeIdent<CSSValueID::kClosestSide, CSSValueID::kClosestCorner, CSSValueID::kFarthestSide,
        CSSValueID::kFarthestCorner, CSSValueID::kContain, CSSValueID::kCover>(args);
    if (!shape)
    ...
    if (!shape && !size_keyword) {
        horizontal_size = ConsumeLengthOrPercent(args, context, CSSPrimitiveValue::ValueRange::kNonNegative);
        if (horizontal_size) {
            vertical_size = ConsumeLengthOrPercent(args, context, CSSPrimitiveValue::ValueRange::kNonNegative);
            if (!vertical_size)
                return nullptr;
    ...
    return ConsumeGradientColorStops(args, context, result, ConsumeGradientLengthOrPercent) ? result : nullptr;
}

static bool ConsumeColorSpace(CSSParserTokenRange& args, Color::ColorInterpolationSpace& color_space, Color::HueInterpolationMethod& hue_interpolation)
{
    ...
    if (read_color_space) {
        ...
        if (color_space == Color::ColorInterpolationSpace::kHSL || color_space == Color::ColorInterpolationSpace::kHWB
            || color_space == Color::ColorInterpolationSpace::kLCH || color_space == Color::ColorInterpolationSpace::kOKLCH) {
...
static CSSValue* ConsumeRadialGradient(CSSParserTokenRange& args, const CSSParserContext& context, cssvalue::CSSGradientRepeat repeating)
{
    ...
    bool has_color_space = ConsumeColorSpace(args, color_space, hue_interpolation_method);
    ...
    for (int i = 0; i < 3; ++i) {
        if (args.Peek().GetType() == kIdentToken) {
            ...
            CSSPrimitiveValue* center = ConsumeLengthOrPercent(args, context, CSSPrimitiveValue::ValueRange::kNonNegative);
            if (!center)
                break;
            if (horizontal_size)
                return nullptr;
            horizontal_size = center;
            center = ConsumeLengthOrPercent(args, context, CSSPrimitiveValue::ValueRange::kNonNegative);
            if (center) {
    ...
    if (args.Peek().Id() == CSSValueID::kAt) {
        ...
        ConsumePosition(args, context, UnitlessQuirk::kForbid, absl::optional<WebFeature>(), center_x, center_y);
    ...
    if (!has_color_space) {
        has_color_space = ConsumeColorSpace(args, color_space, hue_interpolation_method);
    }

    if ((shape || size_keyword || horizontal_size || center_x || center_y || has_color_space) && !ConsumeCommaIncludingWhitespace(args)) {
        return nullptr;
    }
...
static CSSValue* ConsumeLinearGradient(
    CSSParserTokenRange& args, const CSSParserContext& context, cssvalue::CSSGradientRepeat repeating, cssvalue::CSSGradientType gradient_type)
{
    // First part of grammar, the size/shape/color space clause:
    ...
    const CSSPrimitiveValue* angle = ConsumeAngle(args, context, WebFeature::kUnitlessZeroAngleGradient);
    const CSSIdentifierValue* end_x = nullptr;
    const CSSIdentifierValue* end_y = nullptr;
    if (!angle) {
        // <side-or-corner> parsing
        if (gradient_type == cssvalue::kCSSPrefixedLinearGradient || ConsumeIdent<CSSValueID::kTo>(args)) {
...
static CSSValue* ConsumeConicGradient(CSSParserTokenRange& args, const CSSParserContext& context, cssvalue::CSSGradientRepeat repeating)
{
    Color::ColorInterpolationSpace color_space;
    Color::HueInterpolationMethod hue_interpolation_method;
    bool has_color_space = ConsumeColorSpace(args, color_space, hue_interpolation_method);
    ...
    if (ConsumeIdent<CSSValueID::kFrom>(args)) {
        if (!(from_angle = ConsumeAngle(args, context, WebFeature::kUnitlessZeroAngleGradient)))
            return nullptr;
    }
    ...
    // present.
    if ((from_angle || center_x || center_y || has_color_space) && !ConsumeCommaIncludingWhitespace(args)) {
        return nullptr;
    }
    ...
    return ConsumeGradientColorStops(args, context, result, ConsumeGradientAngleOrPercent) ? result : nullptr;
}

CSSValue* ConsumeImageOrNone(CSSParserTokenRange& range, const CSSParserContext& context)
{
...
CSSValue* ConsumeAxis(CSSParserTokenRange& range, const CSSParserContext& context)
{
    ...
    CSSValue* x_dimension = ConsumeNumber(range, context, CSSPrimitiveValue::ValueRange::kAll);
    CSSValue* y_dimension = ConsumeNumber(range, context, CSSPrimitiveValue::ValueRange::kAll);
    CSSValue* z_dimension = ConsumeNumber(range, context, CSSPrimitiveValue::ValueRange::kAll);
...
CSSValue* ConsumeIntrinsicSizeLonghandOld(CSSParserTokenRange& range, const CSSParserContext& context)
{
...
CSSValue* ConsumeIntrinsicSizeLonghandNew(CSSParserTokenRange& range, const CSSParserContext& context)
{
    ...
    CSSValue* length = css_parsing_utils::ConsumeLength(range, context, CSSPrimitiveValue::ValueRange::kNonNegative);
    if (!length)
        return nullptr;
    list->Append(*length);
    return list;
...
CSSValue* ConsumeIntrinsicSizeLonghand(CSSParserTokenRange& range, const CSSParserContext& context)
{
    return ConsumeIntrinsicSizeLonghandNew(range, context);
}

static CSSValue* ConsumeCrossFade(CSSParserTokenRange& args, const CSSParserContext& context)
{
    ...
    } else if (CSSPrimitiveValue* number_value = ConsumeNumber(args, context, CSSPrimitiveValue::ValueRange::kAll)) {
    ...
    if (!percentage)
        return nullptr;
    return MakeGarbageCollected<cssvalue::CSSCrossfadeValue>(from_image_value, to_image_value, percentage);
}

static CSSValue* ConsumePaint(CSSParserTokenRange& args, const CSSParserContext& context)
{
...
static CSSValue* ConsumeGeneratedImage(CSSParserTokenRange& range, const CSSParserContext& context)
{
    CSSValueID id = range.Peek().FunctionId();
    CSSParserTokenRange range_copy = range;
    CSSParserTokenRange args = ConsumeFunction(range_copy);
    ...
    if (id == CSSValueID::kRadialGradient) {
        ...
        result = ConsumeLinearGradient(args, context, cssvalue::kRepeating, cssvalue::kCSSLinearGradient);
    } else if (id == CSSValueID::kLinearGradient) {
        result = ConsumeLinearGradient(args, context, cssvalue::kNonRepeating, cssvalue::kCSSLinearGradient);
        ...
        result = ConsumeDeprecatedRadialGradient(args, context, cssvalue::kNonRepeating);
    } else if (id == CSSValueID::kWebkitRepeatingRadialGradient) {
        context.Count(WebFeature::kDeprecatedWebKitRepeatingRadialGradient);
        result = ConsumeDeprecatedRadialGradient(args, context, cssvalue::kRepeating);
...
static CSSImageValue* CreateCSSImageValueWithReferrer(const AtomicString& raw_value, const CSSParserContext& context)
{
    return MakeGarbageCollected<CSSImageValue>(raw_value, context.CompleteURL(raw_value), context.GetReferrer(),
...
static CSSValue* ConsumeImageSet(CSSParserTokenRange& range, const CSSParserContext& context)
{
    ...
    do {
        AtomicString url_value = ConsumeUrlAsStringView(args, context).ToAtomicString();
        if (url_value.IsNull())
            return nullptr;
        ...
        if (image_scale_factor <= 0)
            return nullptr;
        image_set->Append(*CSSNumericLiteralValue::Create(image_scale_factor, CSSPrimitiveValue::UnitType::kNumber));
    } while (ConsumeCommaIncludingWhitespace(args));
    if (!args.AtEnd())
        return nullptr;
...
{
    return id == CSSValueID::kLinearGradient || id == CSSValueID::kRadialGradient || id == CSSValueID::kConicGradient
        || id == CSSValueID::kRepeatingLinearGradient || id == CSSValueID::kRepeatingRadialGradient || id == CSSValueID::kRepeatingConicGradient
        || id == CSSValueID::kWebkitLinearGradient || id == CSSValueID::kWebkitRadialGradient || id == CSSValueID::kWebkitRepeatingLinearGradient
        || id == CSSValueID::kWebkitRepeatingRadialGradient || id == CSSValueID::kWebkitGradient || id == CSSValueID::kWebkitCrossFade
        || id == CSSValueID::kPaint;
}

CSSValue* ConsumeImage(CSSParserTokenRange& range, const CSSParserContext& context, ConsumeGeneratedImagePolicy generated_image)
{
    ...
    if (range.Peek().GetType() == kFunctionToken) {
        ...
        if (generated_image == ConsumeGeneratedImagePolicy::kAllow && IsGeneratedImage(id)) {
...
{
    return ConsumeIdent<CSSValueID::kContentBox, CSSValueID::kPaddingBox, CSSValueID::kBorderBox, CSSValueID::kMarginBox>(range);
}
...
CSSValue* ConsumeTransformValue(CSSParserTokenRange& range, const CSSParserContext& context)
{
    bool use_legacy_parsing = false;
    return ConsumeTransformValue(range, context, use_legacy_parsing);
}

CSSValue* ConsumeTransformList(CSSParserTokenRange& range, const CSSParserContext& context)
{
    return ConsumeTransformList(range, context, CSSParserLocalContext());
}

CSSValue* ConsumeFilterFunctionList(CSSParserTokenRange& range, const CSSParserContext& context)
{
    if (range.Peek().Id() == CSSValueID::kNone)
        return ConsumeIdent(range);
...
void CountKeywordOnlyPropertyUsage(CSSPropertyID property, const CSSParserContext& context, CSSValueID value_id)
{
    ...
    case CSSPropertyID::kAppearance:
        if (value_id == CSSValueID::kInnerSpinButton || value_id == CSSValueID::kMediaSlider || value_id == CSSValueID::kMediaSliderthumb
            || value_id == CSSValueID::kMediaVolumeSlider || value_id == CSSValueID::kMediaVolumeSliderthumb || value_id == CSSValueID::kSliderVertical
            || value_id == CSSValueID::kSliderthumbHorizontal || value_id == CSSValueID::kSliderthumbVertical
...
const CSSValue* ParseLonghand(CSSPropertyID unresolved_property, CSSPropertyID current_shorthand, const CSSParserContext& context, CSSParserTokenRange& range)
{
    CSSPropertyID property_id = ResolveCSSPropertyID(unresolved_property);
    DCHECK(!CSSProperty::Get(property_id).IsShorthand());
    if (CSSParserFastPaths::IsKeywordPropertyID(property_id)) {
        if (CSSParserFastPaths::IsValidKeywordPropertyAndValue(property_id, range.Peek().Id(), context.Mode())) {
    ...
    const CSSValue* result = To<Longhand>(CSSProperty::Get(property_id)).ParseSingleValue(range, context, local_context);
    return result;
}

bool ConsumeShorthandVia2Longhands(const StylePropertyShorthand& shorthand, bool important, const CSSParserContext& context, CSSParserTokenRange& range,
    HeapVector<CSSPropertyValue, 64>& properties)
{
    DCHECK_EQ(shorthand.length(), 2u);
    const CSSProperty** longhands = shorthand.properties();

    const CSSValue* start = ParseLonghand(longhands[0]->PropertyID(), shorthand.id(), context, range);

    if (!start)
        return false;

    const CSSValue* end = ParseLonghand(longhands[1]->PropertyID(), shorthand.id(), context, range);
...
bool ConsumeShorthandVia4Longhands(const StylePropertyShorthand& shorthand, bool important, const CSSParserContext& context, CSSParserTokenRange& range,
    HeapVector<CSSPropertyValue, 64>& properties)
{
    DCHECK_EQ(shorthand.length(), 4u);
    const CSSProperty** longhands = shorthand.properties();
    const CSSValue* top = ParseLonghand(longhands[0]->PropertyID(), shorthand.id(), context, range);

    if (!top)
        return false;

    const CSSValue* right = ParseLonghand(longhands[1]->PropertyID(), shorthand.id(), context, range);

    const CSSValue* bottom = nullptr;
    const CSSValue* left = nullptr;
    if (right) {
        bottom = ParseLonghand(longhands[2]->PropertyID(), shorthand.id(), context, range);
        if (bottom) {
            left = ParseLonghand(longhands[3]->PropertyID(), shorthand.id(), context, range);
        }
    }
...
bool ConsumeShorthandGreedilyViaLonghands(const StylePropertyShorthand& shorthand, bool important, const CSSParserContext& context, CSSParserTokenRange& range,
    HeapVector<CSSPropertyValue, 64>& properties, bool use_initial_value_function)
{
    ...
    do {
        ...
        for (size_t i = 0; !found_longhand && i < shorthand.length(); ++i) {
            if (longhands[i])
                continue;
            longhands[i] = ParseLonghand(shorthand_properties[i]->PropertyID(), shorthand.id(), context, range);
...
void AddExpandedPropertyForValue(CSSPropertyID property, const CSSValue& value, bool important, HeapVector<CSSPropertyValue, 64>& properties)
{
    ...
    for (unsigned i = 0; i < shorthand_length; ++i) {
        AddProperty(longhands[i]->PropertyID(), property, value, important, IsImplicitProperty::kNotImplicit, properties);
    }
}
...
CSSValue* ConsumeSelfPositionOverflowPosition(CSSParserTokenRange& range, IsPositionKeyword is_position_keyword)
{
    ...
    CSSValue* baseline = RuntimeEnabledFeatures::CSSLastBaselineEnabled() ? ConsumeBaseline(range) : ConsumeFirstBaseline(range);
    if (baseline)
        return baseline;
...
CSSValue* ConsumeContentDistributionOverflowPosition(CSSParserTokenRange& range, IsPositionKeyword is_position_keyword)
{
    DCHECK(is_position_keyword);
    CSSValueID id = range.Peek().Id();
    if (IdentMatches<CSSValueID::kNormal>(id)) {
        return MakeGarbageCollected<cssvalue::CSSContentDistributionValue>(CSSValueID::kInvalid, range.ConsumeIncludingWhitespace().Id(), CSSValueID::kInvalid);
    }
    ...
    if (IsContentDistributionKeyword(id)) {
        return MakeGarbageCollected<cssvalue::CSSContentDistributionValue>(range.ConsumeIncludingWhitespace().Id(), CSSValueID::kInvalid, CSSValueID::kInvalid);
    }

    CSSValueID overflow = IsOverflowKeyword(id) ? range.ConsumeIncludingWhitespace().Id() : CSSValueID::kInvalid;
    if (is_position_keyword(range.Peek().Id())) {
        return MakeGarbageCollected<cssvalue::CSSContentDistributionValue>(CSSValueID::kInvalid, range.ConsumeIncludingWhitespace().Id(), overflow);
    }

    return nullptr;
}

CSSValue* ConsumeAnimationIterationCount(CSSParserTokenRange& range, const CSSParserContext& context)
{
    if (range.Peek().Id() == CSSValueID::kInfinite)
        return ConsumeIdent(range);
    return ConsumeNumber(range, context, CSSPrimitiveValue::ValueRange::kNonNegative);
}

CSSValue* ConsumeAnimationName(CSSParserTokenRange& range, const CSSParserContext& context, bool allow_quoted_name)
{
    if (range.Peek().Id() == CSSValueID::kNone)
        return ConsumeIdent(range);
...
CSSValue* ConsumeScrollFunction(CSSParserTokenRange& range, const CSSParserContext& context)
{
    if (range.Peek().FunctionId() != CSSValueID::kScroll)
        return nullptr;
    CSSParserTokenRange block = range.ConsumeBlock();
    CSSIdentifierValue* axis = ConsumeIdent<CSSValueID::kBlock, CSSValueID::kInline, CSSValueID::kVertical, CSSValueID::kHorizontal>(block);
    CSSValue* scroller = ConsumeIdent<CSSValueID::kNearest, CSSValueID::kRoot>(block);
    if (!block.AtEnd())
        return nullptr;
...
CSSValue* ConsumeAnimationTimeline(CSSParserTokenRange& range, const CSSParserContext& context)
{
...
CSSValue* ConsumeAnimationTimingFunction(CSSParserTokenRange& range, const CSSParserContext& context)
{
    CSSValueID id = range.Peek().Id();
...
bool ConsumeAnimationShorthand(const StylePropertyShorthand& shorthand, HeapVector<Member<CSSValueList>, kMaxNumAnimationLonghands>& longhands,
    ConsumeAnimationItemValue consumeLonghandItem, CSSParserTokenRange& range, const CSSParserContext& context, bool use_legacy_parsing)
{
    ...
    do {
        ...
        do {
            ...
            for (unsigned i = 0; i < longhand_count; ++i) {
                ...
                CSSValue* value = consumeLonghandItem(shorthand.properties()[i]->PropertyID(), range, context, use_legacy_parsing);
                if (value) {
        ...
        for (unsigned i = 0; i < longhand_count; ++i) {
            if (!parsed_longhand[i]) {
                longhands[i]->Append(*To<Longhand>(shorthand.properties()[i])->InitialValue());
            }
...
{
    return ConsumeIdent<CSSValueID::kBlock, CSSValueID::kInline, CSSValueID::kVertical, CSSValueID::kHorizontal>(range);
}

CSSValue* ConsumeSingleTimelineName(CSSParserTokenRange& range, const CSSParserContext& context)
{
...
CSSValue* ConsumeSingleTimelineInsetSide(CSSParserTokenRange& range, const CSSParserContext& context)
{
...
CSSValue* ConsumeSingleTimelineInset(CSSParserTokenRange& range, const CSSParserContext& context)
{
...
{
    return ConsumeIdent<CSSValueID::kScroll, CSSValueID::kFixed, CSSValueID::kLocal>(range);
}
...
{
    return ConsumeIdent<CSSValueID::kBorderBox, CSSValueID::kPaddingBox, CSSValueID::kContentBox>(range);
}
...
CSSPrimitiveValue* ConsumeLengthOrPercentCountNegative(CSSParserTokenRange& range, const CSSParserContext& context, absl::optional<WebFeature> negative_size)
{
    CSSPrimitiveValue* result = ConsumeLengthOrPercent(range, context, CSSPrimitiveValue::ValueRange::kNonNegative, UnitlessQuirk::kForbid);
...
CSSValue* ConsumeBackgroundSize(
    CSSParserTokenRange& range, const CSSParserContext& context, absl::optional<WebFeature> negative_size, ParsingStyle parsing_style)
{
    ...
    if (!horizontal) {
        horizontal = ConsumeLengthOrPercentCountNegative(range, context, negative_size);
    }
    if (!horizontal)
        return nullptr;
    ...
    if (!range.AtEnd()) {
        if (range.Peek().Id() == CSSValueID::kAuto) { // `auto' is the default
            ...
            vertical = ConsumeLengthOrPercentCountNegative(range, context, negative_size);
        }
...
bool ConsumeBackgroundPosition(CSSParserTokenRange& range, const CSSParserContext& context, UnitlessQuirk unitless, CSSValue*& result_x, CSSValue*& result_y)
{
    do {
        CSSValue* position_x = nullptr;
        CSSValue* position_y = nullptr;
        if (!ConsumePosition(range, context, unitless, WebFeature::kThreeValuedPositionBackground, position_x, position_y))
            return false;
...
CSSValue* ConsumePrefixedBackgroundBox(CSSParserTokenRange& range, AllowTextValue allow_text_value)
{
    ...
    if (CSSValue* value = ConsumeIdentRange(range, CSSValueID::kBorder, CSSValueID::kPaddingBox))
        return value;
    if (allow_text_value == AllowTextValue::kAllow && range.Peek().Id() == CSSValueID::kText)
        return ConsumeIdent(range);
    return nullptr;
}

CSSValue* ParseBackgroundBox(CSSParserTokenRange& range, const CSSParserLocalContext& local_context, AllowTextValue alias_allow_text_value)
{
    // This is legacy behavior that does not match spec, see crbug.com/604023
    if (local_context.UseAliasParsing()) {
        return ConsumeCommaSeparatedList(ConsumePrefixedBackgroundBox, range, alias_allow_text_value);
    }
    return ConsumeCommaSeparatedList(ConsumeBackgroundBox, range);
}

CSSValue* ParseBackgroundOrMaskSize(
    CSSParserTokenRange& range, const CSSParserContext& context, const CSSParserLocalContext& local_context, absl::optional<WebFeature> negative_size)
{
    return ConsumeCommaSeparatedList(
        ConsumeBackgroundSize, range, context, negative_size, local_context.UseAliasParsing() ? ParsingStyle::kLegacy : ParsingStyle::kNotLegacy);
}

namespace {

CSSValue* ConsumeBackgroundComponent(CSSPropertyID resolved_property, CSSParserTokenRange& range, const CSSParserContext& context)
{
    ...
    case CSSPropertyID::kWebkitMaskPositionX:
        return ConsumePositionLonghand<CSSValueID::kLeft, CSSValueID::kRight>(range, context);
    case CSSPropertyID::kBackgroundPositionY:
    case CSSPropertyID::kWebkitMaskPositionY:
        return ConsumePositionLonghand<CSSValueID::kTop, CSSValueID::kBottom>(range, context);
    case CSSPropertyID::kBackgroundSize:
        return ConsumeBackgroundSize(range, context, WebFeature::kNegativeBackgroundSize, ParsingStyle::kNotLegacy);
    case CSSPropertyID::kWebkitMaskSize:
        return ConsumeBackgroundSize(range, context, WebFeature::kNegativeMaskSize, ParsingStyle::kNotLegacy);
...
bool ParseBackgroundOrMask(bool important, CSSParserTokenRange& range, const CSSParserContext& context, const CSSParserLocalContext& local_context,
    HeapVector<CSSPropertyValue, 64>& properties)
{
    CSSPropertyID shorthand_id = local_context.CurrentShorthand();
    DCHECK(shorthand_id == CSSPropertyID::kBackground || shorthand_id == CSSPropertyID::kWebkitMask);
    const StylePropertyShorthand& shorthand = shorthand_id == CSSPropertyID::kBackground ? backgroundShorthand() : webkitMaskShorthand();
    ...
    do {
        ...
        do {
            ...
            for (unsigned i = 0; i < longhand_count; ++i) {
                ...
                if (property.IDEquals(CSSPropertyID::kBackgroundRepeatX) || property.IDEquals(CSSPropertyID::kWebkitMaskRepeatX)) {
                    ConsumeRepeatStyleComponent(range, value, value_y, implicit);
                } else if (property.IDEquals(CSSPropertyID::kBackgroundPositionX) || property.IDEquals(CSSPropertyID::kWebkitMaskPositionX)) {
                    if (!ConsumePosition(range, context, UnitlessQuirk::kForbid, WebFeature::kThreeValuedPositionBackground, value, value_y))
                        continue;
                    if (value)
                        bg_position_parsed_in_current_layer = true;
                } else if (property.IDEquals(CSSPropertyID::kBackgroundSize) || property.IDEquals(CSSPropertyID::kWebkitMaskSize)) {
                    if (!ConsumeSlashIncludingWhitespace(range))
                        continue;
                    value = ConsumeBackgroundSize(range, context,
                    ...
                    if (!value || !bg_position_parsed_in_current_layer)
                        return false;
                } else if (property.IDEquals(CSSPropertyID::kBackgroundPositionY) || property.IDEquals(CSSPropertyID::kBackgroundRepeatY)
                    || property.IDEquals(CSSPropertyID::kWebkitMaskPositionY) || property.IDEquals(CSSPropertyID::kWebkitMaskRepeatY)) {
                    continue;
                } else {
                    value = ConsumeBackgroundComponent(property.PropertyID(), range, context);
                }
                if (value) {
                    if (property.IDEquals(CSSPropertyID::kBackgroundOrigin) || property.IDEquals(CSSPropertyID::kWebkitMaskOrigin)) {
                        origin_value = value;
                    }
                    parsed_longhand[i] = true;
                    found_property = true;
        ...
        for (unsigned i = 0; i < longhand_count; ++i) {
            const CSSProperty& property = *shorthand.properties()[i];
            if (property.IDEquals(CSSPropertyID::kBackgroundColor) && !range.AtEnd()) {
                if (parsed_longhand[i])
                    return false; // Colors are only allowed in the last layer.
                continue;
            }
            if ((property.IDEquals(CSSPropertyID::kBackgroundClip) || property.IDEquals(CSSPropertyID::kWebkitMaskClip)) && !parsed_longhand[i]
                && origin_value) {
    ...
    for (unsigned i = 0; i < longhand_count; ++i) {
        const CSSProperty& property = *shorthand.properties()[i];
        if (property.IDEquals(CSSPropertyID::kBackgroundSize) && longhands[i] && context.UseLegacyBackgroundSizeShorthandBehavior())
            continue;
...
bool ConsumeRepeatStyleComponent(CSSParserTokenRange& range, CSSValue*& value1, CSSValue*& value2, bool& implicit)
{
    ...
    value1 = ConsumeIdent<CSSValueID::kRepeat, CSSValueID::kNoRepeat, CSSValueID::kRound, CSSValueID::kSpace>(range);
    if (!value1)
        return false;

    value2 = ConsumeIdent<CSSValueID::kRepeat, CSSValueID::kNoRepeat, CSSValueID::kRound, CSSValueID::kSpace>(range);
    if (!value2) {
        value2 = value1;
        implicit = true;
    }
...
bool ConsumeRepeatStyle(CSSParserTokenRange& range, CSSValue*& result_x, CSSValue*& result_y, bool& implicit)
{
    do {
...
CSSValue* ConsumeWebkitBorderImage(CSSParserTokenRange& range, const CSSParserContext& context)
{
    ...
    if (ConsumeBorderImageComponents(range, context, source, slice, width, outset, repeat, DefaultFill::kFill))
        return CreateBorderImageValue(source, slice, width, outset, repeat);
    return nullptr;
}

bool ConsumeBorderImageComponents(CSSParserTokenRange& range, const CSSParserContext& context, CSSValue*& source, CSSValue*& slice, CSSValue*& width,
...
CSSValue* ConsumeBorderImageSlice(CSSParserTokenRange& range, const CSSParserContext& context, DefaultFill default_fill)
{
    bool fill = ConsumeIdent<CSSValueID::kFill>(range);
    CSSValue* slices[4] = { nullptr };

    for (size_t index = 0; index < 4; ++index) {
        CSSPrimitiveValue* value = ConsumePercent(range, context, CSSPrimitiveValue::ValueRange::kNonNegative);
        if (!value) {
            value = ConsumeNumber(range, context, CSSPrimitiveValue::ValueRange::kNonNegative);
        }
        if (!value)
            break;
        slices[index] = value;
...
CSSValue* ConsumeBorderImageWidth(CSSParserTokenRange& range, const CSSParserContext& context)
{
    ...
    for (size_t index = 0; index < 4; ++index) {
        ...
        if (!value) {
            CSSParserContext::ParserModeOverridingScope scope(context, kHTMLStandardMode);
            value = ConsumeLengthOrPercent(range, context, CSSPrimitiveValue::ValueRange::kNonNegative, UnitlessQuirk::kForbid);
        }
        if (!value) {
...
CSSValue* ConsumeBorderImageOutset(CSSParserTokenRange& range, const CSSParserContext& context)
{
    ...
    for (size_t index = 0; index < 4; ++index) {
        ...
        if (!value) {
            CSSParserContext::ParserModeOverridingScope scope(context, kHTMLStandardMode);
            value = ConsumeLength(range, context, CSSPrimitiveValue::ValueRange::kNonNegative);
        }
        if (!value)
            break;
        outsets[index] = value;
...
CSSValue* ParseBorderRadiusCorner(CSSParserTokenRange& range, const CSSParserContext& context)
{
    CSSValue* parsed_value1 = ConsumeLengthOrPercent(range, context, CSSPrimitiveValue::ValueRange::kNonNegative);
    if (!parsed_value1)
        return nullptr;
    CSSValue* parsed_value2 = ConsumeLengthOrPercent(range, context, CSSPrimitiveValue::ValueRange::kNonNegative);
    if (!parsed_value2)
...
CSSValue* ParseBorderWidthSide(CSSParserTokenRange& range, const CSSParserContext& context, const CSSParserLocalContext& local_context)
{
...
CSSValue* ConsumeShadow(CSSParserTokenRange& range, const CSSParserContext& context, AllowInsetAndSpread inset_and_spread)
{
    if (range.Peek().Id() == CSSValueID::kNone)
        return ConsumeIdent(range);
    return ConsumeCommaSeparatedList(ParseSingleShadow, range, context, inset_and_spread);
}

CSSShadowValue* ParseSingleShadow(CSSParserTokenRange& range, const CSSParserContext& context, AllowInsetAndSpread inset_and_spread)
{
    ...
    CSSPrimitiveValue* horizontal_offset = ConsumeLength(range, context, CSSPrimitiveValue::ValueRange::kAll);
    if (!horizontal_offset)
        return nullptr;

    CSSPrimitiveValue* vertical_offset = ConsumeLength(range, context, CSSPrimitiveValue::ValueRange::kAll);
    if (!vertical_offset)
        return nullptr;

    CSSPrimitiveValue* blur_radius = ConsumeLength(range, context, CSSPrimitiveValue::ValueRange::kNonNegative);
...
CSSValue* ConsumeColumnCount(CSSParserTokenRange& range, const CSSParserContext& context)
{
...
CSSValue* ConsumeColumnWidth(CSSParserTokenRange& range, const CSSParserContext& context)
{
    if (range.Peek().Id() == CSSValueID::kAuto)
        return ConsumeIdent(range);
    ...
    CSSParserContext::ParserModeOverridingScope scope(context, kHTMLStandardMode);
    CSSPrimitiveValue* column_width = ConsumeLength(range, context, CSSPrimitiveValue::ValueRange::kNonNegative);
    if (!column_width)
        return nullptr;
    return column_width;
}

bool ConsumeColumnWidthOrCount(CSSParserTokenRange& range, const CSSParserContext& context, CSSValue*& column_width, CSSValue*& column_count)
{
    if (range.Peek().Id() == CSSValueID::kAuto) {
        ConsumeIdent(range);
        return true;
...
CSSValue* ConsumeGapLength(CSSParserTokenRange& range, const CSSParserContext& context)
{
    if (range.Peek().Id() == CSSValueID::kNormal)
        return ConsumeIdent(range);
    return ConsumeLengthOrPercent(range, context, CSSPrimitiveValue::ValueRange::kNonNegative);
}

CSSValue* ConsumeCounter(CSSParserTokenRange& range, const CSSParserContext& context, int default_value)
{
    if (range.Peek().Id() == CSSValueID::kNone)
        return ConsumeIdent(range);
    ...
    do {
        ...
        list->Append(*MakeGarbageCollected<CSSValuePair>(
            counter_name, CSSNumericLiteralValue::Create(value, CSSPrimitiveValue::UnitType::kInteger), CSSValuePair::kDropIdenticalValues));
    } while (!range.AtEnd());
    return list;
}

CSSValue* ConsumeMathDepth(CSSParserTokenRange& range, const CSSParserContext& context)
{
...
CSSValue* ConsumeFontSize(CSSParserTokenRange& range, const CSSParserContext& context, UnitlessQuirk unitless)
{
    if (range.Peek().Id() == CSSValueID::kWebkitXxxLarge)
        context.Count(WebFeature::kFontSizeWebkitXxxLarge);
    if ((range.Peek().Id() >= CSSValueID::kXxSmall && range.Peek().Id() <= CSSValueID::kWebkitXxxLarge)
        || (RuntimeEnabledFeatures::CSSMathDepthEnabled() && range.Peek().Id() == CSSValueID::kMath))
        return ConsumeIdent(range);
    return ConsumeLengthOrPercent(range, context, CSSPrimitiveValue::ValueRange::kNonNegative, unitless);
}

CSSValue* ConsumeLineHeight(CSSParserTokenRange& range, const CSSParserContext& context)
{
    if (range.Peek().Id() == CSSValueID::kNormal)
        return ConsumeIdent(range);

    CSSPrimitiveValue* line_height = ConsumeNumber(range, context, CSSPrimitiveValue::ValueRange::kNonNegative);
    if (line_height)
        return line_height;
    return ConsumeLengthOrPercent(range, context, CSSPrimitiveValue::ValueRange::kNonNegative);
}
...
{
    if (RuntimeEnabledFeatures::CSSFontFamilyMathEnabled() && range.Peek().Id() == CSSValueID::kMath) {
        return ConsumeIdent(range);
    }
...
{
    if (range.Peek().GetType() == kStringToken) {
        return CSSFontFamilyValue::Create(range.ConsumeIncludingWhitespace().Value().ToAtomicString());
    }
    if (range.Peek().GetType() != kIdentToken)
        return nullptr;
...
CSSValue* ConsumeFontStyle(CSSParserTokenRange& range, const CSSParserContext& context)
{
    if (range.Peek().Id() == CSSValueID::kNormal || range.Peek().Id() == CSSValueID::kItalic)
        return ConsumeIdent(range);

    if (RuntimeEnabledFeatures::CSSFontFaceAutoVariableRangeEnabled() && range.Peek().Id() == CSSValueID::kAuto && context.Mode() == kCSSFontFaceRuleMode)
        return ConsumeIdent(range);

    if (range.Peek().Id() != CSSValueID::kOblique)
        return nullptr;

    CSSIdentifierValue* oblique_identifier = ConsumeIdent<CSSValueID::kOblique>(range);

    CSSPrimitiveValue* start_angle = ConsumeAngle(range, context, absl::nullopt, MinObliqueValue(), MaxObliqueValue());
    if (!start_angle)
    ...
    CSSPrimitiveValue* end_angle = ConsumeAngle(range, context, absl::nullopt, MinObliqueValue(), MaxObliqueValue());
...
CSSIdentifierValue* ConsumeFontStretchKeywordOnly(CSSParserTokenRange& range, const CSSParserContext& context)
{
    const CSSParserToken& token = range.Peek();
    if (token.Id() == CSSValueID::kNormal || (token.Id() >= CSSValueID::kUltraCondensed && token.Id() <= CSSValueID::kUltraExpanded))
        return ConsumeIdent(range);
    if (RuntimeEnabledFeatures::CSSFontFaceAutoVariableRangeEnabled() && token.Id() == CSSValueID::kAuto && context.Mode() == kCSSFontFaceRuleMode)
        return ConsumeIdent(range);
    return nullptr;
}

CSSValue* ConsumeFontStretch(CSSParserTokenRange& range, const CSSParserContext& context)
{
    CSSIdentifierValue* parsed_keyword = ConsumeFontStretchKeywordOnly(range, context);
    if (parsed_keyword)
        return parsed_keyword;

    CSSPrimitiveValue* start_percent = ConsumePercent(range, context, CSSPrimitiveValue::ValueRange::kNonNegative);
    if (!start_percent)
        return nullptr;
    ...
    CSSPrimitiveValue* end_percent = ConsumePercent(range, context, CSSPrimitiveValue::ValueRange::kNonNegative);
    if (!end_percent)
        return nullptr;
...
CSSValue* ConsumeFontWeight(CSSParserTokenRange& range, const CSSParserContext& context)
{
    const CSSParserToken& token = range.Peek();
    if (context.Mode() != kCSSFontFaceRuleMode) {
        ...
        if ((token.Id() == CSSValueID::kNormal || token.Id() == CSSValueID::kBold)
            || (RuntimeEnabledFeatures::CSSFontFaceAutoVariableRangeEnabled() && token.Id() == CSSValueID::kAuto))
            return ConsumeIdent(range);
    }
    ...
    CSSPrimitiveValue* start_weight = ConsumeNumber(range, context, CSSPrimitiveValue::ValueRange::kNonNegative);
    ...
    CSSPrimitiveValue* end_weight = ConsumeNumber(range, context, CSSPrimitiveValue::ValueRange::kNonNegative);
...
CSSValue* ConsumeFontFeatureSettings(CSSParserTokenRange& range, const CSSParserContext& context)
{
    if (range.Peek().Id() == CSSValueID::kNormal)
        return ConsumeIdent(range);
    CSSValueList* settings = CSSValueList::CreateCommaSeparated();
    do {
        CSSFontFeatureValue* font_feature_value = ConsumeFontFeatureTag(range, context);
...
CSSFontFeatureValue* ConsumeFontFeatureTag(CSSParserTokenRange& range, const CSSParserContext& context)
{
    ...
    } else if (range.Peek().Id() == CSSValueID::kOn || range.Peek().Id() == CSSValueID::kOff) {
...
CSSIdentifierValue* ConsumeFontFormatIdent(CSSParserTokenRange& range)
{
    return ConsumeIdent<CSSValueID::kCollection, CSSValueID::kEmbeddedOpentype, CSSValueID::kOpentype, CSSValueID::kTruetype, CSSValueID::kSVG,
        CSSValueID::kWoff, CSSValueID::kWoff2>(range);
}
...
CSSValueID FontFormatToId(String font_format)
{
    ...
    if (converted_id == CSSValueID::kCollection || converted_id == CSSValueID::kEmbeddedOpentype || converted_id == CSSValueID::kOpentype
        || converted_id == CSSValueID::kTruetype || converted_id == CSSValueID::kSVG || converted_id == CSSValueID::kWoff || converted_id == CSSValueID::kWoff2)
        return converted_id;
...
CSSValue* ConsumeGridBreadth(CSSParserTokenRange& range, const CSSParserContext& context)
{
    const CSSParserToken& token = range.Peek();
    if (IdentMatches<CSSValueID::kAuto, CSSValueID::kMinContent, CSSValueID::kMaxContent>(token.Id())) {
        return ConsumeIdent(range);
    }
    if (token.GetType() == kDimensionToken && token.GetUnitType() == CSSPrimitiveValue::UnitType::kFraction) {
        if (token.NumericValue() < 0)
            return nullptr;
        return CSSNumericLiteralValue::Create(range.ConsumeIncludingWhitespace().NumericValue(), CSSPrimitiveValue::UnitType::kFraction);
    }
    return ConsumeLengthOrPercent(range, context, CSSPrimitiveValue::ValueRange::kNonNegative, UnitlessQuirk::kForbid);
}

CSSValue* ConsumeFitContent(CSSParserTokenRange& range, const CSSParserContext& context)
{
    CSSParserTokenRange range_copy = range;
    CSSParserTokenRange args = ConsumeFunction(range_copy);
    CSSPrimitiveValue* length = ConsumeLengthOrPercent(args, context, CSSPrimitiveValue::ValueRange::kNonNegative, UnitlessQuirk::kAllow);
    if (!length || !args.AtEnd())
        return nullptr;
    range = range_copy;
    auto* result = MakeGarbageCollected<CSSFunctionValue>(CSSValueID::kFitContent);
...
CSSValue* ConsumeGridTrackSize(CSSParserTokenRange& range, const CSSParserContext& context)
{
    ...
    return (token_id == CSSValueID::kFitContent) ? ConsumeFitContent(range, context) : ConsumeGridBreadth(range, context);
}

CSSCustomIdentValue* ConsumeCustomIdentForGridLine(CSSParserTokenRange& range, const CSSParserContext& context)
{
    if (range.Peek().Id() == CSSValueID::kAuto || range.Peek().Id() == CSSValueID::kSpan) {
        return nullptr;
    }
    return ConsumeCustomIdent(range, context);
}
...
CSSBracketedValueList* ConsumeGridLineNames(
    CSSParserTokenRange& range, const CSSParserContext& context, bool is_subgrid_track_list, CSSBracketedValueList* line_names = nullptr)
{
    CSSParserTokenRange range_copy = range;
    ...
    while (CSSCustomIdentValue* line_name = ConsumeCustomIdentForGridLine(range_copy, context)) {
...
bool AppendLineNames(CSSParserTokenRange& range, const CSSParserContext& context, bool is_subgrid_track_list, CSSValueList* values)
{
    if (CSSBracketedValueList* line_names = ConsumeGridLineNames(range, context, is_subgrid_track_list)) {
...
bool ConsumeGridTrackRepeatFunction(CSSParserTokenRange& range, const CSSParserContext& context, bool is_subgrid_track_list, CSSValueList& list,
    bool& is_auto_repeat, bool& all_tracks_are_fixed_sized)
{
    CSSParserTokenRange args = ConsumeFunction(range);
    is_auto_repeat = IdentMatches<CSSValueID::kAutoFill, CSSValueID::kAutoFit>(args.Peek().Id());
    ...
    if (is_auto_repeat) {
        repeated_values = MakeGarbageCollected<cssvalue::CSSGridAutoRepeatValue>(args.ConsumeIncludingWhitespace().Id());
    } else {
    ...
    wtf_size_t number_of_line_name_sets = AppendLineNames(args, context, is_subgrid_track_list, repeated_values);
    wtf_size_t number_of_tracks = 0;
    while (!args.AtEnd()) {
        if (is_subgrid_track_list) {
            if (!number_of_line_name_sets || !AppendLineNames(args, context, is_subgrid_track_list, repeated_values)) {
                return false;
            }
...
bool ConsumeGridTemplateRowsAndAreasAndColumns(bool important, CSSParserTokenRange& range, const CSSParserContext& context, const CSSValue*& template_rows,
    const CSSValue*& template_columns, const CSSValue*& template_areas)
{
    ...
    do {
        ...
        line_names = ConsumeGridLineNames(range, context, /* is_subgrid_track_list */ false, line_names);
        if (line_names && !has_previous_line_names)
            template_rows_value_list->Append(*line_names);

        // Handle a template-area's row.
        if (range.Peek().GetType() != kStringToken
            || !ParseGridTemplateAreasRow(range.ConsumeIncludingWhitespace().Value().ToString(), grid_area_map, row_count, column_count)) {
            return false;
        }
        ++row_count;
        ...
        line_names = ConsumeGridLineNames(range, context, /* is_subgrid_track_list */ false);
        if (line_names)
            template_rows_value_list->Append(*line_names);
    } while (!range.AtEnd() && !(range.Peek().GetType() == kDelimiterToken && range.Peek().Delimiter() == '/'));

    if (!range.AtEnd()) {
        if (!ConsumeSlashIncludingWhitespace(range))
            return false;
        template_columns = ConsumeGridTrackList(range, context, TrackListType::kGridTemplateNoRepeat);
...
CSSValue* ConsumeGridLine(CSSParserTokenRange& range, const CSSParserContext& context)
{
    if (range.Peek().Id() == CSSValueID::kAuto)
        return ConsumeIdent(range);
...
CSSValue* ConsumeGridTrackList(CSSParserTokenRange& range, const CSSParserContext& context, TrackListType track_list_type)
{
    ...
    bool is_subgrid_track_list = RuntimeEnabledFeatures::LayoutNGSubgridEnabled() && track_list_type == TrackListType::kGridTemplateSubgrid;
    ...
    auto IsRangeAtEnd = [](CSSParserTokenRange& range) -> bool { return range.AtEnd() || range.Peek().GetType() == kDelimiterToken; };
    ...
    do {
        ...
        if (range.Peek().FunctionId() == CSSValueID::kRepeat) {
            if (!allow_repeat)
                return nullptr;
            if (!ConsumeGridTrackRepeatFunction(range, context, is_subgrid_track_list, *values, is_auto_repeat, all_tracks_are_fixed_sized)) {
                return nullptr;
            }
        ...
        bool did_append_line_names = AppendLineNames(range, context, is_subgrid_track_list, values);
        if (is_subgrid_track_list && !did_append_line_names && range.Peek().FunctionId() != CSSValueID::kRepeat) {
...
CSSValue* ConsumeGridTemplatesRowsOrColumns(CSSParserTokenRange& range, const CSSParserContext& context)
{
    switch (range.Peek().Id()) {
    case CSSValueID::kNone:
        return ConsumeIdent(range);
    case CSSValueID::kSubgrid:
        return ConsumeGridTrackList(range, context, TrackListType::kGridTemplateSubgrid);
    default:
        return ConsumeGridTrackList(range, context, TrackListType::kGridTemplate);
    }
}

bool ConsumeGridItemPositionShorthand(bool important, CSSParserTokenRange& range, const CSSParserContext& context, CSSValue*& start_value, CSSValue*& end_value)
{
...
bool ConsumeGridTemplateShorthand(bool important, CSSParserTokenRange& range, const CSSParserContext& context, const CSSValue*& template_rows,
    const CSSValue*& template_columns, const CSSValue*& template_areas)
{
    DCHECK(!template_rows);
    DCHECK(!template_columns);
    ...
    // [ / <track-list> ]?
    range = range_copy;
    return ConsumeGridTemplateRowsAndAreasAndColumns(important, range, context, template_rows, template_columns, template_areas);
}

CSSValue* ConsumeHyphenateLimitChars(CSSParserTokenRange& range, const CSSParserContext& context)
{
    CSSValueList* const list = CSSValueList::CreateSpaceSeparated();
    while (!range.AtEnd() && list->length() < 3) {
        if (const CSSPrimitiveValue* value = ConsumeIntegerOrNumberCalc(range, context, CSSPrimitiveValue::ValueRange::kPositiveInteger)) {
            list->Append(*value);
            continue;
        }
        if (const CSSIdentifierValue* ident = ConsumeIdent<CSSValueID::kAuto>(range)) {
            list->Append(*ident);
            continue;
        }
        return nullptr;
...
bool ConsumeFromPageBreakBetween(CSSParserTokenRange& range, CSSValueID& value)
{
...
bool ConsumeFromColumnBreakBetween(CSSParserTokenRange& range, CSSValueID& value)
{
    if (!ConsumeCSSValueId(range, value)) {
        return false;
    }
...
bool ConsumeFromColumnOrPageBreakInside(CSSParserTokenRange& range, CSSValueID& value)
{
    if (!ConsumeCSSValueId(range, value)) {
        return false;
    }
...
std::unique_ptr<SVGPathByteStream> ConsumePathStringArg(CSSParserTokenRange& args)
{
    if (args.Peek().GetType() != kStringToken)
        return nullptr;

    StringView path_string = args.ConsumeIncludingWhitespace().Value();
    std::unique_ptr<SVGPathByteStream> byte_stream = std::make_unique<SVGPathByteStream>();
    if (BuildByteStreamFromString(path_string, *byte_stream) != SVGParseStatus::kNoError) {
        return nullptr;
    }
...
CSSValue* ConsumeRay(CSSParserTokenRange& range, const CSSParserContext& context)
{
    ...
    while (!function_args.AtEnd()) {
        if (!angle) {
            angle = ConsumeAngle(function_args, context, absl::optional<WebFeature>());
            if (angle)
                continue;
        }
        if (!size) {
...
CSSValue* ConsumeMaxWidthOrHeight(CSSParserTokenRange& range, const CSSParserContext& context, UnitlessQuirk unitless)
{
    if (range.Peek().Id() == CSSValueID::kNone || ValidWidthOrHeightKeyword(range.Peek().Id(), context))
        return ConsumeIdent(range);
    return ConsumeLengthOrPercent(
        range, context, CSSPrimitiveValue::ValueRange::kNonNegative, unitless, static_cast<CSSAnchorQueryTypes>(CSSAnchorQueryType::kAnchorSize));
}

CSSValue* ConsumeWidthOrHeight(CSSParserTokenRange& range, const CSSParserContext& context, UnitlessQuirk unitless)
{
    if (range.Peek().Id() == CSSValueID::kAuto || ValidWidthOrHeightKeyword(range.Peek().Id(), context))
        return ConsumeIdent(range);
    return ConsumeLengthOrPercent(
        range, context, CSSPrimitiveValue::ValueRange::kNonNegative, unitless, static_cast<CSSAnchorQueryTypes>(CSSAnchorQueryType::kAnchorSize));
}

CSSValue* ConsumeMarginOrOffset(CSSParserTokenRange& range, const CSSParserContext& context, UnitlessQuirk unitless, CSSAnchorQueryTypes allowed_anchor_queries)
{
    if (range.Peek().Id() == CSSValueID::kAuto)
        return ConsumeIdent(range);
    return ConsumeLengthOrPercent(range, context, CSSPrimitiveValue::ValueRange::kAll, unitless, allowed_anchor_queries);
}

CSSValue* ConsumeScrollPadding(CSSParserTokenRange& range, const CSSParserContext& context)
{
    if (range.Peek().Id() == CSSValueID::kAuto)
        return ConsumeIdent(range);
    CSSParserContext::ParserModeOverridingScope scope(context, kHTMLStandardMode);
...
CSSValue* ConsumeOffsetPath(CSSParserTokenRange& range, const CSSParserContext& context)
{
    CSSValue* value = nullptr;
    if (RuntimeEnabledFeatures::CSSOffsetPathRayEnabled() && range.Peek().FunctionId() == CSSValueID::kRay)
...
CSSValue* ConsumeOffsetRotate(CSSParserTokenRange& range, const CSSParserContext& context)
{
    CSSValue* angle = ConsumeAngle(range, context, absl::optional<WebFeature>());
    CSSValue* keyword = ConsumeIdent<CSSValueID::kAuto, CSSValueID::kReverse>(range);
    if (!angle && !keyword)
        return nullptr;
...
CSSValue* ConsumeInitialLetter(CSSParserTokenRange& range, const CSSParserContext& context)
{
    ...
    if (auto* sink_type = ConsumeIdent<CSSValueID::kDrop, CSSValueID::kRaise>(range)) {
        if (auto* size = ConsumeNumber(range, context, CSSPrimitiveValue::ValueRange::kNonNegative)) {
    ...
    if (auto* size = ConsumeNumber(range, context, CSSPrimitiveValue::ValueRange::kNonNegative)) {
        ...
        if (auto* sink = ConsumeIntegerOrNumberCalc(range, context, CSSPrimitiveValue::ValueRange::kPositiveInteger)) {
            list->Append(*sink);
            return list;
        }
    }
...
bool ConsumeRadii(
    CSSValue* horizontal_radii[4], CSSValue* vertical_radii[4], CSSParserTokenRange& range, const CSSParserContext& context, bool use_legacy_parsing)
{
    unsigned horizontal_value_count = 0;
    for (; horizontal_value_count < 4 && !range.AtEnd() && range.Peek().GetType() != kDelimiterToken; ++horizontal_value_count) {
        horizontal_radii[horizontal_value_count] = ConsumeLengthOrPercent(range, context, CSSPrimitiveValue::ValueRange::kNonNegative);
    ...
    if (range.AtEnd()) {
        ...
        for (unsigned i = 0; i < 4 && !range.AtEnd(); ++i) {
            vertical_radii[i] = ConsumeLengthOrPercent(range, context, CSSPrimitiveValue::ValueRange::kNonNegative);
            if (!vertical_radii[i])
                return false;
        }
...
CSSValue* ConsumeBasicShape(CSSParserTokenRange& range, const CSSParserContext& context, AllowPathValue allow_path, AllowBasicShapeRectValue allow_rect,
...
CSSValue* ConsumeTextDecorationLine(CSSParserTokenRange& range)
{
    ...
    if (RuntimeEnabledFeatures::CSSSpellingGrammarErrorsEnabled() && (id == CSSValueID::kSpellingError || id == CSSValueID::kGrammarError)) {
...
CSSValue* ConsumeToggleGroup(CSSParserTokenRange& range, const CSSParserContext& context)
{
    if (range.Peek().Id() == CSSValueID::kNone)
        return nullptr;
    CSSCustomIdentValue* toggle_name = ConsumeCustomIdentConservatively(range, context);
    if (!toggle_name)
        return nullptr;
...
static CSSValue* ConsumeToggleValue(CSSParserTokenRange& range, const CSSParserContext& context)
{
    if (CSSPrimitiveValue* integer_value = ConsumeIntegerOrNumberCalc(range, context, CSSPrimitiveValue::ValueRange::kNonNegativeInteger)) {
        return integer_value;
    }
...
CSSValue* ConsumeToggleSpecifier(CSSParserTokenRange& range, const CSSParserContext& context)
{
    if (range.Peek().Id() == CSSValueID::kNone)
        return nullptr;
    CSSCustomIdentValue* toggle_name = ConsumeCustomIdentConservatively(range, context);
    ...
    while (!range.AtEnd()) {
        if (!overflow_value) {
            overflow_value = ConsumeIdent<CSSValueID::kCycle, CSSValueID::kCycleOn, CSSValueID::kSticky>(range);
            if (overflow_value)
                continue;
        }
        if (!group_value) {
        ...
        if (!found_states) {
            ...
            //     <toggle-value> = <integer [0,∞]> | <custom-ident>
            if (CSSPrimitiveValue* maximum_state_value = ConsumeIntegerOrNumberCalc(range, context, CSSPrimitiveValue::ValueRange::kPositiveInteger)) {
                found_states = true;
                ...
                while (true) {
                    CSSCustomIdentValue* state_name = ConsumeCustomIdentConservatively(block, context);
                    if (!state_name)
                        break;
...
CSSValue* ConsumeToggleTrigger(CSSParserTokenRange& range, const CSSParserContext& context)
{
    if (range.Peek().Id() == CSSValueID::kNone)
        return nullptr;
    CSSCustomIdentValue* toggle_name = ConsumeCustomIdentConservatively(range, context);
    ...
    CSSIdentifierValue* mode_value = ConsumeIdent<CSSValueID::kPrev, CSSValueID::kNext, CSSValueID::kSet>(range);
    if (!mode_value)
        return list;
    ...
    if (mode_value->GetValueID() != CSSValueID::kSet) {
        // [prev | next] <integer [1,∞]>?
        DCHECK(mode_value->GetValueID() == CSSValueID::kPrev || mode_value->GetValueID() == CSSValueID::kNext);
        CSSPrimitiveValue* increment_value = ConsumeIntegerOrNumberCalc(range, context, CSSPrimitiveValue::ValueRange::kPositiveInteger);
        if (increment_value)
...
CSSValue* ConsumeTransformValue(CSSParserTokenRange& range, const CSSParserContext& context, bool use_legacy_parsing)
{
    CSSValueID function_id = range.Peek().FunctionId();
    ...
    case CSSValueID::kSkew:
        parsed_value = ConsumeAngle(args, context, WebFeature::kUnitlessZeroAngleTransform);
        if (!parsed_value)
            return nullptr;
        if (function_id == CSSValueID::kSkew && ConsumeCommaIncludingWhitespace(args)) {
            transform_value->Append(*parsed_value);
            parsed_value = ConsumeAngle(args, context, WebFeature::kUnitlessZeroAngleTransform);
            if (!parsed_value)
                return nullptr;
    ...
    case CSSValueID::kScale:
        parsed_value = ConsumeNumberOrPercent(args, context, CSSPrimitiveValue::ValueRange::kAll);
        if (!parsed_value)
            return nullptr;
        if (function_id == CSSValueID::kScale && ConsumeCommaIncludingWhitespace(args)) {
            transform_value->Append(*parsed_value);
            parsed_value = ConsumeNumberOrPercent(args, context, CSSPrimitiveValue::ValueRange::kAll);
            if (!parsed_value)
                return nullptr;
    ...
    case CSSValueID::kPerspective:
        if (!ConsumePerspective(args, context, transform_value, use_legacy_parsing)) {
            return nullptr;
        }
        break;
    ...
    case CSSValueID::kTranslate:
        ...
        if (!parsed_value)
            return nullptr;
        if (function_id == CSSValueID::kTranslate && ConsumeCommaIncludingWhitespace(args)) {
            transform_value->Append(*parsed_value);
            parsed_value = ConsumeLengthOrPercent(args, context, CSSPrimitiveValue::ValueRange::kAll);
            if (!parsed_value)
                return nullptr;
    ...
    case CSSValueID::kMatrix3d:
        if (!ConsumeNumbers(args, context, transform_value, (function_id == CSSValueID::kMatrix3d) ? 16 : 6)) {
            return nullptr;
        }
        break;
    ...
    case CSSValueID::kRotate3d:
        if (!ConsumeNumbers(args, context, transform_value, 3) || !ConsumeCommaIncludingWhitespace(args)) {
            return nullptr;
        }
        parsed_value = ConsumeAngle(args, context, WebFeature::kUnitlessZeroAngleTransform);
        if (!parsed_value)
...
CSSValue* ConsumeTransformList(CSSParserTokenRange& range, const CSSParserContext& context, const CSSParserLocalContext& local_context)
{
    if (range.Peek().Id() == CSSValueID::kNone)
        return ConsumeIdent(range);
    ...
    CSSValueList* list = CSSValueList::CreateSpaceSeparated();
    do {
        CSSValue* parsed_transform_value = ConsumeTransformValue(range, context, local_context.UseAliasParsing());
...
CSSValue* ConsumeTransitionProperty(CSSParserTokenRange& range, const CSSParserContext& context)
{
    const CSSParserToken& token = range.Peek();
    if (token.GetType() != kIdentToken)
        return nullptr;
...
CSSValue* ConsumeBorderColorSide(CSSParserTokenRange& range, const CSSParserContext& context, const CSSParserLocalContext& local_context)
{
    CSSPropertyID shorthand = local_context.CurrentShorthand();
...
CSSValue* ConsumeBorderWidth(CSSParserTokenRange& range, const CSSParserContext& context, UnitlessQuirk unitless)
{
    return ConsumeLineWidth(range, context, unitless);
}

CSSValue* ParseSpacing(CSSParserTokenRange& range, const CSSParserContext& context)
{
    if (range.Peek().Id() == CSSValueID::kNormal)
        return ConsumeIdent(range);
    // TODO(timloh): allow <percentage>s in word-spacing.
    return ConsumeLength(range, context, CSSPrimitiveValue::ValueRange::kAll, UnitlessQuirk::kAllow);
}

CSSValue* ConsumeSingleContainerName(CSSParserTokenRange& range, const CSSParserContext& context)
{
    if (range.Peek().GetType() != kIdentToken)
        return nullptr;
    if (range.Peek().Id() == CSSValueID::kNormal)
...
CSSValue* ConsumeContainerName(CSSParserTokenRange& range, const CSSParserContext& context)
{
    if (CSSValue* value = ConsumeIdent<CSSValueID::kNone>(range))
        return value;
...
CSSValue* ConsumeContainerType(CSSParserTokenRange& range)
{
    ...
    if (CSSValue* value = ConsumeIdent<CSSValueID::kSize, CSSValueID::kInlineSize>(range)) {
        // Note that StyleBuilderConverter::ConvertFlags requires that values
...
CSSValue* ConsumeSVGPaint(CSSParserTokenRange& range, const CSSParserContext& context)
{
    if (range.Peek().Id() == CSSValueID::kNone)
        return ConsumeIdent(range);
...
CSSCustomIdentValue* ConsumeCounterStyleName(CSSParserTokenRange& range, const CSSParserContext& context)
{
...
AtomicString ConsumeCounterStyleNameInPrelude(CSSParserTokenRange& prelude, const CSSParserContext& context)
{
