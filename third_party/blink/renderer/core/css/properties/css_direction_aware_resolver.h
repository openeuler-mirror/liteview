...
public:
    ...
    static const CSSProperty& ResolveInlineStart(TextDirection, WritingMode, const PhysicalMapping<4>&);
    static const CSSProperty& ResolveInlineEnd(TextDirection, WritingMode, const PhysicalMapping<4>&);
    static const CSSProperty& ResolveBlockStart(TextDirection, WritingMode, const PhysicalMapping<4>&);
    static const CSSProperty& ResolveBlockEnd(TextDirection, WritingMode, const PhysicalMapping<4>&);
    ...
    static const CSSProperty& ResolveTop(TextDirection, WritingMode, const LogicalMapping<4>&);
    static const CSSProperty& ResolveBottom(TextDirection, WritingMode, const LogicalMapping<4>&);
    static const CSSProperty& ResolveLeft(TextDirection, WritingMode, const LogicalMapping<4>&);
    static const CSSProperty& ResolveRight(TextDirection, WritingMode, const LogicalMapping<4>&);

    // These resolvers expect a PhysicalMapping with dimensions, in the following
    // order: horizontal, vertical.
    static const CSSProperty& ResolveInline(TextDirection, WritingMode, const PhysicalMapping<2>&);
    static const CSSProperty& ResolveBlock(TextDirection, WritingMode, const PhysicalMapping<2>&);

    // These resolvers expect a LogicalMapping with dimensions, in the following
    // order: block, inline.
    // TODO(layout-dev): Implement them, if needed.
    static const CSSProperty& ResolveHorizontal(TextDirection, WritingMode, const LogicalMapping<2>&);
    static const CSSProperty& ResolveVertical(TextDirection, WritingMode, const LogicalMapping<2>&);
    ...
    static const CSSProperty& ResolveStartStart(TextDirection, WritingMode, const PhysicalMapping<4>&);
    static const CSSProperty& ResolveStartEnd(TextDirection, WritingMode, const PhysicalMapping<4>&);
    static const CSSProperty& ResolveEndStart(TextDirection, WritingMode, const PhysicalMapping<4>&);
    static const CSSProperty& ResolveEndEnd(TextDirection, WritingMode, const PhysicalMapping<4>&);

    // These resolvers expect a a LogicalMapping with box corners, in the
    // following order: start-start, start-end, end-start, end-end.
    // TODO(layout-dev): Implement them, if needed.
    static const CSSProperty& ResolveTopLeft(TextDirection, WritingMode, const LogicalMapping<4>&);
    static const CSSProperty& ResolveTopRight(TextDirection, WritingMode, const LogicalMapping<4>&);
    static const CSSProperty& ResolveBottomRight(TextDirection, WritingMode, const LogicalMapping<4>&);
    static const CSSProperty& ResolveBottomLeft(TextDirection, WritingMode, const LogicalMapping<4>&);
};
