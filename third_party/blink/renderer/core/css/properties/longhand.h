...
public:
    ...
    virtual const CSSValue* ParseSingleValue(CSSParserTokenRange&, const CSSParserContext&, const CSSParserLocalContext&) const
    {
        return nullptr;
    }
    ...
    virtual void ApplyValue(StyleResolverState& state, const ScopedCSSValue& scoped_value) const
    {
