...
public:
    ...
    void SimulateNavigation()
    {
        ...
        GetDocument().GetFrame()->Loader().CommitNavigation(
            WebNavigationParams::CreateWithHTMLBufferForTesting(SharedBuffer::Create(), url), nullptr /* extra_data */);
    ...
    {
        StyleEnvironmentVariables::GetRootInstance().SetVariable(variable, first_dimension, second_dimension, value);
    }
};
...
TEST_F(StyleEnvironmentVariablesTest, GlobalVariable_DefaultsPresent)
{
    ...
    EXPECT_EQ(nullptr, StyleEnvironmentVariables::GetRootInstance().ResolveVariable("test", {}));
}
...
TEST_F(StyleEnvironmentVariablesTest, DISABLED_PrintExpectedVariableNameHashes)
{
    const UADefinedVariable variables[] = { UADefinedVariable::kSafeAreaInsetTop, UADefinedVariable::kSafeAreaInsetLeft, UADefinedVariable::kSafeAreaInsetRight,
        UADefinedVariable::kSafeAreaInsetBottom };
    for (const auto& variable : variables) {
        const AtomicString name = StyleEnvironmentVariables::GetVariableName(variable, /*feature_context=*/nullptr);
