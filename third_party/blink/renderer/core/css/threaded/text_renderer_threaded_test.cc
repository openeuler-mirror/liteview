...
TSAN_TEST(TextRendererThreadedTest, MeasureText)
{
    RunOnThreads([]() {
        ...
        TextRun text_run(text, 0, 0, TextRun::kAllowTrailingExpansion | TextRun::kForbidLeadingExpansion, TextDirection::kLtr, false);
...
TSAN_TEST(TextRendererThreadedTest, DrawText)
{
    ...
    RunOnThreads([]() {
        ...
        TextRun text_run(text, 0, 0, TextRun::kAllowTrailingExpansion, TextDirection::kLtr, false);
        text_run.SetNormalizeSpace(true);
        ...
        font.DrawBidiText(&mpc, text_run_paint_info, location, Font::kUseFallbackIfFontNotReady, 1.0, flags, Font::DrawType::kGlyphsAndClusters);
    });
}
