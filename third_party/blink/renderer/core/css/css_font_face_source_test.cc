...
public:
    scoped_refptr<SimpleFontData> CreateFontData(const FontDescription&, const FontSelectionCapabilities&) override
    {
        return SimpleFontData::Create(FontPlatformData(SkTypeface::MakeDefault(), /* name */ std::string(),
...
TEST(CSSFontFaceSourceTest, HashCollision)
{
    ...
    EXPECT_NE(font_face_source.GetFontDataForSize(13717), font_face_source.GetFontDataForSize(5613));
}
