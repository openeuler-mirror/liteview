...
public:
    CSSCustomPropertyDeclaration(scoped_refptr<CSSVariableData> value, const CSSParserContext* parser_context)
...
template <> struct DowncastTraits<CSSCustomPropertyDeclaration> {
