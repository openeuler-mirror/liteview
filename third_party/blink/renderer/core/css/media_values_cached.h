...
public:
    struct CORE_EXPORT MediaValuesCachedData final {
        ...
        device::mojom::blink::DevicePostureType device_posture = device::mojom::blink::DevicePostureType::kContinuous;
...
template <> struct CrossThreadCopier<blink::MediaValuesCached::MediaValuesCachedData> {
    typedef blink::MediaValuesCached::MediaValuesCachedData Type;
    static Type Copy(const Type& data)
    {
