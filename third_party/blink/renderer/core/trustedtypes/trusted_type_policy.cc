...
TrustedHTML* TrustedTypePolicy::createHTML(ScriptState* script_state, const String& input, const HeapVector<ScriptValue>& args, ExceptionState& exception_state)
{
    return CreateHTML(script_state->GetIsolate(), input, args, exception_state);
}

TrustedScript* TrustedTypePolicy::createScript(
    ScriptState* script_state, const String& input, const HeapVector<ScriptValue>& args, ExceptionState& exception_state)
{
...
TrustedScriptURL* TrustedTypePolicy::createScriptURL(
    ScriptState* script_state, const String& input, const HeapVector<ScriptValue>& args, ExceptionState& exception_state)
{
    return CreateScriptURL(script_state->GetIsolate(), input, args, exception_state);
}
