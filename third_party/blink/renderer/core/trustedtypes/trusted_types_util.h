...
[[nodiscard]] CORE_EXPORT String TrustedTypesCheckFor(
    SpecificTrustedType type, const V8TrustedType* trusted, const ExecutionContext* execution_context, ExceptionState& exception_state);
[[nodiscard]] CORE_EXPORT String TrustedTypesCheckForScript(
    const V8UnionStringOrTrustedScript* value, const ExecutionContext* execution_context, ExceptionState& exception_state);
[[nodiscard]] CORE_EXPORT String TrustedTypesCheckForScript(
...
// policy.
[[nodiscard]] String TrustedTypesCheckFor(SpecificTrustedType, String, const ExecutionContext*, ExceptionState&);
[[nodiscard]] CORE_EXPORT String TrustedTypesCheckForHTML(const String&, const ExecutionContext*, ExceptionState&);
[[nodiscard]] CORE_EXPORT String TrustedTypesCheckForScript(const String&, const ExecutionContext*, ExceptionState&);
[[nodiscard]] CORE_EXPORT String TrustedTypesCheckForScriptURL(const String&, const ExecutionContext*, ExceptionState&);
