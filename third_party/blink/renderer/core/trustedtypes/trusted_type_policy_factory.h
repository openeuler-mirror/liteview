...
class CORE_EXPORT TrustedTypePolicyFactory final : public EventTargetWithInlineData, public ExecutionContextClient {
...
public:
    ...
    String getPropertyType(const String& tagName, const String& propertyName) const;
    String getPropertyType(const String& tagName, const String& propertyName, const String& elementNS) const;
    String getAttributeType(const String& tagName, const String& attributeName) const;
    String getAttributeType(const String& tagName, const String& attributeName, const String& tagNS) const;
...
private:
    const WrapperTypeInfo* GetWrapperTypeInfoFromScriptValue(ScriptState*, const ScriptValue&);
