...
public:
    ...
    TrustedHTML* createHTML(ScriptState*, const String&, const HeapVector<ScriptValue>&, ExceptionState&);
    TrustedScript* createScript(ScriptState*, const String&, const HeapVector<ScriptValue>&, ExceptionState&);
    TrustedScriptURL* createScriptURL(ScriptState*, const String&, const HeapVector<ScriptValue>&, ExceptionState&);
