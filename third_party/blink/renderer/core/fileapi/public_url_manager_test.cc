...
public:
    void RegisterURL(SecurityOrigin* origin, const KURL& url, URLRegistrable* registrable) override
    {
...
TEST_F(PublicURLManagerTest, RegisterNonMojoBlob)
{
    ...
    EXPECT_EQ(GetExecutionContext()->GetSecurityOrigin(), registry.registrations[0].origin);
