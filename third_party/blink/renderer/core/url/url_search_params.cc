...
class URLSearchParamsIterationSource final : public PairIterable<String, IDLString, String, IDLString>::IterationSource {
public:
...
PairIterable<String, IDLString, String, IDLString>::IterationSource* URLSearchParams::StartIteration(ScriptState*, ExceptionState&)
{
