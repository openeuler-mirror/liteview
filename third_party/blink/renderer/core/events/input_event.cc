...
{
    auto* const it = std::begin(kInputTypeStringNameMap) + static_cast<size_t>(input_type);
...
/* static */
InputEvent* InputEvent::CreateBeforeInput(
    InputType input_type, const String& data, EventCancelable cancelable, EventIsComposing is_composing, const StaticRangeVector* ranges)
{
...
/* static */
InputEvent* InputEvent::CreateBeforeInput(
    InputType input_type, DataTransfer* data_transfer, EventCancelable cancelable, EventIsComposing is_composing, const StaticRangeVector* ranges)
{
    InputEventInit* input_event_init = InputEventInit::Create();
