...
public:
    ...
    static WheelEvent* Create(const WebMouseWheelEvent& native_event, AbstractView*);

    static WheelEvent* Create(const WebMouseWheelEvent& native_event, const gfx::Vector2dF& delta_in_pixels, AbstractView*);
    ...
    WheelEvent(const WebMouseWheelEvent&, const gfx::Vector2dF& delta_in_pixels, AbstractView*);
