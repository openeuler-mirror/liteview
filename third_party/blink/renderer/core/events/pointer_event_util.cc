...
namespace blink {
// static
double PointerEventUtil::AzimuthFromTilt(int32_t tilt_x_degrees, int32_t tilt_y_degrees)
{
...
// static
double PointerEventUtil::AltitudeFromTilt(int32_t tilt_x_degrees, int32_t tilt_y_degrees)
{
    DCHECK(tilt_x_degrees >= -90 && tilt_x_degrees <= 90);
    DCHECK(tilt_y_degrees >= -90 && tilt_y_degrees <= 90);
