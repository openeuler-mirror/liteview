...
public:
    explicit WindowAgentFactory(scheduler::WebAgentGroupScheduler& agent_group_scheduler);
...
private:
    ...
    struct SchemeAndRegistrableDomainHash {
        ...
        static bool Equal(const SchemeAndRegistrableDomain&, const SchemeAndRegistrableDomain&);
    };

    struct SchemeAndRegistrableDomainTraits : SimpleClassHashTraits<SchemeAndRegistrableDomain> {
        ...
        static void ConstructDeletedValue(SchemeAndRegistrableDomain& slot, bool zero_value);
    };
    ...
    HeapHashMap<scoped_refptr<const SecurityOrigin>, WeakMember<WindowAgent>, SecurityOriginHash> opaque_origin_agents_;
    ...
    HeapHashMap<scoped_refptr<const SecurityOrigin>, WeakMember<WindowAgent>, SecurityOriginHash> origin_keyed_agent_cluster_agents_;

    // Use registerable domain as the key for general tuple origins.
    using TupleOriginAgents
        = HeapHashMap<SchemeAndRegistrableDomain, WeakMember<WindowAgent>, SchemeAndRegistrableDomainHash, SchemeAndRegistrableDomainTraits>;
