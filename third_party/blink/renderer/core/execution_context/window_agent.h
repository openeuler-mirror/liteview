...
public:
    ...
    explicit WindowAgent(scheduler::WebAgentGroupScheduler& agent_group_scheduler);
    ...
    WindowAgent(scheduler::WebAgentGroupScheduler& agent_group_scheduler, bool is_origin_agent_cluster, bool origin_agent_cluster_left_as_default);
