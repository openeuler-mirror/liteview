...
public:
    ...
    static void ReportCorsIssue(ExecutionContext* execution_context, int64_t identifier, RendererCorsIssueCode code, WTF::String url,
        WTF::String initiator_origin, WTF::String failedParameter, absl::optional<base::UnguessableToken> issue_id);
    ...
    static void ReportNavigatorUserAgentAccess(ExecutionContext* execution_context, WTF::String url);
    ...
    static void ReportDeprecationIssue(ExecutionContext* execution_context, DeprecationIssueType type);
