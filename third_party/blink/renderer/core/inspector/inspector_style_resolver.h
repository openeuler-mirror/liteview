...
public:
    InspectorStyleResolver(Element*, PseudoId, const AtomicString& document_transition_tag);
...
private:
    void AddPseudoElementRules(PseudoId pseudo_id, const AtomicString& document_transition_tag);
