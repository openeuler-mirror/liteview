...
public:
    ...
    ConsoleMessage(mojom::blink::ConsoleMessageSource, mojom::blink::ConsoleMessageLevel, const String& message, const String& url, DocumentLoader*,
        uint64_t request_identifier);
    // Creates message from WorkerMessageSource.
    ConsoleMessage(mojom::blink::ConsoleMessageLevel, const String& message, std::unique_ptr<SourceLocation>, WorkerThread*);
    ...
    ConsoleMessage(mojom::blink::ConsoleMessageSource, mojom::blink::ConsoleMessageLevel, const String& message,
