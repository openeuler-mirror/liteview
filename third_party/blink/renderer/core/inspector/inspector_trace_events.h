...
public:
    ...
    void WillSendRequest(DocumentLoader*, const KURL& fetch_context_url, const ResourceRequest&, const ResourceResponse& redirect_response,
    ...
    void DidReceiveData(uint64_t identifier, DocumentLoader*, const char* data, uint64_t data_length);
    void DidFinishLoading(uint64_t identifier, DocumentLoader*, base::TimeTicks monotonic_finish_time, int64_t encoded_data_length, int64_t decoded_body_length,
...
void RuleSetInvalidation(perfetto::TracedValue context, ContainerNode&, const InvalidationSet&);
} // namespace inspector_schedule_style_invalidation_tracking_event
...
void SelectorPart(perfetto::TracedValue context, Element&, const char* reason, const InvalidationSet&, const String&);
...
void Data(perfetto::TracedValue context, DocumentLoader*, uint64_t identifier, LocalFrame*, const ResourceRequest&, RenderBlockingBehavior);
}
...
void Data(perfetto::TracedValue context, ExecutionContext*, int timer_id, base::TimeDelta timeout, bool single_shot);
}
...
void Data(perfetto::TracedValue context, Frame*, const LayoutObject*, const gfx::QuadF& quad, int layer_id);
}
...
void Data(perfetto::TracedValue context, LocalFrame*, const String& url, const WTF::TextPosition&);
}
...
void Data(perfetto::TracedValue context, const String& url, const WTF::TextPosition&, absl::optional<V8ConsumeCacheResult>, bool eager, bool streamed,
