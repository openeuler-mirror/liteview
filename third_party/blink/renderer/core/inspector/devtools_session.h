...
private:
    ...
    blink::mojom::blink::DevToolsMessagePtr FinalizeMessage(std::vector<uint8_t> message) const;
    ...
    template <typename T> bool IsDomainAvailableToUntrustedClient()
    {
        return std::disjunction_v<std::is_same<T, InspectorAuditsAgent>, std::is_same<T, InspectorCSSAgent>, std::is_same<T, InspectorCacheStorageAgent>,
            std::is_same<T, InspectorDOMAgent>, std::is_same<T, InspectorDOMDebuggerAgent>, std::is_same<T, InspectorDOMSnapshotAgent>,
            std::is_same<T, InspectorDatabaseAgent>, std::is_same<T, InspectorEmulationAgent>, std::is_same<T, InspectorIOAgent>,
            std::is_same<T, InspectorLogAgent>, std::is_same<T, InspectorNetworkAgent>, std::is_same<T, InspectorOverlayAgent>,
            std::is_same<T, InspectorPageAgent>, std::is_same<T, InspectorPerformanceAgent>, std::is_same<T, InspectorWebAudioAgent>>;
    }
