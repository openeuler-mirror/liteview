...
DevToolsEmulator::DevToolsEmulator(WebViewImpl* web_view)
    ...
    , embedder_prefer_compositing_to_lcd_text_enabled_(web_view->GetPage()->GetSettings().GetPreferCompositingToLCDTextEnabled())
...
void DevToolsEmulator::SetTextAutosizingEnabled(bool enabled)
{
    ...
    bool emulate_mobile_enabled = device_metrics_enabled_ && emulate_mobile_enabled_;
...
void DevToolsEmulator::SetPreferCompositingToLCDTextEnabled(bool enabled)
{
    ...
    bool emulate_mobile_enabled = device_metrics_enabled_ && emulate_mobile_enabled_;
    if (!emulate_mobile_enabled) {
        web_view_->GetPage()->GetSettings().SetPreferCompositingToLCDTextEnabled(enabled);
    }
}
...
TransformationMatrix DevToolsEmulator::EnableDeviceEmulation(const DeviceEmulationParams& params)
{
...
void DevToolsEmulator::EnableMobileEmulation()
{
    ...
    is_overlay_scrollbars_enabled_ = ScrollbarThemeSettings::OverlayScrollbarsEnabled();
    ScrollbarThemeSettings::SetOverlayScrollbarsEnabled(true);
    Page::UsesOverlayScrollbarsChanged();
    is_orientation_event_enabled_ = RuntimeEnabledFeatures::OrientationEventEnabled();
    RuntimeEnabledFeatures::SetOrientationEventEnabled(true);
    is_mobile_layout_theme_enabled_ = RuntimeEnabledFeatures::MobileLayoutThemeEnabled();
    ...
    web_view_->GetPage()->GetSettings().SetPreferCompositingToLCDTextEnabled(true);
...
void DevToolsEmulator::DisableMobileEmulation()
{
    if (!emulate_mobile_enabled_)
        return;
    ScrollbarThemeSettings::SetOverlayScrollbarsEnabled(is_overlay_scrollbars_enabled_);
    Page::UsesOverlayScrollbarsChanged();
    RuntimeEnabledFeatures::SetOrientationEventEnabled(is_orientation_event_enabled_);
    RuntimeEnabledFeatures::SetMobileLayoutThemeEnabled(is_mobile_layout_theme_enabled_);
    Page::PlatformColorsChanged();
    ...
    web_view_->GetPage()->GetSettings().SetPreferCompositingToLCDTextEnabled(embedder_prefer_compositing_to_lcd_text_enabled_);
...
TransformationMatrix DevToolsEmulator::ForceViewport(const gfx::PointF& position, float scale)
{
...
TransformationMatrix DevToolsEmulator::OutermostMainFrameScrollOrScaleChanged()
{
