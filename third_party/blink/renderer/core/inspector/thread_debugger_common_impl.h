...
public:
    ...
    unsigned PromiseRejected(v8::Local<v8::Context>, const String& error_message, v8::Local<v8::Value> exception, std::unique_ptr<SourceLocation>) override;
...
protected:
    ...
    virtual void ReportConsoleMessage(ExecutionContext*, mojom::ConsoleMessageSource, mojom::ConsoleMessageLevel, const String& message, SourceLocation*) = 0;
...
private:
    ...
    std::unique_ptr<v8_inspector::WebDriverValue> serializeToWebDriverValue(v8::Local<v8::Value> v8_value, int max_depth) override;
