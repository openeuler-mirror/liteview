...
constexpr const char* kBoxOptionDevicePixelContentBox = "device-pixel-content-box";
...
ResizeObserverBoxOptions ResizeObserver::ParseBoxOptions(const String& box_options)
{
...
void ResizeObserver::DeliverObservations()
{
    ...
    for (auto& observation : active_observations_) {
        ...
        // such a target.
        ExecutionContext* execution_context = observation->Target()->GetExecutionContext();
