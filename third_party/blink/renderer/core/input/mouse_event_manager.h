...
public:
    ...
    WebInputEventResult SetMousePositionAndDispatchMouseEvent(Element* target_element, const AtomicString& event_type, const WebMouseEvent&);
    ...
    void SendBoundaryEvents(EventTarget* exited_target, EventTarget* entered_target, const WebMouseEvent&);
...
private:
    ...
    private:
        void Dispatch(EventTarget*, EventTarget* related_target, const AtomicString&, const WebMouseEvent&, bool check_for_listener);
