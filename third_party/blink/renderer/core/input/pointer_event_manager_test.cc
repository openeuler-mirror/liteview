...
TEST_F(PointerEventManagerTest, PointerEventMovements)
{
...

    {
        ...
        WebView().MainFrameWidget()->HandleInputEvent(
            WebCoalescedInputEvent(CreateTestPointerEvent(WebInputEvent::Type::kPointerMove, WebPointerProperties::PointerType::kMouse, gfx::PointF(150, 210),
                                       gfx::PointF(100, 16.25), 1024, -8765),
                {}, {}, ui::LatencyInfo()));
        ASSERT_EQ(callback->last_screen_x_, 100);
...
public:
    ...
    {
        return MakeGarbageCollected<PanActionTrackingWebFrameWidget>(compositor, pass_key, std::move(frame_widget_host), std::move(frame_widget),
