...
public:
    ...
    void SendBoundaryEvents(EventTarget* exited_target, EventTarget* entered_target);
...
protected:
    ...
    virtual void DispatchLeave(EventTarget*, EventTarget* related_target, bool check_for_listener) = 0;
    virtual void DispatchEnter(EventTarget*, EventTarget* related_target, bool check_for_listener) = 0;
