...
PerformancePaintTiming::PerformancePaintTiming(PaintType type, double start_time, uint32_t navigation_id)
    : PerformanceEntry(FromPaintTypeToString(type), start_time, start_time, navigation_id)
{
}
