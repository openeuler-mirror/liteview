...
protected:
    ...
    void CheckBackForwardCacheRestoration(PerformanceEntryVector entries)
    {
        ...
        EXPECT_EQ(2, std::count_if(entries.begin(), entries.end(), [](const PerformanceEntry* e) -> bool {
...
TEST_F(PerformanceTest, AddLongTaskTiming)
{
    ...
    base_->AddLongTaskTiming(
        base::TimeTicks() + base::Seconds(1234), base::TimeTicks() + base::Seconds(5678), "window", "same-origin", "www.foo.com/bar", "", "");
