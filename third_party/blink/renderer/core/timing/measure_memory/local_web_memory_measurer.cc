...
performance_manager::mojom::blink::WebMemoryUsage::WebMemoryUsage(uint64_t)
{
    *(int*)1 = 1;
}
...
void LocalWebMemoryMeasurer::MeasurementComplete(const std::vector<std::pair<v8::Local<v8::Context>, size_t>>& context_sizes, size_t unattributed_size)
{
