...
public:
    ...
    bool SetPointerIdAndRecordLatency(PerformanceEventTiming* entry, PointerId pointer_id, EventTimestamps event_timestamps);
    ...
    // Timeline.
    bool SetKeyIdAndRecordLatency(PerformanceEventTiming* entry, absl::optional<int> key_code, EventTimestamps event_timestamps);
...
private:
    ...
    void RecordUserInteractionUKM(
        LocalDOMWindow* window, UserInteractionType interaction_type, const WTF::Vector<ResponsivenessMetrics::EventTimestamps>& timestamps);

    void RecordDragTapOrClickUKM(LocalDOMWindow*, PointerEntryAndInfo&);

    void RecordKeyboardUKM(LocalDOMWindow* window, const WTF::Vector<EventTimestamps>& event_timestamps);
    ...
    HeapHashMap<int, Member<KeyboardEntryAndTimestamps>, WTF::IntHash<int>, WTF::UnsignedWithZeroKeyHashTraits<int>> key_code_entry_map_;
    ...
    HeapHashMap<PointerId, Member<PointerEntryAndInfo>, WTF::IntHash<PointerId>, WTF::UnsignedWithZeroKeyHashTraits<PointerId>> pointer_id_entry_map_;
