...
public:
    ...
    static Vector<mojom::blink::ServerTimingInfoPtr> ParseServerTimingToMojo(const ResourceTimingInfo&);
    static Vector<mojom::blink::ServerTimingInfoPtr> ParseServerTimingFromHeaderValueToMojo(const String& value);
    static HeapVector<Member<PerformanceServerTiming>> ParseServerTiming(const ResourceTimingInfo&);
