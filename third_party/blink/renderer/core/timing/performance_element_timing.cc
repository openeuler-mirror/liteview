...
PerformanceElementTiming* PerformanceElementTiming::Create(const AtomicString& name, const String& url, const gfx::RectF& intersection_rect,
    ...
    Element* element, uint32_t navigation_id)
{
    ...
    return MakeGarbageCollected<PerformanceElementTiming>(
        name, start_time, url, intersection_rect, render_time, load_time, identifier, naturalWidth, naturalHeight, id, element, navigation_id);
}
...
PerformanceElementTiming::PerformanceElementTiming(const AtomicString& name, DOMHighResTimeStamp start_time, const String& url,
    ...
    int naturalHeight, const AtomicString& id, Element* element, uint32_t navigation_id)
