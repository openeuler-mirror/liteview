...
BackForwardCacheRestoration::BackForwardCacheRestoration(
    DOMHighResTimeStamp start_time, DOMHighResTimeStamp pageshow_event_start, DOMHighResTimeStamp pageshow_event_end, uint32_t navigation_id)
    : PerformanceEntry(g_empty_atom, start_time, pageshow_event_start, navigation_id)
