...
public:
    PerformanceNavigationTiming(
        LocalDOMWindow*, ResourceTimingInfo*, base::TimeTicks time_origin, bool cross_origin_isolated_capability, HeapVector<Member<PerformanceServerTiming>>);
...
private:
    ...
    ScriptValue NotRestoredReasonsBuilder(ScriptState* script_state, const mojom::blink::BackForwardCacheNotRestoredReasonsPtr& reasons) const;
