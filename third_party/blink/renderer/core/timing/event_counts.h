...
class EventCounts final : public ScriptWrappable, public Maplike<AtomicString, IDLString, uint32_t, IDLUnsignedLong> {
...
private:
    ...
    PairIterable<AtomicString, IDLString, uint32_t, IDLUnsignedLong>::IterationSource* StartIteration(ScriptState*, ExceptionState&) override;
    bool GetMapEntry(ScriptState*, const AtomicString& key, unsigned& value, ExceptionState&) override;
