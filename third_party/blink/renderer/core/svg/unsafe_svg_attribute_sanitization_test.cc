...
void PasteAndVerifySanitization(const char* html_to_paste, const char* expected_partial_contents)
{
    ...
    frame.Selection().SetSelectionAndEndTyping(SelectionInDOMTree::Builder().SelectAllChildren(*body).Build());
...
{
    QualifiedName href_alternate_prefix("foo", "href", xlink_names::kNamespaceURI);
