...
public:
    ...
    StaticNodeList* getIntersectionList(SVGRectTearOff*, SVGElement* reference_element) const;
...
private:
    ...
    bool CheckIntersectionOrEnclosure(const SVGElement&, const gfx::RectF&, GeometryMatchingMode) const;
    StaticNodeList* CollectIntersectionOrEnclosureList(const gfx::RectF&, SVGElement*, GeometryMatchingMode) const;
