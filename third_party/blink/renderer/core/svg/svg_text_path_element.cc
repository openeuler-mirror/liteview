...
LayoutObject* SVGTextPathElement::CreateLayoutObject(const ComputedStyle&, LegacyLayout)
{
    return MakeGarbageCollected<LayoutSVGTextPath>(this);
}

bool SVGTextPathElement::LayoutObjectIsNeeded(const ComputedStyle& style) const
{
