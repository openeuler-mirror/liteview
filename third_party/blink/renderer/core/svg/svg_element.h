...
public:
    ...
    enum ApplyMotionTransform { kExcludeMotionTransform, kIncludeMotionTransform };
    ...
    public:
        SvgAttributeChangedParams(const QualifiedName& qname, AttributeModificationReason reason)
            : name(qname)
            , reason(reason)
        {
        }
    ...
    scoped_refptr<ComputedStyle> CustomStyleForLayoutObject(const StyleRecalcContext&) final;
