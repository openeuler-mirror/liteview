...
LayoutObject* SVGAElement::CreateLayoutObject(const ComputedStyle&, LegacyLayout)
{
...
{
    return (GetDocument().LastFocusType() != mojom::blink::FocusType::kMouse) || SVGGraphicsElement::SupportsFocus();
}
