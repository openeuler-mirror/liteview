...
float SVGLength::Value(const SVGLengthContext& context) const
{
    ...
    return context.ConvertValueToUserUnits(value_->GetFloatValue(), UnitMode(), NumericLiteralType());
}
...
void SVGLength::SetValue(float value, const SVGLengthContext& context)
{
    ...
    value_ = CSSNumericLiteralValue::Create(context.ConvertValueFromUserUnits(value, UnitMode(), NumericLiteralType()), NumericLiteralType());
}
...
void SVGLength::Add(const SVGPropertyBase* other, const SVGElement* context_element)
{
    ...
    SetValue(Value(length_context) + To<SVGLength>(other)->Value(length_context), length_context);
}
    ...
    const SVGPropertyBase* from_value, const SVGPropertyBase* to_value, const SVGPropertyBase* to_at_end_of_duration_value, const SVGElement* context_element)
{
    ...
    CSSPrimitiveValue::UnitType result_unit = (!unit_determining_length->IsCalculated() && !unit_determining_length->HasContainerRelativeUnits())
