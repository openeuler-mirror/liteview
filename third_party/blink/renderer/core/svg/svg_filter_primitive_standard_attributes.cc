    ...
    FilterEffect* filter_effect, SVGUnitTypes::SVGUnitType primitive_units, const gfx::RectF& reference_box) const
{
    ...
    gfx::RectF primitive_boundaries = SVGLengthContext::ResolveRectangle(this, primitive_units, reference_box);
...
LayoutObject* SVGFilterPrimitiveStandardAttributes::CreateLayoutObject(const ComputedStyle&, LegacyLayout)
{
    return MakeGarbageCollected<LayoutSVGFilterPrimitive>(this);
}

bool SVGFilterPrimitiveStandardAttributes::LayoutObjectIsNeeded(const ComputedStyle& style) const
{
