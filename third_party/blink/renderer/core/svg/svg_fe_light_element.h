...
public:
    ...
    absl::optional<bool> SetLightSourceAttribute(FELighting*, const QualifiedName&) const;
...
template <> inline bool IsElementOfType<const SVGFELightElement>(const Node& node)
{
