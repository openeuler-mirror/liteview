...
std::unique_ptr<SVGPathByteStream> BlendPathByteStreams(const SVGPathByteStream& from_stream, const SVGPathByteStream& to_stream, float progress)
{
    std::unique_ptr<SVGPathByteStream> result_stream = std::make_unique<SVGPathByteStream>();
...
std::unique_ptr<SVGPathByteStream> AddPathByteStreams(const SVGPathByteStream& from_stream, const SVGPathByteStream& by_stream, unsigned repeat_count = 1)
{
    std::unique_ptr<SVGPathByteStream> result_stream = std::make_unique<SVGPathByteStream>();
    SVGPathByteStreamBuilder builder(*result_stream);
    SVGPathByteStreamSource from_source(from_stream);
...
std::unique_ptr<SVGPathByteStream> ConditionallyAddPathByteStreams(
    std::unique_ptr<SVGPathByteStream> from_stream, const SVGPathByteStream& by_stream, unsigned repeat_count = 1)
{
...
SVGPropertyBase* SVGPath::CloneForAnimation(const String& value) const
{
    ...
    return MakeGarbageCollected<SVGPath>(*MakeGarbageCollected<CSSPathValue>(std::move(byte_stream)));
}
    ...
    const SVGPropertyBase* from_value, const SVGPropertyBase* to_value, const SVGPropertyBase* to_at_end_of_duration_value, const SVGElement*)
{
    ...
    std::unique_ptr<SVGPathByteStream> new_stream = BlendPathByteStreams(from_stream, to_stream, percentage);
