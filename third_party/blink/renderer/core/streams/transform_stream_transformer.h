...
public:
    ...
    virtual ScriptPromise Transform(v8::Local<v8::Value> chunk, TransformStreamDefaultController*, ExceptionState&) = 0;
    virtual ScriptPromise Flush(TransformStreamDefaultController*, ExceptionState&) = 0;
