...
v8::Local<v8::Promise> StreamThenPromise(
    v8::Local<v8::Context> context, v8::Local<v8::Promise> promise, ScriptFunction* on_fulfilled, ScriptFunction* on_rejected)
{
    ...
    if (!on_fulfilled) {
        ...
        result_maybe = promise->Then(context, on_fulfilled->V8Function(), on_rejected->V8Function());
    } else {
