...
ReadableStreamDefaultControllerWithScriptScope::ReadableStreamDefaultControllerWithScriptScope(ScriptState* script_state, ScriptValue controller)
    : script_state_(script_state)
{
    v8::Local<v8::Object> controller_object = controller.V8Value().As<v8::Object>();
...
void ReadableStreamDefaultControllerWithScriptScope::Enqueue(v8::Local<v8::Value> js_chunk) const
{
    ...
    ReadableStreamDefaultController::Enqueue(script_state_, controller_, js_chunk, exception_state);
