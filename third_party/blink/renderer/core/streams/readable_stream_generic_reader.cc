...
ScriptPromise ReadableStreamGenericReader::closed(ScriptState* script_state) const
{
...
ScriptPromise ReadableStreamGenericReader::cancel(ScriptState* script_state, ExceptionState& exception_state)
{
    return cancel(script_state, ScriptValue(script_state->GetIsolate(), v8::Undefined(script_state->GetIsolate())), exception_state);
}

ScriptPromise ReadableStreamGenericReader::cancel(ScriptState* script_state, ScriptValue reason, ExceptionState& exception_state)
{
    ...
    v8::Local<v8::Promise> result = GenericCancel(script_state, this, reason.V8Value());
...
void ReadableStreamGenericReader::GenericRelease(ScriptState* script_state, ReadableStreamGenericReader* reader)
{
    ...
    if (stream->state_ == ReadableStream::kReadable) {
        ...
        reader->closed_promise_->Reject(script_state,
            v8::Exception::TypeError(V8String(isolate,
        ...
        // TypeError exception.
        reader->closed_promise_ = StreamPromiseResolver::CreateRejectedAndSilent(script_state,
            v8::Exception::TypeError(V8String(isolate,
...
v8::Local<v8::Promise> ReadableStreamGenericReader::GenericCancel(ScriptState* script_state, ReadableStreamGenericReader* reader, v8::Local<v8::Value> reason)
{
...
void ReadableStreamGenericReader::GenericInitialize(ScriptState* script_state, ReadableStreamGenericReader* reader, ReadableStream* stream)
{
    ...
    case ReadableStream::kReadable:
        ...
        reader->closed_promise_ = MakeGarbageCollected<StreamPromiseResolver>(script_state);
        break;
    ...
    case ReadableStream::kClosed:
        ...
        reader->closed_promise_ = StreamPromiseResolver::CreateResolvedWithUndefined(script_state);
        break;
    ...
    case ReadableStream::kErrored:
        ...
        //    [[storedError]].
        reader->closed_promise_ = StreamPromiseResolver::CreateRejectedAndSilent(script_state, stream->GetStoredError(isolate));
