...
// bindings code.
class CORE_EXPORT StreamPromiseResolver final : public GarbageCollected<StreamPromiseResolver> {
public:
    ...
    static StreamPromiseResolver* CreateResolved(ScriptState*, v8::Local<v8::Value> value);
    ...
    static StreamPromiseResolver* CreateRejected(ScriptState*, v8::Local<v8::Value> reason);

    // Similar to CreateRejected but marks the promise as silent before rejecting.
    // https://crbug.com/1132506
    static StreamPromiseResolver* CreateRejectedAndSilent(ScriptState*, v8::Local<v8::Value> reason);
