...
class ByteLengthQueuingStrategySizeFunction final : public ScriptFunction::Callable {
public:
    static v8::Local<v8::Function> CreateFunction(ScriptState* script_state)
    {
        auto* self = MakeGarbageCollected<ScriptFunction>(script_state, MakeGarbageCollected<ByteLengthQueuingStrategySizeFunction>());
