...
public:
    ...
    virtual ScriptPromise Pull(ReadableByteStreamController* controller, ExceptionState&) = 0;

    virtual ScriptPromise Cancel(ExceptionState&) = 0;
    virtual ScriptPromise Cancel(v8::Local<v8::Value> reason, ExceptionState&) = 0;
