...
public:
    ...
    static ScriptPromise ExitFullscreen(Document&, ScriptState* state = nullptr, ExceptionState* exception_state = nullptr, bool ua_originated = false);
...
private:
    ...
    static void ContinueRequestFullscreen(Document&, Element&, FullscreenRequestType, const FullscreenOptions*, ScriptPromiseResolver* resolver, bool error);

    static void ContinueExitFullscreen(Document*, ScriptPromiseResolver* resolver, bool resize);
    ...
    public:
        PendingRequest(Element* element, FullscreenRequestType type, const FullscreenOptions* options, ScriptPromiseResolver* resolver);
