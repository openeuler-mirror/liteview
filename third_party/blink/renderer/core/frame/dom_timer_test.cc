...
class DOMTimerTestWithSetTimeoutWithout1MsClampPolicyOverride : public DOMTimerTest {
public:
    ...
    {
        DCHECK(!scoped_command_line_.GetProcessCommandLine()->HasSwitch(switches::kSetTimeoutWithout1MsClampPolicy));
        scoped_command_line_.GetProcessCommandLine()->AppendSwitchASCII(switches::kSetTimeoutWithout1MsClampPolicy,
            enabled ? switches::kSetTimeoutWithout1MsClampPolicy_ForceEnable : switches::kSetTimeoutWithout1MsClampPolicy_ForceDisable);
    }
...
TEST_F(DOMTimerTestWithSetTimeoutWithout1MsClampPolicyOverride, PolicyForceEnable)
{
    SetPolicyOverride(/* enabled = */ true);
    EXPECT_TRUE(blink::features::IsSetTimeoutWithoutClampEnabled());
}

TEST_F(DOMTimerTestWithSetTimeoutWithout1MsClampPolicyOverride, PolicyForceDisable)
{
    SetPolicyOverride(/* enabled = */ false);
    EXPECT_FALSE(blink::features::IsSetTimeoutWithoutClampEnabled());
}

class DOMTimerTestWithMaxUnthrottledTimeoutNestingLevelPolicyOverride : public DOMTimerTest {
public:
    ...
    void SetPolicyOverride(bool enabled)
    {
        DCHECK(!scoped_command_line_.GetProcessCommandLine()->HasSwitch(switches::kUnthrottledNestedTimeoutPolicy));
        scoped_command_line_.GetProcessCommandLine()->AppendSwitchASCII(switches::kUnthrottledNestedTimeoutPolicy,
            enabled ? switches::kUnthrottledNestedTimeoutPolicy_ForceEnable : switches::kUnthrottledNestedTimeoutPolicy_ForceDisable);
    }
...
TEST_F(DOMTimerTestWithMaxUnthrottledTimeoutNestingLevelPolicyOverride, PolicyForceEnable)
{
    SetPolicyOverride(/* enabled = */ true);
    EXPECT_TRUE(blink::features::IsMaxUnthrottledTimeoutNestingLevelEnabled());
}

TEST_F(DOMTimerTestWithMaxUnthrottledTimeoutNestingLevelPolicyOverride, PolicyForceDisable)
{
    SetPolicyOverride(/* enabled = */ false);
...
TEST_F(DOMTimerTest, setTimeout_ClampsAfter4Nestings)
{
    ...
    base::test::ScopedFeatureList feature_list;
    feature_list.InitAndDisableFeature(features::kMaxUnthrottledTimeoutNestingLevel);
...
TEST_F(DOMTimerTest, setTimeout_ClampsAfter5Nestings)
{
    ...
    base::test::ScopedFeatureList feature_list;
    feature_list.InitAndEnableFeatureWithParameters(features::kMaxUnthrottledTimeoutNestingLevel, { { "nesting", "6" } });
