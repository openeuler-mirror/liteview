...
private:
    ...
    void BindToHighPriorityReceiver(mojo::PendingReceiver<mojom::blink::HighPriorityLocalFrame> receiver);
    ...
    void RenderFallbackContentWithResourceTiming(mojom::blink::ResourceTimingInfoPtr timing, const String& server_timing_values) final;
    void BeforeUnload(bool is_reload, BeforeUnloadCallback callback) final;
    void MediaPlayerActionAt(const gfx::Point& window_point, blink::mojom::blink::MediaPlayerActionPtr action) final;
    void AdvanceFocusInFrame(mojom::blink::FocusType focus_type, const absl::optional<RemoteFrameToken>& source_frame_token) final;
    ...
    void PostMessageEvent(const absl::optional<RemoteFrameToken>& source_frame_token, const String& source_origin, const String& target_origin,
    ...
    void JavaScriptExecuteRequestForTests(
        const String& javascript, bool wants_result, bool has_user_gesture, int32_t world_id, JavaScriptExecuteRequestForTestsCallback callback) final;
    ...
    void UpdateOpener(const absl::optional<blink::FrameToken>& opener_routing_id) final;
    ...
    void SetNavigationApiHistoryEntriesForRestore(mojom::blink::NavigationApiHistoryEntryArraysPtr) final;
    ...
    void InstallCoopAccessMonitor(
        const FrameToken& accessed_window, network::mojom::blink::CrossOriginOpenerPolicyReporterParamsPtr coop_reporter_params) final;
    void OnPortalActivated(const PortalToken& portal_token, mojo::PendingAssociatedRemote<mojom::blink::Portal> portal,
    ...
    void ForwardMessageFromHost(BlinkTransferableMessage message, const scoped_refptr<const SecurityOrigin>& source_origin) final;
    ...
    void DispatchBeforeUnload(bool is_reload, mojom::blink::LocalFrame::BeforeUnloadCallback callback) final;
    ...
    // HeapMojoRemote<device::mojom::blink::DevicePostureProvider> device_posture_provider_service_{nullptr};
    ...
    // LocalFrameMojoHandler can be reused by multiple ExecutionContext.
    HeapMojoReceiver<mojom::blink::HighPriorityLocalFrame, LocalFrameMojoHandler> high_priority_frame_receiver_ { this, nullptr };
    // LocalFrameMojoHandler can be reused by multiple ExecutionContext.
    ...
    // LocalFrameMojoHandler can be reused by multiple ExecutionContext.
    //   HeapMojoReceiver<device::mojom::blink::DevicePostureProviderClient, LocalFrameMojoHandler> device_posture_receiver_{this, nullptr};
    //
    //   device::mojom::blink::DevicePostureType current_device_posture_ = device::mojom::blink::DevicePostureType::kContinuous;
    //
    //   std::unique_ptr<power_scheduler::PowerModeVoter> script_execution_power_mode_voter_;
};
