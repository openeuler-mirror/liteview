...
public:
    ...
    LocalFrame(LocalFrameClient*, Page&, FrameOwner*, Frame* parent, Frame* previous_sibling, FrameInsertType insert_type, const LocalFrameToken& frame_token,
        WindowAgentFactory* inheriting_agent_factory, InterfaceRegistry*, const base::TickClock* clock = base::DefaultTickClock::GetInstance());
    ...
    // used.
    void StartPrinting(const gfx::SizeF& page_size = gfx::SizeF(), const gfx::SizeF& original_page_size = gfx::SizeF(), float maximum_shrink_ratio = 0);
    ...
    gfx::SizeF ResizePageRectsKeepingRatio(const gfx::SizeF& original_size, const gfx::SizeF& expected_size) const;
    ...
    void SetPageAndTextZoomFactors(float page_zoom_factor, float text_zoom_factor);
    ...
    void UpdateViewportSegmentCSSEnvironmentVariables(const WebVector<gfx::Rect>& window_segments);
    ...
    void ForceSynchronousDocumentInstall(const AtomicString& mime_type, scoped_refptr<const SharedBuffer> data);
...
private:
    ...
    void SetPrinting(bool printing, const gfx::SizeF& page_size, const gfx::SizeF& original_page_size, float maximum_shrink_ratio);
    ...
    bool HasBlockingReasonsHelper(const mojom::blink::BackForwardCacheNotRestoredReasonsPtr&);
