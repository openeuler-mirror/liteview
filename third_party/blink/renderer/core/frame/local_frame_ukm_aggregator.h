...
#define SCOPED_UMA_AND_UKM_TIMER(aggregator, ukm_enum) auto scoped_ukm_hierarchical_timer = aggregator.GetScopedTimer(static_cast<size_t>(ukm_enum));
...
private:
    ...
    {
        static const MetricInitializationData data[] = { { "CompositingCommit", true }, { "CompositingInputs", true }, { "ImplCompositorCommit", true },
            { "IntersectionObservation", true }, { "IntersectionObservationInternalCount", true }, { "IntersectionObservationJavascriptCount", true },
            { "Paint", true }, { "PrePaint", true }, { "Style", true }, { "Layout", true }, { "HandleInputEvents", true }, { "Animate", true },
            { "UpdateLayers", false }, { "WaitForCommit", true }, { "DisplayLockIntersectionObserver", true }, { "JavascriptIntersectionObserver", true },
            { "LazyLoadIntersectionObserver", true }, { "MediaIntersectionObserver", true }, { "AnchorElementMetricsIntersectionObserver", true },
            { "UpdateViewportIntersection", true }, { "ForcedStyleAndLayout", true }, { "ContentDocumentUpdate", true }, { "HitTestDocumentUpdate", true },
            { "JavascriptDocumentUpdate", true }, { "ScrollDocumentUpdate", true }, { "ServiceDocumentUpdate", true }, { "UserDrivenDocumentUpdate", true },
            { "ParseStyleSheet", true }, { "Accessibility", true } };
...
public:
    ...
    void RecordEndOfFrameMetrics(base::TimeTicks start, base::TimeTicks end, cc::ActiveFrameSequenceTrackers trackers);
    ...
    void RecordForcedLayoutSample(DocumentUpdateReason reason, base::TimeTicks start, base::TimeTicks end);
...
private:
    ...
    void UpdateEventTimeAndUpdateSampleIfNeeded(cc::ActiveFrameSequenceTrackers trackers);
