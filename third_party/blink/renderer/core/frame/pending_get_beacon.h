...
public:
    static PendingGetBeacon* Create(ExecutionContext* context, const String& target_url);

    static PendingGetBeacon* Create(ExecutionContext* context, const String& target_url, PendingBeaconOptions* options);

    explicit PendingGetBeacon(ExecutionContext* context, const String& url, int32_t background_timeout, int32_t timeout, base::PassKey<PendingGetBeacon> key);
