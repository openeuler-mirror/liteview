...
TEST_F(LocalFrameBackForwardCacheTest, EvictionOnV8ExecutionAtMicrotask)
{
    ...
    frame->DomWindow()->GetAgent()->event_loop()->EnqueueMicrotask(
        base::BindOnce([](LocalFrame* frame) { ClassicScript::CreateUnspecifiedScript("console.log('hi');")->RunScript(frame->DomWindow()); }, frame));
