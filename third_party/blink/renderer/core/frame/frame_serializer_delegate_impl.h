...
public:
    ...
    FrameSerializerDelegateImpl(WebFrameSerializer::MHTMLPartsGenerationDelegate&, HeapHashSet<WeakMember<const Element>>&);
    FrameSerializerDelegateImpl(const FrameSerializerDelegateImpl&) = delete;
    FrameSerializerDelegateImpl& operator=(const FrameSerializerDelegateImpl&) = delete;
...
private:
    ...
    void GetCustomAttributesForImageElement(const HTMLImageElement&, Vector<Attribute>*);
