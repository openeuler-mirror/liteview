...
private:
    ...
    static ReportLocation CreateReportLocation(const String& file, absl::optional<uint32_t> line_number, absl::optional<uint32_t> column_number);
...
protected:
    ...
    explicit LocationReportBody(const String& source_file = g_empty_string, absl::optional<uint32_t> line_number = absl::nullopt,
...
public:
    ...
    absl::optional<uint32_t> lineNumber() const
    {
        return line_number_;
    }
    absl::optional<uint32_t> columnNumber() const
    {
