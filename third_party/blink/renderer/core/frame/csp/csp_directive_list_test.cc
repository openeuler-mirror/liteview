...
TEST_F(CSPDirectiveListTest, IsMatchingNoncePresent)
{
    ...
    for (const auto& test : cases) {
        ...
        EXPECT_EQ(test.expected,
            CSPDirectiveListAllowFromSource(*directive_list, csp.Get(), CSPDirectiveName::ScriptSrcElem, blocked_url, blocked_url,
                ResourceRequest::RedirectStatus::kNoRedirect, ReportingDisposition::kSuppressReporting, test.nonce));
...
TEST_F(CSPDirectiveListTest, AllowScriptFromSourceNoNonce)
{
    ...
    for (const auto& test : cases) {
        ...
        network::mojom::blink::ContentSecurityPolicyPtr directive_list = CreateList(test.list, ContentSecurityPolicyType::kReport);
        EXPECT_EQ(test.expected,
            CSPDirectiveListAllowFromSource(*directive_list, csp.Get(), CSPDirectiveName::ScriptSrcElem, script_src, script_src,
...
TEST_F(CSPDirectiveListTest, AllowFromSourceWithNonce)
{
    ...
    for (const auto& test : cases) {
        ...
        EXPECT_EQ(test.expected,
            CSPDirectiveListAllowFromSource(*directive_list, csp.Get(), CSPDirectiveName::ScriptSrcElem, resource, resource,
        ...
        EXPECT_EQ(test.expected,
            CSPDirectiveListAllowFromSource(*directive_list, csp.Get(), CSPDirectiveName::StyleSrcElem, resource, resource,
...
TEST_F(CSPDirectiveListTest, WorkerSrc)
{
    ...
    for (const auto& test : cases) {
        ...
        EXPECT_EQ(test.allowed,
            CSPDirectiveListAllowFromSource(*directive_list, csp.Get(), CSPDirectiveName::WorkerSrc, resource, resource,
    ...
    for (const auto& testCase : testCases) {
        ...
        EXPECT_EQ(testCase.allowed,
            CSPDirectiveListAllowFromSource(*testCase.directive_list, context, CSPDirectiveName::ScriptSrcElem, testCase.script_url, testCase.script_url,
                ResourceRequest::RedirectStatus::kNoRedirect, ReportingDisposition::kReport, testCase.script_nonce));
