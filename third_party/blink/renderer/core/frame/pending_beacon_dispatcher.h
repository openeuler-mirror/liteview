...
class CORE_EXPORT PendingBeaconDispatcher : public GarbageCollected<PendingBeaconDispatcher>,
...
public:
    ...
    explicit PendingBeaconDispatcher(ExecutionContext& ec, base::PassKey<PendingBeaconDispatcher> key);
...
private:
    ...
    FRIEND_TEST_ALL_PREFIXES(PendingBeaconDispatcherBasicBeaconsTest, DispatchBeaconsOnBackgroundTimeout);
    FRIEND_TEST_ALL_PREFIXES(PendingBeaconDispatcherBackgroundTimeoutBundledTest, DispatchOrderedBeacons);
    FRIEND_TEST_ALL_PREFIXES(PendingBeaconDispatcherBackgroundTimeoutBundledTest, DispatchReversedBeacons);
    FRIEND_TEST_ALL_PREFIXES(PendingBeaconDispatcherBackgroundTimeoutBundledTest, DispatchDuplicatedBeacons);
    FRIEND_TEST_ALL_PREFIXES(PendingBeaconDispatcherOnPagehideTest, OnPagehideUpdateAndUnregisterAllBeacons);
    ...
    FRIEND_TEST_ALL_PREFIXES(PendingBeaconSendTest, SetNonPendingAfterTimeoutTimerStart);
};
