...
public:
    ...
    void RecordWindowProxyAccessMetrics(mojom::blink::WebFeature property_access, mojom::blink::WebFeature property_access_from_other_page) const;
...
private:
    ...
    struct CoopAccessMonitor {
        ...
        mojo::Remote<network::mojom::blink::CrossOriginOpenerPolicyReporter> reporter;
