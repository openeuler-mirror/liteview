...
void RemoteFrameClientImpl::CreateRemoteChild(const RemoteFrameToken& token, const absl::optional<FrameToken>& opener_frame_token,
    ...
    mojom::blink::RemoteFrameInterfacesFromBrowserPtr remote_frame_interfaces)
{
    ...
    web_frame_->CreateRemoteChild(tree_scope_type, token, devtools_frame_token, opener, std::move(remote_frame_interfaces->frame_host),
        std::move(remote_frame_interfaces->frame_receiver), std::move(replication_state));
}
