...
public:
    ...
    void SetPaintArtifactCompositorNeedsUpdate(PaintArtifactCompositorUpdateReason);
    ...
    void MarkFixedPositionObjectsForLayout(bool width_changed, bool height_changed);
    ...
    void InvalidateBackgroundAttachmentFixedDescendantsOnScroll(const LayoutObject& scrolled_object);
    ...
    void ForceLayoutForPagination(const gfx::SizeF& page_size, const gfx::SizeF& original_page_size, float maximum_shrink_factor);
    ...
    {
        return layer_debug_info_enabled_ || RuntimeEnabledFeatures::PaintUnderInvalidationCheckingEnabled();
    }
...
private:
    ...
    bool RunAccessibilityLifecyclePhase(DocumentLifecycle::LifecycleState target_state);
    ...
    bool UpdateViewportIntersectionsForSubtree(unsigned parent_flags, absl::optional<base::TimeTicks>& monotonic_time) override;
    ...
    bool RunDocumentTransitionSteps(DocumentLifecycle::LifecycleState target_state);
    ...
    void ComputePostLayoutIntersections(unsigned parent_flags, absl::optional<base::TimeTicks>& monotonic_time);
    ...
    void GetUserScrollTranslationNodes(Vector<const TransformPaintPropertyNode*>& scroll_translation_nodes);
    ...
    void AppendDocumentTransitionRequests(WTF::Vector<std::unique_ptr<DocumentTransitionRequest>>&);
