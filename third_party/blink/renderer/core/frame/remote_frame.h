...
public:
    ...
    void DidChangeRootWindowSegments(const std::vector<gfx::Rect>& root_widget_window_segments);
    ...
    void CreateRemoteChild(const RemoteFrameToken& token, const absl::optional<FrameToken>& opener_frame_token, mojom::blink::TreeScopeType tree_scope_type,
        mojom::blink::FrameReplicationStatePtr replication_state, const base::UnguessableToken& devtools_frame_token,
        mojom::blink::RemoteFrameInterfacesFromBrowserPtr remote_frame_interfaces) override;
...
private:
    ...
    mojo::AssociatedReceiver<mojom::blink::RemoteMainFrame> main_frame_receiver_ { this };
