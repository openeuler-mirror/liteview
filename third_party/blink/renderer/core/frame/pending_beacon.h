...
class CORE_EXPORT PendingBeacon : public ScriptWrappable, public ExecutionContextLifecycleObserver, public PendingBeaconDispatcher::PendingBeacon {
...
protected:
    explicit PendingBeacon(ExecutionContext* context, const String& url, const String& method, int32_t background_timeout, int32_t timeout);

    void SetURLInternal(const String& url);
    void SetDataInternal(const BeaconData& beacon_data, ExceptionState& exception_state);
