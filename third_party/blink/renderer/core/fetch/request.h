...
class CORE_EXPORT Request final : public ScriptWrappable, public ActiveScriptWrappable<Request>, public Body {
...
public:
    ...
    static absl::optional<network::mojom::CredentialsMode> ParseCredentialsMode(const String& credentials_mode);
