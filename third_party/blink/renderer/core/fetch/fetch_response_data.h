...
public:
    ...
    void SetConnectionInfo(net::HttpResponseInfo::ConnectionInfo connection_info)
    {
    ...
    void SetAuthChallengeInfo(const absl::optional<net::AuthChallengeInfo>& auth_challenge_info);
