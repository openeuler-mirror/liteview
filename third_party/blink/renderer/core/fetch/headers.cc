...
class HeadersIterationSource final : public PairIterable<String, IDLString, String, IDLString>::IterationSource {
public:
    explicit HeadersIterationSource(const FetchHeaderList* headers)
        : headers_(headers->SortAndCombine())
        , current_(0)
    {
    }

    bool Next(ScriptState* script_state, String& key, String& value, ExceptionState& exception) override
    {
...
PairIterable<String, IDLString, String, IDLString>::IterationSource* Headers::StartIteration(ScriptState*, ExceptionState&)
{
