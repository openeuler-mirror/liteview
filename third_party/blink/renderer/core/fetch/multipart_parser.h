...
private:
    ...
    public:
        ...
        {
            return num_matched_bytes_ == size_;
        }
    ...
    bool ParseHeaderFields(const char** bytes_pointer, const char* bytes_end, HTTPHeaderMap* header_fields);
    void ParseTransportPadding(const char** bytes_pointer, const char* bytes_end) const;
