...
class CORE_EXPORT BodyStreamBuffer final : public UnderlyingSourceBase, public BytesConsumer::Client {
public:
    ...
    scoped_refptr<BlobDataHandle> DrainAsBlobDataHandle(BytesConsumer::BlobSizePolicy);
