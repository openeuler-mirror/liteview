...
public:
    ...
    static ScriptPromise getInitialResourcePriority(ScriptState*, WorkerInternals&, const String& url, WorkerGlobalScope*);

private:
    static void ResolveResourcePriority(ScriptPromiseResolver*, int resource_load_priority);
};
