...
public:
    ...
    explicit PolicyParserMessageBuffer(const String& prefix, bool discard_message = false)
        : prefix_(prefix)
...
using DocumentPolicyFeatureSet = HashSet<mojom::blink::DocumentPolicyFeature, DefaultHash<mojom::blink::DocumentPolicyFeature>::Hash,
...
// protocol.
String PermissionsPolicyFeatureToProtocol(mojom::blink::PermissionsPolicyFeature);
