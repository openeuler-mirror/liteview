...
TEST_F(PermissionsPolicyDevtoolsSupportSimTest, DetectNestedCrossOriginNoBlockage)
{
    ...
    EXPECT_TRUE(MainFrame().GetFrame()->GetSecurityContext()->IsFeatureEnabled(mojom::blink::PermissionsPolicyFeature::kFullscreen));
    EXPECT_TRUE(MainFrame().GetFrame()->FirstChild()->GetSecurityContext()->IsFeatureEnabled(mojom::blink::PermissionsPolicyFeature::kFullscreen));
    EXPECT_TRUE(
        MainFrame().GetFrame()->FirstChild()->FirstChild()->GetSecurityContext()->IsFeatureEnabled(mojom::blink::PermissionsPolicyFeature::kFullscreen));
