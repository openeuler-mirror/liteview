...
public:
    ...
    static absl::optional<DocumentPolicy::ParsedDocumentPolicy> Parse(const String& policy_string, PolicyParserMessageBuffer&);

    // Internal parsing method for testing.
    static absl::optional<DocumentPolicy::ParsedDocumentPolicy> ParseInternal(const String& policy_string, const DocumentPolicyNameFeatureMap& name_feature_map,
