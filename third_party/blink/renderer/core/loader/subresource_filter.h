...
public:
    ...
    bool AllowLoad(const KURL& resource_url, mojom::blink::RequestContextType, ReportingDisposition);
...
private:
    ...
    std::pair<std::pair<KURL, mojom::blink::RequestContextType>, WebDocumentSubresourceFilter::LoadPolicy> last_resource_check_result_;
};
