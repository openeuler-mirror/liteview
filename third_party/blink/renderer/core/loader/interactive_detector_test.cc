...
public:
    InteractiveDetectorTest()
    {
        ...
        detector_ = MakeGarbageCollected<InteractiveDetector>(*document, new NetworkActivityCheckerForTest(document));
...
TEST_F(InteractiveDetectorTest, FirstInputDelayForClickOnMobile)
{
    ...
    base::TimeTicks t0 = Now();
    // Pointerdown
    Event pointerdown(event_type_names::kPointerdown, MessageEvent::Bubbles::kYes, MessageEvent::Cancelable::kYes, MessageEvent::ComposedMode::kComposed, t0);
    ...
    // Pointerup
    Event pointerup(event_type_names::kPointerup, MessageEvent::Bubbles::kYes, MessageEvent::Cancelable::kYes, MessageEvent::ComposedMode::kComposed,
...
TEST_F(InteractiveDetectorTest, FirstInputDelayForClickOnDesktopWithFixEnabled)
{
    ...
    EXPECT_FALSE(detector->GetFirstInputDelay().has_value());
    // Mousedown
    Event mousedown(event_type_names::kMousedown, MessageEvent::Bubbles::kYes, MessageEvent::Cancelable::kYes, MessageEvent::ComposedMode::kComposed, t0);
