...
constexpr char kImageAcceptHeader[] = "image/avif,image/webp,image/apng,image/svg+xml,image/*,*/*;q=0.8";
#else
constexpr char kImageAcceptHeader[] = "image/webp,image/apng,image/svg+xml,image/*,*/*;q=0.8";
#endif
...
AlternateSignedExchangeResourceInfo::Entry* AlternateSignedExchangeResourceInfo::FindMatchingEntry(
    const KURL& url, absl::optional<ResourceType> resource_type, const Vector<String>& languages) const
{
...
AlternateSignedExchangeResourceInfo::Entry* AlternateSignedExchangeResourceInfo::FindMatchingEntry(
    const KURL& url, mojom::blink::RequestContextType request_context, const Vector<String>& languages) const
{
    const char* accept_header = kDefaultAcceptHeader;
