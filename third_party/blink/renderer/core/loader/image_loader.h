...
public:
    ...
    void UpdateFromElement(
        UpdateFromElementBehavior = kUpdateNormal, network::mojom::ReferrerPolicy = network::mojom::ReferrerPolicy::kDefault, bool force_blocking = false);
    ...
    {
        return image_complete_ && !pending_task_;
    }
    ...
    bool ShouldUpdateOnInsertedInto(
        ContainerNode& insertion_point, network::mojom::ReferrerPolicy referrer_policy = network::mojom::ReferrerPolicy::kDefault) const;
    ...
    // force_blocking ensures that the image will block the load event.
    void LoadDeferredImage(network::mojom::ReferrerPolicy, bool force_blocking = false, bool update_from_microtask = false);
...
private:
    ...
    // force_blocking ensures that the image will block the load event.
    void DoUpdateFromElement(scoped_refptr<const DOMWrapperWorld> world, UpdateFromElementBehavior,
        network::mojom::ReferrerPolicy = network::mojom::ReferrerPolicy::kDefault, UpdateType = UpdateType::kAsync, bool force_blocking = false);
    ...
    void EnqueueImageLoadingMicroTask(UpdateFromElementBehavior, network::mojom::ReferrerPolicy);
    ...
    network::mojom::ReferrerPolicy last_referrer_policy_ = network::mojom::ReferrerPolicy::kDefault;
