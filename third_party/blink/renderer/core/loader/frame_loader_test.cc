...
class UserAgentOverrideWebFrameClient : public frame_test_helpers::TestWebFrameClient {
public:
    UserAgentOverrideWebFrameClient() = default;

    WebString UserAgentOverride() override
    {
...
TEST_F(FrameLoaderTest, PolicyContainerIsStoredOnCommitNavigation)
{
    ...
    EXPECT_EQ(*mojom::blink::PolicyContainerPolicies::New(network::mojom::CrossOriginEmbedderPolicyValue::kNone, network::mojom::ReferrerPolicy::kAlways,
...
public:
    void SetUp() override
    {
        ...
        scoped_feature_list_.InitAndEnableFeature(blink::features::kUserAgentOverrideExperiment);
    }
