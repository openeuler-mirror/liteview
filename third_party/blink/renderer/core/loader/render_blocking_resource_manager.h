...
public:
    ...
    {
        return pending_stylesheet_owner_nodes_.size() || pending_scripts_.size() || pending_preloads_.size() || imperative_font_loading_count_;
    }
...
private:
    ...
    HeapHashMap<WeakMember<const PendingLinkPreload>, PreloadType> pending_preloads_;
