...
// modified.
enum class InputEventType { kMousedown = 0, kClick = 1, kKeydown = 2, kPointerup = 3 };
...
public:
    ...
    WTF::Vector<absl::optional<base::TimeDelta>> GetFirstInputDelaysAfterBackForwardCacheRestore() const;
    ...
    void RecordInputEventTimingUKM(
        base::TimeDelta input_delay, base::TimeDelta processing_time, base::TimeDelta time_to_next_paint, WTF::AtomicString event_type);
...
private:
    ...
    struct {
        ...
        WTF::Vector<absl::optional<base::TimeDelta>> first_input_delays_after_back_forward_cache_restore;
    } page_event_times_;
    ...
    void UpdateNetworkQuietState(double request_count, absl::optional<base::TimeTicks> current_time);
