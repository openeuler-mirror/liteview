...
public:
    ModuleScriptCreationParams(const KURL& source_url, const KURL& base_url, ScriptSourceLocationType source_location_type, const ModuleType module_type,
        const ParkableString& source_text, CachedMetadataHandler* cache_handler, ScriptStreamer* script_streamer = nullptr,
    ...
    ModuleScriptCreationParams IsolatedCopy() const
    {
        ...
        return ModuleScriptCreationParams(SourceURL(), BaseURL(), source_location_type_, GetModuleType(), isolated_source_text);
    }
