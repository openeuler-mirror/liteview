...
public:
    ...
    std::unique_ptr<WebURLLoader> MaybeCreateURLLoader(const WebURLRequest& request);
...
private:
    ...
    void TriggerLoad();
    std::unique_ptr<WebURLLoader> CreateDefaultURLLoader(const WebURLRequest& request);
