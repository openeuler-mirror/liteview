...
TEST_F(AlternateSignedExchangeResourceInfoTest, Simple)
{
    ...
    EXPECT_EQ(resource.get(), info->FindMatchingEntry(KURL("https://publisher.example/script.js"), absl::nullopt, { "en" }));
    EXPECT_EQ(nullptr, info->FindMatchingEntry(KURL("https://publisher.example/image"), absl::nullopt, { "en" }));
}
...
TEST_F(AlternateSignedExchangeResourceInfoTest, MultipleResources)
{
    ...
    }
    {
        ...
        EXPECT_TRUE(resource->variants().empty());
        EXPECT_TRUE(resource->variant_key().empty());
        EXPECT_EQ(resource.get(), info->FindMatchingEntry(KURL("https://publisher.example/image"), absl::nullopt, { "en" }));
    }
}
...
TEST_F(AlternateSignedExchangeResourceInfoTest, Variants)
{
    ...
    }
    {
        ...
        EXPECT_EQ(resource.get(), info->FindMatchingEntry(KURL("https://publisher.example/image"), mojom::blink::RequestContextType::IMAGE, { "en" }));
    }
}
