...
RenderBlockingResourceManager::RenderBlockingResourceManager(Document& document)
    : document_(document)
    , font_preload_timer_(document.GetTaskRunner(TaskType::kInternalFrameLifecycleControl), this, &RenderBlockingResourceManager::FontPreloadingTimerFired)
    , font_preload_timeout_(kMaxRenderingDelayForFontPreloads)
{
}

void RenderBlockingResourceManager::AddPendingPreload(const PendingLinkPreload& link, PreloadType type)
{
...
void RenderBlockingResourceManager::RemovePendingPreload(const PendingLinkPreload& link)
{
