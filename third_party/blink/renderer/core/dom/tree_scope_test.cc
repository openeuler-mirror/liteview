...
TEST_F(TreeScopeTest, CommonAncestorOfSameTrees)
{
    ...
    ShadowRoot& shadow_root = GetBody()->AttachShadowRootInternal(ShadowRootType::kOpen);
...
TEST_F(TreeScopeTest, CommonAncestorOfSiblingTrees)
{
    ...
    ShadowRoot& shadow_root_a = div_a->AttachShadowRootInternal(ShadowRootType::kOpen);
    ShadowRoot& shadow_root_b = div_b->AttachShadowRootInternal(ShadowRootType::kOpen);
...
TEST_F(TreeScopeTest, CommonAncestorOfTreesAtDifferentDepths)
{
    ...
    ShadowRoot& shadow_root_y = div_y->AttachShadowRootInternal(ShadowRootType::kOpen);
    ShadowRoot& shadow_root_b = div_b->AttachShadowRootInternal(ShadowRootType::kOpen);

    Element* div_in_y = GetDocument()->CreateRawElement(html_names::kDivTag);
    shadow_root_y.AppendChild(div_in_y);
    ShadowRoot& shadow_root_a = div_in_y->AttachShadowRootInternal(ShadowRootType::kOpen);
