...
using CSSToggleMapMaplike = Maplike<AtomicString, IDLString, Member<CSSToggle>, CSSToggle>;

class CORE_EXPORT CSSToggleMap : public ScriptWrappable, public CSSToggleMapMaplike {
...
public:
    ...
    CSSToggleMap* set(const AtomicString& key, CSSToggle* value, ExceptionState& exception_state);
...
private:
    bool GetMapEntry(ScriptState*, const AtomicString& key, Member<CSSToggle>& value, ExceptionState&) final;
    CSSToggleMapMaplike::IterationSource* StartIteration(ScriptState*, ExceptionState&) final;
    ...
    public:
        ...
        bool Next(ScriptState*, AtomicString&, Member<CSSToggle>&, ExceptionState&) override;
