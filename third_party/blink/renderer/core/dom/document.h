...
public:
    ...
    {
        return document_classes_ & kHTMLDocumentClass;
    }
    ...
    {
        return document_classes_ & kXMLDocumentClass;
    }
    ...
    {
        return document_classes_ & kSVGDocumentClass;
    }
    ...
    {
        ++layout_calls_counter_;
    }
    void IncLayoutCallsCounterNG()
    {
        ++layout_calls_counter_ng_;
    }
    void IncLayoutBlockCounter()
    {
        ++layout_blocks_counter_;
    }
    void IncLayoutBlockCounterNG()
    {
        ++layout_blocks_counter_ng_;
    }
    ...
    {
        return web_bundle_claimed_url_;
    }
    ...
    {
        annotated_regions_dirty_ = f;
    }
    bool AnnotatedRegionsDirty() const
    {
        return annotated_regions_dirty_;
    }
    bool HasAnnotatedRegions() const
    {
        return has_annotated_regions_;
    }
    void SetHasAnnotatedRegions(bool f)
    {
        has_annotated_regions_ = f;
    }
    ...
    {
        return popup_hint_showing_;
    }
    void SetPopupHintShowing(Element* element)
    {
        popup_hint_showing_ = element;
    }
    HeapVector<Member<Element>>& PopupStack()
    {
        return popup_stack_;
    }
    const HeapVector<Member<Element>>& PopupStack() const
    {
        return popup_stack_;
    }
    bool PopupAutoShowing() const
    {
        return !popup_stack_.empty();
    }
    ...
    {
        return template_document_host_;
    }
    ...
    {
        return dir_attribute_dirty_;
    }
    void SetDirAttributeDirty()
    {
        dir_attribute_dirty_ = true;
    }
...
private:
    ...
    public:
        PendingJavascriptUrl(const KURL& input_url, scoped_refptr<const DOMWrapperWorld> world);
    ...
    HeapVector2<Member<Element>> top_layer_elements222_;
    ...
    using EventNodePathCache = HeapHashMap<Member<Node>, Member<EventPath::NodePath>>;
    ...
    HeapHashMap<WeakMember<Element>, Member<ExplicitlySetAttrElementsMap>> element_explicitly_set_attr_elements_map_;

    HeapObserverSet<SynchronousMutationObserver> synchronous_mutation_observer_set_;
