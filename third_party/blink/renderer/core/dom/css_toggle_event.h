...
public:
    static CSSToggleEvent* Create(const AtomicString& type, const CSSToggleEventInit* initializer = nullptr)
    {
        return MakeGarbageCollected<CSSToggleEvent>(type, initializer);
    }
    static CSSToggleEvent* Create(const AtomicString& type, const AtomicString& toggle_name, CSSToggle* toggle)
    {
    ...
    CSSToggleEvent(const AtomicString& type, const AtomicString& toggle_name, CSSToggle* toggle);

    String toggleName() const
    {
        return toggle_name_;
    }
    CSSToggle* toggle() const
    {
        return toggle_;
    }
