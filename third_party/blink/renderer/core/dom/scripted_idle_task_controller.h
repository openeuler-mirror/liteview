...
public:
    ...
    {
        ScriptedIdleTaskController* controller = MakeGarbageCollected<ScriptedIdleTaskController>(context);
    ...
    void CallbackFired(CallbackId, base::TimeTicks deadline, IdleDeadline::CallbackType);
...
private:
    ...
    void ScheduleCallback(scoped_refptr<internal::IdleRequestCallbackWrapper>, uint32_t timeout_millis);
    ...
    void RunCallback(CallbackId, base::TimeTicks deadline, IdleDeadline::CallbackType);
