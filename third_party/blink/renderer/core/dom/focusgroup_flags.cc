...
FocusgroupFlags ParseFocusgroup(const Element* element, const AtomicString& input)
{
    ...
    if (!invalid_tokens.empty()) {
        element->GetDocument().AddConsoleMessage(MakeGarbageCollected<ConsoleMessage>(mojom::blink::ConsoleMessageSource::kOther,
            mojom::blink::ConsoleMessageLevel::kError, WebString::FromUTF8("Unrecognized focusgroup attribute values: " + invalid_tokens.ToString().Ascii())));
    }
            ...
            if (ancestor_flags & FocusgroupFlags::kGrid) {
                element->GetDocument().AddConsoleMessage(
                    MakeGarbageCollected<ConsoleMessage>(mojom::blink::ConsoleMessageSource::kOther, mojom::blink::ConsoleMessageLevel::kError,
                        WebString::FromUTF8("Focusgroup attribute value 'extend' present, "
    ...
    if (has_grid) {
        if (has_extend) {
            element->GetDocument().AddConsoleMessage(
                MakeGarbageCollected<ConsoleMessage>(mojom::blink::ConsoleMessageSource::kOther, mojom::blink::ConsoleMessageLevel::kError,
                    WebString::FromUTF8("Focusgroup attribute values 'extend' and 'grid' present, "
        ...
        if (has_wrap) {
            flags |= FocusgroupFlags::kWrapHorizontally | FocusgroupFlags::kWrapVertically;
            if (has_row_wrap) {
                element->GetDocument().AddConsoleMessage(
                    MakeGarbageCollected<ConsoleMessage>(mojom::blink::ConsoleMessageSource::kOther, mojom::blink::ConsoleMessageLevel::kWarning,
                        WebString::FromUTF8("Focusgroup attribute value 'row-wrap' present, but can be "
                                            "omitted because focusgroup already wraps in both axes.")));
            }
            if (has_col_wrap) {
                element->GetDocument().AddConsoleMessage(
                    MakeGarbageCollected<ConsoleMessage>(mojom::blink::ConsoleMessageSource::kOther, mojom::blink::ConsoleMessageLevel::kWarning,
                        WebString::FromUTF8("Focusgroup attribute value 'col-wrap' present, but can be "
                                            "omitted because focusgroup already wraps in both axes.")));
            }
        } else {
            if (has_row_wrap)
            ...
            if (has_row_wrap && has_col_wrap) {
                element->GetDocument().AddConsoleMessage(
                    MakeGarbageCollected<ConsoleMessage>(mojom::blink::ConsoleMessageSource::kOther, mojom::blink::ConsoleMessageLevel::kWarning,
                        WebString::FromUTF8("Focusgroup attribute values 'row-wrap col-wrap' should be "
                                            "replaced by 'wrap'.")));
            }
        }

        if (has_flow) {
            if (flags & FocusgroupFlags::kWrapHorizontally || flags & FocusgroupFlags::kWrapVertically) {
                element->GetDocument().AddConsoleMessage(
                    MakeGarbageCollected<ConsoleMessage>(mojom::blink::ConsoleMessageSource::kOther, mojom::blink::ConsoleMessageLevel::kError,
                        WebString::FromUTF8("Focusgroup attribute value 'flow' present, "
                ...
                if (has_row_flow) {
                    element->GetDocument().AddConsoleMessage(
                        MakeGarbageCollected<ConsoleMessage>(mojom::blink::ConsoleMessageSource::kOther, mojom::blink::ConsoleMessageLevel::kWarning,
                            WebString::FromUTF8("Focusgroup attribute value 'row-flow' present, but can be "
                                                "omitted because focusgroup already flows in both axes.")));
                }
                if (has_col_flow) {
                    element->GetDocument().AddConsoleMessage(
                        MakeGarbageCollected<ConsoleMessage>(mojom::blink::ConsoleMessageSource::kOther, mojom::blink::ConsoleMessageLevel::kWarning,
                            WebString::FromUTF8("Focusgroup attribute value 'col-flow' present, but can be "
                                                "omitted because focusgroup already flows in both axes.")));
                }
            }
        } else {
            if (has_row_flow) {
                if (flags & FocusgroupFlags::kWrapHorizontally) {
                    element->GetDocument().AddConsoleMessage(
                        MakeGarbageCollected<ConsoleMessage>(mojom::blink::ConsoleMessageSource::kOther, mojom::blink::ConsoleMessageLevel::kError,
                            WebString::FromUTF8("Focusgroup attribute value 'row-flow' present, "
            ...
            if (has_col_flow) {
                if (flags & FocusgroupFlags::kWrapVertically) {
                    element->GetDocument().AddConsoleMessage(
                        MakeGarbageCollected<ConsoleMessage>(mojom::blink::ConsoleMessageSource::kOther, mojom::blink::ConsoleMessageLevel::kError,
                            WebString::FromUTF8("Focusgroup attribute value 'col-flow' present, "
            ...
            if (flags & FocusgroupFlags::kRowFlow && flags & FocusgroupFlags::kColFlow) {
                element->GetDocument().AddConsoleMessage(
                    MakeGarbageCollected<ConsoleMessage>(mojom::blink::ConsoleMessageSource::kOther, mojom::blink::ConsoleMessageLevel::kWarning,
                        WebString::FromUTF8("Focusgroup attribute values 'row-flow col-flow' should be "
                                            "replaced by 'flow'.")));
            }
        }
        ...
        if (has_horizontal) {
            element->GetDocument().AddConsoleMessage(
                MakeGarbageCollected<ConsoleMessage>(mojom::blink::ConsoleMessageSource::kOther, mojom::blink::ConsoleMessageLevel::kError,
                    WebString::FromUTF8("Focusgroup attribute value 'horizontal' present, "
                                        "but no has no effect on grid focusgroups.")));
        }
        if (has_vertical) {
            element->GetDocument().AddConsoleMessage(
                MakeGarbageCollected<ConsoleMessage>(mojom::blink::ConsoleMessageSource::kOther, mojom::blink::ConsoleMessageLevel::kError,
                    WebString::FromUTF8("Focusgroup attribute value 'vertical' present, "
                                        "but no has no effect on grid focusgroups.")));
        }
    ...
    if (has_row_wrap) {
        element->GetDocument().AddConsoleMessage(
            MakeGarbageCollected<ConsoleMessage>(mojom::blink::ConsoleMessageSource::kOther, mojom::blink::ConsoleMessageLevel::kError,
                WebString::FromUTF8("Focusgroup attribute value 'row-wrap' present, "
                                    "but no has no effect on linear focusgroups.")));
    }
    if (has_col_wrap) {
        element->GetDocument().AddConsoleMessage(
            MakeGarbageCollected<ConsoleMessage>(mojom::blink::ConsoleMessageSource::kOther, mojom::blink::ConsoleMessageLevel::kError,
                WebString::FromUTF8("Focusgroup attribute value 'col-wrap' present, "
                                    "but no has no effect on linear focusgroups.")));
    }
    if (has_flow) {
        element->GetDocument().AddConsoleMessage(
    ...
    if (has_horizontal && has_vertical) {
        element->GetDocument().AddConsoleMessage(
            MakeGarbageCollected<ConsoleMessage>(mojom::blink::ConsoleMessageSource::kOther, mojom::blink::ConsoleMessageLevel::kWarning,
                WebString::FromUTF8("'horizontal' and 'vertical' focusgroup attribute values used "
    ...
    if (has_wrap) {
        if (flags & FocusgroupFlags::kExtend) {
            bool extends_horizontally = flags & FocusgroupFlags::kHorizontal && ancestor_flags & FocusgroupFlags::kHorizontal;
            if (!extends_horizontally && flags & FocusgroupFlags::kHorizontal) {
                flags |= FocusgroupFlags::kWrapHorizontally;
            }
            bool extends_vertically = flags & FocusgroupFlags::kVertical && ancestor_flags & FocusgroupFlags::kVertical;
            ...
            if (extends_horizontally && extends_vertically) {
                element->GetDocument().AddConsoleMessage(
                    MakeGarbageCollected<ConsoleMessage>(mojom::blink::ConsoleMessageSource::kOther, mojom::blink::ConsoleMessageLevel::kWarning,
                        WebString::FromUTF8("Focusgroup attribute value 'wrap' present but ignored. 'wrap' "
    ...
    if (flags & FocusgroupFlags::kExtend) {
        ...
        if ((flags & FocusgroupFlags::kWrapHorizontally) == (ancestor_flags & FocusgroupFlags::kWrapHorizontally)
            && (flags & FocusgroupFlags::kWrapVertically) == (ancestor_flags & FocusgroupFlags::kWrapVertically)) {
            element->GetDocument().AddConsoleMessage(
                MakeGarbageCollected<ConsoleMessage>(mojom::blink::ConsoleMessageSource::kOther, mojom::blink::ConsoleMessageLevel::kWarning,
                    WebString::FromUTF8("Focusgroup attribute value 'wrap' present but ignored. 'wrap' "
