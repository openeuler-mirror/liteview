...
CSSToggleEvent::CSSToggleEvent(const AtomicString& type, const CSSToggleEventInit* init)
    : Event(type, init)
{
    if (init) {
...
CSSToggleEvent::CSSToggleEvent(const AtomicString& type, const AtomicString& toggle_name, CSSToggle* toggle)
