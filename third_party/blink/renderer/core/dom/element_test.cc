...
TEST_F(ElementTest, SupportsFocus)
{
    ...
    EXPECT_TRUE(document.documentElement()->SupportsFocus()) << "<html> with designMode=on should be focusable.";
}
...
TEST_F(ElementTest, StickySubtreesAreTrackedCorrectly)
{
    ...
    LayoutObject* ancestor = document.getElementById("ancestor")->GetLayoutObject();
    LayoutObject* outer_sticky = document.getElementById("outerSticky")->GetLayoutObject();
    LayoutObject* child = document.getElementById("child")->GetLayoutObject();
    LayoutObject* grandchild = document.getElementById("grandchild")->GetLayoutObject();
    LayoutObject* inner_sticky = document.getElementById("innerSticky")->GetLayoutObject();
    LayoutObject* great_grandchild = document.getElementById("greatGrandchild")->GetLayoutObject();
    ...
    document.getElementById("child")->SetInlineStyleProperty(CSSPropertyID::kWebkitRubyPosition, CSSValueID::kAfter);
    UpdateAllLifecyclePhasesForTest();
    ...
    EXPECT_EQ(RubyPosition::kAfter, great_grandchild->StyleRef().GetRubyPosition());
    ...
    document.getElementById("outerSticky")->SetInlineStyleProperty(CSSPropertyID::kPosition, CSSValueID::kStatic);
    UpdateAllLifecyclePhasesForTest();
    EXPECT_EQ(DocumentLifecycle::kPaintClean, document.Lifecycle().GetState());
...
TEST_F(ElementTest, ExportpartsAttribute)
{
...

    {
        ...
        ASSERT_EQ("partname2", part_names_map->Get("partname1").value().SerializeToString());
    }

    {
        ...
        ASSERT_EQ("partname2", part_names_map->Get("partname1").value().SerializeToString());
        ASSERT_EQ("partname4", part_names_map->Get("partname3").value().SerializeToString());
    }
...
TEST_F(ElementTest, CreateAndAttachShadowRootSuspendsPluginDisposal)
{
    ...
    auto* plugin_element = DynamicTo<HTMLPlugInElement>(document.getElementById("plugin"));
...
TEST_F(ElementTest, ParseFocusgroupAttrGrid)
{
    ...
    ASSERT_EQ(e3_flags, (FocusgroupFlags::kGrid | FocusgroupFlags::kWrapHorizontally | FocusgroupFlags::kWrapVertically));
    ASSERT_EQ(e4_flags, (FocusgroupFlags::kGrid | FocusgroupFlags::kWrapHorizontally));
    ASSERT_EQ(e5_flags, (FocusgroupFlags::kGrid | FocusgroupFlags::kWrapVertically));
    ASSERT_EQ(e6_flags, (FocusgroupFlags::kGrid | FocusgroupFlags::kWrapHorizontally | FocusgroupFlags::kWrapVertically));
    ...
    ASSERT_EQ(e11_flags, (FocusgroupFlags::kGrid | FocusgroupFlags::kWrapHorizontally));
    ASSERT_EQ(e12_flags, (FocusgroupFlags::kGrid | FocusgroupFlags::kWrapHorizontally | FocusgroupFlags::kColFlow));
    ASSERT_EQ(e13_flags, (FocusgroupFlags::kGrid | FocusgroupFlags::kWrapVertically));
    ASSERT_EQ(e14_flags, (FocusgroupFlags::kGrid | FocusgroupFlags::kWrapVertically | FocusgroupFlags::kRowFlow));
    ASSERT_EQ(e15_flags, FocusgroupFlags::kNone);
    ASSERT_EQ(e16_flags, (FocusgroupFlags::kHorizontal | FocusgroupFlags::kVertical));
}
