...
TEST_F(WhitespaceAttacherTest, WhitespaceAfterReattachedBlock)
{
    ...
    text->SetLayoutObject(text->CreateTextLayoutObject(GetDocument().body()->ComputedStyleRef(), LegacyLayout::kAuto));
...
TEST_F(WhitespaceAttacherTest, WhitespaceAfterReattachedWhitespace)
{
    ...
    second_whitespace->SetLayoutObject(second_whitespace->CreateTextLayoutObject(GetDocument().body()->ComputedStyleRef(), LegacyLayout::kAuto));
...
TEST_F(WhitespaceAttacherTest, ReattachWhitespaceInsideBlockExitingScope)
{
...

    {
        ...
        // Force LayoutText to see that the reattach works.
        text->SetLayoutObject(text->CreateTextLayoutObject(div->ComputedStyleRef(), LegacyLayout::kAuto));
    }
    EXPECT_FALSE(text->GetLayoutObject());
}
...
TEST_F(WhitespaceAttacherTest, SlottedWhitespaceAfterReattachedBlock)
{
    ...
    // Force LayoutText to see that the reattach works.
    text->SetLayoutObject(text->CreateTextLayoutObject(host->ComputedStyleRef(), LegacyLayout::kAuto));
...
TEST_F(WhitespaceAttacherTest, WhitespaceInDisplayContentsAfterReattachedBlock)
{
    ...
    // Force LayoutText to see that the reattach works.
    text->SetLayoutObject(text->CreateTextLayoutObject(contents->ComputedStyleRef(), LegacyLayout::kAuto));
