...
PopupAnimationFinishedEventListener::PopupAnimationFinishedEventListener(Member<Element> popup_element, HeapHashSet<Member<EventTarget>>&& animations)
    : popup_element_(popup_element)
...
PopupAnimationFinishedEventListener::~PopupAnimationFinishedEventListener() = default;
...
void PopupAnimationFinishedEventListener::RemoveEventListeners(EventTarget* animation) const
{
...
void PopupAnimationFinishedEventListener::Invoke(ExecutionContext*, Event* event)
{
    DCHECK(!animations_.empty());
    DCHECK(event->type() == event_type_names::kFinish || event->type() == event_type_names::kCancel);
