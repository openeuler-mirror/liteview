...
public:
    LayoutTreeBuilderForElement(Element&, Node::AttachContext&, const ComputedStyle*, LegacyLayout legacy);
...
private:
    scoped_refptr<ComputedStyle> CreateInlineWrapperStyleForDisplayContentsIfNeeded() const;
    LayoutObject* CreateInlineWrapperForDisplayContentsIfNeeded(ComputedStyle* wrappter_style) const;
};
