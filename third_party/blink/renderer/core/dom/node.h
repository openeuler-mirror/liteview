...
public:
    ...
    void setDistributeScroll(V8ScrollStateCallback*, const String& native_scroll_behavior);
    void setApplyScroll(V8ScrollStateCallback*, const String& native_scroll_behavior);
    ...
    {
        return GetFlag(kHasEventTargetDataFlag);
    }
    ...
    {
        return HasRareData() ? DataAsNodeRareData()->GetNodeRenderingData()->GetLayoutObject() : DataAsNodeRenderingData()->GetLayoutObject();
    }
    ...
    const ComputedStyle* EnsureComputedStyle(PseudoId pseudo_element_specifier = kPseudoIdNone, const AtomicString& pseudo_argument = g_null_atom)
    {
        return VirtualEnsureComputedStyle(pseudo_element_specifier, pseudo_argument);
    }
...
private:
    ...
    virtual const ComputedStyle* VirtualEnsureComputedStyle(PseudoId = kPseudoIdNone, const AtomicString& pseudo_argument = g_null_atom);
