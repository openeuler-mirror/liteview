...
inline void TransitionPseudoElementData::ClearPseudoElements()
{
    ...
    SetPseudoElement(
        kPseudoIdPageTransitionImageWrapper, nullptr, transition_image_wrapper_ ? transition_image_wrapper_->document_transition_tag() : g_null_atom);
    SetPseudoElement(
        kPseudoIdPageTransitionOutgoingImage, nullptr, transition_outgoing_image_ ? transition_outgoing_image_->document_transition_tag() : g_null_atom);
    SetPseudoElement(
        kPseudoIdPageTransitionIncomingImage, nullptr, transition_incoming_image_ ? transition_incoming_image_->document_transition_tag() : g_null_atom);
...
inline void TransitionPseudoElementData::SetPseudoElement(PseudoId pseudo_id, PseudoElement* element, const AtomicString& document_transition_tag)
{
    ...
    case kPseudoIdPageTransitionImageWrapper:
        DCHECK(!element || element->document_transition_tag() == document_transition_tag);
        DCHECK(!transition_image_wrapper_ || transition_image_wrapper_->document_transition_tag() == document_transition_tag);
    ...
    case kPseudoIdPageTransitionOutgoingImage:
        DCHECK(!element || element->document_transition_tag() == document_transition_tag);
        DCHECK(!transition_outgoing_image_ || transition_outgoing_image_->document_transition_tag() == document_transition_tag);
    ...
    case kPseudoIdPageTransitionIncomingImage:
        DCHECK(!element || element->document_transition_tag() == document_transition_tag);
        DCHECK(!transition_incoming_image_ || transition_incoming_image_->document_transition_tag() == document_transition_tag);
    ...
    case kPseudoIdPageTransitionContainer: {
        ...
        previous_element = it == transition_containers_.end() ? nullptr : it->value;
        if (element) {
...
inline PseudoElement* TransitionPseudoElementData::GetPseudoElement(PseudoId pseudo_id, const AtomicString& document_transition_tag) const
{
    if (kPseudoIdPageTransition == pseudo_id)
        return transition_;
    if (kPseudoIdPageTransitionImageWrapper == pseudo_id) {
        DCHECK(document_transition_tag);
        if (transition_image_wrapper_ && transition_image_wrapper_->document_transition_tag() == document_transition_tag) {
    ...
    if (kPseudoIdPageTransitionOutgoingImage == pseudo_id) {
        DCHECK(document_transition_tag);
        if (transition_outgoing_image_ && transition_outgoing_image_->document_transition_tag() == document_transition_tag) {
    ...
    if (kPseudoIdPageTransitionIncomingImage == pseudo_id) {
        DCHECK(document_transition_tag);
        if (transition_incoming_image_ && transition_incoming_image_->document_transition_tag() == document_transition_tag) {
