...
template <typename CharacterType> inline void SpaceSplitString::Data::CreateVector(const AtomicString& source, const CharacterType* characters, unsigned length)
{
...
scoped_refptr<SpaceSplitString::Data> SpaceSplitString::Data::Create(const AtomicString& string)
{
...
scoped_refptr<SpaceSplitString::Data> SpaceSplitString::Data::CreateUnique(const Data& other)
{
