...
protected:
    void SetUp() override
    {
        ...
        const base::TickClock* test_clock = platform()->test_task_runner()->GetMockTickClock();
    ...
    {
        platform()->AdvanceClock(base::Milliseconds(1));
        GetPaintTiming().ReportPresentationTime(PaintEvent::kFirstContentfulPaint, Now());
    }
    ...
    {
        Detector().ReportPresentationTime(PaintEvent::kProvisionalFirstMeaningfulPaint, timestamp);
    }
