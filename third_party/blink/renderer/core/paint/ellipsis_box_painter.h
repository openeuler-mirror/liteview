...
public:
    ...
    void Paint(const PaintInfo&, const PhysicalOffset&, LayoutUnit line_top, LayoutUnit line_bottom);

private:
    void PaintEllipsis(const PaintInfo&, const PhysicalOffset& paint_offset, LayoutUnit line_top, LayoutUnit line_bottom, const ComputedStyle&);
