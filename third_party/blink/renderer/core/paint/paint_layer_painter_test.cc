...
TEST_P(PaintLayerPainterTest, CachedSubsequenceAndChunksWithoutBackgrounds)
{
    ...
    EXPECT_THAT(chunks,
        ElementsAre(VIEW_SCROLLING_BACKGROUND_CHUNK_COMMON,
            ...
            IsPaintChunk(1, 1, PaintChunk::Id(container->Id(), DisplayItem::kScrollHitTest), container_properties, &scroll_hit_test, gfx::Rect(0, 0, 150, 150)),
    ...
    EXPECT_THAT(ContentPaintChunks(),
        ElementsAre(VIEW_SCROLLING_BACKGROUND_CHUNK_COMMON,
            ...
            IsPaintChunk(1, 1, PaintChunk::Id(container->Id(), DisplayItem::kScrollHitTest), container_properties, &scroll_hit_test, gfx::Rect(0, 0, 150, 150)),
            IsPaintChunk(1, 1, PaintChunk::Id(content_layer->Id(), DisplayItem::kLayerChunk), content_properties, nullptr, gfx::Rect(0, 0, 200, 100)),
            IsPaintChunk(1, 2, PaintChunk::Id(inner_content_layer->Id(), DisplayItem::kLayerChunk), content_properties, nullptr, gfx::Rect(0, 100, 100, 100)),
...
TEST_P(PaintLayerPainterTest, CachedSubsequenceRetainsPreviousPaintResult)
{
    ...
    // subsequence.
    GetDocument().getElementById("change")->setAttribute(html_names::kStyleAttr, "display: block");
    UpdateAllLifecyclePhasesExceptPaint();
...
TEST_P(PaintLayerPainterTest, PaintPhaseOutline)
{
    ...
    LayoutObject& outline_div = *GetDocument().getElementById("outline")->GetLayoutObject();
    To<HTMLElement>(outline_div.GetNode())->setAttribute(html_names::kStyleAttr, style_without_outline);
    UpdateAllLifecyclePhasesForTest();

    auto& self_painting_layer_object = *To<LayoutBoxModelObject>(GetDocument().getElementById("self-painting-layer")->GetLayoutObject());
    ...
    To<HTMLElement>(self_painting_layer_object.GetNode())->setAttribute(html_names::kStyleAttr, "position: absolute; outline: 1px solid green");
    UpdateAllLifecyclePhasesForTest();
    EXPECT_FALSE(self_painting_layer.NeedsPaintPhaseDescendantOutlines());
    EXPECT_FALSE(non_self_painting_layer.NeedsPaintPhaseDescendantOutlines());
...
TEST_P(PaintLayerPainterTest, PaintPhaseFloat)
{
    ...
    LayoutObject& float_div = *GetDocument().getElementById("float")->GetLayoutObject();
...
TEST_P(PaintLayerPainterTest, PaintPhasesUpdateOnLayerAddition)
{
    ...
    auto& layer_div = *To<LayoutBoxModelObject>(GetDocument().getElementById("will-be-layer")->GetLayoutObject());
    ...
    To<HTMLElement>(layer_div.GetNode())->setAttribute(html_names::kStyleAttr, "position: relative");
    UpdateAllLifecyclePhasesForTest();
...
TEST_P(PaintLayerPainterTest, PaintPhasesUpdateOnBecomingSelfPainting)
{
    ...
    To<HTMLElement>(layer_div.GetNode())->setAttribute(html_names::kStyleAttr, "width: 100px; height: 100px; overflow: hidden; position: relative");
    UpdateAllLifecyclePhasesForTest();
    PaintLayer& layer = *layer_div.Layer();
    ASSERT_TRUE(layer.IsSelfPaintingLayer());
    EXPECT_TRUE(layer.NeedsPaintPhaseDescendantOutlines());
...
TEST_P(PaintLayerPainterTest, PaintPhasesUpdateOnBecomingNonSelfPainting)
{
    ...
    To<HTMLElement>(layer_div.GetNode())->setAttribute(html_names::kStyleAttr, "width: 100px; height: 100px; overflow: hidden");
    UpdateAllLifecyclePhasesForTest();
...
TEST_P(PaintLayerPainterTest, PaintWithOverriddenCullRect)
{
    ...
    EXPECT_EQ(kFullyPainted, absolute.PreviousPaintResult());
    {
        ...
        OverriddenOldCullRectScope old_scope(stacking, CullRect(gfx::Rect(0, 0, 100, 100)));
