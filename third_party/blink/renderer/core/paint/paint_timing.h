...
class CORE_EXPORT PaintTiming final : public GarbageCollected<PaintTiming>, public Supplement<Document> {
    ...
    using RequestAnimationFrameTimesAfterBackForwardCacheRestore
        = std::array<base::TimeTicks, WebPerformance::kRequestAnimationFramesToRecordAfterBackForwardCacheRestore>;
...
public:
    ...
    void ReportFirstPaintAfterBackForwardCacheRestorePresentationTime(wtf_size_t index, base::TimeTicks timestamp);
