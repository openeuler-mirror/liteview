...
public:
    ...
    static absl::optional<gfx::RectF> LocalClipPathBoundingBox(const LayoutObject&);
    ...
    static absl::optional<Path> PathBasedClip(const LayoutObject& clip_path_owner, const bool is_in_block_fragmentation);
};
