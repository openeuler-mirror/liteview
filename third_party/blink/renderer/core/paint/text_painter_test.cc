...
protected:
    LineLayoutText GetLineLayoutText()
    {
        return LineLayoutText(layout_text_);
    }
...
TEST_F(TextPainterTest, TextPaintingStyle_Simple)
{
    ...
    TextPaintStyle text_style
        = TextPainter::TextPaintingStyle(GetLineLayoutText().GetDocument(), GetLineLayoutText().StyleRef(), CreatePaintInfoForBackground());
...
TEST_F(TextPainterTest, TextPaintingStyle_UsesTextAsClip)
{
    ...
    TextPaintStyle text_style = TextPainter::TextPaintingStyle(GetLineLayoutText().GetDocument(), GetLineLayoutText().StyleRef(), CreatePaintInfoForTextClip());
