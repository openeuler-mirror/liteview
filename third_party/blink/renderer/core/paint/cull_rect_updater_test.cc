...
INSTANTIATE_TEST_SUITE_P(All, CullRectUpdaterTest, ::testing::Values(kScrollUpdateOptimizations | kScrollUnification, kScrollUpdateOptimizations));
...
TEST_P(CullRectUpdaterTest, VerticalRightLeftWritingModeDocument)
{
    ...
    GetDocument().View()->LayoutViewport()->SetScrollOffset(ScrollOffset(-5000, 0), mojom::blink::ScrollType::kProgrammatic);
...
TEST_P(CullRectUpdaterTest, OptimizeNonCompositedTransformUpdate)
{
    ...
    GetDocument().getElementById("target")->setAttribute(html_names::kStyleAttr, "transform: rotate(10deg);");
    UpdateAllLifecyclePhasesForTest();
...
TEST_P(CullRectUpdaterTest, AbsolutePositionUnderNonContainingStackingContext)
{
    ...
    UpdateAllLifecyclePhasesForTest();
    EXPECT_EQ(RuntimeEnabledFeatures::LayoutNGEnabled() ? gfx::Rect(200, 200, 200, 200) : gfx::Rect(150, 200, 200, 200), GetCullRect("absolute").Rect());
}
...
TEST_P(CullRectUpdaterTest, LayerUnderSVGHiddenContainer)
{
    ...
    GetDocument().getElementById("defs")->appendChild(GetDocument().getElementById("div"));
...
protected:
    ...
    void TestTargetChange(const AtomicString& old_style, const AtomicString& new_style, bool expected_needs_repaint, bool expected_needs_cull_rect_update,
        bool expected_needs_repaint_after_cull_rect_update)
    {
    ...
    void TestChildChange(const AtomicString& old_style, const AtomicString& new_style, bool expected_needs_repaint, bool expected_needs_cull_rect_update,
        bool expected_needs_repaint_after_cull_rect_update)
    {
        SetBodyInnerHTML(html_);
...
INSTANTIATE_TEST_SUITE_P(
    All, CullRectUpdateOnPaintPropertyChangeTest, ::testing::Values(kScrollUpdateOptimizations | kScrollUnification, kScrollUpdateOptimizations));
...
TEST_P(CullRectUpdateOnPaintPropertyChangeTest, LargeContentsScrollSmallDeltaOrNotExposingNewContents)
{
    ...
    TestTargetScroll(ScrollOffset(7000, 7000), ScrollOffset(8000, 8000), false, needs_cull_rect_update, false);
}

TEST_P(CullRectUpdateOnPaintPropertyChangeTest, LargeContentsScrollExposingNewContents)
{
    html_ = html_ + "<style>#child { width: 10000px; height: 10000px; }</style>";
