...
public:
    TextDecorationInfo(PhysicalOffset local_origin, LayoutUnit width, const ComputedStyle& target_style, const NGInlinePaintContext* inline_context,
        const absl::optional<AppliedTextDecoration> selection_text_decoration, const Font* font_override = nullptr,
        MinimumThickness1 minimum_thickness1 = MinimumThickness1(true), float scaling_factor = 1.0f,
        // Following arguments are used only in legacy. They're deprecated.
        absl::optional<FontBaseline> baseline_type_override = absl::nullopt, const ComputedStyle* decorating_box_style = nullptr);
...
private:
    ...
    void ComputeWavyLineData(gfx::RectF& pattern_rect, sk_sp<cc::PaintRecord>& tile_record) const;
