...
void SVGModelObjectPainter::RecordHitTestData(const LayoutObject& svg_object, const PaintInfo& paint_info)
{
    ...
    paint_info.context.GetPaintController().RecordHitTestData(svg_object, gfx::ToEnclosingRect(svg_object.VisualRectInLocalSVGCoordinates()),
        svg_object.EffectiveAllowedTouchAction(), svg_object.InsideBlockingWheelEventHandler());
}
