...
public:
    ...
    PaintPropertyTreeBuilderContext(const PaintPropertyTreeBuilderContext&) = default;
    ~PaintPropertyTreeBuilderContext();
...
public:
    NGPrePaintInfo(const NGPhysicalBoxFragment& box_fragment, PhysicalOffset paint_offset, wtf_size_t fragmentainer_idx, bool is_first_for_node,
...
public:
    ...
    PaintPropertyTreeBuilder(const LayoutObject& object, NGPrePaintInfo* pre_paint_info, PaintPropertyTreeBuilderContext& context)
        : object_(object)
...
private:
    ALWAYS_INLINE void InitFragmentPaintProperties(FragmentData&, bool needs_paint_properties, PaintPropertyTreeBuilderFragmentContext&);
    ALWAYS_INLINE void InitFragmentPaintPropertiesForLegacy(
        FragmentData&, bool needs_paint_properties, const PhysicalOffset& pagination_offset, PaintPropertyTreeBuilderFragmentContext&);
    ALWAYS_INLINE void InitFragmentPaintPropertiesForNG(bool needs_paint_properties);
    ...
    ALWAYS_INLINE PaintPropertyTreeBuilderFragmentContext ContextForFragment(
        const absl::optional<PhysicalRect>& fragment_clip, LayoutUnit logical_top_in_flow_thread) const;
    ALWAYS_INLINE void CreateFragmentContextsInFlowThread(bool needs_paint_properties);
    ...
    ALWAYS_INLINE void CreateFragmentContextsForRepeatingTableSectionInPagedMedia();
    ALWAYS_INLINE void CreateFragmentDataForRepeatingInPagedMedia(bool needs_paint_properties);
...
WTF_ALLOW_CLEAR_UNUSED_SLOTS_WITH_MEM_FUNCTIONS(blink::PaintPropertyTreeBuilderFragmentContext)
