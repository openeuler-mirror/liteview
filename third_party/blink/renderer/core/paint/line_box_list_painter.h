...
public:
    ...
    void Paint(const LayoutBoxModelObject&, const PaintInfo&, const PhysicalOffset& paint_offset) const;
    void PaintBackplate(const LayoutBoxModelObject& layout_object, const PaintInfo&, const PhysicalOffset& paint_offset) const;

private:
    const LineBoxList& line_box_list_;

    bool ShouldPaint(const LayoutBoxModelObject& layout_object, const PaintInfo& paint_info, const PhysicalOffset& paint_offset) const;
