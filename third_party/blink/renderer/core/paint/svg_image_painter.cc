...
void SVGImagePainter::PaintForeground(const PaintInfo& paint_info)
{
    ...
    ScopedInterpolationQuality interpolation_quality_scope(paint_info.context, layout_svg_image_.StyleRef().GetInterpolationQuality());
...
gfx::SizeF SVGImagePainter::ComputeImageViewportSize() const
{
    ...
    ImageResourceContent* cached_image = layout_svg_image_.ImageResource()->CachedImage();
    ...
    if (auto* svg_image = DynamicTo<SVGImage>(image)) {
        return svg_image->ConcreteObjectSize(layout_svg_image_.ObjectBoundingBox().size());
    }
