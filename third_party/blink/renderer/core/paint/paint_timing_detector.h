...
public:
    ...
    void ReportPaintTime(std::unique_ptr<std::queue<PaintTimingCallbackManager::LocalThreadCallback>> frame_callbacks, base::TimeTicks paint_time);
...
public:
    ...
    struct LargestContentfulPaintDetails {
        ...
        blink::LargestContentfulPaintType largest_contentful_paint_type_ = blink::LargestContentfulPaintType::kNone;
    ...
    static bool NotifyBackgroundImagePaint(
        const Node&, const Image&, const StyleFetchedImage&, const PropertyTreeStateOrAlias& current_paint_chunk_properties, const gfx::Rect& image_border);
    ...
    bool NotifyIfChangedLargestImagePaint(base::TimeTicks image_paint_time, uint64_t image_size, ImageRecord* image_record, double image_bpp);
    ...
    blink::LargestContentfulPaintType LargestContentfulPaintTypeForMetrics() const
    {
    ...
    absl::optional<PaintTimingVisualizer>& Visualizer()
    {
        return visualizer_;
    }
...
private:
    ...
    absl::optional<base::AutoReset<ScopedPaintTimingDetectorBlockPaintHook*>> reset_top_;
    struct Data {
        STACK_ALLOCATED();
