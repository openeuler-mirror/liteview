...
static ContentLayerClientImpl* GetContentLayerClient(const LocalFrameView& root_frame_view, wtf_size_t index)
{
    return root_frame_view.GetPaintArtifactCompositor()->ContentLayerClientForTesting(index);
}

const RasterInvalidationTracking* GetRasterInvalidationTracking(const LocalFrameView& root_frame_view, wtf_size_t index)
{
...
TEST_P(PaintAndRasterInvalidationTest, SubpixelChange)
{
    ...
    GetDocument().View()->SetTracksRasterInvalidations(true);
    target->setAttribute(html_names::kStyleAttr, "width: 100.6px; height: 70.3px");
    UpdateAllLifecyclePhasesForTest();
    EXPECT_THAT(GetRasterInvalidationTracking()->Invalidations(),
        UnorderedElementsAre(RasterInvalidationInfo { object->Id(), object->DebugName(), gfx::Rect(0, 0, 50, 100), PaintInvalidationReason::kGeometry },
            RasterInvalidationInfo { object->Id(), object->DebugName(), gfx::Rect(0, 0, 101, 70), PaintInvalidationReason::kGeometry }));
    GetDocument().View()->SetTracksRasterInvalidations(false);
...
TEST_P(PaintAndRasterInvalidationTest, SubpixelVisualRectChangeWithTransform)
{
    ...
    UpdateAllLifecyclePhasesForTest();
    EXPECT_THAT(GetRasterInvalidationTracking()->Invalidations(),
        UnorderedElementsAre(RasterInvalidationInfo { object->Id(), object->DebugName(), gfx::Rect(0, 0, 100, 200), PaintInvalidationReason::kGeometry },
            RasterInvalidationInfo { object->Id(), object->DebugName(), gfx::Rect(0, 0, 202, 140), PaintInvalidationReason::kGeometry }));
    GetDocument().View()->SetTracksRasterInvalidations(false);
...
TEST_P(PaintAndRasterInvalidationTest, SubpixelWithinPixelsChange)
{
    ...
    GetDocument().View()->SetTracksRasterInvalidations(true);
    target->setAttribute(html_names::kStyleAttr, "margin-top: 0.6px; width: 50px; height: 99.3px");
    UpdateAllLifecyclePhasesForTest();
    EXPECT_THAT(GetRasterInvalidationTracking()->Invalidations(),
        UnorderedElementsAre(RasterInvalidationInfo { object->Id(), object->DebugName(), gfx::Rect(0, 0, 50, 100), PaintInvalidationReason::kGeometry }));
    GetDocument().View()->SetTracksRasterInvalidations(false);
    ...
    GetDocument().View()->SetTracksRasterInvalidations(true);
    target->setAttribute(html_names::kStyleAttr, "margin-top: 0.6px; width: 49.3px; height: 98.5px");
    UpdateAllLifecyclePhasesForTest();
    EXPECT_THAT(GetRasterInvalidationTracking()->Invalidations(),
        UnorderedElementsAre(RasterInvalidationInfo { object->Id(), object->DebugName(), gfx::Rect(0, 1, 50, 99), PaintInvalidationReason::kGeometry }));
    GetDocument().View()->SetTracksRasterInvalidations(false);
}
...
TEST_P(PaintAndRasterInvalidationTest, ResizeRotated)
{
    ...
    GetDocument().View()->SetTracksRasterInvalidations(true);
    target->setAttribute(html_names::kStyleAttr, "transform: rotate(45deg); width: 200px");
    UpdateAllLifecyclePhasesForTest();
...
TEST_P(PaintAndRasterInvalidationTest, ResizeRotatedChild)
{
    ...
    GetDocument().View()->SetTracksRasterInvalidations(true);
    child->setAttribute(html_names::kStyleAttr, "width: 100px; height: 50px; background: red");
    UpdateAllLifecyclePhasesForTest();
...
TEST_P(PaintAndRasterInvalidationTest, NonCompositedLayoutViewResize)
{
    ...
    EXPECT_EQ(kBackgroundPaintInContentsSpace, content->GetLayoutObject()->View()->ComputeBackgroundPaintLocationIfComposited());
    EXPECT_EQ(kBackgroundPaintInBorderBoxSpace, content->GetLayoutObject()->View()->GetBackgroundPaintLocation());
...
{
    GetDocument().documentElement()->setAttribute(html_names::kStyleAttr, "transform: scale(0.5)");
    const DisplayItemClient* client = &GetDocument().View()->GetLayoutView()->GetScrollableArea()->GetScrollingBackgroundDisplayItemClient();
    UpdateAllLifecyclePhasesForTest();
    ...
    EXPECT_THAT(GetRasterInvalidationTracking()->Invalidations(),
        UnorderedElementsAre(RasterInvalidationInfo { client->Id(), client->DebugName(), gfx::Rect(0, 0, 500, 500), PaintInvalidationReason::kBackground },
            RasterInvalidationInfo { client->Id(), client->DebugName(), gfx::Rect(0, 0, 500, 500), PaintInvalidationReason::kPaintProperty }));
}
...
TEST_P(PaintAndRasterInvalidationTest, NonCompositedLayoutViewGradientResize)
{
    ...
    // raster invalidation for the frame contents.
    EXPECT_THAT(GetRasterInvalidationTracking()->Invalidations(),
        UnorderedElementsAre(RasterInvalidationInfo { client->Id(), client->DebugName(), gfx::Rect(0, 0, 100, 200), PaintInvalidationReason::kBackground }));
    GetDocument().View()->SetTracksRasterInvalidations(false);
}
...
TEST_P(PaintAndRasterInvalidationTest, CompositedBackgroundAttachmentLocalResize)
{
    SetUpHTML(*this);
    Element* target = GetDocument().getElementById("target");
    target->setAttribute(html_names::kClassAttr, "solid composited scroll local-attachment border");
    UpdateAllLifecyclePhasesForTest();
    ...
    auto container_raster_invalidation_tracking = [&]() -> const RasterInvalidationTracking* { return GetRasterInvalidationTracking(1); };
    auto contents_raster_invalidation_tracking = [&]() -> const RasterInvalidationTracking* { return GetRasterInvalidationTracking(2); };
    ...
    EXPECT_THAT(container_raster_invalidation_tracking()->Invalidations(),
        UnorderedElementsAre(
            RasterInvalidationInfo { target_obj->Id(), target_obj->DebugName(), gfx::Rect(0, 0, 70, 220), PaintInvalidationReason::kGeometry }));
...
TEST_P(PaintAndRasterInvalidationTest, CompositedBackgroundAttachmentLocalGradientResize)
{
    SetUpHTML(*this);
    Element* target = GetDocument().getElementById("target");
    target->setAttribute(html_names::kClassAttr, "gradient composited scroll local-attachment border");
    target->setInnerHTML("<div id='child' style='width: 500px; height: 500px'></div>", ASSERT_NO_EXCEPTION);
    Element* child = GetDocument().getElementById("child");
    UpdateAllLifecyclePhasesForTest();
...
TEST_P(PaintAndRasterInvalidationTest, NonCompositedBackgroundAttachmentLocalResize)
{
    ...
    target->setAttribute(html_names::kClassAttr, "translucent local-attachment scroll");
    target->setInnerHTML("<div id=child style='width: 500px; height: 500px'></div>", ASSERT_NO_EXCEPTION);
    Element* child = GetDocument().getElementById("child");
    UpdateAllLifecyclePhasesForTest();
    EXPECT_EQ(kBackgroundPaintInContentsSpace, object->ComputeBackgroundPaintLocationIfComposited());
    EXPECT_EQ(kBackgroundPaintInBorderBoxSpace, object->GetBackgroundPaintLocation());
...
TEST_P(PaintAndRasterInvalidationTest, CompositedSolidBackgroundResize)
{
    ...
    target->setInnerHTML("<div style='height: 500px'></div>", ASSERT_NO_EXCEPTION);
    UpdateAllLifecyclePhasesForTest();
    ...
    const auto* contents_raster_invalidation_tracking = GetRasterInvalidationTracking(2);
    ...
    const auto* container_raster_invalidation_tracking = GetRasterInvalidationTracking(1);
    EXPECT_THAT(container_raster_invalidation_tracking->Invalidations(),
        UnorderedElementsAre(
            RasterInvalidationInfo { target_object->Id(), target_object->DebugName(), gfx::Rect(50, 0, 50, 100), PaintInvalidationReason::kIncremental }));
    GetDocument().View()->SetTracksRasterInvalidations(false);
}
...
TEST_P(PaintAndRasterInvalidationTest, RecalcOverflowInvalidatesBackground)
{
    ...
    container->setAttribute(html_names::kStyleAttr, "transform: translateY(1000px);");
...
TEST_P(PaintAndRasterInvalidationTest, DelayedFullPaintInvalidation)
{
    ...
    target->SetShouldDoFullPaintInvalidationWithoutGeometryChange(PaintInvalidationReason::kForTesting);
    ...
    EXPECT_EQ(PaintInvalidationReason::kForTesting, target->FullPaintInvalidationReason());
    ...
    UpdateAllLifecyclePhasesForTest();
    EXPECT_THAT(GetRasterInvalidationTracking()->Invalidations(),
        UnorderedElementsAre(RasterInvalidationInfo { target->Id(), target->DebugName(), gfx::Rect(0, 4000, 100, 100), PaintInvalidationReason::kForTesting }));
    EXPECT_EQ(PaintInvalidationReason::kNone, target->FullPaintInvalidationReason());
...
TEST_P(PaintAndRasterInvalidationTest, SVGHiddenContainer)
{
    ...
    EXPECT_THAT(GetRasterInvalidationTracking()->Invalidations(),
        UnorderedElementsAre(RasterInvalidationInfo { real_rect->Id(), real_rect->DebugName(), gfx::Rect(155, 166, 7, 8), PaintInvalidationReason::kSubtree },
            RasterInvalidationInfo { real_rect->Id(), real_rect->DebugName(), gfx::Rect(154, 165, 9, 10), PaintInvalidationReason::kSubtree }));
...
TEST_P(PaintAndRasterInvalidationTest, ScrollingInvalidatesStickyOffset)
{
    ...
    EXPECT_EQ(PhysicalOffset(), sticky->FirstFragment().PaintOffset());
    EXPECT_EQ(gfx::Vector2dF(0, 150), sticky->FirstFragment().PaintProperties()->StickyTranslation()->Translation2D());
    EXPECT_EQ(PhysicalOffset(), inner->FirstFragment().PaintOffset());
}
...
TEST_P(PaintAndRasterInvalidationTest, NoDamageDueToFloatingPointError)
{
    ...
    GetDocument().View()->SetPaintArtifactCompositorNeedsUpdate(PaintArtifactCompositorUpdateReason::kTest);
...
TEST_P(PaintAndRasterInvalidationTest, ResizeElementWhichHasNonCustomResizer)
{
    ...
    invalidations.push_back(
        RasterInvalidationInfo { scroll_corner.Id(), scroll_corner.DebugName(), gfx::Rect(93, 93, 7, 7), PaintInvalidationReason::kGeometry });
    invalidations.push_back(
        RasterInvalidationInfo { scroll_corner.Id(), scroll_corner.DebugName(), gfx::Rect(193, 93, 7, 7), PaintInvalidationReason::kGeometry });
