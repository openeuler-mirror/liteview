...
private:
    ...
    absl::optional<LayoutShiftTracker::ContainingBlockScope> containing_block_scope_;
...
public:
    ...
    bool InvalidatePaint(const LayoutObject&, const NGPrePaintInfo*, const PaintPropertyTreeBuilderContext*, PaintInvalidatorContext&);
