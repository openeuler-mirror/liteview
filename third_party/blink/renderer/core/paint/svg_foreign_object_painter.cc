...
SVGForeignObjectPainter::SVGForeignObjectPainter(const LayoutBlockFlow& layout_svg_foreign_object)
...
void SVGForeignObjectPainter::Paint(const PaintInfo& paint_info)
{
    ...
    PaintTiming& timing = PaintTiming::From(layout_svg_foreign_object_.GetDocument());
