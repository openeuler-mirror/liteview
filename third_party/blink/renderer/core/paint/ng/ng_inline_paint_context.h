...
public:
    ...
    public:
        ScopedInlineItem(const NGFragmentItem& inline_item, NGInlinePaintContext* inline_context);
        ~ScopedInlineItem();
    ...
    public:
        ScopedInlineBoxAncestors(const NGInlineCursor& inline_box, NGInlinePaintContext* inline_context);
    ...
    public:
        ScopedLineBox(const NGInlineCursor& line_cursor, NGInlinePaintContext* inline_context);
        ~ScopedLineBox();
    ...
    public:
        ScopedPaintOffset(const PhysicalOffset& paint_offset, NGInlinePaintContext* inline_context)
...
private:
    wtf_size_t SyncDecoratingBox(const NGFragmentItem& item, DecoratingBoxList* saved_decorating_boxes = nullptr);
...
inline NGInlinePaintContext::ScopedInlineBoxAncestors::~ScopedInlineBoxAncestors()
{
    if (inline_context_)
