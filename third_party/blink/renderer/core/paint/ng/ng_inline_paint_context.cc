...
void NGInlinePaintContext::ClearDecoratingBoxes(DecoratingBoxList* saved_decorating_boxes)
{
...
NGInlinePaintContext::ScopedInlineItem::ScopedInlineItem(const NGFragmentItem& item, NGInlinePaintContext* inline_context)
{
...
wtf_size_t NGInlinePaintContext::SyncDecoratingBox(const NGFragmentItem& item, DecoratingBoxList* saved_decorating_boxes)
{
    ...
    public:
        DecorationBoxSynchronizer(NGInlinePaintContext* inline_context, const NGFragmentItem& item, const Vector<AppliedTextDecoration>* stop_at,
        ...
        wtf_size_t Sync(
            const NGFragmentItem* item, const LayoutObject* layout_object, const ComputedStyle* style, const Vector<AppliedTextDecoration>* decorations)
        {
            for (;;) {
                ...
                const Vector<AppliedTextDecoration>& parent_decorations = parent_style.AppliedTextDecorations();
...
NGInlinePaintContext::ScopedInlineBoxAncestors::ScopedInlineBoxAncestors(const NGInlineCursor& inline_box, NGInlinePaintContext* inline_context)
{
    if (!RuntimeEnabledFeatures::TextDecoratingBoxEnabled())
        return;
    DCHECK(inline_context);
...
void NGInlinePaintContext::PushDecoratingBoxAncestors(const NGInlineCursor& inline_box)
{
    DCHECK(RuntimeEnabledFeatures::TextDecoratingBoxEnabled());
...
NGInlinePaintContext::ScopedLineBox::ScopedLineBox(const NGInlineCursor& line_cursor, NGInlinePaintContext* inline_context)
{
    if (!RuntimeEnabledFeatures::TextDecoratingBoxEnabled())
        return;
    DCHECK(inline_context);
...
void NGInlinePaintContext::SetLineBox(const NGInlineCursor& line_cursor)
{
    ...
    const Vector<AppliedTextDecoration>& applied_text_decorations = style.AppliedTextDecorations();
