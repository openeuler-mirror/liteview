...
class NGBoxFragmentPainterTest : public PaintControllerPaintTest, private ScopedLayoutNGForTest {
public:
...
TEST_P(NGBoxFragmentPainterTest, AddUrlRects)
{
    ...
    paint_preview::PaintPreviewTracker tracker(base::UnguessableToken::Create(), absl::nullopt, true);
