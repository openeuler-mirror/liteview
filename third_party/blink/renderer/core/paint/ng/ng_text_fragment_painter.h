...
public:
    ...
    NGTextFragmentPainter(const NGInlineCursor& cursor, const PhysicalOffset& parent_offset, NGInlinePaintContext* inline_context)
        : cursor_(cursor)
...
private:
    void Paint(const NGTextFragmentPaintInfo& fragment_paint_info, const LayoutObject* layout_object, const DisplayItemClient& display_item_client,
