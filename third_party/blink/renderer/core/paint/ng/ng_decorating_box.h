...
public:
    NGDecoratingBox(const PhysicalOffset& content_offset_in_container, const ComputedStyle& style, const Vector<AppliedTextDecoration>* decorations)
    ...
    NGDecoratingBox(const NGFragmentItem& item, const ComputedStyle& style, const Vector<AppliedTextDecoration>* decorations)
        : NGDecoratingBox(item.ContentOffsetInContainerFragment(), style, decorations)
    {
    }
