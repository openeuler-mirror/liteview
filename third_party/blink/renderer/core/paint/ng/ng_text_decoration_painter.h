...
public:
    explicit NGTextDecorationPainter(NGTextPainter& text_painter, const NGFragmentItem& text_item, const PaintInfo& paint_info, const ComputedStyle& style,
        const TextPaintStyle& text_style, const PhysicalRect& decoration_rect, NGHighlightPainter::SelectionPaintState* selection);
    ...
    void UpdateDecorationInfo(absl::optional<TextDecorationInfo>&, const ComputedStyle&, const TextPaintStyle&);
