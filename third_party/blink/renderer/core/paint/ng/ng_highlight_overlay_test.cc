...
class NGHighlightOverlayTest : public PageTestBase, private ScopedHighlightOverlayPaintingForTest, private ScopedLayoutNGForTest {
public:
...
{
    auto* registry = MakeGarbageCollected<HighlightRegistry>(*GetFrame().DomWindow());
    LayoutSelectionStatus selection { 0, 0, SelectSoftLineBreak::kNotSelected };
    auto* none = MakeGarbageCollected<DocumentMarkerVector>();

    EXPECT_EQ(NGHighlightOverlay::ComputeLayers(registry, nullptr, *none, *none, *none, *none),
    ...
    EXPECT_EQ(NGHighlightOverlay::ComputeLayers(registry, &selection, *none, *none, *none, *none),
    ...
    EXPECT_EQ(NGHighlightOverlay::ComputeLayers(registry, nullptr, *none, *grammar, *spelling, *target),
        (Vector<HighlightLayer> {
            HighlightLayer { HighlightLayerType::kOriginating },
    ...
    Highlight* foo = Highlight::Create(*MakeGarbageCollected<HeapVector<Member<AbstractRange>>>());
    Highlight* bar = Highlight::Create(*MakeGarbageCollected<HeapVector<Member<AbstractRange>>>());
    registry->SetForTesting("foo", foo);
    registry->SetForTesting("bar", bar);

    auto* custom = MakeGarbageCollected<DocumentMarkerVector>();
    custom->push_back(MakeGarbageCollected<CustomHighlightMarker>(0, 1, "bar", nullptr));
    custom->push_back(MakeGarbageCollected<CustomHighlightMarker>(0, 1, "foo", nullptr));
    custom->push_back(MakeGarbageCollected<CustomHighlightMarker>(0, 1, "bar", nullptr));
    custom->push_back(MakeGarbageCollected<CustomHighlightMarker>(0, 1, "foo", nullptr));

    EXPECT_EQ(NGHighlightOverlay::ComputeLayers(registry, nullptr, *custom, *none, *none, *none),
        (Vector<HighlightLayer> {
            HighlightLayer { HighlightLayerType::kOriginating },
...
TEST_F(NGHighlightOverlayTest, ComputeEdges)
{
    ...
    EXPECT_EQ(NGHighlightOverlay::ComputeEdges(text, registry, false, originating, nullptr, *none, *none, *none, *none), (Vector<HighlightEdge> {}))
        << "should return no edges when nothing is highlighted";

    EXPECT_EQ(NGHighlightOverlay::ComputeEdges(nullptr, registry, false, originating, &selection, *none, *none, *none, *none),
    ...
    EXPECT_EQ(NGHighlightOverlay::ComputeEdges(br, registry, false, originating, &selection, *none, *none, *none, *none),
        (Vector<HighlightEdge> {
            HighlightEdge { 1, selection_layer, HighlightEdgeType::kStart },
            HighlightEdge { 3, selection_layer, HighlightEdgeType::kEnd },
        }))
    ...
    EXPECT_EQ(NGHighlightOverlay::ComputeEdges(text, registry, false, originating, &selection, *none, *grammar, *spelling, *target),
        (Vector<HighlightEdge> {
    ...
    EXPECT_EQ(NGHighlightOverlay::ComputeEdges(text, registry, false, originating2, &selection, *none, *grammar, *spelling, *target),
        (Vector<HighlightEdge> {
            HighlightEdge { 1, selection_layer, HighlightEdgeType::kStart },
            HighlightEdge { 2, grammar_layer, HighlightEdgeType::kStart },
            HighlightEdge { 2, spelling_layer, HighlightEdgeType::kStart },
...
TEST_F(NGHighlightOverlayTest, ComputeParts)
{
    ...
    auto* spelling = MakeGarbageCollected<DocumentMarkerVector>();
    auto* target = MakeGarbageCollected<DocumentMarkerVector>();
    Highlight* foo_highlight = Highlight::Create(*MakeGarbageCollected<HeapVector<Member<AbstractRange>>>());
    Highlight* bar_highlight = Highlight::Create(*MakeGarbageCollected<HeapVector<Member<AbstractRange>>>());
    ...
    custom->push_back(MakeGarbageCollected<CustomHighlightMarker>(0, 14, "foo", nullptr));
    custom->push_back(MakeGarbageCollected<CustomHighlightMarker>(10, 19, "bar", nullptr));
    ...
    Vector<HighlightLayer> layers = NGHighlightOverlay::ComputeLayers(registry, &selection, *custom, *grammar, *spelling, *target);
    ...
    Vector<HighlightEdge> edges = NGHighlightOverlay::ComputeEdges(node, registry, false, originating, nullptr, *none, *none, *none, *none);
    ...
    Vector<HighlightEdge> edges2 = NGHighlightOverlay::ComputeEdges(node, registry, false, originating, &selection, *custom, *grammar, *spelling, *target);
    ...
    Vector<HighlightEdge> edges3 = NGHighlightOverlay::ComputeEdges(node, registry, false, originating, &selection, *custom, *grammar, *spelling, *target);
    ...
    Vector<HighlightEdge> edges4 = NGHighlightOverlay::ComputeEdges(node, registry, false, originating, &selection, *custom, *grammar, *spelling, *target);
    ...
    Vector<HighlightEdge> edges5 = NGHighlightOverlay::ComputeEdges(node, registry, false, originating, nullptr, *none, *none, *spelling, *none);
    ...
    Vector<HighlightEdge> edges6 = NGHighlightOverlay::ComputeEdges(node, registry, false, originating, &selection, *custom, *grammar, *spelling, *target);
    ...
    Vector<HighlightEdge> edges7 = NGHighlightOverlay::ComputeEdges(node, registry, false, originating, &selection, *custom, *grammar, *spelling, *target);
