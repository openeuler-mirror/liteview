...
public:
    enum class HighlightLayerType : unsigned { kOriginating, kCustom, kGrammar, kSpelling, kTargetText, kSelection };
    ...
    public:
        explicit HighlightLayer(HighlightLayerType type, AtomicString name = g_null_atom)
            : type(type)
            , name(name)
        {
        }
    ...
    static Vector<HighlightLayer> ComputeLayers(const HighlightRegistry*, const LayoutSelectionStatus* selection, const DocumentMarkerVector& custom,
        const DocumentMarkerVector& grammar, const DocumentMarkerVector& spelling, const DocumentMarkerVector& target);
    ...
    static Vector<HighlightEdge> ComputeEdges(const Node*, const HighlightRegistry*, bool is_generated_text_fragment,
        const NGTextFragmentPaintInfo& originating, const LayoutSelectionStatus* selection, const DocumentMarkerVector& custom,
        const DocumentMarkerVector& grammar, const DocumentMarkerVector& spelling, const DocumentMarkerVector& target);
...
CORE_EXPORT std::ostream& operator<<(std::ostream&, const NGHighlightOverlay::HighlightLayer&);
CORE_EXPORT std::ostream& operator<<(std::ostream&, const NGHighlightOverlay::HighlightEdge&);
CORE_EXPORT std::ostream& operator<<(std::ostream&, const NGHighlightOverlay::HighlightPart&);
