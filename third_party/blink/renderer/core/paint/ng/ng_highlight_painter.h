...
public:
    ...
    public:
        ...
        explicit SelectionPaintState(const NGInlineCursor& containing_block, const PhysicalOffset& box_offset,
            const absl::optional<AffineTransform> writing_mode_rotation, const FrameSelection&);
        ...
        void PaintSelectedText(NGTextPainter& text_painter, const NGTextFragmentPaintInfo&, unsigned length, const TextPaintStyle& text_style,
            DOMNodeId node_id, const AutoDarkMode& auto_dark_mode);

        void PaintSuppressingTextProperWhereSelected(NGTextPainter& text_painter, const NGTextFragmentPaintInfo&, unsigned length,
    ...
    NGHighlightPainter(const NGTextFragmentPaintInfo& fragment_paint_info, NGTextPainter& text_painter, NGTextDecorationPainter& decoration_painter,
        const PaintInfo& paint_info, const NGInlineCursor& cursor, const NGFragmentItem& fragment_item,
        ...
        const ComputedStyle& style, const TextPaintStyle& text_style, SelectionPaintState*, bool is_printing);
    ...
    void PaintHighlightOverlays(const TextPaintStyle&, DOMNodeId, bool paint_marker_backgrounds, absl::optional<AffineTransform> rotation);
...
private:
    ...
    public:
        LayerPaintState(NGHighlightOverlay::HighlightLayer id, scoped_refptr<const ComputedStyle> style, TextPaintStyle text_style)
            : id(id)
    ...
    void PaintOneSpellingGrammarDecoration(const DocumentMarker::MarkerType&, const StringView& text, unsigned paint_start_offset, unsigned paint_end_offset);
    void ClipToPartDecorations(const NGHighlightOverlay::HighlightPart&);
    void PaintDecorationsExceptLineThrough(const NGHighlightOverlay::HighlightPart&);
    void PaintDecorationsExceptLineThrough(const NGHighlightOverlay::HighlightPart&, TextDecorationLine lines_to_paint);
    void PaintDecorationsOnlyLineThrough(const NGHighlightOverlay::HighlightPart&);
    void PaintSpellingGrammarDecorations(const NGHighlightOverlay::HighlightPart&);
