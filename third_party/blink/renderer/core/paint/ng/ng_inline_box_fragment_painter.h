...
protected:
    NGInlineBoxFragmentPainterBase(const NGPhysicalFragment& inline_box_fragment, const NGInlineCursor* inline_box_cursor,
        const NGFragmentItem& inline_box_item, const LayoutObject& layout_object, const ComputedStyle& style, const ComputedStyle& line_style,
        NGInlinePaintContext* inline_context)
        : InlineBoxPainterBase(layout_object, &layout_object.GetDocument(), layout_object.GeneratingNode(), style, line_style)
    ...
    NGInlineBoxFragmentPainterBase(const NGInlineCursor& inline_box_cursor, const NGFragmentItem& inline_box_item,
        const NGPhysicalBoxFragment& inline_box_fragment, const LayoutObject& layout_object, const ComputedStyle& style, const ComputedStyle& line_style,
        NGInlinePaintContext* inline_context)
        : NGInlineBoxFragmentPainterBase(inline_box_fragment, &inline_box_cursor, inline_box_item, layout_object, style, line_style, inline_context)
    {
    }
    ...
    PhysicalRect PaintRectForImageStrip(const PhysicalRect&, TextDirection direction) const override;

    BorderPaintingType GetBorderPaintType(
        const PhysicalRect& adjusted_frame_rect, gfx::Rect& adjusted_clip_rect, bool object_has_multiple_boxes) const override;
    void PaintNormalBoxShadow(const PaintInfo&, const ComputedStyle&, const PhysicalRect& paint_rect) override;
    void PaintInsetBoxShadow(const PaintInfo&, const ComputedStyle&, const PhysicalRect& paint_rect) override;
...
public:
    // Constructor for |NGFragmentItem|.
    NGInlineBoxFragmentPainter(const NGInlineCursor& inline_box_cursor, const NGFragmentItem& inline_box_item, const NGPhysicalBoxFragment& inline_box_fragment,
        NGInlinePaintContext* inline_context)
        : NGInlineBoxFragmentPainterBase(inline_box_cursor, inline_box_item, inline_box_fragment, *inline_box_fragment.GetLayoutObject(),
            inline_box_fragment.Style(), inline_box_fragment.Style(), inline_context)
    {
        CheckValid();
    }
    NGInlineBoxFragmentPainter(const NGInlineCursor& inline_box_cursor, const NGFragmentItem& inline_box_item, NGInlinePaintContext* inline_context)
        : NGInlineBoxFragmentPainter(inline_box_cursor, inline_box_item, *inline_box_item.BoxFragment(), inline_context)
    {
    ...
    static void PaintAllFragments(const LayoutInline& layout_inline, const PaintInfo&, const PhysicalOffset& paint_offset);
...
public:
    NGLineBoxFragmentPainter(const NGPhysicalFragment& line_box_fragment, const NGFragmentItem& line_box_item, const NGPhysicalBoxFragment& block_fragment)
        : NGLineBoxFragmentPainter(line_box_fragment, line_box_item, block_fragment, *block_fragment.GetLayoutObject())
    {
    }

    static bool NeedsPaint(const NGPhysicalFragment& line_fragment)
    {
        DCHECK_EQ(line_fragment.Type(), NGPhysicalFragment::NGFragmentType::kFragmentLineBox);
...
private:
    NGLineBoxFragmentPainter(const NGPhysicalFragment& line_box_fragment, const NGFragmentItem& line_box_item, const NGPhysicalBoxFragment& block_fragment,
        ...
        : NGInlineBoxFragmentPainterBase(line_box_fragment,
    ...
    {
        DCHECK_EQ(line_box_fragment.Type(), NGPhysicalFragment::NGFragmentType::kFragmentLineBox);
