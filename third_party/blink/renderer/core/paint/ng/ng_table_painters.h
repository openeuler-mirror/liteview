...
public:
    explicit NGTableSectionPainter(const NGPhysicalBoxFragment& table_section_fragment)
    ...
    void PaintColumnsBackground(
        const PaintInfo&, const PhysicalOffset& section_paint_offset, const PhysicalRect& columns_paint_rect, const NGTableFragmentData::ColumnGeometries&);
...
public:
    ...
    void PaintColumnsBackground(
        const PaintInfo&, const PhysicalOffset& row_paint_offset, const PhysicalRect& columns_paint_rect, const NGTableFragmentData::ColumnGeometries&);
