...
void NGFrameSetPainter::PaintObject(const PaintInfo& paint_info, const PhysicalOffset& paint_offset)
{
...
void NGFrameSetPainter::PaintChildren(const PaintInfo& paint_info)
{
    ...
    for (const NGLink& link : box_fragment_.Children()) {
        ...
        if (To<NGPhysicalBoxFragment>(child_fragment).CanTraverse()) {
            NGBoxFragmentPainter(To<NGPhysicalBoxFragment>(child_fragment)).Paint(paint_info);
        } else {
...
void NGFrameSetPainter::PaintBorders(const PaintInfo& paint_info, const PhysicalOffset& paint_offset)
{
...
void NGFrameSetPainter::PaintRowBorder(const PaintInfo& paint_info, const gfx::Rect& border_rect, const Color& fill_color, const AutoDarkMode& auto_dark_mode)
{
    // Fill first.
...
void NGFrameSetPainter::PaintColumnBorder(
    const PaintInfo& paint_info, const gfx::Rect& border_rect, const Color& fill_color, const AutoDarkMode& auto_dark_mode)
{
