...
private:
    ...
    void PaintBoxDecorationBackground(const PaintInfo&, const PhysicalOffset&, const CellSpan& dirtied_rows, const CellSpan& dirtied_columns);
    ...
    LayoutRect TableAlignedRect(const PaintInfo& paint_info, const PhysicalOffset& paint_offset);
