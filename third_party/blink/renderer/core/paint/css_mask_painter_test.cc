...
TEST_F(CSSMaskPainterTest, MaskBoundingBoxSVG)
{
    ...
    absl::optional<gfx::RectF> mask_bounding_box = CSSMaskPainter::MaskBoundingBox(masked, PhysicalOffset());
...
TEST_F(CSSMaskPainterTest, MaskBoundingBoxCSSBlock)
{
    ...
    auto& masked = *GetLayoutObjectByElementId("masked");
    absl::optional<gfx::RectF> mask_bounding_box = CSSMaskPainter::MaskBoundingBox(masked, PhysicalOffset(8, 8));
    ASSERT_TRUE(mask_bounding_box.has_value());
