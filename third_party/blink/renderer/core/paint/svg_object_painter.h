...
public:
    ...
    // using |paint_flags|.
    bool PreparePaint(const GraphicsContext& context, bool is_rendering_clip_path_as_mask_image, const ComputedStyle&, LayoutSVGResourceMode,
        cc::PaintFlags& paint_flags, const AffineTransform* additional_paint_server_transform = nullptr);

    void PaintResourceSubtree(GraphicsContext&);

private:
    bool ApplyPaintResource(const SVGPaint& paint, const AffineTransform* additional_paint_server_transform, cc::PaintFlags& flags);
