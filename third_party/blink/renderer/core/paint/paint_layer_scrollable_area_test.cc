...
public:
    ...
    {
        const auto* paint_properties = scroller->FirstFragment().PaintProperties();
        bool composited = paint_properties && paint_properties->ScrollTranslation() && paint_properties->ScrollTranslation()->HasDirectCompositingReasons();
...
TEST_P(MAYBE_PaintLayerScrollableAreaTest, OpaqueLayersDepromotedOnStyleChange)
{
    SetBodyInnerHTML(R"HTML(
    <style>
    #scroller { overflow: scroll; height: 200px; width: 200px; background:
    ...
    scroller->setAttribute(html_names::kStyleAttr, "background: rgba(255,255,255,0.5) local content-box;");
...
TEST_P(MAYBE_PaintLayerScrollableAreaTest, OpaqueLayersPromotedOnStyleChange)
{
    ...
    scroller->setAttribute(html_names::kStyleAttr, "background: white local content-box;");
    UpdateAllLifecyclePhasesForTest();
    EXPECT_TRUE(UsesCompositedScrolling(scroller->GetLayoutObject()));
}
...
// promotion.
TEST_P(MAYBE_PaintLayerScrollableAreaTest, TransformDoesNotPreventCompositedScrolling)
{
    SetBodyInnerHTML(R"HTML(
    <style>
    #scroller { overflow: scroll; height: 200px; width: 200px; background:
    ...
    scroller->setAttribute(html_names::kStyleAttr, "transform: translate(1px, 0);");
    UpdateAllLifecyclePhasesForTest();
    EXPECT_TRUE(UsesCompositedScrolling(scroller->GetLayoutObject()));
}

TEST_P(MAYBE_PaintLayerScrollableAreaTest, PromoteLayerRegardlessOfSelfAndAncestorOpacity)
{
    SetBodyInnerHTML(R"HTML(
    <style>
    #scroller { overflow: scroll; height: 200px; width: 200px; background:
...
TEST_P(MAYBE_PaintLayerScrollableAreaTest, CompositedScrollOnWillChangeTransform)
{
    SetBodyInnerHTML(R"HTML(
    <style>
...
TEST_P(MAYBE_PaintLayerScrollableAreaTest, OverlayScrollbarColorThemeUpdated)
{
    ...
    ASSERT_EQ(ScrollbarOverlayColorTheme::kScrollbarOverlayColorThemeDark, none_layer->GetScrollableArea()->GetScrollbarOverlayColorTheme());
    ASSERT_EQ(ScrollbarOverlayColorTheme::kScrollbarOverlayColorThemeDark, white_layer->GetScrollableArea()->GetScrollbarOverlayColorTheme());
    ASSERT_EQ(ScrollbarOverlayColorTheme::kScrollbarOverlayColorThemeLight, black_layer->GetScrollableArea()->GetScrollbarOverlayColorTheme());
}

TEST_P(MAYBE_PaintLayerScrollableAreaTest, RecalculatesScrollbarOverlayIfBackgroundChanges)
{
    SetBodyInnerHTML(R"HTML(
    <style>
      #scroller {
    ...
    EXPECT_EQ(ScrollbarOverlayColorTheme::kScrollbarOverlayColorThemeDark, scroll_paint_layer->GetScrollableArea()->GetScrollbarOverlayColorTheme());

    GetElementById("scroller")->setAttribute(html_names::kStyleAttr, "background: rgb(34, 85, 51);");
    UpdateAllLifecyclePhasesForTest();
    EXPECT_EQ(ScrollbarOverlayColorTheme::kScrollbarOverlayColorThemeLight, scroll_paint_layer->GetScrollableArea()->GetScrollbarOverlayColorTheme());

    GetElementById("scroller")->setAttribute(html_names::kStyleAttr, "background: rgb(236, 143, 185);");
    UpdateAllLifecyclePhasesForTest();
    EXPECT_EQ(ScrollbarOverlayColorTheme::kScrollbarOverlayColorThemeDark, scroll_paint_layer->GetScrollableArea()->GetScrollbarOverlayColorTheme());
}
...
TEST_P(MAYBE_PaintLayerScrollableAreaTest, PreferredOverlayScrollbarColorTheme)
{
    ...
    PaintLayer* white_layer = GetPaintLayerByElementId("white");
    PaintLayer* black_layer = GetPaintLayerByElementId("black");
    EXPECT_EQ(ScrollbarOverlayColorTheme::kScrollbarOverlayColorThemeLight, none_layer->GetScrollableArea()->GetScrollbarOverlayColorTheme());
    EXPECT_EQ(ScrollbarOverlayColorTheme::kScrollbarOverlayColorThemeDark, white_layer->GetScrollableArea()->GetScrollbarOverlayColorTheme());
    EXPECT_EQ(ScrollbarOverlayColorTheme::kScrollbarOverlayColorThemeLight, black_layer->GetScrollableArea()->GetScrollbarOverlayColorTheme());

    color_scheme_helper.SetPreferredColorScheme(mojom::blink::PreferredColorScheme::kLight);
    UpdateAllLifecyclePhasesForTest();
    EXPECT_EQ(ScrollbarOverlayColorTheme::kScrollbarOverlayColorThemeDark, none_layer->GetScrollableArea()->GetScrollbarOverlayColorTheme());
    EXPECT_EQ(ScrollbarOverlayColorTheme::kScrollbarOverlayColorThemeDark, white_layer->GetScrollableArea()->GetScrollbarOverlayColorTheme());
    EXPECT_EQ(ScrollbarOverlayColorTheme::kScrollbarOverlayColorThemeLight, black_layer->GetScrollableArea()->GetScrollbarOverlayColorTheme());
}

TEST_P(MAYBE_PaintLayerScrollableAreaTest, HideTooltipWhenScrollPositionChanges)
{
    SetBodyInnerHTML(R"HTML(
    <style>
    ...
    Element* scroller = GetDocument().getElementById("scroller");
    PaintLayerScrollableArea* scrollable_area = To<LayoutBoxModelObject>(scroller->GetLayoutObject())->GetScrollableArea();
...
TEST_P(MAYBE_PaintLayerScrollableAreaTest, IncludeOverlayScrollbarsInVisibleWidth)
{
...
TEST_P(MAYBE_PaintLayerScrollableAreaTest, ShowAutoScrollbarsForVisibleContent)
{
    USE_NON_OVERLAY_SCROLLBARS();
    ...
    UpdateAllLifecyclePhasesForTest();
    PaintLayerScrollableArea* scrollable_area = To<LayoutBoxModelObject>(outer_div->GetLayoutObject())->GetScrollableArea();
    ASSERT_TRUE(scrollable_area);
...
TEST_P(MAYBE_PaintLayerScrollableAreaTest, FloatOverflowInRtlContainer)
{
    ...
    PaintLayerScrollableArea* scrollable_area = To<LayoutBoxModelObject>(container->GetLayoutObject())->GetScrollableArea();
    ASSERT_TRUE(scrollable_area);
...
TEST_P(MAYBE_PaintLayerScrollableAreaTest, OverflowHiddenScrollOffsetInvalidation)
{
    SetBodyInnerHTML(R"HTML(
    <style>
    #scroller {
    ...
    auto* scroller = GetLayoutObjectByElementId("scroller");
    auto* scrollable_area = To<LayoutBoxModelObject>(scroller)->GetScrollableArea();
...
TEST_P(MAYBE_PaintLayerScrollableAreaTest, ScrollWithStickyNeedsCompositingUpdate)
{
    SetBodyInnerHTML(R"HTML(
    <style>
      * {
    ...
    scrollable_area->SetScrollOffset(ScrollOffset(0, 1), mojom::blink::ScrollType::kProgrammatic);
    UpdateAllLifecyclePhasesExceptPaint();
    EXPECT_EQ(!RuntimeEnabledFeatures::ScrollUpdateOptimizationsEnabled(), GetDocument().View()->GetPaintArtifactCompositor()->NeedsUpdate());
    UpdateAllLifecyclePhasesForTest();
    EXPECT_EQ(ScrollOffset(0, 1), scrollable_area->GetScrollOffset());
}

TEST_P(MAYBE_PaintLayerScrollableAreaTest, ScrollWithFixedDoesNotNeedCompositingUpdate)
{
    SetBodyInnerHTML(R"HTML(
    <style>
      * {
...
TEST_P(MAYBE_PaintLayerScrollableAreaTest, ScrollWithLocalAttachmentBackgroundInScrollingContents)
{
    SetBodyInnerHTML(R"HTML(
    <style>
      #scroller {
    ...
    EXPECT_EQ(kBackgroundPaintInContentsSpace, scroller->ComputeBackgroundPaintLocationIfComposited());
...
TEST_P(MAYBE_PaintLayerScrollableAreaTest, ScrollWith3DPreserveParent)
{
    ...
    auto* scroller = GetLayoutBoxByElementId("scroller");
    EXPECT_EQ(kBackgroundPaintInBorderBoxSpace, scroller->ComputeBackgroundPaintLocationIfComposited());
}

TEST_P(MAYBE_PaintLayerScrollableAreaTest, ScrollWithLocalAttachmentBackgroundInMainLayer)
{
    SetBodyInnerHTML(R"HTML(
    <style>
      #scroller {
    ...
    auto* scroller = GetLayoutBoxByElementId("scroller");
    auto* scrollable_area = scroller->GetScrollableArea();
    EXPECT_EQ(kBackgroundPaintInBothSpaces, scroller->ComputeBackgroundPaintLocationIfComposited());
...
TEST_P(MAYBE_PaintLayerScrollableAreaTest, ViewScrollWithFixedAttachmentBackground)
{
    SetBodyInnerHTML(R"HTML(
    <style>
...
TEST_P(MAYBE_PaintLayerScrollableAreaTest, ViewScrollWithSolidColorFixedAttachmentBackground)
{
    SetBodyInnerHTML(R"HTML(
    <style>
      html, #fixed-background {
    ...
    EXPECT_EQ(kBackgroundPaintInContentsSpace, GetLayoutView().GetBackgroundPaintLocation());
    auto* fixed_background_div = GetLayoutBoxByElementId("fixed-background");
    EXPECT_EQ(kBackgroundPaintInContentsSpace, fixed_background_div->ComputeBackgroundPaintLocationIfComposited());
...
TEST_P(MAYBE_PaintLayerScrollableAreaTest, ViewScrollWithFixedAttachmentBackgroundPreferCompositingToLCDText)
{
    GetDocument().GetFrame()->GetSettings()->SetPreferCompositingToLCDTextEnabled(true);
    SetBodyInnerHTML(R"HTML(
    <style>
...
TEST_P(MAYBE_PaintLayerScrollableAreaTest, CompositedStickyDescendant)
{
    ...
    EXPECT_EQ(gfx::Vector2dF(0, 50), sticky->FirstFragment().PaintProperties()->StickyTranslation()->Translation2D());
}
...
TEST_P(MAYBE_PaintLayerScrollableAreaTest, IgnoreDelayedScrollOnDestroyedLayer)
{
    SetBodyInnerHTML(R"HTML(
...
TEST_P(MAYBE_PaintLayerScrollableAreaTest, ScrollingBackgroundVisualRect)
{
    ...
    EXPECT_EQ(gfx::Rect(2, 3, 101, 200), GetLayoutBoxByElementId("scroller")->GetScrollableArea()->ScrollingBackgroundVisualRect(PhysicalOffset()));
}
...
TEST_P(MAYBE_PaintLayerScrollableAreaTest, ApplyPendingHistoryRestoreScrollOffsetTwice)
{
    GetPage().GetSettings().SetTextAreasAreResizable(true);
    SetBodyInnerHTML(R"HTML(
    <!doctype HTML>
...
TEST_P(MAYBE_PaintLayerScrollableAreaTest, SetSnapContainerDataNeedsUpdate)
{
    ...
    auto* first_scrollable_area = To<LayoutBoxModelObject>(first_scroller)->GetScrollableArea();

    auto* second_scroller = GetLayoutObjectByElementId("second_scroller");
    auto* second_scrollable_area = To<LayoutBoxModelObject>(second_scroller)->GetScrollableArea();

    EXPECT_EQ(&first_scroller->GetDocument().GetSnapCoordinator(), &second_scroller->GetDocument().GetSnapCoordinator());
...
public:
    ScrollTimelineForTest(Document* document, Element* scroll_source)
        : ScrollTimeline(document, ScrollTimeline::ReferenceType::kSource, scroll_source, ScrollDirection::kVertical)
        , invalidated_(false)
    {
    }
...
TEST_P(MAYBE_PaintLayerScrollableAreaTest, ScrollTimelineInvalidation)
{
    ...
    ScrollTimelineForTest* scroll_timeline = MakeGarbageCollected<ScrollTimelineForTest>(&GetDocument(), scroller_element);
...
TEST_P(MAYBE_PaintLayerScrollableAreaTest, RootScrollbarShouldUseParentOfOverscrollNodeAsTransformNode)
{
    auto& document = GetDocument();
    document.GetFrame()->GetSettings()->SetPreferCompositingToLCDTextEnabled(true);
    SetBodyInnerHTML(R"HTML(
    <style>
    ::-webkit-scrollbar {
      width: 12px;
...

    {
        ...
        const auto& visual_viewport = document.View()->GetPage()->GetVisualViewport();
...
TEST_P(MAYBE_PaintLayerScrollableAreaTest, ResizeSmallerToBeScrollableWithResizerAndStackedChild)
{
    USE_NON_OVERLAY_SCROLLBARS();
