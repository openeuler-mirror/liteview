...
public:
    ...
    void Paint(const PaintInfo&, const PhysicalOffset& paint_offset, const LayoutUnit line_top, const LayoutUnit line_bottom);

    LayoutRect FrameRectClampedToLineTopAndBottomIfNeeded() const;

private:
    // LayoutNG version adapters.
    PhysicalRect PaintRectForImageStrip(const PhysicalRect& rect, TextDirection direction) const override;
    void PaintNormalBoxShadow(const PaintInfo& info, const ComputedStyle& style, const PhysicalRect& rect) override;
    void PaintInsetBoxShadow(const PaintInfo& info, const ComputedStyle& style, const PhysicalRect& rect) override;
    ...
    void RecordRegionCaptureData(const PaintInfo& paint_info, const PhysicalOffset& paint_offset);
