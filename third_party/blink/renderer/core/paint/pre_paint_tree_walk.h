...
public:
    ...
    // at all).
    NGPrePaintInfo CreatePrePaintInfo(const NGLink& child, const PrePaintTreeWalkContext& context);

    // Locate and/or set up a FragmentData object for the current object /
    // physical fragment.
    FragmentData* GetOrCreateFragmentData(const LayoutObject&, const PrePaintTreeWalkContext&, const NGPrePaintInfo&);

    void UpdateContextForOOFContainer(const LayoutObject&, PrePaintTreeWalkContext&, const NGPhysicalBoxFragment*);
    ...
    NOINLINE void WalkInternal(const LayoutObject&, PrePaintTreeWalkContext&, NGPrePaintInfo*);
    ...
    // otherwise.
    bool CollectMissableChildren(PrePaintTreeWalkContext&, const NGPhysicalBoxFragment&);
    ...
    void RebuildContextForMissedDescendant(const LayoutObject& ancestor, const LayoutObject& object, PrePaintTreeWalkContext&);
    ...
    void WalkMissedChildren(const LayoutObject& ancestor, const NGPhysicalBoxFragment&, const PrePaintTreeWalkContext&);

    void WalkFragmentationContextRootChildren(const LayoutObject&, const NGPhysicalBoxFragment&, const PrePaintTreeWalkContext&);
    void WalkLayoutObjectChildren(const LayoutObject&, const NGPhysicalBoxFragment*, const PrePaintTreeWalkContext&);
    void WalkChildren(const LayoutObject&, const NGPhysicalBoxFragment*, PrePaintTreeWalkContext&, bool is_inside_fragment_child = false);
