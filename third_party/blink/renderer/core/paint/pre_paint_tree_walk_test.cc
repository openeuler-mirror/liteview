...
TEST_P(PrePaintTreeWalkTest, PropertyTreesRebuiltWithBorderInvalidation)
{
    ...
    EXPECT_EQ(gfx::Vector2dF(100, 100), transformed_properties->Transform()->Translation2D());
...
TEST_P(PrePaintTreeWalkTest, PropertyTreesRebuiltWithCSSTransformInvalidation)
{
    ...
    EXPECT_EQ(gfx::Vector2dF(200, 200), transformed_properties->Transform()->Translation2D());
}
...
TEST_P(PrePaintTreeWalkTest, ClipChangeRepaintsDescendants)
{
    ...
    GetDocument().getElementById("parent")->setAttribute(html_names::kStyleAttr, "height: 100px");
    UpdateAllLifecyclePhasesExceptPaint();
...
TEST_P(PrePaintTreeWalkTest, EffectiveTouchActionStyleUpdate)
{
    ...
    GetDocument().getElementById("touchaction")->setAttribute(html_names::kClassAttr, "touchaction");
...
TEST_P(PrePaintTreeWalkTest, CullRectUpdateOnSVGTransformChange)
{
    ...
    GetDocument().getElementById("rect")->setAttribute(html_names::kStyleAttr, "transform: translateX(20px)");
    UpdateAllLifecyclePhasesExceptPaint();
    EXPECT_EQ(gfx::Rect(0, 0, 200, 200), foreign.FirstFragment().GetCullRect().Rect());

    GetDocument().getElementById("g")->setAttribute(html_names::kStyleAttr, "transform: translateY(20px)");
    UpdateAllLifecyclePhasesExceptPaint();
...
TEST_P(PrePaintTreeWalkTest, InlineOutlineWithContinuationPaintInvalidation)
{
    ...
    GetDocument().getElementById("child-span")->setAttribute(html_names::kStyleAttr, "color: blue");
    UpdateAllLifecyclePhasesForTest();
}
