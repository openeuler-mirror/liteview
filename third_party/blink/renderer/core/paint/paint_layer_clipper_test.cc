...
TEST_F(PaintLayerClipperTest, ParentBackgroundClipRectSubpixelAccumulation)
{
    ...
    target_paint_layer->Clipper(PaintLayer::GeometryMapperOption::kUseGeometryMapper).CalculateBackgroundClipRect(context, background_rect_gm);
    ...
    target_paint_layer->Clipper(PaintLayer::GeometryMapperOption::kDoNotUseGeometryMapper).CalculateBackgroundClipRect(context, background_rect_nogm);

    EXPECT_EQ(PhysicalRect(LayoutUnit(8.25), LayoutUnit(8.34375), LayoutUnit(300), LayoutUnit(300)), background_rect_nogm.Rect());
}
...
TEST_F(PaintLayerClipperTest, LayoutSVGRoot)
{
    ...
    target_paint_layer->Clipper(PaintLayer::GeometryMapperOption::kUseGeometryMapper)
        .CalculateRects(context, &target_paint_layer->GetLayoutObject().FirstFragment(), layer_offset, background_rect, foreground_rect);
...
TEST_F(PaintLayerClipperTest, RoundedClipNested)
{
    ...
    child_paint_layer->Clipper(PaintLayer::GeometryMapperOption::kUseGeometryMapper)
        .CalculateRects(context, &child_paint_layer->GetLayoutObject().FirstFragment(), layer_offset, background_rect, foreground_rect);
...
TEST_F(PaintLayerClipperTest, ControlClipSelect)
{
    ...
    EXPECT_GT(foreground_rect.Rect().X(), content_box_rect.X() + target->Location().X());
...
TEST_F(PaintLayerClipperTest, ContainPaintClip)
{
    ...
    layer->Clipper(PaintLayer::GeometryMapperOption::kUseGeometryMapper)
        .CalculateRects(context, &layer->GetLayoutObject().FirstFragment(), layer_offset, background_rect, foreground_rect);
    ...
    layer->Clipper(PaintLayer::GeometryMapperOption::kUseGeometryMapper)
        .CalculateRects(context_clip, &layer->GetLayoutObject().FirstFragment(), layer_offset, background_rect, foreground_rect);
...
TEST_F(PaintLayerClipperTest, CSSClip)
{
    ...
    target->Clipper(PaintLayer::GeometryMapperOption::kUseGeometryMapper)
        .CalculateRects(context, &target->GetLayoutObject().FirstFragment(), layer_offset, background_rect, foreground_rect);
...
TEST_F(PaintLayerClipperTest, Filter)
{
    ...
    target->Clipper(PaintLayer::GeometryMapperOption::kDoNotUseGeometryMapper).CalculateRects(context, nullptr, layer_offset, background_rect, foreground_rect);
    ...
    foreground_rect = infinite_rect;
    target->Clipper(PaintLayer::GeometryMapperOption::kUseGeometryMapper)
        .CalculateRects(root_context, &target->GetLayoutObject().FirstFragment(), layer_offset, background_rect, foreground_rect);
    ...
    target->Clipper(PaintLayer::GeometryMapperOption::kDoNotUseGeometryMapper)
        .CalculateRects(root_context, nullptr, layer_offset, background_rect, foreground_rect);
    EXPECT_EQ(PhysicalRect(38, 41, 204, 304), background_rect.Rect());
    EXPECT_EQ(PhysicalRect(90, 90, 100, 200), foreground_rect.Rect());
}
...
{
    return rect.X().Round() < -10000000 && rect.Right().Round() > 10000000 && rect.Y().Round() < -10000000 && rect.Bottom().Round() > 10000000;
}
...
TEST_F(PaintLayerClipperTest, Fragmentation)
{
    ...
    PaintLayer* target_paint_layer = GetPaintLayerByElementId("target");
    EXPECT_TRUE(target_paint_layer->GetLayoutObject().FirstFragment().NextFragment());
    EXPECT_FALSE(target_paint_layer->GetLayoutObject().FirstFragment().NextFragment()->NextFragment());
    ...
    if (RuntimeEnabledFeatures::LayoutNGBlockFragmentationEnabled()) {
        ...
        EXPECT_EQ(PhysicalRect(-1000000, -1000000, 2000000, 1000100), background_rect.Rect());
        EXPECT_EQ(PhysicalRect(-1000000, -1000000, 2000000, 1000100), foreground_rect.Rect());
    }
    EXPECT_EQ(PhysicalOffset(), layer_offset);

    target_paint_layer->Clipper(PaintLayer::GeometryMapperOption::kUseGeometryMapper)
        .CalculateRects(context, target_paint_layer->GetLayoutObject().FirstFragment().NextFragment(), layer_offset, background_rect, foreground_rect);
...
TEST_F(PaintLayerClipperTest, ScrollbarClipBehaviorChild)
{
    ...
    child_paint_layer->Clipper(PaintLayer::GeometryMapperOption::kDoNotUseGeometryMapper)
        .CalculateRects(context, nullptr, layer_offset, background_rect, foreground_rect);
...
TEST_F(PaintLayerClipperTest, ScrollbarClipBehaviorParent)
{
    ...
    PhysicalOffset layer_offset;
    ClipRect background_rect, foreground_rect;
    parent_paint_layer->Clipper(PaintLayer::GeometryMapperOption::kUseGeometryMapper)
        .CalculateRects(context, &parent_paint_layer->GetLayoutObject().FirstFragment(), layer_offset, background_rect, foreground_rect);
    ...
    parent_paint_layer->Clipper(PaintLayer::GeometryMapperOption::kDoNotUseGeometryMapper)
        .CalculateRects(context, nullptr, layer_offset, background_rect, foreground_rect);
