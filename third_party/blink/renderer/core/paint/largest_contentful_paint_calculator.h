...
public:
    ...
    void UpdateLargestContentfulPaintIfNeeded(const TextRecord* largest_text, const ImageRecord* largest_image);
...
private:
    ...
    std::unique_ptr<TracedValue> TextCandidateTraceData(const TextRecord& largest_text);
    std::unique_ptr<TracedValue> ImageCandidateTraceData(const ImageRecord* largest_image);
