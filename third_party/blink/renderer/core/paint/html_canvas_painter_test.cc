...
protected:
    ...
    std::unique_ptr<Canvas2DLayerBridge> MakeCanvas2DLayerBridge(const gfx::Size& size)
    {
        return std::make_unique<Canvas2DLayerBridge>(size, RasterMode::kGPU, kNonOpaque);
    }
