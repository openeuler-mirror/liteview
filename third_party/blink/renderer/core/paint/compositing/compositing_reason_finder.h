...
public:
    ...
    static CompositingReasons DirectReasonsForPaintPropertiesExceptScrolling(const LayoutObject&, const LayoutObject* container_for_fixed_position = nullptr);
    ...
    static CompositingReasons DirectReasonsForPaintProperties(const LayoutObject&, CompositingReasons reasons_except_scrolling);
