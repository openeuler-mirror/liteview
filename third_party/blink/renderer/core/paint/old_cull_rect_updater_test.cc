...
INSTANTIATE_TEST_SUITE_P(All, OldCullRectUpdaterTest, ::testing::Values(0, kScrollUnification));
...
TEST_P(OldCullRectUpdaterTest, AbsolutePositionUnderNonContainingStackingContext)
{
...
class OldCullRectUpdateOnPaintPropertyChangeTest : public OldCullRectUpdaterTest {
protected:
...
INSTANTIATE_TEST_SUITE_P(All, OldCullRectUpdateOnPaintPropertyChangeTest, ::testing::Values(0, kScrollUnification));
...
{
    TestTargetChange("transform: translateX(10px)", "transform: translateX(20px)", false, true, false);
...
TEST_P(OldCullRectUpdateOnPaintPropertyChangeTest, SmallContentsScroll)
{
    ...
    TestTargetScroll(ScrollOffset(100, 200), ScrollOffset(1000, 1000), false, true, false);
    TestTargetScroll(ScrollOffset(1000, 1000), ScrollOffset(), false, true, false);
}
...
TEST_P(OldCullRectUpdateOnPaintPropertyChangeTest, LargeContentsScroll)
{
    ...
    TestTargetScroll(ScrollOffset(), ScrollOffset(100, 200), false, true, false);
    TestTargetScroll(ScrollOffset(100, 200), ScrollOffset(8000, 8000), false, true, true);
