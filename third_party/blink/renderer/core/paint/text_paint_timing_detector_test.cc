...
class ParameterizedTextPaintTimingDetectorTest : public ::testing::WithParamInterface<bool>, private ScopedLayoutNGForTest, public TextPaintTimingDetectorTest {
public:
...
INSTANTIATE_TEST_SUITE_P(All, ParameterizedTextPaintTimingDetectorTest, testing::Bool());
...
TEST_F(TextPaintTimingDetectorTest, NodeRemovedBeforeAssigningPresentationTime)
{
    ...
    UpdateAllLifecyclePhases();
    GetDocument().getElementById("parent")->RemoveChild(GetDocument().getElementById("remove"));
    InvokeCallback();
    EXPECT_EQ(TextRecordOfLargestTextPaint(), nullptr);
}
