...
TEST_P(PaintPropertyTreeUpdateTest, ThreadedScrollingDisabledMainThreadScrollReason)
{
    ...
    EXPECT_FALSE(overflow_a->GetLayoutObject()->FirstFragment().PaintProperties()->ScrollTranslation()->ScrollNode()->ThreadedScrollingDisabled());
    ...
    EXPECT_TRUE(overflow_a->GetLayoutObject()->FirstFragment().PaintProperties()->ScrollTranslation()->ScrollNode()->ThreadedScrollingDisabled());
}
...
TEST_P(PaintPropertyTreeUpdateTest, BackgroundAttachmentFixedMainThreadScrollReasonsWithNestedScrollers)
{
    ...
    EXPECT_TRUE(overflow_a->GetLayoutObject()->FirstFragment().PaintProperties()->ScrollTranslation()->ScrollNode()->HasBackgroundAttachmentFixedDescendants());
    EXPECT_TRUE(overflow_b->GetLayoutObject()->FirstFragment().PaintProperties()->ScrollTranslation()->ScrollNode()->HasBackgroundAttachmentFixedDescendants());
    ...
    EXPECT_FALSE(
        overflow_a->GetLayoutObject()->FirstFragment().PaintProperties()->ScrollTranslation()->ScrollNode()->HasBackgroundAttachmentFixedDescendants());
    EXPECT_FALSE(
        overflow_b->GetLayoutObject()->FirstFragment().PaintProperties()->ScrollTranslation()->ScrollNode()->HasBackgroundAttachmentFixedDescendants());
...
TEST_P(PaintPropertyTreeUpdateTest, BuildingStopsAtThrottledFrames)
{
    ...
    auto* iframe_transform = ChildDocument().getElementById("iframeTransform")->GetLayoutObject();
    ...
    GetDocument().View()->UpdateLifecycleToPrePaintClean(DocumentUpdateReason::kTest);
    EXPECT_FALSE(GetDocument().GetLayoutView()->DescendantNeedsPaintPropertyUpdate());
    EXPECT_FALSE(transform->DescendantNeedsPaintPropertyUpdate());
    EXPECT_FALSE(iframe_layout_view->NeedsPaintPropertyUpdate());
...
TEST_P(PaintPropertyTreeUpdateTest, ClipChangesUpdateOverflowClip)
{
    ...
    div->setAttribute(html_names::kStyleAttr, "display:inline-block; width:7px; padding-right:3px;");
    UpdateAllLifecyclePhasesForTest();
    clip_properties = div->GetLayoutObject()->FirstFragment().PaintProperties()->OverflowClip();
    EXPECT_CLIP_RECT(gfx::RectF(0, 0, 10, 0), clip_properties);
    div->setAttribute(html_names::kStyleAttr, "display:inline-block; width:8px; padding-right:2px;");
    UpdateAllLifecyclePhasesForTest();
    EXPECT_CLIP_RECT(gfx::RectF(0, 0, 10, 0), clip_properties);
...
TEST_P(PaintPropertyTreeUpdateTest, TransformUpdatesOnRelativeLengthChanges)
{
    ...
    EXPECT_EQ(gfx::Vector2dF(50, 100), transform_object->FirstFragment().PaintProperties()->Transform()->Translation2D());

    transform->setAttribute(html_names::kStyleAttr, "width: 200px; height: 300px;");
    UpdateAllLifecyclePhasesForTest();
    EXPECT_EQ(gfx::Vector2dF(100, 150), transform_object->FirstFragment().PaintProperties()->Transform()->Translation2D());
}
...
TEST_P(PaintPropertyTreeUpdateTest, ScrollBoundsChange)
{
    ...
    GetDocument().getElementById("content")->setAttribute(html_names::kStyleAttr, "width: 200px; height: 300px");
    UpdateAllLifecyclePhasesForTest();
...
TEST_P(PaintPropertyTreeUpdateTest, Preserve3DChange)
{
    ...
    GetDocument().getElementById("parent")->setAttribute(html_names::kStyleAttr, "transform-style: preserve-3d");
    UpdateAllLifecyclePhasesForTest();
...
TEST_P(PaintPropertyTreeUpdateTest, BoxAddRemoveMask)
{
    ...
    target->setAttribute(html_names::kStyleAttr, "-webkit-mask: linear-gradient(red, blue)");
    UpdateAllLifecyclePhasesForTest();
...
TEST_P(PaintPropertyTreeUpdateTest, MaskClipNodeBoxSizeChange)
{
    ...
    GetDocument().getElementById("target")->setAttribute(html_names::kStyleAttr, "height: 200px");
    UpdateAllLifecyclePhasesForTest();
...
TEST_P(PaintPropertyTreeUpdateTest, MaskClipNodeInlineBoundsChange)
{
    ...
    GetDocument().getElementById("img")->setAttribute(html_names::kStyleAttr, "width: 100px");
    UpdateAllLifecyclePhasesForTest();
...
TEST_P(PaintPropertyTreeUpdateTest, WillTransformChangeAboveFixed)
{
    ...
    To<Element>(container->GetNode())->setAttribute(html_names::kStyleAttr, "will-change: top");
    UpdateAllLifecyclePhasesForTest();
    ...
    To<Element>(container->GetNode())->setAttribute(html_names::kStyleAttr, "will-change: transform");
    UpdateAllLifecyclePhasesForTest();
    EXPECT_EQ(container->FirstFragment().PaintProperties()->Transform(), &fixed->FirstFragment().LocalBorderBoxProperties().Transform());
}
...
TEST_P(PaintPropertyTreeUpdateTest, CompositingReasonForAnimation)
{
    ...
    target->setAttribute(html_names::kStyleAttr, "transform: translateX(11px); filter: opacity(40%)");
    UpdateAllLifecyclePhasesForTest();
...
TEST_P(PaintPropertyTreeUpdateTest, FragmentClipUpdateOnMulticolContainerWidthChange)
{
    ...
    const auto* clip0 = FragmentAt(flow_thread, 0).PaintProperties()->FragmentClip();
    EXPECT_EQ(1000000, clip0->LayoutClipRect().Rect().right());
    EXPECT_EQ(1000000, clip0->PaintClipRect().Rect().right());
    const auto* clip1 = FragmentAt(flow_thread, 1).PaintProperties()->FragmentClip();
    EXPECT_EQ(-999950, clip1->LayoutClipRect().Rect().x());
    EXPECT_EQ(-999950, clip1->PaintClipRect().Rect().x());

    GetDocument().getElementById("container")->setAttribute(html_names::kStyleAttr, "width: 500px");
    UpdateAllLifecyclePhasesForTest();
    ASSERT_EQ(2u, NumFragments(flow_thread));
    EXPECT_EQ(clip0, FragmentAt(flow_thread, 0).PaintProperties()->FragmentClip());
    EXPECT_EQ(1000000, clip0->LayoutClipRect().Rect().right());
    EXPECT_EQ(1000000, clip0->PaintClipRect().Rect().right());
    EXPECT_EQ(clip1, FragmentAt(flow_thread, 1).PaintProperties()->FragmentClip());
...
TEST_P(PaintPropertyTreeUpdateTest, PropertyTreesRebuiltAfterSVGBlendModeChange)
{
    ...
    blended_element->setAttribute(html_names::kStyleAttr, "mix-blend-mode: lighten;");
    UpdateAllLifecyclePhasesForTest();
...
TEST_P(PaintPropertyTreeUpdateTest, ForwardReferencedSVGElementUpdate)
{
    ...
    EXPECT_EQ(MakeTranslationMatrix(1, 0),
        GeometryMapper::SourceToDestinationProjection(*rect_properties->Transform(), *svg2_properties->PaintOffsetTranslation()).Matrix());
    ...
    GetDocument().getElementById("svg2")->setAttribute("transform", "translate(2)");
    UpdateAllLifecyclePhasesForTest();
...
TEST_P(PaintPropertyTreeUpdateTest, OverflowClipUpdateForImage)
{
    ...
    target->setAttribute(html_names::kStyleAttr, "overflow-clip-margin: padding-box;");
    UpdateAllLifecyclePhasesForTest();
    properties = PaintPropertiesForElement("target");
    // Changing overflow-clip-margin induces a clip node.
    EXPECT_NE(nullptr, properties);

    target->setAttribute(html_names::kStyleAttr, "object-fit: none; border-radius: 2px");
    UpdateAllLifecyclePhasesForTest();
    properties = PaintPropertiesForElement("target");
    ...
    target->setAttribute(html_names::kStyleAttr, "object-fit: none; border-radius: 3px");
    UpdateAllLifecyclePhasesForTest();
    ...
    target->setAttribute(html_names::kStyleAttr, "object-fit: none; border-radius: 3px; padding: 1px 2px 3px 4px");
    UpdateAllLifecyclePhasesForTest();
    ASSERT_EQ(properties, PaintPropertiesForElement("target"));
    ASSERT_TRUE(properties->OverflowClip());
...
TEST_P(PaintPropertyTreeUpdateTest, OverflowClipUpdateForVideo)
{
    ...
    // We should update clip rect on padding change.
    target->setAttribute(html_names::kStyleAttr, "object-fit: none; padding: 1px 2px 3px 4px");
    UpdateAllLifecyclePhasesForTest();
    ASSERT_EQ(properties, PaintPropertiesForElement("target"));
    ASSERT_TRUE(properties->OverflowClip());
...
TEST_P(PaintPropertyTreeUpdateTest, SubpixelAccumulationAcrossIsolation)
{
    ...
    EXPECT_EQ(gfx::Vector2dF(10, 0), isolation_properties->PaintOffsetTranslation()->Translation2D());
    ...
    EXPECT_EQ(gfx::Vector2dF(13, 0), isolation_properties->PaintOffsetTranslation()->Translation2D());
    EXPECT_EQ(PhysicalOffset(), child->FirstFragment().PaintOffset());
}
...
TEST_P(PaintPropertyTreeUpdateTest, ChangeDuringAnimation)
{
    ...
    transform.Operations().push_back(RotateTransformOperation::Create(10, TransformOperation::kRotate));
    style->SetTransform(transform);
    style->SetTransformOrigin(TransformOrigin(Length(70, Length::kFixed), Length(30, Length::kFixed), 0));
    target->SetStyle(std::move(style));
    EXPECT_TRUE(target->NeedsPaintPropertyUpdate());
    GetDocument().Lifecycle().AdvanceTo(DocumentLifecycle::kStyleClean);
    {
...
TEST_P(PaintPropertyTreeUpdateTest, InlineFilterReferenceBoxChange)
{
    ...
    GetDocument().getElementById("spacer")->setAttribute(html_names::kStyleAttr, "display: inline-block; height: 100px");
    UpdateAllLifecyclePhasesForTest();
...
TEST_P(PaintPropertyTreeUpdateTest, StartSVGAnimation)
{
    ...
    GetDocument().getElementById("line")->setAttribute(html_names::kStyleAttr, "transform: translateY(100px)");
    UpdateAllLifecyclePhasesForTest();
...
TEST_P(PaintPropertyTreeUpdateTest, ScrollNonStackingContextContainingStacked)
{
    ...
    scroller->setAttribute(html_names::kStyleAttr, "position: absolute; will-change: transform");
...
TEST_P(PaintPropertyTreeUpdateTest, ScrollOriginChange)
{
    ...
    EXPECT_EQ(gfx::Vector2dF(-20, 0), container_properties->ScrollTranslation()->Translation2D());
    EXPECT_EQ(PhysicalOffset(), child1->FirstFragment().PaintOffset());
    EXPECT_EQ(PhysicalOffset(), child2->FirstFragment().PaintOffset());

    To<Element>(child2->GetNode())->setAttribute(html_names::kStyleAttr, "width: 100px");
    UpdateAllLifecyclePhasesForTest();
    EXPECT_EQ(gfx::Vector2dF(-120, 0), container_properties->ScrollTranslation()->Translation2D());
...
TEST_P(PaintPropertyTreeUpdateTest, IFrameContainStrictChangeBorderTopWidth)
{
    ...
    EXPECT_EQ(gfx::Vector2dF(2, 2), child_view_properties->PaintOffsetTranslation()->Translation2D());

    GetDocument().getElementById("iframe")->setAttribute(html_names::kStyleAttr, "border-top-width: 10px");
    UpdateAllLifecyclePhasesForTest();
    EXPECT_EQ(gfx::Vector2dF(2, 10), child_view_properties->PaintOffsetTranslation()->Translation2D());
}
...
TEST_P(PaintPropertyTreeUpdateTest, ChangeMaskOutputClip)
{
    ...
    GetDocument().getElementById("container")->setAttribute(html_names::kStyleAttr, "width: 100px; height: 100px");
    UpdateAllLifecyclePhasesExceptPaint();
