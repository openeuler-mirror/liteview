...
public:
    ...
    public:
        ...
        static bool RelayoutIsPrevented()
        {
            return count_;
        }
        static void SetBoxNeedsLayout(PaintLayerScrollableArea&, bool had_horizontal_scrollbar, bool had_vertical_scrollbar);
        static bool RelayoutNeeded()
        {
            return count_ == 0 && relayout_needed_;
        }
    ...
    PhysicalRect ScrollIntoView(const PhysicalRect&, const mojom::blink::ScrollIntoViewParamsPtr&) override;
    ...
    void UpdateNeedsCompositedScrolling(bool force_prefer_compositing_to_lcd_text);
    bool NeedsCompositedScrolling() const
    {
        return needs_composited_scrolling_;
    }
#if DCHECK_IS_ON()
    void CheckNeedsCompositedScrollingIsUpToDate(bool force_prefer_compositing_to_lcd_text)
    {
        DCHECK_EQ(needs_composited_scrolling_, ComputeNeedsCompositedScrolling(force_prefer_compositing_to_lcd_text));
    }
#endif
    ...
    absl::optional<gfx::PointF> GetSnapPositionAndSetTarget(const cc::SnapSelectionStrategy& strategy) override;

    void DisposeImpl() override;

    void SetPendingHistoryRestoreScrollOffset(const HistoryItem::ViewState& view_state, bool should_restore_scroll) override
    {
...
private:
    ...
    bool ComputeNeedsCompositedScrolling(bool force_prefer_compositing_to_lcd_text);
    ...
    bool ComputeNeedsCompositedScrollingInternal(BackgroundPaintLocation background_paint_location_if_composited, bool force_prefer_compositing_to_lcd_text);
    ...
    void InvalidatePaintOfScrollbarIfNeeded(const PaintInvalidatorContext&, bool needs_paint_invalidation, Scrollbar* scrollbar, bool& previously_was_overlay,
        bool& previously_was_directly_composited, gfx::Rect& visual_rect);
