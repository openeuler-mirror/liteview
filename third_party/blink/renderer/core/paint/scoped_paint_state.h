...
public:
    ...
    ScopedPaintState(const LayoutObject&, const PaintInfo&, const FragmentData*, bool painting_legacy_table_part_in_ancestor_layer = false);

    ScopedPaintState(const LayoutObject& object, const PaintInfo& paint_info, bool painting_legacy_table_part_in_ancestor_layer = false)
        : ScopedPaintState(object, paint_info, paint_info.FragmentToPaint(object), painting_legacy_table_part_in_ancestor_layer)
    {
    }

    ScopedPaintState(const NGPhysicalFragment& fragment, const PaintInfo& paint_info)
        : ScopedPaintState(*fragment.GetLayoutObject(), paint_info, paint_info.FragmentToPaint(fragment))
    {
    }
...
protected:
    ...
    ScopedPaintState(const PaintInfo& paint_info, const PhysicalOffset& paint_offset, const LayoutObject& object)
...
public:
    ...
    ScopedBoxContentsPaintState(const PaintInfo& paint_info, const PhysicalOffset& paint_offset, const LayoutBox& box)
