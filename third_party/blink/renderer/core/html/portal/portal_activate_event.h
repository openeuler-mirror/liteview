...
class ScriptState;
class ScriptValue;
using OnPortalActivatedCallback = base::OnceCallback<void(mojom::blink::PortalActivateResult)>;
...
public:
    // For use by Blink.
    static PortalActivateEvent* Create(LocalFrame* frame, const PortalToken& predecessor_portal_token,
    ...
    static PortalActivateEvent* Create(const AtomicString& type, const PortalActivateEventInit*);

    PortalActivateEvent(Document* document, const PortalToken& predecessor_portal_token, mojo::PendingAssociatedRemote<mojom::blink::Portal> predecessor_portal,
        mojo::PendingAssociatedReceiver<mojom::blink::PortalClient> predecessor_portal_client_receiver, UnpackedSerializedScriptValue* data, MessagePortArray*,
...
private:
    ...
    mojo::PendingAssociatedReceiver<mojom::blink::PortalClient> predecessor_portal_client_receiver_;
    ...
    // |data_from_init_|.
    HeapHashMap<WeakMember<ScriptState>, TraceWrapperV8Reference<v8::Value>> v8_data_;
