...
class DocumentPortals final : public GarbageCollected<DocumentPortals>, public Supplement<Document> {
public:
    ...
    void ClearActivatingPortalContents()
    {
        activating_portal_ = nullptr;
    }
