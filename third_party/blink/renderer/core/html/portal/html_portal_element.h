...
public:
    ...
    explicit HTMLPortalElement(Document& document, const PortalToken* portal_token = nullptr,
    ...
    bool IsHTMLPortalElement() const final
    {
        return true;
    }
    ...
    void postMessage(ScriptState* script_state, const ScriptValue& message, const PostMessageOptions* options, ExceptionState& exception_state);
...
template <> struct DowncastTraits<HTMLPortalElement> {
