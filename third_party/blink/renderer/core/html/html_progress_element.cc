...
LayoutObject* HTMLProgressElement::CreateLayoutObject(const ComputedStyle& style, LegacyLayout legacy)
{
...
{
    value_->SetInlineStyleProperty(CSSPropertyID::kWidth, width, CSSPrimitiveValue::UnitType::kPercentage);
}
