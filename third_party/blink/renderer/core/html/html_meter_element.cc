...
LayoutObject* HTMLMeterElement::CreateLayoutObject(const ComputedStyle& style, LegacyLayout legacy)
{
...
void HTMLMeterElement::UpdateValueAppearance(double percentage)
{
    ...
    value_->SetInlineStyleProperty(CSSPropertyID::kWidth, percentage, CSSPrimitiveValue::UnitType::kPercentage);
