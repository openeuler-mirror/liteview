...
void HTMLLinkElement::ParseAttribute(const AttributeModificationParams& params)
{
    ...
    if (name == html_names::kRelAttr) {
        ...
        Process();
    } else if (name == html_names::kBlockingAttr && RuntimeEnabledFeatures::BlockingAttributeEnabled()) {
...
const QualifiedName& HTMLLinkElement::SubResourceAttributeName() const
{
    ...
    if (EqualIgnoringASCIICase(FastGetAttribute(html_names::kTypeAttr), "text/css")) {
