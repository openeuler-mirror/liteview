...
class CloseWatcher final : public EventTargetWithInlineData, public ExecutionContextClient {
...
public:
    ...
    bool IsGroupedWithPrevious() const
    {
        return grouped_with_previous_;
    }
