...
constexpr std::pair<WebEffectiveConnectionType, const char*> kVisibleLoadTimeAboveTheFoldHistogramNames[] = {
    { WebEffectiveConnectionType::kTypeSlow2G, "Blink.VisibleLoadTime.LazyLoadEligibleFrames.AboveTheFold.Slow2G" },
    { WebEffectiveConnectionType::kType2G, "Blink.VisibleLoadTime.LazyLoadEligibleFrames.AboveTheFold.2G" },
    { WebEffectiveConnectionType::kType3G, "Blink.VisibleLoadTime.LazyLoadEligibleFrames.AboveTheFold.3G" },
    { WebEffectiveConnectionType::kType4G, "Blink.VisibleLoadTime.LazyLoadEligibleFrames.AboveTheFold.4G" },
};

constexpr std::pair<WebEffectiveConnectionType, const char*> kVisibleLoadTimeBelowTheFoldHistogramNames[] = {
    { WebEffectiveConnectionType::kTypeSlow2G, "Blink.VisibleLoadTime.LazyLoadEligibleFrames.BelowTheFold.Slow2G" },
    { WebEffectiveConnectionType::kType2G, "Blink.VisibleLoadTime.LazyLoadEligibleFrames.BelowTheFold.2G" },
    { WebEffectiveConnectionType::kType3G, "Blink.VisibleLoadTime.LazyLoadEligibleFrames.BelowTheFold.3G" },
    { WebEffectiveConnectionType::kType4G, "Blink.VisibleLoadTime.LazyLoadEligibleFrames.BelowTheFold.4G" },
};

constexpr std::pair<WebEffectiveConnectionType, const char*> kInitialDeferralActionHistogramNames[] = {
    { WebEffectiveConnectionType::kTypeUnknown, "Blink.LazyLoad.CrossOriginFrames.InitialDeferralAction.Unknown" },
    { WebEffectiveConnectionType::kTypeOffline, "Blink.LazyLoad.CrossOriginFrames.InitialDeferralAction.Offline" },
    { WebEffectiveConnectionType::kTypeSlow2G, "Blink.LazyLoad.CrossOriginFrames.InitialDeferralAction.Slow2G" },
    { WebEffectiveConnectionType::kType2G, "Blink.LazyLoad.CrossOriginFrames.InitialDeferralAction.2G" },
    { WebEffectiveConnectionType::kType3G, "Blink.LazyLoad.CrossOriginFrames.InitialDeferralAction.3G" },
    { WebEffectiveConnectionType::kType4G, "Blink.LazyLoad.CrossOriginFrames.InitialDeferralAction.4G" },
};
...
class LazyLoadFramesParamsTest
    : public SimTest,
      public ::testing::WithParamInterface<std::tuple<LazyFrameLoadingFeatureStatus, LazyFrameVisibleLoadTimeFeatureStatus, WebEffectiveConnectionType>> {
public:
    static constexpr int kViewportWidth = 800;
    static constexpr int kViewportHeight = 600;

    LazyLoadFramesParamsTest()
        : scoped_lazy_frame_loading_for_test_(std::get<LazyFrameLoadingFeatureStatus>(GetParam()) == LazyFrameLoadingFeatureStatus::kEnabled)
        , scoped_lazy_frame_visible_load_time_metrics_for_test_(
              std::get<LazyFrameVisibleLoadTimeFeatureStatus>(GetParam()) == LazyFrameVisibleLoadTimeFeatureStatus::kEnabled)
    {
    }
    ...
    void SetUp() override
    {
        ...
        settings.SetLazyLoadEnabled(RuntimeEnabledFeatures::LazyFrameLoadingEnabled());
    }
    ...
    void ExpectVisibleLoadTimeHistogramSamplesIfApplicable(int expected_above_the_fold_count, int expected_below_the_fold_count)
    {
        ...
        for (const auto& pair : kVisibleLoadTimeAboveTheFoldHistogramNames) {
            histogram_tester()->ExpectTotalCount(
                pair.second, std::get<WebEffectiveConnectionType>(GetParam()) == pair.first ? expected_above_the_fold_count : 0);
        }
        for (const auto& pair : kVisibleLoadTimeBelowTheFoldHistogramNames) {
            histogram_tester()->ExpectTotalCount(
                pair.second, std::get<WebEffectiveConnectionType>(GetParam()) == pair.first ? expected_below_the_fold_count : 0);
        }
    }

    void ExpectInitialDeferralActionHistogramSamplesIfApplicable(LazyLoadFrameObserver::FrameInitialDeferralAction action, int expected_count)
    {
        for (const auto& pair : kInitialDeferralActionHistogramNames) {
            if (RuntimeEnabledFeatures::LazyFrameLoadingEnabled() && std::get<WebEffectiveConnectionType>(GetParam()) == pair.first) {
                histogram_tester()->ExpectUniqueSample(pair.second, static_cast<int>(action), expected_count);
            } else {
    ...
    void ExpectLoadStartedAfterDeferredSamplesIfApplicable(int expected_count)
    {
        if (RuntimeEnabledFeatures::LazyFrameLoadingEnabled()) {
            histogram_tester()->ExpectUniqueSample("Blink.LazyLoad.CrossOriginFrames.LoadStartedAfterBeingDeferred",
                static_cast<int>(std::get<WebEffectiveConnectionType>(GetParam())), expected_count);
        } else {
            histogram_tester()->ExpectTotalCount("Blink.LazyLoad.CrossOriginFrames.LoadStartedAfterBeingDeferred", 0);
        }
    }

    void ExpectVisibleAfterDeferredSamplesIfApplicable(int expected_count)
    {
        if (RuntimeEnabledFeatures::LazyFrameLoadingEnabled() && RuntimeEnabledFeatures::LazyFrameVisibleLoadTimeMetricsEnabled()) {
            histogram_tester()->ExpectUniqueSample("Blink.LazyLoad.CrossOriginFrames.VisibleAfterBeingDeferred",
                static_cast<int>(std::get<WebEffectiveConnectionType>(GetParam())), expected_count);
        } else {
            histogram_tester()->ExpectTotalCount("Blink.LazyLoad.CrossOriginFrames.VisibleAfterBeingDeferred", 0);
        }
    }
    ...
    std::unique_ptr<SimRequest> LoadPageWithCrossOriginFrameFarFromViewport()
    {
        ...
        EXPECT_EQ(RuntimeEnabledFeatures::LazyFrameLoadingEnabled(), ConsoleMessages().Contains("main body onload"));
        EXPECT_FALSE(ConsoleMessages().Contains("child frame element onload"));

        ExpectVisibleLoadTimeHistogramSamplesIfApplicable(0, 0);

        ExpectInitialDeferralActionHistogramSamplesIfApplicable(LazyLoadFrameObserver::FrameInitialDeferralAction::kDeferred, 1);
        histogram_tester()->ExpectTotalCount("Blink.LazyLoad.CrossOriginFrames.LoadStartedAfterBeingDeferred", 0);
        histogram_tester()->ExpectTotalCount("Blink.LazyLoad.CrossOriginFrames.VisibleAfterBeingDeferred", 0);
...
TEST_P(LazyLoadFramesParamsTest, SameOriginFrame)
{
    ...
    ExpectVisibleLoadTimeHistogramSamplesIfApplicable(0, 0);
    histogram_tester()->ExpectTotalCount("Blink.VisibleBeforeLoaded.LazyLoadEligibleFrames.BelowTheFold", 0);
...
TEST_P(LazyLoadFramesParamsTest, AboveTheFoldFrame)
{
    ...
    ExpectInitialDeferralActionHistogramSamplesIfApplicable(LazyLoadFrameObserver::FrameInitialDeferralAction::kLoadedNearOrInViewport, 1);
    histogram_tester()->ExpectTotalCount("Blink.LazyLoad.CrossOriginFrames.LoadStartedAfterBeingDeferred", 0);
    histogram_tester()->ExpectTotalCount("Blink.LazyLoad.CrossOriginFrames.VisibleAfterBeingDeferred", 0);
}
...
TEST_P(LazyLoadFramesParamsTest, CrossOriginFrameFarFromViewportBecomesVisibleBeforeFinishedLoading)
{
    ...
    if (RuntimeEnabledFeatures::LazyFrameVisibleLoadTimeMetricsEnabled()) {
        ...
        histogram_tester()->ExpectUniqueSample(
            "Blink.VisibleBeforeLoaded.LazyLoadEligibleFrames.BelowTheFold", static_cast<int>(std::get<WebEffectiveConnectionType>(GetParam())), 1);
    } else {
        histogram_tester()->ExpectTotalCount("Blink.VisibleBeforeLoaded.LazyLoadEligibleFrames.BelowTheFold", 0);
    }
    ...
    histogram_tester()->ExpectTotalCount(
        "Blink.VisibleBeforeLoaded.LazyLoadEligibleFrames.BelowTheFold", RuntimeEnabledFeatures::LazyFrameVisibleLoadTimeMetricsEnabled() ? 1 : 0);
...
TEST_P(LazyLoadFramesParamsTest, AboutBlankChildFrameNavigation)
{
    ...
    EXPECT_TRUE(ConsoleMessages().Contains("main body onload"));
    EXPECT_EQ(1, static_cast<int>(std::count(ConsoleMessages().begin(), ConsoleMessages().end(), "child frame element onload")));
    ...
    EXPECT_EQ(2, static_cast<int>(std::count(ConsoleMessages().begin(), ConsoleMessages().end(), "child frame element onload")));
    ...
    histogram_tester()->ExpectTotalCount("Blink.LazyLoad.CrossOriginFrames.LoadStartedAfterBeingDeferred", expected_histogram_count);
    histogram_tester()->ExpectTotalCount("Blink.LazyLoad.CrossOriginFrames.VisibleAfterBeingDeferred", 0);
}
...
INSTANTIATE_TEST_SUITE_P(LazyFrameLoading, LazyLoadFramesParamsTest,
    ::testing::Combine(::testing::Values(LazyFrameLoadingFeatureStatus::kDisabled, LazyFrameLoadingFeatureStatus::kEnabled),
        ::testing::Values(LazyFrameVisibleLoadTimeFeatureStatus::kDisabled, LazyFrameVisibleLoadTimeFeatureStatus::kEnabled),
...
public:
    LazyEmbedsTest()
    {
        feature_list_.InitWithFeaturesAndParameters(
            {
                { features::kAutomaticLazyFrameLoadingToEmbeds, { { "timeout", "3000" } } },
...
TEST_P(LazyEmbedsTest, HiddenAndTinyFrames)
{
    ...
    SimRequest display_none_frame_resource("https://crossorigin.com/display_none.html", "text/html");
    SimRequest visibility_hidden_frame_resource("https://crossorigin.com/visibility_hidden.html", "text/html");
    SimRequest tiny_frame_resource("https://crossorigin.com/tiny.html", "text/html");
    SimRequest tiny_width_frame_resource("https://crossorigin.com/tiny_width.html", "text/html");
    SimRequest tiny_height_frame_resource("https://crossorigin.com/tiny_height.html", "text/html");
    SimRequest off_screen_left_frame_resource("https://crossorigin.com/off_screen_left.html", "text/html");
    SimRequest off_screen_top_frame_resource("https://crossorigin.com/off_screen_top.html", "text/html");
    ...
    GetDocument().View()->LayoutViewport()->SetScrollOffset(
        ScrollOffset(0, kViewportHeight + GetLoadingDistanceThreshold()), mojom::blink::ScrollType::kProgrammatic);
    ...
    ExpectInitialDeferralActionHistogramSamplesIfApplicable(LazyLoadFrameObserver::FrameInitialDeferralAction::kLoadedHidden, 7);
    histogram_tester()->ExpectTotalCount("Blink.LazyLoad.CrossOriginFrames.LoadStartedAfterBeingDeferred", 0);
    histogram_tester()->ExpectTotalCount("Blink.LazyLoad.CrossOriginFrames.VisibleAfterBeingDeferred", 0);
}
...
TEST_P(LazyEmbedsTest, LoadHiddenFrameFarFromViewportWithLoadingAttributeLazy)
{
    ...
    EXPECT_TRUE(ConsoleMessages().Contains("tiny element onload"));
    ExpectInitialDeferralActionHistogramSamplesIfApplicable(LazyLoadFrameObserver::FrameInitialDeferralAction::kDeferred, 1);
    histogram_tester()->ExpectTotalCount("Blink.LazyLoad.CrossOriginFrames.LoadStartedAfterBeingDeferred", 1);
    histogram_tester()->ExpectTotalCount("Blink.LazyLoad.CrossOriginFrames.VisibleAfterBeingDeferred", 1);
}

INSTANTIATE_TEST_SUITE_P(LazyEmbeds, LazyEmbedsTest,
    ::testing::Combine(::testing::Values(LazyFrameLoadingFeatureStatus::kEnabled), ::testing::Values(LazyFrameVisibleLoadTimeFeatureStatus::kEnabled),
...
public:
    ...
    void SetUp() override
    {
        ...
        Settings& settings = WebView().GetPage()->GetSettings();
        settings.SetLazyFrameLoadingDistanceThresholdPx4G(kLoadingDistanceThresholdPx);
    ...
    void TestLazyLoadUsedInPageReload(const char* iframe_attributes, bool is_deferral_expected_on_reload)
    {
        ...
        if (is_deferral_expected_on_reload) {
            ...
            histogram_tester.ExpectTotalCount("Blink.VisibleLoadTime.LazyLoadEligibleFrames.BelowTheFold.4G", 1);
        } else {
            SimRequest child_frame_resource("https://crossorigin.com/subframe.html", "text/html");
            Compositor().BeginFrame();
            test::RunPendingTasks();
...
{
    ScopedLazyFrameLoadingForTest scoped_lazy_frame_loading_for_test(true);
    ScopedLazyFrameVisibleLoadTimeMetricsForTest scoped_lazy_frame_visible_load_time_metrics_for_test(true);
