...
{
    auto* input_without_form = MakeGarbageCollected<HTMLInputElement>(GetDocument(), CreateElementFlags());
    ...
    auto* input_with_form = MakeGarbageCollected<HTMLInputElement>(GetDocument(), CreateElementFlags());
...
{
    auto* input = MakeGarbageCollected<HTMLInputElement>(GetDocument(), CreateElementFlags());
...
TEST_F(HTMLInputElementTest, RadioKeyDownDCHECKFailure)
{
    ...
    radio1.DefaultEventHandler(*MakeGarbageCollected<KeyboardEvent>("keydown", init));
