...
struct ControlKeyHash {
    ...
    static bool Equal(const ControlKey& a, const ControlKey& b)
    {
        return a == b;
    }
...
private:
    using ControlStateMap = HashMap<ControlKey, Deque<FormControlState>, ControlKeyHash, ControlKeyHashTraits>;
