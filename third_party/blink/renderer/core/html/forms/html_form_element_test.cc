...
{
    SetHtmlInnerHTML("<body><form id='form1'></form><form id='form2'></form></body>");
...
TEST_F(HTMLFormElementTest, ListedElementsIncludeShadowTrees)
{
    ...
    ShadowRoot& form1root = form1div->AttachShadowRootInternal(ShadowRootType::kOpen);
    ...
    ShadowRoot& form3root = form3div->AttachShadowRootInternal(ShadowRootType::kOpen);

    HTMLInputElement* input = MakeGarbageCollected<HTMLInputElement>(GetDocument(), CreateElementFlags::ByCreateElement());

    form3root.AppendChild(input);
    EXPECT_EQ(form1->ListedElements(), ListedElement::List {});
    EXPECT_EQ(form1->ListedElements(/*include_shadow_trees=*/true), ListedElement::List {});
    EXPECT_EQ(form2->ListedElements(), ListedElement::List {});
    EXPECT_EQ(form2->ListedElements(/*include_shadow_trees=*/true), ListedElement::List {});
    EXPECT_EQ(form3->ListedElements(), ListedElement::List {});
    EXPECT_EQ(form3->ListedElements(/*include_shadow_trees=*/true), ListedElement::List { input });
    ...
    EXPECT_EQ(form2->ListedElements(/*include_shadow_trees=*/true), ListedElement::List {});
    EXPECT_EQ(form3->ListedElements(), ListedElement::List {});
    EXPECT_EQ(form3->ListedElements(/*include_shadow_trees=*/true), ListedElement::List {});
    ...
    EXPECT_EQ(form2->ListedElements(/*include_shadow_trees=*/true), ListedElement::List { input });
    EXPECT_EQ(form3->ListedElements(), ListedElement::List {});
    EXPECT_EQ(form3->ListedElements(/*include_shadow_trees=*/true), ListedElement::List {});
    ...
    EXPECT_EQ(form1->ListedElements(), ListedElement::List {});
    EXPECT_EQ(form1->ListedElements(/*include_shadow_trees=*/true), ListedElement::List { input });
    EXPECT_EQ(form2->ListedElements(), ListedElement::List {});
    EXPECT_EQ(form2->ListedElements(/*include_shadow_trees=*/true), ListedElement::List {});
    EXPECT_EQ(form3->ListedElements(), ListedElement::List {});
    EXPECT_EQ(form3->ListedElements(/*include_shadow_trees=*/true), ListedElement::List {});
...
TEST_F(HTMLFormElementTest, ListedElementsAfterIncludeShadowTrees)
{
    ...
    HTMLInputElement* input1 = MakeGarbageCollected<HTMLInputElement>(GetDocument(), CreateElementFlags::ByCreateElement());
    ...
    HTMLInputElement* input2 = MakeGarbageCollected<HTMLInputElement>(GetDocument(), CreateElementFlags::ByCreateElement());
...
TEST_F(HTMLFormElementTest, ListedElementsIncludeShadowTreesFormAttribute)
{
    ...
    auto* input2 = ListedElement::From(*GetElementById("shadowhost")->GetShadowRoot()->getElementById("input2"));

    EXPECT_THAT(form1->ListedElements(), ::testing::ElementsAre(input1));
    EXPECT_THAT(form1->ListedElements(/*include_shadow_trees=*/true), ::testing::ElementsAre(input2, input1));
}
