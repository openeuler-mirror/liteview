...
{
    GetElement().Focus(FocusParams(SelectionBehaviorOnFocus::kReset, mojom::blink::FocusType::kNone, nullptr));
}
...
LayoutObject* InputTypeView::CreateLayoutObject(const ComputedStyle& style, LegacyLayout legacy) const
{
