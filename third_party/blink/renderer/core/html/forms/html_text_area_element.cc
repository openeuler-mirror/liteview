...
void HTMLTextAreaElement::CollectStyleForPresentationAttribute(const QualifiedName& name, const AtomicString& value, MutableCSSPropertyValueSet* style)
{
    if (name == html_names::kWrapAttr) {
        if (ShouldWrapText()) {
            AddPropertyToPresentationAttributeStyle(style, CSSPropertyID::kWhiteSpace, CSSValueID::kPreWrap);
            AddPropertyToPresentationAttributeStyle(style, CSSPropertyID::kOverflowWrap, CSSValueID::kBreakWord);
        } else {
            AddPropertyToPresentationAttributeStyle(style, CSSPropertyID::kWhiteSpace, CSSValueID::kPre);
...
LayoutObject* HTMLTextAreaElement::CreateLayoutObject(const ComputedStyle& style, LegacyLayout legacy)
{
...
void HTMLTextAreaElement::setValueForBinding(const String& value)
{
    if (GetAutofillState() != WebAutofillState::kAutofilled) {
        ...
        SetValue(value, TextFieldEventBehavior::kDispatchNoEvent, TextControlSetValueSelection::kSetSelectionToEnd,
            value != old_value ? WebAutofillState::kNotFilled : WebAutofillState::kAutofilled);
...
void HTMLTextAreaElement::CloneNonAttributePropertiesFrom(const Element& source, CloneChildrenFlag flag)
{
