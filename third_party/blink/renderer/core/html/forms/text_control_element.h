...
private:
    ...
    void DispatchFocusEvent(Element* old_focused_element, mojom::blink::FocusType, InputDeviceCapabilities* source_capabilities) final;
    ...
    // visibility.
    bool IsEmptySuggestedValue() const
    {
