...
class CORE_EXPORT HTMLInputElement : public TextControlElement, public ActiveScriptWrappable<HTMLInputElement> {
...
public:
    ...
    void SetFormElementPiiType(FormElementPiiType form_element_pii_type) override
    {
