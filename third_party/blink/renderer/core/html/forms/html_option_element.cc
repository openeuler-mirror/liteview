...
void HTMLOptionElement::ParseAttribute(const AttributeModificationParams& params)
{
    ...
    if (name == html_names::kValueAttr) {
        if (HTMLDataListElement* data_list = OwnerDataListElement()) {
            ...
            if (HTMLSelectMenuElement* select_menu = HTMLSelectMenuElement::OwnerSelectMenu(this)) {
...
void HTMLOptionElement::SetSelected(bool selected)
{
    ...
    } else if (HTMLSelectMenuElement* select_menu = HTMLSelectMenuElement::OwnerSelectMenu(this)) {
