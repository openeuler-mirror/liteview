...
public:
    ...
    public:
        ...
        PopupTargetElement(WeakMember<Element> ele, PopupTriggerAction act, const QualifiedName& attr_name);
    ...
    {
        return autofill_state_ == WebAutofillState::kAutofilled && !PreventHighlightingOfAutofilledFields();
    }
...
template <> inline bool IsElementOfType<const HTMLFormControlElement>(const Node& node)
{
