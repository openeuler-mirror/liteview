...
{
    for (HTMLImageElement* image_element = Traversal<HTMLImageElement>::FirstChild(*this); image_element;
...
{
    for (HTMLSourceElement* source_element = Traversal<HTMLSourceElement>::FirstChild(*this); source_element;
         source_element = Traversal<HTMLSourceElement>::NextSibling(*source_element)) {
