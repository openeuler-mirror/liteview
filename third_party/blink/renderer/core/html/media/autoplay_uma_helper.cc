...
void AutoplayUmaHelper::MaybeStartRecordingMutedVideoPlayMethodBecomeVisible()
{
    ...
    muted_video_play_method_intersection_observer_ = IntersectionObserver::Create({}, { IntersectionObserver::kMinimumThreshold }, &element_->GetDocument(),
...
void AutoplayUmaHelper::MaybeStartRecordingMutedVideoOffscreenDuration()
{
    ...
    muted_video_autoplay_offscreen_start_time_ = base::TimeTicks::Now();
    is_visible_ = false;
    muted_video_offscreen_duration_intersection_observer_ = IntersectionObserver::Create({}, { IntersectionObserver::kMinimumThreshold },
        &element_->GetDocument(), WTF::BindRepeating(&AutoplayUmaHelper::OnIntersectionChangedForMutedVideoOffscreenDuration, WrapWeakPersistent(this)),
        LocalFrameUkmAggregator::kMediaIntersectionObserver);
