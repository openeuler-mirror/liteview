...
public:
    ...
    {
        AbortBackgroundParsingImpl(BackgroundHTMLTokenProducerShutdownReason::kDocumentWrite);
    }
...
private:
    ...
    void AbortBackgroundParsingImpl(BackgroundHTMLTokenProducerShutdownReason reason);
    ...
    ALWAYS_INLINE const BackgroundHTMLTokenProducerParseResult& CurrentBackgroundProducerResult() const
    {
        DCHECK(results_ && current_result_index_ < results_->size());
        return (*results_)[current_result_index_];
    }
    ALWAYS_INLINE BackgroundHTMLTokenProducerParseResult& CurrentBackgroundProducerResult()
    {
        return const_cast<BackgroundHTMLTokenProducerParseResult&>(const_cast<const HTMLTokenProducer*>(this)->CurrentBackgroundProducerResult());
    }
