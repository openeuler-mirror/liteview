...
protected:
    ...
    void Test(HTMLResourcePreconnectTestCase test_case)
    {
        ...
        // beyond preconnect.
        auto preload_request = PreloadRequest::CreateIfNeeded(String(), TextPosition::MinimumPosition(), test_case.url, KURL(test_case.base_url),
            ResourceType::kImage, network::mojom::ReferrerPolicy(), ResourceFetcher::kImageNotImageSet, nullptr /* exclusion_info */,
            FetchParameters::ResourceWidth(), PreloadRequest::kRequestTypePreconnect);
