...
protected:
    ...
    template <typename OtherT> void AppendSpan(const base::span<OtherT>& val)
    {
...
public:
    ...
    void Append(const base::span<const LChar>& span)
    {
...
public:
    ...
    AtomicString AsAtomicString() const
    {
        ...
        return AtomicString(this->data(), this->size(), Is8Bit() ? WTF::AtomicStringUCharEncoding::kIs8Bit : WTF::AtomicStringUCharEncoding::kIs16Bit);
    }
