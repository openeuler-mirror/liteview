...
public:
    static constexpr unsigned kNoSpecialSequencesFound = std::numeric_limits<unsigned>::max();
...
private:
    ...
    bool MatchPossibleCDataSection(const WTF::String& string, wtf_size_t start_string_index);
