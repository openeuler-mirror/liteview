...
TEST_F(HTMLMetricsTest, MAYBE_HistogramReportsTwoChunks)
{
    ...
    histogram_tester.ExpectUniqueSample("Blink.HTMLParsing.TokensParsedMax4", 196, 1);
    histogram_tester.ExpectUniqueSample("Blink.HTMLParsing.TokensParsedMin4", 24, 1);
    histogram_tester.ExpectUniqueSample("Blink.HTMLParsing.TokensParsedAverage4", 113, 1);
    ...
    std::vector<base::Bucket> next_token_time_buckets = histogram_tester.GetAllSamples("Blink.HTMLParsing.NextTokenTimeTotal4");
    std::vector<base::Bucket> parsing_time_max_buckets = histogram_tester.GetAllSamples("Blink.HTMLParsing.ParsingTimeMax4");
    std::vector<base::Bucket> parsing_time_min_buckets = histogram_tester.GetAllSamples("Blink.HTMLParsing.ParsingTimeMin4");
    std::vector<base::Bucket> parsing_time_total_buckets = histogram_tester.GetAllSamples("Blink.HTMLParsing.ParsingTimeTotal4");
...
TEST_F(HTMLMetricsTest, UkmStoresValuesCorrectly)
{
    ...
    reporter.AddChunk(first_parse_time, first_tokens_parsed, base::Microseconds(10));
    reporter.AddYieldInterval(first_yield_time);
    reporter.AddChunk(second_parse_time, second_tokens_parsed, base::Microseconds(1));
    reporter.AddYieldInterval(second_yield_time);
    reporter.AddChunk(third_parse_time, third_tokens_parsed, base::Microseconds(1));
