...
public:
    static void SetAppropriateEndTagName(HTMLTokenizer& tokenizer, const String& string)
    {
    ...
    static void SetBufferedEndTagName(HTMLTokenizer& tokenizer, const String& string)
    {
