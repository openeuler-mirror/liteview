...
void HTMLParserMetrics::AddChunk(base::TimeDelta elapsed_time, unsigned tokens_parsed, base::TimeDelta time_in_next_token)
{
...
void HTMLParserMetrics::ReportUMAs()
{
    ...
    UMA_HISTOGRAM_CUSTOM_MICROSECONDS_TIMES(
        "Blink.HTMLParsing.NextTokenTimeTotal4", accumulated_time_in_next_token_, base::Microseconds(1), base::Seconds(10), 1000);
