...
class CORE_EXPORT HTMLImageElement final : public HTMLElement, public ImageElementBase, public ActiveScriptWrappable<HTMLImageElement>, public FormAssociated {
...
public:
    ...
    static LazyLoadDimensionType GetAttributeLazyLoadDimensionType(const String& attribute_value);
    static LazyLoadDimensionType GetInlineStyleDimensionsType(const CSSPropertyValueSet* property_set);
    ...
    {
      GetImageLoader().LoadDeferredImage(referrer_policy_, /*force_blocking*/false, /*update_from_microtask*/true);
    }
    void LoadDeferredImageBlockingLoad()
    {
        GetImageLoader().LoadDeferredImage(referrer_policy_, /*force_blocking*/true, /*update_from_microtask*/false);
    }
    ...
    LazyLoadImageObserver::VisibleLoadTimeMetrics& EnsureVisibleLoadTimeMetrics()
    {
        if (!visible_load_time_metrics_) {
            visible_load_time_metrics_ = std::make_unique<LazyLoadImageObserver::VisibleLoadTimeMetrics>();
        }
...
protected:
    ...
    scoped_refptr<ComputedStyle> CustomStyleForLayoutObject(const StyleRecalcContext&) override;
...
private:
    ...
    std::unique_ptr<LazyLoadImageObserver::VisibleLoadTimeMetrics> visible_load_time_metrics_;
};
