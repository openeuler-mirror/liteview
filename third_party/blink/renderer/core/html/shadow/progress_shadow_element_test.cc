...
TEST_F(ProgressShadowElementTest, LayoutObjectIsNeeded)
{
    ...
    auto* progress = To<HTMLProgressElement>(GetDocument().getElementById("prog"));
    ...
    scoped_refptr<ComputedStyle> style = shadow_element->StyleForLayoutObject(StyleRecalcContext());
