...
struct CustomElementDescriptorHash {
    ...
    {
        return WTF::HashInts(AtomicStringHash::GetHash(descriptor.GetName()), AtomicStringHash::GetHash(descriptor.LocalName()));
    }
...
template <> struct HashTraits<blink::CustomElementDescriptor> : SimpleClassHashTraits<blink::CustomElementDescriptor> {
    STATIC_ONLY(HashTraits);
    static const bool kEmptyValueIsZero = HashTraits<AtomicString>::kEmptyValueIsZero;
    ...
    static void ConstructDeletedValue(blink::CustomElementDescriptor& slot, bool zero_value)
    {
