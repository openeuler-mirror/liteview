...
public:
    ...
    bool Next(ScriptState*, String& out_key, String& out_value, ExceptionState&) override
    {
...
CustomStateSet::IterationSource* CustomStateSet::StartIteration(ScriptState*, ExceptionState&)
{
