...
public:
    explicit TestReaction(HeapVector<Member<Command>>&& commands)
        : CustomElementReaction(*MakeGarbageCollected<TestCustomElementDefinition>(CustomElementDescriptor("mock-element", "mock-element")))
...
public:
    ResetCustomElementReactionStackForTest()
        ...
        , old_stack_(CustomElementReactionStackTestSupport::SetCurrentForTest(stack_))
    {
    }
