...
class CORE_EXPORT CustomElementDefinition : public GarbageCollected<CustomElementDefinition>, public NameClient {
public:
    ...
    ConstructionStack& GetConstructionStack()
    {
        return construction_stack_;
    }
    ...
    void SetDefaultStyleSheets(const HeapVector<Member<CSSStyleSheet>>& default_style_sheets)
    {
    ...
    {
        return !default_style_sheets_.empty();
    }
...
protected:
    ...
    CustomElementDefinition(const CustomElementDescriptor&, const HashSet<AtomicString>& observed_attributes, const Vector<String>& disabled_features,
