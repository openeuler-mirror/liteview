...
protected:
    ...
    Element* CreateElementWithId(const char* local_name, const char* id)
    {
        ...
        Element* element = GetDocument().CreateElementForBinding(local_name, nullptr, no_exceptions);
...
{
    NonThrowableExceptionState no_exceptions;
    Element* element = GetDocument().CreateElementForBinding("a-a", nullptr, no_exceptions);
