...
{
    DEFINE_STATIC_LOCAL(Persistent<CustomElementReactionStack>, custom_element_reaction_stack, (MakeGarbageCollected<CustomElementReactionStack>()));
...
CustomElementReactionStack* CustomElementReactionStackTestSupport::SetCurrentForTest(CustomElementReactionStack* new_stack)
{
    Persistent<CustomElementReactionStack>& stack = GetCustomElementReactionStack();
