...
static CustomElementDefinition* DefinitionFor(const Document& document, const CustomElementDescriptor desc)
{
...
HTMLElement* CustomElement::CreateCustomElement(Document& document, const QualifiedName& tag_name, CreateElementFlags flags)
{
    ...
    if (auto* definition = DefinitionFor(document, CustomElementDescriptor(tag_name.LocalName(), tag_name.LocalName()))) {
