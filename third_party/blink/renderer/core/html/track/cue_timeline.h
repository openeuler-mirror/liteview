...
public:
    ...
    public:
        ~IgnoreUpdateScope()
        {
            DCHECK(cue_timeline_ || had_moved_cue_timeline_);
            if (cue_timeline_)
                cue_timeline_->EndIgnoreUpdateScope(base::PassKey<IgnoreUpdateScope>(), *this);
        }

        IgnoreUpdateScope(IgnoreUpdateScope&& other)
        {
            cue_timeline_ = other.cue_timeline_;
            other.had_moved_cue_timeline_ = true;
            other.cue_timeline_ = nullptr;
        }
    ...
    private:
        ...
        bool had_moved_cue_timeline_ = false;
