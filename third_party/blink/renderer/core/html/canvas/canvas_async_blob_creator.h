...
public:
    ...
    enum ToBlobFunctionType { kHTMLCanvasToBlobCallback, kHTMLCanvasConvertToBlobPromise, kOffscreenCanvasConvertToBlobPromise };
    ...
    CanvasAsyncBlobCreator(scoped_refptr<StaticBitmapImage>, const ImageEncodeOptions* options, ToBlobFunctionType function_type, base::TimeTicks start_time,
        ExecutionContext*, const IdentifiableToken& input_digest, ScriptPromiseResolver*);
    CanvasAsyncBlobCreator(scoped_refptr<StaticBitmapImage>, const ImageEncodeOptions*, ToBlobFunctionType, V8BlobCallback*, base::TimeTicks start_time,
        ExecutionContext*, const IdentifiableToken& input_digest, ScriptPromiseResolver* = nullptr);
    ...
    static sk_sp<SkColorSpace> BlobColorSpaceToSkColorSpace(String blob_color_space);
