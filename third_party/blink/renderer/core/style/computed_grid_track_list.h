...
struct CORE_EXPORT ComputedGridTrackList {
    ...
    {
        return track_sizes == other.track_sizes && auto_repeat_track_sizes == other.auto_repeat_track_sizes && named_grid_lines == other.named_grid_lines
    ...
    const NGGridTrackList& TrackList() const
    {
        return track_sizes.NGTrackList();
    }
