...
public:
    ...
    {
        if (style_ == static_cast<unsigned>(EBorderStyle::kNone) && o.style_ == static_cast<unsigned>(EBorderStyle::kNone))
            return true;
        if (style_ == static_cast<unsigned>(EBorderStyle::kHidden) && o.style_ == static_cast<unsigned>(EBorderStyle::kHidden))
            return true;
        return *this == o;
    }
    ...
    void SetStyle(EBorderStyle style)
    {
        style_ = static_cast<unsigned>(style);
    }

    static LayoutUnit MaxWidth()
    {
        return LayoutUnit::FromRawValue(kMaxValue);
    }
