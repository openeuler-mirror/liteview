...
struct NamedGridLine {
    explicit NamedGridLine(const String line_name, bool is_in_repeat = false, bool is_first_repeat = false)
        : line_name(line_name)
...
using OrderedNamedGridLines = HashMap<size_t, Vector<NamedGridLine>, WTF::IntHash<size_t>, WTF::UnsignedWithZeroKeyHashTraits<size_t>>;
