...
public:
    NamedLineCollection(const ComputedStyle&, const String& named_line, GridTrackSizingDirection, wtf_size_t last_line, wtf_size_t auto_repeat_tracks_count,
...
public:
    static wtf_size_t ExplicitGridColumnCount(const ComputedStyle&, wtf_size_t auto_repeat_columns_count, wtf_size_t subgrid_span_size = kNotFound);

    static wtf_size_t ExplicitGridRowCount(const ComputedStyle&, wtf_size_t auto_repeat_rows_count, wtf_size_t subgrid_span_size = kNotFound);

    static wtf_size_t SpanSizeForAutoPlacedItem(const ComputedStyle&, GridTrackSizingDirection);

    static GridSpan ResolveGridPositionsFromStyle(const ComputedStyle&, const ComputedStyle&, GridTrackSizingDirection, wtf_size_t auto_repeat_tracks_count,
        bool is_subgridded_to_parent = false, wtf_size_t subgrid_span_size = kNotFound);
};
