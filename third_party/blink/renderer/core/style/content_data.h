...
public:
    ...
    virtual LayoutObject* CreateLayoutObject(PseudoElement&, const ComputedStyle&, LegacyLayout) const = 0;
...
public:
    ...
    LayoutObject* CreateLayoutObject(PseudoElement&, const ComputedStyle&, LegacyLayout) const override;
