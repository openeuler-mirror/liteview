...
public:
    ...
    public:
        ...
        explicit States(IntegerType integer)
            : value_(integer)
        {
        }
        explicit States(const NamesType& names)
            : value_(names)
        {
        }
    ...
    public:
        ...
        explicit State(IntegerType integer)
            : value_(integer)
        {
        }
        explicit State(const NameType& names)
            : value_(names)
        {
        }
    ...
    ToggleRoot(const AtomicString& name, States states, State initial_state, ToggleOverflow overflow, bool is_group, ToggleScope scope)
        : name_(name)
        , states_(states)
...
public:
    ...
    {
        return name_ == other.name_ && states_ == other.states_ && value_ == other.value_ && overflow_ == other.overflow_ && is_group_ == other.is_group_
            && scope_ == other.scope_;
    }
    bool operator!=(const ToggleRoot& other) const
    {
