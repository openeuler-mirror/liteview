...
bool FillLayer::LayerPropertiesEqual(const FillLayer& o) const
{
    return base::ValuesEquivalent(image_, o.image_) && position_x_ == o.position_x_ && position_y_ == o.position_y_
        && background_x_origin_ == o.background_x_origin_ && background_y_origin_ == o.background_y_origin_ && attachment_ == o.attachment_ && clip_ == o.clip_
        && composite_ == o.composite_ && blend_mode_ == o.blend_mode_ && origin_ == o.origin_ && repeat_x_ == o.repeat_x_ && repeat_y_ == o.repeat_y_
        && size_type_ == o.size_type_ && size_length_ == o.size_length_ && type_ == o.type_;
}

bool FillLayer::operator==(const FillLayer& o) const
{
    return LayerPropertiesEqual(o) && ((next_ && o.next_) ? *next_ == *o.next_ : next_ == o.next_);
}
...
void FillLayer::ComputeCachedProperties() const
{
    ...
    any_layer_uses_content_box_ = Clip() == EFillBox::kContent || Origin() == EFillBox::kContent;
    ...
    if (next_) {
        ...
        any_layer_has_fixed_attachment_image_ |= next_->any_layer_has_fixed_attachment_image_;
        any_layer_has_default_attachment_image_ |= next_->any_layer_has_default_attachment_image_;
...
bool FillLayer::ImageTilesLayer() const
{
    ...
    return (RepeatX() == EFillRepeat::kRepeatFill || RepeatX() == EFillRepeat::kRoundFill)
        && (RepeatY() == EFillRepeat::kRepeatFill || RepeatY() == EFillRepeat::kRoundFill);
}
