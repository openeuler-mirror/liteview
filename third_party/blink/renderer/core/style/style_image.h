...
public:
    ...
    virtual CSSValue* ComputedCSSValue(const ComputedStyle&, bool allow_visited_style) const = 0;
...
protected:
    ...
    gfx::SizeF ImageSizeForSVGImage(SVGImage*, float multiplier, const gfx::SizeF& default_object_size) const;
};
