...
StylePath::StylePath(std::unique_ptr<SVGPathByteStream> path_byte_stream, WindRule wind_rule)
...
scoped_refptr<StylePath> StylePath::Create(std::unique_ptr<SVGPathByteStream> path_byte_stream, WindRule wind_rule)
{
...
{
    DEFINE_STATIC_REF(StylePath, empty_path, StylePath::Create(std::make_unique<SVGPathByteStream>()));
    return empty_path;
}
