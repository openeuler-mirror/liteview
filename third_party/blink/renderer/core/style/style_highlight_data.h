...
class ComputedStyle;
using CustomHighlightsStyleMap = HashMap<AtomicString, scoped_refptr<const ComputedStyle>>;

class CORE_EXPORT StyleHighlightData final : public RefCounted<StyleHighlightData> {
public:
