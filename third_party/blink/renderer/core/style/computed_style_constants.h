...
inline bool UsesHighlightPseudoInheritance(PseudoId pseudo_id)
{
    ...
    return ((IsHighlightPseudoElement(pseudo_id) && RuntimeEnabledFeatures::HighlightInheritanceEnabled()) || pseudo_id == PseudoId::kPseudoIdHighlight
        || pseudo_id == PseudoId::kPseudoIdSpellingError || pseudo_id == PseudoId::kPseudoIdGrammarError);
}
...
enum EPaintOrderType { PT_NONE = 0, PT_FILL = 1, PT_STROKE = 2, PT_MARKERS = 3 };
