...
public:
    ...
    {
        return needs_paint_invalidation_ || layout_type_ || needs_reshape_ || property_specific_differences_ || recompute_visual_overflow_
            || visual_rect_update_ || scroll_anchor_disabling_property_changed_ || compositing_reasons_changed_ || compositable_paint_effect_changed_;
    }

    bool HasAtMostPropertySpecificDifferences(unsigned property_differences) const
    {
        return !needs_paint_invalidation_ && !layout_type_ && !compositing_reasons_changed_ && !(property_specific_differences_ & ~property_differences);
    }

    bool NeedsPaintInvalidation() const
    {
        return needs_paint_invalidation_;
    }
    ...
    bool NeedsVisualRectUpdate() const
    {
        return visual_rect_update_;
    }
    void SetNeedsVisualRectUpdate()
    {
        visual_rect_update_ = true;
    }
