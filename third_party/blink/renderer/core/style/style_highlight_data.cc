...
bool StyleHighlightData::operator==(const StyleHighlightData& other) const
{
    return base::ValuesEquivalent(selection_, other.selection_) && base::ValuesEquivalent(target_text_, other.target_text_)
        && base::ValuesEquivalent(spelling_error_, other.spelling_error_) && base::ValuesEquivalent(grammar_error_, other.grammar_error_)
...
void StyleHighlightData::SetSpellingError(scoped_refptr<ComputedStyle>&& style)
{
...
void StyleHighlightData::SetCustomHighlight(const AtomicString& highlight_name, scoped_refptr<ComputedStyle>&& style)
{
