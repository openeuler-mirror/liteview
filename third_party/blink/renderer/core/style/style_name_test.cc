...
{
    EXPECT_EQ(StyleName("foo", StyleName::Type::kString), StyleName("foo", StyleName::Type::kString));
    EXPECT_NE(StyleName("foo", StyleName::Type::kString), StyleName("bar", StyleName::Type::kString));
    EXPECT_NE(StyleName("foo", StyleName::Type::kString), StyleName("foo", StyleName::Type::kCustomIdent));
}
