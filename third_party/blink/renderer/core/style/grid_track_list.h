...
struct NGGridTrackRepeater {
    ...
    NGGridTrackRepeater(wtf_size_t repeat_index, wtf_size_t repeat_size, wtf_size_t repeat_count, RepeatType repeat_type);
...
public:
    ...
    wtf_size_t RepeatCount(const wtf_size_t index, const wtf_size_t auto_value) const;
    ...
    const GridTrackSize& RepeatTrackSize(const wtf_size_t index, const wtf_size_t n) const;
