...
{
    return location_ == o.location_ && blur_ == o.blur_ && spread_ == o.spread_ && style_ == o.style_ && color_ == o.color_;
}

ShadowData ShadowData::NeutralValue()
{
    return ShadowData(gfx::PointF(0, 0), 0, 0, ShadowStyle::kNormal, StyleColor(Color::kTransparent));
}
