...
TEST_F(BackgroundPageThrottlingTest, NestedSetTimeoutZero_MaxUnthrottledTimeoutNestingLevel)
{
    // Disable this test when setTimeoutWithoutClamp feature is enabled.
    // TODO(crbug.com/1303275): Investigate the failure reason.
    if (blink::features::IsSetTimeoutWithoutClampEnabled())
    ...
    scoped_feature_list.InitWithFeaturesAndParameters({ { features::kMaxUnthrottledTimeoutNestingLevel, { { "nesting", "100" } } } }, {});
...
public:
    IntensiveWakeUpThrottlingTest()
    {
        scoped_feature_list_.InitWithFeaturesAndParameters(
            { { features::kIntensiveWakeUpThrottling, {} }, { features::kMaxUnthrottledTimeoutNestingLevel, { { "nesting", "100" } } },
