...
protected:
    ...
    String ExecuteJavaScript(String script_source)
    {
        ...
        WebView().MainFrame()->ToWebLocalFrame()->RequestExecuteScript(DOMWrapperWorld::kMainWorldId, base::make_span(&source, 1),
            mojom::blink::UserActivationOption::kDoNotActivate, mojom::blink::EvaluationTiming::kSynchronous,
            mojom::blink::LoadEventBlockingOption::kDoNotBlock, base::BindOnce(&ScriptExecutionCallbackHelper::Completed, base::Unretained(&callback_helper)),
    ...
    void RunTasksForPeriod(double delay_ms)
    {
        scheduler::GetSingleThreadTaskRunnerForTesting()->PostDelayedTask(
            FROM_HERE, WTF::BindOnce(&VirtualTimeTest::StopVirtualTimeAndExitRunLoop, WTF::Unretained(this)), base::Milliseconds(delay_ms));
        test::EnterRunLoop();
    }
