...
MojoCreateDataPipeResult* Mojo::createDataPipe(const MojoCreateDataPipeOptions* options_dict)
{
    ...
    if (!options_dict->hasElementNumBytes() || !options_dict->hasCapacityNumBytes()) {
...
void Mojo::bindInterface(
    ScriptState* script_state, const String& interface_name, MojoHandle* request_handle, const String& scope, ExceptionState& exception_state)
{
