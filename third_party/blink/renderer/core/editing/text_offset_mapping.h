...
public:
    ...
    public:
        class CORE_EXPORT Iterator : public std::iterator<std::input_iterator_tag, InlineContents> {
            STACK_ALLOCATED();
    ...
    public:
        class CORE_EXPORT Iterator : public std::iterator<std::forward_iterator_tag, InlineContents> {
            STACK_ALLOCATED();
