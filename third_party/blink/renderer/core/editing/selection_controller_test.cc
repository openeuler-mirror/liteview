...
class ParameterizedSelectionControllerTest : public SelectionControllerTest, public testing::WithParamInterface<bool>, private ScopedLayoutNGForTest {
public:
...
INSTANTIATE_TEST_SUITE_P(SelectionControllerTest, ParameterizedSelectionControllerTest, testing::Bool());
...
TEST_F(SelectionControllerTest, setNonDirectionalSelectionIfNeeded)
{
    ...
    EXPECT_EQ(VisibleSelectionInDOMTree().Start(), VisibleSelectionInDOMTree().Base());
    EXPECT_EQ(VisibleSelectionInDOMTree().End(), VisibleSelectionInDOMTree().Extent());
    ...
    EXPECT_EQ(PositionInFlatTree(bottom, 3), GetVisibleSelectionInFlatTree().Extent());
    ...
    EXPECT_EQ(VisibleSelectionInDOMTree().End(), VisibleSelectionInDOMTree().Base());
    EXPECT_EQ(VisibleSelectionInDOMTree().Start(), VisibleSelectionInDOMTree().Extent());
