...
public:
    ...
    LocalCaretRect(const LayoutObject* layout_object, const PhysicalRect& rect, const NGPhysicalBoxFragment* root_box_fragment = nullptr)
...
CORE_EXPORT gfx::Rect AbsoluteCaretBoundsOf(
    const PositionWithAffinity&, LayoutUnit* extra_width_to_end_of_line = nullptr, EditingBoundaryCrossingRule rule = kCanCrossEditingBoundary);
