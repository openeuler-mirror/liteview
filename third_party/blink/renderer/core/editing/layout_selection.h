...
public:
    ...
    SelectionState ComputePaintingSelectionStateForCursor(const NGInlineCursorPosition&) const;
    ...
    SelectionState ComputeSelectionStateForInlineTextBox(const InlineTextBox&) const;
...
private:
    LayoutSelectionStatus ComputeSelectionStatus(const NGInlineCursor&, const NGTextOffset&) const;
