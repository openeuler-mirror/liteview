...
{
    GetFrame().Selection().SetSelectionAndEndTyping(SetSelectionTextToBody("<div contenteditable id=\"sample\">a|b</div>"));
...
TEST_F(CachedTextInputInfoTest, PlaceholderBRInTextArea)
{
    ...
    GetFrame().Selection().SetSelectionAndEndTyping(SelectionInDOMTree::Builder().Collapse(Position::LastPositionInNode(*target.InnerEditorElement())).Build());
...
TEST_F(CachedTextInputInfoTest, RelayoutBoundary)
{
    ...
    GetFrame().Selection().SetSelectionAndEndTyping(SetSelectionTextToBody("<div contenteditable><div id=\"sample\">^a|b</div>"));
    const Element& sample = *GetElementById("sample");
...
{
    GetFrame().Selection().SetSelectionAndEndTyping(SetSelectionTextToBody("<div contenteditable>"
    ...
    // Move caret after "cd"
    GetFrame().Selection().SetSelectionAndEndTyping(SelectionInDOMTree::Builder().Collapse(Position(text_cd, 2)).Build());
...
{
    GetFrame().Selection().SetSelectionAndEndTyping(SetSelectionTextToBody("<div id=host><template data-mode=open>"
    ...
    GetFrame().Selection().SetSelectionAndEndTyping(SelectionInDOMTree::Builder().Collapse(Position(*To<Text>(shadow_root.lastChild()), 0)).Build());
...
{
    GetFrame().Selection().SetSelectionAndEndTyping(SetSelectionTextToBody("<div contenteditable id=sample>"
