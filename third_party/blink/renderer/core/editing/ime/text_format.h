...
public:
    ...
    static TextFormat* Create(wtf_size_t range_start, wtf_size_t range_end, const String& text_color, const String& background_color,
    ...
    TextFormat(wtf_size_t range_start, wtf_size_t range_end, const String& text_color, const String& background_color, const String& underline_color,
