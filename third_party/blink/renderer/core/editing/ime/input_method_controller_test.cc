...
protected:
    ...
    {
        return Controller().composition_range_;
    }
...
TEST_F(InputMethodControllerTest, SetCompositionAfterEmoji)
{
    ...
    EXPECT_EQ(2, GetFrame().Selection().GetSelectionInDOMTree().Base().ComputeOffsetInContainerNode());
    EXPECT_EQ(2, GetFrame().Selection().GetSelectionInDOMTree().Extent().ComputeOffsetInContainerNode());
...
{
    GetFrame().Selection().SetSelectionAndEndTyping(SetSelectionTextToBody("<div contenteditable>|abc^</div>"));
...
TEST_F(InputMethodControllerTest, SelectionOnConfirmExistingText)
{
    ...
    Controller().FinishComposingText(InputMethodController::kKeepSelection);
    EXPECT_EQ(0, GetFrame().Selection().GetSelectionInDOMTree().Base().ComputeOffsetInContainerNode());
    EXPECT_EQ(0, GetFrame().Selection().GetSelectionInDOMTree().Extent().ComputeOffsetInContainerNode());
}
...
TEST_F(InputMethodControllerTest, SelectionWhenFocusChangeFinishesComposition)
{
    ...
    EXPECT_EQ(3, GetFrame().Selection().GetSelectionInDOMTree().Base().ComputeOffsetInContainerNode());
    ...
    EXPECT_TRUE(Controller().HasComposition());
    EXPECT_EQ(7, GetFrame().Selection().GetSelectionInDOMTree().Base().ComputeOffsetInContainerNode());
...
TEST_F(InputMethodControllerTest, TextInputTypeAtBeforeEditable)
{
    ...
    GetFrame().Selection().SetSelectionAndEndTyping(SelectionInDOMTree::Builder().Collapse(Position(GetDocument().documentElement(), 0)).Build());
...
TEST_F(InputMethodControllerTest, SetCompositionDeletesMarkupBeforeText)
{
    ...
    GetFrame().Selection().SetSelectionAndEndTyping(SelectionInDOMTree::Builder().SetBaseAndExtent(EphemeralRange::RangeOfContents(*div)).Build());
...
TEST_F(InputMethodControllerTest, CommitTextWithOpenCompositionAndInputEventHandlerChangingText)
{
    ...
    EXPECT_EQ(11, GetFrame().Selection().GetSelectionInDOMTree().Base().ComputeOffsetInContainerNode());
}
...
TEST_F(InputMethodControllerTest, SetCompositionWithOpenCompositionAndInputEventHandlerChangingSelection)
{
    ...
    EXPECT_EQ(5, GetFrame().Selection().GetSelectionInDOMTree().Base().ComputeOffsetInContainerNode());
}
...
{
    GetFrame().Selection().SetSelectionAndEndTyping(SetSelectionTextToBody("<div id='sample' contenteditable='true'>"
...
{
    GetFrame().Selection().SetSelectionAndEndTyping(SetSelectionTextToBody("<div id='sample' contenteditable>|</div>"));
    Element* const div = GetDocument().getElementById("sample");
    div->Focus();
...
{
    GetFrame().Selection().SetSelectionAndEndTyping(SetSelectionTextToBody("<div id='sample' contenteditable>\u0958|</div>"));
    Element* const div = GetDocument().getElementById("sample");
    div->Focus();
