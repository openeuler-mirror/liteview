...
TextUpdateEvent::TextUpdateEvent(const AtomicString& type, const String& update_text, uint32_t update_range_start, uint32_t update_range_end,
    uint32_t new_selection_start, uint32_t new_selection_end)
