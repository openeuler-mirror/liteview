...
public:
    ...
    void updateCharacterBounds(unsigned long range_start, HeapVector<Member<DOMRect>>& character_bounds);
    ...
    void setSelectionStart(uint32_t selection_start, ExceptionState& exception_state);
...
private:
    ...
    EditContextInputPanelPolicy input_panel_policy_ = EditContextInputPanelPolicy::kManual;
