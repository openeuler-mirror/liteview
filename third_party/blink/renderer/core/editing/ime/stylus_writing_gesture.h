...
public:
    ...
    static void ApplyGesture(LocalFrame*, mojom::blink::StylusWritingGestureDataPtr);

protected:
    StylusWritingGesture(const gfx::Point& start_point, const String& text_alternative);
