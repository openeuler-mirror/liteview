...
TextFormat::TextFormat(wtf_size_t range_start, wtf_size_t range_end, const String& text_color, const String& background_color, const String& underline_color,
    const String& underline_style, const String& underline_thickness)
...
TextFormat* TextFormat::Create(wtf_size_t range_start, wtf_size_t range_end, const String& text_color, const String& background_color,
    const String& underline_color, const String& underline_style, const String& underline_thickness)
{
    return MakeGarbageCollected<TextFormat>(range_start, range_end, text_color, background_color, underline_color, underline_style, underline_thickness);
}
