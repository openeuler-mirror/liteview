...
TEST_F(SpellCheckerTest, AdvancedToNextMisspellingWrapSearchNoCrash)
{
    ...
    div->Focus();
    Selection().SetSelectionAndEndTyping(SelectionInDOMTree::Builder().Collapse(Position::LastPositionInNode(*div)).Build());
    UpdateAllLifecyclePhasesForTest();
...
TEST_F(SpellCheckerTest, SpellCheckDoesNotCauseUpdateLayout)
{
    ...
    GetDocument().GetFrame()->Selection().SetSelectionAndEndTyping(SelectionInDOMTree::Builder().Collapse(new_position).Build());
...
TEST_F(SpellCheckerTest, GetSpellCheckMarkerUnderSelection_FirstCharSelected)
{
    ...
    GetDocument().GetFrame()->Selection().SetSelectionAndEndTyping(
        SelectionInDOMTree::Builder().SetBaseAndExtent(Position(text, 0), Position(text, 1)).Build());
...
TEST_F(SpellCheckerTest, GetSpellCheckMarkerUnderSelection_LastCharSelected)
{
    ...
    GetDocument().GetFrame()->Selection().SetSelectionAndEndTyping(
        SelectionInDOMTree::Builder().SetBaseAndExtent(Position(text, 7), Position(text, 8)).Build());
...
TEST_F(SpellCheckerTest, GetSpellCheckMarkerUnderSelection_CaretLeftOfSingleCharWord)
{
    ...
    GetDocument().GetFrame()->Selection().SetSelectionAndEndTyping(
        SelectionInDOMTree::Builder().SetBaseAndExtent(Position(text, 0), Position(text, 0)).Build());
...
TEST_F(SpellCheckerTest, GetSpellCheckMarkerUnderSelection_CaretRightOfSingleCharWord)
{
    ...
    GetDocument().GetFrame()->Selection().SetSelectionAndEndTyping(
        SelectionInDOMTree::Builder().SetBaseAndExtent(Position(text, 1), Position(text, 1)).Build());
...
TEST_F(SpellCheckerTest, GetSpellCheckMarkerUnderSelection_CaretRightOfMultiCharWord)
{
    ...
    GetDocument().GetFrame()->Selection().SetSelectionAndEndTyping(
        SelectionInDOMTree::Builder().SetBaseAndExtent(Position(text, 8), Position(text, 8)).Build());
...
TEST_F(SpellCheckerTest, GetSpellCheckMarkerUnderSelection_CaretMiddleOfWord)
{
    ...
    GetDocument().GetFrame()->Selection().SetSelectionAndEndTyping(
        SelectionInDOMTree::Builder().SetBaseAndExtent(Position(text, 4), Position(text, 4)).Build());
...
TEST_F(SpellCheckerTest, GetSpellCheckMarkerUnderSelection_CaretOneCharRightOfMisspelling)
{
    ...
    GetDocument().GetFrame()->Selection().SetSelectionAndEndTyping(
        SelectionInDOMTree::Builder().SetBaseAndExtent(Position(text, 9), Position(text, 9)).Build());
...
TEST_F(SpellCheckerTest, GetSpellCheckMarkerUnderSelection_MultiNodeMisspell)
{
    ...
    GetDocument().GetFrame()->Selection().SetSelectionAndEndTyping(
        SelectionInDOMTree::Builder().SetBaseAndExtent(Position(second_text, 1), Position(second_text, 1)).Build());
