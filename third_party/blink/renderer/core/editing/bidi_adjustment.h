...
public:
    ...
    static InlineBoxPosition AdjustForCaretPositionResolution(const InlineBoxPosition&);
    static NGCaretPosition AdjustForCaretPositionResolution(const NGCaretPosition&);
