...
TEST_P(CaretDisplayItemClientTest, CaretPaintInvalidation)
{
    ...
    EXPECT_THAT(CaretRasterInvalidationTracking()->Invalidations(),
        UnorderedElementsAre(RasterInvalidationInfo { GetCaretDisplayItemClient().Id(), "Caret", gfx::Rect(0, 0, 1, 1), PaintInvalidationReason::kFullLayer }));
    GetDocument().View()->SetTracksRasterInvalidations(false);

    // Move the caret to the end of the text. Should invalidate both the old and
    // new carets.
    GetDocument().View()->SetTracksRasterInvalidations(true);
    Selection().SetSelectionAndEndTyping(SelectionInDOMTree::Builder().Collapse(Position(text, 5)).Build());
    ...
    EXPECT_THAT(CaretRasterInvalidationTracking()->Invalidations(),
        UnorderedElementsAre(
            RasterInvalidationInfo { GetCaretDisplayItemClient().Id(), "Caret", gfx::Rect(0, 0, 1, 1), PaintInvalidationReason::kPaintProperty }));
    GetDocument().View()->SetTracksRasterInvalidations(false);
...
TEST_P(CaretDisplayItemClientTest, CaretMovesBetweenBlocks)
{
    ...
    GetDocument().View()->SetTracksRasterInvalidations(true);
    Selection().SetSelectionAndEndTyping(SelectionInDOMTree::Builder().Collapse(Position(block_element2, 0)).Build());
    ...
    GetDocument().View()->SetTracksRasterInvalidations(true);
    Selection().SetSelectionAndEndTyping(SelectionInDOMTree::Builder().Collapse(Position(block_element1, 0)).Build());
...
TEST_P(CaretDisplayItemClientTest, CompositingChange)
{
    ...
    Selection().SetSelectionAndEndTyping(SelectionInDOMTree::Builder().Collapse(Position(editor, 0)).Build());
...
class ParameterizedComputeCaretRectTest : public EditingTestBase, private ScopedLayoutNGForTest, public testing::WithParamInterface<bool> {
public:
...
INSTANTIATE_TEST_SUITE_P(All, ParameterizedComputeCaretRectTest, testing::Bool());
