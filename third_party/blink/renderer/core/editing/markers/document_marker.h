...
public:
    ...
    class MarkerTypesIterator : public std::iterator<std::forward_iterator_tag, MarkerType> {
    public:
    ...
    absl::optional<MarkerOffsets> ComputeOffsetsAfterShift(unsigned offset, unsigned old_length, unsigned new_length) const;
