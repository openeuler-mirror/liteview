...
public:
    ...
    void RepaintMarkers(DocumentMarker::MarkerTypes = DocumentMarker::MarkerTypes::All());
    ...
    DocumentMarkerGroup* FirstMarkerGroupIntersectingOffsetRange(const Text&, unsigned start_offset, unsigned end_offset, DocumentMarker::MarkerTypes);
    // If the given position is either at the boundary or inside a word, expands
...
private:
    ...
    using MarkerLists = HeapVector<Member<DocumentMarkerList>, DocumentMarker::kMarkerTypeIndexesCount>;
    using MarkerMap = HeapHashMap<WeakMember<const Text>, Member<MarkerLists>>;
    static Member<DocumentMarkerList>& ListForType(MarkerLists*, DocumentMarker::MarkerType);
    ...
    void RemoveMarkersInternal(const Text&, unsigned start_offset, int length, DocumentMarker::MarkerTypes);
