...
TEST_F(SelectionAdjusterTest, ShadowRootAsRootBoundaryElement)
{
    ...
    EXPECT_EQ(PositionInFlatTree::FirstPositionInNode(*foo), result_in_flat_tree.Base());
    EXPECT_EQ(PositionInFlatTree::LastPositionInNode(*bar), result_in_flat_tree.Extent());
}
...
TEST_F(SelectionAdjusterTest, ShadowRootAsRootBoundaryElementEditable)
{
    ...
    EXPECT_EQ(PositionInFlatTree::LastPositionInNode(*bar), result_in_flat_tree2.Base());
    EXPECT_EQ(PositionInFlatTree::FirstPositionInNode(*bar), result_in_flat_tree2.Extent());
}
