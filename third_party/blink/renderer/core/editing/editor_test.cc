...
TEST_F(EditorTest, copyGeneratedPassword)
{
    ...
    auto& element = To<HTMLInputElement>(*GetDocument().getElementById("password"));
...
TEST_F(EditorTest, CopyVisibleSelection)
{
    ...
    auto& text_control = To<HTMLInputElement>(*GetDocument().getElementById("hiding"));
    text_control.select();
...
TEST_F(EditorTest, DontCopyHiddenSelections)
{
    ...
    auto& checkbox = To<HTMLInputElement>(*GetDocument().getElementById("checkbox"));
    checkbox.Focus();
...
TEST_F(EditorTest, ReplaceSelection)
{
    ...
    auto& text_control = To<HTMLInputElement>(*GetDocument().getElementById("text"));
    text_control.select();
