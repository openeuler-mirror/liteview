...
TEST_F(ApplyBlockElementCommandTest, selectionCrossingOverBody)
{
    ...
    Selection().SetSelection(SelectionInDOMTree::Builder()
                                 .SetBaseAndExtent(Position(GetDocument().documentElement(), 1), Position(GetDocument().getElementById("va")->firstChild(), 2))
                                 .Build(),
        SetSelectionOptions());
...
TEST_F(ApplyBlockElementCommandTest, visibilityChangeDuringCommand)
{
    ...
    Selection().SetSelection(SelectionInDOMTree::Builder().Collapse(Position(GetDocument().QuerySelector("li"), 0)).Build(), SetSelectionOptions());
