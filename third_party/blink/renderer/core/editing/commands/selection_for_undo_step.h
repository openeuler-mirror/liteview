...
public:
    ...
    Builder& SetBaseAndExtentAsBackwardSelection(const Position& base, const Position& extent);

    // |base| and |extent| can be disconnected.
    Builder& SetBaseAndExtentAsForwardSelection(const Position& base, const Position& extent);
