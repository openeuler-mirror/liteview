...
TEST_F(SurroundingTextTest, TextAreaSelection)
{
    ...
    TextControlElement* text_ctrl = reinterpret_cast<TextControlElement*>(GetDocument().getElementById("selection"));
...
TEST_F(SurroundingTextTest, EmptyInputElementWithChild)
{
    ...
    TextControlElement* input_element = reinterpret_cast<TextControlElement*>(GetDocument().getElementById("input_name"));
