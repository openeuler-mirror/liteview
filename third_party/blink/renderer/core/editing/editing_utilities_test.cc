...
TEST_F(EditingUtilitiesTest, PositionRespectingEditingBoundaryWithPointerEventNone)
{
    ...
    if (RuntimeEnabledFeatures::LayoutNGEnabled()) {
        ...
        ASSERT_EQ(PositionWithAffinity(Position::BeforeNode(target)), hit_result.GetPosition());
        // Simulates drag from "abc"@2 to "abc@1"
        EXPECT_EQ(PositionWithAffinity(Position::BeforeNode(target)), PositionRespectingEditingBoundary(Position(text_abc, 2), hit_result));
    }
}
