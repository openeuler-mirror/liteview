...
public:
    ...
    void StartRequest(int identifier, const WebString& search_text, const mojom::blink::FindOptions& options);
    ...
    void DidFinishTask(int identifier, const WebString& search_text, const mojom::blink::FindOptions& options, bool finished_whole_request,
    ...
    {
        return resume_finding_from_range_;
    }
    ...
    void InvokeFind(int identifier, const WebString& search_text_, mojom::blink::FindOptionsPtr options_);

    int GetMatchYieldCheckInterval() const;

private:
    void RequestFindTask(int identifier, const WebString& search_text, const mojom::blink::FindOptions& options);
