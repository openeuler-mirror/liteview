...
TEST_F(TextFinderTest, BeforeMatchEvent)
{
    ...
    find_options->run_synchronously_for_testing = true;
    GetTextFinder().Find(/*identifier=*/0, WebString(String("bar")), *find_options, /*wrap_within_frame=*/false);
...
TEST_F(TextFinderTest, BeforeMatchEventRemoveElement)
{
    ...
    auto find_options = mojom::blink::FindOptions::New();
    find_options->run_synchronously_for_testing = true;
    GetTextFinder().Find(/*identifier=*/0, WebString(String("foo")), *find_options, /*wrap_within_frame=*/false);
...
TEST_F(TextFinderSimTest, BeforeMatchEventAsyncExpandHighlight)
{
    ...
    GetTextFinder().Find(/*identifier=*/0, WebString(String("hidden")), *mojom::blink::FindOptions::New(),
