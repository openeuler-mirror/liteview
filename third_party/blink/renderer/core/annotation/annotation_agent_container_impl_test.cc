...
TEST_F(AnnotationAgentContainerImplTest, IsConstructedLazily)
{
    ...
    EXPECT_FALSE(Supplement<Document>::From<AnnotationAgentContainerImpl>(GetDocument()));
    EXPECT_FALSE(Supplement<Document>::From<AnnotationAgentContainerImpl>(child_document));
    ...
    EXPECT_EQ(child_container, Supplement<Document>::From<AnnotationAgentContainerImpl>(child_document));
    EXPECT_FALSE(Supplement<Document>::From<AnnotationAgentContainerImpl>(GetDocument()));
    ...
    EXPECT_EQ(main_container, Supplement<Document>::From<AnnotationAgentContainerImpl>(GetDocument()));
...
TEST_F(AnnotationAgentContainerImplTest, BindingCreatesContainer)
{
    ...
    ASSERT_FALSE(Supplement<Document>::From<AnnotationAgentContainerImpl>(GetDocument()));

    AnnotationAgentContainerImpl::BindReceiver(GetDocument().GetFrame(), remote.BindNewPipeAndPassReceiver());

    EXPECT_TRUE(remote.is_connected());
    EXPECT_TRUE(Supplement<Document>::From<AnnotationAgentContainerImpl>(GetDocument()));
}
