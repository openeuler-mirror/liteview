...
class CORE_EXPORT DocumentTransitionContentElement : public DocumentTransitionPseudoElementBase {
public:
    explicit DocumentTransitionContentElement(Element* parent, PseudoId, const AtomicString& document_transition_tag, viz::SharedElementResourceId,
        bool is_live_content_element, const DocumentTransitionStyleTracker* style_tracker);
    ~DocumentTransitionContentElement() override;

    void SetIntrinsicSize(const LayoutSize& intrinsic_size);
    const LayoutSize& intrinsic_size() const
    {
