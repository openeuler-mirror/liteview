...
class CORE_EXPORT DocumentTransitionSupplement : public GarbageCollected<DocumentTransitionSupplement>, public Supplement<Document> {
public:
    ...
    static DocumentTransition* createDocumentTransition(Document&, ExceptionState&);
