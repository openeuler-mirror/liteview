...
class CORE_EXPORT DocumentTransition : public ScriptWrappable,
...
public:
    ...
    ScriptPromise start(ScriptState*, V8DocumentTransitionCallback* callback, ExceptionState&);
    void abandon(ScriptState*, ExceptionState&);

    ScriptPromise prepare(ScriptState*, ExceptionState&);
    ScriptPromise prepare(ScriptState*, V8DocumentTransitionCallback* callback, ExceptionState&);
    ...
    // effect node.
    PaintPropertyChangeType UpdateEffect(const LayoutObject& object, const EffectPaintPropertyNodeOrAlias& current_effect,
...
private:
    ...
    public:
        explicit PostCaptureResolved(DocumentTransition* transition, bool success, Document*);
    ...
    bool InitiateTransition(ScriptState*, V8DocumentTransitionCallback* callback, ExceptionState&);
