...
public:
    using ContainerProperties = DocumentTransitionStyleTracker::ContainerProperties;
    ...
    void AddAnimationAndBlending(const String& tag, const ContainerProperties& source_properties);
    ...
    void AddContainerStyles(const String& tag, const ContainerProperties& properties, WritingMode writing_mode);
...
private:
    ...
    String AddKeyframes(const String& tag, const ContainerProperties& source_properties);
    void AddObjectViewBox(const String& selector, const String& tag, const String& value);
