...
public:
    NavigationTransition(ScriptState*, const String& navigation_type, NavigationHistoryEntry* from);
    ~NavigationTransition() final = default;

    const String& navigationType() const
    {
...
private:
    using FinishedProperty = ScriptPromiseProperty<ToV8UndefinedGenerator, ScriptValue>;
