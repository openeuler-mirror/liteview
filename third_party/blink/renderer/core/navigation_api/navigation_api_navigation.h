...
class NavigationApiNavigation final : public GarbageCollected<NavigationApiNavigation> {
public:
    NavigationApiNavigation(ScriptState*, NavigationApi*, NavigationOptions*, const String& key, scoped_refptr<SerializedScriptValue> state = nullptr);
