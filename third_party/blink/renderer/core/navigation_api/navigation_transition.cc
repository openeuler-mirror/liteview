...
namespace blink {
NavigationTransition::NavigationTransition(ScriptState* script_state, const String& navigation_type, NavigationHistoryEntry* from)
    : navigation_type_(navigation_type)
    , from_(from)
    , finished_(MakeGarbageCollected<FinishedProperty>(ExecutionContext::From(script_state)))
{
