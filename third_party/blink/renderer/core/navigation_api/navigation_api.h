...
class CORE_EXPORT NavigationApi final : public EventTargetWithInlineData, public Supplement<LocalDOMWindow>, public ExecutionContextLifecycleObserver {
...
public:
    ...
    void SetEntriesForRestore(const mojom::blink::NavigationApiHistoryEntryArraysPtr&);
...
private:
    ...
    void PopulateKeySet();
    void FinalizeWithAbortedNavigationError(ScriptState*, NavigationApiNavigation*);
    void ResolvePromisesAndFireNavigateSuccessEvent(NavigationApiNavigation*);
    void RejectPromisesAndFireNavigateErrorEvent(NavigationApiNavigation*, ScriptValue);
