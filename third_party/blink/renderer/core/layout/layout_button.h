...
public:
    ...
    LayoutUnit BaselinePosition(FontBaseline, bool first_line, LineDirectionMode, LinePositionMode) const override;

    static void UpdateAnonymousChildStyle(const ComputedStyle& parent_sytle, ComputedStyle& child_style);
    static bool ShouldCountWrongBaseline(const LayoutBox& button_box, const ComputedStyle& style, const ComputedStyle* parent_style);

private:
    void UpdateAnonymousChildStyle(const LayoutObject* child, ComputedStyle& child_style) const override;
