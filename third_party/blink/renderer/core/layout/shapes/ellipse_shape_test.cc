...
{
    EXPECT_EQ(LayoutRect(LayoutUnit(-2.25f), LayoutUnit(-2.125f), LayoutUnit(7), LayoutUnit(9.75f)),
        EllipseShape(gfx::PointF(1.25f, 2.75f), 3.5f, 4.875f).ShapeMarginLogicalBoundingBox());
    EXPECT_EQ(LayoutRect(LayoutUnit::Min(), LayoutUnit(), LayoutUnit::Max(), LayoutUnit()),
