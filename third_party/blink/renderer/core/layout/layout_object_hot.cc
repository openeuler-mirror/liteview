...
void LayoutObject::SetNeedsOverflowRecalc(OverflowRecalcType overflow_recalc_type)
{
    ...
    bool mark_container_chain_layout_overflow_recalc = !SelfNeedsLayoutOverflowRecalc();
...
void LayoutObject::PropagateStyleToAnonymousChildren()
{
    ...
    for (LayoutObject* child = SlowFirstChild(); child; child = child->NextSibling()) {
        ...
        scoped_refptr<ComputedStyle> new_style = GetDocument().GetStyleResolver().CreateAnonymousStyleWithDisplay(StyleRef(), child->StyleRef().Display());
        ...
        if (child->IsInFlowPositioned() && child_block_flow && child_block_flow->IsAnonymousBlockContinuation())
