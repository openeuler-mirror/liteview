...
SVGTransformChange LayoutSVGTransformableContainer::CalculateLocalTransform(bool bounds_changed)
{
    NOT_DESTROYED();
    ...
    if (IsA<SVGUseElement>(element)) {
        ...
        gfx::Vector2dF translation = length_context.ResolveLengthPair(style.X(), style.Y(), style);
    ...
    local_transform_ = element->CalculateTransform(SVGElement::kIncludeMotionTransform);
