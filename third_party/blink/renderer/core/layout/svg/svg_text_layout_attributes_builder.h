...
public:
    ...
    SVGTextLayoutAttributesBuilder(const SVGTextLayoutAttributesBuilder&) = delete;
    SVGTextLayoutAttributesBuilder& operator=(const SVGTextLayoutAttributesBuilder&) = delete;
    ...
    public:
        TextPosition(SVGTextPositioningElement* new_element = nullptr, unsigned new_start = 0, unsigned new_length = 0)
            : element(new_element)
            , start(new_start)
            , length(new_length)
        {
