...
gfx::RectF SVGResources::ReferenceBoxForEffects(const LayoutObject& layout_object)
{
...
void SVGElementResourceClient::ResourceContentChanged(SVGResource* resource)
{
    ...
    if (ContainsResource(clip_reference, resource) || ContainsResource(style.MaskerResource(), resource)) {
