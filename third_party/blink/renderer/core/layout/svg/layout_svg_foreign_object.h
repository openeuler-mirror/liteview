...
public:
    ...
    bool NodeAtPoint(HitTestResult&, const HitTestLocation&, const PhysicalOffset&, HitTestPhase) override;
    ...
    bool NodeAtPointFromSVG(HitTestResult&, const HitTestLocation&, const PhysicalOffset&, HitTestPhase);

    bool IsOfType(LayoutObjectType type) const override
    {
        NOT_DESTROYED();
        return type == kLayoutObjectSVGForeignObject || LayoutSVGBlock::IsOfType(type);
    }
