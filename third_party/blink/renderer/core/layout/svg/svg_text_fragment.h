...
struct SVGTextFragment {
    ...
    enum TransformType { kTransformRespectingTextLength, kTransformIgnoringTextLength };
    ...
    {
        gfx::RectF fragment_rect(x - glyph_overflow.left, y - baseline - glyph_overflow.top, width + glyph_overflow.left + glyph_overflow.right,
    ...
    AffineTransform BuildFragmentTransform(TransformType type = kTransformRespectingTextLength) const
    {
    ...
    bool AffectedByTextLength() const
    {
        return length_adjust_scale != 1;
    }
