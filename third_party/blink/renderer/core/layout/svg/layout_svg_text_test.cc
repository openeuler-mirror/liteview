...
TEST_F(LayoutSVGTextTest, TransformAffectsVectorEffect)
{
    ...
    GetDocument().getElementById("tspan1")->setAttribute(svg_names::kVectorEffectAttr, "non-scaling-stroke");
    GetDocument().getElementById("text2")->removeAttribute(svg_names::kVectorEffectAttr);
    GetDocument().getElementById("tspan3")->removeAttribute(svg_names::kVectorEffectAttr);
