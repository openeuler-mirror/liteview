...
protected:
    ...
    virtual void HandleTextChunk(BoxListConstIterator box_start, BoxListConstIterator box_end);

private:
    void ProcessTextLengthSpacingCorrection(bool is_vertical_text, float text_length_shift, Vector<SVGTextFragment>&, unsigned& at_character);
    void ApplyTextLengthScaleAdjustment(float text_length_scale, float text_length_bias, Vector<SVGTextFragment>&);
    void ProcessTextAnchorCorrection(bool is_vertical_text, float text_anchor_shift, Vector<SVGTextFragment>&);
};
...
private:
    void HandleTextChunk(BoxListConstIterator box_start, BoxListConstIterator box_end) override;
