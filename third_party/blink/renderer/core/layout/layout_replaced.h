...
public:
    ...
    LayoutUnit ComputeReplacedLogicalWidth(ShouldComputePreferred = kComputeActual) const override;
    LayoutUnit ComputeReplacedLogicalHeight(LayoutUnit estimated_used_width = LayoutUnit()) const override;
...
protected:
    ...
    LayoutSize IntrinsicSize() const final
    {
        ...
        return LayoutSize(width_override.value_or(intrinsic_size_.Width()), height_override.value_or(intrinsic_size_.Height()));
    }
    ...
    PhysicalRect ComputeReplacedContentRect(const LayoutSize* overridden_intrinsic_size = nullptr) const;
...
private:
    ...
    absl::optional<PhysicalRect> ComputeObjectViewBoxRect(const LayoutSize* overridden_intrinsic_size = nullptr) const;

    PhysicalRect ComputeObjectFitAndPositionRect(const LayoutSize* overridden_intrinsic_size) const;
