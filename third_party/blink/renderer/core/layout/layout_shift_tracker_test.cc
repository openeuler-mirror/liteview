...
TEST_F(LayoutShiftTrackerTest, IgnoreAfterInput)
{
    ...
    GetDocument().getElementById("j")->setAttribute(html_names::kStyleAttr, AtomicString("top: 60px"));
    SimulateInput();
...
TEST_F(LayoutShiftTrackerTest, CompositedShiftBeforeFirstPaint)
{
    ...
    GetDocument().getElementById("B")->setAttribute(html_names::kClassAttr, AtomicString("tr"));
    GetFrameView().UpdateAllLifecyclePhasesExceptPaint(DocumentUpdateReason::kTest);
    GetDocument().getElementById("A")->setAttribute(html_names::kClassAttr, AtomicString("hide"));
    UpdateAllLifecyclePhasesForTest();
}
...
TEST_F(LayoutShiftTrackerTest, IgnoreSVG)
{
    ...
    GetDocument().QuerySelector("circle")->setAttribute(svg_names::kCxAttr, AtomicString("100"));
    UpdateAllLifecyclePhasesForTest();
...
TEST_F(LayoutShiftTrackerSimTest, SubframeWeighting)
{
    ...
    GetDocument().getElementById("i")->setAttribute(html_names::kStyleAttr, AtomicString("left: 600px"));
...
void LayoutShiftTrackerNavigationTest::RunTest(bool is_browser_initiated)
{
    ...
    main_frame->Loader().GetDocumentLoader()->CommitSameDocumentNavigation(item1->Url(), WebFrameLoadType::kBackForward, item1.Get(),
        ...
        false /* is_synchronously_committed */, mojom::blink::TriggeringEventInfo::kNotFromEvent, is_browser_initiated);
...
TEST_F(LayoutShiftTrackerTest, ContentVisibilityAutoOnscreenAndOffscreenAfterScrollFirstPaint)
{
    ...
    // report layout shift.
    To<Element>(offscreen->GetNode())->setAttribute(html_names::kStyleAttr, "position: relative; top: 100100px");
    UpdateAllLifecyclePhasesForTest();
...
TEST_F(LayoutShiftTrackerTest, ClipByVisualViewport)
{
    ...
    GetDocument().getElementById("target")->setAttribute(html_names::kStyleAttr, "top: 100px");
    UpdateAllLifecyclePhasesForTest();
    // 50.0: visible width
