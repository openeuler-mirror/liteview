...
public:
    ...
    HeapVector<Member<LayoutTableCell>, 1>& Cells()
    {
        return cells_;
    }
    const HeapVector<Member<LayoutTableCell>, 1>& Cells() const
    {
        return cells_;
    }
    ...
    void SetInColSpan(bool in_col_span)
    {
        in_col_span_ = in_col_span;
    }
...
template <> struct VectorTraits<blink::TableGridCell> : VectorTraitsBase<blink::TableGridCell> {
