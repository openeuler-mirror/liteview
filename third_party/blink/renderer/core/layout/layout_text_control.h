...
public:
    ...
    static void StyleDidChange(HTMLElement* inner_editor, const ComputedStyle* old_style, const ComputedStyle& new_style);
    ...
    static void HitInnerEditorElement(
        const LayoutBox& box, HTMLElement& inner_editor, HitTestResult&, const HitTestLocation&, const PhysicalOffset& accumulated_offset);
...
protected:
    ...
    LayoutObject* LayoutSpecialExcludedChild(bool relayout_children, SubtreeLayoutScope&) override;
...
private:
    ...
    void AddOutlineRects(Vector<PhysicalRect>&, OutlineInfo*, const PhysicalOffset& additional_offset, NGOutlineType) const final;
