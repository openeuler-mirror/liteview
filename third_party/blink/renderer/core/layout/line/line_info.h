...
public:
    ...
    {
        return previous_line_broke_cleanly_;
    }
    ...
    {
        runs_from_leading_whitespace_++;
    }

    void SetFirstLine(bool first_line)
    {
        is_first_line_ = first_line;
    }
    void SetLastLine(bool last_line)
    {
        is_last_line_ = last_line;
    }
    ...
    void SetTextAlign(ETextAlign text_align)
    {
