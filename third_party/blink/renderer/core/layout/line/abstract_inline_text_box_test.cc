...
class AbstractInlineTextBoxTest : public testing::WithParamInterface<bool>, private ScopedLayoutNGForTest, public RenderingTest {
public:
    AbstractInlineTextBoxTest()
...
TEST_P(AbstractInlineTextBoxTest, GetTextWithCollapsedWhiteSpace)
{
    ...
    scoped_refptr<AbstractInlineTextBox> inline_text_box = layout_text.FirstAbstractInlineTextBox();
...
TEST_P(AbstractInlineTextBoxTest, GetTextWithLineBreakAtMiddleCollapsedWhiteSpace)
{
...
TEST_P(AbstractInlineTextBoxTest, GetTextWithLineBreakAtSpanCollapsedWhiteSpace)
{
    ...
    scoped_refptr<AbstractInlineTextBox> inline_text_box1 = layout_text1.FirstAbstractInlineTextBox();
    ...
    scoped_refptr<AbstractInlineTextBox> inline_text_box2 = layout_text2.FirstAbstractInlineTextBox();
