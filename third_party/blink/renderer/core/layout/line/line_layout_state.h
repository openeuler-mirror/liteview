...
public:
    ...
    {
        is_full_layout_ = true;
    }
    bool IsFullLayout() const
    {
        return is_full_layout_;
    }
    ...
    bool HasInlineChild() const
    {
        return has_inline_child_;
    }
    ...
    FloatingObject* LastFloat() const
    {
        return last_float_;
    }
    void SetLastFloat(FloatingObject* last_float)
    {
        last_float_ = last_float;
    }

    HeapVector<LayoutBlockFlow::FloatWithRect>& Floats()
    {
        return floats_;
    }

    unsigned FloatIndex() const
    {
        return float_index_;
    }
    void SetFloatIndex(unsigned float_index)
    {
        float_index_ = float_index;
    }
