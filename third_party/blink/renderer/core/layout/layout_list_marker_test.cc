...
class LayoutListMarkerTest : public RenderingTest, private ScopedLayoutNGForTest {
public:
    // LayoutListMarker is for legacy layout only
    LayoutListMarkerTest()
...
TEST_F(LayoutListMarkerTest, ListStyleTypeNoneTextAlternative)
{
    ...
    LayoutObject* marker = ListMarker::MarkerFromListItem(target->GetLayoutObject());
