...
public:
    ...
    Color PlatformTextSearchHighlightColor(bool active_match, mojom::blink::ColorScheme color_scheme) const;
    Color PlatformTextSearchColor(bool active_match, mojom::blink::ColorScheme color_scheme) const;
    ...
    virtual Color SystemColor(CSSValueID, mojom::blink::ColorScheme color_scheme) const;
...
protected:
    ...
    Color DefaultSystemColor(CSSValueID, mojom::blink::ColorScheme color_scheme) const;
    Color SystemColorFromNativeTheme(CSSValueID, mojom::blink::ColorScheme color_scheme) const;
...
private:
    ...
    ControlPart AdjustAppearanceWithAuthorStyle(ControlPart part, const ComputedStyle& style);

    ControlPart AdjustAppearanceWithElementType(const ComputedStyle& style, const Element* element);
