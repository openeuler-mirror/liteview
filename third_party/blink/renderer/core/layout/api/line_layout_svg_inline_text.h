...
public:
    ...
    {
        Reset(LineLayoutSVGInlineText());
    }
    explicit SVGInlineTextMetricsIterator(LineLayoutSVGInlineText text_line_layout)
    {
        Reset(text_line_layout);
    }

    void AdvanceToTextStart(LineLayoutSVGInlineText text_line_layout, unsigned start_character_offset)
    {
    ...
    unsigned MetricsListOffset() const
    {
        return metrics_list_offset_;
    }
    unsigned CharacterOffset() const
    {
        return character_offset_;
    }
    bool IsAtEnd() const
    {
        return metrics_list_offset_ == MetricsList().size();
    }
