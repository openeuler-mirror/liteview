...
public:
    ...
    {
        return ToInline()->MutableLineBoxes();
    }

    bool HitTestCulledInline(HitTestResult& result, const HitTestLocation& hit_test_location, const PhysicalOffset& accumulated_offset)
    {
        return ToInline()->HitTestCulledInline(result, hit_test_location, accumulated_offset);
    }
