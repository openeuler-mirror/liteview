...
public:
    ...
    LayoutUnit LineHeight(bool first_line, LineDirectionMode line_direction_mode, LinePositionMode line_position_mode = kPositionOnContainingLine) const
    {
        return ToBoxModel()->LineHeight(first_line, line_direction_mode, line_position_mode);
    }

    LayoutUnit BaselinePosition(FontBaseline font_baseline, bool first_line, LineDirectionMode line_direction_mode,
        LinePositionMode line_position_mode = kPositionOnContainingLine) const
    {
        return ToBoxModel()->BaselinePosition(font_baseline, first_line, line_direction_mode, line_position_mode);
    }
