...
public:
    ...
    LayoutUnit StartAlignedOffsetForLine(LayoutUnit position, IndentTextOrNot indent_text)
    {
    ...
    {
        return ToBlockFlow()->LogicalWidthForChild(*To<LayoutBox>(child.GetLayoutObject()));
    }
    ...
    {
        return ToBlockFlow()->MarginStartForChild(*To<LayoutBoxModelObject>(child.GetLayoutObject()));
    }
    ...
    {
        return ToBlockFlow()->MarginEndForChild(*To<LayoutBoxModelObject>(child.GetLayoutObject()));
    }
    ...
    LayoutUnit LineHeight(bool first_line, LineDirectionMode direction, LinePositionMode line_position_mode) const
    {
    ...
    {
        return ToBlockFlow()->MinLineHeightForReplacedObject(is_first_line, replaced_height);
    }

    void SetStaticInlinePositionForChild(LineLayoutBox box, LayoutUnit inline_position)
    {
        ToBlockFlow()->SetStaticInlinePositionForChild(*To<LayoutBox>(box.GetLayoutObject()), inline_position);
    }

    void UpdateStaticInlinePositionForChild(LineLayoutBox box, LayoutUnit logical_top, IndentTextOrNot indent_text = kDoNotIndentText)
    {
        ToBlockFlow()->UpdateStaticInlinePositionForChild(*To<LayoutBox>(box.GetLayoutObject()), logical_top, indent_text);
    }
    ...
    {
        return ToBlockFlow()->InsertFloatingObject(*To<LayoutBox>(box.GetLayoutObject()));
    }
    ...
    void PositionAndLayoutFloat(FloatingObject& floating_object, LayoutUnit logical_top_margin_edge)
    {
    ...
    {
        return ToBlockFlow()->LogicalRightOffsetForLine(position, indent_text, logical_height);
    }
    ...
    {
        return ToBlockFlow()->LogicalLeftOffsetForLine(position, indent_text, logical_height);
    }
