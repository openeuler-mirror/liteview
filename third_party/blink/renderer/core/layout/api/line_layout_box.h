...
public:
    ...
    {
        return ToBox()->HasLayoutOverflow();
    }
    bool HasVisualOverflow() const
    {
        return ToBox()->HasVisualOverflow();
    }
    ...
    void ShowLineTreeAndMark(const InlineBox* marked_box1, const char* marked_label1) const
    {
...
private:
    LayoutBox* ToBox()
    {
        return To<LayoutBox>(GetLayoutObject());
    }
