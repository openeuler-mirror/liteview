...
void LayoutObject::MarkContainerChainForOverflowRecalcIfNeeded(bool mark_container_chain_layout_overflow_recalc)
{
    NOT_DESTROYED();
    ...
    do {
        ...
        if (object) {
            ...
            if (mark_container_chain_layout_overflow_recalc) {
                already_needs_layout_overflow_recalc = object->ChildNeedsLayoutOverflowRecalc();
