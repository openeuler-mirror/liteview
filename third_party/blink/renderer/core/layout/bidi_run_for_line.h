...
TextDirection DeterminePlaintextDirectionality(LineLayoutItem root, LineLayoutItem current = nullptr, unsigned pos = 0);

void ConstructBidiRunsForLine(InlineBidiResolver&, BidiRunList<BidiRun>&, const InlineIterator& end_of_line, VisualDirectionOverride,
    bool previous_line_broke_cleanly, bool is_new_uba_paragraph);
