...
public:
    ...
    virtual void ComputeIntrinsicLogicalWidths(LayoutUnit& min_width, LayoutUnit& max_width) = 0;
    virtual LayoutUnit ScaledWidthFromPercentColumns()
    {
        return LayoutUnit();
    }
    virtual void ApplyPreferredLogicalWidthQuirks(LayoutUnit& min_width, LayoutUnit& max_width) const = 0;
