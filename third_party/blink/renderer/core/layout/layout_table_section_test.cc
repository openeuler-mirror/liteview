...
TEST_F(LayoutTableSectionTest, EmptySectionDirtiedRowsAndEffeciveColumns)
{
    ...
    CellSpan rows;
    CellSpan columns;
    section->DirtiedRowsAndEffectiveColumns(LayoutRect(50, 50, 100, 100), rows, columns);
...
TEST_F(LayoutTableSectionTest, DirtiedRowsAndEffectiveColumnsWithSpans)
{
    ...
    CellSpan rows;
    CellSpan columns;
    section->DirtiedRowsAndEffectiveColumns(LayoutRect(5, 5, 90, 90), rows, columns);
    EXPECT_EQ(0u, rows.Start());
    ...
    section->DirtiedRowsAndEffectiveColumns(LayoutRect(5, 5, 290, 90), rows, columns);
    EXPECT_EQ(0u, rows.Start());
    EXPECT_EQ(1u, rows.End());
    EXPECT_EQ(0u, columns.Start());
    ...
    section->DirtiedRowsAndEffectiveColumns(LayoutRect(205, 105, 90, 90), rows, columns);
    EXPECT_EQ(0u, rows.Start());
    ...
    section->DirtiedRowsAndEffectiveColumns(LayoutRect(105, 105, 90, 90), rows, columns);
    EXPECT_EQ(0u, rows.Start());
    EXPECT_EQ(2u, rows.End());
    EXPECT_EQ(0u, columns.Start());
    ...
    section->DirtiedRowsAndEffectiveColumns(LayoutRect(105, 105, 190, 90), rows, columns);
    EXPECT_EQ(0u, rows.Start());
    EXPECT_EQ(2u, rows.End());
    EXPECT_EQ(0u, columns.Start());
    EXPECT_EQ(3u, columns.End());
    ...
    // rows and columns.
    section->DirtiedRowsAndEffectiveColumns(LayoutRect(205, 105, 90, 190), rows, columns);
    EXPECT_EQ(0u, rows.Start());
...
TEST_F(LayoutTableSectionTest, DirtiedRowsAndEffectiveColumnsWithCollapsedBorders)
{
    ...
    section->DirtiedRowsAndEffectiveColumns(LayoutRect(50, 50, 10, 10), rows, columns);
    EXPECT_EQ(0u, rows.Start());
    EXPECT_EQ(2u, rows.End());
    EXPECT_EQ(0u, columns.Start());
    EXPECT_EQ(2u, columns.End());
    ...
    section->DirtiedRowsAndEffectiveColumns(LayoutRect(250, 150, 10, 10), rows, columns);
    EXPECT_EQ(0u, rows.Start());
    EXPECT_EQ(3u, rows.End());
    EXPECT_EQ(1u, columns.Start());
    ...
    section->DirtiedRowsAndEffectiveColumns(LayoutRect(350, 220, 110, 110), rows, columns);
    ...
    // All cells.
    section->DirtiedRowsAndEffectiveColumns(LayoutRect(0, 0, 400, 400), rows, columns);
    EXPECT_EQ(0u, rows.Start());
    EXPECT_EQ(4u, rows.End());
    EXPECT_EQ(0u, columns.Start());
    EXPECT_EQ(4u, columns.End());
...
static void SetCellsOverflowInRow(LayoutTableRow* row)
{
    for (auto* cell = row->FirstCell(); cell; cell = cell->NextCell()) {
        To<Element>(cell->GetNode())->setAttribute(html_names::kClassAttr, "overflow");
    }
}
