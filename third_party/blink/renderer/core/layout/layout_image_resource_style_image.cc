...
gfx::SizeF LayoutImageResourceStyleImage::ImageSizeWithDefaultSize(float multiplier, const gfx::SizeF& default_size) const
{
    return style_image_->ImageSize(multiplier, default_size, LayoutObject::ShouldRespectImageOrientation(layout_object_));
}
