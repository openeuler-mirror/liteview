...
TEST_F(TextAutosizerTest, TextSizeAdjustDisablesAutosizing)
{
    ...
    LayoutObject* text_size_adjust_auto = GetDocument().getElementById("textSizeAdjustAuto")->GetLayoutObject();
    ...
    LayoutObject* text_size_adjust_none = GetDocument().getElementById("textSizeAdjustNone")->GetLayoutObject();
    ...
    LayoutObject* text_size_adjust100 = GetDocument().getElementById("textSizeAdjust100")->GetLayoutObject();
...
TEST_F(TextAutosizerTest, ZeroTextSizeAdjustment)
{
    ...
    LayoutObject* text_size_adjust_zero = GetDocument().getElementById("textSizeAdjustZero")->GetLayoutObject();
...
TEST_F(TextAutosizerTest, NegativeTextSizeAdjustment)
{
    SetBodyInnerHTML("<style>"
                     ...
                     "  culpa qui officia deserunt mollit anim id est laborum."
                     "</div>");
    LayoutObject* text_size_adjust_negative = GetDocument().getElementById("textSizeAdjustNegative")->GetLayoutObject();
...
TEST_F(TextAutosizerTest, TextSizeAdjustmentPixelUnits)
{
    SetBodyInnerHTML("<style>"
                     ...
                     "  culpa qui officia deserunt mollit anim id est laborum."
                     "</div>");
    LayoutObject* text_size_adjust_pixels = GetDocument().getElementById("textSizeAdjustPixels")->GetLayoutObject();
...
TEST_F(TextAutosizerTest, NestedTextSizeAdjust)
{
    ...
    LayoutObject* text_size_adjust_a = GetDocument().getElementById("textSizeAdjustA")->GetLayoutObject();
    ...
    LayoutObject* text_size_adjust_b = GetDocument().getElementById("textSizeAdjustB")->GetLayoutObject();
...
TEST_F(TextAutosizerTest, PrefixedTextSizeAdjustIsAlias)
{
    ...
    LayoutObject* text_size_adjust = GetDocument().getElementById("textSizeAdjust")->GetLayoutObject();
...
TEST_F(TextAutosizerTest, TextSizeAdjustDoesNotDisableAccessibility)
{
    ...
    Element* text_size_adjust_double = GetDocument().getElementById("textSizeAdjustDouble");
...
TEST_F(TextAutosizerTest, ChangingSuperClusterFirstText)
{
    ...
    LayoutObject* long_text = GetDocument().getElementById("longText")->GetLayoutObject();
    ...
    LayoutObject* short_text = GetDocument().getElementById("shortText")->GetLayoutObject();
