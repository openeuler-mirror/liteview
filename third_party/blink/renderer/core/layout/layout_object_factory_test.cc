...
class LayoutObjectFactoryTest : public ::testing::WithParamInterface<bool>, private ScopedLayoutNGForTest, public RenderingTest {
protected:
...
INSTANTIATE_TEST_SUITE_P(LayoutObjectFactoryTest, LayoutObjectFactoryTest, ::testing::Bool());
...
{
    InsertStyleElement("li::before { content: counter(i, upper-roman); }"
                       "ol { list-style: none; ");
    ...
    const auto& counter_layout_object = *To<LayoutCounter>(psedo.GetLayoutObject()->SlowFirstChild());
