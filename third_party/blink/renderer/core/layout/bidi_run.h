...
struct BidiRun final : BidiCharacterRun {
    BidiRun(bool override, unsigned char level, int start, int stop, LineLayoutItem line_layout_item, WTF::unicode::CharDirection dir,
    ...
    BidiRun(int start, int stop, unsigned char level, LineLayoutItem line_layout_item)
    ...
    BidiRun* Next()
    {
        return static_cast<BidiRun*>(next_);
    }
