...
public:
    ...
    static LayoutTextFragment* Create(Node*, StringImpl*, int start_offset, int length, LegacyLayout);
    static LayoutTextFragment* CreateAnonymous(PseudoElement&, StringImpl*, LegacyLayout);
    static LayoutTextFragment* CreateAnonymous(PseudoElement&, StringImpl*, unsigned start, unsigned length, LegacyLayout);
    static LayoutTextFragment* CreateAnonymous(Document&, StringImpl*, unsigned start, unsigned length, LegacyLayout);

    void Trace(Visitor*) const override;

    Position PositionForCaretOffset(unsigned) const override;
    absl::optional<unsigned> CaretOffsetForPosition(const Position&) const override;
    ...
    void SetTextFragment(scoped_refptr<StringImpl>, unsigned start, unsigned length);
