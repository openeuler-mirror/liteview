...
CollapsedBorderValue::CollapsedBorderValue(const BorderValue& border, const Color& color, EBorderPrecedence precedence)
    : CollapsedBorderValue(border.Style(), border.Width(), color, precedence)
{
}

CollapsedBorderValue::CollapsedBorderValue(EBorderStyle style, const LayoutUnit width, const Color& color, EBorderPrecedence precedence)
    : color_(color)
