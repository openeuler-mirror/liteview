...
inline constexpr LogicalAxes kLogicalAxisBoth = kLogicalAxisInline | kLogicalAxisBlock;
...
inline constexpr PhysicalAxes kPhysicalAxisBoth = kPhysicalAxisHorizontal | kPhysicalAxisVertical;
