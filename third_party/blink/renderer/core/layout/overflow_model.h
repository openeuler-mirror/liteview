...
inline void UniteLayoutOverflowRect(LayoutRect& layout_overflow, const LayoutRect& rect)
{
...
public:
    ...
    SimpleLayoutOverflowModel& operator=(const SimpleLayoutOverflowModel&) = delete;

    const LayoutRect& LayoutOverflowRect() const
    {
        return layout_overflow_;
    }
    void SetLayoutOverflow(const LayoutRect& rect)
    {
        layout_overflow_ = rect;
    }
...
public:
    ...
    SimpleVisualOverflowModel& operator=(const SimpleVisualOverflowModel&) = delete;
    const LayoutRect& VisualOverflowRect() const
    {
        return visual_overflow_;
    }
    void SetVisualOverflow(const LayoutRect& rect)
    {
        visual_overflow_ = rect;
    }
