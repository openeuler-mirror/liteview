...
class NGFragmentationTest : public NGBaseLayoutAlgorithmTest, private ScopedLayoutNGBlockFragmentationForTest {
protected:
    NGFragmentationTest()
...
TEST_F(NGFragmentationTest, InkOverflowInline)
{
    ...
    EXPECT_EQ(flow_thread->PhysicalVisualOverflowRect(), PhysicalRect(0, 0, 100, 30));
    EXPECT_EQ(container->PhysicalVisualOverflowRect(), PhysicalRect(0, 0, 260, 15));
}
