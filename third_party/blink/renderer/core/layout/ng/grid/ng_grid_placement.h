...
public:
    ...
    NGGridPlacement(const ComputedStyle& grid_style, const NGGridPlacementData& placement_data);
    ...
    static void ResolveOutOfFlowItemGridLines(const NGGridLayoutTrackCollection& track_collection, const NGGridPlacementData& placement_data,
