...
NGGridNamedLineCollection::NGGridNamedLineCollection(const String& named_line, GridTrackSizingDirection track_direction,
    ...
    , auto_repeat_total_tracks_(auto_repeat_tracks_count)
{
    ...
    auto_repeat_track_list_length_ = computed_grid_track_list.TrackList().AutoRepeatTrackCount();
}
