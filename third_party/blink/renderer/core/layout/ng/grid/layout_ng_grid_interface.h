...
public:
    virtual wtf_size_t AutoRepeatCountForDirection(const GridTrackSizingDirection track_direction) const = 0;
    virtual wtf_size_t ExplicitGridStartForDirection(const GridTrackSizingDirection track_direction) const = 0;
    virtual wtf_size_t ExplicitGridEndForDirection(const GridTrackSizingDirection track_direction) const = 0;
    virtual LayoutUnit GridGap(const GridTrackSizingDirection track_direction) const = 0;
    virtual LayoutUnit GridItemOffset(const GridTrackSizingDirection track_direction) const = 0;
    virtual Vector<LayoutUnit, 1> TrackSizesForComputedStyle(const GridTrackSizingDirection track_direction) const = 0;

    virtual Vector<LayoutUnit> RowPositions() const = 0;
    virtual Vector<LayoutUnit> ColumnPositions() const = 0;
};

template <> struct InterfaceDowncastTraits<LayoutNGGridInterface> {
