...
public:
    ...
    void SetStyle(scoped_refptr<const ComputedStyle> style, NGStyleVariant style_variant)
    {
        DCHECK(style);
...
protected:
    NGFragmentBuilder(scoped_refptr<const ComputedStyle> style, WritingDirectionMode writing_direction)
        : style_(std::move(style))
