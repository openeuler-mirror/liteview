...
//    layout_ng_mixin.cc.
template <typename Base> class LayoutNGBlockFlowMixin : public LayoutNGMixin<Base> {
public:
...
protected:
    ...
    void AddOutlineRects(Vector<PhysicalRect>&, LayoutObject::OutlineInfo*, const PhysicalOffset& additional_offset, NGOutlineType) const final;

    void DirtyLinesFromChangedChild(LayoutObject* child, MarkingBehavior marking_behavior) final;
