...
{
    NOT_DESTROYED();
    return type == kLayoutObjectNGSVGForeignObject || LayoutNGBlockFlowMixin<LayoutSVGBlock>::IsOfType(type);
}

bool LayoutNGSVGForeignObject::IsChildAllowed(LayoutObject* child, const ComputedStyle& style) const
{
    NOT_DESTROYED();
