...
NGSvgTextLayoutAttributesBuilder::NGSvgTextLayoutAttributesBuilder(NGInlineNode ifc)
...
void NGSvgTextLayoutAttributesBuilder::Build(const String& ifc_text_content, const HeapVector<NGInlineItem>& items)
{
    ...
    const bool horizontal = IsHorizontalWritingMode(block_flow_->StyleRef().GetWritingMode());
