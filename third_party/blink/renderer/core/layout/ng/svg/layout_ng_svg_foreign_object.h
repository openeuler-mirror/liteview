...
extern template class CORE_EXTERN_TEMPLATE_EXPORT LayoutNGBlockFlowMixin<LayoutSVGBlock>;

// The LayoutNG representation of SVG <foreignObject>.
class LayoutNGSVGForeignObject final : public LayoutNGBlockFlowMixin<LayoutSVGBlock> {
public:
...
template <> struct DowncastTraits<LayoutNGSVGForeignObject> {
