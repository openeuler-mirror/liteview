...
public:
    ...
    {
        return !is_first_line || !first_line_items_ ? (const NGInlineItemsData&)*this : *first_line_items_;
    }

    bool IsShapingDeferred() const
    {
        return shaping_state_ == kShapingDeferred;
    }
    bool IsShapingDone() const
    {
        return shaping_state_ == kShapingDone;
    }
    void StopDeferringShaping()
    {
        shaping_state_ = kShapingNone;
    }
