...
public:
    ...
    const NGFragmentItem* Item() const
    {
        return item_;
    }
    ...
    void RecalcInkOverflow(const NGInlineCursor& cursor, NGInlinePaintContext* inline_context) const;
...
public:
    ...
    NGInlineCursor(const NGPhysicalBoxFragment& box_fragment, const NGFragmentItems& items);
    ...
    //
    const NGInlineCursorPosition& Current() const
    {
        return current_;
    }
    ...
    const NGFragmentItem* CurrentItem() const
    {
        return Current().Item();
    }
    ...
    PositionWithAffinity PositionForPointInInlineFormattingContext(const PhysicalOffset& point, const NGPhysicalBoxFragment& container);
...
private:
    NGInlineCursor(const NGPhysicalBoxFragment& box_fragment, const NGFragmentItems& fragment_items, ItemsSpan items);
    ...
    void SetRoot(const NGPhysicalBoxFragment& box_fragment, const NGFragmentItems& items);
    void SetRoot(const NGPhysicalBoxFragment& box_fragment, const NGFragmentItems& fragment_items, ItemsSpan items);
