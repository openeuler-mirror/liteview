...
static_assert(sizeof(NGInlineChildLayoutContext) == sizeof(SameSizeAsNGInlineChildLayoutContext),
...
NGInlineChildLayoutContext::NGInlineChildLayoutContext(const NGInlineNode& node, NGBoxFragmentBuilder* container_builder)
...
NGInlineLayoutStateStack* NGInlineChildLayoutContext::BoxStatesIfValidForItemIndex(const HeapVector<NGInlineItem>& items, unsigned item_index)
{
...
void NGInlineChildLayoutContext::PropagateBreakToken(const NGBlockBreakToken* token)
{
