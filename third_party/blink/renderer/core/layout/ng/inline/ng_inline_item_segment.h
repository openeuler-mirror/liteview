...
public:
    ...
    public:
        Iterator(unsigned start_offset, unsigned end_offset, const NGInlineItemSegment* segment);
    ...
    scoped_refptr<ShapeResult> ShapeText(
...
inline NGInlineItemSegments::Iterator::Iterator(unsigned start_offset, unsigned end_offset, const NGInlineItemSegment* segment)
    : segment_(segment)
