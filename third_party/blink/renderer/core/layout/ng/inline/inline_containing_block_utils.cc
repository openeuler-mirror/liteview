...
using LineBoxPair = std::pair<const NGPhysicalLineBoxFragment*, const NGPhysicalLineBoxFragment*>;
    ...
    const WritingModeConverter* containing_block_converter = nullptr)
{
    ...
    for (const auto& item : items) {
        ...
        if (const NGPhysicalLineBoxFragment* current_linebox = item->LineBoxFragment()) {
        ...
        absl::optional<InlineContainingBlockUtils::InlineContainingBlockGeometry>& containing_block_geometry = it->value;
...
void InlineContainingBlockUtils::ComputeInlineContainerGeometry(InlineContainingBlockMap* inline_containing_block_map, NGBoxFragmentBuilder* container_builder)
{
