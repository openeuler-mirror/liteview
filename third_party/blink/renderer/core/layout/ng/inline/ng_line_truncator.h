...
public:
    ...
    // created.
    LayoutUnit TruncateLine(LayoutUnit line_width, NGLogicalLineItems* line_box, NGInlineLayoutStateStack* box_states);

    LayoutUnit TruncateLineInTheMiddle(LayoutUnit line_width, NGLogicalLineItems* line_box, NGInlineLayoutStateStack* box_states);
...
private:
    ...
    LayoutUnit PlaceEllipsisNextTo(NGLogicalLineItems* line_box, NGLogicalLineItem* ellipsized_child);
    ...
    //                         copied.
    wtf_size_t AddTruncatedChild(wtf_size_t source_index, bool leave_one_character, LayoutUnit position, TextDirection edge, NGLogicalLineItems* line_box,
        NGInlineLayoutStateStack* box_states);
    bool EllipsizeChild(
        LayoutUnit line_width, LayoutUnit ellipsis_width, bool is_first_child, NGLogicalLineItem*, absl::optional<NGLogicalLineItem>* truncated_child);
    bool TruncateChild(
        LayoutUnit space_for_this_child, bool is_first_child, const NGLogicalLineItem& child, absl::optional<NGLogicalLineItem>* truncated_child);
    ...
    NGLogicalLineItem TruncateText(const NGLogicalLineItem& item, const ShapeResult& shape_result, unsigned offset_to_fit, TextDirection direction);
