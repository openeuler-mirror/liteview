...
public:
    ...
    static NGInlineBreakToken* Create(NGInlineNode node, const ComputedStyle* style, unsigned item_index, unsigned text_offset,
        unsigned flags /* NGInlineBreakTokenFlags */, const NGBreakToken* sub_break_token = nullptr);
    ...
    NGInlineBreakToken(PassKey, NGInlineNode node, const ComputedStyle*, unsigned item_index, unsigned text_offset,
...
template <> struct DowncastTraits<NGInlineBreakToken> {
