...
HeapVector<NGOffsetMappingUnit> ToVector(const base::span<const NGOffsetMappingUnit>& range)
{
...
bool operator==(const NGOffsetMappingUnit& unit, const NGOffsetMappingUnit& other)
{
...
bool operator==(const HeapVector<NGOffsetMappingUnit>& units1, const HeapVector<NGOffsetMappingUnit>& units2)
{
...
bool operator==(const HeapVector<NGOffsetMappingUnit>& units, const base::span<const NGOffsetMappingUnit>& range)
{
    return units == ToVector(range);
}

void PrintTo(const HeapVector<NGOffsetMappingUnit>& units, std::ostream* ostream)
{
    *ostream << "[";
    const char* comma = "";
...
void PrintTo(const base::span<const NGOffsetMappingUnit>& range, std::ostream* ostream)
{
...
protected:
    ...
    {
        const NGOffsetMapping* map = NGInlineNode(layout_block_flow_).ComputeOffsetMappingIfNeeded();
        CHECK(map);
        return *map;
    }
    ...
    HeapVector<NGOffsetMappingUnit> GetUnits(wtf_size_t index1, wtf_size_t index2)
    {
    ...
    const NGOffsetMappingUnit* GetUnitForPosition(const Position& position) const
    {
        return GetOffsetMapping().GetMappingUnitForPosition(position);
    }

    absl::optional<unsigned> GetTextContentOffset(const Position& position) const
    {
...
TEST_F(NGOffsetMappingTest, CollapsibleSpaceAfterNonCollapsibleSpaceAcrossElements)
{
    SetupHtml("t",
        "<div id=t>"
...
TEST_F(NGOffsetMappingTest, OneTextNode)
{
    ...
    TEST_UNIT(result.GetUnits()[0], NGOffsetMappingUnitType::kIdentity, foo_node, 0u, 3u, 0u, 3u);
...
TEST_F(NGOffsetMappingTest, TwoTextNodes)
{
    ...
    TEST_UNIT(result.GetUnits()[0], NGOffsetMappingUnitType::kIdentity, foo_node, 0u, 3u, 0u, 3u);
    TEST_UNIT(result.GetUnits()[1], NGOffsetMappingUnitType::kIdentity, bar_node, 0u, 3u, 3u, 6u);
...
TEST_F(NGOffsetMappingTest, BRBetweenTextNodes)
{
    ...
    TEST_UNIT(result.GetUnits()[0], NGOffsetMappingUnitType::kIdentity, foo_node, 0u, 3u, 0u, 3u);
    TEST_UNIT(result.GetUnits()[1], NGOffsetMappingUnitType::kIdentity, br_node, 0u, 1u, 3u, 4u);
    TEST_UNIT(result.GetUnits()[2], NGOffsetMappingUnitType::kIdentity, bar_node, 0u, 3u, 4u, 7u);
...
TEST_F(NGOffsetMappingTest, OneTextNodeWithCollapsedSpace)
{
    ...
    ASSERT_EQ(3u, result.GetUnits().size());
    TEST_UNIT(result.GetUnits()[0], NGOffsetMappingUnitType::kIdentity, node, 0u, 4u, 0u, 4u);
    TEST_UNIT(result.GetUnits()[1], NGOffsetMappingUnitType::kCollapsed, node, 4u, 5u, 4u, 4u);
    TEST_UNIT(result.GetUnits()[2], NGOffsetMappingUnitType::kIdentity, node, 5u, 8u, 4u, 7u);
...
TEST_F(NGOffsetMappingTest, FullyCollapsedWhiteSpaceNode)
{
    ...
    ASSERT_EQ(3u, result.GetUnits().size());
    TEST_UNIT(result.GetUnits()[0], NGOffsetMappingUnitType::kIdentity, foo_node, 0u, 4u, 0u, 4u);
    TEST_UNIT(result.GetUnits()[1], NGOffsetMappingUnitType::kCollapsed, space_node, 0u, 1u, 4u, 4u);
    TEST_UNIT(result.GetUnits()[2], NGOffsetMappingUnitType::kIdentity, bar_node, 0u, 3u, 4u, 7u);
...
TEST_F(NGOffsetMappingTest, ReplacedElement)
{
    ...
    ASSERT_EQ(3u, result.GetUnits().size());
    TEST_UNIT(result.GetUnits()[0], NGOffsetMappingUnitType::kIdentity, foo_node, 0u, 4u, 0u, 4u);
    TEST_UNIT(result.GetUnits()[1], NGOffsetMappingUnitType::kIdentity, img_node, 0u, 1u, 4u, 5u);
    TEST_UNIT(result.GetUnits()[2], NGOffsetMappingUnitType::kIdentity, bar_node, 0u, 4u, 5u, 9u);
...
TEST_F(NGOffsetMappingTest, FirstLetter)
{
    ...
    ASSERT_EQ(2u, result.GetUnits().size());
    TEST_UNIT(result.GetUnits()[0], NGOffsetMappingUnitType::kIdentity, foo_node, 0u, 1u, 0u, 1u);
    // first leter and remaining text are always in different mapping units.
    TEST_UNIT(result.GetUnits()[1], NGOffsetMappingUnitType::kIdentity, foo_node, 1u, 3u, 1u, 3u);
...
TEST_F(NGOffsetMappingTest, FirstLetterWithLeadingSpace)
{
    ...
    ASSERT_EQ(3u, result.GetUnits().size());
    TEST_UNIT(result.GetUnits()[0], NGOffsetMappingUnitType::kCollapsed, foo_node, 0u, 2u, 0u, 0u);
    TEST_UNIT(result.GetUnits()[1], NGOffsetMappingUnitType::kIdentity, foo_node, 2u, 3u, 0u, 1u);
    // first leter and remaining text are always in different mapping units.
    TEST_UNIT(result.GetUnits()[2], NGOffsetMappingUnitType::kIdentity, foo_node, 3u, 5u, 1u, 3u);
...
TEST_F(NGOffsetMappingTest, FirstLetterWithoutRemainingText)
{
    ...
    ASSERT_EQ(2u, result.GetUnits().size());
    TEST_UNIT(result.GetUnits()[0], NGOffsetMappingUnitType::kCollapsed, text_node, 0u, 2u, 0u, 0u);
    TEST_UNIT(result.GetUnits()[1], NGOffsetMappingUnitType::kIdentity, text_node, 2u, 3u, 0u, 1u);
...
TEST_F(NGOffsetMappingTest, FirstLetterInDifferentBlock)
{
    ...
    TEST_UNIT(first_letter_result.GetUnits()[0], NGOffsetMappingUnitType::kIdentity, text_node, 0u, 1u, 0u, 1u);
    ...
    TEST_UNIT(remaining_text_result.GetUnits()[0], NGOffsetMappingUnitType::kIdentity, text_node, 1u, 3u, 1u, 3u);
...
TEST_F(NGOffsetMappingTest, ContainerWithGeneratedContent)
{
    ...
    EXPECT_EQ((HeapVector<NGOffsetMappingUnit> { NGOffsetMappingUnit(kIdentity, before, 0u, 3u, 0u, 3u),
                  NGOffsetMappingUnit(kIdentity, *text->GetLayoutObject(), 0u, 3u, 3u, 6u), NGOffsetMappingUnit(kIdentity, after, 0u, 3u, 6u, 9u) }),
        result.GetUnits());

    // Verify |GetMappingUnitsForLayoutObject()| for ::before and ::after
    EXPECT_EQ((HeapVector<NGOffsetMappingUnit> { NGOffsetMappingUnit(kIdentity, before, 0u, 3u, 0u, 3u) }), result.GetMappingUnitsForLayoutObject(before));
    EXPECT_EQ((HeapVector<NGOffsetMappingUnit> { NGOffsetMappingUnit(kIdentity, after, 0u, 3u, 6u, 9u) }), result.GetMappingUnitsForLayoutObject(after));
}

TEST_F(NGOffsetMappingTest, ContainerWithGeneratedContentWithCollapsedWhitespace)
{
    SetupHtml("t",
        "<style>"
    ...
    EXPECT_EQ((HeapVector<NGOffsetMappingUnit> { NGOffsetMappingUnit(kCollapsed, first_letter_part, 0u, 2u, 0u, 0u),
                  NGOffsetMappingUnit(kIdentity, first_letter_part, 2u, 3u, 0u, 1u), NGOffsetMappingUnit(kIdentity, remaining_part, 0u, 1u, 1u, 2u),
                  NGOffsetMappingUnit(kCollapsed, remaining_part, 1u, 3u, 2u, 2u), NGOffsetMappingUnit(kIdentity, remaining_part, 3u, 5u, 2u, 4u),
    ...
    EXPECT_EQ((HeapVector<NGOffsetMappingUnit> {
                  NGOffsetMappingUnit(kCollapsed, first_letter_part, 0u, 2u, 0u, 0u), NGOffsetMappingUnit(kIdentity, first_letter_part, 2u, 3u, 0u, 1u) }),
        result.GetMappingUnitsForLayoutObject(first_letter_part));
    EXPECT_EQ((HeapVector<NGOffsetMappingUnit> { NGOffsetMappingUnit(kIdentity, remaining_part, 0u, 1u, 1u, 2u),
                  NGOffsetMappingUnit(kCollapsed, remaining_part, 1u, 3u, 2u, 2u), NGOffsetMappingUnit(kIdentity, remaining_part, 3u, 5u, 2u, 4u) }),
...
TEST_F(NGOffsetMappingTest, Table)
{
    ...
    ASSERT_EQ(3u, result.GetUnits().size());
    TEST_UNIT(result.GetUnits()[0], NGOffsetMappingUnitType::kCollapsed, foo_node, 0u, 2u, 0u, 0u);
    TEST_UNIT(result.GetUnits()[1], NGOffsetMappingUnitType::kIdentity, foo_node, 2u, 5u, 0u, 3u);
    TEST_UNIT(result.GetUnits()[2], NGOffsetMappingUnitType::kCollapsed, foo_node, 5u, 7u, 3u, 3u);
...
TEST_F(NGOffsetMappingTest, GetMappingForInlineBlock)
{
    ...
    const NGOffsetMapping* div_mapping = NGOffsetMapping::GetFor(Position(div->firstChild(), 0));
    const NGOffsetMapping* span_mapping = NGOffsetMapping::GetFor(Position(span->firstChild(), 0));
    ...
    const NGOffsetMapping* span_before_mapping = NGOffsetMapping::GetFor(Position::BeforeNode(*span));
    EXPECT_EQ(div_mapping, span_before_mapping);
    EXPECT_NE(span_mapping, span_before_mapping);

    const NGOffsetMapping* span_after_mapping = NGOffsetMapping::GetFor(Position::AfterNode(*span));
...
TEST_F(NGOffsetMappingTest, NoWrapSpaceAndCollapsibleSpace)
{
    ...
    TEST_UNIT(mapping.GetUnits()[0], NGOffsetMappingUnitType::kIdentity, foo, 0u, 4u, 0u, 4u);
    TEST_UNIT(mapping.GetUnits()[1], NGOffsetMappingUnitType::kCollapsed, bar, 0u, 1u, 5u, 5u);
    TEST_UNIT(mapping.GetUnits()[2], NGOffsetMappingUnitType::kIdentity, bar, 1u, 4u, 5u, 8u);
...
TEST_F(NGOffsetMappingTest, PreLine)
{
    ...
    EXPECT_EQ((HeapVector<NGOffsetMappingUnit> { NGOffsetMappingUnit(kIdentity, text_ab_n_cd, 0u, 2u, 0u, 2u),
                  NGOffsetMappingUnit(kCollapsed, text_ab_n_cd, 2u, 3u, 2u, 2u), NGOffsetMappingUnit(kIdentity, text_ab_n_cd, 3u, 4u, 2u, 3u),
                  NGOffsetMappingUnit(kCollapsed, text_ab_n_cd, 4u, 5u, 3u, 3u), NGOffsetMappingUnit(kIdentity, text_ab_n_cd, 5u, 7u, 3u, 5u) }),
        result.GetUnits());
...
TEST_F(NGOffsetMappingTest, BiDiAroundForcedBreakInPreLine)
{
    ...
    ASSERT_EQ(3u, mapping.GetUnits().size());
    TEST_UNIT(mapping.GetUnits()[0], NGOffsetMappingUnitType::kIdentity, text, 0u, 3u, 1u, 4u); // "foo"
    TEST_UNIT(mapping.GetUnits()[1], NGOffsetMappingUnitType::kIdentity, text, 3u, 4u, 5u, 6u); // "\n"
    TEST_UNIT(mapping.GetUnits()[2], NGOffsetMappingUnitType::kIdentity, text, 4u, 7u, 7u, 10u); // "bar"
...
TEST_F(NGOffsetMappingTest, SoftHyphen)
{
    ...
    TEST_UNIT(mapping.GetUnits()[0], NGOffsetMappingUnitType::kIdentity, text, 0u, 7u, 0u, 7u);
...
TEST_F(NGOffsetMappingTest, PreWrapAndReusing)
{
    ...
    EXPECT_EQ((HeapVector<NGOffsetMappingUnit> {
                  NGOffsetMappingUnit(kIdentity, *text.GetLayoutObject(), 0u, 1u, 0u, 1u),
                  NGOffsetMappingUnit(kIdentity, *text.GetLayoutObject(), 1u, 4u, 2u, 5u),
              }),
        mapping.GetUnits());
}
...
TEST_F(NGOffsetMappingTest, RestoreTrailingCollapsibleSpaceReplace)
{
    ...
    EXPECT_EQ((HeapVector<NGOffsetMappingUnit> {
                  NGOffsetMappingUnit(kIdentity, *layout_object_a.SlowFirstChild(), 0u, 1u, 0u, 1u),
                  NGOffsetMappingUnit(kCollapsed, *layout_object_b.SlowFirstChild(), 0u, 1u, 2u, 2u),
                  NGOffsetMappingUnit(kCollapsed, newline, 0u, 1u, 2u, 2u),
                  NGOffsetMappingUnit(kCollapsed, *layout_object_i.SlowFirstChild(), 0u, 1u, 2u, 2u),
              }),
        result.GetUnits());
}
...
TEST_F(NGOffsetMappingTest, RestoreTrailingCollapsibleSpaceReplaceKeep)
{
    ...
    EXPECT_EQ((HeapVector<NGOffsetMappingUnit> {
                  NGOffsetMappingUnit(kIdentity, *layout_object_a.SlowFirstChild(), 0u, 1u, 0u, 1u),
                  NGOffsetMappingUnit(kIdentity, *layout_object_b.SlowFirstChild(), 0u, 1u, 2u, 3u),
                  NGOffsetMappingUnit(kCollapsed, newline, 0u, 1u, 3u, 3u),
                  NGOffsetMappingUnit(kIdentity, *layout_object_i.SlowFirstChild(), 0u, 1u, 3u, 4u),
              }),
        result.GetUnits());
}
...
TEST_F(NGOffsetMappingTest, RestoreTrailingCollapsibleSpaceNone)
{
    ...
    EXPECT_EQ((HeapVector<NGOffsetMappingUnit> {
                  ...
                  NGOffsetMappingUnit(kIdentity, *layout_object_b.SlowFirstChild(), 0u, 1u, 1u, 2u),
                  NGOffsetMappingUnit(kCollapsed, *layout_object_b.SlowFirstChild(), 1u, 3u, 2u, 2u),
                  NGOffsetMappingUnit(kCollapsed, newline, 0u, 1u, 2u, 2u),
                  NGOffsetMappingUnit(kIdentity, *layout_object_i.SlowFirstChild(), 0u, 1u, 2u, 3u),
              }),
        result.GetUnits());
}
...
TEST_F(NGOffsetMappingTest, RestoreTrailingCollapsibleSpaceSplit)
{
    ...
    EXPECT_EQ((HeapVector<NGOffsetMappingUnit> {
                  NGOffsetMappingUnit(kIdentity, *layout_object_a.SlowFirstChild(), 0u, 1u, 0u, 1u),
                  NGOffsetMappingUnit(kCollapsed, *layout_object_b.SlowFirstChild(), 0u, 3u, 2u, 2u),
                  NGOffsetMappingUnit(kCollapsed, newline, 0u, 1u, 2u, 2u),
                  NGOffsetMappingUnit(kCollapsed, *layout_object_i.SlowFirstChild(), 0u, 1u, 2u, 2u),
              }),
        result.GetUnits());
...
TEST_F(NGOffsetMappingTest, RestoreTrailingCollapsibleSpaceSplitKeep)
{
    ...
    EXPECT_EQ((HeapVector<NGOffsetMappingUnit> {
                  NGOffsetMappingUnit(kIdentity, *layout_object_a.SlowFirstChild(), 0u, 1u, 0u, 1u),
                  NGOffsetMappingUnit(kIdentity, *layout_object_b.SlowFirstChild(), 0u, 1u, 2u, 3u),
                  NGOffsetMappingUnit(kCollapsed, *layout_object_b.SlowFirstChild(), 1u, 3u, 3u, 3u),
                  NGOffsetMappingUnit(kCollapsed, newline, 0u, 1u, 3u, 3u),
                  NGOffsetMappingUnit(kIdentity, *layout_object_i.SlowFirstChild(), 0u, 1u, 3u, 4u),
              }),
        result.GetUnits());
...
TEST_F(NGOffsetMappingTest, TextOverflowEllipsis)
{
    ...
    ASSERT_EQ(1u, mapping.GetUnits().size());
    TEST_UNIT(mapping.GetUnits()[0], NGOffsetMappingUnitType::kIdentity, text, 0u, 6u, 0u, 6u);
    TEST_RANGE(mapping.GetRanges(), text, 0u, 1u);
}
...
TEST_F(NGOffsetMappingTest, WordBreak)
{
    ...
    EXPECT_EQ((HeapVector<NGOffsetMappingUnit> { NGOffsetMappingUnit(kIdentity, text_a, 0u, 1u, 0u, 1u), NGOffsetMappingUnit(kIdentity, wbr, 0u, 1u, 1u, 2u),
                  NGOffsetMappingUnit(kIdentity, text_b, 0u, 1u, 2u, 3u) }),
        result.GetUnits());

    EXPECT_EQ((HeapVector<NGOffsetMappingUnit> { NGOffsetMappingUnit(kIdentity, wbr, 0u, 1u, 1u, 2u) }), result.GetMappingUnitsForLayoutObject(wbr));
}

// Test |GetOffsetMapping| which is available both for LayoutNG and for legacy.
class NGOffsetMappingGetterTest : public RenderingTest, public testing::WithParamInterface<bool>, private ScopedLayoutNGForTest {
public:
...
INSTANTIATE_TEST_SUITE_P(NGOffsetMappingTest, NGOffsetMappingGetterTest, testing::Bool());
...
TEST_P(NGOffsetMappingGetterTest, Get)
{
    ...
    // engine.
    DCHECK_EQ(layout_block_flow->IsLayoutNGObject(), RuntimeEnabledFeatures::LayoutNGEnabled());

    const NGOffsetMapping* mapping = NGInlineNode::GetOffsetMapping(layout_block_flow);
    EXPECT_TRUE(mapping);
