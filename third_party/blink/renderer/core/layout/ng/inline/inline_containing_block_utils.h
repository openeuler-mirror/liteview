...
public:
    ...
    using InlineContainingBlockMap = HashMap<Persistent<const LayoutObject>, absl::optional<InlineContainingBlockGeometry>>;
    ...
    static void ComputeInlineContainerGeometry(InlineContainingBlockMap* inline_containing_block_map, NGBoxFragmentBuilder* container_builder);
