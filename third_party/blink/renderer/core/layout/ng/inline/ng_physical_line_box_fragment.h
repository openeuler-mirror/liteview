...
public:
    ...
    static const NGPhysicalLineBoxFragment* Create(NGLineBoxFragmentBuilder* builder);

    static const NGPhysicalLineBoxFragment* Clone(const NGPhysicalLineBoxFragment&);
    ...
    {
        return LineBoxType() == kEmptyLineBox;
    }
    ...
    PhysicalRect ScrollableOverflow(const NGPhysicalBoxFragment& container, const ComputedStyle& container_style, TextHeightType height_type) const;
    PhysicalRect ScrollableOverflowForLine(const NGPhysicalBoxFragment& container, const ComputedStyle& container_style, const NGFragmentItem& line,
        const NGInlineCursor& cursor, TextHeightType height_type) const;
...
template <> struct DowncastTraits<NGPhysicalLineBoxFragment> {
