...
class CORE_EXPORT NGPageLayoutAlgorithm : public NGLayoutAlgorithm<NGBlockNode, NGBoxFragmentBuilder, NGBlockBreakToken> {
public:
...
private:
    NGConstraintSpace CreateConstraintSpaceForPages(const LogicalSize& size) const;
};
