...
class NGColumnLayoutAlgorithmTest : public NGBaseLayoutAlgorithmTest, private ScopedLayoutNGBlockFragmentationForTest {
protected:
...
TEST_F(NGColumnLayoutAlgorithmTest, EmptyMulticol)
{
    ...
    NGConstraintSpace space
        = ConstructBlockLayoutTestConstraintSpace({ WritingMode::kHorizontalTb, TextDirection::kLtr }, LogicalSize(LayoutUnit(1000), kIndefiniteSize));
    const NGPhysicalBoxFragment* parent_fragment = NGBaseLayoutAlgorithmTest::RunBlockLayoutAlgorithm(container, space);
...
TEST_F(NGColumnLayoutAlgorithmTest, LinesInMulticolChildInsufficientSpaceForFirst)
{
    SetBodyInnerHTML(R"HTML(
    <style>
      #parent {
...
TEST_F(NGColumnLayoutAlgorithmTest, MinMax)
{
    ...
    scoped_refptr<ComputedStyle> style = ComputedStyle::Clone(layout_object->StyleRef());
...
TEST_F(NGColumnLayoutAlgorithmTest, ColumnBalancingFixedHeightOverflowingContent)
{
    SetBodyInnerHTML(R"HTML(
    <style>
      #parent {
...
TEST_F(NGColumnLayoutAlgorithmTest, ColumnBalancingMinHeightLargerThanMaxHeight)
{
    // Min-height has no effect on the columns, only on the multicol
    // container. Balanced columns should never be taller than they have to be.
    SetBodyInnerHTML(R"HTML(
...
TEST_F(NGColumnLayoutAlgorithmTest, ColumnBalancing100By3)
{
    ...
    const NGPhysicalBoxFragment* parent_fragment = RunBlockLayoutAlgorithm(GetElementById("container"));
...
TEST_F(NGColumnLayoutAlgorithmTest, ClassCBreakPointBeforeBlockMarginCollapsing)
{
...
TEST_F(NGColumnLayoutAlgorithmTest, NoClassCBreakPointBeforeBlockMarginCollapsing)
{
...
TEST_F(NGColumnLayoutAlgorithmTest, IgnoreBreakInsideAvoidBecauseBreakBetweenAvoid)
{
...
TEST_F(NGColumnLayoutAlgorithmTest, AvoidBreakBetweenBreakInsidePreviousSibling)
{
    SetBodyInnerHTML(R"HTML(
    <style>
      #parent {
