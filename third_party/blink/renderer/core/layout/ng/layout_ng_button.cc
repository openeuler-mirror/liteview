...
void LayoutNGButton::AddChild(LayoutObject* new_child, LayoutObject* before_child)
{
    if (!inner_) {
...
void LayoutNGButton::UpdateAnonymousChildStyle(const LayoutObject* child, ComputedStyle& child_style) const
{
