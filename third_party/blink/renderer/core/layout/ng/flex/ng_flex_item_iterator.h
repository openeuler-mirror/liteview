...
public:
    NGFlexItemIterator(const HeapVector<NGFlexLine>& flex_lines, const NGBlockBreakToken* break_token, bool is_column);
...
public:
    Entry(NGFlexItem* flex_item, wtf_size_t flex_item_idx, wtf_size_t flex_line_idx, const NGBlockBreakToken* token)
        : flex_item(flex_item)
