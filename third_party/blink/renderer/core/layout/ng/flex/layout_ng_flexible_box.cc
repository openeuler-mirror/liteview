...
bool LayoutNGFlexibleBox::HasTopOverflow() const
{
    ...
    if (style.IsHorizontalWritingMode()) {
        return style.ResolvedIsColumnReverseFlexDirection() || (style.ResolvedIsRowFlexDirection() && is_wrap_reverse);
    }
    return style.IsLeftToRightDirection() == (style.ResolvedIsRowReverseFlexDirection() || (style.ResolvedIsColumnFlexDirection() && is_wrap_reverse));
}
...
bool LayoutNGFlexibleBox::HasLeftOverflow() const
{
    ...
    return (style.GetWritingMode() == WritingMode::kVerticalLr)
        == (style.ResolvedIsColumnReverseFlexDirection() || (style.ResolvedIsRowFlexDirection() && is_wrap_reverse));
}
...
bool LayoutNGFlexibleBox::IsChildAllowed(LayoutObject* object, const ComputedStyle& style) const
{
