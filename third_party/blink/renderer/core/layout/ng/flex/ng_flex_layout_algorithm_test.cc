...
TEST_F(NGFlexLayoutAlgorithmTest, AbsPosUma1)
{
    ...
    UpdateAllLifecyclePhasesForTest();
    LayoutNGFlexibleBox* flex = To<LayoutNGFlexibleBox>(GetLayoutObjectByElementId("flexbox"));
    LayoutObject* item = GetLayoutObjectByElementId("item");
    ItemPosition pos = FlexLayoutAlgorithm::AlignmentForChild(flex->StyleRef(), item->StyleRef());
...
TEST_F(NGFlexLayoutAlgorithmTest, AbsPosUmaDifferent)
{
    ...
    EXPECT_TRUE(GetDocument().IsUseCounted(WebFeature::kFlexboxNewAbsPos)) << "justify and align are clearly different";
}
...
TEST_F(NGFlexLayoutAlgorithmTest, AbsPosUmaDifferentButRow)
{
    ...
    EXPECT_FALSE(GetDocument().IsUseCounted(WebFeature::kFlexboxNewAbsPos)) << "justify and align are clearly different but we don't count row "
                                                                               "flexboxes";
}
...
TEST_F(NGFlexLayoutAlgorithmTest, AbsPosUmaBothCenter)
{
    ...
    EXPECT_FALSE(GetDocument().IsUseCounted(WebFeature::kFlexboxNewAbsPos)) << "justify and align are both center";
}
...
TEST_F(NGFlexLayoutAlgorithmTest, AbsPosUmaEndFlexEnd)
{
    ...
    EXPECT_FALSE(GetDocument().IsUseCounted(WebFeature::kFlexboxNewAbsPos)) << "justify and align map to same even though specified differently";
}
...
TEST_F(NGFlexLayoutAlgorithmTest, AbsPosUmaAlignItemsSame)
{
    ...
    // current: top right
    // proposed: top right
    EXPECT_FALSE(GetDocument().IsUseCounted(WebFeature::kFlexboxNewAbsPos)) << "align-items' default value for align-self is same as "
                                                                               "justify-self";
}
...
TEST_F(NGFlexLayoutAlgorithmTest, AbsPosUmaAlignItemsDifferent)
{
    ...
    // current: top right
    // proposed: top left
    EXPECT_TRUE(GetDocument().IsUseCounted(WebFeature::kFlexboxNewAbsPos)) << "align-items' default value for align-self differs from justify-self";
}
...
TEST_F(NGFlexLayoutAlgorithmTest, DISABLED_AbsPosUma0px)
{
    ...
    EXPECT_FALSE(GetDocument().IsUseCounted(WebFeature::kFlexboxNewAbsPos)) << "static pos rectangle and item are both 0px";
}
...
TEST_F(NGFlexLayoutAlgorithmTest, DISABLED_AbsPosUmaSameSize)
{
    ...
    EXPECT_FALSE(GetDocument().IsUseCounted(WebFeature::kFlexboxNewAbsPos)) << "static pos rectangle is same size as item's margin box";
}
...
TEST_F(NGFlexLayoutAlgorithmTest, DISABLED_AbsPosUmaAutoInsetsSameSize)
{
    ...
    EXPECT_FALSE(GetDocument().IsUseCounted(WebFeature::kFlexboxNewAbsPos)) << "auto insets in the axis of same size means no change";
}
...
TEST_F(NGFlexLayoutAlgorithmTest, AbsPosUmaNoAutoInsets)
{
    ...
    EXPECT_FALSE(GetDocument().IsUseCounted(WebFeature::kFlexboxNewAbsPos)) << "justify and align are different but has non-auto insets";
}
...
TEST_F(NGFlexLayoutAlgorithmTest, AbsPosUmaAutoInsetsDifferentSize)
{
    ...
    EXPECT_TRUE(GetDocument().IsUseCounted(WebFeature::kFlexboxNewAbsPos)) << "auto insets in the axis of different size means change";
}
...
TEST_F(NGFlexLayoutAlgorithmTest, UseCounter1)
{
    ...
    EXPECT_TRUE(GetDocument().IsUseCounted(WebFeature::kFlexboxAlignSingleLineDifference));
}
...
TEST_F(NGFlexLayoutAlgorithmTest, UseCounter1b)
{
    ...
    EXPECT_FALSE(GetDocument().IsUseCounted(WebFeature::kFlexboxAlignSingleLineDifference));
}
