...
public:
    CustomLayoutFragment(
        CustomLayoutChild*, CustomLayoutToken*, const NGLayoutResult*, const LogicalSize& size, const absl::optional<LayoutUnit> baseline, v8::Isolate*);
    ...
    absl::optional<double> baseline() const
    {
        return baseline_;
    }
