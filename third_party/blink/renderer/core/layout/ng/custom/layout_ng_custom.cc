...
void LayoutNGCustom::AddChild(LayoutObject* new_child, LayoutObject* before_child)
{
...
void LayoutNGCustom::StyleDidChange(StyleDifference diff, const ComputedStyle* old_style)
{
    if (state_ == kUnloaded) {
