...
public:
    ...
    public:
        ...
        bool Layout(const NGConstraintSpace&, const Document&, const NGBlockNode&, const LogicalSize& border_box_size,
            const NGBoxStrut& border_scrollbar_padding, CustomLayoutScope*, FragmentResultOptions*&,
        ...
        bool IntrinsicSizes(const NGConstraintSpace&, const Document&, const NGBlockNode&, const LogicalSize& border_box_size,
            const NGBoxStrut& border_scrollbar_padding, const LayoutUnit child_available_block_size, CustomLayoutScope*, IntrinsicSizesResultOptions**,
