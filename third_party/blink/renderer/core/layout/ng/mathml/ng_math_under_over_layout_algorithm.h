...
class CORE_EXPORT NGMathUnderOverLayoutAlgorithm : public NGLayoutAlgorithm<NGBlockNode, NGBoxFragmentBuilder, NGBlockBreakToken> {
public:
    explicit NGMathUnderOverLayoutAlgorithm(const NGLayoutAlgorithmParams& params);
...
private:
    void GatherChildren(NGBlockNode* base, NGBlockNode* second, NGBlockNode* third);
};
