...
class CORE_EXPORT NGMathRadicalLayoutAlgorithm : public NGLayoutAlgorithm<NGBlockNode, NGBoxFragmentBuilder, NGBlockBreakToken> {
public:
...
private:
    ...
    void GatherChildren(NGBlockNode* base, NGBlockNode* index, NGBoxFragmentBuilder* = nullptr) const;
};
