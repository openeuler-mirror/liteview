...
public:
    ...
    NGLayoutInputNode(std::nullptr_t)
        : box_(nullptr)
        , type_(kBlock)
    {
    }
    ...
    bool IsView() const
    {
        return IsBlock() && box_->IsLayoutNGView();
    }
    ...
    {
        return IsBlock() && box_->IsFlexItemIncludingNG();
    }
    ...
    bool IsGrid() const
    {
        return IsBlock() && box_->IsLayoutGridIncludingNG();
    }
    ...
    bool IsButton() const
    {
        return IsBlock() && box_->IsLayoutNGButton();
    }
    ...
    {
        return IsBlock() && box_->IsRubyRun();
    }
    bool IsRubyText() const
    {
        return box_->IsRubyText();
    }
    ...
    {
        return box_->IsLayoutNGTextCombine();
    }
    bool IsNGTable() const
    {
        return IsTable() && box_->IsLayoutNGObject();
    }
    ...
    {
        return box_->IsTextAreaIncludingNG();
    }
    bool IsTextControl() const
    {
        return box_->IsTextControlIncludingNG();
    }
    bool IsTextControlPlaceholder() const;
    bool IsTextField() const
    {
        return box_->IsTextFieldIncludingNG();
    }
    ...
    void IntrinsicSize(absl::optional<LayoutUnit>* computed_inline_size, absl::optional<LayoutUnit>* computed_block_size) const;
...
protected:
    ...
    void GetOverrideIntrinsicSize(absl::optional<LayoutUnit>* computed_inline_size, absl::optional<LayoutUnit>* computed_block_size) const;
