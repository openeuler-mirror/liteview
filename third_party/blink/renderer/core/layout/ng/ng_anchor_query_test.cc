...
class NGAnchorQueryTest : public RenderingTest, private ScopedLayoutNGForTest, private ScopedCSSAnchorPositioningForTest {
public:
    NGAnchorQueryTest()
        : ScopedLayoutNGForTest(true)
        , ScopedCSSAnchorPositioningForTest(true)
    {
    }
...
struct AnchorTestData {
    static Vector<AnchorTestData> ToList(const NGPhysicalAnchorQuery& anchor_query)
    {
...
TEST_F(NGAnchorQueryTest, AnchorNameAdd)
{
    ...
    EXPECT_THAT(AnchorTestData::ToList(*anchor_query), testing::ElementsAre(AnchorTestData { "--div1a", PhysicalRect(0, 0, 50, 20) }));
}
...
TEST_F(NGAnchorQueryTest, AnchorNameChange)
{
    ...
    const NGPhysicalAnchorQuery* anchor_query = AnchorQuery(*container);
    ASSERT_NE(anchor_query, nullptr);
    EXPECT_THAT(AnchorTestData::ToList(*anchor_query), testing::ElementsAre(AnchorTestData { "--div1", PhysicalRect(0, 0, 50, 20) }));
...
TEST_F(NGAnchorQueryTest, AnchorNameValid)
{
    ...
    EXPECT_THAT(ValidAnchorNames(*GetElementById("rel1")), testing::ElementsAre("--static"));
    ...
    EXPECT_THAT(ValidAnchorNames(*GetElementById("abs1")), testing::ElementsAre("--abspos", "--static"));
    // For the same reason, `rel2` has no anchors because the "last containing
    // block" is `abs1`.
    EXPECT_THAT(ValidAnchorNames(*GetElementById("rel2")), testing::ElementsAre());
    ...
    EXPECT_THAT(ValidAnchorNames(*GetElementById("static1")), testing::ElementsAre("--abspos", "--static"));
    // For `container`, the last containing block is `static1`, which is not
    // absolutely positioned, so all anchor names are valid.
    EXPECT_THAT(ValidAnchorNames(*GetElementById("container")), testing::ElementsAre("--abspos", "--static"));
}
...
TEST_F(NGAnchorQueryTest, BlockFlow)
{
    ...
    EXPECT_THAT(AnchorTestData::ToList(*anchor_query),
        testing::ElementsAre(AnchorTestData { "--div1", PhysicalRect(0, 0, 400, 20) }, AnchorTestData { "--div2", PhysicalRect(0, 20, 800, 0) },
    ...
    ASSERT_NE(anchor_query, nullptr);
    EXPECT_THAT(AnchorTestData::ToList(*anchor_query),
        testing::ElementsAre(AnchorTestData { "--div1", PhysicalRect(0, 0, 400, 40) }, AnchorTestData { "--div2", PhysicalRect(0, 40, 800, 0) },
...
TEST_F(NGAnchorQueryTest, Inline)
{
    ...
    ASSERT_NE(anchor_query, nullptr);
    EXPECT_THAT(AnchorTestData::ToList(*anchor_query),
        testing::ElementsAre(AnchorTestData { "--culled", PhysicalRect(20, 0, 20, 10) }, AnchorTestData { "--img", PhysicalRect(110, 0, 10, 8) },
            AnchorTestData { "--inline-block", PhysicalRect(130, 0, 10, 10) }, AnchorTestData { "--non-culled", PhysicalRect(50, 0, 20, 10) }));
    ...
    ASSERT_NE(anchor_query, nullptr);
    EXPECT_THAT(AnchorTestData::ToList(*anchor_query),
        testing::ElementsAre(AnchorTestData { "--add", PhysicalRect(80, 0, 20, 10) }, AnchorTestData { "--culled", PhysicalRect(20, 0, 20, 10) },
            AnchorTestData { "--img", PhysicalRect(110, 0, 10, 8) }, AnchorTestData { "--inline-block", PhysicalRect(130, 0, 10, 10) },
...
TEST_F(NGAnchorQueryTest, OutOfFlow)
{
    ...
    const NGPhysicalAnchorQuery* anchor_query = AnchorQueryByElementId("container");
    ASSERT_NE(anchor_query, nullptr);
    EXPECT_THAT(AnchorTestData::ToList(*anchor_query), testing::ElementsAre(AnchorTestData { "--abs1", PhysicalRect(100, 50, 400, 20) }));
...
TEST_F(NGAnchorQueryTest, Relative)
{
    ...
    const NGPhysicalAnchorQuery* anchor_query = AnchorQueryByElementId("container");
    ASSERT_NE(anchor_query, nullptr);
    EXPECT_THAT(AnchorTestData::ToList(*anchor_query), testing::ElementsAre(AnchorTestData { "--relpos", PhysicalRect(20, 10, 800, 0) }));
}
...
TEST_F(NGAnchorQueryTest, Transform)
{
    ...
    const NGPhysicalAnchorQuery* anchor_query = AnchorQueryByElementId("container");
    ASSERT_NE(anchor_query, nullptr);
    EXPECT_THAT(AnchorTestData::ToList(*anchor_query), testing::ElementsAre(AnchorTestData { "--transform", PhysicalRect(0, 0, 800, 0) }));
}
...
TEST_F(NGAnchorQueryTest, Scroll)
{
    ...
    const NGPhysicalAnchorQuery* anchor_query = AnchorQuery(*container);
    ASSERT_NE(anchor_query, nullptr);
    EXPECT_THAT(AnchorTestData::ToList(*anchor_query), testing::ElementsAre(AnchorTestData { "--inner", PhysicalRect(0, 0, 400, 500) }));
}
...
TEST_F(NGAnchorQueryTest, FragmentedContainingBlock)
{
    ...
    EXPECT_THAT(AnchorTestData::ToList(*cb_anchor_query1), testing::ElementsAre(AnchorTestData { "--a1", PhysicalRect(0, 50, 100, 50) }));
    ...
    EXPECT_THAT(AnchorTestData::ToList(*cb_anchor_query2), testing::ElementsAre(AnchorTestData { "--a1", PhysicalRect(0, 0, 100, 50) }));

    const NGPhysicalAnchorQuery* columns_anchor_query = AnchorQueryByElementId("columns");
    ASSERT_NE(columns_anchor_query, nullptr);
    EXPECT_THAT(AnchorTestData::ToList(*columns_anchor_query), testing::ElementsAre(AnchorTestData { "--a1", PhysicalRect(110, 0, 210, 100) }));

    const NGPhysicalAnchorQuery* container_anchor_query = AnchorQueryByElementId("container");
    ASSERT_NE(container_anchor_query, nullptr);
    EXPECT_THAT(AnchorTestData::ToList(*container_anchor_query), testing::ElementsAre(AnchorTestData { "--a1", PhysicalRect(110, 10, 210, 100) }));
}
