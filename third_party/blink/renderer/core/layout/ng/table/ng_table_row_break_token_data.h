...
struct NGTableRowBreakTokenData final : NGBlockBreakTokenData {
    NGTableRowBreakTokenData(const NGBlockBreakTokenData* break_token_data, LayoutUnit previous_consumed_row_block_size)
...
template <> struct DowncastTraits<NGTableRowBreakTokenData> {
