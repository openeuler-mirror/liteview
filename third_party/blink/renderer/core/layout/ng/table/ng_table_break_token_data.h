...
struct NGTableBreakTokenData final : NGBlockBreakTokenData {
    NGTableBreakTokenData(
        const NGBlockBreakTokenData* break_token_data, LayoutUnit consumed_table_box_block_size, bool has_entered_table_box, bool is_past_table_box)
...
template <> struct DowncastTraits<NGTableBreakTokenData> {
