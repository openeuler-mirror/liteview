...
class CORE_EXPORT LayoutNGTable : public LayoutNGBlock, public LayoutNGTableInterface {
public:
    ...
    void SetCachedTableColumnConstraints(scoped_refptr<const NGTableTypes::Columns>);
...
protected:
    ...
    {
        NOT_DESTROYED();
        return type == kLayoutObjectTable || LayoutNGMixin<LayoutBlock>::IsOfType(type);
    }
...
template <> struct DowncastTraits<LayoutNGTable> {
