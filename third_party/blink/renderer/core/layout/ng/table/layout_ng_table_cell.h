...
class CORE_EXPORT LayoutNGTableCell : public LayoutNGBlockFlowMixin<LayoutBlockFlow>, public LayoutNGTableCellInterface {
public:
...
protected:
    ...
    {
        NOT_DESTROYED();
        return type == kLayoutObjectTableCell || LayoutNGBlockFlowMixin<LayoutBlockFlow>::IsOfType(type);
    }
...
template <> struct DowncastTraits<LayoutNGTableCell> {
