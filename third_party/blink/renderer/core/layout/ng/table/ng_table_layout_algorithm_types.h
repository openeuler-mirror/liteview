...
public:
    ...
    struct Column {
        DISALLOW_NEW();
        Column(const absl::optional<LayoutUnit>& min_inline_size, const absl::optional<LayoutUnit>& max_inline_size, const absl::optional<float>& percent,
    ...
    struct CellBlockConstraint {
        ...
        CellBlockConstraint(LayoutUnit min_block_size, NGBoxStrut borders, wtf_size_t column_index, wtf_size_t effective_rowspan, bool is_constrained,
            bool has_descendant_that_depends_on_percentage_block_size)
    ...
    struct RowspanCell {
        ...
        bool operator<(const NGTableTypes::RowspanCell& rhs) const
        {
            ...
            // |RowspanCell|.
            auto IsEnclosed = [](const NGTableTypes::RowspanCell& c1, const NGTableTypes::RowspanCell& c2) {
    ...
    static Column CreateColumn(const ComputedStyle&, absl::optional<LayoutUnit> default_inline_size, bool is_table_fixed);

    static CellInlineConstraint CreateCellInlineConstraint(
        const NGBlockNode&, WritingDirectionMode table_writing_direction, bool is_fixed_layout, const NGBoxStrut& cell_border, const NGBoxStrut& cell_padding);

    static Section CreateSection(const NGLayoutInputNode&, wtf_size_t start_row, wtf_size_t row_count, LayoutUnit block_size, bool treat_as_tbody);
...
public:
    explicit NGTableGroupedChildrenIterator(const NGTableGroupedChildren& grouped_children, bool is_end = false);
...
WTF_ALLOW_MOVE_INIT_AND_COMPARE_WITH_MEM_FUNCTIONS(blink::NGTableTypes::CellInlineConstraint)
WTF_ALLOW_MOVE_INIT_AND_COMPARE_WITH_MEM_FUNCTIONS(blink::NGTableTypes::ColspanCell)
WTF_ALLOW_MOVE_INIT_AND_COMPARE_WITH_MEM_FUNCTIONS(blink::NGTableTypes::Column)
WTF_ALLOW_MOVE_INIT_AND_COMPARE_WITH_MEM_FUNCTIONS(blink::NGTableTypes::CellBlockConstraint)
WTF_ALLOW_MOVE_INIT_AND_COMPARE_WITH_MEM_FUNCTIONS(blink::NGTableTypes::RowspanCell)
