...
class NGTableConstraintSpaceData : public RefCounted<NGTableConstraintSpaceData> {
public:
    ...
    struct Row {
        Row(LayoutUnit block_size, wtf_size_t start_cell_index, wtf_size_t cell_count, absl::optional<LayoutUnit> baseline, bool is_collapsed)
    ...
    struct Cell {
        Cell(NGBoxStrut borders, LayoutUnit rowspan_block_size, wtf_size_t start_column, bool is_initial_block_size_indefinite,
    ...
    bool MaySkipRowLayout(const NGTableConstraintSpaceData& other, wtf_size_t new_row_index, wtf_size_t old_row_index) const
    {
    ...
    bool MaySkipSectionLayout(const NGTableConstraintSpaceData& other, wtf_size_t new_section_index, wtf_size_t old_section_index) const
    {
...
WTF_ALLOW_MOVE_INIT_AND_COMPARE_WITH_MEM_FUNCTIONS(blink::NGTableConstraintSpaceData::Section)
WTF_ALLOW_MOVE_AND_INIT_WITH_MEM_FUNCTIONS(blink::NGTableConstraintSpaceData::Row)
WTF_ALLOW_MOVE_AND_INIT_WITH_MEM_FUNCTIONS(blink::NGTableConstraintSpaceData::Cell)
