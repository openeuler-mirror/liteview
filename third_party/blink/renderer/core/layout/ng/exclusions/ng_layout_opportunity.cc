...
LineSegment ExcludedSegment(const NGExclusion& exclusion, LayoutUnit bfc_block_offset, LayoutUnit line_block_size)
{
...
// exclusion.
bool IntersectsExclusion(const NGExclusion& exclusion, LayoutUnit bfc_block_offset, LayoutUnit line_block_size)
{
...
bool NGLayoutOpportunity::IsBlockDeltaBelowShapes(LayoutUnit block_delta) const
{
...
LayoutUnit NGLayoutOpportunity::ComputeLineLeftOffset(const NGConstraintSpace& space, LayoutUnit line_block_size, LayoutUnit block_delta) const
{
...
LayoutUnit NGLayoutOpportunity::ComputeLineRightOffset(const NGConstraintSpace& space, LayoutUnit line_block_size, LayoutUnit block_delta) const
{
    ...
    LayoutUnit line_right = space.BfcOffset().line_offset + space.AvailableSize().inline_size;
