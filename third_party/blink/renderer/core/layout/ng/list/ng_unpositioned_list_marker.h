...
public:
    ...
    absl::optional<LayoutUnit> ContentAlignmentBaseline(const NGConstraintSpace&, FontBaseline, const NGPhysicalFragment& content) const;
    // Add a fragment for an outside list marker.
    void AddToBox(const NGConstraintSpace&, FontBaseline, const NGPhysicalFragment& content, const NGBoxStrut&, const NGLayoutResult& marker_layout_result,
        LayoutUnit content_baseline, LayoutUnit* block_offset, NGBoxFragmentBuilder*) const;
    ...
    void AddToBoxWithoutLineBoxes(
        const NGConstraintSpace&, FontBaseline, const NGLayoutResult& marker_layout_result, NGBoxFragmentBuilder*, LayoutUnit* intrinsic_block_size) const;
    ...
    const NGLayoutResult* Layout(const NGConstraintSpace& parent_space, const ComputedStyle& parent_style, FontBaseline) const;
...
private:
    LayoutUnit ComputeIntrudedFloatOffset(const NGConstraintSpace&, const NGBoxFragmentBuilder*, const NGBoxStrut&, LayoutUnit) const;
