...
public:
    NGUnpositionedFloat(NGBlockNode node, const NGBlockBreakToken* token, const LogicalSize available_size, const LogicalSize percentage_size,
        const LogicalSize replaced_percentage_size, const NGBfcOffset& origin_bfc_offset, const NGConstraintSpace& parent_space,
