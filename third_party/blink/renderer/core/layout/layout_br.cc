...
void LayoutBR::StyleDidChange(StyleDifference diff, const ComputedStyle* old_style)
{
    NOT_DESTROYED();
...
absl::optional<unsigned> LayoutBR::CaretOffsetForPosition(const Position& position) const
{
    NOT_DESTROYED();
