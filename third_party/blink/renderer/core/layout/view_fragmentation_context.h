...
class ViewFragmentationContext final : public GarbageCollected<ViewFragmentationContext>, public FragmentationContext {
public:
    explicit ViewFragmentationContext(LayoutView& view)
        : view_(&view)
    {
    }
