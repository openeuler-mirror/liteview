...
public:
    ...
    void TransformToInlineCoordinates(GraphicsContext&, const PhysicalRect& box_rect, bool clip = false) const;
...
private:
    ...
    float Width(unsigned from, unsigned length, const Font&, LayoutUnit x_position, TextDirection, HashSet<const SimpleFontData*>* fallback_fonts = nullptr,
        gfx::RectF* glyph_bounds = nullptr, float expansion = 0) const override;
