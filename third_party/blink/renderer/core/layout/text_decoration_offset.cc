...
int TextDecorationOffset::ComputeUnderlineOffsetForUnder(const Length& style_underline_offset, float computed_font_size, const SimpleFontData*,
    float text_decoration_thickness, FontVerticalPositionType position_type) const
{
    ...
    LayoutUnit offset = inline_text_box_->OffsetTo(position_type, baseline_type) + style_underline_offset_pixels;
    ...
    LayoutUnit farthest = root.FarthestPositionForUnderline(decorating_box_, position_type, baseline_type, position);
