...
class ParameterizedLayoutTextFragmentTest : public testing::WithParamInterface<bool>, private ScopedLayoutNGForTest, public LayoutTextFragmentTest {
public:
...
INSTANTIATE_TEST_SUITE_P(All, ParameterizedLayoutTextFragmentTest, testing::Bool());
...
TEST_P(ParameterizedLayoutTextFragmentTest, CaretMinMaxOffsetCollapsedRemainingText)
{
...
TEST_P(ParameterizedLayoutTextFragmentTest, ResolvedTextLengthCollapsedRemainingText)
{
    SetBasicBody("(f)  ");
    EXPECT_EQ(3u, GetFirstLetter()->ResolvedTextLength());
...
TEST_P(ParameterizedLayoutTextFragmentTest, ContainsCaretOffsetSpacesInBetween)
{
    SetBasicBody("(f)   oo");
    EXPECT_TRUE(GetFirstLetter()->ContainsCaretOffset(0)); // "|(f)   oo"
    EXPECT_TRUE(GetFirstLetter()->ContainsCaretOffset(1)); // "(|f)   oo"
...
TEST_P(ParameterizedLayoutTextFragmentTest, IsBeforeAfterNonCollapsedCharacterNoLineWrap)
{
    // Basic tests
    SetBasicBody("foo");
...
TEST_P(ParameterizedLayoutTextFragmentTest, IsBeforeAfterNonCollapsedLineWrapSpace)
{
    LoadAhem();
