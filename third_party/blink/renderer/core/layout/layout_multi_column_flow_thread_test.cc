...
class MultiColumnTreeModifyingTest : public MultiColumnRenderingTest, private ScopedLayoutNGForTest {
public:
    MultiColumnTreeModifyingTest()
...
TEST_F(MultiColumnRenderingTest, LegacyMulticolWithMathMLAndAbspos)
{
    ...
    SetBodyContent("<section style='position: relative; column-count: 1'>"
                   "<math>"
...
TEST_F(MultiColumnRenderingTest, LegacyMulticolWithTHeadContainingFixedpos)
{
    ...
    SetBodyContent("<div style='column-count: 1'>"
