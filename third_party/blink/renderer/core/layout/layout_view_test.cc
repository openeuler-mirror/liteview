...
class LayoutViewHitTestTest : public testing::WithParamInterface<HitTestConfig>, private ScopedLayoutNGForTest, public RenderingTest {
public:
...
INSTANTIATE_TEST_SUITE_P(All, LayoutViewHitTestTest,
    ::testing::Values(
        // Legacy 0 to 4
        HitTestConfig { false, mojom::EditingBehavior::kEditingMacBehavior }, HitTestConfig { false, mojom::EditingBehavior::kEditingWindowsBehavior },
        HitTestConfig { false, mojom::EditingBehavior::kEditingUnixBehavior }, HitTestConfig { false, mojom::EditingBehavior::kEditingAndroidBehavior },
        HitTestConfig { false, mojom::EditingBehavior::kEditingChromeOSBehavior },
        // LayoutNG 5 to 9
        HitTestConfig { true, mojom::EditingBehavior::kEditingMacBehavior }, HitTestConfig { true, mojom::EditingBehavior::kEditingWindowsBehavior },
        HitTestConfig { true, mojom::EditingBehavior::kEditingUnixBehavior }, HitTestConfig { true, mojom::EditingBehavior::kEditingAndroidBehavior },
...
TEST_P(LayoutViewHitTestTest, BlockInInlineBelowBottom)
{
    ...
    const auto& cd_1 = PositionWithAffinity(Position(cd, 1), LayoutNG() ? TextAffinity::kDownstream : TextAffinity::kUpstream);
    const auto& cd_2 = PositionWithAffinity(Position(cd, 2), TextAffinity::kUpstream);
    const auto& kEndOfLine = PositionWithAffinity(LayoutNG() ? Position::AfterNode(line2) : Position(cd, 2));
...
TEST_P(LayoutViewHitTestTest, EmptySpan)
{
    ...
    EXPECT_EQ(PositionWithAffinity(Position(ab, 1), LayoutNG() ? TextAffinity::kDownstream : TextAffinity::kUpstream), HitTest(10, 5));
    EXPECT_EQ(PositionWithAffinity(Position(ab, 1), LayoutNG() ? TextAffinity::kDownstream : TextAffinity::kUpstream), HitTest(15, 5));
...
TEST_P(LayoutViewHitTestTest, FlexBlockChildren)
{
    ...
    EXPECT_EQ(PositionWithAffinity(Position(xy, 1), LayoutNG() ? TextAffinity::kDownstream : TextAffinity::kUpstream), HitTest(30, 5));
    EXPECT_EQ(PositionWithAffinity(Position(xy, 1), LayoutNG() ? TextAffinity::kDownstream : TextAffinity::kUpstream), HitTest(35, 5));
...
TEST_P(LayoutViewHitTestTest, FloatLeftLeft)
{
    ...
    EXPECT_EQ(PositionWithAffinity(Position(xy, 1), LayoutNG() ? TextAffinity::kDownstream : TextAffinity::kUpstream), HitTest(40, 5));
    EXPECT_EQ(PositionWithAffinity(Position(xy, 1), LayoutNG() ? TextAffinity::kDownstream : TextAffinity::kUpstream), HitTest(45, 5));
...
TEST_P(LayoutViewHitTestTest, FloatRightLeft)
{
    ...
    EXPECT_EQ(PositionWithAffinity(Position(xy, 1), LayoutNG() ? TextAffinity::kDownstream : TextAffinity::kUpstream), HitTest(15, 5));
    ...
    EXPECT_EQ(PositionWithAffinity(Position(ab, 1), LayoutNG() ? TextAffinity::kDownstream : TextAffinity::kUpstream), HitTest(40, 5)) << "inside float";
    EXPECT_EQ(PositionWithAffinity(Position(ab, 1), LayoutNG() ? TextAffinity::kDownstream : TextAffinity::kUpstream), HitTest(45, 5)) << "inside float";
...
TEST_P(LayoutViewHitTestTest, FloatRightMiddle)
{
    ...
    EXPECT_EQ(PositionWithAffinity(Position(ab, 1), LayoutNG() ? TextAffinity::kDownstream : TextAffinity::kUpstream), HitTest(40, 5));
    EXPECT_EQ(PositionWithAffinity(Position(ab, 1), LayoutNG() ? TextAffinity::kDownstream : TextAffinity::kUpstream), HitTest(45, 5));
    EXPECT_EQ(PositionWithAffinity(Position(y, 1), TextAffinity::kUpstream), HitTest(50, 5));
    EXPECT_EQ(PositionWithAffinity(Position(y, 1), TextAffinity::kUpstream), HitTest(55, 5));
}
...
TEST_P(LayoutViewHitTestTest, PositionAbsolute)
{
    ...
    EXPECT_EQ(PositionWithAffinity(Position(ab, 1), LayoutNG() ? TextAffinity::kDownstream : TextAffinity::kUpstream), HitTest(50, 5));
    EXPECT_EQ(PositionWithAffinity(Position(ab, 1), LayoutNG() ? TextAffinity::kDownstream : TextAffinity::kUpstream), HitTest(55, 5));
...
TEST_P(LayoutViewHitTestTest, HitTestHorizontal)
{
    ...
    EXPECT_EQ(IsAndroidOrWindowsEditingBehavior() ? PositionWithAffinity(Position(text1, 0), TextAffinity::kDownstream)
...
TEST_P(LayoutViewHitTestTest, HitTestVerticalRL)
{
    ...
    EXPECT_EQ(GetDocument().documentElement(), result.InnerNode());
    EXPECT_EQ(PhysicalOffset(51, 181), result.LocalPoint());
    EXPECT_EQ(IsAndroidOrWindowsEditingBehavior() ? PositionWithAffinity(Position(text2, 3), TextAffinity::kUpstream)
                                                  : PositionWithAffinity(Position(text2, 3), TextAffinity::kDownstream),
        result.GetPosition());
...
TEST_P(LayoutViewHitTestTest, HitTestVerticalRLRoot)
{
    ...
    EXPECT_EQ(IsAndroidOrWindowsEditingBehavior() ? PositionWithAffinity(Position(text, 0), TextAffinity::kDownstream)
    ...
    EXPECT_EQ(IsAndroidOrWindowsEditingBehavior() ? PositionWithAffinity(Position(text, 5), TextAffinity::kUpstream)
                                                  : PositionWithAffinity(Position(text, 5), TextAffinity::kDownstream),
        result.GetPosition());
}
...
TEST_P(LayoutViewHitTestTest, PseudoElementAfterBlock)
{
    ...
    const auto expected = PositionWithAffinity(IsAndroidOrWindowsEditingBehavior() ? Position(text_ab, 2) : Position(text_ab, 0),
        LayoutNG() && IsAndroidOrWindowsEditingBehavior() ? TextAffinity::kUpstream : TextAffinity::kDownstream);
...
TEST_P(LayoutViewHitTestTest, PseudoElementAfterInline)
{
    ...
    EXPECT_EQ(PositionWithAffinity(Position(text_ab, 1), LayoutNG() ? TextAffinity::kDownstream : TextAffinity::kUpstream), HitTest(15, 5));
    EXPECT_EQ(PositionWithAffinity(Position(text_cd, 0)), HitTest(25, 5));
    // Because of hit testing at "d", position should be |kDownstream|.
    EXPECT_EQ(PositionWithAffinity(Position(text_cd, 1), LayoutNG() ? TextAffinity::kDownstream : TextAffinity::kUpstream), HitTest(35, 5));
    // Because of hit testing at right of <span cd>, result position should be
    // |kUpstream|.
    EXPECT_EQ(PositionWithAffinity(Position(text_cd, 2), LayoutNG() ? TextAffinity::kUpstream : TextAffinity::kDownstream), HitTest(45, 5));
    EXPECT_EQ(PositionWithAffinity(Position(text_cd, 2), LayoutNG() ? TextAffinity::kUpstream : TextAffinity::kDownstream), HitTest(55, 5));
    EXPECT_EQ(PositionWithAffinity(Position(text_cd, 2), LayoutNG() ? TextAffinity::kUpstream : TextAffinity::kDownstream), HitTest(65, 5));
}
...
TEST_P(LayoutViewHitTestTest, ScrolledBlockChildren)
{
    ...
    if (LayoutNG()) {
        ...
        EXPECT_EQ(PositionWithAffinity(Position(text_6, 0), TextAffinity::kDownstream), HitTest(15, 45));
    }
...
TEST_P(LayoutViewHitTestTest, ScrolledInlineChildren)
{
    ...
    if (LayoutNG()) {
        ...
        if (IsAndroidOrWindowsEditingBehavior()) {
            EXPECT_EQ(PositionWithAffinity(Position(text, 2), TextAffinity::kUpstream), HitTest(5, 5));
            EXPECT_EQ(PositionWithAffinity(Position(text, 2), TextAffinity::kUpstream), HitTest(5, 15));
            EXPECT_EQ(PositionWithAffinity(Position(text, 2), TextAffinity::kUpstream), HitTest(5, 25));

            EXPECT_EQ(PositionWithAffinity(Position(text, 3), TextAffinity::kUpstream), HitTest(15, 5));
            EXPECT_EQ(PositionWithAffinity(Position(text, 3), TextAffinity::kUpstream), HitTest(15, 15));
            EXPECT_EQ(PositionWithAffinity(Position(text, 3), TextAffinity::kUpstream), HitTest(15, 25));

            EXPECT_EQ(PositionWithAffinity(Position(text, 4), TextAffinity::kUpstream), HitTest(25, 5));
            EXPECT_EQ(PositionWithAffinity(Position(text, 4), TextAffinity::kUpstream), HitTest(25, 15));
            EXPECT_EQ(PositionWithAffinity(Position(text, 4), TextAffinity::kUpstream), HitTest(25, 25));

            EXPECT_EQ(PositionWithAffinity(Position(text, 5), TextAffinity::kUpstream), HitTest(35, 5));
            EXPECT_EQ(PositionWithAffinity(Position(text, 5), TextAffinity::kUpstream), HitTest(35, 15));
            EXPECT_EQ(PositionWithAffinity(Position(text, 5), TextAffinity::kUpstream), HitTest(35, 25));

            EXPECT_EQ(PositionWithAffinity(Position(text, 6), TextAffinity::kUpstream), HitTest(45, 5));
            EXPECT_EQ(PositionWithAffinity(Position(text, 6), TextAffinity::kUpstream), HitTest(45, 15));
            EXPECT_EQ(PositionWithAffinity(Position(text, 6), TextAffinity::kUpstream), HitTest(45, 25));

            EXPECT_EQ(PositionWithAffinity(Position(text, 7), TextAffinity::kUpstream), HitTest(55, 5));
            EXPECT_EQ(PositionWithAffinity(Position(text, 7), TextAffinity::kUpstream), HitTest(55, 15));
            EXPECT_EQ(PositionWithAffinity(Position(text, 7), TextAffinity::kUpstream), HitTest(55, 25));
        } else {
            EXPECT_EQ(PositionWithAffinity(Position(text, 0)), HitTest(5, 5));
            EXPECT_EQ(PositionWithAffinity(Position(text, 2), TextAffinity::kUpstream), HitTest(5, 15));
            EXPECT_EQ(PositionWithAffinity(Position(text, 9)), HitTest(5, 25));
...
TEST_P(LayoutViewHitTestTest, TextAndInputsWithRtlDirection)
{
    ...
    TextAffinity downstream_if_ng = LayoutNG() ? TextAffinity::kDownstream : TextAffinity::kUpstream;

    // Note: This is a crash test. The expectations only reflect the current
    // behavior, which may change.
    for (int y : { 0, 25, 49 }) {
        for (int x : { 0, 25 }) {
            EXPECT_EQ(PositionWithAffinity(Position::AfterNode(*input_1), LayoutNG() ? TextAffinity::kUpstream : TextAffinity::kDownstream), HitTest(x, y));
        }
        for (int x : { 26, 50, 75 }) {
    ...
    for (int y : { 50, 75, 99 }) {
        ...
        for (int x : { 176, 200 }) {
            EXPECT_EQ(PositionWithAffinity(LayoutNG() ? Position::BeforeNode(*input_2) : Position(input_2, 0)), HitTest(x, y));
        }
    }
    if (IsAndroidOrWindowsEditingBehavior()) {
        for (int x : { 0, 25, 50, 75, 99 }) {
        ...
        for (int x : { 176, 200 }) {
            EXPECT_EQ(PositionWithAffinity(LayoutNG() ? Position::BeforeNode(*input_2) : Position(input_2, 0)), HitTest(x, 100));
        }
    } else {
        for (int x : { 0, 25, 50, 75, 100, 125, 150, 175, 200 }) {
            EXPECT_EQ(PositionWithAffinity(LayoutNG() ? Position::AfterNode(*input_2) : Position(text_cd, 2)), HitTest(x, 100));
        }
    }
}
...
TEST_P(LayoutViewHitTestTest, TextCombineOneTextNode)
{
    ...
    if (LayoutNG()) {
        ...
        if (IsAndroidOrWindowsEditingBehavior()) {
            EXPECT_EQ(PositionWithAffinity(Position(text_01234, 0)), HitTest(110, 150));
            EXPECT_EQ(PositionWithAffinity(Position(text_01234, 0)), HitTest(120, 150));
        } else {
            EXPECT_EQ(PositionWithAffinity(Position(text_a, 0)), HitTest(110, 150));
            EXPECT_EQ(PositionWithAffinity(Position(text_a, 0)), HitTest(120, 150));
        }
