...
public:
    ...
    void SetNodeAndPosition(Node*, const NGPhysicalBoxFragment*, const PhysicalOffset&);
    ...
    {
        return canvas_region_id_;
    }
    void SetCanvasRegionId(const String& id)
    {
        canvas_region_id_ = id;
    }
