...
class LayoutTextControlTest : public testing::WithParamInterface<bool>, public RenderingTest, private ScopedLayoutNGForTest {
public:
...
TEST_P(LayoutTextControlTest, ChangingPseudoSelectionStyleShouldInvalidateSelectionSingle)
{
...
TEST_P(LayoutTextControlTest, ChangingPseudoSelectionStyleShouldInvalidateSelectionMulti)
{
    SetBodyInnerHTML(R"HTML(
    <style>
...
TEST_P(LayoutTextControlTest, AddingPseudoSelectionStyleShouldInvalidateSelectionSingle)
{
    SetBodyInnerHTML(R"HTML(
    <style>
      .pseudoSelection::selection { background-color: green; }
...
TEST_P(LayoutTextControlTest, AddingPseudoSelectionStyleShouldInvalidateSelectionMulti)
{
    SetBodyInnerHTML(R"HTML(
    <style>
      .pseudoSelection::selection { background-color: green; }
...
TEST_P(LayoutTextControlTest, RemovingPseudoSelectionStyleShouldInvalidateSelectionSingle)
{
    SetBodyInnerHTML(R"HTML(
    <style>
      .pseudoSelection::selection { background-color: green; }
...
TEST_P(LayoutTextControlTest, RemovingPseudoSelectionStyleShouldInvalidateSelectionMulti)
{
    SetBodyInnerHTML(R"HTML(
    <style>
      .pseudoSelection::selection { background-color: green; }
