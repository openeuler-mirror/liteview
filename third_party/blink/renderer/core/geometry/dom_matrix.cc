...
DOMMatrix* DOMMatrix::fromFloat32Array(NotShared<DOMFloat32Array> float32_array, ExceptionState& exception_state)
{
    ...
    return MakeGarbageCollected<DOMMatrix>(float32_array->Data(), static_cast<int>(float32_array->length()));
}
...
DOMMatrix* DOMMatrix::fromFloat64Array(NotShared<DOMFloat64Array> float64_array, ExceptionState& exception_state)
{
    ...
    return MakeGarbageCollected<DOMMatrix>(float64_array->Data(), static_cast<int>(float64_array->length()));
}
...
DOMMatrix* DOMMatrix::fromMatrix(DOMMatrixInit* other, ExceptionState& exception_state)
{
    ...
    if (other->is2D()) {
        return MakeGarbageCollected<DOMMatrix>(
            TransformationMatrix::Affine(other->m11(), other->m12(), other->m21(), other->m22(), other->m41(), other->m42()), other->is2D());
    }

    return MakeGarbageCollected<DOMMatrix>(
        TransformationMatrix::ColMajor(other->m11(), other->m12(), other->m13(), other->m14(), other->m21(), other->m22(), other->m23(), other->m24(),
...
{
    matrix_ = TransformationMatrix::ColMajor(NAN, NAN, NAN, NAN, NAN, NAN, NAN, NAN, NAN, NAN, NAN, NAN, NAN, NAN, NAN, NAN);
}
