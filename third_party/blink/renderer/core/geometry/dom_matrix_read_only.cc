    ...
    ExecutionContext* execution_context, const V8UnionStringOrUnrestrictedDoubleSequence* init, ExceptionState& exception_state)
{
    ...
    case V8UnionStringOrUnrestrictedDoubleSequence::ContentType::kString: {
        ...
        DOMMatrixReadOnly* matrix = MakeGarbageCollected<DOMMatrixReadOnly>(TransformationMatrix());
...
DOMMatrixReadOnly* DOMMatrixReadOnly::CreateForSerialization(double sequence[], int size)
{
...
DOMMatrixReadOnly* DOMMatrixReadOnly::fromFloat32Array(NotShared<DOMFloat32Array> float32_array, ExceptionState& exception_state)
{
    ...
    return MakeGarbageCollected<DOMMatrixReadOnly>(float32_array->Data(), static_cast<int>(float32_array->length()));
}
...
DOMMatrixReadOnly* DOMMatrixReadOnly::fromFloat64Array(NotShared<DOMFloat64Array> float64_array, ExceptionState& exception_state)
{
    ...
    return MakeGarbageCollected<DOMMatrixReadOnly>(float64_array->Data(), static_cast<int>(float64_array->length()));
}
...
DOMMatrixReadOnly* DOMMatrixReadOnly::fromMatrix2D(DOMMatrix2DInit* other, ExceptionState& exception_state)
{
    ...
    double args[] = { other->m11(), other->m12(), other->m21(), other->m22(), other->m41(), other->m42() };
...
DOMMatrixReadOnly* DOMMatrixReadOnly::fromMatrix(DOMMatrixInit* other, ExceptionState& exception_state)
{
    ...
    double args[] = { other->m11(), other->m12(), other->m13(), other->m14(), other->m21(), other->m22(), other->m23(), other->m24(), other->m31(),
