...
bool IntersectionObserverController::ComputeIntersections(
    unsigned flags, LocalFrameUkmAggregator& ukm_aggregator, absl::optional<base::TimeTicks>& monotonic_time)
{
    ...
    HeapVector<Member<IntersectionObserver>> observers_to_process(tracked_explicit_root_observers_);
    HeapVector<Member<IntersectionObservation>> observations_to_process(tracked_implicit_root_observations_);
    ...
    ukm_aggregator.RecordCountSample(LocalFrameUkmAggregator::kIntersectionObservationInternalCount, internal_observation_count);
    ukm_aggregator.RecordCountSample(LocalFrameUkmAggregator::kIntersectionObservationJavascriptCount, javascript_observation_count);
