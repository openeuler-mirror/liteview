...
class IntersectionObserverController : public GarbageCollected<IntersectionObserverController>, public ExecutionContextClient, public NameClient {
public:
    ...
    // observer.
    bool ComputeIntersections(unsigned flags, LocalFrameUkmAggregator& ukm_aggregator, absl::optional<base::TimeTicks>& monotonic_time);
...
private:
    ...
    HeapHashSet<WeakMember<IntersectionObserver>> tracked_explicit_root_observers_;
    // IntersectionObservations with an implicit root and connected target in this
    // document.
    HeapHashSet<WeakMember<IntersectionObservation>> tracked_implicit_root_observations_;
