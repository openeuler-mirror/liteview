...
public:
    ...
    void RouteMessageEvent(const absl::optional<LocalFrameToken>& source_frame_token, const String& source_origin, const String& target_origin,
    ...
    void UpdateViewportIntersection(
        blink::mojom::blink::ViewportIntersectionStatePtr intersection_state, const absl::optional<FrameVisualProperties>& visual_properties) override;
