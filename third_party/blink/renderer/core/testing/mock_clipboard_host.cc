...
void MockClipboardHost::ReadCustomData(mojom::ClipboardBuffer clipboard_buffer, const String& type, ReadCustomDataCallback callback)
{
...
void MockClipboardHost::ReadUnsanitizedCustomFormat(const String& format, ReadUnsanitizedCustomFormatCallback callback)
{
    ...
    mojo_base::BigBuffer buffer = mojo_base::BigBuffer(base::make_span(it->value.data(), it->value.size()));
