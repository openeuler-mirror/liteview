...
public:
    ...
    void DidChangeOpener(const absl::optional<LocalFrameToken>& opener_frame) override;
    ...
    void CreatePortal(mojo::PendingAssociatedReceiver<mojom::blink::Portal> portal, mojo::PendingAssociatedRemote<mojom::blink::PortalClient> client,
        mojom::blink::RemoteFrameInterfacesFromRendererPtr remote_frame_interfaces, CreatePortalCallback callback) override;
    void AdoptPortal(
        const PortalToken& portal_token, mojom::blink::RemoteFrameInterfacesFromRendererPtr remote_frame_interfaces, AdoptPortalCallback callback) override;
    void CreateFencedFrame(mojo::PendingAssociatedReceiver<mojom::blink::FencedFrameOwnerHost>, mojom::blink::FencedFrameMode,
