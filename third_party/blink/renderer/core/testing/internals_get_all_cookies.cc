...
// static
ScriptPromise InternalsGetAllCookies::getAllCookies(ScriptState* script_state, Internals&)
{
    ...
    raw_cookie_manager->GetAllCookies(WTF::BindOnce(
        [](ScriptPromiseResolver* resolver, ScriptState* script_state, mojo::Remote<test::mojom::blink::CookieManagerAutomation>,
