...
void RecordTest::setNullableStringLongRecord(const absl::optional<Vector<std::pair<String, int32_t>>>& arg)
{
    nullable_string_long_record_ = arg;
}

absl::optional<Vector<std::pair<String, int32_t>>> RecordTest::getNullableStringLongRecord()
{
