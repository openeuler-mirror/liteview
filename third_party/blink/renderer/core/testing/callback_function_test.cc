...
void CallbackFunctionTest::testEnumCallback(V8TestEnumCallback* callback, const String& enum_value, ExceptionState& exception_state)
{
    callback->InvokeAndReportException(nullptr, V8InternalEnum::Create(enum_value).value());
}
