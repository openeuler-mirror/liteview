...
public:
    ...
    public:
        explicit MockClipboardHostProvider(blink::BrowserInterfaceBrokerProxy& interface_broker);
    ...
    void SetUp(gfx::Size);
    void SetupPageWithClients(ChromeClient* = nullptr, LocalFrameClient* = nullptr, FrameSettingOverrideFunction = nullptr);
