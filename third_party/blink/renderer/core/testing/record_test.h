...
public:
    ...
    void setNullableStringLongRecord(const absl::optional<Vector<std::pair<String, int32_t>>>& arg);
    absl::optional<Vector<std::pair<String, int32_t>>> getNullableStringLongRecord();
...
private:
    ...
    absl::optional<Vector<std::pair<String, int32_t>>> nullable_string_long_record_;
