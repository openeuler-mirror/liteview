...
void SimTest::SetUp()
{
    ...
    web_view_helper_ = std::make_unique<frame_test_helpers::WebViewHelper>(base::BindRepeating(&SimTest::CreateTestWebFrameWidget, base::Unretained(this)));
...
SimWebFrameWidget* SimTest::CreateSimWebFrameWidget(base::PassKey<WebLocalFrame> pass_key,
    ...
    bool is_for_scalable_page, SimCompositor* compositor)
{
    return MakeGarbageCollected<SimWebFrameWidget>(compositor, std::move(pass_key), std::move(frame_widget_host), std::move(frame_widget),
...
frame_test_helpers::TestWebFrameWidget* SimTest::CreateTestWebFrameWidget(base::PassKey<WebLocalFrame> pass_key,
    CrossVariantMojoAssociatedRemote<mojom::blink::FrameWidgetHostInterfaceBase> frame_widget_host,
    CrossVariantMojoAssociatedReceiver<mojom::blink::FrameWidgetInterfaceBase> frame_widget,
    CrossVariantMojoAssociatedRemote<mojom::blink::WidgetHostInterfaceBase> widget_host,
    CrossVariantMojoAssociatedReceiver<mojom::blink::WidgetInterfaceBase> widget, scoped_refptr<base::SingleThreadTaskRunner> task_runner,
...
{
    return CreateSimWebFrameWidget(std::move(pass_key), std::move(frame_widget_host), std::move(frame_widget), std::move(widget_host), std::move(widget),
