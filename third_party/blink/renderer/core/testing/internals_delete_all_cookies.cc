...
// static
ScriptPromise InternalsDeleteAllCookies::deleteAllCookies(ScriptState* script_state, Internals&)
{
    ...
    raw_cookie_manager->DeleteAllCookies(WTF::BindOnce(
        [](ScriptPromiseResolver* resolver, mojo::Remote<test::mojom::blink::CookieManagerAutomation>) { resolver->Resolve(); }, WrapPersistent(resolver),
