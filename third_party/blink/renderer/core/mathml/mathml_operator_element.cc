...
static const MathMLOperatorDictionaryProperties MathMLOperatorDictionaryCategories[] = {
...
void MathMLOperatorElement::AddMathLSpaceIfNeeded(ComputedStyle& style, const CSSToLengthConversionData& conversion_data)
{
...
void MathMLOperatorElement::AddMathRSpaceIfNeeded(ComputedStyle& style, const CSSToLengthConversionData& conversion_data)
{
...
void MathMLOperatorElement::AddMathMinSizeIfNeeded(ComputedStyle& style, const CSSToLengthConversionData& conversion_data)
{
...
void MathMLOperatorElement::AddMathMaxSizeIfNeeded(ComputedStyle& style, const CSSToLengthConversionData& conversion_data)
{
