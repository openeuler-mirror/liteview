...
public:
    ...
    void SetOffset(absl::optional<double> offset)
    {
        offset_ = offset;
    }
    absl::optional<double> Offset() const
    {
        return offset_;
    }
...
protected:
    ...
    Keyframe(absl::optional<double> offset, absl::optional<EffectModel::CompositeOperation> composite, scoped_refptr<TimingFunction> easing)
        : offset_(offset)
        , composite_(composite)
        , easing_(std::move(easing))
    {
