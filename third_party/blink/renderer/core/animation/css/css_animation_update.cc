...
void CSSAnimationUpdate::StartTransition(const PropertyHandle& property, scoped_refptr<const ComputedStyle> from, scoped_refptr<const ComputedStyle> to,
    scoped_refptr<const ComputedStyle> reversing_adjusted_start_value, double reversing_shortening_factor, const InertEffect& effect)
{
    ...
    new_transition->reversing_adjusted_start_value = std::move(reversing_adjusted_start_value);
