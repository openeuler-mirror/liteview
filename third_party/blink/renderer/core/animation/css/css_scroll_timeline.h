...
public:
    ...
    public:
        Options(Document&, ScrollTimeline::ReferenceType reference_type, absl::optional<Element*> reference_element, const AtomicString& name, TimelineAxis);
    ...
    bool IsCSSScrollTimeline() const override
    {
        return true;
    }
...
template <> struct DowncastTraits<CSSScrollTimeline> {
