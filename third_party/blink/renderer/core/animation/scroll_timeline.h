...
public:
    ...
    static ScrollTimeline* Create(Document* document, Element* source, ScrollDirection orientation);
    ...
    ScrollTimeline(Document*, ReferenceType reference_type, Element* reference, ScrollDirection);

    static bool StringToScrollDirection(String scroll_direction, ScrollTimeline::ScrollDirection& result);
    ...
    AnimationTimeDelta CalculateIntrinsicIterationDuration(const Timing&) override;
    ...
    ScrollDirection GetOrientation() const
    {
        return orientation_;
    }

    void GetCurrentAndMaxOffset(const LayoutBox*, double& current_offset, double& max_offset) const;
...
protected:
    ...
    virtual Element* ReferenceElement() const
    {
    ...
    virtual absl::optional<ScrollOffsets> CalculateOffsets(PaintLayerScrollableArea* scrollable_area, ScrollOrientation physical_orientation) const;
...
private:
    ...
    struct TimelineState {
        ...
        {
            return phase == other.phase && current_time == other.current_time && scroll_offsets == other.scroll_offsets;
        }
    };
