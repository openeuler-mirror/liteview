...
protected:
    ...
    InertEffect* MakeInertEffect(KeyframeEffectModelBase* effect)
    {
        ...
        return MakeGarbageCollected<InertEffect>(effect, timing, false, AnimationTimeDelta(), absl::nullopt, 1.0);
    }
    ...
    double GetZIndexValue(const ActiveInterpolationsMap& active_interpolations)
    {
        ...
        return To<InterpolableNumber>(&typed_value->GetInterpolableValue())->Value();
    }
