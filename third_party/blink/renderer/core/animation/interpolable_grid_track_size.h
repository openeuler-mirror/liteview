...
public:
    InterpolableGridTrackSize(std::unique_ptr<InterpolableValue> min_value, std::unique_ptr<InterpolableValue> max_value, const GridTrackSizeType type);
    static std::unique_ptr<InterpolableGridTrackSize> Create(const GridTrackSize& grid_track_size, float zoom);
