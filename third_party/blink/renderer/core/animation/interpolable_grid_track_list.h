...
public:
    InterpolableGridTrackList(std::unique_ptr<InterpolableList> values, double progress);
    static std::unique_ptr<InterpolableGridTrackList> MaybeCreate(const NGGridTrackList& track_list, float zoom);
