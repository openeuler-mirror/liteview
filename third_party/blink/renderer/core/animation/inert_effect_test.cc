...
TEST(InertEffectTest, IsCurrent)
{
...

    {
        ...
        auto* inert_effect = MakeGarbageCollected<InertEffect>(opacity_model, timing, /* paused */ false, AnimationTimeDelta(),
...
TEST(InertEffectTest, Affects)
{
    ...
    auto* opacity_effect = MakeGarbageCollected<InertEffect>(opacity_model, timing, /* paused */ false, AnimationTimeDelta(),
        /* timeline_duration */ absl::nullopt, /* playback_rate */ 1.0);

    auto* color_effect = MakeGarbageCollected<InertEffect>(color_model, timing, /* paused */ false, AnimationTimeDelta(),
        /* timeline_duration */ absl::nullopt, /* playback_rate */ 1.0);
