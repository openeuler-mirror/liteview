...
public:
    ...
    using MergeSingleItemConversionsCallback = base::RepeatingCallback<PairwiseInterpolationValue(InterpolationValue&&, InterpolationValue&&)>;
    ...
    using InterpolableValuesAreCompatibleCallback = base::RepeatingCallback<bool(const InterpolableValue*, const InterpolableValue*)>;
    using NonInterpolableValuesAreCompatibleCallback = base::RepeatingCallback<bool(const NonInterpolableValue*, const NonInterpolableValue*)>;
    using CompositeItemCallback
        = base::RepeatingCallback<void(UnderlyingValue&, double underlying_fraction, const InterpolableValue&, const NonInterpolableValue*)>;
