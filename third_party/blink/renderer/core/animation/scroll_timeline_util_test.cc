...
TEST_F(ScrollTimelineUtilTest, ToCompositorScrollTimeline)
{
    ...
    absl::optional<CompositorElementId> element_id = GetCompositorScrollElementId(scroller);
...
{
    DocumentTimeline* timeline = MakeGarbageCollected<DocumentTimeline>(Document::CreateForTest());
...
TEST_F(ScrollTimelineUtilTest, ToCompositorScrollTimelineNullSource)
{
    ...
    ScrollTimeline* timeline = ScrollTimeline::Create(&GetDocument(), source, ScrollTimeline::ScrollDirection::kBlock);
...
TEST_F(ScrollTimelineUtilTest, ConvertOrientationPhysicalCases)
{
    ...
    for (const WritingMode& writing_mode : writing_modes) {
        for (const TextDirection& direction : directions) {
            ...
            EXPECT_EQ(ConvertOrientation(ScrollTimeline::ScrollDirection::kVertical, style.get()), CompositorScrollTimeline::ScrollDown);
            EXPECT_EQ(ConvertOrientation(ScrollTimeline::ScrollDirection::kHorizontal, style.get()), CompositorScrollTimeline::ScrollRight);
        }
    }
}
...
TEST_F(ScrollTimelineUtilTest, ConvertOrientationLogical)
{
    ...
    EXPECT_EQ(ConvertOrientation(ScrollTimeline::ScrollDirection::kBlock, style.get()), CompositorScrollTimeline::ScrollDown);
    EXPECT_EQ(ConvertOrientation(ScrollTimeline::ScrollDirection::kInline, style.get()), CompositorScrollTimeline::ScrollRight);

    // vertical-lr, ltr
    style->SetWritingMode(WritingMode::kVerticalLr);
    style->SetDirection(TextDirection::kLtr);
    EXPECT_EQ(ConvertOrientation(ScrollTimeline::ScrollDirection::kBlock, style.get()), CompositorScrollTimeline::ScrollRight);
    EXPECT_EQ(ConvertOrientation(ScrollTimeline::ScrollDirection::kInline, style.get()), CompositorScrollTimeline::ScrollDown);

    // vertical-rl, ltr
    style->SetWritingMode(WritingMode::kVerticalRl);
    style->SetDirection(TextDirection::kLtr);
    EXPECT_EQ(ConvertOrientation(ScrollTimeline::ScrollDirection::kBlock, style.get()), CompositorScrollTimeline::ScrollLeft);
    EXPECT_EQ(ConvertOrientation(ScrollTimeline::ScrollDirection::kInline, style.get()), CompositorScrollTimeline::ScrollDown);
    ...
    EXPECT_EQ(ConvertOrientation(ScrollTimeline::ScrollDirection::kBlock, style.get()), CompositorScrollTimeline::ScrollDown);
    EXPECT_EQ(ConvertOrientation(ScrollTimeline::ScrollDirection::kInline, style.get()), CompositorScrollTimeline::ScrollLeft);

    // vertical-lr, rtl
    style->SetWritingMode(WritingMode::kVerticalLr);
    style->SetDirection(TextDirection::kRtl);
    EXPECT_EQ(ConvertOrientation(ScrollTimeline::ScrollDirection::kBlock, style.get()), CompositorScrollTimeline::ScrollRight);
    EXPECT_EQ(ConvertOrientation(ScrollTimeline::ScrollDirection::kInline, style.get()), CompositorScrollTimeline::ScrollUp);
...
TEST_F(ScrollTimelineUtilTest, ConvertOrientationNullStyle)
{
    ...
    EXPECT_EQ(ConvertOrientation(ScrollTimeline::ScrollDirection::kVertical, nullptr), CompositorScrollTimeline::ScrollDown);
    EXPECT_EQ(ConvertOrientation(ScrollTimeline::ScrollDirection::kHorizontal, nullptr), CompositorScrollTimeline::ScrollRight);
    EXPECT_EQ(ConvertOrientation(ScrollTimeline::ScrollDirection::kBlock, nullptr), CompositorScrollTimeline::ScrollDown);
    EXPECT_EQ(ConvertOrientation(ScrollTimeline::ScrollDirection::kInline, nullptr), CompositorScrollTimeline::ScrollRight);
}
