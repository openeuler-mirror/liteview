...
public:
    ...
    virtual bool IsCSSScrollTimeline() const
    {
        return false;
    }
    ...
    virtual AnimationTimeDelta CalculateIntrinsicIterationDuration(const Timing&)
    {
    ...
    virtual TimeDelayPair TimelineOffsetsToTimeDelays(const Timing& timing) const
    {
