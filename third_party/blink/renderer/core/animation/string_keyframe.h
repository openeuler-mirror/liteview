...
public:
    ...
    const CSSValue& PresentationAttributeValue(const CSSProperty& property) const
    {
        ...
        CHECK_GE(index, 0);
        return presentation_attribute_map_->PropertyAt(static_cast<unsigned>(index)).Value();
    }
    ...
    bool SetLogicalPropertyResolutionContext(TextDirection text_direction, WritingMode writing_mode);
    ...
    public:
        ...
        void AppendTo(MutableCSSPropertyValueSet* property_value_set, TextDirection text_direction, WritingMode writing_mode);

        void SetProperty(MutableCSSPropertyValueSet* property_value_set, CSSPropertyID property_id, const CSSValue& value, TextDirection text_direction,
