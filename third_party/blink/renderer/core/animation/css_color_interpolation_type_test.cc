...
TEST(CSSColorInterpolationTypeTest, GetRGBA1)
{
    ...
    EXPECT_EQ(color, CSSColorInterpolationType::GetRGBA(*CSSColorInterpolationType::CreateInterpolableColor(color)));
}
...
TEST(CSSColorInterpolationTypeTest, GetRGBA4)
{
    ...
    EXPECT_EQ(Color::FromRGBA(0, 0, 0, 0), CSSColorInterpolationType::GetRGBA(*CSSColorInterpolationType::CreateInterpolableColor(color)));
}
