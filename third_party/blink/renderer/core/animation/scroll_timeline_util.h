...
absl::optional<CompositorElementId> CORE_EXPORT GetCompositorScrollElementId(const Node*);
...
CompositorScrollTimeline::ScrollDirection CORE_EXPORT ConvertOrientation(ScrollTimeline::ScrollDirection, const ComputedStyle*);
