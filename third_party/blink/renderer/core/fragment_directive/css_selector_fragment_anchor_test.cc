...
public:
    void SetUp() override
    {
        ...
        feature_list.InitAndEnableFeature(blink::features::kCssSelectorFragmentAnchor);
    ...
    const CSSValue* GetComputedValue(const CSSPropertyID& property_id, const Element& element)
    {
        return CSSProperty::Get(property_id)
            .CSSValueFromComputedStyle(element.ComputedStyleRef(), nullptr /* layout_object */, false /* allow_visited_style */);
    }
