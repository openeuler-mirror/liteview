...
public:
    ...
    void LoadAhem()
    {
        ...
        FontFace* ahem = FontFace::Create(GetDocument().GetExecutionContext(), "Ahem", buffer, FontFaceDescriptors::Create());
...
TEST_F(TextFragmentHandlerTest, CheckNoPreemptiveGenerationEditable)
{
    ...
    Node* input_text = FlatTreeTraversal::Next(*GetDocument().getElementById("input"))->firstChild();
...
{
    base::test::ScopedFeatureList feature_list_;
    feature_list_.InitAndEnableFeature(shared_highlighting::kSharedHighlightingAmp);
