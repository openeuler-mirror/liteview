...
public:
    ...
    IndexedPropertySetterResult AnonymousIndexedSetter(unsigned, AccessibleNode*, ExceptionState&);
...
private:
    ...
    HeapVector<std::pair<AOMRelationListProperty, Member<AccessibleNode>>> owners_;
