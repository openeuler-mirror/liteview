...
public:
    ...
    void Initialize(WorkerClients*, WorkletModuleResponsesMap*, const absl::optional<WorkerBackingThreadStartupData>& = absl::nullopt);
...
private:
    ...
    virtual std::unique_ptr<ThreadedWorkletObjectProxy> CreateObjectProxy(ThreadedWorkletMessagingProxy*, ParentExecutionContextTaskRunners*);
