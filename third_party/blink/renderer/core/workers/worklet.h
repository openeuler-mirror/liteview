...
public:
    ...
    ScriptPromise addModule(ScriptState*, const String& module_url, const WorkletOptions*, ExceptionState&);
...
private:
    virtual void FetchAndInvokeScript(const KURL& module_url_record, const String& credentials, WorkletPendingTasks*);
