...
void MemoryPressureNotificationToWorkerThreadIsolates(v8::MemoryPressureLevel level)
{
...
void WorkerBackingThread::InitializeOnBackingThread(const WorkerBackingThreadStartupData& startup_data)
{
    ...
    isolate_ = V8PerIsolateData::Initialize(scheduler->V8TaskRunner(), V8PerIsolateData::V8ContextSnapshotMode::kDontUseSnapshot, nullptr, nullptr);
    ...
    if (!base::FeatureList::IsEnabled(features::kV8OptimizeWorkersForPerformance)) {
