...
public:
    SharedWorkerReportingProxy(WebSharedWorkerImpl*, ParentExecutionContextTaskRunners*);
...
private:
    ...
    Member<ParentExecutionContextTaskRunners> parent_execution_context_task_runners_;
};
