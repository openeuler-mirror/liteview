...
TEST(SpeculationRulesOriginTrialTest, RequiresBaseFeature)
{
    ...
    scoped_features.InitAndDisableFeature(features::kSpeculationRulesPrefetchProxy);
    ScopedTestOriginTrialPolicy using_test_keys;

    EXPECT_FALSE(DocumentAcceptsRuleSet(kSpeculationRulesPrefetchToken, kSimplePrefetchProxyRuleSet));
}
...
{
    base::test::ScopedFeatureList scoped_features;
    scoped_features.InitAndEnableFeature(features::kSpeculationRulesPrefetchProxy);
    ScopedTestOriginTrialPolicy using_test_keys;

    EXPECT_FALSE(DocumentAcceptsRuleSet("invalid token", kSimplePrefetchProxyRuleSet));
}
...
TEST(SpeculationRulesOriginTrialTest, BaseFeatureAndValidTokenSuffice)
{
    ...
    EXPECT_TRUE(DocumentAcceptsRuleSet(kSpeculationRulesPrefetchToken, kSimplePrefetchProxyRuleSet));
}
