...
public:
    ...
    SpeculationRule(Vector<KURL>, RequiresAnonymousClientIPWhenCrossOrigin, absl::optional<mojom::blink::SpeculationTargetHint> target_hint);
    ~SpeculationRule();
    ...
    absl::optional<mojom::blink::SpeculationTargetHint> target_browsing_context_name_hint() const
    {
...
private:
    ...
    const absl::optional<mojom::blink::SpeculationTargetHint> target_browsing_context_name_hint_;
};
