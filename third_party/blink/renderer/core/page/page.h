...
public:
    ...
    static Page* CreateNonOrdinary(ChromeClient& chrome_client, scheduler::WebAgentGroupScheduler& agent_group_scheduler);

    // An "ordinary" page is a fully-featured page owned by a web view.
    static Page* CreateOrdinary(ChromeClient& chrome_client, Page* opener, scheduler::WebAgentGroupScheduler& agent_group_scheduler);

    Page(base::PassKey<Page>, ChromeClient& chrome_client, scheduler::WebAgentGroupScheduler& agent_group_scheduler, bool is_ordinary);
    ...
    const absl::optional<features::FencedFramesImplementationType>& FencedFramesImplementationType() const
    {
    ...
    mojom::blink::FencedFrameMode FencedFrameMode()
    {
...
private:
    ...
    mojom::blink::FencedFrameMode fenced_frame_mode_ = mojom::blink::FencedFrameMode::kDefault;
