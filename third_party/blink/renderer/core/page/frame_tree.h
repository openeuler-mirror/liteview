...
public:
    ...
    Frame& Top(FrameTreeBoundary frame_tree_boundary = FrameTreeBoundary::kIgnoreFence) const;
    ...
    Frame* TraverseNext(const Frame* stay_within = nullptr, FrameTreeBoundary frame_tree_boundary = FrameTreeBoundary::kIgnoreFence) const;
