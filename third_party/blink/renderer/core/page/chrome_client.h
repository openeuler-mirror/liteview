...
public:
    ...
    virtual void Show(LocalFrame& frame, LocalFrame& opener_frame, NavigationPolicy navigation_policy, const mojom::blink::WindowFeatures& window_features,
    ...
    virtual void DidOverscroll(const gfx::Vector2dF& overscroll_delta, const gfx::Vector2dF& accumulated_overscroll, const gfx::PointF& position_in_viewport,
    ...
    virtual void InjectGestureScrollEvent(LocalFrame& local_frame, WebGestureDevice device, const gfx::Vector2dF& delta, ui::ScrollGranularity granularity,
    ...
    virtual void JavaScriptChangedAutofilledValue(HTMLFormControlElement&, const String& old_value)
    {
    }
    ...
    // failure.
    using ReportTimeCallback = WTF::CrossThreadOnceFunction<void(base::TimeTicks)>;
    ...
    virtual double UserZoomFactor() const
    {
        return 1;
    }
