...
public:
    ...
    MOCK_METHOD3(DrawPicture, void(const SkPicture*, const SkMatrix*, const SkPaint*));
...
protected:
    ...
    gfx::Rect PrintSinglePage(SkCanvas& canvas, int page_number = 0)
    {
        ...
        GetDocument().View()->PaintOutsideOfLifecycle(context, PaintFlag::kAddUrlMetadata, CullRect(page_rect));
        {
            DrawingRecorder recorder(context, *GetDocument().GetLayoutView(), DisplayItem::kPrintedContentDestinationLocations);
...
TEST_P(PrintContextTest, LinkedTarget)
{
    ...
    SetBodyInnerHTML(AbsoluteBlockHtmlForLink(50, 60, 10, 10,
        ...
        + AbsoluteBlockHtmlForLink(50, 260, 10, 10,
        ...
        + AbsoluteBlockHtmlForLink(50, 460, 10, 10,
...
TEST_P(PrintContextFrameTest, DISABLED_SubframePrintPageLayout)
{
    ...
    ChildDocument().GetFrame()->StartPrinting(page_size, page_size, maximum_shrink_ratio);
    EXPECT_EQ(parent->OffsetWidth(), 800);
