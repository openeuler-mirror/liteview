...
private:
    LayoutNGTableRowInterface* PreviousRow(LayoutNGTableRowInterface* current_row);
    ...
    LayoutNGTableCellInterface* TableCellAtIndexInRowRecursive(
        unsigned index, LayoutNGTableRowInterface* row, absl::optional<unsigned> expected_rowspan = absl::nullopt);
