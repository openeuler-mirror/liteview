...
void SlotScopedTraversalTest::SetupSampleHTML(const char* main_html, const char* shadow_html, unsigned index)
{
...
void SlotScopedTraversalTest::AttachOpenShadowRoot(Element& shadow_host, const char* shadow_inner_html)
{
    ShadowRoot& shadow_root = shadow_host.AttachShadowRootInternal(ShadowRootType::kOpen);
...
void SlotScopedTraversalTest::TestExpectedSequence(const Vector<Element*>& list)
{
...
TEST_F(SlotScopedTraversalTest, multipleSlots)
{
    ...
    const char* shadow_html = "<slot id='unnamedslot'></slot>"
...
TEST_F(SlotScopedTraversalTest, shadowHostAtTopLevel)
{
    ...
    for (int i = 0; i < 3; ++i) {
        ...
        case 0: {
            ...
            Vector<Element*> expected_sequence({ inner[0], inner[1], child[1], inner[2], child[2] });
            TestExpectedSequence(expected_sequence);
        } break;
        ...
        case 1: {
            ...
            Vector<Element*> expected_sequence({ inner[0], child[0], inner[1], inner[2], child[2] });
            TestExpectedSequence(expected_sequence);
        } break;
        ...
        case 2: {
            ...
            Vector<Element*> expected_sequence({ inner[0], child[0], inner[1], child[1], inner[2] });
            TestExpectedSequence(expected_sequence);
        } break;
        }
    }
...
TEST_F(SlotScopedTraversalTest, shadowHostAtSecondLevel)
{
    ...
    for (int i = 0; i < 4; ++i) {
        ...
        case 0: {
            ...
            const Vector<Element*> expected_sequence({ inner[0], child[0], child[1], span[1], inner[1], child[2], span[2], child[3], span[3] });
            TestExpectedSequence(expected_sequence);
        } break;
        ...
        case 1: {
            ...
            const Vector<Element*> expected_sequence({ inner[0], child[0], span[0], child[1], inner[1], child[2], span[2], child[3], span[3] });
            TestExpectedSequence(expected_sequence);
        } break;
        ...
        case 2: {
            ...
            const Vector<Element*> expected_sequence({ inner[0], child[0], span[0], child[1], span[1], inner[1], child[2], child[3], span[3] });
            TestExpectedSequence(expected_sequence);
        } break;
        ...
        case 3: {
            ...
            const Vector<Element*> expected_sequence({ inner[0], child[0], span[0], child[1], span[1], inner[1], child[2], span[2], child[3] });
            TestExpectedSequence(expected_sequence);
        } break;
        }
    }
