...
TEST_F(RootScrollerTest, RemoveRootScrollerFromDom)
{
    ...
    {
        auto* iframe = To<HTMLFrameOwnerElement>(MainFrame()->GetDocument()->getElementById("iframe"));
...
TEST_F(ImplicitRootScrollerSimTest, IframeLoadedWithoutLayout)
{
    ...
    Compositor().BeginFrame();
    EXPECT_EQ(GetDocument().getElementById("container"), GetDocument().GetRootScrollerController().EffectiveRootScroller())
...
TEST_F(ImplicitRootScrollerSimTest, NavigateToValidRemainsRootScroller)
{
    ...
    Compositor().BeginFrame();
    ASSERT_EQ(GetDocument().getElementById("container"), GetDocument().GetRootScrollerController().EffectiveRootScroller());
...
TEST_F(ImplicitRootScrollerSimTest, ScrollRestorationIgnoresImplicit)
{
    ...
    GetDocument().View()->GetScrollableArea()->SetPendingHistoryRestoreScrollOffset(view_state, true);
    GetDocument().View()->LayoutViewport()->SetPendingHistoryRestoreScrollOffset(view_state, true);
...
TEST_F(ImplicitRootScrollerSimTest, IframeScrollingAffectsPromotion)
{
    ...
    auto* container = To<HTMLFrameOwnerElement>(GetDocument().getElementById("container"));
...
TEST_F(ImplicitRootScrollerSimTest, BottomFixedAffectedByTopControls)
{
    ...
    LayoutObject* fixed = GetDocument().getElementById("fixed")->GetLayoutObject();
    LayoutObject* fixed1 = child1_document->getElementById("fixed")->GetLayoutObject();
    LayoutObject* fixed2 = child2_document->getElementById("fixed")->GetLayoutObject();

    EXPECT_TRUE(fixed->FirstFragment().PaintProperties()->PaintOffsetTranslation()->IsAffectedByOuterViewportBoundsDelta());
    EXPECT_TRUE(fixed1->FirstFragment().PaintProperties()->PaintOffsetTranslation()->IsAffectedByOuterViewportBoundsDelta());
    EXPECT_FALSE(fixed2->FirstFragment().PaintProperties()->PaintOffsetTranslation()->IsAffectedByOuterViewportBoundsDelta());
}
