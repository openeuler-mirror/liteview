...
class CORE_EXPORT SnapCoordinator final : public GarbageCollected<SnapCoordinator> {
public:
    ...
    // container.
    cc::SnapAreaData CalculateSnapAreaData(const LayoutBox& snap_area, const LayoutBox& snap_container);
