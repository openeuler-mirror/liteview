...
protected:
    void SetUp() override
    {
        page_holder_ = std::make_unique<DummyPageHolder>(
            gfx::Size(), nullptr, nullptr, base::BindOnce([](Settings& settings) { settings.SetAcceleratedCompositingEnabled(true); }));
...
{
    Element& snap_element = *GetDocument().getElementById("snap-element-fixed-position");
    snap_element.setAttribute(kStyleAttr, "scroll-snap-align: start;");
    UpdateAllLifecyclePhasesForTest();
...
TEST_F(SnapCoordinatorTest, SnapDataCalculation)
{
    ...
    cc::SnapAreaData expected_area(cc::ScrollSnapAlign(cc::SnapAlignment::kStart), gfx::RectF(192, 192, 116, 116), false, cc::ElementId(10));
...
TEST_F(SnapCoordinatorTest, ScrolledSnapDataCalculationOnViewport)
{
    ...
    cc::SnapAreaData expected_area(cc::ScrollSnapAlign(cc::SnapAlignment::kStart), gfx::RectF(200, 200, 100, 100), false, cc::ElementId(10));
    expected_container.AddSnapAreaData(expected_area);
...
TEST_F(SnapCoordinatorTest, SnapDataCalculationWithBoxModel)
{
    ...
    Element* scroller_element = GetDocument().getElementById("scroller");
    scroller_element->setAttribute(kStyleAttr, "margin: 3px; border: 10px solid; padding: 4px;");
    UpdateAllLifecyclePhasesForTest();
    const cc::SnapContainerData* data = GetSnapContainerData(*scroller_element->GetLayoutBox());
    EXPECT_TRUE(data);
    cc::SnapContainerData actual_container = *data;
    ...
    //               2 * (area.padding + area.border + area.scroll-margin)
    cc::SnapAreaData expected_area(cc::ScrollSnapAlign(cc::SnapAlignment::kStart), gfx::RectF(208, 208, 144, 144), false, cc::ElementId(10));
    expected_container.AddSnapAreaData(expected_area);
...
TEST_F(SnapCoordinatorTest, NegativeMarginSnapDataCalculation)
{
    SetUpSingleSnapArea();
    Element* area_element = GetDocument().getElementById("area");
    area_element->setAttribute(kStyleAttr, "scroll-snap-align: start; scroll-margin: -8px;");
    UpdateAllLifecyclePhasesForTest();
    Element* scroller_element = GetDocument().getElementById("scroller");
    const cc::SnapContainerData* data = GetSnapContainerData(*scroller_element->GetLayoutBox());
    EXPECT_TRUE(data);
    ...
    cc::SnapContainerData expected_container(
        cc::ScrollSnapType(false, cc::SnapAxis::kBoth, cc::SnapStrictness::kMandatory), gfx::RectF(10, 10, width - 20, height - 20), max_position);
    cc::SnapAreaData expected_area(cc::ScrollSnapAlign(cc::SnapAlignment::kStart), gfx::RectF(208, 208, 84, 84), false, cc::ElementId(10));
    expected_container.AddSnapAreaData(expected_area);
...
TEST_F(SnapCoordinatorTest, AsymmetricalSnapDataCalculation)
{
    ...
    cc::SnapAreaData expected_area(cc::ScrollSnapAlign(cc::SnapAlignment::kCenter), gfx::RectF(192, 198, 112, 108), false, cc::ElementId(10));
    expected_container.AddSnapAreaData(expected_area);
...
TEST_F(SnapCoordinatorTest, ScaledSnapDataCalculation)
{
    SetUpSingleSnapArea();
    Element* area_element = GetDocument().getElementById("area");
    area_element->setAttribute(kStyleAttr, "scroll-snap-align: end; transform: scale(4, 4);");
    UpdateAllLifecyclePhasesForTest();
    Element* scroller_element = GetDocument().getElementById("scroller");
    const cc::SnapContainerData* data = GetSnapContainerData(*scroller_element->GetLayoutBox());
    EXPECT_TRUE(data);
    ...
    // (50, 50).
    cc::SnapAreaData expected_area(cc::ScrollSnapAlign(cc::SnapAlignment::kEnd), gfx::RectF(42, 42, 416, 416), false, cc::ElementId(10));
    expected_container.AddSnapAreaData(expected_area);
...
TEST_F(SnapCoordinatorTest, VerticalRlSnapDataCalculation)
{
    SetUpSingleSnapArea();
    Element* area_element = GetDocument().getElementById("area");
    area_element->setAttribute(kStyleAttr, "scroll-snap-align: start; left: -200px;");
    Element* scroller_element = GetDocument().getElementById("scroller");
    ...
    cc::SnapAreaData expected_area(
        cc::ScrollSnapAlign(cc::SnapAlignment::kStart, cc::SnapAlignment::kEnd), gfx::RectF(192, 192, 116, 116), false, cc::ElementId(10));
    expected_container.AddSnapAreaData(expected_area);
