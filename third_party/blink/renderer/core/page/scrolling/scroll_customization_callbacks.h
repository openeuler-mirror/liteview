...
public:
    ...
    ScrollCustomizationCallbacks& operator=(const ScrollCustomizationCallbacks&) = delete;
...
private:
    using ScrollStateCallbackList = HeapHashMap<WeakMember<Node>, Member<ScrollStateCallback>>;
