...
void ScrollCustomizationCallbacks::SetDistributeScroll(Node* node, ScrollStateCallback* scroll_state_callback)
{
    distribute_scroll_callbacks_.Set(node, scroll_state_callback);
}

ScrollStateCallback* ScrollCustomizationCallbacks::GetDistributeScroll(Node* node)
{
...
void ScrollCustomizationCallbacks::SetApplyScroll(Node* node, ScrollStateCallback* scroll_state_callback)
{
