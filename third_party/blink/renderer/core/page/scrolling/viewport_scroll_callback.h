...
public:
    ...
    ViewportScrollCallback(BrowserControls*, OverscrollController*, RootFrameViewport&);
...
private:
    bool ShouldScrollBrowserControls(const ScrollOffset&, ui::ScrollGranularity) const;
