...
TEST_F(ElementFragmentAnchorTest, FocusHandlerRunBeforeRaf)
{
    ...
    // point.
    ASSERT_EQ(GetDocument().getElementById("bottom"), GetDocument().ActiveElement());
...
TEST_F(ElementFragmentAnchorTest, IframeFragmentNoLayoutUntilLoad)
{
    ...
    HTMLFrameOwnerElement* iframe = To<HTMLFrameOwnerElement>(GetDocument().getElementById("child"));
