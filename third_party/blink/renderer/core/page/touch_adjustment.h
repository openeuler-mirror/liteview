...
bool FindBestClickableCandidate(
    Node*& target_node, gfx::Point& target_point, const gfx::Point& touch_hotspot, const gfx::Rect& touch_area, const HeapVector<Member<Node>>&);
...
CORE_EXPORT LayoutSize GetHitTestRectForAdjustment(LocalFrame& frame, const LayoutSize& touch_area);
