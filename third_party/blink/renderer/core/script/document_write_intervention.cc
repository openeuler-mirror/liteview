...
{
    params->MutableResourceRequest().AddHttpHeaderField("Intervention",
...
{
    params->MutableResourceRequest().AddHttpHeaderField("Intervention", "<https://www.chromestatus.com/feature/5718547946799104>");
}
    ...
    const Resource* resource, Document& element_document, const ScriptFetchOptions& options, CrossOriginAttributeValue cross_origin)
{
    ...
    AddHeader(&params);
    ScriptResource::Fetch(params, element_document.Fetcher(), nullptr, ScriptResource::kNoStreaming);
}
