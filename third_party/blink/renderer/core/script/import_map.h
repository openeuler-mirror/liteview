...
public:
    static ImportMap* Parse(const String& text, const KURL& base_url, ConsoleLogger& logger, absl::optional<ImportMapError>* error_to_rethrow);
    ...
    absl::optional<KURL> Resolve(const ParsedSpecifier&, const KURL& base_url, String* debug_message) const;
...
private:
    ...
    absl::optional<KURL> ResolveImportsMatch(const ParsedSpecifier&, const SpecifierMap&, String* debug_message) const;
    absl::optional<MatchResult> MatchPrefix(const ParsedSpecifier&, const SpecifierMap&) const;
