...
static constexpr char kInlineRedDot[] = "data:image/"
...
public:
    ...
    {
        if (fixed) {
            time_clock_overrides_ = std::make_unique<base::subtle::ScopedTimeClockOverrides>(nullptr, &ScopedTimeTicksOverride::FixedTicks, nullptr);
        } else {
            time_clock_overrides_ = std::make_unique<base::subtle::ScopedTimeClockOverrides>(nullptr, &ScopedTimeTicksOverride::BoostedTicks, nullptr);
        }
    }
...
class MobileFriendlinessCheckerTest : public testing::Test {
    ...
    static std::unique_ptr<frame_test_helpers::WebViewHelper> CreateMobileMetricsWebViewHelper(float device_scale)
    {
...
public:
    ...
    MobileFriendliness CalculateMetricsForHTMLString(const std::string& html, float device_scale = 1.0, bool fixed_clock = true)
    {
        std::unique_ptr<frame_test_helpers::WebViewHelper> helper(CreateMobileMetricsWebViewHelper(device_scale));
        frame_test_helpers::LoadHTMLString(helper->GetWebView()->MainFrameImpl(), html, url_test_helpers::ToKURL("about:blank"));
        MobileFriendlinessObserver mobile_friendliess_observer(helper->GetWebView()->MainFrameImpl());
        EvalMobileFriendliness(helper->GetWebView()->MainFrameImpl()->GetFrameView(), fixed_clock);
        return mobile_friendliess_observer.GetMobileFriendliness();
    }

    MobileFriendliness CalculateMetricsForFile(const std::string& path, float device_scale = 1.0, bool fixed_clock = true)
    {
        std::unique_ptr<frame_test_helpers::WebViewHelper> helper(CreateMobileMetricsWebViewHelper(device_scale));
...
{
    MobileFriendliness actual_mf = CalculateMetricsForHTMLString("<body>bar</body>");
...
{
    MobileFriendliness actual_mf = CalculateMetricsForFile("viewport/viewport-1.html");
...
{
    MobileFriendliness actual_mf = CalculateMetricsForFile("viewport/viewport-30.html");
    EXPECT_EQ(actual_mf.viewport_device_width, false);
    EXPECT_EQ(actual_mf.allow_user_zoom, true);
...
TEST_F(MobileFriendlinessCheckerTest, DeviceWidthWithInitialScale05)
{
    ...
    MobileFriendliness actual_mf = CalculateMetricsForFile("viewport/viewport-34.html");
    EXPECT_EQ(actual_mf.viewport_device_width, true);
    EXPECT_EQ(actual_mf.allow_user_zoom, true);
...
{
    MobileFriendliness actual_mf = CalculateMetricsForFile("viewport-initial-scale-and-user-scalable-no.html");
    EXPECT_EQ(actual_mf.viewport_device_width, true);
...
{
    MobileFriendliness actual_mf = CalculateMetricsForHTMLString(R"HTML(<body></body>)HTML");
    EXPECT_EQ(actual_mf.viewport_device_width, false);
    EXPECT_EQ(actual_mf.allow_user_zoom, true);
...
{
    MobileFriendliness actual_mf = CalculateMetricsForHTMLString(base::StringPrintf(R"HTML(
<html>
  <head>
    <meta name="viewport" content="width=480, initial-scale=1">
  </head>
...
TEST_F(MobileFriendlinessCheckerTest, IFrame)
{
    ...
    const MobileFriendliness actual_mf = CalculateMetricsForFile("single_iframe.html");
    EXPECT_EQ(actual_mf.viewport_device_width, false);
    EXPECT_EQ(actual_mf.allow_user_zoom, true);
    EXPECT_EQ(actual_mf.bad_tap_targets_ratio, 0);
}
...
TEST_F(MobileFriendlinessCheckerTest, IFrameVieportDeviceWidth)
{
    ...
    const MobileFriendliness actual_mf = CalculateMetricsForFile("page_contains_viewport_iframe.html");
    EXPECT_EQ(actual_mf.viewport_device_width, true);
    EXPECT_EQ(actual_mf.allow_user_zoom, true);
    EXPECT_EQ(actual_mf.small_text_ratio, 0);
    EXPECT_EQ(actual_mf.bad_tap_targets_ratio, 0);
...
TEST_F(MobileFriendlinessCheckerTest, IFrameSmallTextRatio)
{
    ...
    const MobileFriendliness actual_mf = CalculateMetricsForFile("page_contains_small_text_iframe.html");
    EXPECT_EQ(actual_mf.viewport_device_width, false);
    EXPECT_EQ(actual_mf.allow_user_zoom, true);
    EXPECT_EQ(actual_mf.small_text_ratio, 100);
    EXPECT_EQ(actual_mf.bad_tap_targets_ratio, 0);
...
{
    url_test_helpers::RegisterMockedURLLoadFromBase(
        WebString::FromUTF8(kBaseUrl), blink::test::CoreTestDataPath(), WebString::FromUTF8("bad_tap_targets_iframe.html"));
    const MobileFriendliness actual_mf = CalculateMetricsForFile("page_contains_bad_tap_targets_iframe.html");
    EXPECT_EQ(actual_mf.viewport_device_width, false);
    EXPECT_EQ(actual_mf.allow_user_zoom, true);
    EXPECT_EQ(actual_mf.small_text_ratio, 100);
    EXPECT_EQ(actual_mf.bad_tap_targets_ratio, 100);
