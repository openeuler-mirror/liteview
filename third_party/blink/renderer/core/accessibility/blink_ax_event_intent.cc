...
{
    return BlinkAXEventIntentHash::GetHash(a) == BlinkAXEventIntentHash::GetHash(b);
}
...
// static
bool BlinkAXEventIntentHash::Equal(const BlinkAXEventIntent& a, const BlinkAXEventIntent& b)
{
    return a == b;
}
