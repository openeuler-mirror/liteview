...
public:
    ...
    MOCK_METHOD(void, FireBackgroundTracingTrigger, (const String& trigger_name), (override));
...
protected:
    ...
    template <typename MockType> void InitializeMockProcessCoordinationUnit()
    {
...
{
    InitializeMockProcessCoordinationUnit<::testing::StrictMock<MockProcessCoordinationUnit>>();
...
TEST_F(RendererResourceCoordinatorImplTest, NonIframeNotifications)
{
    ...
    InitializeMockProcessCoordinationUnit<::testing::NiceMock<MockProcessCoordinationUnit>>();
