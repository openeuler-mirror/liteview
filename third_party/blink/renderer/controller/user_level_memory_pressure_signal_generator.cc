...
constexpr double kDefaultMemoryThresholdMB = std::numeric_limits<double>::infinity();

double MemoryThresholdParamOf512MbDevices()
{
    static const base::FeatureParam<double> k512MBDeviceMemoryThresholdParam { &blink::features::kUserLevelMemoryPressureSignal,
...
{
    static const base::FeatureParam<double> k1GBDeviceMemoryThresholdParam { &blink::features::kUserLevelMemoryPressureSignal,
...
{
    static const base::FeatureParam<double> k2GBDeviceMemoryThresholdParam { &blink::features::kUserLevelMemoryPressureSignal,
...
{
    static const base::FeatureParam<double> k3GBDeviceMemoryThresholdParam { &blink::features::kUserLevelMemoryPressureSignal,
...
{
    static const base::FeatureParam<double> k4GBDeviceMemoryThresholdParam { &blink::features::kUserLevelMemoryPressureSignal,
...
{
    static const base::FeatureParam<double> kMinimumIntervalSeconds { &blink::features::kUserLevelMemoryPressureSignal, "minimum_interval_s",
...
double MemoryThresholdParam()
{
    ...
    return (physical_memory_mb > 600) ? MemoryThresholdParamOf1GbDevices() : MemoryThresholdParamOf512MbDevices();
}
...
{
    if (!base::FeatureList::IsEnabled(blink::features::kUserLevelMemoryPressureSignal))
        return false;
...
UserLevelMemoryPressureSignalGenerator::UserLevelMemoryPressureSignalGenerator()
    ...
    , delayed_report_timer_(Thread::MainThread()->GetDeprecatedTaskRunner(), this, &UserLevelMemoryPressureSignalGenerator::OnTimerFired)
    , clock_(base::DefaultTickClock::GetInstance())
{
    DCHECK(base::FeatureList::IsEnabled(blink::features::kUserLevelMemoryPressureSignal));
...
UserLevelMemoryPressureSignalGenerator::~UserLevelMemoryPressureSignalGenerator()
{
    ...
    ThreadScheduler::Current()->ToMainThreadScheduler()->RemoveRAILModeObserver(this);
}

void UserLevelMemoryPressureSignalGenerator::SetTickClockForTesting(const base::TickClock* clock)
{
    clock_ = clock;
}
...
{
    UMA_HISTOGRAM_MEMORY_LARGE_MB("Memory.Experimental.UserLevelMemoryPressureSignal."
                                  "RendererPrivateMemoryFootprintBefore",
        base::saturated_cast<base::Histogram::Sample>(usage.private_footprint_bytes / 1024 / 1024));
