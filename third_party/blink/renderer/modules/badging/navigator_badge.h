...
public:
    ...
    static ScriptPromise setAppBadge(ScriptState*, WorkerNavigator&, uint64_t content);
...
private:
    static ScriptPromise SetAppBadgeHelper(ScriptState* script_state, mojom::blink::BadgeValuePtr badge_value);
