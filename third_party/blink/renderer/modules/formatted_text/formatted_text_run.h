...
class FormattedTextRunInternal final : public GarbageCollected<FormattedTextRunInternal>, public FormattedTextStyle {
public:
    static FormattedTextRunInternal* Create(ExecutionContext* execution_context, const String text)
    {
        return MakeGarbageCollected<FormattedTextRunInternal>(execution_context, text);
    }
