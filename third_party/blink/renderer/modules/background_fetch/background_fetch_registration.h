...
public:
    ...
    ScriptPromise matchAll(ScriptState* scrip_state, ExceptionState& exception_state);
...
private:
    void DidAbort(ScriptPromiseResolver* resolver, mojom::blink::BackgroundFetchError error);
    ScriptPromise MatchImpl(ScriptState* script_state, const V8RequestInfo* request, mojom::blink::CacheQueryOptionsPtr cache_query_options,
        ExceptionState& exception_state, bool match_all);
    void DidGetMatchingRequests(ScriptPromiseResolver* resolver, bool return_all, Vector<mojom::blink::BackgroundFetchSettledFetchPtr> settled_fetches);
    ...
    mojo::Remote<mojom::blink::BackgroundFetchRegistrationService> registration_service_;
