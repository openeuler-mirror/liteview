...
public:
    ...
    ScriptPromise getCharacteristic(ScriptState* script_state, const V8BluetoothCharacteristicUUID* characteristic, ExceptionState& exception_state);
    ScriptPromise getCharacteristics(ScriptState* script_state, const V8BluetoothCharacteristicUUID* characteristic, ExceptionState& exception_state);
...
private:
    void GetCharacteristicsCallback(const String& service_instance_id, const String& requested_characteristic_uuid, mojom::blink::WebBluetoothGATTQueryQuantity,
        ScriptPromiseResolver*, mojom::blink::WebBluetoothResult,
    ...
    ScriptPromise GetCharacteristicsImpl(
        ScriptState*, ExceptionState&, mojom::blink::WebBluetoothGATTQueryQuantity, const String& characteristic_uuid = String());
