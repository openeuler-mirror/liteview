...
class BluetoothManufacturerDataMap final : public ScriptWrappable, public Maplike<uint16_t, IDLUnsignedShort, Member<DOMDataView>, DOMDataView> {
...
private:
    PairIterable<uint16_t, IDLUnsignedShort, Member<DOMDataView>, DOMDataView>::IterationSource* StartIteration(ScriptState*, ExceptionState&) override;
    bool GetMapEntry(ScriptState*, const uint16_t& key, Member<DOMDataView>&, ExceptionState&) override;
