...
public:
    ...
    static String getService(const V8BluetoothServiceUUID* name, ExceptionState& exception_state);
    static String getCharacteristic(const V8BluetoothCharacteristicUUID* name, ExceptionState& exception_state);
    static String getDescriptor(const V8BluetoothDescriptorUUID* name, ExceptionState& exception_state);
