...
private:
    ...
    void ReadValueCallback(ScriptPromiseResolver*, mojom::blink::WebBluetoothResult, const absl::optional<Vector<uint8_t>>&);

    void WriteValueCallback(ScriptPromiseResolver*, const Vector<uint8_t>&, mojom::blink::WebBluetoothResult);
