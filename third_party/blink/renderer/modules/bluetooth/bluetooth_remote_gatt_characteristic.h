...
class BluetoothRemoteGATTCharacteristic final : public EventTargetWithInlineData,
...
public:
    ...
    ScriptPromise getDescriptor(ScriptState* script_state, const V8BluetoothDescriptorUUID* descriptor_uuid, ExceptionState& exception_state);
    ScriptPromise getDescriptors(ScriptState*, ExceptionState&);
    ScriptPromise getDescriptors(ScriptState* script_state, const V8BluetoothDescriptorUUID* descriptor_uuid, ExceptionState& exception_state);
    ...
    ScriptPromise writeValueWithResponse(ScriptState*, const DOMArrayPiece&, ExceptionState&);
    ScriptPromise writeValueWithoutResponse(ScriptState*, const DOMArrayPiece&, ExceptionState&);
...
private:
    ...
    struct DeferredValueChange : public GarbageCollected<DeferredValueChange> {
        DeferredValueChange(Member<Event> event, Member<DOMDataView> dom_data_view, Member<ScriptPromiseResolver> resolver)
            : event(event)
    ...
    void ReadValueCallback(ScriptPromiseResolver*, mojom::blink::WebBluetoothResult, const absl::optional<Vector<uint8_t>>& value);
    void WriteValueCallback(ScriptPromiseResolver*, const Vector<uint8_t>& value, mojom::blink::WebBluetoothResult);
    ...
    void NotificationsCallback(ScriptPromiseResolver*, bool started, mojom::blink::WebBluetoothResult);

    ScriptPromise WriteCharacteristicValue(ScriptState*, const DOMArrayPiece& value, mojom::blink::WebBluetoothWriteType, ExceptionState&);

    ScriptPromise GetDescriptorsImpl(ScriptState*, ExceptionState&, mojom::blink::WebBluetoothGATTQueryQuantity, const String& descriptor_uuid = String());
    ...
    void GetDescriptorsCallback(const String& requested_descriptor_uuid, const String& characteristic_instance_id, mojom::blink::WebBluetoothGATTQueryQuantity,
        ScriptPromiseResolver*, mojom::blink::WebBluetoothResult, absl::optional<Vector<mojom::blink::WebBluetoothRemoteGATTDescriptorPtr>> descriptors);
