...
class BluetoothServiceDataMap final : public ScriptWrappable, public Maplike<String, IDLString, Member<DOMDataView>, DOMDataView> {
...
private:
    PairIterable<String, IDLString, Member<DOMDataView>, DOMDataView>::IterationSource* StartIteration(ScriptState*, ExceptionState&) override;
    bool GetMapEntry(ScriptState*, const String& key, Member<DOMDataView>&, ExceptionState&) override;
