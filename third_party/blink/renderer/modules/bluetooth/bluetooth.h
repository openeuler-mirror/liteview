...
public:
    ...
    ScriptPromise requestLEScan(ScriptState*, const BluetoothLEScanOptions*, ExceptionState&);
...
private:
    ...
    void GetDevicesCallback(ScriptPromiseResolver*, Vector<mojom::blink::WebBluetoothDevicePtr>);

    void RequestDeviceCallback(ScriptPromiseResolver*, mojom::blink::WebBluetoothResult, mojom::blink::WebBluetoothDevicePtr);

    void RequestScanningCallback(ScriptPromiseResolver*, mojo::ReceiverId, mojom::blink::WebBluetoothRequestLEScanOptionsPtr, mojom::blink::WebBluetoothResult);
