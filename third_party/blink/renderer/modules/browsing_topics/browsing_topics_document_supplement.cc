...
// static
ScriptPromise BrowsingTopicsDocumentSupplement::browsingTopics(ScriptState* script_state, Document& document, ExceptionState& exception_state)
{
    ...
    ScriptState* script_state, Document& document, const BrowsingTopicsOptions* options, ExceptionState& exception_state)
{
    ...
    document_host_->GetBrowsingTopics(
        ...
        WTF::BindOnce(
            [](ScriptPromiseResolver* resolver, BrowsingTopicsDocumentSupplement* supplement, base::TimeTicks start_time,
