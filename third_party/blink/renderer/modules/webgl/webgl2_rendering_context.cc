...
ImageBitmap* WebGL2RenderingContext::TransferToImageBitmap(ScriptState* script_state)
{
...
void WebGL2RenderingContext::RegisterContextExtensions()
{
    ...
    RegisterExtension(ext_disjoint_timer_query_web_gl2_, TimerQueryExtensionsEnabled() ? kApprovedExtension : kDeveloperExtension);
    ...
    RegisterExtension(webgl_draw_instanced_base_vertex_base_instance_, kDraftExtension);
    RegisterExtension(webgl_lose_context_);
    RegisterExtension(webgl_multi_draw_);
    RegisterExtension(webgl_multi_draw_instanced_base_vertex_base_instance_, kDraftExtension);
