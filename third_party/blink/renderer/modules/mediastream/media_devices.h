...
public:
    ...
    ScriptPromise getUserMedia(ScriptState*, const UserMediaStreamConstraints*, ExceptionState&);
    ScriptPromise SendUserMediaRequest(ScriptState*, UserMediaRequestType, const MediaStreamConstraints*, ExceptionState&);

    ScriptPromise getDisplayMediaSet(ScriptState*, const DisplayMediaStreamOptions*, ExceptionState&);

    ScriptPromise getDisplayMedia(ScriptState*, const DisplayMediaStreamOptions*, ExceptionState&);
    ...
    using EnumerateDevicesTestCallback = base::OnceCallback<void(const MediaDeviceInfoVector&)>;

    void SetDispatcherHostForTesting(mojo::PendingRemote<mojom::blink::MediaDevicesDispatcherHost>);

    void SetEnumerateDevicesCallbackForTesting(EnumerateDevicesTestCallback test_callback)
    {
...
private:
    ...
    void StartObserving();
    void StopObserving();
    void DevicesEnumerated(ScriptPromiseResolver*, const Vector<Vector<WebMediaDeviceInfo>>&, Vector<mojom::blink::VideoInputDeviceCapabilitiesPtr>,
    ...
    void EnqueueMicrotaskToCloseFocusWindowOfOpportunity(const String&, MediaStreamTrack*);
    ...
    // assigned to |element|.
    void ResolveProduceCropIdPromise(Element* element, const WTF::String& crop_id);
#endif
    ...
    HeapHashMap<Member<ScriptPromiseResolver>, RequestMetadata> enumerate_device_requests_;
    ...
    HeapHashMap<Member<Element>, Member<ScriptPromiseResolver>> crop_id_resolvers_;
#endif
