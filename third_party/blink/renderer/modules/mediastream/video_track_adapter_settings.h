...
public:
    ...
    VideoTrackAdapterSettings(const gfx::Size& target_size, double max_frame_rate);
    ...
    VideoTrackAdapterSettings(absl::optional<gfx::Size> target_size, double min_aspect_ratio, double max_aspect_ratio, double max_frame_rate);
    ...
    const absl::optional<gfx::Size>& target_size() const
    {
        return target_size_;
    }
