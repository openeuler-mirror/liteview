...
std::unique_ptr<blink::LocalMediaStreamAudioSource> MakeLocalMediaStreamAudioSource()
{
    ...
    return std::make_unique<blink::LocalMediaStreamAudioSource>(
        ...
        /*disable_local_echo=*/false, blink::WebPlatformMediaStreamSource::ConstraintsRepeatingCallback(),
...
TEST_F(MediaStreamTrackImplTest, StopTrackTriggersObservers)
{
    ...
    MediaStreamSource* source = MakeGarbageCollected<MediaStreamSource>("id", MediaStreamSource::StreamType::kTypeVideo, "name", false /* remote */);
...
TEST_F(MediaStreamTrackImplTest, LabelSanitizer)
{
    ...
    MediaStreamSource* source
        = MakeGarbageCollected<MediaStreamSource>("id", MediaStreamSource::StreamType::kTypeAudio, "Chromiums AirPods", false /* remote */);
    MediaStreamComponent* component = MakeGarbageCollected<MediaStreamComponentImpl>(source);
    MediaStreamTrack* track = MakeGarbageCollected<MediaStreamTrackImpl>(v8_scope.GetExecutionContext(), component);
...
TEST_F(MediaStreamTrackImplTest, StopTrackSynchronouslyDisablesMedia)
{
    ...
    MediaStreamSource* source = MakeGarbageCollected<MediaStreamSource>("id", MediaStreamSource::StreamType::kTypeAudio, "name", false /* remote */);
...
TEST_F(MediaStreamTrackImplTest, CloneVideoTrack)
{
    ...
    std::unique_ptr<MediaStreamVideoSource> platform_source = MakeMockMediaStreamVideoSource();
...
TEST_F(MediaStreamTrackImplTest, CloneAudioTrack)
{
    ...
    MediaStreamSource* source = MakeGarbageCollected<MediaStreamSource>(
        "id", MediaStreamSource::StreamType::kTypeAudio, "name", false /* remote */, MakeLocalMediaStreamAudioSource());
    MediaStreamComponent* component = MakeGarbageCollected<MediaStreamComponentImpl>(source);
    MediaStreamTrack* track = MakeGarbageCollected<MediaStreamTrackImpl>(v8_scope.GetExecutionContext(), component);
