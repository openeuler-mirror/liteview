...
class MODULES_EXPORT BrowserCaptureMediaStreamTrack final : public FocusableMediaStreamTrack {
    DEFINE_WRAPPERTYPEINFO();

public:
    BrowserCaptureMediaStreamTrack(
        ExecutionContext* execution_context, MediaStreamComponent* component, base::OnceClosure callback, const String& descriptor_id, bool is_clone = false);

    BrowserCaptureMediaStreamTrack(ExecutionContext* execution_context, MediaStreamComponent* component, MediaStreamSource::ReadyState ready_state,
        base::OnceClosure callback, const String& descriptor_id, bool is_clone = false);
...
private:
    ...
    using CropVersionToPromiseInfoMap = HeapHashMap<uint32_t, Member<BrowserCaptureMediaStreamTrack::CropPromiseInfo>>;
    ...
    void OnResultFromBrowserProcess(uint32_t crop_version, media::mojom::CropRequestResult result);
