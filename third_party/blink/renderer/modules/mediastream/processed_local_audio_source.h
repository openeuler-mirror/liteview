...
public:
    ...
    absl::optional<blink::AudioProcessingProperties> GetAudioProcessingProperties() const final;
...
protected:
    ...
    void Capture(const media::AudioBus* audio_source, base::TimeTicks audio_capture_time, double volume, bool key_pressed) override;
...
private:
    ...
    // Capture().
    void DeliverProcessedAudio(const media::AudioBus& processed_audio, base::TimeTicks audio_capture_time, absl::optional<double> new_volume);
