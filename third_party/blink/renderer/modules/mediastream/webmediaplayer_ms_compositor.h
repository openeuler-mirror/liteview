...
class MODULES_EXPORT WebMediaPlayerMSCompositor : public cc::VideoFrameProvider,
                                                  public WTF::ThreadSafeRefCounted<WebMediaPlayerMSCompositor, WebMediaPlayerMSCompositorTraits> {
public:
    ...
    WebMediaPlayerMSCompositor(scoped_refptr<base::SingleThreadTaskRunner> task_runner, scoped_refptr<base::SingleThreadTaskRunner> io_task_runner,
...
private:
    friend class WTF::ThreadSafeRefCounted<WebMediaPlayerMSCompositor, WebMediaPlayerMSCompositorTraits>;
    ...
    void SetCurrentFrame(scoped_refptr<media::VideoFrame> frame, bool is_copy, absl::optional<base::TimeTicks> expected_presentation_time);
    // Following the update to |current_frame_|, this will check for changes that
    // require updating video layer.
    void CheckForFrameChanges(bool is_first_frame, bool has_frame_size_changed, absl::optional<media::VideoTransformation> new_frame_transform,
    ...
    void RecordFrameDecodedStats(absl::optional<base::TimeTicks> frame_received_time, absl::optional<base::TimeDelta> frame_processing_time,
