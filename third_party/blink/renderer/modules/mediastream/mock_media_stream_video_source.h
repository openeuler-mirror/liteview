...
public:
    ...
    MOCK_METHOD3(Crop, void(const base::Token&, uint32_t, base::OnceCallback<void(media::mojom::CropRequestResult)>));
    ...
    {
        return max_requested_height_;
    }
    int max_requested_width() const
    {
        return max_requested_width_;
    }
    double max_requested_frame_rate() const
    {
