...
public:
    ...
    VideoCaptureSettings(std::string device_id, media::VideoCaptureParams capture_params_, absl::optional<bool> noise_reduction_,
        const VideoTrackAdapterSettings& track_adapter_settings, absl::optional<double> min_frame_rate, absl::optional<double> max_frame_rate,
        absl::optional<double> pan = absl::nullopt, absl::optional<double> tilt = absl::nullopt, absl::optional<double> zoom = absl::nullopt);
...
public:
    ...
    // Creates an object with the given values.
    AudioCaptureSettings(std::string device_id, const absl::optional<int>& requested_buffer_size, bool disable_local_echo,
...
MODULES_EXPORT MediaStreamSource::Capabilities ComputeCapabilitiesForVideoSource(const String& device_id, const media::VideoCaptureFormats& formats,
    mojom::blink::FacingMode facing_mode, bool is_device_capture, const absl::optional<std::string>& group_id = absl::nullopt);
