...
FocusableMediaStreamTrack* MakeTrack(V8TestingScope& v8_scope, std::unique_ptr<MockMediaStreamVideoSource> media_stream_video_source)
{
    ...
    return MakeGarbageCollected<FocusableMediaStreamTrack>(v8_scope.GetExecutionContext(), component, /*callback=*/base::DoNothing(), "descriptor");
}
...
TEST_F(FocusableMediaStreamTrackTest, CloningPreservesConstraints)
{
    ...
    FocusableMediaStreamTrack* const track = MakeTrack(v8_scope, std::move(media_stream_video_source));
