...
VideoTrackAdapterSettings::VideoTrackAdapterSettings()
    : VideoTrackAdapterSettings(absl::nullopt, 0.0, std::numeric_limits<double>::max(), 0.0)
{
}

VideoTrackAdapterSettings::VideoTrackAdapterSettings(const gfx::Size& target_size, double max_frame_rate)
    : VideoTrackAdapterSettings(target_size, 0.0, HUGE_VAL, max_frame_rate)
{
}

VideoTrackAdapterSettings::VideoTrackAdapterSettings(
    absl::optional<gfx::Size> target_size, double min_aspect_ratio, double max_aspect_ratio, double max_frame_rate)
