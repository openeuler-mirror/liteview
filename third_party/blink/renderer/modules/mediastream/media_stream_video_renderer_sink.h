...
class MODULES_EXPORT MediaStreamVideoRendererSink : public WebMediaStreamVideoRenderer, public MediaStreamVideoSink {
public:
    MediaStreamVideoRendererSink(MediaStreamComponent* video_component, const WebMediaStreamVideoRenderer::RepaintCB& repaint_cb,
