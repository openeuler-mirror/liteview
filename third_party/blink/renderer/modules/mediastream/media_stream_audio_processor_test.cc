...
using MockProcessedCaptureCallback
    = base::MockRepeatingCallback<void(const media::AudioBus& audio_bus, base::TimeTicks audio_capture_time, absl::optional<double> new_volume)>;
...
TEST_P(MediaStreamAudioProcessorTestMultichannel, MAYBE_WithAudioProcessing)
{
    ...
    ProcessDataAndVerifyFormat(
        *audio_processor, mock_capture_callback_, media::kAudioProcessingSampleRateHz, expected_output_channels, media::kAudioProcessingSampleRateHz / 100);
...
TEST(MediaStreamAudioProcessorCallbackTest, ProcessedAudioIsDeliveredAsSoonAsPossibleWithShortBuffers)
{
    ...
    auto check_audio_length = [&](const media::AudioBus& processed_audio, base::TimeTicks, absl::optional<double>) {
...
TEST(MediaStreamAudioProcessorWouldModifyAudioTest, TrueWhenSoftwareEchoCancellationIsEnabled)
{
    blink::AudioProcessingProperties properties;
    properties.DisableDefaultProperties();
...
TEST(MediaStreamAudioProcessorWouldModifyAudioTest, TrueWhenStereoMirroringIsEnabled)
{
    blink::AudioProcessingProperties properties;
    properties.DisableDefaultProperties();
    properties.goog_audio_mirroring = true;
...
TEST(MediaStreamAudioProcessorWouldModifyAudioTest, TrueWhenGainControlIsEnabled)
{
    blink::AudioProcessingProperties properties;
    properties.DisableDefaultProperties();
...
TEST(MediaStreamAudioProcessorWouldModifyAudioTest, TrueWhenExperimentalEchoCancellationIsEnabled)
{
    blink::AudioProcessingProperties properties;
    properties.DisableDefaultProperties();
