...
ScriptPromise TransferredMediaStreamTrack::applyConstraints(ScriptState* script_state, const MediaTrackConstraints* constraints)
{
    if (track_) {
...
void TransferredMediaStreamTrack::applyConstraints(ScriptPromiseResolver* resolver, const MediaTrackConstraints* constraints)
{
...
std::unique_ptr<AudioSourceProvider> TransferredMediaStreamTrack::CreateWebAudioSource(int context_sample_rate)
{
    if (track_) {
...
absl::optional<const MediaStreamDevice> TransferredMediaStreamTrack::device() const
{
    if (track_) {
