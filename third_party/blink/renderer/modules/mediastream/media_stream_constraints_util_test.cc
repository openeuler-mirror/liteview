...
TEST_F(MediaStreamConstraintsUtilTest, BooleanConstraints)
{
    ...
    EXPECT_TRUE(GetConstraintValueAsBoolean(constraints, &MediaTrackConstraintSetPlatform::echo_cancellation, &value_true));
    EXPECT_TRUE(GetConstraintValueAsBoolean(constraints, &MediaTrackConstraintSetPlatform::goog_echo_cancellation, &value_false));
    ...
    EXPECT_TRUE(GetConstraintValueAsBoolean(constraints, &MediaTrackConstraintSetPlatform::echo_cancellation, &value_false));
    EXPECT_TRUE(GetConstraintValueAsBoolean(constraints, &MediaTrackConstraintSetPlatform::goog_echo_cancellation, &value_true));
    EXPECT_TRUE(value_true);
    EXPECT_FALSE(value_false);
