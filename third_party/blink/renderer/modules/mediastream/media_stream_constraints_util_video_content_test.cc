...
void CheckTrackAdapterSettingsEqualsFormat(const VideoCaptureSettings& result, double frame_rate = 0.0)
{
...
void CheckTrackAdapterSettingsEqualsFormatDefaultAspectRatio(const VideoCaptureSettings& result, double frame_rate = 0.0)
{
