...
public:
        ...
        WebMediaStreamDeviceObserver::OnDeviceRequestStateChangeCb request_state_change_callback)
    {
        ...
        stream_devices_set.stream_devices.push_back(blink::mojom::blink::StreamDevices::New(
            absl::nullopt, MediaStreamDevice(blink::mojom::blink::MediaStreamType::DISPLAY_VIDEO_CAPTURE_SET, "device_0_id", "device_0_name")));
        stream_devices_set.stream_devices.push_back(blink::mojom::blink::StreamDevices::New(
            absl::nullopt, MediaStreamDevice(blink::mojom::blink::MediaStreamType::DISPLAY_VIDEO_CAPTURE_SET, "device_1_id", "device_1_name")));

        observer_->AddStreams(streams_label, stream_devices_set, device_stopped_callback,
            /*on_device_changed_cb=*/base::DoNothing(), request_state_change_callback,
