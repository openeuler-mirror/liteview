...
// consumer.
class MODULES_EXPORT TrackAudioRenderer : public WebMediaStreamAudioRenderer, public WebMediaStreamAudioSink, public media::AudioRendererSink::RenderCallback {
public:
    ...
    TrackAudioRenderer(MediaStreamComponent* audio_component, LocalFrame& playout_web_frame, const base::UnguessableToken& session_id, const String& device_id,
