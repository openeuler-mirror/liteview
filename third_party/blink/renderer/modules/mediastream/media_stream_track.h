...
class MODULES_EXPORT MediaStreamTrack : public EventTargetWithInlineData, public ActiveScriptWrappable<MediaStreamTrack> {
...
public:
    ...
    virtual ScriptPromise applyConstraints(ScriptState*, const MediaTrackConstraints*) = 0;

    virtual void applyConstraints(ScriptPromiseResolver*, const MediaTrackConstraints*) = 0;
    ...
    virtual std::unique_ptr<AudioSourceProvider> CreateWebAudioSource(int context_sample_rate) = 0;
