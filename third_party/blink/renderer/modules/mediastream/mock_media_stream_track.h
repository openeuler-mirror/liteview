...
public:
    ...
    void SetReadyState(const String& ready_state)
    {
    ...
    ScriptPromise applyConstraints(ScriptState* state, const MediaTrackConstraints* constraints) override
    {
        return applyConstraintsScriptState(state, constraints);
    }
    void applyConstraints(ScriptPromiseResolver* resolver, const MediaTrackConstraints* constraints) override
    {
    ...
    MOCK_METHOD2(applyConstraintsScriptState, ScriptPromise(ScriptState*, const MediaTrackConstraints*));
    MOCK_METHOD2(applyConstraintsResolver, void(ScriptPromiseResolver*, const MediaTrackConstraints*));
