...
MediaStreamDeviceObserver::MediaStreamDeviceObserver(LocalFrame* frame)
{
    ...
    if (frame) {
        frame->GetInterfaceRegistry()->AddInterface(
            WTF::BindRepeating(&MediaStreamDeviceObserver::BindMediaStreamDeviceObserverReceiver, WTF::Unretained(this)));
    }
}
...
void MediaStreamDeviceObserver::AddStreams(const String& label, const mojom::blink::StreamDevicesSet& stream_devices_set,
    WebMediaStreamDeviceObserver::OnDeviceStoppedCb on_device_stopped_cb, WebMediaStreamDeviceObserver::OnDeviceChangedCb on_device_changed_cb,
    ...
    WebMediaStreamDeviceObserver::OnDeviceCaptureHandleChangeCb on_device_capture_handle_change_cb)
{
    ...
    for (const mojom::blink::StreamDevicesPtr& stream_devices_ptr : stream_devices_set.stream_devices) {
        ...
        stream.on_device_request_state_change_cb = on_device_request_state_change_cb;
        stream.on_device_capture_handle_change_cb = on_device_capture_handle_change_cb;
