...
public:
    ...
    void SetUp() override
    {
        ...
        track_renderer_ = base::MakeRefCounted<TrackAudioRenderer>(audio_component, dummy_page_.GetFrame(), base::UnguessableToken::Null(), String(),
            base::BindRepeating(&TrackAudioRendererTest::OnRenderError, base::Unretained(this)));
    }
