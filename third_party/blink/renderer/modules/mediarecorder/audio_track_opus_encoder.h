...
public:
    AudioTrackOpusEncoder(OnEncodedAudioCB on_encoded_audio_cb, uint32_t bits_per_second, bool vbr_enabled = true);
...
private:
    ...
    double ProvideInput(media::AudioBus* audio_bus, uint32_t frames_delayed) override;
