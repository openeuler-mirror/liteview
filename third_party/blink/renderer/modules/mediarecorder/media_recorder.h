...
class MODULES_EXPORT MediaRecorder : public EventTargetWithInlineData, public ActiveScriptWrappable<MediaRecorder>, public ExecutionContextLifecycleObserver {
...
public:
    ...
    virtual void WriteData(const char* data, size_t length, bool last_in_slice, double timecode);
