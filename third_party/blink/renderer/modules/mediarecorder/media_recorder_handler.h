...
public:
    explicit MediaRecorderHandler(scoped_refptr<base::SingleThreadTaskRunner> task_runner);
    ...
    bool Initialize(MediaRecorder* client, MediaStreamDescriptor* media_stream, const String& type, const String& codecs, uint32_t audio_bits_per_second,
        uint32_t video_bits_per_second, AudioTrackRecorder::BitrateMode audio_bitrate_mode);
