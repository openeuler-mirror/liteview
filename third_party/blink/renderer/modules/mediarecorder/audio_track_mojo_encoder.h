...
public:
    AudioTrackMojoEncoder(AudioTrackRecorder::CodecId codec, OnEncodedAudioCB on_encoded_audio_cb, uint32_t bits_per_second = 0);
...
private:
    ...
    void OnEncodeOutput(media::EncodedAudioBuffer encoded_buffer, absl::optional<media::AudioEncoder::CodecDescription> codec_desc);
