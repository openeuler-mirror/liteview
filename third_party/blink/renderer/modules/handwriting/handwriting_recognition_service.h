...
public:
    ...
    // IDL Interface:
    static ScriptPromise createHandwritingRecognizer(ScriptState*, Navigator&, const HandwritingModelConstraint*, ExceptionState&);
    static ScriptPromise queryHandwritingRecognizer(ScriptState*, Navigator&, const HandwritingModelConstraint*, ExceptionState&);
...
private:
    ...
    ScriptPromise CreateHandwritingRecognizer(ScriptState*, const HandwritingModelConstraint*, ExceptionState&);

    ScriptPromise QueryHandwritingRecognizer(ScriptState*, const HandwritingModelConstraint* constraint, ExceptionState&);
