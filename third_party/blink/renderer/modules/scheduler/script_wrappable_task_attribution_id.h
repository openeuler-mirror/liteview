...
class ScriptWrappableTaskAttributionId final : public ScriptWrappable, public scheduler::TaskAttributionId {
    DEFINE_WRAPPERTYPEINFO();

public:
    explicit ScriptWrappableTaskAttributionId(const scheduler::TaskAttributionId& id)
