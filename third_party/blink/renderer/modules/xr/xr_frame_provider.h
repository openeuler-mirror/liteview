...
private:
    ...
    void ProcessScheduledFrame(device::mojom::blink::XRFrameDataPtr frame_data, double high_res_now_ms);
    ...
    void OnPreDispatchInlineFrame(XRSession* session, double timestamp, const absl::optional<gpu::MailboxHolder>& output_mailbox_holder,
