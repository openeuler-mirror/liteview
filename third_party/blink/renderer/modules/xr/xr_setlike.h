...
template <typename ElementType> class XRSetlike : public SetlikeIterable<Member<ElementType>, ElementType> {
public:
    unsigned size() const
    {
...
private:
    class IterationSource final : public SetlikeIterable<Member<ElementType>, ElementType>::IterationSource {
    public:
        ...
        bool Next(ScriptState* script_state, Member<ElementType>& key, Member<ElementType>& value, ExceptionState& exception_state) override
        {
        ...
        void Trace(Visitor* visitor) const override
        {
            ...
            SetlikeIterable<Member<ElementType>, ElementType>::IterationSource::Trace(visitor);
        }
    ...
    XRSetlike::IterationSource* StartIteration(ScriptState* script_state, ExceptionState& exception_state) override
    {
