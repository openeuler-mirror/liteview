...
void XRBoundedReferenceSpace::EnsureUpdated() const
{
    ...
    if (stage_parameters) {
        ...
        mojo_from_bounded_native_ = std::make_unique<TransformationMatrix>(stage_parameters->mojo_from_floor);
...
absl::optional<TransformationMatrix> XRBoundedReferenceSpace::MojoFromNative() const
{
    EnsureUpdated();
