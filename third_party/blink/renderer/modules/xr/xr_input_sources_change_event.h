...
public:
    static XRInputSourcesChangeEvent* Create(
        const AtomicString& type, XRSession* session, const HeapVector<Member<XRInputSource>>& added, const HeapVector<Member<XRInputSource>>& removed)
    {
        return MakeGarbageCollected<XRInputSourcesChangeEvent>(type, session, added, removed);
    }
    ...
    XRInputSourcesChangeEvent(const AtomicString& type, XRSession*, const HeapVector<Member<XRInputSource>>&, const HeapVector<Member<XRInputSource>>&);
    XRInputSourcesChangeEvent(const AtomicString&, const XRInputSourcesChangeEventInit*);
