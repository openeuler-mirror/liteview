...
XRRigidTransform::XRRigidTransform(const TransformationMatrix& transformationMatrix)
...
void XRRigidTransform::DecomposeMatrix()
{
    ...
    position_ = DOMPointReadOnly::Create(decomposed.translate_x, decomposed.translate_y, decomposed.translate_z, 1.0);

    orientation_ = makeNormalizedQuaternion(decomposed.quaternion_x, decomposed.quaternion_y, decomposed.quaternion_z, decomposed.quaternion_w);
}
