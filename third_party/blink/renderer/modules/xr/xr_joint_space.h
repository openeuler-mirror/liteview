...
public:
    XRJointSpace(XRHand* hand, XRSession* session, std::unique_ptr<TransformationMatrix> mojo_from_joint, device::mojom::blink::XRHandJoint joint, float radius,
    ...
    void UpdateTracking(std::unique_ptr<TransformationMatrix> mojo_from_joint, float radius);
