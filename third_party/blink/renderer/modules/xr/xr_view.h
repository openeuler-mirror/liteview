...
public:
    ...
    XRViewData(const device::mojom::blink::XRViewPtr& view, double depth_near, double depth_far);

    void UpdateView(const device::mojom::blink::XRViewPtr& view, double depth_near, double depth_far);
    ...
    TransformationMatrix UnprojectPointer(double x, double y, double canvas_width, double canvas_height);

    device::mojom::blink::XREye Eye() const
    {
        return eye_;
    }
    const TransformationMatrix& MojoFromView() const
    {
