...
public:
    static device::mojom::blink::XRReferenceSpaceType StringToReferenceSpaceType(const String& reference_space_type);
    ...
    absl::optional<TransformationMatrix> NativeFromViewer(const absl::optional<TransformationMatrix>& mojo_from_viewer) const override;
