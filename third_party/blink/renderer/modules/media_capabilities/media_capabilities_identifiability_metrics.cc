...
IdentifiableToken ComputeToken(const VideoConfiguration* configuration)
{
    ...
    if (configuration->hasHdrMetadataType()) {
        builder.AddToken(IdentifiabilityBenignStringToken(configuration->hdrMetadataType()));
    }
    if (configuration->hasColorGamut()) {
        builder.AddToken(IdentifiabilityBenignStringToken(configuration->colorGamut()));
    }
    if (configuration->hasTransferFunction()) {
        builder.AddToken(IdentifiabilityBenignStringToken(configuration->transferFunction()));
    }
...
IdentifiableToken ComputeToken(const MediaKeySystemConfiguration* configuration)
{
    ...
    builder.AddToken(IdentifiabilityBenignStringToken(configuration->label()))
        ...
        .AddToken(IdentifiabilityBenignStringToken(configuration->persistentState()))
...
void ReportDecodingInfoResult(ExecutionContext* context, absl::optional<IdentifiableToken> input_token, const MediaCapabilitiesDecodingInfo* output)
{
...
absl::optional<IdentifiableToken> ComputeDecodingInfoInputToken(const MediaDecodingConfiguration* input)
{
    if (!IsDecodingInfoTypeAllowed() || !ShouldSampleDecodingInfoType())
        return absl::nullopt;
