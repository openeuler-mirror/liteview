...
void ReportDecodingInfoResult(ExecutionContext*, absl::optional<IdentifiableToken>, const MediaCapabilitiesDecodingInfo*);
...
absl::optional<IdentifiableToken> ComputeDecodingInfoInputToken(const MediaDecodingConfiguration*);
