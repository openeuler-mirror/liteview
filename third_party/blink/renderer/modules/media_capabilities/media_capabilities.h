...
public:
    ...
    ScriptPromise decodingInfo(ScriptState*, const MediaDecodingConfiguration*, ExceptionState&);
    ScriptPromise encodingInfo(ScriptState*, const MediaEncodingConfiguration*, ExceptionState&);
...
private:
    ...
    ScriptPromise GetEmeSupport(ScriptState*, media::VideoCodec, media::VideoCodecProfile, media::VideoColorSpace, const MediaDecodingConfiguration*,
        const base::TimeTicks& request_time, ExceptionState&);
    ...
    void GetPerfInfo(media::VideoCodec, media::VideoCodecProfile, media::VideoColorSpace, const MediaDecodingConfiguration*,
        const base::TimeTicks& request_time, ScriptPromiseResolver*, MediaKeySystemAccess*);
    ...
    void OnBadWindowPrediction(int callback_id, const absl::optional<::media::learning::TargetHistogram>& histogram);

    // Callback for predictions from |nnr_predictor_|.
    void OnNnrPrediction(int callback_id, const absl::optional<::media::learning::TargetHistogram>& histogram);
