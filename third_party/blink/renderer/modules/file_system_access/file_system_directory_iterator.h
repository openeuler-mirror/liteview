...
class FileSystemDirectoryIterator final : public ScriptWrappable,
...
public:
    ...
    FileSystemDirectoryIterator(FileSystemDirectoryHandle* directory, Mode mode, ExecutionContext* execution_context);
...
private:
    ...
    HeapMojoReceiver<mojom::blink::FileSystemAccessDirectoryEntriesListener, FileSystemDirectoryIterator> receiver_;
};
