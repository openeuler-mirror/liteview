...
void Reject(ScriptPromiseResolver* resolver, const mojom::blink::FileSystemAccessError& error)
{
    DCHECK_NE(error.status, mojom::blink::FileSystemAccessStatus::kOk);
    ResolveOrReject(resolver, error);
}

void ResolveOrReject(ScriptPromiseResolver* resolver, const mojom::blink::FileSystemAccessError& error)
{
    ...
    case mojom::blink::FileSystemAccessStatus::kPermissionDenied:
        resolver->Reject(V8ThrowDOMException::CreateOrEmpty(isolate, DOMExceptionCode::kNotAllowedError, message));
        break;
    case mojom::blink::FileSystemAccessStatus::kNoModificationAllowedError:
        resolver->Reject(V8ThrowDOMException::CreateOrEmpty(isolate, DOMExceptionCode::kNoModificationAllowedError, message));
        break;
    case mojom::blink::FileSystemAccessStatus::kSecurityError:
        resolver->Reject(V8ThrowDOMException::CreateOrEmpty(isolate, DOMExceptionCode::kSecurityError, message));
        break;
    case mojom::blink::FileSystemAccessStatus::kInvalidState:
        resolver->Reject(V8ThrowDOMException::CreateOrEmpty(isolate, DOMExceptionCode::kInvalidStateError, message));
        break;
    ...
    case mojom::blink::FileSystemAccessStatus::kOperationAborted:
        resolver->Reject(V8ThrowDOMException::CreateOrEmpty(isolate, DOMExceptionCode::kAbortError, message));
        break;
