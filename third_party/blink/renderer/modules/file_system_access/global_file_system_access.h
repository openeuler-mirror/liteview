...
public:
    static ScriptPromise showOpenFilePicker(ScriptState*, LocalDOMWindow&, const OpenFilePickerOptions*, ExceptionState&);
    static ScriptPromise showSaveFilePicker(ScriptState*, LocalDOMWindow&, const SaveFilePickerOptions*, ExceptionState&);
    static ScriptPromise showDirectoryPicker(ScriptState*, LocalDOMWindow&, const DirectoryPickerOptions*, ExceptionState&);
};
