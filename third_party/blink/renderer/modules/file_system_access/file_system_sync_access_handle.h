...
public:
    explicit FileSystemSyncAccessHandle(ExecutionContext* context, FileSystemAccessFileDelegate* file_delegate,
        mojo::PendingRemote<mojom::blink::FileSystemAccessAccessHandleHost> access_handle_host);
    ...
    uint64_t read(MaybeShared<DOMArrayBufferView> buffer, FileSystemReadWriteOptions* options, ExceptionState&);

    uint64_t write(MaybeShared<DOMArrayBufferView> buffer, FileSystemReadWriteOptions* options, ExceptionState&);
...
private:
    ...
    uint64_t DoRead(MaybeShared<DOMArrayBufferView> buffer, FileSystemReadWriteOptions* options, ExceptionState&);
    uint64_t DoWrite(MaybeShared<DOMArrayBufferView> buffer, FileSystemReadWriteOptions* options, ExceptionState&);
    ...
    public:
        ...
        bool entered_operation() const
        {
            return entered_operation_;
        }
    ...
    const bool is_all_sync_interface_enabled_ = base::FeatureList::IsEnabled(blink::features::kSyncAccessHandleAllSyncSurface)
        && !RuntimeEnabledFeatures::FileSystemSyncAccessHandleAsyncInterfaceOverrideEnabled();
