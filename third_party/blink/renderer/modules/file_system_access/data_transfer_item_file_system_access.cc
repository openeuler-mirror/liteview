...
// static
ScriptPromise DataTransferItemFileSystemAccess::getAsFileSystemHandle(ScriptState* script_state, DataTransferItem& data_transfer_item)
{
    ...
    execution_context->GetBrowserInterfaceBroker().GetInterface(fsa_manager.BindNewPipeAndPassReceiver());
    ...
    raw_fsa_manager->GetEntryFromDataTransferToken(std::move(token_remote),
        WTF::BindOnce(
            [](mojo::Remote<mojom::blink::FileSystemAccessManager>, ScriptPromiseResolver* resolver, mojom::blink::FileSystemAccessErrorPtr result,
