...
public:
    MockFileSystemAccessManager(BrowserInterfaceBrokerProxy& broker, base::OnceClosure reached_callback)
    ...
    void ChooseEntries(
        mojom::blink::FilePickerOptionsPtr options, mojom::blink::CommonFilePickerOptionsPtr common_options, ChooseEntriesCallback callback) override
    {
...
public:
    ...
    void Navigate(const String& destinationUrl)
    {
        ...
        auto navigation_params = WebNavigationParams::CreateWithHTMLBufferForTesting(SharedBuffer::Create(), url);
