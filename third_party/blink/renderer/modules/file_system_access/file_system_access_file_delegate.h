...
public:
    ...
    virtual base::FileErrorOr<int> Write(int64_t offset, const base::span<uint8_t> data) = 0;
    ...
    virtual void GetLengthAsync(base::OnceCallback<void(base::FileErrorOr<int64_t>)> callback) = 0;
    ...
    virtual void SetLengthAsync(int64_t length, base::OnceCallback<void(base::File::Error)> callback) = 0;
