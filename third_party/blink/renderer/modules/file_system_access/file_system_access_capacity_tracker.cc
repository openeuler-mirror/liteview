...
FileSystemAccessCapacityTracker::FileSystemAccessCapacityTracker(ExecutionContext* context,
    mojo::PendingRemote<mojom::blink::FileSystemAccessCapacityAllocationHost> capacity_allocation_host_remote, int64_t file_size,
...
{
    capacity_allocation_host_.Bind(std::move(capacity_allocation_host_remote), task_runner_);
...
void FileSystemAccessCapacityTracker::RequestFileCapacityChange(int64_t required_capacity, base::OnceCallback<void(bool)> callback)
{
    ...
    capacity_allocation_host_->RequestCapacityChange(capacity_delta,
...
bool FileSystemAccessCapacityTracker::RequestFileCapacityChangeSync(int64_t required_capacity)
{
    ...
    bool call_succeeded = capacity_allocation_host_->RequestCapacityChange(capacity_delta, &granted_capacity);
