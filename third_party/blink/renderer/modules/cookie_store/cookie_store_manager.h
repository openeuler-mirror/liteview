...
public:
    ...
    ScriptPromise subscribe(ScriptState* script_state, const HeapVector<Member<CookieStoreGetOptions>>& subscriptions, ExceptionState& exception_state);
    ScriptPromise unsubscribe(ScriptState* script_state, const HeapVector<Member<CookieStoreGetOptions>>& subscription, ExceptionState& exception_state);
    ScriptPromise getSubscriptions(ScriptState* script_state, ExceptionState& exception_state);
...
private:
    ...
    void OnGetSubscriptionsResult(ScriptPromiseResolver* resolver, Vector<mojom::blink::CookieChangeSubscriptionPtr> backend_result, bool backend_success);
