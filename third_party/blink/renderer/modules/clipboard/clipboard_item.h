...
public:
    static ClipboardItem* Create(const HeapVector<std::pair<String, ScriptPromise>>& items, ExceptionState& exception_state);

    explicit ClipboardItem(const HeapVector<std::pair<String, ScriptPromise>>& items);
    Vector<String> types() const;
    ScriptPromise getType(ScriptState* script_state, const String& type, ExceptionState& exception_state) const;
