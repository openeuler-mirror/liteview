...
class ClipboardPromise final : public GarbageCollected<ClipboardPromise>, public ExecutionContextLifecycleObserver {
public:
    ...
    static ScriptPromise CreateForWrite(ExecutionContext*, ScriptState*, const HeapVector<Member<ClipboardItem>>&);
    static ScriptPromise CreateForWriteText(ExecutionContext*, ScriptState*, const String&);
...
private:
    ...
    HeapVector<std::pair<String, ScriptPromise>> clipboard_item_data_with_promises_;
