...
public:
    ...
    static MLOperand* ValidateAndCreateInput(
        MLGraphBuilder* builder, const V8MLOperandType::Enum type, Vector<uint32_t> dimensions, String name, String& error_message);
    static MLOperand* ValidateAndCreateConstant(MLGraphBuilder* builder, const V8MLOperandType::Enum type, Vector<uint32_t> dimensions,
        const DOMArrayBufferView* array_buffer_view, String& error_message);
    static MLOperand* ValidateAndCreateOutput(
    ...
    MLOperand(MLGraphBuilder* builder, OperandKind kind, const V8MLOperandType::Enum type, Vector<uint32_t> dimensions);
