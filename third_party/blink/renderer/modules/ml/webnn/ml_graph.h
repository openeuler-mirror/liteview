...
protected:
    ...
    void BuildAsync(const MLNamedOperands& named_outputs, ScriptPromiseResolver* resolver);
    ...
    virtual void BuildAsyncImpl(const MLNamedOperands& outputs, ScriptPromiseResolver* resolver) = 0;
...
private:
    ...
    bool ValidateAndInitializeResourcesInfo(const MLNamedOperands& named_outputs, String& error_message);
};
