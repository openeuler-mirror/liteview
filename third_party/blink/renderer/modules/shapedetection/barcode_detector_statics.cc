...
ScriptPromise BarcodeDetectorStatics::EnumerateSupportedFormats(ScriptState* script_state)
{
...
void BarcodeDetectorStatics::OnEnumerateSupportedFormats(ScriptPromiseResolver* resolver, const Vector<shape_detection::mojom::blink::BarcodeFormat>& formats)
{
