...
public:
    ...
    ScriptPromise detect(ScriptState* script_state, const V8ImageBitmapSource* image_source, ExceptionState&);

private:
    ScriptPromise DetectShapesOnImageData(ScriptState*, ImageData*, ExceptionState&);
    ScriptPromise DetectShapesOnImageElement(ScriptState*, const HTMLImageElement*, ExceptionState&);
