...
ScriptPromise BarcodeDetector::DoDetect(ScriptState* script_state, SkBitmap bitmap, ExceptionState& exception_state)
{
    if (!service_.is_bound()) {
        exception_state.ThrowDOMException(DOMExceptionCode::kNotSupportedError, "Barcode detection service unavailable.");
...
void BarcodeDetector::OnDetectBarcodes(
    ScriptPromiseResolver* resolver, Vector<shape_detection::mojom::blink::BarcodeDetectionResultPtr> barcode_detection_results)
{
