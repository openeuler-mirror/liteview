...
GamepadAxisEvent::GamepadAxisEvent(const AtomicString& type, Bubbles bubbles, Cancelable cancelable, Gamepad* gamepad, uint32_t axis, double value)
...
GamepadAxisEvent::GamepadAxisEvent(const AtomicString& type, const GamepadAxisEventInit* initializer)
