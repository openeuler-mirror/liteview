...
GamepadButtonEvent::GamepadButtonEvent(const AtomicString& type, Bubbles bubbles, Cancelable cancelable, Gamepad* gamepad, uint32_t button, double value)
...
GamepadButtonEvent::GamepadButtonEvent(const AtomicString& type, const GamepadButtonEventInit* initializer)
