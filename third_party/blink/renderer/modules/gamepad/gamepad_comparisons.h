...
private:
    ...
    std::bitset<device::Gamepad::kAxesLengthCap> axis_changed_[device::Gamepads::kItemsLengthCap];
    std::bitset<device::Gamepad::kButtonsLengthCap> button_changed_[device::Gamepads::kItemsLengthCap];
    std::bitset<device::Gamepad::kButtonsLengthCap> button_down_[device::Gamepads::kItemsLengthCap];
    std::bitset<device::Gamepad::kButtonsLengthCap> button_up_[device::Gamepads::kItemsLengthCap];
};
