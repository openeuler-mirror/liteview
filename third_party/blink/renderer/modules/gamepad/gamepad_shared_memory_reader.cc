...
void GamepadSharedMemoryReader::Start(blink::GamepadListener* listener)
{
    ...
    CHECK(memory);
    gamepad_hardware_buffer_ = static_cast<const device::GamepadHardwareBuffer*>(memory);
}
...
void GamepadSharedMemoryReader::GamepadChanged(device::mojom::blink::GamepadChangesPtr change)
{
