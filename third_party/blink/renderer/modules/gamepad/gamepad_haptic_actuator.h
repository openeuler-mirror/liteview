...
public:
    ...
    ScriptPromise playEffect(ScriptState*, const String&, const GamepadEffectParameters*);
...
private:
    void OnPlayEffectCompleted(ScriptPromiseResolver*, device::mojom::GamepadHapticsResult);
    void OnResetCompleted(ScriptPromiseResolver*, device::mojom::GamepadHapticsResult);
