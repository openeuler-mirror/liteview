...
class MODULES_EXPORT PaintRenderingContext2D : public ScriptWrappable, public BaseRenderingContext2D {
    DEFINE_WRAPPERTYPEINFO();

public:
    PaintRenderingContext2D(const gfx::Size& container_size, const PaintRenderingContext2DSettings*, float zoom, float device_scale_factor,
    ...
    cc::PaintCanvas* GetPaintCanvasForDraw(const SkIRect&, CanvasPerformanceMonitor::DrawType) final;
