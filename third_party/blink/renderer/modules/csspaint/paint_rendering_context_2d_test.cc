...
{
    ctx->setStrokeStyle(MakeGarbageCollected<V8UnionCSSColorValueOrCanvasGradientOrCanvasPatternOrString>("red"));
...
TEST(PaintRenderingContext2DTest, testParseColorOrCurrentColor)
{
    ...
    PaintRenderingContext2D* ctx
        = MakeGarbageCollected<PaintRenderingContext2D>(gfx::Size(kWidth, kHeight), context_settings, kZoom, 1.0 /* device_scale_factor */);
...
TEST(PaintRenderingContext2DTest, setTransformWithDeviceScaleFactor)
{
    ...
    PaintRenderingContext2D* ctx = MakeGarbageCollected<PaintRenderingContext2D>(gfx::Size(kWidth, kHeight), context_settings, kZoom, device_scale_factor);
