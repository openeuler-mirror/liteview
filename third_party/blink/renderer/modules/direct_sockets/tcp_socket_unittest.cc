...
TEST(TCPSocketTest, CloseBeforeInit)
{
    ...
    auto close_promise = tcp_socket->close(script_state, scope.GetExceptionState());
...
TEST(TCPSocketTest, CloseAfterInitWithoutResultOK)
{
    ...
    tcp_socket->Init(net::ERR_FAILED, net::IPEndPoint(), net::IPEndPoint(), mojo::ScopedDataPipeConsumerHandle(), mojo::ScopedDataPipeProducerHandle());
...
TEST(TCPSocketTest, CloseAfterInitWithResultOK)
{
    ...
    tcp_socket->Init(net::OK, net::IPEndPoint { net::IPAddress::IPv4Localhost(), 0 }, net::IPEndPoint { net::IPAddress::IPv4Localhost(), 0 },
