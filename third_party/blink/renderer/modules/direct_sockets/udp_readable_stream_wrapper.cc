    ...
    , udp_socket_(udp_socket)
{
    InitSourceAndReadable(
        /*source=*/MakeGarbageCollected<UnderlyingSource>(GetScriptState(), this), kReadableStreamBufferSize);
}
...
bool UDPReadableStreamWrapper::Push(base::span<const uint8_t> data, const absl::optional<net::IPEndPoint>& src_addr)
{
