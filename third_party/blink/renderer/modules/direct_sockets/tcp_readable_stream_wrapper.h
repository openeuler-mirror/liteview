...
class MODULES_EXPORT TCPReadableStreamWrapper : public GarbageCollected<TCPReadableStreamWrapper>, public ReadableStreamWrapper {
...
public:
    ...
    void Pull() override;
    bool Push(base::span<const uint8_t> data, const absl::optional<net::IPEndPoint>&) override;
