...
class MODULES_EXPORT DirectSocketsServiceMojoRemote : public GarbageCollected<DirectSocketsServiceMojoRemote> {
public:
    static DirectSocketsServiceMojoRemote* Create(ExecutionContext*, base::OnceClosure disconnect_handler);
