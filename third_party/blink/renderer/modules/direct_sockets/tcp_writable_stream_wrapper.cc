...
ScriptPromise TCPWritableStreamWrapper::Write(ScriptValue chunk, ExceptionState& exception_state)
{
...
void TCPWritableStreamWrapper::ErrorStream(int32_t error_code)
{
    ...
    auto exception = ScriptValue::From(script_state, V8ThrowDOMException::CreateOrDie(script_state->GetIsolate(), DOMExceptionCode::kNetworkError, message));
