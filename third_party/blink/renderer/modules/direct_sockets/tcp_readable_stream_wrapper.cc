...
void TCPReadableStreamWrapper::Pull()
{
    ...
    switch (result) {
    case MOJO_RESULT_OK: {
        Push(base::make_span(static_cast<const uint8_t*>(buffer), buffer_num_bytes), {});
...
bool TCPReadableStreamWrapper::Push(base::span<const uint8_t> data, const absl::optional<net::IPEndPoint>&)
{
