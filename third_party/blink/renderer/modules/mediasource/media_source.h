...
class MediaSource final : public EventTargetWithInlineData, public ActiveScriptWrappable<MediaSource>, public ExecutionContextLifecycleObserver {
...
public:
    ...
    void endOfStream(const AtomicString& error, ExceptionState&) LOCKS_EXCLUDED(attachment_link_lock_);
