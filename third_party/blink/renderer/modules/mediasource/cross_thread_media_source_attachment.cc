...
{
    DVLOG(1) << __func__ << " this=" << this << ", IsMainThread=" << IsMainThread();
    ...
    // here).
    {
        ...
        DCHECK(!RuntimeEnabledFeatures::MediaSourceInWorkersUsingHandleEnabled(registered_media_source_->GetExecutionContext()));
        ...
        DCHECK(IsMainThread() || RuntimeEnabledFeatures::MediaSourceInWorkersEnabled(registered_media_source_->GetExecutionContext()));
...
MediaSourceTracer* CrossThreadMediaSourceAttachment::StartAttachingToMediaElement(HTMLMediaElement* element, bool* success)
{
...

    {
        ...
        if (have_ever_attached_) {
            if (RuntimeEnabledFeatures::MediaSourceInWorkersUsingHandleEnabled(element->GetExecutionContext())) {
