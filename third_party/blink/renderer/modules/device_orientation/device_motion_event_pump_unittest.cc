...
TEST_F(DeviceMotionEventPumpTest, AllSensorsAreActive)
{
    ...
    EXPECT_EQ(gfx::RadToDeg(7.0), received_data->GetRotationRate()->alpha().value());
    EXPECT_EQ(gfx::RadToDeg(8.0), received_data->GetRotationRate()->beta().value());
    EXPECT_EQ(gfx::RadToDeg(9.0), received_data->GetRotationRate()->gamma().value());
