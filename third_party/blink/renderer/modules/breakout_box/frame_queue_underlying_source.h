...
class FrameQueueUnderlyingSource : public UnderlyingSourceBase, public ActiveScriptWrappable<FrameQueueUnderlyingSource<NativeFrameType>> {
public:
...
private:
    ...
    NewFrameAction AnalyzeNewFrameLocked(const NativeFrameType& media_frame, const absl::optional<NativeFrameType>& old_frame);
