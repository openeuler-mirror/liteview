...
public:
    ...
    absl::optional<NativeFrameType> PushLocked(NativeFrameType frame) EXCLUSIVE_LOCKS_REQUIRED(GetLock())
    {
    ...
    absl::optional<NativeFrameType> PopLocked() EXCLUSIVE_LOCKS_REQUIRED(GetLock())
    {
        if (queue_.empty())
            return absl::nullopt;
    ...
    absl::optional<NativeFrameType> PeekLocked() EXCLUSIVE_LOCKS_REQUIRED(GetLock())
    {
        if (queue_.empty())
            return absl::nullopt;
        return queue_.front();
