...
public:
    MediaStreamVideoTrackUnderlyingSourceTest()
        ...
        , media_stream_source_(MakeGarbageCollected<MediaStreamSource>(
              "dummy_source_id", MediaStreamSource::kTypeVideo, "dummy_source_name", false /* remote */, base::WrapUnique(pushable_video_source_)))
    {
    }
...
protected:
    void PushFrame(const absl::optional<base::TimeDelta>& timestamp = absl::nullopt)
    {
