...
ScriptValue CreateVideoFrameChunk(ScriptState* script_state)
{
    ...
    return ScriptValue(script_state->GetIsolate(), ToV8Traits<VideoFrame>::ToV8(script_state, video_frame).ToLocalChecked());
}
...
ScriptValue CreateAudioDataChunk(ScriptState* script_state)
{
    ...
    return ScriptValue(script_state->GetIsolate(), ToV8Traits<AudioData>::ToV8(script_state, audio_data).ToLocalChecked());
}
