...
public:
    ...
    void SetDataTimeExpectation(base::TimeTicks time, media::AudioBus* expected_data, base::OnceClosure on_data)
    {
        DCHECK(!on_data_);
...
public:
        ...
        scoped_refptr<media::AudioBuffer> buffer, media::AudioBus* expected_data)
    {
        ...
        fake_sink->SetDataTimeExpectation(base::TimeTicks() + buffer->timestamp(), expected_data, run_loop.QuitClosure());
