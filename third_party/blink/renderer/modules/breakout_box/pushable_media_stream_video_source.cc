...
void PushableMediaStreamVideoSource::Broker::PushFrame(scoped_refptr<media::VideoFrame> video_frame, base::TimeTicks estimated_capture_time)
{
    ...
    PostCrossThreadTask(*io_task_runner_, FROM_HERE,
        CrossThreadBindOnce(frame_callback_, std::move(video_frame), std::vector<scoped_refptr<media::VideoFrame>>(), estimated_capture_time));
}
...
void PushableMediaStreamVideoSource::SetCanDiscardAlpha(bool can_discard_alpha)
{
