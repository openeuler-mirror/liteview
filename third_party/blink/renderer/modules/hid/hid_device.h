...
class MODULES_EXPORT HIDDevice : public EventTargetWithInlineData,
...
public:
    ...
    ScriptPromise open(ScriptState* script_state, ExceptionState& exception_state);
    ScriptPromise close(ScriptState*);
    ScriptPromise forget(ScriptState*, ExceptionState& exception_state);
    ScriptPromise sendReport(ScriptState*, uint8_t report_id, const DOMArrayPiece& data);
    ScriptPromise sendFeatureReport(ScriptState*, uint8_t report_id, const DOMArrayPiece& data);
...
private:
    ...
    void FinishOpen(ScriptPromiseResolver*, mojo::PendingRemote<device::mojom::blink::HidConnection>);
    void FinishForget(ScriptPromiseResolver*);
    void FinishSendReport(ScriptPromiseResolver*, bool success);
    void FinishReceiveReport(ScriptPromiseResolver*, bool success, uint8_t report_id, const absl::optional<Vector<uint8_t>>&);
    void FinishSendFeatureReport(ScriptPromiseResolver*, bool success);
    void FinishReceiveFeatureReport(ScriptPromiseResolver*, bool success, const absl::optional<Vector<uint8_t>>&);
