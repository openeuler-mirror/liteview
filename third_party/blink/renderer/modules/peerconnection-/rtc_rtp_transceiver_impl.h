...
public:
    RtpTransceiverState(scoped_refptr<base::SingleThreadTaskRunner> main_task_runner, scoped_refptr<base::SingleThreadTaskRunner> signaling_task_runner,
        scoped_refptr<webrtc::RtpTransceiverInterface> webrtc_transceiver, absl::optional<blink::RtpSenderState> sender_state,
        absl::optional<blink::RtpReceiverState> receiver_state, absl::optional<std::string> mid, webrtc::RtpTransceiverDirection direction,
        absl::optional<webrtc::RtpTransceiverDirection> current_direction, absl::optional<webrtc::RtpTransceiverDirection> fired_direction,
...
public:
    ...
    RTCRtpTransceiverImpl(scoped_refptr<webrtc::PeerConnectionInterface> native_peer_connection,
