...
public:
    ...
    RTCRtpReceiver(RTCPeerConnection*, std::unique_ptr<RTCRtpReceiverPlatform>, MediaStreamTrack*, MediaStreamVector, bool encoded_insertable_streams);
...
private:
    ...
    void OnAudioFrameFromDepacketizer(std::unique_ptr<webrtc::TransformableFrameInterface> encoded_audio_frame);
    ...
    Member<RTCEncodedVideoUnderlyingSource> video_from_depacketizer_underlying_source_;
