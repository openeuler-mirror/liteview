...
public:
    ...
    // Ctors for tests.
    PeerConnectionTracker(mojo::Remote<mojom::blink::PeerConnectionTrackerHost> host, scoped_refptr<base::SingleThreadTaskRunner> main_thread_task_runner,
    ...
    virtual void TrackIceCandidateError(RTCPeerConnectionHandler* pc_handler, const String& address, absl::optional<uint16_t> port,
...
private:
    ...
    mojo::Remote<blink::mojom::blink::PeerConnectionTrackerHost> peer_connection_tracker_host_;
