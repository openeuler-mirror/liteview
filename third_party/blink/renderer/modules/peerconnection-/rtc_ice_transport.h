...
class MODULES_EXPORT RTCIceTransport final : public EventTargetWithInlineData,
...
public:
    ...
    static RTCIceTransport* Create(ExecutionContext* context, scoped_refptr<base::SingleThreadTaskRunner> proxy_thread,
    ...
    void start(RTCIceParameters* raw_remote_parameters, const String& role, ExceptionState& exception_state);
    void stop();
    void addRemoteCandidate(RTCIceCandidate* remote_candidate, ExceptionState& exception_state);
