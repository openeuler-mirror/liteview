...
public:
    ...
    const webrtc::IceCandidateCollection* candidates(size_t mediasection_index) const override
    {
        NOTIMPLEMENTED();
        return nullptr;
    }
...
public:
    ...
    bool Initialize(ExecutionContext* context, const webrtc::PeerConnectionInterface::RTCConfiguration&, GoogMediaConstraints* media_constraints,
        WebLocalFrame*, ExceptionState&) override;
    void Close() override;
    ...
    scoped_refptr<webrtc::DataChannelInterface> CreateDataChannel(const String& label, const webrtc::DataChannelInit&) override;
