...
public:
    ...
    absl::optional<int32_t> sdpLineNumber() const
    {
    ...
    absl::optional<int32_t> sctpCauseCode() const
    {
        return sctp_cause_code_;
    }
    absl::optional<uint32_t> receivedAlert() const
    {
        return received_alert_;
    }
    absl::optional<uint32_t> sentAlert() const
    {
        return sent_alert_;
    }
