...
v8::Local<v8::Object> RTCStatsToV8Object(ScriptState* script_state, const RTCStats* stats)
{
    V8ObjectBuilder builder(script_state);
    ...
    for (size_t i = 0; i < stats->MembersCount(); ++i) {
        ...
        case webrtc::RTCStatsMemberInterface::kMapStringUint64:
            builder.Add(name, HashMapToValue(script_state, member->ValueMapStringUint64()));
            break;
        case webrtc::RTCStatsMemberInterface::kMapStringDouble:
            builder.Add(name, HashMapToValue(script_state, member->ValueMapStringDouble()));
            break;
        default:
            NOTREACHED();
        }
...
class RTCStatsReportIterationSource final : public PairIterable<String, IDLString, v8::Local<v8::Object>, IDLObject>::IterationSource {
public:
    ...
    bool Next(ScriptState* script_state, String& key, v8::Local<v8::Object>& value, ExceptionState& exception_state) override
    {
...
Vector<webrtc::NonStandardGroupId> GetExposedGroupIds(const ScriptState* script_state)
{
    ...
    if (RuntimeEnabledFeatures::RtcAudioJitterBufferMaxPacketsEnabled(context)) {
        enabled_origin_trials.emplace_back(webrtc::NonStandardGroupId::kRtcAudioJitterBufferMaxPackets);
    }
    if (RuntimeEnabledFeatures::RTCStatsRelativePacketArrivalDelayEnabled(context)) {
        enabled_origin_trials.emplace_back(webrtc::NonStandardGroupId::kRtcStatsRelativePacketArrivalDelay);
    }
...
PairIterable<String, IDLString, v8::Local<v8::Object>, IDLObject>::IterationSource* RTCStatsReport::StartIteration(ScriptState*, ExceptionState&)
{
    return MakeGarbageCollected<RTCStatsReportIterationSource>(report_->CopyHandle());
}

bool RTCStatsReport::GetMapEntry(ScriptState* script_state, const String& key, v8::Local<v8::Object>& value, ExceptionState&)
{
