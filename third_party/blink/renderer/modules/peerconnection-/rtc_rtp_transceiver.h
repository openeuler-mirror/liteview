...
webrtc::RtpTransceiverInit ToRtpTransceiverInit(ExecutionContext* context, const RTCRtpTransceiverInit*);
...
public:
    ...
    void setOfferedRtpHeaderExtensions(const HeapVector<Member<RTCRtpHeaderExtensionCapability>>& header_extensions_to_offer, ExceptionState& exception_state);
    HeapVector<Member<RTCRtpHeaderExtensionCapability>> headerExtensionsToOffer() const;
    HeapVector<Member<RTCRtpHeaderExtensionCapability>> headerExtensionsNegotiated() const;
