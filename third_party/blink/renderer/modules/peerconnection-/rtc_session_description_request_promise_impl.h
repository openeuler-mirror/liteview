...
public:
    static RTCSessionDescriptionRequestPromiseImpl* Create(RTCPeerConnection*, ScriptPromiseResolver*, const char* interface_name, const char* property_name);

    RTCSessionDescriptionRequestPromiseImpl(RTCPeerConnection*, ScriptPromiseResolver*, const char* interface_name, const char* property_name);
