...
class RTCStatsReport final : public ScriptWrappable, public Maplike<String, IDLString, v8::Local<v8::Object>, IDLObject> {
...
public:
    ...
    PairIterable<String, IDLString, v8::Local<v8::Object>, IDLObject>::IterationSource* StartIteration(ScriptState*, ExceptionState&) override;
    bool GetMapEntry(ScriptState*, const String& key, v8::Local<v8::Object>&, ExceptionState&) override;
