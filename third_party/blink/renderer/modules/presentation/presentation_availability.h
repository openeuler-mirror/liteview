...
class MODULES_EXPORT PresentationAvailability final : public EventTargetWithInlineData,
...
public:
    static PresentationAvailability* Take(PresentationAvailabilityProperty*, const WTF::Vector<KURL>&, bool);
