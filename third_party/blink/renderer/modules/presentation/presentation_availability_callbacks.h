...
class MODULES_EXPORT PresentationAvailabilityCallbacks : public GarbageCollected<PresentationAvailabilityCallbacks> {
public:
    PresentationAvailabilityCallbacks(PresentationAvailabilityProperty*, const WTF::Vector<KURL>&);

    PresentationAvailabilityCallbacks(const PresentationAvailabilityCallbacks&) = delete;
    PresentationAvailabilityCallbacks& operator=(const PresentationAvailabilityCallbacks&) = delete;
