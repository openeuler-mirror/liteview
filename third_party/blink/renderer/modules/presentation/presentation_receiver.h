...
class MODULES_EXPORT PresentationReceiver final : public ScriptWrappable, public mojom::blink::PresentationReceiver {
    ...
    using ConnectionListProperty = ScriptPromiseProperty<Member<PresentationConnectionList>, Member<DOMException>>;
...
public:
    ...
    void OnReceiverConnectionAvailable(mojom::blink::PresentationInfoPtr, mojo::PendingRemote<mojom::blink::PresentationConnection>,
