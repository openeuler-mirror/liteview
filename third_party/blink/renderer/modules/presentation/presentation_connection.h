...
class MODULES_EXPORT PresentationConnection : public EventTargetWithInlineData,
...
public:
    ...
    static ControllerPresentationConnection* Take(ScriptPromiseResolver*, const mojom::blink::PresentationInfo&, PresentationRequest*);
