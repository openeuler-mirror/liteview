...
public:
    NativeIOFileSync(base::File backing_file, int64_t backing_file_size, HeapMojoRemote<mojom::blink::NativeIOFileHost> backend_file,
    ...
    NativeIOReadResult* read(ScriptState* script_state, NotShared<DOMArrayBufferView> buffer, uint64_t file_offset, ExceptionState&);
    NativeIOWriteResult* write(ScriptState* script_state, NotShared<DOMArrayBufferView> buffer, uint64_t file_offset, ExceptionState&);
