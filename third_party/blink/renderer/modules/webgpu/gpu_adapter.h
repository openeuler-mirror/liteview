...
public:
    GPUAdapter(GPU* gpu, const String& name, WGPUAdapter handle, scoped_refptr<DawnControlClientHolder> dawn_control_client);
    ...
    ScriptPromise requestDevice(ScriptState* script_state, GPUDeviceDescriptor* descriptor);

    ScriptPromise requestAdapterInfo(ScriptState* script_state, const Vector<String>& unmask_hints);
...
private:
    void OnRequestDeviceCallback(ScriptState* script_state, ScriptPromiseResolver* resolver, const GPUDeviceDescriptor* descriptor,
