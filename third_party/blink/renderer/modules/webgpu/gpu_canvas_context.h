...
public:
    ...
    bool CopyRenderingResultsFromDrawingBuffer(CanvasResourceProvider*, SourceDrawingBuffer) final;
    ...
    void unconfigure();
    String getPreferredFormat(ExecutionContext* execution_context, GPUAdapter* adapter);
...
private:
    ...
    scoped_refptr<StaticBitmapImage> SnapshotInternal(const WGPUTexture& texture, const gfx::Size& size) const;

    bool CopyTextureToResourceProvider(const WGPUTexture& texture, const gfx::Size& size, CanvasResourceProvider* resource_provider) const;
