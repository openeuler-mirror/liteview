...
WGPUExtent3D AsDawnType(const V8GPUExtent3D* webgpu_extent)
{
    ...
    case V8GPUExtent3D::ContentType::kGPUExtent3DDict: {
        const GPUExtent3DDict* webgpu_extent_3d_dict = webgpu_extent->GetAsGPUExtent3DDict();
        dawn_extent.width = webgpu_extent_3d_dict->width();
        dawn_extent.height = webgpu_extent_3d_dict->height();
        dawn_extent.depthOrArrayLayers = webgpu_extent_3d_dict->depthOrArrayLayers();
        break;
    }
    case V8GPUExtent3D::ContentType::kUnsignedLongEnforceRangeSequence: {
        const Vector<uint32_t>& webgpu_extent_sequence = webgpu_extent->GetAsUnsignedLongEnforceRangeSequence();
...
WGPUOrigin3D AsDawnType(const V8GPUOrigin3D* webgpu_origin)
{
    ...
    case V8GPUOrigin3D::ContentType::kGPUOrigin3DDict: {
        const GPUOrigin3DDict* webgpu_origin_3d_dict = webgpu_origin->GetAsGPUOrigin3DDict();
...
const char* ValidateTextureDataLayout(const GPUImageDataLayout* webgpu_layout, WGPUTextureDataLayout* dawn_layout)
{
...
WGPUPipelineLayout AsDawnType(V8UnionGPUAutoLayoutModeOrGPUPipelineLayout* webgpu_layout)
{
    DCHECK(webgpu_layout);
