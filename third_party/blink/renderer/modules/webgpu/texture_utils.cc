...
TexelBlockInfo GetTexelBlockInfoForCopy(WGPUTextureFormat format, WGPUTextureAspect aspect)
{
...
size_t EstimateWriteTextureBytesUpperBound(WGPUTextureDataLayout layout, WGPUExtent3D extent, WGPUTextureFormat format, WGPUTextureAspect aspect)
{
