...
WGPUStorageTextureAccess AsDawnEnum(const V8GPUStorageTextureAccess& webgpu_enum)
{
    switch (webgpu_enum.AsEnum()) {
...
WGPUTextureComponentType AsDawnEnum(const V8GPUTextureComponentType& webgpu_enum)
{
    switch (webgpu_enum.AsEnum()) {
...
WGPUPipelineStatisticName AsDawnEnum(const V8GPUPipelineStatisticName& webgpu_enum)
{
    switch (webgpu_enum.AsEnum()) {
...
WGPUTextureViewDimension AsDawnEnum(const V8GPUTextureViewDimension& webgpu_enum)
{
    switch (webgpu_enum.AsEnum()) {
...
WGPUComputePassTimestampLocation AsDawnEnum(const V8GPUComputePassTimestampLocation& webgpu_enum)
{
    switch (webgpu_enum.AsEnum()) {
...
WGPURenderPassTimestampLocation AsDawnEnum(const V8GPURenderPassTimestampLocation& webgpu_enum)
{
    switch (webgpu_enum.AsEnum()) {
