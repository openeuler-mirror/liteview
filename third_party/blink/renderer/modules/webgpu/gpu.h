...
public:
    ...
    void insert(WGPUBuffer buffer)
    {
        contents_.insert(buffer);
    }

    // Basic typed wrapper around |contents_|.
    void erase(WGPUBuffer buffer)
    {
...
public:
    ...
    // gpu.idl
    ScriptPromise requestAdapter(ScriptState* script_state, const GPURequestAdapterOptions* options);
...
private:
    void OnRequestAdapterCallback(ScriptState* script_state, const GPURequestAdapterOptions* options, ScriptPromiseResolver* resolver,
