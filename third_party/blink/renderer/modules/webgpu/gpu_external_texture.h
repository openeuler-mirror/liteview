...
public:
    static GPUExternalTexture* Create(GPUDevice* device, const GPUExternalTextureDescriptor* webgpu_desc, ExceptionState& exception_state);
    static GPUExternalTexture* CreateExpired(GPUDevice* device, const GPUExternalTextureDescriptor* webgpu_desc, ExceptionState& exception_state);
    explicit GPUExternalTexture(GPUDevice* device, WGPUExternalTexture external_texture, scoped_refptr<WebGPUMailboxTexture> mailbox_texture,
...
private:
    ...
    enum class Status { ListenToHTMLVideoElement, ListenToVideoFrame, Expired, Destroyed };
    ...
    static GPUExternalTexture* CreateImpl(GPUDevice* device, const GPUExternalTextureDescriptor* webgpu_desc,
