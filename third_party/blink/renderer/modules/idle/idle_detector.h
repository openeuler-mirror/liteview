...
class MODULES_EXPORT IdleDetector final : public EventTargetWithInlineData,
...
private:
    ...
    void OnAddMonitor(ScriptPromiseResolver*, mojom::blink::IdleManagerError, mojom::blink::IdleStatePtr);
