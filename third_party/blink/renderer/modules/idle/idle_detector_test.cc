...
public:
    ...
    void SetState(absl::optional<base::TimeDelta> idle_time, bool screen_locked, bool override = false)
    {
...
TEST(IdleDetectorTest, Start)
{
    ...
    ScriptPromise start_promise = detector->start(scope.GetScriptState(), options, scope.GetExceptionState());
