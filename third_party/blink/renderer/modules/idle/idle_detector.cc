...
public:
    ...
    void Run() override
    {
        idle_detector_->Abort(abort_signal_);
    }
...
// static
ScriptPromise IdleDetector::requestPermission(ScriptState* script_state, ExceptionState& exception_state)
{
...
ScriptPromise IdleDetector::start(ScriptState* script_state, const IdleOptions* options, ExceptionState& exception_state)
{
    ...
    if (options->hasSignal()) {
        ...
        signal_->AddAlgorithm(MakeGarbageCollected<StartAbortAlgorithm>(this, signal_));
    }
...
void IdleDetector::OnAddMonitor(ScriptPromiseResolver* resolver, IdleManagerError error, mojom::blink::IdleStatePtr state)
{
