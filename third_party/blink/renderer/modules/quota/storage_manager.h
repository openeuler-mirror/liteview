...
class StorageManager final : public EventTargetWithInlineData, public ExecutionContextClient, public mojom::blink::QuotaChangeListener {
...
private:
    ...
    HeapMojoReceiver<mojom::blink::QuotaChangeListener, StorageManager> change_listener_receiver_;
};
