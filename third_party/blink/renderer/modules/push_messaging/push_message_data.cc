...
PushMessageData* PushMessageData::Create(const V8UnionArrayBufferOrArrayBufferViewOrUSVString* message_data)
{
    ...
    case V8UnionArrayBufferOrArrayBufferViewOrUSVString::ContentType::kArrayBuffer: {
        ...
        return MakeGarbageCollected<PushMessageData>(static_cast<const char*>(buffer->Data()), base::checked_cast<wtf_size_t>(buffer->ByteLength()));
    }
    case V8UnionArrayBufferOrArrayBufferViewOrUSVString::ContentType::kArrayBufferView: {
        ...
        return MakeGarbageCollected<PushMessageData>(
            static_cast<const char*>(buffer_view->BaseAddress()), base::checked_cast<wtf_size_t>(buffer_view->byteLength()));
    }
    case V8UnionArrayBufferOrArrayBufferViewOrUSVString::ContentType::kUSVString: {
        ...
        return MakeGarbageCollected<PushMessageData>(encoded_string.c_str(), static_cast<unsigned>(encoded_string.length()));
    }
    }
    NOTREACHED();
    return nullptr;
...
ScriptValue PushMessageData::json(ScriptState* script_state, ExceptionState& exception_state) const
{
    ScriptState::Scope scope(script_state);
    v8::Local<v8::Value> parsed = FromJSONString(script_state->GetIsolate(), script_state->GetContext(), text(), exception_state);
