...
public:
    ...
    void CreateDocumentPictureInPictureWindow(ScriptState*, LocalDOMWindow&, DocumentPictureInPictureOptions*, ScriptPromiseResolver*, ExceptionState&);

    // Implementation of PictureInPictureController.
    void EnterPictureInPicture(HTMLVideoElement*, ScriptPromiseResolver*) override;
...
private:
    void OnEnteredPictureInPicture(HTMLVideoElement*, ScriptPromiseResolver*, mojo::PendingRemote<mojom::blink::PictureInPictureSession>, const gfx::Size&);
    ...
    HeapMojoRemote<mojom::blink::PictureInPictureSession> video_picture_in_picture_session_;
