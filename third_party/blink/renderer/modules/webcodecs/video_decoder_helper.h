...
public:
    ...
    uint32_t CalculateNeededOutputBufferSize(const uint8_t* input, uint32_t input_size) const;
    ...
    Status ConvertNalUnitStreamToByteStream(const uint8_t* input, uint32_t input_size, uint8_t* output, uint32_t* output_size);
