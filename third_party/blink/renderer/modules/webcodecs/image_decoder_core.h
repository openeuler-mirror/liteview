...
public:
    ...
    ImageDecoderCore(String mime_type, scoped_refptr<SegmentReader> data, bool data_complete, const ColorBehavior& color_behavior, const SkISize& desired_size,
    ...
    void AppendData(size_t data_size, std::unique_ptr<uint8_t[]> data, bool data_complete);
...
private:
    ...
    HashMap<uint32_t, uint32_t, DefaultHash<uint32_t>::Hash, WTF::UnsignedWithZeroKeyHashTraits<uint32_t>> incomplete_frames_;
