...
public:
    ...
    static ScriptPromise isConfigSupported(ScriptState*, const VideoDecoderConfig*, ExceptionState&);
    ...
    static absl::optional<media::VideoType> IsValidVideoDecoderConfig(const VideoDecoderConfig& config, String* js_error_message);
...
protected:
    ...
    absl::optional<media::VideoDecoderConfig> MakeMediaConfig(const ConfigType& config, String* js_error_message) override;
...
private:
    ...
    static absl::optional<media::VideoDecoderConfig> MakeMediaVideoDecoderConfigInternal(
        const ConfigType& config, std::unique_ptr<VideoDecoderHelper>& decoder_helper, String* js_error_message, bool* needs_converter_out = nullptr);
