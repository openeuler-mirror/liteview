...
public:
    ...
    scoped_refptr<media::VideoFrame> MakeVideoFrame(const media::DecoderBuffer& buffer) override
    {
        ...
        scoped_refptr<media::VideoFrame> frame
            = media::VideoFrame::WrapNativeTextures(media::PIXEL_FORMAT_ARGB, mailbox_holders, media::VideoFrame::ReleaseMailboxCB(),
...
public:
    ...
    std::unique_ptr<media::VideoDecoder> CreateVideoDecoder(scoped_refptr<base::SingleThreadTaskRunner> task_runner, media::MediaLog* media_log,
...
public:
    VideoDecoderBrokerTest()
    {
        ...
        std::vector<base::test::FeatureRef> disabled_features { media::kForceHardwareVideoDecoders };
