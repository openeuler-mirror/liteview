...
public:
    ...
    typename T::InitType* CreateInit(v8::Local<v8::Function> output_callback, v8::Local<v8::Function> error_callback);
...
template <> AudioDecoderInit* DecoderTemplateTest<AudioDecoder>::CreateInit(v8::Local<v8::Function> output_callback, v8::Local<v8::Function> error_callback)
{
...
template <> VideoDecoderInit* DecoderTemplateTest<VideoDecoder>::CreateInit(v8::Local<v8::Function> output_callback, v8::Local<v8::Function> error_callback)
{
...
TYPED_TEST(DecoderTemplateTest, BasicConstruction)
{
    ...
    auto* decoder = this->CreateDecoder(
        v8_scope.GetScriptState(), this->CreateInit(mock_function.ExpectNoCall(), mock_function.ExpectNoCall()), v8_scope.GetExceptionState());
    ASSERT_TRUE(decoder);
