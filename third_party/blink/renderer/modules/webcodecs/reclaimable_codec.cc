...
BASE_FEATURE(kReclaimInactiveWebCodecs, "ReclaimInactiveWebCodecs", base::FEATURE_ENABLED_BY_DEFAULT);

BASE_FEATURE(kOnlyReclaimBackgroundWebCodecs, "OnlyReclaimBackgroundWebCodecs", base::FEATURE_ENABLED_BY_DEFAULT);
