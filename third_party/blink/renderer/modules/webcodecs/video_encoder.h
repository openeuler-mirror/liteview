...
public:
    ...
    static ScriptPromise isConfigSupported(ScriptState*, const VideoEncoderConfig*, ExceptionState&);
...
protected:
    ...
    void OnReadbackDone(bool keyframe, uint32_t reset_count, scoped_refptr<media::VideoFrame> txt_frame, media::VideoEncoder::EncoderStatusCB done_callback,
        scoped_refptr<media::VideoFrame> result_frame);
    void OnMediaEncoderCreated(std::string encoder_name, bool is_hw_accelerated);
    static std::unique_ptr<media::VideoEncoder> CreateSoftwareVideoEncoder(VideoEncoder* self, media::VideoCodec codec);
    ...
    // Virtual for UTs.
    virtual std::unique_ptr<media::VideoEncoder> CreateMediaVideoEncoder(const ParsedConfig& config, media::GpuVideoAcceleratorFactories* gpu_factories);
