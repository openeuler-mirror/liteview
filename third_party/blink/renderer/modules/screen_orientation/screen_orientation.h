...
class MODULES_EXPORT ScreenOrientation final : public EventTargetWithInlineData, public ExecutionContextClient {
...
public:
    ...
    ScriptPromise lock(ScriptState*, const AtomicString& orientation, ExceptionState&);
    void unlock();

    DEFINE_ATTRIBUTE_EVENT_LISTENER(change, kChange)

    // Helper being used by this class and LockOrientationCallback.
    static const AtomicString& OrientationTypeToString(display::mojom::blink::ScreenOrientation);
