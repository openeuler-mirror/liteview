...
{
    HashMap<LockResult, blink::WebLockOrientationError, WTF::IntHash<LockResult>> errors;
...
TEST_F(ScreenOrientationControllerTest, PageVisibilityCrash)
{
    ...
    frame_test_helpers::CreateTestWebFrameWidgetCallback create_widget_callback
        = base::BindRepeating(&frame_test_helpers::WebViewHelper::CreateTestWebFrameWidget<ScreenInfoWebFrameWidget>);
