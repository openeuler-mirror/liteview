...
class AudioParamMap final : public ScriptWrappable, public Maplike<String, IDLString, AudioParam*, AudioParam> {
...
private:
    PairIterable<String, IDLString, AudioParam*, AudioParam>::IterationSource* StartIteration(ScriptState*, ExceptionState&) override;
    bool GetMapEntry(ScriptState*, const String& key, AudioParam*&, ExceptionState&) override;
