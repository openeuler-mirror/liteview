    ...
    ScriptState* script_state, BaseAudioContext* context, const String& name, const AudioWorkletNodeOptions* options, ExceptionState& exception_state)
{
    ...
    // by a worklet thread.
    scoped_refptr<SerializedScriptValue> serialized_node_options = SerializedScriptValue::Serialize(
        isolate, ToV8Traits<AudioWorkletNodeOptions>::ToV8(script_state, options).ToLocalChecked(), serialize_options, exception_state);
