...
Response InspectorWebAudioAgent::getRealtimeData(const protocol::WebAudio::GraphObjectId& contextId, std::unique_ptr<ContextRealtimeData>* out_data)
{
    ...
    if (!context->HasRealtimeConstraint()) {
        return Response::ServerError("ContextRealtimeData is only avaliable for an AudioContext.");
    }
