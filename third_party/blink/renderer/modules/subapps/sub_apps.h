...
public:
    ...
    // SubApps API.
    ScriptPromise add(ScriptState*, const HeapVector<std::pair<String, Member<SubAppsAddOptions>>>& sub_apps, ExceptionState&);
    ScriptPromise list(ScriptState*, ExceptionState&);
    ScriptPromise remove(ScriptState*, const String& unhashed_app_id, ExceptionState&);
