...
private:
    ...
    absl::optional<String> ParseString(const JSONObject* object, const String& key, Trim trim);
    ...
    absl::optional<String> ParseStringForMember(const JSONObject* object, const String& member_name, const String& key, bool required, Trim trim);
    ...
    absl::optional<RGBA32> ParseColor(const JSONObject* object, const String& key);
    ...
    absl::optional<Vector<mojom::blink::ManifestImageResource::Purpose>> ParseIconPurpose(const JSONObject* icon);
    ...
    absl::optional<mojom::blink::ManifestImageResourcePtr> ParseImageResource(const JSONValue* object);
    ...
    absl::optional<mojom::blink::ManifestShareTarget::Method> ParseShareTargetMethod(const JSONObject* share_target_dict);

    // Parses the enctype field of a Share Target, as defined in:
    // https://wicg.github.io/web-share-target/#sharetarget-and-its-members
    // Returns an optional share target enctype enum object.
    absl::optional<mojom::blink::ManifestShareTarget::Enctype> ParseShareTargetEnctype(const JSONObject* share_target_dict);
    ...
    absl::optional<mojom::blink::ManifestShareTargetPtr> ParseShareTarget(const JSONObject* object);
    ...
    // This feature is experimental and is only enabled by the blink feature flag:
    // blink::features::kWebAppEnableUrlHandlers.
    absl::optional<mojom::blink::ManifestUrlHandlerPtr> ParseUrlHandler(const JSONObject* object);
    ...
    absl::optional<mojom::blink::ManifestFileHandlerPtr> ParseFileHandler(const JSONObject* file_handler_entry);
    ...
    absl::optional<mojom::blink::ManifestProtocolHandlerPtr> ParseProtocolHandler(const JSONObject* protocol_dictionary);
    ...
    absl::optional<KURL> ParseRelatedApplicationURL(const JSONObject* application);
    ...
    mojom::blink::ManifestUserPreferenceOverridesPtr ParsePreferenceOverrides(const JSONObject* object, const String& preference);
    ...
    mojom::blink::ManifestUserPreferencesPtr ParseUserPreferences(const JSONObject* object);
