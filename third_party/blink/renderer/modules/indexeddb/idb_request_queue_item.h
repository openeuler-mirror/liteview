...
public:
    IDBRequestQueueItem(IDBRequest*, DOMException*, base::OnceClosure on_result_load_complete);
    IDBRequestQueueItem(IDBRequest*, int64_t, base::OnceClosure on_result_load_complete);
    IDBRequestQueueItem(IDBRequest*, base::OnceClosure on_result_load_complete);
    IDBRequestQueueItem(IDBRequest*, std::unique_ptr<IDBKey>, base::OnceClosure on_result_load_complete);
    IDBRequestQueueItem(IDBRequest*, std::unique_ptr<IDBValue>, bool attach_loader, base::OnceClosure on_load_complete);
    IDBRequestQueueItem(IDBRequest*, Vector<std::unique_ptr<IDBValue>>, bool attach_loader, base::OnceClosure on_result_load_complete);
    IDBRequestQueueItem(IDBRequest*, Vector<Vector<std::unique_ptr<IDBValue>>>, bool attach_loader, base::OnceClosure on_result_load_complete);
    IDBRequestQueueItem(IDBRequest*, std::unique_ptr<IDBKey>, std::unique_ptr<IDBKey> primary_key, std::unique_ptr<IDBValue>, bool attach_loader,
        base::OnceClosure on_result_load_complete);
    IDBRequestQueueItem(IDBRequest*, std::unique_ptr<WebIDBCursor>, std::unique_ptr<IDBKey>, std::unique_ptr<IDBKey> primary_key, std::unique_ptr<IDBValue>,
        bool attach_loader, base::OnceClosure on_result_load_complete);
    // Asynchronous fetching of multiple results.
    IDBRequestQueueItem(
        IDBRequest*, bool key_only, mojo::PendingReceiver<mojom::blink::IDBDatabaseGetAllResultSink> receiver, base::OnceClosure on_result_load_complete);
