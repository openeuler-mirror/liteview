...
class MODULES_EXPORT BroadcastChannel final : public EventTargetWithInlineData,
...
private:
    ...
    mojo::AssociatedReceiver<mojom::blink::BroadcastChannelClient> receiver_ { this };
    ...
    mojo::AssociatedRemote<mojom::blink::BroadcastChannelProvider> associated_remote_;
};
