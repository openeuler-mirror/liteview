...
public:
    ...
    void GetSensor(device::mojom::blink::SensorType, device::mojom::blink::SensorProviderProxy::GetSensorCallback);

    void set_inspector_mode(bool flag)
    {
        inspector_mode_ = flag;
    }
    bool inspector_mode() const
    {
        return inspector_mode_;
    }
