...
SensorProxy* SensorProviderProxy::CreateSensorProxy(device::mojom::blink::SensorType type, Page* page)
{
    ...
    SensorProxy* sensor = inspector_mode_ ? static_cast<SensorProxy*>(MakeGarbageCollected<SensorProxyInspectorImpl>(type, this, page))
                                          : static_cast<SensorProxy*>(MakeGarbageCollected<SensorProxyImpl>(type, this, page));
...
void SensorProviderProxy::GetSensor(device::mojom::blink::SensorType type, device::mojom::blink::SensorProviderProxy::GetSensorCallback callback)
{
    InitializeIfNeeded();
