...
public:
    static ScriptPromise setPermission(
        ScriptState*, Internals&, const ScriptValue&, const String& state, const String& origin, const String& embedding_origin, ExceptionState&);
};
