...
class KeyboardLayoutMap final : public ScriptWrappable, public Maplike<String, IDLString, String, IDLString> {
...
private:
    ...
    PairIterable<String, IDLString, String, IDLString>::IterationSource* StartIteration(ScriptState*, ExceptionState&) override;
