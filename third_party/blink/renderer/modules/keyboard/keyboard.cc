...
ScriptPromise Keyboard::lock(ScriptState* state, const Vector<String>& keycodes, ExceptionState& exception_state)
{
...
ScriptPromise Keyboard::getLayoutMap(ScriptState* state, ExceptionState& exception_state)
{
