...
class KeyboardLayoutMapIterationSource final : public PairIterable<String, IDLString, String, IDLString>::IterationSource {
public:
    ...
    bool Next(ScriptState* script_state, String& map_key, String& map_value, ExceptionState&) override
    {
    ...
    {
        visitor->Trace(map_);
        PairIterable<String, IDLString, String, IDLString>::IterationSource::Trace(visitor);
    }
...
PairIterable<String, IDLString, String, IDLString>::IterationSource* KeyboardLayoutMap::StartIteration(ScriptState*, ExceptionState&)
{
