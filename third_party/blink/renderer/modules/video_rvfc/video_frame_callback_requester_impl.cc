...
void VideoFrameCallbackRequesterImpl::ScheduleWindowRaf()
{
    GetSupplementable()->GetDocument().GetScriptedAnimationController().ScheduleVideoFrameCallbacksExecution(
        WTF::BindOnce(&VideoFrameCallbackRequesterImpl::OnExecution, weak_factory_.GetWeakPtr()));
}
...
bool VideoFrameCallbackRequesterImpl::TryScheduleImmersiveXRSessionRaf()
{
    ...
    session->ScheduleVideoFrameCallbacksExecution(WTF::BindOnce(&VideoFrameCallbackRequesterImpl::OnExecution, weak_factory_.GetWeakPtr()));
