...
void VideoFrameRequestCallbackCollection::ExecuteFrameCallbacks(double high_res_now_ms, const VideoFrameMetadata* metadata)
{
...
void VideoFrameRequestCallbackCollection::V8VideoFrameCallback::Invoke(double highResTime, const VideoFrameMetadata* metadata)
{
