    ...
    , use_cached_position_(false)
{
    ...
    base::UmaHistogramCustomTimes("Geolocation.Timeout", base::Milliseconds(options_->timeout()), base::Milliseconds(1), base::Minutes(10),
        /* buckets = */ 20);
}
...
void GeoNotifier::TimerFired(TimerBase*)
{
    ...
    base::UmaHistogramCustomTimes("Geolocation.TimeoutExpired", base::Milliseconds(options_->timeout()), base::Milliseconds(1), base::Minutes(10),
        /* buckets = */ 20);
