...
using AppInstalledCallbacks = CallbackPromiseAdapter<HeapVector<Member<RelatedApplication>>, void>;
...
private:
    ...
    void OnGetManifestForRelatedApps(std::unique_ptr<AppInstalledCallbacks> callbacks, const KURL& url, mojom::blink::ManifestPtr manifest);
