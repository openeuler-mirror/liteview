...
void Lock::HoldUntil(ScriptPromise promise, ScriptPromiseResolver* resolver)
{
    ...
    resolver_ = resolver;
    promise.Then(MakeGarbageCollected<ScriptFunction>(script_state, MakeGarbageCollected<ThenFunction>(this, ThenFunction::kFulfilled)),
        MakeGarbageCollected<ScriptFunction>(script_state, MakeGarbageCollected<ThenFunction>(this, ThenFunction::kRejected)));
}
