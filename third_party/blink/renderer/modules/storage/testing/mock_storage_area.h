...
public:
    ...
    void Put(const Vector<uint8_t>& key, const Vector<uint8_t>& value, const absl::optional<Vector<uint8_t>>& client_old_value, const String& source,
        PutCallback callback) override;
    void Delete(const Vector<uint8_t>& key, const absl::optional<Vector<uint8_t>>& client_old_value, const String& source, DeleteCallback callback) override;
