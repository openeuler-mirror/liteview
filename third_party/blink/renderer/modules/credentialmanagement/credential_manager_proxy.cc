...
mojom::blink::FederatedAuthRequest* CredentialManagerProxy::FedCmLogoutRpsRequest()
{
    BindRemoteForFedCm(fedcm_logout_request_, WTF::BindOnce(&CredentialManagerProxy::OnFedCmLogoutConnectionError, WrapWeakPersistent(this)));
