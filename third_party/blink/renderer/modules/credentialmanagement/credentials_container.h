...
class MODULES_EXPORT CredentialsContainer final : public ScriptWrappable, public Supplement<Navigator> {
...
public:
    ...
    ScriptPromise get(ScriptState*, const CredentialRequestOptions*, ExceptionState&);
    ScriptPromise store(ScriptState*, Credential* = nullptr);
    ScriptPromise create(ScriptState*, const CredentialCreationOptions*, ExceptionState&);
