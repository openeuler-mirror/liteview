...
public:
    ...
    static bool IsRejectingPromiseDueToCSP(ContentSecurityPolicy* policy, ScriptPromiseResolver* resolver, const KURL& provider_url);
    ...
    static ScriptPromise logoutRPs(ScriptState*, const HeapVector<Member<IdentityCredentialLogoutRPsRequest>>&);
