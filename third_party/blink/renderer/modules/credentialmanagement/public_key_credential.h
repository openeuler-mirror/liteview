...
public:
    PublicKeyCredential(const String& id, DOMArrayBuffer* raw_id, AuthenticatorResponse*, mojom::AuthenticatorAttachment authenticator_attachment,
        const AuthenticationExtensionsClientOutputs* extension_outputs, const String& type = "");
    ...
    static ScriptPromise isUserVerifyingPlatformAuthenticatorAvailable(ScriptState*);
