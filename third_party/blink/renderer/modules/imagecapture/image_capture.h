...
public:
    ...
    ScriptPromise setOptions(ScriptState*, const PhotoSettings*, bool trigger_take_photo = false);
    ...
    void SetMediaTrackConstraints(ScriptPromiseResolver*, const HeapVector<Member<MediaTrackConstraintSet>>&);
...
private:
    using PromiseResolverFunction = base::OnceCallback<void(ScriptPromiseResolver*)>;
    ...
    void OnMojoGetPhotoState(ScriptPromiseResolver*, PromiseResolverFunction, bool trigger_take_photo, media::mojom::blink::PhotoStatePtr);
    void OnMojoSetOptions(ScriptPromiseResolver*, bool trigger_take_photo, bool result);
    ...
    void SetPanTiltZoomSettingsFromTrack(base::OnceClosure callback, media::mojom::blink::PhotoStatePtr photo_state);
    ...
    void OnSetPanTiltZoomSettingsFromTrack(base::OnceClosure done_callback, bool result);
    ...
    // retrieved.
    void UpdateMediaTrackCapabilities(base::OnceClosure initialized_callback, media::mojom::blink::PhotoStatePtr photo_state);
