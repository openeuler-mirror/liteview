...
using AXSparseSetterFunc = base::RepeatingCallback<void(AXObject* ax_object, ui::AXNodeData* node_data, const AtomicString& value)>;
...
public:
    AXNodeDataAOMPropertyClient(AXObjectCacheImpl& ax_object_cache, ui::AXNodeData& node_data)
    ...
    void AddRelationProperty(AOMRelationProperty, const AccessibleNode& value) override;
    void AddRelationListProperty(AOMRelationListProperty, const AccessibleNodeList& relations) override;
