...
TEST_F(AccessibilityTest, SimpleTreeNavigation)
{
    ...
    EXPECT_EQ(ax::mojom::Role::kStaticText, paragraph->DeepestFirstChildIncludingIgnored()->RoleValue());
    ASSERT_NE(nullptr, paragraph->DeepestLastChildIncludingIgnored());
    EXPECT_EQ(ax::mojom::Role::kStaticText, paragraph->DeepestLastChildIncludingIgnored()->RoleValue());
...
TEST_F(AccessibilityTest, TreeNavigationWithContinuations)
{
    ...
    EXPECT_EQ(RuntimeEnabledFeatures::LayoutNGBlockInInlineEnabled() ? ax_body : ax_root, ax_link->ParentObjectUnignored());
...
TEST_F(AccessibilityTest, SlotIsLineBreakingObject)
{
    ...
    ShadowRoot& shadow_root = GetElementById("host")->AttachShadowRootInternal(ShadowRootType::kOpen);
