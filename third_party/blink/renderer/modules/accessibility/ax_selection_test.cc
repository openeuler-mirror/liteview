...
TEST_F(AccessibilitySelectionTest, FromCurrentSelectionSelectAll)
{
    ...
    EXPECT_EQ(html_object->ChildCountIncludingIgnored(), ax_selection.Extent().ChildIndex());
...
TEST_F(AccessibilitySelectionTest, CancelSelect)
{
    ...
    AXSelection ax_selection = builder.SetBase(AXPosition::CreatePositionInTextObject(*ax_static_text_1, 3))
...
TEST_F(AccessibilitySelectionTest, SetSelectionInText)
{
    ...
    AXSelection::Builder builder;
    const AXSelection ax_selection = builder.SetBase(ax_base).SetExtent(ax_extent).Build();
...
TEST_P(ParameterizedAccessibilitySelectionTest, SetSelectionAroundListBullet)
{
    ...
    AXSelection ax_selection
        = builder.SetBase(AXPosition::CreateFirstPositionInObject(*ax_bullet_1)).SetExtent(AXPosition::CreateLastPositionInObject(*ax_text_2)).Build();
    ...
    EXPECT_EQ(static_cast<int>(item_1->NodeIndex()), extended_selection.Base().OffsetInContainerNode());
...
TEST_F(AccessibilitySelectionTest, FromCurrentSelectionInContentEditableWithSoftLineBreaks)
{
    ...
    EXPECT_EQ(ax_static_text->ComputedName().length(), static_cast<unsigned>(ax_selection.Extent().TextOffset()));
}
...
TEST_F(AccessibilitySelectionTest, ForwardSelectionInTextField)
{
    ...
    AXSelection::Builder builder;
    AXSelection ax_selection
        = builder.SetBase(AXPosition::CreateFirstPositionInObject(*ax_input)).SetExtent(AXPosition::CreateLastPositionInObject(*ax_input)).Build();
...
TEST_F(AccessibilitySelectionTest, BackwardSelectionInTextField)
{
    ...
    AXSelection::Builder builder;
    AXSelection ax_selection
        = builder.SetBase(AXPosition::CreatePositionInTextObject(*ax_input, 10)).SetExtent(AXPosition::CreatePositionInTextObject(*ax_input, 3)).Build();
...
TEST_F(AccessibilitySelectionTest, SelectingTheWholeOfTheTextField)
{
    ...
    AXSelection::Builder builder;
    AXSelection ax_selection
        = builder.SetBase(AXPosition::CreatePositionBeforeObject(*ax_before)).SetExtent(AXPosition::CreatePositionAfterObject(*ax_input)).Build();
    ...
    EXPECT_EQ(1, dom_selection.Base().OffsetInContainerNode());
    EXPECT_EQ(GetElementById("before"), dom_selection.Base().ComputeNodeAfterPosition());
    EXPECT_EQ(GetDocument().body(), dom_selection.Extent().AnchorNode());
    EXPECT_EQ(5, dom_selection.Extent().OffsetInContainerNode());
    EXPECT_EQ(GetElementById("after"), dom_selection.Extent().ComputeNodeAfterPosition());
...
TEST_F(AccessibilitySelectionTest, SelectEachConsecutiveCharacterInTextField)
{
    ...
    for (unsigned int i = 0; i < text_control.InnerEditorValue().length() - 1; ++i) {
        AXSelection::Builder builder;
        AXSelection ax_selection
            = builder.SetBase(AXPosition::CreatePositionInTextObject(*ax_input, i)).SetExtent(AXPosition::CreatePositionInTextObject(*ax_input, i + 1)).Build();
...
TEST_F(AccessibilitySelectionTest, InvalidSelectionInTextField)
{
    ...
    AXSelection::Builder builder;
    AXSelection ax_selection
        = builder.SetBase(AXPosition::CreatePositionInTextObject(*ax_input, 0)).SetExtent(AXPosition::CreatePositionBeforeObject(*ax_after)).Build();
...
TEST_F(AccessibilitySelectionTest, ForwardSelectionInTextarea)
{
    ...
    AXSelection::Builder builder;
    AXSelection ax_selection
        = builder.SetBase(AXPosition::CreateFirstPositionInObject(*ax_textarea)).SetExtent(AXPosition::CreateLastPositionInObject(*ax_textarea)).Build();
...
TEST_F(AccessibilitySelectionTest, BackwardSelectionInTextarea)
{
    ...
    AXSelection::Builder builder;
    AXSelection ax_selection
        = builder.SetBase(AXPosition::CreatePositionInTextObject(*ax_textarea, 10)).SetExtent(AXPosition::CreatePositionInTextObject(*ax_textarea, 3)).Build();
...
TEST_F(AccessibilitySelectionTest, SelectTheWholeOfTheTextarea)
{
    ...
    AXSelection::Builder builder;
    AXSelection ax_selection
        = builder.SetBase(AXPosition::CreatePositionBeforeObject(*ax_before)).SetExtent(AXPosition::CreatePositionAfterObject(*ax_textarea)).Build();
...
TEST_F(AccessibilitySelectionTest, SelectEachConsecutiveCharacterInTextarea)
{
    ...
    for (unsigned int i = 0; i < text_control.Value().length() - 1; ++i) {
        AXSelection::Builder builder;
        AXSelection ax_selection = builder.SetBase(AXPosition::CreatePositionInTextObject(*ax_textarea, i))
                                       .SetExtent(AXPosition::CreatePositionInTextObject(*ax_textarea, i + 1))
                                       .Build();
...
TEST_F(AccessibilitySelectionTest, InvalidSelectionInTextarea)
{
    ...
    AXSelection::Builder builder;
    AXSelection ax_selection
        = builder.SetBase(AXPosition::CreatePositionInTextObject(*ax_textarea, 0)).SetExtent(AXPosition::CreatePositionBeforeObject(*ax_after)).Build();
...
TEST_F(AccessibilitySelectionTest, FromCurrentSelectionInContenteditableWithAffinity)
{
    ...
    Element* const contenteditable = GetDocument().QuerySelector("div[role=textbox]");
    ...
    EXPECT_GT(static_cast<int>(ax_text->ComputedName().length()), ax_selection.Base().TextOffset());
    EXPECT_EQ(TextAffinity::kUpstream, ax_selection.Base().Affinity());
    EXPECT_TRUE(ax_selection.Extent().IsTextPosition());
    EXPECT_EQ(ax_text, ax_selection.Extent().ContainerObject());
    EXPECT_LE(15, ax_selection.Extent().TextOffset());
    EXPECT_GT(static_cast<int>(ax_text->ComputedName().length()), ax_selection.Extent().TextOffset());
    EXPECT_EQ(TextAffinity::kUpstream, ax_selection.Extent().Affinity());
}
...
TEST_F(AccessibilitySelectionTest, SelectEachConsecutiveCharacterInContenteditable)
{
    ...
    const Element* contenteditable = GetDocument().QuerySelector("div[contenteditable]");
    ASSERT_NE(nullptr, contenteditable);
    ...
    for (unsigned int i = 0; i < computed_name.length() - 1; ++i) {
        AXSelection::Builder builder;
        AXSelection ax_selection = builder.SetBase(AXPosition::CreatePositionInTextObject(*ax_static_text, i))
                                       .SetExtent(AXPosition::CreatePositionInTextObject(*ax_static_text, i + 1))
                                       .Build();
        ...
        // accessibility tree.
        EXPECT_EQ(static_cast<int>(i + 9), dom_selection.Base().OffsetInContainerNode());
        EXPECT_EQ(static_cast<int>(i + 10), dom_selection.Extent().OffsetInContainerNode());
    }
    ...
    for (unsigned int i = computed_name.length(); i > 0; --i) {
        ...
        // accessibility tree.
        EXPECT_EQ(static_cast<int>(i + 9), dom_selection.Base().OffsetInContainerNode());
        EXPECT_EQ(static_cast<int>(i + 8), dom_selection.Extent().OffsetInContainerNode());
    }
}
...
TEST_F(AccessibilitySelectionTest, SelectionWithEqualBaseAndExtent)
{
    ...
    AXSelection::Builder builder;
    AXSelection ax_selection = builder.SetBase(ax_position).SetExtent(ax_position).Build();
}
