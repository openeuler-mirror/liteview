...
class MODULES_EXPORT BlinkAXTreeSource : public GarbageCollected<BlinkAXTreeSource>, public ui::AXTreeSource<AXObject*> {
public:
    ...
    void GetChildren(AXObject* node, std::vector<AXObject*>* out_children) const override;
    ...
    void set_exclude_offscreen(bool exclude)
    {
        exclude_offscreen_ = exclude;
    }
...
private:
    ...
    void Selection(const AXObject* obj, bool& is_selection_backward, AXObject** anchor_object, int& anchor_offset,
