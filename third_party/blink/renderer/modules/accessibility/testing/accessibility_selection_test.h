...
class ParameterizedAccessibilitySelectionTest : public testing::WithParamInterface<bool>, private ScopedLayoutNGForTest, public AccessibilitySelectionTest {
public:
    ParameterizedAccessibilitySelectionTest(LocalFrameClient* local_frame_client = nullptr);
...
INSTANTIATE_TEST_SUITE_P(All, ParameterizedAccessibilitySelectionTest, testing::Bool());
