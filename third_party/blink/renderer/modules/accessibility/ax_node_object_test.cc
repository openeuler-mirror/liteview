...
TEST_P(ParameterizedAccessibilityTest, TextOffsetInFormattingContextWithLayoutReplaced)
{
...
TEST_P(ParameterizedAccessibilityTest, TextOffsetInFormattingContextWithLayoutInline)
{
    SetBodyInnerHTML(R"HTML(
      <p>
...
TEST_P(ParameterizedAccessibilityTest, TextOffsetInFormattingContextWithLayoutBlockFlowAtInlineLevel)
{
    SetBodyInnerHTML(R"HTML(
      <p>
        Before
...
TEST_P(ParameterizedAccessibilityTest, TextOffsetInFormattingContextWithLayoutBlockFlowAtBlockLevel)
{
...
TEST_P(ParameterizedAccessibilityTest, TextOffsetInFormattingContextWithLayoutText)
{
    SetBodyInnerHTML(R"HTML(
      <p>
...
TEST_P(ParameterizedAccessibilityTest, TextOffsetInFormattingContextWithLayoutBr)
{
    SetBodyInnerHTML(R"HTML(
      <p>
...
TEST_P(ParameterizedAccessibilityTest, TextOffsetInFormattingContextWithLayoutFirstLetter)
{
    SetBodyInnerHTML(R"HTML(
      <style>
        q::first-letter {
...
TEST_P(ParameterizedAccessibilityTest, TextOffsetInFormattingContextWithCSSGeneratedContent)
{
    SetBodyInnerHTML(R"HTML(
      <style>
        q::before {
