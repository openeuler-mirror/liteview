...
public:
    ...
    bool IsVirtualObject() const override
    {
        return true;
    }
    void AddChildren() override;
    void ChildrenChangedWithCleanLayout() override;
    const AtomicString& GetAOMPropertyOrARIAAttribute(AOMStringProperty) const override;
    bool HasAOMPropertyOrARIAAttribute(AOMBooleanProperty, bool& result) const override;
...
template <> struct DowncastTraits<AXVirtualObject> {
