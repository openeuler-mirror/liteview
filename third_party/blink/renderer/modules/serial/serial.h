...
public:
    ...
    ScriptPromise requestPort(ScriptState*, const SerialPortRequestOptions*, ExceptionState&);
...
private:
    ...
    void OnGetPorts(ScriptPromiseResolver*, Vector<mojom::blink::SerialPortInfoPtr>);
