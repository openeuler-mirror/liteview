...
class SerialPort final : public EventTargetWithInlineData, public ActiveScriptWrappable<SerialPort>, public device::mojom::blink::SerialPortClient {
...
public:
    ...
    ScriptPromise open(ScriptState*, const SerialOptions* options, ExceptionState&);
    ...
    ScriptPromise setSignals(ScriptState*, const SerialOutputSignals*, ExceptionState&);
...
private:
    ...
    void OnOpen(mojo::PendingReceiver<device::mojom::blink::SerialPortClient>, ScriptPromiseResolver*, mojo::PendingRemote<device::mojom::blink::SerialPort>);
    void OnGetSignals(ScriptPromiseResolver*, device::mojom::blink::SerialPortControlSignalsPtr);
