...
TEST_P(DelegatedInkTrailPresenterCanvasBeyondViewport, CollectAndPropagateMetadata)
{
    ...
    DelegatedInkTrailPresenter* presenter = CreatePresenter(GetDocument().getElementById("canvas"), GetDocument().GetFrame());
    DCHECK(presenter);
...
TEST_P(DelegatedInkTrailPresenterCanvasBeyondViewport, CanvasInIFrame)
{
    ...
    DelegatedInkTrailPresenter* presenter = CreatePresenter(iframe_localframe->GetDocument()->getElementById("canvas"), iframe_document->GetFrame());
    DCHECK(presenter);
...
TEST_P(DelegatedInkTrailPresenterCanvasBeyondViewport, NestedIframe)
{
    ...
    auto* outer_iframe_element = To<HTMLIFrameElement>(GetDocument().getElementById("OuterIframe"));
    auto* inner_iframe_element = To<HTMLIFrameElement>(outer_iframe_element->contentDocument()->getElementById("InnerIframe"));
...
TEST_P(DelegatedInkTrailPresenterCanvasBeyondViewport, IFrameNoPresentationArea)
{
    ...
    Document* iframe_document = To<HTMLIFrameElement>(GetDocument().getElementById("iframe"))->contentDocument();
