...
class MockScreenOrientation final : public device::mojom::blink::ScreenOrientation {
public:
    ...
    void BindPendingReceiver(mojo::PendingAssociatedReceiver<device::mojom::blink::ScreenOrientation> pending_receiver)
    {
...
private:
    mojo::AssociatedReceiver<device::mojom::blink::ScreenOrientation> receiver_ { this };
};
...
public:
    ...
    void InstallSupplements(LocalFrame& frame) override
    {
        ...
        ScreenOrientationClient().BindPendingReceiver(screen_orientation.BindNewEndpointAndPassDedicatedReceiver());
