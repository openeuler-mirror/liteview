...
TEST_F(MediaControlTimelineElementTest, PointerDownPausesPlayback)
{
    ...
    Timeline()->DispatchEvent(*PointerEvent::Create("pointerdown", GetValidPointerEventInit()));
...
TEST_F(MediaControlTimelineElementTest, PointerUpResumesPlayback)
{
    ...
    Timeline()->DispatchEvent(*PointerEvent::Create("pointerdown", GetValidPointerEventInit()));
    Timeline()->DispatchEvent(*PointerEvent::Create("pointerup", GetValidPointerEventInit()));
    EXPECT_FALSE(Video()->paused());
}
...
TEST_F(MediaControlTimelineElementTest, PointerOutDoesNotResume)
{
    ...
    Timeline()->DispatchEvent(*PointerEvent::Create("pointerdown", GetValidPointerEventInit()));
    Timeline()->DispatchEvent(*PointerEvent::Create("pointerout", GetValidPointerEventInit()));
    EXPECT_TRUE(Video()->paused());
}
...
TEST_F(MediaControlTimelineElementTest, PointerMoveDoesNotResume)
{
    ...
    Timeline()->DispatchEvent(*PointerEvent::Create("pointerdown", GetValidPointerEventInit()));
    Timeline()->DispatchEvent(*PointerEvent::Create("pointermove", GetValidPointerEventInit()));
    EXPECT_TRUE(Video()->paused());
}
...
TEST_F(MediaControlTimelineElementTest, PointerCancelResumesPlayback)
{
    ...
    Timeline()->DispatchEvent(*PointerEvent::Create("pointerdown", GetValidPointerEventInit()));
    Timeline()->DispatchEvent(*PointerEvent::Create("pointercancel", GetValidPointerEventInit()));
    EXPECT_FALSE(Video()->paused());
}
...
TEST_F(MediaControlTimelineElementTest, TouchStartPausesPlayback)
{
    ...
    Timeline()->DispatchEvent(*TouchEvent::Create("touchstart", GetValidTouchEventInit()));
    EXPECT_TRUE(Video()->paused());
}
...
TEST_F(MediaControlTimelineElementTest, TouchEndResumesPlayback)
{
    ...
    Timeline()->DispatchEvent(*TouchEvent::Create("touchstart", GetValidTouchEventInit()));
    Timeline()->DispatchEvent(*TouchEvent::Create("touchend", GetValidTouchEventInit()));
    EXPECT_FALSE(Video()->paused());
}
...
TEST_F(MediaControlTimelineElementTest, TouchCancelResumesPlayback)
{
    ...
    Timeline()->DispatchEvent(*TouchEvent::Create("touchstart", GetValidTouchEventInit()));
    Timeline()->DispatchEvent(*TouchEvent::Create("touchcancel", GetValidTouchEventInit()));
    EXPECT_FALSE(Video()->paused());
}
...
TEST_F(MediaControlTimelineElementTest, TouchMoveDoesNotResume)
{
    ...
    Timeline()->DispatchEvent(*TouchEvent::Create("touchstart", GetValidTouchEventInit()));
    Timeline()->DispatchEvent(*TouchEvent::Create("touchmove", GetValidTouchEventInit()));
    EXPECT_TRUE(Video()->paused());
}
