...
void MediaControlAnimatedArrowContainerElement::ShowArrowAnimation(MediaControlAnimatedArrowContainerElement::ArrowDirection direction)
{
    ...
    if (!left_jump_arrow_) {
        ...
        left_jump_arrow_ = MakeGarbageCollected<MediaControlAnimatedArrowContainerElement::AnimatedArrow>("left-arrow", GetDocument());
        shadow_root->ParserAppendChild(left_jump_arrow_);

        right_jump_arrow_ = MakeGarbageCollected<MediaControlAnimatedArrowContainerElement::AnimatedArrow>("right-arrow", GetDocument());
