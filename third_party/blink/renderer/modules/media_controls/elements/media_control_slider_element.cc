...
void MediaControlSliderElement::SetupBarSegments()
{
    ...
    HTMLDivElement* background = MediaControlElementsHelper::CreateDiv("-internal-track-segment-background", &track);
    segment_highlight_before_ = MediaControlElementsHelper::CreateDiv("-internal-track-segment-highlight-before", background);
    segment_highlight_after_ = MediaControlElementsHelper::CreateDiv("-internal-track-segment-highlight-after", background);
}
