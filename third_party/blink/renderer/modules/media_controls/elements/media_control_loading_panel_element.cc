...
void MediaControlLoadingPanelElement::PopulateShadowDOM()
{
    ...
    // elements.
    HTMLDivElement* spinner_frame = MediaControlElementsHelper::CreateDivWithId("spinner-frame", shadow_root);
    spinner_frame->SetShadowPseudoId("-internal-media-controls-loading-panel-spinner-frame");

    // The spinner is responsible for rotating the elements below. The square
    // edges will be cut off by the frame above.
    HTMLDivElement* spinner = MediaControlElementsHelper::CreateDivWithId("spinner", spinner_frame);

    // The layer performs a secondary "fill-unfill-rotate" animation.
    HTMLDivElement* layer = MediaControlElementsHelper::CreateDivWithId("layer", spinner);
    ...
    HTMLDivElement* mask1 = MediaControlElementsHelper::CreateDivWithId("spinner-mask-1", layer);
    mask1_background_ = MediaControlElementsHelper::CreateDiv("-internal-media-controls-loading-panel-spinner-mask-1-background", mask1);
    HTMLDivElement* mask2 = MediaControlElementsHelper::CreateDivWithId("spinner-mask-2", layer);
    mask2_background_ = MediaControlElementsHelper::CreateDiv("-internal-media-controls-loading-panel-spinner-mask-2-background", mask2);
