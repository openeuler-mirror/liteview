...
public:
    void SetUp() final
    {
        ...
        PageTestBase::SetUp();
        arrow_element_ = MakeGarbageCollected<MediaControlAnimatedArrowContainerElement::AnimatedArrow>("test", GetDocument());
...
private:
    ...
    {
        return GetElementById("jump")->InlineStyle()->HasProperty(CSSPropertyID::kDisplay);
    }

    bool SVGElementIsPresent()
    {
        return GetElementById("jump");
    }
