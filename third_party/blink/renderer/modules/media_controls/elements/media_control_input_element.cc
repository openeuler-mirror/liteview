...
HTMLElement* MediaControlInputElement::CreateOverflowElement(MediaControlInputElement* button)
{
    ...
    aria_label_ = button->FastGetAttribute(html_names::kAriaLabelAttr) + " " + button->GetOverflowMenuString();
...
void MediaControlInputElement::UpdateOverflowSubtitleElement(String text)
{
    ...
    if (overflow_menu_subtitle_) {
        ...
        overflow_menu_subtitle_->setInnerText(text);
        overflow_menu_subtitle_->setAttribute("class", AtomicString(kOverflowSubtitleCSSClass));

        overflow_menu_container_->ParserAppendChild(overflow_menu_subtitle_);
        overflow_menu_container_->setAttribute("class", AtomicString(kOverflowContainerWithSubtitleCSSClass));
    }
...
void MediaControlInputElement::SetClass(const AtomicString& class_name, bool should_have_class)
{
