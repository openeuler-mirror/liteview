...
public:
    ...
    ScriptPromise registerPeriodicSync(ScriptState* script_state, const String& tag, const BackgroundSyncOptions* options, ExceptionState& exception_state);
...
private:
    ...
    // Callbacks
    void RegisterCallback(ScriptPromiseResolver* resolver, mojom::blink::BackgroundSyncError error, mojom::blink::SyncRegistrationOptionsPtr options);
    ...
    void UnregisterCallback(ScriptPromiseResolver* resolver, mojom::blink::BackgroundSyncError error);
