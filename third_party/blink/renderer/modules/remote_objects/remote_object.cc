...
mojom::blink::RemoteInvocationArgumentPtr JSValueToMojom(const v8::Local<v8::Value>& js_value, v8::Isolate* isolate)
{
    ...
    if (js_value->IsString()) {
        return mojom::blink::RemoteInvocationArgument::NewStringValue(ToCoreString(js_value.As<v8::String>()));
    }
...
void RemoteObject::RemoteObjectInvokeCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    if (info.IsConstructCall()) {
        ...
        UMA_HISTOGRAM_ENUMERATION("Blink.JavaJsBridge.MethodInvocationError", JavaJsBridgeMethodInvocationError::kAsConstructorDisallowed);
        return;
    }
    ...
    if (!gin::ConvertFromV8(isolate, info.Holder(), &remote_object)) {
        ...
        UMA_HISTOGRAM_ENUMERATION("Blink.JavaJsBridge.MethodInvocationError", JavaJsBridgeMethodInvocationError::kOnNonInjectedObjectDisallowed);
        return;
    }
    ...
    if (cached_method->IsUndefined()) {
        ...
        UMA_HISTOGRAM_ENUMERATION("Blink.JavaJsBridge.MethodInvocationError", JavaJsBridgeMethodInvocationError::kNonexistentMethod);
        return;
    }
    ...
    if (result->error != mojom::blink::RemoteInvocationError::OK) {
        ...
        UMA_HISTOGRAM_ENUMERATION("Blink.JavaJsBridge.MethodInvocationError", JavaJsBridgeMethodInvocationError::kErrorMessage);
        return;
    }
