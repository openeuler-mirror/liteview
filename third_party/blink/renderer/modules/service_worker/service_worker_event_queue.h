...
public:
    ...
    void EnqueueNormal(int event_id, StartCallback start_callback, AbortCallback abort_callback, absl::optional<base::TimeDelta> custom_timeout);

    // Similar to EnqueueNormal(), but enqueues a Pending event.
    void EnqueuePending(int event_id, StartCallback start_callback, AbortCallback abort_callback, absl::optional<base::TimeDelta> custom_timeout);

    // Similar to EnqueueNormal(), but enqueues an Offline event.
    void EnqueueOffline(int event_id, StartCallback start_callback, AbortCallback abort_callback, absl::optional<base::TimeDelta> custom_timeout);
...
private:
    ...
    struct Event {
        ...
        Event(int event_id, Type type, StartCallback start_callback, AbortCallback abort_callback, absl::optional<base::TimeDelta> custom_timeout);
        ~Event();
        const int event_id;
        Type type;
