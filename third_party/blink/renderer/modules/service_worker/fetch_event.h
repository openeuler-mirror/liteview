...
public:
    using PreloadResponseProperty = ScriptPromiseProperty<Member<Response>, Member<DOMException>>;
...
private:
    ...
    Member<ScriptPromiseProperty<ToV8UndefinedGenerator, Member<DOMException>>> handled_property_;
    String client_id_;
