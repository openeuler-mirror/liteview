...
public:
    ...
    std::unique_ptr<WebURLLoaderFactory> WrapURLLoaderFactory(
        CrossVariantMojoRemote<network::mojom::URLLoaderFactoryInterfaceBase> url_loader_factory) override;
...
private:
    ...
    std::unique_ptr<InternetDisconnectedWebURLLoaderFactory> internet_disconnected_web_url_loader_factory_;
