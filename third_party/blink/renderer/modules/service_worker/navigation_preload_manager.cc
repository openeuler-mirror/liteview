...
ScriptPromise NavigationPreloadManager::setHeaderValue(ScriptState* script_state, const String& value, ExceptionState& exception_state)
{
...
ScriptPromise NavigationPreloadManager::SetEnabled(bool enable, ScriptState* script_state)
{
    auto* resolver = MakeGarbageCollected<ScriptPromiseResolver>(script_state);
    ScriptPromise promise = resolver->Promise();
