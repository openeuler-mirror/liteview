...
void ServiceWorkerEventQueue::EnqueueNormal(
    int event_id, StartCallback start_callback, AbortCallback abort_callback, absl::optional<base::TimeDelta> custom_timeout)
{
...
void ServiceWorkerEventQueue::EnqueueEvent(std::unique_ptr<Event> event)
{
    ...
    bool can_start_processing_events = !processing_events_ && event->type != Event::Type::Pending;
