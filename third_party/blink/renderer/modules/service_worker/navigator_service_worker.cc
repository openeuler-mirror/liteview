...
// static
ServiceWorkerContainer* NavigatorServiceWorker::serviceWorker(ScriptState* script_state, Navigator& navigator, ExceptionState& exception_state)
{
    if (!navigator.DomWindow())
        return nullptr;
    LocalDOMWindow& window = *navigator.DomWindow();
    DCHECK(ExecutionContext::From(script_state)->GetSecurityOrigin()->CanAccess(window.GetSecurityOrigin()));
