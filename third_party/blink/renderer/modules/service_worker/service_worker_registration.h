...
public:
    ...
    static ServiceWorkerRegistration* Take(ScriptPromiseResolver*, WebServiceWorkerRegistrationObjectInfo);
    ...
    void SetNavigationPreloadHeader(const String& value, ScriptPromiseResolver* resolver);
...
private:
    ...
    void UpdateInternal(mojom::blink::FetchClientSettingsObjectPtr mojom_settings_object, ScriptPromiseResolver* resolver);
    ...
    mojo::AssociatedRemote<mojom::blink::ServiceWorkerRegistrationObjectHost> host_;
    ...
    mojo::AssociatedReceiver<mojom::blink::ServiceWorkerRegistrationObject> receiver_ { this };
...
public:
    ...
    static HeapVector<Member<ServiceWorkerRegistration>> Take(ScriptPromiseResolver* resolver, WebType web_service_worker_registrations)
    {
