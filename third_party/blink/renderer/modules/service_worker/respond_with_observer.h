...
public:
    ...
    virtual void OnResponseFulfilled(ScriptState*, const ScriptValue&, const ExceptionContext&) = 0;
...
private:
    ...
    void ResponseWasRejected(mojom::ServiceWorkerResponseError, const ScriptValue&);
    void ResponseWasFulfilled(ScriptState* state, const ExceptionContext&, const ScriptValue&);
