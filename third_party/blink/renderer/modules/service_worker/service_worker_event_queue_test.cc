...
public:
    ...
    void EnqueueTo(ServiceWorkerEventQueue* event_queue)
    {
        ...
        event_queue->EnqueueNormal(*event_id_, WTF::BindOnce(&MockEvent::Start, weak_factory_.GetWeakPtr()),
            WTF::BindOnce(&MockEvent::Abort, weak_factory_.GetWeakPtr()), absl::nullopt);
    }
...
TEST_F(ServiceWorkerEventQueueTest, EventFinishedBeforeStart)
{
    ...
    task_runner()->FastForwardBy(base::Seconds(mojom::blink::kServiceWorkerDefaultIdleDelayInSeconds) - base::Seconds(1));
