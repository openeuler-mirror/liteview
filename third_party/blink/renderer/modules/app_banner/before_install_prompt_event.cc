...
ScriptPromise BeforeInstallPromptEvent::userChoice(ScriptState* script_state, ExceptionState& exception_state)
{
...
ScriptPromise BeforeInstallPromptEvent::prompt(ScriptState* script_state, ExceptionState& exception_state)
{
