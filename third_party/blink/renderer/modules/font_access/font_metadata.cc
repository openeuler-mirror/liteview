...
// static
void FontMetadata::BlobImpl(ScriptPromiseResolver* resolver, const String& postscriptName)
{
    ...
    scoped_refptr<SimpleFontData> font_data = FontCache::Get().GetFontData(description, AtomicString(postscriptName), AlternateFontName::kLocalUniqueFace);
    if (!font_data) {
