...
class FontTableMapIterationSource final : public PairIterable<String, IDLString, Member<Blob>, Blob>::IterationSource {
public:
    ...
    bool Next(ScriptState* script_state, String& map_key, Member<Blob>& map_value, ExceptionState&) override
    {
    ...
    void Trace(Visitor* visitor) const override
    {
        ...
        PairIterable<String, IDLString, Member<Blob>, Blob>::IterationSource::Trace(visitor);
    }
...
PairIterable<String, IDLString, Member<Blob>, Blob>::IterationSource* FontTableMap::StartIteration(ScriptState*, ExceptionState&)
{
    return MakeGarbageCollected<FontTableMapIterationSource>(table_map_);
}

bool FontTableMap::GetMapEntry(ScriptState*, const String& key, Member<Blob>& value, ExceptionState&)
{
