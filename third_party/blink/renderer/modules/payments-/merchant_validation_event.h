...
public:
    static MerchantValidationEvent* Create(ScriptState*, const AtomicString& type, const MerchantValidationEventInit*, ExceptionState&);

    MerchantValidationEvent(ScriptState*, const AtomicString& type, const MerchantValidationEventInit*, ExceptionState&);
