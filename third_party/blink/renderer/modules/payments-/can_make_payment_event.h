...
public:
    static CanMakePaymentEvent* Create(ScriptState*, const AtomicString& type, const CanMakePaymentEventInit*);
    static CanMakePaymentEvent* Create(
        ScriptState*, const AtomicString& type, const CanMakePaymentEventInit*, CanMakePaymentRespondWithObserver*, WaitUntilObserver*);

    CanMakePaymentEvent(ScriptState*, const AtomicString& type, const CanMakePaymentEventInit*, CanMakePaymentRespondWithObserver*, WaitUntilObserver*);
