...
public:
    static PaymentRequestEvent* Create(const AtomicString& type, const PaymentRequestEventInit*,
        mojo::PendingRemote<payments::mojom::blink::PaymentHandlerHost> host = mojo::NullRemote(), RespondWithObserver* respond_with_observer = nullptr,
        WaitUntilObserver* wait_until_observer = nullptr, ExecutionContext* execution_context = nullptr);
    ...
    PaymentRequestEvent(const AtomicString& type, const PaymentRequestEventInit*, mojo::PendingRemote<payments::mojom::blink::PaymentHandlerHost> host,
        RespondWithObserver*, WaitUntilObserver*, ExecutionContext* execution_context);
    ...
    absl::optional<HeapVector<Member<PaymentShippingOption>>> shippingOptions() const;

    ScriptPromise openWindow(ScriptState*, const String& url);
    ScriptPromise changePaymentMethod(ScriptState*, const String& method_name, ExceptionState& exception_state);
    ScriptPromise changePaymentMethod(ScriptState*, const String& method_name, const ScriptValue& method_details, ExceptionState& exception_state);
    ScriptPromise changeShippingAddress(ScriptState*, AddressInit*, ExceptionState&);
    ScriptPromise changeShippingOption(ScriptState*, const String& shipping_option_id, ExceptionState&);
