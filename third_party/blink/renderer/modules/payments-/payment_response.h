...
class MODULES_EXPORT PaymentResponse final : public EventTargetWithInlineData, public ExecutionContextClient, public ActiveScriptWrappable<PaymentResponse> {
...
public:
    ...
    ScriptPromise retry(ScriptState*, const PaymentValidationErrors*, ExceptionState&);
