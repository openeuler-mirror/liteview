...
public:
    ...
    static AbortPaymentEvent* Create(const AtomicString& type, const ExtendableEventInit*, RespondWithObserver*, WaitUntilObserver*);

    AbortPaymentEvent(const AtomicString& type, const ExtendableEventInit*, RespondWithObserver*, WaitUntilObserver*);
