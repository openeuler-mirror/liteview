...
class MODULES_EXPORT PaymentRequest final : public EventTargetWithInlineData,
...
public:
    ...
    ScriptPromise show(ScriptState*, ScriptPromise details_promise, ExceptionState&);
    ...
    ScriptPromise Complete(ScriptState*, PaymentComplete result, ExceptionState&) override;
    ScriptPromise Retry(ScriptState*, const PaymentValidationErrors*, ExceptionState&) override;
...
private:
    ...
    Member<ScriptPromiseResolver> accept_resolver_; // the resolver for the show() promise.
