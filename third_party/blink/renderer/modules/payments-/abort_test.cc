...
TEST(AbortTest, CanAbortAfterShow)
{
    ...
    request->abort(scope.GetScriptState(), ASSERT_NO_EXCEPTION).Then(funcs.ExpectNoCall(), funcs.ExpectNoCall());
}
...
TEST(AbortTest, FailedAbortShouldRejectAbortPromise)
{
    ...
    request->abort(scope.GetScriptState(), ASSERT_NO_EXCEPTION).Then(funcs.ExpectNoCall(), funcs.ExpectCall());
...
TEST(AbortTest, SuccessfulAbortShouldRejectShowPromiseAndResolveAbortPromise)
{
    ...
    request->abort(scope.GetScriptState(), ASSERT_NO_EXCEPTION).Then(funcs.ExpectCall(), funcs.ExpectNoCall());
