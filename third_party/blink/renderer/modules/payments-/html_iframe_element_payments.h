...
class HTMLIFrameElementPayments final : public GarbageCollected<HTMLIFrameElementPayments>, public Supplement<HTMLIFrameElement> {
public:
    ...
    static void SetBooleanAttribute(HTMLIFrameElement&, const QualifiedName&, bool);
