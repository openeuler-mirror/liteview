...
public:
    ...
    // IDL Interface:
    static ScriptPromise getDigitalGoodsService(ScriptState*, LocalDOMWindow&, const String& payment_method, ExceptionState&);

    ScriptPromise GetDigitalGoodsService(ScriptState*, LocalDOMWindow&, const String& payment_method, ExceptionState&);
