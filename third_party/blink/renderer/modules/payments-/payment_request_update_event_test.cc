...
TEST(PaymentRequestUpdateEventTest, OnUpdatePaymentDetailsCalled)
{
    ...
    auto* payment_details = MakeGarbageCollected<ScriptPromiseResolver>(scope.GetScriptState());
...
TEST(PaymentRequestUpdateEventTest, CannotUpdateWithoutDispatching)
{
    ...
    event->updateWith(scope.GetScriptState(), MakeGarbageCollected<ScriptPromiseResolver>(scope.GetScriptState())->Promise(), scope.GetExceptionState());
...
TEST(PaymentRequestUpdateEventTest, AddressChangeUpdateWithTimeout)
{
    ...
    request->show(scope.GetScriptState(), scope.GetExceptionState()).Then(funcs.ExpectNoCall(), funcs.ExpectCall(&error_message));
