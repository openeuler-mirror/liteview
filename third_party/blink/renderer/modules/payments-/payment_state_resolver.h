...
public:
    ...
    virtual ScriptPromise Complete(ScriptState*, PaymentComplete result, ExceptionState&) = 0;
    virtual ScriptPromise Retry(ScriptState*, const PaymentValidationErrors*, ExceptionState&) = 0;
