...
public:
    ...
    static v8::Local<v8::Value> Create(v8::Isolate*, absl::optional<uint8_t> stream_error_code, String message, Source);
    ...
    // methods.
    WebTransportError(PassKey, absl::optional<uint8_t> stream_error_code, String message, Source);
    ~WebTransportError() override;

    absl::optional<uint8_t> streamErrorCode() const
    {
