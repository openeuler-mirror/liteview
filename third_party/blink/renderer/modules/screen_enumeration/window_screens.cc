...
// static
ScriptPromise WindowScreens::getScreenDetails(ScriptState* script_state, LocalDOMWindow& window, ExceptionState& exception_state)
{
...
ScriptPromise WindowScreens::GetScreenDetails(ScriptState* script_state, ExceptionState& exception_state)
{
    ...
    auto permission_descriptor = CreatePermissionDescriptor(mojom::blink::PermissionName::WINDOW_PLACEMENT);
    auto* resolver = MakeGarbageCollected<ScriptPromiseResolver>(script_state);
    auto callback = WTF::BindOnce(&WindowScreens::OnPermissionRequestComplete, WrapPersistent(this), WrapPersistent(resolver));
...
void WindowScreens::OnPermissionRequestComplete(ScriptPromiseResolver* resolver, mojom::blink::PermissionStatus status)
{
