...
{
    ctx->setStrokeStyle(MakeGarbageCollected<V8UnionCSSColorValueOrCanvasGradientOrCanvasPatternOrString>("#666"));
    ctx->setStrokeStyle(MakeGarbageCollected<V8UnionCSSColorValueOrCanvasGradientOrCanvasPatternOrString>(value));
...
{
    ctx->setFillStyle(MakeGarbageCollected<V8UnionCSSColorValueOrCanvasGradientOrCanvasPatternOrString>("#666"));
    ctx->setFillStyle(MakeGarbageCollected<V8UnionCSSColorValueOrCanvasGradientOrCanvasPatternOrString>(value));
...
TEST_F(CanvasRenderingContext2DAPITest, GetImageDataIntegerOverflowNegativeParams)
{
    ...
    image_data = Context2D()->getImageData(-2147483647, 1, -2147483647, 1, settings, exception_state);
    EXPECT_EQ(nullptr, image_data);
    EXPECT_TRUE(exception_state.HadException());
    EXPECT_EQ(ESErrorType::kRangeError, exception_state.CodeAs<ESErrorType>());
}
...
TEST_F(CanvasRenderingContext2DAPITest, MAYBE_IdentifiabilityStudyDigest_Font)
{
    ...
    Context2D()->setFont("Arial");
    EXPECT_EQ(INT64_C(-7111871220951205888), Context2D()->IdentifiableTextToken().ToUkmMetricValue());
...
TEST_F(CanvasRenderingContext2DAPITest, MAYBE_IdentifiabilityStudyDigest_StrokeText)
{
    ...
    EXPECT_EQ(INT64_C(2232415440872807707), Context2D()->IdentifiableTextToken().ToUkmMetricValue());
...
TEST_F(CanvasRenderingContext2DAPITest, MAYBE_IdentifiabilityStudyDigest_FillText)
{
    ...
    EXPECT_EQ(INT64_C(6317349156921019980), Context2D()->IdentifiableTextToken().ToUkmMetricValue());
...
TEST_F(CanvasRenderingContext2DAPITest, MAYBE_IdentifiabilityStudyDigest_TextAlign)
{
    ...
    EXPECT_EQ(INT64_C(-1799394612814265049), Context2D()->IdentifiableTextToken().ToUkmMetricValue());
...
TEST_F(CanvasRenderingContext2DAPITest, MAYBE_IdentifiabilityStudyDigest_TextBaseline)
{
    ...
    EXPECT_EQ(INT64_C(-7620161594820691651), Context2D()->IdentifiableTextToken().ToUkmMetricValue());
...
TEST_F(CanvasRenderingContext2DAPITest, MAYBE_IdentifiabilityStudyDigest_StrokeStyle)
{
    ...
    auto* style = MakeGarbageCollected<V8UnionCSSColorValueOrCanvasGradientOrCanvasPatternOrString>("blue");
    Context2D()->setStrokeStyle(style);
    EXPECT_EQ(INT64_C(-1964835352532316734), Context2D()->IdentifiableTextToken().ToUkmMetricValue());
...
TEST_F(CanvasRenderingContext2DAPITest, MAYBE_IdentifiabilityStudyDigest_FillStyle)
{
    ...
    EXPECT_EQ(INT64_C(-4860826471555317536), Context2D()->IdentifiableTextToken().ToUkmMetricValue());
...
TEST_F(CanvasRenderingContext2DAPITest, MAYBE_IdentifiabilityStudyDigest_Combo)
{
    ...
    auto* style = MakeGarbageCollected<V8UnionCSSColorValueOrCanvasGradientOrCanvasPatternOrString>("red");
    Context2D()->setFillStyle(style);
    Context2D()->fillText("Bye", 4.0, 3.0);
    EXPECT_EQ(INT64_C(5574475585707445774), Context2D()->IdentifiableTextToken().ToUkmMetricValue());
