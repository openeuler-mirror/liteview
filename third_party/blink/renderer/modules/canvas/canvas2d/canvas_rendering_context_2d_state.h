...
class CanvasRenderingContext2DState final : public GarbageCollected<CanvasRenderingContext2DState>, public FontSelectorClient {
public:
    ...
    enum class SaveType { kSaveRestore, kBeginEndLayer, kInternalLayer, kInitial };
    ...
    {
        return stroke_style_.Get();
    }

    void SetFillStyle(CanvasStyle*);
    CanvasStyle* FillStyle() const
    {
        return fill_style_.Get();
    }
    ...
    void SetTextRendering(TextRenderingMode text_rendering, FontSelector* selector);
    TextRenderingMode GetTextRendering() const
    {
    ...
    const String& UnparsedStrokeColor() const
    {
        return unparsed_stroke_color_;
    }
    ...
    const String& UnparsedFillColor() const
    {
        return unparsed_fill_color_;
    }
...
{
    return SkColorGetA(shadow_color_) && (shadow_blur_ || !shadow_offset_.IsZero());
}
