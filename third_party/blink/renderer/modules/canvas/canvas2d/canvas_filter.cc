...
CanvasFilter* CanvasFilter::Create(ExecutionContext* execution_context, const V8CanvasFilterInput* init, ExceptionState& exception_state)
{
    ...
    FilterOperations filter_operations = CanvasFilterOperationResolver::CreateFilterOperations(execution_context, filter_array, exception_state);
