...
public:
    ...
    void SetIsInHiddenPage(bool) final
    {
        NOTREACHED();
    }
    void SetIsBeingDisplayed(bool) final
    {
        NOTREACHED();
    }
    void Stop() final
...
private:
    ...
    void DrawTextInternal(const String&, double, double, CanvasRenderingContext2DState::PaintType, double* max_width = nullptr);
