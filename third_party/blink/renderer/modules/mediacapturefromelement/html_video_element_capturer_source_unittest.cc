...
TEST_F(HTMLVideoElementCapturerSourceTest, EmptyWebMediaPlayerFailsCapture)
{
    ...
    html_video_capturer_->StartCapture(media::VideoCaptureParams(),
        WTF::BindRepeating(&HTMLVideoElementCapturerSourceTest::OnDeliverFrame, base::Unretained(this)), base::DoNothing(),
...
TEST_P(HTMLVideoElementCapturerSourceTest, GetFormatsAndStartAndStop)
{
    ...
    html_video_capturer_->StartCapture(params, WTF::BindRepeating(&HTMLVideoElementCapturerSourceTest::OnDeliverFrame, base::Unretained(this)),
        base::DoNothing(), WTF::BindRepeating(&HTMLVideoElementCapturerSourceTest::OnRunning, base::Unretained(this)));
