...
class MapIterationSource final : public PairIterable<Member<V8BufferSource>, V8BufferSource, String, IDLString>::IterationSource {
public:
    ...
    bool Next(ScriptState* script_state, Member<V8BufferSource>& key, String& value, ExceptionState&) override
    {
    ...
    {
        visitor->Trace(map_);
        PairIterable<Member<V8BufferSource>, V8BufferSource, String, IDLString>::IterationSource::Trace(visitor);
    }
...
MediaKeyStatusMap::IterationSource* MediaKeyStatusMap::StartIteration(ScriptState*, ExceptionState&)
{
