...
public:
    NewCdmResultPromise(ScriptState* script_state, const MediaKeysConfig& config, const WebVector<WebEncryptedMediaSessionType>& supported_session_types)
        : ContentDecryptionModuleResultPromise(script_state, config, EmeApiType::kCreateMediaKeys)
        , config_(config)
    ...
    void CompleteWithContentDecryptionModule(WebContentDecryptionModule* cdm) override
    {
        ...
        auto* media_keys = MakeGarbageCollected<MediaKeys>(GetExecutionContext(), supported_session_types_, base::WrapUnique(cdm), config_);
...
MediaKeySystemConfiguration* MediaKeySystemAccess::getConfiguration() const
{
    ...
    result->setDistinctiveIdentifier(EncryptedMediaUtils::ConvertMediaKeysRequirementToString(configuration.distinctive_identifier));
    result->setPersistentState(EncryptedMediaUtils::ConvertMediaKeysRequirementToString(configuration.persistent_state));
...
ScriptPromise MediaKeySystemAccess::createMediaKeys(ScriptState* script_state)
{
    ...
    NewCdmResultPromise* helper = MakeGarbageCollected<NewCdmResultPromise>(script_state, config, configuration.session_types);
