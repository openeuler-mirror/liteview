...
public:
    ...
    DocumentFragment* sanitize(ScriptState* script_state, const V8SanitizerInput* input, ExceptionState& exception_state);
    Element* sanitizeFor(ScriptState* script_state, const String& element, const String& markup, ExceptionState& exception_state);
    ...
    void ElementSetHTML(ScriptState* script_state, Element& element, const String& markup, ExceptionState& exception_state);
...
private:
    ...
    DocumentFragment* PrepareFragment(LocalDOMWindow* window, ScriptState* script_state, const V8SanitizerInput* input, ExceptionState& exception_state);
