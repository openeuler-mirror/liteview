...
SanitizerConfigImpl::AttributeList AttributesFromAPI(const char* const* attributes)
{
...
SanitizerConfigImpl BuildDefaultConfigImpl(const char* const* elements, const char* const* attributes)
{
...
{
    DEFINE_STATIC_LOCAL(SanitizerConfigImpl, config_, (BuildDefaultConfigImpl(kDefaultElements, kDefaultAttributes)));
    return config_;
}

const SanitizerConfigImpl::ElementList& GetBaselineAllowElements()
{
    DEFINE_STATIC_LOCAL(SanitizerConfigImpl::ElementList, elements_, (ElementsFromAPI(kBaselineElements)));
    return elements_;
}

const SanitizerConfigImpl::AttributeList& GetBaselineAllowAttributes()
{
    DEFINE_STATIC_LOCAL(SanitizerConfigImpl::AttributeList, attributes_, (AttributesFromAPI(kBaselineAttributes)));
    return attributes_;
}

const SanitizerConfigImpl::AttributeList& GetKnownAttributes()
{
    DEFINE_STATIC_LOCAL(SanitizerConfigImpl::AttributeList, attributes_, (AttributesFromAPI(kKnownAttributes)));
    return attributes_;
}
...
const SanitizerConfigImpl& GetDefaultConfig()
{
    return WithNamespaces() ? with_namespace_names::GetDefaultConfig() : default_config_names::GetDefaultConfig();
}

const SanitizerConfigImpl::ElementList& GetBaselineAllowElements()
{
    return WithNamespaces() ? with_namespace_names::GetBaselineAllowElements() : default_config_names::GetBaselineAllowElements();
}

const SanitizerConfigImpl::AttributeList& GetBaselineAllowAttributes()
{
    return WithNamespaces() ? with_namespace_names::GetBaselineAllowAttributes() : default_config_names::GetBaselineAllowAttributes();
}

const SanitizerConfigImpl::AttributeList& GetKnownAttributes()
{
    return WithNamespaces() ? with_namespace_names::GetKnownAttributes() : default_config_names::GetKnownAttributes();
}
