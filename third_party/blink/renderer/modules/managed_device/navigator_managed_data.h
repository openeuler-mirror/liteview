...
class MODULES_EXPORT NavigatorManagedData final : public EventTargetWithInlineData,
...
public:
    ...
    ScriptPromise getManagedConfiguration(ScriptState* script_state, Vector<String> keys);
...
private:
    ...
    void OnConfigurationReceived(ScriptPromiseResolver* scoped_resolver, const absl::optional<HashMap<String, String>>& configurations);

    void OnAttributeReceived(ScriptState* script_state, ScriptPromiseResolver* scoped_resolver, mojom::blink::DeviceAttributeResultPtr result);
