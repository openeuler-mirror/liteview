...
public:
    PressureObserver(V8PressureUpdateCallback*, PressureObserverOptions*, ExceptionState&);
    ~PressureObserver() override;

    static PressureObserver* Create(V8PressureUpdateCallback*, PressureObserverOptions*, ExceptionState&);
    ...
    void OnUpdate(ExecutionContext*, V8PressureSource::Enum, V8PressureState::Enum, const Vector<V8PressureFactor>&, DOMHighResTimeStamp);
...
private:
    ...
    bool HasChangeInData(V8PressureSource::Enum, V8PressureState::Enum, const Vector<V8PressureFactor>&) const;
