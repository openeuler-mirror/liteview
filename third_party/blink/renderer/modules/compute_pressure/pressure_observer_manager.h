...
private:
    ...
    void DidBindObserver(V8PressureSource, blink::PressureObserver*, mojom::blink::PressureStatus);
    ...
    HeapMojoReceiver<mojom::blink::PressureObserver, PressureObserverManager> receiver_;

    HeapHashSet<Member<blink::PressureObserver>> registering_observers_[kPressureSourceSize];

    HeapHashSet<Member<blink::PressureObserver>> registered_observers_[kPressureSourceSize];
};
