...
public:
    ...
    ScriptPromise request(ScriptState*, V8WakeLockType type, ExceptionState& exception_state);
...
private:
    ...
    void DidReceivePermissionResponse(V8WakeLockType::Enum, ScriptPromiseResolver*, mojom::blink::PermissionStatus);
