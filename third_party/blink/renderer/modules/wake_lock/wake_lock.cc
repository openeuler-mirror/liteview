...
ScriptPromise WakeLock::request(ScriptState* script_state, V8WakeLockType type, ExceptionState& exception_state)
{
    ...
    if (context->IsDedicatedWorkerGlobalScope()) {
        ...
        if (type == V8WakeLockType::Enum::kScreen && !LocalFrame::HasTransientUserActivation(window->GetFrame())) {
            UseCounter::Count(context, WebFeature::kWakeLockAcquireScreenLockWithoutActivation);
        }
    }
...
void WakeLock::DoRequest(V8WakeLockType::Enum type, ScriptPromiseResolver* resolver)
{
    // https://w3c.github.io/screen-wake-lock/#the-request-method
...
void WakeLock::DidReceivePermissionResponse(V8WakeLockType::Enum type, ScriptPromiseResolver* resolver, PermissionStatus status)
{
    // https://w3c.github.io/screen-wake-lock/#the-request-method
