...
TEST(WakeLockManagerTest, AcquireWakeLock)
{
    ...
    auto* resolver1 = MakeGarbageCollected<ScriptPromiseResolver>(context.GetScriptState());
    ScriptPromise promise1 = resolver1->Promise();
    auto* resolver2 = MakeGarbageCollected<ScriptPromiseResolver>(context.GetScriptState());
    ...
    auto* sentinel1 = ScriptPromiseUtils::GetPromiseResolutionAsWakeLockSentinel(promise1);
    auto* sentinel2 = ScriptPromiseUtils::GetPromiseResolutionAsWakeLockSentinel(promise2);
...
TEST(WakeLockManagerTest, ReleaseAllWakeLocks)
{
    ...
    auto* resolver = MakeGarbageCollected<ScriptPromiseResolver>(context.GetScriptState());
    ...
    auto* sentinel = ScriptPromiseUtils::GetPromiseResolutionAsWakeLockSentinel(promise);
