...
private:
    ...
    absl::optional<mojom::blink::PermissionStatus> permission_responses_[V8WakeLockType::kEnumSize];
...
public:
    ...
    static v8::Promise::PromiseState GetPromiseState(const ScriptPromise& promise);
    ...
    static WakeLockSentinel* GetPromiseResolutionAsWakeLockSentinel(const ScriptPromise&);
};
