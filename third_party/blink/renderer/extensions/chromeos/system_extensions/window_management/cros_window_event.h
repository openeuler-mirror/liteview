...
public:
    static CrosWindowEvent* Create(const AtomicString& type, const CrosWindowEventInit* event_init);

    CrosWindowEvent(const AtomicString& type, const CrosWindowEventInit* event_init);
