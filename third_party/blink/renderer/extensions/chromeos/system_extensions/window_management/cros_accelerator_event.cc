...
CrosAcceleratorEvent* CrosAcceleratorEvent::Create(const AtomicString& type, const CrosAcceleratorEventInit* event_init)
{
    return MakeGarbageCollected<CrosAcceleratorEvent>(type, event_init);
}

CrosAcceleratorEvent::CrosAcceleratorEvent(const AtomicString& type, const CrosAcceleratorEventInit* event_init)
