...
public:
    static CrosAcceleratorEvent* Create(const AtomicString& type, const CrosAcceleratorEventInit* event_init);

    CrosAcceleratorEvent(const AtomicString& type, const CrosAcceleratorEventInit* event_init);
    ~CrosAcceleratorEvent() override;

    const String& acceleratorName()
    {
