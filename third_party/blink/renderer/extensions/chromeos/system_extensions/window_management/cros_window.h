...
public:
    ...
    CrosWindow(CrosWindowManagement* manager, mojom::blink::CrosWindowInfoPtr window);
    ...
    ScriptPromise moveBy(ScriptState* script_state, int32_t delta_x, int32_t delta_y);
    ScriptPromise resizeTo(ScriptState* script_state, int32_t width, int32_t height);
    ScriptPromise resizeBy(ScriptState* script_state, int32_t delta_width, int32_t delta_height);
