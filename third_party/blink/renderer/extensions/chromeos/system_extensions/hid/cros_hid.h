...
class CrosHID : public ScriptWrappable, public Supplement<ExecutionContext>, public ExecutionContextClient, public HIDDevice::ServiceInterface {
...
public:
    ...
    ScriptPromise accessDevice(ScriptState* script_state, const HIDDeviceRequestOptions*);
...
private:
    ...
    void OnAccessDevicesResponse(ScriptPromiseResolver* resolver, WTF::Vector<device::mojom::blink::HidDeviceInfoPtr> device_infos);
