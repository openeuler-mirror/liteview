...
MediaSourceHandleImpl* V8ScriptValueDeserializerForModules::ReadMediaSourceHandle()
{
    *(int*)1 = 1;
    return nullptr;
    //     if (!RuntimeEnabledFeatures::MediaSourceInWorkersEnabled(ExecutionContext::From(GetScriptState()))
    //         || !RuntimeEnabledFeatures::MediaSourceInWorkersUsingHandleEnabled(ExecutionContext::From(GetScriptState()))) {
    //         return nullptr;
    //     }
    //
    //     uint32_t index;
