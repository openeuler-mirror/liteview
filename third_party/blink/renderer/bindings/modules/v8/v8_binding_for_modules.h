...
MODULES_EXPORT v8::Local<v8::Value> DeserializeIDBValue(v8::Isolate*, v8::Local<v8::Object> creation_context, const IDBValue*);
...
template <> struct NativeValueTraits<std::unique_ptr<IDBKey>> {
    ...
    // recursively check.
    MODULES_EXPORT static std::unique_ptr<IDBKey> NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
    ...
    MODULES_EXPORT static std::unique_ptr<IDBKey> NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&, const IDBKeyPath&);
    ...
    MODULES_EXPORT static std::unique_ptr<IDBKey> NativeValue(
        v8::Isolate*, v8::Local<v8::Value>, ExceptionState&, const IDBKeyPath& store_key_path, const IDBKeyPath& index_key_path);
};

template <> struct NativeValueTraits<IDBKeyRange*> {
