...
void V8PromiseRejectionEvent::PromiseAttributeGetterCustom(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    PromiseRejectionEvent* event = V8PromiseRejectionEvent::ToImplWithTypeCheck(isolate, info.Holder());
    if (!event) {
        ExceptionState exception_state(isolate, ExceptionState::kGetterContext, "PromiseRejectionEvent", "promise");
