...
void PagePopupControllerAttributeGetter(const v8::PropertyCallbackInfo<v8::Value>& info)
{
    ...
    V8SetReturnValue(info, ToV8Traits<PagePopupController>::ToV8(ScriptState::From(info.GetIsolate()->GetCurrentContext()), cpp_value).ToLocalChecked());
}
...
void V8PagePopupControllerBinding::InstallPagePopupController(v8::Local<v8::Context> context, v8::Local<v8::Object> window_wrapper)
{
    ...
    window_wrapper->SetAccessor(context, V8AtomicString(context->GetIsolate(), "pagePopupController"), PagePopupControllerAttributeGetterCallback).ToChecked();
}
