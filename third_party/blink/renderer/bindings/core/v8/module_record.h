...
public:
    static v8::Local<v8::Module> Compile(ScriptState*, const ModuleScriptCreationParams& params, const ScriptFetchOptions&, const TextPosition&,
        ExceptionState&, mojom::blink::V8CacheOptions = mojom::blink::V8CacheOptions::kDefault,
...
private:
    static v8::MaybeLocal<v8::Module> ResolveModuleCallback(
        v8::Local<v8::Context>, v8::Local<v8::String> specifier, v8::Local<v8::FixedArray> import_assertions, v8::Local<v8::Module> referrer);
};
