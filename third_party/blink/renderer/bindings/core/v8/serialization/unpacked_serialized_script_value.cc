    ...
    : value_(std::move(value))
{
    ...
    if (!array_buffer_contents.empty()) {
        ...
        std::transform(
            array_buffer_contents.begin(), array_buffer_contents.end(), array_buffers_.begin(), [](ArrayBufferContents& contents) -> DOMArrayBufferBase* {
    ...
    if (!image_bitmap_contents.empty()) {
        ...
        std::transform(image_bitmap_contents.begin(), image_bitmap_contents.end(), image_bitmaps_.begin(),
