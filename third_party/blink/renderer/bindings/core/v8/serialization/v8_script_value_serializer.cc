    ...
    v8::Isolate* isolate, v8::Local<v8::Value> object, wtf_size_t object_index, Transferables& transferables, ExceptionState& exception_state)
{
    ...
    if (V8MessagePort::HasInstance(object, isolate)) {
        MessagePort* port = V8MessagePort::ToImpl(v8::Local<v8::Object>::Cast(object));
    ...
    if (V8MojoHandle::HasInstance(object, isolate)) {
        MojoHandle* handle = V8MojoHandle::ToImpl(v8::Local<v8::Object>::Cast(object));
    ...
    if (object->IsArrayBuffer()) {
        DOMArrayBuffer* array_buffer = NativeValueTraits<DOMArrayBuffer>::NativeValue(isolate, object, exception_state);
    ...
    if (object->IsSharedArrayBuffer()) {
        DOMSharedArrayBuffer* shared_array_buffer = NativeValueTraits<DOMSharedArrayBuffer>::NativeValue(isolate, object, exception_state);
        if (exception_state.HadException())
            return false;
    ...
    if (V8ImageBitmap::HasInstance(object, isolate)) {
        ImageBitmap* image_bitmap = V8ImageBitmap::ToImpl(v8::Local<v8::Object>::Cast(object));
    ...
    if (V8OffscreenCanvas::HasInstance(object, isolate)) {
        OffscreenCanvas* offscreen_canvas = V8OffscreenCanvas::ToImpl(v8::Local<v8::Object>::Cast(object));
    ...
    if (V8ReadableStream::HasInstance(object, isolate)) {
        ReadableStream* stream = V8ReadableStream::ToImpl(v8::Local<v8::Object>::Cast(object));
    ...
    if (V8WritableStream::HasInstance(object, isolate)) {
        WritableStream* stream = V8WritableStream::ToImpl(v8::Local<v8::Object>::Cast(object));
    ...
    if (V8TransformStream::HasInstance(object, isolate)) {
        TransformStream* stream = V8TransformStream::ToImpl(v8::Local<v8::Object>::Cast(object));
...
scoped_refptr<SerializedScriptValue> V8ScriptValueSerializer::Serialize(v8::Local<v8::Value> value, ExceptionState& exception_state)
{
    ...
    base::AutoReset<const ExceptionState*> reset(&exception_state_, &exception_state);
    ...
    serialized_script_value_->SetData(SerializedScriptValue::DataBufferPtr(buffer.first), buffer.second);
...
void V8ScriptValueSerializer::PrepareTransfer(ExceptionState& exception_state)
{
    ...
    for (uint32_t i = 0; i < transferables_->array_buffers.size(); i++) {
        ...
        if (!array_buffer->IsShared()) {
            v8::Local<v8::Value> wrapper = ToV8Traits<DOMArrayBuffer>::ToV8(script_state_, static_cast<DOMArrayBuffer*>(array_buffer)).ToLocalChecked();
...
bool V8ScriptValueSerializer::WriteDOMObject(ScriptWrappable* wrappable, ExceptionState& exception_state)
{
    ...
    if (auto* canvas = dispatcher.ToMostDerived<OffscreenCanvas>()) {
        ...
        if (canvas->IsNeutered()) {
            exception_state.ThrowDOMException(DOMExceptionCode::kDataCloneError, "An OffscreenCanvas could not be cloned because it was detached.");
            return false;
        }
...
bool V8ScriptValueSerializer::WriteFile(File* file, ExceptionState& exception_state)
{
    ...
    if (blob_info_array_) {
        ...
        absl::optional<base::Time> last_modified = file->LastModifiedTimeForSerialization();
        WriteDouble(last_modified ? last_modified->ToJsTimeIgnoringNull() : std::numeric_limits<double>::quiet_NaN());
...
void V8ScriptValueSerializer::ThrowDataCloneError(v8::Local<v8::String> v8_message)
{
    ...
    ExceptionState exception_state(script_state_->GetIsolate(), exception_state_->GetContext());
    exception_state.ThrowDOMException(DOMExceptionCode::kDataCloneError, ToBlinkString<String>(v8_message, kDoNotExternalize));
}
...
v8::Maybe<bool> V8ScriptValueSerializer::WriteHostObject(v8::Isolate* isolate, v8::Local<v8::Object> object)
{
    ...
    if (!exception_state.HadException()) {
        StringView interface_name = wrappable->GetWrapperTypeInfo()->interface_name;
        exception_state.ThrowDOMException(DOMExceptionCode::kDataCloneError, interface_name + " object could not be cloned.");
    }
    return v8::Nothing<bool>();
}
...
v8::Maybe<uint32_t> V8ScriptValueSerializer::GetWasmModuleTransferId(v8::Isolate* isolate, v8::Local<v8::WasmModuleObject> module)
{
    if (for_storage_) {
        ...
        DCHECK_EQ(isolate, script_state_->GetIsolate());
        ExceptionState exception_state(isolate, exception_state_->GetContext());
        exception_state.ThrowDOMException(DOMExceptionCode::kDataCloneError, "A WebAssembly.Module can not be serialized for storage.");
        return v8::Nothing<uint32_t>();
    }
