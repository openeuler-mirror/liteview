...
public:
    ...
    {
        logged_activities_.push_back(api_name + " | " + ToCoreStringWithUndefinedOrNullCheck(new_value));
    }
    ...
    void LogMethod(const String& api_name, int argc, const v8::Local<v8::Value>* argv) override
    {
        ...
        for (int i = 0; i < argc; i++) {
            activity_string = activity_string + " | " + ToCoreStringWithUndefinedOrNullCheck(argv[i]);
        }
