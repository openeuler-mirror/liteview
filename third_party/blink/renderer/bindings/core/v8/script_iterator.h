...
public:
    ...
    //   property.
    static ScriptIterator FromIterable(v8::Isolate* isolate, v8::Local<v8::Object> iterable, ExceptionState& exception_state);
    ...
    bool Next(ExecutionContext* execution_context, ExceptionState& exception_state, v8::Local<v8::Value> value = v8::Local<v8::Value>());
...
private:
    ...
    ScriptIterator(v8::Isolate*, v8::Local<v8::Object> iterator, v8::Local<v8::Value> next_method);
