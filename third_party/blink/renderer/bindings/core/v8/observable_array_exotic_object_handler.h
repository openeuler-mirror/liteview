...
public:
    ...
    static void TrapDefineProperty(const v8::FunctionCallbackInfo<v8::Value>& info)
    {
        ...
        ExceptionState exception_state(
            isolate, ExceptionContext::Context::kOperationInvoke, BackingListWrappable::ObservableArrayNameInIDL(), "defineProperty");
    ...
    static void TrapDeleteProperty(const v8::FunctionCallbackInfo<v8::Value>& info)
    {
        ...
        if (!(info[0]->IsArray() && info[1]->IsName())) {
            ExceptionState exception_state(
                isolate, ExceptionContext::Context::kOperationInvoke, BackingListWrappable::ObservableArrayNameInIDL(), "deleteProperty");
            exception_state.ThrowTypeError("Invalid argument.");
            return;
        }
        v8::Local<v8::Array> v8_target = info[0].As<v8::Array>();
        ...
        if (v8_property->IsString()) {
            ...
            if (v8_property->ToArrayIndex(current_context).ToLocal(&v8_index)) {
                ...
                ExceptionState exception_state(isolate, ExceptionContext::Context::kIndexedPropertyDelete, BackingListWrappable::ObservableArrayNameInIDL());
    ...
    static void TrapGet(const v8::FunctionCallbackInfo<v8::Value>& info)
    {
        ...
        v8::Local<v8::Context> current_context = isolate->GetCurrentContext();
        if (!(info[0]->IsArray() && info[1]->IsName())) {
            ExceptionState exception_state(isolate, ExceptionContext::Context::kOperationInvoke, BackingListWrappable::ObservableArrayNameInIDL(), "get");
            exception_state.ThrowTypeError("Invalid argument.");
            return;
        }
        v8::Local<v8::Array> v8_target = info[0].As<v8::Array>();
        ...
        if (v8_property->IsString()) {
            ...
            if (v8_property->ToArrayIndex(current_context).ToLocal(&v8_index)) {
                ...
                ScriptState* script_state = ScriptState::From(current_context);
                if (!ToV8Traits<ElementIdlType>::ToV8(script_state, backing_list[index]).ToLocal(&v8_element)) {
                    return;
                }
    ...
    static void TrapGetOwnPropertyDescriptor(const v8::FunctionCallbackInfo<v8::Value>& info)
    {
        ...
        if (!(info[0]->IsArray() && info[1]->IsName())) {
            ExceptionState exception_state(
                isolate, ExceptionContext::Context::kOperationInvoke, BackingListWrappable::ObservableArrayNameInIDL(), "getOwnPropertyDescriptor");
            exception_state.ThrowTypeError("Invalid argument.");
            return;
        }
        v8::Local<v8::Array> v8_target = info[0].As<v8::Array>();
    ...
    static void TrapHas(const v8::FunctionCallbackInfo<v8::Value>& info)
    {
        ...
        v8::Local<v8::Context> current_context = isolate->GetCurrentContext();
        if (!(info[0]->IsArray() && info[1]->IsName())) {
            ExceptionState exception_state(isolate, ExceptionContext::Context::kOperationInvoke, BackingListWrappable::ObservableArrayNameInIDL(), "has");
            exception_state.ThrowTypeError("Invalid argument.");
            return;
        }
        v8::Local<v8::Array> v8_target = info[0].As<v8::Array>();
    ...
    static void TrapOwnKeys(const v8::FunctionCallbackInfo<v8::Value>& info)
    {
        ...
        v8::Local<v8::Context> current_context = isolate->GetCurrentContext();
        if (!info[0]->IsArray()) {
            ExceptionState exception_state(isolate, ExceptionContext::Context::kOperationInvoke, BackingListWrappable::ObservableArrayNameInIDL(), "ownKeys");
            exception_state.ThrowTypeError("Invalid argument.");
            return;
        }
        v8::Local<v8::Array> v8_target = info[0].As<v8::Array>();
        ...
        if (!ToV8Traits<IDLSequence<IDLString>>::ToV8(ScriptState::From(current_context), keys_vector).ToLocal(&own_keys_as_value)) {
            return;
        }
    ...
    static void TrapSet(const v8::FunctionCallbackInfo<v8::Value>& info)
    {
        ...
        v8::Local<v8::Context> current_context = isolate->GetCurrentContext();
        if (!(info[0]->IsArray() && info[1]->IsName())) {
            ExceptionState exception_state(isolate, ExceptionContext::Context::kOperationInvoke, BackingListWrappable::ObservableArrayNameInIDL(), "set");
            exception_state.ThrowTypeError("Invalid argument.");
            return;
        }
        v8::Local<v8::Array> v8_target = info[0].As<v8::Array>();
        ...
        if (v8_property->IsString()) {
            v8::Local<v8::Uint32> v8_index;
            if (v8_property->ToArrayIndex(current_context).ToLocal(&v8_index)) {
                ExceptionState exception_state(isolate, ExceptionContext::Context::kIndexedPropertySet, BackingListWrappable::ObservableArrayNameInIDL());
                uint32_t index = v8_index->Value();
            ...
            if (v8_property.As<v8::String>()->StringEquals(V8AtomicString(isolate, "length"))) {
                ExceptionState exception_state(isolate, ExceptionContext::Context::kAttributeSet, BackingListWrappable::ObservableArrayNameInIDL(), "length");
...
private:
    ...
    {
        bindings::ObservableArrayBase* base = bindings::ObservableArrayExoticObjectImpl::ProxyTargetToObservableArrayBaseOrDie(isolate, target);
        ...
        typename BackingListWrappable::value_type& value, ExceptionState& exception_state)
    {
        ...
        (backing_list.GetPlatformObject()->*backing_list.set_algorithm_callback_)(script_state, backing_list, index, value, exception_state);
        ...
        ScriptState* script_state, BackingListWrappable& backing_list, typename BackingListWrappable::size_type index, ExceptionState& exception_state)
    {
        ...
        (backing_list.GetPlatformObject()->*backing_list.delete_algorithm_callback_)(script_state, backing_list, index, exception_state);
        return !exception_state.HadException();
    }
};
