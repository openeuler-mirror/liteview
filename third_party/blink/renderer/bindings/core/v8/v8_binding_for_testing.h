...
public:
    ...
    static std::unique_ptr<DummyPageHolder> CreateDummyPageHolder(const KURL& url);
...
public:
    ...
    void RunV8FullGC(v8::EmbedderHeapTracer::EmbedderStackState stack_state = v8::EmbedderHeapTracer::EmbedderStackState::kNoHeapPointers)
    {
