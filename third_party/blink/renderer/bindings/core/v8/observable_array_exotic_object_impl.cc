...
// static
const WrapperTypeInfo& ObservableArrayExoticObjectImpl::wrapper_type_info_ = kWrapperTypeInfoBody;

// static
bindings::ObservableArrayBase* ObservableArrayExoticObjectImpl::ProxyTargetToObservableArrayBaseOrDie(
    v8::Isolate* isolate, v8::Local<v8::Array> v8_proxy_target)
{
    ...
    return ToScriptWrappable(backing_list_wrapper.As<v8::Object>())->ToImpl<bindings::ObservableArrayBase>();
}

ObservableArrayExoticObjectImpl::ObservableArrayExoticObjectImpl(bindings::ObservableArrayBase* observable_array_backing_list_object)
    : ObservableArrayExoticObject(observable_array_backing_list_object)
{
}

v8::MaybeLocal<v8::Value> ObservableArrayExoticObjectImpl::Wrap(ScriptState* script_state)
{
    ...
    if (!ToV8Traits<bindings::ObservableArrayBase>::ToV8(script_state, GetBackingListObject()).ToLocal(&backing_list_wrapper)) {
        return {};
    }
    CHECK(backing_list_wrapper->IsObject());
    ...
    if (!GetBackingListObject()->GetProxyHandlerObject(script_state).ToLocal(&handler)) {
        return {};
    }
    v8::Local<v8::Proxy> proxy;
    if (!v8::Proxy::New(script_state->GetContext(), target.As<v8::Object>(), handler).ToLocal(&proxy)) {
        return {};
    }
