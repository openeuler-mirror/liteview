...
public:
    ...
    template <typename T> V8ObjectBuilder& Add(const StringView& name, const T& value)
    {
        AddInternal(name, v8::Local<v8::Value>(ToV8(value, script_state_->GetContext()->Global(), script_state_->GetIsolate())));
        return *this;
    }
