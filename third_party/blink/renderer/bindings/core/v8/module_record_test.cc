...
TEST_F(ModuleRecordTest, compileFail)
{
    V8TestingScope scope;
    const KURL js_url("https://example.com/foo.js");
    v8::Local<v8::Module> module = ModuleTestBase::CompileModule(scope.GetScriptState(), "123 = 456", js_url, scope.GetExceptionState());
...
TEST_F(ModuleRecordTest, EvaluationErrorIsRemembered)
{
    ...
    v8::Local<v8::Module> module
        = ModuleTestBase::CompileModule(scope.GetScriptState(), "import 'failure'; export const c = 123;", js_url_c, scope.GetExceptionState());
    ASSERT_FALSE(module.IsEmpty());
