...
public:
    ...
    static bool ConvertEncoding(const char* encoding_name, v8::ScriptCompiler::StreamedSource::Encoding*);
};
...
public:
    ...
    static std::tuple<ResourceScriptStreamer*, NotStreamingReason> TakeFrom(ScriptResource* resource, mojom::blink::ScriptType expected_type);
...
public:
    BackgroundInlineScriptStreamer(const String& text, v8::ScriptCompiler::CompileOptions compile_options);
