...
inline v8::Local<v8::Value> ToV8(const ScriptPromise& value, v8::Local<v8::Object> creation_context, v8::Isolate* isolate)
{
...
inline v8::Local<v8::Value> ToV8(const ScriptValue& value, v8::Local<v8::Object> creation_context, v8::Isolate* isolate)
{
    if (value.IsEmpty())
...
inline v8::Local<v8::Value> ToV8(const DisallowNewWrapper<ScriptValue>* value, v8::Local<v8::Object> creation_context, v8::Isolate* isolate)
{
...
// and ScriptValue
template <typename T> inline ScriptValue ScriptValue::From(ScriptState* script_state, T&& value)
{
