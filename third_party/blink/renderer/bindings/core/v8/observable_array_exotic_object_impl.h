...
class CORE_EXPORT ObservableArrayExoticObjectImpl final : public ObservableArrayExoticObject {
    DEFINE_WRAPPERTYPEINFO();

public:
    // Returns the backing list object extracted from the proxy target object
    // of type JS Array.
    static bindings::ObservableArrayBase* ProxyTargetToObservableArrayBaseOrDie(v8::Isolate* isolate, v8::Local<v8::Array> v8_proxy_target);

    explicit ObservableArrayExoticObjectImpl(bindings::ObservableArrayBase* observable_array_backing_list_object);
