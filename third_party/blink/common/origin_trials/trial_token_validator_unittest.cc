...
public:
    ...
    base::Time Now()
    {
        return base::Time::FromDoubleT(kNowTimestamp);
    }
...
public:
    ...
    virtual TrialTokenResult Validate(base::StringPiece token, const url::Origin& origin, base::Time timestamp) const
    {
        return validator_.ValidateToken(token, origin, timestamp);
    }

    virtual TrialTokenResult Validate(
        base::StringPiece token, const url::Origin& origin, base::span<const url::Origin> script_origins, base::Time timestamp) const
    {
...
public:
    ...
    TrialTokenResult Validate(base::StringPiece token, const url::Origin& origin, base::Time timestamp) const override
    {
        return validator_.ValidateTokenAndTrial(token, origin, timestamp);
    }

    TrialTokenResult Validate(
        base::StringPiece token, const url::Origin& origin, base::span<const url::Origin> script_origins, base::Time timestamp) const override
    {
...
public:
    ...
    TrialTokenResult Validate(base::StringPiece token, const url::Origin& origin, base::Time timestamp) const
    {
        return validator_wrapper_->Validate(token, origin, timestamp);
    }

    TrialTokenResult Validate(base::StringPiece token, const url::Origin& origin, base::span<const url::Origin> script_origins, base::Time timestamp) const
    {
