...
// set to "1" for force enable, or "0" for force disable.
extern const char kSetTimeoutWithout1MsClampPolicy[] = "set-timeout-without-1ms-clamp-policy";
...
extern const char kUnthrottledNestedTimeoutPolicy[] = "unthrottled-nested-timeout-level-policy";
...
const char kWebSQLNonSecureContextEnabled[] = "web-sql-non-secure-context-enabled";
