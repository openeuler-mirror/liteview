...
template <> class StructTraits<blink::mojom::MobileFriendlinessDataView, blink::MobileFriendliness> {
public:
    static bool viewport_device_width(const blink::MobileFriendliness& mf)
    {
        return mf.viewport_device_width;
    }
    static double viewport_initial_scale_x10(const blink::MobileFriendliness& mf)
    {
    ...
    static int text_content_outside_viewport_percentage(const blink::MobileFriendliness& mf)
    {
    ...
    static bool Read(blink::mojom::MobileFriendlinessDataView data, blink::MobileFriendliness* mf);
};
