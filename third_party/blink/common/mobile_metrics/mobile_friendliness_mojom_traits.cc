...
bool StructTraits<blink::mojom::MobileFriendlinessDataView, blink::MobileFriendliness>::Read(
    blink::mojom::MobileFriendlinessDataView data, blink::MobileFriendliness* mf)
{
    ...
    mf->text_content_outside_viewport_percentage = data.text_content_outside_viewport_percentage();
