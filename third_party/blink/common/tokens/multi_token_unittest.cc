...
static_assert(internal::MultiTokenVariantCount<FooToken, BarToken>::kValue == 2, "unexpected count");
static_assert(internal::MultiTokenVariantCount<FooToken, BarToken, BazToken>::kValue == 3, "unexpected count");

// Test MultiTokenTypeRepeated.
static_assert(!internal::MultiTokenTypeRepeated<FooToken>::kValue, "unexpected repeated value");
...
static_assert(internal::MultiTokenVariantIsTokenType<FooToken>::kValue, "unexpected is token type value");
static_assert(!internal::MultiTokenVariantIsTokenType<int>::kValue, "unexpected is token type value");

// Test MultiTokenAllVariantsAreTokenType.
static_assert(internal::MultiTokenAllVariantsAreTokenType<FooToken, BarToken>::kValue, "unexpected all variants are token type value");
static_assert(!internal::MultiTokenAllVariantsAreTokenType<FooToken, BarToken, int>::kValue, "unexpected all variants are token type value");
