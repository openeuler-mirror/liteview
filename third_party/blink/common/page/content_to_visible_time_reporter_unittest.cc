...
protected:
    ContentToVisibleTimeReporterTest()
        : tab_state_(GetParam())
    {
        scoped_feature_list_.InitWithFeatureState(blink::features::kTabSwitchMetrics2, tab_state_.tab_switch_metrics2_enabled);

        duration_histograms_.push_back(base::StrCat({ "Browser.Tabs.TotalSwitchDuration.", tab_state_.histogram_suffix }));
        incomplete_duration_histograms_.push_back(base::StrCat({ "Browser.Tabs.TotalIncompleteSwitchDuration.", tab_state_.histogram_suffix }));
        result_histograms_.push_back(base::StrCat({ "Browser.Tabs.TabSwitchResult.", tab_state_.histogram_suffix }));
        ...
        if (tab_state_.tab_switch_metrics2_enabled) {
            ...
            duration_histograms_.push_back(base::StrCat({ "Browser.Tabs.TotalSwitchDuration2.", tab_state_.histogram_suffix }));
            incomplete_duration_histograms_.push_back(base::StrCat({ "Browser.Tabs.TotalIncompleteSwitchDuration2.", tab_state_.histogram_suffix }));
            result_histograms_.push_back(base::StrCat({ "Browser.Tabs.TabSwitchResult2.", tab_state_.histogram_suffix }));
        }
    ...
    {
        constexpr const char* kAllHistograms[] = { // Pre-TabSwitchMetrics2 feature.
            "Browser.Tabs.TotalSwitchDuration.WithSavedFrames", "Browser.Tabs.TotalSwitchDuration.NoSavedFrames_Loaded",
            "Browser.Tabs.TotalSwitchDuration.NoSavedFrames_NotLoaded", "Browser.Tabs.TotalIncompleteSwitchDuration.WithSavedFrames",
            "Browser.Tabs.TotalIncompleteSwitchDuration.NoSavedFrames_Loaded",
            "Browser.Tabs.TotalIncompleteSwitchDuration.NoSavedFrames_"
            "NotLoaded",
            "Browser.Tabs.TabSwitchResult.WithSavedFrames", "Browser.Tabs.TabSwitchResult.NoSavedFrames_Loaded",
            "Browser.Tabs.TabSwitchResult.NoSavedFrames_NotLoaded",
            // With TabSwitchMetrics2 feature.
            "Browser.Tabs.TotalSwitchDuration2.WithSavedFrames", "Browser.Tabs.TotalSwitchDuration2.NoSavedFrames_Loaded",
            "Browser.Tabs.TotalSwitchDuration2.NoSavedFrames_NotLoaded", "Browser.Tabs.TotalIncompleteSwitchDuration2.WithSavedFrames",
            "Browser.Tabs.TotalIncompleteSwitchDuration2.NoSavedFrames_"
            "Loaded",
            "Browser.Tabs.TotalIncompleteSwitchDuration2.NoSavedFrames_"
            "NotLoaded",
            "Browser.Tabs.TabSwitchResult2.WithSavedFrames", "Browser.Tabs.TabSwitchResult2.NoSavedFrames_Loaded",
...
TEST_P(ContentToVisibleTimeReporterTest, TimeIsRecorded)
{
    ...
    auto presentation_feedback = gfx::PresentationFeedback(end, end - start, gfx::PresentationFeedback::Flags::kHWCompletion);
...
TEST_P(ContentToVisibleTimeReporterTest, PresentationFailure)
{
    ...
    ExpectTotalSamples(result_histograms_, 1);
    ExpectResultBucketCounts(result_histograms_, ContentToVisibleTimeReporter::TabSwitchResult::kPresentationFailure, 1);
}
...
TEST_P(ContentToVisibleTimeReporterTest, HideBeforePresentFrame)
{
    ...
    auto presentation_feedback = gfx::PresentationFeedback(end2, end2 - start2, gfx::PresentationFeedback::Flags::kHWCompletion);
