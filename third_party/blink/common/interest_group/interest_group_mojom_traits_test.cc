...
TEST(InterestGroupMojomTraitsTest, SerializeAndDeserializeAds)
{
    ...
    interest_group.ads->emplace_back(InterestGroup::Ad(GURL(kUrl1), /*metadata=*/absl::nullopt));
    interest_group.ads->emplace_back(InterestGroup::Ad(GURL(kUrl2), /*metadata=*/"[]"));
    SerializeAndDeserializeAndCompare(interest_group);
}
...
TEST(InterestGroupMojomTraitsTest, SerializeAndDeserializeAdComponents)
{
    ...
    interest_group.ad_components->emplace_back(InterestGroup::Ad(GURL(kUrl1), /*metadata=*/absl::nullopt));
    interest_group.ad_components->emplace_back(InterestGroup::Ad(GURL(kUrl2), /*metadata=*/"[]"));
    SerializeAndDeserializeAndCompare(interest_group);
}
