...
InterestGroup::InterestGroup(base::Time expiry, url::Origin owner, std::string name, double priority, bool enable_bidding_signals_prioritization,
    absl::optional<base::flat_map<std::string, double>> priority_vector, absl::optional<base::flat_map<std::string, double>> priority_signals_overrides,
    blink::mojom::InterestGroup::ExecutionMode execution_mode, absl::optional<GURL> bidding_url, absl::optional<GURL> bidding_wasm_helper_url,
    absl::optional<GURL> daily_update_url, absl::optional<GURL> trusted_bidding_signals_url,
    absl::optional<std::vector<std::string>> trusted_bidding_signals_keys, absl::optional<std::string> user_bidding_signals,
    absl::optional<std::vector<InterestGroup::Ad>> ads, absl::optional<std::vector<InterestGroup::Ad>> ad_components)
    : expiry(expiry)
    , owner(std::move(owner))
    , name(std::move(name))
    , priority(priority)
    , enable_bidding_signals_prioritization(enable_bidding_signals_prioritization)
...
{
    return std::tie(expiry, owner, name, priority, enable_bidding_signals_prioritization, priority_vector, priority_signals_overrides, execution_mode,
               bidding_url, bidding_wasm_helper_url, daily_update_url, trusted_bidding_signals_url, trusted_bidding_signals_keys, user_bidding_signals, ads,
               ad_components)
        == std::tie(other.expiry, other.owner, other.name, other.priority, other.enable_bidding_signals_prioritization, other.priority_vector,
            other.priority_signals_overrides, other.execution_mode, other.bidding_url, other.bidding_wasm_helper_url, other.daily_update_url,
            other.trusted_bidding_signals_url, other.trusted_bidding_signals_keys, other.user_bidding_signals, other.ads, other.ad_components);
}
