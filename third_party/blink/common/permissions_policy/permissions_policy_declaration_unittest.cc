...
TEST(ParsedPermissionsPolicyDeclarationTest, Contains)
{
    ...
    mismatch_decl.allowed_origins.emplace_back(url::Origin::Create(GURL("https://example2.test/")),
    ...
    match_decl.allowed_origins.emplace_back(url::Origin::Create(GURL("https://example.test/")),
        /*has_subdomain_wildcard=*/false);
