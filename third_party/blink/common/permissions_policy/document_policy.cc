...
// static
absl::optional<std::string> DocumentPolicy::Serialize(const DocumentPolicyFeatureState& policy)
{
    return DocumentPolicy::SerializeInternal(policy, GetDocumentPolicyFeatureInfoMap());
}

// static
absl::optional<std::string> DocumentPolicy::SerializeInternal(const DocumentPolicyFeatureState& policy, const DocumentPolicyFeatureInfoMap& feature_info_map)
{
...
const absl::optional<std::string> DocumentPolicy::GetFeatureEndpoint(mojom::DocumentPolicyFeature feature) const
{
