...
URLSyntaxErrorCode IsValidCustomHandlerURLSyntax(const GURL& full_url, const base::StringPiece& user_url)
{
...
bool IsValidCustomHandlerScheme(const base::StringPiece scheme, ProtocolHandlerSecurityLevel security_level, bool* has_custom_scheme_prefix)
{
...
{
    bool has_valid_scheme = url.SchemeIsHTTPOrHTTPS()
