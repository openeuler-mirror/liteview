...
bool UseCounterFeature::IsValid() const
{
    ...
    case mojom::UseCounterFeatureType::kWebFeature:
        return value_ < static_cast<UseCounterFeature::EnumValue>(mojom::WebFeature::kNumberOfFeatures);
    case mojom::UseCounterFeatureType::kCssProperty:
    case mojom::UseCounterFeatureType::kAnimatedCssProperty:
        return value_ < static_cast<UseCounterFeature::EnumValue>(mojom::CSSSampleId::kMaxValue) + 1;
    ...
    case mojom::UseCounterFeatureType::kPermissionsPolicyIframeAttribute:
        return value_ < static_cast<UseCounterFeature::EnumValue>(mojom::PermissionsPolicyFeature::kMaxValue) + 1;
    case mojom::UseCounterFeatureType::kUserAgentOverride:
        return value_ < static_cast<UseCounterFeature::EnumValue>(blink::UserAgentOverride::UserAgentOverrideHistogram::kMaxValue) + 1;
    }
}
