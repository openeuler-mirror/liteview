...
public:
    ...
    {
        client_remote_->OnReceiveResponse(network::mojom::URLResponseHead::New(), mojo::ScopedDataPipeConsumerHandle(), absl::nullopt);
    }
...
public:
    ...
    void set_before_will_process_response_callback(const ThrottleCallback& callback)
    {
        before_will_process_response_callback_ = callback;
    }

    void set_before_will_redirect_request_callback(ThrottleRedirectCallback callback)
    {
...
private:
    ...
    void BeforeWillProcessResponse(const GURL& response_url, const network::mojom::URLResponseHead& response_head, bool* defer) override
    {
    ...
    void BeforeWillRedirectRequest(net::RedirectInfo* redirect_info, const network::mojom::URLResponseHead& response_head, bool* defer,
        std::vector<std::string>* removed_headers, net::HttpRequestHeaders* modified_headers, net::HttpRequestHeaders* modified_cors_exempt_headers) override
    {
        before_will_redirect_request_called_++;
        if (before_will_redirect_request_callback_) {
            std::move(before_will_redirect_request_callback_).Run(delegate_.get(), defer, removed_headers, modified_headers, modified_cors_exempt_headers);
        }
    }
...
protected:
    ...
    void CreateLoaderAndStart(bool sync = false)
    {
        ...
        loader_ = ThrottlingURLLoader::CreateLoaderAndStart(factory_.shared_factory(), std::move(throttles_), 0, options, &request, &client_,
...
TEST_F(ThrottlingURLLoaderTest, ModifyHeaderInResumeBeforeStart)
{
    ...
    factory_.set_on_create_loader_and_start(base::BindRepeating(
        [](const base::RepeatingClosure& quit_closure, const network::ResourceRequest& url_request) {
    ...
    throttle_->delegate()->UpdateDeferredRequestHeaders(modified_headers, modified_cors_exempt_headers);
    throttle_->delegate()->Resume();
...
TEST_F(ThrottlingURLLoaderTest, RedirectCallbackShouldNotBeCalledAfterDestruction)
{
    ...
    loader_ = ThrottlingURLLoader::CreateLoaderAndStart(
        factory_.shared_factory(), std::move(throttles_), 0, 0, &request, &client_, TRAFFIC_ANNOTATION_FOR_TESTS, base::ThreadTaskRunnerHandle::Get());
...
TEST_F(ThrottlingURLLoaderTest, PauseResumeReadingBodyFromNet)
{
    ...
    throttle_->set_will_start_request_callback(base::BindLambdaForTesting([](blink::URLLoaderThrottle::Delegate* delegate, bool* defer) {
        delegate->PauseReadingBodyFromNet();
        *defer = true;
    }));
    throttle2->set_will_start_request_callback(
        base::BindLambdaForTesting([](blink::URLLoaderThrottle::Delegate* delegate, bool* defer) { delegate->PauseReadingBodyFromNet(); }));
...
TEST_F(ThrottlingURLLoaderTest, RestartWithFlags)
{
    ...
    throttle_->set_before_will_process_response_callback(
        base::BindRepeating([](blink::URLLoaderThrottle::Delegate* delegate, bool* defer) { delegate->RestartWithFlags(1); }));
    ...
    throttle_->set_before_will_process_response_callback(TestURLLoaderThrottle::ThrottleCallback());
...
TEST_F(ThrottlingURLLoaderTest, DeferThenRestartWithFlags)
{
    ...
    client_.set_on_complete_callback(base::BindLambdaForTesting([&run_loop4](int error) {
        EXPECT_EQ(net::OK, error);
        run_loop4.Quit();
    }));
...
TEST_F(ThrottlingURLLoaderTest, MultipleRestartWithFlags)
{
    ...
    throttles[0]->set_before_will_process_response_callback(
        base::BindRepeating([](blink::URLLoaderThrottle::Delegate* delegate, bool* defer) { delegate->RestartWithFlags(2); }));
    throttles[2]->set_before_will_process_response_callback(
        base::BindRepeating([](blink::URLLoaderThrottle::Delegate* delegate, bool* defer) { delegate->RestartWithFlags(8); }));
    ...
    // BeforeWillProcessResponse() so it doesn't restart the request yet again.
    for (auto* throttle : throttles) {
        throttle->set_before_will_process_response_callback(TestURLLoaderThrottle::ThrottleCallback());
    }
...
TEST_F(ThrottlingURLLoaderTest, MultipleDeferThenRestartWithFlags)
{
    ...
    for (auto* throttle : throttles) {
        throttle->set_before_will_process_response_callback(base::BindRepeating(
            [](const base::RepeatingClosure& quit_closure, int* count, blink::URLLoaderThrottle::Delegate* delegate, bool* defer) {
                *defer = true;
                if (++(*count) == 3) {
                    quit_closure.Run();
                }
...
TEST_F(ThrottlingURLLoaderTest, RestartWithURLResetAndFlags)
{
    ...
    throttle_->set_before_will_process_response_callback(
        base::BindRepeating([](blink::URLLoaderThrottle::Delegate* delegate, bool* defer) { delegate->RestartWithURLResetAndFlags(1); }));
...
TEST_F(ThrottlingURLLoaderTest, MultipleRestartWithURLResetAndFlags)
{
    ...
    throttles[0]->set_before_will_process_response_callback(
        base::BindRepeating([](blink::URLLoaderThrottle::Delegate* delegate, bool* defer) { delegate->RestartWithURLResetAndFlags(2); }));
    throttles[2]->set_before_will_process_response_callback(
        base::BindRepeating([](blink::URLLoaderThrottle::Delegate* delegate, bool* defer) { delegate->RestartWithURLResetAndFlags(8); }));
...
TEST_F(ThrottlingURLLoaderTest, MultipleRestartWithURLResetAndFlagsDeferAndSync)
{
    // Create two additional TestURLLoaderThrottles for a total of 3, and keep
    // local unowned pointers to them in |throttles|.
    std::vector<TestURLLoaderThrottle*> throttles;
...
TEST_F(ThrottlingURLLoaderTest, RestartWithURLResetAndFlagsBeforeWillRedirectRequest)
{
    base::RunLoop run_loop1;
    base::RunLoop run_loop2;
    base::RunLoop run_loop3;
    ...
    throttle_->set_before_will_redirect_request_callback(
        base::BindLambdaForTesting([&](blink::URLLoaderThrottle::Delegate* delegate, bool* /* defer */, std::vector<std::string>* /* removed_headers */,
                                       ...
                                       net::HttpRequestHeaders* /* modified_headers */,
                                       net::HttpRequestHeaders* /* modified_cors_exempt_headers */) { delegate->RestartWithURLResetAndFlags(1); }));
    ...
    throttle_->set_before_will_redirect_request_callback(TestURLLoaderThrottle::ThrottleRedirectCallback());
...
TEST_F(ThrottlingURLLoaderTest, RestartWithURLResetAndFlagsWillRedirectRequestNoOp)
{
    base::RunLoop run_loop1;
    base::RunLoop run_loop2;
    base::RunLoop run_loop3;
    ...
    throttle_->set_will_redirect_request_callback(base::BindLambdaForTesting(
        [&run_loop1](blink::URLLoaderThrottle::Delegate* delegate, bool* /* defer */, std::vector<std::string>* /* removed_headers */,
            net::HttpRequestHeaders* /* modified_headers */, net::HttpRequestHeaders* /* modified_cors_exempt_headers */) {
    ...
    factory_.set_on_create_loader_and_start(base::BindRepeating([](const network::ResourceRequest& url_request) { NOTREACHED(); }));

    // Make another redirect to ensure a restart from one doesn't affect the next
    // one.
    throttle_->set_will_redirect_request_callback(base::BindLambdaForTesting(
        [&run_loop2](blink::URLLoaderThrottle::Delegate* delegate, bool* /* defer */, std::vector<std::string>* /* removed_headers */,
            net::HttpRequestHeaders* /* modified_headers */, net::HttpRequestHeaders* /* modified_cors_exempt_headers */) {
            delegate->RestartWithURLResetAndFlags(1);
            run_loop2.Quit();
        }));
