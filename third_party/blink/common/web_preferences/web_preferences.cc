...
WebPreferences::WebPreferences()
    ...
    , animation_policy(blink::mojom::ImageAnimationPolicy::kImageAnimationPolicyAllowed)
    ...
    , autoplay_policy(blink::mojom::AutoplayPolicy::kDocumentUserActivationRequired)
    , low_priority_iframes_threshold(EffectiveConnectionType::kEffectiveConnectionUnknownType)
    , picture_in_picture_enabled(true)
    , translate_service_available(false)
    , network_quality_estimator_web_holdback(EffectiveConnectionType::kEffectiveConnectionUnknownType)
