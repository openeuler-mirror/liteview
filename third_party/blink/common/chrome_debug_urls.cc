...
const char kChromeUIBrowserDcheckURL[] = "chrome://inducebrowserdcheckforrealz/";
...
const char kChromeUIMemoryPressureCriticalURL[] = "chrome://memory-pressure-critical/";
const char kChromeUIMemoryPressureModerateURL[] = "chrome://memory-pressure-moderate/";
...
#endif
#if BUILDFLAG(IS_WIN)
const char kChromeUIBrowserHeapCorruptionURL[] = "chrome://inducebrowserheapcorruption/";
...
#if BUILDFLAG(IS_WIN)
const char kChromeUICrashCorruptHeapBlockURL[] = "chrome://crash/corrupt-heap-block";
...
bool IsRendererDebugURL(const GURL& url)
{
    ...
    if (url == kChromeUICheckCrashURL || url == kChromeUIBadCastCrashURL || url == kChromeUICrashURL || url == kChromeUIDumpURL || url == kChromeUIKillURL
        || url == kChromeUIHangURL || url == kChromeUIShorthangURL || url == kChromeUIMemoryExhaustURL) {
        return true;
    }
