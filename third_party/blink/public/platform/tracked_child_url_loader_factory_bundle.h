...
public:
    ...
    TrackedChildPendingURLLoaderFactoryBundle(mojo::PendingRemote<network::mojom::URLLoaderFactory> pending_default_factory,
        ...
        mojo::PendingRemote<network::mojom::URLLoaderFactory> pending_prefetch_loader_factory, std::unique_ptr<HostPtrAndTaskRunner> main_thread_host_bundle,
...
// Service crash.
class BLINK_PLATFORM_EXPORT TrackedChildURLLoaderFactoryBundle : public ChildURLLoaderFactoryBundle,
...
// tracking logic.
class BLINK_PLATFORM_EXPORT HostChildURLLoaderFactoryBundle : public ChildURLLoaderFactoryBundle,
...
public:
    ...
    using ObserverList = std::unordered_map<TrackedChildURLLoaderFactoryBundle*, std::unique_ptr<ObserverPtrAndTaskRunner>>;
...
private:
    ...
    // remain valid.
    void AddObserver(TrackedChildURLLoaderFactoryBundle* observer, std::unique_ptr<ObserverPtrAndTaskRunner> observer_info);
    ...
    void NotifyUpdateOnMainOrWorkerThread(ObserverPtrAndTaskRunner* observer_bundle, std::unique_ptr<network::PendingSharedURLLoaderFactory> update_info);
