...
public:
    ...
    BLINK_EXPORT WebBlobInfo(const WebString& uuid, const WebString& file_name, const WebString& type, const absl::optional<base::Time>& last_modified,
    ...
    BLINK_EXPORT WebBlobInfo(scoped_refptr<BlobDataHandle>, const WebString& file_name, const absl::optional<base::Time>& last_modified);
    ...
    BLINK_EXPORT WebBlobInfo(
        scoped_refptr<BlobDataHandle>, const WebString& file_name, const WebString& type, const absl::optional<base::Time>& last_modified, uint64_t size);
