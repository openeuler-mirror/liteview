...
public:
    ...
    MOCK_METHOD0(CompositorTaskRunner, scoped_refptr<base::SingleThreadTaskRunner>());
    ...
    MOCK_METHOD0(CreateAgentGroupScheduler, std::unique_ptr<WebAgentGroupScheduler>());
