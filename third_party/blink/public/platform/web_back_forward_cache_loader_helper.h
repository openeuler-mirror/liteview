...
public:
    ...
    WebBackForwardCacheLoaderHelper& operator=(const WebBackForwardCacheLoaderHelper& o)
    {
        Assign(o);
        return *this;
    }
...
#if INSIDE_BLINK
    PLATFORM_EXPORT explicit WebBackForwardCacheLoaderHelper(BackForwardCacheLoaderHelper* back_forward_cache_loader_helper);
