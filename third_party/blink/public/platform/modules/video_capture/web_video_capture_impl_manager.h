...
public:
    ...
    // resources.
    base::OnceClosure UseDevice(const media::VideoCaptureSessionId& id, BrowserInterfaceBrokerProxy* browser_interface_broker);
    ...
    void OnFrameDropped(const media::VideoCaptureSessionId& id, media::VideoCaptureFrameDropReason reason);
