...
public:
    ...
    virtual int SendAsync(std::unique_ptr<network::ResourceRequest> request, scoped_refptr<base::SingleThreadTaskRunner> loading_task_runner,
    ...
    virtual void DeletePendingRequest(scoped_refptr<base::SingleThreadTaskRunner> task_runner);
    ...
    virtual void OnReceivedResponse(network::mojom::URLResponseHeadPtr, base::TimeTicks response_arrival_timing_at_renderer);
    ...
    virtual void OnStartLoadingResponseBody(mojo::ScopedDataPipeConsumerHandle body);

    // Called when the response is complete.
    virtual void OnRequestComplete(const network::URLLoaderCompletionStatus& status);
...
private:
    ...
    struct PendingRequestInfo {
        PendingRequestInfo(scoped_refptr<WebRequestPeer> peer, network::mojom::RequestDestination request_destination, const GURL& request_url,
            std::unique_ptr<ResourceLoadInfoNotifierWrapper> resource_load_info_notifier_wrapper);
