...
public:
    ...
    void set_url_loader_throttles(WebVector<std::unique_ptr<URLLoaderThrottle>> throttles)
    {
        url_loader_throttles_ = std::move(throttles);
    }
    void set_frame_request_blocker(scoped_refptr<WebFrameRequestBlocker> frame_request_blocker)
    {
