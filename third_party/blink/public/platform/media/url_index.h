...
protected:
    UrlData(const GURL& url, CorsMode cors_mode, UrlIndex* url_index, scoped_refptr<base::SingleThreadTaskRunner> task_runner);
    virtual ~UrlData();
...
public:
    ...
    scoped_refptr<UrlData> GetByUrl(const GURL& gurl, UrlData::CorsMode cors_mode, CacheMode cache_mode);
...
protected:
    ...
    virtual scoped_refptr<UrlData> NewUrlData(const GURL& url, UrlData::CorsMode cors_mode);
