...
public:
    ...
    // in |out_param|.
    virtual bool GetBoolAttributeForAXNode(int32_t ax_id, WebAOMBoolAttribute, bool* out_param) = 0;
    virtual bool GetIntAttributeForAXNode(int32_t ax_id, WebAOMIntAttribute, int32_t* out_param) = 0;
    virtual bool GetStringAttributeForAXNode(int32_t ax_id, WebAOMStringAttribute, WebString* out_param) = 0;

    virtual bool GetFloatAttributeForAXNode(int32_t ax_id, WebAOMFloatAttribute, float* out_param) = 0;
    ...
    virtual bool GetCheckedStateForAXNode(int32_t ax_id, blink::WebString* out_param) = 0;
    ...
    virtual bool GetPreviousSiblingIdForAXNode(int32_t ax_id, int32_t* out_param) = 0;
