...
BLINK_COMMON_EXPORT absl::optional<WebSchedulerTrackedFeature> StringToFeature(const std::string& str);
...
BLINK_COMMON_EXPORT constexpr uint64_t FeatureToBit(WebSchedulerTrackedFeature feature)
{
