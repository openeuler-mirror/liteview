...
template <typename T,
    typename std::enable_if_t<std::is_same<T, base::remove_cvref_t<T>>::value && std::is_trivially_copyable<T>::value
        && has_unique_object_representations<T>::value && sizeof(T) <= sizeof(int64_t)>* = nullptr>
