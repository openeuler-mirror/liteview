...
public:
    ...
    static_assert(static_cast<uint64_t>(ReservedSurfaceMetrics::kMax)
...
constexpr bool operator<(const IdentifiableSurface& left, const IdentifiableSurface& right)
{
...
struct IdentifiableSurfaceCompLess {
    bool operator()(const IdentifiableSurface& lhs, const IdentifiableSurface& rhs) const
    {
