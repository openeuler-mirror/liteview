...
using WorkletToken = MultiToken<AnimationWorkletToken, AudioWorkletToken, LayoutWorkletToken, PaintWorkletToken>;
...
using ExecutionContextToken = MultiToken<LocalFrameToken, DedicatedWorkerToken, ServiceWorkerToken, SharedWorkerToken, AnimationWorkletToken, AudioWorkletToken,
    LayoutWorkletToken, PaintWorkletToken>;
...
//     there later on.
using WebGPUExecutionContextToken = MultiToken<DocumentToken, DedicatedWorkerToken>;
