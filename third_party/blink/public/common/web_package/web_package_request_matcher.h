...
public:
    ...
    absl::optional<size_t> FindBestMatchingIndex(const std::string& variants) const;
...
private:
    ...
    static absl::optional<size_t> FindBestMatchingIndex(const net::HttpRequestHeaders& request_headers, const std::string& variants);
