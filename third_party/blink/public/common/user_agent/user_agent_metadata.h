...
public:
    ...
    static absl::optional<UserAgentMetadata> Demarshal(const absl::optional<std::string>& encoded);
    static absl::optional<std::string> Marshal(const absl::optional<UserAgentMetadata>& ua_metadata);
...
struct BLINK_COMMON_EXPORT UserAgentOverride {
    ...
    static constexpr char kUserAgentOverrideHistogram[] = "Blink.UseCounter.UserAgentOverride";
