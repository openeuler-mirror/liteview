...
bool BLINK_COMMON_EXPORT IsValidCustomHandlerScheme(
    const base::StringPiece scheme, ProtocolHandlerSecurityLevel security_level, bool* has_custom_scheme_prefix = nullptr);
...
URLSyntaxErrorCode BLINK_COMMON_EXPORT IsValidCustomHandlerURLSyntax(const GURL& full_url, const base::StringPiece& user_url);
