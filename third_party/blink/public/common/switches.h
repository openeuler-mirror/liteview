...
BLINK_COMMON_EXPORT extern const char kSetTimeoutWithout1MsClampPolicy_ForceDisable[];
BLINK_COMMON_EXPORT extern const char kSetTimeoutWithout1MsClampPolicy_ForceEnable[];
BLINK_COMMON_EXPORT extern const char kUnthrottledNestedTimeoutPolicy[];
BLINK_COMMON_EXPORT extern const char kUnthrottledNestedTimeoutPolicy_ForceDisable[];
BLINK_COMMON_EXPORT extern const char kUnthrottledNestedTimeoutPolicy_ForceEnable[];
