...
public:
    ...
    // parsed.
    static std::unique_ptr<TrialToken> From(base::StringPiece token_text, const OriginTrialPublicKey& public_key, OriginTrialTokenStatus* out_status);
...
protected:
    ...
    static OriginTrialTokenStatus Extract(base::StringPiece token_text, const OriginTrialPublicKey& public_key, std::string* out_token_payload,
    ...
    static bool ValidateSignature(base::StringPiece signature_text, const std::string& data, const OriginTrialPublicKey& public_key);
