...
bool BLINK_COMMON_EXPORT IsSupportedNonImageMimeType(const std::string& mime_type);
bool BLINK_COMMON_EXPORT IsUnsupportedTextMimeType(const std::string& mime_type);
bool BLINK_COMMON_EXPORT IsSupportedJavascriptMimeType(const std::string& mime_type);
