...
private:
    ...
    std::bitset<static_cast<size_t>(mojom::WebFeature::kNumberOfFeatures)> web_features_;
    ...
    std::bitset<static_cast<size_t>(UserAgentOverride::UserAgentOverrideHistogram::kMaxValue) + 1> user_agent_override_features_;
};
