...
template <> struct BLINK_COMMON_EXPORT StructTraits<blink::mojom::NotificationDataDataView, blink::PlatformNotificationData> {
    ...
    static const base::span<const uint8_t> data(const blink::PlatformNotificationData& data)
    {
        ...
        return base::make_span(reinterpret_cast<const uint8_t*>(data.data.data()), data.data.size());
    }
    ...
    static absl::optional<base::Time> show_trigger_timestamp(const blink::PlatformNotificationData& data)
    {
