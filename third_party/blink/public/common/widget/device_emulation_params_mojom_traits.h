...
template <> struct BLINK_COMMON_EXPORT StructTraits<blink::mojom::DeviceEmulationParamsDataView, blink::DeviceEmulationParams> {
    ...
    static const absl::optional<gfx::Point>& view_position(const blink::DeviceEmulationParams& r)
    {
    ...
    static const std::vector<gfx::Rect>& window_segments(const blink::DeviceEmulationParams& r)
    {
