...
struct BLINK_COMMON_EXPORT WebPreferences {
    ...
    blink::mojom::AutoplayPolicy autoplay_policy = blink::mojom::AutoplayPolicy::kNoUserGestureRequired;
    ...
    std::map<EffectiveConnectionType, int> lazy_frame_loading_distance_thresholds_px;
    std::map<EffectiveConnectionType, int> lazy_image_loading_distance_thresholds_px;
