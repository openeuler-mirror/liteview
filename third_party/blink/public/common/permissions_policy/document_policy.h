...
public:
    ...
    const absl::optional<std::string> GetFeatureEndpoint(mojom::DocumentPolicyFeature feature) const;
    ...
    static absl::optional<std::string> Serialize(const DocumentPolicyFeatureState& policy);

    static absl::optional<std::string> SerializeInternal(const DocumentPolicyFeatureState& policy, const DocumentPolicyFeatureInfoMap&);
