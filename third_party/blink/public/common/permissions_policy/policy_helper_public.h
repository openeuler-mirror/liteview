...
using PermissionsPolicyFeatureToNameMap = base::flat_map<mojom::PermissionsPolicyFeature, base::StringPiece>;

using PermissionsPolicyNameToFeatureMap = base::flat_map<base::StringPiece, mojom::PermissionsPolicyFeature>;
