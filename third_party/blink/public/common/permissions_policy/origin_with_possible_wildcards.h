...
struct BLINK_COMMON_EXPORT OriginWithPossibleWildcards {
    ...
    OriginWithPossibleWildcards(const url::Origin& origin, bool has_subdomain_wildcard);
    ...
    static OriginWithPossibleWildcards Parse(const std::string& allowlist_entry, const NodeType type);
...
bool BLINK_COMMON_EXPORT operator==(const OriginWithPossibleWildcards& lhs, const OriginWithPossibleWildcards& rhs);
bool BLINK_COMMON_EXPORT operator!=(const OriginWithPossibleWildcards& lhs, const OriginWithPossibleWildcards& rhs);
bool BLINK_COMMON_EXPORT operator<(const OriginWithPossibleWildcards& lhs, const OriginWithPossibleWildcards& rhs);
