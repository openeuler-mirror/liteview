...
public:
    ...
    bool SerializeEntireTree(bool exclude_offscreen, size_t max_node_count, base::TimeDelta timeout, ui::AXTreeUpdate* response);
    ...
    bool AddPendingEvent(const ui::AXEvent& event, bool insert_at_beginning = false);
