...
public:
    ...
    // painful...
    static WebLocalFrame* CreateMainFrame(WebView*, WebLocalFrameClient*, blink::InterfaceRegistry*, const LocalFrameToken& frame_token,
        const DocumentToken& document_token, std::unique_ptr<blink::WebPolicyContainer> policy_container, WebFrame* opener = nullptr,
        const WebString& name = WebString(), network::mojom::WebSandboxFlags = network::mojom::WebSandboxFlags::kNone);
    ...
    static WebLocalFrame* CreateProvisional(
        WebLocalFrameClient*, InterfaceRegistry*, const LocalFrameToken& frame_token, WebFrame* previous_web_frame, const FramePolicy&, const WebString& name);
    ...
    virtual const absl::optional<base::UnguessableToken>& GetEmbeddingToken() const = 0;
    ...
    // specified.
    virtual void GetPageDescription(uint32_t page_index, WebPrintPageDescription*) = 0;
    ...
    virtual void RequestExecuteScript(int32_t world_id, base::span<const WebScriptSource> sources, mojom::UserActivationOption, mojom::EvaluationTiming,
        mojom::LoadEventBlockingOption, WebScriptExecutionCallback, WebScriptExecutionCallbackUnmodified, BackForwardCacheAware, mojom::WantResultOption, mojom::PromiseResultOption)
        = 0;
    ...
    virtual void SelectRange(const WebRange&, HandleVisibilityBehavior, mojom::SelectionMenuBehavior) = 0;
    ...
    // page-orientation.
    virtual gfx::Size SpoolSizeInPixelsForTesting(const gfx::Size& page_size_in_pixels, const WebVector<uint32_t>& pages) = 0;
    virtual gfx::Size SpoolSizeInPixelsForTesting(const gfx::Size& page_size_in_pixels, uint32_t page_count) = 0;
    ...
    virtual void PrintPagesForTesting(
        cc::PaintCanvas*, const gfx::Size& page_size_in_pixels, const gfx::Size& spool_size_in_pixels, const WebVector<uint32_t>* pages = nullptr)
        = 0;
