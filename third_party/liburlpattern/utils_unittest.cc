...
void RunEscapeRegexpStringTest(absl::string_view input, absl::string_view expected)
{
...
void RunEscapePatternStringTest(absl::string_view input, absl::string_view expected)
{
    std::string result;
