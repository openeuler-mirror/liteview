...
void __cdecl absl::internal_statusor::Helper::Crash(class absl::Status const&)
{
    *(int*)1 = 1;
}
...
template<>
bool FormatArgImpl::Dispatch<unsigned long>(FormatArgImpl::Data, FormatConversionSpecImpl, void*)
{
    *(int*)1 = 1;
    return false;
}
...
#ifndef _MSC_VER
template<>
bool FormatArgImpl::Dispatch<int>(FormatArgImpl::Data, FormatConversionSpecImpl, void*)
{
    *(int*)1 = 1;
    return false;
}
...
template<>
bool FormatArgImpl::Dispatch<unsigned int>(FormatArgImpl::Data, FormatConversionSpecImpl, void*)
{
    *(int*)1 = 1;
    return false;
}
...
template<>
bool FormatArgImpl::Dispatch<char const*>(FormatArgImpl::Data, FormatConversionSpecImpl, void*)
{
    *(int*)1 = 1;
    return false;
}
...
std::string& AppendPack(std::string*, 
    UntypedFormatSpecImpl, absl::Span<FormatArgImpl const >)
{
    *(int*)1 = 1;
