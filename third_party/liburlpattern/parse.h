...
typedef std::function<absl::StatusOr<std::string>(absl::string_view)> EncodeCallback;
...
absl::StatusOr<Pattern> Parse(absl::string_view pattern, EncodeCallback callback, const Options& options = Options());
