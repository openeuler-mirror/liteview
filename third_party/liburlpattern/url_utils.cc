...
void EscapeStringAndAppendInternal(absl::string_view input, std::string& append_target, absl::string_view special_chars)
{
    for (auto& c : input) {
...
void EscapeRegexpStringAndAppend(absl::string_view input, std::string& append_target)
{
    return EscapeStringAndAppendInternal(input, append_target, kRegexpSpecialCharacters);
}

void EscapePatternStringAndAppend(absl::string_view input, std::string& append_target)
{
