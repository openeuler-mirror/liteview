...
//         if (env_headers) {
//             result = curl_easy_impersonate(data, env_target, !strcasecompare(env_headers, "no"));
//             free(env_headers);
//         } else {
...
//         }
//     }
    result = curl_easy_impersonate(data, "chrome116", false);
...
//         free(env_target);
//     }
    curl_easy_impersonate(data, "chrome116", false);
}
