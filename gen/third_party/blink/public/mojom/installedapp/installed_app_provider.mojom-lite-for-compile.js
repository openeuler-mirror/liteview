// third_party/blink/public/mojom/installedapp/installed_app_provider.mojom-lite-for-compile.js is auto generated by mojom_bindings_generator.py, do not edit
...
goog.require('blink.mojom.RelatedApplication');
...
goog.provide('blink.mojom.InstalledAppProviderReceiver');
goog.provide('blink.mojom.InstalledAppProviderCallbackRouter');
goog.provide('blink.mojom.InstalledAppProviderInterface');
goog.provide('blink.mojom.InstalledAppProviderRemote');
goog.provide('blink.mojom.InstalledAppProviderPendingReceiver');
...
/** @interface */
blink.mojom.InstalledAppProviderInterface = class {
...
goog.provide('blink.mojom.InstalledAppProvider_FilterInstalledApps_ParamsSpec');
/**
...
goog.provide('blink.mojom.InstalledAppProvider_FilterInstalledApps_ResponseParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
