...
// with not having this data in traces there.
    ...
    virtual void FilterInstalledApps(std::vector<::blink::mojom::RelatedApplicationPtr> related_apps, const ::GURL& manifest_url, FilterInstalledAppsCallback callback) = 0;
};
...
//
//   void FilterInstalledApps(std::vector<::blink::mojom::RelatedApplicationPtr> related_apps, const ::GURL& manifest_url, FilterInstalledAppsCallback callback) final;
//
//  private:
