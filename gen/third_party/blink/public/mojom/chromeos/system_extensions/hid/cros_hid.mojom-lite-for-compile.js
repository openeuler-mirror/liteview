// third_party/blink/public/mojom/chromeos/system_extensions/hid/cros_hid.mojom-lite-for-compile.js is auto generated by mojom_bindings_generator.py, do not edit
...
goog.require('blink.mojom.HidDeviceFilter');
goog.require('device.mojom.HidDeviceInfo');
goog.provide('blink.mojom.CrosHID');
goog.provide('blink.mojom.CrosHIDReceiver');
goog.provide('blink.mojom.CrosHIDCallbackRouter');
goog.provide('blink.mojom.CrosHIDInterface');
goog.provide('blink.mojom.CrosHIDRemote');
goog.provide('blink.mojom.CrosHIDPendingReceiver');
/**
...
/** @interface */
blink.mojom.CrosHIDInterface = class {
...
goog.provide('blink.mojom.CrosHID_AccessDevices_ParamsSpec');
/**
...
goog.provide('blink.mojom.CrosHID_AccessDevices_ResponseParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('blink.mojom.CrosHID_Connect_ParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('blink.mojom.CrosHID_Connect_ResponseParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('blink.mojom.CrosHID_AccessDevices_Params');
...
goog.provide('blink.mojom.CrosHID_AccessDevices_ResponseParams');
...
goog.provide('blink.mojom.CrosHID_Connect_Params');
...
goog.provide('blink.mojom.CrosHID_Connect_ResponseParams');
