...
PrefetchedSignedExchangeInfo::PrefetchedSignedExchangeInfo(const ::GURL& outer_url_in, const ::net::SHA256HashValue& header_integrity_in, const ::GURL& inner_url_in,
