...
static_assert(sizeof(BeginNavigationParams_Data) == 112, "Bad sizeof(BeginNavigationParams_Data)");
...
static_assert(sizeof(CommonNavigationParams_Data) == 128, "Bad sizeof(CommonNavigationParams_Data)");
...
static_assert(sizeof(NavigationTiming_Data) == 32, "Bad sizeof(NavigationTiming_Data)");
...
template <typename UserType, typename DataView> const mojo::internal::UnserializedMessageContext::Tag OldPageInfo_UnserializedMessageContext<UserType, DataView>::kMessageTag = {};
...
public:
    ...
    mojo::internal::Pointer<::url::mojom::internal::Url_Data> fallback_srcdoc_baseurl;
...
static_assert(sizeof(CommitNavigationParams_Data) == 264, "Bad sizeof(CommitNavigationParams_Data)");
