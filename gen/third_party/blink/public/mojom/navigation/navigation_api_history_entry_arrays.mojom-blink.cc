...
NavigationApiHistoryEntry::NavigationApiHistoryEntry(const ::WTF::String& key_in, const ::WTF::String& id_in, const ::WTF::String& url_in, int64_t item_sequence_number_in,
...
NavigationApiHistoryEntryArrays::NavigationApiHistoryEntryArrays(
    WTF::Vector<NavigationApiHistoryEntryPtr> back_entries_in, WTF::Vector<NavigationApiHistoryEntryPtr> forward_entries_in)
