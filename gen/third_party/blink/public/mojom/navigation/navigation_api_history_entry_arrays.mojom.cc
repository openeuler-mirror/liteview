...
NavigationApiHistoryEntry::NavigationApiHistoryEntry(const ::std::u16string& key_in, const ::std::u16string& id_in, const ::std::u16string& url_in, int64_t item_sequence_number_in,
...
bool NavigationApiHistoryEntry::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
NavigationApiHistoryEntryArrays::NavigationApiHistoryEntryArrays(
    std::vector<NavigationApiHistoryEntryPtr> back_entries_in, std::vector<NavigationApiHistoryEntryPtr> forward_entries_in)
...
bool NavigationApiHistoryEntryArrays::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
