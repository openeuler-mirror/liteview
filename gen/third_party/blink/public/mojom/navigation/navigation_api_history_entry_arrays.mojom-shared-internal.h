...
template <typename UserType, typename DataView> struct NavigationApiHistoryEntry_UnserializedMessageContext : public mojo::internal::UnserializedMessageContext {
public:
...
static_assert(sizeof(NavigationApiHistoryEntryArrays_Data) == 24, "Bad sizeof(NavigationApiHistoryEntryArrays_Data)");
// Used by NavigationApiHistoryEntryArrays::WrapAsMessage to lazily serialize the struct.
template <typename UserType, typename DataView> struct NavigationApiHistoryEntryArrays_UnserializedMessageContext : public mojo::internal::UnserializedMessageContext {
public:
    static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;
