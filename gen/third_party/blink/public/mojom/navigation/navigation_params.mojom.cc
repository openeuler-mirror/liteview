...
BeginNavigationParams::BeginNavigationParams(const absl::optional<::blink::LocalFrameToken>& initiator_frame_token_in, const std::string& headers_in, int32_t load_flags_in,
...
CommonNavigationParams::CommonNavigationParams(const ::GURL& url_in, const absl::optional<::url::Origin>& initiator_origin_in, ::blink::mojom::ReferrerPtr referrer_in,
...
OldPageInfo::OldPageInfo(int32_t routing_id_for_old_main_frame_in, ::blink::mojom::PageLifecycleStatePtr new_lifecycle_state_for_old_page_in)
...
CommitNavigationParams::CommitNavigationParams(const absl::optional<::url::Origin>& origin_to_commit_in, const ::blink::StorageKey& storage_key_in,
    ...
    std::vector<::net::RedirectInfo> redirect_infos_in, const std::string& post_content_type_in, const ::GURL& original_url_in, const std::string& original_method_in,
    bool can_load_local_resources_in, const std::string& page_state_in, int32_t nav_entry_id_in, const base::flat_map<std::string, bool>& subframe_unique_names_in,
    bool intended_as_new_entry_in, int32_t pending_history_list_offset_in, int32_t current_history_list_offset_in, int32_t current_history_list_length_in, bool was_discarded_in,
    bool is_view_source_in, bool should_clear_history_list_in, NavigationTimingPtr navigation_timing_in, ::blink::mojom::WasActivatedOption was_activated_in,
    const ::base::UnguessableToken& navigation_token_in, std::vector<::blink::mojom::PrefetchedSignedExchangeInfoPtr> prefetched_signed_exchanges_in, bool is_browser_initiated_in,
    const ::GURL& web_bundle_physical_url_in, const ::GURL& web_bundle_claimed_url_in, int64_t document_ukm_source_id_in, const ::blink::FramePolicy& frame_policy_in,
    ...
    std::vector<::network::mojom::WebClientHintsType> enabled_client_hints_in, bool is_cross_site_cross_browsing_context_group_in, OldPageInfoPtr old_page_info_in,
    int32_t http_response_code_in, ::blink::mojom::NavigationApiHistoryEntryArraysPtr navigation_api_history_entry_arrays_in,
...
// static
bool StructTraits<::blink::mojom::OldPageInfo::DataView, ::blink::mojom::OldPageInfoPtr>::Read(::blink::mojom::OldPageInfo::DataView input, ::blink::mojom::OldPageInfoPtr* output)
{
    bool success = true;
