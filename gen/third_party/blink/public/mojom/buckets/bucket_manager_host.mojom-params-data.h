...
static_assert(sizeof(BucketManagerHost_OpenBucket_ResponseParams_Data) == 16, "Bad sizeof(BucketManagerHost_OpenBucket_ResponseParams_Data)");
...
public:
    ...
    bool is_null() const { return !data_; }
    bool persisted() const { return data_->persisted; }
...
public:
    ...
    BucketDurability durability() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::blink::mojom::BucketDurability>(data_->durability)); }
    bool success() const { return data_->success; }
...
public:
    ...
    {
        UserType result;
        bool ret = mojo::internal::Deserialize<mojo::InterfaceRequestDataView<::blink::mojom::LockManagerInterfaceBase>>(&data_->lock_manager, &result, message_);
        DCHECK(ret);
        return result;
    }
...
public:
    ...
    {
        UserType result;
        bool ret = mojo::internal::Deserialize<mojo::InterfaceRequestDataView<::blink::mojom::CacheStorageInterfaceBase>>(&data_->cache_storage, &result, message_);
        DCHECK(ret);
        return result;
    }
