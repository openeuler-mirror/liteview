...
public:
    ...
    BucketPolicies(bool persisted_in, bool has_persisted_in, BucketDurability durability_in, bool has_durability_in, int64_t quota_in, bool has_quota_in,
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::BucketPolicies::DataView, ::blink::mojom::BucketPoliciesPtr> {
    ...
    static decltype(::blink::mojom::BucketPolicies::persisted) persisted(const ::blink::mojom::BucketPoliciesPtr& input) { return input->persisted; }

    static decltype(::blink::mojom::BucketPolicies::has_persisted) has_persisted(const ::blink::mojom::BucketPoliciesPtr& input) { return input->has_persisted; }

    static decltype(::blink::mojom::BucketPolicies::durability) durability(const ::blink::mojom::BucketPoliciesPtr& input) { return input->durability; }

    static decltype(::blink::mojom::BucketPolicies::has_durability) has_durability(const ::blink::mojom::BucketPoliciesPtr& input) { return input->has_durability; }

    static decltype(::blink::mojom::BucketPolicies::quota) quota(const ::blink::mojom::BucketPoliciesPtr& input) { return input->quota; }

    static decltype(::blink::mojom::BucketPolicies::has_quota) has_quota(const ::blink::mojom::BucketPoliciesPtr& input) { return input->has_quota; }

    static const decltype(::blink::mojom::BucketPolicies::expires)& expires(const ::blink::mojom::BucketPoliciesPtr& input) { return input->expires; }
