...
struct blink_mojom_internal_BucketDurability_DataHashFn {
    ...
    static bool Equal(const ::blink::mojom::BucketDurability& left, const ::blink::mojom::BucketDurability& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::blink::mojom::BucketDurability> : public GenericHashTraits<::blink::mojom::BucketDurability> {
    ...
    static void ConstructDeletedValue(::blink::mojom::BucketDurability& slot, bool) { slot = static_cast<::blink::mojom::BucketDurability>(-1000001); }
    static bool IsDeletedValue(const ::blink::mojom::BucketDurability& value) { return value == static_cast<::blink::mojom::BucketDurability>(-1000001); }
};
} // namespace WTF
namespace blink {
namespace mojom {
...
public:
    ...
    template <typename... Args> static BucketPoliciesPtr New(Args&&... args) { return BucketPoliciesPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static BucketPoliciesPtr From(const U& u) { return mojo::TypeConverter<BucketPoliciesPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, BucketPolicies>::Convert(*this); }
    BucketPolicies();

    BucketPolicies(bool persisted, bool has_persisted, BucketDurability durability, bool has_durability, int64_t quota, bool has_quota, absl::optional<::base::Time> expires);
    ~BucketPolicies();
    ...
    template <typename T, BucketPolicies::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    ...
    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<BucketPolicies::DataView>(input); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::BucketPolicies_UnserializedMessageContext<UserType, BucketPolicies::DataView>>(0, 0, std::move(input)), MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    {
        return BucketPolicies::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, BucketPolicies::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, BucketPolicies::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, BucketPolicies::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }

template <typename StructPtrType> BucketPoliciesPtr BucketPolicies::Clone() const
{
    return New(
        mojo::Clone(persisted), mojo::Clone(has_persisted), mojo::Clone(durability), mojo::Clone(has_durability), mojo::Clone(quota), mojo::Clone(has_quota), mojo::Clone(expires));
}
...
template <> struct MODULES_EXPORT StructTraits<::blink::mojom::blink::BucketPolicies::DataView, ::blink::mojom::blink::BucketPoliciesPtr> {
    ...
    static decltype(::blink::mojom::blink::BucketPolicies::persisted) persisted(const ::blink::mojom::blink::BucketPoliciesPtr& input) { return input->persisted; }

    static decltype(::blink::mojom::blink::BucketPolicies::has_persisted) has_persisted(const ::blink::mojom::blink::BucketPoliciesPtr& input) { return input->has_persisted; }

    static decltype(::blink::mojom::blink::BucketPolicies::durability) durability(const ::blink::mojom::blink::BucketPoliciesPtr& input) { return input->durability; }

    static decltype(::blink::mojom::blink::BucketPolicies::has_durability) has_durability(const ::blink::mojom::blink::BucketPoliciesPtr& input) { return input->has_durability; }

    static decltype(::blink::mojom::blink::BucketPolicies::quota) quota(const ::blink::mojom::blink::BucketPoliciesPtr& input) { return input->quota; }

    static decltype(::blink::mojom::blink::BucketPolicies::has_quota) has_quota(const ::blink::mojom::blink::BucketPoliciesPtr& input) { return input->has_quota; }

    static const decltype(::blink::mojom::blink::BucketPolicies::expires)& expires(const ::blink::mojom::blink::BucketPoliciesPtr& input) { return input->expires; }
