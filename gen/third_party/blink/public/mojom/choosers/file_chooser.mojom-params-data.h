...
public:
    ...
    FileChooser_EnumerateChosenDirectory_ResponseParamsDataView(internal::FileChooser_EnumerateChosenDirectory_ResponseParams_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
