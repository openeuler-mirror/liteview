...
inline bool IsKnownEnumValue(FileChooserParams_Mode value) { return internal::FileChooserParams_Mode_Data::IsKnownValue(static_cast<int32_t>(value)); }
...
public:
    ...
    FileChooserParams_Mode mode() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::blink::mojom::FileChooserParams_Mode>(data_->mode)); }
    ...
    bool need_local_path() const { return data_->need_local_path; }
    bool use_media_capture() const { return data_->use_media_capture; }
...
template <typename MaybeConstUserType> struct Serializer<::blink::mojom::FileChooserParamsDataView, MaybeConstUserType> {
    ...
    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::blink::mojom::internal::FileChooserParams_Data>& fragment)
    {
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->title.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null title in FileChooserParams struct");
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
            fragment->default_file_name.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null default_file_name in FileChooserParams struct");
        ...
        const mojo::internal::ContainerValidateParams selected_files_validate_params(0, false, nullptr);
        mojo::internal::Serialize<mojo::ArrayDataView<::mojo_base::mojom::FilePathDataView>>(in_selected_files, selected_files_fragment, &selected_files_validate_params);
        ...
        const mojo::internal::ContainerValidateParams accept_types_validate_params(0, false, nullptr);
        mojo::internal::Serialize<mojo::ArrayDataView<::mojo_base::mojom::String16DataView>>(in_accept_types, accept_types_fragment, &accept_types_validate_params);
...
template <typename MaybeConstUserType> struct Serializer<::blink::mojom::FileSystemFileInfoDataView, MaybeConstUserType> {
    ...
    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::blink::mojom::internal::FileSystemFileInfo_Data>& fragment)
    {
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->url.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null url in FileSystemFileInfo struct");
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
            fragment->modification_time.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null modification_time in FileSystemFileInfo struct");
...
template <typename MaybeConstUserType> struct Serializer<::blink::mojom::FileChooserResultDataView, MaybeConstUserType> {
    ...
    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::blink::mojom::internal::FileChooserResult_Data>& fragment)
    {
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->files.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null files in FileChooserResult struct");
