...
public:
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input) { return mojo::internal::SerializeImpl<IdleState::DataView, std::vector<uint8_t>>(input); }
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::IdleState::DataView, ::blink::mojom::IdleStatePtr> {
    ...
    static const decltype(::blink::mojom::IdleState::idle_time)& idle_time(const ::blink::mojom::IdleStatePtr& input) { return input->idle_time; }

    static decltype(::blink::mojom::IdleState::screen_locked) screen_locked(const ::blink::mojom::IdleStatePtr& input) { return input->screen_locked; }
