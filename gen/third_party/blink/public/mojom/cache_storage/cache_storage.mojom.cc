...
CacheStorageVerboseError::CacheStorageVerboseError(CacheStorageError value_in, const absl::optional<std::string>& message_in)
...
bool CacheStorageVerboseError::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
bool CacheQueryOptions::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
MultiCacheQueryOptions::MultiCacheQueryOptions(CacheQueryOptionsPtr query_options_in, const absl::optional<::std::u16string>& cache_name_in)
...
bool MultiCacheQueryOptions::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
bool BatchOperation::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
bool EagerResponse::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
bool CacheEntry::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
OpenResult::~OpenResult() { DestroyActive(); }
...
bool OpenResult::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context, false); }
...
MatchResult::~MatchResult() { DestroyActive(); }
...
bool MatchResult::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context, false); }
...
MatchAllResult::~MatchAllResult() { DestroyActive(); }
...
bool MatchAllResult::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context, false); }
...
GetAllMatchedEntriesResult::~GetAllMatchedEntriesResult() { DestroyActive(); }
...
bool GetAllMatchedEntriesResult::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context, false); }
...
CacheKeysResult::~CacheKeysResult() { DestroyActive(); }
...
bool CacheKeysResult::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context, false); }
    ...
    bool in_in_range_fetch_event, int64_t in_trace_id, MatchCallback callback)
{
    ...
    mojo::Message message(internal::kCacheStorageCache_Match_Name, kFlags, 0, 0, nullptr);
...
void CacheStorageCacheProxy::MatchAll(::blink::mojom::FetchAPIRequestPtr in_request, CacheQueryOptionsPtr in_query_options, int64_t in_trace_id, MatchAllCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    ...
    mojo::Message message(internal::kCacheStorageCache_MatchAll_Name, kFlags, 0, 0, nullptr);
    ...
    ::blink::mojom::FetchAPIRequestPtr in_request, CacheQueryOptionsPtr in_query_options, int64_t in_trace_id, GetAllMatchedEntriesCallback callback)
{
    ...
    mojo::Message message(internal::kCacheStorageCache_GetAllMatchedEntries_Name, kFlags, 0, 0, nullptr);
    ...
    params->query_options.Set(query_options_fragment.is_null() ? nullptr : query_options_fragment.data());
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
        params->query_options.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null query_options in CacheStorageCache.GetAllMatchedEntries request");
    params->trace_id = in_trace_id;
...
void CacheStorageCacheProxy::Keys(::blink::mojom::FetchAPIRequestPtr in_request, CacheQueryOptionsPtr in_query_options, int64_t in_trace_id, KeysCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    ...
    mojo::Message message(internal::kCacheStorageCache_Keys_Name, kFlags, 0, 0, nullptr);
...
void CacheStorageCacheProxy::Batch(std::vector<BatchOperationPtr> in_batch_operations, int64_t in_trace_id, BatchCallback callback)
{
    ...
    mojo::Message message(internal::kCacheStorageCache_Batch_Name, kFlags, 0, 0, nullptr);
    ...
    const mojo::internal::ContainerValidateParams batch_operations_validate_params(0, false, nullptr);
    mojo::internal::Serialize<mojo::ArrayDataView<::blink::mojom::BatchOperationDataView>>(in_batch_operations, batch_operations_fragment, &batch_operations_validate_params);
    params->batch_operations.Set(batch_operations_fragment.is_null() ? nullptr : batch_operations_fragment.data());
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
        params->batch_operations.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null batch_operations in CacheStorageCache.Batch request");
    params->trace_id = in_trace_id;
    ...
    const ::GURL& in_url, ::base::Time in_expected_response_time, ::mojo_base::BigBuffer in_data, int64_t in_trace_id, WriteSideDataCallback callback)
{
    ...
    mojo::Message message(internal::kCacheStorageCache_WriteSideData_Name, kFlags, 0, 0, nullptr);
...
bool CacheStorageCache_Match_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    internal::CacheStorageCache_Match_ResponseParams_Data* params = reinterpret_cast<internal::CacheStorageCache_Match_ResponseParams_Data*>(message->mutable_payload());

    bool success = true;
    MatchResultPtr p_result = mojo::DefaultConstructTraits::CreateInstance<MatchResultPtr>();
...
bool CacheStorageCache_MatchAll_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    DCHECK(message->is_serialized());
    internal::CacheStorageCache_MatchAll_ResponseParams_Data* params = reinterpret_cast<internal::CacheStorageCache_MatchAll_ResponseParams_Data*>(message->mutable_payload());

    bool success = true;
    MatchAllResultPtr p_result = mojo::DefaultConstructTraits::CreateInstance<MatchAllResultPtr>();
...
public:
    ...
    {
        std::unique_ptr<CacheStorageCache_GetAllMatchedEntries_ProxyToResponder> proxy(new CacheStorageCache_GetAllMatchedEntries_ProxyToResponder(message, std::move(responder)));
...
bool CacheStorageCache_GetAllMatchedEntries_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    bool success = true;
    GetAllMatchedEntriesResultPtr p_result = mojo::DefaultConstructTraits::CreateInstance<GetAllMatchedEntriesResultPtr>();
...
bool CacheStorageCache_Keys_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    DCHECK(message->is_serialized());
    internal::CacheStorageCache_Keys_ResponseParams_Data* params = reinterpret_cast<internal::CacheStorageCache_Keys_ResponseParams_Data*>(message->mutable_payload());

    bool success = true;
    CacheKeysResultPtr p_result = mojo::DefaultConstructTraits::CreateInstance<CacheKeysResultPtr>();
...
bool CacheStorageCache_Batch_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    DCHECK(message->is_serialized());
    internal::CacheStorageCache_Batch_ResponseParams_Data* params = reinterpret_cast<internal::CacheStorageCache_Batch_ResponseParams_Data*>(message->mutable_payload());

    bool success = true;
    CacheStorageVerboseErrorPtr p_result = mojo::DefaultConstructTraits::CreateInstance<CacheStorageVerboseErrorPtr>();
...
public:
    ...
    {
        std::unique_ptr<CacheStorageCache_WriteSideData_ProxyToResponder> proxy(new CacheStorageCache_WriteSideData_ProxyToResponder(message, std::move(responder)));
...
bool CacheStorageCache_WriteSideData_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    bool success = true;
    CacheStorageError p_result = mojo::DefaultConstructTraits::CreateInstance<CacheStorageError>();
...
// static
bool CacheStorageCacheStubDispatch::AcceptWithResponder(CacheStorageCache* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
{
    ...
    case internal::kCacheStorageCache_Match_Name: {
        ...
        CacheQueryOptionsPtr p_query_options = mojo::DefaultConstructTraits::CreateInstance<CacheQueryOptionsPtr>();
        bool p_in_related_fetch_event = mojo::DefaultConstructTraits::CreateInstance<bool>();
        bool p_in_range_fetch_event = mojo::DefaultConstructTraits::CreateInstance<bool>();
        int64_t p_trace_id = mojo::DefaultConstructTraits::CreateInstance<int64_t>();
        ...
        DCHECK(impl);
        impl->Match(
            std::move(p_request), std::move(p_query_options), std::move(p_in_related_fetch_event), std::move(p_in_range_fetch_event), std::move(p_trace_id), std::move(callback));
        return true;
    }
    case internal::kCacheStorageCache_MatchAll_Name: {

        internal::CacheStorageCache_MatchAll_Params_Data* params = reinterpret_cast<internal::CacheStorageCache_MatchAll_Params_Data*>(message->mutable_payload());
    ...
    case internal::kCacheStorageCache_GetAllMatchedEntries_Name: {
        ...
        CacheStorageCache::GetAllMatchedEntriesCallback callback = CacheStorageCache_GetAllMatchedEntries_ProxyToResponder::CreateCallback(*message, std::move(responder));
        // A null |impl| means no implementation was bound.
        DCHECK(impl);
    ...
    case internal::kCacheStorageCache_Batch_Name: {
        ...
        bool success = true;
        std::vector<BatchOperationPtr> p_batch_operations = mojo::DefaultConstructTraits::CreateInstance<std::vector<BatchOperationPtr>>();
        int64_t p_trace_id = mojo::DefaultConstructTraits::CreateInstance<int64_t>();
    ...
    case internal::kCacheStorageCache_WriteSideData_Name: {
        ...
        internal::CacheStorageCache_WriteSideData_Params_Data* params = reinterpret_cast<internal::CacheStorageCache_WriteSideData_Params_Data*>(message->mutable_payload());

        bool success = true;
        ::GURL p_url = mojo::DefaultConstructTraits::CreateInstance<::GURL>();
        ::base::Time p_expected_response_time = mojo::DefaultConstructTraits::CreateInstance<::base::Time>();
...
static const mojo::internal::GenericValidationInfo kCacheStorageCacheValidationInfo[] = {
    ...
    { &internal::CacheStorageCache_GetAllMatchedEntries_Params_Data::Validate, &internal::CacheStorageCache_GetAllMatchedEntries_ResponseParams_Data::Validate },
...
void CacheStorageProxy::Has(const ::std::u16string& in_cache_name, int64_t in_trace_id, HasCallback callback)
{
    ...
    mojo::Message message(internal::kCacheStorage_Has_Name, kFlags, 0, 0, nullptr);
    ...
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(params->cache_name.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null cache_name in CacheStorage.Has request");
    params->trace_id = in_trace_id;
...
void CacheStorageProxy::Delete(const ::std::u16string& in_cache_name, int64_t in_trace_id, DeleteCallback callback)
{
    ...
    mojo::Message message(internal::kCacheStorage_Delete_Name, kFlags, 0, 0, nullptr);
...
void CacheStorageProxy::Keys(int64_t in_trace_id, KeysCallback callback)
{
    ...
    mojo::Message message(internal::kCacheStorage_Keys_Name, kFlags, 0, 0, nullptr);
    ...
    bool in_in_range_fetch_event, int64_t in_trace_id, MatchCallback callback)
{
    ...
    mojo::Message message(internal::kCacheStorage_Match_Name, kFlags, 0, 0, nullptr);
    mojo::internal::MessageFragment<::blink::mojom::internal::CacheStorage_Match_Params_Data> params(message);
    params.Allocate();
    mojo::internal::MessageFragment<typename decltype(params->request)::BaseType> request_fragment(params.message());
    mojo::internal::Serialize<::blink::mojom::FetchAPIRequestDataView>(in_request, request_fragment);
    params->request.Set(request_fragment.is_null() ? nullptr : request_fragment.data());
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(params->request.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null request in CacheStorage.Match request");
...
void CacheStorageProxy::Open(const ::std::u16string& in_cache_name, int64_t in_trace_id, OpenCallback callback)
{
    ...
    mojo::Message message(internal::kCacheStorage_Open_Name, kFlags, 0, 0, nullptr);
...
bool CacheStorage_Delete_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    DCHECK(message->is_serialized());
    internal::CacheStorage_Delete_ResponseParams_Data* params = reinterpret_cast<internal::CacheStorage_Delete_ResponseParams_Data*>(message->mutable_payload());
...
bool CacheStorage_Keys_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    bool success = true;
    std::vector<::std::u16string> p_keys = mojo::DefaultConstructTraits::CreateInstance<std::vector<::std::u16string>>();
...
bool CacheStorage_Open_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    bool success = true;
    OpenResultPtr p_result = mojo::DefaultConstructTraits::CreateInstance<OpenResultPtr>();
...
bool CacheStorageStubDispatch::AcceptWithResponder(CacheStorage* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
{
    ...
    case internal::kCacheStorage_Has_Name: {
        ...
        bool success = true;
        ::std::u16string p_cache_name = mojo::DefaultConstructTraits::CreateInstance<::std::u16string>();
        int64_t p_trace_id = mojo::DefaultConstructTraits::CreateInstance<int64_t>();
    ...
    case internal::kCacheStorage_Match_Name: {
        ...
        bool success = true;
        ::blink::mojom::FetchAPIRequestPtr p_request = mojo::DefaultConstructTraits::CreateInstance<::blink::mojom::FetchAPIRequestPtr>();
        MultiCacheQueryOptionsPtr p_match_options = mojo::DefaultConstructTraits::CreateInstance<MultiCacheQueryOptionsPtr>();
        bool p_in_related_fetch_event = mojo::DefaultConstructTraits::CreateInstance<bool>();
        bool p_in_range_fetch_event = mojo::DefaultConstructTraits::CreateInstance<bool>();
        int64_t p_trace_id = mojo::DefaultConstructTraits::CreateInstance<int64_t>();
        ...
        DCHECK(impl);
        impl->Match(
            std::move(p_request), std::move(p_match_options), std::move(p_in_related_fetch_event), std::move(p_in_range_fetch_event), std::move(p_trace_id), std::move(callback));
        return true;
    }
    case internal::kCacheStorage_Open_Name: {
...
// static
bool StructTraits<::blink::mojom::CacheEntry::DataView, ::blink::mojom::CacheEntryPtr>::Read(::blink::mojom::CacheEntry::DataView input, ::blink::mojom::CacheEntryPtr* output)
{
    bool success = true;
...
// static
bool UnionTraits<::blink::mojom::OpenResult::DataView, ::blink::mojom::OpenResultPtr>::Read(::blink::mojom::OpenResult::DataView input, ::blink::mojom::OpenResultPtr* output)
{
...
// static
bool UnionTraits<::blink::mojom::MatchResult::DataView, ::blink::mojom::MatchResultPtr>::Read(::blink::mojom::MatchResult::DataView input, ::blink::mojom::MatchResultPtr* output)
{
    ...
    bool in_range_fetch_event, int64_t trace_id, MatchCallback callback)
{
    GetForwardingInterface()->Match(
        std::move(request), std::move(query_options), std::move(in_related_fetch_event), std::move(in_range_fetch_event), std::move(trace_id), std::move(callback));
}
...
void CacheStorageCacheAsyncWaiter::Match(::blink::mojom::FetchAPIRequestPtr request, CacheQueryOptionsPtr query_options, bool in_related_fetch_event, bool in_range_fetch_event,
...
{
    MatchResultPtr async_wait_result = mojo::DefaultConstructTraits::CreateInstance<MatchResultPtr>();
    Match(std::move(request), std::move(query_options), std::move(in_related_fetch_event), std::move(in_range_fetch_event), std::move(trace_id), &async_wait_result);
    return async_wait_result;
}

void CacheStorageCacheAsyncWaiter::MatchAll(::blink::mojom::FetchAPIRequestPtr request, CacheQueryOptionsPtr query_options, int64_t trace_id, MatchAllResultPtr* out_result)
{
    base::RunLoop loop;
...
{
    MatchAllResultPtr async_wait_result = mojo::DefaultConstructTraits::CreateInstance<MatchAllResultPtr>();
...
GetAllMatchedEntriesResultPtr CacheStorageCacheAsyncWaiter::GetAllMatchedEntries(::blink::mojom::FetchAPIRequestPtr request, CacheQueryOptionsPtr query_options, int64_t trace_id)
{
    GetAllMatchedEntriesResultPtr async_wait_result = mojo::DefaultConstructTraits::CreateInstance<GetAllMatchedEntriesResultPtr>();
    GetAllMatchedEntries(std::move(request), std::move(query_options), std::move(trace_id), &async_wait_result);
    return async_wait_result;
}

void CacheStorageCacheAsyncWaiter::Keys(::blink::mojom::FetchAPIRequestPtr request, CacheQueryOptionsPtr query_options, int64_t trace_id, CacheKeysResultPtr* out_result)
{
    base::RunLoop loop;
...
{
    CacheKeysResultPtr async_wait_result = mojo::DefaultConstructTraits::CreateInstance<CacheKeysResultPtr>();
...
{
    CacheStorageVerboseErrorPtr async_wait_result = mojo::DefaultConstructTraits::CreateInstance<CacheStorageVerboseErrorPtr>();
...
CacheStorageError CacheStorageCacheAsyncWaiter::WriteSideData(const ::GURL& url, ::base::Time expected_response_time, ::mojo_base::BigBuffer data, int64_t trace_id)
{
    CacheStorageError async_wait_result = mojo::DefaultConstructTraits::CreateInstance<CacheStorageError>();
...
void CacheStorageInterceptorForTesting::Keys(int64_t trace_id, KeysCallback callback) { GetForwardingInterface()->Keys(std::move(trace_id), std::move(callback)); }
...
{
    GetForwardingInterface()->Match(
        std::move(request), std::move(match_options), std::move(in_related_fetch_event), std::move(in_range_fetch_event), std::move(trace_id), std::move(callback));
}
...
void CacheStorageAsyncWaiter::Match(::blink::mojom::FetchAPIRequestPtr request, MultiCacheQueryOptionsPtr match_options, bool in_related_fetch_event, bool in_range_fetch_event,
    int64_t trace_id, MatchResultPtr* out_result)
{
    base::RunLoop loop;
...
{
    MatchResultPtr async_wait_result = mojo::DefaultConstructTraits::CreateInstance<MatchResultPtr>();
    Match(std::move(request), std::move(match_options), std::move(in_related_fetch_event), std::move(in_range_fetch_event), std::move(trace_id), &async_wait_result);
    return async_wait_result;
}
...
{
    OpenResultPtr async_wait_result = mojo::DefaultConstructTraits::CreateInstance<OpenResultPtr>();
