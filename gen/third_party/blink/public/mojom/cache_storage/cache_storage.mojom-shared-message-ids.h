...
constexpr uint32_t kCacheStorageCache_GetAllMatchedEntries_Name = 2;
constexpr uint32_t kCacheStorageCache_Keys_Name = 3;
constexpr uint32_t kCacheStorageCache_Batch_Name = 4;
constexpr uint32_t kCacheStorageCache_WriteSideData_Name = 5;
