...
static_assert(sizeof(CacheStorageCache_GetAllMatchedEntries_ResponseParams_Data) == 24, "Bad sizeof(CacheStorageCache_GetAllMatchedEntries_ResponseParams_Data)");
...
public:
    ...
    bool in_related_fetch_event() const { return data_->in_related_fetch_event; }
    bool in_range_fetch_event() const { return data_->in_range_fetch_event; }
...
public:
    ...
    CacheStorageCache_GetAllMatchedEntries_ResponseParamsDataView(internal::CacheStorageCache_GetAllMatchedEntries_ResponseParams_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
...
public:
    ...
    CacheStorageError result() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::blink::mojom::CacheStorageError>(data_->result)); }
