...
DataTransferFile::DataTransferFile(
    const ::base::FilePath& path_in, const ::base::FilePath& display_name_in, ::mojo::PendingRemote<::blink::mojom::FileSystemAccessDataTransferToken> file_system_access_token_in)
