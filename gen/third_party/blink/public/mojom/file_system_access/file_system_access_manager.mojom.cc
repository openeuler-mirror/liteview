...
CommonFilePickerOptions::CommonFilePickerOptions(const std::string& starting_directory_id_in, WellKnownDirectory well_known_starting_directory_in,
    ...
    ::mojo::PendingRemote<::blink::mojom::FileSystemAccessTransferToken> in_token, ::mojo::PendingReceiver<::blink::mojom::FileSystemAccessFileHandle> in_file_handle)
{
    ...
    TRACE_EVENT1("mojom", "Send blink::mojom::FileSystemAccessManager::GetFileHandleFromToken", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("token"), in_token, "<value of type ::mojo::PendingRemote<::blink::mojom::FileSystemAccessTransferToken>>");
    ...
    ::mojo::PendingRemote<::blink::mojom::FileSystemAccessDataTransferToken> in_token, GetEntryFromDataTransferTokenCallback callback)
{
    ...
    TRACE_EVENT1("mojom", "Send blink::mojom::FileSystemAccessManager::GetEntryFromDataTransferToken", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("token"), in_token, "<value of type ::mojo::PendingRemote<::blink::mojom::FileSystemAccessDataTransferToken>>");
    });
#endif
    const bool kExpectsResponse = true;
    const bool kIsSync = false;
...
bool FileSystemAccessManager_GetSandboxedFileSystem_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    ::mojo::PendingRemote<::blink::mojom::FileSystemAccessDirectoryHandle> p_directory
        = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingRemote<::blink::mojom::FileSystemAccessDirectoryHandle>>();
...
bool FileSystemAccessManager_ChooseEntries_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    bool success = true;
    ::blink::mojom::FileSystemAccessErrorPtr p_result = mojo::DefaultConstructTraits::CreateInstance<::blink::mojom::FileSystemAccessErrorPtr>();
    std::vector<::blink::mojom::FileSystemAccessEntryPtr> p_entries = mojo::DefaultConstructTraits::CreateInstance<std::vector<::blink::mojom::FileSystemAccessEntryPtr>>();
    ...
    ::blink::mojom::FileSystemAccessErrorPtr in_result, std::vector<::blink::mojom::FileSystemAccessEntryPtr> in_entries)
{
    ...
    TRACE_EVENT1("mojom", "Send reply blink::mojom::FileSystemAccessManager::ChooseEntries", "async_response_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("result"), in_result, "<value of type ::blink::mojom::FileSystemAccessErrorPtr>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("entries"), in_entries, "<value of type std::vector<::blink::mojom::FileSystemAccessEntryPtr>>");
    });
#endif
...
bool FileSystemAccessManager_GetEntryFromDataTransferToken_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    bool success = true;
    ::blink::mojom::FileSystemAccessErrorPtr p_result = mojo::DefaultConstructTraits::CreateInstance<::blink::mojom::FileSystemAccessErrorPtr>();
    ::blink::mojom::FileSystemAccessEntryPtr p_entry = mojo::DefaultConstructTraits::CreateInstance<::blink::mojom::FileSystemAccessEntryPtr>();
...
bool FileSystemAccessManagerStubDispatch::Accept(FileSystemAccessManager* impl, mojo::Message* message)
{
    ...
    case internal::kFileSystemAccessManager_GetFileHandleFromToken_Name: {
        ...
        ::mojo::PendingReceiver<::blink::mojom::FileSystemAccessFileHandle> p_file_handle
            = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingReceiver<::blink::mojom::FileSystemAccessFileHandle>>();
    ...
    case internal::kFileSystemAccessManager_GetDirectoryHandleFromToken_Name: {
        ...
        ::mojo::PendingReceiver<::blink::mojom::FileSystemAccessDirectoryHandle> p_directory_handle
            = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingReceiver<::blink::mojom::FileSystemAccessDirectoryHandle>>();
...
bool FileSystemAccessManagerStubDispatch::AcceptWithResponder(FileSystemAccessManager* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
{
    ...
    case internal::kFileSystemAccessManager_GetEntryFromDataTransferToken_Name: {
        ...
        ::mojo::PendingRemote<::blink::mojom::FileSystemAccessDataTransferToken> p_token
            = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingRemote<::blink::mojom::FileSystemAccessDataTransferToken>>();
...
bool StructTraits<::blink::mojom::CommonFilePickerOptions::DataView, ::blink::mojom::CommonFilePickerOptionsPtr>::Read(
    ::blink::mojom::CommonFilePickerOptions::DataView input, ::blink::mojom::CommonFilePickerOptionsPtr* output)
{
    bool success = true;
    ...
    ::blink::mojom::FileSystemAccessErrorPtr* out_result, ::mojo::PendingRemote<::blink::mojom::FileSystemAccessDirectoryHandle>* out_directory)
{
    ...
    proxy_->GetSandboxedFileSystem(base::BindOnce(
        [](base::RunLoop* loop, ::blink::mojom::FileSystemAccessErrorPtr* out_result, ::mojo::PendingRemote<::blink::mojom::FileSystemAccessDirectoryHandle>* out_directory,
            ::blink::mojom::FileSystemAccessErrorPtr result, ::mojo::PendingRemote<::blink::mojom::FileSystemAccessDirectoryHandle> directory) {
...
void FileSystemAccessManagerAsyncWaiter::ChooseEntries(FilePickerOptionsPtr options, CommonFilePickerOptionsPtr common_options,
    ::blink::mojom::FileSystemAccessErrorPtr* out_result, std::vector<::blink::mojom::FileSystemAccessEntryPtr>* out_entries)
{
    base::RunLoop loop;
