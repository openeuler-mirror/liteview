...
static_assert(sizeof(FileSystemAccessManager_GetSandboxedFileSystem_Params_Data) == 8, "Bad sizeof(FileSystemAccessManager_GetSandboxedFileSystem_Params_Data)");
...
static_assert(sizeof(FileSystemAccessManager_GetSandboxedFileSystem_ResponseParams_Data) == 24, "Bad sizeof(FileSystemAccessManager_GetSandboxedFileSystem_ResponseParams_Data)");
...
static_assert(sizeof(FileSystemAccessManager_ChooseEntries_Params_Data) == 32, "Bad sizeof(FileSystemAccessManager_ChooseEntries_Params_Data)");
...
static_assert(sizeof(FileSystemAccessManager_GetFileHandleFromToken_Params_Data) == 24, "Bad sizeof(FileSystemAccessManager_GetFileHandleFromToken_Params_Data)");
...
static_assert(sizeof(FileSystemAccessManager_GetDirectoryHandleFromToken_Params_Data) == 24, "Bad sizeof(FileSystemAccessManager_GetDirectoryHandleFromToken_Params_Data)");
...
static_assert(sizeof(FileSystemAccessManager_GetEntryFromDataTransferToken_Params_Data) == 16, "Bad sizeof(FileSystemAccessManager_GetEntryFromDataTransferToken_Params_Data)");
...
public:
    ...
    FileSystemAccessManager_GetSandboxedFileSystem_ParamsDataView(internal::FileSystemAccessManager_GetSandboxedFileSystem_Params_Data* data, mojo::Message* message)
        : data_(data)
    {
    }
...
public:
    ...
    inline void GetCommonOptionsDataView(CommonFilePickerOptionsDataView* output);

    template <typename UserType> [[nodiscard]] bool ReadCommonOptions(UserType* output)
    {

        auto* pointer = data_->common_options.Get();
        return mojo::internal::Deserialize<::blink::mojom::CommonFilePickerOptionsDataView>(pointer, output, message_);
    }
...
public:
    ...
    FileSystemAccessManager_ChooseEntries_ResponseParamsDataView(internal::FileSystemAccessManager_ChooseEntries_ResponseParams_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
...
public:
    ...
    FileSystemAccessManager_GetFileHandleFromToken_ParamsDataView(internal::FileSystemAccessManager_GetFileHandleFromToken_Params_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
    ...
    {
        UserType result;
        bool ret = mojo::internal::Deserialize<mojo::InterfacePtrDataView<::blink::mojom::FileSystemAccessTransferTokenInterfaceBase>>(&data_->token, &result, message_);
        DCHECK(ret);
        return result;
    }
    ...
    {
        UserType result;
        bool ret = mojo::internal::Deserialize<mojo::InterfaceRequestDataView<::blink::mojom::FileSystemAccessFileHandleInterfaceBase>>(&data_->file_handle, &result, message_);
        DCHECK(ret);
        return result;
    }
...
public:
    ...
    FileSystemAccessManager_GetDirectoryHandleFromToken_ParamsDataView(internal::FileSystemAccessManager_GetDirectoryHandleFromToken_Params_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
...
public:
    ...
    FileSystemAccessManager_GetEntryFromDataTransferToken_ParamsDataView(internal::FileSystemAccessManager_GetEntryFromDataTransferToken_Params_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
    ...
    {
        UserType result;
        bool ret = mojo::internal::Deserialize<mojo::InterfacePtrDataView<::blink::mojom::FileSystemAccessDataTransferTokenInterfaceBase>>(&data_->token, &result, message_);
        DCHECK(ret);
        return result;
    }
...
inline void FileSystemAccessManager_ChooseEntries_ParamsDataView::GetCommonOptionsDataView(CommonFilePickerOptionsDataView* output)
{
    auto pointer = data_->common_options.Get();
...
inline void FileSystemAccessManager_ChooseEntries_ResponseParamsDataView::GetEntriesDataView(mojo::ArrayDataView<::blink::mojom::FileSystemAccessEntryDataView>* output)
{
    auto pointer = data_->entries.Get();
    *output = mojo::ArrayDataView<::blink::mojom::FileSystemAccessEntryDataView>(pointer, message_);
}
inline void FileSystemAccessManager_GetEntryFromDataTransferToken_ResponseParamsDataView::GetResultDataView(::blink::mojom::FileSystemAccessErrorDataView* output)
{
    auto pointer = data_->result.Get();
    *output = ::blink::mojom::FileSystemAccessErrorDataView(pointer, message_);
}
inline void FileSystemAccessManager_GetEntryFromDataTransferToken_ResponseParamsDataView::GetEntryDataView(::blink::mojom::FileSystemAccessEntryDataView* output)
{
    auto pointer = data_->entry.Get();
