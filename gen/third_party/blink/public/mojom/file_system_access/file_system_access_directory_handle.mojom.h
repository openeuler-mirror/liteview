...
public:
    ...
    static FileSystemAccessHandlePtr NewFile(::mojo::PendingRemote<::blink::mojom::FileSystemAccessFileHandle> file)
    {
    ...
    static FileSystemAccessHandlePtr NewDirectory(::mojo::PendingRemote<FileSystemAccessDirectoryHandle> directory)
    {
        auto result = FileSystemAccessHandlePtr(absl::in_place);
    ...
    template <typename U> static FileSystemAccessHandlePtr From(const U& u) { return mojo::TypeConverter<FileSystemAccessHandlePtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, FileSystemAccessHandle>::Convert(*this); }

    FileSystemAccessHandle();
    ~FileSystemAccessHandle() = default;
    ...
    template <typename T, typename std::enable_if<std::is_same<T, FileSystemAccessHandle>::value>::type* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
...
public:
    ...
    template <typename... Args> static FileSystemAccessEntryPtr New(Args&&... args) { return FileSystemAccessEntryPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static FileSystemAccessEntryPtr From(const U& u) { return mojo::TypeConverter<FileSystemAccessEntryPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, FileSystemAccessEntry>::Convert(*this); }
    ...
    template <typename T, FileSystemAccessEntry::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<FileSystemAccessEntry::DataView>(input); }
    ...
    {
        return mojo::Message(std::make_unique<internal::FileSystemAccessEntry_UnserializedMessageContext<UserType, FileSystemAccessEntry::DataView>>(0, 0, std::move(input)),
    ...
    {
        return FileSystemAccessEntry::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, FileSystemAccessEntry::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, FileSystemAccessEntry::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, FileSystemAccessEntry::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
template <typename StructPtrType> FileSystemAccessEntryPtr FileSystemAccessEntry::Clone() const { return New(mojo::Clone(entry_handle), mojo::Clone(name)); }
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::FileSystemAccessEntry::DataView, ::blink::mojom::FileSystemAccessEntryPtr> {
    ...
    static decltype(::blink::mojom::FileSystemAccessEntry::entry_handle)& entry_handle(::blink::mojom::FileSystemAccessEntryPtr& input) { return input->entry_handle; }

    static const decltype(::blink::mojom::FileSystemAccessEntry::name)& name(const ::blink::mojom::FileSystemAccessEntryPtr& input) { return input->name; }
...
template <> struct BLINK_COMMON_EXPORT UnionTraits<::blink::mojom::FileSystemAccessHandle::DataView, ::blink::mojom::FileSystemAccessHandlePtr> {
    ...
    static ::blink::mojom::FileSystemAccessHandle::Tag GetTag(const ::blink::mojom::FileSystemAccessHandlePtr& input) { return input->which(); }

    static ::mojo::PendingRemote<::blink::mojom::FileSystemAccessFileHandle>& file(::blink::mojom::FileSystemAccessHandlePtr& input) { return input->get_file(); }

    static ::mojo::PendingRemote<::blink::mojom::FileSystemAccessDirectoryHandle>& directory(::blink::mojom::FileSystemAccessHandlePtr& input) { return input->get_directory(); }
