...
bool ChooseFileSystemEntryAcceptsOption::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
bool AcceptsTypesInfo::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
bool OpenFilePickerOptions::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
bool SaveFilePickerOptions::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
bool DirectoryPickerOptions::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
CommonFilePickerOptions::CommonFilePickerOptions(const WTF::String& starting_directory_id_in, WellKnownDirectory well_known_starting_directory_in,
...
void CommonFilePickerOptions::WriteIntoTrace(perfetto::TracedValue traced_context) const
{
    [[maybe_unused]] auto dict = std::move(traced_context).WriteDictionary();
    ...
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("well_known_starting_directory"), this->well_known_starting_directory,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    ...
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("starting_directory_token"), this->starting_directory_token,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
bool CommonFilePickerOptions::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
FilePickerOptions::~FilePickerOptions() { DestroyActive(); }

void FilePickerOptions::set_open_file_picker_options(OpenFilePickerOptionsPtr open_file_picker_options)
{
...
void FilePickerOptions::set_save_file_picker_options(SaveFilePickerOptionsPtr save_file_picker_options)
{
...
void FilePickerOptions::set_directory_picker_options(DirectoryPickerOptionsPtr directory_picker_options)
{
...
bool FilePickerOptions::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context, false); }
...
void FileSystemAccessManagerProxy::GetSandboxedFileSystem(GetSandboxedFileSystemCallback callback)
{
    ...
    mojo::Message message(internal::kFileSystemAccessManager_GetSandboxedFileSystem_Name, kFlags, 0, 0, nullptr);
...
void FileSystemAccessManagerProxy::ChooseEntries(FilePickerOptionsPtr in_options, CommonFilePickerOptionsPtr in_common_options, ChooseEntriesCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send blink::mojom::FileSystemAccessManager::ChooseEntries", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("common_options"), in_common_options, "<value of type CommonFilePickerOptionsPtr>");
    });
#endif
    const bool kExpectsResponse = true;
    const bool kIsSync = false;
    ...
    mojo::Message message(internal::kFileSystemAccessManager_ChooseEntries_Name, kFlags, 0, 0, nullptr);
    mojo::internal::MessageFragment<::blink::mojom::internal::FileSystemAccessManager_ChooseEntries_Params_Data> params(message);
    params.Allocate();
    mojo::internal::MessageFragment<decltype(params->options)> options_fragment(params.message());
    options_fragment.Claim(&params->options);
    mojo::internal::Serialize<::blink::mojom::FilePickerOptionsDataView>(in_options, options_fragment, true);
    ...
    mojo::internal::MessageFragment<typename decltype(params->common_options)::BaseType> common_options_fragment(params.message());
    mojo::internal::Serialize<::blink::mojom::CommonFilePickerOptionsDataView>(in_common_options, common_options_fragment);
    params->common_options.Set(common_options_fragment.is_null() ? nullptr : common_options_fragment.data());
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
        params->common_options.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null common_options in FileSystemAccessManager.ChooseEntries request");
    ...
    ::mojo::PendingRemote<::blink::mojom::blink::FileSystemAccessTransferToken> in_token, ::mojo::PendingReceiver<::blink::mojom::blink::FileSystemAccessFileHandle> in_file_handle)
{
    ...
    TRACE_EVENT1("mojom", "Send blink::mojom::FileSystemAccessManager::GetFileHandleFromToken", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("token"), in_token, "<value of type ::mojo::PendingRemote<::blink::mojom::blink::FileSystemAccessTransferToken>>");
    ...
    mojo::Message message(internal::kFileSystemAccessManager_GetFileHandleFromToken_Name, kFlags, 0, 0, nullptr);
    ...
    params.Allocate();
    mojo::internal::Serialize<mojo::InterfacePtrDataView<::blink::mojom::FileSystemAccessTransferTokenInterfaceBase>>(in_token, &params->token, &params.message());
    ...
    mojo::internal::Serialize<mojo::InterfaceRequestDataView<::blink::mojom::FileSystemAccessFileHandleInterfaceBase>>(in_file_handle, &params->file_handle, &params.message());
    ...
    ::mojo::PendingReceiver<::blink::mojom::blink::FileSystemAccessDirectoryHandle> in_directory_handle)
{
    ...
    TRACE_EVENT1("mojom", "Send blink::mojom::FileSystemAccessManager::GetDirectoryHandleFromToken", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("token"), in_token, "<value of type ::mojo::PendingRemote<::blink::mojom::blink::FileSystemAccessTransferToken>>");
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("directory_handle"), in_directory_handle, "<value of type ::mojo::PendingReceiver<::blink::mojom::blink::FileSystemAccessDirectoryHandle>>");
    });
#endif
    const bool kExpectsResponse = false;
    const bool kIsSync = false;
    ...
    mojo::Message message(internal::kFileSystemAccessManager_GetDirectoryHandleFromToken_Name, kFlags, 0, 0, nullptr);
    ...
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(!mojo::internal::IsHandleOrInterfaceValid(params->directory_handle), mojo::internal::VALIDATION_ERROR_UNEXPECTED_INVALID_HANDLE,
    ...
    ::mojo::PendingRemote<::blink::mojom::blink::FileSystemAccessDataTransferToken> in_token, GetEntryFromDataTransferTokenCallback callback)
{
    ...
    mojo::Message message(internal::kFileSystemAccessManager_GetEntryFromDataTransferToken_Name, kFlags, 0, 0, nullptr);
    ...
    params.Allocate();
    mojo::internal::Serialize<mojo::InterfacePtrDataView<::blink::mojom::FileSystemAccessDataTransferTokenInterfaceBase>>(in_token, &params->token, &params.message());
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(!mojo::internal::IsHandleOrInterfaceValid(params->token), mojo::internal::VALIDATION_ERROR_UNEXPECTED_INVALID_HANDLE,
...
public:
    static FileSystemAccessManager::GetSandboxedFileSystemCallback CreateCallback(::mojo::Message& message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
    {
...
private:
    ...
    void Run(::blink::mojom::blink::FileSystemAccessErrorPtr in_result, ::mojo::PendingRemote<::blink::mojom::blink::FileSystemAccessDirectoryHandle> in_directory);
};
...
bool FileSystemAccessManager_GetSandboxedFileSystem_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    ::mojo::PendingRemote<::blink::mojom::blink::FileSystemAccessDirectoryHandle> p_directory
        = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingRemote<::blink::mojom::blink::FileSystemAccessDirectoryHandle>>();
...
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send reply blink::mojom::FileSystemAccessManager::GetSandboxedFileSystem", "async_response_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
...
public:
    ...
    {
        std::unique_ptr<FileSystemAccessManager_ChooseEntries_ProxyToResponder> proxy(new FileSystemAccessManager_ChooseEntries_ProxyToResponder(message, std::move(responder)));
...
bool FileSystemAccessManager_ChooseEntries_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    WTF::Vector<::blink::mojom::blink::FileSystemAccessEntryPtr> p_entries
        = mojo::DefaultConstructTraits::CreateInstance<WTF::Vector<::blink::mojom::blink::FileSystemAccessEntryPtr>>();
    ...
    ::blink::mojom::blink::FileSystemAccessErrorPtr in_result, WTF::Vector<::blink::mojom::blink::FileSystemAccessEntryPtr> in_entries)
{
    ...
    TRACE_EVENT1("mojom", "Send reply blink::mojom::FileSystemAccessManager::ChooseEntries", "async_response_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("result"), in_result, "<value of type ::blink::mojom::blink::FileSystemAccessErrorPtr>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("entries"), in_entries, "<value of type WTF::Vector<::blink::mojom::blink::FileSystemAccessEntryPtr>>");
    });
#endif
...
public:
    static FileSystemAccessManager::GetEntryFromDataTransferTokenCallback CreateCallback(::mojo::Message& message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
    {
...
bool FileSystemAccessManager_GetEntryFromDataTransferToken_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    bool success = true;
    ::blink::mojom::blink::FileSystemAccessErrorPtr p_result = mojo::DefaultConstructTraits::CreateInstance<::blink::mojom::blink::FileSystemAccessErrorPtr>();
    ::blink::mojom::blink::FileSystemAccessEntryPtr p_entry = mojo::DefaultConstructTraits::CreateInstance<::blink::mojom::blink::FileSystemAccessEntryPtr>();
    ...
    if (success && !input_data_view.ReadEntry(&p_entry))
        success = false;
    if (!success) {
        ReportValidationErrorForMessage(message, mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED, FileSystemAccessManager::Name_, 4, true);
        return false;
    }
    if (!callback_.is_null())
...
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send reply blink::mojom::FileSystemAccessManager::GetEntryFromDataTransferToken", "async_response_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("result"), in_result, "<value of type ::blink::mojom::blink::FileSystemAccessErrorPtr>");
...
bool FileSystemAccessManagerStubDispatch::Accept(FileSystemAccessManager* impl, mojo::Message* message)
{
    ...
    case internal::kFileSystemAccessManager_GetFileHandleFromToken_Name: {
        ...
        ::mojo::PendingReceiver<::blink::mojom::blink::FileSystemAccessFileHandle> p_file_handle
            = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingReceiver<::blink::mojom::blink::FileSystemAccessFileHandle>>();
    ...
    case internal::kFileSystemAccessManager_GetDirectoryHandleFromToken_Name: {
        ...
        ::mojo::PendingReceiver<::blink::mojom::blink::FileSystemAccessDirectoryHandle> p_directory_handle
            = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingReceiver<::blink::mojom::blink::FileSystemAccessDirectoryHandle>>();
...
// static
bool FileSystemAccessManagerStubDispatch::AcceptWithResponder(FileSystemAccessManager* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
{
    ...
    case internal::kFileSystemAccessManager_ChooseEntries_Name: {
        ...
        bool success = true;
        FilePickerOptionsPtr p_options = mojo::DefaultConstructTraits::CreateInstance<FilePickerOptionsPtr>();
        CommonFilePickerOptionsPtr p_common_options = mojo::DefaultConstructTraits::CreateInstance<CommonFilePickerOptionsPtr>();
        ...
        FileSystemAccessManager::ChooseEntriesCallback callback = FileSystemAccessManager_ChooseEntries_ProxyToResponder::CreateCallback(*message, std::move(responder));
        // A null |impl| means no implementation was bound.
        DCHECK(impl);
        impl->ChooseEntries(std::move(p_options), std::move(p_common_options), std::move(callback));
        return true;
    }
    case internal::kFileSystemAccessManager_GetFileHandleFromToken_Name: {
        break;
    ...
    case internal::kFileSystemAccessManager_GetEntryFromDataTransferToken_Name: {
        ...
        ::mojo::PendingRemote<::blink::mojom::blink::FileSystemAccessDataTransferToken> p_token
            = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingRemote<::blink::mojom::blink::FileSystemAccessDataTransferToken>>();
...
static const mojo::internal::GenericValidationInfo kFileSystemAccessManagerValidationInfo[] = {
    { &internal::FileSystemAccessManager_GetSandboxedFileSystem_Params_Data::Validate, &internal::FileSystemAccessManager_GetSandboxedFileSystem_ResponseParams_Data::Validate },
...
bool StructTraits<::blink::mojom::blink::CommonFilePickerOptions::DataView, ::blink::mojom::blink::CommonFilePickerOptionsPtr>::Read(
    ::blink::mojom::blink::CommonFilePickerOptions::DataView input, ::blink::mojom::blink::CommonFilePickerOptionsPtr* output)
{
    bool success = true;
    ...
    if (success && !input.ReadWellKnownStartingDirectory(&result->well_known_starting_directory))
        success = false;
    if (success) {
        result->starting_directory_token = input.TakeStartingDirectoryToken<decltype(result->starting_directory_token)>();
    }
    *output = std::move(result);
    return success;
}
...
void FileSystemAccessManagerInterceptorForTesting::GetDirectoryHandleFromToken(::mojo::PendingRemote<::blink::mojom::blink::FileSystemAccessTransferToken> token,
    ...
    ::blink::mojom::blink::FileSystemAccessErrorPtr* out_result, ::mojo::PendingRemote<::blink::mojom::blink::FileSystemAccessDirectoryHandle>* out_directory)
{
    ...
    proxy_->GetSandboxedFileSystem(base::BindOnce(
        [](base::RunLoop* loop, ::blink::mojom::blink::FileSystemAccessErrorPtr* out_result,
            ::mojo::PendingRemote<::blink::mojom::blink::FileSystemAccessDirectoryHandle>* out_directory, ::blink::mojom::blink::FileSystemAccessErrorPtr result,
...
void FileSystemAccessManagerAsyncWaiter::ChooseEntries(FilePickerOptionsPtr options, CommonFilePickerOptionsPtr common_options,
    ::blink::mojom::blink::FileSystemAccessErrorPtr* out_result, WTF::Vector<::blink::mojom::blink::FileSystemAccessEntryPtr>* out_entries)
{
    base::RunLoop loop;
    proxy_->ChooseEntries(std::move(options), std::move(common_options),
        base::BindOnce(
            [](base::RunLoop* loop, ::blink::mojom::blink::FileSystemAccessErrorPtr* out_result, WTF::Vector<::blink::mojom::blink::FileSystemAccessEntryPtr>* out_entries,
                ::blink::mojom::blink::FileSystemAccessErrorPtr result, WTF::Vector<::blink::mojom::blink::FileSystemAccessEntryPtr> entries) {
                *out_result = std::move(result);
