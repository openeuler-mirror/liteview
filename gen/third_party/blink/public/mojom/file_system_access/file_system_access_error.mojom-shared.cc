...
static NOINLINE const char* FileSystemAccessStatusToStringHelper(FileSystemAccessStatus value)
{
...
std::ostream& operator<<(std::ostream& os, FileSystemAccessStatus value) { return os << FileSystemAccessStatusToString(value); }
