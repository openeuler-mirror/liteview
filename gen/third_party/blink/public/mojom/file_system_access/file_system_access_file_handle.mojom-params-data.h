...
static_assert(sizeof(FileSystemAccessFileHandle_GetPermissionStatus_Params_Data) == 16, "Bad sizeof(FileSystemAccessFileHandle_GetPermissionStatus_Params_Data)");
...
static_assert(sizeof(FileSystemAccessFileHandle_GetPermissionStatus_ResponseParams_Data) == 16, "Bad sizeof(FileSystemAccessFileHandle_GetPermissionStatus_ResponseParams_Data)");
...
static_assert(sizeof(FileSystemAccessFileHandle_RequestPermission_ResponseParams_Data) == 24, "Bad sizeof(FileSystemAccessFileHandle_RequestPermission_ResponseParams_Data)");
...
static_assert(sizeof(FileSystemAccessFileHandle_CreateFileWriter_ResponseParams_Data) == 24, "Bad sizeof(FileSystemAccessFileHandle_CreateFileWriter_ResponseParams_Data)");
...
static_assert(sizeof(FileSystemAccessFileHandle_OpenAccessHandle_Params_Data) == 8, "Bad sizeof(FileSystemAccessFileHandle_OpenAccessHandle_Params_Data)");
...
static_assert(sizeof(FileSystemAccessFileHandle_OpenAccessHandle_ResponseParams_Data) == 40, "Bad sizeof(FileSystemAccessFileHandle_OpenAccessHandle_ResponseParams_Data)");
...
static_assert(sizeof(FileSystemAccessFileHandle_IsSameEntry_ResponseParams_Data) == 24, "Bad sizeof(FileSystemAccessFileHandle_IsSameEntry_ResponseParams_Data)");
...
static_assert(sizeof(FileSystemAccessFileHandle_GetUniqueId_ResponseParams_Data) == 16, "Bad sizeof(FileSystemAccessFileHandle_GetUniqueId_ResponseParams_Data)");
...
public:
    ...
    FileSystemAccessFileHandle_GetPermissionStatus_ParamsDataView(internal::FileSystemAccessFileHandle_GetPermissionStatus_Params_Data* data, mojo::Message* message)
        : data_(data)
    {
    }
...
public:
    ...
    FileSystemAccessFileHandle_RequestPermission_ParamsDataView(internal::FileSystemAccessFileHandle_RequestPermission_Params_Data* data, mojo::Message* message)
        : data_(data)
    {
    }
...
public:
    ...
    FileSystemAccessFileHandle_RequestPermission_ResponseParamsDataView(internal::FileSystemAccessFileHandle_RequestPermission_ResponseParams_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
...
public:
    ...
    bool is_null() const { return !data_; }
    bool keep_existing_data() const { return data_->keep_existing_data; }
    bool auto_close() const { return data_->auto_close; }
...
public:
    ...
    FileSystemAccessFileHandle_CreateFileWriter_ResponseParamsDataView(internal::FileSystemAccessFileHandle_CreateFileWriter_ResponseParams_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
    ...
    {
        UserType result;
        bool ret = mojo::internal::Deserialize<mojo::InterfacePtrDataView<::blink::mojom::FileSystemAccessFileWriterInterfaceBase>>(&data_->writer, &result, message_);
        DCHECK(ret);
        return result;
    }
...
public:
    ...
    FileSystemAccessFileHandle_OpenAccessHandle_ResponseParamsDataView(internal::FileSystemAccessFileHandle_OpenAccessHandle_ResponseParams_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
    ...
    template <typename UserType> UserType TakeAccessHandleHost()
    {
        UserType result;
        bool ret
            = mojo::internal::Deserialize<mojo::InterfacePtrDataView<::blink::mojom::FileSystemAccessAccessHandleHostInterfaceBase>>(&data_->access_handle_host, &result, message_);
        DCHECK(ret);
        return result;
    }
...
public:
    ...
    {
        UserType result;
        bool ret = mojo::internal::Deserialize<mojo::InterfacePtrDataView<::blink::mojom::FileSystemAccessTransferTokenInterfaceBase>>(&data_->other, &result, message_);
        DCHECK(ret);
        return result;
    }
...
public:
    ...
    FileSystemAccessFileHandle_IsSameEntry_ResponseParamsDataView(internal::FileSystemAccessFileHandle_IsSameEntry_ResponseParams_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
    ...
    bool is_same() const { return data_->is_same; }
...
public:
    ...
    FileSystemAccessFileHandle_GetUniqueId_ResponseParamsDataView(internal::FileSystemAccessFileHandle_GetUniqueId_ResponseParams_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
