...
// with not having this data in traces there.
    ...
    virtual void Move(::mojo::PendingRemote<::blink::mojom::blink::FileSystemAccessTransferToken> destination_directory, const WTF::String& new_entry_name, MoveCallback callback)
        = 0;
    ...
    using OpenAccessHandleCallback = base::OnceCallback<void(
        ::blink::mojom::blink::FileSystemAccessErrorPtr, FileSystemAccessAccessHandleFilePtr, ::mojo::PendingRemote<::blink::mojom::blink::FileSystemAccessAccessHandleHost>)>;
...
public:
    ...
    static FileSystemAccessAccessHandleFilePtr NewIncognitoFileDelegate(::mojo::PendingRemote<::blink::mojom::blink::FileSystemAccessFileDelegateHost> incognito_file_delegate)
    {
        auto result = FileSystemAccessAccessHandleFilePtr(absl::in_place);
...
namespace mojo {
template <> struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::FileSystemAccessRegularFile::DataView, ::blink::mojom::blink::FileSystemAccessRegularFilePtr> {
    ...
    static decltype(::blink::mojom::blink::FileSystemAccessRegularFile::os_file)& os_file(::blink::mojom::blink::FileSystemAccessRegularFilePtr& input) { return input->os_file; }
...
template <> struct PLATFORM_EXPORT UnionTraits<::blink::mojom::blink::FileSystemAccessAccessHandleFile::DataView, ::blink::mojom::blink::FileSystemAccessAccessHandleFilePtr> {
    ...
    static ::blink::mojom::blink::FileSystemAccessAccessHandleFile::Tag GetTag(const ::blink::mojom::blink::FileSystemAccessAccessHandleFilePtr& input) { return input->which(); }
