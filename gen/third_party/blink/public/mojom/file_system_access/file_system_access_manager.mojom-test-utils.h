...
class BLINK_COMMON_EXPORT FileSystemAccessManagerInterceptorForTesting : public FileSystemAccessManager {
    ...
    void GetFileHandleFromToken(
        ::mojo::PendingRemote<::blink::mojom::FileSystemAccessTransferToken> token, ::mojo::PendingReceiver<::blink::mojom::FileSystemAccessFileHandle> file_handle) override;
...
public:
    ...
    void GetSandboxedFileSystem(::blink::mojom::FileSystemAccessErrorPtr* out_result, ::mojo::PendingRemote<::blink::mojom::FileSystemAccessDirectoryHandle>* out_directory);

    void ChooseEntries(FilePickerOptionsPtr options, CommonFilePickerOptionsPtr common_options, ::blink::mojom::FileSystemAccessErrorPtr* out_result,
        std::vector<::blink::mojom::FileSystemAccessEntryPtr>* out_entries);

    void GetEntryFromDataTransferToken(::mojo::PendingRemote<::blink::mojom::FileSystemAccessDataTransferToken> token, ::blink::mojom::FileSystemAccessErrorPtr* out_result,
