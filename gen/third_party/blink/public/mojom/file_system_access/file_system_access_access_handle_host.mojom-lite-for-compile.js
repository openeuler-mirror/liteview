// third_party/blink/public/mojom/file_system_access/file_system_access_access_handle_host.mojom-lite-for-compile.js is auto generated by mojom_bindings_generator.py, do not edit
...
goog.provide('blink.mojom.FileSystemAccessAccessHandleHost');
goog.provide('blink.mojom.FileSystemAccessAccessHandleHostReceiver');
goog.provide('blink.mojom.FileSystemAccessAccessHandleHostCallbackRouter');
goog.provide('blink.mojom.FileSystemAccessAccessHandleHostInterface');
goog.provide('blink.mojom.FileSystemAccessAccessHandleHostRemote');
goog.provide('blink.mojom.FileSystemAccessAccessHandleHostPendingReceiver');
/**
...
/** @interface */
blink.mojom.FileSystemAccessAccessHandleHostInterface = class {
...
goog.provide('blink.mojom.FileSystemAccessAccessHandleHost_Close_ParamsSpec');
/**
...
goog.provide('blink.mojom.FileSystemAccessAccessHandleHost_Close_ResponseParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('blink.mojom.FileSystemAccessAccessHandleHost_Close_Params');
...
goog.provide('blink.mojom.FileSystemAccessAccessHandleHost_Close_ResponseParams');
