...
public:
    ...
    void CreateFileWriter(bool keep_existing_data, bool auto_close, ::blink::mojom::FileSystemAccessErrorPtr* out_result,
    ...
    void OpenAccessHandle(::blink::mojom::FileSystemAccessErrorPtr* out_result, FileSystemAccessAccessHandleFilePtr* out_file,
        ::mojo::PendingRemote<::blink::mojom::FileSystemAccessAccessHandleHost>* out_access_handle_host);

    void IsSameEntry(::mojo::PendingRemote<::blink::mojom::FileSystemAccessTransferToken> other, ::blink::mojom::FileSystemAccessErrorPtr* out_result, bool* out_is_same);
