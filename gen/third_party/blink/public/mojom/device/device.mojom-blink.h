...
public:
    ...
    static DeviceAttributeResultPtr NewErrorMessage(const WTF::String& error_message)
    {
    ...
    static DeviceAttributeResultPtr NewAttribute(const WTF::String& attribute)
    {
        auto result = DeviceAttributeResultPtr(absl::in_place);
...
template <> struct PLATFORM_EXPORT UnionTraits<::blink::mojom::blink::DeviceAttributeResult::DataView, ::blink::mojom::blink::DeviceAttributeResultPtr> {
    ...
    static ::blink::mojom::blink::DeviceAttributeResult::Tag GetTag(const ::blink::mojom::blink::DeviceAttributeResultPtr& input) { return input->which(); }

    static const WTF::String& error_message(const ::blink::mojom::blink::DeviceAttributeResultPtr& input) { return input->get_error_message(); }

    static const WTF::String& attribute(const ::blink::mojom::blink::DeviceAttributeResultPtr& input) { return input->get_attribute(); }
