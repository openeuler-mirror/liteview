...
public:
    ...
    static DeviceAttributeResultPtr NewErrorMessage(const std::string& error_message)
    {
    ...
    static DeviceAttributeResultPtr NewAttribute(const absl::optional<std::string>& attribute)
    {
        auto result = DeviceAttributeResultPtr(absl::in_place);
    ...
    template <typename U> static DeviceAttributeResultPtr From(const U& u) { return mojo::TypeConverter<DeviceAttributeResultPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, DeviceAttributeResult>::Convert(*this); }
    ...
    template <typename T, typename std::enable_if<std::is_same<T, DeviceAttributeResult>::value>::type* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    ...
    void set_attribute(const absl::optional<std::string>& attribute);

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<DeviceAttributeResult::DataView>(input); }
...
template <> struct BLINK_COMMON_EXPORT UnionTraits<::blink::mojom::DeviceAttributeResult::DataView, ::blink::mojom::DeviceAttributeResultPtr> {
    ...
    static ::blink::mojom::DeviceAttributeResult::Tag GetTag(const ::blink::mojom::DeviceAttributeResultPtr& input) { return input->which(); }

    static const std::string& error_message(const ::blink::mojom::DeviceAttributeResultPtr& input) { return input->get_error_message(); }

    static const absl::optional<std::string>& attribute(const ::blink::mojom::DeviceAttributeResultPtr& input) { return input->get_attribute(); }
