...
// with not having this data in traces there.
    ...
    virtual void RegisterEmbeddedFrameSinkBundle(const ::viz::FrameSinkBundleId& bundle_id, ::mojo::PendingReceiver<::viz::mojom::blink::FrameSinkBundle> receiver,
        ::mojo::PendingRemote<::viz::mojom::blink::FrameSinkBundleClient> client)
        = 0;

    virtual void CreateCompositorFrameSink(const ::viz::FrameSinkId& frame_sink_id, ::mojo::PendingRemote<::viz::mojom::blink::CompositorFrameSinkClient> client,
...
//
//   void RegisterEmbeddedFrameSink(const ::viz::FrameSinkId& parent_frame_sink_id, const ::viz::FrameSinkId& frame_sink_id, ::mojo::PendingRemote<EmbeddedFrameSinkClient> client)
//   final;
//
...
//   ::mojo::PendingRemote<::viz::mojom::blink::CompositorFrameSinkClient> client, ::mojo::PendingReceiver<::viz::mojom::blink::CompositorFrameSink> sink) final;
//
//   void CreateSimpleCompositorFrameSink(const ::viz::FrameSinkId& parent_frame_sink_id, const ::viz::FrameSinkId& frame_sink_id, ::mojo::PendingRemote<EmbeddedFrameSinkClient>
//   surface_client, ::mojo::PendingRemote<::viz::mojom::blink::CompositorFrameSinkClient> client, ::mojo::PendingReceiver<::viz::mojom::blink::CompositorFrameSink> sink) final;
//
