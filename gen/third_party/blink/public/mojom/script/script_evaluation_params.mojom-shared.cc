...
std::ostream& operator<<(std::ostream& os, UserActivationOption value) { return os << UserActivationOptionToString(value); }
...
std::ostream& operator<<(std::ostream& os, WantResultOption value) { return os << WantResultOptionToString(value); }
...
std::ostream& operator<<(std::ostream& os, PromiseResultOption value) { return os << PromiseResultOptionToString(value); }
...
std::ostream& operator<<(std::ostream& os, EvaluationTiming value) { return os << EvaluationTimingToString(value); }
...
std::ostream& operator<<(std::ostream& os, LoadEventBlockingOption value) { return os << LoadEventBlockingOptionToString(value); }
