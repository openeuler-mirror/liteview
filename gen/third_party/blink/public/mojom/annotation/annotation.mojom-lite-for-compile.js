...
goog.require('blink.mojom.LinkGenerationError');
goog.require('blink.mojom.LinkGenerationReadyStatus');
...
goog.provide('blink.mojom.SelectorCreationResultSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('blink.mojom.SelectorCreationResult');
