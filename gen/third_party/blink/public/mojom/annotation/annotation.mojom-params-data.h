...
static_assert(sizeof(AnnotationAgentContainer_CreateAgentFromSelection_Params_Data) == 16, "Bad sizeof(AnnotationAgentContainer_CreateAgentFromSelection_Params_Data)");
...
static_assert(
    sizeof(AnnotationAgentContainer_CreateAgentFromSelection_ResponseParams_Data) == 24, "Bad sizeof(AnnotationAgentContainer_CreateAgentFromSelection_ResponseParams_Data)");
...
public:
    ...
    {
        UserType result;
        bool ret = mojo::internal::Deserialize<mojo::InterfacePtrDataView<::blink::mojom::AnnotationAgentHostInterfaceBase>>(&data_->host_remote, &result, message_);
        DCHECK(ret);
        return result;
    }
    ...
    {
        UserType result;
        bool ret = mojo::internal::Deserialize<mojo::InterfaceRequestDataView<::blink::mojom::AnnotationAgentInterfaceBase>>(&data_->agent_receiver, &result, message_);
        DCHECK(ret);
        return result;
    }
    ...
    AnnotationType type() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::blink::mojom::AnnotationType>(data_->type)); }
...
public:
    ...
    AnnotationAgentContainer_CreateAgentFromSelection_ParamsDataView(internal::AnnotationAgentContainer_CreateAgentFromSelection_Params_Data* data, mojo::Message* message)
        : data_(data)
    {
    }
...
public:
    ...
    ::blink::mojom::LinkGenerationError error() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::blink::mojom::LinkGenerationError>(data_->error)); }
