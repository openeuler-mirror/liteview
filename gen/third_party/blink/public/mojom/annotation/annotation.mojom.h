...
//
//   void CreateAgent(::mojo::PendingRemote<AnnotationAgentHost> host_remote, ::mojo::PendingReceiver<AnnotationAgent> agent_receiver, AnnotationType type, const std::string&
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::SelectorCreationResult::DataView, ::blink::mojom::SelectorCreationResultPtr> {
    ...
    static decltype(::blink::mojom::SelectorCreationResult::host_receiver)& host_receiver(::blink::mojom::SelectorCreationResultPtr& input) { return input->host_receiver; }

    static decltype(::blink::mojom::SelectorCreationResult::agent_remote)& agent_remote(::blink::mojom::SelectorCreationResultPtr& input) { return input->agent_remote; }

    static const decltype(::blink::mojom::SelectorCreationResult::serialized_selector)& serialized_selector(const ::blink::mojom::SelectorCreationResultPtr& input)
    {
