...
struct blink_mojom_internal_AnnotationType_DataHashFn {
    ...
    static bool Equal(const ::blink::mojom::AnnotationType& left, const ::blink::mojom::AnnotationType& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::blink::mojom::AnnotationType> : public GenericHashTraits<::blink::mojom::AnnotationType> {
    ...
    static void ConstructDeletedValue(::blink::mojom::AnnotationType& slot, bool) { slot = static_cast<::blink::mojom::AnnotationType>(-1000001); }
    static bool IsDeletedValue(const ::blink::mojom::AnnotationType& value) { return value == static_cast<::blink::mojom::AnnotationType>(-1000001); }
};
} // namespace WTF
namespace blink {
namespace mojom {
...
// with not having this data in traces there.
    ...
    virtual void CreateAgent(::mojo::PendingRemote<AnnotationAgentHost> host_remote, ::mojo::PendingReceiver<AnnotationAgent> agent_receiver, AnnotationType type,
...
//
//   void CreateAgent(::mojo::PendingRemote<AnnotationAgentHost> host_remote, ::mojo::PendingReceiver<AnnotationAgent> agent_receiver, AnnotationType type, const WTF::String&
//   serialized_selector) final;
//
...
public:
    ...
    template <typename... Args> static SelectorCreationResultPtr New(Args&&... args) { return SelectorCreationResultPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static SelectorCreationResultPtr From(const U& u) { return mojo::TypeConverter<SelectorCreationResultPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, SelectorCreationResult>::Convert(*this); }
    ...
    SelectorCreationResult(::mojo::PendingReceiver<AnnotationAgentHost> host_receiver_in, ::mojo::PendingRemote<AnnotationAgent> agent_remote_in,
    ...
    template <typename T, SelectorCreationResult::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    ...
    {
        return mojo::Message(std::make_unique<internal::SelectorCreationResult_UnserializedMessageContext<UserType, SelectorCreationResult::DataView>>(0, 0, std::move(input)),
    ...
    {
        return SelectorCreationResult::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, SelectorCreationResult::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, SelectorCreationResult::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, SelectorCreationResult::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
template <> struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::SelectorCreationResult::DataView, ::blink::mojom::blink::SelectorCreationResultPtr> {
    ...
    static const decltype(::blink::mojom::blink::SelectorCreationResult::serialized_selector)& serialized_selector(const ::blink::mojom::blink::SelectorCreationResultPtr& input)
    {
        return input->serialized_selector;
    }

    static const decltype(::blink::mojom::blink::SelectorCreationResult::selected_text)& selected_text(const ::blink::mojom::blink::SelectorCreationResultPtr& input)
    {
