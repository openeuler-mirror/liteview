...
class PLATFORM_EXPORT GeolocationServiceInterceptorForTesting : public GeolocationService {
    ...
    void CreateGeolocation(::mojo::PendingReceiver<::device::mojom::blink::Geolocation> receiver, bool user_gesture, CreateGeolocationCallback callback) override;
};
...
public:
    ...
    void CreateGeolocation(::mojo::PendingReceiver<::device::mojom::blink::Geolocation> receiver, bool user_gesture, ::blink::mojom::blink::PermissionStatus* out_status);
