...
public:
    ...
    GeolocationService_CreateGeolocation_ResponseParamsDataView(internal::GeolocationService_CreateGeolocation_ResponseParams_Data* data, mojo::Message* message)
        : data_(data)
    {
    }
