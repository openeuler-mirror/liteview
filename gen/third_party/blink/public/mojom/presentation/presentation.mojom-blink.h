...
struct blink_mojom_internal_ScreenAvailability_DataHashFn {
    ...
    static bool Equal(const ::blink::mojom::ScreenAvailability& left, const ::blink::mojom::ScreenAvailability& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::blink::mojom::ScreenAvailability> : public GenericHashTraits<::blink::mojom::ScreenAvailability> {
    static_assert(true, "-1000000 is a reserved enum value");
    static_assert(true, "-1000001 is a reserved enum value");
    static const bool kEmptyValueIsZero = false;
    static ::blink::mojom::ScreenAvailability EmptyValue() { return static_cast<::blink::mojom::ScreenAvailability>(-1000000); }
    static void ConstructDeletedValue(::blink::mojom::ScreenAvailability& slot, bool) { slot = static_cast<::blink::mojom::ScreenAvailability>(-1000001); }
    static bool IsDeletedValue(const ::blink::mojom::ScreenAvailability& value) { return value == static_cast<::blink::mojom::ScreenAvailability>(-1000001); }
};
} // namespace WTF
namespace WTF {
struct blink_mojom_internal_PresentationConnectionState_DataHashFn {
    ...
    static bool Equal(const ::blink::mojom::PresentationConnectionState& left, const ::blink::mojom::PresentationConnectionState& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::blink::mojom::PresentationConnectionState> : public GenericHashTraits<::blink::mojom::PresentationConnectionState> {
    static_assert(true, "-1000000 is a reserved enum value");
    static_assert(true, "-1000001 is a reserved enum value");
    static const bool kEmptyValueIsZero = false;
    static ::blink::mojom::PresentationConnectionState EmptyValue() { return static_cast<::blink::mojom::PresentationConnectionState>(-1000000); }
    static void ConstructDeletedValue(::blink::mojom::PresentationConnectionState& slot, bool) { slot = static_cast<::blink::mojom::PresentationConnectionState>(-1000001); }
    static bool IsDeletedValue(const ::blink::mojom::PresentationConnectionState& value) { return value == static_cast<::blink::mojom::PresentationConnectionState>(-1000001); }
};
} // namespace WTF
namespace WTF {
struct blink_mojom_internal_PresentationConnectionCloseReason_DataHashFn {
    ...
    static bool Equal(const ::blink::mojom::PresentationConnectionCloseReason& left, const ::blink::mojom::PresentationConnectionCloseReason& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::blink::mojom::PresentationConnectionCloseReason> : public GenericHashTraits<::blink::mojom::PresentationConnectionCloseReason> {
    static_assert(true, "-1000000 is a reserved enum value");
    static_assert(true, "-1000001 is a reserved enum value");
    static const bool kEmptyValueIsZero = false;
    static ::blink::mojom::PresentationConnectionCloseReason EmptyValue() { return static_cast<::blink::mojom::PresentationConnectionCloseReason>(-1000000); }
...
struct blink_mojom_internal_PresentationErrorType_DataHashFn {
    ...
    static bool Equal(const ::blink::mojom::PresentationErrorType& left, const ::blink::mojom::PresentationErrorType& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::blink::mojom::PresentationErrorType> : public GenericHashTraits<::blink::mojom::PresentationErrorType> {
    static_assert(true, "-1000000 is a reserved enum value");
    static_assert(true, "-1000001 is a reserved enum value");
    static const bool kEmptyValueIsZero = false;
    static ::blink::mojom::PresentationErrorType EmptyValue() { return static_cast<::blink::mojom::PresentationErrorType>(-1000000); }
    static void ConstructDeletedValue(::blink::mojom::PresentationErrorType& slot, bool) { slot = static_cast<::blink::mojom::PresentationErrorType>(-1000001); }
    static bool IsDeletedValue(const ::blink::mojom::PresentationErrorType& value) { return value == static_cast<::blink::mojom::PresentationErrorType>(-1000001); }
};
} // namespace WTF
namespace blink {
namespace mojom {
...
//
//   void OnReceiverConnectionAvailable(PresentationInfoPtr info, ::mojo::PendingRemote<PresentationConnection> controller_connection,
//   ::mojo::PendingReceiver<PresentationConnection> receiver_connection_receiver) final;
//
//  private:
//   mojo::MessageReceiverWithResponder* receiver_;
// };
...
public:
    ...
    template <typename... Args> static PresentationErrorPtr New(Args&&... args) { return PresentationErrorPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static PresentationErrorPtr From(const U& u) { return mojo::TypeConverter<PresentationErrorPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, PresentationError>::Convert(*this); }
    PresentationError()
        : error_type()
        , message()
    {
    ...
    template <typename T, PresentationError::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    ...
    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<PresentationError::DataView>(input); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::PresentationError_UnserializedMessageContext<UserType, PresentationError::DataView>>(0, 0, std::move(input)), MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    {
        return PresentationError::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, PresentationError::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, PresentationError::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, PresentationError::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    static PresentationConnectionMessagePtr NewMessage(const WTF::String& message)
    {
    ...
    static PresentationConnectionMessagePtr NewData(WTF::Vector<uint8_t> data)
    {
        auto result = PresentationConnectionMessagePtr(absl::in_place);
    ...
    template <typename U> static PresentationConnectionMessagePtr From(const U& u) { return mojo::TypeConverter<PresentationConnectionMessagePtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, PresentationConnectionMessage>::Convert(*this); }

    PresentationConnectionMessage();
    ~PresentationConnectionMessage() = default;
...
public:
    ...
    template <typename... Args> static PresentationInfoPtr New(Args&&... args) { return PresentationInfoPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static PresentationInfoPtr From(const U& u) { return mojo::TypeConverter<PresentationInfoPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, PresentationInfo>::Convert(*this); }
    PresentationInfo()
        : url()
        , id()
    {
    ...
    template <typename T, PresentationInfo::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static WTF::Vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<PresentationInfo::DataView, WTF::Vector<uint8_t>>(input);
    }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<PresentationInfo::DataView>(input); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::PresentationInfo_UnserializedMessageContext<UserType, PresentationInfo::DataView>>(0, 0, std::move(input)), MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const WTF::Vector<uint8_t>& input, UserType* output)
    {
        return PresentationInfo::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, PresentationInfo::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, PresentationInfo::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, PresentationInfo::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static PresentationConnectionResultPtr New(Args&&... args) { return PresentationConnectionResultPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static PresentationConnectionResultPtr From(const U& u) { return mojo::TypeConverter<PresentationConnectionResultPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, PresentationConnectionResult>::Convert(*this); }
    ...
    PresentationConnectionResult(PresentationInfoPtr presentation_info_in, ::mojo::PendingRemote<PresentationConnection> connection_remote_in,
    ...
    template <typename T, PresentationConnectionResult::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::PresentationConnectionResult_UnserializedMessageContext<UserType, PresentationConnectionResult::DataView>>(0, 0, std::move(input)),
    ...
    template <typename UserType> static bool Deserialize(const WTF::Vector<uint8_t>& input, UserType* output)
    {
        return PresentationConnectionResult::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }

    template <typename UserType> static bool DeserializeFromMessage(mojo::Message input, UserType* output)
    {
        auto context = input.TakeUnserializedContext<internal::PresentationConnectionResult_UnserializedMessageContext<UserType, PresentationConnectionResult::DataView>>();
        if (context) {
            *output = std::move(context->TakeData());
            return true;
        }
...
template <typename T, PresentationConnectionResult::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, PresentationConnectionResult::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, PresentationConnectionResult::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
template <typename T, typename std::enable_if<std::is_same<T, PresentationConnectionMessage>::value>::type*> bool PresentationConnectionMessage::Equals(const T& other) const
{
    if (tag_ != other.which())
        return false;
...
template <typename StructPtrType> PresentationInfoPtr PresentationInfo::Clone() const { return New(mojo::Clone(url), mojo::Clone(id)); }
...
template <typename StructPtrType> PresentationErrorPtr PresentationError::Clone() const { return New(mojo::Clone(error_type), mojo::Clone(message)); }
...
template <> struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::PresentationInfo::DataView, ::blink::mojom::blink::PresentationInfoPtr> {
    ...
    static const decltype(::blink::mojom::blink::PresentationInfo::url)& url(const ::blink::mojom::blink::PresentationInfoPtr& input) { return input->url; }

    static const decltype(::blink::mojom::blink::PresentationInfo::id)& id(const ::blink::mojom::blink::PresentationInfoPtr& input) { return input->id; }
...
template <> struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::PresentationError::DataView, ::blink::mojom::blink::PresentationErrorPtr> {
    ...
    static decltype(::blink::mojom::blink::PresentationError::error_type) error_type(const ::blink::mojom::blink::PresentationErrorPtr& input) { return input->error_type; }

    static const decltype(::blink::mojom::blink::PresentationError::message)& message(const ::blink::mojom::blink::PresentationErrorPtr& input) { return input->message; }

    static bool Read(::blink::mojom::blink::PresentationError::DataView input, ::blink::mojom::blink::PresentationErrorPtr* output);
};
template <> struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::PresentationConnectionResult::DataView, ::blink::mojom::blink::PresentationConnectionResultPtr> {
    ...
    static decltype(::blink::mojom::blink::PresentationConnectionResult::connection_remote)& connection_remote(::blink::mojom::blink::PresentationConnectionResultPtr& input)
    {
        return input->connection_remote;
    }

    static decltype(::blink::mojom::blink::PresentationConnectionResult::connection_receiver)& connection_receiver(::blink::mojom::blink::PresentationConnectionResultPtr& input)
    {
...
template <> struct PLATFORM_EXPORT UnionTraits<::blink::mojom::blink::PresentationConnectionMessage::DataView, ::blink::mojom::blink::PresentationConnectionMessagePtr> {
    ...
    static ::blink::mojom::blink::PresentationConnectionMessage::Tag GetTag(const ::blink::mojom::blink::PresentationConnectionMessagePtr& input) { return input->which(); }

    static const WTF::String& message(const ::blink::mojom::blink::PresentationConnectionMessagePtr& input) { return input->get_message(); }

    static const WTF::Vector<uint8_t>& data(const ::blink::mojom::blink::PresentationConnectionMessagePtr& input) { return input->get_data(); }
