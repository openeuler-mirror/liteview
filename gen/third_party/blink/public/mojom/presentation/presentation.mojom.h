...
public:
    ...
    static PresentationConnectionMessagePtr NewMessage(const std::string& message)
    {
    ...
    static PresentationConnectionMessagePtr NewData(std::vector<uint8_t> data)
    {
        auto result = PresentationConnectionMessagePtr(absl::in_place);
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::PresentationInfo::DataView, ::blink::mojom::PresentationInfoPtr> {
    ...
    static const decltype(::blink::mojom::PresentationInfo::url)& url(const ::blink::mojom::PresentationInfoPtr& input) { return input->url; }

    static const decltype(::blink::mojom::PresentationInfo::id)& id(const ::blink::mojom::PresentationInfoPtr& input) { return input->id; }
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::PresentationError::DataView, ::blink::mojom::PresentationErrorPtr> {
    ...
    static decltype(::blink::mojom::PresentationError::error_type) error_type(const ::blink::mojom::PresentationErrorPtr& input) { return input->error_type; }

    static const decltype(::blink::mojom::PresentationError::message)& message(const ::blink::mojom::PresentationErrorPtr& input) { return input->message; }
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::PresentationConnectionResult::DataView, ::blink::mojom::PresentationConnectionResultPtr> {
    ...
    static const decltype(::blink::mojom::PresentationConnectionResult::presentation_info)& presentation_info(const ::blink::mojom::PresentationConnectionResultPtr& input)
    {
    ...
    static decltype(::blink::mojom::PresentationConnectionResult::connection_receiver)& connection_receiver(::blink::mojom::PresentationConnectionResultPtr& input)
    {
...
template <> struct BLINK_COMMON_EXPORT UnionTraits<::blink::mojom::PresentationConnectionMessage::DataView, ::blink::mojom::PresentationConnectionMessagePtr> {
    ...
    static ::blink::mojom::PresentationConnectionMessage::Tag GetTag(const ::blink::mojom::PresentationConnectionMessagePtr& input) { return input->which(); }

    static const std::string& message(const ::blink::mojom::PresentationConnectionMessagePtr& input) { return input->get_message(); }

    static const std::vector<uint8_t>& data(const ::blink::mojom::PresentationConnectionMessagePtr& input) { return input->get_data(); }
