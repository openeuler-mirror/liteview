...
HandwritingPoint::HandwritingPoint(const ::gfx::PointF& location_in, absl::optional<::base::TimeDelta> t_in)
...
bool HandwritingPoint::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
bool HandwritingStroke::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
bool HandwritingDrawingSegment::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
bool HandwritingSegment::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
bool HandwritingPrediction::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
HandwritingHints::HandwritingHints(const WTF::String& recognition_type_in, const WTF::String& input_type_in, const WTF::String& text_context_in, uint32_t alternatives_in)
...
bool HandwritingHints::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
bool HandwritingHintsQueryResult::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
QueryHandwritingRecognizerResult::QueryHandwritingRecognizerResult(bool text_alternatives_in, bool text_segmentation_in, HandwritingHintsQueryResultPtr hints_in)
...
bool QueryHandwritingRecognizerResult::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
bool HandwritingModelConstraint::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
void HandwritingRecognizerProxy::GetPrediction(WTF::Vector<HandwritingStrokePtr> in_strokes, HandwritingHintsPtr in_hints, GetPredictionCallback callback)
{
    ...
    mojo::Message message(internal::kHandwritingRecognizer_GetPrediction_Name, kFlags, 0, 0, nullptr);
    ...
    const mojo::internal::ContainerValidateParams strokes_validate_params(0, false, nullptr);
...
public:
    ...
    {
        std::unique_ptr<HandwritingRecognizer_GetPrediction_ProxyToResponder> proxy(new HandwritingRecognizer_GetPrediction_ProxyToResponder(message, std::move(responder)));
...
private:
    ...
    void Run(absl::optional<WTF::Vector<HandwritingPredictionPtr>> in_prediction);
};
...
bool HandwritingRecognizer_GetPrediction_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    bool success = true;
    absl::optional<WTF::Vector<HandwritingPredictionPtr>> p_prediction = mojo::DefaultConstructTraits::CreateInstance<absl::optional<WTF::Vector<HandwritingPredictionPtr>>>();
...
void HandwritingRecognizer_GetPrediction_ProxyToResponder::Run(absl::optional<WTF::Vector<HandwritingPredictionPtr>> in_prediction)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send reply handwriting::mojom::HandwritingRecognizer::GetPrediction", "async_response_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("prediction"), in_prediction, "<value of type absl::optional<WTF::Vector<HandwritingPredictionPtr>>>");
    });
#endif
    ...
    const mojo::internal::ContainerValidateParams prediction_validate_params(0, false, nullptr);
    mojo::internal::Serialize<mojo::ArrayDataView<::handwriting::mojom::HandwritingPredictionDataView>>(in_prediction, prediction_fragment, &prediction_validate_params);
...
// static
bool HandwritingRecognizerStubDispatch::AcceptWithResponder(HandwritingRecognizer* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
{
    ...
    case internal::kHandwritingRecognizer_GetPrediction_Name: {
        ...
        bool success = true;
        WTF::Vector<HandwritingStrokePtr> p_strokes = mojo::DefaultConstructTraits::CreateInstance<WTF::Vector<HandwritingStrokePtr>>();
        ...
        HandwritingRecognizer::GetPredictionCallback callback = HandwritingRecognizer_GetPrediction_ProxyToResponder::CreateCallback(*message, std::move(responder));
...
public:
    ...
    HandwritingRecognitionService_CreateHandwritingRecognizer_ForwardToCallback& operator=(const HandwritingRecognitionService_CreateHandwritingRecognizer_ForwardToCallback&)
        = delete;
...
public:
    ...
    HandwritingRecognitionService_QueryHandwritingRecognizer_ForwardToCallback& operator=(const HandwritingRecognitionService_QueryHandwritingRecognizer_ForwardToCallback&)
        = delete;
...
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send handwriting::mojom::HandwritingRecognitionService::CreateHandwritingRecognizer", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
    ...
    mojo::Message message(internal::kHandwritingRecognitionService_CreateHandwritingRecognizer_Name, kFlags, 0, 0, nullptr);
...
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send handwriting::mojom::HandwritingRecognitionService::QueryHandwritingRecognizer", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("constraint"), in_constraint, "<value of type HandwritingModelConstraintPtr>");
    });
#endif
    ...
    mojo::Message message(internal::kHandwritingRecognitionService_QueryHandwritingRecognizer_Name, kFlags, 0, 0, nullptr);
...
public:
    static HandwritingRecognitionService::CreateHandwritingRecognizerCallback CreateCallback(::mojo::Message& message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
    {
...
private:
    HandwritingRecognitionService_CreateHandwritingRecognizer_ProxyToResponder(::mojo::Message& message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
        : ::mojo::internal::ProxyToResponder(message, std::move(responder))
    {
    }
...
bool HandwritingRecognitionService_CreateHandwritingRecognizer_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    bool success = true;
    CreateHandwritingRecognizerResult p_result = mojo::DefaultConstructTraits::CreateInstance<CreateHandwritingRecognizerResult>();
    ::mojo::PendingRemote<HandwritingRecognizer> p_handwriting_recognizer = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingRemote<HandwritingRecognizer>>();
    ...
    CreateHandwritingRecognizerResult in_result, ::mojo::PendingRemote<HandwritingRecognizer> in_handwriting_recognizer)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1(
        "mojom", "Send reply handwriting::mojom::HandwritingRecognitionService::CreateHandwritingRecognizer", "async_response_parameters", [&](perfetto::TracedValue context) {
            auto dict = std::move(context).WriteDictionary();
    ...
    mojo::Message message(internal::kHandwritingRecognitionService_CreateHandwritingRecognizer_Name, kFlags, 0, 0, nullptr);
    mojo::internal::MessageFragment<::handwriting::mojom::internal::HandwritingRecognitionService_CreateHandwritingRecognizer_ResponseParams_Data> params(message);
    params.Allocate();
...
public:
    static HandwritingRecognitionService::QueryHandwritingRecognizerCallback CreateCallback(::mojo::Message& message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
    {
...
private:
    HandwritingRecognitionService_QueryHandwritingRecognizer_ProxyToResponder(::mojo::Message& message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
        : ::mojo::internal::ProxyToResponder(message, std::move(responder))
    {
    }
...
bool HandwritingRecognitionService_QueryHandwritingRecognizer_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    bool success = true;
    QueryHandwritingRecognizerResultPtr p_result = mojo::DefaultConstructTraits::CreateInstance<QueryHandwritingRecognizerResultPtr>();
...
void HandwritingRecognitionService_QueryHandwritingRecognizer_ProxyToResponder::Run(QueryHandwritingRecognizerResultPtr in_result)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1(
        "mojom", "Send reply handwriting::mojom::HandwritingRecognitionService::QueryHandwritingRecognizer", "async_response_parameters", [&](perfetto::TracedValue context) {
            auto dict = std::move(context).WriteDictionary();
    ...
    mojo::Message message(internal::kHandwritingRecognitionService_QueryHandwritingRecognizer_Name, kFlags, 0, 0, nullptr);
    mojo::internal::MessageFragment<::handwriting::mojom::internal::HandwritingRecognitionService_QueryHandwritingRecognizer_ResponseParams_Data> params(message);
    params.Allocate();
    ...
    HandwritingRecognitionService* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
{
    ...
    case internal::kHandwritingRecognitionService_CreateHandwritingRecognizer_Name: {
        ...
        bool success = true;
        HandwritingModelConstraintPtr p_constraint = mojo::DefaultConstructTraits::CreateInstance<HandwritingModelConstraintPtr>();
...
bool StructTraits<::handwriting::mojom::blink::QueryHandwritingRecognizerResult::DataView, ::handwriting::mojom::blink::QueryHandwritingRecognizerResultPtr>::Read(
    ::handwriting::mojom::blink::QueryHandwritingRecognizerResult::DataView input, ::handwriting::mojom::blink::QueryHandwritingRecognizerResultPtr* output)
{
    bool success = true;
    ...
    WTF::Vector<HandwritingStrokePtr> strokes, HandwritingHintsPtr hints, absl::optional<WTF::Vector<HandwritingPredictionPtr>>* out_prediction)
{
    ...
    proxy_->GetPrediction(std::move(strokes), std::move(hints),
        base::BindOnce(
            [](base::RunLoop* loop, absl::optional<WTF::Vector<HandwritingPredictionPtr>>* out_prediction, absl::optional<WTF::Vector<HandwritingPredictionPtr>> prediction) {
...
absl::optional<WTF::Vector<HandwritingPredictionPtr>> HandwritingRecognizerAsyncWaiter::GetPrediction(WTF::Vector<HandwritingStrokePtr> strokes, HandwritingHintsPtr hints)
{
    absl::optional<WTF::Vector<HandwritingPredictionPtr>> async_wait_result = mojo::DefaultConstructTraits::CreateInstance<absl::optional<WTF::Vector<HandwritingPredictionPtr>>>();
...
void HandwritingRecognitionServiceAsyncWaiter::QueryHandwritingRecognizer(HandwritingModelConstraintPtr constraint, QueryHandwritingRecognizerResultPtr* out_result)
{
    base::RunLoop loop;
...
{
    QueryHandwritingRecognizerResultPtr async_wait_result = mojo::DefaultConstructTraits::CreateInstance<QueryHandwritingRecognizerResultPtr>();
