...
static_assert(
    sizeof(HandwritingRecognitionService_CreateHandwritingRecognizer_Params_Data) == 16, "Bad sizeof(HandwritingRecognitionService_CreateHandwritingRecognizer_Params_Data)");
...
static_assert(
    sizeof(HandwritingRecognitionService_QueryHandwritingRecognizer_Params_Data) == 16, "Bad sizeof(HandwritingRecognitionService_QueryHandwritingRecognizer_Params_Data)");
...
public:
    ...
    template <typename UserType> UserType TakeHandwritingRecognizer()
    {
        UserType result;
        bool ret
            = mojo::internal::Deserialize<mojo::InterfacePtrDataView<::handwriting::mojom::HandwritingRecognizerInterfaceBase>>(&data_->handwriting_recognizer, &result, message_);
        DCHECK(ret);
        return result;
    }
