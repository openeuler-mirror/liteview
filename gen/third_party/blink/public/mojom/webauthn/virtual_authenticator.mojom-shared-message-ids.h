// third_party/blink/public/mojom/webauthn/virtual_authenticator.mojom-shared-message-ids.h is auto generated by mojom_bindings_generator.py, do not edit
...
constexpr uint32_t kVirtualAuthenticator_RemoveRegistration_Name = 3;
constexpr uint32_t kVirtualAuthenticator_ClearRegistrations_Name = 4;
constexpr uint32_t kVirtualAuthenticator_GetLargeBlob_Name = 5;
constexpr uint32_t kVirtualAuthenticator_SetLargeBlob_Name = 6;
constexpr uint32_t kVirtualAuthenticator_SetUserVerified_Name = 7;
