...
DevicePublicKeyResponse::DevicePublicKeyResponse(WTF::Vector<uint8_t> authenticator_output_in, WTF::Vector<uint8_t> signature_in)
...
MakeCredentialAuthenticatorResponse::MakeCredentialAuthenticatorResponse(CommonCredentialInfoPtr info_in, AuthenticatorAttachment authenticator_attachment_in,
    WTF::Vector<uint8_t> attestation_object_in, WTF::Vector<AuthenticatorTransport> transports_in, bool echo_hmac_create_secret_in, bool hmac_create_secret_in, bool echo_prf_in,
    bool prf_in, bool echo_cred_blob_in, bool cred_blob_in, absl::optional<WTF::Vector<uint8_t>> public_key_der_in, int32_t public_key_algo_in, bool echo_cred_props_in,
...
GetAssertionAuthenticatorResponse::GetAssertionAuthenticatorResponse(CommonCredentialInfoPtr info_in, AuthenticatorAttachment authenticator_attachment_in,
    WTF::Vector<uint8_t> signature_in, absl::optional<WTF::Vector<uint8_t>> user_handle_in, bool echo_appid_extension_in, bool appid_extension_in, bool echo_prf_in,
    PRFValuesPtr prf_results_in, bool prf_not_evaluated_in, bool echo_large_blob_in, absl::optional<WTF::Vector<uint8_t>> large_blob_in, bool echo_large_blob_written_in,
    bool large_blob_written_in, absl::optional<WTF::Vector<uint8_t>> get_cred_blob_in, DevicePublicKeyResponsePtr device_public_key_in)
    : info(std::move(info_in))
    , authenticator_attachment(std::move(authenticator_attachment_in))
    , signature(std::move(signature_in))
...
CableAuthentication::CableAuthentication(uint8_t version_in, absl::optional<WTF::Vector<uint8_t>> client_eid_in, absl::optional<WTF::Vector<uint8_t>> authenticator_eid_in,
...
CableRegistration::CableRegistration(WTF::Vector<uint8_t> versions_in, WTF::Vector<uint8_t> relying_party_public_key_in)
...
PRFValues::PRFValues(absl::optional<WTF::Vector<uint8_t>> id_in, WTF::Vector<uint8_t> first_in, absl::optional<WTF::Vector<uint8_t>> second_in)
    : id(std::move(id_in))
...
PaymentOptions::PaymentOptions(::payments::mojom::blink::PaymentCurrencyAmountPtr total_in, PaymentCredentialInstrumentPtr instrument_in, const WTF::String& payee_name_in,
...
DevicePublicKeyRequest::DevicePublicKeyRequest(AttestationConveyancePreference attestation_in, WTF::Vector<WTF::String> attestation_formats_in)
...
PublicKeyCredentialRequestOptions::PublicKeyCredentialRequestOptions(bool is_conditional_in, WTF::Vector<uint8_t> challenge_in, absl::optional<::base::TimeDelta> timeout_in,
    ...
    const WTF::String& appid_in, WTF::Vector<CableAuthenticationPtr> cable_authentication_data_in, bool prf_in, WTF::Vector<PRFValuesPtr> prf_inputs_in, bool large_blob_read_in,
    absl::optional<WTF::Vector<uint8_t>> large_blob_write_in, bool get_cred_blob_in, RemoteDesktopClientOverridePtr remote_desktop_client_override_in,
...
PublicKeyCredentialCreationOptions::PublicKeyCredentialCreationOptions(PublicKeyCredentialRpEntityPtr relying_party_in, PublicKeyCredentialUserEntityPtr user_in,
    WTF::Vector<uint8_t> challenge_in, WTF::Vector<PublicKeyCredentialParametersPtr> public_key_parameters_in, absl::optional<::base::TimeDelta> timeout_in,
...
PublicKeyCredentialDescriptor::PublicKeyCredentialDescriptor(PublicKeyCredentialType type_in, WTF::Vector<uint8_t> id_in, WTF::Vector<AuthenticatorTransport> transports_in)
    : type(std::move(type_in))
    , id(std::move(id_in))
    , transports(std::move(transports_in))
{
...
bool StructTraits<::blink::mojom::blink::DevicePublicKeyResponse::DataView, ::blink::mojom::blink::DevicePublicKeyResponsePtr>::Read(
    ::blink::mojom::blink::DevicePublicKeyResponse::DataView input, ::blink::mojom::blink::DevicePublicKeyResponsePtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::blink::CableRegistration::DataView, ::blink::mojom::blink::CableRegistrationPtr>::Read(
    ::blink::mojom::blink::CableRegistration::DataView input, ::blink::mojom::blink::CableRegistrationPtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::blink::DevicePublicKeyRequest::DataView, ::blink::mojom::blink::DevicePublicKeyRequestPtr>::Read(
    ::blink::mojom::blink::DevicePublicKeyRequest::DataView input, ::blink::mojom::blink::DevicePublicKeyRequestPtr* output)
{
    bool success = true;
