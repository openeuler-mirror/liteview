...
bool CommonCredentialInfo::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
DevicePublicKeyResponse::DevicePublicKeyResponse(std::vector<uint8_t> authenticator_output_in, std::vector<uint8_t> signature_in)
...
void DevicePublicKeyResponse::WriteIntoTrace(perfetto::TracedValue traced_context) const
{
    [[maybe_unused]] auto dict = std::move(traced_context).WriteDictionary();
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("authenticator_output"), this->authenticator_output,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
        "<value of type const std::vector<uint8_t>&>"
#else
        "<value>"
...
bool DevicePublicKeyResponse::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
MakeCredentialAuthenticatorResponse::MakeCredentialAuthenticatorResponse(CommonCredentialInfoPtr info_in, ::device::AuthenticatorAttachment authenticator_attachment_in,
    std::vector<uint8_t> attestation_object_in, std::vector<::device::FidoTransportProtocol> transports_in, bool echo_hmac_create_secret_in, bool hmac_create_secret_in,
    bool echo_prf_in, bool prf_in, bool echo_cred_blob_in, bool cred_blob_in, absl::optional<std::vector<uint8_t>> public_key_der_in, int32_t public_key_algo_in,
...
void MakeCredentialAuthenticatorResponse::WriteIntoTrace(perfetto::TracedValue traced_context) const
{
    ...
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("device_public_key"), this->device_public_key,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
bool MakeCredentialAuthenticatorResponse::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
GetAssertionAuthenticatorResponse::GetAssertionAuthenticatorResponse(CommonCredentialInfoPtr info_in, ::device::AuthenticatorAttachment authenticator_attachment_in,
    std::vector<uint8_t> signature_in, absl::optional<std::vector<uint8_t>> user_handle_in, bool echo_appid_extension_in, bool appid_extension_in, bool echo_prf_in,
    PRFValuesPtr prf_results_in, bool prf_not_evaluated_in, bool echo_large_blob_in, absl::optional<std::vector<uint8_t>> large_blob_in, bool echo_large_blob_written_in,
    bool large_blob_written_in, absl::optional<std::vector<uint8_t>> get_cred_blob_in, DevicePublicKeyResponsePtr device_public_key_in)
    : info(std::move(info_in))
    , authenticator_attachment(std::move(authenticator_attachment_in))
    , signature(std::move(signature_in))
...
bool GetAssertionAuthenticatorResponse::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
bool PublicKeyCredentialRpEntity::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
bool PublicKeyCredentialUserEntity::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
bool PublicKeyCredentialParameters::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
CableAuthentication::CableAuthentication(uint8_t version_in, absl::optional<std::vector<uint8_t>> client_eid_in, absl::optional<std::vector<uint8_t>> authenticator_eid_in,
...
bool CableAuthentication::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
CableRegistration::CableRegistration(std::vector<uint8_t> versions_in, std::vector<uint8_t> relying_party_public_key_in)
...
void CableRegistration::WriteIntoTrace(perfetto::TracedValue traced_context) const
{
    [[maybe_unused]] auto dict = std::move(traced_context).WriteDictionary();
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("versions"), this->versions,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
        "<value of type const std::vector<uint8_t>&>"
#else
        "<value>"
    ...
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("relying_party_public_key"), this->relying_party_public_key,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
        "<value of type const std::vector<uint8_t>&>"
#else
        "<value>"
...
bool CableRegistration::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
PRFValues::PRFValues()
    : id()
    , first()
    , second()
...
PRFValues::PRFValues(absl::optional<std::vector<uint8_t>> id_in, std::vector<uint8_t> first_in, absl::optional<std::vector<uint8_t>> second_in)
    : id(std::move(id_in))
...
bool PRFValues::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
PaymentOptions::PaymentOptions(::payments::mojom::PaymentCurrencyAmountPtr total_in, PaymentCredentialInstrumentPtr instrument_in, const absl::optional<std::string>& payee_name_in,
...
bool PaymentCredentialInstrument::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
bool RemoteDesktopClientOverride::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
DevicePublicKeyRequest::DevicePublicKeyRequest(::device::AttestationConveyancePreference attestation_in, std::vector<std::string> attestation_formats_in)
...
void DevicePublicKeyRequest::WriteIntoTrace(perfetto::TracedValue traced_context) const
{
    [[maybe_unused]] auto dict = std::move(traced_context).WriteDictionary();
...
bool DevicePublicKeyRequest::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
PublicKeyCredentialRequestOptions::PublicKeyCredentialRequestOptions(bool is_conditional_in, std::vector<uint8_t> challenge_in, absl::optional<::base::TimeDelta> timeout_in,
    const std::string& relying_party_id_in, std::vector<::device::PublicKeyCredentialDescriptor> allow_credentials_in, ::device::UserVerificationRequirement user_verification_in,
    const absl::optional<std::string>& appid_in, std::vector<::device::CableDiscoveryData> cable_authentication_data_in, bool prf_in, std::vector<PRFValuesPtr> prf_inputs_in,
    bool large_blob_read_in, absl::optional<std::vector<uint8_t>> large_blob_write_in, bool get_cred_blob_in, RemoteDesktopClientOverridePtr remote_desktop_client_override_in,
...
bool PublicKeyCredentialRequestOptions::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
bool AuthenticatorSelectionCriteria::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
PublicKeyCredentialCreationOptions::PublicKeyCredentialCreationOptions(const ::device::PublicKeyCredentialRpEntity& relying_party_in,
    ...
    std::vector<::device::PublicKeyCredentialParams::CredentialInfo> public_key_parameters_in, absl::optional<::base::TimeDelta> timeout_in,
...
void PublicKeyCredentialCreationOptions::WriteIntoTrace(perfetto::TracedValue traced_context) const
{
    ...
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("cable_registration_data"), this->cable_registration_data,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    ...
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("google_legacy_app_id_support"), this->google_legacy_app_id_support,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
        "<value of type bool>"
#else
        "<value>"
...
bool PublicKeyCredentialCreationOptions::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
bool PublicKeyCredentialDescriptor::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
bool WebAuthnDOMExceptionDetails::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
public:
    ...
    Authenticator_IsUserVerifyingPlatformAuthenticatorAvailable_ForwardToCallback& operator=(const Authenticator_IsUserVerifyingPlatformAuthenticatorAvailable_ForwardToCallback&)
        = delete;
...
void AuthenticatorProxy::MakeCredential(PublicKeyCredentialCreationOptionsPtr in_options, MakeCredentialCallback callback)
{
    ...
    mojo::Message message(internal::kAuthenticator_MakeCredential_Name, kFlags, 0, 0, nullptr);
...
void AuthenticatorProxy::GetAssertion(PublicKeyCredentialRequestOptionsPtr in_options, GetAssertionCallback callback)
{
    ...
    mojo::Message message(internal::kAuthenticator_GetAssertion_Name, kFlags, 0, 0, nullptr);
...
void AuthenticatorProxy::IsUserVerifyingPlatformAuthenticatorAvailable(IsUserVerifyingPlatformAuthenticatorAvailableCallback callback)
{
    ...
    mojo::Message message(internal::kAuthenticator_IsUserVerifyingPlatformAuthenticatorAvailable_Name, kFlags, 0, 0, nullptr);
...
void AuthenticatorProxy::IsConditionalMediationAvailable(IsConditionalMediationAvailableCallback callback)
{
    ...
    mojo::Message message(internal::kAuthenticator_IsConditionalMediationAvailable_Name, kFlags, 0, 0, nullptr);
...
void AuthenticatorProxy::Cancel()
{
    ...
    mojo::Message message(internal::kAuthenticator_Cancel_Name, kFlags, 0, 0, nullptr);
...
bool Authenticator_MakeCredential_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    internal::Authenticator_MakeCredential_ResponseParams_Data* params = reinterpret_cast<internal::Authenticator_MakeCredential_ResponseParams_Data*>(message->mutable_payload());

    bool success = true;
    AuthenticatorStatus p_status = mojo::DefaultConstructTraits::CreateInstance<AuthenticatorStatus>();
    MakeCredentialAuthenticatorResponsePtr p_credential = mojo::DefaultConstructTraits::CreateInstance<MakeCredentialAuthenticatorResponsePtr>();
    WebAuthnDOMExceptionDetailsPtr p_dom_exception_details = mojo::DefaultConstructTraits::CreateInstance<WebAuthnDOMExceptionDetailsPtr>();
    ...
    AuthenticatorStatus in_status, MakeCredentialAuthenticatorResponsePtr in_credential, WebAuthnDOMExceptionDetailsPtr in_dom_exception_details)
{
    ...
    TRACE_EVENT1("mojom", "Send reply blink::mojom::Authenticator::MakeCredential", "async_response_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("dom_exception_details"), in_dom_exception_details, "<value of type WebAuthnDOMExceptionDetailsPtr>");
    });
#endif
...
bool Authenticator_GetAssertion_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    DCHECK(message->is_serialized());
    internal::Authenticator_GetAssertion_ResponseParams_Data* params = reinterpret_cast<internal::Authenticator_GetAssertion_ResponseParams_Data*>(message->mutable_payload());

    bool success = true;
    AuthenticatorStatus p_status = mojo::DefaultConstructTraits::CreateInstance<AuthenticatorStatus>();
    GetAssertionAuthenticatorResponsePtr p_credential = mojo::DefaultConstructTraits::CreateInstance<GetAssertionAuthenticatorResponsePtr>();
    WebAuthnDOMExceptionDetailsPtr p_dom_exception_details = mojo::DefaultConstructTraits::CreateInstance<WebAuthnDOMExceptionDetailsPtr>();
...
public:
    static Authenticator::IsUserVerifyingPlatformAuthenticatorAvailableCallback CreateCallback(::mojo::Message& message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
    {
...
private:
    Authenticator_IsUserVerifyingPlatformAuthenticatorAvailable_ProxyToResponder(::mojo::Message& message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
        : ::mojo::internal::ProxyToResponder(message, std::move(responder))
    {
    }
...
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send reply blink::mojom::Authenticator::IsUserVerifyingPlatformAuthenticatorAvailable", "async_response_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
...
public:
    static Authenticator::IsConditionalMediationAvailableCallback CreateCallback(::mojo::Message& message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
    {
...
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send reply blink::mojom::Authenticator::IsConditionalMediationAvailable", "async_response_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("available"), in_available, "<value of type bool>");
    });
#endif
...
bool AuthenticatorStubDispatch::AcceptWithResponder(Authenticator* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
{
    ...
    case internal::kAuthenticator_MakeCredential_Name: {
        ...
        internal::Authenticator_MakeCredential_Params_Data* params = reinterpret_cast<internal::Authenticator_MakeCredential_Params_Data*>(message->mutable_payload());

        bool success = true;
        PublicKeyCredentialCreationOptionsPtr p_options = mojo::DefaultConstructTraits::CreateInstance<PublicKeyCredentialCreationOptionsPtr>();
    ...
    case internal::kAuthenticator_GetAssertion_Name: {
        ...
        internal::Authenticator_GetAssertion_Params_Data* params = reinterpret_cast<internal::Authenticator_GetAssertion_Params_Data*>(message->mutable_payload());

        bool success = true;
        PublicKeyCredentialRequestOptionsPtr p_options = mojo::DefaultConstructTraits::CreateInstance<PublicKeyCredentialRequestOptionsPtr>();
...
static const mojo::internal::GenericValidationInfo kAuthenticatorValidationInfo[] = {
    ...
    { &internal::Authenticator_IsConditionalMediationAvailable_Params_Data::Validate, &internal::Authenticator_IsConditionalMediationAvailable_ResponseParams_Data::Validate },
...
bool StructTraits<::blink::mojom::DevicePublicKeyResponse::DataView, ::blink::mojom::DevicePublicKeyResponsePtr>::Read(
    ::blink::mojom::DevicePublicKeyResponse::DataView input, ::blink::mojom::DevicePublicKeyResponsePtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::CableRegistration::DataView, ::blink::mojom::CableRegistrationPtr>::Read(
    ::blink::mojom::CableRegistration::DataView input, ::blink::mojom::CableRegistrationPtr* output)
{
    bool success = true;
...
// static
bool StructTraits<::blink::mojom::PRFValues::DataView, ::blink::mojom::PRFValuesPtr>::Read(::blink::mojom::PRFValues::DataView input, ::blink::mojom::PRFValuesPtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::DevicePublicKeyRequest::DataView, ::blink::mojom::DevicePublicKeyRequestPtr>::Read(
    ::blink::mojom::DevicePublicKeyRequest::DataView input, ::blink::mojom::DevicePublicKeyRequestPtr* output)
{
    bool success = true;
...
void AuthenticatorInterceptorForTesting::Cancel() { GetForwardingInterface()->Cancel(); }
...
void AuthenticatorAsyncWaiter::GetAssertion(PublicKeyCredentialRequestOptionsPtr options, AuthenticatorStatus* out_status, GetAssertionAuthenticatorResponsePtr* out_credential,
