...
(function() {
  ...
  AuthenticatorStatus.ERROR_WITH_DOM_EXCEPTION_DETAILS = 22;
  AuthenticatorStatus.UNKNOWN_ERROR = 23;
  AuthenticatorStatus.MIN_VALUE = 0;
  AuthenticatorStatus.MAX_VALUE = 23;
  ...
  GetAssertionAuthenticatorResponse.validate = function(messageValidator, offset) {
    ...
    // validate GetAssertionAuthenticatorResponse.devicePublicKey
  ...
  GetAssertionAuthenticatorResponse.encodedSize = codec.kStructHeaderSize + 64;
  ...
  PublicKeyCredentialRequestOptions.validate = function(messageValidator, offset) {
    ...
    // validate PublicKeyCredentialRequestOptions.remoteDesktopClientOverride
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 72, RemoteDesktopClientOverride, true);
    if (err !== validator.validationError.NONE)
        return err;


    // validate PublicKeyCredentialRequestOptions.devicePublicKey
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 80, DevicePublicKeyRequest, true);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  PublicKeyCredentialRequestOptions.encodedSize = codec.kStructHeaderSize + 88;
  ...
  PublicKeyCredentialCreationOptions.decode = function(decoder) {
    ...
    val.minPinLengthRequested = (packed >> 6) & 1 ? true : false;
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  PublicKeyCredentialCreationOptions.encode = function(encoder, val) {
    ...
    packed |= (val.minPinLengthRequested & 1) << 6
    encoder.writeUint8(packed);
    encoder.skip(1);
    encoder.skip(1);
    encoder.skip(1);
