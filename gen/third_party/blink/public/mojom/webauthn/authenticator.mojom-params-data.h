...
static_assert(
    sizeof(Authenticator_IsUserVerifyingPlatformAuthenticatorAvailable_Params_Data) == 8, "Bad sizeof(Authenticator_IsUserVerifyingPlatformAuthenticatorAvailable_Params_Data)");
...
static_assert(sizeof(Authenticator_IsConditionalMediationAvailable_ResponseParams_Data) == 16, "Bad sizeof(Authenticator_IsConditionalMediationAvailable_ResponseParams_Data)");
...
public:
    ...
    AuthenticatorStatus status() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::blink::mojom::AuthenticatorStatus>(data_->status)); }
...
public:
    ...
    Authenticator_IsConditionalMediationAvailable_ParamsDataView(internal::Authenticator_IsConditionalMediationAvailable_Params_Data* data, mojo::Message* message)
        : data_(data)
    {
    }
...
public:
    ...
    Authenticator_IsConditionalMediationAvailable_ResponseParamsDataView(internal::Authenticator_IsConditionalMediationAvailable_ResponseParams_Data* data, mojo::Message* message)
        : data_(data)
    {
    }
