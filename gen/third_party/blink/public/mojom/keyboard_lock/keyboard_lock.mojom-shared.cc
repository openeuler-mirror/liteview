...
std::ostream& operator<<(std::ostream& os, KeyboardLockRequestResult value) { return os << KeyboardLockRequestResultToString(value); }
...
std::ostream& operator<<(std::ostream& os, GetKeyboardLayoutMapStatus value) { return os << GetKeyboardLayoutMapStatusToString(value); }
...
bool KeyboardLockService_RequestKeyboardLock_Params_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    ...
    // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
    // the message comes from an older version.
    [[maybe_unused]] const KeyboardLockService_RequestKeyboardLock_Params_Data* object = static_cast<const KeyboardLockService_RequestKeyboardLock_Params_Data*>(data);
...
bool KeyboardLockService_CancelKeyboardLock_Params_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    ...
    // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
    // the message comes from an older version.
    [[maybe_unused]] const KeyboardLockService_CancelKeyboardLock_Params_Data* object = static_cast<const KeyboardLockService_CancelKeyboardLock_Params_Data*>(data);
...
bool KeyboardLockService_GetKeyboardLayoutMap_Params_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    ...
    // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
    // the message comes from an older version.
    [[maybe_unused]] const KeyboardLockService_GetKeyboardLayoutMap_Params_Data* object = static_cast<const KeyboardLockService_GetKeyboardLayoutMap_Params_Data*>(data);
...
// static
void TraceFormatTraits<::blink::mojom::KeyboardLockRequestResult>::WriteIntoTrace(perfetto::TracedValue context, ::blink::mojom::KeyboardLockRequestResult value)
{
...
// static
void TraceFormatTraits<::blink::mojom::GetKeyboardLayoutMapStatus>::WriteIntoTrace(perfetto::TracedValue context, ::blink::mojom::GetKeyboardLayoutMapStatus value)
{
