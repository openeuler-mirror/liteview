...
static_assert(sizeof(KeyboardLockService_RequestKeyboardLock_ResponseParams_Data) == 16, "Bad sizeof(KeyboardLockService_RequestKeyboardLock_ResponseParams_Data)");
...
static_assert(sizeof(KeyboardLockService_GetKeyboardLayoutMap_ResponseParams_Data) == 16, "Bad sizeof(KeyboardLockService_GetKeyboardLayoutMap_ResponseParams_Data)");
...
public:
    ...
    KeyboardLockService_RequestKeyboardLock_ResponseParamsDataView(internal::KeyboardLockService_RequestKeyboardLock_ResponseParams_Data* data, mojo::Message* message)
        : data_(data)
    {
    }
    ...
    KeyboardLockRequestResult result() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::blink::mojom::KeyboardLockRequestResult>(data_->result)); }
...
public:
    ...
    KeyboardLockService_GetKeyboardLayoutMap_ResponseParamsDataView(internal::KeyboardLockService_GetKeyboardLayoutMap_ResponseParams_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
