...
struct blink_mojom_internal_AdSignals_DataHashFn {
    ...
    static bool Equal(const ::blink::mojom::AdSignals& left, const ::blink::mojom::AdSignals& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::blink::mojom::AdSignals> : public GenericHashTraits<::blink::mojom::AdSignals> {
    ...
    static void ConstructDeletedValue(::blink::mojom::AdSignals& slot, bool) { slot = static_cast<::blink::mojom::AdSignals>(-1000001); }
    static bool IsDeletedValue(const ::blink::mojom::AdSignals& value) { return value == static_cast<::blink::mojom::AdSignals>(-1000001); }
};
} // namespace WTF
namespace blink {
namespace mojom {
...
public:
    ...
    AdProperties(
        const WTF::String& width_in, const WTF::String& height_in, const WTF::String& slot_in, const WTF::String& lang_in, const WTF::String& ad_type_in, double bid_floor_in)
...
public:
    ...
    AdTargeting(absl::optional<WTF::Vector<WTF::String>> interests_in, AdGeolocationPtr geolocation_in)
...
public:
    ...
    AdRequestConfig(const ::blink::KURL& ad_request_url_in, WTF::Vector<AdPropertiesPtr> ad_properties_in, const WTF::String& publisher_code_in, AdTargetingPtr targeting_in,
        absl::optional<WTF::Vector<AdSignals>> anonymized_proxied_signals_in, const absl::optional<::blink::KURL>& fallback_source_in)
...
template <> struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::AdProperties::DataView, ::blink::mojom::blink::AdPropertiesPtr> {
    ...
    static const decltype(::blink::mojom::blink::AdProperties::width)& width(const ::blink::mojom::blink::AdPropertiesPtr& input) { return input->width; }

    static const decltype(::blink::mojom::blink::AdProperties::height)& height(const ::blink::mojom::blink::AdPropertiesPtr& input) { return input->height; }

    static const decltype(::blink::mojom::blink::AdProperties::slot)& slot(const ::blink::mojom::blink::AdPropertiesPtr& input) { return input->slot; }

    static const decltype(::blink::mojom::blink::AdProperties::lang)& lang(const ::blink::mojom::blink::AdPropertiesPtr& input) { return input->lang; }

    static const decltype(::blink::mojom::blink::AdProperties::ad_type)& ad_type(const ::blink::mojom::blink::AdPropertiesPtr& input) { return input->ad_type; }

    static decltype(::blink::mojom::blink::AdProperties::bid_floor) bid_floor(const ::blink::mojom::blink::AdPropertiesPtr& input) { return input->bid_floor; }
...
template <> struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::AdGeolocation::DataView, ::blink::mojom::blink::AdGeolocationPtr> {
    ...
    static decltype(::blink::mojom::blink::AdGeolocation::latitude) latitude(const ::blink::mojom::blink::AdGeolocationPtr& input) { return input->latitude; }

    static decltype(::blink::mojom::blink::AdGeolocation::longitude) longitude(const ::blink::mojom::blink::AdGeolocationPtr& input) { return input->longitude; }
...
template <> struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::AdTargeting::DataView, ::blink::mojom::blink::AdTargetingPtr> {
    ...
    static const decltype(::blink::mojom::blink::AdTargeting::interests)& interests(const ::blink::mojom::blink::AdTargetingPtr& input) { return input->interests; }

    static const decltype(::blink::mojom::blink::AdTargeting::geolocation)& geolocation(const ::blink::mojom::blink::AdTargetingPtr& input) { return input->geolocation; }
...
template <> struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::AdRequestConfig::DataView, ::blink::mojom::blink::AdRequestConfigPtr> {
    ...
    static const decltype(::blink::mojom::blink::AdRequestConfig::targeting)& targeting(const ::blink::mojom::blink::AdRequestConfigPtr& input) { return input->targeting; }

    static const decltype(::blink::mojom::blink::AdRequestConfig::anonymized_proxied_signals)& anonymized_proxied_signals(const ::blink::mojom::blink::AdRequestConfigPtr& input)
    {
