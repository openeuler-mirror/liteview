...
AdTargeting::AdTargeting(absl::optional<WTF::Vector<WTF::String>> interests_in, AdGeolocationPtr geolocation_in)
...
AdRequestConfig::AdRequestConfig(const ::blink::KURL& ad_request_url_in, WTF::Vector<AdPropertiesPtr> ad_properties_in, const WTF::String& publisher_code_in,
    AdTargetingPtr targeting_in, absl::optional<WTF::Vector<AdSignals>> anonymized_proxied_signals_in, const absl::optional<::blink::KURL>& fallback_source_in)
