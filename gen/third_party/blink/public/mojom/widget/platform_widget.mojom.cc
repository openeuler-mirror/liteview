...
#ifndef THIRD_PARTY_BLINK_PUBLIC_MOJOM_WIDGET_PLATFORM_WIDGET_MOJOM_JUMBO_H_
#define THIRD_PARTY_BLINK_PUBLIC_MOJOM_WIDGET_PLATFORM_WIDGET_MOJOM_JUMBO_H_
#endif
...
void WidgetCompositorProxy::VisualStateRequest(VisualStateRequestCallback callback)
{
    ...
    mojo::Message message(internal::kWidgetCompositor_VisualStateRequest_Name, kFlags, 0, 0, nullptr);
...
public:
    ...
    {
        std::unique_ptr<WidgetCompositor_VisualStateRequest_ProxyToResponder> proxy(new WidgetCompositor_VisualStateRequest_ProxyToResponder(message, std::move(responder)));
...
// static
bool WidgetCompositorStubDispatch::AcceptWithResponder(WidgetCompositor* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
{
    ...
    case internal::kWidgetCompositor_VisualStateRequest_Name: {
        ...
        WidgetCompositor::VisualStateRequestCallback callback = WidgetCompositor_VisualStateRequest_ProxyToResponder::CreateCallback(*message, std::move(responder));
...
void WidgetHostProxy::SetCursor(const ::ui::Cursor& in_cursor)
{
    ...
    mojo::Message message(internal::kWidgetHost_SetCursor_Name, kFlags, 0, 0, nullptr);
    ...
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(params->cursor.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null cursor in WidgetHost.SetCursor request");
...
void WidgetHostProxy::UpdateTooltipUnderCursor(const ::std::u16string& in_tooltip_text, ::base::i18n::TextDirection in_text_direction_hint)
{
    ...
    mojo::Message message(internal::kWidgetHost_UpdateTooltipUnderCursor_Name, kFlags, 0, 0, nullptr);
    ...
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
        params->tooltip_text.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null tooltip_text in WidgetHost.UpdateTooltipUnderCursor request");
...
void WidgetHostProxy::UpdateTooltipFromKeyboard(const ::std::u16string& in_tooltip_text, ::base::i18n::TextDirection in_text_direction_hint, const ::gfx::Rect& in_bounds)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    ...
    mojo::Message message(internal::kWidgetHost_UpdateTooltipFromKeyboard_Name, kFlags, 0, 0, nullptr);
    ...
    params->tooltip_text.Set(tooltip_text_fragment.is_null() ? nullptr : tooltip_text_fragment.data());
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
        params->tooltip_text.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null tooltip_text in WidgetHost.UpdateTooltipFromKeyboard request");
    mojo::internal::Serialize<::mojo_base::mojom::TextDirection>(in_text_direction_hint, &params->text_direction_hint);
...
void WidgetHostProxy::ClearKeyboardTriggeredTooltip()
{
    ...
    mojo::Message message(internal::kWidgetHost_ClearKeyboardTriggeredTooltip_Name, kFlags, 0, 0, nullptr);
...
void WidgetHostProxy::TextInputStateChanged(::ui::mojom::TextInputStatePtr in_state)
{
    ...
    mojo::Message message(internal::kWidgetHost_TextInputStateChanged_Name, kFlags, 0, 0, nullptr);
    ...
    ::base::i18n::TextDirection in_focus_dir, const ::gfx::Rect& in_bounding_box_rect, bool in_is_anchor_first)
{
    ...
    mojo::Message message(internal::kWidgetHost_SelectionBoundsChanged_Name, kFlags, 0, 0, nullptr);
    ...
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
        params->anchor_rect.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null anchor_rect in WidgetHost.SelectionBoundsChanged request");
    ...
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
        params->bounding_box_rect.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null bounding_box_rect in WidgetHost.SelectionBoundsChanged request");
    ...
    ::mojo::PendingRemote<::viz::mojom::CompositorFrameSinkClient> in_compositor_frame_sink_client)
{
    ...
    TRACE_EVENT1("mojom", "Send blink::mojom::WidgetHost::CreateFrameSink", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("compositor_frame_sink_receiver"), in_compositor_frame_sink_receiver, "<value of type ::mojo::PendingReceiver<::viz::mojom::CompositorFrameSink>>");
        perfetto::WriteIntoTracedValueWithFallback(
    ...
    mojo::Message message(internal::kWidgetHost_CreateFrameSink_Name, kFlags, 0, 0, nullptr);
...
void WidgetHostProxy::RegisterRenderFrameMetadataObserver(::mojo::PendingReceiver<::cc::mojom::RenderFrameMetadataObserverClient> in_render_frame_metadata_observer_client_receiver,
    ::mojo::PendingRemote<::cc::mojom::RenderFrameMetadataObserver> in_render_frame_metadata_observer)
{
    ...
    TRACE_EVENT1("mojom", "Send blink::mojom::WidgetHost::RegisterRenderFrameMetadataObserver", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("render_frame_metadata_observer_client_receiver"), in_render_frame_metadata_observer_client_receiver,
            "<value of type ::mojo::PendingReceiver<::cc::mojom::RenderFrameMetadataObserverClient>>");
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("render_frame_metadata_observer"), in_render_frame_metadata_observer, "<value of type ::mojo::PendingRemote<::cc::mojom::RenderFrameMetadataObserver>>");
    });
#endif
    const bool kExpectsResponse = false;
    const bool kIsSync = false;
    ...
    mojo::Message message(internal::kWidgetHost_RegisterRenderFrameMetadataObserver_Name, kFlags, 0, 0, nullptr);
    ...
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(!mojo::internal::IsHandleOrInterfaceValid(params->render_frame_metadata_observer),
        mojo::internal::VALIDATION_ERROR_UNEXPECTED_INVALID_HANDLE, "invalid render_frame_metadata_observer in WidgetHost.RegisterRenderFrameMetadataObserver request");
...
bool WidgetHostStubDispatch::Accept(WidgetHost* impl, mojo::Message* message)
{
    ...
    case internal::kWidgetHost_SetCursor_Name: {
        ...
        bool success = true;
        ::ui::Cursor p_cursor = mojo::DefaultConstructTraits::CreateInstance<::ui::Cursor>();
    ...
    case internal::kWidgetHost_UpdateTooltipUnderCursor_Name: {
        ...
        bool success = true;
        ::std::u16string p_tooltip_text = mojo::DefaultConstructTraits::CreateInstance<::std::u16string>();
        ::base::i18n::TextDirection p_text_direction_hint = mojo::DefaultConstructTraits::CreateInstance<::base::i18n::TextDirection>();
    ...
    case internal::kWidgetHost_TextInputStateChanged_Name: {
        ...
        DCHECK(message->is_serialized());
        internal::WidgetHost_TextInputStateChanged_Params_Data* params = reinterpret_cast<internal::WidgetHost_TextInputStateChanged_Params_Data*>(message->mutable_payload());

        bool success = true;
        ::ui::mojom::TextInputStatePtr p_state = mojo::DefaultConstructTraits::CreateInstance<::ui::mojom::TextInputStatePtr>();
    ...
    case internal::kWidgetHost_SelectionBoundsChanged_Name: {
        ...
        DCHECK(message->is_serialized());
        internal::WidgetHost_SelectionBoundsChanged_Params_Data* params = reinterpret_cast<internal::WidgetHost_SelectionBoundsChanged_Params_Data*>(message->mutable_payload());

        bool success = true;
        ::gfx::Rect p_anchor_rect = mojo::DefaultConstructTraits::CreateInstance<::gfx::Rect>();
        ::base::i18n::TextDirection p_anchor_dir = mojo::DefaultConstructTraits::CreateInstance<::base::i18n::TextDirection>();
        ::gfx::Rect p_focus_rect = mojo::DefaultConstructTraits::CreateInstance<::gfx::Rect>();
        ::base::i18n::TextDirection p_focus_dir = mojo::DefaultConstructTraits::CreateInstance<::base::i18n::TextDirection>();
        ::gfx::Rect p_bounding_box_rect = mojo::DefaultConstructTraits::CreateInstance<::gfx::Rect>();
        bool p_is_anchor_first = mojo::DefaultConstructTraits::CreateInstance<bool>();
        ...
        impl->SelectionBoundsChanged(
            std::move(p_anchor_rect), std::move(p_anchor_dir), std::move(p_focus_rect), std::move(p_focus_dir), std::move(p_bounding_box_rect), std::move(p_is_anchor_first));
        return true;
    }
    case internal::kWidgetHost_CreateFrameSink_Name: {

        DCHECK(message->is_serialized());
        internal::WidgetHost_CreateFrameSink_Params_Data* params = reinterpret_cast<internal::WidgetHost_CreateFrameSink_Params_Data*>(message->mutable_payload());
    ...
    case internal::kWidgetHost_RegisterRenderFrameMetadataObserver_Name: {
        ...
        ::mojo::PendingReceiver<::cc::mojom::RenderFrameMetadataObserverClient> p_render_frame_metadata_observer_client_receiver
            = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingReceiver<::cc::mojom::RenderFrameMetadataObserverClient>>();
        ::mojo::PendingRemote<::cc::mojom::RenderFrameMetadataObserver> p_render_frame_metadata_observer
            = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingRemote<::cc::mojom::RenderFrameMetadataObserver>>();
...
uint32_t Widget::GetWidgetInputHandler_Sym::IPCStableHash()
{
    ...
    // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
    // hash instead of __LINE__.
    constexpr uint32_t kHash = base::MD5Hash32Constexpr("(Impl)blink::mojom::Widget::GetWidgetInputHandler");
    const uint32_t hash = kHash;
    base::debug::Alias(&hash);
    return hash;
}
...
uint32_t Widget::RequestPresentationTimeForNextFrame_Sym::IPCStableHash()
{
    ...
    // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
    // hash instead of __LINE__.
    constexpr uint32_t kHash = base::MD5Hash32Constexpr("(Impl)blink::mojom::Widget::RequestPresentationTimeForNextFrame");
    const uint32_t hash = kHash;
    base::debug::Alias(&hash);
    return hash;
}
uint32_t Widget::CancelPresentationTimeRequest_Sym::IPCStableHash()
{
    ...
    // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
    // hash instead of __LINE__.
    constexpr uint32_t kHash = base::MD5Hash32Constexpr("(Impl)blink::mojom::Widget::CancelPresentationTimeRequest");
    const uint32_t hash = kHash;
    base::debug::Alias(&hash);
    return hash;
}
...
void WidgetProxy::ForceRedraw(ForceRedrawCallback callback)
{
    ...
    mojo::Message message(internal::kWidget_ForceRedraw_Name, kFlags, 0, 0, nullptr);
...
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send blink::mojom::Widget::GetWidgetInputHandler", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("request"), in_request, "<value of type ::mojo::PendingReceiver<::blink::mojom::WidgetInputHandler>>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("host"), in_host, "<value of type ::mojo::PendingRemote<::blink::mojom::WidgetInputHandlerHost>>");
    });
#endif
    const bool kExpectsResponse = false;
    const bool kIsSync = false;
    ...
    mojo::Message message(internal::kWidget_GetWidgetInputHandler_Name, kFlags, 0, 0, nullptr);
    mojo::internal::MessageFragment<::blink::mojom::internal::Widget_GetWidgetInputHandler_Params_Data> params(message);
    params.Allocate();
    ...
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(!mojo::internal::IsHandleOrInterfaceValid(params->request), mojo::internal::VALIDATION_ERROR_UNEXPECTED_INVALID_HANDLE,
...
void WidgetProxy::UpdateVisualProperties(const ::blink::VisualProperties& in_visual_properties)
{
    ...
    mojo::Message message(internal::kWidget_UpdateVisualProperties_Name, kFlags, 0, 0, nullptr);
    ...
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
        params->visual_properties.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null visual_properties in Widget.UpdateVisualProperties request");
...
void WidgetProxy::UpdateScreenRects(const ::gfx::Rect& in_widget_screen_rect, const ::gfx::Rect& in_window_screen_rect, UpdateScreenRectsCallback callback)
{
    ...
    mojo::Message message(internal::kWidget_UpdateScreenRects_Name, kFlags, 0, 0, nullptr);
    ...
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
        params->widget_screen_rect.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null widget_screen_rect in Widget.UpdateScreenRects request");
    ...
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
        params->window_screen_rect.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null window_screen_rect in Widget.UpdateScreenRects request");
...
void WidgetProxy::WasHidden()
{
    ...
    mojo::Message message(internal::kWidget_WasHidden_Name, kFlags, 0, 0, nullptr);
...
void WidgetProxy::WasShown(bool in_was_evicted, ::blink::mojom::RecordContentToVisibleTimeRequestPtr in_record_tab_switch_time_request)
{
    ...
    TRACE_EVENT1("mojom", "Send blink::mojom::Widget::WasShown", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("record_tab_switch_time_request"), in_record_tab_switch_time_request, "<value of type ::blink::mojom::RecordContentToVisibleTimeRequestPtr>");
    });
#endif
    const bool kExpectsResponse = false;
    const bool kIsSync = false;
    ...
    mojo::Message message(internal::kWidget_WasShown_Name, kFlags, 0, 0, nullptr);
    ...
    mojo::internal::MessageFragment<typename decltype(params->record_tab_switch_time_request)::BaseType> record_tab_switch_time_request_fragment(params.message());
    mojo::internal::Serialize<::blink::mojom::RecordContentToVisibleTimeRequestDataView>(in_record_tab_switch_time_request, record_tab_switch_time_request_fragment);
...
void WidgetProxy::RequestPresentationTimeForNextFrame(::blink::mojom::RecordContentToVisibleTimeRequestPtr in_visible_time_request)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send blink::mojom::Widget::RequestPresentationTimeForNextFrame", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(
    ...
    mojo::Message message(internal::kWidget_RequestPresentationTimeForNextFrame_Name, kFlags, 0, 0, nullptr);
    mojo::internal::MessageFragment<::blink::mojom::internal::Widget_RequestPresentationTimeForNextFrame_Params_Data> params(message);
    params.Allocate();
...
void WidgetProxy::CancelPresentationTimeRequest()
{
    ...
    mojo::Message message(internal::kWidget_CancelPresentationTimeRequest_Name, kFlags, 0, 0, nullptr);
    mojo::internal::MessageFragment<::blink::mojom::internal::Widget_CancelPresentationTimeRequest_Params_Data> params(message);
    params.Allocate();
...
bool Widget_UpdateScreenRects_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    DCHECK(message->is_serialized());
    internal::Widget_UpdateScreenRects_ResponseParams_Data* params = reinterpret_cast<internal::Widget_UpdateScreenRects_ResponseParams_Data*>(message->mutable_payload());

    bool success = true;
    Widget_UpdateScreenRects_ResponseParamsDataView input_data_view(params, message);

    if (!success) {
        ReportValidationErrorForMessage(message, mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED, Widget::Name_, 3, true);
        return false;
    }
    if (!callback_.is_null())
        std::move(callback_).Run();
...
bool WidgetStubDispatch::Accept(Widget* impl, mojo::Message* message)
{
    ...
    case internal::kWidget_GetWidgetInputHandler_Name: {
        ...
        DCHECK(message->is_serialized());
        internal::Widget_GetWidgetInputHandler_Params_Data* params = reinterpret_cast<internal::Widget_GetWidgetInputHandler_Params_Data*>(message->mutable_payload());

        bool success = true;
        ::mojo::PendingReceiver<::blink::mojom::WidgetInputHandler> p_request
            = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingReceiver<::blink::mojom::WidgetInputHandler>>();
        ::mojo::PendingRemote<::blink::mojom::WidgetInputHandlerHost> p_host
            = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingRemote<::blink::mojom::WidgetInputHandlerHost>>();
    ...
    case internal::kWidget_UpdateVisualProperties_Name: {
        ...
        DCHECK(message->is_serialized());
        internal::Widget_UpdateVisualProperties_Params_Data* params = reinterpret_cast<internal::Widget_UpdateVisualProperties_Params_Data*>(message->mutable_payload());

        bool success = true;
        ::blink::VisualProperties p_visual_properties = mojo::DefaultConstructTraits::CreateInstance<::blink::VisualProperties>();
    ...
    case internal::kWidget_WasShown_Name: {
        ...
        bool success = true;
        bool p_was_evicted = mojo::DefaultConstructTraits::CreateInstance<bool>();
        ::blink::mojom::RecordContentToVisibleTimeRequestPtr p_record_tab_switch_time_request
            = mojo::DefaultConstructTraits::CreateInstance<::blink::mojom::RecordContentToVisibleTimeRequestPtr>();
    ...
    case internal::kWidget_RequestPresentationTimeForNextFrame_Name: {
        ...
        internal::Widget_RequestPresentationTimeForNextFrame_Params_Data* params
            = reinterpret_cast<internal::Widget_RequestPresentationTimeForNextFrame_Params_Data*>(message->mutable_payload());
        ...
        // A null |impl| means no implementation was bound.
        DCHECK(impl);
        impl->RequestPresentationTimeForNextFrame(std::move(p_visible_time_request));
        return true;
    }
    case internal::kWidget_CancelPresentationTimeRequest_Name: {
        ...
        internal::Widget_CancelPresentationTimeRequest_Params_Data* params
            = reinterpret_cast<internal::Widget_CancelPresentationTimeRequest_Params_Data*>(message->mutable_payload());
...
bool WidgetStubDispatch::AcceptWithResponder(Widget* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
{
    ...
    case internal::kWidget_UpdateScreenRects_Name: {
        ...
        bool success = true;
        ::gfx::Rect p_widget_screen_rect = mojo::DefaultConstructTraits::CreateInstance<::gfx::Rect>();
        ::gfx::Rect p_window_screen_rect = mojo::DefaultConstructTraits::CreateInstance<::gfx::Rect>();
...
static const mojo::internal::GenericValidationInfo kWidgetValidationInfo[] = {
    ...
    { &internal::Widget_GetWidgetInputHandler_Params_Data::Validate, nullptr /* no response */ },
    ...
    { &internal::Widget_RequestPresentationTimeForNextFrame_Params_Data::Validate, nullptr /* no response */ },
    { &internal::Widget_CancelPresentationTimeRequest_Params_Data::Validate, nullptr /* no response */ },
};
...
void WidgetCompositorInterceptorForTesting::VisualStateRequest(VisualStateRequestCallback callback) { GetForwardingInterface()->VisualStateRequest(std::move(callback)); }
...
void WidgetHostInterceptorForTesting::SetCursor(const ::ui::Cursor& cursor) { GetForwardingInterface()->SetCursor(std::move(cursor)); }
...
void WidgetHostInterceptorForTesting::ClearKeyboardTriggeredTooltip() { GetForwardingInterface()->ClearKeyboardTriggeredTooltip(); }
void WidgetHostInterceptorForTesting::TextInputStateChanged(::ui::mojom::TextInputStatePtr state) { GetForwardingInterface()->TextInputStateChanged(std::move(state)); }
void WidgetHostInterceptorForTesting::SelectionBoundsChanged(const ::gfx::Rect& anchor_rect, ::base::i18n::TextDirection anchor_dir, const ::gfx::Rect& focus_rect,
...
void WidgetInterceptorForTesting::ForceRedraw(ForceRedrawCallback callback) { GetForwardingInterface()->ForceRedraw(std::move(callback)); }
void WidgetInterceptorForTesting::GetWidgetInputHandler(
...
void WidgetInterceptorForTesting::WasHidden() { GetForwardingInterface()->WasHidden(); }
...
void WidgetInterceptorForTesting::RequestPresentationTimeForNextFrame(::blink::mojom::RecordContentToVisibleTimeRequestPtr visible_time_request)
{
    GetForwardingInterface()->RequestPresentationTimeForNextFrame(std::move(visible_time_request));
}
void WidgetInterceptorForTesting::CancelPresentationTimeRequest() { GetForwardingInterface()->CancelPresentationTimeRequest(); }
