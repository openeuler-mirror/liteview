...
void WidgetHostProxy::UpdateTooltipFromKeyboard(const ::WTF::String& in_tooltip_text, ::base::i18n::TextDirection in_text_direction_hint, const ::gfx::Rect& in_bounds)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    ...
    ::mojo::PendingRemote<::viz::mojom::blink::CompositorFrameSinkClient> in_compositor_frame_sink_client)
{
    ...
    TRACE_EVENT1("mojom", "Send blink::mojom::WidgetHost::CreateFrameSink", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("compositor_frame_sink_receiver"), in_compositor_frame_sink_receiver, "<value of type ::mojo::PendingReceiver<::viz::mojom::blink::CompositorFrameSink>>");
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("compositor_frame_sink_client"), in_compositor_frame_sink_client, "<value of type ::mojo::PendingRemote<::viz::mojom::blink::CompositorFrameSinkClient>>");
    });
#endif
    const bool kExpectsResponse = false;
    const bool kIsSync = false;
...
bool WidgetHostStubDispatch::Accept(WidgetHost* impl, mojo::Message* message)
{
    ...
    case internal::kWidgetHost_UpdateTooltipUnderCursor_Name: {
        ...
        bool success = true;
        ::WTF::String p_tooltip_text = mojo::DefaultConstructTraits::CreateInstance<::WTF::String>();
    ...
    case internal::kWidgetHost_TextInputStateChanged_Name: {
        ...
        bool success = true;
        ::ui::mojom::blink::TextInputStatePtr p_state = mojo::DefaultConstructTraits::CreateInstance<::ui::mojom::blink::TextInputStatePtr>();
    ...
    case internal::kWidgetHost_CreateFrameSink_Name: {
        ...
        ::mojo::PendingReceiver<::viz::mojom::blink::CompositorFrameSink> p_compositor_frame_sink_receiver
            = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingReceiver<::viz::mojom::blink::CompositorFrameSink>>();
        ::mojo::PendingRemote<::viz::mojom::blink::CompositorFrameSinkClient> p_compositor_frame_sink_client
            = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingRemote<::viz::mojom::blink::CompositorFrameSinkClient>>();
    ...
    case internal::kWidgetHost_RegisterRenderFrameMetadataObserver_Name: {
        ...
        ::mojo::PendingReceiver<::cc::mojom::blink::RenderFrameMetadataObserverClient> p_render_frame_metadata_observer_client_receiver
            = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingReceiver<::cc::mojom::blink::RenderFrameMetadataObserverClient>>();
        ::mojo::PendingRemote<::cc::mojom::blink::RenderFrameMetadataObserver> p_render_frame_metadata_observer
            = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingRemote<::cc::mojom::blink::RenderFrameMetadataObserver>>();
    ...
    ::mojo::PendingReceiver<::blink::mojom::blink::WidgetInputHandler> in_request, ::mojo::PendingRemote<::blink::mojom::blink::WidgetInputHandlerHost> in_host)
{
    ...
    TRACE_EVENT1("mojom", "Send blink::mojom::Widget::GetWidgetInputHandler", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("request"), in_request, "<value of type ::mojo::PendingReceiver<::blink::mojom::blink::WidgetInputHandler>>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("host"), in_host, "<value of type ::mojo::PendingRemote<::blink::mojom::blink::WidgetInputHandlerHost>>");
    });
#endif
    const bool kExpectsResponse = false;
    const bool kIsSync = false;
...
void WidgetProxy::WasShown(bool in_was_evicted, ::blink::mojom::blink::RecordContentToVisibleTimeRequestPtr in_record_tab_switch_time_request)
{
    ...
    TRACE_EVENT1("mojom", "Send blink::mojom::Widget::WasShown", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("record_tab_switch_time_request"), in_record_tab_switch_time_request, "<value of type ::blink::mojom::blink::RecordContentToVisibleTimeRequestPtr>");
    });
#endif
    const bool kExpectsResponse = false;
    const bool kIsSync = false;
...
void WidgetProxy::RequestPresentationTimeForNextFrame(::blink::mojom::blink::RecordContentToVisibleTimeRequestPtr in_visible_time_request)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
bool WidgetStubDispatch::Accept(Widget* impl, mojo::Message* message)
{
    ...
    case internal::kWidget_GetWidgetInputHandler_Name: {
        ...
        ::mojo::PendingReceiver<::blink::mojom::blink::WidgetInputHandler> p_request
            = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingReceiver<::blink::mojom::blink::WidgetInputHandler>>();
        ::mojo::PendingRemote<::blink::mojom::blink::WidgetInputHandlerHost> p_host
            = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingRemote<::blink::mojom::blink::WidgetInputHandlerHost>>();
    ...
    case internal::kWidget_WasShown_Name: {
        ...
        ::blink::mojom::blink::RecordContentToVisibleTimeRequestPtr p_record_tab_switch_time_request
            = mojo::DefaultConstructTraits::CreateInstance<::blink::mojom::blink::RecordContentToVisibleTimeRequestPtr>();
...
void WidgetHostInterceptorForTesting::TextInputStateChanged(::ui::mojom::blink::TextInputStatePtr state) { GetForwardingInterface()->TextInputStateChanged(std::move(state)); }
