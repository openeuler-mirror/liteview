...
// with not having this data in traces there.
    ...
    virtual void RegisterRenderFrameMetadataObserver(::mojo::PendingReceiver<::cc::mojom::RenderFrameMetadataObserverClient> render_frame_metadata_observer_client_receiver,
...
// with not having this data in traces there.
    ...
    virtual void GetWidgetInputHandler(::mojo::PendingReceiver<::blink::mojom::WidgetInputHandler> request, ::mojo::PendingRemote<::blink::mojom::WidgetInputHandlerHost> host) = 0;
    ...
    virtual void RequestPresentationTimeForNextFrame(::blink::mojom::RecordContentToVisibleTimeRequestPtr visible_time_request) = 0;
...
//
//   void SelectionBoundsChanged(const ::gfx::Rect& anchor_rect, ::base::i18n::TextDirection anchor_dir, const ::gfx::Rect& focus_rect, ::base::i18n::TextDirection focus_dir, const
//   ::gfx::Rect& bounding_box_rect, bool is_anchor_first) final;
//
//   void CreateFrameSink(::mojo::PendingReceiver<::viz::mojom::CompositorFrameSink> compositor_frame_sink_receiver, ::mojo::PendingRemote<::viz::mojom::CompositorFrameSinkClient>
//   compositor_frame_sink_client) final;
//
//   void RegisterRenderFrameMetadataObserver(::mojo::PendingReceiver<::cc::mojom::RenderFrameMetadataObserverClient> render_frame_metadata_observer_client_receiver,
...
//
//   void GetWidgetInputHandler(::mojo::PendingReceiver<::blink::mojom::WidgetInputHandler> request, ::mojo::PendingRemote<::blink::mojom::WidgetInputHandlerHost> host) final;
//
...
//
//   void RequestPresentationTimeForNextFrame(::blink::mojom::RecordContentToVisibleTimeRequestPtr visible_time_request) final;
//
