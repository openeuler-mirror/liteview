...
(function() {
  ...
  function Widget_RequestPresentationTimeForNextFrame_Params(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  Widget_RequestPresentationTimeForNextFrame_Params.prototype.initDefaults_ = function() {
    this.visibleTimeRequest = null;
  };
  Widget_RequestPresentationTimeForNextFrame_Params.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  Widget_RequestPresentationTimeForNextFrame_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    // validate Widget_RequestPresentationTimeForNextFrame_Params.visibleTimeRequest
  ...
  Widget_RequestPresentationTimeForNextFrame_Params.encodedSize = codec.kStructHeaderSize + 8;

  Widget_RequestPresentationTimeForNextFrame_Params.decode = function(decoder) {
    var packed;
    var val = new Widget_RequestPresentationTimeForNextFrame_Params();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
  ...
  Widget_RequestPresentationTimeForNextFrame_Params.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(Widget_RequestPresentationTimeForNextFrame_Params.encodedSize);
    encoder.writeUint32(0);
  ...
  function Widget_CancelPresentationTimeRequest_Params(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  Widget_CancelPresentationTimeRequest_Params.prototype.initDefaults_ = function() {
  };
  Widget_CancelPresentationTimeRequest_Params.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  Widget_CancelPresentationTimeRequest_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  Widget_CancelPresentationTimeRequest_Params.encodedSize = codec.kStructHeaderSize + 0;

  Widget_CancelPresentationTimeRequest_Params.decode = function(decoder) {
    var packed;
    var val = new Widget_CancelPresentationTimeRequest_Params();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    return val;
  };

  Widget_CancelPresentationTimeRequest_Params.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(Widget_CancelPresentationTimeRequest_Params.encodedSize);
    encoder.writeUint32(0);
  };
  ...
  var kWidget_RequestPresentationTimeForNextFrame_Name = 6;
  var kWidget_CancelPresentationTimeRequest_Name = 7;
  ...
  WidgetPtr.prototype.requestPresentationTimeForNextFrame = function() {
    return WidgetProxy.prototype.requestPresentationTimeForNextFrame
        .apply(this.ptr.getProxy(), arguments);
  };

  WidgetProxy.prototype.requestPresentationTimeForNextFrame = function(visibleTimeRequest) {
    var params_ = new Widget_RequestPresentationTimeForNextFrame_Params();
    params_.visibleTimeRequest = visibleTimeRequest;
    var builder = new codec.MessageV0Builder(
        kWidget_RequestPresentationTimeForNextFrame_Name,
        codec.align(Widget_RequestPresentationTimeForNextFrame_Params.encodedSize));
    builder.encodeStruct(Widget_RequestPresentationTimeForNextFrame_Params, params_);
    var message = builder.finish();
    this.receiver_.accept(message);
  };
  WidgetPtr.prototype.cancelPresentationTimeRequest = function() {
    return WidgetProxy.prototype.cancelPresentationTimeRequest
        .apply(this.ptr.getProxy(), arguments);
  };

  WidgetProxy.prototype.cancelPresentationTimeRequest = function() {
    var params_ = new Widget_CancelPresentationTimeRequest_Params();
    var builder = new codec.MessageV0Builder(
        kWidget_CancelPresentationTimeRequest_Name,
        codec.align(Widget_CancelPresentationTimeRequest_Params.encodedSize));
    builder.encodeStruct(Widget_CancelPresentationTimeRequest_Params, params_);
    var message = builder.finish();
    this.receiver_.accept(message);
  };
  ...
  WidgetStub.prototype.requestPresentationTimeForNextFrame = function(visibleTimeRequest) {
    return this.delegate_ && this.delegate_.requestPresentationTimeForNextFrame && this.delegate_.requestPresentationTimeForNextFrame(visibleTimeRequest);
  }
  WidgetStub.prototype.cancelPresentationTimeRequest = function() {
    return this.delegate_ && this.delegate_.cancelPresentationTimeRequest && this.delegate_.cancelPresentationTimeRequest();
  }
  ...
  WidgetStub.prototype.accept = function(message) {
    ...
    case kWidget_WasShown_Name:
      ...
      return true;
    case kWidget_RequestPresentationTimeForNextFrame_Name:
      var params = reader.decodeStruct(Widget_RequestPresentationTimeForNextFrame_Params);
      this.requestPresentationTimeForNextFrame(params.visibleTimeRequest);
      return true;
    case kWidget_CancelPresentationTimeRequest_Name:
      var params = reader.decodeStruct(Widget_CancelPresentationTimeRequest_Params);
  ...
  function validateWidgetRequest(messageValidator) {
    ...
    switch (message.getName()) {
      ...
      case kWidget_RequestPresentationTimeForNextFrame_Name:
        if (!message.expectsResponse() && !message.isResponse())
          paramsClass = Widget_RequestPresentationTimeForNextFrame_Params;
      break;
      case kWidget_CancelPresentationTimeRequest_Name:
        if (!message.expectsResponse() && !message.isResponse())
          paramsClass = Widget_CancelPresentationTimeRequest_Params;
      break;
    }
    if (paramsClass === null)
      return validator.validationError.NONE;
