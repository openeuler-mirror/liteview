// third_party/blink/public/mojom/push_messaging/push_messaging_status.mojom-lite-for-compile.js is auto generated by mojom_bindings_generator.py, do not edit
...
goog.provide('blink.mojom.PushEventStatus');
goog.provide('blink.mojom.PushEventStatusSpec');
/**
...
goog.provide('blink.mojom.PushGetRegistrationStatus');
goog.provide('blink.mojom.PushGetRegistrationStatusSpec');
/**
 * @const { {$: !mojo.internal.MojomType} }
 * @export
 */
...
goog.provide('blink.mojom.PushRegistrationStatus');
goog.provide('blink.mojom.PushRegistrationStatusSpec');
/**
 * @const { {$: !mojo.internal.MojomType} }
 * @export
 */
...
goog.provide('blink.mojom.PushUnregistrationReason');
goog.provide('blink.mojom.PushUnregistrationReasonSpec');
/**
 * @const { {$: !mojo.internal.MojomType} }
 * @export
 */
...
goog.provide('blink.mojom.PushUnregistrationStatus');
goog.provide('blink.mojom.PushUnregistrationStatusSpec');
/**
 * @const { {$: !mojo.internal.MojomType} }
 * @export
 */
...
goog.provide('blink.mojom.PushUserVisibleStatus');
goog.provide('blink.mojom.PushUserVisibleStatusSpec');
/**
 * @const { {$: !mojo.internal.MojomType} }
 * @export
 */
