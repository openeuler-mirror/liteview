...
public:
    ...
    MimeRegistry_GetMimeTypeFromExtension_ResponseParamsDataView(internal::MimeRegistry_GetMimeTypeFromExtension_ResponseParams_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
