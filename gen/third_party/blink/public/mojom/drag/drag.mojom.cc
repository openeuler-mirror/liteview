...
bool AllowedDragOperations::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
bool DragItemString::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
DragItemBinary::DragItemBinary(::mojo_base::BigBuffer data_in, bool is_image_accessible_in, const ::GURL& source_url_in, const ::base::FilePath& filename_extension_in,
...
bool DragItemBinary::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
DragItemFileSystemFile::DragItemFileSystemFile(
    const ::GURL& url_in, int64_t size_in, const absl::optional<std::string>& file_system_id_in, ::blink::mojom::SerializedBlobPtr serialized_blob_in)
    : url(std::move(url_in))
...
bool DragItemFileSystemFile::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
DragData::DragData()
    : items()
    , file_system_id()
...
DragData::DragData(std::vector<DragItemPtr> items_in, const absl::optional<std::string>& file_system_id_in, ::network::mojom::ReferrerPolicy referrer_policy_in)
...
bool DragData::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
bool DragEventSourceInfo::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
DragItem::DragItem()
    : tag_(Tag::kString)
{
...
DragItem::~DragItem() { DestroyActive(); }
...
bool DragItem::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context, false); }
} // namespace mojom
} // namespace blink
namespace mojo {
// static
...
// static
bool StructTraits<::blink::mojom::DragData::DataView, ::blink::mojom::DragDataPtr>::Read(::blink::mojom::DragData::DataView input, ::blink::mojom::DragDataPtr* output)
{
    bool success = true;
...
// static
bool UnionTraits<::blink::mojom::DragItem::DataView, ::blink::mojom::DragItemPtr>::Read(::blink::mojom::DragItem::DataView input, ::blink::mojom::DragItemPtr* output)
{
