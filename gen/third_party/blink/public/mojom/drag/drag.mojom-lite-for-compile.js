// third_party/blink/public/mojom/drag/drag.mojom-lite-for-compile.js is auto generated by mojom_bindings_generator.py, do not edit
...
goog.require('ui.mojom.DragEventSource');
...
goog.provide('blink.mojom.AllowedDragOperationsSpec');
/**
...
goog.provide('blink.mojom.DragItemStringSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('blink.mojom.DragItemBinarySpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('blink.mojom.DragItemFileSystemFileSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('blink.mojom.DragDataSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('blink.mojom.DragEventSourceInfoSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('blink.mojom.DragItemSpec');
/**
 * @const { {$:!mojo.internal.MojomType} }
 * @export
 */
...
goog.provide('blink.mojom.AllowedDragOperations');
...
goog.provide('blink.mojom.DragItemString');
...
goog.provide('blink.mojom.DragItemBinary');
...
goog.provide('blink.mojom.DragItemFileSystemFile');
...
goog.provide('blink.mojom.DragData');
...
goog.provide('blink.mojom.DragEventSourceInfo');
...
goog.provide('blink.mojom.DragItem');
mojo.internal.Union(
