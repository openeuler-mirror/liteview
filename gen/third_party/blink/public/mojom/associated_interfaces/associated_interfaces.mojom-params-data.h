...
static_assert(sizeof(AssociatedInterfaceProvider_GetAssociatedInterface_Params_Data) == 24, "Bad sizeof(AssociatedInterfaceProvider_GetAssociatedInterface_Params_Data)");
...
public:
    ...
    AssociatedInterfaceProvider_GetAssociatedInterface_ParamsDataView(internal::AssociatedInterfaceProvider_GetAssociatedInterface_Params_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
