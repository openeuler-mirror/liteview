...
// static
bool AssociatedInterfaceStubDispatch::Accept(AssociatedInterface* impl, mojo::Message* message) { return false; }

// static
bool AssociatedInterfaceStubDispatch::AcceptWithResponder(AssociatedInterface* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
{
    return false;
}
...
void AssociatedInterfaceProviderProxy::GetAssociatedInterface(const std::string& in_name, ::mojo::PendingAssociatedReceiver<AssociatedInterface> in_receiver)
{
    ...
    TRACE_EVENT1("mojom", "Send blink::mojom::AssociatedInterfaceProvider::GetAssociatedInterface", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("receiver"), in_receiver, "<value of type ::mojo::PendingAssociatedReceiver<AssociatedInterface>>");
    });
#endif
    ...
    mojo::Message message(internal::kAssociatedInterfaceProvider_GetAssociatedInterface_Name, kFlags, 0, 0, nullptr);
    ...
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
        params->name.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null name in AssociatedInterfaceProvider.GetAssociatedInterface request");
...
bool AssociatedInterfaceProviderStubDispatch::Accept(AssociatedInterfaceProvider* impl, mojo::Message* message)
{
    ...
    case internal::kAssociatedInterfaceProvider_GetAssociatedInterface_Name: {
        ...
        ::mojo::PendingAssociatedReceiver<AssociatedInterface> p_receiver = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingAssociatedReceiver<AssociatedInterface>>();
...
void AssociatedInterfaceProviderInterceptorForTesting::GetAssociatedInterface(const std::string& name, ::mojo::PendingAssociatedReceiver<AssociatedInterface> receiver)
{
