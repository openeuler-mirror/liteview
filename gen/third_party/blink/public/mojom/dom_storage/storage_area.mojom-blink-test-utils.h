...
class PLATFORM_EXPORT StorageAreaObserverInterceptorForTesting : public StorageAreaObserver {
    ...
    void KeyChanged(
        const WTF::Vector<uint8_t>& key, const WTF::Vector<uint8_t>& new_value, const absl::optional<WTF::Vector<uint8_t>>& old_value, const WTF::String& source) override;
...
public:
    ...
    void Delete(const WTF::Vector<uint8_t>& key, const absl::optional<WTF::Vector<uint8_t>>& client_old_value, const WTF::String& source, bool* out_success);
