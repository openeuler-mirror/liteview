...
static_assert(
    sizeof(DomStorageClient_ResetStorageAreaAndNamespaceConnections_Params_Data) == 8, "Bad sizeof(DomStorageClient_ResetStorageAreaAndNamespaceConnections_Params_Data)");
...
public:
    ...
    {
        UserType result;
        bool ret = mojo::internal::Deserialize<mojo::InterfaceRequestDataView<::blink::mojom::StorageAreaInterfaceBase>>(&data_->session_namespace, &result, message_);
        DCHECK(ret);
        return result;
    }
