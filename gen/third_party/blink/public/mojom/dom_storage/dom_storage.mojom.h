...
#include "third_party/blink/public/mojom/dom_storage/dom_storage.mojom-forward.h"
...
// with not having this data in traces there.
    ...
    virtual void BindSessionStorageArea(const ::blink::StorageKey& storage_key, const ::blink::LocalFrameToken& local_frame_token, const std::string& namespace_id,
        ::mojo::PendingReceiver<::blink::mojom::StorageArea> session_namespace)
        = 0;
};
...
//
//   void OpenLocalStorage(const ::blink::StorageKey& storage_key, const ::blink::LocalFrameToken& local_frame_token, ::mojo::PendingReceiver<::blink::mojom::StorageArea> area)
//   final;
//
