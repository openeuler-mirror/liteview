...
MixedContentIssueDetails::MixedContentIssueDetails(::blink::mojom::blink::RequestContextType request_context_in, MixedContentResolutionStatus resolution_status_in,
    const WTF::String& insecure_url_in, const WTF::String& main_resource_url_in, AffectedRequestPtr request_in, AffectedFramePtr frame_in)
...
ContentSecurityPolicyIssueDetails::ContentSecurityPolicyIssueDetails(const absl::optional<::blink::KURL>& blocked_url_in, const WTF::String& violated_directive_in,
...
CookieIssueDetails::CookieIssueDetails(AffectedCookiePtr cookie_in, WTF::Vector<CookieExclusionReason> exclusion_reason_in, WTF::Vector<CookieWarningReason> warning_reason_in,
...
TrustedWebActivityIssueDetails::TrustedWebActivityIssueDetails(const ::blink::KURL& url_in, TwaQualityEnforcementViolationType violation_type_in, int32_t http_error_code_in,
...
LowTextContrastIssue::LowTextContrastIssue(int32_t violating_node_id_in, const WTF::String& violating_node_selector_in, float contrast_ratio_in, float threshold_aa_in,
    float threshold_aaa_in, const WTF::String& font_size_in, const WTF::String& font_weight_in)
    : violating_node_id(std::move(violating_node_id_in))
...
GenericIssueDetails::GenericIssueDetails(GenericIssueErrorType error_type_in, const WTF::String& frame_id_in)
...
bool StructTraits<::blink::mojom::blink::TrustedWebActivityIssueDetails::DataView, ::blink::mojom::blink::TrustedWebActivityIssueDetailsPtr>::Read(
    ::blink::mojom::blink::TrustedWebActivityIssueDetails::DataView input, ::blink::mojom::blink::TrustedWebActivityIssueDetailsPtr* output)
{
    bool success = true;
