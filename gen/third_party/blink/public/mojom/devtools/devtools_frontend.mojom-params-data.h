...
public:
    ...
    DevToolsFrontendHost_DispatchEmbedderMessage_ParamsDataView(internal::DevToolsFrontendHost_DispatchEmbedderMessage_Params_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
