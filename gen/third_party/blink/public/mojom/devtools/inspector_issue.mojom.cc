...
bool AffectedCookie::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
AffectedRequest::AffectedRequest(const std::string& request_id_in, const absl::optional<std::string>& url_in)
...
bool AffectedRequest::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
bool AffectedFrame::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
AffectedLocation::AffectedLocation(const absl::optional<std::string>& script_id_in, const absl::optional<std::string>& url_in, uint32_t line_in, uint32_t column_in)
...
bool AffectedLocation::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
bool BlockedByResponseIssueDetails::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
bool HeavyAdIssueDetails::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
bool MixedContentIssueDetails::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
ContentSecurityPolicyIssueDetails::ContentSecurityPolicyIssueDetails(const absl::optional<::GURL>& blocked_url_in, const std::string& violated_directive_in, bool is_report_only_in,
...
bool ContentSecurityPolicyIssueDetails::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
CookieIssueDetails::CookieIssueDetails(AffectedCookiePtr cookie_in, std::vector<CookieExclusionReason> exclusion_reason_in, std::vector<CookieWarningReason> warning_reason_in,
...
bool CookieIssueDetails::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
bool SharedArrayBufferIssueDetails::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
TrustedWebActivityIssueDetails::TrustedWebActivityIssueDetails(const ::GURL& url_in, TwaQualityEnforcementViolationType violation_type_in, int32_t http_error_code_in,
...
void TrustedWebActivityIssueDetails::WriteIntoTrace(perfetto::TracedValue traced_context) const
{
    [[maybe_unused]] auto dict = std::move(traced_context).WriteDictionary();
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("url"), this->url,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    ...
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("http_error_code"), this->http_error_code,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
        "<value of type int32_t>"
#else
        "<value>"
    ...
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("package_name"), this->package_name,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
        "<value of type const absl::optional<std::string>&>"
#else
        "<value>"
...
bool TrustedWebActivityIssueDetails::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
LowTextContrastIssue::LowTextContrastIssue(int32_t violating_node_id_in, const std::string& violating_node_selector_in, float contrast_ratio_in, float threshold_aa_in,
    float threshold_aaa_in, const std::string& font_size_in, const std::string& font_weight_in)
    : violating_node_id(std::move(violating_node_id_in))
...
bool LowTextContrastIssue::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
bool FederatedAuthRequestIssueDetails::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
GenericIssueDetails::GenericIssueDetails(GenericIssueErrorType error_type_in, const absl::optional<std::string>& frame_id_in)
...
bool GenericIssueDetails::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
InspectorIssueDetails::InspectorIssueDetails(CookieIssueDetailsPtr cookie_issue_details_in, MixedContentIssueDetailsPtr mixed_content_issue_details_in,
    ...
    LowTextContrastIssuePtr low_text_contrast_details_in, FederatedAuthRequestIssueDetailsPtr federated_auth_request_details_in, GenericIssueDetailsPtr generic_issue_details_in,
...
void InspectorIssueDetails::WriteIntoTrace(perfetto::TracedValue traced_context) const
{
    ...
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("twa_issue_details"), this->twa_issue_details,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
bool InspectorIssueDetails::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
bool InspectorIssueInfo::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
} // namespace mojom
} // namespace blink
namespace mojo {
// static
...
bool StructTraits<::blink::mojom::TrustedWebActivityIssueDetails::DataView, ::blink::mojom::TrustedWebActivityIssueDetailsPtr>::Read(
    ::blink::mojom::TrustedWebActivityIssueDetails::DataView input, ::blink::mojom::TrustedWebActivityIssueDetailsPtr* output)
{
    bool success = true;
