...
(function() {
  ...
  InspectorIssueCode.kGenericIssue = 9;
  InspectorIssueCode.MIN_VALUE = 0;
  InspectorIssueCode.MAX_VALUE = 9;
  ...
  CookieExclusionReason.MAX_VALUE = 4;
  ...
  CookieWarningReason.MAX_VALUE = 9;
  ...
  FederatedAuthRequestResult.kErrorFetchingManifestListHttpNotFound = 4;
  FederatedAuthRequestResult.kErrorFetchingManifestListNoResponse = 5;
  FederatedAuthRequestResult.kErrorFetchingManifestListInvalidResponse = 6;
  FederatedAuthRequestResult.kErrorManifestNotInManifestList = 7;
  FederatedAuthRequestResult.kErrorManifestListTooBig = 8;
  FederatedAuthRequestResult.kErrorFetchingManifestHttpNotFound = 9;
  FederatedAuthRequestResult.kErrorFetchingManifestNoResponse = 10;
  FederatedAuthRequestResult.kErrorFetchingManifestInvalidResponse = 11;
  FederatedAuthRequestResult.kErrorFetchingClientMetadataHttpNotFound = 12;
  FederatedAuthRequestResult.kErrorFetchingClientMetadataNoResponse = 13;
  FederatedAuthRequestResult.kErrorFetchingClientMetadataInvalidResponse = 14;
  FederatedAuthRequestResult.kErrorFetchingAccountsHttpNotFound = 15;
  FederatedAuthRequestResult.kErrorFetchingAccountsNoResponse = 16;
  FederatedAuthRequestResult.kErrorFetchingAccountsInvalidResponse = 17;
  FederatedAuthRequestResult.kErrorFetchingIdTokenHttpNotFound = 18;
  FederatedAuthRequestResult.kErrorFetchingIdTokenNoResponse = 19;
  FederatedAuthRequestResult.kErrorFetchingIdTokenInvalidResponse = 20;
  FederatedAuthRequestResult.kErrorCanceled = 21;
  FederatedAuthRequestResult.kErrorRpPageNotVisible = 22;
  FederatedAuthRequestResult.kError = 23;
  FederatedAuthRequestResult.MIN_VALUE = 0;
  FederatedAuthRequestResult.MAX_VALUE = 23;
  ...
  InspectorIssueDetails.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 72, GenericIssueDetails, true);
    if (err !== validator.validationError.NONE)
        return err;
    // validate InspectorIssueDetails.issueId
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 80, unguessable_token$.UnguessableToken, true);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  InspectorIssueDetails.encodedSize = codec.kStructHeaderSize + 88;
