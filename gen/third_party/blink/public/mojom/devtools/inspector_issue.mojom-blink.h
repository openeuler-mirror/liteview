...
struct blink_mojom_internal_InspectorIssueCode_DataHashFn {
    ...
    static bool Equal(const ::blink::mojom::InspectorIssueCode& left, const ::blink::mojom::InspectorIssueCode& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::blink::mojom::InspectorIssueCode> : public GenericHashTraits<::blink::mojom::InspectorIssueCode> {
    ...
    static void ConstructDeletedValue(::blink::mojom::InspectorIssueCode& slot, bool) { slot = static_cast<::blink::mojom::InspectorIssueCode>(-1000001); }
    static bool IsDeletedValue(const ::blink::mojom::InspectorIssueCode& value) { return value == static_cast<::blink::mojom::InspectorIssueCode>(-1000001); }
};
} // namespace WTF
namespace WTF {
struct blink_mojom_internal_HeavyAdResolutionStatus_DataHashFn {
    ...
    static bool Equal(const ::blink::mojom::HeavyAdResolutionStatus& left, const ::blink::mojom::HeavyAdResolutionStatus& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::blink::mojom::HeavyAdResolutionStatus> : public GenericHashTraits<::blink::mojom::HeavyAdResolutionStatus> {
    static_assert(true, "-1000000 is a reserved enum value");
    static_assert(true, "-1000001 is a reserved enum value");
    static const bool kEmptyValueIsZero = false;
    static ::blink::mojom::HeavyAdResolutionStatus EmptyValue() { return static_cast<::blink::mojom::HeavyAdResolutionStatus>(-1000000); }
    static void ConstructDeletedValue(::blink::mojom::HeavyAdResolutionStatus& slot, bool) { slot = static_cast<::blink::mojom::HeavyAdResolutionStatus>(-1000001); }
    static bool IsDeletedValue(const ::blink::mojom::HeavyAdResolutionStatus& value) { return value == static_cast<::blink::mojom::HeavyAdResolutionStatus>(-1000001); }
};
} // namespace WTF
namespace WTF {
struct blink_mojom_internal_HeavyAdReason_DataHashFn {
    ...
    static bool Equal(const ::blink::mojom::HeavyAdReason& left, const ::blink::mojom::HeavyAdReason& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::blink::mojom::HeavyAdReason> : public GenericHashTraits<::blink::mojom::HeavyAdReason> {
    static_assert(true, "-1000000 is a reserved enum value");
    static_assert(true, "-1000001 is a reserved enum value");
    static const bool kEmptyValueIsZero = false;
    static ::blink::mojom::HeavyAdReason EmptyValue() { return static_cast<::blink::mojom::HeavyAdReason>(-1000000); }
    static void ConstructDeletedValue(::blink::mojom::HeavyAdReason& slot, bool) { slot = static_cast<::blink::mojom::HeavyAdReason>(-1000001); }
    static bool IsDeletedValue(const ::blink::mojom::HeavyAdReason& value) { return value == static_cast<::blink::mojom::HeavyAdReason>(-1000001); }
};
} // namespace WTF
namespace WTF {
struct blink_mojom_internal_MixedContentResolutionStatus_DataHashFn {
    ...
    static bool Equal(const ::blink::mojom::MixedContentResolutionStatus& left, const ::blink::mojom::MixedContentResolutionStatus& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::blink::mojom::MixedContentResolutionStatus> : public GenericHashTraits<::blink::mojom::MixedContentResolutionStatus> {
    static_assert(true, "-1000000 is a reserved enum value");
    static_assert(true, "-1000001 is a reserved enum value");
    static const bool kEmptyValueIsZero = false;
    ...
    static void ConstructDeletedValue(::blink::mojom::MixedContentResolutionStatus& slot, bool) { slot = static_cast<::blink::mojom::MixedContentResolutionStatus>(-1000001); }
    static bool IsDeletedValue(const ::blink::mojom::MixedContentResolutionStatus& value) { return value == static_cast<::blink::mojom::MixedContentResolutionStatus>(-1000001); }
};
} // namespace WTF
namespace WTF {
struct blink_mojom_internal_ContentSecurityPolicyViolationType_DataHashFn {
    ...
    static bool Equal(const ::blink::mojom::ContentSecurityPolicyViolationType& left, const ::blink::mojom::ContentSecurityPolicyViolationType& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::blink::mojom::ContentSecurityPolicyViolationType> : public GenericHashTraits<::blink::mojom::ContentSecurityPolicyViolationType> {
    static_assert(true, "-1000000 is a reserved enum value");
    static_assert(true, "-1000001 is a reserved enum value");
    static const bool kEmptyValueIsZero = false;
...
struct blink_mojom_internal_CookieOperation_DataHashFn {
    ...
    static bool Equal(const ::blink::mojom::CookieOperation& left, const ::blink::mojom::CookieOperation& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::blink::mojom::CookieOperation> : public GenericHashTraits<::blink::mojom::CookieOperation> {
    static_assert(true, "-1000000 is a reserved enum value");
    static_assert(true, "-1000001 is a reserved enum value");
    static const bool kEmptyValueIsZero = false;
    static ::blink::mojom::CookieOperation EmptyValue() { return static_cast<::blink::mojom::CookieOperation>(-1000000); }
    static void ConstructDeletedValue(::blink::mojom::CookieOperation& slot, bool) { slot = static_cast<::blink::mojom::CookieOperation>(-1000001); }
    static bool IsDeletedValue(const ::blink::mojom::CookieOperation& value) { return value == static_cast<::blink::mojom::CookieOperation>(-1000001); }
};
} // namespace WTF
namespace WTF {
struct blink_mojom_internal_CookieExclusionReason_DataHashFn {
    ...
    static bool Equal(const ::blink::mojom::CookieExclusionReason& left, const ::blink::mojom::CookieExclusionReason& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::blink::mojom::CookieExclusionReason> : public GenericHashTraits<::blink::mojom::CookieExclusionReason> {
    static_assert(true, "-1000000 is a reserved enum value");
    static_assert(true, "-1000001 is a reserved enum value");
    static const bool kEmptyValueIsZero = false;
    static ::blink::mojom::CookieExclusionReason EmptyValue() { return static_cast<::blink::mojom::CookieExclusionReason>(-1000000); }
    static void ConstructDeletedValue(::blink::mojom::CookieExclusionReason& slot, bool) { slot = static_cast<::blink::mojom::CookieExclusionReason>(-1000001); }
    static bool IsDeletedValue(const ::blink::mojom::CookieExclusionReason& value) { return value == static_cast<::blink::mojom::CookieExclusionReason>(-1000001); }
};
} // namespace WTF
namespace WTF {
struct blink_mojom_internal_CookieWarningReason_DataHashFn {
    ...
    static bool Equal(const ::blink::mojom::CookieWarningReason& left, const ::blink::mojom::CookieWarningReason& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::blink::mojom::CookieWarningReason> : public GenericHashTraits<::blink::mojom::CookieWarningReason> {
    static_assert(true, "-1000000 is a reserved enum value");
    static_assert(true, "-1000001 is a reserved enum value");
    static const bool kEmptyValueIsZero = false;
    static ::blink::mojom::CookieWarningReason EmptyValue() { return static_cast<::blink::mojom::CookieWarningReason>(-1000000); }
    static void ConstructDeletedValue(::blink::mojom::CookieWarningReason& slot, bool) { slot = static_cast<::blink::mojom::CookieWarningReason>(-1000001); }
    static bool IsDeletedValue(const ::blink::mojom::CookieWarningReason& value) { return value == static_cast<::blink::mojom::CookieWarningReason>(-1000001); }
};
} // namespace WTF
namespace WTF {
struct blink_mojom_internal_SharedArrayBufferIssueType_DataHashFn {
    ...
    static bool Equal(const ::blink::mojom::SharedArrayBufferIssueType& left, const ::blink::mojom::SharedArrayBufferIssueType& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::blink::mojom::SharedArrayBufferIssueType> : public GenericHashTraits<::blink::mojom::SharedArrayBufferIssueType> {
    static_assert(true, "-1000000 is a reserved enum value");
    static_assert(true, "-1000001 is a reserved enum value");
    static const bool kEmptyValueIsZero = false;
    ...
    static void ConstructDeletedValue(::blink::mojom::SharedArrayBufferIssueType& slot, bool) { slot = static_cast<::blink::mojom::SharedArrayBufferIssueType>(-1000001); }
    static bool IsDeletedValue(const ::blink::mojom::SharedArrayBufferIssueType& value) { return value == static_cast<::blink::mojom::SharedArrayBufferIssueType>(-1000001); }
};
} // namespace WTF
namespace WTF {
struct blink_mojom_internal_TwaQualityEnforcementViolationType_DataHashFn {
    ...
    static bool Equal(const ::blink::mojom::TwaQualityEnforcementViolationType& left, const ::blink::mojom::TwaQualityEnforcementViolationType& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::blink::mojom::TwaQualityEnforcementViolationType> : public GenericHashTraits<::blink::mojom::TwaQualityEnforcementViolationType> {
    static_assert(true, "-1000000 is a reserved enum value");
    static_assert(true, "-1000001 is a reserved enum value");
    static const bool kEmptyValueIsZero = false;
...
struct blink_mojom_internal_FederatedAuthRequestResult_DataHashFn {
    ...
    static bool Equal(const ::blink::mojom::FederatedAuthRequestResult& left, const ::blink::mojom::FederatedAuthRequestResult& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::blink::mojom::FederatedAuthRequestResult> : public GenericHashTraits<::blink::mojom::FederatedAuthRequestResult> {
    static_assert(true, "-1000000 is a reserved enum value");
    static_assert(true, "-1000001 is a reserved enum value");
    static const bool kEmptyValueIsZero = false;
    ...
    static void ConstructDeletedValue(::blink::mojom::FederatedAuthRequestResult& slot, bool) { slot = static_cast<::blink::mojom::FederatedAuthRequestResult>(-1000001); }
    static bool IsDeletedValue(const ::blink::mojom::FederatedAuthRequestResult& value) { return value == static_cast<::blink::mojom::FederatedAuthRequestResult>(-1000001); }
};
} // namespace WTF
namespace WTF {
struct blink_mojom_internal_GenericIssueErrorType_DataHashFn {
    ...
    static bool Equal(const ::blink::mojom::GenericIssueErrorType& left, const ::blink::mojom::GenericIssueErrorType& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::blink::mojom::GenericIssueErrorType> : public GenericHashTraits<::blink::mojom::GenericIssueErrorType> {
    static_assert(true, "-1000000 is a reserved enum value");
    static_assert(true, "-1000001 is a reserved enum value");
    static const bool kEmptyValueIsZero = false;
    static ::blink::mojom::GenericIssueErrorType EmptyValue() { return static_cast<::blink::mojom::GenericIssueErrorType>(-1000000); }
    static void ConstructDeletedValue(::blink::mojom::GenericIssueErrorType& slot, bool) { slot = static_cast<::blink::mojom::GenericIssueErrorType>(-1000001); }
    static bool IsDeletedValue(const ::blink::mojom::GenericIssueErrorType& value) { return value == static_cast<::blink::mojom::GenericIssueErrorType>(-1000001); }
};
} // namespace WTF
namespace blink {
namespace mojom {
...
public:
    ...
    template <typename... Args> static AffectedCookiePtr New(Args&&... args) { return AffectedCookiePtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static AffectedCookiePtr From(const U& u) { return mojo::TypeConverter<AffectedCookiePtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, AffectedCookie>::Convert(*this); }
    AffectedCookie()
        : name()
        , path()
        , domain()
    ...
    template <typename T, AffectedCookie::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    ...
    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<AffectedCookie::DataView>(input); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::AffectedCookie_UnserializedMessageContext<UserType, AffectedCookie::DataView>>(0, 0, std::move(input)), MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    {
        return AffectedCookie::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, AffectedCookie::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, AffectedCookie::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, AffectedCookie::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static AffectedRequestPtr New(Args&&... args) { return AffectedRequestPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static AffectedRequestPtr From(const U& u) { return mojo::TypeConverter<AffectedRequestPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, AffectedRequest>::Convert(*this); }
    AffectedRequest()
        : request_id()
        , url()
    {
    ...
    template <typename T, AffectedRequest::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static WTF::Vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<AffectedRequest::DataView, WTF::Vector<uint8_t>>(input);
    }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<AffectedRequest::DataView>(input); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::AffectedRequest_UnserializedMessageContext<UserType, AffectedRequest::DataView>>(0, 0, std::move(input)), MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const WTF::Vector<uint8_t>& input, UserType* output)
    {
        return AffectedRequest::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, AffectedRequest::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, AffectedRequest::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, AffectedRequest::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static AffectedFramePtr New(Args&&... args) { return AffectedFramePtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static AffectedFramePtr From(const U& u) { return mojo::TypeConverter<AffectedFramePtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, AffectedFrame>::Convert(*this); }
    AffectedFrame()
        : frame_id()
    {
    }
    ...
    template <typename T, AffectedFrame::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    size_t Hash(size_t seed) const;
    template <typename UserType> static WTF::Vector<uint8_t> Serialize(UserType* input)
    {
    ...
    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<AffectedFrame::DataView>(input); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::AffectedFrame_UnserializedMessageContext<UserType, AffectedFrame::DataView>>(0, 0, std::move(input)), MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const WTF::Vector<uint8_t>& input, UserType* output)
    {
        return AffectedFrame::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, AffectedFrame::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, AffectedFrame::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, AffectedFrame::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static AffectedLocationPtr New(Args&&... args) { return AffectedLocationPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static AffectedLocationPtr From(const U& u) { return mojo::TypeConverter<AffectedLocationPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, AffectedLocation>::Convert(*this); }
    AffectedLocation()
        : script_id()
        , url()
        , line(0U)
    ...
    template <typename T, AffectedLocation::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static WTF::Vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<AffectedLocation::DataView, WTF::Vector<uint8_t>>(input);
    }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<AffectedLocation::DataView>(input); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::AffectedLocation_UnserializedMessageContext<UserType, AffectedLocation::DataView>>(0, 0, std::move(input)), MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const WTF::Vector<uint8_t>& input, UserType* output)
    {
        return AffectedLocation::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, AffectedLocation::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, AffectedLocation::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, AffectedLocation::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    {
        return FederatedAuthRequestIssueDetailsPtr(absl::in_place, std::forward<Args>(args)...);
    }

    template <typename U> static FederatedAuthRequestIssueDetailsPtr From(const U& u) { return mojo::TypeConverter<FederatedAuthRequestIssueDetailsPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, FederatedAuthRequestIssueDetails>::Convert(*this); }
    ...
    template <typename T, FederatedAuthRequestIssueDetails::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    size_t Hash(size_t seed) const;
    template <typename UserType> static WTF::Vector<uint8_t> Serialize(UserType* input)
    {
    ...
    {
        return mojo::Message(
            std::make_unique<internal::FederatedAuthRequestIssueDetails_UnserializedMessageContext<UserType, FederatedAuthRequestIssueDetails::DataView>>(0, 0, std::move(input)),
    ...
    template <typename UserType> static bool Deserialize(const WTF::Vector<uint8_t>& input, UserType* output)
    {
        return FederatedAuthRequestIssueDetails::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }

    template <typename UserType> static bool DeserializeFromMessage(mojo::Message input, UserType* output)
    {
        auto context = input.TakeUnserializedContext<internal::FederatedAuthRequestIssueDetails_UnserializedMessageContext<UserType, FederatedAuthRequestIssueDetails::DataView>>();
        if (context) {
            *output = std::move(context->TakeData());
            return true;
        }
...
template <typename T, FederatedAuthRequestIssueDetails::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, FederatedAuthRequestIssueDetails::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, FederatedAuthRequestIssueDetails::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static GenericIssueDetailsPtr New(Args&&... args) { return GenericIssueDetailsPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static GenericIssueDetailsPtr From(const U& u) { return mojo::TypeConverter<GenericIssueDetailsPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, GenericIssueDetails>::Convert(*this); }
    GenericIssueDetails()
        : error_type()
        , frame_id()
    {
    ...
    GenericIssueDetails(GenericIssueErrorType error_type_in, const WTF::String& frame_id_in)
    ...
    template <typename T, GenericIssueDetails::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static WTF::Vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<GenericIssueDetails::DataView, WTF::Vector<uint8_t>>(input);
    }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<GenericIssueDetails::DataView>(input); }
    ...
    template <typename UserType> static mojo::Message WrapAsMessage(UserType input)
    {
        return mojo::Message(std::make_unique<internal::GenericIssueDetails_UnserializedMessageContext<UserType, GenericIssueDetails::DataView>>(0, 0, std::move(input)),
            MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const WTF::Vector<uint8_t>& input, UserType* output)
    {
        return GenericIssueDetails::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, GenericIssueDetails::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, GenericIssueDetails::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, GenericIssueDetails::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    {
        return BlockedByResponseIssueDetailsPtr(absl::in_place, std::forward<Args>(args)...);
    }

    template <typename U> static BlockedByResponseIssueDetailsPtr From(const U& u) { return mojo::TypeConverter<BlockedByResponseIssueDetailsPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, BlockedByResponseIssueDetails>::Convert(*this); }
    ...
    BlockedByResponseIssueDetails(
        AffectedRequestPtr request_in, AffectedFramePtr parentFrame_in, AffectedFramePtr blockedFrame_in, ::network::mojom::blink::BlockedByResponseReason reason_in)
    ...
    template <typename T, BlockedByResponseIssueDetails::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static WTF::Vector<uint8_t> Serialize(UserType* input)
    {
    ...
    {
        return mojo::Message(
            std::make_unique<internal::BlockedByResponseIssueDetails_UnserializedMessageContext<UserType, BlockedByResponseIssueDetails::DataView>>(0, 0, std::move(input)),
            MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const WTF::Vector<uint8_t>& input, UserType* output)
    {
        return BlockedByResponseIssueDetails::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }

    template <typename UserType> static bool DeserializeFromMessage(mojo::Message input, UserType* output)
    {
        auto context = input.TakeUnserializedContext<internal::BlockedByResponseIssueDetails_UnserializedMessageContext<UserType, BlockedByResponseIssueDetails::DataView>>();
        if (context) {
            *output = std::move(context->TakeData());
            return true;
        }
...
template <typename T, BlockedByResponseIssueDetails::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, BlockedByResponseIssueDetails::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, BlockedByResponseIssueDetails::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static HeavyAdIssueDetailsPtr New(Args&&... args) { return HeavyAdIssueDetailsPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static HeavyAdIssueDetailsPtr From(const U& u) { return mojo::TypeConverter<HeavyAdIssueDetailsPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, HeavyAdIssueDetails>::Convert(*this); }
    HeavyAdIssueDetails()
        : resolution()
        , reason()
        , frame()
    ...
    template <typename T, HeavyAdIssueDetails::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    size_t Hash(size_t seed) const;
    template <typename UserType> static WTF::Vector<uint8_t> Serialize(UserType* input)
    {
    ...
    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<HeavyAdIssueDetails::DataView>(input); }
    ...
    template <typename UserType> static mojo::Message WrapAsMessage(UserType input)
    {
        return mojo::Message(std::make_unique<internal::HeavyAdIssueDetails_UnserializedMessageContext<UserType, HeavyAdIssueDetails::DataView>>(0, 0, std::move(input)),
            MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const WTF::Vector<uint8_t>& input, UserType* output)
    {
        return HeavyAdIssueDetails::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, HeavyAdIssueDetails::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, HeavyAdIssueDetails::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, HeavyAdIssueDetails::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static MixedContentIssueDetailsPtr New(Args&&... args) { return MixedContentIssueDetailsPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static MixedContentIssueDetailsPtr From(const U& u) { return mojo::TypeConverter<MixedContentIssueDetailsPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, MixedContentIssueDetails>::Convert(*this); }
    ...
    MixedContentIssueDetails(::blink::mojom::blink::RequestContextType request_context_in, MixedContentResolutionStatus resolution_status_in, const WTF::String& insecure_url_in,
        const WTF::String& main_resource_url_in, AffectedRequestPtr request_in, AffectedFramePtr frame_in)
    ...
    template <typename T, MixedContentIssueDetails::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static WTF::Vector<uint8_t> Serialize(UserType* input)
    {
    ...
    template <typename UserType> static mojo::Message WrapAsMessage(UserType input)
    {
        return mojo::Message(std::make_unique<internal::MixedContentIssueDetails_UnserializedMessageContext<UserType, MixedContentIssueDetails::DataView>>(0, 0, std::move(input)),
            MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const WTF::Vector<uint8_t>& input, UserType* output)
    {
        return MixedContentIssueDetails::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }

    template <typename UserType> static bool DeserializeFromMessage(mojo::Message input, UserType* output)
    {
        auto context = input.TakeUnserializedContext<internal::MixedContentIssueDetails_UnserializedMessageContext<UserType, MixedContentIssueDetails::DataView>>();
        if (context) {
            *output = std::move(context->TakeData());
            return true;
        }
...
template <typename T, MixedContentIssueDetails::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, MixedContentIssueDetails::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, MixedContentIssueDetails::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    {
        return ContentSecurityPolicyIssueDetailsPtr(absl::in_place, std::forward<Args>(args)...);
    }

    template <typename U> static ContentSecurityPolicyIssueDetailsPtr From(const U& u) { return mojo::TypeConverter<ContentSecurityPolicyIssueDetailsPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, ContentSecurityPolicyIssueDetails>::Convert(*this); }
    ...
    ContentSecurityPolicyIssueDetails(const absl::optional<::blink::KURL>& blocked_url_in, const WTF::String& violated_directive_in, bool is_report_only_in,
        ContentSecurityPolicyViolationType content_security_policy_violation_type_in, AffectedFramePtr frame_ancestor_in, AffectedLocationPtr affected_location_in,
    ...
    template <typename T, ContentSecurityPolicyIssueDetails::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static WTF::Vector<uint8_t> Serialize(UserType* input)
    {
    ...
    {
        return mojo::Message(
            std::make_unique<internal::ContentSecurityPolicyIssueDetails_UnserializedMessageContext<UserType, ContentSecurityPolicyIssueDetails::DataView>>(0, 0, std::move(input)),
            MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const WTF::Vector<uint8_t>& input, UserType* output)
    {
        return ContentSecurityPolicyIssueDetails::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }

    template <typename UserType> static bool DeserializeFromMessage(mojo::Message input, UserType* output)
    {
        auto context
            = input.TakeUnserializedContext<internal::ContentSecurityPolicyIssueDetails_UnserializedMessageContext<UserType, ContentSecurityPolicyIssueDetails::DataView>>();
        if (context) {
            *output = std::move(context->TakeData());
            return true;
        }
        input.SerializeIfNecessary();
        return mojo::internal::DeserializeImpl<ContentSecurityPolicyIssueDetails::DataView>(input, input.payload(), input.payload_num_bytes(), output, Validate);
    }
...
template <typename T, ContentSecurityPolicyIssueDetails::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, ContentSecurityPolicyIssueDetails::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, ContentSecurityPolicyIssueDetails::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static CookieIssueDetailsPtr New(Args&&... args) { return CookieIssueDetailsPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static CookieIssueDetailsPtr From(const U& u) { return mojo::TypeConverter<CookieIssueDetailsPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, CookieIssueDetails>::Convert(*this); }
    CookieIssueDetails()
        : cookie()
        , exclusion_reason()
        , warning_reason()
    ...
    CookieIssueDetails(AffectedCookiePtr cookie_in, WTF::Vector<CookieExclusionReason> exclusion_reason_in, WTF::Vector<CookieWarningReason> warning_reason_in,
        CookieOperation operation_in, const absl::optional<::blink::KURL>& site_for_cookies_in, const absl::optional<::blink::KURL>& cookie_url_in, AffectedRequestPtr request_in)
    ...
    template <typename T, CookieIssueDetails::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static WTF::Vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<CookieIssueDetails::DataView, WTF::Vector<uint8_t>>(input);
    }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<CookieIssueDetails::DataView>(input); }
    ...
    template <typename UserType> static mojo::Message WrapAsMessage(UserType input)
    {
        return mojo::Message(std::make_unique<internal::CookieIssueDetails_UnserializedMessageContext<UserType, CookieIssueDetails::DataView>>(0, 0, std::move(input)),
            MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const WTF::Vector<uint8_t>& input, UserType* output)
    {
        return CookieIssueDetails::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, CookieIssueDetails::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, CookieIssueDetails::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, CookieIssueDetails::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    {
        return SharedArrayBufferIssueDetailsPtr(absl::in_place, std::forward<Args>(args)...);
    }

    template <typename U> static SharedArrayBufferIssueDetailsPtr From(const U& u) { return mojo::TypeConverter<SharedArrayBufferIssueDetailsPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, SharedArrayBufferIssueDetails>::Convert(*this); }
    ...
    template <typename T, SharedArrayBufferIssueDetails::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static WTF::Vector<uint8_t> Serialize(UserType* input)
    {
    ...
    {
        return mojo::Message(
            std::make_unique<internal::SharedArrayBufferIssueDetails_UnserializedMessageContext<UserType, SharedArrayBufferIssueDetails::DataView>>(0, 0, std::move(input)),
            MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const WTF::Vector<uint8_t>& input, UserType* output)
    {
        return SharedArrayBufferIssueDetails::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }

    template <typename UserType> static bool DeserializeFromMessage(mojo::Message input, UserType* output)
    {
        auto context = input.TakeUnserializedContext<internal::SharedArrayBufferIssueDetails_UnserializedMessageContext<UserType, SharedArrayBufferIssueDetails::DataView>>();
        if (context) {
            *output = std::move(context->TakeData());
            return true;
        }
...
template <typename T, SharedArrayBufferIssueDetails::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, SharedArrayBufferIssueDetails::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, SharedArrayBufferIssueDetails::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }

class PLATFORM_EXPORT TrustedWebActivityIssueDetails {
public:
    template <typename T> using EnableIfSame = std::enable_if_t<std::is_same<TrustedWebActivityIssueDetails, T>::value>;
    using DataView = TrustedWebActivityIssueDetailsDataView;
    using Data_ = internal::TrustedWebActivityIssueDetails_Data;

    template <typename... Args> static TrustedWebActivityIssueDetailsPtr New(Args&&... args)
    {
        return TrustedWebActivityIssueDetailsPtr(absl::in_place, std::forward<Args>(args)...);
    }

    template <typename U> static TrustedWebActivityIssueDetailsPtr From(const U& u) { return mojo::TypeConverter<TrustedWebActivityIssueDetailsPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, TrustedWebActivityIssueDetails>::Convert(*this); }
    ...
    TrustedWebActivityIssueDetails(const ::blink::KURL& url_in, TwaQualityEnforcementViolationType violation_type_in, int32_t http_error_code_in,
        const WTF::String& package_name_in, const WTF::String& signature_in)
        : url(std::move(url_in))
    ...
    ~TrustedWebActivityIssueDetails() = default;

    // Clone() is a template so it is only instantiated if it is used. Thus, the
    // bindings generator does not need to know whether Clone() or copy
    // constructor/assignment are available for members.
    template <typename StructPtrType = TrustedWebActivityIssueDetailsPtr> TrustedWebActivityIssueDetailsPtr Clone() const;

    // Equals() is a template so it is only instantiated if it is used. Thus, the
    // bindings generator does not need to know whether Equals() or == operator
    // are available for members.
    template <typename T, TrustedWebActivityIssueDetails::EnableIfSame<T>* = nullptr> bool Equals(const T& other) const;

    template <typename T, TrustedWebActivityIssueDetails::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static WTF::Vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<TrustedWebActivityIssueDetails::DataView, WTF::Vector<uint8_t>>(input);
    }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input)
    {
        return mojo::internal::SerializeAsMessageImpl<TrustedWebActivityIssueDetails::DataView>(input);
    }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::TrustedWebActivityIssueDetails_UnserializedMessageContext<UserType, TrustedWebActivityIssueDetails::DataView>>(0, 0, std::move(input)),
            MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    {
        mojo::Message message;
        return mojo::internal::DeserializeImpl<TrustedWebActivityIssueDetails::DataView>(message, data, data_num_bytes, output, Validate);
    }

    template <typename UserType> static bool Deserialize(const WTF::Vector<uint8_t>& input, UserType* output)
    {
        return TrustedWebActivityIssueDetails::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }

    template <typename UserType> static bool DeserializeFromMessage(mojo::Message input, UserType* output)
    {
        auto context = input.TakeUnserializedContext<internal::TrustedWebActivityIssueDetails_UnserializedMessageContext<UserType, TrustedWebActivityIssueDetails::DataView>>();
        if (context) {
            *output = std::move(context->TakeData());
            return true;
        }
        input.SerializeIfNecessary();
        return mojo::internal::DeserializeImpl<TrustedWebActivityIssueDetails::DataView>(input, input.payload(), input.payload_num_bytes(), output, Validate);
    }
...
// are used. Thus, the bindings generator does not need to know whether
// comparison operators are available for members.
template <typename T, TrustedWebActivityIssueDetails::EnableIfSame<T>* = nullptr> bool operator<(const T& lhs, const T& rhs);

template <typename T, TrustedWebActivityIssueDetails::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, TrustedWebActivityIssueDetails::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, TrustedWebActivityIssueDetails::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static LowTextContrastIssuePtr New(Args&&... args) { return LowTextContrastIssuePtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static LowTextContrastIssuePtr From(const U& u) { return mojo::TypeConverter<LowTextContrastIssuePtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, LowTextContrastIssue>::Convert(*this); }
    ...
    LowTextContrastIssue(int32_t violating_node_id_in, const WTF::String& violating_node_selector_in, float contrast_ratio_in, float threshold_aa_in, float threshold_aaa_in,
        const WTF::String& font_size_in, const WTF::String& font_weight_in)
        : violating_node_id(std::move(violating_node_id_in))
    ...
    template <typename T, LowTextContrastIssue::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    size_t Hash(size_t seed) const;
    template <typename UserType> static WTF::Vector<uint8_t> Serialize(UserType* input)
    {
    ...
    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<LowTextContrastIssue::DataView>(input); }
    ...
    template <typename UserType> static mojo::Message WrapAsMessage(UserType input)
    {
        return mojo::Message(std::make_unique<internal::LowTextContrastIssue_UnserializedMessageContext<UserType, LowTextContrastIssue::DataView>>(0, 0, std::move(input)),
            MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const WTF::Vector<uint8_t>& input, UserType* output)
    {
        return LowTextContrastIssue::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, LowTextContrastIssue::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, LowTextContrastIssue::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, LowTextContrastIssue::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static InspectorIssueDetailsPtr New(Args&&... args) { return InspectorIssueDetailsPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static InspectorIssueDetailsPtr From(const U& u) { return mojo::TypeConverter<InspectorIssueDetailsPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, InspectorIssueDetails>::Convert(*this); }
    ...
    InspectorIssueDetails(CookieIssueDetailsPtr cookie_issue_details_in, MixedContentIssueDetailsPtr mixed_content_issue_details_in,
        ...
        SharedArrayBufferIssueDetailsPtr sab_issue_details_in, TrustedWebActivityIssueDetailsPtr twa_issue_details_in, HeavyAdIssueDetailsPtr heavy_ad_issue_details_in,
        LowTextContrastIssuePtr low_text_contrast_details_in, FederatedAuthRequestIssueDetailsPtr federated_auth_request_details_in,
        GenericIssueDetailsPtr generic_issue_details_in, const absl::optional<::base::UnguessableToken>& issue_id_in)
    ...
    template <typename T, InspectorIssueDetails::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static WTF::Vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<InspectorIssueDetails::DataView, WTF::Vector<uint8_t>>(input);
    }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<InspectorIssueDetails::DataView>(input); }
    ...
    template <typename UserType> static mojo::Message WrapAsMessage(UserType input)
    {
        return mojo::Message(std::make_unique<internal::InspectorIssueDetails_UnserializedMessageContext<UserType, InspectorIssueDetails::DataView>>(0, 0, std::move(input)),
            MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const WTF::Vector<uint8_t>& input, UserType* output)
    {
        return InspectorIssueDetails::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, InspectorIssueDetails::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, InspectorIssueDetails::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, InspectorIssueDetails::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static InspectorIssueInfoPtr New(Args&&... args) { return InspectorIssueInfoPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static InspectorIssueInfoPtr From(const U& u) { return mojo::TypeConverter<InspectorIssueInfoPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, InspectorIssueInfo>::Convert(*this); }
    InspectorIssueInfo()
        : code()
        , details()
    {
    ...
    template <typename T, InspectorIssueInfo::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static WTF::Vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<InspectorIssueInfo::DataView, WTF::Vector<uint8_t>>(input);
    }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<InspectorIssueInfo::DataView>(input); }
    ...
    template <typename UserType> static mojo::Message WrapAsMessage(UserType input)
    {
        return mojo::Message(std::make_unique<internal::InspectorIssueInfo_UnserializedMessageContext<UserType, InspectorIssueInfo::DataView>>(0, 0, std::move(input)),
            MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const WTF::Vector<uint8_t>& input, UserType* output)
    {
        return InspectorIssueInfo::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, InspectorIssueInfo::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, InspectorIssueInfo::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, InspectorIssueInfo::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }

template <typename StructPtrType> AffectedCookiePtr AffectedCookie::Clone() const { return New(mojo::Clone(name), mojo::Clone(path), mojo::Clone(domain)); }
...
template <typename StructPtrType> AffectedRequestPtr AffectedRequest::Clone() const { return New(mojo::Clone(request_id), mojo::Clone(url)); }
...
template <typename StructPtrType> AffectedFramePtr AffectedFrame::Clone() const { return New(mojo::Clone(frame_id)); }
...
template <typename StructPtrType> HeavyAdIssueDetailsPtr HeavyAdIssueDetails::Clone() const { return New(mojo::Clone(resolution), mojo::Clone(reason), mojo::Clone(frame)); }
...
{
    return New(mojo::Clone(request_context), mojo::Clone(resolution_status), mojo::Clone(insecure_url), mojo::Clone(main_resource_url), mojo::Clone(request), mojo::Clone(frame));
}
...
{
    return New(mojo::Clone(cookie), mojo::Clone(exclusion_reason), mojo::Clone(warning_reason), mojo::Clone(operation), mojo::Clone(site_for_cookies), mojo::Clone(cookie_url),
        mojo::Clone(request));
}
...
template <typename StructPtrType> TrustedWebActivityIssueDetailsPtr TrustedWebActivityIssueDetails::Clone() const
{
    return New(mojo::Clone(url), mojo::Clone(violation_type), mojo::Clone(http_error_code), mojo::Clone(package_name), mojo::Clone(signature));
}

template <typename T, TrustedWebActivityIssueDetails::EnableIfSame<T>*> bool TrustedWebActivityIssueDetails::Equals(const T& other_struct) const
{
    if (!mojo::Equals(this->url, other_struct.url))
        return false;
...
template <typename T, TrustedWebActivityIssueDetails::EnableIfSame<T>*> bool operator<(const T& lhs, const T& rhs)
{
    if (lhs.url < rhs.url)
        return true;
    if (rhs.url < lhs.url)
...
{
    return New(mojo::Clone(violating_node_id), mojo::Clone(violating_node_selector), mojo::Clone(contrast_ratio), mojo::Clone(threshold_aa), mojo::Clone(threshold_aaa),
        mojo::Clone(font_size), mojo::Clone(font_weight));
}
...
template <typename StructPtrType> FederatedAuthRequestIssueDetailsPtr FederatedAuthRequestIssueDetails::Clone() const { return New(mojo::Clone(status)); }
...
template <typename StructPtrType> GenericIssueDetailsPtr GenericIssueDetails::Clone() const { return New(mojo::Clone(error_type), mojo::Clone(frame_id)); }
...
{
    return New(mojo::Clone(cookie_issue_details), mojo::Clone(mixed_content_issue_details), mojo::Clone(blocked_by_response_issue_details), mojo::Clone(csp_issue_details),
        mojo::Clone(sab_issue_details), mojo::Clone(twa_issue_details), mojo::Clone(heavy_ad_issue_details), mojo::Clone(low_text_contrast_details),
        mojo::Clone(federated_auth_request_details), mojo::Clone(generic_issue_details), mojo::Clone(issue_id));
}
...
template <typename StructPtrType> InspectorIssueInfoPtr InspectorIssueInfo::Clone() const { return New(mojo::Clone(code), mojo::Clone(details)); }
...
template <> struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::AffectedCookie::DataView, ::blink::mojom::blink::AffectedCookiePtr> {
    ...
    static const decltype(::blink::mojom::blink::AffectedCookie::name)& name(const ::blink::mojom::blink::AffectedCookiePtr& input) { return input->name; }

    static const decltype(::blink::mojom::blink::AffectedCookie::path)& path(const ::blink::mojom::blink::AffectedCookiePtr& input) { return input->path; }

    static const decltype(::blink::mojom::blink::AffectedCookie::domain)& domain(const ::blink::mojom::blink::AffectedCookiePtr& input) { return input->domain; }
...
template <> struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::AffectedRequest::DataView, ::blink::mojom::blink::AffectedRequestPtr> {
    ...
    static const decltype(::blink::mojom::blink::AffectedRequest::request_id)& request_id(const ::blink::mojom::blink::AffectedRequestPtr& input) { return input->request_id; }

    static const decltype(::blink::mojom::blink::AffectedRequest::url)& url(const ::blink::mojom::blink::AffectedRequestPtr& input) { return input->url; }
...
template <> struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::AffectedFrame::DataView, ::blink::mojom::blink::AffectedFramePtr> {
    ...
    static const decltype(::blink::mojom::blink::AffectedFrame::frame_id)& frame_id(const ::blink::mojom::blink::AffectedFramePtr& input) { return input->frame_id; }
...
template <> struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::AffectedLocation::DataView, ::blink::mojom::blink::AffectedLocationPtr> {
    ...
    static const decltype(::blink::mojom::blink::AffectedLocation::script_id)& script_id(const ::blink::mojom::blink::AffectedLocationPtr& input) { return input->script_id; }

    static const decltype(::blink::mojom::blink::AffectedLocation::url)& url(const ::blink::mojom::blink::AffectedLocationPtr& input) { return input->url; }

    static decltype(::blink::mojom::blink::AffectedLocation::line) line(const ::blink::mojom::blink::AffectedLocationPtr& input) { return input->line; }

    static decltype(::blink::mojom::blink::AffectedLocation::column) column(const ::blink::mojom::blink::AffectedLocationPtr& input) { return input->column; }

    static bool Read(::blink::mojom::blink::AffectedLocation::DataView input, ::blink::mojom::blink::AffectedLocationPtr* output);
};
template <> struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::BlockedByResponseIssueDetails::DataView, ::blink::mojom::blink::BlockedByResponseIssueDetailsPtr> {
    ...
    static const decltype(::blink::mojom::blink::BlockedByResponseIssueDetails::request)& request(const ::blink::mojom::blink::BlockedByResponseIssueDetailsPtr& input)
    {
        return input->request;
    }

    static const decltype(::blink::mojom::blink::BlockedByResponseIssueDetails::parentFrame)& parentFrame(const ::blink::mojom::blink::BlockedByResponseIssueDetailsPtr& input)
    {
        return input->parentFrame;
    }

    static const decltype(::blink::mojom::blink::BlockedByResponseIssueDetails::blockedFrame)& blockedFrame(const ::blink::mojom::blink::BlockedByResponseIssueDetailsPtr& input)
    {
...
template <> struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::HeavyAdIssueDetails::DataView, ::blink::mojom::blink::HeavyAdIssueDetailsPtr> {
    ...
    static decltype(::blink::mojom::blink::HeavyAdIssueDetails::resolution) resolution(const ::blink::mojom::blink::HeavyAdIssueDetailsPtr& input) { return input->resolution; }

    static decltype(::blink::mojom::blink::HeavyAdIssueDetails::reason) reason(const ::blink::mojom::blink::HeavyAdIssueDetailsPtr& input) { return input->reason; }

    static const decltype(::blink::mojom::blink::HeavyAdIssueDetails::frame)& frame(const ::blink::mojom::blink::HeavyAdIssueDetailsPtr& input) { return input->frame; }
...
template <> struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::MixedContentIssueDetails::DataView, ::blink::mojom::blink::MixedContentIssueDetailsPtr> {
    ...
    static decltype(::blink::mojom::blink::MixedContentIssueDetails::request_context) request_context(const ::blink::mojom::blink::MixedContentIssueDetailsPtr& input)
    {
        return input->request_context;
    }

    static decltype(::blink::mojom::blink::MixedContentIssueDetails::resolution_status) resolution_status(const ::blink::mojom::blink::MixedContentIssueDetailsPtr& input)
    {
        return input->resolution_status;
    }

    static const decltype(::blink::mojom::blink::MixedContentIssueDetails::insecure_url)& insecure_url(const ::blink::mojom::blink::MixedContentIssueDetailsPtr& input)
    {
        return input->insecure_url;
    }

    static const decltype(::blink::mojom::blink::MixedContentIssueDetails::main_resource_url)& main_resource_url(const ::blink::mojom::blink::MixedContentIssueDetailsPtr& input)
    {
    ...
    static const decltype(::blink::mojom::blink::MixedContentIssueDetails::frame)& frame(const ::blink::mojom::blink::MixedContentIssueDetailsPtr& input) { return input->frame; }
...
template <> struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::ContentSecurityPolicyIssueDetails::DataView, ::blink::mojom::blink::ContentSecurityPolicyIssueDetailsPtr> {
...
template <> struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::CookieIssueDetails::DataView, ::blink::mojom::blink::CookieIssueDetailsPtr> {
    ...
    static const decltype(::blink::mojom::blink::CookieIssueDetails::cookie)& cookie(const ::blink::mojom::blink::CookieIssueDetailsPtr& input) { return input->cookie; }

    static const decltype(::blink::mojom::blink::CookieIssueDetails::exclusion_reason)& exclusion_reason(const ::blink::mojom::blink::CookieIssueDetailsPtr& input)
    {
    ...
    static decltype(::blink::mojom::blink::CookieIssueDetails::operation) operation(const ::blink::mojom::blink::CookieIssueDetailsPtr& input) { return input->operation; }

    static const decltype(::blink::mojom::blink::CookieIssueDetails::site_for_cookies)& site_for_cookies(const ::blink::mojom::blink::CookieIssueDetailsPtr& input)
    {
    ...
    static const decltype(::blink::mojom::blink::CookieIssueDetails::request)& request(const ::blink::mojom::blink::CookieIssueDetailsPtr& input) { return input->request; }

    static bool Read(::blink::mojom::blink::CookieIssueDetails::DataView input, ::blink::mojom::blink::CookieIssueDetailsPtr* output);
};
template <> struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::SharedArrayBufferIssueDetails::DataView, ::blink::mojom::blink::SharedArrayBufferIssueDetailsPtr> {
    ...
    static decltype(::blink::mojom::blink::SharedArrayBufferIssueDetails::is_warning) is_warning(const ::blink::mojom::blink::SharedArrayBufferIssueDetailsPtr& input)
    {
        return input->is_warning;
    }

    static decltype(::blink::mojom::blink::SharedArrayBufferIssueDetails::type) type(const ::blink::mojom::blink::SharedArrayBufferIssueDetailsPtr& input) { return input->type; }
...
template <> struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::TrustedWebActivityIssueDetails::DataView, ::blink::mojom::blink::TrustedWebActivityIssueDetailsPtr> {
    ...
    static const decltype(::blink::mojom::blink::TrustedWebActivityIssueDetails::url)& url(const ::blink::mojom::blink::TrustedWebActivityIssueDetailsPtr& input)
    {
        return input->url;
    }

    static decltype(::blink::mojom::blink::TrustedWebActivityIssueDetails::violation_type) violation_type(const ::blink::mojom::blink::TrustedWebActivityIssueDetailsPtr& input)
    {
        return input->violation_type;
    }

    static decltype(::blink::mojom::blink::TrustedWebActivityIssueDetails::http_error_code) http_error_code(const ::blink::mojom::blink::TrustedWebActivityIssueDetailsPtr& input)
    {
        return input->http_error_code;
    }

    static const decltype(::blink::mojom::blink::TrustedWebActivityIssueDetails::package_name)& package_name(const ::blink::mojom::blink::TrustedWebActivityIssueDetailsPtr& input)
    {
        return input->package_name;
    }

    static const decltype(::blink::mojom::blink::TrustedWebActivityIssueDetails::signature)& signature(const ::blink::mojom::blink::TrustedWebActivityIssueDetailsPtr& input)
    {
...
template <> struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::LowTextContrastIssue::DataView, ::blink::mojom::blink::LowTextContrastIssuePtr> {
    ...
    static decltype(::blink::mojom::blink::LowTextContrastIssue::violating_node_id) violating_node_id(const ::blink::mojom::blink::LowTextContrastIssuePtr& input)
    {
        return input->violating_node_id;
    }
...
template <> struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::FederatedAuthRequestIssueDetails::DataView, ::blink::mojom::blink::FederatedAuthRequestIssueDetailsPtr> {
    ...
    static decltype(::blink::mojom::blink::FederatedAuthRequestIssueDetails::status) status(const ::blink::mojom::blink::FederatedAuthRequestIssueDetailsPtr& input)
    {
        return input->status;
    }
...
template <> struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::GenericIssueDetails::DataView, ::blink::mojom::blink::GenericIssueDetailsPtr> {
    ...
    static decltype(::blink::mojom::blink::GenericIssueDetails::error_type) error_type(const ::blink::mojom::blink::GenericIssueDetailsPtr& input) { return input->error_type; }

    static const decltype(::blink::mojom::blink::GenericIssueDetails::frame_id)& frame_id(const ::blink::mojom::blink::GenericIssueDetailsPtr& input) { return input->frame_id; }
...
template <> struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::InspectorIssueDetails::DataView, ::blink::mojom::blink::InspectorIssueDetailsPtr> {
    ...
    static const decltype(::blink::mojom::blink::InspectorIssueDetails::cookie_issue_details)& cookie_issue_details(const ::blink::mojom::blink::InspectorIssueDetailsPtr& input)
    {
    ...
    static const decltype(::blink::mojom::blink::InspectorIssueDetails::csp_issue_details)& csp_issue_details(const ::blink::mojom::blink::InspectorIssueDetailsPtr& input)
    {
        return input->csp_issue_details;
    }

    static const decltype(::blink::mojom::blink::InspectorIssueDetails::sab_issue_details)& sab_issue_details(const ::blink::mojom::blink::InspectorIssueDetailsPtr& input)
    {
        return input->sab_issue_details;
    }

    static const decltype(::blink::mojom::blink::InspectorIssueDetails::twa_issue_details)& twa_issue_details(const ::blink::mojom::blink::InspectorIssueDetailsPtr& input)
    {
    ...
    static const decltype(::blink::mojom::blink::InspectorIssueDetails::generic_issue_details)& generic_issue_details(const ::blink::mojom::blink::InspectorIssueDetailsPtr& input)
    {
...
template <> struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::InspectorIssueInfo::DataView, ::blink::mojom::blink::InspectorIssueInfoPtr> {
    ...
    static decltype(::blink::mojom::blink::InspectorIssueInfo::code) code(const ::blink::mojom::blink::InspectorIssueInfoPtr& input) { return input->code; }

    static const decltype(::blink::mojom::blink::InspectorIssueInfo::details)& details(const ::blink::mojom::blink::InspectorIssueInfoPtr& input) { return input->details; }
