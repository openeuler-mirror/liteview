...
static_assert(sizeof(DevToolsSessionHost_DispatchProtocolNotification_Params_Data) == 24, "Bad sizeof(DevToolsSessionHost_DispatchProtocolNotification_Params_Data)");
...
public:
    ...
    {
        UserType result;
        bool ret = mojo::internal::Deserialize<mojo::InterfaceRequestDataView<::blink::mojom::DevToolsSessionInterfaceBase>>(&data_->io_session, &result, message_);
        DCHECK(ret);
        return result;
    }
    ...
    bool client_expects_binary_responses() const { return data_->client_expects_binary_responses; }
    bool client_is_trusted() const { return data_->client_is_trusted; }
...
public:
    ...
    bool is_null() const { return !data_; }
    bool report() const { return data_->report; }
...
public:
    ...
    {
        UserType result;
        bool ret = mojo::internal::Deserialize<mojo::InterfacePtrDataView<::blink::mojom::DevToolsAgentInterfaceBase>>(&data_->worker_devtools_agent, &result, message_);
        DCHECK(ret);
        return result;
    }
    template <typename UserType> UserType TakeWorkerDevtoolsAgentHost()
    {
        UserType result;
        bool ret
            = mojo::internal::Deserialize<mojo::InterfaceRequestDataView<::blink::mojom::DevToolsAgentHostInterfaceBase>>(&data_->worker_devtools_agent_host, &result, message_);
        DCHECK(ret);
        return result;
    }
    ...
    bool waiting_for_debugger() const { return data_->waiting_for_debugger; }
...
public:
    ...
    bool is_null() const { return !data_; }
    int32_t call_id() const { return data_->call_id; }
...
public:
    ...
    DevToolsSessionHost_DispatchProtocolResponse_ParamsDataView(internal::DevToolsSessionHost_DispatchProtocolResponse_Params_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
...
public:
    ...
    DevToolsSessionHost_DispatchProtocolNotification_ParamsDataView(internal::DevToolsSessionHost_DispatchProtocolNotification_Params_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
