...
std::ostream& operator<<(std::ostream& os, ConsoleMessageLevel value) { return os << ConsoleMessageLevelToString(value); }
...
std::ostream& operator<<(std::ostream& os, ConsoleMessageSource value) { return os << ConsoleMessageSourceToString(value); }
...
std::ostream& operator<<(std::ostream& os, ConsoleMessageCategory value) { return os << ConsoleMessageCategoryToString(value); }
