...
struct blink_mojom_internal_FileSystemType_DataHashFn {
    ...
    static bool Equal(const ::blink::mojom::FileSystemType& left, const ::blink::mojom::FileSystemType& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::blink::mojom::FileSystemType> : public GenericHashTraits<::blink::mojom::FileSystemType> {
    static_assert(true, "-1000000 is a reserved enum value");
    static_assert(true, "-1000001 is a reserved enum value");
    static const bool kEmptyValueIsZero = false;
    static ::blink::mojom::FileSystemType EmptyValue() { return static_cast<::blink::mojom::FileSystemType>(-1000000); }
    static void ConstructDeletedValue(::blink::mojom::FileSystemType& slot, bool) { slot = static_cast<::blink::mojom::FileSystemType>(-1000001); }
    static bool IsDeletedValue(const ::blink::mojom::FileSystemType& value) { return value == static_cast<::blink::mojom::FileSystemType>(-1000001); }
};
} // namespace WTF
namespace blink {
namespace mojom {
...
// with not having this data in traces there.
    ...
    virtual bool Open(const ::scoped_refptr<const ::blink::SecurityOrigin>& origin, FileSystemType file_system_type, WTF::String* out_name, ::blink::KURL* out_root_url,
    ...
    virtual void Write(const ::blink::KURL& file_path, const WTF::String& blob_uuid, int64_t position, ::mojo::PendingReceiver<FileSystemCancellableOperation> op_receiver,
    ...
    virtual void Truncate(const ::blink::KURL& file_path, int64_t length, ::mojo::PendingReceiver<FileSystemCancellableOperation> op_receiver, TruncateCallback callback) = 0;
    ...
    virtual bool CreateSnapshotFile(const ::blink::KURL& file_path, ::base::File::Info* out_file_info, ::base::FilePath* out_platform_path, ::base::File::Error* out_error_code,
    ...
    virtual bool RegisterBlob(const WTF::String& content_type, const ::blink::KURL& url, uint64_t length, absl::optional<::base::Time> expected_modification_time,
...
//
//   bool ResolveURL(const ::blink::KURL& filesystem_url, FileSystemInfoPtr* out_info, ::base::FilePath* out_file_path, bool* out_is_directory, ::base::File::Error* out_error_code)
//   final;
//
...
//
//   void Write(const ::blink::KURL& file_path, const WTF::String& blob_uuid, int64_t position, ::mojo::PendingReceiver<FileSystemCancellableOperation> op_receiver,
//   ::mojo::PendingRemote<FileSystemOperationListener> listener) final;
//
...
//
//   void Truncate(const ::blink::KURL& file_path, int64_t length, ::mojo::PendingReceiver<FileSystemCancellableOperation> op_receiver, TruncateCallback callback) final;
//
...
//
//   bool CreateSnapshotFile(const ::blink::KURL& file_path, ::base::File::Info* out_file_info, ::base::FilePath* out_platform_path, ::base::File::Error* out_error_code,
//   ::mojo::PendingRemote<ReceivedSnapshotListener>* out_snapshot_listener) final;
//
...
//
//   void RegisterBlob(const WTF::String& content_type, const ::blink::KURL& url, uint64_t length, absl::optional<::base::Time> expected_modification_time, RegisterBlobCallback
//   callback) final;
//
//  private:
//   mojo::MessageReceiverWithResponder* receiver_;
...
public:
    ...
    template <typename... Args> static FileSystemInfoPtr New(Args&&... args) { return FileSystemInfoPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static FileSystemInfoPtr From(const U& u) { return mojo::TypeConverter<FileSystemInfoPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, FileSystemInfo>::Convert(*this); }
    FileSystemInfo()
        : name()
        , root_url()
    ...
    template <typename T, FileSystemInfo::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    ...
    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<FileSystemInfo::DataView>(input); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::FileSystemInfo_UnserializedMessageContext<UserType, FileSystemInfo::DataView>>(0, 0, std::move(input)), MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    {
        return FileSystemInfo::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, FileSystemInfo::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, FileSystemInfo::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, FileSystemInfo::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }

template <typename StructPtrType> FileSystemInfoPtr FileSystemInfo::Clone() const { return New(mojo::Clone(name), mojo::Clone(root_url), mojo::Clone(mount_type)); }
...
template <> struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::FileSystemInfo::DataView, ::blink::mojom::blink::FileSystemInfoPtr> {
    ...
    static const decltype(::blink::mojom::blink::FileSystemInfo::name)& name(const ::blink::mojom::blink::FileSystemInfoPtr& input) { return input->name; }

    static const decltype(::blink::mojom::blink::FileSystemInfo::root_url)& root_url(const ::blink::mojom::blink::FileSystemInfoPtr& input) { return input->root_url; }

    static decltype(::blink::mojom::blink::FileSystemInfo::mount_type) mount_type(const ::blink::mojom::blink::FileSystemInfoPtr& input) { return input->mount_type; }
