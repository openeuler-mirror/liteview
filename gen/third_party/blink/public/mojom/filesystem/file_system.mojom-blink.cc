...
void FileSystemOperationListenerProxy::ResultsRetrieved(WTF::Vector<::filesystem::mojom::blink::DirectoryEntryPtr> in_entries, bool in_has_more)
{
    ...
    TRACE_EVENT1("mojom", "Send blink::mojom::FileSystemOperationListener::ResultsRetrieved", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("entries"), in_entries, "<value of type WTF::Vector<::filesystem::mojom::blink::DirectoryEntryPtr>>");
...
bool FileSystemOperationListenerStubDispatch::Accept(FileSystemOperationListener* impl, mojo::Message* message)
{
    ...
    case internal::kFileSystemOperationListener_ResultsRetrieved_Name: {
        ...
        WTF::Vector<::filesystem::mojom::blink::DirectoryEntryPtr> p_entries
            = mojo::DefaultConstructTraits::CreateInstance<WTF::Vector<::filesystem::mojom::blink::DirectoryEntryPtr>>();
...
#endif // !BUILDFLAG(IS_FUCHSIA)
bool FileSystemManager::Open(const ::scoped_refptr<const ::blink::SecurityOrigin>& origin, FileSystemType file_system_type, WTF::String* out_name, ::blink::KURL* out_root_url,
...
bool FileSystemManager::RegisterBlob(const WTF::String& content_type, const ::blink::KURL& url, uint64_t length, absl::optional<::base::Time> expected_modification_time,
...
bool FileSystemManagerProxy::Open(const ::scoped_refptr<const ::blink::SecurityOrigin>& param_origin, FileSystemType param_file_system_type, WTF::String* out_param_name,
    ::blink::KURL* out_param_root_url, ::base::File::Error* out_param_error_code)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
bool FileSystemManagerProxy::Create(const ::blink::KURL& param_path, bool param_exclusive, bool param_is_directory, bool param_recursive, ::base::File::Error* out_param_error_code)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    ...
    const ::blink::KURL& param_path, WTF::Vector<::filesystem::mojom::blink::DirectoryEntryPtr>* out_param_entries, ::base::File::Error* out_param_error_code)
{
    ...
    TRACE_EVENT_END1("mojom", "FileSystemManager::ReadDirectorySync", "sync_response_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("entries"), out_param_entries, "<value of type WTF::Vector<::filesystem::mojom::blink::DirectoryEntryPtr>>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("error_code"), out_param_error_code, "<value of type ::base::File::Error>");
    });
#endif
    return result;
...
void FileSystemManagerProxy::Write(const ::blink::KURL& in_file_path, const WTF::String& in_blob_uuid, int64_t in_position,
    ::mojo::PendingReceiver<FileSystemCancellableOperation> in_op_receiver, ::mojo::PendingRemote<FileSystemOperationListener> in_listener)
{
    ...
    TRACE_EVENT1("mojom", "Send blink::mojom::FileSystemManager::Write", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("blob_uuid"), in_blob_uuid, "<value of type const WTF::String&>");
    ...
    const ::blink::KURL& param_file_path, const WTF::String& param_blob_uuid, int64_t param_position, int64_t* out_param_byte_count, ::base::File::Error* out_param_error_code)
{
    ...
    TRACE_EVENT_BEGIN1("mojom", "Call blink::mojom::FileSystemManager::WriteSync (sync)", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("blob_uuid"), param_blob_uuid, "<value of type const WTF::String&>");
...
void FileSystemManagerProxy::WriteSync(const ::blink::KURL& in_file_path, const WTF::String& in_blob_uuid, int64_t in_position, WriteSyncCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
bool FileSystemManagerProxy::CreateSnapshotFile(const ::blink::KURL& param_file_path, ::base::File::Info* out_param_file_info, ::base::FilePath* out_param_platform_path,
...
bool FileSystemManagerProxy::RegisterBlob(const WTF::String& param_content_type, const ::blink::KURL& param_url, uint64_t param_length,
    absl::optional<::base::Time> param_expected_modification_time, ::scoped_refptr<::blink::BlobDataHandle>* out_param_blob)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
bool FileSystemManager_Open_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    ::blink::KURL p_root_url = mojo::DefaultConstructTraits::CreateInstance<::blink::KURL>();
    ::base::File::Error p_error_code = mojo::DefaultConstructTraits::CreateInstance<::base::File::Error>();
...
void FileSystemManager_ReadDirectorySync_ProxyToResponder::Run(WTF::Vector<::filesystem::mojom::blink::DirectoryEntryPtr> in_entries, ::base::File::Error in_error_code)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
bool FileSystemManagerStubDispatch::Accept(FileSystemManager* impl, mojo::Message* message)
{
    ...
    case internal::kFileSystemManager_ReadDirectory_Name: {
        ...
        bool success = true;
        ::blink::KURL p_path = mojo::DefaultConstructTraits::CreateInstance<::blink::KURL>();
    ...
    case internal::kFileSystemManager_Write_Name: {
        ...
        bool success = true;
        ::blink::KURL p_file_path = mojo::DefaultConstructTraits::CreateInstance<::blink::KURL>();
        WTF::String p_blob_uuid = mojo::DefaultConstructTraits::CreateInstance<WTF::String>();
...
bool FileSystemManagerStubDispatch::AcceptWithResponder(FileSystemManager* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
{
    ...
    case internal::kFileSystemManager_ResolveURL_Name: {
        ...
        bool success = true;
        ::blink::KURL p_filesystem_url = mojo::DefaultConstructTraits::CreateInstance<::blink::KURL>();
    ...
    case internal::kFileSystemManager_Move_Name: {
        ...
        bool success = true;
        ::blink::KURL p_src_path = mojo::DefaultConstructTraits::CreateInstance<::blink::KURL>();
        ::blink::KURL p_dest_path = mojo::DefaultConstructTraits::CreateInstance<::blink::KURL>();
...
void FileSystemManagerInterceptorForTesting::Write(const ::blink::KURL& file_path, const WTF::String& blob_uuid, int64_t position,
...
void FileSystemManagerInterceptorForTesting::RegisterBlob(
    const WTF::String& content_type, const ::blink::KURL& url, uint64_t length, absl::optional<::base::Time> expected_modification_time, RegisterBlobCallback callback)
{
    ...
    ::blink::KURL* out_root_url, ::base::File::Error* out_error_code)
{
    ...
    proxy_->Open(std::move(origin), std::move(file_system_type),
        base::BindOnce(
            [](base::RunLoop* loop, WTF::String* out_name, ::blink::KURL* out_root_url, ::base::File::Error* out_error_code, const WTF::String& name, const ::blink::KURL& root_url,
...
::base::File::Error FileSystemManagerAsyncWaiter::Truncate(const ::blink::KURL& file_path, int64_t length, ::mojo::PendingReceiver<FileSystemCancellableOperation> op_receiver)
{
    ::base::File::Error async_wait_result = mojo::DefaultConstructTraits::CreateInstance<::base::File::Error>();
...
void FileSystemManagerAsyncWaiter::RegisterBlob(const WTF::String& content_type, const ::blink::KURL& url, uint64_t length, absl::optional<::base::Time> expected_modification_time,
    ::scoped_refptr<::blink::BlobDataHandle>* out_blob)
{
    base::RunLoop loop;
