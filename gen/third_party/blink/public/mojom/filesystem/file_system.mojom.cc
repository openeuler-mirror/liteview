...
bool FileSystemInfo::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
void FileSystemCancellableOperationProxy::Cancel(CancelCallback callback)
{
    ...
    mojo::Message message(internal::kFileSystemCancellableOperation_Cancel_Name, kFlags, 0, 0, nullptr);
...
public:
    ...
    {
        std::unique_ptr<FileSystemCancellableOperation_Cancel_ProxyToResponder> proxy(new FileSystemCancellableOperation_Cancel_ProxyToResponder(message, std::move(responder)));
...
bool FileSystemCancellableOperation_Cancel_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    bool success = true;
    ::base::File::Error p_error_code = mojo::DefaultConstructTraits::CreateInstance<::base::File::Error>();
    ...
    FileSystemCancellableOperation* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
{
    ...
    case internal::kFileSystemCancellableOperation_Cancel_Name: {
        ...
        FileSystemCancellableOperation::CancelCallback callback = FileSystemCancellableOperation_Cancel_ProxyToResponder::CreateCallback(*message, std::move(responder));
...
void FileSystemOperationListenerProxy::ResultsRetrieved(std::vector<::filesystem::mojom::DirectoryEntryPtr> in_entries, bool in_has_more)
{
    ...
    mojo::Message message(internal::kFileSystemOperationListener_ResultsRetrieved_Name, kFlags, 0, 0, nullptr);
    ...
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
        params->entries.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null entries in FileSystemOperationListener.ResultsRetrieved request");
...
void FileSystemOperationListenerProxy::DidWrite(int64_t in_byte_count, bool in_complete)
{
    ...
    mojo::Message message(internal::kFileSystemOperationListener_DidWrite_Name, kFlags, 0, 0, nullptr);
...
void FileSystemOperationListenerProxy::ErrorOccurred(::base::File::Error in_error_code)
{
    ...
    mojo::Message message(internal::kFileSystemOperationListener_ErrorOccurred_Name, kFlags, 0, 0, nullptr);
...
bool FileSystemOperationListenerStubDispatch::Accept(FileSystemOperationListener* impl, mojo::Message* message)
{
    ...
    case internal::kFileSystemOperationListener_ResultsRetrieved_Name: {
        ...
        bool success = true;
        std::vector<::filesystem::mojom::DirectoryEntryPtr> p_entries = mojo::DefaultConstructTraits::CreateInstance<std::vector<::filesystem::mojom::DirectoryEntryPtr>>();
        bool p_has_more = mojo::DefaultConstructTraits::CreateInstance<bool>();
    ...
    case internal::kFileSystemOperationListener_DidWrite_Name: {
        ...
        bool success = true;
        int64_t p_byte_count = mojo::DefaultConstructTraits::CreateInstance<int64_t>();
        bool p_complete = mojo::DefaultConstructTraits::CreateInstance<bool>();
...
void ReceivedSnapshotListenerProxy::DidReceiveSnapshotFile()
{
    ...
    mojo::Message message(internal::kReceivedSnapshotListener_DidReceiveSnapshotFile_Name, kFlags, 0, 0, nullptr);
...
// static
bool ReceivedSnapshotListenerStubDispatch::AcceptWithResponder(ReceivedSnapshotListener* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
{
    [[maybe_unused]] const bool message_is_sync = message->has_flag(mojo::Message::kFlagIsSync);
    [[maybe_unused]] const uint64_t request_id = message->request_id();
    switch (message->header()->name) {
...
bool FileSystemManager::CreateSnapshotFile(const ::GURL& file_path, ::base::File::Info* out_file_info, ::base::FilePath* out_platform_path, ::base::File::Error* out_error_code,
...
bool FileSystemManager::RegisterBlob(
...
public:
    FileSystemManager_ReadDirectorySync_HandleSyncResponse(bool* result, std::vector<::filesystem::mojom::DirectoryEntryPtr>* out_entries, ::base::File::Error* out_error_code)
        : result_(result)
    ...
    const ::url::Origin& param_origin, FileSystemType param_file_system_type, std::string* out_param_name, ::GURL* out_param_root_url, ::base::File::Error* out_param_error_code)
{
    ...
    mojo::Message message(internal::kFileSystemManager_Open_Name, kFlags, 0, 0, nullptr);
    ...
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(params->origin.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null origin in FileSystemManager.Open request");
    ...
    bool result = false;
    std::unique_ptr<mojo::MessageReceiver> responder(new FileSystemManager_Open_HandleSyncResponse(&result, out_param_name, out_param_root_url, out_param_error_code));
    ::mojo::internal::SendMojoMessage(*receiver_, message, std::move(responder));
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
bool FileSystemManagerProxy::ResolveURL(const ::GURL& param_filesystem_url, FileSystemInfoPtr* out_param_info, ::base::FilePath* out_param_file_path, bool* out_param_is_directory,
    ::base::File::Error* out_param_error_code)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    ...
    mojo::Message message(internal::kFileSystemManager_ResolveURL_Name, kFlags, 0, 0, nullptr);
    ...
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
        params->filesystem_url.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null filesystem_url in FileSystemManager.ResolveURL request");
...
bool FileSystemManagerProxy::Move(const ::GURL& param_src_path, const ::GURL& param_dest_path, ::base::File::Error* out_param_error_code)
{
    ...
    mojo::Message message(internal::kFileSystemManager_Move_Name, kFlags, 0, 0, nullptr);
...
bool FileSystemManagerProxy::Copy(const ::GURL& param_src_path, const ::GURL& param_dest_path, ::base::File::Error* out_param_error_code)
{
    ...
    mojo::Message message(internal::kFileSystemManager_Copy_Name, kFlags, 0, 0, nullptr);
...
bool FileSystemManagerProxy::Remove(const ::GURL& param_path, bool param_recursive, ::base::File::Error* out_param_error_code)
{
    ...
    mojo::Message message(internal::kFileSystemManager_Remove_Name, kFlags, 0, 0, nullptr);
    ...
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(params->path.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null path in FileSystemManager.Remove request");
...
bool FileSystemManagerProxy::ReadMetadata(const ::GURL& param_path, ::base::File::Info* out_param_file_info, ::base::File::Error* out_param_error_code)
{
    ...
    mojo::Message message(internal::kFileSystemManager_ReadMetadata_Name, kFlags, 0, 0, nullptr);
...
bool FileSystemManagerProxy::Create(const ::GURL& param_path, bool param_exclusive, bool param_is_directory, bool param_recursive, ::base::File::Error* out_param_error_code)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    ...
    mojo::Message message(internal::kFileSystemManager_Create_Name, kFlags, 0, 0, nullptr);
    mojo::internal::MessageFragment<::blink::mojom::internal::FileSystemManager_Create_Params_Data> params(message);
    params.Allocate();
    mojo::internal::MessageFragment<typename decltype(params->path)::BaseType> path_fragment(params.message());
    mojo::internal::Serialize<::url::mojom::UrlDataView>(param_path, path_fragment);
    params->path.Set(path_fragment.is_null() ? nullptr : path_fragment.data());
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(params->path.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null path in FileSystemManager.Create request");
...
bool FileSystemManagerProxy::Exists(const ::GURL& param_path, bool param_is_directory, ::base::File::Error* out_param_error_code)
{
    ...
    mojo::Message message(internal::kFileSystemManager_Exists_Name, kFlags, 0, 0, nullptr);
    mojo::internal::MessageFragment<::blink::mojom::internal::FileSystemManager_Exists_Params_Data> params(message);
    params.Allocate();
    mojo::internal::MessageFragment<typename decltype(params->path)::BaseType> path_fragment(params.message());
    mojo::internal::Serialize<::url::mojom::UrlDataView>(param_path, path_fragment);
    params->path.Set(path_fragment.is_null() ? nullptr : path_fragment.data());
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(params->path.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null path in FileSystemManager.Exists request");
    params->is_directory = param_is_directory;
...
void FileSystemManagerProxy::ReadDirectory(const ::GURL& in_path, ::mojo::PendingRemote<FileSystemOperationListener> in_listener)
{
    ...
    mojo::Message message(internal::kFileSystemManager_ReadDirectory_Name, kFlags, 0, 0, nullptr);
    ...
    mojo::internal::Serialize<mojo::InterfacePtrDataView<::blink::mojom::FileSystemOperationListenerInterfaceBase>>(in_listener, &params->listener, &params.message());
    ...
    const ::GURL& param_path, std::vector<::filesystem::mojom::DirectoryEntryPtr>* out_param_entries, ::base::File::Error* out_param_error_code)
{
    ...
    mojo::Message message(internal::kFileSystemManager_ReadDirectorySync_Name, kFlags, 0, 0, nullptr);
    ...
    bool result = false;
    std::unique_ptr<mojo::MessageReceiver> responder(new FileSystemManager_ReadDirectorySync_HandleSyncResponse(&result, out_param_entries, out_param_error_code));
    ::mojo::internal::SendMojoMessage(*receiver_, message, std::move(responder));
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT_END1("mojom", "FileSystemManager::ReadDirectorySync", "sync_response_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("entries"), out_param_entries, "<value of type std::vector<::filesystem::mojom::DirectoryEntryPtr>>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("error_code"), out_param_error_code, "<value of type ::base::File::Error>");
    });
#endif
    return result;
...
void FileSystemManagerProxy::Write(const ::GURL& in_file_path, const std::string& in_blob_uuid, int64_t in_position,
    ::mojo::PendingReceiver<FileSystemCancellableOperation> in_op_receiver, ::mojo::PendingRemote<FileSystemOperationListener> in_listener)
{
    ...
    TRACE_EVENT1("mojom", "Send blink::mojom::FileSystemManager::Write", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("blob_uuid"), in_blob_uuid, "<value of type const std::string&>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("position"), in_position, "<value of type int64_t>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("op_receiver"), in_op_receiver, "<value of type ::mojo::PendingReceiver<FileSystemCancellableOperation>>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("listener"), in_listener, "<value of type ::mojo::PendingRemote<FileSystemOperationListener>>");
    });
#endif
    const bool kExpectsResponse = false;
    ...
    mojo::Message message(internal::kFileSystemManager_Write_Name, kFlags, 0, 0, nullptr);
    ...
    mojo::internal::MessageFragment<typename decltype(params->blob_uuid)::BaseType> blob_uuid_fragment(params.message());
    mojo::internal::Serialize<mojo::StringDataView>(in_blob_uuid, blob_uuid_fragment);
    params->blob_uuid.Set(blob_uuid_fragment.is_null() ? nullptr : blob_uuid_fragment.data());
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
        params->blob_uuid.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null blob_uuid in FileSystemManager.Write request");
    params->position = in_position;
    mojo::internal::Serialize<mojo::InterfaceRequestDataView<::blink::mojom::FileSystemCancellableOperationInterfaceBase>>(in_op_receiver, &params->op_receiver, &params.message());
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(!mojo::internal::IsHandleOrInterfaceValid(params->op_receiver), mojo::internal::VALIDATION_ERROR_UNEXPECTED_INVALID_HANDLE,
    ...
    const ::GURL& param_file_path, const std::string& param_blob_uuid, int64_t param_position, int64_t* out_param_byte_count, ::base::File::Error* out_param_error_code)
{
    ...
    TRACE_EVENT_BEGIN1("mojom", "Call blink::mojom::FileSystemManager::WriteSync (sync)", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("blob_uuid"), param_blob_uuid, "<value of type const std::string&>");
    ...
    mojo::Message message(internal::kFileSystemManager_WriteSync_Name, kFlags, 0, 0, nullptr);
    ...
    mojo::internal::MessageFragment<typename decltype(params->blob_uuid)::BaseType> blob_uuid_fragment(params.message());
    mojo::internal::Serialize<mojo::StringDataView>(param_blob_uuid, blob_uuid_fragment);
    params->blob_uuid.Set(blob_uuid_fragment.is_null() ? nullptr : blob_uuid_fragment.data());
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
        params->blob_uuid.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null blob_uuid in FileSystemManager.WriteSync request");
...
void FileSystemManagerProxy::WriteSync(const ::GURL& in_file_path, const std::string& in_blob_uuid, int64_t in_position, WriteSyncCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    ...
    const ::GURL& in_file_path, int64_t in_length, ::mojo::PendingReceiver<FileSystemCancellableOperation> in_op_receiver, TruncateCallback callback)
{
    ...
    mojo::Message message(internal::kFileSystemManager_Truncate_Name, kFlags, 0, 0, nullptr);
...
bool FileSystemManagerProxy::TruncateSync(const ::GURL& param_file_path, int64_t param_length, ::base::File::Error* out_param_error_code)
{
    ...
    mojo::Message message(internal::kFileSystemManager_TruncateSync_Name, kFlags, 0, 0, nullptr);
...
bool FileSystemManagerProxy::CreateSnapshotFile(const ::GURL& param_file_path, ::base::File::Info* out_param_file_info, ::base::FilePath* out_param_platform_path,
    ::base::File::Error* out_param_error_code, ::mojo::PendingRemote<ReceivedSnapshotListener>* out_param_snapshot_listener)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    ...
    mojo::Message message(internal::kFileSystemManager_CreateSnapshotFile_Name, kFlags, 0, 0, nullptr);
    ...
    params->file_path.Set(file_path_fragment.is_null() ? nullptr : file_path_fragment.data());
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
        params->file_path.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null file_path in FileSystemManager.CreateSnapshotFile request");
    ...
    bool result = false;
    std::unique_ptr<mojo::MessageReceiver> responder(
        new FileSystemManager_CreateSnapshotFile_HandleSyncResponse(&result, out_param_file_info, out_param_platform_path, out_param_error_code, out_param_snapshot_listener));
    ::mojo::internal::SendMojoMessage(*receiver_, message, std::move(responder));
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
bool FileSystemManagerProxy::GetPlatformPath(const ::GURL& param_file_path, ::base::FilePath* out_param_platform_path)
{
    ...
    mojo::Message message(internal::kFileSystemManager_GetPlatformPath_Name, kFlags, 0, 0, nullptr);
...
bool FileSystemManagerProxy::RegisterBlob(const std::string& param_content_type, const ::GURL& param_url, uint64_t param_length,
    absl::optional<::base::Time> param_expected_modification_time, ::blink::mojom::SerializedBlobPtr* out_param_blob)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT_BEGIN1("mojom", "Call blink::mojom::FileSystemManager::RegisterBlob (sync)", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("expected_modification_time"), param_expected_modification_time, "<value of type absl::optional<::base::Time>>");
    });
#else
    ...
    mojo::Message message(internal::kFileSystemManager_RegisterBlob_Name, kFlags, 0, 0, nullptr);
    ...
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
        params->content_type.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null content_type in FileSystemManager.RegisterBlob request");
    ...
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(params->url.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null url in FileSystemManager.RegisterBlob request");
    params->length = param_length;
    ...
    const std::string& in_content_type, const ::GURL& in_url, uint64_t in_length, absl::optional<::base::Time> in_expected_modification_time, RegisterBlobCallback callback)
{
    ...
    TRACE_EVENT1("mojom", "Send blink::mojom::FileSystemManager::RegisterBlob", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("expected_modification_time"), in_expected_modification_time, "<value of type absl::optional<::base::Time>>");
    });
#endif
    const bool kExpectsResponse = true;
    const bool kIsSync = false;
...
bool FileSystemManager_Open_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    DCHECK(message->is_serialized());
    internal::FileSystemManager_Open_ResponseParams_Data* params = reinterpret_cast<internal::FileSystemManager_Open_ResponseParams_Data*>(message->mutable_payload());

    bool success = true;
    std::string p_name = mojo::DefaultConstructTraits::CreateInstance<std::string>();
    ::GURL p_root_url = mojo::DefaultConstructTraits::CreateInstance<::GURL>();
    ::base::File::Error p_error_code = mojo::DefaultConstructTraits::CreateInstance<::base::File::Error>();
...
bool FileSystemManager_ResolveURL_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    DCHECK(message->is_serialized());
    internal::FileSystemManager_ResolveURL_ResponseParams_Data* params = reinterpret_cast<internal::FileSystemManager_ResolveURL_ResponseParams_Data*>(message->mutable_payload());

    bool success = true;
    FileSystemInfoPtr p_info = mojo::DefaultConstructTraits::CreateInstance<FileSystemInfoPtr>();
    ::base::FilePath p_file_path = mojo::DefaultConstructTraits::CreateInstance<::base::FilePath>();
    bool p_is_directory = mojo::DefaultConstructTraits::CreateInstance<bool>();
    ::base::File::Error p_error_code = mojo::DefaultConstructTraits::CreateInstance<::base::File::Error>();
...
void FileSystemManager_ResolveURL_ProxyToResponder::Run(FileSystemInfoPtr in_info, const ::base::FilePath& in_file_path, bool in_is_directory, ::base::File::Error in_error_code)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
bool FileSystemManager_Move_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    DCHECK(message->is_serialized());
    internal::FileSystemManager_Move_ResponseParams_Data* params = reinterpret_cast<internal::FileSystemManager_Move_ResponseParams_Data*>(message->mutable_payload());
...
bool FileSystemManager_Copy_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    DCHECK(message->is_serialized());
    internal::FileSystemManager_Copy_ResponseParams_Data* params = reinterpret_cast<internal::FileSystemManager_Copy_ResponseParams_Data*>(message->mutable_payload());
...
bool FileSystemManager_Remove_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    DCHECK(message->is_serialized());
    internal::FileSystemManager_Remove_ResponseParams_Data* params = reinterpret_cast<internal::FileSystemManager_Remove_ResponseParams_Data*>(message->mutable_payload());
...
public:
    ...
    {
        std::unique_ptr<FileSystemManager_ReadMetadata_ProxyToResponder> proxy(new FileSystemManager_ReadMetadata_ProxyToResponder(message, std::move(responder)));
...
bool FileSystemManager_ReadMetadata_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    bool success = true;
    ::base::File::Info p_file_info = mojo::DefaultConstructTraits::CreateInstance<::base::File::Info>();
    ::base::File::Error p_error_code = mojo::DefaultConstructTraits::CreateInstance<::base::File::Error>();
...
bool FileSystemManager_Create_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    DCHECK(message->is_serialized());
    internal::FileSystemManager_Create_ResponseParams_Data* params = reinterpret_cast<internal::FileSystemManager_Create_ResponseParams_Data*>(message->mutable_payload());
...
bool FileSystemManager_Exists_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    DCHECK(message->is_serialized());
    internal::FileSystemManager_Exists_ResponseParams_Data* params = reinterpret_cast<internal::FileSystemManager_Exists_ResponseParams_Data*>(message->mutable_payload());
...
public:
    ...
    {
        std::unique_ptr<FileSystemManager_ReadDirectorySync_ProxyToResponder> proxy(new FileSystemManager_ReadDirectorySync_ProxyToResponder(message, std::move(responder)));
...
void FileSystemManager_ReadDirectorySync_ProxyToResponder::Run(std::vector<::filesystem::mojom::DirectoryEntryPtr> in_entries, ::base::File::Error in_error_code)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
bool FileSystemManager_WriteSync_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    DCHECK(message->is_serialized());
    internal::FileSystemManager_WriteSync_ResponseParams_Data* params = reinterpret_cast<internal::FileSystemManager_WriteSync_ResponseParams_Data*>(message->mutable_payload());
...
bool FileSystemManager_Truncate_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    DCHECK(message->is_serialized());
    internal::FileSystemManager_Truncate_ResponseParams_Data* params = reinterpret_cast<internal::FileSystemManager_Truncate_ResponseParams_Data*>(message->mutable_payload());
...
public:
    ...
    {
        std::unique_ptr<FileSystemManager_TruncateSync_ProxyToResponder> proxy(new FileSystemManager_TruncateSync_ProxyToResponder(message, std::move(responder)));
...
public:
    ...
    {
        std::unique_ptr<FileSystemManager_CreateSnapshotFile_ProxyToResponder> proxy(new FileSystemManager_CreateSnapshotFile_ProxyToResponder(message, std::move(responder)));
...
bool FileSystemManager_CreateSnapshotFile_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    bool success = true;
    ::base::File::Info p_file_info = mojo::DefaultConstructTraits::CreateInstance<::base::File::Info>();
    ::base::FilePath p_platform_path = mojo::DefaultConstructTraits::CreateInstance<::base::FilePath>();
    ::base::File::Error p_error_code = mojo::DefaultConstructTraits::CreateInstance<::base::File::Error>();
    ::mojo::PendingRemote<ReceivedSnapshotListener> p_snapshot_listener = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingRemote<ReceivedSnapshotListener>>();
...
void FileSystemManager_CreateSnapshotFile_ProxyToResponder::Run(const ::base::File::Info& in_file_info, const ::base::FilePath& in_platform_path, ::base::File::Error in_error_code,
    ::mojo::PendingRemote<ReceivedSnapshotListener> in_snapshot_listener)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send reply blink::mojom::FileSystemManager::CreateSnapshotFile", "async_response_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("error_code"), in_error_code, "<value of type ::base::File::Error>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("snapshot_listener"), in_snapshot_listener, "<value of type ::mojo::PendingRemote<ReceivedSnapshotListener>>");
    });
#endif
    ...
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(params->platform_path.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null platform_path in ");
    mojo::internal::Serialize<::mojo_base::mojom::FileError>(in_error_code, &params->error_code);
...
public:
    ...
    {
        std::unique_ptr<FileSystemManager_GetPlatformPath_ProxyToResponder> proxy(new FileSystemManager_GetPlatformPath_ProxyToResponder(message, std::move(responder)));
...
public:
    ...
    {
        std::unique_ptr<FileSystemManager_RegisterBlob_ProxyToResponder> proxy(new FileSystemManager_RegisterBlob_ProxyToResponder(message, std::move(responder)));
...
bool FileSystemManagerStubDispatch::Accept(FileSystemManager* impl, mojo::Message* message)
{
    ...
    case internal::kFileSystemManager_ReadDirectory_Name: {
        ...
        DCHECK(message->is_serialized());
        internal::FileSystemManager_ReadDirectory_Params_Data* params = reinterpret_cast<internal::FileSystemManager_ReadDirectory_Params_Data*>(message->mutable_payload());

        bool success = true;
        ::GURL p_path = mojo::DefaultConstructTraits::CreateInstance<::GURL>();
        ::mojo::PendingRemote<FileSystemOperationListener> p_listener = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingRemote<FileSystemOperationListener>>();
    ...
    case internal::kFileSystemManager_Write_Name: {
        ...
        bool success = true;
        ::GURL p_file_path = mojo::DefaultConstructTraits::CreateInstance<::GURL>();
        std::string p_blob_uuid = mojo::DefaultConstructTraits::CreateInstance<std::string>();
        int64_t p_position = mojo::DefaultConstructTraits::CreateInstance<int64_t>();
        ::mojo::PendingReceiver<FileSystemCancellableOperation> p_op_receiver
            = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingReceiver<FileSystemCancellableOperation>>();
        ::mojo::PendingRemote<FileSystemOperationListener> p_listener = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingRemote<FileSystemOperationListener>>();
        ...
        // A null |impl| means no implementation was bound.
        DCHECK(impl);
        impl->Write(std::move(p_file_path), std::move(p_blob_uuid), std::move(p_position), std::move(p_op_receiver), std::move(p_listener));
        return true;
    }
    case internal::kFileSystemManager_WriteSync_Name: {
        break;
...
// static
bool FileSystemManagerStubDispatch::AcceptWithResponder(FileSystemManager* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
{
    [[maybe_unused]] const bool message_is_sync = message->has_flag(mojo::Message::kFlagIsSync);
    [[maybe_unused]] const uint64_t request_id = message->request_id();
    switch (message->header()->name) {
    case internal::kFileSystemManager_Open_Name: {
        ...
        FileSystemType p_file_system_type = mojo::DefaultConstructTraits::CreateInstance<FileSystemType>();
    ...
    case internal::kFileSystemManager_ResolveURL_Name: {
        ...
        internal::FileSystemManager_ResolveURL_Params_Data* params = reinterpret_cast<internal::FileSystemManager_ResolveURL_Params_Data*>(message->mutable_payload());

        bool success = true;
        ::GURL p_filesystem_url = mojo::DefaultConstructTraits::CreateInstance<::GURL>();
    ...
    case internal::kFileSystemManager_Move_Name: {
        ...
        bool success = true;
        ::GURL p_src_path = mojo::DefaultConstructTraits::CreateInstance<::GURL>();
        ::GURL p_dest_path = mojo::DefaultConstructTraits::CreateInstance<::GURL>();
    ...
    case internal::kFileSystemManager_Remove_Name: {
        ...
        bool success = true;
        ::GURL p_path = mojo::DefaultConstructTraits::CreateInstance<::GURL>();
        bool p_recursive = mojo::DefaultConstructTraits::CreateInstance<bool>();
    ...
    case internal::kFileSystemManager_ReadMetadata_Name: {
        ...
        internal::FileSystemManager_ReadMetadata_Params_Data* params = reinterpret_cast<internal::FileSystemManager_ReadMetadata_Params_Data*>(message->mutable_payload());
    ...
    case internal::kFileSystemManager_Create_Name: {
        ...
        bool success = true;
        ::GURL p_path = mojo::DefaultConstructTraits::CreateInstance<::GURL>();
        bool p_exclusive = mojo::DefaultConstructTraits::CreateInstance<bool>();
        bool p_is_directory = mojo::DefaultConstructTraits::CreateInstance<bool>();
        bool p_recursive = mojo::DefaultConstructTraits::CreateInstance<bool>();
    ...
    case internal::kFileSystemManager_ReadDirectorySync_Name: {
        ...
        FileSystemManager::ReadDirectorySyncCallback callback = FileSystemManager_ReadDirectorySync_ProxyToResponder::CreateCallback(*message, std::move(responder));
        // A null |impl| means no implementation was bound.
        DCHECK(impl);
    ...
    case internal::kFileSystemManager_WriteSync_Name: {
        ...
        internal::FileSystemManager_WriteSync_Params_Data* params = reinterpret_cast<internal::FileSystemManager_WriteSync_Params_Data*>(message->mutable_payload());
        ...
        // A null |impl| means no implementation was bound.
        DCHECK(impl);
        impl->WriteSync(std::move(p_file_path), std::move(p_blob_uuid), std::move(p_position), std::move(callback));
        return true;
    }
    case internal::kFileSystemManager_Truncate_Name: {

        internal::FileSystemManager_Truncate_Params_Data* params = reinterpret_cast<internal::FileSystemManager_Truncate_Params_Data*>(message->mutable_payload());

        bool success = true;
        ::GURL p_file_path = mojo::DefaultConstructTraits::CreateInstance<::GURL>();
        int64_t p_length = mojo::DefaultConstructTraits::CreateInstance<int64_t>();
        ::mojo::PendingReceiver<FileSystemCancellableOperation> p_op_receiver
            = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingReceiver<FileSystemCancellableOperation>>();
    ...
    case internal::kFileSystemManager_TruncateSync_Name: {
        ...
        internal::FileSystemManager_TruncateSync_Params_Data* params = reinterpret_cast<internal::FileSystemManager_TruncateSync_Params_Data*>(message->mutable_payload());
    ...
    case internal::kFileSystemManager_CreateSnapshotFile_Name: {
        ...
        FileSystemManager::CreateSnapshotFileCallback callback = FileSystemManager_CreateSnapshotFile_ProxyToResponder::CreateCallback(*message, std::move(responder));
        // A null |impl| means no implementation was bound.
        DCHECK(impl);
    ...
    case internal::kFileSystemManager_GetPlatformPath_Name: {
        ...
        internal::FileSystemManager_GetPlatformPath_Params_Data* params = reinterpret_cast<internal::FileSystemManager_GetPlatformPath_Params_Data*>(message->mutable_payload());
        ...
        FileSystemManager::GetPlatformPathCallback callback = FileSystemManager_GetPlatformPath_ProxyToResponder::CreateCallback(*message, std::move(responder));
        // A null |impl| means no implementation was bound.
        DCHECK(impl);
    ...
    case internal::kFileSystemManager_RegisterBlob_Name: {
        ...
        internal::FileSystemManager_RegisterBlob_Params_Data* params = reinterpret_cast<internal::FileSystemManager_RegisterBlob_Params_Data*>(message->mutable_payload());
        ...
        absl::optional<::base::Time> p_expected_modification_time = mojo::DefaultConstructTraits::CreateInstance<absl::optional<::base::Time>>();
...
namespace blink {
namespace mojom {
void FileSystemCancellableOperationInterceptorForTesting::Cancel(CancelCallback callback) { GetForwardingInterface()->Cancel(std::move(callback)); }
...
void FileSystemOperationListenerInterceptorForTesting::ErrorOccurred(::base::File::Error error_code) { GetForwardingInterface()->ErrorOccurred(std::move(error_code)); }
...
void ReceivedSnapshotListenerInterceptorForTesting::DidReceiveSnapshotFile() { GetForwardingInterface()->DidReceiveSnapshotFile(); }
...
void FileSystemManagerInterceptorForTesting::Write(const ::GURL& file_path, const std::string& blob_uuid, int64_t position,
    ...
    const ::url::Origin& origin, FileSystemType file_system_type, std::string* out_name, ::GURL* out_root_url, ::base::File::Error* out_error_code)
{
    ...
    proxy_->Open(std::move(origin), std::move(file_system_type),
        base::BindOnce(
            [](base::RunLoop* loop, std::string* out_name, ::GURL* out_root_url, ::base::File::Error* out_error_code, const std::string& name, const ::GURL& root_url,
...
void FileSystemManagerAsyncWaiter::ReadMetadata(const ::GURL& path, ::base::File::Info* out_file_info, ::base::File::Error* out_error_code)
{
    ...
    proxy_->ReadMetadata(std::move(path),
        base::BindOnce(
            [](base::RunLoop* loop, ::base::File::Info* out_file_info, ::base::File::Error* out_error_code, const ::base::File::Info& file_info, ::base::File::Error error_code) {
...
void FileSystemManagerAsyncWaiter::ReadDirectorySync(const ::GURL& path, std::vector<::filesystem::mojom::DirectoryEntryPtr>* out_entries, ::base::File::Error* out_error_code)
{
    base::RunLoop loop;
...
void FileSystemManagerAsyncWaiter::WriteSync(const ::GURL& file_path, const std::string& blob_uuid, int64_t position, int64_t* out_byte_count, ::base::File::Error* out_error_code)
{
    base::RunLoop loop;
...
::base::File::Error FileSystemManagerAsyncWaiter::Truncate(const ::GURL& file_path, int64_t length, ::mojo::PendingReceiver<FileSystemCancellableOperation> op_receiver)
{
    ::base::File::Error async_wait_result = mojo::DefaultConstructTraits::CreateInstance<::base::File::Error>();
    ...
    proxy_->CreateSnapshotFile(std::move(file_path),
        base::BindOnce(
            [](base::RunLoop* loop, ::base::File::Info* out_file_info, ::base::FilePath* out_platform_path, ::base::File::Error* out_error_code,
                ::mojo::PendingRemote<ReceivedSnapshotListener>* out_snapshot_listener, const ::base::File::Info& file_info, const ::base::FilePath& platform_path,
                ::base::File::Error error_code, ::mojo::PendingRemote<ReceivedSnapshotListener> snapshot_listener) {
                *out_file_info = std::move(file_info);
