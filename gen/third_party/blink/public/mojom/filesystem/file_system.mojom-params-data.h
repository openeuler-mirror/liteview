...
static_assert(sizeof(ReceivedSnapshotListener_DidReceiveSnapshotFile_Params_Data) == 8, "Bad sizeof(ReceivedSnapshotListener_DidReceiveSnapshotFile_Params_Data)");
...
public:
    ...
    FileSystemCancellableOperation_Cancel_ResponseParamsDataView(internal::FileSystemCancellableOperation_Cancel_ResponseParams_Data* data, mojo::Message* message)
        : data_(data)
    {
    }
    ...
    ::mojo_base::mojom::FileError error_code() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::mojo_base::mojom::FileError>(data_->error_code)); }
...
public:
    ...
    FileSystemOperationListener_ResultsRetrieved_ParamsDataView(internal::FileSystemOperationListener_ResultsRetrieved_Params_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
    ...
    bool has_more() const { return data_->has_more; }
...
public:
    ...
    bool is_null() const { return !data_; }
    int64_t byte_count() const { return data_->byte_count; }
    bool complete() const { return data_->complete; }
...
public:
    ...
    ReceivedSnapshotListener_DidReceiveSnapshotFile_ParamsDataView(internal::ReceivedSnapshotListener_DidReceiveSnapshotFile_Params_Data* data, mojo::Message* message)
        : data_(data)
    {
    }
...
public:
    ...
    FileSystemType file_system_type() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::blink::mojom::FileSystemType>(data_->file_system_type)); }
...
public:
    ...
    bool is_directory() const { return data_->is_directory; }
    template <typename UserType> [[nodiscard]] bool ReadErrorCode(UserType* output) const
    {
        auto data_value = data_->error_code;
        return mojo::internal::Deserialize<::mojo_base::mojom::FileError>(data_value, output);
...
public:
    ...
    bool exclusive() const { return data_->exclusive; }
    bool is_directory() const { return data_->is_directory; }
    bool recursive() const { return data_->recursive; }
...
public:
    ...
    {
        UserType result;
        bool ret = mojo::internal::Deserialize<mojo::InterfacePtrDataView<::blink::mojom::FileSystemOperationListenerInterfaceBase>>(&data_->listener, &result, message_);
        DCHECK(ret);
        return result;
    }
...
public:
    ...
    inline void GetBlobUuidDataView(mojo::StringDataView* output);

    template <typename UserType> [[nodiscard]] bool ReadBlobUuid(UserType* output)
    {

        auto* pointer = data_->blob_uuid.Get();
        return mojo::internal::Deserialize<mojo::StringDataView>(pointer, output, message_);
    }
    int64_t position() const { return data_->position; }
    template <typename UserType> UserType TakeOpReceiver()
    {
        UserType result;
        bool ret = mojo::internal::Deserialize<mojo::InterfaceRequestDataView<::blink::mojom::FileSystemCancellableOperationInterfaceBase>>(&data_->op_receiver, &result, message_);
        DCHECK(ret);
        return result;
    }
    template <typename UserType> UserType TakeListener()
...
public:
    ...
    FileSystemManager_CreateSnapshotFile_ResponseParamsDataView(internal::FileSystemManager_CreateSnapshotFile_ResponseParams_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
    ...
    {
        UserType result;
        bool ret = mojo::internal::Deserialize<mojo::InterfacePtrDataView<::blink::mojom::ReceivedSnapshotListenerInterfaceBase>>(&data_->snapshot_listener, &result, message_);
        DCHECK(ret);
        return result;
    }
...
inline void FileSystemOperationListener_ResultsRetrieved_ParamsDataView::GetEntriesDataView(mojo::ArrayDataView<::filesystem::mojom::DirectoryEntryDataView>* output)
{
    auto pointer = data_->entries.Get();
...
inline void FileSystemManager_ReadDirectorySync_ResponseParamsDataView::GetEntriesDataView(mojo::ArrayDataView<::filesystem::mojom::DirectoryEntryDataView>* output)
{
    auto pointer = data_->entries.Get();
    *output = mojo::ArrayDataView<::filesystem::mojom::DirectoryEntryDataView>(pointer, message_);
}
...
inline void FileSystemManager_Write_ParamsDataView::GetBlobUuidDataView(mojo::StringDataView* output)
{
    auto pointer = data_->blob_uuid.Get();
    *output = mojo::StringDataView(pointer, message_);
}
...
inline void FileSystemManager_WriteSync_ParamsDataView::GetBlobUuidDataView(mojo::StringDataView* output)
{
    auto pointer = data_->blob_uuid.Get();
    *output = mojo::StringDataView(pointer, message_);
}
