...
//
//   void Write(const ::GURL& file_path, const std::string& blob_uuid, int64_t position, ::mojo::PendingReceiver<FileSystemCancellableOperation> op_receiver,
...
//
//   bool CreateSnapshotFile(const ::GURL& file_path, ::base::File::Info* out_file_info, ::base::FilePath* out_platform_path, ::base::File::Error* out_error_code,
...
//
//   bool RegisterBlob(const std::string& content_type, const ::GURL& url, uint64_t length, absl::optional<::base::Time> expected_modification_time,
//   ::blink::mojom::SerializedBlobPtr* out_blob) final;
//
//   void RegisterBlob(const std::string& content_type, const ::GURL& url, uint64_t length, absl::optional<::base::Time> expected_modification_time, RegisterBlobCallback callback)
//   final;
//
//  private:
//   mojo::MessageReceiverWithResponder* receiver_;
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::FileSystemInfo::DataView, ::blink::mojom::FileSystemInfoPtr> {
    ...
    static const decltype(::blink::mojom::FileSystemInfo::name)& name(const ::blink::mojom::FileSystemInfoPtr& input) { return input->name; }

    static const decltype(::blink::mojom::FileSystemInfo::root_url)& root_url(const ::blink::mojom::FileSystemInfoPtr& input) { return input->root_url; }

    static decltype(::blink::mojom::FileSystemInfo::mount_type) mount_type(const ::blink::mojom::FileSystemInfoPtr& input) { return input->mount_type; }
