...
void AutoplayConfigurationClientProxy::AddAutoplayFlags(const ::scoped_refptr<const ::blink::SecurityOrigin>& in_origin, int32_t in_flags)
{
    ...
    mojo::Message message(internal::kAutoplayConfigurationClient_AddAutoplayFlags_Name, kFlags, 0, 0, nullptr);
    ...
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
        params->origin.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null origin in AutoplayConfigurationClient.AddAutoplayFlags request");
...
bool AutoplayConfigurationClientStubDispatch::Accept(AutoplayConfigurationClient* impl, mojo::Message* message)
{
    ...
    case internal::kAutoplayConfigurationClient_AddAutoplayFlags_Name: {
        ...
        int32_t p_flags = mojo::DefaultConstructTraits::CreateInstance<int32_t>();
