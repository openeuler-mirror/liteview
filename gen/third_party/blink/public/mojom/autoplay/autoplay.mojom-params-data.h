...
public:
    ...
    AutoplayConfigurationClient_AddAutoplayFlags_ParamsDataView(internal::AutoplayConfigurationClient_AddAutoplayFlags_Params_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
