...
public:
    ...
    bool is_null() const { return !data_; }
    inline void GetDeviceFiltersDataView(mojo::ArrayDataView<::device::mojom::UsbDeviceFilterDataView>* output);

    template <typename UserType> [[nodiscard]] bool ReadDeviceFilters(UserType* output)
    {
...
inline void WebUsbService_GetPermission_ParamsDataView::GetDeviceFiltersDataView(mojo::ArrayDataView<::device::mojom::UsbDeviceFilterDataView>* output)
{
    auto pointer = data_->device_filters.Get();
