...
public:
    ...
    void GetPermission(std::vector<::device::mojom::UsbDeviceFilterPtr> device_filters, ::device::mojom::UsbDeviceInfoPtr* out_result);
    ::device::mojom::UsbDeviceInfoPtr GetPermission(std::vector<::device::mojom::UsbDeviceFilterPtr> device_filters);
