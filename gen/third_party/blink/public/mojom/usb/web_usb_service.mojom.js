...
(function() {
  ...
  function WebUsbService_ForgetDevice_Params(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  WebUsbService_ForgetDevice_Params.prototype.initDefaults_ = function() {
    this.guid = null;
  };
  WebUsbService_ForgetDevice_Params.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  WebUsbService_ForgetDevice_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    // validate WebUsbService_ForgetDevice_Params.guid
    err = messageValidator.validateStringPointer(offset + codec.kStructHeaderSize + 0, false)
    if (err !== validator.validationError.NONE)
        return err;
  ...
  WebUsbService_ForgetDevice_Params.encodedSize = codec.kStructHeaderSize + 8;

  WebUsbService_ForgetDevice_Params.decode = function(decoder) {
    var packed;
    var val = new WebUsbService_ForgetDevice_Params();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.guid =
        decoder.decodeStruct(codec.String);
  ...
  WebUsbService_ForgetDevice_Params.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(WebUsbService_ForgetDevice_Params.encodedSize);
    encoder.writeUint32(0);
    encoder.encodeStruct(codec.String, val.guid);
  };
  function WebUsbService_ForgetDevice_ResponseParams(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  WebUsbService_ForgetDevice_ResponseParams.prototype.initDefaults_ = function() {
  };
  WebUsbService_ForgetDevice_ResponseParams.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  WebUsbService_ForgetDevice_ResponseParams.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  WebUsbService_ForgetDevice_ResponseParams.encodedSize = codec.kStructHeaderSize + 0;

  WebUsbService_ForgetDevice_ResponseParams.decode = function(decoder) {
    var packed;
    var val = new WebUsbService_ForgetDevice_ResponseParams();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    return val;
  };

  WebUsbService_ForgetDevice_ResponseParams.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(WebUsbService_ForgetDevice_ResponseParams.encodedSize);
    encoder.writeUint32(0);
  };
  ...
  var kWebUsbService_ForgetDevice_Name = 3;
  var kWebUsbService_SetClient_Name = 4;
  ...
  WebUsbServicePtr.prototype.forgetDevice = function() {
    return WebUsbServiceProxy.prototype.forgetDevice
        .apply(this.ptr.getProxy(), arguments);
  };

  WebUsbServiceProxy.prototype.forgetDevice = function(guid) {
    var params_ = new WebUsbService_ForgetDevice_Params();
    params_.guid = guid;
    return new Promise(function(resolve, reject) {
      var builder = new codec.MessageV1Builder(
          kWebUsbService_ForgetDevice_Name,
          codec.align(WebUsbService_ForgetDevice_Params.encodedSize),
          codec.kMessageExpectsResponse, 0);
      builder.encodeStruct(WebUsbService_ForgetDevice_Params, params_);
      var message = builder.finish();
      this.receiver_.acceptAndExpectResponse(message).then(function(message) {
        var reader = new codec.MessageReader(message);
        var responseParams =
            reader.decodeStruct(WebUsbService_ForgetDevice_ResponseParams);
        resolve(responseParams);
      }).catch(function(result) {
        reject(Error("Connection error: " + result));
      });
  ...
  WebUsbServiceStub.prototype.forgetDevice = function(guid) {
    return this.delegate_ && this.delegate_.forgetDevice && this.delegate_.forgetDevice(guid);
  }
  ...
  WebUsbServiceStub.prototype.acceptWithResponder =
    ...
    case kWebUsbService_GetPermission_Name:
      ...
      return true;
    case kWebUsbService_ForgetDevice_Name:
      var params = reader.decodeStruct(WebUsbService_ForgetDevice_Params);
      this.forgetDevice(params.guid).then(function(response) {
        var responseParams =
            new WebUsbService_ForgetDevice_ResponseParams();
        var builder = new codec.MessageV1Builder(
            kWebUsbService_ForgetDevice_Name,
            codec.align(WebUsbService_ForgetDevice_ResponseParams.encodedSize),
            codec.kMessageIsResponse, reader.requestID);
        builder.encodeStruct(WebUsbService_ForgetDevice_ResponseParams,
                             responseParams);
        var message = builder.finish();
        responder.accept(message);
      });
  ...
  function validateWebUsbServiceRequest(messageValidator) {
    ...
    switch (message.getName()) {
      ...
      case kWebUsbService_ForgetDevice_Name:
        if (message.expectsResponse())
          paramsClass = WebUsbService_ForgetDevice_Params;
      break;
      case kWebUsbService_SetClient_Name:
        if (!message.expectsResponse() && !message.isResponse())
  ...
  function validateWebUsbServiceResponse(messageValidator) {
   ...
   switch (message.getName()) {
      ...
      case kWebUsbService_ForgetDevice_Name:
        if (message.isResponse())
          paramsClass = WebUsbService_ForgetDevice_ResponseParams;
        break;
    }
    if (paramsClass === null)
      return validator.validationError.NONE;
