...
public:
    ...
    void GetPermission(WTF::Vector<::device::mojom::blink::UsbDeviceFilterPtr> device_filters, ::device::mojom::blink::UsbDeviceInfoPtr* out_result);
    ::device::mojom::blink::UsbDeviceInfoPtr GetPermission(WTF::Vector<::device::mojom::blink::UsbDeviceFilterPtr> device_filters);
