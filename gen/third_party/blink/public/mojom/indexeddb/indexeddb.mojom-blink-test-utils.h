...
public:
    ...
    void CursorContinue(::std::unique_ptr<::blink::IDBKey> key, ::std::unique_ptr<::blink::IDBKey> primary_key, IDBCursorResultPtr* out_result);
    IDBCursorResultPtr CursorContinue(::std::unique_ptr<::blink::IDBKey> key, ::std::unique_ptr<::blink::IDBKey> primary_key);
...
class MODULES_EXPORT IDBDatabaseGetAllResultSinkInterceptorForTesting : public IDBDatabaseGetAllResultSink {
    ...
    void ReceiveValues(WTF::Vector<IDBReturnValuePtr> values) override;
    void ReceiveKeys(WTF::Vector<::std::unique_ptr<::blink::IDBKey>> keys) override;
...
class MODULES_EXPORT IDBDatabaseInterceptorForTesting : public IDBDatabase {
    ...
    void BatchGetAll(
        int64_t transaction_id, int64_t object_store_id, int64_t index_id, WTF::Vector<IDBKeyRangePtr> key_ranges, uint32_t max_count, BatchGetAllCallback callback) override;
    ...
    void Count(
        int64_t transaction_id, int64_t object_store_id, int64_t index_id, IDBKeyRangePtr key_range, ::mojo::PendingAssociatedRemote<IDBCallbacks> pending_callbacks) override;
    ...
    void CreateIndex(
        int64_t transaction_id, int64_t object_store_id, int64_t index_id, const ::WTF::String& name, const ::blink::IDBKeyPath& key_path, bool unique, bool multi_entry) override;
...
public:
    ...
    IDBDatabaseBatchGetAllResultPtr BatchGetAll(int64_t transaction_id, int64_t object_store_id, int64_t index_id, WTF::Vector<IDBKeyRangePtr> key_ranges, uint32_t max_count);
    ...
    void GetAll(int64_t transaction_id, int64_t object_store_id, int64_t index_id, IDBKeyRangePtr key_range, bool key_only, int64_t max_count,
    ...
    IDBDatabaseOpenCursorResultPtr OpenCursor(
...
class MODULES_EXPORT IDBFactoryInterceptorForTesting : public IDBFactory {
    ...
    void Open(::mojo::PendingAssociatedRemote<IDBCallbacks> pending_callbacks, ::mojo::PendingAssociatedRemote<IDBDatabaseCallbacks> database_callbacks, const ::WTF::String& name,
        int64_t version, ::mojo::PendingAssociatedReceiver<IDBTransaction> version_change_transaction_receiver, int64_t transaction_id) override;
