...
class BLINK_COMMON_EXPORT IDBCallbacks : public IDBCallbacksInterfaceBase {
public:
...
// with not having this data in traces there.
    ...
    virtual void UpgradeNeeded(::mojo::PendingAssociatedRemote<IDBDatabase> pending_database, int64_t old_version, IDBDataLoss data_loss, const std::string& data_loss_message,
        const ::blink::IndexedDBDatabaseMetadata& db_metadata)
        = 0;
...
// with not having this data in traces there.
    ...
    virtual void Put(int64_t object_store_id, IDBValuePtr value, const ::blink::IndexedDBKey& key, IDBPutMode mode, const std::vector<::blink::IndexedDBIndexKeys>& index_keys,
...
// with not having this data in traces there.
    ...
    virtual void CreateTransaction(::mojo::PendingAssociatedReceiver<IDBTransaction> transaction_receiver, int64_t transaction_id, const std::vector<int64_t>& object_store_ids,
    ...
    virtual void BatchGetAll(int64_t transaction_id, int64_t object_store_id, int64_t index_id, const std::vector<::blink::IndexedDBKeyRange>& key_ranges, uint32_t max_count,
        BatchGetAllCallback callback)
        = 0;
    ...
    virtual void SetIndexKeys(int64_t transaction_id, int64_t object_store_id, const ::blink::IndexedDBKey& primary_key, const std::vector<::blink::IndexedDBIndexKeys>& index_keys)
        = 0;
    ...
    virtual void OpenCursor(int64_t transaction_id, int64_t object_store_id, int64_t index_id, const ::blink::IndexedDBKeyRange& key_range, IDBCursorDirection direction,
        bool key_only, IDBTaskType task_type, OpenCursorCallback callback)
        = 0;

    virtual void Count(int64_t transaction_id, int64_t object_store_id, int64_t index_id, const ::blink::IndexedDBKeyRange& key_range,
        ::mojo::PendingAssociatedRemote<IDBCallbacks> pending_callbacks)
        = 0;
...
// with not having this data in traces there.
    ...
    virtual void Open(::mojo::PendingAssociatedRemote<IDBCallbacks> pending_callbacks, ::mojo::PendingAssociatedRemote<IDBDatabaseCallbacks> database_callbacks,
        const ::std::u16string& name, int64_t version, ::mojo::PendingAssociatedReceiver<IDBTransaction> version_change_transaction_receiver, int64_t transaction_id)
        = 0;
...
//
//   void UpgradeNeeded(::mojo::PendingAssociatedRemote<IDBDatabase> pending_database, int64_t old_version, IDBDataLoss data_loss, const std::string& data_loss_message, const
//   ::blink::IndexedDBDatabaseMetadata& db_metadata) final;
//
...
//
//   void Put(int64_t object_store_id, IDBValuePtr value, const ::blink::IndexedDBKey& key, IDBPutMode mode, const std::vector<::blink::IndexedDBIndexKeys>& index_keys, PutCallback
//   callback) final;
//
...
//   BatchGetAllCallback callback) final;
//
...
//
//   void GetAll(int64_t transaction_id, int64_t object_store_id, int64_t index_id, const ::blink::IndexedDBKeyRange& key_range, bool key_only, int64_t max_count, GetAllCallback
//   callback) final;
//
...
//
//   void Count(int64_t transaction_id, int64_t object_store_id, int64_t index_id, const ::blink::IndexedDBKeyRange& key_range, ::mojo::PendingAssociatedRemote<IDBCallbacks>
//   pending_callbacks) final;
//
//   void DeleteRange(int64_t transaction_id, int64_t object_store_id, const ::blink::IndexedDBKeyRange& key_range, ::mojo::PendingAssociatedRemote<IDBCallbacks> pending_callbacks)
//   final;
//
...
//
//   void CreateIndex(int64_t transaction_id, int64_t object_store_id, int64_t index_id, const ::std::u16string& name, const ::blink::IndexedDBKeyPath& key_path, bool unique, bool
//   multi_entry) final;
//
...
//
//   void Open(::mojo::PendingAssociatedRemote<IDBCallbacks> pending_callbacks, ::mojo::PendingAssociatedRemote<IDBDatabaseCallbacks> database_callbacks, const ::std::u16string&
//   name, int64_t version, ::mojo::PendingAssociatedReceiver<IDBTransaction> version_change_transaction_receiver, int64_t transaction_id) final;
//
...
public:
    ...
    static IDBKeyPtr NewKeyArray(std::vector<::blink::IndexedDBKey> key_array)
    {
    ...
    static IDBKeyPtr NewBinary(std::vector<uint8_t> binary)
    {
        auto result = IDBKeyPtr(absl::in_place);
    ...
    static IDBKeyPtr NewString(const ::std::u16string& string)
    {
        auto result = IDBKeyPtr(absl::in_place);
...
public:
    ...
    // Construct an instance holding |string|.
    static IDBKeyPathDataPtr NewString(const ::std::u16string& string)
    {
    ...
    static IDBKeyPathDataPtr NewStringArray(std::vector<::std::u16string> string_array)
    {
        auto result = IDBKeyPathDataPtr(absl::in_place);
...
public:
    ...
    static IDBExternalObjectPtr NewFileSystemAccessToken(::mojo::PendingRemote<::blink::mojom::FileSystemAccessTransferToken> file_system_access_token)
    {
        auto result = IDBExternalObjectPtr(absl::in_place);
...
public:
    ...
    static IDBTransactionPutResultPtr NewKey(const ::blink::IndexedDBKey& key)
    {
        auto result = IDBTransactionPutResultPtr(absl::in_place);
    ...
    ~IDBTransactionPutResult() = default;
...
public:
    ...
    // Construct an instance holding |key|.
    static IDBDatabaseGetResultPtr NewKey(const ::blink::IndexedDBKey& key)
    {
        auto result = IDBDatabaseGetResultPtr(absl::in_place);
        result->set_key(std::move(key));
        return result;
...
public:
    ...
    // Construct an instance holding |values|.
    static IDBDatabaseBatchGetAllResultPtr NewValues(std::vector<std::vector<IDBReturnValuePtr>> values)
    {
        auto result = IDBDatabaseBatchGetAllResultPtr(absl::in_place);
        result->set_values(std::move(values));
        return result;
    ...
    ~IDBDatabaseBatchGetAllResult() = default;
    ...
    void set_values(std::vector<std::vector<IDBReturnValuePtr>> values);
...
public:
    ...
    ~IDBDatabaseOpenCursorResult() = default;
...
public:
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input) { return mojo::internal::SerializeImpl<IDBKeyPath::DataView, std::vector<uint8_t>>(input); }
...
public:
    ...
    IDBIndexMetadata(int64_t id_in, const ::std::u16string& name_in, const ::blink::IndexedDBKeyPath& key_path_in, bool unique_in, bool multi_entry_in)
        : id(std::move(id_in))
...
public:
    ...
    IDBObjectStoreMetadata(int64_t id_in, const ::std::u16string& name_in, const ::blink::IndexedDBKeyPath& key_path_in, bool auto_increment_in, int64_t max_index_id_in,
        const base::flat_map<int64_t, ::blink::IndexedDBIndexMetadata>& indexes_in)
        : id(std::move(id_in))
        , name(std::move(name_in))
        , key_path(std::move(key_path_in))
...
public:
    ...
    IDBBlobInfo(::mojo::PendingRemote<::blink::mojom::Blob> blob_in, const std::string& uuid_in, const ::std::u16string& mime_type_in, int64_t size_in, IDBFileInfoPtr file_in)
...
public:
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input) { return mojo::internal::SerializeImpl<IDBError::DataView, std::vector<uint8_t>>(input); }
...
public:
    ...
    IDBCursorValue(std::vector<::blink::IndexedDBKey> keys_in, std::vector<::blink::IndexedDBKey> primary_keys_in, std::vector<IDBValuePtr> values_in)
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::IDBKeyPath::DataView, ::blink::mojom::IDBKeyPathPtr> {
    ...
    static const decltype(::blink::mojom::IDBKeyPath::data)& data(const ::blink::mojom::IDBKeyPathPtr& input) { return input->data; }
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::IDBKeyRange::DataView, ::blink::mojom::IDBKeyRangePtr> {
    ...
    static const decltype(::blink::mojom::IDBKeyRange::lower)& lower(const ::blink::mojom::IDBKeyRangePtr& input) { return input->lower; }

    static const decltype(::blink::mojom::IDBKeyRange::upper)& upper(const ::blink::mojom::IDBKeyRangePtr& input) { return input->upper; }

    static decltype(::blink::mojom::IDBKeyRange::lower_open) lower_open(const ::blink::mojom::IDBKeyRangePtr& input) { return input->lower_open; }

    static decltype(::blink::mojom::IDBKeyRange::upper_open) upper_open(const ::blink::mojom::IDBKeyRangePtr& input) { return input->upper_open; }
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::IDBIndexMetadata::DataView, ::blink::mojom::IDBIndexMetadataPtr> {
    ...
    static decltype(::blink::mojom::IDBIndexMetadata::id) id(const ::blink::mojom::IDBIndexMetadataPtr& input) { return input->id; }

    static const decltype(::blink::mojom::IDBIndexMetadata::name)& name(const ::blink::mojom::IDBIndexMetadataPtr& input) { return input->name; }

    static const decltype(::blink::mojom::IDBIndexMetadata::key_path)& key_path(const ::blink::mojom::IDBIndexMetadataPtr& input) { return input->key_path; }

    static decltype(::blink::mojom::IDBIndexMetadata::unique) unique(const ::blink::mojom::IDBIndexMetadataPtr& input) { return input->unique; }

    static decltype(::blink::mojom::IDBIndexMetadata::multi_entry) multi_entry(const ::blink::mojom::IDBIndexMetadataPtr& input) { return input->multi_entry; }
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::IDBObjectStoreMetadata::DataView, ::blink::mojom::IDBObjectStoreMetadataPtr> {
    ...
    static decltype(::blink::mojom::IDBObjectStoreMetadata::id) id(const ::blink::mojom::IDBObjectStoreMetadataPtr& input) { return input->id; }

    static const decltype(::blink::mojom::IDBObjectStoreMetadata::name)& name(const ::blink::mojom::IDBObjectStoreMetadataPtr& input) { return input->name; }

    static const decltype(::blink::mojom::IDBObjectStoreMetadata::key_path)& key_path(const ::blink::mojom::IDBObjectStoreMetadataPtr& input) { return input->key_path; }

    static decltype(::blink::mojom::IDBObjectStoreMetadata::auto_increment) auto_increment(const ::blink::mojom::IDBObjectStoreMetadataPtr& input) { return input->auto_increment; }

    static decltype(::blink::mojom::IDBObjectStoreMetadata::max_index_id) max_index_id(const ::blink::mojom::IDBObjectStoreMetadataPtr& input) { return input->max_index_id; }

    static const decltype(::blink::mojom::IDBObjectStoreMetadata::indexes)& indexes(const ::blink::mojom::IDBObjectStoreMetadataPtr& input) { return input->indexes; }
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::IDBDatabaseMetadata::DataView, ::blink::mojom::IDBDatabaseMetadataPtr> {
    ...
    static decltype(::blink::mojom::IDBDatabaseMetadata::id) id(const ::blink::mojom::IDBDatabaseMetadataPtr& input) { return input->id; }

    static const decltype(::blink::mojom::IDBDatabaseMetadata::name)& name(const ::blink::mojom::IDBDatabaseMetadataPtr& input) { return input->name; }

    static decltype(::blink::mojom::IDBDatabaseMetadata::version) version(const ::blink::mojom::IDBDatabaseMetadataPtr& input) { return input->version; }
    ...
    static const decltype(::blink::mojom::IDBDatabaseMetadata::object_stores)& object_stores(const ::blink::mojom::IDBDatabaseMetadataPtr& input) { return input->object_stores; }

    static decltype(::blink::mojom::IDBDatabaseMetadata::was_cold_open) was_cold_open(const ::blink::mojom::IDBDatabaseMetadataPtr& input) { return input->was_cold_open; }
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::IDBNameAndVersion::DataView, ::blink::mojom::IDBNameAndVersionPtr> {
    ...
    static const decltype(::blink::mojom::IDBNameAndVersion::name)& name(const ::blink::mojom::IDBNameAndVersionPtr& input) { return input->name; }

    static decltype(::blink::mojom::IDBNameAndVersion::version) version(const ::blink::mojom::IDBNameAndVersionPtr& input) { return input->version; }
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::IDBIndexKeys::DataView, ::blink::mojom::IDBIndexKeysPtr> {
    ...
    static decltype(::blink::mojom::IDBIndexKeys::index_id) index_id(const ::blink::mojom::IDBIndexKeysPtr& input) { return input->index_id; }

    static const decltype(::blink::mojom::IDBIndexKeys::index_keys)& index_keys(const ::blink::mojom::IDBIndexKeysPtr& input) { return input->index_keys; }
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::IDBFileInfo::DataView, ::blink::mojom::IDBFileInfoPtr> {
    ...
    static const decltype(::blink::mojom::IDBFileInfo::name)& name(const ::blink::mojom::IDBFileInfoPtr& input) { return input->name; }

    static const decltype(::blink::mojom::IDBFileInfo::last_modified)& last_modified(const ::blink::mojom::IDBFileInfoPtr& input) { return input->last_modified; }
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::IDBBlobInfo::DataView, ::blink::mojom::IDBBlobInfoPtr> {
    ...
    static decltype(::blink::mojom::IDBBlobInfo::blob)& blob(::blink::mojom::IDBBlobInfoPtr& input) { return input->blob; }

    static const decltype(::blink::mojom::IDBBlobInfo::uuid)& uuid(const ::blink::mojom::IDBBlobInfoPtr& input) { return input->uuid; }

    static const decltype(::blink::mojom::IDBBlobInfo::mime_type)& mime_type(const ::blink::mojom::IDBBlobInfoPtr& input) { return input->mime_type; }

    static decltype(::blink::mojom::IDBBlobInfo::size) size(const ::blink::mojom::IDBBlobInfoPtr& input) { return input->size; }

    static const decltype(::blink::mojom::IDBBlobInfo::file)& file(const ::blink::mojom::IDBBlobInfoPtr& input) { return input->file; }
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::IDBValue::DataView, ::blink::mojom::IDBValuePtr> {
    ...
    static const decltype(::blink::mojom::IDBValue::bits)& bits(const ::blink::mojom::IDBValuePtr& input) { return input->bits; }

    static decltype(::blink::mojom::IDBValue::external_objects)& external_objects(::blink::mojom::IDBValuePtr& input) { return input->external_objects; }
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::IDBReturnValue::DataView, ::blink::mojom::IDBReturnValuePtr> {
    ...
    static decltype(::blink::mojom::IDBReturnValue::value)& value(::blink::mojom::IDBReturnValuePtr& input) { return input->value; }

    static const decltype(::blink::mojom::IDBReturnValue::primary_key)& primary_key(const ::blink::mojom::IDBReturnValuePtr& input) { return input->primary_key; }

    static const decltype(::blink::mojom::IDBReturnValue::key_path)& key_path(const ::blink::mojom::IDBReturnValuePtr& input) { return input->key_path; }
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::IDBError::DataView, ::blink::mojom::IDBErrorPtr> {
    ...
    static decltype(::blink::mojom::IDBError::error_code) error_code(const ::blink::mojom::IDBErrorPtr& input) { return input->error_code; }

    static const decltype(::blink::mojom::IDBError::error_message)& error_message(const ::blink::mojom::IDBErrorPtr& input) { return input->error_message; }
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::IDBCursorValue::DataView, ::blink::mojom::IDBCursorValuePtr> {
    ...
    static const decltype(::blink::mojom::IDBCursorValue::keys)& keys(const ::blink::mojom::IDBCursorValuePtr& input) { return input->keys; }

    static const decltype(::blink::mojom::IDBCursorValue::primary_keys)& primary_keys(const ::blink::mojom::IDBCursorValuePtr& input) { return input->primary_keys; }

    static decltype(::blink::mojom::IDBCursorValue::values)& values(::blink::mojom::IDBCursorValuePtr& input) { return input->values; }
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::IDBDatabaseOpenCursorValue::DataView, ::blink::mojom::IDBDatabaseOpenCursorValuePtr> {
    ...
    static decltype(::blink::mojom::IDBDatabaseOpenCursorValue::cursor)& cursor(::blink::mojom::IDBDatabaseOpenCursorValuePtr& input) { return input->cursor; }

    static const decltype(::blink::mojom::IDBDatabaseOpenCursorValue::key)& key(const ::blink::mojom::IDBDatabaseOpenCursorValuePtr& input) { return input->key; }
    ...
    static decltype(::blink::mojom::IDBDatabaseOpenCursorValue::value)& value(::blink::mojom::IDBDatabaseOpenCursorValuePtr& input) { return input->value; }
...
template <> struct BLINK_COMMON_EXPORT UnionTraits<::blink::mojom::IDBKey::DataView, ::blink::mojom::IDBKeyPtr> {
    ...
    static ::blink::mojom::IDBKey::Tag GetTag(const ::blink::mojom::IDBKeyPtr& input) { return input->which(); }

    static const std::vector<::blink::IndexedDBKey>& key_array(const ::blink::mojom::IDBKeyPtr& input) { return input->get_key_array(); }

    static const std::vector<uint8_t>& binary(const ::blink::mojom::IDBKeyPtr& input) { return input->get_binary(); }

    static const ::std::u16string& string(const ::blink::mojom::IDBKeyPtr& input) { return input->get_string(); }

    static double date(const ::blink::mojom::IDBKeyPtr& input) { return input->get_date(); }

    static double number(const ::blink::mojom::IDBKeyPtr& input) { return input->get_number(); }

    static bool other_none(const ::blink::mojom::IDBKeyPtr& input) { return input->get_other_none(); }
...
template <> struct BLINK_COMMON_EXPORT UnionTraits<::blink::mojom::IDBKeyPathData::DataView, ::blink::mojom::IDBKeyPathDataPtr> {
    ...
    static ::blink::mojom::IDBKeyPathData::Tag GetTag(const ::blink::mojom::IDBKeyPathDataPtr& input) { return input->which(); }

    static const ::std::u16string& string(const ::blink::mojom::IDBKeyPathDataPtr& input) { return input->get_string(); }

    static const std::vector<::std::u16string>& string_array(const ::blink::mojom::IDBKeyPathDataPtr& input) { return input->get_string_array(); }
...
template <> struct BLINK_COMMON_EXPORT UnionTraits<::blink::mojom::IDBExternalObject::DataView, ::blink::mojom::IDBExternalObjectPtr> {
    ...
    static ::blink::mojom::IDBExternalObject::Tag GetTag(const ::blink::mojom::IDBExternalObjectPtr& input) { return input->which(); }

    static ::blink::mojom::IDBBlobInfoPtr& blob_or_file(::blink::mojom::IDBExternalObjectPtr& input) { return input->get_blob_or_file(); }
...
template <> struct BLINK_COMMON_EXPORT UnionTraits<::blink::mojom::IDBCursorResult::DataView, ::blink::mojom::IDBCursorResultPtr> {
    ...
    static ::blink::mojom::IDBCursorResult::Tag GetTag(const ::blink::mojom::IDBCursorResultPtr& input) { return input->which(); }

    static const ::blink::mojom::IDBErrorPtr& error_result(const ::blink::mojom::IDBCursorResultPtr& input) { return input->get_error_result(); }

    static bool empty(const ::blink::mojom::IDBCursorResultPtr& input) { return input->get_empty(); }

    static ::blink::mojom::IDBCursorValuePtr& values(::blink::mojom::IDBCursorResultPtr& input) { return input->get_values(); }
...
template <> struct BLINK_COMMON_EXPORT UnionTraits<::blink::mojom::IDBTransactionPutResult::DataView, ::blink::mojom::IDBTransactionPutResultPtr> {
    ...
    static ::blink::mojom::IDBTransactionPutResult::Tag GetTag(const ::blink::mojom::IDBTransactionPutResultPtr& input) { return input->which(); }

    static const ::blink::mojom::IDBErrorPtr& error_result(const ::blink::mojom::IDBTransactionPutResultPtr& input) { return input->get_error_result(); }

    static const ::blink::IndexedDBKey& key(const ::blink::mojom::IDBTransactionPutResultPtr& input) { return input->get_key(); }
...
template <> struct BLINK_COMMON_EXPORT UnionTraits<::blink::mojom::IDBDatabaseGetResult::DataView, ::blink::mojom::IDBDatabaseGetResultPtr> {
    ...
    static ::blink::mojom::IDBDatabaseGetResult::Tag GetTag(const ::blink::mojom::IDBDatabaseGetResultPtr& input) { return input->which(); }

    static const ::blink::mojom::IDBErrorPtr& error_result(const ::blink::mojom::IDBDatabaseGetResultPtr& input) { return input->get_error_result(); }

    static bool empty(const ::blink::mojom::IDBDatabaseGetResultPtr& input) { return input->get_empty(); }

    static const ::blink::IndexedDBKey& key(const ::blink::mojom::IDBDatabaseGetResultPtr& input) { return input->get_key(); }

    static ::blink::mojom::IDBReturnValuePtr& value(::blink::mojom::IDBDatabaseGetResultPtr& input) { return input->get_value(); }

    static bool Read(::blink::mojom::IDBDatabaseGetResult::DataView input, ::blink::mojom::IDBDatabaseGetResultPtr* output);
};
template <> struct BLINK_COMMON_EXPORT UnionTraits<::blink::mojom::IDBDatabaseBatchGetAllResult::DataView, ::blink::mojom::IDBDatabaseBatchGetAllResultPtr> {
    ...
    static ::blink::mojom::IDBDatabaseBatchGetAllResult::Tag GetTag(const ::blink::mojom::IDBDatabaseBatchGetAllResultPtr& input) { return input->which(); }

    static const ::blink::mojom::IDBErrorPtr& error_result(const ::blink::mojom::IDBDatabaseBatchGetAllResultPtr& input) { return input->get_error_result(); }

    static std::vector<std::vector<::blink::mojom::IDBReturnValuePtr>>& values(::blink::mojom::IDBDatabaseBatchGetAllResultPtr& input) { return input->get_values(); }
...
template <> struct BLINK_COMMON_EXPORT UnionTraits<::blink::mojom::IDBDatabaseOpenCursorResult::DataView, ::blink::mojom::IDBDatabaseOpenCursorResultPtr> {
    ...
    static ::blink::mojom::IDBDatabaseOpenCursorResult::Tag GetTag(const ::blink::mojom::IDBDatabaseOpenCursorResultPtr& input) { return input->which(); }

    static const ::blink::mojom::IDBErrorPtr& error_result(const ::blink::mojom::IDBDatabaseOpenCursorResultPtr& input) { return input->get_error_result(); }

    static bool empty(const ::blink::mojom::IDBDatabaseOpenCursorResultPtr& input) { return input->get_empty(); }

    static ::blink::mojom::IDBDatabaseOpenCursorValuePtr& value(::blink::mojom::IDBDatabaseOpenCursorResultPtr& input) { return input->get_value(); }
