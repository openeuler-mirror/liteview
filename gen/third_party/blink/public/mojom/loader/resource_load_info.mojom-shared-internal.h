...
template <typename UserType, typename DataView> const mojo::internal::UnserializedMessageContext::Tag RedirectInfo_UnserializedMessageContext<UserType, DataView>::kMessageTag = {};
...
public:
    ...
    uint8_t was_in_network_service_memory_cache : 1;
    uint8_t pad9_[3];
    int32_t net_error;
    mojo::internal::Pointer<internal::CommonNetworkInfo_Data> network_info;
...
static_assert(sizeof(ResourceLoadInfo_Data) == 112, "Bad sizeof(ResourceLoadInfo_Data)");
