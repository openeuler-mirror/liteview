...
struct blink_mojom_internal_CodeCacheType_DataHashFn {
    ...
    static bool Equal(const ::blink::mojom::CodeCacheType& left, const ::blink::mojom::CodeCacheType& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::blink::mojom::CodeCacheType> : public GenericHashTraits<::blink::mojom::CodeCacheType> {
    static_assert(true, "-1000000 is a reserved enum value");
    static_assert(true, "-1000001 is a reserved enum value");
    static const bool kEmptyValueIsZero = false;
    static ::blink::mojom::CodeCacheType EmptyValue() { return static_cast<::blink::mojom::CodeCacheType>(-1000000); }
    static void ConstructDeletedValue(::blink::mojom::CodeCacheType& slot, bool) { slot = static_cast<::blink::mojom::CodeCacheType>(-1000001); }
    static bool IsDeletedValue(const ::blink::mojom::CodeCacheType& value) { return value == static_cast<::blink::mojom::CodeCacheType>(-1000001); }
};
} // namespace WTF
namespace blink {
namespace mojom {
...
// with not having this data in traces there.
    ...
    virtual void DidGenerateCacheableMetadataInCacheStorage(const ::blink::KURL& url, ::base::Time expected_response_time, ::mojo_base::BigBuffer data,
...
//
//   void DidGenerateCacheableMetadataInCacheStorage(const ::blink::KURL& url, ::base::Time expected_response_time, ::mojo_base::BigBuffer data, const ::scoped_refptr<const
//   ::blink::SecurityOrigin>& cache_storage_origin, const WTF::String& cache_storage_cache_name) final;
//
//  private:
