...
AnchorElementClick::AnchorElementClick(uint32_t anchor_id_in, const ::blink::KURL& target_url_in)
    : anchor_id(std::move(anchor_id_in))
    , target_url(std::move(target_url_in))
{
}
...
void AnchorElementMetricsHostProxy::ReportNewAnchorElements(WTF::Vector<AnchorElementMetricsPtr> in_metrics)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
bool AnchorElementMetricsHostStubDispatch::Accept(AnchorElementMetricsHost* impl, mojo::Message* message)
{
    ...
    case internal::kAnchorElementMetricsHost_ReportNewAnchorElements_Name: {
        ...
        bool success = true;
        WTF::Vector<AnchorElementMetricsPtr> p_metrics = mojo::DefaultConstructTraits::CreateInstance<WTF::Vector<AnchorElementMetricsPtr>>();
    ...
    case internal::kAnchorElementMetricsHost_ReportAnchorElementsEnteredViewport_Name: {
        ...
        bool success = true;
        WTF::Vector<AnchorElementEnteredViewportPtr> p_elements = mojo::DefaultConstructTraits::CreateInstance<WTF::Vector<AnchorElementEnteredViewportPtr>>();
