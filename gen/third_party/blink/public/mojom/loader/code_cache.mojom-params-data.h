...
static_assert(
    sizeof(CodeCacheHost_DidGenerateCacheableMetadataInCacheStorage_Params_Data) == 56, "Bad sizeof(CodeCacheHost_DidGenerateCacheableMetadataInCacheStorage_Params_Data)");
...
public:
    ...
    CodeCacheType cache_type() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::blink::mojom::CodeCacheType>(data_->cache_type)); }
...
public:
    ...
    inline void GetCacheStorageOriginDataView(::url::mojom::OriginDataView* output);

    template <typename UserType> [[nodiscard]] bool ReadCacheStorageOrigin(UserType* output)
    {
...
inline void CodeCacheHost_DidGenerateCacheableMetadataInCacheStorage_ParamsDataView::GetCacheStorageOriginDataView(::url::mojom::OriginDataView* output)
{
    auto pointer = data_->cache_storage_origin.Get();
