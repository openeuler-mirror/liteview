// third_party/blink/public/mojom/loader/content_security_notifier.mojom-lite-for-compile.js is auto generated by mojom_bindings_generator.py, do not edit
...
goog.provide('blink.mojom.ContentSecurityNotifier');
goog.provide('blink.mojom.ContentSecurityNotifierReceiver');
goog.provide('blink.mojom.ContentSecurityNotifierCallbackRouter');
goog.provide('blink.mojom.ContentSecurityNotifierInterface');
goog.provide('blink.mojom.ContentSecurityNotifierRemote');
goog.provide('blink.mojom.ContentSecurityNotifierPendingReceiver');
...
/** @interface */
blink.mojom.ContentSecurityNotifierInterface = class {
...
goog.provide('blink.mojom.ContentSecurityNotifier_NotifyContentWithCertificateErrorsRan_ParamsSpec');
/**
...
goog.provide('blink.mojom.ContentSecurityNotifier_NotifyContentWithCertificateErrorsDisplayed_ParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('blink.mojom.ContentSecurityNotifier_NotifyInsecureContentRan_ParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('blink.mojom.ContentSecurityNotifier_NotifyContentWithCertificateErrorsRan_Params');
...
goog.provide('blink.mojom.ContentSecurityNotifier_NotifyContentWithCertificateErrorsDisplayed_Params');
...
goog.provide('blink.mojom.ContentSecurityNotifier_NotifyInsecureContentRan_Params');
