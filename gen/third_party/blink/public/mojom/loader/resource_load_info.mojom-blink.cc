...
CommonNetworkInfo::CommonNetworkInfo(bool network_accessed_in, bool always_access_network_in, const absl::optional<::net::IPEndPoint>& remote_endpoint_in)
...
bool CommonNetworkInfo::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
bool RedirectInfo::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
ResourceLoadInfo::ResourceLoadInfo(int64_t request_id_in, const ::blink::KURL& final_url_in, const ::blink::KURL& referrer_in, const ::blink::KURL& original_url_in,
    const WTF::String& method_in, ::network::mojom::blink::RequestDestination request_destination_in, ::net::RequestPriority request_priority_in, const WTF::String& mime_type_in,
    bool was_cached_in, bool was_in_network_service_memory_cache_in, CommonNetworkInfoPtr network_info_in, int32_t net_error_in,
    ::network::mojom::blink::LoadTimingInfoPtr load_timing_info_in, int64_t raw_body_bytes_in, int64_t total_received_bytes_in, WTF::Vector<RedirectInfoPtr> redirect_info_chain_in)
...
void ResourceLoadInfo::WriteIntoTrace(perfetto::TracedValue traced_context) const
{
    ...
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("was_in_network_service_memory_cache"), this->was_in_network_service_memory_cache,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
        "<value of type bool>"
#else
        "<value>"
...
bool ResourceLoadInfo::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
