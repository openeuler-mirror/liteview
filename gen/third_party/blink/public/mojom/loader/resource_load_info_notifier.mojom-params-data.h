...
static_assert(sizeof(ResourceLoadInfoNotifier_NotifyResourceRedirectReceived_Params_Data) == 24, "Bad sizeof(ResourceLoadInfoNotifier_NotifyResourceRedirectReceived_Params_Data)");
...
static_assert(sizeof(ResourceLoadInfoNotifier_NotifyResourceResponseReceived_Params_Data) == 40, "Bad sizeof(ResourceLoadInfoNotifier_NotifyResourceResponseReceived_Params_Data)");
...
static_assert(
    sizeof(ResourceLoadInfoNotifier_NotifyResourceTransferSizeUpdated_Params_Data) == 24, "Bad sizeof(ResourceLoadInfoNotifier_NotifyResourceTransferSizeUpdated_Params_Data)");
...
static_assert(sizeof(ResourceLoadInfoNotifier_NotifyResourceLoadCompleted_Params_Data) == 24, "Bad sizeof(ResourceLoadInfoNotifier_NotifyResourceLoadCompleted_Params_Data)");
...
static_assert(sizeof(ResourceLoadInfoNotifier_NotifyResourceLoadCanceled_Params_Data) == 16, "Bad sizeof(ResourceLoadInfoNotifier_NotifyResourceLoadCanceled_Params_Data)");
...
public:
    ...
    bool is_null() const { return !data_; }
    int64_t request_id() const { return data_->request_id; }
    int32_t transfer_size_diff() const { return data_->transfer_size_diff; }
...
public:
    ...
    ResourceLoadInfoNotifier_NotifyResourceLoadCompleted_ParamsDataView(internal::ResourceLoadInfoNotifier_NotifyResourceLoadCompleted_Params_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
...
public:
    ...
    ResourceLoadInfoNotifier_NotifyResourceLoadCanceled_ParamsDataView(internal::ResourceLoadInfoNotifier_NotifyResourceLoadCanceled_Params_Data* data, mojo::Message* message)
        : data_(data)
    {
    }
...
inline void ResourceLoadInfoNotifier_NotifyResourceRedirectReceived_ParamsDataView::GetRedirectInfoDataView(::network::mojom::URLRequestRedirectInfoDataView* output)
{
    auto pointer = data_->redirect_info.Get();
    *output = ::network::mojom::URLRequestRedirectInfoDataView(pointer, message_);
}
inline void ResourceLoadInfoNotifier_NotifyResourceRedirectReceived_ParamsDataView::GetRedirectResponseDataView(::network::mojom::URLResponseHeadDataView* output)
{
    auto pointer = data_->redirect_response.Get();
