...
struct blink_mojom_internal_MHTMLLoadResult_DataHashFn {
    ...
    static bool Equal(const ::blink::mojom::MHTMLLoadResult& left, const ::blink::mojom::MHTMLLoadResult& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::blink::mojom::MHTMLLoadResult> : public GenericHashTraits<::blink::mojom::MHTMLLoadResult> {
    ...
    static void ConstructDeletedValue(::blink::mojom::MHTMLLoadResult& slot, bool) { slot = static_cast<::blink::mojom::MHTMLLoadResult>(-1000001); }
    static bool IsDeletedValue(const ::blink::mojom::MHTMLLoadResult& value) { return value == static_cast<::blink::mojom::MHTMLLoadResult>(-1000001); }
};
} // namespace WTF
namespace blink {
namespace mojom {
