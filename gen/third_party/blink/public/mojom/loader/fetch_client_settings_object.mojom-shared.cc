...
static NOINLINE const char* InsecureRequestsPolicyToStringHelper(InsecureRequestsPolicy value)
{
...
std::ostream& operator<<(std::ostream& os, InsecureRequestsPolicy value) { return os << InsecureRequestsPolicyToString(value); }
