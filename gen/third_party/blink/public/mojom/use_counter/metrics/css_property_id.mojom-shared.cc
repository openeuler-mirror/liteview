...
static NOINLINE const char* CSSSampleIdToStringHelper(CSSSampleId value)
{
    ...
    case CSSSampleId::kInvalid:
        return "{kInvalid, kInternalAlignSelfBlock, kInternalEmptyLineHeight, kInternalVisitedBackgroundColor, kInternalVisitedBorderBlockEndColor, "
               "kInternalVisitedBorderBlockStartColor, kInternalVisitedBorderBottomColor, kInternalVisitedBorderInlineEndColor, kInternalVisitedBorderInlineStartColor, "
               "kInternalVisitedBorderLeftColor, kInternalVisitedBorderRightColor, kInternalVisitedBorderTopColor, kInternalVisitedCaretColor, kInternalVisitedColor, "
               "kInternalVisitedColumnRuleColor, kInternalVisitedFill, kInternalVisitedOutlineColor, kInternalVisitedStroke, kInternalVisitedTextDecorationColor, "
               "kInternalVisitedTextEmphasisColor, kInternalVisitedTextFillColor, kInternalVisitedTextStrokeColor, kInternalFontSizeDelta, kInternalForcedBackgroundColor, "
               "kInternalForcedBorderColor, kInternalForcedColor, kInternalForcedOutlineColor, kInternalForcedVisitedColor}";
...
std::ostream& operator<<(std::ostream& os, CSSSampleId value) { return os << CSSSampleIdToString(value); }
