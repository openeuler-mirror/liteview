...
template <> struct BLINK_COMMON_EXPORT UnionTraits<::blink::mojom::BadgeValue::DataView, ::blink::mojom::BadgeValuePtr> {
    ...
    static ::blink::mojom::BadgeValue::Tag GetTag(const ::blink::mojom::BadgeValuePtr& input) { return input->which(); }

    static uint8_t flag(const ::blink::mojom::BadgeValuePtr& input) { return input->get_flag(); }

    static uint64_t number(const ::blink::mojom::BadgeValuePtr& input) { return input->get_number(); }
