...
public:
    ...
    static BadgeValuePtr NewFlag(uint8_t flag)
    {
    ...
    static BadgeValuePtr NewNumber(uint64_t number)
    {
        auto result = BadgeValuePtr(absl::in_place);
    ...
    template <typename U> static BadgeValuePtr From(const U& u) { return mojo::TypeConverter<BadgeValuePtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, BadgeValue>::Convert(*this); }
    ...
    template <typename T, typename std::enable_if<std::is_same<T, BadgeValue>::value>::type* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    ...
    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<BadgeValue::DataView>(input); }
...
template <> struct PLATFORM_EXPORT UnionTraits<::blink::mojom::blink::BadgeValue::DataView, ::blink::mojom::blink::BadgeValuePtr> {
    ...
    static ::blink::mojom::blink::BadgeValue::Tag GetTag(const ::blink::mojom::blink::BadgeValuePtr& input) { return input->which(); }

    static uint8_t flag(const ::blink::mojom::blink::BadgeValuePtr& input) { return input->get_flag(); }

    static uint64_t number(const ::blink::mojom::blink::BadgeValuePtr& input) { return input->get_number(); }
