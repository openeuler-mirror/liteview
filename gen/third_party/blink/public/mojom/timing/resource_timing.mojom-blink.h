...
struct blink_mojom_internal_CacheState_DataHashFn {
    ...
    static bool Equal(const ::blink::mojom::CacheState& left, const ::blink::mojom::CacheState& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::blink::mojom::CacheState> : public GenericHashTraits<::blink::mojom::CacheState> {
    ...
    static void ConstructDeletedValue(::blink::mojom::CacheState& slot, bool) { slot = static_cast<::blink::mojom::CacheState>(-1000001); }
    static bool IsDeletedValue(const ::blink::mojom::CacheState& value) { return value == static_cast<::blink::mojom::CacheState>(-1000001); }
};
} // namespace WTF
namespace blink {
namespace mojom {
...
public:
    ...
    template <typename... Args> static ServerTimingInfoPtr New(Args&&... args) { return ServerTimingInfoPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static ServerTimingInfoPtr From(const U& u) { return mojo::TypeConverter<ServerTimingInfoPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, ServerTimingInfo>::Convert(*this); }
    ServerTimingInfo()
        : name()
        , duration()
        , description()
    ...
    template <typename T, ServerTimingInfo::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    ...
    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<ServerTimingInfo::DataView>(input); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::ServerTimingInfo_UnserializedMessageContext<UserType, ServerTimingInfo::DataView>>(0, 0, std::move(input)), MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    {
        return ServerTimingInfo::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, ServerTimingInfo::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, ServerTimingInfo::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, ServerTimingInfo::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static ResourceTimingInfoPtr New(Args&&... args) { return ResourceTimingInfoPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static ResourceTimingInfoPtr From(const U& u) { return mojo::TypeConverter<ResourceTimingInfoPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, ResourceTimingInfo>::Convert(*this); }
    ResourceTimingInfo()
        : name()
        , start_time()
    ...
    ResourceTimingInfo(const WTF::String& name_in, ::base::TimeTicks start_time_in, const WTF::String& alpn_negotiated_protocol_in, const WTF::String& connection_info_in,
        ::network::mojom::blink::LoadTimingInfoPtr timing_in, ::base::TimeTicks last_redirect_end_time_in, ::base::TimeTicks response_end_in,
        ::blink::mojom::blink::RequestContextType context_type_in, ::network::mojom::blink::RequestDestination request_destination_in, CacheState cache_state_in,
        uint64_t encoded_body_size_in, uint64_t decoded_body_size_in, bool did_reuse_connection_in, bool is_secure_transport_in, bool allow_timing_details_in,
        bool allow_redirect_details_in, bool allow_negative_values_in, WTF::Vector<ServerTimingInfoPtr> server_timing_in, bool render_blocking_status_in,
    ...
    template <typename T, ResourceTimingInfo::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static WTF::Vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<ResourceTimingInfo::DataView, WTF::Vector<uint8_t>>(input);
    }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<ResourceTimingInfo::DataView>(input); }
    ...
    template <typename UserType> static mojo::Message WrapAsMessage(UserType input)
    {
        return mojo::Message(std::make_unique<internal::ResourceTimingInfo_UnserializedMessageContext<UserType, ResourceTimingInfo::DataView>>(0, 0, std::move(input)),
    ...
    template <typename UserType> static bool Deserialize(const WTF::Vector<uint8_t>& input, UserType* output)
    {
        return ResourceTimingInfo::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, ResourceTimingInfo::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, ResourceTimingInfo::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, ResourceTimingInfo::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }

template <typename StructPtrType> ServerTimingInfoPtr ServerTimingInfo::Clone() const { return New(mojo::Clone(name), mojo::Clone(duration), mojo::Clone(description)); }
...
template <typename StructPtrType> ResourceTimingInfoPtr ResourceTimingInfo::Clone() const
{
    return New(mojo::Clone(name), mojo::Clone(start_time), mojo::Clone(alpn_negotiated_protocol), mojo::Clone(connection_info), mojo::Clone(timing),
        mojo::Clone(last_redirect_end_time), mojo::Clone(response_end), mojo::Clone(context_type), mojo::Clone(request_destination), mojo::Clone(cache_state),
        mojo::Clone(encoded_body_size), mojo::Clone(decoded_body_size), mojo::Clone(did_reuse_connection), mojo::Clone(is_secure_transport), mojo::Clone(allow_timing_details),
        mojo::Clone(allow_redirect_details), mojo::Clone(allow_negative_values), mojo::Clone(server_timing), mojo::Clone(render_blocking_status), mojo::Clone(response_status));
}
...
template <> struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::ServerTimingInfo::DataView, ::blink::mojom::blink::ServerTimingInfoPtr> {
    ...
    static const decltype(::blink::mojom::blink::ServerTimingInfo::name)& name(const ::blink::mojom::blink::ServerTimingInfoPtr& input) { return input->name; }

    static decltype(::blink::mojom::blink::ServerTimingInfo::duration) duration(const ::blink::mojom::blink::ServerTimingInfoPtr& input) { return input->duration; }

    static const decltype(::blink::mojom::blink::ServerTimingInfo::description)& description(const ::blink::mojom::blink::ServerTimingInfoPtr& input) { return input->description; }
...
template <> struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::ResourceTimingInfo::DataView, ::blink::mojom::blink::ResourceTimingInfoPtr> {
    ...
    static const decltype(::blink::mojom::blink::ResourceTimingInfo::name)& name(const ::blink::mojom::blink::ResourceTimingInfoPtr& input) { return input->name; }
    ...
    static const decltype(::blink::mojom::blink::ResourceTimingInfo::alpn_negotiated_protocol)& alpn_negotiated_protocol(const ::blink::mojom::blink::ResourceTimingInfoPtr& input)
    {
        return input->alpn_negotiated_protocol;
    }

    static const decltype(::blink::mojom::blink::ResourceTimingInfo::connection_info)& connection_info(const ::blink::mojom::blink::ResourceTimingInfoPtr& input)
    {
        return input->connection_info;
    }

    static const decltype(::blink::mojom::blink::ResourceTimingInfo::timing)& timing(const ::blink::mojom::blink::ResourceTimingInfoPtr& input) { return input->timing; }

    static const decltype(::blink::mojom::blink::ResourceTimingInfo::last_redirect_end_time)& last_redirect_end_time(const ::blink::mojom::blink::ResourceTimingInfoPtr& input)
    {
    ...
    static decltype(::blink::mojom::blink::ResourceTimingInfo::context_type) context_type(const ::blink::mojom::blink::ResourceTimingInfoPtr& input) { return input->context_type; }

    static decltype(::blink::mojom::blink::ResourceTimingInfo::request_destination) request_destination(const ::blink::mojom::blink::ResourceTimingInfoPtr& input)
    {
        return input->request_destination;
    }

    static decltype(::blink::mojom::blink::ResourceTimingInfo::cache_state) cache_state(const ::blink::mojom::blink::ResourceTimingInfoPtr& input) { return input->cache_state; }
    ...
    static decltype(::blink::mojom::blink::ResourceTimingInfo::did_reuse_connection) did_reuse_connection(const ::blink::mojom::blink::ResourceTimingInfoPtr& input)
    {
        return input->did_reuse_connection;
    }

    static decltype(::blink::mojom::blink::ResourceTimingInfo::is_secure_transport) is_secure_transport(const ::blink::mojom::blink::ResourceTimingInfoPtr& input)
    {
        return input->is_secure_transport;
    }

    static decltype(::blink::mojom::blink::ResourceTimingInfo::allow_timing_details) allow_timing_details(const ::blink::mojom::blink::ResourceTimingInfoPtr& input)
    {
        return input->allow_timing_details;
    }

    static decltype(::blink::mojom::blink::ResourceTimingInfo::allow_redirect_details) allow_redirect_details(const ::blink::mojom::blink::ResourceTimingInfoPtr& input)
    {
        return input->allow_redirect_details;
    }

    static decltype(::blink::mojom::blink::ResourceTimingInfo::allow_negative_values) allow_negative_values(const ::blink::mojom::blink::ResourceTimingInfoPtr& input)
    {
    ...
    static decltype(::blink::mojom::blink::ResourceTimingInfo::render_blocking_status) render_blocking_status(const ::blink::mojom::blink::ResourceTimingInfoPtr& input)
    {
