...
ResourceTimingInfo::ResourceTimingInfo(const std::string& name_in, ::base::TimeTicks start_time_in, const std::string& alpn_negotiated_protocol_in,
    const std::string& connection_info_in, const absl::optional<::net::LoadTimingInfo>& timing_in, ::base::TimeTicks last_redirect_end_time_in, ::base::TimeTicks response_end_in,
