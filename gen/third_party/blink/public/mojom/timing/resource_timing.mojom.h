...
public:
    ...
    ResourceTimingInfo(const std::string& name_in, ::base::TimeTicks start_time_in, const std::string& alpn_negotiated_protocol_in, const std::string& connection_info_in,
        const absl::optional<::net::LoadTimingInfo>& timing_in, ::base::TimeTicks last_redirect_end_time_in, ::base::TimeTicks response_end_in,
        ::blink::mojom::RequestContextType context_type_in, ::network::mojom::RequestDestination request_destination_in, CacheState cache_state_in, uint64_t encoded_body_size_in,
        uint64_t decoded_body_size_in, bool did_reuse_connection_in, bool is_secure_transport_in, bool allow_timing_details_in, bool allow_redirect_details_in,
        bool allow_negative_values_in, std::vector<ServerTimingInfoPtr> server_timing_in, bool render_blocking_status_in, uint16_t response_status_in)
        : name(std::move(name_in))
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::ServerTimingInfo::DataView, ::blink::mojom::ServerTimingInfoPtr> {
    ...
    static const decltype(::blink::mojom::ServerTimingInfo::name)& name(const ::blink::mojom::ServerTimingInfoPtr& input) { return input->name; }

    static decltype(::blink::mojom::ServerTimingInfo::duration) duration(const ::blink::mojom::ServerTimingInfoPtr& input) { return input->duration; }

    static const decltype(::blink::mojom::ServerTimingInfo::description)& description(const ::blink::mojom::ServerTimingInfoPtr& input) { return input->description; }
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::ResourceTimingInfo::DataView, ::blink::mojom::ResourceTimingInfoPtr> {
    ...
    static const decltype(::blink::mojom::ResourceTimingInfo::name)& name(const ::blink::mojom::ResourceTimingInfoPtr& input) { return input->name; }

    static const decltype(::blink::mojom::ResourceTimingInfo::start_time)& start_time(const ::blink::mojom::ResourceTimingInfoPtr& input) { return input->start_time; }

    static const decltype(::blink::mojom::ResourceTimingInfo::alpn_negotiated_protocol)& alpn_negotiated_protocol(const ::blink::mojom::ResourceTimingInfoPtr& input)
    {
    ...
    static const decltype(::blink::mojom::ResourceTimingInfo::timing)& timing(const ::blink::mojom::ResourceTimingInfoPtr& input) { return input->timing; }

    static const decltype(::blink::mojom::ResourceTimingInfo::last_redirect_end_time)& last_redirect_end_time(const ::blink::mojom::ResourceTimingInfoPtr& input)
    {
        return input->last_redirect_end_time;
    }

    static const decltype(::blink::mojom::ResourceTimingInfo::response_end)& response_end(const ::blink::mojom::ResourceTimingInfoPtr& input) { return input->response_end; }

    static decltype(::blink::mojom::ResourceTimingInfo::context_type) context_type(const ::blink::mojom::ResourceTimingInfoPtr& input) { return input->context_type; }

    static decltype(::blink::mojom::ResourceTimingInfo::request_destination) request_destination(const ::blink::mojom::ResourceTimingInfoPtr& input)
    {
        return input->request_destination;
    }

    static decltype(::blink::mojom::ResourceTimingInfo::cache_state) cache_state(const ::blink::mojom::ResourceTimingInfoPtr& input) { return input->cache_state; }
    ...
    static decltype(::blink::mojom::ResourceTimingInfo::allow_redirect_details) allow_redirect_details(const ::blink::mojom::ResourceTimingInfoPtr& input)
    {
    ...
    static const decltype(::blink::mojom::ResourceTimingInfo::server_timing)& server_timing(const ::blink::mojom::ResourceTimingInfoPtr& input) { return input->server_timing; }
    ...
    static decltype(::blink::mojom::ResourceTimingInfo::response_status) response_status(const ::blink::mojom::ResourceTimingInfoPtr& input) { return input->response_status; }
