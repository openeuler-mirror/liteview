...
bool ServerTimingInfo::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
ResourceTimingInfo::ResourceTimingInfo(const WTF::String& name_in, ::base::TimeTicks start_time_in, const WTF::String& alpn_negotiated_protocol_in,
    const WTF::String& connection_info_in, ::network::mojom::blink::LoadTimingInfoPtr timing_in, ::base::TimeTicks last_redirect_end_time_in, ::base::TimeTicks response_end_in,
    ...
    bool allow_redirect_details_in, bool allow_negative_values_in, WTF::Vector<ServerTimingInfoPtr> server_timing_in, bool render_blocking_status_in, uint16_t response_status_in)
    : name(std::move(name_in))
...
void ResourceTimingInfo::WriteIntoTrace(perfetto::TracedValue traced_context) const
{
    ...
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("allow_redirect_details"), this->allow_redirect_details,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
        "<value of type bool>"
#else
        "<value>"
...
bool ResourceTimingInfo::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
