...
StorageAccessPermissionDescriptor::StorageAccessPermissionDescriptor(const ::url::Origin& siteOverride_in)
...
bool PermissionService_RequestPermissions_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    bool success = true;
    std::vector<::blink::mojom::PermissionStatus> p_statuses = mojo::DefaultConstructTraits::CreateInstance<std::vector<::blink::mojom::PermissionStatus>>();
...
void PermissionService_RequestPermissions_ProxyToResponder::Run(const std::vector<::blink::mojom::PermissionStatus>& in_statuses)
{
    ...
    TRACE_EVENT1("mojom", "Send reply blink::mojom::PermissionService::RequestPermissions", "async_response_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("statuses"), in_statuses, "<value of type const std::vector<::blink::mojom::PermissionStatus>&>");
    });
#endif
...
bool PermissionServiceStubDispatch::Accept(PermissionService* impl, mojo::Message* message)
{
    ...
    case internal::kPermissionService_AddPermissionObserver_Name: {
        ...
        ::blink::mojom::PermissionStatus p_last_known_status = mojo::DefaultConstructTraits::CreateInstance<::blink::mojom::PermissionStatus>();
...
bool PermissionServiceStubDispatch::AcceptWithResponder(PermissionService* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
{
    ...
    case internal::kPermissionService_RequestPermissions_Name: {
        ...
        bool success = true;
        std::vector<PermissionDescriptorPtr> p_permission = mojo::DefaultConstructTraits::CreateInstance<std::vector<PermissionDescriptorPtr>>();
        bool p_user_gesture = mojo::DefaultConstructTraits::CreateInstance<bool>();
...
// static
bool StructTraits<::blink::mojom::StorageAccessPermissionDescriptor::DataView, ::blink::mojom::StorageAccessPermissionDescriptorPtr>::Read(
    ::blink::mojom::StorageAccessPermissionDescriptor::DataView input, ::blink::mojom::StorageAccessPermissionDescriptorPtr* output)
{
    bool success = true;
    ::blink::mojom::StorageAccessPermissionDescriptorPtr result(::blink::mojom::StorageAccessPermissionDescriptor::New());
    ...
    ::blink::mojom::PermissionDescriptorExtension::DataView input, ::blink::mojom::PermissionDescriptorExtensionPtr* output)
{
    ...
    case Tag::kStorageAccess: {
        ::blink::mojom::StorageAccessPermissionDescriptorPtr result_storage_access;
    ...
    std::vector<PermissionDescriptorPtr> permission, bool user_gesture, std::vector<::blink::mojom::PermissionStatus>* out_statuses)
{
    ...
    proxy_->RequestPermissions(std::move(permission), std::move(user_gesture),
        base::BindOnce(
            [](base::RunLoop* loop, std::vector<::blink::mojom::PermissionStatus>* out_statuses, const std::vector<::blink::mojom::PermissionStatus>& statuses) {
...
std::vector<::blink::mojom::PermissionStatus> PermissionServiceAsyncWaiter::RequestPermissions(std::vector<PermissionDescriptorPtr> permission, bool user_gesture)
{
    std::vector<::blink::mojom::PermissionStatus> async_wait_result = mojo::DefaultConstructTraits::CreateInstance<std::vector<::blink::mojom::PermissionStatus>>();
