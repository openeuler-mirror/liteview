...
struct blink_mojom_internal_PermissionName_DataHashFn {
    ...
    static bool Equal(const ::blink::mojom::PermissionName& left, const ::blink::mojom::PermissionName& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::blink::mojom::PermissionName> : public GenericHashTraits<::blink::mojom::PermissionName> {
    static_assert(true, "-1000000 is a reserved enum value");
    static_assert(true, "-1000001 is a reserved enum value");
    static const bool kEmptyValueIsZero = false;
    static ::blink::mojom::PermissionName EmptyValue() { return static_cast<::blink::mojom::PermissionName>(-1000000); }
    static void ConstructDeletedValue(::blink::mojom::PermissionName& slot, bool) { slot = static_cast<::blink::mojom::PermissionName>(-1000001); }
    static bool IsDeletedValue(const ::blink::mojom::PermissionName& value) { return value == static_cast<::blink::mojom::PermissionName>(-1000001); }
};
} // namespace WTF
namespace blink {
namespace mojom {
...
//
//   void AddPermissionObserver(PermissionDescriptorPtr permission, ::blink::mojom::blink::PermissionStatus last_known_status, ::mojo::PendingRemote<PermissionObserver> observer)
//   final;
//
//  private:
//   mojo::MessageReceiverWithResponder* receiver_;
...
class PLATFORM_EXPORT StorageAccessPermissionDescriptor {
public:
    ...
    explicit StorageAccessPermissionDescriptor(const ::scoped_refptr<const ::blink::SecurityOrigin>& siteOverride_in)
    ...
    template <typename UserType> static WTF::Vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<StorageAccessPermissionDescriptor::DataView, WTF::Vector<uint8_t>>(input);
    }
    ...
    ::scoped_refptr<const ::blink::SecurityOrigin> siteOverride;
...
template <> struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::MidiPermissionDescriptor::DataView, ::blink::mojom::blink::MidiPermissionDescriptorPtr> {
    ...
    static decltype(::blink::mojom::blink::MidiPermissionDescriptor::sysex) sysex(const ::blink::mojom::blink::MidiPermissionDescriptorPtr& input) { return input->sysex; }
...
template <> struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::ClipboardPermissionDescriptor::DataView, ::blink::mojom::blink::ClipboardPermissionDescriptorPtr> {
    ...
    static decltype(::blink::mojom::blink::ClipboardPermissionDescriptor::has_user_gesture) has_user_gesture(const ::blink::mojom::blink::ClipboardPermissionDescriptorPtr& input)
    {
        return input->has_user_gesture;
    }

    static decltype(::blink::mojom::blink::ClipboardPermissionDescriptor::will_be_sanitized) will_be_sanitized(const ::blink::mojom::blink::ClipboardPermissionDescriptorPtr& input)
    {
...
template <> struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::CameraDevicePermissionDescriptor::DataView, ::blink::mojom::blink::CameraDevicePermissionDescriptorPtr> {
    ...
    static decltype(::blink::mojom::blink::CameraDevicePermissionDescriptor::panTiltZoom) panTiltZoom(const ::blink::mojom::blink::CameraDevicePermissionDescriptorPtr& input)
    {
...
template <> struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::StorageAccessPermissionDescriptor::DataView, ::blink::mojom::blink::StorageAccessPermissionDescriptorPtr> {
    static bool IsNull(const ::blink::mojom::blink::StorageAccessPermissionDescriptorPtr& input) { return !input; }
    static void SetToNull(::blink::mojom::blink::StorageAccessPermissionDescriptorPtr* output) { output->reset(); }

    static const decltype(::blink::mojom::blink::StorageAccessPermissionDescriptor::siteOverride)& siteOverride(
        const ::blink::mojom::blink::StorageAccessPermissionDescriptorPtr& input)
    {
        return input->siteOverride;
    }

    static bool Read(::blink::mojom::blink::StorageAccessPermissionDescriptor::DataView input, ::blink::mojom::blink::StorageAccessPermissionDescriptorPtr* output);
};
template <> struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::PermissionDescriptor::DataView, ::blink::mojom::blink::PermissionDescriptorPtr> {
    ...
    static decltype(::blink::mojom::blink::PermissionDescriptor::name) name(const ::blink::mojom::blink::PermissionDescriptorPtr& input) { return input->name; }
...
template <> struct PLATFORM_EXPORT UnionTraits<::blink::mojom::blink::PermissionDescriptorExtension::DataView, ::blink::mojom::blink::PermissionDescriptorExtensionPtr> {
    ...
    static ::blink::mojom::blink::PermissionDescriptorExtension::Tag GetTag(const ::blink::mojom::blink::PermissionDescriptorExtensionPtr& input) { return input->which(); }

    static const ::blink::mojom::blink::MidiPermissionDescriptorPtr& midi(const ::blink::mojom::blink::PermissionDescriptorExtensionPtr& input) { return input->get_midi(); }
    ...
    static const ::blink::mojom::blink::StorageAccessPermissionDescriptorPtr& storage_access(const ::blink::mojom::blink::PermissionDescriptorExtensionPtr& input)
    {
