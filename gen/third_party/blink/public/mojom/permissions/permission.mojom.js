...
(function() {
  ...
  function StorageAccessPermissionDescriptor(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  StorageAccessPermissionDescriptor.prototype.initDefaults_ = function() {
    this.siteOverride = null;
  };
  StorageAccessPermissionDescriptor.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  StorageAccessPermissionDescriptor.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    // validate StorageAccessPermissionDescriptor.siteOverride
  ...
  StorageAccessPermissionDescriptor.encodedSize = codec.kStructHeaderSize + 8;

  StorageAccessPermissionDescriptor.decode = function(decoder) {
    var packed;
    var val = new StorageAccessPermissionDescriptor();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.siteOverride =
  ...
  StorageAccessPermissionDescriptor.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(StorageAccessPermissionDescriptor.encodedSize);
    encoder.writeUint32(0);
    encoder.encodeStructPointer(origin$.Origin, val.siteOverride);
  };
  ...
  Object.defineProperty(PermissionDescriptorExtension.prototype, "storageAccess", {
    get: function() {
      if (this.$tag != PermissionDescriptorExtension.Tags.storageAccess) {
        throw new ReferenceError(
            "PermissionDescriptorExtension.storageAccess is not currently set.");
      }
      return this.$data;
    },

    set: function(value) {
      this.$tag = PermissionDescriptorExtension.Tags.storageAccess;
      this.$data = value;
    }
  });
    ...
    PermissionDescriptorExtension.encode = function(encoder, val) {
      ...
      switch (val.$tag) {
        ...
        case PermissionDescriptorExtension.Tags.cameraDevice:
          ...
          break;
        case PermissionDescriptorExtension.Tags.storageAccess:
          encoder.encodeStructPointer(StorageAccessPermissionDescriptor, val.storageAccess);
          break;
      }
      encoder.align();
    };
    ...
    PermissionDescriptorExtension.decode = function(decoder) {
      ...
      switch (tag) {
        ...
        case PermissionDescriptorExtension.Tags.cameraDevice:
          ...
          break;
        case PermissionDescriptorExtension.Tags.storageAccess:
          result.storageAccess = decoder.decodeStructPointer(StorageAccessPermissionDescriptor);
          break;
      }
      decoder.align();
    ...
    // validate PermissionDescriptorExtension.storageAccess
    err = messageValidator.validateStructPointer(data_offset, StorageAccessPermissionDescriptor, false);
    if (err !== validator.validationError.NONE)
        return err;
          break;
      }
  ...
  exports.StorageAccessPermissionDescriptor = StorageAccessPermissionDescriptor;
