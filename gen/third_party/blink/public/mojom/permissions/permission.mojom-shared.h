...
class StorageAccessPermissionDescriptorDataView;
...
template <> struct MojomTypeTraits<::blink::mojom::StorageAccessPermissionDescriptorDataView> {
    using Data = ::blink::mojom::internal::StorageAccessPermissionDescriptor_Data;
    using DataAsArrayElement = Pointer<Data>;
    static constexpr MojomTypeCategory category = MojomTypeCategory::kStruct;
};
...
inline bool IsKnownEnumValue(PermissionName value) { return internal::PermissionName_Data::IsKnownValue(static_cast<int32_t>(value)); }
...
public:
    ...
    bool sysex() const { return data_->sysex; }
...
public:
    ...
    bool will_be_sanitized() const { return data_->will_be_sanitized; }
...
public:
    ...
    bool is_null() const { return !data_; }
    bool panTiltZoom() const { return data_->panTiltZoom; }
...
class StorageAccessPermissionDescriptorDataView {
public:
    StorageAccessPermissionDescriptorDataView() = default;

    StorageAccessPermissionDescriptorDataView(internal::StorageAccessPermissionDescriptor_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
    ...
    bool is_null() const { return !data_; }
    inline void GetSiteOverrideDataView(::url::mojom::OriginDataView* output);

    template <typename UserType> [[nodiscard]] bool ReadSiteOverride(UserType* output)
    {

        auto* pointer = data_->siteOverride.Get();
        return mojo::internal::Deserialize<::url::mojom::OriginDataView>(pointer, output, message_);
    }

private:
    internal::StorageAccessPermissionDescriptor_Data* data_ = nullptr;
...
public:
    ...
    PermissionName name() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::blink::mojom::PermissionName>(data_->name)); }
...
public:
    ...
    bool is_storage_access() const { return data_->tag == Tag::kStorageAccess; }
    inline void GetStorageAccessDataView(StorageAccessPermissionDescriptorDataView* output) const;

    template <typename UserType> [[nodiscard]] bool ReadStorageAccess(UserType* output) const
    {

        CHECK(is_storage_access());
        return mojo::internal::Deserialize<::blink::mojom::StorageAccessPermissionDescriptorDataView>(data_->data.f_storage_access.Get(), output, message_);
    }
...
template <typename MaybeConstUserType> struct Serializer<::blink::mojom::StorageAccessPermissionDescriptorDataView, MaybeConstUserType> {
    using UserType = typename std::remove_const<MaybeConstUserType>::type;
    using Traits = StructTraits<::blink::mojom::StorageAccessPermissionDescriptorDataView, UserType>;

    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::blink::mojom::internal::StorageAccessPermissionDescriptor_Data>& fragment)
    {
        if (CallIsNullIfExists<Traits>(input))
            return;
        fragment.Allocate();
        decltype(Traits::siteOverride(input)) in_siteOverride = Traits::siteOverride(input);
        mojo::internal::MessageFragment<typename decltype(fragment->siteOverride)::BaseType> siteOverride_fragment(fragment.message());
        mojo::internal::Serialize<::url::mojom::OriginDataView>(in_siteOverride, siteOverride_fragment);
        fragment->siteOverride.Set(siteOverride_fragment.is_null() ? nullptr : siteOverride_fragment.data());
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
            fragment->siteOverride.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null siteOverride in StorageAccessPermissionDescriptor struct");
    }

    static bool Deserialize(::blink::mojom::internal::StorageAccessPermissionDescriptor_Data* input, UserType* output, Message* message)
    {
        if (!input)
            return CallSetToNullIfExists<Traits>(output);

        ::blink::mojom::StorageAccessPermissionDescriptorDataView data_view(input, message);
        return Traits::Read(data_view, output);
    }
};
...
template <typename MaybeConstUserType> struct Serializer<::blink::mojom::PermissionDescriptorExtensionDataView, MaybeConstUserType> {
    ...
    static void Serialize(MaybeConstUserType& input, MessageFragment<::blink::mojom::internal::PermissionDescriptorExtension_Data>& fragment, bool inlined)
    {
        ...
        case ::blink::mojom::PermissionDescriptorExtensionDataView::Tag::kCameraDevice: {
            ...
            MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
                value_fragment.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null camera_device in PermissionDescriptorExtension union");
            fragment->data.f_camera_device.Set(value_fragment.is_null() ? nullptr : value_fragment.data());
            break;
        }
        case ::blink::mojom::PermissionDescriptorExtensionDataView::Tag::kStorageAccess: {
            decltype(Traits::storage_access(input)) in_storage_access = Traits::storage_access(input);
            mojo::internal::MessageFragment<typename decltype(fragment->data.f_storage_access)::BaseType> value_fragment(fragment.message());
            mojo::internal::Serialize<::blink::mojom::StorageAccessPermissionDescriptorDataView>(in_storage_access, value_fragment);
            MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
                value_fragment.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null storage_access in PermissionDescriptorExtension union");
            fragment->data.f_storage_access.Set(value_fragment.is_null() ? nullptr : value_fragment.data());
            break;
        }
        }
    }
...
inline void StorageAccessPermissionDescriptorDataView::GetSiteOverrideDataView(::url::mojom::OriginDataView* output)
{
    auto pointer = data_->siteOverride.Get();
...
inline void PermissionDescriptorExtensionDataView::GetStorageAccessDataView(StorageAccessPermissionDescriptorDataView* output) const
{
    CHECK(is_storage_access());
    *output = StorageAccessPermissionDescriptorDataView(data_->data.f_storage_access.Get(), message_);
}
} // namespace mojom
} // namespace blink
