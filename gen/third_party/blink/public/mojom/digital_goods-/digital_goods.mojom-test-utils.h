...
public:
    ...
    void ListPurchaseHistory(::payments::mojom::BillingResponseCode* out_code, std::vector<::payments::mojom::PurchaseReferencePtr>* out_purchase_reference_list);
...
public:
    ...
    void CreateDigitalGoods(const std::string& payment_method, ::payments::mojom::CreateDigitalGoodsResponseCode* out_code, ::mojo::PendingRemote<DigitalGoods>* out_digital_goods);
