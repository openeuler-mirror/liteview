...
public:
    ...
    static FrameTokenPtr NewLocalFrameToken(const ::blink::LocalFrameToken& local_frame_token)
    {
    ...
    static FrameTokenPtr NewRemoteFrameToken(const ::blink::RemoteFrameToken& remote_frame_token)
    {
        auto result = FrameTokenPtr(absl::in_place);
    ...
    template <typename U> static FrameTokenPtr From(const U& u) { return mojo::TypeConverter<FrameTokenPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, FrameToken>::Convert(*this); }
    ...
    template <typename T, typename std::enable_if<std::is_same<T, FrameToken>::value>::type* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    ...
    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<FrameToken::DataView>(input); }
...
public:
    ...
    static WorkerTokenPtr NewDedicatedWorkerToken(const ::blink::DedicatedWorkerToken& dedicated_worker_token)
    {
    ...
    static WorkerTokenPtr NewServiceWorkerToken(const ::blink::ServiceWorkerToken& service_worker_token)
    {
        auto result = WorkerTokenPtr(absl::in_place);
    ...
    static WorkerTokenPtr NewSharedWorkerToken(const ::blink::SharedWorkerToken& shared_worker_token)
    {
        auto result = WorkerTokenPtr(absl::in_place);
    ...
    template <typename U> static WorkerTokenPtr From(const U& u) { return mojo::TypeConverter<WorkerTokenPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, WorkerToken>::Convert(*this); }
    ...
    template <typename T, typename std::enable_if<std::is_same<T, WorkerToken>::value>::type* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    ...
    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<WorkerToken::DataView>(input); }
...
public:
    ...
    static WorkletTokenPtr NewAnimationWorkletToken(const ::blink::AnimationWorkletToken& animation_worklet_token)
    {
    ...
    static WorkletTokenPtr NewAudioWorkletToken(const ::blink::AudioWorkletToken& audio_worklet_token)
    {
        auto result = WorkletTokenPtr(absl::in_place);
    ...
    static WorkletTokenPtr NewLayoutWorkletToken(LayoutWorkletTokenPtr layout_worklet_token)
    {
        auto result = WorkletTokenPtr(absl::in_place);
    ...
    static WorkletTokenPtr NewPaintWorkletToken(const ::blink::PaintWorkletToken& paint_worklet_token)
    {
        auto result = WorkletTokenPtr(absl::in_place);
    ...
    template <typename U> static WorkletTokenPtr From(const U& u) { return mojo::TypeConverter<WorkletTokenPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, WorkletToken>::Convert(*this); }

    WorkletToken();
    ~WorkletToken() = default;
    ...
    template <typename T, typename std::enable_if<std::is_same<T, WorkletToken>::value>::type* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    ...
    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<WorkletToken::DataView>(input); }
...
public:
    ...
    // Construct an instance holding |local_frame_token|.
    static ExecutionContextTokenPtr NewLocalFrameToken(const ::blink::LocalFrameToken& local_frame_token)
    {
    ...
    // Construct an instance holding |dedicated_worker_token|.
    static ExecutionContextTokenPtr NewDedicatedWorkerToken(const ::blink::DedicatedWorkerToken& dedicated_worker_token)
    {
        auto result = ExecutionContextTokenPtr(absl::in_place);
        result->set_dedicated_worker_token(std::move(dedicated_worker_token));
        return result;
    ...
    // Construct an instance holding |service_worker_token|.
    static ExecutionContextTokenPtr NewServiceWorkerToken(const ::blink::ServiceWorkerToken& service_worker_token)
    {
        auto result = ExecutionContextTokenPtr(absl::in_place);
        result->set_service_worker_token(std::move(service_worker_token));
        return result;
    ...
    // Construct an instance holding |shared_worker_token|.
    static ExecutionContextTokenPtr NewSharedWorkerToken(const ::blink::SharedWorkerToken& shared_worker_token)
    {
        auto result = ExecutionContextTokenPtr(absl::in_place);
        result->set_shared_worker_token(std::move(shared_worker_token));
        return result;
    ...
    // Construct an instance holding |animation_worklet_token|.
    static ExecutionContextTokenPtr NewAnimationWorkletToken(const ::blink::AnimationWorkletToken& animation_worklet_token)
    {
        auto result = ExecutionContextTokenPtr(absl::in_place);
        result->set_animation_worklet_token(std::move(animation_worklet_token));
        return result;
    ...
    // Construct an instance holding |audio_worklet_token|.
    static ExecutionContextTokenPtr NewAudioWorkletToken(const ::blink::AudioWorkletToken& audio_worklet_token)
    {
        auto result = ExecutionContextTokenPtr(absl::in_place);
        result->set_audio_worklet_token(std::move(audio_worklet_token));
        return result;
    ...
    // Construct an instance holding |layout_worklet_token|.
    static ExecutionContextTokenPtr NewLayoutWorkletToken(LayoutWorkletTokenPtr layout_worklet_token)
    {
        auto result = ExecutionContextTokenPtr(absl::in_place);
        result->set_layout_worklet_token(std::move(layout_worklet_token));
        return result;
    ...
    // Construct an instance holding |paint_worklet_token|.
    static ExecutionContextTokenPtr NewPaintWorkletToken(const ::blink::PaintWorkletToken& paint_worklet_token)
    {
        auto result = ExecutionContextTokenPtr(absl::in_place);
        result->set_paint_worklet_token(std::move(paint_worklet_token));
        return result;
    ...
    template <typename U> static ExecutionContextTokenPtr From(const U& u) { return mojo::TypeConverter<ExecutionContextTokenPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, ExecutionContextToken>::Convert(*this); }

    ExecutionContextToken();
    ~ExecutionContextToken() = default;
    ...
    template <typename T, typename std::enable_if<std::is_same<T, ExecutionContextToken>::value>::type* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    ...
    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<ExecutionContextToken::DataView>(input); }
...
public:
    ...
    static WebGPUExecutionContextTokenPtr NewDocumentToken(const ::blink::DocumentToken& document_token)
    {
    ...
    // Construct an instance holding |dedicated_worker_token|.
    static WebGPUExecutionContextTokenPtr NewDedicatedWorkerToken(const ::blink::DedicatedWorkerToken& dedicated_worker_token)
    {
        auto result = WebGPUExecutionContextTokenPtr(absl::in_place);
        result->set_dedicated_worker_token(std::move(dedicated_worker_token));
        return result;
    ...
    template <typename U> static WebGPUExecutionContextTokenPtr From(const U& u) { return mojo::TypeConverter<WebGPUExecutionContextTokenPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, WebGPUExecutionContextToken>::Convert(*this); }

    WebGPUExecutionContextToken();
    ~WebGPUExecutionContextToken() = default;
    ...
    template <typename T, typename std::enable_if<std::is_same<T, WebGPUExecutionContextToken>::value>::type* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
...
public:
    ...
    template <typename... Args> static DocumentTokenPtr New(Args&&... args) { return DocumentTokenPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static DocumentTokenPtr From(const U& u) { return mojo::TypeConverter<DocumentTokenPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, DocumentToken>::Convert(*this); }
    DocumentToken()
        : value()
    {
    }
    ...
    template <typename T, DocumentToken::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    ...
    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<DocumentToken::DataView>(input); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::DocumentToken_UnserializedMessageContext<UserType, DocumentToken::DataView>>(0, 0, std::move(input)), MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    {
        return DocumentToken::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, DocumentToken::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, DocumentToken::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, DocumentToken::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static LocalFrameTokenPtr New(Args&&... args) { return LocalFrameTokenPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static LocalFrameTokenPtr From(const U& u) { return mojo::TypeConverter<LocalFrameTokenPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, LocalFrameToken>::Convert(*this); }
    LocalFrameToken()
        : value()
    {
    }
    ...
    template <typename T, LocalFrameToken::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static WTF::Vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<LocalFrameToken::DataView, WTF::Vector<uint8_t>>(input);
    }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<LocalFrameToken::DataView>(input); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::LocalFrameToken_UnserializedMessageContext<UserType, LocalFrameToken::DataView>>(0, 0, std::move(input)), MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const WTF::Vector<uint8_t>& input, UserType* output)
    {
        return LocalFrameToken::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, LocalFrameToken::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, LocalFrameToken::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, LocalFrameToken::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static RemoteFrameTokenPtr New(Args&&... args) { return RemoteFrameTokenPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static RemoteFrameTokenPtr From(const U& u) { return mojo::TypeConverter<RemoteFrameTokenPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, RemoteFrameToken>::Convert(*this); }
    RemoteFrameToken()
        : value()
    {
    }
    ...
    template <typename T, RemoteFrameToken::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static WTF::Vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<RemoteFrameToken::DataView, WTF::Vector<uint8_t>>(input);
    }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<RemoteFrameToken::DataView>(input); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::RemoteFrameToken_UnserializedMessageContext<UserType, RemoteFrameToken::DataView>>(0, 0, std::move(input)), MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const WTF::Vector<uint8_t>& input, UserType* output)
    {
        return RemoteFrameToken::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, RemoteFrameToken::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, RemoteFrameToken::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, RemoteFrameToken::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static DedicatedWorkerTokenPtr New(Args&&... args) { return DedicatedWorkerTokenPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static DedicatedWorkerTokenPtr From(const U& u) { return mojo::TypeConverter<DedicatedWorkerTokenPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, DedicatedWorkerToken>::Convert(*this); }
    ...
    template <typename T, DedicatedWorkerToken::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static WTF::Vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<DedicatedWorkerToken::DataView, WTF::Vector<uint8_t>>(input);
    }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<DedicatedWorkerToken::DataView>(input); }
    ...
    template <typename UserType> static mojo::Message WrapAsMessage(UserType input)
    {
        return mojo::Message(std::make_unique<internal::DedicatedWorkerToken_UnserializedMessageContext<UserType, DedicatedWorkerToken::DataView>>(0, 0, std::move(input)),
    ...
    template <typename UserType> static bool Deserialize(const WTF::Vector<uint8_t>& input, UserType* output)
    {
        return DedicatedWorkerToken::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, DedicatedWorkerToken::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, DedicatedWorkerToken::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, DedicatedWorkerToken::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static ServiceWorkerTokenPtr New(Args&&... args) { return ServiceWorkerTokenPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static ServiceWorkerTokenPtr From(const U& u) { return mojo::TypeConverter<ServiceWorkerTokenPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, ServiceWorkerToken>::Convert(*this); }
    ServiceWorkerToken()
        : value()
    {
    }
    ...
    template <typename T, ServiceWorkerToken::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static WTF::Vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<ServiceWorkerToken::DataView, WTF::Vector<uint8_t>>(input);
    }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<ServiceWorkerToken::DataView>(input); }
    ...
    template <typename UserType> static mojo::Message WrapAsMessage(UserType input)
    {
        return mojo::Message(std::make_unique<internal::ServiceWorkerToken_UnserializedMessageContext<UserType, ServiceWorkerToken::DataView>>(0, 0, std::move(input)),
            MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const WTF::Vector<uint8_t>& input, UserType* output)
    {
        return ServiceWorkerToken::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, ServiceWorkerToken::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, ServiceWorkerToken::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, ServiceWorkerToken::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static SharedWorkerTokenPtr New(Args&&... args) { return SharedWorkerTokenPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static SharedWorkerTokenPtr From(const U& u) { return mojo::TypeConverter<SharedWorkerTokenPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, SharedWorkerToken>::Convert(*this); }
    SharedWorkerToken()
        : value()
    {
    }
    ...
    template <typename T, SharedWorkerToken::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static WTF::Vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<SharedWorkerToken::DataView, WTF::Vector<uint8_t>>(input);
    }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<SharedWorkerToken::DataView>(input); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::SharedWorkerToken_UnserializedMessageContext<UserType, SharedWorkerToken::DataView>>(0, 0, std::move(input)), MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const WTF::Vector<uint8_t>& input, UserType* output)
    {
        return SharedWorkerToken::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, SharedWorkerToken::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, SharedWorkerToken::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, SharedWorkerToken::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static AnimationWorkletTokenPtr New(Args&&... args) { return AnimationWorkletTokenPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static AnimationWorkletTokenPtr From(const U& u) { return mojo::TypeConverter<AnimationWorkletTokenPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, AnimationWorkletToken>::Convert(*this); }
    ...
    template <typename T, AnimationWorkletToken::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static WTF::Vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<AnimationWorkletToken::DataView, WTF::Vector<uint8_t>>(input);
    }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<AnimationWorkletToken::DataView>(input); }
    ...
    template <typename UserType> static mojo::Message WrapAsMessage(UserType input)
    {
        return mojo::Message(std::make_unique<internal::AnimationWorkletToken_UnserializedMessageContext<UserType, AnimationWorkletToken::DataView>>(0, 0, std::move(input)),
            MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const WTF::Vector<uint8_t>& input, UserType* output)
    {
        return AnimationWorkletToken::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, AnimationWorkletToken::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, AnimationWorkletToken::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, AnimationWorkletToken::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static AudioWorkletTokenPtr New(Args&&... args) { return AudioWorkletTokenPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static AudioWorkletTokenPtr From(const U& u) { return mojo::TypeConverter<AudioWorkletTokenPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, AudioWorkletToken>::Convert(*this); }
    AudioWorkletToken()
        : value()
    {
    }
    ...
    template <typename T, AudioWorkletToken::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static WTF::Vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<AudioWorkletToken::DataView, WTF::Vector<uint8_t>>(input);
    }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<AudioWorkletToken::DataView>(input); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::AudioWorkletToken_UnserializedMessageContext<UserType, AudioWorkletToken::DataView>>(0, 0, std::move(input)), MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const WTF::Vector<uint8_t>& input, UserType* output)
    {
        return AudioWorkletToken::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, AudioWorkletToken::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, AudioWorkletToken::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, AudioWorkletToken::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static LayoutWorkletTokenPtr New(Args&&... args) { return LayoutWorkletTokenPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static LayoutWorkletTokenPtr From(const U& u) { return mojo::TypeConverter<LayoutWorkletTokenPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, LayoutWorkletToken>::Convert(*this); }
    LayoutWorkletToken()
        : value()
    {
    }
    ...
    template <typename T, LayoutWorkletToken::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static WTF::Vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<LayoutWorkletToken::DataView, WTF::Vector<uint8_t>>(input);
    }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<LayoutWorkletToken::DataView>(input); }
    ...
    template <typename UserType> static mojo::Message WrapAsMessage(UserType input)
    {
        return mojo::Message(std::make_unique<internal::LayoutWorkletToken_UnserializedMessageContext<UserType, LayoutWorkletToken::DataView>>(0, 0, std::move(input)),
            MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const WTF::Vector<uint8_t>& input, UserType* output)
    {
        return LayoutWorkletToken::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, LayoutWorkletToken::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, LayoutWorkletToken::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, LayoutWorkletToken::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static PaintWorkletTokenPtr New(Args&&... args) { return PaintWorkletTokenPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static PaintWorkletTokenPtr From(const U& u) { return mojo::TypeConverter<PaintWorkletTokenPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, PaintWorkletToken>::Convert(*this); }
    PaintWorkletToken()
        : value()
    {
    }
    ...
    template <typename T, PaintWorkletToken::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static WTF::Vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<PaintWorkletToken::DataView, WTF::Vector<uint8_t>>(input);
    }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<PaintWorkletToken::DataView>(input); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::PaintWorkletToken_UnserializedMessageContext<UserType, PaintWorkletToken::DataView>>(0, 0, std::move(input)), MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const WTF::Vector<uint8_t>& input, UserType* output)
    {
        return PaintWorkletToken::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, PaintWorkletToken::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, PaintWorkletToken::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, PaintWorkletToken::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static AttributionSrcTokenPtr New(Args&&... args) { return AttributionSrcTokenPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static AttributionSrcTokenPtr From(const U& u) { return mojo::TypeConverter<AttributionSrcTokenPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, AttributionSrcToken>::Convert(*this); }
    AttributionSrcToken()
        : value()
    {
    }
    ...
    template <typename T, AttributionSrcToken::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static WTF::Vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<AttributionSrcToken::DataView, WTF::Vector<uint8_t>>(input);
    }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<AttributionSrcToken::DataView>(input); }
    ...
    template <typename UserType> static mojo::Message WrapAsMessage(UserType input)
    {
        return mojo::Message(std::make_unique<internal::AttributionSrcToken_UnserializedMessageContext<UserType, AttributionSrcToken::DataView>>(0, 0, std::move(input)),
            MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const WTF::Vector<uint8_t>& input, UserType* output)
    {
        return AttributionSrcToken::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, AttributionSrcToken::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, AttributionSrcToken::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, AttributionSrcToken::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static ClipboardSequenceNumberTokenPtr New(Args&&... args) { return ClipboardSequenceNumberTokenPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static ClipboardSequenceNumberTokenPtr From(const U& u) { return mojo::TypeConverter<ClipboardSequenceNumberTokenPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, ClipboardSequenceNumberToken>::Convert(*this); }
    ...
    template <typename T, ClipboardSequenceNumberToken::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static WTF::Vector<uint8_t> Serialize(UserType* input)
    {
    ...
    {
        return mojo::Message(
            std::make_unique<internal::ClipboardSequenceNumberToken_UnserializedMessageContext<UserType, ClipboardSequenceNumberToken::DataView>>(0, 0, std::move(input)),
            MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const WTF::Vector<uint8_t>& input, UserType* output)
    {
        return ClipboardSequenceNumberToken::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }

    template <typename UserType> static bool DeserializeFromMessage(mojo::Message input, UserType* output)
    {
        auto context = input.TakeUnserializedContext<internal::ClipboardSequenceNumberToken_UnserializedMessageContext<UserType, ClipboardSequenceNumberToken::DataView>>();
        if (context) {
            *output = std::move(context->TakeData());
            return true;
        }
...
template <typename T, ClipboardSequenceNumberToken::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, ClipboardSequenceNumberToken::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, ClipboardSequenceNumberToken::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }

class PLATFORM_EXPORT PortalToken {
public:
    template <typename T> using EnableIfSame = std::enable_if_t<std::is_same<PortalToken, T>::value>;
    using DataView = PortalTokenDataView;
    using Data_ = internal::PortalToken_Data;

    template <typename... Args> static PortalTokenPtr New(Args&&... args) { return PortalTokenPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static PortalTokenPtr From(const U& u) { return mojo::TypeConverter<PortalTokenPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, PortalToken>::Convert(*this); }
    PortalToken()
        : value()
    {
    }

    explicit PortalToken(const ::base::UnguessableToken& value_in)
        : value(std::move(value_in)) {};
    ~PortalToken() = default;
    ...
    // bindings generator does not need to know whether Clone() or copy
    // constructor/assignment are available for members.
    template <typename StructPtrType = PortalTokenPtr> PortalTokenPtr Clone() const;

    // Equals() is a template so it is only instantiated if it is used. Thus, the
    // bindings generator does not need to know whether Equals() or == operator
    // are available for members.
    template <typename T, PortalToken::EnableIfSame<T>* = nullptr> bool Equals(const T& other) const;

    template <typename T, PortalToken::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static WTF::Vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<PortalToken::DataView, WTF::Vector<uint8_t>>(input);
    }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<PortalToken::DataView>(input); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::PortalToken_UnserializedMessageContext<UserType, PortalToken::DataView>>(0, 0, std::move(input)), MOJO_CREATE_MESSAGE_FLAG_NONE);
    }

    template <typename UserType> static bool Deserialize(const void* data, size_t data_num_bytes, UserType* output)
    {
        mojo::Message message;
        return mojo::internal::DeserializeImpl<PortalToken::DataView>(message, data, data_num_bytes, output, Validate);
    }

    template <typename UserType> static bool Deserialize(const WTF::Vector<uint8_t>& input, UserType* output)
    {
        return PortalToken::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }

    template <typename UserType> static bool DeserializeFromMessage(mojo::Message input, UserType* output)
    {
        auto context = input.TakeUnserializedContext<internal::PortalToken_UnserializedMessageContext<UserType, PortalToken::DataView>>();
        if (context) {
            *output = std::move(context->TakeData());
            return true;
        }
        input.SerializeIfNecessary();
        return mojo::internal::DeserializeImpl<PortalToken::DataView>(input, input.payload(), input.payload_num_bytes(), output, Validate);
    }
...
// are used. Thus, the bindings generator does not need to know whether
// comparison operators are available for members.
template <typename T, PortalToken::EnableIfSame<T>* = nullptr> bool operator<(const T& lhs, const T& rhs);

template <typename T, PortalToken::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, PortalToken::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, PortalToken::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static V8ContextTokenPtr New(Args&&... args) { return V8ContextTokenPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static V8ContextTokenPtr From(const U& u) { return mojo::TypeConverter<V8ContextTokenPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, V8ContextToken>::Convert(*this); }
    V8ContextToken()
        : value()
    {
    }
    ...
    template <typename T, V8ContextToken::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static WTF::Vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<V8ContextToken::DataView, WTF::Vector<uint8_t>>(input);
    }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<V8ContextToken::DataView>(input); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::V8ContextToken_UnserializedMessageContext<UserType, V8ContextToken::DataView>>(0, 0, std::move(input)), MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const WTF::Vector<uint8_t>& input, UserType* output)
    {
        return V8ContextToken::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, V8ContextToken::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, V8ContextToken::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, V8ContextToken::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
template <typename T, typename std::enable_if<std::is_same<T, WebGPUExecutionContextToken>::value>::type*> bool WebGPUExecutionContextToken::Equals(const T& other) const
{
    if (tag_ != other.which())
        return false;
...
template <typename StructPtrType> DocumentTokenPtr DocumentToken::Clone() const { return New(mojo::Clone(value)); }
...
template <typename StructPtrType> LocalFrameTokenPtr LocalFrameToken::Clone() const { return New(mojo::Clone(value)); }
...
template <typename StructPtrType> RemoteFrameTokenPtr RemoteFrameToken::Clone() const { return New(mojo::Clone(value)); }
...
template <typename StructPtrType> DedicatedWorkerTokenPtr DedicatedWorkerToken::Clone() const { return New(mojo::Clone(value)); }
...
template <typename StructPtrType> ServiceWorkerTokenPtr ServiceWorkerToken::Clone() const { return New(mojo::Clone(value)); }
...
template <typename StructPtrType> SharedWorkerTokenPtr SharedWorkerToken::Clone() const { return New(mojo::Clone(value)); }
...
template <typename StructPtrType> AnimationWorkletTokenPtr AnimationWorkletToken::Clone() const { return New(mojo::Clone(value)); }
...
template <typename StructPtrType> AudioWorkletTokenPtr AudioWorkletToken::Clone() const { return New(mojo::Clone(value)); }
...
template <typename StructPtrType> LayoutWorkletTokenPtr LayoutWorkletToken::Clone() const { return New(mojo::Clone(value)); }
...
template <typename StructPtrType> PaintWorkletTokenPtr PaintWorkletToken::Clone() const { return New(mojo::Clone(value)); }
...
template <typename StructPtrType> AttributionSrcTokenPtr AttributionSrcToken::Clone() const { return New(mojo::Clone(value)); }
...
template <typename StructPtrType> ClipboardSequenceNumberTokenPtr ClipboardSequenceNumberToken::Clone() const { return New(mojo::Clone(value)); }
...
template <typename StructPtrType> PortalTokenPtr PortalToken::Clone() const { return New(mojo::Clone(value)); }

template <typename T, PortalToken::EnableIfSame<T>*> bool PortalToken::Equals(const T& other_struct) const
{
    if (!mojo::Equals(this->value, other_struct.value))
        return false;
    return true;
...
template <typename T, PortalToken::EnableIfSame<T>*> bool operator<(const T& lhs, const T& rhs)
{
    if (lhs.value < rhs.value)
        return true;
    if (rhs.value < lhs.value)
...
template <typename StructPtrType> V8ContextTokenPtr V8ContextToken::Clone() const { return New(mojo::Clone(value)); }
...
template <> struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::DocumentToken::DataView, ::blink::mojom::blink::DocumentTokenPtr> {
    ...
    static const decltype(::blink::mojom::blink::DocumentToken::value)& value(const ::blink::mojom::blink::DocumentTokenPtr& input) { return input->value; }
...
template <> struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::LocalFrameToken::DataView, ::blink::mojom::blink::LocalFrameTokenPtr> {
    ...
    static const decltype(::blink::mojom::blink::LocalFrameToken::value)& value(const ::blink::mojom::blink::LocalFrameTokenPtr& input) { return input->value; }
...
template <> struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::RemoteFrameToken::DataView, ::blink::mojom::blink::RemoteFrameTokenPtr> {
    ...
    static const decltype(::blink::mojom::blink::RemoteFrameToken::value)& value(const ::blink::mojom::blink::RemoteFrameTokenPtr& input) { return input->value; }
...
template <> struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::DedicatedWorkerToken::DataView, ::blink::mojom::blink::DedicatedWorkerTokenPtr> {
    ...
    static const decltype(::blink::mojom::blink::DedicatedWorkerToken::value)& value(const ::blink::mojom::blink::DedicatedWorkerTokenPtr& input) { return input->value; }
...
template <> struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::ServiceWorkerToken::DataView, ::blink::mojom::blink::ServiceWorkerTokenPtr> {
    ...
    static const decltype(::blink::mojom::blink::ServiceWorkerToken::value)& value(const ::blink::mojom::blink::ServiceWorkerTokenPtr& input) { return input->value; }
...
template <> struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::SharedWorkerToken::DataView, ::blink::mojom::blink::SharedWorkerTokenPtr> {
    ...
    static const decltype(::blink::mojom::blink::SharedWorkerToken::value)& value(const ::blink::mojom::blink::SharedWorkerTokenPtr& input) { return input->value; }
...
template <> struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::AnimationWorkletToken::DataView, ::blink::mojom::blink::AnimationWorkletTokenPtr> {
    ...
    static const decltype(::blink::mojom::blink::AnimationWorkletToken::value)& value(const ::blink::mojom::blink::AnimationWorkletTokenPtr& input) { return input->value; }
...
template <> struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::AudioWorkletToken::DataView, ::blink::mojom::blink::AudioWorkletTokenPtr> {
    ...
    static const decltype(::blink::mojom::blink::AudioWorkletToken::value)& value(const ::blink::mojom::blink::AudioWorkletTokenPtr& input) { return input->value; }
...
template <> struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::LayoutWorkletToken::DataView, ::blink::mojom::blink::LayoutWorkletTokenPtr> {
    ...
    static const decltype(::blink::mojom::blink::LayoutWorkletToken::value)& value(const ::blink::mojom::blink::LayoutWorkletTokenPtr& input) { return input->value; }
...
template <> struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::PaintWorkletToken::DataView, ::blink::mojom::blink::PaintWorkletTokenPtr> {
    ...
    static const decltype(::blink::mojom::blink::PaintWorkletToken::value)& value(const ::blink::mojom::blink::PaintWorkletTokenPtr& input) { return input->value; }
...
template <> struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::AttributionSrcToken::DataView, ::blink::mojom::blink::AttributionSrcTokenPtr> {
    ...
    static const decltype(::blink::mojom::blink::AttributionSrcToken::value)& value(const ::blink::mojom::blink::AttributionSrcTokenPtr& input) { return input->value; }

    static bool Read(::blink::mojom::blink::AttributionSrcToken::DataView input, ::blink::mojom::blink::AttributionSrcTokenPtr* output);
};
template <> struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::ClipboardSequenceNumberToken::DataView, ::blink::mojom::blink::ClipboardSequenceNumberTokenPtr> {
    static bool IsNull(const ::blink::mojom::blink::ClipboardSequenceNumberTokenPtr& input) { return !input; }
    static void SetToNull(::blink::mojom::blink::ClipboardSequenceNumberTokenPtr* output) { output->reset(); }

    static const decltype(::blink::mojom::blink::ClipboardSequenceNumberToken::value)& value(const ::blink::mojom::blink::ClipboardSequenceNumberTokenPtr& input)
    {
        return input->value;
    }
...
template <> struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::PortalToken::DataView, ::blink::mojom::blink::PortalTokenPtr> {
    static bool IsNull(const ::blink::mojom::blink::PortalTokenPtr& input) { return !input; }
    static void SetToNull(::blink::mojom::blink::PortalTokenPtr* output) { output->reset(); }

    static const decltype(::blink::mojom::blink::PortalToken::value)& value(const ::blink::mojom::blink::PortalTokenPtr& input) { return input->value; }

    static bool Read(::blink::mojom::blink::PortalToken::DataView input, ::blink::mojom::blink::PortalTokenPtr* output);
};
template <> struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::V8ContextToken::DataView, ::blink::mojom::blink::V8ContextTokenPtr> {
    ...
    static const decltype(::blink::mojom::blink::V8ContextToken::value)& value(const ::blink::mojom::blink::V8ContextTokenPtr& input) { return input->value; }
...
template <> struct PLATFORM_EXPORT UnionTraits<::blink::mojom::blink::FrameToken::DataView, ::blink::mojom::blink::FrameTokenPtr> {
    ...
    static ::blink::mojom::blink::FrameToken::Tag GetTag(const ::blink::mojom::blink::FrameTokenPtr& input) { return input->which(); }

    static const ::blink::LocalFrameToken& local_frame_token(const ::blink::mojom::blink::FrameTokenPtr& input) { return input->get_local_frame_token(); }

    static const ::blink::RemoteFrameToken& remote_frame_token(const ::blink::mojom::blink::FrameTokenPtr& input) { return input->get_remote_frame_token(); }
...
template <> struct PLATFORM_EXPORT UnionTraits<::blink::mojom::blink::WorkerToken::DataView, ::blink::mojom::blink::WorkerTokenPtr> {
    ...
    static ::blink::mojom::blink::WorkerToken::Tag GetTag(const ::blink::mojom::blink::WorkerTokenPtr& input) { return input->which(); }

    static const ::blink::DedicatedWorkerToken& dedicated_worker_token(const ::blink::mojom::blink::WorkerTokenPtr& input) { return input->get_dedicated_worker_token(); }

    static const ::blink::ServiceWorkerToken& service_worker_token(const ::blink::mojom::blink::WorkerTokenPtr& input) { return input->get_service_worker_token(); }

    static const ::blink::SharedWorkerToken& shared_worker_token(const ::blink::mojom::blink::WorkerTokenPtr& input) { return input->get_shared_worker_token(); }
...
template <> struct PLATFORM_EXPORT UnionTraits<::blink::mojom::blink::WorkletToken::DataView, ::blink::mojom::blink::WorkletTokenPtr> {
    ...
    static ::blink::mojom::blink::WorkletToken::Tag GetTag(const ::blink::mojom::blink::WorkletTokenPtr& input) { return input->which(); }

    static const ::blink::AnimationWorkletToken& animation_worklet_token(const ::blink::mojom::blink::WorkletTokenPtr& input) { return input->get_animation_worklet_token(); }

    static const ::blink::AudioWorkletToken& audio_worklet_token(const ::blink::mojom::blink::WorkletTokenPtr& input) { return input->get_audio_worklet_token(); }
    ...
    static const ::blink::PaintWorkletToken& paint_worklet_token(const ::blink::mojom::blink::WorkletTokenPtr& input) { return input->get_paint_worklet_token(); }
...
template <> struct PLATFORM_EXPORT UnionTraits<::blink::mojom::blink::ExecutionContextToken::DataView, ::blink::mojom::blink::ExecutionContextTokenPtr> {
    ...
    static ::blink::mojom::blink::ExecutionContextToken::Tag GetTag(const ::blink::mojom::blink::ExecutionContextTokenPtr& input) { return input->which(); }

    static const ::blink::LocalFrameToken& local_frame_token(const ::blink::mojom::blink::ExecutionContextTokenPtr& input) { return input->get_local_frame_token(); }

    static const ::blink::DedicatedWorkerToken& dedicated_worker_token(const ::blink::mojom::blink::ExecutionContextTokenPtr& input) { return input->get_dedicated_worker_token(); }

    static const ::blink::ServiceWorkerToken& service_worker_token(const ::blink::mojom::blink::ExecutionContextTokenPtr& input) { return input->get_service_worker_token(); }

    static const ::blink::SharedWorkerToken& shared_worker_token(const ::blink::mojom::blink::ExecutionContextTokenPtr& input) { return input->get_shared_worker_token(); }
    ...
    static const ::blink::AudioWorkletToken& audio_worklet_token(const ::blink::mojom::blink::ExecutionContextTokenPtr& input) { return input->get_audio_worklet_token(); }
    ...
    static const ::blink::PaintWorkletToken& paint_worklet_token(const ::blink::mojom::blink::ExecutionContextTokenPtr& input) { return input->get_paint_worklet_token(); }
...
template <> struct PLATFORM_EXPORT UnionTraits<::blink::mojom::blink::WebGPUExecutionContextToken::DataView, ::blink::mojom::blink::WebGPUExecutionContextTokenPtr> {
    ...
    static ::blink::mojom::blink::WebGPUExecutionContextToken::Tag GetTag(const ::blink::mojom::blink::WebGPUExecutionContextTokenPtr& input) { return input->which(); }

    static const ::blink::DocumentToken& document_token(const ::blink::mojom::blink::WebGPUExecutionContextTokenPtr& input) { return input->get_document_token(); }
