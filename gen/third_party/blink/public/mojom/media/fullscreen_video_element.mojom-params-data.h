...
static_assert(
    sizeof(FullscreenVideoElementHandler_RequestFullscreenVideoElement_Params_Data) == 8, "Bad sizeof(FullscreenVideoElementHandler_RequestFullscreenVideoElement_Params_Data)");
