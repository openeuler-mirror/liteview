...
(function() {
  ...
  if (mojo.config.autoLoadMojomDeps) {
    mojo.internal.loadMojomIfNecessary(
        'media/mojo/mojom/audio_processing.mojom', '../../../../../media/mojo/mojom/audio_processing.mojom.js');
  }
  var media_types$ =
      mojo.internal.exposeNamespace('media.mojom');
  if (mojo.config.autoLoadMojomDeps) {
  ...
  RendererAudioInputStreamFactory_CreateStream_Params.validate = function(messageValidator, offset) {
    ...
    // validate RendererAudioInputStreamFactory_CreateStream_Params.processingConfig
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 32, audio_processing$.AudioProcessingConfig, true);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  RendererAudioInputStreamFactory_CreateStream_Params.encodedSize = codec.kStructHeaderSize + 40;
  ...
  RendererAudioInputStreamFactoryProxy.prototype.createStream = function(client, sessionId, params, automaticGainControl, sharedMemoryCount, processingConfig) {
  ...
  RendererAudioInputStreamFactoryStub.prototype.createStream = function(client, sessionId, params, automaticGainControl, sharedMemoryCount, processingConfig) {
    return this.delegate_ && this.delegate_.createStream && this.delegate_.createStream(client, sessionId, params, automaticGainControl, sharedMemoryCount, processingConfig);
  }
  ...
  RendererAudioInputStreamFactoryStub.prototype.accept = function(message) {
    ...
    case kRendererAudioInputStreamFactory_CreateStream_Name:
      ...
      this.createStream(params.client, params.sessionId, params.params, params.automaticGainControl, params.sharedMemoryCount, params.processingConfig);
      return true;
