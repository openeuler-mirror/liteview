...
static_assert(
    sizeof(RendererAudioOutputStreamFactory_RequestDeviceAuthorization_Params_Data) == 32, "Bad sizeof(RendererAudioOutputStreamFactory_RequestDeviceAuthorization_Params_Data)");
...
public:
    ...
    ::media::mojom::OutputDeviceStatus state() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::media::mojom::OutputDeviceStatus>(data_->state)); }
...
inline void RendererAudioOutputStreamFactory_RequestDeviceAuthorization_ParamsDataView::GetSessionIdDataView(::mojo_base::mojom::UnguessableTokenDataView* output)
{
    auto pointer = data_->session_id.Get();
...
inline void RendererAudioOutputStreamFactory_RequestDeviceAuthorization_ResponseParamsDataView::GetOutputParamsDataView(::media::mojom::AudioParametersDataView* output)
{
    auto pointer = data_->output_params.Get();
