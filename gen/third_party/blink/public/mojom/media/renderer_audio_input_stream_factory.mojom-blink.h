...
// with not having this data in traces there.
    ...
    virtual void CreateStream(::mojo::PendingRemote<RendererAudioInputStreamFactoryClient> client, const ::base::UnguessableToken& session_id,
        const ::media::AudioParameters& params, bool automatic_gain_control, uint32_t shared_memory_count, ::media::mojom::blink::AudioProcessingConfigPtr processing_config)
        = 0;
...
//   automatic_gain_control, uint32_t shared_memory_count, ::media::mojom::blink::AudioProcessingConfigPtr processing_config) final;
//
...
//
//   void StreamCreated(::mojo::PendingRemote<::media::mojom::blink::AudioInputStream> stream, ::mojo::PendingReceiver<::media::mojom::blink::AudioInputStreamClient>
//   client_request, ::media::mojom::blink::ReadOnlyAudioDataPipePtr data_pipe, bool initially_muted, const absl::optional<::base::UnguessableToken>& stream_id) final;
//
//  private:
//   mojo::MessageReceiverWithResponder* receiver_;
// };
