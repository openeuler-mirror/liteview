...
#include "third_party/blink/public/mojom/media/renderer_audio_input_stream_factory.mojom-forward.h"
...
// with not having this data in traces there.
    ...
    virtual void StreamCreated(::mojo::PendingRemote<::media::mojom::AudioInputStream> stream, ::mojo::PendingReceiver<::media::mojom::AudioInputStreamClient> client_request,
...
//
//   void CreateStream(::mojo::PendingRemote<RendererAudioInputStreamFactoryClient> client, const ::base::UnguessableToken& session_id, const ::media::AudioParameters& params, bool
//   automatic_gain_control, uint32_t shared_memory_count, ::media::mojom::AudioProcessingConfigPtr processing_config) final;
//
...
//
//   void StreamCreated(::mojo::PendingRemote<::media::mojom::AudioInputStream> stream, ::mojo::PendingReceiver<::media::mojom::AudioInputStreamClient> client_request,
//   ::media::mojom::ReadOnlyAudioDataPipePtr data_pipe, bool initially_muted, const absl::optional<::base::UnguessableToken>& stream_id) final;
//
//  private:
//   mojo::MessageReceiverWithResponder* receiver_;
// };
