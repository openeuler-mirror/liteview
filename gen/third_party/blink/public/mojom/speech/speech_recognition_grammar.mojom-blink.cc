// third_party/blink/public/mojom/speech/speech_recognition_grammar.mojom-blink.cc is auto generated by mojom_bindings_generator.py, do not edit
...
#include "third_party/blink/public/mojom/speech/speech_recognition_grammar.mojom-blink-test-utils.h"
...
bool SpeechRecognitionGrammar::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
bool StructTraits<::blink::mojom::blink::SpeechRecognitionGrammar::DataView, ::blink::mojom::blink::SpeechRecognitionGrammarPtr>::Read(
    ::blink::mojom::blink::SpeechRecognitionGrammar::DataView input, ::blink::mojom::blink::SpeechRecognitionGrammarPtr* output)
{
    bool success = true;
