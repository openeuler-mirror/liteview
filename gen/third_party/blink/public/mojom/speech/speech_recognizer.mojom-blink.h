// third_party/blink/public/mojom/speech/speech_recognizer.mojom-blink.h is auto generated by mojom_bindings_generator.py, do not edit
...
class PLATFORM_EXPORT SpeechRecognizer : public SpeechRecognizerInterfaceBase {
public:
...
class PLATFORM_EXPORT SpeechRecognitionSession : public SpeechRecognitionSessionInterfaceBase {
public:
    using IPCStableHashFunction = uint32_t (*)();
...
class PLATFORM_EXPORT SpeechRecognitionSessionClient : public SpeechRecognitionSessionClientInterfaceBase {
public:
    using IPCStableHashFunction = uint32_t (*)();
...
public:
    ...
    StartSpeechRecognitionRequestParams(::mojo::PendingReceiver<SpeechRecognitionSession> session_receiver_in, ::mojo::PendingRemote<SpeechRecognitionSessionClient> client_in,
        const WTF::String& language_in, WTF::Vector<::blink::mojom::blink::SpeechRecognitionGrammarPtr> grammars_in, uint32_t max_hypotheses_in, bool continuous_in,
...
namespace mojo {
template <>
struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::StartSpeechRecognitionRequestParams::DataView, ::blink::mojom::blink::StartSpeechRecognitionRequestParamsPtr> {
    ...
    static decltype(::blink::mojom::blink::StartSpeechRecognitionRequestParams::session_receiver)& session_receiver(
        ::blink::mojom::blink::StartSpeechRecognitionRequestParamsPtr& input)
    {
        return input->session_receiver;
    }

    static decltype(::blink::mojom::blink::StartSpeechRecognitionRequestParams::client)& client(::blink::mojom::blink::StartSpeechRecognitionRequestParamsPtr& input)
    {
        return input->client;
    }
    ...
    static decltype(::blink::mojom::blink::StartSpeechRecognitionRequestParams::continuous) continuous(const ::blink::mojom::blink::StartSpeechRecognitionRequestParamsPtr& input)
    {
