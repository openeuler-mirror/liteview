// third_party/blink/public/mojom/speech/speech_recognition_error_code.mojom-shared.cc is auto generated by mojom_bindings_generator.py, do not edit
...
static NOINLINE const char* SpeechRecognitionErrorCodeToStringHelper(SpeechRecognitionErrorCode value)
{
...
std::ostream& operator<<(std::ostream& os, SpeechRecognitionErrorCode value) { return os << SpeechRecognitionErrorCodeToString(value); }
...
// static
void TraceFormatTraits<::blink::mojom::SpeechRecognitionErrorCode>::WriteIntoTrace(perfetto::TracedValue context, ::blink::mojom::SpeechRecognitionErrorCode value)
{
    return std::move(context).WriteString(::blink::mojom::SpeechRecognitionErrorCodeToString(value));
}
