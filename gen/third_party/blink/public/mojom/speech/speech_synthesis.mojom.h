...
public:
    ...
    template <typename... Args> static SpeechSynthesisUtterancePtr New(Args&&... args) { return SpeechSynthesisUtterancePtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static SpeechSynthesisUtterancePtr From(const U& u) { return mojo::TypeConverter<SpeechSynthesisUtterancePtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, SpeechSynthesisUtterance>::Convert(*this); }
    ...
    SpeechSynthesisUtterance(const std::string& text_in, const std::string& lang_in, const std::string& voice_in, double volume_in, double rate_in, double pitch_in)
    ...
    template <typename T, SpeechSynthesisUtterance::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    ...
    {
        return mojo::Message(std::make_unique<internal::SpeechSynthesisUtterance_UnserializedMessageContext<UserType, SpeechSynthesisUtterance::DataView>>(0, 0, std::move(input)),
    ...
    {
        return SpeechSynthesisUtterance::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }

    template <typename UserType> static bool DeserializeFromMessage(mojo::Message input, UserType* output)
    {
        auto context = input.TakeUnserializedContext<internal::SpeechSynthesisUtterance_UnserializedMessageContext<UserType, SpeechSynthesisUtterance::DataView>>();
        if (context) {
...
template <typename T, SpeechSynthesisUtterance::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, SpeechSynthesisUtterance::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, SpeechSynthesisUtterance::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static SpeechSynthesisVoicePtr New(Args&&... args) { return SpeechSynthesisVoicePtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static SpeechSynthesisVoicePtr From(const U& u) { return mojo::TypeConverter<SpeechSynthesisVoicePtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, SpeechSynthesisVoice>::Convert(*this); }
    ...
    SpeechSynthesisVoice(const std::string& voice_uri_in, const std::string& name_in, const std::string& lang_in, bool is_local_service_in, bool is_default_in)
    ...
    template <typename T, SpeechSynthesisVoice::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    size_t Hash(size_t seed) const;
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
    ...
    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<SpeechSynthesisVoice::DataView>(input); }
    ...
    template <typename UserType> static mojo::Message WrapAsMessage(UserType input)
    {
        return mojo::Message(std::make_unique<internal::SpeechSynthesisVoice_UnserializedMessageContext<UserType, SpeechSynthesisVoice::DataView>>(0, 0, std::move(input)),
            MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const std::vector<uint8_t>& input, UserType* output)
    {
        return SpeechSynthesisVoice::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, SpeechSynthesisVoice::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, SpeechSynthesisVoice::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, SpeechSynthesisVoice::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::SpeechSynthesisUtterance::DataView, ::blink::mojom::SpeechSynthesisUtterancePtr> {
    ...
    static const decltype(::blink::mojom::SpeechSynthesisUtterance::text)& text(const ::blink::mojom::SpeechSynthesisUtterancePtr& input) { return input->text; }

    static const decltype(::blink::mojom::SpeechSynthesisUtterance::lang)& lang(const ::blink::mojom::SpeechSynthesisUtterancePtr& input) { return input->lang; }

    static const decltype(::blink::mojom::SpeechSynthesisUtterance::voice)& voice(const ::blink::mojom::SpeechSynthesisUtterancePtr& input) { return input->voice; }

    static decltype(::blink::mojom::SpeechSynthesisUtterance::volume) volume(const ::blink::mojom::SpeechSynthesisUtterancePtr& input) { return input->volume; }

    static decltype(::blink::mojom::SpeechSynthesisUtterance::rate) rate(const ::blink::mojom::SpeechSynthesisUtterancePtr& input) { return input->rate; }

    static decltype(::blink::mojom::SpeechSynthesisUtterance::pitch) pitch(const ::blink::mojom::SpeechSynthesisUtterancePtr& input) { return input->pitch; }
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::SpeechSynthesisVoice::DataView, ::blink::mojom::SpeechSynthesisVoicePtr> {
    ...
    static const decltype(::blink::mojom::SpeechSynthesisVoice::voice_uri)& voice_uri(const ::blink::mojom::SpeechSynthesisVoicePtr& input) { return input->voice_uri; }

    static const decltype(::blink::mojom::SpeechSynthesisVoice::name)& name(const ::blink::mojom::SpeechSynthesisVoicePtr& input) { return input->name; }

    static const decltype(::blink::mojom::SpeechSynthesisVoice::lang)& lang(const ::blink::mojom::SpeechSynthesisVoicePtr& input) { return input->lang; }
    ...
    static decltype(::blink::mojom::SpeechSynthesisVoice::is_default) is_default(const ::blink::mojom::SpeechSynthesisVoicePtr& input) { return input->is_default; }
