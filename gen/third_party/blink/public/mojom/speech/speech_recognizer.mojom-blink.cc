...
StartSpeechRecognitionRequestParams::StartSpeechRecognitionRequestParams(::mojo::PendingReceiver<SpeechRecognitionSession> session_receiver_in,
    ::mojo::PendingRemote<SpeechRecognitionSessionClient> client_in, const WTF::String& language_in, WTF::Vector<::blink::mojom::blink::SpeechRecognitionGrammarPtr> grammars_in,
...
void SpeechRecognitionSessionClientProxy::ResultRetrieved(WTF::Vector<::blink::mojom::blink::SpeechRecognitionResultPtr> in_results)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send blink::mojom::SpeechRecognitionSessionClient::ResultRetrieved", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("results"), in_results, "<value of type WTF::Vector<::blink::mojom::blink::SpeechRecognitionResultPtr>>");
    });
#endif
    const bool kExpectsResponse = false;
    const bool kIsSync = false;
...
void SpeechRecognitionSessionClientProxy::ErrorOccurred(::blink::mojom::blink::SpeechRecognitionErrorPtr in_error)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send blink::mojom::SpeechRecognitionSessionClient::ErrorOccurred", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("error"), in_error, "<value of type ::blink::mojom::blink::SpeechRecognitionErrorPtr>");
    });
#endif
    const bool kExpectsResponse = false;
    const bool kIsSync = false;
...
bool SpeechRecognitionSessionClientStubDispatch::Accept(SpeechRecognitionSessionClient* impl, mojo::Message* message)
{
    ...
    case internal::kSpeechRecognitionSessionClient_ResultRetrieved_Name: {
        ...
        WTF::Vector<::blink::mojom::blink::SpeechRecognitionResultPtr> p_results
            = mojo::DefaultConstructTraits::CreateInstance<WTF::Vector<::blink::mojom::blink::SpeechRecognitionResultPtr>>();
    ...
    case internal::kSpeechRecognitionSessionClient_ErrorOccurred_Name: {
        ...
        bool success = true;
        ::blink::mojom::blink::SpeechRecognitionErrorPtr p_error = mojo::DefaultConstructTraits::CreateInstance<::blink::mojom::blink::SpeechRecognitionErrorPtr>();
...
bool StructTraits<::blink::mojom::blink::StartSpeechRecognitionRequestParams::DataView, ::blink::mojom::blink::StartSpeechRecognitionRequestParamsPtr>::Read(
    ::blink::mojom::blink::StartSpeechRecognitionRequestParams::DataView input, ::blink::mojom::blink::StartSpeechRecognitionRequestParamsPtr* output)
{
    bool success = true;
