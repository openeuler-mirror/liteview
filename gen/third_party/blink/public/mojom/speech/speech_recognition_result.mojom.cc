...
SpeechRecognitionResult::SpeechRecognitionResult(std::vector<SpeechRecognitionHypothesisPtr> hypotheses_in, bool is_provisional_in)
...
bool StructTraits<::blink::mojom::SpeechRecognitionHypothesis::DataView, ::blink::mojom::SpeechRecognitionHypothesisPtr>::Read(
    ::blink::mojom::SpeechRecognitionHypothesis::DataView input, ::blink::mojom::SpeechRecognitionHypothesisPtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::SpeechRecognitionResult::DataView, ::blink::mojom::SpeechRecognitionResultPtr>::Read(
    ::blink::mojom::SpeechRecognitionResult::DataView input, ::blink::mojom::SpeechRecognitionResultPtr* output)
{
    bool success = true;
