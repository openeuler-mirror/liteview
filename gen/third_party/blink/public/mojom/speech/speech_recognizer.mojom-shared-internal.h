// third_party/blink/public/mojom/speech/speech_recognizer.mojom-shared-internal.h is auto generated by mojom_bindings_generator.py, do not edit
...
static_assert(sizeof(StartSpeechRecognitionRequestParams_Data) == 48, "Bad sizeof(StartSpeechRecognitionRequestParams_Data)");
// Used by StartSpeechRecognitionRequestParams::WrapAsMessage to lazily serialize the struct.
template <typename UserType, typename DataView> struct StartSpeechRecognitionRequestParams_UnserializedMessageContext : public mojo::internal::UnserializedMessageContext {
public:
