...
std::ostream& operator<<(std::ostream& os, SpeechAudioErrorDetails value) { return os << SpeechAudioErrorDetailsToString(value); }
...
bool SpeechRecognitionError_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    ...
    if (!::blink::mojom::internal::SpeechRecognitionErrorCode_Data ::Validate(object->code, validation_context))
        return false;

    if (!::blink::mojom::internal::SpeechAudioErrorDetails_Data ::Validate(object->details, validation_context))
        return false;
...
// static
void TraceFormatTraits<::blink::mojom::SpeechAudioErrorDetails>::WriteIntoTrace(perfetto::TracedValue context, ::blink::mojom::SpeechAudioErrorDetails value)
{
