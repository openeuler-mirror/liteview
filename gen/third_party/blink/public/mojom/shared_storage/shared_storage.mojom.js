...
(function() {
  ...
  SharedStorageDocumentService_AddModuleOnWorklet_Params.encodedSize = codec.kStructHeaderSize + 8;
  ...
  SharedStorageDocumentService_RunOperationOnWorklet_Params.encodedSize = codec.kStructHeaderSize + 16;
  ...
  SharedStorageDocumentService_RunOperationOnWorklet_Params.encode = function(encoder, val) {
    ...
    encoder.encodeArrayPointer(codec.Uint8, val.serializedData);
  };
  ...
  SharedStorageDocumentService_RunURLSelectionOperationOnWorklet_Params.encodedSize = codec.kStructHeaderSize + 24;
  ...
  SharedStorageDocumentService_RunURLSelectionOperationOnWorklet_ResponseParams.validate = function(messageValidator, offset) {
    ...
    // validate SharedStorageDocumentService_RunURLSelectionOperationOnWorklet_ResponseParams.opaqueUrl
  ...
  SharedStorageDocumentService_RunURLSelectionOperationOnWorklet_ResponseParams.encode = function(encoder, val) {
    ...
    encoder.skip(1);
    encoder.encodeStruct(codec.String, val.errorMessage);
    encoder.encodeStructPointer(url$.Url, val.opaqueUrl);
  };
  ...
  var kSharedStorageDocumentService_AddModuleOnWorklet_Name = 0;
  var kSharedStorageDocumentService_RunOperationOnWorklet_Name = 1;
  var kSharedStorageDocumentService_RunURLSelectionOperationOnWorklet_Name = 2;
  var kSharedStorageDocumentService_SharedStorageSet_Name = 3;
  var kSharedStorageDocumentService_SharedStorageAppend_Name = 4;
  var kSharedStorageDocumentService_SharedStorageDelete_Name = 5;
  var kSharedStorageDocumentService_SharedStorageClear_Name = 6;
  ...
  SharedStorageDocumentServiceProxy.prototype.addModuleOnWorklet = function(scriptSourceUrl) {
  ...
  SharedStorageDocumentServiceProxy.prototype.runOperationOnWorklet = function(name, serializedData) {
  ...
  SharedStorageDocumentServiceProxy.prototype.runURLSelectionOperationOnWorklet = function(name, urlsWithMetadata, serializedData) {
  ...
  SharedStorageDocumentServiceStub.prototype.addModuleOnWorklet = function(scriptSourceUrl) {
    return this.delegate_ && this.delegate_.addModuleOnWorklet && this.delegate_.addModuleOnWorklet(scriptSourceUrl);
  }
  SharedStorageDocumentServiceStub.prototype.runOperationOnWorklet = function(name, serializedData) {
    return this.delegate_ && this.delegate_.runOperationOnWorklet && this.delegate_.runOperationOnWorklet(name, serializedData);
  }
  SharedStorageDocumentServiceStub.prototype.runURLSelectionOperationOnWorklet = function(name, urlsWithMetadata, serializedData) {
    return this.delegate_ && this.delegate_.runURLSelectionOperationOnWorklet && this.delegate_.runURLSelectionOperationOnWorklet(name, urlsWithMetadata, serializedData);
  }
  ...
  SharedStorageDocumentServiceStub.prototype.acceptWithResponder =
    ...
    case kSharedStorageDocumentService_AddModuleOnWorklet_Name:
      ...
      this.addModuleOnWorklet(params.scriptSourceUrl).then(function(response) {
        var responseParams =
    ...
    case kSharedStorageDocumentService_RunOperationOnWorklet_Name:
      ...
      this.runOperationOnWorklet(params.name, params.serializedData).then(function(response) {
        var responseParams =
    ...
    case kSharedStorageDocumentService_RunURLSelectionOperationOnWorklet_Name:
      ...
      this.runURLSelectionOperationOnWorklet(params.name, params.urlsWithMetadata, params.serializedData).then(function(response) {
        var responseParams =
            new SharedStorageDocumentService_RunURLSelectionOperationOnWorklet_ResponseParams();
        responseParams.success = response.success;
        responseParams.errorMessage = response.errorMessage;
        responseParams.opaqueUrl = response.opaqueUrl;
        var builder = new codec.MessageV1Builder(
            kSharedStorageDocumentService_RunURLSelectionOperationOnWorklet_Name,
