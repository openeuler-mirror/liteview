...
//
//   void ConnectToChannel(const WTF::String& name, ::mojo::PendingAssociatedRemote<BroadcastChannelClient> client, ::mojo::PendingAssociatedReceiver<BroadcastChannelClient>
//   connection) final;
//
//  private:
//   mojo::MessageReceiverWithResponder* receiver_;
