...
class CONTENT_EXPORT BroadcastChannelClient : public BroadcastChannelClientInterfaceBase {
public:
...
class CONTENT_EXPORT BroadcastChannelProvider : public BroadcastChannelProviderInterfaceBase {
public:
    using IPCStableHashFunction = uint32_t (*)();
...
class CONTENT_EXPORT BroadcastChannelClientProxy : public BroadcastChannelClient {
public:
...
class CONTENT_EXPORT BroadcastChannelProviderProxy : public BroadcastChannelProvider {
public:
    ...
    void ConnectToChannel(
        const std::string& name, ::mojo::PendingAssociatedRemote<BroadcastChannelClient> client, ::mojo::PendingAssociatedReceiver<BroadcastChannelClient> connection) final;
