...
Manifest::Manifest(const absl::optional<::std::u16string>& name_in, const absl::optional<::std::u16string>& short_name_in, const absl::optional<::std::u16string>& description_in,
    const absl::optional<::std::u16string>& id_in, const ::GURL& start_url_in, ::blink::mojom::DisplayMode display_in, std::vector<::blink::mojom::DisplayMode> display_override_in,
    ::device::mojom::ScreenOrientationLockType orientation_in, std::vector<::blink::Manifest::ImageResource> icons_in, std::vector<ManifestScreenshotPtr> screenshots_in,
    std::vector<::blink::Manifest::ShortcutItem> shortcuts_in, const absl::optional<::blink::Manifest::ShareTarget>& share_target_in,
    std::vector<ManifestFileHandlerPtr> file_handlers_in, std::vector<ManifestProtocolHandlerPtr> protocol_handlers_in, std::vector<ManifestUrlHandlerPtr> url_handlers_in,
    ManifestLockScreenPtr lock_screen_in, ManifestNoteTakingPtr note_taking_in, std::vector<::blink::Manifest::RelatedApplication> related_applications_in,
    bool prefer_related_applications_in, bool has_theme_color_in, uint32_t theme_color_in, bool has_background_color_in, uint32_t background_color_in,
    const absl::optional<::std::u16string>& gcm_sender_id_in, const ::GURL& scope_in, ::blink::mojom::CaptureLinks capture_links_in, bool isolated_storage_in,
...
ManifestShortcutItem::ManifestShortcutItem(const ::std::u16string& name_in, const absl::optional<::std::u16string>& short_name_in,
    const absl::optional<::std::u16string>& description_in, const ::GURL& url_in, std::vector<::blink::Manifest::ImageResource> icons_in)
    : name(std::move(name_in))
    , short_name(std::move(short_name_in))
    , description(std::move(description_in))
    , url(std::move(url_in))
...
ManifestScreenshot::ManifestScreenshot(
    const ::blink::Manifest::ImageResource& image_in, ManifestScreenshot::FormFactor form_factor_in, const absl::optional<::std::u16string>& label_in)
...
ManifestFileFilter::ManifestFileFilter(const absl::optional<::std::u16string>& name_in, std::vector<::std::u16string> accept_in)
    : name(std::move(name_in))
...
ManifestRelatedApplication::ManifestRelatedApplication(
    const absl::optional<::std::u16string>& platform_in, const absl::optional<::GURL>& url_in, const absl::optional<::std::u16string>& id_in)
...
ManifestShareTargetParams::ManifestShareTargetParams(const absl::optional<::std::u16string>& title_in, const absl::optional<::std::u16string>& text_in,
    const absl::optional<::std::u16string>& url_in, absl::optional<std::vector<ManifestFileFilterPtr>> files_in)
...
HomeTabParams::HomeTabParams(std::vector<::blink::Manifest::ImageResource> icons_in)
    : icons(std::move(icons_in))
{
}
...
NewTabButtonParams::NewTabButtonParams(const absl::optional<::GURL>& url_in)
    : url(std::move(url_in))
{
}
...
// static
bool StructTraits<::blink::mojom::Manifest::DataView, ::blink::mojom::ManifestPtr>::Read(::blink::mojom::Manifest::DataView input, ::blink::mojom::ManifestPtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::ManifestUserPreferences::DataView, ::blink::mojom::ManifestUserPreferencesPtr>::Read(
    ::blink::mojom::ManifestUserPreferences::DataView input, ::blink::mojom::ManifestUserPreferencesPtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::ManifestUserPreferenceOverrides::DataView, ::blink::mojom::ManifestUserPreferenceOverridesPtr>::Read(
    ::blink::mojom::ManifestUserPreferenceOverrides::DataView input, ::blink::mojom::ManifestUserPreferenceOverridesPtr* output)
{
    bool success = true;
...
bool UnionTraits<::blink::mojom::NewTabButtonUnion::DataView, ::blink::mojom::NewTabButtonUnionPtr>::Read(
    ::blink::mojom::NewTabButtonUnion::DataView input, ::blink::mojom::NewTabButtonUnionPtr* output)
{
