...
static NOINLINE const char* DisplayModeToStringHelper(DisplayMode value)
{
...
std::ostream& operator<<(std::ostream& os, DisplayMode value) { return os << DisplayModeToString(value); }
