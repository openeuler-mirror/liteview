...
(function() {
  ...
  Manifest.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 112, ManifestLockScreen, true);
    if (err !== validator.validationError.NONE)
        return err;


    // validate Manifest.noteTaking
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 120, ManifestNoteTaking, true);
    if (err !== validator.validationError.NONE)
        return err;


    // validate Manifest.relatedApplications
    err = messageValidator.validateArrayPointer(offset + codec.kStructHeaderSize + 128, 8, new codec.PointerTo(ManifestRelatedApplication), false, [0], 0);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 152, string16$.String16, true);
    if (err !== validator.validationError.NONE)
        return err;


    // validate Manifest.scope
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 160, url$.Url, false);
    if (err !== validator.validationError.NONE)
        return err;


    // validate Manifest.captureLinks
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 148, capture_links$.CaptureLinks);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    err = messageValidator.validateArrayPointer(offset + codec.kStructHeaderSize + 168, 8, new codec.PointerTo(permissions_policy$.ParsedPermissionsPolicyDeclaration), false, [0], 0);
    if (err !== validator.validationError.NONE)
        return err;


    // validate Manifest.launchHandler
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 176, manifest_launch_handler$.ManifestLaunchHandler, true);
    if (err !== validator.validationError.NONE)
        return err;


    // validate Manifest.translations
    err = messageValidator.validateMapPointer(offset + codec.kStructHeaderSize + 184, false, new codec.PointerTo(string16$.String16), new codec.PointerTo(ManifestTranslationItem), false);
    if (err !== validator.validationError.NONE)
        return err;


    // validate Manifest.userPreferences
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 192, ManifestUserPreferences, true);
    if (err !== validator.validationError.NONE)
        return err;


    // validate Manifest.tabStrip
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 200, ManifestTabStrip, true);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  Manifest.encodedSize = codec.kStructHeaderSize + 208;
  ...
  ManifestTabStrip.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateUnion(offset + codec.kStructHeaderSize + 16, NewTabButtonUnion, false);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  ManifestTabStrip.encodedSize = codec.kStructHeaderSize + 32;
  ...
  ManifestTabStrip.decode = function(decoder) {
    ...
    val.newTabButton =
        decoder.decodeStruct(NewTabButtonUnion);
    return val;
  };
  ...
  ManifestTabStrip.encode = function(encoder, val) {
    ...
    encoder.encodeStruct(NewTabButtonUnion, val.newTabButton);
  };
  ...
  HomeTabParams.encodedSize = codec.kStructHeaderSize + 8;
  ...
  function NewTabButtonUnion(value) {
    this.initDefault_();
    this.initValue_(value);
  }


  NewTabButtonUnion.Tags = {
    visibility: 0,
    params: 1,
  };

  NewTabButtonUnion.prototype.initDefault_ = function() {
    this.$data = null;
    this.$tag = undefined;
  }

  NewTabButtonUnion.prototype.initValue_ = function(value) {
    if (value == undefined) {
      return;
    }
    ...
    if (fields.indexOf(keys[0]) < 0) {
      throw new ReferenceError(keys[0] + " is not a NewTabButtonUnion member.");

    }

    this[keys[0]] = value[keys[0]];
  }
  Object.defineProperty(NewTabButtonUnion.prototype, "visibility", {
    get: function() {
      if (this.$tag != NewTabButtonUnion.Tags.visibility) {
        throw new ReferenceError(
            "NewTabButtonUnion.visibility is not currently set.");
      }
      return this.$data;
    },

    set: function(value) {
      this.$tag = NewTabButtonUnion.Tags.visibility;
      this.$data = value;
    }
  });
  Object.defineProperty(NewTabButtonUnion.prototype, "params", {
    get: function() {
      if (this.$tag != NewTabButtonUnion.Tags.params) {
        throw new ReferenceError(
            "NewTabButtonUnion.params is not currently set.");
      }
      return this.$data;
    },

    set: function(value) {
      this.$tag = NewTabButtonUnion.Tags.params;
      this.$data = value;
    }
  });


    NewTabButtonUnion.encode = function(encoder, val) {
      if (val == null) {
        encoder.writeUint64(0);
        encoder.writeUint64(0);
        return;
      ...
      encoder.writeUint32(val.$tag);
      switch (val.$tag) {
        case NewTabButtonUnion.Tags.visibility:
          encoder.encodeStruct(codec.Int32, val.visibility);
          break;
        case NewTabButtonUnion.Tags.params:
          encoder.encodeStructPointer(NewTabButtonParams, val.params);
          break;
      }
      encoder.align();
    };
    ...
    NewTabButtonUnion.decode = function(decoder) {
      var size = decoder.readUint32();
      if (size == 0) {
        decoder.readUint32();
        decoder.readUint64();
      ...
      var result = new NewTabButtonUnion();
      var tag = decoder.readUint32();
      switch (tag) {
        case NewTabButtonUnion.Tags.visibility:
          result.visibility = decoder.decodeStruct(new codec.Enum(TabStripMemberVisibility));
          break;
        case NewTabButtonUnion.Tags.params:
          result.params = decoder.decodeStructPointer(NewTabButtonParams);
          break;
      }
      decoder.align();
    ...
    NewTabButtonUnion.validate = function(messageValidator, offset) {
      var size = messageValidator.decodeUnionSize(offset);
      if (size != 16) {
        return validator.validationError.INVALID_UNION_SIZE;
      }
    ...
    // validate NewTabButtonUnion.visibility
    err = messageValidator.validateEnum(data_offset, TabStripMemberVisibility);
    if (err !== validator.validationError.NONE)
        return err;
          break;
    ...
    // validate NewTabButtonUnion.params
    err = messageValidator.validateStructPointer(data_offset, NewTabButtonParams, false);
    if (err !== validator.validationError.NONE)
        return err;
          break;
      }
  ...
  NewTabButtonUnion.encodedSize = 16;
  ...
  exports.NewTabButtonUnion = NewTabButtonUnion;
})();
