...
public:
    ...
    void RequestManifest(::blink::KURL* out_url, ::blink::mojom::blink::ManifestPtr* out_manifest);

    void RequestManifestDebugInfo(::blink::KURL* out_url, ::blink::mojom::blink::ManifestPtr* out_parsed_manifest, ::blink::mojom::blink::ManifestDebugInfoPtr* out_debug_info);
