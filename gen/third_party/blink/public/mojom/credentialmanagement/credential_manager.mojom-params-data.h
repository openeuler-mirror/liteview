...
public:
    ...
    CredentialManager_PreventSilentAccess_ResponseParamsDataView(internal::CredentialManager_PreventSilentAccess_ResponseParams_Data* data, mojo::Message* message)
        : data_(data)
    {
    }
...
public:
    ...
    bool include_passwords() const { return data_->include_passwords; }
...
public:
    ...
    CredentialManagerError error() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::blink::mojom::CredentialManagerError>(data_->error)); }
    inline void GetCredentialDataView(CredentialInfoDataView* output);
