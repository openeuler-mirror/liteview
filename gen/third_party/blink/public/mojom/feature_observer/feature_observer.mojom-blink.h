...
struct blink_mojom_internal_ObservedFeatureType_DataHashFn {
    ...
    static bool Equal(const ::blink::mojom::ObservedFeatureType& left, const ::blink::mojom::ObservedFeatureType& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::blink::mojom::ObservedFeatureType> : public GenericHashTraits<::blink::mojom::ObservedFeatureType> {
    ...
    static void ConstructDeletedValue(::blink::mojom::ObservedFeatureType& slot, bool) { slot = static_cast<::blink::mojom::ObservedFeatureType>(-1000001); }
    static bool IsDeletedValue(const ::blink::mojom::ObservedFeatureType& value) { return value == static_cast<::blink::mojom::ObservedFeatureType>(-1000001); }
};
} // namespace WTF
namespace blink {
namespace mojom {
