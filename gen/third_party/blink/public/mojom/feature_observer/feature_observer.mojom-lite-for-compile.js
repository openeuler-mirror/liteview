// third_party/blink/public/mojom/feature_observer/feature_observer.mojom-lite-for-compile.js is auto generated by mojom_bindings_generator.py, do not edit
...
goog.provide('blink.mojom.ObservedFeatureType');
goog.provide('blink.mojom.ObservedFeatureTypeSpec');
/**
...
goog.provide('blink.mojom.ObservedFeature');
goog.provide('blink.mojom.ObservedFeatureReceiver');
goog.provide('blink.mojom.ObservedFeatureCallbackRouter');
goog.provide('blink.mojom.ObservedFeatureInterface');
goog.provide('blink.mojom.ObservedFeatureRemote');
goog.provide('blink.mojom.ObservedFeaturePendingReceiver');
/**
...
/** @interface */
blink.mojom.ObservedFeatureInterface = class {
};
...
goog.provide('blink.mojom.FeatureObserver');
goog.provide('blink.mojom.FeatureObserverReceiver');
goog.provide('blink.mojom.FeatureObserverCallbackRouter');
goog.provide('blink.mojom.FeatureObserverInterface');
goog.provide('blink.mojom.FeatureObserverRemote');
goog.provide('blink.mojom.FeatureObserverPendingReceiver');
/**
 * @implements {mojo.internal.interfaceSupport.PendingReceiver}
 * @export
 */
...
/** @interface */
blink.mojom.FeatureObserverInterface = class {
...
goog.provide('blink.mojom.FeatureObserver_Register_ParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('blink.mojom.FeatureObserver_Register_Params');
