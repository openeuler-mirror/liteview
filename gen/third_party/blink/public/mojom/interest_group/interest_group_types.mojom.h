...
public:
    ...
    InterestGroupAd(const ::GURL& render_url_in, const absl::optional<std::string>& metadata_in)
...
public:
    ...
    InterestGroup(::base::Time expiry_in, const ::url::Origin& owner_in, const std::string& name_in, double priority_in, bool enable_bidding_signals_prioritization_in,
...
public:
    ...
    DirectFromSellerSignals(const ::GURL& prefix_in, const base::flat_map<::url::Origin, ::blink::DirectFromSellerSignalsSubresource>& per_buyer_signals_in,
...
public:
    ...
    AuctionAdConfigNonSharedParams(absl::optional<std::vector<::url::Origin>> interest_group_buyers_in, const absl::optional<std::string>& auction_signals_in,
        const absl::optional<std::string>& seller_signals_in, absl::optional<::base::TimeDelta> seller_timeout_in,
...
public:
    ...
    AuctionAdConfig(const ::url::Origin& seller_in, const ::GURL& decision_logic_url_in, const absl::optional<::GURL>& trusted_scoring_signals_url_in,
        const ::blink::AuctionConfig::NonSharedParams& auction_ad_config_non_shared_params_in,
        const absl::optional<::blink::DirectFromSellerSignals>& direct_from_seller_signals_in, bool has_seller_experiment_group_id_in, uint16_t seller_experiment_group_id_in,
        bool has_all_buyer_experiment_group_id_in, int16_t all_buyer_experiment_group_id_in, const base::flat_map<::url::Origin, uint16_t>& per_buyer_experiment_group_ids_in)
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::InterestGroupAd::DataView, ::blink::mojom::InterestGroupAdPtr> {
    ...
    static const decltype(::blink::mojom::InterestGroupAd::render_url)& render_url(const ::blink::mojom::InterestGroupAdPtr& input) { return input->render_url; }

    static const decltype(::blink::mojom::InterestGroupAd::metadata)& metadata(const ::blink::mojom::InterestGroupAdPtr& input) { return input->metadata; }
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::InterestGroup::DataView, ::blink::mojom::InterestGroupPtr> {
    ...
    static const decltype(::blink::mojom::InterestGroup::expiry)& expiry(const ::blink::mojom::InterestGroupPtr& input) { return input->expiry; }

    static const decltype(::blink::mojom::InterestGroup::owner)& owner(const ::blink::mojom::InterestGroupPtr& input) { return input->owner; }

    static const decltype(::blink::mojom::InterestGroup::name)& name(const ::blink::mojom::InterestGroupPtr& input) { return input->name; }

    static decltype(::blink::mojom::InterestGroup::priority) priority(const ::blink::mojom::InterestGroupPtr& input) { return input->priority; }

    static decltype(::blink::mojom::InterestGroup::enable_bidding_signals_prioritization) enable_bidding_signals_prioritization(const ::blink::mojom::InterestGroupPtr& input)
    {
        return input->enable_bidding_signals_prioritization;
    }

    static const decltype(::blink::mojom::InterestGroup::priority_vector)& priority_vector(const ::blink::mojom::InterestGroupPtr& input) { return input->priority_vector; }
    ...
    static decltype(::blink::mojom::InterestGroup::execution_mode) execution_mode(const ::blink::mojom::InterestGroupPtr& input) { return input->execution_mode; }

    static const decltype(::blink::mojom::InterestGroup::bidding_url)& bidding_url(const ::blink::mojom::InterestGroupPtr& input) { return input->bidding_url; }
    ...
    static const decltype(::blink::mojom::InterestGroup::daily_update_url)& daily_update_url(const ::blink::mojom::InterestGroupPtr& input) { return input->daily_update_url; }

    static const decltype(::blink::mojom::InterestGroup::trusted_bidding_signals_url)& trusted_bidding_signals_url(const ::blink::mojom::InterestGroupPtr& input)
    {
        return input->trusted_bidding_signals_url;
    }

    static const decltype(::blink::mojom::InterestGroup::trusted_bidding_signals_keys)& trusted_bidding_signals_keys(const ::blink::mojom::InterestGroupPtr& input)
    {
    ...
    static const decltype(::blink::mojom::InterestGroup::ads)& ads(const ::blink::mojom::InterestGroupPtr& input) { return input->ads; }

    static const decltype(::blink::mojom::InterestGroup::ad_components)& ad_components(const ::blink::mojom::InterestGroupPtr& input) { return input->ad_components; }

    static bool Read(::blink::mojom::InterestGroup::DataView input, ::blink::mojom::InterestGroupPtr* output);
};
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::DirectFromSellerSignalsSubresource::DataView, ::blink::mojom::DirectFromSellerSignalsSubresourcePtr> {
    static bool IsNull(const ::blink::mojom::DirectFromSellerSignalsSubresourcePtr& input) { return !input; }
    static void SetToNull(::blink::mojom::DirectFromSellerSignalsSubresourcePtr* output) { output->reset(); }

    static const decltype(::blink::mojom::DirectFromSellerSignalsSubresource::bundle_url)& bundle_url(const ::blink::mojom::DirectFromSellerSignalsSubresourcePtr& input)
    {
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::DirectFromSellerSignals::DataView, ::blink::mojom::DirectFromSellerSignalsPtr> {
    static bool IsNull(const ::blink::mojom::DirectFromSellerSignalsPtr& input) { return !input; }
    static void SetToNull(::blink::mojom::DirectFromSellerSignalsPtr* output) { output->reset(); }

    static const decltype(::blink::mojom::DirectFromSellerSignals::prefix)& prefix(const ::blink::mojom::DirectFromSellerSignalsPtr& input) { return input->prefix; }

    static const decltype(::blink::mojom::DirectFromSellerSignals::per_buyer_signals)& per_buyer_signals(const ::blink::mojom::DirectFromSellerSignalsPtr& input)
    {
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::AuctionAdConfigNonSharedParams::DataView, ::blink::mojom::AuctionAdConfigNonSharedParamsPtr> {
    ...
    static const decltype(::blink::mojom::AuctionAdConfigNonSharedParams::auction_signals)& auction_signals(const ::blink::mojom::AuctionAdConfigNonSharedParamsPtr& input)
    {
        return input->auction_signals;
    }

    static const decltype(::blink::mojom::AuctionAdConfigNonSharedParams::seller_signals)& seller_signals(const ::blink::mojom::AuctionAdConfigNonSharedParamsPtr& input)
    {
        return input->seller_signals;
    }

    static const decltype(::blink::mojom::AuctionAdConfigNonSharedParams::seller_timeout)& seller_timeout(const ::blink::mojom::AuctionAdConfigNonSharedParamsPtr& input)
    {
        return input->seller_timeout;
    }

    static const decltype(::blink::mojom::AuctionAdConfigNonSharedParams::per_buyer_signals)& per_buyer_signals(const ::blink::mojom::AuctionAdConfigNonSharedParamsPtr& input)
    {
        return input->per_buyer_signals;
    }

    static const decltype(::blink::mojom::AuctionAdConfigNonSharedParams::per_buyer_timeouts)& per_buyer_timeouts(const ::blink::mojom::AuctionAdConfigNonSharedParamsPtr& input)
    {
        return input->per_buyer_timeouts;
    }

    static const decltype(::blink::mojom::AuctionAdConfigNonSharedParams::all_buyers_timeout)& all_buyers_timeout(const ::blink::mojom::AuctionAdConfigNonSharedParamsPtr& input)
    {
    ...
    static decltype(::blink::mojom::AuctionAdConfigNonSharedParams::all_buyers_group_limit) all_buyers_group_limit(const ::blink::mojom::AuctionAdConfigNonSharedParamsPtr& input)
    {
        return input->all_buyers_group_limit;
    }

    static const decltype(::blink::mojom::AuctionAdConfigNonSharedParams::component_auctions)& component_auctions(const ::blink::mojom::AuctionAdConfigNonSharedParamsPtr& input)
    {
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::AuctionAdConfig::DataView, ::blink::mojom::AuctionAdConfigPtr> {
    ...
    static const decltype(::blink::mojom::AuctionAdConfig::seller)& seller(const ::blink::mojom::AuctionAdConfigPtr& input) { return input->seller; }
    ...
    static const decltype(::blink::mojom::AuctionAdConfig::trusted_scoring_signals_url)& trusted_scoring_signals_url(const ::blink::mojom::AuctionAdConfigPtr& input)
    {
    ...
    static const decltype(::blink::mojom::AuctionAdConfig::direct_from_seller_signals)& direct_from_seller_signals(const ::blink::mojom::AuctionAdConfigPtr& input)
    {
        return input->direct_from_seller_signals;
    }

    static decltype(::blink::mojom::AuctionAdConfig::has_seller_experiment_group_id) has_seller_experiment_group_id(const ::blink::mojom::AuctionAdConfigPtr& input)
    {
    ...
    static decltype(::blink::mojom::AuctionAdConfig::has_all_buyer_experiment_group_id) has_all_buyer_experiment_group_id(const ::blink::mojom::AuctionAdConfigPtr& input)
    {
        return input->has_all_buyer_experiment_group_id;
    }

    static decltype(::blink::mojom::AuctionAdConfig::all_buyer_experiment_group_id) all_buyer_experiment_group_id(const ::blink::mojom::AuctionAdConfigPtr& input)
    {
        return input->all_buyer_experiment_group_id;
    }

    static const decltype(::blink::mojom::AuctionAdConfig::per_buyer_experiment_group_ids)& per_buyer_experiment_group_ids(const ::blink::mojom::AuctionAdConfigPtr& input)
    {
