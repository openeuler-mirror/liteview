...
CloneableMessage::CloneableMessage(::mojo_base::BigBuffer encoded_message_in, WTF::Vector<::scoped_refptr<::blink::BlobDataHandle>> blobs_in,
    ...
    int64_t stack_trace_debugger_id_second_in, bool stack_trace_should_pause_in, const ::base::UnguessableToken& sender_agent_cluster_id_in, bool locked_to_sender_agent_cluster_in,
