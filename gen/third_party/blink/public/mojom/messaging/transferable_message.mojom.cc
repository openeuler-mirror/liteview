...
TransferableMessage::TransferableMessage(::blink::CloneableMessage message_in, std::vector<::blink::MessagePortDescriptor> ports_in,
    std::vector<::blink::MessagePortDescriptor> stream_channels_in, std::vector<::blink::mojom::SerializedArrayBufferContentsPtr> array_buffer_contents_array_in,
    std::vector<::SkBitmap> image_bitmap_contents_array_in, ::blink::mojom::UserActivationSnapshotPtr user_activation_in,
    ::blink::mojom::DelegatedCapability delegated_capability_in, absl::optional<::blink::scheduler::TaskAttributionId> parent_task_id_in)
