...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::FindOptions::DataView, ::blink::mojom::FindOptionsPtr> {
    ...
    static decltype(::blink::mojom::FindOptions::forward) forward(const ::blink::mojom::FindOptionsPtr& input) { return input->forward; }

    static decltype(::blink::mojom::FindOptions::match_case) match_case(const ::blink::mojom::FindOptionsPtr& input) { return input->match_case; }

    static decltype(::blink::mojom::FindOptions::new_session) new_session(const ::blink::mojom::FindOptionsPtr& input) { return input->new_session; }

    static decltype(::blink::mojom::FindOptions::find_match) find_match(const ::blink::mojom::FindOptionsPtr& input) { return input->find_match; }

    static decltype(::blink::mojom::FindOptions::force) force(const ::blink::mojom::FindOptionsPtr& input) { return input->force; }
