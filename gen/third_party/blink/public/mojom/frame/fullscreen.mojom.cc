...
FullscreenOptions::FullscreenOptions(bool prefers_navigation_bar_in, bool prefers_status_bar_in, int64_t display_id_in, bool is_prefixed_in, bool is_xr_overlay_in)
...
bool FullscreenOptions::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
