...
// static
bool StructTraits<::blink::mojom::FramePolicy::DataView, ::blink::mojom::FramePolicyPtr>::Read(::blink::mojom::FramePolicy::DataView input, ::blink::mojom::FramePolicyPtr* output)
{
    bool success = true;
