...
// with not having this data in traces there.
    ...
    virtual void RouteMessageEvent(const absl::optional<::blink::LocalFrameToken>& source_frame_token, const ::std::u16string& source_origin, const ::std::u16string& target_origin,
...
// with not having this data in traces there.
    ...
    virtual void CreateRemoteChild(const ::blink::RemoteFrameToken& token, const absl::optional<::blink::FrameToken>& opener_frame_token,
...
//
//   void RouteMessageEvent(const absl::optional<::blink::LocalFrameToken>& source_frame_token, const ::std::u16string& source_origin, const ::std::u16string& target_origin,
...
//   void Detach() final;
//
//   void UpdateViewportIntersection(::blink::mojom::ViewportIntersectionStatePtr intersection_state, const absl::optional<::blink::FrameVisualProperties>& visual_properties)
//   final;
//
...
//
//   void DidSetFramePolicyHeaders(::network::mojom::WebSandboxFlags sandbox_flags, const std::vector<::blink::ParsedPermissionsPolicyDeclaration>& parsed_permissions_policy)
//   final;
//
...
//
//   void CreateRemoteChild(const ::blink::RemoteFrameToken& token, const absl::optional<::blink::FrameToken>& opener_frame_token, ::blink::mojom::TreeScopeType tree_scope_type,
//   ::blink::mojom::FrameReplicationStatePtr replication_state, const ::base::UnguessableToken& devtools_frame_token, RemoteFrameInterfacesFromBrowserPtr remote_frame_interfaces)
//   final;
//
//  private:
//   mojo::MessageReceiverWithResponder* receiver_;
...
public:
    ...
    template <typename... Args> static RemoteMainFrameInterfacesPtr New(Args&&... args) { return RemoteMainFrameInterfacesPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static RemoteMainFrameInterfacesPtr From(const U& u) { return mojo::TypeConverter<RemoteMainFrameInterfacesPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, RemoteMainFrameInterfaces>::Convert(*this); }
    ...
    RemoteMainFrameInterfaces(::mojo::PendingAssociatedRemote<RemoteMainFrameHost> main_frame_host_in, ::mojo::PendingAssociatedReceiver<RemoteMainFrame> main_frame_in)
    ...
    template <typename T, RemoteMainFrameInterfaces::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::RemoteMainFrameInterfaces_UnserializedMessageContext<UserType, RemoteMainFrameInterfaces::DataView>>(0, 0, std::move(input)),
    ...
    {
        return RemoteMainFrameInterfaces::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }

    template <typename UserType> static bool DeserializeFromMessage(mojo::Message input, UserType* output)
    {
        auto context = input.TakeUnserializedContext<internal::RemoteMainFrameInterfaces_UnserializedMessageContext<UserType, RemoteMainFrameInterfaces::DataView>>();
        if (context) {
...
template <typename T, RemoteMainFrameInterfaces::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, RemoteMainFrameInterfaces::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, RemoteMainFrameInterfaces::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    {
        return RemoteFrameInterfacesFromRendererPtr(absl::in_place, std::forward<Args>(args)...);
    }

    template <typename U> static RemoteFrameInterfacesFromRendererPtr From(const U& u) { return mojo::TypeConverter<RemoteFrameInterfacesFromRendererPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, RemoteFrameInterfacesFromRenderer>::Convert(*this); }
    ...
    RemoteFrameInterfacesFromRenderer(::mojo::PendingAssociatedRemote<RemoteFrame> frame_in, ::mojo::PendingAssociatedReceiver<RemoteFrameHost> frame_host_receiver_in)
    ...
    template <typename T, RemoteFrameInterfacesFromRenderer::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::RemoteFrameInterfacesFromRenderer_UnserializedMessageContext<UserType, RemoteFrameInterfacesFromRenderer::DataView>>(0, 0, std::move(input)),
            MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const std::vector<uint8_t>& input, UserType* output)
    {
        return RemoteFrameInterfacesFromRenderer::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }

    template <typename UserType> static bool DeserializeFromMessage(mojo::Message input, UserType* output)
    {
        auto context
            = input.TakeUnserializedContext<internal::RemoteFrameInterfacesFromRenderer_UnserializedMessageContext<UserType, RemoteFrameInterfacesFromRenderer::DataView>>();
        if (context) {
            *output = std::move(context->TakeData());
            return true;
        }
        input.SerializeIfNecessary();
        return mojo::internal::DeserializeImpl<RemoteFrameInterfacesFromRenderer::DataView>(input, input.payload(), input.payload_num_bytes(), output, Validate);
    }
...
template <typename T, RemoteFrameInterfacesFromRenderer::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, RemoteFrameInterfacesFromRenderer::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, RemoteFrameInterfacesFromRenderer::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    {
        return RemoteFrameInterfacesFromBrowserPtr(absl::in_place, std::forward<Args>(args)...);
    }

    template <typename U> static RemoteFrameInterfacesFromBrowserPtr From(const U& u) { return mojo::TypeConverter<RemoteFrameInterfacesFromBrowserPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, RemoteFrameInterfacesFromBrowser>::Convert(*this); }
    ...
    RemoteFrameInterfacesFromBrowser(::mojo::PendingAssociatedReceiver<RemoteFrame> frame_receiver_in, ::mojo::PendingAssociatedRemote<RemoteFrameHost> frame_host_in)
    ...
    template <typename T, RemoteFrameInterfacesFromBrowser::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::RemoteFrameInterfacesFromBrowser_UnserializedMessageContext<UserType, RemoteFrameInterfacesFromBrowser::DataView>>(0, 0, std::move(input)),
            MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const std::vector<uint8_t>& input, UserType* output)
    {
        return RemoteFrameInterfacesFromBrowser::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }

    template <typename UserType> static bool DeserializeFromMessage(mojo::Message input, UserType* output)
    {
        auto context = input.TakeUnserializedContext<internal::RemoteFrameInterfacesFromBrowser_UnserializedMessageContext<UserType, RemoteFrameInterfacesFromBrowser::DataView>>();
        if (context) {
            *output = std::move(context->TakeData());
            return true;
        }
...
template <typename T, RemoteFrameInterfacesFromBrowser::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, RemoteFrameInterfacesFromBrowser::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, RemoteFrameInterfacesFromBrowser::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static OpenURLParamsPtr New(Args&&... args) { return OpenURLParamsPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static OpenURLParamsPtr From(const U& u) { return mojo::TypeConverter<OpenURLParamsPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, OpenURLParams>::Convert(*this); }
    OpenURLParams()
        : url()
        , initiator_origin()
    ...
    OpenURLParams(const ::GURL& url_in, const ::url::Origin& initiator_origin_in, const absl::optional<::blink::LocalFrameToken>& initiator_frame_token_in,
        ...
        const absl::optional<::blink::Impression>& impression_in, const ::blink::NavigationDownloadPolicy& download_policy_in,
    ...
    template <typename T, OpenURLParams::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<OpenURLParams::DataView>(input); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::OpenURLParams_UnserializedMessageContext<UserType, OpenURLParams::DataView>>(0, 0, std::move(input)), MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const std::vector<uint8_t>& input, UserType* output)
    {
        return OpenURLParams::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, OpenURLParams::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, OpenURLParams::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, OpenURLParams::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }

template <typename StructPtrType> RemoteMainFrameInterfacesPtr RemoteMainFrameInterfaces::Clone() const { return New(mojo::Clone(main_frame_host), mojo::Clone(main_frame)); }
...
{
    return New(mojo::Clone(url), mojo::Clone(initiator_origin), mojo::Clone(initiator_frame_token), mojo::Clone(post_body), mojo::Clone(extra_headers), mojo::Clone(referrer),
        mojo::Clone(is_form_submission), mojo::Clone(disposition), mojo::Clone(should_replace_current_entry), mojo::Clone(user_gesture), mojo::Clone(is_unfenced_top_navigation),
        mojo::Clone(triggering_event_info), mojo::Clone(blob_url_token), mojo::Clone(href_translate), mojo::Clone(impression), mojo::Clone(download_policy),
        mojo::Clone(source_location), mojo::Clone(initiator_policy_container_keep_alive_handle));
}
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::RemoteMainFrameInterfaces::DataView, ::blink::mojom::RemoteMainFrameInterfacesPtr> {
    ...
    static decltype(::blink::mojom::RemoteMainFrameInterfaces::main_frame)& main_frame(::blink::mojom::RemoteMainFrameInterfacesPtr& input) { return input->main_frame; }

    static bool Read(::blink::mojom::RemoteMainFrameInterfaces::DataView input, ::blink::mojom::RemoteMainFrameInterfacesPtr* output);
};
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::RemoteFrameInterfacesFromRenderer::DataView, ::blink::mojom::RemoteFrameInterfacesFromRendererPtr> {
    ...
    static decltype(::blink::mojom::RemoteFrameInterfacesFromRenderer::frame)& frame(::blink::mojom::RemoteFrameInterfacesFromRendererPtr& input) { return input->frame; }

    static decltype(::blink::mojom::RemoteFrameInterfacesFromRenderer::frame_host_receiver)& frame_host_receiver(::blink::mojom::RemoteFrameInterfacesFromRendererPtr& input)
    {
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::RemoteFrameInterfacesFromBrowser::DataView, ::blink::mojom::RemoteFrameInterfacesFromBrowserPtr> {
    ...
    static decltype(::blink::mojom::RemoteFrameInterfacesFromBrowser::frame_receiver)& frame_receiver(::blink::mojom::RemoteFrameInterfacesFromBrowserPtr& input)
    {
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::OpenURLParams::DataView, ::blink::mojom::OpenURLParamsPtr> {
    ...
    static const decltype(::blink::mojom::OpenURLParams::url)& url(const ::blink::mojom::OpenURLParamsPtr& input) { return input->url; }

    static const decltype(::blink::mojom::OpenURLParams::initiator_origin)& initiator_origin(const ::blink::mojom::OpenURLParamsPtr& input) { return input->initiator_origin; }
    ...
    static decltype(::blink::mojom::OpenURLParams::post_body)& post_body(::blink::mojom::OpenURLParamsPtr& input) { return input->post_body; }

    static const decltype(::blink::mojom::OpenURLParams::extra_headers)& extra_headers(const ::blink::mojom::OpenURLParamsPtr& input) { return input->extra_headers; }

    static const decltype(::blink::mojom::OpenURLParams::referrer)& referrer(const ::blink::mojom::OpenURLParamsPtr& input) { return input->referrer; }

    static decltype(::blink::mojom::OpenURLParams::is_form_submission) is_form_submission(const ::blink::mojom::OpenURLParamsPtr& input) { return input->is_form_submission; }

    static decltype(::blink::mojom::OpenURLParams::disposition) disposition(const ::blink::mojom::OpenURLParamsPtr& input) { return input->disposition; }
    ...
    static decltype(::blink::mojom::OpenURLParams::user_gesture) user_gesture(const ::blink::mojom::OpenURLParamsPtr& input) { return input->user_gesture; }
    ...
    static decltype(::blink::mojom::OpenURLParams::blob_url_token)& blob_url_token(::blink::mojom::OpenURLParamsPtr& input) { return input->blob_url_token; }

    static const decltype(::blink::mojom::OpenURLParams::href_translate)& href_translate(const ::blink::mojom::OpenURLParamsPtr& input) { return input->href_translate; }

    static const decltype(::blink::mojom::OpenURLParams::impression)& impression(const ::blink::mojom::OpenURLParamsPtr& input) { return input->impression; }

    static const decltype(::blink::mojom::OpenURLParams::download_policy)& download_policy(const ::blink::mojom::OpenURLParamsPtr& input) { return input->download_policy; }

    static const decltype(::blink::mojom::OpenURLParams::source_location)& source_location(const ::blink::mojom::OpenURLParamsPtr& input) { return input->source_location; }
