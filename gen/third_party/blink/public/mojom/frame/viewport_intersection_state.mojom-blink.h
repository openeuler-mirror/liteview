...
struct blink_mojom_internal_FrameOcclusionState_DataHashFn {
    ...
    static bool Equal(const ::blink::mojom::FrameOcclusionState& left, const ::blink::mojom::FrameOcclusionState& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::blink::mojom::FrameOcclusionState> : public GenericHashTraits<::blink::mojom::FrameOcclusionState> {
    ...
    static void ConstructDeletedValue(::blink::mojom::FrameOcclusionState& slot, bool) { slot = static_cast<::blink::mojom::FrameOcclusionState>(-1000001); }
    static bool IsDeletedValue(const ::blink::mojom::FrameOcclusionState& value) { return value == static_cast<::blink::mojom::FrameOcclusionState>(-1000001); }
};
} // namespace WTF
namespace blink {
namespace mojom {
...
public:
    ...
    template <typename... Args> static ViewportIntersectionStatePtr New(Args&&... args) { return ViewportIntersectionStatePtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static ViewportIntersectionStatePtr From(const U& u) { return mojo::TypeConverter<ViewportIntersectionStatePtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, ViewportIntersectionState>::Convert(*this); }
    ...
    ViewportIntersectionState(const ::gfx::Rect& viewport_intersection_in, const ::gfx::Rect& main_frame_intersection_in, const ::gfx::Rect& compositor_visible_rect_in,
        FrameOcclusionState occlusion_state_in, const ::gfx::Size& outermost_main_frame_size_in, const ::gfx::Point& outermost_main_frame_scroll_position_in,
    ...
    template <typename T, ViewportIntersectionState::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::ViewportIntersectionState_UnserializedMessageContext<UserType, ViewportIntersectionState::DataView>>(0, 0, std::move(input)),
    ...
    {
        return ViewportIntersectionState::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }

    template <typename UserType> static bool DeserializeFromMessage(mojo::Message input, UserType* output)
    {
        auto context = input.TakeUnserializedContext<internal::ViewportIntersectionState_UnserializedMessageContext<UserType, ViewportIntersectionState::DataView>>();
        if (context) {
...
template <typename T, ViewportIntersectionState::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, ViewportIntersectionState::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, ViewportIntersectionState::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
template <> struct CORE_EXPORT StructTraits<::blink::mojom::blink::ViewportIntersectionState::DataView, ::blink::mojom::blink::ViewportIntersectionStatePtr> {
    ...
    static decltype(::blink::mojom::blink::ViewportIntersectionState::occlusion_state) occlusion_state(const ::blink::mojom::blink::ViewportIntersectionStatePtr& input)
    {
