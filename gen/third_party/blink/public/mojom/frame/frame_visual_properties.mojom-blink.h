...
public:
    ...
    template <typename... Args> static FrameVisualPropertiesPtr New(Args&&... args) { return FrameVisualPropertiesPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static FrameVisualPropertiesPtr From(const U& u) { return mojo::TypeConverter<FrameVisualPropertiesPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, FrameVisualProperties>::Convert(*this); }
    ...
    FrameVisualProperties(const ::display::ScreenInfos& screen_infos_in, bool auto_resize_enabled_in, bool is_pinch_gesture_active_in, uint32_t capture_sequence_number_in,
        double zoom_level_in, float page_scale_factor_in, float compositing_scale_factor_in, const ::gfx::Size& visible_viewport_size_in,
        const ::gfx::Size& min_size_for_auto_resize_in, const ::gfx::Size& max_size_for_auto_resize_in, WTF::Vector<::gfx::Rect> root_widget_window_segments_in,
        const ::gfx::Rect& compositor_viewport_in, const ::gfx::Rect& rect_in_local_root_in, const ::gfx::Size& local_frame_size_in,
    ...
    template <typename T, FrameVisualProperties::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    ...
    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<FrameVisualProperties::DataView>(input); }
    ...
    {
        return mojo::Message(std::make_unique<internal::FrameVisualProperties_UnserializedMessageContext<UserType, FrameVisualProperties::DataView>>(0, 0, std::move(input)),
    ...
    {
        return FrameVisualProperties::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, FrameVisualProperties::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, FrameVisualProperties::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, FrameVisualProperties::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }

template <typename StructPtrType> FrameVisualPropertiesPtr FrameVisualProperties::Clone() const
{
    return New(mojo::Clone(screen_infos), mojo::Clone(auto_resize_enabled), mojo::Clone(is_pinch_gesture_active), mojo::Clone(capture_sequence_number), mojo::Clone(zoom_level),
        mojo::Clone(page_scale_factor), mojo::Clone(compositing_scale_factor), mojo::Clone(visible_viewport_size), mojo::Clone(min_size_for_auto_resize),
        mojo::Clone(max_size_for_auto_resize), mojo::Clone(root_widget_window_segments), mojo::Clone(compositor_viewport), mojo::Clone(rect_in_local_root),
...
template <> struct CORE_EXPORT StructTraits<::blink::mojom::blink::FrameVisualProperties::DataView, ::blink::mojom::blink::FrameVisualPropertiesPtr> {
    ...
    static const decltype(::blink::mojom::blink::FrameVisualProperties::screen_infos)& screen_infos(const ::blink::mojom::blink::FrameVisualPropertiesPtr& input)
    {
        return input->screen_infos;
    }

    static decltype(::blink::mojom::blink::FrameVisualProperties::auto_resize_enabled) auto_resize_enabled(const ::blink::mojom::blink::FrameVisualPropertiesPtr& input)
    {
        return input->auto_resize_enabled;
    }

    static decltype(::blink::mojom::blink::FrameVisualProperties::is_pinch_gesture_active) is_pinch_gesture_active(const ::blink::mojom::blink::FrameVisualPropertiesPtr& input)
    {
        return input->is_pinch_gesture_active;
    }

    static decltype(::blink::mojom::blink::FrameVisualProperties::capture_sequence_number) capture_sequence_number(const ::blink::mojom::blink::FrameVisualPropertiesPtr& input)
    {
        return input->capture_sequence_number;
    }

    static decltype(::blink::mojom::blink::FrameVisualProperties::zoom_level) zoom_level(const ::blink::mojom::blink::FrameVisualPropertiesPtr& input) { return input->zoom_level; }

    static decltype(::blink::mojom::blink::FrameVisualProperties::page_scale_factor) page_scale_factor(const ::blink::mojom::blink::FrameVisualPropertiesPtr& input)
    {
        return input->page_scale_factor;
    }

    static decltype(::blink::mojom::blink::FrameVisualProperties::compositing_scale_factor) compositing_scale_factor(const ::blink::mojom::blink::FrameVisualPropertiesPtr& input)
    {
        return input->compositing_scale_factor;
    }

    static const decltype(::blink::mojom::blink::FrameVisualProperties::visible_viewport_size)& visible_viewport_size(const ::blink::mojom::blink::FrameVisualPropertiesPtr& input)
    {
    ...
    static const decltype(::blink::mojom::blink::FrameVisualProperties::compositor_viewport)& compositor_viewport(const ::blink::mojom::blink::FrameVisualPropertiesPtr& input)
    {
        return input->compositor_viewport;
    }

    static const decltype(::blink::mojom::blink::FrameVisualProperties::rect_in_local_root)& rect_in_local_root(const ::blink::mojom::blink::FrameVisualPropertiesPtr& input)
    {
        return input->rect_in_local_root;
    }

    static const decltype(::blink::mojom::blink::FrameVisualProperties::local_frame_size)& local_frame_size(const ::blink::mojom::blink::FrameVisualPropertiesPtr& input)
    {
        return input->local_frame_size;
    }

    static const decltype(::blink::mojom::blink::FrameVisualProperties::local_surface_id)& local_surface_id(const ::blink::mojom::blink::FrameVisualPropertiesPtr& input)
    {
