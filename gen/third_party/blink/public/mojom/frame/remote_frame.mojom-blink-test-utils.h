...
class CORE_EXPORT RemoteFrameHostInterceptorForTesting : public RemoteFrameHost {
    ...
    void UpdateViewportIntersection(
        ::blink::mojom::blink::ViewportIntersectionStatePtr intersection_state, const absl::optional<::blink::FrameVisualProperties>& visual_properties) override;
...
class CORE_EXPORT RemoteFrameInterceptorForTesting : public RemoteFrame {
    ...
    void DidSetFramePolicyHeaders(
        ::network::mojom::blink::WebSandboxFlags sandbox_flags, const WTF::Vector<::blink::ParsedPermissionsPolicyDeclaration>& parsed_permissions_policy) override;
    ...
    void CreateRemoteChild(const ::blink::RemoteFrameToken& token, const absl::optional<::blink::FrameToken>& opener_frame_token,
        ::blink::mojom::blink::TreeScopeType tree_scope_type, ::blink::mojom::blink::FrameReplicationStatePtr replication_state,
        const ::base::UnguessableToken& devtools_frame_token, RemoteFrameInterfacesFromBrowserPtr remote_frame_interfaces) override;
};
