...
static_assert(
    sizeof(BackForwardCacheControllerHost_EvictFromBackForwardCache_Params_Data) == 16, "Bad sizeof(BackForwardCacheControllerHost_EvictFromBackForwardCache_Params_Data)");
...
public:
    ...
    ::blink::mojom::RendererEvictionReason reason() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::blink::mojom::RendererEvictionReason>(data_->reason)); }
...
public:
    ...
    bool is_null() const { return !data_; }
    uint64_t features_mask() const { return data_->features_mask; }
