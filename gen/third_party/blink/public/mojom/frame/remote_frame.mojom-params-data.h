...
static_assert(sizeof(RemoteFrameHost_SetInheritedEffectiveTouchAction_Params_Data) == 16, "Bad sizeof(RemoteFrameHost_SetInheritedEffectiveTouchAction_Params_Data)");
...
static_assert(
    sizeof(RemoteFrameHost_CapturePaintPreviewOfCrossProcessSubframe_Params_Data) == 24, "Bad sizeof(RemoteFrameHost_CapturePaintPreviewOfCrossProcessSubframe_Params_Data)");
...
static_assert(sizeof(RemoteFrame_SetHadStickyUserActivationBeforeNavigation_Params_Data) == 16, "Bad sizeof(RemoteFrame_SetHadStickyUserActivationBeforeNavigation_Params_Data)");
...
static_assert(sizeof(RemoteFrame_RenderFallbackContentWithResourceTiming_Params_Data) == 24, "Bad sizeof(RemoteFrame_RenderFallbackContentWithResourceTiming_Params_Data)");
...
static_assert(sizeof(RemoteFrame_SetFrameSinkId_Params_Data) == 16, "Bad sizeof(RemoteFrame_SetFrameSinkId_Params_Data)");
...
static_assert(sizeof(RemoteFrame_CreateRemoteChild_Params_Data) == 64, "Bad sizeof(RemoteFrame_CreateRemoteChild_Params_Data)");
...
public:
    ...
    RemoteFrameHost_SetInheritedEffectiveTouchAction_ParamsDataView(internal::RemoteFrameHost_SetInheritedEffectiveTouchAction_Params_Data* data, mojo::Message* message)
        : data_(data)
    {
    }
...
public:
    ...
    RemoteFrameHost_UpdateRenderThrottlingStatus_ParamsDataView(internal::RemoteFrameHost_UpdateRenderThrottlingStatus_Params_Data* data, mojo::Message* message)
        : data_(data)
    {
    }

    bool is_null() const { return !data_; }
    bool is_throttled() const { return data_->is_throttled; }
    bool subtree_throttled() const { return data_->subtree_throttled; }
    bool display_locked() const { return data_->display_locked; }
...
public:
    ...
    bool is_null() const { return !data_; }
    bool inert() const { return data_->inert; }
...
public:
    ...
    int32_t document_cookie() const { return data_->document_cookie; }
...
public:
    ...
    ::blink::mojom::InsecureRequestPolicy policy() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::blink::mojom::InsecureRequestPolicy>(data_->policy)); }
...
public:
    ...
    bool is_potentially_trustworthy_unique_origin() const { return data_->is_potentially_trustworthy_unique_origin; }
...
public:
    ...
    bool is_null() const { return !data_; }
    bool is_ad_frame() const { return data_->is_ad_frame; }
...
public:
    ...
    RemoteFrame_RenderFallbackContentWithResourceTiming_ParamsDataView(internal::RemoteFrame_RenderFallbackContentWithResourceTiming_Params_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
...
public:
    ...
    RemoteFrame_IntrinsicSizingInfoOfChildChanged_ParamsDataView(internal::RemoteFrame_IntrinsicSizingInfoOfChildChanged_Params_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
...
public:
    ...
    ::blink::mojom::TreeScopeType tree_scope_type() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::blink::mojom::TreeScopeType>(data_->tree_scope_type)); }
...
inline void RemoteFrameHost_RouteMessageEvent_ParamsDataView::GetSourceOriginDataView(::mojo_base::mojom::String16DataView* output)
{
    auto pointer = data_->source_origin.Get();
...
inline void RemoteFrame_RenderFallbackContentWithResourceTiming_ParamsDataView::GetTimingDataView(::blink::mojom::ResourceTimingInfoDataView* output)
{
    auto pointer = data_->timing.Get();
    *output = ::blink::mojom::ResourceTimingInfoDataView(pointer, message_);
}
inline void RemoteFrame_RenderFallbackContentWithResourceTiming_ParamsDataView::GetServerTimingValueDataView(mojo::StringDataView* output)
{
    auto pointer = data_->server_timing_value.Get();
    *output = mojo::StringDataView(pointer, message_);
}
