...
FrameOwnerProperties::FrameOwnerProperties(const WTF::String& name_in, ::blink::mojom::blink::ScrollbarMode scrollbar_mode_in, int32_t margin_width_in, int32_t margin_height_in,
...
bool FrameOwnerProperties::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
