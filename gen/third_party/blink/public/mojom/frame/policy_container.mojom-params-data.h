...
static_assert(sizeof(PolicyContainerHost_AddContentSecurityPolicies_Params_Data) == 16, "Bad sizeof(PolicyContainerHost_AddContentSecurityPolicies_Params_Data)");
...
static_assert(sizeof(PolicyContainerHost_IssueKeepAliveHandle_Params_Data) == 16, "Bad sizeof(PolicyContainerHost_IssueKeepAliveHandle_Params_Data)");
...
public:
    ...
    PolicyContainerHost_AddContentSecurityPolicies_ParamsDataView(internal::PolicyContainerHost_AddContentSecurityPolicies_Params_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
...
public:
    ...
    PolicyContainerHost_IssueKeepAliveHandle_ParamsDataView(internal::PolicyContainerHost_IssueKeepAliveHandle_Params_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
    ...
    template <typename UserType> UserType TakeReceiver()
    {
        UserType result;
        bool ret
            = mojo::internal::Deserialize<mojo::InterfaceRequestDataView<::blink::mojom::PolicyContainerHostKeepAliveHandleInterfaceBase>>(&data_->receiver, &result, message_);
        DCHECK(ret);
        return result;
    }
