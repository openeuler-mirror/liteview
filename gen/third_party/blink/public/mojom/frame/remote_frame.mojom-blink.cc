...
#ifndef THIRD_PARTY_BLINK_PUBLIC_MOJOM_FRAME_REMOTE_FRAME_MOJOM_BLINK_JUMBO_H_
#define THIRD_PARTY_BLINK_PUBLIC_MOJOM_FRAME_REMOTE_FRAME_MOJOM_BLINK_JUMBO_H_
...
OpenURLParams::OpenURLParams(const ::blink::KURL& url_in, const ::scoped_refptr<const ::blink::SecurityOrigin>& initiator_origin_in,
    const absl::optional<::blink::LocalFrameToken>& initiator_frame_token_in, ::scoped_refptr<::network::ResourceRequestBody> post_body_in, const WTF::String& extra_headers_in,
    ::blink::mojom::blink::ReferrerPtr referrer_in, bool is_form_submission_in, ::ui::mojom::blink::WindowOpenDisposition disposition_in, bool should_replace_current_entry_in,
    bool user_gesture_in, bool is_unfenced_top_navigation_in, ::blink::mojom::blink::TriggeringEventInfo triggering_event_info_in,
    ::mojo::PendingRemote<::blink::mojom::blink::BlobURLToken> blob_url_token_in, const WTF::String& href_translate_in, const absl::optional<::blink::Impression>& impression_in,
    const ::blink::NavigationDownloadPolicy& download_policy_in, ::network::mojom::blink::SourceLocationPtr source_location_in,
    ::mojo::PendingRemote<::blink::mojom::blink::PolicyContainerHostKeepAliveHandle> initiator_policy_container_keep_alive_handle_in)
    : url(std::move(url_in))
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
        "<value of type ::mojo::PendingRemote<::blink::mojom::blink::PolicyContainerHostKeepAliveHandle>>"
#else
        "<value>"
#endif // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
void RemoteFrameHostProxy::RouteMessageEvent(const absl::optional<::blink::LocalFrameToken>& in_source_frame_token, const ::WTF::String& in_source_origin,
...
void RemoteFrameHostProxy::UpdateViewportIntersection(
    ::blink::mojom::blink::ViewportIntersectionStatePtr in_intersection_state, const absl::optional<::blink::FrameVisualProperties>& in_visual_properties)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    ...
    ::blink::mojom::blink::UserActivationUpdateType in_state_update_type, ::blink::mojom::blink::UserActivationNotificationType in_notification_type)
{
    ...
    TRACE_EVENT1("mojom", "Send blink::mojom::RemoteFrame::UpdateUserActivationState", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("state_update_type"), in_state_update_type, "<value of type ::blink::mojom::blink::UserActivationUpdateType>");
        perfetto::WriteIntoTracedValueWithFallback(
...
void RemoteFrameProxy::RenderFallbackContentWithResourceTiming(::blink::mojom::blink::ResourceTimingInfoPtr in_timing, const WTF::String& in_server_timing_value)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    ...
    ::network::mojom::blink::WebSandboxFlags in_sandbox_flags, const WTF::Vector<::blink::ParsedPermissionsPolicyDeclaration>& in_parsed_permissions_policy)
{
    ...
    TRACE_EVENT1("mojom", "Send blink::mojom::RemoteFrame::DidSetFramePolicyHeaders", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("parsed_permissions_policy"), in_parsed_permissions_policy, "<value of type const WTF::Vector<::blink::ParsedPermissionsPolicyDeclaration>&>");
    });
#endif
    const bool kExpectsResponse = false;
    const bool kIsSync = false;
...
void RemoteFrameProxy::CreateRemoteChild(const ::blink::RemoteFrameToken& in_token, const absl::optional<::blink::FrameToken>& in_opener_frame_token,
    ...
    const ::base::UnguessableToken& in_devtools_frame_token, RemoteFrameInterfacesFromBrowserPtr in_remote_frame_interfaces)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send blink::mojom::RemoteFrame::CreateRemoteChild", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("replication_state"), in_replication_state, "<value of type ::blink::mojom::blink::FrameReplicationStatePtr>");
...
bool RemoteFrameStubDispatch::Accept(RemoteFrame* impl, mojo::Message* message)
{
    ...
    case internal::kRemoteFrame_EnforceInsecureRequestPolicy_Name: {
        ...
        bool success = true;
        ::blink::mojom::blink::InsecureRequestPolicy p_policy = mojo::DefaultConstructTraits::CreateInstance<::blink::mojom::blink::InsecureRequestPolicy>();
    ...
    case internal::kRemoteFrame_SetReplicatedName_Name: {
        ...
        WTF::String p_unique_name = mojo::DefaultConstructTraits::CreateInstance<WTF::String>();
    ...
    case internal::kRemoteFrame_UpdateUserActivationState_Name: {
        ...
        bool success = true;
        ::blink::mojom::blink::UserActivationUpdateType p_state_update_type = mojo::DefaultConstructTraits::CreateInstance<::blink::mojom::blink::UserActivationUpdateType>();
    ...
    case internal::kRemoteFrame_DidSetFramePolicyHeaders_Name: {
        ...
        bool success = true;
        ::network::mojom::blink::WebSandboxFlags p_sandbox_flags = mojo::DefaultConstructTraits::CreateInstance<::network::mojom::blink::WebSandboxFlags>();
        WTF::Vector<::blink::ParsedPermissionsPolicyDeclaration> p_parsed_permissions_policy
            = mojo::DefaultConstructTraits::CreateInstance<WTF::Vector<::blink::ParsedPermissionsPolicyDeclaration>>();
    ...
    case internal::kRemoteFrame_CreateRemoteChild_Name: {
        ...
        absl::optional<::blink::FrameToken> p_opener_frame_token = mojo::DefaultConstructTraits::CreateInstance<absl::optional<::blink::FrameToken>>();
        ::blink::mojom::blink::TreeScopeType p_tree_scope_type = mojo::DefaultConstructTraits::CreateInstance<::blink::mojom::blink::TreeScopeType>();
        ::blink::mojom::blink::FrameReplicationStatePtr p_replication_state = mojo::DefaultConstructTraits::CreateInstance<::blink::mojom::blink::FrameReplicationStatePtr>();
...
void RemoteFrameHostInterceptorForTesting::RouteMessageEvent(const absl::optional<::blink::LocalFrameToken>& source_frame_token, const ::WTF::String& source_origin,
...
void RemoteFrameHostInterceptorForTesting::UpdateViewportIntersection(
    ::blink::mojom::blink::ViewportIntersectionStatePtr intersection_state, const absl::optional<::blink::FrameVisualProperties>& visual_properties)
{
...
void RemoteFrameInterceptorForTesting::EnforceInsecureNavigationsSet(const WTF::Vector<uint32_t>& set) { GetForwardingInterface()->EnforceInsecureNavigationsSet(std::move(set)); }
...
void RemoteFrameInterceptorForTesting::RenderFallbackContentWithResourceTiming(::blink::mojom::blink::ResourceTimingInfoPtr timing, const WTF::String& server_timing_value)
{
...
void RemoteFrameInterceptorForTesting::CreateRemoteChild(const ::blink::RemoteFrameToken& token, const absl::optional<::blink::FrameToken>& opener_frame_token,
    ::blink::mojom::blink::TreeScopeType tree_scope_type, ::blink::mojom::blink::FrameReplicationStatePtr replication_state, const ::base::UnguessableToken& devtools_frame_token,
