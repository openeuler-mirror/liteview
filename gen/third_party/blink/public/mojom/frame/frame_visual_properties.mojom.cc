...
#ifndef THIRD_PARTY_BLINK_PUBLIC_MOJOM_FRAME_FRAME_VISUAL_PROPERTIES_MOJOM_JUMBO_H_
#define THIRD_PARTY_BLINK_PUBLIC_MOJOM_FRAME_FRAME_VISUAL_PROPERTIES_MOJOM_JUMBO_H_
#endif
...
FrameVisualProperties::FrameVisualProperties(const ::display::ScreenInfos& screen_infos_in, bool auto_resize_enabled_in, bool is_pinch_gesture_active_in,
    uint32_t capture_sequence_number_in, double zoom_level_in, float page_scale_factor_in, float compositing_scale_factor_in, const ::gfx::Size& visible_viewport_size_in,
    ...
    const ::gfx::Rect& compositor_viewport_in, const ::gfx::Rect& rect_in_local_root_in, const ::gfx::Size& local_frame_size_in, const ::viz::LocalSurfaceId& local_surface_id_in)
...
bool FrameVisualProperties::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
