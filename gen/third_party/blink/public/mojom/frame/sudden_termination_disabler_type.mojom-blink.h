...
struct blink_mojom_internal_SuddenTerminationDisablerType_DataHashFn {
    ...
    static bool Equal(const ::blink::mojom::SuddenTerminationDisablerType& left, const ::blink::mojom::SuddenTerminationDisablerType& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::blink::mojom::SuddenTerminationDisablerType> : public GenericHashTraits<::blink::mojom::SuddenTerminationDisablerType> {
    ...
    static void ConstructDeletedValue(::blink::mojom::SuddenTerminationDisablerType& slot, bool) { slot = static_cast<::blink::mojom::SuddenTerminationDisablerType>(-1000001); }
    static bool IsDeletedValue(const ::blink::mojom::SuddenTerminationDisablerType& value) { return value == static_cast<::blink::mojom::SuddenTerminationDisablerType>(-1000001); }
};
} // namespace WTF
namespace blink {
namespace mojom {
