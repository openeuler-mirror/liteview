...
inline bool IsKnownEnumValue(PluginActionType value) { return internal::PluginActionType_Data::IsKnownValue(static_cast<int32_t>(value)); }
...
inline bool IsKnownEnumValue(JavaScriptExecutionResultType value) { return internal::JavaScriptExecutionResultType_Data::IsKnownValue(static_cast<int32_t>(value)); }
...
inline bool IsKnownEnumValue(TraverseCancelledReason value) { return internal::TraverseCancelledReason_Data::IsKnownValue(static_cast<int32_t>(value)); }
...
using HighPriorityLocalFramePtrDataView = mojo::InterfacePtrDataView<HighPriorityLocalFrameInterfaceBase>;
using HighPriorityLocalFrameRequestDataView = mojo::InterfaceRequestDataView<HighPriorityLocalFrameInterfaceBase>;
using HighPriorityLocalFrameAssociatedPtrInfoDataView = mojo::AssociatedInterfacePtrInfoDataView<HighPriorityLocalFrameInterfaceBase>;
using HighPriorityLocalFrameAssociatedRequestDataView = mojo::AssociatedInterfaceRequestDataView<HighPriorityLocalFrameInterfaceBase>;
...
public:
    ...
    int32_t match_index() const { return data_->match_index; }
    int32_t start_id() const { return data_->start_id; }
    int32_t start_offset() const { return data_->start_offset; }
    int32_t end_id() const { return data_->end_id; }
    int32_t end_offset() const { return data_->end_offset; }
...
public:
    ...
    bool is_context_menu_save() const { return data_->is_context_menu_save; }
...
public:
    ...
    bool anonymous() const { return data_->anonymous; }
...
template <typename MaybeConstUserType> struct Serializer<::blink::mojom::GetSavableResourceLinksReplyDataView, MaybeConstUserType> {
    ...
    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::blink::mojom::internal::GetSavableResourceLinksReply_Data>& fragment)
    {
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
            fragment->resources_list.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null resources_list in GetSavableResourceLinksReply struct");
...
template <typename MaybeConstUserType> struct Serializer<::blink::mojom::DownloadURLParamsDataView, MaybeConstUserType> {
    ...
    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::blink::mojom::internal::DownloadURLParams_Data>& fragment)
    {
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->url.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null url in DownloadURLParams struct");
        decltype(Traits::referrer(input)) in_referrer = Traits::referrer(input);
        mojo::internal::MessageFragment<typename decltype(fragment->referrer)::BaseType> referrer_fragment(fragment.message());
        mojo::internal::Serialize<::blink::mojom::ReferrerDataView>(in_referrer, referrer_fragment);
        fragment->referrer.Set(referrer_fragment.is_null() ? nullptr : referrer_fragment.data());
        ...
        mojo::internal::Serialize<mojo::InterfacePtrDataView<::blink::mojom::BlobInterfaceBase>>(in_data_url_blob, &fragment->data_url_blob, &fragment.message());
...
template <typename MaybeConstUserType> struct Serializer<::blink::mojom::IframeAttributesDataView, MaybeConstUserType> {
    ...
    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::blink::mojom::internal::IframeAttributes_Data>& fragment)
    {
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->id.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null id in IframeAttributes struct");
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->name.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null name in IframeAttributes struct");
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->src.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null src in IframeAttributes struct");
    }
