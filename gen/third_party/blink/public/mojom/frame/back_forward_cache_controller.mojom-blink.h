...
// with not having this data in traces there.
    ...
    virtual void DidChangeBackForwardCacheDisablingFeatures(uint64_t features_mask) = 0;
};

// class CORE_EXPORT BackForwardCacheControllerHostProxy
...
//
//   void DidChangeBackForwardCacheDisablingFeatures(uint64_t features_mask) final;
//
//  private:
