...
class BLINK_COMMON_EXPORT NativeIOFileHost : public NativeIOFileHostInterfaceBase {
public:
...
class BLINK_COMMON_EXPORT NativeIOHost : public NativeIOHostInterfaceBase {
public:
    using IPCStableHashFunction = uint32_t (*)();
...
// with not having this data in traces there.
    ...
    virtual bool OpenFile(const std::string& name, ::mojo::PendingReceiver<NativeIOFileHost> file_host_receiver, ::base::File* out_backing_file, uint64_t* out_backing_file_size,
...
//
//   bool OpenFile(const std::string& name, ::mojo::PendingReceiver<NativeIOFileHost> file_host_receiver, ::base::File* out_backing_file, uint64_t* out_backing_file_size,
...
public:
    ...
    NativeIOError(NativeIOErrorType type_in, const std::string& message_in)
    ...
    {
        return mojo::internal::SerializeImpl<NativeIOError::DataView, std::vector<uint8_t>>(input);
    }
...
namespace mojo {
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::NativeIOError::DataView, ::blink::mojom::NativeIOErrorPtr> {
    ...
    static decltype(::blink::mojom::NativeIOError::type) type(const ::blink::mojom::NativeIOErrorPtr& input) { return input->type; }

    static const decltype(::blink::mojom::NativeIOError::message)& message(const ::blink::mojom::NativeIOErrorPtr& input) { return input->message; }
