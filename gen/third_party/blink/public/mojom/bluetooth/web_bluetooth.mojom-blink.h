...
struct blink_mojom_internal_WebBluetoothResult_DataHashFn {
    ...
    static bool Equal(const ::blink::mojom::WebBluetoothResult& left, const ::blink::mojom::WebBluetoothResult& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::blink::mojom::WebBluetoothResult> : public GenericHashTraits<::blink::mojom::WebBluetoothResult> {
    static_assert(true, "-1000000 is a reserved enum value");
    static_assert(true, "-1000001 is a reserved enum value");
    static const bool kEmptyValueIsZero = false;
    static ::blink::mojom::WebBluetoothResult EmptyValue() { return static_cast<::blink::mojom::WebBluetoothResult>(-1000000); }
    static void ConstructDeletedValue(::blink::mojom::WebBluetoothResult& slot, bool) { slot = static_cast<::blink::mojom::WebBluetoothResult>(-1000001); }
    static bool IsDeletedValue(const ::blink::mojom::WebBluetoothResult& value) { return value == static_cast<::blink::mojom::WebBluetoothResult>(-1000001); }
};
} // namespace WTF
namespace WTF {
struct blink_mojom_internal_WebBluetoothGATTQueryQuantity_DataHashFn {
    ...
    static bool Equal(const ::blink::mojom::WebBluetoothGATTQueryQuantity& left, const ::blink::mojom::WebBluetoothGATTQueryQuantity& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::blink::mojom::WebBluetoothGATTQueryQuantity> : public GenericHashTraits<::blink::mojom::WebBluetoothGATTQueryQuantity> {
    static_assert(true, "-1000000 is a reserved enum value");
    static_assert(true, "-1000001 is a reserved enum value");
    static const bool kEmptyValueIsZero = false;
    static ::blink::mojom::WebBluetoothGATTQueryQuantity EmptyValue() { return static_cast<::blink::mojom::WebBluetoothGATTQueryQuantity>(-1000000); }
    static void ConstructDeletedValue(::blink::mojom::WebBluetoothGATTQueryQuantity& slot, bool) { slot = static_cast<::blink::mojom::WebBluetoothGATTQueryQuantity>(-1000001); }
    static bool IsDeletedValue(const ::blink::mojom::WebBluetoothGATTQueryQuantity& value) { return value == static_cast<::blink::mojom::WebBluetoothGATTQueryQuantity>(-1000001); }
};
} // namespace WTF
namespace WTF {
struct blink_mojom_internal_WebBluetoothWriteType_DataHashFn {
    ...
    static bool Equal(const ::blink::mojom::WebBluetoothWriteType& left, const ::blink::mojom::WebBluetoothWriteType& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::blink::mojom::WebBluetoothWriteType> : public GenericHashTraits<::blink::mojom::WebBluetoothWriteType> {
    static_assert(true, "-1000000 is a reserved enum value");
    static_assert(true, "-1000001 is a reserved enum value");
    static const bool kEmptyValueIsZero = false;
    static ::blink::mojom::WebBluetoothWriteType EmptyValue() { return static_cast<::blink::mojom::WebBluetoothWriteType>(-1000000); }
    static void ConstructDeletedValue(::blink::mojom::WebBluetoothWriteType& slot, bool) { slot = static_cast<::blink::mojom::WebBluetoothWriteType>(-1000001); }
    static bool IsDeletedValue(const ::blink::mojom::WebBluetoothWriteType& value) { return value == static_cast<::blink::mojom::WebBluetoothWriteType>(-1000001); }
};
} // namespace WTF
namespace blink {
namespace mojom {
...
// with not having this data in traces there.
    ...
    virtual void RemoteServerGetPrimaryServices(
        const ::blink::WebBluetoothDeviceId& device_id, WebBluetoothGATTQueryQuantity quantity, const ::WTF::String& services_uuid, RemoteServerGetPrimaryServicesCallback callback)
        = 0;
    ...
    virtual void RemoteServiceGetCharacteristics(
        const WTF::String& service_instance_id, WebBluetoothGATTQueryQuantity quantity, const ::WTF::String& characteristics_uuid, RemoteServiceGetCharacteristicsCallback callback)
        = 0;
    ...
    virtual void RemoteCharacteristicWriteValue(
        const WTF::String& characteristic_instance_id, const WTF::Vector<uint8_t>& value, WebBluetoothWriteType write_type, RemoteCharacteristicWriteValueCallback callback)
        = 0;
    using RemoteCharacteristicStartNotificationsCallback = base::OnceCallback<void(WebBluetoothResult)>;

    virtual void RemoteCharacteristicStartNotifications(const WTF::String& characteristic_instance_id, ::mojo::PendingAssociatedRemote<WebBluetoothCharacteristicClient> client,
    ...
    virtual void RemoteCharacteristicGetDescriptors(const WTF::String& characteristics_instance_id, WebBluetoothGATTQueryQuantity quantity, const ::WTF::String& descriptor_uuid,
    ...
    virtual void RequestScanningStart(
    ...
    virtual void WatchAdvertisementsForDevice(
...
//
//   void RemoteServerConnect(const ::blink::WebBluetoothDeviceId& device_id, ::mojo::PendingAssociatedRemote<WebBluetoothServerClient> client, RemoteServerConnectCallback
//   callback) final;
//
//   void RemoteServerDisconnect(const ::blink::WebBluetoothDeviceId& device_id) final;
//
//   void RemoteServerGetPrimaryServices(const ::blink::WebBluetoothDeviceId& device_id, WebBluetoothGATTQueryQuantity quantity, const ::WTF::String& services_uuid,
//   RemoteServerGetPrimaryServicesCallback callback) final;
//
//   void RemoteServiceGetCharacteristics(const WTF::String& service_instance_id, WebBluetoothGATTQueryQuantity quantity, const ::WTF::String& characteristics_uuid,
//   RemoteServiceGetCharacteristicsCallback callback) final;
//
...
//
//   void RemoteCharacteristicWriteValue(const WTF::String& characteristic_instance_id, const WTF::Vector<uint8_t>& value, WebBluetoothWriteType write_type,
//   RemoteCharacteristicWriteValueCallback callback) final;
//
//   void RemoteCharacteristicStartNotifications(const WTF::String& characteristic_instance_id, ::mojo::PendingAssociatedRemote<WebBluetoothCharacteristicClient> client,
//   RemoteCharacteristicStartNotificationsCallback callback) final;
//
...
//
//   void RemoteCharacteristicGetDescriptors(const WTF::String& characteristics_instance_id, WebBluetoothGATTQueryQuantity quantity, const ::WTF::String& descriptor_uuid,
//   RemoteCharacteristicGetDescriptorsCallback callback) final;
//
...
//
//   void RequestScanningStart(::mojo::PendingAssociatedRemote<WebBluetoothAdvertisementClient> client, WebBluetoothRequestLEScanOptionsPtr options, RequestScanningStartCallback
//   callback) final;
//
...
public:
    ...
    template <typename... Args> static WebBluetoothCompanyPtr New(Args&&... args) { return WebBluetoothCompanyPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static WebBluetoothCompanyPtr From(const U& u) { return mojo::TypeConverter<WebBluetoothCompanyPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, WebBluetoothCompany>::Convert(*this); }
    WebBluetoothCompany()
        : id()
    {
    }
    ...
    template <typename T, WebBluetoothCompany::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    ...
    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<WebBluetoothCompany::DataView>(input); }
    ...
    {
        return mojo::Message(std::make_unique<internal::WebBluetoothCompany_UnserializedMessageContext<UserType, WebBluetoothCompany::DataView>>(0, 0, std::move(input)),
    ...
    {
        return WebBluetoothCompany::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, WebBluetoothCompany::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, WebBluetoothCompany::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, WebBluetoothCompany::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static WebBluetoothDataFilterPtr New(Args&&... args) { return WebBluetoothDataFilterPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static WebBluetoothDataFilterPtr From(const U& u) { return mojo::TypeConverter<WebBluetoothDataFilterPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, WebBluetoothDataFilter>::Convert(*this); }
    ...
    template <typename T, WebBluetoothDataFilter::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    size_t Hash(size_t seed) const;
    template <typename UserType> static WTF::Vector<uint8_t> Serialize(UserType* input)
    {
    ...
    template <typename UserType> static mojo::Message WrapAsMessage(UserType input)
    {
        return mojo::Message(std::make_unique<internal::WebBluetoothDataFilter_UnserializedMessageContext<UserType, WebBluetoothDataFilter::DataView>>(0, 0, std::move(input)),
            MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const WTF::Vector<uint8_t>& input, UserType* output)
    {
        return WebBluetoothDataFilter::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, WebBluetoothDataFilter::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, WebBluetoothDataFilter::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, WebBluetoothDataFilter::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static WebBluetoothLeScanFilterPtr New(Args&&... args) { return WebBluetoothLeScanFilterPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static WebBluetoothLeScanFilterPtr From(const U& u) { return mojo::TypeConverter<WebBluetoothLeScanFilterPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, WebBluetoothLeScanFilter>::Convert(*this); }
    ...
    WebBluetoothLeScanFilter(absl::optional<WTF::Vector<::WTF::String>> services_in, const WTF::String& name_in, const WTF::String& name_prefix_in,
    ...
    template <typename T, WebBluetoothLeScanFilter::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static WTF::Vector<uint8_t> Serialize(UserType* input)
    {
    ...
    template <typename UserType> static mojo::Message WrapAsMessage(UserType input)
    {
        return mojo::Message(std::make_unique<internal::WebBluetoothLeScanFilter_UnserializedMessageContext<UserType, WebBluetoothLeScanFilter::DataView>>(0, 0, std::move(input)),
            MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const WTF::Vector<uint8_t>& input, UserType* output)
    {
        return WebBluetoothLeScanFilter::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }

    template <typename UserType> static bool DeserializeFromMessage(mojo::Message input, UserType* output)
    {
        auto context = input.TakeUnserializedContext<internal::WebBluetoothLeScanFilter_UnserializedMessageContext<UserType, WebBluetoothLeScanFilter::DataView>>();
        if (context) {
            *output = std::move(context->TakeData());
            return true;
        }
...
template <typename T, WebBluetoothLeScanFilter::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, WebBluetoothLeScanFilter::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, WebBluetoothLeScanFilter::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    {
        return WebBluetoothRequestDeviceOptionsPtr(absl::in_place, std::forward<Args>(args)...);
    }

    template <typename U> static WebBluetoothRequestDeviceOptionsPtr From(const U& u) { return mojo::TypeConverter<WebBluetoothRequestDeviceOptionsPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, WebBluetoothRequestDeviceOptions>::Convert(*this); }
    ...
    WebBluetoothRequestDeviceOptions(absl::optional<WTF::Vector<WebBluetoothLeScanFilterPtr>> filters_in, WTF::Vector<::WTF::String> optional_services_in,
    ...
    template <typename T, WebBluetoothRequestDeviceOptions::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static WTF::Vector<uint8_t> Serialize(UserType* input)
    {
    ...
    {
        return mojo::Message(
            std::make_unique<internal::WebBluetoothRequestDeviceOptions_UnserializedMessageContext<UserType, WebBluetoothRequestDeviceOptions::DataView>>(0, 0, std::move(input)),
            MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const WTF::Vector<uint8_t>& input, UserType* output)
    {
        return WebBluetoothRequestDeviceOptions::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }

    template <typename UserType> static bool DeserializeFromMessage(mojo::Message input, UserType* output)
    {
        auto context = input.TakeUnserializedContext<internal::WebBluetoothRequestDeviceOptions_UnserializedMessageContext<UserType, WebBluetoothRequestDeviceOptions::DataView>>();
        if (context) {
            *output = std::move(context->TakeData());
            return true;
        }
...
template <typename T, WebBluetoothRequestDeviceOptions::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, WebBluetoothRequestDeviceOptions::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, WebBluetoothRequestDeviceOptions::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    {
        return WebBluetoothRequestLEScanOptionsPtr(absl::in_place, std::forward<Args>(args)...);
    }

    template <typename U> static WebBluetoothRequestLEScanOptionsPtr From(const U& u) { return mojo::TypeConverter<WebBluetoothRequestLEScanOptionsPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, WebBluetoothRequestLEScanOptions>::Convert(*this); }
    ...
    WebBluetoothRequestLEScanOptions(absl::optional<WTF::Vector<WebBluetoothLeScanFilterPtr>> filters_in, bool keep_repeated_devices_in, bool accept_all_advertisements_in)
        : filters(std::move(filters_in))
    ...
    template <typename T, WebBluetoothRequestLEScanOptions::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static WTF::Vector<uint8_t> Serialize(UserType* input)
    {
    ...
    {
        return mojo::Message(
            std::make_unique<internal::WebBluetoothRequestLEScanOptions_UnserializedMessageContext<UserType, WebBluetoothRequestLEScanOptions::DataView>>(0, 0, std::move(input)),
            MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const WTF::Vector<uint8_t>& input, UserType* output)
    {
        return WebBluetoothRequestLEScanOptions::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }

    template <typename UserType> static bool DeserializeFromMessage(mojo::Message input, UserType* output)
    {
        auto context = input.TakeUnserializedContext<internal::WebBluetoothRequestLEScanOptions_UnserializedMessageContext<UserType, WebBluetoothRequestLEScanOptions::DataView>>();
        if (context) {
            *output = std::move(context->TakeData());
            return true;
        }
...
template <typename T, WebBluetoothRequestLEScanOptions::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, WebBluetoothRequestLEScanOptions::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, WebBluetoothRequestLEScanOptions::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static WebBluetoothDeviceIdPtr New(Args&&... args) { return WebBluetoothDeviceIdPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static WebBluetoothDeviceIdPtr From(const U& u) { return mojo::TypeConverter<WebBluetoothDeviceIdPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, WebBluetoothDeviceId>::Convert(*this); }
    ...
    template <typename T, WebBluetoothDeviceId::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static WTF::Vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<WebBluetoothDeviceId::DataView, WTF::Vector<uint8_t>>(input);
    }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<WebBluetoothDeviceId::DataView>(input); }
    ...
    template <typename UserType> static mojo::Message WrapAsMessage(UserType input)
    {
        return mojo::Message(std::make_unique<internal::WebBluetoothDeviceId_UnserializedMessageContext<UserType, WebBluetoothDeviceId::DataView>>(0, 0, std::move(input)),
            MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const WTF::Vector<uint8_t>& input, UserType* output)
    {
        return WebBluetoothDeviceId::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, WebBluetoothDeviceId::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, WebBluetoothDeviceId::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, WebBluetoothDeviceId::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static WebBluetoothDevicePtr New(Args&&... args) { return WebBluetoothDevicePtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static WebBluetoothDevicePtr From(const U& u) { return mojo::TypeConverter<WebBluetoothDevicePtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, WebBluetoothDevice>::Convert(*this); }
    WebBluetoothDevice()
        : id()
        , name()
    {
    ...
    template <typename T, WebBluetoothDevice::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static WTF::Vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<WebBluetoothDevice::DataView, WTF::Vector<uint8_t>>(input);
    }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<WebBluetoothDevice::DataView>(input); }
    ...
    template <typename UserType> static mojo::Message WrapAsMessage(UserType input)
    {
        return mojo::Message(std::make_unique<internal::WebBluetoothDevice_UnserializedMessageContext<UserType, WebBluetoothDevice::DataView>>(0, 0, std::move(input)),
            MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const WTF::Vector<uint8_t>& input, UserType* output)
    {
        return WebBluetoothDevice::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, WebBluetoothDevice::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, WebBluetoothDevice::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, WebBluetoothDevice::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    {
        return WebBluetoothRemoteGATTServicePtr(absl::in_place, std::forward<Args>(args)...);
    }

    template <typename U> static WebBluetoothRemoteGATTServicePtr From(const U& u) { return mojo::TypeConverter<WebBluetoothRemoteGATTServicePtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, WebBluetoothRemoteGATTService>::Convert(*this); }
    ...
    template <typename T, WebBluetoothRemoteGATTService::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static WTF::Vector<uint8_t> Serialize(UserType* input)
    {
    ...
    {
        return mojo::Message(
            std::make_unique<internal::WebBluetoothRemoteGATTService_UnserializedMessageContext<UserType, WebBluetoothRemoteGATTService::DataView>>(0, 0, std::move(input)),
            MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const WTF::Vector<uint8_t>& input, UserType* output)
    {
        return WebBluetoothRemoteGATTService::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }

    template <typename UserType> static bool DeserializeFromMessage(mojo::Message input, UserType* output)
    {
        auto context = input.TakeUnserializedContext<internal::WebBluetoothRemoteGATTService_UnserializedMessageContext<UserType, WebBluetoothRemoteGATTService::DataView>>();
        if (context) {
            *output = std::move(context->TakeData());
            return true;
        }
...
template <typename T, WebBluetoothRemoteGATTService::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, WebBluetoothRemoteGATTService::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, WebBluetoothRemoteGATTService::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    {
        return WebBluetoothRemoteGATTCharacteristicPtr(absl::in_place, std::forward<Args>(args)...);
    }

    template <typename U> static WebBluetoothRemoteGATTCharacteristicPtr From(const U& u) { return mojo::TypeConverter<WebBluetoothRemoteGATTCharacteristicPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, WebBluetoothRemoteGATTCharacteristic>::Convert(*this); }
    ...
    WebBluetoothRemoteGATTCharacteristic(const WTF::String& instance_id_in, const ::WTF::String& uuid_in, uint32_t properties_in)
        : instance_id(std::move(instance_id_in))
        , uuid(std::move(uuid_in))
    ...
    template <typename T, WebBluetoothRemoteGATTCharacteristic::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static WTF::Vector<uint8_t> Serialize(UserType* input)
    {
    ...
    template <typename UserType> static mojo::Message WrapAsMessage(UserType input)
    {
        return mojo::Message(std::make_unique<internal::WebBluetoothRemoteGATTCharacteristic_UnserializedMessageContext<UserType, WebBluetoothRemoteGATTCharacteristic::DataView>>(
                                 0, 0, std::move(input)),
            MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const WTF::Vector<uint8_t>& input, UserType* output)
    {
        return WebBluetoothRemoteGATTCharacteristic::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }

    template <typename UserType> static bool DeserializeFromMessage(mojo::Message input, UserType* output)
    {
        auto context
            = input.TakeUnserializedContext<internal::WebBluetoothRemoteGATTCharacteristic_UnserializedMessageContext<UserType, WebBluetoothRemoteGATTCharacteristic::DataView>>();
        if (context) {
            *output = std::move(context->TakeData());
            return true;
        }
        input.SerializeIfNecessary();
        return mojo::internal::DeserializeImpl<WebBluetoothRemoteGATTCharacteristic::DataView>(input, input.payload(), input.payload_num_bytes(), output, Validate);
    }
...
template <typename T, WebBluetoothRemoteGATTCharacteristic::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, WebBluetoothRemoteGATTCharacteristic::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, WebBluetoothRemoteGATTCharacteristic::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static WebBluetoothAdvertisingEventPtr New(Args&&... args) { return WebBluetoothAdvertisingEventPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static WebBluetoothAdvertisingEventPtr From(const U& u) { return mojo::TypeConverter<WebBluetoothAdvertisingEventPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, WebBluetoothAdvertisingEvent>::Convert(*this); }
    ...
    WebBluetoothAdvertisingEvent(WebBluetoothDevicePtr device_in, const WTF::String& name_in, WTF::Vector<::WTF::String> uuids_in, bool appearance_is_set_in,
        uint16_t appearance_in, bool tx_power_is_set_in, uint8_t tx_power_in, bool rssi_is_set_in, uint8_t rssi_in,
        const WTF::HashMap<uint16_t, WTF::Vector<uint8_t>>& manufacturer_data_in, const WTF::HashMap<::WTF::String, WTF::Vector<uint8_t>>& service_data_in)
    ...
    template <typename T, WebBluetoothAdvertisingEvent::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static WTF::Vector<uint8_t> Serialize(UserType* input)
    {
    ...
    {
        return mojo::Message(
            std::make_unique<internal::WebBluetoothAdvertisingEvent_UnserializedMessageContext<UserType, WebBluetoothAdvertisingEvent::DataView>>(0, 0, std::move(input)),
            MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const WTF::Vector<uint8_t>& input, UserType* output)
    {
        return WebBluetoothAdvertisingEvent::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }

    template <typename UserType> static bool DeserializeFromMessage(mojo::Message input, UserType* output)
    {
        auto context = input.TakeUnserializedContext<internal::WebBluetoothAdvertisingEvent_UnserializedMessageContext<UserType, WebBluetoothAdvertisingEvent::DataView>>();
        if (context) {
            *output = std::move(context->TakeData());
            return true;
        }
...
template <typename T, WebBluetoothAdvertisingEvent::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, WebBluetoothAdvertisingEvent::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, WebBluetoothAdvertisingEvent::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    {
        return WebBluetoothRemoteGATTDescriptorPtr(absl::in_place, std::forward<Args>(args)...);
    }

    template <typename U> static WebBluetoothRemoteGATTDescriptorPtr From(const U& u) { return mojo::TypeConverter<WebBluetoothRemoteGATTDescriptorPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, WebBluetoothRemoteGATTDescriptor>::Convert(*this); }
    ...
    template <typename T, WebBluetoothRemoteGATTDescriptor::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static WTF::Vector<uint8_t> Serialize(UserType* input)
    {
    ...
    {
        return mojo::Message(
            std::make_unique<internal::WebBluetoothRemoteGATTDescriptor_UnserializedMessageContext<UserType, WebBluetoothRemoteGATTDescriptor::DataView>>(0, 0, std::move(input)),
            MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const WTF::Vector<uint8_t>& input, UserType* output)
    {
        return WebBluetoothRemoteGATTDescriptor::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }

    template <typename UserType> static bool DeserializeFromMessage(mojo::Message input, UserType* output)
    {
        auto context = input.TakeUnserializedContext<internal::WebBluetoothRemoteGATTDescriptor_UnserializedMessageContext<UserType, WebBluetoothRemoteGATTDescriptor::DataView>>();
        if (context) {
            *output = std::move(context->TakeData());
            return true;
        }
...
template <typename T, WebBluetoothRemoteGATTDescriptor::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, WebBluetoothRemoteGATTDescriptor::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, WebBluetoothRemoteGATTDescriptor::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
template <typename StructPtrType> WebBluetoothCompanyPtr WebBluetoothCompany::Clone() const { return New(mojo::Clone(id)); }
...
template <typename StructPtrType> WebBluetoothDataFilterPtr WebBluetoothDataFilter::Clone() const { return New(mojo::Clone(data), mojo::Clone(mask)); }
...
{
    return New(mojo::Clone(filters), mojo::Clone(optional_services), mojo::Clone(optional_manufacturer_data), mojo::Clone(accept_all_devices));
}
...
template <typename StructPtrType> WebBluetoothDeviceIdPtr WebBluetoothDeviceId::Clone() const { return New(mojo::Clone(device_id)); }
...
template <typename StructPtrType> WebBluetoothDevicePtr WebBluetoothDevice::Clone() const { return New(mojo::Clone(id), mojo::Clone(name)); }
...
template <typename StructPtrType> WebBluetoothRemoteGATTServicePtr WebBluetoothRemoteGATTService::Clone() const { return New(mojo::Clone(instance_id), mojo::Clone(uuid)); }
...
{
    return New(mojo::Clone(device), mojo::Clone(name), mojo::Clone(uuids), mojo::Clone(appearance_is_set), mojo::Clone(appearance), mojo::Clone(tx_power_is_set),
        mojo::Clone(tx_power), mojo::Clone(rssi_is_set), mojo::Clone(rssi), mojo::Clone(manufacturer_data), mojo::Clone(service_data));
}
...
template <typename StructPtrType> WebBluetoothRemoteGATTDescriptorPtr WebBluetoothRemoteGATTDescriptor::Clone() const { return New(mojo::Clone(instance_id), mojo::Clone(uuid)); }
...
namespace mojo {
template <> struct BLINK_PLATFORM_EXPORT StructTraits<::blink::mojom::blink::WebBluetoothLeScanFilter::DataView, ::blink::mojom::blink::WebBluetoothLeScanFilterPtr> {
    ...
    static const decltype(::blink::mojom::blink::WebBluetoothLeScanFilter::name)& name(const ::blink::mojom::blink::WebBluetoothLeScanFilterPtr& input) { return input->name; }

    static const decltype(::blink::mojom::blink::WebBluetoothLeScanFilter::name_prefix)& name_prefix(const ::blink::mojom::blink::WebBluetoothLeScanFilterPtr& input)
    {
        return input->name_prefix;
    }

    static const decltype(::blink::mojom::blink::WebBluetoothLeScanFilter::manufacturer_data)& manufacturer_data(const ::blink::mojom::blink::WebBluetoothLeScanFilterPtr& input)
    {
...
template <> struct BLINK_PLATFORM_EXPORT StructTraits<::blink::mojom::blink::WebBluetoothCompany::DataView, ::blink::mojom::blink::WebBluetoothCompanyPtr> {
    static bool IsNull(const ::blink::mojom::blink::WebBluetoothCompanyPtr& input) { return !input; }
    static void SetToNull(::blink::mojom::blink::WebBluetoothCompanyPtr* output) { output->reset(); }

    static decltype(::blink::mojom::blink::WebBluetoothCompany::id) id(const ::blink::mojom::blink::WebBluetoothCompanyPtr& input) { return input->id; }

    static bool Read(::blink::mojom::blink::WebBluetoothCompany::DataView input, ::blink::mojom::blink::WebBluetoothCompanyPtr* output);
};
template <> struct BLINK_PLATFORM_EXPORT StructTraits<::blink::mojom::blink::WebBluetoothDataFilter::DataView, ::blink::mojom::blink::WebBluetoothDataFilterPtr> {
    static bool IsNull(const ::blink::mojom::blink::WebBluetoothDataFilterPtr& input) { return !input; }
    static void SetToNull(::blink::mojom::blink::WebBluetoothDataFilterPtr* output) { output->reset(); }

    static decltype(::blink::mojom::blink::WebBluetoothDataFilter::data) data(const ::blink::mojom::blink::WebBluetoothDataFilterPtr& input) { return input->data; }

    static decltype(::blink::mojom::blink::WebBluetoothDataFilter::mask) mask(const ::blink::mojom::blink::WebBluetoothDataFilterPtr& input) { return input->mask; }
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::blink::mojom::blink::WebBluetoothRequestDeviceOptions::DataView, ::blink::mojom::blink::WebBluetoothRequestDeviceOptionsPtr> {
    ...
    static const decltype(::blink::mojom::blink::WebBluetoothRequestDeviceOptions::filters)& filters(const ::blink::mojom::blink::WebBluetoothRequestDeviceOptionsPtr& input)
    {
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::blink::mojom::blink::WebBluetoothRequestLEScanOptions::DataView, ::blink::mojom::blink::WebBluetoothRequestLEScanOptionsPtr> {
    ...
    static const decltype(::blink::mojom::blink::WebBluetoothRequestLEScanOptions::filters)& filters(const ::blink::mojom::blink::WebBluetoothRequestLEScanOptionsPtr& input)
    {
        return input->filters;
    }
...
template <> struct BLINK_PLATFORM_EXPORT StructTraits<::blink::mojom::blink::WebBluetoothDevice::DataView, ::blink::mojom::blink::WebBluetoothDevicePtr> {
    ...
    static const decltype(::blink::mojom::blink::WebBluetoothDevice::id)& id(const ::blink::mojom::blink::WebBluetoothDevicePtr& input) { return input->id; }

    static const decltype(::blink::mojom::blink::WebBluetoothDevice::name)& name(const ::blink::mojom::blink::WebBluetoothDevicePtr& input) { return input->name; }

    static bool Read(::blink::mojom::blink::WebBluetoothDevice::DataView input, ::blink::mojom::blink::WebBluetoothDevicePtr* output);
};
template <> struct BLINK_PLATFORM_EXPORT StructTraits<::blink::mojom::blink::WebBluetoothRemoteGATTService::DataView, ::blink::mojom::blink::WebBluetoothRemoteGATTServicePtr> {
    ...
    static const decltype(::blink::mojom::blink::WebBluetoothRemoteGATTService::instance_id)& instance_id(const ::blink::mojom::blink::WebBluetoothRemoteGATTServicePtr& input)
    {
        return input->instance_id;
    }

    static const decltype(::blink::mojom::blink::WebBluetoothRemoteGATTService::uuid)& uuid(const ::blink::mojom::blink::WebBluetoothRemoteGATTServicePtr& input)
    {
        return input->uuid;
    }
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::blink::mojom::blink::WebBluetoothRemoteGATTCharacteristic::DataView, ::blink::mojom::blink::WebBluetoothRemoteGATTCharacteristicPtr> {
    ...
    static const decltype(::blink::mojom::blink::WebBluetoothRemoteGATTCharacteristic::uuid)& uuid(const ::blink::mojom::blink::WebBluetoothRemoteGATTCharacteristicPtr& input)
    {
        return input->uuid;
    }

    static decltype(::blink::mojom::blink::WebBluetoothRemoteGATTCharacteristic::properties) properties(const ::blink::mojom::blink::WebBluetoothRemoteGATTCharacteristicPtr& input)
    {
...
template <> struct BLINK_PLATFORM_EXPORT StructTraits<::blink::mojom::blink::WebBluetoothAdvertisingEvent::DataView, ::blink::mojom::blink::WebBluetoothAdvertisingEventPtr> {
    ...
    static const decltype(::blink::mojom::blink::WebBluetoothAdvertisingEvent::device)& device(const ::blink::mojom::blink::WebBluetoothAdvertisingEventPtr& input)
    {
        return input->device;
    }
    ...
    static const decltype(::blink::mojom::blink::WebBluetoothAdvertisingEvent::uuids)& uuids(const ::blink::mojom::blink::WebBluetoothAdvertisingEventPtr& input)
    {
        return input->uuids;
    }

    static decltype(::blink::mojom::blink::WebBluetoothAdvertisingEvent::appearance_is_set) appearance_is_set(const ::blink::mojom::blink::WebBluetoothAdvertisingEventPtr& input)
    {
        return input->appearance_is_set;
    }

    static decltype(::blink::mojom::blink::WebBluetoothAdvertisingEvent::appearance) appearance(const ::blink::mojom::blink::WebBluetoothAdvertisingEventPtr& input)
    {
        return input->appearance;
    }

    static decltype(::blink::mojom::blink::WebBluetoothAdvertisingEvent::tx_power_is_set) tx_power_is_set(const ::blink::mojom::blink::WebBluetoothAdvertisingEventPtr& input)
    {
    ...
    static decltype(::blink::mojom::blink::WebBluetoothAdvertisingEvent::rssi_is_set) rssi_is_set(const ::blink::mojom::blink::WebBluetoothAdvertisingEventPtr& input)
    {
        return input->rssi_is_set;
    }

    static decltype(::blink::mojom::blink::WebBluetoothAdvertisingEvent::rssi) rssi(const ::blink::mojom::blink::WebBluetoothAdvertisingEventPtr& input) { return input->rssi; }
    ...
    static const decltype(::blink::mojom::blink::WebBluetoothAdvertisingEvent::service_data)& service_data(const ::blink::mojom::blink::WebBluetoothAdvertisingEventPtr& input)
    {
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::blink::mojom::blink::WebBluetoothRemoteGATTDescriptor::DataView, ::blink::mojom::blink::WebBluetoothRemoteGATTDescriptorPtr> {
    ...
    static const decltype(::blink::mojom::blink::WebBluetoothRemoteGATTDescriptor::uuid)& uuid(const ::blink::mojom::blink::WebBluetoothRemoteGATTDescriptorPtr& input)
    {
        return input->uuid;
    }
