...
namespace WTF {
struct blink_mojom_internal_ContextMenuDataMediaType_DataHashFn {
    static unsigned GetHash(const ::blink::mojom::ContextMenuDataMediaType& value)
    {
        using utype = std::underlying_type<::blink::mojom::ContextMenuDataMediaType>::type;
        return DefaultHash<utype>::Hash().GetHash(static_cast<utype>(value));
    }
    static bool Equal(const ::blink::mojom::ContextMenuDataMediaType& left, const ::blink::mojom::ContextMenuDataMediaType& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::blink::mojom::ContextMenuDataMediaType> : public GenericHashTraits<::blink::mojom::ContextMenuDataMediaType> {
    static_assert(true, "-1000000 is a reserved enum value");
    static_assert(true, "-1000001 is a reserved enum value");
    static const bool kEmptyValueIsZero = false;
    static ::blink::mojom::ContextMenuDataMediaType EmptyValue() { return static_cast<::blink::mojom::ContextMenuDataMediaType>(-1000000); }
    static void ConstructDeletedValue(::blink::mojom::ContextMenuDataMediaType& slot, bool) { slot = static_cast<::blink::mojom::ContextMenuDataMediaType>(-1000001); }
    static bool IsDeletedValue(const ::blink::mojom::ContextMenuDataMediaType& value) { return value == static_cast<::blink::mojom::ContextMenuDataMediaType>(-1000001); }
};
} // namespace WTF
namespace WTF {
struct blink_mojom_internal_ContextMenuDataInputFieldType_DataHashFn {
    static unsigned GetHash(const ::blink::mojom::ContextMenuDataInputFieldType& value)
    {
        using utype = std::underlying_type<::blink::mojom::ContextMenuDataInputFieldType>::type;
        return DefaultHash<utype>::Hash().GetHash(static_cast<utype>(value));
    }
    static bool Equal(const ::blink::mojom::ContextMenuDataInputFieldType& left, const ::blink::mojom::ContextMenuDataInputFieldType& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::blink::mojom::ContextMenuDataInputFieldType> : public GenericHashTraits<::blink::mojom::ContextMenuDataInputFieldType> {
    static_assert(true, "-1000000 is a reserved enum value");
    static_assert(true, "-1000001 is a reserved enum value");
    static const bool kEmptyValueIsZero = false;
    static ::blink::mojom::ContextMenuDataInputFieldType EmptyValue() { return static_cast<::blink::mojom::ContextMenuDataInputFieldType>(-1000000); }
    static void ConstructDeletedValue(::blink::mojom::ContextMenuDataInputFieldType& slot, bool) { slot = static_cast<::blink::mojom::ContextMenuDataInputFieldType>(-1000001); }
    static bool IsDeletedValue(const ::blink::mojom::ContextMenuDataInputFieldType& value) { return value == static_cast<::blink::mojom::ContextMenuDataInputFieldType>(-1000001); }
};
} // namespace WTF
namespace WTF {
struct blink_mojom_internal_CustomContextMenuItemType_DataHashFn {
    static unsigned GetHash(const ::blink::mojom::CustomContextMenuItemType& value)
    {
        using utype = std::underlying_type<::blink::mojom::CustomContextMenuItemType>::type;
        return DefaultHash<utype>::Hash().GetHash(static_cast<utype>(value));
    }
    static bool Equal(const ::blink::mojom::CustomContextMenuItemType& left, const ::blink::mojom::CustomContextMenuItemType& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::blink::mojom::CustomContextMenuItemType> : public GenericHashTraits<::blink::mojom::CustomContextMenuItemType> {
    static_assert(true, "-1000000 is a reserved enum value");
    static_assert(true, "-1000001 is a reserved enum value");
    static const bool kEmptyValueIsZero = false;
    static ::blink::mojom::CustomContextMenuItemType EmptyValue() { return static_cast<::blink::mojom::CustomContextMenuItemType>(-1000000); }
    static void ConstructDeletedValue(::blink::mojom::CustomContextMenuItemType& slot, bool) { slot = static_cast<::blink::mojom::CustomContextMenuItemType>(-1000001); }
    static bool IsDeletedValue(const ::blink::mojom::CustomContextMenuItemType& value) { return value == static_cast<::blink::mojom::CustomContextMenuItemType>(-1000001); }
};
} // namespace WTF
namespace blink {
namespace mojom {
...
public:
    ...
    template <typename... Args> static FormRendererIdPtr New(Args&&... args) { return FormRendererIdPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static FormRendererIdPtr From(const U& u) { return mojo::TypeConverter<FormRendererIdPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, FormRendererId>::Convert(*this); }
    FormRendererId()
        : id()
    {
    }
    ...
    template <typename T, FormRendererId::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    ...
    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<FormRendererId::DataView>(input); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::FormRendererId_UnserializedMessageContext<UserType, FormRendererId::DataView>>(0, 0, std::move(input)), MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    {
        return FormRendererId::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, FormRendererId::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, FormRendererId::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, FormRendererId::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static FieldRendererIdPtr New(Args&&... args) { return FieldRendererIdPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static FieldRendererIdPtr From(const U& u) { return mojo::TypeConverter<FieldRendererIdPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, FieldRendererId>::Convert(*this); }
    FieldRendererId()
        : id()
    {
    }
    ...
    template <typename T, FieldRendererId::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    size_t Hash(size_t seed) const;
    template <typename UserType> static WTF::Vector<uint8_t> Serialize(UserType* input)
    {
    ...
    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<FieldRendererId::DataView>(input); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::FieldRendererId_UnserializedMessageContext<UserType, FieldRendererId::DataView>>(0, 0, std::move(input)), MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const WTF::Vector<uint8_t>& input, UserType* output)
    {
        return FieldRendererId::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, FieldRendererId::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, FieldRendererId::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, FieldRendererId::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static CustomContextMenuItemPtr New(Args&&... args) { return CustomContextMenuItemPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static CustomContextMenuItemPtr From(const U& u) { return mojo::TypeConverter<CustomContextMenuItemPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, CustomContextMenuItem>::Convert(*this); }
    ...
    CustomContextMenuItem(const ::WTF::String& label_in, const ::WTF::String& icon_in, const ::WTF::String& tool_tip_in, CustomContextMenuItemType type_in, int32_t action_in,
        bool rtl_in, bool has_directional_override_in, bool enabled_in, bool checked_in, WTF::Vector<CustomContextMenuItemPtr> submenu_in)
    ...
    template <typename T, CustomContextMenuItem::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static WTF::Vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<CustomContextMenuItem::DataView, WTF::Vector<uint8_t>>(input);
    }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<CustomContextMenuItem::DataView>(input); }
    ...
    template <typename UserType> static mojo::Message WrapAsMessage(UserType input)
    {
        return mojo::Message(std::make_unique<internal::CustomContextMenuItem_UnserializedMessageContext<UserType, CustomContextMenuItem::DataView>>(0, 0, std::move(input)),
    ...
    template <typename UserType> static bool Deserialize(const WTF::Vector<uint8_t>& input, UserType* output)
    {
        return CustomContextMenuItem::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, CustomContextMenuItem::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, CustomContextMenuItem::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, CustomContextMenuItem::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    {
        return UntrustworthyContextMenuParamsPtr(absl::in_place, std::forward<Args>(args)...);
    }

    template <typename U> static UntrustworthyContextMenuParamsPtr From(const U& u) { return mojo::TypeConverter<UntrustworthyContextMenuParamsPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, UntrustworthyContextMenuParams>::Convert(*this); }
    ...
    UntrustworthyContextMenuParams(ContextMenuDataMediaType media_type_in, int32_t x_in, int32_t y_in, const ::blink::KURL& link_url_in, const ::WTF::String& link_text_in,
        const absl::optional<::blink::Impression>& impression_in, const ::blink::KURL& unfiltered_link_url_in, const ::blink::KURL& src_url_in, bool has_image_contents_in,
        int32_t media_flags_in, const ::WTF::String& selection_text_in, const ::WTF::String& title_text_in, const ::WTF::String& alt_text_in,
        const ::WTF::String& suggested_filename_in, const ::WTF::String& misspelled_word_in, WTF::Vector<::WTF::String> dictionary_suggestions_in, bool spellcheck_enabled_in,
        ...
        const WTF::String& frame_charset_in, ::network::mojom::blink::ReferrerPolicy referrer_policy_in, const ::blink::KURL& link_followed_in,
        WTF::Vector<CustomContextMenuItemPtr> custom_items_in, ::ui::mojom::blink::MenuSourceType source_type_in, ContextMenuDataInputFieldType input_field_type_in,
        const ::gfx::Rect& selection_rect_in, int32_t selection_start_offset_in, bool opened_from_highlight_in, FormRendererIdPtr form_renderer_id_in,
    ...
    template <typename T, UntrustworthyContextMenuParams::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static WTF::Vector<uint8_t> Serialize(UserType* input)
    {
    ...
    {
        return mojo::Message(
            std::make_unique<internal::UntrustworthyContextMenuParams_UnserializedMessageContext<UserType, UntrustworthyContextMenuParams::DataView>>(0, 0, std::move(input)),
            MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const WTF::Vector<uint8_t>& input, UserType* output)
    {
        return UntrustworthyContextMenuParams::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }

    template <typename UserType> static bool DeserializeFromMessage(mojo::Message input, UserType* output)
    {
        auto context = input.TakeUnserializedContext<internal::UntrustworthyContextMenuParams_UnserializedMessageContext<UserType, UntrustworthyContextMenuParams::DataView>>();
        if (context) {
            *output = std::move(context->TakeData());
            return true;
        }
...
template <typename T, UntrustworthyContextMenuParams::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, UntrustworthyContextMenuParams::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, UntrustworthyContextMenuParams::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }

template <typename StructPtrType> FormRendererIdPtr FormRendererId::Clone() const { return New(mojo::Clone(id)); }
...
template <typename StructPtrType> FieldRendererIdPtr FieldRendererId::Clone() const { return New(mojo::Clone(id)); }
...
{
    return New(mojo::Clone(label), mojo::Clone(icon), mojo::Clone(tool_tip), mojo::Clone(type), mojo::Clone(action), mojo::Clone(rtl), mojo::Clone(has_directional_override),
        mojo::Clone(enabled), mojo::Clone(checked), mojo::Clone(submenu));
}
...
{
    return New(mojo::Clone(media_type), mojo::Clone(x), mojo::Clone(y), mojo::Clone(link_url), mojo::Clone(link_text), mojo::Clone(impression), mojo::Clone(unfiltered_link_url),
        mojo::Clone(src_url), mojo::Clone(has_image_contents), mojo::Clone(media_flags), mojo::Clone(selection_text), mojo::Clone(title_text), mojo::Clone(alt_text),
        mojo::Clone(suggested_filename), mojo::Clone(misspelled_word), mojo::Clone(dictionary_suggestions), mojo::Clone(spellcheck_enabled), mojo::Clone(is_editable),
        mojo::Clone(writing_direction_default), mojo::Clone(writing_direction_left_to_right), mojo::Clone(writing_direction_right_to_left), mojo::Clone(edit_flags),
        mojo::Clone(frame_charset), mojo::Clone(referrer_policy), mojo::Clone(link_followed), mojo::Clone(custom_items), mojo::Clone(source_type), mojo::Clone(input_field_type),
        mojo::Clone(selection_rect), mojo::Clone(selection_start_offset), mojo::Clone(opened_from_highlight), mojo::Clone(form_renderer_id), mojo::Clone(field_renderer_id));
}
...
template <> struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::FormRendererId::DataView, ::blink::mojom::blink::FormRendererIdPtr> {
    ...
    static decltype(::blink::mojom::blink::FormRendererId::id) id(const ::blink::mojom::blink::FormRendererIdPtr& input) { return input->id; }
...
template <> struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::FieldRendererId::DataView, ::blink::mojom::blink::FieldRendererIdPtr> {
    ...
    static decltype(::blink::mojom::blink::FieldRendererId::id) id(const ::blink::mojom::blink::FieldRendererIdPtr& input) { return input->id; }
...
template <> struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::CustomContextMenuItem::DataView, ::blink::mojom::blink::CustomContextMenuItemPtr> {
    ...
    static const decltype(::blink::mojom::blink::CustomContextMenuItem::label)& label(const ::blink::mojom::blink::CustomContextMenuItemPtr& input) { return input->label; }

    static const decltype(::blink::mojom::blink::CustomContextMenuItem::icon)& icon(const ::blink::mojom::blink::CustomContextMenuItemPtr& input) { return input->icon; }
    ...
    static decltype(::blink::mojom::blink::CustomContextMenuItem::type) type(const ::blink::mojom::blink::CustomContextMenuItemPtr& input) { return input->type; }

    static decltype(::blink::mojom::blink::CustomContextMenuItem::action) action(const ::blink::mojom::blink::CustomContextMenuItemPtr& input) { return input->action; }

    static decltype(::blink::mojom::blink::CustomContextMenuItem::rtl) rtl(const ::blink::mojom::blink::CustomContextMenuItemPtr& input) { return input->rtl; }

    static decltype(::blink::mojom::blink::CustomContextMenuItem::has_directional_override) has_directional_override(const ::blink::mojom::blink::CustomContextMenuItemPtr& input)
    {
        return input->has_directional_override;
    }

    static decltype(::blink::mojom::blink::CustomContextMenuItem::enabled) enabled(const ::blink::mojom::blink::CustomContextMenuItemPtr& input) { return input->enabled; }

    static decltype(::blink::mojom::blink::CustomContextMenuItem::checked) checked(const ::blink::mojom::blink::CustomContextMenuItemPtr& input) { return input->checked; }

    static const decltype(::blink::mojom::blink::CustomContextMenuItem::submenu)& submenu(const ::blink::mojom::blink::CustomContextMenuItemPtr& input) { return input->submenu; }
...
template <> struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::UntrustworthyContextMenuParams::DataView, ::blink::mojom::blink::UntrustworthyContextMenuParamsPtr> {
    ...
    static decltype(::blink::mojom::blink::UntrustworthyContextMenuParams::media_type) media_type(const ::blink::mojom::blink::UntrustworthyContextMenuParamsPtr& input)
    {
        return input->media_type;
    }

    static decltype(::blink::mojom::blink::UntrustworthyContextMenuParams::x) x(const ::blink::mojom::blink::UntrustworthyContextMenuParamsPtr& input) { return input->x; }

    static decltype(::blink::mojom::blink::UntrustworthyContextMenuParams::y) y(const ::blink::mojom::blink::UntrustworthyContextMenuParamsPtr& input) { return input->y; }

    static const decltype(::blink::mojom::blink::UntrustworthyContextMenuParams::link_url)& link_url(const ::blink::mojom::blink::UntrustworthyContextMenuParamsPtr& input)
    {
        return input->link_url;
    }

    static const decltype(::blink::mojom::blink::UntrustworthyContextMenuParams::link_text)& link_text(const ::blink::mojom::blink::UntrustworthyContextMenuParamsPtr& input)
    {
        return input->link_text;
    }

    static const decltype(::blink::mojom::blink::UntrustworthyContextMenuParams::impression)& impression(const ::blink::mojom::blink::UntrustworthyContextMenuParamsPtr& input)
    {
    ...
    static const decltype(::blink::mojom::blink::UntrustworthyContextMenuParams::src_url)& src_url(const ::blink::mojom::blink::UntrustworthyContextMenuParamsPtr& input)
    {
    ...
    static decltype(::blink::mojom::blink::UntrustworthyContextMenuParams::media_flags) media_flags(const ::blink::mojom::blink::UntrustworthyContextMenuParamsPtr& input)
    {
    ...
    static const decltype(::blink::mojom::blink::UntrustworthyContextMenuParams::title_text)& title_text(const ::blink::mojom::blink::UntrustworthyContextMenuParamsPtr& input)
    {
        return input->title_text;
    }

    static const decltype(::blink::mojom::blink::UntrustworthyContextMenuParams::alt_text)& alt_text(const ::blink::mojom::blink::UntrustworthyContextMenuParamsPtr& input)
    {
    ...
    static decltype(::blink::mojom::blink::UntrustworthyContextMenuParams::is_editable) is_editable(const ::blink::mojom::blink::UntrustworthyContextMenuParamsPtr& input)
    {
    ...
    static decltype(::blink::mojom::blink::UntrustworthyContextMenuParams::edit_flags) edit_flags(const ::blink::mojom::blink::UntrustworthyContextMenuParamsPtr& input)
    {
    ...
    static decltype(::blink::mojom::blink::UntrustworthyContextMenuParams::referrer_policy) referrer_policy(const ::blink::mojom::blink::UntrustworthyContextMenuParamsPtr& input)
    {
    ...
    static const decltype(::blink::mojom::blink::UntrustworthyContextMenuParams::custom_items)& custom_items(const ::blink::mojom::blink::UntrustworthyContextMenuParamsPtr& input)
    {
        return input->custom_items;
    }

    static decltype(::blink::mojom::blink::UntrustworthyContextMenuParams::source_type) source_type(const ::blink::mojom::blink::UntrustworthyContextMenuParamsPtr& input)
    {
        return input->source_type;
    }

    static decltype(::blink::mojom::blink::UntrustworthyContextMenuParams::input_field_type) input_field_type(const ::blink::mojom::blink::UntrustworthyContextMenuParamsPtr& input)
    {
