...
public:
    ...
    CustomContextMenuItem(const ::std::u16string& label_in, const ::std::u16string& icon_in, const ::std::u16string& tool_tip_in, CustomContextMenuItemType type_in,
        int32_t action_in, bool rtl_in, bool has_directional_override_in, bool enabled_in, bool checked_in, std::vector<CustomContextMenuItemPtr> submenu_in)
...
public:
    ...
    UntrustworthyContextMenuParams(ContextMenuDataMediaType media_type_in, int32_t x_in, int32_t y_in, const ::GURL& link_url_in, const ::std::u16string& link_text_in,
        const absl::optional<::blink::Impression>& impression_in, const ::GURL& unfiltered_link_url_in, const ::GURL& src_url_in, bool has_image_contents_in,
        int32_t media_flags_in, const ::std::u16string& selection_text_in, const ::std::u16string& title_text_in, const ::std::u16string& alt_text_in,
        ...
        const ::GURL& link_followed_in, std::vector<CustomContextMenuItemPtr> custom_items_in, ::ui::MenuSourceType source_type_in,
        ContextMenuDataInputFieldType input_field_type_in, const ::gfx::Rect& selection_rect_in, int32_t selection_start_offset_in, bool opened_from_highlight_in,
        FormRendererIdPtr form_renderer_id_in, FieldRendererIdPtr field_renderer_id_in)
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::FormRendererId::DataView, ::blink::mojom::FormRendererIdPtr> {
    ...
    static decltype(::blink::mojom::FormRendererId::id) id(const ::blink::mojom::FormRendererIdPtr& input) { return input->id; }
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::FieldRendererId::DataView, ::blink::mojom::FieldRendererIdPtr> {
    ...
    static decltype(::blink::mojom::FieldRendererId::id) id(const ::blink::mojom::FieldRendererIdPtr& input) { return input->id; }
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::CustomContextMenuItem::DataView, ::blink::mojom::CustomContextMenuItemPtr> {
    ...
    static const decltype(::blink::mojom::CustomContextMenuItem::label)& label(const ::blink::mojom::CustomContextMenuItemPtr& input) { return input->label; }

    static const decltype(::blink::mojom::CustomContextMenuItem::icon)& icon(const ::blink::mojom::CustomContextMenuItemPtr& input) { return input->icon; }

    static const decltype(::blink::mojom::CustomContextMenuItem::tool_tip)& tool_tip(const ::blink::mojom::CustomContextMenuItemPtr& input) { return input->tool_tip; }

    static decltype(::blink::mojom::CustomContextMenuItem::type) type(const ::blink::mojom::CustomContextMenuItemPtr& input) { return input->type; }

    static decltype(::blink::mojom::CustomContextMenuItem::action) action(const ::blink::mojom::CustomContextMenuItemPtr& input) { return input->action; }

    static decltype(::blink::mojom::CustomContextMenuItem::rtl) rtl(const ::blink::mojom::CustomContextMenuItemPtr& input) { return input->rtl; }

    static decltype(::blink::mojom::CustomContextMenuItem::has_directional_override) has_directional_override(const ::blink::mojom::CustomContextMenuItemPtr& input)
    {
        return input->has_directional_override;
    }

    static decltype(::blink::mojom::CustomContextMenuItem::enabled) enabled(const ::blink::mojom::CustomContextMenuItemPtr& input) { return input->enabled; }

    static decltype(::blink::mojom::CustomContextMenuItem::checked) checked(const ::blink::mojom::CustomContextMenuItemPtr& input) { return input->checked; }

    static const decltype(::blink::mojom::CustomContextMenuItem::submenu)& submenu(const ::blink::mojom::CustomContextMenuItemPtr& input) { return input->submenu; }

    static bool Read(::blink::mojom::CustomContextMenuItem::DataView input, ::blink::mojom::CustomContextMenuItemPtr* output);
};
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::UntrustworthyContextMenuParams::DataView, ::blink::mojom::UntrustworthyContextMenuParamsPtr> {
    ...
    static decltype(::blink::mojom::UntrustworthyContextMenuParams::x) x(const ::blink::mojom::UntrustworthyContextMenuParamsPtr& input) { return input->x; }

    static decltype(::blink::mojom::UntrustworthyContextMenuParams::y) y(const ::blink::mojom::UntrustworthyContextMenuParamsPtr& input) { return input->y; }
    ...
    static const decltype(::blink::mojom::UntrustworthyContextMenuParams::impression)& impression(const ::blink::mojom::UntrustworthyContextMenuParamsPtr& input)
    {
        return input->impression;
    }

    static const decltype(::blink::mojom::UntrustworthyContextMenuParams::unfiltered_link_url)& unfiltered_link_url(const ::blink::mojom::UntrustworthyContextMenuParamsPtr& input)
    {
    ...
    static decltype(::blink::mojom::UntrustworthyContextMenuParams::has_image_contents) has_image_contents(const ::blink::mojom::UntrustworthyContextMenuParamsPtr& input)
    {
    ...
    static const decltype(::blink::mojom::UntrustworthyContextMenuParams::selection_text)& selection_text(const ::blink::mojom::UntrustworthyContextMenuParamsPtr& input)
    {
        return input->selection_text;
    }

    static const decltype(::blink::mojom::UntrustworthyContextMenuParams::title_text)& title_text(const ::blink::mojom::UntrustworthyContextMenuParamsPtr& input)
    {
    ...
    static const decltype(::blink::mojom::UntrustworthyContextMenuParams::suggested_filename)& suggested_filename(const ::blink::mojom::UntrustworthyContextMenuParamsPtr& input)
    {
        return input->suggested_filename;
    }

    static const decltype(::blink::mojom::UntrustworthyContextMenuParams::misspelled_word)& misspelled_word(const ::blink::mojom::UntrustworthyContextMenuParamsPtr& input)
    {
    ...
    static decltype(::blink::mojom::UntrustworthyContextMenuParams::spellcheck_enabled) spellcheck_enabled(const ::blink::mojom::UntrustworthyContextMenuParamsPtr& input)
    {
    ...
    static const decltype(::blink::mojom::UntrustworthyContextMenuParams::frame_charset)& frame_charset(const ::blink::mojom::UntrustworthyContextMenuParamsPtr& input)
    {
        return input->frame_charset;
    }

    static decltype(::blink::mojom::UntrustworthyContextMenuParams::referrer_policy) referrer_policy(const ::blink::mojom::UntrustworthyContextMenuParamsPtr& input)
    {
        return input->referrer_policy;
    }

    static const decltype(::blink::mojom::UntrustworthyContextMenuParams::link_followed)& link_followed(const ::blink::mojom::UntrustworthyContextMenuParamsPtr& input)
    {
        return input->link_followed;
    }

    static const decltype(::blink::mojom::UntrustworthyContextMenuParams::custom_items)& custom_items(const ::blink::mojom::UntrustworthyContextMenuParamsPtr& input)
    {
    ...
    static decltype(::blink::mojom::UntrustworthyContextMenuParams::input_field_type) input_field_type(const ::blink::mojom::UntrustworthyContextMenuParamsPtr& input)
    {
        return input->input_field_type;
    }

    static const decltype(::blink::mojom::UntrustworthyContextMenuParams::selection_rect)& selection_rect(const ::blink::mojom::UntrustworthyContextMenuParamsPtr& input)
    {
        return input->selection_rect;
    }

    static decltype(::blink::mojom::UntrustworthyContextMenuParams::selection_start_offset) selection_start_offset(const ::blink::mojom::UntrustworthyContextMenuParamsPtr& input)
    {
        return input->selection_start_offset;
    }

    static decltype(::blink::mojom::UntrustworthyContextMenuParams::opened_from_highlight) opened_from_highlight(const ::blink::mojom::UntrustworthyContextMenuParamsPtr& input)
    {
        return input->opened_from_highlight;
    }

    static const decltype(::blink::mojom::UntrustworthyContextMenuParams::form_renderer_id)& form_renderer_id(const ::blink::mojom::UntrustworthyContextMenuParamsPtr& input)
    {
        return input->form_renderer_id;
    }

    static const decltype(::blink::mojom::UntrustworthyContextMenuParams::field_renderer_id)& field_renderer_id(const ::blink::mojom::UntrustworthyContextMenuParamsPtr& input)
    {
