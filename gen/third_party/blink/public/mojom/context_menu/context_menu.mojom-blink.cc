...
CustomContextMenuItem::CustomContextMenuItem(const ::WTF::String& label_in, const ::WTF::String& icon_in, const ::WTF::String& tool_tip_in, CustomContextMenuItemType type_in,
    int32_t action_in, bool rtl_in, bool has_directional_override_in, bool enabled_in, bool checked_in, WTF::Vector<CustomContextMenuItemPtr> submenu_in)
...
UntrustworthyContextMenuParams::UntrustworthyContextMenuParams(ContextMenuDataMediaType media_type_in, int32_t x_in, int32_t y_in, const ::blink::KURL& link_url_in,
    const ::WTF::String& link_text_in, const absl::optional<::blink::Impression>& impression_in, const ::blink::KURL& unfiltered_link_url_in, const ::blink::KURL& src_url_in,
    bool has_image_contents_in, int32_t media_flags_in, const ::WTF::String& selection_text_in, const ::WTF::String& title_text_in, const ::WTF::String& alt_text_in,
...
bool ContextMenuClientStubDispatch::Accept(ContextMenuClient* impl, mojo::Message* message)
{
    ...
    case internal::kContextMenuClient_ContextMenuClosed_Name: {
        ...
        bool success = true;
        ::blink::KURL p_link_followed = mojo::DefaultConstructTraits::CreateInstance<::blink::KURL>();
...
void ContextMenuClientInterceptorForTesting::ContextMenuClosed(const ::blink::KURL& link_followed) { GetForwardingInterface()->ContextMenuClosed(std::move(link_followed)); }
