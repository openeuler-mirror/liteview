...
class BLINK_COMMON_EXPORT ConversionHost : public ConversionHostInterfaceBase {
public:
...
public:
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input) { return mojo::internal::SerializeImpl<Impression::DataView, std::vector<uint8_t>>(input); }
