...
static_assert(sizeof(AttributionReportingAutomation_Reset_Params_Data) == 8, "Bad sizeof(AttributionReportingAutomation_Reset_Params_Data)");
...
static_assert(sizeof(AttributionReportingAutomation_Reset_ResponseParams_Data) == 16, "Bad sizeof(AttributionReportingAutomation_Reset_ResponseParams_Data)");
...
public:
    ...
    AttributionReportingAutomation_Reset_ParamsDataView(internal::AttributionReportingAutomation_Reset_Params_Data* data, mojo::Message* message)
        : data_(data)
    {
    }
...
public:
    ...
    AttributionReportingAutomation_Reset_ResponseParamsDataView(internal::AttributionReportingAutomation_Reset_ResponseParams_Data* data, mojo::Message* message)
        : data_(data)
    {
    }
