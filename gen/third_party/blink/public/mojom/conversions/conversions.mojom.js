...
(function() {
  ...
  Impression.encodedSize = codec.kStructHeaderSize + 8;
  ...
  ConversionHostProxy.prototype.registerDataHost = function(dataHost) {
  ...
  ConversionHostStub.prototype.registerDataHost = function(dataHost) {
    return this.delegate_ && this.delegate_.registerDataHost && this.delegate_.registerDataHost(dataHost);
  }
  ...
  ConversionHostStub.prototype.accept = function(message) {
    ...
    case kConversionHost_RegisterDataHost_Name:
      ...
      this.registerDataHost(params.dataHost);
      return true;
