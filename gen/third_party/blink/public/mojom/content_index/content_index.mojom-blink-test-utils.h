...
class PLATFORM_EXPORT ContentIndexServiceInterceptorForTesting : public ContentIndexService {
    ...
    void CheckOfflineCapability(int64_t service_worker_registration_id, const ::blink::KURL& launch_url, CheckOfflineCapabilityCallback callback) override;
...
public:
    ...
    void CheckOfflineCapability(int64_t service_worker_registration_id, const ::blink::KURL& launch_url, bool* out_is_offline_capable);
    bool CheckOfflineCapability(int64_t service_worker_registration_id, const ::blink::KURL& launch_url);
    void Add(int64_t service_worker_registration_id, ContentDescriptionPtr description, const WTF::Vector<::SkBitmap>& icon, const ::blink::KURL& launchUrl,
        ContentIndexError* out_error);
    ContentIndexError Add(int64_t service_worker_registration_id, ContentDescriptionPtr description, const WTF::Vector<::SkBitmap>& icon, const ::blink::KURL& launchUrl);
