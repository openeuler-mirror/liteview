...
static_assert(sizeof(ContentIndexService_CheckOfflineCapability_Params_Data) == 24, "Bad sizeof(ContentIndexService_CheckOfflineCapability_Params_Data)");
...
static_assert(sizeof(ContentIndexService_CheckOfflineCapability_ResponseParams_Data) == 16, "Bad sizeof(ContentIndexService_CheckOfflineCapability_ResponseParams_Data)");
...
public:
    ...
    ContentIndexService_CheckOfflineCapability_ParamsDataView(internal::ContentIndexService_CheckOfflineCapability_Params_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
...
public:
    ...
    ContentIndexService_CheckOfflineCapability_ResponseParamsDataView(internal::ContentIndexService_CheckOfflineCapability_ResponseParams_Data* data, mojo::Message* message)
        : data_(data)
    {
    }

    bool is_null() const { return !data_; }
    bool is_offline_capable() const { return data_->is_offline_capable; }
...
public:
    ...
    ContentIndexError error() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::blink::mojom::ContentIndexError>(data_->error)); }
...
inline void ContentIndexService_CheckOfflineCapability_ParamsDataView::GetLaunchUrlDataView(::url::mojom::UrlDataView* output)
{
    auto pointer = data_->launch_url.Get();
