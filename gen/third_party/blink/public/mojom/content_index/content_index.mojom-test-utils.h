...
class BLINK_COMMON_EXPORT ContentIndexServiceInterceptorForTesting : public ContentIndexService {
    ...
    void Add(
        int64_t service_worker_registration_id, ContentDescriptionPtr description, const std::vector<::SkBitmap>& icon, const ::GURL& launchUrl, AddCallback callback) override;
...
public:
    ...
    void CheckOfflineCapability(int64_t service_worker_registration_id, const ::GURL& launch_url, bool* out_is_offline_capable);
    bool CheckOfflineCapability(int64_t service_worker_registration_id, const ::GURL& launch_url);
    void Add(int64_t service_worker_registration_id, ContentDescriptionPtr description, const std::vector<::SkBitmap>& icon, const ::GURL& launchUrl, ContentIndexError* out_error);
    ContentIndexError Add(int64_t service_worker_registration_id, ContentDescriptionPtr description, const std::vector<::SkBitmap>& icon, const ::GURL& launchUrl);
