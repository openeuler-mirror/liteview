...
//
//   void DisplayNonPersistentNotification(const std::string& token, const ::blink::PlatformNotificationData& notification_data, const ::blink::NotificationResources&
...
//
//   void DisplayPersistentNotification(int64_t service_worker_registration_id, const ::blink::PlatformNotificationData& notification_data, const ::blink::NotificationResources&
//   notification_resources, DisplayPersistentNotificationCallback callback) final;
//
