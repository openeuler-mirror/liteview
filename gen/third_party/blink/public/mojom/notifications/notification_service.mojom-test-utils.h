...
public:
    ...
    PersistentNotificationError DisplayPersistentNotification(
    ...
    void GetNotifications(int64_t service_worker_registration_id, const std::string& filter_tag, bool include_triggered, std::vector<std::string>* out_notification_ids,
