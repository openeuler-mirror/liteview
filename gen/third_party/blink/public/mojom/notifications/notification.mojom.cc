...
NotificationAction::NotificationAction(
    NotificationActionType type_in, const std::string& action_in, const ::std::u16string& title_in, const ::GURL& icon_in, const absl::optional<::std::u16string>& placeholder_in)
...
bool NotificationAction::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
NotificationData::NotificationData(const ::std::u16string& title_in, NotificationDirection direction_in, const absl::optional<std::string>& lang_in,
    const ::std::u16string& body_in, const std::string& tag_in, const ::GURL& image_in, const ::GURL& icon_in, const ::GURL& badge_in,
    absl::optional<std::vector<int32_t>> vibration_pattern_in, double timestamp_in, bool renotify_in, bool silent_in, bool require_interaction_in,
    absl::optional<std::vector<uint8_t>> data_in, absl::optional<std::vector<NotificationActionPtr>> actions_in, absl::optional<::base::Time> show_trigger_timestamp_in)
    : title(std::move(title_in))
...
bool NotificationData::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
NotificationResources::NotificationResources(
    const ::SkBitmap& image_in, const ::SkBitmap& icon_in, const ::SkBitmap& badge_in, absl::optional<std::vector<::SkBitmap>> action_icons_in)
    : image(std::move(image_in))
    , icon(std::move(icon_in))
    , badge(std::move(badge_in))
...
bool NotificationResources::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
