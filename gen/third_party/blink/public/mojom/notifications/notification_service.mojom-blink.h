...
struct blink_mojom_internal_PersistentNotificationError_DataHashFn {
    ...
    static bool Equal(const ::blink::mojom::PersistentNotificationError& left, const ::blink::mojom::PersistentNotificationError& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::blink::mojom::PersistentNotificationError> : public GenericHashTraits<::blink::mojom::PersistentNotificationError> {
    static_assert(true, "-1000000 is a reserved enum value");
    static_assert(true, "-1000001 is a reserved enum value");
    static const bool kEmptyValueIsZero = false;
    static ::blink::mojom::PersistentNotificationError EmptyValue() { return static_cast<::blink::mojom::PersistentNotificationError>(-1000000); }
    static void ConstructDeletedValue(::blink::mojom::PersistentNotificationError& slot, bool) { slot = static_cast<::blink::mojom::PersistentNotificationError>(-1000001); }
    static bool IsDeletedValue(const ::blink::mojom::PersistentNotificationError& value) { return value == static_cast<::blink::mojom::PersistentNotificationError>(-1000001); }
};
} // namespace WTF
namespace blink {
namespace mojom {
...
//
//   void DisplayNonPersistentNotification(const WTF::String& token, ::blink::mojom::blink::NotificationDataPtr notification_data, ::blink::mojom::blink::NotificationResourcesPtr
//   notification_resources, ::mojo::PendingRemote<NonPersistentNotificationListener> event_listener) final;
//
