...
NotificationData::NotificationData(const ::WTF::String& title_in, NotificationDirection direction_in, const WTF::String& lang_in, const ::WTF::String& body_in,
    ...
    absl::optional<WTF::Vector<int32_t>> vibration_pattern_in, double timestamp_in, bool renotify_in, bool silent_in, bool require_interaction_in,
    absl::optional<WTF::Vector<uint8_t>> data_in, absl::optional<WTF::Vector<NotificationActionPtr>> actions_in, absl::optional<::base::Time> show_trigger_timestamp_in)
    : title(std::move(title_in))
...
NotificationResources::NotificationResources(
    const ::SkBitmap& image_in, const ::SkBitmap& icon_in, const ::SkBitmap& badge_in, absl::optional<WTF::Vector<::SkBitmap>> action_icons_in)
    : image(std::move(image_in))
    , icon(std::move(icon_in))
    , badge(std::move(badge_in))
