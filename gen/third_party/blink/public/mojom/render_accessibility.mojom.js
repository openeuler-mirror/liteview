...
(function() {
  ...
  RenderAccessibilityHost_HandleAXEvents_Params.encode = function(encoder, val) {
    ...
    encoder.encodeStruct(codec.Int32, val.resetToken);
    encoder.skip(1);
    encoder.skip(1);
    encoder.skip(1);
    encoder.skip(1);
  ...
  RenderAccessibilityHost_HandleAXLocationChanges_Params.encodedSize = codec.kStructHeaderSize + 8;
  ...
  RenderAccessibility_SetMode_Params.encodedSize = codec.kStructHeaderSize + 8;
  ...
  RenderAccessibilityHostProxy.prototype.handleAXLocationChanges = function(changes) {
  ...
  RenderAccessibilityHostStub.prototype.handleAXLocationChanges = function(changes) {
    return this.delegate_ && this.delegate_.handleAXLocationChanges && this.delegate_.handleAXLocationChanges(changes);
  }
  ...
  RenderAccessibilityHostStub.prototype.accept = function(message) {
    ...
    case kRenderAccessibilityHost_HandleAXLocationChanges_Name:
      ...
      this.handleAXLocationChanges(params.changes);
      return true;
    default:
      return false;
    }
  ...
  RenderAccessibilityProxy.prototype.setMode = function(axMode) {
  ...
  RenderAccessibilityStub.prototype.setMode = function(axMode) {
    return this.delegate_ && this.delegate_.setMode && this.delegate_.setMode(axMode);
  }
