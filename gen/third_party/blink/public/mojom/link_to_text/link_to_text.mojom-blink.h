...
struct blink_mojom_internal_LinkGenerationReadyStatus_DataHashFn {
    ...
    static bool Equal(const ::blink::mojom::LinkGenerationReadyStatus& left, const ::blink::mojom::LinkGenerationReadyStatus& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::blink::mojom::LinkGenerationReadyStatus> : public GenericHashTraits<::blink::mojom::LinkGenerationReadyStatus> {
    ...
    static void ConstructDeletedValue(::blink::mojom::LinkGenerationReadyStatus& slot, bool) { slot = static_cast<::blink::mojom::LinkGenerationReadyStatus>(-1000001); }
    static bool IsDeletedValue(const ::blink::mojom::LinkGenerationReadyStatus& value) { return value == static_cast<::blink::mojom::LinkGenerationReadyStatus>(-1000001); }
};
} // namespace WTF
namespace WTF {
struct blink_mojom_internal_LinkGenerationError_DataHashFn {
    ...
    static bool Equal(const ::blink::mojom::LinkGenerationError& left, const ::blink::mojom::LinkGenerationError& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::blink::mojom::LinkGenerationError> : public GenericHashTraits<::blink::mojom::LinkGenerationError> {
    static_assert(true, "-1000000 is a reserved enum value");
    static_assert(true, "-1000001 is a reserved enum value");
    static const bool kEmptyValueIsZero = false;
    static ::blink::mojom::LinkGenerationError EmptyValue() { return static_cast<::blink::mojom::LinkGenerationError>(-1000000); }
    static void ConstructDeletedValue(::blink::mojom::LinkGenerationError& slot, bool) { slot = static_cast<::blink::mojom::LinkGenerationError>(-1000001); }
    static bool IsDeletedValue(const ::blink::mojom::LinkGenerationError& value) { return value == static_cast<::blink::mojom::LinkGenerationError>(-1000001); }
};
} // namespace WTF
namespace blink {
namespace mojom {
