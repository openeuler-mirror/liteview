...
std::ostream& operator<<(std::ostream& os, LinkGenerationReadyStatus value) { return os << LinkGenerationReadyStatusToString(value); }
...
std::ostream& operator<<(std::ostream& os, LinkGenerationError value) { return os << LinkGenerationErrorToString(value); }
...
bool TextFragmentReceiver_RequestSelector_Params_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    ...
    // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
    // the message comes from an older version.
    [[maybe_unused]] const TextFragmentReceiver_RequestSelector_Params_Data* object = static_cast<const TextFragmentReceiver_RequestSelector_Params_Data*>(data);
...
bool TextFragmentReceiver_RequestSelector_ResponseParams_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    ...
    // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
    // the message comes from an older version.
    [[maybe_unused]] const TextFragmentReceiver_RequestSelector_ResponseParams_Data* object = static_cast<const TextFragmentReceiver_RequestSelector_ResponseParams_Data*>(data);

    if (!mojo::internal::ValidatePointerNonNullable(object->selector, 1, validation_context)) {
        return false;
    }
    const mojo::internal::ContainerValidateParams selector_validate_params(0, false, nullptr);
...
bool TextFragmentReceiver_RemoveFragments_Params_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    ...
    // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
    // the message comes from an older version.
    [[maybe_unused]] const TextFragmentReceiver_RemoveFragments_Params_Data* object = static_cast<const TextFragmentReceiver_RemoveFragments_Params_Data*>(data);
...
bool TextFragmentReceiver_GetExistingSelectors_Params_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    ...
    // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
    // the message comes from an older version.
    [[maybe_unused]] const TextFragmentReceiver_GetExistingSelectors_Params_Data* object = static_cast<const TextFragmentReceiver_GetExistingSelectors_Params_Data*>(data);
...
bool TextFragmentReceiver_ExtractFirstFragmentRect_Params_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    ...
    // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
    // the message comes from an older version.
    [[maybe_unused]] const TextFragmentReceiver_ExtractFirstFragmentRect_Params_Data* object = static_cast<const TextFragmentReceiver_ExtractFirstFragmentRect_Params_Data*>(data);
...
// static
void TraceFormatTraits<::blink::mojom::LinkGenerationReadyStatus>::WriteIntoTrace(perfetto::TracedValue context, ::blink::mojom::LinkGenerationReadyStatus value)
{
