...
// with not having this data in traces there.
    ...
    using RequestSelectorCallback = base::OnceCallback<void(const std::string&, ::shared_highlighting::LinkGenerationError, ::shared_highlighting::LinkGenerationReadyStatus)>;
...
// class BLINK_COMMON_EXPORT TextFragmentReceiverProxy
