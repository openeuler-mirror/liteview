...
template <> struct BLINK_COMMON_EXPORT UnionTraits<::blink::mojom::PolicyValue::DataView, ::blink::mojom::PolicyValuePtr> {
    ...
    static ::blink::mojom::PolicyValue::Tag GetTag(const ::blink::mojom::PolicyValuePtr& input) { return input->which(); }

    static bool null_value(const ::blink::mojom::PolicyValuePtr& input) { return input->get_null_value(); }

    static bool bool_value(const ::blink::mojom::PolicyValuePtr& input) { return input->get_bool_value(); }

    static double dec_double_value(const ::blink::mojom::PolicyValuePtr& input) { return input->get_dec_double_value(); }

    static int32_t enum_value(const ::blink::mojom::PolicyValuePtr& input) { return input->get_enum_value(); }
