...
public:
    ...
    void RequestPort(std::vector<SerialPortFilterPtr> filters, SerialPortInfoPtr* out_port);
    SerialPortInfoPtr RequestPort(std::vector<SerialPortFilterPtr> filters);
    void OpenPort(const ::base::UnguessableToken& token, ::device::mojom::SerialConnectionOptionsPtr options, ::mojo::PendingRemote<::device::mojom::SerialPortClient> client,
        ::mojo::PendingRemote<::device::mojom::SerialPort>* out_port);
    ::mojo::PendingRemote<::device::mojom::SerialPort> OpenPort(
