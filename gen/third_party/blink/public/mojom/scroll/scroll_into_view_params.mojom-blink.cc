...
bool ScrollAlignment::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
bool FocusedEditableParams::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
ScrollIntoViewParams::ScrollIntoViewParams(ScrollAlignmentPtr align_x_in, ScrollAlignmentPtr align_y_in, ::blink::mojom::blink::ScrollType type_in,
    bool make_visible_in_visual_viewport_in, ::blink::mojom::blink::ScrollBehavior behavior_in, bool is_for_scroll_sequence_in, FocusedEditableParamsPtr for_focused_editable_in,
...
bool ScrollIntoViewParams::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
