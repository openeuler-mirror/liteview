...
static_assert(sizeof(AndroidFontLookup_GetUniqueNameLookupTable_ResponseParams_Data) == 16, "Bad sizeof(AndroidFontLookup_GetUniqueNameLookupTable_ResponseParams_Data)");
...
static_assert(sizeof(AndroidFontLookup_MatchLocalFontByUniqueName_ResponseParams_Data) == 16, "Bad sizeof(AndroidFontLookup_MatchLocalFontByUniqueName_ResponseParams_Data)");
...
public:
    ...
    mojo::internal::Pointer<
        mojo::internal::Map_Data<mojo::internal::Pointer<mojo::internal::String_Data>, mojo::internal::Pointer<::mojo_base::mojom::internal::ReadOnlyFile_Data>>>
        font_files;
...
public:
    ...
    AndroidFontLookup_GetUniqueNameLookupTable_ResponseParamsDataView(internal::AndroidFontLookup_GetUniqueNameLookupTable_ResponseParams_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
...
public:
    ...
    AndroidFontLookup_MatchLocalFontByUniqueName_ParamsDataView(internal::AndroidFontLookup_MatchLocalFontByUniqueName_Params_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
...
public:
    ...
    AndroidFontLookup_MatchLocalFontByUniqueName_ResponseParamsDataView(internal::AndroidFontLookup_MatchLocalFontByUniqueName_ResponseParams_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
