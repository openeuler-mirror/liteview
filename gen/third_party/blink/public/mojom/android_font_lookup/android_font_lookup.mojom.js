...
(function() {
  ...
  function AndroidFontLookup_FetchAllFontFiles_Params(values) {
    this.initDefaults_();
    this.initFields_(values);
  }
  AndroidFontLookup_FetchAllFontFiles_Params.prototype.initDefaults_ = function() {
  };
  AndroidFontLookup_FetchAllFontFiles_Params.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  AndroidFontLookup_FetchAllFontFiles_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  AndroidFontLookup_FetchAllFontFiles_Params.encodedSize = codec.kStructHeaderSize + 0;

  AndroidFontLookup_FetchAllFontFiles_Params.decode = function(decoder) {
    var packed;
    var val = new AndroidFontLookup_FetchAllFontFiles_Params();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    return val;
  };

  AndroidFontLookup_FetchAllFontFiles_Params.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(AndroidFontLookup_FetchAllFontFiles_Params.encodedSize);
    encoder.writeUint32(0);
  };
  function AndroidFontLookup_FetchAllFontFiles_ResponseParams(values) {
    this.initDefaults_();
    this.initFields_(values);
  }
  AndroidFontLookup_FetchAllFontFiles_ResponseParams.prototype.initDefaults_ = function() {
    this.fontFiles = null;
  };
  AndroidFontLookup_FetchAllFontFiles_ResponseParams.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  AndroidFontLookup_FetchAllFontFiles_ResponseParams.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    if (err !== validator.validationError.NONE)
        return err;
    // validate AndroidFontLookup_FetchAllFontFiles_ResponseParams.fontFiles
    err = messageValidator.validateMapPointer(offset + codec.kStructHeaderSize + 0, false, codec.String, new codec.PointerTo(read_only_file$.ReadOnlyFile), false);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  AndroidFontLookup_FetchAllFontFiles_ResponseParams.encodedSize = codec.kStructHeaderSize + 8;

  AndroidFontLookup_FetchAllFontFiles_ResponseParams.decode = function(decoder) {
    var packed;
    var val = new AndroidFontLookup_FetchAllFontFiles_ResponseParams();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.fontFiles =
  ...
  AndroidFontLookup_FetchAllFontFiles_ResponseParams.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(AndroidFontLookup_FetchAllFontFiles_ResponseParams.encodedSize);
    encoder.writeUint32(0);
    encoder.encodeMapPointer(codec.String, new codec.PointerTo(read_only_file$.ReadOnlyFile), val.fontFiles);
  };
  var kAndroidFontLookup_GetUniqueNameLookupTable_Name = 0;
  var kAndroidFontLookup_MatchLocalFontByUniqueName_Name = 1;
  var kAndroidFontLookup_FetchAllFontFiles_Name = 2;
  ...
  AndroidFontLookupPtr.prototype.fetchAllFontFiles = function() {
    return AndroidFontLookupProxy.prototype.fetchAllFontFiles
        .apply(this.ptr.getProxy(), arguments);
  };

  AndroidFontLookupProxy.prototype.fetchAllFontFiles = function() {
    var params_ = new AndroidFontLookup_FetchAllFontFiles_Params();
    return new Promise(function(resolve, reject) {
      var builder = new codec.MessageV1Builder(
          kAndroidFontLookup_FetchAllFontFiles_Name,
          codec.align(AndroidFontLookup_FetchAllFontFiles_Params.encodedSize),
          codec.kMessageExpectsResponse, 0);
      builder.encodeStruct(AndroidFontLookup_FetchAllFontFiles_Params, params_);
      var message = builder.finish();
      this.receiver_.acceptAndExpectResponse(message).then(function(message) {
        var reader = new codec.MessageReader(message);
        var responseParams =
            reader.decodeStruct(AndroidFontLookup_FetchAllFontFiles_ResponseParams);
        resolve(responseParams);
      }).catch(function(result) {
        reject(Error("Connection error: " + result));
      });
  ...
  AndroidFontLookupStub.prototype.fetchAllFontFiles = function() {
    return this.delegate_ && this.delegate_.fetchAllFontFiles && this.delegate_.fetchAllFontFiles();
  }
  ...
  AndroidFontLookupStub.prototype.acceptWithResponder =
    ...
    case kAndroidFontLookup_MatchLocalFontByUniqueName_Name:
      ...
      return true;
    case kAndroidFontLookup_FetchAllFontFiles_Name:
      var params = reader.decodeStruct(AndroidFontLookup_FetchAllFontFiles_Params);
      this.fetchAllFontFiles().then(function(response) {
        var responseParams =
            new AndroidFontLookup_FetchAllFontFiles_ResponseParams();
        responseParams.fontFiles = response.fontFiles;
        var builder = new codec.MessageV1Builder(
            kAndroidFontLookup_FetchAllFontFiles_Name,
            codec.align(AndroidFontLookup_FetchAllFontFiles_ResponseParams.encodedSize),
            codec.kMessageIsResponse, reader.requestID);
        builder.encodeStruct(AndroidFontLookup_FetchAllFontFiles_ResponseParams,
                             responseParams);
        var message = builder.finish();
        responder.accept(message);
      });
  ...
  function validateAndroidFontLookupRequest(messageValidator) {
    ...
    switch (message.getName()) {
      ...
      case kAndroidFontLookup_FetchAllFontFiles_Name:
        if (message.expectsResponse())
          paramsClass = AndroidFontLookup_FetchAllFontFiles_Params;
      break;
    }
    if (paramsClass === null)
      return validator.validationError.NONE;
  ...
  function validateAndroidFontLookupResponse(messageValidator) {
   ...
   switch (message.getName()) {
      ...
      case kAndroidFontLookup_FetchAllFontFiles_Name:
        if (message.isResponse())
          paramsClass = AndroidFontLookup_FetchAllFontFiles_ResponseParams;
        break;
    }
    if (paramsClass === null)
      return validator.validationError.NONE;
