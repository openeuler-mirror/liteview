...
static_assert(
    sizeof(FontUniqueNameLookup_GetUniqueNameLookupTableIfAvailable_Params_Data) == 8, "Bad sizeof(FontUniqueNameLookup_GetUniqueNameLookupTableIfAvailable_Params_Data)");
...
static_assert(sizeof(FontUniqueNameLookup_GetUniqueNameLookupTable_ResponseParams_Data) == 16, "Bad sizeof(FontUniqueNameLookup_GetUniqueNameLookupTable_ResponseParams_Data)");
...
public:
    ...
    FontUniqueNameLookup_GetUniqueNameLookupTable_ParamsDataView(internal::FontUniqueNameLookup_GetUniqueNameLookupTable_Params_Data* data, mojo::Message* message)
        : data_(data)
    {
    }
...
public:
    ...
    FontUniqueNameLookup_GetUniqueNameLookupTable_ResponseParamsDataView(internal::FontUniqueNameLookup_GetUniqueNameLookupTable_ResponseParams_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
...
inline void FontUniqueNameLookup_GetUniqueNameLookupTable_ResponseParamsDataView::GetFontLookupTableDataView(::mojo_base::mojom::ReadOnlySharedMemoryRegionDataView* output)
{
    auto pointer = data_->font_lookup_table.Get();
    *output = ::mojo_base::mojom::ReadOnlySharedMemoryRegionDataView(pointer, message_);
}
