...
WebPreferences::WebPreferences(const WTF::HashMap<WTF::String, ::WTF::String>& standard_font_family_map_in,
    ...
    int32_t default_font_size_in, int32_t default_fixed_font_size_in, int32_t minimum_font_size_in, int32_t minimum_logical_font_size_in, const WTF::String& default_encoding_in,
    ...
    bool fake_no_alloc_direct_call_for_testing_enabled_in, ::blink::mojom::blink::V8CacheOptions v8_cache_options_in, bool record_whole_document_in,
    ...
    bool user_gesture_required_for_presentation_in, bool text_tracks_enabled_in, const WTF::String& text_track_background_color_in, const WTF::String& text_track_text_color_in,
    const WTF::String& text_track_text_size_in, const WTF::String& text_track_text_shadow_in, const WTF::String& text_track_font_family_in,
    const WTF::String& text_track_font_style_in, const WTF::String& text_track_font_variant_in, const WTF::String& text_track_window_color_in,
    const WTF::String& text_track_window_radius_in, float text_track_margin_percentage_in, bool immersive_mode_enabled_in, bool double_tap_to_zoom_enabled_in,
    bool fullscreen_supported_in, bool text_autosizing_enabled_in, const ::blink::KURL& web_app_scope_in, bool force_dark_mode_enabled_in,
    float default_minimum_page_scale_factor_in, float default_maximum_page_scale_factor_in, bool hide_download_ui_in, bool presentation_receiver_in, bool media_controls_enabled_in,
    bool do_not_update_selection_on_mutating_selection_range_in, AutoplayPolicy autoplay_policy_in, ::blink::mojom::blink::PreferredColorScheme preferred_color_scheme_in,
    ::blink::mojom::blink::PreferredContrast preferred_contrast_in, EffectiveConnectionType low_priority_iframes_threshold_in, bool picture_in_picture_enabled_in,
