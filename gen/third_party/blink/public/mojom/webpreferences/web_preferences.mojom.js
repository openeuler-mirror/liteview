...
(function() {
  ...
  WebPreferences.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 208, url$.Url, false);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 224, AutoplayPolicy);
    if (err !== validator.validationError.NONE)
        return err;


    // validate WebPreferences.preferredColorScheme
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 228, preferred_color_scheme$.PreferredColorScheme);
    if (err !== validator.validationError.NONE)
        return err;


    // validate WebPreferences.preferredContrast
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 232, preferred_contrast$.PreferredContrast);
    if (err !== validator.validationError.NONE)
        return err;


    // validate WebPreferences.lowPriorityIframesThreshold
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 236, EffectiveConnectionType);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    err = messageValidator.validateMapPointer(offset + codec.kStructHeaderSize + 248, false, new codec.Enum(EffectiveConnectionType), codec.Int32, false);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  WebPreferences.decode = function(decoder) {
    ...
    val.threadedScrollingEnabled = (packed >> 5) & 1 ? true : false;
    val.prefersReducedMotion = (packed >> 6) & 1 ? true : false;
    ...
    val.allowNonEmptyNavigatorPlugins = (packed >> 4) & 1 ? true : false;
    ...
    val.navigateOnDragDrop = (packed >> 7) & 1 ? true : false;
    ...
    packed = decoder.readUint8();
    val.pictureInPictureEnabled = (packed >> 0) & 1 ? true : false;
    val.translateServiceAvailable = (packed >> 1) & 1 ? true : false;
    val.lazyLoadEnabled = (packed >> 2) & 1 ? true : false;
    val.allowMixedContentUpgrades = (packed >> 3) & 1 ? true : false;
    val.alwaysShowFocus = (packed >> 4) & 1 ? true : false;
    val.touchDragDropEnabled = (packed >> 5) & 1 ? true : false;
    val.webxrImmersiveArAllowed = (packed >> 6) & 1 ? true : false;
    val.rendererWideNamedFrameLookup = (packed >> 7) & 1 ? true : false;
    packed = decoder.readUint8();
    val.strictMimeTypeCheckForWorkerScriptsEnabled = (packed >> 0) & 1 ? true : false;
    val.v8CacheOptions =
  ...
  WebPreferences.encode = function(encoder, val) {
    ...
    packed |= (val.threadedScrollingEnabled & 1) << 5
    packed |= (val.prefersReducedMotion & 1) << 6
    ...
    packed |= (val.allowNonEmptyNavigatorPlugins & 1) << 4
    ...
    packed |= (val.navigateOnDragDrop & 1) << 7
    encoder.writeUint8(packed);
    ...
    encoder.writeUint8(packed);
    packed = 0;
    packed |= (val.pictureInPictureEnabled & 1) << 0
    packed |= (val.translateServiceAvailable & 1) << 1
    packed |= (val.lazyLoadEnabled & 1) << 2
    packed |= (val.allowMixedContentUpgrades & 1) << 3
    packed |= (val.alwaysShowFocus & 1) << 4
    packed |= (val.touchDragDropEnabled & 1) << 5
    packed |= (val.webxrImmersiveArAllowed & 1) << 6
    packed |= (val.rendererWideNamedFrameLookup & 1) << 7
    encoder.writeUint8(packed);
    packed = 0;
    packed |= (val.strictMimeTypeCheckForWorkerScriptsEnabled & 1) << 0
    encoder.writeUint8(packed);
