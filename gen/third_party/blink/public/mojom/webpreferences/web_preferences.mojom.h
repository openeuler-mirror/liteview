...
public:
    ...
    WebPreferences(const base::flat_map<std::string, ::std::u16string>& standard_font_family_map_in, const base::flat_map<std::string, ::std::u16string>& fixed_font_family_map_in,
        const base::flat_map<std::string, ::std::u16string>& serif_font_family_map_in, const base::flat_map<std::string, ::std::u16string>& sans_serif_font_family_map_in,
        const base::flat_map<std::string, ::std::u16string>& cursive_font_family_map_in, const base::flat_map<std::string, ::std::u16string>& fantasy_font_family_map_in,
        ...
        int32_t minimum_font_size_in, int32_t minimum_logical_font_size_in, const std::string& default_encoding_in, bool context_menu_on_mouse_up_in, bool javascript_enabled_in,
        bool web_security_enabled_in, bool loads_images_automatically_in, bool images_enabled_in, bool plugins_enabled_in, bool dom_paste_enabled_in,
        bool shrinks_standalone_images_to_fit_in, bool text_areas_are_resizable_in, bool allow_scripts_to_close_windows_in, bool remote_fonts_enabled_in,
        bool javascript_can_access_clipboard_in, bool dns_prefetching_enabled_in, bool data_saver_enabled_in, bool local_storage_enabled_in, bool databases_enabled_in,
        bool tabs_to_links_in, bool disable_ipc_flooding_protection_in, bool hyperlink_auditing_enabled_in, bool allow_universal_access_from_file_urls_in,
        bool allow_file_access_from_file_urls_in, bool webgl1_enabled_in, bool webgl2_enabled_in, bool pepper_3d_enabled_in, bool privileged_webgl_extensions_enabled_in,
        bool webgl_errors_to_console_enabled_in, bool hide_scrollbars_in, bool enable_webkit_scrollbar_styling_in, bool accelerated_2d_canvas_enabled_in,
        bool canvas_2d_layers_enabled_in, bool antialiased_2d_canvas_disabled_in, bool antialiased_clips_2d_canvas_enabled_in, bool accelerated_filters_enabled_in,
        bool deferred_filters_enabled_in, bool container_culling_enabled_in, bool allow_running_insecure_content_in, bool disable_reading_from_canvas_in,
        bool strict_mixed_content_checking_in, bool strict_powerful_feature_restrictions_in, bool allow_geolocation_on_insecure_origins_in,
        bool strictly_block_blockable_mixed_content_in, bool block_mixed_plugin_content_in, bool password_echo_enabled_in, bool should_clear_document_background_in,
        bool enable_scroll_animator_in, bool threaded_scrolling_enabled_in, bool prefers_reduced_motion_in, bool touch_event_feature_detection_enabled_in,
        int32_t pointer_events_max_touch_points_in, int32_t available_pointer_types_in, PointerType primary_pointer_type_in, int32_t available_hover_types_in,
        HoverType primary_hover_type_in, bool dont_send_key_events_to_javascript_in, bool barrel_button_for_drag_enabled_in, bool sync_xhr_in_documents_enabled_in,
        ...
        bool navigate_on_drag_drop_in, bool fake_no_alloc_direct_call_for_testing_enabled_in, ::blink::mojom::V8CacheOptions v8_cache_options_in, bool record_whole_document_in,
        ...
        bool user_gesture_required_for_presentation_in, bool text_tracks_enabled_in, const std::string& text_track_background_color_in, const std::string& text_track_text_color_in,
        const std::string& text_track_text_size_in, const std::string& text_track_text_shadow_in, const std::string& text_track_font_family_in,
        const std::string& text_track_font_style_in, const std::string& text_track_font_variant_in, const std::string& text_track_window_color_in,
        const std::string& text_track_window_radius_in, float text_track_margin_percentage_in, bool immersive_mode_enabled_in, bool double_tap_to_zoom_enabled_in,
        bool fullscreen_supported_in, bool text_autosizing_enabled_in, const ::GURL& web_app_scope_in, bool force_dark_mode_enabled_in, float default_minimum_page_scale_factor_in,
        ...
        bool do_not_update_selection_on_mutating_selection_range_in, AutoplayPolicy autoplay_policy_in, ::blink::mojom::PreferredColorScheme preferred_color_scheme_in,
        ::blink::mojom::PreferredContrast preferred_contrast_in, EffectiveConnectionType low_priority_iframes_threshold_in, bool picture_in_picture_enabled_in,
        bool translate_service_available_in, EffectiveConnectionType network_quality_estimator_web_holdback_in, bool lazy_load_enabled_in,
        const base::flat_map<EffectiveConnectionType, int32_t>& lazy_frame_loading_distance_thresholds_px_in,
        const base::flat_map<EffectiveConnectionType, int32_t>& lazy_image_loading_distance_thresholds_px_in, bool allow_mixed_content_upgrades_in, bool always_show_focus_in,
    ...
    base::flat_map<EffectiveConnectionType, int32_t> lazy_frame_loading_distance_thresholds_px;

    base::flat_map<EffectiveConnectionType, int32_t> lazy_image_loading_distance_thresholds_px;
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::WebPreferences::DataView, ::blink::mojom::WebPreferencesPtr> {
    ...
    static const decltype(::blink::mojom::WebPreferences::sans_serif_font_family_map)& sans_serif_font_family_map(const ::blink::mojom::WebPreferencesPtr& input)
    {
    ...
    static decltype(::blink::mojom::WebPreferences::default_font_size) default_font_size(const ::blink::mojom::WebPreferencesPtr& input) { return input->default_font_size; }
    ...
    static decltype(::blink::mojom::WebPreferences::minimum_font_size) minimum_font_size(const ::blink::mojom::WebPreferencesPtr& input) { return input->minimum_font_size; }
    ...
    static const decltype(::blink::mojom::WebPreferences::default_encoding)& default_encoding(const ::blink::mojom::WebPreferencesPtr& input) { return input->default_encoding; }
    ...
    static decltype(::blink::mojom::WebPreferences::javascript_enabled) javascript_enabled(const ::blink::mojom::WebPreferencesPtr& input) { return input->javascript_enabled; }
    ...
    static decltype(::blink::mojom::WebPreferences::images_enabled) images_enabled(const ::blink::mojom::WebPreferencesPtr& input) { return input->images_enabled; }

    static decltype(::blink::mojom::WebPreferences::plugins_enabled) plugins_enabled(const ::blink::mojom::WebPreferencesPtr& input) { return input->plugins_enabled; }

    static decltype(::blink::mojom::WebPreferences::dom_paste_enabled) dom_paste_enabled(const ::blink::mojom::WebPreferencesPtr& input) { return input->dom_paste_enabled; }

    static decltype(::blink::mojom::WebPreferences::shrinks_standalone_images_to_fit) shrinks_standalone_images_to_fit(const ::blink::mojom::WebPreferencesPtr& input)
    {
    ...
    static decltype(::blink::mojom::WebPreferences::allow_scripts_to_close_windows) allow_scripts_to_close_windows(const ::blink::mojom::WebPreferencesPtr& input)
    {
    ...
    static decltype(::blink::mojom::WebPreferences::javascript_can_access_clipboard) javascript_can_access_clipboard(const ::blink::mojom::WebPreferencesPtr& input)
    {
    ...
    static decltype(::blink::mojom::WebPreferences::data_saver_enabled) data_saver_enabled(const ::blink::mojom::WebPreferencesPtr& input) { return input->data_saver_enabled; }
    ...
    static decltype(::blink::mojom::WebPreferences::databases_enabled) databases_enabled(const ::blink::mojom::WebPreferencesPtr& input) { return input->databases_enabled; }

    static decltype(::blink::mojom::WebPreferences::tabs_to_links) tabs_to_links(const ::blink::mojom::WebPreferencesPtr& input) { return input->tabs_to_links; }

    static decltype(::blink::mojom::WebPreferences::disable_ipc_flooding_protection) disable_ipc_flooding_protection(const ::blink::mojom::WebPreferencesPtr& input)
    {
    ...
    static decltype(::blink::mojom::WebPreferences::allow_universal_access_from_file_urls) allow_universal_access_from_file_urls(const ::blink::mojom::WebPreferencesPtr& input)
    {
        return input->allow_universal_access_from_file_urls;
    }

    static decltype(::blink::mojom::WebPreferences::allow_file_access_from_file_urls) allow_file_access_from_file_urls(const ::blink::mojom::WebPreferencesPtr& input)
    {
        return input->allow_file_access_from_file_urls;
    }

    static decltype(::blink::mojom::WebPreferences::webgl1_enabled) webgl1_enabled(const ::blink::mojom::WebPreferencesPtr& input) { return input->webgl1_enabled; }

    static decltype(::blink::mojom::WebPreferences::webgl2_enabled) webgl2_enabled(const ::blink::mojom::WebPreferencesPtr& input) { return input->webgl2_enabled; }

    static decltype(::blink::mojom::WebPreferences::pepper_3d_enabled) pepper_3d_enabled(const ::blink::mojom::WebPreferencesPtr& input) { return input->pepper_3d_enabled; }

    static decltype(::blink::mojom::WebPreferences::privileged_webgl_extensions_enabled) privileged_webgl_extensions_enabled(const ::blink::mojom::WebPreferencesPtr& input)
    {
        return input->privileged_webgl_extensions_enabled;
    }

    static decltype(::blink::mojom::WebPreferences::webgl_errors_to_console_enabled) webgl_errors_to_console_enabled(const ::blink::mojom::WebPreferencesPtr& input)
    {
        return input->webgl_errors_to_console_enabled;
    }

    static decltype(::blink::mojom::WebPreferences::hide_scrollbars) hide_scrollbars(const ::blink::mojom::WebPreferencesPtr& input) { return input->hide_scrollbars; }

    static decltype(::blink::mojom::WebPreferences::enable_webkit_scrollbar_styling) enable_webkit_scrollbar_styling(const ::blink::mojom::WebPreferencesPtr& input)
    {
    ...
    static decltype(::blink::mojom::WebPreferences::antialiased_2d_canvas_disabled) antialiased_2d_canvas_disabled(const ::blink::mojom::WebPreferencesPtr& input)
    {
        return input->antialiased_2d_canvas_disabled;
    }

    static decltype(::blink::mojom::WebPreferences::antialiased_clips_2d_canvas_enabled) antialiased_clips_2d_canvas_enabled(const ::blink::mojom::WebPreferencesPtr& input)
    {
    ...
    static decltype(::blink::mojom::WebPreferences::allow_running_insecure_content) allow_running_insecure_content(const ::blink::mojom::WebPreferencesPtr& input)
    {
    ...
    static decltype(::blink::mojom::WebPreferences::strict_powerful_feature_restrictions) strict_powerful_feature_restrictions(const ::blink::mojom::WebPreferencesPtr& input)
    {
        return input->strict_powerful_feature_restrictions;
    }

    static decltype(::blink::mojom::WebPreferences::allow_geolocation_on_insecure_origins) allow_geolocation_on_insecure_origins(const ::blink::mojom::WebPreferencesPtr& input)
    {
        return input->allow_geolocation_on_insecure_origins;
    }

    static decltype(::blink::mojom::WebPreferences::strictly_block_blockable_mixed_content) strictly_block_blockable_mixed_content(const ::blink::mojom::WebPreferencesPtr& input)
    {
    ...
    static decltype(::blink::mojom::WebPreferences::should_clear_document_background) should_clear_document_background(const ::blink::mojom::WebPreferencesPtr& input)
    {
    ...
    static decltype(::blink::mojom::WebPreferences::threaded_scrolling_enabled) threaded_scrolling_enabled(const ::blink::mojom::WebPreferencesPtr& input)
    {
    ...
    static decltype(::blink::mojom::WebPreferences::touch_event_feature_detection_enabled) touch_event_feature_detection_enabled(const ::blink::mojom::WebPreferencesPtr& input)
    {
        return input->touch_event_feature_detection_enabled;
    }

    static decltype(::blink::mojom::WebPreferences::pointer_events_max_touch_points) pointer_events_max_touch_points(const ::blink::mojom::WebPreferencesPtr& input)
    {
    ...
    static decltype(::blink::mojom::WebPreferences::primary_hover_type) primary_hover_type(const ::blink::mojom::WebPreferencesPtr& input) { return input->primary_hover_type; }

    static decltype(::blink::mojom::WebPreferences::dont_send_key_events_to_javascript) dont_send_key_events_to_javascript(const ::blink::mojom::WebPreferencesPtr& input)
    {
        return input->dont_send_key_events_to_javascript;
    }

    static decltype(::blink::mojom::WebPreferences::barrel_button_for_drag_enabled) barrel_button_for_drag_enabled(const ::blink::mojom::WebPreferencesPtr& input)
    {
    ...
    static decltype(::blink::mojom::WebPreferences::allow_non_empty_navigator_plugins) allow_non_empty_navigator_plugins(const ::blink::mojom::WebPreferencesPtr& input)
    {
        return input->allow_non_empty_navigator_plugins;
    }

    static decltype(::blink::mojom::WebPreferences::number_of_cpu_cores) number_of_cpu_cores(const ::blink::mojom::WebPreferencesPtr& input) { return input->number_of_cpu_cores; }

    static decltype(::blink::mojom::WebPreferences::editing_behavior) editing_behavior(const ::blink::mojom::WebPreferencesPtr& input) { return input->editing_behavior; }
    ...
    static decltype(::blink::mojom::WebPreferences::viewport_enabled) viewport_enabled(const ::blink::mojom::WebPreferencesPtr& input) { return input->viewport_enabled; }
    ...
    static decltype(::blink::mojom::WebPreferences::shrinks_viewport_contents_to_fit) shrinks_viewport_contents_to_fit(const ::blink::mojom::WebPreferencesPtr& input)
    {
        return input->shrinks_viewport_contents_to_fit;
    }

    static decltype(::blink::mojom::WebPreferences::viewport_style) viewport_style(const ::blink::mojom::WebPreferencesPtr& input) { return input->viewport_style; }

    static decltype(::blink::mojom::WebPreferences::smooth_scroll_for_find_enabled) smooth_scroll_for_find_enabled(const ::blink::mojom::WebPreferencesPtr& input)
    {
    ...
    static decltype(::blink::mojom::WebPreferences::initialize_at_minimum_page_scale) initialize_at_minimum_page_scale(const ::blink::mojom::WebPreferencesPtr& input)
    {
    ...
    static decltype(::blink::mojom::WebPreferences::navigate_on_drag_drop) navigate_on_drag_drop(const ::blink::mojom::WebPreferencesPtr& input)
    {
        return input->navigate_on_drag_drop;
    }

    static decltype(::blink::mojom::WebPreferences::fake_no_alloc_direct_call_for_testing_enabled) fake_no_alloc_direct_call_for_testing_enabled(
        const ::blink::mojom::WebPreferencesPtr& input)
    {
        return input->fake_no_alloc_direct_call_for_testing_enabled;
    }

    static decltype(::blink::mojom::WebPreferences::v8_cache_options) v8_cache_options(const ::blink::mojom::WebPreferencesPtr& input) { return input->v8_cache_options; }
    ...
    static decltype(::blink::mojom::WebPreferences::cookie_enabled) cookie_enabled(const ::blink::mojom::WebPreferencesPtr& input) { return input->cookie_enabled; }

    static decltype(::blink::mojom::WebPreferences::accelerated_video_decode_enabled) accelerated_video_decode_enabled(const ::blink::mojom::WebPreferencesPtr& input)
    {
        return input->accelerated_video_decode_enabled;
    }

    static decltype(::blink::mojom::WebPreferences::animation_policy) animation_policy(const ::blink::mojom::WebPreferencesPtr& input) { return input->animation_policy; }

    static decltype(::blink::mojom::WebPreferences::user_gesture_required_for_presentation) user_gesture_required_for_presentation(const ::blink::mojom::WebPreferencesPtr& input)
    {
        return input->user_gesture_required_for_presentation;
    }

    static decltype(::blink::mojom::WebPreferences::text_tracks_enabled) text_tracks_enabled(const ::blink::mojom::WebPreferencesPtr& input) { return input->text_tracks_enabled; }

    static const decltype(::blink::mojom::WebPreferences::text_track_background_color)& text_track_background_color(const ::blink::mojom::WebPreferencesPtr& input)
    {
    ...
    static const decltype(::blink::mojom::WebPreferences::web_app_scope)& web_app_scope(const ::blink::mojom::WebPreferencesPtr& input) { return input->web_app_scope; }
    ...
    static decltype(::blink::mojom::WebPreferences::default_minimum_page_scale_factor) default_minimum_page_scale_factor(const ::blink::mojom::WebPreferencesPtr& input)
    {
        return input->default_minimum_page_scale_factor;
    }

    static decltype(::blink::mojom::WebPreferences::default_maximum_page_scale_factor) default_maximum_page_scale_factor(const ::blink::mojom::WebPreferencesPtr& input)
    {
        return input->default_maximum_page_scale_factor;
    }

    static decltype(::blink::mojom::WebPreferences::hide_download_ui) hide_download_ui(const ::blink::mojom::WebPreferencesPtr& input) { return input->hide_download_ui; }
    ...
    static decltype(::blink::mojom::WebPreferences::autoplay_policy) autoplay_policy(const ::blink::mojom::WebPreferencesPtr& input) { return input->autoplay_policy; }
    ...
    static decltype(::blink::mojom::WebPreferences::preferred_contrast) preferred_contrast(const ::blink::mojom::WebPreferencesPtr& input) { return input->preferred_contrast; }

    static decltype(::blink::mojom::WebPreferences::low_priority_iframes_threshold) low_priority_iframes_threshold(const ::blink::mojom::WebPreferencesPtr& input)
    {
    ...
    static decltype(::blink::mojom::WebPreferences::network_quality_estimator_web_holdback) network_quality_estimator_web_holdback(const ::blink::mojom::WebPreferencesPtr& input)
    {
        return input->network_quality_estimator_web_holdback;
    }

    static decltype(::blink::mojom::WebPreferences::lazy_load_enabled) lazy_load_enabled(const ::blink::mojom::WebPreferencesPtr& input) { return input->lazy_load_enabled; }

    static const decltype(::blink::mojom::WebPreferences::lazy_frame_loading_distance_thresholds_px)& lazy_frame_loading_distance_thresholds_px(
        const ::blink::mojom::WebPreferencesPtr& input)
    {
        return input->lazy_frame_loading_distance_thresholds_px;
    }

    static const decltype(::blink::mojom::WebPreferences::lazy_image_loading_distance_thresholds_px)& lazy_image_loading_distance_thresholds_px(
        const ::blink::mojom::WebPreferencesPtr& input)
    {
    ...
    static decltype(::blink::mojom::WebPreferences::always_show_focus) always_show_focus(const ::blink::mojom::WebPreferencesPtr& input) { return input->always_show_focus; }
    ...
    static decltype(::blink::mojom::WebPreferences::renderer_wide_named_frame_lookup) renderer_wide_named_frame_lookup(const ::blink::mojom::WebPreferencesPtr& input)
    {
