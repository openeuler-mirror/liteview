...
public:
    ...
    template <typename... Args> static LeakDetectionResultPtr New(Args&&... args) { return LeakDetectionResultPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static LeakDetectionResultPtr From(const U& u) { return mojo::TypeConverter<LeakDetectionResultPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, LeakDetectionResult>::Convert(*this); }
    LeakDetectionResult()
    ...
    LeakDetectionResult(uint32_t number_of_live_audio_nodes_in, uint32_t number_of_live_documents_in, uint32_t number_of_live_nodes_in, uint32_t number_of_live_layout_objects_in,
        uint32_t number_of_live_resources_in, uint32_t number_of_live_context_lifecycle_state_observers_in, uint32_t number_of_live_frames_in,
        uint32_t number_of_live_v8_per_context_data_in, uint32_t number_of_worker_global_scopes_in, uint32_t number_of_live_ua_css_resources_in,
    ...
    template <typename T, LeakDetectionResult::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    ...
    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<LeakDetectionResult::DataView>(input); }
    ...
    {
        return mojo::Message(std::make_unique<internal::LeakDetectionResult_UnserializedMessageContext<UserType, LeakDetectionResult::DataView>>(0, 0, std::move(input)),
    ...
    {
        return LeakDetectionResult::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, LeakDetectionResult::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, LeakDetectionResult::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, LeakDetectionResult::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }

template <typename StructPtrType> LeakDetectionResultPtr LeakDetectionResult::Clone() const
{
    return New(mojo::Clone(number_of_live_audio_nodes), mojo::Clone(number_of_live_documents), mojo::Clone(number_of_live_nodes), mojo::Clone(number_of_live_layout_objects),
        mojo::Clone(number_of_live_resources), mojo::Clone(number_of_live_context_lifecycle_state_observers), mojo::Clone(number_of_live_frames),
        mojo::Clone(number_of_live_v8_per_context_data), mojo::Clone(number_of_worker_global_scopes), mojo::Clone(number_of_live_ua_css_resources),
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::LeakDetectionResult::DataView, ::blink::mojom::LeakDetectionResultPtr> {
    ...
    static decltype(::blink::mojom::LeakDetectionResult::number_of_live_audio_nodes) number_of_live_audio_nodes(const ::blink::mojom::LeakDetectionResultPtr& input)
    {
    ...
    static decltype(::blink::mojom::LeakDetectionResult::number_of_live_layout_objects) number_of_live_layout_objects(const ::blink::mojom::LeakDetectionResultPtr& input)
    {
    ...
    static decltype(::blink::mojom::LeakDetectionResult::number_of_live_v8_per_context_data) number_of_live_v8_per_context_data(const ::blink::mojom::LeakDetectionResultPtr& input)
    {
        return input->number_of_live_v8_per_context_data;
    }

    static decltype(::blink::mojom::LeakDetectionResult::number_of_worker_global_scopes) number_of_worker_global_scopes(const ::blink::mojom::LeakDetectionResultPtr& input)
    {
        return input->number_of_worker_global_scopes;
    }

    static decltype(::blink::mojom::LeakDetectionResult::number_of_live_ua_css_resources) number_of_live_ua_css_resources(const ::blink::mojom::LeakDetectionResultPtr& input)
    {
        return input->number_of_live_ua_css_resources;
    }

    static decltype(::blink::mojom::LeakDetectionResult::number_of_live_resource_fetchers) number_of_live_resource_fetchers(const ::blink::mojom::LeakDetectionResultPtr& input)
    {
