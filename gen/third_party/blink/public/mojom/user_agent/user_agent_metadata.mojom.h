...
public:
    ...
    UserAgentMetadata(std::vector<::blink::UserAgentBrandVersion> brand_version_list_in, std::vector<::blink::UserAgentBrandVersion> brand_full_version_list_in,
        const std::string& full_version_in, const std::string& platform_in, const std::string& platform_version_in, const std::string& architecture_in, const std::string& model_in,
        bool mobile_in, const std::string& bitness_in, bool wow64_in)
...
public:
    ...
    UserAgentOverride(const std::string& ua_string_override_in, const absl::optional<::blink::UserAgentMetadata>& ua_metadata_override_in)
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::UserAgentBrandVersion::DataView, ::blink::mojom::UserAgentBrandVersionPtr> {
    ...
    static const decltype(::blink::mojom::UserAgentBrandVersion::brand)& brand(const ::blink::mojom::UserAgentBrandVersionPtr& input) { return input->brand; }

    static const decltype(::blink::mojom::UserAgentBrandVersion::version)& version(const ::blink::mojom::UserAgentBrandVersionPtr& input) { return input->version; }
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::UserAgentMetadata::DataView, ::blink::mojom::UserAgentMetadataPtr> {
    ...
    static const decltype(::blink::mojom::UserAgentMetadata::brand_full_version_list)& brand_full_version_list(const ::blink::mojom::UserAgentMetadataPtr& input)
    {
        return input->brand_full_version_list;
    }

    static const decltype(::blink::mojom::UserAgentMetadata::full_version)& full_version(const ::blink::mojom::UserAgentMetadataPtr& input) { return input->full_version; }

    static const decltype(::blink::mojom::UserAgentMetadata::platform)& platform(const ::blink::mojom::UserAgentMetadataPtr& input) { return input->platform; }
    ...
    static const decltype(::blink::mojom::UserAgentMetadata::architecture)& architecture(const ::blink::mojom::UserAgentMetadataPtr& input) { return input->architecture; }

    static const decltype(::blink::mojom::UserAgentMetadata::model)& model(const ::blink::mojom::UserAgentMetadataPtr& input) { return input->model; }

    static decltype(::blink::mojom::UserAgentMetadata::mobile) mobile(const ::blink::mojom::UserAgentMetadataPtr& input) { return input->mobile; }

    static const decltype(::blink::mojom::UserAgentMetadata::bitness)& bitness(const ::blink::mojom::UserAgentMetadataPtr& input) { return input->bitness; }

    static decltype(::blink::mojom::UserAgentMetadata::wow64) wow64(const ::blink::mojom::UserAgentMetadataPtr& input) { return input->wow64; }
