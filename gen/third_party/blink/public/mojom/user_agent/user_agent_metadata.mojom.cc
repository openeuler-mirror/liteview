...
bool UserAgentBrandVersion::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
UserAgentMetadata::UserAgentMetadata(std::vector<::blink::UserAgentBrandVersion> brand_version_list_in, std::vector<::blink::UserAgentBrandVersion> brand_full_version_list_in,
...
bool UserAgentMetadata::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
UserAgentOverride::UserAgentOverride(const std::string& ua_string_override_in, const absl::optional<::blink::UserAgentMetadata>& ua_metadata_override_in)
...
bool UserAgentOverride::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
