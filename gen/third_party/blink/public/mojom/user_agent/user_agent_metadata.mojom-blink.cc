...
UserAgentMetadata::UserAgentMetadata(WTF::Vector<UserAgentBrandVersionPtr> brand_version_list_in, WTF::Vector<UserAgentBrandVersionPtr> brand_full_version_list_in,
