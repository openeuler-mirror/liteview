...
public:
    ...
    void ReadCustomData(::ui::ClipboardBuffer buffer, const ::std::u16string& type, ::std::u16string* out_result);
    ::std::u16string ReadCustomData(::ui::ClipboardBuffer buffer, const ::std::u16string& type);
