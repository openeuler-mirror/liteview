...
public:
    ...
    void ReadCustomData(ClipboardBuffer buffer, const ::WTF::String& type, ::WTF::String* out_result);
    ::WTF::String ReadCustomData(ClipboardBuffer buffer, const ::WTF::String& type);
