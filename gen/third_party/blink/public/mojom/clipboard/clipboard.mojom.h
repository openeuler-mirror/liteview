...
public:
    ...
    ClipboardFiles(std::vector<::blink::mojom::DataTransferFilePtr> files_in, const absl::optional<std::string>& file_system_id_in)
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::ClipboardFiles::DataView, ::blink::mojom::ClipboardFilesPtr> {
    ...
    static decltype(::blink::mojom::ClipboardFiles::files)& files(::blink::mojom::ClipboardFilesPtr& input) { return input->files; }

    static const decltype(::blink::mojom::ClipboardFiles::file_system_id)& file_system_id(const ::blink::mojom::ClipboardFilesPtr& input) { return input->file_system_id; }
