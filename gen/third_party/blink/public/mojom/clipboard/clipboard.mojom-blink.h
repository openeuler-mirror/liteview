...
struct blink_mojom_internal_ClipboardFormat_DataHashFn {
    ...
    static bool Equal(const ::blink::mojom::ClipboardFormat& left, const ::blink::mojom::ClipboardFormat& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::blink::mojom::ClipboardFormat> : public GenericHashTraits<::blink::mojom::ClipboardFormat> {
    ...
    static void ConstructDeletedValue(::blink::mojom::ClipboardFormat& slot, bool) { slot = static_cast<::blink::mojom::ClipboardFormat>(-1000001); }
    static bool IsDeletedValue(const ::blink::mojom::ClipboardFormat& value) { return value == static_cast<::blink::mojom::ClipboardFormat>(-1000001); }
};
} // namespace WTF
namespace WTF {
struct blink_mojom_internal_ClipboardBuffer_DataHashFn {
    ...
    static bool Equal(const ::blink::mojom::ClipboardBuffer& left, const ::blink::mojom::ClipboardBuffer& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::blink::mojom::ClipboardBuffer> : public GenericHashTraits<::blink::mojom::ClipboardBuffer> {
    static_assert(true, "-1000000 is a reserved enum value");
    static_assert(true, "-1000001 is a reserved enum value");
    static const bool kEmptyValueIsZero = false;
    static ::blink::mojom::ClipboardBuffer EmptyValue() { return static_cast<::blink::mojom::ClipboardBuffer>(-1000000); }
    static void ConstructDeletedValue(::blink::mojom::ClipboardBuffer& slot, bool) { slot = static_cast<::blink::mojom::ClipboardBuffer>(-1000001); }
    static bool IsDeletedValue(const ::blink::mojom::ClipboardBuffer& value) { return value == static_cast<::blink::mojom::ClipboardBuffer>(-1000001); }
};
} // namespace WTF
namespace blink {
namespace mojom {
...
public:
    ...
    template <typename... Args> static ClipboardFilesPtr New(Args&&... args) { return ClipboardFilesPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static ClipboardFilesPtr From(const U& u) { return mojo::TypeConverter<ClipboardFilesPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, ClipboardFiles>::Convert(*this); }
    ClipboardFiles()
        : files()
        , file_system_id()
    {
    ...
    template <typename T, ClipboardFiles::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<ClipboardFiles::DataView>(input); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::ClipboardFiles_UnserializedMessageContext<UserType, ClipboardFiles::DataView>>(0, 0, std::move(input)), MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    {
        return ClipboardFiles::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, ClipboardFiles::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, ClipboardFiles::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, ClipboardFiles::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }

template <typename StructPtrType> ClipboardFilesPtr ClipboardFiles::Clone() const { return New(mojo::Clone(files), mojo::Clone(file_system_id)); }
...
template <> struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::ClipboardFiles::DataView, ::blink::mojom::blink::ClipboardFilesPtr> {
    ...
    static decltype(::blink::mojom::blink::ClipboardFiles::files)& files(::blink::mojom::blink::ClipboardFilesPtr& input) { return input->files; }
