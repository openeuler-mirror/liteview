...
FetchAPIResponse::FetchAPIResponse(std::vector<::GURL> url_list_in, uint16_t status_code_in, const std::string& status_text_in,
    ...
    const base::flat_map<std::string, std::string>& headers_in, const absl::optional<std::string>& mime_type_in, const absl::optional<std::string>& request_method_in,
    ::blink::mojom::SerializedBlobPtr blob_in, ::blink::mojom::ServiceWorkerResponseError error_in, ::base::Time response_time_in,
    const absl::optional<std::string>& cache_storage_cache_name_in, std::vector<std::string> cors_exposed_header_names_in, ::blink::mojom::SerializedBlobPtr side_data_blob_in,
...
bool FetchAPIResponse::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
} // namespace mojom
} // namespace blink
namespace mojo {
// static
