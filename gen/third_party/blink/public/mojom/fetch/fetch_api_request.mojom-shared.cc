...
std::ostream& operator<<(std::ostream& os, RequestContextType value) { return os << RequestContextTypeToString(value); }
...
std::ostream& operator<<(std::ostream& os, FetchCacheMode value) { return os << FetchCacheModeToString(value); }
...
std::ostream& operator<<(std::ostream& os, FetchPriorityHint value) { return os << FetchPriorityHintToString(value); }
...
bool FetchAPIRequest_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    ...
    const mojo::internal::ContainerValidateParams integrity_validate_params(0, false, nullptr);
