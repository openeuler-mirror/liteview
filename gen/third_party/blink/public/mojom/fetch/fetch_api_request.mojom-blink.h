...
struct blink_mojom_internal_RequestContextType_DataHashFn {
    ...
    static bool Equal(const ::blink::mojom::RequestContextType& left, const ::blink::mojom::RequestContextType& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::blink::mojom::RequestContextType> : public GenericHashTraits<::blink::mojom::RequestContextType> {
    static_assert(true, "-1000000 is a reserved enum value");
    static_assert(true, "-1000001 is a reserved enum value");
    static const bool kEmptyValueIsZero = false;
    static ::blink::mojom::RequestContextType EmptyValue() { return static_cast<::blink::mojom::RequestContextType>(-1000000); }
    static void ConstructDeletedValue(::blink::mojom::RequestContextType& slot, bool) { slot = static_cast<::blink::mojom::RequestContextType>(-1000001); }
    static bool IsDeletedValue(const ::blink::mojom::RequestContextType& value) { return value == static_cast<::blink::mojom::RequestContextType>(-1000001); }
};
} // namespace WTF
namespace WTF {
struct blink_mojom_internal_FetchCacheMode_DataHashFn {
    ...
    static bool Equal(const ::blink::mojom::FetchCacheMode& left, const ::blink::mojom::FetchCacheMode& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::blink::mojom::FetchCacheMode> : public GenericHashTraits<::blink::mojom::FetchCacheMode> {
    static_assert(true, "-1000000 is a reserved enum value");
    static_assert(true, "-1000001 is a reserved enum value");
    static const bool kEmptyValueIsZero = false;
    static ::blink::mojom::FetchCacheMode EmptyValue() { return static_cast<::blink::mojom::FetchCacheMode>(-1000000); }
    static void ConstructDeletedValue(::blink::mojom::FetchCacheMode& slot, bool) { slot = static_cast<::blink::mojom::FetchCacheMode>(-1000001); }
    static bool IsDeletedValue(const ::blink::mojom::FetchCacheMode& value) { return value == static_cast<::blink::mojom::FetchCacheMode>(-1000001); }
};
} // namespace WTF
namespace WTF {
struct blink_mojom_internal_FetchPriorityHint_DataHashFn {
    static unsigned GetHash(const ::blink::mojom::FetchPriorityHint& value)
    {
        using utype = std::underlying_type<::blink::mojom::FetchPriorityHint>::type;
        return DefaultHash<utype>::Hash().GetHash(static_cast<utype>(value));
    }
    static bool Equal(const ::blink::mojom::FetchPriorityHint& left, const ::blink::mojom::FetchPriorityHint& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::blink::mojom::FetchPriorityHint> : public GenericHashTraits<::blink::mojom::FetchPriorityHint> {
    static_assert(true, "-1000000 is a reserved enum value");
    static_assert(true, "-1000001 is a reserved enum value");
    static const bool kEmptyValueIsZero = false;
    static ::blink::mojom::FetchPriorityHint EmptyValue() { return static_cast<::blink::mojom::FetchPriorityHint>(-1000000); }
    static void ConstructDeletedValue(::blink::mojom::FetchPriorityHint& slot, bool) { slot = static_cast<::blink::mojom::FetchPriorityHint>(-1000001); }
    static bool IsDeletedValue(const ::blink::mojom::FetchPriorityHint& value) { return value == static_cast<::blink::mojom::FetchPriorityHint>(-1000001); }
};
} // namespace WTF
namespace blink {
namespace mojom {
...
public:
    ...
    template <typename... Args> static FetchAPIRequestHeadersPtr New(Args&&... args) { return FetchAPIRequestHeadersPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static FetchAPIRequestHeadersPtr From(const U& u) { return mojo::TypeConverter<FetchAPIRequestHeadersPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, FetchAPIRequestHeaders>::Convert(*this); }
    ...
    template <typename T, FetchAPIRequestHeaders::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    ...
    {
        return mojo::Message(std::make_unique<internal::FetchAPIRequestHeaders_UnserializedMessageContext<UserType, FetchAPIRequestHeaders::DataView>>(0, 0, std::move(input)),
    ...
    {
        return FetchAPIRequestHeaders::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, FetchAPIRequestHeaders::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, FetchAPIRequestHeaders::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, FetchAPIRequestHeaders::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static FetchAPIRequestBodyPtr New(Args&&... args) { return FetchAPIRequestBodyPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static FetchAPIRequestBodyPtr From(const U& u) { return mojo::TypeConverter<FetchAPIRequestBodyPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, FetchAPIRequestBody>::Convert(*this); }
    FetchAPIRequestBody()
        : elements()
        , identifier()
    ...
    template <typename T, FetchAPIRequestBody::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<FetchAPIRequestBody::DataView>(input); }
    ...
    template <typename UserType> static mojo::Message WrapAsMessage(UserType input)
    {
        return mojo::Message(std::make_unique<internal::FetchAPIRequestBody_UnserializedMessageContext<UserType, FetchAPIRequestBody::DataView>>(0, 0, std::move(input)),
            MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const WTF::Vector<uint8_t>& input, UserType* output)
    {
        return FetchAPIRequestBody::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, FetchAPIRequestBody::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, FetchAPIRequestBody::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, FetchAPIRequestBody::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static FetchAPIRequestPtr New(Args&&... args) { return FetchAPIRequestPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static FetchAPIRequestPtr From(const U& u) { return mojo::TypeConverter<FetchAPIRequestPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, FetchAPIRequest>::Convert(*this); }
    FetchAPIRequest()
    ...
    FetchAPIRequest(::network::mojom::blink::RequestMode mode_in, bool is_main_resource_load_in, ::network::mojom::blink::RequestDestination destination_in,
        ::blink::mojom::blink::RequestContextFrameType frame_type_in, const ::blink::KURL& url_in, const WTF::String& method_in,
        ::WTF::HashMap<::WTF::String, WTF::String, WTF::CaseFoldingHash> headers_in, const ::scoped_refptr<::blink::BlobDataHandle>& blob_in, ::blink::ResourceRequestBody body_in,
        ...
        const absl::optional<::base::UnguessableToken>& fetch_window_id_in, bool keepalive_in, bool is_reload_in, bool is_history_navigation_in,
    ...
    template <typename T, FetchAPIRequest::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<FetchAPIRequest::DataView>(input); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::FetchAPIRequest_UnserializedMessageContext<UserType, FetchAPIRequest::DataView>>(0, 0, std::move(input)), MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const WTF::Vector<uint8_t>& input, UserType* output)
    {
        return FetchAPIRequest::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, FetchAPIRequest::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, FetchAPIRequest::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, FetchAPIRequest::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }

template <typename StructPtrType> FetchAPIRequestHeadersPtr FetchAPIRequestHeaders::Clone() const { return New(mojo::Clone(headers)); }
...
template <typename StructPtrType> FetchAPIRequestPtr FetchAPIRequest::Clone() const
{
    return New(mojo::Clone(mode), mojo::Clone(is_main_resource_load), mojo::Clone(destination), mojo::Clone(frame_type), mojo::Clone(url), mojo::Clone(method),
        mojo::Clone(headers), mojo::Clone(blob), mojo::Clone(body), mojo::Clone(request_initiator), mojo::Clone(navigation_redirect_chain), mojo::Clone(referrer),
        mojo::Clone(credentials_mode), mojo::Clone(cache_mode), mojo::Clone(redirect_mode), mojo::Clone(integrity), mojo::Clone(priority), mojo::Clone(fetch_window_id),
        mojo::Clone(keepalive), mojo::Clone(is_reload), mojo::Clone(is_history_navigation), mojo::Clone(devtools_stack_id), mojo::Clone(trust_token_params),
...
template <> struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::FetchAPIRequestHeaders::DataView, ::blink::mojom::blink::FetchAPIRequestHeadersPtr> {
    ...
    static const decltype(::blink::mojom::blink::FetchAPIRequestHeaders::headers)& headers(const ::blink::mojom::blink::FetchAPIRequestHeadersPtr& input) { return input->headers; }
...
template <> struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::FetchAPIRequestBody::DataView, ::blink::mojom::blink::FetchAPIRequestBodyPtr> {
    ...
    static decltype(::blink::mojom::blink::FetchAPIRequestBody::elements)& elements(::blink::mojom::blink::FetchAPIRequestBodyPtr& input) { return input->elements; }

    static decltype(::blink::mojom::blink::FetchAPIRequestBody::identifier) identifier(const ::blink::mojom::blink::FetchAPIRequestBodyPtr& input) { return input->identifier; }

    static decltype(::blink::mojom::blink::FetchAPIRequestBody::contains_sensitive_info) contains_sensitive_info(const ::blink::mojom::blink::FetchAPIRequestBodyPtr& input)
    {
...
template <> struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::FetchAPIRequest::DataView, ::blink::mojom::blink::FetchAPIRequestPtr> {
    ...
    static decltype(::blink::mojom::blink::FetchAPIRequest::mode) mode(const ::blink::mojom::blink::FetchAPIRequestPtr& input) { return input->mode; }
    ...
    static decltype(::blink::mojom::blink::FetchAPIRequest::destination) destination(const ::blink::mojom::blink::FetchAPIRequestPtr& input) { return input->destination; }

    static decltype(::blink::mojom::blink::FetchAPIRequest::frame_type) frame_type(const ::blink::mojom::blink::FetchAPIRequestPtr& input) { return input->frame_type; }

    static const decltype(::blink::mojom::blink::FetchAPIRequest::url)& url(const ::blink::mojom::blink::FetchAPIRequestPtr& input) { return input->url; }

    static const decltype(::blink::mojom::blink::FetchAPIRequest::method)& method(const ::blink::mojom::blink::FetchAPIRequestPtr& input) { return input->method; }

    static const decltype(::blink::mojom::blink::FetchAPIRequest::headers)& headers(const ::blink::mojom::blink::FetchAPIRequestPtr& input) { return input->headers; }

    static decltype(::blink::mojom::blink::FetchAPIRequest::blob)& blob(::blink::mojom::blink::FetchAPIRequestPtr& input) { return input->blob; }

    static decltype(::blink::mojom::blink::FetchAPIRequest::body)& body(::blink::mojom::blink::FetchAPIRequestPtr& input) { return input->body; }
    ...
    static const decltype(::blink::mojom::blink::FetchAPIRequest::navigation_redirect_chain)& navigation_redirect_chain(const ::blink::mojom::blink::FetchAPIRequestPtr& input)
    {
        return input->navigation_redirect_chain;
    }

    static const decltype(::blink::mojom::blink::FetchAPIRequest::referrer)& referrer(const ::blink::mojom::blink::FetchAPIRequestPtr& input) { return input->referrer; }
    ...
    static decltype(::blink::mojom::blink::FetchAPIRequest::cache_mode) cache_mode(const ::blink::mojom::blink::FetchAPIRequestPtr& input) { return input->cache_mode; }

    static decltype(::blink::mojom::blink::FetchAPIRequest::redirect_mode) redirect_mode(const ::blink::mojom::blink::FetchAPIRequestPtr& input) { return input->redirect_mode; }

    static const decltype(::blink::mojom::blink::FetchAPIRequest::integrity)& integrity(const ::blink::mojom::blink::FetchAPIRequestPtr& input) { return input->integrity; }

    static decltype(::blink::mojom::blink::FetchAPIRequest::priority) priority(const ::blink::mojom::blink::FetchAPIRequestPtr& input) { return input->priority; }
    ...
    static decltype(::blink::mojom::blink::FetchAPIRequest::keepalive) keepalive(const ::blink::mojom::blink::FetchAPIRequestPtr& input) { return input->keepalive; }

    static decltype(::blink::mojom::blink::FetchAPIRequest::is_reload) is_reload(const ::blink::mojom::blink::FetchAPIRequestPtr& input) { return input->is_reload; }
    ...
    static const decltype(::blink::mojom::blink::FetchAPIRequest::trust_token_params)& trust_token_params(const ::blink::mojom::blink::FetchAPIRequestPtr& input)
    {
