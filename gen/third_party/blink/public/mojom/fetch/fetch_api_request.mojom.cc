...
bool FetchAPIRequestHeaders::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
bool FetchAPIRequestBody::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
FetchAPIRequest::FetchAPIRequest(::network::mojom::RequestMode mode_in, bool is_main_resource_load_in, ::network::mojom::RequestDestination destination_in,
    ...
    std::vector<::GURL> navigation_redirect_chain_in, ::blink::mojom::ReferrerPtr referrer_in, ::network::mojom::CredentialsMode credentials_mode_in, FetchCacheMode cache_mode_in,
    ::network::mojom::RedirectMode redirect_mode_in, const absl::optional<std::string>& integrity_in, ::net::RequestPriority priority_in,
    ...
    const absl::optional<std::string>& devtools_stack_id_in, ::network::mojom::TrustTokenParamsPtr trust_token_params_in, ::network::mojom::IPAddressSpace target_address_space_in)
...
bool FetchAPIRequest::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
} // namespace mojom
} // namespace blink
namespace mojo {
// static
