...
FetchAPIRequest::FetchAPIRequest(::network::mojom::blink::RequestMode mode_in, bool is_main_resource_load_in, ::network::mojom::blink::RequestDestination destination_in,
    ...
    const WTF::String& devtools_stack_id_in, ::network::mojom::blink::TrustTokenParamsPtr trust_token_params_in, ::network::mojom::blink::IPAddressSpace target_address_space_in)
