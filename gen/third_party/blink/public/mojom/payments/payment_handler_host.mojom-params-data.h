...
static_assert(sizeof(PaymentHandlerHost_ChangePaymentMethod_ResponseParams_Data) == 16, "Bad sizeof(PaymentHandlerHost_ChangePaymentMethod_ResponseParams_Data)");
...
static_assert(sizeof(PaymentHandlerHost_ChangeShippingOption_ResponseParams_Data) == 16, "Bad sizeof(PaymentHandlerHost_ChangeShippingOption_ResponseParams_Data)");
...
static_assert(sizeof(PaymentHandlerHost_ChangeShippingAddress_ResponseParams_Data) == 16, "Bad sizeof(PaymentHandlerHost_ChangeShippingAddress_ResponseParams_Data)");
...
public:
    ...
    PaymentHandlerHost_ChangePaymentMethod_ResponseParamsDataView(internal::PaymentHandlerHost_ChangePaymentMethod_ResponseParams_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
...
public:
    ...
    PaymentHandlerHost_ChangeShippingOption_ResponseParamsDataView(internal::PaymentHandlerHost_ChangeShippingOption_ResponseParams_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
...
public:
    ...
    PaymentHandlerHost_ChangeShippingAddress_ResponseParamsDataView(internal::PaymentHandlerHost_ChangeShippingAddress_ResponseParams_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
