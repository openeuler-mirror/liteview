...
static_assert(sizeof(PaymentRequestClient_AllowConnectToSource_ResponseParams_Data) == 16, "Bad sizeof(PaymentRequestClient_AllowConnectToSource_ResponseParams_Data)");
...
public:
    ...
    PaymentRequestClient_OnShippingAddressChange_ParamsDataView(internal::PaymentRequestClient_OnShippingAddressChange_Params_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
...
public:
    ...
    PaymentErrorReason error() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::payments::mojom::PaymentErrorReason>(data_->error)); }
...
public:
    ...
    bool is_null() const { return !data_; }
    bool aborted_successfully() const { return data_->aborted_successfully; }
...
public:
    ...
    CanMakePaymentQueryResult result() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::payments::mojom::CanMakePaymentQueryResult>(data_->result)); }
...
public:
    ...
    PaymentRequestClient_OnHasEnrolledInstrument_ParamsDataView(internal::PaymentRequestClient_OnHasEnrolledInstrument_Params_Data* data, mojo::Message* message)
        : data_(data)
    {
    }
...
public:
    ...
    bool did_follow_redirect() const { return data_->did_follow_redirect; }
...
public:
    ...
    PaymentRequestClient_AllowConnectToSource_ResponseParamsDataView(internal::PaymentRequestClient_AllowConnectToSource_ResponseParams_Data* data, mojo::Message* message)
        : data_(data)
    {
    }
...
public:
    ...
    {
        UserType result;
        bool ret = mojo::internal::Deserialize<mojo::InterfacePtrDataView<::payments::mojom::PaymentRequestClientInterfaceBase>>(&data_->client, &result, message_);
        DCHECK(ret);
        return result;
    }
...
public:
    ...
    bool is_null() const { return !data_; }
    bool wait_for_updated_details() const { return data_->wait_for_updated_details; }
...
public:
    ...
    PaymentComplete result() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::payments::mojom::PaymentComplete>(data_->result)); }
