...
PaymentResponse::PaymentResponse(const WTF::String& method_name_in, const WTF::String& stringified_details_in, ::payments::mojom::blink::PaymentAddressPtr shipping_address_in,
...
SecurePaymentConfirmationResponse::SecurePaymentConfirmationResponse(::blink::mojom::blink::CommonCredentialInfoPtr credential_info_in, WTF::Vector<uint8_t> signature_in,
...
PaymentShippingOption::PaymentShippingOption(const WTF::String& id_in, const WTF::String& label_in, ::payments::mojom::blink::PaymentCurrencyAmountPtr amount_in, bool selected_in)
    : id(std::move(id_in))
    , label(std::move(label_in))
    , amount(std::move(amount_in))
...
PaymentDetailsModifier::PaymentDetailsModifier(PaymentItemPtr total_in, WTF::Vector<PaymentItemPtr> additional_display_items_in, PaymentMethodDataPtr method_data_in)
...
PaymentDetails::PaymentDetails(PaymentItemPtr total_in, absl::optional<WTF::Vector<PaymentItemPtr>> display_items_in,
    absl::optional<WTF::Vector<PaymentShippingOptionPtr>> shipping_options_in, absl::optional<WTF::Vector<PaymentDetailsModifierPtr>> modifiers_in, const WTF::String& error_in,
    ::payments::mojom::blink::AddressErrorsPtr shipping_address_errors_in, const WTF::String& id_in, const WTF::String& stringified_payment_method_errors_in)
    : total(std::move(total_in))
...
bool PaymentRequestClientStubDispatch::Accept(PaymentRequestClient* impl, mojo::Message* message)
{
    ...
    case internal::kPaymentRequestClient_OnPaymentMethodChange_Name: {
        ...
        WTF::String p_stringified_details = mojo::DefaultConstructTraits::CreateInstance<WTF::String>();
    ...
    case internal::kPaymentRequestClient_OnShippingAddressChange_Name: {
        ...
        bool success = true;
        ::payments::mojom::blink::PaymentAddressPtr p_address = mojo::DefaultConstructTraits::CreateInstance<::payments::mojom::blink::PaymentAddressPtr>();
    ...
    case internal::kPaymentRequestClient_OnShippingOptionChange_Name: {
        ...
        bool success = true;
        WTF::String p_shipping_option_id = mojo::DefaultConstructTraits::CreateInstance<WTF::String>();
...
bool PaymentRequestStubDispatch::Accept(PaymentRequest* impl, mojo::Message* message)
{
    ...
    case internal::kPaymentRequest_Init_Name: {
        ...
        WTF::Vector<PaymentMethodDataPtr> p_method_data = mojo::DefaultConstructTraits::CreateInstance<WTF::Vector<PaymentMethodDataPtr>>();
    ...
    case internal::kPaymentRequest_Retry_Name: {
        ...
        bool success = true;
        ::payments::mojom::blink::PaymentValidationErrorsPtr p_errors = mojo::DefaultConstructTraits::CreateInstance<::payments::mojom::blink::PaymentValidationErrorsPtr>();
...
bool StructTraits<::payments::mojom::blink::SecurePaymentConfirmationResponse::DataView, ::payments::mojom::blink::SecurePaymentConfirmationResponsePtr>::Read(
    ::payments::mojom::blink::SecurePaymentConfirmationResponse::DataView input, ::payments::mojom::blink::SecurePaymentConfirmationResponsePtr* output)
{
    bool success = true;
...
void PaymentRequestClientAsyncWaiter::AllowConnectToSource(const ::blink::KURL& url, const ::blink::KURL& url_before_redirects, bool did_follow_redirect, bool* out_allow)
{
    base::RunLoop loop;
...
void PaymentRequestInterceptorForTesting::Retry(::payments::mojom::blink::PaymentValidationErrorsPtr errors) { GetForwardingInterface()->Retry(std::move(errors)); }
