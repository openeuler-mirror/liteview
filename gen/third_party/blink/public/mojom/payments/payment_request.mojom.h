...
public:
    ...
    PayerDetail(const absl::optional<std::string>& email_in, const absl::optional<std::string>& name_in, const absl::optional<std::string>& phone_in)
...
public:
    ...
    PaymentResponse(const std::string& method_name_in, const std::string& stringified_details_in, ::payments::mojom::PaymentAddressPtr shipping_address_in,
...
class BLINK_COMMON_EXPORT SecurePaymentConfirmationResponse {
public:
    ...
    SecurePaymentConfirmationResponse(::blink::mojom::CommonCredentialInfoPtr credential_info_in, std::vector<uint8_t> signature_in,
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<SecurePaymentConfirmationResponse::DataView, std::vector<uint8_t>>(input);
    }
...
public:
    ...
    PaymentShippingOption(const std::string& id_in, const std::string& label_in, ::payments::mojom::PaymentCurrencyAmountPtr amount_in, bool selected_in)
        : id(std::move(id_in))
        , label(std::move(label_in))
        , amount(std::move(amount_in))
...
public:
    ...
    PaymentDetailsModifier(PaymentItemPtr total_in, std::vector<PaymentItemPtr> additional_display_items_in, PaymentMethodDataPtr method_data_in)
...
public:
    ...
    PaymentDetails(PaymentItemPtr total_in, absl::optional<std::vector<PaymentItemPtr>> display_items_in, absl::optional<std::vector<PaymentShippingOptionPtr>> shipping_options_in,
        absl::optional<std::vector<PaymentDetailsModifierPtr>> modifiers_in, const std::string& error_in, ::payments::mojom::AddressErrorsPtr shipping_address_errors_in,
        const absl::optional<std::string>& id_in, const absl::optional<std::string>& stringified_payment_method_errors_in)
        : total(std::move(total_in))
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::payments::mojom::PaymentResponse::DataView, ::payments::mojom::PaymentResponsePtr> {
    ...
    static const decltype(::payments::mojom::PaymentResponse::method_name)& method_name(const ::payments::mojom::PaymentResponsePtr& input) { return input->method_name; }
    ...
    static const decltype(::payments::mojom::PaymentResponse::payer)& payer(const ::payments::mojom::PaymentResponsePtr& input) { return input->payer; }

    static const decltype(::payments::mojom::PaymentResponse::secure_payment_confirmation)& secure_payment_confirmation(const ::payments::mojom::PaymentResponsePtr& input)
    {
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::payments::mojom::SecurePaymentConfirmationResponse::DataView, ::payments::mojom::SecurePaymentConfirmationResponsePtr> {
    static bool IsNull(const ::payments::mojom::SecurePaymentConfirmationResponsePtr& input) { return !input; }
    static void SetToNull(::payments::mojom::SecurePaymentConfirmationResponsePtr* output) { output->reset(); }

    static const decltype(::payments::mojom::SecurePaymentConfirmationResponse::credential_info)& credential_info(
        const ::payments::mojom::SecurePaymentConfirmationResponsePtr& input)
    {
        return input->credential_info;
    }

    static const decltype(::payments::mojom::SecurePaymentConfirmationResponse::signature)& signature(const ::payments::mojom::SecurePaymentConfirmationResponsePtr& input)
    {
        return input->signature;
    }

    static decltype(::payments::mojom::SecurePaymentConfirmationResponse::authenticator_attachment) authenticator_attachment(
        const ::payments::mojom::SecurePaymentConfirmationResponsePtr& input)
    {
        return input->authenticator_attachment;
    }

    static const decltype(::payments::mojom::SecurePaymentConfirmationResponse::user_handle)& user_handle(const ::payments::mojom::SecurePaymentConfirmationResponsePtr& input)
    {
        return input->user_handle;
    }

    static bool Read(::payments::mojom::SecurePaymentConfirmationResponse::DataView input, ::payments::mojom::SecurePaymentConfirmationResponsePtr* output);
};
template <> struct BLINK_COMMON_EXPORT StructTraits<::payments::mojom::PayerDetail::DataView, ::payments::mojom::PayerDetailPtr> {
    ...
    static const decltype(::payments::mojom::PayerDetail::email)& email(const ::payments::mojom::PayerDetailPtr& input) { return input->email; }

    static const decltype(::payments::mojom::PayerDetail::name)& name(const ::payments::mojom::PayerDetailPtr& input) { return input->name; }

    static const decltype(::payments::mojom::PayerDetail::phone)& phone(const ::payments::mojom::PayerDetailPtr& input) { return input->phone; }
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::payments::mojom::PaymentItem::DataView, ::payments::mojom::PaymentItemPtr> {
    ...
    static const decltype(::payments::mojom::PaymentItem::label)& label(const ::payments::mojom::PaymentItemPtr& input) { return input->label; }

    static const decltype(::payments::mojom::PaymentItem::amount)& amount(const ::payments::mojom::PaymentItemPtr& input) { return input->amount; }

    static decltype(::payments::mojom::PaymentItem::pending) pending(const ::payments::mojom::PaymentItemPtr& input) { return input->pending; }
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::payments::mojom::PaymentShippingOption::DataView, ::payments::mojom::PaymentShippingOptionPtr> {
    ...
    static const decltype(::payments::mojom::PaymentShippingOption::id)& id(const ::payments::mojom::PaymentShippingOptionPtr& input) { return input->id; }

    static const decltype(::payments::mojom::PaymentShippingOption::label)& label(const ::payments::mojom::PaymentShippingOptionPtr& input) { return input->label; }

    static const decltype(::payments::mojom::PaymentShippingOption::amount)& amount(const ::payments::mojom::PaymentShippingOptionPtr& input) { return input->amount; }

    static decltype(::payments::mojom::PaymentShippingOption::selected) selected(const ::payments::mojom::PaymentShippingOptionPtr& input) { return input->selected; }

    static bool Read(::payments::mojom::PaymentShippingOption::DataView input, ::payments::mojom::PaymentShippingOptionPtr* output);
};
template <> struct BLINK_COMMON_EXPORT StructTraits<::payments::mojom::SecurePaymentConfirmationRequest::DataView, ::payments::mojom::SecurePaymentConfirmationRequestPtr> {
    ...
    static const decltype(::payments::mojom::SecurePaymentConfirmationRequest::credential_ids)& credential_ids(const ::payments::mojom::SecurePaymentConfirmationRequestPtr& input)
    {
        return input->credential_ids;
    }

    static const decltype(::payments::mojom::SecurePaymentConfirmationRequest::challenge)& challenge(const ::payments::mojom::SecurePaymentConfirmationRequestPtr& input)
    {
        return input->challenge;
    }

    static const decltype(::payments::mojom::SecurePaymentConfirmationRequest::instrument)& instrument(const ::payments::mojom::SecurePaymentConfirmationRequestPtr& input)
    {
        return input->instrument;
    }

    static const decltype(::payments::mojom::SecurePaymentConfirmationRequest::timeout)& timeout(const ::payments::mojom::SecurePaymentConfirmationRequestPtr& input)
    {
        return input->timeout;
    }

    static const decltype(::payments::mojom::SecurePaymentConfirmationRequest::payee_origin)& payee_origin(const ::payments::mojom::SecurePaymentConfirmationRequestPtr& input)
    {
        return input->payee_origin;
    }

    static const decltype(::payments::mojom::SecurePaymentConfirmationRequest::payee_name)& payee_name(const ::payments::mojom::SecurePaymentConfirmationRequestPtr& input)
    {
        return input->payee_name;
    }

    static const decltype(::payments::mojom::SecurePaymentConfirmationRequest::rp_id)& rp_id(const ::payments::mojom::SecurePaymentConfirmationRequestPtr& input)
    {
        return input->rp_id;
    }

    static decltype(::payments::mojom::SecurePaymentConfirmationRequest::show_opt_out) show_opt_out(const ::payments::mojom::SecurePaymentConfirmationRequestPtr& input)
    {
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::payments::mojom::PaymentMethodData::DataView, ::payments::mojom::PaymentMethodDataPtr> {
    ...
    static decltype(::payments::mojom::PaymentMethodData::environment) environment(const ::payments::mojom::PaymentMethodDataPtr& input) { return input->environment; }

    static decltype(::payments::mojom::PaymentMethodData::min_google_play_services_version) min_google_play_services_version(const ::payments::mojom::PaymentMethodDataPtr& input)
    {
        return input->min_google_play_services_version;
    }

    static decltype(::payments::mojom::PaymentMethodData::api_version) api_version(const ::payments::mojom::PaymentMethodDataPtr& input) { return input->api_version; }
    ...
    static const decltype(::payments::mojom::PaymentMethodData::secure_payment_confirmation)& secure_payment_confirmation(const ::payments::mojom::PaymentMethodDataPtr& input)
    {
        return input->secure_payment_confirmation;
    }
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::payments::mojom::PaymentDetailsModifier::DataView, ::payments::mojom::PaymentDetailsModifierPtr> {
    ...
    static const decltype(::payments::mojom::PaymentDetailsModifier::total)& total(const ::payments::mojom::PaymentDetailsModifierPtr& input) { return input->total; }

    static const decltype(::payments::mojom::PaymentDetailsModifier::additional_display_items)& additional_display_items(const ::payments::mojom::PaymentDetailsModifierPtr& input)
    {
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::payments::mojom::PaymentDetails::DataView, ::payments::mojom::PaymentDetailsPtr> {
    ...
    static const decltype(::payments::mojom::PaymentDetails::total)& total(const ::payments::mojom::PaymentDetailsPtr& input) { return input->total; }

    static const decltype(::payments::mojom::PaymentDetails::display_items)& display_items(const ::payments::mojom::PaymentDetailsPtr& input) { return input->display_items; }
    ...
    static const decltype(::payments::mojom::PaymentDetails::modifiers)& modifiers(const ::payments::mojom::PaymentDetailsPtr& input) { return input->modifiers; }

    static const decltype(::payments::mojom::PaymentDetails::error)& error(const ::payments::mojom::PaymentDetailsPtr& input) { return input->error; }

    static const decltype(::payments::mojom::PaymentDetails::shipping_address_errors)& shipping_address_errors(const ::payments::mojom::PaymentDetailsPtr& input)
    {
        return input->shipping_address_errors;
    }

    static const decltype(::payments::mojom::PaymentDetails::id)& id(const ::payments::mojom::PaymentDetailsPtr& input) { return input->id; }
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::payments::mojom::PaymentOptions::DataView, ::payments::mojom::PaymentOptionsPtr> {
    ...
    static decltype(::payments::mojom::PaymentOptions::request_shipping) request_shipping(const ::payments::mojom::PaymentOptionsPtr& input) { return input->request_shipping; }

    static decltype(::payments::mojom::PaymentOptions::shipping_type) shipping_type(const ::payments::mojom::PaymentOptionsPtr& input) { return input->shipping_type; }
