...
static_assert(sizeof(PaymentCredential_StorePaymentCredential_ResponseParams_Data) == 16, "Bad sizeof(PaymentCredential_StorePaymentCredential_ResponseParams_Data)");
...
public:
    ...
    PaymentCredential_StorePaymentCredential_ResponseParamsDataView(internal::PaymentCredential_StorePaymentCredential_ResponseParams_Data* data, mojo::Message* message)
        : data_(data)
    {
    }
