...
// with not having this data in traces there.
    ...
    virtual void HandleStylusWritingGestureAction(::blink::mojom::StylusWritingGestureDataPtr gesture_data) = 0;

    virtual void ExecuteEditCommand(const std::string& command, const absl::optional<::std::u16string>& value) = 0;
...
// with not having this data in traces there.
    ...
    virtual void ImeSetComposition(const ::std::u16string& text, const std::vector<::ui::ImeTextSpan>& ime_text_spans, const ::gfx::Range& range, int32_t start, int32_t end,
        ImeSetCompositionCallback callback)
        = 0;
    using ImeCommitTextCallback = base::OnceCallback<void()>;

    virtual void ImeCommitText(const ::std::u16string& text, const std::vector<::ui::ImeTextSpan>& ime_text_spans, const ::gfx::Range& range, int32_t relative_cursor_position,
    ...
    using DispatchEventCallback = base::OnceCallback<void(::blink::mojom::InputEventResultSource, const ::ui::LatencyInfo&, ::blink::mojom::InputEventResultState,
        DidOverscrollParamsPtr, TouchActionOptionalPtr, ScrollResultDataPtr)>;
...
// class BLINK_COMMON_EXPORT WidgetInputHandlerHostProxy
...
// class BLINK_COMMON_EXPORT FrameWidgetInputHandlerProxy
...
//
//   void HandleStylusWritingGestureAction(::blink::mojom::StylusWritingGestureDataPtr gesture_data) final;
//
//   void ExecuteEditCommand(const std::string& command, const absl::optional<::std::u16string>& value) final;
//
//   void Undo() final;
//
//   void Redo() final;
...
// class BLINK_COMMON_EXPORT WidgetInputHandlerProxy
...
//   ImeSetCompositionCallback callback) final;
//
...
//   ImeCommitTextCallback callback) final;
//
...
class BLINK_COMMON_EXPORT ScrollUpdate {
public:
    template <typename T> using EnableIfSame = std::enable_if_t<std::is_same<ScrollUpdate, T>::value>;
    using DataView = ScrollUpdateDataView;
    using Data_ = internal::ScrollUpdate_Data;

    template <typename... Args> static ScrollUpdatePtr New(Args&&... args) { return ScrollUpdatePtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static ScrollUpdatePtr From(const U& u) { return mojo::TypeConverter<ScrollUpdatePtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, ScrollUpdate>::Convert(*this); }
    ScrollUpdate()
        : velocity_x()
        , velocity_y()
    {
    ...
    ScrollUpdate(float velocity_x_in, float velocity_y_in)
    ...
    template <typename StructPtrType = ScrollUpdatePtr> ScrollUpdatePtr Clone() const;

    // Equals() is a template so it is only instantiated if it is used. Thus, the
    // bindings generator does not need to know whether Equals() or == operator
    // are available for members.
    template <typename T, ScrollUpdate::EnableIfSame<T>* = nullptr> bool Equals(const T& other) const;

    template <typename T, ScrollUpdate::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    size_t Hash(size_t seed) const;
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<ScrollUpdate::DataView, std::vector<uint8_t>>(input);
    }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<ScrollUpdate::DataView>(input); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::ScrollUpdate_UnserializedMessageContext<UserType, ScrollUpdate::DataView>>(0, 0, std::move(input)), MOJO_CREATE_MESSAGE_FLAG_NONE);
    }

    template <typename UserType> static bool Deserialize(const void* data, size_t data_num_bytes, UserType* output)
    {
        mojo::Message message;
        return mojo::internal::DeserializeImpl<ScrollUpdate::DataView>(message, data, data_num_bytes, output, Validate);
    }

    template <typename UserType> static bool Deserialize(const std::vector<uint8_t>& input, UserType* output)
    {
        return ScrollUpdate::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }

    template <typename UserType> static bool DeserializeFromMessage(mojo::Message input, UserType* output)
    {
        auto context = input.TakeUnserializedContext<internal::ScrollUpdate_UnserializedMessageContext<UserType, ScrollUpdate::DataView>>();
        if (context) {
            *output = std::move(context->TakeData());
            return true;
        }
        input.SerializeIfNecessary();
        return mojo::internal::DeserializeImpl<ScrollUpdate::DataView>(input, input.payload(), input.payload_num_bytes(), output, Validate);
    }
...
template <typename T, ScrollUpdate::EnableIfSame<T>* = nullptr> bool operator<(const T& lhs, const T& rhs);

template <typename T, ScrollUpdate::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, ScrollUpdate::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, ScrollUpdate::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static PinchBeginDataPtr New(Args&&... args) { return PinchBeginDataPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static PinchBeginDataPtr From(const U& u) { return mojo::TypeConverter<PinchBeginDataPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, PinchBeginData>::Convert(*this); }
    PinchBeginData()
        : needs_wheel_event()
    {
    }
    ...
    template <typename T, PinchBeginData::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    size_t Hash(size_t seed) const;
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
    ...
    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<PinchBeginData::DataView>(input); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::PinchBeginData_UnserializedMessageContext<UserType, PinchBeginData::DataView>>(0, 0, std::move(input)), MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const std::vector<uint8_t>& input, UserType* output)
    {
        return PinchBeginData::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, PinchBeginData::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, PinchBeginData::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, PinchBeginData::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static PinchUpdateDataPtr New(Args&&... args) { return PinchUpdateDataPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static PinchUpdateDataPtr From(const U& u) { return mojo::TypeConverter<PinchUpdateDataPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, PinchUpdateData>::Convert(*this); }
    PinchUpdateData()
        : scale()
        , zoom_disabled()
        , needs_wheel_event()
    ...
    template <typename T, PinchUpdateData::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    size_t Hash(size_t seed) const;
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
    ...
    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<PinchUpdateData::DataView>(input); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::PinchUpdateData_UnserializedMessageContext<UserType, PinchUpdateData::DataView>>(0, 0, std::move(input)), MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const std::vector<uint8_t>& input, UserType* output)
    {
        return PinchUpdateData::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, PinchUpdateData::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, PinchUpdateData::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, PinchUpdateData::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static PinchEndDataPtr New(Args&&... args) { return PinchEndDataPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static PinchEndDataPtr From(const U& u) { return mojo::TypeConverter<PinchEndDataPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, PinchEndData>::Convert(*this); }
    PinchEndData()
        : needs_wheel_event()
    {
    }
    ...
    template <typename T, PinchEndData::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    size_t Hash(size_t seed) const;
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
    ...
    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<PinchEndData::DataView>(input); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::PinchEndData_UnserializedMessageContext<UserType, PinchEndData::DataView>>(0, 0, std::move(input)), MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const std::vector<uint8_t>& input, UserType* output)
    {
        return PinchEndData::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, PinchEndData::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, PinchEndData::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, PinchEndData::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static FlingDataPtr New(Args&&... args) { return FlingDataPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static FlingDataPtr From(const U& u) { return mojo::TypeConverter<FlingDataPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, FlingData>::Convert(*this); }
    FlingData()
        : velocity_x()
        , velocity_y()
        , target_viewport()
    ...
    template <typename T, FlingData::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    size_t Hash(size_t seed) const;
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input) { return mojo::internal::SerializeImpl<FlingData::DataView, std::vector<uint8_t>>(input); }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<FlingData::DataView>(input); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::FlingData_UnserializedMessageContext<UserType, FlingData::DataView>>(0, 0, std::move(input)), MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const std::vector<uint8_t>& input, UserType* output)
    {
        return FlingData::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, FlingData::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, FlingData::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, FlingData::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static TapDataPtr New(Args&&... args) { return TapDataPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static TapDataPtr From(const U& u) { return mojo::TypeConverter<TapDataPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, TapData>::Convert(*this); }
    TapData()
        : tap_count()
        , needs_wheel_event()
    {
    ...
    template <typename T, TapData::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    size_t Hash(size_t seed) const;
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input) { return mojo::internal::SerializeImpl<TapData::DataView, std::vector<uint8_t>>(input); }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<TapData::DataView>(input); }
    ...
    template <typename UserType> static mojo::Message WrapAsMessage(UserType input)
    {
        return mojo::Message(std::make_unique<internal::TapData_UnserializedMessageContext<UserType, TapData::DataView>>(0, 0, std::move(input)), MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const std::vector<uint8_t>& input, UserType* output)
    {
        return TapData::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, TapData::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, TapData::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, TapData::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static TouchActionOptionalPtr New(Args&&... args) { return TouchActionOptionalPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static TouchActionOptionalPtr From(const U& u) { return mojo::TypeConverter<TouchActionOptionalPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, TouchActionOptional>::Convert(*this); }
    TouchActionOptional()
        : touch_action()
    {
    }
    ...
    template <typename T, TouchActionOptional::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<TouchActionOptional::DataView, std::vector<uint8_t>>(input);
    }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<TouchActionOptional::DataView>(input); }
    ...
    template <typename UserType> static mojo::Message WrapAsMessage(UserType input)
    {
        return mojo::Message(std::make_unique<internal::TouchActionOptional_UnserializedMessageContext<UserType, TouchActionOptional::DataView>>(0, 0, std::move(input)),
    ...
    template <typename UserType> static bool Deserialize(const std::vector<uint8_t>& input, UserType* output)
    {
        return TouchActionOptional::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, TouchActionOptional::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, TouchActionOptional::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, TouchActionOptional::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static EditCommandPtr New(Args&&... args) { return EditCommandPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static EditCommandPtr From(const U& u) { return mojo::TypeConverter<EditCommandPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, EditCommand>::Convert(*this); }
    EditCommand()
        : name()
        , value()
    {
    ...
    template <typename T, EditCommand::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    size_t Hash(size_t seed) const;
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
    ...
    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<EditCommand::DataView>(input); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::EditCommand_UnserializedMessageContext<UserType, EditCommand::DataView>>(0, 0, std::move(input)), MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const std::vector<uint8_t>& input, UserType* output)
    {
        return EditCommand::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, EditCommand::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, EditCommand::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, EditCommand::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static SelectAroundCaretResultPtr New(Args&&... args) { return SelectAroundCaretResultPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static SelectAroundCaretResultPtr From(const U& u) { return mojo::TypeConverter<SelectAroundCaretResultPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, SelectAroundCaretResult>::Convert(*this); }
    ...
    SelectAroundCaretResult(int32_t extended_start_adjust_in, int32_t extended_end_adjust_in, int32_t word_start_adjust_in, int32_t word_end_adjust_in)
    ...
    template <typename T, SelectAroundCaretResult::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    size_t Hash(size_t seed) const;
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
    ...
    template <typename UserType> static mojo::Message WrapAsMessage(UserType input)
    {
        return mojo::Message(std::make_unique<internal::SelectAroundCaretResult_UnserializedMessageContext<UserType, SelectAroundCaretResult::DataView>>(0, 0, std::move(input)),
            MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const std::vector<uint8_t>& input, UserType* output)
    {
        return SelectAroundCaretResult::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }

    template <typename UserType> static bool DeserializeFromMessage(mojo::Message input, UserType* output)
    {
        auto context = input.TakeUnserializedContext<internal::SelectAroundCaretResult_UnserializedMessageContext<UserType, SelectAroundCaretResult::DataView>>();
        if (context) {
            *output = std::move(context->TakeData());
            return true;
        }
...
template <typename T, SelectAroundCaretResult::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, SelectAroundCaretResult::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, SelectAroundCaretResult::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static KeyDataPtr New(Args&&... args) { return KeyDataPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static KeyDataPtr From(const U& u) { return mojo::TypeConverter<KeyDataPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, KeyData>::Convert(*this); }
    KeyData()
        : dom_key()
        , dom_code()
        , windows_key_code()
    ...
    KeyData(int32_t dom_key_in, int32_t dom_code_in, int32_t windows_key_code_in, int32_t native_key_code_in, bool is_system_key_in, bool is_browser_shortcut_in,
        const ::std::u16string& text_in, const ::std::u16string& unmodified_text_in)
    ...
    template <typename T, KeyData::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input) { return mojo::internal::SerializeImpl<KeyData::DataView, std::vector<uint8_t>>(input); }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<KeyData::DataView>(input); }
    ...
    template <typename UserType> static mojo::Message WrapAsMessage(UserType input)
    {
        return mojo::Message(std::make_unique<internal::KeyData_UnserializedMessageContext<UserType, KeyData::DataView>>(0, 0, std::move(input)), MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const std::vector<uint8_t>& input, UserType* output)
    {
        return KeyData::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, KeyData::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, KeyData::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, KeyData::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static PointerDataPtr New(Args&&... args) { return PointerDataPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static PointerDataPtr From(const U& u) { return mojo::TypeConverter<PointerDataPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, PointerData>::Convert(*this); }
    PointerData()
        : pointer_id()
        , force()
        , tilt_x()
    ...
    PointerData(int32_t pointer_id_in, float force_in, int32_t tilt_x_in, int32_t tilt_y_in, float tangential_pressure_in, int32_t twist_in, ::blink::mojom::Button button_in,
        ::ui::EventPointerType pointer_type_in, int32_t movement_x_in, int32_t movement_y_in, bool is_raw_movement_event_in, const ::gfx::PointF& widget_position_in,
        const ::gfx::PointF& screen_position_in, MouseDataPtr mouse_data_in)
    ...
    template <typename T, PointerData::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<PointerData::DataView, std::vector<uint8_t>>(input);
    }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<PointerData::DataView>(input); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::PointerData_UnserializedMessageContext<UserType, PointerData::DataView>>(0, 0, std::move(input)), MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const std::vector<uint8_t>& input, UserType* output)
    {
        return PointerData::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, PointerData::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, PointerData::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, PointerData::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static WheelDataPtr New(Args&&... args) { return WheelDataPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static WheelDataPtr From(const U& u) { return mojo::TypeConverter<WheelDataPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, WheelData>::Convert(*this); }
    WheelData()
        : delta_x()
        , delta_y()
        , wheel_ticks_x()
    ...
    WheelData(float delta_x_in, float delta_y_in, float wheel_ticks_x_in, float wheel_ticks_y_in, float acceleration_ratio_x_in, float acceleration_ratio_y_in, uint8_t phase_in,
        uint8_t momentum_phase_in, ::blink::mojom::DispatchType cancelable_in, uint8_t event_action_in, uint8_t delta_units_in)
    ...
    template <typename T, WheelData::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    size_t Hash(size_t seed) const;
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input) { return mojo::internal::SerializeImpl<WheelData::DataView, std::vector<uint8_t>>(input); }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<WheelData::DataView>(input); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::WheelData_UnserializedMessageContext<UserType, WheelData::DataView>>(0, 0, std::move(input)), MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const std::vector<uint8_t>& input, UserType* output)
    {
        return WheelData::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, WheelData::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, WheelData::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, WheelData::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static MouseDataPtr New(Args&&... args) { return MouseDataPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static MouseDataPtr From(const U& u) { return mojo::TypeConverter<MouseDataPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, MouseData>::Convert(*this); }
    MouseData()
        : click_count()
        , wheel_data()
    {
    ...
    template <typename T, MouseData::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input) { return mojo::internal::SerializeImpl<MouseData::DataView, std::vector<uint8_t>>(input); }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<MouseData::DataView>(input); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::MouseData_UnserializedMessageContext<UserType, MouseData::DataView>>(0, 0, std::move(input)), MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const std::vector<uint8_t>& input, UserType* output)
    {
        return MouseData::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, MouseData::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, MouseData::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, MouseData::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static ScrollDataPtr New(Args&&... args) { return ScrollDataPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static ScrollDataPtr From(const U& u) { return mojo::TypeConverter<ScrollDataPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, ScrollData>::Convert(*this); }
    ScrollData()
        : delta_x()
        , delta_y()
        , delta_units()
    ...
    ScrollData(float delta_x_in, float delta_y_in, ::ui::ScrollGranularity delta_units_in, bool target_viewport_in, ::blink::mojom::InertialPhaseState inertial_phase_in,
        bool synthetic_in, int32_t pointer_count_in, bool cursor_control_in, ScrollUpdatePtr update_details_in)
        : delta_x(std::move(delta_x_in))
        , delta_y(std::move(delta_y_in))
        , delta_units(std::move(delta_units_in))
        , target_viewport(std::move(target_viewport_in))
    ...
    template <typename T, ScrollData::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input) { return mojo::internal::SerializeImpl<ScrollData::DataView, std::vector<uint8_t>>(input); }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<ScrollData::DataView>(input); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::ScrollData_UnserializedMessageContext<UserType, ScrollData::DataView>>(0, 0, std::move(input)), MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const std::vector<uint8_t>& input, UserType* output)
    {
        return ScrollData::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, ScrollData::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, ScrollData::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, ScrollData::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static GestureDataPtr New(Args&&... args) { return GestureDataPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static GestureDataPtr From(const U& u) { return mojo::TypeConverter<GestureDataPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, GestureData>::Convert(*this); }
    GestureData()
        : screen_position()
        , widget_position()
        , source_device()
    ...
    GestureData(const ::gfx::PointF& screen_position_in, const ::gfx::PointF& widget_position_in, ::blink::mojom::GestureDevice source_device_in,
        bool is_source_touch_event_set_blocking_in, ::ui::EventPointerType primary_pointer_type_in, int32_t primary_unique_touch_event_id_in, int32_t unique_touch_event_id_in,
        const absl::optional<::gfx::Size>& contact_size_in, ScrollDataPtr scroll_data_in, PinchBeginDataPtr pinch_begin_data_in, PinchUpdateDataPtr pinch_update_data_in,
        PinchEndDataPtr pinch_end_data_in, TapDataPtr tap_data_in, FlingDataPtr fling_data_in)
        : screen_position(std::move(screen_position_in))
        , widget_position(std::move(widget_position_in))
    ...
    template <typename T, GestureData::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<GestureData::DataView, std::vector<uint8_t>>(input);
    }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<GestureData::DataView>(input); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::GestureData_UnserializedMessageContext<UserType, GestureData::DataView>>(0, 0, std::move(input)), MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const std::vector<uint8_t>& input, UserType* output)
    {
        return GestureData::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, GestureData::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, GestureData::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, GestureData::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static TouchPointPtr New(Args&&... args) { return TouchPointPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static TouchPointPtr From(const U& u) { return mojo::TypeConverter<TouchPointPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, TouchPoint>::Convert(*this); }
    TouchPoint()
        : state()
        , radius_x()
        , radius_y()
    ...
    template <typename T, TouchPoint::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input) { return mojo::internal::SerializeImpl<TouchPoint::DataView, std::vector<uint8_t>>(input); }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<TouchPoint::DataView>(input); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::TouchPoint_UnserializedMessageContext<UserType, TouchPoint::DataView>>(0, 0, std::move(input)), MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const std::vector<uint8_t>& input, UserType* output)
    {
        return TouchPoint::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, TouchPoint::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, TouchPoint::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, TouchPoint::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static TouchDataPtr New(Args&&... args) { return TouchDataPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static TouchDataPtr From(const U& u) { return mojo::TypeConverter<TouchDataPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, TouchData>::Convert(*this); }
    TouchData()
        : cancelable()
    ...
    TouchData(::blink::mojom::DispatchType cancelable_in, bool moved_beyond_slop_region_in, bool touch_start_or_first_move_in, bool hovering_in, uint32_t unique_touch_event_id_in,
    ...
    template <typename T, TouchData::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input) { return mojo::internal::SerializeImpl<TouchData::DataView, std::vector<uint8_t>>(input); }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<TouchData::DataView>(input); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::TouchData_UnserializedMessageContext<UserType, TouchData::DataView>>(0, 0, std::move(input)), MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const std::vector<uint8_t>& input, UserType* output)
    {
        return TouchData::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, TouchData::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, TouchData::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, TouchData::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static EventPtr New(Args&&... args) { return EventPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static EventPtr From(const U& u) { return mojo::TypeConverter<EventPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, Event>::Convert(*this); }
    Event()
        : type()
        , modifiers()
        , timestamp()
    ...
    Event(::blink::mojom::EventType type_in, int32_t modifiers_in, ::base::TimeTicks timestamp_in, const ::ui::LatencyInfo& latency_in, KeyDataPtr key_data_in,
        PointerDataPtr pointer_data_in, GestureDataPtr gesture_data_in, TouchDataPtr touch_data_in)
    ...
    template <typename T, Event::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input) { return mojo::internal::SerializeImpl<Event::DataView, std::vector<uint8_t>>(input); }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<Event::DataView>(input); }
    ...
    template <typename UserType> static mojo::Message WrapAsMessage(UserType input)
    {
        return mojo::Message(std::make_unique<internal::Event_UnserializedMessageContext<UserType, Event::DataView>>(0, 0, std::move(input)), MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const std::vector<uint8_t>& input, UserType* output)
    {
        return Event::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, Event::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, Event::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, Event::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static DidOverscrollParamsPtr New(Args&&... args) { return DidOverscrollParamsPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static DidOverscrollParamsPtr From(const U& u) { return mojo::TypeConverter<DidOverscrollParamsPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, DidOverscrollParams>::Convert(*this); }
    DidOverscrollParams()
    ...
    DidOverscrollParams(const ::gfx::Vector2dF& accumulated_overscroll_in, const ::gfx::Vector2dF& latest_overscroll_delta_in, const ::gfx::Vector2dF& current_fling_velocity_in,
        const ::gfx::PointF& causal_event_viewport_point_in, const ::cc::OverscrollBehavior& overscroll_behavior_in)
    ...
    template <typename T, DidOverscrollParams::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<DidOverscrollParams::DataView, std::vector<uint8_t>>(input);
    }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<DidOverscrollParams::DataView>(input); }
    ...
    template <typename UserType> static mojo::Message WrapAsMessage(UserType input)
    {
        return mojo::Message(std::make_unique<internal::DidOverscrollParams_UnserializedMessageContext<UserType, DidOverscrollParams::DataView>>(0, 0, std::move(input)),
            MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const std::vector<uint8_t>& input, UserType* output)
    {
        return DidOverscrollParams::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, DidOverscrollParams::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, DidOverscrollParams::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, DidOverscrollParams::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
class BLINK_COMMON_EXPORT ScrollResultData {
public:
    template <typename T> using EnableIfSame = std::enable_if_t<std::is_same<ScrollResultData, T>::value>;
    using DataView = ScrollResultDataDataView;
    using Data_ = internal::ScrollResultData_Data;

    template <typename... Args> static ScrollResultDataPtr New(Args&&... args) { return ScrollResultDataPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static ScrollResultDataPtr From(const U& u) { return mojo::TypeConverter<ScrollResultDataPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, ScrollResultData>::Convert(*this); }
    ScrollResultData()
        : root_scroll_offset()
    {
    }

    explicit ScrollResultData(const absl::optional<::gfx::PointF>& root_scroll_offset_in)
        : root_scroll_offset(std::move(root_scroll_offset_in)) {};
    ~ScrollResultData() = default;

    // Clone() is a template so it is only instantiated if it is used. Thus, the
    // bindings generator does not need to know whether Clone() or copy
    // constructor/assignment are available for members.
    template <typename StructPtrType = ScrollResultDataPtr> ScrollResultDataPtr Clone() const;

    // Equals() is a template so it is only instantiated if it is used. Thus, the
    // bindings generator does not need to know whether Equals() or == operator
    // are available for members.
    template <typename T, ScrollResultData::EnableIfSame<T>* = nullptr> bool Equals(const T& other) const;

    template <typename T, ScrollResultData::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<ScrollResultData::DataView, std::vector<uint8_t>>(input);
    }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<ScrollResultData::DataView>(input); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::ScrollResultData_UnserializedMessageContext<UserType, ScrollResultData::DataView>>(0, 0, std::move(input)), MOJO_CREATE_MESSAGE_FLAG_NONE);
    }

    template <typename UserType> static bool Deserialize(const void* data, size_t data_num_bytes, UserType* output)
    {
        mojo::Message message;
        return mojo::internal::DeserializeImpl<ScrollResultData::DataView>(message, data, data_num_bytes, output, Validate);
    }

    template <typename UserType> static bool Deserialize(const std::vector<uint8_t>& input, UserType* output)
    {
        return ScrollResultData::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }

    template <typename UserType> static bool DeserializeFromMessage(mojo::Message input, UserType* output)
    {
        auto context = input.TakeUnserializedContext<internal::ScrollResultData_UnserializedMessageContext<UserType, ScrollResultData::DataView>>();
        if (context) {
            *output = std::move(context->TakeData());
            return true;
        }
        input.SerializeIfNecessary();
        return mojo::internal::DeserializeImpl<ScrollResultData::DataView>(input, input.payload(), input.payload_num_bytes(), output, Validate);
    }
...
// are used. Thus, the bindings generator does not need to know whether
// comparison operators are available for members.
template <typename T, ScrollResultData::EnableIfSame<T>* = nullptr> bool operator<(const T& lhs, const T& rhs);

template <typename T, ScrollResultData::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, ScrollResultData::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, ScrollResultData::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
{
    return New(mojo::Clone(pointer_id), mojo::Clone(force), mojo::Clone(tilt_x), mojo::Clone(tilt_y), mojo::Clone(tangential_pressure), mojo::Clone(twist), mojo::Clone(button),
        mojo::Clone(pointer_type), mojo::Clone(movement_x), mojo::Clone(movement_y), mojo::Clone(is_raw_movement_event), mojo::Clone(widget_position), mojo::Clone(screen_position),
...
template <typename StructPtrType> WheelDataPtr WheelData::Clone() const
{
    return New(mojo::Clone(delta_x), mojo::Clone(delta_y), mojo::Clone(wheel_ticks_x), mojo::Clone(wheel_ticks_y), mojo::Clone(acceleration_ratio_x),
        mojo::Clone(acceleration_ratio_y), mojo::Clone(phase), mojo::Clone(momentum_phase), mojo::Clone(cancelable), mojo::Clone(event_action), mojo::Clone(delta_units));
}
...
template <typename StructPtrType> MouseDataPtr MouseData::Clone() const { return New(mojo::Clone(click_count), mojo::Clone(wheel_data)); }
...
template <typename StructPtrType> ScrollUpdatePtr ScrollUpdate::Clone() const { return New(mojo::Clone(velocity_x), mojo::Clone(velocity_y)); }

template <typename T, ScrollUpdate::EnableIfSame<T>*> bool ScrollUpdate::Equals(const T& other_struct) const
{
...
template <typename T, ScrollUpdate::EnableIfSame<T>*> bool operator<(const T& lhs, const T& rhs)
{
...
{
    return New(mojo::Clone(delta_x), mojo::Clone(delta_y), mojo::Clone(delta_units), mojo::Clone(target_viewport), mojo::Clone(inertial_phase), mojo::Clone(synthetic),
        mojo::Clone(pointer_count), mojo::Clone(cursor_control), mojo::Clone(update_details));
}
...
template <typename StructPtrType> PinchBeginDataPtr PinchBeginData::Clone() const { return New(mojo::Clone(needs_wheel_event)); }
...
template <typename StructPtrType> PinchUpdateDataPtr PinchUpdateData::Clone() const { return New(mojo::Clone(scale), mojo::Clone(zoom_disabled), mojo::Clone(needs_wheel_event)); }
...
template <typename StructPtrType> PinchEndDataPtr PinchEndData::Clone() const { return New(mojo::Clone(needs_wheel_event)); }
...
template <typename StructPtrType> TapDataPtr TapData::Clone() const { return New(mojo::Clone(tap_count), mojo::Clone(needs_wheel_event)); }
...
template <typename StructPtrType> GestureDataPtr GestureData::Clone() const
{
    return New(mojo::Clone(screen_position), mojo::Clone(widget_position), mojo::Clone(source_device), mojo::Clone(is_source_touch_event_set_blocking),
        mojo::Clone(primary_pointer_type), mojo::Clone(primary_unique_touch_event_id), mojo::Clone(unique_touch_event_id), mojo::Clone(contact_size), mojo::Clone(scroll_data),
        mojo::Clone(pinch_begin_data), mojo::Clone(pinch_update_data), mojo::Clone(pinch_end_data), mojo::Clone(tap_data), mojo::Clone(fling_data));
}
...
{
    return New(mojo::Clone(cancelable), mojo::Clone(moved_beyond_slop_region), mojo::Clone(touch_start_or_first_move), mojo::Clone(hovering), mojo::Clone(unique_touch_event_id),
        mojo::Clone(touches));
}
...
{
    return New(mojo::Clone(type), mojo::Clone(modifiers), mojo::Clone(timestamp), mojo::Clone(latency), mojo::Clone(key_data), mojo::Clone(pointer_data), mojo::Clone(gesture_data),
...
{
    return New(mojo::Clone(accumulated_overscroll), mojo::Clone(latest_overscroll_delta), mojo::Clone(current_fling_velocity), mojo::Clone(causal_event_viewport_point),
...
template <typename StructPtrType> TouchActionOptionalPtr TouchActionOptional::Clone() const { return New(mojo::Clone(touch_action)); }
...
template <typename StructPtrType> EditCommandPtr EditCommand::Clone() const { return New(mojo::Clone(name), mojo::Clone(value)); }
...
template <typename StructPtrType> ScrollResultDataPtr ScrollResultData::Clone() const { return New(mojo::Clone(root_scroll_offset)); }

template <typename T, ScrollResultData::EnableIfSame<T>*> bool ScrollResultData::Equals(const T& other_struct) const
{
...
template <typename T, ScrollResultData::EnableIfSame<T>*> bool operator<(const T& lhs, const T& rhs)
{
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::KeyData::DataView, ::blink::mojom::KeyDataPtr> {
    ...
    static decltype(::blink::mojom::KeyData::dom_key) dom_key(const ::blink::mojom::KeyDataPtr& input) { return input->dom_key; }

    static decltype(::blink::mojom::KeyData::dom_code) dom_code(const ::blink::mojom::KeyDataPtr& input) { return input->dom_code; }

    static decltype(::blink::mojom::KeyData::windows_key_code) windows_key_code(const ::blink::mojom::KeyDataPtr& input) { return input->windows_key_code; }

    static decltype(::blink::mojom::KeyData::native_key_code) native_key_code(const ::blink::mojom::KeyDataPtr& input) { return input->native_key_code; }

    static decltype(::blink::mojom::KeyData::is_system_key) is_system_key(const ::blink::mojom::KeyDataPtr& input) { return input->is_system_key; }

    static decltype(::blink::mojom::KeyData::is_browser_shortcut) is_browser_shortcut(const ::blink::mojom::KeyDataPtr& input) { return input->is_browser_shortcut; }

    static const decltype(::blink::mojom::KeyData::text)& text(const ::blink::mojom::KeyDataPtr& input) { return input->text; }

    static const decltype(::blink::mojom::KeyData::unmodified_text)& unmodified_text(const ::blink::mojom::KeyDataPtr& input) { return input->unmodified_text; }
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::PointerData::DataView, ::blink::mojom::PointerDataPtr> {
    ...
    static decltype(::blink::mojom::PointerData::pointer_id) pointer_id(const ::blink::mojom::PointerDataPtr& input) { return input->pointer_id; }

    static decltype(::blink::mojom::PointerData::force) force(const ::blink::mojom::PointerDataPtr& input) { return input->force; }

    static decltype(::blink::mojom::PointerData::tilt_x) tilt_x(const ::blink::mojom::PointerDataPtr& input) { return input->tilt_x; }

    static decltype(::blink::mojom::PointerData::tilt_y) tilt_y(const ::blink::mojom::PointerDataPtr& input) { return input->tilt_y; }

    static decltype(::blink::mojom::PointerData::tangential_pressure) tangential_pressure(const ::blink::mojom::PointerDataPtr& input) { return input->tangential_pressure; }

    static decltype(::blink::mojom::PointerData::twist) twist(const ::blink::mojom::PointerDataPtr& input) { return input->twist; }

    static decltype(::blink::mojom::PointerData::button) button(const ::blink::mojom::PointerDataPtr& input) { return input->button; }

    static decltype(::blink::mojom::PointerData::pointer_type) pointer_type(const ::blink::mojom::PointerDataPtr& input) { return input->pointer_type; }

    static decltype(::blink::mojom::PointerData::movement_x) movement_x(const ::blink::mojom::PointerDataPtr& input) { return input->movement_x; }

    static decltype(::blink::mojom::PointerData::movement_y) movement_y(const ::blink::mojom::PointerDataPtr& input) { return input->movement_y; }

    static decltype(::blink::mojom::PointerData::is_raw_movement_event) is_raw_movement_event(const ::blink::mojom::PointerDataPtr& input) { return input->is_raw_movement_event; }

    static const decltype(::blink::mojom::PointerData::widget_position)& widget_position(const ::blink::mojom::PointerDataPtr& input) { return input->widget_position; }

    static const decltype(::blink::mojom::PointerData::screen_position)& screen_position(const ::blink::mojom::PointerDataPtr& input) { return input->screen_position; }

    static const decltype(::blink::mojom::PointerData::mouse_data)& mouse_data(const ::blink::mojom::PointerDataPtr& input) { return input->mouse_data; }
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::WheelData::DataView, ::blink::mojom::WheelDataPtr> {
    ...
    static decltype(::blink::mojom::WheelData::delta_x) delta_x(const ::blink::mojom::WheelDataPtr& input) { return input->delta_x; }

    static decltype(::blink::mojom::WheelData::delta_y) delta_y(const ::blink::mojom::WheelDataPtr& input) { return input->delta_y; }

    static decltype(::blink::mojom::WheelData::wheel_ticks_x) wheel_ticks_x(const ::blink::mojom::WheelDataPtr& input) { return input->wheel_ticks_x; }

    static decltype(::blink::mojom::WheelData::wheel_ticks_y) wheel_ticks_y(const ::blink::mojom::WheelDataPtr& input) { return input->wheel_ticks_y; }

    static decltype(::blink::mojom::WheelData::acceleration_ratio_x) acceleration_ratio_x(const ::blink::mojom::WheelDataPtr& input) { return input->acceleration_ratio_x; }

    static decltype(::blink::mojom::WheelData::acceleration_ratio_y) acceleration_ratio_y(const ::blink::mojom::WheelDataPtr& input) { return input->acceleration_ratio_y; }

    static decltype(::blink::mojom::WheelData::phase) phase(const ::blink::mojom::WheelDataPtr& input) { return input->phase; }

    static decltype(::blink::mojom::WheelData::momentum_phase) momentum_phase(const ::blink::mojom::WheelDataPtr& input) { return input->momentum_phase; }

    static decltype(::blink::mojom::WheelData::cancelable) cancelable(const ::blink::mojom::WheelDataPtr& input) { return input->cancelable; }

    static decltype(::blink::mojom::WheelData::event_action) event_action(const ::blink::mojom::WheelDataPtr& input) { return input->event_action; }

    static decltype(::blink::mojom::WheelData::delta_units) delta_units(const ::blink::mojom::WheelDataPtr& input) { return input->delta_units; }
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::MouseData::DataView, ::blink::mojom::MouseDataPtr> {
    ...
    static decltype(::blink::mojom::MouseData::click_count) click_count(const ::blink::mojom::MouseDataPtr& input) { return input->click_count; }

    static const decltype(::blink::mojom::MouseData::wheel_data)& wheel_data(const ::blink::mojom::MouseDataPtr& input) { return input->wheel_data; }

    static bool Read(::blink::mojom::MouseData::DataView input, ::blink::mojom::MouseDataPtr* output);
};
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::ScrollUpdate::DataView, ::blink::mojom::ScrollUpdatePtr> {
    static bool IsNull(const ::blink::mojom::ScrollUpdatePtr& input) { return !input; }
    static void SetToNull(::blink::mojom::ScrollUpdatePtr* output) { output->reset(); }

    static decltype(::blink::mojom::ScrollUpdate::velocity_x) velocity_x(const ::blink::mojom::ScrollUpdatePtr& input) { return input->velocity_x; }

    static decltype(::blink::mojom::ScrollUpdate::velocity_y) velocity_y(const ::blink::mojom::ScrollUpdatePtr& input) { return input->velocity_y; }

    static bool Read(::blink::mojom::ScrollUpdate::DataView input, ::blink::mojom::ScrollUpdatePtr* output);
};
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::ScrollData::DataView, ::blink::mojom::ScrollDataPtr> {
    ...
    static decltype(::blink::mojom::ScrollData::delta_x) delta_x(const ::blink::mojom::ScrollDataPtr& input) { return input->delta_x; }

    static decltype(::blink::mojom::ScrollData::delta_y) delta_y(const ::blink::mojom::ScrollDataPtr& input) { return input->delta_y; }

    static decltype(::blink::mojom::ScrollData::delta_units) delta_units(const ::blink::mojom::ScrollDataPtr& input) { return input->delta_units; }

    static decltype(::blink::mojom::ScrollData::target_viewport) target_viewport(const ::blink::mojom::ScrollDataPtr& input) { return input->target_viewport; }

    static decltype(::blink::mojom::ScrollData::inertial_phase) inertial_phase(const ::blink::mojom::ScrollDataPtr& input) { return input->inertial_phase; }

    static decltype(::blink::mojom::ScrollData::synthetic) synthetic(const ::blink::mojom::ScrollDataPtr& input) { return input->synthetic; }

    static decltype(::blink::mojom::ScrollData::pointer_count) pointer_count(const ::blink::mojom::ScrollDataPtr& input) { return input->pointer_count; }

    static decltype(::blink::mojom::ScrollData::cursor_control) cursor_control(const ::blink::mojom::ScrollDataPtr& input) { return input->cursor_control; }

    static const decltype(::blink::mojom::ScrollData::update_details)& update_details(const ::blink::mojom::ScrollDataPtr& input) { return input->update_details; }
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::PinchBeginData::DataView, ::blink::mojom::PinchBeginDataPtr> {
    ...
    static decltype(::blink::mojom::PinchBeginData::needs_wheel_event) needs_wheel_event(const ::blink::mojom::PinchBeginDataPtr& input) { return input->needs_wheel_event; }
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::PinchUpdateData::DataView, ::blink::mojom::PinchUpdateDataPtr> {
    ...
    static decltype(::blink::mojom::PinchUpdateData::scale) scale(const ::blink::mojom::PinchUpdateDataPtr& input) { return input->scale; }

    static decltype(::blink::mojom::PinchUpdateData::zoom_disabled) zoom_disabled(const ::blink::mojom::PinchUpdateDataPtr& input) { return input->zoom_disabled; }

    static decltype(::blink::mojom::PinchUpdateData::needs_wheel_event) needs_wheel_event(const ::blink::mojom::PinchUpdateDataPtr& input) { return input->needs_wheel_event; }
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::PinchEndData::DataView, ::blink::mojom::PinchEndDataPtr> {
    ...
    static decltype(::blink::mojom::PinchEndData::needs_wheel_event) needs_wheel_event(const ::blink::mojom::PinchEndDataPtr& input) { return input->needs_wheel_event; }
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::FlingData::DataView, ::blink::mojom::FlingDataPtr> {
    ...
    static decltype(::blink::mojom::FlingData::velocity_x) velocity_x(const ::blink::mojom::FlingDataPtr& input) { return input->velocity_x; }

    static decltype(::blink::mojom::FlingData::velocity_y) velocity_y(const ::blink::mojom::FlingDataPtr& input) { return input->velocity_y; }

    static decltype(::blink::mojom::FlingData::target_viewport) target_viewport(const ::blink::mojom::FlingDataPtr& input) { return input->target_viewport; }

    static decltype(::blink::mojom::FlingData::prevent_boosting) prevent_boosting(const ::blink::mojom::FlingDataPtr& input) { return input->prevent_boosting; }
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::TapData::DataView, ::blink::mojom::TapDataPtr> {
    ...
    static decltype(::blink::mojom::TapData::tap_count) tap_count(const ::blink::mojom::TapDataPtr& input) { return input->tap_count; }

    static decltype(::blink::mojom::TapData::needs_wheel_event) needs_wheel_event(const ::blink::mojom::TapDataPtr& input) { return input->needs_wheel_event; }
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::GestureData::DataView, ::blink::mojom::GestureDataPtr> {
    ...
    static const decltype(::blink::mojom::GestureData::screen_position)& screen_position(const ::blink::mojom::GestureDataPtr& input) { return input->screen_position; }

    static const decltype(::blink::mojom::GestureData::widget_position)& widget_position(const ::blink::mojom::GestureDataPtr& input) { return input->widget_position; }

    static decltype(::blink::mojom::GestureData::source_device) source_device(const ::blink::mojom::GestureDataPtr& input) { return input->source_device; }

    static decltype(::blink::mojom::GestureData::is_source_touch_event_set_blocking) is_source_touch_event_set_blocking(const ::blink::mojom::GestureDataPtr& input)
    {
        return input->is_source_touch_event_set_blocking;
    }

    static decltype(::blink::mojom::GestureData::primary_pointer_type) primary_pointer_type(const ::blink::mojom::GestureDataPtr& input) { return input->primary_pointer_type; }
    ...
    static decltype(::blink::mojom::GestureData::unique_touch_event_id) unique_touch_event_id(const ::blink::mojom::GestureDataPtr& input) { return input->unique_touch_event_id; }

    static const decltype(::blink::mojom::GestureData::contact_size)& contact_size(const ::blink::mojom::GestureDataPtr& input) { return input->contact_size; }

    static const decltype(::blink::mojom::GestureData::scroll_data)& scroll_data(const ::blink::mojom::GestureDataPtr& input) { return input->scroll_data; }

    static const decltype(::blink::mojom::GestureData::pinch_begin_data)& pinch_begin_data(const ::blink::mojom::GestureDataPtr& input) { return input->pinch_begin_data; }

    static const decltype(::blink::mojom::GestureData::pinch_update_data)& pinch_update_data(const ::blink::mojom::GestureDataPtr& input) { return input->pinch_update_data; }

    static const decltype(::blink::mojom::GestureData::pinch_end_data)& pinch_end_data(const ::blink::mojom::GestureDataPtr& input) { return input->pinch_end_data; }

    static const decltype(::blink::mojom::GestureData::tap_data)& tap_data(const ::blink::mojom::GestureDataPtr& input) { return input->tap_data; }

    static const decltype(::blink::mojom::GestureData::fling_data)& fling_data(const ::blink::mojom::GestureDataPtr& input) { return input->fling_data; }
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::TouchPoint::DataView, ::blink::mojom::TouchPointPtr> {
    ...
    static decltype(::blink::mojom::TouchPoint::state) state(const ::blink::mojom::TouchPointPtr& input) { return input->state; }

    static decltype(::blink::mojom::TouchPoint::radius_x) radius_x(const ::blink::mojom::TouchPointPtr& input) { return input->radius_x; }

    static decltype(::blink::mojom::TouchPoint::radius_y) radius_y(const ::blink::mojom::TouchPointPtr& input) { return input->radius_y; }

    static decltype(::blink::mojom::TouchPoint::rotation_angle) rotation_angle(const ::blink::mojom::TouchPointPtr& input) { return input->rotation_angle; }

    static const decltype(::blink::mojom::TouchPoint::pointer_data)& pointer_data(const ::blink::mojom::TouchPointPtr& input) { return input->pointer_data; }
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::TouchData::DataView, ::blink::mojom::TouchDataPtr> {
    ...
    static decltype(::blink::mojom::TouchData::cancelable) cancelable(const ::blink::mojom::TouchDataPtr& input) { return input->cancelable; }
    ...
    static decltype(::blink::mojom::TouchData::hovering) hovering(const ::blink::mojom::TouchDataPtr& input) { return input->hovering; }

    static decltype(::blink::mojom::TouchData::unique_touch_event_id) unique_touch_event_id(const ::blink::mojom::TouchDataPtr& input) { return input->unique_touch_event_id; }

    static const decltype(::blink::mojom::TouchData::touches)& touches(const ::blink::mojom::TouchDataPtr& input) { return input->touches; }
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::Event::DataView, ::blink::mojom::EventPtr> {
    ...
    static decltype(::blink::mojom::Event::type) type(const ::blink::mojom::EventPtr& input) { return input->type; }

    static decltype(::blink::mojom::Event::modifiers) modifiers(const ::blink::mojom::EventPtr& input) { return input->modifiers; }

    static const decltype(::blink::mojom::Event::timestamp)& timestamp(const ::blink::mojom::EventPtr& input) { return input->timestamp; }

    static const decltype(::blink::mojom::Event::latency)& latency(const ::blink::mojom::EventPtr& input) { return input->latency; }

    static const decltype(::blink::mojom::Event::key_data)& key_data(const ::blink::mojom::EventPtr& input) { return input->key_data; }

    static const decltype(::blink::mojom::Event::pointer_data)& pointer_data(const ::blink::mojom::EventPtr& input) { return input->pointer_data; }

    static const decltype(::blink::mojom::Event::gesture_data)& gesture_data(const ::blink::mojom::EventPtr& input) { return input->gesture_data; }

    static const decltype(::blink::mojom::Event::touch_data)& touch_data(const ::blink::mojom::EventPtr& input) { return input->touch_data; }
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::DidOverscrollParams::DataView, ::blink::mojom::DidOverscrollParamsPtr> {
    ...
    static const decltype(::blink::mojom::DidOverscrollParams::accumulated_overscroll)& accumulated_overscroll(const ::blink::mojom::DidOverscrollParamsPtr& input)
    {
        return input->accumulated_overscroll;
    }

    static const decltype(::blink::mojom::DidOverscrollParams::latest_overscroll_delta)& latest_overscroll_delta(const ::blink::mojom::DidOverscrollParamsPtr& input)
    {
        return input->latest_overscroll_delta;
    }

    static const decltype(::blink::mojom::DidOverscrollParams::current_fling_velocity)& current_fling_velocity(const ::blink::mojom::DidOverscrollParamsPtr& input)
    {
        return input->current_fling_velocity;
    }

    static const decltype(::blink::mojom::DidOverscrollParams::causal_event_viewport_point)& causal_event_viewport_point(const ::blink::mojom::DidOverscrollParamsPtr& input)
    {
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::TouchActionOptional::DataView, ::blink::mojom::TouchActionOptionalPtr> {
    ...
    static decltype(::blink::mojom::TouchActionOptional::touch_action) touch_action(const ::blink::mojom::TouchActionOptionalPtr& input) { return input->touch_action; }
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::EditCommand::DataView, ::blink::mojom::EditCommandPtr> {
    ...
    static const decltype(::blink::mojom::EditCommand::name)& name(const ::blink::mojom::EditCommandPtr& input) { return input->name; }

    static const decltype(::blink::mojom::EditCommand::value)& value(const ::blink::mojom::EditCommandPtr& input) { return input->value; }
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::SelectAroundCaretResult::DataView, ::blink::mojom::SelectAroundCaretResultPtr> {
    ...
    static decltype(::blink::mojom::SelectAroundCaretResult::extended_start_adjust) extended_start_adjust(const ::blink::mojom::SelectAroundCaretResultPtr& input)
    {
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::ScrollResultData::DataView, ::blink::mojom::ScrollResultDataPtr> {
    static bool IsNull(const ::blink::mojom::ScrollResultDataPtr& input) { return !input; }
    static void SetToNull(::blink::mojom::ScrollResultDataPtr* output) { output->reset(); }

    static const decltype(::blink::mojom::ScrollResultData::root_scroll_offset)& root_scroll_offset(const ::blink::mojom::ScrollResultDataPtr& input)
    {
        return input->root_scroll_offset;
    }

    static bool Read(::blink::mojom::ScrollResultData::DataView input, ::blink::mojom::ScrollResultDataPtr* output);
};
