// third_party/blink/public/mojom/input/input_event.mojom-lite-for-compile.js is auto generated by mojom_bindings_generator.py, do not edit
...
goog.provide('blink.mojom.Button');
goog.provide('blink.mojom.ButtonSpec');
/**
...
goog.provide('blink.mojom.DispatchType');
goog.provide('blink.mojom.DispatchTypeSpec');
/**
 * @const { {$: !mojo.internal.MojomType} }
 * @export
 */
...
goog.provide('blink.mojom.EventType');
goog.provide('blink.mojom.EventTypeSpec');
/**
 * @const { {$: !mojo.internal.MojomType} }
 * @export
 */
