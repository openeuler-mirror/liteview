...
static_assert(sizeof(TextSuggestionHost_ShowSpellCheckSuggestionMenu_Params_Data) == 40, "Bad sizeof(TextSuggestionHost_ShowSpellCheckSuggestionMenu_Params_Data)");
...
public:
    ...
    TextSuggestionHost_ShowSpellCheckSuggestionMenu_ParamsDataView(internal::TextSuggestionHost_ShowSpellCheckSuggestionMenu_Params_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
    ...
    bool is_null() const { return !data_; }
    double caret_x() const { return data_->caret_x; }
    double caret_y() const { return data_->caret_y; }
