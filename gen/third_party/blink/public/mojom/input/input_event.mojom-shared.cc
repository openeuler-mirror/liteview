...
std::ostream& operator<<(std::ostream& os, Button value) { return os << ButtonToString(value); }
...
std::ostream& operator<<(std::ostream& os, DispatchType value) { return os << DispatchTypeToString(value); }
