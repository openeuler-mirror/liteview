...
static_assert(sizeof(TextSuggestionBackend_ApplySpellCheckSuggestion_Params_Data) == 16, "Bad sizeof(TextSuggestionBackend_ApplySpellCheckSuggestion_Params_Data)");
...
static_assert(sizeof(TextSuggestionBackend_DeleteActiveSuggestionRange_Params_Data) == 8, "Bad sizeof(TextSuggestionBackend_DeleteActiveSuggestionRange_Params_Data)");
...
static_assert(sizeof(TextSuggestionBackend_OnNewWordAddedToDictionary_Params_Data) == 16, "Bad sizeof(TextSuggestionBackend_OnNewWordAddedToDictionary_Params_Data)");
...
static_assert(sizeof(TextSuggestionBackend_SuggestionMenuTimeoutCallback_Params_Data) == 16, "Bad sizeof(TextSuggestionBackend_SuggestionMenuTimeoutCallback_Params_Data)");
...
public:
    ...
    TextSuggestionBackend_ApplySpellCheckSuggestion_ParamsDataView(internal::TextSuggestionBackend_ApplySpellCheckSuggestion_Params_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
...
public:
    ...
    bool is_null() const { return !data_; }
    int32_t marker_tag() const { return data_->marker_tag; }
    int32_t suggestion_index() const { return data_->suggestion_index; }
...
public:
    ...
    TextSuggestionBackend_DeleteActiveSuggestionRange_ParamsDataView(internal::TextSuggestionBackend_DeleteActiveSuggestionRange_Params_Data* data, mojo::Message* message)
        : data_(data)
    {
    }
...
public:
    ...
    TextSuggestionBackend_OnNewWordAddedToDictionary_ParamsDataView(internal::TextSuggestionBackend_OnNewWordAddedToDictionary_Params_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
...
public:
    ...
    TextSuggestionBackend_OnSuggestionMenuClosed_ParamsDataView(internal::TextSuggestionBackend_OnSuggestionMenuClosed_Params_Data* data, mojo::Message* message)
        : data_(data)
    {
    }
...
public:
    ...
    TextSuggestionBackend_SuggestionMenuTimeoutCallback_ParamsDataView(internal::TextSuggestionBackend_SuggestionMenuTimeoutCallback_Params_Data* data, mojo::Message* message)
        : data_(data)
    {
    }

    bool is_null() const { return !data_; }
    int32_t max_number_of_suggestions() const { return data_->max_number_of_suggestions; }
