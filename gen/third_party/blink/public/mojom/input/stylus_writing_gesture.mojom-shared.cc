...
static NOINLINE const char* StylusWritingGestureActionToStringHelper(StylusWritingGestureAction value)
{
...
std::ostream& operator<<(std::ostream& os, StylusWritingGestureAction value) { return os << StylusWritingGestureActionToString(value); }
...
bool StylusWritingGestureData_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    ...
    if (!mojo::internal::ValidatePointerNonNullable(object->start_point, 2, validation_context)) {
        return false;
    }
    if (!mojo::internal::ValidateStruct(object->start_point, validation_context))
        return false;

    if (!mojo::internal::ValidateStruct(object->end_point, validation_context))
        return false;

    if (!mojo::internal::ValidatePointerNonNullable(object->text_alternative, 4, validation_context)) {
        return false;
    }
...
// static
void TraceFormatTraits<::blink::mojom::StylusWritingGestureAction>::WriteIntoTrace(perfetto::TracedValue context, ::blink::mojom::StylusWritingGestureAction value)
{
