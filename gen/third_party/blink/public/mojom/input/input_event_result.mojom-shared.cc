...
std::ostream& operator<<(std::ostream& os, InputEventResultSource value) { return os << InputEventResultSourceToString(value); }
...
std::ostream& operator<<(std::ostream& os, InputEventResultState value) { return os << InputEventResultStateToString(value); }
