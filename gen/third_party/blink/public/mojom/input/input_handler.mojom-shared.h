...
template <> struct MojomTypeTraits<::blink::mojom::ScrollUpdateDataView> {
...
template <> struct MojomTypeTraits<::blink::mojom::ScrollResultDataDataView> {
...
inline bool IsKnownEnumValue(SelectionGranularity value) { return internal::SelectionGranularity_Data::IsKnownValue(static_cast<int32_t>(value)); }
...
inline bool IsKnownEnumValue(PanAction value) { return internal::PanAction_Data::IsKnownValue(static_cast<int32_t>(value)); }
...
inline bool IsKnownEnumValue(FocusState value) { return internal::FocusState_Data::IsKnownValue(static_cast<int32_t>(value)); }
...
public:
    ...
    int32_t dom_key() const { return data_->dom_key; }
    int32_t dom_code() const { return data_->dom_code; }
    int32_t windows_key_code() const { return data_->windows_key_code; }
    int32_t native_key_code() const { return data_->native_key_code; }
    bool is_system_key() const { return data_->is_system_key; }
    bool is_browser_shortcut() const { return data_->is_browser_shortcut; }
...
public:
    ...
    bool is_null() const { return !data_; }
    int32_t pointer_id() const { return data_->pointer_id; }
    float force() const { return data_->force; }
    int32_t tilt_x() const { return data_->tilt_x; }
    int32_t tilt_y() const { return data_->tilt_y; }
    float tangential_pressure() const { return data_->tangential_pressure; }
    int32_t twist() const { return data_->twist; }
    ...
    ::blink::mojom::Button button() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::blink::mojom::Button>(data_->button)); }
    ...
    ::ui::mojom::EventPointerType pointer_type() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::ui::mojom::EventPointerType>(data_->pointer_type)); }
    int32_t movement_x() const { return data_->movement_x; }
    int32_t movement_y() const { return data_->movement_y; }
    bool is_raw_movement_event() const { return data_->is_raw_movement_event; }
...
public:
    ...
    bool is_null() const { return !data_; }
    float delta_x() const { return data_->delta_x; }
    float delta_y() const { return data_->delta_y; }
    float wheel_ticks_x() const { return data_->wheel_ticks_x; }
    float wheel_ticks_y() const { return data_->wheel_ticks_y; }
    float acceleration_ratio_x() const { return data_->acceleration_ratio_x; }
    float acceleration_ratio_y() const { return data_->acceleration_ratio_y; }
    uint8_t phase() const { return data_->phase; }
    uint8_t momentum_phase() const { return data_->momentum_phase; }
    ...
    ::blink::mojom::DispatchType cancelable() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::blink::mojom::DispatchType>(data_->cancelable)); }
    uint8_t event_action() const { return data_->event_action; }
    uint8_t delta_units() const { return data_->delta_units; }
...
public:
    ...
    bool is_null() const { return !data_; }
    int32_t click_count() const { return data_->click_count; }
...
public:
    ...
    ScrollUpdateDataView(internal::ScrollUpdate_Data* data, mojo::Message* message)
        : data_(data)
    {
    }

    bool is_null() const { return !data_; }
    float velocity_x() const { return data_->velocity_x; }
    float velocity_y() const { return data_->velocity_y; }
...
public:
    ...
    ::ui::mojom::ScrollGranularity delta_units() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::ui::mojom::ScrollGranularity>(data_->delta_units)); }
    bool target_viewport() const { return data_->target_viewport; }
    ...
    bool synthetic() const { return data_->synthetic; }
    int32_t pointer_count() const { return data_->pointer_count; }
    bool cursor_control() const { return data_->cursor_control; }
    inline void GetUpdateDetailsDataView(ScrollUpdateDataView* output);

    template <typename UserType> [[nodiscard]] bool ReadUpdateDetails(UserType* output)
    {

        static_assert(mojo::internal::IsValidUserTypeForOptionalValue<::blink::mojom::ScrollUpdateDataView, UserType>(),
        ...
        return mojo::internal::Deserialize<::blink::mojom::ScrollUpdateDataView>(pointer, output, message_);
    }
...
public:
    ...
    bool is_null() const { return !data_; }
    bool needs_wheel_event() const { return data_->needs_wheel_event; }
...
public:
    ...
    bool zoom_disabled() const { return data_->zoom_disabled; }
    bool needs_wheel_event() const { return data_->needs_wheel_event; }
...
public:
    ...
    float velocity_y() const { return data_->velocity_y; }
    bool target_viewport() const { return data_->target_viewport; }
    bool prevent_boosting() const { return data_->prevent_boosting; }
...
public:
    ...
    bool is_null() const { return !data_; }
    int32_t tap_count() const { return data_->tap_count; }
    bool needs_wheel_event() const { return data_->needs_wheel_event; }
...
public:
    ...
    ::blink::mojom::GestureDevice source_device() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::blink::mojom::GestureDevice>(data_->source_device)); }
    bool is_source_touch_event_set_blocking() const { return data_->is_source_touch_event_set_blocking; }
    ...
    int32_t primary_unique_touch_event_id() const { return data_->primary_unique_touch_event_id; }
    int32_t unique_touch_event_id() const { return data_->unique_touch_event_id; }
...
public:
    ...
    ::blink::mojom::TouchState state() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::blink::mojom::TouchState>(data_->state)); }
    float radius_x() const { return data_->radius_x; }
    float radius_y() const { return data_->radius_y; }
    float rotation_angle() const { return data_->rotation_angle; }
...
public:
    ...
    ::blink::mojom::DispatchType cancelable() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::blink::mojom::DispatchType>(data_->cancelable)); }
    bool moved_beyond_slop_region() const { return data_->moved_beyond_slop_region; }
    bool touch_start_or_first_move() const { return data_->touch_start_or_first_move; }
    bool hovering() const { return data_->hovering; }
    uint32_t unique_touch_event_id() const { return data_->unique_touch_event_id; }
...
public:
    ...
    ::blink::mojom::EventType type() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::blink::mojom::EventType>(data_->type)); }
    int32_t modifiers() const { return data_->modifiers; }
...
public:
    ...
    bool is_null() const { return !data_; }
    int32_t extended_start_adjust() const { return data_->extended_start_adjust; }
    int32_t extended_end_adjust() const { return data_->extended_end_adjust; }
    int32_t word_start_adjust() const { return data_->word_start_adjust; }
    int32_t word_end_adjust() const { return data_->word_end_adjust; }
...
public:
    ...
    ScrollResultDataDataView(internal::ScrollResultData_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
...
template <typename MaybeConstUserType> struct Serializer<::blink::mojom::KeyDataDataView, MaybeConstUserType> {
    ...
    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::blink::mojom::internal::KeyData_Data>& fragment)
    {
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->text.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null text in KeyData struct");
...
template <typename MaybeConstUserType> struct Serializer<::blink::mojom::ScrollUpdateDataView, MaybeConstUserType> {
    using UserType = typename std::remove_const<MaybeConstUserType>::type;
    using Traits = StructTraits<::blink::mojom::ScrollUpdateDataView, UserType>;

    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::blink::mojom::internal::ScrollUpdate_Data>& fragment)
    {
        if (CallIsNullIfExists<Traits>(input))
            return;
        fragment.Allocate();
    ...
    static bool Deserialize(::blink::mojom::internal::ScrollUpdate_Data* input, UserType* output, Message* message)
    {
        if (!input)
            return CallSetToNullIfExists<Traits>(output);
...
template <typename MaybeConstUserType> struct Serializer<::blink::mojom::ScrollDataDataView, MaybeConstUserType> {
    ...
    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::blink::mojom::internal::ScrollData_Data>& fragment)
    {
        ...
        mojo::internal::MessageFragment<typename decltype(fragment->update_details)::BaseType> update_details_fragment(fragment.message());
        mojo::internal::Serialize<::blink::mojom::ScrollUpdateDataView>(in_update_details, update_details_fragment);
        fragment->update_details.Set(update_details_fragment.is_null() ? nullptr : update_details_fragment.data());
    }
...
template <typename MaybeConstUserType> struct Serializer<::blink::mojom::TouchDataDataView, MaybeConstUserType> {
    ...
    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::blink::mojom::internal::TouchData_Data>& fragment)
    {
        ...
        const mojo::internal::ContainerValidateParams touches_validate_params(0, false, nullptr);
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->touches.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null touches in TouchData struct");
    }
...
template <typename MaybeConstUserType> struct Serializer<::blink::mojom::EventDataView, MaybeConstUserType> {
    ...
    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::blink::mojom::internal::Event_Data>& fragment)
    {
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->timestamp.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null timestamp in Event struct");
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->latency.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null latency in Event struct");
...
template <typename MaybeConstUserType> struct Serializer<::blink::mojom::DidOverscrollParamsDataView, MaybeConstUserType> {
    ...
    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::blink::mojom::internal::DidOverscrollParams_Data>& fragment)
    {
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
            fragment->accumulated_overscroll.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null accumulated_overscroll in DidOverscrollParams struct");
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
            fragment->latest_overscroll_delta.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null latest_overscroll_delta in DidOverscrollParams struct");
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
            fragment->current_fling_velocity.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null current_fling_velocity in DidOverscrollParams struct");
        ...
        mojo::internal::MessageFragment<typename decltype(fragment->causal_event_viewport_point)::BaseType> causal_event_viewport_point_fragment(fragment.message());
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
            fragment->overscroll_behavior.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null overscroll_behavior in DidOverscrollParams struct");
    }
...
template <typename MaybeConstUserType> struct Serializer<::blink::mojom::EditCommandDataView, MaybeConstUserType> {
    ...
    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::blink::mojom::internal::EditCommand_Data>& fragment)
    {
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->name.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null name in EditCommand struct");
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->value.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null value in EditCommand struct");
    }
...
template <typename MaybeConstUserType> struct Serializer<::blink::mojom::ScrollResultDataDataView, MaybeConstUserType> {
    using UserType = typename std::remove_const<MaybeConstUserType>::type;
    using Traits = StructTraits<::blink::mojom::ScrollResultDataDataView, UserType>;

    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::blink::mojom::internal::ScrollResultData_Data>& fragment)
    {
        if (CallIsNullIfExists<Traits>(input))
            return;
        fragment.Allocate();
    ...
    static bool Deserialize(::blink::mojom::internal::ScrollResultData_Data* input, UserType* output, Message* message)
    {
        if (!input)
            return CallSetToNullIfExists<Traits>(output);
...
inline void ScrollDataDataView::GetUpdateDetailsDataView(ScrollUpdateDataView* output)
{
    auto pointer = data_->update_details.Get();
...
inline void ScrollResultDataDataView::GetRootScrollOffsetDataView(::gfx::mojom::PointFDataView* output)
{
    auto pointer = data_->root_scroll_offset.Get();
    *output = ::gfx::mojom::PointFDataView(pointer, message_);
}
