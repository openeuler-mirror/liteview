...
std::ostream& operator<<(std::ostream& os, GestureDevice value) { return os << GestureDeviceToString(value); }
...
std::ostream& operator<<(std::ostream& os, InertialPhaseState value) { return os << InertialPhaseStateToString(value); }
