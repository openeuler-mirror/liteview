...
KeyData::KeyData(int32_t dom_key_in, int32_t dom_code_in, int32_t windows_key_code_in, int32_t native_key_code_in, bool is_system_key_in, bool is_browser_shortcut_in,
...
bool KeyData::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
PointerData::PointerData(int32_t pointer_id_in, float force_in, int32_t tilt_x_in, int32_t tilt_y_in, float tangential_pressure_in, int32_t twist_in,
...
bool PointerData::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
WheelData::WheelData()
    : delta_x()
    , delta_y()
    , wheel_ticks_x()
...
WheelData::WheelData(float delta_x_in, float delta_y_in, float wheel_ticks_x_in, float wheel_ticks_y_in, float acceleration_ratio_x_in, float acceleration_ratio_y_in,
    uint8_t phase_in, uint8_t momentum_phase_in, ::blink::mojom::DispatchType cancelable_in, uint8_t event_action_in, uint8_t delta_units_in)
...
bool WheelData::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
MouseData::MouseData()
    : click_count()
    , wheel_data()
{
...
bool MouseData::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
ScrollUpdate::ScrollUpdate(float velocity_x_in, float velocity_y_in)
...
void ScrollUpdate::WriteIntoTrace(perfetto::TracedValue traced_context) const
{
    [[maybe_unused]] auto dict = std::move(traced_context).WriteDictionary();
...
bool ScrollUpdate::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
ScrollData::ScrollData(float delta_x_in, float delta_y_in, ::ui::ScrollGranularity delta_units_in, bool target_viewport_in, ::blink::mojom::InertialPhaseState inertial_phase_in,
...
void ScrollData::WriteIntoTrace(perfetto::TracedValue traced_context) const
{
    ...
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("update_details"), this->update_details,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
bool ScrollData::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
bool PinchBeginData::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
bool PinchUpdateData::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
bool PinchEndData::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
FlingData::FlingData()
    : velocity_x()
    , velocity_y()
    , target_viewport()
...
bool FlingData::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
TapData::TapData()
    : tap_count()
    , needs_wheel_event()
{
...
bool TapData::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
bool GestureData::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
bool TouchPoint::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
TouchData::TouchData()
    : cancelable()
...
bool TouchData::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
Event::Event()
    : type()
    , modifiers()
    , timestamp()
...
Event::Event(::blink::mojom::EventType type_in, int32_t modifiers_in, ::base::TimeTicks timestamp_in, const ::ui::LatencyInfo& latency_in, KeyDataPtr key_data_in,
...
bool Event::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
DidOverscrollParams::DidOverscrollParams(const ::gfx::Vector2dF& accumulated_overscroll_in, const ::gfx::Vector2dF& latest_overscroll_delta_in,
    const ::gfx::Vector2dF& current_fling_velocity_in, const ::gfx::PointF& causal_event_viewport_point_in, const ::cc::OverscrollBehavior& overscroll_behavior_in)
...
bool DidOverscrollParams::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
bool TouchActionOptional::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
bool EditCommand::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
SelectAroundCaretResult::SelectAroundCaretResult(int32_t extended_start_adjust_in, int32_t extended_end_adjust_in, int32_t word_start_adjust_in, int32_t word_end_adjust_in)
...
bool SelectAroundCaretResult::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
ScrollResultData::ScrollResultData()
    : root_scroll_offset()
{
}

ScrollResultData::ScrollResultData(const absl::optional<::gfx::PointF>& root_scroll_offset_in)
...
void ScrollResultData::WriteIntoTrace(perfetto::TracedValue traced_context) const
{
    [[maybe_unused]] auto dict = std::move(traced_context).WriteDictionary();
...
bool ScrollResultData::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
void WidgetInputHandlerHostProxy::SetTouchActionFromMain(::cc::TouchAction in_touch_action)
{
    ...
    mojo::Message message(internal::kWidgetInputHandlerHost_SetTouchActionFromMain_Name, kFlags, 0, 0, nullptr);
...
void WidgetInputHandlerHostProxy::SetPanAction(PanAction in_pan_action)
{
    ...
    mojo::Message message(internal::kWidgetInputHandlerHost_SetPanAction_Name, kFlags, 0, 0, nullptr);
...
void WidgetInputHandlerHostProxy::DidOverscroll(DidOverscrollParamsPtr in_params)
{
    ...
    mojo::Message message(internal::kWidgetInputHandlerHost_DidOverscroll_Name, kFlags, 0, 0, nullptr);
...
void WidgetInputHandlerHostProxy::DidStartScrollingViewport()
{
    ...
    mojo::Message message(internal::kWidgetInputHandlerHost_DidStartScrollingViewport_Name, kFlags, 0, 0, nullptr);
...
void WidgetInputHandlerHostProxy::ImeCancelComposition()
{
    ...
    mojo::Message message(internal::kWidgetInputHandlerHost_ImeCancelComposition_Name, kFlags, 0, 0, nullptr);
...
void WidgetInputHandlerHostProxy::ImeCompositionRangeChanged(const ::gfx::Range& in_range, const std::vector<::gfx::Rect>& in_bounds)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send blink::mojom::WidgetInputHandlerHost::ImeCompositionRangeChanged", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("bounds"), in_bounds, "<value of type const std::vector<::gfx::Rect>&>");
    });
#endif
    const bool kExpectsResponse = false;
    const bool kIsSync = false;
    ...
    mojo::Message message(internal::kWidgetInputHandlerHost_ImeCompositionRangeChanged_Name, kFlags, 0, 0, nullptr);
    ...
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
        params->range.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null range in WidgetInputHandlerHost.ImeCompositionRangeChanged request");
    mojo::internal::MessageFragment<typename decltype(params->bounds)::BaseType> bounds_fragment(params.message());
    const mojo::internal::ContainerValidateParams bounds_validate_params(0, false, nullptr);
    ...
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
        params->bounds.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null bounds in WidgetInputHandlerHost.ImeCompositionRangeChanged request");
...
void WidgetInputHandlerHostProxy::SetMouseCapture(bool in_capture)
{
    ...
    mojo::Message message(internal::kWidgetInputHandlerHost_SetMouseCapture_Name, kFlags, 0, 0, nullptr);
...
void WidgetInputHandlerHostProxy::RequestMouseLock(bool in_from_user_gesture, bool in_unadjusted_movement, RequestMouseLockCallback callback)
{
    ...
    mojo::Message message(internal::kWidgetInputHandlerHost_RequestMouseLock_Name, kFlags, 0, 0, nullptr);
...
bool WidgetInputHandlerHost_RequestMouseLock_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    bool success = true;
    ::blink::mojom::PointerLockResult p_result = mojo::DefaultConstructTraits::CreateInstance<::blink::mojom::PointerLockResult>();
    ::mojo::PendingRemote<::blink::mojom::PointerLockContext> p_context = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingRemote<::blink::mojom::PointerLockContext>>();
    ...
    if (!success) {
        ReportValidationErrorForMessage(message, mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED, WidgetInputHandlerHost::Name_, 7, true);
        return false;
    }
    ...
    ::blink::mojom::PointerLockResult in_result, ::mojo::PendingRemote<::blink::mojom::PointerLockContext> in_context)
{
    ...
    TRACE_EVENT1("mojom", "Send reply blink::mojom::WidgetInputHandlerHost::RequestMouseLock", "async_response_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("context"), in_context, "<value of type ::mojo::PendingRemote<::blink::mojom::PointerLockContext>>");
    });
#endif
...
bool WidgetInputHandlerHostStubDispatch::Accept(WidgetInputHandlerHost* impl, mojo::Message* message)
{
    ...
    case internal::kWidgetInputHandlerHost_SetPanAction_Name: {
        ...
        bool success = true;
        PanAction p_pan_action = mojo::DefaultConstructTraits::CreateInstance<PanAction>();
    ...
    case internal::kWidgetInputHandlerHost_DidOverscroll_Name: {
        ...
        bool success = true;
        DidOverscrollParamsPtr p_params = mojo::DefaultConstructTraits::CreateInstance<DidOverscrollParamsPtr>();
    ...
    case internal::kWidgetInputHandlerHost_ImeCompositionRangeChanged_Name: {
        ...
        std::vector<::gfx::Rect> p_bounds = mojo::DefaultConstructTraits::CreateInstance<std::vector<::gfx::Rect>>();
        ...
        // A null |impl| means no implementation was bound.
        DCHECK(impl);
        impl->ImeCompositionRangeChanged(std::move(p_range), std::move(p_bounds));
        return true;
    }
    case internal::kWidgetInputHandlerHost_SetMouseCapture_Name: {
        ...
        bool success = true;
        bool p_capture = mojo::DefaultConstructTraits::CreateInstance<bool>();
...
// static
bool WidgetInputHandlerHostStubDispatch::AcceptWithResponder(WidgetInputHandlerHost* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
{
    ...
    case internal::kWidgetInputHandlerHost_RequestMouseLock_Name: {
        ...
        bool success = true;
        bool p_from_user_gesture = mojo::DefaultConstructTraits::CreateInstance<bool>();
        bool p_unadjusted_movement = mojo::DefaultConstructTraits::CreateInstance<bool>();
        ...
        WidgetInputHandlerHost::RequestMouseLockCallback callback = WidgetInputHandlerHost_RequestMouseLock_ProxyToResponder::CreateCallback(*message, std::move(responder));
        // A null |impl| means no implementation was bound.
        DCHECK(impl);
...
static const mojo::internal::GenericValidationInfo kWidgetInputHandlerHostValidationInfo[] = {
    ...
    { &internal::WidgetInputHandlerHost_RequestMouseLock_Params_Data::Validate, &internal::WidgetInputHandlerHost_RequestMouseLock_ResponseParams_Data::Validate },
};
...
public:
    ...
    FrameWidgetInputHandler_WaitForPageScaleAnimationForTesting_ForwardToCallback& operator=(const FrameWidgetInputHandler_WaitForPageScaleAnimationForTesting_ForwardToCallback&)
        = delete;
...
void FrameWidgetInputHandlerProxy::AddImeTextSpansToExistingText(uint32_t in_start, uint32_t in_end, const std::vector<::ui::ImeTextSpan>& in_ime_text_spans)
{
    ...
    mojo::Message message(internal::kFrameWidgetInputHandler_AddImeTextSpansToExistingText_Name, kFlags, 0, 0, nullptr);
    ...
    const mojo::internal::ContainerValidateParams ime_text_spans_validate_params(0, false, nullptr);
    mojo::internal::Serialize<mojo::ArrayDataView<::ui::mojom::ImeTextSpanDataView>>(in_ime_text_spans, ime_text_spans_fragment, &ime_text_spans_validate_params);
...
void FrameWidgetInputHandlerProxy::ClearImeTextSpansByType(uint32_t in_start, uint32_t in_end, ::ui::ImeTextSpan::Type in_type)
{
    ...
    mojo::Message message(internal::kFrameWidgetInputHandler_ClearImeTextSpansByType_Name, kFlags, 0, 0, nullptr);
...
void FrameWidgetInputHandlerProxy::SetCompositionFromExistingText(int32_t in_start, int32_t in_end, const std::vector<::ui::ImeTextSpan>& in_ime_text_spans)
{
    ...
    mojo::Message message(internal::kFrameWidgetInputHandler_SetCompositionFromExistingText_Name, kFlags, 0, 0, nullptr);
...
void FrameWidgetInputHandlerProxy::ExtendSelectionAndDelete(int32_t in_before, int32_t in_after)
{
    ...
    mojo::Message message(internal::kFrameWidgetInputHandler_ExtendSelectionAndDelete_Name, kFlags, 0, 0, nullptr);
...
void FrameWidgetInputHandlerProxy::DeleteSurroundingText(int32_t in_before, int32_t in_after)
{
    ...
    mojo::Message message(internal::kFrameWidgetInputHandler_DeleteSurroundingText_Name, kFlags, 0, 0, nullptr);
...
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send blink::mojom::FrameWidgetInputHandler::DeleteSurroundingTextInCodePoints", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("before"), in_before, "<value of type int32_t>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("after"), in_after, "<value of type int32_t>");
    });
    ...
    mojo::Message message(internal::kFrameWidgetInputHandler_DeleteSurroundingTextInCodePoints_Name, kFlags, 0, 0, nullptr);
...
void FrameWidgetInputHandlerProxy::SetEditableSelectionOffsets(int32_t in_start, int32_t in_end)
{
    ...
    mojo::Message message(internal::kFrameWidgetInputHandler_SetEditableSelectionOffsets_Name, kFlags, 0, 0, nullptr);
...
void FrameWidgetInputHandlerProxy::HandleStylusWritingGestureAction(::blink::mojom::StylusWritingGestureDataPtr in_gesture_data)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send blink::mojom::FrameWidgetInputHandler::HandleStylusWritingGestureAction", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("gesture_data"), in_gesture_data, "<value of type ::blink::mojom::StylusWritingGestureDataPtr>");
    });
#endif
    const bool kExpectsResponse = false;
    const bool kIsSync = false;
    ...
    mojo::Message message(internal::kFrameWidgetInputHandler_HandleStylusWritingGestureAction_Name, kFlags, 0, 0, nullptr);
...
void FrameWidgetInputHandlerProxy::ExecuteEditCommand(const std::string& in_command, const absl::optional<::std::u16string>& in_value)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send blink::mojom::FrameWidgetInputHandler::ExecuteEditCommand", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("value"), in_value, "<value of type const absl::optional<::std::u16string>&>");
    });
#endif
    const bool kExpectsResponse = false;
    const bool kIsSync = false;
    ...
    mojo::Message message(internal::kFrameWidgetInputHandler_ExecuteEditCommand_Name, kFlags, 0, 0, nullptr);
    ...
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
        params->command.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null command in FrameWidgetInputHandler.ExecuteEditCommand request");
...
void FrameWidgetInputHandlerProxy::Undo()
{
    ...
    mojo::Message message(internal::kFrameWidgetInputHandler_Undo_Name, kFlags, 0, 0, nullptr);
...
void FrameWidgetInputHandlerProxy::Redo()
{
    ...
    mojo::Message message(internal::kFrameWidgetInputHandler_Redo_Name, kFlags, 0, 0, nullptr);
...
void FrameWidgetInputHandlerProxy::Cut()
{
    ...
    mojo::Message message(internal::kFrameWidgetInputHandler_Cut_Name, kFlags, 0, 0, nullptr);
...
void FrameWidgetInputHandlerProxy::Copy()
{
    ...
    mojo::Message message(internal::kFrameWidgetInputHandler_Copy_Name, kFlags, 0, 0, nullptr);
...
void FrameWidgetInputHandlerProxy::CopyToFindPboard()
{
    ...
    mojo::Message message(internal::kFrameWidgetInputHandler_CopyToFindPboard_Name, kFlags, 0, 0, nullptr);
...
void FrameWidgetInputHandlerProxy::Paste()
{
    ...
    mojo::Message message(internal::kFrameWidgetInputHandler_Paste_Name, kFlags, 0, 0, nullptr);
...
void FrameWidgetInputHandlerProxy::PasteAndMatchStyle()
{
    ...
    mojo::Message message(internal::kFrameWidgetInputHandler_PasteAndMatchStyle_Name, kFlags, 0, 0, nullptr);
...
void FrameWidgetInputHandlerProxy::Delete()
{
    ...
    mojo::Message message(internal::kFrameWidgetInputHandler_Delete_Name, kFlags, 0, 0, nullptr);
...
void FrameWidgetInputHandlerProxy::SelectAll()
{
    ...
    mojo::Message message(internal::kFrameWidgetInputHandler_SelectAll_Name, kFlags, 0, 0, nullptr);
...
void FrameWidgetInputHandlerProxy::CollapseSelection()
{
    ...
    mojo::Message message(internal::kFrameWidgetInputHandler_CollapseSelection_Name, kFlags, 0, 0, nullptr);
...
void FrameWidgetInputHandlerProxy::Replace(const ::std::u16string& in_word)
{
    ...
    mojo::Message message(internal::kFrameWidgetInputHandler_Replace_Name, kFlags, 0, 0, nullptr);
...
void FrameWidgetInputHandlerProxy::ReplaceMisspelling(const ::std::u16string& in_word)
{
    ...
    mojo::Message message(internal::kFrameWidgetInputHandler_ReplaceMisspelling_Name, kFlags, 0, 0, nullptr);
...
void FrameWidgetInputHandlerProxy::SelectRange(const ::gfx::Point& in_base, const ::gfx::Point& in_extent)
{
    ...
    mojo::Message message(internal::kFrameWidgetInputHandler_SelectRange_Name, kFlags, 0, 0, nullptr);
...
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send blink::mojom::FrameWidgetInputHandler::AdjustSelectionByCharacterOffset", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("start"), in_start, "<value of type int32_t>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("end"), in_end, "<value of type int32_t>");
    ...
    mojo::Message message(internal::kFrameWidgetInputHandler_AdjustSelectionByCharacterOffset_Name, kFlags, 0, 0, nullptr);
...
void FrameWidgetInputHandlerProxy::MoveRangeSelectionExtent(const ::gfx::Point& in_extent)
{
    ...
    mojo::Message message(internal::kFrameWidgetInputHandler_MoveRangeSelectionExtent_Name, kFlags, 0, 0, nullptr);
    ...
    params->extent.Set(extent_fragment.is_null() ? nullptr : extent_fragment.data());
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
        params->extent.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null extent in FrameWidgetInputHandler.MoveRangeSelectionExtent request");
...
void FrameWidgetInputHandlerProxy::ScrollFocusedEditableNodeIntoView()
{
    ...
    mojo::Message message(internal::kFrameWidgetInputHandler_ScrollFocusedEditableNodeIntoView_Name, kFlags, 0, 0, nullptr);
...
void FrameWidgetInputHandlerProxy::WaitForPageScaleAnimationForTesting(WaitForPageScaleAnimationForTestingCallback callback)
{
    ...
    mojo::Message message(internal::kFrameWidgetInputHandler_WaitForPageScaleAnimationForTesting_Name, kFlags, 0, 0, nullptr);
...
void FrameWidgetInputHandlerProxy::MoveCaret(const ::gfx::Point& in_point)
{
    ...
    mojo::Message message(internal::kFrameWidgetInputHandler_MoveCaret_Name, kFlags, 0, 0, nullptr);
...
public:
    static FrameWidgetInputHandler::WaitForPageScaleAnimationForTestingCallback CreateCallback(::mojo::Message& message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
    {
...
private:
    FrameWidgetInputHandler_WaitForPageScaleAnimationForTesting_ProxyToResponder(::mojo::Message& message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
        : ::mojo::internal::ProxyToResponder(message, std::move(responder))
    {
    }
...
bool FrameWidgetInputHandlerStubDispatch::Accept(FrameWidgetInputHandler* impl, mojo::Message* message)
{
    ...
    case internal::kFrameWidgetInputHandler_AddImeTextSpansToExistingText_Name: {
        ...
        bool success = true;
        uint32_t p_start = mojo::DefaultConstructTraits::CreateInstance<uint32_t>();
        uint32_t p_end = mojo::DefaultConstructTraits::CreateInstance<uint32_t>();
        std::vector<::ui::ImeTextSpan> p_ime_text_spans = mojo::DefaultConstructTraits::CreateInstance<std::vector<::ui::ImeTextSpan>>();
    ...
    case internal::kFrameWidgetInputHandler_ClearImeTextSpansByType_Name: {
        ...
        uint32_t p_start = mojo::DefaultConstructTraits::CreateInstance<uint32_t>();
        uint32_t p_end = mojo::DefaultConstructTraits::CreateInstance<uint32_t>();
        ::ui::ImeTextSpan::Type p_type = mojo::DefaultConstructTraits::CreateInstance<::ui::ImeTextSpan::Type>();
    ...
    case internal::kFrameWidgetInputHandler_ExtendSelectionAndDelete_Name: {
        ...
        bool success = true;
        int32_t p_before = mojo::DefaultConstructTraits::CreateInstance<int32_t>();
        int32_t p_after = mojo::DefaultConstructTraits::CreateInstance<int32_t>();
    ...
    case internal::kFrameWidgetInputHandler_HandleStylusWritingGestureAction_Name: {
        ...
        bool success = true;
        ::blink::mojom::StylusWritingGestureDataPtr p_gesture_data = mojo::DefaultConstructTraits::CreateInstance<::blink::mojom::StylusWritingGestureDataPtr>();
        ...
        // A null |impl| means no implementation was bound.
        DCHECK(impl);
        impl->HandleStylusWritingGestureAction(std::move(p_gesture_data));
        return true;
    }
    case internal::kFrameWidgetInputHandler_ExecuteEditCommand_Name: {
        ...
        bool success = true;
        std::string p_command = mojo::DefaultConstructTraits::CreateInstance<std::string>();
        absl::optional<::std::u16string> p_value = mojo::DefaultConstructTraits::CreateInstance<absl::optional<::std::u16string>>();
    ...
    case internal::kFrameWidgetInputHandler_Undo_Name: {
        ...
        DCHECK(message->is_serialized());
        internal::FrameWidgetInputHandler_Undo_Params_Data* params = reinterpret_cast<internal::FrameWidgetInputHandler_Undo_Params_Data*>(message->mutable_payload());
    ...
    case internal::kFrameWidgetInputHandler_Redo_Name: {
        ...
        DCHECK(message->is_serialized());
        internal::FrameWidgetInputHandler_Redo_Params_Data* params = reinterpret_cast<internal::FrameWidgetInputHandler_Redo_Params_Data*>(message->mutable_payload());
    ...
    case internal::kFrameWidgetInputHandler_Cut_Name: {
        ...
        DCHECK(message->is_serialized());
        internal::FrameWidgetInputHandler_Cut_Params_Data* params = reinterpret_cast<internal::FrameWidgetInputHandler_Cut_Params_Data*>(message->mutable_payload());
    ...
    case internal::kFrameWidgetInputHandler_Copy_Name: {
        ...
        DCHECK(message->is_serialized());
        internal::FrameWidgetInputHandler_Copy_Params_Data* params = reinterpret_cast<internal::FrameWidgetInputHandler_Copy_Params_Data*>(message->mutable_payload());
    ...
    case internal::kFrameWidgetInputHandler_Paste_Name: {
        ...
        DCHECK(message->is_serialized());
        internal::FrameWidgetInputHandler_Paste_Params_Data* params = reinterpret_cast<internal::FrameWidgetInputHandler_Paste_Params_Data*>(message->mutable_payload());
    ...
    case internal::kFrameWidgetInputHandler_Delete_Name: {
        ...
        DCHECK(message->is_serialized());
        internal::FrameWidgetInputHandler_Delete_Params_Data* params = reinterpret_cast<internal::FrameWidgetInputHandler_Delete_Params_Data*>(message->mutable_payload());
    ...
    case internal::kFrameWidgetInputHandler_SelectAll_Name: {
        ...
        DCHECK(message->is_serialized());
        internal::FrameWidgetInputHandler_SelectAll_Params_Data* params = reinterpret_cast<internal::FrameWidgetInputHandler_SelectAll_Params_Data*>(message->mutable_payload());
    ...
    case internal::kFrameWidgetInputHandler_Replace_Name: {
        ...
        DCHECK(message->is_serialized());
        internal::FrameWidgetInputHandler_Replace_Params_Data* params = reinterpret_cast<internal::FrameWidgetInputHandler_Replace_Params_Data*>(message->mutable_payload());

        bool success = true;
        ::std::u16string p_word = mojo::DefaultConstructTraits::CreateInstance<::std::u16string>();
    ...
    case internal::kFrameWidgetInputHandler_SelectRange_Name: {
        ...
        bool success = true;
        ::gfx::Point p_base = mojo::DefaultConstructTraits::CreateInstance<::gfx::Point>();
        ::gfx::Point p_extent = mojo::DefaultConstructTraits::CreateInstance<::gfx::Point>();
    ...
    case internal::kFrameWidgetInputHandler_AdjustSelectionByCharacterOffset_Name: {
        ...
        int32_t p_start = mojo::DefaultConstructTraits::CreateInstance<int32_t>();
        int32_t p_end = mojo::DefaultConstructTraits::CreateInstance<int32_t>();
        ::blink::mojom::SelectionMenuBehavior p_behavior = mojo::DefaultConstructTraits::CreateInstance<::blink::mojom::SelectionMenuBehavior>();
    ...
    case internal::kFrameWidgetInputHandler_MoveCaret_Name: {
        ...
        DCHECK(message->is_serialized());
        internal::FrameWidgetInputHandler_MoveCaret_Params_Data* params = reinterpret_cast<internal::FrameWidgetInputHandler_MoveCaret_Params_Data*>(message->mutable_payload());
...
// static
bool FrameWidgetInputHandlerStubDispatch::AcceptWithResponder(FrameWidgetInputHandler* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
{
    [[maybe_unused]] const bool message_is_sync = message->has_flag(mojo::Message::kFlagIsSync);
    [[maybe_unused]] const uint64_t request_id = message->request_id();
    switch (message->header()->name) {
...
static const mojo::internal::GenericValidationInfo kFrameWidgetInputHandlerValidationInfo[] = {
    ...
    { &internal::FrameWidgetInputHandler_HandleStylusWritingGestureAction_Params_Data::Validate, nullptr /* no response */ },
...
void WidgetInputHandlerProxy::SetFocus(FocusState in_state)
{
    ...
    mojo::Message message(internal::kWidgetInputHandler_SetFocus_Name, kFlags, 0, 0, nullptr);
...
void WidgetInputHandlerProxy::MouseCaptureLost()
{
    ...
    mojo::Message message(internal::kWidgetInputHandler_MouseCaptureLost_Name, kFlags, 0, 0, nullptr);
...
void WidgetInputHandlerProxy::SetEditCommandsForNextKeyEvent(std::vector<EditCommandPtr> in_commands)
{
    ...
    mojo::Message message(internal::kWidgetInputHandler_SetEditCommandsForNextKeyEvent_Name, kFlags, 0, 0, nullptr);
    ...
    const mojo::internal::ContainerValidateParams commands_validate_params(0, false, nullptr);
    ...
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
        params->commands.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null commands in WidgetInputHandler.SetEditCommandsForNextKeyEvent request");
...
void WidgetInputHandlerProxy::CursorVisibilityChanged(bool in_visible)
{
    ...
    mojo::Message message(internal::kWidgetInputHandler_CursorVisibilityChanged_Name, kFlags, 0, 0, nullptr);
...
void WidgetInputHandlerProxy::ImeSetComposition(const ::std::u16string& in_text, const std::vector<::ui::ImeTextSpan>& in_ime_text_spans, const ::gfx::Range& in_range,
    int32_t in_start, int32_t in_end, ImeSetCompositionCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    ...
    mojo::Message message(internal::kWidgetInputHandler_ImeSetComposition_Name, kFlags, 0, 0, nullptr);
    ...
    params->ime_text_spans.Set(ime_text_spans_fragment.is_null() ? nullptr : ime_text_spans_fragment.data());
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
        params->ime_text_spans.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null ime_text_spans in WidgetInputHandler.ImeSetComposition request");
    mojo::internal::MessageFragment<typename decltype(params->range)::BaseType> range_fragment(params.message());
    mojo::internal::Serialize<::gfx::mojom::RangeDataView>(in_range, range_fragment);
    params->range.Set(range_fragment.is_null() ? nullptr : range_fragment.data());
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
...
void WidgetInputHandlerProxy::ImeCommitText(const ::std::u16string& in_text, const std::vector<::ui::ImeTextSpan>& in_ime_text_spans, const ::gfx::Range& in_range,
    int32_t in_relative_cursor_position, ImeCommitTextCallback callback)
{
    ...
    mojo::Message message(internal::kWidgetInputHandler_ImeCommitText_Name, kFlags, 0, 0, nullptr);
    ...
    params->ime_text_spans.Set(ime_text_spans_fragment.is_null() ? nullptr : ime_text_spans_fragment.data());
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
        params->ime_text_spans.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null ime_text_spans in WidgetInputHandler.ImeCommitText request");
    mojo::internal::MessageFragment<typename decltype(params->range)::BaseType> range_fragment(params.message());
    mojo::internal::Serialize<::gfx::mojom::RangeDataView>(in_range, range_fragment);
    params->range.Set(range_fragment.is_null() ? nullptr : range_fragment.data());
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
...
void WidgetInputHandlerProxy::ImeFinishComposingText(bool in_keep_selection)
{
    ...
    mojo::Message message(internal::kWidgetInputHandler_ImeFinishComposingText_Name, kFlags, 0, 0, nullptr);
...
void WidgetInputHandlerProxy::RequestTextInputStateUpdate()
{
    ...
    mojo::Message message(internal::kWidgetInputHandler_RequestTextInputStateUpdate_Name, kFlags, 0, 0, nullptr);
...
void WidgetInputHandlerProxy::RequestCompositionUpdates(bool in_immediate_request, bool in_monitor_request)
{
    ...
    mojo::Message message(internal::kWidgetInputHandler_RequestCompositionUpdates_Name, kFlags, 0, 0, nullptr);
...
void WidgetInputHandlerProxy::DispatchEvent(::std::unique_ptr<::blink::WebCoalescedInputEvent> in_event, DispatchEventCallback callback)
{
    ...
    mojo::Message message(internal::kWidgetInputHandler_DispatchEvent_Name, kFlags, 0, 0, nullptr);
...
void WidgetInputHandlerProxy::DispatchNonBlockingEvent(::std::unique_ptr<::blink::WebCoalescedInputEvent> in_event)
{
    ...
    mojo::Message message(internal::kWidgetInputHandler_DispatchNonBlockingEvent_Name, kFlags, 0, 0, nullptr);
...
void WidgetInputHandlerProxy::WaitForInputProcessed(WaitForInputProcessedCallback callback)
{
    ...
    mojo::Message message(internal::kWidgetInputHandler_WaitForInputProcessed_Name, kFlags, 0, 0, nullptr);
...
void WidgetInputHandlerProxy::GetFrameWidgetInputHandler(::mojo::PendingAssociatedReceiver<FrameWidgetInputHandler> in_interface_request)
{
    ...
    mojo::Message message(internal::kWidgetInputHandler_GetFrameWidgetInputHandler_Name, kFlags, 0, 0, nullptr);
    ...
    params.Allocate();
    mojo::internal::Serialize<::blink::mojom::FrameWidgetInputHandlerAssociatedRequestDataView>(in_interface_request, &params->interface_request, &params.message());
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(!mojo::internal::IsHandleOrInterfaceValid(params->interface_request), mojo::internal::VALIDATION_ERROR_UNEXPECTED_INVALID_INTERFACE_ID,
...
void WidgetInputHandlerProxy::UpdateBrowserControlsState(::cc::BrowserControlsState in_constraints, ::cc::BrowserControlsState in_current, bool in_animate)
{
    ...
    mojo::Message message(internal::kWidgetInputHandler_UpdateBrowserControlsState_Name, kFlags, 0, 0, nullptr);
...
public:
    ...
    {
        std::unique_ptr<WidgetInputHandler_ImeSetComposition_ProxyToResponder> proxy(new WidgetInputHandler_ImeSetComposition_ProxyToResponder(message, std::move(responder)));
...
public:
    ...
    {
        std::unique_ptr<WidgetInputHandler_ImeCommitText_ProxyToResponder> proxy(new WidgetInputHandler_ImeCommitText_ProxyToResponder(message, std::move(responder)));
...
public:
    ...
    {
        std::unique_ptr<WidgetInputHandler_DispatchEvent_ProxyToResponder> proxy(new WidgetInputHandler_DispatchEvent_ProxyToResponder(message, std::move(responder)));
...
private:
    ...
    void Run(::blink::mojom::InputEventResultSource in_source, const ::ui::LatencyInfo& in_updated_latency, ::blink::mojom::InputEventResultState in_state,
        DidOverscrollParamsPtr in_overscroll, TouchActionOptionalPtr in_touch_action, ScrollResultDataPtr in_scroll_result_data);
};
...
bool WidgetInputHandler_DispatchEvent_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    bool success = true;
    ::blink::mojom::InputEventResultSource p_source = mojo::DefaultConstructTraits::CreateInstance<::blink::mojom::InputEventResultSource>();
    ::ui::LatencyInfo p_updated_latency = mojo::DefaultConstructTraits::CreateInstance<::ui::LatencyInfo>();
    ::blink::mojom::InputEventResultState p_state = mojo::DefaultConstructTraits::CreateInstance<::blink::mojom::InputEventResultState>();
    DidOverscrollParamsPtr p_overscroll = mojo::DefaultConstructTraits::CreateInstance<DidOverscrollParamsPtr>();
    TouchActionOptionalPtr p_touch_action = mojo::DefaultConstructTraits::CreateInstance<TouchActionOptionalPtr>();
    ScrollResultDataPtr p_scroll_result_data = mojo::DefaultConstructTraits::CreateInstance<ScrollResultDataPtr>();
    ...
    if (!callback_.is_null())
        std::move(callback_).Run(
            std::move(p_source), std::move(p_updated_latency), std::move(p_state), std::move(p_overscroll), std::move(p_touch_action), std::move(p_scroll_result_data));
    return true;
}
...
void WidgetInputHandler_DispatchEvent_ProxyToResponder::Run(::blink::mojom::InputEventResultSource in_source, const ::ui::LatencyInfo& in_updated_latency,
    ::blink::mojom::InputEventResultState in_state, DidOverscrollParamsPtr in_overscroll, TouchActionOptionalPtr in_touch_action, ScrollResultDataPtr in_scroll_result_data)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send reply blink::mojom::WidgetInputHandler::DispatchEvent", "async_response_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("scroll_result_data"), in_scroll_result_data, "<value of type ScrollResultDataPtr>");
    });
#endif
    ...
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(params->updated_latency.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null updated_latency in ");
    ...
    mojo::internal::MessageFragment<typename decltype(params->scroll_result_data)::BaseType> scroll_result_data_fragment(params.message());
    mojo::internal::Serialize<::blink::mojom::ScrollResultDataDataView>(in_scroll_result_data, scroll_result_data_fragment);
    params->scroll_result_data.Set(scroll_result_data_fragment.is_null() ? nullptr : scroll_result_data_fragment.data());
...
public:
    static WidgetInputHandler::WaitForInputProcessedCallback CreateCallback(::mojo::Message& message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
    {
...
bool WidgetInputHandlerStubDispatch::Accept(WidgetInputHandler* impl, mojo::Message* message)
{
    ...
    case internal::kWidgetInputHandler_SetFocus_Name: {
        ...
        DCHECK(message->is_serialized());
        internal::WidgetInputHandler_SetFocus_Params_Data* params = reinterpret_cast<internal::WidgetInputHandler_SetFocus_Params_Data*>(message->mutable_payload());

        bool success = true;
        FocusState p_state = mojo::DefaultConstructTraits::CreateInstance<FocusState>();
    ...
    case internal::kWidgetInputHandler_SetEditCommandsForNextKeyEvent_Name: {
        ...
        bool success = true;
        std::vector<EditCommandPtr> p_commands = mojo::DefaultConstructTraits::CreateInstance<std::vector<EditCommandPtr>>();
    ...
    case internal::kWidgetInputHandler_ImeFinishComposingText_Name: {
        ...
        bool success = true;
        bool p_keep_selection = mojo::DefaultConstructTraits::CreateInstance<bool>();
    ...
    case internal::kWidgetInputHandler_RequestCompositionUpdates_Name: {
        ...
        bool success = true;
        bool p_immediate_request = mojo::DefaultConstructTraits::CreateInstance<bool>();
        bool p_monitor_request = mojo::DefaultConstructTraits::CreateInstance<bool>();
    ...
    case internal::kWidgetInputHandler_DispatchNonBlockingEvent_Name: {
        ...
        bool success = true;
        ::std::unique_ptr<::blink::WebCoalescedInputEvent> p_event = mojo::DefaultConstructTraits::CreateInstance<::std::unique_ptr<::blink::WebCoalescedInputEvent>>();
    ...
    case internal::kWidgetInputHandler_GetFrameWidgetInputHandler_Name: {
        ...
        ::mojo::PendingAssociatedReceiver<FrameWidgetInputHandler> p_interface_request
            = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingAssociatedReceiver<FrameWidgetInputHandler>>();
...
// static
bool WidgetInputHandlerStubDispatch::AcceptWithResponder(WidgetInputHandler* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
{
    [[maybe_unused]] const bool message_is_sync = message->has_flag(mojo::Message::kFlagIsSync);
    [[maybe_unused]] const uint64_t request_id = message->request_id();
    switch (message->header()->name) {
    ...
    case internal::kWidgetInputHandler_ImeSetComposition_Name: {
        ...
        WidgetInputHandler::ImeSetCompositionCallback callback = WidgetInputHandler_ImeSetComposition_ProxyToResponder::CreateCallback(*message, std::move(responder));
        // A null |impl| means no implementation was bound.
        DCHECK(impl);
    ...
    case internal::kWidgetInputHandler_ImeCommitText_Name: {
        ...
        internal::WidgetInputHandler_ImeCommitText_Params_Data* params = reinterpret_cast<internal::WidgetInputHandler_ImeCommitText_Params_Data*>(message->mutable_payload());

        bool success = true;
        ::std::u16string p_text = mojo::DefaultConstructTraits::CreateInstance<::std::u16string>();
        std::vector<::ui::ImeTextSpan> p_ime_text_spans = mojo::DefaultConstructTraits::CreateInstance<std::vector<::ui::ImeTextSpan>>();
        ::gfx::Range p_range = mojo::DefaultConstructTraits::CreateInstance<::gfx::Range>();
        int32_t p_relative_cursor_position = mojo::DefaultConstructTraits::CreateInstance<int32_t>();
    ...
    case internal::kWidgetInputHandler_DispatchEvent_Name: {
        ...
        internal::WidgetInputHandler_DispatchEvent_Params_Data* params = reinterpret_cast<internal::WidgetInputHandler_DispatchEvent_Params_Data*>(message->mutable_payload());
    ...
    case internal::kWidgetInputHandler_WaitForInputProcessed_Name: {
        ...
        WidgetInputHandler::WaitForInputProcessedCallback callback = WidgetInputHandler_WaitForInputProcessed_ProxyToResponder::CreateCallback(*message, std::move(responder));
        // A null |impl| means no implementation was bound.
        DCHECK(impl);
...
static const mojo::internal::GenericValidationInfo kWidgetInputHandlerValidationInfo[] = {
    ...
    { &internal::WidgetInputHandler_WaitForInputProcessed_Params_Data::Validate, &internal::WidgetInputHandler_WaitForInputProcessed_ResponseParams_Data::Validate },
...
// static
bool StructTraits<::blink::mojom::KeyData::DataView, ::blink::mojom::KeyDataPtr>::Read(::blink::mojom::KeyData::DataView input, ::blink::mojom::KeyDataPtr* output)
{
    bool success = true;
...
// static
bool StructTraits<::blink::mojom::PointerData::DataView, ::blink::mojom::PointerDataPtr>::Read(::blink::mojom::PointerData::DataView input, ::blink::mojom::PointerDataPtr* output)
{
    bool success = true;
...
// static
bool StructTraits<::blink::mojom::WheelData::DataView, ::blink::mojom::WheelDataPtr>::Read(::blink::mojom::WheelData::DataView input, ::blink::mojom::WheelDataPtr* output)
{
    bool success = true;
...
// static
bool StructTraits<::blink::mojom::MouseData::DataView, ::blink::mojom::MouseDataPtr>::Read(::blink::mojom::MouseData::DataView input, ::blink::mojom::MouseDataPtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::ScrollUpdate::DataView, ::blink::mojom::ScrollUpdatePtr>::Read(
    ::blink::mojom::ScrollUpdate::DataView input, ::blink::mojom::ScrollUpdatePtr* output)
{
    bool success = true;
...
// static
bool StructTraits<::blink::mojom::ScrollData::DataView, ::blink::mojom::ScrollDataPtr>::Read(::blink::mojom::ScrollData::DataView input, ::blink::mojom::ScrollDataPtr* output)
{
    bool success = true;
...
// static
bool StructTraits<::blink::mojom::FlingData::DataView, ::blink::mojom::FlingDataPtr>::Read(::blink::mojom::FlingData::DataView input, ::blink::mojom::FlingDataPtr* output)
{
    bool success = true;
...
// static
bool StructTraits<::blink::mojom::TapData::DataView, ::blink::mojom::TapDataPtr>::Read(::blink::mojom::TapData::DataView input, ::blink::mojom::TapDataPtr* output)
{
    bool success = true;
...
// static
bool StructTraits<::blink::mojom::GestureData::DataView, ::blink::mojom::GestureDataPtr>::Read(::blink::mojom::GestureData::DataView input, ::blink::mojom::GestureDataPtr* output)
{
    bool success = true;
...
// static
bool StructTraits<::blink::mojom::TouchPoint::DataView, ::blink::mojom::TouchPointPtr>::Read(::blink::mojom::TouchPoint::DataView input, ::blink::mojom::TouchPointPtr* output)
{
    bool success = true;
...
// static
bool StructTraits<::blink::mojom::TouchData::DataView, ::blink::mojom::TouchDataPtr>::Read(::blink::mojom::TouchData::DataView input, ::blink::mojom::TouchDataPtr* output)
{
    bool success = true;
...
// static
bool StructTraits<::blink::mojom::EditCommand::DataView, ::blink::mojom::EditCommandPtr>::Read(::blink::mojom::EditCommand::DataView input, ::blink::mojom::EditCommandPtr* output)
{
    bool success = true;
...
// static
bool StructTraits<::blink::mojom::ScrollResultData::DataView, ::blink::mojom::ScrollResultDataPtr>::Read(
    ::blink::mojom::ScrollResultData::DataView input, ::blink::mojom::ScrollResultDataPtr* output)
{
    bool success = true;
    ::blink::mojom::ScrollResultDataPtr result(::blink::mojom::ScrollResultData::New());
...
void WidgetInputHandlerHostInterceptorForTesting::SetPanAction(PanAction pan_action) { GetForwardingInterface()->SetPanAction(std::move(pan_action)); }
void WidgetInputHandlerHostInterceptorForTesting::DidOverscroll(DidOverscrollParamsPtr params) { GetForwardingInterface()->DidOverscroll(std::move(params)); }
void WidgetInputHandlerHostInterceptorForTesting::DidStartScrollingViewport() { GetForwardingInterface()->DidStartScrollingViewport(); }
void WidgetInputHandlerHostInterceptorForTesting::ImeCancelComposition() { GetForwardingInterface()->ImeCancelComposition(); }
...
void WidgetInputHandlerHostInterceptorForTesting::SetMouseCapture(bool capture) { GetForwardingInterface()->SetMouseCapture(std::move(capture)); }
...
void FrameWidgetInputHandlerInterceptorForTesting::Undo() { GetForwardingInterface()->Undo(); }
void FrameWidgetInputHandlerInterceptorForTesting::Redo() { GetForwardingInterface()->Redo(); }
void FrameWidgetInputHandlerInterceptorForTesting::Cut() { GetForwardingInterface()->Cut(); }
void FrameWidgetInputHandlerInterceptorForTesting::Copy() { GetForwardingInterface()->Copy(); }
void FrameWidgetInputHandlerInterceptorForTesting::CopyToFindPboard() { GetForwardingInterface()->CopyToFindPboard(); }
void FrameWidgetInputHandlerInterceptorForTesting::Paste() { GetForwardingInterface()->Paste(); }
void FrameWidgetInputHandlerInterceptorForTesting::PasteAndMatchStyle() { GetForwardingInterface()->PasteAndMatchStyle(); }
void FrameWidgetInputHandlerInterceptorForTesting::Delete() { GetForwardingInterface()->Delete(); }
void FrameWidgetInputHandlerInterceptorForTesting::SelectAll() { GetForwardingInterface()->SelectAll(); }
void FrameWidgetInputHandlerInterceptorForTesting::CollapseSelection() { GetForwardingInterface()->CollapseSelection(); }
void FrameWidgetInputHandlerInterceptorForTesting::Replace(const ::std::u16string& word) { GetForwardingInterface()->Replace(std::move(word)); }
void FrameWidgetInputHandlerInterceptorForTesting::ReplaceMisspelling(const ::std::u16string& word) { GetForwardingInterface()->ReplaceMisspelling(std::move(word)); }
...
void FrameWidgetInputHandlerInterceptorForTesting::MoveRangeSelectionExtent(const ::gfx::Point& extent) { GetForwardingInterface()->MoveRangeSelectionExtent(std::move(extent)); }
void FrameWidgetInputHandlerInterceptorForTesting::ScrollFocusedEditableNodeIntoView() { GetForwardingInterface()->ScrollFocusedEditableNodeIntoView(); }
...
void FrameWidgetInputHandlerInterceptorForTesting::MoveCaret(const ::gfx::Point& point) { GetForwardingInterface()->MoveCaret(std::move(point)); }
...
void WidgetInputHandlerInterceptorForTesting::SetFocus(FocusState state) { GetForwardingInterface()->SetFocus(std::move(state)); }
void WidgetInputHandlerInterceptorForTesting::MouseCaptureLost() { GetForwardingInterface()->MouseCaptureLost(); }
...
void WidgetInputHandlerInterceptorForTesting::CursorVisibilityChanged(bool visible) { GetForwardingInterface()->CursorVisibilityChanged(std::move(visible)); }
void WidgetInputHandlerInterceptorForTesting::ImeSetComposition(
    const ::std::u16string& text, const std::vector<::ui::ImeTextSpan>& ime_text_spans, const ::gfx::Range& range, int32_t start, int32_t end, ImeSetCompositionCallback callback)
{
...
void WidgetInputHandlerInterceptorForTesting::ImeCommitText(
    const ::std::u16string& text, const std::vector<::ui::ImeTextSpan>& ime_text_spans, const ::gfx::Range& range, int32_t relative_cursor_position, ImeCommitTextCallback callback)
{
...
void WidgetInputHandlerInterceptorForTesting::ImeFinishComposingText(bool keep_selection) { GetForwardingInterface()->ImeFinishComposingText(std::move(keep_selection)); }
void WidgetInputHandlerInterceptorForTesting::RequestTextInputStateUpdate() { GetForwardingInterface()->RequestTextInputStateUpdate(); }
...
void WidgetInputHandlerInterceptorForTesting::UpdateBrowserControlsState(::cc::BrowserControlsState constraints, ::cc::BrowserControlsState current, bool animate)
{
    ...
    const ::std::u16string& text, const std::vector<::ui::ImeTextSpan>& ime_text_spans, const ::gfx::Range& range, int32_t start, int32_t end)
{
    ...
    proxy_->ImeSetComposition(
        std::move(text), std::move(ime_text_spans), std::move(range), std::move(start), std::move(end), base::BindOnce([](base::RunLoop* loop) { loop->Quit(); }, &loop));
    loop.Run();
}
    ...
    const ::std::u16string& text, const std::vector<::ui::ImeTextSpan>& ime_text_spans, const ::gfx::Range& range, int32_t relative_cursor_position)
{
    ...
    proxy_->ImeCommitText(
        std::move(text), std::move(ime_text_spans), std::move(range), std::move(relative_cursor_position), base::BindOnce([](base::RunLoop* loop) { loop->Quit(); }, &loop));
    loop.Run();
}
...
void WidgetInputHandlerAsyncWaiter::DispatchEvent(::std::unique_ptr<::blink::WebCoalescedInputEvent> event, ::blink::mojom::InputEventResultSource* out_source,
    ::ui::LatencyInfo* out_updated_latency, ::blink::mojom::InputEventResultState* out_state, DidOverscrollParamsPtr* out_overscroll, TouchActionOptionalPtr* out_touch_action,
    ScrollResultDataPtr* out_scroll_result_data)
{
    base::RunLoop loop;
    proxy_->DispatchEvent(std::move(event),
        base::BindOnce(
            [](base::RunLoop* loop, ::blink::mojom::InputEventResultSource* out_source, ::ui::LatencyInfo* out_updated_latency, ::blink::mojom::InputEventResultState* out_state,
                DidOverscrollParamsPtr* out_overscroll, TouchActionOptionalPtr* out_touch_action, ScrollResultDataPtr* out_scroll_result_data,
                ::blink::mojom::InputEventResultSource source, const ::ui::LatencyInfo& updated_latency, ::blink::mojom::InputEventResultState state,
                DidOverscrollParamsPtr overscroll, TouchActionOptionalPtr touch_action, ScrollResultDataPtr scroll_result_data) {
                ...
                *out_scroll_result_data = std::move(scroll_result_data);
                loop->Quit();
            },
            &loop, out_source, out_updated_latency, out_state, out_overscroll, out_touch_action, out_scroll_result_data));
    loop.Run();
}
