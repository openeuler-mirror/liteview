...
static NOINLINE const char* TouchStateToStringHelper(TouchState value)
{
    ...
    case TouchState::kStateCancelled:
        return "{kStateCancelled, kStateMax}";
    default:
        return nullptr;
    }
}
...
std::ostream& operator<<(std::ostream& os, TouchState value) { return os << TouchStateToString(value); }
