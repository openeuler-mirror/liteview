...
public:
    ...
    bool is_null() const { return !data_; }
    uint64_t source_offset() const { return data_->source_offset; }
    uint64_t source_size() const { return data_->source_size; }
    ...
    uint64_t file_offset() const { return data_->file_offset; }
