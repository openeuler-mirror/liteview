...
// with not having this data in traces there.
    ...
    virtual void RegisterFromStream(const WTF::String& content_type, const WTF::String& content_disposition, uint64_t length_hint, ::mojo::ScopedDataPipeConsumerHandle data,
    ...
    virtual void URLStoreForOrigin(const ::scoped_refptr<const ::blink::SecurityOrigin>& origin, ::mojo::PendingAssociatedReceiver<::blink::mojom::blink::BlobURLStore> url_store)
        = 0;
};
...
//
//   bool Register(::mojo::PendingReceiver<::blink::mojom::blink::Blob> blob, const WTF::String& uuid, const WTF::String& content_type, const WTF::String& content_disposition,
//   WTF::Vector<::blink::mojom::blink::DataElementPtr> elements) final;
//
//   void Register(::mojo::PendingReceiver<::blink::mojom::blink::Blob> blob, const WTF::String& uuid, const WTF::String& content_type, const WTF::String& content_disposition,
//   WTF::Vector<::blink::mojom::blink::DataElementPtr> elements, RegisterCallback callback) final;
//
//   void RegisterFromStream(const WTF::String& content_type, const WTF::String& content_disposition, uint64_t length_hint, ::mojo::ScopedDataPipeConsumerHandle data,
