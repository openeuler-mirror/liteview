...
//
//   bool Register(::mojo::PendingRemote<::blink::mojom::Blob> blob, const ::GURL& url, const ::base::UnguessableToken& unsafe_agent_cluster_id, const
//   absl::optional<::net::SchemefulSite>& unsafe_top_level_site) final;
//
//   void Register(::mojo::PendingRemote<::blink::mojom::Blob> blob, const ::GURL& url, const ::base::UnguessableToken& unsafe_agent_cluster_id, const
//   absl::optional<::net::SchemefulSite>& unsafe_top_level_site, RegisterCallback callback) final;
//
