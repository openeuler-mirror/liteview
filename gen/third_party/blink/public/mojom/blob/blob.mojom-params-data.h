...
public:
    ...
    uint64_t total_size() const { return data_->total_size; }
    uint64_t expected_content_size() const { return data_->expected_content_size; }
...
public:
    ...
    {
        UserType result;
        bool ret = mojo::internal::Deserialize<mojo::InterfaceRequestDataView<::network::mojom::DataPipeGetterInterfaceBase>>(&data_->data_pipe_getter, &result, message_);
        DCHECK(ret);
        return result;
    }
