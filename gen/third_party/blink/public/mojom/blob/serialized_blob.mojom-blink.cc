...
#ifndef THIRD_PARTY_BLINK_PUBLIC_MOJOM_BLOB_SERIALIZED_BLOB_MOJOM_BLINK_JUMBO_H_
#define THIRD_PARTY_BLINK_PUBLIC_MOJOM_BLOB_SERIALIZED_BLOB_MOJOM_BLINK_JUMBO_H_
#endif
...
SerializedBlob::SerializedBlob(const WTF::String& uuid_in, const WTF::String& content_type_in, uint64_t size_in, ::mojo::PendingRemote<::blink::mojom::blink::Blob> blob_in)
...
bool SerializedBlob::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
} // namespace blink
} // namespace mojom
} // namespace blink
namespace mojo {
