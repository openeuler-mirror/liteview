...
// with not having this data in traces there.
    ...
    virtual bool Register(::mojo::PendingRemote<::blink::mojom::blink::Blob> blob, const ::blink::KURL& url, const ::base::UnguessableToken& unsafe_agent_cluster_id,
        const absl::optional<::blink::BlinkSchemefulSite>& unsafe_top_level_site);

    using RegisterCallback = base::OnceCallback<void()>;

    virtual void Register(::mojo::PendingRemote<::blink::mojom::blink::Blob> blob, const ::blink::KURL& url, const ::base::UnguessableToken& unsafe_agent_cluster_id,
        const absl::optional<::blink::BlinkSchemefulSite>& unsafe_top_level_site, RegisterCallback callback)
        = 0;
...
//
//   bool Register(::mojo::PendingRemote<::blink::mojom::blink::Blob> blob, const ::blink::KURL& url, const ::base::UnguessableToken& unsafe_agent_cluster_id, const
//   absl::optional<::blink::BlinkSchemefulSite>& unsafe_top_level_site) final;
//
//   void Register(::mojo::PendingRemote<::blink::mojom::blink::Blob> blob, const ::blink::KURL& url, const ::base::UnguessableToken& unsafe_agent_cluster_id, const
//   absl::optional<::blink::BlinkSchemefulSite>& unsafe_top_level_site, RegisterCallback callback) final;
//
//   void Revoke(const ::blink::KURL& url) final;
//
//   void Resolve(const ::blink::KURL& url, ResolveCallback callback) final;
//
//   void ResolveAsURLLoaderFactory(const ::blink::KURL& url, ::mojo::PendingReceiver<::network::mojom::blink::URLLoaderFactory> factory, ResolveAsURLLoaderFactoryCallback
//   callback) final;
//
