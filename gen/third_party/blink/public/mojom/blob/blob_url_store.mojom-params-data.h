...
private:
    friend class mojo::internal::MessageFragment<BlobURLStore_Resolve_Params_Data>;

    BlobURLStore_Resolve_Params_Data();
    ~BlobURLStore_Resolve_Params_Data() = delete;
};
static_assert(sizeof(BlobURLStore_Resolve_Params_Data) == 16, "Bad sizeof(BlobURLStore_Resolve_Params_Data)");
...
private:
    friend class mojo::internal::MessageFragment<BlobURLStore_Resolve_ResponseParams_Data>;

    BlobURLStore_Resolve_ResponseParams_Data();
    ~BlobURLStore_Resolve_ResponseParams_Data() = delete;
};
static_assert(sizeof(BlobURLStore_Resolve_ResponseParams_Data) == 24, "Bad sizeof(BlobURLStore_Resolve_ResponseParams_Data)");
...
static_assert(sizeof(BlobURLStore_ResolveAsURLLoaderFactory_ResponseParams_Data) == 24, "Bad sizeof(BlobURLStore_ResolveAsURLLoaderFactory_ResponseParams_Data)");
...
public:
    BlobURLStore_Resolve_ParamsDataView() = default;

    BlobURLStore_Resolve_ParamsDataView(internal::BlobURLStore_Resolve_Params_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
...
public:
    BlobURLStore_Resolve_ResponseParamsDataView() = default;

    BlobURLStore_Resolve_ResponseParamsDataView(internal::BlobURLStore_Resolve_ResponseParams_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
...
public:
    ...
    {
        UserType result;
        bool ret = mojo::internal::Deserialize<mojo::InterfaceRequestDataView<::network::mojom::URLLoaderFactoryInterfaceBase>>(&data_->factory, &result, message_);
        DCHECK(ret);
        return result;
    }
...
public:
    ...
    BlobURLStore_ResolveAsURLLoaderFactory_ResponseParamsDataView(internal::BlobURLStore_ResolveAsURLLoaderFactory_ResponseParams_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
...
inline void BlobURLStore_Resolve_ParamsDataView::GetUrlDataView(::url::mojom::UrlDataView* output)
{
    auto pointer = data_->url.Get();
    *output = ::url::mojom::UrlDataView(pointer, message_);
}
inline void BlobURLStore_Resolve_ResponseParamsDataView::GetUnsafeAgentClusterIdDataView(::mojo_base::mojom::UnguessableTokenDataView* output)
{
    auto pointer = data_->unsafe_agent_cluster_id.Get();
    *output = ::mojo_base::mojom::UnguessableTokenDataView(pointer, message_);
}
