...
constexpr uint32_t kBlob_Load_Name = 4;
constexpr uint32_t kBlob_ReadSideData_Name = 5;
constexpr uint32_t kBlob_CaptureSnapshot_Name = 6;
constexpr uint32_t kBlob_GetInternalUUID_Name = 7;
