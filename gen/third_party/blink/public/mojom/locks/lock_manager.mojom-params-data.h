...
static_assert(sizeof(LockRequest_Abort_Params_Data) == 16, "Bad sizeof(LockRequest_Abort_Params_Data)");
...
public:
    ...
    LockRequest_Abort_ParamsDataView(internal::LockRequest_Abort_Params_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
...
public:
    ...
    LockManager_WaitMode wait() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::blink::mojom::LockManager_WaitMode>(data_->wait)); }
...
inline void LockRequest_Abort_ParamsDataView::GetReasonDataView(mojo::StringDataView* output)
{
    auto pointer = data_->reason.Get();
