...
(function() {
  ...
  DirectSocketProtocolType.MAX_VALUE = 1;
  ...
  DirectSocketOptions.validate = function(messageValidator, offset) {
    ...
    if (err !== validator.validationError.NONE)
        return err;
    // validate DirectSocketOptions.keepAliveOptions
  ...
  DirectSocketOptions.encodedSize = codec.kStructHeaderSize + 40;
  ...
  DirectSocketOptions.encode = function(encoder, val) {
    ...
    encoder.encodeStruct(codec.String, val.remoteHostname);
