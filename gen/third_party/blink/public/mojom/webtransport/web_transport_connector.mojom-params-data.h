...
public:
    ...
    {
        UserType result;
        bool ret = mojo::internal::Deserialize<mojo::InterfacePtrDataView<::network::mojom::WebTransportHandshakeClientInterfaceBase>>(&data_->client, &result, message_);
        DCHECK(ret);
        return result;
    }
...
inline void WebTransportConnector_Connect_ParamsDataView::GetFingerprintsDataView(mojo::ArrayDataView<::network::mojom::WebTransportCertificateFingerprintDataView>* output)
{
    auto pointer = data_->fingerprints.Get();
