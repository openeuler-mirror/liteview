// third_party/blink/public/mojom/contacts/contacts_manager.mojom-lite-for-compile.js is auto generated by mojom_bindings_generator.py, do not edit
...
goog.provide('blink.mojom.ContactsManager');
goog.provide('blink.mojom.ContactsManagerReceiver');
goog.provide('blink.mojom.ContactsManagerCallbackRouter');
goog.provide('blink.mojom.ContactsManagerInterface');
goog.provide('blink.mojom.ContactsManagerRemote');
goog.provide('blink.mojom.ContactsManagerPendingReceiver');
/**
...
/** @interface */
blink.mojom.ContactsManagerInterface = class {
...
goog.provide('blink.mojom.ContactIconBlobSpec');
/**
...
goog.provide('blink.mojom.ContactInfoSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('blink.mojom.ContactsManager_Select_ParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('blink.mojom.ContactsManager_Select_ResponseParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('blink.mojom.ContactIconBlob');
...
goog.provide('blink.mojom.ContactInfo');
...
goog.provide('blink.mojom.ContactsManager_Select_Params');
...
goog.provide('blink.mojom.ContactsManager_Select_ResponseParams');
