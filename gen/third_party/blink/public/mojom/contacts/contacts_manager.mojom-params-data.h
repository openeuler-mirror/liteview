...
public:
    ...
    bool multiple() const { return data_->multiple; }
    bool include_names() const { return data_->include_names; }
    bool include_emails() const { return data_->include_emails; }
    bool include_tel() const { return data_->include_tel; }
    bool include_addresses() const { return data_->include_addresses; }
    bool include_icons() const { return data_->include_icons; }
