...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::CookieChangeSubscription::DataView, ::blink::mojom::CookieChangeSubscriptionPtr> {
    ...
    static const decltype(::blink::mojom::CookieChangeSubscription::url)& url(const ::blink::mojom::CookieChangeSubscriptionPtr& input) { return input->url; }

    static decltype(::blink::mojom::CookieChangeSubscription::match_type) match_type(const ::blink::mojom::CookieChangeSubscriptionPtr& input) { return input->match_type; }

    static const decltype(::blink::mojom::CookieChangeSubscription::name)& name(const ::blink::mojom::CookieChangeSubscriptionPtr& input) { return input->name; }
