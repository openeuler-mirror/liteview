...
struct blink_mojom_internal_AppBannerPromptReply_DataHashFn {
    ...
    static bool Equal(const ::blink::mojom::AppBannerPromptReply& left, const ::blink::mojom::AppBannerPromptReply& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::blink::mojom::AppBannerPromptReply> : public GenericHashTraits<::blink::mojom::AppBannerPromptReply> {
    static_assert(true, "-1000000 is a reserved enum value");
    static_assert(true, "-1000001 is a reserved enum value");
    static const bool kEmptyValueIsZero = false;
    static ::blink::mojom::AppBannerPromptReply EmptyValue() { return static_cast<::blink::mojom::AppBannerPromptReply>(-1000000); }
    static void ConstructDeletedValue(::blink::mojom::AppBannerPromptReply& slot, bool) { slot = static_cast<::blink::mojom::AppBannerPromptReply>(-1000001); }
    static bool IsDeletedValue(const ::blink::mojom::AppBannerPromptReply& value) { return value == static_cast<::blink::mojom::AppBannerPromptReply>(-1000001); }
};
} // namespace WTF
namespace blink {
namespace mojom {
...
//
//   void BannerPromptRequest(::mojo::PendingRemote<AppBannerService> service, ::mojo::PendingReceiver<AppBannerEvent> event_receiver, const WTF::Vector<WTF::String>& platform,
//   BannerPromptRequestCallback callback) final;
//
//  private:
