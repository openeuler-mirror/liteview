...
static_assert(sizeof(AppBannerController_BannerPromptRequest_ResponseParams_Data) == 16, "Bad sizeof(AppBannerController_BannerPromptRequest_ResponseParams_Data)");
...
public:
    ...
    {
        UserType result;
        bool ret = mojo::internal::Deserialize<mojo::InterfaceRequestDataView<::blink::mojom::AppBannerEventInterfaceBase>>(&data_->event_receiver, &result, message_);
        DCHECK(ret);
        return result;
    }
...
public:
    ...
    AppBannerController_BannerPromptRequest_ResponseParamsDataView(internal::AppBannerController_BannerPromptRequest_ResponseParams_Data* data, mojo::Message* message)
        : data_(data)
    {
    }
    ...
    AppBannerPromptReply reply() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::blink::mojom::AppBannerPromptReply>(data_->reply)); }
