...
class BLINK_COMMON_EXPORT AppBannerControllerInterceptorForTesting : public AppBannerController {
    ...
    void BannerPromptRequest(::mojo::PendingRemote<AppBannerService> service, ::mojo::PendingReceiver<AppBannerEvent> event_receiver, const std::vector<std::string>& platform,
        BannerPromptRequestCallback callback) override;
};
