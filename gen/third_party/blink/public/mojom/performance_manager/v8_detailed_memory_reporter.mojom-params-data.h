...
static_assert(sizeof(V8DetailedMemoryReporter_GetV8MemoryUsage_ResponseParams_Data) == 16, "Bad sizeof(V8DetailedMemoryReporter_GetV8MemoryUsage_ResponseParams_Data)");
...
public:
    ...
    V8DetailedMemoryReporter_Mode mode() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::blink::mojom::V8DetailedMemoryReporter_Mode>(data_->mode)); }
...
public:
    ...
    V8DetailedMemoryReporter_GetV8MemoryUsage_ResponseParamsDataView(internal::V8DetailedMemoryReporter_GetV8MemoryUsage_ResponseParams_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
