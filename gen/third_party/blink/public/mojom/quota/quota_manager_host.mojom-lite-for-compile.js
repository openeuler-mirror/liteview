// third_party/blink/public/mojom/quota/quota_manager_host.mojom-lite-for-compile.js is auto generated by mojom_bindings_generator.py, do not edit
...
goog.require('blink.mojom.QuotaStatusCode');
goog.require('blink.mojom.StorageType');
goog.require('blink.mojom.UsageBreakdown');
...
goog.provide('blink.mojom.QuotaChangeListener');
goog.provide('blink.mojom.QuotaChangeListenerReceiver');
goog.provide('blink.mojom.QuotaChangeListenerCallbackRouter');
goog.provide('blink.mojom.QuotaChangeListenerInterface');
goog.provide('blink.mojom.QuotaChangeListenerRemote');
goog.provide('blink.mojom.QuotaChangeListenerPendingReceiver');
...
/** @interface */
blink.mojom.QuotaChangeListenerInterface = class {
...
goog.provide('blink.mojom.QuotaManagerHost');
goog.provide('blink.mojom.QuotaManagerHostReceiver');
goog.provide('blink.mojom.QuotaManagerHostCallbackRouter');
goog.provide('blink.mojom.QuotaManagerHostInterface');
goog.provide('blink.mojom.QuotaManagerHostRemote');
goog.provide('blink.mojom.QuotaManagerHostPendingReceiver');
...
/** @interface */
blink.mojom.QuotaManagerHostInterface = class {
...
goog.provide('blink.mojom.QuotaChangeListener_OnQuotaChange_ParamsSpec');
/**
...
goog.provide('blink.mojom.QuotaManagerHost_AddChangeListener_ParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('blink.mojom.QuotaManagerHost_AddChangeListener_ResponseParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('blink.mojom.QuotaManagerHost_QueryStorageUsageAndQuota_ParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('blink.mojom.QuotaManagerHost_QueryStorageUsageAndQuota_ResponseParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('blink.mojom.QuotaManagerHost_RequestStorageQuota_ParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('blink.mojom.QuotaManagerHost_RequestStorageQuota_ResponseParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('blink.mojom.QuotaChangeListener_OnQuotaChange_Params');
...
goog.provide('blink.mojom.QuotaManagerHost_AddChangeListener_Params');
...
goog.provide('blink.mojom.QuotaManagerHost_AddChangeListener_ResponseParams');
...
goog.provide('blink.mojom.QuotaManagerHost_QueryStorageUsageAndQuota_Params');
...
goog.provide('blink.mojom.QuotaManagerHost_QueryStorageUsageAndQuota_ResponseParams');
...
goog.provide('blink.mojom.QuotaManagerHost_RequestStorageQuota_Params');
...
goog.provide('blink.mojom.QuotaManagerHost_RequestStorageQuota_ResponseParams');
