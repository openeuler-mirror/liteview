...
#include "third_party/blink/public/mojom/quota/quota_manager_host.mojom-blink-forward.h"
...
template <typename ImplRefTraits> class QuotaChangeListenerStub;

class QuotaChangeListenerRequestValidator;
class PLATFORM_EXPORT QuotaChangeListener : public QuotaChangeListenerInterfaceBase {
public:
    ...
    template <typename ImplRefTraits> using Stub_ = QuotaChangeListenerStub<ImplRefTraits>;
...
// with not having this data in traces there.
    ...
    virtual void QueryStorageUsageAndQuota(::blink::mojom::blink::StorageType storage_type, QueryStorageUsageAndQuotaCallback callback) = 0;
    using RequestStorageQuotaCallback = base::OnceCallback<void(::blink::mojom::blink::QuotaStatusCode, int64_t, int64_t)>;

    virtual void RequestStorageQuota(::blink::mojom::blink::StorageType storage_type, uint64_t requested_size, RequestStorageQuotaCallback callback) = 0;
};

// class PLATFORM_EXPORT QuotaChangeListenerProxy
...
// class PLATFORM_EXPORT QuotaManagerHostProxy
...
//
//   void QueryStorageUsageAndQuota(::blink::mojom::blink::StorageType storage_type, QueryStorageUsageAndQuotaCallback callback) final;
//
//   void RequestStorageQuota(::blink::mojom::blink::StorageType storage_type, uint64_t requested_size, RequestStorageQuotaCallback callback) final;
//
//  private:
//   mojo::MessageReceiverWithResponder* receiver_;
// };
// class PLATFORM_EXPORT QuotaChangeListenerStubDispatch {
//  public:
...
//   ImplPointerType sink_;
// };
// class PLATFORM_EXPORT QuotaChangeListenerRequestValidator : public mojo::MessageReceiver {
//  public:
//   bool Accept(mojo::Message* message) override;
// };
