...
std::ostream& operator<<(std::ostream& os, StorageType value) { return os << StorageTypeToString(value); }
...
std::ostream& operator<<(std::ostream& os, QuotaStatusCode value) { return os << QuotaStatusCodeToString(value); }
