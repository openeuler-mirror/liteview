...
static_assert(sizeof(QuotaChangeListener_OnQuotaChange_Params_Data) == 8, "Bad sizeof(QuotaChangeListener_OnQuotaChange_Params_Data)");
...
static_assert(sizeof(QuotaManagerHost_AddChangeListener_Params_Data) == 16, "Bad sizeof(QuotaManagerHost_AddChangeListener_Params_Data)");
...
static_assert(sizeof(QuotaManagerHost_AddChangeListener_ResponseParams_Data) == 8, "Bad sizeof(QuotaManagerHost_AddChangeListener_ResponseParams_Data)");
...
static_assert(sizeof(QuotaManagerHost_QueryStorageUsageAndQuota_Params_Data) == 16, "Bad sizeof(QuotaManagerHost_QueryStorageUsageAndQuota_Params_Data)");
...
static_assert(sizeof(QuotaManagerHost_QueryStorageUsageAndQuota_ResponseParams_Data) == 40, "Bad sizeof(QuotaManagerHost_QueryStorageUsageAndQuota_ResponseParams_Data)");
...
static_assert(sizeof(QuotaManagerHost_RequestStorageQuota_Params_Data) == 24, "Bad sizeof(QuotaManagerHost_RequestStorageQuota_Params_Data)");
...
static_assert(sizeof(QuotaManagerHost_RequestStorageQuota_ResponseParams_Data) == 32, "Bad sizeof(QuotaManagerHost_RequestStorageQuota_ResponseParams_Data)");
...
public:
    ...
    QuotaChangeListener_OnQuotaChange_ParamsDataView(internal::QuotaChangeListener_OnQuotaChange_Params_Data* data, mojo::Message* message)
        : data_(data)
    {
    }
...
public:
    ...
    QuotaManagerHost_AddChangeListener_ParamsDataView(internal::QuotaManagerHost_AddChangeListener_Params_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
    ...
    {
        UserType result;
        bool ret = mojo::internal::Deserialize<mojo::InterfacePtrDataView<::blink::mojom::QuotaChangeListenerInterfaceBase>>(&data_->listener, &result, message_);
        DCHECK(ret);
        return result;
    }
...
public:
    ...
    QuotaManagerHost_AddChangeListener_ResponseParamsDataView(internal::QuotaManagerHost_AddChangeListener_ResponseParams_Data* data, mojo::Message* message)
        : data_(data)
    {
    }
...
public:
    ...
    ::blink::mojom::StorageType storage_type() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::blink::mojom::StorageType>(data_->storage_type)); }
...
public:
    ...
    QuotaManagerHost_QueryStorageUsageAndQuota_ResponseParamsDataView(internal::QuotaManagerHost_QueryStorageUsageAndQuota_ResponseParams_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
    ...
    ::blink::mojom::QuotaStatusCode error() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::blink::mojom::QuotaStatusCode>(data_->error)); }
    int64_t current_usage() const { return data_->current_usage; }
    int64_t current_quota() const { return data_->current_quota; }
...
public:
    ...
    QuotaManagerHost_RequestStorageQuota_ParamsDataView(internal::QuotaManagerHost_RequestStorageQuota_Params_Data* data, mojo::Message* message)
        : data_(data)
    {
    }
    ...
    ::blink::mojom::StorageType storage_type() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::blink::mojom::StorageType>(data_->storage_type)); }
    uint64_t requested_size() const { return data_->requested_size; }
...
public:
    ...
    QuotaManagerHost_RequestStorageQuota_ResponseParamsDataView(internal::QuotaManagerHost_RequestStorageQuota_ResponseParams_Data* data, mojo::Message* message)
        : data_(data)
    {
    }
    ...
    ::blink::mojom::QuotaStatusCode error() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::blink::mojom::QuotaStatusCode>(data_->error)); }
    int64_t current_usage() const { return data_->current_usage; }
    int64_t granted_quota() const { return data_->granted_quota; }
