...
bool CrashMemoryMetricsReporter_SetSharedMemory_Params_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    ...
    [[maybe_unused]] const CrashMemoryMetricsReporter_SetSharedMemory_Params_Data* object = static_cast<const CrashMemoryMetricsReporter_SetSharedMemory_Params_Data*>(data);
