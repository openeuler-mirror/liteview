...
(function() {
  ...
  WebLaunchService_EnqueueLaunchParams_Params.encodedSize = codec.kStructHeaderSize + 8;
  ...
  WebLaunchServiceProxy.prototype.enqueueLaunchParams = function(launchUrl) {
  ...
  WebLaunchServiceStub.prototype.enqueueLaunchParams = function(launchUrl) {
    return this.delegate_ && this.delegate_.enqueueLaunchParams && this.delegate_.enqueueLaunchParams(launchUrl);
  }
  ...
  WebLaunchServiceStub.prototype.accept = function(message) {
    ...
    case kWebLaunchService_EnqueueLaunchParams_Name:
      ...
      this.enqueueLaunchParams(params.launchUrl);
      return true;
    default:
      return false;
    }
