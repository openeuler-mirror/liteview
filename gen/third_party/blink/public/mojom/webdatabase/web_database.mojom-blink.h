...
// with not having this data in traces there.
    ...
    virtual void Opened(const ::scoped_refptr<const ::blink::SecurityOrigin>& origin, const ::WTF::String& database_name, const ::WTF::String& database_description) = 0;
...
//
//   void Opened(const ::scoped_refptr<const ::blink::SecurityOrigin>& origin, const ::WTF::String& database_name, const ::WTF::String& database_description) final;
//
