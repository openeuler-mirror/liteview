...
constexpr uint32_t kWebDatabaseHost_SetFileSize_Name = 3;
constexpr uint32_t kWebDatabaseHost_GetSpaceAvailable_Name = 4;
constexpr uint32_t kWebDatabaseHost_Opened_Name = 5;
constexpr uint32_t kWebDatabaseHost_Modified_Name = 6;
constexpr uint32_t kWebDatabaseHost_Closed_Name = 7;
constexpr uint32_t kWebDatabaseHost_HandleSqliteError_Name = 8;
