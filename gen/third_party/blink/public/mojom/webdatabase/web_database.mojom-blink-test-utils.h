...
class PLATFORM_EXPORT WebDatabaseHostInterceptorForTesting : public WebDatabaseHost {
    ...
    void Opened(const ::scoped_refptr<const ::blink::SecurityOrigin>& origin, const ::WTF::String& database_name, const ::WTF::String& database_description) override;
...
public:
    ...
    void SetFileSize(const ::WTF::String& vfs_file_name, int64_t expected_size, bool* out_success);
    bool SetFileSize(const ::WTF::String& vfs_file_name, int64_t expected_size);
