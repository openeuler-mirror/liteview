...
struct blink_mojom_internal_LockScreenServiceStatus_DataHashFn {
    ...
    static bool Equal(const ::blink::mojom::LockScreenServiceStatus& left, const ::blink::mojom::LockScreenServiceStatus& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::blink::mojom::LockScreenServiceStatus> : public GenericHashTraits<::blink::mojom::LockScreenServiceStatus> {
    ...
    static void ConstructDeletedValue(::blink::mojom::LockScreenServiceStatus& slot, bool) { slot = static_cast<::blink::mojom::LockScreenServiceStatus>(-1000001); }
    static bool IsDeletedValue(const ::blink::mojom::LockScreenServiceStatus& value) { return value == static_cast<::blink::mojom::LockScreenServiceStatus>(-1000001); }
};
} // namespace WTF
namespace blink {
namespace mojom {
