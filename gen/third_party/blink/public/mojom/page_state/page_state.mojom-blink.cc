...
DEPRECATED_FileSystemFile::DEPRECATED_FileSystemFile(const ::blink::KURL& filesystem_url_in, uint64_t offset_in, uint64_t length_in, ::base::Time modification_time_in)
...
ViewState::ViewState(const ::gfx::PointF& visual_viewport_scroll_offset_in, const ::gfx::Point& scroll_offset_in, double page_scale_factor_in,
    const ::WTF::String& scroll_anchor_selector_in, const absl::optional<::gfx::PointF>& scroll_anchor_offset_in, uint64_t scroll_anchor_simhash_in)
    : visual_viewport_scroll_offset(std::move(visual_viewport_scroll_offset_in))
    , scroll_offset(std::move(scroll_offset_in))
    , page_scale_factor(std::move(page_scale_factor_in))
...
FrameState::FrameState(const ::WTF::String& url_string_in, const ::WTF::String& referrer_in, const ::WTF::String& target_in, const ::WTF::String& state_object_in,
...
FrameState::FrameState(const ::WTF::String& url_string_in, const ::WTF::String& referrer_in, const ::WTF::String& target_in, const ::WTF::String& state_object_in,
    WTF::Vector<::WTF::String> document_state_in, ScrollRestorationType scroll_restoration_type_in, ViewStatePtr view_state_in, int64_t item_sequence_number_in,
    int64_t document_sequence_number_in, ::network::mojom::blink::ReferrerPolicy referrer_policy_in, HttpBodyPtr http_body_in, WTF::Vector<FrameStatePtr> children_in,
    const WTF::String& initiator_origin_in, const ::WTF::String& navigation_api_key_in, const ::WTF::String& navigation_api_id_in, const ::WTF::String& navigation_api_state_in)
    : url_string(std::move(url_string_in))
    , referrer(std::move(referrer_in))
    , target(std::move(target_in))
    , state_object(std::move(state_object_in))
...
// static
bool StructTraits<::blink::mojom::blink::File::DataView, ::blink::mojom::blink::FilePtr>::Read(::blink::mojom::blink::File::DataView input, ::blink::mojom::blink::FilePtr* output)
{
    bool success = true;
