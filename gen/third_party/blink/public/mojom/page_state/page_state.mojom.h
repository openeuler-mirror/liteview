...
public:
    ...
    static ElementPtr NewBlobUuid(const std::string& blob_uuid)
    {
    ...
    static ElementPtr NewBytes(std::vector<uint8_t> bytes)
    {
        auto result = ElementPtr(absl::in_place);
    ...
    static ElementPtr NewFile(FilePtr file)
    {
        auto result = ElementPtr(absl::in_place);
    ...
    static ElementPtr NewDeprecatedFileSystemFile(DEPRECATED_FileSystemFilePtr DEPRECATED_file_system_file)
    {
        auto result = ElementPtr(absl::in_place);
    ...
    template <typename U> static ElementPtr From(const U& u) { return mojo::TypeConverter<ElementPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, Element>::Convert(*this); }
    ...
    template <typename T, typename std::enable_if<std::is_same<T, Element>::value>::type* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    ...
    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<Element::DataView>(input); }
...
public:
    ...
    template <typename... Args> static DEPRECATED_FileSystemFilePtr New(Args&&... args) { return DEPRECATED_FileSystemFilePtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static DEPRECATED_FileSystemFilePtr From(const U& u) { return mojo::TypeConverter<DEPRECATED_FileSystemFilePtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, DEPRECATED_FileSystemFile>::Convert(*this); }
    ...
    template <typename T, DEPRECATED_FileSystemFile::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::DEPRECATED_FileSystemFile_UnserializedMessageContext<UserType, DEPRECATED_FileSystemFile::DataView>>(0, 0, std::move(input)),
    ...
    {
        return DEPRECATED_FileSystemFile::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }

    template <typename UserType> static bool DeserializeFromMessage(mojo::Message input, UserType* output)
    {
        auto context = input.TakeUnserializedContext<internal::DEPRECATED_FileSystemFile_UnserializedMessageContext<UserType, DEPRECATED_FileSystemFile::DataView>>();
        if (context) {
...
template <typename T, DEPRECATED_FileSystemFile::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, DEPRECATED_FileSystemFile::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, DEPRECATED_FileSystemFile::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static FilePtr New(Args&&... args) { return FilePtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static FilePtr From(const U& u) { return mojo::TypeConverter<FilePtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, File>::Convert(*this); }
    File()
        : path()
        , offset()
        , length()
    ...
    template <typename T, File::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input) { return mojo::internal::SerializeImpl<File::DataView, std::vector<uint8_t>>(input); }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<File::DataView>(input); }
    ...
    template <typename UserType> static mojo::Message WrapAsMessage(UserType input)
    {
        return mojo::Message(std::make_unique<internal::File_UnserializedMessageContext<UserType, File::DataView>>(0, 0, std::move(input)), MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const std::vector<uint8_t>& input, UserType* output)
    {
        return File::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, File::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, File::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, File::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static RequestBodyPtr New(Args&&... args) { return RequestBodyPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static RequestBodyPtr From(const U& u) { return mojo::TypeConverter<RequestBodyPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, RequestBody>::Convert(*this); }
    RequestBody()
        : elements()
        , identifier()
    ...
    template <typename T, RequestBody::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<RequestBody::DataView, std::vector<uint8_t>>(input);
    }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<RequestBody::DataView>(input); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::RequestBody_UnserializedMessageContext<UserType, RequestBody::DataView>>(0, 0, std::move(input)), MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const std::vector<uint8_t>& input, UserType* output)
    {
        return RequestBody::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, RequestBody::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, RequestBody::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, RequestBody::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static HttpBodyPtr New(Args&&... args) { return HttpBodyPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static HttpBodyPtr From(const U& u) { return mojo::TypeConverter<HttpBodyPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, HttpBody>::Convert(*this); }
    HttpBody()
        : http_content_type()
        , request_body()
    ...
    HttpBody(const absl::optional<::std::u16string>& http_content_type_in, RequestBodyPtr request_body_in, bool contains_passwords_in)
    ...
    template <typename T, HttpBody::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input) { return mojo::internal::SerializeImpl<HttpBody::DataView, std::vector<uint8_t>>(input); }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<HttpBody::DataView>(input); }
    ...
    template <typename UserType> static mojo::Message WrapAsMessage(UserType input)
    {
        return mojo::Message(std::make_unique<internal::HttpBody_UnserializedMessageContext<UserType, HttpBody::DataView>>(0, 0, std::move(input)), MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const std::vector<uint8_t>& input, UserType* output)
    {
        return HttpBody::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, HttpBody::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, HttpBody::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, HttpBody::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static ViewStatePtr New(Args&&... args) { return ViewStatePtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static ViewStatePtr From(const U& u) { return mojo::TypeConverter<ViewStatePtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, ViewState>::Convert(*this); }
    ViewState()
    ...
    ViewState(const ::gfx::PointF& visual_viewport_scroll_offset, const ::gfx::Point& scroll_offset, double page_scale_factor,
        const absl::optional<::std::u16string>& scroll_anchor_selector, const absl::optional<::gfx::PointF>& scroll_anchor_offset, uint64_t scroll_anchor_simhash);
    ~ViewState() = default;
    ...
    template <typename T, ViewState::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input) { return mojo::internal::SerializeImpl<ViewState::DataView, std::vector<uint8_t>>(input); }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<ViewState::DataView>(input); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::ViewState_UnserializedMessageContext<UserType, ViewState::DataView>>(0, 0, std::move(input)), MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const std::vector<uint8_t>& input, UserType* output)
    {
        return ViewState::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, ViewState::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, ViewState::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, ViewState::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static FrameStatePtr New(Args&&... args) { return FrameStatePtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static FrameStatePtr From(const U& u) { return mojo::TypeConverter<FrameStatePtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, FrameState>::Convert(*this); }
    FrameState()
        : url_string()
        , referrer()
        , target()
    ...
    FrameState(const absl::optional<::std::u16string>& url_string_in, const absl::optional<::std::u16string>& referrer_in, const absl::optional<::std::u16string>& target_in,
        const absl::optional<::std::u16string>& state_object_in, std::vector<absl::optional<::std::u16string>> document_state_in, ScrollRestorationType scroll_restoration_type_in,
        ViewStatePtr view_state_in, int64_t item_sequence_number_in, int64_t document_sequence_number_in, ::network::mojom::ReferrerPolicy referrer_policy_in,
        HttpBodyPtr http_body_in, std::vector<FrameStatePtr> children_in)
    ...
    FrameState(const absl::optional<::std::u16string>& url_string, const absl::optional<::std::u16string>& referrer, const absl::optional<::std::u16string>& target,
        const absl::optional<::std::u16string>& state_object, std::vector<absl::optional<::std::u16string>> document_state, ScrollRestorationType scroll_restoration_type,
        ViewStatePtr view_state, int64_t item_sequence_number, int64_t document_sequence_number, ::network::mojom::ReferrerPolicy referrer_policy, HttpBodyPtr http_body,
        std::vector<FrameStatePtr> children, const absl::optional<std::string>& initiator_origin);

    FrameState(const absl::optional<::std::u16string>& url_string, const absl::optional<::std::u16string>& referrer, const absl::optional<::std::u16string>& target,
        const absl::optional<::std::u16string>& state_object, std::vector<absl::optional<::std::u16string>> document_state, ScrollRestorationType scroll_restoration_type,
        ViewStatePtr view_state, int64_t item_sequence_number, int64_t document_sequence_number, ::network::mojom::ReferrerPolicy referrer_policy, HttpBodyPtr http_body,
        std::vector<FrameStatePtr> children, const absl::optional<std::string>& initiator_origin, const absl::optional<::std::u16string>& navigation_api_key,
    ...
    FrameState(const absl::optional<::std::u16string>& url_string, const absl::optional<::std::u16string>& referrer, const absl::optional<::std::u16string>& target,
        ...
        ViewStatePtr view_state, int64_t item_sequence_number, int64_t document_sequence_number, ::network::mojom::ReferrerPolicy referrer_policy, HttpBodyPtr http_body,
        std::vector<FrameStatePtr> children, const absl::optional<std::string>& initiator_origin, const absl::optional<::std::u16string>& navigation_api_key,
        const absl::optional<::std::u16string>& navigation_api_id, const absl::optional<::std::u16string>& navigation_api_state);

    FrameState(const absl::optional<::std::u16string>& url_string, const absl::optional<::std::u16string>& referrer, const absl::optional<::std::u16string>& target,
        const absl::optional<::std::u16string>& state_object, std::vector<absl::optional<::std::u16string>> document_state, ScrollRestorationType scroll_restoration_type,
        ViewStatePtr view_state, int64_t item_sequence_number, int64_t document_sequence_number, ::network::mojom::ReferrerPolicy referrer_policy, HttpBodyPtr http_body,
        std::vector<FrameStatePtr> children, const absl::optional<std::string>& initiator_origin, const absl::optional<::std::u16string>& navigation_api_key,
        const absl::optional<::std::u16string>& navigation_api_id, const absl::optional<::std::u16string>& navigation_api_state, bool protect_url_in_navigation_api);
    ...
    template <typename T, FrameState::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input) { return mojo::internal::SerializeImpl<FrameState::DataView, std::vector<uint8_t>>(input); }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<FrameState::DataView>(input); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::FrameState_UnserializedMessageContext<UserType, FrameState::DataView>>(0, 0, std::move(input)), MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const std::vector<uint8_t>& input, UserType* output)
    {
        return FrameState::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, FrameState::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, FrameState::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, FrameState::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static PageStatePtr New(Args&&... args) { return PageStatePtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static PageStatePtr From(const U& u) { return mojo::TypeConverter<PageStatePtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, PageState>::Convert(*this); }
    PageState()
        : referenced_files()
        , top()
    {
    ...
    PageState(std::vector<absl::optional<::std::u16string>> referenced_files_in, FrameStatePtr top_in)
    ...
    template <typename T, PageState::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input) { return mojo::internal::SerializeImpl<PageState::DataView, std::vector<uint8_t>>(input); }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<PageState::DataView>(input); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::PageState_UnserializedMessageContext<UserType, PageState::DataView>>(0, 0, std::move(input)), MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const std::vector<uint8_t>& input, UserType* output)
    {
        return PageState::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, PageState::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, PageState::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, PageState::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
template <typename StructPtrType> FilePtr File::Clone() const { return New(mojo::Clone(path), mojo::Clone(offset), mojo::Clone(length), mojo::Clone(modification_time)); }
...
template <typename StructPtrType> RequestBodyPtr RequestBody::Clone() const { return New(mojo::Clone(elements), mojo::Clone(identifier), mojo::Clone(contains_sensitive_info)); }
...
template <typename StructPtrType> HttpBodyPtr HttpBody::Clone() const { return New(mojo::Clone(http_content_type), mojo::Clone(request_body), mojo::Clone(contains_passwords)); }
...
{
    return New(mojo::Clone(url_string), mojo::Clone(referrer), mojo::Clone(target), mojo::Clone(state_object), mojo::Clone(document_state), mojo::Clone(scroll_restoration_type),
        mojo::Clone(view_state), mojo::Clone(item_sequence_number), mojo::Clone(document_sequence_number), mojo::Clone(referrer_policy), mojo::Clone(http_body),
        mojo::Clone(children), mojo::Clone(initiator_origin), mojo::Clone(navigation_api_key), mojo::Clone(navigation_api_id), mojo::Clone(navigation_api_state),
...
template <typename StructPtrType> PageStatePtr PageState::Clone() const { return New(mojo::Clone(referenced_files), mojo::Clone(top)); }
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::DEPRECATED_FileSystemFile::DataView, ::blink::mojom::DEPRECATED_FileSystemFilePtr> {
    ...
    static decltype(::blink::mojom::DEPRECATED_FileSystemFile::offset) offset(const ::blink::mojom::DEPRECATED_FileSystemFilePtr& input) { return input->offset; }

    static decltype(::blink::mojom::DEPRECATED_FileSystemFile::length) length(const ::blink::mojom::DEPRECATED_FileSystemFilePtr& input) { return input->length; }

    static const decltype(::blink::mojom::DEPRECATED_FileSystemFile::modification_time)& modification_time(const ::blink::mojom::DEPRECATED_FileSystemFilePtr& input)
    {
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::File::DataView, ::blink::mojom::FilePtr> {
    ...
    static const decltype(::blink::mojom::File::path)& path(const ::blink::mojom::FilePtr& input) { return input->path; }

    static decltype(::blink::mojom::File::offset) offset(const ::blink::mojom::FilePtr& input) { return input->offset; }

    static decltype(::blink::mojom::File::length) length(const ::blink::mojom::FilePtr& input) { return input->length; }

    static const decltype(::blink::mojom::File::modification_time)& modification_time(const ::blink::mojom::FilePtr& input) { return input->modification_time; }
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::RequestBody::DataView, ::blink::mojom::RequestBodyPtr> {
    ...
    static const decltype(::blink::mojom::RequestBody::elements)& elements(const ::blink::mojom::RequestBodyPtr& input) { return input->elements; }

    static decltype(::blink::mojom::RequestBody::identifier) identifier(const ::blink::mojom::RequestBodyPtr& input) { return input->identifier; }
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::HttpBody::DataView, ::blink::mojom::HttpBodyPtr> {
    ...
    static const decltype(::blink::mojom::HttpBody::http_content_type)& http_content_type(const ::blink::mojom::HttpBodyPtr& input) { return input->http_content_type; }

    static const decltype(::blink::mojom::HttpBody::request_body)& request_body(const ::blink::mojom::HttpBodyPtr& input) { return input->request_body; }

    static decltype(::blink::mojom::HttpBody::contains_passwords) contains_passwords(const ::blink::mojom::HttpBodyPtr& input) { return input->contains_passwords; }
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::ViewState::DataView, ::blink::mojom::ViewStatePtr> {
    ...
    static const decltype(::blink::mojom::ViewState::scroll_offset)& scroll_offset(const ::blink::mojom::ViewStatePtr& input) { return input->scroll_offset; }

    static decltype(::blink::mojom::ViewState::page_scale_factor) page_scale_factor(const ::blink::mojom::ViewStatePtr& input) { return input->page_scale_factor; }
    ...
    static const decltype(::blink::mojom::ViewState::scroll_anchor_offset)& scroll_anchor_offset(const ::blink::mojom::ViewStatePtr& input) { return input->scroll_anchor_offset; }

    static decltype(::blink::mojom::ViewState::scroll_anchor_simhash) scroll_anchor_simhash(const ::blink::mojom::ViewStatePtr& input) { return input->scroll_anchor_simhash; }
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::FrameState::DataView, ::blink::mojom::FrameStatePtr> {
    ...
    static const decltype(::blink::mojom::FrameState::url_string)& url_string(const ::blink::mojom::FrameStatePtr& input) { return input->url_string; }

    static const decltype(::blink::mojom::FrameState::referrer)& referrer(const ::blink::mojom::FrameStatePtr& input) { return input->referrer; }

    static const decltype(::blink::mojom::FrameState::target)& target(const ::blink::mojom::FrameStatePtr& input) { return input->target; }

    static const decltype(::blink::mojom::FrameState::state_object)& state_object(const ::blink::mojom::FrameStatePtr& input) { return input->state_object; }

    static const decltype(::blink::mojom::FrameState::document_state)& document_state(const ::blink::mojom::FrameStatePtr& input) { return input->document_state; }
    ...
    static const decltype(::blink::mojom::FrameState::view_state)& view_state(const ::blink::mojom::FrameStatePtr& input) { return input->view_state; }

    static decltype(::blink::mojom::FrameState::item_sequence_number) item_sequence_number(const ::blink::mojom::FrameStatePtr& input) { return input->item_sequence_number; }
    ...
    static decltype(::blink::mojom::FrameState::referrer_policy) referrer_policy(const ::blink::mojom::FrameStatePtr& input) { return input->referrer_policy; }

    static const decltype(::blink::mojom::FrameState::http_body)& http_body(const ::blink::mojom::FrameStatePtr& input) { return input->http_body; }

    static const decltype(::blink::mojom::FrameState::children)& children(const ::blink::mojom::FrameStatePtr& input) { return input->children; }

    static const decltype(::blink::mojom::FrameState::initiator_origin)& initiator_origin(const ::blink::mojom::FrameStatePtr& input) { return input->initiator_origin; }

    static const decltype(::blink::mojom::FrameState::navigation_api_key)& navigation_api_key(const ::blink::mojom::FrameStatePtr& input) { return input->navigation_api_key; }

    static const decltype(::blink::mojom::FrameState::navigation_api_id)& navigation_api_id(const ::blink::mojom::FrameStatePtr& input) { return input->navigation_api_id; }
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::PageState::DataView, ::blink::mojom::PageStatePtr> {
    ...
    static const decltype(::blink::mojom::PageState::referenced_files)& referenced_files(const ::blink::mojom::PageStatePtr& input) { return input->referenced_files; }

    static const decltype(::blink::mojom::PageState::top)& top(const ::blink::mojom::PageStatePtr& input) { return input->top; }
...
template <> struct BLINK_COMMON_EXPORT UnionTraits<::blink::mojom::Element::DataView, ::blink::mojom::ElementPtr> {
    ...
    static ::blink::mojom::Element::Tag GetTag(const ::blink::mojom::ElementPtr& input) { return input->which(); }

    static const std::string& blob_uuid(const ::blink::mojom::ElementPtr& input) { return input->get_blob_uuid(); }

    static const std::vector<uint8_t>& bytes(const ::blink::mojom::ElementPtr& input) { return input->get_bytes(); }

    static const ::blink::mojom::FilePtr& file(const ::blink::mojom::ElementPtr& input) { return input->get_file(); }
