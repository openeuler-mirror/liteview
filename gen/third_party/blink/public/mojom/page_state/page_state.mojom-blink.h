...
struct blink_mojom_internal_ScrollRestorationType_DataHashFn {
    ...
    static bool Equal(const ::blink::mojom::ScrollRestorationType& left, const ::blink::mojom::ScrollRestorationType& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::blink::mojom::ScrollRestorationType> : public GenericHashTraits<::blink::mojom::ScrollRestorationType> {
    ...
    static void ConstructDeletedValue(::blink::mojom::ScrollRestorationType& slot, bool) { slot = static_cast<::blink::mojom::ScrollRestorationType>(-1000001); }
    static bool IsDeletedValue(const ::blink::mojom::ScrollRestorationType& value) { return value == static_cast<::blink::mojom::ScrollRestorationType>(-1000001); }
};
} // namespace WTF
namespace blink {
namespace mojom {
...
public:
    ...
    static ElementPtr NewBlobUuid(const WTF::String& blob_uuid)
    {
    ...
    static ElementPtr NewBytes(WTF::Vector<uint8_t> bytes)
    {
        auto result = ElementPtr(absl::in_place);
...
public:
    ...
    DEPRECATED_FileSystemFile(const ::blink::KURL& filesystem_url_in, uint64_t offset_in, uint64_t length_in, ::base::Time modification_time_in)
...
public:
    ...
    template <typename UserType> static WTF::Vector<uint8_t> Serialize(UserType* input) { return mojo::internal::SerializeImpl<File::DataView, WTF::Vector<uint8_t>>(input); }
...
public:
    ...
    template <typename UserType> static WTF::Vector<uint8_t> Serialize(UserType* input) { return mojo::internal::SerializeImpl<HttpBody::DataView, WTF::Vector<uint8_t>>(input); }
...
public:
    ...
    ViewState(const ::gfx::PointF& visual_viewport_scroll_offset, const ::gfx::Point& scroll_offset, double page_scale_factor, const ::WTF::String& scroll_anchor_selector,
        const absl::optional<::gfx::PointF>& scroll_anchor_offset, uint64_t scroll_anchor_simhash);
    ~ViewState() = default;
    ...
    template <typename UserType> static WTF::Vector<uint8_t> Serialize(UserType* input) { return mojo::internal::SerializeImpl<ViewState::DataView, WTF::Vector<uint8_t>>(input); }
...
public:
    ...
    FrameState(const ::WTF::String& url_string_in, const ::WTF::String& referrer_in, const ::WTF::String& target_in, const ::WTF::String& state_object_in,
        WTF::Vector<::WTF::String> document_state_in, ScrollRestorationType scroll_restoration_type_in, ViewStatePtr view_state_in, int64_t item_sequence_number_in,
        int64_t document_sequence_number_in, ::network::mojom::blink::ReferrerPolicy referrer_policy_in, HttpBodyPtr http_body_in, WTF::Vector<FrameStatePtr> children_in)
    ...
    FrameState(const ::WTF::String& url_string, const ::WTF::String& referrer, const ::WTF::String& target, const ::WTF::String& state_object,
        WTF::Vector<::WTF::String> document_state, ScrollRestorationType scroll_restoration_type, ViewStatePtr view_state, int64_t item_sequence_number,
        int64_t document_sequence_number, ::network::mojom::blink::ReferrerPolicy referrer_policy, HttpBodyPtr http_body, WTF::Vector<FrameStatePtr> children,
        const WTF::String& initiator_origin, const ::WTF::String& navigation_api_key, const ::WTF::String& navigation_api_id, const ::WTF::String& navigation_api_state);
    ...
    template <typename UserType> static WTF::Vector<uint8_t> Serialize(UserType* input) { return mojo::internal::SerializeImpl<FrameState::DataView, WTF::Vector<uint8_t>>(input); }
...
public:
    ...
    template <typename UserType> static WTF::Vector<uint8_t> Serialize(UserType* input) { return mojo::internal::SerializeImpl<PageState::DataView, WTF::Vector<uint8_t>>(input); }
...
template <> struct CORE_EXPORT StructTraits<::blink::mojom::blink::DEPRECATED_FileSystemFile::DataView, ::blink::mojom::blink::DEPRECATED_FileSystemFilePtr> {
    ...
    static const decltype(::blink::mojom::blink::DEPRECATED_FileSystemFile::filesystem_url)& filesystem_url(const ::blink::mojom::blink::DEPRECATED_FileSystemFilePtr& input)
    {
        return input->filesystem_url;
    }

    static decltype(::blink::mojom::blink::DEPRECATED_FileSystemFile::offset) offset(const ::blink::mojom::blink::DEPRECATED_FileSystemFilePtr& input) { return input->offset; }

    static decltype(::blink::mojom::blink::DEPRECATED_FileSystemFile::length) length(const ::blink::mojom::blink::DEPRECATED_FileSystemFilePtr& input) { return input->length; }

    static const decltype(::blink::mojom::blink::DEPRECATED_FileSystemFile::modification_time)& modification_time(const ::blink::mojom::blink::DEPRECATED_FileSystemFilePtr& input)
    {
...
template <> struct CORE_EXPORT StructTraits<::blink::mojom::blink::File::DataView, ::blink::mojom::blink::FilePtr> {
    ...
    static const decltype(::blink::mojom::blink::File::path)& path(const ::blink::mojom::blink::FilePtr& input) { return input->path; }

    static decltype(::blink::mojom::blink::File::offset) offset(const ::blink::mojom::blink::FilePtr& input) { return input->offset; }

    static decltype(::blink::mojom::blink::File::length) length(const ::blink::mojom::blink::FilePtr& input) { return input->length; }

    static const decltype(::blink::mojom::blink::File::modification_time)& modification_time(const ::blink::mojom::blink::FilePtr& input) { return input->modification_time; }
...
template <> struct CORE_EXPORT StructTraits<::blink::mojom::blink::RequestBody::DataView, ::blink::mojom::blink::RequestBodyPtr> {
    ...
    static const decltype(::blink::mojom::blink::RequestBody::elements)& elements(const ::blink::mojom::blink::RequestBodyPtr& input) { return input->elements; }

    static decltype(::blink::mojom::blink::RequestBody::identifier) identifier(const ::blink::mojom::blink::RequestBodyPtr& input) { return input->identifier; }
...
template <> struct CORE_EXPORT StructTraits<::blink::mojom::blink::HttpBody::DataView, ::blink::mojom::blink::HttpBodyPtr> {
    ...
    static const decltype(::blink::mojom::blink::HttpBody::request_body)& request_body(const ::blink::mojom::blink::HttpBodyPtr& input) { return input->request_body; }

    static decltype(::blink::mojom::blink::HttpBody::contains_passwords) contains_passwords(const ::blink::mojom::blink::HttpBodyPtr& input) { return input->contains_passwords; }
...
template <> struct CORE_EXPORT StructTraits<::blink::mojom::blink::ViewState::DataView, ::blink::mojom::blink::ViewStatePtr> {
    ...
    static const decltype(::blink::mojom::blink::ViewState::visual_viewport_scroll_offset)& visual_viewport_scroll_offset(const ::blink::mojom::blink::ViewStatePtr& input)
    {
        return input->visual_viewport_scroll_offset;
    }

    static const decltype(::blink::mojom::blink::ViewState::scroll_offset)& scroll_offset(const ::blink::mojom::blink::ViewStatePtr& input) { return input->scroll_offset; }

    static decltype(::blink::mojom::blink::ViewState::page_scale_factor) page_scale_factor(const ::blink::mojom::blink::ViewStatePtr& input) { return input->page_scale_factor; }
...
template <> struct CORE_EXPORT StructTraits<::blink::mojom::blink::FrameState::DataView, ::blink::mojom::blink::FrameStatePtr> {
    ...
    static const decltype(::blink::mojom::blink::FrameState::url_string)& url_string(const ::blink::mojom::blink::FrameStatePtr& input) { return input->url_string; }

    static const decltype(::blink::mojom::blink::FrameState::referrer)& referrer(const ::blink::mojom::blink::FrameStatePtr& input) { return input->referrer; }

    static const decltype(::blink::mojom::blink::FrameState::target)& target(const ::blink::mojom::blink::FrameStatePtr& input) { return input->target; }

    static const decltype(::blink::mojom::blink::FrameState::state_object)& state_object(const ::blink::mojom::blink::FrameStatePtr& input) { return input->state_object; }

    static const decltype(::blink::mojom::blink::FrameState::document_state)& document_state(const ::blink::mojom::blink::FrameStatePtr& input) { return input->document_state; }
    ...
    static const decltype(::blink::mojom::blink::FrameState::view_state)& view_state(const ::blink::mojom::blink::FrameStatePtr& input) { return input->view_state; }
    ...
    static decltype(::blink::mojom::blink::FrameState::referrer_policy) referrer_policy(const ::blink::mojom::blink::FrameStatePtr& input) { return input->referrer_policy; }

    static const decltype(::blink::mojom::blink::FrameState::http_body)& http_body(const ::blink::mojom::blink::FrameStatePtr& input) { return input->http_body; }

    static const decltype(::blink::mojom::blink::FrameState::children)& children(const ::blink::mojom::blink::FrameStatePtr& input) { return input->children; }
    ...
    static decltype(::blink::mojom::blink::FrameState::protect_url_in_navigation_api) protect_url_in_navigation_api(const ::blink::mojom::blink::FrameStatePtr& input)
    {
...
template <> struct CORE_EXPORT StructTraits<::blink::mojom::blink::PageState::DataView, ::blink::mojom::blink::PageStatePtr> {
    ...
    static const decltype(::blink::mojom::blink::PageState::top)& top(const ::blink::mojom::blink::PageStatePtr& input) { return input->top; }
...
template <> struct CORE_EXPORT UnionTraits<::blink::mojom::blink::Element::DataView, ::blink::mojom::blink::ElementPtr> {
    ...
    static ::blink::mojom::blink::Element::Tag GetTag(const ::blink::mojom::blink::ElementPtr& input) { return input->which(); }

    static const WTF::String& blob_uuid(const ::blink::mojom::blink::ElementPtr& input) { return input->get_blob_uuid(); }

    static const WTF::Vector<uint8_t>& bytes(const ::blink::mojom::blink::ElementPtr& input) { return input->get_bytes(); }

    static const ::blink::mojom::blink::FilePtr& file(const ::blink::mojom::blink::ElementPtr& input) { return input->get_file(); }
