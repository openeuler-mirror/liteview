...
static_assert(sizeof(PageRestoreParams_Data) == 24, "Bad sizeof(PageRestoreParams_Data)");
...
static_assert(sizeof(PrerenderPageActivationParams_Data) == 24, "Bad sizeof(PrerenderPageActivationParams_Data)");
// Used by PrerenderPageActivationParams::WrapAsMessage to lazily serialize the struct.
template <typename UserType, typename DataView> struct PrerenderPageActivationParams_UnserializedMessageContext : public mojo::internal::UnserializedMessageContext {
public:
    static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;
