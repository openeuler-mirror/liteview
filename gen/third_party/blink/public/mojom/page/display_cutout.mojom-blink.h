...
struct blink_mojom_internal_ViewportFit_DataHashFn {
    ...
    static bool Equal(const ::blink::mojom::ViewportFit& left, const ::blink::mojom::ViewportFit& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::blink::mojom::ViewportFit> : public GenericHashTraits<::blink::mojom::ViewportFit> {
    static_assert(true, "-1000000 is a reserved enum value");
    static_assert(true, "-1000001 is a reserved enum value");
    static const bool kEmptyValueIsZero = false;
    static ::blink::mojom::ViewportFit EmptyValue() { return static_cast<::blink::mojom::ViewportFit>(-1000000); }
    static void ConstructDeletedValue(::blink::mojom::ViewportFit& slot, bool) { slot = static_cast<::blink::mojom::ViewportFit>(-1000001); }
    static bool IsDeletedValue(const ::blink::mojom::ViewportFit& value) { return value == static_cast<::blink::mojom::ViewportFit>(-1000001); }
};
} // namespace WTF
namespace blink {
namespace mojom {
