...
StorageKey::StorageKey(const ::url::Origin& origin_in, const ::net::SchemefulSite& top_level_site_in, const absl::optional<::base::UnguessableToken>& nonce_in,
...
bool StorageKey::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
// static
bool StructTraits<::blink::mojom::StorageKey::DataView, ::blink::mojom::StorageKeyPtr>::Read(::blink::mojom::StorageKey::DataView input, ::blink::mojom::StorageKeyPtr* output)
{
    bool success = true;
