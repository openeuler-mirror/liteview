...
class CORE_EXPORT EmbeddedWorkerInstanceHostInterceptorForTesting : public EmbeddedWorkerInstanceHost {
    ...
    void OnReadyForInspection(
        ::mojo::PendingRemote<::blink::mojom::blink::DevToolsAgent> agent, ::mojo::PendingReceiver<::blink::mojom::blink::DevToolsAgentHost> agent_host) override;
    ...
    void OnStarted(::blink::mojom::blink::ServiceWorkerStartStatus status, ::blink::mojom::blink::ServiceWorkerFetchHandlerType fetch_handler_type, int32_t thread_id,
        EmbeddedWorkerStartTimingPtr start_timing) override;
    ...
    void OnReportConsoleMessage(::blink::mojom::blink::ConsoleMessageSource source, ::blink::mojom::blink::ConsoleMessageLevel message_level, const ::WTF::String& message,
        int32_t line_number, const ::blink::KURL& source_url) override;
