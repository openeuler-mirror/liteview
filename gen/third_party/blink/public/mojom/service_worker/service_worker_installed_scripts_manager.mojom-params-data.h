...
static_assert(
    sizeof(ServiceWorkerInstalledScriptsManager_TransferInstalledScript_Params_Data) == 16, "Bad sizeof(ServiceWorkerInstalledScriptsManager_TransferInstalledScript_Params_Data)");
