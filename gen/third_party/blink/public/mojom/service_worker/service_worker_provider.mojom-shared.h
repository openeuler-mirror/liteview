...
public:
    ...
    template <typename UserType> UserType TakeScriptLoaderFactoryRemote()
    {
        UserType result;
        bool ret
            = mojo::internal::Deserialize<mojo::InterfacePtrDataView<::network::mojom::URLLoaderFactoryInterfaceBase>>(&data_->script_loader_factory_remote, &result, message_);
        DCHECK(ret);
        return result;
    }
...
template <typename MaybeConstUserType> struct Serializer<::blink::mojom::ServiceWorkerProviderInfoForStartWorkerDataView, MaybeConstUserType> {
    ...
    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::blink::mojom::internal::ServiceWorkerProviderInfoForStartWorker_Data>& fragment)
    {
        ...
        mojo::internal::Serialize<mojo::InterfacePtrDataView<::blink::mojom::CacheStorageInterfaceBase>>(in_cache_storage, &fragment->cache_storage, &fragment.message());
