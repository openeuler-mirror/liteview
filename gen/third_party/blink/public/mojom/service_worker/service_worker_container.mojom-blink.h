...
struct blink_mojom_internal_ControllerServiceWorkerPurpose_DataHashFn {
    ...
    static bool Equal(const ::blink::mojom::ControllerServiceWorkerPurpose& left, const ::blink::mojom::ControllerServiceWorkerPurpose& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::blink::mojom::ControllerServiceWorkerPurpose> : public GenericHashTraits<::blink::mojom::ControllerServiceWorkerPurpose> {
    static_assert(true, "-1000000 is a reserved enum value");
    static_assert(true, "-1000001 is a reserved enum value");
    static const bool kEmptyValueIsZero = false;
    static ::blink::mojom::ControllerServiceWorkerPurpose EmptyValue() { return static_cast<::blink::mojom::ControllerServiceWorkerPurpose>(-1000000); }
    static void ConstructDeletedValue(::blink::mojom::ControllerServiceWorkerPurpose& slot, bool) { slot = static_cast<::blink::mojom::ControllerServiceWorkerPurpose>(-1000001); }
...
// with not having this data in traces there.
    ...
    using RegisterCallback
        = base::OnceCallback<void(::blink::mojom::blink::ServiceWorkerErrorType, const WTF::String&, ::blink::mojom::blink::ServiceWorkerRegistrationObjectInfoPtr)>;
    ...
    using GetRegistrationsCallback = base::OnceCallback<void(
        ::blink::mojom::blink::ServiceWorkerErrorType, const WTF::String&, absl::optional<WTF::Vector<::blink::mojom::blink::ServiceWorkerRegistrationObjectInfoPtr>>)>;
...
//
//   void Register(const ::blink::KURL& script_url, ::blink::mojom::blink::ServiceWorkerRegistrationOptionsPtr options, ::blink::mojom::blink::FetchClientSettingsObjectPtr
//   outside_fetch_client_settings_object, RegisterCallback callback) final;
//
...
public:
    ...
    {
        return ServiceWorkerContainerInfoForClientPtr(absl::in_place, std::forward<Args>(args)...);
    }

    template <typename U> static ServiceWorkerContainerInfoForClientPtr From(const U& u) { return mojo::TypeConverter<ServiceWorkerContainerInfoForClientPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, ServiceWorkerContainerInfoForClient>::Convert(*this); }
    ...
    template <typename T, ServiceWorkerContainerInfoForClient::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    ...
    {
        return mojo::Message(std::make_unique<internal::ServiceWorkerContainerInfoForClient_UnserializedMessageContext<UserType, ServiceWorkerContainerInfoForClient::DataView>>(
                                 0, 0, std::move(input)),
    ...
    {
        return ServiceWorkerContainerInfoForClient::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }

    template <typename UserType> static bool DeserializeFromMessage(mojo::Message input, UserType* output)
    {
        auto context
            = input.TakeUnserializedContext<internal::ServiceWorkerContainerInfoForClient_UnserializedMessageContext<UserType, ServiceWorkerContainerInfoForClient::DataView>>();
        if (context) {
            *output = std::move(context->TakeData());
            return true;
        }
        input.SerializeIfNecessary();
        return mojo::internal::DeserializeImpl<ServiceWorkerContainerInfoForClient::DataView>(input, input.payload(), input.payload_num_bytes(), output, Validate);
    }
...
template <typename T, ServiceWorkerContainerInfoForClient::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, ServiceWorkerContainerInfoForClient::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, ServiceWorkerContainerInfoForClient::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
namespace mojo {
template <> struct CORE_EXPORT StructTraits<::blink::mojom::blink::ServiceWorkerContainerInfoForClient::DataView, ::blink::mojom::blink::ServiceWorkerContainerInfoForClientPtr> {
    ...
    static decltype(::blink::mojom::blink::ServiceWorkerContainerInfoForClient::host_remote)& host_remote(::blink::mojom::blink::ServiceWorkerContainerInfoForClientPtr& input)
    {
