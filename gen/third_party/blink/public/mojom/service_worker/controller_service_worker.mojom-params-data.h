...
static_assert(
    sizeof(ControllerServiceWorker_DispatchFetchEventForSubresource_Params_Data) == 24, "Bad sizeof(ControllerServiceWorker_DispatchFetchEventForSubresource_Params_Data)");
...
static_assert(sizeof(ControllerServiceWorkerConnector_UpdateController_Params_Data) == 16, "Bad sizeof(ControllerServiceWorkerConnector_UpdateController_Params_Data)");
...
public:
    ...
    ControllerServiceWorkerConnector_UpdateController_ParamsDataView(internal::ControllerServiceWorkerConnector_UpdateController_Params_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
    ...
    {
        UserType result;
        bool ret = mojo::internal::Deserialize<mojo::InterfacePtrDataView<::blink::mojom::ControllerServiceWorkerInterfaceBase>>(&data_->controller, &result, message_);
        DCHECK(ret);
        return result;
    }
