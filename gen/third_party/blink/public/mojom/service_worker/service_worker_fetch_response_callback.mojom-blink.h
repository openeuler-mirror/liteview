...
// with not having this data in traces there.
    ...
    virtual void OnFallback(absl::optional<::network::DataElementChunkedDataPipe> request_body, ServiceWorkerFetchEventTimingPtr timing) = 0;
};
...
//
//   void OnResponseStream(::blink::mojom::blink::FetchAPIResponsePtr response, ::blink::mojom::blink::ServiceWorkerStreamHandlePtr body_as_stream, ServiceWorkerFetchEventTimingPtr
//   timing) final;
//
//   void OnFallback(absl::optional<::network::DataElementChunkedDataPipe> request_body, ServiceWorkerFetchEventTimingPtr timing) final;
//
//  private:
...
public:
    ...
    {
        return ServiceWorkerFetchEventTimingPtr(absl::in_place, std::forward<Args>(args)...);
    }

    template <typename U> static ServiceWorkerFetchEventTimingPtr From(const U& u) { return mojo::TypeConverter<ServiceWorkerFetchEventTimingPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, ServiceWorkerFetchEventTiming>::Convert(*this); }
    ...
    template <typename T, ServiceWorkerFetchEventTiming::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::ServiceWorkerFetchEventTiming_UnserializedMessageContext<UserType, ServiceWorkerFetchEventTiming::DataView>>(0, 0, std::move(input)),
    ...
    {
        return ServiceWorkerFetchEventTiming::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }

    template <typename UserType> static bool DeserializeFromMessage(mojo::Message input, UserType* output)
    {
        auto context = input.TakeUnserializedContext<internal::ServiceWorkerFetchEventTiming_UnserializedMessageContext<UserType, ServiceWorkerFetchEventTiming::DataView>>();
        if (context) {
...
template <typename T, ServiceWorkerFetchEventTiming::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, ServiceWorkerFetchEventTiming::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, ServiceWorkerFetchEventTiming::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
namespace mojo {
template <> struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::ServiceWorkerFetchEventTiming::DataView, ::blink::mojom::blink::ServiceWorkerFetchEventTimingPtr> {
