...
public:
    ...
    ServiceWorkerProviderInfoForStartWorker(::mojo::PendingAssociatedRemote<::blink::mojom::blink::ServiceWorkerContainerHost> host_remote_in,
...
namespace mojo {
template <>
struct CORE_EXPORT StructTraits<::blink::mojom::blink::ServiceWorkerProviderInfoForStartWorker::DataView, ::blink::mojom::blink::ServiceWorkerProviderInfoForStartWorkerPtr> {
