...
bool ServiceWorkerInstalledScriptsInfo::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
ServiceWorkerScriptInfo::ServiceWorkerScriptInfo(const ::blink::KURL& script_url_in, const WTF::String& encoding_in, const WTF::HashMap<WTF::String, WTF::String>& headers_in,
...
bool ServiceWorkerScriptInfo::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send blink::mojom::ServiceWorkerInstalledScriptsManagerHost::RequestInstalledScript", "input_parameters", [&](perfetto::TracedValue context) {
    ...
    mojo::Message message(internal::kServiceWorkerInstalledScriptsManagerHost_RequestInstalledScript_Name, kFlags, 0, 0, nullptr);
...
bool ServiceWorkerInstalledScriptsManagerHostStubDispatch::Accept(ServiceWorkerInstalledScriptsManagerHost* impl, mojo::Message* message)
{
    ...
    case internal::kServiceWorkerInstalledScriptsManagerHost_RequestInstalledScript_Name: {
        ...
        if (success && !input_data_view.ReadScriptUrl(&p_script_url))
            success = false;
        if (!success) {
            ReportValidationErrorForMessage(message, mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED, ServiceWorkerInstalledScriptsManagerHost::Name_, 0, false);
            return false;
        }
...
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send blink::mojom::ServiceWorkerInstalledScriptsManager::TransferInstalledScript", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
    ...
    mojo::Message message(internal::kServiceWorkerInstalledScriptsManager_TransferInstalledScript_Name, kFlags, 0, 0, nullptr);
...
bool ServiceWorkerInstalledScriptsManagerStubDispatch::Accept(ServiceWorkerInstalledScriptsManager* impl, mojo::Message* message)
{
    ...
    case internal::kServiceWorkerInstalledScriptsManager_TransferInstalledScript_Name: {
        ...
        bool success = true;
        ServiceWorkerScriptInfoPtr p_script_info = mojo::DefaultConstructTraits::CreateInstance<ServiceWorkerScriptInfoPtr>();
        ...
        if (success && !input_data_view.ReadScriptInfo(&p_script_info))
            success = false;
        if (!success) {
            ReportValidationErrorForMessage(message, mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED, ServiceWorkerInstalledScriptsManager::Name_, 0, false);
            return false;
        }
        // A null |impl| means no implementation was bound.
        DCHECK(impl);
