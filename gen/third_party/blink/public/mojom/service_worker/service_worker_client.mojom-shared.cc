...
std::ostream& operator<<(std::ostream& os, ServiceWorkerClientType value) { return os << ServiceWorkerClientTypeToString(value); }
...
std::ostream& operator<<(std::ostream& os, ServiceWorkerClientLifecycleState value) { return os << ServiceWorkerClientLifecycleStateToString(value); }
...
// static
void TraceFormatTraits<::blink::mojom::ServiceWorkerClientLifecycleState>::WriteIntoTrace(perfetto::TracedValue context, ::blink::mojom::ServiceWorkerClientLifecycleState value)
{
