...
static_assert(sizeof(ServiceWorkerObjectHost_PostMessageToServiceWorker_Params_Data) == 16, "Bad sizeof(ServiceWorkerObjectHost_PostMessageToServiceWorker_Params_Data)");
...
static_assert(sizeof(ServiceWorkerObjectHost_TerminateForTesting_ResponseParams_Data) == 8, "Bad sizeof(ServiceWorkerObjectHost_TerminateForTesting_ResponseParams_Data)");
...
public:
    ...
    ServiceWorkerObjectHost_PostMessageToServiceWorker_ParamsDataView(internal::ServiceWorkerObjectHost_PostMessageToServiceWorker_Params_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
...
public:
    ...
    ServiceWorkerObjectHost_TerminateForTesting_ResponseParamsDataView(internal::ServiceWorkerObjectHost_TerminateForTesting_ResponseParams_Data* data, mojo::Message* message)
        : data_(data)
    {
    }
...
public:
    ...
    ::blink::mojom::ServiceWorkerState state() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::blink::mojom::ServiceWorkerState>(data_->state)); }
