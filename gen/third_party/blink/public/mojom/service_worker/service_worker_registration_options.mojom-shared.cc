...
std::ostream& operator<<(std::ostream& os, ServiceWorkerUpdateViaCache value) { return os << ServiceWorkerUpdateViaCacheToString(value); }
...
// static
void TraceFormatTraits<::blink::mojom::ServiceWorkerUpdateViaCache>::WriteIntoTrace(perfetto::TracedValue context, ::blink::mojom::ServiceWorkerUpdateViaCache value)
{
