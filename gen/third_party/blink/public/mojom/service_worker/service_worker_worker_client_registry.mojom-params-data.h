...
static_assert(sizeof(ServiceWorkerWorkerClientRegistry_RegisterWorkerClient_Params_Data) == 16, "Bad sizeof(ServiceWorkerWorkerClientRegistry_RegisterWorkerClient_Params_Data)");
...
static_assert(
    sizeof(ServiceWorkerWorkerClientRegistry_CloneWorkerClientRegistry_Params_Data) == 16, "Bad sizeof(ServiceWorkerWorkerClientRegistry_CloneWorkerClientRegistry_Params_Data)");
...
public:
    ...
    {
        UserType result;
        bool ret = mojo::internal::Deserialize<mojo::InterfacePtrDataView<::blink::mojom::ServiceWorkerWorkerClientInterfaceBase>>(&data_->client, &result, message_);
        DCHECK(ret);
        return result;
    }
...
public:
    ...
    {
        UserType result;
        bool ret = mojo::internal::Deserialize<mojo::InterfaceRequestDataView<::blink::mojom::ServiceWorkerWorkerClientRegistryInterfaceBase>>(&data_->host, &result, message_);
        DCHECK(ret);
        return result;
    }
