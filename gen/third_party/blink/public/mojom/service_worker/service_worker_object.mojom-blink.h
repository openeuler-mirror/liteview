...
template <> struct CORE_EXPORT StructTraits<::blink::mojom::blink::ServiceWorkerObjectInfo::DataView, ::blink::mojom::blink::ServiceWorkerObjectInfoPtr> {
    ...
    static decltype(::blink::mojom::blink::ServiceWorkerObjectInfo::state) state(const ::blink::mojom::blink::ServiceWorkerObjectInfoPtr& input) { return input->state; }

    static const decltype(::blink::mojom::blink::ServiceWorkerObjectInfo::url)& url(const ::blink::mojom::blink::ServiceWorkerObjectInfoPtr& input) { return input->url; }
    ...
    static decltype(::blink::mojom::blink::ServiceWorkerObjectInfo::receiver)& receiver(::blink::mojom::blink::ServiceWorkerObjectInfoPtr& input) { return input->receiver; }
