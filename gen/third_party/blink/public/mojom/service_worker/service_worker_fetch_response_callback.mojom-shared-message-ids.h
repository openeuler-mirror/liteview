...
constexpr uint32_t kServiceWorkerFetchResponseCallback_OnResponseStream_Name = 1;
constexpr uint32_t kServiceWorkerFetchResponseCallback_OnFallback_Name = 2;
