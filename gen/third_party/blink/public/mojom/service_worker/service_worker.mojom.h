...
// with not having this data in traces there.
    ...
    virtual void DispatchNotificationClickEvent(const std::string& notification_id, const ::blink::PlatformNotificationData& notification_data, int32_t action_index,
        const absl::optional<::std::u16string>& reply, DispatchNotificationClickEventCallback callback)
        = 0;
    ...
    virtual void DispatchPushSubscriptionChangeEvent(
...
//
//   void InitializeGlobalScope(::mojo::PendingAssociatedRemote<ServiceWorkerHost> service_worker_host, ::blink::mojom::ServiceWorkerRegistrationObjectInfoPtr registration_info,
//   ::blink::mojom::ServiceWorkerObjectInfoPtr service_worker_info, FetchHandlerExistence fetch_handler_existence, ::mojo::PendingReceiver<::blink::mojom::ReportingObserver>
//   reporting_observer_receiver, ::blink::mojom::AncestorFrameType ancestor_frame_type) final;
//
...
//
//   void DispatchFetchEventForMainResource(::blink::mojom::DispatchFetchEventParamsPtr params, ::mojo::PendingRemote<::blink::mojom::ServiceWorkerFetchResponseCallback>
//   response_callback, DispatchFetchEventForMainResourceCallback callback) final;
//
//   void DispatchNotificationClickEvent(const std::string& notification_id, const ::blink::PlatformNotificationData& notification_data, int32_t action_index, const
//   absl::optional<::std::u16string>& reply, DispatchNotificationClickEventCallback callback) final;
//
//   void DispatchNotificationCloseEvent(const std::string& notification_id, const ::blink::PlatformNotificationData& notification_data, DispatchNotificationCloseEventCallback
//   callback) final;
//
...
//
//   void DispatchAbortPaymentEvent(::mojo::PendingRemote<::payments::mojom::PaymentHandlerResponseCallback> result_of_abort_payment, DispatchAbortPaymentEventCallback callback)
//   final;
//
//   void DispatchCanMakePaymentEvent(::payments::mojom::CanMakePaymentEventDataPtr event_data, ::mojo::PendingRemote<::payments::mojom::PaymentHandlerResponseCallback>
//   result_of_can_make_payment, DispatchCanMakePaymentEventCallback callback) final;
//
//   void DispatchPaymentRequestEvent(::payments::mojom::PaymentRequestEventDataPtr request_data, ::mojo::PendingRemote<::payments::mojom::PaymentHandlerResponseCallback>
//   response_callback, DispatchPaymentRequestEventCallback callback) final;
//
...
public:
    ...
    ExtendableMessageEvent(::blink::TransferableMessage message_in, const ::url::Origin& source_origin_in, ::blink::mojom::ServiceWorkerClientInfoPtr source_info_for_client_in,
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::ExtendableMessageEvent::DataView, ::blink::mojom::ExtendableMessageEventPtr> {
    ...
    static decltype(::blink::mojom::ExtendableMessageEvent::message)& message(::blink::mojom::ExtendableMessageEventPtr& input) { return input->message; }
    ...
    static const decltype(::blink::mojom::ExtendableMessageEvent::source_info_for_client)& source_info_for_client(const ::blink::mojom::ExtendableMessageEventPtr& input)
    {
        return input->source_info_for_client;
    }

    static decltype(::blink::mojom::ExtendableMessageEvent::source_info_for_service_worker)& source_info_for_service_worker(::blink::mojom::ExtendableMessageEventPtr& input)
    {
