...
public:
    ...
    template <typename... Args> static ServiceWorkerObjectInfoPtr New(Args&&... args) { return ServiceWorkerObjectInfoPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static ServiceWorkerObjectInfoPtr From(const U& u) { return mojo::TypeConverter<ServiceWorkerObjectInfoPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, ServiceWorkerObjectInfo>::Convert(*this); }
    ...
    template <typename T, ServiceWorkerObjectInfo::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    ...
    {
        return mojo::Message(std::make_unique<internal::ServiceWorkerObjectInfo_UnserializedMessageContext<UserType, ServiceWorkerObjectInfo::DataView>>(0, 0, std::move(input)),
    ...
    {
        return ServiceWorkerObjectInfo::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }

    template <typename UserType> static bool DeserializeFromMessage(mojo::Message input, UserType* output)
    {
        auto context = input.TakeUnserializedContext<internal::ServiceWorkerObjectInfo_UnserializedMessageContext<UserType, ServiceWorkerObjectInfo::DataView>>();
        if (context) {
...
template <typename T, ServiceWorkerObjectInfo::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, ServiceWorkerObjectInfo::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, ServiceWorkerObjectInfo::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::ServiceWorkerObjectInfo::DataView, ::blink::mojom::ServiceWorkerObjectInfoPtr> {
    ...
    static decltype(::blink::mojom::ServiceWorkerObjectInfo::version_id) version_id(const ::blink::mojom::ServiceWorkerObjectInfoPtr& input) { return input->version_id; }

    static decltype(::blink::mojom::ServiceWorkerObjectInfo::state) state(const ::blink::mojom::ServiceWorkerObjectInfoPtr& input) { return input->state; }

    static const decltype(::blink::mojom::ServiceWorkerObjectInfo::url)& url(const ::blink::mojom::ServiceWorkerObjectInfoPtr& input) { return input->url; }

    static decltype(::blink::mojom::ServiceWorkerObjectInfo::host_remote)& host_remote(::blink::mojom::ServiceWorkerObjectInfoPtr& input) { return input->host_remote; }

    static decltype(::blink::mojom::ServiceWorkerObjectInfo::receiver)& receiver(::blink::mojom::ServiceWorkerObjectInfoPtr& input) { return input->receiver; }
