...
public:
    ...
    {
        return ServiceWorkerProviderInfoForStartWorkerPtr(absl::in_place, std::forward<Args>(args)...);
    }
    ...
    template <typename U> U To() const { return mojo::TypeConverter<U, ServiceWorkerProviderInfoForStartWorker>::Convert(*this); }
    ...
    ServiceWorkerProviderInfoForStartWorker(::mojo::PendingAssociatedRemote<::blink::mojom::ServiceWorkerContainerHost> host_remote_in,
        ::mojo::PendingRemote<::network::mojom::URLLoaderFactory> script_loader_factory_remote_in, ::mojo::PendingRemote<::blink::mojom::CacheStorage> cache_storage_in,
    ...
    template <typename T, ServiceWorkerProviderInfoForStartWorker::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::ServiceWorkerProviderInfoForStartWorker_UnserializedMessageContext<UserType, ServiceWorkerProviderInfoForStartWorker::DataView>>(
                0, 0, std::move(input)),
    ...
    {
        return ServiceWorkerProviderInfoForStartWorker::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
    ...
    template <typename UserType> static bool DeserializeFromMessage(mojo::Message input, UserType* output)
    {
        ...
        return mojo::internal::DeserializeImpl<ServiceWorkerProviderInfoForStartWorker::DataView>(input, input.payload(), input.payload_num_bytes(), output, Validate);
    }
...
template <typename T, ServiceWorkerProviderInfoForStartWorker::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, ServiceWorkerProviderInfoForStartWorker::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, ServiceWorkerProviderInfoForStartWorker::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
template <typename T, ServiceWorkerProviderInfoForStartWorker::EnableIfSame<T>*> bool ServiceWorkerProviderInfoForStartWorker::Equals(const T& other_struct) const
{
...
namespace mojo {
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::ServiceWorkerProviderInfoForStartWorker::DataView, ::blink::mojom::ServiceWorkerProviderInfoForStartWorkerPtr> {
    ...
    static decltype(::blink::mojom::ServiceWorkerProviderInfoForStartWorker::host_remote)& host_remote(::blink::mojom::ServiceWorkerProviderInfoForStartWorkerPtr& input)
    {
    ...
    static decltype(::blink::mojom::ServiceWorkerProviderInfoForStartWorker::cache_storage)& cache_storage(::blink::mojom::ServiceWorkerProviderInfoForStartWorkerPtr& input)
    {
