...
std::ostream& operator<<(std::ostream& os, ServiceWorkerErrorType value) { return os << ServiceWorkerErrorTypeToString(value); }
...
std::ostream& operator<<(std::ostream& os, ServiceWorkerResponseError value) { return os << ServiceWorkerResponseErrorToString(value); }
...
// static
void TraceFormatTraits<::blink::mojom::ServiceWorkerResponseError>::WriteIntoTrace(perfetto::TracedValue context, ::blink::mojom::ServiceWorkerResponseError value)
{
