...
static_assert(sizeof(EmbeddedWorkerStartParams_Data) == 192, "Bad sizeof(EmbeddedWorkerStartParams_Data)");
// Used by EmbeddedWorkerStartParams::WrapAsMessage to lazily serialize the struct.
template <typename UserType, typename DataView> struct EmbeddedWorkerStartParams_UnserializedMessageContext : public mojo::internal::UnserializedMessageContext {
public:
...
template <typename UserType, typename DataView> struct EmbeddedWorkerStartTiming_UnserializedMessageContext : public mojo::internal::UnserializedMessageContext {
public:
    static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;
