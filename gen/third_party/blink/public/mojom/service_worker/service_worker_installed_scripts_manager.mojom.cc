...
ServiceWorkerScriptInfo::ServiceWorkerScriptInfo(const ::GURL& script_url_in, const std::string& encoding_in, const base::flat_map<std::string, std::string>& headers_in,
