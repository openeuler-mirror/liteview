...
class CORE_EXPORT ControllerServiceWorkerInterceptorForTesting : public ControllerServiceWorker {
    ...
    void DispatchFetchEventForSubresource(::blink::mojom::blink::DispatchFetchEventParamsPtr params,
        ::mojo::PendingRemote<::blink::mojom::blink::ServiceWorkerFetchResponseCallback> response_callback, DispatchFetchEventForSubresourceCallback callback) override;
...
public:
    ...
    ::blink::mojom::blink::ServiceWorkerEventStatus DispatchFetchEventForSubresource(
