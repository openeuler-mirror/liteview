...
struct blink_mojom_internal_FetchHandlerExistence_DataHashFn {
    ...
    static bool Equal(const ::blink::mojom::FetchHandlerExistence& left, const ::blink::mojom::FetchHandlerExistence& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::blink::mojom::FetchHandlerExistence> : public GenericHashTraits<::blink::mojom::FetchHandlerExistence> {
    static_assert(true, "-1000000 is a reserved enum value");
    static_assert(true, "-1000001 is a reserved enum value");
    static const bool kEmptyValueIsZero = false;
    static ::blink::mojom::FetchHandlerExistence EmptyValue() { return static_cast<::blink::mojom::FetchHandlerExistence>(-1000000); }
    static void ConstructDeletedValue(::blink::mojom::FetchHandlerExistence& slot, bool) { slot = static_cast<::blink::mojom::FetchHandlerExistence>(-1000001); }
    static bool IsDeletedValue(const ::blink::mojom::FetchHandlerExistence& value) { return value == static_cast<::blink::mojom::FetchHandlerExistence>(-1000001); }
};
} // namespace WTF
namespace blink {
namespace mojom {
...
// with not having this data in traces there.
    ...
    virtual void DispatchNotificationClickEvent(const WTF::String& notification_id, ::blink::mojom::blink::NotificationDataPtr notification_data, int32_t action_index,
        const ::WTF::String& reply, DispatchNotificationClickEventCallback callback)
        = 0;
    ...
    virtual void DispatchPushSubscriptionChangeEvent(::blink::mojom::blink::PushSubscriptionPtr old_subscription, ::blink::mojom::blink::PushSubscriptionPtr new_subscription,
    ...
    //
    //   virtual void DispatchAbortPaymentEvent(::mojo::PendingRemote<::payments::mojom::blink::PaymentHandlerResponseCallback> result_of_abort_payment,
    //   DispatchAbortPaymentEventCallback callback) = 0;
    //
    //
    ...
    //   ::mojo::PendingRemote<::payments::mojom::blink::PaymentHandlerResponseCallback> result_of_can_make_payment, DispatchCanMakePaymentEventCallback callback) = 0;
    //
    //
    ...
    //   ::mojo::PendingRemote<::payments::mojom::blink::PaymentHandlerResponseCallback> response_callback, DispatchPaymentRequestEventCallback callback) = 0;
...
//
//   void InitializeGlobalScope(::mojo::PendingAssociatedRemote<ServiceWorkerHost> service_worker_host, ::blink::mojom::blink::ServiceWorkerRegistrationObjectInfoPtr
//   registration_info, ::blink::mojom::blink::ServiceWorkerObjectInfoPtr service_worker_info, FetchHandlerExistence fetch_handler_existence,
//   ::mojo::PendingReceiver<::blink::mojom::blink::ReportingObserver> reporting_observer_receiver, ::blink::mojom::blink::AncestorFrameType ancestor_frame_type) final;
//
...
//   ::mojo::PendingRemote<::blink::mojom::blink::ServiceWorkerFetchResponseCallback> response_callback, DispatchFetchEventForMainResourceCallback callback) final;
//
//   void DispatchNotificationClickEvent(const WTF::String& notification_id, ::blink::mojom::blink::NotificationDataPtr notification_data, int32_t action_index, const
//   ::WTF::String& reply, DispatchNotificationClickEventCallback callback) final;
//
//   void DispatchNotificationCloseEvent(const WTF::String& notification_id, ::blink::mojom::blink::NotificationDataPtr notification_data, DispatchNotificationCloseEventCallback
//   callback) final;
//
//   void DispatchPushEvent(const WTF::String& payload, DispatchPushEventCallback callback) final;
//
//   void DispatchPushSubscriptionChangeEvent(::blink::mojom::blink::PushSubscriptionPtr old_subscription, ::blink::mojom::blink::PushSubscriptionPtr new_subscription,
...
//
//    void DispatchAbortPaymentEvent(::mojo::PendingRemote<::payments::mojom::blink::PaymentHandlerResponseCallback> result_of_abort_payment, DispatchAbortPaymentEventCallback
//    callback) final;
//
//    void DispatchCanMakePaymentEvent(::payments::mojom::blink::CanMakePaymentEventDataPtr event_data,
//    ::mojo::PendingRemote<::payments::mojom::blink::PaymentHandlerResponseCallback> result_of_can_make_payment, DispatchCanMakePaymentEventCallback callback) final;
//
...
public:
    ...
    template <typename... Args> static ExtendableMessageEventPtr New(Args&&... args) { return ExtendableMessageEventPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static ExtendableMessageEventPtr From(const U& u) { return mojo::TypeConverter<ExtendableMessageEventPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, ExtendableMessageEvent>::Convert(*this); }
    ...
    ExtendableMessageEvent(::blink::BlinkTransferableMessage message_in, const ::scoped_refptr<const ::blink::SecurityOrigin>& source_origin_in,
    ...
    template <typename T, ExtendableMessageEvent::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    ...
    {
        return mojo::Message(std::make_unique<internal::ExtendableMessageEvent_UnserializedMessageContext<UserType, ExtendableMessageEvent::DataView>>(0, 0, std::move(input)),
    ...
    {
        return ExtendableMessageEvent::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, ExtendableMessageEvent::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, ExtendableMessageEvent::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, ExtendableMessageEvent::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
template <> struct CORE_EXPORT StructTraits<::blink::mojom::blink::ExtendableMessageEvent::DataView, ::blink::mojom::blink::ExtendableMessageEventPtr> {
    ...
    static decltype(::blink::mojom::blink::ExtendableMessageEvent::message)& message(::blink::mojom::blink::ExtendableMessageEventPtr& input) { return input->message; }

    static const decltype(::blink::mojom::blink::ExtendableMessageEvent::source_origin)& source_origin(const ::blink::mojom::blink::ExtendableMessageEventPtr& input)
    {
