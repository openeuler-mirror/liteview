...
ControllerServiceWorkerInfo::ControllerServiceWorkerInfo(::blink::mojom::blink::ControllerServiceWorkerMode mode_in,
    ::blink::mojom::blink::ServiceWorkerFetchHandlerType fetch_handler_type_in, ::blink::mojom::blink::ServiceWorkerFetchHandlerType effective_fetch_handler_type_in,
    ::mojo::PendingRemote<ControllerServiceWorker> remote_controller_in, const WTF::String& client_id_in,
    const absl::optional<::base::UnguessableToken>& fetch_request_window_id_in, ::blink::mojom::blink::ServiceWorkerObjectInfoPtr object_info_in,
...
void ControllerServiceWorkerInfo::WriteIntoTrace(perfetto::TracedValue traced_context) const
{
    ...
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("effective_fetch_handler_type"), this->effective_fetch_handler_type,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
        "<value of type ::blink::mojom::blink::ServiceWorkerFetchHandlerType>"
#else
        "<value>"
...
bool ControllerServiceWorkerInfo::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
public:
    ...
    ControllerServiceWorker_DispatchFetchEventForSubresource_ForwardToCallback& operator=(const ControllerServiceWorker_DispatchFetchEventForSubresource_ForwardToCallback&)
        = delete;
...
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send blink::mojom::ControllerServiceWorker::DispatchFetchEventForSubresource", "input_parameters", [&](perfetto::TracedValue context) {
    ...
    mojo::Message message(internal::kControllerServiceWorker_DispatchFetchEventForSubresource_Name, kFlags, 0, 0, nullptr);
    ...
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
        params->params.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null params in ControllerServiceWorker.DispatchFetchEventForSubresource request");
...
void ControllerServiceWorkerProxy::Clone(::mojo::PendingReceiver<ControllerServiceWorker> in_receiver, const ::network::CrossOriginEmbedderPolicy& in_cross_origin_embedder_policy,
    ::mojo::PendingRemote<::network::mojom::blink::CrossOriginEmbedderPolicyReporter> in_coep_reporter)
{
    ...
    TRACE_EVENT1("mojom", "Send blink::mojom::ControllerServiceWorker::Clone", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("coep_reporter"), in_coep_reporter, "<value of type ::mojo::PendingRemote<::network::mojom::blink::CrossOriginEmbedderPolicyReporter>>");
    });
#endif
    ...
    mojo::Message message(internal::kControllerServiceWorker_Clone_Name, kFlags, 0, 0, nullptr);
...
public:
    static ControllerServiceWorker::DispatchFetchEventForSubresourceCallback CreateCallback(::mojo::Message& message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
    {
...
private:
    ControllerServiceWorker_DispatchFetchEventForSubresource_ProxyToResponder(::mojo::Message& message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
...
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send reply blink::mojom::ControllerServiceWorker::DispatchFetchEventForSubresource", "async_response_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
...
bool ControllerServiceWorkerStubDispatch::Accept(ControllerServiceWorker* impl, mojo::Message* message)
{
    ...
    case internal::kControllerServiceWorker_Clone_Name: {
        ...
        DCHECK(message->is_serialized());
        internal::ControllerServiceWorker_Clone_Params_Data* params = reinterpret_cast<internal::ControllerServiceWorker_Clone_Params_Data*>(message->mutable_payload());

        bool success = true;
        ::mojo::PendingReceiver<ControllerServiceWorker> p_receiver = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingReceiver<ControllerServiceWorker>>();
        ::network::CrossOriginEmbedderPolicy p_cross_origin_embedder_policy = mojo::DefaultConstructTraits::CreateInstance<::network::CrossOriginEmbedderPolicy>();
        ::mojo::PendingRemote<::network::mojom::blink::CrossOriginEmbedderPolicyReporter> p_coep_reporter
            = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingRemote<::network::mojom::blink::CrossOriginEmbedderPolicyReporter>>();
...
// static
bool ControllerServiceWorkerStubDispatch::AcceptWithResponder(ControllerServiceWorker* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
{
...
static const std::pair<uint32_t, mojo::internal::GenericValidationInfo> kControllerServiceWorkerValidationInfo[] = {
    ...
    { internal::kControllerServiceWorker_Clone_Name, { &internal::ControllerServiceWorker_Clone_Params_Data::Validate, nullptr /* no response */ } },
};
...
void ControllerServiceWorkerConnectorProxy::UpdateController(::mojo::PendingRemote<ControllerServiceWorker> in_controller)
{
    ...
    mojo::Message message(internal::kControllerServiceWorkerConnector_UpdateController_Name, kFlags, 0, 0, nullptr);
    ...
    params.Allocate();
    mojo::internal::Serialize<mojo::InterfacePtrDataView<::blink::mojom::ControllerServiceWorkerInterfaceBase>>(in_controller, &params->controller, &params.message());
...
bool ControllerServiceWorkerConnectorStubDispatch::Accept(ControllerServiceWorkerConnector* impl, mojo::Message* message)
{
    ...
    case internal::kControllerServiceWorkerConnector_UpdateController_Name: {
        ...
        bool success = true;
        ::mojo::PendingRemote<ControllerServiceWorker> p_controller = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingRemote<ControllerServiceWorker>>();
        ...
        if (!success) {
            ReportValidationErrorForMessage(message, mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED, ControllerServiceWorkerConnector::Name_, 0, false);
            return false;
        }
        // A null |impl| means no implementation was bound.
        DCHECK(impl);
    ...
    ::blink::mojom::blink::ControllerServiceWorkerInfo::DataView input, ::blink::mojom::blink::ControllerServiceWorkerInfoPtr* output)
{
    ...
    if (success && !input.ReadFetchHandlerType(&result->fetch_handler_type))
        success = false;
    if (success && !input.ReadEffectiveFetchHandlerType(&result->effective_fetch_handler_type))
        success = false;
    if (success) {
...
void ControllerServiceWorkerInterceptorForTesting::Clone(::mojo::PendingReceiver<ControllerServiceWorker> receiver,
    const ::network::CrossOriginEmbedderPolicy& cross_origin_embedder_policy, ::mojo::PendingRemote<::network::mojom::blink::CrossOriginEmbedderPolicyReporter> coep_reporter)
{
