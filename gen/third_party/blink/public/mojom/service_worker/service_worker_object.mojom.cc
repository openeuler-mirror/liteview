...
bool ServiceWorkerObjectStubDispatch::Accept(ServiceWorkerObject* impl, mojo::Message* message)
{
    ...
    case internal::kServiceWorkerObject_StateChanged_Name: {
        ...
        bool success = true;
        ::blink::mojom::ServiceWorkerState p_state = mojo::DefaultConstructTraits::CreateInstance<::blink::mojom::ServiceWorkerState>();
...
void ServiceWorkerObjectInterceptorForTesting::StateChanged(::blink::mojom::ServiceWorkerState state) { GetForwardingInterface()->StateChanged(std::move(state)); }
