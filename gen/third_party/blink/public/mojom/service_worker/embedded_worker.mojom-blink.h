...
// with not having this data in traces there.
    ...
    virtual void OnStarted(::blink::mojom::blink::ServiceWorkerStartStatus status, ::blink::mojom::blink::ServiceWorkerFetchHandlerType fetch_handler_type, int32_t thread_id,
    ...
    virtual void OnReportConsoleMessage(::blink::mojom::blink::ConsoleMessageSource source, ::blink::mojom::blink::ConsoleMessageLevel message_level, const ::WTF::String& message,
        int32_t line_number, const ::blink::KURL& source_url)
        = 0;
...
//
//   void OnReadyForInspection(::mojo::PendingRemote<::blink::mojom::blink::DevToolsAgent> agent, ::mojo::PendingReceiver<::blink::mojom::blink::DevToolsAgentHost> agent_host)
//   final;
//
...
//
//   void OnStarted(::blink::mojom::blink::ServiceWorkerStartStatus status, ::blink::mojom::blink::ServiceWorkerFetchHandlerType fetch_handler_type, int32_t thread_id,
...
//
//   void OnReportConsoleMessage(::blink::mojom::blink::ConsoleMessageSource source, ::blink::mojom::blink::ConsoleMessageLevel message_level, const ::WTF::String& message, int32_t
//   line_number, const ::blink::KURL& source_url) final;
//
...
public:
    ...
    EmbeddedWorkerStartParams(int64_t service_worker_version_id_in, const ::blink::KURL& scope_in, const ::blink::KURL& script_url_in,
        ...
        const ::base::UnguessableToken& devtools_worker_token_in, const ::blink::KURL& script_url_to_skip_throttling_in, bool wait_for_debugger_in, bool is_installed_in,
        const ::blink::RendererPreferences& renderer_preferences_in, WTF::Vector<WTF::String> forced_enabled_runtime_features_in,
...
template <> struct CORE_EXPORT StructTraits<::blink::mojom::blink::EmbeddedWorkerStartParams::DataView, ::blink::mojom::blink::EmbeddedWorkerStartParamsPtr> {
    ...
    static const decltype(::blink::mojom::blink::EmbeddedWorkerStartParams::scope)& scope(const ::blink::mojom::blink::EmbeddedWorkerStartParamsPtr& input) { return input->scope; }

    static const decltype(::blink::mojom::blink::EmbeddedWorkerStartParams::script_url)& script_url(const ::blink::mojom::blink::EmbeddedWorkerStartParamsPtr& input)
    {
    ...
    static const decltype(::blink::mojom::blink::EmbeddedWorkerStartParams::user_agent)& user_agent(const ::blink::mojom::blink::EmbeddedWorkerStartParamsPtr& input)
    {
        return input->user_agent;
    }

    static const decltype(::blink::mojom::blink::EmbeddedWorkerStartParams::ua_metadata)& ua_metadata(const ::blink::mojom::blink::EmbeddedWorkerStartParamsPtr& input)
    {
    ...
    static decltype(::blink::mojom::blink::EmbeddedWorkerStartParams::wait_for_debugger) wait_for_debugger(const ::blink::mojom::blink::EmbeddedWorkerStartParamsPtr& input)
    {
        return input->wait_for_debugger;
    }

    static decltype(::blink::mojom::blink::EmbeddedWorkerStartParams::is_installed) is_installed(const ::blink::mojom::blink::EmbeddedWorkerStartParamsPtr& input)
    {
    ...
    static decltype(::blink::mojom::blink::EmbeddedWorkerStartParams::service_worker_receiver)& service_worker_receiver(::blink::mojom::blink::EmbeddedWorkerStartParamsPtr& input)
    {
        return input->service_worker_receiver;
    }

    static decltype(::blink::mojom::blink::EmbeddedWorkerStartParams::interface_provider)& interface_provider(::blink::mojom::blink::EmbeddedWorkerStartParamsPtr& input)
    {
        return input->interface_provider;
    }

    static decltype(::blink::mojom::blink::EmbeddedWorkerStartParams::controller_receiver)& controller_receiver(::blink::mojom::blink::EmbeddedWorkerStartParamsPtr& input)
    {
        return input->controller_receiver;
    }

    static decltype(::blink::mojom::blink::EmbeddedWorkerStartParams::installed_scripts_info)& installed_scripts_info(::blink::mojom::blink::EmbeddedWorkerStartParamsPtr& input)
    {
    ...
    static decltype(::blink::mojom::blink::EmbeddedWorkerStartParams::content_settings_proxy)& content_settings_proxy(::blink::mojom::blink::EmbeddedWorkerStartParamsPtr& input)
    {
    ...
    static decltype(::blink::mojom::blink::EmbeddedWorkerStartParams::ukm_source_id) ukm_source_id(const ::blink::mojom::blink::EmbeddedWorkerStartParamsPtr& input)
    {
        return input->ukm_source_id;
    }

    static decltype(::blink::mojom::blink::EmbeddedWorkerStartParams::main_script_load_params)& main_script_load_params(::blink::mojom::blink::EmbeddedWorkerStartParamsPtr& input)
    {
        return input->main_script_load_params;
    }

    static decltype(::blink::mojom::blink::EmbeddedWorkerStartParams::policy_container)& policy_container(::blink::mojom::blink::EmbeddedWorkerStartParamsPtr& input)
    {
