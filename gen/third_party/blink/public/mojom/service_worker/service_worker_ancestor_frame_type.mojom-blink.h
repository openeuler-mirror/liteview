...
struct blink_mojom_internal_AncestorFrameType_DataHashFn {
    ...
    static bool Equal(const ::blink::mojom::AncestorFrameType& left, const ::blink::mojom::AncestorFrameType& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::blink::mojom::AncestorFrameType> : public GenericHashTraits<::blink::mojom::AncestorFrameType> {
    ...
    static void ConstructDeletedValue(::blink::mojom::AncestorFrameType& slot, bool) { slot = static_cast<::blink::mojom::AncestorFrameType>(-1000001); }
    static bool IsDeletedValue(const ::blink::mojom::AncestorFrameType& value) { return value == static_cast<::blink::mojom::AncestorFrameType>(-1000001); }
};
} // namespace WTF
namespace blink {
namespace mojom {
