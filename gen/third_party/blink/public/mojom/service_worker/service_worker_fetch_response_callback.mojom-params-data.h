...
static_assert(sizeof(ServiceWorkerFetchResponseCallback_OnResponseStream_Params_Data) == 32, "Bad sizeof(ServiceWorkerFetchResponseCallback_OnResponseStream_Params_Data)");
...
public:
    ...
    ServiceWorkerFetchResponseCallback_OnResponse_ParamsDataView(internal::ServiceWorkerFetchResponseCallback_OnResponse_Params_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
...
public:
    ...
    ServiceWorkerFetchResponseCallback_OnResponseStream_ParamsDataView(internal::ServiceWorkerFetchResponseCallback_OnResponseStream_Params_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
...
public:
    ...
    ServiceWorkerFetchResponseCallback_OnFallback_ParamsDataView(internal::ServiceWorkerFetchResponseCallback_OnFallback_Params_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
...
inline void ServiceWorkerFetchResponseCallback_OnResponseStream_ParamsDataView::GetBodyAsStreamDataView(::blink::mojom::ServiceWorkerStreamHandleDataView* output)
{
    auto pointer = data_->body_as_stream.Get();
