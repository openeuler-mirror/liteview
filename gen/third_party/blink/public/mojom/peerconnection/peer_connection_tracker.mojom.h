...
public:
    ...
    PeerConnectionInfo(int32_t lid_in, const std::string& rtc_configuration_in, const std::string& constraints_in, const absl::optional<std::string>& url_in)
        : lid(std::move(lid_in))
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::PeerConnectionInfo::DataView, ::blink::mojom::PeerConnectionInfoPtr> {
    ...
    static decltype(::blink::mojom::PeerConnectionInfo::lid) lid(const ::blink::mojom::PeerConnectionInfoPtr& input) { return input->lid; }
    ...
    static const decltype(::blink::mojom::PeerConnectionInfo::constraints)& constraints(const ::blink::mojom::PeerConnectionInfoPtr& input) { return input->constraints; }

    static const decltype(::blink::mojom::PeerConnectionInfo::url)& url(const ::blink::mojom::PeerConnectionInfoPtr& input) { return input->url; }
