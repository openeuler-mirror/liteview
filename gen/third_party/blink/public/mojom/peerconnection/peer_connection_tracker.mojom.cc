...
PeerConnectionInfo::PeerConnectionInfo(int32_t lid_in, const std::string& rtc_configuration_in, const std::string& constraints_in, const absl::optional<std::string>& url_in)
    : lid(std::move(lid_in))
...
bool PeerConnectionTrackerHostStubDispatch::Accept(PeerConnectionTrackerHost* impl, mojo::Message* message)
{
    ...
    case internal::kPeerConnectionTrackerHost_GetUserMedia_Name: {
        ...
        std::string p_audio_constraints = mojo::DefaultConstructTraits::CreateInstance<std::string>();
        std::string p_video_constraints = mojo::DefaultConstructTraits::CreateInstance<std::string>();
    ...
    case internal::kPeerConnectionTrackerHost_GetUserMediaSuccess_Name: {
        ...
        bool success = true;
        int32_t p_request_id = mojo::DefaultConstructTraits::CreateInstance<int32_t>();
        std::string p_stream_id = mojo::DefaultConstructTraits::CreateInstance<std::string>();
        std::string p_audio_track_info = mojo::DefaultConstructTraits::CreateInstance<std::string>();
        std::string p_video_track_info = mojo::DefaultConstructTraits::CreateInstance<std::string>();
    ...
    case internal::kPeerConnectionTrackerHost_WebRtcEventLogWrite_Name: {
        ...
        bool success = true;
        int32_t p_lid = mojo::DefaultConstructTraits::CreateInstance<int32_t>();
        std::vector<uint8_t> p_output = mojo::DefaultConstructTraits::CreateInstance<std::vector<uint8_t>>();
