...
std::ostream& operator<<(std::ostream& os, FilterListResult value) { return os << FilterListResultToString(value); }
...
std::ostream& operator<<(std::ostream& os, FrameCreationStackEvidence value) { return os << FrameCreationStackEvidenceToString(value); }
...
// static
void TraceFormatTraits<::blink::mojom::FrameCreationStackEvidence>::WriteIntoTrace(perfetto::TracedValue context, ::blink::mojom::FrameCreationStackEvidence value)
{
