...
bool BackgroundFetchSettledFetch::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
bool BackgroundFetchOptions::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
BackgroundFetchRegistrationData::BackgroundFetchRegistrationData(const std::string& developer_id_in, uint64_t upload_total_in, uint64_t uploaded_in, uint64_t download_total_in,
    uint64_t downloaded_in, BackgroundFetchResult result_in, BackgroundFetchFailureReason failure_reason_in)
...
bool BackgroundFetchRegistrationData::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
bool BackgroundFetchRegistration::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
bool BackgroundFetchUkmData::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
    ...
    BackgroundFetchResult in_result, BackgroundFetchFailureReason in_failure_reason)
{
    ...
    mojo::Message message(internal::kBackgroundFetchRegistrationObserver_OnProgress_Name, kFlags, 0, 0, nullptr);
...
void BackgroundFetchRegistrationObserverProxy::OnRecordsUnavailable()
{
    ...
    mojo::Message message(internal::kBackgroundFetchRegistrationObserver_OnRecordsUnavailable_Name, kFlags, 0, 0, nullptr);
...
void BackgroundFetchRegistrationObserverProxy::OnRequestCompleted(::blink::mojom::FetchAPIRequestPtr in_request, ::blink::mojom::FetchAPIResponsePtr in_response)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    ...
    mojo::Message message(internal::kBackgroundFetchRegistrationObserver_OnRequestCompleted_Name, kFlags, 0, 0, nullptr);
    ...
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
        params->request.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null request in BackgroundFetchRegistrationObserver.OnRequestCompleted request");
...
bool BackgroundFetchRegistrationObserverStubDispatch::Accept(BackgroundFetchRegistrationObserver* impl, mojo::Message* message)
{
    ...
    case internal::kBackgroundFetchRegistrationObserver_OnProgress_Name: {
        ...
        bool success = true;
        uint64_t p_upload_total = mojo::DefaultConstructTraits::CreateInstance<uint64_t>();
        uint64_t p_uploaded = mojo::DefaultConstructTraits::CreateInstance<uint64_t>();
        uint64_t p_download_total = mojo::DefaultConstructTraits::CreateInstance<uint64_t>();
        uint64_t p_downloaded = mojo::DefaultConstructTraits::CreateInstance<uint64_t>();
        BackgroundFetchResult p_result = mojo::DefaultConstructTraits::CreateInstance<BackgroundFetchResult>();
        BackgroundFetchFailureReason p_failure_reason = mojo::DefaultConstructTraits::CreateInstance<BackgroundFetchFailureReason>();
        ...
        if (success && !input_data_view.ReadFailureReason(&p_failure_reason))
            success = false;
        if (!success) {
            ReportValidationErrorForMessage(message, mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED, BackgroundFetchRegistrationObserver::Name_, 0, false);
            return false;
        }
        // A null |impl| means no implementation was bound.
        DCHECK(impl);
        impl->OnProgress(std::move(p_upload_total), std::move(p_uploaded), std::move(p_download_total), std::move(p_downloaded), std::move(p_result), std::move(p_failure_reason));
        return true;
    }
    case internal::kBackgroundFetchRegistrationObserver_OnRecordsUnavailable_Name: {
        ...
        if (!success) {
            ReportValidationErrorForMessage(message, mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED, BackgroundFetchRegistrationObserver::Name_, 1, false);
            return false;
        }
        // A null |impl| means no implementation was bound.
        DCHECK(impl);
    ...
    case internal::kBackgroundFetchRegistrationObserver_OnRequestCompleted_Name: {
        ...
        bool success = true;
        ::blink::mojom::FetchAPIRequestPtr p_request = mojo::DefaultConstructTraits::CreateInstance<::blink::mojom::FetchAPIRequestPtr>();
        ::blink::mojom::FetchAPIResponsePtr p_response = mojo::DefaultConstructTraits::CreateInstance<::blink::mojom::FetchAPIResponsePtr>();
        ...
        if (success && !input_data_view.ReadResponse(&p_response))
            success = false;
        if (!success) {
            ReportValidationErrorForMessage(message, mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED, BackgroundFetchRegistrationObserver::Name_, 2, false);
            return false;
        }
        // A null |impl| means no implementation was bound.
        DCHECK(impl);
...
void BackgroundFetchServiceProxy::Fetch(int64_t in_service_worker_registration_id, const std::string& in_developer_id, std::vector<::blink::mojom::FetchAPIRequestPtr> in_requests,
    BackgroundFetchOptionsPtr in_options, const ::SkBitmap& in_icon, BackgroundFetchUkmDataPtr in_ukm_data, FetchCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send blink::mojom::BackgroundFetchService::Fetch", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("service_worker_registration_id"), in_service_worker_registration_id, "<value of type int64_t>");
    ...
    mojo::Message message(internal::kBackgroundFetchService_Fetch_Name, kFlags, 0, 0, nullptr);
...
void BackgroundFetchServiceProxy::GetRegistration(int64_t in_service_worker_registration_id, const std::string& in_developer_id, GetRegistrationCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    ...
    mojo::Message message(internal::kBackgroundFetchService_GetRegistration_Name, kFlags, 0, 0, nullptr);
    ...
    params->developer_id.Set(developer_id_fragment.is_null() ? nullptr : developer_id_fragment.data());
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
        params->developer_id.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null developer_id in BackgroundFetchService.GetRegistration request");
...
void BackgroundFetchServiceProxy::GetDeveloperIds(int64_t in_service_worker_registration_id, GetDeveloperIdsCallback callback)
{
    ...
    mojo::Message message(internal::kBackgroundFetchService_GetDeveloperIds_Name, kFlags, 0, 0, nullptr);
...
void BackgroundFetchServiceProxy::GetIconDisplaySize(GetIconDisplaySizeCallback callback)
{
    ...
    mojo::Message message(internal::kBackgroundFetchService_GetIconDisplaySize_Name, kFlags, 0, 0, nullptr);
...
bool BackgroundFetchService_Fetch_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    DCHECK(message->is_serialized());
    internal::BackgroundFetchService_Fetch_ResponseParams_Data* params = reinterpret_cast<internal::BackgroundFetchService_Fetch_ResponseParams_Data*>(message->mutable_payload());

    bool success = true;
    BackgroundFetchError p_error = mojo::DefaultConstructTraits::CreateInstance<BackgroundFetchError>();
    BackgroundFetchRegistrationPtr p_registration = mojo::DefaultConstructTraits::CreateInstance<BackgroundFetchRegistrationPtr>();
...
public:
    ...
    {
        std::unique_ptr<BackgroundFetchService_GetRegistration_ProxyToResponder> proxy(new BackgroundFetchService_GetRegistration_ProxyToResponder(message, std::move(responder)));
...
public:
    ...
    {
        std::unique_ptr<BackgroundFetchService_GetDeveloperIds_ProxyToResponder> proxy(new BackgroundFetchService_GetDeveloperIds_ProxyToResponder(message, std::move(responder)));
...
bool BackgroundFetchService_GetDeveloperIds_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    bool success = true;
    BackgroundFetchError p_error = mojo::DefaultConstructTraits::CreateInstance<BackgroundFetchError>();
    std::vector<std::string> p_developer_ids = mojo::DefaultConstructTraits::CreateInstance<std::vector<std::string>>();
...
void BackgroundFetchService_GetDeveloperIds_ProxyToResponder::Run(BackgroundFetchError in_error, const std::vector<std::string>& in_developer_ids)
{
    ...
    const mojo::internal::ContainerValidateParams developer_ids_validate_params(0, false, new mojo::internal::ContainerValidateParams(0, false, nullptr));
    ...
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(params->developer_ids.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null developer_ids in ");
...
public:
    static BackgroundFetchService::GetIconDisplaySizeCallback CreateCallback(::mojo::Message& message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
    {
...
bool BackgroundFetchService_GetIconDisplaySize_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    bool success = true;
    ::gfx::Size p_icon_size_pixels = mojo::DefaultConstructTraits::CreateInstance<::gfx::Size>();
...
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send reply blink::mojom::BackgroundFetchService::GetIconDisplaySize", "async_response_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
    ...
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(params->icon_size_pixels.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null icon_size_pixels in ");
...
// static
bool BackgroundFetchServiceStubDispatch::AcceptWithResponder(BackgroundFetchService* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
{
    [[maybe_unused]] const bool message_is_sync = message->has_flag(mojo::Message::kFlagIsSync);
    [[maybe_unused]] const uint64_t request_id = message->request_id();
    switch (message->header()->name) {
    case internal::kBackgroundFetchService_Fetch_Name: {
        ...
        internal::BackgroundFetchService_Fetch_Params_Data* params = reinterpret_cast<internal::BackgroundFetchService_Fetch_Params_Data*>(message->mutable_payload());

        bool success = true;
        int64_t p_service_worker_registration_id = mojo::DefaultConstructTraits::CreateInstance<int64_t>();
        std::string p_developer_id = mojo::DefaultConstructTraits::CreateInstance<std::string>();
        std::vector<::blink::mojom::FetchAPIRequestPtr> p_requests = mojo::DefaultConstructTraits::CreateInstance<std::vector<::blink::mojom::FetchAPIRequestPtr>>();
        BackgroundFetchOptionsPtr p_options = mojo::DefaultConstructTraits::CreateInstance<BackgroundFetchOptionsPtr>();
        ::SkBitmap p_icon = mojo::DefaultConstructTraits::CreateInstance<::SkBitmap>();
        BackgroundFetchUkmDataPtr p_ukm_data = mojo::DefaultConstructTraits::CreateInstance<BackgroundFetchUkmDataPtr>();
        ...
        // A null |impl| means no implementation was bound.
        DCHECK(impl);
        impl->Fetch(std::move(p_service_worker_registration_id), std::move(p_developer_id), std::move(p_requests), std::move(p_options), std::move(p_icon), std::move(p_ukm_data),
            std::move(callback));
        return true;
    }
    case internal::kBackgroundFetchService_GetRegistration_Name: {
        ...
        BackgroundFetchService::GetRegistrationCallback callback = BackgroundFetchService_GetRegistration_ProxyToResponder::CreateCallback(*message, std::move(responder));
        // A null |impl| means no implementation was bound.
        DCHECK(impl);
    ...
    case internal::kBackgroundFetchService_GetDeveloperIds_Name: {
        ...
        BackgroundFetchService::GetDeveloperIdsCallback callback = BackgroundFetchService_GetDeveloperIds_ProxyToResponder::CreateCallback(*message, std::move(responder));
        // A null |impl| means no implementation was bound.
        DCHECK(impl);
    ...
    case internal::kBackgroundFetchService_GetIconDisplaySize_Name: {
        ...
        BackgroundFetchService::GetIconDisplaySizeCallback callback = BackgroundFetchService_GetIconDisplaySize_ProxyToResponder::CreateCallback(*message, std::move(responder));
        // A null |impl| means no implementation was bound.
        DCHECK(impl);
...
static const mojo::internal::GenericValidationInfo kBackgroundFetchServiceValidationInfo[] = {
    ...
    { &internal::BackgroundFetchService_GetRegistration_Params_Data::Validate, &internal::BackgroundFetchService_GetRegistration_ResponseParams_Data::Validate },
    { &internal::BackgroundFetchService_GetDeveloperIds_Params_Data::Validate, &internal::BackgroundFetchService_GetDeveloperIds_ResponseParams_Data::Validate },
    { &internal::BackgroundFetchService_GetIconDisplaySize_Params_Data::Validate, &internal::BackgroundFetchService_GetIconDisplaySize_ResponseParams_Data::Validate },
};
...
void BackgroundFetchRegistrationServiceProxy::UpdateUI(const absl::optional<std::string>& in_title, const ::SkBitmap& in_icon, UpdateUICallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send blink::mojom::BackgroundFetchRegistrationService::UpdateUI", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("title"), in_title, "<value of type const absl::optional<std::string>&>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("icon"), in_icon, "<value of type const ::SkBitmap&>");
    });
#endif
    const bool kExpectsResponse = true;
    ...
    mojo::Message message(internal::kBackgroundFetchRegistrationService_UpdateUI_Name, kFlags, 0, 0, nullptr);
...
void BackgroundFetchRegistrationServiceProxy::Abort(AbortCallback callback)
{
    ...
    mojo::Message message(internal::kBackgroundFetchRegistrationService_Abort_Name, kFlags, 0, 0, nullptr);
    ...
    ::blink::mojom::FetchAPIRequestPtr in_request_to_match, ::blink::mojom::CacheQueryOptionsPtr in_cache_query_options, bool in_match_all, MatchRequestsCallback callback)
{
    ...
    TRACE_EVENT1("mojom", "Send blink::mojom::BackgroundFetchRegistrationService::MatchRequests", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("cache_query_options"), in_cache_query_options, "<value of type ::blink::mojom::CacheQueryOptionsPtr>");
    ...
    mojo::Message message(internal::kBackgroundFetchRegistrationService_MatchRequests_Name, kFlags, 0, 0, nullptr);
...
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send blink::mojom::BackgroundFetchRegistrationService::AddRegistrationObserver", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("observer"), in_observer, "<value of type ::mojo::PendingRemote<BackgroundFetchRegistrationObserver>>");
    });
#endif
    const bool kExpectsResponse = false;
    const bool kIsSync = false;
    ...
    mojo::Message message(internal::kBackgroundFetchRegistrationService_AddRegistrationObserver_Name, kFlags, 0, 0, nullptr);
    ...
    params.Allocate();
    mojo::internal::Serialize<mojo::InterfacePtrDataView<::blink::mojom::BackgroundFetchRegistrationObserverInterfaceBase>>(in_observer, &params->observer, &params.message());
...
public:
    static BackgroundFetchRegistrationService::UpdateUICallback CreateCallback(::mojo::Message& message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
    {
...
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send reply blink::mojom::BackgroundFetchRegistrationService::UpdateUI", "async_response_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("error"), in_error, "<value of type BackgroundFetchError>");
    });
#endif
...
public:
    static BackgroundFetchRegistrationService::AbortCallback CreateCallback(::mojo::Message& message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
    {
...
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send reply blink::mojom::BackgroundFetchRegistrationService::Abort", "async_response_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("error"), in_error, "<value of type BackgroundFetchError>");
    });
#endif
...
public:
    static BackgroundFetchRegistrationService::MatchRequestsCallback CreateCallback(::mojo::Message& message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
    {
...
bool BackgroundFetchRegistrationService_MatchRequests_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    bool success = true;
    std::vector<BackgroundFetchSettledFetchPtr> p_fetches = mojo::DefaultConstructTraits::CreateInstance<std::vector<BackgroundFetchSettledFetchPtr>>();
...
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send reply blink::mojom::BackgroundFetchRegistrationService::MatchRequests", "async_response_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
    ...
    const mojo::internal::ContainerValidateParams fetches_validate_params(0, false, nullptr);
...
bool BackgroundFetchRegistrationServiceStubDispatch::Accept(BackgroundFetchRegistrationService* impl, mojo::Message* message)
{
    ...
    case internal::kBackgroundFetchRegistrationService_AddRegistrationObserver_Name: {
        ...
        ::mojo::PendingRemote<BackgroundFetchRegistrationObserver> p_observer
            = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingRemote<BackgroundFetchRegistrationObserver>>();
        ...
        if (!success) {
            ReportValidationErrorForMessage(message, mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED, BackgroundFetchRegistrationService::Name_, 3, false);
            return false;
        }
        // A null |impl| means no implementation was bound.
        DCHECK(impl);
    ...
    BackgroundFetchRegistrationService* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
{
    ...
    case internal::kBackgroundFetchRegistrationService_UpdateUI_Name: {
        ...
        bool success = true;
        absl::optional<std::string> p_title = mojo::DefaultConstructTraits::CreateInstance<absl::optional<std::string>>();
        ::SkBitmap p_icon = mojo::DefaultConstructTraits::CreateInstance<::SkBitmap>();
        ...
        if (success && !input_data_view.ReadIcon(&p_icon))
            success = false;
        if (!success) {
            ReportValidationErrorForMessage(message, mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED, BackgroundFetchRegistrationService::Name_, 0, false);
            return false;
        }
    ...
    case internal::kBackgroundFetchRegistrationService_Abort_Name: {
        ...
        if (!success) {
            ReportValidationErrorForMessage(message, mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED, BackgroundFetchRegistrationService::Name_, 1, false);
            return false;
        }
        BackgroundFetchRegistrationService::AbortCallback callback = BackgroundFetchRegistrationService_Abort_ProxyToResponder::CreateCallback(*message, std::move(responder));
        // A null |impl| means no implementation was bound.
        DCHECK(impl);
    ...
    case internal::kBackgroundFetchRegistrationService_MatchRequests_Name: {
        ...
        bool success = true;
        ::blink::mojom::FetchAPIRequestPtr p_request_to_match = mojo::DefaultConstructTraits::CreateInstance<::blink::mojom::FetchAPIRequestPtr>();
        ::blink::mojom::CacheQueryOptionsPtr p_cache_query_options = mojo::DefaultConstructTraits::CreateInstance<::blink::mojom::CacheQueryOptionsPtr>();
        bool p_match_all = mojo::DefaultConstructTraits::CreateInstance<bool>();
        ...
        if (!success) {
            ReportValidationErrorForMessage(message, mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED, BackgroundFetchRegistrationService::Name_, 2, false);
            return false;
        }
...
static const mojo::internal::GenericValidationInfo kBackgroundFetchRegistrationServiceValidationInfo[] = {
    { &internal::BackgroundFetchRegistrationService_UpdateUI_Params_Data::Validate, &internal::BackgroundFetchRegistrationService_UpdateUI_ResponseParams_Data::Validate },
    { &internal::BackgroundFetchRegistrationService_Abort_Params_Data::Validate, &internal::BackgroundFetchRegistrationService_Abort_ResponseParams_Data::Validate },
...
namespace blink {
namespace mojom {
void BackgroundFetchRegistrationObserverInterceptorForTesting::OnProgress(
    uint64_t upload_total, uint64_t uploaded, uint64_t download_total, uint64_t downloaded, BackgroundFetchResult result, BackgroundFetchFailureReason failure_reason)
{
...
void BackgroundFetchRegistrationObserverInterceptorForTesting::OnRecordsUnavailable() { GetForwardingInterface()->OnRecordsUnavailable(); }
...
void BackgroundFetchServiceInterceptorForTesting::Fetch(int64_t service_worker_registration_id, const std::string& developer_id,
    std::vector<::blink::mojom::FetchAPIRequestPtr> requests, BackgroundFetchOptionsPtr options, const ::SkBitmap& icon, BackgroundFetchUkmDataPtr ukm_data, FetchCallback callback)
{
    GetForwardingInterface()->Fetch(
        std::move(service_worker_registration_id), std::move(developer_id), std::move(requests), std::move(options), std::move(icon), std::move(ukm_data), std::move(callback));
}
...
void BackgroundFetchServiceInterceptorForTesting::GetIconDisplaySize(GetIconDisplaySizeCallback callback) { GetForwardingInterface()->GetIconDisplaySize(std::move(callback)); }
...
void BackgroundFetchServiceAsyncWaiter::Fetch(int64_t service_worker_registration_id, const std::string& developer_id, std::vector<::blink::mojom::FetchAPIRequestPtr> requests,
...
void BackgroundFetchServiceAsyncWaiter::GetDeveloperIds(int64_t service_worker_registration_id, BackgroundFetchError* out_error, std::vector<std::string>* out_developer_ids)
{
    base::RunLoop loop;
...
void BackgroundFetchRegistrationServiceInterceptorForTesting::Abort(AbortCallback callback) { GetForwardingInterface()->Abort(std::move(callback)); }
void BackgroundFetchRegistrationServiceInterceptorForTesting::MatchRequests(
    ::blink::mojom::FetchAPIRequestPtr request_to_match, ::blink::mojom::CacheQueryOptionsPtr cache_query_options, bool match_all, MatchRequestsCallback callback)
{
...
void BackgroundFetchRegistrationServiceAsyncWaiter::UpdateUI(const absl::optional<std::string>& title, const ::SkBitmap& icon, BackgroundFetchError* out_error)
{
    base::RunLoop loop;
...
BackgroundFetchError BackgroundFetchRegistrationServiceAsyncWaiter::UpdateUI(const absl::optional<std::string>& title, const ::SkBitmap& icon)
{
    BackgroundFetchError async_wait_result = mojo::DefaultConstructTraits::CreateInstance<BackgroundFetchError>();
...
void BackgroundFetchRegistrationServiceAsyncWaiter::MatchRequests(::blink::mojom::FetchAPIRequestPtr request_to_match, ::blink::mojom::CacheQueryOptionsPtr cache_query_options,
    bool match_all, std::vector<BackgroundFetchSettledFetchPtr>* out_fetches)
{
    base::RunLoop loop;
...
{
    std::vector<BackgroundFetchSettledFetchPtr> async_wait_result = mojo::DefaultConstructTraits::CreateInstance<std::vector<BackgroundFetchSettledFetchPtr>>();
