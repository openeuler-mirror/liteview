...
// with not having this data in traces there.
    ...
    using EnumerateDevicesCallback = base::OnceCallback<void(
        const std::vector<std::vector<::blink::WebMediaDeviceInfo>>&, std::vector<VideoInputDeviceCapabilitiesPtr>, std::vector<AudioInputDeviceCapabilitiesPtr>)>;
    ...
    using ProduceCropIdCallback = base::OnceCallback<void(const std::string&)>;
...
public:
    ...
    VideoInputDeviceCapabilities(const std::string& device_id_in, const std::string& group_id_in, const ::media::VideoCaptureControlSupport& control_support_in,
        std::vector<::media::VideoCaptureFormat> formats_in, FacingMode facing_mode_in)
        : device_id(std::move(device_id_in))
        , group_id(std::move(group_id_in))
...
public:
    ...
    AudioInputDeviceCapabilities(const std::string& device_id_in, const std::string& group_id_in, const ::media::AudioParameters& parameters_in, bool is_valid_in,
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::MediaDeviceInfo::DataView, ::blink::mojom::MediaDeviceInfoPtr> {
    ...
    static const decltype(::blink::mojom::MediaDeviceInfo::device_id)& device_id(const ::blink::mojom::MediaDeviceInfoPtr& input) { return input->device_id; }

    static const decltype(::blink::mojom::MediaDeviceInfo::label)& label(const ::blink::mojom::MediaDeviceInfoPtr& input) { return input->label; }

    static const decltype(::blink::mojom::MediaDeviceInfo::group_id)& group_id(const ::blink::mojom::MediaDeviceInfoPtr& input) { return input->group_id; }
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::VideoInputDeviceCapabilities::DataView, ::blink::mojom::VideoInputDeviceCapabilitiesPtr> {
    ...
    static const decltype(::blink::mojom::VideoInputDeviceCapabilities::control_support)& control_support(const ::blink::mojom::VideoInputDeviceCapabilitiesPtr& input)
    {
        return input->control_support;
    }

    static const decltype(::blink::mojom::VideoInputDeviceCapabilities::formats)& formats(const ::blink::mojom::VideoInputDeviceCapabilitiesPtr& input) { return input->formats; }
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::AudioInputDeviceCapabilities::DataView, ::blink::mojom::AudioInputDeviceCapabilitiesPtr> {
    ...
    static decltype(::blink::mojom::AudioInputDeviceCapabilities::is_valid) is_valid(const ::blink::mojom::AudioInputDeviceCapabilitiesPtr& input) { return input->is_valid; }

    static decltype(::blink::mojom::AudioInputDeviceCapabilities::channels) channels(const ::blink::mojom::AudioInputDeviceCapabilitiesPtr& input) { return input->channels; }
    ...
    static const decltype(::blink::mojom::AudioInputDeviceCapabilities::latency)& latency(const ::blink::mojom::AudioInputDeviceCapabilitiesPtr& input) { return input->latency; }
