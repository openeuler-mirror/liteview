...
AudioInputDeviceCapabilities::AudioInputDeviceCapabilities(const std::string& device_id_in, const std::string& group_id_in, const ::media::AudioParameters& parameters_in,
...
private:
    ...
    void Run(const std::vector<std::vector<::blink::WebMediaDeviceInfo>>& in_enumeration, std::vector<VideoInputDeviceCapabilitiesPtr> in_video_input_device_capabilities,
...
bool MediaDevicesDispatcherHost_EnumerateDevices_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    bool success = true;
    std::vector<std::vector<::blink::WebMediaDeviceInfo>> p_enumeration = mojo::DefaultConstructTraits::CreateInstance<std::vector<std::vector<::blink::WebMediaDeviceInfo>>>();
    std::vector<VideoInputDeviceCapabilitiesPtr> p_video_input_device_capabilities = mojo::DefaultConstructTraits::CreateInstance<std::vector<VideoInputDeviceCapabilitiesPtr>>();
    std::vector<AudioInputDeviceCapabilitiesPtr> p_audio_input_device_capabilities = mojo::DefaultConstructTraits::CreateInstance<std::vector<AudioInputDeviceCapabilitiesPtr>>();
...
void MediaDevicesDispatcherHost_EnumerateDevices_ProxyToResponder::Run(const std::vector<std::vector<::blink::WebMediaDeviceInfo>>& in_enumeration,
    std::vector<VideoInputDeviceCapabilitiesPtr> in_video_input_device_capabilities, std::vector<AudioInputDeviceCapabilitiesPtr> in_audio_input_device_capabilities)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send reply blink::mojom::MediaDevicesDispatcherHost::EnumerateDevices", "async_response_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("enumeration"), in_enumeration, "<value of type const std::vector<std::vector<::blink::WebMediaDeviceInfo>>&>");
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("video_input_device_capabilities"), in_video_input_device_capabilities, "<value of type std::vector<VideoInputDeviceCapabilitiesPtr>>");
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("audio_input_device_capabilities"), in_audio_input_device_capabilities, "<value of type std::vector<AudioInputDeviceCapabilitiesPtr>>");
    });
#endif
...
bool MediaDevicesDispatcherHost_GetAllVideoInputDeviceFormats_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    bool success = true;
    std::vector<::media::VideoCaptureFormat> p_formats = mojo::DefaultConstructTraits::CreateInstance<std::vector<::media::VideoCaptureFormat>>();
...
private:
    ...
    void Run(const std::string& in_crop_id);
};
...
bool MediaDevicesDispatcherHost_ProduceCropId_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    bool success = true;
    std::string p_crop_id = mojo::DefaultConstructTraits::CreateInstance<std::string>();
...
void MediaDevicesDispatcherHost_ProduceCropId_ProxyToResponder::Run(const std::string& in_crop_id)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send reply blink::mojom::MediaDevicesDispatcherHost::ProduceCropId", "async_response_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("crop_id"), in_crop_id, "<value of type const std::string&>");
    });
#endif
...
bool MediaDevicesDispatcherHostStubDispatch::Accept(MediaDevicesDispatcherHost* impl, mojo::Message* message)
{
    ...
    case internal::kMediaDevicesDispatcherHost_SetCaptureHandleConfig_Name: {
        ...
        bool success = true;
        ::blink::mojom::CaptureHandleConfigPtr p_config = mojo::DefaultConstructTraits::CreateInstance<::blink::mojom::CaptureHandleConfigPtr>();
...
void MediaDevicesListenerProxy::OnDevicesChanged(MediaDeviceType in_type, const std::vector<::blink::WebMediaDeviceInfo>& in_device_infos)
{
    ...
    TRACE_EVENT1("mojom", "Send blink::mojom::MediaDevicesListener::OnDevicesChanged", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("device_infos"), in_device_infos, "<value of type const std::vector<::blink::WebMediaDeviceInfo>&>");
    });
#endif
    const bool kExpectsResponse = false;
    const bool kIsSync = false;
...
bool MediaDevicesListenerStubDispatch::Accept(MediaDevicesListener* impl, mojo::Message* message)
{
    ...
    case internal::kMediaDevicesListener_OnDevicesChanged_Name: {
        ...
        std::vector<::blink::WebMediaDeviceInfo> p_device_infos = mojo::DefaultConstructTraits::CreateInstance<std::vector<::blink::WebMediaDeviceInfo>>();
...
void MediaDevicesDispatcherHostAsyncWaiter::EnumerateDevices(bool request_audio_input, bool request_video_input, bool request_audio_output, bool request_video_input_capabilities,
    ...
    std::vector<VideoInputDeviceCapabilitiesPtr>* out_video_input_device_capabilities, std::vector<AudioInputDeviceCapabilitiesPtr>* out_audio_input_device_capabilities)
{
    base::RunLoop loop;
    proxy_->EnumerateDevices(std::move(request_audio_input), std::move(request_video_input), std::move(request_audio_output), std::move(request_video_input_capabilities),
        ...
        base::BindOnce(
            [](base::RunLoop* loop, std::vector<std::vector<::blink::WebMediaDeviceInfo>>* out_enumeration,
                ...
                std::vector<AudioInputDeviceCapabilitiesPtr>* out_audio_input_device_capabilities, const std::vector<std::vector<::blink::WebMediaDeviceInfo>>& enumeration,
                std::vector<VideoInputDeviceCapabilitiesPtr> video_input_device_capabilities, std::vector<AudioInputDeviceCapabilitiesPtr> audio_input_device_capabilities) {
...
{
    std::vector<VideoInputDeviceCapabilitiesPtr> async_wait_result = mojo::DefaultConstructTraits::CreateInstance<std::vector<VideoInputDeviceCapabilitiesPtr>>();
...
{
    std::vector<::media::VideoCaptureFormat> async_wait_result = mojo::DefaultConstructTraits::CreateInstance<std::vector<::media::VideoCaptureFormat>>();
    GetAllVideoInputDeviceFormats(std::move(device_id), &async_wait_result);
    return async_wait_result;
}

void MediaDevicesDispatcherHostAsyncWaiter::GetAvailableVideoInputDeviceFormats(const std::string& device_id, std::vector<::media::VideoCaptureFormat>* out_formats)
{
    base::RunLoop loop;
...
{
    std::vector<AudioInputDeviceCapabilitiesPtr> async_wait_result = mojo::DefaultConstructTraits::CreateInstance<std::vector<AudioInputDeviceCapabilitiesPtr>>();
    GetAudioInputCapabilities(&async_wait_result);
    return async_wait_result;
}

void MediaDevicesDispatcherHostAsyncWaiter::ProduceCropId(std::string* out_crop_id)
{
    base::RunLoop loop;
    proxy_->ProduceCropId(base::BindOnce(
        [](base::RunLoop* loop, std::string* out_crop_id, const std::string& crop_id) {
...
std::string MediaDevicesDispatcherHostAsyncWaiter::ProduceCropId()
{
