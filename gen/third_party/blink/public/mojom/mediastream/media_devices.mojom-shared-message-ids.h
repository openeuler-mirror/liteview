...
constexpr uint32_t kMediaDevicesDispatcherHost_SetCaptureHandleConfig_Name = 6;
constexpr uint32_t kMediaDevicesDispatcherHost_CloseFocusWindowOfOpportunity_Name = 7;
constexpr uint32_t kMediaDevicesDispatcherHost_ProduceCropId_Name = 8;
