...
// with not having this data in traces there.
    ...
    using CropCallback = base::OnceCallback<void(::media::mojom::CropRequestResult)>;
...
public:
    ...
    TrackControls(bool requested_in, MediaStreamType stream_type_in, const std::string& device_id_in)
...
public:
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<StreamSelectionInfo::DataView, std::vector<uint8_t>>(input);
    }
...
public:
    ...
    MediaStreamDevice(MediaStreamType type_in, const std::string& id_in, ::media::VideoFacingMode video_facing_in, const absl::optional<std::string>& group_id_in,
...
namespace mojo {
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::StreamSelectionInfo::DataView, ::blink::mojom::StreamSelectionInfoPtr> {
    static bool IsNull(const ::blink::mojom::StreamSelectionInfoPtr& input) { return !input; }
    static void SetToNull(::blink::mojom::StreamSelectionInfoPtr* output) { output->reset(); }

    static decltype(::blink::mojom::StreamSelectionInfo::strategy) strategy(const ::blink::mojom::StreamSelectionInfoPtr& input) { return input->strategy; }

    static const decltype(::blink::mojom::StreamSelectionInfo::session_id)& session_id(const ::blink::mojom::StreamSelectionInfoPtr& input) { return input->session_id; }
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::MediaStreamDevice::DataView, ::blink::mojom::MediaStreamDevicePtr> {
    ...
    static decltype(::blink::mojom::MediaStreamDevice::type) type(const ::blink::mojom::MediaStreamDevicePtr& input) { return input->type; }

    static const decltype(::blink::mojom::MediaStreamDevice::id)& id(const ::blink::mojom::MediaStreamDevicePtr& input) { return input->id; }

    static decltype(::blink::mojom::MediaStreamDevice::video_facing) video_facing(const ::blink::mojom::MediaStreamDevicePtr& input) { return input->video_facing; }

    static const decltype(::blink::mojom::MediaStreamDevice::group_id)& group_id(const ::blink::mojom::MediaStreamDevicePtr& input) { return input->group_id; }

    static const decltype(::blink::mojom::MediaStreamDevice::matched_output_device_id)& matched_output_device_id(const ::blink::mojom::MediaStreamDevicePtr& input)
    {
        return input->matched_output_device_id;
    }

    static const decltype(::blink::mojom::MediaStreamDevice::name)& name(const ::blink::mojom::MediaStreamDevicePtr& input) { return input->name; }

    static const decltype(::blink::mojom::MediaStreamDevice::input)& input(const ::blink::mojom::MediaStreamDevicePtr& input) { return input->input; }

    static const decltype(::blink::mojom::MediaStreamDevice::session_id)& session_id(const ::blink::mojom::MediaStreamDevicePtr& input) { return input->session_id; }
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::TrackControls::DataView, ::blink::mojom::TrackControlsPtr> {
    ...
    static decltype(::blink::mojom::TrackControls::requested) requested(const ::blink::mojom::TrackControlsPtr& input) { return input->requested; }

    static decltype(::blink::mojom::TrackControls::stream_type) stream_type(const ::blink::mojom::TrackControlsPtr& input) { return input->stream_type; }

    static const decltype(::blink::mojom::TrackControls::device_id)& device_id(const ::blink::mojom::TrackControlsPtr& input) { return input->device_id; }
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::StreamControls::DataView, ::blink::mojom::StreamControlsPtr> {
    ...
    static const decltype(::blink::mojom::StreamControls::audio)& audio(const ::blink::mojom::StreamControlsPtr& input) { return input->audio; }

    static const decltype(::blink::mojom::StreamControls::video)& video(const ::blink::mojom::StreamControlsPtr& input) { return input->video; }

    static decltype(::blink::mojom::StreamControls::hotword_enabled) hotword_enabled(const ::blink::mojom::StreamControlsPtr& input) { return input->hotword_enabled; }

    static decltype(::blink::mojom::StreamControls::disable_local_echo) disable_local_echo(const ::blink::mojom::StreamControlsPtr& input) { return input->disable_local_echo; }
    ...
    static decltype(::blink::mojom::StreamControls::request_pan_tilt_zoom_permission) request_pan_tilt_zoom_permission(const ::blink::mojom::StreamControlsPtr& input)
    {
        return input->request_pan_tilt_zoom_permission;
    }

    static decltype(::blink::mojom::StreamControls::request_all_screens) request_all_screens(const ::blink::mojom::StreamControlsPtr& input) { return input->request_all_screens; }
    ...
    static decltype(::blink::mojom::StreamControls::dynamic_surface_switching_requested) dynamic_surface_switching_requested(const ::blink::mojom::StreamControlsPtr& input)
    {
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::GetOpenDeviceResponse::DataView, ::blink::mojom::GetOpenDeviceResponsePtr> {
    static bool IsNull(const ::blink::mojom::GetOpenDeviceResponsePtr& input) { return !input; }
    static void SetToNull(::blink::mojom::GetOpenDeviceResponsePtr* output) { output->reset(); }

    static const decltype(::blink::mojom::GetOpenDeviceResponse::label)& label(const ::blink::mojom::GetOpenDeviceResponsePtr& input) { return input->label; }

    static const decltype(::blink::mojom::GetOpenDeviceResponse::device)& device(const ::blink::mojom::GetOpenDeviceResponsePtr& input) { return input->device; }
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::StreamDevices::DataView, ::blink::mojom::StreamDevicesPtr> {
    static bool IsNull(const ::blink::mojom::StreamDevicesPtr& input) { return !input; }
    static void SetToNull(::blink::mojom::StreamDevicesPtr* output) { output->reset(); }

    static const decltype(::blink::mojom::StreamDevices::audio_device)& audio_device(const ::blink::mojom::StreamDevicesPtr& input) { return input->audio_device; }

    static const decltype(::blink::mojom::StreamDevices::video_device)& video_device(const ::blink::mojom::StreamDevicesPtr& input) { return input->video_device; }
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::StreamDevicesSet::DataView, ::blink::mojom::StreamDevicesSetPtr> {
    static bool IsNull(const ::blink::mojom::StreamDevicesSetPtr& input) { return !input; }
    static void SetToNull(::blink::mojom::StreamDevicesSetPtr* output) { output->reset(); }

    static const decltype(::blink::mojom::StreamDevicesSet::stream_devices)& stream_devices(const ::blink::mojom::StreamDevicesSetPtr& input) { return input->stream_devices; }
