...
static_assert(sizeof(MediaDeviceInfo_Data) == 32, "Bad sizeof(MediaDeviceInfo_Data)");
...
static_assert(sizeof(VideoInputDeviceCapabilities_Data) == 48, "Bad sizeof(VideoInputDeviceCapabilities_Data)");
// Used by VideoInputDeviceCapabilities::WrapAsMessage to lazily serialize the struct.
template <typename UserType, typename DataView> struct VideoInputDeviceCapabilities_UnserializedMessageContext : public mojo::internal::UnserializedMessageContext {
public:
    static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;
...
template <typename UserType, typename DataView> struct AudioInputDeviceCapabilities_UnserializedMessageContext : public mojo::internal::UnserializedMessageContext {
public:
    static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;
