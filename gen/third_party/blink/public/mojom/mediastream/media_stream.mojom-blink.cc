...
MediaStreamDevice::MediaStreamDevice(MediaStreamType type_in, const WTF::String& id_in, ::media::VideoFacingMode video_facing_in, const WTF::String& group_id_in,
...
TrackControls::TrackControls(bool requested_in, MediaStreamType stream_type_in, const WTF::String& device_id_in)
...
void MediaStreamDeviceObserverProxy::OnDeviceChanged(const WTF::String& in_label, const ::blink::MediaStreamDevice& in_old_device, const ::blink::MediaStreamDevice& in_new_device)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void MediaStreamDeviceObserverProxy::OnDeviceRequestStateChange(const WTF::String& in_label, const ::blink::MediaStreamDevice& in_device, MediaStreamStateChange in_new_state)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void MediaStreamDispatcherHostProxy::StopStreamDevice(const WTF::String& in_device_id, const absl::optional<::base::UnguessableToken>& in_session_id)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void MediaStreamDispatcherHostProxy::OnStreamStarted(const WTF::String& in_label)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
private:
    ...
    void Run(::media::mojom::blink::CropRequestResult in_crop_result);
};
...
bool MediaStreamDispatcherHost_Crop_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    bool success = true;
    ::media::mojom::blink::CropRequestResult p_crop_result = mojo::DefaultConstructTraits::CreateInstance<::media::mojom::blink::CropRequestResult>();
...
void MediaStreamDispatcherHost_Crop_ProxyToResponder::Run(::media::mojom::blink::CropRequestResult in_crop_result)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send reply blink::mojom::MediaStreamDispatcherHost::Crop", "async_response_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("crop_result"), in_crop_result, "<value of type ::media::mojom::blink::CropRequestResult>");
    });
#endif
...
bool MediaStreamDispatcherHostStubDispatch::Accept(MediaStreamDispatcherHost* impl, mojo::Message* message)
{
    ...
    case internal::kMediaStreamDispatcherHost_StopStreamDevice_Name: {
        ...
        bool success = true;
        WTF::String p_device_id = mojo::DefaultConstructTraits::CreateInstance<WTF::String>();
...
void MediaStreamDispatcherHostInterceptorForTesting::CloseDevice(const WTF::String& label) { GetForwardingInterface()->CloseDevice(std::move(label)); }
...
void MediaStreamDispatcherHostInterceptorForTesting::OnStreamStarted(const WTF::String& label) { GetForwardingInterface()->OnStreamStarted(std::move(label)); }
    ...
    bool* out_pan_tilt_zoom_allowed)
{
    ...
    proxy_->GenerateStreams(std::move(request_id), std::move(controls), std::move(user_gesture), std::move(audio_stream_selection_info),
        base::BindOnce(
            [](base::RunLoop* loop, MediaStreamRequestResult* out_result, WTF::String* out_label, StreamDevicesSetPtr* out_stream_devices, bool* out_pan_tilt_zoom_allowed,
                MediaStreamRequestResult result, const WTF::String& label, StreamDevicesSetPtr stream_devices, bool pan_tilt_zoom_allowed) {
...
void MediaStreamDispatcherHostAsyncWaiter::Crop(
    const ::base::UnguessableToken& device_id, const ::base::Token& crop_id, uint32_t crop_version, ::media::mojom::blink::CropRequestResult* out_crop_result)
{
    base::RunLoop loop;
    proxy_->Crop(std::move(device_id), std::move(crop_id), std::move(crop_version),
        base::BindOnce(
            [](base::RunLoop* loop, ::media::mojom::blink::CropRequestResult* out_crop_result, ::media::mojom::blink::CropRequestResult crop_result) {
...
::media::mojom::blink::CropRequestResult MediaStreamDispatcherHostAsyncWaiter::Crop(const ::base::UnguessableToken& device_id, const ::base::Token& crop_id, uint32_t crop_version)
{
    ::media::mojom::blink::CropRequestResult async_wait_result = mojo::DefaultConstructTraits::CreateInstance<::media::mojom::blink::CropRequestResult>();
