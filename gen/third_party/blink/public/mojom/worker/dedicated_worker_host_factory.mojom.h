...
// with not having this data in traces there.
    ...
    using CreateWorkerHostCallback = base::OnceCallback<void(const ::network::CrossOriginEmbedderPolicy&, ::mojo::PendingRemote<::blink::mojom::BackForwardCacheControllerHost>)>;

    virtual void CreateWorkerHost(const ::blink::DedicatedWorkerToken& token, const ::GURL& script_url,
    ...
    virtual void CreateWorkerHostAndStartScriptLoad(const ::blink::DedicatedWorkerToken& token, const ::GURL& script_url, ::network::mojom::CredentialsMode credentials_mode,
        ::blink::mojom::FetchClientSettingsObjectPtr outside_fetch_client_settings_object, ::mojo::PendingRemote<::blink::mojom::BlobURLToken> blob_url_token,
        ::mojo::PendingRemote<DedicatedWorkerHostFactoryClient> client)
        = 0;
};
...
//
//   void OnWorkerHostCreated(::mojo::PendingRemote<::blink::mojom::BrowserInterfaceBroker> browser_interface_broker, ::mojo::PendingRemote<::blink::mojom::DedicatedWorkerHost>
//   host) final;
//
//   void OnScriptLoadStarted(::blink::mojom::ServiceWorkerContainerInfoForClientPtr service_worker_container_info, ::blink::mojom::WorkerMainScriptLoadParamsPtr
//   main_script_load_params, ::std::unique_ptr<::blink::PendingURLLoaderFactoryBundle> subresource_loader_factories,
//   ::mojo::PendingReceiver<::blink::mojom::SubresourceLoaderUpdater> subresource_loader_updater, ::blink::mojom::ControllerServiceWorkerInfoPtr controller_info,
...
//
//   void CreateWorkerHost(const ::blink::DedicatedWorkerToken& token, const ::GURL& script_url, ::mojo::PendingReceiver<::blink::mojom::BrowserInterfaceBroker>
//   browser_interface_broker, ::mojo::PendingReceiver<::blink::mojom::DedicatedWorkerHost> host, CreateWorkerHostCallback callback) final;
//
//   void CreateWorkerHostAndStartScriptLoad(const ::blink::DedicatedWorkerToken& token, const ::GURL& script_url, ::network::mojom::CredentialsMode credentials_mode,
//   ::blink::mojom::FetchClientSettingsObjectPtr outside_fetch_client_settings_object, ::mojo::PendingRemote<::blink::mojom::BlobURLToken> blob_url_token,
//   ::mojo::PendingRemote<DedicatedWorkerHostFactoryClient> client) final;
//
//  private:
//   mojo::MessageReceiverWithResponder* receiver_;
// };
