...
static_assert(
    sizeof(SubresourceLoaderUpdater_UpdateSubresourceLoaderFactories_Params_Data) == 16, "Bad sizeof(SubresourceLoaderUpdater_UpdateSubresourceLoaderFactories_Params_Data)");
...
inline void SubresourceLoaderUpdater_UpdateSubresourceLoaderFactories_ParamsDataView::GetSubresourceLoaderFactoriesDataView(::blink::mojom::URLLoaderFactoryBundleDataView* output)
{
    auto pointer = data_->subresource_loader_factories.Get();
