...
class BLINK_COMMON_EXPORT DedicatedWorkerHostFactoryClientInterceptorForTesting : public DedicatedWorkerHostFactoryClient {
    ...
    void OnWorkerHostCreated(
        ::mojo::PendingRemote<::blink::mojom::BrowserInterfaceBroker> browser_interface_broker, ::mojo::PendingRemote<::blink::mojom::DedicatedWorkerHost> host) override;
...
class BLINK_COMMON_EXPORT DedicatedWorkerHostFactoryInterceptorForTesting : public DedicatedWorkerHostFactory {
    ...
    void CreateWorkerHost(const ::blink::DedicatedWorkerToken& token, const ::GURL& script_url,
    ...
    void CreateWorkerHostAndStartScriptLoad(const ::blink::DedicatedWorkerToken& token, const ::GURL& script_url, ::network::mojom::CredentialsMode credentials_mode,
        ...
        ::mojo::PendingRemote<DedicatedWorkerHostFactoryClient> client) override;
};
