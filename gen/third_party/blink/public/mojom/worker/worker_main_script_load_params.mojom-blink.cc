...
WorkerMainScriptLoadParams::WorkerMainScriptLoadParams(int32_t request_id_in, ::network::mojom::blink::URLResponseHeadPtr response_head_in,
    ...
    WTF::Vector<::network::mojom::blink::URLRequestRedirectInfoPtr> redirect_infos_in, WTF::Vector<::network::mojom::blink::URLResponseHeadPtr> redirect_response_heads_in)
...
bool WorkerMainScriptLoadParams::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
