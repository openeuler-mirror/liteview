...
//   ::mojo::PendingRemote<::blink::mojom::blink::DedicatedWorkerHost> host) final;
//
//   void OnScriptLoadStarted(::blink::mojom::blink::ServiceWorkerContainerInfoForClientPtr service_worker_container_info, ::blink::mojom::blink::WorkerMainScriptLoadParamsPtr
...
//
//   void CreateWorkerHost(const ::blink::DedicatedWorkerToken& token, const ::blink::KURL& script_url, ::mojo::PendingReceiver<::blink::mojom::blink::BrowserInterfaceBroker>
//   browser_interface_broker, ::mojo::PendingReceiver<::blink::mojom::blink::DedicatedWorkerHost> host, CreateWorkerHostCallback callback) final;
//
//   void CreateWorkerHostAndStartScriptLoad(const ::blink::DedicatedWorkerToken& token, const ::blink::KURL& script_url, ::network::mojom::blink::CredentialsMode credentials_mode,
//   ::blink::mojom::blink::FetchClientSettingsObjectPtr outside_fetch_client_settings_object, ::mojo::PendingRemote<::blink::mojom::blink::BlobURLToken> blob_url_token,
