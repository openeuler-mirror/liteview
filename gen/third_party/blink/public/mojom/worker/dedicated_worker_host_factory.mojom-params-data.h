...
static_assert(sizeof(DedicatedWorkerHostFactoryClient_OnWorkerHostCreated_Params_Data) == 24, "Bad sizeof(DedicatedWorkerHostFactoryClient_OnWorkerHostCreated_Params_Data)");
...
static_assert(sizeof(DedicatedWorkerHostFactoryClient_OnScriptLoadStarted_Params_Data) == 56, "Bad sizeof(DedicatedWorkerHostFactoryClient_OnScriptLoadStarted_Params_Data)");
...
static_assert(
    sizeof(DedicatedWorkerHostFactoryClient_OnScriptLoadStartFailed_Params_Data) == 8, "Bad sizeof(DedicatedWorkerHostFactoryClient_OnScriptLoadStartFailed_Params_Data)");
...
static_assert(sizeof(DedicatedWorkerHostFactory_CreateWorkerHost_Params_Data) == 32, "Bad sizeof(DedicatedWorkerHostFactory_CreateWorkerHost_Params_Data)");
...
static_assert(sizeof(DedicatedWorkerHostFactory_CreateWorkerHost_ResponseParams_Data) == 24, "Bad sizeof(DedicatedWorkerHostFactory_CreateWorkerHost_ResponseParams_Data)");
...
public:
    ...
    DedicatedWorkerHostFactoryClient_OnWorkerHostCreated_ParamsDataView(internal::DedicatedWorkerHostFactoryClient_OnWorkerHostCreated_Params_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
    ...
    template <typename UserType> UserType TakeBrowserInterfaceBroker()
    {
        UserType result;
        bool ret
            = mojo::internal::Deserialize<mojo::InterfacePtrDataView<::blink::mojom::BrowserInterfaceBrokerInterfaceBase>>(&data_->browser_interface_broker, &result, message_);
        DCHECK(ret);
        return result;
    }
...
public:
    ...
    DedicatedWorkerHostFactoryClient_OnScriptLoadStarted_ParamsDataView(internal::DedicatedWorkerHostFactoryClient_OnScriptLoadStarted_Params_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
...
public:
    ...
    template <typename UserType> UserType TakeBrowserInterfaceBroker()
    {
        UserType result;
        bool ret
            = mojo::internal::Deserialize<mojo::InterfaceRequestDataView<::blink::mojom::BrowserInterfaceBrokerInterfaceBase>>(&data_->browser_interface_broker, &result, message_);
        DCHECK(ret);
        return result;
    }
    template <typename UserType> UserType TakeHost()
    {
        UserType result;
        bool ret = mojo::internal::Deserialize<mojo::InterfaceRequestDataView<::blink::mojom::DedicatedWorkerHostInterfaceBase>>(&data_->host, &result, message_);
        DCHECK(ret);
        return result;
    }
...
public:
    ...
    DedicatedWorkerHostFactory_CreateWorkerHost_ResponseParamsDataView(internal::DedicatedWorkerHostFactory_CreateWorkerHost_ResponseParams_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
...
public:
    ...
    {
        UserType result;
        bool ret = mojo::internal::Deserialize<mojo::InterfacePtrDataView<::blink::mojom::DedicatedWorkerHostFactoryClientInterfaceBase>>(&data_->client, &result, message_);
        DCHECK(ret);
        return result;
    }
...
inline void DedicatedWorkerHostFactoryClient_OnScriptLoadStarted_ParamsDataView::GetMainScriptLoadParamsDataView(::blink::mojom::WorkerMainScriptLoadParamsDataView* output)
{
    auto pointer = data_->main_script_load_params.Get();
    *output = ::blink::mojom::WorkerMainScriptLoadParamsDataView(pointer, message_);
}
inline void DedicatedWorkerHostFactoryClient_OnScriptLoadStarted_ParamsDataView::GetSubresourceLoaderFactoriesDataView(::blink::mojom::URLLoaderFactoryBundleDataView* output)
{
    auto pointer = data_->subresource_loader_factories.Get();
    *output = ::blink::mojom::URLLoaderFactoryBundleDataView(pointer, message_);
}
inline void DedicatedWorkerHostFactoryClient_OnScriptLoadStarted_ParamsDataView::GetControllerInfoDataView(::blink::mojom::ControllerServiceWorkerInfoDataView* output)
{
    auto pointer = data_->controller_info.Get();
...
inline void DedicatedWorkerHostFactory_CreateWorkerHost_ResponseParamsDataView::GetParentCoepDataView(::network::mojom::CrossOriginEmbedderPolicyDataView* output)
{
    auto pointer = data_->parent_coep.Get();
