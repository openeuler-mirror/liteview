...
// with not having this data in traces there.
    ...
    virtual void CreateSharedWorker(::blink::mojom::SharedWorkerInfoPtr info, const ::blink::SharedWorkerToken& token, const ::url::Origin& constructor_origin,
        bool is_constructor_secure_context, const std::string& user_agent, const std::string& full_user_agent, const std::string& reduced_user_agent,
...
//
//   void CreateSharedWorker(::blink::mojom::SharedWorkerInfoPtr info, const ::blink::SharedWorkerToken& token, const ::url::Origin& constructor_origin, bool
//   is_constructor_secure_context, const std::string& user_agent, const std::string& full_user_agent, const std::string& reduced_user_agent, const ::blink::UserAgentMetadata&
//   ua_metadata, bool pause_on_start, const ::base::UnguessableToken& devtools_worker_token, const ::blink::RendererPreferences& renderer_preferences,
//   ::mojo::PendingReceiver<::blink::mojom::RendererPreferenceWatcher> preference_watcher_receiver, ::mojo::PendingRemote<::blink::mojom::WorkerContentSettingsProxy>
//   content_settings, ::blink::mojom::ServiceWorkerContainerInfoForClientPtr service_worker_container_info, ::blink::mojom::WorkerMainScriptLoadParamsPtr main_script_load_params,
...
//   ::blink::mojom::PolicyContainerPtr policy_container, ::mojo::PendingRemote<::blink::mojom::SharedWorkerHost> host, ::mojo::PendingReceiver<::blink::mojom::SharedWorker>
//   shared_worker, ::mojo::PendingRemote<::blink::mojom::BrowserInterfaceBroker> browser_interface_broker, int64_t ukm_source_id) final;
//
//  private:
