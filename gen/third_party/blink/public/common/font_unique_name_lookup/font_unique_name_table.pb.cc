...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 FontUniqueNameTable_UniqueFontDefaultTypeInternal
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 FontUniqueNameTable_UniqueNameToFontMappingDefaultTypeInternal
...
public:
    ...
    static void set_has_file_path(HasBits* has_bits) { (*has_bits)[0] |= 1u; }
    static void set_has_ttc_index(HasBits* has_bits) { (*has_bits)[0] |= 2u; }
    ...
    , _has_bits_(from._has_bits_)
{
    ...
    if (from._internal_has_file_path()) {
        file_path_.Set(from._internal_file_path(), GetArenaForAllocation());
    }
...
void FontUniqueNameTable_UniqueFont::SetCachedSize(int size) const { _cached_size_.Set(size); }
...
void FontUniqueNameTable_UniqueFont::InternalSwap(FontUniqueNameTable_UniqueFont* other)
{
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(&file_path_, lhs_arena, &other->file_path_, rhs_arena);
    swap(ttc_index_, other->ttc_index_);
}

std::string FontUniqueNameTable_UniqueFont::GetTypeName() const { return "blink.FontUniqueNameTable.UniqueFont"; }
// ===================================================================
...
public:
    ...
    static void set_has_font_name(HasBits* has_bits) { (*has_bits)[0] |= 1u; }
    static void set_has_font_index(HasBits* has_bits) { (*has_bits)[0] |= 2u; }
    static bool MissingRequiredFields(const HasBits& has_bits) { return ((has_bits[0] & 0x00000003) ^ 0x00000003) != 0; }
};
    ...
    , _has_bits_(from._has_bits_)
{
    ...
    if (from._internal_has_font_name()) {
        font_name_.Set(from._internal_font_name(), GetArenaForAllocation());
    }
...
void FontUniqueNameTable_UniqueNameToFontMapping::SetCachedSize(int size) const { _cached_size_.Set(size); }
...
void FontUniqueNameTable_UniqueNameToFontMapping::InternalSwap(FontUniqueNameTable_UniqueNameToFontMapping* other)
{
    ...
    _internal_metadata_.InternalSwap(&other->_internal_metadata_);
    swap(_has_bits_[0], other->_has_bits_[0]);
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(&font_name_, lhs_arena, &other->font_name_, rhs_arena);
    swap(font_index_, other->font_index_);
}

std::string FontUniqueNameTable_UniqueNameToFontMapping::GetTypeName() const { return "blink.FontUniqueNameTable.UniqueNameToFontMapping"; }
// ===================================================================

class FontUniqueNameTable::_Internal {
public:
    using HasBits = decltype(std::declval<FontUniqueNameTable>()._has_bits_);
    static void set_has_stored_for_platform_version_identifier(HasBits* has_bits) { (*has_bits)[0] |= 1u; }
    ...
    , name_map_(from.name_map_)
{
    ...
    if (from._internal_has_stored_for_platform_version_identifier()) {
        stored_for_platform_version_identifier_.Set(from._internal_stored_for_platform_version_identifier(), GetArenaForAllocation());
    }
...
void FontUniqueNameTable::SetCachedSize(int size) const { _cached_size_.Set(size); }
...
void FontUniqueNameTable::CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from) { MergeFrom(*::_pbi::DownCast<const FontUniqueNameTable*>(&from)); }
...
void FontUniqueNameTable::InternalSwap(FontUniqueNameTable* other)
{
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
        &stored_for_platform_version_identifier_, lhs_arena, &other->stored_for_platform_version_identifier_, rhs_arena);
}

std::string FontUniqueNameTable::GetTypeName() const { return "blink.FontUniqueNameTable"; }
