...
class FontEnumerationTable_FontData final : public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:blink.FontEnumerationTable.FontData) */ {
public:
    ...
    static const FontEnumerationTable_FontData& default_instance() { return *internal_default_instance(); }
    ...
    friend void swap(FontEnumerationTable_FontData& a, FontEnumerationTable_FontData& b) { a.Swap(&b); }
    ...
    FontEnumerationTable_FontData* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final { return CreateMaybeMessage<FontEnumerationTable_FontData>(arena); }
...
private:
    ...
    static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() { return "blink.FontEnumerationTable.FontData"; }
...
public:
    ...
    static const FontEnumerationTable& default_instance() { return *internal_default_instance(); }
    static inline const FontEnumerationTable* internal_default_instance() { return reinterpret_cast<const FontEnumerationTable*>(&_FontEnumerationTable_default_instance_); }
    static constexpr int kIndexInFileMessages = 1;

    friend void swap(FontEnumerationTable& a, FontEnumerationTable& b) { a.Swap(&b); }
    ...
    FontEnumerationTable* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final { return CreateMaybeMessage<FontEnumerationTable>(arena); }
    void CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from) final;
...
private:
    friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
    static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() { return "blink.FontEnumerationTable"; }
...
inline bool FontEnumerationTable_FontData::has_postscript_name() const { return _internal_has_postscript_name(); }
...
inline const std::string& FontEnumerationTable_FontData::_internal_postscript_name() const { return postscript_name_.Get(); }
...
inline bool FontEnumerationTable_FontData::has_full_name() const { return _internal_has_full_name(); }
...
inline const std::string& FontEnumerationTable_FontData::_internal_full_name() const { return full_name_.Get(); }
...
inline bool FontEnumerationTable_FontData::has_family() const { return _internal_has_family(); }
...
inline const std::string& FontEnumerationTable_FontData::_internal_family() const { return family_.Get(); }
...
inline bool FontEnumerationTable_FontData::has_style() const { return _internal_has_style(); }
...
inline const std::string& FontEnumerationTable_FontData::_internal_style() const { return style_.Get(); }
...
// repeated .blink.FontEnumerationTable.FontData fonts = 10;
inline int FontEnumerationTable::_internal_fonts_size() const { return fonts_.size(); }
inline int FontEnumerationTable::fonts_size() const { return _internal_fonts_size(); }
inline void FontEnumerationTable::clear_fonts() { fonts_.Clear(); }
...
inline const ::blink::FontEnumerationTable_FontData& FontEnumerationTable::_internal_fonts(int index) const { return fonts_.Get(index); }
...
inline ::blink::FontEnumerationTable_FontData* FontEnumerationTable::_internal_add_fonts() { return fonts_.Add(); }
