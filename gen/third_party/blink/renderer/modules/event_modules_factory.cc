...
//         return DeviceMotionEvent::Create();
        OutputDebugStringA("DeviceMotionEvent fail!\n");
    }
...
//         return DeviceOrientationEvent::Create();
        OutputDebugStringA("DeviceOrientationEvent fail!\n");
    }
...
//         return IDBVersionChangeEvent::Create();
        OutputDebugStringA("IDBVersionChangeEvent fail!\n");
    }
...
//         return StorageEvent::Create();
        OutputDebugStringA("StorageEvent fail!\n");
    }
...
//         return WebGLContextEvent::Create();
        OutputDebugStringA("WebGLContextEvent fail!\n");
    }
...
//         return CloseEvent::Create();
        OutputDebugStringA("CloseEvent fail!\n");
    }
    return nullptr;
}
