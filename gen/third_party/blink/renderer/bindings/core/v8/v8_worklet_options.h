...
class CORE_EXPORT WorkletOptions : public bindings::DictionaryBase {

public:
    static WorkletOptions* Create() { return MakeGarbageCollected<WorkletOptions>(); }
    static WorkletOptions* Create(v8::Isolate* isolate) { return MakeGarbageCollected<WorkletOptions>(isolate); }
