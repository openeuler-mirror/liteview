...
public:
    ...
    static ProgressEventInit* Create(v8::Isolate* isolate) { return MakeGarbageCollected<ProgressEventInit>(isolate); }
    ...
    bool hasLengthComputable() const { return true; }
    bool lengthComputable() const { return member_length_computable_; }
    void setLengthComputable(bool value) { member_length_computable_ = value; }

    bool hasLoaded() const { return true; }
    uint64_t loaded() const { return member_loaded_; }
    void setLoaded(uint64_t value) { member_loaded_ = value; }

    bool hasTotal() const { return true; }
    uint64_t total() const { return member_total_; }
    void setTotal(uint64_t value) { member_total_ = value; }
