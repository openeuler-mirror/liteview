...
inline bool operator==(const V8RequestDestination& lhs, V8RequestDestination::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8RequestDestination::Enum lhs, const V8RequestDestination& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
