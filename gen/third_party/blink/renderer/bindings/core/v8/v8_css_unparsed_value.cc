...
static_assert(std::is_same<decltype(&CSSUnparsedValue::HasPendingActivity), decltype(&ScriptWrappable::HasPendingActivity)>::value,
...
void V8CSSUnparsedValue::IndexedPropertySetterCallback(uint32_t index, v8::Local<v8::Value> v8_property_value, const v8::PropertyCallbackInfo<v8::Value>& info)
{
...
void V8CSSUnparsedValue::IndexedPropertyDeleterCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Boolean>& info)
{
    ...
    if (is_supported and info.ShouldThrowOnError()) {
        ExceptionState exception_state(info.GetIsolate(), ExceptionContext::Context::kIndexedPropertyDelete, "CSSUnparsedValue");
        exception_state.ThrowTypeError("Index property deleter is not supported.");
    }
}

void V8CSSUnparsedValue::IndexedPropertyDefinerCallback(uint32_t index, const v8::PropertyDescriptor& v8_property_desc, const v8::PropertyCallbackInfo<v8::Value>& info)
{
    ...
    if (v8_property_desc.has_get() || v8_property_desc.has_set()) {
        ...
        if (info.ShouldThrowOnError()) {
            ExceptionState exception_state(info.GetIsolate(), ExceptionContext::Context::kIndexedPropertySet, "CSSUnparsedValue");
    ...
    V8CSSUnparsedValue::IndexedPropertySetterCallback(index, v8_property_desc.has_value() ? v8_property_desc.value() : v8::Undefined(isolate).As<v8::Value>(), info);
}
...
void ConstructorCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    auto&& return_value = CSSUnparsedValue::Create(arg1_members);
...
void V8CSSUnparsedValue::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template)
{
    ...
    instance_object_template->SetHandler(
        v8::IndexedPropertyHandlerConfiguration(V8CSSUnparsedValue::IndexedPropertyGetterCallback, V8CSSUnparsedValue::IndexedPropertySetterCallback,
            nullptr, // query
            V8CSSUnparsedValue::IndexedPropertyDeleterCallback, V8CSSUnparsedValue::IndexedPropertyEnumeratorCallback, V8CSSUnparsedValue::IndexedPropertyDefinerCallback,
            V8CSSUnparsedValue::IndexedPropertyDescriptorCallback, v8::Local<v8::Value>(), v8::PropertyHandlerFlags::kHasNoSideEffect));
