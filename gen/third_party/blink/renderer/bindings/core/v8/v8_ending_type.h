...
public:
    ...
    static absl::optional<V8EndingType> Create(const String& value);
...
inline bool operator==(const V8EndingType& lhs, V8EndingType::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8EndingType::Enum lhs, const V8EndingType& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
