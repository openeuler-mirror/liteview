...
bool V8DedicatedWorkerGlobalScope::IsExposed(ExecutionContext* execution_context) { return execution_context->IsDedicatedWorkerGlobalScope(); }
...
static_assert(!std::is_same<decltype(&DedicatedWorkerGlobalScope::HasPendingActivity), decltype(&ScriptWrappable::HasPendingActivity)>::value,
