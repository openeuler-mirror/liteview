...
bool V8SVGSymbolElement::IsExposed(ExecutionContext* execution_context) { return execution_context->IsWindow(); }
...
static_assert(std::is_same<decltype(&SVGSymbolElement::HasPendingActivity), decltype(&ScriptWrappable::HasPendingActivity)>::value,
    "SVGSymbolElement is overriding hasPendingActivity() without "
    "[ActiveScriptWrappable] extended attribute.");
...
void ViewBoxAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    SVGSymbolElement* blink_receiver = V8SVGSymbolElement::ToWrappableUnsafe(v8_receiver);
