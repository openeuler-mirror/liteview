...
public:
    ...
    static ShadowRootInit* Create(v8::Isolate* isolate) { return MakeGarbageCollected<ShadowRootInit>(isolate); }
    ...
    void setMode(V8ShadowRootMode value) { member_mode_ = value; }
    void setMode(V8ShadowRootMode::Enum value) { member_mode_ = V8ShadowRootMode(value); }

    bool hasRegistry() const { return has_registry_; }
    CustomElementRegistry* registry() const
    {
        DCHECK(hasRegistry());
        return member_registry_;
    }
    ...
    void setMode(const String& value) { member_mode_ = V8ShadowRootMode::Create(value).value(); }
