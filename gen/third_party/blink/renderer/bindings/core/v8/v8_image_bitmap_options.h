...
public:
    ...
    static ImageBitmapOptions* Create(v8::Isolate* isolate) { return MakeGarbageCollected<ImageBitmapOptions>(isolate); }
    ...
    bool hasColorSpaceConversion() const { return true; }
    V8ColorSpaceConversion colorSpaceConversion() const { return member_color_space_conversion_; }
    void setColorSpaceConversion(V8ColorSpaceConversion value) { member_color_space_conversion_ = value; }
    void setColorSpaceConversion(V8ColorSpaceConversion::Enum value) { member_color_space_conversion_ = V8ColorSpaceConversion(value); }

    bool hasImageOrientation() const { return true; }
    V8ImageOrientation imageOrientation() const { return member_image_orientation_; }
    void setImageOrientation(V8ImageOrientation value) { member_image_orientation_ = value; }
    void setImageOrientation(V8ImageOrientation::Enum value) { member_image_orientation_ = V8ImageOrientation(value); }

    bool hasPremultiplyAlpha() const { return true; }
    V8PremultiplyAlpha premultiplyAlpha() const { return member_premultiply_alpha_; }
    void setPremultiplyAlpha(V8PremultiplyAlpha value) { member_premultiply_alpha_ = value; }
    void setPremultiplyAlpha(V8PremultiplyAlpha::Enum value) { member_premultiply_alpha_ = V8PremultiplyAlpha(value); }
    ...
    bool hasResizeQuality() const { return true; }
    V8ResizeQuality resizeQuality() const { return member_resize_quality_; }
    void setResizeQuality(V8ResizeQuality value) { member_resize_quality_ = value; }
    void setResizeQuality(V8ResizeQuality::Enum value) { member_resize_quality_ = V8ResizeQuality(value); }
    ...
    void setColorSpaceConversion(const String& value) { member_color_space_conversion_ = V8ColorSpaceConversion::Create(value).value(); }
    void setImageOrientation(const String& value) { member_image_orientation_ = V8ImageOrientation::Create(value).value(); }
    void setPremultiplyAlpha(const String& value) { member_premultiply_alpha_ = V8PremultiplyAlpha::Create(value).value(); }
    void setResizeQuality(const String& value) { member_resize_quality_ = V8ResizeQuality::Create(value).value(); }
