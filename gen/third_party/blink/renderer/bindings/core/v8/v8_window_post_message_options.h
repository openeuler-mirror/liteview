...
public:
    ...
    static WindowPostMessageOptions* Create(v8::Isolate* isolate) { return MakeGarbageCollected<WindowPostMessageOptions>(isolate); }
    ...
    bool hasDelegate() const { return has_delegate_; }
    ...
    bool hasTargetOrigin() const { return true; }
    const String& targetOrigin() const { return member_target_origin_; }
