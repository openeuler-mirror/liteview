...
public:
    ...
    static ProfilerStack* Create(v8::Isolate* isolate) { return MakeGarbageCollected<ProfilerStack>(isolate); }
    ...
    bool hasFrameId() const { return true; }
    uint64_t frameId() const { return member_frame_id_; }
    void setFrameId(uint64_t value) { member_frame_id_ = value; }
