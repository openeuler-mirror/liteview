...
bool V8Screen::IsExposed(ExecutionContext* execution_context) { return execution_context->IsWindow(); }
...
static_assert(std::is_same<decltype(&Screen::HasPendingActivity), decltype(&ScriptWrappable::HasPendingActivity)>::value,
