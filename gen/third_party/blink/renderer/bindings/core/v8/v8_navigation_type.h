...
public:
    ...
    static absl::optional<V8NavigationType> Create(const String& value);
...
inline bool operator==(const V8NavigationType& lhs, V8NavigationType::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8NavigationType::Enum lhs, const V8NavigationType& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
