...
const char* V8MojoWatchCallback::NameInHeapSnapshot() const { return "V8MojoWatchCallback"; }
...
v8::Maybe<void> V8MojoWatchCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, uint32_t arg1_result)
{
    ...
    if (!ToV8Traits<IDLUnsignedLong>::ToV8(script_state, arg1_result).ToLocal(&v8_arg1_result)) {
        return v8::Nothing<void>();
    }
