...
public:
    ...
    static ImageDataSettings* Create(v8::Isolate* isolate) { return MakeGarbageCollected<ImageDataSettings>(isolate); }
    ...
    bool hasStorageFormat() const { return true; }
    V8ImageDataStorageFormat storageFormat() const { return member_storage_format_; }
    void setStorageFormat(V8ImageDataStorageFormat value) { member_storage_format_ = value; }
    void setStorageFormat(V8ImageDataStorageFormat::Enum value) { member_storage_format_ = V8ImageDataStorageFormat(value); }
    ...
    void setStorageFormat(const String& value) { member_storage_format_ = V8ImageDataStorageFormat::Create(value).value(); }
