...
public:
    ...
    bool IsV8UnionStringOrTrustedScript() const { return content_type_ == ContentType::kString || content_type_ == ContentType::kTrustedScript; }
