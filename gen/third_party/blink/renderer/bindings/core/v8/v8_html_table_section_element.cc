...
bool V8HTMLTableSectionElement::IsExposed(ExecutionContext* execution_context) { return execution_context->IsWindow(); }
...
static_assert(std::is_same<decltype(&HTMLTableSectionElement::HasPendingActivity), decltype(&ScriptWrappable::HasPendingActivity)>::value,
