...
public:
    ...
    static FullscreenOptions* Create(v8::Isolate* isolate) { return MakeGarbageCollected<FullscreenOptions>(isolate); }
    ...
    bool hasNavigationUI() const { return true; }
    V8FullscreenNavigationUI navigationUI() const { return member_navigation_ui_; }
    void setNavigationUI(V8FullscreenNavigationUI value) { member_navigation_ui_ = value; }
    void setNavigationUI(V8FullscreenNavigationUI::Enum value) { member_navigation_ui_ = V8FullscreenNavigationUI(value); }
    ...
    void setNavigationUI(const String& value) { member_navigation_ui_ = V8FullscreenNavigationUI::Create(value).value(); }
