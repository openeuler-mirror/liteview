...
public:
    ...
    static absl::optional<V8DirectionSetting> Create(const String& value);
...
inline bool operator==(const V8DirectionSetting& lhs, V8DirectionSetting::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8DirectionSetting::Enum lhs, const V8DirectionSetting& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
