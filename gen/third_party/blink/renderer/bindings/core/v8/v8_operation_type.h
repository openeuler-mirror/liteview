...
public:
    ...
    static absl::optional<V8OperationType> Create(const String& value);
...
inline bool operator==(const V8OperationType& lhs, V8OperationType::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8OperationType::Enum lhs, const V8OperationType& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
