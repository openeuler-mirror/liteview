...
const char* V8MutationCallback::NameInHeapSnapshot() const { return "V8MutationCallback"; }
    ...
    bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const HeapVector<Member<MutationRecord>>& arg1_mutations, MutationObserver* arg2_observer)
{
    ...
    if (!ToV8Traits<IDLSequence<MutationRecord>>::ToV8(script_state, arg1_mutations).ToLocal(&v8_arg1_mutations)) {
        return v8::Nothing<void>();
    }
    argv[0] = v8_arg1_mutations;
    v8::Local<v8::Value> v8_arg2_observer;
    if (!ToV8Traits<MutationObserver>::ToV8(script_state, arg2_observer).ToLocal(&v8_arg2_observer)) {
        return v8::Nothing<void>();
    }
