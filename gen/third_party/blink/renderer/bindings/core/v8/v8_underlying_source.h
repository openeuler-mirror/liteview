...
public:
    static UnderlyingSource* Create() { return MakeGarbageCollected<UnderlyingSource>(); }
    static UnderlyingSource* Create(v8::Isolate* isolate) { return MakeGarbageCollected<UnderlyingSource>(isolate); }
    ...
    bool hasAutoAllocateChunkSize() const { return has_auto_allocate_chunk_size_; }
    ...
    bool hasCancel() const { return has_cancel_; }
    ...
    bool hasPull() const { return has_pull_; }
