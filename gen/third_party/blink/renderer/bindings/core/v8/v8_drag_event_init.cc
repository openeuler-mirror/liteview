...
bool DragEventInit::FillV8ObjectWithMembers(ScriptState* script_state, v8::Local<v8::Object> v8_dictionary) const
{
    ...
    if (hasGetDataTransfer()) {
        ...
        if (!ToV8Traits<IDLNullable<DataTransfer>>::ToV8(script_state, member_get_data_transfer_).ToLocal(&v8_value)) {
            return false;
        }
...
void DragEventInit::FillMembersFromV8Object(v8::Isolate* isolate, v8::Local<v8::Object> v8_dictionary, ExceptionState& exception_state)
{
    ...
    if (!bindings::GetDictionaryMemberFromV8Object<IDLNullable<DataTransfer>, is_optional>(
            isolate, current_context, v8_dictionary, v8_own_member_names[0].Get(isolate), fallback_presence_var, member_get_data_transfer_, try_block, exception_state)) {
        return;
    }
}
