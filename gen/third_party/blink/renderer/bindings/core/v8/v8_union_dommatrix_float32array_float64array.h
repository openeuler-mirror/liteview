...
public:
    ...
    bool IsDOMMatrix() const { return content_type_ == ContentType::kDOMMatrix; }
    ...
    bool IsFloat64Array() const { return content_type_ == ContentType::kFloat64Array; }
...
private:
    ...
    static constexpr const char* UnionNameInIDL() { return "(DOMMatrix or Float32Array or Float64Array)"; }
