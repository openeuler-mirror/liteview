...
void StructuredSerializeOptions::setTransfer(const HeapVector<ScriptValue>& value) { member_transfer_ = value; }

void StructuredSerializeOptions::setTransfer(HeapVector<ScriptValue>&& value) { member_transfer_ = std::move(value); }
...
void StructuredSerializeOptions::FillMembersFromV8Object(v8::Isolate* isolate, v8::Local<v8::Object> v8_dictionary, ExceptionState& exception_state)
{
    ...
    if (!bindings::GetDictionaryMemberFromV8Object<IDLSequence<IDLObject>, is_optional>(
            isolate, current_context, v8_dictionary, v8_own_member_names[0].Get(isolate), fallback_presence_var, member_transfer_, try_block, exception_state)) {
        return;
    }
}
