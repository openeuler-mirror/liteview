...
inline bool operator==(const V8RenderBlockingStatusType& lhs, V8RenderBlockingStatusType::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8RenderBlockingStatusType::Enum lhs, const V8RenderBlockingStatusType& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
