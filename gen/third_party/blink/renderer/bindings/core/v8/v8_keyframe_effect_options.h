...
public:
    ...
    static KeyframeEffectOptions* Create(v8::Isolate* isolate) { return MakeGarbageCollected<KeyframeEffectOptions>(isolate); }
    ...
    void setComposite(V8CompositeOperation value) { member_composite_ = value; }
    void setComposite(V8CompositeOperation::Enum value) { member_composite_ = V8CompositeOperation(value); }

    bool hasPseudoElement() const { return true; }
    const String& pseudoElement() const { return member_pseudo_element_; }
    void setPseudoElement(const String& value);
    void setPseudoElement(String&& value);
    // Obsolete accessor functions
    void setComposite(const String& value) { member_composite_ = V8CompositeOperation::Create(value).value(); }
