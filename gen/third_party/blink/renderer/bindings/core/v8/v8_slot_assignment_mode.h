...
public:
    ...
    static absl::optional<V8SlotAssignmentMode> Create(const String& value);
...
inline bool operator==(const V8SlotAssignmentMode& lhs, V8SlotAssignmentMode::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8SlotAssignmentMode::Enum lhs, const V8SlotAssignmentMode& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
