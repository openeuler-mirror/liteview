...
public:
    ...
    static BlobPropertyBag* Create(v8::Isolate* isolate) { return MakeGarbageCollected<BlobPropertyBag>(isolate); }
    ...
    bool hasEndings() const { return true; }
    V8EndingType endings() const { return member_endings_; }
    void setEndings(V8EndingType value) { member_endings_ = value; }
    void setEndings(V8EndingType::Enum value) { member_endings_ = V8EndingType(value); }
    ...
    void setEndings(const String& value) { member_endings_ = V8EndingType::Create(value).value(); }
