...
public:
    ...
    bool IsUSVStringSequence() const { return content_type_ == ContentType::kUSVStringSequence; }
...
private:
    ...
    static constexpr const char* UnionNameInIDL() { return "(USVString or sequence<USVString>)"; }
