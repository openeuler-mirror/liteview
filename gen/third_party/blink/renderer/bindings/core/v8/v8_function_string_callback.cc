...
const char* V8FunctionStringCallback::NameInHeapSnapshot() const { return "V8FunctionStringCallback"; }
...
v8::Maybe<void> V8FunctionStringCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const String& arg1_data)
{
    ...
    if (!ToV8Traits<IDLString>::ToV8(script_state, arg1_data).ToLocal(&v8_arg1_data)) {
        return v8::Nothing<void>();
    }
    argv[0] = v8_arg1_data;
