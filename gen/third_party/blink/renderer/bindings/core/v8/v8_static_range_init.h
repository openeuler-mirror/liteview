...
public:
    ...
    static StaticRangeInit* Create(v8::Isolate* isolate) { return MakeGarbageCollected<StaticRangeInit>(isolate); }
    ...
    bool hasEndContainer() const { return true; }
    Node* endContainer() const { return member_end_container_; }
    ...
    bool hasEndOffset() const { return true; }
    uint32_t endOffset() const { return member_end_offset_; }
    void setEndOffset(uint32_t value) { member_end_offset_ = value; }

    bool hasStartContainer() const { return true; }
    Node* startContainer() const { return member_start_container_; }
    ...
    bool hasStartOffset() const { return true; }
    uint32_t startOffset() const { return member_start_offset_; }
    void setStartOffset(uint32_t value) { member_start_offset_ = value; }
