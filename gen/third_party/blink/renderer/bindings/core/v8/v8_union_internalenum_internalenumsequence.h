...
public:
    ...
    bool IsInternalEnum() const { return content_type_ == ContentType::kInternalEnum; }
    ...
    bool IsInternalEnumSequence() const { return content_type_ == ContentType::kInternalEnumSequence; }
...
private:
    ...
    static constexpr const char* UnionNameInIDL() { return "(InternalEnum or sequence<InternalEnum>)"; }
