...
bool V8StyleSheetList::IsExposed(ExecutionContext* execution_context) { return execution_context->IsWindow(); }
...
static_assert(std::is_same<decltype(&StyleSheetList::HasPendingActivity), decltype(&ScriptWrappable::HasPendingActivity)>::value,
...
void V8StyleSheetList::NamedPropertySetterCallback(v8::Local<v8::Name> v8_property_name, v8::Local<v8::Value> v8_property_value, const v8::PropertyCallbackInfo<v8::Value>& info)
{
    ...
    if (!is_creating) {
        ...
        if (info.ShouldThrowOnError()) {
            ExceptionState exception_state(info.GetIsolate(), ExceptionContext::Context::kNamedPropertySet, "StyleSheetList");
...
void V8StyleSheetList::NamedPropertyDeleterCallback(v8::Local<v8::Name> v8_property_name, const v8::PropertyCallbackInfo<v8::Boolean>& info)
{
...
void V8StyleSheetList::NamedPropertyDefinerCallback(
...
void V8StyleSheetList::NamedPropertyDescriptorCallback(v8::Local<v8::Name> v8_property_name, const v8::PropertyCallbackInfo<v8::Value>& info)
{
...
void V8StyleSheetList::IndexedPropertySetterCallback(uint32_t index, v8::Local<v8::Value> v8_property_value, const v8::PropertyCallbackInfo<v8::Value>& info)
{
    ...
    bindings::V8SetReturnValue(info, nullptr);
    if (info.ShouldThrowOnError()) {
        ExceptionState exception_state(info.GetIsolate(), ExceptionContext::Context::kIndexedPropertySet, "StyleSheetList");
        exception_state.ThrowTypeError("Indexed property setter is not supported.");
    }
}

void V8StyleSheetList::IndexedPropertyDeleterCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Boolean>& info)
{
    ...
    if (is_supported and info.ShouldThrowOnError()) {
        ExceptionState exception_state(info.GetIsolate(), ExceptionContext::Context::kIndexedPropertyDelete, "StyleSheetList");
        exception_state.ThrowTypeError("Index property deleter is not supported.");
    }
}

void V8StyleSheetList::IndexedPropertyDefinerCallback(uint32_t index, const v8::PropertyDescriptor& v8_property_desc, const v8::PropertyCallbackInfo<v8::Value>& info)
{
...
void V8StyleSheetList::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template)
{
    ...
    // Named interceptors
    instance_object_template->SetHandler(v8::NamedPropertyHandlerConfiguration(V8StyleSheetList::NamedPropertyGetterCallback, V8StyleSheetList::NamedPropertySetterCallback,
        nullptr, // query
    ...
    instance_object_template->SetHandler(v8::IndexedPropertyHandlerConfiguration(V8StyleSheetList::IndexedPropertyGetterCallback, V8StyleSheetList::IndexedPropertySetterCallback,
        nullptr, // query
