...
public:
    ...
    static absl::optional<V8RequestCredentials> Create(const String& value);
...
inline bool operator==(const V8RequestCredentials& lhs, V8RequestCredentials::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8RequestCredentials::Enum lhs, const V8RequestCredentials& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
