...
bool V8SharedWorker::IsExposed(ExecutionContext* execution_context) { return execution_context->IsWindow() && RuntimeEnabledFeatures::SharedWorkerEnabled(); }
...
static_assert(!std::is_same<decltype(&SharedWorker::HasPendingActivity), decltype(&ScriptWrappable::HasPendingActivity)>::value,
...
void ConstructorCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    decltype(NativeValueTraits<V8UnionStringOrWorkerOptions>::NativeValue(
