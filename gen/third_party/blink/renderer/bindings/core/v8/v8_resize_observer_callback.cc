...
const char* V8ResizeObserverCallback::NameInHeapSnapshot() const { return "V8ResizeObserverCallback"; }
    ...
    bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const HeapVector<Member<ResizeObserverEntry>>& arg1_entries, ResizeObserver* arg2_observer)
{
    ...
    if (!ToV8Traits<IDLSequence<ResizeObserverEntry>>::ToV8(script_state, arg1_entries).ToLocal(&v8_arg1_entries)) {
        return v8::Nothing<void>();
    }
    argv[0] = v8_arg1_entries;
    v8::Local<v8::Value> v8_arg2_observer;
    if (!ToV8Traits<ResizeObserver>::ToV8(script_state, arg2_observer).ToLocal(&v8_arg2_observer)) {
        return v8::Nothing<void>();
    }
