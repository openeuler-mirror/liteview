...
V8UnionByteStringByteStringRecordOrByteStringSequenceSequence::V8UnionByteStringByteStringRecordOrByteStringSequenceSequence(const Vector<std::pair<String, String>>& value)
    : content_type_(ContentType::kByteStringByteStringRecord)
    , member_byte_string_byte_string_record_(value)
{
}

V8UnionByteStringByteStringRecordOrByteStringSequenceSequence::V8UnionByteStringByteStringRecordOrByteStringSequenceSequence(Vector<std::pair<String, String>>&& value)
    : content_type_(ContentType::kByteStringByteStringRecord)
    , member_byte_string_byte_string_record_(std::move(value))
{
}

V8UnionByteStringByteStringRecordOrByteStringSequenceSequence::V8UnionByteStringByteStringRecordOrByteStringSequenceSequence(const Vector<Vector<String>>& value)
