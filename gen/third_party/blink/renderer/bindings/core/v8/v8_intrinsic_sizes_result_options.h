...
public:
    ...
    static IntrinsicSizesResultOptions* Create(v8::Isolate* isolate) { return MakeGarbageCollected<IntrinsicSizesResultOptions>(isolate); }
    ...
    bool hasMaxContentSize() const { return true; }
    double maxContentSize() const { return member_max_content_size_; }
    void setMaxContentSize(double value) { member_max_content_size_ = value; }

    bool hasMinContentSize() const { return true; }
    double minContentSize() const { return member_min_content_size_; }
    void setMinContentSize(double value) { member_min_content_size_ = value; }
