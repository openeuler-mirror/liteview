...
public:
    ...
    static absl::optional<V8FillMode> Create(const String& value);
...
inline bool operator==(const V8FillMode& lhs, V8FillMode::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8FillMode::Enum lhs, const V8FillMode& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
