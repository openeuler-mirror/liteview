...
public:
    ...
    static MemoryBreakdownEntry* Create(v8::Isolate* isolate) { return MakeGarbageCollected<MemoryBreakdownEntry>(isolate); }
    ...
    bool hasAttribution() const { return true; }
    ...
    bool hasBytes() const { return true; }
    uint64_t bytes() const { return member_bytes_; }
    void setBytes(uint64_t value) { member_bytes_ = value; }

    bool hasTypes() const { return true; }
    const Vector<String>& types() const { return member_types_; }
