...
bool V8DOMRectList::IsExposed(ExecutionContext* execution_context) { return execution_context->IsWindow(); }
...
static_assert(std::is_same<decltype(&DOMRectList::HasPendingActivity), decltype(&ScriptWrappable::HasPendingActivity)>::value,
...
void V8DOMRectList::IndexedPropertySetterCallback(uint32_t index, v8::Local<v8::Value> v8_property_value, const v8::PropertyCallbackInfo<v8::Value>& info)
{
    ...
    if (info.ShouldThrowOnError()) {
        ExceptionState exception_state(info.GetIsolate(), ExceptionContext::Context::kIndexedPropertySet, "DOMRectList");
        exception_state.ThrowTypeError("Indexed property setter is not supported.");
    }
}

void V8DOMRectList::IndexedPropertyDeleterCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Boolean>& info)
{
    ...
    if (is_supported and info.ShouldThrowOnError()) {
        ExceptionState exception_state(info.GetIsolate(), ExceptionContext::Context::kIndexedPropertyDelete, "DOMRectList");
        exception_state.ThrowTypeError("Index property deleter is not supported.");
    }
}

void V8DOMRectList::IndexedPropertyDefinerCallback(uint32_t index, const v8::PropertyDescriptor& v8_property_desc, const v8::PropertyCallbackInfo<v8::Value>& info)
{
...
void V8DOMRectList::IndexedPropertyDescriptorCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info)
{
...
void V8DOMRectList::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template)
{
    ...
    instance_object_template->SetHandler(v8::IndexedPropertyHandlerConfiguration(V8DOMRectList::IndexedPropertyGetterCallback, V8DOMRectList::IndexedPropertySetterCallback,
        nullptr, // query
