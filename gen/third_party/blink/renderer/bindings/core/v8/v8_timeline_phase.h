...
public:
    ...
    static absl::optional<V8TimelinePhase> Create(const String& value);
...
inline bool operator==(const V8TimelinePhase& lhs, V8TimelinePhase::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8TimelinePhase::Enum lhs, const V8TimelinePhase& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
