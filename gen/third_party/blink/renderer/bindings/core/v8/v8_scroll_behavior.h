...
public:
    ...
    static absl::optional<V8ScrollBehavior> Create(const String& value);
...
inline bool operator==(const V8ScrollBehavior& lhs, V8ScrollBehavior::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8ScrollBehavior::Enum lhs, const V8ScrollBehavior& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
