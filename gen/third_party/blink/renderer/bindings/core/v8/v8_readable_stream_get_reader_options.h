...
public:
    static ReadableStreamGetReaderOptions* Create() { return MakeGarbageCollected<ReadableStreamGetReaderOptions>(); }
    static ReadableStreamGetReaderOptions* Create(v8::Isolate* isolate) { return MakeGarbageCollected<ReadableStreamGetReaderOptions>(isolate); }
