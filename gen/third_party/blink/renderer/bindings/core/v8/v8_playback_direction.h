...
public:
    ...
    static absl::optional<V8PlaybackDirection> Create(const String& value);
...
inline bool operator==(const V8PlaybackDirection& lhs, V8PlaybackDirection::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8PlaybackDirection::Enum lhs, const V8PlaybackDirection& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
