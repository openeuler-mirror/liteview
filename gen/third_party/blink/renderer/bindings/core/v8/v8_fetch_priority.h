...
inline bool operator==(const V8FetchPriority& lhs, V8FetchPriority::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8FetchPriority::Enum lhs, const V8FetchPriority& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
