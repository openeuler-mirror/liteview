...
static_assert(std::is_same<decltype(&CSSTransformValue::HasPendingActivity), decltype(&ScriptWrappable::HasPendingActivity)>::value,
...
void V8CSSTransformValue::IndexedPropertySetterCallback(uint32_t index, v8::Local<v8::Value> v8_property_value, const v8::PropertyCallbackInfo<v8::Value>& info)
{
...
void V8CSSTransformValue::IndexedPropertyDeleterCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Boolean>& info)
{
    ...
    if (is_supported and info.ShouldThrowOnError()) {
        ExceptionState exception_state(info.GetIsolate(), ExceptionContext::Context::kIndexedPropertyDelete, "CSSTransformValue");
        exception_state.ThrowTypeError("Index property deleter is not supported.");
    }
}

void V8CSSTransformValue::IndexedPropertyDefinerCallback(uint32_t index, const v8::PropertyDescriptor& v8_property_desc, const v8::PropertyCallbackInfo<v8::Value>& info)
{
    ...
    if (v8_property_desc.has_get() || v8_property_desc.has_set()) {
        ...
        if (info.ShouldThrowOnError()) {
            ExceptionState exception_state(info.GetIsolate(), ExceptionContext::Context::kIndexedPropertySet, "CSSTransformValue");
    ...
    V8CSSTransformValue::IndexedPropertySetterCallback(index, v8_property_desc.has_value() ? v8_property_desc.value() : v8::Undefined(isolate).As<v8::Value>(), info);
}
...
void ConstructorCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    auto&& return_value = CSSTransformValue::Create(arg1_transforms, exception_state);
    if (UNLIKELY(exception_state.HadException())) {
        return;
    }
...
void V8CSSTransformValue::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template)
{
    ...
    instance_object_template->SetHandler(
        v8::IndexedPropertyHandlerConfiguration(V8CSSTransformValue::IndexedPropertyGetterCallback, V8CSSTransformValue::IndexedPropertySetterCallback,
            nullptr, // query
            V8CSSTransformValue::IndexedPropertyDeleterCallback, V8CSSTransformValue::IndexedPropertyEnumeratorCallback, V8CSSTransformValue::IndexedPropertyDefinerCallback,
            V8CSSTransformValue::IndexedPropertyDescriptorCallback, v8::Local<v8::Value>(), v8::PropertyHandlerFlags::kHasNoSideEffect));
    ...
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
...

    {
        static const IDLMemberInstaller::OperationConfig kOperationTable[] = {
            { "toMatrix", ToMatrixOperationCallback, 0, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
                unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck),
