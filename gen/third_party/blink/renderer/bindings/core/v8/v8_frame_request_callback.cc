...
const char* V8FrameRequestCallback::NameInHeapSnapshot() const { return "V8FrameRequestCallback"; }
...
v8::Maybe<void> V8FrameRequestCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, double arg1_high_res_time)
{
    ...
    if (!ToV8Traits<IDLDouble>::ToV8(script_state, arg1_high_res_time).ToLocal(&v8_arg1_high_res_time)) {
        return v8::Nothing<void>();
    }
