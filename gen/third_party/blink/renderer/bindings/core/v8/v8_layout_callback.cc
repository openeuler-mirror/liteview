...
const char* V8LayoutCallback::NameInHeapSnapshot() const { return "V8LayoutCallback"; }

v8::Maybe<ScriptValue> V8LayoutCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const HeapVector<Member<CustomLayoutChild>>& arg1_children,
    CustomLayoutEdges* arg2_edges, CustomLayoutConstraints* arg3_constraints, StylePropertyMapReadOnly* arg4_style_map)
{
...
v8::Maybe<ScriptValue> V8LayoutCallback::Construct(
    const HeapVector<Member<CustomLayoutChild>>& arg1_children, CustomLayoutEdges* arg2_edges, CustomLayoutConstraints* arg3_constraints, StylePropertyMapReadOnly* arg4_style_map)
{
    const char* const class_like_name = "LayoutCallback";
