...
public:
    ...
    static absl::optional<V8FormStateRestoreMode> Create(const String& value);
...
inline bool operator==(const V8FormStateRestoreMode& lhs, V8FormStateRestoreMode::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8FormStateRestoreMode::Enum lhs, const V8FormStateRestoreMode& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
