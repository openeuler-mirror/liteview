...
public:
    ...
    static absl::optional<V8ReferrerPolicy> Create(const String& value);
...
inline bool operator==(const V8ReferrerPolicy& lhs, V8ReferrerPolicy::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8ReferrerPolicy::Enum lhs, const V8ReferrerPolicy& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
