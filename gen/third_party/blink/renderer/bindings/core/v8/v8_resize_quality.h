...
public:
    ...
    static absl::optional<V8ResizeQuality> Create(const String& value);
...
inline bool operator==(const V8ResizeQuality& lhs, V8ResizeQuality::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8ResizeQuality::Enum lhs, const V8ResizeQuality& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
