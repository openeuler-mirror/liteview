...
V8ObservableArrayCSSStyleSheet::V8ObservableArrayCSSStyleSheet(
    ScriptWrappable* platform_object, SetAlgorithmCallback set_algorithm_callback, DeleteAlgorithmCallback delete_algorithm_callback)
...
void V8ObservableArrayCSSStyleSheet::Trace(Visitor* visitor) const { BaseClass::Trace(visitor); }
