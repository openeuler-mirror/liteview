...
class CORE_EXPORT StreamPipeOptions : public bindings::DictionaryBase {

public:
    static StreamPipeOptions* Create() { return MakeGarbageCollected<StreamPipeOptions>(); }
    static StreamPipeOptions* Create(v8::Isolate* isolate) { return MakeGarbageCollected<StreamPipeOptions>(isolate); }
    ...
    bool hasPreventAbort() const { return true; }
    bool preventAbort() const { return member_prevent_abort_; }
    void setPreventAbort(bool value) { member_prevent_abort_ = value; }

    bool hasPreventCancel() const { return true; }
    bool preventCancel() const { return member_prevent_cancel_; }
    void setPreventCancel(bool value) { member_prevent_cancel_ = value; }

    bool hasPreventClose() const { return true; }
    bool preventClose() const { return member_prevent_close_; }
    void setPreventClose(bool value) { member_prevent_close_ = value; }
