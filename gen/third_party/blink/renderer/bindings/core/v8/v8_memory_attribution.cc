...
void MemoryAttribution::setScope(const String& value) { member_scope_ = value; }

void MemoryAttribution::setScope(String&& value) { member_scope_ = std::move(value); }

void MemoryAttribution::setUrl(const String& value) { member_url_ = value; }

void MemoryAttribution::setUrl(String&& value) { member_url_ = std::move(value); }
...
void MemoryAttribution::FillMembersFromV8Object(v8::Isolate* isolate, v8::Local<v8::Object> v8_dictionary, ExceptionState& exception_state)
{
    ...
    if (!bindings::GetDictionaryMemberFromV8Object<MemoryAttributionContainer, is_optional>(
            isolate, current_context, v8_dictionary, v8_own_member_names[0].Get(isolate), has_container_, member_container_, try_block, exception_state)) {
        return;
    }
    ...
    if (!bindings::GetDictionaryMemberFromV8Object<IDLString, is_required>(
            isolate, current_context, v8_dictionary, v8_own_member_names[1].Get(isolate), fallback_presence_var, member_scope_, try_block, exception_state)) {
        return;
    }
    ...
    if (!bindings::GetDictionaryMemberFromV8Object<IDLUSVString, is_required>(
            isolate, current_context, v8_dictionary, v8_own_member_names[2].Get(isolate), fallback_presence_var, member_url_, try_block, exception_state)) {
        return;
    }
}
