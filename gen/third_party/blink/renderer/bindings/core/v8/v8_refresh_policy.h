...
public:
    ...
    static absl::optional<V8RefreshPolicy> Create(const String& value);
...
inline bool operator==(const V8RefreshPolicy& lhs, V8RefreshPolicy::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8RefreshPolicy::Enum lhs, const V8RefreshPolicy& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
