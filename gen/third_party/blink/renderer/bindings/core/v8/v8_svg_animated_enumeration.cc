...
bool V8SVGAnimatedEnumeration::IsExposed(ExecutionContext* execution_context) { return execution_context->IsWindow(); }
...
static_assert(std::is_same<decltype(&SVGAnimatedEnumerationBase::HasPendingActivity), decltype(&ScriptWrappable::HasPendingActivity)>::value,
