...
public:
    ...
    static TextFormatInit* Create(v8::Isolate* isolate) { return MakeGarbageCollected<TextFormatInit>(isolate); }
    ...
    bool hasTextColor() const { return has_text_color_; }
    ...
    bool hasUnderlineColor() const { return has_underline_color_; }
