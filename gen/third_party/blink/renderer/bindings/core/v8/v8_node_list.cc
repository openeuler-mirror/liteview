...
bool V8NodeList::IsExposed(ExecutionContext* execution_context) { return execution_context->IsWindow(); }
...
static_assert(std::is_same<decltype(&NodeList::HasPendingActivity), decltype(&ScriptWrappable::HasPendingActivity)>::value,
    "NodeList is overriding hasPendingActivity() without "
    "[ActiveScriptWrappable] extended attribute.");
...
void V8NodeList::IndexedPropertyGetterCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info)
{
    ...
    NodeList* blink_receiver = V8NodeList::ToWrappableUnsafe(v8_receiver);
...
void V8NodeList::IndexedPropertySetterCallback(uint32_t index, v8::Local<v8::Value> v8_property_value, const v8::PropertyCallbackInfo<v8::Value>& info)
{
    ...
    if (info.ShouldThrowOnError()) {
        ExceptionState exception_state(info.GetIsolate(), ExceptionContext::Context::kIndexedPropertySet, "NodeList");
        exception_state.ThrowTypeError("Indexed property setter is not supported.");
    }
}

void V8NodeList::IndexedPropertyDeleterCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Boolean>& info)
{
    ...
    if (is_supported and info.ShouldThrowOnError()) {
        ExceptionState exception_state(info.GetIsolate(), ExceptionContext::Context::kIndexedPropertyDelete, "NodeList");
        exception_state.ThrowTypeError("Index property deleter is not supported.");
    }
}

void V8NodeList::IndexedPropertyDefinerCallback(uint32_t index, const v8::PropertyDescriptor& v8_property_desc, const v8::PropertyCallbackInfo<v8::Value>& info)
{
...
void ItemOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    const char* const class_like_name = "NodeList";
...
void V8NodeList::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template)
{
    ...
    instance_object_template->SetHandler(v8::IndexedPropertyHandlerConfiguration(V8NodeList::IndexedPropertyGetterCallback, V8NodeList::IndexedPropertySetterCallback,
        nullptr, // query
