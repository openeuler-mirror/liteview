...
bool V8HTMLAllCollection::IsExposed(ExecutionContext* execution_context) { return execution_context->IsWindow(); }
...
static_assert(std::is_same<decltype(&HTMLAllCollection::HasPendingActivity), decltype(&ScriptWrappable::HasPendingActivity)>::value,
    "HTMLAllCollection is overriding hasPendingActivity() without "
    "[ActiveScriptWrappable] extended attribute.");

void V8HTMLAllCollection::NamedPropertyGetterCallback(v8::Local<v8::Name> v8_property_name, const v8::PropertyCallbackInfo<v8::Value>& info)
{
    ...
    HTMLAllCollection* blink_receiver = V8HTMLAllCollection::ToWrappableUnsafe(v8_receiver);
...
void V8HTMLAllCollection::NamedPropertySetterCallback(v8::Local<v8::Name> v8_property_name, v8::Local<v8::Value> v8_property_value, const v8::PropertyCallbackInfo<v8::Value>& info)
{
    ...
    if (!is_creating) {
        ...
        if (info.ShouldThrowOnError()) {
            ExceptionState exception_state(info.GetIsolate(), ExceptionContext::Context::kNamedPropertySet, "HTMLAllCollection");
...
void V8HTMLAllCollection::NamedPropertyDeleterCallback(v8::Local<v8::Name> v8_property_name, const v8::PropertyCallbackInfo<v8::Boolean>& info)
{
    ...
    ExceptionState exception_state(info.GetIsolate(), ExceptionContext::Context::kNamedPropertyDelete, "HTMLAllCollection");
...
void V8HTMLAllCollection::NamedPropertyDefinerCallback(
...
void V8HTMLAllCollection::NamedPropertyDescriptorCallback(v8::Local<v8::Name> v8_property_name, const v8::PropertyCallbackInfo<v8::Value>& info)
{
...
void V8HTMLAllCollection::NamedPropertyQueryCallback(v8::Local<v8::Name> v8_property_name, const v8::PropertyCallbackInfo<v8::Integer>& info)
{
    ...
    HTMLAllCollection* blink_receiver = V8HTMLAllCollection::ToWrappableUnsafe(v8_receiver);
    const AtomicString& blink_property_name = ToCoreAtomicString(v8_property_name.As<v8::String>());
    ExceptionState exception_state(isolate, ExceptionContext::Context::kNamedPropertyGet, "HTMLAllCollection");
    bool does_exist = blink_receiver->NamedPropertyQuery(blink_property_name, exception_state);
    if (!does_exist)
        return; // Do not intercept.
...
void V8HTMLAllCollection::NamedPropertyEnumeratorCallback(const v8::PropertyCallbackInfo<v8::Array>& info)
{
    ...
    ExceptionState exception_state(info.GetIsolate(), ExceptionContext::Context::kNamedPropertyEnumerate, "HTMLAllCollection");
...
void V8HTMLAllCollection::IndexedPropertySetterCallback(uint32_t index, v8::Local<v8::Value> v8_property_value, const v8::PropertyCallbackInfo<v8::Value>& info)
{
    ...
    bindings::V8SetReturnValue(info, nullptr);
    if (info.ShouldThrowOnError()) {
        ExceptionState exception_state(info.GetIsolate(), ExceptionContext::Context::kIndexedPropertySet, "HTMLAllCollection");
        exception_state.ThrowTypeError("Indexed property setter is not supported.");
    }
}

void V8HTMLAllCollection::IndexedPropertyDeleterCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Boolean>& info)
{
    ...
    if (is_supported and info.ShouldThrowOnError()) {
        ExceptionState exception_state(info.GetIsolate(), ExceptionContext::Context::kIndexedPropertyDelete, "HTMLAllCollection");
        exception_state.ThrowTypeError("Index property deleter is not supported.");
    }
}

void V8HTMLAllCollection::IndexedPropertyDefinerCallback(uint32_t index, const v8::PropertyDescriptor& v8_property_desc, const v8::PropertyCallbackInfo<v8::Value>& info)
{
...
void NamedItemOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    if (UNLIKELY(info.Length() < 1)) {
        ...
        const char* const class_like_name = "HTMLAllCollection";
...
void V8HTMLAllCollection::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template)
{
    ...
    // Named interceptors
    instance_object_template->SetHandler(v8::NamedPropertyHandlerConfiguration(V8HTMLAllCollection::NamedPropertyGetterCallback, V8HTMLAllCollection::NamedPropertySetterCallback,
        V8HTMLAllCollection::NamedPropertyQueryCallback, V8HTMLAllCollection::NamedPropertyDeleterCallback, V8HTMLAllCollection::NamedPropertyEnumeratorCallback,
        V8HTMLAllCollection::NamedPropertyDefinerCallback, V8HTMLAllCollection::NamedPropertyDescriptorCallback, v8::Local<v8::Value>(),
    ...
    instance_object_template->SetHandler(
        v8::IndexedPropertyHandlerConfiguration(V8HTMLAllCollection::IndexedPropertyGetterCallback, V8HTMLAllCollection::IndexedPropertySetterCallback,
            nullptr, // query
            V8HTMLAllCollection::IndexedPropertyDeleterCallback, V8HTMLAllCollection::IndexedPropertyEnumeratorCallback, V8HTMLAllCollection::IndexedPropertyDefinerCallback,
            V8HTMLAllCollection::IndexedPropertyDescriptorCallback, v8::Local<v8::Value>(), v8::PropertyHandlerFlags::kHasNoSideEffect));

    // HTMLAllCollection-specific settings
    // https://html.spec.whatwg.org/C/#the-htmlallcollection-interface
    instance_object_template->SetCallAsFunctionHandler(V8HTMLAllCollection::LegacyCallCustom);
    ...
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
...

    {
        static const IDLMemberInstaller::OperationConfig kOperationTable[] = {
            { "item", ItemOperationCallback, 0, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds),
