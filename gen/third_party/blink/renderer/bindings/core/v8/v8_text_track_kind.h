...
public:
    ...
    static absl::optional<V8TextTrackKind> Create(const String& value);
...
inline bool operator==(const V8TextTrackKind& lhs, V8TextTrackKind::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8TextTrackKind::Enum lhs, const V8TextTrackKind& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
