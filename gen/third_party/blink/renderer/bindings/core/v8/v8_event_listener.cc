...
const char* V8EventListener::NameInHeapSnapshot() const { return "V8EventListener"; }
...
bool V8EventListener::IsRunnableOrThrowException(IgnorePause ignore_pause)
{
    ...
    const bool is_runnable = ignore_pause == IgnorePause::kIgnore ? IsCallbackFunctionRunnableIgnoringPause(callback_relevant_script_state, IncumbentScriptState())
