...
public:
    ...
    static absl::optional<V8TextTrackMode> Create(const String& value);
...
inline bool operator==(const V8TextTrackMode& lhs, V8TextTrackMode::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8TextTrackMode::Enum lhs, const V8TextTrackMode& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
