...
const char* V8PerformanceObserverCallback::NameInHeapSnapshot() const { return "V8PerformanceObserverCallback"; }
...
void V8PerformanceObserverCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, PerformanceObserverEntryList* arg1_entries,
    PerformanceObserver* arg2_observer, const PerformanceObserverCallbackOptions* arg3_options)
{
    v8::Isolate* isolate = GetIsolate();
