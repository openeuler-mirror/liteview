...
public:
    using SetAlgorithmCallback = void (ScriptWrappable::*)(
        ScriptState* script_state, V8ObservableArrayCSSStyleSheet& observable_array, size_type index, value_type& value, ExceptionState& exception_state);
    using DeleteAlgorithmCallback
        = void (ScriptWrappable::*)(ScriptState* script_state, V8ObservableArrayCSSStyleSheet& observable_array, size_type index, ExceptionState& exception_state);
...
private:
    ...
    static constexpr const char* ObservableArrayNameInIDL() { return "ObservableArray<CSSStyleSheet>"; }
