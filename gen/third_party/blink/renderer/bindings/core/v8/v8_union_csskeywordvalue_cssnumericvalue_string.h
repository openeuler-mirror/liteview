...
public:
    ...
    bool IsCSSKeywordValue() const { return content_type_ == ContentType::kCSSKeywordValue; }
    ...
    bool IsV8UnionCSSKeywordValueOrString() const { return content_type_ == ContentType::kCSSKeywordValue || content_type_ == ContentType::kString; }
    ...
    bool IsV8CSSKeywordish() const { return IsV8UnionCSSKeywordValueOrString(); }
    V8UnionCSSKeywordValueOrString* GetAsV8CSSKeywordish() const { return GetAsV8UnionCSSKeywordValueOrString(); }

    bool IsV8UnionCSSNumericValueOrString() const { return content_type_ == ContentType::kCSSNumericValue || content_type_ == ContentType::kString; }
...
private:
    ...
    static constexpr const char* UnionNameInIDL() { return "(CSSKeywordValue or CSSNumericValue or DOMString)"; }
