...
inline bool operator==(const V8SignRequestData& lhs, V8SignRequestData::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8SignRequestData::Enum lhs, const V8SignRequestData& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
