...
public:
    ...
    static MutationObserverInit* Create(v8::Isolate* isolate) { return MakeGarbageCollected<MutationObserverInit>(isolate); }
    ...
    bool hasChildList() const { return true; }
    bool childList() const { return member_child_list_; }
    void setChildList(bool value) { member_child_list_ = value; }

    bool hasSubtree() const { return true; }
    bool subtree() const { return member_subtree_; }
    void setSubtree(bool value) { member_subtree_ = value; }
