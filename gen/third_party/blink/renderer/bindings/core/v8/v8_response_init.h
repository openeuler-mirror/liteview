...
public:
    static ResponseInit* Create() { return MakeGarbageCollected<ResponseInit>(); }
    static ResponseInit* Create(v8::Isolate* isolate) { return MakeGarbageCollected<ResponseInit>(isolate); }
    ...
    uint16_t status() const { return member_status_; }
    void setStatus(uint16_t value) { member_status_ = value; }

    bool hasStatusText() const { return true; }
    const String& statusText() const { return member_status_text_; }
