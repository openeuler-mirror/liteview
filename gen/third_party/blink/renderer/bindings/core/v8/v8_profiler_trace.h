...
public:
    ...
    static ProfilerTrace* Create(v8::Isolate* isolate) { return MakeGarbageCollected<ProfilerTrace>(isolate); }
    ...
    bool hasFrames() const { return true; }
    const HeapVector<Member<ProfilerFrame>>& frames() const { return member_frames_; }
    void setFrames(const HeapVector<Member<ProfilerFrame>>& value);
    void setFrames(HeapVector<Member<ProfilerFrame>>&& value);

    bool hasResources() const { return true; }
    const Vector<String>& resources() const { return member_resources_; }
    void setResources(const Vector<String>& value);
    void setResources(Vector<String>&& value);

    bool hasSamples() const { return true; }
    const HeapVector<Member<ProfilerSample>>& samples() const { return member_samples_; }
    void setSamples(const HeapVector<Member<ProfilerSample>>& value);
    void setSamples(HeapVector<Member<ProfilerSample>>&& value);

    bool hasStacks() const { return true; }
    const HeapVector<Member<ProfilerStack>>& stacks() const { return member_stacks_; }
