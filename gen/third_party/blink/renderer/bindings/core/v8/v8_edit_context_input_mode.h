...
class CORE_EXPORT V8EditContextInputMode final : public bindings::EnumerationBase {

public:
    enum class Enum : enum_int_t { kNone, kText, kDecimal, kSearch, kEmail, kNumeric, kTel, kUrl, kPassword };
    static constexpr size_t kEnumSize = 9;

    static V8EditContextInputMode Create(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state);
    static absl::optional<V8EditContextInputMode> Create(const String& value);
...
inline bool operator==(const V8EditContextInputMode& lhs, V8EditContextInputMode::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8EditContextInputMode::Enum lhs, const V8EditContextInputMode& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
