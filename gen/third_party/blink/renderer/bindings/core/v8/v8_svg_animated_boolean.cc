...
bool V8SVGAnimatedBoolean::IsExposed(ExecutionContext* execution_context) { return execution_context->IsWindow(); }
...
static_assert(std::is_same<decltype(&SVGAnimatedBoolean::HasPendingActivity), decltype(&ScriptWrappable::HasPendingActivity)>::value,
