...
public:
    ...
    static absl::optional<V8ResponseType> Create(const String& value);
...
inline bool operator==(const V8ResponseType& lhs, V8ResponseType::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8ResponseType::Enum lhs, const V8ResponseType& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
