...
public:
    ...
    static AnimationPlaybackEventInit* Create(v8::Isolate* isolate) { return MakeGarbageCollected<AnimationPlaybackEventInit>(isolate); }
    ...
    V8UnionCSSNumericValueOrDouble* currentTime() const { return member_current_time_; }
    void setCurrentTime(V8UnionCSSNumericValueOrDouble* value) { member_current_time_ = value; }

    bool hasTimelineTime() const { return true; }
    V8UnionCSSNumericValueOrDouble* timelineTime() const { return member_timeline_time_; }
    void setTimelineTime(V8UnionCSSNumericValueOrDouble* value) { member_timeline_time_ = value; }
