...
public:
    ...
    static AssignedNodesOptions* Create(v8::Isolate* isolate) { return MakeGarbageCollected<AssignedNodesOptions>(isolate); }
    ...
    bool hasFlatten() const { return true; }
    bool flatten() const { return member_flatten_; }
    void setFlatten(bool value) { member_flatten_ = value; }
