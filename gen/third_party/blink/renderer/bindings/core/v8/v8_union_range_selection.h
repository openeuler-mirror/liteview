...
public:
    ...
    bool IsRange() const { return content_type_ == ContentType::kRange; }
    ...
    bool IsSelection() const { return content_type_ == ContentType::kSelection; }
...
private:
    ...
    static constexpr const char* UnionNameInIDL() { return "(Range or Selection)"; }
