...
bool V8HTMLTableColElement::IsExposed(ExecutionContext* execution_context) { return execution_context->IsWindow(); }
...
static_assert(std::is_same<decltype(&HTMLTableColElement::HasPendingActivity), decltype(&ScriptWrappable::HasPendingActivity)>::value,
...
void SpanAttributeSetCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    const char* const property_name = "span";
    ...
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
...

    {
        static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
            { "span", SpanAttributeGetCallback, SpanAttributeSetCallback, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
