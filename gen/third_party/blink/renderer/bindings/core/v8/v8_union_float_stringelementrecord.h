...
public:
    ...
    bool IsStringElementRecord() const { return content_type_ == ContentType::kStringElementRecord; }
...
private:
    ...
    static constexpr const char* UnionNameInIDL() { return "(float or record<DOMString, Element>)"; }
