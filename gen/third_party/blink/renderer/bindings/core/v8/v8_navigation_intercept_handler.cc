...
const char* V8NavigationInterceptHandler::NameInHeapSnapshot() const { return "V8NavigationInterceptHandler"; }

v8::Maybe<ScriptPromise> V8NavigationInterceptHandler::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver)
{
...
v8::Maybe<ScriptPromise> V8NavigationInterceptHandler::Construct()
{
    const char* const class_like_name = "NavigationInterceptHandler";
