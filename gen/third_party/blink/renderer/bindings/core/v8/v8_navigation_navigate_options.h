...
public:
    static NavigationNavigateOptions* Create() { return MakeGarbageCollected<NavigationNavigateOptions>(); }
    static NavigationNavigateOptions* Create(v8::Isolate* isolate) { return MakeGarbageCollected<NavigationNavigateOptions>(isolate); }
    ...
    bool hasHistory() const { return true; }
    V8NavigationHistoryBehavior history() const { return member_history_; }
    void setHistory(V8NavigationHistoryBehavior value) { member_history_ = value; }
    void setHistory(V8NavigationHistoryBehavior::Enum value) { member_history_ = V8NavigationHistoryBehavior(value); }

    bool hasState() const { return !member_state_.IsEmpty(); }
    ...
    void setHistory(const String& value) { member_history_ = V8NavigationHistoryBehavior::Create(value).value(); }
