...
public:
    ...
    static absl::optional<V8FontFaceLoadStatus> Create(const String& value);
...
inline bool operator==(const V8FontFaceLoadStatus& lhs, V8FontFaceLoadStatus::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8FontFaceLoadStatus::Enum lhs, const V8FontFaceLoadStatus& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
