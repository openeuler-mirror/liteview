...
class CORE_EXPORT MojoCreateDataPipeOptions : public bindings::DictionaryBase {

public:
    static MojoCreateDataPipeOptions* Create() { return MakeGarbageCollected<MojoCreateDataPipeOptions>(); }
    static MojoCreateDataPipeOptions* Create(v8::Isolate* isolate) { return MakeGarbageCollected<MojoCreateDataPipeOptions>(isolate); }
