...
public:
    ...
    bool IsAnimationEffect() const { return content_type_ == ContentType::kAnimationEffect; }
    ...
    bool IsAnimationEffectSequence() const { return content_type_ == ContentType::kAnimationEffectSequence; }
...
private:
    ...
    static constexpr const char* UnionNameInIDL() { return "(AnimationEffect or sequence<AnimationEffect>)"; }
