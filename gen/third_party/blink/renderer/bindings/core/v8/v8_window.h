...
public:
    ...
    static void LocationAttributeGetterCustom(const v8::FunctionCallbackInfo<v8::Value>&);
    static void LocationAttributeGetterCustom(const v8::PropertyCallbackInfo<v8::Value>&);
    static void OpenerAttributeSetterCustom(v8::Local<v8::Value>, const v8::FunctionCallbackInfo<v8::Value>&);
    static void FrameElementAttributeGetterCustom(const v8::FunctionCallbackInfo<v8::Value>&);
    static void NamedPropertyGetterCustom(const AtomicString& property_name, const v8::PropertyCallbackInfo<v8::Value>&);
