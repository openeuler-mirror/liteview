...
public:
    ...
    static MojoCreateMessagePipeResult* Create(v8::Isolate* isolate) { return MakeGarbageCollected<MojoCreateMessagePipeResult>(isolate); }
    ...
    bool hasHandle0() const { return has_handle_0_; }
    MojoHandle* handle0() const
    {
        DCHECK(hasHandle0());
        return member_handle_0_;
    }
    ...
    bool hasHandle1() const { return has_handle_1_; }
    MojoHandle* handle1() const
    {
        DCHECK(hasHandle1());
        return member_handle_1_;
    }
