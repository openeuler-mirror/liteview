...
public:
    ...
    static UIEventInit* Create(v8::Isolate* isolate) { return MakeGarbageCollected<UIEventInit>(isolate); }
    ...
    bool hasDetail() const { return true; }
    int32_t detail() const { return member_detail_; }
    void setDetail(int32_t value) { member_detail_ = value; }

    bool hasSourceCapabilities() const { return true; }
    InputDeviceCapabilities* sourceCapabilities() const { return member_source_capabilities_; }
    void setSourceCapabilities(InputDeviceCapabilities* value) { member_source_capabilities_ = value; }

    bool hasView() const { return true; }
    DOMWindow* view() const { return member_view_; }
    void setView(DOMWindow* value) { member_view_ = value; }
