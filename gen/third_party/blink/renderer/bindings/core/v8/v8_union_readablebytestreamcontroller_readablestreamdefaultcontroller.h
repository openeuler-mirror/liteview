...
public:
    ...
    bool IsReadableByteStreamController() const { return content_type_ == ContentType::kReadableByteStreamController; }
    ReadableByteStreamController* GetAsReadableByteStreamController() const
    {
        ...
        return member_readable_byte_stream_controller_;
    }
    ...
    bool IsReadableStreamDefaultController() const { return content_type_ == ContentType::kReadableStreamDefaultController; }
    ReadableStreamDefaultController* GetAsReadableStreamDefaultController() const
    {
        ...
        return member_readable_stream_default_controller_;
    }
...
private:
    ...
    static constexpr const char* UnionNameInIDL() { return "(ReadableByteStreamController or ReadableStreamDefaultController)"; }
