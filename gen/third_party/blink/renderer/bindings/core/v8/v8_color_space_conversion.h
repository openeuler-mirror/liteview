...
public:
    ...
    static absl::optional<V8ColorSpaceConversion> Create(const String& value);
...
inline bool operator==(const V8ColorSpaceConversion& lhs, V8ColorSpaceConversion::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8ColorSpaceConversion::Enum lhs, const V8ColorSpaceConversion& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
