...
bool V8DocumentTimeline::IsExposed(ExecutionContext* execution_context) { return execution_context->IsWindow() && RuntimeEnabledFeatures::WebAnimationsAPIEnabled(); }
...
static_assert(std::is_same<decltype(&DocumentTimeline::HasPendingActivity), decltype(&ScriptWrappable::HasPendingActivity)>::value,
