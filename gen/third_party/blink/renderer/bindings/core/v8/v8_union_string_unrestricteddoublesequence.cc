...
v8::MaybeLocal<v8::Value> V8UnionStringOrUnrestrictedDoubleSequence::ToV8Value(ScriptState* script_state) const
{
    ...
    case ContentType::kUnrestrictedDoubleSequence: {
        return ToV8Traits<IDLSequence<IDLUnrestrictedDouble>>::ToV8(script_state, member_unrestricted_double_sequence_);
    }
    }
