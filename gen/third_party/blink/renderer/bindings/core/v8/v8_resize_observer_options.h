...
public:
    ...
    static ResizeObserverOptions* Create(v8::Isolate* isolate) { return MakeGarbageCollected<ResizeObserverOptions>(isolate); }
    ...
    bool hasBox() const { return true; }
    V8ResizeObserverBoxOptions box() const { return member_box_; }
    void setBox(V8ResizeObserverBoxOptions value) { member_box_ = value; }
    void setBox(V8ResizeObserverBoxOptions::Enum value) { member_box_ = V8ResizeObserverBoxOptions(value); }
    // Obsolete accessor functions
    void setBox(const String& value) { member_box_ = V8ResizeObserverBoxOptions::Create(value).value(); }
