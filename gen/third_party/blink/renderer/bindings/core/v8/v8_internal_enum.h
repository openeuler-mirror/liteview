...
public:
    ...
    static absl::optional<V8InternalEnum> Create(const String& value);
...
inline bool operator==(const V8InternalEnum& lhs, V8InternalEnum::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8InternalEnum::Enum lhs, const V8InternalEnum& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
