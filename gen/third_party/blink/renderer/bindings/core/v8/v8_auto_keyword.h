...
public:
    ...
    static absl::optional<V8AutoKeyword> Create(const String& value);
...
inline bool operator==(const V8AutoKeyword& lhs, V8AutoKeyword::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8AutoKeyword::Enum lhs, const V8AutoKeyword& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
