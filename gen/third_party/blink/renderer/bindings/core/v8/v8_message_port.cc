...
static_assert(!std::is_same<decltype(&MessagePort::HasPendingActivity), decltype(&ScriptWrappable::HasPendingActivity)>::value,
...
void PostMessageOperationOverload1(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    const char* const class_like_name = "MessagePort";
