...
public:
    ...
    static IntersectionObserverInit* Create(v8::Isolate* isolate) { return MakeGarbageCollected<IntersectionObserverInit>(isolate); }
    ...
    void setDelay(double value) { member_delay_ = value; }

    bool hasRoot() const { return true; }
    V8UnionDocumentOrElement* root() const { return member_root_; }
    void setRoot(V8UnionDocumentOrElement* value) { member_root_ = value; }

    bool hasRootMargin() const { return true; }
    const String& rootMargin() const { return member_root_margin_; }
    void setRootMargin(const String& value);
    void setRootMargin(String&& value);

    bool hasThreshold() const { return true; }
    V8UnionDoubleOrDoubleSequence* threshold() const { return member_threshold_; }
    ...
    bool hasTrackVisibility() const { return true; }
    bool trackVisibility() const { return member_track_visibility_; }
    void setTrackVisibility(bool value) { member_track_visibility_ = value; }
