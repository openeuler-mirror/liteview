...
public:
    ...
    static ScrollOptions* Create(v8::Isolate* isolate) { return MakeGarbageCollected<ScrollOptions>(isolate); }
    ...
    bool hasBehavior() const { return true; }
    V8ScrollBehavior behavior() const { return member_behavior_; }
    void setBehavior(V8ScrollBehavior value) { member_behavior_ = value; }
    void setBehavior(V8ScrollBehavior::Enum value) { member_behavior_ = V8ScrollBehavior(value); }
    // Obsolete accessor functions
    void setBehavior(const String& value) { member_behavior_ = V8ScrollBehavior::Create(value).value(); }
