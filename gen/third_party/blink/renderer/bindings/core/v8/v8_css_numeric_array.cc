...
static_assert(std::is_same<decltype(&CSSNumericArray::HasPendingActivity), decltype(&ScriptWrappable::HasPendingActivity)>::value,
...
void V8CSSNumericArray::IndexedPropertySetterCallback(uint32_t index, v8::Local<v8::Value> v8_property_value, const v8::PropertyCallbackInfo<v8::Value>& info)
{
    ...
    if (info.ShouldThrowOnError()) {
        ExceptionState exception_state(info.GetIsolate(), ExceptionContext::Context::kIndexedPropertySet, "CSSNumericArray");
...
void V8CSSNumericArray::IndexedPropertyDeleterCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Boolean>& info)
{
    ...
    if (is_supported and info.ShouldThrowOnError()) {
        ExceptionState exception_state(info.GetIsolate(), ExceptionContext::Context::kIndexedPropertyDelete, "CSSNumericArray");
...
void V8CSSNumericArray::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template)
{
    ...
    instance_object_template->SetHandler(v8::IndexedPropertyHandlerConfiguration(V8CSSNumericArray::IndexedPropertyGetterCallback, V8CSSNumericArray::IndexedPropertySetterCallback,
        nullptr, // query
        V8CSSNumericArray::IndexedPropertyDeleterCallback, V8CSSNumericArray::IndexedPropertyEnumeratorCallback, V8CSSNumericArray::IndexedPropertyDefinerCallback,
        V8CSSNumericArray::IndexedPropertyDescriptorCallback, v8::Local<v8::Value>(), v8::PropertyHandlerFlags::kHasNoSideEffect));
