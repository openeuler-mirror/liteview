...
public:
    static FragmentResultOptions* Create(v8::Isolate* isolate) { return MakeGarbageCollected<FragmentResultOptions>(isolate); }
    ...
    bool hasAutoBlockSize() const { return true; }
    double autoBlockSize() const { return member_auto_block_size_; }
    void setAutoBlockSize(double value) { member_auto_block_size_ = value; }
    ...
    bool hasChildFragments() const { return true; }
    const HeapVector<Member<CustomLayoutFragment>>& childFragments() const { return member_child_fragments_; }
