...
public:
    ...
    bool IsV8UnionFileOrUSVString() const { return content_type_ == ContentType::kFile || content_type_ == ContentType::kUSVString; }
    V8UnionFileOrUSVString* GetAsV8UnionFileOrUSVString() const;
    void Set(const V8UnionFileOrUSVString* value);
    bool IsV8FormDataEntryValue() const { return IsV8UnionFileOrUSVString(); }
    V8UnionFileOrUSVString* GetAsV8FormDataEntryValue() const { return GetAsV8UnionFileOrUSVString(); }
