...
const char* V8CreateURLCallback::NameInHeapSnapshot() const { return "V8CreateURLCallback"; }
...
v8::Maybe<String> V8CreateURLCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const String& arg1_input, const HeapVector<ScriptValue>& arg2_args)
{
    ...
    const int argc = 1 + arg2_args.size();
    CHECK(kMaxArgc >= 1 + arg2_args.size());
    v8::Local<v8::Value> argv[kMaxArgc];
