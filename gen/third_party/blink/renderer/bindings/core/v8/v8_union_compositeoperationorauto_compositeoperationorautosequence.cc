...
V8UnionCompositeOperationOrAutoOrCompositeOperationOrAutoSequence::V8UnionCompositeOperationOrAutoOrCompositeOperationOrAutoSequence(Vector<V8CompositeOperationOrAuto>&& value)
    : content_type_(ContentType::kCompositeOperationOrAutoSequence)
...
void V8UnionCompositeOperationOrAutoOrCompositeOperationOrAutoSequence::Clear() { member_composite_operation_or_auto_sequence_.clear(); }
