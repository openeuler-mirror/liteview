...
const char* V8EventHandlerNonNull::NameInHeapSnapshot() const { return "V8EventHandlerNonNull"; }
...
v8::Maybe<ScriptValue> V8EventHandlerNonNull::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const HeapVector<ScriptValue>& arg1_args)
{
    ...
    const int argc = 0 + arg1_args.size();
    const int argc_max = 20;
    CHECK(argc <= argc_max);
    v8::Local<v8::Value> argv[/*std::max(1, argc)*/ argc_max];
