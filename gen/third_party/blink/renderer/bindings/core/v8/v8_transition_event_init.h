...
public:
    ...
    static TransitionEventInit* Create(v8::Isolate* isolate) { return MakeGarbageCollected<TransitionEventInit>(isolate); }
    ...
    bool hasPropertyName() const { return true; }
    const String& propertyName() const { return member_property_name_; }
