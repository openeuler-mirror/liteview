...
bool V8CSSTransition::IsExposed(ExecutionContext* execution_context) { return execution_context->IsWindow() && RuntimeEnabledFeatures::WebAnimationsAPIEnabled(); }
...
static_assert(!std::is_same<decltype(&CSSTransition::HasPendingActivity), decltype(&ScriptWrappable::HasPendingActivity)>::value,
    ...
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
...

    {
        static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
            { "transitionProperty", TransitionPropertyAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
