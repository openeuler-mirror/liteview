...
public:
    ...
    static absl::optional<V8CSSNumericBaseType> Create(const String& value);
...
inline bool operator==(const V8CSSNumericBaseType& lhs, V8CSSNumericBaseType::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8CSSNumericBaseType::Enum lhs, const V8CSSNumericBaseType& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
