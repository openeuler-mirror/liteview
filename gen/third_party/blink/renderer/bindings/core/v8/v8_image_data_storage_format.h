...
public:
    ...
    static absl::optional<V8ImageDataStorageFormat> Create(const String& value);
...
inline bool operator==(const V8ImageDataStorageFormat& lhs, V8ImageDataStorageFormat::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8ImageDataStorageFormat::Enum lhs, const V8ImageDataStorageFormat& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
