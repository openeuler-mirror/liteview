...
public:
    ...
    static absl::optional<V8FullscreenNavigationUI> Create(const String& value);
...
inline bool operator==(const V8FullscreenNavigationUI& lhs, V8FullscreenNavigationUI::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8FullscreenNavigationUI::Enum lhs, const V8FullscreenNavigationUI& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
