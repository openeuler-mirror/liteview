...
const char* V8IdleRequestCallback::NameInHeapSnapshot() const { return "V8IdleRequestCallback"; }
...
v8::Maybe<void> V8IdleRequestCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, IdleDeadline* arg1_deadline)
{
    ...
    if (!ToV8Traits<IdleDeadline>::ToV8(script_state, arg1_deadline).ToLocal(&v8_arg1_deadline)) {
        return v8::Nothing<void>();
    }
