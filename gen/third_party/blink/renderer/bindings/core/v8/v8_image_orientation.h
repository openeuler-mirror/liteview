...
public:
    ...
    static absl::optional<V8ImageOrientation> Create(const String& value);
...
inline bool operator==(const V8ImageOrientation& lhs, V8ImageOrientation::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8ImageOrientation::Enum lhs, const V8ImageOrientation& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
