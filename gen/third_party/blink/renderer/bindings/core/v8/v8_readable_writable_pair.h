...
public:
    static ReadableWritablePair* Create() { return MakeGarbageCollected<ReadableWritablePair>(); }
    static ReadableWritablePair* Create(v8::Isolate* isolate) { return MakeGarbageCollected<ReadableWritablePair>(isolate); }
    ...
    ReadableStream* readable() const { return member_readable_; }
    ...
    WritableStream* writable() const { return member_writable_; }
