    ...
    v8::Isolate* isolate, v8::Local<v8::Value> v8_value, ExceptionState& exception_state)
{
    if (V8ReadableStreamDefaultController::HasInstance(isolate, v8_value)) {
        auto&& blink_value = V8ReadableStreamDefaultController::ToWrappableUnsafe(v8_value.As<v8::Object>());
    ...
    if (V8ReadableByteStreamController::HasInstance(isolate, v8_value)) {
        auto&& blink_value = V8ReadableByteStreamController::ToWrappableUnsafe(v8_value.As<v8::Object>());
        return MakeGarbageCollected<V8UnionReadableByteStreamControllerOrReadableStreamDefaultController>(blink_value);
    }
...
v8::MaybeLocal<v8::Value> V8UnionReadableByteStreamControllerOrReadableStreamDefaultController::ToV8Value(ScriptState* script_state) const
{
    switch (content_type_) {
    case ContentType::kReadableByteStreamController: {
        return ToV8Traits<ReadableByteStreamController>::ToV8(script_state, member_readable_byte_stream_controller_);
    }
    case ContentType::kReadableStreamDefaultController: {
        return ToV8Traits<ReadableStreamDefaultController>::ToV8(script_state, member_readable_stream_default_controller_);
    }
    }
