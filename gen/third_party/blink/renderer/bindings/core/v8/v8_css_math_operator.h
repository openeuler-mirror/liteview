...
public:
    ...
    static absl::optional<V8CSSMathOperator> Create(const String& value);
...
inline bool operator==(const V8CSSMathOperator& lhs, V8CSSMathOperator::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8CSSMathOperator::Enum lhs, const V8CSSMathOperator& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
