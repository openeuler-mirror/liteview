...
public:
    ...
    static absl::optional<V8ScrollSetting> Create(const String& value);
...
inline bool operator==(const V8ScrollSetting& lhs, V8ScrollSetting::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8ScrollSetting::Enum lhs, const V8ScrollSetting& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
