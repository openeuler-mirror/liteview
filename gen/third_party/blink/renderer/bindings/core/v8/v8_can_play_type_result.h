...
public:
    ...
    static absl::optional<V8CanPlayTypeResult> Create(const String& value);
...
inline bool operator==(const V8CanPlayTypeResult& lhs, V8CanPlayTypeResult::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8CanPlayTypeResult::Enum lhs, const V8CanPlayTypeResult& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
