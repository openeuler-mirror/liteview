...
bool ShadowRootInit::FillV8ObjectWithMembers(ScriptState* script_state, v8::Local<v8::Object> v8_dictionary) const
{
    ...
    if (RuntimeEnabledFeatures::ScopedCustomElementRegistryEnabled()) {
        if (hasRegistry()) {
            if (!ToV8Traits<CustomElementRegistry>::ToV8(script_state, member_registry_).ToLocal(&v8_value)) {
                return false;
            }
...
void ShadowRootInit::FillMembersFromV8Object(v8::Isolate* isolate, v8::Local<v8::Object> v8_dictionary, ExceptionState& exception_state)
{
    ...
    exception_context_scope.ChangePropertyNameAsOptimizationHack("delegatesFocus");
    constexpr bool is_optional = false;
    v8::Local<v8::Context> current_context = isolate->GetCurrentContext();
    const auto& v8_own_member_names = GetV8OwnMemberNames(isolate);
    v8::TryCatch try_block(isolate);
    if (!bindings::GetDictionaryMemberFromV8Object<IDLBoolean, is_optional>(
            isolate, current_context, v8_dictionary, v8_own_member_names[0].Get(isolate), has_delegates_focus_, member_delegates_focus_, try_block, exception_state)) {
        return;
    }
    exception_context_scope.ChangePropertyNameAsOptimizationHack("mode");
    constexpr bool is_required = true;
    bool fallback_presence_var;
    if (!bindings::GetDictionaryMemberFromV8Object<V8ShadowRootMode, is_required>(
    ...
    if (RuntimeEnabledFeatures::ScopedCustomElementRegistryEnabled()) {
        exception_context_scope.ChangePropertyNameAsOptimizationHack("registry");
        if (!bindings::GetDictionaryMemberFromV8Object<CustomElementRegistry, is_optional>(
                isolate, current_context, v8_dictionary, v8_own_member_names[2].Get(isolate), has_registry_, member_registry_, try_block, exception_state)) {
            return;
        }
    }
    exception_context_scope.ChangePropertyNameAsOptimizationHack("slotAssignment");
    if (!bindings::GetDictionaryMemberFromV8Object<V8SlotAssignmentMode, is_optional>(
            isolate, current_context, v8_dictionary, v8_own_member_names[3].Get(isolate), has_slot_assignment_, member_slot_assignment_, try_block, exception_state)) {
        return;
    }
}
