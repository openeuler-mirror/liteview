...
public:
    ...
    static absl::optional<V8PremultiplyAlpha> Create(const String& value);
...
inline bool operator==(const V8PremultiplyAlpha& lhs, V8PremultiplyAlpha::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8PremultiplyAlpha::Enum lhs, const V8PremultiplyAlpha& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
