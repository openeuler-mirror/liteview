...
public:
    ...
    static absl::optional<V8ScrollRestoration> Create(const String& value);
...
inline bool operator==(const V8ScrollRestoration& lhs, V8ScrollRestoration::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8ScrollRestoration::Enum lhs, const V8ScrollRestoration& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
