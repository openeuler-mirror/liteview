...
public:
    ...
    static ScrollIntoViewOptions* Create(v8::Isolate* isolate) { return MakeGarbageCollected<ScrollIntoViewOptions>(isolate); }
    ...
    bool hasBlock() const { return true; }
    V8ScrollLogicalPosition block() const { return member_block_; }
    void setBlock(V8ScrollLogicalPosition value) { member_block_ = value; }
    void setBlock(V8ScrollLogicalPosition::Enum value) { member_block_ = V8ScrollLogicalPosition(value); }

    bool hasInlinePosition() const { return true; }
    V8ScrollLogicalPosition inlinePosition() const { return member_inline_position_; }
    void setInlinePosition(V8ScrollLogicalPosition value) { member_inline_position_ = value; }
    void setInlinePosition(V8ScrollLogicalPosition::Enum value) { member_inline_position_ = V8ScrollLogicalPosition(value); }
    // Obsolete accessor functions
    void setBlock(const String& value) { member_block_ = V8ScrollLogicalPosition::Create(value).value(); }
    void setInlinePosition(const String& value) { member_inline_position_ = V8ScrollLogicalPosition::Create(value).value(); }
