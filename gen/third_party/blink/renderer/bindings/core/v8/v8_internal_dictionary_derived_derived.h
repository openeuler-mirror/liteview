...
public:
    static InternalDictionaryDerivedDerived* Create(v8::Isolate* isolate) { return MakeGarbageCollected<InternalDictionaryDerivedDerived>(isolate); }
    ...
    bool hasDerivedDerivedStringMember() const { return has_derived_derived_string_member_; }
