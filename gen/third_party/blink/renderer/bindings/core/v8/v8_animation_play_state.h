...
public:
    ...
    static absl::optional<V8AnimationPlayState> Create(const String& value);
...
inline bool operator==(const V8AnimationPlayState& lhs, V8AnimationPlayState::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8AnimationPlayState::Enum lhs, const V8AnimationPlayState& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
