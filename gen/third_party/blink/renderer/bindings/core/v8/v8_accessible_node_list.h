...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_ACCESSIBLE_NODE_LIST_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_ACCESSIBLE_NODE_LIST_H_
...
class CORE_EXPORT V8AccessibleNodeList final : public bindings::V8InterfaceBridge<V8AccessibleNodeList, AccessibleNodeList> {
...
#endif // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_ACCESSIBLE_NODE_LIST_H_
