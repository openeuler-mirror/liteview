...
public:
    ...
    static CanvasHighDynamicRangeOptions* Create(v8::Isolate* isolate) { return MakeGarbageCollected<CanvasHighDynamicRangeOptions>(isolate); }
    ...
    void setMode(V8CanvasHighDynamicRangeMode value) { member_mode_ = value; }
    void setMode(V8CanvasHighDynamicRangeMode::Enum value) { member_mode_ = V8CanvasHighDynamicRangeMode(value); }

    bool hasSmpteSt2086Metadata() const { return has_smpte_st_2086_metadata_; }
    CanvasSmpteSt2086Metadata* smpteSt2086Metadata() const
    {
        DCHECK(hasSmpteSt2086Metadata());
        return member_smpte_st_2086_metadata_;
    }
    ...
    void setMode(const String& value) { member_mode_ = V8CanvasHighDynamicRangeMode::Create(value).value(); }
