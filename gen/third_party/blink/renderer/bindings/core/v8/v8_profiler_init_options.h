...
class CORE_EXPORT ProfilerInitOptions : public bindings::DictionaryBase {

public:
    static ProfilerInitOptions* Create() { return MakeGarbageCollected<ProfilerInitOptions>(); }
    static ProfilerInitOptions* Create(v8::Isolate* isolate) { return MakeGarbageCollected<ProfilerInitOptions>(isolate); }
    ...
    bool hasMaxBufferSize() const { return true; }
    uint32_t maxBufferSize() const { return member_max_buffer_size_; }
    void setMaxBufferSize(uint32_t value) { member_max_buffer_size_ = value; }

    bool hasSampleInterval() const { return true; }
    double sampleInterval() const { return member_sample_interval_; }
    void setSampleInterval(double value) { member_sample_interval_ = value; }
