...
public:
    ...
    static absl::optional<V8ReplaceState> Create(const String& value);
...
inline bool operator==(const V8ReplaceState& lhs, V8ReplaceState::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8ReplaceState::Enum lhs, const V8ReplaceState& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
