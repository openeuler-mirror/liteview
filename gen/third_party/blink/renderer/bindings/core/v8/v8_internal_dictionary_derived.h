...
public:
    static InternalDictionaryDerived* Create(v8::Isolate* isolate) { return MakeGarbageCollected<InternalDictionaryDerived>(isolate); }
    ...
    bool hasDerivedStringMember() const { return has_derived_string_member_; }
    ...
    bool hasDerivedStringMemberWithDefault() const { return true; }
    const String& derivedStringMemberWithDefault() const { return member_derived_string_member_with_default_; }
    void setDerivedStringMemberWithDefault(const String& value);
    void setDerivedStringMemberWithDefault(String&& value);

    bool hasRequiredBooleanMember() const { return true; }
    bool requiredBooleanMember() const { return member_required_boolean_member_; }
    void setRequiredBooleanMember(bool value) { member_required_boolean_member_ = value; }
