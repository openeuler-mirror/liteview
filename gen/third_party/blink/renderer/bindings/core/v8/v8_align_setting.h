...
public:
    ...
    static absl::optional<V8AlignSetting> Create(const String& value);
...
inline bool operator==(const V8AlignSetting& lhs, V8AlignSetting::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8AlignSetting::Enum lhs, const V8AlignSetting& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
