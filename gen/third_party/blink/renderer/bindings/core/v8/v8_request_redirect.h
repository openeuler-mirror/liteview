...
public:
    ...
    static absl::optional<V8RequestRedirect> Create(const String& value);
...
inline bool operator==(const V8RequestRedirect& lhs, V8RequestRedirect::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8RequestRedirect::Enum lhs, const V8RequestRedirect& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
