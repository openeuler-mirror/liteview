...
V8UnionDocumentTimelineOrScrollTimeline* V8UnionDocumentTimelineOrScrollTimeline::Create(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, ExceptionState& exception_state)
{
    if (V8ScrollTimeline::HasInstance(isolate, v8_value)) {
        auto&& blink_value = V8ScrollTimeline::ToWrappableUnsafe(v8_value.As<v8::Object>());
    ...
    if (V8DocumentTimeline::HasInstance(isolate, v8_value)) {
        auto&& blink_value = V8DocumentTimeline::ToWrappableUnsafe(v8_value.As<v8::Object>());
        return MakeGarbageCollected<V8UnionDocumentTimelineOrScrollTimeline>(blink_value);
    }
...
v8::MaybeLocal<v8::Value> V8UnionDocumentTimelineOrScrollTimeline::ToV8Value(ScriptState* script_state) const
{
    switch (content_type_) {
    case ContentType::kDocumentTimeline: {
        return ToV8Traits<DocumentTimeline>::ToV8(script_state, member_document_timeline_);
    }
    case ContentType::kScrollTimeline: {
        return ToV8Traits<ScrollTimeline>::ToV8(script_state, member_scroll_timeline_);
    }
    }
