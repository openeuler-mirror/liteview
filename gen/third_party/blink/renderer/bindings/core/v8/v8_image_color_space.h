...
public:
    ...
    static absl::optional<V8ImageColorSpace> Create(const String& value);
...
inline bool operator==(const V8ImageColorSpace& lhs, V8ImageColorSpace::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8ImageColorSpace::Enum lhs, const V8ImageColorSpace& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
