...
public:
    ...
    static PromiseRejectionEventInit* Create(v8::Isolate* isolate) { return MakeGarbageCollected<PromiseRejectionEventInit>(isolate); }
    ...
    bool hasPromise() const { return true; }
    const ScriptPromise& promise() const { return member_promise_; }
    void setPromise(const ScriptPromise& value) { member_promise_ = value; }

    bool hasReason() const { return !member_reason_.IsEmpty(); }
    ...
    void setReason(const ScriptValue& value) { member_reason_ = value; }
