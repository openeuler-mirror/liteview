...
public:
    ...
    static CSSStyleSheetInit* Create(v8::Isolate* isolate) { return MakeGarbageCollected<CSSStyleSheetInit>(isolate); }
    ...
    bool hasAlternate() const { return true; }
    bool alternate() const { return member_alternate_; }
    void setAlternate(bool value) { member_alternate_ = value; }

    bool hasDisabled() const { return true; }
    bool disabled() const { return member_disabled_; }
    void setDisabled(bool value) { member_disabled_ = value; }

    bool hasMedia() const { return true; }
    V8UnionMediaListOrString* media() const { return member_media_; }
