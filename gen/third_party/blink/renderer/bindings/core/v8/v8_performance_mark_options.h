...
class CORE_EXPORT PerformanceMarkOptions : public bindings::DictionaryBase {

public:
    static PerformanceMarkOptions* Create() { return MakeGarbageCollected<PerformanceMarkOptions>(); }
    static PerformanceMarkOptions* Create(v8::Isolate* isolate) { return MakeGarbageCollected<PerformanceMarkOptions>(isolate); }
    ...
    bool hasDetail() const { return !member_detail_.IsEmpty(); }
    ...
    void setDetail(const ScriptValue& value) { member_detail_ = value; }
