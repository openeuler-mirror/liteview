...
public:
    ...
    static ErrorEventInit* Create(v8::Isolate* isolate) { return MakeGarbageCollected<ErrorEventInit>(isolate); }
    ...
    bool hasColno() const { return true; }
    uint32_t colno() const { return member_colno_; }
    void setColno(uint32_t value) { member_colno_ = value; }

    bool hasError() const { return !member_error_.IsEmpty(); }
    ...
    void setError(const ScriptValue& value) { member_error_ = value; }

    bool hasFilename() const { return true; }
    const String& filename() const { return member_filename_; }
    void setFilename(const String& value);
    void setFilename(String&& value);

    bool hasLineno() const { return true; }
    uint32_t lineno() const { return member_lineno_; }
    void setLineno(uint32_t value) { member_lineno_ = value; }

    bool hasMessage() const { return true; }
    const String& message() const { return member_message_; }
