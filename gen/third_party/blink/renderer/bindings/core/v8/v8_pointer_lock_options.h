...
public:
    ...
    static PointerLockOptions* Create(v8::Isolate* isolate) { return MakeGarbageCollected<PointerLockOptions>(isolate); }
    ...
    bool hasUnadjustedMovement() const { return true; }
    bool unadjustedMovement() const { return member_unadjusted_movement_; }
    void setUnadjustedMovement(bool value) { member_unadjusted_movement_ = value; }
