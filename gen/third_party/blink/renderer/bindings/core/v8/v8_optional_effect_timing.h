...
public:
    ...
    static OptionalEffectTiming* Create(v8::Isolate* isolate) { return MakeGarbageCollected<OptionalEffectTiming>(isolate); }
    ...
    V8UnionDoubleOrTimelineOffset* delay() const
    {
        DCHECK(hasDelay());
        return member_delay_;
    }
    V8UnionDoubleOrTimelineOffset* getDelayOr(V8UnionDoubleOrTimelineOffset* fallback_value) const
    {
        if (!hasDelay()) {
    ...
    V8UnionDoubleOrTimelineOffset* endDelay() const
    {
        DCHECK(hasEndDelay());
        return member_end_delay_;
    }
    V8UnionDoubleOrTimelineOffset* getEndDelayOr(V8UnionDoubleOrTimelineOffset* fallback_value) const
    {
        if (!hasEndDelay()) {
            return fallback_value;
        }
