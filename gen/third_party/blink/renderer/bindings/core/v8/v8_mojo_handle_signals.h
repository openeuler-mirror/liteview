...
class CORE_EXPORT MojoHandleSignals : public bindings::DictionaryBase {

public:
    static MojoHandleSignals* Create() { return MakeGarbageCollected<MojoHandleSignals>(); }
    static MojoHandleSignals* Create(v8::Isolate* isolate) { return MakeGarbageCollected<MojoHandleSignals>(isolate); }
    ...
    bool hasPeerClosed() const { return true; }
    bool peerClosed() const { return member_peer_closed_; }
    void setPeerClosed(bool value) { member_peer_closed_ = value; }

    bool hasReadable() const { return true; }
    bool readable() const { return member_readable_; }
    void setReadable(bool value) { member_readable_ = value; }

    bool hasWritable() const { return true; }
    bool writable() const { return member_writable_; }
    void setWritable(bool value) { member_writable_ = value; }
