...
const char* V8UnderlyingSourceCancelCallback::NameInHeapSnapshot() const { return "V8UnderlyingSourceCancelCallback"; }

v8::Maybe<ScriptPromise> V8UnderlyingSourceCancelCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const ScriptValue& arg1_reason)
{
    ...
    if (!ToV8Traits<IDLOptional<IDLAny>>::ToV8(script_state, arg1_reason).ToLocal(&v8_arg1_reason)) {
        return v8::Nothing<ScriptPromise>();
    }
...
v8::Maybe<ScriptPromise> V8UnderlyingSourceCancelCallback::Construct(const ScriptValue& arg1_reason)
{
    const char* const class_like_name = "UnderlyingSourceCancelCallback";
