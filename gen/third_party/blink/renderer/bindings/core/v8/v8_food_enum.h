...
public:
    ...
    static absl::optional<V8FoodEnum> Create(const String& value);
...
inline bool operator==(const V8FoodEnum& lhs, V8FoodEnum::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8FoodEnum::Enum lhs, const V8FoodEnum& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
