...
public:
    ...
    bool IsReadableStreamBYOBReader() const { return content_type_ == ContentType::kReadableStreamBYOBReader; }
    ReadableStreamBYOBReader* GetAsReadableStreamBYOBReader() const
    {
        ...
        return member_readable_stream_byob_reader_;
    }
    ...
    bool IsReadableStreamDefaultReader() const { return content_type_ == ContentType::kReadableStreamDefaultReader; }
    ReadableStreamDefaultReader* GetAsReadableStreamDefaultReader() const
    {
        ...
        return member_readable_stream_default_reader_;
    }
...
private:
    ...
    static constexpr const char* UnionNameInIDL() { return "(ReadableStreamBYOBReader or ReadableStreamDefaultReader)"; }
