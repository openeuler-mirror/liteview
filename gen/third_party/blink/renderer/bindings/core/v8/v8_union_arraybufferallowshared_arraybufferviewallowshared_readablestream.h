...
public:
    ...
    bool IsArrayBufferAllowShared() const { return content_type_ == ContentType::kArrayBufferAllowShared; }
    ...
    bool IsArrayBufferViewAllowShared() const { return content_type_ == ContentType::kArrayBufferViewAllowShared; }
    ...
    bool IsV8AllowSharedBufferSource() const { return IsV8UnionArrayBufferAllowSharedOrArrayBufferViewAllowShared(); }
    V8UnionArrayBufferAllowSharedOrArrayBufferViewAllowShared* GetAsV8AllowSharedBufferSource() const { return GetAsV8UnionArrayBufferAllowSharedOrArrayBufferViewAllowShared(); }
...
private:
    ...
    static constexpr const char* UnionNameInIDL() { return "(ReadableStream or [AllowShared] ArrayBuffer or [AllowShared] ArrayBufferView)"; }
