...
public:
    ...
    static PointerEventInit* Create(v8::Isolate* isolate) { return MakeGarbageCollected<PointerEventInit>(isolate); }
    ...
    bool hasCoalescedEvents() const { return true; }
    ...
    void setHeight(double value) { member_height_ = value; }

    bool hasIsPrimary() const { return true; }
    bool isPrimary() const { return member_is_primary_; }
    void setIsPrimary(bool value) { member_is_primary_ = value; }

    bool hasPointerId() const { return true; }
    int32_t pointerId() const { return member_pointer_id_; }
    void setPointerId(int32_t value) { member_pointer_id_ = value; }

    bool hasPointerType() const { return true; }
    const String& pointerType() const { return member_pointer_type_; }
    void setPointerType(const String& value);
    void setPointerType(String&& value);

    bool hasPredictedEvents() const { return true; }
    ...
    bool hasPressure() const { return true; }
    float pressure() const { return member_pressure_; }
    void setPressure(float value) { member_pressure_ = value; }

    bool hasTangentialPressure() const { return true; }
    float tangentialPressure() const { return member_tangential_pressure_; }
    void setTangentialPressure(float value) { member_tangential_pressure_ = value; }
    ...
    bool hasTwist() const { return true; }
    int32_t twist() const { return member_twist_; }
    void setTwist(int32_t value) { member_twist_ = value; }

    bool hasWidth() const { return true; }
    double width() const { return member_width_; }
    void setWidth(double value) { member_width_ = value; }
