...
public:
    ...
    static TouchEventInit* Create(v8::Isolate* isolate) { return MakeGarbageCollected<TouchEventInit>(isolate); }
    ...
    bool hasChangedTouches() const { return true; }
    ...
    bool hasTargetTouches() const { return true; }
    ...
    bool hasTouches() const { return true; }
