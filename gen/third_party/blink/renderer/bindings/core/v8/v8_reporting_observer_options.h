...
public:
    ...
    static ReportingObserverOptions* Create(v8::Isolate* isolate) { return MakeGarbageCollected<ReportingObserverOptions>(isolate); }
    ...
    bool hasBuffered() const { return true; }
    bool buffered() const { return member_buffered_; }
    void setBuffered(bool value) { member_buffered_ = value; }
    ...
    bool hasTypesNonNull() const { return hasTypes() && types().has_value(); }
