...
public:
    ...
    static absl::optional<V8ScrollLogicalPosition> Create(const String& value);
...
inline bool operator==(const V8ScrollLogicalPosition& lhs, V8ScrollLogicalPosition::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8ScrollLogicalPosition::Enum lhs, const V8ScrollLogicalPosition& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
