...
V8UnionCSSColorValueOrCSSStyleValue* V8UnionCSSColorValueOrCSSStyleValue::Create(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, ExceptionState& exception_state)
{
    if (V8CSSStyleValue::HasInstance(isolate, v8_value)) {
        auto&& blink_value = V8CSSStyleValue::ToWrappableUnsafe(v8_value.As<v8::Object>());
...
v8::MaybeLocal<v8::Value> V8UnionCSSColorValueOrCSSStyleValue::ToV8Value(ScriptState* script_state) const
{
    ...
    case ContentType::kCSSStyleValue: {
        return ToV8Traits<CSSStyleValue>::ToV8(script_state, member_css_style_value_);
    }
    }
