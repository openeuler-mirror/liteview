...
bool V8PortalHost::IsExposed(ExecutionContext* execution_context) { return execution_context->IsWindow() && RuntimeEnabledFeatures::PortalsEnabled(execution_context); }
...
const WrapperTypeInfo V8PortalHost::wrapper_type_info_ {
    gin::kEmbedderBlink,
    V8PortalHost::InstallInterfaceTemplate,
    nullptr,
    "PortalHost",
...
const WrapperTypeInfo& PortalHost::wrapper_type_info_ = V8PortalHost::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(!std::is_base_of<ActiveScriptWrappableBase, PortalHost>::value,
    "PortalHost inherits from ActiveScriptWrappable<> without "
    "[ActiveScriptWrappable] extended attribute.");
static_assert(std::is_same<decltype(&PortalHost::HasPendingActivity), decltype(&ScriptWrappable::HasPendingActivity)>::value,
    "PortalHost is overriding hasPendingActivity() without "
    "[ActiveScriptWrappable] extended attribute.");

namespace {

namespace v8_portal_host {
...
void OnmessageAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    BLINK_BINDINGS_TRACE_EVENT("PortalHost.onmessage.get");

    v8::Local<v8::Object> v8_receiver = info.This();
    PortalHost* blink_receiver = V8PortalHost::ToWrappableUnsafe(v8_receiver);
...
void OnmessageAttributeSetCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    BLINK_BINDINGS_TRACE_EVENT("PortalHost.onmessage.set");
...
void OnmessageerrorAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    BLINK_BINDINGS_TRACE_EVENT("PortalHost.onmessageerror.get");
...
void OnmessageerrorAttributeSetCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    BLINK_BINDINGS_TRACE_EVENT("PortalHost.onmessageerror.set");
...
void PostMessageOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    BLINK_BINDINGS_TRACE_EVENT("PortalHost.postMessage");

    v8::Isolate* isolate = info.GetIsolate();
    v8::Local<v8::Context> current_context = isolate->GetCurrentContext();
    ExecutionContext* current_execution_context = ExecutionContext::From(current_context);
    // [Measure], [MeasureAs]
    UseCounter::Count(current_execution_context, WebFeature::kV8PortalHost_PostMessage_Method);

    const ExceptionState::ContextType exception_state_context_type = ExceptionContext::Context::kOperationInvoke;
    const char* const class_like_name = "PortalHost";
...
using namespace v8_portal_host;

} // namespace

void V8PortalHost::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template)
{
    const WrapperTypeInfo* const wrapper_type_info = V8PortalHost::GetWrapperTypeInfo();
...
void V8PortalHost::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template,
