...
bool V8HTMLDocument::IsExposed(ExecutionContext* execution_context) { return execution_context->IsWindow(); }
...
static_assert(std::is_same<decltype(&HTMLDocument::HasPendingActivity), decltype(&ScriptWrappable::HasPendingActivity)>::value,
...
void LocationAttributeSetCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    if (UNLIKELY(info.Length() < 1)) {
        ...
        const char* const class_like_name = "HTMLDocument";
...
void InstallPropsOfV8HTMLDocument(v8::Local<v8::Context> context, const DOMWrapperWorld& world, v8::Local<v8::Object> instance_object, v8::Local<v8::Object> prototype_object,
    v8::Local<v8::Object> interface_object, v8::Local<v8::Template> interface_template)
{
    using bindings::IDLMemberInstaller;
}

void InstallPropsOfV8HTMLDocument(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template, v8::Local<v8::Template> prototype_template,
