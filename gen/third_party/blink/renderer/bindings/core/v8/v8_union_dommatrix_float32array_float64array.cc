    ...
    v8::Isolate* isolate, v8::Local<v8::Value> v8_value, ExceptionState& exception_state)
{
    if (V8DOMMatrix::HasInstance(isolate, v8_value)) {
        auto&& blink_value = V8DOMMatrix::ToWrappableUnsafe(v8_value.As<v8::Object>());
...
v8::MaybeLocal<v8::Value> V8UnionDOMMatrixOrFloat32ArrayOrFloat64Array::ToV8Value(ScriptState* script_state) const
{
    ...
    case ContentType::kDOMMatrix: {
        return ToV8Traits<DOMMatrix>::ToV8(script_state, member_dom_matrix_);
    }
    case ContentType::kFloat32Array: {
        return ToV8Traits<NotShared<DOMFloat32Array>>::ToV8(script_state, member_float32_array_);
    }
    case ContentType::kFloat64Array: {
        return ToV8Traits<NotShared<DOMFloat64Array>>::ToV8(script_state, member_float64_array_);
    }
    }
