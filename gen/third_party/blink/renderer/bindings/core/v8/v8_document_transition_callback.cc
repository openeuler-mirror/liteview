...
const char* V8DocumentTransitionCallback::NameInHeapSnapshot() const { return "V8DocumentTransitionCallback"; }

v8::Maybe<ScriptPromise> V8DocumentTransitionCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver)
{
    const char* const class_like_name = "DocumentTransitionCallback";
...
v8::Maybe<ScriptPromise> V8DocumentTransitionCallback::Construct()
{
    const char* const class_like_name = "DocumentTransitionCallback";
