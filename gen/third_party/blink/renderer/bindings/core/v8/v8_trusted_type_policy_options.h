...
public:
    ...
    static TrustedTypePolicyOptions* Create(v8::Isolate* isolate) { return MakeGarbageCollected<TrustedTypePolicyOptions>(isolate); }
    ...
    bool hasCreateHTML() const { return has_create_html_; }
    ...
    bool hasCreateScript() const { return has_create_script_; }
    ...
    bool hasCreateScriptURL() const { return has_create_script_url_; }
