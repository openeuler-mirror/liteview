...
public:
    ...
    static WorkerOptions* Create(v8::Isolate* isolate) { return MakeGarbageCollected<WorkerOptions>(isolate); }
    ...
    V8RequestCredentials credentials() const { return member_credentials_; }
    void setCredentials(V8RequestCredentials value) { member_credentials_ = value; }
    void setCredentials(V8RequestCredentials::Enum value) { member_credentials_ = V8RequestCredentials(value); }
    ...
    void setCredentials(const String& value) { member_credentials_ = V8RequestCredentials::Create(value).value(); }
