...
public:
    ...
    static absl::optional<V8WorkerType> Create(const String& value);
...
inline bool operator==(const V8WorkerType& lhs, V8WorkerType::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8WorkerType::Enum lhs, const V8WorkerType& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
