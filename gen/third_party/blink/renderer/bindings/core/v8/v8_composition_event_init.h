...
public:
    ...
    static CompositionEventInit* Create(v8::Isolate* isolate) { return MakeGarbageCollected<CompositionEventInit>(isolate); }
    ...
    const String& data() const { return member_data_; }
