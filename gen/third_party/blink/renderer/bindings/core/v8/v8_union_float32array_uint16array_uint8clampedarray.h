...
public:
    ...
    bool IsUint16Array() const { return content_type_ == ContentType::kUint16Array; }
...
private:
    ...
    static constexpr const char* UnionNameInIDL() { return "(Float32Array or Uint16Array or Uint8ClampedArray)"; }
