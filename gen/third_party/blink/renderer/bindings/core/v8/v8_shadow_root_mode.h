...
public:
    ...
    static absl::optional<V8ShadowRootMode> Create(const String& value);
...
inline bool operator==(const V8ShadowRootMode& lhs, V8ShadowRootMode::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8ShadowRootMode::Enum lhs, const V8ShadowRootMode& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
