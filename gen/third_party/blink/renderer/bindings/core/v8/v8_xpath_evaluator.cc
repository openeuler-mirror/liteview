...
bool V8XPathEvaluator::IsExposed(ExecutionContext* execution_context) { return execution_context->IsWindow(); }
...
static_assert(std::is_same<decltype(&XPathEvaluator::HasPendingActivity), decltype(&ScriptWrappable::HasPendingActivity)>::value,
...
void ConstructorCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    if (!info.IsConstructCall()) {
        ...
        const char* const class_like_name = "XPathEvaluator";
...
void CreateExpressionOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    auto&& return_value = blink_receiver->createExpression(arg1_expression, arg2_resolver, exception_state);
    if (UNLIKELY(exception_state.HadException())) {
        return;
    }
...
void EvaluateOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    auto&& return_value = blink_receiver->evaluate(arg1_expression, arg2_context_node, arg3_resolver, arg4_type, arg5_in_result, exception_state);
    if (UNLIKELY(exception_state.HadException())) {
        return;
    }
    bindings::V8SetReturnValue(info, return_value, blink_receiver);
