...
const char* V8IntersectionObserverCallback::NameInHeapSnapshot() const { return "V8IntersectionObserverCallback"; }

v8::Maybe<void> V8IntersectionObserverCallback::Invoke(
    bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const HeapVector<Member<IntersectionObserverEntry>>& arg1_entries, IntersectionObserver* arg2_observer)
{
    ...
    if (!ToV8Traits<IDLSequence<IntersectionObserverEntry>>::ToV8(script_state, arg1_entries).ToLocal(&v8_arg1_entries)) {
        return v8::Nothing<void>();
    }
    argv[0] = v8_arg1_entries;
    v8::Local<v8::Value> v8_arg2_observer;
    if (!ToV8Traits<IntersectionObserver>::ToV8(script_state, arg2_observer).ToLocal(&v8_arg2_observer)) {
        return v8::Nothing<void>();
    }
...
void V8IntersectionObserverCallback::InvokeAndReportException(
    bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const HeapVector<Member<IntersectionObserverEntry>>& arg1_entries, IntersectionObserver* arg2_observer)
{
    v8::Isolate* isolate = GetIsolate();
