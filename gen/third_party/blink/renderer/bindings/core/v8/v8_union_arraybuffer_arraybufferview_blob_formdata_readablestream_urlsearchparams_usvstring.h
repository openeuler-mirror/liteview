...
public:
    ...
    bool IsReadableStream() const { return content_type_ == ContentType::kReadableStream; }
    ReadableStream* GetAsReadableStream() const
    {
        DCHECK_EQ(content_type_, ContentType::kReadableStream);
        return member_readable_stream_;
    }
    ...
    bool IsURLSearchParams() const { return content_type_ == ContentType::kURLSearchParams; }
    URLSearchParams* GetAsURLSearchParams() const
    {
        DCHECK_EQ(content_type_, ContentType::kURLSearchParams);
        return member_url_search_params_;
    }
    ...
    bool IsV8UnionArrayBufferOrArrayBufferView() const { return content_type_ == ContentType::kArrayBuffer || content_type_ == ContentType::kArrayBufferView; }
    ...
    bool IsV8BufferSource() const { return IsV8UnionArrayBufferOrArrayBufferView(); }
    V8UnionArrayBufferOrArrayBufferView* GetAsV8BufferSource() const { return GetAsV8UnionArrayBufferOrArrayBufferView(); }
    ...
    bool IsV8XMLHttpRequestBodyInit() const { return IsV8UnionArrayBufferOrArrayBufferViewOrBlobOrFormDataOrURLSearchParamsOrUSVString(); }
    ...
    bool IsV8BlobPart() const { return IsV8UnionArrayBufferOrArrayBufferViewOrBlobOrUSVString(); }
    V8UnionArrayBufferOrArrayBufferViewOrBlobOrUSVString* GetAsV8BlobPart() const { return GetAsV8UnionArrayBufferOrArrayBufferViewOrBlobOrUSVString(); }
    ...
    bool IsV8PushMessageDataInit() const { return IsV8UnionArrayBufferOrArrayBufferViewOrUSVString(); }
    V8UnionArrayBufferOrArrayBufferViewOrUSVString* GetAsV8PushMessageDataInit() const { return GetAsV8UnionArrayBufferOrArrayBufferViewOrUSVString(); }
...
private:
    ...
    static constexpr const char* UnionNameInIDL() { return "(ArrayBuffer or ArrayBufferView or Blob or FormData or ReadableStream or URLSearchParams or USVString)"; }
