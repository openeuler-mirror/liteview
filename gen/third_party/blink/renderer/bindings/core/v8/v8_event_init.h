...
public:
    ...
    static EventInit* Create(v8::Isolate* isolate) { return MakeGarbageCollected<EventInit>(isolate); }
    ...
    bool hasBubbles() const { return true; }
    bool bubbles() const { return member_bubbles_; }
    void setBubbles(bool value) { member_bubbles_ = value; }

    bool hasCancelable() const { return true; }
    bool cancelable() const { return member_cancelable_; }
    void setCancelable(bool value) { member_cancelable_ = value; }

    bool hasComposed() const { return true; }
    bool composed() const { return member_composed_; }
    void setComposed(bool value) { member_composed_ = value; }
