...
class CORE_EXPORT V8ComputedAccessibleNode final : public bindings::V8InterfaceBridge<V8ComputedAccessibleNode, ComputedAccessibleNode> {
...
private:
    ...
    friend class ComputedAccessibleNode;
};
} // namespace blink
