...
public:
    ...
    static FontFaceDescriptors* Create(v8::Isolate* isolate) { return MakeGarbageCollected<FontFaceDescriptors>(isolate); }
    ...
    bool hasAscentOverride() const { return true; }
    const String& ascentOverride() const { return member_ascent_override_; }
    void setAscentOverride(const String& value);
    void setAscentOverride(String&& value);

    bool hasDescentOverride() const { return true; }
    const String& descentOverride() const { return member_descent_override_; }
    void setDescentOverride(const String& value);
    void setDescentOverride(String&& value);

    bool hasDisplay() const { return true; }
    const String& display() const { return member_display_; }
    void setDisplay(const String& value);
    void setDisplay(String&& value);

    bool hasFeatureSettings() const { return true; }
    const String& featureSettings() const { return member_feature_settings_; }
    void setFeatureSettings(const String& value);
    void setFeatureSettings(String&& value);

    bool hasLineGapOverride() const { return true; }
    const String& lineGapOverride() const { return member_line_gap_override_; }
    void setLineGapOverride(const String& value);
    void setLineGapOverride(String&& value);

    bool hasSizeAdjust() const { return true; }
    const String& sizeAdjust() const { return member_size_adjust_; }
    void setSizeAdjust(const String& value);
    void setSizeAdjust(String&& value);

    bool hasStretch() const { return true; }
    const String& stretch() const { return member_stretch_; }
    void setStretch(const String& value);
    void setStretch(String&& value);

    bool hasStyle() const { return true; }
    const String& style() const { return member_style_; }
    void setStyle(const String& value);
    void setStyle(String&& value);

    bool hasUnicodeRange() const { return true; }
    const String& unicodeRange() const { return member_unicode_range_; }
    void setUnicodeRange(const String& value);
    void setUnicodeRange(String&& value);

    bool hasVariant() const { return true; }
    const String& variant() const { return member_variant_; }
    void setVariant(const String& value);
    void setVariant(String&& value);

    bool hasWeight() const { return true; }
    const String& weight() const { return member_weight_; }
