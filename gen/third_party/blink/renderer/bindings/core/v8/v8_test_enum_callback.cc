...
const char* V8TestEnumCallback::NameInHeapSnapshot() const { return "V8TestEnumCallback"; }
...
v8::Maybe<void> V8TestEnumCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, V8InternalEnum arg1_arg)
{
    ...
    if (!ToV8Traits<V8InternalEnum>::ToV8(script_state, arg1_arg).ToLocal(&v8_arg1_arg)) {
        return v8::Nothing<void>();
    }
    argv[0] = v8_arg1_arg;
