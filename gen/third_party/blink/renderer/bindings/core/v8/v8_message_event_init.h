...
public:
    static MessageEventInit* Create(v8::Isolate* isolate) { return MakeGarbageCollected<MessageEventInit>(isolate); }
    ...
    bool hasLastEventId() const { return true; }
    const String& lastEventId() const { return member_last_event_id_; }
    void setLastEventId(const String& value);
    void setLastEventId(String&& value);

    bool hasOrigin() const { return true; }
    const String& origin() const { return member_origin_; }
    void setOrigin(const String& value);
    void setOrigin(String&& value);

    bool hasPorts() const { return true; }
    const HeapVector<Member<MessagePort>>& ports() const { return member_ports_; }
    void setPorts(const HeapVector<Member<MessagePort>>& value);
    void setPorts(HeapVector<Member<MessagePort>>&& value);

    bool hasSource() const { return true; }
    EventTarget* source() const { return member_source_; }
    void setSource(EventTarget* value) { member_source_ = value; }

    bool hasUserActivation() const { return true; }
    UserActivation* userActivation() const { return member_user_activation_; }
    void setUserActivation(UserActivation* value) { member_user_activation_ = value; }
