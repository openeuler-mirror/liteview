...
public:
    ...
    static absl::optional<V8SelectionMode> Create(const String& value);
...
inline bool operator==(const V8SelectionMode& lhs, V8SelectionMode::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8SelectionMode::Enum lhs, const V8SelectionMode& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
