...
const char* V8CustomElementFormAssociatedCallback::NameInHeapSnapshot() const { return "V8CustomElementFormAssociatedCallback"; }
...
v8::Maybe<void> V8CustomElementFormAssociatedCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, HTMLFormElement* arg1_form)
{
    ...
    if (!ToV8Traits<IDLNullable<HTMLFormElement>>::ToV8(script_state, arg1_form).ToLocal(&v8_arg1_form)) {
        return v8::Nothing<void>();
    }
    argv[0] = v8_arg1_form;
