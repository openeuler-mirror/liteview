...
public:
    ...
    bool IsDocumentTimeline() const { return content_type_ == ContentType::kDocumentTimeline; }
    ...
    bool IsScrollTimeline() const { return content_type_ == ContentType::kScrollTimeline; }
...
private:
    ...
    static constexpr const char* UnionNameInIDL() { return "(DocumentTimeline or ScrollTimeline)"; }
