...
public:
    static TextDirectiveOptions* Create() { return MakeGarbageCollected<TextDirectiveOptions>(); }
    static TextDirectiveOptions* Create(v8::Isolate* isolate) { return MakeGarbageCollected<TextDirectiveOptions>(isolate); }
    ...
    bool hasPrefix() const { return has_prefix_; }
    ...
    bool hasSuffix() const { return has_suffix_; }
    ...
    bool hasTextEnd() const { return has_text_end_; }
    ...
    bool hasTextStart() const { return has_text_start_; }
