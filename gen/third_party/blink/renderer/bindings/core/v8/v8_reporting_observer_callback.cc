...
const char* V8ReportingObserverCallback::NameInHeapSnapshot() const { return "V8ReportingObserverCallback"; }
    ...
    bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const HeapVector<Member<Report>>& arg1_reports, ReportingObserver* arg2_observer)
{
    ...
    if (!ToV8Traits<IDLSequence<Report>>::ToV8(script_state, arg1_reports).ToLocal(&v8_arg1_reports)) {
        return v8::Nothing<void>();
    }
    argv[0] = v8_arg1_reports;
    v8::Local<v8::Value> v8_arg2_observer;
    if (!ToV8Traits<ReportingObserver>::ToV8(script_state, arg2_observer).ToLocal(&v8_arg2_observer)) {
        return v8::Nothing<void>();
    }
