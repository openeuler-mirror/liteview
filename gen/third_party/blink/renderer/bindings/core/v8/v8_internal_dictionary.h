...
public:
    static InternalDictionary* Create(v8::Isolate* isolate) { return MakeGarbageCollected<InternalDictionary>(isolate); }
    ...
    bool hasAnyMember() const { return !member_any_member_.IsEmpty(); }
    ...
    void setAnyMember(const ScriptValue& value) { member_any_member_ = value; }
    ...
    bool hasByteStringMember() const { return has_byte_string_member_; }
    ...
    bool hasCallbackFunctionMember() const { return has_callback_function_member_; }
    ...
    bool hasDoubleOrStringMember() const { return has_double_or_string_member_; }
    ...
    bool hasElementMember() const { return has_element_member_; }
    ...
    bool hasEnumMember() const { return has_enum_member_; }
    ...
    bool hasEnumMemberWithDefault() const { return true; }
    V8InternalEnum enumMemberWithDefault() const { return member_enum_member_with_default_; }
    void setEnumMemberWithDefault(V8InternalEnum value) { member_enum_member_with_default_ = value; }
    void setEnumMemberWithDefault(V8InternalEnum::Enum value) { member_enum_member_with_default_ = V8InternalEnum(value); }

    bool hasEnumOrNullMember() const { return has_enum_or_null_member_; }
    ...
    bool hasEventTargetOrNullMember() const { return true; }
    EventTarget* eventTargetOrNullMember() const { return member_event_target_or_null_member_; }
    void setEventTargetOrNullMember(EventTarget* value) { member_event_target_or_null_member_ = value; }

    bool hasInternalEnumOrInternalEnumSequenceMember() const { return has_internal_enum_or_internal_enum_sequence_member_; }
    ...
    bool hasLongMemberWithDefault() const { return true; }
    int32_t longMemberWithDefault() const { return member_long_member_with_default_; }
    void setLongMemberWithDefault(int32_t value) { member_long_member_with_default_ = value; }
    ...
    bool hasLongOrNullMemberWithDefault() const { return true; }
    const absl::optional<int32_t>& longOrNullMemberWithDefault() const { return member_long_or_null_member_with_default_; }
    void setLongOrNullMemberWithDefault(const absl::optional<int32_t>& value) { member_long_or_null_member_with_default_ = value; }
    void setLongOrNullMemberWithDefault(int32_t value) { member_long_or_null_member_with_default_ = value; }

    bool hasObjectMember() const { return !member_object_member_.IsEmpty(); }
    ...
    bool hasObjectOrNullMemberWithDefault() const { return true; }
    const ScriptValue& objectOrNullMemberWithDefault() const { return member_object_or_null_member_with_default_; }
    void setObjectOrNullMemberWithDefault(const ScriptValue& value) { member_object_or_null_member_with_default_ = value; }

    bool hasStringMember() const { return has_string_member_; }
    ...
    bool hasStringMemberWithDefault() const { return true; }
    const String& stringMemberWithDefault() const { return member_string_member_with_default_; }
    ...
    bool hasStringSequenceMemberWithDefault() const { return true; }
    const Vector<String>& stringSequenceMemberWithDefault() const { return member_string_sequence_member_with_default_; }
    ...
    bool hasUsvStringMember() const { return has_usv_string_member_; }
    ...
    void setEnumMemberWithDefault(const String& value) { member_enum_member_with_default_ = V8InternalEnum::Create(value).value(); }
    void setEnumOrNullMember(const String& value)
    {
        member_enum_or_null_member_ = V8InternalEnum::Create(value).value();
        has_enum_or_null_member_ = true;
    }
    bool hasEnumOrNullMemberNonNull() const { return hasEnumOrNullMember() && enumOrNullMember().has_value(); }
    V8InternalEnum enumOrNullMemberNonNull() const
    {
        DCHECK(hasEnumOrNullMemberNonNull());
        return enumOrNullMember().value();
    }
    bool hasLongOrNullMemberNonNull() const { return hasLongOrNullMember() && longOrNullMember().has_value(); }
    int32_t longOrNullMemberNonNull() const
    {
        DCHECK(hasLongOrNullMemberNonNull());
        return longOrNullMember().value();
    }
    bool hasLongOrNullMemberWithDefaultNonNull() const { return hasLongOrNullMemberWithDefault() && longOrNullMemberWithDefault().has_value(); }
    ...
    bool hasStringSequenceOrNullMemberNonNull() const { return hasStringSequenceOrNullMember() && stringSequenceOrNullMember().has_value(); }
