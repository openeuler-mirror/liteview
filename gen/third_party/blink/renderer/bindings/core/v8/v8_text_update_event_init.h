...
public:
    ...
    static TextUpdateEventInit* Create(v8::Isolate* isolate) { return MakeGarbageCollected<TextUpdateEventInit>(isolate); }
    ...
    bool hasUpdateText() const { return has_update_text_; }
