...
public:
    ...
    static BaseKeyframe* Create(v8::Isolate* isolate) { return MakeGarbageCollected<BaseKeyframe>(isolate); }
    ...
    void setComposite(V8CompositeOperationOrAuto value) { member_composite_ = value; }
    void setComposite(V8CompositeOperationOrAuto::Enum value) { member_composite_ = V8CompositeOperationOrAuto(value); }
    ...
    const absl::optional<double>& offset() const { return member_offset_; }
    void setOffset(const absl::optional<double>& value) { member_offset_ = value; }
    void setOffset(double value) { member_offset_ = value; }
    // Obsolete accessor functions
    void setComposite(const String& value) { member_composite_ = V8CompositeOperationOrAuto::Create(value).value(); }
    bool hasOffsetNonNull() const { return hasOffset() && offset().has_value(); }
