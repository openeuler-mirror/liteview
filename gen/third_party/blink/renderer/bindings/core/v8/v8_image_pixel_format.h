...
public:
    ...
    static absl::optional<V8ImagePixelFormat> Create(const String& value);
...
inline bool operator==(const V8ImagePixelFormat& lhs, V8ImagePixelFormat::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8ImagePixelFormat::Enum lhs, const V8ImagePixelFormat& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
