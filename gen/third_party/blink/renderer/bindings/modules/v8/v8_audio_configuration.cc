...
void AudioConfiguration::setContentType(const String& value) { member_content_type_ = value; }

void AudioConfiguration::setContentType(String&& value) { member_content_type_ = std::move(value); }
...
bool AudioConfiguration::FillV8ObjectWithMembers(ScriptState* script_state, v8::Local<v8::Object> v8_dictionary) const
{
...
void AudioConfiguration::FillMembersFromV8Object(v8::Isolate* isolate, v8::Local<v8::Object> v8_dictionary, ExceptionState& exception_state)
{
    ...
    if (!bindings::GetDictionaryMemberFromV8Object<IDLString, is_optional>(
            isolate, current_context, v8_dictionary, v8_own_member_names[1].Get(isolate), has_channels_, member_channels_, try_block, exception_state)) {
        return;
    }
    ...
    if (!bindings::GetDictionaryMemberFromV8Object<IDLUnsignedLong, is_optional>(
            isolate, current_context, v8_dictionary, v8_own_member_names[3].Get(isolate), has_samplerate_, member_samplerate_, try_block, exception_state)) {
        return;
    }
    if (RuntimeEnabledFeatures::MediaCapabilitiesSpatialAudioEnabled()) {
        exception_context_scope.ChangePropertyNameAsOptimizationHack("spatialRendering");
        if (!bindings::GetDictionaryMemberFromV8Object<IDLBoolean, is_optional>(
                isolate, current_context, v8_dictionary, v8_own_member_names[4].Get(isolate), has_spatial_rendering_, member_spatial_rendering_, try_block, exception_state)) {
            return;
        }
    }
}
