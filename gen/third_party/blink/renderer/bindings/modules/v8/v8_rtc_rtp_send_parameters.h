...
public:
    ...
    static RTCRtpSendParameters* Create(v8::Isolate* isolate) { return MakeGarbageCollected<RTCRtpSendParameters>(isolate); }
    ...
    bool hasDegradationPreference() const { return has_degradation_preference_; }
    ...
    bool hasEncodings() const { return true; }
    const HeapVector<Member<RTCRtpEncodingParameters>>& encodings() const { return member_encodings_; }
    ...
    bool hasTransactionId() const { return true; }
    const String& transactionId() const { return member_transaction_id_; }
