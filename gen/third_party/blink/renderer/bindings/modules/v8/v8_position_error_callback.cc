...
const char* V8PositionErrorCallback::NameInHeapSnapshot() const { return "V8PositionErrorCallback"; }
...
v8::Maybe<void> V8PositionErrorCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, GeolocationPositionError* arg1_position_error)
{
    ...
    if (!ToV8Traits<GeolocationPositionError>::ToV8(script_state, arg1_position_error).ToLocal(&v8_arg1_position_error)) {
        return v8::Nothing<void>();
    }
