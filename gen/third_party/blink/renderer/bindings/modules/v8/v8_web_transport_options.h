...
public:
    static WebTransportOptions* Create() { return MakeGarbageCollected<WebTransportOptions>(); }
    static WebTransportOptions* Create(v8::Isolate* isolate) { return MakeGarbageCollected<WebTransportOptions>(isolate); }
    ...
    bool hasServerCertificateHashes() const { return has_server_certificate_hashes_; }
