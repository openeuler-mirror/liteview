...
public:
    static HandwritingHints* Create() { return MakeGarbageCollected<HandwritingHints>(); }
    static HandwritingHints* Create(v8::Isolate* isolate) { return MakeGarbageCollected<HandwritingHints>(isolate); }
    ...
    bool hasAlternatives() const { return true; }
    uint32_t alternatives() const { return member_alternatives_; }
    void setAlternatives(uint32_t value) { member_alternatives_ = value; }

    bool hasInputType() const { return true; }
    const String& inputType() const { return member_input_type_; }
    void setInputType(const String& value);
    void setInputType(String&& value);

    bool hasRecognitionType() const { return true; }
    const String& recognitionType() const { return member_recognition_type_; }
    void setRecognitionType(const String& value);
    void setRecognitionType(String&& value);

    bool hasTextContext() const { return has_text_context_; }
