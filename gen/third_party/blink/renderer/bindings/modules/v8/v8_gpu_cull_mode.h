...
public:
    ...
    static absl::optional<V8GPUCullMode> Create(const String& value);
...
inline bool operator==(const V8GPUCullMode& lhs, V8GPUCullMode::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8GPUCullMode::Enum lhs, const V8GPUCullMode& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
