...
public:
    ...
    static CredentialRequestOptions* Create(v8::Isolate* isolate) { return MakeGarbageCollected<CredentialRequestOptions>(isolate); }
    ...
    bool hasMediation() const { return true; }
    V8CredentialMediationRequirement mediation() const { return member_mediation_; }
    void setMediation(V8CredentialMediationRequirement value) { member_mediation_ = value; }
    void setMediation(V8CredentialMediationRequirement::Enum value) { member_mediation_ = V8CredentialMediationRequirement(value); }

    bool hasOtp() const { return has_otp_; }
    ...
    bool hasPassword() const { return true; }
    bool password() const { return member_password_; }
    void setPassword(bool value) { member_password_ = value; }
    ...
    void setMediation(const String& value) { member_mediation_ = V8CredentialMediationRequirement::Create(value).value(); }
