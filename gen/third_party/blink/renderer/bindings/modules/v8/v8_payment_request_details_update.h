...
public:
    ...
    static PaymentRequestDetailsUpdate* Create(v8::Isolate* isolate) { return MakeGarbageCollected<PaymentRequestDetailsUpdate>(isolate); }
    ...
    bool hasPaymentMethodErrors() const { return !member_payment_method_errors_.IsEmpty(); }
    ...
    bool hasShippingAddressErrors() const { return has_shipping_address_errors_; }
    AddressErrors* shippingAddressErrors() const
    {
        DCHECK(hasShippingAddressErrors());
        return member_shipping_address_errors_;
    }
