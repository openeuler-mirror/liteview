...
public:
    static ImageDecodeResult* Create() { return MakeGarbageCollected<ImageDecodeResult>(); }
    static ImageDecodeResult* Create(v8::Isolate* isolate) { return MakeGarbageCollected<ImageDecodeResult>(isolate); }
    ...
    bool hasComplete() const { return true; }
    bool complete() const { return member_complete_; }
    void setComplete(bool value) { member_complete_ = value; }

    bool hasImage() const { return true; }
    VideoFrame* image() const { return member_image_; }
