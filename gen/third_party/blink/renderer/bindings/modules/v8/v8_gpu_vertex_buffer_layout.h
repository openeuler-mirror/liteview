...
public:
    static GPUVertexBufferLayout* Create() { return MakeGarbageCollected<GPUVertexBufferLayout>(); }
    static GPUVertexBufferLayout* Create(v8::Isolate* isolate) { return MakeGarbageCollected<GPUVertexBufferLayout>(isolate); }
    ...
    bool hasArrayStride() const { return true; }
    uint64_t arrayStride() const { return member_array_stride_; }
    void setArrayStride(uint64_t value) { member_array_stride_ = value; }

    bool hasAttributes() const { return true; }
    const HeapVector<Member<GPUVertexAttribute>>& attributes() const { return member_attributes_; }
    ...
    bool hasStepMode() const { return true; }
    V8GPUVertexStepMode stepMode() const { return member_step_mode_; }
    void setStepMode(V8GPUVertexStepMode value) { member_step_mode_ = value; }
    void setStepMode(V8GPUVertexStepMode::Enum value) { member_step_mode_ = V8GPUVertexStepMode(value); }
    // Obsolete accessor functions
    void setStepMode(const String& value) { member_step_mode_ = V8GPUVertexStepMode::Create(value).value(); }
