...
public:
    static CanvasFilterDictionary* Create() { return MakeGarbageCollected<CanvasFilterDictionary>(); }
    static CanvasFilterDictionary* Create(v8::Isolate* isolate) { return MakeGarbageCollected<CanvasFilterDictionary>(isolate); }
    ...
    bool hasBlur() const { return !member_blur_.IsEmpty(); }
    ...
    bool hasColorMatrix() const { return !member_color_matrix_.IsEmpty(); }
    ...
    bool hasComponentTransfer() const { return !member_component_transfer_.IsEmpty(); }
    ...
    bool hasConvolveMatrix() const { return !member_convolve_matrix_.IsEmpty(); }
