...
public:
    ...
    static RTCConfiguration* Create(v8::Isolate* isolate) { return MakeGarbageCollected<RTCConfiguration>(isolate); }
    ...
    bool hasBundlePolicy() const { return true; }
    V8RTCBundlePolicy bundlePolicy() const { return member_bundle_policy_; }
    void setBundlePolicy(V8RTCBundlePolicy value) { member_bundle_policy_ = value; }
    void setBundlePolicy(V8RTCBundlePolicy::Enum value) { member_bundle_policy_ = V8RTCBundlePolicy(value); }
    ...
    bool hasEncodedInsertableStreams() const { return true; }
    bool encodedInsertableStreams() const { return member_encoded_insertable_streams_; }
    void setEncodedInsertableStreams(bool value) { member_encoded_insertable_streams_ = value; }

    bool hasIceCandidatePoolSize() const { return true; }
    uint8_t iceCandidatePoolSize() const { return member_ice_candidate_pool_size_; }
    void setIceCandidatePoolSize(uint8_t value) { member_ice_candidate_pool_size_ = value; }
    ...
    bool hasIceTransportPolicy() const { return has_ice_transport_policy_; }
    ...
    bool hasIceTransports() const { return has_ice_transports_; }
    ...
    bool hasRtcpMuxPolicy() const { return true; }
    V8RTCRtcpMuxPolicy rtcpMuxPolicy() const { return member_rtcp_mux_policy_; }
    void setRtcpMuxPolicy(V8RTCRtcpMuxPolicy value) { member_rtcp_mux_policy_ = value; }
    void setRtcpMuxPolicy(V8RTCRtcpMuxPolicy::Enum value) { member_rtcp_mux_policy_ = V8RTCRtcpMuxPolicy(value); }
    // Obsolete accessor functions
    void setBundlePolicy(const String& value) { member_bundle_policy_ = V8RTCBundlePolicy::Create(value).value(); }
    ...
    void setRtcpMuxPolicy(const String& value) { member_rtcp_mux_policy_ = V8RTCRtcpMuxPolicy::Create(value).value(); }
