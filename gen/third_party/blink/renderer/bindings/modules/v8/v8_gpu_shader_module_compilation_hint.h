...
class MODULES_EXPORT GPUShaderModuleCompilationHint : public bindings::DictionaryBase {

public:
    static GPUShaderModuleCompilationHint* Create() { return MakeGarbageCollected<GPUShaderModuleCompilationHint>(); }
    static GPUShaderModuleCompilationHint* Create(v8::Isolate* isolate) { return MakeGarbageCollected<GPUShaderModuleCompilationHint>(isolate); }
