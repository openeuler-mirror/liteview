...
const char* V8FileWriterCallback::NameInHeapSnapshot() const { return "V8FileWriterCallback"; }
...
v8::Maybe<void> V8FileWriterCallback::handleEvent(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, FileWriter* arg1_file_writer)
{
    ...
    if (!ToV8Traits<FileWriter>::ToV8(script_state, arg1_file_writer).ToLocal(&v8_arg1_file_writer)) {
        return v8::Nothing<void>();
    }
