...
const char* V8MediaSessionActionHandler::NameInHeapSnapshot() const { return "V8MediaSessionActionHandler"; }
...
v8::Maybe<void> V8MediaSessionActionHandler::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const MediaSessionActionDetails* arg1_details)
{
    ...
    if (!ToV8Traits<MediaSessionActionDetails>::ToV8(script_state, arg1_details).ToLocal(&v8_arg1_details)) {
        return v8::Nothing<void>();
    }
