...
bool AuthenticationExtensionsPaymentInputs::FillV8ObjectWithMembers(ScriptState* script_state, v8::Local<v8::Object> v8_dictionary) const
{
    if (hasIsPayment()) {
        v8::Local<v8::Value> v8_value;
        if (!ToV8Traits<IDLBoolean>::ToV8(script_state, member_is_payment_).ToLocal(&v8_value)) {
            return false;
        }
...
void AuthenticationExtensionsPaymentInputs::FillMembersFromV8Object(v8::Isolate* isolate, v8::Local<v8::Object> v8_dictionary, ExceptionState& exception_state)
{
    ...
    exception_context_scope.ChangePropertyNameAsOptimizationHack("isPayment");
    constexpr bool is_optional = false;
    v8::Local<v8::Context> current_context = isolate->GetCurrentContext();
    const auto& v8_own_member_names = GetV8OwnMemberNames(isolate);
    v8::TryCatch try_block(isolate);
    if (!bindings::GetDictionaryMemberFromV8Object<IDLBoolean, is_optional>(
            isolate, current_context, v8_dictionary, v8_own_member_names[0].Get(isolate), has_is_payment_, member_is_payment_, try_block, exception_state)) {
        return;
    }
}
