...
class MODULES_EXPORT HIDDeviceRequestOptions : public bindings::DictionaryBase {

public:
    static HIDDeviceRequestOptions* Create() { return MakeGarbageCollected<HIDDeviceRequestOptions>(); }
    static HIDDeviceRequestOptions* Create(v8::Isolate* isolate) { return MakeGarbageCollected<HIDDeviceRequestOptions>(isolate); }
    ...
    bool hasExclusionFilters() const { return has_exclusion_filters_; }
    ...
    const HeapVector<Member<HIDDeviceFilter>>& filters() const { return member_filters_; }
