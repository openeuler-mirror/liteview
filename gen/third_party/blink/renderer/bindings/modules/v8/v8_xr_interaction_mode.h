...
public:
    ...
    static absl::optional<V8XRInteractionMode> Create(const String& value);
...
inline bool operator==(const V8XRInteractionMode& lhs, V8XRInteractionMode::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8XRInteractionMode::Enum lhs, const V8XRInteractionMode& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
