...
public:
    ...
    static absl::optional<V8HdrMetadataType> Create(const String& value);
...
inline bool operator==(const V8HdrMetadataType& lhs, V8HdrMetadataType::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8HdrMetadataType::Enum lhs, const V8HdrMetadataType& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
