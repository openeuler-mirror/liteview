...
public:
    static PurchaseDetails* Create() { return MakeGarbageCollected<PurchaseDetails>(); }
    static PurchaseDetails* Create(v8::Isolate* isolate) { return MakeGarbageCollected<PurchaseDetails>(isolate); }
    ...
    bool hasPurchaseToken() const { return true; }
    const String& purchaseToken() const { return member_purchase_token_; }
