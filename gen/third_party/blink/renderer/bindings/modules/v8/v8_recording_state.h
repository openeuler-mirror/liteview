...
public:
    ...
    static absl::optional<V8RecordingState> Create(const String& value);
...
inline bool operator==(const V8RecordingState& lhs, V8RecordingState::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8RecordingState::Enum lhs, const V8RecordingState& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
