...
public:
    ...
    static PasswordCredentialData* Create(v8::Isolate* isolate) { return MakeGarbageCollected<PasswordCredentialData>(isolate); }
    ...
    const String& password() const { return member_password_; }
