...
public:
    ...
    static absl::optional<V8RTCIceTransportPolicy> Create(const String& value);
...
inline bool operator==(const V8RTCIceTransportPolicy& lhs, V8RTCIceTransportPolicy::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8RTCIceTransportPolicy::Enum lhs, const V8RTCIceTransportPolicy& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
