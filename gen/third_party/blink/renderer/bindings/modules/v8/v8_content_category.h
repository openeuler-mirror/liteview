...
public:
    ...
    static absl::optional<V8ContentCategory> Create(const String& value);
...
inline bool operator==(const V8ContentCategory& lhs, V8ContentCategory::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8ContentCategory::Enum lhs, const V8ContentCategory& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
