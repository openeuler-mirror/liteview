...
public:
    ...
    static Landmark* Create(v8::Isolate* isolate) { return MakeGarbageCollected<Landmark>(isolate); }
    ...
    bool hasLocations() const { return true; }
    const HeapVector<Member<Point2D>>& locations() const { return member_locations_; }
