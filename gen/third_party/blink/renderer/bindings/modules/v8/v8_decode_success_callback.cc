...
const char* V8DecodeSuccessCallback::NameInHeapSnapshot() const { return "V8DecodeSuccessCallback"; }
...
v8::Maybe<void> V8DecodeSuccessCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, AudioBuffer* arg1_decoded_data)
{
    ...
    if (!ToV8Traits<AudioBuffer>::ToV8(script_state, arg1_decoded_data).ToLocal(&v8_arg1_decoded_data)) {
        return v8::Nothing<void>();
    }
