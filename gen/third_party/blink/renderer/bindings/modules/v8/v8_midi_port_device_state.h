...
inline bool operator==(const V8MIDIPortDeviceState& lhs, V8MIDIPortDeviceState::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8MIDIPortDeviceState::Enum lhs, const V8MIDIPortDeviceState& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
