...
public:
    ...
    static absl::optional<V8MediaStreamTrackState> Create(const String& value);
...
inline bool operator==(const V8MediaStreamTrackState& lhs, V8MediaStreamTrackState::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8MediaStreamTrackState::Enum lhs, const V8MediaStreamTrackState& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
