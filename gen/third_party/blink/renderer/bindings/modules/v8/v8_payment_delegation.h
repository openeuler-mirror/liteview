...
public:
    ...
    static absl::optional<V8PaymentDelegation> Create(const String& value);
...
inline bool operator==(const V8PaymentDelegation& lhs, V8PaymentDelegation::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8PaymentDelegation::Enum lhs, const V8PaymentDelegation& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
