...
public:
    static AdTargeting* Create() { return MakeGarbageCollected<AdTargeting>(); }
    static AdTargeting* Create(v8::Isolate* isolate) { return MakeGarbageCollected<AdTargeting>(isolate); }
    ...
    bool hasGeolocation() const { return has_geolocation_; }
    ...
    bool hasInterests() const { return has_interests_; }
