...
public:
    ...
    static GPUDeviceDescriptor* Create(v8::Isolate* isolate) { return MakeGarbageCollected<GPUDeviceDescriptor>(isolate); }
    ...
    bool hasDefaultQueue() const { return true; }
    GPUQueueDescriptor* defaultQueue() const { return member_default_queue_; }
    ...
    bool hasRequiredFeatures() const { return true; }
    const Vector<V8GPUFeatureName>& requiredFeatures() const { return member_required_features_; }
    void setRequiredFeatures(const Vector<V8GPUFeatureName>& value);
    void setRequiredFeatures(Vector<V8GPUFeatureName>&& value);

    bool hasRequiredLimits() const { return has_required_limits_; }
