...
public:
    static TaskControllerInit* Create() { return MakeGarbageCollected<TaskControllerInit>(); }
    static TaskControllerInit* Create(v8::Isolate* isolate) { return MakeGarbageCollected<TaskControllerInit>(isolate); }
    ...
    V8TaskPriority priority() const { return member_priority_; }
    void setPriority(V8TaskPriority value) { member_priority_ = value; }
    void setPriority(V8TaskPriority::Enum value) { member_priority_ = V8TaskPriority(value); }
    // Obsolete accessor functions
    void setPriority(const String& value) { member_priority_ = V8TaskPriority::Create(value).value(); }
