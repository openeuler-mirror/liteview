...
public:
    ...
    static absl::optional<V8CookieSameSite> Create(const String& value);
...
inline bool operator==(const V8CookieSameSite& lhs, V8CookieSameSite::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8CookieSameSite::Enum lhs, const V8CookieSameSite& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
