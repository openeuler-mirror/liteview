...
public:
    ...
    static absl::optional<V8RTCIceRole> Create(const String& value);
...
inline bool operator==(const V8RTCIceRole& lhs, V8RTCIceRole::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8RTCIceRole::Enum lhs, const V8RTCIceRole& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
