...
inline bool operator==(const V8CanvasFillRule& lhs, V8CanvasFillRule::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8CanvasFillRule::Enum lhs, const V8CanvasFillRule& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
