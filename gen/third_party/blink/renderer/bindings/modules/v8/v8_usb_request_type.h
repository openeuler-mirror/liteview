...
public:
    ...
    static absl::optional<V8USBRequestType> Create(const String& value);
...
inline bool operator==(const V8USBRequestType& lhs, V8USBRequestType::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8USBRequestType::Enum lhs, const V8USBRequestType& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
