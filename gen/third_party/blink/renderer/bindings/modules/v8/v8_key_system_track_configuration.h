...
public:
    static KeySystemTrackConfiguration* Create() { return MakeGarbageCollected<KeySystemTrackConfiguration>(); }
    static KeySystemTrackConfiguration* Create(v8::Isolate* isolate) { return MakeGarbageCollected<KeySystemTrackConfiguration>(isolate); }
