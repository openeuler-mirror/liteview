...
inline bool operator==(const V8FileSystemHandleKind& lhs, V8FileSystemHandleKind::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8FileSystemHandleKind::Enum lhs, const V8FileSystemHandleKind& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
