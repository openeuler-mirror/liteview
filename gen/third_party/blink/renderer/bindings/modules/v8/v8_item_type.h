...
inline bool operator==(const V8ItemType& lhs, V8ItemType::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8ItemType::Enum lhs, const V8ItemType& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
