...
public:
    ...
    static RTCIceServer* Create(v8::Isolate* isolate) { return MakeGarbageCollected<RTCIceServer>(isolate); }
    ...
    bool hasCredential() const { return has_credential_; }
    ...
    bool hasUrls() const { return has_urls_; }
