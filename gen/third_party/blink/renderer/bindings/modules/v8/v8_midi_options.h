...
class MODULES_EXPORT MIDIOptions : public bindings::DictionaryBase {

public:
    static MIDIOptions* Create() { return MakeGarbageCollected<MIDIOptions>(); }
    static MIDIOptions* Create(v8::Isolate* isolate) { return MakeGarbageCollected<MIDIOptions>(isolate); }
