...
public:
    ...
    static absl::optional<V8GamepadHapticsResult> Create(const String& value);
...
inline bool operator==(const V8GamepadHapticsResult& lhs, V8GamepadHapticsResult::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8GamepadHapticsResult::Enum lhs, const V8GamepadHapticsResult& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
