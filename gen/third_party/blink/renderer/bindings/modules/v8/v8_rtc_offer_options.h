...
public:
    ...
    static RTCOfferOptions* Create(v8::Isolate* isolate) { return MakeGarbageCollected<RTCOfferOptions>(isolate); }
    ...
    bool hasIceRestart() const { return true; }
    bool iceRestart() const { return member_ice_restart_; }
    void setIceRestart(bool value) { member_ice_restart_ = value; }
