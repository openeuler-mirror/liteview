...
class MODULES_EXPORT MediaConfiguration : public bindings::DictionaryBase {

public:
    static MediaConfiguration* Create() { return MakeGarbageCollected<MediaConfiguration>(); }
    static MediaConfiguration* Create(v8::Isolate* isolate) { return MakeGarbageCollected<MediaConfiguration>(isolate); }
