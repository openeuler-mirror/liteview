...
class MODULES_EXPORT GPUProgrammableStage : public bindings::DictionaryBase {

public:
    static GPUProgrammableStage* Create() { return MakeGarbageCollected<GPUProgrammableStage>(); }
    static GPUProgrammableStage* Create(v8::Isolate* isolate) { return MakeGarbageCollected<GPUProgrammableStage>(isolate); }
    ...
    bool hasEntryPoint() const { return true; }
    const String& entryPoint() const { return member_entry_point_; }
    void setEntryPoint(const String& value);
    void setEntryPoint(String&& value);

    bool hasModule() const { return true; }
    GPUShaderModule* module() const { return member_module_; }
