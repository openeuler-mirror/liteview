...
public:
    ...
    static AudioConfiguration* Create(v8::Isolate* isolate) { return MakeGarbageCollected<AudioConfiguration>(isolate); }
    ...
    bool hasSpatialRendering() const { return has_spatial_rendering_; }
