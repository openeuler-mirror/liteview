...
bool StereoPannerOptions::FillV8ObjectWithMembers(ScriptState* script_state, v8::Local<v8::Object> v8_dictionary) const
{
    ...
    if (hasPan()) {
        ...
        if (!ToV8Traits<IDLFloat>::ToV8(script_state, member_pan_).ToLocal(&v8_value)) {
            return false;
        }
...
void StereoPannerOptions::FillMembersFromV8Object(v8::Isolate* isolate, v8::Local<v8::Object> v8_dictionary, ExceptionState& exception_state)
{
    ...
    if (!bindings::GetDictionaryMemberFromV8Object<IDLFloat, is_optional>(
            isolate, current_context, v8_dictionary, v8_own_member_names[0].Get(isolate), fallback_presence_var, member_pan_, try_block, exception_state)) {
        return;
    }
}
