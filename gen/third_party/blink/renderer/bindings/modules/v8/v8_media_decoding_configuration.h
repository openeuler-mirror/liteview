...
public:
    ...
    static MediaDecodingConfiguration* Create(v8::Isolate* isolate) { return MakeGarbageCollected<MediaDecodingConfiguration>(isolate); }
    ...
    bool hasKeySystemConfiguration() const { return has_key_system_configuration_; }
    ...
    V8MediaDecodingType type() const { return member_type_; }
    void setType(V8MediaDecodingType value) { member_type_ = value; }
    void setType(V8MediaDecodingType::Enum value) { member_type_ = V8MediaDecodingType(value); }
    // Obsolete accessor functions
    void setType(const String& value) { member_type_ = V8MediaDecodingType::Create(value).value(); }
