...
public:
    ...
    static absl::optional<V8MeteringMode> Create(const String& value);
...
inline bool operator==(const V8MeteringMode& lhs, V8MeteringMode::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8MeteringMode::Enum lhs, const V8MeteringMode& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
