...
public:
    ...
    static absl::optional<V8NotificationPermission> Create(const String& value);
...
inline bool operator==(const V8NotificationPermission& lhs, V8NotificationPermission::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8NotificationPermission::Enum lhs, const V8NotificationPermission& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
