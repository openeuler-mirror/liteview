...
public:
    ...
    static absl::optional<V8XRTargetRayMode> Create(const String& value);
...
inline bool operator==(const V8XRTargetRayMode& lhs, V8XRTargetRayMode::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8XRTargetRayMode::Enum lhs, const V8XRTargetRayMode& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
