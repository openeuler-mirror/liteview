...
public:
    static AuthenticationExtensionsLargeBlobInputs* Create() { return MakeGarbageCollected<AuthenticationExtensionsLargeBlobInputs>(); }
    static AuthenticationExtensionsLargeBlobInputs* Create(v8::Isolate* isolate) { return MakeGarbageCollected<AuthenticationExtensionsLargeBlobInputs>(isolate); }
    ...
    bool hasSupport() const { return has_support_; }
    ...
    bool hasWrite() const { return has_write_; }
