...
const char* V8StorageErrorCallback::NameInHeapSnapshot() const { return "V8StorageErrorCallback"; }
...
v8::Maybe<void> V8StorageErrorCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, DOMError* arg1_error)
{
    ...
    if (!ToV8Traits<DOMError>::ToV8(script_state, arg1_error).ToLocal(&v8_arg1_error)) {
        return v8::Nothing<void>();
    }
