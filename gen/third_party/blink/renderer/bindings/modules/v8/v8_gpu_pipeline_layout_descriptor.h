...
public:
    ...
    static GPUPipelineLayoutDescriptor* Create(v8::Isolate* isolate) { return MakeGarbageCollected<GPUPipelineLayoutDescriptor>(isolate); }
    ...
    bool hasBindGroupLayouts() const { return true; }
    const HeapVector<Member<GPUBindGroupLayout>>& bindGroupLayouts() const { return member_bind_group_layouts_; }
