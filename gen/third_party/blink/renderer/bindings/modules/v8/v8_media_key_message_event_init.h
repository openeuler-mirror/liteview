...
public:
    ...
    static MediaKeyMessageEventInit* Create(v8::Isolate* isolate) { return MakeGarbageCollected<MediaKeyMessageEventInit>(isolate); }
    ...
    DOMArrayBuffer* message() const { return member_message_; }
    ...
    bool hasMessageType() const { return true; }
    V8MediaKeyMessageType messageType() const { return member_message_type_; }
    void setMessageType(V8MediaKeyMessageType value) { member_message_type_ = value; }
    void setMessageType(V8MediaKeyMessageType::Enum value) { member_message_type_ = V8MediaKeyMessageType(value); }
    // Obsolete accessor functions
    void setMessageType(const String& value) { member_message_type_ = V8MediaKeyMessageType::Create(value).value(); }
