...
public:
    ...
    static absl::optional<V8GPUPrimitiveTopology> Create(const String& value);
...
inline bool operator==(const V8GPUPrimitiveTopology& lhs, V8GPUPrimitiveTopology::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8GPUPrimitiveTopology::Enum lhs, const V8GPUPrimitiveTopology& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
