...
public:
    ...
    static ContentDescription* Create(v8::Isolate* isolate) { return MakeGarbageCollected<ContentDescription>(isolate); }
    ...
    bool hasCategory() const { return true; }
    V8ContentCategory category() const { return member_category_; }
    void setCategory(V8ContentCategory value) { member_category_ = value; }
    void setCategory(V8ContentCategory::Enum value) { member_category_ = V8ContentCategory(value); }

    bool hasDescription() const { return true; }
    const String& description() const { return member_description_; }
    void setDescription(const String& value);
    void setDescription(String&& value);

    bool hasIcons() const { return true; }
    const HeapVector<Member<ContentIconDefinition>>& icons() const { return member_icons_; }
    ...
    bool hasTitle() const { return true; }
    const String& title() const { return member_title_; }
    ...
    void setCategory(const String& value) { member_category_ = V8ContentCategory::Create(value).value(); }
