...
public:
    static V8BlinkAudioWorkletProcessCallback* Create(v8::Local<v8::Object> callback_object) { return MakeGarbageCollected<V8BlinkAudioWorkletProcessCallback>(callback_object); }
