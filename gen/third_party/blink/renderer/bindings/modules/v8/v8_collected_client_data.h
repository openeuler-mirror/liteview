...
public:
    ...
    static CollectedClientData* Create(v8::Isolate* isolate) { return MakeGarbageCollected<CollectedClientData>(isolate); }
    ...
    const String& challenge() const { return member_challenge_; }
    ...
    bool hasTokenBindingId() const { return has_token_binding_id_; }
