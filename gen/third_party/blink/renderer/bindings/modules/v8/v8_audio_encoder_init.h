...
class MODULES_EXPORT AudioEncoderInit : public bindings::DictionaryBase {

public:
    static AudioEncoderInit* Create() { return MakeGarbageCollected<AudioEncoderInit>(); }
    static AudioEncoderInit* Create(v8::Isolate* isolate) { return MakeGarbageCollected<AudioEncoderInit>(isolate); }
    ...
    V8EncodedAudioChunkOutputCallback* output() const { return member_output_; }
