...
public:
    static BluetoothDataFilterInit* Create() { return MakeGarbageCollected<BluetoothDataFilterInit>(); }
    static BluetoothDataFilterInit* Create(v8::Isolate* isolate) { return MakeGarbageCollected<BluetoothDataFilterInit>(isolate); }
    ...
    bool hasDataPrefix() const { return has_data_prefix_; }
