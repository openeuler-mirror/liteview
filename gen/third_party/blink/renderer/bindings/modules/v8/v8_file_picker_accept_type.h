...
class MODULES_EXPORT FilePickerAcceptType : public bindings::DictionaryBase {

public:
    static FilePickerAcceptType* Create() { return MakeGarbageCollected<FilePickerAcceptType>(); }
    static FilePickerAcceptType* Create(v8::Isolate* isolate) { return MakeGarbageCollected<FilePickerAcceptType>(isolate); }
    ...
    bool hasAccept() const { return has_accept_; }
