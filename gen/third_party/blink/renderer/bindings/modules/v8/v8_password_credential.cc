...
static_assert(std::is_same<decltype(&PasswordCredential::HasPendingActivity), decltype(&ScriptWrappable::HasPendingActivity)>::value,
...
void ConstructorOverload1(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    const char* const class_like_name = "PasswordCredential";
