...
void GPUExternalTextureBindingLayout::Trace(Visitor* visitor) const { bindings::DictionaryBase::Trace(visitor); }

bool GPUExternalTextureBindingLayout::FillV8ObjectWithMembers(ScriptState* script_state, v8::Local<v8::Object> v8_dictionary) const { return true; }
...
const base::span<const v8::Eternal<v8::Name>> GPUExternalTextureBindingLayout::GetV8OwnMemberNames(v8::Isolate* isolate) { return {}; }
