...
class MODULES_EXPORT PayerErrors : public bindings::DictionaryBase {

public:
    static PayerErrors* Create() { return MakeGarbageCollected<PayerErrors>(); }
    static PayerErrors* Create(v8::Isolate* isolate) { return MakeGarbageCollected<PayerErrors>(isolate); }
