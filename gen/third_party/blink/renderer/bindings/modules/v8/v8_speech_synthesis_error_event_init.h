...
public:
    ...
    static SpeechSynthesisErrorEventInit* Create(v8::Isolate* isolate) { return MakeGarbageCollected<SpeechSynthesisErrorEventInit>(isolate); }
    ...
    V8SpeechSynthesisErrorCode error() const { return member_error_; }
    void setError(V8SpeechSynthesisErrorCode value) { member_error_ = value; }
    void setError(V8SpeechSynthesisErrorCode::Enum value) { member_error_ = V8SpeechSynthesisErrorCode(value); }
    // Obsolete accessor functions
    void setError(const String& value) { member_error_ = V8SpeechSynthesisErrorCode::Create(value).value(); }
