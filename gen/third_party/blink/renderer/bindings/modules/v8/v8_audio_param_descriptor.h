...
public:
    ...
    static AudioParamDescriptor* Create(v8::Isolate* isolate) { return MakeGarbageCollected<AudioParamDescriptor>(isolate); }
    ...
    bool hasAutomationRate() const { return true; }
    V8AutomationRate automationRate() const { return member_automation_rate_; }
    void setAutomationRate(V8AutomationRate value) { member_automation_rate_ = value; }
    void setAutomationRate(V8AutomationRate::Enum value) { member_automation_rate_ = V8AutomationRate(value); }

    bool hasDefaultValue() const { return true; }
    float defaultValue() const { return member_default_value_; }
    void setDefaultValue(float value) { member_default_value_ = value; }

    bool hasMaxValue() const { return true; }
    float maxValue() const { return member_max_value_; }
    void setMaxValue(float value) { member_max_value_ = value; }

    bool hasMinValue() const { return true; }
    float minValue() const { return member_min_value_; }
    void setMinValue(float value) { member_min_value_ = value; }
    ...
    void setAutomationRate(const String& value) { member_automation_rate_ = V8AutomationRate::Create(value).value(); }
