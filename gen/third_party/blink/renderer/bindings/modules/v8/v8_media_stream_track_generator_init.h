...
public:
    static MediaStreamTrackGeneratorInit* Create() { return MakeGarbageCollected<MediaStreamTrackGeneratorInit>(); }
    static MediaStreamTrackGeneratorInit* Create(v8::Isolate* isolate) { return MakeGarbageCollected<MediaStreamTrackGeneratorInit>(isolate); }
    ...
    const String& kind() const { return member_kind_; }
    void setKind(const String& value);
    void setKind(String&& value);

    bool hasMaxSignalBufferSize() const { return has_max_signal_buffer_size_; }
    ...
    bool hasSignalTarget() const { return has_signal_target_; }
