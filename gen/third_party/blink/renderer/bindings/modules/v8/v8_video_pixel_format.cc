...
constexpr const char* const V8VideoPixelFormat::string_table_[] = { "I420", "I420A", "I422", "I444", "NV12", "RGBA", "RGBX", "BGRA", "BGRX" };
...
absl::optional<V8VideoPixelFormat> V8VideoPixelFormat::Create(const String& value)
{
