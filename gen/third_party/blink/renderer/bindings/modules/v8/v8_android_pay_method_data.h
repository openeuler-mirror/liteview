...
public:
    ...
    static AndroidPayMethodData* Create(v8::Isolate* isolate) { return MakeGarbageCollected<AndroidPayMethodData>(isolate); }
    ...
    bool hasEnvironment() const { return has_environment_; }
    ...
    bool hasMinGooglePlayServicesVersion() const { return has_min_google_play_services_version_; }
