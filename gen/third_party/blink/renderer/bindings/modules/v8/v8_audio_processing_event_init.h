...
public:
    ...
    static AudioProcessingEventInit* Create(v8::Isolate* isolate) { return MakeGarbageCollected<AudioProcessingEventInit>(isolate); }
    ...
    bool hasInputBuffer() const { return true; }
    AudioBuffer* inputBuffer() const { return member_input_buffer_; }
    ...
    bool hasOutputBuffer() const { return true; }
    AudioBuffer* outputBuffer() const { return member_output_buffer_; }
    ...
    bool hasPlaybackTime() const { return true; }
    double playbackTime() const { return member_playback_time_; }
    void setPlaybackTime(double value) { member_playback_time_ = value; }
