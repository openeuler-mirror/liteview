...
class MODULES_EXPORT SerialPortFilter : public bindings::DictionaryBase {

public:
    static SerialPortFilter* Create() { return MakeGarbageCollected<SerialPortFilter>(); }
    static SerialPortFilter* Create(v8::Isolate* isolate) { return MakeGarbageCollected<SerialPortFilter>(isolate); }
