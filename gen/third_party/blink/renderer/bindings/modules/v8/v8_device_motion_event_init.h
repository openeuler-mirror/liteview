...
public:
    ...
    static DeviceMotionEventInit* Create(v8::Isolate* isolate) { return MakeGarbageCollected<DeviceMotionEventInit>(isolate); }
    ...
    bool hasInterval() const { return true; }
    double interval() const { return member_interval_; }
    void setInterval(double value) { member_interval_ = value; }
