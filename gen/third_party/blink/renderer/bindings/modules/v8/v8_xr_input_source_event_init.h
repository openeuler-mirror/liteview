...
public:
    ...
    static XRInputSourceEventInit* Create(v8::Isolate* isolate) { return MakeGarbageCollected<XRInputSourceEventInit>(isolate); }
    ...
    XRFrame* frame() const { return member_frame_; }
    ...
    bool hasInputSource() const { return true; }
    XRInputSource* inputSource() const { return member_input_source_; }
