...
public:
    ...
    bool IsConstrainPoint2DParameters() const { return content_type_ == ContentType::kConstrainPoint2DParameters; }
    ...
    bool IsPoint2DSequence() const { return content_type_ == ContentType::kPoint2DSequence; }
...
private:
    ...
    static constexpr const char* UnionNameInIDL() { return "(ConstrainPoint2DParameters or sequence<Point2D>)"; }
