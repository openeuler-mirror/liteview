...
public:
    ...
    bool IsMediaTrackConstraints() const { return content_type_ == ContentType::kMediaTrackConstraints; }
...
private:
    ...
    static constexpr const char* UnionNameInIDL() { return "(MediaTrackConstraints or boolean)"; }
