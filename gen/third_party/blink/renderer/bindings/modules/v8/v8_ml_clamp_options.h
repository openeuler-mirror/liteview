...
public:
    static MLClampOptions* Create() { return MakeGarbageCollected<MLClampOptions>(); }
    static MLClampOptions* Create(v8::Isolate* isolate) { return MakeGarbageCollected<MLClampOptions>(isolate); }
