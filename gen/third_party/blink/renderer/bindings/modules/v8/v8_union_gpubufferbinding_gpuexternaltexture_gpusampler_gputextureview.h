...
public:
    ...
    bool IsGPUBufferBinding() const { return content_type_ == ContentType::kGPUBufferBinding; }
    ...
    bool IsGPUExternalTexture() const { return content_type_ == ContentType::kGPUExternalTexture; }
    ...
    bool IsGPUSampler() const { return content_type_ == ContentType::kGPUSampler; }
    ...
    bool IsGPUTextureView() const { return content_type_ == ContentType::kGPUTextureView; }
...
private:
    ...
    static constexpr const char* UnionNameInIDL() { return "(GPUBufferBinding or GPUExternalTexture or GPUSampler or GPUTextureView)"; }
