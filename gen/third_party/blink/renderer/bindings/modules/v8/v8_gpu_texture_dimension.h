...
public:
    ...
    static absl::optional<V8GPUTextureDimension> Create(const String& value);
...
inline bool operator==(const V8GPUTextureDimension& lhs, V8GPUTextureDimension::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8GPUTextureDimension::Enum lhs, const V8GPUTextureDimension& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
