...
public:
    static HIDCollectionInfo* Create() { return MakeGarbageCollected<HIDCollectionInfo>(); }
    static HIDCollectionInfo* Create(v8::Isolate* isolate) { return MakeGarbageCollected<HIDCollectionInfo>(isolate); }
    ...
    bool hasFeatureReports() const { return has_feature_reports_; }
    ...
    bool hasInputReports() const { return has_input_reports_; }
    ...
    bool hasOutputReports() const { return has_output_reports_; }
