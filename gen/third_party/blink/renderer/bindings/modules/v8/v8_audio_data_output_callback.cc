...
const char* V8AudioDataOutputCallback::NameInHeapSnapshot() const { return "V8AudioDataOutputCallback"; }
...
v8::Maybe<void> V8AudioDataOutputCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, AudioData* arg1_output)
{
    ...
    if (!ToV8Traits<AudioData>::ToV8(script_state, arg1_output).ToLocal(&v8_arg1_output)) {
        return v8::Nothing<void>();
    }
