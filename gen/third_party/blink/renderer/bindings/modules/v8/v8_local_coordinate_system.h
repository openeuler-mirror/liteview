...
public:
    ...
    static absl::optional<V8LocalCoordinateSystem> Create(const String& value);
...
inline bool operator==(const V8LocalCoordinateSystem& lhs, V8LocalCoordinateSystem::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8LocalCoordinateSystem::Enum lhs, const V8LocalCoordinateSystem& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
