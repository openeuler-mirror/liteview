...
public:
    ...
    static VideoConfiguration* Create(v8::Isolate* isolate) { return MakeGarbageCollected<VideoConfiguration>(isolate); }
    ...
    bool hasBitrate() const { return true; }
    uint32_t bitrate() const { return member_bitrate_; }
    void setBitrate(uint32_t value) { member_bitrate_ = value; }

    bool hasColorGamut() const { return has_color_gamut_; }
    ...
    bool hasContentType() const { return true; }
    const String& contentType() const { return member_content_type_; }
    void setContentType(const String& value);
    void setContentType(String&& value);

    bool hasFramerate() const { return true; }
    double framerate() const { return member_framerate_; }
    void setFramerate(double value) { member_framerate_ = value; }

    bool hasHdrMetadataType() const { return has_hdr_metadata_type_; }
    ...
    bool hasSpatialScalability() const { return has_spatial_scalability_; }
    ...
    bool hasTransferFunction() const { return has_transfer_function_; }
