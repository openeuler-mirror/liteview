...
public:
    ...
    static MediaSessionSeekToActionDetails* Create(v8::Isolate* isolate) { return MakeGarbageCollected<MediaSessionSeekToActionDetails>(isolate); }
    ...
    bool hasSeekTime() const { return true; }
    double seekTime() const { return member_seek_time_; }
    void setSeekTime(double value) { member_seek_time_ = value; }
