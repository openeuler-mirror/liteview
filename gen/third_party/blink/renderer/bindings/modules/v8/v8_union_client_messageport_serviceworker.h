...
public:
    ...
    bool IsClient() const { return content_type_ == ContentType::kClient; }
    ...
    bool IsMessagePort() const { return content_type_ == ContentType::kMessagePort; }
    ...
    bool IsServiceWorker() const { return content_type_ == ContentType::kServiceWorker; }
...
private:
    ...
    static constexpr const char* UnionNameInIDL() { return "(Client or MessagePort or ServiceWorker)"; }
