...
public:
    ...
    static absl::optional<V8GPUIndexFormat> Create(const String& value);
...
inline bool operator==(const V8GPUIndexFormat& lhs, V8GPUIndexFormat::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8GPUIndexFormat::Enum lhs, const V8GPUIndexFormat& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
