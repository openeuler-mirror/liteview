...
const char* V8ErrorCallback::NameInHeapSnapshot() const { return "V8ErrorCallback"; }
...
v8::Maybe<void> V8ErrorCallback::handleEvent(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, DOMException* arg1_error)
{
    ...
    if (!ToV8Traits<DOMException>::ToV8(script_state, arg1_error).ToLocal(&v8_arg1_error)) {
        return v8::Nothing<void>();
    }
