...
public:
    ...
    static absl::optional<V8PaymentComplete> Create(const String& value);
...
inline bool operator==(const V8PaymentComplete& lhs, V8PaymentComplete::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8PaymentComplete::Enum lhs, const V8PaymentComplete& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
