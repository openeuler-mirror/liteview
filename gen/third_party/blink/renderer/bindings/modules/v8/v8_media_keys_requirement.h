...
public:
    ...
    static absl::optional<V8MediaKeysRequirement> Create(const String& value);
...
inline bool operator==(const V8MediaKeysRequirement& lhs, V8MediaKeysRequirement::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8MediaKeysRequirement::Enum lhs, const V8MediaKeysRequirement& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
