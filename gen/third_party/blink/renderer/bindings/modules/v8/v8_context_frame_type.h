...
public:
    ...
    static absl::optional<V8ContextFrameType> Create(const String& value);
...
inline bool operator==(const V8ContextFrameType& lhs, V8ContextFrameType::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8ContextFrameType::Enum lhs, const V8ContextFrameType& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
