...
public:
    ...
    static BluetoothLEScanOptions* Create(v8::Isolate* isolate) { return MakeGarbageCollected<BluetoothLEScanOptions>(isolate); }
    ...
    bool hasAcceptAllAdvertisements() const { return true; }
    bool acceptAllAdvertisements() const { return member_accept_all_advertisements_; }
    void setAcceptAllAdvertisements(bool value) { member_accept_all_advertisements_ = value; }
    ...
    bool hasKeepRepeatedDevices() const { return true; }
    bool keepRepeatedDevices() const { return member_keep_repeated_devices_; }
    void setKeepRepeatedDevices(bool value) { member_keep_repeated_devices_ = value; }
