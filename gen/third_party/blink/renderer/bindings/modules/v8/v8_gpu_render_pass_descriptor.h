...
public:
    ...
    static GPURenderPassDescriptor* Create(v8::Isolate* isolate) { return MakeGarbageCollected<GPURenderPassDescriptor>(isolate); }
    ...
    bool hasColorAttachments() const { return true; }
    const HeapVector<Member<GPURenderPassColorAttachment>>& colorAttachments() const { return member_color_attachments_; }
    ...
    bool hasDepthStencilAttachment() const { return has_depth_stencil_attachment_; }
    ...
    bool hasMaxDrawCount() const { return has_max_draw_count_; }
    ...
    bool hasOcclusionQuerySet() const { return has_occlusion_query_set_; }
    ...
    const HeapVector<Member<GPURenderPassTimestampWrite>>& timestampWrites() const { return member_timestamp_writes_; }
    void setTimestampWrites(const HeapVector<Member<GPURenderPassTimestampWrite>>& value);
    void setTimestampWrites(HeapVector<Member<GPURenderPassTimestampWrite>>&& value);
...
private:
    ...
    HeapVector<Member<GPURenderPassTimestampWrite>> member_timestamp_writes_;
};
} // namespace blink
