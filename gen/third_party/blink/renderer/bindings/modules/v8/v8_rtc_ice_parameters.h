...
public:
    ...
    static RTCIceParameters* Create(v8::Isolate* isolate) { return MakeGarbageCollected<RTCIceParameters>(isolate); }
    ...
    bool hasUsernameFragment() const { return has_username_fragment_; }
