...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_URL_PATTERN_COMPONENT_RESULT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_URL_PATTERN_COMPONENT_RESULT_H_
...
class MODULES_EXPORT URLPatternComponentResult : public bindings::DictionaryBase {

public:
    static URLPatternComponentResult* Create() { return MakeGarbageCollected<URLPatternComponentResult>(); }
    static URLPatternComponentResult* Create(v8::Isolate* isolate) { return MakeGarbageCollected<URLPatternComponentResult>(isolate); }
...
#endif // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_URL_PATTERN_COMPONENT_RESULT_H_
