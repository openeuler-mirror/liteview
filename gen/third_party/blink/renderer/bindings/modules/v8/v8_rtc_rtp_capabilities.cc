...
void RTCRtpCapabilities::setCodecs(const HeapVector<Member<RTCRtpCodecCapability>>& value) { member_codecs_ = value; }

void RTCRtpCapabilities::setCodecs(HeapVector<Member<RTCRtpCodecCapability>>&& value) { member_codecs_ = std::move(value); }

void RTCRtpCapabilities::setHeaderExtensions(const HeapVector<Member<RTCRtpHeaderExtensionCapability>>& value) { member_header_extensions_ = value; }

void RTCRtpCapabilities::setHeaderExtensions(HeapVector<Member<RTCRtpHeaderExtensionCapability>>&& value) { member_header_extensions_ = std::move(value); }
...
void RTCRtpCapabilities::FillMembersFromV8Object(v8::Isolate* isolate, v8::Local<v8::Object> v8_dictionary, ExceptionState& exception_state)
{
    ...
    if (!bindings::GetDictionaryMemberFromV8Object<IDLSequence<RTCRtpCodecCapability>, is_required>(
    ...
    if (!bindings::GetDictionaryMemberFromV8Object<IDLSequence<RTCRtpHeaderExtensionCapability>, is_required>(
