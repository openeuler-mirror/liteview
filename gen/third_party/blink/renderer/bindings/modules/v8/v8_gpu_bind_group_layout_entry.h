...
public:
    ...
    static GPUBindGroupLayoutEntry* Create(v8::Isolate* isolate) { return MakeGarbageCollected<GPUBindGroupLayoutEntry>(isolate); }
    ...
    bool hasExternalTexture() const { return has_external_texture_; }
    ...
    bool hasSampler() const { return has_sampler_; }
    ...
    bool hasStorageTexture() const { return has_storage_texture_; }
    ...
    uint32_t visibility() const { return member_visibility_; }
    void setVisibility(uint32_t value) { member_visibility_ = value; }
