...
public:
    ...
    static absl::optional<V8WebGLPowerPreference> Create(const String& value);
...
inline bool operator==(const V8WebGLPowerPreference& lhs, V8WebGLPowerPreference::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8WebGLPowerPreference::Enum lhs, const V8WebGLPowerPreference& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
