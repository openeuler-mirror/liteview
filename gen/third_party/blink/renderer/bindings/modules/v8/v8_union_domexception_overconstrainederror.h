...
public:
    ...
    bool IsDOMException() const { return content_type_ == ContentType::kDOMException; }
    DOMException* GetAsDOMException() const
    {
        DCHECK_EQ(content_type_, ContentType::kDOMException);
        return member_dom_exception_;
    }
    ...
    bool IsOverconstrainedError() const { return content_type_ == ContentType::kOverconstrainedError; }
    OverconstrainedError* GetAsOverconstrainedError() const
    {
        DCHECK_EQ(content_type_, ContentType::kOverconstrainedError);
        return member_overconstrained_error_;
    }
...
private:
    ...
    static constexpr const char* UnionNameInIDL() { return "(DOMException or OverconstrainedError)"; }
