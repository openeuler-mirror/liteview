...
public:
    ...
    static PublicKeyCredentialDescriptor* Create(v8::Isolate* isolate) { return MakeGarbageCollected<PublicKeyCredentialDescriptor>(isolate); }
    ...
    V8UnionArrayBufferOrArrayBufferView* id() const { return member_id_; }
