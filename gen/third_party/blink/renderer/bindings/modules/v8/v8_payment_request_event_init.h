...
public:
    ...
    static PaymentRequestEventInit* Create(v8::Isolate* isolate) { return MakeGarbageCollected<PaymentRequestEventInit>(isolate); }
    ...
    bool hasInstrumentKey() const { return has_instrument_key_; }
    ...
    bool hasPaymentOptions() const { return has_payment_options_; }
    ...
    bool hasPaymentRequestId() const { return has_payment_request_id_; }
    ...
    bool hasPaymentRequestOrigin() const { return has_payment_request_origin_; }
    ...
    bool hasTopOrigin() const { return has_top_origin_; }
