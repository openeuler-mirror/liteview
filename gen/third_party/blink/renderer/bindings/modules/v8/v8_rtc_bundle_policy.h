...
public:
    ...
    static absl::optional<V8RTCBundlePolicy> Create(const String& value);
...
inline bool operator==(const V8RTCBundlePolicy& lhs, V8RTCBundlePolicy::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8RTCBundlePolicy::Enum lhs, const V8RTCBundlePolicy& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
