...
public:
    static AdProperties* Create() { return MakeGarbageCollected<AdProperties>(); }
    static AdProperties* Create(v8::Isolate* isolate) { return MakeGarbageCollected<AdProperties>(isolate); }
    ...
    bool hasAdtype() const { return has_adtype_; }
    ...
    bool hasBidFloor() const { return has_bid_floor_; }
    ...
    bool hasSlot() const { return has_slot_; }
