...
public:
    ...
    static absl::optional<V8GPUErrorFilter> Create(const String& value);
...
inline bool operator==(const V8GPUErrorFilter& lhs, V8GPUErrorFilter::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8GPUErrorFilter::Enum lhs, const V8GPUErrorFilter& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
