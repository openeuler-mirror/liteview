...
public:
    ...
    bool IsHTMLFormElement() const { return content_type_ == ContentType::kHTMLFormElement; }
    ...
    bool IsPasswordCredentialData() const { return content_type_ == ContentType::kPasswordCredentialData; }
...
private:
    ...
    static constexpr const char* UnionNameInIDL() { return "(HTMLFormElement or PasswordCredentialData)"; }
