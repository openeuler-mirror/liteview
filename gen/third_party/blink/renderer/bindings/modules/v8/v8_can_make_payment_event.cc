...
static_assert(std::is_same<decltype(&CanMakePaymentEvent::HasPendingActivity), decltype(&ScriptWrappable::HasPendingActivity)>::value,
...
void ConstructorCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    const char* const class_like_name = "CanMakePaymentEvent";
    ...
    auto&& return_value = CanMakePaymentEvent::Create(script_state, arg1_type, arg2_event_init_dict);
