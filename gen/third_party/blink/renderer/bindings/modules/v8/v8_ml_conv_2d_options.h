...
class MODULES_EXPORT MLConv2dOptions : public bindings::DictionaryBase {

public:
    static MLConv2dOptions* Create() { return MakeGarbageCollected<MLConv2dOptions>(); }
    static MLConv2dOptions* Create(v8::Isolate* isolate) { return MakeGarbageCollected<MLConv2dOptions>(isolate); }
    ...
    MLOperator* activation() const
    {
        DCHECK(hasActivation());
        return member_activation_;
    }
    MLOperator* getActivationOr(MLOperator* fallback_value) const
    {
        if (!hasActivation()) {
    ...
    void setActivation(MLOperator* value)
    {
        member_activation_ = value;
        has_activation_ = true;
        DCHECK(member_activation_);
    }
    ...
    bool hasFilterLayout() const { return true; }
    V8MLConv2dFilterOperandLayout filterLayout() const { return member_filter_layout_; }
    void setFilterLayout(V8MLConv2dFilterOperandLayout value) { member_filter_layout_ = value; }
    void setFilterLayout(V8MLConv2dFilterOperandLayout::Enum value) { member_filter_layout_ = V8MLConv2dFilterOperandLayout(value); }

    bool hasGroups() const { return true; }
    int32_t groups() const { return member_groups_; }
    void setGroups(int32_t value) { member_groups_ = value; }

    bool hasInputLayout() const { return true; }
    V8MLInputOperandLayout inputLayout() const { return member_input_layout_; }
    void setInputLayout(V8MLInputOperandLayout value) { member_input_layout_ = value; }
    void setInputLayout(V8MLInputOperandLayout::Enum value) { member_input_layout_ = V8MLInputOperandLayout(value); }
    ...
    void setFilterLayout(const String& value) { member_filter_layout_ = V8MLConv2dFilterOperandLayout::Create(value).value(); }
    void setInputLayout(const String& value) { member_input_layout_ = V8MLInputOperandLayout::Create(value).value(); }
...
private:
    ...
    Member<MLOperator> member_activation_;
