...
class MODULES_EXPORT XRDepthStateInit : public bindings::DictionaryBase {

public:
    static XRDepthStateInit* Create() { return MakeGarbageCollected<XRDepthStateInit>(); }
    static XRDepthStateInit* Create(v8::Isolate* isolate) { return MakeGarbageCollected<XRDepthStateInit>(isolate); }
    ...
    bool hasDataFormatPreference() const { return true; }
    const Vector<V8XRDepthDataFormat>& dataFormatPreference() const { return member_data_format_preference_; }
    ...
    bool hasUsagePreference() const { return true; }
    const Vector<V8XRDepthUsage>& usagePreference() const { return member_usage_preference_; }
