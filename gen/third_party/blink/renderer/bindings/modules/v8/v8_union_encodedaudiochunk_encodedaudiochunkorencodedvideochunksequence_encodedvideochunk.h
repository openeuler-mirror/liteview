...
public:
    ...
    bool IsEncodedAudioChunk() const { return content_type_ == ContentType::kEncodedAudioChunk; }
    ...
    bool IsEncodedAudioChunkOrEncodedVideoChunkSequence() const { return content_type_ == ContentType::kEncodedAudioChunkOrEncodedVideoChunkSequence; }
    ...
    bool IsEncodedVideoChunk() const { return content_type_ == ContentType::kEncodedVideoChunk; }
    ...
    bool IsV8UnionEncodedAudioChunkOrEncodedVideoChunk() const { return content_type_ == ContentType::kEncodedAudioChunk || content_type_ == ContentType::kEncodedVideoChunk; }
...
private:
    ...
    static constexpr const char* UnionNameInIDL() { return "(EncodedAudioChunk or EncodedVideoChunk or sequence<(EncodedAudioChunk or EncodedVideoChunk)>)"; }
