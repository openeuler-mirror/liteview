...
class MODULES_EXPORT V8UnionBlobOrHTMLCanvasElementOrHTMLImageElementOrHTMLVideoElementOrImageBitmapOrImageDataOrOffscreenCanvasOrSVGImageElementOrVideoFrame final
    : public bindings::UnionBase {

public:
    // The type of the content value of this IDL union.
    enum class ContentType { kBlob, kHTMLCanvasElement, kHTMLImageElement, kHTMLVideoElement, kImageBitmap, kImageData, kOffscreenCanvas, kSVGImageElement, kVideoFrame };
    ...
    explicit V8UnionBlobOrHTMLCanvasElementOrHTMLImageElementOrHTMLVideoElementOrImageBitmapOrImageDataOrOffscreenCanvasOrSVGImageElementOrVideoFrame(Blob* value)
        : content_type_(ContentType::kBlob)
        , member_blob_(value)
    {
        DCHECK(value);
    }
    explicit V8UnionBlobOrHTMLCanvasElementOrHTMLImageElementOrHTMLVideoElementOrImageBitmapOrImageDataOrOffscreenCanvasOrSVGImageElementOrVideoFrame(HTMLCanvasElement* value)
        : content_type_(ContentType::kHTMLCanvasElement)
        , member_html_canvas_element_(value)
    {
        DCHECK(value);
    }
    explicit V8UnionBlobOrHTMLCanvasElementOrHTMLImageElementOrHTMLVideoElementOrImageBitmapOrImageDataOrOffscreenCanvasOrSVGImageElementOrVideoFrame(HTMLImageElement* value)
        : content_type_(ContentType::kHTMLImageElement)
        , member_html_image_element_(value)
    {
        DCHECK(value);
    }
    explicit V8UnionBlobOrHTMLCanvasElementOrHTMLImageElementOrHTMLVideoElementOrImageBitmapOrImageDataOrOffscreenCanvasOrSVGImageElementOrVideoFrame(HTMLVideoElement* value)
        : content_type_(ContentType::kHTMLVideoElement)
        , member_html_video_element_(value)
    {
        DCHECK(value);
    }
    explicit V8UnionBlobOrHTMLCanvasElementOrHTMLImageElementOrHTMLVideoElementOrImageBitmapOrImageDataOrOffscreenCanvasOrSVGImageElementOrVideoFrame(ImageBitmap* value)
        : content_type_(ContentType::kImageBitmap)
        , member_image_bitmap_(value)
    {
        DCHECK(value);
    }
    explicit V8UnionBlobOrHTMLCanvasElementOrHTMLImageElementOrHTMLVideoElementOrImageBitmapOrImageDataOrOffscreenCanvasOrSVGImageElementOrVideoFrame(ImageData* value)
        : content_type_(ContentType::kImageData)
        , member_image_data_(value)
    {
        DCHECK(value);
    }
    explicit V8UnionBlobOrHTMLCanvasElementOrHTMLImageElementOrHTMLVideoElementOrImageBitmapOrImageDataOrOffscreenCanvasOrSVGImageElementOrVideoFrame(OffscreenCanvas* value)
        : content_type_(ContentType::kOffscreenCanvas)
        , member_offscreen_canvas_(value)
    {
        DCHECK(value);
    }
    explicit V8UnionBlobOrHTMLCanvasElementOrHTMLImageElementOrHTMLVideoElementOrImageBitmapOrImageDataOrOffscreenCanvasOrSVGImageElementOrVideoFrame(SVGImageElement* value)
        : content_type_(ContentType::kSVGImageElement)
        , member_svg_image_element_(value)
    {
        DCHECK(value);
    }
    explicit V8UnionBlobOrHTMLCanvasElementOrHTMLImageElementOrHTMLVideoElementOrImageBitmapOrImageDataOrOffscreenCanvasOrSVGImageElementOrVideoFrame(VideoFrame* value)
    ...
    bool IsHTMLVideoElement() const { return content_type_ == ContentType::kHTMLVideoElement; }
    ...
    bool IsImageData() const { return content_type_ == ContentType::kImageData; }
    ImageData* GetAsImageData() const
    {
        DCHECK_EQ(content_type_, ContentType::kImageData);
        return member_image_data_;
    }
    ...
    bool IsSVGImageElement() const { return content_type_ == ContentType::kSVGImageElement; }
    ...
    bool IsVideoFrame() const { return content_type_ == ContentType::kVideoFrame; }
    ...
    bool IsV8UnionHTMLVideoElementOrVideoFrame() const { return content_type_ == ContentType::kHTMLVideoElement || content_type_ == ContentType::kVideoFrame; }
