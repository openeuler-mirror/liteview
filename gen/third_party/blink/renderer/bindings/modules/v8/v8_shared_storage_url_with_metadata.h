...
public:
    static SharedStorageUrlWithMetadata* Create() { return MakeGarbageCollected<SharedStorageUrlWithMetadata>(); }
    static SharedStorageUrlWithMetadata* Create(v8::Isolate* isolate) { return MakeGarbageCollected<SharedStorageUrlWithMetadata>(isolate); }
    ...
    bool hasReportingMetadata() const { return !member_reporting_metadata_.IsEmpty(); }
