...
class MODULES_EXPORT GPUBlendState : public bindings::DictionaryBase {

public:
    static GPUBlendState* Create() { return MakeGarbageCollected<GPUBlendState>(); }
    static GPUBlendState* Create(v8::Isolate* isolate) { return MakeGarbageCollected<GPUBlendState>(isolate); }
    ...
    GPUBlendComponent* alpha() const { return member_alpha_; }
    ...
    GPUBlendComponent* color() const { return member_color_; }
