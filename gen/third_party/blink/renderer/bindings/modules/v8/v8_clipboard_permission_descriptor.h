...
public:
    ...
    static ClipboardPermissionDescriptor* Create(v8::Isolate* isolate) { return MakeGarbageCollected<ClipboardPermissionDescriptor>(isolate); }
    ...
    bool hasAllowWithoutGesture() const { return true; }
    bool allowWithoutGesture() const { return member_allow_without_gesture_; }
    void setAllowWithoutGesture(bool value) { member_allow_without_gesture_ = value; }

    bool hasAllowWithoutSanitization() const { return true; }
    bool allowWithoutSanitization() const { return member_allow_without_sanitization_; }
    void setAllowWithoutSanitization(bool value) { member_allow_without_sanitization_ = value; }
