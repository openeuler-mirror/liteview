...
class MODULES_EXPORT GPUBufferBinding : public bindings::DictionaryBase {

public:
    static GPUBufferBinding* Create() { return MakeGarbageCollected<GPUBufferBinding>(); }
    static GPUBufferBinding* Create(v8::Isolate* isolate) { return MakeGarbageCollected<GPUBufferBinding>(isolate); }
    ...
    GPUBuffer* buffer() const { return member_buffer_; }
