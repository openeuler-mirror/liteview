...
void ExtendableEventInit::Trace(Visitor* visitor) const { EventInit::Trace(visitor); }
...
const base::span<const v8::Eternal<v8::Name>> ExtendableEventInit::GetV8OwnMemberNames(v8::Isolate* isolate) { return {}; }
