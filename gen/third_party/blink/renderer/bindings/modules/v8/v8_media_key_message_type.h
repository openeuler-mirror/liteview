...
public:
    ...
    static absl::optional<V8MediaKeyMessageType> Create(const String& value);
...
inline bool operator==(const V8MediaKeyMessageType& lhs, V8MediaKeyMessageType::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8MediaKeyMessageType::Enum lhs, const V8MediaKeyMessageType& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
