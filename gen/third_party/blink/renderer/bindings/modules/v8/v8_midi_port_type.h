...
public:
    ...
    static absl::optional<V8MIDIPortType> Create(const String& value);
...
inline bool operator==(const V8MIDIPortType& lhs, V8MIDIPortType::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8MIDIPortType::Enum lhs, const V8MIDIPortType& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
