...
static_assert(std::is_same<decltype(&XRInputSourceArray::HasPendingActivity), decltype(&ScriptWrappable::HasPendingActivity)>::value,
...
void V8XRInputSourceArray::IndexedPropertySetterCallback(uint32_t index, v8::Local<v8::Value> v8_property_value, const v8::PropertyCallbackInfo<v8::Value>& info)
{
    ...
    if (info.ShouldThrowOnError()) {
        ExceptionState exception_state(info.GetIsolate(), ExceptionContext::Context::kIndexedPropertySet, "XRInputSourceArray");
        exception_state.ThrowTypeError("Indexed property setter is not supported.");
    }
}

void V8XRInputSourceArray::IndexedPropertyDeleterCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Boolean>& info)
{
    ...
    if (is_supported and info.ShouldThrowOnError()) {
        ExceptionState exception_state(info.GetIsolate(), ExceptionContext::Context::kIndexedPropertyDelete, "XRInputSourceArray");
        exception_state.ThrowTypeError("Index property deleter is not supported.");
    }
}

void V8XRInputSourceArray::IndexedPropertyDefinerCallback(uint32_t index, const v8::PropertyDescriptor& v8_property_desc, const v8::PropertyCallbackInfo<v8::Value>& info)
{
...
void V8XRInputSourceArray::IndexedPropertyDescriptorCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info)
{
...
void V8XRInputSourceArray::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template)
{
    ...
    instance_object_template->SetHandler(
        v8::IndexedPropertyHandlerConfiguration(V8XRInputSourceArray::IndexedPropertyGetterCallback, V8XRInputSourceArray::IndexedPropertySetterCallback,
            nullptr, // query
            V8XRInputSourceArray::IndexedPropertyDeleterCallback, V8XRInputSourceArray::IndexedPropertyEnumeratorCallback, V8XRInputSourceArray::IndexedPropertyDefinerCallback,
            V8XRInputSourceArray::IndexedPropertyDescriptorCallback, v8::Local<v8::Value>(), v8::PropertyHandlerFlags::kHasNoSideEffect));
