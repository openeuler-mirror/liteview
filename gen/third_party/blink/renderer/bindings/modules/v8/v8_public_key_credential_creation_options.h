...
public:
    ...
    static PublicKeyCredentialCreationOptions* Create(v8::Isolate* isolate) { return MakeGarbageCollected<PublicKeyCredentialCreationOptions>(isolate); }
    ...
    bool hasAttestation() const { return has_attestation_; }
    ...
    bool hasExcludeCredentials() const { return true; }
    const HeapVector<Member<PublicKeyCredentialDescriptor>>& excludeCredentials() const { return member_exclude_credentials_; }
    ...
    bool hasPubKeyCredParams() const { return true; }
    const HeapVector<Member<PublicKeyCredentialParameters>>& pubKeyCredParams() const { return member_pub_key_cred_params_; }
    ...
    bool hasRp() const { return true; }
    PublicKeyCredentialRpEntity* rp() const { return member_rp_; }
    ...
    bool hasUser() const { return true; }
    PublicKeyCredentialUserEntity* user() const { return member_user_; }
