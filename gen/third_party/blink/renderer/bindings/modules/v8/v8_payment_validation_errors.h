...
class MODULES_EXPORT PaymentValidationErrors : public bindings::DictionaryBase {

public:
    static PaymentValidationErrors* Create() { return MakeGarbageCollected<PaymentValidationErrors>(); }
    static PaymentValidationErrors* Create(v8::Isolate* isolate) { return MakeGarbageCollected<PaymentValidationErrors>(isolate); }
    ...
    bool hasPayer() const { return has_payer_; }
    PayerErrors* payer() const
    {
        DCHECK(hasPayer());
        return member_payer_;
    }
