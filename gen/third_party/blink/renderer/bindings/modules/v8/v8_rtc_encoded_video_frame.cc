...
bool V8RTCEncodedVideoFrame::IsExposed(ExecutionContext* execution_context) { return execution_context->IsWindow() || execution_context->IsDedicatedWorkerGlobalScope(); }
...
static_assert(std::is_same<decltype(&RTCEncodedVideoFrame::HasPendingActivity), decltype(&ScriptWrappable::HasPendingActivity)>::value,
    "RTCEncodedVideoFrame is overriding hasPendingActivity() without "
    "[ActiveScriptWrappable] extended attribute.");
...
void TypeAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    RTCEncodedVideoFrame* blink_receiver = V8RTCEncodedVideoFrame::ToWrappableUnsafe(v8_receiver);
...
void DataAttributeSetCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    const char* const class_like_name = "RTCEncodedVideoFrame";
