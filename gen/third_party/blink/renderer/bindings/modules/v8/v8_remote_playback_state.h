...
inline bool operator==(const V8RemotePlaybackState& lhs, V8RemotePlaybackState::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8RemotePlaybackState::Enum lhs, const V8RemotePlaybackState& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
