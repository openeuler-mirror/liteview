...
public:
    ...
    static absl::optional<V8USBRecipient> Create(const String& value);
...
inline bool operator==(const V8USBRecipient& lhs, V8USBRecipient::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8USBRecipient::Enum lhs, const V8USBRecipient& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
