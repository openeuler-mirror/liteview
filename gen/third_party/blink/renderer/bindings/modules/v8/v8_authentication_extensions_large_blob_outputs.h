...
public:
    static AuthenticationExtensionsLargeBlobOutputs* Create() { return MakeGarbageCollected<AuthenticationExtensionsLargeBlobOutputs>(); }
    static AuthenticationExtensionsLargeBlobOutputs* Create(v8::Isolate* isolate) { return MakeGarbageCollected<AuthenticationExtensionsLargeBlobOutputs>(isolate); }
    ...
    bool hasBlob() const { return has_blob_; }
