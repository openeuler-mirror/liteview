...
public:
    ...
    bool IsConstrainLongRange() const { return content_type_ == ContentType::kConstrainLongRange; }
...
private:
    ...
    static constexpr const char* UnionNameInIDL() { return "(ConstrainLongRange or long)"; }
