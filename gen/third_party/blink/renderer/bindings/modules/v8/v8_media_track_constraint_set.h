...
public:
    ...
    static MediaTrackConstraintSet* Create(v8::Isolate* isolate) { return MakeGarbageCollected<MediaTrackConstraintSet>(isolate); }
    ...
    bool hasDisplaySurface() const { return has_display_surface_; }
    ...
    bool hasMandatory() const { return !member_mandatory_.IsEmpty(); }
