...
public:
    ...
    static DynamicsCompressorOptions* Create(v8::Isolate* isolate) { return MakeGarbageCollected<DynamicsCompressorOptions>(isolate); }
    ...
    bool hasAttack() const { return true; }
    float attack() const { return member_attack_; }
    void setAttack(float value) { member_attack_ = value; }

    bool hasKnee() const { return true; }
    float knee() const { return member_knee_; }
    void setKnee(float value) { member_knee_ = value; }

    bool hasRatio() const { return true; }
    float ratio() const { return member_ratio_; }
    void setRatio(float value) { member_ratio_ = value; }

    bool hasRelease() const { return true; }
    float release() const { return member_release_; }
    void setRelease(float value) { member_release_ = value; }

    bool hasThreshold() const { return true; }
    float threshold() const { return member_threshold_; }
    void setThreshold(float value) { member_threshold_ = value; }
