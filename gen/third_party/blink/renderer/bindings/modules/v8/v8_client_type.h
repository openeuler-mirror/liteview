...
inline bool operator==(const V8ClientType& lhs, V8ClientType::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8ClientType::Enum lhs, const V8ClientType& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
