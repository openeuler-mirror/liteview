...
public:
    static GPUImageCopyTextureTagged* Create() { return MakeGarbageCollected<GPUImageCopyTextureTagged>(); }
    static GPUImageCopyTextureTagged* Create(v8::Isolate* isolate) { return MakeGarbageCollected<GPUImageCopyTextureTagged>(isolate); }
