...
public:
    ...
    static absl::optional<V8BinaryType> Create(const String& value);
...
inline bool operator==(const V8BinaryType& lhs, V8BinaryType::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8BinaryType::Enum lhs, const V8BinaryType& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
