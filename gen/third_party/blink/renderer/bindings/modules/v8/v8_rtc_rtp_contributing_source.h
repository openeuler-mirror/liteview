...
public:
    ...
    static RTCRtpContributingSource* Create(v8::Isolate* isolate) { return MakeGarbageCollected<RTCRtpContributingSource>(isolate); }
    ...
    bool hasRtpTimestamp() const { return true; }
    uint32_t rtpTimestamp() const { return member_rtp_timestamp_; }
    void setRtpTimestamp(uint32_t value) { member_rtp_timestamp_ = value; }

    bool hasSenderCaptureTimeOffset() const { return has_sender_capture_time_offset_; }
    ...
    uint32_t source() const { return member_source_; }
    void setSource(uint32_t value) { member_source_ = value; }

    bool hasTimestamp() const { return true; }
    double timestamp() const { return member_timestamp_; }
    void setTimestamp(double value) { member_timestamp_ = value; }
