...
public:
    ...
    static absl::optional<V8ScreenIdleState> Create(const String& value);
...
inline bool operator==(const V8ScreenIdleState& lhs, V8ScreenIdleState::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8ScreenIdleState::Enum lhs, const V8ScreenIdleState& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
