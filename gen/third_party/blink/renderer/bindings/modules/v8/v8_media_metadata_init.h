...
public:
    ...
    static MediaMetadataInit* Create(v8::Isolate* isolate) { return MakeGarbageCollected<MediaMetadataInit>(isolate); }
    ...
    bool hasAlbum() const { return true; }
    const String& album() const { return member_album_; }
    void setAlbum(const String& value);
    void setAlbum(String&& value);

    bool hasArtist() const { return true; }
    const String& artist() const { return member_artist_; }
    void setArtist(const String& value);
    void setArtist(String&& value);

    bool hasArtwork() const { return true; }
    const HeapVector<Member<MediaImage>>& artwork() const { return member_artwork_; }
