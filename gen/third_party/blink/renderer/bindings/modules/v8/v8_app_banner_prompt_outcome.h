...
public:
    ...
    static absl::optional<V8AppBannerPromptOutcome> Create(const String& value);
...
inline bool operator==(const V8AppBannerPromptOutcome& lhs, V8AppBannerPromptOutcome::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8AppBannerPromptOutcome::Enum lhs, const V8AppBannerPromptOutcome& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
