...
public:
    ...
    static PushSubscriptionChangeEventInit* Create(v8::Isolate* isolate) { return MakeGarbageCollected<PushSubscriptionChangeEventInit>(isolate); }
    ...
    bool hasNewSubscription() const { return has_new_subscription_; }
    ...
    bool hasOldSubscription() const { return has_old_subscription_; }
