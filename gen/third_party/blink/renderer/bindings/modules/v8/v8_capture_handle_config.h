...
class MODULES_EXPORT CaptureHandleConfig : public bindings::DictionaryBase {

public:
    static CaptureHandleConfig* Create() { return MakeGarbageCollected<CaptureHandleConfig>(); }
    static CaptureHandleConfig* Create(v8::Isolate* isolate) { return MakeGarbageCollected<CaptureHandleConfig>(isolate); }
    ...
    bool hasExposeOrigin() const { return true; }
    bool exposeOrigin() const { return member_expose_origin_; }
    void setExposeOrigin(bool value) { member_expose_origin_ = value; }

    bool hasHandle() const { return true; }
    const String& handle() const { return member_handle_; }
    void setHandle(const String& value);
    void setHandle(String&& value);

    bool hasPermittedOrigins() const { return true; }
    const Vector<String>& permittedOrigins() const { return member_permitted_origins_; }
