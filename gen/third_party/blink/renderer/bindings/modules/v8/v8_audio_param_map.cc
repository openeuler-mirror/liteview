...
bool V8AudioParamMap::IsExposed(ExecutionContext* execution_context) { return execution_context->IsWindow(); }
...
static_assert(std::is_same<decltype(&AudioParamMap::HasPendingActivity), decltype(&ScriptWrappable::HasPendingActivity)>::value,
