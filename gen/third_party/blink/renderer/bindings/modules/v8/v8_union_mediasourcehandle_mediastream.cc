...
V8UnionMediaSourceHandleOrMediaStream* V8UnionMediaSourceHandleOrMediaStream::Create(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, ExceptionState& exception_state)
{
    if (V8MediaStream::HasInstance(isolate, v8_value)) {
        auto&& blink_value = V8MediaStream::ToWrappableUnsafe(v8_value.As<v8::Object>());
    ...
    if (V8MediaSourceHandle::HasInstance(isolate, v8_value)) {
        auto&& blink_value = V8MediaSourceHandle::ToWrappableUnsafe(v8_value.As<v8::Object>());
        return MakeGarbageCollected<V8UnionMediaSourceHandleOrMediaStream>(blink_value);
    }
...
v8::MaybeLocal<v8::Value> V8UnionMediaSourceHandleOrMediaStream::ToV8Value(ScriptState* script_state) const
{
    switch (content_type_) {
    case ContentType::kMediaSourceHandle: {
        return ToV8Traits<MediaSourceHandleImpl>::ToV8(script_state, member_media_source_handle_);
    }
    case ContentType::kMediaStream: {
        return ToV8Traits<MediaStream>::ToV8(script_state, member_media_stream_);
    }
    }
