...
public:
    ...
    static FetchEventInit* Create(v8::Isolate* isolate) { return MakeGarbageCollected<FetchEventInit>(isolate); }
    ...
    bool hasIsReload() const { return true; }
    bool isReload() const { return member_is_reload_; }
    void setIsReload(bool value) { member_is_reload_ = value; }

    bool hasRequest() const { return true; }
    Request* request() const { return member_request_; }
    ...
    bool hasResultingClientId() const { return true; }
    const String& resultingClientId() const { return member_resulting_client_id_; }
