...
public:
    static WebTransportHash* Create() { return MakeGarbageCollected<WebTransportHash>(); }
    static WebTransportHash* Create(v8::Isolate* isolate) { return MakeGarbageCollected<WebTransportHash>(isolate); }
    ...
    bool hasAlgorithm() const { return has_algorithm_; }
