...
class MODULES_EXPORT BarcodeDetectorOptions : public bindings::DictionaryBase {

public:
    static BarcodeDetectorOptions* Create() { return MakeGarbageCollected<BarcodeDetectorOptions>(); }
    static BarcodeDetectorOptions* Create(v8::Isolate* isolate) { return MakeGarbageCollected<BarcodeDetectorOptions>(isolate); }
