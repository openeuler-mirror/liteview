...
public:
    static HandwritingRecognizerQueryResult* Create() { return MakeGarbageCollected<HandwritingRecognizerQueryResult>(); }
    static HandwritingRecognizerQueryResult* Create(v8::Isolate* isolate) { return MakeGarbageCollected<HandwritingRecognizerQueryResult>(isolate); }
    ...
    bool hasTextAlternatives() const { return has_text_alternatives_; }
    ...
    bool hasTextSegmentation() const { return has_text_segmentation_; }
