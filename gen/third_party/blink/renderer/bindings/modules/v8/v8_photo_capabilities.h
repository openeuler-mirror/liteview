...
public:
    static PhotoCapabilities* Create() { return MakeGarbageCollected<PhotoCapabilities>(); }
    static PhotoCapabilities* Create(v8::Isolate* isolate) { return MakeGarbageCollected<PhotoCapabilities>(isolate); }
    ...
    bool hasFillLightMode() const { return has_fill_light_mode_; }
