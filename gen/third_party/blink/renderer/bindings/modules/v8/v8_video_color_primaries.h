...
public:
    enum class Enum : enum_int_t { kBt709, kBt470Bg, kSmpte170M };
...
inline bool operator==(const V8VideoColorPrimaries& lhs, V8VideoColorPrimaries::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8VideoColorPrimaries::Enum lhs, const V8VideoColorPrimaries& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
