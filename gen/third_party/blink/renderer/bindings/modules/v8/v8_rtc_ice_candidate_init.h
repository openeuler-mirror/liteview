...
public:
    ...
    static RTCIceCandidateInit* Create(v8::Isolate* isolate) { return MakeGarbageCollected<RTCIceCandidateInit>(isolate); }
    ...
    bool hasCandidate() const { return true; }
    const String& candidate() const { return member_candidate_; }
    void setCandidate(const String& value);
    void setCandidate(String&& value);

    bool hasSdpMLineIndex() const { return true; }
    const absl::optional<uint16_t>& sdpMLineIndex() const { return member_sdp_m_line_index_; }
    void setSdpMLineIndex(const absl::optional<uint16_t>& value) { member_sdp_m_line_index_ = value; }
    void setSdpMLineIndex(uint16_t value) { member_sdp_m_line_index_ = value; }

    bool hasSdpMid() const { return true; }
    const String& sdpMid() const { return member_sdp_mid_; }
    void setSdpMid(const String& value);
    void setSdpMid(String&& value);

    bool hasUsernameFragment() const { return true; }
    const String& usernameFragment() const { return member_username_fragment_; }
    void setUsernameFragment(const String& value);
    void setUsernameFragment(String&& value);
    // Obsolete accessor functions
    bool hasSdpMLineIndexNonNull() const { return hasSdpMLineIndex() && sdpMLineIndex().has_value(); }
