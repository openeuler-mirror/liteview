...
public:
    ...
    static PushSubscriptionOptionsInit* Create(v8::Isolate* isolate) { return MakeGarbageCollected<PushSubscriptionOptionsInit>(isolate); }
    ...
    bool hasApplicationServerKey() const { return true; }
    V8UnionArrayBufferOrArrayBufferViewOrString* applicationServerKey() const { return member_application_server_key_; }
    void setApplicationServerKey(V8UnionArrayBufferOrArrayBufferViewOrString* value) { member_application_server_key_ = value; }

    bool hasUserVisibleOnly() const { return true; }
    bool userVisibleOnly() const { return member_user_visible_only_; }
    void setUserVisibleOnly(bool value) { member_user_visible_only_ = value; }
