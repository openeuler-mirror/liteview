...
inline bool operator==(const V8ColorGamut& lhs, V8ColorGamut::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8ColorGamut::Enum lhs, const V8ColorGamut& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
