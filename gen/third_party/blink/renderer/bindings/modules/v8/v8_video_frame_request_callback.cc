...
const char* V8VideoFrameRequestCallback::NameInHeapSnapshot() const { return "V8VideoFrameRequestCallback"; }

v8::Maybe<void> V8VideoFrameRequestCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, double arg1_time, const VideoFrameMetadata* arg2_metadata)
{
    ...
    if (!ToV8Traits<VideoFrameMetadata>::ToV8(script_state, arg2_metadata).ToLocal(&v8_arg2_metadata)) {
        return v8::Nothing<void>();
    }
...
v8::Maybe<void> V8VideoFrameRequestCallback::Construct(double arg1_time, const VideoFrameMetadata* arg2_metadata)
{
    const char* const class_like_name = "VideoFrameRequestCallback";
...
void V8VideoFrameRequestCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, double arg1_time, const VideoFrameMetadata* arg2_metadata)
{
    v8::Isolate* isolate = GetIsolate();
