...
void XRTransientInputHitTestOptionsInit::setProfile(const String& value) { member_profile_ = value; }

void XRTransientInputHitTestOptionsInit::setProfile(String&& value) { member_profile_ = std::move(value); }
...
bool XRTransientInputHitTestOptionsInit::FillV8ObjectWithMembers(ScriptState* script_state, v8::Local<v8::Object> v8_dictionary) const
{
    ...
    if (hasProfile()) {
        if (!ToV8Traits<IDLString>::ToV8(script_state, member_profile_).ToLocal(&v8_value)) {
            return false;
        }
...
void XRTransientInputHitTestOptionsInit::FillMembersFromV8Object(v8::Isolate* isolate, v8::Local<v8::Object> v8_dictionary, ExceptionState& exception_state)
{
    ...
    exception_context_scope.ChangePropertyNameAsOptimizationHack("profile");
    constexpr bool is_required = true;
    bool fallback_presence_var;
    if (!bindings::GetDictionaryMemberFromV8Object<IDLString, is_required>(
            isolate, current_context, v8_dictionary, v8_own_member_names[2].Get(isolate), fallback_presence_var, member_profile_, try_block, exception_state)) {
        return;
    }
}
