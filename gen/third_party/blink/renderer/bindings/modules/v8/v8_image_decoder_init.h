...
public:
    ...
    static ImageDecoderInit* Create(v8::Isolate* isolate) { return MakeGarbageCollected<ImageDecoderInit>(isolate); }
    ...
    V8UnionArrayBufferAllowSharedOrArrayBufferViewAllowSharedOrReadableStream* data() const { return member_data_; }
    ...
    bool hasDesiredHeight() const { return has_desired_height_; }
    ...
    bool hasDesiredWidth() const { return has_desired_width_; }
    ...
    bool hasPreferAnimation() const { return has_prefer_animation_; }
