...
public:
    ...
    static OscillatorOptions* Create(v8::Isolate* isolate) { return MakeGarbageCollected<OscillatorOptions>(isolate); }
    ...
    V8OscillatorType type() const { return member_type_; }
    void setType(V8OscillatorType value) { member_type_ = value; }
    void setType(V8OscillatorType::Enum value) { member_type_ = V8OscillatorType(value); }
    // Obsolete accessor functions
    void setType(const String& value) { member_type_ = V8OscillatorType::Create(value).value(); }
