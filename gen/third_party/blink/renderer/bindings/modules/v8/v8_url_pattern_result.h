...
public:
    static URLPatternResult* Create() { return MakeGarbageCollected<URLPatternResult>(); }
    static URLPatternResult* Create(v8::Isolate* isolate) { return MakeGarbageCollected<URLPatternResult>(isolate); }
    ...
    bool hasInputs() const { return has_inputs_; }
