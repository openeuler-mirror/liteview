...
public:
    ...
    bool IsGPUExtent3DDict() const { return content_type_ == ContentType::kGPUExtent3DDict; }
...
private:
    ...
    static constexpr const char* UnionNameInIDL() { return "(GPUExtent3DDict or sequence<GPUIntegerCoordinate>)"; }
