...
public:
    static HandwritingPoint* Create() { return MakeGarbageCollected<HandwritingPoint>(); }
    static HandwritingPoint* Create(v8::Isolate* isolate) { return MakeGarbageCollected<HandwritingPoint>(isolate); }
