...
public:
    ...
    static RTCRtpParameters* Create(v8::Isolate* isolate) { return MakeGarbageCollected<RTCRtpParameters>(isolate); }
    ...
    bool hasCodecs() const { return true; }
    const HeapVector<Member<RTCRtpCodecParameters>>& codecs() const { return member_codecs_; }
    ...
    bool hasHeaderExtensions() const { return true; }
    const HeapVector<Member<RTCRtpHeaderExtensionParameters>>& headerExtensions() const { return member_header_extensions_; }
    ...
    bool hasRtcp() const { return true; }
    RTCRtcpParameters* rtcp() const { return member_rtcp_; }
