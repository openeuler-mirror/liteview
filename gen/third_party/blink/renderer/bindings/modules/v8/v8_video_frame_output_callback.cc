...
const char* V8VideoFrameOutputCallback::NameInHeapSnapshot() const { return "V8VideoFrameOutputCallback"; }
...
v8::Maybe<void> V8VideoFrameOutputCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, VideoFrame* arg1_output)
{
    ...
    if (!ToV8Traits<VideoFrame>::ToV8(script_state, arg1_output).ToLocal(&v8_arg1_output)) {
        return v8::Nothing<void>();
    }
