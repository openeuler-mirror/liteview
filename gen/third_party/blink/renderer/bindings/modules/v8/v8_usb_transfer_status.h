...
public:
    ...
    static absl::optional<V8USBTransferStatus> Create(const String& value);
...
inline bool operator==(const V8USBTransferStatus& lhs, V8USBTransferStatus::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8USBTransferStatus::Enum lhs, const V8USBTransferStatus& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
