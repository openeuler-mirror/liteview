...
public:
    static V8SQLStatementCallback* Create(v8::Local<v8::Object> callback_object) { return MakeGarbageCollected<V8SQLStatementCallback>(callback_object); }
    ...
    [[nodiscard]] v8::Maybe<void> handleEvent(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, SQLTransaction* arg1_transaction, SQLResultSet* arg2_result_set);
