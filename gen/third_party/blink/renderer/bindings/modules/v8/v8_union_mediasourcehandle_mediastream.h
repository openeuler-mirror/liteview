...
public:
    ...
    bool IsMediaSourceHandle() const { return content_type_ == ContentType::kMediaSourceHandle; }
    MediaSourceHandleImpl* GetAsMediaSourceHandle() const
    {
        DCHECK_EQ(content_type_, ContentType::kMediaSourceHandle);
        return member_media_source_handle_;
    }
    ...
    bool IsMediaStream() const { return content_type_ == ContentType::kMediaStream; }
    MediaStream* GetAsMediaStream() const
    {
        DCHECK_EQ(content_type_, ContentType::kMediaStream);
        return member_media_stream_;
    }
...
private:
    ...
    static constexpr const char* UnionNameInIDL() { return "(MediaSourceHandle or MediaStream)"; }
