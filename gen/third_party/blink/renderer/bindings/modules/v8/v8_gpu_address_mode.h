...
public:
    ...
    static absl::optional<V8GPUAddressMode> Create(const String& value);
...
inline bool operator==(const V8GPUAddressMode& lhs, V8GPUAddressMode::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8GPUAddressMode::Enum lhs, const V8GPUAddressMode& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
