...
inline bool operator==(const V8TransferFunction& lhs, V8TransferFunction::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8TransferFunction::Enum lhs, const V8TransferFunction& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
