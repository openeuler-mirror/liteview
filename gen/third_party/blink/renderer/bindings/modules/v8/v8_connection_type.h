...
public:
    ...
    static absl::optional<V8ConnectionType> Create(const String& value);
...
inline bool operator==(const V8ConnectionType& lhs, V8ConnectionType::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8ConnectionType::Enum lhs, const V8ConnectionType& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
