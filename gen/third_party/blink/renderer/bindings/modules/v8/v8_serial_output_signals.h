...
class MODULES_EXPORT SerialOutputSignals : public bindings::DictionaryBase {

public:
    static SerialOutputSignals* Create() { return MakeGarbageCollected<SerialOutputSignals>(); }
    static SerialOutputSignals* Create(v8::Isolate* isolate) { return MakeGarbageCollected<SerialOutputSignals>(isolate); }
    ...
    bool hasDataTerminalReady() const { return has_data_terminal_ready_; }
    ...
    bool hasRequestToSend() const { return has_request_to_send_; }
