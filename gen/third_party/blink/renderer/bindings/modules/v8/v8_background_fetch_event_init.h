...
public:
    ...
    static BackgroundFetchEventInit* Create(v8::Isolate* isolate) { return MakeGarbageCollected<BackgroundFetchEventInit>(isolate); }
    ...
    bool hasRegistration() const { return true; }
    BackgroundFetchRegistration* registration() const { return member_registration_; }
