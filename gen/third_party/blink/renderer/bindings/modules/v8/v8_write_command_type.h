...
public:
    ...
    static absl::optional<V8WriteCommandType> Create(const String& value);
...
inline bool operator==(const V8WriteCommandType& lhs, V8WriteCommandType::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8WriteCommandType::Enum lhs, const V8WriteCommandType& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
