...
public:
    ...
    static absl::optional<V8RTCSignalingState> Create(const String& value);
...
inline bool operator==(const V8RTCSignalingState& lhs, V8RTCSignalingState::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8RTCSignalingState::Enum lhs, const V8RTCSignalingState& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
