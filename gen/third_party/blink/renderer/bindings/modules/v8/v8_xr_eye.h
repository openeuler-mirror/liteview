...
inline bool operator==(const V8XREye& lhs, V8XREye::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8XREye::Enum lhs, const V8XREye& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
