...
public:
    ...
    static absl::optional<V8XRHandedness> Create(const String& value);
...
inline bool operator==(const V8XRHandedness& lhs, V8XRHandedness::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8XRHandedness::Enum lhs, const V8XRHandedness& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
