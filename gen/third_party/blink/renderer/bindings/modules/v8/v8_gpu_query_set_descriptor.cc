...
void GPUQuerySetDescriptor::setPipelineStatistics(const Vector<V8GPUPipelineStatisticName>& value) { member_pipeline_statistics_ = value; }

void GPUQuerySetDescriptor::setPipelineStatistics(Vector<V8GPUPipelineStatisticName>&& value) { member_pipeline_statistics_ = std::move(value); }
...
void GPUQuerySetDescriptor::FillMembersFromV8Object(v8::Isolate* isolate, v8::Local<v8::Object> v8_dictionary, ExceptionState& exception_state)
{
    ...
    if (!bindings::GetDictionaryMemberFromV8Object<IDLUnsignedLongEnforceRange, is_required>(
            isolate, current_context, v8_dictionary, v8_own_member_names[0].Get(isolate), fallback_presence_var, member_count_, try_block, exception_state)) {
        return;
    }
    exception_context_scope.ChangePropertyNameAsOptimizationHack("pipelineStatistics");
    constexpr bool is_optional = false;
    if (!bindings::GetDictionaryMemberFromV8Object<IDLSequence<V8GPUPipelineStatisticName>, is_optional>(
            isolate, current_context, v8_dictionary, v8_own_member_names[1].Get(isolate), fallback_presence_var, member_pipeline_statistics_, try_block, exception_state)) {
        return;
    }
    exception_context_scope.ChangePropertyNameAsOptimizationHack("type");
    if (!bindings::GetDictionaryMemberFromV8Object<V8GPUQueryType, is_required>(
