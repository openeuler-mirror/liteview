...
public:
    ...
    static MediaKeySystemConfiguration* Create(v8::Isolate* isolate) { return MakeGarbageCollected<MediaKeySystemConfiguration>(isolate); }
    ...
    bool hasAudioCapabilities() const { return true; }
    const HeapVector<Member<MediaKeySystemMediaCapability>>& audioCapabilities() const { return member_audio_capabilities_; }
    ...
    bool hasDistinctiveIdentifier() const { return true; }
    V8MediaKeysRequirement distinctiveIdentifier() const { return member_distinctive_identifier_; }
    void setDistinctiveIdentifier(V8MediaKeysRequirement value) { member_distinctive_identifier_ = value; }
    void setDistinctiveIdentifier(V8MediaKeysRequirement::Enum value) { member_distinctive_identifier_ = V8MediaKeysRequirement(value); }

    bool hasInitDataTypes() const { return true; }
    const Vector<String>& initDataTypes() const { return member_init_data_types_; }
    void setInitDataTypes(const Vector<String>& value);
    void setInitDataTypes(Vector<String>&& value);

    bool hasLabel() const { return true; }
    const String& label() const { return member_label_; }
    void setLabel(const String& value);
    void setLabel(String&& value);

    bool hasPersistentState() const { return true; }
    V8MediaKeysRequirement persistentState() const { return member_persistent_state_; }
    void setPersistentState(V8MediaKeysRequirement value) { member_persistent_state_ = value; }
    void setPersistentState(V8MediaKeysRequirement::Enum value) { member_persistent_state_ = V8MediaKeysRequirement(value); }
    ...
    bool hasVideoCapabilities() const { return true; }
    const HeapVector<Member<MediaKeySystemMediaCapability>>& videoCapabilities() const { return member_video_capabilities_; }
    ...
    void setDistinctiveIdentifier(const String& value) { member_distinctive_identifier_ = V8MediaKeysRequirement::Create(value).value(); }
    void setPersistentState(const String& value) { member_persistent_state_ = V8MediaKeysRequirement::Create(value).value(); }
