...
public:
    ...
    static absl::optional<V8IDBRequestReadyState> Create(const String& value);
...
inline bool operator==(const V8IDBRequestReadyState& lhs, V8IDBRequestReadyState::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8IDBRequestReadyState::Enum lhs, const V8IDBRequestReadyState& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
