...
public:
    ...
    static XRReferenceSpaceEventInit* Create(v8::Isolate* isolate) { return MakeGarbageCollected<XRReferenceSpaceEventInit>(isolate); }
    ...
    bool hasReferenceSpace() const { return true; }
    XRReferenceSpace* referenceSpace() const { return member_reference_space_; }
