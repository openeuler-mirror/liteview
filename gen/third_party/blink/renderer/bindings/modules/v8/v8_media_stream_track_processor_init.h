...
class MODULES_EXPORT MediaStreamTrackProcessorInit : public bindings::DictionaryBase {

public:
    static MediaStreamTrackProcessorInit* Create() { return MakeGarbageCollected<MediaStreamTrackProcessorInit>(); }
    static MediaStreamTrackProcessorInit* Create(v8::Isolate* isolate) { return MakeGarbageCollected<MediaStreamTrackProcessorInit>(isolate); }
