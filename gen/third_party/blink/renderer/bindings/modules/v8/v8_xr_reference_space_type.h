...
public:
    ...
    static absl::optional<V8XRReferenceSpaceType> Create(const String& value);
...
inline bool operator==(const V8XRReferenceSpaceType& lhs, V8XRReferenceSpaceType::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8XRReferenceSpaceType::Enum lhs, const V8XRReferenceSpaceType& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
