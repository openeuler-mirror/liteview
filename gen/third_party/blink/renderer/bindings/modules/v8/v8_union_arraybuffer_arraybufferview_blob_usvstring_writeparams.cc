...
v8::MaybeLocal<v8::Value> V8UnionArrayBufferOrArrayBufferViewOrBlobOrUSVStringOrWriteParams::ToV8Value(ScriptState* script_state) const
{
    switch (content_type_) {
    case ContentType::kArrayBuffer: {
    ...
    case ContentType::kWriteParams: {
        return ToV8Traits<WriteParams>::ToV8(script_state, member_write_params_);
    }
    }
