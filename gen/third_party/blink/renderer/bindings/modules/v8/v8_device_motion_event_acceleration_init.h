...
public:
    ...
    static DeviceMotionEventAccelerationInit* Create(v8::Isolate* isolate) { return MakeGarbageCollected<DeviceMotionEventAccelerationInit>(isolate); }
    ...
    bool hasX() const { return true; }
    const absl::optional<double>& x() const { return member_x_; }
    void setX(const absl::optional<double>& value) { member_x_ = value; }
    void setX(double value) { member_x_ = value; }

    bool hasY() const { return true; }
    const absl::optional<double>& y() const { return member_y_; }
    void setY(const absl::optional<double>& value) { member_y_ = value; }
    void setY(double value) { member_y_ = value; }

    bool hasZ() const { return true; }
    const absl::optional<double>& z() const { return member_z_; }
    void setZ(const absl::optional<double>& value) { member_z_ = value; }
    void setZ(double value) { member_z_ = value; }
    // Obsolete accessor functions
    bool hasXNonNull() const { return hasX() && x().has_value(); }
    double xNonNull() const
    {
        DCHECK(hasXNonNull());
        return x().value();
    }
    bool hasYNonNull() const { return hasY() && y().has_value(); }
    double yNonNull() const
    {
        DCHECK(hasYNonNull());
        return y().value();
    }
    bool hasZNonNull() const { return hasZ() && z().has_value(); }
