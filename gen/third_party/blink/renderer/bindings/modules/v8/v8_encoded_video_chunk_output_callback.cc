...
const char* V8EncodedVideoChunkOutputCallback::NameInHeapSnapshot() const { return "V8EncodedVideoChunkOutputCallback"; }
    ...
    bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, EncodedVideoChunk* arg1_chunk, const EncodedVideoChunkMetadata* arg2_metadata)
{
    ...
    if (!ToV8Traits<EncodedVideoChunk>::ToV8(script_state, arg1_chunk).ToLocal(&v8_arg1_chunk)) {
        return v8::Nothing<void>();
    }
    argv[0] = v8_arg1_chunk;
    v8::Local<v8::Value> v8_arg2_metadata;
    if (!ToV8Traits<EncodedVideoChunkMetadata>::ToV8(script_state, arg2_metadata).ToLocal(&v8_arg2_metadata)) {
        return v8::Nothing<void>();
    }
