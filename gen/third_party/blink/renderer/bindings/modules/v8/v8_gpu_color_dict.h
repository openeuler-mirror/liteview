...
public:
    ...
    static GPUColorDict* Create(v8::Isolate* isolate) { return MakeGarbageCollected<GPUColorDict>(isolate); }
    ...
    bool hasA() const { return true; }
    double a() const { return member_a_; }
    void setA(double value) { member_a_ = value; }

    bool hasB() const { return true; }
    double b() const { return member_b_; }
    void setB(double value) { member_b_ = value; }

    bool hasG() const { return true; }
    double g() const { return member_g_; }
    void setG(double value) { member_g_ = value; }

    bool hasR() const { return true; }
    double r() const { return member_r_; }
    void setR(double value) { member_r_ = value; }
