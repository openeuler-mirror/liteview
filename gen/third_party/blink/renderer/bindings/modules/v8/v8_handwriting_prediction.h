...
public:
    static HandwritingPrediction* Create() { return MakeGarbageCollected<HandwritingPrediction>(); }
    static HandwritingPrediction* Create(v8::Isolate* isolate) { return MakeGarbageCollected<HandwritingPrediction>(isolate); }
    ...
    bool hasSegmentationResult() const { return has_segmentation_result_; }
    ...
    const String& text() const { return member_text_; }
