...
public:
    static BrowsingTopic* Create() { return MakeGarbageCollected<BrowsingTopic>(); }
    static BrowsingTopic* Create(v8::Isolate* isolate) { return MakeGarbageCollected<BrowsingTopic>(isolate); }
    ...
    bool hasConfigVersion() const { return has_config_version_; }
    ...
    bool hasModelVersion() const { return has_model_version_; }
    ...
    bool hasTaxonomyVersion() const { return has_taxonomy_version_; }
    ...
    bool hasTopic() const { return has_topic_; }
    int32_t topic() const
    {
        DCHECK(hasTopic());
