...
using V8FormattedTextRunSingle = V8UnionFormattedTextRunOrString;
...
using V8UnionFormattedTextRunListOrFormattedTextRunSingle = V8UnionFormattedTextRunOrFormattedTextRunOrStringSequenceOrString;
