...
bool V8Storage::IsExposed(ExecutionContext* execution_context) { return execution_context->IsWindow(); }
...
static_assert(std::is_same<decltype(&StorageArea::HasPendingActivity), decltype(&ScriptWrappable::HasPendingActivity)>::value,
...
void V8Storage::NamedPropertyDeleterCallback(v8::Local<v8::Name> v8_property_name, const v8::PropertyCallbackInfo<v8::Boolean>& info)
{
    ...
    if (return_value == NamedPropertyDeleterResult::kDidNotDelete) {
        if (info.ShouldThrowOnError()) {
            ExceptionState deletion_exception_state(info.GetIsolate(), ExceptionContext::Context::kNamedPropertyDelete, "Storage");
...
void V8Storage::NamedPropertyDefinerCallback(v8::Local<v8::Name> v8_property_name, const v8::PropertyDescriptor& v8_property_desc, const v8::PropertyCallbackInfo<v8::Value>& info)
{
    ...
    if (v8_property_desc.has_get() || v8_property_desc.has_set()) {
        bindings::V8SetReturnValue(info, nullptr);
        if (info.ShouldThrowOnError()) {
            ExceptionState exception_state(info.GetIsolate(), ExceptionContext::Context::kNamedPropertySet, "Storage");
    ...
    V8Storage::NamedPropertySetterCallback(v8_property_name, v8_property_desc.has_value() ? v8_property_desc.value() : v8::Undefined(isolate).As<v8::Value>(), info);
    bindings::V8SetReturnValue(info, nullptr);
}
...
void V8Storage::NamedPropertyQueryCallback(v8::Local<v8::Name> v8_property_name, const v8::PropertyCallbackInfo<v8::Integer>& info)
{
    ...
    StorageArea* blink_receiver = V8Storage::ToWrappableUnsafe(v8_receiver);
    const AtomicString& blink_property_name = ToCoreAtomicString(v8_property_name.As<v8::String>());
    ExceptionState exception_state(isolate, ExceptionContext::Context::kNamedPropertyGet, "Storage");
...
void V8Storage::NamedPropertyEnumeratorCallback(const v8::PropertyCallbackInfo<v8::Array>& info)
{
    ...
    ExceptionState exception_state(info.GetIsolate(), ExceptionContext::Context::kNamedPropertyEnumerate, "Storage");
...
void V8Storage::IndexedPropertySetterCallback(uint32_t index, v8::Local<v8::Value> v8_property_value, const v8::PropertyCallbackInfo<v8::Value>& info)
{
    ...
    v8::Isolate* isolate = info.GetIsolate();
    v8::Local<v8::String> property_name = V8AtomicString(isolate, AtomicString::Number(index));
    V8Storage::NamedPropertySetterCallback(property_name, v8_property_value, info);
}
...
void V8Storage::IndexedPropertyDefinerCallback(uint32_t index, const v8::PropertyDescriptor& v8_property_desc, const v8::PropertyCallbackInfo<v8::Value>& info)
{
    ...
    v8::Isolate* isolate = info.GetIsolate();
    v8::Local<v8::String> property_name = V8AtomicString(isolate, AtomicString::Number(index));
    V8Storage::NamedPropertyDefinerCallback(property_name, v8_property_desc, info);
}
...
void ClearOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    if (per_context_data && per_context_data->ActivityLogger()) {
        per_context_data->ActivityLogger()->LogMethod("Storage.clear", info);
    }
...
void GetItemOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    // [LogActivity], [LogAllWorlds]
    if (per_context_data && per_context_data->ActivityLogger()) {
        per_context_data->ActivityLogger()->LogMethod("Storage.getItem", info);
    }
...
void RemoveItemOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    // [LogActivity], [LogAllWorlds]
    if (per_context_data && per_context_data->ActivityLogger()) {
        per_context_data->ActivityLogger()->LogMethod("Storage.removeItem", info);
    }
...
void SetItemOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    // [LogActivity], [LogAllWorlds]
    if (per_context_data && per_context_data->ActivityLogger()) {
        per_context_data->ActivityLogger()->LogMethod("Storage.setItem", info);
    }
...
void V8Storage::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template)
{
    ...
    instance_object_template->SetHandler(v8::NamedPropertyHandlerConfiguration(V8Storage::NamedPropertyGetterCallback, V8Storage::NamedPropertySetterCallback,
        V8Storage::NamedPropertyQueryCallback, V8Storage::NamedPropertyDeleterCallback, V8Storage::NamedPropertyEnumeratorCallback, V8Storage::NamedPropertyDefinerCallback,
        V8Storage::NamedPropertyDescriptorCallback, v8::Local<v8::Value>(),
    ...
    instance_object_template->SetHandler(v8::IndexedPropertyHandlerConfiguration(V8Storage::IndexedPropertyGetterCallback, V8Storage::IndexedPropertySetterCallback,
        nullptr, // query
    ...
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
...

    {
        static const IDLMemberInstaller::OperationConfig kOperationTable[] = {
            ...
            { "key", KeyOperationCallback, 1, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds),
                unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasSideEffect) },
            { "removeItem", RemoveItemOperationCallback, 1, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
                unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck),
                unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasSideEffect) },
            { "setItem", SetItemOperationCallback, 2, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
                unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck),
                unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasSideEffect) },
        };
