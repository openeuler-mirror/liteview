...
public:
    ...
    static StorageEstimate* Create(v8::Isolate* isolate) { return MakeGarbageCollected<StorageEstimate>(isolate); }
    ...
    bool hasUsageDetails() const { return has_usage_details_; }
