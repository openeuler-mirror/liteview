...
public:
    ...
    static absl::optional<V8XRSessionMode> Create(const String& value);
...
inline bool operator==(const V8XRSessionMode& lhs, V8XRSessionMode::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8XRSessionMode::Enum lhs, const V8XRSessionMode& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
