...
public:
    ...
    static absl::optional<V8ChannelCountMode> Create(const String& value);
...
inline bool operator==(const V8ChannelCountMode& lhs, V8ChannelCountMode::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8ChannelCountMode::Enum lhs, const V8ChannelCountMode& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
