...
const char* V8PressureUpdateCallback::NameInHeapSnapshot() const { return "V8PressureUpdateCallback"; }
    ...
    bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const HeapVector<Member<PressureRecord>>& arg1_changes, PressureObserver* arg2_observer)
{
    ...
    if (!ToV8Traits<IDLSequence<PressureRecord>>::ToV8(script_state, arg1_changes).ToLocal(&v8_arg1_changes)) {
        return v8::Nothing<void>();
    }
    argv[0] = v8_arg1_changes;
    v8::Local<v8::Value> v8_arg2_observer;
    if (!ToV8Traits<PressureObserver>::ToV8(script_state, arg2_observer).ToLocal(&v8_arg2_observer)) {
        return v8::Nothing<void>();
    }
