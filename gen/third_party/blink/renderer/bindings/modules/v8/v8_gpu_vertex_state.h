...
public:
    static GPUVertexState* Create() { return MakeGarbageCollected<GPUVertexState>(); }
    static GPUVertexState* Create(v8::Isolate* isolate) { return MakeGarbageCollected<GPUVertexState>(isolate); }
    ...
    bool hasBuffers() const { return true; }
    const HeapVector<Member<GPUVertexBufferLayout>>& buffers() const { return member_buffers_; }
