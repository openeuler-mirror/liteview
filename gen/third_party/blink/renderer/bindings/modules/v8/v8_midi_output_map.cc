...
static_assert(std::is_same<decltype(&MIDIOutputMap::HasPendingActivity), decltype(&ScriptWrappable::HasPendingActivity)>::value,
    "MIDIOutputMap is overriding hasPendingActivity() without "
    "[ActiveScriptWrappable] extended attribute.");
...
void SizeAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    MIDIOutputMap* blink_receiver = V8MIDIOutputMap::ToWrappableUnsafe(v8_receiver);
...
void EntriesOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    const char* const class_like_name = "MIDIOutputMap";
