...
public:
    ...
    static absl::optional<V8RTCIceGatheringState> Create(const String& value);
...
inline bool operator==(const V8RTCIceGatheringState& lhs, V8RTCIceGatheringState::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8RTCIceGatheringState::Enum lhs, const V8RTCIceGatheringState& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
