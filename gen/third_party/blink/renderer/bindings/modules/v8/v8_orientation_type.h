...
inline bool operator==(const V8OrientationType& lhs, V8OrientationType::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8OrientationType::Enum lhs, const V8OrientationType& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
