...
public:
    static AdRequestConfig* Create() { return MakeGarbageCollected<AdRequestConfig>(); }
    static AdRequestConfig* Create(v8::Isolate* isolate) { return MakeGarbageCollected<AdRequestConfig>(isolate); }
    ...
    bool hasAdProperties() const { return true; }
    V8UnionAdPropertiesOrAdPropertiesSequence* adProperties() const { return member_ad_properties_; }
    ...
    bool hasAdRequestUrl() const { return true; }
    const String& adRequestUrl() const { return member_ad_request_url_; }
    void setAdRequestUrl(const String& value);
    void setAdRequestUrl(String&& value);

    bool hasAnonymizedProxiedSignals() const { return has_anonymized_proxied_signals_; }
    ...
    bool hasFallbackSource() const { return has_fallback_source_; }
    ...
    bool hasPublisherCode() const { return has_publisher_code_; }
    ...
    bool hasTargeting() const { return has_targeting_; }
