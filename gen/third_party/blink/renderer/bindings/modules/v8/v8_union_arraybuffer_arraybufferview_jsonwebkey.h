...
public:
    ...
    bool IsJsonWebKey() const { return content_type_ == ContentType::kJsonWebKey; }
...
private:
    ...
    static constexpr const char* UnionNameInIDL() { return "(ArrayBuffer or ArrayBufferView or JsonWebKey)"; }
