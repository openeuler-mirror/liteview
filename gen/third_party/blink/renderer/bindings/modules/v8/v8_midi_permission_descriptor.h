...
public:
    ...
    static MidiPermissionDescriptor* Create(v8::Isolate* isolate) { return MakeGarbageCollected<MidiPermissionDescriptor>(isolate); }
    ...
    bool hasSysex() const { return true; }
    bool sysex() const { return member_sysex_; }
    void setSysex(bool value) { member_sysex_ = value; }
