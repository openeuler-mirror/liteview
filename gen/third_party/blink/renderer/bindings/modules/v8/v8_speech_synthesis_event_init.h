...
public:
    ...
    static SpeechSynthesisEventInit* Create(v8::Isolate* isolate) { return MakeGarbageCollected<SpeechSynthesisEventInit>(isolate); }
    ...
    bool hasCharIndex() const { return true; }
    uint32_t charIndex() const { return member_char_index_; }
    void setCharIndex(uint32_t value) { member_char_index_ = value; }

    bool hasCharLength() const { return true; }
    uint32_t charLength() const { return member_char_length_; }
    void setCharLength(uint32_t value) { member_char_length_ = value; }

    bool hasElapsedTime() const { return true; }
    float elapsedTime() const { return member_elapsed_time_; }
    void setElapsedTime(float value) { member_elapsed_time_ = value; }
    ...
    bool hasUtterance() const { return true; }
    SpeechSynthesisUtterance* utterance() const { return member_utterance_; }
