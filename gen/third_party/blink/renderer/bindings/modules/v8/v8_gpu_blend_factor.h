...
public:
    ...
    static absl::optional<V8GPUBlendFactor> Create(const String& value);
...
inline bool operator==(const V8GPUBlendFactor& lhs, V8GPUBlendFactor::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8GPUBlendFactor::Enum lhs, const V8GPUBlendFactor& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
