...
public:
    ...
    static absl::optional<V8GPUBlendOperation> Create(const String& value);
...
inline bool operator==(const V8GPUBlendOperation& lhs, V8GPUBlendOperation::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8GPUBlendOperation::Enum lhs, const V8GPUBlendOperation& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
