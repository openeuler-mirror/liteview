...
const char* V8NotificationPermissionCallback::NameInHeapSnapshot() const { return "V8NotificationPermissionCallback"; }
...
v8::Maybe<void> V8NotificationPermissionCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, V8NotificationPermission arg1_permission)
{
    ...
    if (!ToV8Traits<V8NotificationPermission>::ToV8(script_state, arg1_permission).ToLocal(&v8_arg1_permission)) {
        return v8::Nothing<void>();
    }
