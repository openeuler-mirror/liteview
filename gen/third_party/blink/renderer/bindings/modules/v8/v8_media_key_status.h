...
public:
    ...
    static absl::optional<V8MediaKeyStatus> Create(const String& value);
...
inline bool operator==(const V8MediaKeyStatus& lhs, V8MediaKeyStatus::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8MediaKeyStatus::Enum lhs, const V8MediaKeyStatus& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
