...
public:
    static SocketOpenInfo* Create() { return MakeGarbageCollected<SocketOpenInfo>(); }
    static SocketOpenInfo* Create(v8::Isolate* isolate) { return MakeGarbageCollected<SocketOpenInfo>(isolate); }
    ...
    bool hasLocalAddress() const { return has_local_address_; }
    ...
    bool hasLocalPort() const { return has_local_port_; }
    ...
    bool hasRemoteAddress() const { return has_remote_address_; }
    ...
    bool hasRemotePort() const { return has_remote_port_; }
