...
public:
    static PeriodicSyncEventInit* Create() { return MakeGarbageCollected<PeriodicSyncEventInit>(); }
    static PeriodicSyncEventInit* Create(v8::Isolate* isolate) { return MakeGarbageCollected<PeriodicSyncEventInit>(isolate); }
