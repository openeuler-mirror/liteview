...
public:
    ...
    static RTCErrorInit* Create(v8::Isolate* isolate) { return MakeGarbageCollected<RTCErrorInit>(isolate); }
    ...
    bool hasErrorDetail() const { return true; }
    V8RTCErrorDetailType errorDetail() const { return member_error_detail_; }
    void setErrorDetail(V8RTCErrorDetailType value) { member_error_detail_ = value; }
    void setErrorDetail(V8RTCErrorDetailType::Enum value) { member_error_detail_ = V8RTCErrorDetailType(value); }
    ...
    void setErrorDetail(const String& value) { member_error_detail_ = V8RTCErrorDetailType::Create(value).value(); }
