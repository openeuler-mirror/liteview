...
inline bool operator==(const V8UserIdleState& lhs, V8UserIdleState::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8UserIdleState::Enum lhs, const V8UserIdleState& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
