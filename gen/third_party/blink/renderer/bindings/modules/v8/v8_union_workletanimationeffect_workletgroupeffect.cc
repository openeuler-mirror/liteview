    ...
    v8::Isolate* isolate, v8::Local<v8::Value> v8_value, ExceptionState& exception_state)
{
    if (V8WorkletGroupEffect::HasInstance(isolate, v8_value)) {
        auto&& blink_value = V8WorkletGroupEffect::ToWrappableUnsafe(v8_value.As<v8::Object>());
    ...
    if (V8WorkletAnimationEffect::HasInstance(isolate, v8_value)) {
        auto&& blink_value = V8WorkletAnimationEffect::ToWrappableUnsafe(v8_value.As<v8::Object>());
        return MakeGarbageCollected<V8UnionWorkletAnimationEffectOrWorkletGroupEffect>(blink_value);
    }
...
v8::MaybeLocal<v8::Value> V8UnionWorkletAnimationEffectOrWorkletGroupEffect::ToV8Value(ScriptState* script_state) const
{
    ...
    case ContentType::kWorkletAnimationEffect: {
        return ToV8Traits<WorkletAnimationEffect>::ToV8(script_state, member_worklet_animation_effect_);
    }
    case ContentType::kWorkletGroupEffect: {
        return ToV8Traits<WorkletGroupEffect>::ToV8(script_state, member_worklet_group_effect_);
    }
    }
