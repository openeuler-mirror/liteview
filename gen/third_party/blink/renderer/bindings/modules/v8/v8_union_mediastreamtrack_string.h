...
public:
    ...
    bool IsMediaStreamTrack() const { return content_type_ == ContentType::kMediaStreamTrack; }
...
private:
    ...
    static constexpr const char* UnionNameInIDL() { return "(DOMString or MediaStreamTrack)"; }
