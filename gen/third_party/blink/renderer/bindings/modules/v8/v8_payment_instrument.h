...
public:
    ...
    static PaymentInstrument* Create(v8::Isolate* isolate) { return MakeGarbageCollected<PaymentInstrument>(isolate); }
    ...
    bool hasCapabilities() const { return !member_capabilities_.IsEmpty(); }
