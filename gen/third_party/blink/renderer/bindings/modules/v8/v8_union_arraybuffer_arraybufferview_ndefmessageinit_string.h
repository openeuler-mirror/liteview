...
public:
    ...
    bool IsNDEFMessageInit() const { return content_type_ == ContentType::kNDEFMessageInit; }
    NDEFMessageInit* GetAsNDEFMessageInit() const
    {
        DCHECK_EQ(content_type_, ContentType::kNDEFMessageInit);
        return member_ndef_message_init_;
    }
    ...
    bool IsV8UnionArrayBufferOrString() const { return content_type_ == ContentType::kArrayBuffer || content_type_ == ContentType::kString; }
...
private:
    ...
    static constexpr const char* UnionNameInIDL() { return "(ArrayBuffer or ArrayBufferView or DOMString or NDEFMessageInit)"; }
