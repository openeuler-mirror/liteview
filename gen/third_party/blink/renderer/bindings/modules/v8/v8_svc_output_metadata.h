...
public:
    static SvcOutputMetadata* Create() { return MakeGarbageCollected<SvcOutputMetadata>(); }
    static SvcOutputMetadata* Create(v8::Isolate* isolate) { return MakeGarbageCollected<SvcOutputMetadata>(isolate); }
    ...
    bool hasTemporalLayerId() const { return has_temporal_layer_id_; }
