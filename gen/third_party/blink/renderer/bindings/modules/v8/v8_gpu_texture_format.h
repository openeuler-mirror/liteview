...
inline bool operator==(const V8GPUTextureFormat& lhs, V8GPUTextureFormat::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8GPUTextureFormat::Enum lhs, const V8GPUTextureFormat& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
