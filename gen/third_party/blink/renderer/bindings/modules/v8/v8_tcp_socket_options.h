...
public:
    static TCPSocketOptions* Create() { return MakeGarbageCollected<TCPSocketOptions>(); }
    static TCPSocketOptions* Create(v8::Isolate* isolate) { return MakeGarbageCollected<TCPSocketOptions>(isolate); }
    ...
    bool hasKeepAliveDelay() const { return has_keep_alive_delay_; }
    ...
    bool hasNoDelay() const { return true; }
    bool noDelay() const { return member_no_delay_; }
    void setNoDelay(bool value) { member_no_delay_ = value; }
