...
public:
    ...
    static absl::optional<V8BackgroundFetchResult> Create(const String& value);
...
inline bool operator==(const V8BackgroundFetchResult& lhs, V8BackgroundFetchResult::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8BackgroundFetchResult::Enum lhs, const V8BackgroundFetchResult& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
