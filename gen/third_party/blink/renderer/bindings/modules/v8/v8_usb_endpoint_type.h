...
public:
    ...
    static absl::optional<V8USBEndpointType> Create(const String& value);
...
inline bool operator==(const V8USBEndpointType& lhs, V8USBEndpointType::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8USBEndpointType::Enum lhs, const V8USBEndpointType& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
