...
public:
    ...
    static absl::optional<V8EncodedVideoChunkType> Create(const String& value);
...
inline bool operator==(const V8EncodedVideoChunkType& lhs, V8EncodedVideoChunkType::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8EncodedVideoChunkType::Enum lhs, const V8EncodedVideoChunkType& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
