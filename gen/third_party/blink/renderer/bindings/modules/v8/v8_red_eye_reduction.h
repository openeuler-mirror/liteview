...
public:
    ...
    static absl::optional<V8RedEyeReduction> Create(const String& value);
...
inline bool operator==(const V8RedEyeReduction& lhs, V8RedEyeReduction::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8RedEyeReduction::Enum lhs, const V8RedEyeReduction& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
