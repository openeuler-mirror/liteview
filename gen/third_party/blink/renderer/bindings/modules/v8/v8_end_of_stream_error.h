...
public:
    ...
    static absl::optional<V8EndOfStreamError> Create(const String& value);
...
inline bool operator==(const V8EndOfStreamError& lhs, V8EndOfStreamError::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8EndOfStreamError::Enum lhs, const V8EndOfStreamError& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
