...
bool V8EXTsRGB::IsExposed(ExecutionContext* execution_context) { return false; }
...
static_assert(std::is_same<decltype(&EXTsRGB::HasPendingActivity), decltype(&ScriptWrappable::HasPendingActivity)>::value,
