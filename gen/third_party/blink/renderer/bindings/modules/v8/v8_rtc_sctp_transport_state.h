...
public:
    ...
    static absl::optional<V8RTCSctpTransportState> Create(const String& value);
...
inline bool operator==(const V8RTCSctpTransportState& lhs, V8RTCSctpTransportState::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8RTCSctpTransportState::Enum lhs, const V8RTCSctpTransportState& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
