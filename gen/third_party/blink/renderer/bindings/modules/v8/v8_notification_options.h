...
public:
    static NotificationOptions* Create(v8::Isolate* isolate) { return MakeGarbageCollected<NotificationOptions>(isolate); }
    ...
    bool hasActions() const { return true; }
    const HeapVector<Member<NotificationAction>>& actions() const { return member_actions_; }
    ...
    bool hasBadge() const { return has_badge_; }
    ...
    const String& body() const { return member_body_; }
    ...
    bool hasDir() const { return true; }
    V8NotificationDirection dir() const { return member_dir_; }
    void setDir(V8NotificationDirection value) { member_dir_ = value; }
    void setDir(V8NotificationDirection::Enum value) { member_dir_ = V8NotificationDirection(value); }
    ...
    bool hasLang() const { return true; }
    const String& lang() const { return member_lang_; }
    void setLang(const String& value);
    void setLang(String&& value);

    bool hasRenotify() const { return true; }
    bool renotify() const { return member_renotify_; }
    void setRenotify(bool value) { member_renotify_ = value; }

    bool hasRequireInteraction() const { return true; }
    bool requireInteraction() const { return member_require_interaction_; }
    void setRequireInteraction(bool value) { member_require_interaction_ = value; }

    bool hasShowTrigger() const { return has_show_trigger_; }
    ...
    bool hasSilent() const { return true; }
    bool silent() const { return member_silent_; }
    void setSilent(bool value) { member_silent_ = value; }

    bool hasTag() const { return true; }
    const String& tag() const { return member_tag_; }
    ...
    bool hasVibrate() const { return has_vibrate_; }
    ...
    void setDir(const String& value) { member_dir_ = V8NotificationDirection::Create(value).value(); }
