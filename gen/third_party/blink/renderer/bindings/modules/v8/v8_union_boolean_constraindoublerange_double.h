...
public:
    ...
    bool IsConstrainDoubleRange() const { return content_type_ == ContentType::kConstrainDoubleRange; }
    ConstrainDoubleRange* GetAsConstrainDoubleRange() const
    {
        DCHECK_EQ(content_type_, ContentType::kConstrainDoubleRange);
        return member_constrain_double_range_;
    }
    ...
    bool IsV8UnionConstrainDoubleRangeOrDouble() const { return content_type_ == ContentType::kConstrainDoubleRange || content_type_ == ContentType::kDouble; }
    ...
    bool IsV8ConstrainDouble() const { return IsV8UnionConstrainDoubleRangeOrDouble(); }
    V8UnionConstrainDoubleRangeOrDouble* GetAsV8ConstrainDouble() const { return GetAsV8UnionConstrainDoubleRangeOrDouble(); }
...
private:
    ...
    static constexpr const char* UnionNameInIDL() { return "(ConstrainDoubleRange or boolean or double)"; }
