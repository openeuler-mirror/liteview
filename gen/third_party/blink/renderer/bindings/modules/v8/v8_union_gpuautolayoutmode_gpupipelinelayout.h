...
public:
    ...
    bool IsGPUAutoLayoutMode() const { return content_type_ == ContentType::kGPUAutoLayoutMode; }
    ...
    bool IsGPUPipelineLayout() const { return content_type_ == ContentType::kGPUPipelineLayout; }
    GPUPipelineLayout* GetAsGPUPipelineLayout() const
    {
        DCHECK_EQ(content_type_, ContentType::kGPUPipelineLayout);
        return member_gpu_pipeline_layout_;
    }
...
private:
    ...
    static constexpr const char* UnionNameInIDL() { return "(GPUAutoLayoutMode or GPUPipelineLayout)"; }
