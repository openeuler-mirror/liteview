...
public:
    ...
    static RTCTrackEventInit* Create(v8::Isolate* isolate) { return MakeGarbageCollected<RTCTrackEventInit>(isolate); }
    ...
    bool hasReceiver() const { return true; }
    RTCRtpReceiver* receiver() const { return member_receiver_; }
    ...
    bool hasTrack() const { return true; }
    MediaStreamTrack* track() const { return member_track_; }
    ...
    bool hasTransceiver() const { return true; }
    RTCRtpTransceiver* transceiver() const { return member_transceiver_; }
