...
public:
    static AudioDecoderSupport* Create() { return MakeGarbageCollected<AudioDecoderSupport>(); }
    static AudioDecoderSupport* Create(v8::Isolate* isolate) { return MakeGarbageCollected<AudioDecoderSupport>(isolate); }
    ...
    AudioDecoderConfig* config() const { return member_config_; }
