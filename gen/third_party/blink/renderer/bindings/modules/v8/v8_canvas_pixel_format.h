...
public:
    ...
    static absl::optional<V8CanvasPixelFormat> Create(const String& value);
...
inline bool operator==(const V8CanvasPixelFormat& lhs, V8CanvasPixelFormat::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8CanvasPixelFormat::Enum lhs, const V8CanvasPixelFormat& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
