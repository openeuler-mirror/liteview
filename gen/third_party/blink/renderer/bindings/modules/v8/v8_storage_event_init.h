...
public:
    ...
    static StorageEventInit* Create(v8::Isolate* isolate) { return MakeGarbageCollected<StorageEventInit>(isolate); }
    ...
    bool hasNewValue() const { return true; }
    const String& newValue() const { return member_new_value_; }
    void setNewValue(const String& value);
    void setNewValue(String&& value);

    bool hasOldValue() const { return true; }
    const String& oldValue() const { return member_old_value_; }
    void setOldValue(const String& value);
    void setOldValue(String&& value);

    bool hasStorageArea() const { return true; }
    StorageArea* storageArea() const { return member_storage_area_; }
    void setStorageArea(StorageArea* value) { member_storage_area_ = value; }
