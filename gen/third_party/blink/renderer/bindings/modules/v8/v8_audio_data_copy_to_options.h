...
public:
    static AudioDataCopyToOptions* Create() { return MakeGarbageCollected<AudioDataCopyToOptions>(); }
    static AudioDataCopyToOptions* Create(v8::Isolate* isolate) { return MakeGarbageCollected<AudioDataCopyToOptions>(isolate); }
    ...
    bool hasFrameCount() const { return has_frame_count_; }
    ...
    bool hasFrameOffset() const { return true; }
    uint32_t frameOffset() const { return member_frame_offset_; }
    void setFrameOffset(uint32_t value) { member_frame_offset_ = value; }

    bool hasPlaneIndex() const { return true; }
    uint32_t planeIndex() const { return member_plane_index_; }
    void setPlaneIndex(uint32_t value) { member_plane_index_ = value; }
