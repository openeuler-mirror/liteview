...
bool SerialPortRequestOptions::FillV8ObjectWithMembers(ScriptState* script_state, v8::Local<v8::Object> v8_dictionary) const
{
    if (hasFilters()) {
        v8::Local<v8::Value> v8_value;
        if (!ToV8Traits<IDLSequence<SerialPortFilter>>::ToV8(script_state, member_filters_).ToLocal(&v8_value)) {
            return false;
        }
...
void SerialPortRequestOptions::FillMembersFromV8Object(v8::Isolate* isolate, v8::Local<v8::Object> v8_dictionary, ExceptionState& exception_state)
{
    ...
    if (!bindings::GetDictionaryMemberFromV8Object<IDLSequence<SerialPortFilter>, is_optional>(
            isolate, current_context, v8_dictionary, v8_own_member_names[0].Get(isolate), has_filters_, member_filters_, try_block, exception_state)) {
        return;
    }
}
