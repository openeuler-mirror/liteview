...
V8UnionArrayBufferOrGPUBuffer* V8UnionArrayBufferOrGPUBuffer::Create(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, ExceptionState& exception_state)
{
    if (V8GPUBuffer::HasInstance(isolate, v8_value)) {
        auto&& blink_value = V8GPUBuffer::ToWrappableUnsafe(v8_value.As<v8::Object>());
...
v8::MaybeLocal<v8::Value> V8UnionArrayBufferOrGPUBuffer::ToV8Value(ScriptState* script_state) const
{
    ...
    case ContentType::kGPUBuffer: {
        return ToV8Traits<GPUBuffer>::ToV8(script_state, member_gpu_buffer_);
    }
    }
