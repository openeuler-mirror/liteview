...
public:
    ...
    static absl::optional<V8PushEncryptionKeyName> Create(const String& value);
...
inline bool operator==(const V8PushEncryptionKeyName& lhs, V8PushEncryptionKeyName::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8PushEncryptionKeyName::Enum lhs, const V8PushEncryptionKeyName& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
