...
public:
    ...
    static RTCRtpHeaderExtensionCapability* Create(v8::Isolate* isolate) { return MakeGarbageCollected<RTCRtpHeaderExtensionCapability>(isolate); }
    ...
    bool hasUri() const { return has_uri_; }
