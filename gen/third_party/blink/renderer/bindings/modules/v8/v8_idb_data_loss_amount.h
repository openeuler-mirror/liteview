...
public:
    ...
    static absl::optional<V8IDBDataLossAmount> Create(const String& value);
...
inline bool operator==(const V8IDBDataLossAmount& lhs, V8IDBDataLossAmount::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8IDBDataLossAmount::Enum lhs, const V8IDBDataLossAmount& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
