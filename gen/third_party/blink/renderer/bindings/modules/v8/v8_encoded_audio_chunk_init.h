...
public:
    static EncodedAudioChunkInit* Create() { return MakeGarbageCollected<EncodedAudioChunkInit>(); }
    static EncodedAudioChunkInit* Create(v8::Isolate* isolate) { return MakeGarbageCollected<EncodedAudioChunkInit>(isolate); }
    ...
    V8EncodedAudioChunkType type() const { return member_type_; }
    void setType(V8EncodedAudioChunkType value) { member_type_ = value; }
    void setType(V8EncodedAudioChunkType::Enum value) { member_type_ = V8EncodedAudioChunkType(value); }
    // Obsolete accessor functions
    void setType(const String& value) { member_type_ = V8EncodedAudioChunkType::Create(value).value(); }
