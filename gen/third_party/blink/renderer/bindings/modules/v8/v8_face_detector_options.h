...
public:
    ...
    static FaceDetectorOptions* Create(v8::Isolate* isolate) { return MakeGarbageCollected<FaceDetectorOptions>(isolate); }
    ...
    bool hasFastMode() const { return true; }
    bool fastMode() const { return member_fast_mode_; }
    void setFastMode(bool value) { member_fast_mode_ = value; }

    bool hasMaxDetectedFaces() const { return true; }
    uint16_t maxDetectedFaces() const { return member_max_detected_faces_; }
    void setMaxDetectedFaces(uint16_t value) { member_max_detected_faces_ = value; }
