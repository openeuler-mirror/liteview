...
public:
    static VideoFrameBufferInit* Create() { return MakeGarbageCollected<VideoFrameBufferInit>(); }
    static VideoFrameBufferInit* Create(v8::Isolate* isolate) { return MakeGarbageCollected<VideoFrameBufferInit>(isolate); }
    ...
    bool hasCodedHeight() const { return true; }
    uint32_t codedHeight() const { return member_coded_height_; }
    void setCodedHeight(uint32_t value) { member_coded_height_ = value; }

    bool hasCodedWidth() const { return true; }
    uint32_t codedWidth() const { return member_coded_width_; }
    void setCodedWidth(uint32_t value) { member_coded_width_ = value; }
    ...
    V8VideoPixelFormat format() const { return member_format_; }
    void setFormat(V8VideoPixelFormat value) { member_format_ = value; }
    void setFormat(V8VideoPixelFormat::Enum value) { member_format_ = V8VideoPixelFormat(value); }
    ...
    bool hasVisibleRect() const { return has_visible_rect_; }
    ...
    void setFormat(const String& value) { member_format_ = V8VideoPixelFormat::Create(value).value(); }
