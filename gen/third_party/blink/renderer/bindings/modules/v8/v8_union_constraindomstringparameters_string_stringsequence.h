...
public:
    ...
    bool IsConstrainDOMStringParameters() const { return content_type_ == ContentType::kConstrainDOMStringParameters; }
    ...
    bool IsV8UnionStringOrStringSequence() const { return content_type_ == ContentType::kString || content_type_ == ContentType::kStringSequence; }
...
private:
    ...
    static constexpr const char* UnionNameInIDL() { return "(ConstrainDOMStringParameters or DOMString or sequence<DOMString>)"; }
