...
public:
    ...
    static absl::optional<V8GPUFilterMode> Create(const String& value);
...
inline bool operator==(const V8GPUFilterMode& lhs, V8GPUFilterMode::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8GPUFilterMode::Enum lhs, const V8GPUFilterMode& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
