...
public:
    ...
    static absl::optional<V8GPUFrontFace> Create(const String& value);
...
inline bool operator==(const V8GPUFrontFace& lhs, V8GPUFrontFace::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8GPUFrontFace::Enum lhs, const V8GPUFrontFace& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
