...
public:
    ...
    bool IsAdProperties() const { return content_type_ == ContentType::kAdProperties; }
    ...
    bool IsAdPropertiesSequence() const { return content_type_ == ContentType::kAdPropertiesSequence; }
...
private:
    ...
    static constexpr const char* UnionNameInIDL() { return "(AdProperties or sequence<AdProperties>)"; }
