...
public:
    ...
    static RTCRtpEncodingParameters* Create(v8::Isolate* isolate) { return MakeGarbageCollected<RTCRtpEncodingParameters>(isolate); }
    ...
    bool hasActive() const { return true; }
    bool active() const { return member_active_; }
    void setActive(bool value) { member_active_ = value; }

    bool hasAdaptivePtime() const { return true; }
    bool adaptivePtime() const { return member_adaptive_ptime_; }
    void setAdaptivePtime(bool value) { member_adaptive_ptime_ = value; }
    ...
    bool hasMaxFramerate() const { return has_max_framerate_; }
    ...
    bool hasNetworkPriority() const { return true; }
    V8RTCPriorityType networkPriority() const { return member_network_priority_; }
    void setNetworkPriority(V8RTCPriorityType value) { member_network_priority_ = value; }
    void setNetworkPriority(V8RTCPriorityType::Enum value) { member_network_priority_ = V8RTCPriorityType(value); }

    bool hasPriority() const { return true; }
    V8RTCPriorityType priority() const { return member_priority_; }
    void setPriority(V8RTCPriorityType value) { member_priority_ = value; }
    void setPriority(V8RTCPriorityType::Enum value) { member_priority_ = V8RTCPriorityType(value); }
    ...
    void setNetworkPriority(const String& value) { member_network_priority_ = V8RTCPriorityType::Create(value).value(); }
    void setPriority(const String& value) { member_priority_ = V8RTCPriorityType::Create(value).value(); }
