...
public:
    ...
    static RequestDeviceOptions* Create(v8::Isolate* isolate) { return MakeGarbageCollected<RequestDeviceOptions>(isolate); }
    ...
    bool hasAcceptAllDevices() const { return true; }
    bool acceptAllDevices() const { return member_accept_all_devices_; }
    void setAcceptAllDevices(bool value) { member_accept_all_devices_ = value; }
    ...
    bool hasOptionalManufacturerData() const { return true; }
    const Vector<uint16_t>& optionalManufacturerData() const { return member_optional_manufacturer_data_; }
    void setOptionalManufacturerData(const Vector<uint16_t>& value);
    void setOptionalManufacturerData(Vector<uint16_t>&& value);

    bool hasOptionalServices() const { return true; }
    const HeapVector<Member<V8UnionStringOrUnsignedLong>>& optionalServices() const { return member_optional_services_; }
