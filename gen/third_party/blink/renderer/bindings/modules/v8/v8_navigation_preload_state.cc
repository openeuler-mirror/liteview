...
bool NavigationPreloadState::FillV8ObjectWithMembers(ScriptState* script_state, v8::Local<v8::Object> v8_dictionary) const
{
    ...
    if (hasEnabled()) {
        if (!ToV8Traits<IDLBoolean>::ToV8(script_state, member_enabled_).ToLocal(&v8_value)) {
            return false;
        }
    ...
    if (hasHeaderValue()) {
        if (!ToV8Traits<IDLByteString>::ToV8(script_state, member_header_value_).ToLocal(&v8_value)) {
            return false;
        }
...
void NavigationPreloadState::FillMembersFromV8Object(v8::Isolate* isolate, v8::Local<v8::Object> v8_dictionary, ExceptionState& exception_state)
{
    ...
    exception_context_scope.ChangePropertyNameAsOptimizationHack("enabled");
    ...
    if (!bindings::GetDictionaryMemberFromV8Object<IDLBoolean, is_optional>(
            isolate, current_context, v8_dictionary, v8_own_member_names[0].Get(isolate), fallback_presence_var, member_enabled_, try_block, exception_state)) {
        return;
    }
    exception_context_scope.ChangePropertyNameAsOptimizationHack("headerValue");
    if (!bindings::GetDictionaryMemberFromV8Object<IDLByteString, is_optional>(
            isolate, current_context, v8_dictionary, v8_own_member_names[1].Get(isolate), has_header_value_, member_header_value_, try_block, exception_state)) {
        return;
    }
}
