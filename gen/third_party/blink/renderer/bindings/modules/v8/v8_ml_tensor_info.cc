...
void MLTensorInfo::setDimensions(const Vector<uint32_t>& value) { member_dimensions_ = value; }

void MLTensorInfo::setDimensions(Vector<uint32_t>&& value) { member_dimensions_ = std::move(value); }

void MLTensorInfo::setName(const String& value) { member_name_ = value; }

void MLTensorInfo::setName(String&& value) { member_name_ = std::move(value); }
...
void MLTensorInfo::FillMembersFromV8Object(v8::Isolate* isolate, v8::Local<v8::Object> v8_dictionary, ExceptionState& exception_state)
{
    ...
    if (!bindings::GetDictionaryMemberFromV8Object<IDLSequence<IDLUnsignedLong>, is_required>(
            isolate, current_context, v8_dictionary, v8_own_member_names[0].Get(isolate), fallback_presence_var, member_dimensions_, try_block, exception_state)) {
        return;
    }
    ...
    if (!bindings::GetDictionaryMemberFromV8Object<V8MLDataType, is_required>(
