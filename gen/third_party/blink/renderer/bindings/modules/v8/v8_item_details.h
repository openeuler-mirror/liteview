...
public:
    ...
    static ItemDetails* Create(v8::Isolate* isolate) { return MakeGarbageCollected<ItemDetails>(isolate); }
    ...
    bool hasFreeTrialPeriod() const { return has_free_trial_period_; }
    ...
    bool hasIconURLs() const { return has_icon_urls_; }
    ...
    bool hasIntroductoryPrice() const { return has_introductory_price_; }
    ...
    bool hasIntroductoryPriceCycles() const { return has_introductory_price_cycles_; }
    ...
    bool hasIntroductoryPricePeriod() const { return has_introductory_price_period_; }
    ...
    bool hasItemId() const { return true; }
    const String& itemId() const { return member_item_id_; }
    void setItemId(const String& value);
    void setItemId(String&& value);

    bool hasPrice() const { return true; }
    PaymentCurrencyAmount* price() const { return member_price_; }
    ...
    bool hasSubscriptionPeriod() const { return has_subscription_period_; }
