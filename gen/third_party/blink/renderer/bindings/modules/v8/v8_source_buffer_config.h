...
class MODULES_EXPORT SourceBufferConfig : public bindings::DictionaryBase {

public:
    static SourceBufferConfig* Create() { return MakeGarbageCollected<SourceBufferConfig>(); }
    static SourceBufferConfig* Create(v8::Isolate* isolate) { return MakeGarbageCollected<SourceBufferConfig>(isolate); }
    ...
    bool hasAudioConfig() const { return has_audio_config_; }
    AudioDecoderConfig* audioConfig() const
    {
        DCHECK(hasAudioConfig());
        return member_audio_config_;
    }
    ...
    bool hasVideoConfig() const { return has_video_config_; }
    VideoDecoderConfig* videoConfig() const
    {
        DCHECK(hasVideoConfig());
        return member_video_config_;
    }
