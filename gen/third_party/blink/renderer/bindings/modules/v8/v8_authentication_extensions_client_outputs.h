...
public:
    ...
    static AuthenticationExtensionsClientOutputs* Create(v8::Isolate* isolate) { return MakeGarbageCollected<AuthenticationExtensionsClientOutputs>(isolate); }
    ...
    bool hasCredProps() const { return has_cred_props_; }
