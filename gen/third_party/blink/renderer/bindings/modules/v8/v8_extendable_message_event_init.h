...
public:
    ...
    static ExtendableMessageEventInit* Create(v8::Isolate* isolate) { return MakeGarbageCollected<ExtendableMessageEventInit>(isolate); }
    ...
    bool hasLastEventId() const { return has_last_event_id_; }
