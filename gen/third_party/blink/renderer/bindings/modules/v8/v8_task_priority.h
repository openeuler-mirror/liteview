...
public:
    ...
    static absl::optional<V8TaskPriority> Create(const String& value);
...
inline bool operator==(const V8TaskPriority& lhs, V8TaskPriority::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8TaskPriority::Enum lhs, const V8TaskPriority& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
