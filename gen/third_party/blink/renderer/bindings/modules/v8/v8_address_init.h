...
public:
    static AddressInit* Create() { return MakeGarbageCollected<AddressInit>(); }
    static AddressInit* Create(v8::Isolate* isolate) { return MakeGarbageCollected<AddressInit>(isolate); }
    ...
    bool hasCity() const { return has_city_; }
    ...
    bool hasCountry() const { return has_country_; }
    ...
    bool hasDependentLocality() const { return has_dependent_locality_; }
    ...
    bool hasOrganization() const { return has_organization_; }
    ...
    bool hasPhone() const { return has_phone_; }
    ...
    bool hasPostalCode() const { return has_postal_code_; }
    ...
    bool hasRecipient() const { return has_recipient_; }
    ...
    bool hasSortingCode() const { return has_sorting_code_; }
