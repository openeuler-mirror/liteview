...
class MODULES_EXPORT IDBObjectStoreParameters : public bindings::DictionaryBase {

public:
    static IDBObjectStoreParameters* Create() { return MakeGarbageCollected<IDBObjectStoreParameters>(); }
    static IDBObjectStoreParameters* Create(v8::Isolate* isolate) { return MakeGarbageCollected<IDBObjectStoreParameters>(isolate); }
    ...
    bool hasAutoIncrement() const { return true; }
    bool autoIncrement() const { return member_auto_increment_; }
    void setAutoIncrement(bool value) { member_auto_increment_ = value; }

    bool hasKeyPath() const { return true; }
    V8UnionStringOrStringSequence* keyPath() const { return member_key_path_; }
    void setKeyPath(V8UnionStringOrStringSequence* value) { member_key_path_ = value; }
