...
public:
    ...
    static NotificationAction* Create(v8::Isolate* isolate) { return MakeGarbageCollected<NotificationAction>(isolate); }
    ...
    bool hasAction() const { return true; }
    const String& action() const { return member_action_; }
    ...
    bool hasPlaceholder() const { return true; }
    const String& placeholder() const { return member_placeholder_; }
    ...
    V8NotificationActionType type() const { return member_type_; }
    void setType(V8NotificationActionType value) { member_type_ = value; }
    void setType(V8NotificationActionType::Enum value) { member_type_ = V8NotificationActionType(value); }
    // Obsolete accessor functions
    void setType(const String& value) { member_type_ = V8NotificationActionType::Create(value).value(); }
