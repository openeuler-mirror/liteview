...
public:
    static WindowControlsOverlayGeometryChangeEventInit* Create() { return MakeGarbageCollected<WindowControlsOverlayGeometryChangeEventInit>(); }
    static WindowControlsOverlayGeometryChangeEventInit* Create(v8::Isolate* isolate) { return MakeGarbageCollected<WindowControlsOverlayGeometryChangeEventInit>(isolate); }
    ...
    bool hasTitlebarAreaRect() const { return true; }
    DOMRect* titlebarAreaRect() const { return member_titlebar_area_rect_; }
    ...
    bool hasVisible() const { return true; }
    bool visible() const { return member_visible_; }
    void setVisible(bool value) { member_visible_ = value; }
