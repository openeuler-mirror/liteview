...
public:
    static GPURenderPassLayout* Create() { return MakeGarbageCollected<GPURenderPassLayout>(); }
    static GPURenderPassLayout* Create(v8::Isolate* isolate) { return MakeGarbageCollected<GPURenderPassLayout>(isolate); }
    ...
    bool hasColorFormats() const { return true; }
    const Vector<absl::optional<V8GPUTextureFormat>>& colorFormats() const { return member_color_formats_; }
    ...
    bool hasDepthStencilFormat() const { return has_depth_stencil_format_; }
