...
class MODULES_EXPORT FileSystemReadWriteOptions : public bindings::DictionaryBase {

public:
    static FileSystemReadWriteOptions* Create() { return MakeGarbageCollected<FileSystemReadWriteOptions>(); }
    static FileSystemReadWriteOptions* Create(v8::Isolate* isolate) { return MakeGarbageCollected<FileSystemReadWriteOptions>(isolate); }
    ...
    bool hasAt() const { return true; }
    uint64_t at() const { return member_at_; }
    void setAt(uint64_t value) { member_at_ = value; }
