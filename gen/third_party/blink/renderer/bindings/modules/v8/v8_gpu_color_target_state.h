...
class MODULES_EXPORT GPUColorTargetState : public bindings::DictionaryBase {

public:
    static GPUColorTargetState* Create() { return MakeGarbageCollected<GPUColorTargetState>(); }
    static GPUColorTargetState* Create(v8::Isolate* isolate) { return MakeGarbageCollected<GPUColorTargetState>(isolate); }
    ...
    bool hasBlend() const { return has_blend_; }
    GPUBlendState* blend() const
    {
        DCHECK(hasBlend());
        return member_blend_;
    }
    ...
    bool hasWriteMask() const { return true; }
    uint32_t writeMask() const { return member_write_mask_; }
    void setWriteMask(uint32_t value) { member_write_mask_ = value; }
