...
public:
    ...
    static PaymentDetailsModifier* Create(v8::Isolate* isolate) { return MakeGarbageCollected<PaymentDetailsModifier>(isolate); }
    ...
    bool hasSupportedMethod() const { return true; }
    const String& supportedMethod() const { return member_supported_method_; }
