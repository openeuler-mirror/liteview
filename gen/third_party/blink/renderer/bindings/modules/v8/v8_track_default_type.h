...
public:
    ...
    static absl::optional<V8TrackDefaultType> Create(const String& value);
...
inline bool operator==(const V8TrackDefaultType& lhs, V8TrackDefaultType::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8TrackDefaultType::Enum lhs, const V8TrackDefaultType& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
