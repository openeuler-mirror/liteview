...
bool V8PluginArray::IsExposed(ExecutionContext* execution_context) { return execution_context->IsWindow(); }
...
static_assert(std::is_same<decltype(&DOMPluginArray::HasPendingActivity), decltype(&ScriptWrappable::HasPendingActivity)>::value,
...
void V8PluginArray::NamedPropertySetterCallback(v8::Local<v8::Name> v8_property_name, v8::Local<v8::Value> v8_property_value, const v8::PropertyCallbackInfo<v8::Value>& info)
{
    ...
    if (!is_creating) {
        ...
        if (info.ShouldThrowOnError()) {
            ExceptionState exception_state(info.GetIsolate(), ExceptionContext::Context::kNamedPropertySet, "PluginArray");
...
void V8PluginArray::NamedPropertyDeleterCallback(v8::Local<v8::Name> v8_property_name, const v8::PropertyCallbackInfo<v8::Boolean>& info)
{
    ...
    ExceptionState exception_state(info.GetIsolate(), ExceptionContext::Context::kNamedPropertyDelete, "PluginArray");
...
void V8PluginArray::NamedPropertyDefinerCallback(
...
void V8PluginArray::NamedPropertyDescriptorCallback(v8::Local<v8::Name> v8_property_name, const v8::PropertyCallbackInfo<v8::Value>& info)
{
...
void V8PluginArray::NamedPropertyQueryCallback(v8::Local<v8::Name> v8_property_name, const v8::PropertyCallbackInfo<v8::Integer>& info)
{
    ...
    DOMPluginArray* blink_receiver = V8PluginArray::ToWrappableUnsafe(v8_receiver);
    const AtomicString& blink_property_name = ToCoreAtomicString(v8_property_name.As<v8::String>());
    ExceptionState exception_state(isolate, ExceptionContext::Context::kNamedPropertyGet, "PluginArray");
    bool does_exist = blink_receiver->NamedPropertyQuery(blink_property_name, exception_state);
    if (!does_exist)
        return; // Do not intercept.
...
void V8PluginArray::NamedPropertyEnumeratorCallback(const v8::PropertyCallbackInfo<v8::Array>& info)
{
    ...
    ExceptionState exception_state(info.GetIsolate(), ExceptionContext::Context::kNamedPropertyEnumerate, "PluginArray");
...
void V8PluginArray::IndexedPropertySetterCallback(uint32_t index, v8::Local<v8::Value> v8_property_value, const v8::PropertyCallbackInfo<v8::Value>& info)
{
    ...
    bindings::V8SetReturnValue(info, nullptr);
    if (info.ShouldThrowOnError()) {
        ExceptionState exception_state(info.GetIsolate(), ExceptionContext::Context::kIndexedPropertySet, "PluginArray");
        exception_state.ThrowTypeError("Indexed property setter is not supported.");
    }
}

void V8PluginArray::IndexedPropertyDeleterCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Boolean>& info)
{
    ...
    if (is_supported and info.ShouldThrowOnError()) {
        ExceptionState exception_state(info.GetIsolate(), ExceptionContext::Context::kIndexedPropertyDelete, "PluginArray");
        exception_state.ThrowTypeError("Index property deleter is not supported.");
    }
}

void V8PluginArray::IndexedPropertyDefinerCallback(uint32_t index, const v8::PropertyDescriptor& v8_property_desc, const v8::PropertyCallbackInfo<v8::Value>& info)
{
...
void V8PluginArray::IndexedPropertyDescriptorCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info)
{
...
void V8PluginArray::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template)
{
    ...
    // Named interceptors
    instance_object_template->SetHandler(v8::NamedPropertyHandlerConfiguration(V8PluginArray::NamedPropertyGetterCallback, V8PluginArray::NamedPropertySetterCallback,
    ...
    instance_object_template->SetHandler(v8::IndexedPropertyHandlerConfiguration(V8PluginArray::IndexedPropertyGetterCallback, V8PluginArray::IndexedPropertySetterCallback,
        nullptr, // query
    ...
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
...

    {
        static const IDLMemberInstaller::OperationConfig kOperationTable[] = {
            ...
            { "refresh", RefreshOperationCallback, 0, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
                unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck),
                unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasSideEffect) },
        };
