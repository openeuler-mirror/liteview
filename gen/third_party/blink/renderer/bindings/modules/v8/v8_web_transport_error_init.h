...
class MODULES_EXPORT WebTransportErrorInit : public bindings::DictionaryBase {

public:
    static WebTransportErrorInit* Create() { return MakeGarbageCollected<WebTransportErrorInit>(); }
    static WebTransportErrorInit* Create(v8::Isolate* isolate) { return MakeGarbageCollected<WebTransportErrorInit>(isolate); }
    ...
    bool hasStreamErrorCode() const { return has_stream_error_code_; }
