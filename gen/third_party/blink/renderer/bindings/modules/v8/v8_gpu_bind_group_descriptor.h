...
public:
    ...
    static GPUBindGroupDescriptor* Create(v8::Isolate* isolate) { return MakeGarbageCollected<GPUBindGroupDescriptor>(isolate); }
    ...
    bool hasEntries() const { return true; }
    const HeapVector<Member<GPUBindGroupEntry>>& entries() const { return member_entries_; }
    ...
    GPUBindGroupLayout* layout() const { return member_layout_; }
