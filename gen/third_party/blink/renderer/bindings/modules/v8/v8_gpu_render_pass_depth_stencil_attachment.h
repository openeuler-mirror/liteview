...
public:
    static GPURenderPassDepthStencilAttachment* Create() { return MakeGarbageCollected<GPURenderPassDepthStencilAttachment>(); }
    static GPURenderPassDepthStencilAttachment* Create(v8::Isolate* isolate) { return MakeGarbageCollected<GPURenderPassDepthStencilAttachment>(isolate); }
    ...
    bool hasDepthClearValue() const { return true; }
    float depthClearValue() const { return member_depth_clear_value_; }
    void setDepthClearValue(float value) { member_depth_clear_value_ = value; }

    bool hasDepthLoadOp() const { return has_depth_load_op_; }
    ...
    bool hasDepthLoadValue() const { return has_depth_load_value_; }
    ...
    bool hasDepthReadOnly() const { return true; }
    bool depthReadOnly() const { return member_depth_read_only_; }
    void setDepthReadOnly(bool value) { member_depth_read_only_ = value; }

    bool hasDepthStoreOp() const { return has_depth_store_op_; }
    ...
    bool hasStencilClearValue() const { return true; }
    uint32_t stencilClearValue() const { return member_stencil_clear_value_; }
    void setStencilClearValue(uint32_t value) { member_stencil_clear_value_ = value; }

    bool hasStencilLoadOp() const { return has_stencil_load_op_; }
    ...
    bool hasStencilLoadValue() const { return has_stencil_load_value_; }
    ...
    bool hasStencilReadOnly() const { return true; }
    bool stencilReadOnly() const { return member_stencil_read_only_; }
    void setStencilReadOnly(bool value) { member_stencil_read_only_ = value; }

    bool hasStencilStoreOp() const { return has_stencil_store_op_; }
