...
V8UnionCanvasFilterOrString* V8UnionCanvasFilterOrString::Create(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, ExceptionState& exception_state)
{
    if (V8CanvasFilter::HasInstance(isolate, v8_value)) {
        auto&& blink_value = V8CanvasFilter::ToWrappableUnsafe(v8_value.As<v8::Object>());
...
v8::MaybeLocal<v8::Value> V8UnionCanvasFilterOrString::ToV8Value(ScriptState* script_state) const
{
    switch (content_type_) {
    case ContentType::kCanvasFilter: {
        return ToV8Traits<CanvasFilter>::ToV8(script_state, member_canvas_filter_);
    }
