...
public:
    static MLGemmOptions* Create() { return MakeGarbageCollected<MLGemmOptions>(); }
    static MLGemmOptions* Create(v8::Isolate* isolate) { return MakeGarbageCollected<MLGemmOptions>(isolate); }
    ...
    bool hasATranspose() const { return true; }
    bool aTranspose() const { return member_a_transpose_; }
    void setATranspose(bool value) { member_a_transpose_ = value; }

    bool hasAlpha() const { return true; }
    float alpha() const { return member_alpha_; }
    void setAlpha(float value) { member_alpha_ = value; }

    bool hasBTranspose() const { return true; }
    bool bTranspose() const { return member_b_transpose_; }
    void setBTranspose(bool value) { member_b_transpose_ = value; }

    bool hasBeta() const { return true; }
    float beta() const { return member_beta_; }
    void setBeta(float value) { member_beta_ = value; }
