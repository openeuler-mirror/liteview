...
public:
    static GPUImageCopyExternalImage* Create() { return MakeGarbageCollected<GPUImageCopyExternalImage>(); }
    static GPUImageCopyExternalImage* Create(v8::Isolate* isolate) { return MakeGarbageCollected<GPUImageCopyExternalImage>(isolate); }
    ...
    bool hasFlipY() const { return true; }
    bool flipY() const { return member_flip_y_; }
    void setFlipY(bool value) { member_flip_y_ = value; }

    bool hasOrigin() const { return true; }
    V8UnionGPUOrigin2DDictOrUnsignedLongEnforceRangeSequence* origin() const { return member_origin_; }
    ...
    V8UnionHTMLCanvasElementOrImageBitmapOrOffscreenCanvas* source() const { return member_source_; }
