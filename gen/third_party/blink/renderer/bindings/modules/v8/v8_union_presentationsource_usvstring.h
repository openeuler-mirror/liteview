...
public:
    ...
    bool IsPresentationSource() const { return content_type_ == ContentType::kPresentationSource; }
...
private:
    ...
    static constexpr const char* UnionNameInIDL() { return "(PresentationSource or USVString)"; }
