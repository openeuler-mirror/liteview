...
const char* V8RTCStatsCallback::NameInHeapSnapshot() const { return "V8RTCStatsCallback"; }

v8::Maybe<void> V8RTCStatsCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, RTCStatsResponse* arg1_response)
{
    const char* const class_like_name = "RTCStatsCallback";
    ...
    v8::Local<v8::Value> v8_arg1_response;
    ScriptState* script_state = CallbackRelevantScriptState();
    if (!ToV8Traits<RTCStatsResponse>::ToV8(script_state, arg1_response).ToLocal(&v8_arg1_response)) {
        return v8::Nothing<void>();
    }
    argv[0] = v8_arg1_response;
...
v8::Maybe<void> V8RTCStatsCallback::Construct(RTCStatsResponse* arg1_response)
{
    const char* const class_like_name = "RTCStatsCallback";
...
void V8RTCStatsCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, RTCStatsResponse* arg1_response)
{
    v8::Isolate* isolate = GetIsolate();
    v8::TryCatch try_catch(isolate);
    try_catch.SetVerbose(true);

    std::ignore = Invoke(arg0_receiver, arg1_response);
}
