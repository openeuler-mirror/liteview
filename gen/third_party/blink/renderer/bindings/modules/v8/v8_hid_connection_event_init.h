...
public:
    ...
    static HIDConnectionEventInit* Create(v8::Isolate* isolate) { return MakeGarbageCollected<HIDConnectionEventInit>(isolate); }
    ...
    HIDDevice* device() const { return member_device_; }
