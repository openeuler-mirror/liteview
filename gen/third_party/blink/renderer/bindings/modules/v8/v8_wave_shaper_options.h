...
public:
    ...
    static WaveShaperOptions* Create(v8::Isolate* isolate) { return MakeGarbageCollected<WaveShaperOptions>(isolate); }
    ...
    bool hasOversample() const { return true; }
    V8OverSampleType oversample() const { return member_oversample_; }
    void setOversample(V8OverSampleType value) { member_oversample_ = value; }
    void setOversample(V8OverSampleType::Enum value) { member_oversample_ = V8OverSampleType(value); }
    // Obsolete accessor functions
    void setOversample(const String& value) { member_oversample_ = V8OverSampleType::Create(value).value(); }
