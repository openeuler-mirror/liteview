...
public:
    static GPUImageCopyTexture* Create() { return MakeGarbageCollected<GPUImageCopyTexture>(); }
    static GPUImageCopyTexture* Create(v8::Isolate* isolate) { return MakeGarbageCollected<GPUImageCopyTexture>(isolate); }
    ...
    bool hasMipLevel() const { return true; }
    uint32_t mipLevel() const { return member_mip_level_; }
    void setMipLevel(uint32_t value) { member_mip_level_ = value; }

    bool hasOrigin() const { return true; }
    V8UnionGPUOrigin3DDictOrUnsignedLongEnforceRangeSequence* origin() const { return member_origin_; }
    ...
    GPUTexture* texture() const { return member_texture_; }
