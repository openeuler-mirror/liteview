...
bool V8PaintRenderingContext2D::IsExposed(ExecutionContext* execution_context) { return execution_context->IsPaintWorkletGlobalScope(); }
...
static_assert(std::is_same<decltype(&PaintRenderingContext2D::HasPendingActivity), decltype(&ScriptWrappable::HasPendingActivity)>::value,
...
void IsPointInPathOperationOverload1(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    bindings::V8SetReturnValue(info, return_value, bindings::V8ReturnValue::PrimitiveType<bool>());
    // [HighEntropy]
    Dactyloscoper::Record(current_execution_context, WebFeature::kV8PaintRenderingContext2D_IsPointInPath_Method);
}
...
void IsPointInStrokeOperationOverload1(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    bindings::V8SetReturnValue(info, return_value, bindings::V8ReturnValue::PrimitiveType<bool>());
    // [HighEntropy]
    Dactyloscoper::Record(current_execution_context, WebFeature::kV8PaintRenderingContext2D_IsPointInStroke_Method);
}
...
void V8PaintRenderingContext2D::InstallContextIndependentProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template,
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
    using bindings::IDLMemberInstaller;
