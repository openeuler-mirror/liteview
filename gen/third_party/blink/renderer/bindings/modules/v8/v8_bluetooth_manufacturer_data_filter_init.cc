...
bool BluetoothManufacturerDataFilterInit::FillV8ObjectWithMembers(ScriptState* script_state, v8::Local<v8::Object> v8_dictionary) const
{
    ...
    if (hasCompanyIdentifier()) {
        ...
        if (!ToV8Traits<IDLUnsignedShortEnforceRange>::ToV8(script_state, member_company_identifier_).ToLocal(&v8_value)) {
            return false;
        }
...
void BluetoothManufacturerDataFilterInit::FillMembersFromV8Object(v8::Isolate* isolate, v8::Local<v8::Object> v8_dictionary, ExceptionState& exception_state)
{
    ...
    exception_context_scope.ChangePropertyNameAsOptimizationHack("companyIdentifier");
    ...
    if (!bindings::GetDictionaryMemberFromV8Object<IDLUnsignedShortEnforceRange, is_required>(
            isolate, current_context, v8_dictionary, v8_own_member_names[0].Get(isolate), fallback_presence_var, member_company_identifier_, try_block, exception_state)) {
        return;
    }
}
