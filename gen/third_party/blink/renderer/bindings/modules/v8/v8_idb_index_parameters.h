...
class MODULES_EXPORT IDBIndexParameters : public bindings::DictionaryBase {

public:
    static IDBIndexParameters* Create() { return MakeGarbageCollected<IDBIndexParameters>(); }
    static IDBIndexParameters* Create(v8::Isolate* isolate) { return MakeGarbageCollected<IDBIndexParameters>(isolate); }
    ...
    bool hasMultiEntry() const { return true; }
    bool multiEntry() const { return member_multi_entry_; }
    void setMultiEntry(bool value) { member_multi_entry_ = value; }

    bool hasUnique() const { return true; }
    bool unique() const { return member_unique_; }
    void setUnique(bool value) { member_unique_ = value; }
