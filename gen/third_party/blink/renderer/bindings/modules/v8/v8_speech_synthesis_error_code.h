...
inline bool operator==(const V8SpeechSynthesisErrorCode& lhs, V8SpeechSynthesisErrorCode::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8SpeechSynthesisErrorCode::Enum lhs, const V8SpeechSynthesisErrorCode& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
