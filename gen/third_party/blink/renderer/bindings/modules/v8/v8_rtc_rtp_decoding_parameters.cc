...
void RTCRtpDecodingParameters::Trace(Visitor* visitor) const { RTCRtpCodingParameters::Trace(visitor); }

bool RTCRtpDecodingParameters::FillV8ObjectWithMembers(ScriptState* script_state, v8::Local<v8::Object> v8_dictionary) const
{
...
const base::span<const v8::Eternal<v8::Name>> RTCRtpDecodingParameters::GetV8OwnMemberNames(v8::Isolate* isolate) { return {}; }
