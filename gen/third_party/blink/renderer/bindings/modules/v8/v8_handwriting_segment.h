...
public:
    static HandwritingSegment* Create() { return MakeGarbageCollected<HandwritingSegment>(); }
    static HandwritingSegment* Create(v8::Isolate* isolate) { return MakeGarbageCollected<HandwritingSegment>(isolate); }
    ...
    bool hasBeginIndex() const { return true; }
    uint32_t beginIndex() const { return member_begin_index_; }
    void setBeginIndex(uint32_t value) { member_begin_index_ = value; }

    bool hasDrawingSegments() const { return true; }
    const HeapVector<Member<HandwritingDrawingSegment>>& drawingSegments() const { return member_drawing_segments_; }
    ...
    bool hasEndIndex() const { return true; }
    uint32_t endIndex() const { return member_end_index_; }
    void setEndIndex(uint32_t value) { member_end_index_ = value; }

    bool hasGrapheme() const { return true; }
    const String& grapheme() const { return member_grapheme_; }
