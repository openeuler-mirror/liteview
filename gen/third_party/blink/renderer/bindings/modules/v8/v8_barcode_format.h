...
public:
    ...
    static absl::optional<V8BarcodeFormat> Create(const String& value);
...
inline bool operator==(const V8BarcodeFormat& lhs, V8BarcodeFormat::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8BarcodeFormat::Enum lhs, const V8BarcodeFormat& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
