...
public:
    ...
    static PresentationConnectionCloseEventInit* Create(v8::Isolate* isolate) { return MakeGarbageCollected<PresentationConnectionCloseEventInit>(isolate); }
    ...
    V8PresentationConnectionCloseReason reason() const { return member_reason_; }
    void setReason(V8PresentationConnectionCloseReason value) { member_reason_ = value; }
    void setReason(V8PresentationConnectionCloseReason::Enum value) { member_reason_ = V8PresentationConnectionCloseReason(value); }
    // Obsolete accessor functions
    void setReason(const String& value) { member_reason_ = V8PresentationConnectionCloseReason::Create(value).value(); }
