...
inline bool operator==(const V8XRHitTestTrackableType& lhs, V8XRHitTestTrackableType::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8XRHitTestTrackableType::Enum lhs, const V8XRHitTestTrackableType& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
