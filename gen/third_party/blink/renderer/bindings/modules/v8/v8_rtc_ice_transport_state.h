...
public:
    ...
    static absl::optional<V8RTCIceTransportState> Create(const String& value);
...
inline bool operator==(const V8RTCIceTransportState& lhs, V8RTCIceTransportState::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8RTCIceTransportState::Enum lhs, const V8RTCIceTransportState& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
