...
public:
    ...
    bool IsIDBCursor() const { return content_type_ == ContentType::kIDBCursor; }
    ...
    bool IsIDBIndex() const { return content_type_ == ContentType::kIDBIndex; }
    ...
    bool IsIDBObjectStore() const { return content_type_ == ContentType::kIDBObjectStore; }
    ...
    bool IsV8UnionIDBIndexOrIDBObjectStore() const { return content_type_ == ContentType::kIDBIndex || content_type_ == ContentType::kIDBObjectStore; }
...
private:
    ...
    static constexpr const char* UnionNameInIDL() { return "(IDBCursor or IDBIndex or IDBObjectStore)"; }
