...
public:
    static PaymentCredentialInstrument* Create() { return MakeGarbageCollected<PaymentCredentialInstrument>(); }
    static PaymentCredentialInstrument* Create(v8::Isolate* isolate) { return MakeGarbageCollected<PaymentCredentialInstrument>(isolate); }
    ...
    bool hasDisplayName() const { return true; }
    const String& displayName() const { return member_display_name_; }
    void setDisplayName(const String& value);
    void setDisplayName(String&& value);

    bool hasIcon() const { return true; }
    const String& icon() const { return member_icon_; }
    void setIcon(const String& value);
    void setIcon(String&& value);

    bool hasIconMustBeShown() const { return true; }
    bool iconMustBeShown() const { return member_icon_must_be_shown_; }
    void setIconMustBeShown(bool value) { member_icon_must_be_shown_ = value; }
