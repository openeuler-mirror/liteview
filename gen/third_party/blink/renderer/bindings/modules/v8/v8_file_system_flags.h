...
class MODULES_EXPORT FileSystemFlags : public bindings::DictionaryBase {

public:
    static FileSystemFlags* Create() { return MakeGarbageCollected<FileSystemFlags>(); }
    static FileSystemFlags* Create(v8::Isolate* isolate) { return MakeGarbageCollected<FileSystemFlags>(isolate); }
    ...
    bool hasCreateFlag() const { return true; }
    bool createFlag() const { return member_create_flag_; }
    void setCreateFlag(bool value) { member_create_flag_ = value; }

    bool hasExclusive() const { return true; }
    bool exclusive() const { return member_exclusive_; }
    void setExclusive(bool value) { member_exclusive_ = value; }
