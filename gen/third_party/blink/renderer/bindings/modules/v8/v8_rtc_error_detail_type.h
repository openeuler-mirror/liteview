...
public:
    ...
    static absl::optional<V8RTCErrorDetailType> Create(const String& value);
...
inline bool operator==(const V8RTCErrorDetailType& lhs, V8RTCErrorDetailType::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8RTCErrorDetailType::Enum lhs, const V8RTCErrorDetailType& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
