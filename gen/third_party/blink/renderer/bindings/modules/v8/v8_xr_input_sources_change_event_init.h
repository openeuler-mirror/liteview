...
public:
    ...
    static XRInputSourcesChangeEventInit* Create(v8::Isolate* isolate) { return MakeGarbageCollected<XRInputSourcesChangeEventInit>(isolate); }
    ...
    bool hasAdded() const { return true; }
    const HeapVector<Member<XRInputSource>>& added() const { return member_added_; }
    void setAdded(const HeapVector<Member<XRInputSource>>& value);
    void setAdded(HeapVector<Member<XRInputSource>>&& value);

    bool hasRemoved() const { return true; }
    const HeapVector<Member<XRInputSource>>& removed() const { return member_removed_; }
    ...
    XRSession* session() const { return member_session_; }
