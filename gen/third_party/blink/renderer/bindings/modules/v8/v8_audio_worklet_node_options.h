...
public:
    ...
    static AudioWorkletNodeOptions* Create(v8::Isolate* isolate) { return MakeGarbageCollected<AudioWorkletNodeOptions>(isolate); }
    ...
    bool hasNumberOfInputs() const { return true; }
    uint32_t numberOfInputs() const { return member_number_of_inputs_; }
    void setNumberOfInputs(uint32_t value) { member_number_of_inputs_ = value; }

    bool hasNumberOfOutputs() const { return true; }
    uint32_t numberOfOutputs() const { return member_number_of_outputs_; }
    void setNumberOfOutputs(uint32_t value) { member_number_of_outputs_ = value; }
    ...
    bool hasProcessorOptions() const { return !member_processor_options_.IsEmpty(); }
