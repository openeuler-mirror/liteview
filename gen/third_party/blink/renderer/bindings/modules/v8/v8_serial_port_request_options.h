...
class MODULES_EXPORT SerialPortRequestOptions : public bindings::DictionaryBase {

public:
    static SerialPortRequestOptions* Create() { return MakeGarbageCollected<SerialPortRequestOptions>(); }
    static SerialPortRequestOptions* Create(v8::Isolate* isolate) { return MakeGarbageCollected<SerialPortRequestOptions>(isolate); }
