...
public:
    static HIDReportInfo* Create() { return MakeGarbageCollected<HIDReportInfo>(); }
    static HIDReportInfo* Create(v8::Isolate* isolate) { return MakeGarbageCollected<HIDReportInfo>(isolate); }
    ...
    bool hasItems() const { return has_items_; }
