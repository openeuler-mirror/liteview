...
public:
    ...
    static absl::optional<V8GPUPowerPreference> Create(const String& value);
...
inline bool operator==(const V8GPUPowerPreference& lhs, V8GPUPowerPreference::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8GPUPowerPreference::Enum lhs, const V8GPUPowerPreference& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
