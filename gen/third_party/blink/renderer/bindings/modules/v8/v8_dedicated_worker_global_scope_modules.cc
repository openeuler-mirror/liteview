...
void V8DedicatedWorkerGlobalScope::Impl::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template,
...
//             { "WebSocket", WebSocketExposedConstructCallback },
...

    {
        static const IDLMemberInstaller::OperationConfig kOperationTable[] = {
            ...
            { "postMessage", PostMessageOperationCallback, 1, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kInstance),
                unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck),
                unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasSideEffect) },
...
void V8DedicatedWorkerGlobalScope::Impl::InstallContextIndependentProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template,
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
    using bindings::IDLMemberInstaller;
...
void V8DedicatedWorkerGlobalScope::Impl::InstallContextDependentProperties(v8::Local<v8::Context> context, const DOMWrapperWorld& world, v8::Local<v8::Object> instance_object,
...
//         && ((feature_selector.IsAll() && RuntimeEnabledFeatures::WebCodecsEnabled(execution_context)) || feature_selector.IsAnyOf(OriginTrialFeature::kWebCodecs))) {
//         static const IDLMemberInstaller::ExposedConstructConfig kExposedConstructTable[] = {
...
//         IDLMemberInstaller::InstallExposedConstructs(isolate, world, instance_object, prototype_object, interface_object, signature, kExposedConstructTable);
//     }
//     if ((feature_selector.IsAll() && RuntimeEnabledFeatures::MediaSourceInWorkersEnabled(execution_context))
//         || feature_selector.IsAnyOf(OriginTrialFeature::kMediaSourceInWorkers)) {
//         static const IDLMemberInstaller::ExposedConstructConfig kExposedConstructTable[] = {
