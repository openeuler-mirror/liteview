...
public:
    ...
    static IIRFilterOptions* Create(v8::Isolate* isolate) { return MakeGarbageCollected<IIRFilterOptions>(isolate); }
    ...
    bool hasFeedback() const { return true; }
    const Vector<double>& feedback() const { return member_feedback_; }
    void setFeedback(const Vector<double>& value);
    void setFeedback(Vector<double>&& value);

    bool hasFeedforward() const { return true; }
    const Vector<double>& feedforward() const { return member_feedforward_; }
