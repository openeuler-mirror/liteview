...
public:
    ...
    static absl::optional<V8OverSampleType> Create(const String& value);
...
inline bool operator==(const V8OverSampleType& lhs, V8OverSampleType::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8OverSampleType::Enum lhs, const V8OverSampleType& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
