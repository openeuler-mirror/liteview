...
public:
    ...
    static CookieListItem* Create(v8::Isolate* isolate) { return MakeGarbageCollected<CookieListItem>(isolate); }
    ...
    bool hasDomain() const { return has_domain_; }
    ...
    absl::optional<uint64_t> getExpiresOr(const absl::optional<uint64_t>& fallback_value) const
    {
        if (!hasExpires()) {
    ...
    bool hasPartitioned() const { return has_partitioned_; }
    ...
    bool hasSameParty() const { return has_same_party_; }
    bool sameParty() const
    {
        DCHECK(hasSameParty());
        return member_same_party_;
    }
    bool getSamePartyOr(bool fallback_value) const
    {
        if (!hasSameParty()) {
            return fallback_value;
        }
    ...
    void setSameParty(bool value)
    {
        ...
        has_same_party_ = true;
    }

    bool hasSameSite() const { return has_same_site_; }
