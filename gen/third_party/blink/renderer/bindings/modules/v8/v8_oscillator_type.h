...
public:
    ...
    static absl::optional<V8OscillatorType> Create(const String& value);
...
inline bool operator==(const V8OscillatorType& lhs, V8OscillatorType::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8OscillatorType::Enum lhs, const V8OscillatorType& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
