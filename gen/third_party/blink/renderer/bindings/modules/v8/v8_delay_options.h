...
public:
    ...
    static DelayOptions* Create(v8::Isolate* isolate) { return MakeGarbageCollected<DelayOptions>(isolate); }
    ...
    bool hasDelayTime() const { return true; }
    double delayTime() const { return member_delay_time_; }
    void setDelayTime(double value) { member_delay_time_ = value; }

    bool hasMaxDelayTime() const { return true; }
    double maxDelayTime() const { return member_max_delay_time_; }
    void setMaxDelayTime(double value) { member_max_delay_time_ = value; }
