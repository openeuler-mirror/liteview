...
public:
    ...
    static absl::optional<V8RTCIceComponent> Create(const String& value);
...
inline bool operator==(const V8RTCIceComponent& lhs, V8RTCIceComponent::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8RTCIceComponent::Enum lhs, const V8RTCIceComponent& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
