...
public:
    ...
    static AudioNodeOptions* Create(v8::Isolate* isolate) { return MakeGarbageCollected<AudioNodeOptions>(isolate); }
    ...
    bool hasChannelCountMode() const { return has_channel_count_mode_; }
    ...
    bool hasChannelInterpretation() const { return has_channel_interpretation_; }
