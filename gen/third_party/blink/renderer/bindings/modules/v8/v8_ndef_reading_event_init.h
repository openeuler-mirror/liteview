...
public:
    ...
    static NDEFReadingEventInit* Create(v8::Isolate* isolate) { return MakeGarbageCollected<NDEFReadingEventInit>(isolate); }
    ...
    NDEFMessageInit* message() const { return member_message_; }
    ...
    bool hasSerialNumber() const { return true; }
    const String& serialNumber() const { return member_serial_number_; }
