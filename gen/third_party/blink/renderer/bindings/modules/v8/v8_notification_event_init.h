...
public:
    ...
    static NotificationEventInit* Create(v8::Isolate* isolate) { return MakeGarbageCollected<NotificationEventInit>(isolate); }
    ...
    bool hasNotification() const { return true; }
    Notification* notification() const { return member_notification_; }
    ...
    bool hasReply() const { return true; }
    const String& reply() const { return member_reply_; }
