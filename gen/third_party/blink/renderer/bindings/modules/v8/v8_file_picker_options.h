...
public:
    static FilePickerOptions* Create() { return MakeGarbageCollected<FilePickerOptions>(); }
    static FilePickerOptions* Create(v8::Isolate* isolate) { return MakeGarbageCollected<FilePickerOptions>(isolate); }
    ...
    bool hasExcludeAcceptAllOption() const { return true; }
    bool excludeAcceptAllOption() const { return member_exclude_accept_all_option_; }
    void setExcludeAcceptAllOption(bool value) { member_exclude_accept_all_option_ = value; }
