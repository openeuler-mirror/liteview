...
bool V8RTCEncodedAudioFrame::IsExposed(ExecutionContext* execution_context) { return execution_context->IsWindow() || execution_context->IsDedicatedWorkerGlobalScope(); }
...
static_assert(std::is_same<decltype(&RTCEncodedAudioFrame::HasPendingActivity), decltype(&ScriptWrappable::HasPendingActivity)>::value,
