...
public:
    static AuthenticationExtensionsPaymentInputs* Create() { return MakeGarbageCollected<AuthenticationExtensionsPaymentInputs>(); }
    static AuthenticationExtensionsPaymentInputs* Create(v8::Isolate* isolate) { return MakeGarbageCollected<AuthenticationExtensionsPaymentInputs>(isolate); }
    ...
    bool hasIsPayment() const { return has_is_payment_; }
