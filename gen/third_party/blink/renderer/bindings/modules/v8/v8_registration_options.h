...
public:
    ...
    static RegistrationOptions* Create(v8::Isolate* isolate) { return MakeGarbageCollected<RegistrationOptions>(isolate); }
    ...
    V8WorkerType type() const { return member_type_; }
    void setType(V8WorkerType value) { member_type_ = value; }
    void setType(V8WorkerType::Enum value) { member_type_ = V8WorkerType(value); }

    bool hasUpdateViaCache() const { return true; }
    V8ServiceWorkerUpdateViaCache updateViaCache() const { return member_update_via_cache_; }
    void setUpdateViaCache(V8ServiceWorkerUpdateViaCache value) { member_update_via_cache_ = value; }
    void setUpdateViaCache(V8ServiceWorkerUpdateViaCache::Enum value) { member_update_via_cache_ = V8ServiceWorkerUpdateViaCache(value); }
    // Obsolete accessor functions
    void setType(const String& value) { member_type_ = V8WorkerType::Create(value).value(); }
    void setUpdateViaCache(const String& value) { member_update_via_cache_ = V8ServiceWorkerUpdateViaCache::Create(value).value(); }
