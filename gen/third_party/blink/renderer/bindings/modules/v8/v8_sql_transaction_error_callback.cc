...
const char* V8SQLTransactionErrorCallback::NameInHeapSnapshot() const { return "V8SQLTransactionErrorCallback"; }
...
v8::Maybe<void> V8SQLTransactionErrorCallback::handleEvent(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, SQLError* arg1_error)
{
    ...
    if (!ToV8Traits<SQLError>::ToV8(script_state, arg1_error).ToLocal(&v8_arg1_error)) {
        return v8::Nothing<void>();
    }
