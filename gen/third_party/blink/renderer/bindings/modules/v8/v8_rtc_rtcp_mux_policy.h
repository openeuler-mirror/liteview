...
public:
    ...
    static absl::optional<V8RTCRtcpMuxPolicy> Create(const String& value);
...
inline bool operator==(const V8RTCRtcpMuxPolicy& lhs, V8RTCRtcpMuxPolicy::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8RTCRtcpMuxPolicy::Enum lhs, const V8RTCRtcpMuxPolicy& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
