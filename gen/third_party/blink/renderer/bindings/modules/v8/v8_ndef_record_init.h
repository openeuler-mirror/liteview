...
public:
    ...
    static NDEFRecordInit* Create(v8::Isolate* isolate) { return MakeGarbageCollected<NDEFRecordInit>(isolate); }
    ...
    bool hasEncoding() const { return has_encoding_; }
    ...
    bool hasLang() const { return has_lang_; }
    ...
    bool hasMediaType() const { return has_media_type_; }
    ...
    bool hasRecordType() const { return true; }
    const String& recordType() const { return member_record_type_; }
