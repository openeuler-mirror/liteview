...
public:
    static MediaSettingsRange* Create() { return MakeGarbageCollected<MediaSettingsRange>(); }
    static MediaSettingsRange* Create(v8::Isolate* isolate) { return MakeGarbageCollected<MediaSettingsRange>(isolate); }
