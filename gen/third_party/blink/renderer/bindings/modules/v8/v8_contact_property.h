...
inline bool operator==(const V8ContactProperty& lhs, V8ContactProperty::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8ContactProperty::Enum lhs, const V8ContactProperty& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
