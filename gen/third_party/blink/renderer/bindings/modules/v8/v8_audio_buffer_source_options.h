...
public:
    ...
    static AudioBufferSourceOptions* Create(v8::Isolate* isolate) { return MakeGarbageCollected<AudioBufferSourceOptions>(isolate); }
    ...
    bool hasLoop() const { return true; }
    bool loop() const { return member_loop_; }
    void setLoop(bool value) { member_loop_ = value; }

    bool hasLoopEnd() const { return true; }
    double loopEnd() const { return member_loop_end_; }
    void setLoopEnd(double value) { member_loop_end_ = value; }

    bool hasLoopStart() const { return true; }
    double loopStart() const { return member_loop_start_; }
    void setLoopStart(double value) { member_loop_start_ = value; }

    bool hasPlaybackRate() const { return true; }
    float playbackRate() const { return member_playback_rate_; }
    void setPlaybackRate(float value) { member_playback_rate_ = value; }
