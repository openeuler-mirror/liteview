...
public:
    ...
    static absl::optional<V8RTCIceConnectionState> Create(const String& value);
...
inline bool operator==(const V8RTCIceConnectionState& lhs, V8RTCIceConnectionState::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8RTCIceConnectionState::Enum lhs, const V8RTCIceConnectionState& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
