...
class MODULES_EXPORT XRTrackedImageInit : public bindings::DictionaryBase {

public:
    static XRTrackedImageInit* Create() { return MakeGarbageCollected<XRTrackedImageInit>(); }
    static XRTrackedImageInit* Create(v8::Isolate* isolate) { return MakeGarbageCollected<XRTrackedImageInit>(isolate); }
    ...
    ImageBitmap* image() const { return member_image_; }
    ...
    bool hasWidthInMeters() const { return true; }
    float widthInMeters() const { return member_width_in_meters_; }
    void setWidthInMeters(float value) { member_width_in_meters_ = value; }
