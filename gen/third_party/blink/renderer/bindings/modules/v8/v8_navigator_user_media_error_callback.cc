...
const char* V8NavigatorUserMediaErrorCallback::NameInHeapSnapshot() const { return "V8NavigatorUserMediaErrorCallback"; }
...
v8::Maybe<void> V8NavigatorUserMediaErrorCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const V8UnionDOMExceptionOrOverconstrainedError* arg1_error)
{
    ...
    if (!ToV8Traits<V8UnionDOMExceptionOrOverconstrainedError>::ToV8(script_state, arg1_error).ToLocal(&v8_arg1_error)) {
        return v8::Nothing<void>();
    }
