...
public:
    ...
    static absl::optional<V8RTCSdpType> Create(const String& value);
...
inline bool operator==(const V8RTCSdpType& lhs, V8RTCSdpType::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8RTCSdpType::Enum lhs, const V8RTCSdpType& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
