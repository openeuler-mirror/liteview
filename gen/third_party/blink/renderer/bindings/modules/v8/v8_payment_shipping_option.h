...
public:
    ...
    static PaymentShippingOption* Create(v8::Isolate* isolate) { return MakeGarbageCollected<PaymentShippingOption>(isolate); }
    ...
    bool hasAmount() const { return true; }
    PaymentCurrencyAmount* amount() const { return member_amount_; }
    ...
    bool hasSelected() const { return true; }
    bool selected() const { return member_selected_; }
    void setSelected(bool value) { member_selected_ = value; }
