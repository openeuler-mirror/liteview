...
public:
    ...
    static BackgroundFetchUIOptions* Create(v8::Isolate* isolate) { return MakeGarbageCollected<BackgroundFetchUIOptions>(isolate); }
    ...
    const HeapVector<Member<ManifestImageResource>>& icons() const { return member_icons_; }
