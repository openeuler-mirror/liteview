...
public:
    ...
    static absl::optional<V8HIDUnitSystem> Create(const String& value);
...
inline bool operator==(const V8HIDUnitSystem& lhs, V8HIDUnitSystem::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8HIDUnitSystem::Enum lhs, const V8HIDUnitSystem& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
