...
public:
    static GPUCommandBufferDescriptor* Create() { return MakeGarbageCollected<GPUCommandBufferDescriptor>(); }
    static GPUCommandBufferDescriptor* Create(v8::Isolate* isolate) { return MakeGarbageCollected<GPUCommandBufferDescriptor>(isolate); }
