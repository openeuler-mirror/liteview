...
public:
    ...
    static CableAuthenticationData* Create(v8::Isolate* isolate) { return MakeGarbageCollected<CableAuthenticationData>(isolate); }
    ...
    bool hasAuthenticatorEid() const { return true; }
    V8UnionArrayBufferOrArrayBufferView* authenticatorEid() const { return member_authenticator_eid_; }
    ...
    bool hasClientEid() const { return true; }
    V8UnionArrayBufferOrArrayBufferView* clientEid() const { return member_client_eid_; }
    ...
    bool hasSessionPreKey() const { return true; }
    V8UnionArrayBufferOrArrayBufferView* sessionPreKey() const { return member_session_pre_key_; }
    ...
    bool hasVersion() const { return true; }
    uint8_t version() const { return member_version_; }
    void setVersion(uint8_t value) { member_version_ = value; }
