...
bool V8WebGLDrawBuffers::IsExposed(ExecutionContext* execution_context) { return false; }
...
static_assert(std::is_same<decltype(&WebGLDrawBuffers::HasPendingActivity), decltype(&ScriptWrappable::HasPendingActivity)>::value,
    "WebGLDrawBuffers is overriding hasPendingActivity() without "
    "[ActiveScriptWrappable] extended attribute.");
...
void DrawBuffersWEBGLOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    const char* const class_like_name = "WebGLDrawBuffers";
    const char* const property_name = "drawBuffersWEBGL";
    ...
    WebGLDrawBuffers* blink_receiver = V8WebGLDrawBuffers::ToWrappableUnsafe(v8_receiver);
    auto&& arg1_buffers = NativeValueTraits<IDLSequence<IDLUnsignedLong>>::ArgumentValue(isolate, 0, info[0], exception_state);
    if (UNLIKELY(exception_state.HadException())) {
        return;
    }
    blink_receiver->drawBuffersWEBGL(arg1_buffers);
}
    ...
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
...

    {
        static const IDLMemberInstaller::OperationConfig kOperationTable[] = {
            { "drawBuffersWEBGL", DrawBuffersWEBGLOperationCallback, 1, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
