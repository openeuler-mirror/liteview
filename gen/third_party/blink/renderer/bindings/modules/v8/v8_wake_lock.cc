...
static_assert(std::is_same<decltype(&WakeLock::HasPendingActivity), decltype(&ScriptWrappable::HasPendingActivity)>::value,
    ...
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
...

    {
        static const IDLMemberInstaller::OperationConfig kOperationTable[] = {
            { "request", RequestOperationCallback, 0, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
