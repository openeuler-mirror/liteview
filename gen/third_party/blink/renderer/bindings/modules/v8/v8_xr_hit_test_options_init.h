...
public:
    ...
    static XRHitTestOptionsInit* Create(v8::Isolate* isolate) { return MakeGarbageCollected<XRHitTestOptionsInit>(isolate); }
    ...
    XRSpace* space() const { return member_space_; }
