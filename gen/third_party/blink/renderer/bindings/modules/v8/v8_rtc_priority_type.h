...
public:
    ...
    static absl::optional<V8RTCPriorityType> Create(const String& value);
...
inline bool operator==(const V8RTCPriorityType& lhs, V8RTCPriorityType::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8RTCPriorityType::Enum lhs, const V8RTCPriorityType& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
