...
public:
    static CookieChangeEventInit* Create() { return MakeGarbageCollected<CookieChangeEventInit>(); }
    static CookieChangeEventInit* Create(v8::Isolate* isolate) { return MakeGarbageCollected<CookieChangeEventInit>(isolate); }
