...
const char* V8SQLStatementCallback::NameInHeapSnapshot() const { return "V8SQLStatementCallback"; }

v8::Maybe<void> V8SQLStatementCallback::handleEvent(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, SQLTransaction* arg1_transaction, SQLResultSet* arg2_result_set)
{
...
void V8SQLStatementCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, SQLTransaction* arg1_transaction, SQLResultSet* arg2_result_set)
{
    v8::Isolate* isolate = GetIsolate();
