...
class MODULES_EXPORT EncodedVideoChunkInit : public bindings::DictionaryBase {

public:
    static EncodedVideoChunkInit* Create() { return MakeGarbageCollected<EncodedVideoChunkInit>(); }
    static EncodedVideoChunkInit* Create(v8::Isolate* isolate) { return MakeGarbageCollected<EncodedVideoChunkInit>(isolate); }
    ...
    V8EncodedVideoChunkType type() const { return member_type_; }
    void setType(V8EncodedVideoChunkType value) { member_type_ = value; }
    void setType(V8EncodedVideoChunkType::Enum value) { member_type_ = V8EncodedVideoChunkType(value); }
    // Obsolete accessor functions
    void setType(const String& value) { member_type_ = V8EncodedVideoChunkType::Create(value).value(); }
