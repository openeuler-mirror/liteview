...
public:
    ...
    static absl::optional<V8RTCDataChannelState> Create(const String& value);
...
inline bool operator==(const V8RTCDataChannelState& lhs, V8RTCDataChannelState::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8RTCDataChannelState::Enum lhs, const V8RTCDataChannelState& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
