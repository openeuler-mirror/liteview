...
public:
    static SharedStorageSetMethodOptions* Create() { return MakeGarbageCollected<SharedStorageSetMethodOptions>(); }
    static SharedStorageSetMethodOptions* Create(v8::Isolate* isolate) { return MakeGarbageCollected<SharedStorageSetMethodOptions>(isolate); }
    ...
    bool hasIgnoreIfPresent() const { return has_ignore_if_present_; }
