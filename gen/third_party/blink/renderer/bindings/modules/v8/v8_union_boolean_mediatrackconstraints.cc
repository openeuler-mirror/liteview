...
v8::MaybeLocal<v8::Value> V8UnionBooleanOrMediaTrackConstraints::ToV8Value(ScriptState* script_state) const
{
    switch (content_type_) {
    case ContentType::kBoolean: {
        return ToV8Traits<IDLBoolean>::ToV8(script_state, member_boolean_);
    }
    case ContentType::kMediaTrackConstraints: {
        return ToV8Traits<MediaTrackConstraints>::ToV8(script_state, member_media_track_constraints_);
    }
    }
