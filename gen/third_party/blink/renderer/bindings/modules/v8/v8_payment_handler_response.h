...
public:
    ...
    static PaymentHandlerResponse* Create(v8::Isolate* isolate) { return MakeGarbageCollected<PaymentHandlerResponse>(isolate); }
    ...
    bool hasDetails() const { return !member_details_.IsEmpty(); }
    ...
    bool hasMethodName() const { return has_method_name_; }
    ...
    bool hasPayerEmail() const { return has_payer_email_; }
    ...
    bool hasPayerName() const { return has_payer_name_; }
    ...
    bool hasPayerPhone() const { return has_payer_phone_; }
    ...
    bool hasShippingAddress() const { return has_shipping_address_; }
    ...
    bool hasShippingOption() const { return has_shipping_option_; }
