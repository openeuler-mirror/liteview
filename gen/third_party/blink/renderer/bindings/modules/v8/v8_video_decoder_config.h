...
public:
    static VideoDecoderConfig* Create() { return MakeGarbageCollected<VideoDecoderConfig>(); }
    static VideoDecoderConfig* Create(v8::Isolate* isolate) { return MakeGarbageCollected<VideoDecoderConfig>(isolate); }
    ...
    bool hasCodedHeight() const { return has_coded_height_; }
    ...
    bool hasCodedWidth() const { return has_coded_width_; }
    ...
    bool hasDescription() const { return has_description_; }
    ...
    bool hasDisplayAspectHeight() const { return has_display_aspect_height_; }
    ...
    bool hasDisplayAspectWidth() const { return has_display_aspect_width_; }
    ...
    bool hasOptimizeForLatency() const { return has_optimize_for_latency_; }
