...
public:
    ...
    static RTCRtpHeaderExtensionParameters* Create(v8::Isolate* isolate) { return MakeGarbageCollected<RTCRtpHeaderExtensionParameters>(isolate); }
    ...
    bool hasEncrypted() const { return true; }
    bool encrypted() const { return member_encrypted_; }
    void setEncrypted(bool value) { member_encrypted_ = value; }

    bool hasId() const { return true; }
    uint16_t id() const { return member_id_; }
    void setId(uint16_t value) { member_id_ = value; }

    bool hasUri() const { return true; }
    const String& uri() const { return member_uri_; }
