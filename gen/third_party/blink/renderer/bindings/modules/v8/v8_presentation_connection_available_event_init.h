...
public:
    ...
    static PresentationConnectionAvailableEventInit* Create(v8::Isolate* isolate) { return MakeGarbageCollected<PresentationConnectionAvailableEventInit>(isolate); }
    ...
    PresentationConnection* connection() const { return member_connection_; }
