...
inline bool operator==(const V8PermissionName& lhs, V8PermissionName::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8PermissionName::Enum lhs, const V8PermissionName& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
