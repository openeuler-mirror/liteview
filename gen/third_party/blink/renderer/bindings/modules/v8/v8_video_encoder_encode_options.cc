...
{
    TraceIfNeeded<absl::optional<bool>>::Trace(visitor, member_key_frame_);
    bindings::DictionaryBase::Trace(visitor);
}

bool VideoEncoderEncodeOptions::FillV8ObjectWithMembers(ScriptState* script_state, v8::Local<v8::Object> v8_dictionary) const
{
    if (hasKeyFrame()) {
        v8::Local<v8::Value> v8_value;
        if (!ToV8Traits<IDLNullable<IDLBoolean>>::ToV8(script_state, member_key_frame_).ToLocal(&v8_value)) {
            return false;
        }
...
void VideoEncoderEncodeOptions::FillMembersFromV8Object(v8::Isolate* isolate, v8::Local<v8::Object> v8_dictionary, ExceptionState& exception_state)
{
    ...
    exception_context_scope.ChangePropertyNameAsOptimizationHack("keyFrame");
    constexpr bool is_optional = false;
    v8::Local<v8::Context> current_context = isolate->GetCurrentContext();
    const auto& v8_own_member_names = GetV8OwnMemberNames(isolate);
    v8::TryCatch try_block(isolate);
    if (!bindings::GetDictionaryMemberFromV8Object<IDLNullable<IDLBoolean>, is_optional>(
            isolate, current_context, v8_dictionary, v8_own_member_names[0].Get(isolate), has_key_frame_, member_key_frame_, try_block, exception_state)) {
        return;
    }
}
