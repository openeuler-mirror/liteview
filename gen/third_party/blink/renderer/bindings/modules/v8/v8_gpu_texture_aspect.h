...
public:
    ...
    static absl::optional<V8GPUTextureAspect> Create(const String& value);
...
inline bool operator==(const V8GPUTextureAspect& lhs, V8GPUTextureAspect::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8GPUTextureAspect::Enum lhs, const V8GPUTextureAspect& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
