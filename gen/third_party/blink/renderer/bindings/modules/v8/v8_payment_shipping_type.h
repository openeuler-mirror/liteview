...
public:
    ...
    static absl::optional<V8PaymentShippingType> Create(const String& value);
...
inline bool operator==(const V8PaymentShippingType& lhs, V8PaymentShippingType::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8PaymentShippingType::Enum lhs, const V8PaymentShippingType& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
