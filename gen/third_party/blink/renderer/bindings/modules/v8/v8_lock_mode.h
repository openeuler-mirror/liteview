...
inline bool operator==(const V8LockMode& lhs, V8LockMode::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8LockMode::Enum lhs, const V8LockMode& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
