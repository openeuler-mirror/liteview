...
public:
    ...
    static absl::optional<V8RTCIceTcpCandidateType> Create(const String& value);
...
inline bool operator==(const V8RTCIceTcpCandidateType& lhs, V8RTCIceTcpCandidateType::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8RTCIceTcpCandidateType::Enum lhs, const V8RTCIceTcpCandidateType& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
