...
public:
    ...
    static PublicKeyCredentialRequestOptions* Create(v8::Isolate* isolate) { return MakeGarbageCollected<PublicKeyCredentialRequestOptions>(isolate); }
    ...
    bool hasAllowCredentials() const { return true; }
    const HeapVector<Member<PublicKeyCredentialDescriptor>>& allowCredentials() const { return member_allow_credentials_; }
    ...
    bool hasRpId() const { return has_rp_id_; }
