...
public:
    ...
    static absl::optional<V8GPULoadOp> Create(const String& value);
...
inline bool operator==(const V8GPULoadOp& lhs, V8GPULoadOp::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8GPULoadOp::Enum lhs, const V8GPULoadOp& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
