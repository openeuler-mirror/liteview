...
public:
    ...
    static RTCRtpTransceiverInit* Create(v8::Isolate* isolate) { return MakeGarbageCollected<RTCRtpTransceiverInit>(isolate); }
    ...
    V8RTCRtpTransceiverDirection direction() const { return member_direction_; }
    void setDirection(V8RTCRtpTransceiverDirection value) { member_direction_ = value; }
    void setDirection(V8RTCRtpTransceiverDirection::Enum value) { member_direction_ = V8RTCRtpTransceiverDirection(value); }

    bool hasSendEncodings() const { return true; }
    const HeapVector<Member<RTCRtpEncodingParameters>>& sendEncodings() const { return member_send_encodings_; }
    ...
    bool hasStreams() const { return true; }
    const HeapVector<Member<MediaStream>>& streams() const { return member_streams_; }
    void setStreams(const HeapVector<Member<MediaStream>>& value);
    void setStreams(HeapVector<Member<MediaStream>>&& value);
    // Obsolete accessor functions
    void setDirection(const String& value) { member_direction_ = V8RTCRtpTransceiverDirection::Create(value).value(); }
