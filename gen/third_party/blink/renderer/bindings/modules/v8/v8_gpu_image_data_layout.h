...
public:
    static GPUImageDataLayout* Create() { return MakeGarbageCollected<GPUImageDataLayout>(); }
    static GPUImageDataLayout* Create(v8::Isolate* isolate) { return MakeGarbageCollected<GPUImageDataLayout>(isolate); }
