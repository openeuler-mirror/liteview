...
public:
    ...
    static SpatialSensorOptions* Create(v8::Isolate* isolate) { return MakeGarbageCollected<SpatialSensorOptions>(isolate); }
    ...
    bool hasReferenceFrame() const { return true; }
    V8LocalCoordinateSystem referenceFrame() const { return member_reference_frame_; }
    void setReferenceFrame(V8LocalCoordinateSystem value) { member_reference_frame_ = value; }
    void setReferenceFrame(V8LocalCoordinateSystem::Enum value) { member_reference_frame_ = V8LocalCoordinateSystem(value); }
    // Obsolete accessor functions
    void setReferenceFrame(const String& value) { member_reference_frame_ = V8LocalCoordinateSystem::Create(value).value(); }
