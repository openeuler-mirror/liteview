...
inline bool operator==(const V8GPUVertexFormat& lhs, V8GPUVertexFormat::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8GPUVertexFormat::Enum lhs, const V8GPUVertexFormat& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
