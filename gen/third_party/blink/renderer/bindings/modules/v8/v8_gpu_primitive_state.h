...
public:
    static GPUPrimitiveState* Create() { return MakeGarbageCollected<GPUPrimitiveState>(); }
    static GPUPrimitiveState* Create(v8::Isolate* isolate) { return MakeGarbageCollected<GPUPrimitiveState>(isolate); }
    ...
    bool hasCullMode() const { return true; }
    V8GPUCullMode cullMode() const { return member_cull_mode_; }
    void setCullMode(V8GPUCullMode value) { member_cull_mode_ = value; }
    void setCullMode(V8GPUCullMode::Enum value) { member_cull_mode_ = V8GPUCullMode(value); }

    bool hasFrontFace() const { return true; }
    V8GPUFrontFace frontFace() const { return member_front_face_; }
    void setFrontFace(V8GPUFrontFace value) { member_front_face_ = value; }
    void setFrontFace(V8GPUFrontFace::Enum value) { member_front_face_ = V8GPUFrontFace(value); }

    bool hasStripIndexFormat() const { return has_strip_index_format_; }
    ...
    bool hasTopology() const { return true; }
    V8GPUPrimitiveTopology topology() const { return member_topology_; }
    void setTopology(V8GPUPrimitiveTopology value) { member_topology_ = value; }
    void setTopology(V8GPUPrimitiveTopology::Enum value) { member_topology_ = V8GPUPrimitiveTopology(value); }

    bool hasUnclippedDepth() const { return true; }
    bool unclippedDepth() const { return member_unclipped_depth_; }
    void setUnclippedDepth(bool value) { member_unclipped_depth_ = value; }
    // Obsolete accessor functions
    void setCullMode(const String& value) { member_cull_mode_ = V8GPUCullMode::Create(value).value(); }
    void setFrontFace(const String& value) { member_front_face_ = V8GPUFrontFace::Create(value).value(); }
    void setStripIndexFormat(const String& value)
    {
        member_strip_index_format_ = V8GPUIndexFormat::Create(value).value();
        has_strip_index_format_ = true;
    }
    void setTopology(const String& value) { member_topology_ = V8GPUPrimitiveTopology::Create(value).value(); }
