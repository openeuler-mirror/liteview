...
public:
    ...
    static absl::optional<V8GamepadMappingType> Create(const String& value);
...
inline bool operator==(const V8GamepadMappingType& lhs, V8GamepadMappingType::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8GamepadMappingType::Enum lhs, const V8GamepadMappingType& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
