...
public:
    ...
    static absl::optional<V8GPUStoreOp> Create(const String& value);
...
inline bool operator==(const V8GPUStoreOp& lhs, V8GPUStoreOp::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8GPUStoreOp::Enum lhs, const V8GPUStoreOp& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
