...
public:
    ...
    static RTCPeerConnectionIceErrorEventInit* Create(v8::Isolate* isolate) { return MakeGarbageCollected<RTCPeerConnectionIceErrorEventInit>(isolate); }
    ...
    bool hasErrorCode() const { return true; }
    uint16_t errorCode() const { return member_error_code_; }
    void setErrorCode(uint16_t value) { member_error_code_ = value; }

    bool hasErrorText() const { return has_error_text_; }
    ...
    bool hasHostCandidate() const { return has_host_candidate_; }
    ...
    bool hasPortNonNull() const { return hasPort() && port().has_value(); }
