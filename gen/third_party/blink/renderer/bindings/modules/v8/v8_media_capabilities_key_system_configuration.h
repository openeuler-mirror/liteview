...
public:
    ...
    static MediaCapabilitiesKeySystemConfiguration* Create(v8::Isolate* isolate) { return MakeGarbageCollected<MediaCapabilitiesKeySystemConfiguration>(isolate); }
    ...
    bool hasInitDataType() const { return true; }
    const String& initDataType() const { return member_init_data_type_; }
    void setInitDataType(const String& value);
    void setInitDataType(String&& value);

    bool hasKeySystem() const { return true; }
    const String& keySystem() const { return member_key_system_; }
