...
public:
    ...
    static RTCRtpCodecParameters* Create(v8::Isolate* isolate) { return MakeGarbageCollected<RTCRtpCodecParameters>(isolate); }
    ...
    bool hasPayloadType() const { return true; }
    uint8_t payloadType() const { return member_payload_type_; }
    void setPayloadType(uint8_t value) { member_payload_type_ = value; }
