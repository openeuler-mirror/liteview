...
public:
    ...
    static absl::optional<V8NotificationDirection> Create(const String& value);
...
inline bool operator==(const V8NotificationDirection& lhs, V8NotificationDirection::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8NotificationDirection::Enum lhs, const V8NotificationDirection& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
