...
void RTCRtpSynchronizationSource::Trace(Visitor* visitor) const { RTCRtpContributingSource::Trace(visitor); }
...
const base::span<const v8::Eternal<v8::Name>> RTCRtpSynchronizationSource::GetV8OwnMemberNames(v8::Isolate* isolate) { return {}; }
