...
public:
    ...
    static absl::optional<V8IDBCursorDirection> Create(const String& value);
...
inline bool operator==(const V8IDBCursorDirection& lhs, V8IDBCursorDirection::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8IDBCursorDirection::Enum lhs, const V8IDBCursorDirection& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
