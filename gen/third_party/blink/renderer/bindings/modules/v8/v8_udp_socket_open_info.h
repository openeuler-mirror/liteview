...
public:
    static UDPSocketOpenInfo* Create() { return MakeGarbageCollected<UDPSocketOpenInfo>(); }
    static UDPSocketOpenInfo* Create(v8::Isolate* isolate) { return MakeGarbageCollected<UDPSocketOpenInfo>(isolate); }
