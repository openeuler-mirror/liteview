...
public:
    static GPUImageCopyImageBitmap* Create() { return MakeGarbageCollected<GPUImageCopyImageBitmap>(); }
    static GPUImageCopyImageBitmap* Create(v8::Isolate* isolate) { return MakeGarbageCollected<GPUImageCopyImageBitmap>(isolate); }
    ...
    bool hasImageBitmap() const { return true; }
    ImageBitmap* imageBitmap() const { return member_image_bitmap_; }
