...
public:
    ...
    static absl::optional<V8RTCDtlsTransportState> Create(const String& value);
...
inline bool operator==(const V8RTCDtlsTransportState& lhs, V8RTCDtlsTransportState::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8RTCDtlsTransportState::Enum lhs, const V8RTCDtlsTransportState& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
