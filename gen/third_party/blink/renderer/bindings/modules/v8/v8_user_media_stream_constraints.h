...
class MODULES_EXPORT UserMediaStreamConstraints : public bindings::DictionaryBase {

public:
    static UserMediaStreamConstraints* Create() { return MakeGarbageCollected<UserMediaStreamConstraints>(); }
    static UserMediaStreamConstraints* Create(v8::Isolate* isolate) { return MakeGarbageCollected<UserMediaStreamConstraints>(isolate); }
