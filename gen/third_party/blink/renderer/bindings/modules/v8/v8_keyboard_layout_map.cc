...
static_assert(std::is_same<decltype(&KeyboardLayoutMap::HasPendingActivity), decltype(&ScriptWrappable::HasPendingActivity)>::value,
    "KeyboardLayoutMap is overriding hasPendingActivity() without "
    "[ActiveScriptWrappable] extended attribute.");
...
void SizeAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    KeyboardLayoutMap* blink_receiver = V8KeyboardLayoutMap::ToWrappableUnsafe(v8_receiver);
