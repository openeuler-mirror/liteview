...
public:
    ...
    static AuthenticatorSelectionCriteria* Create(v8::Isolate* isolate) { return MakeGarbageCollected<AuthenticatorSelectionCriteria>(isolate); }
    ...
    bool hasAuthenticatorAttachment() const { return has_authenticator_attachment_; }
    ...
    bool hasRequireResidentKey() const { return true; }
    bool requireResidentKey() const { return member_require_resident_key_; }
    void setRequireResidentKey(bool value) { member_require_resident_key_ = value; }

    bool hasResidentKey() const { return has_resident_key_; }
    ...
    bool hasUserVerification() const { return has_user_verification_; }
