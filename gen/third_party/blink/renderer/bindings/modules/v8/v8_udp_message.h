...
public:
    static UDPMessage* Create() { return MakeGarbageCollected<UDPMessage>(); }
    static UDPMessage* Create(v8::Isolate* isolate) { return MakeGarbageCollected<UDPMessage>(isolate); }
