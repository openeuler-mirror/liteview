...
bool V8WebGLCompressedTextureASTC::IsExposed(ExecutionContext* execution_context) { return false; }
...
static_assert(std::is_same<decltype(&WebGLCompressedTextureASTC::HasPendingActivity), decltype(&ScriptWrappable::HasPendingActivity)>::value,
    "WebGLCompressedTextureASTC is overriding hasPendingActivity() without "
    "[ActiveScriptWrappable] extended attribute.");
...
void GetSupportedProfilesOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    WebGLCompressedTextureASTC* blink_receiver = V8WebGLCompressedTextureASTC::ToWrappableUnsafe(v8_receiver);
    ...
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
...

    {
        static const IDLMemberInstaller::OperationConfig kOperationTable[] = {
            { "getSupportedProfiles", GetSupportedProfilesOperationCallback, 0, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
...
void V8WebGLCompressedTextureASTC::InstallContextDependentProperties(v8::Local<v8::Context> context, const DOMWrapperWorld& world, v8::Local<v8::Object> instance_object,
