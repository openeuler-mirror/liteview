...
static_assert(!std::is_same<decltype(&MIDIOutput::HasPendingActivity), decltype(&ScriptWrappable::HasPendingActivity)>::value,
...
void SendOperationOverload1(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    const char* const class_like_name = "MIDIOutput";
