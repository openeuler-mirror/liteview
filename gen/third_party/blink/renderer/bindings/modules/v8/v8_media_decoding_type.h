...
public:
    ...
    static absl::optional<V8MediaDecodingType> Create(const String& value);
...
inline bool operator==(const V8MediaDecodingType& lhs, V8MediaDecodingType::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8MediaDecodingType::Enum lhs, const V8MediaDecodingType& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
