...
public:
    ...
    static RTCDataChannelInit* Create(v8::Isolate* isolate) { return MakeGarbageCollected<RTCDataChannelInit>(isolate); }
    ...
    bool hasNegotiated() const { return true; }
    bool negotiated() const { return member_negotiated_; }
    void setNegotiated(bool value) { member_negotiated_ = value; }

    bool hasOrdered() const { return true; }
    bool ordered() const { return member_ordered_; }
    void setOrdered(bool value) { member_ordered_ = value; }

    bool hasProtocol() const { return true; }
    const String& protocol() const { return member_protocol_; }
