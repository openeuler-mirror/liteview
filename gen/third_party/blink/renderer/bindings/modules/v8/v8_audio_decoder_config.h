...
public:
    static AudioDecoderConfig* Create() { return MakeGarbageCollected<AudioDecoderConfig>(); }
    static AudioDecoderConfig* Create(v8::Isolate* isolate) { return MakeGarbageCollected<AudioDecoderConfig>(isolate); }
