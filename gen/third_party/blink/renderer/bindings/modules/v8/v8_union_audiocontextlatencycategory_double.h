...
public:
    ...
    bool IsAudioContextLatencyCategory() const { return content_type_ == ContentType::kAudioContextLatencyCategory; }
...
private:
    ...
    static constexpr const char* UnionNameInIDL() { return "(AudioContextLatencyCategory or double)"; }
