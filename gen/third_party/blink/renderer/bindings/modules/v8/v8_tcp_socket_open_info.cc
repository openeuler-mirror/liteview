...
void TCPSocketOpenInfo::Trace(Visitor* visitor) const { SocketOpenInfo::Trace(visitor); }
...
const base::span<const v8::Eternal<v8::Name>> TCPSocketOpenInfo::GetV8OwnMemberNames(v8::Isolate* isolate) { return {}; }
