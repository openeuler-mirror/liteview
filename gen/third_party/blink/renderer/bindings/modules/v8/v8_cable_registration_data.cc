...
void CableRegistrationData::setVersions(const Vector<uint8_t>& value) { member_versions_ = value; }

void CableRegistrationData::setVersions(Vector<uint8_t>&& value) { member_versions_ = std::move(value); }
...
void CableRegistrationData::FillMembersFromV8Object(v8::Isolate* isolate, v8::Local<v8::Object> v8_dictionary, ExceptionState& exception_state)
{
    ...
    if (!bindings::GetDictionaryMemberFromV8Object<V8UnionArrayBufferOrArrayBufferView, is_required>(
            isolate, current_context, v8_dictionary, v8_own_member_names[0].Get(isolate), fallback_presence_var, member_rp_public_key_, try_block, exception_state)) {
        return;
    }
    exception_context_scope.ChangePropertyNameAsOptimizationHack("versions");
    if (!bindings::GetDictionaryMemberFromV8Object<IDLSequence<IDLOctet>, is_required>(
            isolate, current_context, v8_dictionary, v8_own_member_names[1].Get(isolate), fallback_presence_var, member_versions_, try_block, exception_state)) {
        return;
    }
}
