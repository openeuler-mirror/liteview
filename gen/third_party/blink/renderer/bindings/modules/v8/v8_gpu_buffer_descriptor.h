...
public:
    static GPUBufferDescriptor* Create() { return MakeGarbageCollected<GPUBufferDescriptor>(); }
    static GPUBufferDescriptor* Create(v8::Isolate* isolate) { return MakeGarbageCollected<GPUBufferDescriptor>(isolate); }
    ...
    bool hasMappedAtCreation() const { return true; }
    bool mappedAtCreation() const { return member_mapped_at_creation_; }
    void setMappedAtCreation(bool value) { member_mapped_at_creation_ = value; }

    bool hasSize() const { return true; }
    uint64_t size() const { return member_size_; }
    void setSize(uint64_t value) { member_size_ = value; }
