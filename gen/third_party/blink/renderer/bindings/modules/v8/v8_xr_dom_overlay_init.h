...
class MODULES_EXPORT XRDOMOverlayInit : public bindings::DictionaryBase {

public:
    static XRDOMOverlayInit* Create() { return MakeGarbageCollected<XRDOMOverlayInit>(); }
    static XRDOMOverlayInit* Create(v8::Isolate* isolate) { return MakeGarbageCollected<XRDOMOverlayInit>(isolate); }
    ...
    Element* root() const { return member_root_; }
