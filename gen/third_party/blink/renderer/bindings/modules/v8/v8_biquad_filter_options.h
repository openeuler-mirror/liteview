...
public:
    ...
    static BiquadFilterOptions* Create(v8::Isolate* isolate) { return MakeGarbageCollected<BiquadFilterOptions>(isolate); }
    ...
    bool hasQ() const { return true; }
    float q() const { return member_q_; }
    void setQ(float value) { member_q_ = value; }

    bool hasDetune() const { return true; }
    float detune() const { return member_detune_; }
    void setDetune(float value) { member_detune_ = value; }

    bool hasFrequency() const { return true; }
    float frequency() const { return member_frequency_; }
    void setFrequency(float value) { member_frequency_ = value; }

    bool hasGain() const { return true; }
    float gain() const { return member_gain_; }
    void setGain(float value) { member_gain_ = value; }

    bool hasType() const { return true; }
    V8BiquadFilterType type() const { return member_type_; }
    void setType(V8BiquadFilterType value) { member_type_ = value; }
    void setType(V8BiquadFilterType::Enum value) { member_type_ = V8BiquadFilterType(value); }
    // Obsolete accessor functions
    void setType(const String& value) { member_type_ = V8BiquadFilterType::Create(value).value(); }
