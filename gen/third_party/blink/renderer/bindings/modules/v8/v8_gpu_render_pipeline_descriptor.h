...
public:
    ...
    static GPURenderPipelineDescriptor* Create(v8::Isolate* isolate) { return MakeGarbageCollected<GPURenderPipelineDescriptor>(isolate); }
    ...
    bool hasDepthStencil() const { return has_depth_stencil_; }
    ...
    bool hasFragment() const { return has_fragment_; }
    ...
    bool hasMultisample() const { return true; }
    GPUMultisampleState* multisample() const { return member_multisample_; }
    ...
    bool hasPrimitive() const { return true; }
    GPUPrimitiveState* primitive() const { return member_primitive_; }
    ...
    bool hasVertex() const { return true; }
    GPUVertexState* vertex() const { return member_vertex_; }
