...
inline bool operator==(const V8XRHandJoint& lhs, V8XRHandJoint::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8XRHandJoint::Enum lhs, const V8XRHandJoint& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
