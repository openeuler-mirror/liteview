...
public:
    ...
    static BluetoothAdvertisingEventInit* Create(v8::Isolate* isolate) { return MakeGarbageCollected<BluetoothAdvertisingEventInit>(isolate); }
    ...
    BluetoothDevice* device() const { return member_device_; }
    ...
    bool hasManufacturerData() const { return has_manufacturer_data_; }
    ...
    bool hasServiceData() const { return has_service_data_; }
