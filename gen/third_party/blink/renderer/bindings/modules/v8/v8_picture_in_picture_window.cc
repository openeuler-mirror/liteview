...
bool V8PictureInPictureWindow::IsExposed(ExecutionContext* execution_context) { return execution_context->IsWindow() && RuntimeEnabledFeatures::PictureInPictureAPIEnabled(); }
...
static_assert(!std::is_same<decltype(&PictureInPictureWindow::HasPendingActivity), decltype(&ScriptWrappable::HasPendingActivity)>::value,
