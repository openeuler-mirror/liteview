...
public:
    ...
    static LockOptions* Create(v8::Isolate* isolate) { return MakeGarbageCollected<LockOptions>(isolate); }
    ...
    bool hasIfAvailable() const { return true; }
    bool ifAvailable() const { return member_if_available_; }
    void setIfAvailable(bool value) { member_if_available_ = value; }

    bool hasMode() const { return true; }
    V8LockMode mode() const { return member_mode_; }
    void setMode(V8LockMode value) { member_mode_ = value; }
    void setMode(V8LockMode::Enum value) { member_mode_ = V8LockMode(value); }
    ...
    bool hasSteal() const { return true; }
    bool steal() const { return member_steal_; }
    void setSteal(bool value) { member_steal_ = value; }
    // Obsolete accessor functions
    void setMode(const String& value) { member_mode_ = V8LockMode::Create(value).value(); }
