...
public:
    ...
    bool IsFileSystemHandle() const { return content_type_ == ContentType::kFileSystemHandle; }
    FileSystemHandle* GetAsFileSystemHandle() const
    {
        DCHECK_EQ(content_type_, ContentType::kFileSystemHandle);
        return member_file_system_handle_;
    }
    ...
    bool IsWellKnownDirectory() const { return content_type_ == ContentType::kWellKnownDirectory; }
...
private:
    ...
    static constexpr const char* UnionNameInIDL() { return "(FileSystemHandle or WellKnownDirectory)"; }
