...
public:
    enum class Enum : enum_int_t { kPlay, kPause, kPrevioustrack, kNexttrack, kSeekbackward, kSeekforward, kSkipad, kStop, kSeekto, kTogglemicrophone, kTogglecamera, kHangup };
    ...
    static absl::optional<V8MediaSessionAction> Create(const String& value);
...
inline bool operator==(const V8MediaSessionAction& lhs, V8MediaSessionAction::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8MediaSessionAction::Enum lhs, const V8MediaSessionAction& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
