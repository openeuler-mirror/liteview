...
public:
    static AuctionAd* Create() { return MakeGarbageCollected<AuctionAd>(); }
    static AuctionAd* Create(v8::Isolate* isolate) { return MakeGarbageCollected<AuctionAd>(isolate); }
    ...
    bool hasMetadata() const { return !member_metadata_.IsEmpty(); }
    ...
    void setMetadata(const ScriptValue& value) { member_metadata_ = value; }

    bool hasRenderUrl() const { return true; }
    const String& renderUrl() const { return member_render_url_; }
