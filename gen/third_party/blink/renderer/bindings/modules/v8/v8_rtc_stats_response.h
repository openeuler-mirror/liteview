...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_RTC_STATS_RESPONSE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_RTC_STATS_RESPONSE_H_
...
class MODULES_EXPORT V8RTCStatsResponse final : public bindings::V8InterfaceBridge<V8RTCStatsResponse, RTCStatsResponse> {
...
private:
    ...
    friend class RTCStatsResponse;
};
} // namespace blink

#endif // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_RTC_STATS_RESPONSE_H_
