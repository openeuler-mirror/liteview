...
class MODULES_EXPORT V8UnionCSSImageValueOrHTMLCanvasElementOrHTMLImageElementOrHTMLVideoElementOrImageBitmapOrOffscreenCanvasOrSVGImageElementOrVideoFrame final
    : public bindings::UnionBase {

public:
    // The type of the content value of this IDL union.
    enum class ContentType { kCSSImageValue, kHTMLCanvasElement, kHTMLImageElement, kHTMLVideoElement, kImageBitmap, kOffscreenCanvas, kSVGImageElement, kVideoFrame };
    ...
    explicit V8UnionCSSImageValueOrHTMLCanvasElementOrHTMLImageElementOrHTMLVideoElementOrImageBitmapOrOffscreenCanvasOrSVGImageElementOrVideoFrame(CSSStyleImageValue* value)
        : content_type_(ContentType::kCSSImageValue)
        , member_css_image_value_(value)
    {
        DCHECK(value);
    }
    explicit V8UnionCSSImageValueOrHTMLCanvasElementOrHTMLImageElementOrHTMLVideoElementOrImageBitmapOrOffscreenCanvasOrSVGImageElementOrVideoFrame(HTMLCanvasElement* value)
        : content_type_(ContentType::kHTMLCanvasElement)
        , member_html_canvas_element_(value)
    {
        DCHECK(value);
    }
    explicit V8UnionCSSImageValueOrHTMLCanvasElementOrHTMLImageElementOrHTMLVideoElementOrImageBitmapOrOffscreenCanvasOrSVGImageElementOrVideoFrame(HTMLImageElement* value)
        : content_type_(ContentType::kHTMLImageElement)
        , member_html_image_element_(value)
    {
        DCHECK(value);
    }
    explicit V8UnionCSSImageValueOrHTMLCanvasElementOrHTMLImageElementOrHTMLVideoElementOrImageBitmapOrOffscreenCanvasOrSVGImageElementOrVideoFrame(HTMLVideoElement* value)
        : content_type_(ContentType::kHTMLVideoElement)
        , member_html_video_element_(value)
    {
        DCHECK(value);
    }
    explicit V8UnionCSSImageValueOrHTMLCanvasElementOrHTMLImageElementOrHTMLVideoElementOrImageBitmapOrOffscreenCanvasOrSVGImageElementOrVideoFrame(ImageBitmap* value)
        : content_type_(ContentType::kImageBitmap)
        , member_image_bitmap_(value)
    {
        DCHECK(value);
    }
    explicit V8UnionCSSImageValueOrHTMLCanvasElementOrHTMLImageElementOrHTMLVideoElementOrImageBitmapOrOffscreenCanvasOrSVGImageElementOrVideoFrame(OffscreenCanvas* value)
        : content_type_(ContentType::kOffscreenCanvas)
        , member_offscreen_canvas_(value)
    {
        DCHECK(value);
    }
    explicit V8UnionCSSImageValueOrHTMLCanvasElementOrHTMLImageElementOrHTMLVideoElementOrImageBitmapOrOffscreenCanvasOrSVGImageElementOrVideoFrame(SVGImageElement* value)
        : content_type_(ContentType::kSVGImageElement)
        , member_svg_image_element_(value)
    {
        DCHECK(value);
    }
    explicit V8UnionCSSImageValueOrHTMLCanvasElementOrHTMLImageElementOrHTMLVideoElementOrImageBitmapOrOffscreenCanvasOrSVGImageElementOrVideoFrame(VideoFrame* value)
    ...
    bool IsCSSImageValue() const { return content_type_ == ContentType::kCSSImageValue; }
