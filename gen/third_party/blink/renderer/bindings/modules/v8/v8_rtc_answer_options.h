...
public:
    static RTCAnswerOptions* Create() { return MakeGarbageCollected<RTCAnswerOptions>(); }
    static RTCAnswerOptions* Create(v8::Isolate* isolate) { return MakeGarbageCollected<RTCAnswerOptions>(isolate); }
