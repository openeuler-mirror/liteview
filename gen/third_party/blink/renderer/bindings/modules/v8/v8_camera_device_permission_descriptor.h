...
public:
    ...
    static CameraDevicePermissionDescriptor* Create(v8::Isolate* isolate) { return MakeGarbageCollected<CameraDevicePermissionDescriptor>(isolate); }
    ...
    bool hasPanTiltZoom() const { return true; }
    bool panTiltZoom() const { return member_pan_tilt_zoom_; }
    void setPanTiltZoom(bool value) { member_pan_tilt_zoom_ = value; }
