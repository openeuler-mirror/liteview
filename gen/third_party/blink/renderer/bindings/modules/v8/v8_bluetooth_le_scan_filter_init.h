...
public:
    ...
    static BluetoothLEScanFilterInit* Create(v8::Isolate* isolate) { return MakeGarbageCollected<BluetoothLEScanFilterInit>(isolate); }
    ...
    bool hasNamePrefix() const { return has_name_prefix_; }
