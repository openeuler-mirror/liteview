...
bool WebTransportOptions::FillV8ObjectWithMembers(ScriptState* script_state, v8::Local<v8::Object> v8_dictionary) const
{
    ...
    if (RuntimeEnabledFeatures::WebTransportCustomCertificatesEnabled(execution_context)) {
        if (hasServerCertificateHashes()) {
            ...
            if (!ToV8Traits<IDLSequence<WebTransportHash>>::ToV8(script_state, member_server_certificate_hashes_).ToLocal(&v8_value)) {
                return false;
            }
...
void WebTransportOptions::FillMembersFromV8Object(v8::Isolate* isolate, v8::Local<v8::Object> v8_dictionary, ExceptionState& exception_state)
{
    ...
    if (RuntimeEnabledFeatures::WebTransportCustomCertificatesEnabled(execution_context)) {
        ...
        exception_context_scope.ChangePropertyNameAsOptimizationHack("serverCertificateHashes");
        constexpr bool is_optional = false;
        const auto& v8_own_member_names = GetV8OwnMemberNames(isolate);
        v8::TryCatch try_block(isolate);
        if (!bindings::GetDictionaryMemberFromV8Object<IDLSequence<WebTransportHash>, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[0].Get(isolate),
                has_server_certificate_hashes_, member_server_certificate_hashes_, try_block, exception_state)) {
            return;
        }
    }
}
