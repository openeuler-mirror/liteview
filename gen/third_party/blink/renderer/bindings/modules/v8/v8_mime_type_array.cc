...
bool V8MimeTypeArray::IsExposed(ExecutionContext* execution_context) { return execution_context->IsWindow(); }
...
static_assert(std::is_same<decltype(&DOMMimeTypeArray::HasPendingActivity), decltype(&ScriptWrappable::HasPendingActivity)>::value,
    "DOMMimeTypeArray is overriding hasPendingActivity() without "
    "[ActiveScriptWrappable] extended attribute.");

void V8MimeTypeArray::NamedPropertyGetterCallback(v8::Local<v8::Name> v8_property_name, const v8::PropertyCallbackInfo<v8::Value>& info)
{
    ...
    DOMMimeTypeArray* blink_receiver = V8MimeTypeArray::ToWrappableUnsafe(v8_receiver);
...
void V8MimeTypeArray::NamedPropertySetterCallback(v8::Local<v8::Name> v8_property_name, v8::Local<v8::Value> v8_property_value, const v8::PropertyCallbackInfo<v8::Value>& info)
{
    ...
    if (!is_creating) {
        ...
        if (info.ShouldThrowOnError()) {
            ExceptionState exception_state(info.GetIsolate(), ExceptionContext::Context::kNamedPropertySet, "MimeTypeArray");
...
void V8MimeTypeArray::NamedPropertyDeleterCallback(v8::Local<v8::Name> v8_property_name, const v8::PropertyCallbackInfo<v8::Boolean>& info)
{
    ...
    ExceptionState exception_state(info.GetIsolate(), ExceptionContext::Context::kNamedPropertyDelete, "MimeTypeArray");
...
void V8MimeTypeArray::NamedPropertyDefinerCallback(
...
void V8MimeTypeArray::NamedPropertyDescriptorCallback(v8::Local<v8::Name> v8_property_name, const v8::PropertyCallbackInfo<v8::Value>& info)
{
...
void V8MimeTypeArray::NamedPropertyQueryCallback(v8::Local<v8::Name> v8_property_name, const v8::PropertyCallbackInfo<v8::Integer>& info)
{
    ...
    DOMMimeTypeArray* blink_receiver = V8MimeTypeArray::ToWrappableUnsafe(v8_receiver);
    const AtomicString& blink_property_name = ToCoreAtomicString(v8_property_name.As<v8::String>());
    ExceptionState exception_state(isolate, ExceptionContext::Context::kNamedPropertyGet, "MimeTypeArray");
    bool does_exist = blink_receiver->NamedPropertyQuery(blink_property_name, exception_state);
    if (!does_exist)
        return; // Do not intercept.
...
void V8MimeTypeArray::NamedPropertyEnumeratorCallback(const v8::PropertyCallbackInfo<v8::Array>& info)
{
    ...
    ExceptionState exception_state(info.GetIsolate(), ExceptionContext::Context::kNamedPropertyEnumerate, "MimeTypeArray");
...
void V8MimeTypeArray::IndexedPropertySetterCallback(uint32_t index, v8::Local<v8::Value> v8_property_value, const v8::PropertyCallbackInfo<v8::Value>& info)
{
    ...
    bindings::V8SetReturnValue(info, nullptr);
    if (info.ShouldThrowOnError()) {
        ExceptionState exception_state(info.GetIsolate(), ExceptionContext::Context::kIndexedPropertySet, "MimeTypeArray");
        exception_state.ThrowTypeError("Indexed property setter is not supported.");
    }
}

void V8MimeTypeArray::IndexedPropertyDeleterCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Boolean>& info)
{
    ...
    if (is_supported and info.ShouldThrowOnError()) {
        ExceptionState exception_state(info.GetIsolate(), ExceptionContext::Context::kIndexedPropertyDelete, "MimeTypeArray");
        exception_state.ThrowTypeError("Index property deleter is not supported.");
    }
}

void V8MimeTypeArray::IndexedPropertyDefinerCallback(uint32_t index, const v8::PropertyDescriptor& v8_property_desc, const v8::PropertyCallbackInfo<v8::Value>& info)
{
...
void ItemOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    const char* const class_like_name = "MimeTypeArray";
...
void V8MimeTypeArray::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template)
{
    ...
    // Named interceptors
    instance_object_template->SetHandler(v8::NamedPropertyHandlerConfiguration(V8MimeTypeArray::NamedPropertyGetterCallback, V8MimeTypeArray::NamedPropertySetterCallback,
    ...
    instance_object_template->SetHandler(v8::IndexedPropertyHandlerConfiguration(V8MimeTypeArray::IndexedPropertyGetterCallback, V8MimeTypeArray::IndexedPropertySetterCallback,
        nullptr, // query
