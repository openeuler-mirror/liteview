...
public:
    ...
    static JsonWebKey* Create(v8::Isolate* isolate) { return MakeGarbageCollected<JsonWebKey>(isolate); }
    ...
    bool hasCrv() const { return has_crv_; }
    ...
    bool hasDp() const { return has_dp_; }
    ...
    bool hasDq() const { return has_dq_; }
    ...
    bool hasKty() const { return has_kty_; }
    ...
    bool hasQi() const { return has_qi_; }
    ...
    bool hasUse() const { return has_use_; }
