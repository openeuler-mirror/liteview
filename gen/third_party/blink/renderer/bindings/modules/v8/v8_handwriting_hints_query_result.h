...
public:
    static HandwritingHintsQueryResult* Create() { return MakeGarbageCollected<HandwritingHintsQueryResult>(); }
    static HandwritingHintsQueryResult* Create(v8::Isolate* isolate) { return MakeGarbageCollected<HandwritingHintsQueryResult>(isolate); }
    ...
    bool hasAlternatives() const { return has_alternatives_; }
    ...
    bool hasRecognitionType() const { return has_recognition_type_; }
