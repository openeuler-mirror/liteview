...
const char* V8SQLStatementErrorCallback::NameInHeapSnapshot() const { return "V8SQLStatementErrorCallback"; }

v8::Maybe<bool> V8SQLStatementErrorCallback::handleEvent(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, SQLTransaction* arg1_transaction, SQLError* arg2_error)
{
