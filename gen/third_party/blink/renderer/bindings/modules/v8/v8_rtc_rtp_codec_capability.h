...
class MODULES_EXPORT RTCRtpCodecCapability : public bindings::DictionaryBase {

public:
    static RTCRtpCodecCapability* Create() { return MakeGarbageCollected<RTCRtpCodecCapability>(); }
    static RTCRtpCodecCapability* Create(v8::Isolate* isolate) { return MakeGarbageCollected<RTCRtpCodecCapability>(isolate); }
    ...
    bool hasClockRate() const { return true; }
    uint32_t clockRate() const { return member_clock_rate_; }
    void setClockRate(uint32_t value) { member_clock_rate_ = value; }
    ...
    {
        DCHECK(hasScalabilityModes());
        return member_scalability_modes_;
    }
    Vector<String> getScalabilityModesOr(const Vector<String>& fallback_value) const;
    Vector<String> getScalabilityModesOr(Vector<String>&& fallback_value) const;
    void setScalabilityModes(const Vector<String>& value);
    void setScalabilityModes(Vector<String>&& value);

    bool hasSdpFmtpLine() const { return has_sdp_fmtp_line_; }
...
private:
    ...
    Vector<String> member_scalability_modes_;
