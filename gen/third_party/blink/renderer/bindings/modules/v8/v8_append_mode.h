...
public:
    ...
    static absl::optional<V8AppendMode> Create(const String& value);
...
inline bool operator==(const V8AppendMode& lhs, V8AppendMode::Enum rhs) { return lhs.AsEnum() == rhs; }

inline bool operator==(V8AppendMode::Enum lhs, const V8AppendMode& rhs) { return lhs == rhs.AsEnum(); }
} // namespace blink
