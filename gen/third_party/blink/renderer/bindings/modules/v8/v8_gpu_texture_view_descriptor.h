...
public:
    ...
    static GPUTextureViewDescriptor* Create(v8::Isolate* isolate) { return MakeGarbageCollected<GPUTextureViewDescriptor>(isolate); }
    ...
    bool hasAspect() const { return true; }
    V8GPUTextureAspect aspect() const { return member_aspect_; }
    void setAspect(V8GPUTextureAspect value) { member_aspect_ = value; }
    void setAspect(V8GPUTextureAspect::Enum value) { member_aspect_ = V8GPUTextureAspect(value); }

    bool hasBaseArrayLayer() const { return true; }
    uint32_t baseArrayLayer() const { return member_base_array_layer_; }
    void setBaseArrayLayer(uint32_t value) { member_base_array_layer_ = value; }

    bool hasBaseMipLevel() const { return true; }
    uint32_t baseMipLevel() const { return member_base_mip_level_; }
    void setBaseMipLevel(uint32_t value) { member_base_mip_level_ = value; }

    bool hasDimension() const { return has_dimension_; }
    ...
    bool hasFormat() const { return has_format_; }
    ...
    void setAspect(const String& value) { member_aspect_ = V8GPUTextureAspect::Create(value).value(); }
