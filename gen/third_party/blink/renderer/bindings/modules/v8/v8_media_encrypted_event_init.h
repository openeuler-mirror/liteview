...
public:
    ...
    static MediaEncryptedEventInit* Create(v8::Isolate* isolate) { return MakeGarbageCollected<MediaEncryptedEventInit>(isolate); }
    ...
    bool hasInitData() const { return true; }
    DOMArrayBuffer* initData() const { return member_init_data_; }
    void setInitData(DOMArrayBuffer* value) { member_init_data_ = value; }
