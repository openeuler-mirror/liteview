...
public:
    static GPUExternalTextureDescriptor* Create() { return MakeGarbageCollected<GPUExternalTextureDescriptor>(); }
    static GPUExternalTextureDescriptor* Create(v8::Isolate* isolate) { return MakeGarbageCollected<GPUExternalTextureDescriptor>(isolate); }
    ...
    V8UnionHTMLVideoElementOrVideoFrame* source() const { return member_source_; }
