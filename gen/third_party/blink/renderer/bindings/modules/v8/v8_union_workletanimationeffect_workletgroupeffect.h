...
public:
    ...
    bool IsWorkletAnimationEffect() const { return content_type_ == ContentType::kWorkletAnimationEffect; }
    WorkletAnimationEffect* GetAsWorkletAnimationEffect() const
    {
        DCHECK_EQ(content_type_, ContentType::kWorkletAnimationEffect);
        return member_worklet_animation_effect_;
    }
    ...
    bool IsWorkletGroupEffect() const { return content_type_ == ContentType::kWorkletGroupEffect; }
    WorkletGroupEffect* GetAsWorkletGroupEffect() const
    {
        DCHECK_EQ(content_type_, ContentType::kWorkletGroupEffect);
        return member_worklet_group_effect_;
    }
...
private:
    ...
    static constexpr const char* UnionNameInIDL() { return "(WorkletAnimationEffect or WorkletGroupEffect)"; }
