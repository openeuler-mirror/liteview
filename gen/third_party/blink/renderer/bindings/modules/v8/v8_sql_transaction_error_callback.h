...
public:
    static V8SQLTransactionErrorCallback* Create(v8::Local<v8::Object> callback_object) { return MakeGarbageCollected<V8SQLTransactionErrorCallback>(callback_object); }
