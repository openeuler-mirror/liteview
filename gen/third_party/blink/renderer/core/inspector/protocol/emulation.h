...
public:
    ...
    private:
        ...
        template <int STEP> ScreenOrientationBuilder<STATE | STEP>& castState() { return *reinterpret_cast<ScreenOrientationBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::Emulation::ScreenOrientation> m_result;
    };

    static ScreenOrientationBuilder<0> create() { return ScreenOrientationBuilder<0>(); }

private:
    DECLARE_SERIALIZATION_SUPPORT();

    ScreenOrientation() { m_angle = 0; }
...
public:
    ...
    public:
        enum { NoFieldsSet = 0, OrientationSet = 1 << 1, OffsetSet = 1 << 2, MaskLengthSet = 1 << 3, AllFieldsSet = (OrientationSet | OffsetSet | MaskLengthSet | 0) };
    ...
    private:
        ...
        template <int STEP> DisplayFeatureBuilder<STATE | STEP>& castState() { return *reinterpret_cast<DisplayFeatureBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::Emulation::DisplayFeature> m_result;
    };

    static DisplayFeatureBuilder<0> create() { return DisplayFeatureBuilder<0>(); }
...
public:
    ...
    private:
        ...
        template <int STEP> MediaFeatureBuilder<STATE | STEP>& castState() { return *reinterpret_cast<MediaFeatureBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::Emulation::MediaFeature> m_result;
    };

    static MediaFeatureBuilder<0> create() { return MediaFeatureBuilder<0>(); }
...
public:
    ...
    private:
        ...
        template <int STEP> UserAgentBrandVersionBuilder<STATE | STEP>& castState() { return *reinterpret_cast<UserAgentBrandVersionBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::Emulation::UserAgentBrandVersion> m_result;
    };

    static UserAgentBrandVersionBuilder<0> create() { return UserAgentBrandVersionBuilder<0>(); }
...
public:
    ...
    {
        return m_brands.isJust() ? m_brands.fromJust() : defaultValue;
    }
    ...
    {
        return m_fullVersionList.isJust() ? m_fullVersionList.fromJust() : defaultValue;
    }
    ...
    private:
        ...
        template <int STEP> UserAgentMetadataBuilder<STATE | STEP>& castState() { return *reinterpret_cast<UserAgentMetadataBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::Emulation::UserAgentMetadata> m_result;
    };

    static UserAgentMetadataBuilder<0> create() { return UserAgentMetadataBuilder<0>(); }

private:
    DECLARE_SERIALIZATION_SUPPORT();

    UserAgentMetadata() { m_mobile = false; }
...
public:
    ...
    virtual DispatchResponse setDeviceMetricsOverride(int in_width, int in_height, double in_deviceScaleFactor, bool in_mobile, Maybe<double> in_scale, Maybe<int> in_screenWidth,
        Maybe<int> in_screenHeight, Maybe<int> in_positionX, Maybe<int> in_positionY, Maybe<bool> in_dontSetVisibleSize,
        Maybe<protocol::Emulation::ScreenOrientation> in_screenOrientation, Maybe<protocol::Page::Viewport> in_viewport,
        Maybe<protocol::Emulation::DisplayFeature> in_displayFeature)
        = 0;
    ...
    virtual DispatchResponse setVirtualTimePolicy(
        const String& in_policy, Maybe<double> in_budget, Maybe<int> in_maxVirtualTimeTaskStarvationCount, Maybe<double> in_initialVirtualTime, double* out_virtualTimeTicksBase)
        = 0;
    ...
    virtual DispatchResponse setUserAgentOverride(
        const String& in_userAgent, Maybe<String> in_acceptLanguage, Maybe<String> in_platform, Maybe<protocol::Emulation::UserAgentMetadata> in_userAgentMetadata)
        = 0;
    virtual DispatchResponse setAutomationOverride(bool in_enabled) = 0;

    virtual DispatchResponse disable() { return DispatchResponse::Success(); }
};
