...
CRDTP_DESERIALIZE_FIELD("expiryTime", m_expiryTime), CRDTP_DESERIALIZE_FIELD("isThirdParty", m_isThirdParty), CRDTP_DESERIALIZE_FIELD("matchSubDomains", m_matchSubDomains),
    CRDTP_DESERIALIZE_FIELD("origin", m_origin), CRDTP_DESERIALIZE_FIELD("trialName", m_trialName), CRDTP_DESERIALIZE_FIELD("usageRestriction", m_usageRestriction),
    CRDTP_END_DESERIALIZER()
...
CRDTP_DESERIALIZE_FIELD_OPT("adFrameStatus", m_adFrameStatus), CRDTP_DESERIALIZE_FIELD("crossOriginIsolatedContextType", m_crossOriginIsolatedContextType),
    CRDTP_DESERIALIZE_FIELD("domainAndRegistry", m_domainAndRegistry), CRDTP_DESERIALIZE_FIELD("gatedAPIFeatures", m_gatedAPIFeatures), CRDTP_DESERIALIZE_FIELD("id", m_id),
    CRDTP_DESERIALIZE_FIELD("loaderId", m_loaderId), CRDTP_DESERIALIZE_FIELD("mimeType", m_mimeType), CRDTP_DESERIALIZE_FIELD_OPT("name", m_name),
    CRDTP_DESERIALIZE_FIELD_OPT("parentId", m_parentId), CRDTP_DESERIALIZE_FIELD("secureContextType", m_secureContextType),
    CRDTP_DESERIALIZE_FIELD("securityOrigin", m_securityOrigin), CRDTP_DESERIALIZE_FIELD_OPT("unreachableUrl", m_unreachableUrl), CRDTP_DESERIALIZE_FIELD("url", m_url),
...
CRDTP_DESERIALIZE_FIELD("clientHeight", m_clientHeight), CRDTP_DESERIALIZE_FIELD("clientWidth", m_clientWidth), CRDTP_DESERIALIZE_FIELD("offsetX", m_offsetX),
    CRDTP_DESERIALIZE_FIELD("offsetY", m_offsetY), CRDTP_DESERIALIZE_FIELD("pageX", m_pageX), CRDTP_DESERIALIZE_FIELD("pageY", m_pageY), CRDTP_DESERIALIZE_FIELD("scale", m_scale),
...
CRDTP_DESERIALIZE_FIELD("height", m_height), CRDTP_DESERIALIZE_FIELD("scale", m_scale), CRDTP_DESERIALIZE_FIELD("width", m_width), CRDTP_DESERIALIZE_FIELD("x", m_x),
...
CRDTP_DESERIALIZE_FIELD_OPT("context", m_context), CRDTP_DESERIALIZE_FIELD("reason", m_reason), CRDTP_DESERIALIZE_FIELD("type", m_type),
    CRDTP_END_DESERIALIZER()
...
const char HasEffectiveUrl[] = "HasEffectiveUrl";
...
void Frontend::frameAttached(
    const String& frameId, const String& parentFrameId, Maybe<v8_inspector::protocol::Runtime::API::StackTrace> stack, Maybe<protocol::Page::AdScriptId> adScriptId)
{
    if (!frontend_channel_)
        return;
    crdtp::ObjectSerializer serializer;
...
void Frontend::prerenderAttemptCompleted(const String& initiatingFrameId, const String& prerenderingUrl, const String& finalStatus, Maybe<String> disallowedApiMethod)
{
    if (!frontend_channel_)
        return;
    crdtp::ObjectSerializer serializer;
    ...
    serializer.AddField(crdtp::MakeSpan("disallowedApiMethod"), disallowedApiMethod);
...
CRDTP_DESERIALIZE_FIELD_OPT("includeCommandLineAPI", includeCommandLineAPI), CRDTP_DESERIALIZE_FIELD("source", source), CRDTP_DESERIALIZE_FIELD_OPT("worldName", worldName),
    CRDTP_END_DESERIALIZER()
...
CRDTP_DESERIALIZE_FIELD("frameId", frameId), CRDTP_DESERIALIZE_FIELD_OPT("grantUniveralAccess", grantUniveralAccess), CRDTP_DESERIALIZE_FIELD_OPT("worldName", worldName),
    CRDTP_END_DESERIALIZER()
...
void DomainDispatcherImpl::getLayoutMetrics(const crdtp::Dispatchable& dispatchable)
{
    ...
    DispatchResponse response
        = m_backend->getLayoutMetrics(&out_layoutViewport, &out_visualViewport, &out_contentSize, &out_cssLayoutViewport, &out_cssVisualViewport, &out_cssContentSize);
    if (response.IsFallThrough()) {
...
CRDTP_DESERIALIZE_FIELD_OPT("ignoreCache", ignoreCache), CRDTP_DESERIALIZE_FIELD_OPT("scriptToEvaluateOnLoad", scriptToEvaluateOnLoad), CRDTP_END_DESERIALIZER()
...
void DomainDispatcherImpl::startScreencast(const crdtp::Dispatchable& dispatchable)
{
    ...
    std::unique_ptr<DomainDispatcher::WeakPtr> weak = weakPtr();
    DispatchResponse response
        = m_backend->startScreencast(std::move(params.format), std::move(params.quality), std::move(params.maxWidth), std::move(params.maxHeight), std::move(params.everyNthFrame));
    if (response.IsFallThrough()) {
