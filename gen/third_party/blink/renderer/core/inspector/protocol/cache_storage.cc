...
CRDTP_DESERIALIZE_FIELD("requestHeaders", m_requestHeaders), CRDTP_DESERIALIZE_FIELD("requestMethod", m_requestMethod), CRDTP_DESERIALIZE_FIELD("requestURL", m_requestURL),
    CRDTP_DESERIALIZE_FIELD("responseHeaders", m_responseHeaders), CRDTP_DESERIALIZE_FIELD("responseStatus", m_responseStatus),
    CRDTP_DESERIALIZE_FIELD("responseStatusText", m_responseStatusText), CRDTP_DESERIALIZE_FIELD("responseTime", m_responseTime),
...
CRDTP_DESERIALIZE_FIELD("securityOrigin", securityOrigin), CRDTP_END_DESERIALIZER()
...
CRDTP_DESERIALIZE_FIELD("cacheId", cacheId), CRDTP_DESERIALIZE_FIELD("requestHeaders", requestHeaders), CRDTP_DESERIALIZE_FIELD("requestURL", requestURL), CRDTP_END_DESERIALIZER()
