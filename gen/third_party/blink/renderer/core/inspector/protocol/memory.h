...
public:
    ...
    private:
        ...
        template <int STEP> SamplingProfileNodeBuilder<STATE | STEP>& castState() { return *reinterpret_cast<SamplingProfileNodeBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::Memory::SamplingProfileNode> m_result;
    };

    static SamplingProfileNodeBuilder<0> create() { return SamplingProfileNodeBuilder<0>(); }
...
public:
    ...
    private:
        ...
        template <int STEP> SamplingProfileBuilder<STATE | STEP>& castState() { return *reinterpret_cast<SamplingProfileBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::Memory::SamplingProfile> m_result;
    };

    static SamplingProfileBuilder<0> create() { return SamplingProfileBuilder<0>(); }
...
public:
    ...
    public:
        enum { NoFieldsSet = 0, NameSet = 1 << 1, UuidSet = 1 << 2, BaseAddressSet = 1 << 3, SizeSet = 1 << 4, AllFieldsSet = (NameSet | UuidSet | BaseAddressSet | SizeSet | 0) };
    ...
    private:
        ...
        template <int STEP> ModuleBuilder<STATE | STEP>& castState() { return *reinterpret_cast<ModuleBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::Memory::Module> m_result;
    };

    static ModuleBuilder<0> create() { return ModuleBuilder<0>(); }
