...
CRDTP_DESERIALIZE_FIELD("containingBlockRect", m_containingBlockRect), CRDTP_DESERIALIZE_FIELD_OPT("nearestLayerShiftingContainingBlock", m_nearestLayerShiftingContainingBlock),
...
CRDTP_DESERIALIZE_FIELD_OPT("anchorX", m_anchorX), CRDTP_DESERIALIZE_FIELD_OPT("anchorY", m_anchorY), CRDTP_DESERIALIZE_FIELD_OPT("anchorZ", m_anchorZ),
    CRDTP_DESERIALIZE_FIELD_OPT("backendNodeId", m_backendNodeId), CRDTP_DESERIALIZE_FIELD("drawsContent", m_drawsContent), CRDTP_DESERIALIZE_FIELD("height", m_height),
    CRDTP_DESERIALIZE_FIELD_OPT("invisible", m_invisible), CRDTP_DESERIALIZE_FIELD("layerId", m_layerId), CRDTP_DESERIALIZE_FIELD("offsetX", m_offsetX),
    CRDTP_DESERIALIZE_FIELD("offsetY", m_offsetY), CRDTP_DESERIALIZE_FIELD("paintCount", m_paintCount), CRDTP_DESERIALIZE_FIELD_OPT("parentLayerId", m_parentLayerId),
    CRDTP_DESERIALIZE_FIELD_OPT("scrollRects", m_scrollRects), CRDTP_DESERIALIZE_FIELD_OPT("stickyPositionConstraint", m_stickyPositionConstraint),
    CRDTP_DESERIALIZE_FIELD_OPT("transform", m_transform), CRDTP_DESERIALIZE_FIELD("width", m_width),
    CRDTP_END_DESERIALIZER()
...
CRDTP_DESERIALIZE_FIELD_OPT("clipRect", clipRect), CRDTP_DESERIALIZE_FIELD_OPT("minDuration", minDuration), CRDTP_DESERIALIZE_FIELD_OPT("minRepeatCount", minRepeatCount),
...
void DomainDispatcherImpl::profileSnapshot(const crdtp::Dispatchable& dispatchable)
{
    ...
    DispatchResponse response
        = m_backend->profileSnapshot(params.snapshotId, std::move(params.minRepeatCount), std::move(params.minDuration), std::move(params.clipRect), &out_timings);
    if (response.IsFallThrough()) {
