...
CRDTP_DESERIALIZE_FIELD_OPT("attribute", m_attribute), CRDTP_DESERIALIZE_FIELD_OPT("attributeValue", m_attributeValue), CRDTP_DESERIALIZE_FIELD_OPT("invalid", m_invalid),
    CRDTP_DESERIALIZE_FIELD_OPT("invalidReason", m_invalidReason), CRDTP_DESERIALIZE_FIELD_OPT("nativeSource", m_nativeSource),
    CRDTP_DESERIALIZE_FIELD_OPT("nativeSourceValue", m_nativeSourceValue), CRDTP_DESERIALIZE_FIELD_OPT("superseded", m_superseded), CRDTP_DESERIALIZE_FIELD("type", m_type),
...
CRDTP_DESERIALIZE_FIELD_OPT("backendDOMNodeId", m_backendDOMNodeId), CRDTP_DESERIALIZE_FIELD_OPT("childIds", m_childIds), CRDTP_DESERIALIZE_FIELD_OPT("chromeRole", m_chromeRole),
    CRDTP_DESERIALIZE_FIELD_OPT("description", m_description), CRDTP_DESERIALIZE_FIELD_OPT("frameId", m_frameId), CRDTP_DESERIALIZE_FIELD("ignored", m_ignored),
...
CRDTP_DESERIALIZE_FIELD_OPT("backendNodeId", backendNodeId), CRDTP_DESERIALIZE_FIELD_OPT("fetchRelatives", fetchRelatives), CRDTP_DESERIALIZE_FIELD_OPT("nodeId", nodeId),
...
void DomainDispatcherImpl::getPartialAXTree(const crdtp::Dispatchable& dispatchable)
{
    ...
    DispatchResponse response
        = m_backend->getPartialAXTree(std::move(params.nodeId), std::move(params.backendNodeId), std::move(params.objectId), std::move(params.fetchRelatives), &out_nodes);
    if (response.IsFallThrough()) {
...
CRDTP_DESERIALIZE_FIELD_OPT("accessibleName", accessibleName), CRDTP_DESERIALIZE_FIELD_OPT("backendNodeId", backendNodeId), CRDTP_DESERIALIZE_FIELD_OPT("nodeId", nodeId),
    CRDTP_DESERIALIZE_FIELD_OPT("objectId", objectId), CRDTP_DESERIALIZE_FIELD_OPT("role", role), CRDTP_END_DESERIALIZER()
...
void DomainDispatcherImpl::queryAXTree(const crdtp::Dispatchable& dispatchable)
{
    ...
    m_backend->queryAXTree(std::move(params.nodeId), std::move(params.backendNodeId), std::move(params.objectId), std::move(params.accessibleName), std::move(params.role),
        std::make_unique<QueryAXTreeCallbackImpl>(weakPtr(), dispatchable.CallId(), dispatchable.Serialized()));
}
