...
CORE_EXPORT extern const char PageTransition[];
CORE_EXPORT extern const char PageTransitionContainer[];
CORE_EXPORT extern const char PageTransitionImageWrapper[];
CORE_EXPORT extern const char PageTransitionOutgoingImage[];
CORE_EXPORT extern const char PageTransitionIncomingImage[];
} // namespace PseudoTypeEnum
...
public:
    ...
    public:
        enum { NoFieldsSet = 0, NodeTypeSet = 1 << 1, NodeNameSet = 1 << 2, BackendNodeIdSet = 1 << 3, AllFieldsSet = (NodeTypeSet | NodeNameSet | BackendNodeIdSet | 0) };
    ...
    private:
        ...
        template <int STEP> BackendNodeBuilder<STATE | STEP>& castState() { return *reinterpret_cast<BackendNodeBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::DOM::BackendNode> m_result;
    };

    static BackendNodeBuilder<0> create() { return BackendNodeBuilder<0>(); }
...
public:
    ...
    bool hasCompatibilityMode() { return m_compatibilityMode.isJust(); }
    String getCompatibilityMode(const String& defaultValue) { return m_compatibilityMode.isJust() ? m_compatibilityMode.fromJust() : defaultValue; }
    void setCompatibilityMode(const String& value) { m_compatibilityMode = value; }

    bool hasAssignedSlot() { return m_assignedSlot.isJust(); }
    protocol::DOM::BackendNode* getAssignedSlot(protocol::DOM::BackendNode* defaultValue) { return m_assignedSlot.isJust() ? m_assignedSlot.fromJust() : defaultValue; }
    ...
    private:
        ...
        template <int STEP> NodeBuilder<STATE | STEP>& castState() { return *reinterpret_cast<NodeBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::DOM::Node> m_result;
    };

    static NodeBuilder<0> create() { return NodeBuilder<0>(); }
...
public:
    ...
    private:
        ...
        template <int STEP> RGBABuilder<STATE | STEP>& castState() { return *reinterpret_cast<RGBABuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::DOM::RGBA> m_result;
    };

    static RGBABuilder<0> create() { return RGBABuilder<0>(); }
...
public:
    ...
    private:
        ...
        template <int STEP> BoxModelBuilder<STATE | STEP>& castState() { return *reinterpret_cast<BoxModelBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::DOM::BoxModel> m_result;
    };

    static BoxModelBuilder<0> create() { return BoxModelBuilder<0>(); }
...
public:
    ...
    private:
        ...
        template <int STEP> ShapeOutsideInfoBuilder<STATE | STEP>& castState() { return *reinterpret_cast<ShapeOutsideInfoBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::DOM::ShapeOutsideInfo> m_result;
    };

    static ShapeOutsideInfoBuilder<0> create() { return ShapeOutsideInfoBuilder<0>(); }
...
public:
    ...
    private:
        ...
        template <int STEP> RectBuilder<STATE | STEP>& castState() { return *reinterpret_cast<RectBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::DOM::Rect> m_result;
    };

    static RectBuilder<0> create() { return RectBuilder<0>(); }
...
public:
    ...
    virtual DispatchResponse describeNode(
        Maybe<int> in_nodeId, Maybe<int> in_backendNodeId, Maybe<String> in_objectId, Maybe<int> in_depth, Maybe<bool> in_pierce, std::unique_ptr<protocol::DOM::Node>* out_node)
        = 0;
    virtual DispatchResponse scrollIntoViewIfNeeded(Maybe<int> in_nodeId, Maybe<int> in_backendNodeId, Maybe<String> in_objectId, Maybe<protocol::DOM::Rect> in_rect) = 0;
    ...
    virtual DispatchResponse getNodesForSubtreeByStyle(int in_nodeId, std::unique_ptr<protocol::Array<protocol::DOM::CSSComputedStyleProperty>> in_computedStyles,
        Maybe<bool> in_pierce, std::unique_ptr<protocol::Array<int>>* out_nodeIds)
        = 0;
    virtual DispatchResponse getNodeForLocation(
        int in_x, int in_y, Maybe<bool> in_includeUserAgentShadowDOM, Maybe<bool> in_ignorePointerEventsNone, int* out_backendNodeId, String* out_frameId, Maybe<int>* out_nodeId)
        = 0;
    ...
    virtual DispatchResponse getContainerForNode(int in_nodeId, Maybe<String> in_containerName, Maybe<int>* out_nodeId) = 0;
