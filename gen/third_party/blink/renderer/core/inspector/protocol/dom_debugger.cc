...
CRDTP_DESERIALIZE_FIELD_OPT("backendNodeId", m_backendNodeId), CRDTP_DESERIALIZE_FIELD("columnNumber", m_columnNumber), CRDTP_DESERIALIZE_FIELD_OPT("handler", m_handler),
    CRDTP_DESERIALIZE_FIELD("lineNumber", m_lineNumber), CRDTP_DESERIALIZE_FIELD("once", m_once), CRDTP_DESERIALIZE_FIELD_OPT("originalHandler", m_originalHandler),
    CRDTP_DESERIALIZE_FIELD("passive", m_passive), CRDTP_DESERIALIZE_FIELD("scriptId", m_scriptId), CRDTP_DESERIALIZE_FIELD("type", m_type),
...
CRDTP_DESERIALIZE_FIELD_OPT("depth", depth), CRDTP_DESERIALIZE_FIELD("objectId", objectId), CRDTP_DESERIALIZE_FIELD_OPT("pierce", pierce), CRDTP_END_DESERIALIZER()
