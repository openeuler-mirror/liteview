...
public:
    ...
    {
        return m_handler.isJust() ? m_handler.fromJust() : defaultValue;
    }
    ...
    {
        return m_originalHandler.isJust() ? m_originalHandler.fromJust() : defaultValue;
    }
    ...
    private:
        ...
        template <int STEP> EventListenerBuilder<STATE | STEP>& castState() { return *reinterpret_cast<EventListenerBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::DOMDebugger::EventListener> m_result;
    };

    static EventListenerBuilder<0> create() { return EventListenerBuilder<0>(); }
...
public:
    ...
    virtual DispatchResponse getEventListeners(
        const String& in_objectId, Maybe<int> in_depth, Maybe<bool> in_pierce, std::unique_ptr<protocol::Array<protocol::DOMDebugger::EventListener>>* out_listeners)
        = 0;
