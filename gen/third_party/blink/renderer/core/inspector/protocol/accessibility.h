...
public:
    ...
    {
        return m_attributeValue.isJust() ? m_attributeValue.fromJust() : defaultValue;
    }
    ...
    {
        return m_nativeSourceValue.isJust() ? m_nativeSourceValue.fromJust() : defaultValue;
    }
    ...
    private:
        ...
        template <int STEP> AXValueSourceBuilder<STATE | STEP>& castState() { return *reinterpret_cast<AXValueSourceBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::Accessibility::AXValueSource> m_result;
    };

    static AXValueSourceBuilder<0> create() { return AXValueSourceBuilder<0>(); }
...
public:
    ...
    private:
        ...
        template <int STEP> AXRelatedNodeBuilder<STATE | STEP>& castState() { return *reinterpret_cast<AXRelatedNodeBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::Accessibility::AXRelatedNode> m_result;
    };

    static AXRelatedNodeBuilder<0> create() { return AXRelatedNodeBuilder<0>(); }

private:
    DECLARE_SERIALIZATION_SUPPORT();

    AXRelatedNode() { m_backendDOMNodeId = 0; }
...
public:
    ...
    private:
        ...
        template <int STEP> AXPropertyBuilder<STATE | STEP>& castState() { return *reinterpret_cast<AXPropertyBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::Accessibility::AXProperty> m_result;
    };

    static AXPropertyBuilder<0> create() { return AXPropertyBuilder<0>(); }
...
public:
    ...
    {
        return m_relatedNodes.isJust() ? m_relatedNodes.fromJust() : defaultValue;
    }
    ...
    {
        return m_sources.isJust() ? m_sources.fromJust() : defaultValue;
    }
    ...
    private:
        ...
        template <int STEP> AXValueBuilder<STATE | STEP>& castState() { return *reinterpret_cast<AXValueBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::Accessibility::AXValue> m_result;
    };

    static AXValueBuilder<0> create() { return AXValueBuilder<0>(); }
...
public:
    ...
    {
        return m_ignoredReasons.isJust() ? m_ignoredReasons.fromJust() : defaultValue;
    }
    ...
    bool hasChromeRole() { return m_chromeRole.isJust(); }
    protocol::Accessibility::AXValue* getChromeRole(protocol::Accessibility::AXValue* defaultValue) { return m_chromeRole.isJust() ? m_chromeRole.fromJust() : defaultValue; }
    ...
    {
        return m_properties.isJust() ? m_properties.fromJust() : defaultValue;
    }
    ...
    private:
        ...
        template <int STEP> AXNodeBuilder<STATE | STEP>& castState() { return *reinterpret_cast<AXNodeBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::Accessibility::AXNode> m_result;
    };

    static AXNodeBuilder<0> create() { return AXNodeBuilder<0>(); }

private:
    DECLARE_SERIALIZATION_SUPPORT();

    AXNode() { m_ignored = false; }
...
public:
    ...
    virtual DispatchResponse getPartialAXTree(Maybe<int> in_nodeId, Maybe<int> in_backendNodeId, Maybe<String> in_objectId, Maybe<bool> in_fetchRelatives,
        ...
        = 0;
    virtual DispatchResponse getFullAXTree(Maybe<int> in_depth, Maybe<String> in_frameId, std::unique_ptr<protocol::Array<protocol::Accessibility::AXNode>>* out_nodes) = 0;
    virtual DispatchResponse getRootAXNode(Maybe<String> in_frameId, std::unique_ptr<protocol::Accessibility::AXNode>* out_node) = 0;
    virtual DispatchResponse getAXNodeAndAncestors(
        Maybe<int> in_nodeId, Maybe<int> in_backendNodeId, Maybe<String> in_objectId, std::unique_ptr<protocol::Array<protocol::Accessibility::AXNode>>* out_nodes)
        = 0;
    virtual DispatchResponse getChildAXNodes(const String& in_id, Maybe<String> in_frameId, std::unique_ptr<protocol::Array<protocol::Accessibility::AXNode>>* out_nodes) = 0;
    ...
    virtual void queryAXTree(Maybe<int> in_nodeId, Maybe<int> in_backendNodeId, Maybe<String> in_objectId, Maybe<String> in_accessibleName, Maybe<String> in_role,
