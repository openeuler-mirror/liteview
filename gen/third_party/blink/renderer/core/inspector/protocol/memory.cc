...
CRDTP_DESERIALIZE_FIELD("baseAddress", m_baseAddress), CRDTP_DESERIALIZE_FIELD("name", m_name), CRDTP_DESERIALIZE_FIELD("size", m_size), CRDTP_DESERIALIZE_FIELD("uuid", m_uuid),
    CRDTP_END_DESERIALIZER()
...
CRDTP_DESERIALIZE_FIELD_OPT("samplingInterval", samplingInterval), CRDTP_DESERIALIZE_FIELD_OPT("suppressRandomness", suppressRandomness), CRDTP_END_DESERIALIZER()
