...
CRDTP_DESERIALIZE_FIELD_OPT("args", m_args), CRDTP_DESERIALIZE_FIELD_OPT("category", m_category), CRDTP_DESERIALIZE_FIELD("level", m_level),
    CRDTP_DESERIALIZE_FIELD_OPT("lineNumber", m_lineNumber), CRDTP_DESERIALIZE_FIELD_OPT("networkRequestId", m_networkRequestId), CRDTP_DESERIALIZE_FIELD("source", m_source),
    CRDTP_DESERIALIZE_FIELD_OPT("stackTrace", m_stackTrace), CRDTP_DESERIALIZE_FIELD("text", m_text), CRDTP_DESERIALIZE_FIELD("timestamp", m_timestamp),
    CRDTP_DESERIALIZE_FIELD_OPT("url", m_url), CRDTP_DESERIALIZE_FIELD_OPT("workerId", m_workerId),
