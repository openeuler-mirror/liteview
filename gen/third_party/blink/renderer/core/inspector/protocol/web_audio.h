...
public:
    ...
    private:
        ...
        template <int STEP> ContextRealtimeDataBuilder<STATE | STEP>& castState() { return *reinterpret_cast<ContextRealtimeDataBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::WebAudio::ContextRealtimeData> m_result;
    };

    static ContextRealtimeDataBuilder<0> create() { return ContextRealtimeDataBuilder<0>(); }
...
public:
    ...
    {
        return m_realtimeData.isJust() ? m_realtimeData.fromJust() : defaultValue;
    }
    ...
    private:
        ...
        template <int STEP> BaseAudioContextBuilder<STATE | STEP>& castState() { return *reinterpret_cast<BaseAudioContextBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::WebAudio::BaseAudioContext> m_result;
    };

    static BaseAudioContextBuilder<0> create() { return BaseAudioContextBuilder<0>(); }
...
public:
    ...
    private:
        ...
        template <int STEP> AudioListenerBuilder<STATE | STEP>& castState() { return *reinterpret_cast<AudioListenerBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::WebAudio::AudioListener> m_result;
    };

    static AudioListenerBuilder<0> create() { return AudioListenerBuilder<0>(); }
...
public:
    ...
    private:
        ...
        template <int STEP> AudioNodeBuilder<STATE | STEP>& castState() { return *reinterpret_cast<AudioNodeBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::WebAudio::AudioNode> m_result;
    };

    static AudioNodeBuilder<0> create() { return AudioNodeBuilder<0>(); }
...
public:
    ...
    private:
        ...
        template <int STEP> AudioParamBuilder<STATE | STEP>& castState() { return *reinterpret_cast<AudioParamBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::WebAudio::AudioParam> m_result;
    };

    static AudioParamBuilder<0> create() { return AudioParamBuilder<0>(); }
