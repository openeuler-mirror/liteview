...
public:
    ...
    {
        return m_eventListeners.isJust() ? m_eventListeners.fromJust() : defaultValue;
    }
    ...
    private:
        ...
        template <int STEP> DOMNodeBuilder<STATE | STEP>& castState() { return *reinterpret_cast<DOMNodeBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::DOMSnapshot::DOMNode> m_result;
    };

    static DOMNodeBuilder<0> create() { return DOMNodeBuilder<0>(); }
...
public:
    ...
    private:
        ...
        template <int STEP> InlineTextBoxBuilder<STATE | STEP>& castState() { return *reinterpret_cast<InlineTextBoxBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::DOMSnapshot::InlineTextBox> m_result;
    };

    static InlineTextBoxBuilder<0> create() { return InlineTextBoxBuilder<0>(); }
...
public:
    ...
    {
        return m_inlineTextNodes.isJust() ? m_inlineTextNodes.fromJust() : defaultValue;
    }
    ...
    private:
        ...
        template <int STEP> LayoutTreeNodeBuilder<STATE | STEP>& castState() { return *reinterpret_cast<LayoutTreeNodeBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::DOMSnapshot::LayoutTreeNode> m_result;
    };

    static LayoutTreeNodeBuilder<0> create() { return LayoutTreeNodeBuilder<0>(); }

private:
    DECLARE_SERIALIZATION_SUPPORT();

    LayoutTreeNode() { m_domNodeIndex = 0; }
...
public:
    ...
    private:
        ...
        template <int STEP> ComputedStyleBuilder<STATE | STEP>& castState() { return *reinterpret_cast<ComputedStyleBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::DOMSnapshot::ComputedStyle> m_result;
    };

    static ComputedStyleBuilder<0> create() { return ComputedStyleBuilder<0>(); }
...
public:
    ...
    private:
        ...
        template <int STEP> NameValueBuilder<STATE | STEP>& castState() { return *reinterpret_cast<NameValueBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::DOMSnapshot::NameValue> m_result;
    };

    static NameValueBuilder<0> create() { return NameValueBuilder<0>(); }
...
public:
    ...
    private:
        ...
        template <int STEP> RareStringDataBuilder<STATE | STEP>& castState() { return *reinterpret_cast<RareStringDataBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::DOMSnapshot::RareStringData> m_result;
    };

    static RareStringDataBuilder<0> create() { return RareStringDataBuilder<0>(); }
...
public:
    ...
    private:
        ...
        template <int STEP> RareBooleanDataBuilder<STATE | STEP>& castState() { return *reinterpret_cast<RareBooleanDataBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::DOMSnapshot::RareBooleanData> m_result;
    };

    static RareBooleanDataBuilder<0> create() { return RareBooleanDataBuilder<0>(); }
...
public:
    ...
    private:
        ...
        template <int STEP> RareIntegerDataBuilder<STATE | STEP>& castState() { return *reinterpret_cast<RareIntegerDataBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::DOMSnapshot::RareIntegerData> m_result;
    };

    static RareIntegerDataBuilder<0> create() { return RareIntegerDataBuilder<0>(); }
...
public:
    ...
    void setTitle(int value) { m_title = value; }
    ...
    bool hasContentWidth() { return m_contentWidth.isJust(); }
    double getContentWidth(double defaultValue) { return m_contentWidth.isJust() ? m_contentWidth.fromJust() : defaultValue; }
    void setContentWidth(double value) { m_contentWidth = value; }

    bool hasContentHeight() { return m_contentHeight.isJust(); }
    double getContentHeight(double defaultValue) { return m_contentHeight.isJust() ? m_contentHeight.fromJust() : defaultValue; }
    void setContentHeight(double value) { m_contentHeight = value; }
    ...
    public:
        enum {
            ...
            TextBoxesSet = 1 << 11,
            AllFieldsSet
            = (DocumentURLSet | TitleSet | BaseURLSet | ContentLanguageSet | EncodingNameSet | PublicIdSet | SystemIdSet | FrameIdSet | NodesSet | LayoutSet | TextBoxesSet | 0)
        };
    ...
    private:
        ...
        template <int STEP> DocumentSnapshotBuilder<STATE | STEP>& castState() { return *reinterpret_cast<DocumentSnapshotBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::DOMSnapshot::DocumentSnapshot> m_result;
    };

    static DocumentSnapshotBuilder<0> create() { return DocumentSnapshotBuilder<0>(); }
...
public:
    ...
    void setShadowRootType(std::unique_ptr<protocol::DOMSnapshot::RareStringData> value) { m_shadowRootType = std::move(value); }
    ...
    {
        return m_textValue.isJust() ? m_textValue.fromJust() : defaultValue;
    }
    ...
    {
        return m_inputValue.isJust() ? m_inputValue.fromJust() : defaultValue;
    }
    ...
    {
        return m_inputChecked.isJust() ? m_inputChecked.fromJust() : defaultValue;
    }
    ...
    {
        return m_optionSelected.isJust() ? m_optionSelected.fromJust() : defaultValue;
    }
    ...
    {
        return m_contentDocumentIndex.isJust() ? m_contentDocumentIndex.fromJust() : defaultValue;
    }
    ...
    {
        return m_pseudoIdentifier.isJust() ? m_pseudoIdentifier.fromJust() : defaultValue;
    }
    void setPseudoIdentifier(std::unique_ptr<protocol::DOMSnapshot::RareStringData> value) { m_pseudoIdentifier = std::move(value); }

    bool hasIsClickable() { return m_isClickable.isJust(); }
    protocol::DOMSnapshot::RareBooleanData* getIsClickable(protocol::DOMSnapshot::RareBooleanData* defaultValue)
    {
        return m_isClickable.isJust() ? m_isClickable.fromJust() : defaultValue;
    }
    ...
    {
        return m_currentSourceURL.isJust() ? m_currentSourceURL.fromJust() : defaultValue;
    }
    ...
    {
        return m_originURL.isJust() ? m_originURL.fromJust() : defaultValue;
    }
    ...
    private:
        ...
        template <int STEP> NodeTreeSnapshotBuilder<STATE | STEP>& castState() { return *reinterpret_cast<NodeTreeSnapshotBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::DOMSnapshot::NodeTreeSnapshot> m_result;
    };

    static NodeTreeSnapshotBuilder<0> create() { return NodeTreeSnapshotBuilder<0>(); }
...
public:
    ...
    bool hasPaintOrders() { return m_paintOrders.isJust(); }
    protocol::Array<int>* getPaintOrders(protocol::Array<int>* defaultValue) { return m_paintOrders.isJust() ? m_paintOrders.fromJust() : defaultValue; }
    void setPaintOrders(std::unique_ptr<protocol::Array<int>> value) { m_paintOrders = std::move(value); }

    bool hasOffsetRects() { return m_offsetRects.isJust(); }
    protocol::Array<protocol::Array<double>>* getOffsetRects(protocol::Array<protocol::Array<double>>* defaultValue)
    {
        return m_offsetRects.isJust() ? m_offsetRects.fromJust() : defaultValue;
    }
    void setOffsetRects(std::unique_ptr<protocol::Array<protocol::Array<double>>> value) { m_offsetRects = std::move(value); }
    ...
    {
        return m_scrollRects.isJust() ? m_scrollRects.fromJust() : defaultValue;
    }
    void setScrollRects(std::unique_ptr<protocol::Array<protocol::Array<double>>> value) { m_scrollRects = std::move(value); }

    bool hasClientRects() { return m_clientRects.isJust(); }
    protocol::Array<protocol::Array<double>>* getClientRects(protocol::Array<protocol::Array<double>>* defaultValue)
    {
        return m_clientRects.isJust() ? m_clientRects.fromJust() : defaultValue;
    }
    void setClientRects(std::unique_ptr<protocol::Array<protocol::Array<double>>> value) { m_clientRects = std::move(value); }

    bool hasBlendedBackgroundColors() { return m_blendedBackgroundColors.isJust(); }
    protocol::Array<int>* getBlendedBackgroundColors(protocol::Array<int>* defaultValue)
    {
        return m_blendedBackgroundColors.isJust() ? m_blendedBackgroundColors.fromJust() : defaultValue;
    }
    void setBlendedBackgroundColors(std::unique_ptr<protocol::Array<int>> value) { m_blendedBackgroundColors = std::move(value); }

    bool hasTextColorOpacities() { return m_textColorOpacities.isJust(); }
    protocol::Array<double>* getTextColorOpacities(protocol::Array<double>* defaultValue) { return m_textColorOpacities.isJust() ? m_textColorOpacities.fromJust() : defaultValue; }
    void setTextColorOpacities(std::unique_ptr<protocol::Array<double>> value) { m_textColorOpacities = std::move(value); }
    ...
    private:
        ...
        template <int STEP> LayoutTreeSnapshotBuilder<STATE | STEP>& castState() { return *reinterpret_cast<LayoutTreeSnapshotBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::DOMSnapshot::LayoutTreeSnapshot> m_result;
    };

    static LayoutTreeSnapshotBuilder<0> create() { return LayoutTreeSnapshotBuilder<0>(); }
...
public:
    ...
    private:
        ...
        template <int STEP> TextBoxSnapshotBuilder<STATE | STEP>& castState() { return *reinterpret_cast<TextBoxSnapshotBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::DOMSnapshot::TextBoxSnapshot> m_result;
    };

    static TextBoxSnapshotBuilder<0> create() { return TextBoxSnapshotBuilder<0>(); }
...
public:
    ...
    virtual DispatchResponse getSnapshot(std::unique_ptr<protocol::Array<String>> in_computedStyleWhitelist, Maybe<bool> in_includeEventListeners, Maybe<bool> in_includePaintOrder,
        Maybe<bool> in_includeUserAgentShadowTree, std::unique_ptr<protocol::Array<protocol::DOMSnapshot::DOMNode>>* out_domNodes,
        ...
        = 0;
    virtual DispatchResponse captureSnapshot(std::unique_ptr<protocol::Array<String>> in_computedStyles, Maybe<bool> in_includePaintOrder, Maybe<bool> in_includeDOMRects,
        Maybe<bool> in_includeBlendedBackgroundColors, Maybe<bool> in_includeTextColorOpacities,
