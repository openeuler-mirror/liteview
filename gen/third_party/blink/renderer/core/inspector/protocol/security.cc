...
CRDTP_DESERIALIZE_FIELD("certificate", m_certificate), CRDTP_DESERIALIZE_FIELD("certificateHasSha1Signature", m_certificateHasSha1Signature),
    CRDTP_DESERIALIZE_FIELD("certificateHasWeakSignature", m_certificateHasWeakSignature), CRDTP_DESERIALIZE_FIELD_OPT("certificateNetworkError", m_certificateNetworkError),
    CRDTP_DESERIALIZE_FIELD("cipher", m_cipher), CRDTP_DESERIALIZE_FIELD("issuer", m_issuer), CRDTP_DESERIALIZE_FIELD("keyExchange", m_keyExchange),
    CRDTP_DESERIALIZE_FIELD_OPT("keyExchangeGroup", m_keyExchangeGroup), CRDTP_DESERIALIZE_FIELD_OPT("mac", m_mac), CRDTP_DESERIALIZE_FIELD("modernSSL", m_modernSSL),
    CRDTP_DESERIALIZE_FIELD("obsoleteSslCipher", m_obsoleteSslCipher), CRDTP_DESERIALIZE_FIELD("obsoleteSslKeyExchange", m_obsoleteSslKeyExchange),
    CRDTP_DESERIALIZE_FIELD("obsoleteSslProtocol", m_obsoleteSslProtocol), CRDTP_DESERIALIZE_FIELD("obsoleteSslSignature", m_obsoleteSslSignature),
    CRDTP_DESERIALIZE_FIELD("protocol", m_protocol), CRDTP_DESERIALIZE_FIELD("subjectName", m_subjectName), CRDTP_DESERIALIZE_FIELD("validFrom", m_validFrom),
...
CRDTP_DESERIALIZE_FIELD("certificate", m_certificate), CRDTP_DESERIALIZE_FIELD("description", m_description), CRDTP_DESERIALIZE_FIELD("mixedContentType", m_mixedContentType),
    CRDTP_DESERIALIZE_FIELD_OPT("recommendations", m_recommendations), CRDTP_DESERIALIZE_FIELD("securityState", m_securityState), CRDTP_DESERIALIZE_FIELD("summary", m_summary),
...
CRDTP_DESERIALIZE_FIELD("containedMixedForm", m_containedMixedForm), CRDTP_DESERIALIZE_FIELD("displayedContentWithCertErrors", m_displayedContentWithCertErrors),
    CRDTP_DESERIALIZE_FIELD("displayedInsecureContentStyle", m_displayedInsecureContentStyle), CRDTP_DESERIALIZE_FIELD("displayedMixedContent", m_displayedMixedContent),
    CRDTP_DESERIALIZE_FIELD("ranContentWithCertErrors", m_ranContentWithCertErrors), CRDTP_DESERIALIZE_FIELD("ranInsecureContentStyle", m_ranInsecureContentStyle),
...
void Frontend::securityStateChanged(const String& securityState, bool schemeIsCryptographic,
    std::unique_ptr<protocol::Array<protocol::Security::SecurityStateExplanation>> explanations, std::unique_ptr<protocol::Security::InsecureContentStatus> insecureContentStatus,
