...
CRDTP_DESERIALIZE_FIELD("cause", m_cause), CRDTP_DESERIALIZE_FIELD("code", m_code), CRDTP_DESERIALIZE_FIELD("data", m_data), CRDTP_DESERIALIZE_FIELD("errorType", m_errorType),
