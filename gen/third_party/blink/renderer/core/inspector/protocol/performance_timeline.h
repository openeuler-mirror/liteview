...
public:
    ...
    private:
        ...
        template <int STEP> LargestContentfulPaintBuilder<STATE | STEP>& castState() { return *reinterpret_cast<LargestContentfulPaintBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::PerformanceTimeline::LargestContentfulPaint> m_result;
    };

    static LargestContentfulPaintBuilder<0> create() { return LargestContentfulPaintBuilder<0>(); }
...
public:
    ...
    private:
        ...
        template <int STEP> LayoutShiftAttributionBuilder<STATE | STEP>& castState() { return *reinterpret_cast<LayoutShiftAttributionBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::PerformanceTimeline::LayoutShiftAttribution> m_result;
    };

    static LayoutShiftAttributionBuilder<0> create() { return LayoutShiftAttributionBuilder<0>(); }
...
public:
    ...
    private:
        ...
        template <int STEP> LayoutShiftBuilder<STATE | STEP>& castState() { return *reinterpret_cast<LayoutShiftBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::PerformanceTimeline::LayoutShift> m_result;
    };

    static LayoutShiftBuilder<0> create() { return LayoutShiftBuilder<0>(); }
...
public:
    ...
    {
        return m_lcpDetails.isJust() ? m_lcpDetails.fromJust() : defaultValue;
    }
    ...
    {
        return m_layoutShiftDetails.isJust() ? m_layoutShiftDetails.fromJust() : defaultValue;
    }
    ...
    public:
        enum { NoFieldsSet = 0, FrameIdSet = 1 << 1, TypeSet = 1 << 2, NameSet = 1 << 3, TimeSet = 1 << 4, AllFieldsSet = (FrameIdSet | TypeSet | NameSet | TimeSet | 0) };
    ...
    private:
        ...
        template <int STEP> TimelineEventBuilder<STATE | STEP>& castState() { return *reinterpret_cast<TimelineEventBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::PerformanceTimeline::TimelineEvent> m_result;
    };

    static TimelineEventBuilder<0> create() { return TimelineEventBuilder<0>(); }

private:
    DECLARE_SERIALIZATION_SUPPORT();

    TimelineEvent() { m_time = 0; }
