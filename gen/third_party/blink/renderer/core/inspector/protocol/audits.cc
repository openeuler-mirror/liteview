...
CRDTP_DESERIALIZE_FIELD_OPT("cookie", m_cookie), CRDTP_DESERIALIZE_FIELD("cookieExclusionReasons", m_cookieExclusionReasons), CRDTP_DESERIALIZE_FIELD_OPT("cookieUrl", m_cookieUrl),
    CRDTP_DESERIALIZE_FIELD("cookieWarningReasons", m_cookieWarningReasons), CRDTP_DESERIALIZE_FIELD("operation", m_operation),
    CRDTP_DESERIALIZE_FIELD_OPT("rawCookieLine", m_rawCookieLine), CRDTP_DESERIALIZE_FIELD_OPT("request", m_request),
...
CRDTP_DESERIALIZE_FIELD_OPT("frame", m_frame), CRDTP_DESERIALIZE_FIELD("insecureURL", m_insecureURL), CRDTP_DESERIALIZE_FIELD("mainResourceURL", m_mainResourceURL),
    CRDTP_DESERIALIZE_FIELD_OPT("request", m_request), CRDTP_DESERIALIZE_FIELD("resolutionStatus", m_resolutionStatus), CRDTP_DESERIALIZE_FIELD_OPT("resourceType", m_resourceType),
    CRDTP_END_DESERIALIZER()
...
CRDTP_DESERIALIZE_FIELD_OPT("blockedFrame", m_blockedFrame), CRDTP_DESERIALIZE_FIELD_OPT("parentFrame", m_parentFrame), CRDTP_DESERIALIZE_FIELD("reason", m_reason),
...
CRDTP_DESERIALIZE_FIELD("columnNumber", m_columnNumber), CRDTP_DESERIALIZE_FIELD("lineNumber", m_lineNumber), CRDTP_DESERIALIZE_FIELD_OPT("scriptId", m_scriptId),
...
CRDTP_DESERIALIZE_FIELD_OPT("httpStatusCode", m_httpStatusCode), CRDTP_DESERIALIZE_FIELD_OPT("packageName", m_packageName), CRDTP_DESERIALIZE_FIELD_OPT("signature", m_signature),
    CRDTP_DESERIALIZE_FIELD("url", m_url), CRDTP_DESERIALIZE_FIELD("violationType", m_violationType),
    CRDTP_END_DESERIALIZER()

        CRDTP_BEGIN_SERIALIZER(TrustedWebActivityIssueDetails) CRDTP_SERIALIZE_FIELD("url", m_url);
...
CRDTP_DESERIALIZE_FIELD("contrastRatio", m_contrastRatio), CRDTP_DESERIALIZE_FIELD("fontSize", m_fontSize), CRDTP_DESERIALIZE_FIELD("fontWeight", m_fontWeight),
    CRDTP_DESERIALIZE_FIELD("thresholdAA", m_thresholdAA), CRDTP_DESERIALIZE_FIELD("thresholdAAA", m_thresholdAAA), CRDTP_DESERIALIZE_FIELD("violatingNodeId", m_violatingNodeId),
...
CRDTP_DESERIALIZE_FIELD_OPT("clientSecurityState", m_clientSecurityState), CRDTP_DESERIALIZE_FIELD("corsErrorStatus", m_corsErrorStatus),
    CRDTP_DESERIALIZE_FIELD_OPT("initiatorOrigin", m_initiatorOrigin), CRDTP_DESERIALIZE_FIELD("isWarning", m_isWarning), CRDTP_DESERIALIZE_FIELD_OPT("location", m_location),
    CRDTP_DESERIALIZE_FIELD("request", m_request), CRDTP_DESERIALIZE_FIELD_OPT("resourceIPAddressSpace", m_resourceIPAddressSpace),
    CRDTP_END_DESERIALIZER()
...
const char PermissionPolicyNotDelegated[] = "PermissionPolicyNotDelegated";
...
CRDTP_DESERIALIZE_FIELD("documentNodeId", m_documentNodeId), CRDTP_DESERIALIZE_FIELD("frameId", m_frameId), CRDTP_DESERIALIZE_FIELD("isLimitedQuirksMode", m_isLimitedQuirksMode),
    CRDTP_DESERIALIZE_FIELD("loaderId", m_loaderId), CRDTP_DESERIALIZE_FIELD("url", m_url),
    CRDTP_END_DESERIALIZER()
...
CRDTP_DESERIALIZE_FIELD("errorType", m_errorType), CRDTP_DESERIALIZE_FIELD_OPT("frameId", m_frameId),
    CRDTP_END_DESERIALIZER()
...
const char PaymentInstruments[] = "PaymentInstruments";
const char PaymentRequestCSPViolation[] = "PaymentRequestCSPViolation";
...
CRDTP_DESERIALIZE_FIELD_OPT("affectedFrame", m_affectedFrame), CRDTP_DESERIALIZE_FIELD("sourceCodeLocation", m_sourceCodeLocation), CRDTP_DESERIALIZE_FIELD("type", m_type),
    CRDTP_END_DESERIALIZER()
...
CRDTP_DESERIALIZE_FIELD_OPT("attributionReportingIssueDetails", m_attributionReportingIssueDetails),
    CRDTP_DESERIALIZE_FIELD_OPT("blockedByResponseIssueDetails", m_blockedByResponseIssueDetails), CRDTP_DESERIALIZE_FIELD_OPT("clientHintIssueDetails", m_clientHintIssueDetails),
    CRDTP_DESERIALIZE_FIELD_OPT("contentSecurityPolicyIssueDetails", m_contentSecurityPolicyIssueDetails), CRDTP_DESERIALIZE_FIELD_OPT("cookieIssueDetails", m_cookieIssueDetails),
    CRDTP_DESERIALIZE_FIELD_OPT("corsIssueDetails", m_corsIssueDetails), CRDTP_DESERIALIZE_FIELD_OPT("deprecationIssueDetails", m_deprecationIssueDetails),
    CRDTP_DESERIALIZE_FIELD_OPT("federatedAuthRequestIssueDetails", m_federatedAuthRequestIssueDetails), CRDTP_DESERIALIZE_FIELD_OPT("genericIssueDetails", m_genericIssueDetails),
    CRDTP_DESERIALIZE_FIELD_OPT("heavyAdIssueDetails", m_heavyAdIssueDetails), CRDTP_DESERIALIZE_FIELD_OPT("lowTextContrastIssueDetails", m_lowTextContrastIssueDetails),
    ...
    CRDTP_DESERIALIZE_FIELD_OPT("quirksModeIssueDetails", m_quirksModeIssueDetails), CRDTP_DESERIALIZE_FIELD_OPT("sharedArrayBufferIssueDetails", m_sharedArrayBufferIssueDetails),
...
void DomainDispatcherImpl::getEncodedResponse(const crdtp::Dispatchable& dispatchable)
{
    ...
    DispatchResponse response
        = m_backend->getEncodedResponse(params.requestId, params.encoding, std::move(params.quality), std::move(params.sizeOnly), &out_body, &out_originalSize, &out_encodedSize);
