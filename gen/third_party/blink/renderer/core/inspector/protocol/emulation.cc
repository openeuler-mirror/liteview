...
CRDTP_DESERIALIZE_FIELD("architecture", m_architecture), CRDTP_DESERIALIZE_FIELD_OPT("bitness", m_bitness), CRDTP_DESERIALIZE_FIELD_OPT("brands", m_brands),
    CRDTP_DESERIALIZE_FIELD_OPT("fullVersion", m_fullVersion), CRDTP_DESERIALIZE_FIELD_OPT("fullVersionList", m_fullVersionList), CRDTP_DESERIALIZE_FIELD("mobile", m_mobile),
    CRDTP_DESERIALIZE_FIELD("model", m_model), CRDTP_DESERIALIZE_FIELD("platform", m_platform), CRDTP_DESERIALIZE_FIELD("platformVersion", m_platformVersion),
...
CRDTP_DESERIALIZE_FIELD("deviceScaleFactor", deviceScaleFactor), CRDTP_DESERIALIZE_FIELD_OPT("displayFeature", displayFeature),
    CRDTP_DESERIALIZE_FIELD_OPT("dontSetVisibleSize", dontSetVisibleSize), CRDTP_DESERIALIZE_FIELD("height", height), CRDTP_DESERIALIZE_FIELD("mobile", mobile),
    CRDTP_DESERIALIZE_FIELD_OPT("positionX", positionX), CRDTP_DESERIALIZE_FIELD_OPT("positionY", positionY), CRDTP_DESERIALIZE_FIELD_OPT("scale", scale),
    CRDTP_DESERIALIZE_FIELD_OPT("screenHeight", screenHeight), CRDTP_DESERIALIZE_FIELD_OPT("screenOrientation", screenOrientation),
    CRDTP_DESERIALIZE_FIELD_OPT("screenWidth", screenWidth), CRDTP_DESERIALIZE_FIELD_OPT("viewport", viewport), CRDTP_DESERIALIZE_FIELD("width", width), CRDTP_END_DESERIALIZER()
...
void DomainDispatcherImpl::setDeviceMetricsOverride(const crdtp::Dispatchable& dispatchable)
{
    ...
    std::unique_ptr<DomainDispatcher::WeakPtr> weak = weakPtr();
    DispatchResponse response = m_backend->setDeviceMetricsOverride(params.width, params.height, params.deviceScaleFactor, params.mobile, std::move(params.scale),
        std::move(params.screenWidth), std::move(params.screenHeight), std::move(params.positionX), std::move(params.positionY), std::move(params.dontSetVisibleSize),
        std::move(params.screenOrientation), std::move(params.viewport), std::move(params.displayFeature));
    if (response.IsFallThrough()) {
...
CRDTP_DESERIALIZE_FIELD_OPT("budget", budget), CRDTP_DESERIALIZE_FIELD_OPT("initialVirtualTime", initialVirtualTime),
    CRDTP_DESERIALIZE_FIELD_OPT("maxVirtualTimeTaskStarvationCount", maxVirtualTimeTaskStarvationCount), CRDTP_DESERIALIZE_FIELD("policy", policy), CRDTP_END_DESERIALIZER()
...
void DomainDispatcherImpl::setVirtualTimePolicy(const crdtp::Dispatchable& dispatchable)
{
    ...
    std::unique_ptr<DomainDispatcher::WeakPtr> weak = weakPtr();
    DispatchResponse response = m_backend->setVirtualTimePolicy(
        params.policy, std::move(params.budget), std::move(params.maxVirtualTimeTaskStarvationCount), std::move(params.initialVirtualTime), &out_virtualTimeTicksBase);
    if (response.IsFallThrough()) {
...
CRDTP_DESERIALIZE_FIELD_OPT("acceptLanguage", acceptLanguage), CRDTP_DESERIALIZE_FIELD_OPT("platform", platform), CRDTP_DESERIALIZE_FIELD("userAgent", userAgent),
    CRDTP_DESERIALIZE_FIELD_OPT("userAgentMetadata", userAgentMetadata), CRDTP_END_DESERIALIZER()
