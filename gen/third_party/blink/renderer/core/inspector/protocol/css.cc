...
CRDTP_DESERIALIZE_FIELD("matches", m_matches), CRDTP_DESERIALIZE_FIELD_OPT("pseudoIdentifier", m_pseudoIdentifier), CRDTP_DESERIALIZE_FIELD("pseudoType", m_pseudoType),
...
CRDTP_DESERIALIZE_FIELD("disabled", m_disabled), CRDTP_DESERIALIZE_FIELD("endColumn", m_endColumn), CRDTP_DESERIALIZE_FIELD("endLine", m_endLine),
    CRDTP_DESERIALIZE_FIELD("frameId", m_frameId), CRDTP_DESERIALIZE_FIELD_OPT("hasSourceURL", m_hasSourceURL), CRDTP_DESERIALIZE_FIELD("isConstructed", m_isConstructed),
    CRDTP_DESERIALIZE_FIELD("isInline", m_isInline), CRDTP_DESERIALIZE_FIELD("isMutable", m_isMutable), CRDTP_DESERIALIZE_FIELD("length", m_length),
    CRDTP_DESERIALIZE_FIELD("origin", m_origin), CRDTP_DESERIALIZE_FIELD_OPT("ownerNode", m_ownerNode), CRDTP_DESERIALIZE_FIELD_OPT("sourceMapURL", m_sourceMapURL),
...
CRDTP_DESERIALIZE_FIELD_OPT("containerQueries", m_containerQueries), CRDTP_DESERIALIZE_FIELD_OPT("layers", m_layers), CRDTP_DESERIALIZE_FIELD_OPT("media", m_media),
    CRDTP_DESERIALIZE_FIELD("origin", m_origin), CRDTP_DESERIALIZE_FIELD_OPT("scopes", m_scopes), CRDTP_DESERIALIZE_FIELD("selectorList", m_selectorList),
...
CRDTP_DESERIALIZE_FIELD("endOffset", m_endOffset), CRDTP_DESERIALIZE_FIELD("startOffset", m_startOffset), CRDTP_DESERIALIZE_FIELD("styleSheetId", m_styleSheetId),
...
CRDTP_DESERIALIZE_FIELD_OPT("disabled", m_disabled), CRDTP_DESERIALIZE_FIELD_OPT("implicit", m_implicit), CRDTP_DESERIALIZE_FIELD_OPT("important", m_important),
    CRDTP_DESERIALIZE_FIELD_OPT("longhandProperties", m_longhandProperties), CRDTP_DESERIALIZE_FIELD("name", m_name), CRDTP_DESERIALIZE_FIELD_OPT("parsedOk", m_parsedOk),
    CRDTP_DESERIALIZE_FIELD_OPT("range", m_range), CRDTP_DESERIALIZE_FIELD_OPT("text", m_text), CRDTP_DESERIALIZE_FIELD("value", m_value),
    CRDTP_END_DESERIALIZER()
...
CRDTP_DESERIALIZE_FIELD_OPT("name", m_name), CRDTP_DESERIALIZE_FIELD_OPT("range", m_range), CRDTP_DESERIALIZE_FIELD_OPT("styleSheetId", m_styleSheetId),
...
CRDTP_DESERIALIZE_FIELD("familyName", m_familyName), CRDTP_DESERIALIZE_FIELD("glyphCount", m_glyphCount), CRDTP_DESERIALIZE_FIELD("isCustomFont", m_isCustomFont),
    CRDTP_END_DESERIALIZER()
...
CRDTP_DESERIALIZE_FIELD("fontDisplay", m_fontDisplay), CRDTP_DESERIALIZE_FIELD("fontFamily", m_fontFamily), CRDTP_DESERIALIZE_FIELD("fontStretch", m_fontStretch),
    CRDTP_DESERIALIZE_FIELD("fontStyle", m_fontStyle), CRDTP_DESERIALIZE_FIELD("fontVariant", m_fontVariant), CRDTP_DESERIALIZE_FIELD_OPT("fontVariationAxes", m_fontVariationAxes),
    CRDTP_DESERIALIZE_FIELD("fontWeight", m_fontWeight), CRDTP_DESERIALIZE_FIELD("platformFontFamily", m_platformFontFamily), CRDTP_DESERIALIZE_FIELD("src", m_src),
...
CRDTP_DESERIALIZE_FIELD("location", location), CRDTP_DESERIALIZE_FIELD("ruleText", ruleText), CRDTP_DESERIALIZE_FIELD("styleSheetId", styleSheetId), CRDTP_END_DESERIALIZER()
...
void DomainDispatcherImpl::getMatchedStylesForNode(const crdtp::Dispatchable& dispatchable)
{
    ...
    DispatchResponse response = m_backend->getMatchedStylesForNode(params.nodeId, &out_inlineStyle, &out_attributesStyle, &out_matchedCSSRules, &out_pseudoElements, &out_inherited,
        &out_inheritedPseudoElements, &out_cssKeyframesRules, &out_parentLayoutNodeId);
    if (response.IsFallThrough()) {
...
CRDTP_DESERIALIZE_FIELD("nodeId", nodeId), CRDTP_DESERIALIZE_FIELD("propertyName", propertyName), CRDTP_DESERIALIZE_FIELD("value", value), CRDTP_END_DESERIALIZER()
...
CRDTP_DESERIALIZE_FIELD("keyText", keyText), CRDTP_DESERIALIZE_FIELD("range", range), CRDTP_DESERIALIZE_FIELD("styleSheetId", styleSheetId), CRDTP_END_DESERIALIZER()
...
CRDTP_DESERIALIZE_FIELD("range", range), CRDTP_DESERIALIZE_FIELD("selector", selector), CRDTP_DESERIALIZE_FIELD("styleSheetId", styleSheetId), CRDTP_END_DESERIALIZER()
