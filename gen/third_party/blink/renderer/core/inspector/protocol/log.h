...
public:
    ...
    private:
        ...
        template <int STEP> LogEntryBuilder<STATE | STEP>& castState() { return *reinterpret_cast<LogEntryBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::Log::LogEntry> m_result;
    };

    static LogEntryBuilder<0> create() { return LogEntryBuilder<0>(); }

private:
    DECLARE_SERIALIZATION_SUPPORT();

    LogEntry() { m_timestamp = 0; }
...
public:
    ...
    private:
        ...
        template <int STEP> ViolationSettingBuilder<STATE | STEP>& castState() { return *reinterpret_cast<ViolationSettingBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::Log::ViolationSetting> m_result;
    };

    static ViolationSettingBuilder<0> create() { return ViolationSettingBuilder<0>(); }

private:
    DECLARE_SERIALIZATION_SUPPORT();

    ViolationSetting() { m_threshold = 0; }
