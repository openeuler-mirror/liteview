...
public:
    ...
    private:
        ...
        template <int STEP> DatabaseWithObjectStoresBuilder<STATE | STEP>& castState() { return *reinterpret_cast<DatabaseWithObjectStoresBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::IndexedDB::DatabaseWithObjectStores> m_result;
    };

    static DatabaseWithObjectStoresBuilder<0> create() { return DatabaseWithObjectStoresBuilder<0>(); }

private:
    DECLARE_SERIALIZATION_SUPPORT();

    DatabaseWithObjectStores() { m_version = 0; }
...
public:
    ...
    private:
        ...
        template <int STEP> ObjectStoreBuilder<STATE | STEP>& castState() { return *reinterpret_cast<ObjectStoreBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::IndexedDB::ObjectStore> m_result;
    };

    static ObjectStoreBuilder<0> create() { return ObjectStoreBuilder<0>(); }

private:
    DECLARE_SERIALIZATION_SUPPORT();

    ObjectStore() { m_autoIncrement = false; }
...
public:
    ...
    private:
        ...
        template <int STEP> ObjectStoreIndexBuilder<STATE | STEP>& castState() { return *reinterpret_cast<ObjectStoreIndexBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::IndexedDB::ObjectStoreIndex> m_result;
    };

    static ObjectStoreIndexBuilder<0> create() { return ObjectStoreIndexBuilder<0>(); }
...
public:
    ...
    private:
        ...
        template <int STEP> KeyBuilder<STATE | STEP>& castState() { return *reinterpret_cast<KeyBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::IndexedDB::Key> m_result;
    };

    static KeyBuilder<0> create() { return KeyBuilder<0>(); }
...
public:
    ...
    private:
        ...
        template <int STEP> KeyRangeBuilder<STATE | STEP>& castState() { return *reinterpret_cast<KeyRangeBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::IndexedDB::KeyRange> m_result;
    };

    static KeyRangeBuilder<0> create() { return KeyRangeBuilder<0>(); }
...
public:
    ...
    private:
        ...
        template <int STEP> DataEntryBuilder<STATE | STEP>& castState() { return *reinterpret_cast<DataEntryBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::IndexedDB::DataEntry> m_result;
    };

    static DataEntryBuilder<0> create() { return DataEntryBuilder<0>(); }
...
public:
    ...
    private:
        ...
        template <int STEP> KeyPathBuilder<STATE | STEP>& castState() { return *reinterpret_cast<KeyPathBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::IndexedDB::KeyPath> m_result;
    };

    static KeyPathBuilder<0> create() { return KeyPathBuilder<0>(); }
...
public:
    ...
    virtual void clearObjectStore(Maybe<String> in_securityOrigin, Maybe<String> in_storageKey, const String& in_databaseName, const String& in_objectStoreName,
        std::unique_ptr<ClearObjectStoreCallback> callback)
        = 0;
    ...
    virtual void deleteDatabase(Maybe<String> in_securityOrigin, Maybe<String> in_storageKey, const String& in_databaseName, std::unique_ptr<DeleteDatabaseCallback> callback) = 0;
    ...
    virtual void deleteObjectStoreEntries(Maybe<String> in_securityOrigin, Maybe<String> in_storageKey, const String& in_databaseName, const String& in_objectStoreName,
    ...
    virtual void requestData(Maybe<String> in_securityOrigin, Maybe<String> in_storageKey, const String& in_databaseName, const String& in_objectStoreName,
        const String& in_indexName, int in_skipCount, int in_pageSize, Maybe<protocol::IndexedDB::KeyRange> in_keyRange, std::unique_ptr<RequestDataCallback> callback)
        = 0;
    ...
    virtual void getMetadata(Maybe<String> in_securityOrigin, Maybe<String> in_storageKey, const String& in_databaseName, const String& in_objectStoreName,
        std::unique_ptr<GetMetadataCallback> callback)
        = 0;
    ...
    virtual void requestDatabase(Maybe<String> in_securityOrigin, Maybe<String> in_storageKey, const String& in_databaseName, std::unique_ptr<RequestDatabaseCallback> callback)
        = 0;
    ...
    virtual void requestDatabaseNames(Maybe<String> in_securityOrigin, Maybe<String> in_storageKey, std::unique_ptr<RequestDatabaseNamesCallback> callback) = 0;
};
