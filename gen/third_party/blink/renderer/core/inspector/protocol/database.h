...
public:
    ...
    public:
        enum { NoFieldsSet = 0, IdSet = 1 << 1, DomainSet = 1 << 2, NameSet = 1 << 3, VersionSet = 1 << 4, AllFieldsSet = (IdSet | DomainSet | NameSet | VersionSet | 0) };
    ...
    private:
        ...
        template <int STEP> DatabaseBuilder<STATE | STEP>& castState() { return *reinterpret_cast<DatabaseBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::Database::Database> m_result;
    };

    static DatabaseBuilder<0> create() { return DatabaseBuilder<0>(); }
...
public:
    ...
    private:
        ...
        template <int STEP> ErrorBuilder<STATE | STEP>& castState() { return *reinterpret_cast<ErrorBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::Database::Error> m_result;
    };

    static ErrorBuilder<0> create() { return ErrorBuilder<0>(); }
