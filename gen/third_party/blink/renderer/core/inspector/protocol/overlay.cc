...
CRDTP_DESERIALIZE_FIELD_OPT("borderColor", m_borderColor), CRDTP_DESERIALIZE_FIELD_OPT("colorFormat", m_colorFormat),
    CRDTP_DESERIALIZE_FIELD_OPT("containerQueryContainerHighlightConfig", m_containerQueryContainerHighlightConfig), CRDTP_DESERIALIZE_FIELD_OPT("contentColor", m_contentColor),
    CRDTP_DESERIALIZE_FIELD_OPT("contrastAlgorithm", m_contrastAlgorithm), CRDTP_DESERIALIZE_FIELD_OPT("cssGridColor", m_cssGridColor),
    CRDTP_DESERIALIZE_FIELD_OPT("eventTargetColor", m_eventTargetColor), CRDTP_DESERIALIZE_FIELD_OPT("flexContainerHighlightConfig", m_flexContainerHighlightConfig),
    CRDTP_DESERIALIZE_FIELD_OPT("flexItemHighlightConfig", m_flexItemHighlightConfig), CRDTP_DESERIALIZE_FIELD_OPT("gridHighlightConfig", m_gridHighlightConfig),
    CRDTP_DESERIALIZE_FIELD_OPT("marginColor", m_marginColor), CRDTP_DESERIALIZE_FIELD_OPT("paddingColor", m_paddingColor), CRDTP_DESERIALIZE_FIELD_OPT("shapeColor", m_shapeColor),
...
CRDTP_DESERIALIZE_FIELD_OPT("contentColor", m_contentColor), CRDTP_DESERIALIZE_FIELD_OPT("outlineColor", m_outlineColor), CRDTP_DESERIALIZE_FIELD("rect", m_rect),
    CRDTP_END_DESERIALIZER()
...
CRDTP_DESERIALIZE_FIELD("containerQueryContainerHighlightConfig", m_containerQueryContainerHighlightConfig), CRDTP_DESERIALIZE_FIELD("nodeId", m_nodeId),
    CRDTP_END_DESERIALIZER()
        ...
        CRDTP_BEGIN_SERIALIZER(ContainerQueryHighlightConfig) CRDTP_SERIALIZE_FIELD("containerQueryContainerHighlightConfig", m_containerQueryContainerHighlightConfig);
CRDTP_SERIALIZE_FIELD("nodeId", m_nodeId);
CRDTP_END_SERIALIZER();
...
CRDTP_DESERIALIZE_FIELD_OPT("colorFormat", colorFormat), CRDTP_DESERIALIZE_FIELD_OPT("includeDistance", includeDistance), CRDTP_DESERIALIZE_FIELD_OPT("includeStyle", includeStyle),
    CRDTP_DESERIALIZE_FIELD("nodeId", nodeId), CRDTP_DESERIALIZE_FIELD_OPT("showAccessibilityInfo", showAccessibilityInfo), CRDTP_END_DESERIALIZER()
...
void DomainDispatcherImpl::getHighlightObjectForTest(const crdtp::Dispatchable& dispatchable)
{
    ...
    std::unique_ptr<DomainDispatcher::WeakPtr> weak = weakPtr();
    DispatchResponse response = m_backend->getHighlightObjectForTest(
        params.nodeId, std::move(params.includeDistance), std::move(params.includeStyle), std::move(params.colorFormat), std::move(params.showAccessibilityInfo), &out_highlight);
    if (response.IsFallThrough()) {
...
CRDTP_DESERIALIZE_FIELD_OPT("contentColor", contentColor), CRDTP_DESERIALIZE_FIELD_OPT("contentOutlineColor", contentOutlineColor), CRDTP_DESERIALIZE_FIELD("frameId", frameId),
    CRDTP_END_DESERIALIZER()
...
CRDTP_DESERIALIZE_FIELD_OPT("backendNodeId", backendNodeId), CRDTP_DESERIALIZE_FIELD("highlightConfig", highlightConfig), CRDTP_DESERIALIZE_FIELD_OPT("nodeId", nodeId),
    CRDTP_DESERIALIZE_FIELD_OPT("objectId", objectId), CRDTP_DESERIALIZE_FIELD_OPT("selector", selector), CRDTP_END_DESERIALIZER()
...
CRDTP_DESERIALIZE_FIELD_OPT("color", color), CRDTP_DESERIALIZE_FIELD_OPT("outlineColor", outlineColor), CRDTP_DESERIALIZE_FIELD("quad", quad), CRDTP_END_DESERIALIZER()
...
void DomainDispatcherImpl::highlightSourceOrder(const crdtp::Dispatchable& dispatchable)
{
    ...
    DispatchResponse response
        = m_backend->highlightSourceOrder(std::move(params.sourceOrderConfig), std::move(params.nodeId), std::move(params.backendNodeId), std::move(params.objectId));
    if (response.IsFallThrough()) {
