...
public:
    ...
    public:
        enum {
            ...
            AllFieldsSet
            = (RequestURLSet | RequestMethodSet | RequestHeadersSet | ResponseTimeSet | ResponseStatusSet | ResponseStatusTextSet | ResponseTypeSet | ResponseHeadersSet | 0)
        };
...
public:
    ...
    public:
        enum { NoFieldsSet = 0, CacheIdSet = 1 << 1, SecurityOriginSet = 1 << 2, CacheNameSet = 1 << 3, AllFieldsSet = (CacheIdSet | SecurityOriginSet | CacheNameSet | 0) };
    ...
    private:
        ...
        template <int STEP> CacheBuilder<STATE | STEP>& castState() { return *reinterpret_cast<CacheBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::CacheStorage::Cache> m_result;
    };

    static CacheBuilder<0> create() { return CacheBuilder<0>(); }
...
public:
    ...
    private:
        ...
        template <int STEP> HeaderBuilder<STATE | STEP>& castState() { return *reinterpret_cast<HeaderBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::CacheStorage::Header> m_result;
    };

    static HeaderBuilder<0> create() { return HeaderBuilder<0>(); }
...
public:
    ...
    private:
        ...
        template <int STEP> CachedResponseBuilder<STATE | STEP>& castState() { return *reinterpret_cast<CachedResponseBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::CacheStorage::CachedResponse> m_result;
    };

    static CachedResponseBuilder<0> create() { return CachedResponseBuilder<0>(); }
...
public:
    ...
    virtual void requestCachedResponse(const String& in_cacheId, const String& in_requestURL, std::unique_ptr<protocol::Array<protocol::CacheStorage::Header>> in_requestHeaders,
    ...
    virtual void requestEntries(
        const String& in_cacheId, Maybe<int> in_skipCount, Maybe<int> in_pageSize, Maybe<String> in_pathFilter, std::unique_ptr<RequestEntriesCallback> callback)
        = 0;
