...
CORE_EXPORT extern const char HasEffectiveUrl[];
...
public:
    ...
    private:
        ...
        template <int STEP> AdFrameStatusBuilder<STATE | STEP>& castState() { return *reinterpret_cast<AdFrameStatusBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::Page::AdFrameStatus> m_result;
    };

    static AdFrameStatusBuilder<0> create() { return AdFrameStatusBuilder<0>(); }
...
public:
    ...
    private:
        ...
        template <int STEP> AdScriptIdBuilder<STATE | STEP>& castState() { return *reinterpret_cast<AdScriptIdBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::Page::AdScriptId> m_result;
    };

    static AdScriptIdBuilder<0> create() { return AdScriptIdBuilder<0>(); }
...
public:
    ...
    private:
        ...
        template <int STEP> PermissionsPolicyBlockLocatorBuilder<STATE | STEP>& castState() { return *reinterpret_cast<PermissionsPolicyBlockLocatorBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::Page::PermissionsPolicyBlockLocator> m_result;
    };

    static PermissionsPolicyBlockLocatorBuilder<0> create() { return PermissionsPolicyBlockLocatorBuilder<0>(); }
...
public:
    ...
    {
        return m_locator.isJust() ? m_locator.fromJust() : defaultValue;
    }
    ...
    private:
        ...
        template <int STEP> PermissionsPolicyFeatureStateBuilder<STATE | STEP>& castState() { return *reinterpret_cast<PermissionsPolicyFeatureStateBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::Page::PermissionsPolicyFeatureState> m_result;
    };

    static PermissionsPolicyFeatureStateBuilder<0> create() { return PermissionsPolicyFeatureStateBuilder<0>(); }

private:
    DECLARE_SERIALIZATION_SUPPORT();

    PermissionsPolicyFeatureState() { m_allowed = false; }
...
public:
    ...
    private:
        ...
        template <int STEP> OriginTrialTokenBuilder<STATE | STEP>& castState() { return *reinterpret_cast<OriginTrialTokenBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::Page::OriginTrialToken> m_result;
    };

    static OriginTrialTokenBuilder<0> create() { return OriginTrialTokenBuilder<0>(); }
...
public:
    ...
    private:
        ...
        template <int STEP> OriginTrialTokenWithStatusBuilder<STATE | STEP>& castState() { return *reinterpret_cast<OriginTrialTokenWithStatusBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::Page::OriginTrialTokenWithStatus> m_result;
    };

    static OriginTrialTokenWithStatusBuilder<0> create() { return OriginTrialTokenWithStatusBuilder<0>(); }
...
public:
    ...
    public:
        enum { NoFieldsSet = 0, TrialNameSet = 1 << 1, StatusSet = 1 << 2, TokensWithStatusSet = 1 << 3, AllFieldsSet = (TrialNameSet | StatusSet | TokensWithStatusSet | 0) };
    ...
    private:
        ...
        template <int STEP> OriginTrialBuilder<STATE | STEP>& castState() { return *reinterpret_cast<OriginTrialBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::Page::OriginTrial> m_result;
    };

    static OriginTrialBuilder<0> create() { return OriginTrialBuilder<0>(); }
...
public:
    ...
    public:
        enum {
            ...
            AllFieldsSet = (IdSet | LoaderIdSet | UrlSet | DomainAndRegistrySet | SecurityOriginSet | MimeTypeSet | SecureContextTypeSet | CrossOriginIsolatedContextTypeSet
                | GatedAPIFeaturesSet | 0)
        };
    ...
    private:
        ...
        template <int STEP> FrameBuilder<STATE | STEP>& castState() { return *reinterpret_cast<FrameBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::Page::Frame> m_result;
    };

    static FrameBuilder<0> create() { return FrameBuilder<0>(); }
...
public:
    ...
    private:
        ...
        template <int STEP> FrameResourceBuilder<STATE | STEP>& castState() { return *reinterpret_cast<FrameResourceBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::Page::FrameResource> m_result;
    };

    static FrameResourceBuilder<0> create() { return FrameResourceBuilder<0>(); }
...
public:
    ...
    private:
        ...
        template <int STEP> FrameResourceTreeBuilder<STATE | STEP>& castState() { return *reinterpret_cast<FrameResourceTreeBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::Page::FrameResourceTree> m_result;
    };

    static FrameResourceTreeBuilder<0> create() { return FrameResourceTreeBuilder<0>(); }
...
public:
    ...
    private:
        ...
        template <int STEP> FrameTreeBuilder<STATE | STEP>& castState() { return *reinterpret_cast<FrameTreeBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::Page::FrameTree> m_result;
    };

    static FrameTreeBuilder<0> create() { return FrameTreeBuilder<0>(); }
...
public:
    ...
    private:
        ...
        template <int STEP> LayoutViewportBuilder<STATE | STEP>& castState() { return *reinterpret_cast<LayoutViewportBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::Page::LayoutViewport> m_result;
    };

    static LayoutViewportBuilder<0> create() { return LayoutViewportBuilder<0>(); }
...
public:
    ...
    private:
        ...
        template <int STEP> VisualViewportBuilder<STATE | STEP>& castState() { return *reinterpret_cast<VisualViewportBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::Page::VisualViewport> m_result;
    };

    static VisualViewportBuilder<0> create() { return VisualViewportBuilder<0>(); }
...
public:
    ...
    private:
        ...
        template <int STEP> ViewportBuilder<STATE | STEP>& castState() { return *reinterpret_cast<ViewportBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::Page::Viewport> m_result;
    };

    static ViewportBuilder<0> create() { return ViewportBuilder<0>(); }
...
public:
    ...
    private:
        ...
        template <int STEP> FontFamiliesBuilder<STATE | STEP>& castState() { return *reinterpret_cast<FontFamiliesBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::Page::FontFamilies> m_result;
    };

    static FontFamiliesBuilder<0> create() { return FontFamiliesBuilder<0>(); }
...
public:
    ...
    private:
        ...
        template <int STEP> ScriptFontFamiliesBuilder<STATE | STEP>& castState() { return *reinterpret_cast<ScriptFontFamiliesBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::Page::ScriptFontFamilies> m_result;
    };

    static ScriptFontFamiliesBuilder<0> create() { return ScriptFontFamiliesBuilder<0>(); }
...
public:
    ...
    private:
        ...
        template <int STEP> FontSizesBuilder<STATE | STEP>& castState() { return *reinterpret_cast<FontSizesBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::Page::FontSizes> m_result;
    };

    static FontSizesBuilder<0> create() { return FontSizesBuilder<0>(); }
...
public:
    ...
    private:
        ...
        template <int STEP> CompilationCacheParamsBuilder<STATE | STEP>& castState() { return *reinterpret_cast<CompilationCacheParamsBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::Page::CompilationCacheParams> m_result;
    };

    static CompilationCacheParamsBuilder<0> create() { return CompilationCacheParamsBuilder<0>(); }
...
public:
    ...
    static BackForwardCacheNotRestoredExplanationBuilder<0> create() { return BackForwardCacheNotRestoredExplanationBuilder<0>(); }
...
public:
    ...
    static BackForwardCacheNotRestoredExplanationTreeBuilder<0> create() { return BackForwardCacheNotRestoredExplanationTreeBuilder<0>(); }
...
public:
    ...
    virtual DispatchResponse addScriptToEvaluateOnNewDocument(const String& in_source, Maybe<String> in_worldName, Maybe<bool> in_includeCommandLineAPI, String* out_identifier)
        = 0;
...
public:
    ...
    void frameAttached(const String& frameId, const String& parentFrameId,
        ...
        Maybe<protocol::Page::AdScriptId> adScriptId = Maybe<protocol::Page::AdScriptId>());
    ...
    void backForwardCacheNotUsed(const String& loaderId, const String& frameId,
        ...
        Maybe<protocol::Page::BackForwardCacheNotRestoredExplanationTree> notRestoredExplanationsTree = Maybe<protocol::Page::BackForwardCacheNotRestoredExplanationTree>());
    void prerenderAttemptCompleted(const String& initiatingFrameId, const String& prerenderingUrl, const String& finalStatus, Maybe<String> disallowedApiMethod = Maybe<String>());
