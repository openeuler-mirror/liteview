...
CRDTP_DESERIALIZE_FIELD("callbackBufferSize", m_callbackBufferSize), CRDTP_DESERIALIZE_FIELD("contextId", m_contextId), CRDTP_DESERIALIZE_FIELD("contextState", m_contextState),
    CRDTP_DESERIALIZE_FIELD("contextType", m_contextType), CRDTP_DESERIALIZE_FIELD("maxOutputChannelCount", m_maxOutputChannelCount),
    CRDTP_DESERIALIZE_FIELD_OPT("realtimeData", m_realtimeData), CRDTP_DESERIALIZE_FIELD("sampleRate", m_sampleRate),
    CRDTP_END_DESERIALIZER()
...
CRDTP_DESERIALIZE_FIELD("channelCount", m_channelCount), CRDTP_DESERIALIZE_FIELD("channelCountMode", m_channelCountMode),
    CRDTP_DESERIALIZE_FIELD("channelInterpretation", m_channelInterpretation), CRDTP_DESERIALIZE_FIELD("contextId", m_contextId), CRDTP_DESERIALIZE_FIELD("nodeId", m_nodeId),
    CRDTP_DESERIALIZE_FIELD("nodeType", m_nodeType), CRDTP_DESERIALIZE_FIELD("numberOfInputs", m_numberOfInputs), CRDTP_DESERIALIZE_FIELD("numberOfOutputs", m_numberOfOutputs),
    CRDTP_END_DESERIALIZER()
