...
public:
    ...
    private:
        ...
        template <int STEP> ScrollRectBuilder<STATE | STEP>& castState() { return *reinterpret_cast<ScrollRectBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::LayerTree::ScrollRect> m_result;
    };

    static ScrollRectBuilder<0> create() { return ScrollRectBuilder<0>(); }
...
public:
    ...
    String getNearestLayerShiftingStickyBox(const String& defaultValue)
    {
        return m_nearestLayerShiftingStickyBox.isJust() ? m_nearestLayerShiftingStickyBox.fromJust() : defaultValue;
    }
    ...
    String getNearestLayerShiftingContainingBlock(const String& defaultValue)
    {
        return m_nearestLayerShiftingContainingBlock.isJust() ? m_nearestLayerShiftingContainingBlock.fromJust() : defaultValue;
    }
    ...
    private:
        ...
        template <int STEP> StickyPositionConstraintBuilder<STATE | STEP>& castState() { return *reinterpret_cast<StickyPositionConstraintBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::LayerTree::StickyPositionConstraint> m_result;
    };

    static StickyPositionConstraintBuilder<0> create() { return StickyPositionConstraintBuilder<0>(); }
...
public:
    ...
    private:
        ...
        template <int STEP> PictureTileBuilder<STATE | STEP>& castState() { return *reinterpret_cast<PictureTileBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::LayerTree::PictureTile> m_result;
    };

    static PictureTileBuilder<0> create() { return PictureTileBuilder<0>(); }
...
public:
    ...
    {
        return m_stickyPositionConstraint.isJust() ? m_stickyPositionConstraint.fromJust() : defaultValue;
    }
    ...
    private:
        ...
        template <int STEP> LayerBuilder<STATE | STEP>& castState() { return *reinterpret_cast<LayerBuilder<STATE | STEP>*>(this); }
...
public:
    ...
    virtual DispatchResponse compositingReasons(
        const String& in_layerId, std::unique_ptr<protocol::Array<String>>* out_compositingReasons, std::unique_ptr<protocol::Array<String>>* out_compositingReasonIds)
        = 0;
    ...
    virtual DispatchResponse profileSnapshot(const String& in_snapshotId, Maybe<int> in_minRepeatCount, Maybe<double> in_minDuration, Maybe<protocol::DOM::Rect> in_clipRect,
