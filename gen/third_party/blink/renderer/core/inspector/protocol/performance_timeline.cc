...
CRDTP_DESERIALIZE_FIELD("hadRecentInput", m_hadRecentInput), CRDTP_DESERIALIZE_FIELD("lastInputTime", m_lastInputTime), CRDTP_DESERIALIZE_FIELD("sources", m_sources),
...
CRDTP_DESERIALIZE_FIELD_OPT("duration", m_duration), CRDTP_DESERIALIZE_FIELD("frameId", m_frameId), CRDTP_DESERIALIZE_FIELD_OPT("layoutShiftDetails", m_layoutShiftDetails),
    CRDTP_DESERIALIZE_FIELD_OPT("lcpDetails", m_lcpDetails), CRDTP_DESERIALIZE_FIELD("name", m_name), CRDTP_DESERIALIZE_FIELD("time", m_time),
