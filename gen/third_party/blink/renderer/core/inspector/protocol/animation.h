...
public:
    ...
    private:
        ...
        template <int STEP> AnimationBuilder<STATE | STEP>& castState() { return *reinterpret_cast<AnimationBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::Animation::Animation> m_result;
    };

    static AnimationBuilder<0> create() { return AnimationBuilder<0>(); }
...
public:
    ...
    {
        return m_keyframesRule.isJust() ? m_keyframesRule.fromJust() : defaultValue;
    }
    ...
    private:
        ...
        template <int STEP> AnimationEffectBuilder<STATE | STEP>& castState() { return *reinterpret_cast<AnimationEffectBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::Animation::AnimationEffect> m_result;
    };

    static AnimationEffectBuilder<0> create() { return AnimationEffectBuilder<0>(); }
...
public:
    ...
    private:
        ...
        template <int STEP> KeyframesRuleBuilder<STATE | STEP>& castState() { return *reinterpret_cast<KeyframesRuleBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::Animation::KeyframesRule> m_result;
    };

    static KeyframesRuleBuilder<0> create() { return KeyframesRuleBuilder<0>(); }
...
public:
    ...
    private:
        ...
        template <int STEP> KeyframeStyleBuilder<STATE | STEP>& castState() { return *reinterpret_cast<KeyframeStyleBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::Animation::KeyframeStyle> m_result;
    };

    static KeyframeStyleBuilder<0> create() { return KeyframeStyleBuilder<0>(); }
