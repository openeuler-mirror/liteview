...
CRDTP_DESERIALIZE_FIELD_OPT("cssId", m_cssId), CRDTP_DESERIALIZE_FIELD("currentTime", m_currentTime), CRDTP_DESERIALIZE_FIELD("id", m_id), CRDTP_DESERIALIZE_FIELD("name", m_name),
    CRDTP_DESERIALIZE_FIELD("pausedState", m_pausedState), CRDTP_DESERIALIZE_FIELD("playState", m_playState), CRDTP_DESERIALIZE_FIELD("playbackRate", m_playbackRate),
    CRDTP_DESERIALIZE_FIELD_OPT("source", m_source), CRDTP_DESERIALIZE_FIELD("startTime", m_startTime), CRDTP_DESERIALIZE_FIELD("type", m_type),
...
CRDTP_DESERIALIZE_FIELD("animationId", animationId), CRDTP_DESERIALIZE_FIELD("delay", delay), CRDTP_DESERIALIZE_FIELD("duration", duration), CRDTP_END_DESERIALIZER()
