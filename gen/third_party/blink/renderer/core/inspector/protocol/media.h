...
public:
    ...
    private:
        ...
        template <int STEP> PlayerMessageBuilder<STATE | STEP>& castState() { return *reinterpret_cast<PlayerMessageBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::Media::PlayerMessage> m_result;
    };

    static PlayerMessageBuilder<0> create() { return PlayerMessageBuilder<0>(); }
...
public:
    ...
    private:
        ...
        template <int STEP> PlayerPropertyBuilder<STATE | STEP>& castState() { return *reinterpret_cast<PlayerPropertyBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::Media::PlayerProperty> m_result;
    };

    static PlayerPropertyBuilder<0> create() { return PlayerPropertyBuilder<0>(); }
...
public:
    ...
    private:
        ...
        template <int STEP> PlayerEventBuilder<STATE | STEP>& castState() { return *reinterpret_cast<PlayerEventBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::Media::PlayerEvent> m_result;
    };

    static PlayerEventBuilder<0> create() { return PlayerEventBuilder<0>(); }

private:
    DECLARE_SERIALIZATION_SUPPORT();

    PlayerEvent() { m_timestamp = 0; }
...
public:
    ...
    private:
        ...
        template <int STEP> PlayerErrorSourceLocationBuilder<STATE | STEP>& castState() { return *reinterpret_cast<PlayerErrorSourceLocationBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::Media::PlayerErrorSourceLocation> m_result;
    };

    static PlayerErrorSourceLocationBuilder<0> create() { return PlayerErrorSourceLocationBuilder<0>(); }

private:
    DECLARE_SERIALIZATION_SUPPORT();

    PlayerErrorSourceLocation() { m_line = 0; }
...
public:
    ...
    private:
        ...
        template <int STEP> PlayerErrorBuilder<STATE | STEP>& castState() { return *reinterpret_cast<PlayerErrorBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::Media::PlayerError> m_result;
    };

    static PlayerErrorBuilder<0> create() { return PlayerErrorBuilder<0>(); }

private:
    DECLARE_SERIALIZATION_SUPPORT();

    PlayerError() { m_code = 0; }
