...
CRDTP_DESERIALIZE_FIELD_OPT("assignedSlot", m_assignedSlot), CRDTP_DESERIALIZE_FIELD_OPT("attributes", m_attributes), CRDTP_DESERIALIZE_FIELD("backendNodeId", m_backendNodeId),
    CRDTP_DESERIALIZE_FIELD_OPT("baseURL", m_baseURL), CRDTP_DESERIALIZE_FIELD_OPT("childNodeCount", m_childNodeCount), CRDTP_DESERIALIZE_FIELD_OPT("children", m_children),
    ...
    CRDTP_DESERIALIZE_FIELD_OPT("internalSubset", m_internalSubset), CRDTP_DESERIALIZE_FIELD_OPT("isSVG", m_isSVG), CRDTP_DESERIALIZE_FIELD("localName", m_localName),
    ...
    CRDTP_DESERIALIZE_FIELD("nodeType", m_nodeType), CRDTP_DESERIALIZE_FIELD("nodeValue", m_nodeValue), CRDTP_DESERIALIZE_FIELD_OPT("parentId", m_parentId),
    ...
    CRDTP_DESERIALIZE_FIELD_OPT("pseudoType", m_pseudoType), CRDTP_DESERIALIZE_FIELD_OPT("publicId", m_publicId), CRDTP_DESERIALIZE_FIELD_OPT("shadowRootType", m_shadowRootType),
    CRDTP_DESERIALIZE_FIELD_OPT("shadowRoots", m_shadowRoots), CRDTP_DESERIALIZE_FIELD_OPT("systemId", m_systemId),
    CRDTP_DESERIALIZE_FIELD_OPT("templateContent", m_templateContent), CRDTP_DESERIALIZE_FIELD_OPT("value", m_value), CRDTP_DESERIALIZE_FIELD_OPT("xmlVersion", m_xmlVersion),
    CRDTP_END_DESERIALIZER()
...
CRDTP_DESERIALIZE_FIELD_OPT("insertBeforeNodeId", insertBeforeNodeId), CRDTP_DESERIALIZE_FIELD("nodeId", nodeId), CRDTP_DESERIALIZE_FIELD("targetNodeId", targetNodeId),
    CRDTP_END_DESERIALIZER()
...
CRDTP_DESERIALIZE_FIELD("computedStyles", computedStyles), CRDTP_DESERIALIZE_FIELD("nodeId", nodeId), CRDTP_DESERIALIZE_FIELD_OPT("pierce", pierce), CRDTP_END_DESERIALIZER()
...
CRDTP_DESERIALIZE_FIELD_OPT("ignorePointerEventsNone", ignorePointerEventsNone), CRDTP_DESERIALIZE_FIELD_OPT("includeUserAgentShadowDOM", includeUserAgentShadowDOM),
    CRDTP_DESERIALIZE_FIELD("x", x), CRDTP_DESERIALIZE_FIELD("y", y), CRDTP_END_DESERIALIZER()
...
void DomainDispatcherImpl::getNodeForLocation(const crdtp::Dispatchable& dispatchable)
{
    ...
    std::unique_ptr<DomainDispatcher::WeakPtr> weak = weakPtr();
    DispatchResponse response = m_backend->getNodeForLocation(
        params.x, params.y, std::move(params.includeUserAgentShadowDOM), std::move(params.ignorePointerEventsNone), &out_backendNodeId, &out_frameId, &out_nodeId);
    if (response.IsFallThrough()) {
...
CRDTP_DESERIALIZE_FIELD("fromIndex", fromIndex), CRDTP_DESERIALIZE_FIELD("searchId", searchId), CRDTP_DESERIALIZE_FIELD("toIndex", toIndex), CRDTP_END_DESERIALIZER()
...
CRDTP_DESERIALIZE_FIELD_OPT("backendNodeId", backendNodeId), CRDTP_DESERIALIZE_FIELD_OPT("executionContextId", executionContextId), CRDTP_DESERIALIZE_FIELD_OPT("nodeId", nodeId),
    CRDTP_DESERIALIZE_FIELD_OPT("objectGroup", objectGroup), CRDTP_END_DESERIALIZER()
...
void DomainDispatcherImpl::resolveNode(const crdtp::Dispatchable& dispatchable)
{
    ...
    DispatchResponse response
        = m_backend->resolveNode(std::move(params.nodeId), std::move(params.backendNodeId), std::move(params.objectGroup), std::move(params.executionContextId), &out_object);
    if (response.IsFallThrough()) {
...
CRDTP_DESERIALIZE_FIELD_OPT("containerName", containerName), CRDTP_DESERIALIZE_FIELD("nodeId", nodeId), CRDTP_END_DESERIALIZER()
