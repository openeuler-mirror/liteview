...
CRDTP_DESERIALIZE_FIELD("databaseName", databaseName), CRDTP_DESERIALIZE_FIELD("objectStoreName", objectStoreName), CRDTP_DESERIALIZE_FIELD_OPT("securityOrigin", securityOrigin),
...
void DomainDispatcherImpl::clearObjectStore(const crdtp::Dispatchable& dispatchable)
{
    ...
    m_backend->clearObjectStore(std::move(params.securityOrigin), std::move(params.storageKey), params.databaseName, params.objectStoreName,
        std::make_unique<ClearObjectStoreCallbackImpl>(weakPtr(), dispatchable.CallId(), dispatchable.Serialized()));
}
...
CRDTP_DESERIALIZE_FIELD("databaseName", databaseName), CRDTP_DESERIALIZE_FIELD_OPT("securityOrigin", securityOrigin), CRDTP_DESERIALIZE_FIELD_OPT("storageKey", storageKey),
    CRDTP_END_DESERIALIZER()
...
void DomainDispatcherImpl::deleteDatabase(const crdtp::Dispatchable& dispatchable)
{
    ...
    m_backend->deleteDatabase(std::move(params.securityOrigin), std::move(params.storageKey), params.databaseName,
...
CRDTP_DESERIALIZE_FIELD("databaseName", databaseName), CRDTP_DESERIALIZE_FIELD("keyRange", keyRange), CRDTP_DESERIALIZE_FIELD("objectStoreName", objectStoreName),
    CRDTP_DESERIALIZE_FIELD_OPT("securityOrigin", securityOrigin), CRDTP_DESERIALIZE_FIELD_OPT("storageKey", storageKey), CRDTP_END_DESERIALIZER()
...
void DomainDispatcherImpl::deleteObjectStoreEntries(const crdtp::Dispatchable& dispatchable)
{
    ...
    m_backend->deleteObjectStoreEntries(std::move(params.securityOrigin), std::move(params.storageKey), params.databaseName, params.objectStoreName, std::move(params.keyRange),
...
CRDTP_DESERIALIZE_FIELD("databaseName", databaseName), CRDTP_DESERIALIZE_FIELD("indexName", indexName), CRDTP_DESERIALIZE_FIELD_OPT("keyRange", keyRange),
    CRDTP_DESERIALIZE_FIELD("objectStoreName", objectStoreName), CRDTP_DESERIALIZE_FIELD("pageSize", pageSize), CRDTP_DESERIALIZE_FIELD_OPT("securityOrigin", securityOrigin),
    CRDTP_DESERIALIZE_FIELD("skipCount", skipCount), CRDTP_DESERIALIZE_FIELD_OPT("storageKey", storageKey), CRDTP_END_DESERIALIZER()
...
void DomainDispatcherImpl::requestData(const crdtp::Dispatchable& dispatchable)
{
    ...
    m_backend->requestData(std::move(params.securityOrigin), std::move(params.storageKey), params.databaseName, params.objectStoreName, params.indexName, params.skipCount,
        params.pageSize, std::move(params.keyRange), std::make_unique<RequestDataCallbackImpl>(weakPtr(), dispatchable.CallId(), dispatchable.Serialized()));
}
...
void DomainDispatcherImpl::getMetadata(const crdtp::Dispatchable& dispatchable)
{
    ...
    m_backend->getMetadata(std::move(params.securityOrigin), std::move(params.storageKey), params.databaseName, params.objectStoreName,
        std::make_unique<GetMetadataCallbackImpl>(weakPtr(), dispatchable.CallId(), dispatchable.Serialized()));
}
...
void DomainDispatcherImpl::requestDatabase(const crdtp::Dispatchable& dispatchable)
{
    ...
    m_backend->requestDatabase(std::move(params.securityOrigin), std::move(params.storageKey), params.databaseName,
...
void DomainDispatcherImpl::requestDatabaseNames(const crdtp::Dispatchable& dispatchable)
{
    ...
    m_backend->requestDatabaseNames(std::move(params.securityOrigin), std::move(params.storageKey),
