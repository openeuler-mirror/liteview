...
public:
    ...
    private:
        ...
        template <int STEP> MetricBuilder<STATE | STEP>& castState() { return *reinterpret_cast<MetricBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::Performance::Metric> m_result;
    };

    static MetricBuilder<0> create() { return MetricBuilder<0>(); }
