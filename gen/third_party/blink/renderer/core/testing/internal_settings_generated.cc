...
InternalSettingsGenerated::InternalSettingsGenerated(Page* page)
    ...
    , WebXRImmersiveArAllowed_(page->GetSettings().GetWebXRImmersiveArAllowed())
    ...
    , accessibilityAlwaysShowFocus_(page->GetSettings().GetAccessibilityAlwaysShowFocus())
    , accessibilityFontScaleFactor_(page->GetSettings().GetAccessibilityFontScaleFactor())
    , accessibilityIncludeSvgGElement_(page->GetSettings().GetAccessibilityIncludeSvgGElement())
    ...
    , allowNonEmptyNavigatorPlugins_(page->GetSettings().GetAllowNonEmptyNavigatorPlugins())
    ...
    , ariaModalPrunesAXTree_(page->GetSettings().GetAriaModalPrunesAXTree())
    ...
    , bypassCSP_(page->GetSettings().GetBypassCSP())
    , caretBrowsingEnabled_(page->GetSettings().GetCaretBrowsingEnabled())
    ...
    , forceDarkModeEnabled_(page->GetSettings().GetForceDarkModeEnabled())
    ...
    , selectionClipboardBufferAvailable_(page->GetSettings().GetSelectionClipboardBufferAvailable())
    ...
    , targetBlankImpliesNoOpenerEnabledWillBeRemoved_(page->GetSettings().GetTargetBlankImpliesNoOpenerEnabledWillBeRemoved())
    , textAreasAreResizable_(page->GetSettings().GetTextAreasAreResizable())
    , textAutosizingEnabled_(page->GetSettings().GetTextAutosizingEnabled())
    ...
    , textTrackWindowColor_(page->GetSettings().GetTextTrackWindowColor())
    , textTrackWindowRadius_(page->GetSettings().GetTextTrackWindowRadius())
    ...
    , touchDragEndContextMenu_(page->GetSettings().GetTouchDragEndContextMenu())
    , touchEditingEnabled_(page->GetSettings().GetTouchEditingEnabled())
    , useAXMenuList_(page->GetSettings().GetUseAXMenuList())
...
void InternalSettingsGenerated::resetToConsistentState()
{
    ...
    page_->GetSettings().SetWebXRImmersiveArAllowed(WebXRImmersiveArAllowed_);
    ...
    page_->GetSettings().SetAccessibilityAlwaysShowFocus(accessibilityAlwaysShowFocus_);
    page_->GetSettings().SetAccessibilityFontScaleFactor(accessibilityFontScaleFactor_);
    page_->GetSettings().SetAccessibilityIncludeSvgGElement(accessibilityIncludeSvgGElement_);
    ...
    page_->GetSettings().SetAllowNonEmptyNavigatorPlugins(allowNonEmptyNavigatorPlugins_);
    ...
    page_->GetSettings().SetAriaModalPrunesAXTree(ariaModalPrunesAXTree_);
    ...
    page_->GetSettings().SetBypassCSP(bypassCSP_);
    page_->GetSettings().SetCaretBrowsingEnabled(caretBrowsingEnabled_);
    ...
    page_->GetSettings().SetForceDarkModeEnabled(forceDarkModeEnabled_);
    ...
    page_->GetSettings().SetSelectionClipboardBufferAvailable(selectionClipboardBufferAvailable_);
    ...
    page_->GetSettings().SetTargetBlankImpliesNoOpenerEnabledWillBeRemoved(targetBlankImpliesNoOpenerEnabledWillBeRemoved_);
    page_->GetSettings().SetTextAreasAreResizable(textAreasAreResizable_);
    page_->GetSettings().SetTextAutosizingEnabled(textAutosizingEnabled_);
    ...
    page_->GetSettings().SetTextTrackWindowColor(textTrackWindowColor_);
    page_->GetSettings().SetTextTrackWindowRadius(textTrackWindowRadius_);
    ...
    page_->GetSettings().SetTouchDragEndContextMenu(touchDragEndContextMenu_);
    page_->GetSettings().SetTouchEditingEnabled(touchEditingEnabled_);
    page_->GetSettings().SetUseAXMenuList(useAXMenuList_);
...
void InternalSettingsGenerated::setDOMPasteAllowed(bool DOMPasteAllowed) { page_->GetSettings().SetDOMPasteAllowed(DOMPasteAllowed); }
...
void InternalSettingsGenerated::setHighlightAds(bool HighlightAds) { page_->GetSettings().SetHighlightAds(HighlightAds); }

void InternalSettingsGenerated::setNetworkQuietTimeout(double NetworkQuietTimeout) { page_->GetSettings().SetNetworkQuietTimeout(NetworkQuietTimeout); }

void InternalSettingsGenerated::setWebXRImmersiveArAllowed(bool WebXRImmersiveArAllowed) { page_->GetSettings().SetWebXRImmersiveArAllowed(WebXRImmersiveArAllowed); }
...
{
    page_->GetSettings().SetAccessibilityAlwaysShowFocus(accessibilityAlwaysShowFocus);
}
...
{
    page_->GetSettings().SetAccessibilityIncludeSvgGElement(accessibilityIncludeSvgGElement);
}
...
{
    page_->GetSettings().SetAllowNonEmptyNavigatorPlugins(allowNonEmptyNavigatorPlugins);
}
...
void InternalSettingsGenerated::setAllowScriptsToCloseWindows(bool allowScriptsToCloseWindows) { page_->GetSettings().SetAllowScriptsToCloseWindows(allowScriptsToCloseWindows); }
...
void InternalSettingsGenerated::setAntialiased2dCanvasEnabled(bool antialiased2dCanvasEnabled) { page_->GetSettings().SetAntialiased2dCanvasEnabled(antialiased2dCanvasEnabled); }
...
void InternalSettingsGenerated::setAriaModalPrunesAXTree(bool ariaModalPrunesAXTree) { page_->GetSettings().SetAriaModalPrunesAXTree(ariaModalPrunesAXTree); }

void InternalSettingsGenerated::setAvailableHoverTypes(int availableHoverTypes) { page_->GetSettings().SetAvailableHoverTypes(availableHoverTypes); }

void InternalSettingsGenerated::setAvailablePointerTypes(int availablePointerTypes) { page_->GetSettings().SetAvailablePointerTypes(availablePointerTypes); }

void InternalSettingsGenerated::setBarrelButtonForDragEnabled(bool barrelButtonForDragEnabled) { page_->GetSettings().SetBarrelButtonForDragEnabled(barrelButtonForDragEnabled); }

void InternalSettingsGenerated::setBypassCSP(bool bypassCSP) { page_->GetSettings().SetBypassCSP(bypassCSP); }

void InternalSettingsGenerated::setCaretBrowsingEnabled(bool caretBrowsingEnabled) { page_->GetSettings().SetCaretBrowsingEnabled(caretBrowsingEnabled); }

void InternalSettingsGenerated::setCookieEnabled(bool cookieEnabled) { page_->GetSettings().SetCookieEnabled(cookieEnabled); }

void InternalSettingsGenerated::setDefaultFixedFontSize(int defaultFixedFontSize) { page_->GetSettings().SetDefaultFixedFontSize(defaultFixedFontSize); }

void InternalSettingsGenerated::setDefaultFontSize(int defaultFontSize) { page_->GetSettings().SetDefaultFontSize(defaultFontSize); }

void InternalSettingsGenerated::setDefaultTextEncodingName(const String& defaultTextEncodingName) { page_->GetSettings().SetDefaultTextEncodingName(defaultTextEncodingName); }

void InternalSettingsGenerated::setDefaultVideoPosterURL(const String& defaultVideoPosterURL) { page_->GetSettings().SetDefaultVideoPosterURL(defaultVideoPosterURL); }

void InternalSettingsGenerated::setDeviceScaleAdjustment(double deviceScaleAdjustment) { page_->GetSettings().SetDeviceScaleAdjustment(deviceScaleAdjustment); }

void InternalSettingsGenerated::setDisableReadingFromCanvas(bool disableReadingFromCanvas) { page_->GetSettings().SetDisableReadingFromCanvas(disableReadingFromCanvas); }
...
void InternalSettingsGenerated::setDNSPrefetchingEnabled(bool dnsPrefetchingEnabled) { page_->GetSettings().SetDNSPrefetchingEnabled(dnsPrefetchingEnabled); }

void InternalSettingsGenerated::setDoHtmlPreloadScanning(bool doHtmlPreloadScanning) { page_->GetSettings().SetDoHtmlPreloadScanning(doHtmlPreloadScanning); }
...
void InternalSettingsGenerated::setForceDarkModeEnabled(bool forceDarkModeEnabled) { page_->GetSettings().SetForceDarkModeEnabled(forceDarkModeEnabled); }
...
void InternalSettingsGenerated::setForceZeroLayoutHeight(bool forceZeroLayoutHeight) { page_->GetSettings().SetForceZeroLayoutHeight(forceZeroLayoutHeight); }

void InternalSettingsGenerated::setFullscreenSupported(bool fullscreenSupported) { page_->GetSettings().SetFullscreenSupported(fullscreenSupported); }

void InternalSettingsGenerated::setHideDownloadUI(bool hideDownloadUI) { page_->GetSettings().SetHideDownloadUI(hideDownloadUI); }

void InternalSettingsGenerated::setHideScrollbars(bool hideScrollbars) { page_->GetSettings().SetHideScrollbars(hideScrollbars); }

void InternalSettingsGenerated::setHyperlinkAuditingEnabled(bool hyperlinkAuditingEnabled) { page_->GetSettings().SetHyperlinkAuditingEnabled(hyperlinkAuditingEnabled); }
...
void InternalSettingsGenerated::setImagesEnabled(bool imagesEnabled) { page_->GetSettings().SetImagesEnabled(imagesEnabled); }

void InternalSettingsGenerated::setImmersiveModeEnabled(bool immersiveModeEnabled) { page_->GetSettings().SetImmersiveModeEnabled(immersiveModeEnabled); }
...
void InternalSettingsGenerated::setLazyLoadEnabled(bool lazyLoadEnabled) { page_->GetSettings().SetLazyLoadEnabled(lazyLoadEnabled); }

void InternalSettingsGenerated::setLoadWithOverviewMode(bool loadWithOverviewMode) { page_->GetSettings().SetLoadWithOverviewMode(loadWithOverviewMode); }

void InternalSettingsGenerated::setLoadsImagesAutomatically(bool loadsImagesAutomatically) { page_->GetSettings().SetLoadsImagesAutomatically(loadsImagesAutomatically); }

void InternalSettingsGenerated::setLocalStorageEnabled(bool localStorageEnabled) { page_->GetSettings().SetLocalStorageEnabled(localStorageEnabled); }
...
void InternalSettingsGenerated::setLogPreload(bool logPreload) { page_->GetSettings().SetLogPreload(logPreload); }

void InternalSettingsGenerated::setMainFrameClipsContent(bool mainFrameClipsContent) { page_->GetSettings().SetMainFrameClipsContent(mainFrameClipsContent); }
...
void InternalSettingsGenerated::setMaxTouchPoints(int maxTouchPoints) { page_->GetSettings().SetMaxTouchPoints(maxTouchPoints); }

void InternalSettingsGenerated::setMediaControlsEnabled(bool mediaControlsEnabled) { page_->GetSettings().SetMediaControlsEnabled(mediaControlsEnabled); }

void InternalSettingsGenerated::setMediaTypeOverride(const String& mediaTypeOverride) { page_->GetSettings().SetMediaTypeOverride(mediaTypeOverride); }

void InternalSettingsGenerated::setMinimumFontSize(int minimumFontSize) { page_->GetSettings().SetMinimumFontSize(minimumFontSize); }

void InternalSettingsGenerated::setMinimumLogicalFontSize(int minimumLogicalFontSize) { page_->GetSettings().SetMinimumLogicalFontSize(minimumLogicalFontSize); }
...
void InternalSettingsGenerated::setNavigateOnDragDrop(bool navigateOnDragDrop) { page_->GetSettings().SetNavigateOnDragDrop(navigateOnDragDrop); }
...
void InternalSettingsGenerated::setPasswordEchoEnabled(bool passwordEchoEnabled) { page_->GetSettings().SetPasswordEchoEnabled(passwordEchoEnabled); }

void InternalSettingsGenerated::setPictureInPictureEnabled(bool pictureInPictureEnabled) { page_->GetSettings().SetPictureInPictureEnabled(pictureInPictureEnabled); }

void InternalSettingsGenerated::setPluginsEnabled(bool pluginsEnabled) { page_->GetSettings().SetPluginsEnabled(pluginsEnabled); }
...
void InternalSettingsGenerated::setPreferHiddenVolumeControls(bool preferHiddenVolumeControls) { page_->GetSettings().SetPreferHiddenVolumeControls(preferHiddenVolumeControls); }

void InternalSettingsGenerated::setPrefersReducedMotion(bool prefersReducedMotion) { page_->GetSettings().SetPrefersReducedMotion(prefersReducedMotion); }

void InternalSettingsGenerated::setPresentationReceiver(bool presentationReceiver) { page_->GetSettings().SetPresentationReceiver(presentationReceiver); }
...
void InternalSettingsGenerated::setScriptEnabled(bool scriptEnabled) { page_->GetSettings().SetScriptEnabled(scriptEnabled); }

void InternalSettingsGenerated::setScrollAnimatorEnabled(bool scrollAnimatorEnabled) { page_->GetSettings().SetScrollAnimatorEnabled(scrollAnimatorEnabled); }
...
{
    page_->GetSettings().SetSelectionClipboardBufferAvailable(selectionClipboardBufferAvailable);
}
...
void InternalSettingsGenerated::setShouldPrintBackgrounds(bool shouldPrintBackgrounds) { page_->GetSettings().SetShouldPrintBackgrounds(shouldPrintBackgrounds); }
...
void InternalSettingsGenerated::setShowContextMenuOnMouseUp(bool showContextMenuOnMouseUp) { page_->GetSettings().SetShowContextMenuOnMouseUp(showContextMenuOnMouseUp); }
...
void InternalSettingsGenerated::setSmartInsertDeleteEnabled(bool smartInsertDeleteEnabled) { page_->GetSettings().SetSmartInsertDeleteEnabled(smartInsertDeleteEnabled); }

void InternalSettingsGenerated::setSmoothScrollForFindEnabled(bool smoothScrollForFindEnabled) { page_->GetSettings().SetSmoothScrollForFindEnabled(smoothScrollForFindEnabled); }

void InternalSettingsGenerated::setSpatialNavigationEnabled(bool spatialNavigationEnabled) { page_->GetSettings().SetSpatialNavigationEnabled(spatialNavigationEnabled); }

void InternalSettingsGenerated::setSpellCheckEnabledByDefault(bool spellCheckEnabledByDefault) { page_->GetSettings().SetSpellCheckEnabledByDefault(spellCheckEnabledByDefault); }

void InternalSettingsGenerated::setStrictMixedContentChecking(bool strictMixedContentChecking) { page_->GetSettings().SetStrictMixedContentChecking(strictMixedContentChecking); }
...
void InternalSettingsGenerated::setSupportsMultipleWindows(bool supportsMultipleWindows) { page_->GetSettings().SetSupportsMultipleWindows(supportsMultipleWindows); }

void InternalSettingsGenerated::setSyncXHRInDocumentsEnabled(bool syncXHRInDocumentsEnabled) { page_->GetSettings().SetSyncXHRInDocumentsEnabled(syncXHRInDocumentsEnabled); }
...
{
    page_->GetSettings().SetTargetBlankImpliesNoOpenerEnabledWillBeRemoved(targetBlankImpliesNoOpenerEnabledWillBeRemoved);
}

void InternalSettingsGenerated::setTextAreasAreResizable(bool textAreasAreResizable) { page_->GetSettings().SetTextAreasAreResizable(textAreasAreResizable); }

void InternalSettingsGenerated::setTextAutosizingEnabled(bool textAutosizingEnabled) { page_->GetSettings().SetTextAutosizingEnabled(textAutosizingEnabled); }

void InternalSettingsGenerated::setTextTrackBackgroundColor(const String& textTrackBackgroundColor) { page_->GetSettings().SetTextTrackBackgroundColor(textTrackBackgroundColor); }

void InternalSettingsGenerated::setTextTrackFontFamily(const String& textTrackFontFamily) { page_->GetSettings().SetTextTrackFontFamily(textTrackFontFamily); }

void InternalSettingsGenerated::setTextTrackFontStyle(const String& textTrackFontStyle) { page_->GetSettings().SetTextTrackFontStyle(textTrackFontStyle); }

void InternalSettingsGenerated::setTextTrackFontVariant(const String& textTrackFontVariant) { page_->GetSettings().SetTextTrackFontVariant(textTrackFontVariant); }

void InternalSettingsGenerated::setTextTrackMarginPercentage(double textTrackMarginPercentage) { page_->GetSettings().SetTextTrackMarginPercentage(textTrackMarginPercentage); }

void InternalSettingsGenerated::setTextTrackTextColor(const String& textTrackTextColor) { page_->GetSettings().SetTextTrackTextColor(textTrackTextColor); }

void InternalSettingsGenerated::setTextTrackTextShadow(const String& textTrackTextShadow) { page_->GetSettings().SetTextTrackTextShadow(textTrackTextShadow); }

void InternalSettingsGenerated::setTextTrackTextSize(const String& textTrackTextSize) { page_->GetSettings().SetTextTrackTextSize(textTrackTextSize); }

void InternalSettingsGenerated::setTextTrackWindowColor(const String& textTrackWindowColor) { page_->GetSettings().SetTextTrackWindowColor(textTrackWindowColor); }

void InternalSettingsGenerated::setTextTrackWindowRadius(const String& textTrackWindowRadius) { page_->GetSettings().SetTextTrackWindowRadius(textTrackWindowRadius); }

void InternalSettingsGenerated::setThreadedScrollingEnabled(bool threadedScrollingEnabled) { page_->GetSettings().SetThreadedScrollingEnabled(threadedScrollingEnabled); }

void InternalSettingsGenerated::setTouchDragDropEnabled(bool touchDragDropEnabled) { page_->GetSettings().SetTouchDragDropEnabled(touchDragDropEnabled); }

void InternalSettingsGenerated::setTouchDragEndContextMenu(bool touchDragEndContextMenu) { page_->GetSettings().SetTouchDragEndContextMenu(touchDragEndContextMenu); }

void InternalSettingsGenerated::setTouchEditingEnabled(bool touchEditingEnabled) { page_->GetSettings().SetTouchEditingEnabled(touchEditingEnabled); }

void InternalSettingsGenerated::setUseAXMenuList(bool useAXMenuList) { page_->GetSettings().SetUseAXMenuList(useAXMenuList); }
...
void InternalSettingsGenerated::setUseWideViewport(bool useWideViewport) { page_->GetSettings().SetUseWideViewport(useWideViewport); }
...
void InternalSettingsGenerated::setViewportEnabled(bool viewportEnabled) { page_->GetSettings().SetViewportEnabled(viewportEnabled); }

void InternalSettingsGenerated::setViewportMetaEnabled(bool viewportMetaEnabled) { page_->GetSettings().SetViewportMetaEnabled(viewportMetaEnabled); }
...
void InternalSettingsGenerated::setWebAppScope(const String& webAppScope) { page_->GetSettings().SetWebAppScope(webAppScope); }

void InternalSettingsGenerated::setWebGL1Enabled(bool webGL1Enabled) { page_->GetSettings().SetWebGL1Enabled(webGL1Enabled); }

void InternalSettingsGenerated::setWebGL2Enabled(bool webGL2Enabled) { page_->GetSettings().SetWebGL2Enabled(webGL2Enabled); }
...
void InternalSettingsGenerated::setWebSecurityEnabled(bool webSecurityEnabled) { page_->GetSettings().SetWebSecurityEnabled(webSecurityEnabled); }

void InternalSettingsGenerated::setWideViewportQuirkEnabled(bool wideViewportQuirkEnabled) { page_->GetSettings().SetWideViewportQuirkEnabled(wideViewportQuirkEnabled); }
