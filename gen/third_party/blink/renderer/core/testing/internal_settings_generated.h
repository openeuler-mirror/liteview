...
private:
    ...
    bool allowNonEmptyNavigatorPlugins_;
    ...
    bool selectionClipboardBufferAvailable_;
    ...
    bool targetBlankImpliesNoOpenerEnabledWillBeRemoved_;
    bool textAreasAreResizable_;
    bool textAutosizingEnabled_;
    ...
    String textTrackWindowColor_;
    String textTrackWindowRadius_;
    bool threadedScrollingEnabled_;
    bool touchDragDropEnabled_;
    bool touchDragEndContextMenu_;
