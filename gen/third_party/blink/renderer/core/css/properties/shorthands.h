...
public:
    constexpr Background()
        : Shorthand(CSSPropertyID::kBackground, kProperty | kSupportsIncrementalStyle | kIdempotent | kValidForKeyframe, '\0')
    {
    }
    const char* GetPropertyName() const override;
    const WTF::AtomicString& GetPropertyNameAtomicString() const override;
...
public:
    constexpr BackgroundPosition()
        : Shorthand(CSSPropertyID::kBackgroundPosition, kProperty | kSupportsIncrementalStyle | kIdempotent | kValidForKeyframe, '\0')
    {
    }
    const char* GetPropertyName() const override;
    const WTF::AtomicString& GetPropertyNameAtomicString() const override;
...
public:
    constexpr BackgroundRepeat()
        : Shorthand(CSSPropertyID::kBackgroundRepeat, kProperty | kIdempotent | kValidForKeyframe, '\0')
    {
    }
    const char* GetPropertyName() const override;
    const WTF::AtomicString& GetPropertyNameAtomicString() const override;
...
public:
    constexpr Border()
        : Shorthand(CSSPropertyID::kBorder, kProperty | kIdempotent | kValidForKeyframe, '\0')
    {
    }
    const char* GetPropertyName() const override;
    const WTF::AtomicString& GetPropertyNameAtomicString() const override;
...
public:
    constexpr BorderBlock()
        : Shorthand(CSSPropertyID::kBorderBlock, kProperty | kIdempotent | kValidForKeyframe, '\0')
    {
    }
    const char* GetPropertyName() const override;
    const WTF::AtomicString& GetPropertyNameAtomicString() const override;
...
public:
    constexpr BorderBlockColor()
        : Shorthand(CSSPropertyID::kBorderBlockColor, kProperty | kIdempotent | kValidForKeyframe, '\0')
    {
    }
    const char* GetPropertyName() const override;
    const WTF::AtomicString& GetPropertyNameAtomicString() const override;
...
public:
    constexpr BorderBlockEnd()
        : Shorthand(CSSPropertyID::kBorderBlockEnd, kProperty | kIdempotent | kValidForKeyframe | kSurrogate | kInLogicalPropertyGroup, '\0')
    {
    }
    const char* GetPropertyName() const override;
    const WTF::AtomicString& GetPropertyNameAtomicString() const override;
...
public:
    constexpr BorderBlockStart()
        : Shorthand(CSSPropertyID::kBorderBlockStart, kProperty | kIdempotent | kValidForKeyframe | kSurrogate | kInLogicalPropertyGroup, '\0')
    {
    }
    const char* GetPropertyName() const override;
    const WTF::AtomicString& GetPropertyNameAtomicString() const override;
...
public:
    constexpr BorderBlockStyle()
        : Shorthand(CSSPropertyID::kBorderBlockStyle, kProperty | kIdempotent | kValidForKeyframe, '\0')
    {
    }
    const char* GetPropertyName() const override;
    const WTF::AtomicString& GetPropertyNameAtomicString() const override;
...
public:
    constexpr BorderBlockWidth()
        : Shorthand(CSSPropertyID::kBorderBlockWidth, kProperty | kIdempotent | kValidForKeyframe, '\0')
    {
    }
    const char* GetPropertyName() const override;
    const WTF::AtomicString& GetPropertyNameAtomicString() const override;
...
public:
    constexpr BorderBottom()
        : Shorthand(CSSPropertyID::kBorderBottom, kProperty | kIdempotent | kValidForKeyframe | kInLogicalPropertyGroup, '\0')
    {
    }
    const char* GetPropertyName() const override;
    const WTF::AtomicString& GetPropertyNameAtomicString() const override;
...
public:
    constexpr BorderColor()
        : Shorthand(CSSPropertyID::kBorderColor, kProperty | kSupportsIncrementalStyle | kIdempotent | kValidForKeyframe, '\0')
    {
    }
    const char* GetPropertyName() const override;
    const WTF::AtomicString& GetPropertyNameAtomicString() const override;
...
public:
    constexpr BorderImage()
        : Shorthand(CSSPropertyID::kBorderImage, kProperty | kIdempotent | kValidForKeyframe, '\0')
    {
    }
    const char* GetPropertyName() const override;
    const WTF::AtomicString& GetPropertyNameAtomicString() const override;
...
public:
    constexpr BorderInline()
        : Shorthand(CSSPropertyID::kBorderInline, kProperty | kIdempotent | kValidForKeyframe, '\0')
    {
    }
    const char* GetPropertyName() const override;
    const WTF::AtomicString& GetPropertyNameAtomicString() const override;
...
public:
    constexpr BorderInlineColor()
        : Shorthand(CSSPropertyID::kBorderInlineColor, kProperty | kIdempotent | kValidForKeyframe, '\0')
    {
    }
    const char* GetPropertyName() const override;
    const WTF::AtomicString& GetPropertyNameAtomicString() const override;
...
public:
    constexpr BorderInlineEnd()
        : Shorthand(CSSPropertyID::kBorderInlineEnd, kProperty | kIdempotent | kValidForKeyframe | kSurrogate | kInLogicalPropertyGroup, '\0')
    {
    }
    const char* GetPropertyName() const override;
    const WTF::AtomicString& GetPropertyNameAtomicString() const override;
...
public:
    constexpr BorderInlineStart()
        : Shorthand(CSSPropertyID::kBorderInlineStart, kProperty | kIdempotent | kValidForKeyframe | kSurrogate | kInLogicalPropertyGroup, '\0')
    {
    }
    const char* GetPropertyName() const override;
    const WTF::AtomicString& GetPropertyNameAtomicString() const override;
...
public:
    constexpr BorderInlineStyle()
        : Shorthand(CSSPropertyID::kBorderInlineStyle, kProperty | kIdempotent | kValidForKeyframe, '\0')
    {
    }
    const char* GetPropertyName() const override;
    const WTF::AtomicString& GetPropertyNameAtomicString() const override;
...
public:
    constexpr BorderInlineWidth()
        : Shorthand(CSSPropertyID::kBorderInlineWidth, kProperty | kIdempotent | kValidForKeyframe, '\0')
    {
    }
    const char* GetPropertyName() const override;
    const WTF::AtomicString& GetPropertyNameAtomicString() const override;
...
public:
    constexpr BorderLeft()
        : Shorthand(CSSPropertyID::kBorderLeft, kProperty | kIdempotent | kValidForKeyframe | kInLogicalPropertyGroup, '\0')
    {
    }
    const char* GetPropertyName() const override;
    const WTF::AtomicString& GetPropertyNameAtomicString() const override;
...
public:
    constexpr BorderRadius()
        : Shorthand(CSSPropertyID::kBorderRadius, kProperty | kIdempotent | kValidForKeyframe, '\0')
    {
    }
    const char* GetPropertyName() const override;
    const WTF::AtomicString& GetPropertyNameAtomicString() const override;
...
public:
    constexpr BorderRight()
        : Shorthand(CSSPropertyID::kBorderRight, kProperty | kIdempotent | kValidForKeyframe | kInLogicalPropertyGroup, '\0')
    {
    }
    const char* GetPropertyName() const override;
    const WTF::AtomicString& GetPropertyNameAtomicString() const override;
...
public:
    constexpr BorderStyle()
        : Shorthand(CSSPropertyID::kBorderStyle, kProperty | kIdempotent | kValidForKeyframe, '\0')
    {
    }
    const char* GetPropertyName() const override;
    const WTF::AtomicString& GetPropertyNameAtomicString() const override;
...
public:
    constexpr BorderTop()
        : Shorthand(CSSPropertyID::kBorderTop, kProperty | kIdempotent | kValidForKeyframe | kInLogicalPropertyGroup, '\0')
    {
    }
    const char* GetPropertyName() const override;
    const WTF::AtomicString& GetPropertyNameAtomicString() const override;
...
public:
    constexpr BorderWidth()
        : Shorthand(CSSPropertyID::kBorderWidth, kProperty | kIdempotent | kValidForKeyframe, '\0')
    {
    }
    const char* GetPropertyName() const override;
    const WTF::AtomicString& GetPropertyNameAtomicString() const override;
...
public:
    constexpr ContainIntrinsicSize()
        : Shorthand(CSSPropertyID::kContainIntrinsicSize, kProperty | kIdempotent | kValidForKeyframe, '\0')
    {
    }
    const char* GetPropertyName() const override;
    const WTF::AtomicString& GetPropertyNameAtomicString() const override;
...
public:
    constexpr GridColumnGap()
        : Shorthand(CSSPropertyID::kGridColumnGap, kProperty | kIdempotent | kValidForKeyframe, '\0')
    {
    }
    const char* GetPropertyName() const override;
    const WTF::AtomicString& GetPropertyNameAtomicString() const override;
...
public:
    constexpr GridGap()
        : Shorthand(CSSPropertyID::kGridGap, kProperty | kIdempotent | kValidForKeyframe, '\0')
    {
    }
    const char* GetPropertyName() const override;
    const WTF::AtomicString& GetPropertyNameAtomicString() const override;
...
public:
    constexpr GridRowGap()
        : Shorthand(CSSPropertyID::kGridRowGap, kProperty | kIdempotent | kValidForKeyframe, '\0')
    {
    }
    const char* GetPropertyName() const override;
    const WTF::AtomicString& GetPropertyNameAtomicString() const override;
...
public:
    constexpr Inset()
        : Shorthand(CSSPropertyID::kInset, kProperty | kIdempotent | kValidForKeyframe | kValidForPositionFallback, '\0')
    {
    }
    const char* GetPropertyName() const override;
    const WTF::AtomicString& GetPropertyNameAtomicString() const override;
...
public:
    constexpr InsetBlock()
        : Shorthand(CSSPropertyID::kInsetBlock, kProperty | kIdempotent | kValidForKeyframe | kValidForPositionFallback, '\0')
    {
    }
    const char* GetPropertyName() const override;
    const WTF::AtomicString& GetPropertyNameAtomicString() const override;
...
public:
    constexpr InsetInline()
        : Shorthand(CSSPropertyID::kInsetInline, kProperty | kIdempotent | kValidForKeyframe | kValidForPositionFallback, '\0')
    {
    }
    const char* GetPropertyName() const override;
    const WTF::AtomicString& GetPropertyNameAtomicString() const override;
...
public:
    constexpr Margin()
        : Shorthand(CSSPropertyID::kMargin, kProperty | kIdempotent | kValidForKeyframe, '\0')
    {
    }
    const char* GetPropertyName() const override;
    const WTF::AtomicString& GetPropertyNameAtomicString() const override;
...
public:
    constexpr MarginBlock()
        : Shorthand(CSSPropertyID::kMarginBlock, kProperty | kIdempotent | kValidForKeyframe, '\0')
    {
    }
    const char* GetPropertyName() const override;
    const WTF::AtomicString& GetPropertyNameAtomicString() const override;
...
public:
    constexpr MarginInline()
        : Shorthand(CSSPropertyID::kMarginInline, kProperty | kIdempotent | kValidForKeyframe, '\0')
    {
    }
    const char* GetPropertyName() const override;
    const WTF::AtomicString& GetPropertyNameAtomicString() const override;
...
public:
    constexpr Outline()
        : Shorthand(CSSPropertyID::kOutline, kProperty | kIdempotent | kValidForKeyframe, '\0')
    {
    }
    const char* GetPropertyName() const override;
    const WTF::AtomicString& GetPropertyNameAtomicString() const override;
...
public:
    constexpr Padding()
        : Shorthand(CSSPropertyID::kPadding, kProperty | kSupportsIncrementalStyle | kIdempotent | kValidForKeyframe, '\0')
    {
    }
    const char* GetPropertyName() const override;
    const WTF::AtomicString& GetPropertyNameAtomicString() const override;
...
public:
    constexpr PaddingBlock()
        : Shorthand(CSSPropertyID::kPaddingBlock, kProperty | kIdempotent | kValidForKeyframe, '\0')
    {
    }
    const char* GetPropertyName() const override;
    const WTF::AtomicString& GetPropertyNameAtomicString() const override;
...
public:
    constexpr PaddingInline()
        : Shorthand(CSSPropertyID::kPaddingInline, kProperty | kIdempotent | kValidForKeyframe, '\0')
    {
    }
    const char* GetPropertyName() const override;
    const WTF::AtomicString& GetPropertyNameAtomicString() const override;
...
public:
    constexpr PlaceSelf()
        : Shorthand(CSSPropertyID::kPlaceSelf, kProperty | kIdempotent | kValidForKeyframe, '\0')
    {
    }
    const char* GetPropertyName() const override;
    const WTF::AtomicString& GetPropertyNameAtomicString() const override;
...
public:
    constexpr TextDecoration()
        : Shorthand(CSSPropertyID::kTextDecoration, kProperty | kIdempotent | kValidForKeyframe, '\0')
    {
    }
    const char* GetPropertyName() const override;
    const WTF::AtomicString& GetPropertyNameAtomicString() const override;
...
public:
    constexpr Toggle()
        : Shorthand(CSSPropertyID::kToggle, kProperty | kIdempotent | kValidForKeyframe, '\0')
    {
    }
    const char* GetPropertyName() const override;
    const WTF::AtomicString& GetPropertyNameAtomicString() const override;
...
public:
    constexpr WebkitMask()
        : Shorthand(CSSPropertyID::kWebkitMask, kProperty | kIdempotent | kValidForKeyframe, '\0')
    {
    }
    const char* GetPropertyName() const override;
    const WTF::AtomicString& GetPropertyNameAtomicString() const override;
...
public:
    constexpr WebkitMaskPosition()
        : Shorthand(CSSPropertyID::kWebkitMaskPosition, kProperty | kIdempotent | kValidForKeyframe, '\0')
    {
    }
    const char* GetPropertyName() const override;
    const WTF::AtomicString& GetPropertyNameAtomicString() const override;
...
public:
    constexpr WebkitMaskRepeat()
        : Shorthand(CSSPropertyID::kWebkitMaskRepeat, kProperty | kIdempotent | kValidForKeyframe, '\0')
    {
    }
    const char* GetPropertyName() const override;
    const WTF::AtomicString& GetPropertyNameAtomicString() const override;
