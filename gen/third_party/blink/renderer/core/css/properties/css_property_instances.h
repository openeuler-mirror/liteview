...
CORE_EXPORT const CSSProperty& GetCSSPropertyFontOpticalSizing();
CORE_EXPORT const CSSProperty& GetCSSPropertyFontPalette();
...
CORE_EXPORT const CSSProperty& GetCSSPropertyFontSynthesisSmallCaps();
CORE_EXPORT const CSSProperty& GetCSSPropertyFontSynthesisStyle();
CORE_EXPORT const CSSProperty& GetCSSPropertyFontSynthesisWeight();
...
CORE_EXPORT const CSSProperty& GetCSSPropertyForcedColorAdjust();
CORE_EXPORT const CSSProperty& GetCSSPropertyInternalVisitedColor();
...
CORE_EXPORT const CSSProperty& GetCSSPropertyAccentColor();
CORE_EXPORT const CSSProperty& GetCSSPropertyAdditiveSymbols();
...
CORE_EXPORT const CSSProperty& GetCSSPropertyAnchorName();
CORE_EXPORT const CSSProperty& GetCSSPropertyAnchorScroll();
...
CORE_EXPORT const CSSProperty& GetCSSPropertyAnimationTimeline();
CORE_EXPORT const CSSProperty& GetCSSPropertyAnimationTimingFunction();
CORE_EXPORT const CSSProperty& GetCSSPropertyAppRegion();
CORE_EXPORT const CSSProperty& GetCSSPropertyAppearance();
CORE_EXPORT const CSSProperty& GetCSSPropertyAscentOverride();
CORE_EXPORT const CSSProperty& GetCSSPropertyAspectRatio();
...
CORE_EXPORT const CSSProperty& GetCSSPropertyBasePalette();
...
CORE_EXPORT const CSSProperty& GetCSSPropertyBorderEndEndRadius();
CORE_EXPORT const CSSProperty& GetCSSPropertyBorderEndStartRadius();
...
CORE_EXPORT const CSSProperty& GetCSSPropertyBorderStartEndRadius();
CORE_EXPORT const CSSProperty& GetCSSPropertyBorderStartStartRadius();
...
CORE_EXPORT const CSSProperty& GetCSSPropertyColorScheme();
...
CORE_EXPORT const CSSProperty& GetCSSPropertyContainIntrinsicBlockSize();
CORE_EXPORT const CSSProperty& GetCSSPropertyContainIntrinsicHeight();
CORE_EXPORT const CSSProperty& GetCSSPropertyContainIntrinsicInlineSize();
CORE_EXPORT const CSSProperty& GetCSSPropertyContainIntrinsicWidth();
CORE_EXPORT const CSSProperty& GetCSSPropertyContainerName();
CORE_EXPORT const CSSProperty& GetCSSPropertyContainerType();
CORE_EXPORT const CSSProperty& GetCSSPropertyContent();
CORE_EXPORT const CSSProperty& GetCSSPropertyContentVisibility();
CORE_EXPORT const CSSProperty& GetCSSPropertyCounterIncrement();
CORE_EXPORT const CSSProperty& GetCSSPropertyCounterReset();
CORE_EXPORT const CSSProperty& GetCSSPropertyCounterSet();
...
CORE_EXPORT const CSSProperty& GetCSSPropertyDescentOverride();
...
CORE_EXPORT const CSSProperty& GetCSSPropertyEnd();
CORE_EXPORT const CSSProperty& GetCSSPropertyFallback();
...
CORE_EXPORT const CSSProperty& GetCSSPropertyHyphenateCharacter();
CORE_EXPORT const CSSProperty& GetCSSPropertyHyphenateLimitChars();
...
CORE_EXPORT const CSSProperty& GetCSSPropertyInherits();
CORE_EXPORT const CSSProperty& GetCSSPropertyInitialLetter();
CORE_EXPORT const CSSProperty& GetCSSPropertyInitialValue();
...
CORE_EXPORT const CSSProperty& GetCSSPropertyInternalAlignSelfBlock();
CORE_EXPORT const CSSProperty& GetCSSPropertyInternalEmptyLineHeight();
CORE_EXPORT const CSSProperty& GetCSSPropertyInternalFontSizeDelta();
CORE_EXPORT const CSSProperty& GetCSSPropertyInternalForcedBackgroundColor();
CORE_EXPORT const CSSProperty& GetCSSPropertyInternalForcedBorderColor();
CORE_EXPORT const CSSProperty& GetCSSPropertyInternalForcedColor();
CORE_EXPORT const CSSProperty& GetCSSPropertyInternalForcedOutlineColor();
CORE_EXPORT const CSSProperty& GetCSSPropertyInternalForcedVisitedColor();
CORE_EXPORT const CSSProperty& GetCSSPropertyInternalVisitedBackgroundColor();
CORE_EXPORT const CSSProperty& GetCSSPropertyInternalVisitedBorderBlockEndColor();
CORE_EXPORT const CSSProperty& GetCSSPropertyInternalVisitedBorderBlockStartColor();
CORE_EXPORT const CSSProperty& GetCSSPropertyInternalVisitedBorderBottomColor();
CORE_EXPORT const CSSProperty& GetCSSPropertyInternalVisitedBorderInlineEndColor();
CORE_EXPORT const CSSProperty& GetCSSPropertyInternalVisitedBorderInlineStartColor();
CORE_EXPORT const CSSProperty& GetCSSPropertyInternalVisitedBorderLeftColor();
CORE_EXPORT const CSSProperty& GetCSSPropertyInternalVisitedBorderRightColor();
CORE_EXPORT const CSSProperty& GetCSSPropertyInternalVisitedBorderTopColor();
CORE_EXPORT const CSSProperty& GetCSSPropertyInternalVisitedCaretColor();
CORE_EXPORT const CSSProperty& GetCSSPropertyInternalVisitedColumnRuleColor();
CORE_EXPORT const CSSProperty& GetCSSPropertyInternalVisitedFill();
CORE_EXPORT const CSSProperty& GetCSSPropertyInternalVisitedOutlineColor();
CORE_EXPORT const CSSProperty& GetCSSPropertyInternalVisitedStroke();
CORE_EXPORT const CSSProperty& GetCSSPropertyInternalVisitedTextDecorationColor();
CORE_EXPORT const CSSProperty& GetCSSPropertyInternalVisitedTextEmphasisColor();
CORE_EXPORT const CSSProperty& GetCSSPropertyInternalVisitedTextFillColor();
CORE_EXPORT const CSSProperty& GetCSSPropertyInternalVisitedTextStrokeColor();
...
CORE_EXPORT const CSSProperty& GetCSSPropertyLineGapOverride();
...
CORE_EXPORT const CSSProperty& GetCSSPropertyMathDepth();
CORE_EXPORT const CSSProperty& GetCSSPropertyMathShift();
CORE_EXPORT const CSSProperty& GetCSSPropertyMathStyle();
...
CORE_EXPORT const CSSProperty& GetCSSPropertyOriginTrialTestProperty();
...
CORE_EXPORT const CSSProperty& GetCSSPropertyOverflowBlock();
CORE_EXPORT const CSSProperty& GetCSSPropertyOverflowClipMargin();
CORE_EXPORT const CSSProperty& GetCSSPropertyOverflowInline();
...
CORE_EXPORT const CSSProperty& GetCSSPropertyOverrideColors();
CORE_EXPORT const CSSProperty& GetCSSPropertyOverscrollBehaviorBlock();
CORE_EXPORT const CSSProperty& GetCSSPropertyOverscrollBehaviorInline();
...
CORE_EXPORT const CSSProperty& GetCSSPropertyPad();
...
CORE_EXPORT const CSSProperty& GetCSSPropertyPageOrientation();
CORE_EXPORT const CSSProperty& GetCSSPropertyPageTransitionTag();
...
CORE_EXPORT const CSSProperty& GetCSSPropertyPositionFallback();
CORE_EXPORT const CSSProperty& GetCSSPropertyPrefix();
CORE_EXPORT const CSSProperty& GetCSSPropertyQuotes();
CORE_EXPORT const CSSProperty& GetCSSPropertyR();
CORE_EXPORT const CSSProperty& GetCSSPropertyRange();
...
CORE_EXPORT const CSSProperty& GetCSSPropertyRubyPosition();
...
CORE_EXPORT const CSSProperty& GetCSSPropertyScrollTimelineAxis();
CORE_EXPORT const CSSProperty& GetCSSPropertyScrollTimelineName();
CORE_EXPORT const CSSProperty& GetCSSPropertyScrollbarGutter();
CORE_EXPORT const CSSProperty& GetCSSPropertyScrollbarWidth();
...
CORE_EXPORT const CSSProperty& GetCSSPropertySizeAdjust();
CORE_EXPORT const CSSProperty& GetCSSPropertySource();
CORE_EXPORT const CSSProperty& GetCSSPropertySpeak();
CORE_EXPORT const CSSProperty& GetCSSPropertySpeakAs();
CORE_EXPORT const CSSProperty& GetCSSPropertySrc();
CORE_EXPORT const CSSProperty& GetCSSPropertyStart();
...
CORE_EXPORT const CSSProperty& GetCSSPropertySuffix();
CORE_EXPORT const CSSProperty& GetCSSPropertySymbols();
CORE_EXPORT const CSSProperty& GetCSSPropertySyntax();
CORE_EXPORT const CSSProperty& GetCSSPropertySystem();
...
CORE_EXPORT const CSSProperty& GetCSSPropertyTextDecorationThickness();
CORE_EXPORT const CSSProperty& GetCSSPropertyTextEmphasisColor();
CORE_EXPORT const CSSProperty& GetCSSPropertyTextEmphasisPosition();
CORE_EXPORT const CSSProperty& GetCSSPropertyTextEmphasisStyle();
...
CORE_EXPORT const CSSProperty& GetCSSPropertyTextUnderlineOffset();
CORE_EXPORT const CSSProperty& GetCSSPropertyTextUnderlinePosition();
CORE_EXPORT const CSSProperty& GetCSSPropertyToggleGroup();
CORE_EXPORT const CSSProperty& GetCSSPropertyToggleRoot();
CORE_EXPORT const CSSProperty& GetCSSPropertyToggleTrigger();
CORE_EXPORT const CSSProperty& GetCSSPropertyToggleVisibility();
...
CORE_EXPORT const CSSProperty& GetCSSPropertyViewTimelineAxis();
CORE_EXPORT const CSSProperty& GetCSSPropertyViewTimelineInset();
CORE_EXPORT const CSSProperty& GetCSSPropertyViewTimelineName();
...
CORE_EXPORT const CSSProperty& GetCSSPropertyContainIntrinsicSize();
CORE_EXPORT const CSSProperty& GetCSSPropertyContainer();
...
CORE_EXPORT const CSSProperty& GetCSSPropertyFontSynthesis();
...
CORE_EXPORT const CSSProperty& GetCSSPropertyScrollTimeline();
CORE_EXPORT const CSSProperty& GetCSSPropertyTextDecoration();
CORE_EXPORT const CSSProperty& GetCSSPropertyTextEmphasis();
CORE_EXPORT const CSSProperty& GetCSSPropertyToggle();
CORE_EXPORT const CSSProperty& GetCSSPropertyTransition();
CORE_EXPORT const CSSProperty& GetCSSPropertyViewTimeline();
