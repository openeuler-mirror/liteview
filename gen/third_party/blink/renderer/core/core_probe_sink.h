...
public:
    enum AgentType : unsigned {
        kAdTracker = 1u << 0,
        kDevToolsSession = 1u << 1,
        kInspectorAnimationAgent = 1u << 2,
        kInspectorAuditsAgent = 1u << 3,
        kInspectorCSSAgent = 1u << 4,
        kInspectorDOMAgent = 1u << 5,
        kInspectorDOMDebuggerAgent = 1u << 6,
        kInspectorDOMSnapshotAgent = 1u << 7,
        kInspectorEmulationAgent = 1u << 8,
        kInspectorIssueReporter = 1u << 9,
        kInspectorLayerTreeAgent = 1u << 10,
        kInspectorLogAgent = 1u << 11,
        kInspectorMediaAgent = 1u << 12,
        kInspectorNetworkAgent = 1u << 13,
        kInspectorPageAgent = 1u << 14,
        kInspectorPerformanceAgent = 1u << 15,
        kInspectorPerformanceTimelineAgent = 1u << 16,
        kInspectorTraceEvents = 1u << 17,
        kPerformanceMonitor = 1u << 18,
    };
    ...
    static bool HasAgentsGlobal(unsigned mask) { return s_existingAgents.load(std::memory_order_acquire) & mask; }
