...
const AtomicString& kCompositionEvent = reinterpret_cast<AtomicString*>(&names_storage)[6];
const AtomicString& kContentVisibilityAutoStateChangeEvent = reinterpret_cast<AtomicString*>(&names_storage)[7];
...
const AtomicString& kNavigateEvent = reinterpret_cast<AtomicString*>(&names_storage)[23];
const AtomicString& kNavigationCurrentEntryChangeEvent = reinterpret_cast<AtomicString*>(&names_storage)[24];
const AtomicString& kOverscrollEvent = reinterpret_cast<AtomicString*>(&names_storage)[25];
const AtomicString& kPageTransitionEvent = reinterpret_cast<AtomicString*>(&names_storage)[26];
const AtomicString& kPointerEvent = reinterpret_cast<AtomicString*>(&names_storage)[27];
const AtomicString& kPopStateEvent = reinterpret_cast<AtomicString*>(&names_storage)[28];
const AtomicString& kProgressEvent = reinterpret_cast<AtomicString*>(&names_storage)[29];
const AtomicString& kPromiseRejectionEvent = reinterpret_cast<AtomicString*>(&names_storage)[30];
const AtomicString& kResourceProgressEvent = reinterpret_cast<AtomicString*>(&names_storage)[31];
const AtomicString& kSecurityPolicyViolationEvent = reinterpret_cast<AtomicString*>(&names_storage)[32];
const AtomicString& kSubmitEvent = reinterpret_cast<AtomicString*>(&names_storage)[33];
const AtomicString& kTextEvent = reinterpret_cast<AtomicString*>(&names_storage)[34];
const AtomicString& kTextFormat = reinterpret_cast<AtomicString*>(&names_storage)[35];
const AtomicString& kTextFormatUpdateEvent = reinterpret_cast<AtomicString*>(&names_storage)[36];
const AtomicString& kTextUpdateEvent = reinterpret_cast<AtomicString*>(&names_storage)[37];
const AtomicString& kTouchEvent = reinterpret_cast<AtomicString*>(&names_storage)[38];
const AtomicString& kTrackEvent = reinterpret_cast<AtomicString*>(&names_storage)[39];
const AtomicString& kTransitionEvent = reinterpret_cast<AtomicString*>(&names_storage)[40];
const AtomicString& kUIEvent = reinterpret_cast<AtomicString*>(&names_storage)[41];
const AtomicString& kWheelEvent = reinterpret_cast<AtomicString*>(&names_storage)[42];
...
void Init()
{
    ...
    static const NameEntry kNames[] = {
        ...
        { "BeforeCreatePolicyEvent", 6244020, 23 },
        { "BeforeUnloadEvent", 6032602, 17 },
        { "CharacterBoundsUpdateEvent", 7162636, 26 },
        { "ClipboardEvent", 10110691, 14 },
        { "CompositionEvent", 9205103, 16 },
        { "ContentVisibilityAutoStateChangeEvent", 3626592, 37 },
        ...
        { "NavigateEvent", 12108648, 13 },
        { "NavigationCurrentEntryChangeEvent", 16388261, 33 },
        ...
        { "SubmitEvent", 875228, 11 },
        { "TextEvent", 9996370, 9 },
        { "TextFormat", 6825262, 10 },
        { "TextFormatUpdateEvent", 7144158, 21 },
        { "TextUpdateEvent", 2849566, 15 },
