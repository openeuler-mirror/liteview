...
static MathMLElement* MathMLMathConstructor(Document& document, const CreateElementFlags flags) { return MakeGarbageCollected<MathMLRowElement>(mathml_names::kMathTag, document); }
...
static MathMLElement* MathMLMfracConstructor(Document& document, const CreateElementFlags flags) { return MakeGarbageCollected<MathMLFractionElement>(document); }
...
static MathMLElement* MathMLMiConstructor(Document& document, const CreateElementFlags flags) { return MakeGarbageCollected<MathMLTokenElement>(mathml_names::kMiTag, document); }
...
static MathMLElement* MathMLMnConstructor(Document& document, const CreateElementFlags flags) { return MakeGarbageCollected<MathMLTokenElement>(mathml_names::kMnTag, document); }
static MathMLElement* MathMLMoConstructor(Document& document, const CreateElementFlags flags) { return MakeGarbageCollected<MathMLOperatorElement>(document); }
...
static MathMLElement* MathMLMpaddedConstructor(Document& document, const CreateElementFlags flags) { return MakeGarbageCollected<MathMLPaddedElement>(document); }
...
static MathMLElement* MathMLMrowConstructor(Document& document, const CreateElementFlags flags) { return MakeGarbageCollected<MathMLRowElement>(mathml_names::kMrowTag, document); }
static MathMLElement* MathMLMsConstructor(Document& document, const CreateElementFlags flags) { return MakeGarbageCollected<MathMLTokenElement>(mathml_names::kMsTag, document); }
static MathMLElement* MathMLMspaceConstructor(Document& document, const CreateElementFlags flags) { return MakeGarbageCollected<MathMLSpaceElement>(document); }
...
static MathMLElement* MathMLMtdConstructor(Document& document, const CreateElementFlags flags) { return MakeGarbageCollected<MathMLElement>(mathml_names::kMtdTag, document); }
...
static MathMLElement* MathMLMtrConstructor(Document& document, const CreateElementFlags flags) { return MakeGarbageCollected<MathMLElement>(mathml_names::kMtrTag, document); }
...
static MathMLElement* MathMLNoneConstructor(Document& document, const CreateElementFlags flags) { return MakeGarbageCollected<MathMLRowElement>(mathml_names::kNoneTag, document); }
