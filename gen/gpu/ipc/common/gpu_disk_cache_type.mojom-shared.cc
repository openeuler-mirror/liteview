...
static NOINLINE const char* GpuDiskCacheTypeToStringHelper(GpuDiskCacheType value)
{
...
std::ostream& operator<<(std::ostream& os, GpuDiskCacheType value) { return os << GpuDiskCacheTypeToString(value); }
