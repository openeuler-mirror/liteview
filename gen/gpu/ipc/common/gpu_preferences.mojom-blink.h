...
struct gpu_mojom_internal_VulkanImplementationName_DataHashFn {
    ...
    static bool Equal(const ::gpu::mojom::VulkanImplementationName& left, const ::gpu::mojom::VulkanImplementationName& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::gpu::mojom::VulkanImplementationName> : public GenericHashTraits<::gpu::mojom::VulkanImplementationName> {
    static_assert(true, "-1000000 is a reserved enum value");
    static_assert(true, "-1000001 is a reserved enum value");
    static const bool kEmptyValueIsZero = false;
    static ::gpu::mojom::VulkanImplementationName EmptyValue() { return static_cast<::gpu::mojom::VulkanImplementationName>(-1000000); }
    static void ConstructDeletedValue(::gpu::mojom::VulkanImplementationName& slot, bool) { slot = static_cast<::gpu::mojom::VulkanImplementationName>(-1000001); }
    static bool IsDeletedValue(const ::gpu::mojom::VulkanImplementationName& value) { return value == static_cast<::gpu::mojom::VulkanImplementationName>(-1000001); }
};
} // namespace WTF
namespace WTF {
struct gpu_mojom_internal_WebGPUAdapterName_DataHashFn {
    static unsigned GetHash(const ::gpu::mojom::WebGPUAdapterName& value)
    {
        using utype = std::underlying_type<::gpu::mojom::WebGPUAdapterName>::type;
        return DefaultHash<utype>::Hash().GetHash(static_cast<utype>(value));
    }
    static bool Equal(const ::gpu::mojom::WebGPUAdapterName& left, const ::gpu::mojom::WebGPUAdapterName& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::gpu::mojom::WebGPUAdapterName> : public GenericHashTraits<::gpu::mojom::WebGPUAdapterName> {
    static_assert(true, "-1000000 is a reserved enum value");
    static_assert(true, "-1000001 is a reserved enum value");
    static const bool kEmptyValueIsZero = false;
    static ::gpu::mojom::WebGPUAdapterName EmptyValue() { return static_cast<::gpu::mojom::WebGPUAdapterName>(-1000000); }
    static void ConstructDeletedValue(::gpu::mojom::WebGPUAdapterName& slot, bool) { slot = static_cast<::gpu::mojom::WebGPUAdapterName>(-1000001); }
    static bool IsDeletedValue(const ::gpu::mojom::WebGPUAdapterName& value) { return value == static_cast<::gpu::mojom::WebGPUAdapterName>(-1000001); }
};
} // namespace WTF
namespace WTF {
struct gpu_mojom_internal_GrContextType_DataHashFn {
    ...
    static bool Equal(const ::gpu::mojom::GrContextType& left, const ::gpu::mojom::GrContextType& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::gpu::mojom::GrContextType> : public GenericHashTraits<::gpu::mojom::GrContextType> {
    static_assert(true, "-1000000 is a reserved enum value");
    static_assert(true, "-1000001 is a reserved enum value");
    static const bool kEmptyValueIsZero = false;
    static ::gpu::mojom::GrContextType EmptyValue() { return static_cast<::gpu::mojom::GrContextType>(-1000000); }
    static void ConstructDeletedValue(::gpu::mojom::GrContextType& slot, bool) { slot = static_cast<::gpu::mojom::GrContextType>(-1000001); }
    static bool IsDeletedValue(const ::gpu::mojom::GrContextType& value) { return value == static_cast<::gpu::mojom::GrContextType>(-1000001); }
};
} // namespace WTF
namespace WTF {
struct gpu_mojom_internal_DawnBackendValidationLevel_DataHashFn {
    static unsigned GetHash(const ::gpu::mojom::DawnBackendValidationLevel& value)
    {
        using utype = std::underlying_type<::gpu::mojom::DawnBackendValidationLevel>::type;
        return DefaultHash<utype>::Hash().GetHash(static_cast<utype>(value));
    }
    static bool Equal(const ::gpu::mojom::DawnBackendValidationLevel& left, const ::gpu::mojom::DawnBackendValidationLevel& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::gpu::mojom::DawnBackendValidationLevel> : public GenericHashTraits<::gpu::mojom::DawnBackendValidationLevel> {
    static_assert(true, "-1000000 is a reserved enum value");
    static_assert(true, "-1000001 is a reserved enum value");
    static const bool kEmptyValueIsZero = false;
    static ::gpu::mojom::DawnBackendValidationLevel EmptyValue() { return static_cast<::gpu::mojom::DawnBackendValidationLevel>(-1000000); }
    static void ConstructDeletedValue(::gpu::mojom::DawnBackendValidationLevel& slot, bool) { slot = static_cast<::gpu::mojom::DawnBackendValidationLevel>(-1000001); }
    static bool IsDeletedValue(const ::gpu::mojom::DawnBackendValidationLevel& value) { return value == static_cast<::gpu::mojom::DawnBackendValidationLevel>(-1000001); }
};
} // namespace WTF
namespace gpu {
namespace mojom {
...
public:
    ...
    template <typename... Args> static GpuPreferencesPtr New(Args&&... args) { return GpuPreferencesPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static GpuPreferencesPtr From(const U& u) { return mojo::TypeConverter<GpuPreferencesPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, GpuPreferences>::Convert(*this); }
    GpuPreferences()
    ...
    GpuPreferences(bool disable_accelerated_video_decode_in, bool disable_accelerated_video_encode_in, bool gpu_startup_dialog_in, bool disable_gpu_watchdog_in,
        bool gpu_sandbox_start_early_in, bool enable_low_latency_dxva_in, bool enable_zero_copy_dxgi_video_in, bool enable_nv12_dxgi_video_in,
        bool enable_media_foundation_vea_on_windows7_in, bool disable_software_rasterizer_in, bool log_gpu_control_list_decisions_in, bool compile_shader_always_succeeds_in,
        bool disable_gl_error_limit_in, bool disable_glsl_translator_in, bool disable_shader_name_hashing_in, bool enable_gpu_command_logging_in, bool enable_gpu_debugging_in,
        bool enable_gpu_service_logging_gpu_in, bool enable_gpu_driver_debug_logging_in, bool disable_gpu_program_cache_in, bool enforce_gl_minimums_in,
        uint32_t force_gpu_mem_available_bytes_in, uint32_t force_gpu_mem_discardable_limit_bytes_in, uint32_t force_max_texture_size_in, uint32_t gpu_program_cache_size_in,
        bool disable_gpu_shader_disk_cache_in, bool enable_threaded_texture_mailboxes_in, bool gl_shader_interm_output_in, bool enable_android_surface_control_in,
        bool enable_gpu_service_logging_in, bool enable_gpu_service_tracing_in, bool use_passthrough_cmd_decoder_in, bool disable_biplanar_gpu_memory_buffers_for_video_frames_in,
        WTF::Vector<::gfx::BufferUsageAndFormat> texture_target_exception_list_in, bool ignore_gpu_blocklist_in, bool watchdog_starts_backgrounded_in,
        GrContextType gr_context_type_in, VulkanImplementationName use_vulkan_in, bool enable_vulkan_protected_memory_in, bool disable_vulkan_surface_in,
        bool disable_vulkan_fallback_to_gl_for_testing_in, uint32_t vulkan_heap_memory_limit_in, uint32_t vulkan_sync_cpu_memory_limit_in, bool enable_metal_in,
        bool enable_gpu_benchmarking_extension_in, bool enable_webgpu_in, bool enable_unsafe_webgpu_in, WebGPUAdapterName use_webgpu_adapter_in,
        DawnBackendValidationLevel enable_dawn_backend_validation_in, WTF::Vector<WTF::String> enabled_dawn_features_list_in,
        WTF::Vector<WTF::String> disabled_dawn_features_list_in, bool enable_gpu_blocked_time_metric_in, bool enable_perf_data_collection_in,
    ...
    template <typename T, GpuPreferences::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    ...
    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<GpuPreferences::DataView>(input); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::GpuPreferences_UnserializedMessageContext<UserType, GpuPreferences::DataView>>(0, 0, std::move(input)), MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    {
        return GpuPreferences::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, GpuPreferences::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, GpuPreferences::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, GpuPreferences::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }

template <typename StructPtrType> GpuPreferencesPtr GpuPreferences::Clone() const
{
    return New(mojo::Clone(disable_accelerated_video_decode), mojo::Clone(disable_accelerated_video_encode), mojo::Clone(gpu_startup_dialog), mojo::Clone(disable_gpu_watchdog),
        mojo::Clone(gpu_sandbox_start_early), mojo::Clone(enable_low_latency_dxva), mojo::Clone(enable_zero_copy_dxgi_video), mojo::Clone(enable_nv12_dxgi_video),
        mojo::Clone(enable_media_foundation_vea_on_windows7), mojo::Clone(disable_software_rasterizer), mojo::Clone(log_gpu_control_list_decisions),
        mojo::Clone(compile_shader_always_succeeds), mojo::Clone(disable_gl_error_limit), mojo::Clone(disable_glsl_translator), mojo::Clone(disable_shader_name_hashing),
        mojo::Clone(enable_gpu_command_logging), mojo::Clone(enable_gpu_debugging), mojo::Clone(enable_gpu_service_logging_gpu), mojo::Clone(enable_gpu_driver_debug_logging),
        mojo::Clone(disable_gpu_program_cache), mojo::Clone(enforce_gl_minimums), mojo::Clone(force_gpu_mem_available_bytes), mojo::Clone(force_gpu_mem_discardable_limit_bytes),
        mojo::Clone(force_max_texture_size), mojo::Clone(gpu_program_cache_size), mojo::Clone(disable_gpu_shader_disk_cache), mojo::Clone(enable_threaded_texture_mailboxes),
        mojo::Clone(gl_shader_interm_output), mojo::Clone(enable_android_surface_control), mojo::Clone(enable_gpu_service_logging), mojo::Clone(enable_gpu_service_tracing),
        mojo::Clone(use_passthrough_cmd_decoder), mojo::Clone(disable_biplanar_gpu_memory_buffers_for_video_frames), mojo::Clone(texture_target_exception_list),
        ...
        mojo::Clone(vulkan_heap_memory_limit), mojo::Clone(vulkan_sync_cpu_memory_limit), mojo::Clone(enable_metal), mojo::Clone(enable_gpu_benchmarking_extension),
        mojo::Clone(enable_webgpu), mojo::Clone(enable_unsafe_webgpu), mojo::Clone(use_webgpu_adapter), mojo::Clone(enable_dawn_backend_validation),
        mojo::Clone(enabled_dawn_features_list), mojo::Clone(disabled_dawn_features_list), mojo::Clone(enable_gpu_blocked_time_metric), mojo::Clone(enable_perf_data_collection),
...
template <> struct StructTraits<::gpu::mojom::blink::GpuPreferences::DataView, ::gpu::mojom::blink::GpuPreferencesPtr> {
    ...
    static decltype(::gpu::mojom::blink::GpuPreferences::disable_accelerated_video_decode) disable_accelerated_video_decode(const ::gpu::mojom::blink::GpuPreferencesPtr& input)
    {
        return input->disable_accelerated_video_decode;
    }

    static decltype(::gpu::mojom::blink::GpuPreferences::disable_accelerated_video_encode) disable_accelerated_video_encode(const ::gpu::mojom::blink::GpuPreferencesPtr& input)
    {
    ...
    static decltype(::gpu::mojom::blink::GpuPreferences::enable_zero_copy_dxgi_video) enable_zero_copy_dxgi_video(const ::gpu::mojom::blink::GpuPreferencesPtr& input)
    {
    ...
    static decltype(::gpu::mojom::blink::GpuPreferences::disable_software_rasterizer) disable_software_rasterizer(const ::gpu::mojom::blink::GpuPreferencesPtr& input)
    {
        return input->disable_software_rasterizer;
    }

    static decltype(::gpu::mojom::blink::GpuPreferences::log_gpu_control_list_decisions) log_gpu_control_list_decisions(const ::gpu::mojom::blink::GpuPreferencesPtr& input)
    {
        return input->log_gpu_control_list_decisions;
    }

    static decltype(::gpu::mojom::blink::GpuPreferences::compile_shader_always_succeeds) compile_shader_always_succeeds(const ::gpu::mojom::blink::GpuPreferencesPtr& input)
    {
    ...
    static decltype(::gpu::mojom::blink::GpuPreferences::disable_shader_name_hashing) disable_shader_name_hashing(const ::gpu::mojom::blink::GpuPreferencesPtr& input)
    {
        return input->disable_shader_name_hashing;
    }

    static decltype(::gpu::mojom::blink::GpuPreferences::enable_gpu_command_logging) enable_gpu_command_logging(const ::gpu::mojom::blink::GpuPreferencesPtr& input)
    {
    ...
    static decltype(::gpu::mojom::blink::GpuPreferences::enable_gpu_service_logging_gpu) enable_gpu_service_logging_gpu(const ::gpu::mojom::blink::GpuPreferencesPtr& input)
    {
        return input->enable_gpu_service_logging_gpu;
    }

    static decltype(::gpu::mojom::blink::GpuPreferences::enable_gpu_driver_debug_logging) enable_gpu_driver_debug_logging(const ::gpu::mojom::blink::GpuPreferencesPtr& input)
    {
        return input->enable_gpu_driver_debug_logging;
    }

    static decltype(::gpu::mojom::blink::GpuPreferences::disable_gpu_program_cache) disable_gpu_program_cache(const ::gpu::mojom::blink::GpuPreferencesPtr& input)
    {
    ...
    static decltype(::gpu::mojom::blink::GpuPreferences::force_gpu_mem_available_bytes) force_gpu_mem_available_bytes(const ::gpu::mojom::blink::GpuPreferencesPtr& input)
    {
    ...
    static decltype(::gpu::mojom::blink::GpuPreferences::disable_gpu_shader_disk_cache) disable_gpu_shader_disk_cache(const ::gpu::mojom::blink::GpuPreferencesPtr& input)
    {
        return input->disable_gpu_shader_disk_cache;
    }

    static decltype(::gpu::mojom::blink::GpuPreferences::enable_threaded_texture_mailboxes) enable_threaded_texture_mailboxes(const ::gpu::mojom::blink::GpuPreferencesPtr& input)
    {
    ...
    static decltype(::gpu::mojom::blink::GpuPreferences::enable_android_surface_control) enable_android_surface_control(const ::gpu::mojom::blink::GpuPreferencesPtr& input)
    {
        return input->enable_android_surface_control;
    }

    static decltype(::gpu::mojom::blink::GpuPreferences::enable_gpu_service_logging) enable_gpu_service_logging(const ::gpu::mojom::blink::GpuPreferencesPtr& input)
    {
        return input->enable_gpu_service_logging;
    }

    static decltype(::gpu::mojom::blink::GpuPreferences::enable_gpu_service_tracing) enable_gpu_service_tracing(const ::gpu::mojom::blink::GpuPreferencesPtr& input)
    {
        return input->enable_gpu_service_tracing;
    }

    static decltype(::gpu::mojom::blink::GpuPreferences::use_passthrough_cmd_decoder) use_passthrough_cmd_decoder(const ::gpu::mojom::blink::GpuPreferencesPtr& input)
    {
    ...
    static const decltype(::gpu::mojom::blink::GpuPreferences::texture_target_exception_list)& texture_target_exception_list(const ::gpu::mojom::blink::GpuPreferencesPtr& input)
    {
    ...
    static decltype(::gpu::mojom::blink::GpuPreferences::watchdog_starts_backgrounded) watchdog_starts_backgrounded(const ::gpu::mojom::blink::GpuPreferencesPtr& input)
    {
        return input->watchdog_starts_backgrounded;
    }

    static decltype(::gpu::mojom::blink::GpuPreferences::gr_context_type) gr_context_type(const ::gpu::mojom::blink::GpuPreferencesPtr& input) { return input->gr_context_type; }

    static decltype(::gpu::mojom::blink::GpuPreferences::use_vulkan) use_vulkan(const ::gpu::mojom::blink::GpuPreferencesPtr& input) { return input->use_vulkan; }

    static decltype(::gpu::mojom::blink::GpuPreferences::enable_vulkan_protected_memory) enable_vulkan_protected_memory(const ::gpu::mojom::blink::GpuPreferencesPtr& input)
    {
    ...
    static decltype(::gpu::mojom::blink::GpuPreferences::vulkan_sync_cpu_memory_limit) vulkan_sync_cpu_memory_limit(const ::gpu::mojom::blink::GpuPreferencesPtr& input)
    {
        return input->vulkan_sync_cpu_memory_limit;
    }

    static decltype(::gpu::mojom::blink::GpuPreferences::enable_metal) enable_metal(const ::gpu::mojom::blink::GpuPreferencesPtr& input) { return input->enable_metal; }

    static decltype(::gpu::mojom::blink::GpuPreferences::enable_gpu_benchmarking_extension) enable_gpu_benchmarking_extension(const ::gpu::mojom::blink::GpuPreferencesPtr& input)
    {
        return input->enable_gpu_benchmarking_extension;
    }

    static decltype(::gpu::mojom::blink::GpuPreferences::enable_webgpu) enable_webgpu(const ::gpu::mojom::blink::GpuPreferencesPtr& input) { return input->enable_webgpu; }
    ...
    static decltype(::gpu::mojom::blink::GpuPreferences::enable_dawn_backend_validation) enable_dawn_backend_validation(const ::gpu::mojom::blink::GpuPreferencesPtr& input)
    {
        return input->enable_dawn_backend_validation;
    }

    static const decltype(::gpu::mojom::blink::GpuPreferences::enabled_dawn_features_list)& enabled_dawn_features_list(const ::gpu::mojom::blink::GpuPreferencesPtr& input)
    {
        return input->enabled_dawn_features_list;
    }

    static const decltype(::gpu::mojom::blink::GpuPreferences::disabled_dawn_features_list)& disabled_dawn_features_list(const ::gpu::mojom::blink::GpuPreferencesPtr& input)
    {
        return input->disabled_dawn_features_list;
    }

    static decltype(::gpu::mojom::blink::GpuPreferences::enable_gpu_blocked_time_metric) enable_gpu_blocked_time_metric(const ::gpu::mojom::blink::GpuPreferencesPtr& input)
    {
        return input->enable_gpu_blocked_time_metric;
    }

    static decltype(::gpu::mojom::blink::GpuPreferences::enable_perf_data_collection) enable_perf_data_collection(const ::gpu::mojom::blink::GpuPreferencesPtr& input)
    {
        return input->enable_perf_data_collection;
    }

    static decltype(::gpu::mojom::blink::GpuPreferences::enable_native_gpu_memory_buffers) enable_native_gpu_memory_buffers(const ::gpu::mojom::blink::GpuPreferencesPtr& input)
    {
