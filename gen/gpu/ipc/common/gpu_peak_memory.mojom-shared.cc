...
std::ostream& operator<<(std::ostream& os, GpuPeakMemoryAllocationSource value) { return os << GpuPeakMemoryAllocationSourceToString(value); }
...
// static
void TraceFormatTraits<::gpu::mojom::GpuPeakMemoryAllocationSource>::WriteIntoTrace(perfetto::TracedValue context, ::gpu::mojom::GpuPeakMemoryAllocationSource value)
{
