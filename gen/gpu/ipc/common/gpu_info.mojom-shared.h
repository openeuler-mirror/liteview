...
inline bool IsKnownEnumValue(ImageDecodeAcceleratorType value) { return internal::ImageDecodeAcceleratorType_Data::IsKnownValue(static_cast<int32_t>(value)); }
...
inline bool IsKnownEnumValue(ImageDecodeAcceleratorSubsampling value) { return internal::ImageDecodeAcceleratorSubsampling_Data::IsKnownValue(static_cast<int32_t>(value)); }
...
inline bool IsKnownEnumValue(OverlaySupport value) { return internal::OverlaySupport_Data::IsKnownValue(static_cast<int32_t>(value)); }
class GpuDeviceDataView {
public:
    ...
    uint32_t device_id() const { return data_->device_id; }
    uint32_t sub_sys_id() const { return data_->sub_sys_id; }
    uint32_t revision() const { return data_->revision; }
    bool active() const { return data_->active; }
    ...
    int32_t cuda_compute_capability_major() const { return data_->cuda_compute_capability_major; }
...
public:
    ...
    VideoCodecProfile profile() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::gpu::mojom::VideoCodecProfile>(data_->profile)); }
    ...
    bool encrypted_only() const { return data_->encrypted_only; }
...
public:
    ...
    ImageDecodeAcceleratorType image_type() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::gpu::mojom::ImageDecodeAcceleratorType>(data_->image_type)); }
...
public:
    ...
    bool is_null() const { return !data_; }
    bool direct_composition() const { return data_->direct_composition; }
    bool supports_overlays() const { return data_->supports_overlays; }
    ...
    OverlaySupport yuy2_overlay_support() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::gpu::mojom::OverlaySupport>(data_->yuy2_overlay_support)); }
    ...
    OverlaySupport nv12_overlay_support() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::gpu::mojom::OverlaySupport>(data_->nv12_overlay_support)); }
    ...
    OverlaySupport bgra8_overlay_support() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::gpu::mojom::OverlaySupport>(data_->bgra8_overlay_support)); }
    ...
    OverlaySupport rgb10a2_overlay_support() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::gpu::mojom::OverlaySupport>(data_->rgb10a2_overlay_support)); }
...
public:
    ...
    bool optimus() const { return data_->optimus; }
    bool amd_switchable() const { return data_->amd_switchable; }
    ...
    uint32_t gl_reset_notification_strategy() const { return data_->gl_reset_notification_strategy; }
    bool software_rendering() const { return data_->software_rendering; }
    ...
    bool sandboxed() const { return data_->sandboxed; }
    bool in_process_gpu() const { return data_->in_process_gpu; }
    bool passthrough_cmd_decoder() const { return data_->passthrough_cmd_decoder; }
    bool can_support_threaded_texture_mailbox() const { return data_->can_support_threaded_texture_mailbox; }
    ...
    bool shared_image_d3d() const { return data_->shared_image_d3d; }
    ...
    bool jpeg_decode_accelerator_supported() const { return data_->jpeg_decode_accelerator_supported; }
    ...
    bool subpixel_font_rendering() const { return data_->subpixel_font_rendering; }
    uint32_t visibility_callback_call_count() const { return data_->visibility_callback_call_count; }
...
template <> struct hash<::gpu::mojom::ImageDecodeAcceleratorSubsampling> : public mojo::internal::EnumHashImpl<::gpu::mojom::ImageDecodeAcceleratorSubsampling> { };
...
template <typename MaybeConstUserType> struct Serializer<::gpu::mojom::GpuDeviceDataView, MaybeConstUserType> {
    ...
    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::gpu::mojom::internal::GpuDevice_Data>& fragment)
    {
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->luid.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null luid in GpuDevice struct");
...
template <typename MaybeConstUserType> struct Serializer<::gpu::mojom::VideoDecodeAcceleratorSupportedProfileDataView, MaybeConstUserType> {
    ...
    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::gpu::mojom::internal::VideoDecodeAcceleratorSupportedProfile_Data>& fragment)
    {
        if (CallIsNullIfExists<Traits>(input))
            return;
        fragment.Allocate();
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
            fragment->max_resolution.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null max_resolution in VideoDecodeAcceleratorSupportedProfile struct");
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
            fragment->min_resolution.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null min_resolution in VideoDecodeAcceleratorSupportedProfile struct");
...
template <typename MaybeConstUserType> struct Serializer<::gpu::mojom::VideoDecodeAcceleratorCapabilitiesDataView, MaybeConstUserType> {
    ...
    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::gpu::mojom::internal::VideoDecodeAcceleratorCapabilities_Data>& fragment)
    {
        ...
        const mojo::internal::ContainerValidateParams supported_profiles_validate_params(0, false, nullptr);
...
template <typename MaybeConstUserType> struct Serializer<::gpu::mojom::VideoEncodeAcceleratorSupportedProfileDataView, MaybeConstUserType> {
    ...
    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::gpu::mojom::internal::VideoEncodeAcceleratorSupportedProfile_Data>& fragment)
    {
        if (CallIsNullIfExists<Traits>(input))
            return;
        fragment.Allocate();
...
template <typename MaybeConstUserType> struct Serializer<::gpu::mojom::ImageDecodeAcceleratorSupportedProfileDataView, MaybeConstUserType> {
    ...
    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::gpu::mojom::internal::ImageDecodeAcceleratorSupportedProfile_Data>& fragment)
    {
        if (CallIsNullIfExists<Traits>(input))
            return;
        fragment.Allocate();
        ...
        const mojo::internal::ContainerValidateParams subsamplings_validate_params(0, ::gpu::mojom::internal::ImageDecodeAcceleratorSubsampling_Data::Validate);
        mojo::internal::Serialize<mojo::ArrayDataView<::gpu::mojom::ImageDecodeAcceleratorSubsampling>>(in_subsamplings, subsamplings_fragment, &subsamplings_validate_params);
        fragment->subsamplings.Set(subsamplings_fragment.is_null() ? nullptr : subsamplings_fragment.data());
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
            fragment->subsamplings.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null subsamplings in ImageDecodeAcceleratorSupportedProfile struct");
    }
...
template <typename MaybeConstUserType> struct Serializer<::gpu::mojom::GpuInfoDataView, MaybeConstUserType> {
    ...
    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::gpu::mojom::internal::GpuInfo_Data>& fragment)
    {
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->gpu.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null gpu in GpuInfo struct");
        ...
        const mojo::internal::ContainerValidateParams secondary_gpus_validate_params(0, false, nullptr);
        mojo::internal::Serialize<mojo::ArrayDataView<::gpu::mojom::GpuDeviceDataView>>(in_secondary_gpus, secondary_gpus_fragment, &secondary_gpus_validate_params);
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
            fragment->vertex_shader_version.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null vertex_shader_version in GpuInfo struct");
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
            fragment->machine_model_version.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null machine_model_version in GpuInfo struct");
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->gl_version.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null gl_version in GpuInfo struct");
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->gl_vendor.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null gl_vendor in GpuInfo struct");
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->gl_renderer.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null gl_renderer in GpuInfo struct");
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->gl_ws_vendor.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null gl_ws_vendor in GpuInfo struct");
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
            fragment->direct_rendering_version.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null direct_rendering_version in GpuInfo struct");
        ...
        decltype(Traits::dx_diagnostics(input)) in_dx_diagnostics = Traits::dx_diagnostics(input);
        mojo::internal::MessageFragment<typename decltype(fragment->dx_diagnostics)::BaseType> dx_diagnostics_fragment(fragment.message());
        mojo::internal::Serialize<::gpu::mojom::DxDiagNodeDataView>(in_dx_diagnostics, dx_diagnostics_fragment);
        fragment->dx_diagnostics.Set(dx_diagnostics_fragment.is_null() ? nullptr : dx_diagnostics_fragment.data());
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
            fragment->dx_diagnostics.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null dx_diagnostics in GpuInfo struct");
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->overlay_info.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null overlay_info in GpuInfo struct");
        ...
        mojo::internal::MessageFragment<typename decltype(fragment->video_decode_accelerator_supported_profiles)::BaseType> video_decode_accelerator_supported_profiles_fragment(
            fragment.message());
        const mojo::internal::ContainerValidateParams video_decode_accelerator_supported_profiles_validate_params(0, false, nullptr);
        mojo::internal::Serialize<mojo::ArrayDataView<::gpu::mojom::VideoDecodeAcceleratorSupportedProfileDataView>>(
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->video_decode_accelerator_supported_profiles.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER,
        ...
        mojo::internal::MessageFragment<typename decltype(fragment->video_encode_accelerator_supported_profiles)::BaseType> video_encode_accelerator_supported_profiles_fragment(
            fragment.message());
        const mojo::internal::ContainerValidateParams video_encode_accelerator_supported_profiles_validate_params(0, false, nullptr);
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->video_encode_accelerator_supported_profiles.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER,
        ...
        mojo::internal::MessageFragment<typename decltype(fragment->image_decode_accelerator_supported_profiles)::BaseType> image_decode_accelerator_supported_profiles_fragment(
            fragment.message());
        const mojo::internal::ContainerValidateParams image_decode_accelerator_supported_profiles_validate_params(0, false, nullptr);
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->image_decode_accelerator_supported_profiles.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER,
...
inline void VideoDecodeAcceleratorCapabilitiesDataView::GetSupportedProfilesDataView(mojo::ArrayDataView<VideoDecodeAcceleratorSupportedProfileDataView>* output)
{
    auto pointer = data_->supported_profiles.Get();
...
inline void GpuInfoDataView::GetDxDiagnosticsDataView(::gpu::mojom::DxDiagNodeDataView* output)
{
    auto pointer = data_->dx_diagnostics.Get();
