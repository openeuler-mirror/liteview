...
GpuDevice::GpuDevice(uint32_t vendor_id_in, uint32_t device_id_in, uint32_t sub_sys_id_in, uint32_t revision_in, bool active_in, const std::string& vendor_string_in,
    const std::string& device_string_in, const std::string& driver_vendor_in, const std::string& driver_version_in, int32_t cuda_compute_capability_major_in,
...
void GpuDevice::WriteIntoTrace(perfetto::TracedValue traced_context) const
{
    ...
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("cuda_compute_capability_major"), this->cuda_compute_capability_major,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
bool GpuDevice::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
bool VideoDecodeAcceleratorSupportedProfile::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
VideoDecodeAcceleratorCapabilities::VideoDecodeAcceleratorCapabilities(std::vector<::gpu::VideoDecodeAcceleratorSupportedProfile> supported_profiles_in, uint32_t flags_in)
...
bool VideoDecodeAcceleratorCapabilities::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
ImageDecodeAcceleratorSupportedProfile::ImageDecodeAcceleratorSupportedProfile(ImageDecodeAcceleratorType image_type_in, const ::gfx::Size& min_encoded_dimensions_in,
    const ::gfx::Size& max_encoded_dimensions_in, std::vector<ImageDecodeAcceleratorSubsampling> subsamplings_in)
...
bool ImageDecodeAcceleratorSupportedProfile::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
bool OverlayInfo::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
GpuInfo::GpuInfo()
    : initialization_time()
    , optimus()
    , amd_switchable()
...
GpuInfo::GpuInfo(::base::TimeDelta initialization_time_in, bool optimus_in, bool amd_switchable_in, const ::gpu::GPUInfo::GPUDevice& gpu_in,
    std::vector<::gpu::GPUInfo::GPUDevice> secondary_gpus_in, const std::string& pixel_shader_version_in, const std::string& vertex_shader_version_in,
    const std::string& max_msaa_samples_in, const std::string& machine_model_name_in, const std::string& machine_model_version_in, const std::string& gl_version_in,
    const std::string& gl_vendor_in, const std::string& gl_renderer_in, const std::string& gl_extensions_in, const std::string& gl_ws_vendor_in,
    const std::string& gl_ws_version_in, const std::string& gl_ws_extensions_in, uint32_t gl_reset_notification_strategy_in, bool software_rendering_in,
    const std::string& direct_rendering_version_in, bool sandboxed_in, bool in_process_gpu_in, bool passthrough_cmd_decoder_in, bool can_support_threaded_texture_mailbox_in,
    const ::gpu::DxDiagNode& dx_diagnostics_in, uint32_t d3d12_feature_level_in, uint32_t vulkan_version_in, const ::gpu::OverlayInfo& overlay_info_in, bool shared_image_d3d_in,
    ...
    uint32_t visibility_callback_call_count_in, const absl::optional<::gpu::VulkanInfo>& vulkan_info_in)
...
void GpuInfo::WriteIntoTrace(perfetto::TracedValue traced_context) const
{
    ...
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("software_rendering"), this->software_rendering,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
        "<value of type bool>"
#else
        "<value>"
    ...
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("dx_diagnostics"), this->dx_diagnostics,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
        "<value of type const ::gpu::DxDiagNode&>"
#else
        "<value>"
#endif // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
bool GpuInfo::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
} // namespace mojom
} // namespace gpu
namespace mojo {
// static
bool StructTraits<::gpu::mojom::GpuDevice::DataView, ::gpu::mojom::GpuDevicePtr>::Read(::gpu::mojom::GpuDevice::DataView input, ::gpu::mojom::GpuDevicePtr* output)
{
    bool success = true;
...
// static
bool StructTraits<::gpu::mojom::OverlayInfo::DataView, ::gpu::mojom::OverlayInfoPtr>::Read(::gpu::mojom::OverlayInfo::DataView input, ::gpu::mojom::OverlayInfoPtr* output)
{
    bool success = true;
...
bool StructTraits<::gpu::mojom::GpuInfo::DataView, ::gpu::mojom::GpuInfoPtr>::Read(::gpu::mojom::GpuInfo::DataView input, ::gpu::mojom::GpuInfoPtr* output)
{
    ...
    if (success && !input.ReadDxDiagnostics(&result->dx_diagnostics))
        success = false;
    if (success)
