...
class GPU_EXPORT GpuChannelInterceptorForTesting : public GpuChannel {
    ...
    void CreateCommandBuffer(CreateCommandBufferParamsPtr params, int32_t routing_id, ::base::UnsafeSharedMemoryRegion shared_state,
        ::mojo::PendingAssociatedReceiver<CommandBuffer> receiver, ::mojo::PendingAssociatedRemote<CommandBufferClient> client, CreateCommandBufferCallback callback) override;
    ...
    void RegisterOverlayStateObserver(
        ::mojo::PendingRemote<OverlayStateObserver> promotion_hint_observer, const ::gpu::Mailbox& mailbox, RegisterOverlayStateObserverCallback callback) override;
