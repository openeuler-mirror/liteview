...
struct gpu_mojom_internal_VideoCodecProfile_DataHashFn {
    ...
    static bool Equal(const ::gpu::mojom::VideoCodecProfile& left, const ::gpu::mojom::VideoCodecProfile& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::gpu::mojom::VideoCodecProfile> : public GenericHashTraits<::gpu::mojom::VideoCodecProfile> {
    ...
    static void ConstructDeletedValue(::gpu::mojom::VideoCodecProfile& slot, bool) { slot = static_cast<::gpu::mojom::VideoCodecProfile>(-1000001); }
    static bool IsDeletedValue(const ::gpu::mojom::VideoCodecProfile& value) { return value == static_cast<::gpu::mojom::VideoCodecProfile>(-1000001); }
};
} // namespace WTF
namespace WTF {
struct gpu_mojom_internal_ImageDecodeAcceleratorType_DataHashFn {
    ...
    static bool Equal(const ::gpu::mojom::ImageDecodeAcceleratorType& left, const ::gpu::mojom::ImageDecodeAcceleratorType& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::gpu::mojom::ImageDecodeAcceleratorType> : public GenericHashTraits<::gpu::mojom::ImageDecodeAcceleratorType> {
    static_assert(true, "-1000000 is a reserved enum value");
    static_assert(true, "-1000001 is a reserved enum value");
    static const bool kEmptyValueIsZero = false;
    static ::gpu::mojom::ImageDecodeAcceleratorType EmptyValue() { return static_cast<::gpu::mojom::ImageDecodeAcceleratorType>(-1000000); }
    static void ConstructDeletedValue(::gpu::mojom::ImageDecodeAcceleratorType& slot, bool) { slot = static_cast<::gpu::mojom::ImageDecodeAcceleratorType>(-1000001); }
    static bool IsDeletedValue(const ::gpu::mojom::ImageDecodeAcceleratorType& value) { return value == static_cast<::gpu::mojom::ImageDecodeAcceleratorType>(-1000001); }
};
} // namespace WTF
namespace WTF {
struct gpu_mojom_internal_ImageDecodeAcceleratorSubsampling_DataHashFn {
    ...
    static bool Equal(const ::gpu::mojom::ImageDecodeAcceleratorSubsampling& left, const ::gpu::mojom::ImageDecodeAcceleratorSubsampling& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::gpu::mojom::ImageDecodeAcceleratorSubsampling> : public GenericHashTraits<::gpu::mojom::ImageDecodeAcceleratorSubsampling> {
    static_assert(true, "-1000000 is a reserved enum value");
    static_assert(true, "-1000001 is a reserved enum value");
    static const bool kEmptyValueIsZero = false;
...
namespace WTF {
struct gpu_mojom_internal_OverlaySupport_DataHashFn {
    static unsigned GetHash(const ::gpu::mojom::OverlaySupport& value)
    {
        using utype = std::underlying_type<::gpu::mojom::OverlaySupport>::type;
        return DefaultHash<utype>::Hash().GetHash(static_cast<utype>(value));
    }
    static bool Equal(const ::gpu::mojom::OverlaySupport& left, const ::gpu::mojom::OverlaySupport& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::gpu::mojom::OverlaySupport> : public GenericHashTraits<::gpu::mojom::OverlaySupport> {
    static_assert(true, "-1000000 is a reserved enum value");
    static_assert(true, "-1000001 is a reserved enum value");
    static const bool kEmptyValueIsZero = false;
    static ::gpu::mojom::OverlaySupport EmptyValue() { return static_cast<::gpu::mojom::OverlaySupport>(-1000000); }
    static void ConstructDeletedValue(::gpu::mojom::OverlaySupport& slot, bool) { slot = static_cast<::gpu::mojom::OverlaySupport>(-1000001); }
    static bool IsDeletedValue(const ::gpu::mojom::OverlaySupport& value) { return value == static_cast<::gpu::mojom::OverlaySupport>(-1000001); }
};
} // namespace WTF
namespace gpu {
namespace mojom {
...
public:
    ...
    template <typename... Args> static GpuDevicePtr New(Args&&... args) { return GpuDevicePtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static GpuDevicePtr From(const U& u) { return mojo::TypeConverter<GpuDevicePtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, GpuDevice>::Convert(*this); }
    GpuDevice()
        : vendor_id()
        , device_id()
        , sub_sys_id()
    ...
    GpuDevice(uint32_t vendor_id_in, uint32_t device_id_in, uint32_t sub_sys_id_in, uint32_t revision_in, bool active_in, const WTF::String& vendor_string_in,
        const WTF::String& device_string_in, const WTF::String& driver_vendor_in, const WTF::String& driver_version_in, int32_t cuda_compute_capability_major_in,
    ...
    template <typename T, GpuDevice::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static WTF::Vector<uint8_t> Serialize(UserType* input) { return mojo::internal::SerializeImpl<GpuDevice::DataView, WTF::Vector<uint8_t>>(input); }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<GpuDevice::DataView>(input); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::GpuDevice_UnserializedMessageContext<UserType, GpuDevice::DataView>>(0, 0, std::move(input)), MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    {
        return GpuDevice::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, GpuDevice::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, GpuDevice::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, GpuDevice::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    {
        return VideoDecodeAcceleratorSupportedProfilePtr(absl::in_place, std::forward<Args>(args)...);
    }
    ...
    template <typename U> U To() const { return mojo::TypeConverter<U, VideoDecodeAcceleratorSupportedProfile>::Convert(*this); }
    ...
    VideoDecodeAcceleratorSupportedProfile(VideoCodecProfile profile_in, const ::gfx::Size& max_resolution_in, const ::gfx::Size& min_resolution_in, bool encrypted_only_in)
    ...
    template <typename T, VideoDecodeAcceleratorSupportedProfile::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::VideoDecodeAcceleratorSupportedProfile_UnserializedMessageContext<UserType, VideoDecodeAcceleratorSupportedProfile::DataView>>(
                0, 0, std::move(input)),
    ...
    template <typename UserType> static bool Deserialize(const WTF::Vector<uint8_t>& input, UserType* output)
    {
        return VideoDecodeAcceleratorSupportedProfile::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
    ...
    template <typename UserType> static bool DeserializeFromMessage(mojo::Message input, UserType* output)
    {
        ...
        input.SerializeIfNecessary();
        return mojo::internal::DeserializeImpl<VideoDecodeAcceleratorSupportedProfile::DataView>(input, input.payload(), input.payload_num_bytes(), output, Validate);
    }
...
template <typename T, VideoDecodeAcceleratorSupportedProfile::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, VideoDecodeAcceleratorSupportedProfile::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, VideoDecodeAcceleratorSupportedProfile::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    {
        return VideoDecodeAcceleratorCapabilitiesPtr(absl::in_place, std::forward<Args>(args)...);
    }

    template <typename U> static VideoDecodeAcceleratorCapabilitiesPtr From(const U& u) { return mojo::TypeConverter<VideoDecodeAcceleratorCapabilitiesPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, VideoDecodeAcceleratorCapabilities>::Convert(*this); }
    ...
    VideoDecodeAcceleratorCapabilities(WTF::Vector<VideoDecodeAcceleratorSupportedProfilePtr> supported_profiles_in, uint32_t flags_in)
    ...
    template <typename T, VideoDecodeAcceleratorCapabilities::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static WTF::Vector<uint8_t> Serialize(UserType* input)
    {
    ...
    template <typename UserType> static mojo::Message WrapAsMessage(UserType input)
    {
        return mojo::Message(std::make_unique<internal::VideoDecodeAcceleratorCapabilities_UnserializedMessageContext<UserType, VideoDecodeAcceleratorCapabilities::DataView>>(
                                 0, 0, std::move(input)),
            MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const WTF::Vector<uint8_t>& input, UserType* output)
    {
        return VideoDecodeAcceleratorCapabilities::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }

    template <typename UserType> static bool DeserializeFromMessage(mojo::Message input, UserType* output)
    {
        auto context
            = input.TakeUnserializedContext<internal::VideoDecodeAcceleratorCapabilities_UnserializedMessageContext<UserType, VideoDecodeAcceleratorCapabilities::DataView>>();
        if (context) {
            *output = std::move(context->TakeData());
            return true;
        }
        input.SerializeIfNecessary();
        return mojo::internal::DeserializeImpl<VideoDecodeAcceleratorCapabilities::DataView>(input, input.payload(), input.payload_num_bytes(), output, Validate);
    }
...
template <typename T, VideoDecodeAcceleratorCapabilities::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, VideoDecodeAcceleratorCapabilities::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, VideoDecodeAcceleratorCapabilities::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    VideoEncodeAcceleratorSupportedProfile(VideoCodecProfile profile_in, const ::gfx::Size& min_resolution_in, const ::gfx::Size& max_resolution_in,
        uint32_t max_framerate_numerator_in, uint32_t max_framerate_denominator_in)
        : profile(std::move(profile_in))
        , min_resolution(std::move(min_resolution_in))
        , max_resolution(std::move(max_resolution_in))
...
public:
    ...
    {
        return ImageDecodeAcceleratorSupportedProfilePtr(absl::in_place, std::forward<Args>(args)...);
    }
    ...
    template <typename U> U To() const { return mojo::TypeConverter<U, ImageDecodeAcceleratorSupportedProfile>::Convert(*this); }
    ...
    ImageDecodeAcceleratorSupportedProfile(ImageDecodeAcceleratorType image_type_in, const ::gfx::Size& min_encoded_dimensions_in, const ::gfx::Size& max_encoded_dimensions_in,
    ...
    template <typename T, ImageDecodeAcceleratorSupportedProfile::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static WTF::Vector<uint8_t> Serialize(UserType* input)
    {
    ...
    {
        return mojo::Message(
            std::make_unique<internal::ImageDecodeAcceleratorSupportedProfile_UnserializedMessageContext<UserType, ImageDecodeAcceleratorSupportedProfile::DataView>>(
                0, 0, std::move(input)),
            MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const WTF::Vector<uint8_t>& input, UserType* output)
    {
        return ImageDecodeAcceleratorSupportedProfile::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
    ...
    template <typename UserType> static bool DeserializeFromMessage(mojo::Message input, UserType* output)
    {
        ...
        input.SerializeIfNecessary();
        return mojo::internal::DeserializeImpl<ImageDecodeAcceleratorSupportedProfile::DataView>(input, input.payload(), input.payload_num_bytes(), output, Validate);
    }
...
template <typename T, ImageDecodeAcceleratorSupportedProfile::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, ImageDecodeAcceleratorSupportedProfile::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, ImageDecodeAcceleratorSupportedProfile::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static OverlayInfoPtr New(Args&&... args) { return OverlayInfoPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static OverlayInfoPtr From(const U& u) { return mojo::TypeConverter<OverlayInfoPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, OverlayInfo>::Convert(*this); }
    OverlayInfo()
        : direct_composition()
        , supports_overlays()
    ...
    OverlayInfo(bool direct_composition_in, bool supports_overlays_in, OverlaySupport yuy2_overlay_support_in, OverlaySupport nv12_overlay_support_in,
        OverlaySupport bgra8_overlay_support_in, OverlaySupport rgb10a2_overlay_support_in)
    ...
    template <typename T, OverlayInfo::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    ...
    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<OverlayInfo::DataView>(input); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::OverlayInfo_UnserializedMessageContext<UserType, OverlayInfo::DataView>>(0, 0, std::move(input)), MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const WTF::Vector<uint8_t>& input, UserType* output)
    {
        return OverlayInfo::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, OverlayInfo::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, OverlayInfo::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, OverlayInfo::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static GpuInfoPtr New(Args&&... args) { return GpuInfoPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static GpuInfoPtr From(const U& u) { return mojo::TypeConverter<GpuInfoPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, GpuInfo>::Convert(*this); }
    GpuInfo()
        : initialization_time()
        , optimus()
        , amd_switchable()
    ...
    GpuInfo(::base::TimeDelta initialization_time_in, bool optimus_in, bool amd_switchable_in, GpuDevicePtr gpu_in, WTF::Vector<GpuDevicePtr> secondary_gpus_in,
        const WTF::String& pixel_shader_version_in, const WTF::String& vertex_shader_version_in, const WTF::String& max_msaa_samples_in, const WTF::String& machine_model_name_in,
        const WTF::String& machine_model_version_in, const WTF::String& gl_version_in, const WTF::String& gl_vendor_in, const WTF::String& gl_renderer_in,
        const WTF::String& gl_extensions_in, const WTF::String& gl_ws_vendor_in, const WTF::String& gl_ws_version_in, const WTF::String& gl_ws_extensions_in,
        uint32_t gl_reset_notification_strategy_in, bool software_rendering_in, const WTF::String& direct_rendering_version_in, bool sandboxed_in, bool in_process_gpu_in,
        bool passthrough_cmd_decoder_in, bool can_support_threaded_texture_mailbox_in, ::gpu::mojom::blink::DxDiagNodePtr dx_diagnostics_in, uint32_t d3d12_feature_level_in,
        uint32_t vulkan_version_in, OverlayInfoPtr overlay_info_in, bool shared_image_d3d_in,
        ...
        uint32_t visibility_callback_call_count_in, ::gpu::mojom::blink::VulkanInfoPtr vulkan_info_in)
        ...
        , dx_diagnostics(std::move(dx_diagnostics_in))
    ...
    template <typename T, GpuInfo::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static WTF::Vector<uint8_t> Serialize(UserType* input) { return mojo::internal::SerializeImpl<GpuInfo::DataView, WTF::Vector<uint8_t>>(input); }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<GpuInfo::DataView>(input); }
    ...
    template <typename UserType> static mojo::Message WrapAsMessage(UserType input)
    {
        return mojo::Message(std::make_unique<internal::GpuInfo_UnserializedMessageContext<UserType, GpuInfo::DataView>>(0, 0, std::move(input)), MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const WTF::Vector<uint8_t>& input, UserType* output)
    {
        return GpuInfo::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, GpuInfo::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, GpuInfo::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, GpuInfo::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
template <typename StructPtrType> GpuDevicePtr GpuDevice::Clone() const
{
    return New(mojo::Clone(vendor_id), mojo::Clone(device_id), mojo::Clone(sub_sys_id), mojo::Clone(revision), mojo::Clone(active), mojo::Clone(vendor_string),
        mojo::Clone(device_string), mojo::Clone(driver_vendor), mojo::Clone(driver_version), mojo::Clone(cuda_compute_capability_major), mojo::Clone(luid),
...
template <typename StructPtrType> OverlayInfoPtr OverlayInfo::Clone() const
{
    return New(mojo::Clone(direct_composition), mojo::Clone(supports_overlays), mojo::Clone(yuy2_overlay_support), mojo::Clone(nv12_overlay_support),
        mojo::Clone(bgra8_overlay_support), mojo::Clone(rgb10a2_overlay_support));
}
...
template <typename StructPtrType> GpuInfoPtr GpuInfo::Clone() const
{
    return New(mojo::Clone(initialization_time), mojo::Clone(optimus), mojo::Clone(amd_switchable), mojo::Clone(gpu), mojo::Clone(secondary_gpus),
        mojo::Clone(pixel_shader_version), mojo::Clone(vertex_shader_version), mojo::Clone(max_msaa_samples), mojo::Clone(machine_model_name), mojo::Clone(machine_model_version),
        mojo::Clone(gl_version), mojo::Clone(gl_vendor), mojo::Clone(gl_renderer), mojo::Clone(gl_extensions), mojo::Clone(gl_ws_vendor), mojo::Clone(gl_ws_version),
        mojo::Clone(gl_ws_extensions), mojo::Clone(gl_reset_notification_strategy), mojo::Clone(software_rendering), mojo::Clone(direct_rendering_version), mojo::Clone(sandboxed),
        mojo::Clone(in_process_gpu), mojo::Clone(passthrough_cmd_decoder), mojo::Clone(can_support_threaded_texture_mailbox), mojo::Clone(dx_diagnostics),
        mojo::Clone(d3d12_feature_level), mojo::Clone(vulkan_version), mojo::Clone(overlay_info), mojo::Clone(shared_image_d3d),
        mojo::Clone(video_decode_accelerator_supported_profiles), mojo::Clone(video_encode_accelerator_supported_profiles), mojo::Clone(jpeg_decode_accelerator_supported),
        mojo::Clone(image_decode_accelerator_supported_profiles), mojo::Clone(subpixel_font_rendering), mojo::Clone(visibility_callback_call_count), mojo::Clone(vulkan_info));
}
...
template <typename T, GpuInfo::EnableIfSame<T>*> bool GpuInfo::Equals(const T& other_struct) const
{
    ...
    if (!mojo::Equals(this->can_support_threaded_texture_mailbox, other_struct.can_support_threaded_texture_mailbox))
        return false;
    if (!mojo::Equals(this->dx_diagnostics, other_struct.dx_diagnostics))
        return false;
...
template <typename T, GpuInfo::EnableIfSame<T>*> bool operator<(const T& lhs, const T& rhs)
{
    ...
    if (rhs.can_support_threaded_texture_mailbox < lhs.can_support_threaded_texture_mailbox)
        return false;
    if (lhs.dx_diagnostics < rhs.dx_diagnostics)
        return true;
    if (rhs.dx_diagnostics < lhs.dx_diagnostics)
        return false;
...
template <> struct BLINK_PLATFORM_EXPORT StructTraits<::gpu::mojom::blink::GpuDevice::DataView, ::gpu::mojom::blink::GpuDevicePtr> {
    ...
    static decltype(::gpu::mojom::blink::GpuDevice::vendor_id) vendor_id(const ::gpu::mojom::blink::GpuDevicePtr& input) { return input->vendor_id; }

    static decltype(::gpu::mojom::blink::GpuDevice::device_id) device_id(const ::gpu::mojom::blink::GpuDevicePtr& input) { return input->device_id; }

    static decltype(::gpu::mojom::blink::GpuDevice::sub_sys_id) sub_sys_id(const ::gpu::mojom::blink::GpuDevicePtr& input) { return input->sub_sys_id; }

    static decltype(::gpu::mojom::blink::GpuDevice::revision) revision(const ::gpu::mojom::blink::GpuDevicePtr& input) { return input->revision; }

    static decltype(::gpu::mojom::blink::GpuDevice::active) active(const ::gpu::mojom::blink::GpuDevicePtr& input) { return input->active; }

    static const decltype(::gpu::mojom::blink::GpuDevice::vendor_string)& vendor_string(const ::gpu::mojom::blink::GpuDevicePtr& input) { return input->vendor_string; }

    static const decltype(::gpu::mojom::blink::GpuDevice::device_string)& device_string(const ::gpu::mojom::blink::GpuDevicePtr& input) { return input->device_string; }

    static const decltype(::gpu::mojom::blink::GpuDevice::driver_vendor)& driver_vendor(const ::gpu::mojom::blink::GpuDevicePtr& input) { return input->driver_vendor; }

    static const decltype(::gpu::mojom::blink::GpuDevice::driver_version)& driver_version(const ::gpu::mojom::blink::GpuDevicePtr& input) { return input->driver_version; }

    static decltype(::gpu::mojom::blink::GpuDevice::cuda_compute_capability_major) cuda_compute_capability_major(const ::gpu::mojom::blink::GpuDevicePtr& input)
    {
        return input->cuda_compute_capability_major;
    }

    static const decltype(::gpu::mojom::blink::GpuDevice::luid)& luid(const ::gpu::mojom::blink::GpuDevicePtr& input) { return input->luid; }

    static decltype(::gpu::mojom::blink::GpuDevice::gpu_preference) gpu_preference(const ::gpu::mojom::blink::GpuDevicePtr& input) { return input->gpu_preference; }

    static bool Read(::gpu::mojom::blink::GpuDevice::DataView input, ::gpu::mojom::blink::GpuDevicePtr* output);
};
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::gpu::mojom::blink::VideoDecodeAcceleratorSupportedProfile::DataView, ::gpu::mojom::blink::VideoDecodeAcceleratorSupportedProfilePtr> {
    ...
    static decltype(::gpu::mojom::blink::VideoDecodeAcceleratorSupportedProfile::profile) profile(const ::gpu::mojom::blink::VideoDecodeAcceleratorSupportedProfilePtr& input)
    {
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::gpu::mojom::blink::VideoDecodeAcceleratorCapabilities::DataView, ::gpu::mojom::blink::VideoDecodeAcceleratorCapabilitiesPtr> {
    ...
    static decltype(::gpu::mojom::blink::VideoDecodeAcceleratorCapabilities::flags) flags(const ::gpu::mojom::blink::VideoDecodeAcceleratorCapabilitiesPtr& input)
    {
        return input->flags;
    }
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::gpu::mojom::blink::VideoEncodeAcceleratorSupportedProfile::DataView, ::gpu::mojom::blink::VideoEncodeAcceleratorSupportedProfilePtr> {
    ...
    static decltype(::gpu::mojom::blink::VideoEncodeAcceleratorSupportedProfile::profile) profile(const ::gpu::mojom::blink::VideoEncodeAcceleratorSupportedProfilePtr& input)
    {
        return input->profile;
    }
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::gpu::mojom::blink::ImageDecodeAcceleratorSupportedProfile::DataView, ::gpu::mojom::blink::ImageDecodeAcceleratorSupportedProfilePtr> {
    ...
    static decltype(::gpu::mojom::blink::ImageDecodeAcceleratorSupportedProfile::image_type) image_type(const ::gpu::mojom::blink::ImageDecodeAcceleratorSupportedProfilePtr& input)
    {
...
template <> struct BLINK_PLATFORM_EXPORT StructTraits<::gpu::mojom::blink::OverlayInfo::DataView, ::gpu::mojom::blink::OverlayInfoPtr> {
    ...
    static decltype(::gpu::mojom::blink::OverlayInfo::direct_composition) direct_composition(const ::gpu::mojom::blink::OverlayInfoPtr& input) { return input->direct_composition; }

    static decltype(::gpu::mojom::blink::OverlayInfo::supports_overlays) supports_overlays(const ::gpu::mojom::blink::OverlayInfoPtr& input) { return input->supports_overlays; }
...
template <> struct BLINK_PLATFORM_EXPORT StructTraits<::gpu::mojom::blink::GpuInfo::DataView, ::gpu::mojom::blink::GpuInfoPtr> {
    ...
    static decltype(::gpu::mojom::blink::GpuInfo::optimus) optimus(const ::gpu::mojom::blink::GpuInfoPtr& input) { return input->optimus; }

    static decltype(::gpu::mojom::blink::GpuInfo::amd_switchable) amd_switchable(const ::gpu::mojom::blink::GpuInfoPtr& input) { return input->amd_switchable; }

    static const decltype(::gpu::mojom::blink::GpuInfo::gpu)& gpu(const ::gpu::mojom::blink::GpuInfoPtr& input) { return input->gpu; }

    static const decltype(::gpu::mojom::blink::GpuInfo::secondary_gpus)& secondary_gpus(const ::gpu::mojom::blink::GpuInfoPtr& input) { return input->secondary_gpus; }
    ...
    static const decltype(::gpu::mojom::blink::GpuInfo::max_msaa_samples)& max_msaa_samples(const ::gpu::mojom::blink::GpuInfoPtr& input) { return input->max_msaa_samples; }

    static const decltype(::gpu::mojom::blink::GpuInfo::machine_model_name)& machine_model_name(const ::gpu::mojom::blink::GpuInfoPtr& input) { return input->machine_model_name; }
    ...
    static const decltype(::gpu::mojom::blink::GpuInfo::gl_version)& gl_version(const ::gpu::mojom::blink::GpuInfoPtr& input) { return input->gl_version; }

    static const decltype(::gpu::mojom::blink::GpuInfo::gl_vendor)& gl_vendor(const ::gpu::mojom::blink::GpuInfoPtr& input) { return input->gl_vendor; }

    static const decltype(::gpu::mojom::blink::GpuInfo::gl_renderer)& gl_renderer(const ::gpu::mojom::blink::GpuInfoPtr& input) { return input->gl_renderer; }

    static const decltype(::gpu::mojom::blink::GpuInfo::gl_extensions)& gl_extensions(const ::gpu::mojom::blink::GpuInfoPtr& input) { return input->gl_extensions; }

    static const decltype(::gpu::mojom::blink::GpuInfo::gl_ws_vendor)& gl_ws_vendor(const ::gpu::mojom::blink::GpuInfoPtr& input) { return input->gl_ws_vendor; }

    static const decltype(::gpu::mojom::blink::GpuInfo::gl_ws_version)& gl_ws_version(const ::gpu::mojom::blink::GpuInfoPtr& input) { return input->gl_ws_version; }

    static const decltype(::gpu::mojom::blink::GpuInfo::gl_ws_extensions)& gl_ws_extensions(const ::gpu::mojom::blink::GpuInfoPtr& input) { return input->gl_ws_extensions; }
    ...
    static decltype(::gpu::mojom::blink::GpuInfo::software_rendering) software_rendering(const ::gpu::mojom::blink::GpuInfoPtr& input) { return input->software_rendering; }
    ...
    static decltype(::gpu::mojom::blink::GpuInfo::sandboxed) sandboxed(const ::gpu::mojom::blink::GpuInfoPtr& input) { return input->sandboxed; }

    static decltype(::gpu::mojom::blink::GpuInfo::in_process_gpu) in_process_gpu(const ::gpu::mojom::blink::GpuInfoPtr& input) { return input->in_process_gpu; }
    ...
    static decltype(::gpu::mojom::blink::GpuInfo::can_support_threaded_texture_mailbox) can_support_threaded_texture_mailbox(const ::gpu::mojom::blink::GpuInfoPtr& input)
    {
        return input->can_support_threaded_texture_mailbox;
    }

    static const decltype(::gpu::mojom::blink::GpuInfo::dx_diagnostics)& dx_diagnostics(const ::gpu::mojom::blink::GpuInfoPtr& input) { return input->dx_diagnostics; }

    static decltype(::gpu::mojom::blink::GpuInfo::d3d12_feature_level) d3d12_feature_level(const ::gpu::mojom::blink::GpuInfoPtr& input) { return input->d3d12_feature_level; }

    static decltype(::gpu::mojom::blink::GpuInfo::vulkan_version) vulkan_version(const ::gpu::mojom::blink::GpuInfoPtr& input) { return input->vulkan_version; }

    static const decltype(::gpu::mojom::blink::GpuInfo::overlay_info)& overlay_info(const ::gpu::mojom::blink::GpuInfoPtr& input) { return input->overlay_info; }

    static decltype(::gpu::mojom::blink::GpuInfo::shared_image_d3d) shared_image_d3d(const ::gpu::mojom::blink::GpuInfoPtr& input) { return input->shared_image_d3d; }
    ...
    static decltype(::gpu::mojom::blink::GpuInfo::jpeg_decode_accelerator_supported) jpeg_decode_accelerator_supported(const ::gpu::mojom::blink::GpuInfoPtr& input)
    {
    ...
    static const decltype(::gpu::mojom::blink::GpuInfo::vulkan_info)& vulkan_info(const ::gpu::mojom::blink::GpuInfoPtr& input) { return input->vulkan_info; }
