...
public:
...
#if defined(OS_WIN)
    GpuDevice(uint32_t vendor_id, uint32_t device_id, uint32_t sub_sys_id, uint32_t revision, bool active, const std::string& vendor_string, const std::string& device_string,
        const std::string& driver_vendor, const std::string& driver_version, int32_t cuda_compute_capability_major, const ::CHROME_LUID& luid, ::gl::GpuPreference gpu_preference);
#endif
    ~GpuDevice();
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input) { return mojo::internal::SerializeImpl<GpuDevice::DataView, std::vector<uint8_t>>(input); }
...
public:
    ...
    VideoDecodeAcceleratorSupportedProfile(::gpu::VideoCodecProfile profile, const ::gfx::Size& max_resolution, const ::gfx::Size& min_resolution, bool encrypted_only);
    ~VideoDecodeAcceleratorSupportedProfile();
...
public:
    ...
    VideoEncodeAcceleratorSupportedProfile(::gpu::VideoCodecProfile profile, const ::gfx::Size& min_resolution, const ::gfx::Size& max_resolution, uint32_t max_framerate_numerator,
...
public:
    ...
    ImageDecodeAcceleratorSupportedProfile(ImageDecodeAcceleratorType image_type, const ::gfx::Size& min_encoded_dimensions, const ::gfx::Size& max_encoded_dimensions,
...
public:
    ...
    OverlayInfo(bool direct_composition, bool supports_overlays, OverlaySupport yuy2_overlay_support, OverlaySupport nv12_overlay_support, OverlaySupport bgra8_overlay_support,
...
public:
...
#if BUILDFLAG(IS_WIN)
    GpuInfo(::base::TimeDelta initialization_time, bool optimus, bool amd_switchable, const ::gpu::GPUInfo::GPUDevice& gpu, std::vector<::gpu::GPUInfo::GPUDevice> secondary_gpus,
        const std::string& pixel_shader_version, const std::string& vertex_shader_version, const std::string& max_msaa_samples, const std::string& machine_model_name,
        const std::string& machine_model_version, const std::string& gl_version, const std::string& gl_vendor, const std::string& gl_renderer, const std::string& gl_extensions,
        const std::string& gl_ws_vendor, const std::string& gl_ws_version, const std::string& gl_ws_extensions, uint32_t gl_reset_notification_strategy, bool software_rendering,
        const std::string& direct_rendering_version, bool sandboxed, bool in_process_gpu, bool passthrough_cmd_decoder, bool can_support_threaded_texture_mailbox,
        const ::gpu::DxDiagNode& dx_diagnostics, uint32_t d3d12_feature_level, uint32_t vulkan_version, const ::gpu::OverlayInfo& overlay_info, bool shared_image_d3d,
        ...
        //, const absl::optional<::gpu::VulkanInfo>& vulkan_info
    );
#endif
    ~GpuInfo();
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input) { return mojo::internal::SerializeImpl<GpuInfo::DataView, std::vector<uint8_t>>(input); }
    ...
    // absl::optional<::gpu::VulkanInfo> vulkan_info;
...
template <typename StructPtrType> GpuDevicePtr GpuDevice::Clone() const
{
    ...
    return New(mojo::Clone(vendor_id), mojo::Clone(device_id), mojo::Clone(sub_sys_id), mojo::Clone(revision), mojo::Clone(active), mojo::Clone(vendor_string),
        mojo::Clone(device_string), mojo::Clone(driver_vendor), mojo::Clone(driver_version), mojo::Clone(cuda_compute_capability_major), 
        mojo::Clone(luid),
        mojo::Clone(gpu_preference));
#else
    *(int*)1 = 1;
    return GpuDevicePtr(nullptr);
#endif
}
...
template <typename StructPtrType> GpuInfoPtr GpuInfo::Clone() const
{
    ...
    return New(mojo::Clone(initialization_time), mojo::Clone(optimus), mojo::Clone(amd_switchable), mojo::Clone(gpu), mojo::Clone(secondary_gpus),
        ...
        mojo::Clone(image_decode_accelerator_supported_profiles), mojo::Clone(subpixel_font_rendering), mojo::Clone(visibility_callback_call_count)
...
template <> struct GPU_EXPORT StructTraits<::gpu::mojom::GpuDevice::DataView, ::gpu::mojom::GpuDevicePtr> {
    ...
    static decltype(::gpu::mojom::GpuDevice::vendor_id) vendor_id(const ::gpu::mojom::GpuDevicePtr& input) { return input->vendor_id; }

    static decltype(::gpu::mojom::GpuDevice::device_id) device_id(const ::gpu::mojom::GpuDevicePtr& input) { return input->device_id; }

    static decltype(::gpu::mojom::GpuDevice::sub_sys_id) sub_sys_id(const ::gpu::mojom::GpuDevicePtr& input) { return input->sub_sys_id; }

    static decltype(::gpu::mojom::GpuDevice::revision) revision(const ::gpu::mojom::GpuDevicePtr& input) { return input->revision; }

    static decltype(::gpu::mojom::GpuDevice::active) active(const ::gpu::mojom::GpuDevicePtr& input) { return input->active; }

    static const decltype(::gpu::mojom::GpuDevice::vendor_string)& vendor_string(const ::gpu::mojom::GpuDevicePtr& input) { return input->vendor_string; }

    static const decltype(::gpu::mojom::GpuDevice::device_string)& device_string(const ::gpu::mojom::GpuDevicePtr& input) { return input->device_string; }

    static const decltype(::gpu::mojom::GpuDevice::driver_vendor)& driver_vendor(const ::gpu::mojom::GpuDevicePtr& input) { return input->driver_vendor; }

    static const decltype(::gpu::mojom::GpuDevice::driver_version)& driver_version(const ::gpu::mojom::GpuDevicePtr& input) { return input->driver_version; }

    static decltype(::gpu::mojom::GpuDevice::cuda_compute_capability_major) cuda_compute_capability_major(const ::gpu::mojom::GpuDevicePtr& input)
    {
        return input->cuda_compute_capability_major;
    }
#if BUILDFLAG(IS_WIN)
    static const decltype(::gpu::mojom::GpuDevice::luid)& luid(const ::gpu::mojom::GpuDevicePtr& input) { return input->luid; }
#endif
    static decltype(::gpu::mojom::GpuDevice::gpu_preference) gpu_preference(const ::gpu::mojom::GpuDevicePtr& input) { return input->gpu_preference; }

    static bool Read(::gpu::mojom::GpuDevice::DataView input, ::gpu::mojom::GpuDevicePtr* output);
};
template <> struct GPU_EXPORT StructTraits<::gpu::mojom::VideoDecodeAcceleratorSupportedProfile::DataView, ::gpu::mojom::VideoDecodeAcceleratorSupportedProfilePtr> {
    ...
    static decltype(::gpu::mojom::VideoDecodeAcceleratorSupportedProfile::encrypted_only) encrypted_only(const ::gpu::mojom::VideoDecodeAcceleratorSupportedProfilePtr& input)
    {
...
template <> struct GPU_EXPORT StructTraits<::gpu::mojom::VideoDecodeAcceleratorCapabilities::DataView, ::gpu::mojom::VideoDecodeAcceleratorCapabilitiesPtr> {
    ...
    static decltype(::gpu::mojom::VideoDecodeAcceleratorCapabilities::flags) flags(const ::gpu::mojom::VideoDecodeAcceleratorCapabilitiesPtr& input) { return input->flags; }
...
template <> struct GPU_EXPORT StructTraits<::gpu::mojom::VideoEncodeAcceleratorSupportedProfile::DataView, ::gpu::mojom::VideoEncodeAcceleratorSupportedProfilePtr> {
...
template <> struct GPU_EXPORT StructTraits<::gpu::mojom::ImageDecodeAcceleratorSupportedProfile::DataView, ::gpu::mojom::ImageDecodeAcceleratorSupportedProfilePtr> {
    ...
    static decltype(::gpu::mojom::ImageDecodeAcceleratorSupportedProfile::image_type) image_type(const ::gpu::mojom::ImageDecodeAcceleratorSupportedProfilePtr& input)
    {
    ...
    static const decltype(::gpu::mojom::ImageDecodeAcceleratorSupportedProfile::subsamplings)& subsamplings(const ::gpu::mojom::ImageDecodeAcceleratorSupportedProfilePtr& input)
    {
...
template <> struct GPU_EXPORT StructTraits<::gpu::mojom::OverlayInfo::DataView, ::gpu::mojom::OverlayInfoPtr> {
    ...
    static decltype(::gpu::mojom::OverlayInfo::direct_composition) direct_composition(const ::gpu::mojom::OverlayInfoPtr& input) { return input->direct_composition; }

    static decltype(::gpu::mojom::OverlayInfo::supports_overlays) supports_overlays(const ::gpu::mojom::OverlayInfoPtr& input) { return input->supports_overlays; }

    static decltype(::gpu::mojom::OverlayInfo::yuy2_overlay_support) yuy2_overlay_support(const ::gpu::mojom::OverlayInfoPtr& input) { return input->yuy2_overlay_support; }

    static decltype(::gpu::mojom::OverlayInfo::nv12_overlay_support) nv12_overlay_support(const ::gpu::mojom::OverlayInfoPtr& input) { return input->nv12_overlay_support; }

    static decltype(::gpu::mojom::OverlayInfo::bgra8_overlay_support) bgra8_overlay_support(const ::gpu::mojom::OverlayInfoPtr& input) { return input->bgra8_overlay_support; }
...
template <> struct GPU_EXPORT StructTraits<::gpu::mojom::GpuInfo::DataView, ::gpu::mojom::GpuInfoPtr> {
    ...
    static const decltype(::gpu::mojom::GpuInfo::initialization_time)& initialization_time(const ::gpu::mojom::GpuInfoPtr& input) { return input->initialization_time; }

    static decltype(::gpu::mojom::GpuInfo::optimus) optimus(const ::gpu::mojom::GpuInfoPtr& input) { return input->optimus; }

    static decltype(::gpu::mojom::GpuInfo::amd_switchable) amd_switchable(const ::gpu::mojom::GpuInfoPtr& input) { return input->amd_switchable; }

    static const decltype(::gpu::mojom::GpuInfo::gpu)& gpu(const ::gpu::mojom::GpuInfoPtr& input) { return input->gpu; }

    static const decltype(::gpu::mojom::GpuInfo::secondary_gpus)& secondary_gpus(const ::gpu::mojom::GpuInfoPtr& input) { return input->secondary_gpus; }

    static const decltype(::gpu::mojom::GpuInfo::pixel_shader_version)& pixel_shader_version(const ::gpu::mojom::GpuInfoPtr& input) { return input->pixel_shader_version; }

    static const decltype(::gpu::mojom::GpuInfo::vertex_shader_version)& vertex_shader_version(const ::gpu::mojom::GpuInfoPtr& input) { return input->vertex_shader_version; }

    static const decltype(::gpu::mojom::GpuInfo::max_msaa_samples)& max_msaa_samples(const ::gpu::mojom::GpuInfoPtr& input) { return input->max_msaa_samples; }

    static const decltype(::gpu::mojom::GpuInfo::machine_model_name)& machine_model_name(const ::gpu::mojom::GpuInfoPtr& input) { return input->machine_model_name; }

    static const decltype(::gpu::mojom::GpuInfo::machine_model_version)& machine_model_version(const ::gpu::mojom::GpuInfoPtr& input) { return input->machine_model_version; }

    static const decltype(::gpu::mojom::GpuInfo::gl_version)& gl_version(const ::gpu::mojom::GpuInfoPtr& input) { return input->gl_version; }

    static const decltype(::gpu::mojom::GpuInfo::gl_vendor)& gl_vendor(const ::gpu::mojom::GpuInfoPtr& input) { return input->gl_vendor; }

    static const decltype(::gpu::mojom::GpuInfo::gl_renderer)& gl_renderer(const ::gpu::mojom::GpuInfoPtr& input) { return input->gl_renderer; }

    static const decltype(::gpu::mojom::GpuInfo::gl_extensions)& gl_extensions(const ::gpu::mojom::GpuInfoPtr& input) { return input->gl_extensions; }

    static const decltype(::gpu::mojom::GpuInfo::gl_ws_vendor)& gl_ws_vendor(const ::gpu::mojom::GpuInfoPtr& input) { return input->gl_ws_vendor; }

    static const decltype(::gpu::mojom::GpuInfo::gl_ws_version)& gl_ws_version(const ::gpu::mojom::GpuInfoPtr& input) { return input->gl_ws_version; }

    static const decltype(::gpu::mojom::GpuInfo::gl_ws_extensions)& gl_ws_extensions(const ::gpu::mojom::GpuInfoPtr& input) { return input->gl_ws_extensions; }
    ...
    static decltype(::gpu::mojom::GpuInfo::software_rendering) software_rendering(const ::gpu::mojom::GpuInfoPtr& input) { return input->software_rendering; }
    ...
    static decltype(::gpu::mojom::GpuInfo::sandboxed) sandboxed(const ::gpu::mojom::GpuInfoPtr& input) { return input->sandboxed; }

    static decltype(::gpu::mojom::GpuInfo::in_process_gpu) in_process_gpu(const ::gpu::mojom::GpuInfoPtr& input) { return input->in_process_gpu; }

    static decltype(::gpu::mojom::GpuInfo::passthrough_cmd_decoder) passthrough_cmd_decoder(const ::gpu::mojom::GpuInfoPtr& input) { return input->passthrough_cmd_decoder; }
    ...
    static const decltype(::gpu::mojom::GpuInfo::dx_diagnostics)& dx_diagnostics(const ::gpu::mojom::GpuInfoPtr& input) { return input->dx_diagnostics; }

    static decltype(::gpu::mojom::GpuInfo::d3d12_feature_level) d3d12_feature_level(const ::gpu::mojom::GpuInfoPtr& input) { return input->d3d12_feature_level; }
    ...
    //   }
#if BUILDFLAG(IS_WIN)
    static const decltype(::gpu::mojom::GpuInfo::overlay_info)& overlay_info(const ::gpu::mojom::GpuInfoPtr& input) { return input->overlay_info; }
#endif
    static decltype(::gpu::mojom::GpuInfo::shared_image_d3d) shared_image_d3d(const ::gpu::mojom::GpuInfoPtr& input) { return input->shared_image_d3d; }

    static const decltype(::gpu::mojom::GpuInfo::video_decode_accelerator_supported_profiles)& video_decode_accelerator_supported_profiles(const ::gpu::mojom::GpuInfoPtr& input)
    {
        return input->video_decode_accelerator_supported_profiles;
    }

    static const decltype(::gpu::mojom::GpuInfo::video_encode_accelerator_supported_profiles)& video_encode_accelerator_supported_profiles(const ::gpu::mojom::GpuInfoPtr& input)
    {
    ...
    static const decltype(::gpu::mojom::GpuInfo::image_decode_accelerator_supported_profiles)& image_decode_accelerator_supported_profiles(const ::gpu::mojom::GpuInfoPtr& input)
    {
        return input->image_decode_accelerator_supported_profiles;
    }

    static decltype(::gpu::mojom::GpuInfo::subpixel_font_rendering) subpixel_font_rendering(const ::gpu::mojom::GpuInfoPtr& input) { return input->subpixel_font_rendering; }
