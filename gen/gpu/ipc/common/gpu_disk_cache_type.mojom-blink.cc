...
#ifndef GPU_IPC_COMMON_GPU_DISK_CACHE_TYPE_MOJOM_BLINK_JUMBO_H_
#define GPU_IPC_COMMON_GPU_DISK_CACHE_TYPE_MOJOM_BLINK_JUMBO_H_
#endif
...
bool GpuDiskCacheGlShaderHandle::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
bool GpuDiskCacheDawnWebGPUHandle::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
GpuDiskCacheHandle::~GpuDiskCacheHandle() { DestroyActive(); }
...
bool GpuDiskCacheHandle::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context, false); }
} // namespace blink
} // namespace mojom
} // namespace gpu
namespace mojo {
