...
std::ostream& operator<<(std::ostream& os, Direct3DFeatureLevel value) { return os << Direct3DFeatureLevelToString(value); }
...
std::ostream& operator<<(std::ostream& os, HasDiscreteGpu value) { return os << HasDiscreteGpuToString(value); }
