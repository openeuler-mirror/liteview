...
inline bool IsKnownEnumValue(VulkanImplementationName value) { return internal::VulkanImplementationName_Data::IsKnownValue(static_cast<int32_t>(value)); }
...
inline bool IsKnownEnumValue(WebGPUAdapterName value) { return internal::WebGPUAdapterName_Data::IsKnownValue(static_cast<int32_t>(value)); }
...
inline bool IsKnownEnumValue(GrContextType value) { return internal::GrContextType_Data::IsKnownValue(static_cast<int32_t>(value)); }
...
inline bool IsKnownEnumValue(DawnBackendValidationLevel value) { return internal::DawnBackendValidationLevel_Data::IsKnownValue(static_cast<int32_t>(value)); }
class GpuPreferencesDataView {
public:
    ...
    bool disable_accelerated_video_decode() const { return data_->disable_accelerated_video_decode; }
    bool disable_accelerated_video_encode() const { return data_->disable_accelerated_video_encode; }
    bool gpu_startup_dialog() const { return data_->gpu_startup_dialog; }
    bool disable_gpu_watchdog() const { return data_->disable_gpu_watchdog; }
    bool gpu_sandbox_start_early() const { return data_->gpu_sandbox_start_early; }
    bool enable_low_latency_dxva() const { return data_->enable_low_latency_dxva; }
    bool enable_zero_copy_dxgi_video() const { return data_->enable_zero_copy_dxgi_video; }
    bool enable_nv12_dxgi_video() const { return data_->enable_nv12_dxgi_video; }
    bool enable_media_foundation_vea_on_windows7() const { return data_->enable_media_foundation_vea_on_windows7; }
    bool disable_software_rasterizer() const { return data_->disable_software_rasterizer; }
    bool log_gpu_control_list_decisions() const { return data_->log_gpu_control_list_decisions; }
    bool compile_shader_always_succeeds() const { return data_->compile_shader_always_succeeds; }
    bool disable_gl_error_limit() const { return data_->disable_gl_error_limit; }
    bool disable_glsl_translator() const { return data_->disable_glsl_translator; }
    bool disable_shader_name_hashing() const { return data_->disable_shader_name_hashing; }
    bool enable_gpu_command_logging() const { return data_->enable_gpu_command_logging; }
    bool enable_gpu_debugging() const { return data_->enable_gpu_debugging; }
    bool enable_gpu_service_logging_gpu() const { return data_->enable_gpu_service_logging_gpu; }
    bool enable_gpu_driver_debug_logging() const { return data_->enable_gpu_driver_debug_logging; }
    bool disable_gpu_program_cache() const { return data_->disable_gpu_program_cache; }
    bool enforce_gl_minimums() const { return data_->enforce_gl_minimums; }
    uint32_t force_gpu_mem_available_bytes() const { return data_->force_gpu_mem_available_bytes; }
    uint32_t force_gpu_mem_discardable_limit_bytes() const { return data_->force_gpu_mem_discardable_limit_bytes; }
    uint32_t force_max_texture_size() const { return data_->force_max_texture_size; }
    uint32_t gpu_program_cache_size() const { return data_->gpu_program_cache_size; }
    bool disable_gpu_shader_disk_cache() const { return data_->disable_gpu_shader_disk_cache; }
    bool enable_threaded_texture_mailboxes() const { return data_->enable_threaded_texture_mailboxes; }
    bool gl_shader_interm_output() const { return data_->gl_shader_interm_output; }
    bool enable_android_surface_control() const { return data_->enable_android_surface_control; }
    bool enable_gpu_service_logging() const { return data_->enable_gpu_service_logging; }
    bool enable_gpu_service_tracing() const { return data_->enable_gpu_service_tracing; }
    bool use_passthrough_cmd_decoder() const { return data_->use_passthrough_cmd_decoder; }
    bool disable_biplanar_gpu_memory_buffers_for_video_frames() const { return data_->disable_biplanar_gpu_memory_buffers_for_video_frames; }
    inline void GetTextureTargetExceptionListDataView(mojo::ArrayDataView<::gfx::mojom::BufferUsageAndFormatDataView>* output);

    template <typename UserType> [[nodiscard]] bool ReadTextureTargetExceptionList(UserType* output)
    {

        auto* pointer = data_->texture_target_exception_list.Get();
        return mojo::internal::Deserialize<mojo::ArrayDataView<::gfx::mojom::BufferUsageAndFormatDataView>>(pointer, output, message_);
    }
    bool ignore_gpu_blocklist() const { return data_->ignore_gpu_blocklist; }
    bool watchdog_starts_backgrounded() const { return data_->watchdog_starts_backgrounded; }
    ...
    GrContextType gr_context_type() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::gpu::mojom::GrContextType>(data_->gr_context_type)); }
    ...
    VulkanImplementationName use_vulkan() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::gpu::mojom::VulkanImplementationName>(data_->use_vulkan)); }
    bool enable_vulkan_protected_memory() const { return data_->enable_vulkan_protected_memory; }
    bool disable_vulkan_surface() const { return data_->disable_vulkan_surface; }
    bool disable_vulkan_fallback_to_gl_for_testing() const { return data_->disable_vulkan_fallback_to_gl_for_testing; }
    uint32_t vulkan_heap_memory_limit() const { return data_->vulkan_heap_memory_limit; }
    uint32_t vulkan_sync_cpu_memory_limit() const { return data_->vulkan_sync_cpu_memory_limit; }
    bool enable_metal() const { return data_->enable_metal; }
    bool enable_gpu_benchmarking_extension() const { return data_->enable_gpu_benchmarking_extension; }
    bool enable_webgpu() const { return data_->enable_webgpu; }
    bool enable_unsafe_webgpu() const { return data_->enable_unsafe_webgpu; }
    ...
    WebGPUAdapterName use_webgpu_adapter() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::gpu::mojom::WebGPUAdapterName>(data_->use_webgpu_adapter)); }
    ...
    bool enable_gpu_blocked_time_metric() const { return data_->enable_gpu_blocked_time_metric; }
    bool enable_perf_data_collection() const { return data_->enable_perf_data_collection; }
    bool enable_native_gpu_memory_buffers() const { return data_->enable_native_gpu_memory_buffers; }
...
template <typename MaybeConstUserType> struct Serializer<::gpu::mojom::GpuPreferencesDataView, MaybeConstUserType> {
    ...
    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::gpu::mojom::internal::GpuPreferences_Data>& fragment)
    {
        ...
        mojo::internal::MessageFragment<typename decltype(fragment->texture_target_exception_list)::BaseType> texture_target_exception_list_fragment(fragment.message());
        const mojo::internal::ContainerValidateParams texture_target_exception_list_validate_params(0, false, nullptr);
        ...
        fragment->texture_target_exception_list.Set(texture_target_exception_list_fragment.is_null() ? nullptr : texture_target_exception_list_fragment.data());
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->texture_target_exception_list.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER,
        ...
        mojo::internal::Serialize<::gpu::mojom::DawnBackendValidationLevel>(Traits::enable_dawn_backend_validation(input), &fragment->enable_dawn_backend_validation);
        decltype(Traits::enabled_dawn_features_list(input)) in_enabled_dawn_features_list = Traits::enabled_dawn_features_list(input);
        mojo::internal::MessageFragment<typename decltype(fragment->enabled_dawn_features_list)::BaseType> enabled_dawn_features_list_fragment(fragment.message());
        const mojo::internal::ContainerValidateParams enabled_dawn_features_list_validate_params(0, false, new mojo::internal::ContainerValidateParams(0, false, nullptr));
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
            fragment->enabled_dawn_features_list.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null enabled_dawn_features_list in GpuPreferences struct");
        ...
        mojo::internal::MessageFragment<typename decltype(fragment->disabled_dawn_features_list)::BaseType> disabled_dawn_features_list_fragment(fragment.message());
        const mojo::internal::ContainerValidateParams disabled_dawn_features_list_validate_params(0, false, new mojo::internal::ContainerValidateParams(0, false, nullptr));
        mojo::internal::Serialize<mojo::ArrayDataView<mojo::StringDataView>>(
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
            fragment->disabled_dawn_features_list.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null disabled_dawn_features_list in GpuPreferences struct");
...
inline void GpuPreferencesDataView::GetTextureTargetExceptionListDataView(mojo::ArrayDataView<::gfx::mojom::BufferUsageAndFormatDataView>* output)
{
    auto pointer = data_->texture_target_exception_list.Get();
