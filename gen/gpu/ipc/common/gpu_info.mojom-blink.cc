...
GpuDevice::GpuDevice(uint32_t vendor_id_in, uint32_t device_id_in, uint32_t sub_sys_id_in, uint32_t revision_in, bool active_in, const WTF::String& vendor_string_in,
...
VideoDecodeAcceleratorCapabilities::VideoDecodeAcceleratorCapabilities(WTF::Vector<VideoDecodeAcceleratorSupportedProfilePtr> supported_profiles_in, uint32_t flags_in)
...
ImageDecodeAcceleratorSupportedProfile::ImageDecodeAcceleratorSupportedProfile(ImageDecodeAcceleratorType image_type_in, const ::gfx::Size& min_encoded_dimensions_in,
    const ::gfx::Size& max_encoded_dimensions_in, WTF::Vector<ImageDecodeAcceleratorSubsampling> subsamplings_in)
...
GpuInfo::GpuInfo(::base::TimeDelta initialization_time_in, bool optimus_in, bool amd_switchable_in, GpuDevicePtr gpu_in, WTF::Vector<GpuDevicePtr> secondary_gpus_in,
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
        "<value of type ::gpu::mojom::blink::DxDiagNodePtr>"
#else
        "<value>"
#endif // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
