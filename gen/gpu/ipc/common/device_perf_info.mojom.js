...
(function() {
  ...
  DevicePerfInfo.prototype.initDefaults_ = function() {
    ...
    this.systemCommitLimitMb = 0;
    this.d3d11FeatureLevel = 0;
    this.hasDiscreteGpu = 0;
  };
  ...
  DevicePerfInfo.validate = function(messageValidator, offset) {
    ...
    if (err !== validator.validationError.NONE)
        return err;
    // validate DevicePerfInfo.d3d11FeatureLevel
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 16, Direct3DFeatureLevel);
    if (err !== validator.validationError.NONE)
        return err;
    // validate DevicePerfInfo.hasDiscreteGpu
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 20, HasDiscreteGpu);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  DevicePerfInfo.encodedSize = codec.kStructHeaderSize + 24;
  ...
  DevicePerfInfo.decode = function(decoder) {
    ...
    val.hardwareConcurrency =
        decoder.decodeStruct(codec.Uint32);
    val.systemCommitLimitMb =
        decoder.decodeStruct(codec.Uint32);
    val.d3d11FeatureLevel =
        decoder.decodeStruct(new codec.Enum(Direct3DFeatureLevel));
    val.hasDiscreteGpu =
        decoder.decodeStruct(new codec.Enum(HasDiscreteGpu));
    return val;
  };
  ...
  DevicePerfInfo.encode = function(encoder, val) {
    ...
    encoder.encodeStruct(codec.Uint32, val.systemCommitLimitMb);
    encoder.encodeStruct(codec.Int32, val.d3d11FeatureLevel);
    encoder.encodeStruct(codec.Int32, val.hasDiscreteGpu);
  };
