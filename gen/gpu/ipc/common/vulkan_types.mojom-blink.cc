...
VkLayerProperties::VkLayerProperties(const WTF::String& layerName_in, uint32_t specVersion_in, uint32_t implementationVersion_in, const WTF::String& description_in)
...
VkPhysicalDeviceLimits::VkPhysicalDeviceLimits(uint32_t maxImageDimension1D_in, uint32_t maxImageDimension2D_in, uint32_t maxImageDimension3D_in, uint32_t maxImageDimensionCube_in,
    ...
    float maxSamplerLodBias_in, float maxSamplerAnisotropy_in, uint32_t maxViewports_in, WTF::Vector<uint32_t> maxViewportDimensions_in, WTF::Vector<float> viewportBoundsRange_in,
    ...
    uint32_t maxCombinedClipAndCullDistances_in, uint32_t discreteQueuePriorities_in, WTF::Vector<float> pointSizeRange_in, WTF::Vector<float> lineWidthRange_in,
...
VkQueueFamilyProperties::VkQueueFamilyProperties(uint32_t queueFlags_in, uint32_t queueCount_in, uint32_t timestampValidBits_in, VkExtent3DPtr minImageTransferGranularity_in)
