...
static NOINLINE const char* ContextResultToStringHelper(ContextResult value)
{
...
std::ostream& operator<<(std::ostream& os, ContextResult value) { return os << ContextResultToString(value); }
