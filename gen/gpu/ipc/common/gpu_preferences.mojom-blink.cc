...
GpuPreferences::GpuPreferences(bool disable_accelerated_video_decode_in, bool disable_accelerated_video_encode_in, bool gpu_startup_dialog_in, bool disable_gpu_watchdog_in,
    ...
    WTF::Vector<::gfx::BufferUsageAndFormat> texture_target_exception_list_in, bool ignore_gpu_blocklist_in, bool watchdog_starts_backgrounded_in, GrContextType gr_context_type_in,
    VulkanImplementationName use_vulkan_in, bool enable_vulkan_protected_memory_in, bool disable_vulkan_surface_in, bool disable_vulkan_fallback_to_gl_for_testing_in,
    uint32_t vulkan_heap_memory_limit_in, uint32_t vulkan_sync_cpu_memory_limit_in, bool enable_metal_in, bool enable_gpu_benchmarking_extension_in, bool enable_webgpu_in,
    bool enable_unsafe_webgpu_in, WebGPUAdapterName use_webgpu_adapter_in, DawnBackendValidationLevel enable_dawn_backend_validation_in,
    WTF::Vector<WTF::String> enabled_dawn_features_list_in, WTF::Vector<WTF::String> disabled_dawn_features_list_in, bool enable_gpu_blocked_time_metric_in,
    bool enable_perf_data_collection_in, bool enable_native_gpu_memory_buffers_in)
...
void GpuPreferences::WriteIntoTrace(perfetto::TracedValue traced_context) const
{
    ...
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("enable_media_foundation_vea_on_windows7"), this->enable_media_foundation_vea_on_windows7,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
        "<value of type bool>"
#else
        "<value>"
    ...
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("disable_biplanar_gpu_memory_buffers_for_video_frames"), this->disable_biplanar_gpu_memory_buffers_for_video_frames,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
        "<value of type bool>"
#else
        "<value>"
    ...
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("texture_target_exception_list"), this->texture_target_exception_list,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
        "<value of type const WTF::Vector<::gfx::BufferUsageAndFormat>&>"
#else
        "<value>"
#endif // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
    ...
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("enable_metal"), this->enable_metal,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
        "<value of type bool>"
#else
        "<value>"
    ...
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("enable_gpu_blocked_time_metric"), this->enable_gpu_blocked_time_metric,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
        "<value of type bool>"
#else
        "<value>"
...
bool GpuPreferences::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
} // namespace blink
} // namespace mojom
} // namespace gpu
namespace mojo {
