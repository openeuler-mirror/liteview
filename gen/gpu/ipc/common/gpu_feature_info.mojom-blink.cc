...
void GpuFeatureInfo::WriteIntoTrace(perfetto::TracedValue traced_context) const
{
    ...
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("supported_buffer_formats_for_allocation_and_texturing"), this->supported_buffer_formats_for_allocation_and_texturing,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
bool GpuFeatureInfo::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
} // namespace blink
} // namespace mojom
} // namespace gpu
namespace mojo {
