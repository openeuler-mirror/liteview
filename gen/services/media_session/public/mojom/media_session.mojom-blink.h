...
struct media_session_mojom_internal_MediaPlaybackState_DataHashFn {
    ...
    static bool Equal(const ::media_session::mojom::MediaPlaybackState& left, const ::media_session::mojom::MediaPlaybackState& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::media_session::mojom::MediaPlaybackState> : public GenericHashTraits<::media_session::mojom::MediaPlaybackState> {
    ...
    static void ConstructDeletedValue(::media_session::mojom::MediaPlaybackState& slot, bool) { slot = static_cast<::media_session::mojom::MediaPlaybackState>(-1000001); }
    static bool IsDeletedValue(const ::media_session::mojom::MediaPlaybackState& value) { return value == static_cast<::media_session::mojom::MediaPlaybackState>(-1000001); }
};
} // namespace WTF
namespace WTF {
struct media_session_mojom_internal_MediaSessionAction_DataHashFn {
    ...
    static bool Equal(const ::media_session::mojom::MediaSessionAction& left, const ::media_session::mojom::MediaSessionAction& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::media_session::mojom::MediaSessionAction> : public GenericHashTraits<::media_session::mojom::MediaSessionAction> {
    static_assert(true, "-1000000 is a reserved enum value");
    static_assert(true, "-1000001 is a reserved enum value");
    static const bool kEmptyValueIsZero = false;
    ...
    static void ConstructDeletedValue(::media_session::mojom::MediaSessionAction& slot, bool) { slot = static_cast<::media_session::mojom::MediaSessionAction>(-1000001); }
    static bool IsDeletedValue(const ::media_session::mojom::MediaSessionAction& value) { return value == static_cast<::media_session::mojom::MediaSessionAction>(-1000001); }
};
} // namespace WTF
namespace WTF {
struct media_session_mojom_internal_MediaSessionImageType_DataHashFn {
    ...
    static bool Equal(const ::media_session::mojom::MediaSessionImageType& left, const ::media_session::mojom::MediaSessionImageType& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::media_session::mojom::MediaSessionImageType> : public GenericHashTraits<::media_session::mojom::MediaSessionImageType> {
    static_assert(true, "-1000000 is a reserved enum value");
    static_assert(true, "-1000001 is a reserved enum value");
    static const bool kEmptyValueIsZero = false;
    ...
    static void ConstructDeletedValue(::media_session::mojom::MediaSessionImageType& slot, bool) { slot = static_cast<::media_session::mojom::MediaSessionImageType>(-1000001); }
    static bool IsDeletedValue(const ::media_session::mojom::MediaSessionImageType& value) { return value == static_cast<::media_session::mojom::MediaSessionImageType>(-1000001); }
};
} // namespace WTF
namespace WTF {
struct media_session_mojom_internal_MediaPictureInPictureState_DataHashFn {
    ...
    static bool Equal(const ::media_session::mojom::MediaPictureInPictureState& left, const ::media_session::mojom::MediaPictureInPictureState& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::media_session::mojom::MediaPictureInPictureState> : public GenericHashTraits<::media_session::mojom::MediaPictureInPictureState> {
    static_assert(true, "-1000000 is a reserved enum value");
    static_assert(true, "-1000001 is a reserved enum value");
    static const bool kEmptyValueIsZero = false;
...
struct media_session_mojom_internal_MediaAudioVideoState_DataHashFn {
    ...
    static bool Equal(const ::media_session::mojom::MediaAudioVideoState& left, const ::media_session::mojom::MediaAudioVideoState& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::media_session::mojom::MediaAudioVideoState> : public GenericHashTraits<::media_session::mojom::MediaAudioVideoState> {
    static_assert(true, "-1000000 is a reserved enum value");
    static_assert(true, "-1000001 is a reserved enum value");
    static const bool kEmptyValueIsZero = false;
    ...
    static void ConstructDeletedValue(::media_session::mojom::MediaAudioVideoState& slot, bool) { slot = static_cast<::media_session::mojom::MediaAudioVideoState>(-1000001); }
    static bool IsDeletedValue(const ::media_session::mojom::MediaAudioVideoState& value) { return value == static_cast<::media_session::mojom::MediaAudioVideoState>(-1000001); }
};
} // namespace WTF
namespace WTF {
struct media_session_mojom_internal_MediaImageBitmapColorType_DataHashFn {
    ...
    static bool Equal(const ::media_session::mojom::MediaImageBitmapColorType& left, const ::media_session::mojom::MediaImageBitmapColorType& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::media_session::mojom::MediaImageBitmapColorType> : public GenericHashTraits<::media_session::mojom::MediaImageBitmapColorType> {
    static_assert(true, "-1000000 is a reserved enum value");
    static_assert(true, "-1000001 is a reserved enum value");
    static const bool kEmptyValueIsZero = false;
...
struct media_session_mojom_internal_MicrophoneState_DataHashFn {
    ...
    static bool Equal(const ::media_session::mojom::MicrophoneState& left, const ::media_session::mojom::MicrophoneState& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::media_session::mojom::MicrophoneState> : public GenericHashTraits<::media_session::mojom::MicrophoneState> {
    static_assert(true, "-1000000 is a reserved enum value");
    static_assert(true, "-1000001 is a reserved enum value");
    static const bool kEmptyValueIsZero = false;
    static ::media_session::mojom::MicrophoneState EmptyValue() { return static_cast<::media_session::mojom::MicrophoneState>(-1000000); }
    static void ConstructDeletedValue(::media_session::mojom::MicrophoneState& slot, bool) { slot = static_cast<::media_session::mojom::MicrophoneState>(-1000001); }
    static bool IsDeletedValue(const ::media_session::mojom::MicrophoneState& value) { return value == static_cast<::media_session::mojom::MicrophoneState>(-1000001); }
};
} // namespace WTF
namespace WTF {
struct media_session_mojom_internal_CameraState_DataHashFn {
    ...
    static bool Equal(const ::media_session::mojom::CameraState& left, const ::media_session::mojom::CameraState& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::media_session::mojom::CameraState> : public GenericHashTraits<::media_session::mojom::CameraState> {
    static_assert(true, "-1000000 is a reserved enum value");
    static_assert(true, "-1000001 is a reserved enum value");
    static const bool kEmptyValueIsZero = false;
    static ::media_session::mojom::CameraState EmptyValue() { return static_cast<::media_session::mojom::CameraState>(-1000000); }
    static void ConstructDeletedValue(::media_session::mojom::CameraState& slot, bool) { slot = static_cast<::media_session::mojom::CameraState>(-1000001); }
    static bool IsDeletedValue(const ::media_session::mojom::CameraState& value) { return value == static_cast<::media_session::mojom::CameraState>(-1000001); }
};
} // namespace WTF
namespace WTF {
...
template <> struct HashTraits<::media_session::mojom::MediaSessionInfo_SessionState> : public GenericHashTraits<::media_session::mojom::MediaSessionInfo_SessionState> {
    static_assert(true, "-1000000 is a reserved enum value");
    static_assert(true, "-1000001 is a reserved enum value");
    static const bool kEmptyValueIsZero = false;
...
struct media_session_mojom_internal_MediaSession_SuspendType_DataHashFn {
    ...
    static bool Equal(const ::media_session::mojom::MediaSession_SuspendType& left, const ::media_session::mojom::MediaSession_SuspendType& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::media_session::mojom::MediaSession_SuspendType> : public GenericHashTraits<::media_session::mojom::MediaSession_SuspendType> {
    static_assert(true, "-1000000 is a reserved enum value");
    static_assert(true, "-1000001 is a reserved enum value");
    static const bool kEmptyValueIsZero = false;
...
public:
    ...
    template <typename... Args> static RemotePlaybackMetadataPtr New(Args&&... args) { return RemotePlaybackMetadataPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static RemotePlaybackMetadataPtr From(const U& u) { return mojo::TypeConverter<RemotePlaybackMetadataPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, RemotePlaybackMetadata>::Convert(*this); }
    ...
    template <typename T, RemotePlaybackMetadata::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    ...
    {
        return mojo::Message(std::make_unique<internal::RemotePlaybackMetadata_UnserializedMessageContext<UserType, RemotePlaybackMetadata::DataView>>(0, 0, std::move(input)),
    ...
    {
        return RemotePlaybackMetadata::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, RemotePlaybackMetadata::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, RemotePlaybackMetadata::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, RemotePlaybackMetadata::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static MediaSessionDebugInfoPtr New(Args&&... args) { return MediaSessionDebugInfoPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static MediaSessionDebugInfoPtr From(const U& u) { return mojo::TypeConverter<MediaSessionDebugInfoPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, MediaSessionDebugInfo>::Convert(*this); }
    ...
    template <typename T, MediaSessionDebugInfo::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    size_t Hash(size_t seed) const;
    template <typename UserType> static WTF::Vector<uint8_t> Serialize(UserType* input)
    {
    ...
    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<MediaSessionDebugInfo::DataView>(input); }
    ...
    template <typename UserType> static mojo::Message WrapAsMessage(UserType input)
    {
        return mojo::Message(std::make_unique<internal::MediaSessionDebugInfo_UnserializedMessageContext<UserType, MediaSessionDebugInfo::DataView>>(0, 0, std::move(input)),
            MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const WTF::Vector<uint8_t>& input, UserType* output)
    {
        return MediaSessionDebugInfo::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, MediaSessionDebugInfo::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, MediaSessionDebugInfo::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, MediaSessionDebugInfo::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static MediaImagePtr New(Args&&... args) { return MediaImagePtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static MediaImagePtr From(const U& u) { return mojo::TypeConverter<MediaImagePtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, MediaImage>::Convert(*this); }
    MediaImage()
        : src()
        , type()
        , sizes()
    ...
    template <typename T, MediaImage::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static WTF::Vector<uint8_t> Serialize(UserType* input) { return mojo::internal::SerializeImpl<MediaImage::DataView, WTF::Vector<uint8_t>>(input); }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<MediaImage::DataView>(input); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::MediaImage_UnserializedMessageContext<UserType, MediaImage::DataView>>(0, 0, std::move(input)), MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const WTF::Vector<uint8_t>& input, UserType* output)
    {
        return MediaImage::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, MediaImage::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, MediaImage::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, MediaImage::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static MediaMetadataPtr New(Args&&... args) { return MediaMetadataPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static MediaMetadataPtr From(const U& u) { return mojo::TypeConverter<MediaMetadataPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, MediaMetadata>::Convert(*this); }
    MediaMetadata()
        : title()
        , artist()
        , album()
    ...
    template <typename T, MediaMetadata::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static WTF::Vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<MediaMetadata::DataView, WTF::Vector<uint8_t>>(input);
    }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<MediaMetadata::DataView>(input); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::MediaMetadata_UnserializedMessageContext<UserType, MediaMetadata::DataView>>(0, 0, std::move(input)), MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const WTF::Vector<uint8_t>& input, UserType* output)
    {
        return MediaMetadata::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, MediaMetadata::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, MediaMetadata::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, MediaMetadata::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static MediaImageBitmapPtr New(Args&&... args) { return MediaImageBitmapPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static MediaImageBitmapPtr From(const U& u) { return mojo::TypeConverter<MediaImageBitmapPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, MediaImageBitmap>::Convert(*this); }
    MediaImageBitmap()
        : width()
        , height()
        , pixel_data()
    ...
    template <typename T, MediaImageBitmap::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static WTF::Vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<MediaImageBitmap::DataView, WTF::Vector<uint8_t>>(input);
    }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<MediaImageBitmap::DataView>(input); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::MediaImageBitmap_UnserializedMessageContext<UserType, MediaImageBitmap::DataView>>(0, 0, std::move(input)), MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const WTF::Vector<uint8_t>& input, UserType* output)
    {
        return MediaImageBitmap::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, MediaImageBitmap::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, MediaImageBitmap::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, MediaImageBitmap::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static MediaPositionPtr New(Args&&... args) { return MediaPositionPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static MediaPositionPtr From(const U& u) { return mojo::TypeConverter<MediaPositionPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, MediaPosition>::Convert(*this); }
    MediaPosition()
        : playback_rate()
        , duration()
        , position()
    ...
    template <typename T, MediaPosition::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static WTF::Vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<MediaPosition::DataView, WTF::Vector<uint8_t>>(input);
    }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<MediaPosition::DataView>(input); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::MediaPosition_UnserializedMessageContext<UserType, MediaPosition::DataView>>(0, 0, std::move(input)), MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const WTF::Vector<uint8_t>& input, UserType* output)
    {
        return MediaPosition::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, MediaPosition::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, MediaPosition::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, MediaPosition::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static MediaSessionInfoPtr New(Args&&... args) { return MediaSessionInfoPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static MediaSessionInfoPtr From(const U& u) { return mojo::TypeConverter<MediaSessionInfoPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, MediaSessionInfo>::Convert(*this); }
    MediaSessionInfo()
        : state()
        , force_duck()
        , playback_state()
    ...
    MediaSessionInfo(MediaSessionInfo::SessionState state, bool force_duck, MediaPlaybackState playback_state, bool is_controllable, bool prefer_stop_for_gain_focus_loss);

    MediaSessionInfo(
        MediaSessionInfo::SessionState state, bool force_duck, MediaPlaybackState playback_state, bool is_controllable, bool prefer_stop_for_gain_focus_loss, bool is_sensitive);

    MediaSessionInfo(MediaSessionInfo::SessionState state, bool force_duck, MediaPlaybackState playback_state, bool is_controllable, bool prefer_stop_for_gain_focus_loss,
        bool is_sensitive, MediaPictureInPictureState picture_in_picture_state);

    MediaSessionInfo(MediaSessionInfo::SessionState state, bool force_duck, MediaPlaybackState playback_state, bool is_controllable, bool prefer_stop_for_gain_focus_loss,
        bool is_sensitive, MediaPictureInPictureState picture_in_picture_state, MediaAudioVideoState deprecated_audio_video_state);

    MediaSessionInfo(MediaSessionInfo::SessionState state, bool force_duck, MediaPlaybackState playback_state, bool is_controllable, bool prefer_stop_for_gain_focus_loss,
        bool is_sensitive, MediaPictureInPictureState picture_in_picture_state, MediaAudioVideoState deprecated_audio_video_state, const WTF::String& audio_sink_id);
    ...
    MediaSessionInfo(MediaSessionInfo::SessionState state, bool force_duck, MediaPlaybackState playback_state, bool is_controllable, bool prefer_stop_for_gain_focus_loss,
        bool is_sensitive, MediaPictureInPictureState picture_in_picture_state, MediaAudioVideoState deprecated_audio_video_state, const WTF::String& audio_sink_id,
        absl::optional<WTF::Vector<MediaAudioVideoState>> audio_video_states, MicrophoneState microphone_state, CameraState camera_state);

    MediaSessionInfo(MediaSessionInfo::SessionState state, bool force_duck, MediaPlaybackState playback_state, bool is_controllable, bool prefer_stop_for_gain_focus_loss,
        bool is_sensitive, MediaPictureInPictureState picture_in_picture_state, MediaAudioVideoState deprecated_audio_video_state, const WTF::String& audio_sink_id,
        absl::optional<WTF::Vector<MediaAudioVideoState>> audio_video_states, MicrophoneState microphone_state, CameraState camera_state, bool muted);

    MediaSessionInfo(MediaSessionInfo::SessionState state, bool force_duck, MediaPlaybackState playback_state, bool is_controllable, bool prefer_stop_for_gain_focus_loss,
        bool is_sensitive, MediaPictureInPictureState picture_in_picture_state, MediaAudioVideoState deprecated_audio_video_state, const WTF::String& audio_sink_id,
        absl::optional<WTF::Vector<MediaAudioVideoState>> audio_video_states, MicrophoneState microphone_state, CameraState camera_state, bool muted, bool has_presentation);
    ...
    template <typename T, MediaSessionInfo::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static WTF::Vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<MediaSessionInfo::DataView, WTF::Vector<uint8_t>>(input);
    }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<MediaSessionInfo::DataView>(input); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::MediaSessionInfo_UnserializedMessageContext<UserType, MediaSessionInfo::DataView>>(0, 0, std::move(input)), MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const WTF::Vector<uint8_t>& input, UserType* output)
    {
        return MediaSessionInfo::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, MediaSessionInfo::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, MediaSessionInfo::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, MediaSessionInfo::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
template <typename StructPtrType> MediaImagePtr MediaImage::Clone() const { return New(mojo::Clone(src), mojo::Clone(type), mojo::Clone(sizes)); }
...
{
    return New(mojo::Clone(title), mojo::Clone(artist), mojo::Clone(album), mojo::Clone(source_title));
}
...
{
    return New(mojo::Clone(video_codec), mojo::Clone(audio_codec), mojo::Clone(remote_playback_disabled));
}
...
{
    return New(mojo::Clone(state), mojo::Clone(force_duck), mojo::Clone(playback_state), mojo::Clone(is_controllable), mojo::Clone(prefer_stop_for_gain_focus_loss),
        mojo::Clone(is_sensitive), mojo::Clone(picture_in_picture_state), mojo::Clone(deprecated_audio_video_state), mojo::Clone(audio_sink_id), mojo::Clone(audio_video_states),
        mojo::Clone(microphone_state), mojo::Clone(camera_state), mojo::Clone(muted), mojo::Clone(has_presentation), mojo::Clone(remote_playback_metadata));
}
...
template <typename StructPtrType> MediaSessionDebugInfoPtr MediaSessionDebugInfo::Clone() const { return New(mojo::Clone(name), mojo::Clone(owner), mojo::Clone(state)); }
...
template <> struct BLINK_PLATFORM_EXPORT StructTraits<::media_session::mojom::blink::MediaImage::DataView, ::media_session::mojom::blink::MediaImagePtr> {
    ...
    static const decltype(::media_session::mojom::blink::MediaImage::src)& src(const ::media_session::mojom::blink::MediaImagePtr& input) { return input->src; }

    static const decltype(::media_session::mojom::blink::MediaImage::type)& type(const ::media_session::mojom::blink::MediaImagePtr& input) { return input->type; }

    static const decltype(::media_session::mojom::blink::MediaImage::sizes)& sizes(const ::media_session::mojom::blink::MediaImagePtr& input) { return input->sizes; }
...
template <> struct BLINK_PLATFORM_EXPORT StructTraits<::media_session::mojom::blink::MediaMetadata::DataView, ::media_session::mojom::blink::MediaMetadataPtr> {
    ...
    static const decltype(::media_session::mojom::blink::MediaMetadata::title)& title(const ::media_session::mojom::blink::MediaMetadataPtr& input) { return input->title; }

    static const decltype(::media_session::mojom::blink::MediaMetadata::artist)& artist(const ::media_session::mojom::blink::MediaMetadataPtr& input) { return input->artist; }

    static const decltype(::media_session::mojom::blink::MediaMetadata::album)& album(const ::media_session::mojom::blink::MediaMetadataPtr& input) { return input->album; }

    static const decltype(::media_session::mojom::blink::MediaMetadata::source_title)& source_title(const ::media_session::mojom::blink::MediaMetadataPtr& input)
    {
...
template <> struct BLINK_PLATFORM_EXPORT StructTraits<::media_session::mojom::blink::MediaImageBitmap::DataView, ::media_session::mojom::blink::MediaImageBitmapPtr> {
    ...
    static decltype(::media_session::mojom::blink::MediaImageBitmap::width) width(const ::media_session::mojom::blink::MediaImageBitmapPtr& input) { return input->width; }

    static decltype(::media_session::mojom::blink::MediaImageBitmap::height) height(const ::media_session::mojom::blink::MediaImageBitmapPtr& input) { return input->height; }

    static const decltype(::media_session::mojom::blink::MediaImageBitmap::pixel_data)& pixel_data(const ::media_session::mojom::blink::MediaImageBitmapPtr& input)
    {
...
template <> struct BLINK_PLATFORM_EXPORT StructTraits<::media_session::mojom::blink::MediaPosition::DataView, ::media_session::mojom::blink::MediaPositionPtr> {
    ...
    static const decltype(::media_session::mojom::blink::MediaPosition::last_updated_time)& last_updated_time(const ::media_session::mojom::blink::MediaPositionPtr& input)
    {
...
template <> struct BLINK_PLATFORM_EXPORT StructTraits<::media_session::mojom::blink::RemotePlaybackMetadata::DataView, ::media_session::mojom::blink::RemotePlaybackMetadataPtr> {
    ...
    static const decltype(::media_session::mojom::blink::RemotePlaybackMetadata::video_codec)& video_codec(const ::media_session::mojom::blink::RemotePlaybackMetadataPtr& input)
    {
        return input->video_codec;
    }

    static const decltype(::media_session::mojom::blink::RemotePlaybackMetadata::audio_codec)& audio_codec(const ::media_session::mojom::blink::RemotePlaybackMetadataPtr& input)
    {
...
template <> struct BLINK_PLATFORM_EXPORT StructTraits<::media_session::mojom::blink::MediaSessionInfo::DataView, ::media_session::mojom::blink::MediaSessionInfoPtr> {
    ...
    static decltype(::media_session::mojom::blink::MediaSessionInfo::state) state(const ::media_session::mojom::blink::MediaSessionInfoPtr& input) { return input->state; }
    ...
    static decltype(::media_session::mojom::blink::MediaSessionInfo::playback_state) playback_state(const ::media_session::mojom::blink::MediaSessionInfoPtr& input)
    {
        return input->playback_state;
    }

    static decltype(::media_session::mojom::blink::MediaSessionInfo::is_controllable) is_controllable(const ::media_session::mojom::blink::MediaSessionInfoPtr& input)
    {
    ...
    static decltype(::media_session::mojom::blink::MediaSessionInfo::is_sensitive) is_sensitive(const ::media_session::mojom::blink::MediaSessionInfoPtr& input)
    {
    ...
    static const decltype(::media_session::mojom::blink::MediaSessionInfo::audio_sink_id)& audio_sink_id(const ::media_session::mojom::blink::MediaSessionInfoPtr& input)
    {
        return input->audio_sink_id;
    }

    static const decltype(::media_session::mojom::blink::MediaSessionInfo::audio_video_states)& audio_video_states(const ::media_session::mojom::blink::MediaSessionInfoPtr& input)
    {
        return input->audio_video_states;
    }

    static decltype(::media_session::mojom::blink::MediaSessionInfo::microphone_state) microphone_state(const ::media_session::mojom::blink::MediaSessionInfoPtr& input)
    {
    ...
    static decltype(::media_session::mojom::blink::MediaSessionInfo::muted) muted(const ::media_session::mojom::blink::MediaSessionInfoPtr& input) { return input->muted; }

    static decltype(::media_session::mojom::blink::MediaSessionInfo::has_presentation) has_presentation(const ::media_session::mojom::blink::MediaSessionInfoPtr& input)
    {
...
template <> struct BLINK_PLATFORM_EXPORT StructTraits<::media_session::mojom::blink::MediaSessionDebugInfo::DataView, ::media_session::mojom::blink::MediaSessionDebugInfoPtr> {
    ...
    static const decltype(::media_session::mojom::blink::MediaSessionDebugInfo::name)& name(const ::media_session::mojom::blink::MediaSessionDebugInfoPtr& input)
    {
        return input->name;
    }

    static const decltype(::media_session::mojom::blink::MediaSessionDebugInfo::owner)& owner(const ::media_session::mojom::blink::MediaSessionDebugInfoPtr& input)
    {
        return input->owner;
    }

    static const decltype(::media_session::mojom::blink::MediaSessionDebugInfo::state)& state(const ::media_session::mojom::blink::MediaSessionDebugInfoPtr& input)
    {
        return input->state;
    }
