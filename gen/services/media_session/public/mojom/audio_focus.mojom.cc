...
AudioFocusRequestState::AudioFocusRequestState(
    ::media_session::mojom::MediaSessionInfoPtr session_info_in, AudioFocusType audio_focus_type_in, const absl::optional<std::string>& source_name_in)
    : session_info(std::move(session_info_in))
    , audio_focus_type(std::move(audio_focus_type_in))
...
AudioFocusRequestState::AudioFocusRequestState(::media_session::mojom::MediaSessionInfoPtr session_info_in, AudioFocusType audio_focus_type_in,
    const absl::optional<std::string>& source_name_in, const absl::optional<::base::UnguessableToken>& request_id_in)
    : session_info(std::move(session_info_in))
    , audio_focus_type(std::move(audio_focus_type_in))
    , source_name(std::move(source_name_in))
...
bool AudioFocusRequestState::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
void AudioFocusObserverProxy::OnFocusGained(AudioFocusRequestStatePtr in_state)
{
    ...
    mojo::Message message(internal::kAudioFocusObserver_OnFocusGained_Name, kFlags, 0, 0, nullptr);
...
void AudioFocusObserverProxy::OnFocusLost(AudioFocusRequestStatePtr in_state)
{
    ...
    mojo::Message message(internal::kAudioFocusObserver_OnFocusLost_Name, kFlags, 0, 0, nullptr);
...
void AudioFocusObserverProxy::OnRequestIdReleased(const ::base::UnguessableToken& in_request_id)
{
    ...
    mojo::Message message(internal::kAudioFocusObserver_OnRequestIdReleased_Name, kFlags, 0, 0, nullptr);
    ...
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
        params->request_id.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null request_id in AudioFocusObserver.OnRequestIdReleased request");
...
bool AudioFocusObserverStubDispatch::Accept(AudioFocusObserver* impl, mojo::Message* message)
{
    ...
    case internal::kAudioFocusObserver_OnFocusGained_Name: {
        ...
        internal::AudioFocusObserver_OnFocusGained_Params_Data* params = reinterpret_cast<internal::AudioFocusObserver_OnFocusGained_Params_Data*>(message->mutable_payload());

        bool success = true;
        AudioFocusRequestStatePtr p_state = mojo::DefaultConstructTraits::CreateInstance<AudioFocusRequestStatePtr>();
    ...
    case internal::kAudioFocusObserver_OnFocusLost_Name: {
        ...
        DCHECK(message->is_serialized());
        internal::AudioFocusObserver_OnFocusLost_Params_Data* params = reinterpret_cast<internal::AudioFocusObserver_OnFocusLost_Params_Data*>(message->mutable_payload());
...
// static
bool AudioFocusObserverStubDispatch::AcceptWithResponder(AudioFocusObserver* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
{
...
void AudioFocusRequestClientProxy::RequestAudioFocus(::media_session::mojom::MediaSessionInfoPtr in_session_info, AudioFocusType in_type, RequestAudioFocusCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send media_session::mojom::AudioFocusRequestClient::RequestAudioFocus", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("session_info"), in_session_info, "<value of type ::media_session::mojom::MediaSessionInfoPtr>");
    ...
    mojo::Message message(internal::kAudioFocusRequestClient_RequestAudioFocus_Name, kFlags, 0, 0, nullptr);
    ...
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
        params->session_info.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null session_info in AudioFocusRequestClient.RequestAudioFocus request");
...
void AudioFocusRequestClientProxy::AbandonAudioFocus()
{
    ...
    mojo::Message message(internal::kAudioFocusRequestClient_AbandonAudioFocus_Name, kFlags, 0, 0, nullptr);
...
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send media_session::mojom::AudioFocusRequestClient::MediaSessionInfoChanged", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("session_info"), in_session_info, "<value of type ::media_session::mojom::MediaSessionInfoPtr>");
    });
#endif
    ...
    mojo::Message message(internal::kAudioFocusRequestClient_MediaSessionInfoChanged_Name, kFlags, 0, 0, nullptr);
    ...
    params->session_info.Set(session_info_fragment.is_null() ? nullptr : session_info_fragment.data());
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
        params->session_info.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null session_info in AudioFocusRequestClient.MediaSessionInfoChanged request");
...
public:
    static AudioFocusRequestClient::RequestAudioFocusCallback CreateCallback(::mojo::Message& message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
    {
...
bool AudioFocusRequestClientStubDispatch::Accept(AudioFocusRequestClient* impl, mojo::Message* message)
{
    ...
    case internal::kAudioFocusRequestClient_MediaSessionInfoChanged_Name: {
        ...
        bool success = true;
        ::media_session::mojom::MediaSessionInfoPtr p_session_info = mojo::DefaultConstructTraits::CreateInstance<::media_session::mojom::MediaSessionInfoPtr>();
...
// static
bool AudioFocusRequestClientStubDispatch::AcceptWithResponder(AudioFocusRequestClient* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
{
    [[maybe_unused]] const bool message_is_sync = message->has_flag(mojo::Message::kFlagIsSync);
    [[maybe_unused]] const uint64_t request_id = message->request_id();
    switch (message->header()->name) {
    case internal::kAudioFocusRequestClient_RequestAudioFocus_Name: {
        ...
        bool success = true;
        ::media_session::mojom::MediaSessionInfoPtr p_session_info = mojo::DefaultConstructTraits::CreateInstance<::media_session::mojom::MediaSessionInfoPtr>();
        AudioFocusType p_type = mojo::DefaultConstructTraits::CreateInstance<AudioFocusType>();
        ...
        AudioFocusRequestClient::RequestAudioFocusCallback callback = AudioFocusRequestClient_RequestAudioFocus_ProxyToResponder::CreateCallback(*message, std::move(responder));
        // A null |impl| means no implementation was bound.
        DCHECK(impl);
...
static const mojo::internal::GenericValidationInfo kAudioFocusRequestClientValidationInfo[] = {
    { &internal::AudioFocusRequestClient_RequestAudioFocus_Params_Data::Validate, &internal::AudioFocusRequestClient_RequestAudioFocus_ResponseParams_Data::Validate },
...
void AudioFocusManagerProxy::RequestAudioFocus(::mojo::PendingReceiver<AudioFocusRequestClient> in_client, ::mojo::PendingRemote<::media_session::mojom::MediaSession> in_session,
    ::media_session::mojom::MediaSessionInfoPtr in_session_info, AudioFocusType in_type, RequestAudioFocusCallback callback)
{
    ...
    TRACE_EVENT1("mojom", "Send media_session::mojom::AudioFocusManager::RequestAudioFocus", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("session"), in_session, "<value of type ::mojo::PendingRemote<::media_session::mojom::MediaSession>>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("session_info"), in_session_info, "<value of type ::media_session::mojom::MediaSessionInfoPtr>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("type"), in_type, "<value of type AudioFocusType>");
    });
#endif
    ...
    mojo::Message message(internal::kAudioFocusManager_RequestAudioFocus_Name, kFlags, 0, 0, nullptr);
    ...
    params.Allocate();
    mojo::internal::Serialize<mojo::InterfaceRequestDataView<::media_session::mojom::AudioFocusRequestClientInterfaceBase>>(in_client, &params->client, &params.message());
    ...
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(!mojo::internal::IsHandleOrInterfaceValid(params->session), mojo::internal::VALIDATION_ERROR_UNEXPECTED_INVALID_HANDLE,
        "invalid session in AudioFocusManager.RequestAudioFocus request");
    mojo::internal::MessageFragment<typename decltype(params->session_info)::BaseType> session_info_fragment(params.message());
    mojo::internal::Serialize<::media_session::mojom::MediaSessionInfoDataView>(in_session_info, session_info_fragment);
    params->session_info.Set(session_info_fragment.is_null() ? nullptr : session_info_fragment.data());
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
        params->session_info.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null session_info in AudioFocusManager.RequestAudioFocus request");
    mojo::internal::Serialize<::media_session::mojom::AudioFocusType>(in_type, &params->type);
    ...
    const ::base::UnguessableToken& in_group_id, RequestGroupedAudioFocusCallback callback)
{
    ...
    mojo::Message message(internal::kAudioFocusManager_RequestGroupedAudioFocus_Name, kFlags, 0, 0, nullptr);
    ...
    params->request_id.Set(request_id_fragment.is_null() ? nullptr : request_id_fragment.data());
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
        params->request_id.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null request_id in AudioFocusManager.RequestGroupedAudioFocus request");
    mojo::internal::Serialize<mojo::InterfaceRequestDataView<::media_session::mojom::AudioFocusRequestClientInterfaceBase>>(in_client, &params->client, &params.message());
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(!mojo::internal::IsHandleOrInterfaceValid(params->client), mojo::internal::VALIDATION_ERROR_UNEXPECTED_INVALID_HANDLE,
    ...
    params->session_info.Set(session_info_fragment.is_null() ? nullptr : session_info_fragment.data());
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
        params->session_info.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null session_info in AudioFocusManager.RequestGroupedAudioFocus request");
    mojo::internal::Serialize<::media_session::mojom::AudioFocusType>(in_type, &params->type);
    ...
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
        params->group_id.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null group_id in AudioFocusManager.RequestGroupedAudioFocus request");
...
void AudioFocusManagerProxy::GetFocusRequests(GetFocusRequestsCallback callback)
{
    ...
    mojo::Message message(internal::kAudioFocusManager_GetFocusRequests_Name, kFlags, 0, 0, nullptr);
...
void AudioFocusManagerProxy::AddObserver(::mojo::PendingRemote<AudioFocusObserver> in_observer)
{
    ...
    mojo::Message message(internal::kAudioFocusManager_AddObserver_Name, kFlags, 0, 0, nullptr);
    mojo::internal::MessageFragment<::media_session::mojom::internal::AudioFocusManager_AddObserver_Params_Data> params(message);
    params.Allocate();
    mojo::internal::Serialize<mojo::InterfacePtrDataView<::media_session::mojom::AudioFocusObserverInterfaceBase>>(in_observer, &params->observer, &params.message());
...
void AudioFocusManagerProxy::SetSource(const ::base::UnguessableToken& in_identity, const std::string& in_name)
{
    ...
    mojo::Message message(internal::kAudioFocusManager_SetSource_Name, kFlags, 0, 0, nullptr);
    ...
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(params->name.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null name in AudioFocusManager.SetSource request");
...
void AudioFocusManagerProxy::SetEnforcementMode(EnforcementMode in_mode)
{
    ...
    mojo::Message message(internal::kAudioFocusManager_SetEnforcementMode_Name, kFlags, 0, 0, nullptr);
...
void AudioFocusManagerProxy::AddSourceObserver(const ::base::UnguessableToken& in_source_id, ::mojo::PendingRemote<AudioFocusObserver> in_observer)
{
    ...
    mojo::Message message(internal::kAudioFocusManager_AddSourceObserver_Name, kFlags, 0, 0, nullptr);
...
void AudioFocusManagerProxy::GetSourceFocusRequests(const ::base::UnguessableToken& in_source_id, GetSourceFocusRequestsCallback callback)
{
    ...
    mojo::Message message(internal::kAudioFocusManager_GetSourceFocusRequests_Name, kFlags, 0, 0, nullptr);
    ...
    params->source_id.Set(source_id_fragment.is_null() ? nullptr : source_id_fragment.data());
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
        params->source_id.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null source_id in AudioFocusManager.GetSourceFocusRequests request");
...
void AudioFocusManagerProxy::RequestIdReleased(const ::base::UnguessableToken& in_request_id)
{
    ...
    mojo::Message message(internal::kAudioFocusManager_RequestIdReleased_Name, kFlags, 0, 0, nullptr);
    ...
    params->request_id.Set(request_id_fragment.is_null() ? nullptr : request_id_fragment.data());
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
        params->request_id.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null request_id in AudioFocusManager.RequestIdReleased request");
...
public:
    ...
    {
        std::unique_ptr<AudioFocusManager_RequestAudioFocus_ProxyToResponder> proxy(new AudioFocusManager_RequestAudioFocus_ProxyToResponder(message, std::move(responder)));
...
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send reply media_session::mojom::AudioFocusManager::RequestAudioFocus", "async_response_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("request_id"), in_request_id, "<value of type const ::base::UnguessableToken&>");
    });
#endif
...
public:
    static AudioFocusManager::RequestGroupedAudioFocusCallback CreateCallback(::mojo::Message& message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
    {
...
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send reply media_session::mojom::AudioFocusManager::RequestGroupedAudioFocus", "async_response_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
...
public:
    ...
    {
        std::unique_ptr<AudioFocusManager_GetFocusRequests_ProxyToResponder> proxy(new AudioFocusManager_GetFocusRequests_ProxyToResponder(message, std::move(responder)));
...
bool AudioFocusManager_GetFocusRequests_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    bool success = true;
    std::vector<AudioFocusRequestStatePtr> p_requests = mojo::DefaultConstructTraits::CreateInstance<std::vector<AudioFocusRequestStatePtr>>();
...
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send reply media_session::mojom::AudioFocusManager::GetFocusRequests", "async_response_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
    ...
    mojo::internal::Serialize<mojo::ArrayDataView<::media_session::mojom::AudioFocusRequestStateDataView>>(in_requests, requests_fragment, &requests_validate_params);
...
public:
    static AudioFocusManager::GetSourceFocusRequestsCallback CreateCallback(::mojo::Message& message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
    {
...
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send reply media_session::mojom::AudioFocusManager::GetSourceFocusRequests", "async_response_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("requests"), in_requests, "<value of type std::vector<AudioFocusRequestStatePtr>>");
    });
#endif
...
bool AudioFocusManagerStubDispatch::Accept(AudioFocusManager* impl, mojo::Message* message)
{
    ...
    case internal::kAudioFocusManager_AddObserver_Name: {
        ...
        DCHECK(message->is_serialized());
        internal::AudioFocusManager_AddObserver_Params_Data* params = reinterpret_cast<internal::AudioFocusManager_AddObserver_Params_Data*>(message->mutable_payload());

        bool success = true;
        ::mojo::PendingRemote<AudioFocusObserver> p_observer = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingRemote<AudioFocusObserver>>();
    ...
    case internal::kAudioFocusManager_SetSource_Name: {
        ...
        DCHECK(message->is_serialized());
        internal::AudioFocusManager_SetSource_Params_Data* params = reinterpret_cast<internal::AudioFocusManager_SetSource_Params_Data*>(message->mutable_payload());

        bool success = true;
        ::base::UnguessableToken p_identity = mojo::DefaultConstructTraits::CreateInstance<::base::UnguessableToken>();
    ...
    case internal::kAudioFocusManager_SetEnforcementMode_Name: {
        ...
        bool success = true;
        EnforcementMode p_mode = mojo::DefaultConstructTraits::CreateInstance<EnforcementMode>();
    ...
    case internal::kAudioFocusManager_AddSourceObserver_Name: {
        ...
        bool success = true;
        ::base::UnguessableToken p_source_id = mojo::DefaultConstructTraits::CreateInstance<::base::UnguessableToken>();
        ::mojo::PendingRemote<AudioFocusObserver> p_observer = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingRemote<AudioFocusObserver>>();
...
// static
bool AudioFocusManagerStubDispatch::AcceptWithResponder(AudioFocusManager* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
{
    [[maybe_unused]] const bool message_is_sync = message->has_flag(mojo::Message::kFlagIsSync);
    [[maybe_unused]] const uint64_t request_id = message->request_id();
    switch (message->header()->name) {
    case internal::kAudioFocusManager_RequestAudioFocus_Name: {
        ...
        bool success = true;
        ::mojo::PendingReceiver<AudioFocusRequestClient> p_client = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingReceiver<AudioFocusRequestClient>>();
        ::mojo::PendingRemote<::media_session::mojom::MediaSession> p_session
            = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingRemote<::media_session::mojom::MediaSession>>();
        ::media_session::mojom::MediaSessionInfoPtr p_session_info = mojo::DefaultConstructTraits::CreateInstance<::media_session::mojom::MediaSessionInfoPtr>();
        AudioFocusType p_type = mojo::DefaultConstructTraits::CreateInstance<AudioFocusType>();
        ...
        AudioFocusManager::RequestAudioFocusCallback callback = AudioFocusManager_RequestAudioFocus_ProxyToResponder::CreateCallback(*message, std::move(responder));
        // A null |impl| means no implementation was bound.
        DCHECK(impl);
    ...
    case internal::kAudioFocusManager_RequestGroupedAudioFocus_Name: {
        ...
        ::media_session::mojom::MediaSessionInfoPtr p_session_info = mojo::DefaultConstructTraits::CreateInstance<::media_session::mojom::MediaSessionInfoPtr>();
        AudioFocusType p_type = mojo::DefaultConstructTraits::CreateInstance<AudioFocusType>();
        ::base::UnguessableToken p_group_id = mojo::DefaultConstructTraits::CreateInstance<::base::UnguessableToken>();
        ...
        AudioFocusManager::RequestGroupedAudioFocusCallback callback = AudioFocusManager_RequestGroupedAudioFocus_ProxyToResponder::CreateCallback(*message, std::move(responder));
        // A null |impl| means no implementation was bound.
        DCHECK(impl);
        impl->RequestGroupedAudioFocus(
            std::move(p_request_id), std::move(p_client), std::move(p_session), std::move(p_session_info), std::move(p_type), std::move(p_group_id), std::move(callback));
        return true;
    }
    case internal::kAudioFocusManager_GetFocusRequests_Name: {

        internal::AudioFocusManager_GetFocusRequests_Params_Data* params = reinterpret_cast<internal::AudioFocusManager_GetFocusRequests_Params_Data*>(message->mutable_payload());
        ...
        AudioFocusManager::GetFocusRequestsCallback callback = AudioFocusManager_GetFocusRequests_ProxyToResponder::CreateCallback(*message, std::move(responder));
        // A null |impl| means no implementation was bound.
        DCHECK(impl);
    ...
    case internal::kAudioFocusManager_GetSourceFocusRequests_Name: {
        ...
        AudioFocusManager::GetSourceFocusRequestsCallback callback = AudioFocusManager_GetSourceFocusRequests_ProxyToResponder::CreateCallback(*message, std::move(responder));
        // A null |impl| means no implementation was bound.
        DCHECK(impl);
...
static const mojo::internal::GenericValidationInfo kAudioFocusManagerValidationInfo[] = {
    ...
    { &internal::AudioFocusManager_RequestGroupedAudioFocus_Params_Data::Validate, &internal::AudioFocusManager_RequestGroupedAudioFocus_ResponseParams_Data::Validate },
    ...
    { &internal::AudioFocusManager_GetSourceFocusRequests_Params_Data::Validate, &internal::AudioFocusManager_GetSourceFocusRequests_ResponseParams_Data::Validate },
...
void AudioFocusManagerDebugProxy::GetDebugInfoForRequest(const ::base::UnguessableToken& in_request_id, GetDebugInfoForRequestCallback callback)
{
    ...
    mojo::Message message(internal::kAudioFocusManagerDebug_GetDebugInfoForRequest_Name, kFlags, 0, 0, nullptr);
    ...
    params->request_id.Set(request_id_fragment.is_null() ? nullptr : request_id_fragment.data());
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
        params->request_id.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null request_id in AudioFocusManagerDebug.GetDebugInfoForRequest request");
...
public:
    static AudioFocusManagerDebug::GetDebugInfoForRequestCallback CreateCallback(::mojo::Message& message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
    {
...
bool AudioFocusManagerDebug_GetDebugInfoForRequest_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    bool success = true;
    ::media_session::mojom::MediaSessionDebugInfoPtr p_debug_info = mojo::DefaultConstructTraits::CreateInstance<::media_session::mojom::MediaSessionDebugInfoPtr>();
...
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send reply media_session::mojom::AudioFocusManagerDebug::GetDebugInfoForRequest", "async_response_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("debug_info"), in_debug_info, "<value of type ::media_session::mojom::MediaSessionDebugInfoPtr>");
    });
#endif
...
// static
bool AudioFocusManagerDebugStubDispatch::AcceptWithResponder(AudioFocusManagerDebug* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
{
    [[maybe_unused]] const bool message_is_sync = message->has_flag(mojo::Message::kFlagIsSync);
    [[maybe_unused]] const uint64_t request_id = message->request_id();
    switch (message->header()->name) {
...
static const mojo::internal::GenericValidationInfo kAudioFocusManagerDebugValidationInfo[] = {
    { &internal::AudioFocusManagerDebug_GetDebugInfoForRequest_Params_Data::Validate, &internal::AudioFocusManagerDebug_GetDebugInfoForRequest_ResponseParams_Data::Validate },
};
...
namespace media_session {
namespace mojom {
void AudioFocusObserverInterceptorForTesting::OnFocusGained(AudioFocusRequestStatePtr state) { GetForwardingInterface()->OnFocusGained(std::move(state)); }
void AudioFocusObserverInterceptorForTesting::OnFocusLost(AudioFocusRequestStatePtr state) { GetForwardingInterface()->OnFocusLost(std::move(state)); }
...
void AudioFocusRequestClientInterceptorForTesting::AbandonAudioFocus() { GetForwardingInterface()->AbandonAudioFocus(); }
...
void AudioFocusManagerInterceptorForTesting::RequestGroupedAudioFocus(const ::base::UnguessableToken& request_id, ::mojo::PendingReceiver<AudioFocusRequestClient> client,
    ::mojo::PendingRemote<::media_session::mojom::MediaSession> session, ::media_session::mojom::MediaSessionInfoPtr session_info, AudioFocusType type,
...
void AudioFocusManagerInterceptorForTesting::GetFocusRequests(GetFocusRequestsCallback callback) { GetForwardingInterface()->GetFocusRequests(std::move(callback)); }
void AudioFocusManagerInterceptorForTesting::AddObserver(::mojo::PendingRemote<AudioFocusObserver> observer) { GetForwardingInterface()->AddObserver(std::move(observer)); }
...
void AudioFocusManagerInterceptorForTesting::SetEnforcementMode(EnforcementMode mode) { GetForwardingInterface()->SetEnforcementMode(std::move(mode)); }
...
void AudioFocusManagerInterceptorForTesting::RequestIdReleased(const ::base::UnguessableToken& request_id) { GetForwardingInterface()->RequestIdReleased(std::move(request_id)); }
...
void AudioFocusManagerAsyncWaiter::RequestAudioFocus(::mojo::PendingReceiver<AudioFocusRequestClient> client, ::mojo::PendingRemote<::media_session::mojom::MediaSession> session,
...
{
    std::vector<AudioFocusRequestStatePtr> async_wait_result = mojo::DefaultConstructTraits::CreateInstance<std::vector<AudioFocusRequestStatePtr>>();
...
void AudioFocusManagerDebugAsyncWaiter::GetDebugInfoForRequest(const ::base::UnguessableToken& request_id, ::media_session::mojom::MediaSessionDebugInfoPtr* out_debug_info)
{
    base::RunLoop loop;
    proxy_->GetDebugInfoForRequest(std::move(request_id),
        base::BindOnce(
            [](base::RunLoop* loop, ::media_session::mojom::MediaSessionDebugInfoPtr* out_debug_info, ::media_session::mojom::MediaSessionDebugInfoPtr debug_info) {
...
{
    ::media_session::mojom::MediaSessionDebugInfoPtr async_wait_result = mojo::DefaultConstructTraits::CreateInstance<::media_session::mojom::MediaSessionDebugInfoPtr>();
