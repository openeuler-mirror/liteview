...
bool MediaControllerStubDispatch::Accept(MediaController* impl, mojo::Message* message)
{
    ...
    case internal::kMediaController_ObserveImages_Name: {
        ...
        bool success = true;
        ::media_session::mojom::blink::MediaSessionImageType p_type = mojo::DefaultConstructTraits::CreateInstance<::media_session::mojom::blink::MediaSessionImageType>();
...
void MediaControllerObserverProxy::MediaSessionMetadataChanged(::media_session::mojom::blink::MediaMetadataPtr in_metadata)
{
    ...
    TRACE_EVENT1("mojom", "Send media_session::mojom::MediaControllerObserver::MediaSessionMetadataChanged", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("metadata"), in_metadata, "<value of type ::media_session::mojom::blink::MediaMetadataPtr>");
    });
#endif
    const bool kExpectsResponse = false;
    const bool kIsSync = false;
...
void MediaControllerObserverProxy::MediaSessionActionsChanged(const WTF::Vector<::media_session::mojom::blink::MediaSessionAction>& in_action)
{
    ...
    TRACE_EVENT1("mojom", "Send media_session::mojom::MediaControllerObserver::MediaSessionActionsChanged", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("action"), in_action, "<value of type const WTF::Vector<::media_session::mojom::blink::MediaSessionAction>&>");
    });
#endif
    const bool kExpectsResponse = false;
    const bool kIsSync = false;
...
bool MediaControllerObserverStubDispatch::Accept(MediaControllerObserver* impl, mojo::Message* message)
{
    ...
    case internal::kMediaControllerObserver_MediaSessionInfoChanged_Name: {
        ...
        bool success = true;
        ::media_session::mojom::blink::MediaSessionInfoPtr p_info = mojo::DefaultConstructTraits::CreateInstance<::media_session::mojom::blink::MediaSessionInfoPtr>();
    ...
    case internal::kMediaControllerObserver_MediaSessionMetadataChanged_Name: {
        ...
        bool success = true;
        ::media_session::mojom::blink::MediaMetadataPtr p_metadata = mojo::DefaultConstructTraits::CreateInstance<::media_session::mojom::blink::MediaMetadataPtr>();
    ...
    case internal::kMediaControllerObserver_MediaSessionActionsChanged_Name: {
        ...
        WTF::Vector<::media_session::mojom::blink::MediaSessionAction> p_action
            = mojo::DefaultConstructTraits::CreateInstance<WTF::Vector<::media_session::mojom::blink::MediaSessionAction>>();
...
bool MediaControllerImageObserverStubDispatch::Accept(MediaControllerImageObserver* impl, mojo::Message* message)
{
    ...
    case internal::kMediaControllerImageObserver_MediaControllerImageChanged_Name: {
        ...
        bool success = true;
        ::media_session::mojom::blink::MediaSessionImageType p_type = mojo::DefaultConstructTraits::CreateInstance<::media_session::mojom::blink::MediaSessionImageType>();
        ::media_session::mojom::blink::MediaImageBitmapPtr p_bitmap = mojo::DefaultConstructTraits::CreateInstance<::media_session::mojom::blink::MediaImageBitmapPtr>();
...
void MediaControllerInterceptorForTesting::ObserveImages(
    ::media_session::mojom::blink::MediaSessionImageType type, int32_t minimum_size_px, int32_t desired_size_px, ::mojo::PendingRemote<MediaControllerImageObserver> observer)
{
...
void MediaControllerInterceptorForTesting::SetAudioSinkId(const WTF::String& id) { GetForwardingInterface()->SetAudioSinkId(std::move(id)); }
