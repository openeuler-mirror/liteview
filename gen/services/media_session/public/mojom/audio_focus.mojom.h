...
//   ::mojo::PendingRemote<::media_session::mojom::MediaSession> session, ::media_session::mojom::MediaSessionInfoPtr session_info, AudioFocusType type, const
...
public:
    ...
    AudioFocusRequestState(::media_session::mojom::MediaSessionInfoPtr session_info_in, AudioFocusType audio_focus_type_in)
        : session_info(std::move(session_info_in))
        , audio_focus_type(std::move(audio_focus_type_in))
        , source_name()
        , request_id() {};

    AudioFocusRequestState(::media_session::mojom::MediaSessionInfoPtr session_info, AudioFocusType audio_focus_type, const absl::optional<std::string>& source_name);
...
template <> struct StructTraits<::media_session::mojom::AudioFocusRequestState::DataView, ::media_session::mojom::AudioFocusRequestStatePtr> {
    ...
    static const decltype(::media_session::mojom::AudioFocusRequestState::session_info)& session_info(const ::media_session::mojom::AudioFocusRequestStatePtr& input)
    {
        return input->session_info;
    }

    static decltype(::media_session::mojom::AudioFocusRequestState::audio_focus_type) audio_focus_type(const ::media_session::mojom::AudioFocusRequestStatePtr& input)
    {
        return input->audio_focus_type;
    }

    static const decltype(::media_session::mojom::AudioFocusRequestState::source_name)& source_name(const ::media_session::mojom::AudioFocusRequestStatePtr& input)
    {
        return input->source_name;
    }

    static const decltype(::media_session::mojom::AudioFocusRequestState::request_id)& request_id(const ::media_session::mojom::AudioFocusRequestStatePtr& input)
    {
