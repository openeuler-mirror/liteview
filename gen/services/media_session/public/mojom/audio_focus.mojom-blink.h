...
struct media_session_mojom_internal_EnforcementMode_DataHashFn {
    ...
    static bool Equal(const ::media_session::mojom::EnforcementMode& left, const ::media_session::mojom::EnforcementMode& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::media_session::mojom::EnforcementMode> : public GenericHashTraits<::media_session::mojom::EnforcementMode> {
    static_assert(true, "-1000000 is a reserved enum value");
    static_assert(true, "-1000001 is a reserved enum value");
    static const bool kEmptyValueIsZero = false;
    static ::media_session::mojom::EnforcementMode EmptyValue() { return static_cast<::media_session::mojom::EnforcementMode>(-1000000); }
    static void ConstructDeletedValue(::media_session::mojom::EnforcementMode& slot, bool) { slot = static_cast<::media_session::mojom::EnforcementMode>(-1000001); }
    static bool IsDeletedValue(const ::media_session::mojom::EnforcementMode& value) { return value == static_cast<::media_session::mojom::EnforcementMode>(-1000001); }
};
} // namespace WTF
namespace WTF {
struct media_session_mojom_internal_AudioFocusType_DataHashFn {
    ...
    static bool Equal(const ::media_session::mojom::AudioFocusType& left, const ::media_session::mojom::AudioFocusType& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::media_session::mojom::AudioFocusType> : public GenericHashTraits<::media_session::mojom::AudioFocusType> {
    static_assert(true, "-1000000 is a reserved enum value");
    static_assert(true, "-1000001 is a reserved enum value");
    static const bool kEmptyValueIsZero = false;
    static ::media_session::mojom::AudioFocusType EmptyValue() { return static_cast<::media_session::mojom::AudioFocusType>(-1000000); }
    static void ConstructDeletedValue(::media_session::mojom::AudioFocusType& slot, bool) { slot = static_cast<::media_session::mojom::AudioFocusType>(-1000001); }
    static bool IsDeletedValue(const ::media_session::mojom::AudioFocusType& value) { return value == static_cast<::media_session::mojom::AudioFocusType>(-1000001); }
};
} // namespace WTF
...
// with not having this data in traces there.
    ...
    virtual void RequestAudioFocus(::mojo::PendingReceiver<AudioFocusRequestClient> client, ::mojo::PendingRemote<::media_session::mojom::blink::MediaSession> session,
...
//   ::mojo::PendingRemote<::media_session::mojom::blink::MediaSession> session, ::media_session::mojom::blink::MediaSessionInfoPtr session_info, AudioFocusType type, const
//   ::base::UnguessableToken& group_id, RequestGroupedAudioFocusCallback callback) final;
//
...
public:
    ...
    template <typename... Args> static AudioFocusRequestStatePtr New(Args&&... args) { return AudioFocusRequestStatePtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static AudioFocusRequestStatePtr From(const U& u) { return mojo::TypeConverter<AudioFocusRequestStatePtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, AudioFocusRequestState>::Convert(*this); }
    ...
    template <typename T, AudioFocusRequestState::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    ...
    {
        return mojo::Message(std::make_unique<internal::AudioFocusRequestState_UnserializedMessageContext<UserType, AudioFocusRequestState::DataView>>(0, 0, std::move(input)),
    ...
    {
        return AudioFocusRequestState::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, AudioFocusRequestState::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, AudioFocusRequestState::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, AudioFocusRequestState::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }

template <typename StructPtrType> AudioFocusRequestStatePtr AudioFocusRequestState::Clone() const
{
    return New(mojo::Clone(session_info), mojo::Clone(audio_focus_type), mojo::Clone(source_name), mojo::Clone(request_id));
}
...
namespace mojo {
template <> struct BLINK_PLATFORM_EXPORT StructTraits<::media_session::mojom::blink::AudioFocusRequestState::DataView, ::media_session::mojom::blink::AudioFocusRequestStatePtr> {
    ...
    static const decltype(::media_session::mojom::blink::AudioFocusRequestState::session_info)& session_info(const ::media_session::mojom::blink::AudioFocusRequestStatePtr& input)
    {
        return input->session_info;
    }

    static decltype(::media_session::mojom::blink::AudioFocusRequestState::audio_focus_type) audio_focus_type(const ::media_session::mojom::blink::AudioFocusRequestStatePtr& input)
    {
        return input->audio_focus_type;
    }

    static const decltype(::media_session::mojom::blink::AudioFocusRequestState::source_name)& source_name(const ::media_session::mojom::blink::AudioFocusRequestStatePtr& input)
    {
        return input->source_name;
    }

    static const decltype(::media_session::mojom::blink::AudioFocusRequestState::request_id)& request_id(const ::media_session::mojom::blink::AudioFocusRequestStatePtr& input)
    {
