...
bool MediaImage::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
MediaMetadata::MediaMetadata(const ::std::u16string& title_in, const ::std::u16string& artist_in, const ::std::u16string& album_in, const ::std::u16string& source_title_in)
...
bool MediaMetadata::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
bool MediaImageBitmap::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
MediaPosition::MediaPosition(double playback_rate_in, ::base::TimeDelta duration_in, ::base::TimeDelta position_in, ::base::TimeTicks last_updated_time_in, bool end_of_media_in)
    : playback_rate(std::move(playback_rate_in))
    , duration(std::move(duration_in))
    , position(std::move(position_in))
    , last_updated_time(std::move(last_updated_time_in))
...
bool MediaPosition::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
size_t RemotePlaybackMetadata::Hash(size_t seed) const
{
    seed = mojo::internal::Hash(seed, this->video_codec);
    seed = mojo::internal::Hash(seed, this->audio_codec);
    seed = mojo::internal::Hash(seed, this->remote_playback_disabled);
    return seed;
}
...
bool RemotePlaybackMetadata::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
MediaSessionInfo::MediaSessionInfo(
    MediaSessionInfo::SessionState state_in, bool force_duck_in, MediaPlaybackState playback_state_in, bool is_controllable_in, bool prefer_stop_for_gain_focus_loss_in)
    : state(std::move(state_in))
    , force_duck(std::move(force_duck_in))
    , playback_state(std::move(playback_state_in))
    , is_controllable(std::move(is_controllable_in))
...
MediaSessionInfo::MediaSessionInfo(MediaSessionInfo::SessionState state_in, bool force_duck_in, MediaPlaybackState playback_state_in, bool is_controllable_in,
    bool prefer_stop_for_gain_focus_loss_in, bool is_sensitive_in)
    : state(std::move(state_in))
    , force_duck(std::move(force_duck_in))
    , playback_state(std::move(playback_state_in))
    , is_controllable(std::move(is_controllable_in))
...
MediaSessionInfo::MediaSessionInfo(MediaSessionInfo::SessionState state_in, bool force_duck_in, MediaPlaybackState playback_state_in, bool is_controllable_in,
    bool prefer_stop_for_gain_focus_loss_in, bool is_sensitive_in, MediaPictureInPictureState picture_in_picture_state_in)
    : state(std::move(state_in))
    , force_duck(std::move(force_duck_in))
    , playback_state(std::move(playback_state_in))
    , is_controllable(std::move(is_controllable_in))
...
MediaSessionInfo::MediaSessionInfo(MediaSessionInfo::SessionState state_in, bool force_duck_in, MediaPlaybackState playback_state_in, bool is_controllable_in,
    bool prefer_stop_for_gain_focus_loss_in, bool is_sensitive_in, MediaPictureInPictureState picture_in_picture_state_in, MediaAudioVideoState deprecated_audio_video_state_in)
    : state(std::move(state_in))
    , force_duck(std::move(force_duck_in))
    , playback_state(std::move(playback_state_in))
    , is_controllable(std::move(is_controllable_in))
...
MediaSessionInfo::MediaSessionInfo(MediaSessionInfo::SessionState state_in, bool force_duck_in, MediaPlaybackState playback_state_in, bool is_controllable_in,
    bool prefer_stop_for_gain_focus_loss_in, bool is_sensitive_in, MediaPictureInPictureState picture_in_picture_state_in, MediaAudioVideoState deprecated_audio_video_state_in,
    const absl::optional<std::string>& audio_sink_id_in, absl::optional<std::vector<MediaAudioVideoState>> audio_video_states_in)
    : state(std::move(state_in))
    , force_duck(std::move(force_duck_in))
    , playback_state(std::move(playback_state_in))
    , is_controllable(std::move(is_controllable_in))
...
MediaSessionInfo::MediaSessionInfo(MediaSessionInfo::SessionState state_in, bool force_duck_in, MediaPlaybackState playback_state_in, bool is_controllable_in,
    bool prefer_stop_for_gain_focus_loss_in, bool is_sensitive_in, MediaPictureInPictureState picture_in_picture_state_in, MediaAudioVideoState deprecated_audio_video_state_in,
    const absl::optional<std::string>& audio_sink_id_in, absl::optional<std::vector<MediaAudioVideoState>> audio_video_states_in, MicrophoneState microphone_state_in,
...
MediaSessionInfo::MediaSessionInfo(MediaSessionInfo::SessionState state_in, bool force_duck_in, MediaPlaybackState playback_state_in, bool is_controllable_in,
    bool prefer_stop_for_gain_focus_loss_in, bool is_sensitive_in, MediaPictureInPictureState picture_in_picture_state_in, MediaAudioVideoState deprecated_audio_video_state_in,
    const absl::optional<std::string>& audio_sink_id_in, absl::optional<std::vector<MediaAudioVideoState>> audio_video_states_in, MicrophoneState microphone_state_in,
    CameraState camera_state_in, bool muted_in)
    : state(std::move(state_in))
    , force_duck(std::move(force_duck_in))
    , playback_state(std::move(playback_state_in))
    , is_controllable(std::move(is_controllable_in))
...
MediaSessionInfo::MediaSessionInfo(MediaSessionInfo::SessionState state_in, bool force_duck_in, MediaPlaybackState playback_state_in, bool is_controllable_in,
    bool prefer_stop_for_gain_focus_loss_in, bool is_sensitive_in, MediaPictureInPictureState picture_in_picture_state_in, MediaAudioVideoState deprecated_audio_video_state_in,
    const absl::optional<std::string>& audio_sink_id_in, absl::optional<std::vector<MediaAudioVideoState>> audio_video_states_in, MicrophoneState microphone_state_in,
    CameraState camera_state_in, bool muted_in, bool has_presentation_in)
    : state(std::move(state_in))
    , force_duck(std::move(force_duck_in))
    , playback_state(std::move(playback_state_in))
    , is_controllable(std::move(is_controllable_in))
...
MediaSessionInfo::MediaSessionInfo(MediaSessionInfo::SessionState state_in, bool force_duck_in, MediaPlaybackState playback_state_in, bool is_controllable_in,
    bool prefer_stop_for_gain_focus_loss_in, bool is_sensitive_in, MediaPictureInPictureState picture_in_picture_state_in, MediaAudioVideoState deprecated_audio_video_state_in,
    const absl::optional<std::string>& audio_sink_id_in, absl::optional<std::vector<MediaAudioVideoState>> audio_video_states_in, MicrophoneState microphone_state_in,
    CameraState camera_state_in, bool muted_in, bool has_presentation_in, RemotePlaybackMetadataPtr remote_playback_metadata_in)
    : state(std::move(state_in))
    , force_duck(std::move(force_duck_in))
    , playback_state(std::move(playback_state_in))
    , is_controllable(std::move(is_controllable_in))
...
void MediaSessionInfo::WriteIntoTrace(perfetto::TracedValue traced_context) const
{
    ...
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("is_sensitive"), this->is_sensitive,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
        "<value of type bool>"
#else
        "<value>"
...
bool MediaSessionInfo::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
bool MediaSessionDebugInfo::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
void MediaSessionObserverProxy::MediaSessionInfoChanged(MediaSessionInfoPtr in_info)
{
    ...
    mojo::Message message(internal::kMediaSessionObserver_MediaSessionInfoChanged_Name, kFlags, 0, 0, nullptr);
...
void MediaSessionObserverProxy::MediaSessionMetadataChanged(const absl::optional<::media_session::MediaMetadata>& in_metadata)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send media_session::mojom::MediaSessionObserver::MediaSessionMetadataChanged", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
    ...
    mojo::Message message(internal::kMediaSessionObserver_MediaSessionMetadataChanged_Name, kFlags, 0, 0, nullptr);
...
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send media_session::mojom::MediaSessionObserver::MediaSessionActionsChanged", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
    ...
    mojo::Message message(internal::kMediaSessionObserver_MediaSessionActionsChanged_Name, kFlags, 0, 0, nullptr);
    ...
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
        params->action.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null action in MediaSessionObserver.MediaSessionActionsChanged request");
...
void MediaSessionObserverProxy::MediaSessionImagesChanged(const base::flat_map<MediaSessionImageType, std::vector<::media_session::MediaImage>>& in_images)
{
    ...
    mojo::Message message(internal::kMediaSessionObserver_MediaSessionImagesChanged_Name, kFlags, 0, 0, nullptr);
    ...
    const mojo::internal::ContainerValidateParams images_validate_params(
        new mojo::internal::ContainerValidateParams(0, ::media_session::mojom::internal::MediaSessionImageType_Data::Validate),
    ...
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
        params->images.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null images in MediaSessionObserver.MediaSessionImagesChanged request");
...
void MediaSessionObserverProxy::MediaSessionPositionChanged(const absl::optional<::media_session::MediaPosition>& in_position)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send media_session::mojom::MediaSessionObserver::MediaSessionPositionChanged", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
    ...
    mojo::Message message(internal::kMediaSessionObserver_MediaSessionPositionChanged_Name, kFlags, 0, 0, nullptr);
...
bool MediaSessionObserverStubDispatch::Accept(MediaSessionObserver* impl, mojo::Message* message)
{
    ...
    case internal::kMediaSessionObserver_MediaSessionInfoChanged_Name: {
        ...
        bool success = true;
        MediaSessionInfoPtr p_info = mojo::DefaultConstructTraits::CreateInstance<MediaSessionInfoPtr>();
    ...
    case internal::kMediaSessionObserver_MediaSessionActionsChanged_Name: {
        ...
        bool success = true;
        std::vector<MediaSessionAction> p_action = mojo::DefaultConstructTraits::CreateInstance<std::vector<MediaSessionAction>>();
    ...
    case internal::kMediaSessionObserver_MediaSessionImagesChanged_Name: {
        ...
        base::flat_map<MediaSessionImageType, std::vector<::media_session::MediaImage>> p_images
            = mojo::DefaultConstructTraits::CreateInstance<base::flat_map<MediaSessionImageType, std::vector<::media_session::MediaImage>>>();
...
// static
bool MediaSessionObserverStubDispatch::AcceptWithResponder(MediaSessionObserver* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
{
...
void MediaSessionProxy::GetMediaSessionInfo(GetMediaSessionInfoCallback callback)
{
    ...
    mojo::Message message(internal::kMediaSession_GetMediaSessionInfo_Name, kFlags, 0, 0, nullptr);
...
void MediaSessionProxy::GetDebugInfo(GetDebugInfoCallback callback)
{
    ...
    mojo::Message message(internal::kMediaSession_GetDebugInfo_Name, kFlags, 0, 0, nullptr);
...
void MediaSessionProxy::StartDucking()
{
    ...
    mojo::Message message(internal::kMediaSession_StartDucking_Name, kFlags, 0, 0, nullptr);
...
void MediaSessionProxy::StopDucking()
{
    ...
    mojo::Message message(internal::kMediaSession_StopDucking_Name, kFlags, 0, 0, nullptr);
...
void MediaSessionProxy::Suspend(MediaSession::SuspendType in_suspend_type)
{
    ...
    mojo::Message message(internal::kMediaSession_Suspend_Name, kFlags, 0, 0, nullptr);
...
void MediaSessionProxy::Resume(MediaSession::SuspendType in_suspend_type)
{
    ...
    mojo::Message message(internal::kMediaSession_Resume_Name, kFlags, 0, 0, nullptr);
...
void MediaSessionProxy::AddObserver(::mojo::PendingRemote<MediaSessionObserver> in_observer)
{
    ...
    mojo::Message message(internal::kMediaSession_AddObserver_Name, kFlags, 0, 0, nullptr);
    mojo::internal::MessageFragment<::media_session::mojom::internal::MediaSession_AddObserver_Params_Data> params(message);
    params.Allocate();
    mojo::internal::Serialize<mojo::InterfacePtrDataView<::media_session::mojom::MediaSessionObserverInterfaceBase>>(in_observer, &params->observer, &params.message());
...
void MediaSessionProxy::PreviousTrack()
{
    ...
    mojo::Message message(internal::kMediaSession_PreviousTrack_Name, kFlags, 0, 0, nullptr);
...
void MediaSessionProxy::NextTrack()
{
    ...
    mojo::Message message(internal::kMediaSession_NextTrack_Name, kFlags, 0, 0, nullptr);
...
void MediaSessionProxy::Seek(::base::TimeDelta in_seek_time)
{
    ...
    mojo::Message message(internal::kMediaSession_Seek_Name, kFlags, 0, 0, nullptr);
    ...
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(params->seek_time.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null seek_time in MediaSession.Seek request");
...
void MediaSessionProxy::Stop(MediaSession::SuspendType in_suspend_type)
{
    ...
    mojo::Message message(internal::kMediaSession_Stop_Name, kFlags, 0, 0, nullptr);
...
void MediaSessionProxy::SkipAd()
{
    ...
    mojo::Message message(internal::kMediaSession_SkipAd_Name, kFlags, 0, 0, nullptr);
    ...
    const ::media_session::MediaImage& in_image, int32_t in_minimum_size_px, int32_t in_desired_size_px, GetMediaImageBitmapCallback callback)
{
    ...
    mojo::Message message(internal::kMediaSession_GetMediaImageBitmap_Name, kFlags, 0, 0, nullptr);
...
void MediaSessionProxy::SeekTo(::base::TimeDelta in_seek_time)
{
    ...
    mojo::Message message(internal::kMediaSession_SeekTo_Name, kFlags, 0, 0, nullptr);
...
void MediaSessionProxy::ScrubTo(::base::TimeDelta in_seek_time)
{
    ...
    mojo::Message message(internal::kMediaSession_ScrubTo_Name, kFlags, 0, 0, nullptr);
...
void MediaSessionProxy::EnterPictureInPicture()
{
    ...
    mojo::Message message(internal::kMediaSession_EnterPictureInPicture_Name, kFlags, 0, 0, nullptr);
...
void MediaSessionProxy::ExitPictureInPicture()
{
    ...
    mojo::Message message(internal::kMediaSession_ExitPictureInPicture_Name, kFlags, 0, 0, nullptr);
...
void MediaSessionProxy::SetAudioSinkId(const absl::optional<std::string>& in_id)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    ...
    mojo::Message message(internal::kMediaSession_SetAudioSinkId_Name, kFlags, 0, 0, nullptr);
...
void MediaSessionProxy::ToggleMicrophone()
{
    ...
    mojo::Message message(internal::kMediaSession_ToggleMicrophone_Name, kFlags, 0, 0, nullptr);
...
void MediaSessionProxy::ToggleCamera()
{
    ...
    mojo::Message message(internal::kMediaSession_ToggleCamera_Name, kFlags, 0, 0, nullptr);
...
void MediaSessionProxy::HangUp()
{
    ...
    mojo::Message message(internal::kMediaSession_HangUp_Name, kFlags, 0, 0, nullptr);
...
void MediaSessionProxy::Raise()
{
    ...
    mojo::Message message(internal::kMediaSession_Raise_Name, kFlags, 0, 0, nullptr);
...
void MediaSessionProxy::SetMute(bool in_mute)
{
    ...
    mojo::Message message(internal::kMediaSession_SetMute_Name, kFlags, 0, 0, nullptr);
...
public:
    ...
    {
        std::unique_ptr<MediaSession_GetMediaSessionInfo_ProxyToResponder> proxy(new MediaSession_GetMediaSessionInfo_ProxyToResponder(message, std::move(responder)));
...
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send reply media_session::mojom::MediaSession::GetMediaSessionInfo", "async_response_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("info"), in_info, "<value of type MediaSessionInfoPtr>");
    });
#endif
...
bool MediaSession_GetDebugInfo_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    DCHECK(message->is_serialized());
    internal::MediaSession_GetDebugInfo_ResponseParams_Data* params = reinterpret_cast<internal::MediaSession_GetDebugInfo_ResponseParams_Data*>(message->mutable_payload());

    bool success = true;
    MediaSessionDebugInfoPtr p_info = mojo::DefaultConstructTraits::CreateInstance<MediaSessionDebugInfoPtr>();
...
public:
    ...
    {
        std::unique_ptr<MediaSession_GetMediaImageBitmap_ProxyToResponder> proxy(new MediaSession_GetMediaImageBitmap_ProxyToResponder(message, std::move(responder)));
...
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send reply media_session::mojom::MediaSession::GetMediaImageBitmap", "async_response_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
...
bool MediaSessionStubDispatch::Accept(MediaSession* impl, mojo::Message* message)
{
    ...
    case internal::kMediaSession_StartDucking_Name: {
        ...
        DCHECK(message->is_serialized());
        internal::MediaSession_StartDucking_Params_Data* params = reinterpret_cast<internal::MediaSession_StartDucking_Params_Data*>(message->mutable_payload());
    ...
    case internal::kMediaSession_Suspend_Name: {
        ...
        bool success = true;
        MediaSession::SuspendType p_suspend_type = mojo::DefaultConstructTraits::CreateInstance<MediaSession::SuspendType>();
    ...
    case internal::kMediaSession_AddObserver_Name: {
        ...
        bool success = true;
        ::mojo::PendingRemote<MediaSessionObserver> p_observer = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingRemote<MediaSessionObserver>>();
    ...
    case internal::kMediaSession_PreviousTrack_Name: {
        ...
        DCHECK(message->is_serialized());
        internal::MediaSession_PreviousTrack_Params_Data* params = reinterpret_cast<internal::MediaSession_PreviousTrack_Params_Data*>(message->mutable_payload());
    ...
    case internal::kMediaSession_EnterPictureInPicture_Name: {
        ...
        DCHECK(message->is_serialized());
        internal::MediaSession_EnterPictureInPicture_Params_Data* params = reinterpret_cast<internal::MediaSession_EnterPictureInPicture_Params_Data*>(message->mutable_payload());
    ...
    case internal::kMediaSession_ExitPictureInPicture_Name: {
        ...
        DCHECK(message->is_serialized());
        internal::MediaSession_ExitPictureInPicture_Params_Data* params = reinterpret_cast<internal::MediaSession_ExitPictureInPicture_Params_Data*>(message->mutable_payload());
    ...
    case internal::kMediaSession_SetAudioSinkId_Name: {
        ...
        DCHECK(message->is_serialized());
        internal::MediaSession_SetAudioSinkId_Params_Data* params = reinterpret_cast<internal::MediaSession_SetAudioSinkId_Params_Data*>(message->mutable_payload());
    ...
    case internal::kMediaSession_ToggleMicrophone_Name: {
        ...
        DCHECK(message->is_serialized());
        internal::MediaSession_ToggleMicrophone_Params_Data* params = reinterpret_cast<internal::MediaSession_ToggleMicrophone_Params_Data*>(message->mutable_payload());
    ...
    case internal::kMediaSession_ToggleCamera_Name: {
        ...
        DCHECK(message->is_serialized());
        internal::MediaSession_ToggleCamera_Params_Data* params = reinterpret_cast<internal::MediaSession_ToggleCamera_Params_Data*>(message->mutable_payload());
...
bool MediaSessionStubDispatch::AcceptWithResponder(MediaSession* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
{
    ...
    case internal::kMediaSession_GetMediaSessionInfo_Name: {
        ...
        internal::MediaSession_GetMediaSessionInfo_Params_Data* params = reinterpret_cast<internal::MediaSession_GetMediaSessionInfo_Params_Data*>(message->mutable_payload());
    ...
    case internal::kMediaSession_GetDebugInfo_Name: {
        ...
        internal::MediaSession_GetDebugInfo_Params_Data* params = reinterpret_cast<internal::MediaSession_GetDebugInfo_Params_Data*>(message->mutable_payload());
    ...
    case internal::kMediaSession_GetMediaImageBitmap_Name: {
        ...
        internal::MediaSession_GetMediaImageBitmap_Params_Data* params = reinterpret_cast<internal::MediaSession_GetMediaImageBitmap_Params_Data*>(message->mutable_payload());

        bool success = true;
        ::media_session::MediaImage p_image = mojo::DefaultConstructTraits::CreateInstance<::media_session::MediaImage>();
...
namespace media_session {
namespace mojom {
void MediaSessionObserverInterceptorForTesting::MediaSessionInfoChanged(MediaSessionInfoPtr info) { GetForwardingInterface()->MediaSessionInfoChanged(std::move(info)); }
...
void MediaSessionInterceptorForTesting::GetMediaSessionInfo(GetMediaSessionInfoCallback callback) { GetForwardingInterface()->GetMediaSessionInfo(std::move(callback)); }
void MediaSessionInterceptorForTesting::GetDebugInfo(GetDebugInfoCallback callback) { GetForwardingInterface()->GetDebugInfo(std::move(callback)); }
void MediaSessionInterceptorForTesting::StartDucking() { GetForwardingInterface()->StartDucking(); }
void MediaSessionInterceptorForTesting::StopDucking() { GetForwardingInterface()->StopDucking(); }
void MediaSessionInterceptorForTesting::Suspend(MediaSession::SuspendType suspend_type) { GetForwardingInterface()->Suspend(std::move(suspend_type)); }
void MediaSessionInterceptorForTesting::Resume(MediaSession::SuspendType suspend_type) { GetForwardingInterface()->Resume(std::move(suspend_type)); }
void MediaSessionInterceptorForTesting::AddObserver(::mojo::PendingRemote<MediaSessionObserver> observer) { GetForwardingInterface()->AddObserver(std::move(observer)); }
void MediaSessionInterceptorForTesting::PreviousTrack() { GetForwardingInterface()->PreviousTrack(); }
void MediaSessionInterceptorForTesting::NextTrack() { GetForwardingInterface()->NextTrack(); }
void MediaSessionInterceptorForTesting::Seek(::base::TimeDelta seek_time) { GetForwardingInterface()->Seek(std::move(seek_time)); }
void MediaSessionInterceptorForTesting::Stop(MediaSession::SuspendType suspend_type) { GetForwardingInterface()->Stop(std::move(suspend_type)); }
void MediaSessionInterceptorForTesting::SkipAd() { GetForwardingInterface()->SkipAd(); }
...
void MediaSessionInterceptorForTesting::SeekTo(::base::TimeDelta seek_time) { GetForwardingInterface()->SeekTo(std::move(seek_time)); }
void MediaSessionInterceptorForTesting::ScrubTo(::base::TimeDelta seek_time) { GetForwardingInterface()->ScrubTo(std::move(seek_time)); }
void MediaSessionInterceptorForTesting::EnterPictureInPicture() { GetForwardingInterface()->EnterPictureInPicture(); }
void MediaSessionInterceptorForTesting::ExitPictureInPicture() { GetForwardingInterface()->ExitPictureInPicture(); }
void MediaSessionInterceptorForTesting::SetAudioSinkId(const absl::optional<std::string>& id) { GetForwardingInterface()->SetAudioSinkId(std::move(id)); }
void MediaSessionInterceptorForTesting::ToggleMicrophone() { GetForwardingInterface()->ToggleMicrophone(); }
void MediaSessionInterceptorForTesting::ToggleCamera() { GetForwardingInterface()->ToggleCamera(); }
void MediaSessionInterceptorForTesting::HangUp() { GetForwardingInterface()->HangUp(); }
void MediaSessionInterceptorForTesting::Raise() { GetForwardingInterface()->Raise(); }
void MediaSessionInterceptorForTesting::SetMute(bool mute) { GetForwardingInterface()->SetMute(std::move(mute)); }
...
{
    MediaSessionInfoPtr async_wait_result = mojo::DefaultConstructTraits::CreateInstance<MediaSessionInfoPtr>();
...
{
    MediaSessionDebugInfoPtr async_wait_result = mojo::DefaultConstructTraits::CreateInstance<MediaSessionDebugInfoPtr>();
    GetDebugInfo(&async_wait_result);
    return async_wait_result;
}

void MediaSessionAsyncWaiter::GetMediaImageBitmap(const ::media_session::MediaImage& image, int32_t minimum_size_px, int32_t desired_size_px, ::SkBitmap* out_image)
{
    base::RunLoop loop;
...
{
    ::SkBitmap async_wait_result = mojo::DefaultConstructTraits::CreateInstance<::SkBitmap>();
