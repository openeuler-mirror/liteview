...
{
    seed = mojo::internal::WTFHash(seed, this->video_codec);
    seed = mojo::internal::WTFHash(seed, this->audio_codec);
    seed = mojo::internal::WTFHash(seed, this->remote_playback_disabled);
    return seed;
}
...
MediaSessionInfo::MediaSessionInfo(MediaSessionInfo::SessionState state_in, bool force_duck_in, MediaPlaybackState playback_state_in, bool is_controllable_in,
    bool prefer_stop_for_gain_focus_loss_in, bool is_sensitive_in, MediaPictureInPictureState picture_in_picture_state_in, MediaAudioVideoState deprecated_audio_video_state_in,
    const WTF::String& audio_sink_id_in, absl::optional<WTF::Vector<MediaAudioVideoState>> audio_video_states_in)
    : state(std::move(state_in))
    , force_duck(std::move(force_duck_in))
    , playback_state(std::move(playback_state_in))
    , is_controllable(std::move(is_controllable_in))
...
MediaSessionInfo::MediaSessionInfo(MediaSessionInfo::SessionState state_in, bool force_duck_in, MediaPlaybackState playback_state_in, bool is_controllable_in,
    bool prefer_stop_for_gain_focus_loss_in, bool is_sensitive_in, MediaPictureInPictureState picture_in_picture_state_in, MediaAudioVideoState deprecated_audio_video_state_in,
    const WTF::String& audio_sink_id_in, absl::optional<WTF::Vector<MediaAudioVideoState>> audio_video_states_in, MicrophoneState microphone_state_in, CameraState camera_state_in)
    : state(std::move(state_in))
    , force_duck(std::move(force_duck_in))
    , playback_state(std::move(playback_state_in))
    , is_controllable(std::move(is_controllable_in))
...
MediaSessionInfo::MediaSessionInfo(MediaSessionInfo::SessionState state_in, bool force_duck_in, MediaPlaybackState playback_state_in, bool is_controllable_in,
    bool prefer_stop_for_gain_focus_loss_in, bool is_sensitive_in, MediaPictureInPictureState picture_in_picture_state_in, MediaAudioVideoState deprecated_audio_video_state_in,
    const WTF::String& audio_sink_id_in, absl::optional<WTF::Vector<MediaAudioVideoState>> audio_video_states_in, MicrophoneState microphone_state_in, CameraState camera_state_in,
    bool muted_in, bool has_presentation_in)
    : state(std::move(state_in))
    , force_duck(std::move(force_duck_in))
    , playback_state(std::move(playback_state_in))
    , is_controllable(std::move(is_controllable_in))
...
MediaSessionInfo::MediaSessionInfo(MediaSessionInfo::SessionState state_in, bool force_duck_in, MediaPlaybackState playback_state_in, bool is_controllable_in,
    bool prefer_stop_for_gain_focus_loss_in, bool is_sensitive_in, MediaPictureInPictureState picture_in_picture_state_in, MediaAudioVideoState deprecated_audio_video_state_in,
    const WTF::String& audio_sink_id_in, absl::optional<WTF::Vector<MediaAudioVideoState>> audio_video_states_in, MicrophoneState microphone_state_in, CameraState camera_state_in,
    bool muted_in, bool has_presentation_in, RemotePlaybackMetadataPtr remote_playback_metadata_in)
    : state(std::move(state_in))
    , force_duck(std::move(force_duck_in))
    , playback_state(std::move(playback_state_in))
    , is_controllable(std::move(is_controllable_in))
...
void MediaSessionObserverProxy::MediaSessionImagesChanged(WTF::HashMap<MediaSessionImageType, WTF::Vector<MediaImagePtr>> in_images)
{
    ...
    TRACE_EVENT1("mojom", "Send media_session::mojom::MediaSessionObserver::MediaSessionImagesChanged", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("images"), in_images, "<value of type WTF::HashMap<MediaSessionImageType, WTF::Vector<MediaImagePtr>>>");
    });
#endif
    const bool kExpectsResponse = false;
    const bool kIsSync = false;
...
bool MediaSessionObserverStubDispatch::Accept(MediaSessionObserver* impl, mojo::Message* message)
{
    ...
    case internal::kMediaSessionObserver_MediaSessionMetadataChanged_Name: {
        ...
        bool success = true;
        MediaMetadataPtr p_metadata = mojo::DefaultConstructTraits::CreateInstance<MediaMetadataPtr>();
    ...
    case internal::kMediaSessionObserver_MediaSessionActionsChanged_Name: {
        ...
        bool success = true;
        WTF::Vector<MediaSessionAction> p_action = mojo::DefaultConstructTraits::CreateInstance<WTF::Vector<MediaSessionAction>>();
    ...
    case internal::kMediaSessionObserver_MediaSessionImagesChanged_Name: {
        ...
        WTF::HashMap<MediaSessionImageType, WTF::Vector<MediaImagePtr>> p_images
            = mojo::DefaultConstructTraits::CreateInstance<WTF::HashMap<MediaSessionImageType, WTF::Vector<MediaImagePtr>>>();
    ...
    case internal::kMediaSessionObserver_MediaSessionPositionChanged_Name: {
        ...
        bool success = true;
        MediaPositionPtr p_position = mojo::DefaultConstructTraits::CreateInstance<MediaPositionPtr>();
...
void MediaSessionProxy::GetMediaImageBitmap(MediaImagePtr in_image, int32_t in_minimum_size_px, int32_t in_desired_size_px, GetMediaImageBitmapCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
bool MediaSession_GetMediaImageBitmap_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    bool success = true;
    MediaImageBitmapPtr p_image = mojo::DefaultConstructTraits::CreateInstance<MediaImageBitmapPtr>();
...
bool MediaSessionStubDispatch::AcceptWithResponder(MediaSession* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
{
    ...
    case internal::kMediaSession_GetMediaImageBitmap_Name: {
        ...
        bool success = true;
        MediaImagePtr p_image = mojo::DefaultConstructTraits::CreateInstance<MediaImagePtr>();
...
void MediaSessionInterceptorForTesting::SetAudioSinkId(const WTF::String& id) { GetForwardingInterface()->SetAudioSinkId(std::move(id)); }
...
{
    MediaImageBitmapPtr async_wait_result = mojo::DefaultConstructTraits::CreateInstance<MediaImageBitmapPtr>();
