...
AudioFocusRequestState::AudioFocusRequestState(::media_session::mojom::blink::MediaSessionInfoPtr session_info_in, AudioFocusType audio_focus_type_in,
    const WTF::String& source_name_in, const absl::optional<::base::UnguessableToken>& request_id_in)
    : session_info(std::move(session_info_in))
    , audio_focus_type(std::move(audio_focus_type_in))
    , source_name(std::move(source_name_in))
...
void AudioFocusRequestClientProxy::RequestAudioFocus(::media_session::mojom::blink::MediaSessionInfoPtr in_session_info, AudioFocusType in_type, RequestAudioFocusCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send media_session::mojom::AudioFocusRequestClient::RequestAudioFocus", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("session_info"), in_session_info, "<value of type ::media_session::mojom::blink::MediaSessionInfoPtr>");
...
bool AudioFocusRequestClientStubDispatch::Accept(AudioFocusRequestClient* impl, mojo::Message* message)
{
    ...
    case internal::kAudioFocusRequestClient_MediaSessionInfoChanged_Name: {
        ...
        bool success = true;
        ::media_session::mojom::blink::MediaSessionInfoPtr p_session_info = mojo::DefaultConstructTraits::CreateInstance<::media_session::mojom::blink::MediaSessionInfoPtr>();
...
void AudioFocusManagerProxy::RequestAudioFocus(::mojo::PendingReceiver<AudioFocusRequestClient> in_client,
    ::mojo::PendingRemote<::media_session::mojom::blink::MediaSession> in_session, ::media_session::mojom::blink::MediaSessionInfoPtr in_session_info, AudioFocusType in_type,
    RequestAudioFocusCallback callback)
{
    ...
    TRACE_EVENT1("mojom", "Send media_session::mojom::AudioFocusManager::RequestAudioFocus", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("session"), in_session, "<value of type ::mojo::PendingRemote<::media_session::mojom::blink::MediaSession>>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("session_info"), in_session_info, "<value of type ::media_session::mojom::blink::MediaSessionInfoPtr>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("type"), in_type, "<value of type AudioFocusType>");
    });
#endif
...
bool AudioFocusManager_GetFocusRequests_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    bool success = true;
    WTF::Vector<AudioFocusRequestStatePtr> p_requests = mojo::DefaultConstructTraits::CreateInstance<WTF::Vector<AudioFocusRequestStatePtr>>();
...
bool AudioFocusManagerStubDispatch::AcceptWithResponder(AudioFocusManager* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
{
    ...
    case internal::kAudioFocusManager_RequestAudioFocus_Name: {
        ...
        ::mojo::PendingRemote<::media_session::mojom::blink::MediaSession> p_session
            = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingRemote<::media_session::mojom::blink::MediaSession>>();
        ::media_session::mojom::blink::MediaSessionInfoPtr p_session_info = mojo::DefaultConstructTraits::CreateInstance<::media_session::mojom::blink::MediaSessionInfoPtr>();
        AudioFocusType p_type = mojo::DefaultConstructTraits::CreateInstance<AudioFocusType>();
...
bool AudioFocusManagerDebug_GetDebugInfoForRequest_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    bool success = true;
    ::media_session::mojom::blink::MediaSessionDebugInfoPtr p_debug_info = mojo::DefaultConstructTraits::CreateInstance<::media_session::mojom::blink::MediaSessionDebugInfoPtr>();
...
void AudioFocusManagerDebug_GetDebugInfoForRequest_ProxyToResponder::Run(::media_session::mojom::blink::MediaSessionDebugInfoPtr in_debug_info)
{
    ...
    TRACE_EVENT1("mojom", "Send reply media_session::mojom::AudioFocusManagerDebug::GetDebugInfoForRequest", "async_response_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("debug_info"), in_debug_info, "<value of type ::media_session::mojom::blink::MediaSessionDebugInfoPtr>");
    });
#endif
...
void AudioFocusManagerInterceptorForTesting::RequestAudioFocus(::mojo::PendingReceiver<AudioFocusRequestClient> client,
    ::mojo::PendingRemote<::media_session::mojom::blink::MediaSession> session, ::media_session::mojom::blink::MediaSessionInfoPtr session_info, AudioFocusType type,
    RequestAudioFocusCallback callback)
{
...
{
    WTF::Vector<AudioFocusRequestStatePtr> async_wait_result = mojo::DefaultConstructTraits::CreateInstance<WTF::Vector<AudioFocusRequestStatePtr>>();
...
void AudioFocusManagerDebugAsyncWaiter::GetDebugInfoForRequest(const ::base::UnguessableToken& request_id, ::media_session::mojom::blink::MediaSessionDebugInfoPtr* out_debug_info)
{
    base::RunLoop loop;
    proxy_->GetDebugInfoForRequest(std::move(request_id),
        base::BindOnce(
            [](base::RunLoop* loop, ::media_session::mojom::blink::MediaSessionDebugInfoPtr* out_debug_info, ::media_session::mojom::blink::MediaSessionDebugInfoPtr debug_info) {
...
::media_session::mojom::blink::MediaSessionDebugInfoPtr AudioFocusManagerDebugAsyncWaiter::GetDebugInfoForRequest(const ::base::UnguessableToken& request_id)
{
    ::media_session::mojom::blink::MediaSessionDebugInfoPtr async_wait_result
        = mojo::DefaultConstructTraits::CreateInstance<::media_session::mojom::blink::MediaSessionDebugInfoPtr>();
