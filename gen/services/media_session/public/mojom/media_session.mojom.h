...
public:
    ...
    RemotePlaybackMetadata(const std::string& video_codec_in, const std::string& audio_codec_in, bool remote_playback_disabled_in)
...
public:
    ...
    MediaSessionDebugInfo(const std::string& name_in, const std::string& owner_in, const std::string& state_in)
...
public:
    ...
    MediaImage(const ::GURL& src_in, const ::std::u16string& type_in, std::vector<::gfx::Size> sizes_in)
        : src(std::move(src_in))
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input) { return mojo::internal::SerializeImpl<MediaImage::DataView, std::vector<uint8_t>>(input); }
...
public:
    ...
    MediaMetadata(const ::std::u16string& title_in, const ::std::u16string& artist_in, const ::std::u16string& album_in, const ::std::u16string& source_title_in)
...
public:
    ...
    MediaImageBitmap(int32_t width_in, int32_t height_in, std::vector<uint8_t> pixel_data_in)
...
public:
    ...
    MediaSessionInfo(MediaSessionInfo::SessionState state, bool force_duck, MediaPlaybackState playback_state, bool is_controllable, bool prefer_stop_for_gain_focus_loss,
        bool is_sensitive, MediaPictureInPictureState picture_in_picture_state, MediaAudioVideoState deprecated_audio_video_state, const absl::optional<std::string>& audio_sink_id,
        absl::optional<std::vector<MediaAudioVideoState>> audio_video_states);

    MediaSessionInfo(MediaSessionInfo::SessionState state, bool force_duck, MediaPlaybackState playback_state, bool is_controllable, bool prefer_stop_for_gain_focus_loss,
        bool is_sensitive, MediaPictureInPictureState picture_in_picture_state, MediaAudioVideoState deprecated_audio_video_state, const absl::optional<std::string>& audio_sink_id,
        absl::optional<std::vector<MediaAudioVideoState>> audio_video_states, MicrophoneState microphone_state, CameraState camera_state);

    MediaSessionInfo(MediaSessionInfo::SessionState state, bool force_duck, MediaPlaybackState playback_state, bool is_controllable, bool prefer_stop_for_gain_focus_loss,
        bool is_sensitive, MediaPictureInPictureState picture_in_picture_state, MediaAudioVideoState deprecated_audio_video_state, const absl::optional<std::string>& audio_sink_id,
        absl::optional<std::vector<MediaAudioVideoState>> audio_video_states, MicrophoneState microphone_state, CameraState camera_state, bool muted);

    MediaSessionInfo(MediaSessionInfo::SessionState state, bool force_duck, MediaPlaybackState playback_state, bool is_controllable, bool prefer_stop_for_gain_focus_loss,
        bool is_sensitive, MediaPictureInPictureState picture_in_picture_state, MediaAudioVideoState deprecated_audio_video_state, const absl::optional<std::string>& audio_sink_id,
        absl::optional<std::vector<MediaAudioVideoState>> audio_video_states, MicrophoneState microphone_state, CameraState camera_state, bool muted, bool has_presentation);
...
template <> struct StructTraits<::media_session::mojom::MediaImage::DataView, ::media_session::mojom::MediaImagePtr> {
    ...
    static const decltype(::media_session::mojom::MediaImage::src)& src(const ::media_session::mojom::MediaImagePtr& input) { return input->src; }

    static const decltype(::media_session::mojom::MediaImage::type)& type(const ::media_session::mojom::MediaImagePtr& input) { return input->type; }

    static const decltype(::media_session::mojom::MediaImage::sizes)& sizes(const ::media_session::mojom::MediaImagePtr& input) { return input->sizes; }
...
template <> struct StructTraits<::media_session::mojom::MediaMetadata::DataView, ::media_session::mojom::MediaMetadataPtr> {
    ...
    static const decltype(::media_session::mojom::MediaMetadata::title)& title(const ::media_session::mojom::MediaMetadataPtr& input) { return input->title; }

    static const decltype(::media_session::mojom::MediaMetadata::artist)& artist(const ::media_session::mojom::MediaMetadataPtr& input) { return input->artist; }

    static const decltype(::media_session::mojom::MediaMetadata::album)& album(const ::media_session::mojom::MediaMetadataPtr& input) { return input->album; }

    static const decltype(::media_session::mojom::MediaMetadata::source_title)& source_title(const ::media_session::mojom::MediaMetadataPtr& input) { return input->source_title; }
...
template <> struct StructTraits<::media_session::mojom::MediaImageBitmap::DataView, ::media_session::mojom::MediaImageBitmapPtr> {
    ...
    static decltype(::media_session::mojom::MediaImageBitmap::width) width(const ::media_session::mojom::MediaImageBitmapPtr& input) { return input->width; }

    static decltype(::media_session::mojom::MediaImageBitmap::height) height(const ::media_session::mojom::MediaImageBitmapPtr& input) { return input->height; }

    static const decltype(::media_session::mojom::MediaImageBitmap::pixel_data)& pixel_data(const ::media_session::mojom::MediaImageBitmapPtr& input) { return input->pixel_data; }

    static decltype(::media_session::mojom::MediaImageBitmap::color_type) color_type(const ::media_session::mojom::MediaImageBitmapPtr& input) { return input->color_type; }
...
template <> struct StructTraits<::media_session::mojom::MediaPosition::DataView, ::media_session::mojom::MediaPositionPtr> {
    ...
    static decltype(::media_session::mojom::MediaPosition::playback_rate) playback_rate(const ::media_session::mojom::MediaPositionPtr& input) { return input->playback_rate; }

    static const decltype(::media_session::mojom::MediaPosition::duration)& duration(const ::media_session::mojom::MediaPositionPtr& input) { return input->duration; }

    static const decltype(::media_session::mojom::MediaPosition::position)& position(const ::media_session::mojom::MediaPositionPtr& input) { return input->position; }
    ...
    static decltype(::media_session::mojom::MediaPosition::end_of_media) end_of_media(const ::media_session::mojom::MediaPositionPtr& input) { return input->end_of_media; }
...
template <> struct StructTraits<::media_session::mojom::RemotePlaybackMetadata::DataView, ::media_session::mojom::RemotePlaybackMetadataPtr> {
    ...
    static const decltype(::media_session::mojom::RemotePlaybackMetadata::video_codec)& video_codec(const ::media_session::mojom::RemotePlaybackMetadataPtr& input)
    {
        return input->video_codec;
    }

    static const decltype(::media_session::mojom::RemotePlaybackMetadata::audio_codec)& audio_codec(const ::media_session::mojom::RemotePlaybackMetadataPtr& input)
    {
...
template <> struct StructTraits<::media_session::mojom::MediaSessionInfo::DataView, ::media_session::mojom::MediaSessionInfoPtr> {
    ...
    static decltype(::media_session::mojom::MediaSessionInfo::state) state(const ::media_session::mojom::MediaSessionInfoPtr& input) { return input->state; }

    static decltype(::media_session::mojom::MediaSessionInfo::force_duck) force_duck(const ::media_session::mojom::MediaSessionInfoPtr& input) { return input->force_duck; }
    ...
    static decltype(::media_session::mojom::MediaSessionInfo::is_sensitive) is_sensitive(const ::media_session::mojom::MediaSessionInfoPtr& input) { return input->is_sensitive; }

    static decltype(::media_session::mojom::MediaSessionInfo::picture_in_picture_state) picture_in_picture_state(const ::media_session::mojom::MediaSessionInfoPtr& input)
    {
        return input->picture_in_picture_state;
    }

    static decltype(::media_session::mojom::MediaSessionInfo::deprecated_audio_video_state) deprecated_audio_video_state(const ::media_session::mojom::MediaSessionInfoPtr& input)
    {
    ...
    static const decltype(::media_session::mojom::MediaSessionInfo::audio_video_states)& audio_video_states(const ::media_session::mojom::MediaSessionInfoPtr& input)
    {
    ...
    static decltype(::media_session::mojom::MediaSessionInfo::camera_state) camera_state(const ::media_session::mojom::MediaSessionInfoPtr& input) { return input->camera_state; }

    static decltype(::media_session::mojom::MediaSessionInfo::muted) muted(const ::media_session::mojom::MediaSessionInfoPtr& input) { return input->muted; }
    ...
    static const decltype(::media_session::mojom::MediaSessionInfo::remote_playback_metadata)& remote_playback_metadata(const ::media_session::mojom::MediaSessionInfoPtr& input)
    {
...
template <> struct StructTraits<::media_session::mojom::MediaSessionDebugInfo::DataView, ::media_session::mojom::MediaSessionDebugInfoPtr> {
    ...
    static const decltype(::media_session::mojom::MediaSessionDebugInfo::name)& name(const ::media_session::mojom::MediaSessionDebugInfoPtr& input) { return input->name; }

    static const decltype(::media_session::mojom::MediaSessionDebugInfo::owner)& owner(const ::media_session::mojom::MediaSessionDebugInfoPtr& input) { return input->owner; }

    static const decltype(::media_session::mojom::MediaSessionDebugInfo::state)& state(const ::media_session::mojom::MediaSessionDebugInfoPtr& input) { return input->state; }
