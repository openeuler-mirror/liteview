...
EarlyHints::EarlyHints(::network::mojom::ParsedHeadersPtr headers_in, ::network::mojom::ReferrerPolicy referrer_policy_in, ::network::mojom::IPAddressSpace ip_address_space_in)
