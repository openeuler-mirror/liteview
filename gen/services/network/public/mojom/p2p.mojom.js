...
(function() {
  ...
  function P2PSocketManager_GetHostAddressWithFamily_Params(values) {
    this.initDefaults_();
    this.initFields_(values);
  }
  P2PSocketManager_GetHostAddressWithFamily_Params.prototype.initDefaults_ = function() {
    this.hostName = null;
    this.addressFamily = 0;
    this.enableMdns = false;
  };
  P2PSocketManager_GetHostAddressWithFamily_Params.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  P2PSocketManager_GetHostAddressWithFamily_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    if (err !== validator.validationError.NONE)
        return err;
    // validate P2PSocketManager_GetHostAddressWithFamily_Params.hostName
    err = messageValidator.validateStringPointer(offset + codec.kStructHeaderSize + 0, false)
    if (err !== validator.validationError.NONE)
        return err;
  ...
  P2PSocketManager_GetHostAddressWithFamily_Params.encodedSize = codec.kStructHeaderSize + 16;

  P2PSocketManager_GetHostAddressWithFamily_Params.decode = function(decoder) {
    var packed;
    var val = new P2PSocketManager_GetHostAddressWithFamily_Params();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.hostName =
        decoder.decodeStruct(codec.String);
  ...
  P2PSocketManager_GetHostAddressWithFamily_Params.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(P2PSocketManager_GetHostAddressWithFamily_Params.encodedSize);
    encoder.writeUint32(0);
    encoder.encodeStruct(codec.String, val.hostName);
  ...
  function P2PSocketManager_GetHostAddressWithFamily_ResponseParams(values) {
    this.initDefaults_();
    this.initFields_(values);
  }
  P2PSocketManager_GetHostAddressWithFamily_ResponseParams.prototype.initDefaults_ = function() {
    this.addresses = null;
  };
  P2PSocketManager_GetHostAddressWithFamily_ResponseParams.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  P2PSocketManager_GetHostAddressWithFamily_ResponseParams.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    if (err !== validator.validationError.NONE)
        return err;
    // validate P2PSocketManager_GetHostAddressWithFamily_ResponseParams.addresses
    err = messageValidator.validateArrayPointer(offset + codec.kStructHeaderSize + 0, 8, new codec.PointerTo(ip_address$.IPAddress), false, [0], 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  P2PSocketManager_GetHostAddressWithFamily_ResponseParams.encodedSize = codec.kStructHeaderSize + 8;

  P2PSocketManager_GetHostAddressWithFamily_ResponseParams.decode = function(decoder) {
    var packed;
    var val = new P2PSocketManager_GetHostAddressWithFamily_ResponseParams();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.addresses =
        decoder.decodeArrayPointer(new codec.PointerTo(ip_address$.IPAddress));
  ...
  P2PSocketManager_GetHostAddressWithFamily_ResponseParams.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(P2PSocketManager_GetHostAddressWithFamily_ResponseParams.encodedSize);
    encoder.writeUint32(0);
    encoder.encodeArrayPointer(new codec.PointerTo(ip_address$.IPAddress), val.addresses);
  };
  ...
  var kP2PNetworkNotificationClient_NetworkListChanged_Name = 145520244;
  ...
  var kP2PSocketManager_StartNetworkNotifications_Name = 1223462169;
  var kP2PSocketManager_GetHostAddress_Name = 1916742691;
  var kP2PSocketManager_GetHostAddressWithFamily_Name = 1346181333;
  var kP2PSocketManager_CreateSocket_Name = 1693342421;
  ...
  P2PSocketManagerPtr.prototype.getHostAddressWithFamily = function() {
    return P2PSocketManagerProxy.prototype.getHostAddressWithFamily
        .apply(this.ptr.getProxy(), arguments);
  };

  P2PSocketManagerProxy.prototype.getHostAddressWithFamily = function(hostName, addressFamily, enableMdns) {
    var params_ = new P2PSocketManager_GetHostAddressWithFamily_Params();
    params_.hostName = hostName;
    params_.addressFamily = addressFamily;
    params_.enableMdns = enableMdns;
    return new Promise(function(resolve, reject) {
      var builder = new codec.MessageV1Builder(
          kP2PSocketManager_GetHostAddressWithFamily_Name,
          codec.align(P2PSocketManager_GetHostAddressWithFamily_Params.encodedSize),
          codec.kMessageExpectsResponse, 0);
      builder.encodeStruct(P2PSocketManager_GetHostAddressWithFamily_Params, params_);
      var message = builder.finish();
      this.receiver_.acceptAndExpectResponse(message).then(function(message) {
        var reader = new codec.MessageReader(message);
        var responseParams =
            reader.decodeStruct(P2PSocketManager_GetHostAddressWithFamily_ResponseParams);
        resolve(responseParams);
      }).catch(function(result) {
        reject(Error("Connection error: " + result));
      });
  ...
  P2PSocketManagerStub.prototype.acceptWithResponder =
    ...
    case kP2PSocketManager_GetHostAddress_Name:
      ...
      return true;
    case kP2PSocketManager_GetHostAddressWithFamily_Name:
      var params = reader.decodeStruct(P2PSocketManager_GetHostAddressWithFamily_Params);
      this.getHostAddressWithFamily(params.hostName, params.addressFamily, params.enableMdns).then(function(response) {
        var responseParams =
            new P2PSocketManager_GetHostAddressWithFamily_ResponseParams();
        responseParams.addresses = response.addresses;
        var builder = new codec.MessageV1Builder(
            kP2PSocketManager_GetHostAddressWithFamily_Name,
            codec.align(P2PSocketManager_GetHostAddressWithFamily_ResponseParams.encodedSize),
            codec.kMessageIsResponse, reader.requestID);
        builder.encodeStruct(P2PSocketManager_GetHostAddressWithFamily_ResponseParams,
                             responseParams);
        var message = builder.finish();
        responder.accept(message);
      });
  ...
  function validateP2PSocketManagerRequest(messageValidator) {
    ...
    switch (message.getName()) {
      ...
      case kP2PSocketManager_GetHostAddressWithFamily_Name:
        if (message.expectsResponse())
          paramsClass = P2PSocketManager_GetHostAddressWithFamily_Params;
      break;
      case kP2PSocketManager_CreateSocket_Name:
        if (!message.expectsResponse() && !message.isResponse())
  ...
  function validateP2PSocketManagerResponse(messageValidator) {
   ...
   switch (message.getName()) {
      ...
      case kP2PSocketManager_GetHostAddressWithFamily_Name:
        if (message.isResponse())
          paramsClass = P2PSocketManager_GetHostAddressWithFamily_ResponseParams;
        break;
    }
    if (paramsClass === null)
      return validator.validationError.NONE;
  ...
  var kP2PSocket_Send_Name = 1069467379;
  var kP2PSocket_SetOption_Name = 1121175185;
  ...
  var kP2PSocketClient_SocketCreated_Name = 39176576;
  var kP2PSocketClient_SendComplete_Name = 1451939734;
  var kP2PSocketClient_DataReceived_Name = 2115232918;
