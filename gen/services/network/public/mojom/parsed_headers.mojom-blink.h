...
struct network_mojom_internal_OriginAgentClusterValue_DataHashFn {
    ...
    static bool Equal(const ::network::mojom::OriginAgentClusterValue& left, const ::network::mojom::OriginAgentClusterValue& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::network::mojom::OriginAgentClusterValue> : public GenericHashTraits<::network::mojom::OriginAgentClusterValue> {
    ...
    static void ConstructDeletedValue(::network::mojom::OriginAgentClusterValue& slot, bool) { slot = static_cast<::network::mojom::OriginAgentClusterValue>(-1000001); }
    static bool IsDeletedValue(const ::network::mojom::OriginAgentClusterValue& value) { return value == static_cast<::network::mojom::OriginAgentClusterValue>(-1000001); }
};
} // namespace WTF
namespace network {
namespace mojom {
...
public:
    ...
    template <typename... Args> static ParsedHeadersPtr New(Args&&... args) { return ParsedHeadersPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static ParsedHeadersPtr From(const U& u) { return mojo::TypeConverter<ParsedHeadersPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, ParsedHeaders>::Convert(*this); }
    ParsedHeaders()
    ...
    ParsedHeaders(WTF::Vector<::network::mojom::blink::ContentSecurityPolicyPtr> content_security_policy_in, ::network::mojom::blink::AllowCSPFromHeaderValuePtr allow_csp_from_in,
        ...
        OriginAgentClusterValue origin_agent_cluster_in, absl::optional<WTF::Vector<::network::mojom::blink::WebClientHintsType>> accept_ch_in,
        absl::optional<WTF::Vector<::network::mojom::blink::WebClientHintsType>> critical_ch_in, ::network::mojom::blink::XFrameOptionsValue xfo_in,
        WTF::Vector<::network::mojom::blink::LinkHeaderPtr> link_headers_in, ::network::mojom::blink::TimingAllowOriginPtr timing_allow_origin_in,
        WTF::Vector<::network::mojom::blink::LoadingMode> supports_loading_mode_in, const absl::optional<WTF::HashMap<WTF::String, WTF::String>>& reporting_endpoints_in,
        absl::optional<WTF::Vector<::network::mojom::blink::VariantsHeaderPtr>> variants_headers_in, absl::optional<WTF::Vector<WTF::String>> content_language_in)
    ...
    template <typename T, ParsedHeaders::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    ...
    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<ParsedHeaders::DataView>(input); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::ParsedHeaders_UnserializedMessageContext<UserType, ParsedHeaders::DataView>>(0, 0, std::move(input)), MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    {
        return ParsedHeaders::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, ParsedHeaders::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, ParsedHeaders::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, ParsedHeaders::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }

template <typename StructPtrType> ParsedHeadersPtr ParsedHeaders::Clone() const
{
    return New(mojo::Clone(content_security_policy), mojo::Clone(allow_csp_from), mojo::Clone(cross_origin_embedder_policy), mojo::Clone(cross_origin_opener_policy),
        mojo::Clone(origin_agent_cluster), mojo::Clone(accept_ch), mojo::Clone(critical_ch), mojo::Clone(xfo), mojo::Clone(link_headers), mojo::Clone(timing_allow_origin),
        mojo::Clone(supports_loading_mode), mojo::Clone(reporting_endpoints), mojo::Clone(variants_headers), mojo::Clone(content_language));
}
...
template <> struct BLINK_PLATFORM_EXPORT StructTraits<::network::mojom::blink::ParsedHeaders::DataView, ::network::mojom::blink::ParsedHeadersPtr> {
    ...
    static const decltype(::network::mojom::blink::ParsedHeaders::content_security_policy)& content_security_policy(const ::network::mojom::blink::ParsedHeadersPtr& input)
    {
    ...
    static const decltype(::network::mojom::blink::ParsedHeaders::cross_origin_opener_policy)& cross_origin_opener_policy(const ::network::mojom::blink::ParsedHeadersPtr& input)
    {
    ...
    static const decltype(::network::mojom::blink::ParsedHeaders::accept_ch)& accept_ch(const ::network::mojom::blink::ParsedHeadersPtr& input) { return input->accept_ch; }

    static const decltype(::network::mojom::blink::ParsedHeaders::critical_ch)& critical_ch(const ::network::mojom::blink::ParsedHeadersPtr& input) { return input->critical_ch; }

    static decltype(::network::mojom::blink::ParsedHeaders::xfo) xfo(const ::network::mojom::blink::ParsedHeadersPtr& input) { return input->xfo; }
    ...
    static const decltype(::network::mojom::blink::ParsedHeaders::timing_allow_origin)& timing_allow_origin(const ::network::mojom::blink::ParsedHeadersPtr& input)
    {
        return input->timing_allow_origin;
    }

    static const decltype(::network::mojom::blink::ParsedHeaders::supports_loading_mode)& supports_loading_mode(const ::network::mojom::blink::ParsedHeadersPtr& input)
    {
        return input->supports_loading_mode;
    }

    static const decltype(::network::mojom::blink::ParsedHeaders::reporting_endpoints)& reporting_endpoints(const ::network::mojom::blink::ParsedHeadersPtr& input)
    {
        return input->reporting_endpoints;
    }

    static const decltype(::network::mojom::blink::ParsedHeaders::variants_headers)& variants_headers(const ::network::mojom::blink::ParsedHeadersPtr& input)
    {
