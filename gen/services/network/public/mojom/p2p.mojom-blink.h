...
// with not having this data in traces there.
    ...
    virtual void GetHostAddressWithFamily(const WTF::String& host_name, int32_t address_family, bool enable_mdns, GetHostAddressWithFamilyCallback callback) = 0;
...
// with not having this data in traces there.
    ...
    virtual void Send(const WTF::Vector<int8_t>& data, const ::network::P2PPacketInfo& packet_info, const ::net::MutableNetworkTrafficAnnotationTag& traffic_annotation) = 0;
...
// with not having this data in traces there.
    ...
    virtual void DataReceived(const ::net::IPEndPoint& socket_address, const WTF::Vector<int8_t>& data, ::base::TimeTicks timestamp) = 0;
};
...
//
//   void NetworkListChanged(const WTF::Vector<::net::NetworkInterface>& networks, const ::net::IPAddress& default_ipv4_local_address, const ::net::IPAddress&
//   default_ipv6_local_address) final;
//
//  private:
...
//
//   void CreateSocket(::network::P2PSocketType type, const ::net::IPEndPoint& local_address, const ::network::P2PPortRange& port_range, const ::network::P2PHostAndIPEndPoint&
//   remote_address, ::mojo::PendingRemote<P2PSocketClient> client, ::mojo::PendingReceiver<P2PSocket> socket) final;
//
//  private:
//   mojo::MessageReceiverWithResponder* receiver_;
// };
...
//
//   void Send(const WTF::Vector<int8_t>& data, const ::network::P2PPacketInfo& packet_info, const ::net::MutableNetworkTrafficAnnotationTag& traffic_annotation) final;
//
...
//
//   void DataReceived(const ::net::IPEndPoint& socket_address, const WTF::Vector<int8_t>& data, ::base::TimeTicks timestamp) final;
//
//  private:
//   mojo::MessageReceiverWithResponder* receiver_;
// };
