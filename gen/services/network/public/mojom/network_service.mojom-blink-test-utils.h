...
class BLINK_PLATFORM_EXPORT NetworkServiceInterceptorForTesting : public NetworkService {
    ...
    void AttachNetLogProxy(
        ::mojo::PendingRemote<::network::mojom::blink::NetLogProxySource> proxy_source, ::mojo::PendingReceiver<::network::mojom::blink::NetLogProxySink> proxy_sink) override;
...
public:
    ...
    void GetNetworkList(uint32_t policy, absl::optional<WTF::Vector<::net::NetworkInterface>>* out_networks);
    ...
    void UpdateCtLogList(WTF::Vector<::network::mojom::blink::CTLogInfoPtr> log_list, ::base::Time update_time);

    void UpdateCtKnownPopularSCTs(const WTF::Vector<WTF::Vector<uint8_t>>& sct_hashes);

    void SetCtEnforcementEnabled(bool enabled);

    void ParseHeaders(const ::blink::KURL& url, ::network::mojom::blink::HttpResponseHeadersPtr headers, ::network::mojom::blink::ParsedHeadersPtr* out_parsed_headers);
