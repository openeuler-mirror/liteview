...
ContentSecurityPolicyHeader::ContentSecurityPolicyHeader(const WTF::String& header_value_in, ContentSecurityPolicyType type_in, ContentSecurityPolicySource source_in)
...
CSPSource::CSPSource(const WTF::String& scheme_in, const WTF::String& host_in, int32_t port_in, const WTF::String& path_in, bool is_host_wildcard_in, bool is_port_wildcard_in)
...
CSPSourceList::CSPSourceList(WTF::Vector<CSPSourcePtr> sources_in, WTF::Vector<WTF::String> nonces_in, WTF::Vector<CSPHashSourcePtr> hashes_in, bool allow_self_in,
...
CSPViolation::CSPViolation(const WTF::String& directive_in, const WTF::String& effective_directive_in, const WTF::String& console_message_in, const ::blink::KURL& blocked_url_in,
