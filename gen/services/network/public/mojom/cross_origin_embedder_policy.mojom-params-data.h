...
static_assert(
    sizeof(CrossOriginEmbedderPolicyReporter_QueueCorpViolationReport_Params_Data) == 24, "Bad sizeof(CrossOriginEmbedderPolicyReporter_QueueCorpViolationReport_Params_Data)");
...
public:
    ...
    bool report_only() const { return data_->report_only; }
...
public:
    ...
    template <typename UserType> UserType TakeReceiver()
    {
        UserType result;
        bool ret
            = mojo::internal::Deserialize<mojo::InterfaceRequestDataView<::network::mojom::CrossOriginEmbedderPolicyReporterInterfaceBase>>(&data_->receiver, &result, message_);
        DCHECK(ret);
        return result;
    }
