...
(function() {
  ...
  RestrictedCookieManager_GetAllForUrl_Params.prototype.initDefaults_ = function() {
    ...
    this.options = null;
    this.partitionedCookiesRuntimeFeatureEnabled = false;
  };
  ...
  RestrictedCookieManager_GetAllForUrl_Params.decode = function(decoder) {
    ...
    val.partitionedCookiesRuntimeFeatureEnabled = (packed >> 0) & 1 ? true : false;
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  RestrictedCookieManager_GetAllForUrl_Params.encode = function(encoder, val) {
    ...
    packed = 0;
    packed |= (val.partitionedCookiesRuntimeFeatureEnabled & 1) << 0
  ...
  RestrictedCookieManager_SetCanonicalCookie_Params.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 32, cookie_manager$.CookieInclusionStatus, false);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  RestrictedCookieManager_SetCanonicalCookie_Params.encodedSize = codec.kStructHeaderSize + 40;
  ...
  RestrictedCookieManager_SetCookieFromString_ResponseParams.prototype.initDefaults_ = function() {
    this.siteForCookiesOk = false;
    this.topFrameOriginOk = false;
  };
  ...
  RestrictedCookieManager_SetCookieFromString_ResponseParams.decode = function(decoder) {
    ...
    var version = decoder.readUint32();
    packed = decoder.readUint8();
    val.siteForCookiesOk = (packed >> 0) & 1 ? true : false;
    val.topFrameOriginOk = (packed >> 1) & 1 ? true : false;
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  RestrictedCookieManager_SetCookieFromString_ResponseParams.encode = function(encoder, val) {
    ...
    encoder.writeUint32(0);
    packed = 0;
    packed |= (val.siteForCookiesOk & 1) << 0
    packed |= (val.topFrameOriginOk & 1) << 1
    encoder.writeUint8(packed);
    encoder.skip(1);
    encoder.skip(1);
    encoder.skip(1);
  ...
  function RestrictedCookieManager_ConvertPartitionedCookiesToUnpartitioned_Params(values) {
    this.initDefaults_();
    this.initFields_(values);
  }
  RestrictedCookieManager_ConvertPartitionedCookiesToUnpartitioned_Params.prototype.initDefaults_ = function() {
    this.url = null;
  };
  RestrictedCookieManager_ConvertPartitionedCookiesToUnpartitioned_Params.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  RestrictedCookieManager_ConvertPartitionedCookiesToUnpartitioned_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    if (err !== validator.validationError.NONE)
        return err;
    // validate RestrictedCookieManager_ConvertPartitionedCookiesToUnpartitioned_Params.url
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 0, url$.Url, false);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  RestrictedCookieManager_ConvertPartitionedCookiesToUnpartitioned_Params.encodedSize = codec.kStructHeaderSize + 8;

  RestrictedCookieManager_ConvertPartitionedCookiesToUnpartitioned_Params.decode = function(decoder) {
    var packed;
    var val = new RestrictedCookieManager_ConvertPartitionedCookiesToUnpartitioned_Params();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.url =
        decoder.decodeStructPointer(url$.Url);
  ...
  RestrictedCookieManager_ConvertPartitionedCookiesToUnpartitioned_Params.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(RestrictedCookieManager_ConvertPartitionedCookiesToUnpartitioned_Params.encodedSize);
    encoder.writeUint32(0);
    encoder.encodeStructPointer(url$.Url, val.url);
  };
  var kRestrictedCookieManager_GetAllForUrl_Name = 942463470;
  var kRestrictedCookieManager_SetCanonicalCookie_Name = 1417016408;
  var kRestrictedCookieManager_AddChangeListener_Name = 2038257378;
  var kRestrictedCookieManager_SetCookieFromString_Name = 1139689244;
  var kRestrictedCookieManager_GetCookiesString_Name = 348443330;
  var kRestrictedCookieManager_CookiesEnabledFor_Name = 1708938462;
  var kRestrictedCookieManager_ConvertPartitionedCookiesToUnpartitioned_Name = 120536227;
  ...
  RestrictedCookieManagerProxy.prototype.getAllForUrl = function(url, siteForCookies, topFrameOrigin, options, partitionedCookiesRuntimeFeatureEnabled) {
    ...
    params_.partitionedCookiesRuntimeFeatureEnabled = partitionedCookiesRuntimeFeatureEnabled;
  ...
  RestrictedCookieManagerProxy.prototype.setCanonicalCookie = function(cookie, url, siteForCookies, topFrameOrigin, status) {
  ...
  RestrictedCookieManagerProxy.prototype.setCookieFromString = function(url, siteForCookies, topFrameOrigin, cookie, partitionedCookiesRuntimeFeatureEnabled) {
  ...
  RestrictedCookieManagerProxy.prototype.getCookiesString = function(url, siteForCookies, topFrameOrigin, partitionedCookiesRuntimeFeatureEnabled) {
  ...
  RestrictedCookieManagerPtr.prototype.convertPartitionedCookiesToUnpartitioned = function() {
    return RestrictedCookieManagerProxy.prototype.convertPartitionedCookiesToUnpartitioned
        .apply(this.ptr.getProxy(), arguments);
  };

  RestrictedCookieManagerProxy.prototype.convertPartitionedCookiesToUnpartitioned = function(url) {
    var params_ = new RestrictedCookieManager_ConvertPartitionedCookiesToUnpartitioned_Params();
    params_.url = url;
    var builder = new codec.MessageV0Builder(
        kRestrictedCookieManager_ConvertPartitionedCookiesToUnpartitioned_Name,
        codec.align(RestrictedCookieManager_ConvertPartitionedCookiesToUnpartitioned_Params.encodedSize));
    builder.encodeStruct(RestrictedCookieManager_ConvertPartitionedCookiesToUnpartitioned_Params, params_);
    var message = builder.finish();
  ...
  RestrictedCookieManagerStub.prototype.getAllForUrl = function(url, siteForCookies, topFrameOrigin, options, partitionedCookiesRuntimeFeatureEnabled) {
    return this.delegate_ && this.delegate_.getAllForUrl && this.delegate_.getAllForUrl(url, siteForCookies, topFrameOrigin, options, partitionedCookiesRuntimeFeatureEnabled);
  }
  RestrictedCookieManagerStub.prototype.setCanonicalCookie = function(cookie, url, siteForCookies, topFrameOrigin, status) {
    return this.delegate_ && this.delegate_.setCanonicalCookie && this.delegate_.setCanonicalCookie(cookie, url, siteForCookies, topFrameOrigin, status);
  }
  ...
  RestrictedCookieManagerStub.prototype.setCookieFromString = function(url, siteForCookies, topFrameOrigin, cookie, partitionedCookiesRuntimeFeatureEnabled) {
    return this.delegate_ && this.delegate_.setCookieFromString && this.delegate_.setCookieFromString(url, siteForCookies, topFrameOrigin, cookie, partitionedCookiesRuntimeFeatureEnabled);
  }
  RestrictedCookieManagerStub.prototype.getCookiesString = function(url, siteForCookies, topFrameOrigin, partitionedCookiesRuntimeFeatureEnabled) {
    return this.delegate_ && this.delegate_.getCookiesString && this.delegate_.getCookiesString(url, siteForCookies, topFrameOrigin, partitionedCookiesRuntimeFeatureEnabled);
  }
  ...
  RestrictedCookieManagerStub.prototype.convertPartitionedCookiesToUnpartitioned = function(url) {
    return this.delegate_ && this.delegate_.convertPartitionedCookiesToUnpartitioned && this.delegate_.convertPartitionedCookiesToUnpartitioned(url);
  }

  RestrictedCookieManagerStub.prototype.accept = function(message) {
    var reader = new codec.MessageReader(message);
    switch (reader.messageName) {
    case kRestrictedCookieManager_ConvertPartitionedCookiesToUnpartitioned_Name:
      var params = reader.decodeStruct(RestrictedCookieManager_ConvertPartitionedCookiesToUnpartitioned_Params);
      this.convertPartitionedCookiesToUnpartitioned(params.url);
      return true;
    default:
      return false;
    }
  ...
  RestrictedCookieManagerStub.prototype.acceptWithResponder =
    ...
    case kRestrictedCookieManager_GetAllForUrl_Name:
      ...
      this.getAllForUrl(params.url, params.siteForCookies, params.topFrameOrigin, params.options, params.partitionedCookiesRuntimeFeatureEnabled).then(function(response) {
        var responseParams =
    ...
    case kRestrictedCookieManager_SetCanonicalCookie_Name:
      ...
      this.setCanonicalCookie(params.cookie, params.url, params.siteForCookies, params.topFrameOrigin, params.status).then(function(response) {
        var responseParams =
    ...
    case kRestrictedCookieManager_SetCookieFromString_Name:
      ...
      this.setCookieFromString(params.url, params.siteForCookies, params.topFrameOrigin, params.cookie, params.partitionedCookiesRuntimeFeatureEnabled).then(function(response) {
        var responseParams =
            new RestrictedCookieManager_SetCookieFromString_ResponseParams();
        responseParams.siteForCookiesOk = response.siteForCookiesOk;
        responseParams.topFrameOriginOk = response.topFrameOriginOk;
        var builder = new codec.MessageV1Builder(
            kRestrictedCookieManager_SetCookieFromString_Name,
    ...
    case kRestrictedCookieManager_GetCookiesString_Name:
      ...
      this.getCookiesString(params.url, params.siteForCookies, params.topFrameOrigin, params.partitionedCookiesRuntimeFeatureEnabled).then(function(response) {
        var responseParams =
    ...
    switch (message.getName()) {
      ...
      case kRestrictedCookieManager_ConvertPartitionedCookiesToUnpartitioned_Name:
        if (!message.expectsResponse() && !message.isResponse())
          paramsClass = RestrictedCookieManager_ConvertPartitionedCookiesToUnpartitioned_Params;
      break;
    }
    if (paramsClass === null)
      return validator.validationError.NONE;
