...
static NOINLINE const char* LoadingModeToStringHelper(LoadingMode value)
{
...
std::ostream& operator<<(std::ostream& os, LoadingMode value) { return os << LoadingModeToString(value); }
