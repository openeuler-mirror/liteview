...
// with not having this data in traces there.
    ...
    virtual void OnRawRequest(const WTF::String& devtool_request_id, WTF::Vector<::network::mojom::blink::CookieWithAccessResultPtr> cookies_with_access_result,
        WTF::Vector<::network::mojom::blink::HttpRawHeaderPairPtr> headers, ::base::TimeTicks timestamp, ::network::mojom::blink::ClientSecurityStatePtr client_security_state)
        = 0;

    virtual void OnRawResponse(const WTF::String& devtool_request_id, WTF::Vector<::network::mojom::blink::CookieAndLineWithAccessResultPtr> cookies_with_access_result,
        WTF::Vector<::network::mojom::blink::HttpRawHeaderPairPtr> headers, const WTF::String& raw_response_headers, ::network::mojom::blink::IPAddressSpace resource_address_space,
...
//   WTF::Vector<::network::mojom::blink::HttpRawHeaderPairPtr> headers, ::base::TimeTicks timestamp, ::network::mojom::blink::ClientSecurityStatePtr client_security_state) final;
//
...
//   WTF::Vector<::network::mojom::blink::HttpRawHeaderPairPtr> headers, const WTF::String& raw_response_headers, ::network::mojom::blink::IPAddressSpace resource_address_space,
//   int32_t http_status_code) final;
//
//   void OnPrivateNetworkRequest(const WTF::String& devtool_request_id, const ::blink::KURL& url, bool is_warning, ::network::mojom::blink::IPAddressSpace resource_address_space,
//   ::network::mojom::blink::ClientSecurityStatePtr client_security_state) final;
//
//   void OnCorsPreflightRequest(const ::base::UnguessableToken& devtool_request_id, const ::net::HttpRequestHeaders& request_headers, URLRequestDevToolsInfoPtr request_info, const
//   ::blink::KURL& initiator_url, const WTF::String& initiator_devtool_request_id) final;
//
...
//
//   void OnCorsError(const WTF::String& devtool_request_id, const ::scoped_refptr<const ::blink::SecurityOrigin>& initiator_origin, ::network::mojom::blink::ClientSecurityStatePtr
//   client_security_state, const ::blink::KURL& url, ::network::mojom::blink::CorsErrorStatusPtr status, bool is_warning) final;
//
...
//
//   void OnSubresourceWebBundleInnerResponseError(const WTF::String& inner_request_devtools_id, const ::blink::KURL& url, const WTF::String& error_message, const WTF::String&
//   bundle_request_devtools_id) final;
//
...
public:
    ...
    template <typename... Args> static URLRequestDevToolsInfoPtr New(Args&&... args) { return URLRequestDevToolsInfoPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static URLRequestDevToolsInfoPtr From(const U& u) { return mojo::TypeConverter<URLRequestDevToolsInfoPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, URLRequestDevToolsInfo>::Convert(*this); }
    ...
    URLRequestDevToolsInfo(const WTF::String& method_in, const ::blink::KURL& url_in, ::net::RequestPriority priority_in, ::net::ReferrerPolicy referrer_policy_in,
        ::network::mojom::blink::TrustTokenParamsPtr trust_token_params_in, bool has_user_gesture_in, uint32_t resource_type_in)
    ...
    template <typename T, URLRequestDevToolsInfo::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    ...
    {
        return mojo::Message(std::make_unique<internal::URLRequestDevToolsInfo_UnserializedMessageContext<UserType, URLRequestDevToolsInfo::DataView>>(0, 0, std::move(input)),
    ...
    {
        return URLRequestDevToolsInfo::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, URLRequestDevToolsInfo::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, URLRequestDevToolsInfo::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, URLRequestDevToolsInfo::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static URLResponseHeadDevToolsInfoPtr New(Args&&... args) { return URLResponseHeadDevToolsInfoPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static URLResponseHeadDevToolsInfoPtr From(const U& u) { return mojo::TypeConverter<URLResponseHeadDevToolsInfoPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, URLResponseHeadDevToolsInfo>::Convert(*this); }
    ...
    URLResponseHeadDevToolsInfo(::base::Time response_time_in, ::network::mojom::blink::HttpResponseHeadersPtr headers_in, const WTF::String& mime_type_in,
    ...
    template <typename T, URLResponseHeadDevToolsInfo::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static WTF::Vector<uint8_t> Serialize(UserType* input)
    {
    ...
    {
        return mojo::Message(
            std::make_unique<internal::URLResponseHeadDevToolsInfo_UnserializedMessageContext<UserType, URLResponseHeadDevToolsInfo::DataView>>(0, 0, std::move(input)),
            MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const WTF::Vector<uint8_t>& input, UserType* output)
    {
        return URLResponseHeadDevToolsInfo::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }

    template <typename UserType> static bool DeserializeFromMessage(mojo::Message input, UserType* output)
    {
        auto context = input.TakeUnserializedContext<internal::URLResponseHeadDevToolsInfo_UnserializedMessageContext<UserType, URLResponseHeadDevToolsInfo::DataView>>();
        if (context) {
            *output = std::move(context->TakeData());
            return true;
        }
...
template <typename T, URLResponseHeadDevToolsInfo::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, URLResponseHeadDevToolsInfo::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, URLResponseHeadDevToolsInfo::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }

template <typename StructPtrType> URLRequestDevToolsInfoPtr URLRequestDevToolsInfo::Clone() const
{
    return New(mojo::Clone(method), mojo::Clone(url), mojo::Clone(priority), mojo::Clone(referrer_policy), mojo::Clone(trust_token_params), mojo::Clone(has_user_gesture),
...
{
    return New(mojo::Clone(response_time), mojo::Clone(headers), mojo::Clone(mime_type), mojo::Clone(load_timing), mojo::Clone(cert_status), mojo::Clone(encoded_data_length),
        mojo::Clone(was_in_prefetch_cache), mojo::Clone(was_fetched_via_service_worker), mojo::Clone(cache_storage_cache_name), mojo::Clone(alpn_negotiated_protocol),
        mojo::Clone(alternate_protocol_usage), mojo::Clone(was_fetched_via_spdy), mojo::Clone(service_worker_response_source), mojo::Clone(ssl_info), mojo::Clone(remote_endpoint),
...
namespace mojo {
template <> struct BLINK_PLATFORM_EXPORT StructTraits<::network::mojom::blink::URLRequestDevToolsInfo::DataView, ::network::mojom::blink::URLRequestDevToolsInfoPtr> {
    ...
    static const decltype(::network::mojom::blink::URLRequestDevToolsInfo::url)& url(const ::network::mojom::blink::URLRequestDevToolsInfoPtr& input) { return input->url; }

    static decltype(::network::mojom::blink::URLRequestDevToolsInfo::priority) priority(const ::network::mojom::blink::URLRequestDevToolsInfoPtr& input) { return input->priority; }

    static decltype(::network::mojom::blink::URLRequestDevToolsInfo::referrer_policy) referrer_policy(const ::network::mojom::blink::URLRequestDevToolsInfoPtr& input)
    {
        return input->referrer_policy;
    }

    static const decltype(::network::mojom::blink::URLRequestDevToolsInfo::trust_token_params)& trust_token_params(const ::network::mojom::blink::URLRequestDevToolsInfoPtr& input)
    {
        return input->trust_token_params;
    }

    static decltype(::network::mojom::blink::URLRequestDevToolsInfo::has_user_gesture) has_user_gesture(const ::network::mojom::blink::URLRequestDevToolsInfoPtr& input)
    {
        return input->has_user_gesture;
    }

    static decltype(::network::mojom::blink::URLRequestDevToolsInfo::resource_type) resource_type(const ::network::mojom::blink::URLRequestDevToolsInfoPtr& input)
    {
...
template <> struct BLINK_PLATFORM_EXPORT StructTraits<::network::mojom::blink::URLResponseHeadDevToolsInfo::DataView, ::network::mojom::blink::URLResponseHeadDevToolsInfoPtr> {
    ...
    static const decltype(::network::mojom::blink::URLResponseHeadDevToolsInfo::response_time)& response_time(const ::network::mojom::blink::URLResponseHeadDevToolsInfoPtr& input)
    {
        return input->response_time;
    }

    static const decltype(::network::mojom::blink::URLResponseHeadDevToolsInfo::headers)& headers(const ::network::mojom::blink::URLResponseHeadDevToolsInfoPtr& input)
    {
        return input->headers;
    }

    static const decltype(::network::mojom::blink::URLResponseHeadDevToolsInfo::mime_type)& mime_type(const ::network::mojom::blink::URLResponseHeadDevToolsInfoPtr& input)
    {
        return input->mime_type;
    }

    static const decltype(::network::mojom::blink::URLResponseHeadDevToolsInfo::load_timing)& load_timing(const ::network::mojom::blink::URLResponseHeadDevToolsInfoPtr& input)
    {
        return input->load_timing;
    }

    static decltype(::network::mojom::blink::URLResponseHeadDevToolsInfo::cert_status) cert_status(const ::network::mojom::blink::URLResponseHeadDevToolsInfoPtr& input)
    {
    ...
    static const decltype(::network::mojom::blink::URLResponseHeadDevToolsInfo::ssl_info)& ssl_info(const ::network::mojom::blink::URLResponseHeadDevToolsInfoPtr& input)
    {
