...
inline bool IsKnownEnumValue(TrustTokenProtocolVersion value) { return internal::TrustTokenProtocolVersion_Data::IsKnownValue(static_cast<int32_t>(value)); }
...
inline bool IsKnownEnumValue(TrustTokenOperationStatus value) { return internal::TrustTokenOperationStatus_Data::IsKnownValue(static_cast<int32_t>(value)); }
...
inline bool IsKnownEnumValue(TrustTokenOperationType value) { return internal::TrustTokenOperationType_Data::IsKnownValue(static_cast<int32_t>(value)); }
...
inline bool IsKnownEnumValue(TrustTokenRefreshPolicy value) { return internal::TrustTokenRefreshPolicy_Data::IsKnownValue(static_cast<int32_t>(value)); }
...
inline bool IsKnownEnumValue(TrustTokenSignRequestData value) { return internal::TrustTokenSignRequestData_Data::IsKnownValue(static_cast<int32_t>(value)); }
...
inline bool IsKnownEnumValue(DeleteStoredTrustTokensStatus value) { return internal::DeleteStoredTrustTokensStatus_Data::IsKnownValue(static_cast<int32_t>(value)); }
...
inline bool IsKnownEnumValue(TrustTokenKeyCommitmentResult_Os value) { return internal::TrustTokenKeyCommitmentResult_Os_Data::IsKnownValue(static_cast<int32_t>(value)); }
...
public:
    ...
    TrustTokenOperationType type() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::network::mojom::TrustTokenOperationType>(data_->type)); }
    ...
    bool include_timestamp_header() const { return data_->include_timestamp_header; }
...
public:
    ...
    TrustTokenOperationStatus status() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::network::mojom::TrustTokenOperationStatus>(data_->status)); }
    bool has_trust_tokens() const { return data_->has_trust_tokens; }
...
public:
    ...
    TrustTokenOperationStatus status() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::network::mojom::TrustTokenOperationStatus>(data_->status)); }
    bool has_redemption_record() const { return data_->has_redemption_record; }
...
public:
    ...
    int32_t batch_size() const { return data_->batch_size; }
...
public:
    ...
    int32_t issued_token_count() const { return data_->issued_token_count; }
...
template <> struct hash<::network::mojom::DeleteStoredTrustTokensStatus> : public mojo::internal::EnumHashImpl<::network::mojom::DeleteStoredTrustTokensStatus> { };

template <> struct hash<::network::mojom::TrustTokenKeyCommitmentResult_Os> : public mojo::internal::EnumHashImpl<::network::mojom::TrustTokenKeyCommitmentResult_Os> { };
...
template <>
struct hash<::network::mojom::FulfillTrustTokenIssuanceAnswer_Status> : public mojo::internal::EnumHashImpl<::network::mojom::FulfillTrustTokenIssuanceAnswer_Status> { };
...
template <typename MaybeConstUserType> struct Serializer<::network::mojom::TrustTokenKeyCommitmentResult_UnavailableLocalOperationFallback, MaybeConstUserType> {
    using UserType = typename std::remove_const<MaybeConstUserType>::type;
    ...
    static bool Deserialize(int32_t input, UserType* output)
    {
        return Traits::FromMojom(
            ::mojo::internal::ToKnownEnumValueHelper(static_cast<::network::mojom::TrustTokenKeyCommitmentResult_UnavailableLocalOperationFallback>(input)), output);
    }
};
...
template <typename MaybeConstUserType> struct Serializer<::network::mojom::FulfillTrustTokenIssuanceAnswer_Status, MaybeConstUserType> {
    ...
    static bool Deserialize(int32_t input, UserType* output)
    {
        return Traits::FromMojom(::mojo::internal::ToKnownEnumValueHelper(static_cast<::network::mojom::FulfillTrustTokenIssuanceAnswer_Status>(input)), output);
    }
};
...
template <typename MaybeConstUserType> struct Serializer<::network::mojom::TrustTokenParamsDataView, MaybeConstUserType> {
    ...
    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::network::mojom::internal::TrustTokenParams_Data>& fragment)
    {
        if (CallIsNullIfExists<Traits>(input))
            return;
        fragment.Allocate();
        mojo::internal::Serialize<::network::mojom::TrustTokenOperationType>(Traits::type(input), &fragment->type);
        ...
        const mojo::internal::ContainerValidateParams issuers_validate_params(0, false, nullptr);
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->issuers.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null issuers in TrustTokenParams struct");
        decltype(Traits::additional_signed_headers(input)) in_additional_signed_headers = Traits::additional_signed_headers(input);
        mojo::internal::MessageFragment<typename decltype(fragment->additional_signed_headers)::BaseType> additional_signed_headers_fragment(fragment.message());
        const mojo::internal::ContainerValidateParams additional_signed_headers_validate_params(0, false, new mojo::internal::ContainerValidateParams(0, false, nullptr));
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
            fragment->additional_signed_headers.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null additional_signed_headers in TrustTokenParams struct");
        ...
        mojo::internal::MessageFragment<typename decltype(fragment->possibly_unsafe_additional_signing_data)::BaseType> possibly_unsafe_additional_signing_data_fragment(
            fragment.message());
...
template <typename MaybeConstUserType> struct Serializer<::network::mojom::TrustTokenKeyCommitmentResultDataView, MaybeConstUserType> {
    ...
    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::network::mojom::internal::TrustTokenKeyCommitmentResult_Data>& fragment)
    {
        ...
        mojo::internal::MessageFragment<typename decltype(fragment->request_issuance_locally_on)::BaseType> request_issuance_locally_on_fragment(fragment.message());
        const mojo::internal::ContainerValidateParams request_issuance_locally_on_validate_params(0, ::network::mojom::internal::TrustTokenKeyCommitmentResult_Os_Data::Validate);
...
template <typename MaybeConstUserType> struct Serializer<::network::mojom::FulfillTrustTokenIssuanceRequestDataView, MaybeConstUserType> {
    ...
    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::network::mojom::internal::FulfillTrustTokenIssuanceRequest_Data>& fragment)
    {
        if (CallIsNullIfExists<Traits>(input))
            return;
        fragment.Allocate();
...
template <typename MaybeConstUserType> struct Serializer<::network::mojom::FulfillTrustTokenIssuanceAnswerDataView, MaybeConstUserType> {
    ...
    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::network::mojom::internal::FulfillTrustTokenIssuanceAnswer_Data>& fragment)
    {
        if (CallIsNullIfExists<Traits>(input))
            return;
        fragment.Allocate();
