// services/network/public/mojom/mdns_responder.mojom-lite-for-compile.js is auto generated by mojom_bindings_generator.py, do not edit
...
goog.provide('network.mojom.MdnsResponderReceiver');
goog.provide('network.mojom.MdnsResponderCallbackRouter');
goog.provide('network.mojom.MdnsResponderInterface');
goog.provide('network.mojom.MdnsResponderRemote');
goog.provide('network.mojom.MdnsResponderPendingReceiver');
/**
...
/** @interface */
network.mojom.MdnsResponderInterface = class {
...
goog.provide('network.mojom.MdnsResponder_CreateNameForAddress_ParamsSpec');
/**
...
goog.provide('network.mojom.MdnsResponder_CreateNameForAddress_ResponseParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('network.mojom.MdnsResponder_RemoveNameForAddress_ParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('network.mojom.MdnsResponder_RemoveNameForAddress_ResponseParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
