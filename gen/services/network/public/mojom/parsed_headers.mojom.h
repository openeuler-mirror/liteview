...
public:
    ...
    ParsedHeaders(std::vector<::network::mojom::ContentSecurityPolicyPtr> content_security_policy_in, ::network::mojom::AllowCSPFromHeaderValuePtr allow_csp_from_in,
...
template <> struct StructTraits<::network::mojom::ParsedHeaders::DataView, ::network::mojom::ParsedHeadersPtr> {
    ...
    static const decltype(::network::mojom::ParsedHeaders::allow_csp_from)& allow_csp_from(const ::network::mojom::ParsedHeadersPtr& input) { return input->allow_csp_from; }

    static const decltype(::network::mojom::ParsedHeaders::cross_origin_embedder_policy)& cross_origin_embedder_policy(const ::network::mojom::ParsedHeadersPtr& input)
    {
        return input->cross_origin_embedder_policy;
    }

    static const decltype(::network::mojom::ParsedHeaders::cross_origin_opener_policy)& cross_origin_opener_policy(const ::network::mojom::ParsedHeadersPtr& input)
    {
    ...
    static const decltype(::network::mojom::ParsedHeaders::accept_ch)& accept_ch(const ::network::mojom::ParsedHeadersPtr& input) { return input->accept_ch; }

    static const decltype(::network::mojom::ParsedHeaders::critical_ch)& critical_ch(const ::network::mojom::ParsedHeadersPtr& input) { return input->critical_ch; }

    static decltype(::network::mojom::ParsedHeaders::xfo) xfo(const ::network::mojom::ParsedHeadersPtr& input) { return input->xfo; }

    static const decltype(::network::mojom::ParsedHeaders::link_headers)& link_headers(const ::network::mojom::ParsedHeadersPtr& input) { return input->link_headers; }
    ...
    static const decltype(::network::mojom::ParsedHeaders::variants_headers)& variants_headers(const ::network::mojom::ParsedHeadersPtr& input) { return input->variants_headers; }

    static const decltype(::network::mojom::ParsedHeaders::content_language)& content_language(const ::network::mojom::ParsedHeadersPtr& input) { return input->content_language; }
