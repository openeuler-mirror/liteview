...
static_assert(sizeof(WebSocketAuthenticationHandler_OnAuthRequired_ResponseParams_Data) == 16, "Bad sizeof(WebSocketAuthenticationHandler_OnAuthRequired_ResponseParams_Data)");
...
static_assert(sizeof(WebSocketHandshakeClient_OnOpeningHandshakeStarted_Params_Data) == 16, "Bad sizeof(WebSocketHandshakeClient_OnOpeningHandshakeStarted_Params_Data)");
...
static_assert(sizeof(WebSocketHandshakeClient_OnConnectionEstablished_Params_Data) == 40, "Bad sizeof(WebSocketHandshakeClient_OnConnectionEstablished_Params_Data)");
...
public:
    ...
    WebSocketAuthenticationHandler_OnAuthRequired_ParamsDataView(internal::WebSocketAuthenticationHandler_OnAuthRequired_Params_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
...
public:
    ...
    WebSocketAuthenticationHandler_OnAuthRequired_ResponseParamsDataView(internal::WebSocketAuthenticationHandler_OnAuthRequired_ResponseParams_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
...
public:
    ...
    WebSocketHandshakeClient_OnOpeningHandshakeStarted_ParamsDataView(internal::WebSocketHandshakeClient_OnOpeningHandshakeStarted_Params_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
...
public:
    ...
    int32_t response_code() const { return data_->response_code; }
...
public:
    ...
    WebSocketHandshakeClient_OnConnectionEstablished_ParamsDataView(internal::WebSocketHandshakeClient_OnConnectionEstablished_Params_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
    ...
    {
        UserType result;
        bool ret = mojo::internal::Deserialize<mojo::InterfaceRequestDataView<::network::mojom::WebSocketClientInterfaceBase>>(&data_->client_receiver, &result, message_);
        DCHECK(ret);
        return result;
    }
...
public:
    ...
    bool is_null() const { return !data_; }
    bool fin() const { return data_->fin; }
    ...
    WebSocketMessageType type() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::network::mojom::WebSocketMessageType>(data_->type)); }
    uint64_t data_length() const { return data_->data_length; }
...
public:
    ...
    bool is_null() const { return !data_; }
    bool was_clean() const { return data_->was_clean; }
