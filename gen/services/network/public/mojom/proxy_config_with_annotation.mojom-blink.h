...
public:
    ...
    ProxyConfigWithAnnotation(::network::mojom::blink::ProxyConfigPtr value_in, const ::net::MutableNetworkTrafficAnnotationTag& traffic_annotation_in)
...
template <> struct StructTraits<::network::mojom::blink::ProxyConfigWithAnnotation::DataView, ::network::mojom::blink::ProxyConfigWithAnnotationPtr> {
    ...
    static decltype(::network::mojom::blink::ProxyConfigWithAnnotation::value)& value(::network::mojom::blink::ProxyConfigWithAnnotationPtr& input) { return input->value; }
