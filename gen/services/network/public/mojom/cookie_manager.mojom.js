...
(function() {
  ...
  CookieOptions.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 16, first_party_sets$.SamePartyContext, false);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  CookieOptions.decode = function(decoder) {
    ...
    val.samePartyContext =
        decoder.decodeStructPointer(first_party_sets$.SamePartyContext);
    return val;
  };
  ...
  CookieOptions.encode = function(encoder, val) {
    ...
    encoder.encodeStructPointer(first_party_sets$.SamePartyContext, val.samePartyContext);
  };
  ...
  CookieDeletionFilter.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 64, cookie_partition_key$.CookiePartitionKeyCollection, false);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  function CookieManager_ConvertPartitionedCookiesToUnpartitioned_Params(values) {
    this.initDefaults_();
    this.initFields_(values);
  }
  CookieManager_ConvertPartitionedCookiesToUnpartitioned_Params.prototype.initDefaults_ = function() {
    this.url = null;
  };
  CookieManager_ConvertPartitionedCookiesToUnpartitioned_Params.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  CookieManager_ConvertPartitionedCookiesToUnpartitioned_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    if (err !== validator.validationError.NONE)
        return err;
    // validate CookieManager_ConvertPartitionedCookiesToUnpartitioned_Params.url
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 0, url$.Url, false);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  CookieManager_ConvertPartitionedCookiesToUnpartitioned_Params.encodedSize = codec.kStructHeaderSize + 8;

  CookieManager_ConvertPartitionedCookiesToUnpartitioned_Params.decode = function(decoder) {
    var packed;
    var val = new CookieManager_ConvertPartitionedCookiesToUnpartitioned_Params();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.url =
        decoder.decodeStructPointer(url$.Url);
  ...
  CookieManager_ConvertPartitionedCookiesToUnpartitioned_Params.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(CookieManager_ConvertPartitionedCookiesToUnpartitioned_Params.encodedSize);
    encoder.writeUint32(0);
    encoder.encodeStructPointer(url$.Url, val.url);
  };
  ...
  var kCookieChangeListener_OnCookieChange_Name = 877648724;
  ...
  var kCookieManager_GetAllCookies_Name = 1673693209;
  var kCookieManager_GetAllCookiesWithAccessSemantics_Name = 1275719243;
  var kCookieManager_GetCookieList_Name = 106294093;
  var kCookieManager_SetCanonicalCookie_Name = 1174282826;
  var kCookieManager_DeleteCanonicalCookie_Name = 544198186;
  var kCookieManager_DeleteCookies_Name = 75856560;
  var kCookieManager_DeleteSessionOnlyCookies_Name = 198722651;
  var kCookieManager_AddCookieChangeListener_Name = 84102207;
  var kCookieManager_AddGlobalChangeListener_Name = 755796177;
  var kCookieManager_CloneInterface_Name = 2074648698;
  var kCookieManager_FlushCookieStore_Name = 1649699765;
  var kCookieManager_AllowFileSchemeCookies_Name = 1062080122;
  var kCookieManager_SetContentSettings_Name = 156930437;
  var kCookieManager_SetForceKeepSessionState_Name = 1957508267;
  var kCookieManager_BlockThirdPartyCookies_Name = 1646300841;
  var kCookieManager_SetContentSettingsForLegacyCookieAccess_Name = 717200928;
  var kCookieManager_SetStorageAccessGrantSettings_Name = 1599634375;
  var kCookieManager_ConvertPartitionedCookiesToUnpartitioned_Name = 1317860538;
  ...
  CookieManagerPtr.prototype.convertPartitionedCookiesToUnpartitioned = function() {
    return CookieManagerProxy.prototype.convertPartitionedCookiesToUnpartitioned
        .apply(this.ptr.getProxy(), arguments);
  };

  CookieManagerProxy.prototype.convertPartitionedCookiesToUnpartitioned = function(url) {
    var params_ = new CookieManager_ConvertPartitionedCookiesToUnpartitioned_Params();
    params_.url = url;
    var builder = new codec.MessageV0Builder(
        kCookieManager_ConvertPartitionedCookiesToUnpartitioned_Name,
        codec.align(CookieManager_ConvertPartitionedCookiesToUnpartitioned_Params.encodedSize));
    builder.encodeStruct(CookieManager_ConvertPartitionedCookiesToUnpartitioned_Params, params_);
    var message = builder.finish();
    this.receiver_.accept(message);
  };
  ...
  CookieManagerStub.prototype.convertPartitionedCookiesToUnpartitioned = function(url) {
  ...
  CookieManagerStub.prototype.accept = function(message) {
    ...
    case kCookieManager_SetContentSettingsForLegacyCookieAccess_Name:
      ...
      return true;
    case kCookieManager_ConvertPartitionedCookiesToUnpartitioned_Name:
      var params = reader.decodeStruct(CookieManager_ConvertPartitionedCookiesToUnpartitioned_Params);
  ...
  function validateCookieManagerRequest(messageValidator) {
    ...
    switch (message.getName()) {
      ...
      case kCookieManager_ConvertPartitionedCookiesToUnpartitioned_Name:
        if (!message.expectsResponse() && !message.isResponse())
          paramsClass = CookieManager_ConvertPartitionedCookiesToUnpartitioned_Params;
      break;
    }
    if (paramsClass === null)
      return validator.validationError.NONE;
