...
//
//   bool MockCertVerifierAddResultForCertAndHost(const ::scoped_refptr<::net::X509Certificate>& cert, const std::string& host_pattern, const ::net::CertVerifyResult&
//   verify_result, int32_t rv) final;
//
//   void MockCertVerifierAddResultForCertAndHost(const ::scoped_refptr<::net::X509Certificate>& cert, const std::string& host_pattern, const ::net::CertVerifyResult&
...
//
//   void EnumerateFiles(const ::base::FilePath& path, ::mojo::PendingRemote<::network::mojom::HttpCacheBackendFileOperationsFactory> factory, EnumerateFilesCallback callback)
//   final;
//
...
public:
    ...
    Rule(ResolverType resolver_type_in, const std::string& host_pattern_in, const std::string& replacement_in, int32_t host_resolver_flags_in,
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input) { return mojo::internal::SerializeImpl<Rule::DataView, std::vector<uint8_t>>(input); }
...
public:
    ...
    SimpleCacheOpenEntryResult(int32_t error_in, const std::string& key_in, ::mojo::PendingRemote<SimpleCacheEntry> entry_in)
...
template <> struct StructTraits<::network::mojom::Rule::DataView, ::network::mojom::RulePtr> {
    ...
    static decltype(::network::mojom::Rule::resolver_type) resolver_type(const ::network::mojom::RulePtr& input) { return input->resolver_type; }

    static const decltype(::network::mojom::Rule::host_pattern)& host_pattern(const ::network::mojom::RulePtr& input) { return input->host_pattern; }

    static const decltype(::network::mojom::Rule::replacement)& replacement(const ::network::mojom::RulePtr& input) { return input->replacement; }

    static decltype(::network::mojom::Rule::host_resolver_flags) host_resolver_flags(const ::network::mojom::RulePtr& input) { return input->host_resolver_flags; }

    static const decltype(::network::mojom::Rule::dns_aliases)& dns_aliases(const ::network::mojom::RulePtr& input) { return input->dns_aliases; }
...
template <> struct StructTraits<::network::mojom::SimpleCacheOpenEntryResult::DataView, ::network::mojom::SimpleCacheOpenEntryResultPtr> {
    ...
    static decltype(::network::mojom::SimpleCacheOpenEntryResult::error) error(const ::network::mojom::SimpleCacheOpenEntryResultPtr& input) { return input->error; }

    static const decltype(::network::mojom::SimpleCacheOpenEntryResult::key)& key(const ::network::mojom::SimpleCacheOpenEntryResultPtr& input) { return input->key; }

    static decltype(::network::mojom::SimpleCacheOpenEntryResult::entry)& entry(::network::mojom::SimpleCacheOpenEntryResultPtr& input) { return input->entry; }
