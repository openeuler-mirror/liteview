...
goog.provide('network.mojom.P2PSocketManager_GetHostAddressWithFamily_ParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('network.mojom.P2PSocketManager_GetHostAddressWithFamily_ResponseParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('network.mojom.P2PSocketManager_GetHostAddressWithFamily_Params');
...
goog.provide('network.mojom.P2PSocketManager_GetHostAddressWithFamily_ResponseParams');
