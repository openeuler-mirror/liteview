...
static_assert(sizeof(CertVerifierServiceRemoteParams_Data) == 16, "Bad sizeof(CertVerifierServiceRemoteParams_Data)");
// Used by CertVerifierServiceRemoteParams::WrapAsMessage to lazily serialize the struct.
template <typename UserType, typename DataView> struct CertVerifierServiceRemoteParams_UnserializedMessageContext : public mojo::internal::UnserializedMessageContext {
public:
    static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;
...
template <typename UserType, typename DataView> struct HttpAuthStaticNetworkContextParams_UnserializedMessageContext : public mojo::internal::UnserializedMessageContext {
public:
    static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;
...
static_assert(sizeof(CTPolicy_Data) == 40, "Bad sizeof(CTPolicy_Data)");
...
template <typename UserType, typename DataView> const mojo::internal::UnserializedMessageContext::Tag CTPolicy_UnserializedMessageContext<UserType, DataView>::kMessageTag = {};
class NetworkContextFilePaths_Data {
public:
    static bool Validate(const void* data, mojo::internal::ValidationContext* validation_context);
...
static_assert(sizeof(NetworkContextFilePaths_Data) == 88, "Bad sizeof(NetworkContextFilePaths_Data)");
...
static_assert(sizeof(NetworkContextParams_Data) == 248, "Bad sizeof(NetworkContextParams_Data)");
...
static_assert(sizeof(NetworkConditions_Data) == 40, "Bad sizeof(NetworkConditions_Data)");
...
static_assert(sizeof(URLLoaderFactoryParams_Data) == 112, "Bad sizeof(URLLoaderFactoryParams_Data)");
