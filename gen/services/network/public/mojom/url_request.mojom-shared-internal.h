...
static_assert(sizeof(TrustedUrlRequestParams_Data) == 64, "Bad sizeof(TrustedUrlRequestParams_Data)");
...
template <typename UserType, typename DataView> const mojo::internal::UnserializedMessageContext::Tag NetLogSource_UnserializedMessageContext<UserType, DataView>::kMessageTag = {};
class URLRequest_Data {
public:
    static bool Validate(const void* data, mojo::internal::ValidationContext* validation_context);
...
static_assert(sizeof(URLRequest_Data) == 240, "Bad sizeof(URLRequest_Data)");
...
template <typename UserType, typename DataView> const mojo::internal::UnserializedMessageContext::Tag URLRequest_UnserializedMessageContext<UserType, DataView>::kMessageTag = {};
class URLRequestBody_Data {
public:
    static bool Validate(const void* data, mojo::internal::ValidationContext* validation_context);
...
template <typename UserType, typename DataView> struct DataElementChunkedDataPipe_UnserializedMessageContext : public mojo::internal::UnserializedMessageContext {
public:
    static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;
