...
struct network_mojom_internal_HttpCacheBackendOpenFileFlags_DataHashFn {
    ...
    static bool Equal(const ::network::mojom::HttpCacheBackendOpenFileFlags& left, const ::network::mojom::HttpCacheBackendOpenFileFlags& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::network::mojom::HttpCacheBackendOpenFileFlags> : public GenericHashTraits<::network::mojom::HttpCacheBackendOpenFileFlags> {
...
struct network_mojom_internal_HttpCacheBackendDeleteFileMode_DataHashFn {
    ...
    static bool Equal(const ::network::mojom::HttpCacheBackendDeleteFileMode& left, const ::network::mojom::HttpCacheBackendDeleteFileMode& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::network::mojom::HttpCacheBackendDeleteFileMode> : public GenericHashTraits<::network::mojom::HttpCacheBackendDeleteFileMode> {
    static_assert(true, "-1000000 is a reserved enum value");
    static_assert(true, "-1000001 is a reserved enum value");
    static const bool kEmptyValueIsZero = false;
...
public:
    ...
    static inline constexpr uint32_t kSyncMethodOrdinals[] = { 1724320095 };
...
public:
    ...
    static constexpr uint32_t Version_ = 0;
    static constexpr bool PassesAssociatedKinds_ = false;
    static inline constexpr uint32_t kSyncMethodOrdinals[] = { 599905491, 1005439545, 1123633917, 1665818315, 1689734232, 1949158822, 2093781749 };
    static constexpr bool HasUninterruptableMethods_ = false;
...
public:
    ...
    template <typename... Args> static FileEnumerationEntryPtr New(Args&&... args) { return FileEnumerationEntryPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static FileEnumerationEntryPtr From(const U& u) { return mojo::TypeConverter<FileEnumerationEntryPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, FileEnumerationEntry>::Convert(*this); }
    ...
    template <typename T, FileEnumerationEntry::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    ...
    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<FileEnumerationEntry::DataView>(input); }
    ...
    {
        return mojo::Message(std::make_unique<internal::FileEnumerationEntry_UnserializedMessageContext<UserType, FileEnumerationEntry::DataView>>(0, 0, std::move(input)),
    ...
    {
        return FileEnumerationEntry::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, FileEnumerationEntry::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, FileEnumerationEntry::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, FileEnumerationEntry::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
namespace mojo {
template <> struct BLINK_PLATFORM_EXPORT StructTraits<::network::mojom::blink::FileEnumerationEntry::DataView, ::network::mojom::blink::FileEnumerationEntryPtr> {
    ...
    static const decltype(::network::mojom::blink::FileEnumerationEntry::path)& path(const ::network::mojom::blink::FileEnumerationEntryPtr& input) { return input->path; }

    static decltype(::network::mojom::blink::FileEnumerationEntry::size) size(const ::network::mojom::blink::FileEnumerationEntryPtr& input) { return input->size; }

    static const decltype(::network::mojom::blink::FileEnumerationEntry::last_accessed)& last_accessed(const ::network::mojom::blink::FileEnumerationEntryPtr& input)
    {
        return input->last_accessed;
    }

    static const decltype(::network::mojom::blink::FileEnumerationEntry::last_modified)& last_modified(const ::network::mojom::blink::FileEnumerationEntryPtr& input)
    {
