...
IsolationInfo::IsolationInfo(IsolationInfoRequestType request_type_in, const absl::optional<::url::Origin>& top_frame_origin_in,
    const absl::optional<::url::Origin>& frame_origin_in, const absl::optional<::base::UnguessableToken>& nonce_in, const ::net::SiteForCookies& site_for_cookies_in,
...
void IsolationInfo::WriteIntoTrace(perfetto::TracedValue traced_context) const
{
    ...
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("party_context"), this->party_context,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
        "<value of type const absl::optional<std::vector<::net::SchemefulSite>>&>"
#else
        "<value>"
#endif // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
bool IsolationInfo::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
} // namespace mojom
} // namespace network
namespace mojo {
// static
