...
static_assert(sizeof(P2PTrustedSocketManager_PauseNetworkChangeNotifications_Params_Data) == 8, "Bad sizeof(P2PTrustedSocketManager_PauseNetworkChangeNotifications_Params_Data)");
...
static_assert(
    sizeof(P2PTrustedSocketManager_ResumeNetworkChangeNotifications_Params_Data) == 8, "Bad sizeof(P2PTrustedSocketManager_ResumeNetworkChangeNotifications_Params_Data)");
...
public:
    ...
    uint64_t packet_length() const { return data_->packet_length; }
    bool incoming() const { return data_->incoming; }
...
public:
    ...
    bool is_null() const { return !data_; }
    bool incoming() const { return data_->incoming; }
    bool outgoing() const { return data_->outgoing; }
