...
static NOINLINE const char* WebSandboxFlagsToStringHelper(WebSandboxFlags value)
{
...
std::ostream& operator<<(std::ostream& os, WebSandboxFlags value) { return os << WebSandboxFlagsToString(value); }
