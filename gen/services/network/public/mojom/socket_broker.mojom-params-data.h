...
public:
    ...
    ::network::mojom::AddressFamily address_family() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::network::mojom::AddressFamily>(data_->address_family)); }
