...
template <> struct StructTraits<::network::mojom::UDPSocketOptions::DataView, ::network::mojom::UDPSocketOptionsPtr> {
    ...
    static decltype(::network::mojom::UDPSocketOptions::allow_broadcast) allow_broadcast(const ::network::mojom::UDPSocketOptionsPtr& input) { return input->allow_broadcast; }

    static decltype(::network::mojom::UDPSocketOptions::allow_address_sharing_for_multicast) allow_address_sharing_for_multicast(const ::network::mojom::UDPSocketOptionsPtr& input)
    {
    ...
    static decltype(::network::mojom::UDPSocketOptions::send_buffer_size) send_buffer_size(const ::network::mojom::UDPSocketOptionsPtr& input) { return input->send_buffer_size; }
