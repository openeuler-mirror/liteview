...
#ifndef SERVICES_NETWORK_PUBLIC_MOJOM_CORS_MOJOM_BLINK_JUMBO_H_
#define SERVICES_NETWORK_PUBLIC_MOJOM_CORS_MOJOM_BLINK_JUMBO_H_
#endif
...
CorsErrorStatus::CorsErrorStatus(CorsError cors_error_in, const WTF::String& failed_parameter_in, ::network::mojom::blink::IPAddressSpace target_address_space_in,
...
bool CorsErrorStatus::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
} // namespace blink
} // namespace mojom
} // namespace network
namespace mojo {
