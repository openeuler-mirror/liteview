...
std::ostream& operator<<(std::ostream& os, HashAlgorithm value) { return os << HashAlgorithmToString(value); }
...
std::ostream& operator<<(std::ostream& os, SignatureAlgorithm value) { return os << SignatureAlgorithmToString(value); }
