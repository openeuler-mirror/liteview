...
(function() {
  ...
  ReportingApiEndpoint.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 48, network_anonymization_key$.NetworkAnonymizationKey, false);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  ReportingApiEndpoint.encodedSize = codec.kStructHeaderSize + 64;
  ...
  var kReportingApiObserver_OnReportAdded_Name = 146873296;
  var kReportingApiObserver_OnReportUpdated_Name = 1104158782;
  var kReportingApiObserver_OnEndpointsUpdatedForOrigin_Name = 1117395103;
