...
CustomProxyConfig::CustomProxyConfig(const ::net::ProxyConfig::ProxyRules& rules_in, bool should_override_existing_config_in, bool allow_non_idempotent_methods_in,
...
CTPolicy::CTPolicy(std::vector<std::string> required_hosts_in, std::vector<std::string> excluded_hosts_in, std::vector<std::string> excluded_spkis_in,
...
NetworkContextFilePaths::NetworkContextFilePaths(::network::TransferableDirectory data_directory_in, const absl::optional<::base::FilePath>& unsandboxed_data_path_in,
...
NetworkContextParams::NetworkContextParams(const std::string& user_agent_in, const std::string& accept_language_in, bool enable_brotli_in, const std::string& quic_user_agent_id_in,
    ...
    ::mojo::PendingRemote<::network::mojom::HttpCacheBackendFileOperationsFactory> http_cache_file_operations_factory_in, bool disable_idle_sockets_close_on_memory_pressure_in,
    ::network::mojom::SSLConfigPtr initial_ssl_config_in, ::mojo::PendingReceiver<::network::mojom::SSLConfigClient> ssl_config_client_receiver_in,
    const absl::optional<::net::ProxyConfigWithAnnotation>& initial_proxy_config_in, ::mojo::PendingReceiver<::network::mojom::ProxyConfigClient> proxy_config_client_receiver_in,
    CustomProxyConfigPtr initial_custom_proxy_config_in, ::mojo::PendingReceiver<CustomProxyConfigClient> custom_proxy_config_client_receiver_in,
    ::mojo::PendingRemote<CustomProxyConnectionObserver> custom_proxy_connection_observer_remote_in,
    ::mojo::PendingRemote<::network::mojom::ProxyConfigPollerClient> proxy_config_poller_client_in, ::mojo::PendingRemote<::network::mojom::ProxyErrorClient> proxy_error_client_in,
    ::mojo::PendingRemote<::network::mojom::SocketBroker> socket_broker_in, bool pac_quick_check_enabled_in, bool enable_certificate_reporting_in, bool enforce_chrome_ct_policy_in,
    bool enable_expect_ct_reporting_in, SCTAuditingMode sct_auditing_mode_in, CTPolicyPtr ct_policy_in, CertVerifierServiceRemoteParamsPtr cert_verifier_params_in,
    ::network::mojom::CookieManagerParamsPtr cookie_manager_params_in, bool enable_domain_reliability_in, const std::string& domain_reliability_upload_reporter_in,
...
SignedExchangeReport::SignedExchangeReport(bool success_in, const std::string& type_in, const ::GURL& outer_url_in, const ::GURL& inner_url_in, const ::GURL& cert_url_in,
    const std::string& referrer_in, const ::net::IPAddress& server_ip_address_in, const std::string& protocol_in, const std::string& method_in, int32_t status_code_in,
...
URLLoaderFactoryParams::URLLoaderFactoryParams(int32_t process_id_in, const absl::optional<::url::Origin>& request_initiator_origin_lock_in, bool is_corb_enabled_in,
    bool ignore_isolated_world_origin_in, bool unsafe_non_webby_initiator_in, bool disable_web_security_in, ::mojo::PendingRemote<TrustedURLLoaderHeaderClient> header_client_in,
    const ::net::IsolationInfo& isolation_info_in, bool disable_secure_dns_in, bool is_trusted_in, bool automatically_assign_isolation_info_in,
    bool provide_loading_state_updates_in, const absl::optional<::base::UnguessableToken>& top_frame_id_in, URLLoaderFactoryOverridePtr factory_override_in,
    ::network::mojom::ClientSecurityStatePtr client_security_state_in, ::mojo::PendingRemote<::network::mojom::CrossOriginEmbedderPolicyReporter> coep_reporter_in,
    ...
    ::mojo::PendingRemote<::network::mojom::DevToolsObserver> devtools_observer_in, TrustTokenRedemptionPolicy trust_token_redemption_policy_in, const std::string& debug_tag_in)
...
void CustomProxyConnectionObserverProxy::OnFallback(const ::net::ProxyServer& in_bad_proxy, int32_t in_net_error)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send network::mojom::CustomProxyConnectionObserver::OnFallback", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("bad_proxy"), in_bad_proxy, "<value of type const ::net::ProxyServer&>");
...
void CustomProxyConnectionObserverProxy::OnTunnelHeadersReceived(const ::net::ProxyServer& in_proxy_server, const ::scoped_refptr<::net::HttpResponseHeaders>& in_response_headers)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send network::mojom::CustomProxyConnectionObserver::OnTunnelHeadersReceived", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("proxy_server"), in_proxy_server, "<value of type const ::net::ProxyServer&>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("response_headers"), in_response_headers, "<value of type const ::scoped_refptr<::net::HttpResponseHeaders>&>");
    });
#endif
    const bool kExpectsResponse = false;
    const bool kIsSync = false;
...
bool CustomProxyConnectionObserverStubDispatch::Accept(CustomProxyConnectionObserver* impl, mojo::Message* message)
{
    ...
    case internal::kCustomProxyConnectionObserver_OnFallback_Name: {
        ...
        bool success = true;
        ::net::ProxyServer p_bad_proxy = mojo::DefaultConstructTraits::CreateInstance<::net::ProxyServer>();
    ...
    case internal::kCustomProxyConnectionObserver_OnTunnelHeadersReceived_Name: {
        ...
        bool success = true;
        ::net::ProxyServer p_proxy_server = mojo::DefaultConstructTraits::CreateInstance<::net::ProxyServer>();
        ::scoped_refptr<::net::HttpResponseHeaders> p_response_headers = mojo::DefaultConstructTraits::CreateInstance<::scoped_refptr<::net::HttpResponseHeaders>>();
...
void CustomProxyConfigClientProxy::MarkProxiesAsBad(::base::TimeDelta in_bypass_duration, const ::net::ProxyList& in_bad_proxies, MarkProxiesAsBadCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send network::mojom::CustomProxyConfigClient::MarkProxiesAsBad", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("bad_proxies"), in_bad_proxies, "<value of type const ::net::ProxyList&>");
    });
#endif
    const bool kExpectsResponse = true;
    const bool kIsSync = false;
...
bool CustomProxyConfigClientStubDispatch::AcceptWithResponder(CustomProxyConfigClient* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
{
    ...
    case internal::kCustomProxyConfigClient_MarkProxiesAsBad_Name: {
        ...
        ::net::ProxyList p_bad_proxies = mojo::DefaultConstructTraits::CreateInstance<::net::ProxyList>();
...
private:
    ...
    void Run(int32_t in_result, const absl::optional<std::string>& in_headers, const absl::optional<::GURL>& in_preserve_fragment_on_redirect_url);
};
...
bool TrustedHeaderClient_OnHeadersReceived_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    bool success = true;
    int32_t p_result = mojo::DefaultConstructTraits::CreateInstance<int32_t>();
    absl::optional<std::string> p_headers = mojo::DefaultConstructTraits::CreateInstance<absl::optional<std::string>>();
    absl::optional<::GURL> p_preserve_fragment_on_redirect_url = mojo::DefaultConstructTraits::CreateInstance<absl::optional<::GURL>>();
    ...
    int32_t in_result, const absl::optional<std::string>& in_headers, const absl::optional<::GURL>& in_preserve_fragment_on_redirect_url)
{
    ...
    TRACE_EVENT1("mojom", "Send reply network::mojom::TrustedHeaderClient::OnHeadersReceived", "async_response_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("result"), in_result, "<value of type int32_t>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("headers"), in_headers, "<value of type const absl::optional<std::string>&>");
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("preserve_fragment_on_redirect_url"), in_preserve_fragment_on_redirect_url, "<value of type const absl::optional<::GURL>&>");
    });
#endif
...
bool TrustedHeaderClientStubDispatch::AcceptWithResponder(TrustedHeaderClient* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
{
    ...
    case internal::kTrustedHeaderClient_OnHeadersReceived_Name: {
        ...
        bool success = true;
        std::string p_headers = mojo::DefaultConstructTraits::CreateInstance<std::string>();
    ...
    ::network::mojom::FulfillTrustTokenIssuanceRequestPtr in_request, OnTrustTokenIssuanceDivertedToSystemCallback callback)
{
    ...
    TRACE_EVENT1("mojom", "Send network::mojom::NetworkContextClient::OnTrustTokenIssuanceDivertedToSystem", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("request"), in_request, "<value of type ::network::mojom::FulfillTrustTokenIssuanceRequestPtr>");
    });
#endif
    const bool kExpectsResponse = true;
    const bool kIsSync = false;
...
bool NetworkContextClient_OnFileUploadRequested_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    bool success = true;
    int32_t p_net_error = mojo::DefaultConstructTraits::CreateInstance<int32_t>();
    std::vector<::base::File> p_files = mojo::DefaultConstructTraits::CreateInstance<std::vector<::base::File>>();
...
private:
    ...
    void Run(::network::mojom::FulfillTrustTokenIssuanceAnswerPtr in_response);
};
...
bool NetworkContextClient_OnTrustTokenIssuanceDivertedToSystem_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    bool success = true;
    ::network::mojom::FulfillTrustTokenIssuanceAnswerPtr p_response = mojo::DefaultConstructTraits::CreateInstance<::network::mojom::FulfillTrustTokenIssuanceAnswerPtr>();
...
void NetworkContextClient_OnTrustTokenIssuanceDivertedToSystem_ProxyToResponder::Run(::network::mojom::FulfillTrustTokenIssuanceAnswerPtr in_response)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send reply network::mojom::NetworkContextClient::OnTrustTokenIssuanceDivertedToSystem", "async_response_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("response"), in_response, "<value of type ::network::mojom::FulfillTrustTokenIssuanceAnswerPtr>");
    });
#endif
...
bool NetworkContextClientStubDispatch::AcceptWithResponder(NetworkContextClient* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
{
    ...
    case internal::kNetworkContextClient_OnFileUploadRequested_Name: {
        ...
        std::vector<::base::FilePath> p_file_paths = mojo::DefaultConstructTraits::CreateInstance<std::vector<::base::FilePath>>();
        ::GURL p_destination_url = mojo::DefaultConstructTraits::CreateInstance<::GURL>();
    ...
    case internal::kNetworkContextClient_OnTrustTokenIssuanceDivertedToSystem_Name: {
        ...
        bool success = true;
        ::network::mojom::FulfillTrustTokenIssuanceRequestPtr p_request = mojo::DefaultConstructTraits::CreateInstance<::network::mojom::FulfillTrustTokenIssuanceRequestPtr>();
...
void NetworkContextProxy::CreateURLLoaderFactory(::mojo::PendingReceiver<::network::mojom::URLLoaderFactory> in_url_loader_factory, URLLoaderFactoryParamsPtr in_params)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void NetworkContextProxy::GetCookieManager(::mojo::PendingReceiver<::network::mojom::CookieManager> in_cookie_manager)
{
    ...
    TRACE_EVENT1("mojom", "Send network::mojom::NetworkContext::GetCookieManager", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("cookie_manager"), in_cookie_manager, "<value of type ::mojo::PendingReceiver<::network::mojom::CookieManager>>");
    });
#endif
    const bool kExpectsResponse = false;
    const bool kIsSync = false;
...
void NetworkContextProxy::GetRestrictedCookieManager(::mojo::PendingReceiver<::network::mojom::RestrictedCookieManager> in_restricted_cookie_manager,
    ...
    ::mojo::PendingRemote<::network::mojom::CookieAccessObserver> in_cookie_observer)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send network::mojom::NetworkContext::GetRestrictedCookieManager", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("restricted_cookie_manager"), in_restricted_cookie_manager, "<value of type ::mojo::PendingReceiver<::network::mojom::RestrictedCookieManager>>");
    ...
    ::mojo::PendingReceiver<::network::mojom::TrustTokenQueryAnswerer> in_trust_token_query_answerer, const ::url::Origin& in_top_frame_origin)
{
    ...
    TRACE_EVENT1("mojom", "Send network::mojom::NetworkContext::GetTrustTokenQueryAnswerer", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("trust_token_query_answerer"), in_trust_token_query_answerer, "<value of type ::mojo::PendingReceiver<::network::mojom::TrustTokenQueryAnswerer>>");
...
void NetworkContextProxy::QueueReport(const std::string& in_type, const std::string& in_group, const ::GURL& in_url,
    const absl::optional<::base::UnguessableToken>& in_reporting_source, const ::net::NetworkAnonymizationKey& in_network_anonymization_key,
    const absl::optional<std::string>& in_user_agent, ::base::Value::Dict in_body)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send network::mojom::NetworkContext::QueueReport", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("user_agent"), in_user_agent, "<value of type const absl::optional<std::string>&>");
...
void NetworkContextProxy::AddExpectCT(const std::string& in_host, ::base::Time in_expiry, bool in_enforce, const ::GURL& in_report_uri,
    const ::net::NetworkAnonymizationKey& in_network_anonymization_key, AddExpectCTCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send network::mojom::NetworkContext::AddExpectCT", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("report_uri"), in_report_uri, "<value of type const ::GURL&>");
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("network_anonymization_key"), in_network_anonymization_key, "<value of type const ::net::NetworkAnonymizationKey&>");
    });
#endif
...
void NetworkContextProxy::SetExpectCTTestReport(const ::GURL& in_report_uri, SetExpectCTTestReportCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void NetworkContextProxy::GetExpectCTState(const std::string& in_domain, const ::net::NetworkAnonymizationKey& in_network_anonymization_key, GetExpectCTStateCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void NetworkContextProxy::CreateUDPSocket(::mojo::PendingReceiver<::network::mojom::UDPSocket> in_receiver, ::mojo::PendingRemote<::network::mojom::UDPSocketListener> in_listener)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send network::mojom::NetworkContext::CreateUDPSocket", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("receiver"), in_receiver, "<value of type ::mojo::PendingReceiver<::network::mojom::UDPSocket>>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("listener"), in_listener, "<value of type ::mojo::PendingRemote<::network::mojom::UDPSocketListener>>");
    });
#endif
    const bool kExpectsResponse = false;
    const bool kIsSync = false;
...
void NetworkContextProxy::CreateTCPServerSocket(const ::net::IPEndPoint& in_local_addr, uint32_t in_backlog, const ::net::MutableNetworkTrafficAnnotationTag& in_traffic_annotation,
    ::mojo::PendingReceiver<::network::mojom::TCPServerSocket> in_socket, CreateTCPServerSocketCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send network::mojom::NetworkContext::CreateTCPServerSocket", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("socket"), in_socket, "<value of type ::mojo::PendingReceiver<::network::mojom::TCPServerSocket>>");
    });
#endif
    const bool kExpectsResponse = true;
    const bool kIsSync = false;
...
void NetworkContextProxy::CreateTCPConnectedSocket(const absl::optional<::net::IPEndPoint>& in_local_addr, const ::net::AddressList& in_remote_addr_list,
    ...
    CreateTCPConnectedSocketCallback callback)
{
    ...
    TRACE_EVENT1("mojom", "Send network::mojom::NetworkContext::CreateTCPConnectedSocket", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("traffic_annotation"), in_traffic_annotation, "<value of type const ::net::MutableNetworkTrafficAnnotationTag&>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("socket"), in_socket, "<value of type ::mojo::PendingReceiver<::network::mojom::TCPConnectedSocket>>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("observer"), in_observer, "<value of type ::mojo::PendingRemote<::network::mojom::SocketObserver>>");
    });
#endif
    const bool kExpectsResponse = true;
    const bool kIsSync = false;
    ...
    ::mojo::PendingReceiver<::network::mojom::TCPBoundSocket> in_socket, CreateTCPBoundSocketCallback callback)
{
    ...
    TRACE_EVENT1("mojom", "Send network::mojom::NetworkContext::CreateTCPBoundSocket", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("local_addr"), in_local_addr, "<value of type const ::net::IPEndPoint&>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("traffic_annotation"), in_traffic_annotation, "<value of type const ::net::MutableNetworkTrafficAnnotationTag&>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("socket"), in_socket, "<value of type ::mojo::PendingReceiver<::network::mojom::TCPBoundSocket>>");
    });
#endif
    const bool kExpectsResponse = true;
    const bool kIsSync = false;
...
void NetworkContextProxy::CreateProxyResolvingSocketFactory(::mojo::PendingReceiver<::network::mojom::ProxyResolvingSocketFactory> in_factory)
{
    ...
    TRACE_EVENT1("mojom", "Send network::mojom::NetworkContext::CreateProxyResolvingSocketFactory", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("factory"), in_factory, "<value of type ::mojo::PendingReceiver<::network::mojom::ProxyResolvingSocketFactory>>");
    });
#endif
    const bool kExpectsResponse = false;
    const bool kIsSync = false;
...
void NetworkContextProxy::CreateWebSocket(const ::GURL& in_url, const std::vector<std::string>& in_requested_protocols, const ::net::SiteForCookies& in_site_for_cookies,
    const ::net::IsolationInfo& in_isolation_info, std::vector<::network::mojom::HttpHeaderPtr> in_additional_headers, int32_t in_process_id, const ::url::Origin& in_origin,
    uint32_t in_options, const ::net::MutableNetworkTrafficAnnotationTag& in_traffic_annotation,
    ...
    const absl::optional<::base::UnguessableToken>& in_throttling_profile_id)
{
    ...
    TRACE_EVENT1("mojom", "Send network::mojom::NetworkContext::CreateWebSocket", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("url"), in_url, "<value of type const ::GURL&>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("requested_protocols"), in_requested_protocols, "<value of type const std::vector<std::string>&>");
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("isolation_info"), in_isolation_info, "<value of type const ::net::IsolationInfo&>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("additional_headers"), in_additional_headers, "<value of type std::vector<::network::mojom::HttpHeaderPtr>>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("process_id"), in_process_id, "<value of type int32_t>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("origin"), in_origin, "<value of type const ::url::Origin&>");
...
void NetworkContextProxy::CreateWebTransport(const ::GURL& in_url, const ::url::Origin& in_origin, const ::net::NetworkAnonymizationKey& in_network_anonymization_key,
    std::vector<::network::mojom::WebTransportCertificateFingerprintPtr> in_fingerprints, ::mojo::PendingRemote<::network::mojom::WebTransportHandshakeClient> in_handshake_client)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void NetworkContextProxy::CreateNetLogExporter(::mojo::PendingReceiver<::network::mojom::NetLogExporter> in_receiver)
{
    ...
    TRACE_EVENT1("mojom", "Send network::mojom::NetworkContext::CreateNetLogExporter", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("receiver"), in_receiver, "<value of type ::mojo::PendingReceiver<::network::mojom::NetLogExporter>>");
    });
#endif
    const bool kExpectsResponse = false;
    const bool kIsSync = false;
...
void NetworkContextProxy::PreconnectSockets(
    uint32_t in_num_streams, const ::GURL& in_url, bool in_allow_credentials, const ::net::NetworkAnonymizationKey& in_network_anonymization_key)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void NetworkContextProxy::CreateP2PSocketManager(const ::net::NetworkAnonymizationKey& in_network_anonymization_key,
    ::mojo::PendingRemote<::network::mojom::P2PTrustedSocketManagerClient> in_client, ::mojo::PendingReceiver<::network::mojom::P2PTrustedSocketManager> in_trusted_socket_manager,
    ::mojo::PendingReceiver<::network::mojom::P2PSocketManager> in_socket_manager)
{
    ...
    TRACE_EVENT1("mojom", "Send network::mojom::NetworkContext::CreateP2PSocketManager", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("network_anonymization_key"), in_network_anonymization_key, "<value of type const ::net::NetworkAnonymizationKey&>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("client"), in_client, "<value of type ::mojo::PendingRemote<::network::mojom::P2PTrustedSocketManagerClient>>");
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("trusted_socket_manager"), in_trusted_socket_manager, "<value of type ::mojo::PendingReceiver<::network::mojom::P2PTrustedSocketManager>>");
        perfetto::WriteIntoTracedValueWithFallback(
    ...
    ::network::mojom::ResolveHostParametersPtr in_optional_parameters, ::mojo::PendingRemote<::network::mojom::ResolveHostClient> in_response_client)
{
    ...
    TRACE_EVENT1("mojom", "Send network::mojom::NetworkContext::ResolveHost", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("network_anonymization_key"), in_network_anonymization_key, "<value of type const ::net::NetworkAnonymizationKey&>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("optional_parameters"), in_optional_parameters, "<value of type ::network::mojom::ResolveHostParametersPtr>");
        perfetto::WriteIntoTracedValueWithFallback(
    ...
    const absl::optional<::net::DnsConfigOverrides>& in_config_overrides, ::mojo::PendingReceiver<::network::mojom::HostResolver> in_host_resolver)
{
    ...
    TRACE_EVENT1("mojom", "Send network::mojom::NetworkContext::CreateHostResolver", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("config_overrides"), in_config_overrides, "<value of type const absl::optional<::net::DnsConfigOverrides>&>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("host_resolver"), in_host_resolver, "<value of type ::mojo::PendingReceiver<::network::mojom::HostResolver>>");
    });
#endif
    const bool kExpectsResponse = false;
    const bool kIsSync = false;
...
void NetworkContextProxy::VerifyCertForSignedExchange(const ::scoped_refptr<::net::X509Certificate>& in_certificate, const ::GURL& in_url,
    const ::net::NetworkAnonymizationKey& in_network_anonymization_key, const std::string& in_ocsp_response, const std::string& in_sct_list,
    VerifyCertForSignedExchangeCallback callback)
{
    ...
    TRACE_EVENT1("mojom", "Send network::mojom::NetworkContext::VerifyCertForSignedExchange", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("certificate"), in_certificate, "<value of type const ::scoped_refptr<::net::X509Certificate>&>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("url"), in_url, "<value of type const ::GURL&>");
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("network_anonymization_key"), in_network_anonymization_key, "<value of type const ::net::NetworkAnonymizationKey&>");
...
void NetworkContextProxy::SetCorsOriginAccessListsForOrigin(const ::url::Origin& in_source_origin, std::vector<::network::mojom::CorsOriginPatternPtr> in_allow_patterns,
    std::vector<::network::mojom::CorsOriginPatternPtr> in_block_patterns, SetCorsOriginAccessListsForOriginCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send network::mojom::NetworkContext::SetCorsOriginAccessListsForOrigin", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("allow_patterns"), in_allow_patterns, "<value of type std::vector<::network::mojom::CorsOriginPatternPtr>>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("block_patterns"), in_block_patterns, "<value of type std::vector<::network::mojom::CorsOriginPatternPtr>>");
    });
#endif
    const bool kExpectsResponse = true;
    const bool kIsSync = false;
...
void NetworkContextProxy::AddDomainReliabilityContextForTesting(const ::url::Origin& in_origin, const ::GURL& in_upload_url, AddDomainReliabilityContextForTestingCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void NetworkContextProxy::AddReportingApiObserver(::mojo::PendingRemote<::network::mojom::ReportingApiObserver> in_observer)
{
    ...
    TRACE_EVENT1("mojom", "Send network::mojom::NetworkContext::AddReportingApiObserver", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("observer"), in_observer, "<value of type ::mojo::PendingRemote<::network::mojom::ReportingApiObserver>>");
    });
#endif
    const bool kExpectsResponse = false;
    const bool kIsSync = false;
...
void NetworkContextProxy::ComputeFirstPartySetMetadata(const ::net::SchemefulSite& in_site, const absl::optional<::net::SchemefulSite>& in_top_frame_site,
    const std::vector<::net::SchemefulSite>& in_party_context, ComputeFirstPartySetMetadataCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send network::mojom::NetworkContext::ComputeFirstPartySetMetadata", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("site"), in_site, "<value of type const ::net::SchemefulSite&>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("top_frame_site"), in_top_frame_site, "<value of type const absl::optional<::net::SchemefulSite>&>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("party_context"), in_party_context, "<value of type const std::vector<::net::SchemefulSite>&>");
    });
#endif
    const bool kExpectsResponse = true;
    const bool kIsSync = false;
...
bool NetworkContext_GetStoredTrustTokenCounts_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    std::vector<::network::mojom::StoredTrustTokensForIssuerPtr> p_tokens
        = mojo::DefaultConstructTraits::CreateInstance<std::vector<::network::mojom::StoredTrustTokensForIssuerPtr>>();
...
void NetworkContext_GetStoredTrustTokenCounts_ProxyToResponder::Run(std::vector<::network::mojom::StoredTrustTokensForIssuerPtr> in_tokens)
{
    ...
    TRACE_EVENT1("mojom", "Send reply network::mojom::NetworkContext::GetStoredTrustTokenCounts", "async_response_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("tokens"), in_tokens, "<value of type std::vector<::network::mojom::StoredTrustTokensForIssuerPtr>>");
    });
#endif
...
bool NetworkContext_DeleteStoredTrustTokens_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    bool success = true;
    ::network::mojom::DeleteStoredTrustTokensStatus p_status = mojo::DefaultConstructTraits::CreateInstance<::network::mojom::DeleteStoredTrustTokensStatus>();
...
private:
    ...
    void Run(int32_t in_error_code, const ::net::CertVerifyResult& in_cv_result, bool in_pkp_bypassed, const std::string& in_pinning_failure_log);
};
...
bool NetworkContext_VerifyCertForSignedExchange_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    ::net::CertVerifyResult p_cv_result = mojo::DefaultConstructTraits::CreateInstance<::net::CertVerifyResult>();
    bool p_pkp_bypassed = mojo::DefaultConstructTraits::CreateInstance<bool>();
    std::string p_pinning_failure_log = mojo::DefaultConstructTraits::CreateInstance<std::string>();
    ...
    int32_t in_error_code, const ::net::CertVerifyResult& in_cv_result, bool in_pkp_bypassed, const std::string& in_pinning_failure_log)
{
    ...
    TRACE_EVENT1("mojom", "Send reply network::mojom::NetworkContext::VerifyCertForSignedExchange", "async_response_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("pinning_failure_log"), in_pinning_failure_log, "<value of type const std::string&>");
    });
#endif
...
void NetworkContext_LookupServerBasicAuthCredentials_ProxyToResponder::Run(const absl::optional<::net::AuthCredentials>& in_credentials)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
private:
    ...
    void Run(::net::FirstPartySetMetadata in_metadata);
};
...
bool NetworkContext_ComputeFirstPartySetMetadata_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    bool success = true;
    ::net::FirstPartySetMetadata p_metadata = mojo::DefaultConstructTraits::CreateInstance<::net::FirstPartySetMetadata>();
...
void NetworkContext_ComputeFirstPartySetMetadata_ProxyToResponder::Run(::net::FirstPartySetMetadata in_metadata)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send reply network::mojom::NetworkContext::ComputeFirstPartySetMetadata", "async_response_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("metadata"), in_metadata, "<value of type ::net::FirstPartySetMetadata>");
    });
#endif
...
bool NetworkContextStubDispatch::Accept(NetworkContext* impl, mojo::Message* message)
{
    ...
    case internal::kNetworkContext_CreateURLLoaderFactory_Name: {
        ...
        ::mojo::PendingReceiver<::network::mojom::URLLoaderFactory> p_url_loader_factory
            = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingReceiver<::network::mojom::URLLoaderFactory>>();
    ...
    case internal::kNetworkContext_GetCookieManager_Name: {
        ...
        ::mojo::PendingReceiver<::network::mojom::CookieManager> p_cookie_manager
            = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingReceiver<::network::mojom::CookieManager>>();
    ...
    case internal::kNetworkContext_GetRestrictedCookieManager_Name: {
        ...
        ::mojo::PendingReceiver<::network::mojom::RestrictedCookieManager> p_restricted_cookie_manager
            = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingReceiver<::network::mojom::RestrictedCookieManager>>();
        ::network::mojom::RestrictedCookieManagerRole p_role = mojo::DefaultConstructTraits::CreateInstance<::network::mojom::RestrictedCookieManagerRole>();
        ::url::Origin p_origin = mojo::DefaultConstructTraits::CreateInstance<::url::Origin>();
        ...
        ::mojo::PendingRemote<::network::mojom::CookieAccessObserver> p_cookie_observer
            = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingRemote<::network::mojom::CookieAccessObserver>>();
    ...
    case internal::kNetworkContext_GetTrustTokenQueryAnswerer_Name: {
        ...
        ::mojo::PendingReceiver<::network::mojom::TrustTokenQueryAnswerer> p_trust_token_query_answerer
            = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingReceiver<::network::mojom::TrustTokenQueryAnswerer>>();
        ::url::Origin p_top_frame_origin = mojo::DefaultConstructTraits::CreateInstance<::url::Origin>();
    ...
    case internal::kNetworkContext_NotifyExternalCacheHit_Name: {
        ...
        std::string p_http_method = mojo::DefaultConstructTraits::CreateInstance<std::string>();
        ::net::NetworkIsolationKey p_key = mojo::DefaultConstructTraits::CreateInstance<::net::NetworkIsolationKey>();
    ...
    case internal::kNetworkContext_SetDocumentReportingEndpoints_Name: {
        ...
        ::url::Origin p_origin = mojo::DefaultConstructTraits::CreateInstance<::url::Origin>();
        ::net::IsolationInfo p_isolation_info = mojo::DefaultConstructTraits::CreateInstance<::net::IsolationInfo>();
        base::flat_map<std::string, std::string> p_endpoints = mojo::DefaultConstructTraits::CreateInstance<base::flat_map<std::string, std::string>>();
    ...
    case internal::kNetworkContext_QueueReport_Name: {
        ...
        bool success = true;
        std::string p_type = mojo::DefaultConstructTraits::CreateInstance<std::string>();
        std::string p_group = mojo::DefaultConstructTraits::CreateInstance<std::string>();
        ::GURL p_url = mojo::DefaultConstructTraits::CreateInstance<::GURL>();
        ...
        ::net::NetworkAnonymizationKey p_network_anonymization_key = mojo::DefaultConstructTraits::CreateInstance<::net::NetworkAnonymizationKey>();
        absl::optional<std::string> p_user_agent = mojo::DefaultConstructTraits::CreateInstance<absl::optional<std::string>>();
    ...
    case internal::kNetworkContext_SetAcceptLanguage_Name: {
        ...
        bool success = true;
        std::string p_new_accept_language = mojo::DefaultConstructTraits::CreateInstance<std::string>();
    ...
    case internal::kNetworkContext_CreateUDPSocket_Name: {
        ...
        bool success = true;
        ::mojo::PendingReceiver<::network::mojom::UDPSocket> p_receiver = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingReceiver<::network::mojom::UDPSocket>>();
        ::mojo::PendingRemote<::network::mojom::UDPSocketListener> p_listener
            = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingRemote<::network::mojom::UDPSocketListener>>();
    ...
    case internal::kNetworkContext_CreateProxyResolvingSocketFactory_Name: {
        ...
        ::mojo::PendingReceiver<::network::mojom::ProxyResolvingSocketFactory> p_factory
            = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingReceiver<::network::mojom::ProxyResolvingSocketFactory>>();
    ...
    case internal::kNetworkContext_LookUpProxyForURL_Name: {
        ...
        ::mojo::PendingRemote<::network::mojom::ProxyLookupClient> p_proxy_lookup_client
            = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingRemote<::network::mojom::ProxyLookupClient>>();
    ...
    case internal::kNetworkContext_CreateWebSocket_Name: {
        ...
        bool success = true;
        ::GURL p_url = mojo::DefaultConstructTraits::CreateInstance<::GURL>();
        std::vector<std::string> p_requested_protocols = mojo::DefaultConstructTraits::CreateInstance<std::vector<std::string>>();
        ::net::SiteForCookies p_site_for_cookies = mojo::DefaultConstructTraits::CreateInstance<::net::SiteForCookies>();
        ::net::IsolationInfo p_isolation_info = mojo::DefaultConstructTraits::CreateInstance<::net::IsolationInfo>();
        std::vector<::network::mojom::HttpHeaderPtr> p_additional_headers = mojo::DefaultConstructTraits::CreateInstance<std::vector<::network::mojom::HttpHeaderPtr>>();
        int32_t p_process_id = mojo::DefaultConstructTraits::CreateInstance<int32_t>();
        ::url::Origin p_origin = mojo::DefaultConstructTraits::CreateInstance<::url::Origin>();
        ...
        ::mojo::PendingRemote<::network::mojom::WebSocketHandshakeClient> p_handshake_client
            = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingRemote<::network::mojom::WebSocketHandshakeClient>>();
        ::mojo::PendingRemote<::network::mojom::URLLoaderNetworkServiceObserver> p_url_loader_network_observer
            = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingRemote<::network::mojom::URLLoaderNetworkServiceObserver>>();
        ::mojo::PendingRemote<::network::mojom::WebSocketAuthenticationHandler> p_auth_handler
            = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingRemote<::network::mojom::WebSocketAuthenticationHandler>>();
    ...
    case internal::kNetworkContext_CreateNetLogExporter_Name: {
        ...
        ::mojo::PendingReceiver<::network::mojom::NetLogExporter> p_receiver
            = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingReceiver<::network::mojom::NetLogExporter>>();
    ...
    case internal::kNetworkContext_CreateP2PSocketManager_Name: {
        ...
        ::mojo::PendingRemote<::network::mojom::P2PTrustedSocketManagerClient> p_client
            = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingRemote<::network::mojom::P2PTrustedSocketManagerClient>>();
        ::mojo::PendingReceiver<::network::mojom::P2PTrustedSocketManager> p_trusted_socket_manager
            = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingReceiver<::network::mojom::P2PTrustedSocketManager>>();
        ::mojo::PendingReceiver<::network::mojom::P2PSocketManager> p_socket_manager
            = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingReceiver<::network::mojom::P2PSocketManager>>();
    ...
    case internal::kNetworkContext_CreateMdnsResponder_Name: {
        ...
        ::mojo::PendingReceiver<::network::mojom::MdnsResponder> p_responder_receiver
            = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingReceiver<::network::mojom::MdnsResponder>>();
    ...
    case internal::kNetworkContext_ResolveHost_Name: {
        ...
        bool success = true;
        ::network::mojom::HostResolverHostPtr p_host = mojo::DefaultConstructTraits::CreateInstance<::network::mojom::HostResolverHostPtr>();
        ::net::NetworkAnonymizationKey p_network_anonymization_key = mojo::DefaultConstructTraits::CreateInstance<::net::NetworkAnonymizationKey>();
        ::network::mojom::ResolveHostParametersPtr p_optional_parameters = mojo::DefaultConstructTraits::CreateInstance<::network::mojom::ResolveHostParametersPtr>();
        ::mojo::PendingRemote<::network::mojom::ResolveHostClient> p_response_client
            = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingRemote<::network::mojom::ResolveHostClient>>();
    ...
    case internal::kNetworkContext_CreateHostResolver_Name: {
        ...
        bool success = true;
        absl::optional<::net::DnsConfigOverrides> p_config_overrides = mojo::DefaultConstructTraits::CreateInstance<absl::optional<::net::DnsConfigOverrides>>();
        ::mojo::PendingReceiver<::network::mojom::HostResolver> p_host_resolver
            = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingReceiver<::network::mojom::HostResolver>>();
    ...
    case internal::kNetworkContext_AddReportingApiObserver_Name: {
        ...
        ::mojo::PendingRemote<::network::mojom::ReportingApiObserver> p_observer
            = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingRemote<::network::mojom::ReportingApiObserver>>();
...
bool NetworkContextStubDispatch::AcceptWithResponder(NetworkContext* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
{
    ...
    case internal::kNetworkContext_DeleteStoredTrustTokens_Name: {
        ...
        bool success = true;
        ::url::Origin p_issuer = mojo::DefaultConstructTraits::CreateInstance<::url::Origin>();
    ...
    case internal::kNetworkContext_AddExpectCT_Name: {
        ...
        ::GURL p_report_uri = mojo::DefaultConstructTraits::CreateInstance<::GURL>();
        ::net::NetworkAnonymizationKey p_network_anonymization_key = mojo::DefaultConstructTraits::CreateInstance<::net::NetworkAnonymizationKey>();
    ...
    case internal::kNetworkContext_GetExpectCTState_Name: {
        ...
        bool success = true;
        std::string p_domain = mojo::DefaultConstructTraits::CreateInstance<std::string>();
        ::net::NetworkAnonymizationKey p_network_anonymization_key = mojo::DefaultConstructTraits::CreateInstance<::net::NetworkAnonymizationKey>();
    ...
    case internal::kNetworkContext_CreateTCPServerSocket_Name: {
        ...
        ::mojo::PendingReceiver<::network::mojom::TCPServerSocket> p_socket
            = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingReceiver<::network::mojom::TCPServerSocket>>();
    ...
    case internal::kNetworkContext_CreateTCPConnectedSocket_Name: {
        ...
        bool success = true;
        absl::optional<::net::IPEndPoint> p_local_addr = mojo::DefaultConstructTraits::CreateInstance<absl::optional<::net::IPEndPoint>>();
        ::net::AddressList p_remote_addr_list = mojo::DefaultConstructTraits::CreateInstance<::net::AddressList>();
        ::network::mojom::TCPConnectedSocketOptionsPtr p_tcp_connected_socket_options
            = mojo::DefaultConstructTraits::CreateInstance<::network::mojom::TCPConnectedSocketOptionsPtr>();
        ::net::MutableNetworkTrafficAnnotationTag p_traffic_annotation = mojo::DefaultConstructTraits::CreateInstance<::net::MutableNetworkTrafficAnnotationTag>();
        ::mojo::PendingReceiver<::network::mojom::TCPConnectedSocket> p_socket
            = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingReceiver<::network::mojom::TCPConnectedSocket>>();
        ::mojo::PendingRemote<::network::mojom::SocketObserver> p_observer
            = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingRemote<::network::mojom::SocketObserver>>();
    ...
    case internal::kNetworkContext_CreateTCPBoundSocket_Name: {
        ...
        ::mojo::PendingReceiver<::network::mojom::TCPBoundSocket> p_socket
            = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingReceiver<::network::mojom::TCPBoundSocket>>();
    ...
    case internal::kNetworkContext_VerifyCertForSignedExchange_Name: {
        ...
        bool success = true;
        ::scoped_refptr<::net::X509Certificate> p_certificate = mojo::DefaultConstructTraits::CreateInstance<::scoped_refptr<::net::X509Certificate>>();
        ::GURL p_url = mojo::DefaultConstructTraits::CreateInstance<::GURL>();
        ::net::NetworkAnonymizationKey p_network_anonymization_key = mojo::DefaultConstructTraits::CreateInstance<::net::NetworkAnonymizationKey>();
        std::string p_ocsp_response = mojo::DefaultConstructTraits::CreateInstance<std::string>();
        std::string p_sct_list = mojo::DefaultConstructTraits::CreateInstance<std::string>();
    ...
    case internal::kNetworkContext_SetCorsOriginAccessListsForOrigin_Name: {
        ...
        std::vector<::network::mojom::CorsOriginPatternPtr> p_allow_patterns = mojo::DefaultConstructTraits::CreateInstance<std::vector<::network::mojom::CorsOriginPatternPtr>>();
        std::vector<::network::mojom::CorsOriginPatternPtr> p_block_patterns = mojo::DefaultConstructTraits::CreateInstance<std::vector<::network::mojom::CorsOriginPatternPtr>>();
    ...
    case internal::kNetworkContext_AddAuthCacheEntry_Name: {
        ...
        ::net::NetworkAnonymizationKey p_network_anonymization_key = mojo::DefaultConstructTraits::CreateInstance<::net::NetworkAnonymizationKey>();
        ::net::AuthCredentials p_credentials = mojo::DefaultConstructTraits::CreateInstance<::net::AuthCredentials>();
    ...
    case internal::kNetworkContext_VerifyCertificateForTesting_Name: {
        ...
        bool success = true;
        ::scoped_refptr<::net::X509Certificate> p_certificate = mojo::DefaultConstructTraits::CreateInstance<::scoped_refptr<::net::X509Certificate>>();
        std::string p_hostname = mojo::DefaultConstructTraits::CreateInstance<std::string>();
        std::string p_ocsp_response = mojo::DefaultConstructTraits::CreateInstance<std::string>();
        std::string p_sct_list = mojo::DefaultConstructTraits::CreateInstance<std::string>();
    ...
    case internal::kNetworkContext_AddDomainReliabilityContextForTesting_Name: {
        ...
        bool success = true;
        ::url::Origin p_origin = mojo::DefaultConstructTraits::CreateInstance<::url::Origin>();
        ::GURL p_upload_url = mojo::DefaultConstructTraits::CreateInstance<::GURL>();
    ...
    case internal::kNetworkContext_ComputeFirstPartySetMetadata_Name: {
        ...
        bool success = true;
        ::net::SchemefulSite p_site = mojo::DefaultConstructTraits::CreateInstance<::net::SchemefulSite>();
        absl::optional<::net::SchemefulSite> p_top_frame_site = mojo::DefaultConstructTraits::CreateInstance<absl::optional<::net::SchemefulSite>>();
        std::vector<::net::SchemefulSite> p_party_context = mojo::DefaultConstructTraits::CreateInstance<std::vector<::net::SchemefulSite>>();
...
// static
bool StructTraits<::network::mojom::CTPolicy::DataView, ::network::mojom::CTPolicyPtr>::Read(::network::mojom::CTPolicy::DataView input, ::network::mojom::CTPolicyPtr* output)
{
    bool success = true;
...
void CustomProxyConnectionObserverInterceptorForTesting::OnTunnelHeadersReceived(
    const ::net::ProxyServer& proxy_server, const ::scoped_refptr<::net::HttpResponseHeaders>& response_headers)
{
...
void CustomProxyConfigClientAsyncWaiter::MarkProxiesAsBad(::base::TimeDelta bypass_duration, const ::net::ProxyList& bad_proxies)
{
    base::RunLoop loop;
...
void TrustedHeaderClientAsyncWaiter::OnHeadersReceived(const std::string& headers, const ::net::IPEndPoint& remote_endpoint, int32_t* out_result,
    absl::optional<std::string>* out_headers, absl::optional<::GURL>* out_preserve_fragment_on_redirect_url)
{
    base::RunLoop loop;
    proxy_->OnHeadersReceived(std::move(headers), std::move(remote_endpoint),
        base::BindOnce(
            [](base::RunLoop* loop, int32_t* out_result, absl::optional<std::string>* out_headers, absl::optional<::GURL>* out_preserve_fragment_on_redirect_url, int32_t result,
                const absl::optional<std::string>& headers, const absl::optional<::GURL>& preserve_fragment_on_redirect_url) {
                *out_result = std::move(result);
                *out_headers = std::move(headers);
...
void NetworkContextClientInterceptorForTesting::OnTrustTokenIssuanceDivertedToSystem(
    ::network::mojom::FulfillTrustTokenIssuanceRequestPtr request, OnTrustTokenIssuanceDivertedToSystemCallback callback)
{
...
{
    std::vector<::url::Origin> async_wait_result = mojo::DefaultConstructTraits::CreateInstance<std::vector<::url::Origin>>();
    ...
    ::network::mojom::FulfillTrustTokenIssuanceRequestPtr request, ::network::mojom::FulfillTrustTokenIssuanceAnswerPtr* out_response)
{
    ...
    proxy_->OnTrustTokenIssuanceDivertedToSystem(std::move(request),
        base::BindOnce(
            [](base::RunLoop* loop, ::network::mojom::FulfillTrustTokenIssuanceAnswerPtr* out_response, ::network::mojom::FulfillTrustTokenIssuanceAnswerPtr response) {
...
::network::mojom::FulfillTrustTokenIssuanceAnswerPtr NetworkContextClientAsyncWaiter::OnTrustTokenIssuanceDivertedToSystem(
    ::network::mojom::FulfillTrustTokenIssuanceRequestPtr request)
{
    ::network::mojom::FulfillTrustTokenIssuanceAnswerPtr async_wait_result = mojo::DefaultConstructTraits::CreateInstance<::network::mojom::FulfillTrustTokenIssuanceAnswerPtr>();
...
void NetworkContextInterceptorForTesting::GetRestrictedCookieManager(::mojo::PendingReceiver<::network::mojom::RestrictedCookieManager> restricted_cookie_manager,
...
void NetworkContextInterceptorForTesting::NotifyExternalCacheHit(
    const ::GURL& url, const std::string& http_method, const ::net::NetworkIsolationKey& key, bool is_subframe_document_resource, bool include_credentials)
{
...
void NetworkContextInterceptorForTesting::QueueReport(const std::string& type, const std::string& group, const ::GURL& url,
    const absl::optional<::base::UnguessableToken>& reporting_source, const ::net::NetworkAnonymizationKey& network_anonymization_key,
    const absl::optional<std::string>& user_agent, ::base::Value::Dict body)
{
...
void NetworkContextInterceptorForTesting::SetAcceptLanguage(const std::string& new_accept_language) { GetForwardingInterface()->SetAcceptLanguage(std::move(new_accept_language)); }
...
void NetworkContextInterceptorForTesting::AddExpectCT(const std::string& host, ::base::Time expiry, bool enforce, const ::GURL& report_uri,
    const ::net::NetworkAnonymizationKey& network_anonymization_key, AddExpectCTCallback callback)
{
...
void NetworkContextInterceptorForTesting::GetExpectCTState(
    const std::string& domain, const ::net::NetworkAnonymizationKey& network_anonymization_key, GetExpectCTStateCallback callback)
{
...
void NetworkContextInterceptorForTesting::CreateTCPServerSocket(const ::net::IPEndPoint& local_addr, uint32_t backlog,
    const ::net::MutableNetworkTrafficAnnotationTag& traffic_annotation, ::mojo::PendingReceiver<::network::mojom::TCPServerSocket> socket, CreateTCPServerSocketCallback callback)
{
...
void NetworkContextInterceptorForTesting::CreateTCPConnectedSocket(const absl::optional<::net::IPEndPoint>& local_addr, const ::net::AddressList& remote_addr_list,
...
void NetworkContextInterceptorForTesting::LookUpProxyForURL(
    const ::GURL& url, const ::net::NetworkAnonymizationKey& network_anonymization_key, ::mojo::PendingRemote<::network::mojom::ProxyLookupClient> proxy_lookup_client)
{
...
void NetworkContextInterceptorForTesting::CreateWebSocket(const ::GURL& url, const std::vector<std::string>& requested_protocols, const ::net::SiteForCookies& site_for_cookies,
    const ::net::IsolationInfo& isolation_info, std::vector<::network::mojom::HttpHeaderPtr> additional_headers, int32_t process_id, const ::url::Origin& origin, uint32_t options,
...
void NetworkContextInterceptorForTesting::CreateWebTransport(const ::GURL& url, const ::url::Origin& origin, const ::net::NetworkAnonymizationKey& network_anonymization_key,
    std::vector<::network::mojom::WebTransportCertificateFingerprintPtr> fingerprints, ::mojo::PendingRemote<::network::mojom::WebTransportHandshakeClient> handshake_client)
{
...
void NetworkContextInterceptorForTesting::PreconnectSockets(
    uint32_t num_streams, const ::GURL& url, bool allow_credentials, const ::net::NetworkAnonymizationKey& network_anonymization_key)
{
...
void NetworkContextInterceptorForTesting::CreateP2PSocketManager(const ::net::NetworkAnonymizationKey& network_anonymization_key,
    ::mojo::PendingRemote<::network::mojom::P2PTrustedSocketManagerClient> client, ::mojo::PendingReceiver<::network::mojom::P2PTrustedSocketManager> trusted_socket_manager,
...
void NetworkContextInterceptorForTesting::ResolveHost(::network::mojom::HostResolverHostPtr host, const ::net::NetworkAnonymizationKey& network_anonymization_key,
...
void NetworkContextInterceptorForTesting::CreateHostResolver(
    const absl::optional<::net::DnsConfigOverrides>& config_overrides, ::mojo::PendingReceiver<::network::mojom::HostResolver> host_resolver)
{
...
void NetworkContextInterceptorForTesting::VerifyCertForSignedExchange(const ::scoped_refptr<::net::X509Certificate>& certificate, const ::GURL& url,
    const ::net::NetworkAnonymizationKey& network_anonymization_key, const std::string& ocsp_response, const std::string& sct_list, VerifyCertForSignedExchangeCallback callback)
{
...
void NetworkContextInterceptorForTesting::SetCorsOriginAccessListsForOrigin(const ::url::Origin& source_origin, std::vector<::network::mojom::CorsOriginPatternPtr> allow_patterns,
...
void NetworkContextInterceptorForTesting::AddAuthCacheEntry(const ::net::AuthChallengeInfo& challenge, const ::net::NetworkAnonymizationKey& network_anonymization_key,
...
void NetworkContextInterceptorForTesting::ComputeFirstPartySetMetadata(const ::net::SchemefulSite& site, const absl::optional<::net::SchemefulSite>& top_frame_site,
    const std::vector<::net::SchemefulSite>& party_context, ComputeFirstPartySetMetadataCallback callback)
{
...
void NetworkContextAsyncWaiter::GetStoredTrustTokenCounts(std::vector<::network::mojom::StoredTrustTokensForIssuerPtr>* out_tokens)
{
    ...
    proxy_->GetStoredTrustTokenCounts(base::BindOnce(
        [](base::RunLoop* loop, std::vector<::network::mojom::StoredTrustTokensForIssuerPtr>* out_tokens, std::vector<::network::mojom::StoredTrustTokensForIssuerPtr> tokens) {
...
{
    ::network::mojom::DeleteStoredTrustTokensStatus async_wait_result = mojo::DefaultConstructTraits::CreateInstance<::network::mojom::DeleteStoredTrustTokensStatus>();
...
bool NetworkContextAsyncWaiter::AddExpectCT(
    const std::string& host, ::base::Time expiry, bool enforce, const ::GURL& report_uri, const ::net::NetworkAnonymizationKey& network_anonymization_key)
{
    bool async_wait_result = mojo::DefaultConstructTraits::CreateInstance<bool>();
...
void NetworkContextAsyncWaiter::SetExpectCTTestReport(const ::GURL& report_uri, bool* out_success)
{
    base::RunLoop loop;
...
bool NetworkContextAsyncWaiter::SetExpectCTTestReport(const ::GURL& report_uri)
{
    bool async_wait_result = mojo::DefaultConstructTraits::CreateInstance<bool>();
...
void NetworkContextAsyncWaiter::GetExpectCTState(const std::string& domain, const ::net::NetworkAnonymizationKey& network_anonymization_key, ::base::Value::Dict* out_state)
{
    base::RunLoop loop;
...
::base::Value::Dict NetworkContextAsyncWaiter::GetExpectCTState(const std::string& domain, const ::net::NetworkAnonymizationKey& network_anonymization_key)
{
...
void NetworkContextAsyncWaiter::CreateTCPConnectedSocket(const absl::optional<::net::IPEndPoint>& local_addr, const ::net::AddressList& remote_addr_list,
    ::network::mojom::TCPConnectedSocketOptionsPtr tcp_connected_socket_options, const ::net::MutableNetworkTrafficAnnotationTag& traffic_annotation,
...
void NetworkContextAsyncWaiter::VerifyCertForSignedExchange(const ::scoped_refptr<::net::X509Certificate>& certificate, const ::GURL& url,
    const ::net::NetworkAnonymizationKey& network_anonymization_key, const std::string& ocsp_response, const std::string& sct_list, int32_t* out_error_code,
    ::net::CertVerifyResult* out_cv_result, bool* out_pkp_bypassed, std::string* out_pinning_failure_log)
{
    base::RunLoop loop;
    proxy_->VerifyCertForSignedExchange(std::move(certificate), std::move(url), std::move(network_anonymization_key), std::move(ocsp_response), std::move(sct_list),
        base::BindOnce(
            [](base::RunLoop* loop, int32_t* out_error_code, ::net::CertVerifyResult* out_cv_result, bool* out_pkp_bypassed, std::string* out_pinning_failure_log,
                int32_t error_code, const ::net::CertVerifyResult& cv_result, bool pkp_bypassed, const std::string& pinning_failure_log) {
...
void NetworkContextAsyncWaiter::ComputeFirstPartySetMetadata(const ::net::SchemefulSite& site, const absl::optional<::net::SchemefulSite>& top_frame_site,
    const std::vector<::net::SchemefulSite>& party_context, ::net::FirstPartySetMetadata* out_metadata)
{
    ...
    proxy_->ComputeFirstPartySetMetadata(std::move(site), std::move(top_frame_site), std::move(party_context),
        base::BindOnce(
            [](base::RunLoop* loop, ::net::FirstPartySetMetadata* out_metadata, ::net::FirstPartySetMetadata metadata) {
...
::net::FirstPartySetMetadata NetworkContextAsyncWaiter::ComputeFirstPartySetMetadata(
...
{
    ::net::FirstPartySetMetadata async_wait_result = mojo::DefaultConstructTraits::CreateInstance<::net::FirstPartySetMetadata>();
