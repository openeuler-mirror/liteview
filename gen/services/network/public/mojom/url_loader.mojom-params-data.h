...
public:
    ...
    int32_t intra_priority_value() const { return data_->intra_priority_value; }
...
public:
    ...
    bool is_null() const { return !data_; }
    int64_t current_position() const { return data_->current_position; }
    int64_t total_size() const { return data_->total_size; }
