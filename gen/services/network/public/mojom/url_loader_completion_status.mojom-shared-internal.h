...
template <typename UserType, typename DataView> struct BlockedByResponseReasonWrapper_UnserializedMessageContext : public mojo::internal::UnserializedMessageContext {
public:
...
template <typename UserType, typename DataView> struct URLLoaderCompletionStatus_UnserializedMessageContext : public mojo::internal::UnserializedMessageContext {
public:
    static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;
