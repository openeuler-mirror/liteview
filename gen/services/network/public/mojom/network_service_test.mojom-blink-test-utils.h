...
class BLINK_PLATFORM_EXPORT NetworkServiceTestInterceptorForTesting : public NetworkServiceTest {
    ...
    void SetTestDohConfig(
        ::network::mojom::blink::SecureDnsMode secure_dns_mode, ::network::mojom::blink::DnsOverHttpsConfigPtr doh_config, SetTestDohConfigCallback callback) override;
    ...
    void EnumerateFiles(
        const ::base::FilePath& path, ::mojo::PendingRemote<::network::mojom::blink::HttpCacheBackendFileOperationsFactory> factory, EnumerateFilesCallback callback) override;
...
public:
    ...
    void SetRequireCT(NetworkServiceTest::RequireCT required);
    ...
    void SetSCTAuditingRetryDelay(absl::optional<::base::TimeDelta> delay);
