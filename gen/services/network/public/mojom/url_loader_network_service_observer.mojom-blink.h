...
// with not having this data in traces there.
    ...
    virtual void OnCertificateRequested(const absl::optional<::base::UnguessableToken>& window_id, ::network::mojom::blink::SSLCertRequestInfoPtr cert_info,
        ::mojo::PendingRemote<ClientCertificateResponder> cert_responder)
        = 0;

    virtual void OnAuthRequired(const absl::optional<::base::UnguessableToken>& window_id, uint32_t request_id, const ::blink::KURL& url, bool first_auth_attempt,
    ...
    virtual void OnClearSiteData(const ::blink::KURL& url, const WTF::String& header_value, int32_t load_flags, ::network::mojom::blink::CookiePartitionKeyPtr cookie_partition_key,
...
//
//   void ContinueWithCertificate(::network::mojom::blink::X509CertificatePtr x509_certificate, const WTF::String& provider_name, const WTF::Vector<uint16_t>&
...
//
//   void OnSSLCertificateError(const ::blink::KURL& url, int32_t net_error, ::network::mojom::blink::SSLInfoPtr ssl_info, bool fatal, OnSSLCertificateErrorCallback callback)
//   final;
//
//   void OnCertificateRequested(const absl::optional<::base::UnguessableToken>& window_id, ::network::mojom::blink::SSLCertRequestInfoPtr cert_info,
//   ::mojo::PendingRemote<ClientCertificateResponder> cert_responder) final;
//
//   void OnAuthRequired(const absl::optional<::base::UnguessableToken>& window_id, uint32_t request_id, const ::blink::KURL& url, bool first_auth_attempt, const
//   ::net::AuthChallengeInfo& auth_info, ::network::mojom::blink::HttpResponseHeadersPtr head_headers, ::mojo::PendingRemote<AuthChallengeResponder> auth_challenge_responder)
//   final;
//
//   void OnClearSiteData(const ::blink::KURL& url, const WTF::String& header_value, int32_t load_flags, ::network::mojom::blink::CookiePartitionKeyPtr cookie_partition_key,
...
public:
    ...
    LoadInfo(::base::TimeTicks timestamp_in, const WTF::String& host_in, uint32_t load_state_in, const ::WTF::String& state_param_in, uint64_t upload_position_in,
    ...
    template <typename UserType> static WTF::Vector<uint8_t> Serialize(UserType* input) { return mojo::internal::SerializeImpl<LoadInfo::DataView, WTF::Vector<uint8_t>>(input); }
...
template <> struct BLINK_PLATFORM_EXPORT StructTraits<::network::mojom::blink::LoadInfo::DataView, ::network::mojom::blink::LoadInfoPtr> {
    ...
    static const decltype(::network::mojom::blink::LoadInfo::timestamp)& timestamp(const ::network::mojom::blink::LoadInfoPtr& input) { return input->timestamp; }

    static const decltype(::network::mojom::blink::LoadInfo::host)& host(const ::network::mojom::blink::LoadInfoPtr& input) { return input->host; }

    static decltype(::network::mojom::blink::LoadInfo::load_state) load_state(const ::network::mojom::blink::LoadInfoPtr& input) { return input->load_state; }

    static const decltype(::network::mojom::blink::LoadInfo::state_param)& state_param(const ::network::mojom::blink::LoadInfoPtr& input) { return input->state_param; }

    static decltype(::network::mojom::blink::LoadInfo::upload_position) upload_position(const ::network::mojom::blink::LoadInfoPtr& input) { return input->upload_position; }

    static decltype(::network::mojom::blink::LoadInfo::upload_size) upload_size(const ::network::mojom::blink::LoadInfoPtr& input) { return input->upload_size; }
