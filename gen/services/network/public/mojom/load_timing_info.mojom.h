...
template <> struct StructTraits<::network::mojom::LoadTimingInfoConnectTiming::DataView, ::network::mojom::LoadTimingInfoConnectTimingPtr> {
    ...
    static const decltype(::network::mojom::LoadTimingInfoConnectTiming::domain_lookup_start)& domain_lookup_start(const ::network::mojom::LoadTimingInfoConnectTimingPtr& input)
    {
        return input->domain_lookup_start;
    }

    static const decltype(::network::mojom::LoadTimingInfoConnectTiming::domain_lookup_end)& domain_lookup_end(const ::network::mojom::LoadTimingInfoConnectTimingPtr& input)
    {
        return input->domain_lookup_end;
    }

    static const decltype(::network::mojom::LoadTimingInfoConnectTiming::connect_start)& connect_start(const ::network::mojom::LoadTimingInfoConnectTimingPtr& input)
    {
        return input->connect_start;
    }

    static const decltype(::network::mojom::LoadTimingInfoConnectTiming::connect_end)& connect_end(const ::network::mojom::LoadTimingInfoConnectTimingPtr& input)
    {
    ...
    static const decltype(::network::mojom::LoadTimingInfoConnectTiming::ssl_end)& ssl_end(const ::network::mojom::LoadTimingInfoConnectTimingPtr& input) { return input->ssl_end; }
...
template <> struct StructTraits<::network::mojom::LoadTimingInfo::DataView, ::network::mojom::LoadTimingInfoPtr> {
    ...
    static decltype(::network::mojom::LoadTimingInfo::socket_reused) socket_reused(const ::network::mojom::LoadTimingInfoPtr& input) { return input->socket_reused; }

    static decltype(::network::mojom::LoadTimingInfo::socket_log_id) socket_log_id(const ::network::mojom::LoadTimingInfoPtr& input) { return input->socket_log_id; }
    ...
    static const decltype(::network::mojom::LoadTimingInfo::request_start)& request_start(const ::network::mojom::LoadTimingInfoPtr& input) { return input->request_start; }
    ...
    static const decltype(::network::mojom::LoadTimingInfo::connect_timing)& connect_timing(const ::network::mojom::LoadTimingInfoPtr& input) { return input->connect_timing; }

    static const decltype(::network::mojom::LoadTimingInfo::send_start)& send_start(const ::network::mojom::LoadTimingInfoPtr& input) { return input->send_start; }

    static const decltype(::network::mojom::LoadTimingInfo::send_end)& send_end(const ::network::mojom::LoadTimingInfoPtr& input) { return input->send_end; }
    ...
    static const decltype(::network::mojom::LoadTimingInfo::push_start)& push_start(const ::network::mojom::LoadTimingInfoPtr& input) { return input->push_start; }

    static const decltype(::network::mojom::LoadTimingInfo::push_end)& push_end(const ::network::mojom::LoadTimingInfoPtr& input) { return input->push_end; }

    static const decltype(::network::mojom::LoadTimingInfo::service_worker_start_time)& service_worker_start_time(const ::network::mojom::LoadTimingInfoPtr& input)
    {
        return input->service_worker_start_time;
    }

    static const decltype(::network::mojom::LoadTimingInfo::service_worker_ready_time)& service_worker_ready_time(const ::network::mojom::LoadTimingInfoPtr& input)
    {
        return input->service_worker_ready_time;
    }

    static const decltype(::network::mojom::LoadTimingInfo::service_worker_fetch_start)& service_worker_fetch_start(const ::network::mojom::LoadTimingInfoPtr& input)
    {
