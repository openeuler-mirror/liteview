...
//
//   void SendTo(const ::net::IPEndPoint& dest_addr, ::base::span<const ::uint8_t> data, const ::net::MutableNetworkTrafficAnnotationTag& traffic_annotation, SendToCallback
//   callback) final;
//
...
public:
    ...
    template <typename... Args> static UDPSocketOptionsPtr New(Args&&... args) { return UDPSocketOptionsPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static UDPSocketOptionsPtr From(const U& u) { return mojo::TypeConverter<UDPSocketOptionsPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, UDPSocketOptions>::Convert(*this); }
    UDPSocketOptions()
    ...
    UDPSocketOptions(bool allow_address_reuse_in, bool allow_broadcast_in, bool allow_address_sharing_for_multicast_in, uint32_t multicast_interface_in,
    ...
    template <typename T, UDPSocketOptions::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    ...
    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<UDPSocketOptions::DataView>(input); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::UDPSocketOptions_UnserializedMessageContext<UserType, UDPSocketOptions::DataView>>(0, 0, std::move(input)), MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    {
        return UDPSocketOptions::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, UDPSocketOptions::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, UDPSocketOptions::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, UDPSocketOptions::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }

template <typename StructPtrType> UDPSocketOptionsPtr UDPSocketOptions::Clone() const
{
    return New(mojo::Clone(allow_address_reuse), mojo::Clone(allow_broadcast), mojo::Clone(allow_address_sharing_for_multicast), mojo::Clone(multicast_interface),
        mojo::Clone(multicast_time_to_live), mojo::Clone(multicast_loopback_mode), mojo::Clone(send_buffer_size), mojo::Clone(receive_buffer_size));
}
...
template <> struct BLINK_PLATFORM_EXPORT StructTraits<::network::mojom::blink::UDPSocketOptions::DataView, ::network::mojom::blink::UDPSocketOptionsPtr> {
    ...
    static decltype(::network::mojom::blink::UDPSocketOptions::allow_address_reuse) allow_address_reuse(const ::network::mojom::blink::UDPSocketOptionsPtr& input)
    {
    ...
    static decltype(::network::mojom::blink::UDPSocketOptions::multicast_interface) multicast_interface(const ::network::mojom::blink::UDPSocketOptionsPtr& input)
    {
        return input->multicast_interface;
    }

    static decltype(::network::mojom::blink::UDPSocketOptions::multicast_time_to_live) multicast_time_to_live(const ::network::mojom::blink::UDPSocketOptionsPtr& input)
    {
        return input->multicast_time_to_live;
    }

    static decltype(::network::mojom::blink::UDPSocketOptions::multicast_loopback_mode) multicast_loopback_mode(const ::network::mojom::blink::UDPSocketOptionsPtr& input)
    {
    ...
    static decltype(::network::mojom::blink::UDPSocketOptions::receive_buffer_size) receive_buffer_size(const ::network::mojom::blink::UDPSocketOptionsPtr& input)
    {
