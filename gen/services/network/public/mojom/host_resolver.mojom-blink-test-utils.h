...
class BLINK_PLATFORM_EXPORT ResolveHostClientInterceptorForTesting : public ResolveHostClient {
    ...
    void OnComplete(int32_t result, ::network::mojom::blink::ResolveErrorInfoPtr resolve_error_info, ::network::mojom::blink::AddressListPtr resolved_addresses,
        absl::optional<WTF::Vector<::network::mojom::blink::HostResolverEndpointResultPtr>> endpoint_results_with_metadata) override;
...
class BLINK_PLATFORM_EXPORT MdnsListenClientInterceptorForTesting : public MdnsListenClient {
    ...
    void OnAddressResult(MdnsListenClient::UpdateType update_type, DnsQueryType query_type, const ::net::IPEndPoint& endpoint) override;
...
class BLINK_PLATFORM_EXPORT HostResolverInterceptorForTesting : public HostResolver {
    ...
    void MdnsListen(
        ::network::mojom::blink::HostPortPairPtr host, DnsQueryType query_type, ::mojo::PendingRemote<MdnsListenClient> response_client, MdnsListenCallback callback) override;
};
...
public:
    ...
    void MdnsListen(::network::mojom::blink::HostPortPairPtr host, DnsQueryType query_type, ::mojo::PendingRemote<MdnsListenClient> response_client, int32_t* out_result);
