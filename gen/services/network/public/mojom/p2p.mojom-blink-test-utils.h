...
class BLINK_PLATFORM_EXPORT P2PNetworkNotificationClientInterceptorForTesting : public P2PNetworkNotificationClient {
    ...
    void NetworkListChanged(
        const WTF::Vector<::net::NetworkInterface>& networks, const ::net::IPAddress& default_ipv4_local_address, const ::net::IPAddress& default_ipv6_local_address) override;
};
...
class BLINK_PLATFORM_EXPORT P2PSocketManagerInterceptorForTesting : public P2PSocketManager {
    ...
    void CreateSocket(::network::P2PSocketType type, const ::net::IPEndPoint& local_address, const ::network::P2PPortRange& port_range,
        const ::network::P2PHostAndIPEndPoint& remote_address, ::mojo::PendingRemote<P2PSocketClient> client, ::mojo::PendingReceiver<P2PSocket> socket) override;
};
...
class BLINK_PLATFORM_EXPORT P2PSocketInterceptorForTesting : public P2PSocket {
    ...
    void Send(const WTF::Vector<int8_t>& data, const ::network::P2PPacketInfo& packet_info, const ::net::MutableNetworkTrafficAnnotationTag& traffic_annotation) override;
...
class BLINK_PLATFORM_EXPORT P2PSocketClientInterceptorForTesting : public P2PSocketClient {
    ...
    void DataReceived(const ::net::IPEndPoint& socket_address, const WTF::Vector<int8_t>& data, ::base::TimeTicks timestamp) override;
};
