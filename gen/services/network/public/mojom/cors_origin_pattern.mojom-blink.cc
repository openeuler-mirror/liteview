...
bool CorsOriginPattern::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
CorsOriginAccessPatterns::CorsOriginAccessPatterns(const ::scoped_refptr<const ::blink::SecurityOrigin>& source_origin_in, WTF::Vector<CorsOriginPatternPtr> allow_patterns_in,
...
bool CorsOriginAccessPatterns::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
} // namespace blink
} // namespace mojom
} // namespace network
namespace mojo {
