...
URLLoaderClientEndpoints::URLLoaderClientEndpoints(::mojo::PendingRemote<URLLoader> url_loader_in, ::mojo::PendingReceiver<URLLoaderClient> url_loader_client_in)
...
bool URLLoaderClientEndpoints::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
void URLLoaderProxy::FollowRedirect(const std::vector<std::string>& in_removed_headers, const ::net::HttpRequestHeaders& in_modified_headers,
    const ::net::HttpRequestHeaders& in_modified_cors_exempt_headers, const absl::optional<::GURL>& in_new_url)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send network::mojom::URLLoader::FollowRedirect", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("new_url"), in_new_url, "<value of type const absl::optional<::GURL>&>");
    });
#endif
    ...
    mojo::Message message(internal::kURLLoader_FollowRedirect_Name, kFlags, 0, 0, nullptr);
    ...
    const mojo::internal::ContainerValidateParams removed_headers_validate_params(0, false, new mojo::internal::ContainerValidateParams(0, false, nullptr));
    ...
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
        params->removed_headers.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null removed_headers in URLLoader.FollowRedirect request");
    ...
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
        params->modified_headers.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null modified_headers in URLLoader.FollowRedirect request");
...
void URLLoaderProxy::SetPriority(::net::RequestPriority in_priority, int32_t in_intra_priority_value)
{
    ...
    mojo::Message message(internal::kURLLoader_SetPriority_Name, kFlags, 0, 0, nullptr);
...
void URLLoaderProxy::PauseReadingBodyFromNet()
{
    ...
    mojo::Message message(internal::kURLLoader_PauseReadingBodyFromNet_Name, kFlags, 0, 0, nullptr);
...
void URLLoaderProxy::ResumeReadingBodyFromNet()
{
    ...
    mojo::Message message(internal::kURLLoader_ResumeReadingBodyFromNet_Name, kFlags, 0, 0, nullptr);
...
bool URLLoaderStubDispatch::Accept(URLLoader* impl, mojo::Message* message)
{
    ...
    case internal::kURLLoader_FollowRedirect_Name: {
        ...
        bool success = true;
        std::vector<std::string> p_removed_headers = mojo::DefaultConstructTraits::CreateInstance<std::vector<std::string>>();
        ::net::HttpRequestHeaders p_modified_headers = mojo::DefaultConstructTraits::CreateInstance<::net::HttpRequestHeaders>();
        ::net::HttpRequestHeaders p_modified_cors_exempt_headers = mojo::DefaultConstructTraits::CreateInstance<::net::HttpRequestHeaders>();
        absl::optional<::GURL> p_new_url = mojo::DefaultConstructTraits::CreateInstance<absl::optional<::GURL>>();
    ...
    case internal::kURLLoader_SetPriority_Name: {
        ...
        bool success = true;
        ::net::RequestPriority p_priority = mojo::DefaultConstructTraits::CreateInstance<::net::RequestPriority>();
        int32_t p_intra_priority_value = mojo::DefaultConstructTraits::CreateInstance<int32_t>();
    ...
    case internal::kURLLoader_PauseReadingBodyFromNet_Name: {
        ...
        DCHECK(message->is_serialized());
        internal::URLLoader_PauseReadingBodyFromNet_Params_Data* params = reinterpret_cast<internal::URLLoader_PauseReadingBodyFromNet_Params_Data*>(message->mutable_payload());
    ...
    case internal::kURLLoader_ResumeReadingBodyFromNet_Name: {
        ...
        DCHECK(message->is_serialized());
        internal::URLLoader_ResumeReadingBodyFromNet_Params_Data* params = reinterpret_cast<internal::URLLoader_ResumeReadingBodyFromNet_Params_Data*>(message->mutable_payload());
...
static const std::pair<uint32_t, mojo::internal::GenericValidationInfo> kURLLoaderValidationInfo[] = {
    { internal::kURLLoader_FollowRedirect_Name, { &internal::URLLoader_FollowRedirect_Params_Data::Validate, nullptr /* no response */ } },
    { internal::kURLLoader_SetPriority_Name, { &internal::URLLoader_SetPriority_Params_Data::Validate, nullptr /* no response */ } },
    { internal::kURLLoader_PauseReadingBodyFromNet_Name, { &internal::URLLoader_PauseReadingBodyFromNet_Params_Data::Validate, nullptr /* no response */ } },
    { internal::kURLLoader_ResumeReadingBodyFromNet_Name, { &internal::URLLoader_ResumeReadingBodyFromNet_Params_Data::Validate, nullptr /* no response */ } },
};
...
void URLLoaderClientProxy::OnReceiveEarlyHints(::network::mojom::EarlyHintsPtr in_early_hints)
{
    ...
    mojo::Message message(internal::kURLLoaderClient_OnReceiveEarlyHints_Name, kFlags, 0, 0, nullptr);
    ...
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
        params->early_hints.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null early_hints in URLLoaderClient.OnReceiveEarlyHints request");
...
void URLLoaderClientProxy::OnReceiveResponse(
    ::network::mojom::URLResponseHeadPtr in_head, ::mojo::ScopedDataPipeConsumerHandle in_body, absl::optional<::mojo_base::BigBuffer> in_cached_metadata)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send network::mojom::URLLoaderClient::OnReceiveResponse", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("cached_metadata"), in_cached_metadata, "<value of type absl::optional<::mojo_base::BigBuffer>>");
    });
#endif
    const bool kExpectsResponse = false;
    const bool kIsSync = false;
    ...
    mojo::Message message(internal::kURLLoaderClient_OnReceiveResponse_Name, kFlags, 0, 0, nullptr);
...
void URLLoaderClientProxy::OnReceiveRedirect(const ::net::RedirectInfo& in_redirect_info, ::network::mojom::URLResponseHeadPtr in_head)
{
    ...
    mojo::Message message(internal::kURLLoaderClient_OnReceiveRedirect_Name, kFlags, 0, 0, nullptr);
    ...
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
        params->redirect_info.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null redirect_info in URLLoaderClient.OnReceiveRedirect request");
    mojo::internal::MessageFragment<typename decltype(params->head)::BaseType> head_fragment(params.message());
    mojo::internal::Serialize<::network::mojom::URLResponseHeadDataView>(in_head, head_fragment);
    params->head.Set(head_fragment.is_null() ? nullptr : head_fragment.data());
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
...
void URLLoaderClientProxy::OnUploadProgress(int64_t in_current_position, int64_t in_total_size, OnUploadProgressCallback callback)
{
    ...
    mojo::Message message(internal::kURLLoaderClient_OnUploadProgress_Name, kFlags, 0, 0, nullptr);
...
void URLLoaderClientProxy::OnTransferSizeUpdated(int32_t in_transfer_size_diff)
{
    ...
    mojo::Message message(internal::kURLLoaderClient_OnTransferSizeUpdated_Name, kFlags, 0, 0, nullptr);
...
void URLLoaderClientProxy::OnComplete(const ::network::URLLoaderCompletionStatus& in_status)
{
    ...
    mojo::Message message(internal::kURLLoaderClient_OnComplete_Name, kFlags, 0, 0, nullptr);
...
public:
    ...
    {
        std::unique_ptr<URLLoaderClient_OnUploadProgress_ProxyToResponder> proxy(new URLLoaderClient_OnUploadProgress_ProxyToResponder(message, std::move(responder)));
...
bool URLLoaderClientStubDispatch::Accept(URLLoaderClient* impl, mojo::Message* message)
{
    ...
    case internal::kURLLoaderClient_OnReceiveEarlyHints_Name: {
        ...
        bool success = true;
        ::network::mojom::EarlyHintsPtr p_early_hints = mojo::DefaultConstructTraits::CreateInstance<::network::mojom::EarlyHintsPtr>();
    ...
    case internal::kURLLoaderClient_OnReceiveResponse_Name: {
        ...
        DCHECK(message->is_serialized());
        internal::URLLoaderClient_OnReceiveResponse_Params_Data* params = reinterpret_cast<internal::URLLoaderClient_OnReceiveResponse_Params_Data*>(message->mutable_payload());

        bool success = true;
        ::network::mojom::URLResponseHeadPtr p_head = mojo::DefaultConstructTraits::CreateInstance<::network::mojom::URLResponseHeadPtr>();
        ::mojo::ScopedDataPipeConsumerHandle p_body = mojo::DefaultConstructTraits::CreateInstance<::mojo::ScopedDataPipeConsumerHandle>();
        absl::optional<::mojo_base::BigBuffer> p_cached_metadata = mojo::DefaultConstructTraits::CreateInstance<absl::optional<::mojo_base::BigBuffer>>();
    ...
    case internal::kURLLoaderClient_OnReceiveRedirect_Name: {
        ...
        DCHECK(message->is_serialized());
        internal::URLLoaderClient_OnReceiveRedirect_Params_Data* params = reinterpret_cast<internal::URLLoaderClient_OnReceiveRedirect_Params_Data*>(message->mutable_payload());
    ...
    case internal::kURLLoaderClient_OnComplete_Name: {
        ...
        DCHECK(message->is_serialized());
        internal::URLLoaderClient_OnComplete_Params_Data* params = reinterpret_cast<internal::URLLoaderClient_OnComplete_Params_Data*>(message->mutable_payload());
...
bool URLLoaderClientStubDispatch::AcceptWithResponder(URLLoaderClient* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
{
    ...
    case internal::kURLLoaderClient_OnUploadProgress_Name: {
        ...
        internal::URLLoaderClient_OnUploadProgress_Params_Data* params = reinterpret_cast<internal::URLLoaderClient_OnUploadProgress_Params_Data*>(message->mutable_payload());

        bool success = true;
        int64_t p_current_position = mojo::DefaultConstructTraits::CreateInstance<int64_t>();
        int64_t p_total_size = mojo::DefaultConstructTraits::CreateInstance<int64_t>();
...
static const std::pair<uint32_t, mojo::internal::GenericValidationInfo> kURLLoaderClientValidationInfo[] = {
    { internal::kURLLoaderClient_OnReceiveEarlyHints_Name, { &internal::URLLoaderClient_OnReceiveEarlyHints_Params_Data::Validate, nullptr /* no response */ } },
    { internal::kURLLoaderClient_OnReceiveResponse_Name, { &internal::URLLoaderClient_OnReceiveResponse_Params_Data::Validate, nullptr /* no response */ } },
    { internal::kURLLoaderClient_OnReceiveRedirect_Name, { &internal::URLLoaderClient_OnReceiveRedirect_Params_Data::Validate, nullptr /* no response */ } },
    ...
    { internal::kURLLoaderClient_OnTransferSizeUpdated_Name, { &internal::URLLoaderClient_OnTransferSizeUpdated_Params_Data::Validate, nullptr /* no response */ } },
    { internal::kURLLoaderClient_OnComplete_Name, { &internal::URLLoaderClient_OnComplete_Params_Data::Validate, nullptr /* no response */ } },
};
...
void URLLoaderInterceptorForTesting::PauseReadingBodyFromNet() { GetForwardingInterface()->PauseReadingBodyFromNet(); }
void URLLoaderInterceptorForTesting::ResumeReadingBodyFromNet() { GetForwardingInterface()->ResumeReadingBodyFromNet(); }
...
void URLLoaderClientInterceptorForTesting::OnTransferSizeUpdated(int32_t transfer_size_diff) { GetForwardingInterface()->OnTransferSizeUpdated(std::move(transfer_size_diff)); }
void URLLoaderClientInterceptorForTesting::OnComplete(const ::network::URLLoaderCompletionStatus& status) { GetForwardingInterface()->OnComplete(std::move(status)); }
