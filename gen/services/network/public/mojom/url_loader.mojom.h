...
// with not having this data in traces there.
    ...
    virtual void OnReceiveResponse(::network::mojom::URLResponseHeadPtr head, ::mojo::ScopedDataPipeConsumerHandle body, absl::optional<::mojo_base::BigBuffer> cached_metadata)
        = 0;
...
//
//   void FollowRedirect(const std::vector<std::string>& removed_headers, const ::net::HttpRequestHeaders& modified_headers, const ::net::HttpRequestHeaders&
//   modified_cors_exempt_headers, const absl::optional<::GURL>& new_url) final;
//
...
template <> struct StructTraits<::network::mojom::URLLoaderClientEndpoints::DataView, ::network::mojom::URLLoaderClientEndpointsPtr> {
    ...
    static decltype(::network::mojom::URLLoaderClientEndpoints::url_loader)& url_loader(::network::mojom::URLLoaderClientEndpointsPtr& input) { return input->url_loader; }
