    ...
    const ::blink::KURL& in_blocked_url, ::network::mojom::blink::RequestDestination in_destination, bool in_report_only)
{
    ...
    TRACE_EVENT1("mojom", "Send network::mojom::CrossOriginEmbedderPolicyReporter::QueueCorpViolationReport", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("destination"), in_destination, "<value of type ::network::mojom::blink::RequestDestination>");
...
bool CrossOriginEmbedderPolicyReporterStubDispatch::Accept(CrossOriginEmbedderPolicyReporter* impl, mojo::Message* message)
{
    ...
    case internal::kCrossOriginEmbedderPolicyReporter_QueueCorpViolationReport_Name: {
        ...
        ::network::mojom::blink::RequestDestination p_destination = mojo::DefaultConstructTraits::CreateInstance<::network::mojom::blink::RequestDestination>();
