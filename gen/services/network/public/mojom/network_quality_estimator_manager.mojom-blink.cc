...
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send network::mojom::NetworkQualityEstimatorManagerClient::OnNetworkQualityChanged", "input_parameters", [&](perfetto::TracedValue context) {
    ...
    mojo::Message message(internal::kNetworkQualityEstimatorManagerClient_OnNetworkQualityChanged_Name, kFlags, 0, 0, nullptr);
...
bool NetworkQualityEstimatorManagerClientStubDispatch::Accept(NetworkQualityEstimatorManagerClient* impl, mojo::Message* message)
{
    ...
    case internal::kNetworkQualityEstimatorManagerClient_OnNetworkQualityChanged_Name: {
        ...
        ::base::TimeDelta p_http_rtt = mojo::DefaultConstructTraits::CreateInstance<::base::TimeDelta>();
        ::base::TimeDelta p_transport_rtt = mojo::DefaultConstructTraits::CreateInstance<::base::TimeDelta>();
        int32_t p_downlink_bandwidth_kbps = mojo::DefaultConstructTraits::CreateInstance<int32_t>();
        ...
        if (!success) {
            ReportValidationErrorForMessage(message, mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED, NetworkQualityEstimatorManagerClient::Name_, 0, false);
            return false;
        }
...
void NetworkQualityEstimatorManagerProxy::RequestNotifications(::mojo::PendingRemote<NetworkQualityEstimatorManagerClient> in_client)
{
    ...
    TRACE_EVENT1("mojom", "Send network::mojom::NetworkQualityEstimatorManager::RequestNotifications", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("client"), in_client, "<value of type ::mojo::PendingRemote<NetworkQualityEstimatorManagerClient>>");
    });
#endif
    const bool kExpectsResponse = false;
    const bool kIsSync = false;
    ...
    mojo::Message message(internal::kNetworkQualityEstimatorManager_RequestNotifications_Name, kFlags, 0, 0, nullptr);
    ...
    params.Allocate();
    mojo::internal::Serialize<mojo::InterfacePtrDataView<::network::mojom::NetworkQualityEstimatorManagerClientInterfaceBase>>(in_client, &params->client, &params.message());
...
bool NetworkQualityEstimatorManagerStubDispatch::Accept(NetworkQualityEstimatorManager* impl, mojo::Message* message)
{
    ...
    case internal::kNetworkQualityEstimatorManager_RequestNotifications_Name: {
        ...
        ::mojo::PendingRemote<NetworkQualityEstimatorManagerClient> p_client
            = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingRemote<NetworkQualityEstimatorManagerClient>>();
