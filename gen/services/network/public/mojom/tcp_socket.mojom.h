...
// with not having this data in traces there.
    ...
    virtual void Connect(const ::net::AddressList& remote_addr_list, TCPConnectedSocketOptionsPtr tcp_connected_socket_options, ::mojo::PendingReceiver<TCPConnectedSocket> socket,
...
// with not having this data in traces there.
    ...
    using UpgradeToTLSCallback
        = base::OnceCallback<void(int32_t, ::mojo::ScopedDataPipeConsumerHandle, ::mojo::ScopedDataPipeProducerHandle, const absl::optional<::net::SSLInfo>&)>;
...
//
//   void Connect(const ::net::AddressList& remote_addr_list, TCPConnectedSocketOptionsPtr tcp_connected_socket_options, ::mojo::PendingReceiver<TCPConnectedSocket> socket,
//   ::mojo::PendingRemote<SocketObserver> observer, ConnectCallback callback) final;
//
//  private:
...
template <> struct StructTraits<::network::mojom::TCPKeepAliveOptions::DataView, ::network::mojom::TCPKeepAliveOptionsPtr> {
    ...
    static decltype(::network::mojom::TCPKeepAliveOptions::enable) enable(const ::network::mojom::TCPKeepAliveOptionsPtr& input) { return input->enable; }

    static decltype(::network::mojom::TCPKeepAliveOptions::delay) delay(const ::network::mojom::TCPKeepAliveOptionsPtr& input) { return input->delay; }
...
template <> struct StructTraits<::network::mojom::TCPConnectedSocketOptions::DataView, ::network::mojom::TCPConnectedSocketOptionsPtr> {
    ...
    static decltype(::network::mojom::TCPConnectedSocketOptions::receive_buffer_size) receive_buffer_size(const ::network::mojom::TCPConnectedSocketOptionsPtr& input)
    {
        return input->receive_buffer_size;
    }

    static decltype(::network::mojom::TCPConnectedSocketOptions::no_delay) no_delay(const ::network::mojom::TCPConnectedSocketOptionsPtr& input) { return input->no_delay; }

    static const decltype(::network::mojom::TCPConnectedSocketOptions::keep_alive_options)& keep_alive_options(const ::network::mojom::TCPConnectedSocketOptionsPtr& input)
    {
