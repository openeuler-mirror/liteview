...
static NOINLINE const char* IsolationInfoRequestTypeToStringHelper(IsolationInfoRequestType value)
{
...
std::ostream& operator<<(std::ostream& os, IsolationInfoRequestType value) { return os << IsolationInfoRequestTypeToString(value); }
...
// static
void TraceFormatTraits<::network::mojom::IsolationInfoRequestType>::WriteIntoTrace(perfetto::TracedValue context, ::network::mojom::IsolationInfoRequestType value)
{
