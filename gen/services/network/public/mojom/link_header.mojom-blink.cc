...
LinkHeader::LinkHeader(const ::blink::KURL& href_in, LinkRelAttribute rel_in, LinkAsAttribute as_in, CrossOriginAttribute cross_origin_in, const WTF::String& mime_type_in)
