...
static_assert(sizeof(NetworkChangeManagerClient_OnInitialConnectionType_Params_Data) == 16, "Bad sizeof(NetworkChangeManagerClient_OnInitialConnectionType_Params_Data)");
...
public:
    ...
    NetworkChangeManagerClient_OnInitialConnectionType_ParamsDataView(internal::NetworkChangeManagerClient_OnInitialConnectionType_Params_Data* data, mojo::Message* message)
        : data_(data)
    {
    }
    ...
    ConnectionType type() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::network::mojom::ConnectionType>(data_->type)); }
...
public:
    ...
    {
        UserType result;
        bool ret = mojo::internal::Deserialize<mojo::InterfacePtrDataView<::network::mojom::NetworkChangeManagerClientInterfaceBase>>(&data_->client_remote, &result, message_);
        DCHECK(ret);
        return result;
    }
