...
NetworkInterface::NetworkInterface(const WTF::String& name_in, const WTF::String& friendly_name_in, uint32_t interface_index_in, ::network::mojom::blink::ConnectionType type_in,
...
bool NetworkInterface::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
} // namespace blink
} // namespace mojom
} // namespace network
namespace mojo {
