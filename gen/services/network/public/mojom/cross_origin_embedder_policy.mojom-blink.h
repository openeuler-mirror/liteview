...
struct network_mojom_internal_CrossOriginEmbedderPolicyValue_DataHashFn {
    ...
    static bool Equal(const ::network::mojom::CrossOriginEmbedderPolicyValue& left, const ::network::mojom::CrossOriginEmbedderPolicyValue& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::network::mojom::CrossOriginEmbedderPolicyValue> : public GenericHashTraits<::network::mojom::CrossOriginEmbedderPolicyValue> {
...
public:
    ...
    template <typename... Args> static CrossOriginEmbedderPolicyPtr New(Args&&... args) { return CrossOriginEmbedderPolicyPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static CrossOriginEmbedderPolicyPtr From(const U& u) { return mojo::TypeConverter<CrossOriginEmbedderPolicyPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, CrossOriginEmbedderPolicy>::Convert(*this); }
    ...
    CrossOriginEmbedderPolicy(CrossOriginEmbedderPolicyValue value_in, const WTF::String& reporting_endpoint_in, CrossOriginEmbedderPolicyValue report_only_value_in,
    ...
    template <typename T, CrossOriginEmbedderPolicy::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::CrossOriginEmbedderPolicy_UnserializedMessageContext<UserType, CrossOriginEmbedderPolicy::DataView>>(0, 0, std::move(input)),
    ...
    {
        return CrossOriginEmbedderPolicy::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }

    template <typename UserType> static bool DeserializeFromMessage(mojo::Message input, UserType* output)
    {
        auto context = input.TakeUnserializedContext<internal::CrossOriginEmbedderPolicy_UnserializedMessageContext<UserType, CrossOriginEmbedderPolicy::DataView>>();
        if (context) {
...
template <typename T, CrossOriginEmbedderPolicy::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, CrossOriginEmbedderPolicy::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, CrossOriginEmbedderPolicy::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
namespace mojo {
template <> struct BLINK_PLATFORM_EXPORT StructTraits<::network::mojom::blink::CrossOriginEmbedderPolicy::DataView, ::network::mojom::blink::CrossOriginEmbedderPolicyPtr> {
    ...
    static decltype(::network::mojom::blink::CrossOriginEmbedderPolicy::value) value(const ::network::mojom::blink::CrossOriginEmbedderPolicyPtr& input) { return input->value; }
    ...
    static decltype(::network::mojom::blink::CrossOriginEmbedderPolicy::report_only_value) report_only_value(const ::network::mojom::blink::CrossOriginEmbedderPolicyPtr& input)
    {
