...
LoadInfo::LoadInfo(::base::TimeTicks timestamp_in, const std::string& host_in, uint32_t load_state_in, const ::std::u16string& state_param_in, uint64_t upload_position_in,
...
void ClientCertificateResponderProxy::ContinueWithCertificate(const ::scoped_refptr<::net::X509Certificate>& in_x509_certificate, const std::string& in_provider_name,
    const std::vector<uint16_t>& in_algorithm_preferences, ::mojo::PendingRemote<SSLPrivateKey> in_ssl_private_key)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send network::mojom::ClientCertificateResponder::ContinueWithCertificate", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("x509_certificate"), in_x509_certificate, "<value of type const ::scoped_refptr<::net::X509Certificate>&>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("provider_name"), in_provider_name, "<value of type const std::string&>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("algorithm_preferences"), in_algorithm_preferences, "<value of type const std::vector<uint16_t>&>");
...
bool ClientCertificateResponderStubDispatch::Accept(ClientCertificateResponder* impl, mojo::Message* message)
{
    ...
    case internal::kClientCertificateResponder_ContinueWithCertificate_Name: {
        ...
        bool success = true;
        ::scoped_refptr<::net::X509Certificate> p_x509_certificate = mojo::DefaultConstructTraits::CreateInstance<::scoped_refptr<::net::X509Certificate>>();
        std::string p_provider_name = mojo::DefaultConstructTraits::CreateInstance<std::string>();
        std::vector<uint16_t> p_algorithm_preferences = mojo::DefaultConstructTraits::CreateInstance<std::vector<uint16_t>>();
...
bool SSLPrivateKey_Sign_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    std::vector<uint8_t> p_signature = mojo::DefaultConstructTraits::CreateInstance<std::vector<uint8_t>>();
...
bool SSLPrivateKeyStubDispatch::AcceptWithResponder(SSLPrivateKey* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
{
    ...
    case internal::kSSLPrivateKey_Sign_Name: {
        ...
        std::vector<uint8_t> p_input = mojo::DefaultConstructTraits::CreateInstance<std::vector<uint8_t>>();
...
void AuthChallengeResponderProxy::OnAuthCredentials(const absl::optional<::net::AuthCredentials>& in_credentials)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    ...
    const ::scoped_refptr<::net::SSLCertRequestInfo>& in_cert_info, ::mojo::PendingRemote<ClientCertificateResponder> in_cert_responder)
{
    ...
    TRACE_EVENT1("mojom", "Send network::mojom::URLLoaderNetworkServiceObserver::OnCertificateRequested", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("cert_info"), in_cert_info, "<value of type const ::scoped_refptr<::net::SSLCertRequestInfo>&>");
...
void URLLoaderNetworkServiceObserverProxy::OnAuthRequired(const absl::optional<::base::UnguessableToken>& in_window_id, uint32_t in_request_id, const ::GURL& in_url,
    bool in_first_auth_attempt, const ::net::AuthChallengeInfo& in_auth_info, const ::scoped_refptr<::net::HttpResponseHeaders>& in_head_headers,
    ::mojo::PendingRemote<AuthChallengeResponder> in_auth_challenge_responder)
{
    ...
    TRACE_EVENT1("mojom", "Send network::mojom::URLLoaderNetworkServiceObserver::OnAuthRequired", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("head_headers"), in_head_headers, "<value of type const ::scoped_refptr<::net::HttpResponseHeaders>&>");
...
void URLLoaderNetworkServiceObserverProxy::OnClearSiteData(const ::GURL& in_url, const std::string& in_header_value, int32_t in_load_flags,
    const absl::optional<::net::CookiePartitionKey>& in_cookie_partition_key, OnClearSiteDataCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send network::mojom::URLLoaderNetworkServiceObserver::OnClearSiteData", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("cookie_partition_key"), in_cookie_partition_key, "<value of type const absl::optional<::net::CookiePartitionKey>&>");
    });
#endif
    const bool kExpectsResponse = true;
    const bool kIsSync = false;
...
bool URLLoaderNetworkServiceObserverStubDispatch::Accept(URLLoaderNetworkServiceObserver* impl, mojo::Message* message)
{
    ...
    case internal::kURLLoaderNetworkServiceObserver_OnCertificateRequested_Name: {
        ...
        ::scoped_refptr<::net::SSLCertRequestInfo> p_cert_info = mojo::DefaultConstructTraits::CreateInstance<::scoped_refptr<::net::SSLCertRequestInfo>>();
    ...
    case internal::kURLLoaderNetworkServiceObserver_OnAuthRequired_Name: {
        ...
        ::scoped_refptr<::net::HttpResponseHeaders> p_head_headers = mojo::DefaultConstructTraits::CreateInstance<::scoped_refptr<::net::HttpResponseHeaders>>();
    ...
    URLLoaderNetworkServiceObserver* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
{
    ...
    case internal::kURLLoaderNetworkServiceObserver_OnSSLCertificateError_Name: {
        ...
        ::GURL p_url = mojo::DefaultConstructTraits::CreateInstance<::GURL>();
        int32_t p_net_error = mojo::DefaultConstructTraits::CreateInstance<int32_t>();
        ::net::SSLInfo p_ssl_info = mojo::DefaultConstructTraits::CreateInstance<::net::SSLInfo>();
    ...
    case internal::kURLLoaderNetworkServiceObserver_OnClearSiteData_Name: {
        ...
        bool success = true;
        ::GURL p_url = mojo::DefaultConstructTraits::CreateInstance<::GURL>();
        std::string p_header_value = mojo::DefaultConstructTraits::CreateInstance<std::string>();
        int32_t p_load_flags = mojo::DefaultConstructTraits::CreateInstance<int32_t>();
        absl::optional<::net::CookiePartitionKey> p_cookie_partition_key = mojo::DefaultConstructTraits::CreateInstance<absl::optional<::net::CookiePartitionKey>>();
...
namespace mojo {
// static
bool StructTraits<::network::mojom::LoadInfo::DataView, ::network::mojom::LoadInfoPtr>::Read(::network::mojom::LoadInfo::DataView input, ::network::mojom::LoadInfoPtr* output)
{
    bool success = true;
...
namespace network {
namespace mojom {
void ClientCertificateResponderInterceptorForTesting::ContinueWithCertificate(const ::scoped_refptr<::net::X509Certificate>& x509_certificate, const std::string& provider_name,
...
void URLLoaderNetworkServiceObserverInterceptorForTesting::OnAuthRequired(const absl::optional<::base::UnguessableToken>& window_id, uint32_t request_id, const ::GURL& url,
    bool first_auth_attempt, const ::net::AuthChallengeInfo& auth_info, const ::scoped_refptr<::net::HttpResponseHeaders>& head_headers,
...
void URLLoaderNetworkServiceObserverInterceptorForTesting::OnClearSiteData(
    const ::GURL& url, const std::string& header_value, int32_t load_flags, const absl::optional<::net::CookiePartitionKey>& cookie_partition_key, OnClearSiteDataCallback callback)
{
...
void URLLoaderNetworkServiceObserverAsyncWaiter::OnSSLCertificateError(const ::GURL& url, int32_t net_error, const ::net::SSLInfo& ssl_info, bool fatal, int32_t* out_net_error)
{
    base::RunLoop loop;
