...
public:
    ...
    template <typename... Args> static URLResponseHeadPtr New(Args&&... args) { return URLResponseHeadPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static URLResponseHeadPtr From(const U& u) { return mojo::TypeConverter<URLResponseHeadPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, URLResponseHead>::Convert(*this); }
    URLResponseHead()
        : request_time()
        , response_time()
        , headers()
    ...
    URLResponseHead(::base::Time request_time_in, ::base::Time response_time_in, const ::scoped_refptr<::net::HttpResponseHeaders>& headers_in, const std::string& mime_type_in,
        const std::string& charset_in, ::net::ct::CTPolicyCompliance ct_policy_compliance_in, int64_t content_length_in, int64_t encoded_data_length_in,
        int64_t encoded_body_length_in, bool network_accessed_in, const ::net::LoadTimingInfo& load_timing_in, bool emitted_extra_info_in, bool was_fetched_via_spdy_in,
        bool was_alpn_negotiated_in, bool was_alternate_protocol_available_in, ::net::HttpResponseInfo::ConnectionInfo connection_info_in,
        const std::string& alpn_negotiated_protocol_in, ::net::AlternateProtocolUsage alternate_protocol_usage_in, const ::net::IPEndPoint& remote_endpoint_in,
        ::network::mojom::IPAddressSpace client_address_space_in, ::network::mojom::IPAddressSpace response_address_space_in, bool is_validated_in, bool was_fetched_via_cache_in,
        const ::net::ProxyServer& proxy_server_in, bool was_fetched_via_service_worker_in, ::network::mojom::FetchResponseSource service_worker_response_source_in,
        std::vector<::GURL> url_list_via_service_worker_in, ::network::mojom::FetchResponseType response_type_in, int64_t padding_in,
        const std::string& cache_storage_cache_name_in, uint32_t cert_status_in, const absl::optional<::net::SSLInfo>& ssl_info_in,
        std::vector<std::string> cors_exposed_header_names_in, bool did_service_worker_navigation_preload_in, bool should_report_corb_blocking_in,
        bool async_revalidation_requested_in, bool did_mime_sniff_in, bool is_signed_exchange_inner_response_in, bool was_in_prefetch_cache_in, bool was_cookie_in_request_in,
        bool intercepted_by_plugin_in, bool is_legacy_tls_version_in, bool has_range_requested_in, bool timing_allow_passed_in,
        const absl::optional<::net::AuthChallengeInfo>& auth_challenge_info_in, ::base::TimeTicks request_start_in, ::base::TimeTicks response_start_in,
        ::network::mojom::ParsedHeadersPtr parsed_headers_in, const absl::optional<::base::UnguessableToken>& recursive_prefetch_token_in, std::vector<std::string> dns_aliases_in,
        const ::GURL& web_bundle_url_in, bool has_authorization_covered_by_wildcard_on_preflight_in, bool request_include_credentials_in, bool has_partitioned_cookie_in)
    ...
    template <typename T, URLResponseHead::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    ...
    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<URLResponseHead::DataView>(input); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::URLResponseHead_UnserializedMessageContext<UserType, URLResponseHead::DataView>>(0, 0, std::move(input)), MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    {
        return URLResponseHead::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, URLResponseHead::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, URLResponseHead::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, URLResponseHead::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }

template <typename StructPtrType> URLResponseHeadPtr URLResponseHead::Clone() const
{
    return New(mojo::Clone(request_time), mojo::Clone(response_time), mojo::Clone(headers), mojo::Clone(mime_type), mojo::Clone(charset), mojo::Clone(ct_policy_compliance),
        mojo::Clone(content_length), mojo::Clone(encoded_data_length), mojo::Clone(encoded_body_length), mojo::Clone(network_accessed), mojo::Clone(load_timing),
        mojo::Clone(emitted_extra_info), mojo::Clone(was_fetched_via_spdy), mojo::Clone(was_alpn_negotiated), mojo::Clone(was_alternate_protocol_available),
        mojo::Clone(connection_info), mojo::Clone(alpn_negotiated_protocol), mojo::Clone(alternate_protocol_usage), mojo::Clone(remote_endpoint), mojo::Clone(client_address_space),
        mojo::Clone(response_address_space), mojo::Clone(is_validated), mojo::Clone(was_fetched_via_cache), mojo::Clone(proxy_server), mojo::Clone(was_fetched_via_service_worker),
        mojo::Clone(service_worker_response_source), mojo::Clone(url_list_via_service_worker), mojo::Clone(response_type), mojo::Clone(padding),
        mojo::Clone(cache_storage_cache_name), mojo::Clone(cert_status), mojo::Clone(ssl_info), mojo::Clone(cors_exposed_header_names),
        mojo::Clone(did_service_worker_navigation_preload), mojo::Clone(should_report_corb_blocking), mojo::Clone(async_revalidation_requested), mojo::Clone(did_mime_sniff),
        mojo::Clone(is_signed_exchange_inner_response), mojo::Clone(was_in_prefetch_cache), mojo::Clone(was_cookie_in_request), mojo::Clone(intercepted_by_plugin),
        mojo::Clone(is_legacy_tls_version), mojo::Clone(has_range_requested), mojo::Clone(timing_allow_passed), mojo::Clone(auth_challenge_info), mojo::Clone(request_start),
        mojo::Clone(response_start), mojo::Clone(parsed_headers), mojo::Clone(recursive_prefetch_token), mojo::Clone(dns_aliases), mojo::Clone(web_bundle_url),
        mojo::Clone(has_authorization_covered_by_wildcard_on_preflight), mojo::Clone(request_include_credentials), mojo::Clone(has_partitioned_cookie));
}
...
template <> struct StructTraits<::network::mojom::URLResponseHead::DataView, ::network::mojom::URLResponseHeadPtr> {
    ...
    static const decltype(::network::mojom::URLResponseHead::request_time)& request_time(const ::network::mojom::URLResponseHeadPtr& input) { return input->request_time; }

    static const decltype(::network::mojom::URLResponseHead::response_time)& response_time(const ::network::mojom::URLResponseHeadPtr& input) { return input->response_time; }

    static const decltype(::network::mojom::URLResponseHead::headers)& headers(const ::network::mojom::URLResponseHeadPtr& input) { return input->headers; }

    static const decltype(::network::mojom::URLResponseHead::mime_type)& mime_type(const ::network::mojom::URLResponseHeadPtr& input) { return input->mime_type; }

    static const decltype(::network::mojom::URLResponseHead::charset)& charset(const ::network::mojom::URLResponseHeadPtr& input) { return input->charset; }

    static decltype(::network::mojom::URLResponseHead::ct_policy_compliance) ct_policy_compliance(const ::network::mojom::URLResponseHeadPtr& input)
    {
        return input->ct_policy_compliance;
    }

    static decltype(::network::mojom::URLResponseHead::content_length) content_length(const ::network::mojom::URLResponseHeadPtr& input) { return input->content_length; }
    ...
    static decltype(::network::mojom::URLResponseHead::encoded_body_length) encoded_body_length(const ::network::mojom::URLResponseHeadPtr& input)
    {
        return input->encoded_body_length;
    }

    static decltype(::network::mojom::URLResponseHead::network_accessed) network_accessed(const ::network::mojom::URLResponseHeadPtr& input) { return input->network_accessed; }

    static const decltype(::network::mojom::URLResponseHead::load_timing)& load_timing(const ::network::mojom::URLResponseHeadPtr& input) { return input->load_timing; }
    ...
    static decltype(::network::mojom::URLResponseHead::was_alternate_protocol_available) was_alternate_protocol_available(const ::network::mojom::URLResponseHeadPtr& input)
    {
        return input->was_alternate_protocol_available;
    }

    static decltype(::network::mojom::URLResponseHead::connection_info) connection_info(const ::network::mojom::URLResponseHeadPtr& input) { return input->connection_info; }

    static const decltype(::network::mojom::URLResponseHead::alpn_negotiated_protocol)& alpn_negotiated_protocol(const ::network::mojom::URLResponseHeadPtr& input)
    {
    ...
    static const decltype(::network::mojom::URLResponseHead::remote_endpoint)& remote_endpoint(const ::network::mojom::URLResponseHeadPtr& input) { return input->remote_endpoint; }
    ...
    static decltype(::network::mojom::URLResponseHead::is_validated) is_validated(const ::network::mojom::URLResponseHeadPtr& input) { return input->is_validated; }
    ...
    static const decltype(::network::mojom::URLResponseHead::proxy_server)& proxy_server(const ::network::mojom::URLResponseHeadPtr& input) { return input->proxy_server; }

    static decltype(::network::mojom::URLResponseHead::was_fetched_via_service_worker) was_fetched_via_service_worker(const ::network::mojom::URLResponseHeadPtr& input)
    {
        return input->was_fetched_via_service_worker;
    }

    static decltype(::network::mojom::URLResponseHead::service_worker_response_source) service_worker_response_source(const ::network::mojom::URLResponseHeadPtr& input)
    {
        return input->service_worker_response_source;
    }

    static const decltype(::network::mojom::URLResponseHead::url_list_via_service_worker)& url_list_via_service_worker(const ::network::mojom::URLResponseHeadPtr& input)
    {
        return input->url_list_via_service_worker;
    }

    static decltype(::network::mojom::URLResponseHead::response_type) response_type(const ::network::mojom::URLResponseHeadPtr& input) { return input->response_type; }

    static decltype(::network::mojom::URLResponseHead::padding) padding(const ::network::mojom::URLResponseHeadPtr& input) { return input->padding; }

    static const decltype(::network::mojom::URLResponseHead::cache_storage_cache_name)& cache_storage_cache_name(const ::network::mojom::URLResponseHeadPtr& input)
    {
        return input->cache_storage_cache_name;
    }

    static decltype(::network::mojom::URLResponseHead::cert_status) cert_status(const ::network::mojom::URLResponseHeadPtr& input) { return input->cert_status; }

    static const decltype(::network::mojom::URLResponseHead::ssl_info)& ssl_info(const ::network::mojom::URLResponseHeadPtr& input) { return input->ssl_info; }

    static const decltype(::network::mojom::URLResponseHead::cors_exposed_header_names)& cors_exposed_header_names(const ::network::mojom::URLResponseHeadPtr& input)
    {
    ...
    static decltype(::network::mojom::URLResponseHead::should_report_corb_blocking) should_report_corb_blocking(const ::network::mojom::URLResponseHeadPtr& input)
    {
        return input->should_report_corb_blocking;
    }

    static decltype(::network::mojom::URLResponseHead::async_revalidation_requested) async_revalidation_requested(const ::network::mojom::URLResponseHeadPtr& input)
    {
        return input->async_revalidation_requested;
    }

    static decltype(::network::mojom::URLResponseHead::did_mime_sniff) did_mime_sniff(const ::network::mojom::URLResponseHeadPtr& input) { return input->did_mime_sniff; }

    static decltype(::network::mojom::URLResponseHead::is_signed_exchange_inner_response) is_signed_exchange_inner_response(const ::network::mojom::URLResponseHeadPtr& input)
    {
    ...
    static decltype(::network::mojom::URLResponseHead::is_legacy_tls_version) is_legacy_tls_version(const ::network::mojom::URLResponseHeadPtr& input)
    {
    ...
    static const decltype(::network::mojom::URLResponseHead::request_start)& request_start(const ::network::mojom::URLResponseHeadPtr& input) { return input->request_start; }

    static const decltype(::network::mojom::URLResponseHead::response_start)& response_start(const ::network::mojom::URLResponseHeadPtr& input) { return input->response_start; }

    static const decltype(::network::mojom::URLResponseHead::parsed_headers)& parsed_headers(const ::network::mojom::URLResponseHeadPtr& input) { return input->parsed_headers; }

    static const decltype(::network::mojom::URLResponseHead::recursive_prefetch_token)& recursive_prefetch_token(const ::network::mojom::URLResponseHeadPtr& input)
    {
        return input->recursive_prefetch_token;
    }

    static const decltype(::network::mojom::URLResponseHead::dns_aliases)& dns_aliases(const ::network::mojom::URLResponseHeadPtr& input) { return input->dns_aliases; }

    static const decltype(::network::mojom::URLResponseHead::web_bundle_url)& web_bundle_url(const ::network::mojom::URLResponseHeadPtr& input) { return input->web_bundle_url; }
    ...
    static decltype(::network::mojom::URLResponseHead::request_include_credentials) request_include_credentials(const ::network::mojom::URLResponseHeadPtr& input)
    {
        return input->request_include_credentials;
    }

    static decltype(::network::mojom::URLResponseHead::has_partitioned_cookie) has_partitioned_cookie(const ::network::mojom::URLResponseHeadPtr& input)
    {
