...
public:
    ...
    template <typename... Args> static LoadTimingInfoConnectTimingPtr New(Args&&... args) { return LoadTimingInfoConnectTimingPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static LoadTimingInfoConnectTimingPtr From(const U& u) { return mojo::TypeConverter<LoadTimingInfoConnectTimingPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, LoadTimingInfoConnectTiming>::Convert(*this); }
    ...
    LoadTimingInfoConnectTiming(::base::TimeTicks domain_lookup_start_in, ::base::TimeTicks domain_lookup_end_in, ::base::TimeTicks connect_start_in,
        ::base::TimeTicks connect_end_in, ::base::TimeTicks ssl_start_in, ::base::TimeTicks ssl_end_in)
    ...
    template <typename T, LoadTimingInfoConnectTiming::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::LoadTimingInfoConnectTiming_UnserializedMessageContext<UserType, LoadTimingInfoConnectTiming::DataView>>(0, 0, std::move(input)),
    ...
    {
        return LoadTimingInfoConnectTiming::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }

    template <typename UserType> static bool DeserializeFromMessage(mojo::Message input, UserType* output)
    {
        auto context = input.TakeUnserializedContext<internal::LoadTimingInfoConnectTiming_UnserializedMessageContext<UserType, LoadTimingInfoConnectTiming::DataView>>();
        if (context) {
...
template <typename T, LoadTimingInfoConnectTiming::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, LoadTimingInfoConnectTiming::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, LoadTimingInfoConnectTiming::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static LoadTimingInfoPtr New(Args&&... args) { return LoadTimingInfoPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static LoadTimingInfoPtr From(const U& u) { return mojo::TypeConverter<LoadTimingInfoPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, LoadTimingInfo>::Convert(*this); }
    LoadTimingInfo()
        : socket_reused()
        , socket_log_id()
        , request_start_time()
    ...
    LoadTimingInfo(bool socket_reused_in, uint32_t socket_log_id_in, ::base::Time request_start_time_in, ::base::TimeTicks request_start_in,
        ::base::TimeTicks proxy_resolve_start_in, ::base::TimeTicks proxy_resolve_end_in, LoadTimingInfoConnectTimingPtr connect_timing_in, ::base::TimeTicks send_start_in,
        ::base::TimeTicks send_end_in, ::base::TimeTicks receive_headers_start_in, ::base::TimeTicks receive_headers_end_in,
        ::base::TimeTicks receive_non_informational_headers_start_in, ::base::TimeTicks first_early_hints_time_in, ::base::TimeTicks push_start_in, ::base::TimeTicks push_end_in,
        ::base::TimeTicks service_worker_start_time_in, ::base::TimeTicks service_worker_ready_time_in, ::base::TimeTicks service_worker_fetch_start_in,
    ...
    template <typename T, LoadTimingInfo::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static WTF::Vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<LoadTimingInfo::DataView, WTF::Vector<uint8_t>>(input);
    }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<LoadTimingInfo::DataView>(input); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::LoadTimingInfo_UnserializedMessageContext<UserType, LoadTimingInfo::DataView>>(0, 0, std::move(input)), MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const WTF::Vector<uint8_t>& input, UserType* output)
    {
        return LoadTimingInfo::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, LoadTimingInfo::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, LoadTimingInfo::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, LoadTimingInfo::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }

template <typename StructPtrType> LoadTimingInfoConnectTimingPtr LoadTimingInfoConnectTiming::Clone() const
{
    return New(
        mojo::Clone(domain_lookup_start), mojo::Clone(domain_lookup_end), mojo::Clone(connect_start), mojo::Clone(connect_end), mojo::Clone(ssl_start), mojo::Clone(ssl_end));
}
...
{
    return New(mojo::Clone(socket_reused), mojo::Clone(socket_log_id), mojo::Clone(request_start_time), mojo::Clone(request_start), mojo::Clone(proxy_resolve_start),
        mojo::Clone(proxy_resolve_end), mojo::Clone(connect_timing), mojo::Clone(send_start), mojo::Clone(send_end), mojo::Clone(receive_headers_start),
        mojo::Clone(receive_headers_end), mojo::Clone(receive_non_informational_headers_start), mojo::Clone(first_early_hints_time), mojo::Clone(push_start), mojo::Clone(push_end),
        mojo::Clone(service_worker_start_time), mojo::Clone(service_worker_ready_time), mojo::Clone(service_worker_fetch_start), mojo::Clone(service_worker_respond_with_settled));
}
...
namespace mojo {
template <> struct BLINK_PLATFORM_EXPORT StructTraits<::network::mojom::blink::LoadTimingInfoConnectTiming::DataView, ::network::mojom::blink::LoadTimingInfoConnectTimingPtr> {
    ...
    static const decltype(::network::mojom::blink::LoadTimingInfoConnectTiming::connect_start)& connect_start(const ::network::mojom::blink::LoadTimingInfoConnectTimingPtr& input)
    {
        return input->connect_start;
    }

    static const decltype(::network::mojom::blink::LoadTimingInfoConnectTiming::connect_end)& connect_end(const ::network::mojom::blink::LoadTimingInfoConnectTimingPtr& input)
    {
        return input->connect_end;
    }

    static const decltype(::network::mojom::blink::LoadTimingInfoConnectTiming::ssl_start)& ssl_start(const ::network::mojom::blink::LoadTimingInfoConnectTimingPtr& input)
    {
        return input->ssl_start;
    }

    static const decltype(::network::mojom::blink::LoadTimingInfoConnectTiming::ssl_end)& ssl_end(const ::network::mojom::blink::LoadTimingInfoConnectTimingPtr& input)
    {
...
template <> struct BLINK_PLATFORM_EXPORT StructTraits<::network::mojom::blink::LoadTimingInfo::DataView, ::network::mojom::blink::LoadTimingInfoPtr> {
    ...
    static decltype(::network::mojom::blink::LoadTimingInfo::socket_reused) socket_reused(const ::network::mojom::blink::LoadTimingInfoPtr& input) { return input->socket_reused; }

    static decltype(::network::mojom::blink::LoadTimingInfo::socket_log_id) socket_log_id(const ::network::mojom::blink::LoadTimingInfoPtr& input) { return input->socket_log_id; }

    static const decltype(::network::mojom::blink::LoadTimingInfo::request_start_time)& request_start_time(const ::network::mojom::blink::LoadTimingInfoPtr& input)
    {
    ...
    static const decltype(::network::mojom::blink::LoadTimingInfo::proxy_resolve_start)& proxy_resolve_start(const ::network::mojom::blink::LoadTimingInfoPtr& input)
    {
        return input->proxy_resolve_start;
    }

    static const decltype(::network::mojom::blink::LoadTimingInfo::proxy_resolve_end)& proxy_resolve_end(const ::network::mojom::blink::LoadTimingInfoPtr& input)
    {
    ...
    static const decltype(::network::mojom::blink::LoadTimingInfo::send_start)& send_start(const ::network::mojom::blink::LoadTimingInfoPtr& input) { return input->send_start; }

    static const decltype(::network::mojom::blink::LoadTimingInfo::send_end)& send_end(const ::network::mojom::blink::LoadTimingInfoPtr& input) { return input->send_end; }

    static const decltype(::network::mojom::blink::LoadTimingInfo::receive_headers_start)& receive_headers_start(const ::network::mojom::blink::LoadTimingInfoPtr& input)
    {
        return input->receive_headers_start;
    }

    static const decltype(::network::mojom::blink::LoadTimingInfo::receive_headers_end)& receive_headers_end(const ::network::mojom::blink::LoadTimingInfoPtr& input)
    {
    ...
    static const decltype(::network::mojom::blink::LoadTimingInfo::first_early_hints_time)& first_early_hints_time(const ::network::mojom::blink::LoadTimingInfoPtr& input)
    {
        return input->first_early_hints_time;
    }

    static const decltype(::network::mojom::blink::LoadTimingInfo::push_start)& push_start(const ::network::mojom::blink::LoadTimingInfoPtr& input) { return input->push_start; }

    static const decltype(::network::mojom::blink::LoadTimingInfo::push_end)& push_end(const ::network::mojom::blink::LoadTimingInfoPtr& input) { return input->push_end; }

    static const decltype(::network::mojom::blink::LoadTimingInfo::service_worker_start_time)& service_worker_start_time(const ::network::mojom::blink::LoadTimingInfoPtr& input)
    {
        return input->service_worker_start_time;
    }

    static const decltype(::network::mojom::blink::LoadTimingInfo::service_worker_ready_time)& service_worker_ready_time(const ::network::mojom::blink::LoadTimingInfoPtr& input)
    {
        return input->service_worker_ready_time;
    }

    static const decltype(::network::mojom::blink::LoadTimingInfo::service_worker_fetch_start)& service_worker_fetch_start(const ::network::mojom::blink::LoadTimingInfoPtr& input)
    {
