...
CTLogInfo::CTLogInfo(const WTF::String& id_in, const WTF::String& public_key_in, const WTF::String& name_in, bool operated_by_google_in,
    absl::optional<::base::Time> disqualified_at_in, ::base::TimeDelta mmd_in, const WTF::String& current_operator_in, WTF::Vector<PreviousOperatorEntryPtr> previous_operators_in)
    : id(std::move(id_in))
