...
static_assert(sizeof(RestrictedCookieManager_SetCanonicalCookie_Params_Data) == 48, "Bad sizeof(RestrictedCookieManager_SetCanonicalCookie_Params_Data)");
...
static_assert(sizeof(RestrictedCookieManager_SetCanonicalCookie_ResponseParams_Data) == 16, "Bad sizeof(RestrictedCookieManager_SetCanonicalCookie_ResponseParams_Data)");
...
static_assert(sizeof(RestrictedCookieManager_AddChangeListener_Params_Data) == 40, "Bad sizeof(RestrictedCookieManager_AddChangeListener_Params_Data)");
...
static_assert(sizeof(RestrictedCookieManager_AddChangeListener_ResponseParams_Data) == 8, "Bad sizeof(RestrictedCookieManager_AddChangeListener_ResponseParams_Data)");
...
static_assert(sizeof(RestrictedCookieManager_SetCookieFromString_ResponseParams_Data) == 16, "Bad sizeof(RestrictedCookieManager_SetCookieFromString_ResponseParams_Data)");
...
static_assert(sizeof(RestrictedCookieManager_GetCookiesString_ResponseParams_Data) == 16, "Bad sizeof(RestrictedCookieManager_GetCookiesString_ResponseParams_Data)");
...
static_assert(sizeof(RestrictedCookieManager_CookiesEnabledFor_Params_Data) == 32, "Bad sizeof(RestrictedCookieManager_CookiesEnabledFor_Params_Data)");
...
static_assert(sizeof(RestrictedCookieManager_CookiesEnabledFor_ResponseParams_Data) == 16, "Bad sizeof(RestrictedCookieManager_CookiesEnabledFor_ResponseParams_Data)");
...
public:
    ...
    bool partitioned_cookies_runtime_feature_enabled() const { return data_->partitioned_cookies_runtime_feature_enabled; }
...
public:
    ...
    RestrictedCookieManager_GetAllForUrl_ResponseParamsDataView(internal::RestrictedCookieManager_GetAllForUrl_ResponseParams_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
...
public:
    ...
    RestrictedCookieManager_SetCanonicalCookie_ResponseParamsDataView(internal::RestrictedCookieManager_SetCanonicalCookie_ResponseParams_Data* data, mojo::Message* message)
        : data_(data)
    {
    }
...
public:
    ...
    RestrictedCookieManager_AddChangeListener_ResponseParamsDataView(internal::RestrictedCookieManager_AddChangeListener_ResponseParams_Data* data, mojo::Message* message)
        : data_(data)
    {
    }
...
public:
    ...
    RestrictedCookieManager_SetCookieFromString_ResponseParamsDataView(internal::RestrictedCookieManager_SetCookieFromString_ResponseParams_Data* data, mojo::Message* message)
        : data_(data)
    {
    }

    bool is_null() const { return !data_; }
    bool site_for_cookies_ok() const { return data_->site_for_cookies_ok; }
    bool top_frame_origin_ok() const { return data_->top_frame_origin_ok; }
...
public:
    ...
    RestrictedCookieManager_GetCookiesString_ResponseParamsDataView(internal::RestrictedCookieManager_GetCookiesString_ResponseParams_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
...
public:
    ...
    RestrictedCookieManager_CookiesEnabledFor_ResponseParamsDataView(internal::RestrictedCookieManager_CookiesEnabledFor_ResponseParams_Data* data, mojo::Message* message)
        : data_(data)
    {
    }

    bool is_null() const { return !data_; }
    bool cookies_enabled() const { return data_->cookies_enabled; }
...
public:
    ...
    RestrictedCookieManager_ConvertPartitionedCookiesToUnpartitioned_ParamsDataView(
        internal::RestrictedCookieManager_ConvertPartitionedCookiesToUnpartitioned_Params_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
...
inline void RestrictedCookieManager_GetAllForUrl_ResponseParamsDataView::GetCookiesDataView(mojo::ArrayDataView<::network::mojom::CookieWithAccessResultDataView>* output)
{
    auto pointer = data_->cookies.Get();
...
inline void RestrictedCookieManager_ConvertPartitionedCookiesToUnpartitioned_ParamsDataView::GetUrlDataView(::url::mojom::UrlDataView* output)
{
    auto pointer = data_->url.Get();
    *output = ::url::mojom::UrlDataView(pointer, message_);
}
