...
static_assert(sizeof(URLResponseHeadDevToolsInfo_Data) == 96, "Bad sizeof(URLResponseHeadDevToolsInfo_Data)");
// Used by URLResponseHeadDevToolsInfo::WrapAsMessage to lazily serialize the struct.
template <typename UserType, typename DataView> struct URLResponseHeadDevToolsInfo_UnserializedMessageContext : public mojo::internal::UnserializedMessageContext {
public:
    static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;
