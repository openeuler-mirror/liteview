...
CookieManagerParams::CookieManagerParams(bool block_third_party_cookies_in, WTF::Vector<::content_settings::mojom::blink::ContentSettingPatternSourcePtr> settings_in,
...
void CookieManagerParams::WriteIntoTrace(perfetto::TracedValue traced_context) const
{
    ...
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("settings_for_legacy_cookie_access"), this->settings_for_legacy_cookie_access,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
        "<value of type WTF::Vector<::content_settings::mojom::blink::ContentSettingPatternSourcePtr>>"
#else
        "<value>"
    ...
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("settings_for_storage_access"), this->settings_for_storage_access,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
        "<value of type WTF::Vector<::content_settings::mojom::blink::ContentSettingPatternSourcePtr>>"
#else
        "<value>"
...
bool CookieManagerParams::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
CookieSameSiteContextMetadata::CookieSameSiteContextMetadata(
    CookieSameSiteContextMetadataDowngradeType cross_site_redirect_downgrade_in, ContextRedirectTypeBug1221316 redirect_type_bug_1221316_in)
...
bool CookieSameSiteContextMetadata::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
bool CookieSameSiteContext::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
CookieOptions::CookieOptions(bool exclude_httponly_in, CookieSameSiteContextPtr same_site_cookie_context_in, bool update_access_time_in, bool return_excluded_cookies_in,
...
size_t CookieOptions::Hash(size_t seed) const
{
    ...
    seed = mojo::internal::WTFHash(seed, this->same_party_context);
...
void CookieOptions::WriteIntoTrace(perfetto::TracedValue traced_context) const
{
    ...
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("same_party_context"), this->same_party_context,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
        "<value of type ::network::mojom::blink::SamePartyContextPtr>"
#else
        "<value>"
#endif // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("full_party_context_size"), this->full_party_context_size,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    ...
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("is_in_nontrivial_first_party_set"), this->is_in_nontrivial_first_party_set,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
        "<value of type bool>"
#else
        "<value>"
...
bool CookieOptions::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
CanonicalCookie::CanonicalCookie(const WTF::String& name_in, const WTF::String& value_in, const WTF::String& domain_in, const WTF::String& path_in, ::base::Time creation_in,
    ...
    CookiePriority priority_in, CookieSourceScheme source_scheme_in, bool same_party_in, ::network::mojom::blink::CookiePartitionKeyPtr partition_key_in, int32_t source_port_in)
...
void CanonicalCookie::WriteIntoTrace(perfetto::TracedValue traced_context) const
{
    ...
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("same_party"), this->same_party,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
        "<value of type bool>"
#else
        "<value>"
...
bool CanonicalCookie::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
CookieInclusionStatus::CookieInclusionStatus(uint32_t exclusion_reasons_in, uint32_t warning_reasons_in)
...
bool CookieInclusionStatus::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
CookieAndLineWithAccessResult::CookieAndLineWithAccessResult(
    const absl::optional<::net::CanonicalCookie>& cookie_in, const WTF::String& cookie_string_in, CookieAccessResultPtr access_result_in)
...
bool CookieAndLineWithAccessResult::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
bool CookieOrLineWithAccessResult::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
CookieAccessResult::CookieAccessResult(
    CookieEffectiveSameSite effective_same_site_in, CookieAccessSemantics access_semantics_in, ::net::CookieInclusionStatus status_in, bool is_allowed_to_access_secure_cookies_in)
...
bool CookieAccessResult::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
bool CookieWithAccessResult::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
bool CookieChangeInfo::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
CookieDeletionFilter::CookieDeletionFilter(absl::optional<::base::Time> created_after_time_in, absl::optional<::base::Time> created_before_time_in,
...
bool CookieDeletionFilter::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
CookieOrLine::~CookieOrLine() { DestroyActive(); }
...
bool CookieOrLine::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context, false); }
...
void CookieChangeListenerProxy::OnCookieChange(CookieChangeInfoPtr in_change)
{
    ...
    mojo::Message message(internal::kCookieChangeListener_OnCookieChange_Name, kFlags, 0, 0, nullptr);
...
bool CookieChangeListenerStubDispatch::Accept(CookieChangeListener* impl, mojo::Message* message)
{
    ...
    case internal::kCookieChangeListener_OnCookieChange_Name: {
        ...
        bool success = true;
        CookieChangeInfoPtr p_change = mojo::DefaultConstructTraits::CreateInstance<CookieChangeInfoPtr>();
...
// static
bool CookieChangeListenerStubDispatch::AcceptWithResponder(CookieChangeListener* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
{
...
static const std::pair<uint32_t, mojo::internal::GenericValidationInfo> kCookieChangeListenerValidationInfo[] = {
    { internal::kCookieChangeListener_OnCookieChange_Name, { &internal::CookieChangeListener_OnCookieChange_Params_Data::Validate, nullptr /* no response */ } },
};
...
uint32_t CookieManager::SetContentSettingsForLegacyCookieAccess_Sym::IPCStableHash()
{
    ...
    // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
    // hash instead of __LINE__.
    constexpr uint32_t kHash = base::MD5Hash32Constexpr("(Impl)network::mojom::CookieManager::SetContentSettingsForLegacyCookieAccess");
    const uint32_t hash = kHash;
    base::debug::Alias(&hash);
    return hash;
}
uint32_t CookieManager::SetStorageAccessGrantSettings_Sym::IPCStableHash()
{
    ...
    // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
    // hash instead of __LINE__.
    constexpr uint32_t kHash = base::MD5Hash32Constexpr("(Impl)network::mojom::CookieManager::SetStorageAccessGrantSettings");
    const uint32_t hash = kHash;
    base::debug::Alias(&hash);
    return hash;
}
uint32_t CookieManager::ConvertPartitionedCookiesToUnpartitioned_Sym::IPCStableHash()
{
    ...
    // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
    // hash instead of __LINE__.
    constexpr uint32_t kHash = base::MD5Hash32Constexpr("(Impl)network::mojom::CookieManager::ConvertPartitionedCookiesToUnpartitioned");
    const uint32_t hash = kHash;
    base::debug::Alias(&hash);
    return hash;
}
...
class CookieManager_SetStorageAccessGrantSettings_ForwardToCallback : public mojo::MessageReceiver {
public:
    CookieManager_SetStorageAccessGrantSettings_ForwardToCallback(CookieManager::SetStorageAccessGrantSettingsCallback callback)
        : callback_(std::move(callback))
    {
    }
...
void CookieManagerProxy::GetAllCookies(GetAllCookiesCallback callback)
{
    ...
    mojo::Message message(internal::kCookieManager_GetAllCookies_Name, kFlags, 0, 0, nullptr);
...
void CookieManagerProxy::GetAllCookiesWithAccessSemantics(GetAllCookiesWithAccessSemanticsCallback callback)
{
    ...
    mojo::Message message(internal::kCookieManager_GetAllCookiesWithAccessSemantics_Name, kFlags, 0, 0, nullptr);
    ...
    ::network::mojom::blink::CookiePartitionKeyCollectionPtr in_cookie_partition_key_collection, GetCookieListCallback callback)
{
    ...
    TRACE_EVENT1("mojom", "Send network::mojom::CookieManager::GetCookieList", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("cookie_partition_key_collection"), in_cookie_partition_key_collection, "<value of type ::network::mojom::blink::CookiePartitionKeyCollectionPtr>");
    });
#endif
    const bool kExpectsResponse = true;
    const bool kIsSync = false;
    ...
    mojo::Message message(internal::kCookieManager_GetCookieList_Name, kFlags, 0, 0, nullptr);
    ...
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(params->url.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null url in CookieManager.GetCookieList request");
    ...
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
        params->cookie_options.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null cookie_options in CookieManager.GetCookieList request");
    mojo::internal::MessageFragment<typename decltype(params->cookie_partition_key_collection)::BaseType> cookie_partition_key_collection_fragment(params.message());
    mojo::internal::Serialize<::network::mojom::CookiePartitionKeyCollectionDataView>(in_cookie_partition_key_collection, cookie_partition_key_collection_fragment);
    ...
    const ::net::CanonicalCookie& in_cookie, const ::blink::KURL& in_source_url, CookieOptionsPtr in_cookie_options, SetCanonicalCookieCallback callback)
{
    ...
    mojo::Message message(internal::kCookieManager_SetCanonicalCookie_Name, kFlags, 0, 0, nullptr);
    ...
    params->cookie_options.Set(cookie_options_fragment.is_null() ? nullptr : cookie_options_fragment.data());
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
        params->cookie_options.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null cookie_options in CookieManager.SetCanonicalCookie request");
...
void CookieManagerProxy::DeleteCanonicalCookie(const ::net::CanonicalCookie& in_cookie, DeleteCanonicalCookieCallback callback)
{
    ...
    mojo::Message message(internal::kCookieManager_DeleteCanonicalCookie_Name, kFlags, 0, 0, nullptr);
...
void CookieManagerProxy::DeleteCookies(CookieDeletionFilterPtr in_filter, DeleteCookiesCallback callback)
{
    ...
    mojo::Message message(internal::kCookieManager_DeleteCookies_Name, kFlags, 0, 0, nullptr);
...
void CookieManagerProxy::DeleteSessionOnlyCookies(DeleteSessionOnlyCookiesCallback callback)
{
    ...
    mojo::Message message(internal::kCookieManager_DeleteSessionOnlyCookies_Name, kFlags, 0, 0, nullptr);
...
void CookieManagerProxy::AddCookieChangeListener(const ::blink::KURL& in_url, const WTF::String& in_name, ::mojo::PendingRemote<CookieChangeListener> in_listener)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    ...
    mojo::Message message(internal::kCookieManager_AddCookieChangeListener_Name, kFlags, 0, 0, nullptr);
...
void CookieManagerProxy::AddGlobalChangeListener(::mojo::PendingRemote<CookieChangeListener> in_notification_pointer)
{
    ...
    TRACE_EVENT1("mojom", "Send network::mojom::CookieManager::AddGlobalChangeListener", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("notification_pointer"), in_notification_pointer, "<value of type ::mojo::PendingRemote<CookieChangeListener>>");
    });
#endif
    const bool kExpectsResponse = false;
    const bool kIsSync = false;
    ...
    mojo::Message message(internal::kCookieManager_AddGlobalChangeListener_Name, kFlags, 0, 0, nullptr);
    ...
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(!mojo::internal::IsHandleOrInterfaceValid(params->notification_pointer), mojo::internal::VALIDATION_ERROR_UNEXPECTED_INVALID_HANDLE,
...
void CookieManagerProxy::CloneInterface(::mojo::PendingReceiver<CookieManager> in_new_interface)
{
    ...
    mojo::Message message(internal::kCookieManager_CloneInterface_Name, kFlags, 0, 0, nullptr);
    mojo::internal::MessageFragment<::network::mojom::internal::CookieManager_CloneInterface_Params_Data> params(message);
    params.Allocate();
    mojo::internal::Serialize<mojo::InterfaceRequestDataView<::network::mojom::CookieManagerInterfaceBase>>(in_new_interface, &params->new_interface, &params.message());
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(!mojo::internal::IsHandleOrInterfaceValid(params->new_interface), mojo::internal::VALIDATION_ERROR_UNEXPECTED_INVALID_HANDLE,
...
void CookieManagerProxy::FlushCookieStore(FlushCookieStoreCallback callback)
{
    ...
    mojo::Message message(internal::kCookieManager_FlushCookieStore_Name, kFlags, 0, 0, nullptr);
...
void CookieManagerProxy::AllowFileSchemeCookies(bool in_allow, AllowFileSchemeCookiesCallback callback)
{
    ...
    mojo::Message message(internal::kCookieManager_AllowFileSchemeCookies_Name, kFlags, 0, 0, nullptr);
...
void CookieManagerProxy::SetContentSettings(WTF::Vector<::content_settings::mojom::blink::ContentSettingPatternSourcePtr> in_settings)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    ...
    mojo::Message message(internal::kCookieManager_SetContentSettings_Name, kFlags, 0, 0, nullptr);
    ...
    const mojo::internal::ContainerValidateParams settings_validate_params(0, false, nullptr);
    mojo::internal::Serialize<mojo::ArrayDataView<::content_settings::mojom::ContentSettingPatternSourceDataView>>(in_settings, settings_fragment, &settings_validate_params);
...
void CookieManagerProxy::SetForceKeepSessionState()
{
    ...
    mojo::Message message(internal::kCookieManager_SetForceKeepSessionState_Name, kFlags, 0, 0, nullptr);
...
void CookieManagerProxy::BlockThirdPartyCookies(bool in_block)
{
    ...
    mojo::Message message(internal::kCookieManager_BlockThirdPartyCookies_Name, kFlags, 0, 0, nullptr);
...
void CookieManagerProxy::SetContentSettingsForLegacyCookieAccess(WTF::Vector<::content_settings::mojom::blink::ContentSettingPatternSourcePtr> in_settings)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send network::mojom::CookieManager::SetContentSettingsForLegacyCookieAccess", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("settings"), in_settings, "<value of type WTF::Vector<::content_settings::mojom::blink::ContentSettingPatternSourcePtr>>");
    });
    ...
    mojo::Message message(internal::kCookieManager_SetContentSettingsForLegacyCookieAccess_Name, kFlags, 0, 0, nullptr);
    mojo::internal::MessageFragment<::network::mojom::internal::CookieManager_SetContentSettingsForLegacyCookieAccess_Params_Data> params(message);
    params.Allocate();
    mojo::internal::MessageFragment<typename decltype(params->settings)::BaseType> settings_fragment(params.message());
    const mojo::internal::ContainerValidateParams settings_validate_params(0, false, nullptr);
    mojo::internal::Serialize<mojo::ArrayDataView<::content_settings::mojom::ContentSettingPatternSourceDataView>>(in_settings, settings_fragment, &settings_validate_params);
    params->settings.Set(settings_fragment.is_null() ? nullptr : settings_fragment.data());
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
        params->settings.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null settings in CookieManager.SetContentSettingsForLegacyCookieAccess request");
...
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send network::mojom::CookieManager::SetStorageAccessGrantSettings", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("settings"), in_settings, "<value of type WTF::Vector<::content_settings::mojom::blink::ContentSettingPatternSourcePtr>>");
    });
    ...
    mojo::Message message(internal::kCookieManager_SetStorageAccessGrantSettings_Name, kFlags, 0, 0, nullptr);
    mojo::internal::MessageFragment<::network::mojom::internal::CookieManager_SetStorageAccessGrantSettings_Params_Data> params(message);
    params.Allocate();
    mojo::internal::MessageFragment<typename decltype(params->settings)::BaseType> settings_fragment(params.message());
    const mojo::internal::ContainerValidateParams settings_validate_params(0, false, nullptr);
    mojo::internal::Serialize<mojo::ArrayDataView<::content_settings::mojom::ContentSettingPatternSourceDataView>>(in_settings, settings_fragment, &settings_validate_params);
    params->settings.Set(settings_fragment.is_null() ? nullptr : settings_fragment.data());
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
        params->settings.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null settings in CookieManager.SetStorageAccessGrantSettings request");

#if defined(ENABLE_IPC_FUZZER)
    message.set_interface_name(CookieManager::Name_);
    message.set_method_name("SetStorageAccessGrantSettings");
#endif
    std::unique_ptr<mojo::MessageReceiver> responder(new CookieManager_SetStorageAccessGrantSettings_ForwardToCallback(std::move(callback)));
    ::mojo::internal::SendMojoMessage(*receiver_, message, std::move(responder));
}

void CookieManagerProxy::ConvertPartitionedCookiesToUnpartitioned(const ::blink::KURL& in_url)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send network::mojom::CookieManager::ConvertPartitionedCookiesToUnpartitioned", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("url"), in_url, "<value of type const ::blink::KURL&>");
    });
#endif
    ...
    mojo::Message message(internal::kCookieManager_ConvertPartitionedCookiesToUnpartitioned_Name, kFlags, 0, 0, nullptr);
    mojo::internal::MessageFragment<::network::mojom::internal::CookieManager_ConvertPartitionedCookiesToUnpartitioned_Params_Data> params(message);
    params.Allocate();
    mojo::internal::MessageFragment<typename decltype(params->url)::BaseType> url_fragment(params.message());
    mojo::internal::Serialize<::url::mojom::UrlDataView>(in_url, url_fragment);
    params->url.Set(url_fragment.is_null() ? nullptr : url_fragment.data());
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
        params->url.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null url in CookieManager.ConvertPartitionedCookiesToUnpartitioned request");
...
bool CookieManager_GetAllCookies_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    DCHECK(message->is_serialized());
    internal::CookieManager_GetAllCookies_ResponseParams_Data* params = reinterpret_cast<internal::CookieManager_GetAllCookies_ResponseParams_Data*>(message->mutable_payload());

    bool success = true;
    WTF::Vector<::net::CanonicalCookie> p_cookies = mojo::DefaultConstructTraits::CreateInstance<WTF::Vector<::net::CanonicalCookie>>();
...
public:
    static CookieManager::GetAllCookiesWithAccessSemanticsCallback CreateCallback(::mojo::Message& message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
    {
...
bool CookieManager_GetAllCookiesWithAccessSemantics_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    bool success = true;
    WTF::Vector<::net::CanonicalCookie> p_cookies = mojo::DefaultConstructTraits::CreateInstance<WTF::Vector<::net::CanonicalCookie>>();
    WTF::Vector<CookieAccessSemantics> p_access_semantics_list = mojo::DefaultConstructTraits::CreateInstance<WTF::Vector<CookieAccessSemantics>>();
...
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send reply network::mojom::CookieManager::GetAllCookiesWithAccessSemantics", "async_response_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("cookies"), in_cookies, "<value of type const WTF::Vector<::net::CanonicalCookie>&>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("access_semantics_list"), in_access_semantics_list, "<value of type const WTF::Vector<CookieAccessSemantics>&>");
    });
#endif
    ...
    const mojo::internal::ContainerValidateParams access_semantics_list_validate_params(0, ::network::mojom::internal::CookieAccessSemantics_Data::Validate);
    ...
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(params->access_semantics_list.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null access_semantics_list in ");
...
bool CookieManager_GetCookieList_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    DCHECK(message->is_serialized());
    internal::CookieManager_GetCookieList_ResponseParams_Data* params = reinterpret_cast<internal::CookieManager_GetCookieList_ResponseParams_Data*>(message->mutable_payload());

    bool success = true;
    WTF::Vector<CookieWithAccessResultPtr> p_cookies = mojo::DefaultConstructTraits::CreateInstance<WTF::Vector<CookieWithAccessResultPtr>>();
    WTF::Vector<CookieWithAccessResultPtr> p_excluded_cookies = mojo::DefaultConstructTraits::CreateInstance<WTF::Vector<CookieWithAccessResultPtr>>();
...
void CookieManager_GetCookieList_ProxyToResponder::Run(WTF::Vector<CookieWithAccessResultPtr> in_cookies, WTF::Vector<CookieWithAccessResultPtr> in_excluded_cookies)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send reply network::mojom::CookieManager::GetCookieList", "async_response_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("excluded_cookies"), in_excluded_cookies, "<value of type WTF::Vector<CookieWithAccessResultPtr>>");
    });
#endif
    ...
    const mojo::internal::ContainerValidateParams excluded_cookies_validate_params(0, false, nullptr);
    ...
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(params->excluded_cookies.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null excluded_cookies in ");
...
public:
    ...
    {
        std::unique_ptr<CookieManager_SetCanonicalCookie_ProxyToResponder> proxy(new CookieManager_SetCanonicalCookie_ProxyToResponder(message, std::move(responder)));
...
bool CookieManager_SetCanonicalCookie_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    bool success = true;
    CookieAccessResultPtr p_access_result = mojo::DefaultConstructTraits::CreateInstance<CookieAccessResultPtr>();
...
void CookieManager_SetCanonicalCookie_ProxyToResponder::Run(CookieAccessResultPtr in_access_result)
{
    ...
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(params->access_result.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null access_result in ");
...
public:
    ...
    {
        std::unique_ptr<CookieManager_DeleteCanonicalCookie_ProxyToResponder> proxy(new CookieManager_DeleteCanonicalCookie_ProxyToResponder(message, std::move(responder)));
...
bool CookieManager_DeleteCookies_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    DCHECK(message->is_serialized());
    internal::CookieManager_DeleteCookies_ResponseParams_Data* params = reinterpret_cast<internal::CookieManager_DeleteCookies_ResponseParams_Data*>(message->mutable_payload());

    bool success = true;
    uint32_t p_num_deleted = mojo::DefaultConstructTraits::CreateInstance<uint32_t>();
...
public:
    ...
    {
        std::unique_ptr<CookieManager_DeleteSessionOnlyCookies_ProxyToResponder> proxy(new CookieManager_DeleteSessionOnlyCookies_ProxyToResponder(message, std::move(responder)));
...
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send reply network::mojom::CookieManager::DeleteSessionOnlyCookies", "async_response_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("num_deleted"), in_num_deleted, "<value of type uint32_t>");
    });
#endif
...
public:
    ...
    {
        std::unique_ptr<CookieManager_FlushCookieStore_ProxyToResponder> proxy(new CookieManager_FlushCookieStore_ProxyToResponder(message, std::move(responder)));
...
bool CookieManager_FlushCookieStore_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    if (!success) {
        ReportValidationErrorForMessage(message, mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED, CookieManager::Name_, 10, true);
        return false;
    }
    if (!callback_.is_null())
...
public:
    ...
    {
        std::unique_ptr<CookieManager_AllowFileSchemeCookies_ProxyToResponder> proxy(new CookieManager_AllowFileSchemeCookies_ProxyToResponder(message, std::move(responder)));
...
public:
    static CookieManager::SetStorageAccessGrantSettingsCallback CreateCallback(::mojo::Message& message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
    {
        std::unique_ptr<CookieManager_SetStorageAccessGrantSettings_ProxyToResponder> proxy(
            new CookieManager_SetStorageAccessGrantSettings_ProxyToResponder(message, std::move(responder)));
        return base::BindOnce(&CookieManager_SetStorageAccessGrantSettings_ProxyToResponder::Run, std::move(proxy));
    }
...
private:
    CookieManager_SetStorageAccessGrantSettings_ProxyToResponder(::mojo::Message& message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
        : ::mojo::internal::ProxyToResponder(message, std::move(responder))
    {
    }
    ...
    static void OnIsConnectedComplete(bool connected)
    {
        DCHECK(!connected) << "CookieManager::SetStorageAccessGrantSettingsCallback was destroyed without "
                           << "first either being run or its corresponding binding being closed. "
                           << "It is an error to drop response callbacks which still correspond "
                           << "to an open interface pipe.";
    }
...
bool CookieManager_SetStorageAccessGrantSettings_ForwardToCallback::Accept(mojo::Message* message)
{

    DCHECK(message->is_serialized());
    internal::CookieManager_SetStorageAccessGrantSettings_ResponseParams_Data* params
        = reinterpret_cast<internal::CookieManager_SetStorageAccessGrantSettings_ResponseParams_Data*>(message->mutable_payload());

    bool success = true;
    CookieManager_SetStorageAccessGrantSettings_ResponseParamsDataView input_data_view(params, message);

    if (!success) {
        ReportValidationErrorForMessage(message, mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED, CookieManager::Name_, 16, true);
        return false;
    }
    if (!callback_.is_null())
        std::move(callback_).Run();
...
void CookieManager_SetStorageAccessGrantSettings_ProxyToResponder::Run()
{
    ...
    mojo::Message message(internal::kCookieManager_SetStorageAccessGrantSettings_Name, kFlags, 0, 0, nullptr);
    mojo::internal::MessageFragment<::network::mojom::internal::CookieManager_SetStorageAccessGrantSettings_ResponseParams_Data> params(message);
    params.Allocate();
...
bool CookieManagerStubDispatch::Accept(CookieManager* impl, mojo::Message* message)
{
    ...
    case internal::kCookieManager_AddCookieChangeListener_Name: {
        ...
        ::mojo::PendingRemote<CookieChangeListener> p_listener = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingRemote<CookieChangeListener>>();
    ...
    case internal::kCookieManager_AddGlobalChangeListener_Name: {
        ...
        bool success = true;
        ::mojo::PendingRemote<CookieChangeListener> p_notification_pointer = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingRemote<CookieChangeListener>>();
    ...
    case internal::kCookieManager_CloneInterface_Name: {
        ...
        DCHECK(message->is_serialized());
        internal::CookieManager_CloneInterface_Params_Data* params = reinterpret_cast<internal::CookieManager_CloneInterface_Params_Data*>(message->mutable_payload());

        bool success = true;
        ::mojo::PendingReceiver<CookieManager> p_new_interface = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingReceiver<CookieManager>>();
    ...
    case internal::kCookieManager_SetContentSettings_Name: {
        ...
        DCHECK(message->is_serialized());
        internal::CookieManager_SetContentSettings_Params_Data* params = reinterpret_cast<internal::CookieManager_SetContentSettings_Params_Data*>(message->mutable_payload());

        bool success = true;
        WTF::Vector<::content_settings::mojom::blink::ContentSettingPatternSourcePtr> p_settings
            = mojo::DefaultConstructTraits::CreateInstance<WTF::Vector<::content_settings::mojom::blink::ContentSettingPatternSourcePtr>>();
        ...
        // A null |impl| means no implementation was bound.
        DCHECK(impl);
        impl->SetContentSettings(std::move(p_settings));
        return true;
    }
    case internal::kCookieManager_SetForceKeepSessionState_Name: {
    ...
    case internal::kCookieManager_SetContentSettingsForLegacyCookieAccess_Name: {
        ...
        internal::CookieManager_SetContentSettingsForLegacyCookieAccess_Params_Data* params
            = reinterpret_cast<internal::CookieManager_SetContentSettingsForLegacyCookieAccess_Params_Data*>(message->mutable_payload());
        ...
        // A null |impl| means no implementation was bound.
        DCHECK(impl);
        impl->SetContentSettingsForLegacyCookieAccess(std::move(p_settings));
        return true;
    }
    case internal::kCookieManager_SetStorageAccessGrantSettings_Name: {
        break;
    ...
    case internal::kCookieManager_ConvertPartitionedCookiesToUnpartitioned_Name: {
        ...
        internal::CookieManager_ConvertPartitionedCookiesToUnpartitioned_Params_Data* params
            = reinterpret_cast<internal::CookieManager_ConvertPartitionedCookiesToUnpartitioned_Params_Data*>(message->mutable_payload());
...
bool CookieManagerStubDispatch::AcceptWithResponder(CookieManager* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
{
    ...
    case internal::kCookieManager_GetAllCookies_Name: {
        ...
        internal::CookieManager_GetAllCookies_Params_Data* params = reinterpret_cast<internal::CookieManager_GetAllCookies_Params_Data*>(message->mutable_payload());
    ...
    case internal::kCookieManager_GetCookieList_Name: {
        ...
        internal::CookieManager_GetCookieList_Params_Data* params = reinterpret_cast<internal::CookieManager_GetCookieList_Params_Data*>(message->mutable_payload());

        bool success = true;
        ::blink::KURL p_url = mojo::DefaultConstructTraits::CreateInstance<::blink::KURL>();
        CookieOptionsPtr p_cookie_options = mojo::DefaultConstructTraits::CreateInstance<CookieOptionsPtr>();
        ::network::mojom::blink::CookiePartitionKeyCollectionPtr p_cookie_partition_key_collection
            = mojo::DefaultConstructTraits::CreateInstance<::network::mojom::blink::CookiePartitionKeyCollectionPtr>();
    ...
    case internal::kCookieManager_SetCanonicalCookie_Name: {
        ...
        internal::CookieManager_SetCanonicalCookie_Params_Data* params = reinterpret_cast<internal::CookieManager_SetCanonicalCookie_Params_Data*>(message->mutable_payload());

        bool success = true;
        ::net::CanonicalCookie p_cookie = mojo::DefaultConstructTraits::CreateInstance<::net::CanonicalCookie>();
        ::blink::KURL p_source_url = mojo::DefaultConstructTraits::CreateInstance<::blink::KURL>();
        CookieOptionsPtr p_cookie_options = mojo::DefaultConstructTraits::CreateInstance<CookieOptionsPtr>();
    ...
    case internal::kCookieManager_DeleteCanonicalCookie_Name: {
        ...
        CookieManager::DeleteCanonicalCookieCallback callback = CookieManager_DeleteCanonicalCookie_ProxyToResponder::CreateCallback(*message, std::move(responder));
        // A null |impl| means no implementation was bound.
        DCHECK(impl);
    ...
    case internal::kCookieManager_DeleteCookies_Name: {
        ...
        internal::CookieManager_DeleteCookies_Params_Data* params = reinterpret_cast<internal::CookieManager_DeleteCookies_Params_Data*>(message->mutable_payload());

        bool success = true;
        CookieDeletionFilterPtr p_filter = mojo::DefaultConstructTraits::CreateInstance<CookieDeletionFilterPtr>();
    ...
    case internal::kCookieManager_DeleteSessionOnlyCookies_Name: {
        ...
        CookieManager::DeleteSessionOnlyCookiesCallback callback = CookieManager_DeleteSessionOnlyCookies_ProxyToResponder::CreateCallback(*message, std::move(responder));
        // A null |impl| means no implementation was bound.
        DCHECK(impl);
    ...
    case internal::kCookieManager_FlushCookieStore_Name: {
        ...
        internal::CookieManager_FlushCookieStore_Params_Data* params = reinterpret_cast<internal::CookieManager_FlushCookieStore_Params_Data*>(message->mutable_payload());
    ...
    case internal::kCookieManager_AllowFileSchemeCookies_Name: {
        ...
        CookieManager::AllowFileSchemeCookiesCallback callback = CookieManager_AllowFileSchemeCookies_ProxyToResponder::CreateCallback(*message, std::move(responder));
        // A null |impl| means no implementation was bound.
        DCHECK(impl);
    ...
    case internal::kCookieManager_SetStorageAccessGrantSettings_Name: {
        ...
        internal::CookieManager_SetStorageAccessGrantSettings_Params_Data* params
            = reinterpret_cast<internal::CookieManager_SetStorageAccessGrantSettings_Params_Data*>(message->mutable_payload());
        ...
        CookieManager::SetStorageAccessGrantSettingsCallback callback
            = CookieManager_SetStorageAccessGrantSettings_ProxyToResponder::CreateCallback(*message, std::move(responder));
        // A null |impl| means no implementation was bound.
        DCHECK(impl);
        impl->SetStorageAccessGrantSettings(std::move(p_settings), std::move(callback));
        return true;
    }
    case internal::kCookieManager_ConvertPartitionedCookiesToUnpartitioned_Name: {
        break;
...
static const std::pair<uint32_t, mojo::internal::GenericValidationInfo> kCookieManagerValidationInfo[] = {
    ...
    { internal::kCookieManager_DeleteSessionOnlyCookies_Name,
        { &internal::CookieManager_DeleteSessionOnlyCookies_Params_Data::Validate, &internal::CookieManager_DeleteSessionOnlyCookies_ResponseParams_Data::Validate } },
    { internal::kCookieManager_AddCookieChangeListener_Name, { &internal::CookieManager_AddCookieChangeListener_Params_Data::Validate, nullptr /* no response */ } },
    { internal::kCookieManager_AddGlobalChangeListener_Name, { &internal::CookieManager_AddGlobalChangeListener_Params_Data::Validate, nullptr /* no response */ } },
    { internal::kCookieManager_CloneInterface_Name, { &internal::CookieManager_CloneInterface_Params_Data::Validate, nullptr /* no response */ } },
    ...
    { internal::kCookieManager_SetContentSettings_Name, { &internal::CookieManager_SetContentSettings_Params_Data::Validate, nullptr /* no response */ } },
    { internal::kCookieManager_SetForceKeepSessionState_Name, { &internal::CookieManager_SetForceKeepSessionState_Params_Data::Validate, nullptr /* no response */ } },
    { internal::kCookieManager_BlockThirdPartyCookies_Name, { &internal::CookieManager_BlockThirdPartyCookies_Params_Data::Validate, nullptr /* no response */ } },
    { internal::kCookieManager_SetContentSettingsForLegacyCookieAccess_Name,
        { &internal::CookieManager_SetContentSettingsForLegacyCookieAccess_Params_Data::Validate, nullptr /* no response */ } },
    { internal::kCookieManager_SetStorageAccessGrantSettings_Name,
        { &internal::CookieManager_SetStorageAccessGrantSettings_Params_Data::Validate, &internal::CookieManager_SetStorageAccessGrantSettings_ResponseParams_Data::Validate } },
    { internal::kCookieManager_ConvertPartitionedCookiesToUnpartitioned_Name,
        { &internal::CookieManager_ConvertPartitionedCookiesToUnpartitioned_Params_Data::Validate, nullptr /* no response */ } },
};
...
namespace mojom {
namespace blink {
void CookieChangeListenerInterceptorForTesting::OnCookieChange(CookieChangeInfoPtr change) { GetForwardingInterface()->OnCookieChange(std::move(change)); }
...
void CookieManagerInterceptorForTesting::GetAllCookies(GetAllCookiesCallback callback) { GetForwardingInterface()->GetAllCookies(std::move(callback)); }
...
void CookieManagerInterceptorForTesting::FlushCookieStore(FlushCookieStoreCallback callback) { GetForwardingInterface()->FlushCookieStore(std::move(callback)); }
...
void CookieManagerInterceptorForTesting::SetForceKeepSessionState() { GetForwardingInterface()->SetForceKeepSessionState(); }
void CookieManagerInterceptorForTesting::BlockThirdPartyCookies(bool block) { GetForwardingInterface()->BlockThirdPartyCookies(std::move(block)); }
...
void CookieManagerInterceptorForTesting::SetStorageAccessGrantSettings(
...
void CookieManagerInterceptorForTesting::ConvertPartitionedCookiesToUnpartitioned(const ::blink::KURL& url)
{
...
{
    WTF::Vector<::net::CanonicalCookie> async_wait_result = mojo::DefaultConstructTraits::CreateInstance<WTF::Vector<::net::CanonicalCookie>>();
    GetAllCookies(&async_wait_result);
    return async_wait_result;
}

void CookieManagerAsyncWaiter::GetAllCookiesWithAccessSemantics(WTF::Vector<::net::CanonicalCookie>* out_cookies, WTF::Vector<CookieAccessSemantics>* out_access_semantics_list)
{
    base::RunLoop loop;
...
CookieAccessResultPtr CookieManagerAsyncWaiter::SetCanonicalCookie(const ::net::CanonicalCookie& cookie, const ::blink::KURL& source_url, CookieOptionsPtr cookie_options)
{
    CookieAccessResultPtr async_wait_result = mojo::DefaultConstructTraits::CreateInstance<CookieAccessResultPtr>();
...
void CookieManagerAsyncWaiter::SetStorageAccessGrantSettings(WTF::Vector<::content_settings::mojom::blink::ContentSettingPatternSourcePtr> settings)
{
    base::RunLoop loop;
    proxy_->SetStorageAccessGrantSettings(std::move(settings), base::BindOnce([](base::RunLoop* loop) { loop->Quit(); }, &loop));
    loop.Run();
}
} // namespace blink
} // namespace mojom
