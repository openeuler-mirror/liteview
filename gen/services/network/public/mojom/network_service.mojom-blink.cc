...
HttpAuthDynamicParams::HttpAuthDynamicParams(absl::optional<WTF::Vector<WTF::String>> allowed_schemes_in, WTF::Vector<WTF::String> patterns_allowed_to_use_all_schemes_in,
    const WTF::String& server_allowlist_in, const WTF::String& delegate_allowlist_in, bool delegate_by_kdc_policy_in, bool negotiate_disable_cname_lookup_in,
    bool enable_negotiate_port_in, bool ntlm_v2_enabled_in, const WTF::String& android_negotiate_account_type_in, bool allow_gssapi_library_load_in,
...
SCTAuditingConfiguration::SCTAuditingConfiguration(double sampling_rate_in, ::base::TimeDelta log_expected_ingestion_delay_in, ::base::TimeDelta log_max_ingestion_random_delay_in,
    const ::blink::KURL& report_uri_in, const ::blink::KURL& hashdance_lookup_uri_in, const ::net::MutableNetworkTrafficAnnotationTag& traffic_annotation_in,
...
void NetworkServiceProxy::StartNetLog(::base::File in_file, ::network::mojom::blink::NetLogCaptureMode in_capture_mode, ::base::Value::Dict in_constants)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    ...
    ::mojo::PendingRemote<::network::mojom::blink::NetLogProxySource> in_proxy_source, ::mojo::PendingReceiver<::network::mojom::blink::NetLogProxySink> in_proxy_sink)
{
    ...
    TRACE_EVENT1("mojom", "Send network::mojom::NetworkService::AttachNetLogProxy", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("proxy_sink"), in_proxy_sink, "<value of type ::mojo::PendingReceiver<::network::mojom::blink::NetLogProxySink>>");
    });
#endif
    const bool kExpectsResponse = false;
    const bool kIsSync = false;
    ...
    ::mojo::PendingReceiver<::network::mojom::blink::NetworkContext> in_context, ::network::mojom::blink::NetworkContextParamsPtr in_params)
{
    ...
    TRACE_EVENT1("mojom", "Send network::mojom::NetworkService::CreateNetworkContext", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("context"), in_context, "<value of type ::mojo::PendingReceiver<::network::mojom::blink::NetworkContext>>");
...
void NetworkServiceProxy::GetNetworkChangeManager(::mojo::PendingReceiver<::network::mojom::blink::NetworkChangeManager> in_network_change_manager)
{
    ...
    TRACE_EVENT1("mojom", "Send network::mojom::NetworkService::GetNetworkChangeManager", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("network_change_manager"), in_network_change_manager, "<value of type ::mojo::PendingReceiver<::network::mojom::blink::NetworkChangeManager>>");
    });
#endif
    const bool kExpectsResponse = false;
    const bool kIsSync = false;
...
void NetworkServiceProxy::SetEnvironment(WTF::Vector<EnvironmentVariablePtr> in_environment)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send network::mojom::NetworkService::SetEnvironment", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("environment"), in_environment, "<value of type WTF::Vector<EnvironmentVariablePtr>>");
    });
#endif
    const bool kExpectsResponse = false;
    const bool kIsSync = false;
...
void NetworkServiceProxy::UpdateCtLogList(WTF::Vector<::network::mojom::blink::CTLogInfoPtr> in_log_list, ::base::Time in_update_time, UpdateCtLogListCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void NetworkServiceProxy::BindTestInterface(::mojo::PendingReceiver<::network::mojom::blink::NetworkServiceTest> in_receiver)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send network::mojom::NetworkService::BindTestInterface", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("receiver"), in_receiver, "<value of type ::mojo::PendingReceiver<::network::mojom::blink::NetworkServiceTest>>");
    });
#endif
    const bool kExpectsResponse = false;
    const bool kIsSync = false;
...
private:
    ...
    void Run(const absl::optional<WTF::Vector<::net::NetworkInterface>>& in_networks);
};
...
bool NetworkService_GetNetworkList_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    bool success = true;
    absl::optional<WTF::Vector<::net::NetworkInterface>> p_networks = mojo::DefaultConstructTraits::CreateInstance<absl::optional<WTF::Vector<::net::NetworkInterface>>>();
...
void NetworkService_GetNetworkList_ProxyToResponder::Run(const absl::optional<WTF::Vector<::net::NetworkInterface>>& in_networks)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send reply network::mojom::NetworkService::GetNetworkList", "async_response_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("networks"), in_networks, "<value of type const absl::optional<WTF::Vector<::net::NetworkInterface>>&>");
    });
#endif
...
bool NetworkService_ParseHeaders_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    bool success = true;
    ::network::mojom::blink::ParsedHeadersPtr p_parsed_headers = mojo::DefaultConstructTraits::CreateInstance<::network::mojom::blink::ParsedHeadersPtr>();
...
void NetworkService_ParseHeaders_ProxyToResponder::Run(::network::mojom::blink::ParsedHeadersPtr in_parsed_headers)
{
    ...
    TRACE_EVENT1("mojom", "Send reply network::mojom::NetworkService::ParseHeaders", "async_response_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("parsed_headers"), in_parsed_headers, "<value of type ::network::mojom::blink::ParsedHeadersPtr>");
    });
#endif
...
bool NetworkServiceStubDispatch::Accept(NetworkService* impl, mojo::Message* message)
{
    ...
    case internal::kNetworkService_StartNetLog_Name: {
        ...
        ::network::mojom::blink::NetLogCaptureMode p_capture_mode = mojo::DefaultConstructTraits::CreateInstance<::network::mojom::blink::NetLogCaptureMode>();
    ...
    case internal::kNetworkService_AttachNetLogProxy_Name: {
        ...
        ::mojo::PendingRemote<::network::mojom::blink::NetLogProxySource> p_proxy_source
            = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingRemote<::network::mojom::blink::NetLogProxySource>>();
        ::mojo::PendingReceiver<::network::mojom::blink::NetLogProxySink> p_proxy_sink
            = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingReceiver<::network::mojom::blink::NetLogProxySink>>();
    ...
    case internal::kNetworkService_CreateNetworkContext_Name: {
        ...
        ::mojo::PendingReceiver<::network::mojom::blink::NetworkContext> p_context
            = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingReceiver<::network::mojom::blink::NetworkContext>>();
        ::network::mojom::blink::NetworkContextParamsPtr p_params = mojo::DefaultConstructTraits::CreateInstance<::network::mojom::blink::NetworkContextParamsPtr>();
    ...
    case internal::kNetworkService_ConfigureStubHostResolver_Name: {
        ...
        ::network::mojom::blink::DnsOverHttpsConfigPtr p_dns_over_https_config = mojo::DefaultConstructTraits::CreateInstance<::network::mojom::blink::DnsOverHttpsConfigPtr>();
    ...
    case internal::kNetworkService_GetNetworkChangeManager_Name: {
        ...
        ::mojo::PendingReceiver<::network::mojom::blink::NetworkChangeManager> p_network_change_manager
            = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingReceiver<::network::mojom::blink::NetworkChangeManager>>();
    ...
    case internal::kNetworkService_GetNetworkQualityEstimatorManager_Name: {
        ...
        ::mojo::PendingReceiver<::network::mojom::blink::NetworkQualityEstimatorManager> p_receiver
            = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingReceiver<::network::mojom::blink::NetworkQualityEstimatorManager>>();
    ...
    case internal::kNetworkService_GetDnsConfigChangeManager_Name: {
        ...
        ::mojo::PendingReceiver<::network::mojom::blink::DnsConfigChangeManager> p_receiver
            = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingReceiver<::network::mojom::blink::DnsConfigChangeManager>>();
    ...
    case internal::kNetworkService_SetEnvironment_Name: {
        ...
        bool success = true;
        WTF::Vector<EnvironmentVariablePtr> p_environment = mojo::DefaultConstructTraits::CreateInstance<WTF::Vector<EnvironmentVariablePtr>>();
    ...
    case internal::kNetworkService_UpdateKeyPinsList_Name: {
        ...
        bool success = true;
        ::network::mojom::blink::PinListPtr p_pin_list = mojo::DefaultConstructTraits::CreateInstance<::network::mojom::blink::PinListPtr>();
    ...
    case internal::kNetworkService_BindTestInterface_Name: {
        ...
        ::mojo::PendingReceiver<::network::mojom::blink::NetworkServiceTest> p_receiver
            = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingReceiver<::network::mojom::blink::NetworkServiceTest>>();
    ...
    case internal::kNetworkService_SetFirstPartySets_Name: {
        ...
        bool success = true;
        ::network::mojom::blink::GlobalFirstPartySetsPtr p_sets = mojo::DefaultConstructTraits::CreateInstance<::network::mojom::blink::GlobalFirstPartySetsPtr>();
    ...
    case internal::kNetworkService_SetExplicitlyAllowedPorts_Name: {
        ...
        bool success = true;
        WTF::Vector<uint16_t> p_ports = mojo::DefaultConstructTraits::CreateInstance<WTF::Vector<uint16_t>>();
...
bool NetworkServiceStubDispatch::AcceptWithResponder(NetworkService* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
{
    ...
    case internal::kNetworkService_SetTrustTokenKeyCommitments_Name: {
        ...
        bool success = true;
        WTF::String p_raw_commitments = mojo::DefaultConstructTraits::CreateInstance<WTF::String>();
    ...
    case internal::kNetworkService_UpdateCtLogList_Name: {
        ...
        bool success = true;
        WTF::Vector<::network::mojom::blink::CTLogInfoPtr> p_log_list = mojo::DefaultConstructTraits::CreateInstance<WTF::Vector<::network::mojom::blink::CTLogInfoPtr>>();
        ::base::Time p_update_time = mojo::DefaultConstructTraits::CreateInstance<::base::Time>();
    ...
    case internal::kNetworkService_UpdateCtKnownPopularSCTs_Name: {
        ...
        bool success = true;
        WTF::Vector<WTF::Vector<uint8_t>> p_sct_hashes = mojo::DefaultConstructTraits::CreateInstance<WTF::Vector<WTF::Vector<uint8_t>>>();
    ...
    case internal::kNetworkService_ParseHeaders_Name: {
        ...
        ::network::mojom::blink::HttpResponseHeadersPtr p_headers = mojo::DefaultConstructTraits::CreateInstance<::network::mojom::blink::HttpResponseHeadersPtr>();
...
void NetworkServiceInterceptorForTesting::StartNetLog(::base::File file, ::network::mojom::blink::NetLogCaptureMode capture_mode, ::base::Value::Dict constants)
{
...
void NetworkServiceInterceptorForTesting::AttachNetLogProxy(
    ::mojo::PendingRemote<::network::mojom::blink::NetLogProxySource> proxy_source, ::mojo::PendingReceiver<::network::mojom::blink::NetLogProxySink> proxy_sink)
{
...
void NetworkServiceInterceptorForTesting::SetEnvironment(WTF::Vector<EnvironmentVariablePtr> environment) { GetForwardingInterface()->SetEnvironment(std::move(environment)); }
...
void NetworkServiceInterceptorForTesting::UpdateCtLogList(WTF::Vector<::network::mojom::blink::CTLogInfoPtr> log_list, ::base::Time update_time, UpdateCtLogListCallback callback)
{
...
void NetworkServiceInterceptorForTesting::SetFirstPartySets(::network::mojom::blink::GlobalFirstPartySetsPtr sets) { GetForwardingInterface()->SetFirstPartySets(std::move(sets)); }
void NetworkServiceInterceptorForTesting::SetExplicitlyAllowedPorts(const WTF::Vector<uint16_t>& ports) { GetForwardingInterface()->SetExplicitlyAllowedPorts(std::move(ports)); }
...
void NetworkServiceAsyncWaiter::GetNetworkList(uint32_t policy, absl::optional<WTF::Vector<::net::NetworkInterface>>* out_networks)
{
    base::RunLoop loop;
    proxy_->GetNetworkList(std::move(policy),
        base::BindOnce(
            [](base::RunLoop* loop, absl::optional<WTF::Vector<::net::NetworkInterface>>* out_networks, const absl::optional<WTF::Vector<::net::NetworkInterface>>& networks) {
...
absl::optional<WTF::Vector<::net::NetworkInterface>> NetworkServiceAsyncWaiter::GetNetworkList(uint32_t policy)
{
    absl::optional<WTF::Vector<::net::NetworkInterface>> async_wait_result = mojo::DefaultConstructTraits::CreateInstance<absl::optional<WTF::Vector<::net::NetworkInterface>>>();
...
void NetworkServiceAsyncWaiter::UpdateCtLogList(WTF::Vector<::network::mojom::blink::CTLogInfoPtr> log_list, ::base::Time update_time)
{
    base::RunLoop loop;
...
::network::mojom::blink::ParsedHeadersPtr NetworkServiceAsyncWaiter::ParseHeaders(const ::blink::KURL& url, ::network::mojom::blink::HttpResponseHeadersPtr headers)
{
    ::network::mojom::blink::ParsedHeadersPtr async_wait_result = mojo::DefaultConstructTraits::CreateInstance<::network::mojom::blink::ParsedHeadersPtr>();
