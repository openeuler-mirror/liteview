...
class TCPBoundSocketInterceptorForTesting : public TCPBoundSocket {
    ...
    void Connect(const ::net::AddressList& remote_addr_list, TCPConnectedSocketOptionsPtr tcp_connected_socket_options, ::mojo::PendingReceiver<TCPConnectedSocket> socket,
        ::mojo::PendingRemote<SocketObserver> observer, ConnectCallback callback) override;
};
...
public:
    ...
    void Connect(const ::net::AddressList& remote_addr_list, TCPConnectedSocketOptionsPtr tcp_connected_socket_options, ::mojo::PendingReceiver<TCPConnectedSocket> socket,
        ::mojo::PendingRemote<SocketObserver> observer, int32_t* out_net_error, absl::optional<::net::IPEndPoint>* out_local_addr, absl::optional<::net::IPEndPoint>* out_peer_addr,
...
public:
    ...
    void Accept(::mojo::PendingRemote<SocketObserver> observer, int32_t* out_net_error, absl::optional<::net::IPEndPoint>* out_remote_addr,
