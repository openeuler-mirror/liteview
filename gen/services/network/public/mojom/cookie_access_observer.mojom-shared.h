...
inline bool IsKnownEnumValue(CookieAccessDetails_Type value) { return internal::CookieAccessDetails_Type_Data::IsKnownValue(static_cast<int32_t>(value)); }
...
public:
    ...
    CookieAccessDetails_Type type() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::network::mojom::CookieAccessDetails_Type>(data_->type)); }
...
template <typename MaybeConstUserType> struct Serializer<::network::mojom::CookieAccessDetailsDataView, MaybeConstUserType> {
    ...
    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::network::mojom::internal::CookieAccessDetails_Data>& fragment)
    {
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->url.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null url in CookieAccessDetails struct");
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
            fragment->site_for_cookies.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null site_for_cookies in CookieAccessDetails struct");
        ...
        mojo::internal::Serialize<mojo::ArrayDataView<::network::mojom::CookieOrLineWithAccessResultDataView>>(in_cookie_list, cookie_list_fragment, &cookie_list_validate_params);
