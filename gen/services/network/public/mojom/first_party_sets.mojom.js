...
(function() {
  ...
  FirstPartySetsContextConfig.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateMapPointer(offset + codec.kStructHeaderSize + 0, false, new codec.PointerTo(schemeful_site$.SchemefulSite), new codec.NullablePointerTo(FirstPartySetEntry), true);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  FirstPartySetsContextConfig.decode = function(decoder) {
    ...
    var version = decoder.readUint32();
    val.customizations =
        decoder.decodeMapPointer(new codec.PointerTo(schemeful_site$.SchemefulSite), new codec.NullablePointerTo(FirstPartySetEntry));
    return val;
  };
  ...
  FirstPartySetsContextConfig.encode = function(encoder, val) {
    ...
    encoder.writeUint32(0);
    encoder.encodeMapPointer(new codec.PointerTo(schemeful_site$.SchemefulSite), new codec.NullablePointerTo(FirstPartySetEntry), val.customizations);
  };
  ...
  GlobalFirstPartySets.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateMapPointer(offset + codec.kStructHeaderSize + 0, false, new codec.PointerTo(schemeful_site$.SchemefulSite), new codec.PointerTo(FirstPartySetEntry), false);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 16, FirstPartySetsContextConfig, false);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  GlobalFirstPartySets.encodedSize = codec.kStructHeaderSize + 24;
