...
CookieManagerParams::CookieManagerParams(bool block_third_party_cookies_in, std::vector<::ContentSettingPatternSource> settings_in,
...
CookieSameSiteContextMetadata::CookieSameSiteContextMetadata(::net::CookieOptions::SameSiteCookieContext::ContextMetadata::ContextDowngradeType cross_site_redirect_downgrade_in,
...
CookieSameSiteContext::CookieSameSiteContext(ContextType context_in, ContextType schemeful_context_in,
    const ::net::CookieOptions::SameSiteCookieContext::ContextMetadata& metadata_in, const ::net::CookieOptions::SameSiteCookieContext::ContextMetadata& schemeful_metadata_in)
...
CookieOptions::CookieOptions(bool exclude_httponly_in, const ::net::CookieOptions::SameSiteCookieContext& same_site_cookie_context_in, bool update_access_time_in,
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
        "<value of type const ::net::SamePartyContext&>"
#else
        "<value>"
#endif // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
CanonicalCookie::CanonicalCookie(const std::string& name_in, const std::string& value_in, const std::string& domain_in, const std::string& path_in, ::base::Time creation_in,
...
CookieAndLineWithAccessResult::CookieAndLineWithAccessResult(
    const absl::optional<::net::CanonicalCookie>& cookie_in, const std::string& cookie_string_in, ::net::CookieAccessResult access_result_in)
...
CookieDeletionFilter::CookieDeletionFilter(absl::optional<::base::Time> created_after_time_in, absl::optional<::base::Time> created_before_time_in,
    absl::optional<std::vector<std::string>> excluding_domains_in, absl::optional<std::vector<std::string>> including_domains_in, const absl::optional<std::string>& cookie_name_in,
    const absl::optional<std::string>& host_name_in, const absl::optional<::GURL>& url_in, CookieDeletionSessionControl session_control_in,
...
void CookieManagerProxy::AddCookieChangeListener(const ::GURL& in_url, const absl::optional<std::string>& in_name, ::mojo::PendingRemote<CookieChangeListener> in_listener)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send network::mojom::CookieManager::AddCookieChangeListener", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("url"), in_url, "<value of type const ::GURL&>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("name"), in_name, "<value of type const absl::optional<std::string>&>");
...
void CookieManagerProxy::SetContentSettings(const std::vector<::ContentSettingPatternSource>& in_settings)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void CookieManagerProxy::SetContentSettingsForLegacyCookieAccess(const std::vector<::ContentSettingPatternSource>& in_settings)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void CookieManagerProxy::SetStorageAccessGrantSettings(const std::vector<::ContentSettingPatternSource>& in_settings, SetStorageAccessGrantSettingsCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void CookieManagerProxy::ConvertPartitionedCookiesToUnpartitioned(const ::GURL& in_url)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
bool CookieManager_GetAllCookies_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    bool success = true;
    std::vector<::net::CanonicalCookie> p_cookies = mojo::DefaultConstructTraits::CreateInstance<std::vector<::net::CanonicalCookie>>();
...
bool CookieManager_GetAllCookiesWithAccessSemantics_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    bool success = true;
    std::vector<::net::CanonicalCookie> p_cookies = mojo::DefaultConstructTraits::CreateInstance<std::vector<::net::CanonicalCookie>>();
    std::vector<::net::CookieAccessSemantics> p_access_semantics_list = mojo::DefaultConstructTraits::CreateInstance<std::vector<::net::CookieAccessSemantics>>();
...
bool CookieManager_GetCookieList_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    std::vector<::net::CookieWithAccessResult> p_excluded_cookies = mojo::DefaultConstructTraits::CreateInstance<std::vector<::net::CookieWithAccessResult>>();
    ...
    const std::vector<::net::CookieWithAccessResult>& in_cookies, const std::vector<::net::CookieWithAccessResult>& in_excluded_cookies)
{
    ...
    TRACE_EVENT1("mojom", "Send reply network::mojom::CookieManager::GetCookieList", "async_response_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("excluded_cookies"), in_excluded_cookies, "<value of type const std::vector<::net::CookieWithAccessResult>&>");
    });
#endif
...
bool CookieManager_SetCanonicalCookie_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    bool success = true;
    ::net::CookieAccessResult p_access_result = mojo::DefaultConstructTraits::CreateInstance<::net::CookieAccessResult>();
...
bool CookieManagerStubDispatch::Accept(CookieManager* impl, mojo::Message* message)
{
    ...
    case internal::kCookieManager_SetContentSettings_Name: {
        ...
        bool success = true;
        std::vector<::ContentSettingPatternSource> p_settings = mojo::DefaultConstructTraits::CreateInstance<std::vector<::ContentSettingPatternSource>>();
...
bool CookieManagerStubDispatch::AcceptWithResponder(CookieManager* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
{
    ...
    case internal::kCookieManager_GetCookieList_Name: {
        ...
        bool success = true;
        ::GURL p_url = mojo::DefaultConstructTraits::CreateInstance<::GURL>();
        ::net::CookieOptions p_cookie_options = mojo::DefaultConstructTraits::CreateInstance<::net::CookieOptions>();
        ::net::CookiePartitionKeyCollection p_cookie_partition_key_collection = mojo::DefaultConstructTraits::CreateInstance<::net::CookiePartitionKeyCollection>();
    ...
    case internal::kCookieManager_SetCanonicalCookie_Name: {
        ...
        ::GURL p_source_url = mojo::DefaultConstructTraits::CreateInstance<::GURL>();
        ::net::CookieOptions p_cookie_options = mojo::DefaultConstructTraits::CreateInstance<::net::CookieOptions>();
...
namespace network {
namespace mojom {
void CookieChangeListenerInterceptorForTesting::OnCookieChange(const ::net::CookieChangeInfo& change) { GetForwardingInterface()->OnCookieChange(std::move(change)); }
...
void CookieManagerInterceptorForTesting::GetCookieList(
...
{
    std::vector<::net::CanonicalCookie> async_wait_result = mojo::DefaultConstructTraits::CreateInstance<std::vector<::net::CanonicalCookie>>();
...
::net::CookieAccessResult CookieManagerAsyncWaiter::SetCanonicalCookie(const ::net::CanonicalCookie& cookie, const ::GURL& source_url, const ::net::CookieOptions& cookie_options)
{
    ::net::CookieAccessResult async_wait_result = mojo::DefaultConstructTraits::CreateInstance<::net::CookieAccessResult>();
...
void CookieManagerAsyncWaiter::SetStorageAccessGrantSettings(const std::vector<::ContentSettingPatternSource>& settings)
{
    base::RunLoop loop;
