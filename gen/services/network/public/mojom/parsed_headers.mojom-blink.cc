...
ParsedHeaders::ParsedHeaders(WTF::Vector<::network::mojom::blink::ContentSecurityPolicyPtr> content_security_policy_in,
    ...
    const ::network::CrossOriginOpenerPolicy& cross_origin_opener_policy_in, OriginAgentClusterValue origin_agent_cluster_in,
    absl::optional<WTF::Vector<::network::mojom::blink::WebClientHintsType>> accept_ch_in, absl::optional<WTF::Vector<::network::mojom::blink::WebClientHintsType>> critical_ch_in,
