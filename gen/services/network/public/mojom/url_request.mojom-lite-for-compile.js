// services/network/public/mojom/url_request.mojom-lite-for-compile.js is auto generated by mojom_bindings_generator.py, do not edit
...
goog.require('network.mojom.AcceptCHFrameObserver');
goog.require('network.mojom.ChunkedDataPipeGetter');
...
goog.require('network.mojom.WebBundleHandle');
...
goog.provide('network.mojom.SourceType');
goog.provide('network.mojom.SourceTypeSpec');
/**
...
goog.provide('network.mojom.WebBundleTokenParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('network.mojom.NetLogSourceSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('network.mojom.DataElementBytesSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('network.mojom.DataElementFileSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('network.mojom.DataElementDataPipeSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('network.mojom.DataElementChunkedDataPipeSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('network.mojom.WebBundleTokenParams');
...
goog.provide('network.mojom.NetLogSource');
...
goog.provide('network.mojom.DataElementBytes');
...
goog.provide('network.mojom.DataElementFile');
...
goog.provide('network.mojom.DataElementDataPipe');
...
goog.provide('network.mojom.DataElementChunkedDataPipe');
