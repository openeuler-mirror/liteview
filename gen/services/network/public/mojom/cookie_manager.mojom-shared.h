...
inline bool IsKnownEnumValue(CookieAccessDelegateType value) { return internal::CookieAccessDelegateType_Data::IsKnownValue(static_cast<int32_t>(value)); }
...
inline bool IsKnownEnumValue(CookiePriority value) { return internal::CookiePriority_Data::IsKnownValue(static_cast<int32_t>(value)); }
...
inline bool IsKnownEnumValue(CookieSourceScheme value) { return internal::CookieSourceScheme_Data::IsKnownValue(static_cast<int32_t>(value)); }
...
inline bool IsKnownEnumValue(CookieSameSite value) { return internal::CookieSameSite_Data::IsKnownValue(static_cast<int32_t>(value)); }
...
inline bool IsKnownEnumValue(CookieEffectiveSameSite value) { return internal::CookieEffectiveSameSite_Data::IsKnownValue(static_cast<int32_t>(value)); }
...
inline bool IsKnownEnumValue(ContextRedirectTypeBug1221316 value) { return internal::ContextRedirectTypeBug1221316_Data::IsKnownValue(static_cast<int32_t>(value)); }
...
inline bool IsKnownEnumValue(CookieAccessSemantics value) { return internal::CookieAccessSemantics_Data::IsKnownValue(static_cast<int32_t>(value)); }
...
inline bool IsKnownEnumValue(CookieChangeCause value) { return internal::CookieChangeCause_Data::IsKnownValue(static_cast<int32_t>(value)); }
...
inline bool IsKnownEnumValue(CookieDeletionSessionControl value) { return internal::CookieDeletionSessionControl_Data::IsKnownValue(static_cast<int32_t>(value)); }
...
public:
    ...
    bool block_third_party_cookies() const { return data_->block_third_party_cookies; }
    ...
    bool allow_file_scheme_cookies() const { return data_->allow_file_scheme_cookies; }
    inline void GetSettingsForLegacyCookieAccessDataView(mojo::ArrayDataView<::content_settings::mojom::ContentSettingPatternSourceDataView>* output);

    template <typename UserType> [[nodiscard]] bool ReadSettingsForLegacyCookieAccess(UserType* output)
    {

        auto* pointer = data_->settings_for_legacy_cookie_access.Get();
        return mojo::internal::Deserialize<mojo::ArrayDataView<::content_settings::mojom::ContentSettingPatternSourceDataView>>(pointer, output, message_);
    }
    inline void GetSettingsForStorageAccessDataView(mojo::ArrayDataView<::content_settings::mojom::ContentSettingPatternSourceDataView>* output);

    template <typename UserType> [[nodiscard]] bool ReadSettingsForStorageAccess(UserType* output)
    {
...
public:
    ...
    {
        return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::network::mojom::CookieSameSiteContextMetadataDowngradeType>(data_->cross_site_redirect_downgrade));
    }
...
public:
    ...
    ContextType context() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::network::mojom::ContextType>(data_->context)); }
    ...
    ContextType schemeful_context() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::network::mojom::ContextType>(data_->schemeful_context)); }
...
public:
    ...
    bool is_null() const { return !data_; }
    bool exclude_httponly() const { return data_->exclude_httponly; }
    ...
    bool update_access_time() const { return data_->update_access_time; }
    bool return_excluded_cookies() const { return data_->return_excluded_cookies; }
    inline void GetSamePartyContextDataView(::network::mojom::SamePartyContextDataView* output);

    template <typename UserType> [[nodiscard]] bool ReadSamePartyContext(UserType* output)
    {

        auto* pointer = data_->same_party_context.Get();
        return mojo::internal::Deserialize<::network::mojom::SamePartyContextDataView>(pointer, output, message_);
    }
    uint32_t full_party_context_size() const { return data_->full_party_context_size; }
    bool is_in_nontrivial_first_party_set() const { return data_->is_in_nontrivial_first_party_set; }
...
public:
    ...
    bool secure() const { return data_->secure; }
    bool httponly() const { return data_->httponly; }
    ...
    CookieSameSite site_restrictions() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::network::mojom::CookieSameSite>(data_->site_restrictions)); }
    ...
    CookiePriority priority() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::network::mojom::CookiePriority>(data_->priority)); }
    ...
    CookieSourceScheme source_scheme() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::network::mojom::CookieSourceScheme>(data_->source_scheme)); }
    bool same_party() const { return data_->same_party; }
    ...
    int32_t source_port() const { return data_->source_port; }
...
public:
    ...
    bool is_null() const { return !data_; }
    uint32_t exclusion_reasons() const { return data_->exclusion_reasons; }
    uint32_t warning_reasons() const { return data_->warning_reasons; }
...
public:
    ...
    bool is_allowed_to_access_secure_cookies() const { return data_->is_allowed_to_access_secure_cookies; }
...
public:
    ...
    CookieChangeCause cause() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::network::mojom::CookieChangeCause>(data_->cause)); }
...
template <>
struct hash<::network::mojom::CookieSameSiteContextMetadataDowngradeType> : public mojo::internal::EnumHashImpl<::network::mojom::CookieSameSiteContextMetadataDowngradeType> { };

template <> struct hash<::network::mojom::ContextRedirectTypeBug1221316> : public mojo::internal::EnumHashImpl<::network::mojom::ContextRedirectTypeBug1221316> { };
...
template <> struct hash<::network::mojom::CookieDeletionSessionControl> : public mojo::internal::EnumHashImpl<::network::mojom::CookieDeletionSessionControl> { };
...
template <typename MaybeConstUserType> struct Serializer<::network::mojom::CookieSameSiteContextMetadataDowngradeType, MaybeConstUserType> {
    ...
    static bool Deserialize(int32_t input, UserType* output)
    {
        return Traits::FromMojom(::mojo::internal::ToKnownEnumValueHelper(static_cast<::network::mojom::CookieSameSiteContextMetadataDowngradeType>(input)), output);
    }
};
...
template <typename MaybeConstUserType> struct Serializer<::network::mojom::CookieManagerParamsDataView, MaybeConstUserType> {
    ...
    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::network::mojom::internal::CookieManagerParams_Data>& fragment)
    {
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
            fragment->settings.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null settings in CookieManagerParams struct");
        ...
        mojo::internal::MessageFragment<typename decltype(fragment->secure_origin_cookies_allowed_schemes)::BaseType> secure_origin_cookies_allowed_schemes_fragment(
            fragment.message());
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->secure_origin_cookies_allowed_schemes.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER,
        ...
        mojo::internal::MessageFragment<typename decltype(fragment->matching_scheme_cookies_allowed_schemes)::BaseType> matching_scheme_cookies_allowed_schemes_fragment(
            fragment.message());
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->matching_scheme_cookies_allowed_schemes.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER,
        ...
        mojo::internal::MessageFragment<typename decltype(fragment->third_party_cookies_allowed_schemes)::BaseType> third_party_cookies_allowed_schemes_fragment(
            fragment.message());
        const mojo::internal::ContainerValidateParams third_party_cookies_allowed_schemes_validate_params(0, false, new mojo::internal::ContainerValidateParams(0, false, nullptr));
        mojo::internal::Serialize<mojo::ArrayDataView<mojo::StringDataView>>(
        ...
        fragment->third_party_cookies_allowed_schemes.Set(third_party_cookies_allowed_schemes_fragment.is_null() ? nullptr : third_party_cookies_allowed_schemes_fragment.data());
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->third_party_cookies_allowed_schemes.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER,
        ...
        mojo::internal::MessageFragment<typename decltype(fragment->settings_for_legacy_cookie_access)::BaseType> settings_for_legacy_cookie_access_fragment(fragment.message());
        const mojo::internal::ContainerValidateParams settings_for_legacy_cookie_access_validate_params(0, false, nullptr);
        ...
        fragment->settings_for_legacy_cookie_access.Set(settings_for_legacy_cookie_access_fragment.is_null() ? nullptr : settings_for_legacy_cookie_access_fragment.data());
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->settings_for_legacy_cookie_access.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER,
        ...
        mojo::internal::MessageFragment<typename decltype(fragment->settings_for_storage_access)::BaseType> settings_for_storage_access_fragment(fragment.message());
        const mojo::internal::ContainerValidateParams settings_for_storage_access_validate_params(0, false, nullptr);
        mojo::internal::Serialize<mojo::ArrayDataView<::content_settings::mojom::ContentSettingPatternSourceDataView>>(
            in_settings_for_storage_access, settings_for_storage_access_fragment, &settings_for_storage_access_validate_params);
        fragment->settings_for_storage_access.Set(settings_for_storage_access_fragment.is_null() ? nullptr : settings_for_storage_access_fragment.data());
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->settings_for_storage_access.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER,
            "null settings_for_storage_access in CookieManagerParams struct");
        mojo::internal::Serialize<::network::mojom::CookieAccessDelegateType>(Traits::cookie_access_delegate_type(input), &fragment->cookie_access_delegate_type);
    }
...
template <typename MaybeConstUserType> struct Serializer<::network::mojom::CookieSameSiteContextMetadataDataView, MaybeConstUserType> {
    ...
    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::network::mojom::internal::CookieSameSiteContextMetadata_Data>& fragment)
    {
        ...
        mojo::internal::Serialize<::network::mojom::ContextRedirectTypeBug1221316>(Traits::redirect_type_bug_1221316(input), &fragment->redirect_type_bug_1221316);
    }
...
template <typename MaybeConstUserType> struct Serializer<::network::mojom::CookieSameSiteContextDataView, MaybeConstUserType> {
    ...
    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::network::mojom::internal::CookieSameSiteContext_Data>& fragment)
    {
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
            fragment->schemeful_metadata.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null schemeful_metadata in CookieSameSiteContext struct");
    }
...
template <typename MaybeConstUserType> struct Serializer<::network::mojom::CookieOptionsDataView, MaybeConstUserType> {
    ...
    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::network::mojom::internal::CookieOptions_Data>& fragment)
    {
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
            fragment->same_site_cookie_context.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null same_site_cookie_context in CookieOptions struct");
        ...
        mojo::internal::MessageFragment<typename decltype(fragment->same_party_context)::BaseType> same_party_context_fragment(fragment.message());
        mojo::internal::Serialize<::network::mojom::SamePartyContextDataView>(in_same_party_context, same_party_context_fragment);
        fragment->same_party_context.Set(same_party_context_fragment.is_null() ? nullptr : same_party_context_fragment.data());
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
            fragment->same_party_context.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null same_party_context in CookieOptions struct");
...
template <typename MaybeConstUserType> struct Serializer<::network::mojom::CanonicalCookieDataView, MaybeConstUserType> {
    ...
    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::network::mojom::internal::CanonicalCookie_Data>& fragment)
    {
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->name.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null name in CanonicalCookie struct");
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->value.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null value in CanonicalCookie struct");
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->domain.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null domain in CanonicalCookie struct");
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->path.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null path in CanonicalCookie struct");
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->creation.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null creation in CanonicalCookie struct");
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->expiry.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null expiry in CanonicalCookie struct");
...
template <typename MaybeConstUserType> struct Serializer<::network::mojom::CookieAndLineWithAccessResultDataView, MaybeConstUserType> {
    ...
    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::network::mojom::internal::CookieAndLineWithAccessResult_Data>& fragment)
    {
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
            fragment->cookie_string.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null cookie_string in CookieAndLineWithAccessResult struct");
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
            fragment->access_result.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null access_result in CookieAndLineWithAccessResult struct");
    }
...
template <typename MaybeConstUserType> struct Serializer<::network::mojom::CookieOrLineWithAccessResultDataView, MaybeConstUserType> {
    ...
    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::network::mojom::internal::CookieOrLineWithAccessResult_Data>& fragment)
    {
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
            fragment->cookie_or_line.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null cookie_or_line in CookieOrLineWithAccessResult struct");
        decltype(Traits::access_result(input)) in_access_result = Traits::access_result(input);
        mojo::internal::MessageFragment<typename decltype(fragment->access_result)::BaseType> access_result_fragment(fragment.message());
        mojo::internal::Serialize<::network::mojom::CookieAccessResultDataView>(in_access_result, access_result_fragment);
        fragment->access_result.Set(access_result_fragment.is_null() ? nullptr : access_result_fragment.data());
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
            fragment->access_result.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null access_result in CookieOrLineWithAccessResult struct");
    }
...
template <typename MaybeConstUserType> struct Serializer<::network::mojom::CookieAccessResultDataView, MaybeConstUserType> {
    ...
    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::network::mojom::internal::CookieAccessResult_Data>& fragment)
    {
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->status.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null status in CookieAccessResult struct");
...
template <typename MaybeConstUserType> struct Serializer<::network::mojom::CookieChangeInfoDataView, MaybeConstUserType> {
    ...
    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::network::mojom::internal::CookieChangeInfo_Data>& fragment)
    {
        ...
        mojo::internal::Serialize<::network::mojom::CanonicalCookieDataView>(in_cookie, cookie_fragment);
        fragment->cookie.Set(cookie_fragment.is_null() ? nullptr : cookie_fragment.data());
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->cookie.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null cookie in CookieChangeInfo struct");
        decltype(Traits::access_result(input)) in_access_result = Traits::access_result(input);
        mojo::internal::MessageFragment<typename decltype(fragment->access_result)::BaseType> access_result_fragment(fragment.message());
        mojo::internal::Serialize<::network::mojom::CookieAccessResultDataView>(in_access_result, access_result_fragment);
        fragment->access_result.Set(access_result_fragment.is_null() ? nullptr : access_result_fragment.data());
...
template <typename MaybeConstUserType> struct Serializer<::network::mojom::CookieDeletionFilterDataView, MaybeConstUserType> {
    ...
    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::network::mojom::internal::CookieDeletionFilter_Data>& fragment)
    {
        ...
        const mojo::internal::ContainerValidateParams excluding_domains_validate_params(0, false, new mojo::internal::ContainerValidateParams(0, false, nullptr));
        mojo::internal::Serialize<mojo::ArrayDataView<mojo::StringDataView>>(in_excluding_domains, excluding_domains_fragment, &excluding_domains_validate_params);
        ...
        const mojo::internal::ContainerValidateParams including_domains_validate_params(0, false, new mojo::internal::ContainerValidateParams(0, false, nullptr));
        mojo::internal::Serialize<mojo::ArrayDataView<mojo::StringDataView>>(in_including_domains, including_domains_fragment, &including_domains_validate_params);
        ...
        mojo::internal::MessageFragment<typename decltype(fragment->cookie_partition_key_collection)::BaseType> cookie_partition_key_collection_fragment(fragment.message());
        ...
        fragment->cookie_partition_key_collection.Set(cookie_partition_key_collection_fragment.is_null() ? nullptr : cookie_partition_key_collection_fragment.data());
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->cookie_partition_key_collection.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER,
...
template <typename MaybeConstUserType> struct Serializer<::network::mojom::CookieOrLineDataView, MaybeConstUserType> {
    ...
    static void Serialize(MaybeConstUserType& input, MessageFragment<::network::mojom::internal::CookieOrLine_Data>& fragment, bool inlined)
    {
        ...
        case ::network::mojom::CookieOrLineDataView::Tag::kCookie: {
            ...
            MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(value_fragment.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null cookie in CookieOrLine union");
...
inline void CookieManagerParamsDataView::GetSettingsDataView(mojo::ArrayDataView<::content_settings::mojom::ContentSettingPatternSourceDataView>* output)
{
    auto pointer = data_->settings.Get();
...
inline void CookieManagerParamsDataView::GetSettingsForLegacyCookieAccessDataView(mojo::ArrayDataView<::content_settings::mojom::ContentSettingPatternSourceDataView>* output)
{
    auto pointer = data_->settings_for_legacy_cookie_access.Get();
    *output = mojo::ArrayDataView<::content_settings::mojom::ContentSettingPatternSourceDataView>(pointer, message_);
}
inline void CookieManagerParamsDataView::GetSettingsForStorageAccessDataView(mojo::ArrayDataView<::content_settings::mojom::ContentSettingPatternSourceDataView>* output)
{
    auto pointer = data_->settings_for_storage_access.Get();
    *output = mojo::ArrayDataView<::content_settings::mojom::ContentSettingPatternSourceDataView>(pointer, message_);
}
...
inline void CookieOptionsDataView::GetSamePartyContextDataView(::network::mojom::SamePartyContextDataView* output)
{
    auto pointer = data_->same_party_context.Get();
