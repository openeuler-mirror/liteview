...
static_assert(sizeof(AcceptCHFrameObserver_OnAcceptCHFrameReceived_ResponseParams_Data) == 16, "Bad sizeof(AcceptCHFrameObserver_OnAcceptCHFrameReceived_ResponseParams_Data)");
...
public:
    ...
    AcceptCHFrameObserver_OnAcceptCHFrameReceived_ParamsDataView(internal::AcceptCHFrameObserver_OnAcceptCHFrameReceived_Params_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
...
public:
    ...
    AcceptCHFrameObserver_OnAcceptCHFrameReceived_ResponseParamsDataView(internal::AcceptCHFrameObserver_OnAcceptCHFrameReceived_ResponseParams_Data* data, mojo::Message* message)
        : data_(data)
    {
    }
...
public:
    ...
    {
        UserType result;
        bool ret = mojo::internal::Deserialize<mojo::InterfaceRequestDataView<::network::mojom::AcceptCHFrameObserverInterfaceBase>>(&data_->listener, &result, message_);
        DCHECK(ret);
        return result;
    }
...
inline void AcceptCHFrameObserver_OnAcceptCHFrameReceived_ParamsDataView::GetAcceptChFrameDataView(mojo::ArrayDataView<::network::mojom::WebClientHintsType>* output)
{
    auto pointer = data_->accept_ch_frame.Get();
