...
static_assert(sizeof(NetLogProxySink_AddEntry_Params_Data) == 56, "Bad sizeof(NetLogProxySink_AddEntry_Params_Data)");
...
public:
    ...
    NetLogCaptureMode capture_mode() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::network::mojom::NetLogCaptureMode>(data_->capture_mode)); }
    uint64_t max_file_size() const { return data_->max_file_size; }
...
public:
    ...
    bool is_null() const { return !data_; }
    uint32_t modes() const { return data_->modes; }
...
public:
    ...
    inline void GetSourceStartTimeDataView(::mojo_base::mojom::TimeTicksDataView* output);

    template <typename UserType> [[nodiscard]] bool ReadSourceStartTime(UserType* output)
    {
    ...
    NetLogEventPhase phase() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::network::mojom::NetLogEventPhase>(data_->phase)); }
    ...
    inline void GetParamsDataView(::mojo_base::mojom::ValueDataView* output);
...
inline void NetLogProxySink_AddEntry_ParamsDataView::GetSourceStartTimeDataView(::mojo_base::mojom::TimeTicksDataView* output)
{
    auto pointer = data_->source_start_time.Get();
...
inline void NetLogProxySink_AddEntry_ParamsDataView::GetParamsDataView(::mojo_base::mojom::ValueDataView* output)
{
