...
std::ostream& operator<<(std::ostream& os, PrivateNetworkRequestPolicy value) { return os << PrivateNetworkRequestPolicyToString(value); }
...
// static
void TraceFormatTraits<::network::mojom::PrivateNetworkRequestPolicy>::WriteIntoTrace(perfetto::TracedValue context, ::network::mojom::PrivateNetworkRequestPolicy value)
{
