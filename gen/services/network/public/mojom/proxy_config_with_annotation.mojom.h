...
public:
    ...
    template <typename... Args> static ProxyConfigWithAnnotationPtr New(Args&&... args) { return ProxyConfigWithAnnotationPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static ProxyConfigWithAnnotationPtr From(const U& u) { return mojo::TypeConverter<ProxyConfigWithAnnotationPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, ProxyConfigWithAnnotation>::Convert(*this); }
    ...
    ProxyConfigWithAnnotation(const ::net::ProxyConfig& value_in, const ::net::MutableNetworkTrafficAnnotationTag& traffic_annotation_in)
        : value(std::move(value_in))
        , traffic_annotation(std::move(traffic_annotation_in)) {};
    ~ProxyConfigWithAnnotation() = default;
    ...
    template <typename T, ProxyConfigWithAnnotation::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::ProxyConfigWithAnnotation_UnserializedMessageContext<UserType, ProxyConfigWithAnnotation::DataView>>(0, 0, std::move(input)),
    ...
    {
        return ProxyConfigWithAnnotation::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }

    template <typename UserType> static bool DeserializeFromMessage(mojo::Message input, UserType* output)
    {
        auto context = input.TakeUnserializedContext<internal::ProxyConfigWithAnnotation_UnserializedMessageContext<UserType, ProxyConfigWithAnnotation::DataView>>();
        if (context) {
...
template <typename T, ProxyConfigWithAnnotation::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, ProxyConfigWithAnnotation::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, ProxyConfigWithAnnotation::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }

template <typename StructPtrType> ProxyConfigWithAnnotationPtr ProxyConfigWithAnnotation::Clone() const { return New(mojo::Clone(value), mojo::Clone(traffic_annotation)); }
...
template <> struct StructTraits<::network::mojom::ProxyConfigWithAnnotation::DataView, ::network::mojom::ProxyConfigWithAnnotationPtr> {
    ...
    static decltype(::network::mojom::ProxyConfigWithAnnotation::value)& value(::network::mojom::ProxyConfigWithAnnotationPtr& input) { return input->value; }

    static const decltype(::network::mojom::ProxyConfigWithAnnotation::traffic_annotation)& traffic_annotation(const ::network::mojom::ProxyConfigWithAnnotationPtr& input)
    {
