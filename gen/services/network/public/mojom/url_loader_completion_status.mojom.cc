...
#ifndef SERVICES_NETWORK_PUBLIC_MOJOM_URL_LOADER_COMPLETION_STATUS_MOJOM_JUMBO_H_
#define SERVICES_NETWORK_PUBLIC_MOJOM_URL_LOADER_COMPLETION_STATUS_MOJOM_JUMBO_H_
#endif
...
URLLoaderCompletionStatus::URLLoaderCompletionStatus(int32_t error_code_in, int32_t extended_error_code_in, bool exists_in_cache_in, bool exists_in_memory_cache_in,
    ...
    const absl::optional<::network::CorsErrorStatus>& cors_error_status_in, ::network::mojom::TrustTokenOperationStatus trust_token_operation_status_in,
    const absl::optional<::net::SSLInfo>& ssl_info_in, BlockedByResponseReasonWrapperPtr blocked_by_response_reason_in, bool should_report_corb_blocking_in,
    const ::net::ProxyServer& proxy_server_in, const ::net::ResolveErrorInfo& resolve_error_info_in, bool should_collapse_initiator_in, bool pervasive_payload_requested_in)
