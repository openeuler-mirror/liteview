...
static_assert(sizeof(ProxyResolvingSocketFactory_CreateProxyResolvingSocket_Params_Data) == 56, "Bad sizeof(ProxyResolvingSocketFactory_CreateProxyResolvingSocket_Params_Data)");
...
public:
    ...
    {
        UserType result;
        bool ret = mojo::internal::Deserialize<mojo::InterfaceRequestDataView<::network::mojom::ProxyResolvingSocketInterfaceBase>>(&data_->socket, &result, message_);
        DCHECK(ret);
        return result;
    }
    template <typename UserType> UserType TakeObserver()
...
inline void ProxyResolvingSocketFactory_CreateProxyResolvingSocket_ParamsDataView::GetNetworkAnonymizationKeyDataView(::network::mojom::NetworkAnonymizationKeyDataView* output)
{
    auto pointer = data_->network_anonymization_key.Get();
