...
static NOINLINE const char* RequestPriorityToStringHelper(RequestPriority value)
{
...
std::ostream& operator<<(std::ostream& os, RequestPriority value) { return os << RequestPriorityToString(value); }
