...
public:
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input) { return mojo::internal::SerializeImpl<SiteIndex::DataView, std::vector<uint8_t>>(input); }
...
public:
    ...
    SamePartyContext()
        : context_type(mojo::internal::ConvertEnumValue<SamePartyCookieContextType, ::net::SamePartyContext::Type>(SamePartyCookieContextType::kCrossParty))
    {
    }

    explicit SamePartyContext(::net::SamePartyContext::Type context_type_in)
    ...
    {
        return mojo::internal::SerializeImpl<SamePartyContext::DataView, std::vector<uint8_t>>(input);
    }
...
public:
    ...
    FirstPartySetEntry(const ::net::SchemefulSite& primary_in, ::net::SiteType site_type_in, const absl::optional<::net::FirstPartySetEntry::SiteIndex>& site_index_in)
...
public:
    ...
    FirstPartySetMetadata(const ::net::SamePartyContext& context_in, const absl::optional<::net::FirstPartySetEntry>& frame_entry_in,
...
public:
    ...
    explicit FirstPartySetsContextConfig(const base::flat_map<::net::SchemefulSite, absl::optional<::net::FirstPartySetEntry>>& customizations_in)
...
public:
    ...
    GlobalFirstPartySets(const base::flat_map<::net::SchemefulSite, ::net::FirstPartySetEntry>& sets_in,
...
template <> struct StructTraits<::network::mojom::SiteIndex::DataView, ::network::mojom::SiteIndexPtr> {
    ...
    static decltype(::network::mojom::SiteIndex::value) value(const ::network::mojom::SiteIndexPtr& input) { return input->value; }
...
template <> struct StructTraits<::network::mojom::FirstPartySetEntry::DataView, ::network::mojom::FirstPartySetEntryPtr> {
    ...
    static const decltype(::network::mojom::FirstPartySetEntry::primary)& primary(const ::network::mojom::FirstPartySetEntryPtr& input) { return input->primary; }

    static decltype(::network::mojom::FirstPartySetEntry::site_type) site_type(const ::network::mojom::FirstPartySetEntryPtr& input) { return input->site_type; }

    static const decltype(::network::mojom::FirstPartySetEntry::site_index)& site_index(const ::network::mojom::FirstPartySetEntryPtr& input) { return input->site_index; }

    static bool Read(::network::mojom::FirstPartySetEntry::DataView input, ::network::mojom::FirstPartySetEntryPtr* output);
};
template <> struct StructTraits<::network::mojom::SamePartyContext::DataView, ::network::mojom::SamePartyContextPtr> {
    ...
    static decltype(::network::mojom::SamePartyContext::context_type) context_type(const ::network::mojom::SamePartyContextPtr& input) { return input->context_type; }
...
template <> struct StructTraits<::network::mojom::FirstPartySetMetadata::DataView, ::network::mojom::FirstPartySetMetadataPtr> {
    ...
    static const decltype(::network::mojom::FirstPartySetMetadata::context)& context(const ::network::mojom::FirstPartySetMetadataPtr& input) { return input->context; }

    static const decltype(::network::mojom::FirstPartySetMetadata::frame_entry)& frame_entry(const ::network::mojom::FirstPartySetMetadataPtr& input) { return input->frame_entry; }
...
template <> struct StructTraits<::network::mojom::FirstPartySetsContextConfig::DataView, ::network::mojom::FirstPartySetsContextConfigPtr> {
    ...
    static const decltype(::network::mojom::FirstPartySetsContextConfig::customizations)& customizations(const ::network::mojom::FirstPartySetsContextConfigPtr& input)
    {
...
template <> struct StructTraits<::network::mojom::FirstPartySetsCacheFilter::DataView, ::network::mojom::FirstPartySetsCacheFilterPtr> {
    ...
    static const decltype(::network::mojom::FirstPartySetsCacheFilter::filter)& filter(const ::network::mojom::FirstPartySetsCacheFilterPtr& input) { return input->filter; }
...
template <> struct StructTraits<::network::mojom::GlobalFirstPartySets::DataView, ::network::mojom::GlobalFirstPartySetsPtr> {
    ...
    static const decltype(::network::mojom::GlobalFirstPartySets::sets)& sets(const ::network::mojom::GlobalFirstPartySetsPtr& input) { return input->sets; }

    static const decltype(::network::mojom::GlobalFirstPartySets::aliases)& aliases(const ::network::mojom::GlobalFirstPartySetsPtr& input) { return input->aliases; }
