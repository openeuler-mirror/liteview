...
// with not having this data in traces there.
    ...
    virtual void EnableNetworkAccess(::mojo::PendingRemote<::network::mojom::URLLoaderFactory> url_loader_factory, ::mojo::PendingRemote<URLLoaderFactoryConnector> reconnector)
        = 0;

    virtual void Verify(const ::net::CertVerifier::RequestParams& params, uint32_t netlog_source_type, uint32_t netlog_source_id, ::base::TimeTicks netlog_source_start_time,
...
public:
    ...
    RequestParams(const ::scoped_refptr<::net::X509Certificate>& certificate_in, const std::string& hostname_in, int32_t flags_in, const std::string& ocsp_response_in,
...
public:
    ...
    CertVerifierConfig(bool enable_rev_checking_in, bool require_rev_checking_local_anchors_in, bool enable_sha1_local_anchors_in, bool disable_symantec_enforcement_in,
        ::mojo_base::BigBuffer crl_set_in, std::vector<::scoped_refptr<::net::X509Certificate>> additional_trust_anchors_in,
...
template <> struct StructTraits<::cert_verifier::mojom::RequestParams::DataView, ::cert_verifier::mojom::RequestParamsPtr> {
    ...
    static const decltype(::cert_verifier::mojom::RequestParams::certificate)& certificate(const ::cert_verifier::mojom::RequestParamsPtr& input) { return input->certificate; }

    static const decltype(::cert_verifier::mojom::RequestParams::hostname)& hostname(const ::cert_verifier::mojom::RequestParamsPtr& input) { return input->hostname; }

    static decltype(::cert_verifier::mojom::RequestParams::flags) flags(const ::cert_verifier::mojom::RequestParamsPtr& input) { return input->flags; }
    ...
    static const decltype(::cert_verifier::mojom::RequestParams::sct_list)& sct_list(const ::cert_verifier::mojom::RequestParamsPtr& input) { return input->sct_list; }
...
template <> struct StructTraits<::cert_verifier::mojom::CertVerifierConfig::DataView, ::cert_verifier::mojom::CertVerifierConfigPtr> {
    ...
    static decltype(::cert_verifier::mojom::CertVerifierConfig::enable_rev_checking) enable_rev_checking(const ::cert_verifier::mojom::CertVerifierConfigPtr& input)
    {
    ...
    static decltype(::cert_verifier::mojom::CertVerifierConfig::enable_sha1_local_anchors) enable_sha1_local_anchors(const ::cert_verifier::mojom::CertVerifierConfigPtr& input)
    {
    ...
    static decltype(::cert_verifier::mojom::CertVerifierConfig::crl_set)& crl_set(::cert_verifier::mojom::CertVerifierConfigPtr& input) { return input->crl_set; }
