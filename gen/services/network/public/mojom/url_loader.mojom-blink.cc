...
void URLLoaderProxy::FollowRedirect(const WTF::Vector<WTF::String>& in_removed_headers, const ::net::HttpRequestHeaders& in_modified_headers,
    const ::net::HttpRequestHeaders& in_modified_cors_exempt_headers, const absl::optional<::blink::KURL>& in_new_url)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send network::mojom::URLLoader::FollowRedirect", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("new_url"), in_new_url, "<value of type const absl::optional<::blink::KURL>&>");
    });
#endif
...
bool URLLoaderStubDispatch::Accept(URLLoader* impl, mojo::Message* message)
{
    ...
    case internal::kURLLoader_FollowRedirect_Name: {
        ...
        bool success = true;
        WTF::Vector<WTF::String> p_removed_headers = mojo::DefaultConstructTraits::CreateInstance<WTF::Vector<WTF::String>>();
        ...
        absl::optional<::blink::KURL> p_new_url = mojo::DefaultConstructTraits::CreateInstance<absl::optional<::blink::KURL>>();
...
bool URLLoaderClientStubDispatch::Accept(URLLoaderClient* impl, mojo::Message* message)
{
    ...
    case internal::kURLLoaderClient_OnReceiveEarlyHints_Name: {
        ...
        bool success = true;
        ::network::mojom::blink::EarlyHintsPtr p_early_hints = mojo::DefaultConstructTraits::CreateInstance<::network::mojom::blink::EarlyHintsPtr>();
    ...
    case internal::kURLLoaderClient_OnReceiveRedirect_Name: {
        ...
        bool success = true;
        URLRequestRedirectInfoPtr p_redirect_info = mojo::DefaultConstructTraits::CreateInstance<URLRequestRedirectInfoPtr>();
        ::network::mojom::blink::URLResponseHeadPtr p_head = mojo::DefaultConstructTraits::CreateInstance<::network::mojom::blink::URLResponseHeadPtr>();
...
void URLLoaderInterceptorForTesting::FollowRedirect(const WTF::Vector<WTF::String>& removed_headers, const ::net::HttpRequestHeaders& modified_headers,
    const ::net::HttpRequestHeaders& modified_cors_exempt_headers, const absl::optional<::blink::KURL>& new_url)
{
...
void URLLoaderClientInterceptorForTesting::OnReceiveResponse(
    ::network::mojom::blink::URLResponseHeadPtr head, ::mojo::ScopedDataPipeConsumerHandle body, absl::optional<::mojo_base::BigBuffer> cached_metadata)
{
