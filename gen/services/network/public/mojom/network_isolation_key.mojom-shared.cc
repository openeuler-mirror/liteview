...
namespace internal {
// static
bool NetworkIsolationKey_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    if (!data)
        return true;
    ...
    [[maybe_unused]] const NetworkIsolationKey_Data* object = static_cast<const NetworkIsolationKey_Data*>(data);
...
NetworkIsolationKey_Data::NetworkIsolationKey_Data()
