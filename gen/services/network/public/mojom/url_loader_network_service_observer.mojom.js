...
(function() {
  ...
  var kClientCertificateResponder_ContinueWithCertificate_Name = 974743614;
  var kClientCertificateResponder_ContinueWithoutCertificate_Name = 1651598197;
  var kClientCertificateResponder_CancelRequest_Name = 761594960;
  ...
  var kSSLPrivateKey_Sign_Name = 956192914;
  ...
  var kAuthChallengeResponder_OnAuthCredentials_Name = 1965152207;
  ...
  var kURLLoaderNetworkServiceObserver_OnSSLCertificateError_Name = 1662253558;
  var kURLLoaderNetworkServiceObserver_OnCertificateRequested_Name = 1784456109;
  var kURLLoaderNetworkServiceObserver_OnAuthRequired_Name = 1206966650;
  var kURLLoaderNetworkServiceObserver_OnClearSiteData_Name = 1113398165;
  var kURLLoaderNetworkServiceObserver_OnLoadingStateUpdate_Name = 1254267753;
  var kURLLoaderNetworkServiceObserver_OnDataUseUpdate_Name = 165488253;
  var kURLLoaderNetworkServiceObserver_Clone_Name = 2091416624;
  ...
  URLLoaderNetworkServiceObserverProxy.prototype.onClearSiteData = function(url, headerValue, loadFlags, cookiePartitionKey) {
  ...
  URLLoaderNetworkServiceObserverStub.prototype.onClearSiteData = function(url, headerValue, loadFlags, cookiePartitionKey) {
    return this.delegate_ && this.delegate_.onClearSiteData && this.delegate_.onClearSiteData(url, headerValue, loadFlags, cookiePartitionKey);
  }
  ...
  URLLoaderNetworkServiceObserverStub.prototype.acceptWithResponder =
    ...
    case kURLLoaderNetworkServiceObserver_OnClearSiteData_Name:
      ...
      this.onClearSiteData(params.url, params.headerValue, params.loadFlags, params.cookiePartitionKey).then(function(response) {
        var responseParams =
