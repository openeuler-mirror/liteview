...
template <> struct StructTraits<::network::mojom::FileEnumerationEntry::DataView, ::network::mojom::FileEnumerationEntryPtr> {
    ...
    static const decltype(::network::mojom::FileEnumerationEntry::path)& path(const ::network::mojom::FileEnumerationEntryPtr& input) { return input->path; }

    static decltype(::network::mojom::FileEnumerationEntry::size) size(const ::network::mojom::FileEnumerationEntryPtr& input) { return input->size; }
