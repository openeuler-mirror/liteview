...
static_assert(sizeof(WebTransport_AcceptBidirectionalStream_ResponseParams_Data) == 24, "Bad sizeof(WebTransport_AcceptBidirectionalStream_ResponseParams_Data)");
...
static_assert(sizeof(WebTransport_AcceptUnidirectionalStream_ResponseParams_Data) == 16, "Bad sizeof(WebTransport_AcceptUnidirectionalStream_ResponseParams_Data)");
...
static_assert(sizeof(WebTransport_SetOutgoingDatagramExpirationDuration_Params_Data) == 16, "Bad sizeof(WebTransport_SetOutgoingDatagramExpirationDuration_Params_Data)");
...
static_assert(sizeof(WebTransportClient_OnClosed_Params_Data) == 16, "Bad sizeof(WebTransportClient_OnClosed_Params_Data)");
...
static_assert(sizeof(WebTransportHandshakeClient_OnConnectionEstablished_Params_Data) == 32, "Bad sizeof(WebTransportHandshakeClient_OnConnectionEstablished_Params_Data)");
...
public:
    ...
    bool is_null() const { return !data_; }
    bool succeeded() const { return data_->succeeded; }
    uint32_t stream_id() const { return data_->stream_id; }
...
public:
    ...
    WebTransport_AcceptBidirectionalStream_ResponseParamsDataView(internal::WebTransport_AcceptBidirectionalStream_ResponseParams_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
...
public:
    ...
    WebTransport_AcceptUnidirectionalStream_ResponseParamsDataView(internal::WebTransport_AcceptUnidirectionalStream_ResponseParams_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
...
public:
    ...
    bool is_null() const { return !data_; }
    uint32_t stream_id() const { return data_->stream_id; }
    uint8_t code() const { return data_->code; }
...
public:
    ...
    WebTransport_SetOutgoingDatagramExpirationDuration_ParamsDataView(internal::WebTransport_SetOutgoingDatagramExpirationDuration_Params_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
...
public:
    ...
    bool is_null() const { return !data_; }
    uint32_t stream_id() const { return data_->stream_id; }
    bool fin_received() const { return data_->fin_received; }
...
public:
    ...
    WebTransportHandshakeClient_OnConnectionEstablished_ParamsDataView(internal::WebTransportHandshakeClient_OnConnectionEstablished_Params_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
    ...
    {
        UserType result;
        bool ret = mojo::internal::Deserialize<mojo::InterfaceRequestDataView<::network::mojom::WebTransportClientInterfaceBase>>(&data_->client, &result, message_);
        DCHECK(ret);
        return result;
    }
...
public:
    ...
    WebTransportHandshakeClient_OnHandshakeFailed_ParamsDataView(internal::WebTransportHandshakeClient_OnHandshakeFailed_Params_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
...
inline void WebTransportHandshakeClient_OnConnectionEstablished_ParamsDataView::GetResponseHeadersDataView(::network::mojom::HttpResponseHeadersDataView* output)
{
    auto pointer = data_->response_headers.Get();
