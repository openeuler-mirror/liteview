...
template <> struct MojomTypeTraits<::network::mojom::SamePartyContextDataView> {
...
inline bool IsKnownEnumValue(SiteType value) { return internal::SiteType_Data::IsKnownValue(static_cast<int32_t>(value)); }
...
inline bool IsKnownEnumValue(SamePartyCookieContextType value) { return internal::SamePartyCookieContextType_Data::IsKnownValue(static_cast<int32_t>(value)); }
class SiteIndexDataView {
public:
...
public:
    ...
    SiteType site_type() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::network::mojom::SiteType>(data_->site_type)); }
...
public:
    ...
    SamePartyContextDataView(internal::SamePartyContext_Data* data, mojo::Message* message)
        : data_(data)
    {
    }
    ...
    template <typename UserType> [[nodiscard]] bool ReadContextType(UserType* output) const
    {
        ...
        return mojo::internal::Deserialize<::network::mojom::SamePartyCookieContextType>(data_value, output);
    }
    SamePartyCookieContextType context_type() const
    {
        return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::network::mojom::SamePartyCookieContextType>(data_->context_type));
    }
...
public:
    ...
    bool is_null() const { return !data_; }
    inline void GetContextDataView(SamePartyContextDataView* output);
...
public:
    ...
    bool is_null() const { return !data_; }
    inline void GetCustomizationsDataView(mojo::MapDataView<::network::mojom::SchemefulSiteDataView, FirstPartySetEntryDataView>* output);

    template <typename UserType> [[nodiscard]] bool ReadCustomizations(UserType* output)
    {

        auto* pointer = data_->customizations.Get();
        return mojo::internal::Deserialize<mojo::MapDataView<::network::mojom::SchemefulSiteDataView, ::network::mojom::FirstPartySetEntryDataView>>(pointer, output, message_);
    }
...
public:
    ...
    int64_t browser_run_id() const { return data_->browser_run_id; }
...
public:
    ...
    template <typename UserType> [[nodiscard]] bool ReadAliases(UserType* output)
    {
        ...
        return mojo::internal::Deserialize<mojo::MapDataView<::network::mojom::SchemefulSiteDataView, ::network::mojom::SchemefulSiteDataView>>(pointer, output, message_);
    }
...
template <> struct hash<::network::mojom::SamePartyCookieContextType> : public mojo::internal::EnumHashImpl<::network::mojom::SamePartyCookieContextType> { };
...
template <typename MaybeConstUserType> struct Serializer<::network::mojom::SamePartyCookieContextType, MaybeConstUserType> {
    using UserType = typename std::remove_const<MaybeConstUserType>::type;
    ...
    static bool Deserialize(int32_t input, UserType* output)
    {
        return Traits::FromMojom(::mojo::internal::ToKnownEnumValueHelper(static_cast<::network::mojom::SamePartyCookieContextType>(input)), output);
    }
};
...
template <typename MaybeConstUserType> struct Serializer<::network::mojom::SamePartyContextDataView, MaybeConstUserType> {
    using UserType = typename std::remove_const<MaybeConstUserType>::type;
    using Traits = StructTraits<::network::mojom::SamePartyContextDataView, UserType>;

    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::network::mojom::internal::SamePartyContext_Data>& fragment)
    {
        if (CallIsNullIfExists<Traits>(input))
            return;
        fragment.Allocate();
        mojo::internal::Serialize<::network::mojom::SamePartyCookieContextType>(Traits::context_type(input), &fragment->context_type);
    }

    static bool Deserialize(::network::mojom::internal::SamePartyContext_Data* input, UserType* output, Message* message)
    {
        if (!input)
            return CallSetToNullIfExists<Traits>(output);
...
template <typename MaybeConstUserType> struct Serializer<::network::mojom::FirstPartySetMetadataDataView, MaybeConstUserType> {
    ...
    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::network::mojom::internal::FirstPartySetMetadata_Data>& fragment)
    {
        ...
        mojo::internal::MessageFragment<typename decltype(fragment->context)::BaseType> context_fragment(fragment.message());
        mojo::internal::Serialize<::network::mojom::SamePartyContextDataView>(in_context, context_fragment);
        fragment->context.Set(context_fragment.is_null() ? nullptr : context_fragment.data());
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
            fragment->context.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null context in FirstPartySetMetadata struct");
...
template <typename MaybeConstUserType> struct Serializer<::network::mojom::FirstPartySetsContextConfigDataView, MaybeConstUserType> {
    ...
    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::network::mojom::internal::FirstPartySetsContextConfig_Data>& fragment)
    {
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
            fragment->customizations.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null customizations in FirstPartySetsContextConfig struct");
    }
...
template <typename MaybeConstUserType> struct Serializer<::network::mojom::GlobalFirstPartySetsDataView, MaybeConstUserType> {
    ...
    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::network::mojom::internal::GlobalFirstPartySets_Data>& fragment)
    {
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->sets.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null sets in GlobalFirstPartySets struct");
...
inline void FirstPartySetMetadataDataView::GetContextDataView(SamePartyContextDataView* output)
{
    auto pointer = data_->context.Get();
...
inline void FirstPartySetsContextConfigDataView::GetCustomizationsDataView(mojo::MapDataView<::network::mojom::SchemefulSiteDataView, FirstPartySetEntryDataView>* output)
{
    auto pointer = data_->customizations.Get();
...
inline void GlobalFirstPartySetsDataView::GetAliasesDataView(mojo::MapDataView<::network::mojom::SchemefulSiteDataView, ::network::mojom::SchemefulSiteDataView>* output)
{
    auto pointer = data_->aliases.Get();
...
template <> struct TraceFormatTraits<::network::mojom::SamePartyCookieContextType> {
