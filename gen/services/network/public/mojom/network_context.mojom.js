...
(function() {
  ...
  var proxy_resolver_win$ =
      mojo.internal.exposeNamespace('proxyResolverWin.mojom');
  if (mojo.config.autoLoadMojomDeps) {
    mojo.internal.loadMojomIfNecessary(
        'services/proxy_resolver_win/public/mojom/proxy_resolver_win.mojom', '../../../proxy_resolver_win/public/mojom/proxy_resolver_win.mojom.js');
  }
  ...
  NetworkContextFilePaths.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateUnion(offset + codec.kStructHeaderSize + 0, transferable_directory$.TransferableDirectory, false);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  NetworkContextFilePaths.encodedSize = codec.kStructHeaderSize + 80;
  ...
  NetworkContextParams.prototype.initDefaults_ = function() {
    ...
    this.windowsSystemProxyResolver = new proxy_resolver_win$.WindowsSystemProxyResolverPtr();
    ...
    this.socketBroker = new socket_broker$.SocketBrokerPtr();
  ...
  NetworkContextParams.validate = function(messageValidator, offset) {
    ...
    if (err !== validator.validationError.NONE)
        return err;
    // validate NetworkContextParams.windowsSystemProxyResolver
    err = messageValidator.validateInterface(offset + codec.kStructHeaderSize + 40, true);
    if (err !== validator.validationError.NONE)
        return err;

    // validate NetworkContextParams.httpCacheDirectory
    err = messageValidator.validateUnion(offset + codec.kStructHeaderSize + 48, transferable_directory$.TransferableDirectory, true);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 72, ssl_config$.SSLConfig, true);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 88, proxy_config_with_annotation$.ProxyConfigWithAnnotation, true);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 96, CustomProxyConfig, true);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    err = messageValidator.validateInterface(offset + codec.kStructHeaderSize + 108, true);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    if (err !== validator.validationError.NONE)
        return err;
    // validate NetworkContextParams.socketBroker
    ...
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 140, SCTAuditingMode);
    if (err !== validator.validationError.NONE)
        return err;
    // validate NetworkContextParams.ctPolicy
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 144, CTPolicy, true);
    if (err !== validator.validationError.NONE)
        return err;
    // validate NetworkContextParams.certVerifierParams
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 152, CertVerifierServiceRemoteParams, false);
    if (err !== validator.validationError.NONE)
        return err;
    // validate NetworkContextParams.cookieManagerParams
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 160, cookie_manager$.CookieManagerParams, true);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    err = messageValidator.validateArrayPointer(offset + codec.kStructHeaderSize + 184, 8, new codec.PointerTo(cors_origin_pattern$.CorsOriginAccessPatterns), false, [0], 0);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 208, HttpAuthStaticNetworkContextParams, true);
    if (err !== validator.validationError.NONE)
        return err;

    // validate NetworkContextParams.filePaths
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 216, NetworkContextFilePaths, true);
    if (err !== validator.validationError.NONE)
        return err;

    // validate NetworkContextParams.firstPartySetsAccessDelegateParams
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 224, first_party_sets_access_delegate$.FirstPartySetsAccessDelegateParams, true);
    if (err !== validator.validationError.NONE)
        return err;
    // validate NetworkContextParams.firstPartySetsAccessDelegateReceiver
    err = messageValidator.validateInterfaceRequest(offset + codec.kStructHeaderSize + 232, true)
    if (err !== validator.validationError.NONE)
        return err;
  ...
  NetworkContextParams.decode = function(decoder) {
    ...
    val.enablePreconnect = (packed >> 2) & 1 ? true : false;
    ...
    val.windowsSystemProxyResolver =
        decoder.decodeStruct(new codec.NullableInterface(proxy_resolver_win$.WindowsSystemProxyResolverPtr));
    ...
    val.socketBroker =
        decoder.decodeStruct(new codec.NullableInterface(socket_broker$.SocketBrokerPtr));
    val.sctAuditingMode =
  ...
  NetworkContextParams.encode = function(encoder, val) {
    ...
    packed |= (val.enablePreconnect & 1) << 2
    ...
    encoder.encodeStruct(new codec.NullableInterface(proxy_resolver_win$.WindowsSystemProxyResolverPtr), val.windowsSystemProxyResolver);
    ...
    encoder.encodeStruct(new codec.NullableInterface(socket_broker$.SocketBrokerPtr), val.socketBroker);
  ...
  NetworkContext_QueueReport_Params.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 32, network_anonymization_key$.NetworkAnonymizationKey, false);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  NetworkContext_QueueReport_Params.decode = function(decoder) {
    ...
    val.networkAnonymizationKey =
        decoder.decodeStructPointer(network_anonymization_key$.NetworkAnonymizationKey);
    val.userAgent =
        decoder.decodeStruct(codec.NullableString);
    val.body =
  ...
  NetworkContext_QueueReport_Params.encode = function(encoder, val) {
    ...
    encoder.encodeStructPointer(url$.Url, val.url);
    encoder.encodeStructPointer(unguessable_token$.UnguessableToken, val.reportingSource);
    encoder.encodeStructPointer(network_anonymization_key$.NetworkAnonymizationKey, val.networkAnonymizationKey);
  ...
  NetworkContext_QueueSignedExchangeReport_Params.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 8, network_anonymization_key$.NetworkAnonymizationKey, false);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  function NetworkContext_SetEnablePreconnect_Params(values) {
    this.initDefaults_();
    this.initFields_(values);
  }
  NetworkContext_SetEnablePreconnect_Params.prototype.initDefaults_ = function() {
    this.enablePreconnect = false;
  };
  NetworkContext_SetEnablePreconnect_Params.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  NetworkContext_SetEnablePreconnect_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  NetworkContext_SetEnablePreconnect_Params.encodedSize = codec.kStructHeaderSize + 8;

  NetworkContext_SetEnablePreconnect_Params.decode = function(decoder) {
    var packed;
    var val = new NetworkContext_SetEnablePreconnect_Params();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    packed = decoder.readUint8();
    val.enablePreconnect = (packed >> 0) & 1 ? true : false;
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  NetworkContext_SetEnablePreconnect_Params.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(NetworkContext_SetEnablePreconnect_Params.encodedSize);
    encoder.writeUint32(0);
    packed = 0;
    packed |= (val.enablePreconnect & 1) << 0
    encoder.writeUint8(packed);
    encoder.skip(1);
    encoder.skip(1);
    encoder.skip(1);
  ...
  NetworkContext_AddExpectCT_Params.validate = function(messageValidator, offset) {
    ...
    if (err !== validator.validationError.NONE)
        return err;
    // validate NetworkContext_AddExpectCT_Params.networkAnonymizationKey
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 32, network_anonymization_key$.NetworkAnonymizationKey, false);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  NetworkContext_GetExpectCTState_Params.validate = function(messageValidator, offset) {
    ...
    if (err !== validator.validationError.NONE)
        return err;
    // validate NetworkContext_GetExpectCTState_Params.networkAnonymizationKey
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 8, network_anonymization_key$.NetworkAnonymizationKey, false);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  NetworkContext_CreateWebTransport_Params.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 16, network_anonymization_key$.NetworkAnonymizationKey, false);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  NetworkContext_CreateP2PSocketManager_Params.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 0, network_anonymization_key$.NetworkAnonymizationKey, false);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  NetworkContext_ResolveHost_Params.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 24, host_resolver$.ResolveHostParameters, true);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  NetworkContext_ResolveHost_Params.encodedSize = codec.kStructHeaderSize + 40;
  ...
  function NetworkContext_ComputeFirstPartySetMetadata_Params(values) {
    this.initDefaults_();
    this.initFields_(values);
  }
  NetworkContext_ComputeFirstPartySetMetadata_Params.prototype.initDefaults_ = function() {
    this.site = null;
    this.topFrameSite = null;
    this.partyContext = null;
  };
  NetworkContext_ComputeFirstPartySetMetadata_Params.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  NetworkContext_ComputeFirstPartySetMetadata_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  NetworkContext_ComputeFirstPartySetMetadata_Params.encodedSize = codec.kStructHeaderSize + 24;

  NetworkContext_ComputeFirstPartySetMetadata_Params.decode = function(decoder) {
    var packed;
    var val = new NetworkContext_ComputeFirstPartySetMetadata_Params();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.site =
  ...
  NetworkContext_ComputeFirstPartySetMetadata_Params.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(NetworkContext_ComputeFirstPartySetMetadata_Params.encodedSize);
    encoder.writeUint32(0);
  ...
  function NetworkContext_ComputeFirstPartySetMetadata_ResponseParams(values) {
    this.initDefaults_();
    this.initFields_(values);
  }
  NetworkContext_ComputeFirstPartySetMetadata_ResponseParams.prototype.initDefaults_ = function() {
    this.metadata = null;
  };
  NetworkContext_ComputeFirstPartySetMetadata_ResponseParams.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  NetworkContext_ComputeFirstPartySetMetadata_ResponseParams.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    if (err !== validator.validationError.NONE)
        return err;
    // validate NetworkContext_ComputeFirstPartySetMetadata_ResponseParams.metadata
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 0, first_party_sets$.FirstPartySetMetadata, false);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  NetworkContext_ComputeFirstPartySetMetadata_ResponseParams.encodedSize = codec.kStructHeaderSize + 8;

  NetworkContext_ComputeFirstPartySetMetadata_ResponseParams.decode = function(decoder) {
    var packed;
    var val = new NetworkContext_ComputeFirstPartySetMetadata_ResponseParams();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.metadata =
        decoder.decodeStructPointer(first_party_sets$.FirstPartySetMetadata);
    return val;
  };

  NetworkContext_ComputeFirstPartySetMetadata_ResponseParams.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(NetworkContext_ComputeFirstPartySetMetadata_ResponseParams.encodedSize);
    encoder.writeUint32(0);
    encoder.encodeStructPointer(first_party_sets$.FirstPartySetMetadata, val.metadata);
  };
  var kCustomProxyConnectionObserver_OnFallback_Name = 61943589;
  var kCustomProxyConnectionObserver_OnTunnelHeadersReceived_Name = 1418673979;
  ...
  var kCustomProxyConfigClient_OnCustomProxyConfigUpdated_Name = 1082279277;
  var kCustomProxyConfigClient_MarkProxiesAsBad_Name = 443165509;
  var kCustomProxyConfigClient_ClearBadProxiesCache_Name = 1252899403;
  ...
  var kTrustedHeaderClient_OnBeforeSendHeaders_Name = 598509411;
  var kTrustedHeaderClient_OnHeadersReceived_Name = 1941758398;
  ...
  var kTrustedURLLoaderHeaderClient_OnLoaderCreated_Name = 1550345182;
  var kTrustedURLLoaderHeaderClient_OnLoaderForCorsPreflightCreated_Name = 1158417729;
  ...
  var kNetworkContextClient_OnFileUploadRequested_Name = 1605112577;
  var kNetworkContextClient_OnCanSendReportingReports_Name = 1594296518;
  var kNetworkContextClient_OnCanSendDomainReliabilityUpload_Name = 133860328;
  var kNetworkContextClient_OnTrustTokenIssuanceDivertedToSystem_Name = 542465900;
  var kNetworkContextClient_OnCanSendSCTAuditingReport_Name = 1575774125;
  var kNetworkContextClient_OnNewSCTAuditingReportSent_Name = 1560258266;
  ...
  var kNetworkContext_SetClient_Name = 485520508;
  var kNetworkContext_CreateURLLoaderFactory_Name = 1925306867;
  var kNetworkContext_ResetURLLoaderFactories_Name = 1370220374;
  var kNetworkContext_GetCookieManager_Name = 771094267;
  var kNetworkContext_GetRestrictedCookieManager_Name = 124159077;
  var kNetworkContext_GetTrustTokenQueryAnswerer_Name = 347142997;
  var kNetworkContext_ClearTrustTokenData_Name = 1987704064;
  var kNetworkContext_GetStoredTrustTokenCounts_Name = 366784327;
  var kNetworkContext_DeleteStoredTrustTokens_Name = 2066407579;
  var kNetworkContext_SetBlockTrustTokens_Name = 894437595;
  var kNetworkContext_ClearNetworkingHistoryBetween_Name = 1211773670;
  var kNetworkContext_ClearHttpCache_Name = 468492316;
  var kNetworkContext_ComputeHttpCacheSize_Name = 1105611200;
  var kNetworkContext_NotifyExternalCacheHit_Name = 168408262;
  var kNetworkContext_ClearHostCache_Name = 1562234062;
  var kNetworkContext_ClearHttpAuthCache_Name = 292459296;
  var kNetworkContext_ClearReportingCacheReports_Name = 2128981464;
  var kNetworkContext_ClearReportingCacheClients_Name = 1236122310;
  var kNetworkContext_ClearNetworkErrorLogging_Name = 768384969;
  var kNetworkContext_ClearDomainReliability_Name = 1550285332;
  var kNetworkContext_SetDocumentReportingEndpoints_Name = 1572900884;
  var kNetworkContext_SendReportsAndRemoveSource_Name = 186652559;
  var kNetworkContext_QueueReport_Name = 2039783797;
  var kNetworkContext_QueueSignedExchangeReport_Name = 1432335537;
  var kNetworkContext_CloseAllConnections_Name = 588875715;
  var kNetworkContext_CloseIdleConnections_Name = 792864299;
  var kNetworkContext_SetNetworkConditions_Name = 326804659;
  var kNetworkContext_SetAcceptLanguage_Name = 122539977;
  var kNetworkContext_SetEnableReferrers_Name = 1739882963;
  var kNetworkContext_SetEnablePreconnect_Name = 279994659;
  var kNetworkContext_SetCTPolicy_Name = 737796441;
  var kNetworkContext_AddExpectCT_Name = 1828592958;
  var kNetworkContext_SetExpectCTTestReport_Name = 1511198723;
  var kNetworkContext_GetExpectCTState_Name = 479821939;
  var kNetworkContext_CreateUDPSocket_Name = 1971687438;
  var kNetworkContext_CreateTCPServerSocket_Name = 300752630;
  var kNetworkContext_CreateTCPConnectedSocket_Name = 2127391284;
  var kNetworkContext_CreateTCPBoundSocket_Name = 994271821;
  var kNetworkContext_CreateProxyResolvingSocketFactory_Name = 507129841;
  var kNetworkContext_LookUpProxyForURL_Name = 1817494055;
  var kNetworkContext_ForceReloadProxyConfig_Name = 1165383443;
  var kNetworkContext_ClearBadProxiesCache_Name = 661697989;
  var kNetworkContext_CreateWebSocket_Name = 1733633395;
  var kNetworkContext_CreateWebTransport_Name = 1521641627;
  var kNetworkContext_CreateNetLogExporter_Name = 432052037;
  var kNetworkContext_PreconnectSockets_Name = 966386516;
  var kNetworkContext_CreateP2PSocketManager_Name = 1127010452;
  var kNetworkContext_CreateMdnsResponder_Name = 1672795494;
  var kNetworkContext_ResolveHost_Name = 929154784;
  var kNetworkContext_CreateHostResolver_Name = 529657792;
  var kNetworkContext_VerifyCertForSignedExchange_Name = 387705296;
  var kNetworkContext_AddHSTS_Name = 886337553;
  var kNetworkContext_IsHSTSActiveForHost_Name = 1206385891;
  var kNetworkContext_GetHSTSState_Name = 693820545;
  var kNetworkContext_SetCorsOriginAccessListsForOrigin_Name = 301954763;
  var kNetworkContext_DeleteDynamicDataForHost_Name = 850559146;
  var kNetworkContext_SetSplitAuthCacheByNetworkAnonymizationKey_Name = 1545910945;
  var kNetworkContext_SaveHttpAuthCacheProxyEntries_Name = 1151084661;
  var kNetworkContext_LoadHttpAuthCacheProxyEntries_Name = 1527078016;
  var kNetworkContext_AddAuthCacheEntry_Name = 1862831809;
  var kNetworkContext_SetCorsNonWildcardRequestHeadersSupport_Name = 193423422;
  var kNetworkContext_LookupServerBasicAuthCredentials_Name = 315825179;
  var kNetworkContext_EnableStaticKeyPinningForTesting_Name = 743318922;
  var kNetworkContext_VerifyCertificateForTesting_Name = 742370450;
  var kNetworkContext_AddDomainReliabilityContextForTesting_Name = 1265250893;
  var kNetworkContext_ForceDomainReliabilityUploadsForTesting_Name = 147955009;
  var kNetworkContext_SetCTLogListAlwaysTimelyForTesting_Name = 924977801;
  var kNetworkContext_SetSCTAuditingMode_Name = 800123134;
  var kNetworkContext_AddReportingApiObserver_Name = 1221733526;
  var kNetworkContext_ComputeFirstPartySetMetadata_Name = 901017009;
  ...
  NetworkContextPtr.prototype.setEnablePreconnect = function() {
    return NetworkContextProxy.prototype.setEnablePreconnect
        .apply(this.ptr.getProxy(), arguments);
  };

  NetworkContextProxy.prototype.setEnablePreconnect = function(enablePreconnect) {
    var params_ = new NetworkContext_SetEnablePreconnect_Params();
    params_.enablePreconnect = enablePreconnect;
    var builder = new codec.MessageV0Builder(
        kNetworkContext_SetEnablePreconnect_Name,
        codec.align(NetworkContext_SetEnablePreconnect_Params.encodedSize));
    builder.encodeStruct(NetworkContext_SetEnablePreconnect_Params, params_);
    var message = builder.finish();
    this.receiver_.accept(message);
  };
  ...
  NetworkContextProxy.prototype.addExpectCT = function(host, expiry, enforce, reportUri, networkAnonymizationKey) {
  ...
  NetworkContextProxy.prototype.getExpectCTState = function(domain, networkAnonymizationKey) {
  ...
  NetworkContextPtr.prototype.computeFirstPartySetMetadata = function() {
    return NetworkContextProxy.prototype.computeFirstPartySetMetadata
        .apply(this.ptr.getProxy(), arguments);
  };

  NetworkContextProxy.prototype.computeFirstPartySetMetadata = function(site, topFrameSite, partyContext) {
    var params_ = new NetworkContext_ComputeFirstPartySetMetadata_Params();
    params_.site = site;
    params_.topFrameSite = topFrameSite;
    params_.partyContext = partyContext;
    return new Promise(function(resolve, reject) {
      var builder = new codec.MessageV1Builder(
          kNetworkContext_ComputeFirstPartySetMetadata_Name,
          codec.align(NetworkContext_ComputeFirstPartySetMetadata_Params.encodedSize),
          codec.kMessageExpectsResponse, 0);
      builder.encodeStruct(NetworkContext_ComputeFirstPartySetMetadata_Params, params_);
      var message = builder.finish();
      this.receiver_.acceptAndExpectResponse(message).then(function(message) {
        var reader = new codec.MessageReader(message);
        var responseParams =
            reader.decodeStruct(NetworkContext_ComputeFirstPartySetMetadata_ResponseParams);
        resolve(responseParams);
      }).catch(function(result) {
        reject(Error("Connection error: " + result));
      });
  ...
  NetworkContextStub.prototype.setEnablePreconnect = function(enablePreconnect) {
    return this.delegate_ && this.delegate_.setEnablePreconnect && this.delegate_.setEnablePreconnect(enablePreconnect);
  }
  ...
  NetworkContextStub.prototype.addExpectCT = function(host, expiry, enforce, reportUri, networkAnonymizationKey) {
    return this.delegate_ && this.delegate_.addExpectCT && this.delegate_.addExpectCT(host, expiry, enforce, reportUri, networkAnonymizationKey);
  }
  ...
  NetworkContextStub.prototype.getExpectCTState = function(domain, networkAnonymizationKey) {
    return this.delegate_ && this.delegate_.getExpectCTState && this.delegate_.getExpectCTState(domain, networkAnonymizationKey);
  }
  ...
  NetworkContextStub.prototype.computeFirstPartySetMetadata = function(site, topFrameSite, partyContext) {
    return this.delegate_ && this.delegate_.computeFirstPartySetMetadata && this.delegate_.computeFirstPartySetMetadata(site, topFrameSite, partyContext);
  }
  ...
  NetworkContextStub.prototype.accept = function(message) {
    ...
    case kNetworkContext_SetEnableReferrers_Name:
      ...
      return true;
    case kNetworkContext_SetEnablePreconnect_Name:
      var params = reader.decodeStruct(NetworkContext_SetEnablePreconnect_Params);
      this.setEnablePreconnect(params.enablePreconnect);
      return true;
  ...
  NetworkContextStub.prototype.acceptWithResponder =
    ...
    case kNetworkContext_AddExpectCT_Name:
      ...
      this.addExpectCT(params.host, params.expiry, params.enforce, params.reportUri, params.networkAnonymizationKey).then(function(response) {
        var responseParams =
    ...
    case kNetworkContext_GetExpectCTState_Name:
      ...
      this.getExpectCTState(params.domain, params.networkAnonymizationKey).then(function(response) {
        var responseParams =
    ...
    case kNetworkContext_ForceDomainReliabilityUploadsForTesting_Name:
      ...
      return true;
    case kNetworkContext_ComputeFirstPartySetMetadata_Name:
      var params = reader.decodeStruct(NetworkContext_ComputeFirstPartySetMetadata_Params);
      this.computeFirstPartySetMetadata(params.site, params.topFrameSite, params.partyContext).then(function(response) {
        var responseParams =
            new NetworkContext_ComputeFirstPartySetMetadata_ResponseParams();
        responseParams.metadata = response.metadata;
        var builder = new codec.MessageV1Builder(
            kNetworkContext_ComputeFirstPartySetMetadata_Name,
            codec.align(NetworkContext_ComputeFirstPartySetMetadata_ResponseParams.encodedSize),
            codec.kMessageIsResponse, reader.requestID);
        builder.encodeStruct(NetworkContext_ComputeFirstPartySetMetadata_ResponseParams,
                             responseParams);
        var message = builder.finish();
        responder.accept(message);
      });
  ...
  function validateNetworkContextRequest(messageValidator) {
    ...
    switch (message.getName()) {
      ...
      case kNetworkContext_SetEnablePreconnect_Name:
        if (!message.expectsResponse() && !message.isResponse())
          paramsClass = NetworkContext_SetEnablePreconnect_Params;
      break;
      case kNetworkContext_SetCTPolicy_Name:
        if (!message.expectsResponse() && !message.isResponse())
      ...
      case kNetworkContext_ComputeFirstPartySetMetadata_Name:
        if (message.expectsResponse())
          paramsClass = NetworkContext_ComputeFirstPartySetMetadata_Params;
      break;
    }
    if (paramsClass === null)
      return validator.validationError.NONE;
  ...
  function validateNetworkContextResponse(messageValidator) {
   ...
   switch (message.getName()) {
      ...
      case kNetworkContext_ComputeFirstPartySetMetadata_Name:
        if (message.isResponse())
          paramsClass = NetworkContext_ComputeFirstPartySetMetadata_ResponseParams;
        break;
    }
    if (paramsClass === null)
      return validator.validationError.NONE;
