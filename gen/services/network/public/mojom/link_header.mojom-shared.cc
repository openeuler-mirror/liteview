...
std::ostream& operator<<(std::ostream& os, LinkRelAttribute value) { return os << LinkRelAttributeToString(value); }
...
std::ostream& operator<<(std::ostream& os, LinkAsAttribute value) { return os << LinkAsAttributeToString(value); }
...
std::ostream& operator<<(std::ostream& os, CrossOriginAttribute value) { return os << CrossOriginAttributeToString(value); }
