...
std::ostream& operator<<(std::ostream& os, CorsPreflightPolicy value) { return os << CorsPreflightPolicyToString(value); }
...
std::ostream& operator<<(std::ostream& os, CorsError value) { return os << CorsErrorToString(value); }
...
bool CorsErrorStatus_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    ...
    const mojo::internal::ContainerValidateParams failed_parameter_validate_params(0, false, nullptr);
