...
public:
    ...
    URLResponseHead(::base::Time request_time_in, ::base::Time response_time_in, ::network::mojom::blink::HttpResponseHeadersPtr headers_in, const WTF::String& mime_type_in,
        const WTF::String& charset_in, ::network::mojom::blink::CTPolicyCompliance ct_policy_compliance_in, int64_t content_length_in, int64_t encoded_data_length_in,
        int64_t encoded_body_length_in, bool network_accessed_in, ::network::mojom::blink::LoadTimingInfoPtr load_timing_in, bool emitted_extra_info_in,
        bool was_fetched_via_spdy_in, bool was_alpn_negotiated_in, bool was_alternate_protocol_available_in, ::net::HttpResponseInfo::ConnectionInfo connection_info_in,
        const WTF::String& alpn_negotiated_protocol_in, ::net::AlternateProtocolUsage alternate_protocol_usage_in, const ::net::IPEndPoint& remote_endpoint_in,
        ...
        bool was_fetched_via_cache_in, ::proxy_resolver::mojom::blink::ProxyServerPtr proxy_server_in, bool was_fetched_via_service_worker_in,
        ::network::mojom::blink::FetchResponseSource service_worker_response_source_in, WTF::Vector<::blink::KURL> url_list_via_service_worker_in,
        ::network::mojom::blink::FetchResponseType response_type_in, int64_t padding_in, const WTF::String& cache_storage_cache_name_in, uint32_t cert_status_in,
        ::network::mojom::blink::SSLInfoPtr ssl_info_in, WTF::Vector<WTF::String> cors_exposed_header_names_in, bool did_service_worker_navigation_preload_in,
        bool should_report_corb_blocking_in, bool async_revalidation_requested_in, bool did_mime_sniff_in, bool is_signed_exchange_inner_response_in, bool was_in_prefetch_cache_in,
        bool was_cookie_in_request_in, bool intercepted_by_plugin_in, bool is_legacy_tls_version_in, bool has_range_requested_in, bool timing_allow_passed_in,
        ...
        ::network::mojom::blink::ParsedHeadersPtr parsed_headers_in, const absl::optional<::base::UnguessableToken>& recursive_prefetch_token_in,
        WTF::Vector<WTF::String> dns_aliases_in, const ::blink::KURL& web_bundle_url_in, bool has_authorization_covered_by_wildcard_on_preflight_in,
        bool request_include_credentials_in, bool has_partitioned_cookie_in)
...
template <> struct BLINK_PLATFORM_EXPORT StructTraits<::network::mojom::blink::URLResponseHead::DataView, ::network::mojom::blink::URLResponseHeadPtr> {
    ...
    static const decltype(::network::mojom::blink::URLResponseHead::headers)& headers(const ::network::mojom::blink::URLResponseHeadPtr& input) { return input->headers; }

    static const decltype(::network::mojom::blink::URLResponseHead::mime_type)& mime_type(const ::network::mojom::blink::URLResponseHeadPtr& input) { return input->mime_type; }

    static const decltype(::network::mojom::blink::URLResponseHead::charset)& charset(const ::network::mojom::blink::URLResponseHeadPtr& input) { return input->charset; }

    static decltype(::network::mojom::blink::URLResponseHead::ct_policy_compliance) ct_policy_compliance(const ::network::mojom::blink::URLResponseHeadPtr& input)
    {
    ...
    static decltype(::network::mojom::blink::URLResponseHead::encoded_body_length) encoded_body_length(const ::network::mojom::blink::URLResponseHeadPtr& input)
    {
    ...
    static decltype(::network::mojom::blink::URLResponseHead::was_fetched_via_spdy) was_fetched_via_spdy(const ::network::mojom::blink::URLResponseHeadPtr& input)
    {
    ...
    static const decltype(::network::mojom::blink::URLResponseHead::alpn_negotiated_protocol)& alpn_negotiated_protocol(const ::network::mojom::blink::URLResponseHeadPtr& input)
    {
        return input->alpn_negotiated_protocol;
    }

    static decltype(::network::mojom::blink::URLResponseHead::alternate_protocol_usage) alternate_protocol_usage(const ::network::mojom::blink::URLResponseHeadPtr& input)
    {
    ...
    static decltype(::network::mojom::blink::URLResponseHead::client_address_space) client_address_space(const ::network::mojom::blink::URLResponseHeadPtr& input)
    {
        return input->client_address_space;
    }

    static decltype(::network::mojom::blink::URLResponseHead::response_address_space) response_address_space(const ::network::mojom::blink::URLResponseHeadPtr& input)
    {
        return input->response_address_space;
    }

    static decltype(::network::mojom::blink::URLResponseHead::is_validated) is_validated(const ::network::mojom::blink::URLResponseHeadPtr& input) { return input->is_validated; }

    static decltype(::network::mojom::blink::URLResponseHead::was_fetched_via_cache) was_fetched_via_cache(const ::network::mojom::blink::URLResponseHeadPtr& input)
    {
        return input->was_fetched_via_cache;
    }

    static const decltype(::network::mojom::blink::URLResponseHead::proxy_server)& proxy_server(const ::network::mojom::blink::URLResponseHeadPtr& input)
    {
    ...
    static decltype(::network::mojom::blink::URLResponseHead::padding) padding(const ::network::mojom::blink::URLResponseHeadPtr& input) { return input->padding; }

    static const decltype(::network::mojom::blink::URLResponseHead::cache_storage_cache_name)& cache_storage_cache_name(const ::network::mojom::blink::URLResponseHeadPtr& input)
    {
        return input->cache_storage_cache_name;
    }

    static decltype(::network::mojom::blink::URLResponseHead::cert_status) cert_status(const ::network::mojom::blink::URLResponseHeadPtr& input) { return input->cert_status; }

    static const decltype(::network::mojom::blink::URLResponseHead::ssl_info)& ssl_info(const ::network::mojom::blink::URLResponseHeadPtr& input) { return input->ssl_info; }

    static const decltype(::network::mojom::blink::URLResponseHead::cors_exposed_header_names)& cors_exposed_header_names(const ::network::mojom::blink::URLResponseHeadPtr& input)
    {
    ...
    static decltype(::network::mojom::blink::URLResponseHead::should_report_corb_blocking) should_report_corb_blocking(const ::network::mojom::blink::URLResponseHeadPtr& input)
    {
        return input->should_report_corb_blocking;
    }

    static decltype(::network::mojom::blink::URLResponseHead::async_revalidation_requested) async_revalidation_requested(const ::network::mojom::blink::URLResponseHeadPtr& input)
    {
    ...
    static decltype(::network::mojom::blink::URLResponseHead::was_in_prefetch_cache) was_in_prefetch_cache(const ::network::mojom::blink::URLResponseHeadPtr& input)
    {
        return input->was_in_prefetch_cache;
    }

    static decltype(::network::mojom::blink::URLResponseHead::was_cookie_in_request) was_cookie_in_request(const ::network::mojom::blink::URLResponseHeadPtr& input)
    {
        return input->was_cookie_in_request;
    }

    static decltype(::network::mojom::blink::URLResponseHead::intercepted_by_plugin) intercepted_by_plugin(const ::network::mojom::blink::URLResponseHeadPtr& input)
    {
        return input->intercepted_by_plugin;
    }

    static decltype(::network::mojom::blink::URLResponseHead::is_legacy_tls_version) is_legacy_tls_version(const ::network::mojom::blink::URLResponseHeadPtr& input)
    {
    ...
    static const decltype(::network::mojom::blink::URLResponseHead::auth_challenge_info)& auth_challenge_info(const ::network::mojom::blink::URLResponseHeadPtr& input)
    {
    ...
    static const decltype(::network::mojom::blink::URLResponseHead::recursive_prefetch_token)& recursive_prefetch_token(const ::network::mojom::blink::URLResponseHeadPtr& input)
    {
    ...
    static const decltype(::network::mojom::blink::URLResponseHead::web_bundle_url)& web_bundle_url(const ::network::mojom::blink::URLResponseHeadPtr& input)
    {
    ...
    static decltype(::network::mojom::blink::URLResponseHead::request_include_credentials) request_include_credentials(const ::network::mojom::blink::URLResponseHeadPtr& input)
    {
        return input->request_include_credentials;
    }

    static decltype(::network::mojom::blink::URLResponseHead::has_partitioned_cookie) has_partitioned_cookie(const ::network::mojom::blink::URLResponseHeadPtr& input)
    {
