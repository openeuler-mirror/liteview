...
public:
    ...
    AuthChallengeInfo(bool is_proxy_in, const ::url::SchemeHostPort& challenger_in, const std::string& scheme_in, const std::string& realm_in, const std::string& challenge_in,
...
template <> struct StructTraits<::network::mojom::AuthChallengeInfo::DataView, ::network::mojom::AuthChallengeInfoPtr> {
    ...
    static decltype(::network::mojom::AuthChallengeInfo::is_proxy) is_proxy(const ::network::mojom::AuthChallengeInfoPtr& input) { return input->is_proxy; }

    static const decltype(::network::mojom::AuthChallengeInfo::challenger)& challenger(const ::network::mojom::AuthChallengeInfoPtr& input) { return input->challenger; }

    static const decltype(::network::mojom::AuthChallengeInfo::scheme)& scheme(const ::network::mojom::AuthChallengeInfoPtr& input) { return input->scheme; }

    static const decltype(::network::mojom::AuthChallengeInfo::realm)& realm(const ::network::mojom::AuthChallengeInfoPtr& input) { return input->realm; }

    static const decltype(::network::mojom::AuthChallengeInfo::challenge)& challenge(const ::network::mojom::AuthChallengeInfoPtr& input) { return input->challenge; }

    static const decltype(::network::mojom::AuthChallengeInfo::path)& path(const ::network::mojom::AuthChallengeInfoPtr& input) { return input->path; }
...
template <> struct StructTraits<::network::mojom::HttpVersion::DataView, ::network::mojom::HttpVersionPtr> {
    ...
    static decltype(::network::mojom::HttpVersion::major_value) major_value(const ::network::mojom::HttpVersionPtr& input) { return input->major_value; }

    static decltype(::network::mojom::HttpVersion::minor_value) minor_value(const ::network::mojom::HttpVersionPtr& input) { return input->minor_value; }
...
template <> struct StructTraits<::network::mojom::ResolveErrorInfo::DataView, ::network::mojom::ResolveErrorInfoPtr> {
    ...
    static decltype(::network::mojom::ResolveErrorInfo::error) error(const ::network::mojom::ResolveErrorInfoPtr& input) { return input->error; }
