...
static_assert(sizeof(CookieManagerParams_Data) == 64, "Bad sizeof(CookieManagerParams_Data)");
...
static_assert(sizeof(CookieSameSiteContextMetadata_Data) == 16, "Bad sizeof(CookieSameSiteContextMetadata_Data)");
// Used by CookieSameSiteContextMetadata::WrapAsMessage to lazily serialize the struct.
template <typename UserType, typename DataView> struct CookieSameSiteContextMetadata_UnserializedMessageContext : public mojo::internal::UnserializedMessageContext {
public:
    static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;
...
static_assert(sizeof(CookieOptions_Data) == 32, "Bad sizeof(CookieOptions_Data)");
...
static_assert(sizeof(CookieInclusionStatus_Data) == 16, "Bad sizeof(CookieInclusionStatus_Data)");
...
template <typename UserType, typename DataView> struct CookieAndLineWithAccessResult_UnserializedMessageContext : public mojo::internal::UnserializedMessageContext {
public:
    static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;
...
template <typename UserType, typename DataView> struct CookieOrLineWithAccessResult_UnserializedMessageContext : public mojo::internal::UnserializedMessageContext {
public:
    static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;
