...
class ResolveHostClientInterceptorForTesting : public ResolveHostClient {
    ...
    void OnComplete(int32_t result, const ::net::ResolveErrorInfo& resolve_error_info, const absl::optional<::net::AddressList>& resolved_addresses,
        const absl::optional<std::vector<::net::HostResolverEndpointResult>>& endpoint_results_with_metadata) override;
...
public:
    ...
    void MdnsListen(const ::net::HostPortPair& host, ::net::DnsQueryType query_type, ::mojo::PendingRemote<MdnsListenClient> response_client, int32_t* out_result);
