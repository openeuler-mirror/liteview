...
ContentSecurityPolicyHeader::ContentSecurityPolicyHeader(const std::string& header_value_in, ContentSecurityPolicyType type_in, ContentSecurityPolicySource source_in)
...
bool ContentSecurityPolicyHeader::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
CSPSource::CSPSource()
    : scheme()
    , host()
    , port(-1)
...
CSPSource::CSPSource(const std::string& scheme_in, const std::string& host_in, int32_t port_in, const std::string& path_in, bool is_host_wildcard_in, bool is_port_wildcard_in)
...
bool CSPSource::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
bool CSPHashSource::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
CSPSourceList::CSPSourceList(std::vector<CSPSourcePtr> sources_in, std::vector<std::string> nonces_in, std::vector<CSPHashSourcePtr> hashes_in, bool allow_self_in,
    bool allow_star_in, bool allow_response_redirects_in, bool allow_inline_in, bool allow_eval_in, bool allow_wasm_eval_in, bool allow_wasm_unsafe_eval_in, bool allow_dynamic_in,
...
void CSPSourceList::WriteIntoTrace(perfetto::TracedValue traced_context) const
{
    ...
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("allow_response_redirects"), this->allow_response_redirects,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
        "<value of type bool>"
#else
        "<value>"
...
bool CSPSourceList::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
bool CSPTrustedTypes::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
bool ContentSecurityPolicy::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
CSPViolation::CSPViolation(const std::string& directive_in, const std::string& effective_directive_in, const std::string& console_message_in, const ::GURL& blocked_url_in,
...
bool CSPViolation::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
AllowCSPFromHeaderValue::~AllowCSPFromHeaderValue() { DestroyActive(); }
...
bool AllowCSPFromHeaderValue::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context, false); }
} // namespace mojom
} // namespace network
namespace mojo {
// static
...
// static
bool StructTraits<::network::mojom::CSPSource::DataView, ::network::mojom::CSPSourcePtr>::Read(::network::mojom::CSPSource::DataView input, ::network::mojom::CSPSourcePtr* output)
{
    bool success = true;
