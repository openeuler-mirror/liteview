...
inline bool IsKnownEnumValue(SourceType value) { return internal::SourceType_Data::IsKnownValue(static_cast<int32_t>(value)); }
class TrustedUrlRequestParamsDataView {
public:
    ...
    bool has_user_activation() const { return data_->has_user_activation; }
    ...
    template <typename UserType> UserType TakeAcceptChFrameObserver()
    {
        UserType result;
        bool ret
            = mojo::internal::Deserialize<mojo::InterfacePtrDataView<::network::mojom::AcceptCHFrameObserverInterfaceBase>>(&data_->accept_ch_frame_observer, &result, message_);
        DCHECK(ret);
        return result;
    }
...
public:
    ...
    {
        UserType result;
        bool ret = mojo::internal::Deserialize<mojo::InterfacePtrDataView<::network::mojom::WebBundleHandleInterfaceBase>>(&data_->web_bundle_handle, &result, message_);
        DCHECK(ret);
        return result;
    }
    int32_t render_process_id() const { return data_->render_process_id; }
...
public:
    ...
    bool is_null() const { return !data_; }
    uint32_t source_type() const { return data_->source_type; }
    uint32_t source_id() const { return data_->source_id; }
...
public:
    ...
    bool update_first_party_url_on_redirect() const { return data_->update_first_party_url_on_redirect; }
    ...
    int32_t resource_type() const { return data_->resource_type; }
    ...
    ::network::mojom::RequestPriority priority() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::network::mojom::RequestPriority>(data_->priority)); }
    ...
    bool originated_from_service_worker() const { return data_->originated_from_service_worker; }
    bool skip_service_worker() const { return data_->skip_service_worker; }
    bool corb_detachable() const { return data_->corb_detachable; }
    ...
    ::network::mojom::RequestMode mode() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::network::mojom::RequestMode>(data_->mode)); }
    ...
    ::network::mojom::RedirectMode redirect_mode() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::network::mojom::RedirectMode>(data_->redirect_mode)); }
    ...
    bool keepalive() const { return data_->keepalive; }
    bool has_user_gesture() const { return data_->has_user_gesture; }
    bool enable_load_timing() const { return data_->enable_load_timing; }
    bool enable_upload_progress() const { return data_->enable_upload_progress; }
    bool do_not_prompt_for_login() const { return data_->do_not_prompt_for_login; }
    bool is_outermost_main_frame() const { return data_->is_outermost_main_frame; }
    int32_t transition_type() const { return data_->transition_type; }
    int32_t previews_state() const { return data_->previews_state; }
    bool upgrade_if_insecure() const { return data_->upgrade_if_insecure; }
    bool is_revalidating() const { return data_->is_revalidating; }
    ...
    bool is_fetch_like_api() const { return data_->is_fetch_like_api; }
    ...
    inline void GetNetLogCreateInfoDataView(NetLogSourceDataView* output);
    ...
    inline void GetNetLogReferenceInfoDataView(NetLogSourceDataView* output);
...
public:
    ...
    uint64_t identifier() const { return data_->identifier; }
    bool contains_sensitive_info() const { return data_->contains_sensitive_info; }
    bool allow_http1_for_streaming_upload() const { return data_->allow_http1_for_streaming_upload; }
...
public:
    ...
    uint64_t offset() const { return data_->offset; }
    uint64_t length() const { return data_->length; }
...
public:
    ...
    {
        UserType result;
        bool ret = mojo::internal::Deserialize<mojo::InterfacePtrDataView<::network::mojom::DataPipeGetterInterfaceBase>>(&data_->data_pipe_getter, &result, message_);
        DCHECK(ret);
        return result;
    }
...
public:
    ...
    {
        UserType result;
        bool ret = mojo::internal::Deserialize<mojo::InterfacePtrDataView<::network::mojom::ChunkedDataPipeGetterInterfaceBase>>(&data_->data_pipe_getter, &result, message_);
        DCHECK(ret);
        return result;
    }
    bool read_only_once() const { return data_->read_only_once; }
...
template <typename MaybeConstUserType> struct Serializer<::network::mojom::TrustedUrlRequestParamsDataView, MaybeConstUserType> {
    ...
    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::network::mojom::internal::TrustedUrlRequestParams_Data>& fragment)
    {
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
            fragment->isolation_info.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null isolation_info in TrustedUrlRequestParams struct");
...
template <typename MaybeConstUserType> struct Serializer<::network::mojom::WebBundleTokenParamsDataView, MaybeConstUserType> {
    ...
    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::network::mojom::internal::WebBundleTokenParams_Data>& fragment)
    {
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->token.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null token in WebBundleTokenParams struct");
...
template <typename MaybeConstUserType> struct Serializer<::network::mojom::URLRequestDataView, MaybeConstUserType> {
    ...
    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::network::mojom::internal::URLRequest_Data>& fragment)
    {
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->method.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null method in URLRequest struct");
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->url.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null url in URLRequest struct");
        ...
        mojo::internal::MessageFragment<typename decltype(fragment->navigation_redirect_chain)::BaseType> navigation_redirect_chain_fragment(fragment.message());
        const mojo::internal::ContainerValidateParams navigation_redirect_chain_validate_params(0, false, nullptr);
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
            fragment->navigation_redirect_chain.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null navigation_redirect_chain in URLRequest struct");
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->referrer.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null referrer in URLRequest struct");
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->headers.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null headers in URLRequest struct");
        ...
        mojo::internal::MessageFragment<typename decltype(fragment->devtools_accepted_stream_types)::BaseType> devtools_accepted_stream_types_fragment(fragment.message());
        const mojo::internal::ContainerValidateParams devtools_accepted_stream_types_validate_params(0, ::network::mojom::internal::SourceType_Data::Validate);
        ...
        fragment->devtools_accepted_stream_types.Set(devtools_accepted_stream_types_fragment.is_null() ? nullptr : devtools_accepted_stream_types_fragment.data());
...
template <typename MaybeConstUserType> struct Serializer<::network::mojom::URLRequestBodyDataView, MaybeConstUserType> {
    ...
    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::network::mojom::internal::URLRequestBody_Data>& fragment)
    {
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->elements.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null elements in URLRequestBody struct");
...
template <typename MaybeConstUserType> struct Serializer<::network::mojom::DataElementBytesDataView, MaybeConstUserType> {
    ...
    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::network::mojom::internal::DataElementBytes_Data>& fragment)
    {
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->data.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null data in DataElementBytes struct");
    }
...
template <typename MaybeConstUserType> struct Serializer<::network::mojom::DataElementFileDataView, MaybeConstUserType> {
    ...
    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::network::mojom::internal::DataElementFile_Data>& fragment)
    {
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->path.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null path in DataElementFile struct");
        ...
        mojo::internal::MessageFragment<typename decltype(fragment->expected_modification_time)::BaseType> expected_modification_time_fragment(fragment.message());
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
            fragment->expected_modification_time.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null expected_modification_time in DataElementFile struct");
    }
...
template <typename MaybeConstUserType> struct Serializer<::network::mojom::DataElementDataPipeDataView, MaybeConstUserType> {
    ...
    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::network::mojom::internal::DataElementDataPipe_Data>& fragment)
    {
        ...
        mojo::internal::Serialize<mojo::InterfacePtrDataView<::network::mojom::DataPipeGetterInterfaceBase>>(in_data_pipe_getter, &fragment->data_pipe_getter, &fragment.message());
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(!mojo::internal::IsHandleOrInterfaceValid(fragment->data_pipe_getter), mojo::internal::VALIDATION_ERROR_UNEXPECTED_INVALID_HANDLE,
...
template <typename MaybeConstUserType> struct Serializer<::network::mojom::DataElementDataView, MaybeConstUserType> {
    ...
    static void Serialize(MaybeConstUserType& input, MessageFragment<::network::mojom::internal::DataElement_Data>& fragment, bool inlined)
    {
        ...
        case ::network::mojom::DataElementDataView::Tag::kBytes: {
            ...
            MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(value_fragment.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null bytes in DataElement union");
        ...
        case ::network::mojom::DataElementDataView::Tag::kFile: {
            ...
            MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(value_fragment.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null file in DataElement union");
        ...
        case ::network::mojom::DataElementDataView::Tag::kDataPipe: {
            ...
            MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(value_fragment.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null data_pipe in DataElement union");
...
inline void URLRequestDataView::GetNetLogCreateInfoDataView(NetLogSourceDataView* output)
{
    auto pointer = data_->net_log_create_info.Get();
    *output = NetLogSourceDataView(pointer, message_);
}
inline void URLRequestDataView::GetNetLogReferenceInfoDataView(NetLogSourceDataView* output)
{
    auto pointer = data_->net_log_reference_info.Get();
    *output = NetLogSourceDataView(pointer, message_);
}
