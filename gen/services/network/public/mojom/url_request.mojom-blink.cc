...
#ifndef SERVICES_NETWORK_PUBLIC_MOJOM_URL_REQUEST_MOJOM_BLINK_JUMBO_H_
#define SERVICES_NETWORK_PUBLIC_MOJOM_URL_REQUEST_MOJOM_BLINK_JUMBO_H_
...
bool TrustedUrlRequestParams::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
bool WebBundleTokenParams::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
bool NetLogSource::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
URLRequest::URLRequest(const WTF::String& method_in, const ::blink::KURL& url_in, const ::net::SiteForCookies& site_for_cookies_in, bool update_first_party_url_on_redirect_in,
    ...
    ::net::RequestPriority priority_in, ::network::mojom::blink::CorsPreflightPolicy cors_preflight_policy_in, bool originated_from_service_worker_in, bool skip_service_worker_in,
    bool corb_detachable_in, ::network::mojom::blink::RequestMode mode_in, ::network::mojom::blink::CredentialsMode credentials_mode_in,
    ...
    bool do_not_prompt_for_login_in, bool is_outermost_main_frame_in, int32_t transition_type_in, int32_t previews_state_in, bool upgrade_if_insecure_in, bool is_revalidating_in,
    const absl::optional<::base::UnguessableToken>& throttling_profile_id_in, const absl::optional<::base::UnguessableToken>& fetch_window_id_in,
...
void URLRequest::WriteIntoTrace(perfetto::TracedValue traced_context) const
{
    ...
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("corb_detachable"), this->corb_detachable,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
        "<value of type bool>"
#else
        "<value>"
...
bool URLRequest::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
URLRequestBody::URLRequestBody(WTF::Vector<::network::DataElement> elements_in, uint64_t identifier_in, bool contains_sensitive_info_in, bool allow_http1_for_streaming_upload_in)
...
bool URLRequestBody::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
bool DataElementDataPipe::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
DataElementChunkedDataPipe::DataElementChunkedDataPipe(::mojo::PendingRemote<::network::mojom::blink::ChunkedDataPipeGetter> data_pipe_getter_in, bool read_only_once_in)
    : data_pipe_getter(std::move(data_pipe_getter_in))
...
bool DataElementChunkedDataPipe::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
