...
URLRequest::URLRequest(const std::string& method_in, const ::GURL& url_in, const ::net::SiteForCookies& site_for_cookies_in, bool update_first_party_url_on_redirect_in,
...
URLRequestBody::URLRequestBody(std::vector<::network::DataElement> elements_in, uint64_t identifier_in, bool contains_sensitive_info_in, bool allow_http1_for_streaming_upload_in)
...
DataElementChunkedDataPipe::DataElementChunkedDataPipe(::mojo::PendingRemote<::network::mojom::ChunkedDataPipeGetter> data_pipe_getter_in, bool read_only_once_in)
    : data_pipe_getter(std::move(data_pipe_getter_in))
