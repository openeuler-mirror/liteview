...
HttpRequestHeaderKeyValuePair::HttpRequestHeaderKeyValuePair(const WTF::String& key_in, const WTF::String& value_in)
    : key(std::move(key_in))
...
bool HttpRequestHeaderKeyValuePair::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
bool HttpRequestHeaders::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
} // namespace blink
} // namespace mojom
} // namespace network
namespace mojo {
