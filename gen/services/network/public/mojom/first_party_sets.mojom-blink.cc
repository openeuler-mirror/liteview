...
SamePartyContext::SamePartyContext(SamePartyCookieContextType context_type_in)
...
FirstPartySetMetadata::FirstPartySetMetadata(SamePartyContextPtr context_in, FirstPartySetEntryPtr frame_entry_in, FirstPartySetEntryPtr top_frame_entry_in)
...
FirstPartySetsContextConfig::FirstPartySetsContextConfig(WTF::HashMap<::blink::BlinkSchemefulSite, FirstPartySetEntryPtr> customizations_in)
...
GlobalFirstPartySets::GlobalFirstPartySets(WTF::HashMap<::blink::BlinkSchemefulSite, FirstPartySetEntryPtr> sets_in,
...
bool StructTraits<::network::mojom::blink::SamePartyContext::DataView, ::network::mojom::blink::SamePartyContextPtr>::Read(
    ::network::mojom::blink::SamePartyContext::DataView input, ::network::mojom::blink::SamePartyContextPtr* output)
{
    bool success = true;
