...
URLResponseHead::URLResponseHead(::base::Time request_time_in, ::base::Time response_time_in, const ::scoped_refptr<::net::HttpResponseHeaders>& headers_in,
    const std::string& mime_type_in, const std::string& charset_in, ::net::ct::CTPolicyCompliance ct_policy_compliance_in, int64_t content_length_in,
    int64_t encoded_data_length_in, int64_t encoded_body_length_in, bool network_accessed_in, const ::net::LoadTimingInfo& load_timing_in, bool emitted_extra_info_in,
    ...
    std::vector<::GURL> url_list_via_service_worker_in, ::network::mojom::FetchResponseType response_type_in, int64_t padding_in, const std::string& cache_storage_cache_name_in,
    uint32_t cert_status_in, const absl::optional<::net::SSLInfo>& ssl_info_in, std::vector<std::string> cors_exposed_header_names_in,
    bool did_service_worker_navigation_preload_in, bool should_report_corb_blocking_in, bool async_revalidation_requested_in, bool did_mime_sniff_in,
    bool is_signed_exchange_inner_response_in, bool was_in_prefetch_cache_in, bool was_cookie_in_request_in, bool intercepted_by_plugin_in, bool is_legacy_tls_version_in,
    bool has_range_requested_in, bool timing_allow_passed_in, const absl::optional<::net::AuthChallengeInfo>& auth_challenge_info_in, ::base::TimeTicks request_start_in,
    ::base::TimeTicks response_start_in, ::network::mojom::ParsedHeadersPtr parsed_headers_in, const absl::optional<::base::UnguessableToken>& recursive_prefetch_token_in,
    std::vector<std::string> dns_aliases_in, const ::GURL& web_bundle_url_in, bool has_authorization_covered_by_wildcard_on_preflight_in, bool request_include_credentials_in,
...
void URLResponseHead::WriteIntoTrace(perfetto::TracedValue traced_context) const
{
    ...
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("ct_policy_compliance"), this->ct_policy_compliance,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    ...
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("is_legacy_tls_version"), this->is_legacy_tls_version,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
        "<value of type bool>"
#else
        "<value>"
    ...
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("web_bundle_url"), this->web_bundle_url,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    ...
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("has_authorization_covered_by_wildcard_on_preflight"), this->has_authorization_covered_by_wildcard_on_preflight,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
        "<value of type bool>"
#else
        "<value>"
    ...
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("has_partitioned_cookie"), this->has_partitioned_cookie,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
        "<value of type bool>"
#else
        "<value>"
...
bool URLResponseHead::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
} // namespace mojom
} // namespace network
namespace mojo {
// static
