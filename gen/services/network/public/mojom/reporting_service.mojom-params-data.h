...
static_assert(sizeof(ReportingApiObserver_OnEndpointsUpdatedForOrigin_Params_Data) == 16, "Bad sizeof(ReportingApiObserver_OnEndpointsUpdatedForOrigin_Params_Data)");
...
public:
    ...
    ReportingApiObserver_OnEndpointsUpdatedForOrigin_ParamsDataView(internal::ReportingApiObserver_OnEndpointsUpdatedForOrigin_Params_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
