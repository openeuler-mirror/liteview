...
namespace internal {
// static
bool NetworkAnonymizationKey_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    if (!data)
        return true;
    ...
    [[maybe_unused]] const NetworkAnonymizationKey_Data* object = static_cast<const NetworkAnonymizationKey_Data*>(data);
...
NetworkAnonymizationKey_Data::NetworkAnonymizationKey_Data()
