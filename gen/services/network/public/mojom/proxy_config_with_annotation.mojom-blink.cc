...
ProxyConfigWithAnnotation::ProxyConfigWithAnnotation(::network::mojom::blink::ProxyConfigPtr value_in, const ::net::MutableNetworkTrafficAnnotationTag& traffic_annotation_in)
...
bool ProxyConfigWithAnnotation::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
void ProxyConfigClientProxy::OnProxyConfigUpdated(ProxyConfigWithAnnotationPtr in_proxy_config)
{
    ...
    mojo::Message message(internal::kProxyConfigClient_OnProxyConfigUpdated_Name, kFlags, 0, 0, nullptr);
    ...
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
        params->proxy_config.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null proxy_config in ProxyConfigClient.OnProxyConfigUpdated request");
...
void ProxyConfigClientProxy::FlushProxyConfig(FlushProxyConfigCallback callback)
{
    ...
    mojo::Message message(internal::kProxyConfigClient_FlushProxyConfig_Name, kFlags, 0, 0, nullptr);
...
public:
    ...
    {
        std::unique_ptr<ProxyConfigClient_FlushProxyConfig_ProxyToResponder> proxy(new ProxyConfigClient_FlushProxyConfig_ProxyToResponder(message, std::move(responder)));
...
bool ProxyConfigClientStubDispatch::Accept(ProxyConfigClient* impl, mojo::Message* message)
{
    ...
    case internal::kProxyConfigClient_OnProxyConfigUpdated_Name: {
        ...
        bool success = true;
        ProxyConfigWithAnnotationPtr p_proxy_config = mojo::DefaultConstructTraits::CreateInstance<ProxyConfigWithAnnotationPtr>();
...
// static
bool ProxyConfigClientStubDispatch::AcceptWithResponder(ProxyConfigClient* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
{
    ...
    case internal::kProxyConfigClient_FlushProxyConfig_Name: {
        ...
        internal::ProxyConfigClient_FlushProxyConfig_Params_Data* params = reinterpret_cast<internal::ProxyConfigClient_FlushProxyConfig_Params_Data*>(message->mutable_payload());
        ...
        ProxyConfigClient::FlushProxyConfigCallback callback = ProxyConfigClient_FlushProxyConfig_ProxyToResponder::CreateCallback(*message, std::move(responder));
        // A null |impl| means no implementation was bound.
        DCHECK(impl);
...
static const std::pair<uint32_t, mojo::internal::GenericValidationInfo> kProxyConfigClientValidationInfo[] = {
    { internal::kProxyConfigClient_OnProxyConfigUpdated_Name, { &internal::ProxyConfigClient_OnProxyConfigUpdated_Params_Data::Validate, nullptr /* no response */ } },
...
void ProxyConfigPollerClientProxy::OnLazyProxyConfigPoll()
{
    ...
    mojo::Message message(internal::kProxyConfigPollerClient_OnLazyProxyConfigPoll_Name, kFlags, 0, 0, nullptr);
...
// static
bool ProxyConfigPollerClientStubDispatch::AcceptWithResponder(ProxyConfigPollerClient* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
{
    [[maybe_unused]] const bool message_is_sync = message->has_flag(mojo::Message::kFlagIsSync);
    [[maybe_unused]] const uint64_t request_id = message->request_id();
    switch (message->header()->name) {
...
void ProxyErrorClientProxy::OnPACScriptError(int32_t in_line_number, const WTF::String& in_details)
{
    ...
    mojo::Message message(internal::kProxyErrorClient_OnPACScriptError_Name, kFlags, 0, 0, nullptr);
...
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send network::mojom::ProxyErrorClient::OnRequestMaybeFailedDueToProxySettings", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
    ...
    mojo::Message message(internal::kProxyErrorClient_OnRequestMaybeFailedDueToProxySettings_Name, kFlags, 0, 0, nullptr);
...
bool ProxyErrorClientStubDispatch::Accept(ProxyErrorClient* impl, mojo::Message* message)
{
    ...
    case internal::kProxyErrorClient_OnPACScriptError_Name: {
        ...
        DCHECK(message->is_serialized());
        internal::ProxyErrorClient_OnPACScriptError_Params_Data* params = reinterpret_cast<internal::ProxyErrorClient_OnPACScriptError_Params_Data*>(message->mutable_payload());

        bool success = true;
        int32_t p_line_number = mojo::DefaultConstructTraits::CreateInstance<int32_t>();
        WTF::String p_details = mojo::DefaultConstructTraits::CreateInstance<WTF::String>();
...
// static
bool ProxyErrorClientStubDispatch::AcceptWithResponder(ProxyErrorClient* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
{
    [[maybe_unused]] const bool message_is_sync = message->has_flag(mojo::Message::kFlagIsSync);
    [[maybe_unused]] const uint64_t request_id = message->request_id();
    switch (message->header()->name) {
...
static const std::pair<uint32_t, mojo::internal::GenericValidationInfo> kProxyErrorClientValidationInfo[] = {
    { internal::kProxyErrorClient_OnPACScriptError_Name, { &internal::ProxyErrorClient_OnPACScriptError_Params_Data::Validate, nullptr /* no response */ } },
...
void ProxyConfigClientInterceptorForTesting::FlushProxyConfig(FlushProxyConfigCallback callback) { GetForwardingInterface()->FlushProxyConfig(std::move(callback)); }
...
void ProxyConfigPollerClientInterceptorForTesting::OnLazyProxyConfigPoll() { GetForwardingInterface()->OnLazyProxyConfigPoll(); }
