...
class BLINK_PLATFORM_EXPORT NetLogExporterInterceptorForTesting : public NetLogExporter {
    ...
    void Start(::base::File destination, ::base::Value::Dict extra_constants, NetLogCaptureMode capture_mode, uint64_t max_file_size, StartCallback callback) override;
...
class BLINK_PLATFORM_EXPORT NetLogProxySinkInterceptorForTesting : public NetLogProxySink {
    ...
    void AddEntry(uint32_t type, uint32_t source_type, uint32_t source_id, ::base::TimeTicks source_start_time, NetLogEventPhase phase, ::base::TimeTicks time,
