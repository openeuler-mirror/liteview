...
public:
    ...
    FulfillTrustTokenIssuanceAnswer(FulfillTrustTokenIssuanceAnswer::Status status_in, const std::string& response_in)
        : status(std::move(status_in))
...
public:
    ...
    TrustTokenParams(TrustTokenOperationType type_in, TrustTokenRefreshPolicy refresh_policy_in, const absl::optional<std::string>& custom_key_commitment_in,
        const absl::optional<::url::Origin>& custom_issuer_in, TrustTokenSignRequestData sign_request_data_in, bool include_timestamp_header_in,
        std::vector<::url::Origin> issuers_in, std::vector<std::string> additional_signed_headers_in, const absl::optional<std::string>& possibly_unsafe_additional_signing_data_in)
...
public:
    ...
    TrustTokenVerificationKey(const std::string& body_in, ::base::Time expiry_in)
...
public:
    ...
    TrustTokenKeyCommitmentResult(TrustTokenProtocolVersion protocol_version_in, int32_t id_in, int32_t batch_size_in, std::vector<TrustTokenVerificationKeyPtr> keys_in,
...
public:
    ...
    FulfillTrustTokenIssuanceRequest(const ::url::Origin& issuer_in, const std::string& request_in)
...
public:
    ...
    TrustTokenOperationResult(TrustTokenOperationType type_in, TrustTokenOperationStatus status_in, const absl::optional<::url::Origin>& issuer_in,
        const absl::optional<::url::Origin>& top_level_origin_in, int32_t issued_token_count_in)
        : type(std::move(type_in))
        , status(std::move(status_in))
        , issuer(std::move(issuer_in))
...
public:
    ...
    StoredTrustTokensForIssuer(const ::url::Origin& issuer_in, int32_t count_in)
        : issuer(std::move(issuer_in))
...
template <> struct StructTraits<::network::mojom::TrustTokenParams::DataView, ::network::mojom::TrustTokenParamsPtr> {
    ...
    static decltype(::network::mojom::TrustTokenParams::type) type(const ::network::mojom::TrustTokenParamsPtr& input) { return input->type; }

    static decltype(::network::mojom::TrustTokenParams::refresh_policy) refresh_policy(const ::network::mojom::TrustTokenParamsPtr& input) { return input->refresh_policy; }
    ...
    static const decltype(::network::mojom::TrustTokenParams::custom_issuer)& custom_issuer(const ::network::mojom::TrustTokenParamsPtr& input) { return input->custom_issuer; }
    ...
    static const decltype(::network::mojom::TrustTokenParams::issuers)& issuers(const ::network::mojom::TrustTokenParamsPtr& input) { return input->issuers; }

    static const decltype(::network::mojom::TrustTokenParams::additional_signed_headers)& additional_signed_headers(const ::network::mojom::TrustTokenParamsPtr& input)
    {
...
template <> struct StructTraits<::network::mojom::HasTrustTokensResult::DataView, ::network::mojom::HasTrustTokensResultPtr> {
    ...
    static decltype(::network::mojom::HasTrustTokensResult::status) status(const ::network::mojom::HasTrustTokensResultPtr& input) { return input->status; }
...
template <> struct StructTraits<::network::mojom::HasRedemptionRecordResult::DataView, ::network::mojom::HasRedemptionRecordResultPtr> {
    ...
    static decltype(::network::mojom::HasRedemptionRecordResult::status) status(const ::network::mojom::HasRedemptionRecordResultPtr& input) { return input->status; }

    static decltype(::network::mojom::HasRedemptionRecordResult::has_redemption_record) has_redemption_record(const ::network::mojom::HasRedemptionRecordResultPtr& input)
    {
...
template <> struct StructTraits<::network::mojom::TrustTokenVerificationKey::DataView, ::network::mojom::TrustTokenVerificationKeyPtr> {
    ...
    static const decltype(::network::mojom::TrustTokenVerificationKey::body)& body(const ::network::mojom::TrustTokenVerificationKeyPtr& input) { return input->body; }

    static const decltype(::network::mojom::TrustTokenVerificationKey::expiry)& expiry(const ::network::mojom::TrustTokenVerificationKeyPtr& input) { return input->expiry; }
...
template <> struct StructTraits<::network::mojom::TrustTokenKeyCommitmentResult::DataView, ::network::mojom::TrustTokenKeyCommitmentResultPtr> {
    ...
    static decltype(::network::mojom::TrustTokenKeyCommitmentResult::protocol_version) protocol_version(const ::network::mojom::TrustTokenKeyCommitmentResultPtr& input)
    {
        return input->protocol_version;
    }

    static decltype(::network::mojom::TrustTokenKeyCommitmentResult::id) id(const ::network::mojom::TrustTokenKeyCommitmentResultPtr& input) { return input->id; }
    ...
    static const decltype(::network::mojom::TrustTokenKeyCommitmentResult::keys)& keys(const ::network::mojom::TrustTokenKeyCommitmentResultPtr& input) { return input->keys; }
...
template <> struct StructTraits<::network::mojom::FulfillTrustTokenIssuanceRequest::DataView, ::network::mojom::FulfillTrustTokenIssuanceRequestPtr> {
    ...
    static const decltype(::network::mojom::FulfillTrustTokenIssuanceRequest::issuer)& issuer(const ::network::mojom::FulfillTrustTokenIssuanceRequestPtr& input)
    {
        return input->issuer;
    }

    static const decltype(::network::mojom::FulfillTrustTokenIssuanceRequest::request)& request(const ::network::mojom::FulfillTrustTokenIssuanceRequestPtr& input)
    {
...
template <> struct StructTraits<::network::mojom::FulfillTrustTokenIssuanceAnswer::DataView, ::network::mojom::FulfillTrustTokenIssuanceAnswerPtr> {
    ...
    static decltype(::network::mojom::FulfillTrustTokenIssuanceAnswer::status) status(const ::network::mojom::FulfillTrustTokenIssuanceAnswerPtr& input) { return input->status; }

    static const decltype(::network::mojom::FulfillTrustTokenIssuanceAnswer::response)& response(const ::network::mojom::FulfillTrustTokenIssuanceAnswerPtr& input)
    {
...
template <> struct StructTraits<::network::mojom::TrustTokenOperationResult::DataView, ::network::mojom::TrustTokenOperationResultPtr> {
    ...
    static decltype(::network::mojom::TrustTokenOperationResult::type) type(const ::network::mojom::TrustTokenOperationResultPtr& input) { return input->type; }

    static decltype(::network::mojom::TrustTokenOperationResult::status) status(const ::network::mojom::TrustTokenOperationResultPtr& input) { return input->status; }

    static const decltype(::network::mojom::TrustTokenOperationResult::issuer)& issuer(const ::network::mojom::TrustTokenOperationResultPtr& input) { return input->issuer; }

    static const decltype(::network::mojom::TrustTokenOperationResult::top_level_origin)& top_level_origin(const ::network::mojom::TrustTokenOperationResultPtr& input)
    {
        return input->top_level_origin;
    }

    static decltype(::network::mojom::TrustTokenOperationResult::issued_token_count) issued_token_count(const ::network::mojom::TrustTokenOperationResultPtr& input)
    {
...
template <> struct StructTraits<::network::mojom::StoredTrustTokensForIssuer::DataView, ::network::mojom::StoredTrustTokensForIssuerPtr> {
    ...
    static const decltype(::network::mojom::StoredTrustTokensForIssuer::issuer)& issuer(const ::network::mojom::StoredTrustTokensForIssuerPtr& input) { return input->issuer; }

    static decltype(::network::mojom::StoredTrustTokensForIssuer::count) count(const ::network::mojom::StoredTrustTokensForIssuerPtr& input) { return input->count; }
