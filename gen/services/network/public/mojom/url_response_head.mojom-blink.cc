...
URLResponseHead::URLResponseHead(::base::Time request_time_in, ::base::Time response_time_in, ::network::mojom::blink::HttpResponseHeadersPtr headers_in,
    const WTF::String& mime_type_in, const WTF::String& charset_in, ::network::mojom::blink::CTPolicyCompliance ct_policy_compliance_in, int64_t content_length_in,
    int64_t encoded_data_length_in, int64_t encoded_body_length_in, bool network_accessed_in, ::network::mojom::blink::LoadTimingInfoPtr load_timing_in, bool emitted_extra_info_in,
