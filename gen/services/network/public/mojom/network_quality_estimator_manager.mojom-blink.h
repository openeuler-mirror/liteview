...
//
//   void OnNetworkQualityChanged(::network::mojom::blink::EffectiveConnectionType type, ::base::TimeDelta http_rtt, ::base::TimeDelta transport_rtt, int32_t
//   downlink_bandwidth_kbps) final;
//
//  private:
