...
//
//   void AddEntry(uint32_t type, uint32_t source_type, uint32_t source_id, ::base::TimeTicks source_start_time, ::net::NetLogEventPhase phase, ::base::TimeTicks time,
//   ::base::Value params) final;
//
//  private:
//   mojo::MessageReceiverWithResponder* receiver_;
// };
