...
std::ostream& operator<<(std::ostream& os, ReferrerPolicy value) { return os << ReferrerPolicyToString(value); }
...
std::ostream& operator<<(std::ostream& os, URLRequestReferrerPolicy value) { return os << URLRequestReferrerPolicyToString(value); }
...
// static
void TraceFormatTraits<::network::mojom::URLRequestReferrerPolicy>::WriteIntoTrace(perfetto::TracedValue context, ::network::mojom::URLRequestReferrerPolicy value)
{
