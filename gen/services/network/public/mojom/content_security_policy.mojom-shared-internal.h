...
template <typename UserType, typename DataView> struct ContentSecurityPolicyHeader_UnserializedMessageContext : public mojo::internal::UnserializedMessageContext {
public:
...
template <typename UserType, typename DataView> const mojo::internal::UnserializedMessageContext::Tag CSPSource_UnserializedMessageContext<UserType, DataView>::kMessageTag = {};
class CSPHashSource_Data {
public:
    static bool Validate(const void* data, mojo::internal::ValidationContext* validation_context);
...
template <typename UserType, typename DataView> const mojo::internal::UnserializedMessageContext::Tag CSPViolation_UnserializedMessageContext<UserType, DataView>::kMessageTag = {};
