...
NetworkInterface::NetworkInterface(const std::string& name_in, const std::string& friendly_name_in, uint32_t interface_index_in, ::network::mojom::ConnectionType type_in,
