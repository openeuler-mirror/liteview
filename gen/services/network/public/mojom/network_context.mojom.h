...
// with not having this data in traces there.
    ...
    virtual void OnFallback(const ::net::ProxyServer& bad_proxy, int32_t net_error) = 0;

    virtual void OnTunnelHeadersReceived(const ::net::ProxyServer& proxy_server, const ::scoped_refptr<::net::HttpResponseHeaders>& response_headers) = 0;
};
...
// with not having this data in traces there.
    ...
    using OnHeadersReceivedCallback = base::OnceCallback<void(int32_t, const absl::optional<std::string>&, const absl::optional<::GURL>&)>;
...
// with not having this data in traces there.
    ...
    using OnTrustTokenIssuanceDivertedToSystemCallback = base::OnceCallback<void(::network::mojom::FulfillTrustTokenIssuanceAnswerPtr)>;

    virtual void OnTrustTokenIssuanceDivertedToSystem(::network::mojom::FulfillTrustTokenIssuanceRequestPtr request, OnTrustTokenIssuanceDivertedToSystemCallback callback) = 0;
...
// with not having this data in traces there.
    ...
    virtual void GetTrustTokenQueryAnswerer(::mojo::PendingReceiver<::network::mojom::TrustTokenQueryAnswerer> trust_token_query_answerer, const ::url::Origin& top_frame_origin)
        = 0;
    ...
    virtual void SetDocumentReportingEndpoints(const ::base::UnguessableToken& reporting_source, const ::url::Origin& origin, const ::net::IsolationInfo& isolation_info,
    ...
    virtual void QueueReport(const std::string& type, const std::string& group, const ::GURL& url, const absl::optional<::base::UnguessableToken>& reporting_source,
        const ::net::NetworkAnonymizationKey& network_anonymization_key, const absl::optional<std::string>& user_agent, ::base::Value::Dict body)
        = 0;
    ...
    virtual void AddExpectCT(const std::string& host, ::base::Time expiry, bool enforce, const ::GURL& report_uri, const ::net::NetworkAnonymizationKey& network_anonymization_key,
    ...
    virtual void GetExpectCTState(const std::string& domain, const ::net::NetworkAnonymizationKey& network_anonymization_key, GetExpectCTStateCallback callback) = 0;
    ...
    virtual void CreateTCPServerSocket(const ::net::IPEndPoint& local_addr, uint32_t backlog, const ::net::MutableNetworkTrafficAnnotationTag& traffic_annotation,
        ::mojo::PendingReceiver<::network::mojom::TCPServerSocket> socket, CreateTCPServerSocketCallback callback)
        = 0;
    ...
    virtual void CreateTCPConnectedSocket(const absl::optional<::net::IPEndPoint>& local_addr, const ::net::AddressList& remote_addr_list,
    ...
    virtual void LookUpProxyForURL(
    ...
    virtual void PreconnectSockets(uint32_t num_streams, const ::GURL& url, bool allow_credentials, const ::net::NetworkAnonymizationKey& network_anonymization_key) = 0;
    ...
    virtual void CreateHostResolver(const absl::optional<::net::DnsConfigOverrides>& config_overrides, ::mojo::PendingReceiver<::network::mojom::HostResolver> host_resolver) = 0;
    using VerifyCertForSignedExchangeCallback = base::OnceCallback<void(int32_t, const ::net::CertVerifyResult&, bool, const std::string&)>;

    virtual void VerifyCertForSignedExchange(const ::scoped_refptr<::net::X509Certificate>& certificate, const ::GURL& url,
        const ::net::NetworkAnonymizationKey& network_anonymization_key, const std::string& ocsp_response, const std::string& sct_list,
    ...
    using LookupServerBasicAuthCredentialsCallback = base::OnceCallback<void(const absl::optional<::net::AuthCredentials>&)>;
    ...
    virtual void VerifyCertificateForTesting(const ::scoped_refptr<::net::X509Certificate>& certificate, const std::string& hostname, const std::string& ocsp_response,
        const std::string& sct_list, VerifyCertificateForTestingCallback callback)
        = 0;
    ...
    using ComputeFirstPartySetMetadataCallback = base::OnceCallback<void(::net::FirstPartySetMetadata)>;

    virtual void ComputeFirstPartySetMetadata(const ::net::SchemefulSite& site, const absl::optional<::net::SchemefulSite>& top_frame_site,
...
//
//   void OnFallback(const ::net::ProxyServer& bad_proxy, int32_t net_error) final;
//
//   void OnTunnelHeadersReceived(const ::net::ProxyServer& proxy_server, const ::scoped_refptr<::net::HttpResponseHeaders>& response_headers) final;
//
//  private:
...
//
//   void OnFileUploadRequested(int32_t process_id, bool async, const std::vector<::base::FilePath>& file_paths, const ::GURL& destination_url, OnFileUploadRequestedCallback
//   callback) final;
//
...
//
//   void OnTrustTokenIssuanceDivertedToSystem(::network::mojom::FulfillTrustTokenIssuanceRequestPtr request, OnTrustTokenIssuanceDivertedToSystemCallback callback) final;
//
...
//
//   void GetRestrictedCookieManager(::mojo::PendingReceiver<::network::mojom::RestrictedCookieManager> restricted_cookie_manager, ::network::mojom::RestrictedCookieManagerRole
//   role, const ::url::Origin& origin, const ::net::IsolationInfo& isolation_info, ::mojo::PendingRemote<::network::mojom::CookieAccessObserver> cookie_observer) final;
//
...
//
//   void NotifyExternalCacheHit(const ::GURL& url, const std::string& http_method, const ::net::NetworkIsolationKey& key, bool is_subframe_document_resource, bool
//   include_credentials) final;
//
...
//
//   void SetDocumentReportingEndpoints(const ::base::UnguessableToken& reporting_source, const ::url::Origin& origin, const ::net::IsolationInfo& isolation_info, const
//   base::flat_map<std::string, std::string>& endpoints) final;
//
//   void SendReportsAndRemoveSource(const ::base::UnguessableToken& reporting_source) final;
//
//   void QueueReport(const std::string& type, const std::string& group, const ::GURL& url, const absl::optional<::base::UnguessableToken>& reporting_source, const
//   ::net::NetworkAnonymizationKey& network_anonymization_key, const absl::optional<std::string>& user_agent, ::base::Value::Dict body) final;
//
...
//   AddExpectCTCallback callback) final;
//
//   void SetExpectCTTestReport(const ::GURL& report_uri, SetExpectCTTestReportCallback callback) final;
//
//   void GetExpectCTState(const std::string& domain, const ::net::NetworkAnonymizationKey& network_anonymization_key, GetExpectCTStateCallback callback) final;
//
...
//   ::mojo::PendingReceiver<::network::mojom::TCPServerSocket> socket, CreateTCPServerSocketCallback callback) final;
//
//   void CreateTCPConnectedSocket(const absl::optional<::net::IPEndPoint>& local_addr, const ::net::AddressList& remote_addr_list, ::network::mojom::TCPConnectedSocketOptionsPtr
//   tcp_connected_socket_options, const ::net::MutableNetworkTrafficAnnotationTag& traffic_annotation, ::mojo::PendingReceiver<::network::mojom::TCPConnectedSocket> socket,
//   ::mojo::PendingRemote<::network::mojom::SocketObserver> observer, CreateTCPConnectedSocketCallback callback) final;
//
...
//
//   void LookUpProxyForURL(const ::GURL& url, const ::net::NetworkAnonymizationKey& network_anonymization_key, ::mojo::PendingRemote<::network::mojom::ProxyLookupClient>
//   proxy_lookup_client) final;
//
...
//
//   void CreateWebSocket(const ::GURL& url, const std::vector<std::string>& requested_protocols, const ::net::SiteForCookies& site_for_cookies, const ::net::IsolationInfo&
//   isolation_info, std::vector<::network::mojom::HttpHeaderPtr> additional_headers, int32_t process_id, const ::url::Origin& origin, uint32_t options, const
//   ::net::MutableNetworkTrafficAnnotationTag& traffic_annotation, ::mojo::PendingRemote<::network::mojom::WebSocketHandshakeClient> handshake_client,
//   ::mojo::PendingRemote<::network::mojom::URLLoaderNetworkServiceObserver> url_loader_network_observer, ::mojo::PendingRemote<::network::mojom::WebSocketAuthenticationHandler>
//   auth_handler, ::mojo::PendingRemote<TrustedHeaderClient> header_client, const absl::optional<::base::UnguessableToken>& throttling_profile_id) final;
//
...
//
//   void PreconnectSockets(uint32_t num_streams, const ::GURL& url, bool allow_credentials, const ::net::NetworkAnonymizationKey& network_anonymization_key) final;
//
...
//   ::mojo::PendingReceiver<::network::mojom::P2PTrustedSocketManager> trusted_socket_manager, ::mojo::PendingReceiver<::network::mojom::P2PSocketManager> socket_manager) final;
//
//   void CreateMdnsResponder(::mojo::PendingReceiver<::network::mojom::MdnsResponder> responder_receiver) final;
//
//   void ResolveHost(::network::mojom::HostResolverHostPtr host, const ::net::NetworkAnonymizationKey& network_anonymization_key, ::network::mojom::ResolveHostParametersPtr
//   optional_parameters, ::mojo::PendingRemote<::network::mojom::ResolveHostClient> response_client) final;
//
//   void CreateHostResolver(const absl::optional<::net::DnsConfigOverrides>& config_overrides, ::mojo::PendingReceiver<::network::mojom::HostResolver> host_resolver) final;
//
//   void VerifyCertForSignedExchange(const ::scoped_refptr<::net::X509Certificate>& certificate, const ::GURL& url, const ::net::NetworkAnonymizationKey&
//   network_anonymization_key, const std::string& ocsp_response, const std::string& sct_list, VerifyCertForSignedExchangeCallback callback) final;
//
...
//   AddAuthCacheEntryCallback callback) final;
//
//   void SetCorsNonWildcardRequestHeadersSupport(bool value) final;
//
//   void LookupServerBasicAuthCredentials(const ::GURL& url, const ::net::NetworkAnonymizationKey& network_anonymization_key, LookupServerBasicAuthCredentialsCallback callback)
//   final;
//
...
//
//   void VerifyCertificateForTesting(const ::scoped_refptr<::net::X509Certificate>& certificate, const std::string& hostname, const std::string& ocsp_response, const std::string&
...
//
//   void ComputeFirstPartySetMetadata(const ::net::SchemefulSite& site, const absl::optional<::net::SchemefulSite>& top_frame_site, const std::vector<::net::SchemefulSite>&
//   party_context, ComputeFirstPartySetMetadataCallback callback) final;
//
//  private:
//   mojo::MessageReceiverWithResponder* receiver_;
// };
...
public:
    ...
    explicit HttpAuthStaticNetworkContextParams(::net::HttpAuthPreferences::DefaultCredentials allow_default_credentials_in)
...
public:
    ...
    CustomProxyConfig(const ::net::ProxyConfig::ProxyRules& rules_in, bool should_override_existing_config_in, bool allow_non_idempotent_methods_in,
...
public:
    ...
    explicit CertVerifierServiceRemoteParams(::mojo::PendingRemote<::cert_verifier::mojom::CertVerifierService> cert_verifier_service_in)
...
public:
    ...
    CTPolicy(std::vector<std::string> required_hosts_in, std::vector<std::string> excluded_hosts_in, std::vector<std::string> excluded_spkis_in,
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input) { return mojo::internal::SerializeImpl<CTPolicy::DataView, std::vector<uint8_t>>(input); }
...
public:
    ...
    NetworkContextFilePaths(::network::TransferableDirectory data_directory_in, const absl::optional<::base::FilePath>& unsandboxed_data_path_in,
...
public:
    ...
    NetworkContextParams(const std::string& user_agent_in, const std::string& accept_language_in, bool enable_brotli_in, const std::string& quic_user_agent_id_in,
        ...
        ::mojo::PendingRemote<::network::mojom::ProxyErrorClient> proxy_error_client_in, ::mojo::PendingRemote<::network::mojom::SocketBroker> socket_broker_in,
    ...
    absl::optional<::network::TransferableDirectory> http_cache_directory;
    ...
    ::mojo::PendingRemote<::network::mojom::SocketBroker> socket_broker;
...
public:
    ...
    SignedExchangeReport(bool success_in, const std::string& type_in, const ::GURL& outer_url_in, const ::GURL& inner_url_in, const ::GURL& cert_url_in,
...
public:
    ...
    URLLoaderFactoryOverride(::mojo::PendingRemote<::network::mojom::URLLoaderFactory> overriding_factory_in,
...
public:
    ...
    URLLoaderFactoryParams(int32_t process_id_in, const absl::optional<::url::Origin>& request_initiator_origin_lock_in, bool is_corb_enabled_in,
        ...
        URLLoaderFactoryOverridePtr factory_override_in, ::network::mojom::ClientSecurityStatePtr client_security_state_in,
        ...
        ::mojo::PendingRemote<::network::mojom::DevToolsObserver> devtools_observer_in, TrustTokenRedemptionPolicy trust_token_redemption_policy_in,
...
template <> struct StructTraits<::network::mojom::CustomProxyConfig::DataView, ::network::mojom::CustomProxyConfigPtr> {
    ...
    static const decltype(::network::mojom::CustomProxyConfig::rules)& rules(const ::network::mojom::CustomProxyConfigPtr& input) { return input->rules; }

    static decltype(::network::mojom::CustomProxyConfig::should_override_existing_config) should_override_existing_config(const ::network::mojom::CustomProxyConfigPtr& input)
    {
        return input->should_override_existing_config;
    }

    static decltype(::network::mojom::CustomProxyConfig::allow_non_idempotent_methods) allow_non_idempotent_methods(const ::network::mojom::CustomProxyConfigPtr& input)
    {
        return input->allow_non_idempotent_methods;
    }

    static const decltype(::network::mojom::CustomProxyConfig::connect_tunnel_headers)& connect_tunnel_headers(const ::network::mojom::CustomProxyConfigPtr& input)
    {
...
template <> struct StructTraits<::network::mojom::CertVerifierServiceRemoteParams::DataView, ::network::mojom::CertVerifierServiceRemoteParamsPtr> {
    ...
    static decltype(::network::mojom::CertVerifierServiceRemoteParams::cert_verifier_service)& cert_verifier_service(::network::mojom::CertVerifierServiceRemoteParamsPtr& input)
    {
...
template <> struct StructTraits<::network::mojom::CTPolicy::DataView, ::network::mojom::CTPolicyPtr> {
    ...
    static const decltype(::network::mojom::CTPolicy::required_hosts)& required_hosts(const ::network::mojom::CTPolicyPtr& input) { return input->required_hosts; }

    static const decltype(::network::mojom::CTPolicy::excluded_hosts)& excluded_hosts(const ::network::mojom::CTPolicyPtr& input) { return input->excluded_hosts; }

    static const decltype(::network::mojom::CTPolicy::excluded_spkis)& excluded_spkis(const ::network::mojom::CTPolicyPtr& input) { return input->excluded_spkis; }

    static const decltype(::network::mojom::CTPolicy::excluded_legacy_spkis)& excluded_legacy_spkis(const ::network::mojom::CTPolicyPtr& input)
    {
...
template <> struct StructTraits<::network::mojom::NetworkContextFilePaths::DataView, ::network::mojom::NetworkContextFilePathsPtr> {
    ...
    static const decltype(::network::mojom::NetworkContextFilePaths::unsandboxed_data_path)& unsandboxed_data_path(const ::network::mojom::NetworkContextFilePathsPtr& input)
    {
        return input->unsandboxed_data_path;
    }

    static const decltype(::network::mojom::NetworkContextFilePaths::cookie_database_name)& cookie_database_name(const ::network::mojom::NetworkContextFilePathsPtr& input)
    {
...
template <> struct StructTraits<::network::mojom::NetworkContextParams::DataView, ::network::mojom::NetworkContextParamsPtr> {
    ...
    static const decltype(::network::mojom::NetworkContextParams::user_agent)& user_agent(const ::network::mojom::NetworkContextParamsPtr& input) { return input->user_agent; }
    ...
    static decltype(::network::mojom::NetworkContextParams::enable_brotli) enable_brotli(const ::network::mojom::NetworkContextParamsPtr& input) { return input->enable_brotli; }

    static const decltype(::network::mojom::NetworkContextParams::quic_user_agent_id)& quic_user_agent_id(const ::network::mojom::NetworkContextParamsPtr& input)
    {
    ...
    static decltype(::network::mojom::NetworkContextParams::enable_preconnect) enable_preconnect(const ::network::mojom::NetworkContextParamsPtr& input)
    {
    ...
    static decltype(::network::mojom::NetworkContextParams::windows_system_proxy_resolver)& windows_system_proxy_resolver(::network::mojom::NetworkContextParamsPtr& input)
    {
        return input->windows_system_proxy_resolver;
    }

    static decltype(::network::mojom::NetworkContextParams::enable_encrypted_cookies) enable_encrypted_cookies(const ::network::mojom::NetworkContextParamsPtr& input)
    {
        return input->enable_encrypted_cookies;
    }

    static decltype(::network::mojom::NetworkContextParams::restore_old_session_cookies) restore_old_session_cookies(const ::network::mojom::NetworkContextParamsPtr& input)
    {
        return input->restore_old_session_cookies;
    }

    static decltype(::network::mojom::NetworkContextParams::persist_session_cookies) persist_session_cookies(const ::network::mojom::NetworkContextParamsPtr& input)
    {
    ...
    static decltype(::network::mojom::NetworkContextParams::http_cache_directory)& http_cache_directory(::network::mojom::NetworkContextParamsPtr& input)
    {
    ...
    static const decltype(::network::mojom::NetworkContextParams::initial_ssl_config)& initial_ssl_config(const ::network::mojom::NetworkContextParamsPtr& input)
    {
        return input->initial_ssl_config;
    }

    static decltype(::network::mojom::NetworkContextParams::ssl_config_client_receiver)& ssl_config_client_receiver(::network::mojom::NetworkContextParamsPtr& input)
    {
    ...
    static decltype(::network::mojom::NetworkContextParams::proxy_config_client_receiver)& proxy_config_client_receiver(::network::mojom::NetworkContextParamsPtr& input)
    {
        return input->proxy_config_client_receiver;
    }

    static const decltype(::network::mojom::NetworkContextParams::initial_custom_proxy_config)& initial_custom_proxy_config(const ::network::mojom::NetworkContextParamsPtr& input)
    {
    ...
    static decltype(::network::mojom::NetworkContextParams::proxy_config_poller_client)& proxy_config_poller_client(::network::mojom::NetworkContextParamsPtr& input)
    {
    ...
    static decltype(::network::mojom::NetworkContextParams::socket_broker)& socket_broker(::network::mojom::NetworkContextParamsPtr& input) { return input->socket_broker; }

    static decltype(::network::mojom::NetworkContextParams::pac_quick_check_enabled) pac_quick_check_enabled(const ::network::mojom::NetworkContextParamsPtr& input)
    {
        return input->pac_quick_check_enabled;
    }

    static decltype(::network::mojom::NetworkContextParams::enable_certificate_reporting) enable_certificate_reporting(const ::network::mojom::NetworkContextParamsPtr& input)
    {
        return input->enable_certificate_reporting;
    }

    static decltype(::network::mojom::NetworkContextParams::enforce_chrome_ct_policy) enforce_chrome_ct_policy(const ::network::mojom::NetworkContextParamsPtr& input)
    {
        return input->enforce_chrome_ct_policy;
    }

    static decltype(::network::mojom::NetworkContextParams::enable_expect_ct_reporting) enable_expect_ct_reporting(const ::network::mojom::NetworkContextParamsPtr& input)
    {
    ...
    static const decltype(::network::mojom::NetworkContextParams::ct_policy)& ct_policy(const ::network::mojom::NetworkContextParamsPtr& input) { return input->ct_policy; }
    ...
    static const decltype(::network::mojom::NetworkContextParams::cookie_manager_params)& cookie_manager_params(const ::network::mojom::NetworkContextParamsPtr& input)
    {
        return input->cookie_manager_params;
    }

    static decltype(::network::mojom::NetworkContextParams::enable_domain_reliability) enable_domain_reliability(const ::network::mojom::NetworkContextParamsPtr& input)
    {
    ...
    static const decltype(::network::mojom::NetworkContextParams::reporting_delivery_interval)& reporting_delivery_interval(const ::network::mojom::NetworkContextParamsPtr& input)
    {
    ...
    static const decltype(::network::mojom::NetworkContextParams::cors_origin_access_list)& cors_origin_access_list(const ::network::mojom::NetworkContextParamsPtr& input)
    {
        return input->cors_origin_access_list;
    }

    static const decltype(::network::mojom::NetworkContextParams::cors_exempt_header_list)& cors_exempt_header_list(const ::network::mojom::NetworkContextParamsPtr& input)
    {
    ...
    static const decltype(::network::mojom::NetworkContextParams::hsts_policy_bypass_list)& hsts_policy_bypass_list(const ::network::mojom::NetworkContextParamsPtr& input)
    {
    ...
    static decltype(::network::mojom::NetworkContextParams::reset_http_cache_backend) reset_http_cache_backend(const ::network::mojom::NetworkContextParamsPtr& input)
    {
    ...
    static decltype(::network::mojom::NetworkContextParams::require_network_isolation_key) require_network_isolation_key(const ::network::mojom::NetworkContextParamsPtr& input)
    {
        return input->require_network_isolation_key;
    }

    static decltype(::network::mojom::NetworkContextParams::file_paths)& file_paths(::network::mojom::NetworkContextParamsPtr& input) { return input->file_paths; }
...
template <> struct StructTraits<::network::mojom::NetworkConditions::DataView, ::network::mojom::NetworkConditionsPtr> {
    ...
    static decltype(::network::mojom::NetworkConditions::offline) offline(const ::network::mojom::NetworkConditionsPtr& input) { return input->offline; }

    static const decltype(::network::mojom::NetworkConditions::latency)& latency(const ::network::mojom::NetworkConditionsPtr& input) { return input->latency; }
...
template <> struct StructTraits<::network::mojom::ClearDataFilter::DataView, ::network::mojom::ClearDataFilterPtr> {
    ...
    static decltype(::network::mojom::ClearDataFilter::type) type(const ::network::mojom::ClearDataFilterPtr& input) { return input->type; }

    static const decltype(::network::mojom::ClearDataFilter::domains)& domains(const ::network::mojom::ClearDataFilterPtr& input) { return input->domains; }

    static const decltype(::network::mojom::ClearDataFilter::origins)& origins(const ::network::mojom::ClearDataFilterPtr& input) { return input->origins; }
...
template <> struct StructTraits<::network::mojom::SignedExchangeReport::DataView, ::network::mojom::SignedExchangeReportPtr> {
    ...
    static decltype(::network::mojom::SignedExchangeReport::success) success(const ::network::mojom::SignedExchangeReportPtr& input) { return input->success; }

    static const decltype(::network::mojom::SignedExchangeReport::type)& type(const ::network::mojom::SignedExchangeReportPtr& input) { return input->type; }

    static const decltype(::network::mojom::SignedExchangeReport::outer_url)& outer_url(const ::network::mojom::SignedExchangeReportPtr& input) { return input->outer_url; }

    static const decltype(::network::mojom::SignedExchangeReport::inner_url)& inner_url(const ::network::mojom::SignedExchangeReportPtr& input) { return input->inner_url; }

    static const decltype(::network::mojom::SignedExchangeReport::cert_url)& cert_url(const ::network::mojom::SignedExchangeReportPtr& input) { return input->cert_url; }

    static const decltype(::network::mojom::SignedExchangeReport::referrer)& referrer(const ::network::mojom::SignedExchangeReportPtr& input) { return input->referrer; }
    ...
    static const decltype(::network::mojom::SignedExchangeReport::protocol)& protocol(const ::network::mojom::SignedExchangeReportPtr& input) { return input->protocol; }

    static const decltype(::network::mojom::SignedExchangeReport::method)& method(const ::network::mojom::SignedExchangeReportPtr& input) { return input->method; }

    static decltype(::network::mojom::SignedExchangeReport::status_code) status_code(const ::network::mojom::SignedExchangeReportPtr& input) { return input->status_code; }
...
template <> struct StructTraits<::network::mojom::URLLoaderFactoryOverride::DataView, ::network::mojom::URLLoaderFactoryOverridePtr> {
    ...
    static decltype(::network::mojom::URLLoaderFactoryOverride::overridden_factory_receiver)& overridden_factory_receiver(::network::mojom::URLLoaderFactoryOverridePtr& input)
    {
...
template <> struct StructTraits<::network::mojom::URLLoaderFactoryParams::DataView, ::network::mojom::URLLoaderFactoryParamsPtr> {
    ...
    static decltype(::network::mojom::URLLoaderFactoryParams::process_id) process_id(const ::network::mojom::URLLoaderFactoryParamsPtr& input) { return input->process_id; }
    ...
    static decltype(::network::mojom::URLLoaderFactoryParams::is_corb_enabled) is_corb_enabled(const ::network::mojom::URLLoaderFactoryParamsPtr& input)
    {
        return input->is_corb_enabled;
    }

    static decltype(::network::mojom::URLLoaderFactoryParams::ignore_isolated_world_origin) ignore_isolated_world_origin(const ::network::mojom::URLLoaderFactoryParamsPtr& input)
    {
        return input->ignore_isolated_world_origin;
    }

    static decltype(::network::mojom::URLLoaderFactoryParams::unsafe_non_webby_initiator) unsafe_non_webby_initiator(const ::network::mojom::URLLoaderFactoryParamsPtr& input)
    {
        return input->unsafe_non_webby_initiator;
    }

    static decltype(::network::mojom::URLLoaderFactoryParams::disable_web_security) disable_web_security(const ::network::mojom::URLLoaderFactoryParamsPtr& input)
    {
        return input->disable_web_security;
    }

    static decltype(::network::mojom::URLLoaderFactoryParams::header_client)& header_client(::network::mojom::URLLoaderFactoryParamsPtr& input) { return input->header_client; }
    ...
    static decltype(::network::mojom::URLLoaderFactoryParams::is_trusted) is_trusted(const ::network::mojom::URLLoaderFactoryParamsPtr& input) { return input->is_trusted; }
    ...
    static decltype(::network::mojom::URLLoaderFactoryParams::provide_loading_state_updates) provide_loading_state_updates(const ::network::mojom::URLLoaderFactoryParamsPtr& input)
    {
    ...
    static const decltype(::network::mojom::URLLoaderFactoryParams::client_security_state)& client_security_state(const ::network::mojom::URLLoaderFactoryParamsPtr& input)
    {
        return input->client_security_state;
    }

    static decltype(::network::mojom::URLLoaderFactoryParams::coep_reporter)& coep_reporter(::network::mojom::URLLoaderFactoryParamsPtr& input) { return input->coep_reporter; }
    ...
    static decltype(::network::mojom::URLLoaderFactoryParams::url_loader_network_observer)& url_loader_network_observer(::network::mojom::URLLoaderFactoryParamsPtr& input)
    {
    ...
    static decltype(::network::mojom::URLLoaderFactoryParams::trust_token_redemption_policy) trust_token_redemption_policy(const ::network::mojom::URLLoaderFactoryParamsPtr& input)
    {
        return input->trust_token_redemption_policy;
    }

    static const decltype(::network::mojom::URLLoaderFactoryParams::debug_tag)& debug_tag(const ::network::mojom::URLLoaderFactoryParamsPtr& input) { return input->debug_tag; }
