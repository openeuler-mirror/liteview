...
struct network_mojom_internal_XFrameOptionsValue_DataHashFn {
    ...
    static bool Equal(const ::network::mojom::XFrameOptionsValue& left, const ::network::mojom::XFrameOptionsValue& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::network::mojom::XFrameOptionsValue> : public GenericHashTraits<::network::mojom::XFrameOptionsValue> {
    ...
    static void ConstructDeletedValue(::network::mojom::XFrameOptionsValue& slot, bool) { slot = static_cast<::network::mojom::XFrameOptionsValue>(-1000001); }
    static bool IsDeletedValue(const ::network::mojom::XFrameOptionsValue& value) { return value == static_cast<::network::mojom::XFrameOptionsValue>(-1000001); }
};
} // namespace WTF
namespace network {
namespace mojom {
