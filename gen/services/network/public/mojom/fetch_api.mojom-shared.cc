...
std::ostream& operator<<(std::ostream& os, RequestMode value) { return os << RequestModeToString(value); }
...
std::ostream& operator<<(std::ostream& os, RequestDestination value) { return os << RequestDestinationToString(value); }
...
std::ostream& operator<<(std::ostream& os, RedirectMode value) { return os << RedirectModeToString(value); }
...
std::ostream& operator<<(std::ostream& os, CredentialsMode value) { return os << CredentialsModeToString(value); }
...
std::ostream& operator<<(std::ostream& os, FetchResponseType value) { return os << FetchResponseTypeToString(value); }
...
std::ostream& operator<<(std::ostream& os, FetchResponseSource value) { return os << FetchResponseSourceToString(value); }
