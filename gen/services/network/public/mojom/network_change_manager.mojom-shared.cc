...
std::ostream& operator<<(std::ostream& os, ConnectionType value) { return os << ConnectionTypeToString(value); }
...
std::ostream& operator<<(std::ostream& os, ConnectionSubtype value) { return os << ConnectionSubtypeToString(value); }
...
bool NetworkChangeManagerClient_OnNetworkChanged_Params_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    ...
    // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
    // the message comes from an older version.
    [[maybe_unused]] const NetworkChangeManagerClient_OnNetworkChanged_Params_Data* object = static_cast<const NetworkChangeManagerClient_OnNetworkChanged_Params_Data*>(data);
    if (!::network::mojom::internal::ConnectionType_Data ::Validate(object->type, validation_context))
        return false;
...
bool NetworkChangeManager_RequestNotifications_Params_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    ...
    // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
    // the message comes from an older version.
    [[maybe_unused]] const NetworkChangeManager_RequestNotifications_Params_Data* object = static_cast<const NetworkChangeManager_RequestNotifications_Params_Data*>(data);
