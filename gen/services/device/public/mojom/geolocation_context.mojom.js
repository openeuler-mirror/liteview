...
(function() {
  ...
  GeolocationContext_BindGeolocation_Params.validate = function(messageValidator, offset) {
    ...
    if (err !== validator.validationError.NONE)
        return err;
    // validate GeolocationContext_BindGeolocation_Params.url
  ...
  var kGeolocationContext_BindGeolocation_Name = 866316424;
  var kGeolocationContext_SetOverride_Name = 2064737426;
  var kGeolocationContext_ClearOverride_Name = 794515391;
  ...
  GeolocationContextProxy.prototype.bindGeolocation = function(receiver, url) {
  ...
  GeolocationContextStub.prototype.bindGeolocation = function(receiver, url) {
    return this.delegate_ && this.delegate_.bindGeolocation && this.delegate_.bindGeolocation(receiver, url);
  }
  ...
  GeolocationContextStub.prototype.accept = function(message) {
    ...
    case kGeolocationContext_BindGeolocation_Name:
      ...
      this.bindGeolocation(params.receiver, params.url);
      return true;
