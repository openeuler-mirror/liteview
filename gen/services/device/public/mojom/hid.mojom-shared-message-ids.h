...
constexpr uint32_t kHidManagerClient_DeviceChanged_Name = 2;
...
constexpr uint32_t kHidManager_AddReceiver_Name = 3;
...
constexpr uint32_t kHidConnectionClient_OnInputReport_Name = 0;
