...
public:
    ...
    {
        UserType result;
        bool ret = mojo::internal::Deserialize<mojo::InterfacePtrDataView<::device::mojom::SerialPortManagerClientInterfaceBase>>(&data_->client, &result, message_);
        DCHECK(ret);
        return result;
    }
...
public:
    ...
    bool use_alternate_path() const { return data_->use_alternate_path; }
    ...
    {
        UserType result;
        bool ret = mojo::internal::Deserialize<mojo::InterfacePtrDataView<::device::mojom::SerialPortConnectionWatcherInterfaceBase>>(&data_->watcher, &result, message_);
        DCHECK(ret);
        return result;
    }
...
public:
    ...
    SerialPortFlushMode mode() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::device::mojom::SerialPortFlushMode>(data_->mode)); }
...
public:
    ...
    bool is_null() const { return !data_; }
    bool flush() const { return data_->flush; }
...
public:
    ...
    SerialReceiveError error() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::device::mojom::SerialReceiveError>(data_->error)); }
...
public:
    ...
    SerialSendError error() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::device::mojom::SerialSendError>(data_->error)); }
