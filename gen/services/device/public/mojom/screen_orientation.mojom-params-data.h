...
static_assert(sizeof(ScreenOrientationListener_IsAutoRotateEnabledByUser_Params_Data) == 8, "Bad sizeof(ScreenOrientationListener_IsAutoRotateEnabledByUser_Params_Data)");
...
static_assert(
    sizeof(ScreenOrientationListener_IsAutoRotateEnabledByUser_ResponseParams_Data) == 16, "Bad sizeof(ScreenOrientationListener_IsAutoRotateEnabledByUser_ResponseParams_Data)");
...
public:
    ...
    ScreenOrientationListener_IsAutoRotateEnabledByUser_ParamsDataView(internal::ScreenOrientationListener_IsAutoRotateEnabledByUser_Params_Data* data, mojo::Message* message)
        : data_(data)
    {
    }
