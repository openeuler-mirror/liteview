...
std::ostream& operator<<(std::ostream& os, ScreenOrientationLockResult value) { return os << ScreenOrientationLockResultToString(value); }
...
std::ostream& operator<<(std::ostream& os, ScreenOrientationLockType value) { return os << ScreenOrientationLockTypeToString(value); }
...
// static
void TraceFormatTraits<::device::mojom::ScreenOrientationLockResult>::WriteIntoTrace(perfetto::TracedValue context, ::device::mojom::ScreenOrientationLockResult value)
{
...
// static
void TraceFormatTraits<::device::mojom::ScreenOrientationLockType>::WriteIntoTrace(perfetto::TracedValue context, ::device::mojom::ScreenOrientationLockType value)
{
