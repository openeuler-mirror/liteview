...
#ifndef SERVICES_DEVICE_PUBLIC_MOJOM_PRESSURE_UPDATE_MOJOM_BLINK_JUMBO_H_
#define SERVICES_DEVICE_PUBLIC_MOJOM_PRESSURE_UPDATE_MOJOM_BLINK_JUMBO_H_
#endif
...
PressureUpdate::PressureUpdate(PressureState state_in, WTF::Vector<PressureFactor> factors_in, ::base::Time timestamp_in)
...
void PressureUpdate::WriteIntoTrace(perfetto::TracedValue traced_context) const
{
    ...
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("factors"), this->factors,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
        "<value of type const WTF::Vector<PressureFactor>&>"
#else
        "<value>"
#endif // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
bool PressureUpdate::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
} // namespace blink
} // namespace mojom
} // namespace device
namespace mojo {
    ...
    ::device::mojom::blink::PressureUpdate::DataView input, ::device::mojom::blink::PressureUpdatePtr* output)
{
    ...
    if (success && !input.ReadState(&result->state))
        success = false;
    if (success && !input.ReadFactors(&result->factors))
        success = false;
