...
static_assert(sizeof(Fingerprint_GetRecordsForUser_ResponseParams_Data) == 16, "Bad sizeof(Fingerprint_GetRecordsForUser_ResponseParams_Data)");
...
static_assert(sizeof(Fingerprint_CancelCurrentEnrollSession_ResponseParams_Data) == 16, "Bad sizeof(Fingerprint_CancelCurrentEnrollSession_ResponseParams_Data)");
...
public:
    ...
    ScanResult scan_result() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::device::mojom::ScanResult>(data_->scan_result)); }
    bool is_complete() const { return data_->is_complete; }
    int32_t percent_complete() const { return data_->percent_complete; }
...
public:
    ...
    Fingerprint_CancelCurrentEnrollSession_ResponseParamsDataView(internal::Fingerprint_CancelCurrentEnrollSession_ResponseParams_Data* data, mojo::Message* message)
        : data_(data)
    {
    }
...
public:
    ...
    {
        UserType result;
        bool ret = mojo::internal::Deserialize<mojo::InterfacePtrDataView<::device::mojom::FingerprintObserverInterfaceBase>>(&data_->observer, &result, message_);
        DCHECK(ret);
        return result;
    }
...
public:
    ...
    BiometricType type() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::device::mojom::BiometricType>(data_->type)); }
...
inline void FingerprintObserver_OnAuthScanDone_ParamsDataView::GetMatchesDataView(mojo::MapDataView<mojo::StringDataView, mojo::ArrayDataView<mojo::StringDataView>>* output)
{
    auto pointer = data_->matches.Get();
