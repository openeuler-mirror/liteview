...
void GeolocationControlProxy::UserDidOptIntoLocationServices()
{
    ...
    mojo::Message message(internal::kGeolocationControl_UserDidOptIntoLocationServices_Name, kFlags, 0, 0, nullptr);
...
// static
bool GeolocationControlStubDispatch::AcceptWithResponder(GeolocationControl* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
{
...
static const std::pair<uint32_t, mojo::internal::GenericValidationInfo> kGeolocationControlValidationInfo[] = {
    { internal::kGeolocationControl_UserDidOptIntoLocationServices_Name,
...
bool GeolocationControlRequestValidator::Accept(mojo::Message* message)
{
    ...
    return mojo::internal::ValidateRequestGeneric(message, name, kGeolocationControlValidationInfo);
}
...
namespace mojom {
namespace blink {
void GeolocationControlInterceptorForTesting::UserDidOptIntoLocationServices() { GetForwardingInterface()->UserDidOptIntoLocationServices(); }
