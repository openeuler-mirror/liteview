...
public:
    ...
    void GetRecordsForUser(const std::string& user_id, base::flat_map<std::string, std::string>* out_records);
    base::flat_map<std::string, std::string> GetRecordsForUser(const std::string& user_id);
