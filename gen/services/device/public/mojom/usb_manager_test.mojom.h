...
public:
    ...
    template <typename... Args> static TestDeviceInfoPtr New(Args&&... args) { return TestDeviceInfoPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static TestDeviceInfoPtr From(const U& u) { return mojo::TypeConverter<TestDeviceInfoPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, TestDeviceInfo>::Convert(*this); }
    TestDeviceInfo()
        : guid()
        , name()
        , serial_number()
    ...
    TestDeviceInfo(const std::string& guid_in, const std::string& name_in, const std::string& serial_number_in, const ::GURL& landing_page_in)
        : guid(std::move(guid_in))
        , name(std::move(name_in))
        , serial_number(std::move(serial_number_in))
        , landing_page(std::move(landing_page_in)) {};
    ~TestDeviceInfo() = default;
    ...
    template <typename T, TestDeviceInfo::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    ...
    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<TestDeviceInfo::DataView>(input); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::TestDeviceInfo_UnserializedMessageContext<UserType, TestDeviceInfo::DataView>>(0, 0, std::move(input)), MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    {
        return TestDeviceInfo::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, TestDeviceInfo::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, TestDeviceInfo::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, TestDeviceInfo::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
template <> struct StructTraits<::device::mojom::TestDeviceInfo::DataView, ::device::mojom::TestDeviceInfoPtr> {
    ...
    static const decltype(::device::mojom::TestDeviceInfo::guid)& guid(const ::device::mojom::TestDeviceInfoPtr& input) { return input->guid; }

    static const decltype(::device::mojom::TestDeviceInfo::name)& name(const ::device::mojom::TestDeviceInfoPtr& input) { return input->name; }

    static const decltype(::device::mojom::TestDeviceInfo::serial_number)& serial_number(const ::device::mojom::TestDeviceInfoPtr& input) { return input->serial_number; }

    static const decltype(::device::mojom::TestDeviceInfo::landing_page)& landing_page(const ::device::mojom::TestDeviceInfoPtr& input) { return input->landing_page; }
