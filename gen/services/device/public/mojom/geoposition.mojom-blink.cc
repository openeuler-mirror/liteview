...
#ifndef SERVICES_DEVICE_PUBLIC_MOJOM_GEOPOSITION_MOJOM_BLINK_JUMBO_H_
#define SERVICES_DEVICE_PUBLIC_MOJOM_GEOPOSITION_MOJOM_BLINK_JUMBO_H_
#endif
...
Geoposition::Geoposition(bool valid_in, double latitude_in, double longitude_in, double altitude_in, double accuracy_in, double altitude_accuracy_in, double heading_in,
    double speed_in, ::base::Time timestamp_in, Geoposition::ErrorCode error_code_in, const WTF::String& error_message_in, const WTF::String& error_technical_in)
