...
public:
    ...
    void GetRecordsForUser(const WTF::String& user_id, WTF::HashMap<WTF::String, WTF::String>* out_records);
    WTF::HashMap<WTF::String, WTF::String> GetRecordsForUser(const WTF::String& user_id);
