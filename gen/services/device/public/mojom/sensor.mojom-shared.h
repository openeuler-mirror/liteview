...
enum class SensorType : int32_t {
    ...
    ABSOLUTE_ORIENTATION_EULER_ANGLES = 8,

    ABSOLUTE_ORIENTATION_QUATERNION = 9,

    RELATIVE_ORIENTATION_EULER_ANGLES = 10,

    RELATIVE_ORIENTATION_QUATERNION = 11,
    kMinValue = 0,
    kMaxValue = 11,
};

std::ostream& operator<<(std::ostream& os, SensorType value);
inline bool IsKnownEnumValue(SensorType value) { return internal::SensorType_Data::IsKnownValue(static_cast<int32_t>(value)); }
...
inline bool IsKnownEnumValue(ReportingMode value) { return internal::ReportingMode_Data::IsKnownValue(static_cast<int32_t>(value)); }
...
public:
    ...
    double frequency() const { return data_->frequency; }
