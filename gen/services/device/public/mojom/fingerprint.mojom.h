...
template <> struct UnionTraits<::device::mojom::FingerprintMessage::DataView, ::device::mojom::FingerprintMessagePtr> {
    static bool IsNull(const ::device::mojom::FingerprintMessagePtr& input) { return !input; }
    static void SetToNull(::device::mojom::FingerprintMessagePtr* output) { output->reset(); }

    static ::device::mojom::FingerprintMessage::Tag GetTag(const ::device::mojom::FingerprintMessagePtr& input) { return input->which(); }

    static ::device::mojom::FingerprintError fingerprint_error(const ::device::mojom::FingerprintMessagePtr& input) { return input->get_fingerprint_error(); }

    static ::device::mojom::ScanResult scan_result(const ::device::mojom::FingerprintMessagePtr& input) { return input->get_scan_result(); }
