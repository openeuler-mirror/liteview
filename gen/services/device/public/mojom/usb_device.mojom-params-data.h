...
static_assert(sizeof(UsbDevice_Open_ResponseParams_Data) == 16, "Bad sizeof(UsbDevice_Open_ResponseParams_Data)");
...
static_assert(sizeof(UsbDevice_SetInterfaceAlternateSetting_ResponseParams_Data) == 16, "Bad sizeof(UsbDevice_SetInterfaceAlternateSetting_ResponseParams_Data)");
...
public:
    ...
    template <typename UserType> [[nodiscard]] bool ReadError(UserType* output) const
    {
        ...
        return mojo::internal::Deserialize<::device::mojom::UsbOpenDeviceError>(data_value, output);
    }
    UsbOpenDeviceError error() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::device::mojom::UsbOpenDeviceError>(data_->error)); }
...
public:
    ...
    bool is_null() const { return !data_; }
    uint8_t value() const { return data_->value; }
...
public:
    ...
    UsbClaimInterfaceResult result() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::device::mojom::UsbClaimInterfaceResult>(data_->result)); }
...
public:
    ...
    UsbDevice_SetInterfaceAlternateSetting_ResponseParamsDataView(internal::UsbDevice_SetInterfaceAlternateSetting_ResponseParams_Data* data, mojo::Message* message)
        : data_(data)
    {
    }
