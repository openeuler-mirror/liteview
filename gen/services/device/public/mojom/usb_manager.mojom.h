...
// with not having this data in traces there.
    ...
    virtual void GetDevice(const std::string& guid, const std::vector<uint8_t>& blocked_interface_classes, ::mojo::PendingReceiver<::device::mojom::UsbDevice> device_receiver,
        ::mojo::PendingRemote<::device::mojom::UsbDeviceClient> device_client)
        = 0;

    virtual void GetSecurityKeyDevice(
...
//
//   void GetDevice(const std::string& guid, const std::vector<uint8_t>& blocked_interface_classes, ::mojo::PendingReceiver<::device::mojom::UsbDevice> device_receiver,
//   ::mojo::PendingRemote<::device::mojom::UsbDeviceClient> device_client) final;
//
//   void GetSecurityKeyDevice(const std::string& guid, ::mojo::PendingReceiver<::device::mojom::UsbDevice> device_receiver, ::mojo::PendingRemote<::device::mojom::UsbDeviceClient>
//   device_client) final;
//
