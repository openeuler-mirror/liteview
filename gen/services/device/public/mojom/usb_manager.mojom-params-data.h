...
static_assert(sizeof(UsbDeviceManager_EnumerateDevicesAndSetClient_ResponseParams_Data) == 16, "Bad sizeof(UsbDeviceManager_EnumerateDevicesAndSetClient_ResponseParams_Data)");
...
public:
    ...
    UsbDeviceManager_EnumerateDevicesAndSetClient_ParamsDataView(internal::UsbDeviceManager_EnumerateDevicesAndSetClient_Params_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
...
public:
    ...
    UsbDeviceManager_EnumerateDevicesAndSetClient_ResponseParamsDataView(internal::UsbDeviceManager_EnumerateDevicesAndSetClient_ResponseParams_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
...
public:
    ...
    {
        UserType result;
        bool ret = mojo::internal::Deserialize<mojo::InterfaceRequestDataView<::device::mojom::UsbDeviceInterfaceBase>>(&data_->device_receiver, &result, message_);
        DCHECK(ret);
        return result;
    }
    ...
    {
        UserType result;
        bool ret = mojo::internal::Deserialize<mojo::InterfacePtrDataView<::device::mojom::UsbDeviceClientInterfaceBase>>(&data_->device_client, &result, message_);
        DCHECK(ret);
        return result;
    }
...
inline void UsbDeviceManager_EnumerateDevicesAndSetClient_ResponseParamsDataView::GetResultsDataView(mojo::ArrayDataView<::device::mojom::UsbDeviceInfoDataView>* output)
{
    auto pointer = data_->results.Get();
