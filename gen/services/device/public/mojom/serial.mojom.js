...
(function() {
  ...
  SerialPortInfo.validate = function(messageValidator, offset) {
    ...
    if (err !== validator.validationError.NONE)
        return err;
    // validate SerialPortInfo.deviceInstanceId
  ...
  SerialPortInfo.encodedSize = codec.kStructHeaderSize + 56;
  ...
  SerialPortInfo.encode = function(encoder, val) {
    ...
    encoder.skip(1);
    encoder.encodeStruct(codec.String, val.deviceInstanceId);
  ...
  var kSerialPortManager_SetClient_Name = 1131963217;
  var kSerialPortManager_GetDevices_Name = 1920117048;
  var kSerialPortManager_OpenPort_Name = 543277792;
  ...
  var kSerialPortManagerClient_OnPortAdded_Name = 874007780;
  var kSerialPortManagerClient_OnPortRemoved_Name = 547107632;
  ...
  var kSerialPort_StartWriting_Name = 1848660862;
  var kSerialPort_StartReading_Name = 1963818141;
  var kSerialPort_Flush_Name = 1288877685;
  var kSerialPort_Drain_Name = 1913904246;
  var kSerialPort_GetControlSignals_Name = 323111395;
  var kSerialPort_SetControlSignals_Name = 513186721;
  var kSerialPort_ConfigurePort_Name = 1053751094;
  var kSerialPort_GetPortInfo_Name = 1899883795;
  var kSerialPort_Close_Name = 34106423;
  ...
  var kSerialPortClient_OnReadError_Name = 1852670207;
  var kSerialPortClient_OnSendError_Name = 136878569;
