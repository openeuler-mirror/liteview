...
static_assert(sizeof(UsbDeviceManagerTest_AddDeviceForTesting_ResponseParams_Data) == 24, "Bad sizeof(UsbDeviceManagerTest_AddDeviceForTesting_ResponseParams_Data)");
...
static_assert(sizeof(UsbDeviceManagerTest_RemoveDeviceForTesting_ResponseParams_Data) == 8, "Bad sizeof(UsbDeviceManagerTest_RemoveDeviceForTesting_ResponseParams_Data)");
...
public:
    ...
    UsbDeviceManagerTest_AddDeviceForTesting_ResponseParamsDataView(internal::UsbDeviceManagerTest_AddDeviceForTesting_ResponseParams_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
...
public:
    ...
    UsbDeviceManagerTest_RemoveDeviceForTesting_ResponseParamsDataView(internal::UsbDeviceManagerTest_RemoveDeviceForTesting_ResponseParams_Data* data, mojo::Message* message)
        : data_(data)
    {
    }
