...
class HidManagerInterceptorForTesting : public HidManager {
    ...
    void Connect(const std::string& device_guid, ::mojo::PendingRemote<HidConnectionClient> connection_client, ::mojo::PendingRemote<HidConnectionWatcher> watcher,
...
public:
    ...
    void Read(bool* out_success, uint8_t* out_report_id, absl::optional<std::vector<uint8_t>>* out_buffer);
    ...
    void GetFeatureReport(uint8_t report_id, bool* out_success, absl::optional<std::vector<uint8_t>>* out_buffer);
