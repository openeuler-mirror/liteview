...
template <typename UserType, typename DataView> const mojo::internal::UnserializedMessageContext::Tag NDEFError_UnserializedMessageContext<UserType, DataView>::kMessageTag = {};
class NDEFRecord_Data {
public:
    static bool Validate(const void* data, mojo::internal::ValidationContext* validation_context);
...
template <typename UserType, typename DataView> const mojo::internal::UnserializedMessageContext::Tag NDEFRecord_UnserializedMessageContext<UserType, DataView>::kMessageTag = {};
class NDEFMessage_Data {
public:
    static bool Validate(const void* data, mojo::internal::ValidationContext* validation_context);
...
template <typename UserType, typename DataView> const mojo::internal::UnserializedMessageContext::Tag NDEFMessage_UnserializedMessageContext<UserType, DataView>::kMessageTag = {};
class NDEFWriteOptions_Data {
public:
    static bool Validate(const void* data, mojo::internal::ValidationContext* validation_context);
