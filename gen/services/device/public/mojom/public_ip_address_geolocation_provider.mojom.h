...
// with not having this data in traces there.
    ...
    virtual void CreateGeolocation(const ::net::MutablePartialNetworkTrafficAnnotationTag& tag, ::mojo::PendingReceiver<::device::mojom::Geolocation> receiver) = 0;
};
...
//
//   void CreateGeolocation(const ::net::MutablePartialNetworkTrafficAnnotationTag& tag, ::mojo::PendingReceiver<::device::mojom::Geolocation> receiver) final;
//
//  private:
