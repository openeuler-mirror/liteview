...
class BLINK_PLATFORM_EXPORT HidManagerInterceptorForTesting : public HidManager {
    ...
    void Connect(const WTF::String& device_guid, ::mojo::PendingRemote<HidConnectionClient> connection_client, ::mojo::PendingRemote<HidConnectionWatcher> watcher,
        bool allow_protected_reports, bool allow_fido_reports, ConnectCallback callback) override;
...
public:
    ...
    void Connect(const WTF::String& device_guid, ::mojo::PendingRemote<HidConnectionClient> connection_client, ::mojo::PendingRemote<HidConnectionWatcher> watcher,
        bool allow_protected_reports, bool allow_fido_reports, ::mojo::PendingRemote<HidConnection>* out_connection);
...
public:
    ...
    void Read(bool* out_success, uint8_t* out_report_id, absl::optional<WTF::Vector<uint8_t>>* out_buffer);
    ...
    void GetFeatureReport(uint8_t report_id, bool* out_success, absl::optional<WTF::Vector<uint8_t>>* out_buffer);
