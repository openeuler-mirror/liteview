...
void GeolocationConfigProxy::IsHighAccuracyLocationBeingCaptured(IsHighAccuracyLocationBeingCapturedCallback callback)
{
    ...
    mojo::Message message(internal::kGeolocationConfig_IsHighAccuracyLocationBeingCaptured_Name, kFlags, 0, 0, nullptr);
...
public:
    static GeolocationConfig::IsHighAccuracyLocationBeingCapturedCallback CreateCallback(::mojo::Message& message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
    {
...
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send reply device::mojom::GeolocationConfig::IsHighAccuracyLocationBeingCaptured", "async_response_parameters", [&](perfetto::TracedValue context) {
...
// static
bool GeolocationConfigStubDispatch::AcceptWithResponder(GeolocationConfig* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
{
...
static const std::pair<uint32_t, mojo::internal::GenericValidationInfo> kGeolocationConfigValidationInfo[] = {
    { internal::kGeolocationConfig_IsHighAccuracyLocationBeingCaptured_Name,
