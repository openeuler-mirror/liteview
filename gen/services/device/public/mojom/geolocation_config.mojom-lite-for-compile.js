// services/device/public/mojom/geolocation_config.mojom-lite-for-compile.js is auto generated by mojom_bindings_generator.py, do not edit
...
goog.provide('device.mojom.GeolocationConfigReceiver');
goog.provide('device.mojom.GeolocationConfigCallbackRouter');
goog.provide('device.mojom.GeolocationConfigInterface');
goog.provide('device.mojom.GeolocationConfigRemote');
goog.provide('device.mojom.GeolocationConfigPendingReceiver');
/**
...
/** @interface */
device.mojom.GeolocationConfigInterface = class {
...
goog.provide('device.mojom.GeolocationConfig_IsHighAccuracyLocationBeingCaptured_ParamsSpec');
/**
...
goog.provide('device.mojom.GeolocationConfig_IsHighAccuracyLocationBeingCaptured_ResponseParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
