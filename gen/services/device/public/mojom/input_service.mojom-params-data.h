...
static_assert(sizeof(InputDeviceManager_GetDevicesAndSetClient_ResponseParams_Data) == 16, "Bad sizeof(InputDeviceManager_GetDevicesAndSetClient_ResponseParams_Data)");
...
public:
    ...
    InputDeviceManager_GetDevicesAndSetClient_ResponseParamsDataView(internal::InputDeviceManager_GetDevicesAndSetClient_ResponseParams_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
