...
// with not having this data in traces there.
    ...
    virtual void CreateGeolocation(::network::mojom::blink::MutablePartialNetworkTrafficAnnotationTagPtr tag, ::mojo::PendingReceiver<::device::mojom::blink::Geolocation> receiver)
        = 0;
};
...
//
//   void CreateGeolocation(::network::mojom::blink::MutablePartialNetworkTrafficAnnotationTagPtr tag, ::mojo::PendingReceiver<::device::mojom::blink::Geolocation> receiver) final;
//
//  private:
