...
class ProxyResolverInterceptorForTesting : public ProxyResolver {
    ...
    void GetProxyForUrl(const ::GURL& url, const ::net::NetworkAnonymizationKey& network_anonymization_key, ::mojo::PendingRemote<ProxyResolverRequestClient> client) override;
};
