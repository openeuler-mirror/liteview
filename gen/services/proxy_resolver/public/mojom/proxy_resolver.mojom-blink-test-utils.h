...
class BLINK_PLATFORM_EXPORT ProxyResolverInterceptorForTesting : public ProxyResolver {
    ...
    void GetProxyForUrl(
        const ::blink::KURL& url, ::network::mojom::blink::NetworkAnonymizationKeyPtr network_anonymization_key, ::mojo::PendingRemote<ProxyResolverRequestClient> client) override;
};
...
class BLINK_PLATFORM_EXPORT ProxyResolverFactoryInterceptorForTesting : public ProxyResolverFactory {
    ...
    void CreateResolver(const WTF::String& pac_script, ::mojo::PendingReceiver<ProxyResolver> receiver, ::mojo::PendingRemote<ProxyResolverFactoryRequestClient> client) override;
};
