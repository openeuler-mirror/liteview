...
std::ostream& operator<<(std::ostream& os, CompositorFrameTransitionDirectiveType value) { return os << CompositorFrameTransitionDirectiveTypeToString(value); }
...
bool CompositorFrameTransitionDirectiveSharedElement_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    ...
    [[maybe_unused]] const CompositorFrameTransitionDirectiveSharedElement_Data* object = static_cast<const CompositorFrameTransitionDirectiveSharedElement_Data*>(data);
    ...
    if (!mojo::internal::ValidatePointerNonNullable(object->shared_element_resource_id, 2, validation_context)) {
        return false;
    }
...
bool CompositorFrameTransitionDirective_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    ...
    if (!mojo::internal::ValidatePointerNonNullable(object->shared_elements, 3, validation_context)) {
        return false;
    }
