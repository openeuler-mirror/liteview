...
(function() {
  ...
  TextureQuadState.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 56, hdr_metadata$.HDRMetadata, true);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  TextureQuadState.encodedSize = codec.kStructHeaderSize + 80;
  ...
  SharedElementQuadState.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 0, shared_element_resource_id$.SharedElementResourceId, false);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  SharedElementQuadState.encode = function(encoder, val) {
    ...
    encoder.writeUint32(0);
    encoder.encodeStructPointer(shared_element_resource_id$.SharedElementResourceId, val.resourceId);
  };
