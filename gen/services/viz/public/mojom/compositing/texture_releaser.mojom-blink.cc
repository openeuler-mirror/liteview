...
void TextureReleaserProxy::Release(const ::gpu::SyncToken& in_sync_token, bool in_is_lost)
{
    ...
    mojo::Message message(internal::kTextureReleaser_Release_Name, kFlags, 0, 0, nullptr);
...
bool TextureReleaserStubDispatch::Accept(TextureReleaser* impl, mojo::Message* message)
{
    ...
    case internal::kTextureReleaser_Release_Name: {
        ...
        bool p_is_lost = mojo::DefaultConstructTraits::CreateInstance<bool>();
...
static const std::pair<uint32_t, mojo::internal::GenericValidationInfo> kTextureReleaserValidationInfo[] = {
    { internal::kTextureReleaser_Release_Name, { &internal::TextureReleaser_Release_Params_Data::Validate, nullptr /* no response */ } },
};
