...
(function() {
  ...
  CompositorRenderPass.validate = function(messageValidator, offset) {
    ...
    if (err !== validator.validationError.NONE)
        return err;
    // validate CompositorRenderPass.sharedElementResourceId
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 72, shared_element_resource_id$.SharedElementResourceId, false);
    if (err !== validator.validationError.NONE)
        return err;
