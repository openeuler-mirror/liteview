...
CompositorFrameMetadata::CompositorFrameMetadata(float device_scale_factor_in, const ::gfx::PointF& root_scroll_offset_in, float page_scale_factor_in,
    const ::gfx::SizeF& scrollable_viewport_size_in, ::gfx::mojom::ContentColorUsage content_color_usage_in, bool may_contain_video_in, bool may_throttle_if_undrawn_frames_in,
