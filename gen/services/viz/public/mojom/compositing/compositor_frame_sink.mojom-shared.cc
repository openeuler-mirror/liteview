...
std::ostream& operator<<(std::ostream& os, CompositorFrameSinkType value) { return os << CompositorFrameSinkTypeToString(value); }
...
bool CompositorFrameSink_SetNeedsBeginFrame_Params_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    ...
    [[maybe_unused]] const CompositorFrameSink_SetNeedsBeginFrame_Params_Data* object = static_cast<const CompositorFrameSink_SetNeedsBeginFrame_Params_Data*>(data);
...
bool CompositorFrameSink_SubmitCompositorFrame_Params_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    ...
    // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
    // the message comes from an older version.
    [[maybe_unused]] const CompositorFrameSink_SubmitCompositorFrame_Params_Data* object = static_cast<const CompositorFrameSink_SubmitCompositorFrame_Params_Data*>(data);
...
bool CompositorFrameSink_SubmitCompositorFrameSync_Params_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    ...
    // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
    // the message comes from an older version.
    [[maybe_unused]] const CompositorFrameSink_SubmitCompositorFrameSync_Params_Data* object = static_cast<const CompositorFrameSink_SubmitCompositorFrameSync_Params_Data*>(data);
...
bool CompositorFrameSink_DidNotProduceFrame_Params_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    ...
    // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
    // the message comes from an older version.
    [[maybe_unused]] const CompositorFrameSink_DidNotProduceFrame_Params_Data* object = static_cast<const CompositorFrameSink_DidNotProduceFrame_Params_Data*>(data);
...
bool CompositorFrameSink_DidAllocateSharedBitmap_Params_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    ...
    // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
    // the message comes from an older version.
    [[maybe_unused]] const CompositorFrameSink_DidAllocateSharedBitmap_Params_Data* object = static_cast<const CompositorFrameSink_DidAllocateSharedBitmap_Params_Data*>(data);
...
bool CompositorFrameSink_DidDeleteSharedBitmap_Params_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    ...
    // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
    // the message comes from an older version.
    [[maybe_unused]] const CompositorFrameSink_DidDeleteSharedBitmap_Params_Data* object = static_cast<const CompositorFrameSink_DidDeleteSharedBitmap_Params_Data*>(data);
...
bool CompositorFrameSinkClient_OnBeginFrame_Params_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    ...
    // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
    // the message comes from an older version.
    [[maybe_unused]] const CompositorFrameSinkClient_OnBeginFrame_Params_Data* object = static_cast<const CompositorFrameSinkClient_OnBeginFrame_Params_Data*>(data);
...
bool CompositorFrameSinkClient_ReclaimResources_Params_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    ...
    // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
    // the message comes from an older version.
    [[maybe_unused]] const CompositorFrameSinkClient_ReclaimResources_Params_Data* object = static_cast<const CompositorFrameSinkClient_ReclaimResources_Params_Data*>(data);
...
// static
bool CompositorFrameSinkClient_OnCompositorFrameTransitionDirectiveProcessed_Params_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    if (!data)
        return true;
    if (!ValidateUnversionedStructHeaderAndSizeAndClaimMemory(data, 16, validation_context)) {
