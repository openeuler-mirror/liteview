...
static_assert(sizeof(FrameSinkBundle_InitializeCompositorFrameSinkType_Params_Data) == 16, "Bad sizeof(FrameSinkBundle_InitializeCompositorFrameSinkType_Params_Data)");
...
static_assert(sizeof(FrameSinkBundleClient_OnBeginFramePausedChanged_Params_Data) == 16, "Bad sizeof(FrameSinkBundleClient_OnBeginFramePausedChanged_Params_Data)");
...
public:
    ...
    FrameSinkBundle_InitializeCompositorFrameSinkType_ParamsDataView(internal::FrameSinkBundle_InitializeCompositorFrameSinkType_Params_Data* data, mojo::Message* message)
        : data_(data)
    {
    }
    ...
    ::viz::mojom::CompositorFrameSinkType type() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::viz::mojom::CompositorFrameSinkType>(data_->type)); }
...
public:
    ...
    FrameSinkBundleClient_OnBeginFramePausedChanged_ParamsDataView(internal::FrameSinkBundleClient_OnBeginFramePausedChanged_Params_Data* data, mojo::Message* message)
        : data_(data)
    {
    }
...
inline void FrameSinkBundle_DidAllocateSharedBitmap_ParamsDataView::GetIdDataView(::gpu::mojom::MailboxDataView* output)
{
    auto pointer = data_->id.Get();
...
inline void FrameSinkBundleClient_FlushNotifications_ParamsDataView::GetReclaimedResourcesDataView(mojo::ArrayDataView<BundledReturnedResourcesDataView>* output)
{
    auto pointer = data_->reclaimed_resources.Get();
    *output = mojo::ArrayDataView<BundledReturnedResourcesDataView>(pointer, message_);
}
