...
CompositorRenderPassQuadState::CompositorRenderPassQuadState(::viz::mojom::blink::CompositorRenderPassIdPtr render_pass_id_in,
    ::viz::mojom::blink::ResourceIdPtr mask_resource_id_in, const ::gfx::RectF& mask_uv_rect_in, const ::gfx::Size& mask_texture_size_in, const ::gfx::Vector2dF& filters_scale_in,
    const ::gfx::PointF& filters_origin_in, const ::gfx::RectF& tex_coord_rect_in, bool force_anti_aliasing_off_in, float backdrop_filter_quality_in,
...
SurfaceQuadState::SurfaceQuadState(::viz::mojom::blink::SurfaceRangePtr surface_range_in, const ::SkColor4f& default_background_color_in, bool stretch_content_to_fill_bounds_in,
...
TextureQuadState::TextureQuadState(::viz::mojom::blink::ResourceIdPtr resource_id_in, const ::gfx::Size& resource_size_in_pixels_in, bool premultiplied_alpha_in,
    const ::gfx::PointF& uv_top_left_in, const ::gfx::PointF& uv_bottom_right_in, const ::SkColor4f& background_color_in, WTF::Vector<float> vertex_opacity_in, bool y_flipped_in,
    bool nearest_neighbor_in, bool secure_output_only_in, bool is_stream_video_in, bool is_video_frame_in, ProtectedVideoState protected_video_type_in,
...
TileQuadState::TileQuadState(const ::gfx::RectF& tex_coord_rect_in, const ::gfx::Size& texture_size_in, bool is_premultiplied_in, ::viz::mojom::blink::ResourceIdPtr resource_id_in,
...
YUVVideoQuadState::YUVVideoQuadState(const ::gfx::Size& coded_size_in, const ::gfx::Rect& video_visible_rect_in, uint8_t u_scale_in, uint8_t v_scale_in,
    ::viz::mojom::blink::ResourceIdPtr y_plane_resource_id_in, ::viz::mojom::blink::ResourceIdPtr u_plane_resource_id_in, ::viz::mojom::blink::ResourceIdPtr v_plane_resource_id_in,
    ::viz::mojom::blink::ResourceIdPtr a_plane_resource_id_in, float resource_offset_in, float resource_multiplier_in, uint32_t bits_per_channel_in,
    const ::gfx::ColorSpace& video_color_space_in, ProtectedVideoState protected_video_type_in, ::gfx::mojom::blink::HDRMetadataPtr hdr_metadata_in,
...
SharedElementQuadState::SharedElementQuadState(::viz::mojom::blink::SharedElementResourceIdPtr resource_id_in)
    : resource_id(std::move(resource_id_in))
{
}
...
bool StructTraits<::viz::mojom::blink::YUVVideoQuadState::DataView, ::viz::mojom::blink::YUVVideoQuadStatePtr>::Read(
    ::viz::mojom::blink::YUVVideoQuadState::DataView input, ::viz::mojom::blink::YUVVideoQuadStatePtr* output)
{
    bool success = true;
