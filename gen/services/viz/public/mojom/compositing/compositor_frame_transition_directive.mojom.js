...
(function() {
  ...
  var shared_element_resource_id$ =
      mojo.internal.exposeNamespace('viz.mojom');
  if (mojo.config.autoLoadMojomDeps) {
    mojo.internal.loadMojomIfNecessary(
        'services/viz/public/mojom/compositing/shared_element_resource_id.mojom', 'shared_element_resource_id.mojom.js');
  }
  ...
  CompositorFrameTransitionDirectiveSharedElement.prototype.initDefaults_ = function() {
    ...
    this.sharedElementResourceId = null;
  };
  ...
  CompositorFrameTransitionDirectiveSharedElement.validate = function(messageValidator, offset) {
    ...
    if (err !== validator.validationError.NONE)
        return err;
    // validate CompositorFrameTransitionDirectiveSharedElement.sharedElementResourceId
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 8, shared_element_resource_id$.SharedElementResourceId, false);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  CompositorFrameTransitionDirectiveSharedElement.decode = function(decoder) {
    ...
    val.sharedElementResourceId =
        decoder.decodeStructPointer(shared_element_resource_id$.SharedElementResourceId);
    return val;
  };
  ...
  CompositorFrameTransitionDirectiveSharedElement.encode = function(encoder, val) {
    ...
    encoder.encodeStructPointer(shared_element_resource_id$.SharedElementResourceId, val.sharedElementResourceId);
  };
  ...
  CompositorFrameTransitionDirective.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateArrayPointer(offset + codec.kStructHeaderSize + 8, 8, new codec.PointerTo(CompositorFrameTransitionDirectiveSharedElement), false, [0], 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  CompositorFrameTransitionDirective.encodedSize = codec.kStructHeaderSize + 16;
