...
template <typename UserType, typename DataView> struct CompositorRenderPassQuadState_UnserializedMessageContext : public mojo::internal::UnserializedMessageContext {
public:
    static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;
...
static_assert(sizeof(TextureQuadState_Data) == 88, "Bad sizeof(TextureQuadState_Data)");
...
public:
    ...
    mojo::internal::Pointer<::gfx::mojom::internal::Rect_Data> video_visible_rect;
    uint8_t u_scale;
    uint8_t v_scale;
    uint8_t pad3_[2];
...
static_assert(sizeof(YUVVideoQuadState_Data) == 104, "Bad sizeof(YUVVideoQuadState_Data)");
// Used by YUVVideoQuadState::WrapAsMessage to lazily serialize the struct.
template <typename UserType, typename DataView> struct YUVVideoQuadState_UnserializedMessageContext : public mojo::internal::UnserializedMessageContext {
public:
    static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;

    YUVVideoQuadState_UnserializedMessageContext(uint32_t message_name, uint32_t message_flags, UserType input)
        : mojo::internal::UnserializedMessageContext(&kMessageTag, message_name, message_flags)
        , user_data_(std::move(input))
    {
    }
...
template <typename UserType, typename DataView>
const mojo::internal::UnserializedMessageContext::Tag YUVVideoQuadState_UnserializedMessageContext<UserType, DataView>::kMessageTag = {};
class VideoHoleQuadState_Data {
public:
    static bool Validate(const void* data, mojo::internal::ValidationContext* validation_context);
...
template <typename UserType, typename DataView> const mojo::internal::UnserializedMessageContext::Tag DrawQuad_UnserializedMessageContext<UserType, DataView>::kMessageTag = {};
