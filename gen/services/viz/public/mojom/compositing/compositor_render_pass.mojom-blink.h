...
#include "services/viz/public/mojom/compositing/compositor_render_pass.mojom-blink-forward.h"
...
public:
    ...
    template <typename... Args> static CompositorRenderPassPtr New(Args&&... args) { return CompositorRenderPassPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static CompositorRenderPassPtr From(const U& u) { return mojo::TypeConverter<CompositorRenderPassPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, CompositorRenderPass>::Convert(*this); }
    ...
    CompositorRenderPass(::viz::mojom::blink::CompositorRenderPassIdPtr id_in, const ::gfx::Rect& output_rect_in, const ::gfx::Rect& damage_rect_in,
        const ::gfx::Transform& transform_to_root_target_in, ::viz::mojom::blink::FilterOperationsPtr filters_in, ::viz::mojom::blink::FilterOperationsPtr backdrop_filters_in,
        ::gfx::mojom::blink::RRectFPtr backdrop_filter_bounds_in, const ::viz::SubtreeCaptureId& subtree_capture_id_in, const ::gfx::Size& subtree_size_in,
        ::viz::mojom::blink::SharedElementResourceIdPtr shared_element_resource_id_in, bool has_transparent_background_in, bool cache_render_pass_in,
        bool has_damage_from_contributing_content_in, bool generate_mipmap_in, WTF::Vector<::viz::mojom::blink::CopyOutputRequestPtr> copy_requests_in,
        WTF::Vector<::viz::mojom::blink::DrawQuadPtr> quad_list_in, bool has_per_quad_damage_in)
        : id(std::move(id_in))
    ...
    template <typename T, CompositorRenderPass::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<CompositorRenderPass::DataView>(input); }
    ...
    {
        return mojo::Message(std::make_unique<internal::CompositorRenderPass_UnserializedMessageContext<UserType, CompositorRenderPass::DataView>>(0, 0, std::move(input)),
    ...
    {
        return CompositorRenderPass::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, CompositorRenderPass::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, CompositorRenderPass::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, CompositorRenderPass::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }

template <typename StructPtrType> CompositorRenderPassPtr CompositorRenderPass::Clone() const
{
    return New(mojo::Clone(id), mojo::Clone(output_rect), mojo::Clone(damage_rect), mojo::Clone(transform_to_root_target), mojo::Clone(filters), mojo::Clone(backdrop_filters),
        mojo::Clone(backdrop_filter_bounds), mojo::Clone(subtree_capture_id), mojo::Clone(subtree_size), mojo::Clone(shared_element_resource_id),
        mojo::Clone(has_transparent_background), mojo::Clone(cache_render_pass), mojo::Clone(has_damage_from_contributing_content), mojo::Clone(generate_mipmap),
        mojo::Clone(copy_requests), mojo::Clone(quad_list), mojo::Clone(has_per_quad_damage));
}
...
template <> struct BLINK_PLATFORM_EXPORT StructTraits<::viz::mojom::blink::CompositorRenderPass::DataView, ::viz::mojom::blink::CompositorRenderPassPtr> {
    ...
    static const decltype(::viz::mojom::blink::CompositorRenderPass::id)& id(const ::viz::mojom::blink::CompositorRenderPassPtr& input) { return input->id; }
    ...
    static const decltype(::viz::mojom::blink::CompositorRenderPass::transform_to_root_target)& transform_to_root_target(const ::viz::mojom::blink::CompositorRenderPassPtr& input)
    {
        return input->transform_to_root_target;
    }

    static const decltype(::viz::mojom::blink::CompositorRenderPass::filters)& filters(const ::viz::mojom::blink::CompositorRenderPassPtr& input) { return input->filters; }

    static const decltype(::viz::mojom::blink::CompositorRenderPass::backdrop_filters)& backdrop_filters(const ::viz::mojom::blink::CompositorRenderPassPtr& input)
    {
        return input->backdrop_filters;
    }

    static const decltype(::viz::mojom::blink::CompositorRenderPass::backdrop_filter_bounds)& backdrop_filter_bounds(const ::viz::mojom::blink::CompositorRenderPassPtr& input)
    {
        return input->backdrop_filter_bounds;
    }

    static const decltype(::viz::mojom::blink::CompositorRenderPass::subtree_capture_id)& subtree_capture_id(const ::viz::mojom::blink::CompositorRenderPassPtr& input)
    {
    ...
    static const decltype(::viz::mojom::blink::CompositorRenderPass::shared_element_resource_id)& shared_element_resource_id(
        const ::viz::mojom::blink::CompositorRenderPassPtr& input)
    {
        return input->shared_element_resource_id;
    }

    static decltype(::viz::mojom::blink::CompositorRenderPass::has_transparent_background) has_transparent_background(const ::viz::mojom::blink::CompositorRenderPassPtr& input)
    {
    ...
    static decltype(::viz::mojom::blink::CompositorRenderPass::copy_requests)& copy_requests(::viz::mojom::blink::CompositorRenderPassPtr& input) { return input->copy_requests; }

    static const decltype(::viz::mojom::blink::CompositorRenderPass::quad_list)& quad_list(const ::viz::mojom::blink::CompositorRenderPassPtr& input) { return input->quad_list; }

    static decltype(::viz::mojom::blink::CompositorRenderPass::has_per_quad_damage) has_per_quad_damage(const ::viz::mojom::blink::CompositorRenderPassPtr& input)
    {
