...
ReturnedResource::ReturnedResource(const ::viz::ResourceId& id_in, const ::gpu::SyncToken& sync_token_in, ::gfx::GpuFenceHandle release_fence_in, int32_t count_in, bool lost_in)
    : id(std::move(id_in))
