...
namespace mojo {
// static
bool StructTraits<::viz::mojom::FrameDeadline::DataView, ::viz::mojom::FrameDeadlinePtr>::Read(::viz::mojom::FrameDeadline::DataView input, ::viz::mojom::FrameDeadlinePtr* output)
{
    bool success = true;
