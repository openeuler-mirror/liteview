...
static NOINLINE const char* CopyOutputResultFormatToStringHelper(CopyOutputResultFormat value)
{
...
std::ostream& operator<<(std::ostream& os, CopyOutputResultFormat value) { return os << CopyOutputResultFormatToString(value); }

static NOINLINE const char* CopyOutputResultDestinationToStringHelper(CopyOutputResultDestination value)
{
    // Defined in a helper function to ensure that Clang generates a lookup table.
    switch (value) {
...
std::ostream& operator<<(std::ostream& os, CopyOutputResultDestination value) { return os << CopyOutputResultDestinationToString(value); }
...
// static
void TraceFormatTraits<::viz::mojom::CopyOutputResultDestination>::WriteIntoTrace(perfetto::TracedValue context, ::viz::mojom::CopyOutputResultDestination value)
{
