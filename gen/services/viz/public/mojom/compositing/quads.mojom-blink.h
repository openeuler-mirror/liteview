...
struct viz_mojom_internal_ProtectedVideoState_DataHashFn {
    ...
    static bool Equal(const ::viz::mojom::ProtectedVideoState& left, const ::viz::mojom::ProtectedVideoState& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::viz::mojom::ProtectedVideoState> : public GenericHashTraits<::viz::mojom::ProtectedVideoState> {
    ...
    static void ConstructDeletedValue(::viz::mojom::ProtectedVideoState& slot, bool) { slot = static_cast<::viz::mojom::ProtectedVideoState>(-1000001); }
    static bool IsDeletedValue(const ::viz::mojom::ProtectedVideoState& value) { return value == static_cast<::viz::mojom::ProtectedVideoState>(-1000001); }
};
} // namespace WTF
namespace WTF {
struct viz_mojom_internal_OverlayPriority_DataHashFn {
    ...
    static bool Equal(const ::viz::mojom::OverlayPriority& left, const ::viz::mojom::OverlayPriority& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::viz::mojom::OverlayPriority> : public GenericHashTraits<::viz::mojom::OverlayPriority> {
    static_assert(true, "-1000000 is a reserved enum value");
    static_assert(true, "-1000001 is a reserved enum value");
    static const bool kEmptyValueIsZero = false;
    static ::viz::mojom::OverlayPriority EmptyValue() { return static_cast<::viz::mojom::OverlayPriority>(-1000000); }
    static void ConstructDeletedValue(::viz::mojom::OverlayPriority& slot, bool) { slot = static_cast<::viz::mojom::OverlayPriority>(-1000001); }
    static bool IsDeletedValue(const ::viz::mojom::OverlayPriority& value) { return value == static_cast<::viz::mojom::OverlayPriority>(-1000001); }
};
} // namespace WTF
namespace viz {
namespace mojom {
...
public:
    ...
    CompositorRenderPassQuadState(::viz::mojom::blink::CompositorRenderPassIdPtr render_pass_id_in, ::viz::mojom::blink::ResourceIdPtr mask_resource_id_in,
        const ::gfx::RectF& mask_uv_rect_in, const ::gfx::Size& mask_texture_size_in, const ::gfx::Vector2dF& filters_scale_in, const ::gfx::PointF& filters_origin_in,
        const ::gfx::RectF& tex_coord_rect_in, bool force_anti_aliasing_off_in, float backdrop_filter_quality_in, bool intersects_damage_under_in)
...
public:
    ...
    SurfaceQuadState(::viz::mojom::blink::SurfaceRangePtr surface_range_in, const ::SkColor4f& default_background_color_in, bool stretch_content_to_fill_bounds_in,
        bool is_reflection_in, bool allow_merge_in)
...
public:
    ...
    TextureQuadState(::viz::mojom::blink::ResourceIdPtr resource_id_in, const ::gfx::Size& resource_size_in_pixels_in, bool premultiplied_alpha_in,
        const ::gfx::PointF& uv_top_left_in, const ::gfx::PointF& uv_bottom_right_in, const ::SkColor4f& background_color_in, WTF::Vector<float> vertex_opacity_in,
        bool y_flipped_in, bool nearest_neighbor_in, bool secure_output_only_in, bool is_stream_video_in, bool is_video_frame_in, ProtectedVideoState protected_video_type_in,
        ::gfx::mojom::blink::HDRMetadataPtr hdr_metadata_in, const absl::optional<::gfx::Rect>& damage_rect_in, OverlayPriority overlay_priority_hint_in)
...
public:
    ...
    TileQuadState(const ::gfx::RectF& tex_coord_rect_in, const ::gfx::Size& texture_size_in, bool is_premultiplied_in, ::viz::mojom::blink::ResourceIdPtr resource_id_in,
...
public:
    ...
    YUVVideoQuadState(const ::gfx::Size& coded_size_in, const ::gfx::Rect& video_visible_rect_in, uint8_t u_scale_in, uint8_t v_scale_in,
        ::viz::mojom::blink::ResourceIdPtr y_plane_resource_id_in, ::viz::mojom::blink::ResourceIdPtr u_plane_resource_id_in,
        ::viz::mojom::blink::ResourceIdPtr v_plane_resource_id_in, ::viz::mojom::blink::ResourceIdPtr a_plane_resource_id_in, float resource_offset_in,
        float resource_multiplier_in, uint32_t bits_per_channel_in, const ::gfx::ColorSpace& video_color_space_in, ProtectedVideoState protected_video_type_in,
        ::gfx::mojom::blink::HDRMetadataPtr hdr_metadata_in, const absl::optional<::gfx::Rect>& damage_rect_in)
    ...
    template <typename UserType> static WTF::Vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<YUVVideoQuadState::DataView, WTF::Vector<uint8_t>>(input);
    }
...
public:
    ...
    explicit SharedElementQuadState(::viz::mojom::blink::SharedElementResourceIdPtr resource_id_in)
        : resource_id(std::move(resource_id_in)) {};
...
public:
    ...
    DrawQuad(
        const ::gfx::Rect& rect_in, const ::gfx::Rect& visible_rect_in, bool needs_blending_in, ::viz::mojom::blink::SharedQuadStatePtr sqs_in, DrawQuadStatePtr draw_quad_state_in)
    ...
    template <typename UserType> static WTF::Vector<uint8_t> Serialize(UserType* input) { return mojo::internal::SerializeImpl<DrawQuad::DataView, WTF::Vector<uint8_t>>(input); }
...
template <> struct BLINK_PLATFORM_EXPORT StructTraits<::viz::mojom::blink::DebugBorderQuadState::DataView, ::viz::mojom::blink::DebugBorderQuadStatePtr> {
    ...
    static const decltype(::viz::mojom::blink::DebugBorderQuadState::color)& color(const ::viz::mojom::blink::DebugBorderQuadStatePtr& input) { return input->color; }

    static decltype(::viz::mojom::blink::DebugBorderQuadState::width) width(const ::viz::mojom::blink::DebugBorderQuadStatePtr& input) { return input->width; }

    static bool Read(::viz::mojom::blink::DebugBorderQuadState::DataView input, ::viz::mojom::blink::DebugBorderQuadStatePtr* output);
};
template <> struct BLINK_PLATFORM_EXPORT StructTraits<::viz::mojom::blink::CompositorRenderPassQuadState::DataView, ::viz::mojom::blink::CompositorRenderPassQuadStatePtr> {
    ...
    static const decltype(::viz::mojom::blink::CompositorRenderPassQuadState::render_pass_id)& render_pass_id(const ::viz::mojom::blink::CompositorRenderPassQuadStatePtr& input)
    {
    ...
    static const decltype(::viz::mojom::blink::CompositorRenderPassQuadState::mask_uv_rect)& mask_uv_rect(const ::viz::mojom::blink::CompositorRenderPassQuadStatePtr& input)
    {
    ...
    static const decltype(::viz::mojom::blink::CompositorRenderPassQuadState::filters_scale)& filters_scale(const ::viz::mojom::blink::CompositorRenderPassQuadStatePtr& input)
    {
        return input->filters_scale;
    }

    static const decltype(::viz::mojom::blink::CompositorRenderPassQuadState::filters_origin)& filters_origin(const ::viz::mojom::blink::CompositorRenderPassQuadStatePtr& input)
    {
        return input->filters_origin;
    }

    static const decltype(::viz::mojom::blink::CompositorRenderPassQuadState::tex_coord_rect)& tex_coord_rect(const ::viz::mojom::blink::CompositorRenderPassQuadStatePtr& input)
    {
...
template <> struct BLINK_PLATFORM_EXPORT StructTraits<::viz::mojom::blink::SolidColorQuadState::DataView, ::viz::mojom::blink::SolidColorQuadStatePtr> {
    ...
    static const decltype(::viz::mojom::blink::SolidColorQuadState::color)& color(const ::viz::mojom::blink::SolidColorQuadStatePtr& input) { return input->color; }

    static decltype(::viz::mojom::blink::SolidColorQuadState::force_anti_aliasing_off) force_anti_aliasing_off(const ::viz::mojom::blink::SolidColorQuadStatePtr& input)
    {
        return input->force_anti_aliasing_off;
    }
...
template <> struct BLINK_PLATFORM_EXPORT StructTraits<::viz::mojom::blink::SurfaceQuadState::DataView, ::viz::mojom::blink::SurfaceQuadStatePtr> {
    ...
    static const decltype(::viz::mojom::blink::SurfaceQuadState::default_background_color)& default_background_color(const ::viz::mojom::blink::SurfaceQuadStatePtr& input)
    {
        return input->default_background_color;
    }

    static decltype(::viz::mojom::blink::SurfaceQuadState::stretch_content_to_fill_bounds) stretch_content_to_fill_bounds(const ::viz::mojom::blink::SurfaceQuadStatePtr& input)
    {
        return input->stretch_content_to_fill_bounds;
    }

    static decltype(::viz::mojom::blink::SurfaceQuadState::is_reflection) is_reflection(const ::viz::mojom::blink::SurfaceQuadStatePtr& input) { return input->is_reflection; }

    static decltype(::viz::mojom::blink::SurfaceQuadState::allow_merge) allow_merge(const ::viz::mojom::blink::SurfaceQuadStatePtr& input) { return input->allow_merge; }
...
template <> struct BLINK_PLATFORM_EXPORT StructTraits<::viz::mojom::blink::TextureQuadState::DataView, ::viz::mojom::blink::TextureQuadStatePtr> {
    ...
    static const decltype(::viz::mojom::blink::TextureQuadState::resource_id)& resource_id(const ::viz::mojom::blink::TextureQuadStatePtr& input) { return input->resource_id; }

    static const decltype(::viz::mojom::blink::TextureQuadState::resource_size_in_pixels)& resource_size_in_pixels(const ::viz::mojom::blink::TextureQuadStatePtr& input)
    {
    ...
    static const decltype(::viz::mojom::blink::TextureQuadState::uv_top_left)& uv_top_left(const ::viz::mojom::blink::TextureQuadStatePtr& input) { return input->uv_top_left; }
    ...
    static const decltype(::viz::mojom::blink::TextureQuadState::vertex_opacity)& vertex_opacity(const ::viz::mojom::blink::TextureQuadStatePtr& input)
    {
        return input->vertex_opacity;
    }

    static decltype(::viz::mojom::blink::TextureQuadState::y_flipped) y_flipped(const ::viz::mojom::blink::TextureQuadStatePtr& input) { return input->y_flipped; }
    ...
    static decltype(::viz::mojom::blink::TextureQuadState::is_video_frame) is_video_frame(const ::viz::mojom::blink::TextureQuadStatePtr& input) { return input->is_video_frame; }
    ...
    static const decltype(::viz::mojom::blink::TextureQuadState::hdr_metadata)& hdr_metadata(const ::viz::mojom::blink::TextureQuadStatePtr& input) { return input->hdr_metadata; }

    static const decltype(::viz::mojom::blink::TextureQuadState::damage_rect)& damage_rect(const ::viz::mojom::blink::TextureQuadStatePtr& input) { return input->damage_rect; }
...
template <> struct BLINK_PLATFORM_EXPORT StructTraits<::viz::mojom::blink::TileQuadState::DataView, ::viz::mojom::blink::TileQuadStatePtr> {
    ...
    static const decltype(::viz::mojom::blink::TileQuadState::tex_coord_rect)& tex_coord_rect(const ::viz::mojom::blink::TileQuadStatePtr& input) { return input->tex_coord_rect; }

    static const decltype(::viz::mojom::blink::TileQuadState::texture_size)& texture_size(const ::viz::mojom::blink::TileQuadStatePtr& input) { return input->texture_size; }

    static decltype(::viz::mojom::blink::TileQuadState::is_premultiplied) is_premultiplied(const ::viz::mojom::blink::TileQuadStatePtr& input) { return input->is_premultiplied; }

    static const decltype(::viz::mojom::blink::TileQuadState::resource_id)& resource_id(const ::viz::mojom::blink::TileQuadStatePtr& input) { return input->resource_id; }

    static decltype(::viz::mojom::blink::TileQuadState::nearest_neighbor) nearest_neighbor(const ::viz::mojom::blink::TileQuadStatePtr& input) { return input->nearest_neighbor; }
...
template <> struct BLINK_PLATFORM_EXPORT StructTraits<::viz::mojom::blink::YUVVideoQuadState::DataView, ::viz::mojom::blink::YUVVideoQuadStatePtr> {
    ...
    static const decltype(::viz::mojom::blink::YUVVideoQuadState::coded_size)& coded_size(const ::viz::mojom::blink::YUVVideoQuadStatePtr& input) { return input->coded_size; }

    static const decltype(::viz::mojom::blink::YUVVideoQuadState::video_visible_rect)& video_visible_rect(const ::viz::mojom::blink::YUVVideoQuadStatePtr& input)
    {
        return input->video_visible_rect;
    }

    static decltype(::viz::mojom::blink::YUVVideoQuadState::u_scale) u_scale(const ::viz::mojom::blink::YUVVideoQuadStatePtr& input) { return input->u_scale; }

    static decltype(::viz::mojom::blink::YUVVideoQuadState::v_scale) v_scale(const ::viz::mojom::blink::YUVVideoQuadStatePtr& input) { return input->v_scale; }

    static const decltype(::viz::mojom::blink::YUVVideoQuadState::y_plane_resource_id)& y_plane_resource_id(const ::viz::mojom::blink::YUVVideoQuadStatePtr& input)
    {
        return input->y_plane_resource_id;
    }

    static const decltype(::viz::mojom::blink::YUVVideoQuadState::u_plane_resource_id)& u_plane_resource_id(const ::viz::mojom::blink::YUVVideoQuadStatePtr& input)
    {
        return input->u_plane_resource_id;
    }

    static const decltype(::viz::mojom::blink::YUVVideoQuadState::v_plane_resource_id)& v_plane_resource_id(const ::viz::mojom::blink::YUVVideoQuadStatePtr& input)
    {
        return input->v_plane_resource_id;
    }

    static const decltype(::viz::mojom::blink::YUVVideoQuadState::a_plane_resource_id)& a_plane_resource_id(const ::viz::mojom::blink::YUVVideoQuadStatePtr& input)
    {
        return input->a_plane_resource_id;
    }

    static decltype(::viz::mojom::blink::YUVVideoQuadState::resource_offset) resource_offset(const ::viz::mojom::blink::YUVVideoQuadStatePtr& input)
    {
        return input->resource_offset;
    }

    static decltype(::viz::mojom::blink::YUVVideoQuadState::resource_multiplier) resource_multiplier(const ::viz::mojom::blink::YUVVideoQuadStatePtr& input)
    {
        return input->resource_multiplier;
    }

    static decltype(::viz::mojom::blink::YUVVideoQuadState::bits_per_channel) bits_per_channel(const ::viz::mojom::blink::YUVVideoQuadStatePtr& input)
    {
        return input->bits_per_channel;
    }

    static const decltype(::viz::mojom::blink::YUVVideoQuadState::video_color_space)& video_color_space(const ::viz::mojom::blink::YUVVideoQuadStatePtr& input)
    {
        return input->video_color_space;
    }

    static decltype(::viz::mojom::blink::YUVVideoQuadState::protected_video_type) protected_video_type(const ::viz::mojom::blink::YUVVideoQuadStatePtr& input)
    {
        return input->protected_video_type;
    }

    static const decltype(::viz::mojom::blink::YUVVideoQuadState::hdr_metadata)& hdr_metadata(const ::viz::mojom::blink::YUVVideoQuadStatePtr& input)
    {
        return input->hdr_metadata;
    }

    static const decltype(::viz::mojom::blink::YUVVideoQuadState::damage_rect)& damage_rect(const ::viz::mojom::blink::YUVVideoQuadStatePtr& input) { return input->damage_rect; }
...
template <> struct BLINK_PLATFORM_EXPORT StructTraits<::viz::mojom::blink::SharedElementQuadState::DataView, ::viz::mojom::blink::SharedElementQuadStatePtr> {
    ...
    static const decltype(::viz::mojom::blink::SharedElementQuadState::resource_id)& resource_id(const ::viz::mojom::blink::SharedElementQuadStatePtr& input)
    {
...
template <> struct BLINK_PLATFORM_EXPORT StructTraits<::viz::mojom::blink::DrawQuad::DataView, ::viz::mojom::blink::DrawQuadPtr> {
    ...
    static const decltype(::viz::mojom::blink::DrawQuad::rect)& rect(const ::viz::mojom::blink::DrawQuadPtr& input) { return input->rect; }

    static const decltype(::viz::mojom::blink::DrawQuad::visible_rect)& visible_rect(const ::viz::mojom::blink::DrawQuadPtr& input) { return input->visible_rect; }

    static decltype(::viz::mojom::blink::DrawQuad::needs_blending) needs_blending(const ::viz::mojom::blink::DrawQuadPtr& input) { return input->needs_blending; }

    static const decltype(::viz::mojom::blink::DrawQuad::sqs)& sqs(const ::viz::mojom::blink::DrawQuadPtr& input) { return input->sqs; }

    static const decltype(::viz::mojom::blink::DrawQuad::draw_quad_state)& draw_quad_state(const ::viz::mojom::blink::DrawQuadPtr& input) { return input->draw_quad_state; }
...
template <> struct BLINK_PLATFORM_EXPORT UnionTraits<::viz::mojom::blink::DrawQuadState::DataView, ::viz::mojom::blink::DrawQuadStatePtr> {
    ...
    static ::viz::mojom::blink::DrawQuadState::Tag GetTag(const ::viz::mojom::blink::DrawQuadStatePtr& input) { return input->which(); }
    ...
    static const ::viz::mojom::blink::SurfaceQuadStatePtr& surface_quad_state(const ::viz::mojom::blink::DrawQuadStatePtr& input) { return input->get_surface_quad_state(); }

    static const ::viz::mojom::blink::TextureQuadStatePtr& texture_quad_state(const ::viz::mojom::blink::DrawQuadStatePtr& input) { return input->get_texture_quad_state(); }

    static const ::viz::mojom::blink::TileQuadStatePtr& tile_quad_state(const ::viz::mojom::blink::DrawQuadStatePtr& input) { return input->get_tile_quad_state(); }

    static const ::viz::mojom::blink::YUVVideoQuadStatePtr& yuv_video_quad_state(const ::viz::mojom::blink::DrawQuadStatePtr& input) { return input->get_yuv_video_quad_state(); }
