// services/viz/public/mojom/compositing/texture_releaser.mojom-lite-for-compile.js is auto generated by mojom_bindings_generator.py, do not edit
...
goog.provide('viz.mojom.TextureReleaser');
goog.provide('viz.mojom.TextureReleaserReceiver');
goog.provide('viz.mojom.TextureReleaserCallbackRouter');
goog.provide('viz.mojom.TextureReleaserInterface');
goog.provide('viz.mojom.TextureReleaserRemote');
goog.provide('viz.mojom.TextureReleaserPendingReceiver');
/**
...
/** @interface */
viz.mojom.TextureReleaserInterface = class {
...
goog.provide('viz.mojom.TextureReleaser_Release_ParamsSpec');
/**
...
goog.provide('viz.mojom.TextureReleaser_Release_Params');
