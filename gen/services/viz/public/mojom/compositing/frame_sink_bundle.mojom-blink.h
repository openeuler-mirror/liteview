...
//
//   void FlushNotifications(WTF::Vector<BundledReturnedResourcesPtr> acks, WTF::Vector<BeginFrameInfoPtr> begin_frames, WTF::Vector<BundledReturnedResourcesPtr>
...
public:
    ...
    {
        return mojo::internal::SerializeImpl<BeginFrameInfo::DataView, WTF::Vector<uint8_t>>(input);
    }
...
template <> struct BLINK_PLATFORM_EXPORT StructTraits<::viz::mojom::blink::BundledFrameSubmission::DataView, ::viz::mojom::blink::BundledFrameSubmissionPtr> {
    ...
    static decltype(::viz::mojom::blink::BundledFrameSubmission::sink_id) sink_id(const ::viz::mojom::blink::BundledFrameSubmissionPtr& input) { return input->sink_id; }

    static decltype(::viz::mojom::blink::BundledFrameSubmission::data)& data(::viz::mojom::blink::BundledFrameSubmissionPtr& input) { return input->data; }
...
template <> struct BLINK_PLATFORM_EXPORT StructTraits<::viz::mojom::blink::BundledCompositorFrame::DataView, ::viz::mojom::blink::BundledCompositorFramePtr> {
    ...
    static const decltype(::viz::mojom::blink::BundledCompositorFrame::local_surface_id)& local_surface_id(const ::viz::mojom::blink::BundledCompositorFramePtr& input)
    {
        return input->local_surface_id;
    }

    static decltype(::viz::mojom::blink::BundledCompositorFrame::frame)& frame(::viz::mojom::blink::BundledCompositorFramePtr& input) { return input->frame; }

    static const decltype(::viz::mojom::blink::BundledCompositorFrame::hit_test_region_list)& hit_test_region_list(const ::viz::mojom::blink::BundledCompositorFramePtr& input)
    {
...
template <> struct BLINK_PLATFORM_EXPORT StructTraits<::viz::mojom::blink::BundledReturnedResources::DataView, ::viz::mojom::blink::BundledReturnedResourcesPtr> {
    ...
    static decltype(::viz::mojom::blink::BundledReturnedResources::sink_id) sink_id(const ::viz::mojom::blink::BundledReturnedResourcesPtr& input) { return input->sink_id; }

    static decltype(::viz::mojom::blink::BundledReturnedResources::resources)& resources(::viz::mojom::blink::BundledReturnedResourcesPtr& input) { return input->resources; }
...
template <> struct BLINK_PLATFORM_EXPORT StructTraits<::viz::mojom::blink::BeginFrameInfo::DataView, ::viz::mojom::blink::BeginFrameInfoPtr> {
    ...
    static decltype(::viz::mojom::blink::BeginFrameInfo::sink_id) sink_id(const ::viz::mojom::blink::BeginFrameInfoPtr& input) { return input->sink_id; }

    static const decltype(::viz::mojom::blink::BeginFrameInfo::args)& args(const ::viz::mojom::blink::BeginFrameInfoPtr& input) { return input->args; }

    static const decltype(::viz::mojom::blink::BeginFrameInfo::details)& details(const ::viz::mojom::blink::BeginFrameInfoPtr& input) { return input->details; }

    static bool Read(::viz::mojom::blink::BeginFrameInfo::DataView input, ::viz::mojom::blink::BeginFrameInfoPtr* output);
};
template <> struct BLINK_PLATFORM_EXPORT UnionTraits<::viz::mojom::blink::BundledFrameSubmissionData::DataView, ::viz::mojom::blink::BundledFrameSubmissionDataPtr> {
    ...
    static ::viz::mojom::blink::BundledFrameSubmissionData::Tag GetTag(const ::viz::mojom::blink::BundledFrameSubmissionDataPtr& input) { return input->which(); }

    static ::viz::mojom::blink::BundledCompositorFramePtr& frame(::viz::mojom::blink::BundledFrameSubmissionDataPtr& input) { return input->get_frame(); }

    static const ::viz::BeginFrameAck& did_not_produce_frame(const ::viz::mojom::blink::BundledFrameSubmissionDataPtr& input) { return input->get_did_not_produce_frame(); }

    static const ::gpu::Mailbox& did_delete_shared_bitmap(const ::viz::mojom::blink::BundledFrameSubmissionDataPtr& input) { return input->get_did_delete_shared_bitmap(); }
