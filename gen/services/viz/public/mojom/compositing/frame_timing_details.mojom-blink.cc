...
FrameTimingDetails::FrameTimingDetails(::base::TimeTicks received_compositor_frame_timestamp_in, ::base::TimeTicks draw_start_timestamp_in,
    const ::gfx::SwapTimings& swap_timings_in, const ::gfx::PresentationFeedback& presentation_feedback_in)
...
bool FrameTimingDetails::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
} // namespace blink
} // namespace mojom
} // namespace viz
namespace mojo {
