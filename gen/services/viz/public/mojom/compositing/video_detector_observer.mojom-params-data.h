...
public:
    ...
    VideoDetectorObserver_OnVideoActivityStarted_ParamsDataView(internal::VideoDetectorObserver_OnVideoActivityStarted_Params_Data* data, mojo::Message* message)
        : data_(data)
    {
    }
