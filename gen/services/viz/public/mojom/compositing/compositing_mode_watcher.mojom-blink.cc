...
void CompositingModeWatcherProxy::CompositingModeFallbackToSoftware()
{
    ...
    mojo::Message message(internal::kCompositingModeWatcher_CompositingModeFallbackToSoftware_Name, kFlags, 0, 0, nullptr);
...
// static
bool CompositingModeWatcherStubDispatch::AcceptWithResponder(CompositingModeWatcher* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
{
...
void CompositingModeReporterProxy::AddCompositingModeWatcher(::mojo::PendingRemote<CompositingModeWatcher> in_watcher)
{
    ...
    mojo::Message message(internal::kCompositingModeReporter_AddCompositingModeWatcher_Name, kFlags, 0, 0, nullptr);
    ...
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(!mojo::internal::IsHandleOrInterfaceValid(params->watcher), mojo::internal::VALIDATION_ERROR_UNEXPECTED_INVALID_HANDLE,
...
bool CompositingModeReporterStubDispatch::Accept(CompositingModeReporter* impl, mojo::Message* message)
{
    ...
    case internal::kCompositingModeReporter_AddCompositingModeWatcher_Name: {
        ...
        bool success = true;
        ::mojo::PendingRemote<CompositingModeWatcher> p_watcher = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingRemote<CompositingModeWatcher>>();
...
// static
bool CompositingModeReporterStubDispatch::AcceptWithResponder(CompositingModeReporter* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
{
    [[maybe_unused]] const bool message_is_sync = message->has_flag(mojo::Message::kFlagIsSync);
    [[maybe_unused]] const uint64_t request_id = message->request_id();
    switch (message->header()->name) {
...
namespace mojom {
namespace blink {
void CompositingModeWatcherInterceptorForTesting::CompositingModeFallbackToSoftware() { GetForwardingInterface()->CompositingModeFallbackToSoftware(); }
