...
#include "services/viz/public/mojom/compositing/compositor_frame_metadata.mojom-blink-forward.h"
...
public:
    ...
    CompositorFrameMetadata(float device_scale_factor_in, const ::gfx::PointF& root_scroll_offset_in, float page_scale_factor_in, const ::gfx::SizeF& scrollable_viewport_size_in,
        ::gfx::mojom::blink::ContentColorUsage content_color_usage_in, bool may_contain_video_in, bool may_throttle_if_undrawn_frames_in,
        bool is_resourceless_software_draw_with_scroll_or_animation_in, const ::SkColor4f& root_background_color_in, WTF::Vector<::ui::LatencyInfo> latency_info_in,
        WTF::Vector<::viz::mojom::blink::SurfaceRangePtr> referenced_surfaces_in, ::viz::mojom::blink::FrameDeadlinePtr deadline_in,
        WTF::Vector<::viz::SurfaceId> activation_dependencies_in, const ::viz::BeginFrameAck& begin_frame_ack_in, uint32_t frame_token_in, bool send_frame_token_to_embedder_in,
        bool top_controls_visible_height_set_in, float top_controls_visible_height_in, float min_page_scale_factor_in,
        absl::optional<::base::TimeDelta> preferred_frame_interval_in, ::gfx::mojom::blink::OverlayTransform display_transform_hint_in,
        ::std::unique_ptr<::gfx::DelegatedInkMetadata> delegated_ink_metadata_in, WTF::Vector<::viz::mojom::blink::CompositorFrameTransitionDirectivePtr> transition_directives_in,
        const ::viz::RegionCaptureBounds& capture_bounds_in, bool has_shared_element_resources_in)
    ...
    ::gfx::mojom::blink::ContentColorUsage content_color_usage;
...
template <> struct BLINK_PLATFORM_EXPORT StructTraits<::viz::mojom::blink::CompositorFrameMetadata::DataView, ::viz::mojom::blink::CompositorFrameMetadataPtr> {
    ...
    static decltype(::viz::mojom::blink::CompositorFrameMetadata::device_scale_factor) device_scale_factor(const ::viz::mojom::blink::CompositorFrameMetadataPtr& input)
    {
        return input->device_scale_factor;
    }

    static const decltype(::viz::mojom::blink::CompositorFrameMetadata::root_scroll_offset)& root_scroll_offset(const ::viz::mojom::blink::CompositorFrameMetadataPtr& input)
    {
        return input->root_scroll_offset;
    }

    static decltype(::viz::mojom::blink::CompositorFrameMetadata::page_scale_factor) page_scale_factor(const ::viz::mojom::blink::CompositorFrameMetadataPtr& input)
    {
    ...
    static decltype(::viz::mojom::blink::CompositorFrameMetadata::content_color_usage) content_color_usage(const ::viz::mojom::blink::CompositorFrameMetadataPtr& input)
    {
        return input->content_color_usage;
    }

    static decltype(::viz::mojom::blink::CompositorFrameMetadata::may_contain_video) may_contain_video(const ::viz::mojom::blink::CompositorFrameMetadataPtr& input)
    {
    ...
    static const decltype(::viz::mojom::blink::CompositorFrameMetadata::root_background_color)& root_background_color(const ::viz::mojom::blink::CompositorFrameMetadataPtr& input)
    {
        return input->root_background_color;
    }

    static const decltype(::viz::mojom::blink::CompositorFrameMetadata::latency_info)& latency_info(const ::viz::mojom::blink::CompositorFrameMetadataPtr& input)
    {
        return input->latency_info;
    }

    static const decltype(::viz::mojom::blink::CompositorFrameMetadata::referenced_surfaces)& referenced_surfaces(const ::viz::mojom::blink::CompositorFrameMetadataPtr& input)
    {
    ...
    static const decltype(::viz::mojom::blink::CompositorFrameMetadata::begin_frame_ack)& begin_frame_ack(const ::viz::mojom::blink::CompositorFrameMetadataPtr& input)
    {
    ...
    static decltype(::viz::mojom::blink::CompositorFrameMetadata::min_page_scale_factor) min_page_scale_factor(const ::viz::mojom::blink::CompositorFrameMetadataPtr& input)
    {
    ...
    static decltype(::viz::mojom::blink::CompositorFrameMetadata::display_transform_hint) display_transform_hint(const ::viz::mojom::blink::CompositorFrameMetadataPtr& input)
    {
    ...
    static const decltype(::viz::mojom::blink::CompositorFrameMetadata::transition_directives)& transition_directives(const ::viz::mojom::blink::CompositorFrameMetadataPtr& input)
    {
        return input->transition_directives;
    }

    static const decltype(::viz::mojom::blink::CompositorFrameMetadata::capture_bounds)& capture_bounds(const ::viz::mojom::blink::CompositorFrameMetadataPtr& input)
    {
