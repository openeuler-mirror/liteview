...
bool Selection::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
} // namespace mojom
} // namespace viz
namespace mojo {
// static
bool StructTraits<::viz::mojom::Selection::DataView, ::viz::mojom::SelectionPtr>::Read(::viz::mojom::Selection::DataView input, ::viz::mojom::SelectionPtr* output)
{
    bool success = true;
