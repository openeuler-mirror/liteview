...
(function() {
  ...
  FilterOperation.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 24, skcolor4f$.SkColor4f, false);
    if (err !== validator.validationError.NONE)
        return err;
    // validate FilterOperation.imageFilter
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 32, paint_filter$.PaintFilter, false);
    if (err !== validator.validationError.NONE)
        return err;
    // validate FilterOperation.matrix
    err = messageValidator.validateArrayPointer(offset + codec.kStructHeaderSize + 40, 4, codec.Float, true, [20], 0);
    if (err !== validator.validationError.NONE)
        return err;

    // validate FilterOperation.blurTileMode
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 48, tile_mode$.TileMode);
    if (err !== validator.validationError.NONE)
        return err;
    // validate FilterOperation.shape
    err = messageValidator.validateArrayPointer(offset + codec.kStructHeaderSize + 56, 8, new codec.PointerTo(geometry$.Rect), true, [0], 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  FilterOperation.encodedSize = codec.kStructHeaderSize + 64;
