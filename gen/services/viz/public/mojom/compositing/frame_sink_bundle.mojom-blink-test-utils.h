...
class BLINK_PLATFORM_EXPORT FrameSinkBundleClientInterceptorForTesting : public FrameSinkBundleClient {
    ...
    void FlushNotifications(
        WTF::Vector<BundledReturnedResourcesPtr> acks, WTF::Vector<BeginFrameInfoPtr> begin_frames, WTF::Vector<BundledReturnedResourcesPtr> reclaimed_resources) override;
