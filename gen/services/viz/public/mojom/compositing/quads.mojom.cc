...
bool DebugBorderQuadState::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
CompositorRenderPassQuadState::CompositorRenderPassQuadState(const ::viz::CompositorRenderPassId& render_pass_id_in, const ::viz::ResourceId& mask_resource_id_in,
...
bool CompositorRenderPassQuadState::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
bool SolidColorQuadState::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
SurfaceQuadState::SurfaceQuadState(
    const ::viz::SurfaceRange& surface_range_in, const ::SkColor4f& default_background_color_in, bool stretch_content_to_fill_bounds_in, bool is_reflection_in, bool allow_merge_in)
...
bool SurfaceQuadState::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
TextureQuadState::TextureQuadState(const ::viz::ResourceId& resource_id_in, const ::gfx::Size& resource_size_in_pixels_in, bool premultiplied_alpha_in,
    const ::gfx::PointF& uv_top_left_in, const ::gfx::PointF& uv_bottom_right_in, const ::SkColor4f& background_color_in, std::vector<float> vertex_opacity_in, bool y_flipped_in,
    bool nearest_neighbor_in, bool secure_output_only_in, bool is_stream_video_in, bool is_video_frame_in, ::gfx::ProtectedVideoType protected_video_type_in,
...
void TextureQuadState::WriteIntoTrace(perfetto::TracedValue traced_context) const
{
    ...
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("vertex_opacity"), this->vertex_opacity,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
bool TextureQuadState::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
TileQuadState::TileQuadState(const ::gfx::RectF& tex_coord_rect_in, const ::gfx::Size& texture_size_in, bool is_premultiplied_in, const ::viz::ResourceId& resource_id_in,
...
bool TileQuadState::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
YUVVideoQuadState::YUVVideoQuadState(const ::gfx::Size& coded_size_in, const ::gfx::Rect& video_visible_rect_in, uint8_t u_scale_in, uint8_t v_scale_in,
...
void YUVVideoQuadState::WriteIntoTrace(perfetto::TracedValue traced_context) const
{
    [[maybe_unused]] auto dict = std::move(traced_context).WriteDictionary();
    ...
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("video_visible_rect"), this->video_visible_rect,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    ...
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("u_scale"), this->u_scale,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    ...
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("v_scale"), this->v_scale,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
        "<value of type uint8_t>"
#else
        "<value>"
    ...
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("y_plane_resource_id"), this->y_plane_resource_id,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
        "<value of type const ::viz::ResourceId&>"
#else
        "<value>"
    ...
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("u_plane_resource_id"), this->u_plane_resource_id,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
        "<value of type const ::viz::ResourceId&>"
#else
        "<value>"
    ...
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("v_plane_resource_id"), this->v_plane_resource_id,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
        "<value of type const ::viz::ResourceId&>"
#else
        "<value>"
    ...
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("a_plane_resource_id"), this->a_plane_resource_id,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
        "<value of type const ::viz::ResourceId&>"
#else
        "<value>"
    ...
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("resource_offset"), this->resource_offset,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
        "<value of type float>"
#else
        "<value>"
    ...
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("resource_multiplier"), this->resource_multiplier,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
        "<value of type float>"
#else
        "<value>"
    ...
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("video_color_space"), this->video_color_space,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
bool YUVVideoQuadState::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
bool VideoHoleQuadState::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
SharedElementQuadState::SharedElementQuadState()
    : resource_id()
{
}

SharedElementQuadState::SharedElementQuadState(const ::viz::SharedElementResourceId& resource_id_in)
    : resource_id(std::move(resource_id_in))
{
}
...
bool SharedElementQuadState::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
DrawQuad::DrawQuad()
    : rect()
    , visible_rect()
    , needs_blending()
...
DrawQuad::DrawQuad(const ::gfx::Rect& rect_in, const ::gfx::Rect& visible_rect_in, bool needs_blending_in, const absl::optional<::viz::SharedQuadState>& sqs_in,
...
bool DrawQuad::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
DrawQuadState::~DrawQuadState() { DestroyActive(); }
...
void DrawQuadState::set_yuv_video_quad_state(YUVVideoQuadStatePtr yuv_video_quad_state)
{
    if (tag_ == Tag::kYuvVideoQuadState) {
        *(data_.yuv_video_quad_state) = std::move(yuv_video_quad_state);
        ...
        data_.yuv_video_quad_state = new YUVVideoQuadStatePtr(std::move(yuv_video_quad_state));
    }
}
...
bool DrawQuadState::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context, false); }
} // namespace mojom
} // namespace viz
namespace mojo {
// static
...
// static
bool StructTraits<::viz::mojom::TileQuadState::DataView, ::viz::mojom::TileQuadStatePtr>::Read(::viz::mojom::TileQuadState::DataView input, ::viz::mojom::TileQuadStatePtr* output)
{
    bool success = true;
...
bool StructTraits<::viz::mojom::YUVVideoQuadState::DataView, ::viz::mojom::YUVVideoQuadStatePtr>::Read(
    ::viz::mojom::YUVVideoQuadState::DataView input, ::viz::mojom::YUVVideoQuadStatePtr* output)
{
    bool success = true;
    ...
    if (success && !input.ReadCodedSize(&result->coded_size))
        success = false;
    if (success && !input.ReadVideoVisibleRect(&result->video_visible_rect))
        success = false;
    if (success)
        result->u_scale = input.u_scale();
    if (success)
        result->v_scale = input.v_scale();
...
// static
bool UnionTraits<::viz::mojom::DrawQuadState::DataView, ::viz::mojom::DrawQuadStatePtr>::Read(::viz::mojom::DrawQuadState::DataView input, ::viz::mojom::DrawQuadStatePtr* output)
{
    ...
    case Tag::kYuvVideoQuadState: {
        ...
        *output = UnionType::NewYuvVideoQuadState(std::move(result_yuv_video_quad_state));
        break;
    }
    case Tag::kVideoHoleQuadState: {
