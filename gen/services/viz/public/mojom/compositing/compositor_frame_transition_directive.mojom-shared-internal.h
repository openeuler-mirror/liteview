...
template <typename UserType, typename DataView>
const mojo::internal::UnserializedMessageContext::Tag CompositorFrameTransitionDirectiveSharedElement_UnserializedMessageContext<UserType, DataView>::kMessageTag = {};
class CompositorFrameTransitionDirective_Data {
public:
    static bool Validate(const void* data, mojo::internal::ValidationContext* validation_context);
...
static_assert(sizeof(CompositorFrameTransitionDirective_Data) == 24, "Bad sizeof(CompositorFrameTransitionDirective_Data)");
// Used by CompositorFrameTransitionDirective::WrapAsMessage to lazily serialize the struct.
template <typename UserType, typename DataView> struct CompositorFrameTransitionDirective_UnserializedMessageContext : public mojo::internal::UnserializedMessageContext {
public:
    static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;
