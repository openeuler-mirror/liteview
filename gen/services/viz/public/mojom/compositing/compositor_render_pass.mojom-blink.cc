...
CompositorRenderPass::CompositorRenderPass(::viz::mojom::blink::CompositorRenderPassIdPtr id_in, const ::gfx::Rect& output_rect_in, const ::gfx::Rect& damage_rect_in,
...
bool CompositorRenderPass::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
} // namespace blink
} // namespace mojom
} // namespace viz
namespace mojo {
