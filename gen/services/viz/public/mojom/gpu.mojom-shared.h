...
using GpuMemoryBufferFactoryPtrDataView = mojo::InterfacePtrDataView<GpuMemoryBufferFactoryInterfaceBase>;
using GpuMemoryBufferFactoryRequestDataView = mojo::InterfaceRequestDataView<GpuMemoryBufferFactoryInterfaceBase>;
using GpuMemoryBufferFactoryAssociatedPtrInfoDataView = mojo::AssociatedInterfacePtrInfoDataView<GpuMemoryBufferFactoryInterfaceBase>;
using GpuMemoryBufferFactoryAssociatedRequestDataView = mojo::AssociatedInterfaceRequestDataView<GpuMemoryBufferFactoryInterfaceBase>;
