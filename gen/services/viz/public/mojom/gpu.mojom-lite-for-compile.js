// services/viz/public/mojom/gpu.mojom-lite-for-compile.js is auto generated by mojom_bindings_generator.py, do not edit
...
goog.provide('viz.mojom.GpuMemoryBufferFactoryReceiver');
goog.provide('viz.mojom.GpuMemoryBufferFactoryCallbackRouter');
goog.provide('viz.mojom.GpuMemoryBufferFactoryInterface');
goog.provide('viz.mojom.GpuMemoryBufferFactoryRemote');
goog.provide('viz.mojom.GpuMemoryBufferFactoryPendingReceiver');
/**
...
goog.provide('viz.mojom.GpuReceiver');
goog.provide('viz.mojom.GpuCallbackRouter');
goog.provide('viz.mojom.GpuInterface');
goog.provide('viz.mojom.GpuRemote');
goog.provide('viz.mojom.GpuPendingReceiver');
/**
 * @implements {mojo.internal.interfaceSupport.PendingReceiver}
 * @export
 */
...
goog.provide('viz.mojom.GpuMemoryBufferFactory_CopyGpuMemoryBuffer_ParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('viz.mojom.GpuMemoryBufferFactory_CopyGpuMemoryBuffer_ResponseParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('viz.mojom.GpuMemoryBufferFactory_CopyGpuMemoryBuffer_Params');
...
goog.provide('viz.mojom.GpuMemoryBufferFactory_CopyGpuMemoryBuffer_ResponseParams');
