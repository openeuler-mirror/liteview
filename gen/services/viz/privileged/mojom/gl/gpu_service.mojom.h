...
public:
    ...
    static inline constexpr uint32_t kSyncMethodOrdinals[] = { 850795193, 1632356135 };
...
// with not having this data in traces there.
    ...
    using EstablishGpuChannelCallback = base::OnceCallback<void(::mojo::ScopedMessagePipeHandle, const ::gpu::GPUInfo&, const ::gpu::GpuFeatureInfo&)>;
    ...
    using RegisterDCOMPSurfaceHandleCallback = base::OnceCallback<void(const absl::optional<::base::UnguessableToken>&)>;
    ...
    virtual bool CreateGpuMemoryBuffer(::gfx::GpuMemoryBufferId id, const ::gfx::Size& size, ::gfx::BufferFormat format, ::gfx::BufferUsage usage, int32_t client_id,
    ...
    virtual void CreateGpuMemoryBuffer(::gfx::GpuMemoryBufferId id, const ::gfx::Size& size, ::gfx::BufferFormat format, ::gfx::BufferUsage usage, int32_t client_id,
    ...
    virtual void GetDawnInfo(GetDawnInfoCallback callback) = 0;
...
//
//   bool EstablishGpuChannel(int32_t client_id, uint64_t client_tracing_id, bool is_gpu_host, ::mojo::ScopedMessagePipeHandle* out_channel_handle, ::gpu::GPUInfo* out_gpu_info,
//   ::gpu::GpuFeatureInfo* out_gpu_feature_info) final;
//
...
//
//   bool CreateGpuMemoryBuffer(::gfx::GpuMemoryBufferId id, const ::gfx::Size& size, ::gfx::BufferFormat format, ::gfx::BufferUsage usage, int32_t client_id, ::gpu::SurfaceHandle
//   surface_handle, ::gfx::GpuMemoryBufferHandle* out_buffer_handle) final;
//
//   void CreateGpuMemoryBuffer(::gfx::GpuMemoryBufferId id, const ::gfx::Size& size, ::gfx::BufferFormat format, ::gfx::BufferUsage usage, int32_t client_id, ::gpu::SurfaceHandle
//   surface_handle, CreateGpuMemoryBufferCallback callback) final;
//
...
//
//   void GetDawnInfo(GetDawnInfoCallback callback) final;
//
//   void Crash() final;
//
//   void Hang() final;
