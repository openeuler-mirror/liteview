...
static NOINLINE const char* ContextLostReasonToStringHelper(ContextLostReason value)
{
...
std::ostream& operator<<(std::ostream& os, ContextLostReason value) { return os << ContextLostReasonToString(value); }
