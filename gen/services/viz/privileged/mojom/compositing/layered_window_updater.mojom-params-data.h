...
public:
    ...
    LayeredWindowUpdater_OnAllocatedSharedMemory_ParamsDataView(internal::LayeredWindowUpdater_OnAllocatedSharedMemory_Params_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
