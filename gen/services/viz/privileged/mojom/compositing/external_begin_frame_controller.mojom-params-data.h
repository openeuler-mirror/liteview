...
static_assert(sizeof(ExternalBeginFrameController_IssueExternalBeginFrame_Params_Data) == 24, "Bad sizeof(ExternalBeginFrameController_IssueExternalBeginFrame_Params_Data)");
...
static_assert(
    sizeof(ExternalBeginFrameController_IssueExternalBeginFrame_ResponseParams_Data) == 16, "Bad sizeof(ExternalBeginFrameController_IssueExternalBeginFrame_ResponseParams_Data)");
...
public:
    ...
    ExternalBeginFrameController_IssueExternalBeginFrame_ParamsDataView(internal::ExternalBeginFrameController_IssueExternalBeginFrame_Params_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
