...
public:
    ...
    static VideoCaptureSubTargetPtr NewSubtreeCaptureId(const ::viz::SubtreeCaptureId& subtree_capture_id)
    {
    ...
    static VideoCaptureSubTargetPtr NewRegionCaptureCropId(const ::base::Token& region_capture_crop_id)
    {
        auto result = VideoCaptureSubTargetPtr(absl::in_place);
    ...
    template <typename U> static VideoCaptureSubTargetPtr From(const U& u) { return mojo::TypeConverter<VideoCaptureSubTargetPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, VideoCaptureSubTarget>::Convert(*this); }

    VideoCaptureSubTarget();
    ~VideoCaptureSubTarget() = default;
    ...
    template <typename T, typename std::enable_if<std::is_same<T, VideoCaptureSubTarget>::value>::type* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    ...
    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<VideoCaptureSubTarget::DataView>(input); }
...
public:
    ...
    template <typename... Args> static VideoCaptureTargetPtr New(Args&&... args) { return VideoCaptureTargetPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static VideoCaptureTargetPtr From(const U& u) { return mojo::TypeConverter<VideoCaptureTargetPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, VideoCaptureTarget>::Convert(*this); }
    VideoCaptureTarget()
        : frame_sink_id()
        , sub_target()
    {
    ...
    VideoCaptureTarget(const ::viz::FrameSinkId& frame_sink_id_in, const ::viz::VideoCaptureSubTarget& sub_target_in)
    ...
    template <typename T, VideoCaptureTarget::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    ...
    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<VideoCaptureTarget::DataView>(input); }
    ...
    {
        return mojo::Message(std::make_unique<internal::VideoCaptureTarget_UnserializedMessageContext<UserType, VideoCaptureTarget::DataView>>(0, 0, std::move(input)),
    ...
    {
        return VideoCaptureTarget::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, VideoCaptureTarget::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, VideoCaptureTarget::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, VideoCaptureTarget::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
template <typename StructPtrType> VideoCaptureTargetPtr VideoCaptureTarget::Clone() const { return New(mojo::Clone(frame_sink_id), mojo::Clone(sub_target)); }
...
template <> struct StructTraits<::viz::mojom::VideoCaptureTarget::DataView, ::viz::mojom::VideoCaptureTargetPtr> {
    ...
    static const decltype(::viz::mojom::VideoCaptureTarget::frame_sink_id)& frame_sink_id(const ::viz::mojom::VideoCaptureTargetPtr& input) { return input->frame_sink_id; }

    static const decltype(::viz::mojom::VideoCaptureTarget::sub_target)& sub_target(const ::viz::mojom::VideoCaptureTargetPtr& input) { return input->sub_target; }
...
template <> struct UnionTraits<::viz::mojom::VideoCaptureSubTarget::DataView, ::viz::mojom::VideoCaptureSubTargetPtr> {
    ...
    static ::viz::mojom::VideoCaptureSubTarget::Tag GetTag(const ::viz::mojom::VideoCaptureSubTargetPtr& input) { return input->which(); }

    static const ::viz::SubtreeCaptureId& subtree_capture_id(const ::viz::mojom::VideoCaptureSubTargetPtr& input) { return input->get_subtree_capture_id(); }

    static const ::base::Token& region_capture_crop_id(const ::viz::mojom::VideoCaptureSubTargetPtr& input) { return input->get_region_capture_crop_id(); }
