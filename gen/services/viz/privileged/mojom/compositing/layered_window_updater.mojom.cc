...
void LayeredWindowUpdaterProxy::OnAllocatedSharedMemory(const ::gfx::Size& in_pixel_size, ::base::UnsafeSharedMemoryRegion in_region)
{
    ...
    mojo::Message message(internal::kLayeredWindowUpdater_OnAllocatedSharedMemory_Name, kFlags, 0, 0, nullptr);
    ...
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
        params->pixel_size.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null pixel_size in LayeredWindowUpdater.OnAllocatedSharedMemory request");
    ...
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
        params->region.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null region in LayeredWindowUpdater.OnAllocatedSharedMemory request");
...
void LayeredWindowUpdaterProxy::Draw(DrawCallback callback)
{
    ...
    mojo::Message message(internal::kLayeredWindowUpdater_Draw_Name, kFlags, 0, 0, nullptr);
...
bool LayeredWindowUpdater_Draw_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    internal::LayeredWindowUpdater_Draw_ResponseParams_Data* params = reinterpret_cast<internal::LayeredWindowUpdater_Draw_ResponseParams_Data*>(message->mutable_payload());
...
bool LayeredWindowUpdaterStubDispatch::Accept(LayeredWindowUpdater* impl, mojo::Message* message)
{
    ...
    case internal::kLayeredWindowUpdater_OnAllocatedSharedMemory_Name: {
        ...
        bool success = true;
        ::gfx::Size p_pixel_size = mojo::DefaultConstructTraits::CreateInstance<::gfx::Size>();
...
// static
bool LayeredWindowUpdaterStubDispatch::AcceptWithResponder(LayeredWindowUpdater* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
{
    ...
    case internal::kLayeredWindowUpdater_Draw_Name: {
        ...
        internal::LayeredWindowUpdater_Draw_Params_Data* params = reinterpret_cast<internal::LayeredWindowUpdater_Draw_Params_Data*>(message->mutable_payload());
...
static const std::pair<uint32_t, mojo::internal::GenericValidationInfo> kLayeredWindowUpdaterValidationInfo[] = {
    { internal::kLayeredWindowUpdater_OnAllocatedSharedMemory_Name, { &internal::LayeredWindowUpdater_OnAllocatedSharedMemory_Params_Data::Validate, nullptr /* no response */ } },
...
void LayeredWindowUpdaterInterceptorForTesting::Draw(DrawCallback callback) { GetForwardingInterface()->Draw(std::move(callback)); }
