...
public:
    ...
    uint8_t set_present_duration_allowed : 1;
    uint8_t pad5_[3];
...
template <typename UserType, typename DataView> struct RootCompositorFrameSinkParams_UnserializedMessageContext : public mojo::internal::UnserializedMessageContext {
public:
