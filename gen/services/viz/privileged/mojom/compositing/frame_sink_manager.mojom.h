...
public:
    ...
    static inline constexpr uint32_t kSyncMethodOrdinals[] = { 474613673, 878262029 };
...
// with not having this data in traces there.
    ...
    struct CacheBackBuffer_Sym {
        NOINLINE static uint32_t IPCStableHash();
    };
    struct EvictBackBuffer_Sym {
        NOINLINE static uint32_t IPCStableHash();
    };
    ...
    virtual void CreateCompositorFrameSink(const ::viz::FrameSinkId& frame_sink_id, const absl::optional<::viz::FrameSinkBundleId>& bundle_id,
...
//
//   void CreateCompositorFrameSink(const ::viz::FrameSinkId& frame_sink_id, const absl::optional<::viz::FrameSinkBundleId>& bundle_id,
...
public:
    ...
    {
        return RootCompositorFrameSinkParamsPtr(absl::in_place, std::forward<Args>(args)...);
    }

    template <typename U> static RootCompositorFrameSinkParamsPtr From(const U& u) { return mojo::TypeConverter<RootCompositorFrameSinkParamsPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, RootCompositorFrameSinkParams>::Convert(*this); }
    ...
    RootCompositorFrameSinkParams(const ::viz::FrameSinkId& frame_sink_id_in, ::gpu::SurfaceHandle widget_in, bool gpu_compositing_in,
    ...
    template <typename T, RootCompositorFrameSinkParams::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::RootCompositorFrameSinkParams_UnserializedMessageContext<UserType, RootCompositorFrameSinkParams::DataView>>(0, 0, std::move(input)),
    ...
    {
        return RootCompositorFrameSinkParams::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }

    template <typename UserType> static bool DeserializeFromMessage(mojo::Message input, UserType* output)
    {
        auto context = input.TakeUnserializedContext<internal::RootCompositorFrameSinkParams_UnserializedMessageContext<UserType, RootCompositorFrameSinkParams::DataView>>();
        if (context) {
    ...
    bool set_present_duration_allowed;
...
template <typename T, RootCompositorFrameSinkParams::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, RootCompositorFrameSinkParams::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, RootCompositorFrameSinkParams::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }

template <typename StructPtrType> RootCompositorFrameSinkParamsPtr RootCompositorFrameSinkParams::Clone() const
{
    return New(mojo::Clone(frame_sink_id), mojo::Clone(widget), mojo::Clone(gpu_compositing), mojo::Clone(renderer_settings), mojo::Clone(send_swap_size_notifications),
        mojo::Clone(disable_frame_rate_limit), mojo::Clone(set_present_duration_allowed), mojo::Clone(compositor_frame_sink), mojo::Clone(compositor_frame_sink_client),
        mojo::Clone(display_private), mojo::Clone(display_client), mojo::Clone(external_begin_frame_controller));
}
...
template <typename T, RootCompositorFrameSinkParams::EnableIfSame<T>*> bool RootCompositorFrameSinkParams::Equals(const T& other_struct) const
{
    ...
    if (!mojo::Equals(this->disable_frame_rate_limit, other_struct.disable_frame_rate_limit))
        return false;
    if (!mojo::Equals(this->set_present_duration_allowed, other_struct.set_present_duration_allowed))
        return false;
...
template <typename T, RootCompositorFrameSinkParams::EnableIfSame<T>*> bool operator<(const T& lhs, const T& rhs)
{
    ...
    if (rhs.disable_frame_rate_limit < lhs.disable_frame_rate_limit)
        return false;
    if (lhs.set_present_duration_allowed < rhs.set_present_duration_allowed)
        return true;
    if (rhs.set_present_duration_allowed < lhs.set_present_duration_allowed)
        return false;
...
template <> struct StructTraits<::viz::mojom::RootCompositorFrameSinkParams::DataView, ::viz::mojom::RootCompositorFrameSinkParamsPtr> {
    ...
    static const decltype(::viz::mojom::RootCompositorFrameSinkParams::frame_sink_id)& frame_sink_id(const ::viz::mojom::RootCompositorFrameSinkParamsPtr& input)
    {
        return input->frame_sink_id;
    }

    static const decltype(::viz::mojom::RootCompositorFrameSinkParams::widget)& widget(const ::viz::mojom::RootCompositorFrameSinkParamsPtr& input) { return input->widget; }
    ...
    static const decltype(::viz::mojom::RootCompositorFrameSinkParams::renderer_settings)& renderer_settings(const ::viz::mojom::RootCompositorFrameSinkParamsPtr& input)
    {
    ...
    static decltype(::viz::mojom::RootCompositorFrameSinkParams::disable_frame_rate_limit) disable_frame_rate_limit(const ::viz::mojom::RootCompositorFrameSinkParamsPtr& input)
    {
        return input->disable_frame_rate_limit;
    }

    static decltype(::viz::mojom::RootCompositorFrameSinkParams::set_present_duration_allowed) set_present_duration_allowed(
        const ::viz::mojom::RootCompositorFrameSinkParamsPtr& input)
    {
        return input->set_present_duration_allowed;
    }

    static decltype(::viz::mojom::RootCompositorFrameSinkParams::compositor_frame_sink)& compositor_frame_sink(::viz::mojom::RootCompositorFrameSinkParamsPtr& input)
    {
        return input->compositor_frame_sink;
    }

    static decltype(::viz::mojom::RootCompositorFrameSinkParams::compositor_frame_sink_client)& compositor_frame_sink_client(::viz::mojom::RootCompositorFrameSinkParamsPtr& input)
    {
