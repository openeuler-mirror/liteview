...
(function() {
  ...
  RenderFrameMetadata.prototype.initDefaults_ = function() {
    ...
    this.previousSurfacesVisualUpdateDuration = null;
    this.currentSurfaceVisualUpdateDuration = null;
  };
  ...
  RenderFrameMetadata.validate = function(messageValidator, offset) {
    ...
    if (err !== validator.validationError.NONE)
        return err;
    // validate RenderFrameMetadata.previousSurfacesVisualUpdateDuration
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 80, time$.TimeDelta, false);
    if (err !== validator.validationError.NONE)
        return err;
    // validate RenderFrameMetadata.currentSurfaceVisualUpdateDuration
  ...
  RenderFrameMetadata.encodedSize = codec.kStructHeaderSize + 96;
  ...
  RenderFrameMetadata.decode = function(decoder) {
    ...
    decoder.skip(1);
    decoder.skip(1);
    val.previousSurfacesVisualUpdateDuration =
        decoder.decodeStructPointer(time$.TimeDelta);
    val.currentSurfaceVisualUpdateDuration =
        decoder.decodeStructPointer(time$.TimeDelta);
    return val;
  };
  ...
  RenderFrameMetadata.encode = function(encoder, val) {
    ...
    encoder.skip(1);
    encoder.skip(1);
    encoder.encodeStructPointer(time$.TimeDelta, val.previousSurfacesVisualUpdateDuration);
    encoder.encodeStructPointer(time$.TimeDelta, val.currentSurfaceVisualUpdateDuration);
  };
  ...
  var kRenderFrameMetadataObserver_ReportAllFrameSubmissionsForTesting_Name = 1593204279;
  ...
  var kRenderFrameMetadataObserverClient_OnRenderFrameMetadataChanged_Name = 1309162449;
  var kRenderFrameMetadataObserverClient_OnFrameSubmissionForTesting_Name = 1349303148;
