    ...
    if (block0.is_used()) {
        ...
        InitializeFieldsFromIterator_uint8_ConstantIterator_uint8_0(state_,
            TorqueStructSlice_uint8_MutableReference_uint8_0 {
                TNode<Object> { tmp30 }, TNode<IntPtrT> { tmp37 }, TNode<IntPtrT> { tmp12 }, TorqueStructUnsafe_0 {} },
        ...
        InitializeFieldsFromIterator_uint8_ConstantIterator_uint8_0(state_,
            TorqueStructSlice_uint8_MutableReference_uint8_0 {
                TNode<Object> { tmp30 }, TNode<IntPtrT> { tmp20 }, TNode<IntPtrT> { tmp21 }, TorqueStructUnsafe_0 {} },
            TorqueStructConstantIterator_uint8_0 { TNode<Uint8T> { tmp9 } });
        InitializeFieldsFromIterator_uint8_ConstantIterator_uint8_0(state_,
            TorqueStructSlice_uint8_MutableReference_uint8_0 {
                TNode<Object> { tmp30 }, TNode<IntPtrT> { tmp22 }, TNode<IntPtrT> { tmp26 }, TorqueStructUnsafe_0 {} },
...
TNode<SmallOrderedHashMap> AllocateSmallOrderedHashMap_0(compiler::CodeAssemblerState* state_, TNode<IntPtrT> p_capacity)
{
    ...
    if (block0.is_used()) {
        ...
        InitializeFieldsFromIterator_uint8_ConstantIterator_uint8_0(state_,
            TorqueStructSlice_uint8_MutableReference_uint8_0 {
                TNode<Object> { tmp32 }, TNode<IntPtrT> { tmp39 }, TNode<IntPtrT> { tmp14 }, TorqueStructUnsafe_0 {} },
            TorqueStructConstantIterator_uint8_0 { TNode<Uint8T> { tmp5 } });
        ...
        InitializeFieldsFromIterator_HashMapEntry_ConstantIterator_HashMapEntry_0(state_,
            TorqueStructSlice_HashMapEntry_MutableReference_HashMapEntry_0 {
                TNode<Object> { tmp32 }, TNode<IntPtrT> { tmp40 }, TNode<IntPtrT> { tmp20 }, TorqueStructUnsafe_0 {} },
            TorqueStructConstantIterator_HashMapEntry_0 { TorqueStructHashMapEntry_0 { TNode<Object> { tmp8 }, TNode<Object> { tmp9 } } });
        InitializeFieldsFromIterator_uint8_ConstantIterator_uint8_0(state_,
            TorqueStructSlice_uint8_MutableReference_uint8_0 {
                TNode<Object> { tmp32 }, TNode<IntPtrT> { tmp22 }, TNode<IntPtrT> { tmp23 }, TorqueStructUnsafe_0 {} },
            TorqueStructConstantIterator_uint8_0 { TNode<Uint8T> { tmp11 } });
        InitializeFieldsFromIterator_uint8_ConstantIterator_uint8_0(state_,
            TorqueStructSlice_uint8_MutableReference_uint8_0 {
                TNode<Object> { tmp32 }, TNode<IntPtrT> { tmp24 }, TNode<IntPtrT> { tmp28 }, TorqueStructUnsafe_0 {} },
...
TNode<Object> LoadSmallOrderedHashSetDataTable_0(compiler::CodeAssemblerState* state_, TNode<SmallOrderedHashSet> p_o, TNode<IntPtrT> p_i)
{
    ...
    if (block6.is_used()) {
        ca_.Bind(&block6);
        tmp6 = TimesSizeOf_JSReceiver_OR_Undefined_OR_Null_OR_False_OR_True_OR_Symbol_OR_String_OR_BigInt_OR_HeapNumber_OR_Smi_OR_TheHole_0(
    ...
    compiler::CodeAssemblerState* state_, TNode<HeapObject> p_o, compiler::CodeAssemblerLabel* label_CastError)
{
    ...
    if (block4.is_used()) {
        ...
        tmp8 = FromConstexpr_int32_constexpr_int32_0(
            state_, (CodeStubAssembler(state_).ConstexprUint32Sub(static_cast<InstanceType>(225), static_cast<InstanceType>(223))));
