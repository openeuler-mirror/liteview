...
TNode<JSFunction> CreatePromiseAllResolveElementFunction_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context,
    TNode<Context> p_resolveElementContext, TNode<Smi> p_index, TNode<NativeContext> p_nativeContext, TNode<SharedFunctionInfo> p_resolveFunction)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    if (block0.is_used()) {
        ...
        std::tie(tmp1, tmp2)
            = ContextSlot_NativeContext_NativeContext_Map_0(state_, TNode<NativeContext> { p_nativeContext }, TNode<IntPtrT> { tmp0 }).Flatten();
...
TNode<Context> CreatePromiseResolvingFunctionsContext_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSPromise> p_promise,
    TNode<Oddball> p_debugEvent, TNode<NativeContext> p_nativeContext)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    compiler::TypedCodeAssemblerVariable<Object>* label_Reject_parameter_0)
{
    ...
    if (block63.is_used()) {
        ...
        compiler::CodeAssemblerExceptionHandlerLabel catch144__label(&ca_, compiler::CodeAssemblerLabel::kDeferred);
        {
            ...
            tmp143 = CodeStubAssembler(state_).SetPropertyStrict(
                TNode<Context> { p_context }, TNode<Object> { tmp124 }, TNode<Object> { tmp142 }, TNode<Object> { tmp1 });
        }
    ...
    if (block34.is_used()) {
        ...
        compiler::CodeAssemblerExceptionHandlerLabel catch151__label(&ca_, compiler::CodeAssemblerLabel::kDeferred);
        {
            ...
            PerformPromiseThenImpl_0(state_, TNode<Context> { p_context }, TNode<JSPromise> { tmp147 }, TNode<HeapObject> { tmp60 },
                TNode<HeapObject> { tmp63 }, TNode<HeapObject> { tmp150 });
        }
    ...
    if (block5.is_used()) {
        ...
        std::tie(tmp164, tmp165)
            = ContextSlot_PromiseAllResolveElementContext_PromiseAllResolveElementContext_Smi_0(state_, TNode<Context> { tmp10 }, TNode<IntPtrT> { tmp163 })
                  .Flatten();
    ...
    if (block78.is_used()) {
        ...
        std::tie(tmp174, tmp175) = ContextSlot_PromiseAllResolveElementContext_PromiseAllResolveElementContext_FixedArray_0(
            state_, TNode<Context> { tmp10 }, TNode<IntPtrT> { tmp173 })
                                       .Flatten();
    ...
    if (block79.is_used()) {
        ...
        std::tie(tmp185, tmp186) = ContextSlot_PromiseAllResolveElementContext_PromiseAllResolveElementContext_FixedArray_0(
            state_, TNode<Context> { tmp10 }, TNode<IntPtrT> { tmp184 })
                                       .Flatten();
        ...
        tmp195
            = CodeStubAssembler(state_).Call(TNode<Context> { p_nativeContext }, TNode<Object> { tmp193 }, TNode<Object> { tmp194 }, TNode<Object> { tmp192 });
    ...
    compiler::TypedCodeAssemblerVariable<Object>* label_Reject_parameter_0)
{
    ...
    if (block34.is_used()) {
        ...
        compiler::CodeAssemblerExceptionHandlerLabel catch150__label(&ca_, compiler::CodeAssemblerLabel::kDeferred);
        {
            ...
            PerformPromiseThenImpl_0(state_, TNode<Context> { p_context }, TNode<JSPromise> { tmp146 }, TNode<HeapObject> { tmp60 },
    ...
    if (block78.is_used()) {
        ...
        std::tie(tmp173, tmp174) = ContextSlot_PromiseAllResolveElementContext_PromiseAllResolveElementContext_FixedArray_0(
            state_, TNode<Context> { tmp10 }, TNode<IntPtrT> { tmp172 })
                                       .Flatten();
    ...
    if (block79.is_used()) {
        ...
        std::tie(tmp184, tmp185) = ContextSlot_PromiseAllResolveElementContext_PromiseAllResolveElementContext_FixedArray_0(
            state_, TNode<Context> { tmp10 }, TNode<IntPtrT> { tmp183 })
                                       .Flatten();
        ...
        tmp194
            = CodeStubAssembler(state_).Call(TNode<Context> { p_nativeContext }, TNode<Object> { tmp192 }, TNode<Object> { tmp193 }, TNode<Object> { tmp191 });
        ca_.Goto(&block80, phi_bb79_11);
    }
