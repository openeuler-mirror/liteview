...
TNode<String> NumberToStringSmi_0(compiler::CodeAssemblerState* state_, TNode<Int32T> p_x, TNode<Int32T> p_radix, compiler::CodeAssemblerLabel* label_Slow)
{
    ...
    compiler::CodeAssemblerParameterizedLabel<Int32T, Int32T, IntPtrT, IntPtrT, IntPtrT, IntPtrT, IntPtrT> block34(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<Int32T, Int32T, IntPtrT, IntPtrT, IntPtrT, IntPtrT, IntPtrT> block35(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    if (block27.is_used()) {
        ...
        ca_.Branch(tmp34, &block34, std::vector<compiler::Node*> { phi_bb27_4, phi_bb27_5, phi_bb27_7, phi_bb27_7, phi_bb27_7, phi_bb27_7, phi_bb27_7 },
            &block35, std::vector<compiler::Node*> { phi_bb27_4, phi_bb27_5, phi_bb27_7, phi_bb27_7, phi_bb27_7, phi_bb27_7, phi_bb27_7 });
    }
...
TF_BUILTIN(BitwiseOr, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        tmp0 = BinaryOpAssembler(state_).Generate_BitwiseBinaryOp(
            Operation::kBitwiseOr, TNode<Object> { parameter1 }, TNode<Object> { parameter2 }, TNode<Context> { parameter0 });
        CodeStubAssembler(state_).Return(tmp0);
    }
}
...
TF_BUILTIN(BitwiseXor, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        tmp0 = BinaryOpAssembler(state_).Generate_BitwiseBinaryOp(
            Operation::kBitwiseXor, TNode<Object> { parameter1 }, TNode<Object> { parameter2 }, TNode<Context> { parameter0 });
        CodeStubAssembler(state_).Return(tmp0);
    }
}
