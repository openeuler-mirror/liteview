    ...
    compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSReceiver> p_regexp, TNode<String> p_string, bool p_isFastPath)
{
    ...
    compiler::CodeAssemblerParameterizedLabel<FixedArray, IntPtrT, IntPtrT, BoolT, String, HeapObject> block66(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<FixedArray, IntPtrT, IntPtrT, BoolT, String, String, String, Object> block88(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<FixedArray, IntPtrT, IntPtrT, BoolT, String, String, String, Object> block89(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<BoolT, String, String, String, Object, IntPtrT, IntPtrT, IntPtrT, IntPtrT> block107(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<BoolT, String, String, String, Object, IntPtrT, IntPtrT, IntPtrT, IntPtrT> block108(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    if (block45.is_used()) {
        ...
        ca_.Branch(tmp47, &block43, std::vector<compiler::Node*> { phi_bb45_5, phi_bb45_6, phi_bb45_7, phi_bb45_8, phi_bb45_9 }, &block44,
            std::vector<compiler::Node*> { phi_bb45_5, phi_bb45_6, phi_bb45_7, phi_bb45_8, phi_bb45_9 });
    }
    ...
    if (block50.is_used()) {
        ...
        tmp50
            = RegExpPrototypeExecBodyWithoutResultFast_0(state_, TNode<Context> { p_context }, TNode<JSRegExp> { tmp49 }, TNode<String> { p_string }, &label51);
    ...
    if (block53.is_used()) {
        ...
        ca_.Branch(phi_bb53_8, &block55, std::vector<compiler::Node*> { phi_bb53_5, phi_bb53_6, phi_bb53_7, phi_bb53_8, phi_bb53_9 }, &block56,
            std::vector<compiler::Node*> { phi_bb53_5, phi_bb53_6, phi_bb53_7, phi_bb53_8, phi_bb53_9 });
    }
    ...
    if (block56.is_used()) {
        ...
        tmp53 = CodeStubAssembler(state_).UnsafeLoadFixedArrayElement(TNode<RegExpMatchInfo> { tmp50 },
            (CodeStubAssembler(state_).ConstexprInt31Add(
                RegExpMatchInfo::kFirstCaptureIndex, (FromConstexpr_constexpr_int31_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x1ull))))));
    ...
    if (block51.is_used()) {
        ...
        ca_.Branch(tmp59, &block62, std::vector<compiler::Node*> { phi_bb51_5, phi_bb51_6, phi_bb51_7, phi_bb51_8, phi_bb51_9 }, &block63,
            std::vector<compiler::Node*> { phi_bb51_5, phi_bb51_6, phi_bb51_7, phi_bb51_8, phi_bb51_9 });
    }
    ...
    if (block52.is_used()) {
        ...
        ca_.Branch(tmp63, &block88,
            std::vector<compiler::Node*> { phi_bb52_5, phi_bb52_6, phi_bb52_7, phi_bb52_8, phi_bb52_9, phi_bb52_10, phi_bb52_10, phi_bb52_10 }, &block89,
            std::vector<compiler::Node*> { phi_bb52_5, phi_bb52_6, phi_bb52_7, phi_bb52_8, phi_bb52_9, phi_bb52_10, phi_bb52_10, phi_bb52_10 });
    }
    ...
    if (block49.is_used()) {
        ...
        ca_.Branch(tmp65, &block64, std::vector<compiler::Node*> { phi_bb49_5, phi_bb49_6, phi_bb49_7, phi_bb49_8, phi_bb49_9 }, &block65,
            std::vector<compiler::Node*> { phi_bb49_5, phi_bb49_6, phi_bb49_7, phi_bb49_8, phi_bb49_9 });
    }
    ...
    if (block65.is_used()) {
        ...
        tmp70 = ExtractFixedArray_0(
            state_, TNode<FixedArray> { phi_bb65_5 }, TNode<IntPtrT> { tmp69 }, TNode<IntPtrT> { phi_bb65_7 }, TNode<IntPtrT> { phi_bb65_7 });
    ...
    if (block88.is_used()) {
        ...
        tmp79
            = ExtractFixedArray_0(state_, TNode<FixedArray> { phi_bb88_5 }, TNode<IntPtrT> { tmp78 }, TNode<IntPtrT> { phi_bb88_7 }, TNode<IntPtrT> { tmp77 });
    ...
    if (block89.is_used()) {
        ...
        ca_.Branch(tmp87, &block107,
            std::vector<compiler::Node*> { phi_bb89_8, phi_bb89_9, phi_bb89_10, phi_bb89_11, phi_bb89_12, phi_bb89_7, phi_bb89_7, phi_bb89_7, phi_bb89_7 },
            &block108,
            std::vector<compiler::Node*> { phi_bb89_8, phi_bb89_9, phi_bb89_10, phi_bb89_11, phi_bb89_12, phi_bb89_7, phi_bb89_7, phi_bb89_7, phi_bb89_7 });
    }
    ...
    if (block107.is_used()) {
        ca_.Bind(
            &block107, &phi_bb107_8, &phi_bb107_9, &phi_bb107_10, &phi_bb107_11, &phi_bb107_12, &phi_bb107_17, &phi_bb107_18, &phi_bb107_22, &phi_bb107_23);
        ...
        ca_.Branch(tmp94, &block111, std::vector<compiler::Node*> { phi_bb107_8, phi_bb107_9, phi_bb107_10 }, &block112,
            std::vector<compiler::Node*> { phi_bb107_8, phi_bb107_9, phi_bb107_10 });
    }
    ...
    if (block108.is_used()) {
        ca_.Bind(
            &block108, &phi_bb108_8, &phi_bb108_9, &phi_bb108_10, &phi_bb108_11, &phi_bb108_12, &phi_bb108_17, &phi_bb108_18, &phi_bb108_22, &phi_bb108_23);
        CodeStubAssembler(state_).Unreachable();
    }
    ...
    if (block115.is_used()) {
        ...
        tmp98 = RegExpBuiltinsAssembler(state_).AdvanceStringIndex(
            TNode<String> { p_string }, TNode<Number> { tmp97 }, TNode<BoolT> { phi_bb21_5 }, p_isFastPath);
        if ((p_isFastPath)) {
