...
TF_BUILTIN(ConvertToLocaleString, CodeStubAssembler)
{
    ...
    if (block10.is_used()) {
        ca_.Bind(&block10);
        tmp9
            = CodeStubAssembler(state_).Call(TNode<Context> { parameter0 }, TNode<Object> { tmp4 }, TNode<Object> { parameter1 }, TNode<Object> { parameter2 });
    ...
    TNode<String> p_sep, TNode<Number> p_lenNumber, TNode<Object> p_locales, TNode<Object> p_options)
{
    ...
    if (block4.is_used()) {
        ...
        tmp48 = ArrayJoinImpl_JSTypedArray_0(state_, TNode<Context> { p_context }, TNode<JSReceiver> { p_receiver }, TNode<String> { p_sep },
    ...
    TNode<Number> p_lengthNumber, bool p_useToLocaleString, TNode<Object> p_locales, TNode<Object> p_options, TNode<BuiltinPtr> p_initialLoadFn)
{
    ...
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<IntPtrT, BuiltinPtr, FixedArray, IntPtrT, IntPtrT, BoolT, UintPtrT> block4(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<IntPtrT, BuiltinPtr, FixedArray, IntPtrT, IntPtrT, BoolT, UintPtrT> block2(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<IntPtrT, BuiltinPtr, FixedArray, IntPtrT, IntPtrT, BoolT, UintPtrT> block5(
        &ca_, compiler::CodeAssemblerLabel::kDeferred);
    compiler::CodeAssemblerParameterizedLabel<IntPtrT, BuiltinPtr, FixedArray, IntPtrT, IntPtrT, BoolT, UintPtrT> block6(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    compiler::CodeAssemblerParameterizedLabel<FixedArray, IntPtrT, IntPtrT, BoolT, String, String, String> block30(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<FixedArray, IntPtrT, IntPtrT, BoolT, String, String, String> block31(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<FixedArray, IntPtrT, IntPtrT, BoolT, String, String, String, BoolT> block32(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<FixedArray, IntPtrT, IntPtrT, BoolT, String, String, String> block28(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<FixedArray, IntPtrT, IntPtrT, BoolT, String, String, String> block29(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<FixedArray, IntPtrT, IntPtrT, BoolT, String, String, String> block33(
        &ca_, compiler::CodeAssemblerLabel::kDeferred);
    compiler::CodeAssemblerParameterizedLabel<FixedArray, IntPtrT, IntPtrT, BoolT, String, String, String> block34(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    compiler::CodeAssemblerParameterizedLabel<FixedArray, IntPtrT, IntPtrT, BoolT, String, String, String> block27(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<IntPtrT, BuiltinPtr, FixedArray, IntPtrT, IntPtrT, BoolT, UintPtrT> block3(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    if (block2.is_used()) {
        ...
        tmp11 = CannotUseSameArrayAccessor_JSArray_0(state_, TNode<Context> { p_context }, TNode<BuiltinPtr> { phi_bb2_11 }, TNode<JSReceiver> { p_receiver },
    ...
    if (block5.is_used()) {
        ...
        ca_.Goto(&block6, phi_bb5_10, ca_.UncheckedCast<BuiltinPtr>(ca_.SmiConstant(Builtin::kLoadJoinElement_GenericElementsAccessor_0)), phi_bb5_12,
            phi_bb5_13, phi_bb5_14, phi_bb5_15, phi_bb5_16);
    }
    ...
    if (block11.is_used()) {
        ...
        ca_.Branch(tmp37, &block30, std::vector<compiler::Node*> { phi_bb11_12, phi_bb11_13, phi_bb11_14, phi_bb11_15, phi_bb11_18, phi_bb11_18, phi_bb11_18 },
            &block31, std::vector<compiler::Node*> { phi_bb11_12, phi_bb11_13, phi_bb11_14, phi_bb11_15, phi_bb11_18, phi_bb11_18, phi_bb11_18 });
    }
    ...
    if (block32.is_used()) {
        ...
        ca_.Branch(phi_bb32_37, &block28,
            std::vector<compiler::Node*> { phi_bb32_12, phi_bb32_13, phi_bb32_14, phi_bb32_15, phi_bb32_18, phi_bb32_19, phi_bb32_24 }, &block29,
    ...
    if (block29.is_used()) {
        ...
        ca_.Branch(tmp43, &block33, std::vector<compiler::Node*> { phi_bb29_12, phi_bb29_13, phi_bb29_14, phi_bb29_15, phi_bb29_18, phi_bb29_19, phi_bb29_24 },
            &block34, std::vector<compiler::Node*> { phi_bb29_12, phi_bb29_13, phi_bb29_14, phi_bb29_15, phi_bb29_18, phi_bb29_19, phi_bb29_24 });
    }
    ...
    if (block3.is_used()) {
        ...
        ca_.Branch(tmp60, &block40,
            std::vector<compiler::Node*> { phi_bb3_10, phi_bb3_11, phi_bb3_12, phi_bb3_13, phi_bb3_14, phi_bb3_15, phi_bb3_16, phi_bb3_10, phi_bb3_10 },
            &block41,
            std::vector<compiler::Node*> { phi_bb3_10, phi_bb3_11, phi_bb3_12, phi_bb3_13, phi_bb3_14, phi_bb3_15, phi_bb3_16, phi_bb3_10, phi_bb3_10 });
    }
    ...
    if (block42.is_used()) {
        ca_.Bind(&block42, &phi_bb42_10, &phi_bb42_11, &phi_bb42_12, &phi_bb42_13, &phi_bb42_14, &phi_bb42_15, &phi_bb42_16, &phi_bb42_17, &phi_bb42_21,
            &phi_bb42_25);
    ...
    if (block39.is_used()) {
        ...
        ca_.Branch(tmp66, &block43,
            std::vector<compiler::Node*> {
                phi_bb39_10, phi_bb39_11, phi_bb39_12, phi_bb39_13, phi_bb39_14, phi_bb39_15, phi_bb39_16, phi_bb39_17, phi_bb39_21, phi_bb39_21 },
            &block44,
            std::vector<compiler::Node*> {
                phi_bb39_10, phi_bb39_11, phi_bb39_12, phi_bb39_13, phi_bb39_14, phi_bb39_15, phi_bb39_16, phi_bb39_17, phi_bb39_21, phi_bb39_21 });
    }
    ...
    if (block43.is_used()) {
        ca_.Bind(&block43, &phi_bb43_10, &phi_bb43_11, &phi_bb43_12, &phi_bb43_13, &phi_bb43_14, &phi_bb43_15, &phi_bb43_16, &phi_bb43_17, &phi_bb43_21,
            &phi_bb43_24);
        CodeStubAssembler(state_).CallRuntime(Runtime::kThrowInvalidStringLength, p_context);
        CodeStubAssembler(state_).Unreachable();
    }
    ...
    TNode<IntPtrT> tmp67;
    if (block44.is_used()) {
        ca_.Bind(&block44, &phi_bb44_10, &phi_bb44_11, &phi_bb44_12, &phi_bb44_13, &phi_bb44_14, &phi_bb44_15, &phi_bb44_16, &phi_bb44_17, &phi_bb44_21,
            &phi_bb44_24);
        ...
        ca_.Branch(tmp58, &block45,
            std::vector<compiler::Node*> {
                phi_bb44_10, phi_bb44_11, phi_bb44_12, phi_bb44_13, phi_bb44_15, phi_bb44_16, phi_bb44_17, phi_bb44_21, phi_bb44_24 },
            &block46,
            std::vector<compiler::Node*> {
                phi_bb44_10, phi_bb44_11, phi_bb44_12, phi_bb44_13, phi_bb44_15, phi_bb44_16, phi_bb44_17, phi_bb44_21, phi_bb44_24 });
    }
    ...
    if (block37.is_used()) {
        ...
        tmp72 = BufferJoin_0(state_, TNode<Context> { p_context },
            TorqueStructBuffer_0 {
                TNode<FixedArray> { phi_bb37_12 }, TNode<IntPtrT> { phi_bb37_13 }, TNode<IntPtrT> { phi_bb37_14 }, TNode<BoolT> { phi_bb37_15 } },
            TNode<String> { p_sep });
        ca_.Goto(&block47);
    }
    ...
    TNode<Number> p_lengthNumber, bool p_useToLocaleString, TNode<Object> p_locales, TNode<Object> p_options, TNode<BuiltinPtr> p_initialLoadFn)
{
    ...
    if (block2.is_used()) {
        ca_.Bind(&block2, &phi_bb2_10, &phi_bb2_11, &phi_bb2_12, &phi_bb2_13, &phi_bb2_14, &phi_bb2_15, &phi_bb2_16);
        tmp11 = CannotUseSameArrayAccessor_JSTypedArray_0(state_, TNode<Context> { p_context }, TNode<BuiltinPtr> { phi_bb2_11 },
