...
TF_BUILTIN(ArrayReduceRightPreLoopEagerDeoptContinuation, CodeStubAssembler)
{
    ...
    if (block11.is_used()) {
        ...
        tmp9 = ca_.CallStub<Object>(
            Builtins::CallableFor(ca_.isolate(), Builtin::kArrayReduceRightLoopContinuation), parameter0, tmp0, tmp2, tmp8, tmp0, tmp7, tmp4);
...
TF_BUILTIN(ArrayReduceRightLoopEagerDeoptContinuation, CodeStubAssembler)
{
    ...
    if (block15.is_used()) {
        ca_.Bind(&block15);
        tmp8 = ca_.CallStub<Object>(
            Builtins::CallableFor(ca_.isolate(), Builtin::kArrayReduceRightLoopContinuation), parameter0, tmp0, tmp2, parameter5, tmp0, tmp4, tmp6);
