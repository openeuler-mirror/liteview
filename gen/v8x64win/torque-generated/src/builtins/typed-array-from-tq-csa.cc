...
TF_BUILTIN(TypedArrayFrom, CodeStubAssembler)
{
    ...
    if (block14.is_used()) {
        ...
        tmp55 = TypedArrayCreateByLength_0(
            state_, TNode<Context> { parameter0 }, TNode<JSReceiver> { tmp6 }, TNode<Number> { tmp54 }, kBuiltinNameFrom_0(state_));
        tmp56 = CodeStubAssembler(state_).Word32BinaryNot(TNode<BoolT> { tmp9 });
        ca_.Branch(
            tmp56, &block45, std::vector<compiler::Node*> { phi_bb14_11, phi_bb14_12 }, &block46, std::vector<compiler::Node*> { phi_bb14_11, phi_bb14_12 });
    }
    ...
    if (block45.is_used()) {
        ...
        ca_.Branch(
            tmp58, &block47, std::vector<compiler::Node*> { phi_bb45_11, phi_bb45_12 }, &block48, std::vector<compiler::Node*> { phi_bb45_11, phi_bb45_12 });
    }
    ...
    if (block55.is_used()) {
        ...
        ca_.Branch(tmp66, &block53, std::vector<compiler::Node*> { phi_bb55_11, phi_bb55_12, phi_bb55_19 }, &block54,
            std::vector<compiler::Node*> { phi_bb55_11, phi_bb55_12, phi_bb55_19 });
    }
    ...
    if (block53.is_used()) {
        ...
        ca_.Branch(tmp9, &block57, std::vector<compiler::Node*> { phi_bb53_11, phi_bb53_12, phi_bb53_19 }, &block58,
            std::vector<compiler::Node*> { phi_bb53_11, phi_bb53_12, phi_bb53_19 });
    }
    ...
    if (block57.is_used()) {
        ...
        tmp69 = CodeStubAssembler(state_).Call(
            TNode<Context> { parameter0 }, TNode<Object> { tmp59 }, TNode<Object> { tmp5 }, TNode<Object> { tmp68 }, TNode<Object> { tmp67 });
    ...
    if (block59.is_used()) {
        ...
        tmp70 = TORQUE_CAST(
            CodeStubAssembler(state_).CallBuiltinPointer(Builtins::CallableFor(ca_.isolate(), ExampleBuiltinForTorqueFunctionPointerType(3)).descriptor(),
                tmp64, parameter0, tmp55, phi_bb59_19, phi_bb59_22));
        tmp71 = kStoreFailureArrayDetached_0(state_);
        tmp72 = CodeStubAssembler(state_).SmiEqual(TNode<Smi> { tmp70 }, TNode<Smi> { tmp71 });
        ca_.Branch(tmp72, &block61, std::vector<compiler::Node*> { phi_bb59_11, phi_bb59_12, phi_bb59_19, phi_bb59_19, phi_bb59_19 }, &block62,
            std::vector<compiler::Node*> { phi_bb59_11, phi_bb59_12, phi_bb59_19, phi_bb59_19, phi_bb59_19 });
    }
