...
TF_BUILTIN(ToName, CodeStubAssembler)
{
    ...
    if (block19.is_used()) {
        ...
        tmp10 = ca_.CallStub<Object>(
            Builtins::CallableFor(ca_.isolate(), Builtin::kNonPrimitiveToPrimitive_String), parameter0, ca_.UncheckedCast<JSReceiver>(phi_bb19_3));
...
TNode<Object> TryGetExoticToPrimitive_0(
    compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_input, compiler::CodeAssemblerLabel* label_OrdinaryToPrimitive)
{
