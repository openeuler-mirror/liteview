...
TF_BUILTIN(ArrayEveryLoopEagerDeoptContinuation, CodeStubAssembler)
{
    ...
    if (block15.is_used()) {
        ...
        tmp10 = ca_.CallStub<Object>(
            Builtins::CallableFor(ca_.isolate(), Builtin::kArrayEveryLoopContinuation), parameter0, tmp0, tmp2, parameter3, tmp8, tmp0, tmp4, tmp6, tmp9);
...
TF_BUILTIN(ArrayEveryLoopLazyDeoptContinuation, CodeStubAssembler)
{
    ...
    if (block18.is_used()) {
        ...
        tmp15 = ca_.CallStub<Object>(
            Builtins::CallableFor(ca_.isolate(), Builtin::kArrayEveryLoopContinuation), parameter0, tmp0, tmp2, parameter3, tmp13, tmp0, tmp12, tmp6, tmp14);
