...
TF_BUILTIN(ArraySomeLoopEagerDeoptContinuation, CodeStubAssembler)
{
    ...
    if (block15.is_used()) {
        ...
        tmp10 = ca_.CallStub<Object>(
            Builtins::CallableFor(ca_.isolate(), Builtin::kArraySomeLoopContinuation), parameter0, tmp0, tmp2, parameter3, tmp8, tmp0, tmp4, tmp6, tmp9);
...
TF_BUILTIN(ArraySomeLoopLazyDeoptContinuation, CodeStubAssembler)
{
    ...
    if (block18.is_used()) {
        ...
        tmp14 = ca_.CallStub<Object>(
            Builtins::CallableFor(ca_.isolate(), Builtin::kArraySomeLoopContinuation), parameter0, tmp0, tmp2, parameter3, tmp12, tmp0, tmp11, tmp6, tmp13);
