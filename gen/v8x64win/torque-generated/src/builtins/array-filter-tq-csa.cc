...
TF_BUILTIN(ArrayFilterLoopEagerDeoptContinuation, CodeStubAssembler)
{
    ...
    if (block23.is_used()) {
        ca_.Bind(&block23);
        tmp12 = ca_.CallStub<Object>(
            Builtins::CallableFor(ca_.isolate(), Builtin::kArrayFilterLoopContinuation), parameter0, tmp0, tmp2, parameter3, tmp4, tmp0, tmp6, tmp10, tmp8);
...
TF_BUILTIN(ArrayFilterLoopLazyDeoptContinuation, CodeStubAssembler)
{
    ...
    if (block26.is_used()) {
        ...
        tmp18 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtin::kArrayFilterLoopContinuation), parameter0, tmp0, tmp2, parameter3, tmp4,
            tmp0, tmp17, tmp10, phi_bb26_14);
...
TF_BUILTIN(ArrayFilter, CodeStubAssembler)
{
    ...
    if (block7.is_used()) {
        ...
        tmp26 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtin::kArrayFilterLoopContinuation), parameter0, tmp1, tmp7, tmp10, phi_bb7_10,
            tmp1, phi_bb7_11, tmp2, phi_bb7_12);
