    ...
    TNode<Object> p_argument, PromiseReaction::Type p_reactionType)
{
    ...
    if (block6.is_used()) {
        ...
        std::tie(tmp23, tmp24) = UnsafeConstCast_Map_0(
            state_, TorqueStructReference_Map_0 { TNode<Object> { p_promiseReaction }, TNode<IntPtrT> { tmp22 }, TorqueStructUnsafe_0 {} })
                                     .Flatten();
        ...
        tmp31 = FromConstexpr_bool_constexpr_bool_0(state_,
            (CodeStubAssembler(state_).ConstexprInt31Equal(PromiseReaction::kPromiseOrCapabilityOffset, PromiseReactionJobTask::kPromiseOrCapabilityOffset)));
...
TorqueStructPromiseResolvingFunctions CreatePromiseResolvingFunctions_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context,
    TNode<JSPromise> p_promise, TNode<Oddball> p_debugEvent, TNode<NativeContext> p_nativeContext)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
...
TNode<PromiseCapability> InnerNewPromiseCapability_0(
    compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<HeapObject> p_constructor, TNode<Oddball> p_debugEvent)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    if (block2.is_used()) {
        ...
        std::tie(tmp7, tmp8) = CreatePromiseResolvingFunctions_0(
            state_, TNode<Context> { p_context }, TNode<JSPromise> { tmp6 }, TNode<Oddball> { p_debugEvent }, TNode<NativeContext> { tmp0 })
                                   .Flatten();
    ...
    if (block3.is_used()) {
        ...
        tmp20
            = CodeStubAssembler(state_).AllocateFunctionWithMapAndContext(TNode<Map> { tmp19 }, TNode<SharedFunctionInfo> { tmp15 }, TNode<Context> { tmp14 });
...
TF_BUILTIN(NewPromiseCapability, CodeStubAssembler)
{
    ...
    if (block6.is_used()) {
        ...
        tmp4 = InnerNewPromiseCapability_0(
            state_, TNode<Context> { parameter0 }, TNode<HeapObject> { ca_.UncheckedCast<HeapObject>(parameter1) }, TNode<Oddball> { parameter2 });
        CodeStubAssembler(state_).Return(tmp4);
    }
}
    ...
    TNode<HeapObject> p_onRejected, TNode<HeapObject> p_resultPromiseOrCapability)
{
    ...
    if (block2.is_used()) {
        ...
        tmp7 = NewPromiseReaction_0(state_, TNode<Context> { p_context }, TNode<Context> { tmp3 }, TNode<Object> { tmp6 },
            TNode<HeapObject> { p_resultPromiseOrCapability }, TNode<HeapObject> { p_onFulfilled }, TNode<HeapObject> { p_onRejected });
    ...
    if (block5.is_used()) {
        ...
        tmp15 = NewPromiseFulfillReactionJobTask_0(state_, TNode<Context> { p_context }, TNode<Context> { tmp14 }, TNode<Object> { tmp10 },
    ...
    if (block6.is_used()) {
        ...
        tmp17 = NewPromiseRejectReactionJobTask_0(state_, TNode<Context> { p_context }, TNode<Context> { tmp16 }, TNode<Object> { tmp10 },
            TNode<HeapObject> { p_onRejected }, TNode<HeapObject> { p_resultPromiseOrCapability });
