...
TF_BUILTIN(CallRefIC, CodeStubAssembler)
{
    ...
    compiler::CodeAssemblerParameterizedLabel<IntPtrT, IntPtrT, IntPtrT, IntPtrT, IntPtrT, IntPtrT, IntPtrT> block191(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<IntPtrT, IntPtrT, IntPtrT, IntPtrT, IntPtrT, IntPtrT, IntPtrT> block192(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    if (block144.is_used()) {
        ...
        tmp161
            = CodeStubAssembler(state_).AllocateFixedArray(ElementsKind::PACKED_ELEMENTS, TNode<IntPtrT> { tmp160 }, CodeStubAssembler::AllocationFlag::kNone);
    ...
    if (block183.is_used()) {
        ...
        ca_.Branch(tmp181, &block191,
            std::vector<compiler::Node*> { phi_bb183_8, phi_bb183_13, phi_bb183_14, phi_bb183_8, phi_bb183_8, phi_bb183_8, phi_bb183_8 }, &block192,
    ...
    if (block219.is_used()) {
        ...
        tmp230
            = CodeStubAssembler(state_).AllocateFixedArray(ElementsKind::PACKED_ELEMENTS, TNode<IntPtrT> { tmp229 }, CodeStubAssembler::AllocationFlag::kNone);
    ...
    if (block21.is_used()) {
        ...
        tmp33 = AllocateSeqTwoByteString_SliceIterator_char16_ConstReference_char16_0(state_, TNode<Uint32T> { tmp26 },
            TorqueStructSliceIterator_char16_ConstReference_char16_0 {
                TNode<Object> { tmp27 }, TNode<IntPtrT> { tmp28 }, TNode<IntPtrT> { tmp32 }, TorqueStructUnsafe_0 {} });
...
TF_BUILTIN(ExperimentalWasmConvertStringToArray, CodeStubAssembler)
{
    ...
    if (block21.is_used()) {
        ...
        ca_.Branch(
            tmp28, &block19, std::vector<compiler::Node*> { phi_bb21_15, phi_bb21_16 }, &block20, std::vector<compiler::Node*> { phi_bb21_15, phi_bb21_16 });
    }
    ...
    if (block24.is_used()) {
        ...
        std::tie(tmp36, tmp37, tmp38) = Subslice_char8_0(state_,
            TorqueStructSlice_char8_ConstReference_char8_0 {
                TNode<Object> { tmp33 }, TNode<IntPtrT> { tmp34 }, TNode<IntPtrT> { tmp35 }, TorqueStructUnsafe_0 {} },
    ...
    if (block32.is_used()) {
        ...
        std::tie(tmp45, tmp46, tmp47) = Subslice_char16_0(state_,
            TorqueStructSlice_char16_ConstReference_char16_0 {
                TNode<Object> { tmp42 }, TNode<IntPtrT> { tmp43 }, TNode<IntPtrT> { tmp44 }, TorqueStructUnsafe_0 {} },
    ...
    if (block52.is_used()) {
        ...
        std::tie(tmp73, tmp74, tmp75) = Subslice_char8_0(state_,
            TorqueStructSlice_char8_ConstReference_char8_0 {
                TNode<Object> { tmp70 }, TNode<IntPtrT> { tmp71 }, TNode<IntPtrT> { tmp72 }, TorqueStructUnsafe_0 {} },
    ...
    if (block60.is_used()) {
        ...
        std::tie(tmp84, tmp85, tmp86) = Subslice_char16_0(state_,
            TorqueStructSlice_char16_ConstReference_char16_0 {
                TNode<Object> { tmp81 }, TNode<IntPtrT> { tmp82 }, TNode<IntPtrT> { tmp83 }, TorqueStructUnsafe_0 {} },
...
TF_BUILTIN(WasmStringEncodeWtf16Array, CodeStubAssembler)
{
    ...
    if (block6.is_used()) {
        ...
        std::tie(tmp17, tmp18, tmp19)
            = NewMutableSlice_char16_0(state_, TNode<Object> { parameter1 }, TNode<IntPtrT> { tmp13 }, TNode<IntPtrT> { tmp16 }).Flatten();
    ...
    if (block13.is_used()) {
        ...
        ca_.Branch(
            tmp24, &block11, std::vector<compiler::Node*> { phi_bb13_9, phi_bb13_10 }, &block12, std::vector<compiler::Node*> { phi_bb13_9, phi_bb13_10 });
    }
...
TNode<WasmStruct> Cast_WasmStruct_1(
    compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_o, compiler::CodeAssemblerLabel* label_CastError)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
