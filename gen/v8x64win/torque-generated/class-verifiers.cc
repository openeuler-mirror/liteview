...
void TorqueGeneratedClassVerifiers::JSWrappedFunctionVerify(JSWrappedFunction o, Isolate* isolate)
{
    ...
    CHECK(o.IsJSWrappedFunction(isolate));
    {
        ...
        CHECK(wrapped_target_function__value.IsCallableApiObject() || wrapped_target_function__value.IsCallableJSProxy()
            || wrapped_target_function__value.IsJSWrappedFunction() || wrapped_target_function__value.IsJSBoundFunction()
            || wrapped_target_function__value.IsJSFunction());
    }
    {
...
void TorqueGeneratedClassVerifiers::JSBoundFunctionVerify(JSBoundFunction o, Isolate* isolate)
{
    ...
    CHECK(o.IsJSBoundFunction(isolate));
    {
        ...
        CHECK(bound_target_function__value.IsCallableApiObject() || bound_target_function__value.IsCallableJSProxy()
            || bound_target_function__value.IsJSWrappedFunction() || bound_target_function__value.IsJSBoundFunction()
            || bound_target_function__value.IsJSFunction());
    }
    {
        Object bound_this__value = TaggedField<Object>::load(o, 16);
        Object::VerifyPointer(isolate, bound_this__value);
        CHECK(bound_this__value.IsJSReceiver() || bound_this__value.IsUndefined() || bound_this__value.IsNull() || bound_this__value.IsFalse()
            || bound_this__value.IsTrue() || bound_this__value.IsSymbol() || bound_this__value.IsString() || bound_this__value.IsBigInt()
            || bound_this__value.IsHeapNumber() || bound_this__value.IsSmi() || bound_this__value.IsSourceTextModule());
    }
    {
...
void TorqueGeneratedClassVerifiers::WeakCellVerify(WeakCell o, Isolate* isolate)
{
    ...
    }
    {
        ...
        CHECK(holdings__value.IsJSReceiver() || holdings__value.IsUndefined() || holdings__value.IsNull() || holdings__value.IsFalse()
            || holdings__value.IsTrue() || holdings__value.IsSymbol() || holdings__value.IsString() || holdings__value.IsBigInt()
            || holdings__value.IsHeapNumber() || holdings__value.IsSmi());
    }
    {
...
void TorqueGeneratedClassVerifiers::JSPromiseVerify(JSPromise o, Isolate* isolate)
{
    ...
    CHECK(o.IsJSPromise(isolate));
    {
        ...
        CHECK(reactions_or_result__value.IsJSReceiver() || reactions_or_result__value.IsUndefined() || reactions_or_result__value.IsNull()
            || reactions_or_result__value.IsFalse() || reactions_or_result__value.IsTrue() || reactions_or_result__value.IsSymbol()
            || reactions_or_result__value.IsString() || reactions_or_result__value.IsBigInt() || reactions_or_result__value.IsHeapNumber()
            || reactions_or_result__value.IsSmi() || reactions_or_result__value.IsPromiseReaction());
    }
    {
...
void TorqueGeneratedClassVerifiers::CallSiteInfoVerify(CallSiteInfo o, Isolate* isolate)
{
    ...
    CHECK(o.IsCallSiteInfo(isolate));
    {
        ...
        CHECK(receiver_or_instance__value.IsJSReceiver() || receiver_or_instance__value.IsUndefined() || receiver_or_instance__value.IsNull()
            || receiver_or_instance__value.IsFalse() || receiver_or_instance__value.IsTrue() || receiver_or_instance__value.IsSymbol()
            || receiver_or_instance__value.IsString() || receiver_or_instance__value.IsBigInt() || receiver_or_instance__value.IsHeapNumber()
            || receiver_or_instance__value.IsSmi());
    }
    {
...
void TorqueGeneratedClassVerifiers::ErrorStackDataVerify(ErrorStackData o, Isolate* isolate)
{
    ...
    CHECK(o.IsErrorStackData(isolate));
    {
        ...
        CHECK(call_site_infos_or_formatted_stack__value.IsJSReceiver() || call_site_infos_or_formatted_stack__value.IsUndefined()
            || call_site_infos_or_formatted_stack__value.IsNull() || call_site_infos_or_formatted_stack__value.IsFalse()
            || call_site_infos_or_formatted_stack__value.IsTrue() || call_site_infos_or_formatted_stack__value.IsSymbol()
            || call_site_infos_or_formatted_stack__value.IsString() || call_site_infos_or_formatted_stack__value.IsBigInt()
...
void TorqueGeneratedClassVerifiers::DescriptorArrayVerify(DescriptorArray o, Isolate* isolate)
{
    ...
    for (int i = 0; i < static_cast<int>(descriptors__length); ++i) {
        ...
        CHECK(value__value.IsCleared() || (!value__value.IsWeak() && value__value.GetHeapObjectOrSmi().IsJSReceiver())
            || (!value__value.IsWeak() && value__value.GetHeapObjectOrSmi().IsUndefined())
            || (!value__value.IsWeak() && value__value.GetHeapObjectOrSmi().IsNull()) || (!value__value.IsWeak() && value__value.GetHeapObjectOrSmi().IsFalse())
            || (!value__value.IsWeak() && value__value.GetHeapObjectOrSmi().IsTrue())
            || (!value__value.IsWeak() && value__value.GetHeapObjectOrSmi().IsSymbol())
            || (!value__value.IsWeak() && value__value.GetHeapObjectOrSmi().IsString())
            || (!value__value.IsWeak() && value__value.GetHeapObjectOrSmi().IsBigInt())
            || (!value__value.IsWeak() && value__value.GetHeapObjectOrSmi().IsHeapNumber())
            || (!value__value.IsWeak() && value__value.GetHeapObjectOrSmi().IsSmi())
            || (!value__value.IsWeak() && value__value.GetHeapObjectOrSmi().IsAccessorInfo())
            || (!value__value.IsWeak() && value__value.GetHeapObjectOrSmi().IsClassPositions())
            || (!value__value.IsWeak() && value__value.GetHeapObjectOrSmi().IsAccessorPair())
...
void TorqueGeneratedClassVerifiers::FeedbackVectorVerify(FeedbackVector o, Isolate* isolate)
{
    ...
    }
    {
        ...
        CHECK(maybe_optimized_code__value.IsCleared()
            || (maybe_optimized_code__value.IsWeak() && maybe_optimized_code__value.GetHeapObjectOrSmi().IsCodeDataContainer()));
    }
...
void TorqueGeneratedClassVerifiers::JSGeneratorObjectVerify(JSGeneratorObject o, Isolate* isolate)
{
    ...
    }
    {
        ...
        CHECK(receiver__value.IsJSReceiver() || receiver__value.IsUndefined() || receiver__value.IsNull() || receiver__value.IsFalse()
            || receiver__value.IsTrue() || receiver__value.IsSymbol() || receiver__value.IsString() || receiver__value.IsBigInt()
            || receiver__value.IsHeapNumber() || receiver__value.IsSmi());
    }
    {
...
void TorqueGeneratedClassVerifiers::JSPrimitiveWrapperVerify(JSPrimitiveWrapper o, Isolate* isolate)
{
    ...
    CHECK(o.IsJSPrimitiveWrapper(isolate));
    {
        Object value__value = TaggedField<Object>::load(o, 12);
        Object::VerifyPointer(isolate, value__value);
        CHECK(value__value.IsJSReceiver() || value__value.IsUndefined() || value__value.IsNull() || value__value.IsFalse() || value__value.IsTrue()
            || value__value.IsSymbol() || value__value.IsString() || value__value.IsBigInt() || value__value.IsHeapNumber() || value__value.IsSmi());
    }
}
...
void TorqueGeneratedClassVerifiers::JSFinalizationRegistryVerify(JSFinalizationRegistry o, Isolate* isolate)
{
    ...
    }
    {
        ...
        CHECK(cleanup__value.IsCallableApiObject() || cleanup__value.IsCallableJSProxy() || cleanup__value.IsJSWrappedFunction()
            || cleanup__value.IsJSBoundFunction() || cleanup__value.IsJSFunction());
    }
    {
...
void TorqueGeneratedClassVerifiers::PropertyDescriptorObjectVerify(PropertyDescriptorObject o, Isolate* isolate)
{
    ...
    }
    {
        ...
        CHECK(value__value.IsJSReceiver() || value__value.IsUndefined() || value__value.IsNull() || value__value.IsFalse() || value__value.IsTrue()
            || value__value.IsSymbol() || value__value.IsString() || value__value.IsBigInt() || value__value.IsHeapNumber() || value__value.IsSmi()
            || value__value.IsTheHole());
    }
    {
        Object get__value = TaggedField<Object>::load(o, 12);
        Object::VerifyPointer(isolate, get__value);
        CHECK(get__value.IsJSReceiver() || get__value.IsUndefined() || get__value.IsNull() || get__value.IsFalse() || get__value.IsTrue()
            || get__value.IsSymbol() || get__value.IsString() || get__value.IsBigInt() || get__value.IsHeapNumber() || get__value.IsSmi()
            || get__value.IsTheHole());
    }
    {
        Object set__value = TaggedField<Object>::load(o, 16);
        Object::VerifyPointer(isolate, set__value);
        CHECK(set__value.IsJSReceiver() || set__value.IsUndefined() || set__value.IsNull() || set__value.IsFalse() || set__value.IsTrue()
            || set__value.IsSymbol() || set__value.IsString() || set__value.IsBigInt() || set__value.IsHeapNumber() || set__value.IsSmi()
            || set__value.IsTheHole());
    }
}
void TorqueGeneratedClassVerifiers::PrototypeInfoVerify(PrototypeInfo o, Isolate* isolate)
{
    ...
    }
    {
        ...
        CHECK(
            prototype_chain_enum_cache__value.IsUndefined() || prototype_chain_enum_cache__value.IsFixedArray() || prototype_chain_enum_cache__value.IsZero());
    }
    {
...
void TorqueGeneratedClassVerifiers::ScriptVerify(Script o, Isolate* isolate)
{
    ...
    }
    {
        ...
        CHECK(eval_from_shared_or_wrapped_arguments_or_sfi_table__value.IsUndefined()
            || eval_from_shared_or_wrapped_arguments_or_sfi_table__value.IsFixedArray()
...
void TorqueGeneratedClassVerifiers::SortStateVerify(SortState o, Isolate* isolate)
{
    ...
    }
    {
        ...
        CHECK(userCmpFn__value.IsUndefined() || userCmpFn__value.IsCallableApiObject() || userCmpFn__value.IsCallableJSProxy()
            || userCmpFn__value.IsJSWrappedFunction() || userCmpFn__value.IsJSBoundFunction() || userCmpFn__value.IsJSFunction());
    }
    {
...
void TorqueGeneratedClassVerifiers::WasmTypeInfoVerify(WasmTypeInfo o, Isolate* isolate)
{
    ...
    {
        Object supertypes_length__value = TaggedField<Object>::load(o, 20);
