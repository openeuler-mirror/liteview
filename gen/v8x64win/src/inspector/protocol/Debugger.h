...
public:
    ...
    {
        return m_canBeRestarted.isJust();
    }
    bool getCanBeRestarted(bool defaultValue)
    {
        return m_canBeRestarted.isJust() ? m_canBeRestarted.fromJust() : defaultValue;
    }
...
public:
    ...
    bool hasExternalURL()
    {
        return m_externalURL.isJust();
    }
    String getExternalURL(const String& defaultValue)
    {
        return m_externalURL.isJust() ? m_externalURL.fromJust() : defaultValue;
    }
