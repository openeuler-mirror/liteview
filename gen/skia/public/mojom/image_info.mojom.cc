...
ImageInfo::ImageInfo(::SkColorType color_type_in, ::SkAlphaType alpha_type_in, uint32_t width_in, uint32_t height_in, absl::optional<std::vector<float>> color_transfer_function_in,
...
BitmapN32ImageInfo::BitmapN32ImageInfo(::SkAlphaType alpha_type_in, uint32_t width_in, uint32_t height_in, absl::optional<std::vector<float>> color_transfer_function_in,
    absl::optional<std::vector<float>> color_to_xyz_matrix_in)
    : alpha_type(std::move(alpha_type_in))
    , width(std::move(width_in))
    , height(std::move(height_in))
...
namespace mojo {
// static
bool StructTraits<::skia::mojom::ImageInfo::DataView, ::skia::mojom::ImageInfoPtr>::Read(::skia::mojom::ImageInfo::DataView input, ::skia::mojom::ImageInfoPtr* output)
{
    bool success = true;
