...
#ifndef SKIA_PUBLIC_MOJOM_IMAGE_INFO_MOJOM_BLINK_JUMBO_H_
#define SKIA_PUBLIC_MOJOM_IMAGE_INFO_MOJOM_BLINK_JUMBO_H_
#endif
...
ImageInfo::ImageInfo(::SkColorType color_type_in, ::SkAlphaType alpha_type_in, uint32_t width_in, uint32_t height_in, absl::optional<WTF::Vector<float>> color_transfer_function_in,
...
bool ImageInfo::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
BitmapN32ImageInfo::BitmapN32ImageInfo(::SkAlphaType alpha_type_in, uint32_t width_in, uint32_t height_in, absl::optional<WTF::Vector<float>> color_transfer_function_in,
    absl::optional<WTF::Vector<float>> color_to_xyz_matrix_in)
    : alpha_type(std::move(alpha_type_in))
    , width(std::move(width_in))
    , height(std::move(height_in))
...
bool BitmapN32ImageInfo::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
} // namespace blink
} // namespace mojom
} // namespace skia
namespace mojo {
