...
public:
    ...
    float rX() const { return data_->rX; }
    float rY() const { return data_->rY; }
    float gX() const { return data_->gX; }
    float gY() const { return data_->gY; }
    float bX() const { return data_->bX; }
    float bY() const { return data_->bY; }
    float wX() const { return data_->wX; }
    float wY() const { return data_->wY; }
