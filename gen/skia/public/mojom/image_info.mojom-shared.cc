...
std::ostream& operator<<(std::ostream& os, ColorType value) { return os << ColorTypeToString(value); }
...
std::ostream& operator<<(std::ostream& os, AlphaType value) { return os << AlphaTypeToString(value); }
