...
template <typename UserType, typename DataView> const mojo::internal::UnserializedMessageContext::Tag BitmapN32_UnserializedMessageContext<UserType, DataView>::kMessageTag = {};
class BitmapWithArbitraryBpp_Data {
public:
    static bool Validate(const void* data, mojo::internal::ValidationContext* validation_context);
...
template <typename UserType, typename DataView> struct BitmapMappedFromTrustedProcess_UnserializedMessageContext : public mojo::internal::UnserializedMessageContext {
public:
    static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;
...
template <typename UserType, typename DataView> const mojo::internal::UnserializedMessageContext::Tag InlineBitmap_UnserializedMessageContext<UserType, DataView>::kMessageTag = {};
