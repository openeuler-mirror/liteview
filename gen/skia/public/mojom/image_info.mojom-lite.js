// skia/public/mojom/image_info.mojom-lite.js is auto generated by mojom_bindings_generator.py, do not edit
...
skia.mojom.ImageInfo = class {
  constructor() {
    /** @export { !skia.mojom.ColorType } */
    this.colorType;
    /** @export { !skia.mojom.AlphaType } */
    this.alphaType;
    /** @export { !number } */
    this.width;
    /** @export { !number } */
...
/** @record */
skia.mojom.BitmapN32ImageInfo = class {
  constructor() {
    /** @export { !skia.mojom.AlphaType } */
    this.alphaType;
    /** @export { !number } */
