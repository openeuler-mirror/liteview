...
static_assert(sizeof(Channel_SetPeerPid_Params_Data) == 16, "Bad sizeof(Channel_SetPeerPid_Params_Data)");
...
static_assert(sizeof(Channel_Receive_Params_Data) == 16, "Bad sizeof(Channel_Receive_Params_Data)");
...
static_assert(sizeof(Channel_GetAssociatedInterface_Params_Data) == 16, "Bad sizeof(Channel_GetAssociatedInterface_Params_Data)");
...
public:
    ...
    Channel_SetPeerPid_ParamsDataView(internal::Channel_SetPeerPid_Params_Data* data, mojo::Message* message)
        : data_(data)
    {
    }

    bool is_null() const { return !data_; }
    int32_t pid() const { return data_->pid; }
...
public:
    ...
    Channel_Receive_ParamsDataView(internal::Channel_Receive_Params_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
    ...
    bool is_null() const { return !data_; }
    inline void GetMessageDataView(MessageDataView* output);

    template <typename UserType> [[nodiscard]] bool ReadMessage(UserType* output)
    {

        auto* pointer = data_->message.Get();
        return mojo::internal::Deserialize<::IPC::mojom::MessageDataView>(pointer, output, message_);
    }
...
public:
    ...
    Channel_GetAssociatedInterface_ParamsDataView(internal::Channel_GetAssociatedInterface_Params_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
...
inline void Channel_Receive_ParamsDataView::GetMessageDataView(MessageDataView* output)
{
    auto pointer = data_->message.Get();
    *output = MessageDataView(pointer, message_);
}
inline void Channel_GetAssociatedInterface_ParamsDataView::GetReceiverDataView(::mojo_base::mojom::GenericPendingAssociatedReceiverDataView* output)
{
    auto pointer = data_->receiver.Get();
