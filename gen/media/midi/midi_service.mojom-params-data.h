...
public:
    ...
    bool is_null() const { return !data_; }
    uint32_t port() const { return data_->port; }
...
public:
    ...
    Result result() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::midi::mojom::Result>(data_->result)); }
...
public:
    ...
    bool is_null() const { return !data_; }
    uint32_t bytes() const { return data_->bytes; }
