...
public:
    ...
    PortInfo(const std::string& id_in, const std::string& manufacturer_in, const std::string& name_in, const std::string& version_in, PortState state_in)
        : id(std::move(id_in))
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input) { return mojo::internal::SerializeImpl<PortInfo::DataView, std::vector<uint8_t>>(input); }
...
template <> struct StructTraits<::midi::mojom::PortInfo::DataView, ::midi::mojom::PortInfoPtr> {
    ...
    static const decltype(::midi::mojom::PortInfo::id)& id(const ::midi::mojom::PortInfoPtr& input) { return input->id; }

    static const decltype(::midi::mojom::PortInfo::manufacturer)& manufacturer(const ::midi::mojom::PortInfoPtr& input) { return input->manufacturer; }

    static const decltype(::midi::mojom::PortInfo::name)& name(const ::midi::mojom::PortInfoPtr& input) { return input->name; }

    static const decltype(::midi::mojom::PortInfo::version)& version(const ::midi::mojom::PortInfoPtr& input) { return input->version; }

    static decltype(::midi::mojom::PortInfo::state) state(const ::midi::mojom::PortInfoPtr& input) { return input->state; }
