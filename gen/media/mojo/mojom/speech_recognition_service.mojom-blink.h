...
// with not having this data in traces there.
    ...
    virtual void Start(::mojo::PendingRemote<::media::mojom::blink::AudioStreamFactory> factory, const WTF::String& device_id, const ::media::AudioParameters& audio_parameters)
        = 0;
...
//
//   void BindAudioSourceFetcher(::mojo::PendingReceiver<AudioSourceFetcher> fetcher_receiver, ::mojo::PendingRemote<::media::mojom::blink::SpeechRecognitionRecognizerClient>
//   client, ::media::mojom::blink::SpeechRecognitionOptionsPtr options, BindAudioSourceFetcherCallback callback) final;
//
//  private:
