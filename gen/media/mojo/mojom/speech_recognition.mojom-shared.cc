...
std::ostream& operator<<(std::ostream& os, ConfidenceLevel value) { return os << ConfidenceLevelToString(value); }
...
std::ostream& operator<<(std::ostream& os, SpeechRecognitionMode value) { return os << SpeechRecognitionModeToString(value); }

static NOINLINE const char* RecognizerClientTypeToStringHelper(RecognizerClientType value)
{
    // Defined in a helper function to ensure that Clang generates a lookup table.
    switch (value) {
...
std::ostream& operator<<(std::ostream& os, RecognizerClientType value) { return os << RecognizerClientTypeToString(value); }
...
bool SpeechRecognitionResult_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    ...
    const mojo::internal::ContainerValidateParams transcription_validate_params(0, false, nullptr);
...
bool SpeechRecognitionContext_BindRecognizer_Params_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    ...
    // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
    // the message comes from an older version.
    [[maybe_unused]] const SpeechRecognitionContext_BindRecognizer_Params_Data* object = static_cast<const SpeechRecognitionContext_BindRecognizer_Params_Data*>(data);
...
// static
bool SpeechRecognitionRecognizer_SendAudioToSpeechRecognitionService_Params_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    if (!data)
        return true;
    if (!ValidateUnversionedStructHeaderAndSizeAndClaimMemory(data, 16, validation_context)) {
...
bool SpeechRecognitionRecognizer_MarkDone_Params_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    ...
    // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
    // the message comes from an older version.
    [[maybe_unused]] const SpeechRecognitionRecognizer_MarkDone_Params_Data* object = static_cast<const SpeechRecognitionRecognizer_MarkDone_Params_Data*>(data);
...
bool SpeechRecognitionRecognizer_OnLanguageChanged_Params_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    ...
    // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
    // the message comes from an older version.
    [[maybe_unused]] const SpeechRecognitionRecognizer_OnLanguageChanged_Params_Data* object = static_cast<const SpeechRecognitionRecognizer_OnLanguageChanged_Params_Data*>(data);
...
// static
bool SpeechRecognitionRecognizerClient_OnSpeechRecognitionRecognitionEvent_Params_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    if (!data)
        return true;
    if (!ValidateUnversionedStructHeaderAndSizeAndClaimMemory(data, 16, validation_context)) {
...
// static
bool SpeechRecognitionRecognizerClient_OnSpeechRecognitionRecognitionEvent_ResponseParams_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    if (!data)
        return true;
    if (!ValidateUnversionedStructHeaderAndSizeAndClaimMemory(data, 16, validation_context)) {
...
// static
bool SpeechRecognitionRecognizerClient_OnLanguageIdentificationEvent_Params_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    if (!data)
        return true;
    if (!ValidateUnversionedStructHeaderAndSizeAndClaimMemory(data, 16, validation_context)) {
...
// static
bool SpeechRecognitionBrowserObserver_SpeechRecognitionAvailabilityChanged_Params_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    if (!data)
        return true;
    if (!ValidateUnversionedStructHeaderAndSizeAndClaimMemory(data, 16, validation_context)) {
...
// static
bool SpeechRecognitionBrowserObserver_SpeechRecognitionLanguageChanged_Params_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    if (!data)
        return true;
    if (!ValidateUnversionedStructHeaderAndSizeAndClaimMemory(data, 16, validation_context)) {
...
// static
bool SpeechRecognitionClientBrowserInterface_BindSpeechRecognitionBrowserObserver_Params_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    if (!data)
        return true;
    if (!ValidateUnversionedStructHeaderAndSizeAndClaimMemory(data, 16, validation_context)) {
