...
public:
    ...
    AudioLogComponent component() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::media::mojom::AudioLogComponent>(data_->component)); }
    int32_t component_id() const { return data_->component_id; }
    template <typename UserType> UserType TakeAudioLogReceiver()
    {
        UserType result;
        bool ret = mojo::internal::Deserialize<mojo::InterfaceRequestDataView<::media::mojom::AudioLogInterfaceBase>>(&data_->audio_log_receiver, &result, message_);
        DCHECK(ret);
        return result;
    }
