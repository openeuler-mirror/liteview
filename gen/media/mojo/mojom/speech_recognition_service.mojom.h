...
// with not having this data in traces there.
    ...
    virtual void Start(::mojo::PendingRemote<::media::mojom::AudioStreamFactory> factory, const std::string& device_id, const ::media::AudioParameters& audio_parameters) = 0;
...
//   ::media::mojom::SpeechRecognitionOptionsPtr options, BindAudioSourceFetcherCallback callback) final;
//
//  private:
...
//
//   void Start(::mojo::PendingRemote<::media::mojom::AudioStreamFactory> factory, const std::string& device_id, const ::media::AudioParameters& audio_parameters) final;
//
//   void Stop() final;
//
//  private:
