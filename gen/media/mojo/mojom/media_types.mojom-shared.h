...
template <> struct MojomTypeTraits<::media::mojom::GpuMemoryBufferVideoFrameDataDataView> {
    using Data = ::media::mojom::internal::GpuMemoryBufferVideoFrameData_Data;
    using DataAsArrayElement = Pointer<Data>;
    static constexpr MojomTypeCategory category = MojomTypeCategory::kStruct;
};

template <> struct MojomTypeTraits<::media::mojom::MailboxVideoFrameDataDataView> {
...
inline bool IsKnownEnumValue(VideoRotation value) { return internal::VideoRotation_Data::IsKnownValue(static_cast<int32_t>(value)); }
...
inline bool IsKnownEnumValue(EncryptionType value) { return internal::EncryptionType_Data::IsKnownValue(static_cast<int32_t>(value)); }
...
inline bool IsKnownEnumValue(SVCScalabilityMode value) { return internal::SVCScalabilityMode_Data::IsKnownValue(static_cast<int32_t>(value)); }
...
inline bool IsKnownEnumValue(CdmEvent value) { return internal::CdmEvent_Data::IsKnownValue(static_cast<int32_t>(value)); }
...
inline bool IsKnownEnumValue(CdmSessionClosedReason value) { return internal::CdmSessionClosedReason_Data::IsKnownValue(static_cast<int32_t>(value)); }
...
inline bool IsKnownEnumValue(MediaStreamType value) { return internal::MediaStreamType_Data::IsKnownValue(static_cast<int32_t>(value)); }
...
inline bool IsKnownEnumValue(InputStreamErrorCode value) { return internal::InputStreamErrorCode_Data::IsKnownValue(static_cast<int32_t>(value)); }
...
inline bool IsKnownEnumValue(RendererType value) { return internal::RendererType_Data::IsKnownValue(static_cast<int32_t>(value)); }
...
public:
    ...
    VideoRotation rotation() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::media::mojom::VideoRotation>(data_->rotation)); }
    bool mirrored() const { return data_->mirrored; }
...
public:
    ...
    VideoColorSpace_PrimaryID primaries() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::media::mojom::VideoColorSpace_PrimaryID>(data_->primaries)); }
    ...
    VideoColorSpace_TransferID transfer() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::media::mojom::VideoColorSpace_TransferID>(data_->transfer)); }
    ...
    VideoColorSpace_MatrixID matrix() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::media::mojom::VideoColorSpace_MatrixID>(data_->matrix)); }
    ...
    VideoColorSpace_RangeID range() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::media::mojom::VideoColorSpace_RangeID>(data_->range)); }
...
public:
    ...
    AudioCodec codec() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::media::mojom::AudioCodec>(data_->codec)); }
    ...
    SampleFormat sample_format() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::media::mojom::SampleFormat>(data_->sample_format)); }
    ...
    ChannelLayout channel_layout() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::media::mojom::ChannelLayout>(data_->channel_layout)); }
    int32_t samples_per_second() const { return data_->samples_per_second; }
    ...
    EncryptionScheme encryption_scheme() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::media::mojom::EncryptionScheme>(data_->encryption_scheme)); }
    ...
    int32_t codec_delay() const { return data_->codec_delay; }
    ...
    AudioCodecProfile profile() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::media::mojom::AudioCodecProfile>(data_->profile)); }
    ...
    bool should_discard_decoder_delay() const { return data_->should_discard_decoder_delay; }
...
public:
    ...
    VideoCodec codec() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::media::mojom::VideoCodec>(data_->codec)); }
    template <typename UserType> [[nodiscard]] bool ReadProfile(UserType* output) const
    {
        auto data_value = data_->profile;
        return mojo::internal::Deserialize<::media::mojom::VideoCodecProfile>(data_value, output);
    }
    VideoCodecProfile profile() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::media::mojom::VideoCodecProfile>(data_->profile)); }
    uint32_t level() const { return data_->level; }
    bool has_alpha() const { return data_->has_alpha; }
...
public:
    ...
    bool is_end_of_stream() const { return data_->is_end_of_stream; }
    uint32_t data_size() const { return data_->data_size; }
    bool is_key_frame() const { return data_->is_key_frame; }
    inline void GetSideDataDataView(mojo::ArrayDataView<uint8_t>* output);
...
public:
    ...
    ChannelLayout channel_layout() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::media::mojom::ChannelLayout>(data_->channel_layout)); }
    int32_t channel_count() const { return data_->channel_count; }
    int32_t sample_rate() const { return data_->sample_rate; }
    int32_t frame_count() const { return data_->frame_count; }
    bool end_of_stream() const { return data_->end_of_stream; }
    inline void GetTimestampDataView(::mojo_base::mojom::TimeDeltaDataView* output);
...
public:
    ...
    bool has_capture_counter() const { return data_->has_capture_counter; }
    int32_t capture_counter() const { return data_->capture_counter; }
    ...
    bool copy_required() const { return data_->copy_required; }
    bool end_of_stream() const { return data_->end_of_stream; }
    ...
    bool has_frame_rate() const { return data_->has_frame_rate; }
    double frame_rate() const { return data_->frame_rate; }
    bool interactive_content() const { return data_->interactive_content; }
    ...
    bool texture_owner() const { return data_->texture_owner; }
    bool wants_promotion_hint() const { return data_->wants_promotion_hint; }
    bool protected_video() const { return data_->protected_video; }
    bool hw_protected() const { return data_->hw_protected; }
    bool is_webgpu_compatible() const { return data_->is_webgpu_compatible; }
    ...
    bool power_efficient() const { return data_->power_efficient; }
    bool texture_origin_is_top_left() const { return data_->texture_origin_is_top_left; }
    bool has_device_scale_factor() const { return data_->has_device_scale_factor; }
    double device_scale_factor() const { return data_->device_scale_factor; }
    bool has_page_scale_factor() const { return data_->has_page_scale_factor; }
    double page_scale_factor() const { return data_->page_scale_factor; }
    bool has_root_scroll_offset_x() const { return data_->has_root_scroll_offset_x; }
    double root_scroll_offset_x() const { return data_->root_scroll_offset_x; }
    bool has_root_scroll_offset_y() const { return data_->has_root_scroll_offset_y; }
    double root_scroll_offset_y() const { return data_->root_scroll_offset_y; }
    bool has_top_controls_visible_height() const { return data_->has_top_controls_visible_height; }
    double top_controls_visible_height() const { return data_->top_controls_visible_height; }
    ...
    bool has_rtp_timestamp() const { return data_->has_rtp_timestamp; }
    double rtp_timestamp() const { return data_->rtp_timestamp; }
...
public:
    ...
    VideoPixelFormat format() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::media::mojom::VideoPixelFormat>(data_->format)); }
    inline void GetCodedSizeDataView(::gfx::mojom::SizeDataView* output);
...
public:
    ...
    GpuMemoryBufferVideoFrameDataDataView(internal::GpuMemoryBufferVideoFrameData_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
    ...
    inline void GetMailboxHolderDataView(mojo::ArrayDataView<::gpu::mojom::MailboxHolderDataView>* output);

    template <typename UserType> [[nodiscard]] bool ReadMailboxHolder(UserType* output)
    {

        auto* pointer = data_->mailbox_holder.Get();
        return mojo::internal::Deserialize<mojo::ArrayDataView<::gpu::mojom::MailboxHolderDataView>>(pointer, output, message_);
    }
...
public:
    ...
    MailboxVideoFrameDataDataView(internal::MailboxVideoFrameData_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
...
public:
    ...
    bool is_null() const { return !data_; }
    uint64_t audio_bytes_decoded() const { return data_->audio_bytes_decoded; }
    uint64_t video_bytes_decoded() const { return data_->video_bytes_decoded; }
    uint32_t video_frames_decoded() const { return data_->video_frames_decoded; }
    uint32_t video_frames_dropped() const { return data_->video_frames_dropped; }
    int64_t audio_memory_usage() const { return data_->audio_memory_usage; }
    int64_t video_memory_usage() const { return data_->video_memory_usage; }
...
public:
    ...
    double frames_per_sec() const { return data_->frames_per_sec; }
    ...
    bool use_hw_secure_codecs() const { return data_->use_hw_secure_codecs; }
...
public:
    ...
    bool is_null() const { return !data_; }
    uint32_t frames_decoded() const { return data_->frames_decoded; }
    uint32_t frames_dropped() const { return data_->frames_dropped; }
    uint32_t frames_power_efficient() const { return data_->frames_power_efficient; }
...
public:
    ...
    AudioDecoderType decoder_type() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::media::mojom::AudioDecoderType>(data_->decoder_type)); }
    bool is_platform_decoder() const { return data_->is_platform_decoder; }
    bool has_decrypting_demuxer_stream() const { return data_->has_decrypting_demuxer_stream; }
    ...
    EncryptionType encryption_type() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::media::mojom::EncryptionType>(data_->encryption_type)); }
...
public:
    ...
    VideoDecoderType decoder_type() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::media::mojom::VideoDecoderType>(data_->decoder_type)); }
    bool is_platform_decoder() const { return data_->is_platform_decoder; }
    bool has_decrypting_demuxer_stream() const { return data_->has_decrypting_demuxer_stream; }
    template <typename UserType> [[nodiscard]] bool ReadEncryptionType(UserType* output) const
    {
...
public:
    ...
    uint16_t code() const { return data_->code; }
    ...
    uint64_t packed_root_cause() const { return data_->packed_root_cause; }
...
public:
    ...
    inline void GetGpuMemoryBufferDataDataView(GpuMemoryBufferVideoFrameDataDataView* output) const;

    template <typename UserType> [[nodiscard]] bool ReadGpuMemoryBufferData(UserType* output) const
    {

        CHECK(is_gpu_memory_buffer_data());
        return mojo::internal::Deserialize<::media::mojom::GpuMemoryBufferVideoFrameDataDataView>(data_->data.f_gpu_memory_buffer_data.Get(), output, message_);
    }
    bool is_mailbox_data() const { return data_->tag == Tag::kMailboxData; }
    inline void GetMailboxDataDataView(MailboxVideoFrameDataDataView* output) const;

    template <typename UserType> [[nodiscard]] bool ReadMailboxData(UserType* output) const
    {

        CHECK(is_mailbox_data());
        return mojo::internal::Deserialize<::media::mojom::MailboxVideoFrameDataDataView>(data_->data.f_mailbox_data.Get(), output, message_);
    }
...
template <typename MaybeConstUserType> struct Serializer<::media::mojom::VideoDecoderConfigDataView, MaybeConstUserType> {
    ...
    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::media::mojom::internal::VideoDecoderConfig_Data>& fragment)
    {
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
            fragment->color_space_info.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null color_space_info in VideoDecoderConfig struct");
...
template <typename MaybeConstUserType> struct Serializer<::media::mojom::DecryptConfigDataView, MaybeConstUserType> {
    ...
    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::media::mojom::internal::DecryptConfig_Data>& fragment)
    {
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->key_id.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null key_id in DecryptConfig struct");
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->iv.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null iv in DecryptConfig struct");
...
template <typename MaybeConstUserType> struct Serializer<::media::mojom::DecoderBufferDataView, MaybeConstUserType> {
    ...
    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::media::mojom::internal::DecoderBuffer_Data>& fragment)
    {
        if (CallIsNullIfExists<Traits>(input))
            return;
        fragment.Allocate();
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->timestamp.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null timestamp in DecoderBuffer struct");
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->duration.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null duration in DecoderBuffer struct");
        ...
        mojo::internal::Serialize<mojo::ArrayDataView<uint8_t>>(in_side_data, side_data_fragment, &side_data_validate_params);
        fragment->side_data.Set(side_data_fragment.is_null() ? nullptr : side_data_fragment.data());
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->side_data.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null side_data in DecoderBuffer struct");
...
template <typename MaybeConstUserType> struct Serializer<::media::mojom::AudioBufferDataView, MaybeConstUserType> {
    ...
    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::media::mojom::internal::AudioBuffer_Data>& fragment)
    {
        ...
        mojo::internal::Serialize<::mojo_base::mojom::TimeDeltaDataView>(in_timestamp, timestamp_fragment);
        fragment->timestamp.Set(timestamp_fragment.is_null() ? nullptr : timestamp_fragment.data());
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->timestamp.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null timestamp in AudioBuffer struct");
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->data.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null data in AudioBuffer struct");
    }
...
template <typename MaybeConstUserType> struct Serializer<::media::mojom::VideoFrameDataView, MaybeConstUserType> {
    ...
    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::media::mojom::internal::VideoFrame_Data>& fragment)
    {
        ...
        mojo::internal::Serialize<::gfx::mojom::SizeDataView>(in_coded_size, coded_size_fragment);
        fragment->coded_size.Set(coded_size_fragment.is_null() ? nullptr : coded_size_fragment.data());
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->coded_size.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null coded_size in VideoFrame struct");
        decltype(Traits::visible_rect(input)) in_visible_rect = Traits::visible_rect(input);
        mojo::internal::MessageFragment<typename decltype(fragment->visible_rect)::BaseType> visible_rect_fragment(fragment.message());
        mojo::internal::Serialize<::gfx::mojom::RectDataView>(in_visible_rect, visible_rect_fragment);
        fragment->visible_rect.Set(visible_rect_fragment.is_null() ? nullptr : visible_rect_fragment.data());
        ...
        mojo::internal::Serialize<::mojo_base::mojom::TimeDeltaDataView>(in_timestamp, timestamp_fragment);
        fragment->timestamp.Set(timestamp_fragment.is_null() ? nullptr : timestamp_fragment.data());
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->timestamp.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null timestamp in VideoFrame struct");
        decltype(Traits::data(input)) in_data = Traits::data(input);
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->data.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null data in VideoFrame struct");
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->metadata.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null metadata in VideoFrame struct");
...
template <typename MaybeConstUserType> struct Serializer<::media::mojom::GpuMemoryBufferVideoFrameDataDataView, MaybeConstUserType> {
    using UserType = typename std::remove_const<MaybeConstUserType>::type;
    using Traits = StructTraits<::media::mojom::GpuMemoryBufferVideoFrameDataDataView, UserType>;

    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::media::mojom::internal::GpuMemoryBufferVideoFrameData_Data>& fragment)
    {
        if (CallIsNullIfExists<Traits>(input))
            return;
        fragment.Allocate();
        ...
        mojo::internal::Serialize<mojo::ArrayDataView<::gpu::mojom::MailboxHolderDataView>>(in_mailbox_holder, mailbox_holder_fragment, &mailbox_holder_validate_params);
        fragment->mailbox_holder.Set(mailbox_holder_fragment.is_null() ? nullptr : mailbox_holder_fragment.data());
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
            fragment->mailbox_holder.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null mailbox_holder in GpuMemoryBufferVideoFrameData struct");
    }

    static bool Deserialize(::media::mojom::internal::GpuMemoryBufferVideoFrameData_Data* input, UserType* output, Message* message)
    {
        if (!input)
            return CallSetToNullIfExists<Traits>(output);
...
template <typename MaybeConstUserType> struct Serializer<::media::mojom::MailboxVideoFrameDataDataView, MaybeConstUserType> {
    using UserType = typename std::remove_const<MaybeConstUserType>::type;
    using Traits = StructTraits<::media::mojom::MailboxVideoFrameDataDataView, UserType>;

    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::media::mojom::internal::MailboxVideoFrameData_Data>& fragment)
    {
        if (CallIsNullIfExists<Traits>(input))
            return;
        fragment.Allocate();
        ...
        fragment->mailbox_holder.Set(mailbox_holder_fragment.is_null() ? nullptr : mailbox_holder_fragment.data());
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
            fragment->mailbox_holder.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null mailbox_holder in MailboxVideoFrameData struct");
    ...
    static bool Deserialize(::media::mojom::internal::MailboxVideoFrameData_Data* input, UserType* output, Message* message)
    {
        if (!input)
            return CallSetToNullIfExists<Traits>(output);
...
template <typename MaybeConstUserType> struct Serializer<::media::mojom::StatusDataDataView, MaybeConstUserType> {
    ...
    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::media::mojom::internal::StatusData_Data>& fragment)
    {
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->group.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null group in StatusData struct");
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->message.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null message in StatusData struct");
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->frames.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null frames in StatusData struct");
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->data.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null data in StatusData struct");
...
template <typename MaybeConstUserType> struct Serializer<::media::mojom::VideoFrameDataDataView, MaybeConstUserType> {
    ...
    static void Serialize(MaybeConstUserType& input, MessageFragment<::media::mojom::internal::VideoFrameData_Data>& fragment, bool inlined)
    {
        ...
        case ::media::mojom::VideoFrameDataDataView::Tag::kEosData: {
            ...
            MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(value_fragment.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null eos_data in VideoFrameData union");
        ...
        case ::media::mojom::VideoFrameDataDataView::Tag::kGpuMemoryBufferData: {
            decltype(Traits::gpu_memory_buffer_data(input)) in_gpu_memory_buffer_data = Traits::gpu_memory_buffer_data(input);
            mojo::internal::MessageFragment<typename decltype(fragment->data.f_gpu_memory_buffer_data)::BaseType> value_fragment(fragment.message());
            mojo::internal::Serialize<::media::mojom::GpuMemoryBufferVideoFrameDataDataView>(in_gpu_memory_buffer_data, value_fragment);
            MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
                value_fragment.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null gpu_memory_buffer_data in VideoFrameData union");
            fragment->data.f_gpu_memory_buffer_data.Set(value_fragment.is_null() ? nullptr : value_fragment.data());
            break;
        }
        case ::media::mojom::VideoFrameDataDataView::Tag::kMailboxData: {
            decltype(Traits::mailbox_data(input)) in_mailbox_data = Traits::mailbox_data(input);
            mojo::internal::MessageFragment<typename decltype(fragment->data.f_mailbox_data)::BaseType> value_fragment(fragment.message());
            mojo::internal::Serialize<::media::mojom::MailboxVideoFrameDataDataView>(in_mailbox_data, value_fragment);
            MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
                value_fragment.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null mailbox_data in VideoFrameData union");
            fragment->data.f_mailbox_data.Set(value_fragment.is_null() ? nullptr : value_fragment.data());
            break;
        }
        }
    }
...
inline void DecoderBufferDataView::GetSideDataDataView(mojo::ArrayDataView<uint8_t>* output)
{
    auto pointer = data_->side_data.Get();
    *output = mojo::ArrayDataView<uint8_t>(pointer, message_);
}
...
inline void VideoFrameMetadataDataView::GetOverlayPlaneIdDataView(::mojo_base::mojom::UnguessableTokenDataView* output)
{
    auto pointer = data_->overlay_plane_id.Get();
...
inline void GpuMemoryBufferVideoFrameDataDataView::GetGpuMemoryBufferHandleDataView(::gfx::mojom::GpuMemoryBufferHandleDataView* output)
{
    auto pointer = data_->gpu_memory_buffer_handle.Get();
    *output = ::gfx::mojom::GpuMemoryBufferHandleDataView(pointer, message_);
}
inline void GpuMemoryBufferVideoFrameDataDataView::GetMailboxHolderDataView(mojo::ArrayDataView<::gpu::mojom::MailboxHolderDataView>* output)
{
    auto pointer = data_->mailbox_holder.Get();
    *output = mojo::ArrayDataView<::gpu::mojom::MailboxHolderDataView>(pointer, message_);
}
inline void MailboxVideoFrameDataDataView::GetMailboxHolderDataView(mojo::ArrayDataView<::gpu::mojom::MailboxHolderDataView>* output)
{
    auto pointer = data_->mailbox_holder.Get();
    *output = mojo::ArrayDataView<::gpu::mojom::MailboxHolderDataView>(pointer, message_);
}
inline void MailboxVideoFrameDataDataView::GetYcbcrDataDataView(::gpu::mojom::VulkanYCbCrInfoDataView* output)
{
    auto pointer = data_->ycbcr_data.Get();
...
inline void VideoFrameDataDataView::GetGpuMemoryBufferDataDataView(GpuMemoryBufferVideoFrameDataDataView* output) const
{
    CHECK(is_gpu_memory_buffer_data());
    *output = GpuMemoryBufferVideoFrameDataDataView(data_->data.f_gpu_memory_buffer_data.Get(), message_);
}
inline void VideoFrameDataDataView::GetMailboxDataDataView(MailboxVideoFrameDataDataView* output) const
{
    CHECK(is_mailbox_data());
