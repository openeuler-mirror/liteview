...
static_assert(sizeof(RemotingDataStreamSender_SendFrame_Params_Data) == 16, "Bad sizeof(RemotingDataStreamSender_SendFrame_Params_Data)");
...
static_assert(sizeof(RemotingDataStreamReceiver_ReceiveFrame_Params_Data) == 24, "Bad sizeof(RemotingDataStreamReceiver_ReceiveFrame_Params_Data)");
...
public:
    ...
    bool is_null() const { return !data_; }
    uint32_t frame_size() const { return data_->frame_size; }
...
public:
    ...
    {
        UserType result;
        bool ret = mojo::internal::Deserialize<mojo::InterfaceRequestDataView<::media::mojom::RemotingDataStreamSenderInterfaceBase>>(&data_->audio_sender, &result, message_);
        DCHECK(ret);
        return result;
    }
    ...
    {
        UserType result;
        bool ret = mojo::internal::Deserialize<mojo::InterfaceRequestDataView<::media::mojom::RemotingDataStreamSenderInterfaceBase>>(&data_->video_sender, &result, message_);
        DCHECK(ret);
        return result;
    }
...
public:
    ...
    ::media::mojom::RemotingStopReason reason() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::media::mojom::RemotingStopReason>(data_->reason)); }
...
public:
    ...
    Remoter_EstimateTransmissionCapacity_ResponseParamsDataView(internal::Remoter_EstimateTransmissionCapacity_ResponseParams_Data* data, mojo::Message* message)
        : data_(data)
    {
    }

    bool is_null() const { return !data_; }
    double rate() const { return data_->rate; }
...
public:
    ...
    ::media::mojom::RemotingStartFailReason reason() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::media::mojom::RemotingStartFailReason>(data_->reason)); }
...
public:
    ...
    {
        UserType result;
        bool ret = mojo::internal::Deserialize<mojo::InterfacePtrDataView<::media::mojom::RemotingDataStreamReceiverInterfaceBase>>(&data_->audio_stream, &result, message_);
        DCHECK(ret);
        return result;
    }
    ...
    {
        UserType result;
        bool ret = mojo::internal::Deserialize<mojo::InterfacePtrDataView<::media::mojom::RemotingDataStreamReceiverInterfaceBase>>(&data_->video_stream, &result, message_);
        DCHECK(ret);
        return result;
    }
...
public:
    ...
    bool is_null() const { return !data_; }
    uint32_t audio_frame_count() const { return data_->audio_frame_count; }
    uint32_t video_frame_count() const { return data_->video_frame_count; }
...
public:
    ...
    RemotingDataStreamReceiver_InitializeDataPipe_ParamsDataView(internal::RemotingDataStreamReceiver_InitializeDataPipe_Params_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
...
public:
    ...
    bool is_null() const { return !data_; }
    uint32_t frame_count() const { return data_->frame_count; }
