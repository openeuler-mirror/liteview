// media/mojo/mojom/interface_factory.mojom-lite-for-compile.js is auto generated by mojom_bindings_generator.py, do not edit
...
goog.require('media.mojom.AudioDecoder');
goog.require('media.mojom.AudioEncoder');
goog.require('media.mojom.ContentDecryptionModule');
goog.require('media.mojom.MediaFoundationRendererClientExtension');
goog.require('media.mojom.MediaFoundationRendererExtension');
goog.require('media.mojom.MediaLog');
goog.require('media.mojom.Renderer');
goog.require('media.stable.mojom.StableVideoDecoder');
goog.require('media.mojom.VideoDecoder');
goog.require('media.mojom.CdmConfig');
goog.require('media.mojom.CdmContext');
goog.provide('media.mojom.InterfaceFactory');
goog.provide('media.mojom.InterfaceFactoryReceiver');
goog.provide('media.mojom.InterfaceFactoryCallbackRouter');
goog.provide('media.mojom.InterfaceFactoryInterface');
goog.provide('media.mojom.InterfaceFactoryRemote');
goog.provide('media.mojom.InterfaceFactoryPendingReceiver');
/**
...
/** @interface */
media.mojom.InterfaceFactoryInterface = class {
...
goog.provide('media.mojom.InterfaceFactory_CreateAudioDecoder_ParamsSpec');
/**
...
goog.provide('media.mojom.InterfaceFactory_CreateVideoDecoder_ParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('media.mojom.InterfaceFactory_CreateAudioEncoder_ParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('media.mojom.InterfaceFactory_CreateDefaultRenderer_ParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('media.mojom.InterfaceFactory_CreateMediaFoundationRenderer_ParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('media.mojom.InterfaceFactory_CreateCdm_ParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('media.mojom.InterfaceFactory_CreateCdm_ResponseParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('media.mojom.InterfaceFactory_CreateAudioDecoder_Params');
...
goog.provide('media.mojom.InterfaceFactory_CreateVideoDecoder_Params');
...
goog.provide('media.mojom.InterfaceFactory_CreateAudioEncoder_Params');
...
goog.provide('media.mojom.InterfaceFactory_CreateDefaultRenderer_Params');
...
goog.provide('media.mojom.InterfaceFactory_CreateMediaFoundationRenderer_Params');
...
goog.provide('media.mojom.InterfaceFactory_CreateCdm_Params');
...
goog.provide('media.mojom.InterfaceFactory_CreateCdm_ResponseParams');
