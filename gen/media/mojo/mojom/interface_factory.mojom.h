...
// with not having this data in traces there.
    ...
    virtual void CreateMediaFoundationRenderer(::mojo::PendingRemote<::media::mojom::MediaLog> media_log, ::mojo::PendingReceiver<::media::mojom::Renderer> renderer,
        ...
        = 0;
    using CreateCdmCallback = base::OnceCallback<void(::mojo::PendingRemote<::media::mojom::ContentDecryptionModule>, ::media::mojom::CdmContextPtr, const std::string&)>;
...
//
//   void CreateVideoDecoder(::mojo::PendingReceiver<::media::mojom::VideoDecoder> video_decoder, ::mojo::PendingRemote<::media::stable::mojom::StableVideoDecoder>
...
//   ::mojo::PendingReceiver<::media::mojom::MediaFoundationRendererExtension> renderer_extension, ::mojo::PendingRemote<::media::mojom::MediaFoundationRendererClientExtension>
//   client_extension) final;
//
