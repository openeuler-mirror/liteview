...
struct media_mojom_internal_MediaURLScheme_DataHashFn {
    ...
    static bool Equal(const ::media::mojom::MediaURLScheme& left, const ::media::mojom::MediaURLScheme& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::media::mojom::MediaURLScheme> : public GenericHashTraits<::media::mojom::MediaURLScheme> {
    ...
    static void ConstructDeletedValue(::media::mojom::MediaURLScheme& slot, bool) { slot = static_cast<::media::mojom::MediaURLScheme>(-1000001); }
    static bool IsDeletedValue(const ::media::mojom::MediaURLScheme& value) { return value == static_cast<::media::mojom::MediaURLScheme>(-1000001); }
};
} // namespace WTF
namespace media {
namespace mojom {
