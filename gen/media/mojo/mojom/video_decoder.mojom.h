...
//
//   void OnVideoFrameDecoded(const ::scoped_refptr<::media::VideoFrame>& frame, bool can_read_without_stalling, const absl::optional<::base::UnguessableToken>& release_token)
//   final;
//
...
template <> struct StructTraits<::media::mojom::SupportedVideoDecoderConfig::DataView, ::media::mojom::SupportedVideoDecoderConfigPtr> {
    ...
    static const decltype(::media::mojom::SupportedVideoDecoderConfig::coded_size_min)& coded_size_min(const ::media::mojom::SupportedVideoDecoderConfigPtr& input)
    {
        return input->coded_size_min;
    }

    static const decltype(::media::mojom::SupportedVideoDecoderConfig::coded_size_max)& coded_size_max(const ::media::mojom::SupportedVideoDecoderConfigPtr& input)
    {
    ...
    static decltype(::media::mojom::SupportedVideoDecoderConfig::require_encrypted) require_encrypted(const ::media::mojom::SupportedVideoDecoderConfigPtr& input)
    {
...
template <> struct StructTraits<::media::mojom::CommandBufferId::DataView, ::media::mojom::CommandBufferIdPtr> {
    ...
    static const decltype(::media::mojom::CommandBufferId::channel_token)& channel_token(const ::media::mojom::CommandBufferIdPtr& input) { return input->channel_token; }

    static decltype(::media::mojom::CommandBufferId::route_id) route_id(const ::media::mojom::CommandBufferIdPtr& input) { return input->route_id; }
