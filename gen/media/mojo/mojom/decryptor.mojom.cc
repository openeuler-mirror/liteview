...
#ifndef MEDIA_MOJO_MOJOM_DECRYPTOR_MOJOM_JUMBO_H_
#define MEDIA_MOJO_MOJOM_DECRYPTOR_MOJOM_JUMBO_H_
    ...
    ::mojo::ScopedDataPipeConsumerHandle in_decrypt_pipe, ::mojo::ScopedDataPipeProducerHandle in_decrypted_pipe)
{
    ...
    mojo::Message message(internal::kDecryptor_Initialize_Name, kFlags, 0, 0, nullptr);
    ...
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(!mojo::internal::IsHandleOrInterfaceValid(params->audio_pipe), mojo::internal::VALIDATION_ERROR_UNEXPECTED_INVALID_HANDLE,
    ...
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(!mojo::internal::IsHandleOrInterfaceValid(params->video_pipe), mojo::internal::VALIDATION_ERROR_UNEXPECTED_INVALID_HANDLE,
    ...
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(!mojo::internal::IsHandleOrInterfaceValid(params->decrypt_pipe), mojo::internal::VALIDATION_ERROR_UNEXPECTED_INVALID_HANDLE,
    ...
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(!mojo::internal::IsHandleOrInterfaceValid(params->decrypted_pipe), mojo::internal::VALIDATION_ERROR_UNEXPECTED_INVALID_HANDLE,
...
void DecryptorProxy::Decrypt(::media::Decryptor::StreamType in_stream_type, ::media::mojom::DecoderBufferPtr in_encrypted, DecryptCallback callback)
{
    ...
    mojo::Message message(internal::kDecryptor_Decrypt_Name, kFlags, 0, 0, nullptr);
    ...
    mojo::internal::MessageFragment<typename decltype(params->encrypted)::BaseType> encrypted_fragment(params.message());
    mojo::internal::Serialize<::media::mojom::DecoderBufferDataView>(in_encrypted, encrypted_fragment);
    params->encrypted.Set(encrypted_fragment.is_null() ? nullptr : encrypted_fragment.data());
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(params->encrypted.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null encrypted in Decryptor.Decrypt request");
...
void DecryptorProxy::CancelDecrypt(::media::Decryptor::StreamType in_stream_type)
{
    ...
    mojo::Message message(internal::kDecryptor_CancelDecrypt_Name, kFlags, 0, 0, nullptr);
...
void DecryptorProxy::InitializeAudioDecoder(const ::media::AudioDecoderConfig& in_config, InitializeAudioDecoderCallback callback)
{
    ...
    mojo::Message message(internal::kDecryptor_InitializeAudioDecoder_Name, kFlags, 0, 0, nullptr);
...
void DecryptorProxy::InitializeVideoDecoder(const ::media::VideoDecoderConfig& in_config, InitializeVideoDecoderCallback callback)
{
    ...
    mojo::Message message(internal::kDecryptor_InitializeVideoDecoder_Name, kFlags, 0, 0, nullptr);
...
void DecryptorProxy::DecryptAndDecodeAudio(::media::mojom::DecoderBufferPtr in_encrypted, DecryptAndDecodeAudioCallback callback)
{
    ...
    mojo::Message message(internal::kDecryptor_DecryptAndDecodeAudio_Name, kFlags, 0, 0, nullptr);
...
void DecryptorProxy::DecryptAndDecodeVideo(::media::mojom::DecoderBufferPtr in_encrypted, DecryptAndDecodeVideoCallback callback)
{
    ...
    mojo::Message message(internal::kDecryptor_DecryptAndDecodeVideo_Name, kFlags, 0, 0, nullptr);
...
void DecryptorProxy::ResetDecoder(::media::Decryptor::StreamType in_stream_type)
{
    ...
    mojo::Message message(internal::kDecryptor_ResetDecoder_Name, kFlags, 0, 0, nullptr);
...
void DecryptorProxy::DeinitializeDecoder(::media::Decryptor::StreamType in_stream_type)
{
    ...
    mojo::Message message(internal::kDecryptor_DeinitializeDecoder_Name, kFlags, 0, 0, nullptr);
...
public:
    ...
    {
        std::unique_ptr<Decryptor_InitializeAudioDecoder_ProxyToResponder> proxy(new Decryptor_InitializeAudioDecoder_ProxyToResponder(message, std::move(responder)));
...
public:
    ...
    {
        std::unique_ptr<Decryptor_InitializeVideoDecoder_ProxyToResponder> proxy(new Decryptor_InitializeVideoDecoder_ProxyToResponder(message, std::move(responder)));
...
public:
    ...
    {
        std::unique_ptr<Decryptor_DecryptAndDecodeAudio_ProxyToResponder> proxy(new Decryptor_DecryptAndDecodeAudio_ProxyToResponder(message, std::move(responder)));
...
bool Decryptor_DecryptAndDecodeAudio_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    bool success = true;
    ::media::Decryptor::Status p_status = mojo::DefaultConstructTraits::CreateInstance<::media::Decryptor::Status>();
    std::vector<::media::mojom::AudioBufferPtr> p_audio_buffers = mojo::DefaultConstructTraits::CreateInstance<std::vector<::media::mojom::AudioBufferPtr>>();
...
void Decryptor_DecryptAndDecodeAudio_ProxyToResponder::Run(::media::Decryptor::Status in_status, std::vector<::media::mojom::AudioBufferPtr> in_audio_buffers)
{
    ...
    TRACE_EVENT1("mojom", "Send reply media::mojom::Decryptor::DecryptAndDecodeAudio", "async_response_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("status"), in_status, "<value of type ::media::Decryptor::Status>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("audio_buffers"), in_audio_buffers, "<value of type std::vector<::media::mojom::AudioBufferPtr>>");
    });
#endif
    ...
    const mojo::internal::ContainerValidateParams audio_buffers_validate_params(0, false, nullptr);
    mojo::internal::Serialize<mojo::ArrayDataView<::media::mojom::AudioBufferDataView>>(in_audio_buffers, audio_buffers_fragment, &audio_buffers_validate_params);
    params->audio_buffers.Set(audio_buffers_fragment.is_null() ? nullptr : audio_buffers_fragment.data());
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(params->audio_buffers.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null audio_buffers in ");
...
public:
    ...
    {
        std::unique_ptr<Decryptor_DecryptAndDecodeVideo_ProxyToResponder> proxy(new Decryptor_DecryptAndDecodeVideo_ProxyToResponder(message, std::move(responder)));
...
private:
    ...
    void Run(::media::Decryptor::Status in_status, const ::scoped_refptr<::media::VideoFrame>& in_video_frame, ::mojo::PendingRemote<FrameResourceReleaser> in_releaser);
};
...
bool Decryptor_DecryptAndDecodeVideo_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    bool success = true;
    ::media::Decryptor::Status p_status = mojo::DefaultConstructTraits::CreateInstance<::media::Decryptor::Status>();
    ::scoped_refptr<::media::VideoFrame> p_video_frame = mojo::DefaultConstructTraits::CreateInstance<::scoped_refptr<::media::VideoFrame>>();
    ::mojo::PendingRemote<FrameResourceReleaser> p_releaser = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingRemote<FrameResourceReleaser>>();
    ...
    ::media::Decryptor::Status in_status, const ::scoped_refptr<::media::VideoFrame>& in_video_frame, ::mojo::PendingRemote<FrameResourceReleaser> in_releaser)
{
    ...
    mojo::internal::Serialize<mojo::InterfacePtrDataView<::media::mojom::FrameResourceReleaserInterfaceBase>>(in_releaser, &params->releaser, &params.message());
...
bool DecryptorStubDispatch::Accept(Decryptor* impl, mojo::Message* message)
{
    ...
    case internal::kDecryptor_Initialize_Name: {
        ...
        ::mojo::ScopedDataPipeConsumerHandle p_decrypt_pipe = mojo::DefaultConstructTraits::CreateInstance<::mojo::ScopedDataPipeConsumerHandle>();
        ::mojo::ScopedDataPipeProducerHandle p_decrypted_pipe = mojo::DefaultConstructTraits::CreateInstance<::mojo::ScopedDataPipeProducerHandle>();
    ...
    case internal::kDecryptor_CancelDecrypt_Name: {
        ...
        bool success = true;
        ::media::Decryptor::StreamType p_stream_type = mojo::DefaultConstructTraits::CreateInstance<::media::Decryptor::StreamType>();
    ...
    case internal::kDecryptor_DeinitializeDecoder_Name: {
        ...
        DCHECK(message->is_serialized());
        internal::Decryptor_DeinitializeDecoder_Params_Data* params = reinterpret_cast<internal::Decryptor_DeinitializeDecoder_Params_Data*>(message->mutable_payload());
...
bool DecryptorStubDispatch::AcceptWithResponder(Decryptor* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
{
    ...
    case internal::kDecryptor_Decrypt_Name: {
        ...
        bool success = true;
        ::media::Decryptor::StreamType p_stream_type = mojo::DefaultConstructTraits::CreateInstance<::media::Decryptor::StreamType>();
        ::media::mojom::DecoderBufferPtr p_encrypted = mojo::DefaultConstructTraits::CreateInstance<::media::mojom::DecoderBufferPtr>();
    ...
    case internal::kDecryptor_InitializeAudioDecoder_Name: {
        ...
        internal::Decryptor_InitializeAudioDecoder_Params_Data* params = reinterpret_cast<internal::Decryptor_InitializeAudioDecoder_Params_Data*>(message->mutable_payload());
    ...
    case internal::kDecryptor_InitializeVideoDecoder_Name: {
        ...
        internal::Decryptor_InitializeVideoDecoder_Params_Data* params = reinterpret_cast<internal::Decryptor_InitializeVideoDecoder_Params_Data*>(message->mutable_payload());
    ...
    case internal::kDecryptor_DecryptAndDecodeAudio_Name: {
        ...
        internal::Decryptor_DecryptAndDecodeAudio_Params_Data* params = reinterpret_cast<internal::Decryptor_DecryptAndDecodeAudio_Params_Data*>(message->mutable_payload());
    ...
    case internal::kDecryptor_DecryptAndDecodeVideo_Name: {
        ...
        internal::Decryptor_DecryptAndDecodeVideo_Params_Data* params = reinterpret_cast<internal::Decryptor_DecryptAndDecodeVideo_Params_Data*>(message->mutable_payload());
...
static const std::pair<uint32_t, mojo::internal::GenericValidationInfo> kDecryptorValidationInfo[] = {
    { internal::kDecryptor_Initialize_Name, { &internal::Decryptor_Initialize_Params_Data::Validate, nullptr /* no response */ } },
    { internal::kDecryptor_Decrypt_Name, { &internal::Decryptor_Decrypt_Params_Data::Validate, &internal::Decryptor_Decrypt_ResponseParams_Data::Validate } },
    { internal::kDecryptor_CancelDecrypt_Name, { &internal::Decryptor_CancelDecrypt_Params_Data::Validate, nullptr /* no response */ } },
    { internal::kDecryptor_InitializeAudioDecoder_Name,
    ...
    { internal::kDecryptor_InitializeVideoDecoder_Name,
    ...
    { internal::kDecryptor_DecryptAndDecodeAudio_Name,
    ...
    { internal::kDecryptor_DecryptAndDecodeVideo_Name,
    ...
    { internal::kDecryptor_ResetDecoder_Name, { &internal::Decryptor_ResetDecoder_Params_Data::Validate, nullptr /* no response */ } },
    { internal::kDecryptor_DeinitializeDecoder_Name, { &internal::Decryptor_DeinitializeDecoder_Params_Data::Validate, nullptr /* no response */ } },
};
...
// static
bool FrameResourceReleaserStubDispatch::Accept(FrameResourceReleaser* impl, mojo::Message* message) { return false; }

// static
bool FrameResourceReleaserStubDispatch::AcceptWithResponder(FrameResourceReleaser* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
{
    return false;
}
...
void DecryptorInterceptorForTesting::CancelDecrypt(::media::Decryptor::StreamType stream_type) { GetForwardingInterface()->CancelDecrypt(std::move(stream_type)); }
...
void DecryptorInterceptorForTesting::ResetDecoder(::media::Decryptor::StreamType stream_type) { GetForwardingInterface()->ResetDecoder(std::move(stream_type)); }
void DecryptorInterceptorForTesting::DeinitializeDecoder(::media::Decryptor::StreamType stream_type) { GetForwardingInterface()->DeinitializeDecoder(std::move(stream_type)); }
    ...
    ::media::mojom::DecoderBufferPtr encrypted, ::media::Decryptor::Status* out_status, std::vector<::media::mojom::AudioBufferPtr>* out_audio_buffers)
{
    ...
    proxy_->DecryptAndDecodeAudio(std::move(encrypted),
        base::BindOnce(
            [](base::RunLoop* loop, ::media::Decryptor::Status* out_status, std::vector<::media::mojom::AudioBufferPtr>* out_audio_buffers, ::media::Decryptor::Status status,
                std::vector<::media::mojom::AudioBufferPtr> audio_buffers) {
                *out_status = std::move(status);
    ...
    proxy_->DecryptAndDecodeVideo(std::move(encrypted),
        base::BindOnce(
            [](base::RunLoop* loop, ::media::Decryptor::Status* out_status, ::scoped_refptr<::media::VideoFrame>* out_video_frame,
                ::mojo::PendingRemote<FrameResourceReleaser>* out_releaser, ::media::Decryptor::Status status, const ::scoped_refptr<::media::VideoFrame>& video_frame,
