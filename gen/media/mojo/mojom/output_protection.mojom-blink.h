...
#include "media/mojo/mojom/output_protection.mojom-blink-forward.h"
...
struct media_mojom_internal_OutputProtection_ProtectionType_DataHashFn {
    ...
    static bool Equal(const ::media::mojom::OutputProtection_ProtectionType& left, const ::media::mojom::OutputProtection_ProtectionType& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::media::mojom::OutputProtection_ProtectionType> : public GenericHashTraits<::media::mojom::OutputProtection_ProtectionType> {
    static_assert(true, "-1000000 is a reserved enum value");
    static_assert(true, "-1000001 is a reserved enum value");
    static const bool kEmptyValueIsZero = false;
    static ::media::mojom::OutputProtection_ProtectionType EmptyValue() { return static_cast<::media::mojom::OutputProtection_ProtectionType>(-1000000); }
...
struct media_mojom_internal_OutputProtection_LinkType_DataHashFn {
    ...
    static bool Equal(const ::media::mojom::OutputProtection_LinkType& left, const ::media::mojom::OutputProtection_LinkType& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::media::mojom::OutputProtection_LinkType> : public GenericHashTraits<::media::mojom::OutputProtection_LinkType> {
    static_assert(true, "-1000000 is a reserved enum value");
    static_assert(true, "-1000001 is a reserved enum value");
    static const bool kEmptyValueIsZero = false;
    static ::media::mojom::OutputProtection_LinkType EmptyValue() { return static_cast<::media::mojom::OutputProtection_LinkType>(-1000000); }
    static void ConstructDeletedValue(::media::mojom::OutputProtection_LinkType& slot, bool) { slot = static_cast<::media::mojom::OutputProtection_LinkType>(-1000001); }
    static bool IsDeletedValue(const ::media::mojom::OutputProtection_LinkType& value) { return value == static_cast<::media::mojom::OutputProtection_LinkType>(-1000001); }
};
} // namespace WTF
namespace media {
namespace mojom {
