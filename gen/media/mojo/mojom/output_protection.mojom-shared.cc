...
std::ostream& operator<<(std::ostream& os, OutputProtection_ProtectionType value) { return os << OutputProtection_ProtectionTypeToString(value); }
...
std::ostream& operator<<(std::ostream& os, OutputProtection_LinkType value) { return os << OutputProtection_LinkTypeToString(value); }
...
bool OutputProtection_QueryStatus_ResponseParams_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    ...
    // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
    // the message comes from an older version.
    [[maybe_unused]] const OutputProtection_QueryStatus_ResponseParams_Data* object = static_cast<const OutputProtection_QueryStatus_ResponseParams_Data*>(data);
...
bool OutputProtection_EnableProtection_ResponseParams_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    ...
    // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
    // the message comes from an older version.
    [[maybe_unused]] const OutputProtection_EnableProtection_ResponseParams_Data* object = static_cast<const OutputProtection_EnableProtection_ResponseParams_Data*>(data);
...
// static
void TraceFormatTraits<::media::mojom::OutputProtection_ProtectionType>::WriteIntoTrace(perfetto::TracedValue context, ::media::mojom::OutputProtection_ProtectionType value)
{
...
// static
void TraceFormatTraits<::media::mojom::OutputProtection_LinkType>::WriteIntoTrace(perfetto::TracedValue context, ::media::mojom::OutputProtection_LinkType value)
{
