...
public:
    ...
    static constexpr uint32_t Version_ = 0;
    static constexpr bool PassesAssociatedKinds_ = false;
    static inline constexpr uint32_t kSyncMethodOrdinals[] = { 1551061468 };
    static constexpr bool HasUninterruptableMethods_ = false;
...
// class BLINK_PLATFORM_EXPORT MuteStateObserverProxy
//     : public MuteStateObserver {
//  public:
...
//       MuteStateObserver* impl,
//       mojo::Message* message,
//       std::unique_ptr<mojo::MessageReceiverWithStatus> responder);
// };

// template <typename ImplRefTraits =
//               mojo::RawPtrImplRefTraits<MuteStateObserver>>
// class MuteStateObserverStub
...
//       return false;
//     return MuteStateObserverStubDispatch::Accept(
...
//     if (ImplRefTraits::IsNull(sink_))
//       return false;
//     return MuteStateObserverStubDispatch::AcceptWithResponder(
