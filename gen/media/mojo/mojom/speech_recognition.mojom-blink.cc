...
#ifndef MEDIA_MOJO_MOJOM_SPEECH_RECOGNITION_MOJOM_BLINK_JUMBO_H_
#define MEDIA_MOJO_MOJOM_SPEECH_RECOGNITION_MOJOM_BLINK_JUMBO_H_
#endif
...
TimingInformation::TimingInformation(
    ::base::TimeDelta audio_start_time_in, ::base::TimeDelta audio_end_time_in, absl::optional<WTF::Vector<HypothesisPartsPtr>> hypothesis_parts_in)
...
SpeechRecognitionOptions::SpeechRecognitionOptions(
    SpeechRecognitionMode recognition_mode_in, bool enable_formatting_in, const WTF::String& language_in, bool is_server_based_in, RecognizerClientType recognizer_client_type_in)
    : recognition_mode(std::move(recognition_mode_in))
    , enable_formatting(std::move(enable_formatting_in))
    , language(std::move(language_in))
...
bool SpeechRecognitionRecognizerStubDispatch::Accept(SpeechRecognitionRecognizer* impl, mojo::Message* message)
{
    ...
    case internal::kSpeechRecognitionRecognizer_SendAudioToSpeechRecognitionService_Name: {
        ...
        bool success = true;
        ::media::mojom::blink::AudioDataS16Ptr p_buffer = mojo::DefaultConstructTraits::CreateInstance<::media::mojom::blink::AudioDataS16Ptr>();
    ...
    case internal::kSpeechRecognitionRecognizer_OnLanguageChanged_Name: {
        ...
        bool success = true;
        WTF::String p_language = mojo::DefaultConstructTraits::CreateInstance<WTF::String>();
...
void SpeechRecognitionRecognizerClientProxy::OnSpeechRecognitionRecognitionEvent(SpeechRecognitionResultPtr in_result, OnSpeechRecognitionRecognitionEventCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    ...
    SpeechRecognitionRecognizerClient* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
{
    ...
    case internal::kSpeechRecognitionRecognizerClient_OnSpeechRecognitionRecognitionEvent_Name: {
        ...
        bool success = true;
        SpeechRecognitionResultPtr p_result = mojo::DefaultConstructTraits::CreateInstance<SpeechRecognitionResultPtr>();
...
void SpeechRecognitionRecognizerInterceptorForTesting::OnLanguageChanged(const WTF::String& language) { GetForwardingInterface()->OnLanguageChanged(std::move(language)); }
...
void SpeechRecognitionRecognizerClientAsyncWaiter::OnSpeechRecognitionRecognitionEvent(SpeechRecognitionResultPtr result, bool* out_success)
{
    base::RunLoop loop;
