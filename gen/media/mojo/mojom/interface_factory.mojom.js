...
(function() {
  ...
  if (mojo.config.autoLoadMojomDeps) {
    mojo.internal.loadMojomIfNecessary(
        'media/mojo/mojom/audio_encoder.mojom', 'audio_encoder.mojom.js');
  }
  var decryptor$ =
      mojo.internal.exposeNamespace('media.mojom');
  if (mojo.config.autoLoadMojomDeps) {
  ...
  var stable_video_decoder$ =
      mojo.internal.exposeNamespace('media.stable.mojom');
  if (mojo.config.autoLoadMojomDeps) {
    mojo.internal.loadMojomIfNecessary(
        'media/mojo/mojom/stable/stable_video_decoder.mojom', 'stable/stable_video_decoder.mojom.js');
  }
  var video_decoder$ =
      mojo.internal.exposeNamespace('media.mojom');
  if (mojo.config.autoLoadMojomDeps) {
  ...
  InterfaceFactory_CreateVideoDecoder_Params.prototype.initDefaults_ = function() {
    ...
    this.dstVideoDecoder = new stable_video_decoder$.StableVideoDecoderPtr();
  };
  ...
  InterfaceFactory_CreateVideoDecoder_Params.validate = function(messageValidator, offset) {
    ...
    if (err !== validator.validationError.NONE)
        return err;
    // validate InterfaceFactory_CreateVideoDecoder_Params.dstVideoDecoder
  ...
  InterfaceFactory_CreateVideoDecoder_Params.encodedSize = codec.kStructHeaderSize + 16;
  ...
  InterfaceFactory_CreateVideoDecoder_Params.decode = function(decoder) {
    ...
    val.videoDecoder =
        decoder.decodeStruct(codec.InterfaceRequest);
    val.dstVideoDecoder =
        decoder.decodeStruct(new codec.NullableInterface(stable_video_decoder$.StableVideoDecoderPtr));
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  InterfaceFactory_CreateVideoDecoder_Params.encode = function(encoder, val) {
    ...
    encoder.encodeStruct(new codec.NullableInterface(stable_video_decoder$.StableVideoDecoderPtr), val.dstVideoDecoder);
    encoder.skip(1);
    encoder.skip(1);
    encoder.skip(1);
    encoder.skip(1);
  };
  function InterfaceFactory_CreateAudioEncoder_Params(values) {
    this.initDefaults_();
    this.initFields_(values);
  }
  InterfaceFactory_CreateAudioEncoder_Params.prototype.initDefaults_ = function() {
    this.audioEncoder = new bindings.InterfaceRequest();
  };
  InterfaceFactory_CreateAudioEncoder_Params.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  InterfaceFactory_CreateAudioEncoder_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    if (err !== validator.validationError.NONE)
        return err;
    // validate InterfaceFactory_CreateAudioEncoder_Params.audioEncoder
    err = messageValidator.validateInterfaceRequest(offset + codec.kStructHeaderSize + 0, false)
    if (err !== validator.validationError.NONE)
        return err;
  ...
  InterfaceFactory_CreateAudioEncoder_Params.encodedSize = codec.kStructHeaderSize + 8;

  InterfaceFactory_CreateAudioEncoder_Params.decode = function(decoder) {
    var packed;
    var val = new InterfaceFactory_CreateAudioEncoder_Params();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.audioEncoder =
        decoder.decodeStruct(codec.InterfaceRequest);
  ...
  InterfaceFactory_CreateAudioEncoder_Params.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(InterfaceFactory_CreateAudioEncoder_Params.encodedSize);
    encoder.writeUint32(0);
    encoder.encodeStruct(codec.InterfaceRequest, val.audioEncoder);
    encoder.skip(1);
    encoder.skip(1);
    encoder.skip(1);
    encoder.skip(1);
  ...
  function InterfaceFactory_CreateMediaFoundationRenderer_Params(values) {
    this.initDefaults_();
    this.initFields_(values);
  }
  InterfaceFactory_CreateMediaFoundationRenderer_Params.prototype.initDefaults_ = function() {
    this.mediaLog = new media_log$.MediaLogPtr();
    this.renderer = new bindings.InterfaceRequest();
    this.rendererExtension = new bindings.InterfaceRequest();
    this.clientExtension = new renderer_extensions$.MediaFoundationRendererClientExtensionPtr();
  };
  InterfaceFactory_CreateMediaFoundationRenderer_Params.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  InterfaceFactory_CreateMediaFoundationRenderer_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    if (err !== validator.validationError.NONE)
        return err;
    // validate InterfaceFactory_CreateMediaFoundationRenderer_Params.mediaLog
    err = messageValidator.validateInterface(offset + codec.kStructHeaderSize + 0, false);
    if (err !== validator.validationError.NONE)
        return err;
    // validate InterfaceFactory_CreateMediaFoundationRenderer_Params.renderer
    err = messageValidator.validateInterfaceRequest(offset + codec.kStructHeaderSize + 8, false)
    if (err !== validator.validationError.NONE)
        return err;
    // validate InterfaceFactory_CreateMediaFoundationRenderer_Params.rendererExtension
    err = messageValidator.validateInterfaceRequest(offset + codec.kStructHeaderSize + 12, false)
    if (err !== validator.validationError.NONE)
        return err;
    // validate InterfaceFactory_CreateMediaFoundationRenderer_Params.clientExtension
  ...
  InterfaceFactory_CreateMediaFoundationRenderer_Params.encodedSize = codec.kStructHeaderSize + 24;

  InterfaceFactory_CreateMediaFoundationRenderer_Params.decode = function(decoder) {
    var packed;
    var val = new InterfaceFactory_CreateMediaFoundationRenderer_Params();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.mediaLog =
    ...
    val.renderer =
        decoder.decodeStruct(codec.InterfaceRequest);
    val.rendererExtension =
        decoder.decodeStruct(codec.InterfaceRequest);
    val.clientExtension =
        decoder.decodeStruct(new codec.Interface(renderer_extensions$.MediaFoundationRendererClientExtensionPtr));
    return val;
  };

  InterfaceFactory_CreateMediaFoundationRenderer_Params.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(InterfaceFactory_CreateMediaFoundationRenderer_Params.encodedSize);
    encoder.writeUint32(0);
    ...
    encoder.encodeStruct(new codec.Interface(renderer_extensions$.MediaFoundationRendererClientExtensionPtr), val.clientExtension);
  };
  ...
  InterfaceFactory_CreateCdm_Params.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 0, content_decryption_module$.CdmConfig, false);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  var kInterfaceFactory_CreateAudioDecoder_Name = 723055525;
  var kInterfaceFactory_CreateVideoDecoder_Name = 1792908447;
  var kInterfaceFactory_CreateAudioEncoder_Name = 1439555659;
  var kInterfaceFactory_CreateDefaultRenderer_Name = 225779598;
  var kInterfaceFactory_CreateMediaFoundationRenderer_Name = 213223421;
  var kInterfaceFactory_CreateCdm_Name = 19623720;
  ...
  InterfaceFactoryProxy.prototype.createVideoDecoder = function(videoDecoder, dstVideoDecoder) {
    var params_ = new InterfaceFactory_CreateVideoDecoder_Params();
    params_.videoDecoder = videoDecoder;
    params_.dstVideoDecoder = dstVideoDecoder;
    var builder = new codec.MessageV0Builder(
  ...
  InterfaceFactoryPtr.prototype.createAudioEncoder = function() {
    return InterfaceFactoryProxy.prototype.createAudioEncoder
        .apply(this.ptr.getProxy(), arguments);
  };

  InterfaceFactoryProxy.prototype.createAudioEncoder = function(audioEncoder) {
    var params_ = new InterfaceFactory_CreateAudioEncoder_Params();
    params_.audioEncoder = audioEncoder;
    var builder = new codec.MessageV0Builder(
        kInterfaceFactory_CreateAudioEncoder_Name,
        codec.align(InterfaceFactory_CreateAudioEncoder_Params.encodedSize));
    builder.encodeStruct(InterfaceFactory_CreateAudioEncoder_Params, params_);
    var message = builder.finish();
    this.receiver_.accept(message);
  };
  ...
  InterfaceFactoryPtr.prototype.createMediaFoundationRenderer = function() {
    return InterfaceFactoryProxy.prototype.createMediaFoundationRenderer
        .apply(this.ptr.getProxy(), arguments);
  };

  InterfaceFactoryProxy.prototype.createMediaFoundationRenderer = function(mediaLog, renderer, rendererExtension, clientExtension) {
    var params_ = new InterfaceFactory_CreateMediaFoundationRenderer_Params();
    params_.mediaLog = mediaLog;
    params_.renderer = renderer;
    params_.rendererExtension = rendererExtension;
    params_.clientExtension = clientExtension;
    var builder = new codec.MessageV0Builder(
        kInterfaceFactory_CreateMediaFoundationRenderer_Name,
        codec.align(InterfaceFactory_CreateMediaFoundationRenderer_Params.encodedSize));
    builder.encodeStruct(InterfaceFactory_CreateMediaFoundationRenderer_Params, params_);
    var message = builder.finish();
    this.receiver_.accept(message);
  };
  ...
  InterfaceFactoryProxy.prototype.createCdm = function(cdmConfig) {
  ...
  InterfaceFactoryStub.prototype.createVideoDecoder = function(videoDecoder, dstVideoDecoder) {
    return this.delegate_ && this.delegate_.createVideoDecoder && this.delegate_.createVideoDecoder(videoDecoder, dstVideoDecoder);
  }
  InterfaceFactoryStub.prototype.createAudioEncoder = function(audioEncoder) {
    return this.delegate_ && this.delegate_.createAudioEncoder && this.delegate_.createAudioEncoder(audioEncoder);
  }
  ...
  InterfaceFactoryStub.prototype.createMediaFoundationRenderer = function(mediaLog, renderer, rendererExtension, clientExtension) {
    return this.delegate_ && this.delegate_.createMediaFoundationRenderer && this.delegate_.createMediaFoundationRenderer(mediaLog, renderer, rendererExtension, clientExtension);
  }
  InterfaceFactoryStub.prototype.createCdm = function(cdmConfig) {
    return this.delegate_ && this.delegate_.createCdm && this.delegate_.createCdm(cdmConfig);
  }
  ...
  InterfaceFactoryStub.prototype.accept = function(message) {
    ...
    case kInterfaceFactory_CreateVideoDecoder_Name:
      ...
      this.createVideoDecoder(params.videoDecoder, params.dstVideoDecoder);
      return true;
    case kInterfaceFactory_CreateAudioEncoder_Name:
      var params = reader.decodeStruct(InterfaceFactory_CreateAudioEncoder_Params);
      this.createAudioEncoder(params.audioEncoder);
      return true;
    case kInterfaceFactory_CreateDefaultRenderer_Name:
      ...
      return true;
    case kInterfaceFactory_CreateMediaFoundationRenderer_Name:
      var params = reader.decodeStruct(InterfaceFactory_CreateMediaFoundationRenderer_Params);
      this.createMediaFoundationRenderer(params.mediaLog, params.renderer, params.rendererExtension, params.clientExtension);
      return true;
    default:
      return false;
    }
  ...
  InterfaceFactoryStub.prototype.acceptWithResponder =
    ...
    case kInterfaceFactory_CreateCdm_Name:
      ...
      this.createCdm(params.cdmConfig).then(function(response) {
        var responseParams =
  ...
  function validateInterfaceFactoryRequest(messageValidator) {
    ...
    switch (message.getName()) {
      ...
      case kInterfaceFactory_CreateAudioEncoder_Name:
        if (!message.expectsResponse() && !message.isResponse())
          paramsClass = InterfaceFactory_CreateAudioEncoder_Params;
      break;
      case kInterfaceFactory_CreateDefaultRenderer_Name:
        if (!message.expectsResponse() && !message.isResponse())
      ...
      case kInterfaceFactory_CreateMediaFoundationRenderer_Name:
        if (!message.expectsResponse() && !message.isResponse())
          paramsClass = InterfaceFactory_CreateMediaFoundationRenderer_Params;
      break;
      case kInterfaceFactory_CreateCdm_Name:
