    ...
    BindAudioSourceFetcherCallback callback)
{
    ...
    TRACE_EVENT1("mojom", "Send media::mojom::AudioSourceSpeechRecognitionContext::BindAudioSourceFetcher", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("options"), in_options, "<value of type ::media::mojom::blink::SpeechRecognitionOptionsPtr>");
    });
#endif
    ...
    AudioSourceSpeechRecognitionContext* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
{
    ...
    case internal::kAudioSourceSpeechRecognitionContext_BindAudioSourceFetcher_Name: {
        ...
        ::mojo::PendingRemote<::media::mojom::blink::SpeechRecognitionRecognizerClient> p_client
            = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingRemote<::media::mojom::blink::SpeechRecognitionRecognizerClient>>();
        ::media::mojom::blink::SpeechRecognitionOptionsPtr p_options = mojo::DefaultConstructTraits::CreateInstance<::media::mojom::blink::SpeechRecognitionOptionsPtr>();
...
void SpeechRecognitionServiceProxy::BindSpeechRecognitionContext(::mojo::PendingReceiver<::media::mojom::blink::SpeechRecognitionContext> in_context)
{
    ...
    TRACE_EVENT1("mojom", "Send media::mojom::SpeechRecognitionService::BindSpeechRecognitionContext", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("context"), in_context, "<value of type ::mojo::PendingReceiver<::media::mojom::blink::SpeechRecognitionContext>>");
    });
#endif
...
bool SpeechRecognitionServiceStubDispatch::Accept(SpeechRecognitionService* impl, mojo::Message* message)
{
    ...
    case internal::kSpeechRecognitionService_BindSpeechRecognitionContext_Name: {
        ...
        ::mojo::PendingReceiver<::media::mojom::blink::SpeechRecognitionContext> p_context
            = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingReceiver<::media::mojom::blink::SpeechRecognitionContext>>();
    ...
    ::mojo::PendingRemote<::media::mojom::blink::AudioStreamFactory> in_factory, const WTF::String& in_device_id, const ::media::AudioParameters& in_audio_parameters)
{
    ...
    TRACE_EVENT1("mojom", "Send media::mojom::AudioSourceFetcher::Start", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("factory"), in_factory, "<value of type ::mojo::PendingRemote<::media::mojom::blink::AudioStreamFactory>>");
...
bool AudioSourceFetcherStubDispatch::Accept(AudioSourceFetcher* impl, mojo::Message* message)
{
    ...
    case internal::kAudioSourceFetcher_Start_Name: {
        ...
        ::mojo::PendingRemote<::media::mojom::blink::AudioStreamFactory> p_factory
            = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingRemote<::media::mojom::blink::AudioStreamFactory>>();
