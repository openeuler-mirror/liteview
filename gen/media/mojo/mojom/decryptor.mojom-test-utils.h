...
class DecryptorInterceptorForTesting : public Decryptor {
    ...
    void Initialize(::mojo::ScopedDataPipeConsumerHandle audio_pipe, ::mojo::ScopedDataPipeConsumerHandle video_pipe, ::mojo::ScopedDataPipeConsumerHandle decrypt_pipe,
        ::mojo::ScopedDataPipeProducerHandle decrypted_pipe) override;
...
public:
    ...
    void DecryptAndDecodeAudio(::media::mojom::DecoderBufferPtr encrypted, ::media::Decryptor::Status* out_status, std::vector<::media::mojom::AudioBufferPtr>* out_audio_buffers);

    void DecryptAndDecodeVideo(::media::mojom::DecoderBufferPtr encrypted, ::media::Decryptor::Status* out_status, ::scoped_refptr<::media::VideoFrame>* out_video_frame,
