...
public:
    ...
    AudioPipelineInfo(::media::AudioDecoderType decoder_type_in, bool is_platform_decoder_in, bool has_decrypting_demuxer_stream_in, EncryptionType encryption_type_in)
...
public:
    ...
    VideoPipelineInfo(::media::VideoDecoderType decoder_type_in, bool is_platform_decoder_in, bool has_decrypting_demuxer_stream_in, EncryptionType encryption_type_in)
        : decoder_type(std::move(decoder_type_in))
        , is_platform_decoder(std::move(is_platform_decoder_in))
        , has_decrypting_demuxer_stream(std::move(has_decrypting_demuxer_stream_in))
        , encryption_type(std::move(encryption_type_in)) {};
...
public:
    ...
    AudioDecoderConfig(::media::AudioCodec codec_in, ::media::SampleFormat sample_format_in, ::media::ChannelLayout channel_layout_in, int32_t samples_per_second_in,
        std::vector<uint8_t> extra_data_in, ::media::EncryptionScheme encryption_scheme_in, ::base::TimeDelta seek_preroll_in, int32_t codec_delay_in,
...
public:
    ...
    DecryptConfig(::media::EncryptionScheme encryption_scheme_in, const std::string& key_id_in, const std::string& iv_in, std::vector<::media::SubsampleEntry> subsamples_in,
...
public:
    ...
    AudioBuffer(::media::SampleFormat sample_format_in, ::media::ChannelLayout channel_layout_in, int32_t channel_count_in, int32_t sample_rate_in, int32_t frame_count_in,
...
public:
    ...
    SharedMemoryVideoFrameData(::base::ReadOnlySharedMemoryRegion frame_data_in, std::vector<int32_t> strides_in, std::vector<uint32_t> offsets_in)
...
public:
    ...
    GpuMemoryBufferVideoFrameData(::gfx::GpuMemoryBufferHandle gpu_memory_buffer_handle_in, std::vector<::gpu::MailboxHolder> mailbox_holder_in)
...
public:
    ...
    MailboxVideoFrameData(std::vector<::gpu::MailboxHolder> mailbox_holder_in, absl::optional<::gpu::VulkanYCbCrInfo> ycbcr_data_in)
        : mailbox_holder(std::move(mailbox_holder_in))
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<MailboxVideoFrameData::DataView, std::vector<uint8_t>>(input);
    }
...
public:
    ...
    StatusData(const std::string& group_in, uint16_t code_in, const std::string& message_in, std::vector<::base::Value> frames_in,
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input) { return mojo::internal::SerializeImpl<StatusData::DataView, std::vector<uint8_t>>(input); }
...
public:
    ...
    explicit EncoderStatus(const absl::optional<::media::internal::StatusData>& internal_in)
...
public:
    ...
    explicit DecoderStatus(const absl::optional<::media::internal::StatusData>& internal_in)
        : internal(std::move(internal_in)) {};
...
public:
    ...
    explicit PipelineStatus(const absl::optional<::media::internal::StatusData>& internal_in)
        : internal(std::move(internal_in)) {};
...
public:
    ...
    VideoFrame(::media::VideoPixelFormat format_in, const ::gfx::Size& coded_size_in, const ::gfx::Rect& visible_rect_in, const ::gfx::Size& natural_size_in,
...
template <> struct StructTraits<::media::mojom::VideoTransformation::DataView, ::media::mojom::VideoTransformationPtr> {
    ...
    static decltype(::media::mojom::VideoTransformation::rotation) rotation(const ::media::mojom::VideoTransformationPtr& input) { return input->rotation; }

    static decltype(::media::mojom::VideoTransformation::mirrored) mirrored(const ::media::mojom::VideoTransformationPtr& input) { return input->mirrored; }
...
template <> struct StructTraits<::media::mojom::VideoColorSpace::DataView, ::media::mojom::VideoColorSpacePtr> {
    ...
    static decltype(::media::mojom::VideoColorSpace::primaries) primaries(const ::media::mojom::VideoColorSpacePtr& input) { return input->primaries; }

    static decltype(::media::mojom::VideoColorSpace::transfer) transfer(const ::media::mojom::VideoColorSpacePtr& input) { return input->transfer; }

    static decltype(::media::mojom::VideoColorSpace::matrix) matrix(const ::media::mojom::VideoColorSpacePtr& input) { return input->matrix; }

    static decltype(::media::mojom::VideoColorSpace::range) range(const ::media::mojom::VideoColorSpacePtr& input) { return input->range; }
...
template <> struct StructTraits<::media::mojom::AudioDecoderConfig::DataView, ::media::mojom::AudioDecoderConfigPtr> {
    ...
    static decltype(::media::mojom::AudioDecoderConfig::codec) codec(const ::media::mojom::AudioDecoderConfigPtr& input) { return input->codec; }

    static decltype(::media::mojom::AudioDecoderConfig::sample_format) sample_format(const ::media::mojom::AudioDecoderConfigPtr& input) { return input->sample_format; }

    static decltype(::media::mojom::AudioDecoderConfig::channel_layout) channel_layout(const ::media::mojom::AudioDecoderConfigPtr& input) { return input->channel_layout; }
    ...
    static const decltype(::media::mojom::AudioDecoderConfig::extra_data)& extra_data(const ::media::mojom::AudioDecoderConfigPtr& input) { return input->extra_data; }
    ...
    static const decltype(::media::mojom::AudioDecoderConfig::seek_preroll)& seek_preroll(const ::media::mojom::AudioDecoderConfigPtr& input) { return input->seek_preroll; }

    static decltype(::media::mojom::AudioDecoderConfig::codec_delay) codec_delay(const ::media::mojom::AudioDecoderConfigPtr& input) { return input->codec_delay; }

    static decltype(::media::mojom::AudioDecoderConfig::profile) profile(const ::media::mojom::AudioDecoderConfigPtr& input) { return input->profile; }

    static decltype(::media::mojom::AudioDecoderConfig::target_output_channel_layout) target_output_channel_layout(const ::media::mojom::AudioDecoderConfigPtr& input)
    {
        return input->target_output_channel_layout;
    }

    static decltype(::media::mojom::AudioDecoderConfig::target_output_sample_format) target_output_sample_format(const ::media::mojom::AudioDecoderConfigPtr& input)
    {
        return input->target_output_sample_format;
    }

    static decltype(::media::mojom::AudioDecoderConfig::should_discard_decoder_delay) should_discard_decoder_delay(const ::media::mojom::AudioDecoderConfigPtr& input)
    {
        return input->should_discard_decoder_delay;
    }

    static const decltype(::media::mojom::AudioDecoderConfig::aac_extra_data)& aac_extra_data(const ::media::mojom::AudioDecoderConfigPtr& input) { return input->aac_extra_data; }
...
template <> struct StructTraits<::media::mojom::VideoDecoderConfig::DataView, ::media::mojom::VideoDecoderConfigPtr> {
    ...
    static decltype(::media::mojom::VideoDecoderConfig::codec) codec(const ::media::mojom::VideoDecoderConfigPtr& input) { return input->codec; }

    static decltype(::media::mojom::VideoDecoderConfig::profile) profile(const ::media::mojom::VideoDecoderConfigPtr& input) { return input->profile; }

    static decltype(::media::mojom::VideoDecoderConfig::level) level(const ::media::mojom::VideoDecoderConfigPtr& input) { return input->level; }

    static decltype(::media::mojom::VideoDecoderConfig::has_alpha) has_alpha(const ::media::mojom::VideoDecoderConfigPtr& input) { return input->has_alpha; }

    static const decltype(::media::mojom::VideoDecoderConfig::transformation)& transformation(const ::media::mojom::VideoDecoderConfigPtr& input) { return input->transformation; }

    static const decltype(::media::mojom::VideoDecoderConfig::coded_size)& coded_size(const ::media::mojom::VideoDecoderConfigPtr& input) { return input->coded_size; }

    static const decltype(::media::mojom::VideoDecoderConfig::visible_rect)& visible_rect(const ::media::mojom::VideoDecoderConfigPtr& input) { return input->visible_rect; }

    static const decltype(::media::mojom::VideoDecoderConfig::natural_size)& natural_size(const ::media::mojom::VideoDecoderConfigPtr& input) { return input->natural_size; }

    static const decltype(::media::mojom::VideoDecoderConfig::extra_data)& extra_data(const ::media::mojom::VideoDecoderConfigPtr& input) { return input->extra_data; }
    ...
    static const decltype(::media::mojom::VideoDecoderConfig::hdr_metadata)& hdr_metadata(const ::media::mojom::VideoDecoderConfigPtr& input) { return input->hdr_metadata; }
...
template <> struct StructTraits<::media::mojom::DecryptConfig::DataView, ::media::mojom::DecryptConfigPtr> {
    ...
    static decltype(::media::mojom::DecryptConfig::encryption_scheme) encryption_scheme(const ::media::mojom::DecryptConfigPtr& input) { return input->encryption_scheme; }

    static const decltype(::media::mojom::DecryptConfig::key_id)& key_id(const ::media::mojom::DecryptConfigPtr& input) { return input->key_id; }

    static const decltype(::media::mojom::DecryptConfig::iv)& iv(const ::media::mojom::DecryptConfigPtr& input) { return input->iv; }

    static const decltype(::media::mojom::DecryptConfig::subsamples)& subsamples(const ::media::mojom::DecryptConfigPtr& input) { return input->subsamples; }
...
template <> struct StructTraits<::media::mojom::DecoderBuffer::DataView, ::media::mojom::DecoderBufferPtr> {
    ...
    static const decltype(::media::mojom::DecoderBuffer::timestamp)& timestamp(const ::media::mojom::DecoderBufferPtr& input) { return input->timestamp; }

    static const decltype(::media::mojom::DecoderBuffer::duration)& duration(const ::media::mojom::DecoderBufferPtr& input) { return input->duration; }

    static decltype(::media::mojom::DecoderBuffer::is_end_of_stream) is_end_of_stream(const ::media::mojom::DecoderBufferPtr& input) { return input->is_end_of_stream; }

    static decltype(::media::mojom::DecoderBuffer::data_size) data_size(const ::media::mojom::DecoderBufferPtr& input) { return input->data_size; }

    static decltype(::media::mojom::DecoderBuffer::is_key_frame) is_key_frame(const ::media::mojom::DecoderBufferPtr& input) { return input->is_key_frame; }

    static const decltype(::media::mojom::DecoderBuffer::side_data)& side_data(const ::media::mojom::DecoderBufferPtr& input) { return input->side_data; }

    static const decltype(::media::mojom::DecoderBuffer::decrypt_config)& decrypt_config(const ::media::mojom::DecoderBufferPtr& input) { return input->decrypt_config; }

    static const decltype(::media::mojom::DecoderBuffer::front_discard)& front_discard(const ::media::mojom::DecoderBufferPtr& input) { return input->front_discard; }

    static const decltype(::media::mojom::DecoderBuffer::back_discard)& back_discard(const ::media::mojom::DecoderBufferPtr& input) { return input->back_discard; }
...
template <> struct StructTraits<::media::mojom::AudioBuffer::DataView, ::media::mojom::AudioBufferPtr> {
    ...
    static decltype(::media::mojom::AudioBuffer::sample_format) sample_format(const ::media::mojom::AudioBufferPtr& input) { return input->sample_format; }

    static decltype(::media::mojom::AudioBuffer::channel_layout) channel_layout(const ::media::mojom::AudioBufferPtr& input) { return input->channel_layout; }

    static decltype(::media::mojom::AudioBuffer::channel_count) channel_count(const ::media::mojom::AudioBufferPtr& input) { return input->channel_count; }

    static decltype(::media::mojom::AudioBuffer::sample_rate) sample_rate(const ::media::mojom::AudioBufferPtr& input) { return input->sample_rate; }

    static decltype(::media::mojom::AudioBuffer::frame_count) frame_count(const ::media::mojom::AudioBufferPtr& input) { return input->frame_count; }

    static decltype(::media::mojom::AudioBuffer::end_of_stream) end_of_stream(const ::media::mojom::AudioBufferPtr& input) { return input->end_of_stream; }

    static const decltype(::media::mojom::AudioBuffer::timestamp)& timestamp(const ::media::mojom::AudioBufferPtr& input) { return input->timestamp; }

    static const decltype(::media::mojom::AudioBuffer::data)& data(const ::media::mojom::AudioBufferPtr& input) { return input->data; }
...
template <> struct StructTraits<::media::mojom::VideoFrameMetadata::DataView, ::media::mojom::VideoFrameMetadataPtr> {
    ...
    static decltype(::media::mojom::VideoFrameMetadata::allow_overlay) allow_overlay(const ::media::mojom::VideoFrameMetadataPtr& input) { return input->allow_overlay; }
    ...
    static decltype(::media::mojom::VideoFrameMetadata::capture_counter) capture_counter(const ::media::mojom::VideoFrameMetadataPtr& input) { return input->capture_counter; }
    ...
    static const decltype(::media::mojom::VideoFrameMetadata::source_size)& source_size(const ::media::mojom::VideoFrameMetadataPtr& input) { return input->source_size; }
    ...
    static decltype(::media::mojom::VideoFrameMetadata::crop_version) crop_version(const ::media::mojom::VideoFrameMetadataPtr& input) { return input->crop_version; }

    static decltype(::media::mojom::VideoFrameMetadata::copy_required) copy_required(const ::media::mojom::VideoFrameMetadataPtr& input) { return input->copy_required; }

    static decltype(::media::mojom::VideoFrameMetadata::end_of_stream) end_of_stream(const ::media::mojom::VideoFrameMetadataPtr& input) { return input->end_of_stream; }

    static const decltype(::media::mojom::VideoFrameMetadata::frame_duration)& frame_duration(const ::media::mojom::VideoFrameMetadataPtr& input) { return input->frame_duration; }

    static decltype(::media::mojom::VideoFrameMetadata::has_frame_rate) has_frame_rate(const ::media::mojom::VideoFrameMetadataPtr& input) { return input->has_frame_rate; }

    static decltype(::media::mojom::VideoFrameMetadata::frame_rate) frame_rate(const ::media::mojom::VideoFrameMetadataPtr& input) { return input->frame_rate; }
    ...
    static const decltype(::media::mojom::VideoFrameMetadata::reference_time)& reference_time(const ::media::mojom::VideoFrameMetadataPtr& input) { return input->reference_time; }
    ...
    static const decltype(::media::mojom::VideoFrameMetadata::transformation)& transformation(const ::media::mojom::VideoFrameMetadataPtr& input) { return input->transformation; }

    static decltype(::media::mojom::VideoFrameMetadata::texture_owner) texture_owner(const ::media::mojom::VideoFrameMetadataPtr& input) { return input->texture_owner; }
    ...
    static decltype(::media::mojom::VideoFrameMetadata::protected_video) protected_video(const ::media::mojom::VideoFrameMetadataPtr& input) { return input->protected_video; }

    static decltype(::media::mojom::VideoFrameMetadata::hw_protected) hw_protected(const ::media::mojom::VideoFrameMetadataPtr& input) { return input->hw_protected; }
    ...
    static const decltype(::media::mojom::VideoFrameMetadata::overlay_plane_id)& overlay_plane_id(const ::media::mojom::VideoFrameMetadataPtr& input)
    {
        return input->overlay_plane_id;
    }

    static decltype(::media::mojom::VideoFrameMetadata::power_efficient) power_efficient(const ::media::mojom::VideoFrameMetadataPtr& input) { return input->power_efficient; }

    static decltype(::media::mojom::VideoFrameMetadata::texture_origin_is_top_left) texture_origin_is_top_left(const ::media::mojom::VideoFrameMetadataPtr& input)
    {
    ...
    static decltype(::media::mojom::VideoFrameMetadata::has_top_controls_visible_height) has_top_controls_visible_height(const ::media::mojom::VideoFrameMetadataPtr& input)
    {
        return input->has_top_controls_visible_height;
    }

    static decltype(::media::mojom::VideoFrameMetadata::top_controls_visible_height) top_controls_visible_height(const ::media::mojom::VideoFrameMetadataPtr& input)
    {
    ...
    static decltype(::media::mojom::VideoFrameMetadata::rtp_timestamp) rtp_timestamp(const ::media::mojom::VideoFrameMetadataPtr& input) { return input->rtp_timestamp; }

    static const decltype(::media::mojom::VideoFrameMetadata::receive_time)& receive_time(const ::media::mojom::VideoFrameMetadataPtr& input) { return input->receive_time; }

    static const decltype(::media::mojom::VideoFrameMetadata::wallclock_frame_duration)& wallclock_frame_duration(const ::media::mojom::VideoFrameMetadataPtr& input)
    {
...
template <> struct StructTraits<::media::mojom::VideoFrame::DataView, ::media::mojom::VideoFramePtr> {
    ...
    static decltype(::media::mojom::VideoFrame::format) format(const ::media::mojom::VideoFramePtr& input) { return input->format; }

    static const decltype(::media::mojom::VideoFrame::coded_size)& coded_size(const ::media::mojom::VideoFramePtr& input) { return input->coded_size; }

    static const decltype(::media::mojom::VideoFrame::visible_rect)& visible_rect(const ::media::mojom::VideoFramePtr& input) { return input->visible_rect; }

    static const decltype(::media::mojom::VideoFrame::natural_size)& natural_size(const ::media::mojom::VideoFramePtr& input) { return input->natural_size; }

    static const decltype(::media::mojom::VideoFrame::timestamp)& timestamp(const ::media::mojom::VideoFramePtr& input) { return input->timestamp; }

    static decltype(::media::mojom::VideoFrame::data)& data(::media::mojom::VideoFramePtr& input) { return input->data; }

    static const decltype(::media::mojom::VideoFrame::metadata)& metadata(const ::media::mojom::VideoFramePtr& input) { return input->metadata; }

    static const decltype(::media::mojom::VideoFrame::color_space)& color_space(const ::media::mojom::VideoFramePtr& input) { return input->color_space; }

    static const decltype(::media::mojom::VideoFrame::hdr_metadata)& hdr_metadata(const ::media::mojom::VideoFramePtr& input) { return input->hdr_metadata; }
...
template <> struct StructTraits<::media::mojom::SharedMemoryVideoFrameData::DataView, ::media::mojom::SharedMemoryVideoFrameDataPtr> {
    ...
    static decltype(::media::mojom::SharedMemoryVideoFrameData::frame_data)& frame_data(::media::mojom::SharedMemoryVideoFrameDataPtr& input) { return input->frame_data; }

    static const decltype(::media::mojom::SharedMemoryVideoFrameData::strides)& strides(const ::media::mojom::SharedMemoryVideoFrameDataPtr& input) { return input->strides; }

    static const decltype(::media::mojom::SharedMemoryVideoFrameData::offsets)& offsets(const ::media::mojom::SharedMemoryVideoFrameDataPtr& input) { return input->offsets; }

    static bool Read(::media::mojom::SharedMemoryVideoFrameData::DataView input, ::media::mojom::SharedMemoryVideoFrameDataPtr* output);
};
template <> struct StructTraits<::media::mojom::GpuMemoryBufferVideoFrameData::DataView, ::media::mojom::GpuMemoryBufferVideoFrameDataPtr> {
    ...
    static decltype(::media::mojom::GpuMemoryBufferVideoFrameData::gpu_memory_buffer_handle)& gpu_memory_buffer_handle(::media::mojom::GpuMemoryBufferVideoFrameDataPtr& input)
    {
        return input->gpu_memory_buffer_handle;
    }

    static const decltype(::media::mojom::GpuMemoryBufferVideoFrameData::mailbox_holder)& mailbox_holder(const ::media::mojom::GpuMemoryBufferVideoFrameDataPtr& input)
    {
...
template <> struct StructTraits<::media::mojom::MailboxVideoFrameData::DataView, ::media::mojom::MailboxVideoFrameDataPtr> {
    ...
    static const decltype(::media::mojom::MailboxVideoFrameData::mailbox_holder)& mailbox_holder(const ::media::mojom::MailboxVideoFrameDataPtr& input)
    {
        return input->mailbox_holder;
    }

    static const decltype(::media::mojom::MailboxVideoFrameData::ycbcr_data)& ycbcr_data(const ::media::mojom::MailboxVideoFrameDataPtr& input) { return input->ycbcr_data; }
...
template <> struct StructTraits<::media::mojom::PredictionFeatures::DataView, ::media::mojom::PredictionFeaturesPtr> {
    ...
    static decltype(::media::mojom::PredictionFeatures::profile) profile(const ::media::mojom::PredictionFeaturesPtr& input) { return input->profile; }

    static const decltype(::media::mojom::PredictionFeatures::video_size)& video_size(const ::media::mojom::PredictionFeaturesPtr& input) { return input->video_size; }

    static decltype(::media::mojom::PredictionFeatures::frames_per_sec) frames_per_sec(const ::media::mojom::PredictionFeaturesPtr& input) { return input->frames_per_sec; }

    static const decltype(::media::mojom::PredictionFeatures::key_system)& key_system(const ::media::mojom::PredictionFeaturesPtr& input) { return input->key_system; }
...
template <> struct StructTraits<::media::mojom::PredictionTargets::DataView, ::media::mojom::PredictionTargetsPtr> {
    ...
    static decltype(::media::mojom::PredictionTargets::frames_decoded) frames_decoded(const ::media::mojom::PredictionTargetsPtr& input) { return input->frames_decoded; }

    static decltype(::media::mojom::PredictionTargets::frames_dropped) frames_dropped(const ::media::mojom::PredictionTargetsPtr& input) { return input->frames_dropped; }
...
template <> struct StructTraits<::media::mojom::AudioPipelineInfo::DataView, ::media::mojom::AudioPipelineInfoPtr> {
    ...
    static decltype(::media::mojom::AudioPipelineInfo::decoder_type) decoder_type(const ::media::mojom::AudioPipelineInfoPtr& input) { return input->decoder_type; }
    ...
    static decltype(::media::mojom::AudioPipelineInfo::has_decrypting_demuxer_stream) has_decrypting_demuxer_stream(const ::media::mojom::AudioPipelineInfoPtr& input)
    {
        return input->has_decrypting_demuxer_stream;
    }

    static decltype(::media::mojom::AudioPipelineInfo::encryption_type) encryption_type(const ::media::mojom::AudioPipelineInfoPtr& input) { return input->encryption_type; }
...
template <> struct StructTraits<::media::mojom::VideoPipelineInfo::DataView, ::media::mojom::VideoPipelineInfoPtr> {
    ...
    static decltype(::media::mojom::VideoPipelineInfo::decoder_type) decoder_type(const ::media::mojom::VideoPipelineInfoPtr& input) { return input->decoder_type; }
    ...
    static decltype(::media::mojom::VideoPipelineInfo::has_decrypting_demuxer_stream) has_decrypting_demuxer_stream(const ::media::mojom::VideoPipelineInfoPtr& input)
    {
        return input->has_decrypting_demuxer_stream;
    }

    static decltype(::media::mojom::VideoPipelineInfo::encryption_type) encryption_type(const ::media::mojom::VideoPipelineInfoPtr& input) { return input->encryption_type; }
...
template <> struct StructTraits<::media::mojom::StatusData::DataView, ::media::mojom::StatusDataPtr> {
    ...
    static const decltype(::media::mojom::StatusData::group)& group(const ::media::mojom::StatusDataPtr& input) { return input->group; }

    static decltype(::media::mojom::StatusData::code) code(const ::media::mojom::StatusDataPtr& input) { return input->code; }

    static const decltype(::media::mojom::StatusData::message)& message(const ::media::mojom::StatusDataPtr& input) { return input->message; }

    static const decltype(::media::mojom::StatusData::frames)& frames(const ::media::mojom::StatusDataPtr& input) { return input->frames; }

    static const decltype(::media::mojom::StatusData::cause)& cause(const ::media::mojom::StatusDataPtr& input) { return input->cause; }

    static const decltype(::media::mojom::StatusData::data)& data(const ::media::mojom::StatusDataPtr& input) { return input->data; }

    static decltype(::media::mojom::StatusData::packed_root_cause) packed_root_cause(const ::media::mojom::StatusDataPtr& input) { return input->packed_root_cause; }
...
template <> struct StructTraits<::media::mojom::EncoderStatus::DataView, ::media::mojom::EncoderStatusPtr> {
    ...
    static const decltype(::media::mojom::EncoderStatus::internal)& internal(const ::media::mojom::EncoderStatusPtr& input) { return input->internal; }
...
template <> struct StructTraits<::media::mojom::DecoderStatus::DataView, ::media::mojom::DecoderStatusPtr> {
    ...
    static const decltype(::media::mojom::DecoderStatus::internal)& internal(const ::media::mojom::DecoderStatusPtr& input) { return input->internal; }
...
template <> struct StructTraits<::media::mojom::PipelineStatus::DataView, ::media::mojom::PipelineStatusPtr> {
    ...
    static const decltype(::media::mojom::PipelineStatus::internal)& internal(const ::media::mojom::PipelineStatusPtr& input) { return input->internal; }
...
template <> struct UnionTraits<::media::mojom::VideoFrameData::DataView, ::media::mojom::VideoFrameDataPtr> {
    ...
    static ::media::mojom::VideoFrameData::Tag GetTag(const ::media::mojom::VideoFrameDataPtr& input) { return input->which(); }

    static const ::media::mojom::EosVideoFrameDataPtr& eos_data(const ::media::mojom::VideoFrameDataPtr& input) { return input->get_eos_data(); }

    static ::media::mojom::SharedMemoryVideoFrameDataPtr& shared_memory_data(::media::mojom::VideoFrameDataPtr& input) { return input->get_shared_memory_data(); }

    static ::media::mojom::GpuMemoryBufferVideoFrameDataPtr& gpu_memory_buffer_data(::media::mojom::VideoFrameDataPtr& input) { return input->get_gpu_memory_buffer_data(); }

    static const ::media::mojom::MailboxVideoFrameDataPtr& mailbox_data(const ::media::mojom::VideoFrameDataPtr& input) { return input->get_mailbox_data(); }
