...
class BLINK_PLATFORM_EXPORT VideoDecoderInterceptorForTesting : public VideoDecoder {
    ...
    void Initialize(
        ::media::mojom::blink::VideoDecoderConfigPtr config, bool low_delay, const absl::optional<::base::UnguessableToken>& cdm_id, InitializeCallback callback) override;
...
public:
    ...
    void Initialize(::media::mojom::blink::VideoDecoderConfigPtr config, bool low_delay, const absl::optional<::base::UnguessableToken>& cdm_id,
