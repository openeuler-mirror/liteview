...
std::ostream& operator<<(std::ostream& os, RemotingStopReason value) { return os << RemotingStopReasonToString(value); }
...
std::ostream& operator<<(std::ostream& os, RemotingStartFailReason value) { return os << RemotingStartFailReasonToString(value); }
...
std::ostream& operator<<(std::ostream& os, RemotingSinkFeature value) { return os << RemotingSinkFeatureToString(value); }
...
std::ostream& operator<<(std::ostream& os, RemotingSinkAudioCapability value) { return os << RemotingSinkAudioCapabilityToString(value); }
...
std::ostream& operator<<(std::ostream& os, RemotingSinkVideoCapability value) { return os << RemotingSinkVideoCapabilityToString(value); }
...
bool RemotingSinkMetadata_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    ...
    const mojo::internal::ContainerValidateParams friendly_name_validate_params(0, false, nullptr);
...
// static
void TraceFormatTraits<::media::mojom::RemotingSinkAudioCapability>::WriteIntoTrace(perfetto::TracedValue context, ::media::mojom::RemotingSinkAudioCapability value)
{
...
// static
void TraceFormatTraits<::media::mojom::RemotingSinkVideoCapability>::WriteIntoTrace(perfetto::TracedValue context, ::media::mojom::RemotingSinkVideoCapability value)
{
