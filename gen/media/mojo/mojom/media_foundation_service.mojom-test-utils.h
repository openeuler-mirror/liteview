...
class MediaFoundationServiceInterceptorForTesting : public MediaFoundationService {
    ...
    void CreateInterfaceFactory(
        ::mojo::PendingReceiver<::media::mojom::InterfaceFactory> factory, ::mojo::PendingRemote<::media::mojom::FrameInterfaceFactory> frame_interfaces) override;
};
...
public:
    ...
    void IsKeySystemSupported(const std::string& key_system, bool* out_is_supported, ::media::mojom::KeySystemCapabilityPtr* out_key_system_capability);
