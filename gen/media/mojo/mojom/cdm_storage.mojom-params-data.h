...
public:
    ...
    CdmStorage_Status status() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::media::mojom::CdmStorage_Status>(data_->status)); }
...
public:
    ...
    CdmFile_Status status() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::media::mojom::CdmFile_Status>(data_->status)); }
