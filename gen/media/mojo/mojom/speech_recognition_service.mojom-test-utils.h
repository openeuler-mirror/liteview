...
class AudioSourceSpeechRecognitionContextInterceptorForTesting : public AudioSourceSpeechRecognitionContext {
    ...
    void BindAudioSourceFetcher(::mojo::PendingReceiver<AudioSourceFetcher> fetcher_receiver, ::mojo::PendingRemote<::media::mojom::SpeechRecognitionRecognizerClient> client,
        ::media::mojom::SpeechRecognitionOptionsPtr options, BindAudioSourceFetcherCallback callback) override;
};
...
public:
    ...
    void BindAudioSourceFetcher(::mojo::PendingReceiver<AudioSourceFetcher> fetcher_receiver, ::mojo::PendingRemote<::media::mojom::SpeechRecognitionRecognizerClient> client,
        ::media::mojom::SpeechRecognitionOptionsPtr options, bool* out_is_multichannel_supported);
    bool BindAudioSourceFetcher(::mojo::PendingReceiver<AudioSourceFetcher> fetcher_receiver, ::mojo::PendingRemote<::media::mojom::SpeechRecognitionRecognizerClient> client,
...
class SpeechRecognitionServiceInterceptorForTesting : public SpeechRecognitionService {
    ...
    void SetSodaPath(const ::base::FilePath& binary_path, const ::base::FilePath& config_path) override;
};
...
class AudioSourceFetcherInterceptorForTesting : public AudioSourceFetcher {
    ...
    void Start(::mojo::PendingRemote<::media::mojom::AudioStreamFactory> factory, const std::string& device_id, const ::media::AudioParameters& audio_parameters) override;
    void Stop() override;
};
