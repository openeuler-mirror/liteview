...
public:
    ...
    void Initialize(const ::media::VideoDecoderConfig& config, bool low_delay, const absl::optional<::base::UnguessableToken>& cdm_id, ::media::DecoderStatus* out_status,
...
class VideoDecoderClientInterceptorForTesting : public VideoDecoderClient {
    ...
    void OnVideoFrameDecoded(
        const ::scoped_refptr<::media::VideoFrame>& frame, bool can_read_without_stalling, const absl::optional<::base::UnguessableToken>& release_token) override;
