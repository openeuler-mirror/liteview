...
(function() {
  ...
  AudioDecoder_Initialize_ResponseParams.encode = function(encoder, val) {
    ...
    encoder.writeUint32(0);
    encoder.encodeStructPointer(media_types$.DecoderStatus, val.success);
    packed = 0;
  ...
  var kAudioDecoder_Construct_Name = 1964702758;
  var kAudioDecoder_Initialize_Name = 823643506;
  var kAudioDecoder_SetDataSource_Name = 1048662827;
  var kAudioDecoder_Decode_Name = 149946287;
  var kAudioDecoder_Reset_Name = 1607011748;
  ...
  var kAudioDecoderClient_OnBufferDecoded_Name = 491424564;
  var kAudioDecoderClient_OnWaiting_Name = 2022021664;
