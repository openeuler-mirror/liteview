...
// with not having this data in traces there.
    ...
    virtual void OnVideoFrameDecoded(const ::scoped_refptr<::media::VideoFrame>& frame, bool can_read_without_stalling, const ::base::UnguessableToken& release_token) = 0;
...
//
//   void OnVideoFrameDecoded(const ::scoped_refptr<::media::VideoFrame>& frame, bool can_read_without_stalling, const ::base::UnguessableToken& release_token) final;
//
...
//   video_frame_handle_releaser, ::mojo::ScopedDataPipeConsumerHandle decoder_buffer_pipe, const ::gfx::ColorSpace& target_color_space) final;
//
