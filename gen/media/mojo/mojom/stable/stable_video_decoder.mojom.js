...
(function() {
  ...
  var STABLE_VIDEO_DECODER_FACTORY_SERVICE_SANDBOX = sandbox$.Sandbox.kNoSandbox;
  ...
  StableVideoDecoderFactory_CreateStableVideoDecoder_Params.encodedSize = codec.kStructHeaderSize + 8;
  ...
  StableVideoDecoderFactoryProxy.prototype.createStableVideoDecoder = function(receiver) {
  ...
  StableVideoDecoderFactoryStub.prototype.createStableVideoDecoder = function(receiver) {
    return this.delegate_ && this.delegate_.createStableVideoDecoder && this.delegate_.createStableVideoDecoder(receiver);
  }
  ...
  StableVideoDecoderFactoryStub.prototype.accept = function(message) {
    ...
    case kStableVideoDecoderFactory_CreateStableVideoDecoder_Name:
      ...
      this.createStableVideoDecoder(params.receiver);
      return true;
    default:
      return false;
    }
