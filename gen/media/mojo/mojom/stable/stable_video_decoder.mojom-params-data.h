...
static_assert(sizeof(StableVideoDecoder_GetSupportedConfigs_ResponseParams_Data) == 24, "Bad sizeof(StableVideoDecoder_GetSupportedConfigs_ResponseParams_Data)");
...
static_assert(sizeof(StableVideoDecoderFactory_CreateStableVideoDecoder_Params_Data) == 16, "Bad sizeof(StableVideoDecoderFactory_CreateStableVideoDecoder_Params_Data)");
...
public:
    ...
    bool can_read_without_stalling() const { return data_->can_read_without_stalling; }
    inline void GetReleaseTokenDataView(::mojo_base::mojom::UnguessableTokenDataView* output);
...
public:
    ...
    ::media::stable::mojom::WaitingReason reason() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::media::stable::mojom::WaitingReason>(data_->reason)); }
...
public:
    ...
    ::media::stable::mojom::CdmContextEvent event() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::media::stable::mojom::CdmContextEvent>(data_->event)); }
...
public:
    ...
    ::media::stable::mojom::DecryptStatus status() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::media::stable::mojom::DecryptStatus>(data_->status)); }
...
public:
    ...
    {
        UserType result;
        bool ret = mojo::internal::Deserialize<mojo::InterfacePtrDataView<::media::stable::mojom::CdmContextEventCallbackInterfaceBase>>(&data_->callback, &result, message_);
        DCHECK(ret);
        return result;
    }
...
public:
    ...
    StableCdmContext_GetScreenResolutions_ResponseParamsDataView(internal::StableCdmContext_GetScreenResolutions_ResponseParams_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
...
public:
    ...
    StableVideoDecoder_GetSupportedConfigs_ResponseParamsDataView(internal::StableVideoDecoder_GetSupportedConfigs_ResponseParams_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
...
public:
    ...
    bool low_delay() const { return data_->low_delay; }
    template <typename UserType> UserType TakeCdmContext()
    {
        UserType result;
        bool ret = mojo::internal::Deserialize<mojo::InterfacePtrDataView<::media::stable::mojom::StableCdmContextInterfaceBase>>(&data_->cdm_context, &result, message_);
        DCHECK(ret);
        return result;
    }
...
public:
    ...
    bool needs_bitstream_conversion() const { return data_->needs_bitstream_conversion; }
    int32_t max_decode_requests() const { return data_->max_decode_requests; }
    template <typename UserType> [[nodiscard]] bool ReadDecoderType(UserType* output) const
    {
        auto data_value = data_->decoder_type;
        return mojo::internal::Deserialize<::media::stable::mojom::VideoDecoderType>(data_value, output);
...
public:
    ...
    StableVideoDecoderFactory_CreateStableVideoDecoder_ParamsDataView(internal::StableVideoDecoderFactory_CreateStableVideoDecoder_Params_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
    ...
    {
        UserType result;
        bool ret = mojo::internal::Deserialize<mojo::InterfaceRequestDataView<::media::stable::mojom::StableVideoDecoderInterfaceBase>>(&data_->receiver, &result, message_);
        DCHECK(ret);
        return result;
    }
