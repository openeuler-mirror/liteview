...
VideoDecoderConfig::VideoDecoderConfig(VideoCodec codec_in, VideoCodecProfile profile_in, uint32_t level_in, bool has_alpha_in, const ::gfx::Size& coded_size_in,
...
SupportedVideoDecoderConfig::SupportedVideoDecoderConfig(VideoCodecProfile profile_min_in, VideoCodecProfile profile_max_in, const ::gfx::Size& coded_size_min_in,
...
StatusData::StatusData(
    const WTF::String& group_in, StatusCode code_in, const WTF::String& message_in, WTF::Vector<::base::Value> frames_in, StatusDataPtr cause_in, ::base::Value data_in)
...
NativeGpuMemoryBufferHandle::NativeGpuMemoryBufferHandle(::gfx::GpuMemoryBufferId id_in, ::media::stable::mojom::blink::NativePixmapHandlePtr platform_handle_in)
    : id(std::move(id_in))
...
GpuMemoryBufferVideoFrameData::GpuMemoryBufferVideoFrameData(NativeGpuMemoryBufferHandlePtr gpu_memory_buffer_handle_in)
...
VideoFrame::VideoFrame(VideoPixelFormat format_in, const ::gfx::Size& coded_size_in, const ::gfx::Rect& visible_rect_in, const ::gfx::Size& natural_size_in,
    ::base::TimeDelta timestamp_in, VideoFrameDataPtr data_in, VideoFrameMetadataPtr metadata_in, ColorSpacePtr color_space_in, HDRMetadataPtr hdr_metadata_in)
...
bool StructTraits<::media::stable::mojom::blink::EosVideoFrameData::DataView, ::media::stable::mojom::blink::EosVideoFrameDataPtr>::Read(
    ::media::stable::mojom::blink::EosVideoFrameData::DataView input, ::media::stable::mojom::blink::EosVideoFrameDataPtr* output)
{
    bool success = true;
...
bool StructTraits<::media::stable::mojom::blink::GpuMemoryBufferVideoFrameData::DataView, ::media::stable::mojom::blink::GpuMemoryBufferVideoFrameDataPtr>::Read(
    ::media::stable::mojom::blink::GpuMemoryBufferVideoFrameData::DataView input, ::media::stable::mojom::blink::GpuMemoryBufferVideoFrameDataPtr* output)
{
    bool success = true;
...
bool UnionTraits<::media::stable::mojom::blink::VideoFrameData::DataView, ::media::stable::mojom::blink::VideoFrameDataPtr>::Read(
    ::media::stable::mojom::blink::VideoFrameData::DataView input, ::media::stable::mojom::blink::VideoFrameDataPtr* output)
{
