...
struct media_stable_mojom_internal_VideoCodec_DataHashFn {
    ...
    static bool Equal(const ::media::stable::mojom::VideoCodec& left, const ::media::stable::mojom::VideoCodec& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::media::stable::mojom::VideoCodec> : public GenericHashTraits<::media::stable::mojom::VideoCodec> {
    ...
    static void ConstructDeletedValue(::media::stable::mojom::VideoCodec& slot, bool) { slot = static_cast<::media::stable::mojom::VideoCodec>(-1000001); }
    static bool IsDeletedValue(const ::media::stable::mojom::VideoCodec& value) { return value == static_cast<::media::stable::mojom::VideoCodec>(-1000001); }
};
} // namespace WTF
namespace WTF {
struct media_stable_mojom_internal_VideoCodecProfile_DataHashFn {
    ...
    static bool Equal(const ::media::stable::mojom::VideoCodecProfile& left, const ::media::stable::mojom::VideoCodecProfile& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::media::stable::mojom::VideoCodecProfile> : public GenericHashTraits<::media::stable::mojom::VideoCodecProfile> {
    static_assert(true, "-1000000 is a reserved enum value");
    static_assert(true, "-1000001 is a reserved enum value");
    static const bool kEmptyValueIsZero = false;
    static ::media::stable::mojom::VideoCodecProfile EmptyValue() { return static_cast<::media::stable::mojom::VideoCodecProfile>(-1000000); }
    static void ConstructDeletedValue(::media::stable::mojom::VideoCodecProfile& slot, bool) { slot = static_cast<::media::stable::mojom::VideoCodecProfile>(-1000001); }
    static bool IsDeletedValue(const ::media::stable::mojom::VideoCodecProfile& value) { return value == static_cast<::media::stable::mojom::VideoCodecProfile>(-1000001); }
};
} // namespace WTF
namespace WTF {
struct media_stable_mojom_internal_EncryptionScheme_DataHashFn {
    ...
    static bool Equal(const ::media::stable::mojom::EncryptionScheme& left, const ::media::stable::mojom::EncryptionScheme& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::media::stable::mojom::EncryptionScheme> : public GenericHashTraits<::media::stable::mojom::EncryptionScheme> {
    static_assert(true, "-1000000 is a reserved enum value");
    static_assert(true, "-1000001 is a reserved enum value");
    static const bool kEmptyValueIsZero = false;
    static ::media::stable::mojom::EncryptionScheme EmptyValue() { return static_cast<::media::stable::mojom::EncryptionScheme>(-1000000); }
    static void ConstructDeletedValue(::media::stable::mojom::EncryptionScheme& slot, bool) { slot = static_cast<::media::stable::mojom::EncryptionScheme>(-1000001); }
    static bool IsDeletedValue(const ::media::stable::mojom::EncryptionScheme& value) { return value == static_cast<::media::stable::mojom::EncryptionScheme>(-1000001); }
};
} // namespace WTF
namespace WTF {
struct media_stable_mojom_internal_StatusCode_DataHashFn {
    ...
    static bool Equal(const ::media::stable::mojom::StatusCode& left, const ::media::stable::mojom::StatusCode& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::media::stable::mojom::StatusCode> : public GenericHashTraits<::media::stable::mojom::StatusCode> {
    static_assert(true, "-1000000 is a reserved enum value");
    static_assert(true, "-1000001 is a reserved enum value");
    static const bool kEmptyValueIsZero = false;
    static ::media::stable::mojom::StatusCode EmptyValue() { return static_cast<::media::stable::mojom::StatusCode>(-1000000); }
    static void ConstructDeletedValue(::media::stable::mojom::StatusCode& slot, bool) { slot = static_cast<::media::stable::mojom::StatusCode>(-1000001); }
    static bool IsDeletedValue(const ::media::stable::mojom::StatusCode& value) { return value == static_cast<::media::stable::mojom::StatusCode>(-1000001); }
};
} // namespace WTF
namespace WTF {
struct media_stable_mojom_internal_VideoDecoderType_DataHashFn {
    ...
    static bool Equal(const ::media::stable::mojom::VideoDecoderType& left, const ::media::stable::mojom::VideoDecoderType& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::media::stable::mojom::VideoDecoderType> : public GenericHashTraits<::media::stable::mojom::VideoDecoderType> {
    static_assert(true, "-1000000 is a reserved enum value");
    static_assert(true, "-1000001 is a reserved enum value");
    static const bool kEmptyValueIsZero = false;
    static ::media::stable::mojom::VideoDecoderType EmptyValue() { return static_cast<::media::stable::mojom::VideoDecoderType>(-1000000); }
    static void ConstructDeletedValue(::media::stable::mojom::VideoDecoderType& slot, bool) { slot = static_cast<::media::stable::mojom::VideoDecoderType>(-1000001); }
    static bool IsDeletedValue(const ::media::stable::mojom::VideoDecoderType& value) { return value == static_cast<::media::stable::mojom::VideoDecoderType>(-1000001); }
};
} // namespace WTF
namespace WTF {
struct media_stable_mojom_internal_ColorSpacePrimaryID_DataHashFn {
    ...
    static bool Equal(const ::media::stable::mojom::ColorSpacePrimaryID& left, const ::media::stable::mojom::ColorSpacePrimaryID& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::media::stable::mojom::ColorSpacePrimaryID> : public GenericHashTraits<::media::stable::mojom::ColorSpacePrimaryID> {
    static_assert(true, "-1000000 is a reserved enum value");
    static_assert(true, "-1000001 is a reserved enum value");
    static const bool kEmptyValueIsZero = false;
    ...
    static void ConstructDeletedValue(::media::stable::mojom::ColorSpacePrimaryID& slot, bool) { slot = static_cast<::media::stable::mojom::ColorSpacePrimaryID>(-1000001); }
    static bool IsDeletedValue(const ::media::stable::mojom::ColorSpacePrimaryID& value) { return value == static_cast<::media::stable::mojom::ColorSpacePrimaryID>(-1000001); }
};
} // namespace WTF
namespace WTF {
struct media_stable_mojom_internal_ColorSpaceTransferID_DataHashFn {
    ...
    static bool Equal(const ::media::stable::mojom::ColorSpaceTransferID& left, const ::media::stable::mojom::ColorSpaceTransferID& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::media::stable::mojom::ColorSpaceTransferID> : public GenericHashTraits<::media::stable::mojom::ColorSpaceTransferID> {
    static_assert(true, "-1000000 is a reserved enum value");
    static_assert(true, "-1000001 is a reserved enum value");
    static const bool kEmptyValueIsZero = false;
    ...
    static void ConstructDeletedValue(::media::stable::mojom::ColorSpaceTransferID& slot, bool) { slot = static_cast<::media::stable::mojom::ColorSpaceTransferID>(-1000001); }
    static bool IsDeletedValue(const ::media::stable::mojom::ColorSpaceTransferID& value) { return value == static_cast<::media::stable::mojom::ColorSpaceTransferID>(-1000001); }
};
} // namespace WTF
namespace WTF {
struct media_stable_mojom_internal_ColorSpaceMatrixID_DataHashFn {
    ...
    static bool Equal(const ::media::stable::mojom::ColorSpaceMatrixID& left, const ::media::stable::mojom::ColorSpaceMatrixID& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::media::stable::mojom::ColorSpaceMatrixID> : public GenericHashTraits<::media::stable::mojom::ColorSpaceMatrixID> {
    static_assert(true, "-1000000 is a reserved enum value");
    static_assert(true, "-1000001 is a reserved enum value");
    static const bool kEmptyValueIsZero = false;
    static ::media::stable::mojom::ColorSpaceMatrixID EmptyValue() { return static_cast<::media::stable::mojom::ColorSpaceMatrixID>(-1000000); }
    static void ConstructDeletedValue(::media::stable::mojom::ColorSpaceMatrixID& slot, bool) { slot = static_cast<::media::stable::mojom::ColorSpaceMatrixID>(-1000001); }
    static bool IsDeletedValue(const ::media::stable::mojom::ColorSpaceMatrixID& value) { return value == static_cast<::media::stable::mojom::ColorSpaceMatrixID>(-1000001); }
};
} // namespace WTF
namespace WTF {
struct media_stable_mojom_internal_ColorSpaceRangeID_DataHashFn {
    ...
    static bool Equal(const ::media::stable::mojom::ColorSpaceRangeID& left, const ::media::stable::mojom::ColorSpaceRangeID& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::media::stable::mojom::ColorSpaceRangeID> : public GenericHashTraits<::media::stable::mojom::ColorSpaceRangeID> {
    static_assert(true, "-1000000 is a reserved enum value");
    static_assert(true, "-1000001 is a reserved enum value");
    static const bool kEmptyValueIsZero = false;
    static ::media::stable::mojom::ColorSpaceRangeID EmptyValue() { return static_cast<::media::stable::mojom::ColorSpaceRangeID>(-1000000); }
    static void ConstructDeletedValue(::media::stable::mojom::ColorSpaceRangeID& slot, bool) { slot = static_cast<::media::stable::mojom::ColorSpaceRangeID>(-1000001); }
    static bool IsDeletedValue(const ::media::stable::mojom::ColorSpaceRangeID& value) { return value == static_cast<::media::stable::mojom::ColorSpaceRangeID>(-1000001); }
};
} // namespace WTF
namespace WTF {
struct media_stable_mojom_internal_VideoPixelFormat_DataHashFn {
    ...
    static bool Equal(const ::media::stable::mojom::VideoPixelFormat& left, const ::media::stable::mojom::VideoPixelFormat& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::media::stable::mojom::VideoPixelFormat> : public GenericHashTraits<::media::stable::mojom::VideoPixelFormat> {
    static_assert(true, "-1000000 is a reserved enum value");
    static_assert(true, "-1000001 is a reserved enum value");
    static const bool kEmptyValueIsZero = false;
    static ::media::stable::mojom::VideoPixelFormat EmptyValue() { return static_cast<::media::stable::mojom::VideoPixelFormat>(-1000000); }
    static void ConstructDeletedValue(::media::stable::mojom::VideoPixelFormat& slot, bool) { slot = static_cast<::media::stable::mojom::VideoPixelFormat>(-1000001); }
    static bool IsDeletedValue(const ::media::stable::mojom::VideoPixelFormat& value) { return value == static_cast<::media::stable::mojom::VideoPixelFormat>(-1000001); }
};
} // namespace WTF
namespace WTF {
struct media_stable_mojom_internal_WaitingReason_DataHashFn {
    ...
    static bool Equal(const ::media::stable::mojom::WaitingReason& left, const ::media::stable::mojom::WaitingReason& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::media::stable::mojom::WaitingReason> : public GenericHashTraits<::media::stable::mojom::WaitingReason> {
    static_assert(true, "-1000000 is a reserved enum value");
    static_assert(true, "-1000001 is a reserved enum value");
    static const bool kEmptyValueIsZero = false;
    static ::media::stable::mojom::WaitingReason EmptyValue() { return static_cast<::media::stable::mojom::WaitingReason>(-1000000); }
    static void ConstructDeletedValue(::media::stable::mojom::WaitingReason& slot, bool) { slot = static_cast<::media::stable::mojom::WaitingReason>(-1000001); }
    static bool IsDeletedValue(const ::media::stable::mojom::WaitingReason& value) { return value == static_cast<::media::stable::mojom::WaitingReason>(-1000001); }
};
} // namespace WTF
namespace WTF {
struct media_stable_mojom_internal_DecryptStatus_DataHashFn {
    ...
    static bool Equal(const ::media::stable::mojom::DecryptStatus& left, const ::media::stable::mojom::DecryptStatus& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::media::stable::mojom::DecryptStatus> : public GenericHashTraits<::media::stable::mojom::DecryptStatus> {
    static_assert(true, "-1000000 is a reserved enum value");
    static_assert(true, "-1000001 is a reserved enum value");
    static const bool kEmptyValueIsZero = false;
    static ::media::stable::mojom::DecryptStatus EmptyValue() { return static_cast<::media::stable::mojom::DecryptStatus>(-1000000); }
    static void ConstructDeletedValue(::media::stable::mojom::DecryptStatus& slot, bool) { slot = static_cast<::media::stable::mojom::DecryptStatus>(-1000001); }
    static bool IsDeletedValue(const ::media::stable::mojom::DecryptStatus& value) { return value == static_cast<::media::stable::mojom::DecryptStatus>(-1000001); }
};
} // namespace WTF
namespace WTF {
struct media_stable_mojom_internal_CdmContextEvent_DataHashFn {
    ...
    static bool Equal(const ::media::stable::mojom::CdmContextEvent& left, const ::media::stable::mojom::CdmContextEvent& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::media::stable::mojom::CdmContextEvent> : public GenericHashTraits<::media::stable::mojom::CdmContextEvent> {
    static_assert(true, "-1000000 is a reserved enum value");
    static_assert(true, "-1000001 is a reserved enum value");
    static const bool kEmptyValueIsZero = false;
    static ::media::stable::mojom::CdmContextEvent EmptyValue() { return static_cast<::media::stable::mojom::CdmContextEvent>(-1000000); }
    static void ConstructDeletedValue(::media::stable::mojom::CdmContextEvent& slot, bool) { slot = static_cast<::media::stable::mojom::CdmContextEvent>(-1000001); }
    static bool IsDeletedValue(const ::media::stable::mojom::CdmContextEvent& value) { return value == static_cast<::media::stable::mojom::CdmContextEvent>(-1000001); }
};
} // namespace WTF
namespace WTF {
struct media_stable_mojom_internal_MediaLogRecord_Type_DataHashFn {
    ...
    static bool Equal(const ::media::stable::mojom::MediaLogRecord_Type& left, const ::media::stable::mojom::MediaLogRecord_Type& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::media::stable::mojom::MediaLogRecord_Type> : public GenericHashTraits<::media::stable::mojom::MediaLogRecord_Type> {
    static_assert(true, "-1000000 is a reserved enum value");
    static_assert(true, "-1000001 is a reserved enum value");
    static const bool kEmptyValueIsZero = false;
    ...
    static void ConstructDeletedValue(::media::stable::mojom::MediaLogRecord_Type& slot, bool) { slot = static_cast<::media::stable::mojom::MediaLogRecord_Type>(-1000001); }
    static bool IsDeletedValue(const ::media::stable::mojom::MediaLogRecord_Type& value) { return value == static_cast<::media::stable::mojom::MediaLogRecord_Type>(-1000001); }
};
} // namespace WTF
namespace media {
namespace stable {
...
public:
    ...
    template <typename... Args> static SubsampleEntryPtr New(Args&&... args) { return SubsampleEntryPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static SubsampleEntryPtr From(const U& u) { return mojo::TypeConverter<SubsampleEntryPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, SubsampleEntry>::Convert(*this); }
    SubsampleEntry()
        : clear_bytes()
        , cypher_bytes()
    {
    ...
    template <typename T, SubsampleEntry::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    ...
    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<SubsampleEntry::DataView>(input); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::SubsampleEntry_UnserializedMessageContext<UserType, SubsampleEntry::DataView>>(0, 0, std::move(input)), MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    {
        return SubsampleEntry::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, SubsampleEntry::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, SubsampleEntry::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, SubsampleEntry::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    VideoDecoderConfig(VideoCodec codec_in, VideoCodecProfile profile_in, uint32_t level_in, bool has_alpha_in, const ::gfx::Size& coded_size_in,
        const ::gfx::Rect& visible_rect_in, const ::gfx::Size& natural_size_in, WTF::Vector<uint8_t> extra_data_in, EncryptionScheme encryption_scheme_in,
        ColorSpacePtr color_space_info_in, HDRMetadataPtr hdr_metadata_in)
...
public:
    ...
    template <typename... Args> static SupportedVideoDecoderConfigPtr New(Args&&... args) { return SupportedVideoDecoderConfigPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static SupportedVideoDecoderConfigPtr From(const U& u) { return mojo::TypeConverter<SupportedVideoDecoderConfigPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, SupportedVideoDecoderConfig>::Convert(*this); }
    ...
    SupportedVideoDecoderConfig(VideoCodecProfile profile_min_in, VideoCodecProfile profile_max_in, const ::gfx::Size& coded_size_min_in, const ::gfx::Size& coded_size_max_in,
    ...
    template <typename T, SupportedVideoDecoderConfig::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static WTF::Vector<uint8_t> Serialize(UserType* input)
    {
    ...
    {
        return mojo::Message(
            std::make_unique<internal::SupportedVideoDecoderConfig_UnserializedMessageContext<UserType, SupportedVideoDecoderConfig::DataView>>(0, 0, std::move(input)),
            MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const WTF::Vector<uint8_t>& input, UserType* output)
    {
        return SupportedVideoDecoderConfig::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }

    template <typename UserType> static bool DeserializeFromMessage(mojo::Message input, UserType* output)
    {
        auto context = input.TakeUnserializedContext<internal::SupportedVideoDecoderConfig_UnserializedMessageContext<UserType, SupportedVideoDecoderConfig::DataView>>();
        if (context) {
            *output = std::move(context->TakeData());
            return true;
        }
...
template <typename T, SupportedVideoDecoderConfig::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, SupportedVideoDecoderConfig::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, SupportedVideoDecoderConfig::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    StatusData(const WTF::String& group_in, StatusCode code_in, const WTF::String& message_in, WTF::Vector<::base::Value> frames_in, StatusDataPtr cause_in, ::base::Value data_in)
...
public:
    ...
    template <typename... Args> static StatusPtr New(Args&&... args) { return StatusPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static StatusPtr From(const U& u) { return mojo::TypeConverter<StatusPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, Status>::Convert(*this); }
    Status()
        : internal()
    {
    }
    ...
    template <typename T, Status::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static WTF::Vector<uint8_t> Serialize(UserType* input) { return mojo::internal::SerializeImpl<Status::DataView, WTF::Vector<uint8_t>>(input); }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<Status::DataView>(input); }
    ...
    template <typename UserType> static mojo::Message WrapAsMessage(UserType input)
    {
        return mojo::Message(std::make_unique<internal::Status_UnserializedMessageContext<UserType, Status::DataView>>(0, 0, std::move(input)), MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const WTF::Vector<uint8_t>& input, UserType* output)
    {
        return Status::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, Status::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, Status::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, Status::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static ColorSpacePtr New(Args&&... args) { return ColorSpacePtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static ColorSpacePtr From(const U& u) { return mojo::TypeConverter<ColorSpacePtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, ColorSpace>::Convert(*this); }
    ColorSpace()
        : primaries()
        , transfer()
        , matrix()
    ...
    template <typename T, ColorSpace::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static WTF::Vector<uint8_t> Serialize(UserType* input) { return mojo::internal::SerializeImpl<ColorSpace::DataView, WTF::Vector<uint8_t>>(input); }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<ColorSpace::DataView>(input); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::ColorSpace_UnserializedMessageContext<UserType, ColorSpace::DataView>>(0, 0, std::move(input)), MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const WTF::Vector<uint8_t>& input, UserType* output)
    {
        return ColorSpace::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, ColorSpace::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, ColorSpace::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, ColorSpace::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static NativeGpuMemoryBufferHandlePtr New(Args&&... args) { return NativeGpuMemoryBufferHandlePtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static NativeGpuMemoryBufferHandlePtr From(const U& u) { return mojo::TypeConverter<NativeGpuMemoryBufferHandlePtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, NativeGpuMemoryBufferHandle>::Convert(*this); }
    ...
    NativeGpuMemoryBufferHandle(::gfx::GpuMemoryBufferId id_in, ::media::stable::mojom::blink::NativePixmapHandlePtr platform_handle_in)
        : id(std::move(id_in))
    ...
    template <typename T, NativeGpuMemoryBufferHandle::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::NativeGpuMemoryBufferHandle_UnserializedMessageContext<UserType, NativeGpuMemoryBufferHandle::DataView>>(0, 0, std::move(input)),
            MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const WTF::Vector<uint8_t>& input, UserType* output)
    {
        return NativeGpuMemoryBufferHandle::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }

    template <typename UserType> static bool DeserializeFromMessage(mojo::Message input, UserType* output)
    {
        auto context = input.TakeUnserializedContext<internal::NativeGpuMemoryBufferHandle_UnserializedMessageContext<UserType, NativeGpuMemoryBufferHandle::DataView>>();
        if (context) {
            *output = std::move(context->TakeData());
            return true;
        }
...
template <typename T, NativeGpuMemoryBufferHandle::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, NativeGpuMemoryBufferHandle::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, NativeGpuMemoryBufferHandle::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    explicit GpuMemoryBufferVideoFrameData(NativeGpuMemoryBufferHandlePtr gpu_memory_buffer_handle_in)
...
public:
    ...
    VideoFrameMetadata(bool allow_overlay_in, bool end_of_stream_in, bool read_lock_fences_enabled_in, bool protected_video_in, bool hw_protected_in, bool power_efficient_in)
...
public:
    ...
    VideoFrame(VideoPixelFormat format_in, const ::gfx::Size& coded_size_in, const ::gfx::Rect& visible_rect_in, const ::gfx::Size& natural_size_in, ::base::TimeDelta timestamp_in,
        VideoFrameDataPtr data_in, VideoFrameMetadataPtr metadata_in, ColorSpacePtr color_space_in, HDRMetadataPtr hdr_metadata_in)
...
public:
    ...
    template <typename... Args> static MediaLogRecordPtr New(Args&&... args) { return MediaLogRecordPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static MediaLogRecordPtr From(const U& u) { return mojo::TypeConverter<MediaLogRecordPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, MediaLogRecord>::Convert(*this); }
    MediaLogRecord()
        : id()
        , type()
        , params()
    ...
    template <typename T, MediaLogRecord::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static WTF::Vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<MediaLogRecord::DataView, WTF::Vector<uint8_t>>(input);
    }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<MediaLogRecord::DataView>(input); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::MediaLogRecord_UnserializedMessageContext<UserType, MediaLogRecord::DataView>>(0, 0, std::move(input)), MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const WTF::Vector<uint8_t>& input, UserType* output)
    {
        return MediaLogRecord::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, MediaLogRecord::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, MediaLogRecord::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, MediaLogRecord::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
template <typename StructPtrType> SubsampleEntryPtr SubsampleEntry::Clone() const { return New(mojo::Clone(clear_bytes), mojo::Clone(cypher_bytes)); }
...
{
    return New(mojo::Clone(codec), mojo::Clone(profile), mojo::Clone(level), mojo::Clone(has_alpha), mojo::Clone(coded_size), mojo::Clone(visible_rect), mojo::Clone(natural_size),
        mojo::Clone(extra_data), mojo::Clone(encryption_scheme), mojo::Clone(color_space_info), mojo::Clone(hdr_metadata));
}
...
{
    return New(
        mojo::Clone(profile_min), mojo::Clone(profile_max), mojo::Clone(coded_size_min), mojo::Clone(coded_size_max), mojo::Clone(allow_encrypted), mojo::Clone(require_encrypted));
}
...
template <typename StructPtrType> StatusPtr Status::Clone() const { return New(mojo::Clone(internal)); }
...
{
    return New(mojo::Clone(primaries), mojo::Clone(transfer), mojo::Clone(matrix), mojo::Clone(range), mojo::Clone(custom_primary_matrix), mojo::Clone(transfer_params));
}
...
template <typename StructPtrType> NativeGpuMemoryBufferHandlePtr NativeGpuMemoryBufferHandle::Clone() const { return New(mojo::Clone(id), mojo::Clone(platform_handle)); }
...
template <typename StructPtrType> GpuMemoryBufferVideoFrameDataPtr GpuMemoryBufferVideoFrameData::Clone() const { return New(mojo::Clone(gpu_memory_buffer_handle)); }
...
{
    return New(mojo::Clone(allow_overlay), mojo::Clone(end_of_stream), mojo::Clone(read_lock_fences_enabled), mojo::Clone(protected_video), mojo::Clone(hw_protected),
...
template <typename StructPtrType> MediaLogRecordPtr MediaLogRecord::Clone() const { return New(mojo::Clone(id), mojo::Clone(type), mojo::Clone(params), mojo::Clone(time)); }
...
template <> struct StructTraits<::media::stable::mojom::blink::DecryptConfig::DataView, ::media::stable::mojom::blink::DecryptConfigPtr> {
    ...
    static decltype(::media::stable::mojom::blink::DecryptConfig::encryption_scheme) encryption_scheme(const ::media::stable::mojom::blink::DecryptConfigPtr& input)
    {
        return input->encryption_scheme;
    }

    static const decltype(::media::stable::mojom::blink::DecryptConfig::key_id)& key_id(const ::media::stable::mojom::blink::DecryptConfigPtr& input) { return input->key_id; }

    static const decltype(::media::stable::mojom::blink::DecryptConfig::iv)& iv(const ::media::stable::mojom::blink::DecryptConfigPtr& input) { return input->iv; }
    ...
    static const decltype(::media::stable::mojom::blink::DecryptConfig::encryption_pattern)& encryption_pattern(const ::media::stable::mojom::blink::DecryptConfigPtr& input)
    {
...
template <> struct StructTraits<::media::stable::mojom::blink::ColorVolumeMetadata::DataView, ::media::stable::mojom::blink::ColorVolumeMetadataPtr> {
    ...
    static const decltype(::media::stable::mojom::blink::ColorVolumeMetadata::primary_r)& primary_r(const ::media::stable::mojom::blink::ColorVolumeMetadataPtr& input)
    {
        return input->primary_r;
    }

    static const decltype(::media::stable::mojom::blink::ColorVolumeMetadata::primary_g)& primary_g(const ::media::stable::mojom::blink::ColorVolumeMetadataPtr& input)
    {
        return input->primary_g;
    }

    static const decltype(::media::stable::mojom::blink::ColorVolumeMetadata::primary_b)& primary_b(const ::media::stable::mojom::blink::ColorVolumeMetadataPtr& input)
    {
        return input->primary_b;
    }

    static const decltype(::media::stable::mojom::blink::ColorVolumeMetadata::white_point)& white_point(const ::media::stable::mojom::blink::ColorVolumeMetadataPtr& input)
    {
        return input->white_point;
    }

    static decltype(::media::stable::mojom::blink::ColorVolumeMetadata::luminance_max) luminance_max(const ::media::stable::mojom::blink::ColorVolumeMetadataPtr& input)
    {
        return input->luminance_max;
    }

    static decltype(::media::stable::mojom::blink::ColorVolumeMetadata::luminance_min) luminance_min(const ::media::stable::mojom::blink::ColorVolumeMetadataPtr& input)
    {
...
template <> struct StructTraits<::media::stable::mojom::blink::HDRMetadata::DataView, ::media::stable::mojom::blink::HDRMetadataPtr> {
    ...
    static const decltype(::media::stable::mojom::blink::HDRMetadata::color_volume_metadata)& color_volume_metadata(const ::media::stable::mojom::blink::HDRMetadataPtr& input)
    {
        return input->color_volume_metadata;
    }

    static decltype(::media::stable::mojom::blink::HDRMetadata::max_content_light_level) max_content_light_level(const ::media::stable::mojom::blink::HDRMetadataPtr& input)
    {
...
template <> struct StructTraits<::media::stable::mojom::blink::VideoDecoderConfig::DataView, ::media::stable::mojom::blink::VideoDecoderConfigPtr> {
    ...
    static decltype(::media::stable::mojom::blink::VideoDecoderConfig::codec) codec(const ::media::stable::mojom::blink::VideoDecoderConfigPtr& input) { return input->codec; }
    ...
    static decltype(::media::stable::mojom::blink::VideoDecoderConfig::level) level(const ::media::stable::mojom::blink::VideoDecoderConfigPtr& input) { return input->level; }
    ...
    static const decltype(::media::stable::mojom::blink::VideoDecoderConfig::coded_size)& coded_size(const ::media::stable::mojom::blink::VideoDecoderConfigPtr& input)
    {
        return input->coded_size;
    }

    static const decltype(::media::stable::mojom::blink::VideoDecoderConfig::visible_rect)& visible_rect(const ::media::stable::mojom::blink::VideoDecoderConfigPtr& input)
    {
        return input->visible_rect;
    }

    static const decltype(::media::stable::mojom::blink::VideoDecoderConfig::natural_size)& natural_size(const ::media::stable::mojom::blink::VideoDecoderConfigPtr& input)
    {
        return input->natural_size;
    }

    static const decltype(::media::stable::mojom::blink::VideoDecoderConfig::extra_data)& extra_data(const ::media::stable::mojom::blink::VideoDecoderConfigPtr& input)
    {
        return input->extra_data;
    }

    static decltype(::media::stable::mojom::blink::VideoDecoderConfig::encryption_scheme) encryption_scheme(const ::media::stable::mojom::blink::VideoDecoderConfigPtr& input)
    {
        return input->encryption_scheme;
    }

    static const decltype(::media::stable::mojom::blink::VideoDecoderConfig::color_space_info)& color_space_info(const ::media::stable::mojom::blink::VideoDecoderConfigPtr& input)
    {
        return input->color_space_info;
    }

    static const decltype(::media::stable::mojom::blink::VideoDecoderConfig::hdr_metadata)& hdr_metadata(const ::media::stable::mojom::blink::VideoDecoderConfigPtr& input)
    {
...
template <> struct StructTraits<::media::stable::mojom::blink::SupportedVideoDecoderConfig::DataView, ::media::stable::mojom::blink::SupportedVideoDecoderConfigPtr> {
    ...
    static decltype(::media::stable::mojom::blink::SupportedVideoDecoderConfig::profile_min) profile_min(const ::media::stable::mojom::blink::SupportedVideoDecoderConfigPtr& input)
    {
        return input->profile_min;
    }

    static decltype(::media::stable::mojom::blink::SupportedVideoDecoderConfig::profile_max) profile_max(const ::media::stable::mojom::blink::SupportedVideoDecoderConfigPtr& input)
    {
...
template <> struct StructTraits<::media::stable::mojom::blink::StatusData::DataView, ::media::stable::mojom::blink::StatusDataPtr> {
    ...
    static const decltype(::media::stable::mojom::blink::StatusData::group)& group(const ::media::stable::mojom::blink::StatusDataPtr& input) { return input->group; }

    static decltype(::media::stable::mojom::blink::StatusData::code) code(const ::media::stable::mojom::blink::StatusDataPtr& input) { return input->code; }

    static const decltype(::media::stable::mojom::blink::StatusData::message)& message(const ::media::stable::mojom::blink::StatusDataPtr& input) { return input->message; }

    static const decltype(::media::stable::mojom::blink::StatusData::frames)& frames(const ::media::stable::mojom::blink::StatusDataPtr& input) { return input->frames; }

    static const decltype(::media::stable::mojom::blink::StatusData::cause)& cause(const ::media::stable::mojom::blink::StatusDataPtr& input) { return input->cause; }

    static const decltype(::media::stable::mojom::blink::StatusData::data)& data(const ::media::stable::mojom::blink::StatusDataPtr& input) { return input->data; }
...
template <> struct StructTraits<::media::stable::mojom::blink::Status::DataView, ::media::stable::mojom::blink::StatusPtr> {
    ...
    static const decltype(::media::stable::mojom::blink::Status::internal)& internal(const ::media::stable::mojom::blink::StatusPtr& input) { return input->internal; }
...
template <> struct StructTraits<::media::stable::mojom::blink::DecoderBuffer::DataView, ::media::stable::mojom::blink::DecoderBufferPtr> {
    ...
    static decltype(::media::stable::mojom::blink::DecoderBuffer::is_end_of_stream) is_end_of_stream(const ::media::stable::mojom::blink::DecoderBufferPtr& input)
    {
        return input->is_end_of_stream;
    }

    static decltype(::media::stable::mojom::blink::DecoderBuffer::data_size) data_size(const ::media::stable::mojom::blink::DecoderBufferPtr& input) { return input->data_size; }
    ...
    static const decltype(::media::stable::mojom::blink::DecoderBuffer::decrypt_config)& decrypt_config(const ::media::stable::mojom::blink::DecoderBufferPtr& input)
    {
        return input->decrypt_config;
    }

    static const decltype(::media::stable::mojom::blink::DecoderBuffer::front_discard)& front_discard(const ::media::stable::mojom::blink::DecoderBufferPtr& input)
    {
        return input->front_discard;
    }

    static const decltype(::media::stable::mojom::blink::DecoderBuffer::back_discard)& back_discard(const ::media::stable::mojom::blink::DecoderBufferPtr& input)
    {
...
template <> struct StructTraits<::media::stable::mojom::blink::ColorSpace::DataView, ::media::stable::mojom::blink::ColorSpacePtr> {
    ...
    static decltype(::media::stable::mojom::blink::ColorSpace::primaries) primaries(const ::media::stable::mojom::blink::ColorSpacePtr& input) { return input->primaries; }

    static decltype(::media::stable::mojom::blink::ColorSpace::transfer) transfer(const ::media::stable::mojom::blink::ColorSpacePtr& input) { return input->transfer; }

    static decltype(::media::stable::mojom::blink::ColorSpace::matrix) matrix(const ::media::stable::mojom::blink::ColorSpacePtr& input) { return input->matrix; }

    static decltype(::media::stable::mojom::blink::ColorSpace::range) range(const ::media::stable::mojom::blink::ColorSpacePtr& input) { return input->range; }

    static const decltype(::media::stable::mojom::blink::ColorSpace::custom_primary_matrix)& custom_primary_matrix(const ::media::stable::mojom::blink::ColorSpacePtr& input)
    {
        return input->custom_primary_matrix;
    }

    static const decltype(::media::stable::mojom::blink::ColorSpace::transfer_params)& transfer_params(const ::media::stable::mojom::blink::ColorSpacePtr& input)
    {
...
template <> struct StructTraits<::media::stable::mojom::blink::EosVideoFrameData::DataView, ::media::stable::mojom::blink::EosVideoFrameDataPtr> {
...
template <> struct StructTraits<::media::stable::mojom::blink::NativeGpuMemoryBufferHandle::DataView, ::media::stable::mojom::blink::NativeGpuMemoryBufferHandlePtr> {
    ...
    static const decltype(::media::stable::mojom::blink::NativeGpuMemoryBufferHandle::id)& id(const ::media::stable::mojom::blink::NativeGpuMemoryBufferHandlePtr& input)
    {
        return input->id;
    }
...
template <> struct StructTraits<::media::stable::mojom::blink::GpuMemoryBufferVideoFrameData::DataView, ::media::stable::mojom::blink::GpuMemoryBufferVideoFrameDataPtr> {
...
template <> struct StructTraits<::media::stable::mojom::blink::VideoFrameMetadata::DataView, ::media::stable::mojom::blink::VideoFrameMetadataPtr> {
    ...
    static decltype(::media::stable::mojom::blink::VideoFrameMetadata::allow_overlay) allow_overlay(const ::media::stable::mojom::blink::VideoFrameMetadataPtr& input)
    {
        return input->allow_overlay;
    }

    static decltype(::media::stable::mojom::blink::VideoFrameMetadata::end_of_stream) end_of_stream(const ::media::stable::mojom::blink::VideoFrameMetadataPtr& input)
    {
    ...
    static decltype(::media::stable::mojom::blink::VideoFrameMetadata::protected_video) protected_video(const ::media::stable::mojom::blink::VideoFrameMetadataPtr& input)
    {
        return input->protected_video;
    }

    static decltype(::media::stable::mojom::blink::VideoFrameMetadata::hw_protected) hw_protected(const ::media::stable::mojom::blink::VideoFrameMetadataPtr& input)
    {
        return input->hw_protected;
    }

    static decltype(::media::stable::mojom::blink::VideoFrameMetadata::power_efficient) power_efficient(const ::media::stable::mojom::blink::VideoFrameMetadataPtr& input)
    {
...
template <> struct StructTraits<::media::stable::mojom::blink::VideoFrame::DataView, ::media::stable::mojom::blink::VideoFramePtr> {
    ...
    static decltype(::media::stable::mojom::blink::VideoFrame::format) format(const ::media::stable::mojom::blink::VideoFramePtr& input) { return input->format; }
    ...
    static const decltype(::media::stable::mojom::blink::VideoFrame::timestamp)& timestamp(const ::media::stable::mojom::blink::VideoFramePtr& input) { return input->timestamp; }

    static decltype(::media::stable::mojom::blink::VideoFrame::data)& data(::media::stable::mojom::blink::VideoFramePtr& input) { return input->data; }

    static const decltype(::media::stable::mojom::blink::VideoFrame::metadata)& metadata(const ::media::stable::mojom::blink::VideoFramePtr& input) { return input->metadata; }
...
template <> struct StructTraits<::media::stable::mojom::blink::MediaLogRecord::DataView, ::media::stable::mojom::blink::MediaLogRecordPtr> {
    ...
    static decltype(::media::stable::mojom::blink::MediaLogRecord::id) id(const ::media::stable::mojom::blink::MediaLogRecordPtr& input) { return input->id; }

    static decltype(::media::stable::mojom::blink::MediaLogRecord::type) type(const ::media::stable::mojom::blink::MediaLogRecordPtr& input) { return input->type; }

    static const decltype(::media::stable::mojom::blink::MediaLogRecord::params)& params(const ::media::stable::mojom::blink::MediaLogRecordPtr& input) { return input->params; }

    static const decltype(::media::stable::mojom::blink::MediaLogRecord::time)& time(const ::media::stable::mojom::blink::MediaLogRecordPtr& input) { return input->time; }
...
template <> struct UnionTraits<::media::stable::mojom::blink::VideoFrameData::DataView, ::media::stable::mojom::blink::VideoFrameDataPtr> {
    ...
    static ::media::stable::mojom::blink::VideoFrameData::Tag GetTag(const ::media::stable::mojom::blink::VideoFrameDataPtr& input) { return input->which(); }

    static const ::media::stable::mojom::blink::EosVideoFrameDataPtr& eos_data(const ::media::stable::mojom::blink::VideoFrameDataPtr& input) { return input->get_eos_data(); }
