...
(function() {
  ...
  GpuMemoryBufferVideoFrameData.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 0, NativeGpuMemoryBufferHandle, false);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  GpuMemoryBufferVideoFrameData.encodedSize = codec.kStructHeaderSize + 8;
  ...
  VideoFrameMetadata.decode = function(decoder) {
    ...
    val.endOfStream = (packed >> 1) & 1 ? true : false;
    val.readLockFencesEnabled = (packed >> 2) & 1 ? true : false;
    val.protectedVideo = (packed >> 3) & 1 ? true : false;
    val.hwProtected = (packed >> 4) & 1 ? true : false;
  ...
  VideoFrameMetadata.encode = function(encoder, val) {
    ...
    packed |= (val.endOfStream & 1) << 1
    packed |= (val.readLockFencesEnabled & 1) << 2
    packed |= (val.protectedVideo & 1) << 3
    packed |= (val.hwProtected & 1) << 4
  ...
  VideoFrame.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 64, ColorSpace, false);
    if (err !== validator.validationError.NONE)
        return err;
