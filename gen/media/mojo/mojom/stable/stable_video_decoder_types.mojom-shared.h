...
template <> struct MojomTypeTraits<::media::stable::mojom::EosVideoFrameDataDataView> {
...
template <> struct MojomTypeTraits<::media::stable::mojom::GpuMemoryBufferVideoFrameDataDataView> {
...
template <> struct MojomTypeTraits<::media::stable::mojom::VideoFrameDataDataView> {
...
inline bool IsKnownEnumValue(VideoCodec value) { return internal::VideoCodec_Data::IsKnownValue(static_cast<int32_t>(value)); }
...
inline bool IsKnownEnumValue(VideoCodecProfile value) { return internal::VideoCodecProfile_Data::IsKnownValue(static_cast<int32_t>(value)); }
...
inline bool IsKnownEnumValue(EncryptionScheme value) { return internal::EncryptionScheme_Data::IsKnownValue(static_cast<int32_t>(value)); }
...
inline bool IsKnownEnumValue(StatusCode value) { return internal::StatusCode_Data::IsKnownValue(static_cast<int32_t>(value)); }
...
inline bool IsKnownEnumValue(VideoDecoderType value) { return internal::VideoDecoderType_Data::IsKnownValue(static_cast<int32_t>(value)); }
...
inline bool IsKnownEnumValue(ColorSpacePrimaryID value) { return internal::ColorSpacePrimaryID_Data::IsKnownValue(static_cast<int32_t>(value)); }
...
inline bool IsKnownEnumValue(ColorSpaceTransferID value) { return internal::ColorSpaceTransferID_Data::IsKnownValue(static_cast<int32_t>(value)); }
...
inline bool IsKnownEnumValue(ColorSpaceMatrixID value) { return internal::ColorSpaceMatrixID_Data::IsKnownValue(static_cast<int32_t>(value)); }
...
inline bool IsKnownEnumValue(ColorSpaceRangeID value) { return internal::ColorSpaceRangeID_Data::IsKnownValue(static_cast<int32_t>(value)); }
...
inline bool IsKnownEnumValue(VideoPixelFormat value) { return internal::VideoPixelFormat_Data::IsKnownValue(static_cast<int32_t>(value)); }
...
inline bool IsKnownEnumValue(WaitingReason value) { return internal::WaitingReason_Data::IsKnownValue(static_cast<int32_t>(value)); }
...
inline bool IsKnownEnumValue(DecryptStatus value) { return internal::DecryptStatus_Data::IsKnownValue(static_cast<int32_t>(value)); }
...
inline bool IsKnownEnumValue(CdmContextEvent value) { return internal::CdmContextEvent_Data::IsKnownValue(static_cast<int32_t>(value)); }
...
inline bool IsKnownEnumValue(MediaLogRecord_Type value) { return internal::MediaLogRecord_Type_Data::IsKnownValue(static_cast<int32_t>(value)); }
...
public:
    ...
    uint32_t clear_bytes() const { return data_->clear_bytes; }
    uint32_t cypher_bytes() const { return data_->cypher_bytes; }
...
public:
    ...
    EncryptionScheme encryption_scheme() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::media::stable::mojom::EncryptionScheme>(data_->encryption_scheme)); }
...
public:
    ...
    VideoCodec codec() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::media::stable::mojom::VideoCodec>(data_->codec)); }
    ...
    VideoCodecProfile profile() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::media::stable::mojom::VideoCodecProfile>(data_->profile)); }
...
public:
    ...
    VideoCodecProfile profile_min() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::media::stable::mojom::VideoCodecProfile>(data_->profile_min)); }
    template <typename UserType> [[nodiscard]] bool ReadProfileMax(UserType* output) const
    {
        auto data_value = data_->profile_max;
        return mojo::internal::Deserialize<::media::stable::mojom::VideoCodecProfile>(data_value, output);
    }
    VideoCodecProfile profile_max() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::media::stable::mojom::VideoCodecProfile>(data_->profile_max)); }
    ...
    bool allow_encrypted() const { return data_->allow_encrypted; }
    bool require_encrypted() const { return data_->require_encrypted; }
...
public:
    ...
    StatusCode code() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::media::stable::mojom::StatusCode>(data_->code)); }
...
public:
    ...
    ColorSpacePrimaryID primaries() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::media::stable::mojom::ColorSpacePrimaryID>(data_->primaries)); }
    ...
    ColorSpaceTransferID transfer() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::media::stable::mojom::ColorSpaceTransferID>(data_->transfer)); }
    ...
    ColorSpaceMatrixID matrix() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::media::stable::mojom::ColorSpaceMatrixID>(data_->matrix)); }
    ...
    ColorSpaceRangeID range() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::media::stable::mojom::ColorSpaceRangeID>(data_->range)); }
...
public:
    ...
    VideoPixelFormat format() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::media::stable::mojom::VideoPixelFormat>(data_->format)); }
    inline void GetCodedSizeDataView(::gfx::mojom::SizeDataView* output);
    ...
    template <typename UserType> [[nodiscard]] bool ReadData(UserType* output)
    {
        ...
        auto* pointer = !data_->data.is_null() ? &data_->data : nullptr;
        return mojo::internal::Deserialize<::media::stable::mojom::VideoFrameDataDataView>(pointer, output, message_);
    }
...
public:
    ...
    MediaLogRecord_Type type() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::media::stable::mojom::MediaLogRecord_Type>(data_->type)); }
...
public:
    ...
    template <typename UserType> [[nodiscard]] bool ReadEosData(UserType* output) const
    {
        ...
        CHECK(is_eos_data());
        return mojo::internal::Deserialize<::media::stable::mojom::EosVideoFrameDataDataView>(data_->data.f_eos_data.Get(), output, message_);
    }
    ...
    template <typename UserType> [[nodiscard]] bool ReadGpuMemoryBufferData(UserType* output) const
    {
        ...
        return mojo::internal::Deserialize<::media::stable::mojom::GpuMemoryBufferVideoFrameDataDataView>(data_->data.f_gpu_memory_buffer_data.Get(), output, message_);
    }
...
template <typename MaybeConstUserType> struct Serializer<::media::stable::mojom::DecryptConfigDataView, MaybeConstUserType> {
    ...
    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::media::stable::mojom::internal::DecryptConfig_Data>& fragment)
    {
        ...
        mojo::internal::Serialize<mojo::ArrayDataView<::media::stable::mojom::SubsampleEntryDataView>>(in_subsamples, subsamples_fragment, &subsamples_validate_params);
...
template <typename MaybeConstUserType> struct Serializer<::media::stable::mojom::SupportedVideoDecoderConfigDataView, MaybeConstUserType> {
    ...
    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::media::stable::mojom::internal::SupportedVideoDecoderConfig_Data>& fragment)
    {
        if (CallIsNullIfExists<Traits>(input))
            return;
        fragment.Allocate();
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
            fragment->coded_size_min.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null coded_size_min in SupportedVideoDecoderConfig struct");
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
            fragment->coded_size_max.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null coded_size_max in SupportedVideoDecoderConfig struct");
...
template <typename MaybeConstUserType> struct Serializer<::media::stable::mojom::ColorSpaceDataView, MaybeConstUserType> {
    ...
    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::media::stable::mojom::internal::ColorSpace_Data>& fragment)
    {
        ...
        const mojo::internal::ContainerValidateParams custom_primary_matrix_validate_params(9, false, nullptr);
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
            fragment->custom_primary_matrix.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null custom_primary_matrix in ColorSpace struct");
        ...
        const mojo::internal::ContainerValidateParams transfer_params_validate_params(7, false, nullptr);
...
template <typename MaybeConstUserType> struct Serializer<::media::stable::mojom::EosVideoFrameDataDataView, MaybeConstUserType> {
    using UserType = typename std::remove_const<MaybeConstUserType>::type;
    using Traits = StructTraits<::media::stable::mojom::EosVideoFrameDataDataView, UserType>;

    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::media::stable::mojom::internal::EosVideoFrameData_Data>& fragment)
    {
        if (CallIsNullIfExists<Traits>(input))
            return;
        fragment.Allocate();
    ...
    static bool Deserialize(::media::stable::mojom::internal::EosVideoFrameData_Data* input, UserType* output, Message* message)
    {
        if (!input)
            return CallSetToNullIfExists<Traits>(output);
...
template <typename MaybeConstUserType> struct Serializer<::media::stable::mojom::NativeGpuMemoryBufferHandleDataView, MaybeConstUserType> {
    ...
    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::media::stable::mojom::internal::NativeGpuMemoryBufferHandle_Data>& fragment)
    {
        if (CallIsNullIfExists<Traits>(input))
            return;
        fragment.Allocate();
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->id.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null id in NativeGpuMemoryBufferHandle struct");
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
            fragment->platform_handle.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null platform_handle in NativeGpuMemoryBufferHandle struct");
    }
...
template <typename MaybeConstUserType> struct Serializer<::media::stable::mojom::GpuMemoryBufferVideoFrameDataDataView, MaybeConstUserType> {
    using UserType = typename std::remove_const<MaybeConstUserType>::type;
    using Traits = StructTraits<::media::stable::mojom::GpuMemoryBufferVideoFrameDataDataView, UserType>;

    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::media::stable::mojom::internal::GpuMemoryBufferVideoFrameData_Data>& fragment)
    {
        if (CallIsNullIfExists<Traits>(input))
            return;
        fragment.Allocate();
    ...
    static bool Deserialize(::media::stable::mojom::internal::GpuMemoryBufferVideoFrameData_Data* input, UserType* output, Message* message)
    {
        if (!input)
            return CallSetToNullIfExists<Traits>(output);
...
template <typename MaybeConstUserType> struct Serializer<::media::stable::mojom::VideoFrameDataView, MaybeConstUserType> {
    ...
    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::media::stable::mojom::internal::VideoFrame_Data>& fragment)
    {
        ...
        mojo::internal::MessageFragment<decltype(fragment->data)> data_fragment(fragment.message());
        data_fragment.Claim(&fragment->data);
        mojo::internal::Serialize<::media::stable::mojom::VideoFrameDataDataView>(in_data, data_fragment, true);
...
template <typename MaybeConstUserType> struct Serializer<::media::stable::mojom::MediaLogRecordDataView, MaybeConstUserType> {
    ...
    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::media::stable::mojom::internal::MediaLogRecord_Data>& fragment)
    {
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->params.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null params in MediaLogRecord struct");
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->time.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null time in MediaLogRecord struct");
    }
...
template <typename MaybeConstUserType> struct Serializer<::media::stable::mojom::VideoFrameDataDataView, MaybeConstUserType> {
    using UserType = typename std::remove_const<MaybeConstUserType>::type;
    using Traits = UnionTraits<::media::stable::mojom::VideoFrameDataDataView, UserType>;

    static void Serialize(MaybeConstUserType& input, MessageFragment<::media::stable::mojom::internal::VideoFrameData_Data>& fragment, bool inlined)
    {
        if (CallIsNullIfExists<Traits>(input)) {
            if (inlined)
                fragment->set_null();
        ...
        case ::media::stable::mojom::VideoFrameDataDataView::Tag::kEosData: {
            ...
            mojo::internal::Serialize<::media::stable::mojom::EosVideoFrameDataDataView>(in_eos_data, value_fragment);
        ...
        case ::media::stable::mojom::VideoFrameDataDataView::Tag::kGpuMemoryBufferData: {
            ...
            mojo::internal::Serialize<::media::stable::mojom::GpuMemoryBufferVideoFrameDataDataView>(in_gpu_memory_buffer_data, value_fragment);
            MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
    ...
    static bool Deserialize(::media::stable::mojom::internal::VideoFrameData_Data* input, UserType* output, Message* message)
    {
...
inline void GpuMemoryBufferVideoFrameDataDataView::GetGpuMemoryBufferHandleDataView(NativeGpuMemoryBufferHandleDataView* output)
{
    auto pointer = data_->gpu_memory_buffer_handle.Get();
