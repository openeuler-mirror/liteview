...
struct media_mojom_internal_AudioLogComponent_DataHashFn {
    ...
    static bool Equal(const ::media::mojom::AudioLogComponent& left, const ::media::mojom::AudioLogComponent& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::media::mojom::AudioLogComponent> : public GenericHashTraits<::media::mojom::AudioLogComponent> {
    static_assert(true, "-1000000 is a reserved enum value");
    static_assert(true, "-1000001 is a reserved enum value");
    static const bool kEmptyValueIsZero = false;
    static ::media::mojom::AudioLogComponent EmptyValue() { return static_cast<::media::mojom::AudioLogComponent>(-1000000); }
    static void ConstructDeletedValue(::media::mojom::AudioLogComponent& slot, bool) { slot = static_cast<::media::mojom::AudioLogComponent>(-1000001); }
    static bool IsDeletedValue(const ::media::mojom::AudioLogComponent& value) { return value == static_cast<::media::mojom::AudioLogComponent>(-1000001); }
};
} // namespace WTF
namespace media {
namespace mojom {
