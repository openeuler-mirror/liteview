...
public:
    ...
    template <typename... Args> static PlaybackPropertiesPtr New(Args&&... args) { return PlaybackPropertiesPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static PlaybackPropertiesPtr From(const U& u) { return mojo::TypeConverter<PlaybackPropertiesPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, PlaybackProperties>::Convert(*this); }
    PlaybackProperties()
        : has_audio()
        , has_video()
        , is_background()
    ...
    PlaybackProperties(bool has_audio_in, bool has_video_in, bool is_background_in, bool is_muted_in, bool is_mse_in, bool is_eme_in, bool is_embedded_media_experience_in,
    ...
    template <typename T, PlaybackProperties::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    ...
    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<PlaybackProperties::DataView>(input); }
    ...
    {
        return mojo::Message(std::make_unique<internal::PlaybackProperties_UnserializedMessageContext<UserType, PlaybackProperties::DataView>>(0, 0, std::move(input)),
    ...
    {
        return PlaybackProperties::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, PlaybackProperties::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, PlaybackProperties::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, PlaybackProperties::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static SecondaryPlaybackPropertiesPtr New(Args&&... args) { return SecondaryPlaybackPropertiesPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static SecondaryPlaybackPropertiesPtr From(const U& u) { return mojo::TypeConverter<SecondaryPlaybackPropertiesPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, SecondaryPlaybackProperties>::Convert(*this); }
    ...
    template <typename T, SecondaryPlaybackProperties::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static WTF::Vector<uint8_t> Serialize(UserType* input)
    {
    ...
    {
        return mojo::Message(
            std::make_unique<internal::SecondaryPlaybackProperties_UnserializedMessageContext<UserType, SecondaryPlaybackProperties::DataView>>(0, 0, std::move(input)),
            MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const WTF::Vector<uint8_t>& input, UserType* output)
    {
        return SecondaryPlaybackProperties::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }

    template <typename UserType> static bool DeserializeFromMessage(mojo::Message input, UserType* output)
    {
        auto context = input.TakeUnserializedContext<internal::SecondaryPlaybackProperties_UnserializedMessageContext<UserType, SecondaryPlaybackProperties::DataView>>();
        if (context) {
            *output = std::move(context->TakeData());
            return true;
        }
...
template <typename T, SecondaryPlaybackProperties::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, SecondaryPlaybackProperties::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, SecondaryPlaybackProperties::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
template <typename StructPtrType> PlaybackPropertiesPtr PlaybackProperties::Clone() const
{
    return New(mojo::Clone(has_audio), mojo::Clone(has_video), mojo::Clone(is_background), mojo::Clone(is_muted), mojo::Clone(is_mse), mojo::Clone(is_eme),
        mojo::Clone(is_embedded_media_experience), mojo::Clone(media_stream_type));
}
...
{
    return New(mojo::Clone(audio_codec), mojo::Clone(video_codec), mojo::Clone(audio_codec_profile), mojo::Clone(video_codec_profile), mojo::Clone(audio_decoder),
        mojo::Clone(video_decoder), mojo::Clone(audio_encryption_scheme), mojo::Clone(video_encryption_scheme), mojo::Clone(natural_size));
}
...
template <> struct BLINK_PLATFORM_EXPORT StructTraits<::media::mojom::blink::PlaybackProperties::DataView, ::media::mojom::blink::PlaybackPropertiesPtr> {
    ...
    static decltype(::media::mojom::blink::PlaybackProperties::has_audio) has_audio(const ::media::mojom::blink::PlaybackPropertiesPtr& input) { return input->has_audio; }

    static decltype(::media::mojom::blink::PlaybackProperties::has_video) has_video(const ::media::mojom::blink::PlaybackPropertiesPtr& input) { return input->has_video; }
    ...
    static decltype(::media::mojom::blink::PlaybackProperties::is_muted) is_muted(const ::media::mojom::blink::PlaybackPropertiesPtr& input) { return input->is_muted; }

    static decltype(::media::mojom::blink::PlaybackProperties::is_mse) is_mse(const ::media::mojom::blink::PlaybackPropertiesPtr& input) { return input->is_mse; }

    static decltype(::media::mojom::blink::PlaybackProperties::is_eme) is_eme(const ::media::mojom::blink::PlaybackPropertiesPtr& input) { return input->is_eme; }

    static decltype(::media::mojom::blink::PlaybackProperties::is_embedded_media_experience) is_embedded_media_experience(const ::media::mojom::blink::PlaybackPropertiesPtr& input)
    {
...
template <> struct BLINK_PLATFORM_EXPORT StructTraits<::media::mojom::blink::SecondaryPlaybackProperties::DataView, ::media::mojom::blink::SecondaryPlaybackPropertiesPtr> {
    ...
    static decltype(::media::mojom::blink::SecondaryPlaybackProperties::audio_codec) audio_codec(const ::media::mojom::blink::SecondaryPlaybackPropertiesPtr& input)
    {
        return input->audio_codec;
    }

    static decltype(::media::mojom::blink::SecondaryPlaybackProperties::video_codec) video_codec(const ::media::mojom::blink::SecondaryPlaybackPropertiesPtr& input)
    {
        return input->video_codec;
    }

    static decltype(::media::mojom::blink::SecondaryPlaybackProperties::audio_codec_profile) audio_codec_profile(const ::media::mojom::blink::SecondaryPlaybackPropertiesPtr& input)
    {
        return input->audio_codec_profile;
    }

    static decltype(::media::mojom::blink::SecondaryPlaybackProperties::video_codec_profile) video_codec_profile(const ::media::mojom::blink::SecondaryPlaybackPropertiesPtr& input)
    {
        return input->video_codec_profile;
    }

    static decltype(::media::mojom::blink::SecondaryPlaybackProperties::audio_decoder) audio_decoder(const ::media::mojom::blink::SecondaryPlaybackPropertiesPtr& input)
    {
        return input->audio_decoder;
    }

    static decltype(::media::mojom::blink::SecondaryPlaybackProperties::video_decoder) video_decoder(const ::media::mojom::blink::SecondaryPlaybackPropertiesPtr& input)
    {
    ...
    static const decltype(::media::mojom::blink::SecondaryPlaybackProperties::natural_size)& natural_size(const ::media::mojom::blink::SecondaryPlaybackPropertiesPtr& input)
    {
