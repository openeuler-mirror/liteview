...
(function() {
  ...
  VideoEncodeAcceleratorSupportedRateControlMode.MAX_VALUE = 2;
  ...
  VideoEncodeAcceleratorConfig.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 52, VideoEncodeAcceleratorConfig.InterLayerPredMode);
    if (err !== validator.validationError.NONE)
        return err;
    return validator.validationError.NONE;
  };

  VideoEncodeAcceleratorConfig.encodedSize = codec.kStructHeaderSize + 64;
  ...
  Av1Metadata.validate = function(messageValidator, offset) {
    ...
    // validate Av1Metadata.spatialLayerResolutions
    err = messageValidator.validateArrayPointer(offset + codec.kStructHeaderSize + 8, 8, new codec.PointerTo(geometry$.Size), false, [0], 0);
    if (err !== validator.validationError.NONE)
        return err;
    // validate Av1Metadata.fDiffs
    err = messageValidator.validateArrayPointer(offset + codec.kStructHeaderSize + 16, 1, codec.Uint8, false, [0], 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  Av1Metadata.encodedSize = codec.kStructHeaderSize + 24;
  ...
  Av1Metadata.decode = function(decoder) {
    ...
    packed = decoder.readUint8();
    val.interPicPredicted = (packed >> 0) & 1 ? true : false;
    val.switchFrame = (packed >> 1) & 1 ? true : false;
    val.endOfPicture = (packed >> 2) & 1 ? true : false;
    val.temporalIdx =
        decoder.decodeStruct(codec.Uint8);
    val.spatialIdx =
        decoder.decodeStruct(codec.Uint8);
  ...
  Av1Metadata.encode = function(encoder, val) {
    ...
    packed = 0;
    packed |= (val.interPicPredicted & 1) << 0
    packed |= (val.switchFrame & 1) << 1
    packed |= (val.endOfPicture & 1) << 2
    encoder.writeUint8(packed);
    encoder.encodeStruct(codec.Uint8, val.temporalIdx);
    encoder.encodeStruct(codec.Uint8, val.spatialIdx);
    encoder.skip(1);
    ...
    encoder.skip(1);
    encoder.encodeArrayPointer(new codec.PointerTo(geometry$.Size), val.spatialLayerResolutions);
    encoder.encodeArrayPointer(codec.Uint8, val.fDiffs);
  };
  ...
  BitstreamBufferMetadata.encodedSize = codec.kStructHeaderSize + 40;
  ...
  var kVideoEncodeAcceleratorProvider_CreateVideoEncodeAccelerator_Name = 648505044;
  var kVideoEncodeAcceleratorProvider_GetVideoEncodeAcceleratorSupportedProfiles_Name = 1755638624;
  ...
  var kVideoEncodeAccelerator_Initialize_Name = 167886935;
  var kVideoEncodeAccelerator_Encode_Name = 172932824;
  var kVideoEncodeAccelerator_UseOutputBitstreamBuffer_Name = 1253395289;
  var kVideoEncodeAccelerator_RequestEncodingParametersChangeWithLayers_Name = 1399892488;
  var kVideoEncodeAccelerator_RequestEncodingParametersChangeWithBitrate_Name = 718015341;
  var kVideoEncodeAccelerator_IsFlushSupported_Name = 1326273114;
  var kVideoEncodeAccelerator_Flush_Name = 2098684447;
  ...
  var kVideoEncodeAcceleratorClient_RequireBitstreamBuffers_Name = 1202189138;
  var kVideoEncodeAcceleratorClient_BitstreamBufferReady_Name = 1623528741;
  var kVideoEncodeAcceleratorClient_NotifyError_Name = 571199804;
  var kVideoEncodeAcceleratorClient_NotifyEncoderInfoChange_Name = 2062809305;
