// media/mojo/mojom/playback_events_recorder.mojom-lite-for-compile.js is auto generated by mojom_bindings_generator.py, do not edit
...
goog.provide('media.mojom.PlaybackEventsRecorder');
goog.provide('media.mojom.PlaybackEventsRecorderReceiver');
goog.provide('media.mojom.PlaybackEventsRecorderCallbackRouter');
goog.provide('media.mojom.PlaybackEventsRecorderInterface');
goog.provide('media.mojom.PlaybackEventsRecorderRemote');
goog.provide('media.mojom.PlaybackEventsRecorderPendingReceiver');
/**
...
/** @interface */
media.mojom.PlaybackEventsRecorderInterface = class {
...
goog.provide('media.mojom.PlaybackEventsRecorder_OnPlaying_ParamsSpec');
/**
...
goog.provide('media.mojom.PlaybackEventsRecorder_OnPaused_ParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('media.mojom.PlaybackEventsRecorder_OnSeeking_ParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('media.mojom.PlaybackEventsRecorder_OnEnded_ParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('media.mojom.PlaybackEventsRecorder_OnError_ParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('media.mojom.PlaybackEventsRecorder_OnBuffering_ParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('media.mojom.PlaybackEventsRecorder_OnBufferingComplete_ParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('media.mojom.PlaybackEventsRecorder_OnNaturalSizeChanged_ParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('media.mojom.PlaybackEventsRecorder_OnPipelineStatistics_ParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('media.mojom.PlaybackEventsRecorder_OnPlaying_Params');
...
goog.provide('media.mojom.PlaybackEventsRecorder_OnPaused_Params');
...
goog.provide('media.mojom.PlaybackEventsRecorder_OnSeeking_Params');
...
goog.provide('media.mojom.PlaybackEventsRecorder_OnEnded_Params');
...
goog.provide('media.mojom.PlaybackEventsRecorder_OnError_Params');
...
goog.provide('media.mojom.PlaybackEventsRecorder_OnBuffering_Params');
...
goog.provide('media.mojom.PlaybackEventsRecorder_OnBufferingComplete_Params');
...
goog.provide('media.mojom.PlaybackEventsRecorder_OnNaturalSizeChanged_Params');
...
goog.provide('media.mojom.PlaybackEventsRecorder_OnPipelineStatistics_Params');
