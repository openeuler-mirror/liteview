...
//   void Start() final;
//
//   void StartDataStreams(::mojo::ScopedDataPipeConsumerHandle audio_pipe, ::mojo::ScopedDataPipeConsumerHandle video_pipe, ::mojo::PendingReceiver<RemotingDataStreamSender>
//   audio_sender, ::mojo::PendingReceiver<RemotingDataStreamSender> video_sender) final;
//
