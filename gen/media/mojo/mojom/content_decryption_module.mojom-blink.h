...
struct media_mojom_internal_CdmKeyStatus_DataHashFn {
    ...
    static bool Equal(const ::media::mojom::CdmKeyStatus& left, const ::media::mojom::CdmKeyStatus& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::media::mojom::CdmKeyStatus> : public GenericHashTraits<::media::mojom::CdmKeyStatus> {
    ...
    static void ConstructDeletedValue(::media::mojom::CdmKeyStatus& slot, bool) { slot = static_cast<::media::mojom::CdmKeyStatus>(-1000001); }
    static bool IsDeletedValue(const ::media::mojom::CdmKeyStatus& value) { return value == static_cast<::media::mojom::CdmKeyStatus>(-1000001); }
};
} // namespace WTF
namespace media {
namespace mojom {
...
public:
    ...
    CdmContext(const ::base::UnguessableToken& cdm_id_in, ::mojo::PendingRemote<::media::mojom::blink::Decryptor> decryptor_in, bool requires_media_foundation_renderer_in)
...
template <> struct BLINK_PLATFORM_EXPORT StructTraits<::media::mojom::blink::CdmPromiseResult::DataView, ::media::mojom::blink::CdmPromiseResultPtr> {
    ...
    static decltype(::media::mojom::blink::CdmPromiseResult::success) success(const ::media::mojom::blink::CdmPromiseResultPtr& input) { return input->success; }

    static decltype(::media::mojom::blink::CdmPromiseResult::exception) exception(const ::media::mojom::blink::CdmPromiseResultPtr& input) { return input->exception; }

    static decltype(::media::mojom::blink::CdmPromiseResult::system_code) system_code(const ::media::mojom::blink::CdmPromiseResultPtr& input) { return input->system_code; }
...
template <> struct BLINK_PLATFORM_EXPORT StructTraits<::media::mojom::blink::CdmKeyInformation::DataView, ::media::mojom::blink::CdmKeyInformationPtr> {
    ...
    static const decltype(::media::mojom::blink::CdmKeyInformation::key_id)& key_id(const ::media::mojom::blink::CdmKeyInformationPtr& input) { return input->key_id; }

    static decltype(::media::mojom::blink::CdmKeyInformation::status) status(const ::media::mojom::blink::CdmKeyInformationPtr& input) { return input->status; }

    static decltype(::media::mojom::blink::CdmKeyInformation::system_code) system_code(const ::media::mojom::blink::CdmKeyInformationPtr& input) { return input->system_code; }
...
template <> struct BLINK_PLATFORM_EXPORT StructTraits<::media::mojom::blink::CdmContext::DataView, ::media::mojom::blink::CdmContextPtr> {
    ...
    static const decltype(::media::mojom::blink::CdmContext::cdm_id)& cdm_id(const ::media::mojom::blink::CdmContextPtr& input) { return input->cdm_id; }

    static decltype(::media::mojom::blink::CdmContext::decryptor)& decryptor(::media::mojom::blink::CdmContextPtr& input) { return input->decryptor; }

    static decltype(::media::mojom::blink::CdmContext::requires_media_foundation_renderer) requires_media_foundation_renderer(const ::media::mojom::blink::CdmContextPtr& input)
    {
