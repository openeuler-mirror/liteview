...
AudioSourceSpeechRecognitionContext::IPCStableHashFunction AudioSourceSpeechRecognitionContext::MessageToMethodInfo_(mojo::Message& message)
{
    ...
    switch (message.name()) {
    case internal::kAudioSourceSpeechRecognitionContext_BindAudioSourceFetcher_Name: {
...
public:
    ...
    AudioSourceSpeechRecognitionContext_BindAudioSourceFetcher_ForwardToCallback& operator=(const AudioSourceSpeechRecognitionContext_BindAudioSourceFetcher_ForwardToCallback&)
        = delete;
...
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send media::mojom::AudioSourceSpeechRecognitionContext::BindAudioSourceFetcher", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("fetcher_receiver"), in_fetcher_receiver, "<value of type ::mojo::PendingReceiver<AudioSourceFetcher>>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("client"), in_client, "<value of type ::mojo::PendingRemote<::media::mojom::SpeechRecognitionRecognizerClient>>");
    ...
    mojo::Message message(internal::kAudioSourceSpeechRecognitionContext_BindAudioSourceFetcher_Name, kFlags, 0, 0, nullptr);
    ...
    params.Allocate();
    mojo::internal::Serialize<mojo::InterfaceRequestDataView<::media::mojom::AudioSourceFetcherInterfaceBase>>(in_fetcher_receiver, &params->fetcher_receiver, &params.message());
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(!mojo::internal::IsHandleOrInterfaceValid(params->fetcher_receiver), mojo::internal::VALIDATION_ERROR_UNEXPECTED_INVALID_HANDLE,
    ...
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
        params->options.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null options in AudioSourceSpeechRecognitionContext.BindAudioSourceFetcher request");
...
public:
    static AudioSourceSpeechRecognitionContext::BindAudioSourceFetcherCallback CreateCallback(::mojo::Message& message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
    {
...
private:
    AudioSourceSpeechRecognitionContext_BindAudioSourceFetcher_ProxyToResponder(::mojo::Message& message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
...
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send reply media::mojom::AudioSourceSpeechRecognitionContext::BindAudioSourceFetcher", "async_response_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
    ...
    AudioSourceSpeechRecognitionContext* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
{
    ...
    case internal::kAudioSourceSpeechRecognitionContext_BindAudioSourceFetcher_Name: {
        ...
        bool success = true;
        ::mojo::PendingReceiver<AudioSourceFetcher> p_fetcher_receiver = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingReceiver<AudioSourceFetcher>>();
        ::mojo::PendingRemote<::media::mojom::SpeechRecognitionRecognizerClient> p_client
            = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingRemote<::media::mojom::SpeechRecognitionRecognizerClient>>();
        ::media::mojom::SpeechRecognitionOptionsPtr p_options = mojo::DefaultConstructTraits::CreateInstance<::media::mojom::SpeechRecognitionOptionsPtr>();
        ...
        if (success && !input_data_view.ReadOptions(&p_options))
            success = false;
        if (!success) {
            ReportValidationErrorForMessage(message, mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED, AudioSourceSpeechRecognitionContext::Name_, 0, false);
            return false;
        }
...
static const std::pair<uint32_t, mojo::internal::GenericValidationInfo> kAudioSourceSpeechRecognitionContextValidationInfo[] = {
    { internal::kAudioSourceSpeechRecognitionContext_BindAudioSourceFetcher_Name,
...
bool AudioSourceSpeechRecognitionContextRequestValidator::Accept(mojo::Message* message)
{
    ...
    return mojo::internal::ValidateRequestGeneric(message, name, kAudioSourceSpeechRecognitionContextValidationInfo);
}

bool AudioSourceSpeechRecognitionContextResponseValidator::Accept(mojo::Message* message)
{
    const char* name = ::media::mojom::AudioSourceSpeechRecognitionContext::Name_;
    return mojo::internal::ValidateResponseGeneric(message, name, kAudioSourceSpeechRecognitionContextValidationInfo);
}
...
SpeechRecognitionService::IPCStableHashFunction SpeechRecognitionService::MessageToMethodInfo_(mojo::Message& message)
{
#if !BUILDFLAG(IS_FUCHSIA)
    switch (message.name()) {
    case internal::kSpeechRecognitionService_BindSpeechRecognitionContext_Name: {
    ...
    case internal::kSpeechRecognitionService_SetSodaPath_Name: {
        return &SpeechRecognitionService::SetSodaPath_Sym::IPCStableHash;
    }
    }
#endif // !BUILDFLAG(IS_FUCHSIA)
    return nullptr;
...
const char* SpeechRecognitionService::MessageToMethodName_(mojo::Message& message)
{
    ...
    if (!is_response) {
        ...
        case internal::kSpeechRecognitionService_SetSodaPath_Name:
            return "Receive media::mojom::SpeechRecognitionService::SetSodaPath";
        }
    } else {
        switch (message.name()) {
        case internal::kSpeechRecognitionService_BindSpeechRecognitionContext_Name:
        ...
        case internal::kSpeechRecognitionService_SetSodaPath_Name:
            return "Receive reply media::mojom::SpeechRecognitionService::SetSodaPath";
        }
    }
    return "Receive unknown mojo message";
#else
...
uint32_t SpeechRecognitionService::SetSodaPath_Sym::IPCStableHash()
{
    // This method's address is used for indetifiying the mojo method name after
    // symbolization. So each IPCStableHash should have a unique address.
    // We cannot use NO_CODE_FOLDING() here - it relies on the uniqueness of
    ...
    // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
    // hash instead of __LINE__.
    constexpr uint32_t kHash = base::MD5Hash32Constexpr("(Impl)media::mojom::SpeechRecognitionService::SetSodaPath");
    const uint32_t hash = kHash;
    base::debug::Alias(&hash);
    return hash;
}
...
void SpeechRecognitionServiceProxy::BindSpeechRecognitionContext(::mojo::PendingReceiver<::media::mojom::SpeechRecognitionContext> in_context)
{
    ...
    TRACE_EVENT1("mojom", "Send media::mojom::SpeechRecognitionService::BindSpeechRecognitionContext", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("context"), in_context, "<value of type ::mojo::PendingReceiver<::media::mojom::SpeechRecognitionContext>>");
    });
#endif
    ...
    mojo::Message message(internal::kSpeechRecognitionService_BindSpeechRecognitionContext_Name, kFlags, 0, 0, nullptr);
    ...
    params.Allocate();
    mojo::internal::Serialize<mojo::InterfaceRequestDataView<::media::mojom::SpeechRecognitionContextInterfaceBase>>(in_context, &params->context, &params.message());
...
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send media::mojom::SpeechRecognitionService::BindAudioSourceSpeechRecognitionContext", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("context"), in_context, "<value of type ::mojo::PendingReceiver<AudioSourceSpeechRecognitionContext>>");
    });
#endif
    const bool kExpectsResponse = false;
    const bool kIsSync = false;
    ...
    mojo::Message message(internal::kSpeechRecognitionService_BindAudioSourceSpeechRecognitionContext_Name, kFlags, 0, 0, nullptr);
    ...
    params.Allocate();
    mojo::internal::Serialize<mojo::InterfaceRequestDataView<::media::mojom::AudioSourceSpeechRecognitionContextInterfaceBase>>(in_context, &params->context, &params.message());
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(!mojo::internal::IsHandleOrInterfaceValid(params->context), mojo::internal::VALIDATION_ERROR_UNEXPECTED_INVALID_HANDLE,
...
void SpeechRecognitionServiceProxy::SetSodaPath(const ::base::FilePath& in_binary_path, const ::base::FilePath& in_config_path)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send media::mojom::SpeechRecognitionService::SetSodaPath", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("binary_path"), in_binary_path, "<value of type const ::base::FilePath&>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("config_path"), in_config_path, "<value of type const ::base::FilePath&>");
    });
#endif
    const bool kExpectsResponse = false;
    const bool kIsSync = false;
    ...
    mojo::Message message(internal::kSpeechRecognitionService_SetSodaPath_Name, kFlags, 0, 0, nullptr);
    mojo::internal::MessageFragment<::media::mojom::internal::SpeechRecognitionService_SetSodaPath_Params_Data> params(message);
    params.Allocate();
    ...
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
        params->binary_path.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null binary_path in SpeechRecognitionService.SetSodaPath request");
    mojo::internal::MessageFragment<typename decltype(params->config_path)::BaseType> config_path_fragment(params.message());
    mojo::internal::Serialize<::mojo_base::mojom::FilePathDataView>(in_config_path, config_path_fragment);
    params->config_path.Set(config_path_fragment.is_null() ? nullptr : config_path_fragment.data());
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
        params->config_path.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null config_path in SpeechRecognitionService.SetSodaPath request");
...
bool SpeechRecognitionServiceStubDispatch::Accept(SpeechRecognitionService* impl, mojo::Message* message)
{
    ...
    case internal::kSpeechRecognitionService_BindSpeechRecognitionContext_Name: {
        ...
        ::mojo::PendingReceiver<::media::mojom::SpeechRecognitionContext> p_context
            = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingReceiver<::media::mojom::SpeechRecognitionContext>>();
    ...
    case internal::kSpeechRecognitionService_BindAudioSourceSpeechRecognitionContext_Name: {
        ...
        ::mojo::PendingReceiver<AudioSourceSpeechRecognitionContext> p_context
            = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingReceiver<AudioSourceSpeechRecognitionContext>>();
    ...
    case internal::kSpeechRecognitionService_SetSodaPath_Name: {
        ...
        internal::SpeechRecognitionService_SetSodaPath_Params_Data* params
            = reinterpret_cast<internal::SpeechRecognitionService_SetSodaPath_Params_Data*>(message->mutable_payload());

        bool success = true;
        ::base::FilePath p_binary_path = mojo::DefaultConstructTraits::CreateInstance<::base::FilePath>();
        ::base::FilePath p_config_path = mojo::DefaultConstructTraits::CreateInstance<::base::FilePath>();
        ...
        // A null |impl| means no implementation was bound.
        DCHECK(impl);
        impl->SetSodaPath(std::move(p_binary_path), std::move(p_config_path));
        return true;
    }
    }
    return false;
...
// static
bool SpeechRecognitionServiceStubDispatch::AcceptWithResponder(SpeechRecognitionService* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
{
    [[maybe_unused]] const bool message_is_sync = message->has_flag(mojo::Message::kFlagIsSync);
    [[maybe_unused]] const uint64_t request_id = message->request_id();
    switch (message->header()->name) {
...
static const std::pair<uint32_t, mojo::internal::GenericValidationInfo> kSpeechRecognitionServiceValidationInfo[] = {
    { internal::kSpeechRecognitionService_BindSpeechRecognitionContext_Name,
        { &internal::SpeechRecognitionService_BindSpeechRecognitionContext_Params_Data::Validate, nullptr /* no response */ } },
    { internal::kSpeechRecognitionService_BindAudioSourceSpeechRecognitionContext_Name,
        { &internal::SpeechRecognitionService_BindAudioSourceSpeechRecognitionContext_Params_Data::Validate, nullptr /* no response */ } },
    { internal::kSpeechRecognitionService_SetSodaPath_Name, { &internal::SpeechRecognitionService_SetSodaPath_Params_Data::Validate, nullptr /* no response */ } },
};
    ...
    ::mojo::PendingRemote<::media::mojom::AudioStreamFactory> in_factory, const std::string& in_device_id, const ::media::AudioParameters& in_audio_parameters)
{
    ...
    TRACE_EVENT1("mojom", "Send media::mojom::AudioSourceFetcher::Start", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("factory"), in_factory, "<value of type ::mojo::PendingRemote<::media::mojom::AudioStreamFactory>>");
    ...
    mojo::Message message(internal::kAudioSourceFetcher_Start_Name, kFlags, 0, 0, nullptr);
    ...
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
        params->audio_parameters.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null audio_parameters in AudioSourceFetcher.Start request");
...
void AudioSourceFetcherProxy::Stop()
{
    ...
    mojo::Message message(internal::kAudioSourceFetcher_Stop_Name, kFlags, 0, 0, nullptr);
...
bool AudioSourceFetcherStubDispatch::Accept(AudioSourceFetcher* impl, mojo::Message* message)
{
    ...
    case internal::kAudioSourceFetcher_Start_Name: {
        ...
        ::mojo::PendingRemote<::media::mojom::AudioStreamFactory> p_factory
            = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingRemote<::media::mojom::AudioStreamFactory>>();
        std::string p_device_id = mojo::DefaultConstructTraits::CreateInstance<std::string>();
        ::media::AudioParameters p_audio_parameters = mojo::DefaultConstructTraits::CreateInstance<::media::AudioParameters>();
...
// static
bool AudioSourceFetcherStubDispatch::AcceptWithResponder(AudioSourceFetcher* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
{
    [[maybe_unused]] const bool message_is_sync = message->has_flag(mojo::Message::kFlagIsSync);
    [[maybe_unused]] const uint64_t request_id = message->request_id();
    switch (message->header()->name) {
...
static const std::pair<uint32_t, mojo::internal::GenericValidationInfo> kAudioSourceFetcherValidationInfo[] = {
    { internal::kAudioSourceFetcher_Start_Name, { &internal::AudioSourceFetcher_Start_Params_Data::Validate, nullptr /* no response */ } },
    { internal::kAudioSourceFetcher_Stop_Name, { &internal::AudioSourceFetcher_Stop_Params_Data::Validate, nullptr /* no response */ } },
};
...
void AudioSourceSpeechRecognitionContextInterceptorForTesting::BindAudioSourceFetcher(::mojo::PendingReceiver<AudioSourceFetcher> fetcher_receiver,
    ::mojo::PendingRemote<::media::mojom::SpeechRecognitionRecognizerClient> client, ::media::mojom::SpeechRecognitionOptionsPtr options, BindAudioSourceFetcherCallback callback)
{
...
void AudioSourceSpeechRecognitionContextAsyncWaiter::BindAudioSourceFetcher(::mojo::PendingReceiver<AudioSourceFetcher> fetcher_receiver,
    ::mojo::PendingRemote<::media::mojom::SpeechRecognitionRecognizerClient> client, ::media::mojom::SpeechRecognitionOptionsPtr options, bool* out_is_multichannel_supported)
{
    base::RunLoop loop;
...
void AudioSourceFetcherInterceptorForTesting::Stop() { GetForwardingInterface()->Stop(); }
