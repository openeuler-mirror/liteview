...
class AudioDecoderInterceptorForTesting : public AudioDecoder {
    ...
    void Construct(::mojo::PendingAssociatedRemote<AudioDecoderClient> client) override;
...
public:
    ...
    void Initialize(const ::media::AudioDecoderConfig& config, const absl::optional<::base::UnguessableToken>& cdm_id, ::media::DecoderStatus* out_success,
