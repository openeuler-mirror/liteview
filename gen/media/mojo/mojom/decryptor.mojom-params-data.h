...
static_assert(sizeof(Decryptor_Decrypt_Params_Data) == 24, "Bad sizeof(Decryptor_Decrypt_Params_Data)");
...
static_assert(sizeof(Decryptor_Decrypt_ResponseParams_Data) == 24, "Bad sizeof(Decryptor_Decrypt_ResponseParams_Data)");
...
static_assert(sizeof(Decryptor_DecryptAndDecodeAudio_Params_Data) == 16, "Bad sizeof(Decryptor_DecryptAndDecodeAudio_Params_Data)");
...
static_assert(sizeof(Decryptor_DecryptAndDecodeVideo_Params_Data) == 16, "Bad sizeof(Decryptor_DecryptAndDecodeVideo_Params_Data)");
...
public:
    ...
    Decryptor_StreamType stream_type() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::media::mojom::Decryptor_StreamType>(data_->stream_type)); }
...
public:
    ...
    Decryptor_Status status() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::media::mojom::Decryptor_Status>(data_->status)); }
...
public:
    ...
    {
        UserType result;
        bool ret = mojo::internal::Deserialize<mojo::InterfacePtrDataView<::media::mojom::FrameResourceReleaserInterfaceBase>>(&data_->releaser, &result, message_);
        DCHECK(ret);
        return result;
    }
