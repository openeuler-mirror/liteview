...
std::ostream& operator<<(std::ostream& os, AudioInputStreamObserver_DisconnectReason value) { return os << AudioInputStreamObserver_DisconnectReasonToString(value); }
...
bool AudioInputStreamClient_OnMutedStateChanged_Params_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    ...
    // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
    // the message comes from an older version.
    [[maybe_unused]] const AudioInputStreamClient_OnMutedStateChanged_Params_Data* object = static_cast<const AudioInputStreamClient_OnMutedStateChanged_Params_Data*>(data);
...
bool AudioInputStreamObserver_DidStartRecording_Params_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    ...
    // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
    // the message comes from an older version.
    [[maybe_unused]] const AudioInputStreamObserver_DidStartRecording_Params_Data* object = static_cast<const AudioInputStreamObserver_DidStartRecording_Params_Data*>(data);
