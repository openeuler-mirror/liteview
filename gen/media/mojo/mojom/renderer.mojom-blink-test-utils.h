...
class BLINK_PLATFORM_EXPORT RendererInterceptorForTesting : public Renderer {
    ...
    void Initialize(::mojo::PendingAssociatedRemote<RendererClient> client, absl::optional<WTF::Vector<::mojo::PendingRemote<::media::mojom::blink::DemuxerStream>>> streams,
        MediaUrlParamsPtr media_url_params, InitializeCallback callback) override;
...
public:
    ...
    ~RendererAsyncWaiter();
    void Initialize(::mojo::PendingAssociatedRemote<RendererClient> client, absl::optional<WTF::Vector<::mojo::PendingRemote<::media::mojom::blink::DemuxerStream>>> streams,
        MediaUrlParamsPtr media_url_params, bool* out_success);
    bool Initialize(::mojo::PendingAssociatedRemote<RendererClient> client, absl::optional<WTF::Vector<::mojo::PendingRemote<::media::mojom::blink::DemuxerStream>>> streams,
        MediaUrlParamsPtr media_url_params);
    void Flush();

    void SetCdm(const absl::optional<::base::UnguessableToken>& cdm_id, bool* out_success);
