...
//
//   void Initialize(::mojo::PendingAssociatedRemote<RendererClient> client, absl::optional<WTF::Vector<::mojo::PendingRemote<::media::mojom::blink::DemuxerStream>>> streams,
...
public:
    ...
    MediaUrlParams(const ::blink::KURL& media_url_in, const ::net::SiteForCookies& site_for_cookies_in, const ::scoped_refptr<const ::blink::SecurityOrigin>& top_frame_origin_in,
        bool allow_credentials_in, bool is_hls_in)
...
template <> struct BLINK_PLATFORM_EXPORT StructTraits<::media::mojom::blink::MediaUrlParams::DataView, ::media::mojom::blink::MediaUrlParamsPtr> {
    ...
    static const decltype(::media::mojom::blink::MediaUrlParams::media_url)& media_url(const ::media::mojom::blink::MediaUrlParamsPtr& input) { return input->media_url; }
    ...
    static decltype(::media::mojom::blink::MediaUrlParams::is_hls) is_hls(const ::media::mojom::blink::MediaUrlParamsPtr& input) { return input->is_hls; }
