...
template <> struct HashTraits<::media::mojom::AudioInputStreamObserver_DisconnectReason> : public GenericHashTraits<::media::mojom::AudioInputStreamObserver_DisconnectReason> {
    static_assert(true, "-1000000 is a reserved enum value");
    static_assert(true, "-1000001 is a reserved enum value");
    static const bool kEmptyValueIsZero = false;
    static ::media::mojom::AudioInputStreamObserver_DisconnectReason EmptyValue() { return static_cast<::media::mojom::AudioInputStreamObserver_DisconnectReason>(-1000000); }
