...
// with not having this data in traces there.
    ...
    virtual void CreateInputStream(::mojo::PendingReceiver<::media::mojom::blink::AudioInputStream> stream,
        ...
        ::mojo::PendingRemote<::media::mojom::blink::AudioLog> log, const WTF::String& device_id, const ::media::AudioParameters& params, uint32_t shared_memory_count,
        bool enable_agc, ::base::ReadOnlySharedMemoryRegion key_press_count_buffer, ::media::mojom::blink::AudioProcessingConfigPtr processing_config,
...
//
//   void CreateInputStream(::mojo::PendingReceiver<::media::mojom::blink::AudioInputStream> stream, ::mojo::PendingRemote<::media::mojom::blink::AudioInputStreamClient> client,
//   ::mojo::PendingRemote<::media::mojom::blink::AudioInputStreamObserver> observer, ::mojo::PendingRemote<::media::mojom::blink::AudioLog> log, const WTF::String& device_id,
...
//   ::media::mojom::blink::AudioProcessingConfigPtr processing_config, CreateInputStreamCallback callback) final;
//
...
//   ::mojo::PendingAssociatedRemote<::media::mojom::blink::AudioOutputStreamObserver> observer, ::mojo::PendingRemote<::media::mojom::blink::AudioLog> log, const WTF::String&
//   device_id, const ::media::AudioParameters& params, const ::base::UnguessableToken& group_id, CreateOutputStreamCallback callback) final;
//
//   void BindMuter(::mojo::PendingAssociatedReceiver<LocalMuter> receiver, const ::base::UnguessableToken& group_id) final;
//
//   void CreateLoopbackStream(::mojo::PendingReceiver<::media::mojom::blink::AudioInputStream> receiver, ::mojo::PendingRemote<::media::mojom::blink::AudioInputStreamClient>
//   client, ::mojo::PendingRemote<::media::mojom::blink::AudioInputStreamObserver> observer, const ::media::AudioParameters& params, uint32_t shared_memory_count, const
//   ::base::UnguessableToken& group_id, CreateLoopbackStreamCallback callback) final;
//
//  private:
//   mojo::MessageReceiverWithResponder* receiver_;
// };
