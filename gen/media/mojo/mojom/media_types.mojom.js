...
(function() {
  ...
  var CdmEvent = {};
  CdmEvent.kSignificantPlayback = 0;
  CdmEvent.kPlaybackError = 1;
  CdmEvent.kCdmError = 2;
  CdmEvent.MIN_VALUE = 0;
  CdmEvent.MAX_VALUE = 2;

  CdmEvent.isKnownEnumValue = function(value) {
    switch (value) {
    case 0:
    case 1:
    case 2:
  ...
  CdmEvent.toKnownEnumValue = function(value) {
    return value;
  };

  CdmEvent.validate = function(enumValue) {
    const isExtensible = false;
    if (isExtensible || this.isKnownEnumValue(enumValue))
      return validator.validationError.NONE;
