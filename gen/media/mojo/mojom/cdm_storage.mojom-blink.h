...
struct media_mojom_internal_CdmStorage_Status_DataHashFn {
    ...
    static bool Equal(const ::media::mojom::CdmStorage_Status& left, const ::media::mojom::CdmStorage_Status& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::media::mojom::CdmStorage_Status> : public GenericHashTraits<::media::mojom::CdmStorage_Status> {
    ...
    static void ConstructDeletedValue(::media::mojom::CdmStorage_Status& slot, bool) { slot = static_cast<::media::mojom::CdmStorage_Status>(-1000001); }
    static bool IsDeletedValue(const ::media::mojom::CdmStorage_Status& value) { return value == static_cast<::media::mojom::CdmStorage_Status>(-1000001); }
};
} // namespace WTF
namespace WTF {
struct media_mojom_internal_CdmFile_Status_DataHashFn {
    ...
    static bool Equal(const ::media::mojom::CdmFile_Status& left, const ::media::mojom::CdmFile_Status& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::media::mojom::CdmFile_Status> : public GenericHashTraits<::media::mojom::CdmFile_Status> {
    static_assert(true, "-1000000 is a reserved enum value");
    static_assert(true, "-1000001 is a reserved enum value");
    static const bool kEmptyValueIsZero = false;
    static ::media::mojom::CdmFile_Status EmptyValue() { return static_cast<::media::mojom::CdmFile_Status>(-1000000); }
    static void ConstructDeletedValue(::media::mojom::CdmFile_Status& slot, bool) { slot = static_cast<::media::mojom::CdmFile_Status>(-1000001); }
    static bool IsDeletedValue(const ::media::mojom::CdmFile_Status& value) { return value == static_cast<::media::mojom::CdmFile_Status>(-1000001); }
};
} // namespace WTF
namespace media {
namespace mojom {
