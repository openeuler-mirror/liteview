...
std::ostream& operator<<(std::ostream& os, DisplayCaptureSurfaceType value) { return os << DisplayCaptureSurfaceTypeToString(value); }
...
std::ostream& operator<<(std::ostream& os, CursorCaptureType value) { return os << CursorCaptureTypeToString(value); }
...
// static
void TraceFormatTraits<::media::mojom::DisplayCaptureSurfaceType>::WriteIntoTrace(perfetto::TracedValue context, ::media::mojom::DisplayCaptureSurfaceType value)
{
