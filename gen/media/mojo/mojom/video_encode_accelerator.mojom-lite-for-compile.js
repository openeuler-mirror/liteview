...
goog.provide('media.mojom.VideoEncodeAccelerator_Error');
goog.provide('media.mojom.VideoEncodeAccelerator.ErrorSpec');
/**
 * @const { {$: !mojo.internal.MojomType} }
 * @export
 */
...
goog.provide('media.mojom.Av1MetadataSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('media.mojom.VideoEncodeAcceleratorClient_NotifyError_ParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('media.mojom.CodecMetadataSpec');
/**
 * @const { {$:!mojo.internal.MojomType} }
 * @export
 */
...
goog.provide('media.mojom.VideoEncodeAcceleratorConfig_InterLayerPredMode');
goog.provide('media.mojom.VideoEncodeAcceleratorConfigSpec.InterLayerPredModeSpec');
/**
 * @const { {$: !mojo.internal.MojomType} }
 * @export
 */
...
goog.provide('media.mojom.Av1Metadata');
...
goog.provide('media.mojom.VideoEncodeAcceleratorClient_NotifyError_Params');
 ...
 */
media.mojom.Bitrate;
goog.provide('media.mojom.CodecMetadata');
mojo.internal.Union(
