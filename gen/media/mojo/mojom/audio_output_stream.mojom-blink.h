...
template <> struct HashTraits<::media::mojom::AudioOutputStreamObserver_DisconnectReason> : public GenericHashTraits<::media::mojom::AudioOutputStreamObserver_DisconnectReason> {
