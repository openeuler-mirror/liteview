...
static_assert(
    sizeof(AudioSourceSpeechRecognitionContext_BindAudioSourceFetcher_Params_Data) == 32, "Bad sizeof(AudioSourceSpeechRecognitionContext_BindAudioSourceFetcher_Params_Data)");
...
static_assert(sizeof(SpeechRecognitionService_BindSpeechRecognitionContext_Params_Data) == 16, "Bad sizeof(SpeechRecognitionService_BindSpeechRecognitionContext_Params_Data)");
...
class SpeechRecognitionService_SetSodaPath_Params_Data {
public:
    static bool Validate(const void* data, mojo::internal::ValidationContext* validation_context);

    mojo::internal::StructHeader header_;
    mojo::internal::Pointer<::mojo_base::mojom::internal::FilePath_Data> binary_path;
    mojo::internal::Pointer<::mojo_base::mojom::internal::FilePath_Data> config_path;

private:
    friend class mojo::internal::MessageFragment<SpeechRecognitionService_SetSodaPath_Params_Data>;

    SpeechRecognitionService_SetSodaPath_Params_Data();
    ~SpeechRecognitionService_SetSodaPath_Params_Data() = delete;
};
static_assert(sizeof(SpeechRecognitionService_SetSodaPath_Params_Data) == 24, "Bad sizeof(SpeechRecognitionService_SetSodaPath_Params_Data)");
...
public:
    ...
    {
        UserType result;
        bool ret = mojo::internal::Deserialize<mojo::InterfaceRequestDataView<::media::mojom::AudioSourceFetcherInterfaceBase>>(&data_->fetcher_receiver, &result, message_);
        DCHECK(ret);
        return result;
    }
...
public:
    ...
    SpeechRecognitionService_BindSpeechRecognitionContext_ParamsDataView(internal::SpeechRecognitionService_BindSpeechRecognitionContext_Params_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
    ...
    {
        UserType result;
        bool ret = mojo::internal::Deserialize<mojo::InterfaceRequestDataView<::media::mojom::SpeechRecognitionContextInterfaceBase>>(&data_->context, &result, message_);
        DCHECK(ret);
        return result;
    }
...
public:
    ...
    template <typename UserType> UserType TakeContext()
    {
        UserType result;
        bool ret
            = mojo::internal::Deserialize<mojo::InterfaceRequestDataView<::media::mojom::AudioSourceSpeechRecognitionContextInterfaceBase>>(&data_->context, &result, message_);
        DCHECK(ret);
        return result;
    }
...
class SpeechRecognitionService_SetSodaPath_ParamsDataView {
public:
    SpeechRecognitionService_SetSodaPath_ParamsDataView() = default;

    SpeechRecognitionService_SetSodaPath_ParamsDataView(internal::SpeechRecognitionService_SetSodaPath_Params_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
    ...
    inline void GetConfigPathDataView(::mojo_base::mojom::FilePathDataView* output);

    template <typename UserType> [[nodiscard]] bool ReadConfigPath(UserType* output)
    {

        auto* pointer = data_->config_path.Get();
        return mojo::internal::Deserialize<::mojo_base::mojom::FilePathDataView>(pointer, output, message_);
    }

private:
    internal::SpeechRecognitionService_SetSodaPath_Params_Data* data_ = nullptr;
    mojo::Message* message_ = nullptr;
};
...
inline void AudioSourceSpeechRecognitionContext_BindAudioSourceFetcher_ParamsDataView::GetOptionsDataView(::media::mojom::SpeechRecognitionOptionsDataView* output)
{
    auto pointer = data_->options.Get();
    *output = ::media::mojom::SpeechRecognitionOptionsDataView(pointer, message_);
}
inline void SpeechRecognitionService_SetSodaPath_ParamsDataView::GetBinaryPathDataView(::mojo_base::mojom::FilePathDataView* output)
{
    auto pointer = data_->binary_path.Get();
    *output = ::mojo_base::mojom::FilePathDataView(pointer, message_);
}
inline void SpeechRecognitionService_SetSodaPath_ParamsDataView::GetConfigPathDataView(::mojo_base::mojom::FilePathDataView* output)
{
    auto pointer = data_->config_path.Get();
    *output = ::mojo_base::mojom::FilePathDataView(pointer, message_);
}
