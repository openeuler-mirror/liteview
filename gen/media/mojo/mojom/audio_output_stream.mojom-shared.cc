...
std::ostream& operator<<(std::ostream& os, AudioOutputStreamObserver_DisconnectReason value) { return os << AudioOutputStreamObserver_DisconnectReasonToString(value); }
...
bool AudioOutputStreamObserver_DidStartPlaying_Params_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    ...
    // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
    // the message comes from an older version.
    [[maybe_unused]] const AudioOutputStreamObserver_DidStartPlaying_Params_Data* object = static_cast<const AudioOutputStreamObserver_DidStartPlaying_Params_Data*>(data);
...
bool AudioOutputStreamObserver_DidStopPlaying_Params_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    ...
    // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
    // the message comes from an older version.
    [[maybe_unused]] const AudioOutputStreamObserver_DidStopPlaying_Params_Data* object = static_cast<const AudioOutputStreamObserver_DidStopPlaying_Params_Data*>(data);
...
bool AudioOutputStreamProviderClient_Created_Params_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    ...
    // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
    // the message comes from an older version.
    [[maybe_unused]] const AudioOutputStreamProviderClient_Created_Params_Data* object = static_cast<const AudioOutputStreamProviderClient_Created_Params_Data*>(data);
