...
(function() {
  ...
  CdmContext.prototype.initDefaults_ = function() {
    ...
    this.requiresMediaFoundationRenderer = false;
  };
  ...
  CdmContext.encodedSize = codec.kStructHeaderSize + 24;
  ...
  CdmContext.decode = function(decoder) {
    ...
    packed = decoder.readUint8();
    val.requiresMediaFoundationRenderer = (packed >> 0) & 1 ? true : false;
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  CdmContext.encode = function(encoder, val) {
    ...
    packed = 0;
    packed |= (val.requiresMediaFoundationRenderer & 1) << 0
    encoder.writeUint8(packed);
    encoder.skip(1);
    encoder.skip(1);
    encoder.skip(1);
  ...
  CdmFactory_CreateCdm_Params.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 0, CdmConfig, false);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  CdmFactory_CreateCdm_Params.encodedSize = codec.kStructHeaderSize + 8;
  ...
  var kContentDecryptionModule_SetClient_Name = 2018431455;
  var kContentDecryptionModule_SetServerCertificate_Name = 1229773935;
  var kContentDecryptionModule_GetStatusForPolicy_Name = 746548742;
  var kContentDecryptionModule_CreateSessionAndGenerateRequest_Name = 2023655664;
  var kContentDecryptionModule_LoadSession_Name = 382400566;
  var kContentDecryptionModule_UpdateSession_Name = 1413713274;
  var kContentDecryptionModule_CloseSession_Name = 1908899260;
  var kContentDecryptionModule_RemoveSession_Name = 638422125;
  ...
  var kContentDecryptionModuleClient_OnSessionMessage_Name = 874466726;
  var kContentDecryptionModuleClient_OnSessionClosed_Name = 2078194406;
  var kContentDecryptionModuleClient_OnSessionKeysChange_Name = 1417974775;
  var kContentDecryptionModuleClient_OnSessionExpirationUpdate_Name = 406402184;
  ...
  var kCdmFactory_CreateCdm_Name = 1500338297;
  ...
  CdmFactoryProxy.prototype.createCdm = function(cdmConfig) {
  ...
  CdmFactoryStub.prototype.createCdm = function(cdmConfig) {
