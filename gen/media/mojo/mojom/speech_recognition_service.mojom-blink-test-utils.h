...
class BLINK_PLATFORM_EXPORT AudioSourceFetcherInterceptorForTesting : public AudioSourceFetcher {
    ...
    void Start(::mojo::PendingRemote<::media::mojom::blink::AudioStreamFactory> factory, const WTF::String& device_id, const ::media::AudioParameters& audio_parameters) override;
    void Stop() override;
};
