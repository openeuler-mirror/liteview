...
public:
    ...
    uint32_t link_mask() const { return data_->link_mask; }
    uint32_t protection_mask() const { return data_->protection_mask; }
...
public:
    ...
    bool is_null() const { return !data_; }
    uint32_t desired_protection_mask() const { return data_->desired_protection_mask; }
