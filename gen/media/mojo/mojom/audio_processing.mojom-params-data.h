...
static_assert(sizeof(AudioProcessorControls_SetPreferredNumCaptureChannels_Params_Data) == 16, "Bad sizeof(AudioProcessorControls_SetPreferredNumCaptureChannels_Params_Data)");
...
public:
    ...
    AudioProcessorControls_SetPreferredNumCaptureChannels_ParamsDataView(internal::AudioProcessorControls_SetPreferredNumCaptureChannels_Params_Data* data, mojo::Message* message)
        : data_(data)
    {
    }

    bool is_null() const { return !data_; }
    int32_t num_preferred_channels() const { return data_->num_preferred_channels; }
