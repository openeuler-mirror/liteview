...
// with not having this data in traces there.
    ...
    virtual void Initialize(::mojo::PendingAssociatedRemote<RendererClient> client, absl::optional<std::vector<::mojo::PendingRemote<::media::mojom::DemuxerStream>>> streams,
        MediaUrlParamsPtr media_url_params, InitializeCallback callback)
        = 0;
...
//
//   void Initialize(::mojo::PendingAssociatedRemote<RendererClient> client, absl::optional<std::vector<::mojo::PendingRemote<::media::mojom::DemuxerStream>>> streams,
//   MediaUrlParamsPtr media_url_params, InitializeCallback callback) final;
//
...
public:
    ...
    template <typename... Args> static MediaUrlParamsPtr New(Args&&... args) { return MediaUrlParamsPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static MediaUrlParamsPtr From(const U& u) { return mojo::TypeConverter<MediaUrlParamsPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, MediaUrlParams>::Convert(*this); }
    MediaUrlParams()
        : media_url()
        , site_for_cookies()
        , top_frame_origin()
    ...
    template <typename T, MediaUrlParams::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    ...
    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<MediaUrlParams::DataView>(input); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::MediaUrlParams_UnserializedMessageContext<UserType, MediaUrlParams::DataView>>(0, 0, std::move(input)), MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    {
        return MediaUrlParams::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, MediaUrlParams::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, MediaUrlParams::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, MediaUrlParams::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }

template <typename StructPtrType> MediaUrlParamsPtr MediaUrlParams::Clone() const
{
    return New(mojo::Clone(media_url), mojo::Clone(site_for_cookies), mojo::Clone(top_frame_origin), mojo::Clone(allow_credentials), mojo::Clone(is_hls));
}
...
template <> struct StructTraits<::media::mojom::MediaUrlParams::DataView, ::media::mojom::MediaUrlParamsPtr> {
    ...
    static const decltype(::media::mojom::MediaUrlParams::media_url)& media_url(const ::media::mojom::MediaUrlParamsPtr& input) { return input->media_url; }

    static const decltype(::media::mojom::MediaUrlParams::site_for_cookies)& site_for_cookies(const ::media::mojom::MediaUrlParamsPtr& input) { return input->site_for_cookies; }

    static const decltype(::media::mojom::MediaUrlParams::top_frame_origin)& top_frame_origin(const ::media::mojom::MediaUrlParamsPtr& input) { return input->top_frame_origin; }

    static decltype(::media::mojom::MediaUrlParams::allow_credentials) allow_credentials(const ::media::mojom::MediaUrlParamsPtr& input) { return input->allow_credentials; }

    static decltype(::media::mojom::MediaUrlParams::is_hls) is_hls(const ::media::mojom::MediaUrlParamsPtr& input) { return input->is_hls; }
