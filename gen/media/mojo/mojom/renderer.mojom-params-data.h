...
public:
    ...
    template <typename UserType> [[nodiscard]] bool ReadStreams(UserType* output)
    {
        ...
        static_assert(mojo::internal::IsValidUserTypeForOptionalValue<mojo::ArrayDataView<mojo::InterfacePtrDataView<::media::mojom::DemuxerStreamInterfaceBase>>, UserType>(),
        ...
        return mojo::internal::Deserialize<mojo::ArrayDataView<mojo::InterfacePtrDataView<::media::mojom::DemuxerStreamInterfaceBase>>>(pointer, output, message_);
    }
...
public:
    ...
    bool is_null() const { return !data_; }
    float volume() const { return data_->volume; }
...
public:
    ...
    ::media::mojom::BufferingState state() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::media::mojom::BufferingState>(data_->state)); }
...
inline void Renderer_Initialize_ParamsDataView::GetStreamsDataView(mojo::ArrayDataView<mojo::InterfacePtrDataView<::media::mojom::DemuxerStreamInterfaceBase>>* output)
{
    auto pointer = data_->streams.Get();
