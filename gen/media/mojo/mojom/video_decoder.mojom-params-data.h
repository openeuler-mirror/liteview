...
static_assert(sizeof(VideoDecoder_Decode_Params_Data) == 16, "Bad sizeof(VideoDecoder_Decode_Params_Data)");
...
public:
    ...
    ::media::mojom::VideoDecoderType decoder_type() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::media::mojom::VideoDecoderType>(data_->decoder_type)); }
...
public:
    ...
    ::media::mojom::WaitingReason reason() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::media::mojom::WaitingReason>(data_->reason)); }
...
public:
    ...
    bool is_null() const { return !data_; }
    bool restart_for_transitions() const { return data_->restart_for_transitions; }
...
inline void VideoDecoder_GetSupportedConfigs_ResponseParamsDataView::GetSupportedConfigsDataView(mojo::ArrayDataView<SupportedVideoDecoderConfigDataView>* output)
{
    auto pointer = data_->supported_configs.Get();
