// media/mojo/mojom/video_decode_stats_recorder.mojom-lite-for-compile.js is auto generated by mojom_bindings_generator.py, do not edit
...
goog.require('media.mojom.PredictionTargets');
goog.provide('media.mojom.VideoDecodeStatsRecorder');
goog.provide('media.mojom.VideoDecodeStatsRecorderReceiver');
goog.provide('media.mojom.VideoDecodeStatsRecorderCallbackRouter');
goog.provide('media.mojom.VideoDecodeStatsRecorderInterface');
goog.provide('media.mojom.VideoDecodeStatsRecorderRemote');
goog.provide('media.mojom.VideoDecodeStatsRecorderPendingReceiver');
/**
...
/** @interface */
media.mojom.VideoDecodeStatsRecorderInterface = class {
...
goog.provide('media.mojom.VideoDecodeStatsRecorder_StartNewRecord_ParamsSpec');
/**
...
goog.provide('media.mojom.VideoDecodeStatsRecorder_UpdateRecord_ParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('media.mojom.VideoDecodeStatsRecorder_StartNewRecord_Params');
...
goog.provide('media.mojom.VideoDecodeStatsRecorder_UpdateRecord_Params');
