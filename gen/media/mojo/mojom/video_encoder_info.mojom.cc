...
VideoEncoderInfo::VideoEncoderInfo(const std::string& implementation_name_in, bool supports_native_handle_in, bool has_trusted_rate_controller_in, bool is_hardware_accelerated_in,
