...
// with not having this data in traces there.
    ...
    using InitializeCallback = base::OnceCallback<void(::media::DemuxerStream::Type, ::mojo::ScopedDataPipeConsumerHandle, const absl::optional<::media::AudioDecoderConfig>&,
        const absl::optional<::media::VideoDecoderConfig>&)>;

    virtual void Initialize(InitializeCallback callback) = 0;
    using ReadCallback = base::OnceCallback<void(
        ::media::DemuxerStream::Status, ::media::mojom::DecoderBufferPtr, const absl::optional<::media::AudioDecoderConfig>&, const absl::optional<::media::VideoDecoderConfig>&)>;
