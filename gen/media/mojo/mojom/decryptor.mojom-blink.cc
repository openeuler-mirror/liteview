...
bool Decryptor_Decrypt_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    bool success = true;
    Decryptor::Status p_status = mojo::DefaultConstructTraits::CreateInstance<Decryptor::Status>();
...
bool Decryptor_DecryptAndDecodeAudio_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    bool success = true;
    Decryptor::Status p_status = mojo::DefaultConstructTraits::CreateInstance<Decryptor::Status>();
    WTF::Vector<::media::mojom::blink::AudioBufferPtr> p_audio_buffers = mojo::DefaultConstructTraits::CreateInstance<WTF::Vector<::media::mojom::blink::AudioBufferPtr>>();
...
void Decryptor_DecryptAndDecodeAudio_ProxyToResponder::Run(Decryptor::Status in_status, WTF::Vector<::media::mojom::blink::AudioBufferPtr> in_audio_buffers)
{
    ...
    TRACE_EVENT1("mojom", "Send reply media::mojom::Decryptor::DecryptAndDecodeAudio", "async_response_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("status"), in_status, "<value of type Decryptor::Status>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("audio_buffers"), in_audio_buffers, "<value of type WTF::Vector<::media::mojom::blink::AudioBufferPtr>>");
    });
#endif
...
bool Decryptor_DecryptAndDecodeVideo_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    bool success = true;
    Decryptor::Status p_status = mojo::DefaultConstructTraits::CreateInstance<Decryptor::Status>();
    ::media::mojom::blink::VideoFramePtr p_video_frame = mojo::DefaultConstructTraits::CreateInstance<::media::mojom::blink::VideoFramePtr>();
...
bool DecryptorStubDispatch::Accept(Decryptor* impl, mojo::Message* message)
{
    ...
    case internal::kDecryptor_CancelDecrypt_Name: {
        ...
        bool success = true;
        Decryptor::StreamType p_stream_type = mojo::DefaultConstructTraits::CreateInstance<Decryptor::StreamType>();
...
bool DecryptorStubDispatch::AcceptWithResponder(Decryptor* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
{
    ...
    case internal::kDecryptor_Decrypt_Name: {
        ...
        bool success = true;
        Decryptor::StreamType p_stream_type = mojo::DefaultConstructTraits::CreateInstance<Decryptor::StreamType>();
        ::media::mojom::blink::DecoderBufferPtr p_encrypted = mojo::DefaultConstructTraits::CreateInstance<::media::mojom::blink::DecoderBufferPtr>();
...
void DecryptorInterceptorForTesting::CancelDecrypt(Decryptor::StreamType stream_type) { GetForwardingInterface()->CancelDecrypt(std::move(stream_type)); }
...
void DecryptorInterceptorForTesting::ResetDecoder(Decryptor::StreamType stream_type) { GetForwardingInterface()->ResetDecoder(std::move(stream_type)); }
void DecryptorInterceptorForTesting::DeinitializeDecoder(Decryptor::StreamType stream_type) { GetForwardingInterface()->DeinitializeDecoder(std::move(stream_type)); }
    ...
    ::media::mojom::blink::DecoderBufferPtr encrypted, Decryptor::Status* out_status, WTF::Vector<::media::mojom::blink::AudioBufferPtr>* out_audio_buffers)
{
    ...
    proxy_->DecryptAndDecodeAudio(std::move(encrypted),
        base::BindOnce(
            [](base::RunLoop* loop, Decryptor::Status* out_status, WTF::Vector<::media::mojom::blink::AudioBufferPtr>* out_audio_buffers, Decryptor::Status status,
                WTF::Vector<::media::mojom::blink::AudioBufferPtr> audio_buffers) {
                *out_status = std::move(status);
