...
class LearningTaskControllerInterceptorForTesting : public LearningTaskController {
    ...
    void BeginObservation(const ::base::UnguessableToken& id, const std::vector<::media::learning::FeatureValue>& features,
        const absl::optional<::media::learning::TargetValue>& default_target) override;
...
public:
    ...
    void PredictDistribution(const std::vector<::media::learning::FeatureValue>& features, absl::optional<::media::learning::TargetHistogram>* out_predicted);
