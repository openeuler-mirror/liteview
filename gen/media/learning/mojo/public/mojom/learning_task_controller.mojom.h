...
//
//   void BeginObservation(const ::base::UnguessableToken& id, const std::vector<::media::learning::FeatureValue>& features, const absl::optional<::media::learning::TargetValue>&
