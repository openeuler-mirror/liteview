...
static_assert(sizeof(VideoCaptureObserver_OnBufferReady_Params_Data) == 24, "Bad sizeof(VideoCaptureObserver_OnBufferReady_Params_Data)");
...
static_assert(sizeof(VideoCaptureObserver_OnNewCropVersion_Params_Data) == 16, "Bad sizeof(VideoCaptureObserver_OnNewCropVersion_Params_Data)");
...
static_assert(sizeof(VideoCaptureHost_GetDeviceSupportedFormats_ResponseParams_Data) == 16, "Bad sizeof(VideoCaptureHost_GetDeviceSupportedFormats_ResponseParams_Data)");
...
static_assert(sizeof(VideoCaptureHost_GetDeviceFormatsInUse_ResponseParams_Data) == 16, "Bad sizeof(VideoCaptureHost_GetDeviceFormatsInUse_ResponseParams_Data)");
...
static_assert(sizeof(VideoCaptureHost_OnFrameDropped_Params_Data) == 24, "Bad sizeof(VideoCaptureHost_OnFrameDropped_Params_Data)");
...
public:
    ...
    inline void GetScaledBuffersDataView(mojo::ArrayDataView<::media::mojom::ReadyBufferDataView>* output);

    template <typename UserType> [[nodiscard]] bool ReadScaledBuffers(UserType* output)
    {

        auto* pointer = data_->scaled_buffers.Get();
        return mojo::internal::Deserialize<mojo::ArrayDataView<::media::mojom::ReadyBufferDataView>>(pointer, output, message_);
    }
...
public:
    ...
    VideoCaptureObserver_OnNewCropVersion_ParamsDataView(internal::VideoCaptureObserver_OnNewCropVersion_Params_Data* data, mojo::Message* message)
        : data_(data)
    {
    }
...
public:
    ...
    {
        UserType result;
        bool ret = mojo::internal::Deserialize<mojo::InterfacePtrDataView<::media::mojom::VideoCaptureObserverInterfaceBase>>(&data_->observer, &result, message_);
        DCHECK(ret);
        return result;
    }
...
public:
    ...
    VideoCaptureHost_GetDeviceSupportedFormats_ResponseParamsDataView(internal::VideoCaptureHost_GetDeviceSupportedFormats_ResponseParams_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
...
public:
    ...
    VideoCaptureHost_GetDeviceFormatsInUse_ResponseParamsDataView(internal::VideoCaptureHost_GetDeviceFormatsInUse_ResponseParams_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
...
public:
    ...
    VideoCaptureHost_OnFrameDropped_ParamsDataView(internal::VideoCaptureHost_OnFrameDropped_Params_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
...
inline void VideoCaptureObserver_OnBufferReady_ParamsDataView::GetScaledBuffersDataView(mojo::ArrayDataView<::media::mojom::ReadyBufferDataView>* output)
{
    auto pointer = data_->scaled_buffers.Get();
...
inline void VideoCaptureHost_GetDeviceSupportedFormats_ResponseParamsDataView::GetFormatsSupportedDataView(mojo::ArrayDataView<::media::mojom::VideoCaptureFormatDataView>* output)
{
    auto pointer = data_->formats_supported.Get();
...
inline void VideoCaptureHost_GetDeviceFormatsInUse_ResponseParamsDataView::GetFormatsInUseDataView(mojo::ArrayDataView<::media::mojom::VideoCaptureFormatDataView>* output)
{
    auto pointer = data_->formats_in_use.Get();
    *output = mojo::ArrayDataView<::media::mojom::VideoCaptureFormatDataView>(pointer, message_);
}
inline void VideoCaptureHost_OnFrameDropped_ParamsDataView::GetDeviceIdDataView(::mojo_base::mojom::UnguessableTokenDataView* output)
{
    auto pointer = data_->device_id.Get();
    *output = ::mojo_base::mojom::UnguessableTokenDataView(pointer, message_);
}
