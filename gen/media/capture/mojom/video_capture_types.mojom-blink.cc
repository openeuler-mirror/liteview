...
VideoCaptureFeedback::VideoCaptureFeedback(
    double resource_utilization_in, float max_framerate_fps_in, int32_t max_pixels_in, bool require_mapped_frame_in, absl::optional<WTF::Vector<::gfx::Size>> mapped_sizes_in)
    : resource_utilization(std::move(resource_utilization_in))
    , max_framerate_fps(std::move(max_framerate_fps_in))
    , max_pixels(std::move(max_pixels_in))
    , require_mapped_frame(std::move(require_mapped_frame_in))
...
VideoCaptureFeedback::VideoCaptureFeedback(double resource_utilization_in, float max_framerate_fps_in, int32_t max_pixels_in, bool require_mapped_frame_in,
    absl::optional<WTF::Vector<::gfx::Size>> mapped_sizes_in, int32_t frame_id_in, bool has_frame_id_in)
    : resource_utilization(std::move(resource_utilization_in))
    , max_framerate_fps(std::move(max_framerate_fps_in))
    , max_pixels(std::move(max_pixels_in))
    , require_mapped_frame(std::move(require_mapped_frame_in))
...
VideoCaptureDeviceInfo::VideoCaptureDeviceInfo(const ::media::VideoCaptureDeviceDescriptor& descriptor_in, WTF::Vector<::media::VideoCaptureFormat> supported_formats_in)
