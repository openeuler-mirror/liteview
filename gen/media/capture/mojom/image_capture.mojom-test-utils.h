...
public:
    ...
    void SetOptions(const std::string& source_id, PhotoSettingsPtr settings, bool* out_success);
    bool SetOptions(const std::string& source_id, PhotoSettingsPtr settings);
