...
#ifndef MEDIA_CAPTURE_MOJOM_IMAGE_CAPTURE_MOJOM_BLINK_JUMBO_H_
#define MEDIA_CAPTURE_MOJOM_IMAGE_CAPTURE_MOJOM_BLINK_JUMBO_H_
#endif
...
bool Range::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
PhotoState::PhotoState(WTF::Vector<MeteringMode> supported_white_balance_modes_in, MeteringMode current_white_balance_mode_in,
    ...
    MeteringMode current_focus_mode_in, WTF::Vector<Point2DPtr> points_of_interest_in, RangePtr exposure_compensation_in, RangePtr exposure_time_in, RangePtr color_temperature_in,
    RangePtr iso_in, RangePtr brightness_in, RangePtr contrast_in, RangePtr saturation_in, RangePtr sharpness_in, RangePtr focus_distance_in, RangePtr pan_in, RangePtr tilt_in,
...
PhotoState::PhotoState(WTF::Vector<MeteringMode> supported_white_balance_modes_in, MeteringMode current_white_balance_mode_in,
    ...
    RangePtr iso_in, RangePtr brightness_in, RangePtr contrast_in, RangePtr saturation_in, RangePtr sharpness_in, RangePtr focus_distance_in, RangePtr pan_in, RangePtr tilt_in,
    RangePtr zoom_in, bool supports_torch_in, bool torch_in, RedEyeReduction red_eye_reduction_in, RangePtr height_in, RangePtr width_in,
    WTF::Vector<FillLightMode> fill_light_mode_in, absl::optional<WTF::Vector<BackgroundBlurMode>> supported_background_blur_modes_in, BackgroundBlurMode background_blur_mode_in)
    : supported_white_balance_modes(std::move(supported_white_balance_modes_in))
    , current_white_balance_mode(std::move(current_white_balance_mode_in))
    , supported_exposure_modes(std::move(supported_exposure_modes_in))
    , current_exposure_mode(std::move(current_exposure_mode_in))
...
bool PhotoState::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
Point2D::Point2D()
    : x()
    , y()
{
...
bool Point2D::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
PhotoSettings::PhotoSettings(bool has_white_balance_mode_in, MeteringMode white_balance_mode_in, bool has_exposure_mode_in, MeteringMode exposure_mode_in, bool has_focus_mode_in,
...
bool PhotoSettings::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
Blob::Blob()
    : mime_type()
    , data()
{
...
bool Blob::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
ImageCapture::IPCStableHashFunction ImageCapture::MessageToMethodInfo_(mojo::Message& message)
{
    ...
    case internal::kImageCapture_SetOptions_Name: {
        return &ImageCapture::SetOptions_Sym::IPCStableHash;
    }
...
const char* ImageCapture::MessageToMethodName_(mojo::Message& message)
{
    ...
    if (!is_response) {
        ...
        case internal::kImageCapture_SetOptions_Name:
            return "Receive media::mojom::ImageCapture::SetOptions";
        case internal::kImageCapture_TakePhoto_Name:
        ...
        case internal::kImageCapture_SetOptions_Name:
            return "Receive reply media::mojom::ImageCapture::SetOptions";
        case internal::kImageCapture_TakePhoto_Name:
...
uint32_t ImageCapture::SetOptions_Sym::IPCStableHash()
{
    // This method's address is used for indetifiying the mojo method name after
    // symbolization. So each IPCStableHash should have a unique address.
    // We cannot use NO_CODE_FOLDING() here - it relies on the uniqueness of
    ...
    // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
    // hash instead of __LINE__.
    constexpr uint32_t kHash = base::MD5Hash32Constexpr("(Impl)media::mojom::ImageCapture::SetOptions");
    const uint32_t hash = kHash;
    base::debug::Alias(&hash);
    return hash;
}
...
class ImageCapture_SetOptions_ForwardToCallback : public mojo::MessageReceiver {
public:
    ImageCapture_SetOptions_ForwardToCallback(ImageCapture::SetOptionsCallback callback)
        : callback_(std::move(callback))
    {
    }

    ImageCapture_SetOptions_ForwardToCallback(const ImageCapture_SetOptions_ForwardToCallback&) = delete;
    ImageCapture_SetOptions_ForwardToCallback& operator=(const ImageCapture_SetOptions_ForwardToCallback&) = delete;
...
void ImageCaptureProxy::GetPhotoState(const WTF::String& in_source_id, GetPhotoStateCallback callback)
{
    ...
    mojo::Message message(internal::kImageCapture_GetPhotoState_Name, kFlags, 0, 0, nullptr);
...
void ImageCaptureProxy::SetOptions(const WTF::String& in_source_id, PhotoSettingsPtr in_settings, SetOptionsCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send media::mojom::ImageCapture::SetOptions", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("source_id"), in_source_id, "<value of type const WTF::String&>");
    ...
    mojo::Message message(internal::kImageCapture_SetOptions_Name, kFlags, 0, 0, nullptr);
    mojo::internal::MessageFragment<::media::mojom::internal::ImageCapture_SetOptions_Params_Data> params(message);
    params.Allocate();
    mojo::internal::MessageFragment<typename decltype(params->source_id)::BaseType> source_id_fragment(params.message());
    mojo::internal::Serialize<mojo::StringDataView>(in_source_id, source_id_fragment);
    params->source_id.Set(source_id_fragment.is_null() ? nullptr : source_id_fragment.data());
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
        params->source_id.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null source_id in ImageCapture.SetOptions request");
    ...
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
        params->settings.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null settings in ImageCapture.SetOptions request");

#if defined(ENABLE_IPC_FUZZER)
    message.set_interface_name(ImageCapture::Name_);
    message.set_method_name("SetOptions");
#endif
    std::unique_ptr<mojo::MessageReceiver> responder(new ImageCapture_SetOptions_ForwardToCallback(std::move(callback)));
    ::mojo::internal::SendMojoMessage(*receiver_, message, std::move(responder));
}
...
void ImageCaptureProxy::TakePhoto(const WTF::String& in_source_id, TakePhotoCallback callback)
{
    ...
    mojo::Message message(internal::kImageCapture_TakePhoto_Name, kFlags, 0, 0, nullptr);
...
bool ImageCapture_GetPhotoState_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    internal::ImageCapture_GetPhotoState_ResponseParams_Data* params = reinterpret_cast<internal::ImageCapture_GetPhotoState_ResponseParams_Data*>(message->mutable_payload());

    bool success = true;
    PhotoStatePtr p_state = mojo::DefaultConstructTraits::CreateInstance<PhotoStatePtr>();
...
class ImageCapture_SetOptions_ProxyToResponder : public ::mojo::internal::ProxyToResponder {
public:
    static ImageCapture::SetOptionsCallback CreateCallback(::mojo::Message& message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
    {
        std::unique_ptr<ImageCapture_SetOptions_ProxyToResponder> proxy(new ImageCapture_SetOptions_ProxyToResponder(message, std::move(responder)));
        return base::BindOnce(&ImageCapture_SetOptions_ProxyToResponder::Run, std::move(proxy));
    }
...
private:
    ImageCapture_SetOptions_ProxyToResponder(::mojo::Message& message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
        : ::mojo::internal::ProxyToResponder(message, std::move(responder))
    {
    }
    ...
    static void OnIsConnectedComplete(bool connected)
    {
        DCHECK(!connected) << "ImageCapture::SetOptionsCallback was destroyed without "
                           << "first either being run or its corresponding binding being closed. "
                           << "It is an error to drop response callbacks which still correspond "
                           << "to an open interface pipe.";
    }
...
bool ImageCapture_SetOptions_ForwardToCallback::Accept(mojo::Message* message)
{

    DCHECK(message->is_serialized());
    internal::ImageCapture_SetOptions_ResponseParams_Data* params = reinterpret_cast<internal::ImageCapture_SetOptions_ResponseParams_Data*>(message->mutable_payload());

    bool success = true;
    bool p_success = mojo::DefaultConstructTraits::CreateInstance<bool>();
    ImageCapture_SetOptions_ResponseParamsDataView input_data_view(params, message);
...
void ImageCapture_SetOptions_ProxyToResponder::Run(bool in_success)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send reply media::mojom::ImageCapture::SetOptions", "async_response_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
    ...
    mojo::Message message(internal::kImageCapture_SetOptions_Name, kFlags, 0, 0, nullptr);
    mojo::internal::MessageFragment<::media::mojom::internal::ImageCapture_SetOptions_ResponseParams_Data> params(message);
    params.Allocate();
...
bool ImageCapture_TakePhoto_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    DCHECK(message->is_serialized());
    internal::ImageCapture_TakePhoto_ResponseParams_Data* params = reinterpret_cast<internal::ImageCapture_TakePhoto_ResponseParams_Data*>(message->mutable_payload());

    bool success = true;
    BlobPtr p_blob = mojo::DefaultConstructTraits::CreateInstance<BlobPtr>();
...
bool ImageCaptureStubDispatch::AcceptWithResponder(ImageCapture* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
{
    ...
    case internal::kImageCapture_GetPhotoState_Name: {
        ...
        internal::ImageCapture_GetPhotoState_Params_Data* params = reinterpret_cast<internal::ImageCapture_GetPhotoState_Params_Data*>(message->mutable_payload());
    ...
    case internal::kImageCapture_SetOptions_Name: {
        ...
        internal::ImageCapture_SetOptions_Params_Data* params = reinterpret_cast<internal::ImageCapture_SetOptions_Params_Data*>(message->mutable_payload());

        bool success = true;
        WTF::String p_source_id = mojo::DefaultConstructTraits::CreateInstance<WTF::String>();
        PhotoSettingsPtr p_settings = mojo::DefaultConstructTraits::CreateInstance<PhotoSettingsPtr>();
        ImageCapture_SetOptions_ParamsDataView input_data_view(params, message);
        ...
        ImageCapture::SetOptionsCallback callback = ImageCapture_SetOptions_ProxyToResponder::CreateCallback(*message, std::move(responder));
        // A null |impl| means no implementation was bound.
        DCHECK(impl);
        impl->SetOptions(std::move(p_source_id), std::move(p_settings), std::move(callback));
        return true;
    }
    case internal::kImageCapture_TakePhoto_Name: {
...
static const mojo::internal::GenericValidationInfo kImageCaptureValidationInfo[] = {
    ...
    { &internal::ImageCapture_SetOptions_Params_Data::Validate, &internal::ImageCapture_SetOptions_ResponseParams_Data::Validate },
...
// static
bool StructTraits<::media::mojom::blink::Blob::DataView, ::media::mojom::blink::BlobPtr>::Read(::media::mojom::blink::Blob::DataView input, ::media::mojom::blink::BlobPtr* output)
{
    bool success = true;
...
void ImageCaptureInterceptorForTesting::SetOptions(const WTF::String& source_id, PhotoSettingsPtr settings, SetOptionsCallback callback)
{
...
{
    PhotoStatePtr async_wait_result = mojo::DefaultConstructTraits::CreateInstance<PhotoStatePtr>();
    GetPhotoState(std::move(source_id), &async_wait_result);
    return async_wait_result;
}

void ImageCaptureAsyncWaiter::SetOptions(const WTF::String& source_id, PhotoSettingsPtr settings, bool* out_success)
{
    base::RunLoop loop;
...
bool ImageCaptureAsyncWaiter::SetOptions(const WTF::String& source_id, PhotoSettingsPtr settings)
{
    bool async_wait_result = mojo::DefaultConstructTraits::CreateInstance<bool>();
    SetOptions(std::move(source_id), std::move(settings), &async_wait_result);
    return async_wait_result;
}
...
{
    BlobPtr async_wait_result = mojo::DefaultConstructTraits::CreateInstance<BlobPtr>();
