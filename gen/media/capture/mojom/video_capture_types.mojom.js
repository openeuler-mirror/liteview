...
(function() {
  ...
  VideoCapturePixelFormat.MAX_VALUE = 35;
  ...
  VideoCaptureError.MAX_VALUE = 135;
  ...
  VideoCaptureFrameDropReason.MAX_VALUE = 26;
  ...
  var CropRequestResult = {};
  CropRequestResult.kSuccess = 0;
  CropRequestResult.kErrorGeneric = 1;
  CropRequestResult.kUnsupportedCaptureDevice = 2;
  CropRequestResult.kNotImplemented = 3;
  CropRequestResult.kNonIncreasingCropVersion = 4;
  CropRequestResult.kInvalidCropTarget = 5;
  CropRequestResult.MIN_VALUE = 0;
  CropRequestResult.MAX_VALUE = 5;

  CropRequestResult.isKnownEnumValue = function(value) {
    switch (value) {
    case 0:
    case 1:
    case 2:
  ...
  CropRequestResult.toKnownEnumValue = function(value) {
    return value;
  };

  CropRequestResult.validate = function(enumValue) {
  ...
  exports.CropRequestResult = CropRequestResult;
