...
MailboxBufferHandleSet::MailboxBufferHandleSet(std::vector<::gpu::MailboxHolder> mailbox_holder_in)
...
// static
bool StructTraits<::media::mojom::ReadyBuffer::DataView, ::media::mojom::ReadyBufferPtr>::Read(::media::mojom::ReadyBuffer::DataView input, ::media::mojom::ReadyBufferPtr* output)
{
    bool success = true;
...
bool StructTraits<::media::mojom::MailboxBufferHandleSet::DataView, ::media::mojom::MailboxBufferHandleSetPtr>::Read(
    ::media::mojom::MailboxBufferHandleSet::DataView input, ::media::mojom::MailboxBufferHandleSetPtr* output)
{
    bool success = true;
