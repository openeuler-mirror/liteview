...
public:
    ...
    void SetOptions(const WTF::String& source_id, PhotoSettingsPtr settings, bool* out_success);
    bool SetOptions(const WTF::String& source_id, PhotoSettingsPtr settings);
