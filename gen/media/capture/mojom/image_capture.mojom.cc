...
PhotoState::PhotoState(std::vector<MeteringMode> supported_white_balance_modes_in, MeteringMode current_white_balance_mode_in,
    ...
    MeteringMode current_focus_mode_in, std::vector<Point2DPtr> points_of_interest_in, RangePtr exposure_compensation_in, RangePtr exposure_time_in, RangePtr color_temperature_in,
...
PhotoState::PhotoState(std::vector<MeteringMode> supported_white_balance_modes_in, MeteringMode current_white_balance_mode_in,
    ...
    RangePtr iso_in, RangePtr brightness_in, RangePtr contrast_in, RangePtr saturation_in, RangePtr sharpness_in, RangePtr focus_distance_in, RangePtr pan_in, RangePtr tilt_in,
    RangePtr zoom_in, bool supports_torch_in, bool torch_in, RedEyeReduction red_eye_reduction_in, RangePtr height_in, RangePtr width_in,
    std::vector<FillLightMode> fill_light_mode_in, absl::optional<std::vector<BackgroundBlurMode>> supported_background_blur_modes_in, BackgroundBlurMode background_blur_mode_in)
    : supported_white_balance_modes(std::move(supported_white_balance_modes_in))
    , current_white_balance_mode(std::move(current_white_balance_mode_in))
    , supported_exposure_modes(std::move(supported_exposure_modes_in))
    , current_exposure_mode(std::move(current_exposure_mode_in))
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
        "<value of type const absl::optional<std::vector<BackgroundBlurMode>>&>"
#else
        "<value>"
#endif // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
void ImageCaptureProxy::SetOptions(const std::string& in_source_id, PhotoSettingsPtr in_settings, SetOptionsCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
bool ImageCaptureStubDispatch::AcceptWithResponder(ImageCapture* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
{
    ...
    case internal::kImageCapture_GetPhotoState_Name: {
        ...
        bool success = true;
        std::string p_source_id = mojo::DefaultConstructTraits::CreateInstance<std::string>();
...
// static
bool StructTraits<::media::mojom::PhotoState::DataView, ::media::mojom::PhotoStatePtr>::Read(::media::mojom::PhotoState::DataView input, ::media::mojom::PhotoStatePtr* output)
{
    bool success = true;
...
// static
bool StructTraits<::media::mojom::Point2D::DataView, ::media::mojom::Point2DPtr>::Read(::media::mojom::Point2D::DataView input, ::media::mojom::Point2DPtr* output)
{
    bool success = true;
...
void ImageCaptureAsyncWaiter::SetOptions(const std::string& source_id, PhotoSettingsPtr settings, bool* out_success)
{
    base::RunLoop loop;
...
bool ImageCaptureAsyncWaiter::SetOptions(const std::string& source_id, PhotoSettingsPtr settings)
{
