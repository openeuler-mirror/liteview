...
template <> struct UnionTraits<::media::mojom::VideoCaptureResult::DataView, ::media::mojom::VideoCaptureResultPtr> {
    ...
    static ::media::mojom::VideoCaptureResult::Tag GetTag(const ::media::mojom::VideoCaptureResultPtr& input) { return input->which(); }

    static ::media::mojom::VideoCaptureState state(const ::media::mojom::VideoCaptureResultPtr& input) { return input->get_state(); }

    static ::media::VideoCaptureError error_code(const ::media::mojom::VideoCaptureResultPtr& input) { return input->get_error_code(); }
