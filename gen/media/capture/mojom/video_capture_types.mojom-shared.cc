...
std::ostream& operator<<(std::ostream& os, VideoCapturePixelFormat value) { return os << VideoCapturePixelFormatToString(value); }
...
std::ostream& operator<<(std::ostream& os, ResolutionChangePolicy value) { return os << ResolutionChangePolicyToString(value); }
...
std::ostream& operator<<(std::ostream& os, PowerLineFrequency value) { return os << PowerLineFrequencyToString(value); }
...
std::ostream& operator<<(std::ostream& os, VideoFacingMode value) { return os << VideoFacingModeToString(value); }
...
std::ostream& operator<<(std::ostream& os, VideoCaptureApi value) { return os << VideoCaptureApiToString(value); }
...
std::ostream& operator<<(std::ostream& os, VideoCaptureTransportType value) { return os << VideoCaptureTransportTypeToString(value); }
...
std::ostream& operator<<(std::ostream& os, VideoCaptureBufferType value) { return os << VideoCaptureBufferTypeToString(value); }
...
std::ostream& operator<<(std::ostream& os, VideoCaptureError value) { return os << VideoCaptureErrorToString(value); }
...
std::ostream& operator<<(std::ostream& os, VideoCaptureFrameDropReason value) { return os << VideoCaptureFrameDropReasonToString(value); }
...
std::ostream& operator<<(std::ostream& os, CropRequestResult value) { return os << CropRequestResultToString(value); }
...
bool VideoCaptureFeedback_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    ...
    if (!mojo::internal::ValidateContainer(object->mapped_sizes, validation_context, &mapped_sizes_validate_params)) {
        return false;
    }
...
bool VideoCaptureDeviceDescriptor_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    ...
    const mojo::internal::ContainerValidateParams model_id_validate_params(0, false, nullptr);
...
// static
void TraceFormatTraits<::media::mojom::VideoCaptureTransportType>::WriteIntoTrace(perfetto::TracedValue context, ::media::mojom::VideoCaptureTransportType value)
{
...
// static
void TraceFormatTraits<::media::mojom::VideoCaptureFrameDropReason>::WriteIntoTrace(perfetto::TracedValue context, ::media::mojom::VideoCaptureFrameDropReason value)
{
...
// static
void TraceFormatTraits<::media::mojom::CropRequestResult>::WriteIntoTrace(perfetto::TracedValue context, ::media::mojom::CropRequestResult value)
{
