// media/capture/mojom/video_capture_buffer.mojom-lite-for-compile.js is auto generated by mojom_bindings_generator.py, do not edit
...
goog.require('media.mojom.VideoFrameMetadata');
goog.provide('media.mojom.VideoFrameInfoSpec');
/**
...
goog.provide('media.mojom.ReadyBufferSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('media.mojom.MailboxBufferHandleSetSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('media.mojom.VideoBufferHandleSpec');
/**
 * @const { {$:!mojo.internal.MojomType} }
 * @export
 */
...
goog.provide('media.mojom.VideoFrameInfo');
...
goog.provide('media.mojom.ReadyBuffer');
...
goog.provide('media.mojom.MailboxBufferHandleSet');
...
goog.provide('media.mojom.VideoBufferHandle');
mojo.internal.Union(
