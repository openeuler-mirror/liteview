...
class BLINK_PLATFORM_EXPORT VideoCaptureObserverInterceptorForTesting : public VideoCaptureObserver {
    ...
    void OnBufferReady(::media::mojom::blink::ReadyBufferPtr buffer, WTF::Vector<::media::mojom::blink::ReadyBufferPtr> scaled_buffers) override;
...
public:
    ...
    void GetDeviceFormatsInUse(const ::base::UnguessableToken& device_id, const ::base::UnguessableToken& session_id, WTF::Vector<::media::VideoCaptureFormat>* out_formats_in_use);
