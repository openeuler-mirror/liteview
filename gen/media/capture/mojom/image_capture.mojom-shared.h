...
inline bool IsKnownEnumValue(BackgroundBlurMode value) { return internal::BackgroundBlurMode_Data::IsKnownValue(static_cast<int32_t>(value)); }
...
inline bool IsKnownEnumValue(MeteringMode value) { return internal::MeteringMode_Data::IsKnownValue(static_cast<int32_t>(value)); }
...
inline bool IsKnownEnumValue(RedEyeReduction value) { return internal::RedEyeReduction_Data::IsKnownValue(static_cast<int32_t>(value)); }
...
inline bool IsKnownEnumValue(FillLightMode value) { return internal::FillLightMode_Data::IsKnownValue(static_cast<int32_t>(value)); }
...
public:
    ...
    double current() const { return data_->current; }
    double step() const { return data_->step; }
...
public:
    ...
    MeteringMode current_exposure_mode() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::media::mojom::MeteringMode>(data_->current_exposure_mode)); }
    ...
    MeteringMode current_focus_mode() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::media::mojom::MeteringMode>(data_->current_focus_mode)); }
    ...
    bool supports_torch() const { return data_->supports_torch; }
    bool torch() const { return data_->torch; }
    ...
    RedEyeReduction red_eye_reduction() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::media::mojom::RedEyeReduction>(data_->red_eye_reduction)); }
...
public:
    ...
    bool is_null() const { return !data_; }
    bool has_white_balance_mode() const { return data_->has_white_balance_mode; }
    ...
    MeteringMode white_balance_mode() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::media::mojom::MeteringMode>(data_->white_balance_mode)); }
    bool has_exposure_mode() const { return data_->has_exposure_mode; }
    template <typename UserType> [[nodiscard]] bool ReadExposureMode(UserType* output) const
    {
        auto data_value = data_->exposure_mode;
        return mojo::internal::Deserialize<::media::mojom::MeteringMode>(data_value, output);
    }
    MeteringMode exposure_mode() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::media::mojom::MeteringMode>(data_->exposure_mode)); }
    bool has_focus_mode() const { return data_->has_focus_mode; }
    template <typename UserType> [[nodiscard]] bool ReadFocusMode(UserType* output) const
    {
        auto data_value = data_->focus_mode;
        return mojo::internal::Deserialize<::media::mojom::MeteringMode>(data_value, output);
    }
    MeteringMode focus_mode() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::media::mojom::MeteringMode>(data_->focus_mode)); }
    inline void GetPointsOfInterestDataView(mojo::ArrayDataView<Point2DDataView>* output);
    ...
    bool has_exposure_compensation() const { return data_->has_exposure_compensation; }
    double exposure_compensation() const { return data_->exposure_compensation; }
    bool has_exposure_time() const { return data_->has_exposure_time; }
    double exposure_time() const { return data_->exposure_time; }
    bool has_color_temperature() const { return data_->has_color_temperature; }
    double color_temperature() const { return data_->color_temperature; }
    bool has_iso() const { return data_->has_iso; }
    double iso() const { return data_->iso; }
    bool has_brightness() const { return data_->has_brightness; }
    double brightness() const { return data_->brightness; }
    bool has_contrast() const { return data_->has_contrast; }
    double contrast() const { return data_->contrast; }
    bool has_saturation() const { return data_->has_saturation; }
    double saturation() const { return data_->saturation; }
    bool has_sharpness() const { return data_->has_sharpness; }
    double sharpness() const { return data_->sharpness; }
    bool has_focus_distance() const { return data_->has_focus_distance; }
    double focus_distance() const { return data_->focus_distance; }
    bool has_pan() const { return data_->has_pan; }
    double pan() const { return data_->pan; }
    bool has_tilt() const { return data_->has_tilt; }
    double tilt() const { return data_->tilt; }
    bool has_zoom() const { return data_->has_zoom; }
    double zoom() const { return data_->zoom; }
    bool has_torch() const { return data_->has_torch; }
    bool torch() const { return data_->torch; }
    bool has_fill_light_mode() const { return data_->has_fill_light_mode; }
    ...
    FillLightMode fill_light_mode() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::media::mojom::FillLightMode>(data_->fill_light_mode)); }
    bool has_width() const { return data_->has_width; }
    double width() const { return data_->width; }
    bool has_height() const { return data_->has_height; }
    double height() const { return data_->height; }
    bool has_red_eye_reduction() const { return data_->has_red_eye_reduction; }
    bool red_eye_reduction() const { return data_->red_eye_reduction; }
...
template <typename MaybeConstUserType> struct Serializer<::media::mojom::PhotoStateDataView, MaybeConstUserType> {
    ...
    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::media::mojom::internal::PhotoState_Data>& fragment)
    {
        ...
        mojo::internal::MessageFragment<typename decltype(fragment->supported_white_balance_modes)::BaseType> supported_white_balance_modes_fragment(fragment.message());
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
            fragment->supported_white_balance_modes.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null supported_white_balance_modes in PhotoState struct");
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
            fragment->supported_exposure_modes.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null supported_exposure_modes in PhotoState struct");
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
            fragment->supported_focus_modes.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null supported_focus_modes in PhotoState struct");
        ...
        mojo::internal::Serialize<mojo::ArrayDataView<::media::mojom::Point2DDataView>>(in_points_of_interest, points_of_interest_fragment, &points_of_interest_validate_params);
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
            fragment->exposure_compensation.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null exposure_compensation in PhotoState struct");
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->iso.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null iso in PhotoState struct");
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->brightness.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null brightness in PhotoState struct");
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->contrast.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null contrast in PhotoState struct");
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->saturation.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null saturation in PhotoState struct");
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->sharpness.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null sharpness in PhotoState struct");
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->pan.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null pan in PhotoState struct");
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->tilt.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null tilt in PhotoState struct");
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->zoom.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null zoom in PhotoState struct");
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->height.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null height in PhotoState struct");
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->width.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null width in PhotoState struct");
        ...
        mojo::internal::Serialize<mojo::ArrayDataView<::media::mojom::FillLightMode>>(in_fill_light_mode, fill_light_mode_fragment, &fill_light_mode_validate_params);
        ...
        mojo::internal::MessageFragment<typename decltype(fragment->supported_background_blur_modes)::BaseType> supported_background_blur_modes_fragment(fragment.message());
        ...
        fragment->supported_background_blur_modes.Set(supported_background_blur_modes_fragment.is_null() ? nullptr : supported_background_blur_modes_fragment.data());
...
template <typename MaybeConstUserType> struct Serializer<::media::mojom::PhotoSettingsDataView, MaybeConstUserType> {
    ...
    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::media::mojom::internal::PhotoSettings_Data>& fragment)
    {
        ...
        fragment->points_of_interest.Set(points_of_interest_fragment.is_null() ? nullptr : points_of_interest_fragment.data());
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
            fragment->points_of_interest.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null points_of_interest in PhotoSettings struct");
...
template <typename MaybeConstUserType> struct Serializer<::media::mojom::BlobDataView, MaybeConstUserType> {
    ...
    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::media::mojom::internal::Blob_Data>& fragment)
    {
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->mime_type.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null mime_type in Blob struct");
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->data.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null data in Blob struct");
    }
