...
template <> struct MojomTypeTraits<::media::mojom::MailboxBufferHandleSetDataView> {
...
public:
    ...
    bool is_premapped() const { return data_->is_premapped; }
...
public:
    ...
    MailboxBufferHandleSetDataView(internal::MailboxBufferHandleSet_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
...
public:
    ...
    template <typename UserType> [[nodiscard]] bool ReadReadOnlyShmemRegion(UserType* output) const
    {
        ...
        return mojo::internal::Deserialize<::mojo_base::mojom::ReadOnlySharedMemoryRegionDataView>(data_->data.f_read_only_shmem_region.Get(), output, message_);
    }
    bool is_mailbox_handles() const { return data_->tag == Tag::kMailboxHandles; }
    inline void GetMailboxHandlesDataView(MailboxBufferHandleSetDataView* output) const;

    template <typename UserType> [[nodiscard]] bool ReadMailboxHandles(UserType* output) const
    {

        CHECK(is_mailbox_handles());
        return mojo::internal::Deserialize<::media::mojom::MailboxBufferHandleSetDataView>(data_->data.f_mailbox_handles.Get(), output, message_);
    }
...
template <typename MaybeConstUserType> struct Serializer<::media::mojom::VideoFrameInfoDataView, MaybeConstUserType> {
    ...
    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::media::mojom::internal::VideoFrameInfo_Data>& fragment)
    {
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->metadata.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null metadata in VideoFrameInfo struct");
...
template <typename MaybeConstUserType> struct Serializer<::media::mojom::ReadyBufferDataView, MaybeConstUserType> {
    ...
    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::media::mojom::internal::ReadyBuffer_Data>& fragment)
    {
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->info.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null info in ReadyBuffer struct");
    }
...
template <typename MaybeConstUserType> struct Serializer<::media::mojom::MailboxBufferHandleSetDataView, MaybeConstUserType> {
    using UserType = typename std::remove_const<MaybeConstUserType>::type;
    using Traits = StructTraits<::media::mojom::MailboxBufferHandleSetDataView, UserType>;

    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::media::mojom::internal::MailboxBufferHandleSet_Data>& fragment)
    {
        if (CallIsNullIfExists<Traits>(input))
            return;
        fragment.Allocate();
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
            fragment->mailbox_holder.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null mailbox_holder in MailboxBufferHandleSet struct");
    }

    static bool Deserialize(::media::mojom::internal::MailboxBufferHandleSet_Data* input, UserType* output, Message* message)
    {
        if (!input)
            return CallSetToNullIfExists<Traits>(output);
...
template <typename MaybeConstUserType> struct Serializer<::media::mojom::VideoBufferHandleDataView, MaybeConstUserType> {
    ...
    static void Serialize(MaybeConstUserType& input, MessageFragment<::media::mojom::internal::VideoBufferHandle_Data>& fragment, bool inlined)
    {
        ...
        case ::media::mojom::VideoBufferHandleDataView::Tag::kMailboxHandles: {
            decltype(Traits::mailbox_handles(input)) in_mailbox_handles = Traits::mailbox_handles(input);
            mojo::internal::MessageFragment<typename decltype(fragment->data.f_mailbox_handles)::BaseType> value_fragment(fragment.message());
            mojo::internal::Serialize<::media::mojom::MailboxBufferHandleSetDataView>(in_mailbox_handles, value_fragment);
            MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
                value_fragment.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null mailbox_handles in VideoBufferHandle union");
            fragment->data.f_mailbox_handles.Set(value_fragment.is_null() ? nullptr : value_fragment.data());
            break;
        }
...
inline void MailboxBufferHandleSetDataView::GetMailboxHolderDataView(mojo::ArrayDataView<::gpu::mojom::MailboxHolderDataView>* output)
{
    auto pointer = data_->mailbox_holder.Get();
...
inline void VideoBufferHandleDataView::GetMailboxHandlesDataView(MailboxBufferHandleSetDataView* output) const
{
    CHECK(is_mailbox_handles());
