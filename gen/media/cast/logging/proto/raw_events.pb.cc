...
public:
    ...
    static void set_has_product(HasBits* has_bits) { (*has_bits)[0] |= 1u; }
    static void set_has_product_version(HasBits* has_bits) { (*has_bits)[0] |= 2u; }
    static void set_has_os(HasBits* has_bits) { (*has_bits)[0] |= 4u; }
};
    ...
    , _has_bits_(from._has_bits_)
{
    ...
    if (from._internal_has_product()) {
        product_.Set(from._internal_product(), GetArenaForAllocation());
    }
    ...
    if (from._internal_has_product_version()) {
        product_version_.Set(from._internal_product_version(), GetArenaForAllocation());
    }
    os_.InitDefault();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    ...
    if (from._internal_has_os()) {
        os_.Set(from._internal_os(), GetArenaForAllocation());
    }
...
void GeneralDescription::SetCachedSize(int size) const { _cached_size_.Set(size); }
...
void GeneralDescription::CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from) { MergeFrom(*::_pbi::DownCast<const GeneralDescription*>(&from)); }
...
bool GeneralDescription::IsInitialized() const { return true; }
...
void GeneralDescription::InternalSwap(GeneralDescription* other)
{
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(&product_, lhs_arena, &other->product_, rhs_arena);
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(&product_version_, lhs_arena, &other->product_version_, rhs_arena);
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(&os_, lhs_arena, &other->os_, rhs_arena);
}

std::string GeneralDescription::GetTypeName() const { return "media.cast.proto.GeneralDescription"; }
// ===================================================================

class LogMetadata::_Internal {
public:
    using HasBits = decltype(std::declval<LogMetadata>()._has_bits_);
    static void set_has_is_audio(HasBits* has_bits) { (*has_bits)[0] |= 4u; }
    static void set_has_first_rtp_timestamp(HasBits* has_bits) { (*has_bits)[0] |= 8u; }
    static void set_has_num_frame_events(HasBits* has_bits) { (*has_bits)[0] |= 16u; }
    static void set_has_num_packet_events(HasBits* has_bits) { (*has_bits)[0] |= 32u; }
    static void set_has_reference_timestamp_ms_at_unix_epoch(HasBits* has_bits) { (*has_bits)[0] |= 64u; }
    static void set_has_extra_data(HasBits* has_bits) { (*has_bits)[0] |= 1u; }
    static const ::media::cast::proto::GeneralDescription& general_description(const LogMetadata* msg);
    static void set_has_general_description(HasBits* has_bits) { (*has_bits)[0] |= 2u; }
};

const ::media::cast::proto::GeneralDescription& LogMetadata::_Internal::general_description(const LogMetadata* msg) { return *msg->general_description_; }
    ...
    , _has_bits_(from._has_bits_)
{
    ...
    if (from._internal_has_extra_data()) {
        extra_data_.Set(from._internal_extra_data(), GetArenaForAllocation());
    }
    ...
    ::memcpy(&is_audio_, &from.is_audio_,
        static_cast<size_t>(reinterpret_cast<char*>(&reference_timestamp_ms_at_unix_epoch_) - reinterpret_cast<char*>(&is_audio_)) + sizeof(reference_timestamp_ms_at_unix_epoch_));
...
inline void LogMetadata::SharedCtor()
{
    ...
    extra_data_.Set("", GetArenaForAllocation());
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
    ::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(reinterpret_cast<char*>(&general_description_) - reinterpret_cast<char*>(this)), 0,
        static_cast<size_t>(reinterpret_cast<char*>(&reference_timestamp_ms_at_unix_epoch_) - reinterpret_cast<char*>(&general_description_))
            + sizeof(reference_timestamp_ms_at_unix_epoch_));
}
...
void LogMetadata::Clear()
{
    ...
    if (cached_has_bits & 0x0000007cu) {
        ::memset(&is_audio_, 0,
            static_cast<size_t>(reinterpret_cast<char*>(&reference_timestamp_ms_at_unix_epoch_) - reinterpret_cast<char*>(&is_audio_))
                + sizeof(reference_timestamp_ms_at_unix_epoch_));
    }
    _has_bits_.Clear();
    _internal_metadata_.Clear<std::string>();
...
size_t LogMetadata::ByteSizeLong() const
{
    ...
    if (cached_has_bits & 0x0000007fu) {
        ...
        // optional .media.cast.proto.GeneralDescription general_description = 7;
        if (cached_has_bits & 0x00000002u) {
            total_size += 1 + ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::MessageSize(*general_description_);
        }
...
void LogMetadata::CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from) { MergeFrom(*::_pbi::DownCast<const LogMetadata*>(&from)); }
...
void LogMetadata::InternalSwap(LogMetadata* other)
{
    ...
    _internal_metadata_.InternalSwap(&other->_internal_metadata_);
    swap(_has_bits_[0], other->_has_bits_[0]);
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(&extra_data_, lhs_arena, &other->extra_data_, rhs_arena);
    ::PROTOBUF_NAMESPACE_ID::internal::memswap<PROTOBUF_FIELD_OFFSET(LogMetadata, reference_timestamp_ms_at_unix_epoch_)
        + sizeof(LogMetadata::reference_timestamp_ms_at_unix_epoch_) - PROTOBUF_FIELD_OFFSET(LogMetadata, general_description_)>(
        reinterpret_cast<char*>(&general_description_), reinterpret_cast<char*>(&other->general_description_));
}

std::string LogMetadata::GetTypeName() const { return "media.cast.proto.LogMetadata"; }
// ===================================================================

class AggregatedFrameEvent::_Internal {
public:
    using HasBits = decltype(std::declval<AggregatedFrameEvent>()._has_bits_);
    static void set_has_relative_rtp_timestamp(HasBits* has_bits) { (*has_bits)[0] |= 1u; }
    static void set_has_encoded_frame_size(HasBits* has_bits) { (*has_bits)[0] |= 2u; }
    static void set_has_delay_millis(HasBits* has_bits) { (*has_bits)[0] |= 4u; }
    static void set_has_key_frame(HasBits* has_bits) { (*has_bits)[0] |= 8u; }
    static void set_has_target_bitrate(HasBits* has_bits) { (*has_bits)[0] |= 16u; }
    static void set_has_width(HasBits* has_bits) { (*has_bits)[0] |= 32u; }
    static void set_has_height(HasBits* has_bits) { (*has_bits)[0] |= 64u; }
    static void set_has_encoder_cpu_percent_utilized(HasBits* has_bits) { (*has_bits)[0] |= 128u; }
    static void set_has_idealized_bitrate_percent_utilized(HasBits* has_bits) { (*has_bits)[0] |= 256u; }
};
    ...
    , event_timestamp_ms_(from.event_timestamp_ms_)
{
    ...
    ::memcpy(&relative_rtp_timestamp_, &from.relative_rtp_timestamp_,
        static_cast<size_t>(reinterpret_cast<char*>(&idealized_bitrate_percent_utilized_) - reinterpret_cast<char*>(&relative_rtp_timestamp_))
            + sizeof(idealized_bitrate_percent_utilized_));
    // @@protoc_insertion_point(copy_constructor:media.cast.proto.AggregatedFrameEvent)
}

inline void AggregatedFrameEvent::SharedCtor()
{
    ::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(reinterpret_cast<char*>(&relative_rtp_timestamp_) - reinterpret_cast<char*>(this)), 0,
        static_cast<size_t>(reinterpret_cast<char*>(&idealized_bitrate_percent_utilized_) - reinterpret_cast<char*>(&relative_rtp_timestamp_))
            + sizeof(idealized_bitrate_percent_utilized_));
}
...
inline void AggregatedFrameEvent::SharedDtor() { GOOGLE_DCHECK(GetArenaForAllocation() == nullptr); }

void AggregatedFrameEvent::SetCachedSize(int size) const { _cached_size_.Set(size); }
...
void AggregatedFrameEvent::Clear()
{
    ...
    if (cached_has_bits & 0x000000ffu) {
        ::memset(&relative_rtp_timestamp_, 0,
            static_cast<size_t>(reinterpret_cast<char*>(&encoder_cpu_percent_utilized_) - reinterpret_cast<char*>(&relative_rtp_timestamp_))
                + sizeof(encoder_cpu_percent_utilized_));
    }
    idealized_bitrate_percent_utilized_ = 0;
    _has_bits_.Clear();
    _internal_metadata_.Clear<std::string>();
...
uint8_t* AggregatedFrameEvent::_InternalSerialize(uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const
{
    ...
    // repeated .media.cast.proto.EventType event_type = 2 [packed = true];
    {
        ...
        if (byte_size > 0) {
            target = stream->WriteEnumPacked(2, event_type_, byte_size, target);
        }
    }
...
size_t AggregatedFrameEvent::ByteSizeLong() const
{
    ...
    // repeated .media.cast.proto.EventType event_type = 2 [packed = true];
    {
        ...
        _event_type_cached_byte_size_.store(cached_size, std::memory_order_relaxed);
        total_size += data_size;
    }

    // repeated int64 event_timestamp_ms = 3 [packed = true];
    {
        size_t data_size = ::_pbi::WireFormatLite::Int64Size(this->event_timestamp_ms_);
        if (data_size > 0) {
            total_size += 1 + ::_pbi::WireFormatLite::Int32Size(static_cast<int32_t>(data_size));
        }
        int cached_size = ::_pbi::ToCachedSize(data_size);
        _event_timestamp_ms_cached_byte_size_.store(cached_size, std::memory_order_relaxed);
        total_size += data_size;
    }
...
void AggregatedFrameEvent::CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from) { MergeFrom(*::_pbi::DownCast<const AggregatedFrameEvent*>(&from)); }
...
bool AggregatedFrameEvent::IsInitialized() const { return true; }
...
void AggregatedFrameEvent::InternalSwap(AggregatedFrameEvent* other)
{
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::memswap<PROTOBUF_FIELD_OFFSET(AggregatedFrameEvent, idealized_bitrate_percent_utilized_)
        + sizeof(AggregatedFrameEvent::idealized_bitrate_percent_utilized_) - PROTOBUF_FIELD_OFFSET(AggregatedFrameEvent, relative_rtp_timestamp_)>(
        reinterpret_cast<char*>(&relative_rtp_timestamp_), reinterpret_cast<char*>(&other->relative_rtp_timestamp_));
}

std::string AggregatedFrameEvent::GetTypeName() const { return "media.cast.proto.AggregatedFrameEvent"; }
// ===================================================================

class BasePacketEvent::_Internal {
public:
    using HasBits = decltype(std::declval<BasePacketEvent>()._has_bits_);
    static void set_has_packet_id(HasBits* has_bits) { (*has_bits)[0] |= 1u; }
    static void set_has_size(HasBits* has_bits) { (*has_bits)[0] |= 2u; }
};
...
{
    _internal_metadata_.MergeFrom<std::string>(from._internal_metadata_);
    ::memcpy(&packet_id_, &from.packet_id_, static_cast<size_t>(reinterpret_cast<char*>(&size_) - reinterpret_cast<char*>(&packet_id_)) + sizeof(size_));
    // @@protoc_insertion_point(copy_constructor:media.cast.proto.BasePacketEvent)
}

inline void BasePacketEvent::SharedCtor()
{
    ::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(reinterpret_cast<char*>(&packet_id_) - reinterpret_cast<char*>(this)), 0,
        static_cast<size_t>(reinterpret_cast<char*>(&size_) - reinterpret_cast<char*>(&packet_id_)) + sizeof(size_));
}
...
inline void BasePacketEvent::SharedDtor() { GOOGLE_DCHECK(GetArenaForAllocation() == nullptr); }

void BasePacketEvent::SetCachedSize(int size) const { _cached_size_.Set(size); }
...
void BasePacketEvent::Clear()
{
    ...
    cached_has_bits = _has_bits_[0];
    if (cached_has_bits & 0x00000003u) {
        ::memset(&packet_id_, 0, static_cast<size_t>(reinterpret_cast<char*>(&size_) - reinterpret_cast<char*>(&packet_id_)) + sizeof(size_));
    }
    _has_bits_.Clear();
    _internal_metadata_.Clear<std::string>();
}
...
void BasePacketEvent::CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from) { MergeFrom(*::_pbi::DownCast<const BasePacketEvent*>(&from)); }
...
bool BasePacketEvent::IsInitialized() const { return true; }
...
void BasePacketEvent::InternalSwap(BasePacketEvent* other)
{
    ...
    event_type_.InternalSwap(&other->event_type_);
    event_timestamp_ms_.InternalSwap(&other->event_timestamp_ms_);
    ::PROTOBUF_NAMESPACE_ID::internal::memswap<PROTOBUF_FIELD_OFFSET(BasePacketEvent, size_) + sizeof(BasePacketEvent::size_) - PROTOBUF_FIELD_OFFSET(BasePacketEvent, packet_id_)>(
        reinterpret_cast<char*>(&packet_id_), reinterpret_cast<char*>(&other->packet_id_));
}

std::string BasePacketEvent::GetTypeName() const { return "media.cast.proto.BasePacketEvent"; }
// ===================================================================
...
inline void AggregatedPacketEvent::SharedCtor() { relative_rtp_timestamp_ = 0u; }
...
inline void AggregatedPacketEvent::SharedDtor() { GOOGLE_DCHECK(GetArenaForAllocation() == nullptr); }

void AggregatedPacketEvent::SetCachedSize(int size) const { _cached_size_.Set(size); }
...
void AggregatedPacketEvent::CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from) { MergeFrom(*::_pbi::DownCast<const AggregatedPacketEvent*>(&from)); }
...
bool AggregatedPacketEvent::IsInitialized() const { return true; }
...
std::string AggregatedPacketEvent::GetTypeName() const { return "media.cast.proto.AggregatedPacketEvent"; }
