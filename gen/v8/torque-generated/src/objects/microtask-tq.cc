...
bool IsMicrotask_NonInline(HeapObject o) { return o.IsMicrotask(); }

#ifdef VERIFY_HEAP

template <> void TorqueGeneratedMicrotask<Microtask, Struct>::MicrotaskVerify(Isolate* isolate) { TorqueGeneratedClassVerifiers::MicrotaskVerify(Microtask::cast(*this), isolate); }

#endif // VERIFY_HEAP
// https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/microtask.tq?l=9&c=1
bool IsCallbackTask_NonInline(HeapObject o) { return o.IsCallbackTask(); }
...
bool IsCallableTask_NonInline(HeapObject o) { return o.IsCallableTask(); }
