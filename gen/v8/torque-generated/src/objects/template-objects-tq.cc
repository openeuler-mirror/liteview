...
bool IsCachedTemplateObject_NonInline(HeapObject o) { return o.IsCachedTemplateObject(); }
...
bool IsTemplateObjectDescription_NonInline(HeapObject o) { return o.IsTemplateObjectDescription(); }
