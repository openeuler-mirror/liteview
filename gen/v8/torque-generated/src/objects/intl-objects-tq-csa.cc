...
TNode<Uint8T> IntlAsciiCollationWeightL1_0(compiler::CodeAssemblerState* state_, TNode<Uint8T> p_c, compiler::CodeAssemblerLabel* label__Bailout)
{
    ...
    if (block0.is_used()) {
        ...
        CodeStubAssembler(state_).StaticAssert(TNode<BoolT> { tmp0 },
            "static_assert(kIntlAsciiCollationWeightsLength == 256) at https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/intl-objects.tq?l=14&c=3");
    ...
    if (block0.is_used()) {
        ...
        tmp0 = FromConstexpr_bool_constexpr_bool_0(state_,
            (CodeStubAssembler(state_).ConstexprInt31Equal(
                Intl::kAsciiCollationWeightsLength, (FromConstexpr_constexpr_int31_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x100ull))))));
        CodeStubAssembler(state_).StaticAssert(TNode<BoolT> { tmp0 },
            "static_assert(kIntlAsciiCollationWeightsLength == 256) at https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/intl-objects.tq?l=23&c=3");
...
TF_BUILTIN(StringFastLocaleCompare, CodeStubAssembler)
{
    ...
    if (block16.is_used()) {
        ...
        std::tie(tmp16, tmp17, tmp18) = Subslice_char8_0(state_,
            TorqueStructSlice_char8_ConstReference_char8_0 { TNode<Object> { tmp13 }, TNode<IntPtrT> { tmp14 }, TNode<IntPtrT> { tmp15 }, TorqueStructUnsafe_0 {} },
    ...
    if (block24.is_used()) {
        ...
        std::tie(tmp25, tmp26, tmp27) = Subslice_char16_0(state_,
            TorqueStructSlice_char16_ConstReference_char16_0 { TNode<Object> { tmp22 }, TNode<IntPtrT> { tmp23 }, TNode<IntPtrT> { tmp24 }, TorqueStructUnsafe_0 {} },
    ...
    if (block44.is_used()) {
        ...
        std::tie(tmp53, tmp54, tmp55) = Subslice_char8_0(state_,
            TorqueStructSlice_char8_ConstReference_char8_0 { TNode<Object> { tmp50 }, TNode<IntPtrT> { tmp51 }, TNode<IntPtrT> { tmp52 }, TorqueStructUnsafe_0 {} },
    ...
    if (block52.is_used()) {
        ...
        std::tie(tmp64, tmp65, tmp66) = Subslice_char16_0(state_,
            TorqueStructSlice_char16_ConstReference_char16_0 { TNode<Object> { tmp61 }, TNode<IntPtrT> { tmp62 }, TNode<IntPtrT> { tmp63 }, TorqueStructUnsafe_0 {} },
    ...
    if (block69.is_used()) {
        ...
        std::tie(tmp82, tmp83, tmp84) = Subslice_char8_0(state_,
            TorqueStructSlice_char8_ConstReference_char8_0 { TNode<Object> { tmp79 }, TNode<IntPtrT> { tmp80 }, TNode<IntPtrT> { tmp81 }, TorqueStructUnsafe_0 {} },
    ...
    if (block77.is_used()) {
        ...
        std::tie(tmp91, tmp92, tmp93) = Subslice_char16_0(state_,
            TorqueStructSlice_char16_ConstReference_char16_0 { TNode<Object> { tmp88 }, TNode<IntPtrT> { tmp89 }, TNode<IntPtrT> { tmp90 }, TorqueStructUnsafe_0 {} },
    ...
    if (block97.is_used()) {
        ...
        std::tie(tmp119, tmp120, tmp121) = Subslice_char8_0(state_,
            TorqueStructSlice_char8_ConstReference_char8_0 { TNode<Object> { tmp116 }, TNode<IntPtrT> { tmp117 }, TNode<IntPtrT> { tmp118 }, TorqueStructUnsafe_0 {} },
    ...
    if (block105.is_used()) {
        ...
        std::tie(tmp130, tmp131, tmp132) = Subslice_char16_0(state_,
            TorqueStructSlice_char16_ConstReference_char16_0 { TNode<Object> { tmp127 }, TNode<IntPtrT> { tmp128 }, TNode<IntPtrT> { tmp129 }, TorqueStructUnsafe_0 {} },
    ...
    if (block61.is_used()) {
        ...
        tmp134 = LocaleCompareFastPath_char8_char8_0(state_,
            TorqueStructSlice_char8_ConstReference_char8_0 { TNode<Object> { phi_bb61_5 }, TNode<IntPtrT> { phi_bb61_6 }, TNode<IntPtrT> { phi_bb61_7 }, TorqueStructUnsafe_0 {} },
            TorqueStructSlice_char8_ConstReference_char8_0 { TNode<Object> { phi_bb61_8 }, TNode<IntPtrT> { phi_bb61_9 }, TNode<IntPtrT> { phi_bb61_10 }, TorqueStructUnsafe_0 {} },
            &label135);
    ...
    if (block112.is_used()) {
        ca_.Bind(&block112, &phi_bb112_5, &phi_bb112_6, &phi_bb112_7, &phi_bb112_8, &phi_bb112_9, &phi_bb112_10, &phi_bb112_11, &phi_bb112_12, &phi_bb112_13, &phi_bb112_14,
            &phi_bb112_15, &phi_bb112_16);
        ca_.Goto(&block2);
    }
    ...
    if (block111.is_used()) {
        ca_.Bind(&block111, &phi_bb111_5, &phi_bb111_6, &phi_bb111_7, &phi_bb111_8, &phi_bb111_9, &phi_bb111_10, &phi_bb111_11, &phi_bb111_12, &phi_bb111_13, &phi_bb111_14,
            &phi_bb111_15, &phi_bb111_16);
    ...
    if (block59.is_used()) {
        ...
        tmp136 = LocaleCompareFastPath_char8_char16_0(state_,
            TorqueStructSlice_char8_ConstReference_char8_0 { TNode<Object> { phi_bb59_5 }, TNode<IntPtrT> { phi_bb59_6 }, TNode<IntPtrT> { phi_bb59_7 }, TorqueStructUnsafe_0 {} },
    ...
    if (block114.is_used()) {
        ca_.Bind(&block114, &phi_bb114_5, &phi_bb114_6, &phi_bb114_7, &phi_bb114_8, &phi_bb114_9, &phi_bb114_10, &phi_bb114_11, &phi_bb114_12, &phi_bb114_13, &phi_bb114_14,
            &phi_bb114_15, &phi_bb114_16);
        ca_.Goto(&block2);
    }
    ...
    if (block113.is_used()) {
        ca_.Bind(&block113, &phi_bb113_5, &phi_bb113_6, &phi_bb113_7, &phi_bb113_8, &phi_bb113_9, &phi_bb113_10, &phi_bb113_11, &phi_bb113_12, &phi_bb113_13, &phi_bb113_14,
            &phi_bb113_15, &phi_bb113_16);
    ...
    if (block126.is_used()) {
        ...
        std::tie(tmp152, tmp153, tmp154) = Subslice_char8_0(state_,
            TorqueStructSlice_char8_ConstReference_char8_0 { TNode<Object> { tmp149 }, TNode<IntPtrT> { tmp150 }, TNode<IntPtrT> { tmp151 }, TorqueStructUnsafe_0 {} },
    ...
    if (block134.is_used()) {
        ...
        std::tie(tmp161, tmp162, tmp163) = Subslice_char16_0(state_,
            TorqueStructSlice_char16_ConstReference_char16_0 { TNode<Object> { tmp158 }, TNode<IntPtrT> { tmp159 }, TNode<IntPtrT> { tmp160 }, TorqueStructUnsafe_0 {} },
    ...
    if (block154.is_used()) {
        ...
        std::tie(tmp189, tmp190, tmp191) = Subslice_char8_0(state_,
            TorqueStructSlice_char8_ConstReference_char8_0 { TNode<Object> { tmp186 }, TNode<IntPtrT> { tmp187 }, TNode<IntPtrT> { tmp188 }, TorqueStructUnsafe_0 {} },
    ...
    if (block162.is_used()) {
        ...
        std::tie(tmp200, tmp201, tmp202) = Subslice_char16_0(state_,
            TorqueStructSlice_char16_ConstReference_char16_0 { TNode<Object> { tmp197 }, TNode<IntPtrT> { tmp198 }, TNode<IntPtrT> { tmp199 }, TorqueStructUnsafe_0 {} },
    ...
    if (block118.is_used()) {
        ...
        tmp204 = LocaleCompareFastPath_char16_char8_0(state_,
            ...
            &label205);
        ca_.Goto(&block168, phi_bb118_5, phi_bb118_6, phi_bb118_7, phi_bb118_8, phi_bb118_9, phi_bb118_10, phi_bb118_5, phi_bb118_6, phi_bb118_7, phi_bb118_8, phi_bb118_9,
            phi_bb118_10);
        if (label205.is_used()) {
            ca_.Bind(&label205);
            ca_.Goto(&block169, phi_bb118_5, phi_bb118_6, phi_bb118_7, phi_bb118_8, phi_bb118_9, phi_bb118_10, phi_bb118_5, phi_bb118_6, phi_bb118_7, phi_bb118_8, phi_bb118_9,
                phi_bb118_10);
        }
    }
    ...
    if (block169.is_used()) {
        ca_.Bind(&block169, &phi_bb169_5, &phi_bb169_6, &phi_bb169_7, &phi_bb169_8, &phi_bb169_9, &phi_bb169_10, &phi_bb169_11, &phi_bb169_12, &phi_bb169_13, &phi_bb169_14,
            &phi_bb169_15, &phi_bb169_16);
        ca_.Goto(&block2);
    }
    ...
    if (block168.is_used()) {
        ca_.Bind(&block168, &phi_bb168_5, &phi_bb168_6, &phi_bb168_7, &phi_bb168_8, &phi_bb168_9, &phi_bb168_10, &phi_bb168_11, &phi_bb168_12, &phi_bb168_13, &phi_bb168_14,
            &phi_bb168_15, &phi_bb168_16);
    ...
    if (block116.is_used()) {
        ...
        tmp206 = LocaleCompareFastPath_char16_char16_0(state_,
            ...
            &label207);
        ca_.Goto(&block170, phi_bb116_5, phi_bb116_6, phi_bb116_7, phi_bb116_8, phi_bb116_9, phi_bb116_10, phi_bb116_5, phi_bb116_6, phi_bb116_7, phi_bb116_8, phi_bb116_9,
            phi_bb116_10);
        if (label207.is_used()) {
            ca_.Bind(&label207);
            ca_.Goto(&block171, phi_bb116_5, phi_bb116_6, phi_bb116_7, phi_bb116_8, phi_bb116_9, phi_bb116_10, phi_bb116_5, phi_bb116_6, phi_bb116_7, phi_bb116_8, phi_bb116_9,
                phi_bb116_10);
        }
    }
    ...
    if (block171.is_used()) {
        ca_.Bind(&block171, &phi_bb171_5, &phi_bb171_6, &phi_bb171_7, &phi_bb171_8, &phi_bb171_9, &phi_bb171_10, &phi_bb171_11, &phi_bb171_12, &phi_bb171_13, &phi_bb171_14,
            &phi_bb171_15, &phi_bb171_16);
        ca_.Goto(&block2);
    }
    ...
    if (block170.is_used()) {
        ca_.Bind(&block170, &phi_bb170_5, &phi_bb170_6, &phi_bb170_7, &phi_bb170_8, &phi_bb170_9, &phi_bb170_10, &phi_bb170_11, &phi_bb170_12, &phi_bb170_13, &phi_bb170_14,
            &phi_bb170_15, &phi_bb170_16);
    ...
    if (block2.is_used()) {
        ca_.Bind(&block2);
        tmp208 = CodeStubAssembler(state_).Call(
            TNode<Context> { parameter0 }, TNode<Object> { parameter1 }, TNode<Object> { parameter2 }, TNode<Object> { parameter3 }, TNode<Object> { parameter4 });
    ...
    TorqueStructSlice_char8_ConstReference_char8_0 p_right, compiler::CodeAssemblerLabel* label_Bailout)
{
    ...
    if (block37.is_used()) {
        ...
        CheckEmptyOr1Byte_0(state_,
            TorqueStructSliceIterator_char8_ConstReference_char8_0 { TNode<Object> { p_left.object }, TNode<IntPtrT> { tmp12 }, TNode<IntPtrT> { tmp3 }, TorqueStructUnsafe_0 {} },
            &label30);
        ca_.Goto(&block38);
        if (label30.is_used()) {
            ca_.Bind(&label30);
    ...
    if (block38.is_used()) {
        ...
        CheckEmptyOr1Byte_0(state_,
            TorqueStructSliceIterator_char8_ConstReference_char8_0 { TNode<Object> { p_right.object }, TNode<IntPtrT> { tmp23 }, TNode<IntPtrT> { tmp5 }, TorqueStructUnsafe_0 {} },
            &label31);
        ca_.Goto(&block40);
        if (label31.is_used()) {
            ca_.Bind(&label31);
    ...
    compiler::CodeAssemblerState* state_, TorqueStructSlice_char8_ConstReference_char8_0 p_a, TorqueStructSlice_char8_ConstReference_char8_0 p_b)
{
    ...
    if (block14.is_used()) {
        ...
        ca_.Branch(tmp30, &block12, std::vector<compiler::Node*> { phi_bb14_7, phi_bb14_8, phi_bb14_9, phi_bb14_10, phi_bb14_11, phi_bb14_12, phi_bb14_13, phi_bb14_14 }, &block13,
    ...
    if (block12.is_used()) {
        ...
        ca_.Branch(tmp33, &block17, std::vector<compiler::Node*> { phi_bb12_7, phi_bb12_8, phi_bb12_9, phi_bb12_10, phi_bb12_11, phi_bb12_12, phi_bb12_13, phi_bb12_14 }, &block18,
    ...
    if (block19.is_used()) {
        ...
        ca_.Branch(phi_bb19_16, &block15, std::vector<compiler::Node*> { phi_bb19_7, phi_bb19_8, phi_bb19_9, phi_bb19_10, phi_bb19_11, phi_bb19_12, phi_bb19_13, phi_bb19_14 },
            &block16, std::vector<compiler::Node*> { phi_bb19_7, phi_bb19_8, phi_bb19_9, phi_bb19_10, phi_bb19_11, phi_bb19_12, phi_bb19_13, phi_bb19_14 });
    }
    ...
    if (block16.is_used()) {
        ...
        std::tie(tmp40, tmp41) = AddOffset_char8_0(
            state_, TorqueStructReference_char8_0 { TNode<Object> { phi_bb16_7 }, TNode<IntPtrT> { phi_bb16_8 }, TorqueStructUnsafe_0 {} }, TNode<IntPtrT> { tmp39 })
                                     .Flatten();
        tmp42 = FromConstexpr_intptr_constexpr_IntegerLiteral_0(state_, IntegerLiteral(true, 0x1ull));
        std::tie(tmp43, tmp44) = AddOffset_char8_0(
            state_, TorqueStructReference_char8_0 { TNode<Object> { phi_bb16_11 }, TNode<IntPtrT> { phi_bb16_12 }, TorqueStructUnsafe_0 {} }, TNode<IntPtrT> { tmp42 })
                                     .Flatten();
        tmp45 = FromConstexpr_intptr_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x1ull));
        std::tie(tmp46, tmp47) = AddOffset_char8_0(
            state_, TorqueStructReference_char8_0 { TNode<Object> { phi_bb16_9 }, TNode<IntPtrT> { phi_bb16_10 }, TorqueStructUnsafe_0 {} }, TNode<IntPtrT> { tmp45 })
                                     .Flatten();
        tmp48 = FromConstexpr_intptr_constexpr_IntegerLiteral_0(state_, IntegerLiteral(true, 0x1ull));
        std::tie(tmp49, tmp50) = AddOffset_char8_0(
            state_, TorqueStructReference_char8_0 { TNode<Object> { phi_bb16_13 }, TNode<IntPtrT> { phi_bb16_14 }, TorqueStructUnsafe_0 {} }, TNode<IntPtrT> { tmp48 })
                                     .Flatten();
    ...
    if (block16.is_used()) {
        ...
        std::tie(tmp43, tmp44) = AddOffset_char8_0(
            state_, TorqueStructReference_char8_0 { TNode<Object> { phi_bb16_11 }, TNode<IntPtrT> { phi_bb16_12 }, TorqueStructUnsafe_0 {} }, TNode<IntPtrT> { tmp42 })
                                     .Flatten();
        tmp45 = FromConstexpr_intptr_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x1ull));
        std::tie(tmp46, tmp47) = AddOffset_char16_0(
            state_, TorqueStructReference_char16_0 { TNode<Object> { phi_bb16_9 }, TNode<IntPtrT> { phi_bb16_10 }, TorqueStructUnsafe_0 {} }, TNode<IntPtrT> { tmp45 })
                                     .Flatten();
        tmp48 = FromConstexpr_intptr_constexpr_IntegerLiteral_0(state_, IntegerLiteral(true, 0x1ull));
        std::tie(tmp49, tmp50) = AddOffset_char16_0(
            state_, TorqueStructReference_char16_0 { TNode<Object> { phi_bb16_13 }, TNode<IntPtrT> { phi_bb16_14 }, TorqueStructUnsafe_0 {} }, TNode<IntPtrT> { tmp48 })
                                     .Flatten();
        ca_.Goto(&block14, tmp40, tmp41, tmp46, tmp47, tmp43, tmp44, tmp49, tmp50);
    }
    ...
    compiler::CodeAssemblerState* state_, TorqueStructSlice_char16_ConstReference_char16_0 p_a, TorqueStructSlice_char8_ConstReference_char8_0 p_b)
{
    ...
    if (block16.is_used()) {
        ca_.Bind(&block16, &phi_bb16_7, &phi_bb16_8, &phi_bb16_9, &phi_bb16_10, &phi_bb16_11, &phi_bb16_12, &phi_bb16_13, &phi_bb16_14);
        tmp39 = FromConstexpr_intptr_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x1ull));
        std::tie(tmp40, tmp41) = AddOffset_char16_0(
            state_, TorqueStructReference_char16_0 { TNode<Object> { phi_bb16_7 }, TNode<IntPtrT> { phi_bb16_8 }, TorqueStructUnsafe_0 {} }, TNode<IntPtrT> { tmp39 })
                                     .Flatten();
        tmp42 = FromConstexpr_intptr_constexpr_IntegerLiteral_0(state_, IntegerLiteral(true, 0x1ull));
        std::tie(tmp43, tmp44) = AddOffset_char16_0(
            state_, TorqueStructReference_char16_0 { TNode<Object> { phi_bb16_11 }, TNode<IntPtrT> { phi_bb16_12 }, TorqueStructUnsafe_0 {} }, TNode<IntPtrT> { tmp42 })
                                     .Flatten();
        tmp45 = FromConstexpr_intptr_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x1ull));
        std::tie(tmp46, tmp47) = AddOffset_char8_0(
            state_, TorqueStructReference_char8_0 { TNode<Object> { phi_bb16_9 }, TNode<IntPtrT> { phi_bb16_10 }, TorqueStructUnsafe_0 {} }, TNode<IntPtrT> { tmp45 })
