...
bool IsFixedArrayBase_NonInline(HeapObject o) { return o.IsFixedArrayBase(); }

#ifdef VERIFY_HEAP

template <> void TorqueGeneratedFixedArrayBase<FixedArrayBase, HeapObject>::FixedArrayBaseVerify(Isolate* isolate)
{
...
bool IsFixedArray_NonInline(HeapObject o) { return o.IsFixedArray(); }

#ifdef VERIFY_HEAP

template <> void TorqueGeneratedFixedArray<FixedArray, FixedArrayBase>::FixedArrayVerify(Isolate* isolate)
{
...
bool IsWeakFixedArray_NonInline(HeapObject o) { return o.IsWeakFixedArray(); }

#ifdef VERIFY_HEAP

template <> void TorqueGeneratedWeakFixedArray<WeakFixedArray, HeapObject>::WeakFixedArrayVerify(Isolate* isolate)
{
...
bool IsFixedDoubleArray_NonInline(HeapObject o) { return o.IsFixedDoubleArray(); }

#ifdef VERIFY_HEAP

template <> void TorqueGeneratedFixedDoubleArray<FixedDoubleArray, FixedArrayBase>::FixedDoubleArrayVerify(Isolate* isolate)
{
...
bool IsByteArray_NonInline(HeapObject o) { return o.IsByteArray(); }

#ifdef VERIFY_HEAP

template <> void TorqueGeneratedByteArray<ByteArray, FixedArrayBase>::ByteArrayVerify(Isolate* isolate)
{
...
bool IsArrayList_NonInline(HeapObject o) { return o.IsArrayList(); }

#ifdef VERIFY_HEAP

template <> void TorqueGeneratedArrayList<ArrayList, FixedArray>::ArrayListVerify(Isolate* isolate)
{
...
bool IsTemplateList_NonInline(HeapObject o) { return o.IsTemplateList(); }

#ifdef VERIFY_HEAP

template <> void TorqueGeneratedTemplateList<TemplateList, FixedArray>::TemplateListVerify(Isolate* isolate)
{
...
bool IsWeakArrayList_NonInline(HeapObject o) { return o.IsWeakArrayList(); }
