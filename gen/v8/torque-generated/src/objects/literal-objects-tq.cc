...
bool IsArrayBoilerplateDescription_NonInline(HeapObject o) { return o.IsArrayBoilerplateDescription(); }
...
bool IsRegExpBoilerplateDescription_NonInline(HeapObject o) { return o.IsRegExpBoilerplateDescription(); }
