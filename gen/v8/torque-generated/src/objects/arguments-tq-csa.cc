    ...
    compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<IntPtrT> p_formalParameterCount, TNode<IntPtrT> p_mappedCount)
{
    ...
    if (block0.is_used()) {
        ...
        tmp4 = ca_.UncheckedCast<BoolT>(
            CodeStubAssembler(state_).DecodeWord32FromWord<base::BitField<bool, 27, 1, uintptr_t>>(ca_.UncheckedCast<WordT>(ca_.BitcastTaggedToWordForTagAndSmiBits(tmp2))));
    ...
    if (block3.is_used()) {
        ...
        tmp7 = ca_.UncheckedCast<Uint32T>(CodeStubAssembler(state_).DecodeWord32FromWord<base::BitField<VariableAllocationInfo, 8, 2, uintptr_t>>(
            ca_.UncheckedCast<WordT>(ca_.BitcastTaggedToWordForTagAndSmiBits(tmp2))));
...
TorqueStructParameterValueIterator_0 NewParameterValueIterator_0(compiler::CodeAssemblerState* state_, TNode<IntPtrT> p_mappedCount, TorqueStructArguments p_arguments)
{
    ...
    return TorqueStructParameterValueIterator_0 { TNode<IntPtrT> { p_mappedCount },
        TorqueStructArguments {
            TNode<RawPtrT> { p_arguments.frame }, TNode<RawPtrT> { p_arguments.base }, TNode<IntPtrT> { p_arguments.length }, TNode<IntPtrT> { p_arguments.actual_count } },
    ...
    if (block0.is_used()) {
        ...
        tmp6 = NewFixedArray_ArgumentsIterator_0(state_, TNode<IntPtrT> { p_argumentCount },
            TorqueStructArgumentsIterator_0 {
                TorqueStructArguments { TNode<RawPtrT> { tmp1 }, TNode<RawPtrT> { tmp2 }, TNode<IntPtrT> { tmp3 }, TNode<IntPtrT> { tmp4 } }, TNode<IntPtrT> { tmp5 } });
...
TNode<FixedArray> NewRestArgumentsElements_0(compiler::CodeAssemblerState* state_, TNode<RawPtrT> p_frame, TNode<IntPtrT> p_formalParameterCount, TNode<IntPtrT> p_argumentCount)
{
    ...
    if (block4.is_used()) {
        ...
        tmp7 = NewFixedArray_ArgumentsIterator_0(state_, TNode<IntPtrT> { phi_bb4_3 },
            TorqueStructArgumentsIterator_0 { TorqueStructArguments { TNode<RawPtrT> { tmp3 }, TNode<RawPtrT> { tmp4 }, TNode<IntPtrT> { tmp5 }, TNode<IntPtrT> { tmp6 } },
...
TNode<FixedArray> NewStrictArgumentsElements_0(compiler::CodeAssemblerState* state_, TNode<RawPtrT> p_frame, TNode<IntPtrT> p_argumentCount)
{
    ...
    if (block0.is_used()) {
        ...
        tmp5 = NewFixedArray_ArgumentsIterator_0(state_, TNode<IntPtrT> { p_argumentCount },
            TorqueStructArgumentsIterator_0 {
                TorqueStructArguments { TNode<RawPtrT> { tmp0 }, TNode<RawPtrT> { tmp1 }, TNode<IntPtrT> { tmp2 }, TNode<IntPtrT> { tmp3 } }, TNode<IntPtrT> { tmp4 } });
        ca_.Goto(&block2);
    }
...
TNode<FixedArray> NewSloppyArgumentsElements_0(compiler::CodeAssemblerState* state_, TNode<RawPtrT> p_frame, TNode<IntPtrT> p_formalParameterCount, TNode<IntPtrT> p_argumentCount)
{
    ...
    if (block2.is_used()) {
        ...
        tmp7 = NewFixedArray_ArgumentsIterator_0(state_, TNode<IntPtrT> { p_argumentCount },
            TorqueStructArgumentsIterator_0 {
                TorqueStructArguments { TNode<RawPtrT> { tmp0 }, TNode<RawPtrT> { tmp1 }, TNode<IntPtrT> { tmp2 }, TNode<IntPtrT> { tmp3 } }, TNode<IntPtrT> { tmp6 } });
    ...
    if (block3.is_used()) {
        ...
        tmp15 = NewFixedArray_ParameterValueIterator_0(state_, TNode<IntPtrT> { p_argumentCount },
            TorqueStructParameterValueIterator_0 { TNode<IntPtrT> { tmp9 },
                TorqueStructArguments { TNode<RawPtrT> { tmp10 }, TNode<RawPtrT> { tmp11 }, TNode<IntPtrT> { tmp12 }, TNode<IntPtrT> { tmp13 } }, TNode<IntPtrT> { tmp14 } });
...
TNode<Object> SloppyArgumentsStore_0(
    compiler::CodeAssemblerState* state_, TNode<JSObject> p_receiver, TNode<Object> p_keyObject, TNode<Object> p_value, compiler::CodeAssemblerLabel* label_Bailout)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    if (block5.is_used()) {
        ...
        InitializeFieldsFromIterator_Object_ParameterValueIterator_0(state_,
            ...
            TorqueStructParameterValueIterator_0 { TNode<IntPtrT> { p_it.mapped_count },
                TorqueStructArguments { TNode<RawPtrT> { p_it.arguments.frame }, TNode<RawPtrT> { p_it.arguments.base }, TNode<IntPtrT> { p_it.arguments.length },
                    TNode<IntPtrT> { p_it.arguments.actual_count } },
...
void InitializeFieldsFromIterator_Smi_OR_TheHole_ParameterMapIterator_0(
    compiler::CodeAssemblerState* state_, TorqueStructSlice_Smi_OR_TheHole_MutableReference_Smi_OR_TheHole_0 p_target, TorqueStructParameterMapIterator_0 p_originIterator)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/arguments.tq?l=87&c=10
void InitializeFieldsFromIterator_Smi_OR_TheHole_ConstantIterator_TheHole_0(
    compiler::CodeAssemblerState* state_, TorqueStructSlice_Smi_OR_TheHole_MutableReference_Smi_OR_TheHole_0 p_target, TorqueStructConstantIterator_TheHole_0 p_originIterator)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
