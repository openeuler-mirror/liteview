...
bool IsJSFunctionOrBoundFunctionOrWrappedFunction_NonInline(HeapObject o) { return o.IsJSFunctionOrBoundFunctionOrWrappedFunction(); }

#ifdef VERIFY_HEAP

template <>
void TorqueGeneratedJSFunctionOrBoundFunctionOrWrappedFunction<JSFunctionOrBoundFunctionOrWrappedFunction, JSObject>::JSFunctionOrBoundFunctionOrWrappedFunctionVerify(
    Isolate* isolate)
{
...
bool IsJSWrappedFunction_NonInline(HeapObject o) { return o.IsJSWrappedFunction(); }
...
bool IsJSBoundFunction_NonInline(HeapObject o) { return o.IsJSBoundFunction(); }
...
bool IsJSFunction_NonInline(HeapObject o) { return o.IsJSFunction(); }
