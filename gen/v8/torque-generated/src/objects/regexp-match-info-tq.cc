...
bool IsRegExpMatchInfo_NonInline(HeapObject o) { return o.IsRegExpMatchInfo(); }

#ifdef VERIFY_HEAP

template <> void TorqueGeneratedRegExpMatchInfo<RegExpMatchInfo, FixedArray>::RegExpMatchInfoVerify(Isolate* isolate)
{
