...
bool IsHeapNumber_NonInline(HeapObject o) { return o.IsHeapNumber(); }

#ifdef VERIFY_HEAP

template <> void TorqueGeneratedHeapNumber<HeapNumber, PrimitiveHeapObject>::HeapNumberVerify(Isolate* isolate)
{
