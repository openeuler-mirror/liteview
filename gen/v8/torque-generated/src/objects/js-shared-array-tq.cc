...
bool IsJSSharedArray_NonInline(HeapObject o) { return o.IsJSSharedArray(); }

#ifdef VERIFY_HEAP

template <> void TorqueGeneratedJSSharedArray<JSSharedArray, JSObject>::JSSharedArrayVerify(Isolate* isolate)
{
