...
TNode<SmallOrderedHashSet> AllocateSmallOrderedHashSet_0(compiler::CodeAssemblerState* state_, TNode<IntPtrT> p_capacity)
{
    ...
    if (block0.is_used()) {
        ...
        InitializeFieldsFromIterator_uint8_ConstantIterator_uint8_0(state_,
            TorqueStructSlice_uint8_MutableReference_uint8_0 { TNode<Object> { tmp30 }, TNode<IntPtrT> { tmp37 }, TNode<IntPtrT> { tmp12 }, TorqueStructUnsafe_0 {} },
        ...
        InitializeFieldsFromIterator_JSReceiver_OR_Undefined_OR_Null_OR_False_OR_True_OR_Symbol_OR_String_OR_BigInt_OR_HeapNumber_OR_Smi_OR_TheHole_ConstantIterator_TheHole_0(
            ...
            TorqueStructSlice_JSReceiver_OR_Undefined_OR_Null_OR_False_OR_True_OR_Symbol_OR_String_OR_BigInt_OR_HeapNumber_OR_Smi_OR_TheHole_MutableReference_JSReceiver_OR_Undefined_OR_Null_OR_False_OR_True_OR_Symbol_OR_String_OR_BigInt_OR_HeapNumber_OR_Smi_OR_TheHole_0 {
                TNode<Object> { tmp30 }, TNode<IntPtrT> { tmp38 }, TNode<IntPtrT> { tmp18 }, TorqueStructUnsafe_0 {} },
            TorqueStructConstantIterator_TheHole_0 { TNode<Oddball> { tmp7 } });
        InitializeFieldsFromIterator_uint8_ConstantIterator_uint8_0(state_,
            TorqueStructSlice_uint8_MutableReference_uint8_0 { TNode<Object> { tmp30 }, TNode<IntPtrT> { tmp20 }, TNode<IntPtrT> { tmp21 }, TorqueStructUnsafe_0 {} },
            TorqueStructConstantIterator_uint8_0 { TNode<Uint8T> { tmp9 } });
        InitializeFieldsFromIterator_uint8_ConstantIterator_uint8_0(state_,
            TorqueStructSlice_uint8_MutableReference_uint8_0 { TNode<Object> { tmp30 }, TNode<IntPtrT> { tmp22 }, TNode<IntPtrT> { tmp26 }, TorqueStructUnsafe_0 {} },
...
TNode<SmallOrderedHashMap> AllocateSmallOrderedHashMap_0(compiler::CodeAssemblerState* state_, TNode<IntPtrT> p_capacity)
{
    ...
    if (block0.is_used()) {
        ...
        InitializeFieldsFromIterator_uint8_ConstantIterator_uint8_0(state_,
            TorqueStructSlice_uint8_MutableReference_uint8_0 { TNode<Object> { tmp32 }, TNode<IntPtrT> { tmp39 }, TNode<IntPtrT> { tmp14 }, TorqueStructUnsafe_0 {} },
            TorqueStructConstantIterator_uint8_0 { TNode<Uint8T> { tmp5 } });
        ...
        InitializeFieldsFromIterator_HashMapEntry_ConstantIterator_HashMapEntry_0(state_,
            TorqueStructSlice_HashMapEntry_MutableReference_HashMapEntry_0 { TNode<Object> { tmp32 }, TNode<IntPtrT> { tmp40 }, TNode<IntPtrT> { tmp20 }, TorqueStructUnsafe_0 {} },
            TorqueStructConstantIterator_HashMapEntry_0 { TorqueStructHashMapEntry_0 { TNode<Object> { tmp8 }, TNode<Object> { tmp9 } } });
        InitializeFieldsFromIterator_uint8_ConstantIterator_uint8_0(state_,
            TorqueStructSlice_uint8_MutableReference_uint8_0 { TNode<Object> { tmp32 }, TNode<IntPtrT> { tmp22 }, TNode<IntPtrT> { tmp23 }, TorqueStructUnsafe_0 {} },
            TorqueStructConstantIterator_uint8_0 { TNode<Uint8T> { tmp11 } });
        InitializeFieldsFromIterator_uint8_ConstantIterator_uint8_0(state_,
            TorqueStructSlice_uint8_MutableReference_uint8_0 { TNode<Object> { tmp32 }, TNode<IntPtrT> { tmp24 }, TNode<IntPtrT> { tmp28 }, TorqueStructUnsafe_0 {} },
...
FieldSliceSmallOrderedHashSetDataTable_0(compiler::CodeAssemblerState* state_, TNode<SmallOrderedHashSet> p_o)
{
    ...
    if (block0.is_used()) {
        ...
        std::tie(tmp7, tmp8, tmp9) = NewMutableSlice_JSReceiver_OR_Undefined_OR_Null_OR_False_OR_True_OR_Symbol_OR_String_OR_BigInt_OR_HeapNumber_OR_Smi_OR_TheHole_0(
...
TNode<Object> LoadSmallOrderedHashSetDataTable_0(compiler::CodeAssemblerState* state_, TNode<SmallOrderedHashSet> p_o, TNode<IntPtrT> p_i)
{
    ...
    if (block6.is_used()) {
        ...
        tmp7 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT> { tmp1 }, TNode<IntPtrT> { tmp6 });
        std::tie(tmp8, tmp9) = NewReference_JSReceiver_OR_Undefined_OR_Null_OR_False_OR_True_OR_Symbol_OR_String_OR_BigInt_OR_HeapNumber_OR_Smi_OR_TheHole_0(
    ...
    compiler::CodeAssemblerState* state_, TNode<SmallOrderedNameDictionary> p_o)
{
    ...
    ca_.Bind(&block2);
    return TorqueStructSlice_NameDictionaryEntry_MutableReference_NameDictionaryEntry_0 { TNode<Object> { tmp7 }, TNode<IntPtrT> { tmp8 }, TNode<IntPtrT> { tmp9 },
    ...
    TorqueStructConstantIterator_TheHole_0 p_originIterator)
{
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        tmp0 = TimesSizeOf_JSReceiver_OR_Undefined_OR_Null_OR_False_OR_True_OR_Symbol_OR_String_OR_BigInt_OR_HeapNumber_OR_Smi_OR_TheHole_0(
    ...
    if (block10.is_used()) {
        ca_.Bind(&block10, &phi_bb10_5);
        std::tie(tmp4, tmp5) = NewReference_JSReceiver_OR_Undefined_OR_Null_OR_False_OR_True_OR_Symbol_OR_String_OR_BigInt_OR_HeapNumber_OR_Smi_OR_TheHole_0(
...
void InitializeFieldsFromIterator_HashMapEntry_ConstantIterator_HashMapEntry_0(
    compiler::CodeAssemblerState* state_, TorqueStructSlice_HashMapEntry_MutableReference_HashMapEntry_0 p_target, TorqueStructConstantIterator_HashMapEntry_0 p_originIterator)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    compiler::CodeAssemblerState* state_, TNode<Object> p_object, TNode<IntPtrT> p_offset, TNode<IntPtrT> p_length)
{
    ...
    ca_.Bind(&block2);
    return TorqueStructSlice_NameDictionaryEntry_MutableReference_NameDictionaryEntry_0 { TNode<Object> { tmp0 }, TNode<IntPtrT> { tmp1 }, TNode<IntPtrT> { tmp2 },
        TorqueStructUnsafe_0 {} };
}
