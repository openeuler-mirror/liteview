...
bool IsJSArrayIterator_NonInline(HeapObject o) { return o.IsJSArrayIterator(); }
...
bool IsJSArray_NonInline(HeapObject o) { return o.IsJSArray(); }

#ifdef VERIFY_HEAP

template <> void TorqueGeneratedJSArray<JSArray, JSObject>::JSArrayVerify(Isolate* isolate) { TorqueGeneratedClassVerifiers::JSArrayVerify(JSArray::cast(*this), isolate); }
