...
TNode<Number> FindIndexAllElements_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TorqueStructAttachedJSTypedArrayAndLength_0 p_attachedArrayAndLength,
...
TF_BUILTIN(TypedArrayPrototypeFindIndex, CodeStubAssembler)
{
    ...
    if (block11.is_used()) {
        ...
        tmp13 = FindIndexAllElements_0(state_, TNode<Context> { parameter0 },
            TorqueStructAttachedJSTypedArrayAndLength_0 { TNode<JSTypedArray> { tmp2 }, TNode<UintPtrT> { tmp3 } }, TNode<JSReceiver> { tmp7 }, TNode<Object> { tmp12 });
