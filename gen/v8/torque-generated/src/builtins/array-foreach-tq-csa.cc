...
TF_BUILTIN(ArrayForEachLoopEagerDeoptContinuation, CodeStubAssembler)
{
    ...
    if (block15.is_used()) {
        ...
        tmp10
            = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtin::kArrayForEachLoopContinuation), parameter0, tmp0, tmp2, parameter3, tmp8, tmp0, tmp4, tmp6, tmp9);
...
TNode<Object> FastArrayForEach_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSReceiver> p_o, TNode<Number> p_len, TNode<JSReceiver> p_callbackfn,
    TNode<Object> p_thisArg, compiler::CodeAssemblerLabel* label_Bailout, compiler::TypedCodeAssemblerVariable<Smi>* label_Bailout_parameter_0)
{
    ...
    if (block23.is_used()) {
        ...
        ca_.Branch(
            tmp8, &block28, std::vector<compiler::Node*> { phi_bb23_5, phi_bb23_5, phi_bb23_5 }, &block29, std::vector<compiler::Node*> { phi_bb23_5, phi_bb23_5, phi_bb23_5 });
    }
    ...
    if (block27.is_used()) {
        ...
        tmp23 = CodeStubAssembler(state_).Call(TNode<Context> { p_context }, TNode<Object> { p_callbackfn }, TNode<Object> { p_thisArg }, TNode<Object> { phi_bb27_18 },
            TNode<Object> { phi_bb27_5 }, TNode<Object> { tmp16 });
...
TF_BUILTIN(ArrayForEach, CodeStubAssembler)
{
    ...
    if (block5.is_used()) {
        ...
        tmp12 = FastArrayForEach_0(
            state_, TNode<Context> { parameter0 }, TNode<JSReceiver> { tmp1 }, TNode<Number> { tmp2 }, TNode<JSReceiver> { tmp7 }, TNode<Object> { tmp10 }, &label13, &tmp14);
        ca_.Goto(&block9);
        if (label13.is_used()) {
            ca_.Bind(&label13);
            ca_.Goto(&block10);
    ...
    if (block10.is_used()) {
        ...
        tmp17 = ca_.CallStub<Object>(
            Builtins::CallableFor(ca_.isolate(), Builtin::kArrayForEachLoopContinuation), parameter0, tmp1, tmp7, tmp10, tmp15, tmp1, tmp14.value(), tmp2, tmp16);
    ...
    if (block2.is_used()) {
        ...
        tmp19 = CodeStubAssembler(state_).GetArgumentValue(TorqueStructArguments { TNode<RawPtrT> { torque_arguments.frame }, TNode<RawPtrT> { torque_arguments.base },
                                                               TNode<IntPtrT> { torque_arguments.length }, TNode<IntPtrT> { torque_arguments.actual_count } },
            TNode<IntPtrT> { tmp18 });
