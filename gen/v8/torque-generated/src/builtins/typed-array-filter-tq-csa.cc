...
TF_BUILTIN(TypedArrayPrototypeFilter, CodeStubAssembler)
{
    ...
    if (block22.is_used()) {
        ...
        ca_.Branch(tmp23, &block24, std::vector<compiler::Node*> { phi_bb22_11, phi_bb22_12, phi_bb22_13, phi_bb22_15, phi_bb22_17, phi_bb22_19, phi_bb22_20 }, &block25,
            std::vector<compiler::Node*> { phi_bb22_11, phi_bb22_12, phi_bb22_13, phi_bb22_15, phi_bb22_17, phi_bb22_19, phi_bb22_20 });
    }
    ...
    if (block25.is_used()) {
        ...
        tmp25 = TORQUE_CAST(CodeStubAssembler(state_).CallBuiltinPointer(
            Builtins::CallableFor(ca_.isolate(), ExampleBuiltinForTorqueFunctionPointerType(1)).descriptor(), tmp18, TNode<Object>(), tmp24, phi_bb25_17));
    ...
    if (block17.is_used()) {
        ...
        tmp28 = CodeStubAssembler(state_).Call(
            TNode<Context> { parameter0 }, TNode<Object> { tmp7 }, TNode<Object> { tmp12 }, TNode<Object> { phi_bb17_18 }, TNode<Object> { tmp27 }, TNode<Object> { tmp16 });
    ...
    if (block37.is_used()) {
        ...
        ca_.Branch(tmp45, &block55, std::vector<compiler::Node*> { phi_bb37_17, phi_bb37_13, phi_bb37_13, phi_bb37_13, phi_bb37_13 }, &block56,
