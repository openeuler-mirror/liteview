...
TNode<Object> ReduceRightAllElements_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TorqueStructAttachedJSTypedArrayAndLength_0 p_attachedArrayAndLength,
...
TF_BUILTIN(TypedArrayPrototypeReduceRight, CodeStubAssembler)
{
    ...
    if (block15.is_used()) {
        ...
        tmp16 = ReduceRightAllElements_0(state_, TNode<Context> { parameter0 },
            TorqueStructAttachedJSTypedArrayAndLength_0 { TNode<JSTypedArray> { tmp2 }, TNode<UintPtrT> { tmp3 } }, TNode<JSReceiver> { tmp7 }, TNode<Object> { phi_bb15_10 });
