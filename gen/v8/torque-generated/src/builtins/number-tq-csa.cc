...
TNode<String> NumberToStringSmi_0(compiler::CodeAssemblerState* state_, TNode<Int32T> p_x, TNode<Int32T> p_radix, compiler::CodeAssemblerLabel* label_Slow)
{
    ...
    if (block29.is_used()) {
        ...
        ca_.Branch(tmp26, &block27, std::vector<compiler::Node*> { phi_bb29_3, phi_bb29_4, phi_bb29_5, phi_bb29_7 }, &block28,
            std::vector<compiler::Node*> { phi_bb29_3, phi_bb29_4, phi_bb29_5, phi_bb29_7 });
    }
    ...
    if (block27.is_used()) {
        ...
        ca_.Branch(tmp34, &block34, std::vector<compiler::Node*> { phi_bb27_4, phi_bb27_5, phi_bb27_7, phi_bb27_7, phi_bb27_7, phi_bb27_7, phi_bb27_7 }, &block35,
            std::vector<compiler::Node*> { phi_bb27_4, phi_bb27_5, phi_bb27_7, phi_bb27_7, phi_bb27_7, phi_bb27_7, phi_bb27_7 });
    }
    ...
    if (block34.is_used()) {
        ...
        std::tie(tmp39, tmp40)
            = UnsafeConstCast_char8_0(state_, TorqueStructReference_char8_0 { TNode<Object> { tmp37 }, TNode<IntPtrT> { tmp38 }, TorqueStructUnsafe_0 {} }).Flatten();
    ...
    if (block28.is_used()) {
        ...
        ca_.Branch(tmp1, &block38, std::vector<compiler::Node*> { phi_bb28_3, phi_bb28_4, phi_bb28_5, phi_bb28_7 }, &block39,
            std::vector<compiler::Node*> { phi_bb28_3, phi_bb28_4, phi_bb28_5, phi_bb28_7 });
    }
    ...
    if (block38.is_used()) {
        ...
        ca_.Branch(tmp51, &block50, std::vector<compiler::Node*> { phi_bb38_3, phi_bb38_4, phi_bb38_5, phi_bb38_7 }, &block51,
            std::vector<compiler::Node*> { phi_bb38_3, phi_bb38_4, phi_bb38_5, phi_bb38_7 });
    }
    ...
    if (block50.is_used()) {
        ...
        std::tie(tmp56, tmp57)
            = UnsafeConstCast_char8_0(state_, TorqueStructReference_char8_0 { TNode<Object> { tmp54 }, TNode<IntPtrT> { tmp55 }, TorqueStructUnsafe_0 {} }).Flatten();
    ...
    if (block39.is_used()) {
        ...
        ca_.Branch(tmp60, &block58, std::vector<compiler::Node*> { phi_bb39_3, phi_bb39_4, phi_bb39_5, phi_bb39_7 }, &block59,
            std::vector<compiler::Node*> { phi_bb39_3, phi_bb39_4, phi_bb39_5, phi_bb39_7 });
    }
...
TF_BUILTIN(NumberPrototypeToString, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ...
        tmp2 = CodeStubAssembler(state_).GetArgumentValue(TorqueStructArguments { TNode<RawPtrT> { torque_arguments.frame }, TNode<RawPtrT> { torque_arguments.base },
...
void BinaryOp1_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_leftVal, TNode<Object> p_rightVal, compiler::CodeAssemblerLabel* label_Number,
    compiler::TypedCodeAssemblerVariable<Number>* label_Number_parameter_0, compiler::TypedCodeAssemblerVariable<Number>* label_Number_parameter_1,
...
void BinaryOp2_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_leftVal, TNode<Object> p_rightVal, compiler::CodeAssemblerLabel* label_Smis,
    compiler::TypedCodeAssemblerVariable<Smi>* label_Smis_parameter_0, compiler::TypedCodeAssemblerVariable<Smi>* label_Smis_parameter_1,
    compiler::CodeAssemblerLabel* label_Float64s, compiler::TypedCodeAssemblerVariable<Float64T>* label_Float64s_parameter_0,
    compiler::TypedCodeAssemblerVariable<Float64T>* label_Float64s_parameter_1, compiler::CodeAssemblerLabel* label_AtLeastOneBigInt,
    compiler::TypedCodeAssemblerVariable<Numeric>* label_AtLeastOneBigInt_parameter_0, compiler::TypedCodeAssemblerVariable<Numeric>* label_AtLeastOneBigInt_parameter_1)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
...
TF_BUILTIN(Subtract, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ...
        compiler::CodeAssemblerLabel label6(&ca_);
        BinaryOp2_0(
            state_, TNode<Context> { parameter0 }, TNode<Object> { parameter1 }, TNode<Object> { parameter2 }, &label0, &tmp1, &tmp2, &label3, &tmp4, &tmp5, &label6, &tmp7, &tmp8);
        if (label0.is_used()) {
            ca_.Bind(&label0);
            ca_.Goto(&block7);
        }
...
TNode<Int32T> kMinimumDividend_0(compiler::CodeAssemblerState* state_)
{
    ...
    if (block0.is_used()) {
        ...
        tmp0 = FromConstexpr_bool_constexpr_bool_0(state_,
            (CodeStubAssembler(state_).ConstexprInt32Equal(kSmiValueSize, (FromConstexpr_constexpr_int32_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x20ull))))));
...
TF_BUILTIN(ShiftRight, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        tmp0
            = BinaryOpAssembler(state_).Generate_BitwiseBinaryOp(Operation::kShiftRight, TNode<Object> { parameter1 }, TNode<Object> { parameter2 }, TNode<Context> { parameter0 });
        CodeStubAssembler(state_).Return(tmp0);
    }
}
...
TF_BUILTIN(BitwiseXor, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        tmp0
            = BinaryOpAssembler(state_).Generate_BitwiseBinaryOp(Operation::kBitwiseXor, TNode<Object> { parameter1 }, TNode<Object> { parameter2 }, TNode<Context> { parameter0 });
        CodeStubAssembler(state_).Return(tmp0);
    }
}
