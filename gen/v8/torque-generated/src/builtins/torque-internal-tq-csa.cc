...
TNode<HeapObject> AllocateFromNew_0(compiler::CodeAssemblerState* state_, TNode<IntPtrT> p_sizeInBytes, TNode<Map> p_map, TNode<BoolT> p_pretenured)
{
    ...
    if (block6.is_used()) {
        ...
        tmp0 = CodeStubAssembler(state_).Allocate(TNode<IntPtrT> { p_sizeInBytes },
            static_cast<CodeStubAssembler::AllocationFlag>((CodeStubAssembler(state_).ConstexprWord32Or(
                static_cast<int32_t>(kAllocateBaseFlags_0(state_)), static_cast<int32_t>(CodeStubAssembler::AllocationFlag::kPretenured)))));
    ...
    compiler::CodeAssemblerState* state_, TNode<Object> p_object, TNode<IntPtrT> p_offset)
{
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        std::tie(tmp0, tmp1)
            = (TorqueStructReference_SmiTagged_VariableProperties_0 { TNode<Object> { p_object }, TNode<IntPtrT> { p_offset }, TorqueStructUnsafe_0 {} }).Flatten();
        ca_.Goto(&block2);
    }
...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/src/builtins/torque-internal.tq?l=97&c=36
TNode<IntPtrT> TimesSizeOf_JSReceiver_OR_Undefined_OR_Null_OR_False_OR_True_OR_Symbol_OR_String_OR_BigInt_OR_HeapNumber_OR_Smi_OR_TheHole_0(
    ...
    compiler::CodeAssemblerState* state_, TNode<Object> p_object, TNode<IntPtrT> p_offset)
{
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        std::tie(tmp0, tmp1) = (TorqueStructReference_JSReceiver_OR_Undefined_OR_Null_OR_False_OR_True_OR_Symbol_OR_String_OR_BigInt_OR_HeapNumber_OR_Smi_OR_TheHole_0 {
    ...
    ca_.Bind(&block2);
    return TorqueStructReference_JSReceiver_OR_Undefined_OR_Null_OR_False_OR_True_OR_Symbol_OR_String_OR_BigInt_OR_HeapNumber_OR_Smi_OR_TheHole_0 { TNode<Object> { tmp0 },
    ...
    compiler::CodeAssemblerState* state_, TNode<Object> p_object, TNode<IntPtrT> p_offset)
{
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        std::tie(tmp0, tmp1) = (TorqueStructReference_Undefined_OR_CallableApiObject_OR_CallableJSProxy_OR_JSWrappedFunction_OR_JSBoundFunction_OR_JSFunction_0 {
                                    TNode<Object> { p_object }, TNode<IntPtrT> { p_offset }, TorqueStructUnsafe_0 {} })
                                   .Flatten();
        ca_.Goto(&block2);
    }
...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/src/builtins/torque-internal.tq?l=78&c=3
TNode<HeapObject> UnsafeCast_Undefined_OR_CallableApiObject_OR_CallableJSProxy_OR_JSWrappedFunction_OR_JSBoundFunction_OR_JSFunction_0(
