...
TF_BUILTIN(TypedArrayPrototypeSubArray, CodeStubAssembler)
{
    ...
    if (block29.is_used()) {
        ...
        tmp37 = TypedArraySpeciesCreateByBuffer_0(state_, TNode<Context> { parameter0 }, "%TypedArray%.prototype.subarray", TNode<JSTypedArray> { tmp0 },
            TNode<JSArrayBuffer> { tmp2 }, TNode<UintPtrT> { tmp36 }, TNode<Object> { phi_bb29_13 });
