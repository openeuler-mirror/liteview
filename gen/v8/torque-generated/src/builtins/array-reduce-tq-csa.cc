...
TNode<Object> FastArrayReduce_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSReceiver> p_o, TNode<Number> p_len, TNode<JSReceiver> p_callbackfn,
    ...
    compiler::TypedCodeAssemblerVariable<Object>* label_Bailout_parameter_1)
{
    ...
    if (block13.is_used()) {
        ...
        ca_.Branch(
            tmp11, &block11, std::vector<compiler::Node*> { phi_bb13_5, phi_bb13_8, phi_bb13_11 }, &block12, std::vector<compiler::Node*> { phi_bb13_5, phi_bb13_8, phi_bb13_11 });
    }
    ...
    if (block11.is_used()) {
        ...
        ca_.Branch(
            tmp14, &block18, std::vector<compiler::Node*> { phi_bb11_5, phi_bb11_8, phi_bb11_11 }, &block19, std::vector<compiler::Node*> { phi_bb11_5, phi_bb11_8, phi_bb11_11 });
    }
    ...
    if (block19.is_used()) {
        ...
        ca_.Branch(
            tmp15, &block20, std::vector<compiler::Node*> { phi_bb19_5, phi_bb19_8, phi_bb19_11 }, &block21, std::vector<compiler::Node*> { phi_bb19_5, phi_bb19_8, phi_bb19_11 });
    }
...
TF_BUILTIN(ArrayReduce, CodeStubAssembler)
{
    ...
    if (block2.is_used()) {
        ...
        tmp20 = CodeStubAssembler(state_).GetArgumentValue(TorqueStructArguments { TNode<RawPtrT> { torque_arguments.frame }, TNode<RawPtrT> { torque_arguments.base },
                                                               TNode<IntPtrT> { torque_arguments.length }, TNode<IntPtrT> { torque_arguments.actual_count } },
            TNode<IntPtrT> { tmp19 });
