...
TNode<JSFunction> CreatePromiseAnyRejectElementFunction_0(
    compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Context> p_rejectElementContext, TNode<Smi> p_index, TNode<NativeContext> p_nativeContext)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
...
TF_BUILTIN(PromiseAnyRejectElementClosure, CodeStubAssembler)
{
    ...
    if (block13.is_used()) {
        ...
        std::tie(tmp10, tmp11)
            = ContextSlot_PromiseAnyRejectElementContext_PromiseAnyRejectElementContext_FixedArray_0(state_, TNode<Context> { tmp2 }, TNode<IntPtrT> { tmp9 }).Flatten();
        ...
        std::tie(tmp14, tmp15)
            = ContextSlot_PromiseAnyRejectElementContext_PromiseAnyRejectElementContext_Smi_0(state_, TNode<Context> { tmp2 }, TNode<IntPtrT> { tmp13 }).Flatten();
    ...
    if (block19.is_used()) {
        ...
        std::tie(tmp29, tmp30)
            = ContextSlot_PromiseAnyRejectElementContext_PromiseAnyRejectElementContext_FixedArray_0(state_, TNode<Context> { tmp2 }, TNode<IntPtrT> { tmp28 }).Flatten();
    ...
    if (block25.is_used()) {
        ...
        std::tie(tmp44, tmp45)
            = ContextSlot_PromiseAnyRejectElementContext_PromiseAnyRejectElementContext_Smi_0(state_, TNode<Context> { tmp2 }, TNode<IntPtrT> { tmp43 }).Flatten();
    ...
    if (block29.is_used()) {
        ...
        std::tie(tmp50, tmp51)
            = ContextSlot_PromiseAnyRejectElementContext_PromiseAnyRejectElementContext_PromiseCapability_0(state_, TNode<Context> { tmp2 }, TNode<IntPtrT> { tmp49 }).Flatten();
...
TNode<Object> PerformPromiseAny_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<NativeContext> p_nativeContext, TorqueStructIteratorRecord p_iteratorRecord,
    TNode<JSReceiver> p_constructor, TNode<PromiseCapability> p_resultCapability, TNode<Object> p_promiseResolveFunction, compiler::CodeAssemblerLabel* label_Reject,
    compiler::TypedCodeAssemblerVariable<Object>* label_Reject_parameter_0)
{
    ...
    if (block8.is_used()) {
        ...
        compiler::CodeAssemblerExceptionHandlerLabel catch15__label(&ca_, compiler::CodeAssemblerLabel::kDeferred);
        {
            ...
            tmp13 = IteratorBuiltinsAssembler(state_).IteratorStep(TNode<Context> { p_context },
                TorqueStructIteratorRecord { TNode<JSReceiver> { p_iteratorRecord.object }, TNode<Object> { p_iteratorRecord.next } }, TNode<Map> { tmp7 }, &label14);
        }
    ...
    if (block21.is_used()) {
        ...
        compiler::CodeAssemblerExceptionHandlerLabel catch46__label(&ca_, compiler::CodeAssemblerLabel::kDeferred);
        {
            ...
            std::tie(tmp44, tmp45)
                = ContextSlot_PromiseAnyRejectElementContext_PromiseAnyRejectElementContext_Smi_0(state_, TNode<Context> { tmp0 }, TNode<IntPtrT> { tmp43 }).Flatten();
        }
        ...
        compiler::CodeAssemblerExceptionHandlerLabel catch52__label(&ca_, compiler::CodeAssemblerLabel::kDeferred);
        {
            ...
            std::tie(tmp50, tmp51)
                = ContextSlot_PromiseAnyRejectElementContext_PromiseAnyRejectElementContext_Smi_0(state_, TNode<Context> { tmp0 }, TNode<IntPtrT> { tmp49 }).Flatten();
        }
        ...
        compiler::CodeAssemblerExceptionHandlerLabel catch72__label(&ca_, compiler::CodeAssemblerLabel::kDeferred);
        {
            ...
            tmp71
                = CodeStubAssembler(state_).Call(TNode<Context> { p_context }, TNode<Object> { tmp61 }, TNode<Object> { tmp37 }, TNode<Object> { tmp68 }, TNode<Object> { tmp40 });
        }
    ...
    if (block6.is_used()) {
        ...
        IteratorCloseOnException_0(
            state_, TNode<Context> { p_context }, TorqueStructIteratorRecord { TNode<JSReceiver> { p_iteratorRecord.object }, TNode<Object> { p_iteratorRecord.next } });
    ...
    if (block3.is_used()) {
        ...
        std::tie(tmp121, tmp122)
            = ContextSlot_PromiseAnyRejectElementContext_PromiseAnyRejectElementContext_Smi_0(state_, TNode<Context> { tmp0 }, TNode<IntPtrT> { tmp120 }).Flatten();
    ...
    if (block49.is_used()) {
        ...
        std::tie(tmp129, tmp130)
            = ContextSlot_PromiseAnyRejectElementContext_PromiseAnyRejectElementContext_FixedArray_0(state_, TNode<Context> { tmp0 }, TNode<IntPtrT> { tmp128 }).Flatten();
    ...
    if (block3.is_used()) {
        ...
        compiler::CodeAssemblerExceptionHandlerLabel catch16__label(&ca_, compiler::CodeAssemblerLabel::kDeferred);
        {
            ...
            tmp13 = PerformPromiseAny_0(state_, TNode<Context> { parameter0 }, TNode<NativeContext> { tmp0 },
                ...
                TNode<Object> { tmp6 }, &label14, &tmp15);
        }
