...
TNode<Object> RegExpPrototypeMatchBody_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSReceiver> p_regexp, TNode<String> p_string, bool p_isFastPath)
{
    ...
    if (block52.is_used()) {
        ...
        ca_.Branch(tmp63, &block88, std::vector<compiler::Node*> { phi_bb52_5, phi_bb52_6, phi_bb52_7, phi_bb52_8, phi_bb52_9, phi_bb52_10, phi_bb52_10, phi_bb52_10 }, &block89,
    ...
    if (block89.is_used()) {
        ...
        ca_.Branch(tmp87, &block107, std::vector<compiler::Node*> { phi_bb89_8, phi_bb89_9, phi_bb89_10, phi_bb89_11, phi_bb89_12, phi_bb89_7, phi_bb89_7, phi_bb89_7, phi_bb89_7 },
            &block108, std::vector<compiler::Node*> { phi_bb89_8, phi_bb89_9, phi_bb89_10, phi_bb89_11, phi_bb89_12, phi_bb89_7, phi_bb89_7, phi_bb89_7, phi_bb89_7 });
    }
