...
TF_BUILTIN(TypedArrayFrom, CodeStubAssembler)
{
    ...
    if (block59.is_used()) {
        ...
        tmp70 = TORQUE_CAST(CodeStubAssembler(state_).CallBuiltinPointer(
            Builtins::CallableFor(ca_.isolate(), ExampleBuiltinForTorqueFunctionPointerType(3)).descriptor(), tmp64, parameter0, tmp55, phi_bb59_19, phi_bb59_22));
