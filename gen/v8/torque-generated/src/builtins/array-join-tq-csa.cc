...
TF_BUILTIN(LoadJoinElement_FastDoubleElements_0, CodeStubAssembler)
{
    ...
    if (block7.is_used()) {
        ...
        std::tie(tmp15, tmp16)
            = LoadFloat64OrHole_0(state_, TorqueStructReference_float64_or_hole_0 { TNode<Object> { tmp13 }, TNode<IntPtrT> { tmp14 }, TorqueStructUnsafe_0 {} }).Flatten();
...
TNode<BoolT> CannotUseSameArrayAccessor_JSArray_0(
    compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<BuiltinPtr> p_loadFn, TNode<JSReceiver> p_receiver, TNode<Map> p_originalMap, TNode<Number> p_originalLen)
{
...
TNode<BoolT> CannotUseSameArrayAccessor_JSTypedArray_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<BuiltinPtr> p__loadFn, TNode<JSReceiver> p_receiver,
    TNode<Map> p__initialMap, TNode<Number> p__initialLen)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
...
TNode<String> BufferJoin_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TorqueStructBuffer_0 p_buffer, TNode<String> p_sep)
{
    ...
    if (block29.is_used()) {
        ...
        tmp27 = ArrayBuiltinsAssembler(state_).CallJSArrayArrayJoinConcatToSequentialString(
            TNode<FixedArray> { p_buffer.fixedArray }, TNode<IntPtrT> { p_buffer.index }, TNode<String> { p_sep }, TNode<String> { phi_bb29_7 });
...
TNode<Object> ArrayJoin_JSArray_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, bool p_useToLocaleString, TNode<JSReceiver> p_receiver, TNode<String> p_sep,
    TNode<Number> p_lenNumber, TNode<Object> p_locales, TNode<Object> p_options)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    if (block2.is_used()) {
        ...
        tmp29 = ArrayJoinImpl_JSArray_0(state_, TNode<Context> { p_context }, TNode<JSReceiver> { p_receiver }, TNode<String> { p_sep }, TNode<Number> { p_lenNumber },
            p_useToLocaleString, TNode<Object> { p_locales }, TNode<Object> { p_options }, TNode<BuiltinPtr> { phi_bb2_8 });
...
TNode<Object> ArrayJoin_JSTypedArray_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, bool p_useToLocaleString, TNode<JSReceiver> p_receiver, TNode<String> p_sep,
    TNode<Number> p_lenNumber, TNode<Object> p_locales, TNode<Object> p_options)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    ...
    if (block4.is_used()) {
        ...
        tmp48 = ArrayJoinImpl_JSTypedArray_0(state_, TNode<Context> { p_context }, TNode<JSReceiver> { p_receiver }, TNode<String> { p_sep }, TNode<Number> { p_lenNumber },
            p_useToLocaleString, TNode<Object> { p_locales }, TNode<Object> { p_options }, TNode<BuiltinPtr> { phi_bb4_8 });
        ca_.Goto(&block71);
    }
...
TF_BUILTIN(ArrayPrototypeJoin, CodeStubAssembler)
{
    ...
    if (block2.is_used()) {
        ...
        tmp8 = CycleProtectedArrayJoin_JSArray_0(state_, TNode<Context> { parameter0 }, false, TNode<JSReceiver> { tmp2 }, TNode<Number> { tmp3 }, TNode<Object> { tmp1 },
            TNode<Object> { tmp6 }, TNode<Object> { tmp7 });
...
TF_BUILTIN(ArrayPrototypeToLocaleString, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ...
        tmp3 = CodeStubAssembler(state_).GetArgumentValue(TorqueStructArguments { TNode<RawPtrT> { torque_arguments.frame }, TNode<RawPtrT> { torque_arguments.base },
                                                              TNode<IntPtrT> { torque_arguments.length }, TNode<IntPtrT> { torque_arguments.actual_count } },
            TNode<IntPtrT> { tmp2 });
    ...
    if (block2.is_used()) {
        ...
        tmp9 = CycleProtectedArrayJoin_JSArray_0(state_, TNode<Context> { parameter0 }, true, TNode<JSReceiver> { tmp4 }, TNode<Number> { tmp5 }, TNode<Object> { tmp8 },
            TNode<Object> { tmp1 }, TNode<Object> { tmp3 });
...
TF_BUILTIN(TypedArrayPrototypeJoin, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ...
        tmp6 = Undefined_0(state_);
        tmp7 = CycleProtectedArrayJoin_JSTypedArray_0(state_, TNode<Context> { parameter0 }, false, TNode<JSReceiver> { tmp3 }, TNode<Number> { tmp4 }, TNode<Object> { tmp1 },
            TNode<Object> { tmp5 }, TNode<Object> { tmp6 });
...
TF_BUILTIN(TypedArrayPrototypeToLocaleString, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ...
        tmp8 = CycleProtectedArrayJoin_JSTypedArray_0(state_, TNode<Context> { parameter0 }, true, TNode<JSReceiver> { tmp5 }, TNode<Number> { tmp6 }, TNode<Object> { tmp7 },
            TNode<Object> { tmp1 }, TNode<Object> { tmp3 });
        arguments.PopAndReturn(tmp8);
    }
}
    ...
    TNode<Number> p_lengthNumber, bool p_useToLocaleString, TNode<Object> p_locales, TNode<Object> p_options, TNode<BuiltinPtr> p_initialLoadFn)
{
    ...
    compiler::CodeAssemblerParameterizedLabel<IntPtrT, BuiltinPtr, FixedArray, IntPtrT, IntPtrT, BoolT, UintPtrT, IntPtrT, IntPtrT> block40(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<IntPtrT, BuiltinPtr, FixedArray, IntPtrT, IntPtrT, BoolT, UintPtrT, IntPtrT, IntPtrT> block41(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<IntPtrT, BuiltinPtr, FixedArray, IntPtrT, IntPtrT, BoolT, UintPtrT, IntPtrT, IntPtrT, BoolT> block42(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<IntPtrT, BuiltinPtr, FixedArray, IntPtrT, IntPtrT, BoolT, UintPtrT, IntPtrT, IntPtrT> block38(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<IntPtrT, BuiltinPtr, FixedArray, IntPtrT, IntPtrT, BoolT, UintPtrT, IntPtrT, IntPtrT> block39(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<IntPtrT, BuiltinPtr, FixedArray, IntPtrT, IntPtrT, BoolT, UintPtrT, IntPtrT, IntPtrT, IntPtrT> block43(
        &ca_, compiler::CodeAssemblerLabel::kDeferred);
    compiler::CodeAssemblerParameterizedLabel<IntPtrT, BuiltinPtr, FixedArray, IntPtrT, IntPtrT, BoolT, UintPtrT, IntPtrT, IntPtrT, IntPtrT> block44(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<IntPtrT, BuiltinPtr, FixedArray, IntPtrT, BoolT, UintPtrT, IntPtrT, IntPtrT, IntPtrT> block45(
        &ca_, compiler::CodeAssemblerLabel::kDeferred);
    compiler::CodeAssemblerParameterizedLabel<IntPtrT, BuiltinPtr, FixedArray, IntPtrT, BoolT, UintPtrT, IntPtrT, IntPtrT, IntPtrT> block46(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<IntPtrT, BuiltinPtr, FixedArray, IntPtrT, IntPtrT, BoolT, UintPtrT, IntPtrT, IntPtrT> block37(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<> block47(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ca_.Goto(&block0);
    ...
    if (block4.is_used()) {
        ...
        ca_.Branch(tmp10, &block2, std::vector<compiler::Node*> { phi_bb4_10, phi_bb4_11, phi_bb4_12, phi_bb4_13, phi_bb4_14, phi_bb4_15, phi_bb4_16 }, &block3,
            std::vector<compiler::Node*> { phi_bb4_10, phi_bb4_11, phi_bb4_12, phi_bb4_13, phi_bb4_14, phi_bb4_15, phi_bb4_16 });
    }
    ...
    if (block2.is_used()) {
        ...
        tmp11 = CannotUseSameArrayAccessor_JSArray_0(
            state_, TNode<Context> { p_context }, TNode<BuiltinPtr> { phi_bb2_11 }, TNode<JSReceiver> { p_receiver }, TNode<Map> { tmp1 }, TNode<Number> { p_lengthNumber });
        ca_.Branch(tmp11, &block5, std::vector<compiler::Node*> { phi_bb2_10, phi_bb2_11, phi_bb2_12, phi_bb2_13, phi_bb2_14, phi_bb2_15, phi_bb2_16 }, &block6,
            std::vector<compiler::Node*> { phi_bb2_10, phi_bb2_11, phi_bb2_12, phi_bb2_13, phi_bb2_14, phi_bb2_15, phi_bb2_16 });
    }
    ...
    if (block5.is_used()) {
        ...
        ca_.Goto(&block6, phi_bb5_10, ca_.UncheckedCast<BuiltinPtr>(ca_.SmiConstant(Builtin::kLoadJoinElement_GenericElementsAccessor_0)), phi_bb5_12, phi_bb5_13, phi_bb5_14,
            phi_bb5_15, phi_bb5_16);
    }
    ...
    if (block6.is_used()) {
        ...
        ca_.Branch(tmp13, &block7, std::vector<compiler::Node*> { phi_bb6_10, phi_bb6_12, phi_bb6_13, phi_bb6_14, phi_bb6_15, phi_bb6_16 }, &block8,
            std::vector<compiler::Node*> { phi_bb6_10, phi_bb6_12, phi_bb6_13, phi_bb6_14, phi_bb6_15, phi_bb6_16 });
    }
    ...
    if (block8.is_used()) {
        ...
        tmp18 = CodeStubAssembler(state_).CallBuiltinPointer(
            Builtins::CallableFor(ca_.isolate(), ExampleBuiltinForTorqueFunctionPointerType(0)).descriptor(), phi_bb6_11, p_context, p_receiver, phi_bb8_16);
    ...
    if (block9.is_used()) {
        ...
        ca_.Branch(tmp21, &block12, std::vector<compiler::Node*> { phi_bb9_12, phi_bb9_13, phi_bb9_14, phi_bb9_15 }, &block13,
            std::vector<compiler::Node*> { phi_bb9_12, phi_bb9_13, phi_bb9_14, phi_bb9_15 });
    }
    ...
    if (block16.is_used()) {
        ...
        ca_.Branch(tmp27, &block18, std::vector<compiler::Node*> { phi_bb16_12, phi_bb16_13, phi_bb16_14, phi_bb16_15 }, &block19,
            std::vector<compiler::Node*> { phi_bb16_12, phi_bb16_13, phi_bb16_14, phi_bb16_15 });
    }
    ...
    if (block23.is_used()) {
        ...
        ca_.Branch(tmp28, &block24, std::vector<compiler::Node*> { phi_bb23_12, phi_bb23_13, phi_bb23_14, phi_bb23_15 }, &block25,
            std::vector<compiler::Node*> { phi_bb23_12, phi_bb23_13, phi_bb23_14, phi_bb23_15 });
    }
    ...
    if (block11.is_used()) {
        ...
        ca_.Branch(tmp37, &block30, std::vector<compiler::Node*> { phi_bb11_12, phi_bb11_13, phi_bb11_14, phi_bb11_15, phi_bb11_18, phi_bb11_18, phi_bb11_18 }, &block31,
            std::vector<compiler::Node*> { phi_bb11_12, phi_bb11_13, phi_bb11_14, phi_bb11_15, phi_bb11_18, phi_bb11_18, phi_bb11_18 });
    }
    ...
    if (block32.is_used()) {
        ...
        ca_.Branch(phi_bb32_37, &block28, std::vector<compiler::Node*> { phi_bb32_12, phi_bb32_13, phi_bb32_14, phi_bb32_15, phi_bb32_18, phi_bb32_19, phi_bb32_24 }, &block29,
            std::vector<compiler::Node*> { phi_bb32_12, phi_bb32_13, phi_bb32_14, phi_bb32_15, phi_bb32_18, phi_bb32_19, phi_bb32_24 });
    }
    ...
    if (block29.is_used()) {
        ...
        ca_.Branch(tmp43, &block33, std::vector<compiler::Node*> { phi_bb29_12, phi_bb29_13, phi_bb29_14, phi_bb29_15, phi_bb29_18, phi_bb29_19, phi_bb29_24 }, &block34,
            std::vector<compiler::Node*> { phi_bb29_12, phi_bb29_13, phi_bb29_14, phi_bb29_15, phi_bb29_18, phi_bb29_19, phi_bb29_24 });
    }
    ...
    if (block34.is_used()) {
        ...
        ca_.Branch(tmp35, &block35, std::vector<compiler::Node*> { phi_bb34_12, phi_bb34_13, phi_bb34_15, phi_bb34_18, phi_bb34_19, phi_bb34_24 }, &block36,
            std::vector<compiler::Node*> { phi_bb34_12, phi_bb34_13, phi_bb34_15, phi_bb34_18, phi_bb34_19, phi_bb34_24 });
    }
    ...
    if (block3.is_used()) {
        ...
        ca_.Branch(tmp60, &block40, std::vector<compiler::Node*> { phi_bb3_10, phi_bb3_11, phi_bb3_12, phi_bb3_13, phi_bb3_14, phi_bb3_15, phi_bb3_16, phi_bb3_10, phi_bb3_10 },
            &block41, std::vector<compiler::Node*> { phi_bb3_10, phi_bb3_11, phi_bb3_12, phi_bb3_13, phi_bb3_14, phi_bb3_15, phi_bb3_16, phi_bb3_10, phi_bb3_10 });
    }
    ...
    if (block42.is_used()) {
        ...
        ca_.Branch(phi_bb42_25, &block38,
            std::vector<compiler::Node*> { phi_bb42_10, phi_bb42_11, phi_bb42_12, phi_bb42_13, phi_bb42_14, phi_bb42_15, phi_bb42_16, phi_bb42_17, phi_bb42_21 }, &block39,
            std::vector<compiler::Node*> { phi_bb42_10, phi_bb42_11, phi_bb42_12, phi_bb42_13, phi_bb42_14, phi_bb42_15, phi_bb42_16, phi_bb42_17, phi_bb42_21 });
    }
    ...
    if (block39.is_used()) {
        ...
        ca_.Branch(tmp66, &block43,
            std::vector<compiler::Node*> { phi_bb39_10, phi_bb39_11, phi_bb39_12, phi_bb39_13, phi_bb39_14, phi_bb39_15, phi_bb39_16, phi_bb39_17, phi_bb39_21, phi_bb39_21 },
            &block44,
            std::vector<compiler::Node*> { phi_bb39_10, phi_bb39_11, phi_bb39_12, phi_bb39_13, phi_bb39_14, phi_bb39_15, phi_bb39_16, phi_bb39_17, phi_bb39_21, phi_bb39_21 });
    }
    ...
    if (block44.is_used()) {
        ...
        ca_.Branch(tmp58, &block45,
            std::vector<compiler::Node*> { phi_bb44_10, phi_bb44_11, phi_bb44_12, phi_bb44_13, phi_bb44_15, phi_bb44_16, phi_bb44_17, phi_bb44_21, phi_bb44_24 }, &block46,
            std::vector<compiler::Node*> { phi_bb44_10, phi_bb44_11, phi_bb44_12, phi_bb44_13, phi_bb44_15, phi_bb44_16, phi_bb44_17, phi_bb44_21, phi_bb44_24 });
    }
    ...
    if (block37.is_used()) {
        ...
        tmp72 = BufferJoin_0(state_, TNode<Context> { p_context },
            TorqueStructBuffer_0 { TNode<FixedArray> { phi_bb37_12 }, TNode<IntPtrT> { phi_bb37_13 }, TNode<IntPtrT> { phi_bb37_14 }, TNode<BoolT> { phi_bb37_15 } },
            TNode<String> { p_sep });
        ca_.Goto(&block47);
    }
...
TF_BUILTIN(LoadJoinTypedElement_BigUint64Elements_0, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ...
        tmp1 = CodeStubAssembler(state_).LoadJSTypedArrayDataPtr(TNode<JSTypedArray> { tmp0 });
        tmp2
            = CodeStubAssembler(state_).LoadFixedTypedArrayElementAsTagged(TNode<RawPtrT> { tmp1 }, TNode<UintPtrT> { parameter2 }, (KindForArrayType_BigUint64Elements_0(state_)));
        CodeStubAssembler(state_).Return(tmp2);
    }
}
    ...
    TNode<Number> p_lengthNumber, bool p_useToLocaleString, TNode<Object> p_locales, TNode<Object> p_options, TNode<BuiltinPtr> p_initialLoadFn)
{
    ...
    if (block2.is_used()) {
        ca_.Bind(&block2, &phi_bb2_10, &phi_bb2_11, &phi_bb2_12, &phi_bb2_13, &phi_bb2_14, &phi_bb2_15, &phi_bb2_16);
        tmp11 = CannotUseSameArrayAccessor_JSTypedArray_0(
            state_, TNode<Context> { p_context }, TNode<BuiltinPtr> { phi_bb2_11 }, TNode<JSReceiver> { p_receiver }, TNode<Map> { tmp1 }, TNode<Number> { p_lengthNumber });
        ca_.Branch(tmp11, &block5, std::vector<compiler::Node*> { phi_bb2_10, phi_bb2_11, phi_bb2_12, phi_bb2_13, phi_bb2_14, phi_bb2_15, phi_bb2_16 }, &block6,
            std::vector<compiler::Node*> { phi_bb2_10, phi_bb2_11, phi_bb2_12, phi_bb2_13, phi_bb2_14, phi_bb2_15, phi_bb2_16 });
    }
    ...
    TNode<Number> p_len, TNode<Object> p_sepObj, TNode<Object> p_locales, TNode<Object> p_options)
{
    ...
    if (block6.is_used()) {
        ...
        compiler::CodeAssemblerExceptionHandlerLabel catch9__label(&ca_, compiler::CodeAssemblerLabel::kDeferred);
        {
            ...
            tmp8 = ArrayJoin_JSArray_0(state_, TNode<Context> { p_context }, p_useToLocaleString, TNode<JSReceiver> { p_o }, TNode<String> { phi_bb4_6 }, TNode<Number> { p_len },
                TNode<Object> { p_locales }, TNode<Object> { p_options });
        }
...
TNode<Object> CycleProtectedArrayJoin_JSTypedArray_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, bool p_useToLocaleString, TNode<JSReceiver> p_o,
    TNode<Number> p_len, TNode<Object> p_sepObj, TNode<Object> p_locales, TNode<Object> p_options)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
