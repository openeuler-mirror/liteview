    ...
    compiler::TypedCodeAssemblerVariable<Object>* label_Bailout_parameter_1)
{
    ...
    if (block13.is_used()) {
        ...
        ca_.Branch(
            tmp15, &block11, std::vector<compiler::Node*> { phi_bb13_5, phi_bb13_9, phi_bb13_12 }, &block12, std::vector<compiler::Node*> { phi_bb13_5, phi_bb13_9, phi_bb13_12 });
    }
    ...
    if (block11.is_used()) {
        ...
        ca_.Branch(
            tmp18, &block18, std::vector<compiler::Node*> { phi_bb11_5, phi_bb11_9, phi_bb11_12 }, &block19, std::vector<compiler::Node*> { phi_bb11_5, phi_bb11_9, phi_bb11_12 });
    }
    ...
    if (block19.is_used()) {
        ...
        ca_.Branch(
            tmp19, &block20, std::vector<compiler::Node*> { phi_bb19_5, phi_bb19_9, phi_bb19_12 }, &block21, std::vector<compiler::Node*> { phi_bb19_5, phi_bb19_9, phi_bb19_12 });
    }
...
TF_BUILTIN(ArrayReduceRight, CodeStubAssembler)
{
    ...
    if (block14.is_used()) {
        ...
        tmp18 = ca_.CallStub<Object>(
            Builtins::CallableFor(ca_.isolate(), Builtin::kArrayReduceRightLoopContinuation), parameter0, tmp1, tmp7, tmp17.value(), tmp1, tmp16.value(), tmp2);
