...
TNode<Object> RejectPromiseReactionJob_0(
    compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<HeapObject> p_promiseOrCapability, TNode<Object> p_reason, PromiseReaction::Type p_reactionType)
{
    ...
    if (block3.is_used()) {
        ...
        CodeStubAssembler(state_).StaticAssert(TNode<BoolT> { tmp12 },
            "static_assert(reactionType == kPromiseReactionFulfill) at https://source.chromium.org/chromium/chromium/src/+/main:v8/src/builtins/promise-reaction-job.tq?l=33&c=5");
...
TNode<Object> FuflfillPromiseReactionJob_0(
    compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<HeapObject> p_promiseOrCapability, TNode<Object> p_result, PromiseReaction::Type p_reactionType)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    TNode<HeapObject> p_promiseOrCapability, PromiseReaction::Type p_reactionType)
{
    ...
    if (block6.is_used()) {
        ...
        CodeStubAssembler(state_).StaticAssert(TNode<BoolT> { tmp3 },
            "static_assert(reactionType == kPromiseReactionReject) at https://source.chromium.org/chromium/chromium/src/+/main:v8/src/builtins/promise-reaction-job.tq?l=82&c=7");
...
TF_BUILTIN(PromiseFulfillReactionJob, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        tmp0 = PromiseReactionJob_0(
            state_, TNode<Context> { parameter0 }, TNode<Object> { parameter1 }, TNode<HeapObject> { parameter2 }, TNode<HeapObject> { parameter3 }, PromiseReaction::kFulfill);
...
TF_BUILTIN(PromiseRejectReactionJob, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        tmp0 = PromiseReactionJob_0(
            state_, TNode<Context> { parameter0 }, TNode<Object> { parameter1 }, TNode<HeapObject> { parameter2 }, TNode<HeapObject> { parameter3 }, PromiseReaction::kReject);
        CodeStubAssembler(state_).Return(tmp0);
    }
}
