...
TNode<Number> CallCompare_0(
    compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSTypedArray> p_array, TNode<JSReceiver> p_comparefn, TNode<Object> p_a, TNode<Object> p_b)
{
    compiler::CodeAssembler ca_(state_);
...
void TypedArrayMerge_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSTypedArray> p_array, TNode<JSReceiver> p_comparefn, TNode<FixedArray> p_source,
    TNode<UintPtrT> p_from, TNode<UintPtrT> p_middle, TNode<UintPtrT> p_to, TNode<FixedArray> p_target)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    if (block43.is_used()) {
        ...
        tmp56 = CallCompare_0(
            state_, TNode<Context> { p_context }, TNode<JSTypedArray> { p_array }, TNode<JSReceiver> { p_comparefn }, TNode<Object> { tmp42 }, TNode<Object> { tmp55 });
        ...
        ca_.Branch(
            tmp58, &block47, std::vector<compiler::Node*> { phi_bb43_8, phi_bb43_9, phi_bb43_10 }, &block48, std::vector<compiler::Node*> { phi_bb43_8, phi_bb43_9, phi_bb43_10 });
    }
...
TF_BUILTIN(TypedArrayMergeSort, CodeStubAssembler)
{
    ...
    if (block5.is_used()) {
        ca_.Bind(&block5);
        tmp7 = ca_.CallStub<Object>(
            Builtins::CallableFor(ca_.isolate(), Builtin::kTypedArrayMergeSort), parameter0, parameter4, parameter2, tmp3, parameter1, parameter5, parameter6);
        ca_.Goto(&block6);
    }
    ...
    if (block7.is_used()) {
        ca_.Bind(&block7);
        tmp11 = ca_.CallStub<Object>(
            Builtins::CallableFor(ca_.isolate(), Builtin::kTypedArrayMergeSort), parameter0, parameter4, tmp3, parameter3, parameter1, parameter5, parameter6);
        ca_.Goto(&block8);
    }
    ...
    if (block8.is_used()) {
        ca_.Bind(&block8);
        TypedArrayMerge_0(state_, TNode<Context> { parameter0 }, TNode<JSTypedArray> { parameter5 }, TNode<JSReceiver> { parameter6 }, TNode<FixedArray> { parameter1 },
            TNode<UintPtrT> { parameter2 }, TNode<UintPtrT> { tmp3 }, TNode<UintPtrT> { parameter3 }, TNode<FixedArray> { parameter4 });
...
TNode<JSTypedArray> TypedArraySortCommon_0(
    compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSTypedArray> p_array, TNode<UintPtrT> p_len, TNode<HeapObject> p_comparefnArg, bool p_isSort)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    if (block12.is_used()) {
        ...
        tmp19 = TORQUE_CAST(CodeStubAssembler(state_).CallBuiltinPointer(
            Builtins::CallableFor(ca_.isolate(), ExampleBuiltinForTorqueFunctionPointerType(1)).descriptor(), tmp10, TNode<Object>(), p_array, phi_bb12_10));
    ...
    if (block58.is_used()) {
        ...
        tmp65 = TORQUE_CAST(CodeStubAssembler(state_).CallBuiltinPointer(
            Builtins::CallableFor(ca_.isolate(), ExampleBuiltinForTorqueFunctionPointerType(2)).descriptor(), tmp11, p_context, p_array, phi_bb58_17, tmp64));
