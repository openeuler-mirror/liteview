...
TF_BUILTIN(StringToList, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ...
        tmp4 = CodeStubAssembler(state_).AllocateJSArray(
            ElementsKind::PACKED_ELEMENTS, TNode<Map> { tmp2 }, TNode<IntPtrT> { tmp0 }, TNode<Smi> { tmp3 }, CodeStubAssembler::AllocationFlag::kAllowLargeObjectAllocation);
...
void GenerateStringAt_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_receiver, TNode<Object> p_position, const char* p_methodName,
    compiler::CodeAssemblerLabel* label_IfInBounds, compiler::TypedCodeAssemblerVariable<String>* label_IfInBounds_parameter_0,
...
TF_BUILTIN(StringPrototypeCharAt, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ...
        compiler::CodeAssemblerLabel label4(&ca_);
        GenerateStringAt_0(
            state_, TNode<Context> { parameter0 }, TNode<Object> { parameter1 }, TNode<Object> { parameter2 }, "String.prototype.charAt", &label0, &tmp1, &tmp2, &tmp3, &label4);
        if (label0.is_used()) {
            ca_.Bind(&label0);
            ca_.Goto(&block5);
        }
...
TF_BUILTIN(StringPrototypeCharCodeAt, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ...
        compiler::CodeAssemblerLabel label0(&ca_);
        compiler::CodeAssemblerLabel label4(&ca_);
        GenerateStringAt_0(state_, TNode<Context> { parameter0 }, TNode<Object> { parameter1 }, TNode<Object> { parameter2 }, "String.prototype.charCodeAt", &label0, &tmp1, &tmp2,
            &tmp3, &label4);
        if (label0.is_used()) {
            ca_.Bind(&label0);
            ca_.Goto(&block5);
...
TF_BUILTIN(StringPrototypeCodePointAt, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ...
        compiler::CodeAssemblerLabel label0(&ca_);
        compiler::CodeAssemblerLabel label4(&ca_);
        GenerateStringAt_0(state_, TNode<Context> { parameter0 }, TNode<Object> { parameter1 }, TNode<Object> { parameter2 }, "String.prototype.codePointAt", &label0, &tmp1, &tmp2,
            &tmp3, &label4);
        if (label0.is_used()) {
            ca_.Bind(&label0);
            ca_.Goto(&block5);
