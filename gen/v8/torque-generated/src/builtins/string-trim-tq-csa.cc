...
TNode<String> StringTrim_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_receiver, TorqueStructArguments p__arguments, const char* p_methodName,
    String::TrimMode p_variant)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    if (block11.is_used()) {
        ...
        std::tie(tmp14, tmp15, tmp16) = Subslice_char8_0(state_,
            TorqueStructSlice_char8_ConstReference_char8_0 { TNode<Object> { tmp11 }, TNode<IntPtrT> { tmp12 }, TNode<IntPtrT> { tmp13 }, TorqueStructUnsafe_0 {} },
    ...
    if (block19.is_used()) {
        ...
        std::tie(tmp23, tmp24, tmp25) = Subslice_char16_0(state_,
            TorqueStructSlice_char16_ConstReference_char16_0 { TNode<Object> { tmp20 }, TNode<IntPtrT> { tmp21 }, TNode<IntPtrT> { tmp22 }, TorqueStructUnsafe_0 {} },
    ...
    if (block39.is_used()) {
        ...
        std::tie(tmp51, tmp52, tmp53) = Subslice_char8_0(state_,
            TorqueStructSlice_char8_ConstReference_char8_0 { TNode<Object> { tmp48 }, TNode<IntPtrT> { tmp49 }, TNode<IntPtrT> { tmp50 }, TorqueStructUnsafe_0 {} },
    ...
    if (block47.is_used()) {
        ...
        std::tie(tmp62, tmp63, tmp64) = Subslice_char16_0(state_,
            TorqueStructSlice_char16_ConstReference_char16_0 { TNode<Object> { tmp59 }, TNode<IntPtrT> { tmp60 }, TNode<IntPtrT> { tmp61 }, TorqueStructUnsafe_0 {} },
    ...
    if (block5.is_used()) {
        ...
        tmp66 = StringTrimBody_char8_0(state_, TNode<Context> { p_context }, TNode<String> { tmp1 },
            TorqueStructSlice_char8_ConstReference_char8_0 { TNode<Object> { phi_bb5_7 }, TNode<IntPtrT> { phi_bb5_8 }, TNode<IntPtrT> { phi_bb5_9 }, TorqueStructUnsafe_0 {} },
            p_variant);
    ...
    if (block3.is_used()) {
        ...
        tmp67 = StringTrimBody_char16_0(state_, TNode<Context> { p_context }, TNode<String> { tmp1 },
            TorqueStructSlice_char16_ConstReference_char16_0 { TNode<Object> { phi_bb3_7 }, TNode<IntPtrT> { phi_bb3_8 }, TNode<IntPtrT> { phi_bb3_9 }, TorqueStructUnsafe_0 {} },
            p_variant);
...
TNode<String> StringTrimBody_char8_0(
    compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<String> p_string, TorqueStructSlice_char8_ConstReference_char8_0 p_slice, String::TrimMode p_variant)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
...
TNode<String> StringTrimBody_char16_0(
    compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<String> p_string, TorqueStructSlice_char16_ConstReference_char16_0 p_slice, String::TrimMode p_variant)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
...
TNode<IntPtrT> StringTrimLoop_char8_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TorqueStructSlice_char8_ConstReference_char8_0 p_stringSlice,
    TNode<IntPtrT> p_startIndex, TNode<IntPtrT> p_endIndex, TNode<IntPtrT> p_increment)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/src/builtins/string-trim.tq?l=120&c=18
TNode<IntPtrT> StringTrimLoop_char16_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TorqueStructSlice_char16_ConstReference_char16_0 p_stringSlice,
    TNode<IntPtrT> p_startIndex, TNode<IntPtrT> p_endIndex, TNode<IntPtrT> p_increment)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
