...
TF_BUILTIN(ArrayFilterLoopEagerDeoptContinuation, CodeStubAssembler)
{
    ...
    if (block23.is_used()) {
        ca_.Bind(&block23);
        tmp12
            = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtin::kArrayFilterLoopContinuation), parameter0, tmp0, tmp2, parameter3, tmp4, tmp0, tmp6, tmp10, tmp8);
...
TF_BUILTIN(ArrayFilterLoopLazyDeoptContinuation, CodeStubAssembler)
{
    ...
    if (block26.is_used()) {
        ...
        tmp18 = ca_.CallStub<Object>(
            Builtins::CallableFor(ca_.isolate(), Builtin::kArrayFilterLoopContinuation), parameter0, tmp0, tmp2, parameter3, tmp4, tmp0, tmp17, tmp10, phi_bb26_14);
...
void FastArrayFilter_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSArray> p_fastO, TNode<Smi> p_len, TNode<JSReceiver> p_callbackfn,
    TNode<Object> p_thisArg, TNode<JSArray> p_output, compiler::CodeAssemblerLabel* label_Bailout, compiler::TypedCodeAssemblerVariable<Number>* label_Bailout_parameter_0,
    compiler::TypedCodeAssemblerVariable<Number>* label_Bailout_parameter_1)
{
    ...
    if (block18.is_used()) {
        ...
        ca_.Branch(
            tmp24, &block19, std::vector<compiler::Node*> { phi_bb18_6, phi_bb18_7, phi_bb18_15 }, &block20, std::vector<compiler::Node*> { phi_bb18_6, phi_bb18_7, phi_bb18_15 });
    }
    ...
    if (block24.is_used()) {
        ...
        tmp29 = CodeStubAssembler(state_).Call(TNode<Context> { p_context }, TNode<Object> { p_callbackfn }, TNode<Object> { p_thisArg }, TNode<Object> { phi_bb24_24 },
            TNode<Object> { phi_bb24_6 }, TNode<Object> { tmp22 });
        tmp30 = ToBoolean_0(state_, TNode<Object> { tmp29 });
        ca_.Branch(
            tmp30, &block33, std::vector<compiler::Node*> { phi_bb24_6, phi_bb24_7, phi_bb24_15 }, &block34, std::vector<compiler::Node*> { phi_bb24_6, phi_bb24_7, phi_bb24_15 });
    }
    ...
    if (block33.is_used()) {
        ...
        ca_.Branch(
            tmp33, &block38, std::vector<compiler::Node*> { phi_bb33_6, phi_bb33_7, phi_bb33_15 }, &block39, std::vector<compiler::Node*> { phi_bb33_6, phi_bb33_7, phi_bb33_15 });
    }
    ...
    if (block39.is_used()) {
        ...
        ca_.Branch(
            tmp34, &block40, std::vector<compiler::Node*> { phi_bb39_6, phi_bb39_7, phi_bb39_15 }, &block41, std::vector<compiler::Node*> { phi_bb39_6, phi_bb39_7, phi_bb39_15 });
    }
...
TF_BUILTIN(ArrayFilter, CodeStubAssembler)
{
    ...
    if (block23.is_used()) {
        ...
        FastArrayFilter_0(state_, TNode<Context> { parameter0 }, TNode<JSArray> { tmp21 }, TNode<Smi> { tmp17 }, TNode<JSReceiver> { tmp7 }, TNode<Object> { tmp10 },
            TNode<JSArray> { tmp19 }, &label23, &tmp24, &tmp25);
        ca_.Goto(&block25);
        if (label23.is_used()) {
            ca_.Bind(&label23);
            ca_.Goto(&block26);
    ...
    if (block7.is_used()) {
        ...
        tmp26 = ca_.CallStub<Object>(
            Builtins::CallableFor(ca_.isolate(), Builtin::kArrayFilterLoopContinuation), parameter0, tmp1, tmp7, tmp10, phi_bb7_10, tmp1, phi_bb7_11, tmp2, phi_bb7_12);
    ...
    if (block2.is_used()) {
        ...
        tmp28 = CodeStubAssembler(state_).GetArgumentValue(TorqueStructArguments { TNode<RawPtrT> { torque_arguments.frame }, TNode<RawPtrT> { torque_arguments.base },
                                                               TNode<IntPtrT> { torque_arguments.length }, TNode<IntPtrT> { torque_arguments.actual_count } },
            TNode<IntPtrT> { tmp27 });
