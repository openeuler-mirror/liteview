...
TF_BUILTIN(ArraySomeLoopLazyDeoptContinuation, CodeStubAssembler)
{
    ...
    if (block18.is_used()) {
        ...
        tmp14
            = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtin::kArraySomeLoopContinuation), parameter0, tmp0, tmp2, parameter3, tmp12, tmp0, tmp11, tmp6, tmp13);
...
TNode<Object> FastArraySome_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSReceiver> p_o, TNode<Number> p_len, TNode<JSReceiver> p_callbackfn,
...
TF_BUILTIN(ArraySome, CodeStubAssembler)
{
    ...
    if (block10.is_used()) {
        ...
        tmp16 = ca_.CallStub<Object>(
            Builtins::CallableFor(ca_.isolate(), Builtin::kArraySomeLoopContinuation), parameter0, tmp1, tmp7, tmp10, tmp14, tmp1, tmp13.value(), tmp2, tmp15);
