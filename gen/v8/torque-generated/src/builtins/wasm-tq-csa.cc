...
TF_BUILTIN(CallRefIC, CodeStubAssembler)
{
    ...
    if (block60.is_used()) {
        ...
        ca_.Branch(tmp57, &block70, std::vector<compiler::Node*> { phi_bb60_5, phi_bb60_5, phi_bb60_5, phi_bb60_5, phi_bb60_5 }, &block71,
            std::vector<compiler::Node*> { phi_bb60_5, phi_bb60_5, phi_bb60_5, phi_bb60_5, phi_bb60_5 });
    }
    ...
    if (block119.is_used()) {
        ...
        tmp132 = CodeStubAssembler(state_).SmiConstant((CodeStubAssembler(state_).ConstexprInt31Mul(
    ...
    if (block175.is_used()) {
        ...
        ca_.Branch(tmp171, &block183, std::vector<compiler::Node*> { phi_bb175_8, phi_bb175_8, phi_bb175_8, phi_bb175_8, phi_bb175_8 }, &block184,
            std::vector<compiler::Node*> { phi_bb175_8, phi_bb175_8, phi_bb175_8, phi_bb175_8, phi_bb175_8 });
    }
    ...
    if (block183.is_used()) {
        ...
        ca_.Branch(tmp181, &block191, std::vector<compiler::Node*> { phi_bb183_8, phi_bb183_13, phi_bb183_14, phi_bb183_8, phi_bb183_8, phi_bb183_8, phi_bb183_8 }, &block192,
            std::vector<compiler::Node*> { phi_bb183_8, phi_bb183_13, phi_bb183_14, phi_bb183_8, phi_bb183_8, phi_bb183_8, phi_bb183_8 });
    }
...
TF_BUILTIN(ExperimentalWasmConvertArrayToString, CodeStubAssembler)
{
    ...
    if (block7.is_used()) {
        ...
        tmp7 = CodeStubAssembler(state_).GetArgumentValue(TorqueStructArguments { TNode<RawPtrT> { torque_arguments.frame }, TNode<RawPtrT> { torque_arguments.base },
                                                              TNode<IntPtrT> { torque_arguments.length }, TNode<IntPtrT> { torque_arguments.actual_count } },
            TNode<IntPtrT> { tmp6 });
        compiler::CodeAssemblerLabel label9(&ca_);
    ...
    if (block11.is_used()) {
        ...
        tmp11 = CodeStubAssembler(state_).GetArgumentValue(TorqueStructArguments { TNode<RawPtrT> { torque_arguments.frame }, TNode<RawPtrT> { torque_arguments.base },
                                                               TNode<IntPtrT> { torque_arguments.length }, TNode<IntPtrT> { torque_arguments.actual_count } },
            TNode<IntPtrT> { tmp10 });
    ...
    if (block18.is_used()) {
        ...
        std::tie(tmp27, tmp28, tmp29) = Subslice_char16_0(state_,
            ...
            TNode<IntPtrT> { tmp8 }, TNode<IntPtrT> { tmp12 }, &label30)
                                            .Flatten();
        ca_.Goto(&block21);
        if (label30.is_used()) {
            ca_.Bind(&label30);
    ...
    if (block21.is_used()) {
        ...
        tmp33 = AllocateSeqTwoByteString_SliceIterator_char16_ConstReference_char16_0(state_, TNode<Uint32T> { tmp26 },
            TorqueStructSliceIterator_char16_ConstReference_char16_0 { TNode<Object> { tmp27 }, TNode<IntPtrT> { tmp28 }, TNode<IntPtrT> { tmp32 }, TorqueStructUnsafe_0 {} });
...
TF_BUILTIN(ExperimentalWasmConvertStringToArray, CodeStubAssembler)
{
    ...
    if (block24.is_used()) {
        ...
        std::tie(tmp36, tmp37, tmp38) = Subslice_char8_0(state_,
            TorqueStructSlice_char8_ConstReference_char8_0 { TNode<Object> { tmp33 }, TNode<IntPtrT> { tmp34 }, TNode<IntPtrT> { tmp35 }, TorqueStructUnsafe_0 {} },
            TNode<IntPtrT> { phi_bb24_16 }, TNode<IntPtrT> { tmp27 }, &label39)
                                            .Flatten();
    ...
    if (block32.is_used()) {
        ...
        std::tie(tmp45, tmp46, tmp47) = Subslice_char16_0(state_,
            TorqueStructSlice_char16_ConstReference_char16_0 { TNode<Object> { tmp42 }, TNode<IntPtrT> { tmp43 }, TNode<IntPtrT> { tmp44 }, TorqueStructUnsafe_0 {} },
            TNode<IntPtrT> { phi_bb32_16 }, TNode<IntPtrT> { tmp27 }, &label48)
                                            .Flatten();
    ...
    if (block52.is_used()) {
        ...
        std::tie(tmp73, tmp74, tmp75) = Subslice_char8_0(state_,
            TorqueStructSlice_char8_ConstReference_char8_0 { TNode<Object> { tmp70 }, TNode<IntPtrT> { tmp71 }, TNode<IntPtrT> { tmp72 }, TorqueStructUnsafe_0 {} },
            TNode<IntPtrT> { phi_bb52_16 }, TNode<IntPtrT> { tmp27 }, &label76)
                                            .Flatten();
    ...
    if (block60.is_used()) {
        ...
        std::tie(tmp84, tmp85, tmp86) = Subslice_char16_0(state_,
            TorqueStructSlice_char16_ConstReference_char16_0 { TNode<Object> { tmp81 }, TNode<IntPtrT> { tmp82 }, TNode<IntPtrT> { tmp83 }, TorqueStructUnsafe_0 {} },
            TNode<IntPtrT> { phi_bb60_16 }, TNode<IntPtrT> { tmp27 }, &label87)
                                            .Flatten();
    ...
    if (block70.is_used()) {
        ...
        ca_.Branch(tmp92, &block68, std::vector<compiler::Node*> { phi_bb70_13, phi_bb70_14, phi_bb70_15, phi_bb70_16, phi_bb70_17, phi_bb70_20 }, &block69,
            std::vector<compiler::Node*> { phi_bb70_13, phi_bb70_14, phi_bb70_15, phi_bb70_16, phi_bb70_17, phi_bb70_20 });
    }
    ...
    if (block68.is_used()) {
        ...
        ca_.Branch(tmp93, &block74, std::vector<compiler::Node*> { phi_bb68_13, phi_bb68_14, phi_bb68_15, phi_bb68_16, phi_bb68_17, phi_bb68_20 }, &block75,
            std::vector<compiler::Node*> { phi_bb68_13, phi_bb68_14, phi_bb68_15, phi_bb68_16, phi_bb68_17, phi_bb68_20 });
    }
    ...
    if (block89.is_used()) {
        ...
        ca_.Branch(tmp109, &block87, std::vector<compiler::Node*> { phi_bb89_13, phi_bb89_14, phi_bb89_15, phi_bb89_16, phi_bb89_17, phi_bb89_20 }, &block88,
            std::vector<compiler::Node*> { phi_bb89_13, phi_bb89_14, phi_bb89_15, phi_bb89_16, phi_bb89_17, phi_bb89_20 });
    }
    ...
    if (block87.is_used()) {
        ...
        ca_.Branch(tmp110, &block93, std::vector<compiler::Node*> { phi_bb87_13, phi_bb87_14, phi_bb87_15, phi_bb87_16, phi_bb87_17, phi_bb87_20 }, &block94,
            std::vector<compiler::Node*> { phi_bb87_13, phi_bb87_14, phi_bb87_15, phi_bb87_16, phi_bb87_17, phi_bb87_20 });
    }
...
TF_BUILTIN(WasmStringEncodeWtf16Array, CodeStubAssembler)
{
    ...
    if (block16.is_used()) {
        ...
        std::tie(tmp32, tmp33, tmp34) = Subslice_char8_0(state_,
            TorqueStructSlice_char8_ConstReference_char8_0 { TNode<Object> { tmp29 }, TNode<IntPtrT> { tmp30 }, TNode<IntPtrT> { tmp31 }, TorqueStructUnsafe_0 {} },
            TNode<IntPtrT> { phi_bb16_10 }, TNode<IntPtrT> { tmp23 }, &label35)
                                            .Flatten();
    ...
    if (block24.is_used()) {
        ...
        std::tie(tmp41, tmp42, tmp43) = Subslice_char16_0(state_,
            TorqueStructSlice_char16_ConstReference_char16_0 { TNode<Object> { tmp38 }, TNode<IntPtrT> { tmp39 }, TNode<IntPtrT> { tmp40 }, TorqueStructUnsafe_0 {} },
            TNode<IntPtrT> { phi_bb24_10 }, TNode<IntPtrT> { tmp23 }, &label44)
                                            .Flatten();
    ...
    if (block44.is_used()) {
        ...
        std::tie(tmp69, tmp70, tmp71) = Subslice_char8_0(state_,
            TorqueStructSlice_char8_ConstReference_char8_0 { TNode<Object> { tmp66 }, TNode<IntPtrT> { tmp67 }, TNode<IntPtrT> { tmp68 }, TorqueStructUnsafe_0 {} },
            TNode<IntPtrT> { phi_bb44_10 }, TNode<IntPtrT> { tmp23 }, &label72)
                                            .Flatten();
    ...
    if (block52.is_used()) {
        ...
        std::tie(tmp80, tmp81, tmp82) = Subslice_char16_0(state_,
            TorqueStructSlice_char16_ConstReference_char16_0 { TNode<Object> { tmp77 }, TNode<IntPtrT> { tmp78 }, TNode<IntPtrT> { tmp79 }, TorqueStructUnsafe_0 {} },
            TNode<IntPtrT> { phi_bb52_10 }, TNode<IntPtrT> { tmp23 }, &label83)
                                            .Flatten();
    ...
    if (block62.is_used()) {
        ...
        ca_.Branch(tmp88, &block60, std::vector<compiler::Node*> { phi_bb62_7, phi_bb62_8, phi_bb62_9, phi_bb62_10, phi_bb62_11, phi_bb62_14 }, &block61,
    ...
    if (block60.is_used()) {
        ...
        ca_.Branch(tmp89, &block66, std::vector<compiler::Node*> { phi_bb60_7, phi_bb60_8, phi_bb60_9, phi_bb60_10, phi_bb60_11, phi_bb60_14 }, &block67,
    ...
    if (block81.is_used()) {
        ...
        ca_.Branch(tmp105, &block79, std::vector<compiler::Node*> { phi_bb81_7, phi_bb81_8, phi_bb81_9, phi_bb81_10, phi_bb81_11, phi_bb81_14 }, &block80,
    ...
    if (block79.is_used()) {
        ...
        ca_.Branch(tmp106, &block85, std::vector<compiler::Node*> { phi_bb79_7, phi_bb79_8, phi_bb79_9, phi_bb79_10, phi_bb79_11, phi_bb79_14 }, &block86,
    ...
    if (block7.is_used()) {
        ca_.Bind(&block7);
        tmp116 = FromConstexpr_intptr_constexpr_int31_0(state_, 8);
...
TF_BUILTIN(WasmStringAsIter, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ...
        tmp5 = FromConstexpr_intptr_constexpr_int31_0(state_, 4);
        CodeStubAssembler(state_).StoreReference<String>(CodeStubAssembler::Reference { tmp3, tmp5 }, parameter0);
        tmp6 = FromConstexpr_intptr_constexpr_int31_0(state_, 8);
        tmp7 = FromConstexpr_uint32_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x0ull));
        CodeStubAssembler(state_).StoreReference<Uint32T>(CodeStubAssembler::Reference { tmp3, tmp6 }, tmp7);
    ...
    compiler::CodeAssemblerState* state_, TNode<Object> p_object, TNode<IntPtrT> p_offset, TNode<IntPtrT> p_length)
{
    ...
    if (block0.is_used()) {
        ...
        std::tie(tmp0, tmp1, tmp2)
            = (TorqueStructSlice_char16_ConstReference_char16_0 { TNode<Object> { p_object }, TNode<IntPtrT> { p_offset }, TNode<IntPtrT> { p_length }, TorqueStructUnsafe_0 {} })
                  .Flatten();
        ca_.Goto(&block2);
    }
    ...
    compiler::CodeAssemblerState* state_, TNode<Object> p_object, TNode<IntPtrT> p_offset, TNode<IntPtrT> p_length)
{
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        std::tie(tmp0, tmp1, tmp2)
            = (TorqueStructSlice_char16_MutableReference_char16_0 { TNode<Object> { p_object }, TNode<IntPtrT> { p_offset }, TNode<IntPtrT> { p_length }, TorqueStructUnsafe_0 {} })
                  .Flatten();
        ca_.Goto(&block2);
    }
