...
TorqueStructTypedArrayAccessor_0 GetTypedArrayAccessor_Float32Elements_0(compiler::CodeAssemblerState* state_)
{
    ...
    ca_.Bind(&block2);
    return TorqueStructTypedArrayAccessor_0 { TNode<BuiltinPtr> { ca_.UncheckedCast<BuiltinPtr>(ca_.SmiConstant(Builtin::kLoadTypedElement_Float32Elements_0)) },
...
TorqueStructTypedArrayAccessor_0 GetTypedArrayAccessor_Float64Elements_0(compiler::CodeAssemblerState* state_)
{
    ...
    ca_.Bind(&block2);
    return TorqueStructTypedArrayAccessor_0 { TNode<BuiltinPtr> { ca_.UncheckedCast<BuiltinPtr>(ca_.SmiConstant(Builtin::kLoadTypedElement_Float64Elements_0)) },
...
TorqueStructTypedArrayAccessor_0 GetTypedArrayAccessor_Uint8ClampedElements_0(compiler::CodeAssemblerState* state_)
{
    ...
    ca_.Bind(&block2);
    return TorqueStructTypedArrayAccessor_0 { TNode<BuiltinPtr> { ca_.UncheckedCast<BuiltinPtr>(ca_.SmiConstant(Builtin::kLoadTypedElement_Uint8ClampedElements_0)) },
...
TorqueStructTypedArrayAccessor_0 GetTypedArrayAccessor_BigUint64Elements_0(compiler::CodeAssemblerState* state_)
{
    ...
    ca_.Bind(&block2);
    return TorqueStructTypedArrayAccessor_0 { TNode<BuiltinPtr> { ca_.UncheckedCast<BuiltinPtr>(ca_.SmiConstant(Builtin::kLoadTypedElement_BigUint64Elements_0)) },
...
TorqueStructTypedArrayAccessor_0 GetTypedArrayAccessor_BigInt64Elements_0(compiler::CodeAssemblerState* state_)
{
    ...
    ca_.Bind(&block2);
    return TorqueStructTypedArrayAccessor_0 { TNode<BuiltinPtr> { ca_.UncheckedCast<BuiltinPtr>(ca_.SmiConstant(Builtin::kLoadTypedElement_BigInt64Elements_0)) },
...
TF_BUILTIN(StoreTypedElementNumeric_Int32Elements_0, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        TypedArrayBuiltinsAssembler(state_).StoreJSTypedArrayElementFromNumeric(TNode<Context> { parameter0 }, TNode<JSTypedArray> { parameter1 }, TNode<UintPtrT> { parameter2 },
            TNode<Numeric> { parameter3 }, (KindForArrayType_Int32Elements_0(state_)));
...
TF_BUILTIN(StoreTypedElementJSAny_Int32Elements_0, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        compiler::CodeAssemblerLabel label0(&ca_);
        TypedArrayBuiltinsAssembler(state_).StoreJSTypedArrayElementFromTagged(TNode<Context> { parameter0 }, TNode<JSTypedArray> { parameter1 }, TNode<UintPtrT> { parameter2 },
            TNode<Object> { parameter3 }, (KindForArrayType_Int32Elements_0(state_)), &label0);
        ca_.Goto(&block3);
        if (label0.is_used()) {
            ca_.Bind(&label0);
            ca_.Goto(&block4);
...
TF_BUILTIN(StoreTypedElementNumeric_Float32Elements_0, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        TypedArrayBuiltinsAssembler(state_).StoreJSTypedArrayElementFromNumeric(TNode<Context> { parameter0 }, TNode<JSTypedArray> { parameter1 }, TNode<UintPtrT> { parameter2 },
            TNode<Numeric> { parameter3 }, (KindForArrayType_Float32Elements_0(state_)));
        tmp0 = kStoreSucceded_0(state_);
        CodeStubAssembler(state_).Return(tmp0);
    }
}
...
TF_BUILTIN(StoreTypedElementJSAny_Float32Elements_0, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ...
        compiler::CodeAssemblerLabel label0(&ca_);
        TypedArrayBuiltinsAssembler(state_).StoreJSTypedArrayElementFromTagged(TNode<Context> { parameter0 }, TNode<JSTypedArray> { parameter1 }, TNode<UintPtrT> { parameter2 },
            TNode<Object> { parameter3 }, (KindForArrayType_Float32Elements_0(state_)), &label0);
        ca_.Goto(&block3);
        if (label0.is_used()) {
            ca_.Bind(&label0);
            ca_.Goto(&block4);
...
TF_BUILTIN(StoreTypedElementNumeric_Float64Elements_0, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        TypedArrayBuiltinsAssembler(state_).StoreJSTypedArrayElementFromNumeric(TNode<Context> { parameter0 }, TNode<JSTypedArray> { parameter1 }, TNode<UintPtrT> { parameter2 },
            TNode<Numeric> { parameter3 }, (KindForArrayType_Float64Elements_0(state_)));
        tmp0 = kStoreSucceded_0(state_);
        CodeStubAssembler(state_).Return(tmp0);
    }
}
...
TF_BUILTIN(StoreTypedElementJSAny_Float64Elements_0, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ...
        compiler::CodeAssemblerLabel label0(&ca_);
        TypedArrayBuiltinsAssembler(state_).StoreJSTypedArrayElementFromTagged(TNode<Context> { parameter0 }, TNode<JSTypedArray> { parameter1 }, TNode<UintPtrT> { parameter2 },
            TNode<Object> { parameter3 }, (KindForArrayType_Float64Elements_0(state_)), &label0);
        ca_.Goto(&block3);
        if (label0.is_used()) {
            ca_.Bind(&label0);
            ca_.Goto(&block4);
...
TF_BUILTIN(StoreTypedElementNumeric_Uint8ClampedElements_0, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        TypedArrayBuiltinsAssembler(state_).StoreJSTypedArrayElementFromNumeric(TNode<Context> { parameter0 }, TNode<JSTypedArray> { parameter1 }, TNode<UintPtrT> { parameter2 },
            TNode<Numeric> { parameter3 }, (KindForArrayType_Uint8ClampedElements_0(state_)));
        tmp0 = kStoreSucceded_0(state_);
        CodeStubAssembler(state_).Return(tmp0);
    }
}
...
TF_BUILTIN(StoreTypedElementJSAny_Uint8ClampedElements_0, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ...
        compiler::CodeAssemblerLabel label0(&ca_);
        TypedArrayBuiltinsAssembler(state_).StoreJSTypedArrayElementFromTagged(TNode<Context> { parameter0 }, TNode<JSTypedArray> { parameter1 }, TNode<UintPtrT> { parameter2 },
            TNode<Object> { parameter3 }, (KindForArrayType_Uint8ClampedElements_0(state_)), &label0);
        ca_.Goto(&block3);
        if (label0.is_used()) {
            ca_.Bind(&label0);
            ca_.Goto(&block4);
...
TF_BUILTIN(LoadTypedElement_BigUint64Elements_0, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ...
        tmp0 = CodeStubAssembler(state_).LoadJSTypedArrayDataPtr(TNode<JSTypedArray> { parameter0 });
        tmp1
            = CodeStubAssembler(state_).LoadFixedTypedArrayElementAsTagged(TNode<RawPtrT> { tmp0 }, TNode<UintPtrT> { parameter1 }, (KindForArrayType_BigUint64Elements_0(state_)));
        CodeStubAssembler(state_).Return(tmp1);
    }
}
...
TF_BUILTIN(StoreTypedElementNumeric_BigUint64Elements_0, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        TypedArrayBuiltinsAssembler(state_).StoreJSTypedArrayElementFromNumeric(TNode<Context> { parameter0 }, TNode<JSTypedArray> { parameter1 }, TNode<UintPtrT> { parameter2 },
            TNode<Numeric> { parameter3 }, (KindForArrayType_BigUint64Elements_0(state_)));
        tmp0 = kStoreSucceded_0(state_);
        CodeStubAssembler(state_).Return(tmp0);
    }
}
...
TF_BUILTIN(StoreTypedElementJSAny_BigUint64Elements_0, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ...
        compiler::CodeAssemblerLabel label0(&ca_);
        TypedArrayBuiltinsAssembler(state_).StoreJSTypedArrayElementFromTagged(TNode<Context> { parameter0 }, TNode<JSTypedArray> { parameter1 }, TNode<UintPtrT> { parameter2 },
            TNode<Object> { parameter3 }, (KindForArrayType_BigUint64Elements_0(state_)), &label0);
        ca_.Goto(&block3);
        if (label0.is_used()) {
            ca_.Bind(&label0);
            ca_.Goto(&block4);
...
TF_BUILTIN(StoreTypedElementNumeric_BigInt64Elements_0, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        TypedArrayBuiltinsAssembler(state_).StoreJSTypedArrayElementFromNumeric(TNode<Context> { parameter0 }, TNode<JSTypedArray> { parameter1 }, TNode<UintPtrT> { parameter2 },
            TNode<Numeric> { parameter3 }, (KindForArrayType_BigInt64Elements_0(state_)));
        tmp0 = kStoreSucceded_0(state_);
        CodeStubAssembler(state_).Return(tmp0);
    }
}
...
TF_BUILTIN(StoreTypedElementJSAny_BigInt64Elements_0, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ...
        compiler::CodeAssemblerLabel label0(&ca_);
        TypedArrayBuiltinsAssembler(state_).StoreJSTypedArrayElementFromTagged(TNode<Context> { parameter0 }, TNode<JSTypedArray> { parameter1 }, TNode<UintPtrT> { parameter2 },
            TNode<Object> { parameter3 }, (KindForArrayType_BigInt64Elements_0(state_)), &label0);
        ca_.Goto(&block3);
        if (label0.is_used()) {
            ca_.Bind(&label0);
            ca_.Goto(&block4);
...
TF_BUILTIN(StoreTypedElementNumeric_Uint8Elements_0, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        TypedArrayBuiltinsAssembler(state_).StoreJSTypedArrayElementFromNumeric(TNode<Context> { parameter0 }, TNode<JSTypedArray> { parameter1 }, TNode<UintPtrT> { parameter2 },
            TNode<Numeric> { parameter3 }, (KindForArrayType_Uint8Elements_0(state_)));
        tmp0 = kStoreSucceded_0(state_);
        CodeStubAssembler(state_).Return(tmp0);
    }
}
...
TF_BUILTIN(StoreTypedElementJSAny_Uint8Elements_0, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ...
        compiler::CodeAssemblerLabel label0(&ca_);
        TypedArrayBuiltinsAssembler(state_).StoreJSTypedArrayElementFromTagged(TNode<Context> { parameter0 }, TNode<JSTypedArray> { parameter1 }, TNode<UintPtrT> { parameter2 },
            TNode<Object> { parameter3 }, (KindForArrayType_Uint8Elements_0(state_)), &label0);
        ca_.Goto(&block3);
        if (label0.is_used()) {
            ca_.Bind(&label0);
            ca_.Goto(&block4);
...
TF_BUILTIN(StoreTypedElementNumeric_Int8Elements_0, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        TypedArrayBuiltinsAssembler(state_).StoreJSTypedArrayElementFromNumeric(TNode<Context> { parameter0 }, TNode<JSTypedArray> { parameter1 }, TNode<UintPtrT> { parameter2 },
            TNode<Numeric> { parameter3 }, (KindForArrayType_Int8Elements_0(state_)));
        tmp0 = kStoreSucceded_0(state_);
        CodeStubAssembler(state_).Return(tmp0);
    }
}
...
TF_BUILTIN(StoreTypedElementJSAny_Int8Elements_0, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ...
        compiler::CodeAssemblerLabel label0(&ca_);
        TypedArrayBuiltinsAssembler(state_).StoreJSTypedArrayElementFromTagged(TNode<Context> { parameter0 }, TNode<JSTypedArray> { parameter1 }, TNode<UintPtrT> { parameter2 },
            TNode<Object> { parameter3 }, (KindForArrayType_Int8Elements_0(state_)), &label0);
        ca_.Goto(&block3);
        if (label0.is_used()) {
            ca_.Bind(&label0);
            ca_.Goto(&block4);
...
TF_BUILTIN(StoreTypedElementNumeric_Uint16Elements_0, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        TypedArrayBuiltinsAssembler(state_).StoreJSTypedArrayElementFromNumeric(TNode<Context> { parameter0 }, TNode<JSTypedArray> { parameter1 }, TNode<UintPtrT> { parameter2 },
            TNode<Numeric> { parameter3 }, (KindForArrayType_Uint16Elements_0(state_)));
        tmp0 = kStoreSucceded_0(state_);
        CodeStubAssembler(state_).Return(tmp0);
    }
}
...
TF_BUILTIN(StoreTypedElementJSAny_Uint16Elements_0, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ...
        compiler::CodeAssemblerLabel label0(&ca_);
        TypedArrayBuiltinsAssembler(state_).StoreJSTypedArrayElementFromTagged(TNode<Context> { parameter0 }, TNode<JSTypedArray> { parameter1 }, TNode<UintPtrT> { parameter2 },
            TNode<Object> { parameter3 }, (KindForArrayType_Uint16Elements_0(state_)), &label0);
        ca_.Goto(&block3);
        if (label0.is_used()) {
            ca_.Bind(&label0);
            ca_.Goto(&block4);
...
TF_BUILTIN(StoreTypedElementNumeric_Int16Elements_0, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        TypedArrayBuiltinsAssembler(state_).StoreJSTypedArrayElementFromNumeric(TNode<Context> { parameter0 }, TNode<JSTypedArray> { parameter1 }, TNode<UintPtrT> { parameter2 },
            TNode<Numeric> { parameter3 }, (KindForArrayType_Int16Elements_0(state_)));
        tmp0 = kStoreSucceded_0(state_);
        CodeStubAssembler(state_).Return(tmp0);
    }
}
...
TF_BUILTIN(StoreTypedElementJSAny_Int16Elements_0, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ...
        compiler::CodeAssemblerLabel label0(&ca_);
        TypedArrayBuiltinsAssembler(state_).StoreJSTypedArrayElementFromTagged(TNode<Context> { parameter0 }, TNode<JSTypedArray> { parameter1 }, TNode<UintPtrT> { parameter2 },
            TNode<Object> { parameter3 }, (KindForArrayType_Int16Elements_0(state_)), &label0);
        ca_.Goto(&block3);
        if (label0.is_used()) {
            ca_.Bind(&label0);
            ca_.Goto(&block4);
...
TF_BUILTIN(StoreTypedElementNumeric_Uint32Elements_0, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        TypedArrayBuiltinsAssembler(state_).StoreJSTypedArrayElementFromNumeric(TNode<Context> { parameter0 }, TNode<JSTypedArray> { parameter1 }, TNode<UintPtrT> { parameter2 },
            TNode<Numeric> { parameter3 }, (KindForArrayType_Uint32Elements_0(state_)));
        tmp0 = kStoreSucceded_0(state_);
        CodeStubAssembler(state_).Return(tmp0);
    }
}
...
TF_BUILTIN(StoreTypedElementJSAny_Uint32Elements_0, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ...
        compiler::CodeAssemblerLabel label0(&ca_);
        TypedArrayBuiltinsAssembler(state_).StoreJSTypedArrayElementFromTagged(TNode<Context> { parameter0 }, TNode<JSTypedArray> { parameter1 }, TNode<UintPtrT> { parameter2 },
            TNode<Object> { parameter3 }, (KindForArrayType_Uint32Elements_0(state_)), &label0);
        ca_.Goto(&block3);
        if (label0.is_used()) {
            ca_.Bind(&label0);
            ca_.Goto(&block4);
