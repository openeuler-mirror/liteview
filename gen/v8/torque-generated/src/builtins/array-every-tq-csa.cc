...
TF_BUILTIN(ArrayEveryLoopLazyDeoptContinuation, CodeStubAssembler)
{
    ...
    if (block18.is_used()) {
        ...
        tmp15
            = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtin::kArrayEveryLoopContinuation), parameter0, tmp0, tmp2, parameter3, tmp13, tmp0, tmp12, tmp6, tmp14);
...
TNode<Object> FastArrayEvery_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSReceiver> p_o, TNode<Number> p_len, TNode<JSReceiver> p_callbackfn,
...
TF_BUILTIN(ArrayEvery, CodeStubAssembler)
{
    ...
    if (block5.is_used()) {
        ...
        tmp11 = FastArrayEvery_0(
            state_, TNode<Context> { parameter0 }, TNode<JSReceiver> { tmp1 }, TNode<Number> { tmp2 }, TNode<JSReceiver> { tmp7 }, TNode<Object> { tmp10 }, &label12, &tmp13);
        ca_.Goto(&block9);
        if (label12.is_used()) {
            ca_.Bind(&label12);
            ca_.Goto(&block10);
    ...
    if (block10.is_used()) {
        ...
        tmp16 = ca_.CallStub<Object>(
            Builtins::CallableFor(ca_.isolate(), Builtin::kArrayEveryLoopContinuation), parameter0, tmp1, tmp7, tmp10, tmp14, tmp1, tmp13.value(), tmp2, tmp15);
    ...
    if (block2.is_used()) {
        ...
        tmp18 = CodeStubAssembler(state_).GetArgumentValue(TorqueStructArguments { TNode<RawPtrT> { torque_arguments.frame }, TNode<RawPtrT> { torque_arguments.base },
                                                               TNode<IntPtrT> { torque_arguments.length }, TNode<IntPtrT> { torque_arguments.actual_count } },
            TNode<IntPtrT> { tmp17 });
