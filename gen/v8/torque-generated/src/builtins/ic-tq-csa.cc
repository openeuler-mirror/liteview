...
void CollectCallFeedback_1(compiler::CodeAssemblerState* state_, TNode<Object> p_maybeTarget, std::function<TNode<Object>()> p_maybeReceiver, TNode<Context> p_context,
...
void CollectInstanceOfFeedback_1(
    ...
    compiler::CodeAssemblerLabel* label_ConstructArray, compiler::TypedCodeAssemblerVariable<AllocationSite>* label_ConstructArray_parameter_0)
{
    ...
    if (block0.is_used()) {
        ...
        CollectConstructFeedback_0(state_, TNode<Context> { p_context }, TNode<Object> { p_target }, TNode<Object> { p_newTarget }, TNode<HeapObject> { p_maybeFeedbackVector },
            TNode<UintPtrT> { p_slotId }, p_updateFeedbackMode, &label0, &label1, &tmp2);
        if (label0.is_used()) {
            ca_.Bind(&label0);
            ca_.Goto(&block3);
        }
