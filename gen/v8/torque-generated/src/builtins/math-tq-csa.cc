...
TF_BUILTIN(MathHypot, CodeStubAssembler)
{
    ...
    if (block3.is_used()) {
        ...
        tmp8 = CodeStubAssembler(state_).GetArgumentValue(TorqueStructArguments { TNode<RawPtrT> { torque_arguments.frame }, TNode<RawPtrT> { torque_arguments.base },
                                                              TNode<IntPtrT> { torque_arguments.length }, TNode<IntPtrT> { torque_arguments.actual_count } },
            TNode<IntPtrT> { phi_bb3_10 });
    ...
    if (block14.is_used()) {
        ...
        ca_.Branch(
            tmp26, &block18, std::vector<compiler::Node*> { phi_bb14_8, phi_bb14_9, phi_bb14_10 }, &block19, std::vector<compiler::Node*> { phi_bb14_8, phi_bb14_9, phi_bb14_10 });
    }
    ...
    if (block32.is_used()) {
        ...
        ca_.Branch(tmp45, &block40,
            std::vector<compiler::Node*> { phi_bb32_8, phi_bb32_9, phi_bb32_10, phi_bb32_11, phi_bb32_12, phi_bb32_12, phi_bb32_12, phi_bb32_12, phi_bb32_12 }, &block41,
    ...
    if (block40.is_used()) {
        ...
        std::tie(tmp50, tmp51)
            = LoadFloat64OrHole_0(state_, TorqueStructReference_float64_or_hole_0 { TNode<Object> { tmp48 }, TNode<IntPtrT> { tmp49 }, TorqueStructUnsafe_0 {} }).Flatten();
...
TF_BUILTIN(MathRandom, CodeStubAssembler)
{
    ...
    if (block7.is_used()) {
        ...
        std::tie(tmp27, tmp28)
            = LoadFloat64OrHole_0(state_, TorqueStructReference_float64_or_hole_0 { TNode<Object> { tmp25 }, TNode<IntPtrT> { tmp26 }, TorqueStructUnsafe_0 {} }).Flatten();
