...
void MorphAndEnqueuePromiseReaction_0(
    compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<PromiseReaction> p_promiseReaction, TNode<Object> p_argument, PromiseReaction::Type p_reactionType)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    if (block3.is_used()) {
        ...
        CodeStubAssembler(state_).StaticAssert(TNode<BoolT> { tmp4 },
            ...
            "https://source.chromium.org/chromium/chromium/src/+/main:v8/src/builtins/promise-abstract-operations.tq?l=103&c=5");
    ...
    if (block4.is_used()) {
        ...
        CodeStubAssembler(state_).StaticAssert(TNode<BoolT> { tmp10 },
            ...
            "https://source.chromium.org/chromium/chromium/src/+/main:v8/src/builtins/promise-abstract-operations.tq?l=117&c=3");
        if (((CodeStubAssembler(state_).ConstexprInt31Equal(p_reactionType, PromiseReaction::kFulfill)))) {
            ca_.Goto(&block5);
        } else {
            ca_.Goto(&block6);
    ...
    if (block5.is_used()) {
        ...
        std::tie(tmp12, tmp13)
            = UnsafeConstCast_Map_0(state_, TorqueStructReference_Map_0 { TNode<Object> { p_promiseReaction }, TNode<IntPtrT> { tmp11 }, TorqueStructUnsafe_0 {} }).Flatten();
        ...
        tmp20 = FromConstexpr_bool_constexpr_bool_0(
            state_, (CodeStubAssembler(state_).ConstexprInt31Equal(PromiseReaction::kPromiseOrCapabilityOffset, PromiseReactionJobTask::kPromiseOrCapabilityOffset)));
        CodeStubAssembler(state_).StaticAssert(TNode<BoolT> { tmp20 },
            ...
            "https://source.chromium.org/chromium/chromium/src/+/main:v8/src/builtins/promise-abstract-operations.tq?l=131&c=5");
        ca_.Goto(&block7);
    }
    ...
    if (block6.is_used()) {
        ...
        CodeStubAssembler(state_).StaticAssert(TNode<BoolT> { tmp21 },
            "static_assert(reactionType == kPromiseReactionReject) at "
            "https://source.chromium.org/chromium/chromium/src/+/main:v8/src/builtins/promise-abstract-operations.tq?l=135&c=5");
        tmp22 = FromConstexpr_intptr_constexpr_int31_0(state_, 0);
        std::tie(tmp23, tmp24)
            = UnsafeConstCast_Map_0(state_, TorqueStructReference_Map_0 { TNode<Object> { p_promiseReaction }, TNode<IntPtrT> { tmp22 }, TorqueStructUnsafe_0 {} }).Flatten();
        ...
        tmp31 = FromConstexpr_bool_constexpr_bool_0(
            state_, (CodeStubAssembler(state_).ConstexprInt31Equal(PromiseReaction::kPromiseOrCapabilityOffset, PromiseReactionJobTask::kPromiseOrCapabilityOffset)));
        CodeStubAssembler(state_).StaticAssert(TNode<BoolT> { tmp31 },
            "static_assert(kPromiseReactionPromiseOrCapabilityOffset ==\n        kPromiseReactionJobTaskPromiseOrCapabilityOffset) at "
            "https://source.chromium.org/chromium/chromium/src/+/main:v8/src/builtins/promise-abstract-operations.tq?l=144&c=5");
        ca_.Goto(&block7);
    }
    ...
    compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_reactions, TNode<Object> p_argument, PromiseReaction::Type p_reactionType)
{
    ...
    if (block15.is_used()) {
        ...
        MorphAndEnqueuePromiseReaction_0(
            state_, TNode<Context> { p_context }, TNode<PromiseReaction> { ca_.UncheckedCast<PromiseReaction>(phi_bb15_5) }, TNode<Object> { p_argument }, p_reactionType);
...
TorqueStructPromiseResolvingFunctions CreatePromiseResolvingFunctions_0(
    compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSPromise> p_promise, TNode<Oddball> p_debugEvent, TNode<NativeContext> p_nativeContext)
{
    ...
    if (block0.is_used()) {
        ...
        tmp0 = CreatePromiseResolvingFunctionsContext_0(
            state_, TNode<Context> { p_context }, TNode<JSPromise> { p_promise }, TNode<Oddball> { p_debugEvent }, TNode<NativeContext> { p_nativeContext });
...
TNode<PromiseCapability> InnerNewPromiseCapability_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<HeapObject> p_constructor, TNode<Oddball> p_debugEvent)
{
    ...
    if (block2.is_used()) {
        ...
        std::tie(tmp7, tmp8)
            = CreatePromiseResolvingFunctions_0(state_, TNode<Context> { p_context }, TNode<JSPromise> { tmp6 }, TNode<Oddball> { p_debugEvent }, TNode<NativeContext> { tmp0 })
                  .Flatten();
...
TF_BUILTIN(PromiseCapabilityDefaultReject, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ...
        std::tie(tmp2, tmp3)
            = ContextSlot_PromiseResolvingFunctionContext_PromiseResolvingFunctionContext_JSPromise_0(state_, TNode<Context> { tmp0 }, TNode<IntPtrT> { tmp1 }).Flatten();
        ...
        std::tie(tmp6, tmp7)
            = ContextSlot_PromiseResolvingFunctionContext_PromiseResolvingFunctionContext_Boolean_0(state_, TNode<Context> { tmp0 }, TNode<IntPtrT> { tmp5 }).Flatten();
    ...
    if (block2.is_used()) {
        ...
        std::tie(tmp13, tmp14)
            = ContextSlot_PromiseResolvingFunctionContext_PromiseResolvingFunctionContext_Boolean_0(state_, TNode<Context> { tmp0 }, TNode<IntPtrT> { tmp12 }).Flatten();
        tmp15 = True_0(state_);
        ...
        std::tie(tmp17, tmp18)
            = ContextSlot_PromiseResolvingFunctionContext_PromiseResolvingFunctionContext_Boolean_0(state_, TNode<Context> { tmp0 }, TNode<IntPtrT> { tmp16 }).Flatten();
    ...
    TNode<HeapObject> p_onRejected, TNode<HeapObject> p_resultPromiseOrCapability)
{
    ...
    if (block2.is_used()) {
        ...
        tmp7 = NewPromiseReaction_0(state_, TNode<Context> { p_context }, TNode<Context> { tmp3 }, TNode<Object> { tmp6 }, TNode<HeapObject> { p_resultPromiseOrCapability },
    ...
    if (block5.is_used()) {
        ...
        tmp15 = NewPromiseFulfillReactionJobTask_0(state_, TNode<Context> { p_context }, TNode<Context> { tmp14 }, TNode<Object> { tmp10 }, TNode<HeapObject> { p_onFulfilled },
    ...
    if (block6.is_used()) {
        ...
        tmp17 = NewPromiseRejectReactionJobTask_0(state_, TNode<Context> { p_context }, TNode<Context> { tmp16 }, TNode<Object> { tmp10 }, TNode<HeapObject> { p_onRejected },
            TNode<HeapObject> { p_resultPromiseOrCapability });
...
TF_BUILTIN(PerformPromiseThen, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        PerformPromiseThenImpl_0(state_, TNode<Context> { parameter0 }, TNode<JSPromise> { parameter1 }, TNode<HeapObject> { parameter2 }, TNode<HeapObject> { parameter3 },
            TNode<HeapObject> { parameter4 });
...
TF_BUILTIN(PromiseGetCapabilitiesExecutor, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ...
        std::tie(tmp2, tmp3)
            = ContextSlot_PromiseCapabilitiesExecutorContext_PromiseCapabilitiesExecutorContext_PromiseCapability_0(state_, TNode<Context> { tmp0 }, TNode<IntPtrT> { tmp1 })
                  .Flatten();
...
TF_BUILTIN(PromiseConstructorLazyDeoptContinuation, CodeStubAssembler)
{
    ...
    if (block4.is_used()) {
        ...
        tmp3 = CodeStubAssembler(state_).Call(
            TNode<Context> { parameter0 }, TNode<Object> { parameter3 }, TNode<Object> { tmp2 }, TNode<Object> { ca_.UncheckedCast<Object>(parameter4) });
        ca_.Goto(&block1);
    }
    ...
    compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<IntPtrT> p_index)
{
    ...
    if (block6.is_used()) {
        ...
        std::tie(tmp8, tmp9) = NewReference_Object_0(state_, TNode<Object> { tmp0 }, TNode<IntPtrT> { tmp7 }).Flatten();
        std::tie(tmp10, tmp11)
            = ReferenceCast_JSPromise_Object_0(state_, TorqueStructReference_Object_0 { TNode<Object> { tmp8 }, TNode<IntPtrT> { tmp9 }, TorqueStructUnsafe_0 {} }).Flatten();
        ca_.Goto(&block10);
    }
    ...
    compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<IntPtrT> p_index)
{
    ...
    if (block6.is_used()) {
        ...
        std::tie(tmp8, tmp9) = NewReference_Object_0(state_, TNode<Object> { tmp0 }, TNode<IntPtrT> { tmp7 }).Flatten();
        std::tie(tmp10, tmp11)
            = ReferenceCast_Boolean_Object_0(state_, TorqueStructReference_Object_0 { TNode<Object> { tmp8 }, TNode<IntPtrT> { tmp9 }, TorqueStructUnsafe_0 {} }).Flatten();
        ca_.Goto(&block10);
    }
    ...
    compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<IntPtrT> p_index)
{
    ...
    if (block6.is_used()) {
        ...
        std::tie(tmp8, tmp9) = NewReference_Object_0(state_, TNode<Object> { tmp0 }, TNode<IntPtrT> { tmp7 }).Flatten();
        std::tie(tmp10, tmp11)
            = ReferenceCast_PromiseCapability_Object_0(state_, TorqueStructReference_Object_0 { TNode<Object> { tmp8 }, TNode<IntPtrT> { tmp9 }, TorqueStructUnsafe_0 {} })
                  .Flatten();
        ca_.Goto(&block10);
    }
