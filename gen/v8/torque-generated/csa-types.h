...
struct TorqueStructBuffer_0 {
    ...
    std::tuple<TNode<FixedArray>, TNode<IntPtrT>, TNode<IntPtrT>, TNode<BoolT>> Flatten() const { return std::make_tuple(fixedArray, index, totalStringLength, isOneByte); }
};
struct TorqueStructVector_0 {
    ...
    std::tuple<TNode<FixedArray>, TNode<BoolT>, TNode<BoolT>, TNode<BoolT>> Flatten() const { return std::make_tuple(fixedArray, onlySmis, onlyNumbers, skippedElements); }
};
struct TorqueStructfloat64_or_hole_0 {
    TNode<BoolT> is_hole;
    TNode<Float64T> value;

    std::tuple<TNode<BoolT>, TNode<Float64T>> Flatten() const { return std::make_tuple(is_hole, value); }
};
struct TorqueStructKeyValuePair {
    TNode<Object> key;
    TNode<Object> value;

    std::tuple<TNode<Object>, TNode<Object>> Flatten() const { return std::make_tuple(key, value); }
};
struct TorqueStructToBooleanForBaselineJumpResult_0 {
    TNode<Object> value;
    TNode<Smi> is_to_boolean;

    std::tuple<TNode<Object>, TNode<Smi>> Flatten() const { return std::make_tuple(value, is_to_boolean); }
};
struct TorqueStructArguments {
    ...
    std::tuple<TNode<RawPtrT>, TNode<RawPtrT>, TNode<IntPtrT>, TNode<IntPtrT>> Flatten() const { return std::make_tuple(frame, base, length, actual_count); }
};
...
struct TorqueStructFrameWithArgumentsInfo_0 {
    ...
    std::tuple<TNode<RawPtrT>, TNode<BInt>, TNode<BInt>> Flatten() const { return std::make_tuple(frame, argument_count, formal_parameter_count); }
};
struct TorqueStructGrowableFixedArray_0 {
    ...
    std::tuple<TNode<FixedArray>, TNode<IntPtrT>, TNode<IntPtrT>> Flatten() const { return std::make_tuple(array, capacity, length); }
};
struct TorqueStructIteratorRecord {
    TNode<JSReceiver> object;
    TNode<Object> next;

    std::tuple<TNode<JSReceiver>, TNode<Object>> Flatten() const { return std::make_tuple(object, next); }
};
struct TorqueStructPromiseResolvingFunctions {
    TNode<JSFunction> resolve;
    TNode<JSFunction> reject;

    std::tuple<TNode<JSFunction>, TNode<JSFunction>> Flatten() const { return std::make_tuple(resolve, reject); }
};
struct TorqueStructPromiseAllResolveElementFunctor_0 {

    std::tuple<> Flatten() const { return std::make_tuple(); }
};
...
struct TorqueStructPromiseFinallyFunctions_0 {
    ...
    std::tuple<TNode<JSFunction>, TNode<JSFunction>> Flatten() const { return std::make_tuple(then_finally, catch_finally); }
};
...
struct TorqueStructIsSubstringAtFunctor_0 {
    ...
    std::tuple<TNode<IntPtrT>> Flatten() const { return std::make_tuple(start); }
};
...
struct TorqueStructTypedArrayElementsInfo {
    ...
    std::tuple<TNode<UintPtrT>, TNode<Int32T>> Flatten() const { return std::make_tuple(sizeLog2, kind); }
};
struct TorqueStructTypedArrayAccessor_0 {
    ...
    std::tuple<TNode<BuiltinPtr>, TNode<BuiltinPtr>, TNode<BuiltinPtr>> Flatten() const { return std::make_tuple(loadNumericFn, storeNumericFn, storeJSAnyFn); }
};
struct TorqueStructAttachedJSTypedArrayAndLength_0 {
    TNode<JSTypedArray> array;
    TNode<UintPtrT> length;

    std::tuple<TNode<JSTypedArray>, TNode<UintPtrT>> Flatten() const { return std::make_tuple(array, length); }
};
struct TorqueStructAttachedJSTypedArrayWitness_0 {
    ...
    std::tuple<TNode<JSTypedArray>, TNode<JSTypedArray>, TNode<BuiltinPtr>> Flatten() const { return std::make_tuple(stable, unstable, loadfn); }
};
struct TorqueStructParameterMapIterator_0 {
    TNode<IntPtrT> currentIndex;
    TNode<IntPtrT> endInterationIndex;

    std::tuple<TNode<IntPtrT>, TNode<IntPtrT>> Flatten() const { return std::make_tuple(currentIndex, endInterationIndex); }
};
...
struct TorqueStructDescriptorEntry {
    ...
    std::tuple<TNode<PrimitiveHeapObject>, TNode<Object>, TNode<MaybeObject>> Flatten() const { return std::make_tuple(key, details, value); }
};
...
struct TorqueStructFastJSArrayForReadWitness_0 {
    ...
    std::tuple<TNode<JSArray>, TNode<JSArray>, TNode<Map>, TNode<BoolT>> Flatten() const { return std::make_tuple(stable, unstable, map, hasDoubles); }
};
...
struct TorqueStructNameDictionaryEntry_0 {
    ...
    std::tuple<TNode<Object>, TNode<Object>, TNode<Object>> Flatten() const { return std::make_tuple(key, value, property_details); }
};
struct TorqueStructPositionInfo_0 {
    TNode<Smi> start;
    TNode<Smi> end;

    std::tuple<TNode<Smi>, TNode<Smi>> Flatten() const { return std::make_tuple(start, end); }
};
struct TorqueStructFunctionVariableInfo_0 {
    TNode<Object> name;
    TNode<Smi> context_or_stack_slot_index;

    std::tuple<TNode<Object>, TNode<Smi>> Flatten() const { return std::make_tuple(name, context_or_stack_slot_index); }
};
struct TorqueStructModuleVariable_0 {
    ...
    std::tuple<TNode<String>, TNode<Smi>, TNode<Smi>> Flatten() const { return std::make_tuple(name, index, properties); }
};
struct TorqueStructAbstractStringIndexOfFunctor_0 {
    TNode<Smi> fromIndex;

    std::tuple<TNode<Smi>> Flatten() const { return std::make_tuple(fromIndex); }
};
struct TorqueStructProbeSequence_0 {
    ...
    std::tuple<TNode<Uint32T>, TNode<Uint32T>, TNode<Uint32T>> Flatten() const { return std::make_tuple(mask, offset, index); }
};
struct TorqueStructByteMask_0 {
    TNode<Uint64T> mask;

    std::tuple<TNode<Uint64T>> Flatten() const { return std::make_tuple(mask); }
};
struct TorqueStructBitMask_0 {
    TNode<Uint32T> mask;

    std::tuple<TNode<Uint32T>> Flatten() const { return std::make_tuple(mask); }
};
struct TorqueStructGroupPortableImpl_0 {
    TNode<Uint64T> ctrl;

    std::tuple<TNode<Uint64T>> Flatten() const { return std::make_tuple(ctrl); }
};
struct TorqueStructGroupSse2Impl_0 {
    TNode<I8x16T> ctrl;

    std::tuple<TNode<I8x16T>> Flatten() const { return std::make_tuple(ctrl); }
};
...
struct TorqueStructTestStructA_0 {
    ...
    std::tuple<TNode<FixedArray>, TNode<Smi>, TNode<Number>> Flatten() const { return std::make_tuple(indexes, i, k); }
};
struct TorqueStructTestStructB_0 {
    TorqueStructTestStructA_0 x;
    TNode<Smi> y;

    std::tuple<TNode<FixedArray>, TNode<Smi>, TNode<Number>, TNode<Smi>> Flatten() const { return std::make_tuple(x.indexes, x.i, x.k, y); }
};
...
struct TorqueStructTestInner_0 {
    ...
    std::tuple<TNode<Int32T>, TNode<Int32T>> Flatten() const { return std::make_tuple(x, y); }
};
struct TorqueStructTestOuter_0 {
    ...
    std::tuple<TNode<Int32T>, TNode<Int32T>, TNode<Int32T>, TNode<Int32T>> Flatten() const { return std::make_tuple(a, b.x, b.y, c); }
};
struct TorqueStructStructWithConst_0 {
    TNode<Object> a;
    TNode<Int32T> b;

    std::tuple<TNode<Object>, TNode<Int32T>> Flatten() const { return std::make_tuple(a, b); }
};
struct TorqueStructTestIterator_0 {
    TNode<Smi> count;

    std::tuple<TNode<Smi>> Flatten() const { return std::make_tuple(count); }
};
struct TorqueStructInternalClassStructElement_0 {
    TNode<Smi> a;
    TNode<Smi> b;

    std::tuple<TNode<Smi>, TNode<Smi>> Flatten() const { return std::make_tuple(a, b); }
};
struct TorqueStructSmiGeneratorIterator_0 {
    TNode<Smi> value;

    std::tuple<TNode<Smi>> Flatten() const { return std::make_tuple(value); }
};
...
struct TorqueStructTwoValues_0 {
    ...
    std::tuple<TNode<Smi>, TNode<Map>> Flatten() const { return std::make_tuple(a, b); }
};
struct TorqueStructTargetAndInstance_0 {
    TNode<RawPtrT> target;
    TNode<HeapObject> instance;

    std::tuple<TNode<RawPtrT>, TNode<HeapObject>> Flatten() const { return std::make_tuple(target, instance); }
};
struct TorqueStructNewPositionAndBytesWritten_0 {
    TNode<UintPtrT> newPosition;
    TNode<UintPtrT> bytesWritten;

    std::tuple<TNode<UintPtrT>, TNode<UintPtrT>> Flatten() const { return std::make_tuple(newPosition, bytesWritten); }
};
...
struct TorqueStructSlice_char8_MutableReference_char8_0 {
    ...
    std::tuple<TNode<Object>, TNode<IntPtrT>, TNode<IntPtrT>> Flatten() const { return std::make_tuple(object, offset, length); }
};
...
struct TorqueStructTestTuple_intptr_Smi_0 {
    ...
    std::tuple<TNode<IntPtrT>, TNode<Smi>> Flatten() const { return std::make_tuple(fst, snd); }
};
struct TorqueStructTestTuple_Smi_intptr_0 {
    TNode<Smi> fst;
    TNode<IntPtrT> snd;

    std::tuple<TNode<Smi>, TNode<IntPtrT>> Flatten() const { return std::make_tuple(fst, snd); }
};
struct TorqueStructTestTuple_TestTuple_intptr_Smi_TestTuple_Smi_intptr_0 {
    ...
    std::tuple<TNode<IntPtrT>, TNode<Smi>, TNode<Smi>, TNode<IntPtrT>> Flatten() const { return std::make_tuple(fst.fst, fst.snd, snd.fst, snd.snd); }
};
struct TorqueStructSliceIterator_char8_ConstReference_char8_0 {
    ...
    std::tuple<TNode<Object>, TNode<IntPtrT>, TNode<IntPtrT>> Flatten() const { return std::make_tuple(object, start, end); }
};
...
struct
    TorqueStructSliceIterator_JSReceiver_OR_Undefined_OR_Null_OR_False_OR_True_OR_Symbol_OR_String_OR_BigInt_OR_HeapNumber_OR_Smi_OR_TheHole_MutableReference_JSReceiver_OR_Undefined_OR_Null_OR_False_OR_True_OR_Symbol_OR_String_OR_BigInt_OR_HeapNumber_OR_Smi_OR_TheHole_0 {
    TNode<Object> object;
    TNode<IntPtrT> start;
    TNode<IntPtrT> end;
    TorqueStructUnsafe_0 unsafeMarker;
...
struct
    TorqueStructReference_JSReceiver_OR_Undefined_OR_Null_OR_False_OR_True_OR_Symbol_OR_String_OR_BigInt_OR_HeapNumber_OR_Smi_OR_AccessorInfo_OR_ClassPositions_OR_AccessorPair_OR_Weak_Map_0 {
    TNode<Object> object;
    TNode<IntPtrT> offset;
    TorqueStructUnsafe_0 unsafeMarker;
...
struct TorqueStructConstantIterator_TheHole_0 {
    ...
    std::tuple<TNode<Oddball>> Flatten() const { return std::make_tuple(value); }
};
struct TorqueStructIteratorSequence_Object_SliceIterator_Object_MutableReference_Object_ConstantIterator_TheHole_0 {
    ...
    std::tuple<TNode<Object>, TNode<IntPtrT>, TNode<IntPtrT>, TNode<Oddball>> Flatten() const { return std::make_tuple(first.object, first.start, first.end, second.value); }
};
struct TorqueStructConstantIterator_float64_or_hole_0 {
    TorqueStructfloat64_or_hole_0 value;

    std::tuple<TNode<BoolT>, TNode<Float64T>> Flatten() const { return std::make_tuple(value.is_hole, value.value); }
};
...
struct TorqueStructConstantIterator_uint8_0 {
    ...
    std::tuple<TNode<Uint8T>> Flatten() const { return std::make_tuple(value); }
};
struct TorqueStructConstantIterator_HashMapEntry_0 {
    TorqueStructHashMapEntry_0 value;

    std::tuple<TNode<Object>, TNode<Object>> Flatten() const { return std::make_tuple(value.key, value.value); }
};
...
struct TorqueStructSBox_intptr_0 {
    ...
    std::tuple<TNode<IntPtrT>> Flatten() const { return std::make_tuple(value); }
};
struct TorqueStructSBox_SBox_intptr_0 {
    TorqueStructSBox_intptr_0 value;

    std::tuple<TNode<IntPtrT>> Flatten() const { return std::make_tuple(value.value); }
};
