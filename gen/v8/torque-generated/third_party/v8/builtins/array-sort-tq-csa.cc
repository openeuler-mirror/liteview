    ...
    TNode<Number> p_initialReceiverLength, bool p_isToSorted)
{
    ...
    if (block16.is_used()) {
        ...
        ca_.Goto(&block18, ca_.UncheckedCast<BuiltinPtr>(ca_.SmiConstant(Builtin::kLoad_FastSmiElements_0)),
            ca_.UncheckedCast<BuiltinPtr>(ca_.SmiConstant(Builtin::kStore_FastSmiElements_0)), ca_.UncheckedCast<BuiltinPtr>(ca_.SmiConstant(Builtin::kDelete_FastSmiElements_0)),
...
TF_BUILTIN(Load_FastSmiElements_0, CodeStubAssembler)
{
    ...
    if (block5.is_used()) {
        ...
        tmp18 = UnsafeCast_JSReceiver_OR_Undefined_OR_Null_OR_False_OR_True_OR_Symbol_OR_String_OR_BigInt_OR_HeapNumber_OR_Smi_OR_TheHole_0(
...
TF_BUILTIN(Load_FastDoubleElements_0, CodeStubAssembler)
{
    ...
    if (block7.is_used()) {
        ...
        std::tie(tmp17, tmp18)
            = LoadFloat64OrHole_0(state_, TorqueStructReference_float64_or_hole_0 { TNode<Object> { tmp15 }, TNode<IntPtrT> { tmp16 }, TorqueStructUnsafe_0 {} }).Flatten();
...
TF_BUILTIN(Copy, CodeStubAssembler)
{
    ...
    if (block20.is_used()) {
        ...
        ca_.Branch(
            tmp16, &block27, std::vector<compiler::Node*> { phi_bb20_6, phi_bb20_7, phi_bb20_7 }, &block28, std::vector<compiler::Node*> { phi_bb20_6, phi_bb20_7, phi_bb20_7 });
    }
    ...
    if (block39.is_used()) {
        ...
        ca_.Branch(
            tmp45, &block46, std::vector<compiler::Node*> { phi_bb39_6, phi_bb39_7, phi_bb39_7 }, &block47, std::vector<compiler::Node*> { phi_bb39_6, phi_bb39_7, phi_bb39_7 });
    }
...
void BinaryInsertionSort_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<SortState> p_sortState, TNode<Smi> p_low, TNode<Smi> p_startArg, TNode<Smi> p_high)
{
    ...
    if (block31.is_used()) {
        ...
        ca_.Branch(
            tmp19, &block29, std::vector<compiler::Node*> { phi_bb31_6, phi_bb31_7, phi_bb31_8 }, &block30, std::vector<compiler::Node*> { phi_bb31_6, phi_bb31_7, phi_bb31_8 });
    }
    ...
    if (block29.is_used()) {
        ...
        tmp29 = CodeStubAssembler(state_).UintPtrLessThan(TNode<UintPtrT> { tmp27 }, TNode<UintPtrT> { tmp28 });
        ca_.Branch(
            tmp29, &block36, std::vector<compiler::Node*> { phi_bb29_6, phi_bb29_7, phi_bb29_8 }, &block37, std::vector<compiler::Node*> { phi_bb29_6, phi_bb29_7, phi_bb29_8 });
    }
    ...
    if (block36.is_used()) {
        ...
        ca_.Branch(
            tmp38, &block40, std::vector<compiler::Node*> { phi_bb36_6, phi_bb36_7, phi_bb36_8 }, &block41, std::vector<compiler::Node*> { phi_bb36_6, phi_bb36_7, phi_bb36_8 });
    }
...
void ReverseRange_0(compiler::CodeAssemblerState* state_, TNode<FixedArray> p_array, TNode<Smi> p_from, TNode<Smi> p_to)
{
    ...
    if (block17.is_used()) {
        ...
        ca_.Branch(
            tmp35, &block25, std::vector<compiler::Node*> { phi_bb17_4, phi_bb17_3, phi_bb17_3 }, &block26, std::vector<compiler::Node*> { phi_bb17_4, phi_bb17_3, phi_bb17_3 });
    }
...
TF_BUILTIN(GallopLeft, CodeStubAssembler)
{
    ...
    if (block28.is_used()) {
        ...
        ca_.Branch(
            tmp20, &block26, std::vector<compiler::Node*> { phi_bb28_7, phi_bb28_8, phi_bb28_10 }, &block27, std::vector<compiler::Node*> { phi_bb28_7, phi_bb28_8, phi_bb28_10 });
    }
    ...
    if (block26.is_used()) {
        ...
        tmp29 = CodeStubAssembler(state_).UintPtrLessThan(TNode<UintPtrT> { tmp27 }, TNode<UintPtrT> { tmp28 });
        ca_.Branch(
            tmp29, &block33, std::vector<compiler::Node*> { phi_bb26_7, phi_bb26_8, phi_bb26_10 }, &block34, std::vector<compiler::Node*> { phi_bb26_7, phi_bb26_8, phi_bb26_10 });
    }
    ...
    if (block27.is_used()) {
        ...
        ca_.Branch(
            tmp44, &block41, std::vector<compiler::Node*> { phi_bb27_7, phi_bb27_8, phi_bb27_10 }, &block42, std::vector<compiler::Node*> { phi_bb27_7, phi_bb27_8, phi_bb27_10 });
    }
    ...
    if (block49.is_used()) {
        ...
        ca_.Branch(
            tmp49, &block47, std::vector<compiler::Node*> { phi_bb49_7, phi_bb49_8, phi_bb49_10 }, &block48, std::vector<compiler::Node*> { phi_bb49_7, phi_bb49_8, phi_bb49_10 });
    }
    ...
    if (block47.is_used()) {
        ...
        tmp58 = CodeStubAssembler(state_).UintPtrLessThan(TNode<UintPtrT> { tmp56 }, TNode<UintPtrT> { tmp57 });
        ca_.Branch(
            tmp58, &block54, std::vector<compiler::Node*> { phi_bb47_7, phi_bb47_8, phi_bb47_10 }, &block55, std::vector<compiler::Node*> { phi_bb47_7, phi_bb47_8, phi_bb47_10 });
    }
    ...
    if (block48.is_used()) {
        ...
        ca_.Branch(
            tmp73, &block62, std::vector<compiler::Node*> { phi_bb48_7, phi_bb48_8, phi_bb48_10 }, &block63, std::vector<compiler::Node*> { phi_bb48_7, phi_bb48_8, phi_bb48_10 });
    }
    ...
    if (block76.is_used()) {
        ...
        ca_.Branch(
            tmp78, &block74, std::vector<compiler::Node*> { phi_bb76_7, phi_bb76_8, phi_bb76_10 }, &block75, std::vector<compiler::Node*> { phi_bb76_7, phi_bb76_8, phi_bb76_10 });
    }
    ...
    if (block74.is_used()) {
        ...
        ca_.Branch(
            tmp89, &block81, std::vector<compiler::Node*> { phi_bb74_7, phi_bb74_8, phi_bb74_10 }, &block82, std::vector<compiler::Node*> { phi_bb74_7, phi_bb74_8, phi_bb74_10 });
    }
...
TF_BUILTIN(GallopRight, CodeStubAssembler)
{
    ...
    if (block28.is_used()) {
        ...
        ca_.Branch(
            tmp21, &block26, std::vector<compiler::Node*> { phi_bb28_7, phi_bb28_8, phi_bb28_10 }, &block27, std::vector<compiler::Node*> { phi_bb28_7, phi_bb28_8, phi_bb28_10 });
    }
    ...
    if (block26.is_used()) {
        ...
        ca_.Branch(
            tmp30, &block33, std::vector<compiler::Node*> { phi_bb26_7, phi_bb26_8, phi_bb26_10 }, &block34, std::vector<compiler::Node*> { phi_bb26_7, phi_bb26_8, phi_bb26_10 });
    }
    ...
    if (block27.is_used()) {
        ...
        ca_.Branch(
            tmp45, &block41, std::vector<compiler::Node*> { phi_bb27_7, phi_bb27_8, phi_bb27_10 }, &block42, std::vector<compiler::Node*> { phi_bb27_7, phi_bb27_8, phi_bb27_10 });
    }
    ...
    if (block45.is_used()) {
        ...
        ca_.Branch(
            tmp49, &block43, std::vector<compiler::Node*> { phi_bb45_7, phi_bb45_8, phi_bb45_10 }, &block44, std::vector<compiler::Node*> { phi_bb45_7, phi_bb45_8, phi_bb45_10 });
    }
    ...
    if (block43.is_used()) {
        ...
        tmp58 = CodeStubAssembler(state_).UintPtrLessThan(TNode<UintPtrT> { tmp56 }, TNode<UintPtrT> { tmp57 });
        ca_.Branch(
            tmp58, &block50, std::vector<compiler::Node*> { phi_bb43_7, phi_bb43_8, phi_bb43_10 }, &block51, std::vector<compiler::Node*> { phi_bb43_7, phi_bb43_8, phi_bb43_10 });
    }
    ...
    if (block44.is_used()) {
        ...
        ca_.Branch(
            tmp73, &block58, std::vector<compiler::Node*> { phi_bb44_7, phi_bb44_8, phi_bb44_10 }, &block59, std::vector<compiler::Node*> { phi_bb44_7, phi_bb44_8, phi_bb44_10 });
    }
    ...
    if (block72.is_used()) {
        ...
        ca_.Branch(
            tmp78, &block70, std::vector<compiler::Node*> { phi_bb72_7, phi_bb72_8, phi_bb72_10 }, &block71, std::vector<compiler::Node*> { phi_bb72_7, phi_bb72_8, phi_bb72_10 });
    }
    ...
    if (block70.is_used()) {
        ...
        tmp89 = CodeStubAssembler(state_).UintPtrLessThan(TNode<UintPtrT> { tmp87 }, TNode<UintPtrT> { tmp88 });
        ca_.Branch(
            tmp89, &block77, std::vector<compiler::Node*> { phi_bb70_7, phi_bb70_8, phi_bb70_10 }, &block78, std::vector<compiler::Node*> { phi_bb70_7, phi_bb70_8, phi_bb70_10 });
    }
...
void MergeLow_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<SortState> p_sortState, TNode<Smi> p_baseA, TNode<Smi> p_lengthAArg, TNode<Smi> p_baseB,
    TNode<Smi> p_lengthBArg)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    if (block49.is_used()) {
        ...
        ca_.Branch(tmp44, &block47, std::vector<compiler::Node*> { phi_bb49_6, phi_bb49_7, phi_bb49_10, phi_bb49_11, phi_bb49_12, phi_bb49_13, phi_bb49_14, phi_bb49_15 }, &block48,
    ...
    if (block47.is_used()) {
        ...
        ca_.Branch(tmp51, &block61,
            std::vector<compiler::Node*> { phi_bb47_6, phi_bb47_7, phi_bb47_10, phi_bb47_11, phi_bb47_12, phi_bb47_13, phi_bb47_14, phi_bb47_15, phi_bb47_12, phi_bb47_12 },
            &block62,
            std::vector<compiler::Node*> { phi_bb47_6, phi_bb47_7, phi_bb47_10, phi_bb47_11, phi_bb47_12, phi_bb47_13, phi_bb47_14, phi_bb47_15, phi_bb47_12, phi_bb47_12 });
    }
    ...
    if (block61.is_used()) {
        ...
        ca_.Branch(tmp64, &block69,
            std::vector<compiler::Node*> { phi_bb61_6, phi_bb61_7, phi_bb61_10, phi_bb61_11, phi_bb61_12, phi_bb61_13, phi_bb61_14, phi_bb61_15, phi_bb61_11, phi_bb61_11 },
            &block70,
            std::vector<compiler::Node*> { phi_bb61_6, phi_bb61_7, phi_bb61_10, phi_bb61_11, phi_bb61_12, phi_bb61_13, phi_bb61_14, phi_bb61_15, phi_bb61_11, phi_bb61_11 });
    }
    ...
    if (block69.is_used()) {
        ...
        ca_.Branch(tmp73, &block73, std::vector<compiler::Node*> { phi_bb69_6, phi_bb69_7, phi_bb69_10, phi_bb69_11, phi_bb69_12, phi_bb69_13, phi_bb69_14, phi_bb69_15 }, &block74,
    ...
    if (block73.is_used()) {
        ...
        ca_.Branch(tmp82, &block80,
            std::vector<compiler::Node*> { phi_bb73_6, phi_bb73_7, phi_bb73_11, phi_bb73_12, phi_bb73_13, phi_bb73_14, phi_bb73_15, phi_bb73_10, phi_bb73_10 }, &block81,
    ...
    if (block80.is_used()) {
        ...
        ca_.Branch(tmp95, &block88,
            std::vector<compiler::Node*> { phi_bb80_6, phi_bb80_7, phi_bb80_11, phi_bb80_13, phi_bb80_14, phi_bb80_15, phi_bb80_21, phi_bb80_22, phi_bb80_12, phi_bb80_12 },
            &block89,
            std::vector<compiler::Node*> { phi_bb80_6, phi_bb80_7, phi_bb80_11, phi_bb80_13, phi_bb80_14, phi_bb80_15, phi_bb80_21, phi_bb80_22, phi_bb80_12, phi_bb80_12 });
    }
    ...
    if (block74.is_used()) {
        ...
        ca_.Branch(tmp117, &block100,
            std::vector<compiler::Node*> { phi_bb74_6, phi_bb74_7, phi_bb74_11, phi_bb74_12, phi_bb74_13, phi_bb74_14, phi_bb74_15, phi_bb74_10, phi_bb74_10 }, &block101,
    ...
    if (block118.is_used()) {
        ...
        ca_.Branch(tmp148, &block119,
            std::vector<compiler::Node*> { phi_bb118_6, phi_bb118_7, phi_bb118_10, phi_bb118_11, phi_bb118_12, phi_bb118_13, phi_bb118_14, phi_bb118_15, phi_bb118_16 }, &block120,
            std::vector<compiler::Node*> { phi_bb118_6, phi_bb118_7, phi_bb118_10, phi_bb118_11, phi_bb118_12, phi_bb118_13, phi_bb118_14, phi_bb118_15, phi_bb118_16 });
    }
    ...
    if (block121.is_used()) {
        ...
        ca_.Branch(phi_bb121_18, &block122,
            std::vector<compiler::Node*> { phi_bb121_6, phi_bb121_7, phi_bb121_10, phi_bb121_11, phi_bb121_12, phi_bb121_13, phi_bb121_14, phi_bb121_15, phi_bb121_16 }, &block123,
            std::vector<compiler::Node*> { phi_bb121_6, phi_bb121_7, phi_bb121_10, phi_bb121_11, phi_bb121_12, phi_bb121_13, phi_bb121_14, phi_bb121_15, phi_bb121_16 });
    }
    ...
    if (block124.is_used()) {
        ...
        ca_.Branch(phi_bb124_18, &block116,
            std::vector<compiler::Node*> { phi_bb124_6, phi_bb124_7, phi_bb124_10, phi_bb124_11, phi_bb124_12, phi_bb124_13, phi_bb124_14, phi_bb124_15, phi_bb124_16 }, &block117,
            std::vector<compiler::Node*> { phi_bb124_6, phi_bb124_7, phi_bb124_10, phi_bb124_11, phi_bb124_12, phi_bb124_13, phi_bb124_14, phi_bb124_15, phi_bb124_16 });
    }
    ...
    if (block116.is_used()) {
        ...
        ca_.Branch(tmp165, &block136,
            std::vector<compiler::Node*> { phi_bb116_6, phi_bb116_7, phi_bb116_10, phi_bb116_11, phi_bb116_12, phi_bb116_14, phi_bb116_15, phi_bb116_12, phi_bb116_12 }, &block137,
            std::vector<compiler::Node*> { phi_bb116_6, phi_bb116_7, phi_bb116_10, phi_bb116_11, phi_bb116_12, phi_bb116_14, phi_bb116_15, phi_bb116_12, phi_bb116_12 });
    }
    ...
    if (block136.is_used()) {
        ...
        ca_.Branch(tmp175, &block144, std::vector<compiler::Node*> { phi_bb136_6, phi_bb136_7, phi_bb136_10, phi_bb136_11, phi_bb136_12, phi_bb136_15 }, &block145,
            std::vector<compiler::Node*> { phi_bb136_6, phi_bb136_7, phi_bb136_10, phi_bb136_11, phi_bb136_12, phi_bb136_15 });
    }
    ...
    if (block145.is_used()) {
        ...
        ca_.Branch(tmp192, &block154, std::vector<compiler::Node*> { phi_bb145_6, phi_bb145_7, phi_bb145_11, phi_bb145_12, phi_bb145_15, phi_bb145_10, phi_bb145_10 }, &block155,
    ...
    if (block154.is_used()) {
        ...
        ca_.Branch(tmp205, &block162, std::vector<compiler::Node*> { phi_bb154_6, phi_bb154_7, phi_bb154_11, phi_bb154_15, phi_bb154_21, phi_bb154_22, phi_bb154_12, phi_bb154_12 },
            &block163, std::vector<compiler::Node*> { phi_bb154_6, phi_bb154_7, phi_bb154_11, phi_bb154_15, phi_bb154_21, phi_bb154_22, phi_bb154_12, phi_bb154_12 });
    }
    ...
    if (block181.is_used()) {
        ...
        ca_.Branch(tmp246, &block188, std::vector<compiler::Node*> { phi_bb181_6, phi_bb181_7, phi_bb181_11, phi_bb181_12, phi_bb181_10, phi_bb181_10 }, &block189,
            std::vector<compiler::Node*> { phi_bb181_6, phi_bb181_7, phi_bb181_11, phi_bb181_12, phi_bb181_10, phi_bb181_10 });
    }
    ...
    if (block188.is_used()) {
        ...
        ca_.Branch(tmp259, &block196, std::vector<compiler::Node*> { phi_bb188_6, phi_bb188_7, phi_bb188_12, phi_bb188_21, phi_bb188_22, phi_bb188_11, phi_bb188_11 }, &block197,
    ...
    if (block215.is_used()) {
        ...
        ca_.Branch(tmp294, &block223, std::vector<compiler::Node*> { phi_bb215_6, phi_bb215_7, phi_bb215_10, phi_bb215_11, phi_bb215_12, phi_bb215_11, phi_bb215_11 }, &block224,
...
void MergeHigh_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<SortState> p_sortState, TNode<Smi> p_baseA, TNode<Smi> p_lengthAArg, TNode<Smi> p_baseB,
    TNode<Smi> p_lengthBArg)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    ...
    if (block49.is_used()) {
        ...
        ca_.Branch(tmp51, &block47, std::vector<compiler::Node*> { phi_bb49_6, phi_bb49_7, phi_bb49_10, phi_bb49_11, phi_bb49_12, phi_bb49_13, phi_bb49_14, phi_bb49_15 }, &block48,
            std::vector<compiler::Node*> { phi_bb49_6, phi_bb49_7, phi_bb49_10, phi_bb49_11, phi_bb49_12, phi_bb49_13, phi_bb49_14, phi_bb49_15 });
    }
    ...
    if (block47.is_used()) {
        ...
        ca_.Branch(tmp58, &block61,
            std::vector<compiler::Node*> { phi_bb47_6, phi_bb47_7, phi_bb47_10, phi_bb47_11, phi_bb47_12, phi_bb47_13, phi_bb47_14, phi_bb47_15, phi_bb47_11, phi_bb47_11 },
            &block62,
            std::vector<compiler::Node*> { phi_bb47_6, phi_bb47_7, phi_bb47_10, phi_bb47_11, phi_bb47_12, phi_bb47_13, phi_bb47_14, phi_bb47_15, phi_bb47_11, phi_bb47_11 });
    }
    ...
    if (block61.is_used()) {
        ...
        ca_.Branch(tmp71, &block69,
            std::vector<compiler::Node*> { phi_bb61_6, phi_bb61_7, phi_bb61_10, phi_bb61_11, phi_bb61_12, phi_bb61_13, phi_bb61_14, phi_bb61_15, phi_bb61_12, phi_bb61_12 },
            &block70,
            std::vector<compiler::Node*> { phi_bb61_6, phi_bb61_7, phi_bb61_10, phi_bb61_11, phi_bb61_12, phi_bb61_13, phi_bb61_14, phi_bb61_15, phi_bb61_12, phi_bb61_12 });
    }
    ...
    if (block69.is_used()) {
        ...
        ca_.Branch(tmp80, &block73, std::vector<compiler::Node*> { phi_bb69_6, phi_bb69_7, phi_bb69_10, phi_bb69_11, phi_bb69_12, phi_bb69_13, phi_bb69_14, phi_bb69_15 }, &block74,
            std::vector<compiler::Node*> { phi_bb69_6, phi_bb69_7, phi_bb69_10, phi_bb69_11, phi_bb69_12, phi_bb69_13, phi_bb69_14, phi_bb69_15 });
    }
    ...
    if (block116.is_used()) {
        ...
        ca_.Branch(tmp172, &block136,
            std::vector<compiler::Node*> { phi_bb116_6, phi_bb116_7, phi_bb116_10, phi_bb116_11, phi_bb116_12, phi_bb116_14, phi_bb116_15, phi_bb116_11, phi_bb116_11 }, &block137,
            std::vector<compiler::Node*> { phi_bb116_6, phi_bb116_7, phi_bb116_10, phi_bb116_11, phi_bb116_12, phi_bb116_14, phi_bb116_15, phi_bb116_11, phi_bb116_11 });
    }
    ...
    if (block136.is_used()) {
        ...
        ca_.Branch(tmp184, &block144, std::vector<compiler::Node*> { phi_bb136_6, phi_bb136_7, phi_bb136_10, phi_bb136_11, phi_bb136_12, phi_bb136_15 }, &block145,
            std::vector<compiler::Node*> { phi_bb136_6, phi_bb136_7, phi_bb136_10, phi_bb136_11, phi_bb136_12, phi_bb136_15 });
    }
    ...
    if (block145.is_used()) {
        ...
        ca_.Branch(tmp203, &block152, std::vector<compiler::Node*> { phi_bb145_6, phi_bb145_7, phi_bb145_11, phi_bb145_12, phi_bb145_15, phi_bb145_10, phi_bb145_10 }, &block153,
            std::vector<compiler::Node*> { phi_bb145_6, phi_bb145_7, phi_bb145_11, phi_bb145_12, phi_bb145_15, phi_bb145_10, phi_bb145_10 });
    }
    ...
    if (block152.is_used()) {
        ...
        ca_.Branch(tmp216, &block160, std::vector<compiler::Node*> { phi_bb152_6, phi_bb152_7, phi_bb152_12, phi_bb152_15, phi_bb152_22, phi_bb152_23, phi_bb152_11, phi_bb152_11 },
            &block161, std::vector<compiler::Node*> { phi_bb152_6, phi_bb152_7, phi_bb152_12, phi_bb152_15, phi_bb152_22, phi_bb152_23, phi_bb152_11, phi_bb152_11 });
    }
    ...
    if (block179.is_used()) {
        ...
        ca_.Branch(tmp266, &block188, std::vector<compiler::Node*> { phi_bb179_6, phi_bb179_7, phi_bb179_11, phi_bb179_12, phi_bb179_10, phi_bb179_10 }, &block189,
            std::vector<compiler::Node*> { phi_bb179_6, phi_bb179_7, phi_bb179_11, phi_bb179_12, phi_bb179_10, phi_bb179_10 });
    }
    ...
    if (block188.is_used()) {
        ...
        ca_.Branch(tmp279, &block196, std::vector<compiler::Node*> { phi_bb188_6, phi_bb188_7, phi_bb188_11, phi_bb188_22, phi_bb188_23, phi_bb188_12, phi_bb188_12 }, &block197,
...
TNode<Smi> CompactReceiverElementsIntoWorkArray_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<SortState> p_sortState, bool p_isToSorted)
{
    ...
    if (block14.is_used()) {
        ...
        tmp20 = CodeStubAssembler(state_).CallBuiltinPointer(
            Builtins::CallableFor(ca_.isolate(), ExampleBuiltinForTorqueFunctionPointerType(5)).descriptor(), tmp9, p_context, p_sortState, phi_bb14_9);
    ...
    if (block34.is_used()) {
        ...
        ca_.Branch(tmp44, &block52, std::vector<compiler::Node*> { phi_bb34_7, phi_bb34_8, phi_bb34_9, phi_bb34_4, phi_bb34_4, phi_bb34_4, phi_bb34_4 }, &block53,
            std::vector<compiler::Node*> { phi_bb34_7, phi_bb34_8, phi_bb34_9, phi_bb34_4, phi_bb34_4, phi_bb34_4, phi_bb34_4 });
    }
...
void CopyWorkArrayToReceiver_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<SortState> p_sortState, TNode<Smi> p_numberOfNonUndefined)
{
    ...
    if (block18.is_used()) {
        ...
        tmp19 = TORQUE_CAST(CodeStubAssembler(state_).CallBuiltinPointer(
            Builtins::CallableFor(ca_.isolate(), ExampleBuiltinForTorqueFunctionPointerType(6)).descriptor(), tmp1, p_context, p_sortState, phi_bb18_8, tmp18));
    ...
    if (block22.is_used()) {
        ...
        tmp27 = TORQUE_CAST(CodeStubAssembler(state_).CallBuiltinPointer(
            Builtins::CallableFor(ca_.isolate(), ExampleBuiltinForTorqueFunctionPointerType(6)).descriptor(), tmp1, p_context, p_sortState, phi_bb22_5, tmp26));
    ...
    if (block26.is_used()) {
        ...
        tmp35 = TORQUE_CAST(CodeStubAssembler(state_).CallBuiltinPointer(
            Builtins::CallableFor(ca_.isolate(), ExampleBuiltinForTorqueFunctionPointerType(7)).descriptor(), tmp33, p_context, p_sortState, phi_bb26_5));
...
TF_BUILTIN(ArrayPrototypeSort, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ...
        tmp1 = CodeStubAssembler(state_).GetArgumentValue(TorqueStructArguments { TNode<RawPtrT> { torque_arguments.frame }, TNode<RawPtrT> { torque_arguments.base },
                                                              TNode<IntPtrT> { torque_arguments.length }, TNode<IntPtrT> { torque_arguments.actual_count } },
            TNode<IntPtrT> { tmp0 });
        compiler::CodeAssemblerLabel label3(&ca_);
        tmp2 = Cast_Undefined_OR_CallableApiObject_OR_CallableJSProxy_OR_JSWrappedFunction_OR_JSBoundFunction_OR_JSFunction_1(
...
TNode<Number> Method_SortState_Compare_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<SortState> p_this, TNode<Object> p_x, TNode<Object> p_y)
{
    ...
    if (block0.is_used()) {
        ...
        tmp4 = TORQUE_CAST(CodeStubAssembler(state_).CallBuiltinPointer(
            Builtins::CallableFor(ca_.isolate(), ExampleBuiltinForTorqueFunctionPointerType(9)).descriptor(), tmp1, p_context, tmp3, p_x, p_y));
        ca_.Goto(&block2);
    }
...
void Method_SortState_CheckAccessor_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<SortState> p_this, compiler::CodeAssemblerLabel* label_Bailout)
{
    ...
    if (block4.is_used()) {
        ...
        tmp12 = TORQUE_CAST(CodeStubAssembler(state_).CallBuiltinPointer(
            Builtins::CallableFor(ca_.isolate(), ExampleBuiltinForTorqueFunctionPointerType(8)).descriptor(), tmp5, p_context, tmp7, tmp9, tmp11));
...
void Method_SortState_ResetToGenericAccessor_0(compiler::CodeAssemblerState* state_, TNode<SortState> p_this, bool p_isToSorted)
{
    ...
    if (block2.is_used()) {
        ...
        CodeStubAssembler(state_).StoreReference<BuiltinPtr>(
            CodeStubAssembler::Reference { p_this, tmp0 }, ca_.UncheckedCast<BuiltinPtr>(ca_.SmiConstant(Builtin::kLoadNoHasPropertyCheck_GenericElementsAccessor_0)));
        ca_.Goto(&block4);
    }
