...
block0:
    ...
    ASSIGN_OR_RETURN(std::tie(tmp7, tmp8, tmp9),
        TqDebugNewMutableSlice_JSReceiver_OR_Undefined_OR_Null_OR_False_OR_True_OR_Symbol_OR_String_OR_BigInt_OR_HeapNumber_OR_Smi_OR_TheHole_0(accessor, p_o, tmp6, tmp5));
    goto block2;
