...
void LabelTestHelper3_0(compiler::CodeAssemblerState* state_, compiler::CodeAssemblerLabel* label_Label3, compiler::TypedCodeAssemblerVariable<Oddball>* label_Label3_parameter_0,
    compiler::TypedCodeAssemblerVariable<Smi>* label_Label3_parameter_1)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
...
TNode<Oddball> TestFunctionPointers_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context)
{
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        tmp0 = FromConstexpr_Smi_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x2aull));
        tmp1 = TORQUE_CAST(CodeStubAssembler(state_).CallBuiltinPointer(Builtins::CallableFor(ca_.isolate(), ExampleBuiltinForTorqueFunctionPointerType(10)).descriptor(),
    ...
    if (block2.is_used()) {
        ...
        tmp5 = TORQUE_CAST(CodeStubAssembler(state_).CallBuiltinPointer(Builtins::CallableFor(ca_.isolate(), ExampleBuiltinForTorqueFunctionPointerType(10)).descriptor(),
...
void TestFunctionPointerToGeneric_0(compiler::CodeAssemblerState* state_)
{
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        tmp0 = FromConstexpr_Smi_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x0ull));
        tmp1 = CodeStubAssembler(state_).CallBuiltinPointer(Builtins::CallableFor(ca_.isolate(), ExampleBuiltinForTorqueFunctionPointerType(11)).descriptor(),
    ...
    if (block2.is_used()) {
        ca_.Bind(&block2);
        tmp4 = FromConstexpr_Smi_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x1ull));
        tmp5 = CodeStubAssembler(state_).CallBuiltinPointer(Builtins::CallableFor(ca_.isolate(), ExampleBuiltinForTorqueFunctionPointerType(11)).descriptor(),
    ...
    if (block4.is_used()) {
        ca_.Bind(&block4);
        tmp8 = Undefined_0(state_);
        tmp9 = CodeStubAssembler(state_).CallBuiltinPointer(Builtins::CallableFor(ca_.isolate(), ExampleBuiltinForTorqueFunctionPointerType(12)).descriptor(),
    ...
    if (block6.is_used()) {
        ca_.Bind(&block6);
        tmp12 = Undefined_0(state_);
        tmp13 = CodeStubAssembler(state_).CallBuiltinPointer(Builtins::CallableFor(ca_.isolate(), ExampleBuiltinForTorqueFunctionPointerType(12)).descriptor(),
    ...
    if (block3.is_used()) {
        ca_.Bind(&block3);
        {
            ...
            CodeStubAssembler(state_).FailAssert(
                "Torque assert 'someVeryLongVariableNameThatWillCauseLineBreaks > 0 && someVeryLongVariableNameThatWillCauseLineBreaks < 10' failed", pos_stack);
        }
    }
...
void TestForLoop_0(compiler::CodeAssemblerState* state_)
{
    ...
    if (block21.is_used()) {
        ...
        ca_.Branch(
            tmp30, &block23, std::vector<compiler::Node*> { phi_bb21_0, phi_bb21_1, phi_bb21_2 }, &block24, std::vector<compiler::Node*> { phi_bb21_0, phi_bb21_1, phi_bb21_2 });
    }
    ...
    if (block36.is_used()) {
        ...
        ca_.Branch(
            tmp48, &block34, std::vector<compiler::Node*> { phi_bb36_0, phi_bb36_1, phi_bb36_2 }, &block35, std::vector<compiler::Node*> { phi_bb36_0, phi_bb36_1, phi_bb36_2 });
    }
    ...
    if (block34.is_used()) {
        ...
        ca_.Branch(
            tmp50, &block38, std::vector<compiler::Node*> { phi_bb34_0, phi_bb34_1, phi_bb34_2 }, &block39, std::vector<compiler::Node*> { phi_bb34_0, phi_bb34_1, phi_bb34_2 });
    }
    ...
    if (block59.is_used()) {
        ...
        ca_.Branch(
            tmp83, &block61, std::vector<compiler::Node*> { phi_bb59_0, phi_bb59_1, phi_bb59_2 }, &block62, std::vector<compiler::Node*> { phi_bb59_0, phi_bb59_1, phi_bb59_2 });
    }
    ...
    if (block62.is_used()) {
        ...
        ca_.Branch(
            tmp85, &block63, std::vector<compiler::Node*> { phi_bb62_0, phi_bb62_1, phi_bb62_2 }, &block64, std::vector<compiler::Node*> { phi_bb62_0, phi_bb62_1, phi_bb62_2 });
    }
...
TNode<Object> TestNewFixedArrayFromSpread_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context)
{
    ...
    if (block0.is_used()) {
        ...
        InitializeFieldsFromIterator_Object_TestIterator_0(state_,
            TorqueStructSlice_Object_MutableReference_Object_0 { TNode<Object> { tmp6 }, TNode<IntPtrT> { tmp10 }, TNode<IntPtrT> { tmp2 }, TorqueStructUnsafe_0 {} },
...
void TestReferences_0(compiler::CodeAssemblerState* state_)
{
    ...
    if (block0.is_used()) {
        ...
        Swap_Smi_0(state_, TorqueStructReference_Smi_0 { TNode<Object> { tmp9 }, TNode<IntPtrT> { tmp17 }, TorqueStructUnsafe_0 {} },
            TorqueStructReference_Smi_0 { TNode<Object> { tmp18 }, TNode<IntPtrT> { tmp19 }, TorqueStructUnsafe_0 {} });
...
TNode<Oddball> TestSliceEnumeration_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context)
{
    ...
    if (block24.is_used()) {
        ...
        ca_.Branch(
            tmp41, &block31, std::vector<compiler::Node*> { phi_bb24_5, phi_bb24_5, phi_bb24_5 }, &block32, std::vector<compiler::Node*> { phi_bb24_5, phi_bb24_5, phi_bb24_5 });
    }
    ...
    if (block0.is_used()) {
        ...
        tmp0 = FromConstexpr_bool_constexpr_bool_0(state_,
            (CodeStubAssembler(state_).ConstexprIntegerLiteralEqual(
                (CodeStubAssembler(state_).ConstexprIntegerLiteralAdd(IntegerLiteral(false, 0x1ull), IntegerLiteral(false, 0x2ull))), IntegerLiteral(false, 0x3ull))));
        CodeStubAssembler(state_).StaticAssert(
            TNode<BoolT> { tmp0 }, "static_assert(1 + 2 == 3) at https://source.chromium.org/chromium/chromium/src/+/main:v8/test/torque/test-torque.tq?l=909&c=3");
        ...
        CodeStubAssembler(state_).StaticAssert(TNode<BoolT> { tmp3 },
            "static_assert(Convert<uintptr>(5) < Convert<uintptr>(6)) at https://source.chromium.org/chromium/chromium/src/+/main:v8/test/torque/test-torque.tq?l=911&c=3");
        ...
        CodeStubAssembler(state_).StaticAssert(TNode<BoolT> { tmp7 },
            "static_assert(!(Convert<uintptr>(5) < Convert<uintptr>(5))) at https://source.chromium.org/chromium/chromium/src/+/main:v8/test/torque/test-torque.tq?l=912&c=3");
        ...
        CodeStubAssembler(state_).StaticAssert(TNode<BoolT> { tmp11 },
            "static_assert(!(Convert<uintptr>(6) < Convert<uintptr>(5))) at https://source.chromium.org/chromium/chromium/src/+/main:v8/test/torque/test-torque.tq?l=913&c=3");
        ...
        CodeStubAssembler(state_).StaticAssert(TNode<BoolT> { tmp14 },
            "static_assert(Convert<uintptr>(5) <= Convert<uintptr>(5)) at https://source.chromium.org/chromium/chromium/src/+/main:v8/test/torque/test-torque.tq?l=914&c=3");
        ...
        CodeStubAssembler(state_).StaticAssert(TNode<BoolT> { tmp17 },
            "static_assert(Convert<uintptr>(5) <= Convert<uintptr>(6)) at https://source.chromium.org/chromium/chromium/src/+/main:v8/test/torque/test-torque.tq?l=915&c=3");
        ...
        CodeStubAssembler(state_).StaticAssert(TNode<BoolT> { tmp21 },
            "static_assert(!(Convert<uintptr>(6) <= Convert<uintptr>(5))) at https://source.chromium.org/chromium/chromium/src/+/main:v8/test/torque/test-torque.tq?l=916&c=3");
        ...
        CodeStubAssembler(state_).StaticAssert(TNode<BoolT> { tmp24 },
            "static_assert(Convert<intptr>(-6) < Convert<intptr>(-5)) at https://source.chromium.org/chromium/chromium/src/+/main:v8/test/torque/test-torque.tq?l=918&c=3");
        ...
        CodeStubAssembler(state_).StaticAssert(TNode<BoolT> { tmp28 },
            "static_assert(!(Convert<intptr>(-5) < Convert<intptr>(-5))) at https://source.chromium.org/chromium/chromium/src/+/main:v8/test/torque/test-torque.tq?l=919&c=3");
        ...
        CodeStubAssembler(state_).StaticAssert(TNode<BoolT> { tmp32 },
            "static_assert(!(Convert<intptr>(-5) < Convert<intptr>(-6))) at https://source.chromium.org/chromium/chromium/src/+/main:v8/test/torque/test-torque.tq?l=920&c=3");
        ...
        CodeStubAssembler(state_).StaticAssert(TNode<BoolT> { tmp35 },
            "static_assert(Convert<intptr>(-5) <= Convert<intptr>(-5)) at https://source.chromium.org/chromium/chromium/src/+/main:v8/test/torque/test-torque.tq?l=921&c=3");
        ...
        CodeStubAssembler(state_).StaticAssert(TNode<BoolT> { tmp38 },
            "static_assert(Convert<intptr>(-6) <= Convert<intptr>(-5)) at https://source.chromium.org/chromium/chromium/src/+/main:v8/test/torque/test-torque.tq?l=922&c=3");
        ...
        CodeStubAssembler(state_).StaticAssert(TNode<BoolT> { tmp42 },
            "static_assert(!(Convert<intptr>(-5) <= Convert<intptr>(-6))) at https://source.chromium.org/chromium/chromium/src/+/main:v8/test/torque/test-torque.tq?l=923&c=3");
        ca_.Goto(&block2);
    }
...
void TestLoadEliminationFixed_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context)
{
    ...
    if (block4.is_used()) {
        ...
        CodeStubAssembler(state_).StaticAssert(
            TNode<BoolT> { tmp14 }, "static_assert(TaggedEqual(v1, v2)) at https://source.chromium.org/chromium/chromium/src/+/main:v8/test/torque/test-torque.tq?l=941&c=3");
        ...
        CodeStubAssembler(state_).StaticAssert(
            TNode<BoolT> { tmp20 }, "static_assert(TaggedEqual(v3, eleven)) at https://source.chromium.org/chromium/chromium/src/+/main:v8/test/torque/test-torque.tq?l=946&c=3");
        ca_.Goto(&block6);
    }
...
void TestLoadEliminationVariable_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context)
{
    ...
    if (block30.is_used()) {
        ...
        CodeStubAssembler(state_).StaticAssert(
            TNode<BoolT> { tmp64 }, "static_assert(TaggedEqual(v1, v2)) at https://source.chromium.org/chromium/chromium/src/+/main:v8/test/torque/test-torque.tq?l=957&c=3");
        tmp65 = CodeStubAssembler(state_).TaggedEqual(TNode<MaybeObject> { tmp33 }, TNode<MaybeObject> { tmp63 });
        CodeStubAssembler(state_).StaticAssert(
            TNode<BoolT> { tmp65 }, "static_assert(TaggedEqual(u1, u2)) at https://source.chromium.org/chromium/chromium/src/+/main:v8/test/torque/test-torque.tq?l=958&c=3");
        ca_.Goto(&block34);
    }
...
TorqueStructTestTuple_TestTuple_intptr_Smi_TestTuple_Smi_intptr_0 TestGenericStruct2_0(compiler::CodeAssemblerState* state_)
{
    ...
    ca_.Bind(&block6);
    return TorqueStructTestTuple_TestTuple_intptr_Smi_TestTuple_Smi_intptr_0 { TorqueStructTestTuple_intptr_Smi_0 { TNode<IntPtrT> { tmp0 }, TNode<Smi> { tmp1 } },
...
void TestBranchOnBoolOptimization_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Smi> p_input)
{
    ...
    if (block2.is_used()) {
        ...
        tmp6 = CodeStubAssembler(state_).SmiEqual(TNode<Smi> { tmp4 }, TNode<Smi> { tmp5 });
        CodeStubAssembler(state_).StaticAssert(
            TNode<BoolT> { tmp6 }, "static_assert(box.value == 1) at https://source.chromium.org/chromium/chromium/src/+/main:v8/test/torque/test-torque.tq?l=1045&c=5");
        ca_.Goto(&block4);
    }
    ...
    if (block3.is_used()) {
        ...
        CodeStubAssembler(state_).StaticAssert(
            TNode<BoolT> { tmp10 }, "static_assert(box.value == 2) at https://source.chromium.org/chromium/chromium/src/+/main:v8/test/torque/test-torque.tq?l=1047&c=5");
        ca_.Goto(&block4);
    }
...
void TestBitFieldLoad_0(
    compiler::CodeAssemblerState* state_, TNode<Uint8T> p_val, TNode<BoolT> p_expectedA, TNode<Uint16T> p_expectedB, TNode<Uint32T> p_expectedC, TNode<BoolT> p_expectedD)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
...
void TestBitFieldStore_0(compiler::CodeAssemblerState* state_, TNode<Uint8T> p_val)
{
    ...
    if (block0.is_used()) {
        ...
        tmp12 = ca_.UncheckedCast<Uint8T>(
            CodeStubAssembler(state_).UpdateWord32<base::BitField<uint32_t, 4, 3, uint8_t>>(ca_.UncheckedCast<Word32T>(tmp5), ca_.UncheckedCast<Uint32T>(tmp11)));
...
void TestBitFieldInit_0(compiler::CodeAssemblerState* state_, TNode<BoolT> p_a, TNode<Uint16T> p_b, TNode<Uint32T> p_c, TNode<BoolT> p_d)
{
    ...
    if (block0.is_used()) {
        ...
        tmp3 = ca_.UncheckedCast<Uint8T>(
            CodeStubAssembler(state_).UpdateWord32<base::BitField<bool, 0, 1, uint8_t>>(ca_.UncheckedCast<Word32T>(tmp2), ca_.UncheckedCast<Uint32T>(p_a), true));
        tmp4 = ca_.UncheckedCast<Uint8T>(
            CodeStubAssembler(state_).UpdateWord32<base::BitField<uint16_t, 1, 3, uint8_t>>(ca_.UncheckedCast<Word32T>(tmp3), ca_.UncheckedCast<Uint32T>(p_b), true));
        tmp5 = ca_.UncheckedCast<Uint8T>(
            CodeStubAssembler(state_).UpdateWord32<base::BitField<uint32_t, 4, 3, uint8_t>>(ca_.UncheckedCast<Word32T>(tmp4), ca_.UncheckedCast<Uint32T>(p_c), true));
        tmp6 = ca_.UncheckedCast<Uint8T>(
            CodeStubAssembler(state_).UpdateWord32<base::BitField<bool, 7, 1, uint8_t>>(ca_.UncheckedCast<Word32T>(tmp5), ca_.UncheckedCast<Uint32T>(p_d), true));
...
void TestBitFieldUintptrOps_0(compiler::CodeAssemblerState* state_, TNode<Uint32T> p_val2, TNode<UintPtrT> p_val3)
{
    ...
    if (block10.is_used()) {
        ...
        tmp14 = ca_.UncheckedCast<Uint32T>(
            CodeStubAssembler(state_).UpdateWordInWord32<base::BitField<uintptr_t, 5, 6, uint32_t>>(ca_.UncheckedCast<Word32T>(p_val2), ca_.UncheckedCast<UintPtrT>(tmp13)));
    ...
    if (block14.is_used()) {
        ...
        tmp24 = ca_.UncheckedCast<Uint32T>(
            CodeStubAssembler(state_).UpdateWordInWord32<base::BitField<uintptr_t, 5, 6, uint32_t>>(ca_.UncheckedCast<Word32T>(tmp14), ca_.UncheckedCast<UintPtrT>(tmp23)));
    ...
    if (block18.is_used()) {
        ...
        tmp32 = ca_.UncheckedCast<UintPtrT>(
            CodeStubAssembler(state_).UpdateWord32InWord<base::BitField<uint32_t, 1, 9, uintptr_t>>(ca_.UncheckedCast<WordT>(p_val3), ca_.UncheckedCast<Uint32T>(tmp31)));
        tmp33 = FromConstexpr_uintptr_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x4d2ull));
        tmp34 = ca_.UncheckedCast<UintPtrT>(
            CodeStubAssembler(state_).UpdateWord<base::BitField<uintptr_t, 10, 17, uintptr_t>>(ca_.UncheckedCast<WordT>(tmp32), ca_.UncheckedCast<UintPtrT>(tmp33)));
...
void TestBitFieldMultipleFlags_0(compiler::CodeAssemblerState* state_, TNode<BoolT> p_a, TNode<Int32T> p_b, TNode<BoolT> p_c)
{
    ...
    if (block0.is_used()) {
        ...
        tmp3 = ca_.UncheckedCast<Uint32T>(
            CodeStubAssembler(state_).UpdateWord32<base::BitField<bool, 0, 1, uint32_t>>(ca_.UncheckedCast<Word32T>(tmp2), ca_.UncheckedCast<Uint32T>(p_a), true));
        tmp4 = ca_.UncheckedCast<Uint32T>(
            CodeStubAssembler(state_).UpdateWord32<base::BitField<int32_t, 1, 3, uint32_t>>(ca_.UncheckedCast<Word32T>(tmp3), ca_.UncheckedCast<Uint32T>(p_b), true));
        tmp5 = ca_.UncheckedCast<Uint32T>(
            CodeStubAssembler(state_).UpdateWord32<base::BitField<bool, 4, 1, uint32_t>>(ca_.UncheckedCast<Word32T>(tmp4), ca_.UncheckedCast<Uint32T>(p_c), true));
        ...
        tmp17 = Convert_int32_constexpr_IntegerLiteral_0(state_,
            (CodeStubAssembler(state_).ConstexprIntegerLiteralBitwiseOr(
                IntegerLiteral(false, 0x1ull), (CodeStubAssembler(state_).ConstexprIntegerLiteralLeftShift(IntegerLiteral(false, 0x3ull), IntegerLiteral(false, 0x1ull))))));
        ...
        CodeStubAssembler(state_).StaticAssert(TNode<BoolT> { tmp19 },
            "static_assert(simpleExpression == expectedReduction) at https://source.chromium.org/chromium/chromium/src/+/main:v8/test/torque/test-torque.tq?l=1151&c=3");
        ...
        CodeStubAssembler(state_).StaticAssert(TNode<BoolT> { tmp33 },
            "static_assert(simpleExpression == expectedReduction) at https://source.chromium.org/chromium/chromium/src/+/main:v8/test/torque/test-torque.tq?l=1154&c=3");
        ...
        CodeStubAssembler(state_).StaticAssert(TNode<BoolT> { tmp44 },
            "static_assert(simpleExpression == expectedReduction) at https://source.chromium.org/chromium/chromium/src/+/main:v8/test/torque/test-torque.tq?l=1157&c=3");
        ...
        tmp51 = Convert_int32_constexpr_IntegerLiteral_0(state_,
            (CodeStubAssembler(state_).ConstexprIntegerLiteralBitwiseOr(
                IntegerLiteral(false, 0x1ull), (CodeStubAssembler(state_).ConstexprIntegerLiteralLeftShift(IntegerLiteral(false, 0x1ull), IntegerLiteral(false, 0x4ull))))));
        ...
        CodeStubAssembler(state_).StaticAssert(TNode<BoolT> { tmp53 },
            "static_assert(simpleExpression == expectedReduction) at https://source.chromium.org/chromium/chromium/src/+/main:v8/test/torque/test-torque.tq?l=1160&c=3");
        ...
        tmp57 = ca_.UncheckedCast<Uint32T>(
            CodeStubAssembler(state_).UpdateWord32<base::BitField<int32_t, 0, 19, uint32_t>>(ca_.UncheckedCast<Word32T>(tmp56), ca_.UncheckedCast<Uint32T>(p_b), true));
        tmp58 = ca_.UncheckedCast<Uint32T>(
            CodeStubAssembler(state_).UpdateWord32<base::BitField<bool, 19, 1, uint32_t>>(ca_.UncheckedCast<Word32T>(tmp57), ca_.UncheckedCast<Uint32T>(p_a), true));
        tmp59 = ca_.UncheckedCast<Uint32T>(
            CodeStubAssembler(state_).UpdateWord32<base::BitField<bool, 20, 1, uint32_t>>(ca_.UncheckedCast<Word32T>(tmp58), ca_.UncheckedCast<Uint32T>(p_c), true));
        ...
        tmp71 = Convert_int32_constexpr_IntegerLiteral_0(state_,
            (CodeStubAssembler(state_).ConstexprIntegerLiteralBitwiseOr(
                IntegerLiteral(false, 0x4d2ull), (CodeStubAssembler(state_).ConstexprIntegerLiteralLeftShift(IntegerLiteral(false, 0x1ull), IntegerLiteral(false, 0x14ull))))));
        ...
        CodeStubAssembler(state_).StaticAssert(TNode<BoolT> { tmp73 },
            "static_assert(simpleExpression == expectedReduction) at https://source.chromium.org/chromium/chromium/src/+/main:v8/test/torque/test-torque.tq?l=1164&c=3");
        ...
        CodeStubAssembler(state_).StaticAssert(TNode<BoolT> { tmp84 },
            "static_assert(simpleExpression == expectedReduction) at https://source.chromium.org/chromium/chromium/src/+/main:v8/test/torque/test-torque.tq?l=1167&c=3");
        ca_.Goto(&block2);
    }
...
TNode<InternalClassWithSmiElements> Cast_InternalClassWithSmiElements_0(
    compiler::CodeAssemblerState* state_, TNode<HeapObject> p_obj, compiler::CodeAssemblerLabel* label_CastError)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
...
void TestFullyGeneratedClassWithElements_0(compiler::CodeAssemblerState* state_)
{
    ...
    if (block0.is_used()) {
        ...
        InitializeFieldsFromIterator_Smi_SmiGeneratorIterator_0(state_,
            TorqueStructSlice_Smi_MutableReference_Smi_0 { TNode<Object> { tmp8 }, TNode<IntPtrT> { tmp14 }, TNode<IntPtrT> { tmp4 }, TorqueStructUnsafe_0 {} },
            TorqueStructSmiGeneratorIterator_0 { TNode<Smi> { tmp2 } });
        ...
        InitializeFieldsFromIterator_Smi_SmiGeneratorIterator_0(state_,
            TorqueStructSlice_Smi_MutableReference_Smi_0 { TNode<Object> { tmp26 }, TNode<IntPtrT> { tmp36 }, TNode<IntPtrT> { tmp20 }, TorqueStructUnsafe_0 {} },
            TorqueStructSmiGeneratorIterator_0 { TNode<Smi> { tmp17 } });
        InitializeFieldsFromIterator_InternalClassStructElement_InternalClassStructElementGeneratorIterator_0(state_,
            TorqueStructSlice_InternalClassStructElement_MutableReference_InternalClassStructElement_0 {
                TNode<Object> { tmp26 }, TNode<IntPtrT> { tmp22 }, TNode<IntPtrT> { tmp23 }, TorqueStructUnsafe_0 {} },
            TorqueStructInternalClassStructElementGeneratorIterator_0 { TNode<Smi> { tmp18 } });
...
void TestGeneratedCastOperators_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context)
{
    ...
    if (block0.is_used()) {
        ...
        tmp53 = NewSloppyArgumentsElements_ConstantIterator_TheHole_0(
            state_, TNode<Smi> { tmp52 }, TNode<Context> { p_context }, TNode<FixedArray> { tmp49 }, TorqueStructConstantIterator_TheHole_0 { TNode<Oddball> { tmp51 } });
...
void TestCreateLazyNodeFromTorque_0(compiler::CodeAssemblerState* state_)
{
    ...
    if (block6.is_used()) {
        ...
        tmp15 = [=]() {
            return AddSmiAndConstexprValues_0(state_, TNode<Smi> { tmp14 }, (FromConstexpr_constexpr_int31_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x8ull))));
        };
    ...
    compiler::CodeAssemblerState* state_, TNode<InternalClassWithStructElements> p_o)
{
    ...
    ca_.Bind(&block2);
    return TorqueStructSlice_InternalClassStructElement_MutableReference_InternalClassStructElement_0 { TNode<Object> { tmp9 }, TNode<IntPtrT> { tmp10 }, TNode<IntPtrT> { tmp11 },
...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/test/torque/test-torque.tq?l=1191&c=1
TNode<InternalClassWithSmiElements> DownCastForTorqueClass_InternalClassWithSmiElements_0(
    compiler::CodeAssemblerState* state_, TNode<HeapObject> p_o, compiler::CodeAssemblerLabel* label_CastError)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
...
void InitializeFieldsFromIterator_Smi_SmiGeneratorIterator_0(
    compiler::CodeAssemblerState* state_, TorqueStructSlice_Smi_MutableReference_Smi_0 p_target, TorqueStructSmiGeneratorIterator_0 p_originIterator)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
...
void InitializeFieldsFromIterator_InternalClassStructElement_InternalClassStructElementGeneratorIterator_0(compiler::CodeAssemblerState* state_,
    TorqueStructSlice_InternalClassStructElement_MutableReference_InternalClassStructElement_0 p_target, TorqueStructInternalClassStructElementGeneratorIterator_0 p_originIterator)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
...
TNode<FixedArray> NewFixedArray_ConstantIterator_TheHole_0(compiler::CodeAssemblerState* state_, TNode<IntPtrT> p_length, TorqueStructConstantIterator_TheHole_0 p_it)
{
    ...
    if (block5.is_used()) {
        ...
        InitializeFieldsFromIterator_Object_ConstantIterator_TheHole_0(state_,
            TorqueStructSlice_Object_MutableReference_Object_0 { TNode<Object> { tmp12 }, TNode<IntPtrT> { tmp15 }, TNode<IntPtrT> { tmp8 }, TorqueStructUnsafe_0 {} },
            TorqueStructConstantIterator_TheHole_0 { TNode<Oddball> { p_it.value } });
...
TNode<SloppyArgumentsElements> NewSloppyArgumentsElements_ConstantIterator_TheHole_0(
    compiler::CodeAssemblerState* state_, TNode<Smi> p_length, TNode<Context> p_context, TNode<FixedArray> p_arguments, TorqueStructConstantIterator_TheHole_0 p_it)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    if (block0.is_used()) {
        ...
        InitializeFieldsFromIterator_Smi_OR_TheHole_ConstantIterator_TheHole_0(state_,
            TorqueStructSlice_Smi_OR_TheHole_MutableReference_Smi_OR_TheHole_0 {
                TNode<Object> { tmp5 }, TNode<IntPtrT> { tmp10 }, TNode<IntPtrT> { tmp1 }, TorqueStructUnsafe_0 {} },
            TorqueStructConstantIterator_TheHole_0 { TNode<Oddball> { p_it.value } });
    ...
    compiler::CodeAssemblerState* state_, TNode<Object> p_object, TNode<IntPtrT> p_offset, TNode<IntPtrT> p_length)
{
    ...
    ca_.Bind(&block2);
    return TorqueStructSlice_InternalClassStructElement_MutableReference_InternalClassStructElement_0 { TNode<Object> { tmp0 }, TNode<IntPtrT> { tmp1 }, TNode<IntPtrT> { tmp2 },
        TorqueStructUnsafe_0 {} };
}
