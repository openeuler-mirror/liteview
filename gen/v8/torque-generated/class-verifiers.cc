...
void TorqueGeneratedClassVerifiers::JSReceiverVerify(JSReceiver o, Isolate* isolate)
{
    CHECK(o.IsJSReceiver(isolate));
    {
        ...
        CHECK(properties_or_hash__value.IsSmi() || properties_or_hash__value.IsFixedArrayBase() || properties_or_hash__value.IsPropertyArray()
            || properties_or_hash__value.IsSwissNameDictionary());
    }
}
void TorqueGeneratedClassVerifiers::PrimitiveHeapObjectVerify(PrimitiveHeapObject o, Isolate* isolate) { CHECK(o.IsPrimitiveHeapObject(isolate)); }
...
void TorqueGeneratedClassVerifiers::WeakFixedArrayVerify(WeakFixedArray o, Isolate* isolate)
{
    ...
    for (int i = 0; i < static_cast<int>(objects__length); ++i) {
        ...
        CHECK(objects__value.IsCleared() || (!objects__value.IsWeak() && objects__value.GetHeapObjectOrSmi().IsHeapObject())
            || (!objects__value.IsWeak() && objects__value.GetHeapObjectOrSmi().IsSmi()) || objects__value.IsWeak());
    }
}
void TorqueGeneratedClassVerifiers::ForeignVerify(Foreign o, Isolate* isolate) { CHECK(o.IsForeign(isolate)); }
...
void TorqueGeneratedClassVerifiers::JSWrappedFunctionVerify(JSWrappedFunction o, Isolate* isolate)
{
    ...
    CHECK(o.IsJSWrappedFunction(isolate));
    {
        ...
        CHECK(wrapped_target_function__value.IsCallableApiObject() || wrapped_target_function__value.IsCallableJSProxy() || wrapped_target_function__value.IsJSWrappedFunction()
            || wrapped_target_function__value.IsJSBoundFunction() || wrapped_target_function__value.IsJSFunction());
    }
    {
...
void TorqueGeneratedClassVerifiers::JSBoundFunctionVerify(JSBoundFunction o, Isolate* isolate)
{
    ...
    CHECK(o.IsJSBoundFunction(isolate));
    {
        ...
        CHECK(bound_target_function__value.IsCallableApiObject() || bound_target_function__value.IsCallableJSProxy() || bound_target_function__value.IsJSWrappedFunction()
            || bound_target_function__value.IsJSBoundFunction() || bound_target_function__value.IsJSFunction());
    }
    {
        Object bound_this__value = TaggedField<Object>::load(o, 16);
        Object::VerifyPointer(isolate, bound_this__value);
        CHECK(bound_this__value.IsJSReceiver() || bound_this__value.IsUndefined() || bound_this__value.IsNull() || bound_this__value.IsFalse() || bound_this__value.IsTrue()
            || bound_this__value.IsSymbol() || bound_this__value.IsString() || bound_this__value.IsBigInt() || bound_this__value.IsHeapNumber() || bound_this__value.IsSmi()
            || bound_this__value.IsSourceTextModule());
    }
    {
...
void TorqueGeneratedClassVerifiers::WeakCellVerify(WeakCell o, Isolate* isolate)
{
    ...
    }
    {
        ...
        CHECK(holdings__value.IsJSReceiver() || holdings__value.IsUndefined() || holdings__value.IsNull() || holdings__value.IsFalse() || holdings__value.IsTrue()
            || holdings__value.IsSymbol() || holdings__value.IsString() || holdings__value.IsBigInt() || holdings__value.IsHeapNumber() || holdings__value.IsSmi());
    }
    {
...
void TorqueGeneratedClassVerifiers::MapVerify(Map o, Isolate* isolate)
{
    ...
    }
    {
        ...
        CHECK(transitions_or_prototype_info__value.IsCleared()
            || (!transitions_or_prototype_info__value.IsWeak() && transitions_or_prototype_info__value.GetHeapObjectOrSmi().IsSmi())
            || (!transitions_or_prototype_info__value.IsWeak() && transitions_or_prototype_info__value.GetHeapObjectOrSmi().IsTransitionArray())
            || (!transitions_or_prototype_info__value.IsWeak() && transitions_or_prototype_info__value.GetHeapObjectOrSmi().IsMap())
            || (transitions_or_prototype_info__value.IsWeak() && transitions_or_prototype_info__value.GetHeapObjectOrSmi().IsMap())
            || (!transitions_or_prototype_info__value.IsWeak() && transitions_or_prototype_info__value.GetHeapObjectOrSmi().IsPrototypeInfo()));
    }
}
void TorqueGeneratedClassVerifiers::JSPromiseVerify(JSPromise o, Isolate* isolate)
{
    ...
    CHECK(o.IsJSPromise(isolate));
    {
        ...
        CHECK(reactions_or_result__value.IsJSReceiver() || reactions_or_result__value.IsUndefined() || reactions_or_result__value.IsNull() || reactions_or_result__value.IsFalse()
            || reactions_or_result__value.IsTrue() || reactions_or_result__value.IsSymbol() || reactions_or_result__value.IsString() || reactions_or_result__value.IsBigInt()
            || reactions_or_result__value.IsHeapNumber() || reactions_or_result__value.IsSmi() || reactions_or_result__value.IsPromiseReaction());
    }
    {
...
void TorqueGeneratedClassVerifiers::StructVerify(Struct o, Isolate* isolate) { CHECK(o.IsStruct(isolate)); }
...
void TorqueGeneratedClassVerifiers::JSTypedArrayVerify(JSTypedArray o, Isolate* isolate)
{
    ...
    {
        Object base_pointer__value = TaggedField<Object>::load(o, 36);
...
void TorqueGeneratedClassVerifiers::DataHandlerVerify(DataHandler o, Isolate* isolate)
{
    ...
    }
    {
        ...
        CHECK(data1__value.IsCleared() || (!data1__value.IsWeak() && data1__value.GetHeapObjectOrSmi().IsHeapObject())
            || (!data1__value.IsWeak() && data1__value.GetHeapObjectOrSmi().IsSmi()) || data1__value.IsWeak());
    }
    {
        MaybeObject data2__value = TaggedField<MaybeObject>::load(o, 16);
        MaybeObject::VerifyMaybeObjectPointer(isolate, data2__value);
        CHECK(data2__value.IsCleared() || (!data2__value.IsWeak() && data2__value.GetHeapObjectOrSmi().IsHeapObject())
            || (!data2__value.IsWeak() && data2__value.GetHeapObjectOrSmi().IsSmi()) || data2__value.IsWeak());
    }
    {
        MaybeObject data3__value = TaggedField<MaybeObject>::load(o, 20);
        MaybeObject::VerifyMaybeObjectPointer(isolate, data3__value);
        CHECK(data3__value.IsCleared() || (!data3__value.IsWeak() && data3__value.GetHeapObjectOrSmi().IsHeapObject())
            || (!data3__value.IsWeak() && data3__value.GetHeapObjectOrSmi().IsSmi()) || data3__value.IsWeak());
    }
}
...
void TorqueGeneratedClassVerifiers::CallSiteInfoVerify(CallSiteInfo o, Isolate* isolate)
{
    ...
    CHECK(o.IsCallSiteInfo(isolate));
    {
        ...
        CHECK(receiver_or_instance__value.IsJSReceiver() || receiver_or_instance__value.IsUndefined() || receiver_or_instance__value.IsNull()
            || receiver_or_instance__value.IsFalse() || receiver_or_instance__value.IsTrue() || receiver_or_instance__value.IsSymbol() || receiver_or_instance__value.IsString()
            || receiver_or_instance__value.IsBigInt() || receiver_or_instance__value.IsHeapNumber() || receiver_or_instance__value.IsSmi());
    }
    {
...
void TorqueGeneratedClassVerifiers::ErrorStackDataVerify(ErrorStackData o, Isolate* isolate)
{
    ...
    CHECK(o.IsErrorStackData(isolate));
    {
        ...
        CHECK(call_site_infos_or_formatted_stack__value.IsJSReceiver() || call_site_infos_or_formatted_stack__value.IsUndefined()
            || call_site_infos_or_formatted_stack__value.IsNull() || call_site_infos_or_formatted_stack__value.IsFalse() || call_site_infos_or_formatted_stack__value.IsTrue()
            || call_site_infos_or_formatted_stack__value.IsSymbol() || call_site_infos_or_formatted_stack__value.IsString() || call_site_infos_or_formatted_stack__value.IsBigInt()
            || call_site_infos_or_formatted_stack__value.IsHeapNumber() || call_site_infos_or_formatted_stack__value.IsSmi()
            || call_site_infos_or_formatted_stack__value.IsFixedArray());
    }
    {
...
void TorqueGeneratedClassVerifiers::DescriptorArrayVerify(DescriptorArray o, Isolate* isolate)
{
    ...
    for (int i = 0; i < static_cast<int>(descriptors__length); ++i) {
        ...
        CHECK(value__value.IsCleared() || (!value__value.IsWeak() && value__value.GetHeapObjectOrSmi().IsJSReceiver())
            || (!value__value.IsWeak() && value__value.GetHeapObjectOrSmi().IsUndefined()) || (!value__value.IsWeak() && value__value.GetHeapObjectOrSmi().IsNull())
            || (!value__value.IsWeak() && value__value.GetHeapObjectOrSmi().IsFalse()) || (!value__value.IsWeak() && value__value.GetHeapObjectOrSmi().IsTrue())
            || (!value__value.IsWeak() && value__value.GetHeapObjectOrSmi().IsSymbol()) || (!value__value.IsWeak() && value__value.GetHeapObjectOrSmi().IsString())
            || (!value__value.IsWeak() && value__value.GetHeapObjectOrSmi().IsBigInt()) || (!value__value.IsWeak() && value__value.GetHeapObjectOrSmi().IsHeapNumber())
            || (!value__value.IsWeak() && value__value.GetHeapObjectOrSmi().IsSmi()) || (!value__value.IsWeak() && value__value.GetHeapObjectOrSmi().IsAccessorInfo())
            || (!value__value.IsWeak() && value__value.GetHeapObjectOrSmi().IsClassPositions()) || (!value__value.IsWeak() && value__value.GetHeapObjectOrSmi().IsAccessorPair())
            || (value__value.IsWeak() && value__value.GetHeapObjectOrSmi().IsMap()));
    }
}
...
void TorqueGeneratedClassVerifiers::FeedbackVectorVerify(FeedbackVector o, Isolate* isolate)
{
    ...
    for (int i = 0; i < static_cast<int>(raw_feedback_slots__length); ++i) {
        ...
        CHECK(raw_feedback_slots__value.IsCleared() || (!raw_feedback_slots__value.IsWeak() && raw_feedback_slots__value.GetHeapObjectOrSmi().IsHeapObject())
            || (!raw_feedback_slots__value.IsWeak() && raw_feedback_slots__value.GetHeapObjectOrSmi().IsSmi()) || raw_feedback_slots__value.IsWeak());
    }
}
...
void TorqueGeneratedClassVerifiers::JSGeneratorObjectVerify(JSGeneratorObject o, Isolate* isolate)
{
    ...
    }
    {
        ...
        CHECK(receiver__value.IsJSReceiver() || receiver__value.IsUndefined() || receiver__value.IsNull() || receiver__value.IsFalse() || receiver__value.IsTrue()
            || receiver__value.IsSymbol() || receiver__value.IsString() || receiver__value.IsBigInt() || receiver__value.IsHeapNumber() || receiver__value.IsSmi());
    }
    {
...
void TorqueGeneratedClassVerifiers::JSPrimitiveWrapperVerify(JSPrimitiveWrapper o, Isolate* isolate)
{
    ...
    CHECK(o.IsJSPrimitiveWrapper(isolate));
    {
        Object value__value = TaggedField<Object>::load(o, 12);
        Object::VerifyPointer(isolate, value__value);
        CHECK(value__value.IsJSReceiver() || value__value.IsUndefined() || value__value.IsNull() || value__value.IsFalse() || value__value.IsTrue() || value__value.IsSymbol()
            || value__value.IsString() || value__value.IsBigInt() || value__value.IsHeapNumber() || value__value.IsSmi());
    }
}
...
void TorqueGeneratedClassVerifiers::JSFinalizationRegistryVerify(JSFinalizationRegistry o, Isolate* isolate)
{
    ...
    }
    {
        ...
        CHECK(cleanup__value.IsCallableApiObject() || cleanup__value.IsCallableJSProxy() || cleanup__value.IsJSWrappedFunction() || cleanup__value.IsJSBoundFunction()
            || cleanup__value.IsJSFunction());
    }
    {
...
void TorqueGeneratedClassVerifiers::MegaDomHandlerVerify(MegaDomHandler o, Isolate* isolate)
{
    CHECK(o.IsMegaDomHandler(isolate));
    {
        ...
        CHECK(accessor__value.IsCleared() || (!accessor__value.IsWeak() && accessor__value.GetHeapObjectOrSmi().IsHeapObject())
            || (!accessor__value.IsWeak() && accessor__value.GetHeapObjectOrSmi().IsSmi()) || accessor__value.IsWeak());
    }
    {
        MaybeObject context__value = TaggedField<MaybeObject>::load(o, 8);
        MaybeObject::VerifyMaybeObjectPointer(isolate, context__value);
        CHECK(context__value.IsCleared() || (!context__value.IsWeak() && context__value.GetHeapObjectOrSmi().IsHeapObject())
            || (!context__value.IsWeak() && context__value.GetHeapObjectOrSmi().IsSmi()) || context__value.IsWeak());
    }
}
...
void TorqueGeneratedClassVerifiers::PromiseReactionVerify(PromiseReaction o, Isolate* isolate)
{
    ...
    }
    {
        ...
        CHECK(reject_handler__value.IsUndefined() || reject_handler__value.IsCallableApiObject() || reject_handler__value.IsCallableJSProxy()
            || reject_handler__value.IsJSWrappedFunction() || reject_handler__value.IsJSBoundFunction() || reject_handler__value.IsJSFunction());
    }
    {
        Object fulfill_handler__value = TaggedField<Object>::load(o, 12);
        Object::VerifyPointer(isolate, fulfill_handler__value);
        CHECK(fulfill_handler__value.IsUndefined() || fulfill_handler__value.IsCallableApiObject() || fulfill_handler__value.IsCallableJSProxy()
            || fulfill_handler__value.IsJSWrappedFunction() || fulfill_handler__value.IsJSBoundFunction() || fulfill_handler__value.IsJSFunction());
    }
    {
...
void TorqueGeneratedClassVerifiers::PromiseReactionJobTaskVerify(PromiseReactionJobTask o, Isolate* isolate)
{
    ...
    }
    {
        Object handler__value = TaggedField<Object>::load(o, 12);
        Object::VerifyPointer(isolate, handler__value);
        CHECK(handler__value.IsUndefined() || handler__value.IsCallableApiObject() || handler__value.IsCallableJSProxy() || handler__value.IsJSWrappedFunction()
            || handler__value.IsJSBoundFunction() || handler__value.IsJSFunction());
    }
    {
        Object promise_or_capability__value = TaggedField<Object>::load(o, 16);
        Object::VerifyPointer(isolate, promise_or_capability__value);
...
void TorqueGeneratedClassVerifiers::PropertyDescriptorObjectVerify(PropertyDescriptorObject o, Isolate* isolate)
{
    ...
    }
    {
        ...
        Object::VerifyPointer(isolate, value__value);
        CHECK(value__value.IsJSReceiver() || value__value.IsUndefined() || value__value.IsNull() || value__value.IsFalse() || value__value.IsTrue() || value__value.IsSymbol()
            || value__value.IsString() || value__value.IsBigInt() || value__value.IsHeapNumber() || value__value.IsSmi() || value__value.IsTheHole());
    }
    {
        Object get__value = TaggedField<Object>::load(o, 12);
        Object::VerifyPointer(isolate, get__value);
        CHECK(get__value.IsJSReceiver() || get__value.IsUndefined() || get__value.IsNull() || get__value.IsFalse() || get__value.IsTrue() || get__value.IsSymbol()
            || get__value.IsString() || get__value.IsBigInt() || get__value.IsHeapNumber() || get__value.IsSmi() || get__value.IsTheHole());
    }
    {
        Object set__value = TaggedField<Object>::load(o, 16);
        Object::VerifyPointer(isolate, set__value);
        CHECK(set__value.IsJSReceiver() || set__value.IsUndefined() || set__value.IsNull() || set__value.IsFalse() || set__value.IsTrue() || set__value.IsSymbol()
            || set__value.IsString() || set__value.IsBigInt() || set__value.IsHeapNumber() || set__value.IsSmi() || set__value.IsTheHole());
    }
}
void TorqueGeneratedClassVerifiers::PrototypeInfoVerify(PrototypeInfo o, Isolate* isolate)
{
    ...
    }
    {
        ...
        CHECK(object_create_map__value.IsCleared() || (!object_create_map__value.IsWeak() && object_create_map__value.GetHeapObjectOrSmi().IsUndefined())
            || (object_create_map__value.IsWeak() && object_create_map__value.GetHeapObjectOrSmi().IsMap()));
    }
}
void TorqueGeneratedClassVerifiers::ScriptVerify(Script o, Isolate* isolate)
{
    ...
    }
    {
        ...
        CHECK(eval_from_shared_or_wrapped_arguments_or_sfi_table__value.IsUndefined() || eval_from_shared_or_wrapped_arguments_or_sfi_table__value.IsFixedArray()
            || eval_from_shared_or_wrapped_arguments_or_sfi_table__value.IsSharedFunctionInfo());
    }
    {
    ...
    {
        Object source_hash__value = TaggedField<Object>::load(o, 64);
        Object::VerifyPointer(isolate, source_hash__value);
        CHECK(source_hash__value.IsUndefined() || source_hash__value.IsString());
    }
}
void TorqueGeneratedClassVerifiers::PreparseDataVerify(PreparseData o, Isolate* isolate) { CHECK(o.IsPreparseData(isolate)); }
...
void TorqueGeneratedClassVerifiers::OnHeapBasicBlockProfilerDataVerify(OnHeapBasicBlockProfilerData o, Isolate* isolate)
{
    ...
    {
        Object branches__value = TaggedField<Object>::load(o, 12);
    ...
    {
        Object schedule__value = TaggedField<Object>::load(o, 20);
    ...
    {
        Object hash__value = TaggedField<Object>::load(o, 28);
        Object::VerifyPointer(isolate, hash__value);
        CHECK(hash__value.IsSmi());
    }
}
...
void TorqueGeneratedClassVerifiers::TurbofanTypeVerify(TurbofanType o, Isolate* isolate) { CHECK(o.IsTurbofanType(isolate)); }
...
void TorqueGeneratedClassVerifiers::AbstractInternalClassVerify(AbstractInternalClass o, Isolate* isolate) { CHECK(o.IsAbstractInternalClass(isolate)); }
...
void TorqueGeneratedClassVerifiers::SortStateVerify(SortState o, Isolate* isolate)
{
    ...
    }
    {
        ...
        CHECK(userCmpFn__value.IsUndefined() || userCmpFn__value.IsCallableApiObject() || userCmpFn__value.IsCallableJSProxy() || userCmpFn__value.IsJSWrappedFunction()
            || userCmpFn__value.IsJSBoundFunction() || userCmpFn__value.IsJSFunction());
    }
    {
...
void TorqueGeneratedClassVerifiers::WasmFunctionDataVerify(WasmFunctionData o, Isolate* isolate)
{
    ...
    {
        Object js_promise_flags__value = TaggedField<Object>::load(o, 12);
...
void TorqueGeneratedClassVerifiers::WasmExportedFunctionDataVerify(WasmExportedFunctionData o, Isolate* isolate)
{
    ...
    {
        Object function_index__value = TaggedField<Object>::load(o, 20);
...
void TorqueGeneratedClassVerifiers::WasmCapiFunctionDataVerify(WasmCapiFunctionData o, Isolate* isolate)
{
    ...
    {
        Object embedder_data__value = TaggedField<Object>::load(o, 16);
...
void TorqueGeneratedClassVerifiers::WasmResumeDataVerify(WasmResumeData o, Isolate* isolate)
{
    ...
    {
        Object on_resume__value = TaggedField<Object>::load(o, 8);
...
void TorqueGeneratedClassVerifiers::WasmIndirectFunctionTableVerify(WasmIndirectFunctionTable o, Isolate* isolate)
{
    ...
    {
        Object managed_native_allocations__value = TaggedField<Object>::load(o, 16);
    ...
    {
        Object refs__value = TaggedField<Object>::load(o, 20);
...
void TorqueGeneratedClassVerifiers::WasmContinuationObjectVerify(WasmContinuationObject o, Isolate* isolate)
{
    ...
    {
        Object parent__value = TaggedField<Object>::load(o, 8);
        Object::VerifyPointer(isolate, parent__value);
...
void TorqueGeneratedClassVerifiers::WasmSuspenderObjectVerify(WasmSuspenderObject o, Isolate* isolate)
{
    ...
    {
        Object state__value = TaggedField<Object>::load(o, 28);
...
void TorqueGeneratedClassVerifiers::WasmModuleObjectVerify(WasmModuleObject o, Isolate* isolate)
{
    ...
    {
        Object script__value = TaggedField<Object>::load(o, 16);
        Object::VerifyPointer(isolate, script__value);
        CHECK(script__value.IsScript());
    }
}
...
void TorqueGeneratedClassVerifiers::WasmMemoryObjectVerify(WasmMemoryObject o, Isolate* isolate)
{
    ...
    {
        Object is_memory64__value = TaggedField<Object>::load(o, 20);
        Object::VerifyPointer(isolate, is_memory64__value);
        CHECK(is_memory64__value.IsSmi());
    }
    {
        Object instances__value = TaggedField<Object>::load(o, 24);
...
void TorqueGeneratedClassVerifiers::AsmWasmDataVerify(AsmWasmData o, Isolate* isolate)
{
    ...
    {
        Object uses_bitset__value = TaggedField<Object>::load(o, 8);
...
void TorqueGeneratedClassVerifiers::WasmTypeInfoVerify(WasmTypeInfo o, Isolate* isolate)
{
    ...
    {
        Object supertypes_length__value = TaggedField<Object>::load(o, 16);
...
void TorqueGeneratedClassVerifiers::WasmStringViewIterVerify(WasmStringViewIter o, Isolate* isolate)
{
    ...
    {
        Object string__value = TaggedField<Object>::load(o, 4);
        Object::VerifyPointer(isolate, string__value);
        CHECK(string__value.IsString());
    }
}
