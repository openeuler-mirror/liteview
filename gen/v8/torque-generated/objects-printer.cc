...
namespace v8 {
namespace internal {
template <> void TorqueGeneratedSymbol<Symbol, Name>::SymbolPrint(std::ostream& os)
{
...
template <> void TorqueGeneratedHeapNumber<HeapNumber, PrimitiveHeapObject>::HeapNumberPrint(std::ostream& os)
{
...
template <> void TorqueGeneratedFixedArray<FixedArray, FixedArrayBase>::FixedArrayPrint(std::ostream& os)
{
...
template <> void TorqueGeneratedWeakFixedArray<WeakFixedArray, HeapObject>::WeakFixedArrayPrint(std::ostream& os)
{
...
template <> void TorqueGeneratedWasmInternalFunction<WasmInternalFunction, HeapObject>::WasmInternalFunctionPrint(std::ostream& os)
{
...
template <> void TorqueGeneratedCallHandlerInfo<CallHandlerInfo, HeapObject>::CallHandlerInfoPrint(std::ostream& os)
{
...
template <> void TorqueGeneratedSloppyArgumentsElements<SloppyArgumentsElements, FixedArrayBase>::SloppyArgumentsElementsPrint(std::ostream& os)
{
...
template <> void TorqueGeneratedBytecodeArray<BytecodeArray, FixedArrayBase>::BytecodeArrayPrint(std::ostream& os)
{
...
template <> void TorqueGeneratedFixedDoubleArray<FixedDoubleArray, FixedArrayBase>::FixedDoubleArrayPrint(std::ostream& os)
{
...
template <> void TorqueGeneratedRegExpMatchInfo<RegExpMatchInfo, FixedArray>::RegExpMatchInfoPrint(std::ostream& os)
{
...
template <> void TorqueGeneratedPromiseOnStack<PromiseOnStack, Struct>::PromiseOnStackPrint(std::ostream& os)
{
...
template <> void TorqueGeneratedByteArray<ByteArray, FixedArrayBase>::ByteArrayPrint(std::ostream& os)
{
...
template <> void TorqueGeneratedArrayList<ArrayList, FixedArray>::ArrayListPrint(std::ostream& os)
{
...
template <> void TorqueGeneratedTemplateList<TemplateList, FixedArray>::TemplateListPrint(std::ostream& os)
{
...
template <> void TorqueGeneratedJSArrayBuffer<JSArrayBuffer, JSObjectWithEmbedderSlots>::JSArrayBufferPrint(std::ostream& os)
{
...
template <> void TorqueGeneratedJSDataView<JSDataView, JSArrayBufferView>::JSDataViewPrint(std::ostream& os)
{
...
template <> void TorqueGeneratedJSSharedArray<JSSharedArray, JSObject>::JSSharedArrayPrint(std::ostream& os)
{
...
template <> void TorqueGeneratedJSSharedStruct<JSSharedStruct, JSObject>::JSSharedStructPrint(std::ostream& os)
{
...
template <> void TorqueGeneratedRegExpBoilerplateDescription<RegExpBoilerplateDescription, Struct>::RegExpBoilerplateDescriptionPrint(std::ostream& os)
{
...
template <> void TorqueGeneratedPromiseFulfillReactionJobTask<PromiseFulfillReactionJobTask, PromiseReactionJobTask>::PromiseFulfillReactionJobTaskPrint(std::ostream& os)
{
...
template <> void TorqueGeneratedPromiseRejectReactionJobTask<PromiseRejectReactionJobTask, PromiseReactionJobTask>::PromiseRejectReactionJobTaskPrint(std::ostream& os)
{
...
template <> void TorqueGeneratedInterpreterData<InterpreterData, Struct>::InterpreterDataPrint(std::ostream& os)
{
...
template <> void TorqueGeneratedUncompiledDataWithoutPreparseData<UncompiledDataWithoutPreparseData, UncompiledData>::UncompiledDataWithoutPreparseDataPrint(std::ostream& os)
{
...
template <> void TorqueGeneratedUncompiledDataWithPreparseData<UncompiledDataWithPreparseData, UncompiledData>::UncompiledDataWithPreparseDataPrint(std::ostream& os)
{
...
template <>
void TorqueGeneratedUncompiledDataWithPreparseDataAndJob<UncompiledDataWithPreparseDataAndJob, UncompiledDataWithPreparseData>::UncompiledDataWithPreparseDataAndJobPrint(
    std::ostream& os)
{
...
template <> void TorqueGeneratedConsString<ConsString, String>::ConsStringPrint(std::ostream& os)
{
...
template <> void TorqueGeneratedExternalOneByteString<ExternalOneByteString, ExternalString>::ExternalOneByteStringPrint(std::ostream& os)
{
...
template <> void TorqueGeneratedExternalTwoByteString<ExternalTwoByteString, ExternalString>::ExternalTwoByteStringPrint(std::ostream& os)
{
...
template <> void TorqueGeneratedInternalizedString<InternalizedString, String>::InternalizedStringPrint(std::ostream& os)
{
...
template <> void TorqueGeneratedSeqOneByteString<SeqOneByteString, SeqString>::SeqOneByteStringPrint(std::ostream& os)
{
...
template <> void TorqueGeneratedSeqTwoByteString<SeqTwoByteString, SeqString>::SeqTwoByteStringPrint(std::ostream& os)
{
...
template <> void TorqueGeneratedSlicedString<SlicedString, String>::SlicedStringPrint(std::ostream& os)
{
...
template <> void TorqueGeneratedThinString<ThinString, String>::ThinStringPrint(std::ostream& os)
{
...
template <> void TorqueGeneratedCachedTemplateObject<CachedTemplateObject, Struct>::CachedTemplateObjectPrint(std::ostream& os)
{
...
template <> void TorqueGeneratedTurbofanOtherNumberConstantType<TurbofanOtherNumberConstantType, TurbofanType>::TurbofanOtherNumberConstantTypePrint(std::ostream& os)
{
...
template <> void TorqueGeneratedAbstractInternalClassSubclass1<AbstractInternalClassSubclass1, AbstractInternalClass>::AbstractInternalClassSubclass1Print(std::ostream& os)
{
    this->PrintHeader(os, "AbstractInternalClassSubclass1");
    os << '\n';
}

template <> void TorqueGeneratedAbstractInternalClassSubclass2<AbstractInternalClassSubclass2, AbstractInternalClass>::AbstractInternalClassSubclass2Print(std::ostream& os)
{
    this->PrintHeader(os, "AbstractInternalClassSubclass2");
    os << '\n';
}

template <> void TorqueGeneratedInternalClassWithSmiElements<InternalClassWithSmiElements, FixedArrayBase>::InternalClassWithSmiElementsPrint(std::ostream& os)
{
...
template <> void TorqueGeneratedInternalClassWithStructElements<InternalClassWithStructElements, HeapObject>::InternalClassWithStructElementsPrint(std::ostream& os)
{
...
template <> void TorqueGeneratedWasmApiFunctionRef<WasmApiFunctionRef, HeapObject>::WasmApiFunctionRefPrint(std::ostream& os)
{
...
template <> void TorqueGeneratedWasmFunctionData<WasmFunctionData, HeapObject>::WasmFunctionDataPrint(std::ostream& os)
{
...
template <> void TorqueGeneratedWasmIndirectFunctionTable<WasmIndirectFunctionTable, Struct>::WasmIndirectFunctionTablePrint(std::ostream& os)
{
...
template <> void TorqueGeneratedWasmSuspenderObject<WasmSuspenderObject, JSObject>::WasmSuspenderObjectPrint(std::ostream& os)
{
