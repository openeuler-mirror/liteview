...
public:
    ...
    Value<uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> GetInobjectPropertiesStartOrConstructorFunctionIndexValue(
        d::MemoryAccessor accessor) const;
...
public:
    inline TqCallHandlerInfo(uintptr_t address)
        : TqHeapObject(address)
    {
    }
    std::vector<std::unique_ptr<ObjectProperty>> GetProperties(d::MemoryAccessor accessor) const override;
...
public:
    ...
    Value<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> GetIncomingNewTargetOrGeneratorRegisterValue(
        d::MemoryAccessor accessor) const;
...
public:
    inline TqPromiseOnStack(uintptr_t address)
        : TqStruct(address)
    {
    }
    std::vector<std::unique_ptr<ObjectProperty>> GetProperties(d::MemoryAccessor accessor) const override;
...
public:
    ...
    Value<uint16_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> GetRawNumberOfMarkedDescriptorsValue(
        d::MemoryAccessor accessor) const;
...
public:
    inline TqTemplateList(uintptr_t address)
        : TqFixedArray(address)
    {
    }
    std::vector<std::unique_ptr<ObjectProperty>> GetProperties(d::MemoryAccessor accessor) const override;
...
public:
    inline TqCachedTemplateObject(uintptr_t address)
        : TqStruct(address)
    {
    }
    std::vector<std::unique_ptr<ObjectProperty>> GetProperties(d::MemoryAccessor accessor) const override;
...
public:
    inline TqInternalClassWithSmiElements(uintptr_t address)
        : TqFixedArrayBase(address)
    {
    }
    std::vector<std::unique_ptr<ObjectProperty>> GetProperties(d::MemoryAccessor accessor) const override;
...
public:
    inline TqWasmApiFunctionRef(uintptr_t address)
        : TqHeapObject(address)
    {
    }
    std::vector<std::unique_ptr<ObjectProperty>> GetProperties(d::MemoryAccessor accessor) const override;
...
public:
    inline TqWasmIndirectFunctionTable(uintptr_t address)
        : TqStruct(address)
    {
    }
    std::vector<std::unique_ptr<ObjectProperty>> GetProperties(d::MemoryAccessor accessor) const override;
...
public:
    ...
    virtual void VisitHeapObject(const TqHeapObject* object) { VisitObject(object); }
    virtual void VisitContext(const TqContext* object) { VisitHeapObject(object); }
    virtual void VisitJSReceiver(const TqJSReceiver* object) { VisitHeapObject(object); }
    virtual void VisitPrimitiveHeapObject(const TqPrimitiveHeapObject* object) { VisitHeapObject(object); }
    virtual void VisitOddball(const TqOddball* object) { VisitPrimitiveHeapObject(object); }
    virtual void VisitName(const TqName* object) { VisitPrimitiveHeapObject(object); }
    virtual void VisitSymbol(const TqSymbol* object) { VisitName(object); }
    virtual void VisitString(const TqString* object) { VisitName(object); }
    virtual void VisitHeapNumber(const TqHeapNumber* object) { VisitPrimitiveHeapObject(object); }
    virtual void VisitFixedArrayBase(const TqFixedArrayBase* object) { VisitHeapObject(object); }
    virtual void VisitFixedArray(const TqFixedArray* object) { VisitFixedArrayBase(object); }
    virtual void VisitJSObject(const TqJSObject* object) { VisitJSReceiver(object); }
    virtual void VisitWeakFixedArray(const TqWeakFixedArray* object) { VisitHeapObject(object); }
    virtual void VisitForeign(const TqForeign* object) { VisitHeapObject(object); }
    virtual void VisitJSProxy(const TqJSProxy* object) { VisitJSReceiver(object); }
    virtual void VisitJSFunctionOrBoundFunctionOrWrappedFunction(const TqJSFunctionOrBoundFunctionOrWrappedFunction* object) { VisitJSObject(object); }
    virtual void VisitJSWrappedFunction(const TqJSWrappedFunction* object) { VisitJSFunctionOrBoundFunctionOrWrappedFunction(object); }
    virtual void VisitJSBoundFunction(const TqJSBoundFunction* object) { VisitJSFunctionOrBoundFunctionOrWrappedFunction(object); }
    virtual void VisitJSFunction(const TqJSFunction* object) { VisitJSFunctionOrBoundFunctionOrWrappedFunction(object); }
    virtual void VisitJSObjectWithEmbedderSlots(const TqJSObjectWithEmbedderSlots* object) { VisitJSObject(object); }
    virtual void VisitJSCustomElementsObject(const TqJSCustomElementsObject* object) { VisitJSObject(object); }
    virtual void VisitJSSpecialObject(const TqJSSpecialObject* object) { VisitJSCustomElementsObject(object); }
    virtual void VisitWasmInternalFunction(const TqWasmInternalFunction* object) { VisitHeapObject(object); }
    virtual void VisitWeakCell(const TqWeakCell* object) { VisitHeapObject(object); }
    virtual void VisitMap(const TqMap* object) { VisitHeapObject(object); }
    virtual void VisitJSPromise(const TqJSPromise* object) { VisitJSObjectWithEmbedderSlots(object); }
    virtual void VisitStruct(const TqStruct* object) { VisitHeapObject(object); }
    virtual void VisitPromiseCapability(const TqPromiseCapability* object) { VisitStruct(object); }
    virtual void VisitJSArrayBufferView(const TqJSArrayBufferView* object) { VisitJSObjectWithEmbedderSlots(object); }
    virtual void VisitJSTypedArray(const TqJSTypedArray* object) { VisitJSArrayBufferView(object); }
    virtual void VisitDataHandler(const TqDataHandler* object) { VisitStruct(object); }
    virtual void VisitAllocationMemento(const TqAllocationMemento* object) { VisitStruct(object); }
    virtual void VisitCallHandlerInfo(const TqCallHandlerInfo* object) { VisitHeapObject(object); }
    virtual void VisitInterceptorInfo(const TqInterceptorInfo* object) { VisitStruct(object); }
    virtual void VisitAccessCheckInfo(const TqAccessCheckInfo* object) { VisitStruct(object); }
    virtual void VisitAccessorInfo(const TqAccessorInfo* object) { VisitHeapObject(object); }
    virtual void VisitJSArgumentsObject(const TqJSArgumentsObject* object) { VisitJSObject(object); }
    virtual void VisitJSStrictArgumentsObject(const TqJSStrictArgumentsObject* object) { VisitJSArgumentsObject(object); }
    virtual void VisitJSSloppyArgumentsObject(const TqJSSloppyArgumentsObject* object) { VisitJSArgumentsObject(object); }
    virtual void VisitSloppyArgumentsElements(const TqSloppyArgumentsElements* object) { VisitFixedArrayBase(object); }
    virtual void VisitAliasedArgumentsEntry(const TqAliasedArgumentsEntry* object) { VisitStruct(object); }
    virtual void VisitCallSiteInfo(const TqCallSiteInfo* object) { VisitStruct(object); }
    virtual void VisitCell(const TqCell* object) { VisitHeapObject(object); }
    virtual void VisitBytecodeArray(const TqBytecodeArray* object) { VisitFixedArrayBase(object); }
    virtual void VisitScopeInfo(const TqScopeInfo* object) { VisitHeapObject(object); }
    virtual void VisitFixedDoubleArray(const TqFixedDoubleArray* object) { VisitFixedArrayBase(object); }
    virtual void VisitRegExpMatchInfo(const TqRegExpMatchInfo* object) { VisitFixedArray(object); }
    virtual void VisitBreakPoint(const TqBreakPoint* object) { VisitStruct(object); }
    virtual void VisitBreakPointInfo(const TqBreakPointInfo* object) { VisitStruct(object); }
    virtual void VisitDebugInfo(const TqDebugInfo* object) { VisitStruct(object); }
    virtual void VisitCoverageInfo(const TqCoverageInfo* object) { VisitHeapObject(object); }
    virtual void VisitStackFrameInfo(const TqStackFrameInfo* object) { VisitStruct(object); }
    virtual void VisitErrorStackData(const TqErrorStackData* object) { VisitStruct(object); }
    virtual void VisitPromiseOnStack(const TqPromiseOnStack* object) { VisitStruct(object); }
    virtual void VisitEnumCache(const TqEnumCache* object) { VisitStruct(object); }
    virtual void VisitClassPositions(const TqClassPositions* object) { VisitStruct(object); }
    virtual void VisitAccessorPair(const TqAccessorPair* object) { VisitStruct(object); }
    virtual void VisitDescriptorArray(const TqDescriptorArray* object) { VisitHeapObject(object); }
    virtual void VisitStrongDescriptorArray(const TqStrongDescriptorArray* object) { VisitDescriptorArray(object); }
    virtual void VisitEmbedderDataArray(const TqEmbedderDataArray* object) { VisitHeapObject(object); }
    virtual void VisitFeedbackCell(const TqFeedbackCell* object) { VisitStruct(object); }
    virtual void VisitFeedbackVector(const TqFeedbackVector* object) { VisitHeapObject(object); }
    virtual void VisitByteArray(const TqByteArray* object) { VisitFixedArrayBase(object); }
    virtual void VisitArrayList(const TqArrayList* object) { VisitFixedArray(object); }
    virtual void VisitTemplateList(const TqTemplateList* object) { VisitFixedArray(object); }
    virtual void VisitWeakArrayList(const TqWeakArrayList* object) { VisitHeapObject(object); }
    virtual void VisitFreeSpace(const TqFreeSpace* object) { VisitHeapObject(object); }
    virtual void VisitJSArrayBuffer(const TqJSArrayBuffer* object) { VisitJSObjectWithEmbedderSlots(object); }
    virtual void VisitJSDataView(const TqJSDataView* object) { VisitJSArrayBufferView(object); }
    virtual void VisitJSArrayIterator(const TqJSArrayIterator* object) { VisitJSObject(object); }
    virtual void VisitJSArray(const TqJSArray* object) { VisitJSObject(object); }
    virtual void VisitJSSynchronizationPrimitive(const TqJSSynchronizationPrimitive* object) { VisitJSObject(object); }
    virtual void VisitJSAtomicsMutex(const TqJSAtomicsMutex* object) { VisitJSSynchronizationPrimitive(object); }
    virtual void VisitJSAtomicsCondition(const TqJSAtomicsCondition* object) { VisitJSSynchronizationPrimitive(object); }
    virtual void VisitJSCollectionIterator(const TqJSCollectionIterator* object) { VisitJSObject(object); }
    virtual void VisitJSCollection(const TqJSCollection* object) { VisitJSObject(object); }
    virtual void VisitJSSet(const TqJSSet* object) { VisitJSCollection(object); }
    virtual void VisitJSMap(const TqJSMap* object) { VisitJSCollection(object); }
    virtual void VisitJSWeakCollection(const TqJSWeakCollection* object) { VisitJSObject(object); }
    virtual void VisitJSWeakSet(const TqJSWeakSet* object) { VisitJSWeakCollection(object); }
    virtual void VisitJSWeakMap(const TqJSWeakMap* object) { VisitJSWeakCollection(object); }
    virtual void VisitJSGeneratorObject(const TqJSGeneratorObject* object) { VisitJSObject(object); }
    virtual void VisitJSAsyncFunctionObject(const TqJSAsyncFunctionObject* object) { VisitJSGeneratorObject(object); }
    virtual void VisitJSAsyncGeneratorObject(const TqJSAsyncGeneratorObject* object) { VisitJSGeneratorObject(object); }
    virtual void VisitAsyncGeneratorRequest(const TqAsyncGeneratorRequest* object) { VisitStruct(object); }
    virtual void VisitJSExternalObject(const TqJSExternalObject* object) { VisitJSObject(object); }
    virtual void VisitJSGlobalProxy(const TqJSGlobalProxy* object) { VisitJSSpecialObject(object); }
    virtual void VisitJSGlobalObject(const TqJSGlobalObject* object) { VisitJSSpecialObject(object); }
    virtual void VisitJSPrimitiveWrapper(const TqJSPrimitiveWrapper* object) { VisitJSCustomElementsObject(object); }
    virtual void VisitJSMessageObject(const TqJSMessageObject* object) { VisitJSObject(object); }
    virtual void VisitJSDate(const TqJSDate* object) { VisitJSObject(object); }
    virtual void VisitJSAsyncFromSyncIterator(const TqJSAsyncFromSyncIterator* object) { VisitJSObject(object); }
    virtual void VisitJSStringIterator(const TqJSStringIterator* object) { VisitJSObject(object); }
    virtual void VisitJSProxyRevocableResult(const TqJSProxyRevocableResult* object) { VisitJSObject(object); }
    virtual void VisitJSRawJson(const TqJSRawJson* object) { VisitJSObject(object); }
    virtual void VisitJSRegExpStringIterator(const TqJSRegExpStringIterator* object) { VisitJSObject(object); }
    virtual void VisitJSRegExp(const TqJSRegExp* object) { VisitJSObject(object); }
    virtual void VisitJSRegExpResult(const TqJSRegExpResult* object) { VisitJSArray(object); }
    virtual void VisitJSRegExpResultWithIndices(const TqJSRegExpResultWithIndices* object) { VisitJSRegExpResult(object); }
    virtual void VisitJSRegExpResultIndices(const TqJSRegExpResultIndices* object) { VisitJSArray(object); }
    virtual void VisitJSShadowRealm(const TqJSShadowRealm* object) { VisitJSObject(object); }
    virtual void VisitJSSharedArray(const TqJSSharedArray* object) { VisitJSObject(object); }
    virtual void VisitJSSharedStruct(const TqJSSharedStruct* object) { VisitJSObject(object); }
    virtual void VisitJSTemporalCalendar(const TqJSTemporalCalendar* object) { VisitJSObject(object); }
    virtual void VisitJSTemporalDuration(const TqJSTemporalDuration* object) { VisitJSObject(object); }
    virtual void VisitJSTemporalInstant(const TqJSTemporalInstant* object) { VisitJSObject(object); }
    virtual void VisitJSTemporalPlainDateTime(const TqJSTemporalPlainDateTime* object) { VisitJSObject(object); }
    virtual void VisitJSTemporalPlainDate(const TqJSTemporalPlainDate* object) { VisitJSObject(object); }
    virtual void VisitJSTemporalPlainMonthDay(const TqJSTemporalPlainMonthDay* object) { VisitJSObject(object); }
    virtual void VisitJSTemporalPlainTime(const TqJSTemporalPlainTime* object) { VisitJSObject(object); }
    virtual void VisitJSTemporalPlainYearMonth(const TqJSTemporalPlainYearMonth* object) { VisitJSObject(object); }
    virtual void VisitJSTemporalTimeZone(const TqJSTemporalTimeZone* object) { VisitJSObject(object); }
    virtual void VisitJSTemporalZonedDateTime(const TqJSTemporalZonedDateTime* object) { VisitJSObject(object); }
    virtual void VisitJSFinalizationRegistry(const TqJSFinalizationRegistry* object) { VisitJSObject(object); }
    virtual void VisitJSWeakRef(const TqJSWeakRef* object) { VisitJSObject(object); }
    virtual void VisitArrayBoilerplateDescription(const TqArrayBoilerplateDescription* object) { VisitStruct(object); }
    virtual void VisitRegExpBoilerplateDescription(const TqRegExpBoilerplateDescription* object) { VisitStruct(object); }
    virtual void VisitMegaDomHandler(const TqMegaDomHandler* object) { VisitHeapObject(object); }
    virtual void VisitMicrotask(const TqMicrotask* object) { VisitStruct(object); }
    virtual void VisitCallbackTask(const TqCallbackTask* object) { VisitMicrotask(object); }
    virtual void VisitCallableTask(const TqCallableTask* object) { VisitMicrotask(object); }
    virtual void VisitModule(const TqModule* object) { VisitHeapObject(object); }
    virtual void VisitJSModuleNamespace(const TqJSModuleNamespace* object) { VisitJSSpecialObject(object); }
    virtual void VisitScriptOrModule(const TqScriptOrModule* object) { VisitStruct(object); }
    virtual void VisitSmallOrderedHashTable(const TqSmallOrderedHashTable* object) { VisitHeapObject(object); }
    virtual void VisitSmallOrderedHashSet(const TqSmallOrderedHashSet* object) { VisitSmallOrderedHashTable(object); }
    virtual void VisitSmallOrderedHashMap(const TqSmallOrderedHashMap* object) { VisitSmallOrderedHashTable(object); }
    virtual void VisitSmallOrderedNameDictionary(const TqSmallOrderedNameDictionary* object) { VisitSmallOrderedHashTable(object); }
    virtual void VisitPromiseReaction(const TqPromiseReaction* object) { VisitStruct(object); }
    virtual void VisitPromiseReactionJobTask(const TqPromiseReactionJobTask* object) { VisitMicrotask(object); }
    virtual void VisitPromiseFulfillReactionJobTask(const TqPromiseFulfillReactionJobTask* object) { VisitPromiseReactionJobTask(object); }
    virtual void VisitPromiseRejectReactionJobTask(const TqPromiseRejectReactionJobTask* object) { VisitPromiseReactionJobTask(object); }
    virtual void VisitPromiseResolveThenableJobTask(const TqPromiseResolveThenableJobTask* object) { VisitMicrotask(object); }
    virtual void VisitPropertyArray(const TqPropertyArray* object) { VisitHeapObject(object); }
    virtual void VisitPropertyCell(const TqPropertyCell* object) { VisitHeapObject(object); }
    virtual void VisitPropertyDescriptorObject(const TqPropertyDescriptorObject* object) { VisitStruct(object); }
    virtual void VisitPrototypeInfo(const TqPrototypeInfo* object) { VisitStruct(object); }
    virtual void VisitScript(const TqScript* object) { VisitStruct(object); }
    virtual void VisitPreparseData(const TqPreparseData* object) { VisitHeapObject(object); }
    virtual void VisitInterpreterData(const TqInterpreterData* object) { VisitStruct(object); }
    virtual void VisitSharedFunctionInfo(const TqSharedFunctionInfo* object) { VisitHeapObject(object); }
    virtual void VisitUncompiledData(const TqUncompiledData* object) { VisitHeapObject(object); }
    virtual void VisitUncompiledDataWithoutPreparseData(const TqUncompiledDataWithoutPreparseData* object) { VisitUncompiledData(object); }
    virtual void VisitUncompiledDataWithPreparseData(const TqUncompiledDataWithPreparseData* object) { VisitUncompiledData(object); }
    virtual void VisitUncompiledDataWithoutPreparseDataWithJob(const TqUncompiledDataWithoutPreparseDataWithJob* object) { VisitUncompiledDataWithoutPreparseData(object); }
    virtual void VisitUncompiledDataWithPreparseDataAndJob(const TqUncompiledDataWithPreparseDataAndJob* object) { VisitUncompiledDataWithPreparseData(object); }
    virtual void VisitOnHeapBasicBlockProfilerData(const TqOnHeapBasicBlockProfilerData* object) { VisitHeapObject(object); }
    virtual void VisitSourceTextModule(const TqSourceTextModule* object) { VisitModule(object); }
    virtual void VisitModuleRequest(const TqModuleRequest* object) { VisitStruct(object); }
    virtual void VisitSourceTextModuleInfoEntry(const TqSourceTextModuleInfoEntry* object) { VisitStruct(object); }
    virtual void VisitConsString(const TqConsString* object) { VisitString(object); }
    virtual void VisitExternalString(const TqExternalString* object) { VisitString(object); }
    virtual void VisitExternalOneByteString(const TqExternalOneByteString* object) { VisitExternalString(object); }
    virtual void VisitExternalTwoByteString(const TqExternalTwoByteString* object) { VisitExternalString(object); }
    virtual void VisitInternalizedString(const TqInternalizedString* object) { VisitString(object); }
    virtual void VisitSeqString(const TqSeqString* object) { VisitString(object); }
    virtual void VisitSeqOneByteString(const TqSeqOneByteString* object) { VisitSeqString(object); }
    virtual void VisitSeqTwoByteString(const TqSeqTwoByteString* object) { VisitSeqString(object); }
    virtual void VisitSlicedString(const TqSlicedString* object) { VisitString(object); }
    virtual void VisitThinString(const TqThinString* object) { VisitString(object); }
    virtual void VisitTuple2(const TqTuple2* object) { VisitStruct(object); }
    virtual void VisitSwissNameDictionary(const TqSwissNameDictionary* object) { VisitHeapObject(object); }
    virtual void VisitSyntheticModule(const TqSyntheticModule* object) { VisitModule(object); }
    virtual void VisitCachedTemplateObject(const TqCachedTemplateObject* object) { VisitStruct(object); }
    virtual void VisitTemplateObjectDescription(const TqTemplateObjectDescription* object) { VisitStruct(object); }
    virtual void VisitTemplateInfo(const TqTemplateInfo* object) { VisitStruct(object); }
    virtual void VisitFunctionTemplateRareData(const TqFunctionTemplateRareData* object) { VisitStruct(object); }
    virtual void VisitFunctionTemplateInfo(const TqFunctionTemplateInfo* object) { VisitTemplateInfo(object); }
    virtual void VisitObjectTemplateInfo(const TqObjectTemplateInfo* object) { VisitTemplateInfo(object); }
    virtual void VisitTurbofanType(const TqTurbofanType* object) { VisitHeapObject(object); }
    virtual void VisitTurbofanBitsetType(const TqTurbofanBitsetType* object) { VisitTurbofanType(object); }
    virtual void VisitTurbofanUnionType(const TqTurbofanUnionType* object) { VisitTurbofanType(object); }
    virtual void VisitTurbofanRangeType(const TqTurbofanRangeType* object) { VisitTurbofanType(object); }
    virtual void VisitTurbofanHeapConstantType(const TqTurbofanHeapConstantType* object) { VisitTurbofanType(object); }
    virtual void VisitTurbofanOtherNumberConstantType(const TqTurbofanOtherNumberConstantType* object) { VisitTurbofanType(object); }
    virtual void VisitInternalClass(const TqInternalClass* object) { VisitHeapObject(object); }
    virtual void VisitSmiPair(const TqSmiPair* object) { VisitHeapObject(object); }
    virtual void VisitSmiBox(const TqSmiBox* object) { VisitHeapObject(object); }
    virtual void VisitExportedSubClassBase(const TqExportedSubClassBase* object) { VisitHeapObject(object); }
    virtual void VisitExportedSubClass(const TqExportedSubClass* object) { VisitExportedSubClassBase(object); }
    virtual void VisitAbstractInternalClass(const TqAbstractInternalClass* object) { VisitHeapObject(object); }
    virtual void VisitAbstractInternalClassSubclass1(const TqAbstractInternalClassSubclass1* object) { VisitAbstractInternalClass(object); }
    virtual void VisitAbstractInternalClassSubclass2(const TqAbstractInternalClassSubclass2* object) { VisitAbstractInternalClass(object); }
    virtual void VisitInternalClassWithSmiElements(const TqInternalClassWithSmiElements* object) { VisitFixedArrayBase(object); }
    virtual void VisitInternalClassWithStructElements(const TqInternalClassWithStructElements* object) { VisitHeapObject(object); }
    virtual void VisitExportedSubClass2(const TqExportedSubClass2* object) { VisitExportedSubClassBase(object); }
    virtual void VisitSortState(const TqSortState* object) { VisitHeapObject(object); }
    virtual void VisitJSV8BreakIterator(const TqJSV8BreakIterator* object) { VisitJSObject(object); }
    virtual void VisitJSCollator(const TqJSCollator* object) { VisitJSObject(object); }
    virtual void VisitJSDateTimeFormat(const TqJSDateTimeFormat* object) { VisitJSObject(object); }
    virtual void VisitJSDisplayNames(const TqJSDisplayNames* object) { VisitJSObject(object); }
    virtual void VisitJSDurationFormat(const TqJSDurationFormat* object) { VisitJSObject(object); }
    virtual void VisitJSListFormat(const TqJSListFormat* object) { VisitJSObject(object); }
    virtual void VisitJSLocale(const TqJSLocale* object) { VisitJSObject(object); }
    virtual void VisitJSNumberFormat(const TqJSNumberFormat* object) { VisitJSObject(object); }
    virtual void VisitJSPluralRules(const TqJSPluralRules* object) { VisitJSObject(object); }
    virtual void VisitJSRelativeTimeFormat(const TqJSRelativeTimeFormat* object) { VisitJSObject(object); }
    virtual void VisitJSSegmentIterator(const TqJSSegmentIterator* object) { VisitJSObject(object); }
    virtual void VisitJSSegmenter(const TqJSSegmenter* object) { VisitJSObject(object); }
    virtual void VisitJSSegments(const TqJSSegments* object) { VisitJSObject(object); }
    virtual void VisitWasmApiFunctionRef(const TqWasmApiFunctionRef* object) { VisitHeapObject(object); }
    virtual void VisitWasmFunctionData(const TqWasmFunctionData* object) { VisitHeapObject(object); }
    virtual void VisitWasmExportedFunctionData(const TqWasmExportedFunctionData* object) { VisitWasmFunctionData(object); }
    virtual void VisitWasmJSFunctionData(const TqWasmJSFunctionData* object) { VisitWasmFunctionData(object); }
    virtual void VisitWasmCapiFunctionData(const TqWasmCapiFunctionData* object) { VisitWasmFunctionData(object); }
    virtual void VisitWasmResumeData(const TqWasmResumeData* object) { VisitHeapObject(object); }
    virtual void VisitWasmIndirectFunctionTable(const TqWasmIndirectFunctionTable* object) { VisitStruct(object); }
    virtual void VisitWasmContinuationObject(const TqWasmContinuationObject* object) { VisitHeapObject(object); }
    virtual void VisitWasmSuspenderObject(const TqWasmSuspenderObject* object) { VisitJSObject(object); }
    virtual void VisitWasmExceptionTag(const TqWasmExceptionTag* object) { VisitStruct(object); }
    virtual void VisitWasmModuleObject(const TqWasmModuleObject* object) { VisitJSObject(object); }
    virtual void VisitWasmTableObject(const TqWasmTableObject* object) { VisitJSObject(object); }
    virtual void VisitWasmMemoryObject(const TqWasmMemoryObject* object) { VisitJSObject(object); }
    virtual void VisitWasmGlobalObject(const TqWasmGlobalObject* object) { VisitJSObject(object); }
    virtual void VisitWasmTagObject(const TqWasmTagObject* object) { VisitJSObject(object); }
    virtual void VisitAsmWasmData(const TqAsmWasmData* object) { VisitStruct(object); }
    virtual void VisitWasmTypeInfo(const TqWasmTypeInfo* object) { VisitHeapObject(object); }
    virtual void VisitWasmObject(const TqWasmObject* object) { VisitJSReceiver(object); }
    virtual void VisitWasmStruct(const TqWasmStruct* object) { VisitWasmObject(object); }
    virtual void VisitWasmArray(const TqWasmArray* object) { VisitWasmObject(object); }
    virtual void VisitWasmStringViewIter(const TqWasmStringViewIter* object) { VisitHeapObject(object); }
};
} // namespace debug_helper_internal
} // namespace internal
} // namespace v8
