...
V8_CRDTP_DESERIALIZE_FIELD_OPT("columnNumber", m_columnNumber), V8_CRDTP_DESERIALIZE_FIELD("lineNumber", m_lineNumber), V8_CRDTP_DESERIALIZE_FIELD("scriptId", m_scriptId),
...
V8_CRDTP_DESERIALIZE_FIELD("callFrameId", m_callFrameId), V8_CRDTP_DESERIALIZE_FIELD_OPT("canBeRestarted", m_canBeRestarted),
    ...
    V8_CRDTP_DESERIALIZE_FIELD("location", m_location), V8_CRDTP_DESERIALIZE_FIELD_OPT("returnValue", m_returnValue), V8_CRDTP_DESERIALIZE_FIELD("scopeChain", m_scopeChain),
    V8_CRDTP_DESERIALIZE_FIELD("this", m_this), V8_CRDTP_DESERIALIZE_FIELD("url", m_url),
    V8_CRDTP_END_DESERIALIZER()
...
// static
std::unique_ptr<API::SearchMatch> API::SearchMatch::fromBinary(const uint8_t* data, size_t length) { return protocol::Debugger::SearchMatch::FromBinary(data, length); }
...
void Frontend::paused(std::unique_ptr<protocol::Array<protocol::Debugger::CallFrame>> callFrames, const String& reason, Maybe<protocol::DictionaryValue> data,
    Maybe<protocol::Array<String>> hitBreakpoints, Maybe<protocol::Runtime::StackTrace> asyncStackTrace, Maybe<protocol::Runtime::StackTraceId> asyncStackTraceId,
    Maybe<protocol::Runtime::StackTraceId> asyncCallStackTraceId)
{
    if (!frontend_channel_)
        return;
    v8_crdtp::ObjectSerializer serializer;
...
void Frontend::scriptFailedToParse(const String& scriptId, const String& url, int startLine, int startColumn, int endLine, int endColumn, int executionContextId,
    const String& hash, Maybe<protocol::DictionaryValue> executionContextAuxData, Maybe<String> sourceMapURL, Maybe<bool> hasSourceURL, Maybe<bool> isModule, Maybe<int> length,
    Maybe<protocol::Runtime::StackTrace> stackTrace, Maybe<int> codeOffset, Maybe<String> scriptLanguage, Maybe<String> embedderName)
{
    if (!frontend_channel_)
        return;
    v8_crdtp::ObjectSerializer serializer;
...
void Frontend::scriptParsed(const String& scriptId, const String& url, int startLine, int startColumn, int endLine, int endColumn, int executionContextId, const String& hash,
    Maybe<protocol::DictionaryValue> executionContextAuxData, Maybe<bool> isLiveEdit, Maybe<String> sourceMapURL, Maybe<bool> hasSourceURL, Maybe<bool> isModule, Maybe<int> length,
    Maybe<protocol::Runtime::StackTrace> stackTrace, Maybe<int> codeOffset, Maybe<String> scriptLanguage, Maybe<protocol::Debugger::DebugSymbols> debugSymbols,
...
V8_CRDTP_DESERIALIZE_FIELD("callFrameId", callFrameId), V8_CRDTP_DESERIALIZE_FIELD("expression", expression), V8_CRDTP_DESERIALIZE_FIELD_OPT("generatePreview", generatePreview),
    ...
    V8_CRDTP_DESERIALIZE_FIELD_OPT("throwOnSideEffect", throwOnSideEffect), V8_CRDTP_DESERIALIZE_FIELD_OPT("timeout", timeout), V8_CRDTP_END_DESERIALIZER()
...
void DomainDispatcherImpl::evaluateOnCallFrame(const v8_crdtp::Dispatchable& dispatchable)
{
    ...
    DispatchResponse response
        = m_backend->evaluateOnCallFrame(params.callFrameId, params.expression, std::move(params.objectGroup), std::move(params.includeCommandLineAPI), std::move(params.silent),
            std::move(params.returnByValue), std::move(params.generatePreview), std::move(params.throwOnSideEffect), std::move(params.timeout), &out_result, &out_exceptionDetails);
    if (response.IsFallThrough()) {
...
V8_CRDTP_DESERIALIZE_FIELD_OPT("end", end), V8_CRDTP_DESERIALIZE_FIELD_OPT("restrictToFunction", restrictToFunction), V8_CRDTP_DESERIALIZE_FIELD("start", start),
    V8_CRDTP_END_DESERIALIZER()
...
V8_CRDTP_DESERIALIZE_FIELD("patterns", patterns), V8_CRDTP_END_DESERIALIZER()
...
V8_CRDTP_DESERIALIZE_FIELD_OPT("columnNumber", columnNumber), V8_CRDTP_DESERIALIZE_FIELD_OPT("condition", condition), V8_CRDTP_DESERIALIZE_FIELD("lineNumber", lineNumber),
    V8_CRDTP_DESERIALIZE_FIELD_OPT("scriptHash", scriptHash), V8_CRDTP_DESERIALIZE_FIELD_OPT("url", url), V8_CRDTP_DESERIALIZE_FIELD_OPT("urlRegex", urlRegex),
    V8_CRDTP_END_DESERIALIZER()
...
void DomainDispatcherImpl::setBreakpointByUrl(const v8_crdtp::Dispatchable& dispatchable)
{
    ...
    std::unique_ptr<DomainDispatcher::WeakPtr> weak = weakPtr();
    DispatchResponse response = m_backend->setBreakpointByUrl(params.lineNumber, std::move(params.url), std::move(params.urlRegex), std::move(params.scriptHash),
        std::move(params.columnNumber), std::move(params.condition), &out_breakpointId, &out_locations);
    if (response.IsFallThrough()) {
...
V8_CRDTP_DESERIALIZE_FIELD_OPT("allowTopFrameEditing", allowTopFrameEditing), V8_CRDTP_DESERIALIZE_FIELD_OPT("dryRun", dryRun), V8_CRDTP_DESERIALIZE_FIELD("scriptId", scriptId),
    V8_CRDTP_DESERIALIZE_FIELD("scriptSource", scriptSource), V8_CRDTP_END_DESERIALIZER()
...
void DomainDispatcherImpl::setScriptSource(const v8_crdtp::Dispatchable& dispatchable)
{
    ...
    std::unique_ptr<DomainDispatcher::WeakPtr> weak = weakPtr();
    DispatchResponse response = m_backend->setScriptSource(params.scriptId, params.scriptSource, std::move(params.dryRun), std::move(params.allowTopFrameEditing), &out_callFrames,
...
V8_CRDTP_DESERIALIZE_FIELD("callFrameId", callFrameId), V8_CRDTP_DESERIALIZE_FIELD("newValue", newValue), V8_CRDTP_DESERIALIZE_FIELD("scopeNumber", scopeNumber),
    V8_CRDTP_DESERIALIZE_FIELD("variableName", variableName), V8_CRDTP_END_DESERIALIZER()
