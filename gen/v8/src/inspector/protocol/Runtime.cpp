...
V8_CRDTP_DESERIALIZE_FIELD_OPT("objectId", m_objectId), V8_CRDTP_DESERIALIZE_FIELD("type", m_type), V8_CRDTP_DESERIALIZE_FIELD_OPT("value", m_value),
    V8_CRDTP_END_DESERIALIZER()
        ...
        V8_CRDTP_BEGIN_SERIALIZER(WebDriverValue) V8_CRDTP_SERIALIZE_FIELD("type", m_type);
...
V8_CRDTP_DESERIALIZE_FIELD_OPT("className", m_className), V8_CRDTP_DESERIALIZE_FIELD_OPT("customPreview", m_customPreview),
    V8_CRDTP_DESERIALIZE_FIELD_OPT("description", m_description), V8_CRDTP_DESERIALIZE_FIELD_OPT("objectId", m_objectId), V8_CRDTP_DESERIALIZE_FIELD_OPT("preview", m_preview),
    V8_CRDTP_DESERIALIZE_FIELD_OPT("subtype", m_subtype), V8_CRDTP_DESERIALIZE_FIELD("type", m_type), V8_CRDTP_DESERIALIZE_FIELD_OPT("unserializableValue", m_unserializableValue),
    V8_CRDTP_DESERIALIZE_FIELD_OPT("value", m_value), V8_CRDTP_DESERIALIZE_FIELD_OPT("webDriverValue", m_webDriverValue),
    V8_CRDTP_END_DESERIALIZER()
...
// static
std::unique_ptr<API::RemoteObject> API::RemoteObject::fromBinary(const uint8_t* data, size_t length) { return protocol::Runtime::RemoteObject::FromBinary(data, length); }
...
V8_CRDTP_DESERIALIZE_FIELD_OPT("description", m_description), V8_CRDTP_DESERIALIZE_FIELD_OPT("entries", m_entries), V8_CRDTP_DESERIALIZE_FIELD("overflow", m_overflow),
    V8_CRDTP_DESERIALIZE_FIELD("properties", m_properties), V8_CRDTP_DESERIALIZE_FIELD_OPT("subtype", m_subtype), V8_CRDTP_DESERIALIZE_FIELD("type", m_type),
    V8_CRDTP_END_DESERIALIZER()
...
V8_CRDTP_DESERIALIZE_FIELD("configurable", m_configurable), V8_CRDTP_DESERIALIZE_FIELD("enumerable", m_enumerable), V8_CRDTP_DESERIALIZE_FIELD_OPT("get", m_get),
    V8_CRDTP_DESERIALIZE_FIELD_OPT("isOwn", m_isOwn), V8_CRDTP_DESERIALIZE_FIELD("name", m_name), V8_CRDTP_DESERIALIZE_FIELD_OPT("set", m_set),
    V8_CRDTP_DESERIALIZE_FIELD_OPT("symbol", m_symbol), V8_CRDTP_DESERIALIZE_FIELD_OPT("value", m_value), V8_CRDTP_DESERIALIZE_FIELD_OPT("wasThrown", m_wasThrown),
...
V8_CRDTP_DESERIALIZE_FIELD("columnNumber", m_columnNumber), V8_CRDTP_DESERIALIZE_FIELD_OPT("exception", m_exception), V8_CRDTP_DESERIALIZE_FIELD("exceptionId", m_exceptionId),
    V8_CRDTP_DESERIALIZE_FIELD_OPT("exceptionMetaData", m_exceptionMetaData), V8_CRDTP_DESERIALIZE_FIELD_OPT("executionContextId", m_executionContextId),
    V8_CRDTP_DESERIALIZE_FIELD("lineNumber", m_lineNumber), V8_CRDTP_DESERIALIZE_FIELD_OPT("scriptId", m_scriptId), V8_CRDTP_DESERIALIZE_FIELD_OPT("stackTrace", m_stackTrace),
...
V8_CRDTP_DESERIALIZE_FIELD("columnNumber", m_columnNumber), V8_CRDTP_DESERIALIZE_FIELD("functionName", m_functionName), V8_CRDTP_DESERIALIZE_FIELD("lineNumber", m_lineNumber),
    V8_CRDTP_DESERIALIZE_FIELD("scriptId", m_scriptId), V8_CRDTP_DESERIALIZE_FIELD("url", m_url),
    V8_CRDTP_END_DESERIALIZER()
...
V8_CRDTP_DESERIALIZE_FIELD("callFrames", m_callFrames), V8_CRDTP_DESERIALIZE_FIELD_OPT("description", m_description), V8_CRDTP_DESERIALIZE_FIELD_OPT("parent", m_parent),
...
// static
std::unique_ptr<API::StackTrace> API::StackTrace::fromBinary(const uint8_t* data, size_t length) { return protocol::Runtime::StackTrace::FromBinary(data, length); }
...
// static
std::unique_ptr<API::StackTraceId> API::StackTraceId::fromBinary(const uint8_t* data, size_t length) { return protocol::Runtime::StackTraceId::FromBinary(data, length); }
...
void Frontend::consoleAPICalled(const String& type, std::unique_ptr<protocol::Array<protocol::Runtime::RemoteObject>> args, int executionContextId, double timestamp,
    Maybe<protocol::Runtime::StackTrace> stackTrace, Maybe<String> context)
{
    if (!frontend_channel_)
        return;
    v8_crdtp::ObjectSerializer serializer;
...
V8_CRDTP_DESERIALIZE_FIELD_OPT("arguments", arguments), V8_CRDTP_DESERIALIZE_FIELD_OPT("awaitPromise", awaitPromise),
    ...
    V8_CRDTP_DESERIALIZE_FIELD_OPT("generatePreview", generatePreview), V8_CRDTP_DESERIALIZE_FIELD_OPT("generateWebDriverValue", generateWebDriverValue),
    V8_CRDTP_DESERIALIZE_FIELD_OPT("objectGroup", objectGroup), V8_CRDTP_DESERIALIZE_FIELD_OPT("objectId", objectId),
    V8_CRDTP_DESERIALIZE_FIELD_OPT("returnByValue", returnByValue), V8_CRDTP_DESERIALIZE_FIELD_OPT("silent", silent),
    V8_CRDTP_DESERIALIZE_FIELD_OPT("throwOnSideEffect", throwOnSideEffect), V8_CRDTP_DESERIALIZE_FIELD_OPT("userGesture", userGesture), V8_CRDTP_END_DESERIALIZER()
...
void DomainDispatcherImpl::callFunctionOn(const v8_crdtp::Dispatchable& dispatchable)
{
    ...
    m_backend->callFunctionOn(params.functionDeclaration, std::move(params.objectId), std::move(params.arguments), std::move(params.silent), std::move(params.returnByValue),
        std::move(params.generatePreview), std::move(params.userGesture), std::move(params.awaitPromise), std::move(params.executionContextId), std::move(params.objectGroup),
        std::move(params.throwOnSideEffect), std::move(params.generateWebDriverValue),
        std::make_unique<CallFunctionOnCallbackImpl>(weakPtr(), dispatchable.CallId(), dispatchable.Serialized()));
}
...
void DomainDispatcherImpl::compileScript(const v8_crdtp::Dispatchable& dispatchable)
{
    ...
    DispatchResponse response
        = m_backend->compileScript(params.expression, params.sourceURL, params.persistScript, std::move(params.executionContextId), &out_scriptId, &out_exceptionDetails);
...
V8_CRDTP_DESERIALIZE_FIELD_OPT("allowUnsafeEvalBlockedByCSP", allowUnsafeEvalBlockedByCSP), V8_CRDTP_DESERIALIZE_FIELD_OPT("awaitPromise", awaitPromise),
    V8_CRDTP_DESERIALIZE_FIELD_OPT("contextId", contextId), V8_CRDTP_DESERIALIZE_FIELD_OPT("disableBreaks", disableBreaks), V8_CRDTP_DESERIALIZE_FIELD("expression", expression),
    V8_CRDTP_DESERIALIZE_FIELD_OPT("generatePreview", generatePreview), V8_CRDTP_DESERIALIZE_FIELD_OPT("generateWebDriverValue", generateWebDriverValue),
    ...
    V8_CRDTP_DESERIALIZE_FIELD_OPT("replMode", replMode), V8_CRDTP_DESERIALIZE_FIELD_OPT("returnByValue", returnByValue), V8_CRDTP_DESERIALIZE_FIELD_OPT("silent", silent),
...
void DomainDispatcherImpl::evaluate(const v8_crdtp::Dispatchable& dispatchable)
{
    ...
    m_backend->evaluate(params.expression, std::move(params.objectGroup), std::move(params.includeCommandLineAPI), std::move(params.silent), std::move(params.contextId),
        std::move(params.returnByValue), std::move(params.generatePreview), std::move(params.userGesture), std::move(params.awaitPromise), std::move(params.throwOnSideEffect),
        std::move(params.timeout), std::move(params.disableBreaks), std::move(params.replMode), std::move(params.allowUnsafeEvalBlockedByCSP), std::move(params.uniqueContextId),
        std::move(params.generateWebDriverValue), std::make_unique<EvaluateCallbackImpl>(weakPtr(), dispatchable.CallId(), dispatchable.Serialized()));
}
...
void DomainDispatcherImpl::getProperties(const v8_crdtp::Dispatchable& dispatchable)
{
    ...
    DispatchResponse response = m_backend->getProperties(params.objectId, std::move(params.ownProperties), std::move(params.accessorPropertiesOnly),
        std::move(params.generatePreview), std::move(params.nonIndexedPropertiesOnly), &out_result, &out_internalProperties, &out_privateProperties, &out_exceptionDetails);
    if (response.IsFallThrough()) {
...
V8_CRDTP_DESERIALIZE_FIELD_OPT("awaitPromise", awaitPromise), V8_CRDTP_DESERIALIZE_FIELD_OPT("executionContextId", executionContextId),
    ...
    V8_CRDTP_DESERIALIZE_FIELD_OPT("objectGroup", objectGroup), V8_CRDTP_DESERIALIZE_FIELD_OPT("returnByValue", returnByValue), V8_CRDTP_DESERIALIZE_FIELD("scriptId", scriptId),
    V8_CRDTP_DESERIALIZE_FIELD_OPT("silent", silent), V8_CRDTP_END_DESERIALIZER()
...
void DomainDispatcherImpl::runScript(const v8_crdtp::Dispatchable& dispatchable)
{
    ...
    m_backend->runScript(params.scriptId, std::move(params.executionContextId), std::move(params.objectGroup), std::move(params.silent), std::move(params.includeCommandLineAPI),
        std::move(params.returnByValue), std::move(params.generatePreview), std::move(params.awaitPromise),
