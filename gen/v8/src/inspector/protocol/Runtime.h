...
public:
    ...
    template <int STATE> class WebDriverValueBuilder {
    public:
    ...
    private:
        ...
        WebDriverValueBuilder()
            : m_result(new WebDriverValue())
        {
        }

        template <int STEP> WebDriverValueBuilder<STATE | STEP>& castState() { return *reinterpret_cast<WebDriverValueBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::Runtime::WebDriverValue> m_result;
    };

    static WebDriverValueBuilder<0> create() { return WebDriverValueBuilder<0>(); }
...
public:
    ...
    protocol::Runtime::WebDriverValue* getWebDriverValue(protocol::Runtime::WebDriverValue* defaultValue)
    {
        return m_webDriverValue.isJust() ? m_webDriverValue.fromJust() : defaultValue;
    }
    ...
    private:
        ...
        template <int STEP> RemoteObjectBuilder<STATE | STEP>& castState() { return *reinterpret_cast<RemoteObjectBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::Runtime::RemoteObject> m_result;
    };

    static RemoteObjectBuilder<0> create() { return RemoteObjectBuilder<0>(); }
...
public:
    ...
    private:
        ...
        template <int STEP> CustomPreviewBuilder<STATE | STEP>& castState() { return *reinterpret_cast<CustomPreviewBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::Runtime::CustomPreview> m_result;
    };

    static CustomPreviewBuilder<0> create() { return CustomPreviewBuilder<0>(); }
...
public:
    ...
    private:
        ...
        template <int STEP> ObjectPreviewBuilder<STATE | STEP>& castState() { return *reinterpret_cast<ObjectPreviewBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::Runtime::ObjectPreview> m_result;
    };

    static ObjectPreviewBuilder<0> create() { return ObjectPreviewBuilder<0>(); }

private:
    DECLARE_SERIALIZATION_SUPPORT();

    ObjectPreview() { m_overflow = false; }
...
public:
    ...
    private:
        ...
        template <int STEP> PropertyPreviewBuilder<STATE | STEP>& castState() { return *reinterpret_cast<PropertyPreviewBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::Runtime::PropertyPreview> m_result;
    };

    static PropertyPreviewBuilder<0> create() { return PropertyPreviewBuilder<0>(); }
...
public:
    ...
    private:
        ...
        template <int STEP> EntryPreviewBuilder<STATE | STEP>& castState() { return *reinterpret_cast<EntryPreviewBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::Runtime::EntryPreview> m_result;
    };

    static EntryPreviewBuilder<0> create() { return EntryPreviewBuilder<0>(); }
...
public:
    ...
    public:
        enum { NoFieldsSet = 0, NameSet = 1 << 1, ConfigurableSet = 1 << 2, EnumerableSet = 1 << 3, AllFieldsSet = (NameSet | ConfigurableSet | EnumerableSet | 0) };
    ...
    private:
        ...
        template <int STEP> PropertyDescriptorBuilder<STATE | STEP>& castState() { return *reinterpret_cast<PropertyDescriptorBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::Runtime::PropertyDescriptor> m_result;
    };

    static PropertyDescriptorBuilder<0> create() { return PropertyDescriptorBuilder<0>(); }
...
public:
    ...
    private:
        ...
        template <int STEP> InternalPropertyDescriptorBuilder<STATE | STEP>& castState() { return *reinterpret_cast<InternalPropertyDescriptorBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::Runtime::InternalPropertyDescriptor> m_result;
    };

    static InternalPropertyDescriptorBuilder<0> create() { return InternalPropertyDescriptorBuilder<0>(); }
...
public:
    ...
    private:
        ...
        template <int STEP> PrivatePropertyDescriptorBuilder<STATE | STEP>& castState() { return *reinterpret_cast<PrivatePropertyDescriptorBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::Runtime::PrivatePropertyDescriptor> m_result;
    };

    static PrivatePropertyDescriptorBuilder<0> create() { return PrivatePropertyDescriptorBuilder<0>(); }
...
public:
    ...
    private:
        ...
        template <int STEP> CallArgumentBuilder<STATE | STEP>& castState() { return *reinterpret_cast<CallArgumentBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::Runtime::CallArgument> m_result;
    };

    static CallArgumentBuilder<0> create() { return CallArgumentBuilder<0>(); }
...
public:
    ...
    public:
        enum { NoFieldsSet = 0, IdSet = 1 << 1, OriginSet = 1 << 2, NameSet = 1 << 3, UniqueIdSet = 1 << 4, AllFieldsSet = (IdSet | OriginSet | NameSet | UniqueIdSet | 0) };
    ...
    private:
        ...
        template <int STEP> ExecutionContextDescriptionBuilder<STATE | STEP>& castState() { return *reinterpret_cast<ExecutionContextDescriptionBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::Runtime::ExecutionContextDescription> m_result;
    };

    static ExecutionContextDescriptionBuilder<0> create() { return ExecutionContextDescriptionBuilder<0>(); }

private:
    DECLARE_SERIALIZATION_SUPPORT();

    ExecutionContextDescription() { m_id = 0; }
...
public:
    ...
    {
        return m_exceptionMetaData.isJust() ? m_exceptionMetaData.fromJust() : defaultValue;
    }
    ...
    private:
        ...
        template <int STEP> ExceptionDetailsBuilder<STATE | STEP>& castState() { return *reinterpret_cast<ExceptionDetailsBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::Runtime::ExceptionDetails> m_result;
    };

    static ExceptionDetailsBuilder<0> create() { return ExceptionDetailsBuilder<0>(); }
...
public:
    ...
    private:
        ...
        template <int STEP> CallFrameBuilder<STATE | STEP>& castState() { return *reinterpret_cast<CallFrameBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::Runtime::CallFrame> m_result;
    };

    static CallFrameBuilder<0> create() { return CallFrameBuilder<0>(); }
...
public:
    ...
    private:
        ...
        template <int STEP> StackTraceBuilder<STATE | STEP>& castState() { return *reinterpret_cast<StackTraceBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::Runtime::StackTrace> m_result;
    };

    static StackTraceBuilder<0> create() { return StackTraceBuilder<0>(); }
...
public:
    ...
    private:
        ...
        template <int STEP> StackTraceIdBuilder<STATE | STEP>& castState() { return *reinterpret_cast<StackTraceIdBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::Runtime::StackTraceId> m_result;
    };

    static StackTraceIdBuilder<0> create() { return StackTraceIdBuilder<0>(); }
...
public:
    ...
    virtual void callFunctionOn(const String& in_functionDeclaration, Maybe<String> in_objectId, Maybe<protocol::Array<protocol::Runtime::CallArgument>> in_arguments,
        Maybe<bool> in_silent, Maybe<bool> in_returnByValue, Maybe<bool> in_generatePreview, Maybe<bool> in_userGesture, Maybe<bool> in_awaitPromise,
        Maybe<int> in_executionContextId, Maybe<String> in_objectGroup, Maybe<bool> in_throwOnSideEffect, Maybe<bool> in_generateWebDriverValue,
    ...
    virtual void evaluate(const String& in_expression, Maybe<String> in_objectGroup, Maybe<bool> in_includeCommandLineAPI, Maybe<bool> in_silent, Maybe<int> in_contextId,
        Maybe<bool> in_returnByValue, Maybe<bool> in_generatePreview, Maybe<bool> in_userGesture, Maybe<bool> in_awaitPromise, Maybe<bool> in_throwOnSideEffect,
        Maybe<double> in_timeout, Maybe<bool> in_disableBreaks, Maybe<bool> in_replMode, Maybe<bool> in_allowUnsafeEvalBlockedByCSP, Maybe<String> in_uniqueContextId,
        Maybe<bool> in_generateWebDriverValue, std::unique_ptr<EvaluateCallback> callback)
        = 0;
    ...
    virtual DispatchResponse getProperties(const String& in_objectId, Maybe<bool> in_ownProperties, Maybe<bool> in_accessorPropertiesOnly, Maybe<bool> in_generatePreview,
        Maybe<bool> in_nonIndexedPropertiesOnly, std::unique_ptr<protocol::Array<protocol::Runtime::PropertyDescriptor>>* out_result,
        Maybe<protocol::Array<protocol::Runtime::InternalPropertyDescriptor>>* out_internalProperties,
        Maybe<protocol::Array<protocol::Runtime::PrivatePropertyDescriptor>>* out_privateProperties, Maybe<protocol::Runtime::ExceptionDetails>* out_exceptionDetails)
        = 0;
    ...
    virtual void runScript(const String& in_scriptId, Maybe<int> in_executionContextId, Maybe<String> in_objectGroup, Maybe<bool> in_silent, Maybe<bool> in_includeCommandLineAPI,
        Maybe<bool> in_returnByValue, Maybe<bool> in_generatePreview, Maybe<bool> in_awaitPromise, std::unique_ptr<RunScriptCallback> callback)
        = 0;
