...
V8_CRDTP_DESERIALIZE_FIELD("callFrame", m_callFrame), V8_CRDTP_DESERIALIZE_FIELD_OPT("children", m_children), V8_CRDTP_DESERIALIZE_FIELD_OPT("deoptReason", m_deoptReason),
    V8_CRDTP_DESERIALIZE_FIELD_OPT("hitCount", m_hitCount), V8_CRDTP_DESERIALIZE_FIELD("id", m_id), V8_CRDTP_DESERIALIZE_FIELD_OPT("positionTicks", m_positionTicks),
...
V8_CRDTP_DESERIALIZE_FIELD("functionName", m_functionName), V8_CRDTP_DESERIALIZE_FIELD("isBlockCoverage", m_isBlockCoverage), V8_CRDTP_DESERIALIZE_FIELD("ranges", m_ranges),
    V8_CRDTP_END_DESERIALIZER()
