...
public:
    ...
    private:
        ...
        template <int STEP> ProfileNodeBuilder<STATE | STEP>& castState() { return *reinterpret_cast<ProfileNodeBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::Profiler::ProfileNode> m_result;
    };

    static ProfileNodeBuilder<0> create() { return ProfileNodeBuilder<0>(); }
...
public:
    ...
    private:
        ...
        template <int STEP> ProfileBuilder<STATE | STEP>& castState() { return *reinterpret_cast<ProfileBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::Profiler::Profile> m_result;
    };

    static ProfileBuilder<0> create() { return ProfileBuilder<0>(); }
...
public:
    ...
    private:
        ...
        template <int STEP> PositionTickInfoBuilder<STATE | STEP>& castState() { return *reinterpret_cast<PositionTickInfoBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::Profiler::PositionTickInfo> m_result;
    };

    static PositionTickInfoBuilder<0> create() { return PositionTickInfoBuilder<0>(); }
...
public:
    ...
    public:
        enum { NoFieldsSet = 0, StartOffsetSet = 1 << 1, EndOffsetSet = 1 << 2, CountSet = 1 << 3, AllFieldsSet = (StartOffsetSet | EndOffsetSet | CountSet | 0) };
    ...
    private:
        ...
        template <int STEP> CoverageRangeBuilder<STATE | STEP>& castState() { return *reinterpret_cast<CoverageRangeBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::Profiler::CoverageRange> m_result;
    };

    static CoverageRangeBuilder<0> create() { return CoverageRangeBuilder<0>(); }
...
public:
    ...
    public:
        enum { NoFieldsSet = 0, FunctionNameSet = 1 << 1, RangesSet = 1 << 2, IsBlockCoverageSet = 1 << 3, AllFieldsSet = (FunctionNameSet | RangesSet | IsBlockCoverageSet | 0) };
    ...
    private:
        ...
        template <int STEP> FunctionCoverageBuilder<STATE | STEP>& castState() { return *reinterpret_cast<FunctionCoverageBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::Profiler::FunctionCoverage> m_result;
    };

    static FunctionCoverageBuilder<0> create() { return FunctionCoverageBuilder<0>(); }

private:
    DECLARE_SERIALIZATION_SUPPORT();

    FunctionCoverage() { m_isBlockCoverage = false; }
...
public:
    ...
    private:
        ...
        template <int STEP> ScriptCoverageBuilder<STATE | STEP>& castState() { return *reinterpret_cast<ScriptCoverageBuilder<STATE | STEP>*>(this); }

        std::unique_ptr<protocol::Profiler::ScriptCoverage> m_result;
    };

    static ScriptCoverageBuilder<0> create() { return ScriptCoverageBuilder<0>(); }
...
public:
    ...
    void consoleProfileFinished(
        const String& id, std::unique_ptr<protocol::Debugger::Location> location, std::unique_ptr<protocol::Profiler::Profile> profile, Maybe<String> title = Maybe<String>());
