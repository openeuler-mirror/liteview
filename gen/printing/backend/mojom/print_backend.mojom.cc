...
#ifndef PRINTING_BACKEND_MOJOM_PRINT_BACKEND_MOJOM_JUMBO_H_
#define PRINTING_BACKEND_MOJOM_PRINT_BACKEND_MOJOM_JUMBO_H_
#endif
...
PrinterBasicInfo::PrinterBasicInfo(const std::string& printer_name_in, const std::string& display_name_in, const std::string& printer_description_in, int32_t printer_status_in,
...
bool PrinterBasicInfo::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
Paper::Paper()
    : display_name()
    , vendor_id()
    , size_um()
...
bool Paper::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
bool PageOutputQualityAttribute::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
PageOutputQuality::PageOutputQuality(std::vector<::printing::PageOutputQualityAttribute> qualities_in, const absl::optional<std::string>& default_quality_in)
...
bool PageOutputQuality::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
PrinterSemanticCapsAndDefaults::PrinterSemanticCapsAndDefaults(bool collate_capable_in, bool collate_default_in, int32_t copies_max_in,
    std::vector<::printing::mojom::DuplexMode> duplex_modes_in, ::printing::mojom::DuplexMode duplex_default_in, bool color_changeable_in, bool color_default_in,
    ::printing::mojom::ColorModel color_model_in, ::printing::mojom::ColorModel bw_model_in, std::vector<::printing::PrinterSemanticCapsAndDefaults::Paper> papers_in,
...
PrinterSemanticCapsAndDefaults::PrinterSemanticCapsAndDefaults(bool collate_capable_in, bool collate_default_in, int32_t copies_max_in,
    ...
    ::printing::mojom::ColorModel color_model_in, ::printing::mojom::ColorModel bw_model_in, std::vector<::printing::PrinterSemanticCapsAndDefaults::Paper> papers_in,
    std::vector<::printing::PrinterSemanticCapsAndDefaults::Paper> user_defined_papers_in, const ::printing::PrinterSemanticCapsAndDefaults::Paper& default_paper_in,
    std::vector<::gfx::Size> dpis_in, const ::gfx::Size& default_dpi_in, const absl::optional<::printing::PageOutputQuality>& page_output_quality_in)
    : collate_capable(std::move(collate_capable_in))
    , collate_default(std::move(collate_default_in))
    , copies_max(std::move(copies_max_in))
    , duplex_modes(std::move(duplex_modes_in))
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
        "<value of type const absl::optional<::printing::PageOutputQuality>&>"
#else
        "<value>"
#endif // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
bool PrinterSemanticCapsAndDefaults::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
} // namespace mojom
} // namespace printing
namespace mojo {
// static
...
// static
bool StructTraits<::printing::mojom::Paper::DataView, ::printing::mojom::PaperPtr>::Read(::printing::mojom::Paper::DataView input, ::printing::mojom::PaperPtr* output)
{
    bool success = true;
