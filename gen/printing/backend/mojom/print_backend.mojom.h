...
public:
    ...
    template <typename... Args> static PageOutputQualityAttributePtr New(Args&&... args) { return PageOutputQualityAttributePtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static PageOutputQualityAttributePtr From(const U& u) { return mojo::TypeConverter<PageOutputQualityAttributePtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, PageOutputQualityAttribute>::Convert(*this); }
    ...
    template <typename T, PageOutputQualityAttribute::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::PageOutputQualityAttribute_UnserializedMessageContext<UserType, PageOutputQualityAttribute::DataView>>(0, 0, std::move(input)),
    ...
    {
        return PageOutputQualityAttribute::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }

    template <typename UserType> static bool DeserializeFromMessage(mojo::Message input, UserType* output)
    {
        auto context = input.TakeUnserializedContext<internal::PageOutputQualityAttribute_UnserializedMessageContext<UserType, PageOutputQualityAttribute::DataView>>();
        if (context) {
...
template <typename T, PageOutputQualityAttribute::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, PageOutputQualityAttribute::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, PageOutputQualityAttribute::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static PrinterBasicInfoPtr New(Args&&... args) { return PrinterBasicInfoPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static PrinterBasicInfoPtr From(const U& u) { return mojo::TypeConverter<PrinterBasicInfoPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, PrinterBasicInfo>::Convert(*this); }
    PrinterBasicInfo()
        : printer_name()
        , display_name()
        , printer_description()
    ...
    PrinterBasicInfo(const std::string& printer_name_in, const std::string& display_name_in, const std::string& printer_description_in, int32_t printer_status_in,
        bool is_default_in, const base::flat_map<std::string, std::string>& options_in)
    ...
    template <typename T, PrinterBasicInfo::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<PrinterBasicInfo::DataView, std::vector<uint8_t>>(input);
    }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<PrinterBasicInfo::DataView>(input); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::PrinterBasicInfo_UnserializedMessageContext<UserType, PrinterBasicInfo::DataView>>(0, 0, std::move(input)), MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const std::vector<uint8_t>& input, UserType* output)
    {
        return PrinterBasicInfo::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, PrinterBasicInfo::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, PrinterBasicInfo::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, PrinterBasicInfo::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static PaperPtr New(Args&&... args) { return PaperPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static PaperPtr From(const U& u) { return mojo::TypeConverter<PaperPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, Paper>::Convert(*this); }
    Paper()
        : display_name()
        , vendor_id()
        , size_um()
    ...
    template <typename T, Paper::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input) { return mojo::internal::SerializeImpl<Paper::DataView, std::vector<uint8_t>>(input); }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<Paper::DataView>(input); }
    ...
    template <typename UserType> static mojo::Message WrapAsMessage(UserType input)
    {
        return mojo::Message(std::make_unique<internal::Paper_UnserializedMessageContext<UserType, Paper::DataView>>(0, 0, std::move(input)), MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const std::vector<uint8_t>& input, UserType* output)
    {
        return Paper::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, Paper::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, Paper::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, Paper::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static PageOutputQualityPtr New(Args&&... args) { return PageOutputQualityPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static PageOutputQualityPtr From(const U& u) { return mojo::TypeConverter<PageOutputQualityPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, PageOutputQuality>::Convert(*this); }
    PageOutputQuality()
        : qualities()
        , default_quality()
    {
    ...
    PageOutputQuality(std::vector<::printing::PageOutputQualityAttribute> qualities_in, const absl::optional<std::string>& default_quality_in)
    ...
    template <typename T, PageOutputQuality::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<PageOutputQuality::DataView, std::vector<uint8_t>>(input);
    }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<PageOutputQuality::DataView>(input); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::PageOutputQuality_UnserializedMessageContext<UserType, PageOutputQuality::DataView>>(0, 0, std::move(input)), MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const std::vector<uint8_t>& input, UserType* output)
    {
        return PageOutputQuality::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, PageOutputQuality::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, PageOutputQuality::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, PageOutputQuality::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    {
        return PrinterSemanticCapsAndDefaultsPtr(absl::in_place, std::forward<Args>(args)...);
    }

    template <typename U> static PrinterSemanticCapsAndDefaultsPtr From(const U& u) { return mojo::TypeConverter<PrinterSemanticCapsAndDefaultsPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, PrinterSemanticCapsAndDefaults>::Convert(*this); }
    ...
    PrinterSemanticCapsAndDefaults(bool collate_capable_in, bool collate_default_in, int32_t copies_max_in, std::vector<::printing::mojom::DuplexMode> duplex_modes_in,
        ::printing::mojom::DuplexMode duplex_default_in, bool color_changeable_in, bool color_default_in, ::printing::mojom::ColorModel color_model_in,
        ::printing::mojom::ColorModel bw_model_in, std::vector<::printing::PrinterSemanticCapsAndDefaults::Paper> papers_in,
        std::vector<::printing::PrinterSemanticCapsAndDefaults::Paper> user_defined_papers_in, const ::printing::PrinterSemanticCapsAndDefaults::Paper& default_paper_in,
        std::vector<::gfx::Size> dpis_in, const ::gfx::Size& default_dpi_in)
    ...
    PrinterSemanticCapsAndDefaults(bool collate_capable, bool collate_default, int32_t copies_max, std::vector<::printing::mojom::DuplexMode> duplex_modes,
        ::printing::mojom::DuplexMode duplex_default, bool color_changeable, bool color_default, ::printing::mojom::ColorModel color_model, ::printing::mojom::ColorModel bw_model,
        std::vector<::printing::PrinterSemanticCapsAndDefaults::Paper> papers, std::vector<::printing::PrinterSemanticCapsAndDefaults::Paper> user_defined_papers,
    ...
    template <typename T, PrinterSemanticCapsAndDefaults::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
    ...
    {
        return mojo::Message(
            std::make_unique<internal::PrinterSemanticCapsAndDefaults_UnserializedMessageContext<UserType, PrinterSemanticCapsAndDefaults::DataView>>(0, 0, std::move(input)),
            MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const std::vector<uint8_t>& input, UserType* output)
    {
        return PrinterSemanticCapsAndDefaults::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }

    template <typename UserType> static bool DeserializeFromMessage(mojo::Message input, UserType* output)
    {
        auto context = input.TakeUnserializedContext<internal::PrinterSemanticCapsAndDefaults_UnserializedMessageContext<UserType, PrinterSemanticCapsAndDefaults::DataView>>();
        if (context) {
            *output = std::move(context->TakeData());
            return true;
        }
    ...
    absl::optional<::printing::PageOutputQuality> page_output_quality;
...
template <typename T, PrinterSemanticCapsAndDefaults::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, PrinterSemanticCapsAndDefaults::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, PrinterSemanticCapsAndDefaults::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }

template <typename StructPtrType> PrinterBasicInfoPtr PrinterBasicInfo::Clone() const
{
    return New(mojo::Clone(printer_name), mojo::Clone(display_name), mojo::Clone(printer_description), mojo::Clone(printer_status), mojo::Clone(is_default), mojo::Clone(options));
}
...
template <typename StructPtrType> PaperPtr Paper::Clone() const { return New(mojo::Clone(display_name), mojo::Clone(vendor_id), mojo::Clone(size_um)); }
...
template <typename StructPtrType> PageOutputQualityAttributePtr PageOutputQualityAttribute::Clone() const { return New(mojo::Clone(display_name), mojo::Clone(name)); }
...
template <typename StructPtrType> PageOutputQualityPtr PageOutputQuality::Clone() const { return New(mojo::Clone(qualities), mojo::Clone(default_quality)); }
...
template <typename StructPtrType> PrinterSemanticCapsAndDefaultsPtr PrinterSemanticCapsAndDefaults::Clone() const
{
    return New(mojo::Clone(collate_capable), mojo::Clone(collate_default), mojo::Clone(copies_max), mojo::Clone(duplex_modes), mojo::Clone(duplex_default),
        mojo::Clone(color_changeable), mojo::Clone(color_default), mojo::Clone(color_model), mojo::Clone(bw_model), mojo::Clone(papers), mojo::Clone(user_defined_papers),
        mojo::Clone(default_paper), mojo::Clone(dpis), mojo::Clone(default_dpi), mojo::Clone(page_output_quality));
}
...
template <> struct StructTraits<::printing::mojom::PrinterBasicInfo::DataView, ::printing::mojom::PrinterBasicInfoPtr> {
    ...
    static const decltype(::printing::mojom::PrinterBasicInfo::printer_name)& printer_name(const ::printing::mojom::PrinterBasicInfoPtr& input) { return input->printer_name; }

    static const decltype(::printing::mojom::PrinterBasicInfo::display_name)& display_name(const ::printing::mojom::PrinterBasicInfoPtr& input) { return input->display_name; }
    ...
    static decltype(::printing::mojom::PrinterBasicInfo::printer_status) printer_status(const ::printing::mojom::PrinterBasicInfoPtr& input) { return input->printer_status; }

    static decltype(::printing::mojom::PrinterBasicInfo::is_default) is_default(const ::printing::mojom::PrinterBasicInfoPtr& input) { return input->is_default; }

    static const decltype(::printing::mojom::PrinterBasicInfo::options)& options(const ::printing::mojom::PrinterBasicInfoPtr& input) { return input->options; }
...
template <> struct StructTraits<::printing::mojom::Paper::DataView, ::printing::mojom::PaperPtr> {
    ...
    static const decltype(::printing::mojom::Paper::display_name)& display_name(const ::printing::mojom::PaperPtr& input) { return input->display_name; }

    static const decltype(::printing::mojom::Paper::vendor_id)& vendor_id(const ::printing::mojom::PaperPtr& input) { return input->vendor_id; }

    static const decltype(::printing::mojom::Paper::size_um)& size_um(const ::printing::mojom::PaperPtr& input) { return input->size_um; }
...
template <> struct StructTraits<::printing::mojom::PageOutputQualityAttribute::DataView, ::printing::mojom::PageOutputQualityAttributePtr> {
    static bool IsNull(const ::printing::mojom::PageOutputQualityAttributePtr& input) { return !input; }
    static void SetToNull(::printing::mojom::PageOutputQualityAttributePtr* output) { output->reset(); }

    static const decltype(::printing::mojom::PageOutputQualityAttribute::display_name)& display_name(const ::printing::mojom::PageOutputQualityAttributePtr& input)
    {
        return input->display_name;
    }

    static const decltype(::printing::mojom::PageOutputQualityAttribute::name)& name(const ::printing::mojom::PageOutputQualityAttributePtr& input) { return input->name; }
...
template <> struct StructTraits<::printing::mojom::PageOutputQuality::DataView, ::printing::mojom::PageOutputQualityPtr> {
    static bool IsNull(const ::printing::mojom::PageOutputQualityPtr& input) { return !input; }
    static void SetToNull(::printing::mojom::PageOutputQualityPtr* output) { output->reset(); }

    static const decltype(::printing::mojom::PageOutputQuality::qualities)& qualities(const ::printing::mojom::PageOutputQualityPtr& input) { return input->qualities; }
...
template <> struct StructTraits<::printing::mojom::PrinterSemanticCapsAndDefaults::DataView, ::printing::mojom::PrinterSemanticCapsAndDefaultsPtr> {
    ...
    static decltype(::printing::mojom::PrinterSemanticCapsAndDefaults::collate_capable) collate_capable(const ::printing::mojom::PrinterSemanticCapsAndDefaultsPtr& input)
    {
        return input->collate_capable;
    }

    static decltype(::printing::mojom::PrinterSemanticCapsAndDefaults::collate_default) collate_default(const ::printing::mojom::PrinterSemanticCapsAndDefaultsPtr& input)
    {
    ...
    static const decltype(::printing::mojom::PrinterSemanticCapsAndDefaults::duplex_modes)& duplex_modes(const ::printing::mojom::PrinterSemanticCapsAndDefaultsPtr& input)
    {
        return input->duplex_modes;
    }

    static decltype(::printing::mojom::PrinterSemanticCapsAndDefaults::duplex_default) duplex_default(const ::printing::mojom::PrinterSemanticCapsAndDefaultsPtr& input)
    {
        return input->duplex_default;
    }

    static decltype(::printing::mojom::PrinterSemanticCapsAndDefaults::color_changeable) color_changeable(const ::printing::mojom::PrinterSemanticCapsAndDefaultsPtr& input)
    {
        return input->color_changeable;
    }

    static decltype(::printing::mojom::PrinterSemanticCapsAndDefaults::color_default) color_default(const ::printing::mojom::PrinterSemanticCapsAndDefaultsPtr& input)
    {
        return input->color_default;
    }

    static decltype(::printing::mojom::PrinterSemanticCapsAndDefaults::color_model) color_model(const ::printing::mojom::PrinterSemanticCapsAndDefaultsPtr& input)
    {
    ...
    static const decltype(::printing::mojom::PrinterSemanticCapsAndDefaults::default_paper)& default_paper(const ::printing::mojom::PrinterSemanticCapsAndDefaultsPtr& input)
    {
        return input->default_paper;
    }

    static const decltype(::printing::mojom::PrinterSemanticCapsAndDefaults::dpis)& dpis(const ::printing::mojom::PrinterSemanticCapsAndDefaultsPtr& input) { return input->dpis; }

    static const decltype(::printing::mojom::PrinterSemanticCapsAndDefaults::default_dpi)& default_dpi(const ::printing::mojom::PrinterSemanticCapsAndDefaultsPtr& input)
    {
