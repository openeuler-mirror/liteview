...
#ifndef PRINTING_MOJOM_PRINTING_CONTEXT_MOJOM_JUMBO_H_
#define PRINTING_MOJOM_PRINTING_CONTEXT_MOJOM_JUMBO_H_
#endif
...
bool PageMargins::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
PageSetup::PageSetup()
    : physical_size()
    , printable_area()
    , overlay_area()
...
PageSetup::PageSetup(const ::gfx::Size& physical_size_in, const ::gfx::Rect& printable_area_in, const ::gfx::Rect& overlay_area_in, const ::gfx::Rect& content_area_in,
...
bool PageSetup::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
bool RequestedMedia::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
PrintSettings::PrintSettings(std::vector<::printing::PageRange> ranges_in, bool selection_only_in, ::printing::mojom::MarginType margin_type_in, const ::std::u16string& title_in,
...
void PrintSettings::WriteIntoTrace(perfetto::TracedValue traced_context) const
{
    ...
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("supports_alpha_blend"), this->supports_alpha_blend,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
        "<value of type bool>"
#else
        "<value>"
...
bool PrintSettings::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
} // namespace mojom
} // namespace printing
namespace mojo {
// static
