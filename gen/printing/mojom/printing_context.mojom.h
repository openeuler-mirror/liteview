...
public:
    ...
    template <typename... Args> static PageMarginsPtr New(Args&&... args) { return PageMarginsPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static PageMarginsPtr From(const U& u) { return mojo::TypeConverter<PageMarginsPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, PageMargins>::Convert(*this); }
    PageMargins()
        : header()
        , footer()
        , left()
    ...
    template <typename T, PageMargins::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    ...
    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<PageMargins::DataView>(input); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::PageMargins_UnserializedMessageContext<UserType, PageMargins::DataView>>(0, 0, std::move(input)), MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    {
        return PageMargins::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, PageMargins::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, PageMargins::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, PageMargins::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static PageSetupPtr New(Args&&... args) { return PageSetupPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static PageSetupPtr From(const U& u) { return mojo::TypeConverter<PageSetupPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, PageSetup>::Convert(*this); }
    PageSetup()
        : physical_size()
        , printable_area()
        , overlay_area()
    ...
    PageSetup(const ::gfx::Size& physical_size_in, const ::gfx::Rect& printable_area_in, const ::gfx::Rect& overlay_area_in, const ::gfx::Rect& content_area_in,
        const ::printing::PageMargins& effective_margins_in, const ::printing::PageMargins& requested_margins_in, bool forced_margins_in, int32_t text_height_in)
    ...
    template <typename T, PageSetup::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input) { return mojo::internal::SerializeImpl<PageSetup::DataView, std::vector<uint8_t>>(input); }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<PageSetup::DataView>(input); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::PageSetup_UnserializedMessageContext<UserType, PageSetup::DataView>>(0, 0, std::move(input)), MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const std::vector<uint8_t>& input, UserType* output)
    {
        return PageSetup::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, PageSetup::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, PageSetup::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, PageSetup::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static RequestedMediaPtr New(Args&&... args) { return RequestedMediaPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static RequestedMediaPtr From(const U& u) { return mojo::TypeConverter<RequestedMediaPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, RequestedMedia>::Convert(*this); }
    RequestedMedia()
        : size_microns()
        , vendor_id()
    {
    ...
    template <typename T, RequestedMedia::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<RequestedMedia::DataView, std::vector<uint8_t>>(input);
    }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<RequestedMedia::DataView>(input); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::RequestedMedia_UnserializedMessageContext<UserType, RequestedMedia::DataView>>(0, 0, std::move(input)), MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const std::vector<uint8_t>& input, UserType* output)
    {
        return RequestedMedia::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, RequestedMedia::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, RequestedMedia::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, RequestedMedia::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static PrintSettingsPtr New(Args&&... args) { return PrintSettingsPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static PrintSettingsPtr From(const U& u) { return mojo::TypeConverter<PrintSettingsPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, PrintSettings>::Convert(*this); }
    PrintSettings()
        : ranges()
        , selection_only()
        , margin_type()
    ...
    PrintSettings(std::vector<::printing::PageRange> ranges_in, bool selection_only_in, ::printing::mojom::MarginType margin_type_in, const ::std::u16string& title_in,
        const ::std::u16string& url_in, bool display_header_footer_in, bool should_print_backgrounds_in, bool collate_in, ::printing::mojom::ColorModel color_in, int32_t copies_in,
        ::printing::mojom::DuplexMode duplex_mode_in, const ::std::u16string& device_name_in, const ::printing::PrintSettings::RequestedMedia& requested_media_in,
        const ::printing::PageSetup& page_setup_device_units_in, const ::gfx::Size& dpi_in, double scale_factor_in, bool rasterize_pdf_in, bool landscape_in,
        bool supports_alpha_blend_in, ::printing::mojom::PrinterLanguageType printer_language_type_in, bool is_modifiable_in,
    ...
    template <typename T, PrintSettings::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<PrintSettings::DataView, std::vector<uint8_t>>(input);
    }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<PrintSettings::DataView>(input); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::PrintSettings_UnserializedMessageContext<UserType, PrintSettings::DataView>>(0, 0, std::move(input)), MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const std::vector<uint8_t>& input, UserType* output)
    {
        return PrintSettings::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, PrintSettings::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, PrintSettings::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, PrintSettings::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
template <typename StructPtrType> RequestedMediaPtr RequestedMedia::Clone() const { return New(mojo::Clone(size_microns), mojo::Clone(vendor_id)); }
...
{
    return New(mojo::Clone(ranges), mojo::Clone(selection_only), mojo::Clone(margin_type), mojo::Clone(title), mojo::Clone(url), mojo::Clone(display_header_footer),
        mojo::Clone(should_print_backgrounds), mojo::Clone(collate), mojo::Clone(color), mojo::Clone(copies), mojo::Clone(duplex_mode), mojo::Clone(device_name),
        mojo::Clone(requested_media), mojo::Clone(page_setup_device_units), mojo::Clone(dpi), mojo::Clone(scale_factor), mojo::Clone(rasterize_pdf), mojo::Clone(landscape),
        mojo::Clone(supports_alpha_blend), mojo::Clone(printer_language_type), mojo::Clone(is_modifiable), mojo::Clone(requested_custom_margins_in_points),
...
template <> struct StructTraits<::printing::mojom::PageMargins::DataView, ::printing::mojom::PageMarginsPtr> {
    ...
    static decltype(::printing::mojom::PageMargins::header) header(const ::printing::mojom::PageMarginsPtr& input) { return input->header; }

    static decltype(::printing::mojom::PageMargins::footer) footer(const ::printing::mojom::PageMarginsPtr& input) { return input->footer; }

    static decltype(::printing::mojom::PageMargins::left) left(const ::printing::mojom::PageMarginsPtr& input) { return input->left; }

    static decltype(::printing::mojom::PageMargins::right) right(const ::printing::mojom::PageMarginsPtr& input) { return input->right; }

    static decltype(::printing::mojom::PageMargins::top) top(const ::printing::mojom::PageMarginsPtr& input) { return input->top; }

    static decltype(::printing::mojom::PageMargins::bottom) bottom(const ::printing::mojom::PageMarginsPtr& input) { return input->bottom; }
...
template <> struct StructTraits<::printing::mojom::PageSetup::DataView, ::printing::mojom::PageSetupPtr> {
    ...
    static const decltype(::printing::mojom::PageSetup::physical_size)& physical_size(const ::printing::mojom::PageSetupPtr& input) { return input->physical_size; }

    static const decltype(::printing::mojom::PageSetup::printable_area)& printable_area(const ::printing::mojom::PageSetupPtr& input) { return input->printable_area; }

    static const decltype(::printing::mojom::PageSetup::overlay_area)& overlay_area(const ::printing::mojom::PageSetupPtr& input) { return input->overlay_area; }

    static const decltype(::printing::mojom::PageSetup::content_area)& content_area(const ::printing::mojom::PageSetupPtr& input) { return input->content_area; }

    static const decltype(::printing::mojom::PageSetup::effective_margins)& effective_margins(const ::printing::mojom::PageSetupPtr& input) { return input->effective_margins; }

    static const decltype(::printing::mojom::PageSetup::requested_margins)& requested_margins(const ::printing::mojom::PageSetupPtr& input) { return input->requested_margins; }

    static decltype(::printing::mojom::PageSetup::forced_margins) forced_margins(const ::printing::mojom::PageSetupPtr& input) { return input->forced_margins; }

    static decltype(::printing::mojom::PageSetup::text_height) text_height(const ::printing::mojom::PageSetupPtr& input) { return input->text_height; }
...
template <> struct StructTraits<::printing::mojom::RequestedMedia::DataView, ::printing::mojom::RequestedMediaPtr> {
    ...
    static const decltype(::printing::mojom::RequestedMedia::size_microns)& size_microns(const ::printing::mojom::RequestedMediaPtr& input) { return input->size_microns; }

    static const decltype(::printing::mojom::RequestedMedia::vendor_id)& vendor_id(const ::printing::mojom::RequestedMediaPtr& input) { return input->vendor_id; }
...
template <> struct StructTraits<::printing::mojom::PrintSettings::DataView, ::printing::mojom::PrintSettingsPtr> {
    ...
    static const decltype(::printing::mojom::PrintSettings::ranges)& ranges(const ::printing::mojom::PrintSettingsPtr& input) { return input->ranges; }

    static decltype(::printing::mojom::PrintSettings::selection_only) selection_only(const ::printing::mojom::PrintSettingsPtr& input) { return input->selection_only; }

    static decltype(::printing::mojom::PrintSettings::margin_type) margin_type(const ::printing::mojom::PrintSettingsPtr& input) { return input->margin_type; }

    static const decltype(::printing::mojom::PrintSettings::title)& title(const ::printing::mojom::PrintSettingsPtr& input) { return input->title; }

    static const decltype(::printing::mojom::PrintSettings::url)& url(const ::printing::mojom::PrintSettingsPtr& input) { return input->url; }
    ...
    static decltype(::printing::mojom::PrintSettings::collate) collate(const ::printing::mojom::PrintSettingsPtr& input) { return input->collate; }

    static decltype(::printing::mojom::PrintSettings::color) color(const ::printing::mojom::PrintSettingsPtr& input) { return input->color; }

    static decltype(::printing::mojom::PrintSettings::copies) copies(const ::printing::mojom::PrintSettingsPtr& input) { return input->copies; }

    static decltype(::printing::mojom::PrintSettings::duplex_mode) duplex_mode(const ::printing::mojom::PrintSettingsPtr& input) { return input->duplex_mode; }

    static const decltype(::printing::mojom::PrintSettings::device_name)& device_name(const ::printing::mojom::PrintSettingsPtr& input) { return input->device_name; }

    static const decltype(::printing::mojom::PrintSettings::requested_media)& requested_media(const ::printing::mojom::PrintSettingsPtr& input) { return input->requested_media; }
    ...
    static const decltype(::printing::mojom::PrintSettings::dpi)& dpi(const ::printing::mojom::PrintSettingsPtr& input) { return input->dpi; }

    static decltype(::printing::mojom::PrintSettings::scale_factor) scale_factor(const ::printing::mojom::PrintSettingsPtr& input) { return input->scale_factor; }

    static decltype(::printing::mojom::PrintSettings::rasterize_pdf) rasterize_pdf(const ::printing::mojom::PrintSettingsPtr& input) { return input->rasterize_pdf; }

    static decltype(::printing::mojom::PrintSettings::landscape) landscape(const ::printing::mojom::PrintSettingsPtr& input) { return input->landscape; }

    static decltype(::printing::mojom::PrintSettings::supports_alpha_blend) supports_alpha_blend(const ::printing::mojom::PrintSettingsPtr& input)
    {
    ...
    static decltype(::printing::mojom::PrintSettings::is_modifiable) is_modifiable(const ::printing::mojom::PrintSettingsPtr& input) { return input->is_modifiable; }
    ...
    static decltype(::printing::mojom::PrintSettings::pages_per_sheet) pages_per_sheet(const ::printing::mojom::PrintSettingsPtr& input) { return input->pages_per_sheet; }
