...
template <typename UserType, typename DataView> struct PeerAssociatedEndpointClosedEvent_UnserializedMessageContext : public mojo::internal::UnserializedMessageContext {
public:
    static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;
...
template <typename UserType, typename DataView> const mojo::internal::UnserializedMessageContext::Tag FlushAsync_UnserializedMessageContext<UserType, DataView>::kMessageTag = {};
