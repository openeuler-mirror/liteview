...
bool SerializedHandle::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
NativeStruct::NativeStruct(std::vector<uint8_t> data_in, absl::optional<std::vector<SerializedHandlePtr>> handles_in)
...
bool NativeStruct::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
} // namespace native
} // namespace mojo
namespace mojo {
// static
