...
bool BigBufferSharedMemoryRegion::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
BigBuffer::BigBuffer()
    : tag_(Tag::kBytes)
{
...
BigBuffer::~BigBuffer() { DestroyActive(); }
...
bool BigBuffer::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context, false); }
} // namespace mojom
} // namespace mojo_base
namespace mojo {
// static
