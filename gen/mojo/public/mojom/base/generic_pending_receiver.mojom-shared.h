...
template <typename MaybeConstUserType> struct Serializer<::mojo_base::mojom::GenericPendingReceiverDataView, MaybeConstUserType> {
    ...
    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::mojo_base::mojom::internal::GenericPendingReceiver_Data>& fragment)
    {
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
            fragment->interface_name.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null interface_name in GenericPendingReceiver struct");
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(!mojo::internal::IsHandleOrInterfaceValid(fragment->receiving_pipe), mojo::internal::VALIDATION_ERROR_UNEXPECTED_INVALID_HANDLE,
