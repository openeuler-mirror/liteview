...
FileInfo::FileInfo(int64_t size_in, bool is_directory_in, bool is_symbolic_link_in, ::base::Time last_modified_in, ::base::Time last_accessed_in, ::base::Time creation_time_in)
...
bool FileInfo::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
} // namespace blink
} // namespace mojom
} // namespace mojo_base
namespace mojo {
