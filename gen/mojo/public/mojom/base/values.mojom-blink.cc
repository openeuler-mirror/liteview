...
DeprecatedDictionaryValue::DeprecatedDictionaryValue(WTF::HashMap<WTF::String, ::base::Value> storage_in)
    : storage(std::move(storage_in))
{
}
...
bool StructTraits<::mojo_base::mojom::blink::DeprecatedDictionaryValue::DataView, ::mojo_base::mojom::blink::DeprecatedDictionaryValuePtr>::Read(
    ::mojo_base::mojom::blink::DeprecatedDictionaryValue::DataView input, ::mojo_base::mojom::blink::DeprecatedDictionaryValuePtr* output)
{
    bool success = true;
