...
static NOINLINE const char* MessagePumpTypeToStringHelper(MessagePumpType value)
{
...
std::ostream& operator<<(std::ostream& os, MessagePumpType value) { return os << MessagePumpTypeToString(value); }
