...
struct mojo_base_mojom_internal_TextDirection_DataHashFn {
    ...
    static bool Equal(const ::mojo_base::mojom::TextDirection& left, const ::mojo_base::mojom::TextDirection& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::mojo_base::mojom::TextDirection> : public GenericHashTraits<::mojo_base::mojom::TextDirection> {
    ...
    static void ConstructDeletedValue(::mojo_base::mojom::TextDirection& slot, bool) { slot = static_cast<::mojo_base::mojom::TextDirection>(-1000001); }
    static bool IsDeletedValue(const ::mojo_base::mojom::TextDirection& value) { return value == static_cast<::mojo_base::mojom::TextDirection>(-1000001); }
};
} // namespace WTF
namespace mojo_base {
namespace mojom {
