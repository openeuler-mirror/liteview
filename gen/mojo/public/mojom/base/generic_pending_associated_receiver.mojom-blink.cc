...
GenericPendingAssociatedReceiver::GenericPendingAssociatedReceiver(const WTF::String& interface_name_in, ::mojo::PendingAssociatedReceiver<GenericAssociatedInterface> receiver_in)
