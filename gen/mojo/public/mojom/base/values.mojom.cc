...
bool DictionaryValue::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
ListValue::ListValue()
    : storage()
{
}
...
bool ListValue::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
DeprecatedDictionaryValue::DeprecatedDictionaryValue()
    : storage()
{
}

DeprecatedDictionaryValue::DeprecatedDictionaryValue(base::flat_map<std::string, ::base::Value> storage_in)
    : storage(std::move(storage_in))
{
}
...
void DeprecatedDictionaryValue::WriteIntoTrace(perfetto::TracedValue traced_context) const
{
    [[maybe_unused]] auto dict = std::move(traced_context).WriteDictionary();
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("storage"), this->storage,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
bool DeprecatedDictionaryValue::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
Value::Value()
    : tag_(Tag::kNullValue)
{
...
bool Value::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context, false); }
} // namespace mojom
} // namespace mojo_base
namespace mojo {
// static
...
bool StructTraits<::mojo_base::mojom::DeprecatedDictionaryValue::DataView, ::mojo_base::mojom::DeprecatedDictionaryValuePtr>::Read(
    ::mojo_base::mojom::DeprecatedDictionaryValue::DataView input, ::mojo_base::mojom::DeprecatedDictionaryValuePtr* output)
{
    bool success = true;
...
// static
bool UnionTraits<::mojo_base::mojom::Value::DataView, ::mojo_base::mojom::ValuePtr>::Read(::mojo_base::mojom::Value::DataView input, ::mojo_base::mojom::ValuePtr* output)
{
