...
static NOINLINE const char* ApplicationStateToStringHelper(ApplicationState value)
{
...
std::ostream& operator<<(std::ostream& os, ApplicationState value) { return os << ApplicationStateToString(value); }
