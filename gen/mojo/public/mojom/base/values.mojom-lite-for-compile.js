...
goog.provide('mojoBase.mojom.DeprecatedDictionaryValueSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('mojoBase.mojom.DeprecatedDictionaryValue');

/** @record */
mojoBase.mojom.DeprecatedDictionaryValue = class {
  constructor() {
    /** @export { !Object<!string, !mojoBase.mojom.Value> } */
    this.storage;
  }
