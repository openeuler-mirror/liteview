...
(function() {
  ...
  function DeprecatedDictionaryValue(values) {
    this.initDefaults_();
    this.initFields_(values);
  }
  DeprecatedDictionaryValue.prototype.initDefaults_ = function() {
    this.storage = null;
  };
  DeprecatedDictionaryValue.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  DeprecatedDictionaryValue.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    if (err !== validator.validationError.NONE)
        return err;
    // validate DeprecatedDictionaryValue.storage
    err = messageValidator.validateMapPointer(offset + codec.kStructHeaderSize + 0, false, codec.String, Value, false);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  DeprecatedDictionaryValue.encodedSize = codec.kStructHeaderSize + 8;

  DeprecatedDictionaryValue.decode = function(decoder) {
    var packed;
    var val = new DeprecatedDictionaryValue();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.storage =
        decoder.decodeMapPointer(codec.String, Value);
  ...
  DeprecatedDictionaryValue.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(DeprecatedDictionaryValue.encodedSize);
    encoder.writeUint32(0);
    encoder.encodeMapPointer(codec.String, Value, val.storage);
  };
  ...
  exports.DeprecatedDictionaryValue = DeprecatedDictionaryValue;
  exports.Value = Value;
})();
