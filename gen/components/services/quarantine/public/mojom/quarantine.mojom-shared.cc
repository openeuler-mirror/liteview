...
static NOINLINE const char* QuarantineFileResultToStringHelper(QuarantineFileResult value)
{
...
std::ostream& operator<<(std::ostream& os, QuarantineFileResult value) { return os << QuarantineFileResultToString(value); }
...
bool Quarantine_QuarantineFile_Params_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    ...
    if (!mojo::internal::ValidatePointerNonNullable(object->client_guid, 4, validation_context)) {
        return false;
    }
    const mojo::internal::ContainerValidateParams client_guid_validate_params(0, false, nullptr);
...
// static
void TraceFormatTraits<::quarantine::mojom::QuarantineFileResult>::WriteIntoTrace(perfetto::TracedValue context, ::quarantine::mojom::QuarantineFileResult value)
{
