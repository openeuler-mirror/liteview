...
static_assert(sizeof(Quarantine_QuarantineFile_Params_Data) == 40, "Bad sizeof(Quarantine_QuarantineFile_Params_Data)");
...
public:
    ...
    QuarantineFileResult result() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::quarantine::mojom::QuarantineFileResult>(data_->result)); }
