...
constexpr ApplicationType ApplicationType_MAX = APPLICATION_TYPE_STANDALONE_BROWSER_EXTENSION;
...
{
    static_assert(::std::is_same<T, ApplicationInstallSource>::value || ::std::is_integral<T>::value, "Incorrect type passed to function ApplicationInstallSource_Name.");
...
{
    static_assert(::std::is_same<T, ApplicationInstallReason>::value || ::std::is_integral<T>::value, "Incorrect type passed to function ApplicationInstallReason_Name.");
...
{
    static_assert(::std::is_same<T, ApplicationInstallTime>::value || ::std::is_integral<T>::value, "Incorrect type passed to function ApplicationInstallTime_Name.");
...
constexpr ApplicationLaunchSource ApplicationLaunchSource_MAX = APPLICATION_LAUNCH_SOURCE_LOCK_SCREEN;
...
{
    static_assert(::std::is_same<T, ApplicationLaunchSource>::value || ::std::is_integral<T>::value, "Incorrect type passed to function ApplicationLaunchSource_Name.");
...
{
    static_assert(::std::is_same<T, ApplicationUninstallSource>::value || ::std::is_integral<T>::value, "Incorrect type passed to function ApplicationUninstallSource_Name.");
