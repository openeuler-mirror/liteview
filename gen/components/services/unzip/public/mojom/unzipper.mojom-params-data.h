...
public:
    ...
    {
        UserType result;
        bool ret = mojo::internal::Deserialize<mojo::InterfacePtrDataView<::filesystem::mojom::DirectoryInterfaceBase>>(&data_->output_dir, &result, message_);
        DCHECK(ret);
        return result;
    }
...
public:
    ...
    bool is_null() const { return !data_; }
    int32_t encoding() const { return data_->encoding; }
