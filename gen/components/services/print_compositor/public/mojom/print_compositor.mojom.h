...
// with not having this data in traces there.
    ...
    virtual void AddSubframeContent(uint64_t frame_guid, ::base::ReadOnlySharedMemoryRegion serialized_content, const base::flat_map<uint32_t, uint64_t>& subframe_content_info)
        = 0;
    ...
    virtual void CompositePageToPdf(
    ...
    virtual void CompositeDocumentToPdf(
...
//
//   void CompositePageToPdf(uint64_t frame_guid, ::base::ReadOnlySharedMemoryRegion sk_region, const base::flat_map<uint32_t, uint64_t>& subframe_content_info,
//   CompositePageToPdfCallback callback) final;
//
//   void CompositeDocumentToPdf(uint64_t frame_guid, ::base::ReadOnlySharedMemoryRegion sk_region, const base::flat_map<uint32_t, uint64_t>& subframe_content_info,
//   CompositeDocumentToPdfCallback callback) final;
//
