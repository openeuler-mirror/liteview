...
static_assert(sizeof(FilePatcher_PatchFileBsdiff_Params_Data) == 32, "Bad sizeof(FilePatcher_PatchFileBsdiff_Params_Data)");
...
static_assert(sizeof(FilePatcher_PatchFileBsdiff_ResponseParams_Data) == 16, "Bad sizeof(FilePatcher_PatchFileBsdiff_ResponseParams_Data)");
...
static_assert(sizeof(FilePatcher_PatchFileCourgette_Params_Data) == 32, "Bad sizeof(FilePatcher_PatchFileCourgette_Params_Data)");
...
static_assert(sizeof(FilePatcher_PatchFileCourgette_ResponseParams_Data) == 16, "Bad sizeof(FilePatcher_PatchFileCourgette_ResponseParams_Data)");
...
public:
    ...
    FilePatcher_PatchFileBsdiff_ParamsDataView(internal::FilePatcher_PatchFileBsdiff_Params_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
...
public:
    ...
    FilePatcher_PatchFileBsdiff_ResponseParamsDataView(internal::FilePatcher_PatchFileBsdiff_ResponseParams_Data* data, mojo::Message* message)
        : data_(data)
    {
    }
...
public:
    ...
    FilePatcher_PatchFileCourgette_ParamsDataView(internal::FilePatcher_PatchFileCourgette_Params_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
...
public:
    ...
    FilePatcher_PatchFileCourgette_ResponseParamsDataView(internal::FilePatcher_PatchFileCourgette_ResponseParams_Data* data, mojo::Message* message)
        : data_(data)
    {
    }
...
inline void FilePatcher_PatchFileBsdiff_ParamsDataView::GetInputFileDataView(::mojo_base::mojom::ReadOnlyFileDataView* output)
{
    auto pointer = data_->input_file.Get();
    *output = ::mojo_base::mojom::ReadOnlyFileDataView(pointer, message_);
}
inline void FilePatcher_PatchFileBsdiff_ParamsDataView::GetPatchFileDataView(::mojo_base::mojom::ReadOnlyFileDataView* output)
{
    auto pointer = data_->patch_file.Get();
    *output = ::mojo_base::mojom::ReadOnlyFileDataView(pointer, message_);
}
inline void FilePatcher_PatchFileBsdiff_ParamsDataView::GetOutputFileDataView(::mojo_base::mojom::FileDataView* output)
{
    auto pointer = data_->output_file.Get();
    *output = ::mojo_base::mojom::FileDataView(pointer, message_);
}
inline void FilePatcher_PatchFileCourgette_ParamsDataView::GetInputFileDataView(::mojo_base::mojom::ReadOnlyFileDataView* output)
{
    auto pointer = data_->input_file.Get();
    *output = ::mojo_base::mojom::ReadOnlyFileDataView(pointer, message_);
}
inline void FilePatcher_PatchFileCourgette_ParamsDataView::GetPatchFileDataView(::mojo_base::mojom::ReadOnlyFileDataView* output)
{
    auto pointer = data_->patch_file.Get();
    *output = ::mojo_base::mojom::ReadOnlyFileDataView(pointer, message_);
}
inline void FilePatcher_PatchFileCourgette_ParamsDataView::GetOutputFileDataView(::mojo_base::mojom::FileDataView* output)
{
    auto pointer = data_->output_file.Get();
    *output = ::mojo_base::mojom::FileDataView(pointer, message_);
}
