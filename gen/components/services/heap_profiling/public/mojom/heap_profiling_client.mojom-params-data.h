...
public:
    ...
    ProfilingClient_AddHeapProfileToTrace_ResponseParamsDataView(internal::ProfilingClient_AddHeapProfileToTrace_ResponseParams_Data* data, mojo::Message* message)
        : data_(data)
    {
    }
