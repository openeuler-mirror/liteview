...
public:
    ...
    {
        UserType result;
        bool ret = mojo::internal::Deserialize<mojo::InterfacePtrDataView<::heap_profiling::mojom::ProfilingClientInterfaceBase>>(&data_->client, &result, message_);
        DCHECK(ret);
        return result;
    }
    ...
    ProcessType process_type() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::heap_profiling::mojom::ProcessType>(data_->process_type)); }
