...
inline bool IsKnownEnumValue(StackMode value) { return internal::StackMode_Data::IsKnownValue(static_cast<int32_t>(value)); }
...
inline bool IsKnownEnumValue(AllocatorType value) { return internal::AllocatorType_Data::IsKnownValue(static_cast<int32_t>(value)); }
...
public:
    ...
    StackMode stack_mode() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::heap_profiling::mojom::StackMode>(data_->stack_mode)); }
    uint32_t sampling_rate() const { return data_->sampling_rate; }
...
public:
    ...
    AllocatorType allocator() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::heap_profiling::mojom::AllocatorType>(data_->allocator)); }
    uint64_t size() const { return data_->size; }
    uint64_t total() const { return data_->total; }
    uint64_t context_id() const { return data_->context_id; }
...
template <typename MaybeConstUserType> struct Serializer<::heap_profiling::mojom::HeapProfileSampleDataView, MaybeConstUserType> {
    ...
    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::heap_profiling::mojom::internal::HeapProfileSample_Data>& fragment)
    {
        ...
        const mojo::internal::ContainerValidateParams stack_validate_params(0, false, nullptr);
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->stack.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null stack in HeapProfileSample struct");
    }
...
template <typename MaybeConstUserType> struct Serializer<::heap_profiling::mojom::HeapProfileDataView, MaybeConstUserType> {
    ...
    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::heap_profiling::mojom::internal::HeapProfile_Data>& fragment)
    {
        ...
        const mojo::internal::ContainerValidateParams samples_validate_params(0, false, nullptr);
        mojo::internal::Serialize<mojo::ArrayDataView<::heap_profiling::mojom::HeapProfileSampleDataView>>(in_samples, samples_fragment, &samples_validate_params);
        fragment->samples.Set(samples_fragment.is_null() ? nullptr : samples_fragment.data());
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->samples.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null samples in HeapProfile struct");
        ...
        const mojo::internal::ContainerValidateParams strings_validate_params(new mojo::internal::ContainerValidateParams(0, false, nullptr),
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(fragment->strings.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null strings in HeapProfile struct");
    }
