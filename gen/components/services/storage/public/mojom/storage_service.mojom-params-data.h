...
static_assert(sizeof(StorageService_EnableAggressiveDomStorageFlushing_Params_Data) == 8, "Bad sizeof(StorageService_EnableAggressiveDomStorageFlushing_Params_Data)");
...
public:
    ...
    StorageService_EnableAggressiveDomStorageFlushing_ParamsDataView(internal::StorageService_EnableAggressiveDomStorageFlushing_Params_Data* data, mojo::Message* message)
        : data_(data)
    {
    }
