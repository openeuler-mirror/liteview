...
public:
    ...
    {
        return ServiceWorkerRegistrationDataPtr(absl::in_place, std::forward<Args>(args)...);
    }

    template <typename U> static ServiceWorkerRegistrationDataPtr From(const U& u) { return mojo::TypeConverter<ServiceWorkerRegistrationDataPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, ServiceWorkerRegistrationData>::Convert(*this); }
    ...
    ServiceWorkerRegistrationData(int64_t registration_id_in, const ::GURL& scope_in, const ::blink::StorageKey& key_in, const ::GURL& script_in,
        ...
        std::vector<::blink::mojom::WebFeature> used_features_in, int64_t resources_total_size_bytes_in,
        const ::network::CrossOriginEmbedderPolicy& cross_origin_embedder_policy_in, ::blink::mojom::PolicyContainerPoliciesPtr policy_container_policies_in,
    ...
    template <typename T, ServiceWorkerRegistrationData::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::ServiceWorkerRegistrationData_UnserializedMessageContext<UserType, ServiceWorkerRegistrationData::DataView>>(0, 0, std::move(input)),
    ...
    {
        return ServiceWorkerRegistrationData::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }

    template <typename UserType> static bool DeserializeFromMessage(mojo::Message input, UserType* output)
    {
        auto context = input.TakeUnserializedContext<internal::ServiceWorkerRegistrationData_UnserializedMessageContext<UserType, ServiceWorkerRegistrationData::DataView>>();
        if (context) {
...
template <typename T, ServiceWorkerRegistrationData::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, ServiceWorkerRegistrationData::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, ServiceWorkerRegistrationData::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static ServiceWorkerResourceRecordPtr New(Args&&... args) { return ServiceWorkerResourceRecordPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static ServiceWorkerResourceRecordPtr From(const U& u) { return mojo::TypeConverter<ServiceWorkerResourceRecordPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, ServiceWorkerResourceRecord>::Convert(*this); }
    ...
    ServiceWorkerResourceRecord(int64_t resource_id_in, const ::GURL& url_in, int64_t size_bytes_in)
    ...
    template <typename T, ServiceWorkerResourceRecord::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
    ...
    {
        return mojo::Message(
            std::make_unique<internal::ServiceWorkerResourceRecord_UnserializedMessageContext<UserType, ServiceWorkerResourceRecord::DataView>>(0, 0, std::move(input)),
            MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const std::vector<uint8_t>& input, UserType* output)
    {
        return ServiceWorkerResourceRecord::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }

    template <typename UserType> static bool DeserializeFromMessage(mojo::Message input, UserType* output)
    {
        auto context = input.TakeUnserializedContext<internal::ServiceWorkerResourceRecord_UnserializedMessageContext<UserType, ServiceWorkerResourceRecord::DataView>>();
        if (context) {
            *output = std::move(context->TakeData());
            return true;
        }
...
template <typename T, ServiceWorkerResourceRecord::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, ServiceWorkerResourceRecord::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, ServiceWorkerResourceRecord::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
template <typename StructPtrType> ServiceWorkerRegistrationDataPtr ServiceWorkerRegistrationData::Clone() const
{
    return New(mojo::Clone(registration_id), mojo::Clone(scope), mojo::Clone(key), mojo::Clone(script), mojo::Clone(script_type), mojo::Clone(update_via_cache),
        ...
        mojo::Clone(cross_origin_embedder_policy), mojo::Clone(policy_container_policies), mojo::Clone(ancestor_frame_type));
}
...
{
    return New(mojo::Clone(resource_id), mojo::Clone(url), mojo::Clone(size_bytes));
}
...
template <> struct StructTraits<::storage::mojom::ServiceWorkerRegistrationData::DataView, ::storage::mojom::ServiceWorkerRegistrationDataPtr> {
    ...
    static decltype(::storage::mojom::ServiceWorkerRegistrationData::registration_id) registration_id(const ::storage::mojom::ServiceWorkerRegistrationDataPtr& input)
    {
        return input->registration_id;
    }

    static const decltype(::storage::mojom::ServiceWorkerRegistrationData::scope)& scope(const ::storage::mojom::ServiceWorkerRegistrationDataPtr& input) { return input->scope; }

    static const decltype(::storage::mojom::ServiceWorkerRegistrationData::key)& key(const ::storage::mojom::ServiceWorkerRegistrationDataPtr& input) { return input->key; }
    ...
    static decltype(::storage::mojom::ServiceWorkerRegistrationData::update_via_cache) update_via_cache(const ::storage::mojom::ServiceWorkerRegistrationDataPtr& input)
    {
    ...
    static decltype(::storage::mojom::ServiceWorkerRegistrationData::fetch_handler_type) fetch_handler_type(const ::storage::mojom::ServiceWorkerRegistrationDataPtr& input)
    {
        return input->fetch_handler_type;
    }

    static const decltype(::storage::mojom::ServiceWorkerRegistrationData::last_update_check)& last_update_check(const ::storage::mojom::ServiceWorkerRegistrationDataPtr& input)
    {
    ...
    static const decltype(::storage::mojom::ServiceWorkerRegistrationData::used_features)& used_features(const ::storage::mojom::ServiceWorkerRegistrationDataPtr& input)
    {
    ...
    static decltype(::storage::mojom::ServiceWorkerRegistrationData::ancestor_frame_type) ancestor_frame_type(const ::storage::mojom::ServiceWorkerRegistrationDataPtr& input)
    {
...
template <> struct StructTraits<::storage::mojom::ServiceWorkerResourceRecord::DataView, ::storage::mojom::ServiceWorkerResourceRecordPtr> {
    ...
    static const decltype(::storage::mojom::ServiceWorkerResourceRecord::url)& url(const ::storage::mojom::ServiceWorkerResourceRecordPtr& input) { return input->url; }
