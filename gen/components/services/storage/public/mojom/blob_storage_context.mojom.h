...
// with not having this data in traces there.
    ...
    virtual void WriteBlobToFile(::mojo::PendingRemote<::blink::mojom::Blob> blob, const ::base::FilePath& path, bool flush_on_write, absl::optional<::base::Time> last_modified,
...
//
//   void WriteBlobToFile(::mojo::PendingRemote<::blink::mojom::Blob> blob, const ::base::FilePath& path, bool flush_on_write, absl::optional<::base::Time> last_modified,
//   WriteBlobToFileCallback callback) final;
//
//  private:
//   mojo::MessageReceiverWithResponder* receiver_;
// };
...
public:
    ...
    template <typename... Args> static BlobDataItemPtr New(Args&&... args) { return BlobDataItemPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static BlobDataItemPtr From(const U& u) { return mojo::TypeConverter<BlobDataItemPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, BlobDataItem>::Convert(*this); }
    BlobDataItem()
        : type()
        , size()
        , side_data_size()
    ...
    BlobDataItem(BlobDataItemType type_in, uint64_t size_in, uint64_t side_data_size_in, const std::string& content_type_in, ::mojo::PendingRemote<BlobDataItemReader> reader_in)
    ...
    template <typename T, BlobDataItem::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<BlobDataItem::DataView>(input); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::BlobDataItem_UnserializedMessageContext<UserType, BlobDataItem::DataView>>(0, 0, std::move(input)), MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    {
        return BlobDataItem::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, BlobDataItem::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, BlobDataItem::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, BlobDataItem::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
template <> struct StructTraits<::storage::mojom::BlobDataItem::DataView, ::storage::mojom::BlobDataItemPtr> {
    ...
    static decltype(::storage::mojom::BlobDataItem::type) type(const ::storage::mojom::BlobDataItemPtr& input) { return input->type; }

    static decltype(::storage::mojom::BlobDataItem::size) size(const ::storage::mojom::BlobDataItemPtr& input) { return input->size; }

    static decltype(::storage::mojom::BlobDataItem::side_data_size) side_data_size(const ::storage::mojom::BlobDataItemPtr& input) { return input->side_data_size; }

    static const decltype(::storage::mojom::BlobDataItem::content_type)& content_type(const ::storage::mojom::BlobDataItemPtr& input) { return input->content_type; }

    static decltype(::storage::mojom::BlobDataItem::reader)& reader(::storage::mojom::BlobDataItemPtr& input) { return input->reader; }
