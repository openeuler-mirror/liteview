...
// with not having this data in traces there.
    ...
    virtual void StoreRegistration(::storage::mojom::ServiceWorkerRegistrationDataPtr registration, std::vector<::storage::mojom::ServiceWorkerResourceRecordPtr> resources,
    ...
    virtual void UpdateLastUpdateCheckTime(int64_t registration_id, const ::blink::StorageKey& key, ::base::Time last_update_check_time, UpdateLastUpdateCheckTimeCallback callback)
        = 0;
    ...
    virtual void UpdateNavigationPreloadHeader(int64_t registration_id, const ::blink::StorageKey& key, const std::string& value, UpdateNavigationPreloadHeaderCallback callback)
        = 0;
...
//
//   void StoreRegistration(::storage::mojom::ServiceWorkerRegistrationDataPtr registration, std::vector<::storage::mojom::ServiceWorkerResourceRecordPtr> resources,
//   StoreRegistrationCallback callback) final;
//
...
//
//   void UpdateFetchHandlerType(int64_t registration_id, const ::blink::StorageKey& key, ::blink::mojom::ServiceWorkerFetchHandlerType type, UpdateFetchHandlerTypeCallback
//   callback) final;
//
...
public:
    ...
    template <typename... Args> static ServiceWorkerUserDataPtr New(Args&&... args) { return ServiceWorkerUserDataPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static ServiceWorkerUserDataPtr From(const U& u) { return mojo::TypeConverter<ServiceWorkerUserDataPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, ServiceWorkerUserData>::Convert(*this); }
    ...
    ServiceWorkerUserData(int64_t registration_id_in, const std::string& key_in, const std::string& value_in)
        : registration_id(std::move(registration_id_in))
        , key(std::move(key_in))
        , value(std::move(value_in)) {};
    ~ServiceWorkerUserData() = default;
    ...
    template <typename T, ServiceWorkerUserData::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    ...
    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<ServiceWorkerUserData::DataView>(input); }
    ...
    {
        return mojo::Message(std::make_unique<internal::ServiceWorkerUserData_UnserializedMessageContext<UserType, ServiceWorkerUserData::DataView>>(0, 0, std::move(input)),
    ...
    {
        return ServiceWorkerUserData::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, ServiceWorkerUserData::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, ServiceWorkerUserData::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, ServiceWorkerUserData::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static ServiceWorkerLiveVersionInfoPtr New(Args&&... args) { return ServiceWorkerLiveVersionInfoPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static ServiceWorkerLiveVersionInfoPtr From(const U& u) { return mojo::TypeConverter<ServiceWorkerLiveVersionInfoPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, ServiceWorkerLiveVersionInfo>::Convert(*this); }
    ...
    ServiceWorkerLiveVersionInfo(int64_t id_in, std::vector<int64_t> purgeable_resources_in, ::mojo::PendingReceiver<ServiceWorkerLiveVersionRef> reference_in)
        : id(std::move(id_in))
    ...
    ~ServiceWorkerLiveVersionInfo() = default;
    ...
    template <typename T, ServiceWorkerLiveVersionInfo::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::ServiceWorkerLiveVersionInfo_UnserializedMessageContext<UserType, ServiceWorkerLiveVersionInfo::DataView>>(0, 0, std::move(input)),
            MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const std::vector<uint8_t>& input, UserType* output)
    {
        return ServiceWorkerLiveVersionInfo::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }

    template <typename UserType> static bool DeserializeFromMessage(mojo::Message input, UserType* output)
    {
        auto context = input.TakeUnserializedContext<internal::ServiceWorkerLiveVersionInfo_UnserializedMessageContext<UserType, ServiceWorkerLiveVersionInfo::DataView>>();
        if (context) {
            *output = std::move(context->TakeData());
            return true;
        }
...
template <typename T, ServiceWorkerLiveVersionInfo::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, ServiceWorkerLiveVersionInfo::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, ServiceWorkerLiveVersionInfo::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    {
        return ServiceWorkerFindRegistrationResultPtr(absl::in_place, std::forward<Args>(args)...);
    }

    template <typename U> static ServiceWorkerFindRegistrationResultPtr From(const U& u) { return mojo::TypeConverter<ServiceWorkerFindRegistrationResultPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, ServiceWorkerFindRegistrationResult>::Convert(*this); }
    ...
    ServiceWorkerFindRegistrationResult(::mojo::PendingRemote<ServiceWorkerLiveVersionRef> version_reference_in, ::storage::mojom::ServiceWorkerRegistrationDataPtr registration_in,
    ...
    ~ServiceWorkerFindRegistrationResult() = default;
    ...
    template <typename T, ServiceWorkerFindRegistrationResult::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    ...
    template <typename UserType> static mojo::Message WrapAsMessage(UserType input)
    {
        return mojo::Message(std::make_unique<internal::ServiceWorkerFindRegistrationResult_UnserializedMessageContext<UserType, ServiceWorkerFindRegistrationResult::DataView>>(
                                 0, 0, std::move(input)),
            MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const std::vector<uint8_t>& input, UserType* output)
    {
        return ServiceWorkerFindRegistrationResult::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }

    template <typename UserType> static bool DeserializeFromMessage(mojo::Message input, UserType* output)
    {
        auto context
            = input.TakeUnserializedContext<internal::ServiceWorkerFindRegistrationResult_UnserializedMessageContext<UserType, ServiceWorkerFindRegistrationResult::DataView>>();
        if (context) {
            *output = std::move(context->TakeData());
            return true;
        }
        input.SerializeIfNecessary();
        return mojo::internal::DeserializeImpl<ServiceWorkerFindRegistrationResult::DataView>(input, input.payload(), input.payload_num_bytes(), output, Validate);
    }
...
template <typename T, ServiceWorkerFindRegistrationResult::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, ServiceWorkerFindRegistrationResult::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, ServiceWorkerFindRegistrationResult::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
template <typename StructPtrType> ServiceWorkerUserDataPtr ServiceWorkerUserData::Clone() const { return New(mojo::Clone(registration_id), mojo::Clone(key), mojo::Clone(value)); }
...
template <> struct StructTraits<::storage::mojom::ServiceWorkerLiveVersionInfo::DataView, ::storage::mojom::ServiceWorkerLiveVersionInfoPtr> {
    ...
    static decltype(::storage::mojom::ServiceWorkerLiveVersionInfo::id) id(const ::storage::mojom::ServiceWorkerLiveVersionInfoPtr& input) { return input->id; }

    static const decltype(::storage::mojom::ServiceWorkerLiveVersionInfo::purgeable_resources)& purgeable_resources(const ::storage::mojom::ServiceWorkerLiveVersionInfoPtr& input)
    {
        return input->purgeable_resources;
    }

    static decltype(::storage::mojom::ServiceWorkerLiveVersionInfo::reference)& reference(::storage::mojom::ServiceWorkerLiveVersionInfoPtr& input) { return input->reference; }
...
template <> struct StructTraits<::storage::mojom::ServiceWorkerFindRegistrationResult::DataView, ::storage::mojom::ServiceWorkerFindRegistrationResultPtr> {
    ...
    static decltype(::storage::mojom::ServiceWorkerFindRegistrationResult::version_reference)& version_reference(::storage::mojom::ServiceWorkerFindRegistrationResultPtr& input)
    {
        return input->version_reference;
    }

    static const decltype(::storage::mojom::ServiceWorkerFindRegistrationResult::registration)& registration(const ::storage::mojom::ServiceWorkerFindRegistrationResultPtr& input)
    {
        return input->registration;
    }

    static const decltype(::storage::mojom::ServiceWorkerFindRegistrationResult::resources)& resources(const ::storage::mojom::ServiceWorkerFindRegistrationResultPtr& input)
    {
...
template <> struct StructTraits<::storage::mojom::ServiceWorkerUserData::DataView, ::storage::mojom::ServiceWorkerUserDataPtr> {
    ...
    static const decltype(::storage::mojom::ServiceWorkerUserData::key)& key(const ::storage::mojom::ServiceWorkerUserDataPtr& input) { return input->key; }

    static const decltype(::storage::mojom::ServiceWorkerUserData::value)& value(const ::storage::mojom::ServiceWorkerUserDataPtr& input) { return input->value; }
