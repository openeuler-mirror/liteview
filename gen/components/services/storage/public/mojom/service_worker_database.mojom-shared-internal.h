...
template <typename UserType, typename DataView> struct ServiceWorkerRegistrationData_UnserializedMessageContext : public mojo::internal::UnserializedMessageContext {
public:
...
static_assert(sizeof(ServiceWorkerResourceRecord_Data) == 32, "Bad sizeof(ServiceWorkerResourceRecord_Data)");
// Used by ServiceWorkerResourceRecord::WrapAsMessage to lazily serialize the struct.
template <typename UserType, typename DataView> struct ServiceWorkerResourceRecord_UnserializedMessageContext : public mojo::internal::UnserializedMessageContext {
public:
    static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;
