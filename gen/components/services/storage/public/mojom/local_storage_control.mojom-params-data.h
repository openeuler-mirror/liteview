...
static_assert(sizeof(LocalStorageControl_Flush_ResponseParams_Data) == 8, "Bad sizeof(LocalStorageControl_Flush_ResponseParams_Data)");
...
public:
    ...
    LocalStorageControl_Flush_ResponseParamsDataView(internal::LocalStorageControl_Flush_ResponseParams_Data* data, mojo::Message* message)
        : data_(data)
    {
    }
...
inline void LocalStorageControl_ApplyPolicyUpdates_ParamsDataView::GetPolicyUpdatesDataView(mojo::ArrayDataView<::storage::mojom::StoragePolicyUpdateDataView>* output)
{
    auto pointer = data_->policy_updates.Get();
