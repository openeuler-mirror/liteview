...
class CacheStorageControlInterceptorForTesting : public CacheStorageControl {
    ...
    void AddReceiver(const ::network::CrossOriginEmbedderPolicy& policy, ::mojo::PendingRemote<::network::mojom::CrossOriginEmbedderPolicyReporter> coep_reporter,
        const ::storage::BucketLocator& bucket_locator, CacheStorageOwner owner, ::mojo::PendingReceiver<::blink::mojom::CacheStorage> receiver) override;
...
public:
    ...
    void GetAllStorageKeysInfo(std::vector<::storage::mojom::StorageUsageInfoPtr>* out_usage_info);
    std::vector<::storage::mojom::StorageUsageInfoPtr> GetAllStorageKeysInfo();
