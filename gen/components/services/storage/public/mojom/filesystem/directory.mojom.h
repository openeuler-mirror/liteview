...
public:
    ...
    static inline constexpr uint32_t kSyncMethodOrdinals[] = { 1647586929 };
...
public:
    ...
    static inline constexpr uint32_t kSyncMethodOrdinals[]
        = { 88609655, 120203891, 261415012, 290536073, 384811462, 574167623, 873549981, 1030236798, 1091643418, 1142588656, 1191366411, 1382751235, 1744974625 };
    static constexpr bool HasUninterruptableMethods_ = false;
...
// with not having this data in traces there.
    ...
    struct SetOpenedFileLength_Sym {
        NOINLINE static uint32_t IPCStableHash();
    };
#endif // !BUILDFLAG(IS_FUCHSIA)
...
public:
    ...
    bool OpenFile(
        const ::base::FilePath& path, FileOpenMode mode, FileReadAccess read_access, FileWriteAccess write_access, ::base::File::Error* out_error, ::base::File* out_file) final;
...
public:
    ...
    template <typename... Args> static PathAccessInfoPtr New(Args&&... args) { return PathAccessInfoPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static PathAccessInfoPtr From(const U& u) { return mojo::TypeConverter<PathAccessInfoPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, PathAccessInfo>::Convert(*this); }
    PathAccessInfo();
    ...
    template <typename T, PathAccessInfo::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    ...
    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<PathAccessInfo::DataView>(input); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::PathAccessInfo_UnserializedMessageContext<UserType, PathAccessInfo::DataView>>(0, 0, std::move(input)), MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    {
        return PathAccessInfo::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, PathAccessInfo::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, PathAccessInfo::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, PathAccessInfo::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static StrictRelativePathPtr New(Args&&... args) { return StrictRelativePathPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static StrictRelativePathPtr From(const U& u) { return mojo::TypeConverter<StrictRelativePathPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, StrictRelativePath>::Convert(*this); }
    StrictRelativePath();
    ...
    template <typename T, StrictRelativePath::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<StrictRelativePath::DataView, std::vector<uint8_t>>(input);
    }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<StrictRelativePath::DataView>(input); }
    ...
    template <typename UserType> static mojo::Message WrapAsMessage(UserType input)
    {
        return mojo::Message(std::make_unique<internal::StrictRelativePath_UnserializedMessageContext<UserType, StrictRelativePath::DataView>>(0, 0, std::move(input)),
    ...
    template <typename UserType> static bool Deserialize(const std::vector<uint8_t>& input, UserType* output)
    {
        return StrictRelativePath::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, StrictRelativePath::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, StrictRelativePath::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, StrictRelativePath::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
template <typename StructPtrType> StrictRelativePathPtr StrictRelativePath::Clone() const { return New(mojo::Clone(path)); }
...
template <typename StructPtrType> PathAccessInfoPtr PathAccessInfo::Clone() const { return New(mojo::Clone(can_read), mojo::Clone(can_write)); }
...
namespace mojo {
template <> struct COMPONENT_EXPORT(STORAGE_SERVICE_FILESYSTEM_MOJOM) StructTraits<::storage::mojom::StrictRelativePath::DataView, ::storage::mojom::StrictRelativePathPtr> {
    ...
    static const decltype(::storage::mojom::StrictRelativePath::path)& path(const ::storage::mojom::StrictRelativePathPtr& input) { return input->path; }

    static bool Read(::storage::mojom::StrictRelativePath::DataView input, ::storage::mojom::StrictRelativePathPtr* output);
};
template <> struct COMPONENT_EXPORT(STORAGE_SERVICE_FILESYSTEM_MOJOM) StructTraits<::storage::mojom::PathAccessInfo::DataView, ::storage::mojom::PathAccessInfoPtr> {
    ...
    static decltype(::storage::mojom::PathAccessInfo::can_read) can_read(const ::storage::mojom::PathAccessInfoPtr& input) { return input->can_read; }

    static decltype(::storage::mojom::PathAccessInfo::can_write) can_write(const ::storage::mojom::PathAccessInfoPtr& input) { return input->can_write; }
