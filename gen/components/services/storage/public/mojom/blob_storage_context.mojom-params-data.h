...
public:
    ...
    bool is_null() const { return !data_; }
    int32_t success() const { return data_->success; }
...
public:
    ...
    bool flush_on_write() const { return data_->flush_on_write; }
...
public:
    ...
    WriteBlobToFileResult result() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::storage::mojom::WriteBlobToFileResult>(data_->result)); }
