...
public:
    ...
    template <typename... Args> static SessionStorageUsageInfoPtr New(Args&&... args) { return SessionStorageUsageInfoPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static SessionStorageUsageInfoPtr From(const U& u) { return mojo::TypeConverter<SessionStorageUsageInfoPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, SessionStorageUsageInfo>::Convert(*this); }
    ...
    SessionStorageUsageInfo(const ::blink::StorageKey& storage_key_in, const std::string& namespace_id_in)
        : storage_key(std::move(storage_key_in))
        , namespace_id(std::move(namespace_id_in)) {};
    ~SessionStorageUsageInfo() = default;
    ...
    template <typename T, SessionStorageUsageInfo::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    ...
    {
        return mojo::Message(std::make_unique<internal::SessionStorageUsageInfo_UnserializedMessageContext<UserType, SessionStorageUsageInfo::DataView>>(0, 0, std::move(input)),
    ...
    {
        return SessionStorageUsageInfo::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }

    template <typename UserType> static bool DeserializeFromMessage(mojo::Message input, UserType* output)
    {
        auto context = input.TakeUnserializedContext<internal::SessionStorageUsageInfo_UnserializedMessageContext<UserType, SessionStorageUsageInfo::DataView>>();
        if (context) {
...
template <typename T, SessionStorageUsageInfo::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, SessionStorageUsageInfo::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, SessionStorageUsageInfo::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }

template <typename StructPtrType> SessionStorageUsageInfoPtr SessionStorageUsageInfo::Clone() const { return New(mojo::Clone(storage_key), mojo::Clone(namespace_id)); }
