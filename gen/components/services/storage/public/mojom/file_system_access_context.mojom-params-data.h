...
static_assert(sizeof(FileSystemAccessContext_SerializeHandle_ResponseParams_Data) == 16, "Bad sizeof(FileSystemAccessContext_SerializeHandle_ResponseParams_Data)");
...
public:
    ...
    FileSystemAccessContext_SerializeHandle_ResponseParamsDataView(internal::FileSystemAccessContext_SerializeHandle_ResponseParams_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
