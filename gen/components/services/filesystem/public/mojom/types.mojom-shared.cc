...
std::ostream& operator<<(std::ostream& os, Whence value) { return os << WhenceToString(value); }
...
std::ostream& operator<<(std::ostream& os, FsFileType value) { return os << FsFileTypeToString(value); }
