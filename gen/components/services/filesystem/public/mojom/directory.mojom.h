...
public:
    ...
    FileOpenDetails(const std::string& path_in, uint32_t open_flags_in)
...
public:
    ...
    FileOpenResult(const std::string& path_in, ::base::File::Error error_in, ::base::File file_handle_in)
        : path(std::move(path_in))
...
template <> struct StructTraits<::filesystem::mojom::FileOpenDetails::DataView, ::filesystem::mojom::FileOpenDetailsPtr> {
    ...
    static const decltype(::filesystem::mojom::FileOpenDetails::path)& path(const ::filesystem::mojom::FileOpenDetailsPtr& input) { return input->path; }

    static decltype(::filesystem::mojom::FileOpenDetails::open_flags) open_flags(const ::filesystem::mojom::FileOpenDetailsPtr& input) { return input->open_flags; }
...
template <> struct StructTraits<::filesystem::mojom::FileOpenResult::DataView, ::filesystem::mojom::FileOpenResultPtr> {
    ...
    static const decltype(::filesystem::mojom::FileOpenResult::path)& path(const ::filesystem::mojom::FileOpenResultPtr& input) { return input->path; }

    static decltype(::filesystem::mojom::FileOpenResult::error) error(const ::filesystem::mojom::FileOpenResultPtr& input) { return input->error; }

    static decltype(::filesystem::mojom::FileOpenResult::file_handle)& file_handle(::filesystem::mojom::FileOpenResultPtr& input) { return input->file_handle; }
