...
public:
    ...
    uint32_t open_flags() const { return data_->open_flags; }
...
public:
    ...
    {
        UserType result;
        bool ret = mojo::internal::Deserialize<mojo::InterfaceRequestDataView<::filesystem::mojom::DirectoryInterfaceBase>>(&data_->directory, &result, message_);
        DCHECK(ret);
        return result;
    }
    uint32_t open_flags() const { return data_->open_flags; }
...
public:
    ...
    uint32_t delete_flags() const { return data_->delete_flags; }
...
public:
    ...
    ::mojo_base::mojom::FileError error() const { return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::mojo_base::mojom::FileError>(data_->error)); }
    bool is_writable() const { return data_->is_writable; }
