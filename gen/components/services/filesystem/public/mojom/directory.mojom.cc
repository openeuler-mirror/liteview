...
public:
    Directory_Read_HandleSyncResponse(bool* result, ::base::File::Error* out_error, absl::optional<std::vector<::filesystem::mojom::DirectoryEntryPtr>>* out_directory_contents)
        : result_(result)
...
bool DirectoryProxy::Read(::base::File::Error* out_param_error, absl::optional<std::vector<::filesystem::mojom::DirectoryEntryPtr>>* out_param_directory_contents)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    ...
    TRACE_EVENT_END1("mojom", "Directory::Read", "sync_response_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("directory_contents"), out_param_directory_contents, "<value of type absl::optional<std::vector<::filesystem::mojom::DirectoryEntryPtr>>>");
    });
#endif
    return result;
}
...
bool DirectoryProxy::OpenFileHandle(const std::string& param_path, uint32_t param_open_flags, ::base::File::Error* out_param_error, ::base::File* out_param_file_handle)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void DirectoryProxy::OpenDirectory(const std::string& in_path, ::mojo::PendingReceiver<Directory> in_directory, uint32_t in_open_flags, OpenDirectoryCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
bool DirectoryProxy::StatFile(const std::string& param_path, ::base::File::Error* out_param_error, ::filesystem::mojom::FileInformationPtr* out_param_file_information)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    ...
    TRACE_EVENT_END1("mojom", "Directory::StatFile", "sync_response_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("error"), out_param_error, "<value of type ::base::File::Error>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("file_information"), out_param_file_information, "<value of type ::filesystem::mojom::FileInformationPtr>");
    });
#endif
    return result;
}
...
private:
    ...
    void Run(::base::File::Error in_error, absl::optional<std::vector<::filesystem::mojom::DirectoryEntryPtr>> in_directory_contents);
};
...
bool Directory_Read_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    absl::optional<std::vector<::filesystem::mojom::DirectoryEntryPtr>> p_directory_contents
        = mojo::DefaultConstructTraits::CreateInstance<absl::optional<std::vector<::filesystem::mojom::DirectoryEntryPtr>>>();
...
void Directory_Read_ProxyToResponder::Run(::base::File::Error in_error, absl::optional<std::vector<::filesystem::mojom::DirectoryEntryPtr>> in_directory_contents)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send reply filesystem::mojom::Directory::Read", "async_response_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("directory_contents"), in_directory_contents, "<value of type absl::optional<std::vector<::filesystem::mojom::DirectoryEntryPtr>>>");
    });
#endif
...
bool Directory_OpenFileHandles_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    bool success = true;
    std::vector<FileOpenResultPtr> p_results = mojo::DefaultConstructTraits::CreateInstance<std::vector<FileOpenResultPtr>>();
...
bool Directory_StatFile_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    bool success = true;
    ::base::File::Error p_error = mojo::DefaultConstructTraits::CreateInstance<::base::File::Error>();
    ::filesystem::mojom::FileInformationPtr p_file_information = mojo::DefaultConstructTraits::CreateInstance<::filesystem::mojom::FileInformationPtr>();
...
void Directory_StatFile_ProxyToResponder::Run(::base::File::Error in_error, ::filesystem::mojom::FileInformationPtr in_file_information)
{
    ...
    TRACE_EVENT1("mojom", "Send reply filesystem::mojom::Directory::StatFile", "async_response_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("error"), in_error, "<value of type ::base::File::Error>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("file_information"), in_file_information, "<value of type ::filesystem::mojom::FileInformationPtr>");
    });
#endif
...
bool DirectoryStubDispatch::AcceptWithResponder(Directory* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
{
    ...
    case internal::kDirectory_OpenFileHandle_Name: {
        ...
        bool success = true;
        std::string p_path = mojo::DefaultConstructTraits::CreateInstance<std::string>();
    ...
    case internal::kDirectory_OpenFileHandles_Name: {
        ...
        bool success = true;
        std::vector<FileOpenDetailsPtr> p_files = mojo::DefaultConstructTraits::CreateInstance<std::vector<FileOpenDetailsPtr>>();
    ...
    case internal::kDirectory_Rename_Name: {
        ...
        bool success = true;
        std::string p_path = mojo::DefaultConstructTraits::CreateInstance<std::string>();
        std::string p_new_path = mojo::DefaultConstructTraits::CreateInstance<std::string>();
...
void DirectoryInterceptorForTesting::Exists(const std::string& path, ExistsCallback callback) { GetForwardingInterface()->Exists(std::move(path), std::move(callback)); }
...
void DirectoryInterceptorForTesting::StatFile(const std::string& path, StatFileCallback callback) { GetForwardingInterface()->StatFile(std::move(path), std::move(callback)); }
...
void DirectoryAsyncWaiter::Read(::base::File::Error* out_error, absl::optional<std::vector<::filesystem::mojom::DirectoryEntryPtr>>* out_directory_contents)
{
    base::RunLoop loop;
    proxy_->Read(base::BindOnce(
        [](base::RunLoop* loop, ::base::File::Error* out_error, absl::optional<std::vector<::filesystem::mojom::DirectoryEntryPtr>>* out_directory_contents,
            ::base::File::Error error, absl::optional<std::vector<::filesystem::mojom::DirectoryEntryPtr>> directory_contents) {
...
{
    std::vector<FileOpenResultPtr> async_wait_result = mojo::DefaultConstructTraits::CreateInstance<std::vector<FileOpenResultPtr>>();
    OpenFileHandles(std::move(files), &async_wait_result);
    return async_wait_result;
}

void DirectoryAsyncWaiter::OpenDirectory(const std::string& path, ::mojo::PendingReceiver<Directory> directory, uint32_t open_flags, ::base::File::Error* out_error)
{
    base::RunLoop loop;
...
void DirectoryAsyncWaiter::ReadEntireFile(const std::string& path, ::base::File::Error* out_error, std::vector<uint8_t>* out_data)
{
    ...
    proxy_->ReadEntireFile(std::move(path),
        base::BindOnce(
            [](base::RunLoop* loop, ::base::File::Error* out_error, std::vector<uint8_t>* out_data, ::base::File::Error error, const std::vector<uint8_t>& data) {
                *out_error = std::move(error);
