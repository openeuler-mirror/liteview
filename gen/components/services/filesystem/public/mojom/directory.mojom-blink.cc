...
bool FileOpenDetails::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
bool FileOpenResult::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
bool DirectoryProxy::Read(::base::File::Error* out_param_error, absl::optional<WTF::Vector<::filesystem::mojom::blink::DirectoryEntryPtr>>* out_param_directory_contents)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    ...
    mojo::Message message(internal::kDirectory_Read_Name, kFlags, 0, 0, nullptr);
    ...
    TRACE_EVENT_END1("mojom", "Directory::Read", "sync_response_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("directory_contents"), out_param_directory_contents, "<value of type absl::optional<WTF::Vector<::filesystem::mojom::blink::DirectoryEntryPtr>>>");
    });
#endif
    return result;
}
...
bool DirectoryProxy::OpenFileHandle(const WTF::String& param_path, uint32_t param_open_flags, ::base::File::Error* out_param_error, ::base::File* out_param_file_handle)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    ...
    mojo::Message message(internal::kDirectory_OpenFileHandle_Name, kFlags, 0, 0, nullptr);
    ...
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(params->path.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null path in Directory.OpenFileHandle request");
...
bool DirectoryProxy::OpenFileHandles(WTF::Vector<FileOpenDetailsPtr> param_files, WTF::Vector<FileOpenResultPtr>* out_param_results)
{
    ...
    mojo::Message message(internal::kDirectory_OpenFileHandles_Name, kFlags, 0, 0, nullptr);
    ...
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(params->files.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null files in Directory.OpenFileHandles request");
    ...
    const WTF::String& param_path, ::mojo::PendingReceiver<Directory> param_directory, uint32_t param_open_flags, ::base::File::Error* out_param_error)
{
    ...
    mojo::Message message(internal::kDirectory_OpenDirectory_Name, kFlags, 0, 0, nullptr);
    mojo::internal::MessageFragment<::filesystem::mojom::internal::Directory_OpenDirectory_Params_Data> params(message);
    params.Allocate();
    mojo::internal::MessageFragment<typename decltype(params->path)::BaseType> path_fragment(params.message());
    mojo::internal::Serialize<mojo::StringDataView>(param_path, path_fragment);
    params->path.Set(path_fragment.is_null() ? nullptr : path_fragment.data());
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(params->path.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null path in Directory.OpenDirectory request");
    mojo::internal::Serialize<mojo::InterfaceRequestDataView<::filesystem::mojom::DirectoryInterfaceBase>>(param_directory, &params->directory, &params.message());
    params->open_flags = param_open_flags;
...
void DirectoryProxy::OpenDirectory(const WTF::String& in_path, ::mojo::PendingReceiver<Directory> in_directory, uint32_t in_open_flags, OpenDirectoryCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
bool DirectoryProxy::Rename(const WTF::String& param_path, const WTF::String& param_new_path, ::base::File::Error* out_param_error)
{
    ...
    mojo::Message message(internal::kDirectory_Rename_Name, kFlags, 0, 0, nullptr);
    mojo::internal::MessageFragment<::filesystem::mojom::internal::Directory_Rename_Params_Data> params(message);
    params.Allocate();
    mojo::internal::MessageFragment<typename decltype(params->path)::BaseType> path_fragment(params.message());
    mojo::internal::Serialize<mojo::StringDataView>(param_path, path_fragment);
    params->path.Set(path_fragment.is_null() ? nullptr : path_fragment.data());
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(params->path.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null path in Directory.Rename request");
    ...
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(params->new_path.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null new_path in Directory.Rename request");
...
bool DirectoryProxy::Replace(const WTF::String& param_path, const WTF::String& param_new_path, ::base::File::Error* out_param_error)
{
    ...
    mojo::Message message(internal::kDirectory_Replace_Name, kFlags, 0, 0, nullptr);
    mojo::internal::MessageFragment<::filesystem::mojom::internal::Directory_Replace_Params_Data> params(message);
    params.Allocate();
    mojo::internal::MessageFragment<typename decltype(params->path)::BaseType> path_fragment(params.message());
    mojo::internal::Serialize<mojo::StringDataView>(param_path, path_fragment);
    params->path.Set(path_fragment.is_null() ? nullptr : path_fragment.data());
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(params->path.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null path in Directory.Replace request");
    mojo::internal::MessageFragment<typename decltype(params->new_path)::BaseType> new_path_fragment(params.message());
    mojo::internal::Serialize<mojo::StringDataView>(param_new_path, new_path_fragment);
    params->new_path.Set(new_path_fragment.is_null() ? nullptr : new_path_fragment.data());
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(params->new_path.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null new_path in Directory.Replace request");
...
bool DirectoryProxy::Delete(const WTF::String& param_path, uint32_t param_delete_flags, ::base::File::Error* out_param_error)
{
    ...
    mojo::Message message(internal::kDirectory_Delete_Name, kFlags, 0, 0, nullptr);
    mojo::internal::MessageFragment<::filesystem::mojom::internal::Directory_Delete_Params_Data> params(message);
    params.Allocate();
    mojo::internal::MessageFragment<typename decltype(params->path)::BaseType> path_fragment(params.message());
    mojo::internal::Serialize<mojo::StringDataView>(param_path, path_fragment);
    params->path.Set(path_fragment.is_null() ? nullptr : path_fragment.data());
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(params->path.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null path in Directory.Delete request");
...
bool DirectoryProxy::Exists(const WTF::String& param_path, ::base::File::Error* out_param_error, bool* out_param_exists)
{
    ...
    mojo::Message message(internal::kDirectory_Exists_Name, kFlags, 0, 0, nullptr);
    mojo::internal::MessageFragment<::filesystem::mojom::internal::Directory_Exists_Params_Data> params(message);
    params.Allocate();
    mojo::internal::MessageFragment<typename decltype(params->path)::BaseType> path_fragment(params.message());
    mojo::internal::Serialize<mojo::StringDataView>(param_path, path_fragment);
    params->path.Set(path_fragment.is_null() ? nullptr : path_fragment.data());
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(params->path.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null path in Directory.Exists request");
...
bool DirectoryProxy::IsWritable(const WTF::String& param_path, ::base::File::Error* out_param_error, bool* out_param_is_writable)
{
    ...
    mojo::Message message(internal::kDirectory_IsWritable_Name, kFlags, 0, 0, nullptr);
    mojo::internal::MessageFragment<::filesystem::mojom::internal::Directory_IsWritable_Params_Data> params(message);
    params.Allocate();
    mojo::internal::MessageFragment<typename decltype(params->path)::BaseType> path_fragment(params.message());
    mojo::internal::Serialize<mojo::StringDataView>(param_path, path_fragment);
    params->path.Set(path_fragment.is_null() ? nullptr : path_fragment.data());
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(params->path.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null path in Directory.IsWritable request");
...
bool DirectoryProxy::Flush(::base::File::Error* out_param_error)
{
    ...
    mojo::Message message(internal::kDirectory_Flush_Name, kFlags, 0, 0, nullptr);
...
bool DirectoryProxy::StatFile(const WTF::String& param_path, ::base::File::Error* out_param_error, ::filesystem::mojom::blink::FileInformationPtr* out_param_file_information)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    ...
    mojo::Message message(internal::kDirectory_StatFile_Name, kFlags, 0, 0, nullptr);
    mojo::internal::MessageFragment<::filesystem::mojom::internal::Directory_StatFile_Params_Data> params(message);
    params.Allocate();
    mojo::internal::MessageFragment<typename decltype(params->path)::BaseType> path_fragment(params.message());
    mojo::internal::Serialize<mojo::StringDataView>(param_path, path_fragment);
    params->path.Set(path_fragment.is_null() ? nullptr : path_fragment.data());
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(params->path.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null path in Directory.StatFile request");
    ...
    TRACE_EVENT_END1("mojom", "Directory::StatFile", "sync_response_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("error"), out_param_error, "<value of type ::base::File::Error>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("file_information"), out_param_file_information, "<value of type ::filesystem::mojom::blink::FileInformationPtr>");
    });
#endif
    return result;
}
...
void DirectoryProxy::Clone(::mojo::PendingReceiver<Directory> in_directory)
{
    ...
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
        !mojo::internal::IsHandleOrInterfaceValid(params->directory), mojo::internal::VALIDATION_ERROR_UNEXPECTED_INVALID_HANDLE, "invalid directory in Directory.Clone request");
...
bool DirectoryProxy::ReadEntireFile(const WTF::String& param_path, ::base::File::Error* out_param_error, WTF::Vector<uint8_t>* out_param_data)
{
    ...
    mojo::Message message(internal::kDirectory_ReadEntireFile_Name, kFlags, 0, 0, nullptr);
    mojo::internal::MessageFragment<::filesystem::mojom::internal::Directory_ReadEntireFile_Params_Data> params(message);
    params.Allocate();
    mojo::internal::MessageFragment<typename decltype(params->path)::BaseType> path_fragment(params.message());
    mojo::internal::Serialize<mojo::StringDataView>(param_path, path_fragment);
    params->path.Set(path_fragment.is_null() ? nullptr : path_fragment.data());
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(params->path.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null path in Directory.ReadEntireFile request");
...
bool DirectoryProxy::WriteFile(const WTF::String& param_path, const WTF::Vector<uint8_t>& param_data, ::base::File::Error* out_param_error)
{
    ...
    mojo::Message message(internal::kDirectory_WriteFile_Name, kFlags, 0, 0, nullptr);
    mojo::internal::MessageFragment<::filesystem::mojom::internal::Directory_WriteFile_Params_Data> params(message);
    params.Allocate();
    mojo::internal::MessageFragment<typename decltype(params->path)::BaseType> path_fragment(params.message());
    mojo::internal::Serialize<mojo::StringDataView>(param_path, path_fragment);
    params->path.Set(path_fragment.is_null() ? nullptr : path_fragment.data());
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(params->path.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null path in Directory.WriteFile request");
    ...
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(params->data.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null data in Directory.WriteFile request");
...
private:
    ...
    void Run(::base::File::Error in_error, absl::optional<WTF::Vector<::filesystem::mojom::blink::DirectoryEntryPtr>> in_directory_contents);
};
...
bool Directory_Read_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    absl::optional<WTF::Vector<::filesystem::mojom::blink::DirectoryEntryPtr>> p_directory_contents
        = mojo::DefaultConstructTraits::CreateInstance<absl::optional<WTF::Vector<::filesystem::mojom::blink::DirectoryEntryPtr>>>();
...
void Directory_Read_ProxyToResponder::Run(::base::File::Error in_error, absl::optional<WTF::Vector<::filesystem::mojom::blink::DirectoryEntryPtr>> in_directory_contents)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send reply filesystem::mojom::Directory::Read", "async_response_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("directory_contents"), in_directory_contents, "<value of type absl::optional<WTF::Vector<::filesystem::mojom::blink::DirectoryEntryPtr>>>");
    });
#endif
    ...
    const mojo::internal::ContainerValidateParams directory_contents_validate_params(0, false, nullptr);
...
bool Directory_OpenFileHandle_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    DCHECK(message->is_serialized());
    internal::Directory_OpenFileHandle_ResponseParams_Data* params = reinterpret_cast<internal::Directory_OpenFileHandle_ResponseParams_Data*>(message->mutable_payload());

    bool success = true;
    ::base::File::Error p_error = mojo::DefaultConstructTraits::CreateInstance<::base::File::Error>();
    ::base::File p_file_handle = mojo::DefaultConstructTraits::CreateInstance<::base::File>();
...
bool Directory_OpenFileHandles_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    DCHECK(message->is_serialized());
    internal::Directory_OpenFileHandles_ResponseParams_Data* params = reinterpret_cast<internal::Directory_OpenFileHandles_ResponseParams_Data*>(message->mutable_payload());

    bool success = true;
    WTF::Vector<FileOpenResultPtr> p_results = mojo::DefaultConstructTraits::CreateInstance<WTF::Vector<FileOpenResultPtr>>();
...
bool Directory_OpenDirectory_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    DCHECK(message->is_serialized());
    internal::Directory_OpenDirectory_ResponseParams_Data* params = reinterpret_cast<internal::Directory_OpenDirectory_ResponseParams_Data*>(message->mutable_payload());
...
bool Directory_IsWritable_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    DCHECK(message->is_serialized());
    internal::Directory_IsWritable_ResponseParams_Data* params = reinterpret_cast<internal::Directory_IsWritable_ResponseParams_Data*>(message->mutable_payload());

    bool success = true;
    ::base::File::Error p_error = mojo::DefaultConstructTraits::CreateInstance<::base::File::Error>();
    bool p_is_writable = mojo::DefaultConstructTraits::CreateInstance<bool>();
...
bool Directory_StatFile_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    bool success = true;
    ::base::File::Error p_error = mojo::DefaultConstructTraits::CreateInstance<::base::File::Error>();
    ::filesystem::mojom::blink::FileInformationPtr p_file_information = mojo::DefaultConstructTraits::CreateInstance<::filesystem::mojom::blink::FileInformationPtr>();
...
void Directory_StatFile_ProxyToResponder::Run(::base::File::Error in_error, ::filesystem::mojom::blink::FileInformationPtr in_file_information)
{
    ...
    TRACE_EVENT1("mojom", "Send reply filesystem::mojom::Directory::StatFile", "async_response_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("error"), in_error, "<value of type ::base::File::Error>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("file_information"), in_file_information, "<value of type ::filesystem::mojom::blink::FileInformationPtr>");
    });
#endif
...
bool Directory_ReadEntireFile_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    DCHECK(message->is_serialized());
    internal::Directory_ReadEntireFile_ResponseParams_Data* params = reinterpret_cast<internal::Directory_ReadEntireFile_ResponseParams_Data*>(message->mutable_payload());
...
bool Directory_WriteFile_ForwardToCallback::Accept(mojo::Message* message)
{
    ...
    DCHECK(message->is_serialized());
    internal::Directory_WriteFile_ResponseParams_Data* params = reinterpret_cast<internal::Directory_WriteFile_ResponseParams_Data*>(message->mutable_payload());
...
bool DirectoryStubDispatch::Accept(Directory* impl, mojo::Message* message)
{
    ...
    case internal::kDirectory_Clone_Name: {
        ...
        bool success = true;
        ::mojo::PendingReceiver<Directory> p_directory = mojo::DefaultConstructTraits::CreateInstance<::mojo::PendingReceiver<Directory>>();
...
bool DirectoryStubDispatch::AcceptWithResponder(Directory* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
{
    ...
    case internal::kDirectory_OpenFileHandle_Name: {
        ...
        bool success = true;
        WTF::String p_path = mojo::DefaultConstructTraits::CreateInstance<WTF::String>();
        uint32_t p_open_flags = mojo::DefaultConstructTraits::CreateInstance<uint32_t>();
    ...
    case internal::kDirectory_OpenFileHandles_Name: {
        ...
        internal::Directory_OpenFileHandles_Params_Data* params = reinterpret_cast<internal::Directory_OpenFileHandles_Params_Data*>(message->mutable_payload());

        bool success = true;
        WTF::Vector<FileOpenDetailsPtr> p_files = mojo::DefaultConstructTraits::CreateInstance<WTF::Vector<FileOpenDetailsPtr>>();
    ...
    case internal::kDirectory_Rename_Name: {
        ...
        bool success = true;
        WTF::String p_path = mojo::DefaultConstructTraits::CreateInstance<WTF::String>();
        WTF::String p_new_path = mojo::DefaultConstructTraits::CreateInstance<WTF::String>();
    ...
    case internal::kDirectory_Delete_Name: {
        ...
        bool success = true;
        WTF::String p_path = mojo::DefaultConstructTraits::CreateInstance<WTF::String>();
        uint32_t p_delete_flags = mojo::DefaultConstructTraits::CreateInstance<uint32_t>();
...
static const std::pair<uint32_t, mojo::internal::GenericValidationInfo> kDirectoryValidationInfo[] = {
    { internal::kDirectory_Read_Name, { &internal::Directory_Read_Params_Data::Validate, &internal::Directory_Read_ResponseParams_Data::Validate } },
    { internal::kDirectory_OpenFileHandle_Name, { &internal::Directory_OpenFileHandle_Params_Data::Validate, &internal::Directory_OpenFileHandle_ResponseParams_Data::Validate } },
    ...
    { internal::kDirectory_OpenDirectory_Name, { &internal::Directory_OpenDirectory_Params_Data::Validate, &internal::Directory_OpenDirectory_ResponseParams_Data::Validate } },
    { internal::kDirectory_Rename_Name, { &internal::Directory_Rename_Params_Data::Validate, &internal::Directory_Rename_ResponseParams_Data::Validate } },
    { internal::kDirectory_Replace_Name, { &internal::Directory_Replace_Params_Data::Validate, &internal::Directory_Replace_ResponseParams_Data::Validate } },
    { internal::kDirectory_Delete_Name, { &internal::Directory_Delete_Params_Data::Validate, &internal::Directory_Delete_ResponseParams_Data::Validate } },
    { internal::kDirectory_Exists_Name, { &internal::Directory_Exists_Params_Data::Validate, &internal::Directory_Exists_ResponseParams_Data::Validate } },
    { internal::kDirectory_IsWritable_Name, { &internal::Directory_IsWritable_Params_Data::Validate, &internal::Directory_IsWritable_ResponseParams_Data::Validate } },
    { internal::kDirectory_Flush_Name, { &internal::Directory_Flush_Params_Data::Validate, &internal::Directory_Flush_ResponseParams_Data::Validate } },
    { internal::kDirectory_StatFile_Name, { &internal::Directory_StatFile_Params_Data::Validate, &internal::Directory_StatFile_ResponseParams_Data::Validate } },
    { internal::kDirectory_Clone_Name, { &internal::Directory_Clone_Params_Data::Validate, nullptr /* no response */ } },
    { internal::kDirectory_ReadEntireFile_Name, { &internal::Directory_ReadEntireFile_Params_Data::Validate, &internal::Directory_ReadEntireFile_ResponseParams_Data::Validate } },
    { internal::kDirectory_WriteFile_Name, { &internal::Directory_WriteFile_Params_Data::Validate, &internal::Directory_WriteFile_ResponseParams_Data::Validate } },
};
...
namespace mojom {
namespace blink {
void DirectoryInterceptorForTesting::Read(ReadCallback callback) { GetForwardingInterface()->Read(std::move(callback)); }
...
void DirectoryInterceptorForTesting::Exists(const WTF::String& path, ExistsCallback callback) { GetForwardingInterface()->Exists(std::move(path), std::move(callback)); }
...
void DirectoryInterceptorForTesting::Flush(FlushCallback callback) { GetForwardingInterface()->Flush(std::move(callback)); }
void DirectoryInterceptorForTesting::StatFile(const WTF::String& path, StatFileCallback callback) { GetForwardingInterface()->StatFile(std::move(path), std::move(callback)); }
void DirectoryInterceptorForTesting::Clone(::mojo::PendingReceiver<Directory> directory) { GetForwardingInterface()->Clone(std::move(directory)); }
...
void DirectoryAsyncWaiter::Read(::base::File::Error* out_error, absl::optional<WTF::Vector<::filesystem::mojom::blink::DirectoryEntryPtr>>* out_directory_contents)
{
    base::RunLoop loop;
    proxy_->Read(base::BindOnce(
        [](base::RunLoop* loop, ::base::File::Error* out_error, absl::optional<WTF::Vector<::filesystem::mojom::blink::DirectoryEntryPtr>>* out_directory_contents,
            ::base::File::Error error, absl::optional<WTF::Vector<::filesystem::mojom::blink::DirectoryEntryPtr>> directory_contents) {
...
{
    WTF::Vector<FileOpenResultPtr> async_wait_result = mojo::DefaultConstructTraits::CreateInstance<WTF::Vector<FileOpenResultPtr>>();
    OpenFileHandles(std::move(files), &async_wait_result);
    return async_wait_result;
}

void DirectoryAsyncWaiter::OpenDirectory(const WTF::String& path, ::mojo::PendingReceiver<Directory> directory, uint32_t open_flags, ::base::File::Error* out_error)
{
    base::RunLoop loop;
...
void DirectoryAsyncWaiter::StatFile(const WTF::String& path, ::base::File::Error* out_error, ::filesystem::mojom::blink::FileInformationPtr* out_file_information)
{
    base::RunLoop loop;
    proxy_->StatFile(std::move(path),
        base::BindOnce(
            [](base::RunLoop* loop, ::base::File::Error* out_error, ::filesystem::mojom::blink::FileInformationPtr* out_file_information, ::base::File::Error error,
                ::filesystem::mojom::blink::FileInformationPtr file_information) {
                *out_error = std::move(error);
...
void DirectoryAsyncWaiter::ReadEntireFile(const WTF::String& path, ::base::File::Error* out_error, WTF::Vector<uint8_t>* out_data)
{
    ...
    proxy_->ReadEntireFile(std::move(path),
        base::BindOnce(
            [](base::RunLoop* loop, ::base::File::Error* out_error, WTF::Vector<uint8_t>* out_data, ::base::File::Error error, const WTF::Vector<uint8_t>& data) {
                *out_error = std::move(error);
