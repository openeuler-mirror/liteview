...
public:
    ...
    mojo::internal::Pointer<
        mojo::internal::Map_Data<mojo::internal::Pointer<::mojo_base::mojom::internal::UnguessableToken_Data>, ::paint_preview::mojom::internal::SerializedRecording_Data>>
        recording_map;
...
template <typename UserType, typename DataView> struct PaintPreviewBeginCompositeRequest_UnserializedMessageContext : public mojo::internal::UnserializedMessageContext {
public:
...
template <typename UserType, typename DataView> const mojo::internal::UnserializedMessageContext::Tag FrameData_UnserializedMessageContext<UserType, DataView>::kMessageTag = {};
class PaintPreviewBeginCompositeResponse_Data {
public:
    static bool Validate(const void* data, mojo::internal::ValidationContext* validation_context);
    ...
    mojo::internal::Pointer<
        mojo::internal::Map_Data<mojo::internal::Pointer<::mojo_base::mojom::internal::UnguessableToken_Data>, mojo::internal::Pointer<internal::FrameData_Data>>>
        frames;
...
template <typename UserType, typename DataView> struct PaintPreviewBeginCompositeResponse_UnserializedMessageContext : public mojo::internal::UnserializedMessageContext {
public:
    static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;
