...
std::ostream& operator<<(std::ostream& os, PaintPreviewCompositor_BeginCompositeStatus value) { return os << PaintPreviewCompositor_BeginCompositeStatusToString(value); }
...
std::ostream& operator<<(std::ostream& os, PaintPreviewCompositor_BitmapStatus value) { return os << PaintPreviewCompositor_BitmapStatusToString(value); }
...
bool PaintPreviewBeginCompositeRequest_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    ...
    if (!mojo::internal::ValidatePointerNonNullable(object->proto, 1, validation_context)) {
        return false;
    }
...
bool PaintPreviewCompositor_BitmapForMainFrame_Params_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    ...
    // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
    // the message comes from an older version.
    [[maybe_unused]] const PaintPreviewCompositor_BitmapForMainFrame_Params_Data* object = static_cast<const PaintPreviewCompositor_BitmapForMainFrame_Params_Data*>(data);
...
bool PaintPreviewCompositor_SetRootFrameUrl_Params_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    ...
    // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
    // the message comes from an older version.
    [[maybe_unused]] const PaintPreviewCompositor_SetRootFrameUrl_Params_Data* object = static_cast<const PaintPreviewCompositor_SetRootFrameUrl_Params_Data*>(data);
...
// static
bool PaintPreviewCompositorCollection_SetDiscardableSharedMemoryManager_Params_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    if (!data)
        return true;
    if (!ValidateUnversionedStructHeaderAndSizeAndClaimMemory(data, 16, validation_context)) {
