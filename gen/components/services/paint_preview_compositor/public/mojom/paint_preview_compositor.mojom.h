...
// with not having this data in traces there.
    ...
    virtual void BitmapForSeparatedFrame(const ::base::UnguessableToken& frame_guid, const ::gfx::Rect& clip_rect, float scale_factor, BitmapForSeparatedFrameCallback callback)
        = 0;
...
public:
    ...
    {
        return PaintPreviewBeginCompositeRequestPtr(absl::in_place, std::forward<Args>(args)...);
    }

    template <typename U> static PaintPreviewBeginCompositeRequestPtr From(const U& u) { return mojo::TypeConverter<PaintPreviewBeginCompositeRequestPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, PaintPreviewBeginCompositeRequest>::Convert(*this); }
    ...
    PaintPreviewBeginCompositeRequest(::base::ReadOnlySharedMemoryRegion proto_in, base::flat_map<::base::UnguessableToken, ::paint_preview::SerializedRecording> recording_map_in)
    ...
    ~PaintPreviewBeginCompositeRequest() = default;
    ...
    template <typename T, PaintPreviewBeginCompositeRequest::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::PaintPreviewBeginCompositeRequest_UnserializedMessageContext<UserType, PaintPreviewBeginCompositeRequest::DataView>>(0, 0, std::move(input)),
    ...
    {
        return PaintPreviewBeginCompositeRequest::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }

    template <typename UserType> static bool DeserializeFromMessage(mojo::Message input, UserType* output)
    {
        auto context
            = input.TakeUnserializedContext<internal::PaintPreviewBeginCompositeRequest_UnserializedMessageContext<UserType, PaintPreviewBeginCompositeRequest::DataView>>();
        if (context) {
            *output = std::move(context->TakeData());
            return true;
        }
        input.SerializeIfNecessary();
        return mojo::internal::DeserializeImpl<PaintPreviewBeginCompositeRequest::DataView>(input, input.payload(), input.payload_num_bytes(), output, Validate);
    }
...
template <typename T, PaintPreviewBeginCompositeRequest::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, PaintPreviewBeginCompositeRequest::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, PaintPreviewBeginCompositeRequest::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static SubframeClipRectPtr New(Args&&... args) { return SubframeClipRectPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static SubframeClipRectPtr From(const U& u) { return mojo::TypeConverter<SubframeClipRectPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, SubframeClipRect>::Convert(*this); }
    SubframeClipRect()
        : frame_guid()
        , clip_rect()
    {
    ...
    SubframeClipRect(const ::base::UnguessableToken& frame_guid_in, const ::gfx::RectF& clip_rect_in)
        : frame_guid(std::move(frame_guid_in))
        , clip_rect(std::move(clip_rect_in)) {};
    ~SubframeClipRect() = default;
    ...
    template <typename T, SubframeClipRect::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    ...
    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<SubframeClipRect::DataView>(input); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::SubframeClipRect_UnserializedMessageContext<UserType, SubframeClipRect::DataView>>(0, 0, std::move(input)), MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const std::vector<uint8_t>& input, UserType* output)
    {
        return SubframeClipRect::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, SubframeClipRect::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, SubframeClipRect::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, SubframeClipRect::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    template <typename... Args> static FrameDataPtr New(Args&&... args) { return FrameDataPtr(absl::in_place, std::forward<Args>(args)...); }

    template <typename U> static FrameDataPtr From(const U& u) { return mojo::TypeConverter<FrameDataPtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, FrameData>::Convert(*this); }
    FrameData()
        : scroll_extents()
        , scroll_offsets()
        , subframes()
    ...
    FrameData(const ::gfx::Size& scroll_extents_in, const ::gfx::Size& scroll_offsets_in, std::vector<SubframeClipRectPtr> subframes_in)
    ...
    template <typename T, FrameData::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input) { return mojo::internal::SerializeImpl<FrameData::DataView, std::vector<uint8_t>>(input); }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input) { return mojo::internal::SerializeAsMessageImpl<FrameData::DataView>(input); }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::FrameData_UnserializedMessageContext<UserType, FrameData::DataView>>(0, 0, std::move(input)), MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const std::vector<uint8_t>& input, UserType* output)
    {
        return FrameData::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }
...
template <typename T, FrameData::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, FrameData::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, FrameData::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }
...
public:
    ...
    {
        return PaintPreviewBeginCompositeResponsePtr(absl::in_place, std::forward<Args>(args)...);
    }

    template <typename U> static PaintPreviewBeginCompositeResponsePtr From(const U& u) { return mojo::TypeConverter<PaintPreviewBeginCompositeResponsePtr, U>::Convert(u); }

    template <typename U> U To() const { return mojo::TypeConverter<U, PaintPreviewBeginCompositeResponse>::Convert(*this); }
    ...
    PaintPreviewBeginCompositeResponse(const ::base::UnguessableToken& root_frame_guid_in, base::flat_map<::base::UnguessableToken, FrameDataPtr> frames_in)
    ...
    ~PaintPreviewBeginCompositeResponse() = default;
    ...
    template <typename T, PaintPreviewBeginCompositeResponse::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const { return Equals(rhs); }
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
    ...
    template <typename UserType> static mojo::Message WrapAsMessage(UserType input)
    {
        return mojo::Message(std::make_unique<internal::PaintPreviewBeginCompositeResponse_UnserializedMessageContext<UserType, PaintPreviewBeginCompositeResponse::DataView>>(
                                 0, 0, std::move(input)),
            MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    template <typename UserType> static bool Deserialize(const std::vector<uint8_t>& input, UserType* output)
    {
        return PaintPreviewBeginCompositeResponse::Deserialize(input.size() == 0 ? nullptr : &input.front(), input.size(), output);
    }

    template <typename UserType> static bool DeserializeFromMessage(mojo::Message input, UserType* output)
    {
        auto context
            = input.TakeUnserializedContext<internal::PaintPreviewBeginCompositeResponse_UnserializedMessageContext<UserType, PaintPreviewBeginCompositeResponse::DataView>>();
        if (context) {
            *output = std::move(context->TakeData());
            return true;
        }
        input.SerializeIfNecessary();
        return mojo::internal::DeserializeImpl<PaintPreviewBeginCompositeResponse::DataView>(input, input.payload(), input.payload_num_bytes(), output, Validate);
    }
...
template <typename T, PaintPreviewBeginCompositeResponse::EnableIfSame<T>* = nullptr> bool operator<=(const T& lhs, const T& rhs) { return !(rhs < lhs); }

template <typename T, PaintPreviewBeginCompositeResponse::EnableIfSame<T>* = nullptr> bool operator>(const T& lhs, const T& rhs) { return rhs < lhs; }

template <typename T, PaintPreviewBeginCompositeResponse::EnableIfSame<T>* = nullptr> bool operator>=(const T& lhs, const T& rhs) { return !(lhs < rhs); }

template <typename StructPtrType> PaintPreviewBeginCompositeRequestPtr PaintPreviewBeginCompositeRequest::Clone() const
{
    return New(mojo::Clone(proto), mojo::Clone(recording_map));
}
...
template <typename StructPtrType> SubframeClipRectPtr SubframeClipRect::Clone() const { return New(mojo::Clone(frame_guid), mojo::Clone(clip_rect)); }
...
template <typename StructPtrType> FrameDataPtr FrameData::Clone() const { return New(mojo::Clone(scroll_extents), mojo::Clone(scroll_offsets), mojo::Clone(subframes)); }
...
namespace mojo {
template <> struct StructTraits<::paint_preview::mojom::PaintPreviewBeginCompositeRequest::DataView, ::paint_preview::mojom::PaintPreviewBeginCompositeRequestPtr> {
    ...
    static decltype(::paint_preview::mojom::PaintPreviewBeginCompositeRequest::proto)& proto(::paint_preview::mojom::PaintPreviewBeginCompositeRequestPtr& input)
    {
        return input->proto;
    }

    static decltype(::paint_preview::mojom::PaintPreviewBeginCompositeRequest::recording_map)& recording_map(::paint_preview::mojom::PaintPreviewBeginCompositeRequestPtr& input)
    {
...
template <> struct StructTraits<::paint_preview::mojom::SubframeClipRect::DataView, ::paint_preview::mojom::SubframeClipRectPtr> {
    ...
    static const decltype(::paint_preview::mojom::SubframeClipRect::frame_guid)& frame_guid(const ::paint_preview::mojom::SubframeClipRectPtr& input) { return input->frame_guid; }

    static const decltype(::paint_preview::mojom::SubframeClipRect::clip_rect)& clip_rect(const ::paint_preview::mojom::SubframeClipRectPtr& input) { return input->clip_rect; }
...
template <> struct StructTraits<::paint_preview::mojom::FrameData::DataView, ::paint_preview::mojom::FrameDataPtr> {
    ...
    static const decltype(::paint_preview::mojom::FrameData::scroll_extents)& scroll_extents(const ::paint_preview::mojom::FrameDataPtr& input) { return input->scroll_extents; }

    static const decltype(::paint_preview::mojom::FrameData::scroll_offsets)& scroll_offsets(const ::paint_preview::mojom::FrameDataPtr& input) { return input->scroll_offsets; }

    static const decltype(::paint_preview::mojom::FrameData::subframes)& subframes(const ::paint_preview::mojom::FrameDataPtr& input) { return input->subframes; }

    static bool Read(::paint_preview::mojom::FrameData::DataView input, ::paint_preview::mojom::FrameDataPtr* output);
};
template <> struct StructTraits<::paint_preview::mojom::PaintPreviewBeginCompositeResponse::DataView, ::paint_preview::mojom::PaintPreviewBeginCompositeResponsePtr> {
    ...
    static const decltype(::paint_preview::mojom::PaintPreviewBeginCompositeResponse::frames)& frames(const ::paint_preview::mojom::PaintPreviewBeginCompositeResponsePtr& input)
    {
        return input->frames;
    }
