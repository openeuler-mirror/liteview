...
PatternParts::PatternParts(const std::string& scheme_in, bool is_scheme_wildcard_in, const std::string& host_in, bool has_domain_wildcard_in, const std::string& port_in,
...
ContentSettingPatternSource::ContentSettingPatternSource(const ::ContentSettingsPattern& primary_pattern_in, const ::ContentSettingsPattern& secondary_pattern_in,
    ::base::Value setting_value_in, ::base::Time expiration_in, const std::string& source_in, bool incognito_in)
...
RendererContentSettingRules::RendererContentSettingRules(std::vector<::ContentSettingPatternSource> image_rules_in, std::vector<::ContentSettingPatternSource> script_rules_in,
