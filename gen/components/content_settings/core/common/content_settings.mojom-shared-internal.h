...
using ContentSettingsType_Data = mojo::internal::NativeEnum_Data;
...
template <typename UserType, typename DataView> const mojo::internal::UnserializedMessageContext::Tag PatternParts_UnserializedMessageContext<UserType, DataView>::kMessageTag = {};
class ContentSettingsPattern_Data {
public:
    static bool Validate(const void* data, mojo::internal::ValidationContext* validation_context);
...
static_assert(sizeof(ContentSettingPatternSource_Data) == 64, "Bad sizeof(ContentSettingPatternSource_Data)");
// Used by ContentSettingPatternSource::WrapAsMessage to lazily serialize the struct.
template <typename UserType, typename DataView> struct ContentSettingPatternSource_UnserializedMessageContext : public mojo::internal::UnserializedMessageContext {
public:
    static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;
...
public:
    ...
    mojo::internal::Pointer<mojo::internal::Array_Data<mojo::internal::Pointer<internal::ContentSettingPatternSource_Data>>> auto_dark_content_rules;
...
static_assert(sizeof(RendererContentSettingRules_Data) == 48, "Bad sizeof(RendererContentSettingRules_Data)");
// Used by RendererContentSettingRules::WrapAsMessage to lazily serialize the struct.
template <typename UserType, typename DataView> struct RendererContentSettingRules_UnserializedMessageContext : public mojo::internal::UnserializedMessageContext {
public:
    static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;
