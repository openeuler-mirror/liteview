...
WebMemoryBreakdownEntry::WebMemoryBreakdownEntry(WebMemoryUsagePtr memory_in, WebMemoryUsagePtr canvas_memory_in, WTF::Vector<WebMemoryAttributionPtr> attribution_in)
...
WebMemoryMeasurement::WebMemoryMeasurement(
    WTF::Vector<WebMemoryBreakdownEntryPtr> breakdown_in, WebMemoryUsagePtr detached_memory_in, WebMemoryUsagePtr shared_memory_in, WebMemoryUsagePtr blink_memory_in)
