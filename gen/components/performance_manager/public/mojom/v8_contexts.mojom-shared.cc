...
std::ostream& operator<<(std::ostream& os, V8ContextWorldType value) { return os << V8ContextWorldTypeToString(value); }
...
bool V8ContextDescription_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    ...
    const mojo::internal::ContainerValidateParams world_name_validate_params(0, false, nullptr);
...
// static
void TraceFormatTraits<::performance_manager::mojom::V8ContextWorldType>::WriteIntoTrace(perfetto::TracedValue context, ::performance_manager::mojom::V8ContextWorldType value)
{
