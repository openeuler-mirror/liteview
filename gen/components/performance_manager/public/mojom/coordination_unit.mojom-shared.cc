...
std::ostream& operator<<(std::ostream& os, CoordinationUnitType value) { return os << CoordinationUnitTypeToString(value); }
...
bool DocumentCoordinationUnit_SetNetworkAlmostIdle_Params_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    ...
    [[maybe_unused]] const DocumentCoordinationUnit_SetNetworkAlmostIdle_Params_Data* object = static_cast<const DocumentCoordinationUnit_SetNetworkAlmostIdle_Params_Data*>(data);
...
bool DocumentCoordinationUnit_SetLifecycleState_Params_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    ...
    // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
    // the message comes from an older version.
    [[maybe_unused]] const DocumentCoordinationUnit_SetLifecycleState_Params_Data* object = static_cast<const DocumentCoordinationUnit_SetLifecycleState_Params_Data*>(data);
...
bool DocumentCoordinationUnit_SetIsAdFrame_Params_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    ...
    // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
    // the message comes from an older version.
    [[maybe_unused]] const DocumentCoordinationUnit_SetIsAdFrame_Params_Data* object = static_cast<const DocumentCoordinationUnit_SetIsAdFrame_Params_Data*>(data);
...
// static
bool DocumentCoordinationUnit_OnWebMemoryMeasurementRequested_ResponseParams_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    if (!data)
        return true;
    if (!ValidateUnversionedStructHeaderAndSizeAndClaimMemory(data, 16, validation_context)) {
...
bool ProcessCoordinationUnit_OnV8ContextCreated_Params_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    ...
    // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
    // the message comes from an older version.
    [[maybe_unused]] const ProcessCoordinationUnit_OnV8ContextCreated_Params_Data* object = static_cast<const ProcessCoordinationUnit_OnV8ContextCreated_Params_Data*>(data);
...
bool ProcessCoordinationUnit_OnV8ContextDetached_Params_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    ...
    // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
    // the message comes from an older version.
    [[maybe_unused]] const ProcessCoordinationUnit_OnV8ContextDetached_Params_Data* object = static_cast<const ProcessCoordinationUnit_OnV8ContextDetached_Params_Data*>(data);
...
bool ProcessCoordinationUnit_OnV8ContextDestroyed_Params_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    ...
    // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
    // the message comes from an older version.
    [[maybe_unused]] const ProcessCoordinationUnit_OnV8ContextDestroyed_Params_Data* object = static_cast<const ProcessCoordinationUnit_OnV8ContextDestroyed_Params_Data*>(data);
...
// static
bool ProcessCoordinationUnit_FireBackgroundTracingTrigger_Params_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    if (!data)
        return true;
    if (!ValidateUnversionedStructHeaderAndSizeAndClaimMemory(data, 16, validation_context)) {
    ...
    if (!mojo::internal::ValidatePointerNonNullable(object->trigger_name, 1, validation_context)) {
        return false;
    }
    const mojo::internal::ContainerValidateParams trigger_name_validate_params(0, false, nullptr);
    if (!mojo::internal::ValidateContainer(object->trigger_name, validation_context, &trigger_name_validate_params)) {
        return false;
    }
...
// static
void TraceFormatTraits<::performance_manager::mojom::CoordinationUnitType>::WriteIntoTrace(perfetto::TracedValue context, ::performance_manager::mojom::CoordinationUnitType value)
{
