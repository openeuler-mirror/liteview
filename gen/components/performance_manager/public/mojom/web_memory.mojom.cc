...
WebMemoryAttribution::WebMemoryAttribution(
    WebMemoryAttribution::Scope scope_in, const absl::optional<std::string>& url_in, const absl::optional<std::string>& src_in, const absl::optional<std::string>& id_in)
...
bool WebMemoryAttribution::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
bool WebMemoryUsage::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
WebMemoryBreakdownEntry::WebMemoryBreakdownEntry(WebMemoryUsagePtr memory_in, WebMemoryUsagePtr canvas_memory_in, std::vector<WebMemoryAttributionPtr> attribution_in)
...
bool WebMemoryBreakdownEntry::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
WebMemoryMeasurement::WebMemoryMeasurement(
    std::vector<WebMemoryBreakdownEntryPtr> breakdown_in, WebMemoryUsagePtr detached_memory_in, WebMemoryUsagePtr shared_memory_in, WebMemoryUsagePtr blink_memory_in)
...
bool WebMemoryMeasurement::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
} // namespace mojom
} // namespace performance_manager
namespace mojo {
// static
