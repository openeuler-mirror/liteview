...
std::ostream& operator<<(std::ostream& os, WebMemoryAttribution_Scope value) { return os << WebMemoryAttribution_ScopeToString(value); }
...
std::ostream& operator<<(std::ostream& os, WebMemoryMeasurement_Mode value) { return os << WebMemoryMeasurement_ModeToString(value); }
