...
// with not having this data in traces there.
    ...
    virtual void FireBackgroundTracingTrigger(const std::string& trigger_name) = 0;
};
...
public:
    ...
    void OnV8ContextCreated(
        ::performance_manager::mojom::V8ContextDescriptionPtr description, ::performance_manager::mojom::IframeAttributionDataPtr iframe_attribution_data) final;
    ...
    void FireBackgroundTracingTrigger(const std::string& trigger_name) final;
