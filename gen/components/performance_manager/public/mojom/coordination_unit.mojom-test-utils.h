...
public:
    ...
    void OnWebMemoryMeasurementRequested(::performance_manager::mojom::WebMemoryMeasurement::Mode mode, ::performance_manager::mojom::WebMemoryMeasurementPtr* out_measurement);
...
class COMPONENT_EXPORT(PERFORMANCE_MANAGER_PUBLIC_MOJOM) ProcessCoordinationUnitInterceptorForTesting : public ProcessCoordinationUnit {
    ...
    void OnV8ContextCreated(
        ::performance_manager::mojom::V8ContextDescriptionPtr description, ::performance_manager::mojom::IframeAttributionDataPtr iframe_attribution_data) override;
