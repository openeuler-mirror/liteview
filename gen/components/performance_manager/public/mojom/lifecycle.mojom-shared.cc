...
static NOINLINE const char* LifecycleStateToStringHelper(LifecycleState value)
{
...
std::ostream& operator<<(std::ostream& os, LifecycleState value) { return os << LifecycleStateToString(value); }
...
// static
void TraceFormatTraits<::performance_manager::mojom::LifecycleState>::WriteIntoTrace(perfetto::TracedValue context, ::performance_manager::mojom::LifecycleState value)
{
