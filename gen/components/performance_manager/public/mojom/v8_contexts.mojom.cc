...
IframeAttributionData::IframeAttributionData(const absl::optional<std::string>& id_in, const absl::optional<std::string>& src_in)
    : id(std::move(id_in))
    , src(std::move(src_in))
{
}
...
bool IframeAttributionData::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
V8ContextDescription::V8ContextDescription(const ::blink::V8ContextToken& token_in, V8ContextWorldType world_type_in, const absl::optional<std::string>& world_name_in,
...
bool V8ContextDescription::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
} // namespace mojom
} // namespace performance_manager
namespace mojo {
// static
