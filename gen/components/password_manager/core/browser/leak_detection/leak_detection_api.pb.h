...
public:
    ...
    static const LookupSingleLeakRequest& default_instance() { return *internal_default_instance(); }
    ...
    friend void swap(LookupSingleLeakRequest& a, LookupSingleLeakRequest& b) { a.Swap(&b); }
    ...
    LookupSingleLeakRequest* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final { return CreateMaybeMessage<LookupSingleLeakRequest>(arena); }
...
private:
    ...
    static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() { return "google.internal.identity.passwords.leak.check.v1.LookupSingleLeakRequest"; }
...
public:
    ...
    static const LookupSingleLeakResponse& default_instance() { return *internal_default_instance(); }
    ...
    friend void swap(LookupSingleLeakResponse& a, LookupSingleLeakResponse& b) { a.Swap(&b); }
    ...
    LookupSingleLeakResponse* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final { return CreateMaybeMessage<LookupSingleLeakResponse>(arena); }
    void CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from) final;
...
private:
    friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
    static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() { return "google.internal.identity.passwords.leak.check.v1.LookupSingleLeakResponse"; }
...
// bytes username_hash_prefix = 1;
inline void LookupSingleLeakRequest::clear_username_hash_prefix() { username_hash_prefix_.ClearToEmpty(); }
...
inline const std::string& LookupSingleLeakRequest::_internal_username_hash_prefix() const { return username_hash_prefix_.Get(); }
inline void LookupSingleLeakRequest::_internal_set_username_hash_prefix(const std::string& value) { username_hash_prefix_.Set(value, GetArenaForAllocation()); }
inline std::string* LookupSingleLeakRequest::_internal_mutable_username_hash_prefix() { return username_hash_prefix_.Mutable(GetArenaForAllocation()); }
...
// uint32 username_hash_prefix_length = 2;
inline void LookupSingleLeakRequest::clear_username_hash_prefix_length() { username_hash_prefix_length_ = 0u; }
inline uint32_t LookupSingleLeakRequest::_internal_username_hash_prefix_length() const { return username_hash_prefix_length_; }
...
inline void LookupSingleLeakRequest::_internal_set_username_hash_prefix_length(uint32_t value) { username_hash_prefix_length_ = value; }
...
// bytes encrypted_lookup_hash = 3;
inline void LookupSingleLeakRequest::clear_encrypted_lookup_hash() { encrypted_lookup_hash_.ClearToEmpty(); }
...
inline const std::string& LookupSingleLeakRequest::_internal_encrypted_lookup_hash() const { return encrypted_lookup_hash_.Get(); }
inline void LookupSingleLeakRequest::_internal_set_encrypted_lookup_hash(const std::string& value) { encrypted_lookup_hash_.Set(value, GetArenaForAllocation()); }
inline std::string* LookupSingleLeakRequest::_internal_mutable_encrypted_lookup_hash() { return encrypted_lookup_hash_.Mutable(GetArenaForAllocation()); }
...
// repeated bytes encrypted_leak_match_prefix = 1;
inline int LookupSingleLeakResponse::_internal_encrypted_leak_match_prefix_size() const { return encrypted_leak_match_prefix_.size(); }
inline int LookupSingleLeakResponse::encrypted_leak_match_prefix_size() const { return _internal_encrypted_leak_match_prefix_size(); }
inline void LookupSingleLeakResponse::clear_encrypted_leak_match_prefix() { encrypted_leak_match_prefix_.Clear(); }
...
inline const std::string& LookupSingleLeakResponse::_internal_encrypted_leak_match_prefix(int index) const { return encrypted_leak_match_prefix_.Get(index); }
...
{
    encrypted_leak_match_prefix_.Mutable(index)->assign(reinterpret_cast<const char*>(value), size);
...
inline std::string* LookupSingleLeakResponse::_internal_add_encrypted_leak_match_prefix() { return encrypted_leak_match_prefix_.Add(); }
...
// bytes reencrypted_lookup_hash = 2;
inline void LookupSingleLeakResponse::clear_reencrypted_lookup_hash() { reencrypted_lookup_hash_.ClearToEmpty(); }
...
inline const std::string& LookupSingleLeakResponse::_internal_reencrypted_lookup_hash() const { return reencrypted_lookup_hash_.Get(); }
inline void LookupSingleLeakResponse::_internal_set_reencrypted_lookup_hash(const std::string& value) { reencrypted_lookup_hash_.Set(value, GetArenaForAllocation()); }
inline std::string* LookupSingleLeakResponse::_internal_mutable_reencrypted_lookup_hash() { return reencrypted_lookup_hash_.Mutable(GetArenaForAllocation()); }
