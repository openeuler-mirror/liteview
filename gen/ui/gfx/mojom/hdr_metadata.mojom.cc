...
// static
bool StructTraits<::gfx::mojom::ColorVolumeMetadata::DataView, ::gfx::mojom::ColorVolumeMetadataPtr>::Read(
    ::gfx::mojom::ColorVolumeMetadata::DataView input, ::gfx::mojom::ColorVolumeMetadataPtr* output)
{
    bool success = true;
    ::gfx::mojom::ColorVolumeMetadataPtr result(::gfx::mojom::ColorVolumeMetadata::New());
...
// static
bool StructTraits<::gfx::mojom::HDRMetadata::DataView, ::gfx::mojom::HDRMetadataPtr>::Read(::gfx::mojom::HDRMetadata::DataView input, ::gfx::mojom::HDRMetadataPtr* output)
{
    bool success = true;
