...
struct gfx_mojom_internal_OverlayTransform_DataHashFn {
    ...
    static bool Equal(const ::gfx::mojom::OverlayTransform& left, const ::gfx::mojom::OverlayTransform& right) { return left == right; }
    static const bool safe_to_compare_to_empty_or_deleted = true;
};

template <> struct HashTraits<::gfx::mojom::OverlayTransform> : public GenericHashTraits<::gfx::mojom::OverlayTransform> {
    ...
    static void ConstructDeletedValue(::gfx::mojom::OverlayTransform& slot, bool) { slot = static_cast<::gfx::mojom::OverlayTransform>(-1000001); }
    static bool IsDeletedValue(const ::gfx::mojom::OverlayTransform& value) { return value == static_cast<::gfx::mojom::OverlayTransform>(-1000001); }
};
} // namespace WTF
namespace gfx {
namespace mojom {
