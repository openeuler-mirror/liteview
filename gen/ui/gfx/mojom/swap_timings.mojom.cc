...
bool SwapTimings::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
// static
bool StructTraits<::gfx::mojom::SwapTimings::DataView, ::gfx::mojom::SwapTimingsPtr>::Read(::gfx::mojom::SwapTimings::DataView input, ::gfx::mojom::SwapTimingsPtr* output)
{
    bool success = true;
