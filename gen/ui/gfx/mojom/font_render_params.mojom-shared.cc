...
std::ostream& operator<<(std::ostream& os, Hinting value) { return os << HintingToString(value); }
...
std::ostream& operator<<(std::ostream& os, SubpixelRendering value) { return os << SubpixelRenderingToString(value); }
