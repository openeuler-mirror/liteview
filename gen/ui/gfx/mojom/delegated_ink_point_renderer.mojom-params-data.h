...
static_assert(sizeof(DelegatedInkPointRenderer_StoreDelegatedInkPoint_Params_Data) == 16, "Bad sizeof(DelegatedInkPointRenderer_StoreDelegatedInkPoint_Params_Data)");
...
public:
    ...
    DelegatedInkPointRenderer_StoreDelegatedInkPoint_ParamsDataView(internal::DelegatedInkPointRenderer_StoreDelegatedInkPoint_Params_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
