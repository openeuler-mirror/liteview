...
#ifndef UI_GFX_MOJOM_LINEAR_GRADIENT_MOJOM_BLINK_JUMBO_H_
#define UI_GFX_MOJOM_LINEAR_GRADIENT_MOJOM_BLINK_JUMBO_H_
#endif
...
bool Step::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
bool LinearGradient::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
// static
bool StructTraits<::gfx::mojom::blink::Step::DataView, ::gfx::mojom::blink::StepPtr>::Read(::gfx::mojom::blink::Step::DataView input, ::gfx::mojom::blink::StepPtr* output)
{
    bool success = true;
