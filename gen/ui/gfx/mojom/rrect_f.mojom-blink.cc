...
bool RRectF::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
// static
bool StructTraits<::gfx::mojom::blink::RRectF::DataView, ::gfx::mojom::blink::RRectFPtr>::Read(::gfx::mojom::blink::RRectF::DataView input, ::gfx::mojom::blink::RRectFPtr* output)
{
    bool success = true;
