...
std::ostream& operator<<(std::ostream& os, BufferFormat value) { return os << BufferFormatToString(value); }
...
std::ostream& operator<<(std::ostream& os, BufferUsage value) { return os << BufferUsageToString(value); }
...
std::ostream& operator<<(std::ostream& os, BufferPlane value) { return os << BufferPlaneToString(value); }
