...
#ifndef UI_GFX_MOJOM_TRANSFORM_MOJOM_JUMBO_H_
#define UI_GFX_MOJOM_TRANSFORM_MOJOM_JUMBO_H_
#endif
...
Transform::Transform(absl::optional<std::vector<float>> matrix_in)
...
bool Transform::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
// static
bool StructTraits<::gfx::mojom::Transform::DataView, ::gfx::mojom::TransformPtr>::Read(::gfx::mojom::Transform::DataView input, ::gfx::mojom::TransformPtr* output)
{
    bool success = true;
