...
bool CALayerParams::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
CALayerContent::~CALayerContent() { DestroyActive(); }
...
bool CALayerContent::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context, false); }
...
// static
bool StructTraits<::gfx::mojom::CALayerParams::DataView, ::gfx::mojom::CALayerParamsPtr>::Read(::gfx::mojom::CALayerParams::DataView input, ::gfx::mojom::CALayerParamsPtr* output)
{
    bool success = true;
