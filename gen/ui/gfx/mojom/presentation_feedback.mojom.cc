...
PresentationFeedback::PresentationFeedback(::base::TimeTicks timestamp_in, ::base::TimeDelta interval_in, uint32_t flags_in, ::base::TimeTicks available_timestamp_in,
...
bool PresentationFeedback::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
