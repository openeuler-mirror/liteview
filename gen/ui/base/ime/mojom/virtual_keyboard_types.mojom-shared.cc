...
static NOINLINE const char* VirtualKeyboardPolicyToStringHelper(VirtualKeyboardPolicy value)
{
...
std::ostream& operator<<(std::ostream& os, VirtualKeyboardPolicy value) { return os << VirtualKeyboardPolicyToString(value); }

static NOINLINE const char* VirtualKeyboardVisibilityRequestToStringHelper(VirtualKeyboardVisibilityRequest value)
{
    // Defined in a helper function to ensure that Clang generates a lookup table.
    switch (value) {
...
std::ostream& operator<<(std::ostream& os, VirtualKeyboardVisibilityRequest value) { return os << VirtualKeyboardVisibilityRequestToString(value); }

static NOINLINE const char* VirtualKeyboardModeToStringHelper(VirtualKeyboardMode value)
{
    // Defined in a helper function to ensure that Clang generates a lookup table.
    switch (value) {
...
std::ostream& operator<<(std::ostream& os, VirtualKeyboardMode value) { return os << VirtualKeyboardModeToString(value); }
...
// static
void TraceFormatTraits<::ui::mojom::VirtualKeyboardVisibilityRequest>::WriteIntoTrace(perfetto::TracedValue context, ::ui::mojom::VirtualKeyboardVisibilityRequest value)
{
