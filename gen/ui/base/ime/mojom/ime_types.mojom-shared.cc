...
std::ostream& operator<<(std::ostream& os, TextInputMode value) { return os << TextInputModeToString(value); }
...
std::ostream& operator<<(std::ostream& os, TextInputAction value) { return os << TextInputActionToString(value); }
...
std::ostream& operator<<(std::ostream& os, TextInputType value) { return os << TextInputTypeToString(value); }
...
std::ostream& operator<<(std::ostream& os, ImeTextSpanType value) { return os << ImeTextSpanTypeToString(value); }
...
std::ostream& operator<<(std::ostream& os, ImeTextSpanThickness value) { return os << ImeTextSpanThicknessToString(value); }
...
std::ostream& operator<<(std::ostream& os, ImeTextSpanUnderlineStyle value) { return os << ImeTextSpanUnderlineStyleToString(value); }
