...
(function() {
  ...
  MenuSourceType.DEFAULT_VALUE = 0;
  ...
  var WindowShowState = {};
  WindowShowState.SHOW_STATE_DEFAULT = 0;
  WindowShowState.SHOW_STATE_NORMAL = 1;
  WindowShowState.SHOW_STATE_MINIMIZED = 2;
  WindowShowState.SHOW_STATE_MAXIMIZED = 3;
  WindowShowState.SHOW_STATE_INACTIVE = 4;
  WindowShowState.SHOW_STATE_FULLSCREEN = 5;
  WindowShowState.MIN_VALUE = 0;
  WindowShowState.MAX_VALUE = 5;
  WindowShowState.DEFAULT_VALUE = 0;

  WindowShowState.isKnownEnumValue = function(value) {
    switch (value) {
    case 0:
    case 1:
    case 2:
  ...
  WindowShowState.toKnownEnumValue = function(value) {
    if (this.isKnownEnumValue(value))
      return value;
    return this.DEFAULT_VALUE;
  };

  WindowShowState.validate = function(enumValue) {
    const isExtensible = true;
    if (isExtensible || this.isKnownEnumValue(enumValue))
      return validator.validationError.NONE;
  ...
  exports.WindowShowState = WindowShowState;
})();
