...
bool ClickModifiers::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
// static
bool StructTraits<::ui::mojom::ClickModifiers::DataView, ::ui::mojom::ClickModifiersPtr>::Read(::ui::mojom::ClickModifiers::DataView input, ::ui::mojom::ClickModifiersPtr* output)
{
    bool success = true;
