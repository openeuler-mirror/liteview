...
std::ostream& operator<<(std::ostream& os, DragEventSource value) { return os << DragEventSourceToString(value); }
...
std::ostream& operator<<(std::ostream& os, DragOperation value) { return os << DragOperationToString(value); }
