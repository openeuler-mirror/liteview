...
DisplayPlacement::DisplayPlacement(int64_t display_id_in, int64_t parent_display_id_in, Position position_in, int32_t offset_in, OffsetReference offset_reference_in)
...
bool DisplayPlacement::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
bool DisplayLayout::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
