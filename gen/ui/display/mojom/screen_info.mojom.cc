...
ScreenInfo::ScreenInfo(float device_scale_factor_in, const ::gfx::DisplayColorSpaces& display_color_spaces_in, uint32_t depth_in, uint32_t depth_per_component_in,
    bool is_monochrome_in, uint32_t display_frequency_in, const ::gfx::Rect& rect_in, const ::gfx::Rect& available_rect_in, ::display::mojom::ScreenOrientation orientation_type_in,
...
bool ScreenInfo::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
