// ui/display/mojom/display.mojom-lite-for-compile.js is auto generated by mojom_bindings_generator.py, do not edit
...
goog.provide('display.mojom.Rotation');
goog.provide('display.mojom.RotationSpec');
/**
...
goog.provide('display.mojom.TouchSupport');
goog.provide('display.mojom.TouchSupportSpec');
/**
 * @const { {$: !mojo.internal.MojomType} }
 * @export
 */
...
goog.provide('display.mojom.AccelerometerSupport');
goog.provide('display.mojom.AccelerometerSupportSpec');
/**
 * @const { {$: !mojo.internal.MojomType} }
 * @export
 */
...
goog.provide('display.mojom.DisplaySpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('display.mojom.Display');
