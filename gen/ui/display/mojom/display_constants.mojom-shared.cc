...
std::ostream& operator<<(std::ostream& os, DisplayConnectionType value) { return os << DisplayConnectionTypeToString(value); }
...
std::ostream& operator<<(std::ostream& os, HDCPState value) { return os << HDCPStateToString(value); }
...
std::ostream& operator<<(std::ostream& os, ContentProtectionMethod value) { return os << ContentProtectionMethodToString(value); }
...
std::ostream& operator<<(std::ostream& os, PanelOrientation value) { return os << PanelOrientationToString(value); }
...
std::ostream& operator<<(std::ostream& os, PrivacyScreenState value) { return os << PrivacyScreenStateToString(value); }
...
// static
void TraceFormatTraits<::display::mojom::ContentProtectionMethod>::WriteIntoTrace(perfetto::TracedValue context, ::display::mojom::ContentProtectionMethod value)
{
