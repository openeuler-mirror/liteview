...
DisplaySnapshot::DisplaySnapshot(int64_t display_id_in, int64_t port_display_id_in, int64_t edid_display_id_in, uint16_t connector_index_in, const ::gfx::Point& origin_in,
...
void DisplaySnapshot::WriteIntoTrace(perfetto::TracedValue traced_context) const
{
    ...
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("has_color_correction_matrix"), this->has_color_correction_matrix,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
        "<value of type bool>"
#else
        "<value>"
    ...
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("color_correction_in_linear_space"), this->color_correction_in_linear_space,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
        "<value of type bool>"
#else
        "<value>"
...
bool DisplaySnapshot::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
