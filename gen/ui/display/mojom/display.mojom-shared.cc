...
std::ostream& operator<<(std::ostream& os, Rotation value) { return os << RotationToString(value); }
...
std::ostream& operator<<(std::ostream& os, TouchSupport value) { return os << TouchSupportToString(value); }
...
std::ostream& operator<<(std::ostream& os, AccelerometerSupport value) { return os << AccelerometerSupportToString(value); }
...
bool Display_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    ...
    if (!mojo::internal::ValidatePointerNonNullable(object->work_area, 4, validation_context)) {
        return false;
    }
    ...
    if (!mojo::internal::ValidatePointerNonNullable(object->maximum_cursor_size, 9, validation_context)) {
        return false;
    }
    if (!mojo::internal::ValidateStruct(object->maximum_cursor_size, validation_context))
        return false;

    if (!mojo::internal::ValidatePointerNonNullable(object->color_spaces, 10, validation_context)) {
        return false;
    }
    if (!mojo::internal::ValidateStruct(object->color_spaces, validation_context))
        return false;

    if (!mojo::internal::ValidatePointerNonNullable(object->label, 15, validation_context)) {
        return false;
    }
