...
public:
    ...
    DisplaySnapshot(int64_t display_id_in, int64_t port_display_id_in, int64_t edid_display_id_in, uint16_t connector_index_in, const ::gfx::Point& origin_in,
        const ::gfx::Size& physical_size_in, ::display::mojom::blink::DisplayConnectionType type_in, uint64_t base_connector_id_in, WTF::Vector<uint64_t> path_topology_in,
        bool is_aspect_preserving_scaling_in, bool has_overscan_in, ::display::mojom::blink::PrivacyScreenState privacy_screen_state_in, bool has_color_correction_matrix_in,
        bool color_correction_in_linear_space_in, const ::gfx::ColorSpace& color_space_in, uint32_t bits_per_channel_in,
        const absl::optional<::gfx::HDRStaticMetadata>& hdr_static_metadata_in, const WTF::String& display_name_in, const ::base::FilePath& sys_path_in,
        WTF::Vector<::display::mojom::blink::DisplayModePtr> modes_in, ::display::mojom::blink::PanelOrientation panel_orientation_in, WTF::Vector<uint8_t> edid_in,
...
template <> struct StructTraits<::display::mojom::blink::DisplaySnapshot::DataView, ::display::mojom::blink::DisplaySnapshotPtr> {
    ...
    static decltype(::display::mojom::blink::DisplaySnapshot::display_id) display_id(const ::display::mojom::blink::DisplaySnapshotPtr& input) { return input->display_id; }
    ...
    static const decltype(::display::mojom::blink::DisplaySnapshot::origin)& origin(const ::display::mojom::blink::DisplaySnapshotPtr& input) { return input->origin; }
    ...
    static decltype(::display::mojom::blink::DisplaySnapshot::type) type(const ::display::mojom::blink::DisplaySnapshotPtr& input) { return input->type; }
    ...
    static decltype(::display::mojom::blink::DisplaySnapshot::is_aspect_preserving_scaling) is_aspect_preserving_scaling(const ::display::mojom::blink::DisplaySnapshotPtr& input)
    {
        return input->is_aspect_preserving_scaling;
    }

    static decltype(::display::mojom::blink::DisplaySnapshot::has_overscan) has_overscan(const ::display::mojom::blink::DisplaySnapshotPtr& input) { return input->has_overscan; }

    static decltype(::display::mojom::blink::DisplaySnapshot::privacy_screen_state) privacy_screen_state(const ::display::mojom::blink::DisplaySnapshotPtr& input)
    {
        return input->privacy_screen_state;
    }

    static decltype(::display::mojom::blink::DisplaySnapshot::has_color_correction_matrix) has_color_correction_matrix(const ::display::mojom::blink::DisplaySnapshotPtr& input)
    {
    ...
    static const decltype(::display::mojom::blink::DisplaySnapshot::color_space)& color_space(const ::display::mojom::blink::DisplaySnapshotPtr& input)
    {
        return input->color_space;
    }

    static decltype(::display::mojom::blink::DisplaySnapshot::bits_per_channel) bits_per_channel(const ::display::mojom::blink::DisplaySnapshotPtr& input)
    {
        return input->bits_per_channel;
    }

    static const decltype(::display::mojom::blink::DisplaySnapshot::hdr_static_metadata)& hdr_static_metadata(const ::display::mojom::blink::DisplaySnapshotPtr& input)
    {
    ...
    static const decltype(::display::mojom::blink::DisplaySnapshot::sys_path)& sys_path(const ::display::mojom::blink::DisplaySnapshotPtr& input) { return input->sys_path; }

    static const decltype(::display::mojom::blink::DisplaySnapshot::modes)& modes(const ::display::mojom::blink::DisplaySnapshotPtr& input) { return input->modes; }
    ...
    static const decltype(::display::mojom::blink::DisplaySnapshot::edid)& edid(const ::display::mojom::blink::DisplaySnapshotPtr& input) { return input->edid; }
    ...
    static decltype(::display::mojom::blink::DisplaySnapshot::product_code) product_code(const ::display::mojom::blink::DisplaySnapshotPtr& input) { return input->product_code; }
    ...
    static const decltype(::display::mojom::blink::DisplaySnapshot::maximum_cursor_size)& maximum_cursor_size(const ::display::mojom::blink::DisplaySnapshotPtr& input)
    {
