...
GestureData::GestureData(LocationDataPtr location_in, ::ui::mojom::blink::GestureDeviceType device_type_in, float scale_in)
...
Event::Event(::ui::mojom::blink::EventType action_in, int32_t flags_in, ::base::TimeTicks time_stamp_in, const ::ui::LatencyInfo& latency_in, KeyDataPtr key_data_in,
...
// static
bool StructTraits<::ui::mojom::blink::KeyData::DataView, ::ui::mojom::blink::KeyDataPtr>::Read(::ui::mojom::blink::KeyData::DataView input, ::ui::mojom::blink::KeyDataPtr* output)
{
    bool success = true;
...
// static
bool StructTraits<::ui::mojom::blink::Event::DataView, ::ui::mojom::blink::EventPtr>::Read(::ui::mojom::blink::Event::DataView input, ::ui::mojom::blink::EventPtr* output)
{
    bool success = true;
