...
bool LocationData::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
GestureData::GestureData(LocationDataPtr location_in, ::ui::GestureDeviceType device_type_in, float scale_in)
...
ScrollData::ScrollData(LocationDataPtr location_in, float x_offset_in, float y_offset_in, float x_offset_ordinal_in, float y_offset_ordinal_in, int32_t finger_count_in,
...
bool PointerDetails::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
MouseData::MouseData()
...
MouseData::MouseData(int32_t changed_button_flags_in, LocationDataPtr location_in, const ::ui::PointerDetails& pointer_details_in, const ::gfx::Vector2d& wheel_offset_in,
...
// static
bool StructTraits<::ui::mojom::LocationData::DataView, ::ui::mojom::LocationDataPtr>::Read(::ui::mojom::LocationData::DataView input, ::ui::mojom::LocationDataPtr* output)
{
    bool success = true;
...
// static
bool StructTraits<::ui::mojom::GestureData::DataView, ::ui::mojom::GestureDataPtr>::Read(::ui::mojom::GestureData::DataView input, ::ui::mojom::GestureDataPtr* output)
{
    bool success = true;
...
// static
bool StructTraits<::ui::mojom::ScrollData::DataView, ::ui::mojom::ScrollDataPtr>::Read(::ui::mojom::ScrollData::DataView input, ::ui::mojom::ScrollDataPtr* output)
{
    bool success = true;
...
// static
bool StructTraits<::ui::mojom::PointerDetails::DataView, ::ui::mojom::PointerDetailsPtr>::Read(::ui::mojom::PointerDetails::DataView input, ::ui::mojom::PointerDetailsPtr* output)
{
    bool success = true;
