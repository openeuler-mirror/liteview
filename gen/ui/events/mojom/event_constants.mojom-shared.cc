...
std::ostream& operator<<(std::ostream& os, AcceleratorPhase value) { return os << AcceleratorPhaseToString(value); }
...
std::ostream& operator<<(std::ostream& os, EventType value) { return os << EventTypeToString(value); }
...
std::ostream& operator<<(std::ostream& os, ScrollEventPhase value) { return os << ScrollEventPhaseToString(value); }
...
std::ostream& operator<<(std::ostream& os, EventMomentumPhase value) { return os << EventMomentumPhaseToString(value); }
...
std::ostream& operator<<(std::ostream& os, GestureDeviceType value) { return os << GestureDeviceTypeToString(value); }
