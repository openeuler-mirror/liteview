...
VECTOR_ICON_TEMPLATE_H(kWindowControlCloseIcon)
VECTOR_ICON_TEMPLATE_H(kWindowControlMaximizeIcon)
VECTOR_ICON_TEMPLATE_H(kWindowControlMinimizeIcon)
VECTOR_ICON_TEMPLATE_H(kWindowControlRestoreIcon)
