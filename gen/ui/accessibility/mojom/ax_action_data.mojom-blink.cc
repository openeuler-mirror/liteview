...
#ifndef UI_ACCESSIBILITY_MOJOM_AX_ACTION_DATA_MOJOM_BLINK_JUMBO_H_
#define UI_ACCESSIBILITY_MOJOM_AX_ACTION_DATA_MOJOM_BLINK_JUMBO_H_
#endif
...
AXActionData::AXActionData(::ax::mojom::blink::Action action_in, ::ax::mojom::blink::AXTreeIDPtr target_tree_id_in, const WTF::String& source_extension_id_in,
    int32_t target_node_id_in, int32_t request_id_in, int32_t flags_in, int32_t anchor_node_id_in, int32_t anchor_offset_in, int32_t focus_node_id_in, int32_t focus_offset_in,
