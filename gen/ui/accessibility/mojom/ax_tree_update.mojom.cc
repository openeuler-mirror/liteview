...
AXTreeUpdate::AXTreeUpdate(bool has_tree_data_in, const ::ui::AXTreeData& tree_data_in, int32_t node_id_to_clear_in, int32_t root_id_in, std::vector<::ui::AXNodeData> nodes_in,
...
bool AXTreeUpdate::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
// static
bool StructTraits<::ax::mojom::AXTreeUpdate::DataView, ::ax::mojom::AXTreeUpdatePtr>::Read(::ax::mojom::AXTreeUpdate::DataView input, ::ax::mojom::AXTreeUpdatePtr* output)
{
    bool success = true;
