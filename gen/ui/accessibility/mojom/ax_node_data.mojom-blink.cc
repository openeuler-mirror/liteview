...
AXNodeData::AXNodeData(int32_t id_in, ::ax::mojom::blink::Role role_in, uint32_t state_in, uint64_t actions_in,
    const WTF::HashMap<::ax::mojom::blink::StringAttribute, WTF::String>& string_attributes_in, const WTF::HashMap<::ax::mojom::blink::IntAttribute, int32_t>& int_attributes_in,
    const WTF::HashMap<::ax::mojom::blink::FloatAttribute, float>& float_attributes_in, const WTF::HashMap<::ax::mojom::blink::BoolAttribute, bool>& bool_attributes_in,
