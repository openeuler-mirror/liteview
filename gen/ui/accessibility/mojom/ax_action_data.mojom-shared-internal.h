...
static_assert(sizeof(AXActionData_Data) == 112, "Bad sizeof(AXActionData_Data)");
...
template <typename UserType, typename DataView> const mojo::internal::UnserializedMessageContext::Tag AXActionData_UnserializedMessageContext<UserType, DataView>::kMessageTag = {};
