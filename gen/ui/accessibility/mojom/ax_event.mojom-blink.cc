...
AXEvent::AXEvent(::ax::mojom::blink::Event event_type_in, int32_t id_in, ::ax::mojom::blink::EventFrom event_from_in, ::ax::mojom::blink::Action event_from_action_in,
...
bool AXEvent::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
// static
bool StructTraits<::ax::mojom::blink::AXEvent::DataView, ::ax::mojom::blink::AXEventPtr>::Read(::ax::mojom::blink::AXEvent::DataView input, ::ax::mojom::blink::AXEventPtr* output)
{
    bool success = true;
