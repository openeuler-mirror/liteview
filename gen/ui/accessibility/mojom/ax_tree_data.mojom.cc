...
AXTreeData::AXTreeData(const ::ui::AXTreeID& tree_id_in, const ::ui::AXTreeID& parent_tree_id_in, const ::ui::AXTreeID& focused_tree_id_in, const std::string& doctype_in,
    bool loaded_in, float loading_progress_in, const std::string& mimetype_in, const std::string& title_in, const std::string& url_in, int32_t focus_id_in, bool sel_is_backward_in,
    int32_t sel_anchor_object_id_in, int32_t sel_anchor_offset_in, ::ax::mojom::TextAffinity sel_anchor_affinity_in, int32_t sel_focus_object_id_in, int32_t sel_focus_offset_in,
...
AXTreeData::AXTreeData(const ::ui::AXTreeID& tree_id_in, const ::ui::AXTreeID& parent_tree_id_in, const ::ui::AXTreeID& focused_tree_id_in, const std::string& doctype_in,
    bool loaded_in, float loading_progress_in, const std::string& mimetype_in, const std::string& title_in, const std::string& url_in, int32_t focus_id_in, bool sel_is_backward_in,
    int32_t sel_anchor_object_id_in, int32_t sel_anchor_offset_in, ::ax::mojom::TextAffinity sel_anchor_affinity_in, int32_t sel_focus_object_id_in, int32_t sel_focus_offset_in,
    ::ax::mojom::TextAffinity sel_focus_affinity_in, int32_t root_scroller_id_in, absl::optional<std::vector<std::string>> metadata_in)
    : tree_id(std::move(tree_id_in))
    , parent_tree_id(std::move(parent_tree_id_in))
    , focused_tree_id(std::move(focused_tree_id_in))
    , doctype(std::move(doctype_in))
...
bool AXTreeData::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
// static
bool StructTraits<::ax::mojom::AXTreeData::DataView, ::ax::mojom::AXTreeDataPtr>::Read(::ax::mojom::AXTreeData::DataView input, ::ax::mojom::AXTreeDataPtr* output)
{
    bool success = true;
