...
#ifndef UI_ACCESSIBILITY_MOJOM_AX_TREE_ID_MOJOM_BLINK_JUMBO_H_
#define UI_ACCESSIBILITY_MOJOM_AX_TREE_ID_MOJOM_BLINK_JUMBO_H_
#endif
...
AXTreeID::~AXTreeID() { DestroyActive(); }
...
bool AXTreeID::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context, false); }
