...
AXNodeData::AXNodeData(int32_t id_in, ::ax::mojom::Role role_in, uint32_t state_in, uint64_t actions_in,
    ...
    const base::flat_map<::ax::mojom::StringListAttribute, std::vector<std::string>>& stringlist_attributes_in, const base::flat_map<std::string, std::string>& html_attributes_in,
    std::vector<int32_t> child_ids_in, const ::ui::AXRelativeBounds& relative_bounds_in)
    : id(std::move(id_in))
...
bool AXNodeData::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
// static
bool StructTraits<::ax::mojom::AXNodeData::DataView, ::ax::mojom::AXNodeDataPtr>::Read(::ax::mojom::AXNodeData::DataView input, ::ax::mojom::AXNodeDataPtr* output)
{
    bool success = true;
