...
AXActionData::AXActionData(::ax::mojom::Action action_in, const ::ui::AXTreeID& target_tree_id_in, const std::string& source_extension_id_in, int32_t target_node_id_in,
    int32_t request_id_in, int32_t flags_in, int32_t anchor_node_id_in, int32_t anchor_offset_in, int32_t focus_node_id_in, int32_t focus_offset_in, int32_t custom_action_id_in,
    const ::gfx::Rect& target_rect_in, const ::gfx::Point& target_point_in, const std::string& value_in, ::ax::mojom::Event hit_test_event_to_fire_in,
    ::ax::mojom::ScrollAlignment horizontal_scroll_alignment_in, ::ax::mojom::ScrollAlignment vertical_scroll_alignment_in, ::ax::mojom::ScrollBehavior scroll_behavior_in)
...
bool AXActionData::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context); }
...
// static
bool StructTraits<::ax::mojom::AXActionData::DataView, ::ax::mojom::AXActionDataPtr>::Read(::ax::mojom::AXActionData::DataView input, ::ax::mojom::AXActionDataPtr* output)
{
    bool success = true;
