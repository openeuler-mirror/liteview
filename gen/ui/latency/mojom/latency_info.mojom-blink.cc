...
LatencyInfo::LatencyInfo(const WTF::HashMap<::ui::LatencyComponentType, ::base::TimeTicks>& latency_components_in, int64_t trace_id_in, int64_t ukm_source_id_in, bool coalesced_in,
