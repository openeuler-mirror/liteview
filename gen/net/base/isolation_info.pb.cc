...
namespace net {
namespace proto {
PROTOBUF_CONSTEXPR IsolationInfo_PartyContext::IsolationInfo_PartyContext(::_pbi::ConstantInitialized)
    : site_()
{
}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 IsolationInfo_PartyContextDefaultTypeInternal
...
IsolationInfo_PartyContext::IsolationInfo_PartyContext(::PROTOBUF_NAMESPACE_ID::Arena* arena, bool is_message_owned)
...
inline void IsolationInfo_PartyContext::SharedDtor() { GOOGLE_DCHECK(GetArenaForAllocation() == nullptr); }

void IsolationInfo_PartyContext::SetCachedSize(int size) const { _cached_size_.Set(size); }
...
uint8_t* IsolationInfo_PartyContext::_InternalSerialize(uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const
{
...
size_t IsolationInfo_PartyContext::ByteSizeLong() const
{
    ...
    // repeated string site = 1;
    total_size += 1 * ::PROTOBUF_NAMESPACE_ID::internal::FromIntSize(site_.size());
    for (int i = 0, n = site_.size(); i < n; i++) {
        total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::StringSize(site_.Get(i));
    }
...
void IsolationInfo_PartyContext::CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from) { MergeFrom(*::_pbi::DownCast<const IsolationInfo_PartyContext*>(&from)); }
...
bool IsolationInfo_PartyContext::IsInitialized() const { return true; }
...
std::string IsolationInfo_PartyContext::GetTypeName() const { return "net.proto.IsolationInfo.PartyContext"; }
// ===================================================================

class IsolationInfo::_Internal {
public:
    using HasBits = decltype(std::declval<IsolationInfo>()._has_bits_);
    static void set_has_request_type(HasBits* has_bits) { (*has_bits)[0] |= 16u; }
    static void set_has_top_frame_origin(HasBits* has_bits) { (*has_bits)[0] |= 1u; }
    static void set_has_frame_origin(HasBits* has_bits) { (*has_bits)[0] |= 2u; }
    static void set_has_site_for_cookies(HasBits* has_bits) { (*has_bits)[0] |= 4u; }
    static const ::net::proto::IsolationInfo_PartyContext& party_context(const IsolationInfo* msg);
    static void set_has_party_context(HasBits* has_bits) { (*has_bits)[0] |= 8u; }
};

const ::net::proto::IsolationInfo_PartyContext& IsolationInfo::_Internal::party_context(const IsolationInfo* msg) { return *msg->party_context_; }
    ...
    , _has_bits_(from._has_bits_)
{
    ...
    if (from._internal_has_top_frame_origin()) {
        top_frame_origin_.Set(from._internal_top_frame_origin(), GetArenaForAllocation());
    }
    ...
    if (from._internal_has_frame_origin()) {
        frame_origin_.Set(from._internal_frame_origin(), GetArenaForAllocation());
    }
    ...
    if (from._internal_has_site_for_cookies()) {
        site_for_cookies_.Set(from._internal_site_for_cookies(), GetArenaForAllocation());
    }
...
inline void IsolationInfo::SharedCtor()
{
    ...
    site_for_cookies_.Set("", GetArenaForAllocation());
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
    ::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(reinterpret_cast<char*>(&party_context_) - reinterpret_cast<char*>(this)), 0,
        static_cast<size_t>(reinterpret_cast<char*>(&request_type_) - reinterpret_cast<char*>(&party_context_)) + sizeof(request_type_));
}
...
void IsolationInfo::SetCachedSize(int size) const { _cached_size_.Set(size); }
...
uint8_t* IsolationInfo::_InternalSerialize(uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const
{
    ...
    if (cached_has_bits & 0x00000008u) {
        target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::InternalWriteMessage(
            5, _Internal::party_context(this), _Internal::party_context(this).GetCachedSize(), target, stream);
    }
...
size_t IsolationInfo::ByteSizeLong() const
{
    ...
    if (cached_has_bits & 0x0000001fu) {
        ...
        // optional .net.proto.IsolationInfo.PartyContext party_context = 5;
        if (cached_has_bits & 0x00000008u) {
            total_size += 1 + ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::MessageSize(*party_context_);
        }
...
void IsolationInfo::CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from) { MergeFrom(*::_pbi::DownCast<const IsolationInfo*>(&from)); }
...
bool IsolationInfo::IsInitialized() const { return true; }
...
void IsolationInfo::InternalSwap(IsolationInfo* other)
{
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(&top_frame_origin_, lhs_arena, &other->top_frame_origin_, rhs_arena);
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(&frame_origin_, lhs_arena, &other->frame_origin_, rhs_arena);
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(&site_for_cookies_, lhs_arena, &other->site_for_cookies_, rhs_arena);
    ::PROTOBUF_NAMESPACE_ID::internal::memswap<PROTOBUF_FIELD_OFFSET(IsolationInfo, request_type_) + sizeof(IsolationInfo::request_type_)
        - PROTOBUF_FIELD_OFFSET(IsolationInfo, party_context_)>(reinterpret_cast<char*>(&party_context_), reinterpret_cast<char*>(&other->party_context_));
}

std::string IsolationInfo::GetTypeName() const { return "net.proto.IsolationInfo"; }
// @@protoc_insertion_point(namespace_scope)
} // namespace proto
} // namespace net
PROTOBUF_NAMESPACE_OPEN
template <> PROTOBUF_NOINLINE ::net::proto::IsolationInfo_PartyContext* Arena::CreateMaybeMessage<::net::proto::IsolationInfo_PartyContext>(Arena* arena)
{
