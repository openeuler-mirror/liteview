...
public:
    ...
    static void set_has_connection_type(HasBits* has_bits) { (*has_bits)[0] |= 2u; }
    static void set_has_id(HasBits* has_bits) { (*has_bits)[0] |= 1u; }
    static void set_has_signal_strength(HasBits* has_bits) { (*has_bits)[0] |= 4u; }
};
    ...
    , _has_bits_(from._has_bits_)
{
    ...
    ::memcpy(&connection_type_, &from.connection_type_,
        static_cast<size_t>(reinterpret_cast<char*>(&signal_strength_) - reinterpret_cast<char*>(&connection_type_)) + sizeof(signal_strength_));
...
inline void NetworkIDProto::SharedCtor()
{
    ...
    id_.Set("", GetArenaForAllocation());
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
    ::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(reinterpret_cast<char*>(&connection_type_) - reinterpret_cast<char*>(this)), 0,
        static_cast<size_t>(reinterpret_cast<char*>(&signal_strength_) - reinterpret_cast<char*>(&connection_type_)) + sizeof(signal_strength_));
}
...
void NetworkIDProto::SetCachedSize(int size) const { _cached_size_.Set(size); }
...
void NetworkIDProto::Clear()
{
    ...
    if (cached_has_bits & 0x00000006u) {
        ::memset(&connection_type_, 0, static_cast<size_t>(reinterpret_cast<char*>(&signal_strength_) - reinterpret_cast<char*>(&connection_type_)) + sizeof(signal_strength_));
    }
    _has_bits_.Clear();
...
void NetworkIDProto::CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from) { MergeFrom(*::_pbi::DownCast<const NetworkIDProto*>(&from)); }
...
bool NetworkIDProto::IsInitialized() const { return true; }
...
void NetworkIDProto::InternalSwap(NetworkIDProto* other)
{
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::memswap<PROTOBUF_FIELD_OFFSET(NetworkIDProto, signal_strength_) + sizeof(NetworkIDProto::signal_strength_)
        - PROTOBUF_FIELD_OFFSET(NetworkIDProto, connection_type_)>(reinterpret_cast<char*>(&connection_type_), reinterpret_cast<char*>(&other->connection_type_));
}

std::string NetworkIDProto::GetTypeName() const { return "net.nqe.internal.NetworkIDProto"; }
