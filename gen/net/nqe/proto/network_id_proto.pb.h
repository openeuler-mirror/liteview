...
class NET_EXPORT_PRIVATE NetworkIDProto final : public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:net.nqe.internal.NetworkIDProto) */ {
public:
    ...
    static const NetworkIDProto& default_instance() { return *internal_default_instance(); }
    static inline const NetworkIDProto* internal_default_instance() { return reinterpret_cast<const NetworkIDProto*>(&_NetworkIDProto_default_instance_); }
    ...
    NetworkIDProto* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final { return CreateMaybeMessage<NetworkIDProto>(arena); }
...
private:
    ...
    static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() { return "net.nqe.internal.NetworkIDProto"; }
...
inline bool NetworkIDProto::has_connection_type() const { return _internal_has_connection_type(); }
inline void NetworkIDProto::clear_connection_type()
{
    connection_type_ = 0;
    _has_bits_[0] &= ~0x00000002u;
}
inline int32_t NetworkIDProto::_internal_connection_type() const { return connection_type_; }
...
inline bool NetworkIDProto::has_id() const { return _internal_has_id(); }
...
inline const std::string& NetworkIDProto::_internal_id() const { return id_.Get(); }
...
inline bool NetworkIDProto::has_signal_strength() const { return _internal_has_signal_strength(); }
inline void NetworkIDProto::clear_signal_strength()
{
    signal_strength_ = 0;
    _has_bits_[0] &= ~0x00000004u;
}
inline int32_t NetworkIDProto::_internal_signal_strength() const { return signal_strength_; }
