...
public:
    ...
    static const TrustAnchor& default_instance() { return *internal_default_instance(); }
    ...
    static inline const TrustAnchor* internal_default_instance() { return reinterpret_cast<const TrustAnchor*>(&_TrustAnchor_default_instance_); }
    ...
    TrustAnchor* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final { return CreateMaybeMessage<TrustAnchor>(arena); }
...
private:
    ...
    static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() { return "chrome_root_store.TrustAnchor"; }
...
public:
    ...
    static const ::PROTOBUF_NAMESPACE_ID::Descriptor* GetDescriptor() { return default_instance().GetMetadata().descriptor; }
    static const ::PROTOBUF_NAMESPACE_ID::Reflection* GetReflection() { return default_instance().GetMetadata().reflection; }
    static const RootStore& default_instance() { return *internal_default_instance(); }
    static inline const RootStore* internal_default_instance() { return reinterpret_cast<const RootStore*>(&_RootStore_default_instance_); }
    ...
    RootStore* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final { return CreateMaybeMessage<RootStore>(arena); }
    using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
...
private:
    friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
    static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() { return "chrome_root_store.RootStore"; }
...
// bytes der = 1;
inline bool TrustAnchor::_internal_has_der() const { return certificate_case() == kDer; }
inline bool TrustAnchor::has_der() const { return _internal_has_der(); }
inline void TrustAnchor::set_has_der() { _oneof_case_[0] = kDer; }
...
// string sha256_hex = 2;
inline bool TrustAnchor::_internal_has_sha256_hex() const { return certificate_case() == kSha256Hex; }
inline bool TrustAnchor::has_sha256_hex() const { return _internal_has_sha256_hex(); }
inline void TrustAnchor::set_has_sha256_hex() { _oneof_case_[0] = kSha256Hex; }
...
// repeated string ev_policy_oids = 3;
inline int TrustAnchor::_internal_ev_policy_oids_size() const { return ev_policy_oids_.size(); }
inline int TrustAnchor::ev_policy_oids_size() const { return _internal_ev_policy_oids_size(); }
inline void TrustAnchor::clear_ev_policy_oids() { ev_policy_oids_.Clear(); }
...
inline const std::string& TrustAnchor::_internal_ev_policy_oids(int index) const { return ev_policy_oids_.Get(index); }
...
{
    ev_policy_oids_.Mutable(index)->assign(reinterpret_cast<const char*>(value), size);
    // @@protoc_insertion_point(field_set_pointer:chrome_root_store.TrustAnchor.ev_policy_oids)
}
inline std::string* TrustAnchor::_internal_add_ev_policy_oids() { return ev_policy_oids_.Add(); }
...
inline bool TrustAnchor::has_certificate() const { return certificate_case() != CERTIFICATE_NOT_SET; }
inline void TrustAnchor::clear_has_certificate() { _oneof_case_[0] = CERTIFICATE_NOT_SET; }
inline TrustAnchor::CertificateCase TrustAnchor::certificate_case() const { return TrustAnchor::CertificateCase(_oneof_case_[0]); }
// -------------------------------------------------------------------

// RootStore

// repeated .chrome_root_store.TrustAnchor trust_anchors = 1;
inline int RootStore::_internal_trust_anchors_size() const { return trust_anchors_.size(); }
inline int RootStore::trust_anchors_size() const { return _internal_trust_anchors_size(); }
inline void RootStore::clear_trust_anchors() { trust_anchors_.Clear(); }
...
inline const ::chrome_root_store::TrustAnchor& RootStore::_internal_trust_anchors(int index) const { return trust_anchors_.Get(index); }
...
inline ::chrome_root_store::TrustAnchor* RootStore::_internal_add_trust_anchors() { return trust_anchors_.Add(); }
...
// int64 version_major = 2;
inline void RootStore::clear_version_major() { version_major_ = int64_t { 0 }; }
inline int64_t RootStore::_internal_version_major() const { return version_major_; }
...
inline void RootStore::_internal_set_version_major(int64_t value) { version_major_ = value; }
