...
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_root_5fstore_2eproto_getter() { return &descriptor_table_root_5fstore_2eproto; }
...
inline void TrustAnchor::SharedCtor() { clear_has_certificate(); }
...
void TrustAnchor::SetCachedSize(int size) const { _cached_size_.Set(size); }
...
uint8_t* TrustAnchor::_InternalSerialize(uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const
{
    ...
    if (_internal_has_sha256_hex()) {
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(this->_internal_sha256_hex().data(), static_cast<int>(this->_internal_sha256_hex().length()),
            ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE, "chrome_root_store.TrustAnchor.sha256_hex");
    ...
    for (int i = 0, n = this->_internal_ev_policy_oids_size(); i < n; i++) {
        ...
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
            s.data(), static_cast<int>(s.length()), ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE, "chrome_root_store.TrustAnchor.ev_policy_oids");
...
size_t TrustAnchor::ByteSizeLong() const
{
    ...
    // repeated string ev_policy_oids = 3;
    total_size += 1 * ::PROTOBUF_NAMESPACE_ID::internal::FromIntSize(ev_policy_oids_.size());
    for (int i = 0, n = ev_policy_oids_.size(); i < n; i++) {
        total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::StringSize(ev_policy_oids_.Get(i));
    }
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData TrustAnchor::_class_data_ = { ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSizeCheck, TrustAnchor::MergeImpl };
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData* TrustAnchor::GetClassData() const { return &_class_data_; }

void TrustAnchor::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to, const ::PROTOBUF_NAMESPACE_ID::Message& from)
{
    static_cast<TrustAnchor*>(to)->MergeFrom(static_cast<const TrustAnchor&>(from));
}
...
bool TrustAnchor::IsInitialized() const { return true; }
...
{
    return ::_pbi::AssignDescriptors(&descriptor_table_root_5fstore_2eproto_getter, &descriptor_table_root_5fstore_2eproto_once, file_level_metadata_root_5fstore_2eproto[0]);
}
...
inline void RootStore::SharedCtor() { version_major_ = int64_t { 0 }; }
...
inline void RootStore::SharedDtor() { GOOGLE_DCHECK(GetArenaForAllocation() == nullptr); }

void RootStore::SetCachedSize(int size) const { _cached_size_.Set(size); }
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData RootStore::_class_data_ = { ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSizeCheck, RootStore::MergeImpl };
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData* RootStore::GetClassData() const { return &_class_data_; }

void RootStore::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to, const ::PROTOBUF_NAMESPACE_ID::Message& from)
{
    static_cast<RootStore*>(to)->MergeFrom(static_cast<const RootStore&>(from));
}
...
bool RootStore::IsInitialized() const { return true; }
...
{
    return ::_pbi::AssignDescriptors(&descriptor_table_root_5fstore_2eproto_getter, &descriptor_table_root_5fstore_2eproto_once, file_level_metadata_root_5fstore_2eproto[1]);
}
