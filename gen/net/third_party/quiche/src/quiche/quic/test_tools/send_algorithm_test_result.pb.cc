...
public:
    ...
    static void set_has_test_name(HasBits* has_bits) { (*has_bits)[0] |= 1u; }
    static void set_has_random_seed(HasBits* has_bits) { (*has_bits)[0] |= 2u; }
    static void set_has_simulated_duration_micros(HasBits* has_bits) { (*has_bits)[0] |= 4u; }
};
    ...
    , _has_bits_(from._has_bits_)
{
    ...
    if (from._internal_has_test_name()) {
        test_name_.Set(from._internal_test_name(), GetArenaForAllocation());
    }
    ::memcpy(&random_seed_, &from.random_seed_,
        static_cast<size_t>(reinterpret_cast<char*>(&simulated_duration_micros_) - reinterpret_cast<char*>(&random_seed_)) + sizeof(simulated_duration_micros_));
...
inline void SendAlgorithmTestResult::SharedCtor()
{
    ...
    test_name_.Set("", GetArenaForAllocation());
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
    ::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(reinterpret_cast<char*>(&random_seed_) - reinterpret_cast<char*>(this)), 0,
        static_cast<size_t>(reinterpret_cast<char*>(&simulated_duration_micros_) - reinterpret_cast<char*>(&random_seed_)) + sizeof(simulated_duration_micros_));
}
...
void SendAlgorithmTestResult::SetCachedSize(int size) const { _cached_size_.Set(size); }
...
void SendAlgorithmTestResult::CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from) { MergeFrom(*::_pbi::DownCast<const SendAlgorithmTestResult*>(&from)); }
...
bool SendAlgorithmTestResult::IsInitialized() const { return true; }
...
void SendAlgorithmTestResult::InternalSwap(SendAlgorithmTestResult* other)
{
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(&test_name_, lhs_arena, &other->test_name_, rhs_arena);
    ::PROTOBUF_NAMESPACE_ID::internal::memswap<PROTOBUF_FIELD_OFFSET(SendAlgorithmTestResult, simulated_duration_micros_)
        + sizeof(SendAlgorithmTestResult::simulated_duration_micros_) - PROTOBUF_FIELD_OFFSET(SendAlgorithmTestResult, random_seed_)>(
        reinterpret_cast<char*>(&random_seed_), reinterpret_cast<char*>(&other->random_seed_));
}

std::string SendAlgorithmTestResult::GetTypeName() const { return "quic.SendAlgorithmTestResult"; }
