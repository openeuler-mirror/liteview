...
class NET_EXPORT_PRIVATE SendAlgorithmTestResult final : public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:quic.SendAlgorithmTestResult) */ {
public:
    ...
    static const SendAlgorithmTestResult& default_instance() { return *internal_default_instance(); }
    ...
    SendAlgorithmTestResult* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final { return CreateMaybeMessage<SendAlgorithmTestResult>(arena); }
...
private:
    ...
    static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() { return "quic.SendAlgorithmTestResult"; }
...
inline bool SendAlgorithmTestResult::has_test_name() const { return _internal_has_test_name(); }
...
inline const std::string& SendAlgorithmTestResult::_internal_test_name() const { return test_name_.Get(); }
...
inline bool SendAlgorithmTestResult::has_random_seed() const { return _internal_has_random_seed(); }
inline void SendAlgorithmTestResult::clear_random_seed()
{
    random_seed_ = uint64_t { 0u };
    _has_bits_[0] &= ~0x00000002u;
}
inline uint64_t SendAlgorithmTestResult::_internal_random_seed() const { return random_seed_; }
...
inline bool SendAlgorithmTestResult::has_simulated_duration_micros() const { return _internal_has_simulated_duration_micros(); }
inline void SendAlgorithmTestResult::clear_simulated_duration_micros()
{
    simulated_duration_micros_ = int64_t { 0 };
    _has_bits_[0] &= ~0x00000004u;
}
inline int64_t SendAlgorithmTestResult::_internal_simulated_duration_micros() const { return simulated_duration_micros_; }
