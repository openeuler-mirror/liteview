...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 QuicServerConfigProtobuf_PrivateKeyDefaultTypeInternal
...
public:
    ...
    static void set_has_tag(HasBits* has_bits) { (*has_bits)[0] |= 2u; }
    static void set_has_private_key(HasBits* has_bits) { (*has_bits)[0] |= 1u; }
    ...
    , _has_bits_(from._has_bits_)
{
    ...
    if (from._internal_has_private_key()) {
        private_key_.Set(from._internal_private_key(), GetArenaForAllocation());
    }
    tag_ = from.tag_;
...
void QuicServerConfigProtobuf_PrivateKey::SetCachedSize(int size) const { _cached_size_.Set(size); }
...
void QuicServerConfigProtobuf_PrivateKey::InternalSwap(QuicServerConfigProtobuf_PrivateKey* other)
{
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(&private_key_, lhs_arena, &other->private_key_, rhs_arena);
    swap(tag_, other->tag_);
}

std::string QuicServerConfigProtobuf_PrivateKey::GetTypeName() const { return "quic.QuicServerConfigProtobuf.PrivateKey"; }
// ===================================================================

class QuicServerConfigProtobuf::_Internal {
public:
    using HasBits = decltype(std::declval<QuicServerConfigProtobuf>()._has_bits_);
    static void set_has_config(HasBits* has_bits) { (*has_bits)[0] |= 1u; }
    static void set_has_primary_time(HasBits* has_bits) { (*has_bits)[0] |= 2u; }
    static void set_has_priority(HasBits* has_bits) { (*has_bits)[0] |= 4u; }
    ...
    , key_(from.key_)
{
    ...
    if (from._internal_has_config()) {
        config_.Set(from._internal_config(), GetArenaForAllocation());
    }
    ::memcpy(&primary_time_, &from.primary_time_, static_cast<size_t>(reinterpret_cast<char*>(&priority_) - reinterpret_cast<char*>(&primary_time_)) + sizeof(priority_));
...
inline void QuicServerConfigProtobuf::SharedCtor()
{
    ...
    config_.Set("", GetArenaForAllocation());
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
    ::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(reinterpret_cast<char*>(&primary_time_) - reinterpret_cast<char*>(this)), 0,
        static_cast<size_t>(reinterpret_cast<char*>(&priority_) - reinterpret_cast<char*>(&primary_time_)) + sizeof(priority_));
}
...
void QuicServerConfigProtobuf::SetCachedSize(int size) const { _cached_size_.Set(size); }
...
void QuicServerConfigProtobuf::Clear()
{
    ...
    if (cached_has_bits & 0x00000006u) {
        ::memset(&primary_time_, 0, static_cast<size_t>(reinterpret_cast<char*>(&priority_) - reinterpret_cast<char*>(&primary_time_)) + sizeof(priority_));
    }
    _has_bits_.Clear();
    _internal_metadata_.Clear<std::string>();
}
...
void QuicServerConfigProtobuf::CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from) { MergeFrom(*::_pbi::DownCast<const QuicServerConfigProtobuf*>(&from)); }
...
void QuicServerConfigProtobuf::InternalSwap(QuicServerConfigProtobuf* other)
{
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(&config_, lhs_arena, &other->config_, rhs_arena);
    ::PROTOBUF_NAMESPACE_ID::internal::memswap<PROTOBUF_FIELD_OFFSET(QuicServerConfigProtobuf, priority_) + sizeof(QuicServerConfigProtobuf::priority_)
        - PROTOBUF_FIELD_OFFSET(QuicServerConfigProtobuf, primary_time_)>(reinterpret_cast<char*>(&primary_time_), reinterpret_cast<char*>(&other->primary_time_));
}

std::string QuicServerConfigProtobuf::GetTypeName() const { return "quic.QuicServerConfigProtobuf"; }
