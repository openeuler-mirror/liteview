...
class COMPONENT_EXPORT(QUICHE) SourceAddressToken final : public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:quic.SourceAddressToken) */ {
public:
    ...
    static const SourceAddressToken& default_instance() { return *internal_default_instance(); }
    static inline const SourceAddressToken* internal_default_instance() { return reinterpret_cast<const SourceAddressToken*>(&_SourceAddressToken_default_instance_); }
    ...
    SourceAddressToken* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final { return CreateMaybeMessage<SourceAddressToken>(arena); }
...
private:
    ...
    static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() { return "quic.SourceAddressToken"; }
...
class COMPONENT_EXPORT(QUICHE) SourceAddressTokens final : public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:quic.SourceAddressTokens) */ {
public:
    ...
    static const SourceAddressTokens& default_instance() { return *internal_default_instance(); }
    static inline const SourceAddressTokens* internal_default_instance() { return reinterpret_cast<const SourceAddressTokens*>(&_SourceAddressTokens_default_instance_); }
    ...
    SourceAddressTokens* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final { return CreateMaybeMessage<SourceAddressTokens>(arena); }
    void CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from) final;
...
private:
    friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
    static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() { return "quic.SourceAddressTokens"; }
...
inline bool SourceAddressToken::has_ip() const { return _internal_has_ip(); }
...
inline const std::string& SourceAddressToken::_internal_ip() const { return ip_.Get(); }
...
inline bool SourceAddressToken::has_timestamp() const { return _internal_has_timestamp(); }
inline void SourceAddressToken::clear_timestamp()
{
    timestamp_ = int64_t { 0 };
    _has_bits_[0] &= ~0x00000004u;
}
inline int64_t SourceAddressToken::_internal_timestamp() const { return timestamp_; }
...
inline bool SourceAddressToken::has_cached_network_parameters() const { return _internal_has_cached_network_parameters(); }
...
// repeated .quic.SourceAddressToken tokens = 4;
inline int SourceAddressTokens::_internal_tokens_size() const { return tokens_.size(); }
inline int SourceAddressTokens::tokens_size() const { return _internal_tokens_size(); }
inline void SourceAddressTokens::clear_tokens() { tokens_.Clear(); }
...
inline const ::quic::SourceAddressToken& SourceAddressTokens::_internal_tokens(int index) const { return tokens_.Get(index); }
...
inline ::quic::SourceAddressToken* SourceAddressTokens::_internal_add_tokens() { return tokens_.Add(); }
