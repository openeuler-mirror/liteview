...
public:
    ...
    static void set_has_timestamp(HasBits* has_bits) { (*has_bits)[0] |= 4u; }
    static const ::quic::CachedNetworkParameters& cached_network_parameters(const SourceAddressToken* msg);
    static void set_has_cached_network_parameters(HasBits* has_bits) { (*has_bits)[0] |= 2u; }
    static bool MissingRequiredFields(const HasBits& has_bits) { return ((has_bits[0] & 0x00000005) ^ 0x00000005) != 0; }
};

const ::quic::CachedNetworkParameters& SourceAddressToken::_Internal::cached_network_parameters(const SourceAddressToken* msg) { return *msg->cached_network_parameters_; }
    ...
    , _has_bits_(from._has_bits_)
{
    ...
    if (from._internal_has_ip()) {
        ip_.Set(from._internal_ip(), GetArenaForAllocation());
    }
...
inline void SourceAddressToken::SharedCtor()
{
    ...
    ip_.Set("", GetArenaForAllocation());
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
    ::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(reinterpret_cast<char*>(&cached_network_parameters_) - reinterpret_cast<char*>(this)), 0,
        static_cast<size_t>(reinterpret_cast<char*>(&timestamp_) - reinterpret_cast<char*>(&cached_network_parameters_)) + sizeof(timestamp_));
}
...
void SourceAddressToken::SetCachedSize(int size) const { _cached_size_.Set(size); }
...
size_t SourceAddressToken::ByteSizeLong() const
{
    ...
    cached_has_bits = _has_bits_[0];
    if (cached_has_bits & 0x00000002u) {
        total_size += 1 + ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::MessageSize(*cached_network_parameters_);
    }
...
void SourceAddressToken::CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from) { MergeFrom(*::_pbi::DownCast<const SourceAddressToken*>(&from)); }
...
void SourceAddressToken::InternalSwap(SourceAddressToken* other)
{
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(&ip_, lhs_arena, &other->ip_, rhs_arena);
    ::PROTOBUF_NAMESPACE_ID::internal::memswap<PROTOBUF_FIELD_OFFSET(SourceAddressToken, timestamp_) + sizeof(SourceAddressToken::timestamp_)
        - PROTOBUF_FIELD_OFFSET(SourceAddressToken, cached_network_parameters_)>(
        reinterpret_cast<char*>(&cached_network_parameters_), reinterpret_cast<char*>(&other->cached_network_parameters_));
}

std::string SourceAddressToken::GetTypeName() const { return "quic.SourceAddressToken"; }
// ===================================================================
...
inline void SourceAddressTokens::SharedDtor() { GOOGLE_DCHECK(GetArenaForAllocation() == nullptr); }

void SourceAddressTokens::SetCachedSize(int size) const { _cached_size_.Set(size); }
...
void SourceAddressTokens::CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from) { MergeFrom(*::_pbi::DownCast<const SourceAddressTokens*>(&from)); }
...
std::string SourceAddressTokens::GetTypeName() const { return "quic.SourceAddressTokens"; }
