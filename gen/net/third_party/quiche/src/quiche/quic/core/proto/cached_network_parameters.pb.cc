...
public:
    ...
    static void set_has_serving_region(HasBits* has_bits) { (*has_bits)[0] |= 1u; }
    static void set_has_bandwidth_estimate_bytes_per_second(HasBits* has_bits) { (*has_bits)[0] |= 2u; }
    static void set_has_max_bandwidth_estimate_bytes_per_second(HasBits* has_bits) { (*has_bits)[0] |= 16u; }
    static void set_has_max_bandwidth_timestamp_seconds(HasBits* has_bits) { (*has_bits)[0] |= 32u; }
    static void set_has_min_rtt_ms(HasBits* has_bits) { (*has_bits)[0] |= 4u; }
    static void set_has_previous_connection_state(HasBits* has_bits) { (*has_bits)[0] |= 8u; }
    ...
    , _has_bits_(from._has_bits_)
{
    ...
    if (from._internal_has_serving_region()) {
        serving_region_.Set(from._internal_serving_region(), GetArenaForAllocation());
    }
    ::memcpy(&bandwidth_estimate_bytes_per_second_, &from.bandwidth_estimate_bytes_per_second_,
        static_cast<size_t>(reinterpret_cast<char*>(&timestamp_) - reinterpret_cast<char*>(&bandwidth_estimate_bytes_per_second_)) + sizeof(timestamp_));
...
inline void CachedNetworkParameters::SharedCtor()
{
    ...
    serving_region_.Set("", GetArenaForAllocation());
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
    ::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(reinterpret_cast<char*>(&bandwidth_estimate_bytes_per_second_) - reinterpret_cast<char*>(this)), 0,
        static_cast<size_t>(reinterpret_cast<char*>(&timestamp_) - reinterpret_cast<char*>(&bandwidth_estimate_bytes_per_second_)) + sizeof(timestamp_));
}
...
void CachedNetworkParameters::SetCachedSize(int size) const { _cached_size_.Set(size); }
...
void CachedNetworkParameters::Clear()
{
    ...
    if (cached_has_bits & 0x0000007eu) {
        ::memset(&bandwidth_estimate_bytes_per_second_, 0,
            static_cast<size_t>(reinterpret_cast<char*>(&timestamp_) - reinterpret_cast<char*>(&bandwidth_estimate_bytes_per_second_)) + sizeof(timestamp_));
    }
    _has_bits_.Clear();
...
void CachedNetworkParameters::CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from) { MergeFrom(*::_pbi::DownCast<const CachedNetworkParameters*>(&from)); }
...
bool CachedNetworkParameters::IsInitialized() const { return true; }
...
void CachedNetworkParameters::InternalSwap(CachedNetworkParameters* other)
{
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(&serving_region_, lhs_arena, &other->serving_region_, rhs_arena);
    ::PROTOBUF_NAMESPACE_ID::internal::memswap<PROTOBUF_FIELD_OFFSET(CachedNetworkParameters, timestamp_) + sizeof(CachedNetworkParameters::timestamp_)
        - PROTOBUF_FIELD_OFFSET(CachedNetworkParameters, bandwidth_estimate_bytes_per_second_)>(
        reinterpret_cast<char*>(&bandwidth_estimate_bytes_per_second_), reinterpret_cast<char*>(&other->bandwidth_estimate_bytes_per_second_));
}

std::string CachedNetworkParameters::GetTypeName() const { return "quic.CachedNetworkParameters"; }
