    ...
    TNode<Smi> p_baseB, TNode<Smi> p_lengthBArg)
{
    ...
    if (block136.is_used()) {
        ...
        tmp173 = ca_.CallStub<Smi>(
            Builtins::CallableFor(ca_.isolate(), Builtin::kGallopRight), p_context, p_sortState, tmp2, tmp171, phi_bb136_11, phi_bb136_6, tmp172);
    ...
    TNode<Smi> p_baseB, TNode<Smi> p_lengthBArg)
{
    ...
    if (block136.is_used()) {
        ...
        tmp181 = ca_.CallStub<Smi>(
            Builtins::CallableFor(ca_.isolate(), Builtin::kGallopRight), p_context, p_sortState, tmp1, tmp178, p_baseA, phi_bb136_6, tmp180);
    ...
    compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<SortState> p_sortState, bool p_isToSorted)
{
    ...
    if (block33.is_used()) {
        ...
        tmp36
            = ExtractFixedArray_0(state_, TNode<FixedArray> { phi_bb33_2 }, TNode<IntPtrT> { tmp35 }, TNode<IntPtrT> { phi_bb33_4 }, TNode<IntPtrT> { tmp34 });
    ...
    if (block34.is_used()) {
        ...
        ca_.Branch(tmp44, &block52, std::vector<compiler::Node*> { phi_bb34_7, phi_bb34_8, phi_bb34_9, phi_bb34_4, phi_bb34_4, phi_bb34_4, phi_bb34_4 },
