...
public:
    ...
    Value<ExternalPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> GetCallTargetValue(
        d::MemoryAccessor accessor) const;
};
...
public:
    ...
    Value<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> GetParameterSizeValue(
        d::MemoryAccessor accessor) const;
    ...
    Value<uint16_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> GetBytecodeAgeValue(
        d::MemoryAccessor accessor) const;
};
...
public:
    ...
    Value<uint16_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> GetFiller16BitsValue(
        d::MemoryAccessor accessor) const;
...
public:
    ...
    Value<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> GetProfilerTicksValue(
        d::MemoryAccessor accessor) const;
    uintptr_t GetPlaceholder0Address() const;
    Value<uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> GetPlaceholder0Value(
        d::MemoryAccessor accessor) const;
...
public:
    ...
    Value<Address /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> GetExtensionValue(
        d::MemoryAccessor accessor) const;
    uintptr_t GetBitFieldAddress() const;
    Value<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> GetBitFieldValue(
        d::MemoryAccessor accessor) const;
...
public:
    ...
    Value<Address /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> GetIsolateRootValue(
        d::MemoryAccessor accessor) const;
    uintptr_t GetNativeContextAddress() const;
    Value<uintptr_t> GetNativeContextValue(d::MemoryAccessor accessor) const;
    uintptr_t GetCallableAddress() const;
...
public:
    ...
    Value<ExternalPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> GetSigValue(
        d::MemoryAccessor accessor) const;
};
...
public:
    ...
    bool IsSuperclassOf(const TqObject* other) const override;
    uintptr_t GetSizeAddress() const;
    Value<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> GetSizeValue(
        d::MemoryAccessor accessor) const;
    uintptr_t GetSigIdsAddress() const;
    Value<Address /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> GetSigIdsValue(
        d::MemoryAccessor accessor) const;
    uintptr_t GetTargetsAddress() const;
    Value<Address /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> GetTargetsValue(
        d::MemoryAccessor accessor) const;
...
public:
    ...
    Value<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> GetTypeIndexValue(
        d::MemoryAccessor accessor) const;
    uintptr_t GetInstanceAddress() const;
    Value<uintptr_t> GetInstanceValue(d::MemoryAccessor accessor) const;
