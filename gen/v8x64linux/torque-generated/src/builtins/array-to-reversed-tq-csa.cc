...
TNode<JSArray> TryFastPackedArrayToReversed_0(
    compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_receiver, compiler::CodeAssemblerLabel* label_Slow)
{
    ...
    if (block7.is_used()) {
        ...
        tmp15 = FastPackedArrayToReversed_FastPackedSmiElements_Smi_0(
            state_, TNode<Context> { p_context }, ElementsKind::PACKED_SMI_ELEMENTS, TNode<FixedArrayBase> { tmp13 }, TNode<Smi> { tmp14 });
    ...
    if (block9.is_used()) {
        ...
        tmp21 = FastPackedArrayToReversed_FastPackedObjectElements_JSAny_0(
            state_, TNode<Context> { p_context }, ElementsKind::PACKED_ELEMENTS, TNode<FixedArrayBase> { tmp19 }, TNode<Smi> { tmp20 });
    ...
    if (block11.is_used()) {
        ...
        tmp27 = FastPackedArrayToReversed_FastPackedDoubleElements_float64_0(
            state_, TNode<Context> { p_context }, ElementsKind::PACKED_DOUBLE_ELEMENTS, TNode<FixedArrayBase> { tmp25 }, TNode<Smi> { tmp26 });
...
TNode<JSArray> FastPackedArrayToReversed_FastPackedSmiElements_Smi_0(
    compiler::CodeAssemblerState* state_, TNode<Context> p_context, ElementsKind p_kind, TNode<FixedArrayBase> p_elements, TNode<Smi> p_length)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    if (block2.is_used()) {
        ...
        StoreElement_FastPackedSmiElements_Smi_0(
            state_, TNode<Context> { p_context }, TNode<FixedArrayBase> { tmp1 }, TNode<Smi> { phi_bb2_4 }, TNode<Smi> { tmp7 });
...
TNode<JSArray> FastPackedArrayToReversed_FastPackedObjectElements_JSAny_0(
    compiler::CodeAssemblerState* state_, TNode<Context> p_context, ElementsKind p_kind, TNode<FixedArrayBase> p_elements, TNode<Smi> p_length)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    ...
    if (block2.is_used()) {
        ...
        StoreElement_FastPackedObjectElements_JSAny_0(
            state_, TNode<Context> { p_context }, TNode<FixedArrayBase> { tmp1 }, TNode<Smi> { phi_bb2_4 }, TNode<Object> { tmp7 });
        tmp8 = FromConstexpr_Smi_constexpr_int31_0(state_, 1);
        tmp9 = CodeStubAssembler(state_).SmiAdd(TNode<Smi> { phi_bb2_4 }, TNode<Smi> { tmp8 });
        ca_.Goto(&block4, tmp9);
    }
...
TNode<JSArray> FastPackedArrayToReversed_FastPackedDoubleElements_float64_0(
    compiler::CodeAssemblerState* state_, TNode<Context> p_context, ElementsKind p_kind, TNode<FixedArrayBase> p_elements, TNode<Smi> p_length)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    ...
    if (block2.is_used()) {
        ...
        StoreElement_FastPackedDoubleElements_float64_0(
            state_, TNode<Context> { p_context }, TNode<FixedArrayBase> { tmp1 }, TNode<Smi> { phi_bb2_4 }, TNode<Float64T> { tmp7 });
        tmp8 = FromConstexpr_Smi_constexpr_int31_0(state_, 1);
        tmp9 = CodeStubAssembler(state_).SmiAdd(TNode<Smi> { phi_bb2_4 }, TNode<Smi> { tmp8 });
        ca_.Goto(&block4, tmp9);
    }
