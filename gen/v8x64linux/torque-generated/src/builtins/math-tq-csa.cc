...
TF_BUILTIN(MathHypot, CodeStubAssembler)
{
    ...
    compiler::CodeAssemblerParameterizedLabel<BoolT, Float64T, IntPtrT, IntPtrT, IntPtrT, IntPtrT, IntPtrT> block14(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<BoolT, Float64T, IntPtrT, IntPtrT, IntPtrT, IntPtrT, IntPtrT> block15(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    compiler::CodeAssemblerParameterizedLabel<BoolT, Float64T, Float64T, Float64T, IntPtrT, IntPtrT, IntPtrT, IntPtrT, IntPtrT> block40(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<BoolT, Float64T, Float64T, Float64T, IntPtrT, IntPtrT, IntPtrT, IntPtrT, IntPtrT> block41(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    if (block5.is_used()) {
        ...
        ca_.Branch(tmp7, &block3, std::vector<compiler::Node*> { phi_bb5_8, phi_bb5_9, phi_bb5_10 }, &block4,
    ...
    if (block3.is_used()) {
        ...
        ca_.Branch(tmp11, &block7, std::vector<compiler::Node*> { phi_bb3_8, phi_bb3_9, phi_bb3_10 }, &block8,
            std::vector<compiler::Node*> { phi_bb3_8, phi_bb3_9, phi_bb3_10 });
    }
    ...
    if (block8.is_used()) {
        ...
        ca_.Branch(tmp19, &block14, std::vector<compiler::Node*> { phi_bb8_8, phi_bb8_9, phi_bb8_10, phi_bb8_10, phi_bb8_10, phi_bb8_10, phi_bb8_10 }, &block15,
            std::vector<compiler::Node*> { phi_bb8_8, phi_bb8_9, phi_bb8_10, phi_bb8_10, phi_bb8_10, phi_bb8_10, phi_bb8_10 });
    }
    ...
    if (block14.is_used()) {
        ...
        StoreFloat64OrHole_0(state_, TorqueStructReference_float64_or_hole_0 { TNode<Object> { tmp22 }, TNode<IntPtrT> { tmp23 }, TorqueStructUnsafe_0 {} },
            TorqueStructfloat64_or_hole_0 { TNode<BoolT> { tmp24 }, TNode<Float64T> { tmp25 } });
        tmp26 = CodeStubAssembler(state_).Float64GreaterThan(TNode<Float64T> { tmp13 }, TNode<Float64T> { phi_bb14_9 });
        ca_.Branch(tmp26, &block18, std::vector<compiler::Node*> { phi_bb14_8, phi_bb14_9, phi_bb14_10 }, &block19,
            std::vector<compiler::Node*> { phi_bb14_8, phi_bb14_9, phi_bb14_10 });
    }
    ...
    if (block21.is_used()) {
        ...
        ca_.Branch(
            phi_bb21_8, &block23, std::vector<compiler::Node*> { phi_bb21_8, phi_bb21_9 }, &block24, std::vector<compiler::Node*> { phi_bb21_8, phi_bb21_9 });
    }
    ...
    if (block34.is_used()) {
        ...
        ca_.Branch(tmp39, &block32, std::vector<compiler::Node*> { phi_bb34_8, phi_bb34_9, phi_bb34_10, phi_bb34_11, phi_bb34_12 }, &block33,
            std::vector<compiler::Node*> { phi_bb34_8, phi_bb34_9, phi_bb34_10, phi_bb34_11, phi_bb34_12 });
    }
    ...
    if (block32.is_used()) {
        ...
        ca_.Branch(tmp45, &block40,
            std::vector<compiler::Node*> { phi_bb32_8, phi_bb32_9, phi_bb32_10, phi_bb32_11, phi_bb32_12, phi_bb32_12, phi_bb32_12, phi_bb32_12, phi_bb32_12 },
            &block41,
            std::vector<compiler::Node*> { phi_bb32_8, phi_bb32_9, phi_bb32_10, phi_bb32_11, phi_bb32_12, phi_bb32_12, phi_bb32_12, phi_bb32_12, phi_bb32_12 });
    }
    ...
    if (block40.is_used()) {
        ...
        std::tie(tmp50, tmp51) = LoadFloat64OrHole_0(
            state_, TorqueStructReference_float64_or_hole_0 { TNode<Object> { tmp48 }, TNode<IntPtrT> { tmp49 }, TorqueStructUnsafe_0 {} })
                                     .Flatten();
