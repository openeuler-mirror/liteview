...
TF_BUILTIN(ArrayReducePreLoopEagerDeoptContinuation, CodeStubAssembler)
{
    ...
    if (block11.is_used()) {
        ...
        tmp8
            = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtin::kArrayReduceLoopContinuation), parameter0, tmp0, tmp2, tmp6, tmp0, tmp7, tmp4);
...
TF_BUILTIN(ArrayReduceLoopEagerDeoptContinuation, CodeStubAssembler)
{
    ...
    if (block15.is_used()) {
        ...
        tmp8 = ca_.CallStub<Object>(
            Builtins::CallableFor(ca_.isolate(), Builtin::kArrayReduceLoopContinuation), parameter0, tmp0, tmp2, parameter5, tmp0, tmp4, tmp6);
        CodeStubAssembler(state_).Return(tmp8);
    }
}
...
TF_BUILTIN(ArrayReduce, CodeStubAssembler)
{
    ...
    if (block14.is_used()) {
        ...
        tmp18 = ca_.CallStub<Object>(
            Builtins::CallableFor(ca_.isolate(), Builtin::kArrayReduceLoopContinuation), parameter0, tmp1, tmp7, tmp17.value(), tmp1, tmp16.value(), tmp2);
