...
TF_BUILTIN(ArrayFindLoopEagerDeoptContinuation, CodeStubAssembler)
{
    ...
    if (block15.is_used()) {
        ...
        tmp8 = ca_.CallStub<Object>(
            Builtins::CallableFor(ca_.isolate(), Builtin::kArrayFindLoopContinuation), parameter0, tmp0, tmp2, parameter3, tmp0, tmp4, tmp6);
...
TF_BUILTIN(ArrayPrototypeFind, CodeStubAssembler)
{
    ...
    if (block10.is_used()) {
        ...
        tmp14 = ca_.CallStub<Object>(
            Builtins::CallableFor(ca_.isolate(), Builtin::kArrayFindLoopContinuation), parameter0, tmp1, tmp7, tmp10, tmp1, tmp13.value(), tmp2);
