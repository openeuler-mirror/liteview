...
TF_BUILTIN(PromiseAllResolveElementClosure, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ...
        tmp1 = PromiseAllResolveElementClosure_PromiseAllWrapResultAsFulfilledFunctor_0(state_, TNode<Context> { tmp0 }, TNode<Object> { parameter3 },
            TNode<JSFunction> { parameter2 }, TorqueStructPromiseAllWrapResultAsFulfilledFunctor_0 {}, false);
...
TF_BUILTIN(PromiseAllSettledResolveElementClosure, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ...
        tmp1 = PromiseAllResolveElementClosure_PromiseAllSettledWrapResultAsFulfilledFunctor_0(state_, TNode<Context> { tmp0 }, TNode<Object> { parameter3 },
            TNode<JSFunction> { parameter2 }, TorqueStructPromiseAllSettledWrapResultAsFulfilledFunctor_0 {}, true);
        CodeStubAssembler(state_).Return(tmp1);
    }
}
...
TF_BUILTIN(PromiseAllSettledRejectElementClosure, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ...
        tmp1 = PromiseAllResolveElementClosure_PromiseAllSettledWrapResultAsRejectedFunctor_0(state_, TNode<Context> { tmp0 }, TNode<Object> { parameter3 },
            TNode<JSFunction> { parameter2 }, TorqueStructPromiseAllSettledWrapResultAsRejectedFunctor_0 {}, true);
        CodeStubAssembler(state_).Return(tmp1);
    }
}
    ...
    bool p_hasResolveAndRejectClosures)
{
    ...
    if (block47.is_used()) {
        ...
        tmp74 = CodeStubAssembler(state_).Call(
            TNode<Context> { ca_.UncheckedCast<Context>(p_context) }, TNode<Object> { tmp67 }, TNode<Object> { tmp73 }, TNode<Object> { tmp72 });
        ca_.Goto(&block48);
    }
    ...
    bool p_hasResolveAndRejectClosures)
{
    ...
    if (block47.is_used()) {
        ...
        tmp87 = CodeStubAssembler(state_).Call(
            TNode<Context> { ca_.UncheckedCast<Context>(p_context) }, TNode<Object> { tmp80 }, TNode<Object> { tmp86 }, TNode<Object> { tmp85 });
        ca_.Goto(&block48);
    }
