...
TorqueStructReference_HashTable_0 NewReference_HashTable_0(compiler::CodeAssemblerState* state_, TNode<Object> p_object, TNode<IntPtrT> p_offset)
{
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        std::tie(tmp0, tmp1)
            = (TorqueStructReference_HashTable_0 { TNode<Object> { p_object }, TNode<IntPtrT> { p_offset }, TorqueStructUnsafe_0 {} }).Flatten();
        ca_.Goto(&block2);
    }
    ...
    compiler::CodeAssemblerState* state_, TNode<Object> p_object, TNode<IntPtrT> p_offset)
{
    ...
    ca_.Bind(&block2);
    return TorqueStructReference_JSReceiver_OR_Undefined_OR_Null_OR_False_OR_True_OR_Symbol_OR_String_OR_BigInt_OR_HeapNumber_OR_Smi_OR_TheHole_0 {
...
TorqueStructReference_PositionInfo_0 NewReference_PositionInfo_0(compiler::CodeAssemblerState* state_, TNode<Object> p_object, TNode<IntPtrT> p_offset)
{
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        std::tie(tmp0, tmp1)
            = (TorqueStructReference_PositionInfo_0 { TNode<Object> { p_object }, TNode<IntPtrT> { p_offset }, TorqueStructUnsafe_0 {} }).Flatten();
        ca_.Goto(&block2);
    }
