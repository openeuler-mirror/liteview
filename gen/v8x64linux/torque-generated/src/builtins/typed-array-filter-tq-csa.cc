...
TF_BUILTIN(TypedArrayPrototypeFilter, CodeStubAssembler)
{
    ...
    if (block36.is_used()) {
        ...
        tmp37 = ExtractFixedArray_0(
            state_, TNode<FixedArray> { phi_bb36_11 }, TNode<IntPtrT> { tmp36 }, TNode<IntPtrT> { phi_bb36_13 }, TNode<IntPtrT> { tmp35 });
    ...
    if (block14.is_used()) {
        ...
        tmp53 = TypedArraySpeciesCreateByLength_0(
            state_, TNode<Context> { parameter0 }, kBuiltinNameFilter_0(state_), TNode<JSTypedArray> { tmp0 }, TNode<UintPtrT> { tmp52 });
        ...
        tmp59 = ExtractFixedArray_0(
            state_, TNode<FixedArray> { phi_bb14_11 }, TNode<IntPtrT> { tmp58 }, TNode<IntPtrT> { phi_bb14_13 }, TNode<IntPtrT> { phi_bb14_13 });
