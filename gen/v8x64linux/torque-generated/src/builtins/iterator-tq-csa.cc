...
TF_BUILTIN(GetIteratorWithFeedback, CodeStubAssembler)
{
    ...
    if (block11.is_used()) {
        ...
        tmp3 = ca_.CallStub<Object>(
            Builtins::CallableFor(ca_.isolate(), Builtin::kLoadIC), parameter0, parameter1, tmp2, parameter2, ca_.UncheckedCast<FeedbackVector>(parameter4));
    ...
    if (block8.is_used()) {
        ...
        tmp7 = ca_.CallStub<Object>(
            Builtins::CallableFor(ca_.isolate(), Builtin::kCallIteratorWithFeedback), parameter0, parameter1, phi_bb8_5, tmp6, parameter4);
