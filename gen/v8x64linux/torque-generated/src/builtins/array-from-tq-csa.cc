...
TF_BUILTIN(ArrayFrom, CodeStubAssembler)
{
    ...
    if (block43.is_used()) {
        ...
        compiler::CodeAssemblerExceptionHandlerLabel catch54__label(&ca_, compiler::CodeAssemblerLabel::kDeferred);
        {
            ...
            tmp53 = ca_.CallStub<Object>(
                Builtins::CallableFor(ca_.isolate(), Builtin::kFastCreateDataProperty), parameter0, phi_bb26_12, phi_bb43_16, phi_bb43_19);
        }
    ...
    if (block57.is_used()) {
        ...
        ca_.Branch(
            tmp62, &block55, std::vector<compiler::Node*> { phi_bb57_10, phi_bb57_14 }, &block56, std::vector<compiler::Node*> { phi_bb57_10, phi_bb57_14 });
    }
    ...
    if (block55.is_used()) {
        ...
        ca_.Branch(phi_bb55_10, &block58, std::vector<compiler::Node*> { phi_bb55_10, phi_bb55_14 }, &block59,
            std::vector<compiler::Node*> { phi_bb55_10, phi_bb55_14 });
    }
