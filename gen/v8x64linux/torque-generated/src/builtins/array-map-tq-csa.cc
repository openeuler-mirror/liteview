...
TF_BUILTIN(ArrayMapPreLoopLazyDeoptContinuation, CodeStubAssembler)
{
    ...
    if (block15.is_used()) {
        ca_.Bind(&block15);
        tmp8 = kZero_0(state_);
        tmp9 = ca_.CallStub<Object>(
            Builtins::CallableFor(ca_.isolate(), Builtin::kArrayMapLoopContinuation), parameter0, tmp0, tmp6, parameter3, tmp2, tmp0, tmp8, tmp4);
...
TF_BUILTIN(ArrayMapLoopEagerDeoptContinuation, CodeStubAssembler)
{
    ...
    if (block19.is_used()) {
        ca_.Bind(&block19);
        tmp10 = ca_.CallStub<Object>(
            Builtins::CallableFor(ca_.isolate(), Builtin::kArrayMapLoopContinuation), parameter0, tmp0, tmp2, parameter3, tmp4, tmp0, tmp6, tmp8);
...
TF_BUILTIN(ArrayMapLoopLazyDeoptContinuation, CodeStubAssembler)
{
    ...
    if (block19.is_used()) {
        ...
        tmp13 = ca_.CallStub<Object>(
            Builtins::CallableFor(ca_.isolate(), Builtin::kArrayMapLoopContinuation), parameter0, tmp0, tmp2, parameter3, tmp4, tmp0, tmp12, tmp8);
    ...
    compiler::TypedCodeAssemblerVariable<JSArray>* label_Bailout_parameter_0, compiler::TypedCodeAssemblerVariable<Smi>* label_Bailout_parameter_1)
{
    ...
    if (block79.is_used()) {
        ...
        tmp83 = CodeStubAssembler(state_).AllocateFixedDoubleArrayWithHoles(
            TNode<IntPtrT> { tmp82 }, CodeStubAssembler::AllocationFlag::kAllowLargeObjectAllocation);
    ...
    if (block121.is_used()) {
        ...
        tmp129 = CodeStubAssembler(state_).AllocateFixedDoubleArrayWithHoles(
            TNode<IntPtrT> { tmp128 }, CodeStubAssembler::AllocationFlag::kAllowLargeObjectAllocation);
...
TF_BUILTIN(ArrayMap, CodeStubAssembler)
{
    ...
    if (block7.is_used()) {
        ...
        tmp22 = ca_.CallStub<Object>(
            Builtins::CallableFor(ca_.isolate(), Builtin::kArrayMapLoopContinuation), parameter0, tmp1, tmp7, tmp10, phi_bb7_10, tmp1, phi_bb7_11, tmp2);
