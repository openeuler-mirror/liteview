    ...
    TNode<Object> p_reason, PromiseReaction::Type p_reactionType)
{
    ...
    if (block3.is_used()) {
        ...
        CodeStubAssembler(state_).StaticAssert(TNode<BoolT> { tmp12 },
            ...
            "https://source.chromium.org/chromium/chromium/src/+/main:v8/src/builtins/promise-reaction-job.tq?l=33&c=5");
        tmp13 = Undefined_0(state_);
        tmp14
            = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtin::kPromiseRejectReactionJob), p_context, p_reason, tmp13, p_promiseOrCapability);
    ...
    TNode<HeapObject> p_promiseOrCapability, PromiseReaction::Type p_reactionType)
{
    ...
    if (block6.is_used()) {
        ...
        CodeStubAssembler(state_).StaticAssert(TNode<BoolT> { tmp3 },
            ...
            "https://source.chromium.org/chromium/chromium/src/+/main:v8/src/builtins/promise-reaction-job.tq?l=82&c=7");
