...
void RegExpReplaceCallableNoExplicitCaptures_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<FixedArray> p_matchesElements,
    TNode<IntPtrT> p_matchesLength, TNode<String> p_string, TNode<JSReceiver> p_replaceFn)
{
    ...
    if (block31.is_used()) {
        ...
        tmp43 = CodeStubAssembler(state_).Call(TNode<Context> { p_context }, TNode<Object> { p_replaceFn }, TNode<Object> { tmp42 }, TNode<Object> { tmp16 },
        ...
        ca_.Branch(tmp50, &block37, std::vector<compiler::Node*> { phi_bb31_5, phi_bb31_6, phi_bb31_6, phi_bb31_6, phi_bb31_6, phi_bb31_6 }, &block38,
...
void RegExpReplaceCallableWithExplicitCaptures_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<FixedArray> p_matchesElements,
    TNode<IntPtrT> p_matchesLength, TNode<JSReceiver> p_replaceFn)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    if (block16.is_used()) {
        ...
        tmp18 = CodeStubAssembler(state_).Call(TNode<Context> { p_context }, TNode<Object> { tmp15 }, TNode<Object> { tmp16 }, TNode<Object> { p_replaceFn },
            TNode<Object> { tmp17 }, TNode<Object> { tmp13 });
        ...
        ca_.Branch(tmp24, &block22, std::vector<compiler::Node*> { phi_bb16_4, phi_bb16_4, phi_bb16_4, phi_bb16_4, phi_bb16_4 }, &block23,
    ...
    compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSRegExp> p_regexp, TNode<String> p_string, TNode<JSReceiver> p_replaceFn)
{
    ...
    if (block8.is_used()) {
        ca_.Bind(&block8);
        RegExpReplaceCallableNoExplicitCaptures_0(state_, TNode<Context> { p_context }, TNode<FixedArray> { tmp18 }, TNode<IntPtrT> { tmp15 },
    ...
    if (block9.is_used()) {
        ca_.Bind(&block9);
        RegExpReplaceCallableWithExplicitCaptures_0(
            state_, TNode<Context> { p_context }, TNode<FixedArray> { tmp18 }, TNode<IntPtrT> { tmp15 }, TNode<JSReceiver> { p_replaceFn });
        ca_.Goto(&block10);
    }
    ...
    compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSRegExp> p_regexp, TNode<String> p_string, TNode<String> p_replaceString)
{
    ...
    if (block12.is_used()) {
        ...
        tmp13 = Method_RegExpMatchInfo_GetStartOfCapture_0(state_, TNode<Context> { p_context }, TNode<RegExpMatchInfo> { tmp11 },
            (FromConstexpr_constexpr_int31_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x0ull))));
        tmp14 = Method_RegExpMatchInfo_GetEndOfCapture_0(state_, TNode<Context> { p_context }, TNode<RegExpMatchInfo> { tmp11 },
            (FromConstexpr_constexpr_int31_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x0ull))));
