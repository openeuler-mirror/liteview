...
TorqueStructSlice_String_MutableReference_String_0 FieldSliceScopeInfoContextLocalNames_0(compiler::CodeAssemblerState* state_, TNode<ScopeInfo> p_o)
{
    ...
    ca_.Bind(&block6);
    return TorqueStructSlice_String_MutableReference_String_0 { TNode<Object> { tmp10 }, TNode<IntPtrT> { tmp11 }, TNode<IntPtrT> { tmp12 },
...
TorqueStructSlice_Smi_MutableReference_Smi_0 FieldSliceScopeInfoSavedClassVariableInfo_0(compiler::CodeAssemblerState* state_, TNode<ScopeInfo> p_o)
{
    ...
    if (block0.is_used()) {
        ...
        tmp7 = CodeStubAssembler(state_).LoadReference<Smi>(CodeStubAssembler::Reference { p_o, tmp6 });
        tmp8 = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).DecodeWord32FromWord<base::BitField<bool, 11, 1, uintptr_t>>(
    ...
    compiler::CodeAssemblerState* state_, TNode<ScopeInfo> p_o)
{
    ...
    if (block0.is_used()) {
        ...
        tmp6 = FromConstexpr_intptr_constexpr_int31_0(state_, 4);
        tmp7 = CodeStubAssembler(state_).LoadReference<Smi>(CodeStubAssembler::Reference { p_o, tmp6 });
        tmp8 = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).DecodeWord32FromWord<base::BitField<bool, 15, 1, uintptr_t>>(
            ca_.UncheckedCast<WordT>(ca_.BitcastTaggedToWordForTagAndSmiBits(tmp7))));
        ca_.Branch(tmp8, &block2, std::vector<compiler::Node*> {}, &block3, std::vector<compiler::Node*> {});
    }
...
TorqueStructSlice_PositionInfo_MutableReference_PositionInfo_0 FieldSliceScopeInfoPositionInfo_0(compiler::CodeAssemblerState* state_, TNode<ScopeInfo> p_o)
{
    ...
    if (block0.is_used()) {
        ...
        tmp6 = FromConstexpr_intptr_constexpr_int31_0(state_, 4);
        tmp7 = CodeStubAssembler(state_).LoadReference<Smi>(CodeStubAssembler::Reference { p_o, tmp6 });
        tmp8 = ca_.UncheckedCast<Uint32T>(CodeStubAssembler(state_).DecodeWord32FromWord<base::BitField<ScopeType, 1, 4, uintptr_t>>(
            ca_.UncheckedCast<WordT>(ca_.BitcastTaggedToWordForTagAndSmiBits(tmp7))));
    ...
    if (block7.is_used()) {
        ...
        tmp14 = ca_.UncheckedCast<Uint32T>(CodeStubAssembler(state_).DecodeWord32FromWord<base::BitField<ScopeType, 1, 4, uintptr_t>>(
    ...
    if (block10.is_used()) {
        ...
        tmp20 = ca_.UncheckedCast<Uint32T>(CodeStubAssembler(state_).DecodeWord32FromWord<base::BitField<ScopeType, 1, 4, uintptr_t>>(
    ...
    if (block13.is_used()) {
        ...
        tmp26 = ca_.UncheckedCast<Uint32T>(CodeStubAssembler(state_).DecodeWord32FromWord<base::BitField<ScopeType, 1, 4, uintptr_t>>(
    ...
    if (block16.is_used()) {
        ...
        tmp32 = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).DecodeWord32FromWord<base::BitField<bool, 30, 1, uintptr_t>>(
            ca_.UncheckedCast<WordT>(ca_.BitcastTaggedToWordForTagAndSmiBits(tmp31))));
    ...
    if (block19.is_used()) {
        ...
        tmp36 = ca_.UncheckedCast<Uint32T>(CodeStubAssembler(state_).DecodeWord32FromWord<base::BitField<ScopeType, 1, 4, uintptr_t>>(
    ...
    if (block4.is_used()) {
        ...
        std::tie(tmp42, tmp43, tmp44)
            = NewMutableSlice_PositionInfo_0(state_, TNode<Object> { p_o }, TNode<IntPtrT> { tmp5 }, TNode<IntPtrT> { tmp41 }).Flatten();
        ca_.Goto(&block22);
    }

    ca_.Bind(&block22);
    return TorqueStructSlice_PositionInfo_MutableReference_PositionInfo_0 { TNode<Object> { tmp42 }, TNode<IntPtrT> { tmp43 }, TNode<IntPtrT> { tmp44 },
        TorqueStructUnsafe_0 {} };
}
    ...
    compiler::CodeAssemblerState* state_, TNode<ScopeInfo> p_o)
{
    ...
    if (block0.is_used()) {
        ...
        tmp6 = FromConstexpr_intptr_constexpr_int31_0(state_, 4);
        tmp7 = CodeStubAssembler(state_).LoadReference<Smi>(CodeStubAssembler::Reference { p_o, tmp6 });
        tmp8 = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).DecodeWord32FromWord<base::BitField<bool, 23, 1, uintptr_t>>(
            ca_.UncheckedCast<WordT>(ca_.BitcastTaggedToWordForTagAndSmiBits(tmp7))));
        ca_.Branch(tmp8, &block2, std::vector<compiler::Node*> {}, &block3, std::vector<compiler::Node*> {});
    }
...
TorqueStructSlice_HashTable_MutableReference_HashTable_0 FieldSliceScopeInfoLocalsBlockList_0(compiler::CodeAssemblerState* state_, TNode<ScopeInfo> p_o)
{
    ...
    if (block0.is_used()) {
        ...
        tmp6 = FromConstexpr_intptr_constexpr_int31_0(state_, 4);
        tmp7 = CodeStubAssembler(state_).LoadReference<Smi>(CodeStubAssembler::Reference { p_o, tmp6 });
        tmp8 = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).DecodeWord32FromWord<base::BitField<bool, 29, 1, uintptr_t>>(
            ca_.UncheckedCast<WordT>(ca_.BitcastTaggedToWordForTagAndSmiBits(tmp7))));
        ca_.Branch(tmp8, &block2, std::vector<compiler::Node*> {}, &block3, std::vector<compiler::Node*> {});
    }
    ...
    ca_.Bind(&block6);
    return TorqueStructSlice_HashTable_MutableReference_HashTable_0 { TNode<Object> { tmp12 }, TNode<IntPtrT> { tmp13 }, TNode<IntPtrT> { tmp14 },
        TorqueStructUnsafe_0 {} };
}
    ...
    compiler::CodeAssemblerState* state_, TNode<Object> p_object, TNode<IntPtrT> p_offset, TNode<IntPtrT> p_length)
{
    ...
    ca_.Bind(&block2);
    return TorqueStructSlice_PositionInfo_MutableReference_PositionInfo_0 { TNode<Object> { tmp0 }, TNode<IntPtrT> { tmp1 }, TNode<IntPtrT> { tmp2 },
        TorqueStructUnsafe_0 {} };
}
    ...
    compiler::CodeAssemblerState* state_, TNode<Object> p_object, TNode<IntPtrT> p_offset, TNode<IntPtrT> p_length)
{
    ...
    ca_.Bind(&block2);
    return TorqueStructSlice_HashTable_MutableReference_HashTable_0 { TNode<Object> { tmp0 }, TNode<IntPtrT> { tmp1 }, TNode<IntPtrT> { tmp2 },
        TorqueStructUnsafe_0 {} };
}
