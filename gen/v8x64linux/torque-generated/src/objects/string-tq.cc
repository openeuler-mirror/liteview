...
template <> void TorqueGeneratedString<String, Name>::StringVerify(Isolate* isolate)
{
...
template <> void TorqueGeneratedSeqString<SeqString, String>::SeqStringVerify(Isolate* isolate)
{
