...
void StaticAssertStringLengthFitsSmi_0(compiler::CodeAssemblerState* state_)
{
    ...
    if (block0.is_used()) {
        ...
        CodeStubAssembler(state_).StaticAssert(TNode<BoolT> { tmp0 },
            "static_assert(kMaxStringLengthFitsSmi) at https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/string.tq?l=314&c=3");
        ca_.Goto(&block2);
    }
    ...
    if (block0.is_used()) {
        ...
        InitializeFieldsFromIterator_char8_UninitializedIterator_0(state_,
            TorqueStructSlice_char8_MutableReference_char8_0 {
                TNode<Object> { tmp8 }, TNode<IntPtrT> { tmp12 }, TNode<IntPtrT> { tmp3 }, TorqueStructUnsafe_0 {} },
