...
public:
    ...
    bool hasWebDriverValue()
    {
        return m_webDriverValue.isJust();
    }
    ...
    void setWebDriverValue(std::unique_ptr<protocol::Runtime::WebDriverValue> value)
    {
        m_webDriverValue = std::move(value);
    }
...
public:
    ...
    {
        return m_exceptionMetaData.isJust();
    }
...
public:
    ...
    virtual void callFunctionOn(const String& in_functionDeclaration, Maybe<String> in_objectId,
        ...
        Maybe<bool> in_throwOnSideEffect, Maybe<bool> in_generateWebDriverValue, std::unique_ptr<CallFunctionOnCallback> callback)
        = 0;
    ...
    virtual void evaluate(const String& in_expression, Maybe<String> in_objectGroup, Maybe<bool> in_includeCommandLineAPI, Maybe<bool> in_silent,
        ...
        Maybe<bool> in_allowUnsafeEvalBlockedByCSP, Maybe<String> in_uniqueContextId, Maybe<bool> in_generateWebDriverValue,
