...
typedef SECURITY_STATUS(WINAPI* NCryptGetPropertyFunc)(NCRYPT_HANDLE hObject, LPCWSTR pszProperty, PBYTE pbOutput, DWORD cbOutput, DWORD* pcbResult, DWORD dwFlags);
...
public:
    ...
    static SECURITY_STATUS WINAPI dummyNCryptSignHashFunc(NCRYPT_KEY_HANDLE, VOID*, BYTE*, DWORD, BYTE*, DWORD, DWORD*, DWORD) { return E_FAIL; }

    static SECURITY_STATUS WINAPI dummyNCryptFreeObjectFunc(NCRYPT_HANDLE) { return E_FAIL; }

    static SECURITY_STATUS WINAPI dummyNCryptGetPropertyFunc(NCRYPT_HANDLE hObject, LPCWSTR pszProperty, PBYTE pbOutput, DWORD cbOutput, DWORD* pcbResult, DWORD dwFlags)
    {
        return E_FAIL;
    }

    NCryptFreeObjectFunc ncrypt_free_object() const { return ncrypt_free_object_; }

    NCryptSignHashFunc ncrypt_sign_hash() const { return ncrypt_sign_hash_; }

    NCryptGetPropertyFunc ncrypt_get_prop() const { return ncrypt_get_prop_; }
