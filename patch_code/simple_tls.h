...
template <typename T>
class SimpleTlsPointerXp {
public:
    SimpleTlsPointerXp() : impl_() 
    {
    }

    SimpleTlsPointerXp(void* default_val) : impl_(default_val) 
    {
...
template <typename T>
class SimpleTlsValueXp {
public:
    SimpleTlsValueXp() : tlp_(nullptr)
    {
    }
    ~SimpleTlsValueXp() {}

    SimpleTlsValueXp(T v) : tlp_((void*)v) 
    {

    }

    T Get() { return (T)tlp_.Get(); }
    void Set(T val) { tlp_.Set((void*)val); }
...
public:
    SimpleTlsBoolXp() : tlp_(nullptr)
    {
    }
    ~SimpleTlsBoolXp() {}

    SimpleTlsBoolXp(bool val) : tlp_(val ? this : nullptr) 
    {
...
public:
    SimpleTlsIntptrXp() : tlp_(nullptr) 
    {
    }
    ~SimpleTlsIntptrXp() {}

    SimpleTlsIntptrXp(intptr_t val) : tlp_((void*)val) 
    {
    }

    intptr_t Get() { return (intptr_t)tlp_.Get(); }
    void Set(intptr_t val) { tlp_.Set((void*)val); }
...
public:
    inline SimpleTlsUint8Xp() : tlp_(nullptr) 
    {
    }
    inline ~SimpleTlsUint8Xp() {}

    uint8_t Get() { return (uint8_t)tlp_.Get(); }
    void Set(uint8_t val) { tlp_.Set((void*)val); }
