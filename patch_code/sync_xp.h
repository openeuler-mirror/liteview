...
inline BOOL InitOnceExecuteOnceXp(INIT_ONCE* once, PINIT_ONCE_FN func, void* param, void** context) { return 0 == runOnceExecuteOnce(once, func, param, context); }
...
static inline void releaseWaitBlockLockImpl(PRTL_SRWLOCK SRWLock) { _InterlockedAnd((long*)&SRWLock->Ptr, ~XP_SRWLOCK_CONTENTION_LOCK); }
