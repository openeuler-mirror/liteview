...
inline DWORD CredUIPromptForCredentialsWXp(PCREDUI_INFOW pUiInfo, PCWSTR pszTargetName, PCtxtHandle pContext, DWORD dwAuthError, PWSTR pszUserName, ULONG ulUserNameBufferSize,
    PWSTR pszPassword, ULONG ulPasswordBufferSize, BOOL* save, DWORD dwFlags)
{
    typedef DWORD(__stdcall * PFN_CredUIPromptForCredentialsW)(PCWSTR pszTargetName, PCtxtHandle pContext, DWORD dwAuthError, PWSTR pszUserName, ULONG ulUserNameBufferSize,
        PWSTR pszPassword, ULONG ulPasswordBufferSize, BOOL * save, DWORD dwFlags);
    ...
    if (s_CredUIPromptForCredentialsW)
        return s_CredUIPromptForCredentialsW(pszTargetName, pContext, dwAuthError, pszUserName, ulUserNameBufferSize, pszPassword, ulPasswordBufferSize, save, dwFlags);

    return ERROR_ACCESS_DENIED;
}

inline DWORD CredUIPromptForWindowsCredentialsWXp(PCREDUI_INFOW pUiInfo, DWORD dwAuthError, ULONG* pulAuthPackage, LPCVOID pvInAuthBuffer, ULONG ulInAuthBufferSize,
    LPVOID* ppvOutAuthBuffer, ULONG* pulOutAuthBufferSize, BOOL* pfSave, DWORD dwFlags)
{
    typedef POWER_PLATFORM_ROLE(__stdcall * PFN_CredUIPromptForWindowsCredentialsW)(PCREDUI_INFOW pUiInfo, DWORD dwAuthError, ULONG * pulAuthPackage, LPCVOID pvInAuthBuffer,
