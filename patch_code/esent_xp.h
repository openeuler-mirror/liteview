...
inline JET_ERR JetGetTableColumnInfoWXp(JET_SESID sesid, JET_TABLEID tableid, JET_PCWSTR szColumnName, void* pvResult, unsigned long cbMax, unsigned long InfoLevel)
{
...
{
    typedef JET_ERR(WINAPI * PFN_JetSetSystemParameterW)(JET_INSTANCE * pinstance, JET_SESID sesid, unsigned long paramid, JET_API_PTR lParam, JET_PCWSTR szParam);
...
inline JET_ERR JetOpenTableWXp(JET_SESID sesid, JET_DBID dbid, JET_PCWSTR szTableName, const void* pvParameters, unsigned long cbParameters, JET_GRBIT grbit, JET_TABLEID* ptableid)
{
...
inline JET_ERR JetGetSystemParameterWXp(JET_INSTANCE instance, JET_SESID sesid, unsigned long paramid, JET_API_PTR* plParam, JET_PWSTR szParam, unsigned long cbMax)
{
...
inline JET_ERR JetRetrieveColumnXp(
...
{
    typedef JET_ERR(WINAPI * PFN_JetRetrieveColumn)(
        JET_SESID sesid, JET_TABLEID tableid, JET_COLUMNID columnid, void* pvData, unsigned long cbData, unsigned long* pcbActual, JET_GRBIT grbit, JET_RETINFO* pretinfo);
