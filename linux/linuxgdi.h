...
public:
    ...
    GtkWidget* getRootWindow() { return m_window; }
    ...
    */
    ...
    bool m_isDestroying;
    GtkIMContext* m_imContext = nullptr;

    static std::map<int, WNDCLASSEXW*>* s_wndClassMap;
    static std::set<HWND>* s_hwnds;
    static pthread_mutex_t s_hwndMutex;

    static GdkEvent* s_lastMousePressEvent;
    static GdkEvent* getLastMousePressEvent() { return s_lastMousePressEvent; }

    static void setLastMousePressEvent(GdkEvent* aEvent);
};
