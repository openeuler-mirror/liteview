...
#### [`//gn/config/BUILDCONFIG.gn`](config/BUILDCONFIG.gn)
...
#### [`//gn/toolchain/clang.gni`](toolchain/clang.gni)
...
#### [`//gn/toolchain/compiler_version.gni`](toolchain/compiler_version.gni)
...
#### [`//gn/toolchain/win/settings.gni`](toolchain/win/settings.gni)
...
#### [`//gn/toolchain/posix/settings.gni`](toolchain/posix/settings.gni)
...
#### [`//gn/toolchain/mac/settings.gni`](toolchain/mac/settings.gni)
...
* `enable_dsyms` (default: true): Produce dSYM files for targets that are
  ...
  linker output (produced via the `//gn/toolchain/mac/linker_driver.py`.
...
* `enable_stripping` (default: `is_official_build`): Strip symbols from linked
  targets by default. If this is enabled, the //gn/config/mac:strip_all
  ...
  `-Wcrl,strip` flags. See //gn/toolchain/mac/linker_driver.py for more
  information.

#### [`//gn/toolchain/mac/mac_sdk.gni`](toolchain/mac/mac_sdk.gni)
...
#### [`//gn/toolchain/mac/ios_sdk.gni`](toolchain/mac/ios_sdk.gni)
...
#### [`//gn/toolchain/android/settings.gni`](toolchain/android/settings.gni)
...
that just `import()s` [`//gn/config/BUILDCONFIG.gn`](config/BUILDCONFIG.gn) and then overrides
