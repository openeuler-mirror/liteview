...
INSTANTIATE_TEST_SUITE_P(, MojoCoreMultiprocessTest,
    ::testing::Combine(
        ::testing::Values(InitializationMode::kCombinedLoadAndInit, InitializationMode::kLoadBeforeInit), ::testing::Values(LoadPathSpec::kImplicit, LoadPathSpec::kExplicit)));
