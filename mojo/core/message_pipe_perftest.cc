...
protected:
    ...
    void SendQuitMessage(MojoHandle mp) { CHECK_EQ(WriteMessageRaw(MessagePipeHandle(mp), "", 0, nullptr, 0, MOJO_WRITE_MESSAGE_FLAG_NONE), MOJO_RESULT_OK); }
...
DEFINE_TEST_CLIENT_WITH_PIPE(PingPongClient, MessagePipePerfTest, h) { return RunPingPongClient(h); }
