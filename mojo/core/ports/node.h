...
public:
    ...
    int InitializePort(const PortRef& port_ref, const NodeName& peer_node_name, const PortName& peer_port_name, const NodeName& prev_node_name, const PortName& prev_port_name);
...
private:
    ...
    void ConvertToProxy(Port* port, const NodeName& to_node_name, PortName* port_name, Event::PortDescriptor* port_descriptor, PendingUpdatePreviousPeer* pending_update);
