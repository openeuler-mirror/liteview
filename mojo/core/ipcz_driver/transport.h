...
public:
    ...
    void set_leak_channel_on_shutdown(bool leak) { leak_channel_on_shutdown_ = leak; }
    ...
    PlatformChannelEndpoint TakeEndpoint() { return std::move(absl::get<PlatformChannelEndpoint>(inactive_endpoint_)); }
