...
private:
    ~MojoIpczInProcessTestNodeController() override { CHECK(node_thread_.HasBeenJoined()); }
...
public:
    ...
    IpczConnectNodeFlags GetExtraClientConnectNodeFlags() const override { return IPCZ_NO_FLAGS; }
    ...
    IpczDriverHandle GetClientTestNodeTransport() override
    {
        ...
        return Transport::ReleaseAsHandle(Transport::Create({ .source = parent_process.IsValid() ? Transport::kBroker : Transport::kNonBroker, .destination = Transport::kBroker },
