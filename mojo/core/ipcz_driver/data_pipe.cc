...
IpczResult DataPipe::WriteData(const void* elements, uint32_t& num_bytes, MojoWriteDataFlags flags)
{
    ...
    const MojoBeginWriteDataFlags begin_write_flags = (flags & MOJO_WRITE_DATA_FLAG_ALL_OR_NONE) ? MOJO_BEGIN_WRITE_DATA_FLAG_ALL_OR_NONE : MOJO_BEGIN_WRITE_DATA_FLAG_NONE;
...
bool DataPipe::IsSerializable() const { return true; }
