...
public:
    ...
    void Start() override { io_task_runner_->PostTask(FROM_HERE, base::BindOnce(&ChannelMac::StartOnIOThread, this)); }

    void ShutDownImpl() override { io_task_runner_->PostTask(FROM_HERE, base::BindOnce(&ChannelMac::ShutDownOnIOThread, this)); }
...
private:
    ...
    bool RequestSendDeadNameNotification()
    {
        ...
        kern_return_t kr = mach_port_request_notification(mach_task_self(), send_port_.get(), MACH_NOTIFY_DEAD_NAME, 0, receive_port_.get(), MACH_MSG_TYPE_MAKE_SEND_ONCE,
...
scoped_refptr<Channel> Channel::Create(
    Channel::Delegate* delegate, ConnectionParams connection_params, Channel::HandlePolicy handle_policy, scoped_refptr<base::SingleThreadTaskRunner> io_task_runner)
{
