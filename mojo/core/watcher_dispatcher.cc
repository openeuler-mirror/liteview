...
Dispatcher::Type WatcherDispatcher::GetType() const { return Type::WATCHER; }
...
MojoResult WatcherDispatcher::WatchDispatcher(scoped_refptr<Dispatcher> dispatcher, MojoHandleSignals signals, MojoTriggerCondition condition, uintptr_t context)
{
