...
TEST(PlatformHandleDispatcherTest, Serialization)
{
    ...
    dispatcher
        = static_cast<PlatformHandleDispatcher*>(Dispatcher::Deserialize(Dispatcher::Type::PLATFORM_HANDLE, nullptr, num_bytes, nullptr, num_ports, &received_handle, 1u).get());
