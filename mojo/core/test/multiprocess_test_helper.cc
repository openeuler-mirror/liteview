...
MultiprocessTestHelper::~MultiprocessTestHelper() { CHECK(!test_child_.IsValid()); }
...
#error "Platform not yet supported."
    ...
    if (launch_type == LaunchType::CHILD || launch_type == LaunchType::CHILD_WITHOUT_CAPABILITIES || launch_type == LaunchType::PEER || launch_type == LaunchType::ASYNC) {
...
bool MultiprocessTestHelper::WaitForChildTestShutdown() { return WaitForChildShutdown() == 0; }
