...
public:
    TestSupportInitializer() { mojo::test::TestSupport::Init(new mojo::core::test::TestSupportImpl()); }
};
...
public:
    CoreInstance()
    {
        ...
        if (!base::CommandLine::ForCurrentProcess()->HasSwitch(switches::kTestChildProcess) || base::CommandLine::ForCurrentProcess()->HasSwitch(test_switches::kMojoIsBroker)) {
