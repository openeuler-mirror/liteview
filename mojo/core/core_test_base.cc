...
public:
    static scoped_refptr<MockDispatcher> Create(CoreTestBase::MockHandleInfo* info) { return base::WrapRefCounted(new MockDispatcher(info)); }
...
Core* CoreTestBase::core() { return Core::Get(); }
