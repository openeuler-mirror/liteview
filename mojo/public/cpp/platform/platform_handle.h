...
public:
    ...
    bool is_valid_mach_port() const { return is_valid_mach_send() || is_valid_mach_receive(); }

    bool is_valid_mach_send() const { return mach_send_.is_valid(); }
    bool is_mach_send() const { return type_ == Type::kMachSend; }
    const base::mac::ScopedMachSendRight& GetMachSendRight() const { return mach_send_; }
    ...
    [[nodiscard]] mach_port_t ReleaseMachSendRight() { return TakeMachSendRight().release(); }

    bool is_valid_mach_receive() const { return mach_receive_.is_valid(); }
    bool is_mach_receive() const { return type_ == Type::kMachReceive; }
    const base::mac::ScopedMachReceiveRight& GetMachReceiveRight() const { return mach_receive_; }
    ...
    [[nodiscard]] mach_port_t ReleaseMachReceiveRight() { return TakeMachReceiveRight().release(); }
