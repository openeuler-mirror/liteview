...
bool SyncCallRestrictionsEnforceable() { return base::internal::SequenceLocalStorageMap::IsSetForCurrentThread(); }
...
// static
void SyncCallRestrictions::DisallowSyncCall() { GetGlobalSettings().DisallowSyncCallByDefault(); }
...
// static
void SyncCallRestrictions::DisableSyncCallInterrupts() { g_enable_sync_call_interrupts = false; }

// static
void SyncCallRestrictions::EnableSyncCallInterruptsForTesting() { g_enable_sync_call_interrupts = true; }

// static
bool SyncCallRestrictions::AreSyncCallInterruptsEnabled() { return g_enable_sync_call_interrupts; }
