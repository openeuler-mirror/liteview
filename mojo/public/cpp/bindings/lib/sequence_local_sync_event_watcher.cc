...
public:
    ...
    static base::WeakPtr<SequenceLocalState> GetOrCreate() { return GetStorageSlot().GetOrCreateValue().weak_ptr_factory_.GetWeakPtr(); }
...
void SequenceLocalSyncEventWatcher::SignalEvent() { registration_->shared_state()->SignalForWatcher(this); }

void SequenceLocalSyncEventWatcher::ResetEvent() { registration_->shared_state()->ResetForWatcher(this); }

void SequenceLocalSyncEventWatcher::AllowWokenUpBySyncWatchOnSameSequence() { can_wake_up_during_any_watch_ = true; }
