...
void DoNotifyBadMessage(Message message, base::StringPiece error) { message.NotifyBadMessage(error); }
...
void DestroyUnserializedContext(uintptr_t context) { delete reinterpret_cast<internal::UnserializedMessageContext*>(context); }
...
uint64_t Message::GetTraceId() const { return ::mojo::GetTraceId(header()->name, header()->trace_nonce); }
...
bool MessageReceiver::PrefersSerializedMessages() { return false; }
...
bool IsInMessageDispatch() { return internal::MessageDispatchContext::current(); }
...
// static
MessageDispatchContext* MessageDispatchContext::current() { return g_sls_message_dispatch_context.Get().GetOrCreateValue(); }
