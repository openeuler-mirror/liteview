...
void ServiceFactory::OnInstanceDisconnected(InstanceHolderBase* instance) { instances_.erase(instance); }
...
void ServiceFactory::InstanceHolderBase::WatchPipe(MessagePipeHandle pipe, base::OnceClosure disconnect_callback)
{
    ...
    watcher_.Watch(pipe, MOJO_HANDLE_SIGNAL_READABLE, MOJO_TRIGGER_CONDITION_SIGNALS_SATISFIED, base::BindRepeating(&InstanceHolderBase::OnPipeSignaled, base::Unretained(this)));
}
