...
public:
    ...
    {
        binders_[Interface::Name_] = std::make_unique<internal::GenericCallbackBinderWithContext<ContextType>>(
    ...
    void SetDefaultBinderDeprecated(DefaultBinder binder) { default_binder_ = std::move(binder); }
