...
public:
    ...
    const absl::optional<std::string>& interface_name() const { return interface_name_; }
    ...
    template <typename Interface> mojo::PendingAssociatedReceiver<Interface> As() { return mojo::PendingAssociatedReceiver<Interface>(PassHandleIfNameIs(Interface::Name_)); }
