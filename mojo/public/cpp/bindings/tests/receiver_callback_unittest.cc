...
public:
    ...
    void EchoString(const std::string& a, EchoStringCallback callback) override { CHECK(false) << "Not implemented."; }

    void EchoStrings(const std::string& a, const std::string& b, EchoStringsCallback callback) override { CHECK(false) << "Not implemented."; }

    void EchoMessagePipeHandle(ScopedMessagePipeHandle a, EchoMessagePipeHandleCallback callback) override { CHECK(false) << "Not implemented."; }

    void EchoEnum(sample::Enum a, EchoEnumCallback callback) override { CHECK(false) << "Not implemented."; }
