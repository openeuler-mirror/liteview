...
void SetBoolFromRawPtr(bool* var, bool* val) { *var = *val; }
...
void SetIntegerFromUniquePtr(int* var, std::unique_ptr<int> val) { *var = *val; }

void SetString(std::string* var, const std::string val) { *var = val; }

void CallClosure(base::OnceClosure cl) { std::move(cl).Run(); }
