...
public:
    ...
    void EchoString(const absl::optional<std::string>& str, EchoStringCallback callback) override { std::move(callback).Run(str); }
...
void ExpectStringMap(
    absl::optional<WTF::HashMap<WTF::String, WTF::String>>* expected_map, base::OnceClosure closure, const absl::optional<WTF::HashMap<WTF::String, WTF::String>>& map)
{
