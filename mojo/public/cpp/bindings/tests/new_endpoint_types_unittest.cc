...
public:
    ...
    void AddObserver(mojo::PendingRemote<mojom::WidgetObserver> observer) override { observers_.emplace_back(std::move(observer)); }
...
public:
    ...
    mojo::PendingRemote<mojom::WidgetClient> BindNewPipeAndPassRemote() { return receiver_.BindNewPipeAndPassRemote(); }
...
public:
    ...
    void AddReceiver(mojo::PendingAssociatedReceiver<mojom::Pinger> receiver) { receivers_.Add(this, std::move(receiver)); }
