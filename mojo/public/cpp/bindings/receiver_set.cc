...
private:
    ...
    void DidDispatchOrReject(Message* message, bool accepted) override { entry_.DidDispatchOrReject(); }
...
{
    receiver_->InstallDispatchHooks(std::make_unique<DispatchFilter>(*this), base::BindRepeating(&ReceiverSetState::Entry::OnDisconnect, base::Unretained(this)));
}
