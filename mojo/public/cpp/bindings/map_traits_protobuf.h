...
template <typename K, typename V> struct MapTraits<::google::protobuf::Map<K, V>> {
    ...
    static size_t GetSize(const ::google::protobuf::Map<K, V>& input) { return input.size(); }

    static ConstIterator GetBegin(const ::google::protobuf::Map<K, V>& input) { return input.begin(); }
    static Iterator GetBegin(::google::protobuf::Map<K, V>& input) { return input.begin(); }
    ...
    static void SetToEmpty(::google::protobuf::Map<K, V>* output) { output->clear(); }
};
