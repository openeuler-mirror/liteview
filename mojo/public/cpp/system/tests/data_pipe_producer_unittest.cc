...
protected:
    ...
    static void WriteFromFileThenCloseWriter(std::unique_ptr<DataPipeProducer> producer, std::unique_ptr<FilteredDataSource::Filter> filter, base::File file, uint64_t max_bytes)
    {
        DataPipeProducer* raw_producer = producer.get();
