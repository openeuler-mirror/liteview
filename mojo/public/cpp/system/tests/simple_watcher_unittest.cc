...
template <typename Handler> void RunResultHandler(Handler f, MojoResult result) { f(result); }

template <typename Handler> SimpleWatcher::ReadyCallback OnReady(Handler f) { return base::BindRepeating(&RunResultHandler<Handler>, f); }
