...
public:
    ...
    void Wait(base::WaitableEvent** ready_event, size_t* num_ready_handles, Handle* ready_handles, MojoResult* ready_results, MojoHandleSignalsState* signals_states)
    {
...
bool mojo::StructTraits<mojo_base::mojom::String16DataView, std::u16string>::Read(
...
bool mojo::StructTraits<blink::mojom::FrameStateDataView, mojo::StructPtr<blink::mojom::FrameState> >::Read(
    blink::mojom::FrameStateDataView input, 
    mojo::StructPtr<blink::mojom::FrameState>* output)
{
    bool success = true;
...
bool mojo::StructTraits<blink::mojom::PageStateDataView, mojo::StructPtr<blink::mojom::PageState> >::Read(
    blink::mojom::PageStateDataView input,
    mojo::StructPtr<blink::mojom::PageState>* output)
{
    bool success = true;
...
bool viz::mojom::blink::CompositorFrameSink::SubmitCompositorFrameSync(
...
base::BasicStringPiece<char, struct std::char_traits<char> > mojo::StructTraits<url::mojom::UrlDataView, GURL>::url(GURL const&)
{
    *(int*)1 = 1;
    return base::BasicStringPiece<char, std::char_traits<char> >();
}

uint32_t mojo::StructTraits<skia::mojom::ImageInfoDataView, SkImageInfo>::height(SkImageInfo const&)
{
    *(int*)1 = 1;
    return 0;
}
...
scoped_refptr<mojo::internal::MultiplexRouter> mojo::internal::MultiplexRouter::CreateAndStartReceiving(mojo::ScopedHandleBase<mojo::MessagePipeHandle>,
    mojo::internal::MultiplexRouter::Config, bool, scoped_refptr<base::SequencedTaskRunner>, char const*)
{
    *(int*)1 = 1;
    return nullptr;
}
...
std::basic_ostream<char, struct std::char_traits<char> >& network::mojom::operator<<(std::basic_ostream<char, std::char_traits<char> >& other, network::mojom::CSPDirectiveName)
{
    *(int*)1 = 1;
    return other;
}

WTF::StringUTF8Adaptor mojo::StringTraits<WTF::String>::GetUTF8(const WTF::String& str)
{
...
bool blink::mojom::blink::DataElement::Validate(const void* data, mojo::internal::ValidationContext* validation_context) { return Data_::Validate(data, validation_context, false); }
//const char BytesProvider::Name_[] = "blink.mojom.BytesProvider";

blink::mojom::Element::Element(void) { *(int*)1 = 1; }
...
blink::mojom::blink::PermissionDescriptorExtension::PermissionDescriptorExtension(void) { *(int*)1 = 1; }

void blink::mojom::Element::set_bytes(std::vector<unsigned char, std::allocator<unsigned char>>) { *(int*)1 = 1; }
void blink::mojom::Element::set_file(mojo::StructPtr<::blink::mojom::File>) { *(int*)1 = 1; }
...
blink::mojom::blink::FileChooserFileInfo::FileChooserFileInfo() : tag_(Tag::kNativeFile)
{
...
void blink::mojom::blink::PermissionDescriptorExtension::set_storage_access(mojo::StructPtr<::blink::mojom::blink::StorageAccessPermissionDescriptor>) { *(int*)1 = 1; }
...
mojo::internal::ValidationContext::ValidationContext(const void* data, size_t data_num_bytes, size_t num_handles, size_t num_associated_endpoint_handles, mojo::Message* message,
    const char* description, int stack_depth, mojo::internal::ValidationContext::ValidatorType validator_type)
    : message_(message)
...
void mojo::internal::ReceiverImplBase::EnableBatchDispatch(void) { *(int*)1 = 1; }
void mojo::internal::ReceiverImplBase::FlushForTesting(void) { *(int*)1 = 1; }
void mojo::internal::ReceiverImplBase::PauseIncomingMethodCallProcessing(void) { *(int*)1 = 1; }
void mojo::internal::ReceiverImplBase::ResumeIncomingMethodCallProcessing(void) { *(int*)1 = 1; }
...
media_session::mojom::blink::MediaPosition::MediaPosition(double, class base::TimeDelta, class base::TimeDelta, class base::TimeTicks, bool) { *(int*)1 = 1; }

viz::mojom::blink::BundledFrameSubmissionData::BundledFrameSubmissionData(void) { *(int*)1 = 1; }
...
blink::MojoInterfaceRequestEvent::~MojoInterfaceRequestEvent(void) { *(int*)1 = 1; }
...
void network::mojom::AllowCSPFromHeaderValue::set_allow_star(bool allow_star) { *(int*)1 = 1; }
void network::mojom::AllowCSPFromHeaderValue::set_origin(const ::url::Origin& origin) { *(int*)1 = 1; }
void network::mojom::AllowCSPFromHeaderValue::set_error_message(const std::string& error_message) { *(int*)1 = 1; }
void network::mojom::AllowCSPFromHeaderValue::DestroyActive() { *(int*)1 = 1; }

void network::mojom::blink::AllowCSPFromHeaderValue::set_allow_star(bool) { *(int*)1 = 1; }
void network::mojom::blink::AllowCSPFromHeaderValue::set_error_message(WTF::String const&) { *(int*)1 = 1; }
void network::mojom::blink::AllowCSPFromHeaderValue::set_origin(scoped_refptr<::blink::SecurityOrigin const> const&) { *(int*)1 = 1; }

void network::mojom::TimingAllowOrigin::set_serialized_origins(std::vector<std::string> serialized_origins) { *(int*)1 = 1; }
void network::mojom::TimingAllowOrigin::set_all(unsigned char) { *(int*)1 = 1; }

void network::mojom::blink::TimingAllowOrigin::set_all(unsigned char) { *(int*)1 = 1; }
void network::mojom::blink::TimingAllowOrigin::set_serialized_origins(WTF::Vector<WTF::String, 0, WTF::PartitionAllocator>) { *(int*)1 = 1; }

network::mojom::TimingAllowOrigin::~TimingAllowOrigin(void) { *(int*)1 = 1; }
