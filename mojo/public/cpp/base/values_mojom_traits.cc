...
bool StructTraits<mojo_base::mojom::DeprecatedDictionaryValueDataView, base::Value>::Read(mojo_base::mojom::DeprecatedDictionaryValueDataView data, base::Value* value_out)
{
    mojo::MapDataView<mojo::StringDataView, mojo_base::mojom::ValueDataView> view;
    data.GetStorageDataView(&view);
