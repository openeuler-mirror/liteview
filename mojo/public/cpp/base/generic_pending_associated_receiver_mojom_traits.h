...
template <> struct COMPONENT_EXPORT(MOJO_BASE_SHARED_TRAITS) StructTraits<mojo_base::mojom::GenericPendingAssociatedReceiverDataView, GenericPendingAssociatedReceiver> {
    ...
    static mojo::ScopedInterfaceEndpointHandle receiver(GenericPendingAssociatedReceiver& receiver) { return receiver.PassHandle(); }
