...
//             sprintf_s(output, 399, "updateHandle, SelectClipRgn fail: %d\n", ::GetLastError());
...
//         }
        ...
        //DCHECK(result != 0);
//         if (result == 0)
//             OutputDebugStringA("updateHandle, DeleteObject fail\n");
    }
};

void unmap_view_proc(void* pixels, void*) { UnmapViewOfFile(pixels); }

// class GdiDataAllocator : public SkRasterHandleAllocator {
// public:
//     GdiDataAllocator(HBITMAP hBitmap) 
//         : hBitmap_(hBitmap) 
//     {
//     }
// 
...
//         int result = SelectClipRgn(hdc, hrgn);
//         if (result == ERROR)
//             OutputDebugStringA("updateHandle, SelectClipRgn fail\n");
//         //DCHECK(result != ERROR);
//         result = DeleteObject(hrgn);
//         //DCHECK(result != 0);
//         if (result == 0)
