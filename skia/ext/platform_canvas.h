...
// See it for details.
SK_API std::unique_ptr<SkCanvas> CreatePlatformCanvasWithSharedSection(int width, int height, bool is_opaque, HANDLE shared_section, OnFailureType failure_type);
